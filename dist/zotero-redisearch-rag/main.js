...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:we,rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${ne}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Ze=class extends T.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async h=>{this.plugin.settings.llmProviderProfiles=h,await this.plugin.saveSettings()},i=h=>{h.inputEl.type="password",h.inputEl.autocomplete="off",h.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:h=>{h.createEl("h2",{text:"Prerequisites"});let k=null,b=null,w=null,S=null,P=null,N=null,R=null,I=null,L=null,j=(M,z)=>{if(!M)return;M.settingEl.classList.toggle("is-disabled",z),M.settingEl.style.opacity=z?"0.55":"";let B=M.settingEl.querySelector(".setting-item-description");B&&(B.style.color=z?"var(--text-faint)":"")},F=(M,z)=>{M&&(M.settingEl.style.display=z?"":"none")},q=()=>{let M=!!this.plugin.settings.showAdvancedPythonRuntimeOptions,z=this.plugin.settings.pythonRuntime==="local",B=M&&z;b==null||b.setDisabled(!M),j(k,!M),F(w,M),F(S,M),F(P,M),N==null||N.setDisabled(!B),R==null||R.setDisabled(!B),L==null||L.setDisabled(!B),I&&(I.disabled=!B),j(w,!B),j(S,!B),j(P,!B)};new T.Setting(h).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(M=>M.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async z=>{this.plugin.settings.dockerPath=z.trim()||"docker",await this.plugin.saveSettings()})),new T.Setting(h).setName("Advanced Python runtime options").setDesc("Show legacy local interpreter/venv controls. Recommended to keep this disabled.").addToggle(M=>M.setValue(this.plugin.settings.showAdvancedPythonRuntimeOptions).onChange(async z=>{this.plugin.settings.showAdvancedPythonRuntimeOptions=z,!z&&this.plugin.settings.pythonRuntime==="local"&&(this.plugin.settings.pythonRuntime="worker",new T.Notice("Switched Python runtime to worker mode.")),await this.plugin.saveSettings(),q()})),k=new T.Setting(h).setName("Python runtime").setDesc("Worker runtime is recommended. Enable advanced options to expose local interpreter/venv mode.").addDropdown(M=>{b=M,M.addOption("worker","Python worker container (recommended)"),M.addOption("local","Local interpreter/venv"),M.setValue(this.plugin.settings.pythonRuntime).onChange(async z=>{z!=="worker"&&z!=="local"||(this.plugin.settings.pythonRuntime=z,await this.plugin.saveSettings(),q())})}),w=new T.Setting(h).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(M=>(N=M,M.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async z=>{this.plugin.settings.pythonPath=z.trim(),await this.plugin.saveSettings()}))),S=new T.Setting(h).setName("Python environment").setDesc("Local mode: create or update the plugin's Python env. Worker mode: managed by Docker startup.").addButton(M=>{L=M,I=M.buttonEl,M.setButtonText("Create/Update").setCta(),M.onClick(async()=>{M.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{M.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),P=new T.Setting(h).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(M=>{R=M,M.addOption("shared","Shared user cache"),M.addOption("plugin","Plugin folder (.venv)"),M.setValue(this.plugin.settings.pythonEnvLocation).onChange(async z=>{z!=="shared"&&z!=="plugin"||(this.plugin.settings.pythonEnvLocation=z,await this.plugin.saveSettings())})}),q(),new T.Setting(h).setName("Redis URL").addText(M=>M.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async z=>{this.plugin.settings.redisUrl=z.trim(),await this.plugin.saveSettings()}));let V=null,O=null,$=null,U=null,H=()=>{let M=this.plugin.settings.autoAssignRedisPort;$==null||$.setDisabled(M),U==null||U.setDisabled(M),V==null||V.settingEl.classList.toggle("is-disabled",M),O==null||O.settingEl.classList.toggle("is-disabled",M)};new T.Setting(h).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(M=>M.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async z=>{this.plugin.settings.autoAssignRedisPort=z,await this.plugin.saveSettings(),H()})),V=new T.Setting(h).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(M=>($=M,M.setPlaceholder("~/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async z=>{this.plugin.settings.redisDataDirOverride=z.trim(),await this.plugin.saveSettings()}))),V.settingEl.addClass("zrr-redis-override-setting"),O=new T.Setting(h).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(M=>(U=M,M.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async z=>{this.plugin.settings.redisProjectName=z.trim(),await this.plugin.saveSettings()}))),O.settingEl.addClass("zrr-redis-override-setting"),H(),new T.Setting(h).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(M=>M.setValue(this.plugin.settings.autoStartRedis).onChange(async z=>{this.plugin.settings.autoStartRedis=z,await this.plugin.saveSettings()})),new T.Setting(h).setName("Start Redis stack now").setDesc("Starts or restarts Redis stack (and Python worker in worker mode).").addButton(M=>M.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:h=>{h.createEl("h2",{text:"Zotero Local API"}),new T.Setting(h).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(P=>P.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async N=>{this.plugin.settings.zoteroBaseUrl=N.trim(),await this.plugin.saveSettings()}));let k=new T.Setting(h).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),b=null,w=P=>{if(!b)return;let N=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(P.map(I=>I.value)).has(N)||(P=P.concat([{value:N,label:`Custom (${N})`}])),b.selectEl.options.length=0;for(let I of P)b.addOption(I.value,I.label);b.setValue(N)},S=async()=>{if(b){b.setDisabled(!0);try{let P=await this.plugin.fetchZoteroLibraryOptions();w(P)}finally{b.setDisabled(!1)}}};k.addDropdown(P=>{b=P;let N=(this.plugin.settings.zoteroUserId||"0").trim()||"0";P.addOption(N,"Loading..."),P.setValue(N),P.onChange(async R=>{this.plugin.settings.zoteroUserId=R.trim(),await this.plugin.saveSettings()})}),k.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),h.createEl("h2",{text:"Zotero Web API"}),new T.Setting(h).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(P=>P.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async N=>{this.plugin.settings.webApiBaseUrl=N.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(P=>P.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async N=>{this.plugin.settings.webApiLibraryType=N,await this.plugin.saveSettings()})),new T.Setting(h).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(P=>P.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async N=>{this.plugin.settings.webApiLibraryId=N.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(P=>{i(P),P.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async N=>{this.plugin.settings.webApiKey=N.trim(),await this.plugin.saveSettings()})}),h.createEl("h2",{text:"Output"}),new T.Setting(h).setName("PDF folder").addText(P=>P.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async N=>{this.plugin.settings.outputPdfDir=N.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("Notes folder").addText(P=>P.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async N=>{this.plugin.settings.outputNoteDir=N.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(P=>{P.setValue(this.plugin.settings.frontmatterTemplate).onChange(async N=>{this.plugin.settings.frontmatterTemplate=N,await this.plugin.saveSettings()}),P.inputEl.rows=10,P.inputEl.style.width="100%"}),new T.Setting(h).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(P=>P.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async N=>{this.plugin.settings.tagSanitizeMode=N,await this.plugin.saveSettings()})),new T.Setting(h).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(P=>{P.setValue(this.plugin.settings.noteBodyTemplate).onChange(async N=>{this.plugin.settings.noteBodyTemplate=N,await this.plugin.saveSettings()}),P.inputEl.rows=8,P.inputEl.style.width="100%"}),new T.Setting(h).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(P=>P.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async N=>{this.plugin.settings.chatOutputDir=N.trim()||"zotero/chats",await this.plugin.saveSettings()})),new T.Setting(h).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(P=>P.setValue(this.plugin.settings.copyPdfToVault).onChange(async N=>{this.plugin.settings.copyPdfToVault=N,!N&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new T.Setting(h).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(P=>{let N=this.plugin.settings.copyPdfToVault;P.setValue(N?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!N).onChange(async R=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=R,await this.plugin.saveSettings()})}),new T.Setting(h).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(P=>P.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async N=>{this.plugin.settings.preferObsidianNoteForCitations=N,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:h=>{h.createEl("h2",{text:"Annotations"}),new T.Setting(h).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(S=>S.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async P=>{this.plugin.settings.annotationPageLabel=P.trim()||"Page",await this.plugin.saveSettings()})),new T.Setting(h).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(S=>S.setValue(this.plugin.settings.includeAnnotationImages).onChange(async P=>{this.plugin.settings.includeAnnotationImages=P,await this.plugin.saveSettings()})),h.createEl("h3",{text:"Zotero companion"}),h.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new T.Setting(h).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(S=>S.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async P=>{this.plugin.settings.zoteroCompanionEnabled=P,await this.plugin.saveSettings()})),new T.Setting(h).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(S=>S.setPlaceholder("http://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async P=>{this.plugin.settings.zoteroCompanionBaseUrl=P.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(S=>{i(S),this.companionTokenInput=S,S.setPlaceholder("optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async P=>{this.plugin.settings.zoteroCompanionToken=P.trim(),await this.plugin.saveSettings()})}),new T.Setting(h).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero Companion Plugin token to this value.").addButton(S=>S.setButtonText("Generate token").onClick(async()=>{let P=(0,Mt.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=P,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(P);try{await navigator.clipboard.writeText(P),new T.Notice("Generated and copied companion token.")}catch(N){new T.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",N)}})),h.createEl("h3",{text:"Annotation color map"}),h.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let k=h.createDiv({cls:"zrr-annotation-map"}),b=async S=>{this.plugin.settings.annotationColorMap=S,await this.plugin.saveSettings()},w=()=>{var L,j;k.empty();let S=this.plugin.settings.annotationColorMap||{},P=Object.entries(S);if(P.length||k.createEl("p",{text:"No color mappings configured."}),P.length){let F=k.createDiv({cls:"zrr-annotation-map-row-header"});F.createEl("span",{text:"Color"}),F.createEl("span",{text:"Heading"}),F.createEl("span",{text:"Callout"}),F.createEl("span")}for(let[F,q]of P){let O=k.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),$=O.createEl("input",{type:"text",value:F,cls:"zrr-annotation-map-input"}),U=O.createEl("input",{type:"text",value:(L=q.heading)!=null?L:"",cls:"zrr-annotation-map-input"}),H=O.createEl("input",{type:"text",value:(j=q.callout)!=null?j:"",cls:"zrr-annotation-map-input"}),M=O.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});M.type="button",$.addEventListener("change",async()=>{let z=$.value.trim().toLowerCase();if(!z){$.value=F;return}let B={...this.plugin.settings.annotationColorMap||{}};if(z!==F&&B[z]){new T.Notice(`Annotation color '${z}' already exists.`),$.value=F;return}let Z=B[F];delete B[F],B[z]=Z!=null?Z:{heading:"",callout:""},await b(B),w()}),U.addEventListener("change",async()=>{var Z;let z={...this.plugin.settings.annotationColorMap||{}},B=(Z=z[F])!=null?Z:{heading:"",callout:""};B.heading=U.value.trim(),z[F]=B,await b(z)}),H.addEventListener("change",async()=>{var Z;let z={...this.plugin.settings.annotationColorMap||{}},B=(Z=z[F])!=null?Z:{heading:"",callout:""};B.callout=H.value.trim(),z[F]=B,await b(z)}),M.addEventListener("click",async()=>{let z={...this.plugin.settings.annotationColorMap||{}};delete z[F],await b(z),w()})}let N=k.createDiv({cls:"zrr-annotation-map-actions"}),R=N.createEl("button",{text:"Add mapping"});R.type="button",R.addEventListener("click",async()=>{let F={...this.plugin.settings.annotationColorMap||{}},q="new-color",V=1;for(;F[q];)q=`new-color-${V}`,V+=1;F[q]={heading:"",callout:""},await b(F),w()});let I=N.createEl("button",{text:"Reset to defaults"});I.type="button",I.addEventListener("click",async()=>{await b({...Be.annotationColorMap}),w()})};w()}},{id:"ocr",label:"OCR",render:h=>{h.createEl("h2",{text:"Docling"});let k=null,b=N=>{if(!k)return;let R=this.plugin.settings.ocrEngine;new Set(N.map(L=>L.value)).has(R)||(N=N.concat([{value:R,label:`Current (unavailable): ${R}`}])),k.selectEl.options.length=0;for(let L of N)k.addOption(L.value,L.label);k.setValue(R)},w=async()=>{if(!k)return;k.setDisabled(!0);let N={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{N=await this.plugin.detectOcrEngines()}catch(L){N={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let R=[{value:"auto",label:"Auto (default)"}];N.tesseract&&R.push({value:"tesseract",label:"Tesseract (local)"}),N.paddleStructureLocal&&R.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),N.paddleVlLocal&&R.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(R.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),R.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),b(R),k.setDisabled(!1)},S=new T.Setting(h).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),P=document.createElement("a");P.href="https://aistudio.baidu.com/paddleocr",P.textContent="https://aistudio.baidu.com/paddleocr",P.target="_blank",P.rel="noopener noreferrer",S.descEl.appendChild(P),S.descEl.append("."),S.addText(N=>{i(N),N.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async R=>{this.plugin.settings.paddleApiKey=R.trim(),await this.plugin.saveSettings(),await w()})}),new T.Setting(h).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(N=>N.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async R=>{this.plugin.settings.paddleVlApiUrl=R.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(N=>N.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async R=>{this.plugin.settings.paddleStructureApiUrl=R.trim(),await this.plugin.saveSettings(),await w()})),new T.Setting(h).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(N=>{k=N,N.addOption("auto","Auto (default)"),N.setValue(this.plugin.settings.ocrEngine),N.onChange(async R=>{this.plugin.settings.ocrEngine=R,await this.plugin.saveSettings()})}),new T.Setting(h).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(N=>N.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async R=>{this.plugin.settings.ocrMode=R,await this.plugin.saveSettings()})),new T.Setting(h).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(N=>N.setValue(this.plugin.settings.forcePerPageOcr).onChange(async R=>{this.plugin.settings.forcePerPageOcr=R,await this.plugin.saveSettings()})),new T.Setting(h).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(N=>{N.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async R=>{this.plugin.settings.ocrQualityThreshold=R,await this.plugin.saveSettings()})}),new T.Setting(h).setName("Chunking").setDesc("page or section").addDropdown(N=>N.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async R=>{this.plugin.settings.chunkingMode=R,await this.plugin.saveSettings()})),w()}},{id:"llms",label:"LLMs",render:h=>{h.createEl("h2",{text:"LLM Provider Profiles"});let k=h.createDiv({cls:"zrr-llm-profiles"}),b=()=>{k.empty();let A=t();A.length||k.createEl("p",{text:"No profiles yet. Add one below."});for(let C of A){let D=k.createEl("details",{cls:"zrr-profile"});A.length===1&&(D.open=!0);let te=D.createEl("summary",{text:C.name||C.id||"Profile"});te.addClass("zrr-profile-title");let qe=D.createDiv({cls:"zrr-profile-body"});new T.Setting(qe).setName("Profile name").addText(ue=>ue.setPlaceholder("My provider").setValue(C.name||"").onChange(async ge=>{C.name=ge.trim(),te.textContent=C.name||C.id||"Profile",await n(t())})),new T.Setting(qe).setName("Base URL").addText(ue=>ue.setPlaceholder("http://localhost:1234/v1").setValue(C.baseUrl||"").onChange(async ge=>{C.baseUrl=ge.trim(),await n(t())})),new T.Setting(qe).setName("API key").setDesc("Stored in settings (not encrypted).").addText(ue=>{i(ue),ue.setPlaceholder("sk-...").setValue(C.apiKey||"").onChange(async ge=>{C.apiKey=ge.trim(),await n(t())})}),new T.Setting(qe).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(ue=>ue.setButtonText("Delete profile").onClick(async()=>{let ge=t().filter(pn=>pn.id!==C.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===C.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===C.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===C.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(ge),b()}))}new T.Setting(k).addButton(C=>C.setButtonText("Add profile").onClick(async()=>{let D=`profile-${Date.now().toString(36)}`,te=t().concat([{id:D,name:"Custom",baseUrl:"",apiKey:""}]);await n(te),b()}))};b(),h.createEl("h2",{text:"OCR cleanup"}),new T.Setting(h).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(A=>A.setValue(this.plugin.settings.enableLlmCleanup).onChange(async C=>{this.plugin.settings.enableLlmCleanup=C,await this.plugin.saveSettings()}));let w=null,S=null,P=null,N=async()=>{},R=async(A,C=!0)=>{let D=A.trim();this.plugin.settings.llmCleanupBaseUrl=D,C&&(this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom")),S&&S.setValue(D),await this.plugin.saveSettings()},I=async A=>{let C=t().find(D=>D.id===A);this.plugin.settings.llmCleanupProviderProfileId=A,C&&(this.plugin.settings.llmCleanupBaseUrl=C.baseUrl,this.plugin.settings.llmCleanupApiKey=C.apiKey,S==null||S.setValue(C.baseUrl),P==null||P.setValue(C.apiKey)),await this.plugin.saveSettings(),await N()};new T.Setting(h).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{w=A,A.addOption("custom","Custom (manual)");for(let D of t())A.addOption(D.id,D.name||D.id);let C=this.plugin.settings.llmCleanupProviderProfileId;A.setValue(C&&t().some(D=>D.id===C)?C:"custom"),A.onChange(async D=>{if(D==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await I(D)})}),new T.Setting(h).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(A=>{S=A,A.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async C=>{await R(C)})}),new T.Setting(h).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(A=>{P=A,i(A),A.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async C=>{this.plugin.settings.llmCleanupApiKey=C.trim(),this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom"),await this.plugin.saveSettings()})});let L=new T.Setting(h).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),j=null,F=A=>{if(!j)return;let C=(this.plugin.settings.llmCleanupModel||"").trim(),D=new Set(A.map(te=>te.value));C&&!D.has(C)&&(A=A.concat([{value:C,label:`Custom (${C})`}])),j.selectEl.options.length=0;for(let te of A)j.addOption(te.value,te.label);C&&j.setValue(C)};N=async()=>{if(j){j.setDisabled(!0);try{let A=await this.plugin.fetchCleanupModelOptions();F(A)}finally{j.setDisabled(!1)}}},L.addDropdown(A=>{j=A;let C=(this.plugin.settings.llmCleanupModel||"").trim();A.addOption(C||"loading","Loading..."),A.setValue(C||"loading"),A.onChange(async D=>{this.plugin.settings.llmCleanupModel=D.trim(),await this.plugin.saveSettings()})}),L.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await N()})}),N(),new T.Setting(h).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(A=>A.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async C=>{let D=Number.parseFloat(C);this.plugin.settings.llmCleanupTemperature=Number.isFinite(D)?D:0,await this.plugin.saveSettings()})),new T.Setting(h).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(A=>A.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async C=>{this.plugin.settings.llmCleanupMinQuality=C,await this.plugin.saveSettings()})),new T.Setting(h).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(A=>A.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(D)?D:2e3,await this.plugin.saveSettings()})),h.createEl("h2",{text:"Text Embedding"});let q=null,V=null,O=null,$=async()=>{},U=async(A,C=!0)=>{let D=A.trim();this.plugin.settings.embedBaseUrl=D,C&&(this.plugin.settings.embedProviderProfileId="",q&&q.setValue("custom")),V&&V.setValue(D),await this.plugin.saveSettings()},H=async A=>{let C=t().find(D=>D.id===A);this.plugin.settings.embedProviderProfileId=A,C&&(this.plugin.settings.embedBaseUrl=C.baseUrl,this.plugin.settings.embedApiKey=C.apiKey,V==null||V.setValue(C.baseUrl),O==null||O.setValue(C.apiKey)),await this.plugin.saveSettings(),await $()};new T.Setting(h).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{q=A,A.addOption("custom","Custom (manual)");for(let D of t())A.addOption(D.id,D.name||D.id);let C=this.plugin.settings.embedProviderProfileId;A.setValue(C&&t().some(D=>D.id===C)?C:"custom"),A.onChange(async D=>{if(D==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await H(D)})}),new T.Setting(h).setName("Embeddings base URL").addText(A=>{V=A,A.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async C=>{await U(C)})}),new T.Setting(h).setName("Embeddings API key").addText(A=>{O=A,i(A),A.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async C=>{this.plugin.settings.embedApiKey=C.trim(),this.plugin.settings.embedProviderProfileId="",q&&q.setValue("custom"),await this.plugin.saveSettings()})});let M=new T.Setting(h).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),z=null,B=A=>{if(!z)return;let C=(this.plugin.settings.embedModel||"").trim(),D=new Set(A.map(te=>te.value));C&&!D.has(C)&&(A=A.concat([{value:C,label:`Custom (${C})`}])),z.selectEl.options.length=0;for(let te of A)z.addOption(te.value,te.label);C&&z.setValue(C)};$=async()=>{if(z){z.setDisabled(!0);try{let A=await this.plugin.fetchEmbeddingModelOptions();B(A)}finally{z.setDisabled(!1)}}},M.addDropdown(A=>{z=A;let C=(this.plugin.settings.embedModel||"").trim();A.addOption(C||"loading","Loading..."),A.setValue(C||"loading"),A.onChange(async D=>{this.plugin.settings.embedModel=D.trim(),await this.plugin.saveSettings()})}),M.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await $()})}),$(),new T.Setting(h).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(A=>A.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async C=>{this.plugin.settings.embedIncludeMetadata=C,await this.plugin.saveSettings()})),new T.Setting(h).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(A=>A.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.embedContextWindow=Number.isFinite(D)?Math.max(0,D):1,await this.plugin.saveSettings()})),new T.Setting(h).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(A=>A.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.embedContextChars=Number.isFinite(D)?Math.max(0,D):220,await this.plugin.saveSettings()})),new T.Setting(h).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(A=>A.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(D)?Math.max(0,D):3500,await this.plugin.saveSettings()})),new T.Setting(h).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(A=>A.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(D)?Math.max(0,D):200,await this.plugin.saveSettings()})),new T.Setting(h).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(A=>A.setValue(this.plugin.settings.enableChunkTagging).onChange(async C=>{this.plugin.settings.enableChunkTagging=C,await this.plugin.saveSettings()})),h.createEl("h2",{text:"Chat LLM"});let Z=null,G=null,re=null,pe=async()=>{},ye=async(A,C=!0)=>{let D=A.trim();this.plugin.settings.chatBaseUrl=D,C&&(this.plugin.settings.chatProviderProfileId="",Z&&Z.setValue("custom")),G&&G.setValue(D),await this.plugin.saveSettings()},be=async A=>{let C=t().find(D=>D.id===A);this.plugin.settings.chatProviderProfileId=A,C&&(this.plugin.settings.chatBaseUrl=C.baseUrl,this.plugin.settings.chatApiKey=C.apiKey,G==null||G.setValue(C.baseUrl),re==null||re.setValue(C.apiKey)),await this.plugin.saveSettings(),await pe()};new T.Setting(h).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{Z=A,A.addOption("custom","Custom (manual)");for(let D of t())A.addOption(D.id,D.name||D.id);let C=this.plugin.settings.chatProviderProfileId;A.setValue(C&&t().some(D=>D.id===C)?C:"custom"),A.onChange(async D=>{if(D==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await be(D)})}),new T.Setting(h).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(A=>{G=A,A.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async C=>{await ye(C)})}),new T.Setting(h).setName("Chat API key").addText(A=>{re=A,i(A),A.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async C=>{this.plugin.settings.chatApiKey=C.trim(),this.plugin.settings.chatProviderProfileId="",Z&&Z.setValue("custom"),await this.plugin.saveSettings()})});let Me=new T.Setting(h).setName("Chat model").setDesc("Select a chat-capable model from the provider."),le=null,lt=A=>{if(!le)return;let C=(this.plugin.settings.chatModel||"").trim(),D=new Set(A.map(te=>te.value));C&&!D.has(C)&&(A=A.concat([{value:C,label:`Custom (${C})`}])),le.selectEl.options.length=0;for(let te of A)le.addOption(te.value,te.label);C&&le.setValue(C)};pe=async()=>{if(le){le.setDisabled(!0);try{let A=await this.plugin.fetchChatModelOptions();lt(A)}finally{le.setDisabled(!1)}}},Me.addDropdown(A=>{le=A;let C=(this.plugin.settings.chatModel||"").trim();A.addOption(C||"loading","Loading..."),A.setValue(C||"loading"),A.onChange(async D=>{this.plugin.settings.chatModel=D.trim(),await this.plugin.saveSettings()})}),Me.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await pe()})}),pe(),new T.Setting(h).setName("Temperature").addText(A=>A.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async C=>{let D=Number.parseFloat(C);this.plugin.settings.chatTemperature=Number.isFinite(D)?D:.2,await this.plugin.saveSettings()})),new T.Setting(h).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(A=>A.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(D)?Math.max(0,D):6,await this.plugin.saveSettings()})),new T.Setting(h).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(A=>A.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async C=>{this.plugin.settings.chatPaneLocation=C,await this.plugin.saveSettings()})),h.createEl("h2",{text:"Retrieval"}),new T.Setting(h).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(A=>A.setValue(this.plugin.settings.enableAgenticRag).onChange(async C=>{this.plugin.settings.enableAgenticRag=C,await this.plugin.saveSettings()})),new T.Setting(h).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(A=>A.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.agenticMaxIters=Number.isFinite(D)?Math.max(1,D):2,await this.plugin.saveSettings()})),new T.Setting(h).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(A=>A.setValue(this.plugin.settings.enableQueryExpansion).onChange(async C=>{this.plugin.settings.enableQueryExpansion=C,await this.plugin.saveSettings()})),new T.Setting(h).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(A=>A.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.queryExpansionCount=Number.isFinite(D)?Math.max(1,D):3,await this.plugin.saveSettings()})),new T.Setting(h).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(A=>A.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async C=>{this.plugin.settings.enableCrossEncoderRerank=C,await this.plugin.saveSettings()}));let J=new Set(Ft.map(A=>A.value)),X=(this.plugin.settings.rerankModel||"").trim()||we,xe=J.has(X)?X:Se,se=null,vt=()=>{if(!se)return;let C=!(xe===Se);se.setDisabled(C),se.inputEl.disabled=C,se.inputEl.readOnly=C,se.inputEl.classList.toggle("is-disabled",C),se.inputEl.setAttribute("aria-disabled",String(C))},Pt=new T.Setting(h).setName("Cross-encoder model").setDesc("Choose a multilingual preset, or select Custom to edit the model id.");Pt.addDropdown(A=>{for(let C of Ft)A.addOption(C.value,C.label);A.addOption(Se,"Custom"),A.setValue(xe),A.onChange(async C=>{xe=C,C!==Se?this.plugin.settings.rerankModel=C:(this.plugin.settings.rerankModel||"").trim()||(this.plugin.settings.rerankModel=we),await this.plugin.saveSettings(),se==null||se.setValue(this.plugin.settings.rerankModel||we),vt()})}),Pt.addText(A=>{se=A,A.setPlaceholder(we).setValue(X).onChange(async C=>{xe===Se&&(this.plugin.settings.rerankModel=C.trim()||we,await this.plugin.saveSettings())}),vt()}),new T.Setting(h).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(A=>A.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(D)?Math.max(1,D):4,await this.plugin.saveSettings()})),new T.Setting(h).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(A=>A.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.rrfK=Number.isFinite(D)?Math.max(1,D):60,await this.plugin.saveSettings()})),new T.Setting(h).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(A=>A.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.rrfLogTop=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()})),new T.Setting(h).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(A=>A.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:h=>{h.createEl("h2",{text:"Python Runtime"}),new T.Setting(h).setName("Use local runtime (legacy)").setDesc("Switch to local interpreter/venv mode and enable advanced runtime settings.").addButton(k=>k.setButtonText("Switch").onClick(async()=>{await this.plugin.switchPythonRuntimeToLocalLegacy()})),h.createEl("h2",{text:"Logging"}),new T.Setting(h).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(k=>k.setValue(this.plugin.settings.enableFileLogging).onChange(async b=>{this.plugin.settings.enableFileLogging=b,await this.plugin.saveSettings()})),new T.Setting(h).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(k=>k.setPlaceholder(`${ne}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async b=>{this.plugin.settings.logFilePath=b.trim()||`${ne}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new T.Setting(h).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(k=>k.setButtonText("Open log").onClick(async()=>{var b,w;await((w=(b=this.plugin).openLogFile)==null?void 0:w.call(b))})).addButton(k=>k.setButtonText("Clear log").onClick(async()=>{var b,w;await((w=(b=this.plugin).clearLogFile)==null?void 0:w.call(b))})),h.createEl("h2",{text:"Zotero Companion Plugin"}),h.createEl("p",{text:"Download the XPI, then in Zotero go to Tools \u2192 Add-ons \u2192 Install from File and restart."}),new T.Setting(h).setName("Download companion add-on").setDesc("Downloads the companion XPI to your system Downloads folder.").addButton(k=>k.setButtonText("Download XPI").onClick(async()=>{let b=this.getDefaultDownloadDir();if(!b){new T.Notice("Unable to resolve the system Downloads folder.");return}let w=Ue.default.join(b,"zrr-companion.xpi");if(await this.companionXpiExists(w)){new T.Notice(`Companion XPI already exists: ${w}`);return}new T.Notice("Downloading companion XPI..."),await this.downloadCompanionXpi(w)})),new T.Setting(h).setName("Open Zotero").setDesc("Launch Zotero and open the Add-ons window (Tools \u2192 Add-ons).").addButton(k=>k.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new T.Setting(h).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(k=>k.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),h.createEl("h2",{text:"Redis Indexing"}),new T.Setting(h).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(k=>k.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new T.Setting(h).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(k=>k.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(k=>k.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()})),h.createEl("h2",{text:"Release Notes"}),new T.Setting(h).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(k=>k.setButtonText("Show").onClick(async()=>{await this.plugin.openReleaseNotesModal()}))}}],_=new Map,p=new Map,f=h=>{this.activeTab=h;for(let[k,b]of _){let w=k===h;b.classList.toggle("is-active",w),b.setAttribute("aria-selected",w?"true":"false"),b.setAttribute("tabindex",w?"0":"-1")}for(let[k,b]of p){let w=k===h;b.classList.toggle("is-active",w),b.hidden=!w}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let x=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let h of d){let k=y.createEl("button",{text:h.label,cls:"zrr-settings-tab-button"}),b=`zrr-settings-tab-${h.id}`,w=`zrr-settings-panel-${h.id}`;k.type="button",k.id=b,k.setAttribute("role","tab"),k.setAttribute("aria-controls",w),k.setAttribute("aria-selected","false"),k.addEventListener("click",()=>f(h.id));let S=x.createDiv({cls:"zrr-settings-tab-panel"});S.id=w,S.setAttribute("role","tabpanel"),S.setAttribute("aria-labelledby",b),S.hidden=!0,h.render(S),_.set(h.id,k),p.set(h.id,S)}let v=d.some(h=>h.id===this.activeTab)?this.activeTab:d[0].id;f(v)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Ue.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await Ve.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await Ve.promises.mkdir(Ue.default.dirname(e),{recursive:!0});let t=await(0,T.requestUrl)({url:wn,method:"GET"});if(t.status!==200){new T.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await Ve.promises.writeFile(e,n),new T.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new T.Notice("Failed to download companion XPI. See console for details."),console.warn("Failed to download companion XPI",t)}}};var jt=require("@codemirror/state"),$t=require("@codemirror/view"),de=require("obsidian");var vn=g=>{let u=g.scrollDOM.getBoundingClientRect(),e=g.posAtCoords({x:u.left+8,y:+u.height*.25});return e===null?null:g.state.doc.lineAt(e).number},Ge=class{constructor(u,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=u,this.helpers=e}createSyncExtension(){let u=this,e=this.helpers;return $t.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=e.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=e.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var _,p;let i=this.docId;if(!i)return;let r=vn(t);if(r===null)return;let a=e.findChunkStartLineInDoc(t.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(_=s==null?void 0:s.pageNumber)!=null?_:null,l=(p=s==null?void 0:s.chunkId)!=null?p:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||d)||(this.lastPage=o,this.lastChunkId=l,u.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,t;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((t=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:t.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let u=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(u.docId,u.pageNumber,u.chunkId)}updatePreviewScrollHandler(){var n;let u=this.deps.app.workspace.getActiveViewOfType(de.MarkdownView);if(!u||u.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=u.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(u);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(u)}async syncPdfSidebarForFile(u){try{let e=await this.deps.app.vault.read(u),t=await this.deps.resolveDocIdForNote(u,e);if(!t)return;let n=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(t,n==null?void 0:n.pageNumber,n==null?void 0:n.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(u,e,t){if(u){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:u,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let n=await this.deps.getDocIndexEntry(u);n||(n=await this.deps.hydrateDocIndexFromCache(u));let i=n!=null&&n.pdf_path?String(n.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let d=(0,de.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(d)instanceof de.TFile&&(r=d)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof de.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&t&&(o=await this.resolvePageNumberForChunk(u,t)),o===null||this.pdfSidebarDocId===u&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=u,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,c=o!==null?`${l}#page=${o}`:l;await this.openPdfLinkInLeaf(s,c),this.updatePdfSidebarIcon(s)}finally{this.pdfSyncInFlight=!1;let n=this.queuedPdfSync;this.queuedPdfSync=null,n&&this.syncPdfSidebarForDoc(n.docId,n.pageNumber,n.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(u){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(u)}))}syncPdfSidebarForPreview(u){let e=this.previewScrollEl;if(!e)return;let t=u.getViewData();if(!t)return;let n=jt.Text.of(t.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(n);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(n,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(u){var n;let e=u.getBoundingClientRect().top,t=u.querySelectorAll("[data-line]");for(let i of Array.from(t))if(i.getBoundingClientRect().bottom>=e+2){let a=(n=i.getAttribute("data-line"))!=null?n:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var n,i;if(this.pdfSidebarLeaf&&((i=(n=this.pdfSidebarLeaf.view)==null?void 0:n.getViewType)==null?void 0:i.call(n))==="pdf")return this.pdfSidebarLeaf;let u=this.deps.app.workspace;if(typeof u.ensureSideLeaf=="function")try{let r=await u.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let t=this.deps.app.workspace.getRightLeaf(!0);return t&&this.isRightSidebarLeaf(t)?(this.pdfSidebarLeaf=t,this.updatePdfSidebarIcon(t),t):null}isRightSidebarLeaf(u){if(!u)return!1;let t=u.containerEl;return!!(t!=null&&t.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(u){if(!u||!this.isRightSidebarLeaf(u))return;let t=u.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let i=u;if(i.tabHeaderEl&&n.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&n.push(i.tabHeaderInnerIconEl),n.length===0)return;let r=new Set;for(let s of n)r.has(s)||(r.add(s),s.innerHTML="",(0,de.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=u.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(u,e){var r,a,s;let t=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],n=(s=(a=t==null?void 0:t.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof n=="function")try{await n.call(t.lib.workspace,u,e,"",{active:!1});return}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150)}let i=u;if(typeof i.openLinkText=="function"){try{await i.openLinkText(e,"",{active:!1})}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150),await i.openLinkText(e,"",{active:!1})}return}await this.deps.app.workspace.openLinkText(e,"",!1)}isPdfAnnotationRaceError(u){let e=u instanceof Error?u.message:String(u!=null?u:"");return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(u){return new Promise(e=>setTimeout(e,u))}getPluginsRegistry(){var u;return(u=this.deps.app.plugins)==null?void 0:u.plugins}isLeafTabActive(u){var i;let e=u;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===u;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(u,e){var l,c,d,_,p;if(!u||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,u)||e,n=this.chunkPageCache.get(u);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let i=(0,de.normalizePath)(`${Q}/${u}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let f of s){let y=typeof(f==null?void 0:f.chunk_id)=="string"?f.chunk_id.trim():"";if(!y)continue;let x=Number.isFinite((c=f==null?void 0:f.page_start)!=null?c:NaN)?Number(f.page_start):null,v=Number.isFinite((d=f==null?void 0:f.page_end)!=null?d:NaN)?Number(f.page_end):null,h=x!=null?x:v;h!==null&&(o.set(y,h),o.set(`${u}:${y}`,h))}return this.chunkPageCache.set(u,o),(p=(_=o.get(t))!=null?_:o.get(e))!=null?p:null}};var We={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.6
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.6
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.6
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.6
...
`).trim()}getBundledReleaseNotesEntries(){var i,r;let e=new Set,t=Array.isArray(bt)?bt:[],n=[];for(let a of t){let s=this.normalizeReleaseVersion(String((i=a==null?void 0:a.version)!=null?i:"")),o=this.sanitizeReleaseNotesMarkdown(String((r=a==null?void 0:a.markdown)!=null?r:""));!s||e.has(s)||(e.add(s),n.push({version:s,markdown:o}))}return n.sort((a,s)=>this.compareReleaseVersions(s.version,a.version))}getReleaseNotesMarkdown(e,t){let n=this.normalizeReleaseVersion(e);if(!n)return"";let i=this.normalizeReleaseVersion(t||""),r=this.getBundledReleaseNotesEntries(),a=r.filter(o=>this.compareReleaseVersions(o.version,n)>0?!1:i?this.compareReleaseVersions(o.version,i)>0:o.version===n),s=a.length?a:r.filter(o=>o.version===n);if(!s.length)return"This version includes improvements and fixes.";if(s.length===1){let o=s[0],l=this.stripLeadingVersionHeading(this.sanitizeReleaseNotesMarkdown(String(o.markdown||"")),o.version);return`### v${o.version}
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,t=1200){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},t);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,t=1200,n="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,n)},t);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,t=1200,n="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,n)},t);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let t=this.annotationNoteEditTimes.get(e);if(!t)return 0;let n=Date.now()-t;return n>=on?0:on-n}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let t=(e.annotation_page_label||"").trim();if(t)return t;let n=e.page_start?String(e.page_start):"",i=e.page_end?String(e.page_end):"";if(n&&(!i||n===i))return n;if(n&&i)return`${n} - ${i}`;let r=(e.pages||"").trim();if(!r)return"?";let a=r.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:r.replace("-"," - ")}normalizeChunkIdForNote(e,t){if(!e)return null;let n=String(e);if(t&&n.startsWith(`${t}:`))return n.slice(t.length+1);if(n.includes(":")){let i=n.split(":");if(i.length>1&&t&&i[0]===t)return i.slice(1).join(":")}return n}async syncNoteToRedis(e){var t,n,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,m.normalizePath)(`${Q}/${s}.json`),c=this.app.vault.adapter;if(!await c.exists(l))return;let d=await this.readChunkPayload(l);if(!d)return;let _=Array.isArray(d.chunks)?d.chunks:[],p=new Map;for(let b of _){if(this.isAnnotationChunk(b))continue;let w=typeof(b==null?void 0:b.chunk_id)=="string"?b.chunk_id:String((t=b==null?void 0:b.chunk_id)!=null?t:"");w&&p.set(w,b)}let f=new Set,y=new Set,x=new Set,v=new Set,h=!1;for(let b of o){let w=b.chunkId;if(!w)continue;f.add(w);let S=p.get(w);if(!S){console.warn(`Sync note: chunk id not found in cache (${w})`);continue}if(b.excludeFlag){S.excluded!==!0&&(S.excluded=!0,h=!0);let R=this.normalizeChunkText(b.text);R&&R!==String((n=S.text)!=null?n:"")&&(S.text=R,S.char_count=R.length,h=!0),x.add(w);continue}if(S.excluded&&(S.excluded=!1,h=!0,y.add(w)),!b.text.trim()){x.add(w),v.add(w);continue}let P=this.normalizeChunkText(b.text);if(!P){x.add(w),v.add(w);continue}let N=typeof S.text=="string"?S.text:String((i=S.text)!=null?i:"");P!==N&&(S.text=P,S.char_count=P.length,y.add(w),h=!0)}for(let b of p.keys())f.has(b)||(x.add(b),v.add(b));let k=new Set([...x,...v]);if(k.size){let b=Array.from(k).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==b){this.noteSyncPendingDeletes.set(e.path,b),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!y.size&&!x.size&&!v.size&&!h)return;v.size&&(d.chunks=_.filter(b=>{var S;let w=typeof(b==null?void 0:b.chunk_id)=="string"?b.chunk_id:String((S=b==null?void 0:b.chunk_id)!=null?S:"");return w&&!v.has(w)}),h=!0),(h||v.size)&&await c.write(l,JSON.stringify(d,null,2)),await this.reindexChunkUpdates(s,l,Array.from(y),Array.from(x)),(x.size||v.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,t){var n,i,r;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,t);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),s=await this.resolveDocIdForNote(e,a);if(!s)return;let o=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter;if(!o)return;let l=this.resolveZoteroItemKey(o,s);if(!l)return;let c=await this.fetchZoteroItem(l),d=(i=c==null?void 0:c.data)!=null?i:c;if(!d||typeof d!="object")return;let _=this.extractNoteMetadata(o),p=this.extractZoteroMetadata(d);p.citekey||(p.citekey=await this.resolveZoteroCitekey(d,l,c==null?void 0:c.meta));let f=await this.getMetadataSnapshot(s,o,e),y={},x={},v={},h=[],k=["title","short_title","citekey","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],b={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},w=Object.fromEntries(k.map(R=>[R,this.hasFrontmatterKey(o,b[R])])),S=new Set(["title","short_title","citekey","date","abstract","doi","publisher","place","issue","volume","pages","item_type","authors","editors"]),P=k.filter(R=>w[R]||!this.isMetadataValueEmpty(_[R])||!this.isMetadataValueEmpty(p[R]));if(!P.length)return;let N={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let R of P){let I=_[R],L=p[R];if(this.metadataValuesEqual(R,I,L))continue;let j=this.isMetadataValueEmpty(I),F=this.isMetadataValueEmpty(L),q=f==null?void 0:f[R];if(q===void 0){if(j&&!F){v[R]="zotero",this.assignMetadataUpdate(y,R,L);continue}if(!j&&F&&S.has(R)){v[R]="note",this.assignMetadataUpdate(x,R,I);continue}}if(q!==void 0){let O=!this.metadataValuesEqual(R,I,q),$=!this.metadataValuesEqual(R,L,q);if(O&&!$){v[R]="note",this.assignMetadataUpdate(x,R,I);continue}if(!O&&$){v[R]="zotero",this.assignMetadataUpdate(y,R,L);continue}}let V=this.getMetadataDecisionLabels(R,I,L,N);h.push({field:R,fieldLabel:N[R],noteLabel:V.noteLabel,zoteroLabel:V.zoteroLabel,noteValue:this.formatMetadataValue(I),zoteroValue:this.formatMetadataValue(L)})}if(h.length>0){let R=await this.promptMetadataBatchDecision(h);for(let I of h){let L=(r=R[I.field])!=null?r:"skip";v[I.field]=L,L==="note"?this.assignMetadataUpdate(x,I.field,_[I.field]):L==="zotero"&&this.assignMetadataUpdate(y,I.field,p[I.field])}}Object.keys(y).length>0&&await this.applyNoteMetadataUpdates(e,y),Object.keys(x).length>0&&await this.applyZoteroMetadataUpdates(l,d,_,p,x),await this.updateMetadataSnapshot(e,s,_,p,f,v,P)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,t)}}async syncNoteAnnotationsWithZotero(e,t){var n,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,t);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let q=this.ensureDocIdInNoteContent(o,d);q!==o&&await this.writeNoteWithSyncSuppressed(e.path,q)}if(!d)return;let _=(i=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter)!=null?i:{},p=(r=c.attachmentKey)!=null?r:"";if(p||(p=await this.resolveAttachmentKeyForDocId(d,_)),!p)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===p&&await this.updateDocIndex({doc_id:d,attachment_key:p});let f=p,y=await this.fetchZoteroAnnotationsForDoc(d,p),x=y.annotations;p=y.attachmentKey,p&&p!==f&&await this.updateDocIndex({doc_id:d,attachment_key:p});let v=this.parseAnnotationBlock(l.block,p),h=new Map;for(let q of v)q.key&&q.imagePath&&h.set(q.key,{path:q.imagePath,hash:q.imageHash||this.extractAnnotationImageHashFromPath(q.imagePath)});await this.attachAnnotationImages(d,p,x,e.path,h);let k=new Map;for(let q of v)q.key&&k.set(q.key,q);let b=new Map;for(let q of x)b.set(q.key,q);let w=await this.getAnnotationSnapshot(d),S=(a=w==null?void 0:w.annotations)!=null?a:{},P={},N=[],R=!1,I=!1,L=!1;p&&p!==f&&x.length>0&&(I=!0,L=!0);for(let[q,V]of b.entries()){let O=k.get(q);if(!O){I=!0;continue}let $=S[q],U=this.annotationSnapshotFromEntry(O,V.annotationType),H=this.annotationSnapshotFromEntry(V,V.annotationType),M=(U.image_hash||"")!==(H.image_hash||"");if(!$){this.annotationSnapshotsEqualIgnoringImage(U,H)?M&&(I=!0,L=!0):(P[q]="note",R=!0);continue}let z=!this.annotationSnapshotsEqual(U,$),B=!this.annotationSnapshotsEqual(H,$),Z=(H.color_key||"")!==($.color_key||""),G=!this.annotationSnapshotsEqualIgnoringImage(U,$),re=!this.annotationSnapshotsEqualIgnoringImage(H,$);G&&!re?(P[q]="note",R=!0):!G&&re?(P[q]="zotero",I=!0):G&&re&&N.push({key:q,title:this.formatAnnotationConflictTitle(V),noteValue:this.formatAnnotationConflictValue(U,O.tags),zoteroValue:this.formatAnnotationConflictValue(H,V.tags)}),M&&(z||B)&&(I=!0,L=!0),Z&&(I=!0,L=!0)}if(N.length>0){let q=await this.promptAnnotationBatchDecision(N);for(let V of N){let O=(s=q[V.key])!=null?s:"skip";P[V.key]=O,O==="note"?R=!0:O==="zotero"&&(I=!0,L=!0)}}let j=[];for(let[q,V]of Object.entries(P)){if(V!=="note")continue;let O=k.get(q),$=b.get(q);!O||!$||j.push({entry:$,note:O})}j.length>0&&await this.applyZoteroAnnotationUpdates(j),R&&this.annotationNoteEditTimes.set(e.path,Date.now());let F=this.getAnnotationGraceRemaining(e.path);if(I&&F>0&&R&&!L&&(this.scheduleNoteAnnotationSync(e,F+250,t),I=!1),I){let q=this.buildAnnotationBlock(d,p,x),V=this.replaceAnnotationBlock(o,q);if(V&&V!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,V)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,p,x),await this.updateAnnotationChunks(d,p,x)}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,t)}}resolveZoteroItemKey(e,t){let n=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),t];for(let i of n){let r=W(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,t){var l;if(!e)return"";let n=await this.getDocIndexEntry(e);if(n||(n=await this.hydrateDocIndexFromCache(e)),n!=null&&n.attachment_key)return n.attachment_key;let i=(0,m.normalizePath)(`${Q}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let d=await this.readChunkPayload(i),_=d!=null&&d.metadata&&typeof d.metadata=="object"?d.metadata:null,p=_==null?void 0:_.attachment_key;if(typeof p=="string"&&p.trim())return await this.updateDocIndex({doc_id:e,attachment_key:p.trim()}),p.trim()}}catch(c){}let r=this.resolveZoteroItemKey(t,e);if(!r)return"";let a=await this.fetchZoteroItem(r),s=(l=a==null?void 0:a.data)!=null?l:a;if(!s||typeof s!="object")return"";let o=await Te(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var v,h,k,b,w,S,P,N,R,I,L,j,F;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString((b=(k=(h=(v=e==null?void 0:e["short title"])!=null?v:e==null?void 0:e.short_title)!=null?h:e==null?void 0:e.shortTitle)!=null?k:e==null?void 0:e["short-title"])!=null?b:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString((N=(P=(S=(w=e==null?void 0:e.citekey)!=null?w:e==null?void 0:e["citation key"])!=null?S:e==null?void 0:e.citation_key)!=null?P:e==null?void 0:e.citationKey)!=null?N:e==null?void 0:e["citation-key"]),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString((R=e==null?void 0:e.abstract)!=null?R:e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((I=e==null?void 0:e.doi)!=null?I:e==null?void 0:e.DOI),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),_=this.normalizeMetadataString(e==null?void 0:e.pages),p=this.normalizeMetadataString((F=(j=(L=e==null?void 0:e["item type"])!=null?L:e==null?void 0:e.item_type)!=null?j:e==null?void 0:e.itemType)!=null?F:e==null?void 0:e["item-type"]),f=this.normalizeMetadataList(e==null?void 0:e.tags),y=this.normalizeMetadataList(e==null?void 0:e.authors),x=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:t,short_title:n,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:_,item_type:p,tags:this.sanitizeObsidianTags(f),authors:y,editors:x}}extractZoteroMetadata(e){var h,k,b;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString(Pe(e)),i=this.normalizeMetadataString(He(e)),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString(e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((h=e==null?void 0:e.DOI)!=null?h:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),_=this.normalizeMetadataString(e==null?void 0:e.pages),p=this.normalizeMetadataString((b=(k=e==null?void 0:e.itemType)!=null?k:e==null?void 0:e.item_type)!=null?b:e==null?void 0:e["item-type"]),f=Array.isArray(e==null?void 0:e.creators)?e.creators:[],y=f.filter(w=>(w==null?void 0:w.creatorType)==="author").map(w=>ve(w)).filter(Boolean),x=f.filter(w=>(w==null?void 0:w.creatorType)==="editor"||(w==null?void 0:w.creatorType)==="seriesEditor").map(w=>ve(w)).filter(Boolean),v=Array.isArray(e==null?void 0:e.tags)?e.tags.map(w=>typeof w=="string"?w:w==null?void 0:w.tag).filter(w=>typeof w=="string"):[];return{title:t,short_title:n,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:_,item_type:p,tags:this.sanitizeObsidianTags(v),authors:this.normalizeMetadataList(y),editors:this.normalizeMetadataList(x)}}async resolveZoteroCitekey(e,t,n){let i=this.normalizeMetadataString(He(e,n!=null?n:void 0));if(i)return i;if(!t)return"";let r=await this.fetchZoteroItemCsl(t);return this.normalizeMetadataString(gt(r))}extractAnnotationPageInfo(e){var a;let n=W((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:n,pageIndex:i}}extractAnnotationImagePayload(e){var a,s,o,l;let t=(s=(a=e.annotationImage)!=null?a:e.annotationImageData)!=null?s:e.annotationImageBase64;if(!t)return null;let n=null,i="";if(Buffer.isBuffer(t))n=t;else if(ArrayBuffer.isView(t))n=Buffer.from(t.buffer,t.byteOffset,t.byteLength);else if(t instanceof ArrayBuffer)n=Buffer.from(t);else if(typeof t=="string"){let c=t.trim();if(!c)return null;let d=c.match(/^data:([^;]+);base64,(.*)$/i);if(d&&(i=this.normalizeAnnotationImageMime(d[1]),c=d[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;n=Buffer.from(c,"base64")}if(!n||!n.length)return null;i||(i=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(n)||"image/png");let r=this.annotationImageExtensionFromMime(i)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(n))||"png";return{buffer:n,mime:i,ext:r}}parseZoteroAnnotationItem(e,t){var v,h,k,b;let n=(h=(v=e==null?void 0:e.data)!=null?v:e)!=null?h:{},i=W((k=e==null?void 0:e.key)!=null?k:n==null?void 0:n.key);if(!i)return null;let r=W(n.annotationType),a=this.normalizeAnnotationText(n.annotationText),s=this.normalizeAnnotationText(n.annotationComment),o=W(n.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:_,pageIndex:p}=this.extractAnnotationPageInfo(n),f=(b=n.annotationSortIndex)!=null?b:n.annotationSort,y=Number.isFinite(Number(f))?Number(f):0,x=Array.isArray(n.tags)?n.tags.map(w=>typeof w=="string"?w:w==null?void 0:w.tag).filter(w=>typeof w=="string"):[];return{key:i.trim(),attachmentKey:t,pageLabel:_,pageIndex:p,colorKey:l,callout:d,heading:c,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(x),sortIndex:y,rawValues:n}}async fetchZoteroAnnotations(e){if(!e)return[];let t=this.canUseWebApi()||await this.ensureWebApiLibraryId(),n=a=>{var o,l;let s=[];for(let c of a){let d=(l=(o=c==null?void 0:c.data)!=null?o:c)!=null?l:{};if(W(d.itemType)!=="annotation")continue;let _=this.parseZoteroAnnotationItem(c,e);_&&s.push(_)}return s},i=[];try{i=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(a){try{i=await this.fetchZoteroChildrenLocal(e)}catch(s){console.warn("Failed to fetch Zotero annotation items from local API",s)}}let r=n(i);if(!r.length&&t)try{let a=[];try{a=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(o){a=await this.fetchZoteroChildrenWeb(e)}let s=n(a);s.length&&(r=s)}catch(a){console.warn("Failed to fetch Zotero annotation items from Web API",a)}return r}async fetchZoteroAnnotationsForDoc(e,t){var o,l,c;let n=t,i=await this.fetchZoteroAnnotations(n);if(i.length||!e)return i.length||this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i};let r=[];try{r=await this.fetchZoteroChildren(e)}catch(d){return console.warn("Failed to fetch Zotero attachments for annotations",d),this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i}}let a=[],s=new Set(n?[n]:[]);for(let d of r){if(!ht(d))continue;let _=W((c=(l=d==null?void 0:d.key)!=null?l:(o=d==null?void 0:d.data)==null?void 0:o.key)!=null?c:d==null?void 0:d.attachmentKey);!_||s.has(_)||(s.add(_),a.push(_))}for(let d of a){let _=await this.fetchZoteroAnnotations(d);if(_.length)return{attachmentKey:d,annotations:_}}return this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i}}async attachAnnotationImages(e,t,n,i,r){var _;if(!this.settings.includeAnnotationImages||!n.length)return;let a=await this.resolveAnnotationImageOutputDir(i);if(!a)return;let s=this.sanitizeFileName(e||t)||"annotations",o=(0,m.normalizePath)(E.default.join(a.relative||"",s)),l=E.default.normalize(E.default.join(a.absolute,s));o?await this.ensureFolder(o):await Y.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,d=new Map;for(let p of n){let f=String(p.annotationType||"").trim().toLowerCase(),y=f==="image"||f==="ink",x=this.extractAnnotationImagePayload((_=p.rawValues)!=null?_:{});if(!x&&y&&this.settings.zoteroCompanionEnabled&&(x=await this.fetchCompanionAnnotationImage(p.key)),!x){let b=r==null?void 0:r.get(p.key);b!=null&&b.path&&await c.exists(b.path)&&(p.imagePath=b.path,p.imageHash=b.hash,d.set(p.key,b.path));continue}let v=(0,Fe.createHash)("sha1").update(x.buffer).digest("hex").slice(0,12),h=`zrr-annotation-${p.key}-${v}.${x.ext}`,k=(0,m.normalizePath)(E.default.join(o,h));try{await c.exists(k)||await c.writeBinary(k,this.bufferToArrayBuffer(x.buffer)),p.imagePath=k,p.imageHash=v,d.set(p.key,k)}catch(b){console.warn("Failed to write annotation image",{annotationKey:p.key,error:b})}}if(o&&await c.exists(o))try{let p=await c.list(o);for(let f of p.files){let x=E.default.basename(f).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!x)continue;let v=x[1].toUpperCase(),h=d.get(v);(!h||(0,m.normalizePath)(h)!==(0,m.normalizePath)(f))&&await c.remove(f)}}catch(p){console.warn("Failed to clean up annotation images",p)}}async fetchCompanionAnnotationImage(e){let t=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!t)return null;let n=`${t.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,i={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(i.Authorization=`Bearer ${r}`);try{let a=await this.requestLocalApiRaw(n,{headers:i,timeoutMs:5e3});if(a.statusCode===200){let s=a.headers["content-type"],o=Array.isArray(s)?s[0]:s!=null?s:"";return this.buildAnnotationImagePayloadFromBuffer(a.body,o)}if(a.statusCode===204||a.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:a.statusCode})}catch(a){console.warn("Failed to fetch annotation image from Zotero companion",a)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new m.Notice("Zotero companion base URL is not set.");return}let t=`${e.replace(/\/$/,"")}/health`,n={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(n.Authorization=`Bearer ${i}`);try{let r=await this.requestLocalApiRaw(t,{headers:n,timeoutMs:3e3});if(r.statusCode===200){try{let a=JSON.parse(r.body.toString("utf8"));if(a!=null&&a.ok){new m.Notice("Zotero companion: OK.");return}}catch(a){}new m.Notice("Zotero companion responded but did not return OK.");return}if(r.statusCode===401){new m.Notice("Zotero companion: unauthorized (check token).");return}new m.Notice(`Zotero companion: HTTP ${r.statusCode}.`)}catch(r){console.warn("Zotero companion health check failed",r),new m.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new m.Notice("Opened Zotero. Go to Tools \u2192 Add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new m.Notice("Unable to open Zotero automatically. Open Zotero and go to Tools \u2192 Add-ons.")}}async spawnDetached(e){let[t,...n]=e;if(!t)throw new Error("Missing command");await new Promise((i,r)=>{let a=!1,s=(0,ae.spawn)(t,n,{detached:!0,stdio:"ignore"});s.on("error",o=>{a||(a=!0,r(o))}),s.unref(),a||(a=!0,i())})}maybeWarnMissingAnnotationApi(e,t){if(this.canUseWebApi()){console.info("No Zotero annotations returned for attachment",{docId:e,attachmentKey:t});return}let n=e||t;!n||this.annotationWebApiWarned.has(n)||(this.annotationWebApiWarned.add(n),new m.Notice("Zotero annotations require Web API access. Configure the Web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
`).trim(),excludeFlag:r}),i="",r=!1,a=[])};for(let l of t){let c=l.match(_e);if(c){s();let d=(o=c[1])!=null?o:"",_=d.match(/id=([\"']?)([^\"'\s]+)\1/i),p=_?_[2].trim():"";if(!p)continue;i=p,r=/\bexclude\b/i.test(d)||/\bdelete\b/i.test(d),a=[];continue}if(je.test(l)){s();continue}if(i){if(Ee.test(l)){r=!0;continue}a.push(l)}}return s(),n}normalizeChunkText(e){return e.split(/\r?\n/).map(t=>t.replace(/\s+/g," ").trim()).filter((t,n,i)=>!(t===""&&i[n-1]==="")).join(`
...
${p}`:h)}let f=c!==null?r?` (${c})`:` page=${c}`:"",x=` id=${l}${r?" section":""}${f}${d?" exclude":""}`;a.push(`<!-- zrr:chunk${x} -->`),p&&a.push(p),a.push("<!-- zrr:chunk end -->"),a.push("")}return a[a.length-1]===""&&a.pop(),a.push("<!-- zrr:sync-end -->"),a.join(`
...
`)}async renderFrontmatter(e,t,n,i,r,a){var d;let s=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,t,n,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let t=e.split(/\r?\n/),n=[],i=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<t.length;){let l=t[o],c=l.match(i);if(!c){n.push(l),o+=1;continue}let d=c[1].trim(),_=c[2].trim();if(a.has(d)){n.push(l),o+=1;continue}if(!s(_)){n.push(l),o+=1;continue}let p=o+1,f=[];for(;p<t.length&&t[p].match(r);)f.push(t[p]),p+=1;if(f.length===0){for(o=p;o<t.length&&t[o].trim()==="";)o+=1;continue}let y=f.filter(x=>{let v=x.match(r);if(!v)return!1;let h=v[1].trim();return!s(h)});if(y.length>0&&n.push(l,...y),o=p,y.length===0)for(;o<t.length&&t[o].trim()==="";)o+=1}for(;n.length>0&&n[n.length-1].trim()==="";)n.pop();return n.join(`

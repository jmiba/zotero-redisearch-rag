"use strict";var kn=Object.create;var Ve=Object.defineProperty;var wn=Object.getOwnPropertyDescriptor;var vn=Object.getOwnPropertyNames;var Pn=Object.getPrototypeOf,Cn=Object.prototype.hasOwnProperty;var An=(y,u)=>{for(var e in u)Ve(y,e,{get:u[e],enumerable:!0})},Nt=(y,u,e,t)=>{if(u&&typeof u=="object"||typeof u=="function")for(let n of vn(u))!Cn.call(y,n)&&n!==e&&Ve(y,n,{get:()=>u[n],enumerable:!(t=wn(u,n))||t.enumerable});return y};var xe=(y,u,e)=>(e=y!=null?kn(Pn(y)):{},Nt(u||!y||!y.__esModule?Ve(e,"default",{value:y,enumerable:!0}):e,y)),En=y=>Nt(Ve({},"__esModule",{value:!0}),y);var tr={};An(tr,{default:()=>_t});module.exports=En(tr);var h=require("obsidian");var zt=require("@codemirror/state"),ie=require("@codemirror/view"),qt=require("obsidian");var ke=/<!--\s*zrr:sync-start[^>]*-->/i,Ae=/<!--\s*zrr:sync-end\s*-->/i,ye=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ze=/<!--\s*zrr:chunk\s+end\s*-->/i,Ne=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,Tt=y=>{let u=y.trim();if(!u.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(u)){let _=u.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:_?_[2]:void 0}}if(/^zrr:sync-end\b/i.test(u))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(u)){let _=u.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),g=u.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:_?_[2]:void 0,attachmentKey:g?g[2]:void 0}}if(/^zrr:annotations-end\b/i.test(u))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(u))return{type:"chunk-end"};let e=u.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let t=e[1]||"",n=t.match(/\bid=(["']?)([^"'\s]+)\1/i),r=n?n[2]:"",i=t.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=i?null:t.match(/\(\s*(\d+)\s*\)/),s=i?Number.parseInt(i[2],10):a?Number.parseInt(a[1],10):void 0,o=r.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,p=/\bexclude\b/i.test(t)||/\bdelete\b/i.test(t),d=/\bsection\b/i.test(t);return{type:"chunk-start",chunkId:r||void 0,excluded:p,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:d?"section":c?"page":"section"}},Be=y=>{var l;if(!y)return null;let u=y.match(ye);if(!u)return null;let e=u[1]||"",t=e.match(/\bid=(["']?)([^"'\s]+)\1/i),n=t?t[2].trim():void 0,r=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),i=r?null:e.match(/\(\s*(\d+)\s*\)/),a=r?Number.parseInt(r[2],10):i?Number.parseInt(i[1],10):void 0,s=n&&(l=ht(n))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:n,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Ge=y=>{for(let u=1;u<=y.lines;u+=1){let e=y.line(u).text;if(ke.test(e)){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i);return t?t[2].trim():null}}return null},mt=(y,u)=>{let e=u;for(;e>=1;e-=1){let t=y.line(e).text;if(ye.test(t))return{line:e,text:t};if(ke.test(t)||Ae.test(t))break}return null},Rn=(y,u)=>{for(let e=u;e<=y.lines;e+=1){let t=y.line(e).text;if(Ze.test(t))return e;if(Ae.test(t))break}return null},Dt=(y,u)=>{let e=mt(y,u);if(!e)return null;let t=Rn(y,e.line+1);return t===null||u<e.line||u>t?null:{startLine:e.line,endLine:t,text:e.text}},Ot=(y,u,e)=>{if(u>e)return!1;for(let t=u;t<=e;t+=1){let n=y.line(t).text;if(Ne.test(n))return!0}return!1},ht=y=>{var n;if(!y)return null;let e=(y.includes(":")&&(n=y.split(":").pop())!=null?n:y).match(/^p(\d+)$/i);if(!e)return null;let t=Number.parseInt(e[1],10);return Number.isFinite(t)?t:null};var It=y=>{if(!y)return null;let u=y.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return u?Be(u[0]):null};var Sn=(y,u)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),y.type==="sync-start"||y.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(y.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),y.type==="sync-start"?e.textContent=y.docId?`Redis Index Sync start - ${y.docId}`:"Redis Index Sync start":e.textContent="Redis index sync end",e;if(y.type==="annotations-start"||y.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),y.type==="annotations-start"){let t=y.docId?` - ${y.docId}`:"";e.textContent=`Zotero annotations start${t}`}else e.textContent="Zotero annotations end";return e}if(y.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=y.chunkKind==="page"?"Page end":"Section end",y.chunkKind&&e.classList.add(`zrr-sync-badge--${y.chunkKind}`),e;if(y.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),y.chunkKind&&e.classList.add(`zrr-sync-badge--${y.chunkKind}`),y.excluded&&e.classList.add("is-excluded"),y.pageNumber&&u>0)if(y.chunkKind==="section"){let t=y.chunkId?`Section ${y.chunkId}`:"Section";e.textContent=`${t} (p${y.pageNumber}/${u})`}else e.textContent=`Page ${y.pageNumber}/${u}`;else if(y.pageNumber)if(y.chunkKind==="section"){let t=y.chunkId?`Section ${y.chunkId}`:"Section";e.textContent=`${t} (p${y.pageNumber})`}else e.textContent=`Page ${y.pageNumber}`;else y.chunkId?e.textContent=`Section ${y.chunkId}`:e.textContent="Section";return y.excluded&&(e.textContent=`${e.textContent} - excluded`),e},ft=class extends ie.WidgetType{constructor(u,e,t,n,r){super(),this.plugin=u,this.docId=e,this.chunkId=t,this.startLine=n,this.excluded=r}eq(u){return this.docId===u.docId&&this.chunkId===u.chunkId&&this.startLine===u.startLine&&this.excluded===u.excluded}toDOM(){let u=document.createElement("span");u.className="zrr-chunk-toolbar",u.setAttribute("data-chunk-id",this.chunkId);let e=(c,p)=>{c.setAttribute("title",p),c.setAttribute("aria-label",p),c.setAttribute("data-tooltip-position","top")},t=(c,p,d)=>{let _=document.createElement("span");_.className="zrr-chunk-button-icon",(0,qt.setIcon)(_,p);let g=document.createElement("span");g.className="zrr-chunk-button-label",g.textContent=d,c.appendChild(_),c.appendChild(g)},n=document.createElement("button");n.type="button",n.className="zrr-chunk-button",t(n,"sparkles","Clean"),e(n,"Clean this chunk with the OCR cleanup model"),n.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),u.appendChild(n);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",t(r,"tag","Tags"),e(r,"Edit chunk tags"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),u.appendChild(r);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",t(i,"search","Indexed"),e(i,"Preview indexed chunk text"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),u.appendChild(i);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",t(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),u.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return t(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),u.appendChild(s),u}ignoreEvent(){return!0}},Ft=(y,u)=>{var f;let e=y.state.doc,t=Ge(e);if(!t)return ie.Decoration.none;let n=y.state.selection.main.head,r=e.lineAt(n).number,i=Dt(e,r);if(!i)return ie.Decoration.none;let a=i.text.match(ye);if(!a)return ie.Decoration.none;let s=((f=a[1])!=null?f:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return ie.Decoration.none;let l=o[2].trim();if(!l)return ie.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),p=Ot(e,i.startLine+1,i.endLine-1),d=c||p,_=e.line(i.startLine),g=ie.Decoration.widget({widget:new ft(u,t,l,i.startLine,d),side:1});return ie.Decoration.set([g.range(_.to)])},yt=class extends ie.WidgetType{constructor(u,e){super(),this.info=u,this.totalPages=e}toDOM(){var u;return(u=Sn(this.info,this.totalPages))!=null?u:document.createElement("span")}},Mt=y=>{var o,l;let u=y.dom.closest(".markdown-source-view");if(!u||!u.classList.contains("is-live-preview"))return ie.Decoration.none;let e=y.state.doc,t=new zt.RangeSetBuilder,n=[],r=[],i=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let p=e.line(c),d=p.text.match(/<!--\s*([^>]*)\s*-->/);if(!d)continue;let _=Tt(d[1]);_&&(_.type==="chunk-start"?(_.chunkKind=(o=_.chunkKind)!=null?o:_.pageNumber?"page":"section",_.pageNumber&&(i=!0),_.chunkKind==="section"&&(a=!0)):_.type==="chunk-end"&&(_.chunkKind=(l=_.chunkKind)!=null?l:"section"),n.push({line:c,from:p.from,to:p.to,info:_}),_.pageNumber&&r.push(_.pageNumber))}if(!n.length)return ie.Decoration.none;if(i&&!a)for(let c of n)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=r.length?Math.max(...r):0;for(let c of n){let p=ie.Decoration.replace({widget:new yt(c.info,s)});t.add(c.from,c.to,p)}return t.finish()},jt=()=>ie.ViewPlugin.fromClass(class{constructor(y){this.decorations=Mt(y)}update(y){(y.docChanged||y.viewportChanged)&&(this.decorations=Mt(y.view))}},{decorations:y=>y.decorations}),$t=y=>ie.ViewPlugin.fromClass(class{constructor(u){this.decorations=Ft(u,y)}update(u){(u.docChanged||u.selectionSet||u.viewportChanged)&&(this.decorations=Ft(u.view,y))}},{decorations:u=>u.decorations}),Ln=(y,u)=>{var t,n,r;if(!y||u<0)return null;let e=/\[\[([^\]\n]+)\]\]/g;for(let i of y.matchAll(e)){let a=(t=i[0])!=null?t:"",s=(n=i[1])!=null?n:"",o=(r=i.index)!=null?r:-1;if(o<0)continue;let l=o+a.length;if(u<o||u>l)continue;let c=s.indexOf("|");return(c>=0?s.slice(0,c):s).trim()||null}return null},Ut=y=>ie.ViewPlugin.fromClass(class{},{eventHandlers:{click(u,e){if(u.defaultPrevented||u.button!==0)return!1;let t=e.dom.closest(".markdown-source-view");if(!t||!t.classList.contains("is-live-preview"))return!1;let n=e.posAtCoords({x:u.clientX,y:u.clientY});if(n===null)return!1;let r=e.state.doc.lineAt(n),i=n-r.from,a=Ln(r.text,i);return!a||!a.includes("#zrr-chunk:")?!1:(u.preventDefault(),u.stopPropagation(),y.openInternalLinkInMain(a,y.getLivePreviewSourcePath()),!0)}}});var le=require("child_process"),ee=require("fs"),Et=xe(require("http")),fn=xe(require("https")),qe=xe(require("net")),je=xe(require("os")),yn=xe(require("tls")),S=xe(require("path")),Rt=require("url"),$e=require("crypto");var L=require("obsidian"),Zt=require("crypto"),We=require("fs"),He=xe(require("path")),ae=".zotero-redisearch-rag",oe=`${ae}/items`,Y=`${ae}/chunks`,Bt=`${ae}/metadata_snapshots.json`,Gt=`${ae}/annotation_snapshots.json`,Nn="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",Ee="cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",Te="__custom__",Vt=[{value:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",label:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1 (Fast multilingual)"},{value:"BAAI/bge-reranker-v2-m3",label:"BAAI/bge-reranker-v2-m3 (Best quality, heaviest)"},{value:"jinaai/jina-reranker-v2-base-multilingual",label:"jinaai/jina-reranker-v2-base-multilingual (Balanced multilingual)"}],Je={pythonRuntime:"worker",pythonRuntimeMigrationV1Done:!1,showAdvancedPythonRuntimeOptions:!1,pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,firstContainerStartupNoticeShown:!1,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",chatExportTemplatePath:"",chatExportPostCreateCommandId:"",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,llmCleanupReasoningMode:"auto",llmCleanupModeMemory:{},embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:Ee,rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${ae}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Ke=class extends L.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async m=>{this.plugin.settings.llmProviderProfiles=m,await this.plugin.saveSettings()},r=m=>{m.inputEl.type="password",m.inputEl.autocomplete="off",m.inputEl.spellcheck=!1},p=[{id:"prerequisites",label:"Prerequisites",render:m=>{new L.Setting(m).setName("Prerequisites").setHeading();let x=null,w=null,E=null,R=null,v=null,A=null,N=null,O=null,F=null,U=(I,q)=>{I&&(I.settingEl.classList.toggle("is-disabled",q),I.settingEl.classList.toggle("zrr-setting-disabled",q))},V=(I,q)=>{I&&I.settingEl.classList.toggle("zrr-setting-hidden",!q)},M=()=>{let I=!!this.plugin.settings.showAdvancedPythonRuntimeOptions,q=this.plugin.settings.pythonRuntime==="local",j=I&&q;w==null||w.setDisabled(!I),U(x,!I),V(E,I),V(R,I),V(v,I),A==null||A.setDisabled(!j),N==null||N.setDisabled(!j),F==null||F.setDisabled(!j),O&&(O.disabled=!j),U(E,!j),U(R,!j),U(v,!j)};new L.Setting(m).setName("Docker/podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(I=>I.setPlaceholder("Docker").setValue(this.plugin.settings.dockerPath).onChange(async q=>{this.plugin.settings.dockerPath=q.trim()||"docker",await this.plugin.saveSettings()})),new L.Setting(m).setName("Advanced python runtime options").setDesc("Show legacy local interpreter/venv controls. Recommended to keep this disabled.").addToggle(I=>I.setValue(this.plugin.settings.showAdvancedPythonRuntimeOptions).onChange(async q=>{this.plugin.settings.showAdvancedPythonRuntimeOptions=q,!q&&this.plugin.settings.pythonRuntime==="local"&&(this.plugin.settings.pythonRuntime="worker",new L.Notice("Switched python runtime to worker mode.")),await this.plugin.saveSettings(),M()})),x=new L.Setting(m).setName("Python runtime").setDesc("Worker runtime is recommended. Enable advanced options to expose local interpreter/venv mode.").addDropdown(I=>{w=I,I.addOption("worker","Python worker container (recommended)"),I.addOption("local","Local interpreter/venv"),I.setValue(this.plugin.settings.pythonRuntime).onChange(async q=>{q!=="worker"&&q!=="local"||(this.plugin.settings.pythonRuntime=q,await this.plugin.saveSettings(),M())})}),E=new L.Setting(m).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(I=>(A=I,I.setPlaceholder("Auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async q=>{this.plugin.settings.pythonPath=q.trim(),await this.plugin.saveSettings()}))),R=new L.Setting(m).setName("Python environment").setDesc("Local mode: create or update the plugin's python env. Worker mode: managed by docker startup.").addButton(I=>{F=I,O=I.buttonEl,I.setButtonText("Create/update").setCta(),I.onClick(async()=>{I.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{I.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),v=new L.Setting(m).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(I=>{N=I,I.addOption("shared","Shared user cache"),I.addOption("plugin","Plugin folder (.venv)"),I.setValue(this.plugin.settings.pythonEnvLocation).onChange(async q=>{q!=="shared"&&q!=="plugin"||(this.plugin.settings.pythonEnvLocation=q,await this.plugin.saveSettings())})}),M(),new L.Setting(m).setName("Redis URL").addText(I=>I.setPlaceholder("Redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async q=>{this.plugin.settings.redisUrl=q.trim(),await this.plugin.saveSettings()}));let G=null,T=null,W=null,Z=null,H=()=>{let I=this.plugin.settings.autoAssignRedisPort;W==null||W.setDisabled(I),Z==null||Z.setDisabled(I),G==null||G.settingEl.classList.toggle("is-disabled",I),T==null||T.settingEl.classList.toggle("is-disabled",I)};new L.Setting(m).setName("Auto-assign redis port").setDesc("When starting redis stack, pick a free local port and update the redis URL.").addToggle(I=>I.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async q=>{this.plugin.settings.autoAssignRedisPort=q,await this.plugin.saveSettings(),H()})),G=new L.Setting(m).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(I=>(W=I,I.setPlaceholder("~/redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async q=>{this.plugin.settings.redisDataDirOverride=q.trim(),await this.plugin.saveSettings()}))),G.settingEl.addClass("zrr-redis-override-setting"),T=new L.Setting(m).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(I=>(Z=I,I.setPlaceholder("Zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async q=>{this.plugin.settings.redisProjectName=q.trim(),await this.plugin.saveSettings()}))),T.settingEl.addClass("zrr-redis-override-setting"),H(),new L.Setting(m).setName("Auto-start redis stack (docker/podman compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(I=>I.setValue(this.plugin.settings.autoStartRedis).onChange(async q=>{this.plugin.settings.autoStartRedis=q,await this.plugin.saveSettings()})),new L.Setting(m).setName("Start redis stack now").setDesc("Starts or restarts redis stack (and python worker in worker mode).").addButton(I=>I.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:m=>{new L.Setting(m).setName("Zotero local API").setHeading(),new L.Setting(m).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. HTTP://127.0.0.1:23119/API").addText(v=>v.setPlaceholder("HTTP://127.0.0.1:23119/API").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async A=>{this.plugin.settings.zoteroBaseUrl=A.trim(),await this.plugin.saveSettings()}));let x=new L.Setting(m).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),w=null,E=v=>{if(!w)return;let A=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(v.map(O=>O.value)).has(A)||(v=v.concat([{value:A,label:`Custom (${A})`}])),w.selectEl.options.length=0;for(let O of v)w.addOption(O.value,O.label);w.setValue(A)},R=async()=>{if(w){w.setDisabled(!0);try{let v=await this.plugin.fetchZoteroLibraryOptions();E(v)}finally{w.setDisabled(!1)}}};x.addDropdown(v=>{w=v;let A=(this.plugin.settings.zoteroUserId||"0").trim()||"0";v.addOption(A,"Loading..."),v.setValue(A),v.onChange(async N=>{this.plugin.settings.zoteroUserId=N.trim(),await this.plugin.saveSettings()})}),x.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await R()})}),R(),new L.Setting(m).setName("Zotero web API").setHeading(),new L.Setting(m).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(v=>v.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async A=>{this.plugin.settings.webApiBaseUrl=A.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Web API library type").setDesc("Library type for web API writes.").addDropdown(v=>v.addOption("user","User").addOption("group","Group").setValue(this.plugin.settings.webApiLibraryType).onChange(async A=>{this.plugin.settings.webApiLibraryType=A,await this.plugin.saveSettings()})),new L.Setting(m).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for web API writes.").addText(v=>v.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async A=>{this.plugin.settings.webApiLibraryId=A.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Web API key").setDesc("Zotero API key for write fallback (from Zotero.org).").addText(v=>{r(v),v.setPlaceholder("Your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async A=>{this.plugin.settings.webApiKey=A.trim(),await this.plugin.saveSettings()})}),new L.Setting(m).setName("Output").setHeading(),new L.Setting(m).setName("PDF folder").addText(v=>v.setPlaceholder("Zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async A=>{this.plugin.settings.outputPdfDir=A.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Notes folder").addText(v=>v.setPlaceholder("Zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async A=>{this.plugin.settings.outputNoteDir=A.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(v=>{v.setValue(this.plugin.settings.frontmatterTemplate).onChange(async A=>{this.plugin.settings.frontmatterTemplate=A,await this.plugin.saveSettings()}),v.inputEl.rows=10,v.inputEl.addClass("zrr-u-width-100")}),new L.Setting(m).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(v=>v.addOption("none","No change").addOption("camel","Camelcase").addOption("pascal","Pascalcase").addOption("snake","Snake_case").addOption("kebab","Kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async A=>{this.plugin.settings.tagSanitizeMode=A,await this.plugin.saveSettings()})),new L.Setting(m).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(v=>{v.setValue(this.plugin.settings.noteBodyTemplate).onChange(async A=>{this.plugin.settings.noteBodyTemplate=A,await this.plugin.saveSettings()}),v.inputEl.rows=8,v.inputEl.addClass("zrr-u-width-100")}),new L.Setting(m).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(v=>v.setPlaceholder("Zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async A=>{this.plugin.settings.chatOutputDir=A.trim()||"zotero/chats",await this.plugin.saveSettings()})),new L.Setting(m).setName("Chat export template").setDesc("Optional vault-relative template file for copied chat notes. Use {{chat_body}} to control where the transcript is inserted (otherwise template text is appended after the transcript).").addText(v=>v.setPlaceholder("Path to chat export template note").setValue(this.plugin.settings.chatExportTemplatePath).onChange(async A=>{this.plugin.settings.chatExportTemplatePath=A.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Chat export post-create command").setDesc("Optional command ID to run after the chat note is created and opened. Useful for templater workflows that need the full note body already present.").addText(v=>v.setPlaceholder("Command ID to run after note creation").setValue(this.plugin.settings.chatExportPostCreateCommandId).onChange(async A=>{this.plugin.settings.chatExportPostCreateCommandId=A.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Copy pdfs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(v=>v.setValue(this.plugin.settings.copyPdfToVault).onChange(async A=>{this.plugin.settings.copyPdfToVault=A,!A&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new L.Setting(m).setName("Create ocr-layered PDF copy").setDesc("When ocr is used, replace the vault PDF with a tesseract text layer (requires copy pdfs into vault).").addToggle(v=>{let A=this.plugin.settings.copyPdfToVault;v.setValue(A?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!A).onChange(async N=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=N,await this.plugin.saveSettings()})}),new L.Setting(m).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(v=>v.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async A=>{this.plugin.settings.preferObsidianNoteForCitations=A,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:m=>{new L.Setting(m).setName("Annotations").setHeading(),new L.Setting(m).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(R=>R.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async v=>{this.plugin.settings.annotationPageLabel=v.trim()||"Page",await this.plugin.saveSettings()})),new L.Setting(m).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(R=>R.setValue(this.plugin.settings.includeAnnotationImages).onChange(async v=>{this.plugin.settings.includeAnnotationImages=v,await this.plugin.saveSettings()})),new L.Setting(m).setName("Zotero companion").setHeading(),m.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new L.Setting(m).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(R=>R.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async v=>{this.plugin.settings.zoteroCompanionEnabled=v,await this.plugin.saveSettings()})),new L.Setting(m).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(R=>R.setPlaceholder("HTTP://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async v=>{this.plugin.settings.zoteroCompanionBaseUrl=v.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(R=>{r(R),this.companionTokenInput=R,R.setPlaceholder("Optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async v=>{this.plugin.settings.zoteroCompanionToken=v.trim(),await this.plugin.saveSettings()})}),new L.Setting(m).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero companion plugin token to this value.").addButton(R=>R.setButtonText("Generate token").onClick(async()=>{let v=(0,Zt.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=v,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(v);try{await navigator.clipboard.writeText(v),new L.Notice("Generated and copied companion token.")}catch(A){new L.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",A)}})),new L.Setting(m).setName("Annotation color map").setHeading(),m.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let x=m.createDiv({cls:"zrr-annotation-map"}),w=async R=>{this.plugin.settings.annotationColorMap=R,await this.plugin.saveSettings()},E=()=>{var F,U;x.empty();let R=this.plugin.settings.annotationColorMap||{},v=Object.entries(R);if(v.length||x.createEl("p",{text:"No color mappings configured."}),v.length){let V=x.createDiv({cls:"zrr-annotation-map-row-header"});V.createEl("span",{text:"Color"}),V.createEl("span",{text:"Heading"}),V.createEl("span",{text:"Callout"}),V.createEl("span")}for(let[V,M]of v){let T=x.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),W=T.createEl("input",{type:"text",value:V,cls:"zrr-annotation-map-input"}),Z=T.createEl("input",{type:"text",value:(F=M.heading)!=null?F:"",cls:"zrr-annotation-map-input"}),H=T.createEl("input",{type:"text",value:(U=M.callout)!=null?U:"",cls:"zrr-annotation-map-input"}),I=T.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});I.type="button",W.addEventListener("change",()=>{(async()=>{let q=W.value.trim().toLowerCase();if(!q){W.value=V;return}let j={...this.plugin.settings.annotationColorMap||{}};if(q!==V&&j[q]){new L.Notice(`Annotation color '${q}' already exists.`),W.value=V;return}let z=j[V];delete j[V],j[q]=z!=null?z:{heading:"",callout:""},await w(j),E()})()}),Z.addEventListener("change",()=>{(async()=>{var z;let q={...this.plugin.settings.annotationColorMap||{}},j=(z=q[V])!=null?z:{heading:"",callout:""};j.heading=Z.value.trim(),q[V]=j,await w(q)})()}),H.addEventListener("change",()=>{(async()=>{var z;let q={...this.plugin.settings.annotationColorMap||{}},j=(z=q[V])!=null?z:{heading:"",callout:""};j.callout=H.value.trim(),q[V]=j,await w(q)})()}),I.addEventListener("click",()=>{(async()=>{let q={...this.plugin.settings.annotationColorMap||{}};delete q[V],await w(q),E()})()})}let A=x.createDiv({cls:"zrr-annotation-map-actions"}),N=A.createEl("button",{text:"Add mapping"});N.type="button",N.addEventListener("click",()=>{(async()=>{let V={...this.plugin.settings.annotationColorMap||{}},M="new-color",G=1;for(;V[M];)M=`new-color-${G}`,G+=1;V[M]={heading:"",callout:""},await w(V),E()})()});let O=A.createEl("button",{text:"Reset to defaults"});O.type="button",O.addEventListener("click",()=>{(async()=>(await w({...Je.annotationColorMap}),E()))()})};E()}},{id:"ocr",label:"OCR",render:m=>{new L.Setting(m).setName("Docling").setHeading();let x=null,w=A=>{if(!x)return;let N=this.plugin.settings.ocrEngine;new Set(A.map(F=>F.value)).has(N)||(A=A.concat([{value:N,label:`Current (unavailable): ${N}`}])),x.selectEl.options.length=0;for(let F of A)x.addOption(F.value,F.label);x.setValue(N)},E=async()=>{if(!x)return;x.setDisabled(!0);let A={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{A=await this.plugin.detectOcrEngines()}catch(F){A={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let N=[{value:"auto",label:"Auto (default)"}];A.tesseract&&N.push({value:"tesseract",label:"Tesseract (local)"}),A.paddleStructureLocal&&N.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),A.paddleVlLocal&&N.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(N.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),N.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),w(N),x.setDisabled(!1)},R=new L.Setting(m).setName("Paddle ocr API key").setDesc("API token for paddleocr-vl / pp-structurev3 endpoints. Get a free API key at "),v=document.createElement("a");v.href="https://aistudio.baidu.com/paddleocr",v.textContent="HTTPS://aistudio.baidu.com/paddleocr",v.target="_blank",v.rel="noopener noreferrer",R.descEl.appendChild(v),R.descEl.append("."),R.addText(A=>{r(A),A.setPlaceholder("Your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async N=>{this.plugin.settings.paddleApiKey=N.trim(),await this.plugin.saveSettings(),await E()})}),new L.Setting(m).setName("Paddleocr-vl API URL").setDesc("Optional override for the paddleocr-vl API endpoint.").addText(A=>A.setPlaceholder("HTTPS://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async N=>{this.plugin.settings.paddleVlApiUrl=N.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Pp-structurev3 API URL").setDesc("API endpoint for pp-structurev3 (see baidu AI studio docs).").addText(A=>A.setPlaceholder("HTTPS://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async N=>{this.plugin.settings.paddleStructureApiUrl=N.trim(),await this.plugin.saveSettings(),await E()})),new L.Setting(m).setName("Ocr engine").setDesc("Select the ocr engine to use when ocr is required.").addDropdown(A=>{x=A,A.addOption("auto","Auto (default)"),A.setValue(this.plugin.settings.ocrEngine),A.onChange(async N=>{this.plugin.settings.ocrEngine=N,await this.plugin.saveSettings()})}),new L.Setting(m).setName("Ocr decision (when to ocr)").setDesc("Controls when ocr runs; per-page behavior is configured separately below.").addDropdown(A=>A.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","Ocr only if text is poor").addOption("force","Prefer ocr for full document").setValue(this.plugin.settings.ocrMode).onChange(async N=>{this.plugin.settings.ocrMode=N,await this.plugin.saveSettings()})),new L.Setting(m).setName("Ocr layout override (per-page)").setDesc("Force per-page ocr when ocr runs, bypassing layout heuristics; can be slower for multi-column pdfs.").addToggle(A=>A.setValue(this.plugin.settings.forcePerPageOcr).onChange(async N=>{this.plugin.settings.forcePerPageOcr=N,await this.plugin.saveSettings()})),new L.Setting(m).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(A=>{A.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async N=>{this.plugin.settings.ocrQualityThreshold=N,await this.plugin.saveSettings()})}),new L.Setting(m).setName("Chunking").setDesc("Page or section").addDropdown(A=>A.addOption("page","Page").addOption("section","Section").setValue(this.plugin.settings.chunkingMode).onChange(async N=>{this.plugin.settings.chunkingMode=N,await this.plugin.saveSettings()})),E()}},{id:"llms",label:"LLMs",render:m=>{new L.Setting(m).setName("Model provider profiles").setHeading();let x=m.createDiv({cls:"zrr-llm-profiles"}),w=()=>{x.empty();let C=t();C.length||x.createEl("p",{text:"No profiles yet. Add one below."});for(let P of C){let D=x.createEl("details",{cls:"zrr-profile"});C.length===1&&(D.open=!0);let re=D.createEl("summary",{text:P.name||P.id||"Profile"});re.addClass("zrr-profile-title");let Ue=D.createDiv({cls:"zrr-profile-body"});new L.Setting(Ue).setName("Profile name").addText(fe=>fe.setPlaceholder("My provider").setValue(P.name||"").onChange(async be=>{P.name=be.trim(),re.textContent=P.name||P.id||"Profile",await n(t())})),new L.Setting(Ue).setName("Base URL").addText(fe=>fe.setPlaceholder("HTTP://localhost:1234/v1").setValue(P.baseUrl||"").onChange(async be=>{P.baseUrl=be.trim(),await n(t())})),new L.Setting(Ue).setName("API key").setDesc("Stored in settings (not encrypted).").addText(fe=>{r(fe),fe.setPlaceholder("Sk-...").setValue(P.apiKey||"").onChange(async be=>{P.apiKey=be.trim(),await n(t())})}),new L.Setting(Ue).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(fe=>fe.setButtonText("Delete profile").onClick(async()=>{let be=t().filter(xn=>xn.id!==P.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===P.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===P.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===P.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(be),w()}))}new L.Setting(x).addButton(P=>P.setButtonText("Add profile").onClick(async()=>{let D=`profile-${Date.now().toString(36)}`,re=t().concat([{id:D,name:"Custom",baseUrl:"",apiKey:""}]);await n(re),w()}))};w(),new L.Setting(m).setName("Ocr cleanup").setHeading(),new L.Setting(m).setName("Model cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor ocr at import. Can be slow/costly.").addToggle(C=>C.setValue(this.plugin.settings.enableLlmCleanup).onChange(async P=>{this.plugin.settings.enableLlmCleanup=P,await this.plugin.saveSettings()}));let E=null,R=null,v=null,A=()=>Promise.resolve(),N=async(C,P=!0)=>{let D=C.trim();this.plugin.settings.llmCleanupBaseUrl=D,P&&(this.plugin.settings.llmCleanupProviderProfileId="",E&&E.setValue("custom")),R&&R.setValue(D),await this.plugin.saveSettings()},O=async C=>{let P=t().find(D=>D.id===C);this.plugin.settings.llmCleanupProviderProfileId=C,P&&(this.plugin.settings.llmCleanupBaseUrl=P.baseUrl,this.plugin.settings.llmCleanupApiKey=P.apiKey,R==null||R.setValue(P.baseUrl),v==null||v.setValue(P.apiKey)),await this.plugin.saveSettings(),await A()};new L.Setting(m).setName("Cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{E=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let P=this.plugin.settings.llmCleanupProviderProfileId;C.setValue(P&&t().some(D=>D.id===P)?P:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await O(D)})}),new L.Setting(m).setName("Cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. HTTP://127.0.0.1:1234/v1").addText(C=>{R=C,C.setPlaceholder("HTTP://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async P=>{await N(P)})}),new L.Setting(m).setName("Cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(C=>{v=C,r(C),C.setPlaceholder("Sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async P=>{this.plugin.settings.llmCleanupApiKey=P.trim(),this.plugin.settings.llmCleanupProviderProfileId="",E&&E.setValue("custom"),await this.plugin.saveSettings()})});let F=new L.Setting(m).setName("Cleanup model").setDesc("Select a cleanup-capable model from the provider."),U=null,V=C=>{if(!U)return;let P=(this.plugin.settings.llmCleanupModel||"").trim(),D=new Set(C.map(re=>re.value));P&&!D.has(P)&&(C=C.concat([{value:P,label:`Custom (${P})`}])),U.selectEl.options.length=0;for(let re of C)U.addOption(re.value,re.label);P&&U.setValue(P)};A=async()=>{if(U){U.setDisabled(!0);try{let C=await this.plugin.fetchCleanupModelOptions();V(C)}finally{U.setDisabled(!1)}}},F.addDropdown(C=>{U=C;let P=(this.plugin.settings.llmCleanupModel||"").trim();C.addOption(P||"loading","Loading..."),C.setValue(P||"loading"),C.onChange(async D=>{this.plugin.settings.llmCleanupModel=D.trim(),await this.plugin.saveSettings()})}),F.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await A()})}),A(),new L.Setting(m).setName("Cleanup temperature").setDesc("Lower is more conservative.").addText(C=>C.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async P=>{let D=Number.parseFloat(P);this.plugin.settings.llmCleanupTemperature=Number.isFinite(D)?D:0,await this.plugin.saveSettings()})),new L.Setting(m).setName("Cleanup reasoning mode").setDesc("Automatically learn the best cleanup mode for the selected provider and model, and reprobe reasoning every 30 days.").addDropdown(C=>C.addOption("auto","Automatic").addOption("on","Reasoning on").addOption("off","Reasoning off").setValue(this.plugin.settings.llmCleanupReasoningMode).onChange(async P=>{this.plugin.settings.llmCleanupReasoningMode=P==="on"||P==="off"?P:"auto",await this.plugin.saveSettings()})),new L.Setting(m).setName("Cleanup minimum quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(C=>C.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async P=>{this.plugin.settings.llmCleanupMinQuality=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Cleanup maximum chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(C=>C.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(D)?D:2e3,await this.plugin.saveSettings()})),new L.Setting(m).setName("Text embedding").setHeading();let M=null,G=null,T=null,W=()=>Promise.resolve(),Z=async(C,P=!0)=>{let D=C.trim();this.plugin.settings.embedBaseUrl=D,P&&(this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom")),G&&G.setValue(D),await this.plugin.saveSettings()},H=async C=>{let P=t().find(D=>D.id===C);this.plugin.settings.embedProviderProfileId=C,P&&(this.plugin.settings.embedBaseUrl=P.baseUrl,this.plugin.settings.embedApiKey=P.apiKey,G==null||G.setValue(P.baseUrl),T==null||T.setValue(P.apiKey)),await this.plugin.saveSettings(),await W()};new L.Setting(m).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{M=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let P=this.plugin.settings.embedProviderProfileId;C.setValue(P&&t().some(D=>D.id===P)?P:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await H(D)})}),new L.Setting(m).setName("Embeddings base URL").addText(C=>{G=C,C.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async P=>{await Z(P)})}),new L.Setting(m).setName("Embeddings API key").addText(C=>{T=C,r(C),C.setPlaceholder("Lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async P=>{this.plugin.settings.embedApiKey=P.trim(),this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom"),await this.plugin.saveSettings()})});let I=new L.Setting(m).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),q=null,j=C=>{if(!q)return;let P=(this.plugin.settings.embedModel||"").trim(),D=new Set(C.map(re=>re.value));P&&!D.has(P)&&(C=C.concat([{value:P,label:`Custom (${P})`}])),q.selectEl.options.length=0;for(let re of C)q.addOption(re.value,re.label);P&&q.setValue(P)};W=async()=>{if(q){q.setDisabled(!0);try{let C=await this.plugin.fetchEmbeddingModelOptions();j(C)}finally{q.setDisabled(!1)}}},I.addDropdown(C=>{q=C;let P=(this.plugin.settings.embedModel||"").trim();C.addOption(P||"loading","Loading..."),C.setValue(P||"loading"),C.onChange(async D=>{this.plugin.settings.embedModel=D.trim(),await this.plugin.saveSettings()})}),I.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await W()})}),W(),new L.Setting(m).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(C=>C.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async P=>{this.plugin.settings.embedIncludeMetadata=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(C=>C.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedContextWindow=Number.isFinite(D)?Math.max(0,D):1,await this.plugin.saveSettings()})),new L.Setting(m).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(C=>C.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedContextChars=Number.isFinite(D)?Math.max(0,D):220,await this.plugin.saveSettings()})),new L.Setting(m).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(C=>C.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(D)?Math.max(0,D):3500,await this.plugin.saveSettings()})),new L.Setting(m).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(C=>C.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(D)?Math.max(0,D):200,await this.plugin.saveSettings()})),new L.Setting(m).setName("Generate model tags for chunks").setDesc("Use the ocr cleanup model to tag chunks before indexing.").addToggle(C=>C.setValue(this.plugin.settings.enableChunkTagging).onChange(async P=>{this.plugin.settings.enableChunkTagging=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Chat model").setHeading();let z=null,$=null,K=null,ne=()=>Promise.resolve(),pe=async(C,P=!0)=>{let D=C.trim();this.plugin.settings.chatBaseUrl=D,P&&(this.plugin.settings.chatProviderProfileId="",z&&z.setValue("custom")),$&&$.setValue(D),await this.plugin.saveSettings()},he=async C=>{let P=t().find(D=>D.id===C);this.plugin.settings.chatProviderProfileId=C,P&&(this.plugin.settings.chatBaseUrl=P.baseUrl,this.plugin.settings.chatApiKey=P.apiKey,$==null||$.setValue(P.baseUrl),K==null||K.setValue(P.apiKey)),await this.plugin.saveSettings(),await ne()};new L.Setting(m).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{z=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let P=this.plugin.settings.chatProviderProfileId;C.setValue(P&&t().some(D=>D.id===P)?P:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await he(D)})}),new L.Setting(m).setName("Chat base URL").setDesc("Compatible endpoint for chat requests.").addText(C=>{$=C,C.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async P=>{await pe(P)})}),new L.Setting(m).setName("Chat API key").addText(C=>{K=C,r(C),C.setPlaceholder("Lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async P=>{this.plugin.settings.chatApiKey=P.trim(),this.plugin.settings.chatProviderProfileId="",z&&z.setValue("custom"),await this.plugin.saveSettings()})});let Ce=new L.Setting(m).setName("Chat model").setDesc("Select a chat-capable model from the provider."),ce=null,gt=C=>{if(!ce)return;let P=(this.plugin.settings.chatModel||"").trim(),D=new Set(C.map(re=>re.value));P&&!D.has(P)&&(C=C.concat([{value:P,label:`Custom (${P})`}])),ce.selectEl.options.length=0;for(let re of C)ce.addOption(re.value,re.label);P&&ce.setValue(P)};ne=async()=>{if(ce){ce.setDisabled(!0);try{let C=await this.plugin.fetchChatModelOptions();gt(C)}finally{ce.setDisabled(!1)}}},Ce.addDropdown(C=>{ce=C;let P=(this.plugin.settings.chatModel||"").trim();C.addOption(P||"loading","Loading..."),C.setValue(P||"loading"),C.onChange(async D=>{this.plugin.settings.chatModel=D.trim(),await this.plugin.saveSettings()})}),Ce.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await ne()})}),ne(),new L.Setting(m).setName("Temperature").addText(C=>C.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async P=>{let D=Number.parseFloat(P);this.plugin.settings.chatTemperature=Number.isFinite(D)?D:.2,await this.plugin.saveSettings()})),new L.Setting(m).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(C=>C.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(D)?Math.max(0,D):6,await this.plugin.saveSettings()})),new L.Setting(m).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(C=>C.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async P=>{this.plugin.settings.chatPaneLocation=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Retrieval").setHeading(),new L.Setting(m).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(C=>C.setValue(this.plugin.settings.enableAgenticRag).onChange(async P=>{this.plugin.settings.enableAgenticRag=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(C=>C.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.agenticMaxIters=Number.isFinite(D)?Math.max(1,D):2,await this.plugin.saveSettings()})),new L.Setting(m).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(C=>C.setValue(this.plugin.settings.enableQueryExpansion).onChange(async P=>{this.plugin.settings.enableQueryExpansion=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(C=>C.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.queryExpansionCount=Number.isFinite(D)?Math.max(1,D):3,await this.plugin.saveSettings()})),new L.Setting(m).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(C=>C.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async P=>{this.plugin.settings.enableCrossEncoderRerank=P,await this.plugin.saveSettings()}));let X=new Set(Vt.map(C=>C.value)),Q=(this.plugin.settings.rerankModel||"").trim()||Ee,_e=X.has(Q)?Q:Te,se=null,St=()=>{if(!se)return;let P=!(_e===Te);se.setDisabled(P),se.inputEl.disabled=P,se.inputEl.readOnly=P,se.inputEl.classList.toggle("is-disabled",P),se.inputEl.setAttribute("aria-disabled",String(P))},Lt=new L.Setting(m).setName("Cross-encoder model").setDesc("Choose a multilingual preset, or select custom to edit the model ID.");Lt.addDropdown(C=>{for(let P of Vt)C.addOption(P.value,P.label);C.addOption(Te,"Custom"),C.setValue(_e),C.onChange(async P=>{_e=P,P!==Te?this.plugin.settings.rerankModel=P:(this.plugin.settings.rerankModel||"").trim()||(this.plugin.settings.rerankModel=Ee),await this.plugin.saveSettings(),se==null||se.setValue(this.plugin.settings.rerankModel||Ee),St()})}),Lt.addText(C=>{se=C,C.setPlaceholder(Ee).setValue(Q).onChange(async P=>{_e===Te&&(this.plugin.settings.rerankModel=P.trim()||Ee,await this.plugin.saveSettings())}),St()}),new L.Setting(m).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 n candidates before reranking.").addText(C=>C.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(D)?Math.max(1,D):4,await this.plugin.saveSettings()})),new L.Setting(m).setName("Rrf k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(C=>C.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.rrfK=Number.isFinite(D)?Math.max(1,D):60,await this.plugin.saveSettings()})),new L.Setting(m).setName("Rrf log top n").setDesc("Log the top n rrf-ranked chunks to stderr (0 disables).").addText(C=>C.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.rrfLogTop=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()})),new L.Setting(m).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(C=>C.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:m=>{new L.Setting(m).setName("Python runtime").setHeading(),new L.Setting(m).setName("Use local runtime (legacy)").setDesc("Switch to local interpreter/venv mode and enable advanced runtime settings.").addButton(x=>x.setButtonText("Switch").onClick(async()=>{await this.plugin.switchPythonRuntimeToLocalLegacy()})),new L.Setting(m).setName("Logging").setHeading(),new L.Setting(m).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(x=>x.setValue(this.plugin.settings.enableFileLogging).onChange(async w=>{this.plugin.settings.enableFileLogging=w,await this.plugin.saveSettings()})),new L.Setting(m).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(x=>x.setPlaceholder(`${ae}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async w=>{this.plugin.settings.logFilePath=w.trim()||`${ae}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new L.Setting(m).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(x=>x.setButtonText("Open log").onClick(async()=>{var w,E;await((E=(w=this.plugin).openLogFile)==null?void 0:E.call(w))})).addButton(x=>x.setButtonText("Clear log").onClick(async()=>{var w,E;await((E=(w=this.plugin).clearLogFile)==null?void 0:E.call(w))})),new L.Setting(m).setName("Zotero companion plugin").setHeading(),m.createEl("p",{text:"Download the xpi, then in Zotero go to tools \u2192 add-ons \u2192 install from file and restart."}),new L.Setting(m).setName("Download companion add-on").setDesc("Downloads the companion xpi to your system downloads folder.").addButton(x=>x.setButtonText("Download xpi").onClick(async()=>{let w=this.getDefaultDownloadDir();if(!w){new L.Notice("Unable to resolve the system downloads folder.");return}let E=He.default.join(w,"zrr-companion.xpi");if(await this.companionXpiExists(E)){new L.Notice(`Companion XPI already exists: ${E}`);return}new L.Notice("Downloading companion xpi..."),await this.downloadCompanionXpi(E)})),new L.Setting(m).setName("Open Zotero").setDesc("Launch Zotero and open the add-ons window (tools \u2192 add-ons).").addButton(x=>x.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new L.Setting(m).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(x=>x.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),new L.Setting(m).setName("Redis indexing").setHeading(),new L.Setting(m).setName("Reindex redis from cached chunks").setDesc("Rebuild the redis index from cached chunk JSON files.").addButton(x=>x.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new L.Setting(m).setName("Recreate redis stack").setDesc("Pulls the configured redis image and force-recreates the redis-stack service.").addButton(x=>x.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateRedisStack()})),new L.Setting(m).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(x=>x.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(x=>x.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()})),new L.Setting(m).setName("Release notes").setHeading(),new L.Setting(m).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(x=>x.setButtonText("Show").onClick(()=>{this.plugin.openReleaseNotesModal()}))}}],d=new Map,_=new Map,g=m=>{this.activeTab=m;for(let[x,w]of d){let E=x===m;w.classList.toggle("is-active",E),w.setAttribute("aria-selected",E?"true":"false"),w.setAttribute("tabindex",E?"0":"-1")}for(let[x,w]of _){let E=x===m;w.classList.toggle("is-active",E),w.hidden=!E}},f=e.createDiv({cls:"zrr-settings-tabs"});f.setAttribute("role","tablist");let b=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let m of p){let x=f.createEl("button",{text:m.label,cls:"zrr-settings-tab-button"}),w=`zrr-settings-tab-${m.id}`,E=`zrr-settings-panel-${m.id}`;x.type="button",x.id=w,x.setAttribute("role","tab"),x.setAttribute("aria-controls",E),x.setAttribute("aria-selected","false"),x.addEventListener("click",()=>g(m.id));let R=b.createDiv({cls:"zrr-settings-tab-panel"});R.id=E,R.setAttribute("role","tabpanel"),R.setAttribute("aria-labelledby",w),R.hidden=!0,m.render(R),d.set(m.id,x),_.set(m.id,R)}let k=p.some(m=>m.id===this.activeTab)?this.activeTab:p[0].id;g(k)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?He.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await We.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await We.promises.mkdir(He.default.dirname(e),{recursive:!0});let t=await(0,L.requestUrl)({url:Nn,method:"GET"});if(t.status!==200){new L.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await We.promises.writeFile(e,n),new L.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new L.Notice("Failed to download companion xpi. See console for details."),console.warn("Failed to download companion XPI",t)}}};var Wt=require("@codemirror/state"),Ht=require("@codemirror/view"),ue=require("obsidian");var Tn=y=>{let u=y.scrollDOM.getBoundingClientRect(),e=y.posAtCoords({x:u.left+8,y:+u.height*.25});return e===null?null:y.state.doc.lineAt(e).number},De=y=>!y||typeof y!="object"?null:y,Xe=class{constructor(u,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=u,this.helpers=e}createSyncExtension(){let u=this.helpers,e=this.syncPdfSidebarForDoc.bind(this);return Ht.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=u.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=u.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var d,_;let r=this.docId;if(!r)return;let i=Tn(t);if(i===null)return;let a=u.findChunkStartLineInDoc(t.state.doc,i);if(!a)return;let s=u.parseChunkMarkerLine(a.text),o=(d=s==null?void 0:s.pageNumber)!=null?d:null,l=(_=s==null?void 0:s.chunkId)!=null?_:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,p=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||p)||(this.lastPage=o,this.lastChunkId=l,e(r,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(u={}){if(!this.pendingPdfSync||!this.isPdfSidebarLeaf(this.pdfSidebarLeaf)&&!await this.getPdfSidebarLeaf(!!u.allowCreateLeaf)||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let e=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(e.docId,e.pageNumber,e.chunkId)}async revealPdfSidebar(u={}){let e=await this.getPdfSidebarLeaf(!!u.allowCreateLeaf);if(e)try{await this.deps.app.workspace.revealLeaf(e)}catch(t){console.warn("Failed to reveal PDF sidebar leaf",t)}}updatePreviewScrollHandler(){var n;let u=this.deps.app.workspace.getActiveViewOfType(ue.MarkdownView);if(!u||u.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=u.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(u);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(u)}async syncPdfSidebarForFile(u,e={}){try{let t=await this.deps.app.vault.read(u),n=await this.deps.resolveDocIdForNote(u,t);if(!n)return;let r=this.helpers.extractFirstChunkMarkerFromContent(t);await this.syncPdfSidebarForDoc(n,r==null?void 0:r.pageNumber,r==null?void 0:r.chunkId,e)}catch(t){console.warn("Failed to sync PDF sidebar for opened note",t)}}async syncPdfSidebarForDoc(u,e,t,n={}){if(u){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:u,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let r=await this.deps.getDocIndexEntry(u);r||(r=await this.deps.hydrateDocIndexFromCache(u));let i=r!=null&&r.pdf_path?String(r.pdf_path):"";if(!i)return;let a=this.deps.toVaultRelativePath(i);if(!a){let d=(0,ue.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(d)instanceof ue.TFile&&(a=d)}if(!a)return;let s=this.deps.app.vault.getAbstractFileByPath(a);if(!(s instanceof ue.TFile)||s.extension.toLowerCase()!=="pdf")return;let o=await this.getPdfSidebarLeaf(!!n.allowCreateLeaf);if(!o){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}if(!this.isLeafTabActive(o)&&!n.allowCreateLeaf){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}let l=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(l===null&&t&&(l=await this.resolvePageNumberForChunk(u,t)),l===null||this.isPdfSidebarLeaf(o)&&this.pdfSidebarLeaf===o&&this.pdfSidebarDocId===u&&this.pdfSidebarPdfPath===s.path&&this.pdfSidebarPage===l)return;let c=a,p=l!==null?`${c}#page=${l}`:c;if(await this.openPdfLinkInLeaf(o,s,p),this.pdfSidebarLeaf=o,this.pdfSidebarDocId=u,this.pdfSidebarPdfPath=s.path,this.pdfSidebarPage=l,this.updatePdfSidebarIcon(o),n.allowCreateLeaf&&!this.isLeafTabActive(o))try{await this.deps.app.workspace.revealLeaf(o)}catch(d){console.warn("Failed to reveal PDF sidebar leaf",d)}}finally{this.pdfSyncInFlight=!1;let r=this.queuedPdfSync;this.queuedPdfSync=null,r&&this.syncPdfSidebarForDoc(r.docId,r.pageNumber,r.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(u){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(u)}))}syncPdfSidebarForPreview(u){let e=this.previewScrollEl;if(!e)return;let t=u.getViewData();if(!t)return;let n=Wt.Text.of(t.split(/\r?\n/)),r=this.helpers.extractDocIdFromDoc(n);if(!r)return;let i=this.getPreviewTopLineNumber(e);if(i===null)return;let a=this.helpers.findChunkStartLineInDoc(n,i+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(r,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(u){var n;let e=u.getBoundingClientRect().top,t=u.querySelectorAll("[data-line]");for(let r of Array.from(t))if(r.getBoundingClientRect().bottom>=e+2){let a=(n=r.getAttribute("data-line"))!=null?n:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(u=!1){if(this.pdfSidebarLeaf&&this.isUsableRightSidebarLeaf(this.pdfSidebarLeaf)&&this.isPdfSidebarLeaf(this.pdfSidebarLeaf))return this.pdfSidebarLeaf;this.resetPdfSidebarLeaf();let e=this.findRightSidebarPdfLeaf();if(e)return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;if(u){let t=this.deps.app.workspace;if(typeof t.ensureSideLeaf=="function")try{let r=await t.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!1});if(this.isUsableRightSidebarLeaf(r))return this.pdfSidebarLeaf=r,r.isDeferred&&await r.loadIfDeferred(),this.updatePdfSidebarIcon(r),r}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let n=this.deps.app.workspace.getRightLeaf(!1);if(this.isUsableRightSidebarLeaf(n))return this.pdfSidebarLeaf=n,n}return null}findRightSidebarPdfLeaf(){let u=this.deps.app.workspace;if(typeof u.iterateAllLeaves!="function")return null;let e=null;return u.iterateAllLeaves(t=>{if(!(!this.isUsableRightSidebarLeaf(t)||!this.isPdfSidebarLeaf(t))){if(this.isLeafTabActive(t)){e=t;return}e||(e=t)}}),e}resetPdfSidebarLeaf(){this.pdfSidebarLeaf=null,this.pdfSidebarDocId=null,this.pdfSidebarPdfPath=null,this.pdfSidebarPage=null}isUsableRightSidebarLeaf(u){var t;return this.isRightSidebarLeaf(u)?!!((t=u.containerEl)!=null&&t.isConnected):!1}getLeafViewType(u){var t,n;if(!u)return"";try{let r=u.getViewState();if(typeof(r==null?void 0:r.type)=="string"&&r.type)return r.type}catch(r){console.debug("Failed to read leaf view state",r)}let e=(n=(t=u.view)==null?void 0:t.getViewType)==null?void 0:n.call(t);return typeof e=="string"?e:""}isPdfSidebarLeaf(u){return this.getLeafViewType(u)==="pdf"}isRightSidebarLeaf(u){if(!u)return!1;let t=u.containerEl;return t?!!t.closest(".workspace-split.mod-right-split, .mod-right-split"):!1}updatePdfSidebarIcon(u){if(!u||!this.isRightSidebarLeaf(u)||!this.isPdfSidebarLeaf(u))return;let t=u.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let r=u;if(r.tabHeaderEl&&n.push(...Array.from(r.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),r.tabHeaderInnerIconEl&&n.push(r.tabHeaderInnerIconEl),n.length===0)return;let i=new Set;for(let s of n)if(!i.has(s)){if(i.add(s),s.replaceChildren(),(0,ue.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg){let o=document.createRange().createContextualFragment(this.deps.iconSvg);s.replaceChildren(o)}s.dataset&&(s.dataset.zrrIcon="zrr-pdf")}let a=u.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(u,e,t){var l;if(!await this.ensurePdfLeafReady(u,e)){await u.openFile(e,{active:!1});return}let r=De((l=this.getPluginsRegistry())==null?void 0:l["pdf-plus"]),i=De(r==null?void 0:r.lib),a=De(i==null?void 0:i.workspace),s=typeof(a==null?void 0:a.openPDFLinkTextInLeaf)=="function"?a.openPDFLinkTextInLeaf:null;if(typeof s=="function")try{await s.call(a,u,t,"",{active:!1});return}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150)}let o=u;if(typeof o.openLinkText=="function"){try{await o.openLinkText(t,"",{active:!1})}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150),await o.openLinkText(t,"",{active:!1})}return}await u.openFile(e,{active:!1})}async ensurePdfLeafReady(u,e){if(this.isPdfSidebarLeaf(u))return!0;try{await u.setViewState({type:"pdf",active:!1})}catch(t){console.debug("Failed to set PDF view state on sidebar leaf",t)}if(u.isDeferred)try{await u.loadIfDeferred()}catch(t){console.debug("Failed to load deferred PDF sidebar leaf",t)}if(this.isPdfSidebarLeaf(u))return!0;try{await u.openFile(e,{active:!1})}catch(t){return console.warn("Failed to open PDF file in sidebar leaf",t),!1}return this.isPdfSidebarLeaf(u)}isPdfAnnotationRaceError(u){let e=u instanceof Error?u.message:typeof u=="string"?u:"";return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(u){return new Promise(e=>setTimeout(e,u))}getPluginsRegistry(){var e;return(e=this.deps.app.plugins)==null?void 0:e.plugins}isLeafTabActive(u){var r;let e=u;if((r=e.parent)!=null&&r.activeLeaf)return e.parent.activeLeaf===u;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(u,e){var l,c,p,d,_;if(!u||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,u)||e,n=this.chunkPageCache.get(u);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let r=(0,ue.normalizePath)(`${Y}/${u}.json`);if(!await this.deps.app.vault.adapter.exists(r))return null;let a=De(await this.deps.readChunkPayload(r)),s=Array.isArray(a==null?void 0:a.chunks)?a.chunks:[],o=new Map;for(let g of s){let f=De(g),b=typeof(f==null?void 0:f.chunk_id)=="string"?f.chunk_id.trim():"";if(!b)continue;let k=Number.isFinite((c=f==null?void 0:f.page_start)!=null?c:NaN)?Number(f==null?void 0:f.page_start):null,m=Number.isFinite((p=f==null?void 0:f.page_end)!=null?p:NaN)?Number(f==null?void 0:f.page_end):null,x=k!=null?k:m;x!==null&&(o.set(b,x),o.set(`${u}:${b}`,x))}return this.chunkPageCache.set(u,o),(_=(d=o.get(t))!=null?d:o.get(e))!=null?_:null}};var Qe={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.26
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.26
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.26
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.26
...
`).trim()+`
`}async resolveUniqueNotePath(e,t){let n=this.app.vault.adapter;if(!await n.exists(e))return e;let r=S.default.dirname(e),i=(0,h.normalizePath)(S.default.join(r,t));if(!await n.exists(i))return i;let a=2;for(;a<1e3;){let s=(0,h.normalizePath)(S.default.join(r,`${S.default.basename(t,".md")}-${a}.md`));if(!await n.exists(s))return s;a+=1}return i}formatTimestamp(e){let t=n=>String(n).padStart(2,"0");return[e.getFullYear(),t(e.getMonth()+1),t(e.getDate()),"-",t(e.getHours()),t(e.getMinutes())].join("")}async openCitationTarget(e,t){var s,o;let n=t!=null?t:await this.resolveCitationDisplay(e),r=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id),i=e.annotation_key||this.extractAnnotationKey(e.chunk_id);if(this.settings.preferObsidianNoteForCitations&&n.notePath){if(i){let l=e.attachment_key||((o=(s=this.docIndex)==null?void 0:s[e.doc_id||""])==null?void 0:o.attachment_key)||"",c=e.page_start?String(e.page_start):e.page_end?String(e.page_end):"0";if(await this.openNoteAtAnnotation(n.notePath,i,l,c))return}if(r&&!i&&await this.openNoteAtChunk(n.notePath,r))return;await this.openNoteInMain(n.notePath);return}if(n.zoteroUrl){this.openExternalUrl(n.zoteroUrl);return}if(!(n.pdfPath&&await this.openPdfInMain(n.pdfPath,n.pageStart))){if(n.zoteroUrl){this.openExternalUrl(n.zoteroUrl);return}new h.Notice("Unable to open citation target.")}}async rebuildNoteFromCache(){let e=await this.promptDocId();if(!e){new h.Notice("No doc_ID provided.");return}await this.rebuildNoteFromCacheForDocId(e,!0)&&new h.Notice(`Rebuilt Zotero note for ${e}.`)}async reindexCurrentNoteFromCache(){let e=this.app.workspace.getActiveFile();if(!e){new h.Notice("No active note to reindex.");return}await this.reindexNoteFromCacheForFile(e,!0)}async reindexNoteFromCacheForFile(e,t){try{let n=await this.app.vault.read(e),r=await this.resolveDocIdForNote(e,n);if(!r){t&&new h.Notice("No doc_ID found for this note.");return}let i=(0,h.normalizePath)(`${Y}/${r}.json`);if(!await this.app.vault.adapter.exists(i)&&!await this.restoreMissingChunkCacheFromNote(e,n,r,t))return;await this.reindexDocIdFromCache(r,t)&&t&&new h.Notice(`Reindexed ${r}.`)}catch(n){t&&new h.Notice("Failed to reindex note."),console.error("Failed to reindex note",n)}}async rebuildDocIndexFromCache(){var c,p,d;let e=this.app.vault.adapter,t=await this.listDocIds(oe),n=await this.listDocIds(Y),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),i=Object.keys(r),a=Array.from(new Set([...t,...n,...i]));if(a.length===0){new h.Notice("No cached items found.");return}this.showStatusProgress("Rebuilding doc index...",0);let s=await this.getDocIndex(),o=0;for(let _ of a){o+=1;let g={},f=r[_];f&&(g.note_path=f.note_path,g.note_title=f.note_title);let b=(0,h.normalizePath)(`${oe}/${_}.json`);if(await e.exists(b))try{let x=await e.read(b),w=JSON.parse(x),E=(p=(c=w==null?void 0:w.data)!=null?c:w)!=null?p:{},R=typeof E.title=="string"?E.title:"";R&&(g.zotero_title=R);let v=ve(E);v&&(g.short_title=v);let A=this.sanitizeFileName(R)||_,N=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${A}.md`),O=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${A}-${_}.md`);await e.exists(N)?(g.note_path=N,g.note_title=S.default.basename(N,".md")):await e.exists(O)&&(g.note_path=O,g.note_title=S.default.basename(O,".md"))}catch(x){console.error("Failed to read cached item JSON",x)}let k=(0,h.normalizePath)(`${Y}/${_}.json`);if(await e.exists(k))try{let x=await e.read(k),w=JSON.parse(x);typeof(w==null?void 0:w.source_pdf)=="string"&&(g.pdf_path=w.source_pdf)}catch(x){console.error("Failed to read cached chunks JSON",x)}if(Object.keys(g).length>0){let w={...(d=s[_])!=null?d:{doc_id:_},...g,doc_id:_,updated_at:new Date().toISOString()};!w.note_title&&w.note_path&&(w.note_title=S.default.basename(w.note_path,".md")),typeof w.pdf_path=="string"&&(w.pdf_path=this.normalizeDocIndexPdfPath(w.pdf_path)),s[_]=w}let m=Math.round(o/a.length*100);this.showStatusProgress(`Rebuilding doc index ${o}/${a.length}`,m)}await this.saveDocIndex(s);let l=await this.pruneDocIndexOrphans();this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),l.removed>0?new h.Notice(`Rebuilt doc index for ${a.length} items; pruned ${l.removed} stale entries.`):new h.Notice(`Rebuilt doc index for ${a.length} items.`)}async recreateMissingNotesFromCache(){if(this.recreateMissingNotesActive){new h.Notice("Recreate missing notes is already running.");return}this.recreateMissingNotesActive=!0,this.recreateMissingNotesAbort=!1,this.recreateMissingNotesProcess=null;try{let e=this.app.vault.adapter,t=await this.listDocIds(oe),n=await this.listDocIds(Y),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),i=Object.keys(r),a=Array.from(new Set([...t,...n,...i]));if(a.length===0){new h.Notice("No cached items found.");return}let s=[];for(let c of a){if(r[c])continue;let p=await this.getDocIndexEntry(c);if(p!=null&&p.note_path&&await e.exists(p.note_path))continue;let d=await this.inferNotePathFromCache(c);d&&await e.exists(d)||s.push(c)}if(s.length===0){new h.Notice("No missing notes detected.");return}this.showStatusProgress("Recreating missing notes...",0);let o=0,l=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;for(let c=0;c<s.length&&!this.recreateMissingNotesAbort;c+=1){let p=s[c],d=Math.round((c+1)/s.length*100);this.showStatusProgress(`Recreating ${c+1}/${s.length}`,d),l&&this.appendToLogFile(l,`Recreate missing note doc_id ${p} (${c+1}/${s.length})`,"recreate_missing_notes","INFO"),await this.rebuildNoteFromCacheForDocId(p,!1)&&(o+=1)}this.recreateMissingNotesAbort?(this.showStatusProgress("Canceled",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new h.Notice(`Canceled after ${o}/${s.length} notes.`)):(this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new h.Notice(`Recreated ${o}/${s.length} missing notes.`))}finally{this.recreateMissingNotesActive=!1,this.recreateMissingNotesProcess=null}}cancelRecreateMissingNotesFromCache(){if(!this.recreateMissingNotesActive){new h.Notice("No recreate job is running.");return}this.recreateMissingNotesAbort=!0;let e=this.recreateMissingNotesProcess;if(e&&!e.killed){try{e.kill("SIGTERM")}catch(t){console.warn("Failed to terminate recreate process",t)}window.setTimeout(()=>{if(e&&!e.killed)try{e.kill("SIGKILL")}catch(t){console.warn("Failed to force-kill recreate process",t)}},2e3)}new h.Notice("Canceling recreate missing notes...")}buildRedisCommand(e){let t=[`*${e.length}\r
`];for(let n of e){let r=String(n);t.push(`$${Buffer.byteLength(r)}\r
${r}\r
`)}return t.join("")}async checkRedisConnectionWithUrl(e,t=2e3){let n=(e||"").trim();if(!n)return{ok:!1,message:"Redis URL is not configured."};let r;try{r=new URL(n)}catch(c){return{ok:!1,message:"Redis URL is invalid."}}let i=r.hostname||"127.0.0.1",a=Number(r.port)||(r.protocol==="rediss:"||r.protocol==="redis+tls:"?6380:6379),s=decodeURIComponent(r.username||""),o=decodeURIComponent(r.password||""),l=r.protocol==="rediss:"||r.protocol==="redis+tls:";return new Promise(c=>{let p=l?yn.default.connect({host:i,port:a,timeout:t,rejectUnauthorized:!1}):qe.default.createConnection({host:i,port:a,timeout:t}),d="",_=o||s?"auth":"ping",g=!1,f=(k,m)=>{if(!g){g=!0;try{p.end(),p.destroy()}catch(x){}c({ok:k,message:m})}},b=k=>{let m=k.trim();if(m){if(m.startsWith("-NOAUTH")){f(!1,"Redis requires authentication. Check your Redis URL credentials.");return}if(m.startsWith("-WRONGPASS")||m.toLowerCase().includes("invalid password")){f(!1,"Redis authentication failed. Check your Redis URL credentials.");return}if(m.startsWith("-ERR")){f(!1,`Redis error: ${m}`);return}if(_==="auth"){if(m.startsWith("+OK")){_="ping",d="",p.write(this.buildRedisCommand(["PING"]));return}f(!1,`Redis auth failed: ${m}`);return}m.startsWith("+PONG")&&f(!0)}};p.on("connect",()=>{if(_==="auth"){let k=s?["AUTH",s,o]:["AUTH",o];p.write(this.buildRedisCommand(k))}else p.write(this.buildRedisCommand(["PING"]))}),p.on("data",k=>{var x;d+=k.toString();let m=d.split(/\r?\n/);d=(x=m.pop())!=null?x:"";for(let w of m)b(w)}),p.on("timeout",()=>{f(!1,"Timed out connecting to Redis.")}),p.on("error",k=>{f(!1,`Redis connection failed: ${k.message}`)}),p.on("close",()=>{g||f(!1,"Redis connection closed unexpectedly.")})})}async checkRedisConnection(e=2e3){return this.checkRedisConnectionWithUrl(this.settings.redisUrl,e)}async ensureRedisAvailable(e){let t=await this.checkRedisConnection();if(t.ok)return!0;let n=t.message?`Redis unavailable for ${e}: ${t.message}`:`Redis unavailable for ${e}.`;return this.notifyContainerOnce(n),!1}isOptionalLookupNetworkError(e){let t=this.getPythonErrorMessage(e).toLowerCase();return t.includes("enotfound")||t.includes("getaddrinfo")||t.includes("eai_again")||t.includes("timed out")||t.includes("etimedout")||t.includes("econnrefused")||t.includes("econnreset")||t.includes("ehostunreach")||t.includes("enetunreach")}isTimeoutLikeErrorMessage(e){let t=(e||"").toLowerCase();return t.includes("timed out")||t.includes("timeout")||t.includes("request timed out")||t.includes("timeout_while_waiting")||t.includes("python worker streaming request timed out")}isRateLimitErrorMessage(e){let t=(e||"").toLowerCase();return/\b429\b/.test(t)||t.includes("status 429")||t.includes("too many requests")||t.includes("rate limit")||t.includes("rate-limit")||t.includes("rate limited")||t.includes("rate-limited")||t.includes("retry-after")||t.includes("quota exceeded")}getEmbeddingRateLimitMessage(e){switch(e){case"rerun":return"Embedding provider rate limit exceeded. Wait and rerun.";case"rebuild":return"Embedding provider rate limit exceeded while rebuilding the index. Wait and retry.";case"retry_import":return"Embedding provider rate limit exceeded. Wait and retry import.";default:return"Embedding provider rate limit exceeded. Wait and retry."}}getChatRateLimitMessage(){return"Chat provider rate limit exceeded. Wait and retry."}isLmStudioProvider(e,t=""){if((t||"").trim()==="lm-studio")return!0;let n=(e||"").trim();if(!n)return!1;try{let r=new URL(n),i=r.hostname.toLowerCase(),a=r.port||(r.protocol==="https:"?"443":"80");return(i==="127.0.0.1"||i==="localhost")&&a==="1234"}catch(r){return!1}}isTemperatureUnsupportedMessage(e){let t=(e||"").toLowerCase();return t.includes("temperature")&&(t.includes("unsupported")||t.includes("not supported")||t.includes("unknown parameter")||t.includes("default"))}isResponsesEndpointUnsupportedMessage(e){let t=(e||"").toLowerCase();return t.includes("404")||t.includes("not found")||t.includes("unknown endpoint")||t.includes("responses response missing content")}buildLmStudioModelsUrl(e){try{let t=new URL((e||"").trim()),n=t.pathname.replace(/\/+$/,""),r=n.endsWith("/v1")?n.slice(0,-3):n;return t.pathname=`${r||""}/api/v1/models`.replace(/\/{2,}/g,"/"),t.search="",t.hash="",t.toString()}catch(t){return null}}buildLmStudioNativeChatUrl(e){try{let t=new URL((e||"").trim()),n=t.pathname.replace(/\/+$/,""),r=n.endsWith("/v1")?n.slice(0,-3):n;return t.pathname=`${r||""}/api/v1/chat`.replace(/\/{2,}/g,"/"),t.search="",t.hash="",t.toString()}catch(t){return null}}estimateTextTokens(e){return e?Math.max(1,Math.ceil(e.length/3)):0}trimTextToApproxTokenBudget(e,t){let n=Math.max(0,Math.trunc(t));if(n<=0||!e)return"";let r=n*3;if(e.length<=r)return e;let i=e.slice(0,r),a=i.lastIndexOf(`

`),s=i.lastIndexOf(`
`),o=Math.max(i.lastIndexOf(". "),i.lastIndexOf("? "),i.lastIndexOf("! ")),l=Math.max(a,s,o);return l>=Math.floor(r*.7)?i=i.slice(0,l).trimEnd():i=i.trimEnd(),i}async getLmStudioPromptBudget(e,t,n,r,i){if(!this.isLmStudioProvider(e))return null;let a=this.buildLmStudioModelsUrl(e);if(!a)return null;try{let s={};t&&(s.Authorization=`Bearer ${t}`);let o=await this.requestLocalApiRaw(a,{headers:s,timeoutMs:3e3});if(o.statusCode>=400)return null;let l=JSON.parse(o.body.toString("utf8")),c=this.asRecord(l),p=Array.isArray(c==null?void 0:c.models)?c.models:[];for(let d of p){let _=this.asRecord(d);if(!_||B(_.key).trim()!==n)continue;let g=Array.isArray(_.loaded_instances)?_.loaded_instances:[],f=0;for(let O of g){let F=this.asRecord(O);if(!F)continue;let U=B(F.id).trim();if(U&&U!==n)continue;let V=this.asRecord(F.config),M=Number(V==null?void 0:V.context_length);if(Number.isFinite(M)&&M>0){f=Math.trunc(M);break}}let b=Number(_.max_context_length),k=Number.isFinite(b)&&b>0?Math.trunc(b):0;if(f<=0&&(f=k),f<=0)return null;let m=this.estimateTextTokens(i),x=Math.max(256,Math.min(2048,Math.max(Math.ceil(m*1.1),Math.floor(f*.2)))),w=Math.max(64,Math.min(x,Math.max(64,f-256))),E=Math.max(64,f-w-128),R=Math.max(64,Math.floor(E*.25)),v=this.trimTextToApproxTokenBudget(r,R),A=Math.max(64,E-this.estimateTextTokens(v)),N=this.trimTextToApproxTokenBudget(i,A);return{systemPrompt:v||r,userPrompt:N,maxOutputTokens:w}}}catch(s){console.debug("Failed to read LM Studio model metadata",s)}return null}extractTextSegments(e){if(typeof e=="string")return e?[e]:[];if(Array.isArray(e))return e.flatMap(i=>this.extractTextSegments(i));let t=this.asRecord(e);if(!t)return[];let n=B(t.type).trim().toLowerCase();if(n==="reasoning"||n==="reasoning_content"||n==="thinking")return[];let r=[];for(let i of["text","output_text","content","value"]){let a=t[i];typeof a=="string"?a&&r.push(a):a!==void 0&&r.push(...this.extractTextSegments(a))}return r}extractTextFromChatCompletionsPayload(e){let t=this.asRecord(e);if(!t)return"";let n=[],r=Array.isArray(t.choices)?t.choices:[],i=this.asRecord(r[0]),a=this.asRecord(i==null?void 0:i.message);return n.push(...this.extractTextSegments(a==null?void 0:a.content)),n.push(...this.extractTextSegments(i==null?void 0:i.text)),n.push(...this.extractTextSegments(t.output_text)),n.join("").trim()}extractTextFromResponsesPayload(e){let t=this.asRecord(e);if(!t)return"";let n=[];n.push(...this.extractTextSegments(t.output_text));let r=Array.isArray(t.output)?t.output:[];for(let a of r){let s=this.asRecord(a);s&&(B(s.type).trim().toLowerCase()==="message"?n.push(...this.extractTextSegments(s.content)):n.push(...this.extractTextSegments(s)))}let i=this.asRecord(t.response);if(i){n.push(...this.extractTextSegments(i.output_text));let a=Array.isArray(i.output)?i.output:[];for(let s of a)n.push(...this.extractTextSegments(s))}return n.join("").trim()}extractTextFromLmStudioNativeChatPayload(e){let t=this.asRecord(e);if(!t)return"";let n=[],r=Array.isArray(t.output)?t.output:[];for(let i of r)n.push(...this.extractTextSegments(i));return n.join("").trim()}async requestLmStudioNativeText(e){var _,g;let t=this.buildLmStudioNativeChatUrl(e.baseUrl);if(!t)throw new Error("LM Studio native chat endpoint is invalid.");let n={"Content-Type":"application/json"};e.apiKey&&(n.Authorization=`Bearer ${e.apiKey}`);let r=await this.getLmStudioPromptBudget(e.baseUrl,e.apiKey,e.model,e.systemPrompt,e.userPrompt),i=(_=r==null?void 0:r.systemPrompt)!=null?_:e.systemPrompt,a=(g=r==null?void 0:r.userPrompt)!=null?g:e.userPrompt,s=r==null?void 0:r.maxOutputTokens,o=`${i}

${a}`.trim(),l={model:e.model,input:o,reasoning:e.reasoningMode};s&&Number.isFinite(s)&&s>0&&(l.max_output_tokens=s);let c=await this.requestLocalApiRaw(t,{method:"POST",headers:n,body:JSON.stringify(l)});if(c.statusCode>=400){let f=c.body.toString("utf8");throw new Error(`LM Studio native chat request failed (${c.statusCode}): ${f||"no response body"}`)}let p=JSON.parse(c.body.toString("utf8")),d=this.extractTextFromLmStudioNativeChatPayload(p);if(!d)throw new Error("LM Studio native chat response missing content");return d}buildCleanupModeMemoryKey(e,t,n){return JSON.stringify({provider:(t||"").trim()||(this.isLmStudioProvider(e,t)?"lm-studio":"custom"),baseUrl:(e||"").trim().replace(/\/+$/,"").toLowerCase(),model:(n||"").trim()})}getCleanupModeMemoryEntry(e){var a;let t=this.asRecord((a=this.settings.llmCleanupModeMemory)==null?void 0:a[e]);if(!t)return null;let n=B(t.mode).trim(),r=Number(t.lastPreferredProbeAt),i=Number(t.updatedAt);return n!=="lmstudio_native_reasoning_on"&&n!=="lmstudio_native_reasoning_off"||!Number.isFinite(r)||!Number.isFinite(i)?null:{mode:n,lastPreferredProbeAt:Math.trunc(r),updatedAt:Math.trunc(i)}}async setCleanupModeMemoryEntry(e,t){let n=this.getCleanupModeMemoryEntry(e);n&&n.mode===t.mode&&n.lastPreferredProbeAt===t.lastPreferredProbeAt&&n.updatedAt===t.updatedAt||(this.settings.llmCleanupModeMemory={...this.settings.llmCleanupModeMemory||{},[e]:t},await this.saveSettings())}shouldReprobeCleanupPreferredMode(e,t=Date.now()){return e?e.mode==="lmstudio_native_reasoning_on"?!1:t-e.lastPreferredProbeAt>=Qn:!0}isCleanupModeSwitchableError(e){let t=(e||"").toLowerCase();return t.includes("compute error")||t.includes("internal_error")||t.includes("missing content")||t.includes("response missing")}buildLmStudioCleanupAttemptModes(e,t,n){let r=this.settings.llmCleanupReasoningMode||"auto";if(r==="on")return["lmstudio_native_reasoning_on"];if(r==="off")return["lmstudio_native_reasoning_off"];let i=this.buildCleanupModeMemoryKey(e,t,n),a=this.getCleanupModeMemoryEntry(i),s=[],o=l=>{s.includes(l)||s.push(l)};return a&&a.mode==="lmstudio_native_reasoning_off"?(this.shouldReprobeCleanupPreferredMode(a)&&o("lmstudio_native_reasoning_on"),o("lmstudio_native_reasoning_off"),o("lmstudio_native_reasoning_on"),s):(o("lmstudio_native_reasoning_on"),o("lmstudio_native_reasoning_off"),s)}async requestCleanupText(e,t){var _,g,f;let n=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),r=(this.settings.llmCleanupModel||"").trim(),i=(this.settings.llmCleanupApiKey||"").trim(),a=this.settings.llmCleanupProviderProfileId;if(!this.isLmStudioProvider(n,a))return this.requestLlmText({baseUrl:n,apiKey:i,model:r,temperature:Number((_=this.settings.llmCleanupTemperature)!=null?_:0),systemPrompt:e,userPrompt:t,endpointMode:"chat"});let o=this.settings.llmCleanupReasoningMode||"auto",l=this.buildCleanupModeMemoryKey(n,a,r),c=this.buildLmStudioCleanupAttemptModes(n,a,r),p=!1,d=null;for(let b of c){b==="lmstudio_native_reasoning_on"&&(p=!0);try{let k=await this.requestLmStudioNativeText({baseUrl:n,apiKey:i,model:r,systemPrompt:e,userPrompt:t,reasoningMode:b==="lmstudio_native_reasoning_on"?"on":"off"});if(o==="auto"){let m=Date.now(),x={mode:b,lastPreferredProbeAt:b==="lmstudio_native_reasoning_on"||p?m:(f=(g=this.getCleanupModeMemoryEntry(l))==null?void 0:g.lastPreferredProbeAt)!=null?f:0,updatedAt:m};await this.setCleanupModeMemoryEntry(l,x)}return k}catch(k){d=k;let m=k instanceof Error?k.message:String(k),x=b===c[c.length-1];if(o!=="auto"||!this.isCleanupModeSwitchableError(m)||x){if(o==="auto"&&p&&x){let w=this.getCleanupModeMemoryEntry(l);w&&w.mode==="lmstudio_native_reasoning_off"&&await this.setCleanupModeMemoryEntry(l,{...w,lastPreferredProbeAt:Date.now(),updatedAt:w.updatedAt})}break}}}if(o==="auto"&&p){let b=this.getCleanupModeMemoryEntry(l);b&&b.mode==="lmstudio_native_reasoning_off"&&await this.setCleanupModeMemoryEntry(l,{...b,lastPreferredProbeAt:Date.now()})}throw d instanceof Error?d:new Error(String(d))}async requestLlmText(e){var c,p;let t=(e.baseUrl||"").trim().replace(/\/$/,""),n={"Content-Type":"application/json"};e.apiKey&&(n.Authorization=`Bearer ${e.apiKey}`);let r=await this.getLmStudioPromptBudget(t,e.apiKey,e.model,e.systemPrompt,e.userPrompt),i=(c=r==null?void 0:r.systemPrompt)!=null?c:e.systemPrompt,a=(p=r==null?void 0:r.userPrompt)!=null?p:e.userPrompt,s=r==null?void 0:r.maxOutputTokens,o=async(d,_)=>{var x;let g=`${t}/${d==="responses"?"responses":"chat/completions"}`,f=d==="responses"?{model:e.model,instructions:i,input:a}:{model:e.model,messages:[{role:"system",content:i},{role:"user",content:a}]};s&&Number.isFinite(s)&&s>0&&(d==="responses"?f.max_output_tokens=s:f.max_tokens=s),_&&Number.isFinite((x=e.temperature)!=null?x:NaN)&&(f.temperature=Number(e.temperature));let b=await this.requestLocalApiRaw(g,{method:"POST",headers:n,body:JSON.stringify(f)});if(b.statusCode>=400){let w=b.body.toString("utf8");throw new Error(`${d==="responses"?"Responses":"Chat"} request failed (${b.statusCode}): ${w||"no response body"}`)}let k=JSON.parse(b.body.toString("utf8")),m=d==="responses"?this.extractTextFromResponsesPayload(k):this.extractTextFromChatCompletionsPayload(k);if(!m)throw new Error(d==="responses"?"Responses response missing content":"Chat response missing content");return m},l=async d=>{try{return await o(d,!0)}catch(_){let g=_ instanceof Error?_.message:String(_);if(this.isTemperatureUnsupportedMessage(g))return o(d,!1);throw _}};if(e.endpointMode==="responses")try{return await l("responses")}catch(d){let _=d instanceof Error?d.message:String(d);if(this.isResponsesEndpointUnsupportedMessage(_))return l("chat");throw d}return l("chat")}logOptionalLookupFailure(e,t){if(this.isOptionalLookupNetworkError(t)){console.debug(`${e} (network unavailable)`,t);return}console.warn(e,t)}getPythonErrorMessage(e){if(e instanceof Error)return e.message||String(e);if(typeof e=="string")return e;try{return JSON.stringify(e)}catch(t){return String(e)}}summarizePythonDiagnostic(e,t){let n=e.split(/\r?\n/).map(a=>a.trimEnd()).filter(a=>!!a.trim());if(!n.length)return t;let r=n.findIndex(a=>a.startsWith("Traceback"));if(r>=0)return n.slice(r).slice(-12).join(`
...
`)}buildImportTempPath(e,t){let n=(0,h.normalizePath)(S.default.dirname(e)),r=S.default.extname(e),i=S.default.basename(e,r),a=`${Date.now()}-${Math.random().toString(36).slice(2,8)}`;return(0,h.normalizePath)(S.default.join(n,`${i}.zrr-${t}-${a}${r}`))}async removeVaultFilesIfExist(e){let t=this.app.vault.adapter;for(let n of e){let r=(0,h.normalizePath)(n||"");if(r)try{await t.exists(r)&&await t.remove(r)}catch(i){console.warn("Failed to remove temporary import file",{target:r,error:i})}}}async replaceVaultFile(e,t){let n=this.app.vault.adapter,r=(0,h.normalizePath)(e),i=(0,h.normalizePath)(t);if(!r||!i||r===i)return;let a=(0,h.normalizePath)(S.default.dirname(i));a&&await this.ensureFolder(a),await n.exists(i)&&await n.remove(i),await n.rename(r,i)}async cleanupIndexedChunksForDoc(e){if(e)try{let t=this.getPluginDir(),n=S.default.join(t,"tools","delete_redis_doc_chunks.py");await this.runPython(n,["--redis-url",this.settings.redisUrl,"--prefix",this.getRedisKeyPrefix(),"--doc-id",e])}catch(t){console.warn("Failed to clean up Redis chunks after import failure",{docId:e,error:t})}}classifyIndexingError(e){let t=e.toLowerCase();return t.includes("embedding dim mismatch")||t.includes("dim mismatch")?"embed_dim_mismatch":t.includes("chunks json not found")?"chunks_missing":this.isRateLimitErrorMessage(e)&&(t.includes("embedding request failed")||t.includes("failed to embed query"))?"rate_limited":t.includes("embedding failed")||t.includes("embedding request failed")||t.includes("unloaded")||t.includes("crashed")||t.includes("model does not exist")||t.includes("failed to load model")||t.includes("connection refused")||t.includes("econnrefused")||t.includes("max retries exceeded")||t.includes("failed to establish a new connection")||t.includes("failed to fetch models")?"embed_failure":"unknown"}async confirmRebuildIndex(e){return new Promise(t=>{new at(this.app,e,t).open()})}async confirmPurgeRedisOrphans(){return new Promise(e=>{new st(this.app,e).open()})}async dropRedisIndex(e=!1){await this.ensureBundledTools();let t=this.getPluginDir(),n=S.default.join(t,"tools","drop_redis_index.py"),r=["--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName()];e&&r.push("--drop-docs"),await this.runPython(n,r)}async dropAndRebuildRedisIndex(){if(this.reindexCacheActive){new h.Notice("Reindex already running.");return}if(!(!await this.ensureRedisAvailable("drop/rebuild")||!await this.confirmRebuildIndex("This will remove the current RedisSearch index and rebuild it from cached chunks."))){try{await this.dropRedisIndex(!0)}catch(t){let n=t instanceof Error?t.message:String(t);if(n.includes("Unknown Index name")||n.includes("Unknown index name"))console.warn("Redis index missing; skipping drop step.");else{console.error("Failed to drop Redis index",t),new h.Notice("Failed to drop redis index. See console for details.");return}}await this.reindexRedisFromCache()}}async purgeRedisOrphanedKeys(){var i,a,s,o,l;if(!await this.ensureRedisAvailable("purge orphans")||!await this.confirmPurgeRedisOrphans())return;try{await this.ensureBundledTools()}catch(c){new h.Notice("Failed to sync bundled tools. See console for details."),console.error(c);return}let t=this.getPluginDir(),n=S.default.join(t,"tools","purge_redis_orphans.py"),r=["--redis-url",this.settings.redisUrl,"--key-prefix",this.getRedisKeyPrefix(),"--chunk-dir",this.getAbsoluteVaultPath(Y),"--item-dir",this.getAbsoluteVaultPath(oe)];try{let c=await this.runPythonWithOutput(n,r),p=null;try{p=c?JSON.parse(c):null}catch(w){console.warn("Failed to parse purge output",w)}if(!p){new h.Notice("Purge completed. See console for details.");return}let d=(i=this.asRecord(p))!=null?i:{},_=Number((a=d.keys_scanned)!=null?a:0),g=Number((s=d.keys_deleted)!=null?s:0),f=Number((o=d.docs_checked)!=null?o:0),b=Number((l=d.orphan_doc_count)!=null?l:0),k=[`Keys scanned: ${_}`,`Keys deleted: ${g}`,`Docs checked: ${f}`,`Orphan docs: ${b}`],m=await this.pruneDocIndexOrphans();k.push(`Doc index entries removed: ${m.removed}`),m.updated>0&&k.push(`Doc index entries updated: ${m.updated}`);let x=Array.isArray(d.sample_orphan_doc_ids)?d.sample_orphan_doc_ids.filter(Boolean):[];x.length&&k.push("","Sample doc_ids:",...x.map(w=>`- ${w}`)),new Se(this.app,"Redis orphan purge",k.join(`
`)).open(),g===0?new h.Notice("No orphaned redis keys found."):new h.Notice(`Deleted ${g} Redis keys.`)}catch(c){console.error("Failed to purge Redis orphans",c),new h.Notice("Failed to purge redis orphans. See console for details.")}}async reindexRedisFromCache(){if(this.lastReindexFailure=null,this.reindexCacheActive)return new h.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;let e=null,t=0;try{await this.ensureBundledTools()}catch(o){return new h.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let n=await this.listDocIds(Y);if(n.length===0)return new h.Notice("No cached chunks found."),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let r=this.getPluginDir(),i=S.default.join(r,"tools","index_redisearch.py"),a=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null,s=0;this.showStatusProgress("Reindexing cached chunks...",0),a&&this.appendToLogFile(a,`Reindex started: ${n.length} cached items`,"index_redisearch","INFO");for(let o of n){s+=1;let l=Math.round(s/n.length*100);this.showStatusProgress(`Reindexing ${s}/${n.length}`,l);let c=(0,h.normalizePath)(`${Y}/${o}.json`);try{let p=["--chunks-json",this.getAbsoluteVaultPath(c),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(p),this.appendEmbedContextArgs(p),this.settings.embedIncludeMetadata&&p.push("--embed-include-metadata"),this.appendChunkTaggingArgs(p,{allowRegenerate:!1}),a&&this.appendToLogFile(a,`Reindexing doc_id ${o}`,"index_redisearch","INFO"),await this.runPythonStreaming(i,p,d=>{let _=this.asRecord(d);if(!(!a||!_)&&_.type==="progress"&&_.message){let g=typeof _.message=="string"?_.message:"";if(!g)return;this.appendToLogFile(a,g,"index_redisearch","INFO")}},()=>{},a,"index_redisearch")}catch(p){t+=1;let d=this.getPythonErrorMessage(p),_=this.classifyIndexingError(d);if(console.error(`Failed to reindex ${o}`,p),_==="chunks_missing"){new h.Notice(`Chunks cache missing for ${o}. Reimport or rebuild this note.`);continue}if(_==="embed_dim_mismatch"){e={kind:"embed_dim_mismatch",message:d};break}if(_==="rate_limited"){e={kind:"embed_failure",message:d};break}if(_==="embed_failure"){e={kind:"embed_failure",message:d};break}}}if(e){if(this.showStatusProgress("Aborted",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,e.kind==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(l){return new h.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(l),this.lastReindexFailure="unknown",!1}this.lastReindexFailure="embed_dim_mismatch"}else this.isRateLimitErrorMessage(e.message)?(new h.Notice(this.getEmbeddingRateLimitMessage("rerun")),this.lastReindexFailure="rate_limited"):(new h.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing."),this.lastReindexFailure="embed_failure");return!1}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),t===0?new h.Notice(`Reindexed ${n.length} cached items.`):new h.Notice(`Reindexed ${n.length-t}/${n.length} items (see console).`);try{await this.pruneDocIndexOrphans()}catch(o){console.warn("Failed to prune doc index orphans",o)}return this.reindexCacheActive=!1,this.lastReindexFailure=null,!0}async reindexDocIdFromCache(e,t){if(this.lastReindexFailure=null,this.reindexCacheActive)return t&&new h.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;try{await this.ensureBundledTools()}catch(o){return t&&new h.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let n=(0,h.normalizePath)(`${Y}/${e}.json`);if(!await this.app.vault.adapter.exists(n))return t&&new h.Notice(`Chunks cache missing for ${e}.`),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let i=this.getPluginDir(),a=S.default.join(i,"tools","index_redisearch.py"),s=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;this.showStatusProgress(`Reindexing ${e}...`,0),s&&this.appendToLogFile(s,`Reindexing doc_id ${e}`,"index_redisearch","INFO");try{let o=["--chunks-json",this.getAbsoluteVaultPath(n),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(o),this.appendEmbedContextArgs(o),this.settings.embedIncludeMetadata&&o.push("--embed-include-metadata"),this.appendChunkTaggingArgs(o,{allowRegenerate:!1}),await this.runPythonStreaming(a,o,l=>{let c=this.asRecord(l),p=typeof(c==null?void 0:c.total)=="number"?c.total:0,d=typeof(c==null?void 0:c.current)=="number"?c.current:0;if((c==null?void 0:c.type)==="progress"&&p>0){let _=Math.round(d/p*100),g=typeof c.message=="string"&&c.message.trim()?c.message:`Indexing chunks ${d}/${p}`;this.showStatusProgress(this.formatStatusLabel(g),_)}},()=>{},s,"index_redisearch")}catch(o){let l=this.getPythonErrorMessage(o),c=this.classifyIndexingError(l);if(console.error(`Failed to reindex ${e}`,o),c==="embed_dim_mismatch"){if(this.lastReindexFailure="embed_dim_mismatch",t&&await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),this.reindexCacheActive=!1,await this.reindexRedisFromCache()}catch(d){new h.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(d),this.lastReindexFailure="unknown"}}else c==="rate_limited"?(this.lastReindexFailure="rate_limited",t&&new h.Notice(this.getEmbeddingRateLimitMessage("rerun"))):c==="embed_failure"?(this.lastReindexFailure="embed_failure",t&&new h.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing.")):t&&new h.Notice(`Failed to reindex ${e}. See console for details.`);return this.showStatusProgress("Failed",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!1}return this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!0}async reindexChunkUpdates(e,t,n,r){if(!n.length&&!r.length||!await this.ensureRedisAvailable("reindex updates"))return;let i=this.getPluginDir(),a=S.default.join(i,"tools","index_redisearch.py"),s=["--chunks-json",this.getAbsoluteVaultPath(t),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert"];this.appendEmbedSubchunkArgs(s),this.appendEmbedContextArgs(s),this.settings.embedIncludeMetadata&&s.push("--embed-include-metadata"),this.appendChunkTaggingArgs(s,{allowRegenerate:!1}),n.length&&s.push("--chunk-ids",n.join(",")),r.length&&s.push("--delete-chunk-ids",r.join(","));try{await this.runPython(a,s)}catch(o){let l=this.getPythonErrorMessage(o),c=this.classifyIndexingError(l);if(console.error(`Failed to reindex updated chunks for ${e}`,o),c==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(d){new h.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(d)}return}if(c==="rate_limited"){new h.Notice(this.getEmbeddingRateLimitMessage("rerun"));return}c==="embed_failure"&&new h.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.")}}async promptZoteroItem(){return new Promise(e=>{new dt(this.app,this,e).open()})}async listDocIds(e){let t=this.app.vault.adapter,n=(0,h.normalizePath)(e);return await t.exists(n)?(await t.list(n)).files.filter(i=>i.endsWith(".json")).map(i=>S.default.basename(i,".json")):[]}async listMarkdownFiles(e){let t=this.app.vault.adapter,n=(0,h.normalizePath)(e);if(!await t.exists(n))return[];let r=[n],i=[];for(;r.length>0;){let a=r.pop();if(!a)continue;let s=await t.list(a);for(let o of s.files)o.endsWith(".md")&&i.push(o);for(let o of s.folders)r.push(o)}return i}getZoteroFrontmatterKeyVariants(e){let t=e.replace(/_/g," "),n=new Set([t,e,e.replace(/_/g,"-")]);if(e.includes("_")){let r=e.split("_"),i=r[0]+r.slice(1).map(a=>a.charAt(0).toUpperCase()+a.slice(1)).join("");n.add(i)}return Array.from(n)}getFrontmatterValue(e,t){if(!e)return;let n=this.getZoteroFrontmatterKeyVariants(t);for(let r of n)if(Object.prototype.hasOwnProperty.call(e,r))return e[r]}hasFrontmatterKey(e,t){if(!e)return!1;let n=this.getZoteroFrontmatterKeyVariants(t);for(let r of n)if(Object.prototype.hasOwnProperty.call(e,r))return!0;return!1}normalizeZoteroFrontmatterKeys(e){let t=!1;for(let n of hn){let r=n.replace(/_/g," "),i=this.getZoteroFrontmatterKeyVariants(n),a=Object.prototype.hasOwnProperty.call(e,r),s=a?e[r]:void 0;if(!a){for(let o of i)if(o!==r&&Object.prototype.hasOwnProperty.call(e,o)){s=e[o];break}}if(s!==void 0){a||(e[r]=s,t=!0);for(let o of i)o!==r&&Object.prototype.hasOwnProperty.call(e,o)&&(delete e[o],t=!0)}}return t}async normalizeZoteroFrontmatterKeysInFile(e){let t=this.app.metadataCache.getFileCache(e),n=t==null?void 0:t.frontmatter;if(!n)return;let r=this.getFrontmatterValue(n,"doc_id"),i=this.getFrontmatterValue(n,"zotero_key");if(!r&&!i)return;let a={...n};if(!this.normalizeZoteroFrontmatterKeys(a))return;let s=e.path;this.noteSyncSuppressed.add(s),this.noteMetadataSyncSuppressed.add(s);try{await this.app.fileManager.processFrontMatter(e,o=>{this.normalizeZoteroFrontmatterKeys(o)})}catch(o){console.warn("Failed to normalize Zotero frontmatter keys",o)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(s),this.noteMetadataSyncSuppressed.delete(s)},1500)}}normalizeFrontmatterKeySpacing(e){return e.trim()?e.split(/\r?\n/).map(r=>{var l,c;if(/^\s+-\s+/.test(r)||!r.includes(":")||((c=(l=r.match(/^\s*/))==null?void 0:l[0])!=null?c:""))return r;let a=r.indexOf(":");if(a<=0)return r;let s=r.slice(0,a).trim(),o=r.slice(a);for(let p of hn){let d=p.replace(/_/g," ");if(this.getZoteroFrontmatterKeyVariants(p).includes(s))return`${d}${o}`}return r}).join(`
...
`;n.replaceRange(l,{line:i.startLine+1,ch:0},{line:i.endLine,ch:0}),this.showStatusProgress("Chunk cleaned.",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new h.Notice("Chunk cleaned.")}async requestOcrCleanup(e){let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new h.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let r=Number(this.settings.llmCleanupMaxChars||0);if(r>0&&e.length>r)return new h.Notice("Chunk exceeds ocr cleanup max length. Adjust settings to clean it."),this.openPluginSettings(),null;try{let i=await this.requestCleanupText(this.getOcrCleanupSystemPrompt(),e),a=this.escapeGenderStars(String(i||"").trim());return a||(new h.Notice("Cleanup returned empty text."),null)}catch(i){return console.error("OCR cleanup failed",i),new h.Notice("Ocr cleanup failed. Check the cleanup model settings."),null}}getOcrCleanupSystemPrompt(){return["You clean OCR text into Markdown.","Correct OCR errors only when the intended text is clear.","Do not add, remove, or invent content.","Preserve wording, punctuation, and special characters.","Return only the corrected text.","Reformat existing footnote references as [^n].","Reformat existing footnote definitions as [^n]: ....","Do not create new footnotes; only reformat footnotes that already exist.","If paragraph breaks are completely missing, insert them only where the sentence structure clearly supports them.","Do not escape asterisks used for Markdown emphasis, list bullets, multiplication, or other non-gender uses.","Adding the backslash for escaping literal gender stars is allowed and does not count as adding content."].join(" ")}escapeGenderStars(e){return e&&e.replace(/(?<!\\)\b([A-Za-zÄÖÜäöüß]{2,})\*(in(?:nen)?|r|n|m|s)\b/g,(t,n,r)=>`${n}\\*${r}`)}parseChunkTags(e,t){if(!e)return[];let n=e.trim(),r=[];if(n.startsWith("[")&&n.endsWith("]"))try{let s=JSON.parse(n);Array.isArray(s)&&(r=s.map(o=>String(o)))}catch(s){r=[]}r.length===0&&(r=n.split(/[,;\n]+/));let i=new Set,a=[];for(let s of r){let o=s.trim();if(o=o.replace(/^[-•\d.)\s]+/,""),o=o.replace(/\s+/g," ").trim(),!o||o.length<2)continue;let l=o.toLowerCase();if(!i.has(l)&&(i.add(l),a.push(o),a.length>=t))break}return a}async requestChunkTags(e){let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new h.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let r=e.trim().slice(0,2e3);if(!r)return[];let i=5,a="Return 3 to 5 high-signal, concrete noun-phrase tags. Avoid generic terms (study, paper, method), verbs, and filler. Prefer specific entities, methods, datasets, and named concepts. Output comma-separated tags only. No extra text.";this.showStatusProgress("Generating tags...",null);try{let s=await this.requestCleanupText(a,r),o=this.parseChunkTags(String(s||""),i);return o.length||new h.Notice("Tag generation returned no tags."),o}catch(s){return console.error("Tag generation failed",s),new h.Notice("Tag generation failed. Check the cleanup model settings."),null}finally{this.clearStatusProgress()}}async renderMarkdownToIndexText(e){if(!e)return"";let t=this.replaceImageMarkersForIndexPreview(e),n=document.createElement("div"),r=new h.Component;r.load();try{await h.MarkdownRenderer.render(this.app,t,n,"",r)}catch(a){return console.warn("Failed to render markdown for index preview",a),this.normalizeIndexPreviewText(t)}finally{r.unload()}let i=n.textContent||t;return this.normalizeIndexPreviewText(i)}replaceImageMarkersForIndexPreview(e){if(!e)return"";let t=r=>{let i=r.trim();return i?`Image caption: ${i}`:"Image"},n=e.replace(/!\[\[([^\]|]+)(?:\|([^\]]+))?\]\]/g,(r,i,a)=>t(a||""));return n=n.replace(/!\[([^\]]*)]\([^)]+\)/g,(r,i)=>t(i||"")),n=n.replace(/<img[^>]*>/gi,r=>{let i=r.match(/\balt=(['"])([^'"]*)\1/i);return t(i?i[2]:"")}),n}normalizeIndexPreviewText(e){return e.replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/[ \t]+/g," ").replace(/\n{3,}/g,`

`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,t=1200){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let r=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},t);this.noteSyncTimers.set(e.path,r)}scheduleNoteMetadataSync(e,t=1200,n="save"){let r=this.noteMetadataSyncTimers.get(e.path);r!==void 0&&window.clearTimeout(r);let i=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,n)},t);this.noteMetadataSyncTimers.set(e.path,i)}scheduleNoteAnnotationSync(e,t=1200,n="save"){let r=this.noteAnnotationSyncTimers.get(e.path);r!==void 0&&window.clearTimeout(r);let i=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,n)},t);this.noteAnnotationSyncTimers.set(e.path,i)}getAnnotationGraceRemaining(e){let t=this.annotationNoteEditTimes.get(e);if(!t)return 0;let n=Date.now()-t;return n>=mn?0:mn-n}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let t=(e.annotation_page_label||"").trim();if(t)return t;let n=e.page_start?String(e.page_start):"",r=e.page_end?String(e.page_end):"";if(n&&(!r||n===r))return n;if(n&&r)return`${n} - ${r}`;let i=(e.pages||"").trim();if(!i)return"?";let a=i.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:i.replace("-"," - ")}normalizeChunkIdForNote(e,t){if(!e)return null;let n=String(e);if(t&&n.startsWith(`${t}:`))return n.slice(t.length+1);if(n.includes(":")){let r=n.split(":");if(r.length>1&&t&&r[0]===t)return r.slice(1).join(":")}return n}async syncNoteToRedis(e){if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let t=await this.app.vault.read(e),n=this.extractSyncSection(t);if(!n)return;let r=await this.resolveDocIdForNote(e,t);if(!r)return;let i=this.parseSyncedChunkBlocks(n);if(!i.length)return;let a=(0,h.normalizePath)(`${Y}/${r}.json`),s=this.app.vault.adapter;if(!await s.exists(a)&&!await this.restoreMissingChunkCacheFromNote(e,t,r,!1))return;let o=await this.readChunkPayload(a);if(!o)return;let l=Array.isArray(o.chunks)?o.chunks:[],c=new Map;for(let k of l){if(this.isAnnotationChunk(k))continue;let m=typeof(k==null?void 0:k.chunk_id)=="string"?k.chunk_id:"";m&&c.set(m,k)}let p=new Set,d=new Set,_=new Set,g=new Set,f=!1;for(let k of i){let m=k.chunkId;if(!m)continue;p.add(m);let x=c.get(m);if(!x){console.warn(`Sync note: chunk id not found in cache (${m})`);continue}if(k.excludeFlag){x.excluded!==!0&&(x.excluded=!0,f=!0);let R=this.normalizeChunkText(k.text),v=typeof x.text=="string"?x.text:"";R&&R!==v&&(x.text=R,x.char_count=R.length,f=!0),_.add(m);continue}if(x.excluded&&(x.excluded=!1,f=!0,d.add(m)),!k.text.trim()){_.add(m),g.add(m);continue}let w=this.normalizeChunkText(k.text);if(!w){_.add(m),g.add(m);continue}let E=typeof x.text=="string"?x.text:"";w!==E&&(x.text=w,x.char_count=w.length,d.add(m),f=!0)}for(let k of c.keys())p.has(k)||(_.add(k),g.add(k));let b=new Set([..._,...g]);if(b.size){let k=Array.from(b).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==k){this.noteSyncPendingDeletes.set(e.path,k),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!d.size&&!_.size&&!g.size&&!f)return;g.size&&(o.chunks=l.filter(k=>{let m=typeof(k==null?void 0:k.chunk_id)=="string"?k.chunk_id:"";return m&&!g.has(m)}),f=!0),(f||g.size)&&await s.write(a,JSON.stringify(o,null,2)),await this.reindexChunkUpdates(r,a,Array.from(d),Array.from(_)),(_.size||g.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(t){console.warn("Failed to sync note edits to Redis",t)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,t){var n,r,i,a;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,t);return}this.noteMetadataSyncInFlight.add(e.path);try{let s=await this.app.vault.read(e),o=await this.resolveDocIdForNote(e,s);if(!o)return;let l=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter;if(!l)return;let c=this.resolveZoteroItemKey(l,o);if(!c)return;let p=this.asRecord(await this.fetchZoteroItem(c)),d=(r=this.asRecord(p==null?void 0:p.data))!=null?r:p;if(!d||typeof d!="object")return;let _=this.extractNoteMetadata(l),g=this.extractZoteroMetadata(d);g.citekey||(g.citekey=await this.resolveZoteroCitekey(d,c,(i=this.asRecord(p==null?void 0:p.meta))!=null?i:{}));let f=await this.getMetadataSnapshot(o,l,e),b={},k={},m={},x=[],w=["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],E={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publication_title:"publication_title",book_title:"book_title",journal_abbrev:"journal_abbrev",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},R=Object.fromEntries(w.map(O=>[O,this.hasFrontmatterKey(l,E[O])])),v=new Set(["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","authors","editors"]),A=w.filter(O=>R[O]||!this.isMetadataValueEmpty(_[O])||!this.isMetadataValueEmpty(g[O]));if(!A.length)return;let N={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publication_title:"Publication title",book_title:"Book title",journal_abbrev:"Journal abbreviation",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let O of A){let F=_[O],U=g[O];if(this.metadataValuesEqual(O,F,U))continue;let V=this.isMetadataValueEmpty(F),M=this.isMetadataValueEmpty(U),G=f==null?void 0:f[O];if(G===void 0){if(V&&!M){m[O]="zotero",this.assignMetadataUpdate(b,O,U);continue}if(!V&&M&&v.has(O)){m[O]="note",this.assignMetadataUpdate(k,O,F);continue}}if(G!==void 0){let W=!this.metadataValuesEqual(O,F,G),Z=!this.metadataValuesEqual(O,U,G);if(W&&!Z){m[O]="note",this.assignMetadataUpdate(k,O,F);continue}if(!W&&Z){m[O]="zotero",this.assignMetadataUpdate(b,O,U);continue}}let T=this.getMetadataDecisionLabels(O,F,U,N);x.push({field:O,fieldLabel:N[O],noteLabel:T.noteLabel,zoteroLabel:T.zoteroLabel,noteValue:this.formatMetadataValue(F),zoteroValue:this.formatMetadataValue(U)})}if(x.length>0){let O=await this.promptMetadataBatchDecision(x);for(let F of x){let U=(a=O[F.field])!=null?a:"skip";m[F.field]=U,U==="note"?this.assignMetadataUpdate(k,F.field,_[F.field]):U==="zotero"&&this.assignMetadataUpdate(b,F.field,g[F.field])}}Object.keys(b).length>0&&await this.applyNoteMetadataUpdates(e,b),Object.keys(k).length>0&&await this.applyZoteroMetadataUpdates(c,d,_,g,k),await this.updateMetadataSnapshot(e,o,_,g,f,m,A)}catch(s){console.warn("Failed to sync note metadata with Zotero",s)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,t)}}async syncNoteAnnotationsWithZotero(e,t){var n,r,i,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,t);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),p=await this.resolveDocIdForNote(e,o);if(!p&&c.docId){p=c.docId;let M=this.ensureDocIdInNoteContent(o,p);M!==o&&await this.writeNoteWithSyncSuppressed(e.path,M)}if(!p)return;let d=(r=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter)!=null?r:{},_=(i=c.attachmentKey)!=null?i:"";if(_||(_=await this.resolveAttachmentKeyForDocId(p,d)),!_)return;c.attachmentKey&&(!c.docId||c.docId===p)&&c.attachmentKey===_&&await this.updateDocIndex({doc_id:p,attachment_key:_});let g=_,f=await this.fetchZoteroAnnotationsForDoc(p,_),b=f.annotations;_=f.attachmentKey,_&&_!==g&&await this.updateDocIndex({doc_id:p,attachment_key:_});let k=this.parseAnnotationBlock(l.block,_),m=new Map;for(let M of k)M.key&&M.imagePath&&m.set(M.key,{path:M.imagePath,hash:M.imageHash||this.extractAnnotationImageHashFromPath(M.imagePath)});await this.attachAnnotationImages(p,_,b,e.path,m);let x=new Map;for(let M of k)M.key&&x.set(M.key,M);let w=new Map;for(let M of b)w.set(M.key,M);let E=!1,R=!1,v=!1;if(f.hadFetchError)x.size>0&&b.length===0&&console.debug("Skipping annotation-prune sync due incomplete Zotero annotation fetch.",{docId:p,attachmentKey:_,reason:t});else for(let M of x.keys())w.has(M)||(R=!0);let A=await this.getAnnotationSnapshot(p),N=(a=A==null?void 0:A.annotations)!=null?a:{},O={},F=[];_&&_!==g&&b.length>0&&(R=!0,v=!0);for(let[M,G]of w.entries()){let T=x.get(M);if(!T){R=!0;continue}let W=N[M],Z=this.annotationSnapshotFromEntry(T,G.annotationType),H=this.annotationSnapshotFromEntry(G,G.annotationType),I=(Z.image_hash||"")!==(H.image_hash||"");if(!W){this.annotationSnapshotsEqualIgnoringImage(Z,H)?I&&(R=!0,v=!0):(O[M]="note",E=!0);continue}let q=!this.annotationSnapshotsEqual(Z,W),j=!this.annotationSnapshotsEqual(H,W),z=(H.color_key||"")!==(W.color_key||""),$=!this.annotationSnapshotsEqualIgnoringImage(Z,W),K=!this.annotationSnapshotsEqualIgnoringImage(H,W);$&&!K?(O[M]="note",E=!0):!$&&K?(O[M]="zotero",R=!0):$&&K&&F.push({key:M,title:this.formatAnnotationConflictTitle(G),noteValue:this.formatAnnotationConflictValue(Z,T.tags),zoteroValue:this.formatAnnotationConflictValue(H,G.tags)}),I&&(q||j)&&(R=!0,v=!0),z&&(R=!0,v=!0)}if(F.length>0){let M=await this.promptAnnotationBatchDecision(F);for(let G of F){let T=(s=M[G.key])!=null?s:"skip";O[G.key]=T,T==="note"?E=!0:T==="zotero"&&(R=!0,v=!0)}}let U=[];for(let[M,G]of Object.entries(O)){if(G!=="note")continue;let T=x.get(M),W=w.get(M);!T||!W||U.push({entry:W,note:T})}U.length>0&&await this.applyZoteroAnnotationUpdates(U),E&&this.annotationNoteEditTimes.set(e.path,Date.now());let V=this.getAnnotationGraceRemaining(e.path);if(R&&V>0&&E&&!v&&(this.scheduleNoteAnnotationSync(e,V+250,t),R=!1),R){let M=this.buildAnnotationBlock(p,_,b),G=this.replaceAnnotationBlock(o,M);if(G&&G!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,G)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(p,_,b),await this.updateAnnotationChunks(p,_,b,{allowDeletes:!f.hadFetchError})}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,t)}}resolveZoteroItemKey(e,t){let n=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),t];for(let r of n){let i=B(r);if(i)return i}return""}async resolveAttachmentKeyForDocId(e,t){var l;if(!e)return"";let n=await this.getDocIndexEntry(e);if(n||(n=await this.hydrateDocIndexFromCache(e)),n!=null&&n.attachment_key)return n.attachment_key;let r=(0,h.normalizePath)(`${Y}/${e}.json`);try{if(await this.app.vault.adapter.exists(r)){let p=await this.readChunkPayload(r),d=this.asRecord(p==null?void 0:p.metadata),_=d==null?void 0:d.attachment_key;if(typeof _=="string"&&_.trim())return await this.updateDocIndex({doc_id:e,attachment_key:_.trim()}),_.trim()}}catch(c){}let i=this.resolveZoteroItemKey(t,e);if(!i)return"";let a=this.asRecord(await this.fetchZoteroItem(i)),s=(l=this.asRecord(a==null?void 0:a.data))!=null?l:a;if(!s||typeof s!="object")return"";let o=await Me(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var w,E,R,v,A,N,O,F,U,V,M,G,T,W,Z,H,I,q,j,z,$,K;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString((v=(R=(E=(w=e==null?void 0:e["short title"])!=null?w:e==null?void 0:e.short_title)!=null?E:e==null?void 0:e.shortTitle)!=null?R:e==null?void 0:e["short-title"])!=null?v:e==null?void 0:e["title-short"]),r=this.normalizeMetadataString((F=(O=(N=(A=e==null?void 0:e.citekey)!=null?A:e==null?void 0:e["citation key"])!=null?N:e==null?void 0:e.citation_key)!=null?O:e==null?void 0:e.citationKey)!=null?F:e==null?void 0:e["citation-key"]),i=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString((U=e==null?void 0:e.abstract)!=null?U:e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((V=e==null?void 0:e.doi)!=null?V:e==null?void 0:e.DOI),o=this.normalizeMetadataString((T=(G=(M=e==null?void 0:e["publication title"])!=null?M:e==null?void 0:e.publication_title)!=null?G:e==null?void 0:e.publicationTitle)!=null?T:e==null?void 0:e["publication-title"]),l=this.normalizeMetadataString((H=(Z=(W=e==null?void 0:e["book title"])!=null?W:e==null?void 0:e.book_title)!=null?Z:e==null?void 0:e.bookTitle)!=null?H:e==null?void 0:e["book-title"]),c=this.normalizeMetadataString((j=(q=(I=e==null?void 0:e["journal abbrev"])!=null?I:e==null?void 0:e.journal_abbrev)!=null?q:e==null?void 0:e.journalAbbrev)!=null?j:e==null?void 0:e["journal-abbrev"]),p=this.normalizeMetadataString(e==null?void 0:e.publisher),d=this.normalizeMetadataString(e==null?void 0:e.place),_=this.normalizeMetadataString(e==null?void 0:e.issue),g=this.normalizeMetadataString(e==null?void 0:e.volume),f=this.normalizeMetadataString(e==null?void 0:e.pages),b=this.normalizeMetadataString((K=($=(z=e==null?void 0:e["item type"])!=null?z:e==null?void 0:e.item_type)!=null?$:e==null?void 0:e.itemType)!=null?K:e==null?void 0:e["item-type"]),k=this.normalizeMetadataList(e==null?void 0:e.tags),m=this.normalizeMetadataList(e==null?void 0:e.authors),x=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:t,short_title:n,citekey:r,date:i,abstract:a,doi:s,publication_title:o,book_title:l,journal_abbrev:c,publisher:p,place:d,issue:_,volume:g,pages:f,item_type:b,tags:this.sanitizeObsidianTags(k),authors:m,editors:x}}extractZoteroMetadata(e){var E,R,v;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString(ve(e)),r=this.normalizeMetadataString(Oe(e)),i=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString(e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((E=e==null?void 0:e.DOI)!=null?E:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publicationTitle),l=this.normalizeMetadataString(e==null?void 0:e.bookTitle),c=this.normalizeMetadataString(e==null?void 0:e.journalAbbreviation),p=this.normalizeMetadataString(e==null?void 0:e.publisher),d=this.normalizeMetadataString(e==null?void 0:e.place),_=this.normalizeMetadataString(e==null?void 0:e.issue),g=this.normalizeMetadataString(e==null?void 0:e.volume),f=this.normalizeMetadataString(e==null?void 0:e.pages),b=this.normalizeMetadataString((v=(R=e==null?void 0:e.itemType)!=null?R:e==null?void 0:e.item_type)!=null?v:e==null?void 0:e["item-type"]),k=Array.isArray(e==null?void 0:e.creators)?e.creators:[],m=k.filter(A=>(A==null?void 0:A.creatorType)==="author").map(A=>we(A)).filter(Boolean),x=k.filter(A=>(A==null?void 0:A.creatorType)==="editor"||(A==null?void 0:A.creatorType)==="seriesEditor").map(A=>we(A)).filter(Boolean),w=Array.isArray(e==null?void 0:e.tags)?e.tags.map(A=>{var N;return typeof A=="string"?A:(N=this.asRecord(A))==null?void 0:N.tag}).filter(A=>typeof A=="string"):[];return{title:t,short_title:n,citekey:r,date:i,abstract:a,doi:s,publication_title:o,book_title:l,journal_abbrev:c,publisher:p,place:d,issue:_,volume:g,pages:f,item_type:b,tags:this.sanitizeObsidianTags(w),authors:this.normalizeMetadataList(m),editors:this.normalizeMetadataList(x)}}async resolveZoteroCitekey(e,t,n){let r=this.normalizeMetadataString(Oe(e,n!=null?n:void 0));if(r)return r;if(!t)return"";let i=await this.fetchZoteroItemCsl(t);return this.normalizeMetadataString(xt(i))}extractAnnotationPageInfo(e){var a;let n=B((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),r=null,i=e.annotationPage;if(typeof i=="number"&&Number.isFinite(i))r=i;else if(typeof i=="string"&&i.trim()){let s=Number(i);Number.isFinite(s)&&(r=s)}if(r===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(r=o+1)}catch(s){}return{pageLabel:n,pageIndex:r}}extractAnnotationImagePayload(e){var a,s,o,l;let t=(s=(a=e.annotationImage)!=null?a:e.annotationImageData)!=null?s:e.annotationImageBase64;if(!t)return null;let n=null,r="";if(Buffer.isBuffer(t))n=t;else if(ArrayBuffer.isView(t))n=Buffer.from(t.buffer,t.byteOffset,t.byteLength);else if(t instanceof ArrayBuffer)n=Buffer.from(t);else if(typeof t=="string"){let c=t.trim();if(!c)return null;let p=c.match(/^data:([^;]+);base64,(.*)$/i);if(p&&(r=this.normalizeAnnotationImageMime(p[1]),c=p[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;n=Buffer.from(c,"base64")}if(!n||!n.length)return null;r||(r=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(n)||"image/png");let i=this.annotationImageExtensionFromMime(r)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(n))||"png";return{buffer:n,mime:r,ext:i}}parseZoteroAnnotationItem(e,t){var m,x,w,E;let n=(x=(m=e==null?void 0:e.data)!=null?m:e)!=null?x:{},r=B((w=e==null?void 0:e.key)!=null?w:n==null?void 0:n.key);if(!r)return null;let i=B(n.annotationType),a=this.normalizeAnnotationText(n.annotationText),s=this.normalizeAnnotationText(n.annotationComment),o=B(n.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:p}=this.resolveAnnotationColorMeta(l),{pageLabel:d,pageIndex:_}=this.extractAnnotationPageInfo(n),g=(E=n.annotationSortIndex)!=null?E:n.annotationSort,f=B(g).trim(),b=Number.isFinite(Number(f))?Number(f):Number.NaN,k=Array.isArray(n.tags)?n.tags.map(R=>{var v;return typeof R=="string"?R:(v=this.asRecord(R))==null?void 0:v.tag}).filter(R=>typeof R=="string"):[];return{key:r.trim(),attachmentKey:t,pageLabel:d,pageIndex:_,colorKey:l,callout:p,heading:c,annotationType:i,text:a,comment:s,tags:this.normalizeAnnotationTags(k),sortToken:f,sortIndex:b,rawValues:n}}async fetchZoteroAnnotations(e){if(!e)return{annotations:[],hadFetchError:!1};let t=this.canUseWebApi()||await this.ensureWebApiLibraryId(),n=!1,r=!1,i=o=>{var c,p;let l=[];for(let d of o){let _=this.asRecord(d),g=(p=(c=this.asRecord(_==null?void 0:_.data))!=null?c:_)!=null?p:{};if(B(g.itemType)!=="annotation")continue;let f=this.parseZoteroAnnotationItem(d,e);f&&l.push(f)}return l},a=[];try{a=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(o){try{a=await this.fetchZoteroChildrenLocal(e)}catch(l){n=!0,console.warn("Failed to fetch Zotero annotation items from local API",l)}}let s=i(a);if(!s.length&&t)try{let o=[];try{o=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(c){o=await this.fetchZoteroChildrenWeb(e)}r=!0;let l=i(o);l.length&&(s=l)}catch(o){n=!0,this.logOptionalLookupFailure("Failed to fetch Zotero annotation items from Web API",o)}return!s.length&&t&&!r&&(n=!0),!s.length&&!t&&(n=!0),{annotations:s,hadFetchError:n}}async fetchZoteroAnnotationsForDoc(e,t){var l,c;let n=t,r=await this.fetchZoteroAnnotations(n);if(r.annotations.length||!e)return r.annotations.length||this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:r.hadFetchError};let i=[];try{i=await this.fetchZoteroChildren(e)}catch(p){return console.warn("Failed to fetch Zotero attachments for annotations",p),this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:!0}}let a=r.hadFetchError,s=[],o=new Set(n?[n]:[]);for(let p of i){if(!kt(p))continue;let d=this.asRecord(p),_=this.asRecord(d==null?void 0:d.data),g=B((c=(l=d==null?void 0:d.key)!=null?l:_==null?void 0:_.key)!=null?c:d==null?void 0:d.attachmentKey);!g||o.has(g)||(o.add(g),s.push(g))}for(let p of s){let d=await this.fetchZoteroAnnotations(p);if(a=a||d.hadFetchError,d.annotations.length)return{attachmentKey:p,annotations:d.annotations,hadFetchError:a}}return this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:a}}async attachAnnotationImages(e,t,n,r,i){var d;if(!this.settings.includeAnnotationImages||!n.length)return;let a=await this.resolveAnnotationImageOutputDir(r);if(!a)return;let s=this.sanitizeFileName(e||t)||"annotations",o=(0,h.normalizePath)(S.default.join(a.relative||"",s)),l=S.default.normalize(S.default.join(a.absolute,s));o?await this.ensureFolder(o):await ee.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,p=new Map;for(let _ of n){let g=String(_.annotationType||"").trim().toLowerCase(),f=g==="image"||g==="ink",b=this.extractAnnotationImagePayload((d=_.rawValues)!=null?d:{});if(!b&&f&&this.settings.zoteroCompanionEnabled&&(b=await this.fetchCompanionAnnotationImage(_.key)),!b){let w=i==null?void 0:i.get(_.key);w!=null&&w.path&&await c.exists(w.path)&&(_.imagePath=w.path,_.imageHash=w.hash,p.set(_.key,w.path));continue}let k=(0,$e.createHash)("sha1").update(b.buffer).digest("hex").slice(0,12),m=`zrr-annotation-${_.key}-${k}.${b.ext}`,x=(0,h.normalizePath)(S.default.join(o,m));try{await c.exists(x)||await c.writeBinary(x,this.bufferToArrayBuffer(b.buffer)),_.imagePath=x,_.imageHash=k,p.set(_.key,x)}catch(w){console.warn("Failed to write annotation image",{annotationKey:_.key,error:w})}}if(o&&await c.exists(o))try{let _=await c.list(o);for(let g of _.files){let b=S.default.basename(g).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!b)continue;let k=b[1].toUpperCase(),m=p.get(k);(!m||(0,h.normalizePath)(m)!==(0,h.normalizePath)(g))&&await c.remove(g)}}catch(_){console.warn("Failed to clean up annotation images",_)}}async fetchCompanionAnnotationImage(e){let t=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!t)return null;let n=`${t.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,r={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(r.Authorization=`Bearer ${i}`);try{let a=await this.requestLocalApiRaw(n,{headers:r,timeoutMs:5e3});if(a.statusCode===200){let s=a.headers["content-type"],o=Array.isArray(s)?s[0]:s!=null?s:"";return this.buildAnnotationImagePayloadFromBuffer(a.body,o)}if(a.statusCode===204||a.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:a.statusCode})}catch(a){console.warn("Failed to fetch annotation image from Zotero companion",a)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new h.Notice("Zotero companion base URL is not set.");return}let t=`${e.replace(/\/$/,"")}/health`,n={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(n.Authorization=`Bearer ${r}`);try{let i=await this.requestLocalApiRaw(t,{headers:n,timeoutMs:3e3});if(i.statusCode===200){try{let a=JSON.parse(i.body.toString("utf8"));if(a!=null&&a.ok){new h.Notice("Zotero companion: OK.");return}}catch(a){}new h.Notice("Zotero companion responded but did not return OK.");return}if(i.statusCode===401){new h.Notice("Zotero companion: unauthorized (check token).");return}new h.Notice(`Zotero companion: HTTP ${i.statusCode}.`)}catch(i){console.warn("Zotero companion health check failed",i),new h.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new h.Notice("Opened Zotero. Go to tools \u2192 add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new h.Notice("Unable to open Zotero automatically. Open Zotero and go to tools \u2192 add-ons.")}}async spawnDetached(e){let[t,...n]=e;if(!t)throw new Error("Missing command");await new Promise((r,i)=>{let a=!1,s=(0,le.spawn)(t,n,{detached:!0,stdio:"ignore"});s.on("error",o=>{a||(a=!0,i(o))}),s.unref(),a||(a=!0,r())})}maybeWarnMissingAnnotationApi(e,t){if(this.canUseWebApi()){console.debug("No Zotero annotations returned for attachment",{docId:e,attachmentKey:t});return}let n=e||t;!n||this.annotationWebApiWarned.has(n)||(this.annotationWebApiWarned.add(n),new h.Notice("Zotero annotations require web API access. Configure the web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
${n}
<!-- zrr:sync-end -->`;let a=i.some(l=>{if(typeof(l==null?void 0:l.section)=="string"?l.section.trim():"")return!0;let p=typeof(l==null?void 0:l.chunk_id)=="string"?l.chunk_id.trim():"";return!!(p&&!/^p\d+$/i.test(p))}),s=[`<!-- zrr:sync-start doc_id=${e} -->`];for(let l of i){let c=typeof(l==null?void 0:l.chunk_id)=="string"?l.chunk_id.trim():"";if(!c)continue;let p=Number.isFinite((o=l==null?void 0:l.page_start)!=null?o:NaN)?Number(l.page_start):null,d=!!(l!=null&&l.excluded||l!=null&&l.exclude),g=typeof(l==null?void 0:l.text)=="string"?l.text.trim():"";if(a){let m=typeof(l==null?void 0:l.section)=="string"?l.section.trim():"",x=m?`## ${m}`:"";x&&!g.startsWith("#")&&(g=g?`${x}

${g}`:x)}let f=p!==null?a?` (${p})`:` page=${p}`:"",k=` id=${c}${a?" section":""}${f}${d?" exclude":""}`;s.push(`<!-- zrr:chunk${k} -->`),g&&s.push(g),s.push("<!-- zrr:chunk end -->"),s.push("")}return s[s.length-1]===""&&s.pop(),s.push("<!-- zrr:sync-end -->"),s.join(`
...
`).trim(),r=(a=e.pageIndex)!=null?a:0,i=e.pageLabel||(e.pageIndex?String(e.pageIndex):"");return{chunk_id:e.key,text:n,page_start:r,page_end:r,annotation_page_label:i,section:e.heading,chunk_tags:e.tags,is_annotation:!0,annotation_key:e.key,annotation_color:e.colorKey,annotation_text:e.text,annotation_comment:e.comment}}annotationChunkSignature(e){var t,n,r,i,a,s,o,l,c;return JSON.stringify({text:(t=e.text)!=null?t:"",page_start:(n=e.page_start)!=null?n:"",page_end:(r=e.page_end)!=null?r:"",section:(i=e.section)!=null?i:"",chunk_tags:Array.isArray(e.chunk_tags)?e.chunk_tags:(a=e.chunk_tags)!=null?a:"",annotation_color:(s=e.annotation_color)!=null?s:"",annotation_page_label:(o=e.annotation_page_label)!=null?o:"",annotation_text:(l=e.annotation_text)!=null?l:"",annotation_comment:(c=e.annotation_comment)!=null?c:""})}async updateAnnotationChunks(e,t,n,r){var b;let i=(r==null?void 0:r.allowDeletes)!==!1,a=(0,h.normalizePath)(`${Y}/${e}.json`),s=this.app.vault.adapter;if(!await s.exists(a))return;let o=await this.readChunkPayload(a);if(!o)return;let l=Array.isArray(o.chunks)?o.chunks:[],c=[],p=new Map;for(let k of l){let m=typeof(k==null?void 0:k.chunk_id)=="string"?k.chunk_id:"";m&&this.isAnnotationChunk(k)?p.set(m,k):c.push(k)}let d=[],_=[],g=new Set;for(let k of n){let m=this.buildAnnotationChunk(k),x=typeof m.chunk_id=="string"?m.chunk_id:"";if(!x)continue;g.add(x),d.push(m);let w=p.get(x);if(!w){_.push(x);continue}this.annotationChunkSignature(w)!==this.annotationChunkSignature(m)&&_.push(x)}let f=[];if(i)for(let k of p.keys())g.has(k)||f.push(k);else for(let[k,m]of p.entries())g.has(k)||d.push(m);if(o.chunks=[...c,...d],await s.write(a,JSON.stringify(o,null,2)),(_.length||f.length)&&await this.reindexChunkUpdates(e,a,_,f),t)try{let k=(b=this.asRecord(o.metadata))!=null?b:{};k.attachment_key!==t&&(k.attachment_key=t,o.metadata=k,await s.write(a,JSON.stringify(o,null,2)))}catch(k){}}resolveChunkFromPayload(e,t,n){let r=this.normalizeChunkIdForNote(t,n)||t,i=new Set([t,r,`${n}:${t}`]);for(let a of e){let s=typeof(a==null?void 0:a.chunk_id)=="string"?a.chunk_id:"";if(s&&i.has(s))return a}return null}async writeNoteWithSyncSuppressed(e,t){this.noteSyncSuppressed.add(e);try{await this.app.vault.adapter.write(e,t)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e)},1500)}}async resolveNotePathForDocId(e){if(!e)return null;let t=this.app.vault.adapter,n=await this.getDocIndexEntry(e);if(n!=null&&n.note_path&&await t.exists(n.note_path))return n.note_path;let i=(await this.scanNotesForDocIds(this.settings.outputNoteDir))[e];return i!=null&&i.note_path?(await this.updateDocIndex({doc_id:e,note_path:i.note_path,note_title:i.note_title}),i.note_path):null}isZoteroNoteFile(e){let t=this.app.metadataCache.getFileCache(e),n=t==null?void 0:t.frontmatter;return!!(this.getFrontmatterValue(n,"doc_id")||this.getFrontmatterValue(n,"zotero_key"))}async deleteZoteroNoteAndCacheForFile(e){var d,_;let t=e.path,n=await this.app.vault.read(e),r=(d=this.extractDocIdFromFrontmatter(n))!=null?d:this.extractDocIdFromSyncMarker(n);if(!r){new h.Notice("No doc_ID found in this note.");return}if(!await new Promise(g=>{new it(this.app,t,r,g).open()}))return;let a=this.app.vault.adapter,s=(0,h.normalizePath)(`${Y}/${r}.json`),o=(0,h.normalizePath)(`${oe}/${r}.json`),l=await this.getDocIndexEntry(r),c="",p=[];if(await a.exists(s)){let g=await this.readChunkPayload(s);p=(Array.isArray(g==null?void 0:g.chunks)?g==null?void 0:g.chunks:[]).map(m=>typeof(m==null?void 0:m.chunk_id)=="string"?m.chunk_id:"").map(m=>m.startsWith(`${r}:`)?m.slice(r.length+1):m).filter(m=>m);let b=typeof(g==null?void 0:g.source_pdf)=="string"?g.source_pdf:"",k=this.normalizeDocIndexPdfPath(b);k&&k.startsWith((0,h.normalizePath)(this.settings.outputPdfDir))&&await a.exists(k)&&(c=k)}if(!c){let g=this.normalizeDocIndexPdfPath((_=l==null?void 0:l.pdf_path)!=null?_:"");g&&g.startsWith((0,h.normalizePath)(this.settings.outputPdfDir))&&await a.exists(g)&&(c=g)}p.length>0&&await this.reindexChunkUpdates(r,s,[],p);try{if(await a.exists(s)&&await a.remove(s),await a.exists(o)&&await a.remove(o),await this.removeDocIndexEntry(r),c){let g=this.app.vault.getAbstractFileByPath(c);g instanceof h.TFile?await this.app.fileManager.trashFile(g):await a.exists(c)&&await a.remove(c)}await this.app.fileManager.trashFile(e),new h.Notice(`Deleted note and cache for ${r}.`)}catch(g){console.error("Failed to delete note and cached data",g),new h.Notice("Failed to delete note or cached data. See console for details.")}}async deleteZoteroNoteAndCache(){let e=this.app.workspace.getActiveViewOfType(h.MarkdownView);if(!e||!e.file){new h.Notice("No active Zotero note found.");return}await this.deleteZoteroNoteAndCacheForFile(e.file)}formatRedisSearchResults(e){var _;let t=(_=this.asRecord(e))!=null?_:{},n=typeof t.total=="number"?t.total:0,r=typeof t.query=="string"?t.query:"",i=typeof t.raw_query=="string"?t.raw_query:"",a=t.field_types&&typeof t.field_types=="object"?t.field_types:null,s=!!t.fallback_used,o=typeof t.fallback_reason=="string"?t.fallback_reason:"",l=Array.isArray(t.fallback_queries)?t.fallback_queries:[],c=Array.isArray(t.fallback_failed_fields)?t.fallback_failed_fields:[],p=Array.isArray(t.results)?t.results:[],d=[];if(d.push(`Query: ${i||r}`),r&&i&&r!==i&&d.push(`Expanded: ${r}`),d.push(`Total matches: ${n}`),a&&Object.keys(a).length>0){let g=Object.keys(a).sort().map(f=>{let b=a[f],k=typeof b=="string"||typeof b=="number"||typeof b=="boolean"?String(b):"";return`${f}:${k}`});d.push(`Field types: {${g.join(", ")}}`)}if(s&&d.push(`Fallback: ${o||"true"}`),l.length){d.push("Fallback queries:");for(let g of l)d.push(`  - ${g}`)}if(c.length&&d.push(`Fallback failed fields: ${c.join(", ")}`),d.push(""),!p.length)return d.push("(no results)"),d.join(`
`);for(let g of p){let f=String(g.doc_id||"").trim(),b=String(g.chunk_id||"").trim(),k=String(g.page_start||"").trim(),m=String(g.page_end||"").trim(),x=String(g.title||"").trim(),w=String(g.section||"").trim(),E=String(g.score||"").trim(),R=String(g.authors||"").trim(),v=String(g.item_type||"").trim(),A=String(g.year||"").trim(),N=String(g.tags||"").trim(),O=String(g.chunk_tags||"").trim(),F=String(g.attachment_key||"").trim(),U=String(g.source_pdf||"").trim(),V=String(g.text||"").replace(/\s+/g," ").trim(),M=V.length>220?`${V.slice(0,220)}\u2026`:V,G=[f];b&&G.push(b),(k||m)&&G.push(`p.${k||"?"}-${m||"?"}`),d.push(G.filter(Boolean).join(" \u2022 ")),E&&d.push(`  score: ${E}`),x&&d.push(`  title: ${x}`),R&&d.push(`  authors: ${R}`),A&&d.push(`  year: ${A}`),v&&d.push(`  item_type: ${v}`),N&&d.push(`  tags: ${N}`),O&&d.push(`  chunk_tags: ${O}`),F&&d.push(`  attachment_key: ${F}`),w&&d.push(`  section: ${w}`),U&&d.push(`  source_pdf: ${U}`),M&&d.push(`  ${M}`),d.push("")}return d.join(`
...
`)}async renderFrontmatter(e,t,n,r,i,a){var p;let s=(p=this.settings.frontmatterTemplate)!=null?p:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,t,n,r,i),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let t=e.split(/\r?\n/),n=[],r=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,i=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<t.length;){let l=t[o],c=l.match(r);if(!c){n.push(l),o+=1;continue}let p=c[1].trim(),d=c[2].trim();if(a.has(p)){n.push(l),o+=1;continue}if(!s(d)){n.push(l),o+=1;continue}let _=o+1,g=[];for(;_<t.length&&t[_].match(i);)g.push(t[_]),_+=1;if(g.length===0){for(o=_;o<t.length&&t[o].trim()==="";)o+=1;continue}let f=g.filter(b=>{let k=b.match(i);if(!k)return!1;let m=k[1].trim();return!s(m)});if(f.length>0&&n.push(l,...f),o=_,f.length===0)for(;o<t.length&&t[o].trim()==="";)o+=1}for(;n.length>0&&n[n.length-1].trim()==="";)n.pop();return n.join(`

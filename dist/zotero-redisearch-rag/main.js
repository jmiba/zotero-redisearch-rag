"use strict";var nn=Object.create;var Ne=Object.defineProperty;var rn=Object.getOwnPropertyDescriptor;var an=Object.getOwnPropertyNames;var sn=Object.getPrototypeOf,on=Object.prototype.hasOwnProperty;var ln=(g,p)=>{for(var e in p)Ne(g,e,{get:p[e],enumerable:!0})},ft=(g,p,e,t)=>{if(p&&typeof p=="object"||typeof p=="function")for(let n of an(p))!on.call(g,n)&&n!==e&&Ne(g,n,{get:()=>p[n],enumerable:!(t=rn(p,n))||t.enumerable});return g};var pe=(g,p,e)=>(e=g!=null?nn(sn(g)):{},ft(p||!g||!g.__esModule?Ne(e,"default",{value:g,enumerable:!0}):e,g)),cn=g=>ft(Ne({},"__esModule",{value:!0}),g);var En={};ln(En,{default:()=>Qe});module.exports=cn(En);var h=require("obsidian");var wt=require("@codemirror/state"),ee=require("@codemirror/view"),vt=require("obsidian");var ue=/<!--\s*zrr:sync-start[^>]*-->/i,fe=/<!--\s*zrr:sync-end\s*-->/i,ce=/<!--\s*zrr:chunk\b([^>]*)-->/i,De=/<!--\s*zrr:chunk\s+end\s*-->/i,xe=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,ht=g=>{let p=g.trim();if(!p.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(p)){let _=p.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:_?_[2]:void 0}}if(/^zrr:sync-end\b/i.test(p))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(p)){let _=p.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),m=p.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:_?_[2]:void 0,attachmentKey:m?m[2]:void 0}}if(/^zrr:annotations-end\b/i.test(p))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(p))return{type:"chunk-end"};let e=p.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let t=e[1]||"",n=t.match(/\bid=(["']?)([^"'\s]+)\1/i),i=n?n[2]:"",r=t.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:t.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(t)||/\bdelete\b/i.test(t),u=/\bsection\b/i.test(t);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:u?"section":c?"page":"section"}},it=g=>{var l;if(!g)return null;let p=g.match(ce);if(!p)return null;let e=p[1]||"",t=e.match(/\bid=(["']?)([^"'\s]+)\1/i),n=t?t[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=n&&(l=pn(n))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:n,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Te=g=>{for(let p=1;p<=g.lines;p+=1){let e=g.line(p).text;if(ue.test(e)){let t=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return t?t[2].trim():null}}return null},rt=(g,p)=>{let e=p;for(;e>=1;e-=1){let t=g.line(e).text;if(ce.test(t))return{line:e,text:t};if(ue.test(t)||fe.test(t))break}return null},dn=(g,p)=>{for(let e=p;e<=g.lines;e+=1){let t=g.line(e).text;if(De.test(t))return e;if(fe.test(t))break}return null},mt=(g,p)=>{let e=rt(g,p);if(!e)return null;let t=dn(g,e.line+1);return t===null||p<e.line||p>t?null:{startLine:e.line,endLine:t,text:e.text}},yt=(g,p,e)=>{if(p>e)return!1;for(let t=p;t<=e;t+=1){let n=g.line(t).text;if(xe.test(n))return!0}return!1},pn=g=>{var n;if(!g)return null;let e=(g.includes(":")&&(n=g.split(":").pop())!=null?n:g).match(/^p(\d+)$/i);if(!e)return null;let t=Number.parseInt(e[1],10);return Number.isFinite(t)?t:null};var bt=g=>{if(!g)return null;let p=g.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return p?it(p[0]):null};var un=(g,p)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),g.type==="sync-start"||g.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(g.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),g.type==="sync-start"?e.textContent=g.docId?`Redis Index Sync start - ${g.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e;if(g.type==="annotations-start"||g.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),g.type==="annotations-start"){let t=g.docId?` - ${g.docId}`:"";e.textContent=`Zotero annotations start${t}`}else e.textContent="Zotero annotations end";return e}if(g.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=g.chunkKind==="page"?"Page end":"Section end",g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),e;if(g.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),g.excluded&&e.classList.add("is-excluded"),g.pageNumber&&p>0)if(g.chunkKind==="section"){let t=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${t} (p${g.pageNumber}/${p})`}else e.textContent=`Page ${g.pageNumber}/${p}`;else if(g.pageNumber)if(g.chunkKind==="section"){let t=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${t} (p${g.pageNumber})`}else e.textContent=`Page ${g.pageNumber}`;else g.chunkId?e.textContent=`Section ${g.chunkId}`:e.textContent="Section";return g.excluded&&(e.textContent=`${e.textContent} - excluded`),e},at=class extends ee.WidgetType{constructor(p,e,t,n,i){super(),this.plugin=p,this.docId=e,this.chunkId=t,this.startLine=n,this.excluded=i}eq(p){return this.docId===p.docId&&this.chunkId===p.chunkId&&this.startLine===p.startLine&&this.excluded===p.excluded}toDOM(){let p=document.createElement("span");p.className="zrr-chunk-toolbar",p.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},t=(c,d,u)=>{let _=document.createElement("span");_.className="zrr-chunk-button-icon",(0,vt.setIcon)(_,d);let m=document.createElement("span");m.className="zrr-chunk-button-label",m.textContent=u,c.appendChild(_),c.appendChild(m)},n=document.createElement("button");n.type="button",n.className="zrr-chunk-button",t(n,"sparkles","Clean"),e(n,"Clean this chunk with the OCR cleanup model"),n.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),p.appendChild(n);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",t(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),p.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",t(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),p.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",t(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),p.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return t(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),p.appendChild(s),p}ignoreEvent(){return!0}},xt=(g,p)=>{var y;let e=g.state.doc,t=Te(e);if(!t)return ee.Decoration.none;let n=g.state.selection.main.head,i=e.lineAt(n).number,r=mt(e,i);if(!r)return ee.Decoration.none;let a=r.text.match(ce);if(!a)return ee.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return ee.Decoration.none;let l=o[2].trim();if(!l)return ee.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=yt(e,r.startLine+1,r.endLine-1),u=c||d,_=e.line(r.startLine),m=ee.Decoration.widget({widget:new at(p,t,l,r.startLine,u),side:1});return ee.Decoration.set([m.range(_.to)])},st=class extends ee.WidgetType{constructor(p,e){super(),this.info=p,this.totalPages=e}toDOM(){var p;return(p=un(this.info,this.totalPages))!=null?p:document.createElement("span")}},kt=g=>{var o,l;let p=g.dom.closest(".markdown-source-view");if(!p||!p.classList.contains("is-live-preview"))return ee.Decoration.none;let e=g.state.doc,t=new wt.RangeSetBuilder,n=[],i=[],r=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),u=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!u)continue;let _=ht(u[1]);_&&(_.type==="chunk-start"?(_.chunkKind=(o=_.chunkKind)!=null?o:_.pageNumber?"page":"section",_.pageNumber&&(r=!0),_.chunkKind==="section"&&(a=!0)):_.type==="chunk-end"&&(_.chunkKind=(l=_.chunkKind)!=null?l:"section"),n.push({line:c,from:d.from,to:d.to,info:_}),_.pageNumber&&i.push(_.pageNumber))}if(!n.length)return ee.Decoration.none;if(r&&!a)for(let c of n)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let c of n){let d=ee.Decoration.replace({widget:new st(c.info,s)});t.add(c.from,c.to,d)}return t.finish()},Pt=()=>ee.ViewPlugin.fromClass(class{constructor(g){this.decorations=kt(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=kt(g.view))}},{decorations:g=>g.decorations}),At=g=>ee.ViewPlugin.fromClass(class{constructor(p){this.decorations=xt(p,g)}update(p){(p.docChanged||p.selectionSet||p.viewportChanged)&&(this.decorations=xt(p.view,g))}},{decorations:p=>p.decorations});var te=require("child_process"),G=require("fs"),Yt=pe(require("http")),Qt=pe(require("https")),Ce=pe(require("net")),Se=pe(require("os")),en=pe(require("tls")),E=pe(require("path")),gt=require("url"),Ee=require("crypto");var N=require("obsidian"),Ct=require("crypto"),Oe=require("fs"),Ie=pe(require("path")),Y=".zotero-redisearch-rag",ne=`${Y}/items`,H=`${Y}/chunks`,St=`${Y}/metadata_snapshots.json`,Et=`${Y}/annotation_snapshots.json`,_n="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",Me={pythonRuntime:"worker",pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"BAAI/bge-reranker-v2-m3",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${Y}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Fe=class extends N.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async f=>{this.plugin.settings.llmProviderProfiles=f,await this.plugin.saveSettings()},i=f=>{f.inputEl.type="password",f.inputEl.autocomplete="off",f.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:f=>{f.createEl("h2",{text:"Prerequisites"});let k=null,x=null,v=null,R=null,A=null,S=null,L=null,M=(D,q)=>{if(!D)return;D.settingEl.classList.toggle("is-disabled",q),D.settingEl.style.opacity=q?"0.55":"";let U=D.settingEl.querySelector(".setting-item-description");U&&(U.style.color=q?"var(--text-faint)":"")},O=()=>{let D=this.plugin.settings.pythonRuntime==="local";R==null||R.setDisabled(!D),A==null||A.setDisabled(!D),L==null||L.setDisabled(!D),S&&(S.disabled=!D),M(k,!D),M(x,!D),M(v,!D)};new N.Setting(f).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(D=>D.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async q=>{this.plugin.settings.dockerPath=q.trim()||"docker",await this.plugin.saveSettings()})),new N.Setting(f).setName("Python runtime").setDesc("Recommended: Worker container (Docker/Podman Compose). Local interpreter mode is optional.").addDropdown(D=>{D.addOption("worker","Python worker container (recommended)"),D.addOption("local","Local interpreter/venv"),D.setValue(this.plugin.settings.pythonRuntime).onChange(async q=>{q!=="worker"&&q!=="local"||(this.plugin.settings.pythonRuntime=q,await this.plugin.saveSettings(),O())})}),k=new N.Setting(f).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(D=>(R=D,D.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async q=>{this.plugin.settings.pythonPath=q.trim(),await this.plugin.saveSettings()}))),x=new N.Setting(f).setName("Python environment").setDesc("Local mode: create or update the plugin's Python env. Worker mode: managed by Docker startup.").addButton(D=>{L=D,S=D.buttonEl,D.setButtonText("Create/Update").setCta(),D.onClick(async()=>{D.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{D.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),v=new N.Setting(f).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(D=>{A=D,D.addOption("shared","Shared user cache"),D.addOption("plugin","Plugin folder (.venv)"),D.setValue(this.plugin.settings.pythonEnvLocation).onChange(async q=>{q!=="shared"&&q!=="plugin"||(this.plugin.settings.pythonEnvLocation=q,await this.plugin.saveSettings())})}),O(),new N.Setting(f).setName("Redis URL").addText(D=>D.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async q=>{this.plugin.settings.redisUrl=q.trim(),await this.plugin.saveSettings()}));let $=null,F=null,z=null,j=null,I=()=>{let D=this.plugin.settings.autoAssignRedisPort;z==null||z.setDisabled(D),j==null||j.setDisabled(D),$==null||$.settingEl.classList.toggle("is-disabled",D),F==null||F.settingEl.classList.toggle("is-disabled",D)};new N.Setting(f).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(D=>D.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async q=>{this.plugin.settings.autoAssignRedisPort=q,await this.plugin.saveSettings(),I()})),$=new N.Setting(f).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(D=>(z=D,D.setPlaceholder("~/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async q=>{this.plugin.settings.redisDataDirOverride=q.trim(),await this.plugin.saveSettings()}))),$.settingEl.addClass("zrr-redis-override-setting"),F=new N.Setting(f).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(D=>(j=D,D.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async q=>{this.plugin.settings.redisProjectName=q.trim(),await this.plugin.saveSettings()}))),F.settingEl.addClass("zrr-redis-override-setting"),I(),new N.Setting(f).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(D=>D.setValue(this.plugin.settings.autoStartRedis).onChange(async q=>{this.plugin.settings.autoStartRedis=q,await this.plugin.saveSettings()})),new N.Setting(f).setName("Start Redis stack now").setDesc("Starts or restarts Redis stack (and Python worker in worker mode).").addButton(D=>D.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:f=>{f.createEl("h2",{text:"Zotero Local API"}),new N.Setting(f).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(A=>A.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async S=>{this.plugin.settings.zoteroBaseUrl=S.trim(),await this.plugin.saveSettings()}));let k=new N.Setting(f).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),x=null,v=A=>{if(!x)return;let S=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(A.map(M=>M.value)).has(S)||(A=A.concat([{value:S,label:`Custom (${S})`}])),x.selectEl.options.length=0;for(let M of A)x.addOption(M.value,M.label);x.setValue(S)},R=async()=>{if(x){x.setDisabled(!0);try{let A=await this.plugin.fetchZoteroLibraryOptions();v(A)}finally{x.setDisabled(!1)}}};k.addDropdown(A=>{x=A;let S=(this.plugin.settings.zoteroUserId||"0").trim()||"0";A.addOption(S,"Loading..."),A.setValue(S),A.onChange(async L=>{this.plugin.settings.zoteroUserId=L.trim(),await this.plugin.saveSettings()})}),k.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await R()})}),R(),f.createEl("h2",{text:"Zotero Web API"}),new N.Setting(f).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(A=>A.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async S=>{this.plugin.settings.webApiBaseUrl=S.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(A=>A.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async S=>{this.plugin.settings.webApiLibraryType=S,await this.plugin.saveSettings()})),new N.Setting(f).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(A=>A.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async S=>{this.plugin.settings.webApiLibraryId=S.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(A=>{i(A),A.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async S=>{this.plugin.settings.webApiKey=S.trim(),await this.plugin.saveSettings()})}),f.createEl("h2",{text:"Output"}),new N.Setting(f).setName("PDF folder").addText(A=>A.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async S=>{this.plugin.settings.outputPdfDir=S.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Notes folder").addText(A=>A.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async S=>{this.plugin.settings.outputNoteDir=S.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(A=>{A.setValue(this.plugin.settings.frontmatterTemplate).onChange(async S=>{this.plugin.settings.frontmatterTemplate=S,await this.plugin.saveSettings()}),A.inputEl.rows=10,A.inputEl.style.width="100%"}),new N.Setting(f).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(A=>A.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async S=>{this.plugin.settings.tagSanitizeMode=S,await this.plugin.saveSettings()})),new N.Setting(f).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(A=>{A.setValue(this.plugin.settings.noteBodyTemplate).onChange(async S=>{this.plugin.settings.noteBodyTemplate=S,await this.plugin.saveSettings()}),A.inputEl.rows=8,A.inputEl.style.width="100%"}),new N.Setting(f).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(A=>A.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async S=>{this.plugin.settings.chatOutputDir=S.trim()||"zotero/chats",await this.plugin.saveSettings()})),new N.Setting(f).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(A=>A.setValue(this.plugin.settings.copyPdfToVault).onChange(async S=>{this.plugin.settings.copyPdfToVault=S,!S&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new N.Setting(f).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(A=>{let S=this.plugin.settings.copyPdfToVault;A.setValue(S?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!S).onChange(async L=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=L,await this.plugin.saveSettings()})}),new N.Setting(f).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(A=>A.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async S=>{this.plugin.settings.preferObsidianNoteForCitations=S,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:f=>{f.createEl("h2",{text:"Annotations"}),new N.Setting(f).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(R=>R.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async A=>{this.plugin.settings.annotationPageLabel=A.trim()||"Page",await this.plugin.saveSettings()})),new N.Setting(f).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(R=>R.setValue(this.plugin.settings.includeAnnotationImages).onChange(async A=>{this.plugin.settings.includeAnnotationImages=A,await this.plugin.saveSettings()})),f.createEl("h3",{text:"Zotero companion"}),f.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new N.Setting(f).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(R=>R.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async A=>{this.plugin.settings.zoteroCompanionEnabled=A,await this.plugin.saveSettings()})),new N.Setting(f).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(R=>R.setPlaceholder("http://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async A=>{this.plugin.settings.zoteroCompanionBaseUrl=A.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(R=>{i(R),this.companionTokenInput=R,R.setPlaceholder("optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async A=>{this.plugin.settings.zoteroCompanionToken=A.trim(),await this.plugin.saveSettings()})}),new N.Setting(f).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero Companion Plugin token to this value.").addButton(R=>R.setButtonText("Generate token").onClick(async()=>{let A=(0,Ct.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=A,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(A);try{await navigator.clipboard.writeText(A),new N.Notice("Generated and copied companion token.")}catch(S){new N.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",S)}})),f.createEl("h3",{text:"Annotation color map"}),f.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let k=f.createDiv({cls:"zrr-annotation-map"}),x=async R=>{this.plugin.settings.annotationColorMap=R,await this.plugin.saveSettings()},v=()=>{var O,$;k.empty();let R=this.plugin.settings.annotationColorMap||{},A=Object.entries(R);if(A.length||k.createEl("p",{text:"No color mappings configured."}),A.length){let F=k.createDiv({cls:"zrr-annotation-map-row-header"});F.createEl("span",{text:"Color"}),F.createEl("span",{text:"Heading"}),F.createEl("span",{text:"Callout"}),F.createEl("span")}for(let[F,z]of A){let I=k.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),D=I.createEl("input",{type:"text",value:F,cls:"zrr-annotation-map-input"}),q=I.createEl("input",{type:"text",value:(O=z.heading)!=null?O:"",cls:"zrr-annotation-map-input"}),U=I.createEl("input",{type:"text",value:($=z.callout)!=null?$:"",cls:"zrr-annotation-map-input"}),J=I.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});J.type="button",D.addEventListener("change",async()=>{let Z=D.value.trim().toLowerCase();if(!Z){D.value=F;return}let Q={...this.plugin.settings.annotationColorMap||{}};if(Z!==F&&Q[Z]){new N.Notice(`Annotation color '${Z}' already exists.`),D.value=F;return}let X=Q[F];delete Q[F],Q[Z]=X!=null?X:{heading:"",callout:""},await x(Q),v()}),q.addEventListener("change",async()=>{var X;let Z={...this.plugin.settings.annotationColorMap||{}},Q=(X=Z[F])!=null?X:{heading:"",callout:""};Q.heading=q.value.trim(),Z[F]=Q,await x(Z)}),U.addEventListener("change",async()=>{var X;let Z={...this.plugin.settings.annotationColorMap||{}},Q=(X=Z[F])!=null?X:{heading:"",callout:""};Q.callout=U.value.trim(),Z[F]=Q,await x(Z)}),J.addEventListener("click",async()=>{let Z={...this.plugin.settings.annotationColorMap||{}};delete Z[F],await x(Z),v()})}let S=k.createDiv({cls:"zrr-annotation-map-actions"}),L=S.createEl("button",{text:"Add mapping"});L.type="button",L.addEventListener("click",async()=>{let F={...this.plugin.settings.annotationColorMap||{}},z="new-color",j=1;for(;F[z];)z=`new-color-${j}`,j+=1;F[z]={heading:"",callout:""},await x(F),v()});let M=S.createEl("button",{text:"Reset to defaults"});M.type="button",M.addEventListener("click",async()=>{await x({...Me.annotationColorMap}),v()})};v()}},{id:"ocr",label:"OCR",render:f=>{f.createEl("h2",{text:"Docling"});let k=null,x=S=>{if(!k)return;let L=this.plugin.settings.ocrEngine;new Set(S.map(O=>O.value)).has(L)||(S=S.concat([{value:L,label:`Current (unavailable): ${L}`}])),k.selectEl.options.length=0;for(let O of S)k.addOption(O.value,O.label);k.setValue(L)},v=async()=>{if(!k)return;k.setDisabled(!0);let S={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{S=await this.plugin.detectOcrEngines()}catch(O){S={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let L=[{value:"auto",label:"Auto (default)"}];S.tesseract&&L.push({value:"tesseract",label:"Tesseract (local)"}),S.paddleStructureLocal&&L.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),S.paddleVlLocal&&L.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(L.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),L.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),x(L),k.setDisabled(!1)},R=new N.Setting(f).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),A=document.createElement("a");A.href="https://aistudio.baidu.com/paddleocr",A.textContent="https://aistudio.baidu.com/paddleocr",A.target="_blank",A.rel="noopener noreferrer",R.descEl.appendChild(A),R.descEl.append("."),R.addText(S=>{i(S),S.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async L=>{this.plugin.settings.paddleApiKey=L.trim(),await this.plugin.saveSettings(),await v()})}),new N.Setting(f).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(S=>S.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async L=>{this.plugin.settings.paddleVlApiUrl=L.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(S=>S.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async L=>{this.plugin.settings.paddleStructureApiUrl=L.trim(),await this.plugin.saveSettings(),await v()})),new N.Setting(f).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(S=>{k=S,S.addOption("auto","Auto (default)"),S.setValue(this.plugin.settings.ocrEngine),S.onChange(async L=>{this.plugin.settings.ocrEngine=L,await this.plugin.saveSettings()})}),new N.Setting(f).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(S=>S.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async L=>{this.plugin.settings.ocrMode=L,await this.plugin.saveSettings()})),new N.Setting(f).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(S=>S.setValue(this.plugin.settings.forcePerPageOcr).onChange(async L=>{this.plugin.settings.forcePerPageOcr=L,await this.plugin.saveSettings()})),new N.Setting(f).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(S=>{S.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async L=>{this.plugin.settings.ocrQualityThreshold=L,await this.plugin.saveSettings()})}),new N.Setting(f).setName("Chunking").setDesc("page or section").addDropdown(S=>S.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async L=>{this.plugin.settings.chunkingMode=L,await this.plugin.saveSettings()})),v()}},{id:"llms",label:"LLMs",render:f=>{f.createEl("h2",{text:"LLM Provider Profiles"});let k=f.createDiv({cls:"zrr-llm-profiles"}),x=()=>{k.empty();let w=t();w.length||k.createEl("p",{text:"No profiles yet. Add one below."});for(let P of w){let T=k.createEl("details",{cls:"zrr-profile"});w.length===1&&(T.open=!0);let W=T.createEl("summary",{text:P.name||P.id||"Profile"});W.addClass("zrr-profile-title");let Le=T.createDiv({cls:"zrr-profile-body"});new N.Setting(Le).setName("Profile name").addText(le=>le.setPlaceholder("My provider").setValue(P.name||"").onChange(async de=>{P.name=de.trim(),W.textContent=P.name||P.id||"Profile",await n(t())})),new N.Setting(Le).setName("Base URL").addText(le=>le.setPlaceholder("http://localhost:1234/v1").setValue(P.baseUrl||"").onChange(async de=>{P.baseUrl=de.trim(),await n(t())})),new N.Setting(Le).setName("API key").setDesc("Stored in settings (not encrypted).").addText(le=>{i(le),le.setPlaceholder("sk-...").setValue(P.apiKey||"").onChange(async de=>{P.apiKey=de.trim(),await n(t())})}),new N.Setting(Le).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(le=>le.setButtonText("Delete profile").onClick(async()=>{let de=t().filter(tn=>tn.id!==P.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===P.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===P.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===P.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(de),x()}))}new N.Setting(k).addButton(P=>P.setButtonText("Add profile").onClick(async()=>{let T=`profile-${Date.now().toString(36)}`,W=t().concat([{id:T,name:"Custom",baseUrl:"",apiKey:""}]);await n(W),x()}))};x(),f.createEl("h2",{text:"OCR cleanup"}),new N.Setting(f).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(w=>w.setValue(this.plugin.settings.enableLlmCleanup).onChange(async P=>{this.plugin.settings.enableLlmCleanup=P,await this.plugin.saveSettings()}));let v=null,R=null,A=null,S=async()=>{},L=async(w,P=!0)=>{let T=w.trim();this.plugin.settings.llmCleanupBaseUrl=T,P&&(this.plugin.settings.llmCleanupProviderProfileId="",v&&v.setValue("custom")),R&&R.setValue(T),await this.plugin.saveSettings()},M=async w=>{let P=t().find(T=>T.id===w);this.plugin.settings.llmCleanupProviderProfileId=w,P&&(this.plugin.settings.llmCleanupBaseUrl=P.baseUrl,this.plugin.settings.llmCleanupApiKey=P.apiKey,R==null||R.setValue(P.baseUrl),A==null||A.setValue(P.apiKey)),await this.plugin.saveSettings(),await S()};new N.Setting(f).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(w=>{v=w,w.addOption("custom","Custom (manual)");for(let T of t())w.addOption(T.id,T.name||T.id);let P=this.plugin.settings.llmCleanupProviderProfileId;w.setValue(P&&t().some(T=>T.id===P)?P:"custom"),w.onChange(async T=>{if(T==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await M(T)})}),new N.Setting(f).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(w=>{R=w,w.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async P=>{await L(P)})}),new N.Setting(f).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(w=>{A=w,i(w),w.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async P=>{this.plugin.settings.llmCleanupApiKey=P.trim(),this.plugin.settings.llmCleanupProviderProfileId="",v&&v.setValue("custom"),await this.plugin.saveSettings()})});let O=new N.Setting(f).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),$=null,F=w=>{if(!$)return;let P=(this.plugin.settings.llmCleanupModel||"").trim(),T=new Set(w.map(W=>W.value));P&&!T.has(P)&&(w=w.concat([{value:P,label:`Custom (${P})`}])),$.selectEl.options.length=0;for(let W of w)$.addOption(W.value,W.label);P&&$.setValue(P)};S=async()=>{if($){$.setDisabled(!0);try{let w=await this.plugin.fetchCleanupModelOptions();F(w)}finally{$.setDisabled(!1)}}},O.addDropdown(w=>{$=w;let P=(this.plugin.settings.llmCleanupModel||"").trim();w.addOption(P||"loading","Loading..."),w.setValue(P||"loading"),w.onChange(async T=>{this.plugin.settings.llmCleanupModel=T.trim(),await this.plugin.saveSettings()})}),O.addButton(w=>{w.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),new N.Setting(f).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(w=>w.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async P=>{let T=Number.parseFloat(P);this.plugin.settings.llmCleanupTemperature=Number.isFinite(T)?T:0,await this.plugin.saveSettings()})),new N.Setting(f).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(w=>w.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async P=>{this.plugin.settings.llmCleanupMinQuality=P,await this.plugin.saveSettings()})),new N.Setting(f).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(w=>w.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(T)?T:2e3,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Text Embedding"});let z=null,j=null,I=null,D=async()=>{},q=async(w,P=!0)=>{let T=w.trim();this.plugin.settings.embedBaseUrl=T,P&&(this.plugin.settings.embedProviderProfileId="",z&&z.setValue("custom")),j&&j.setValue(T),await this.plugin.saveSettings()},U=async w=>{let P=t().find(T=>T.id===w);this.plugin.settings.embedProviderProfileId=w,P&&(this.plugin.settings.embedBaseUrl=P.baseUrl,this.plugin.settings.embedApiKey=P.apiKey,j==null||j.setValue(P.baseUrl),I==null||I.setValue(P.apiKey)),await this.plugin.saveSettings(),await D()};new N.Setting(f).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(w=>{z=w,w.addOption("custom","Custom (manual)");for(let T of t())w.addOption(T.id,T.name||T.id);let P=this.plugin.settings.embedProviderProfileId;w.setValue(P&&t().some(T=>T.id===P)?P:"custom"),w.onChange(async T=>{if(T==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await U(T)})}),new N.Setting(f).setName("Embeddings base URL").addText(w=>{j=w,w.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async P=>{await q(P)})}),new N.Setting(f).setName("Embeddings API key").addText(w=>{I=w,i(w),w.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async P=>{this.plugin.settings.embedApiKey=P.trim(),this.plugin.settings.embedProviderProfileId="",z&&z.setValue("custom"),await this.plugin.saveSettings()})});let J=new N.Setting(f).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),Z=null,Q=w=>{if(!Z)return;let P=(this.plugin.settings.embedModel||"").trim(),T=new Set(w.map(W=>W.value));P&&!T.has(P)&&(w=w.concat([{value:P,label:`Custom (${P})`}])),Z.selectEl.options.length=0;for(let W of w)Z.addOption(W.value,W.label);P&&Z.setValue(P)};D=async()=>{if(Z){Z.setDisabled(!0);try{let w=await this.plugin.fetchEmbeddingModelOptions();Q(w)}finally{Z.setDisabled(!1)}}},J.addDropdown(w=>{Z=w;let P=(this.plugin.settings.embedModel||"").trim();w.addOption(P||"loading","Loading..."),w.setValue(P||"loading"),w.onChange(async T=>{this.plugin.settings.embedModel=T.trim(),await this.plugin.saveSettings()})}),J.addButton(w=>{w.setButtonText("Refresh").onClick(async()=>{await D()})}),D(),new N.Setting(f).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(w=>w.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async P=>{this.plugin.settings.embedIncludeMetadata=P,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(w=>w.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.embedContextWindow=Number.isFinite(T)?Math.max(0,T):1,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(w=>w.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.embedContextChars=Number.isFinite(T)?Math.max(0,T):220,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(w=>w.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(T)?Math.max(0,T):3500,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(w=>w.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(T)?Math.max(0,T):200,await this.plugin.saveSettings()})),new N.Setting(f).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(w=>w.setValue(this.plugin.settings.enableChunkTagging).onChange(async P=>{this.plugin.settings.enableChunkTagging=P,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Chat LLM"});let X=null,ie=null,se=null,ge=async()=>{},et=async(w,P=!0)=>{let T=w.trim();this.plugin.settings.chatBaseUrl=T,P&&(this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom")),ie&&ie.setValue(T),await this.plugin.saveSettings()},tt=async w=>{let P=t().find(T=>T.id===w);this.plugin.settings.chatProviderProfileId=w,P&&(this.plugin.settings.chatBaseUrl=P.baseUrl,this.plugin.settings.chatApiKey=P.apiKey,ie==null||ie.setValue(P.baseUrl),se==null||se.setValue(P.apiKey)),await this.plugin.saveSettings(),await ge()};new N.Setting(f).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(w=>{X=w,w.addOption("custom","Custom (manual)");for(let T of t())w.addOption(T.id,T.name||T.id);let P=this.plugin.settings.chatProviderProfileId;w.setValue(P&&t().some(T=>T.id===P)?P:"custom"),w.onChange(async T=>{if(T==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await tt(T)})}),new N.Setting(f).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(w=>{ie=w,w.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async P=>{await et(P)})}),new N.Setting(f).setName("Chat API key").addText(w=>{se=w,i(w),w.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async P=>{this.plugin.settings.chatApiKey=P.trim(),this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom"),await this.plugin.saveSettings()})});let Re=new N.Setting(f).setName("Chat model").setDesc("Select a chat-capable model from the provider."),re=null,nt=w=>{if(!re)return;let P=(this.plugin.settings.chatModel||"").trim(),T=new Set(w.map(W=>W.value));P&&!T.has(P)&&(w=w.concat([{value:P,label:`Custom (${P})`}])),re.selectEl.options.length=0;for(let W of w)re.addOption(W.value,W.label);P&&re.setValue(P)};ge=async()=>{if(re){re.setDisabled(!0);try{let w=await this.plugin.fetchChatModelOptions();nt(w)}finally{re.setDisabled(!1)}}},Re.addDropdown(w=>{re=w;let P=(this.plugin.settings.chatModel||"").trim();w.addOption(P||"loading","Loading..."),w.setValue(P||"loading"),w.onChange(async T=>{this.plugin.settings.chatModel=T.trim(),await this.plugin.saveSettings()})}),Re.addButton(w=>{w.setButtonText("Refresh").onClick(async()=>{await ge()})}),ge(),new N.Setting(f).setName("Temperature").addText(w=>w.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async P=>{let T=Number.parseFloat(P);this.plugin.settings.chatTemperature=Number.isFinite(T)?T:.2,await this.plugin.saveSettings()})),new N.Setting(f).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(w=>w.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(T)?Math.max(0,T):6,await this.plugin.saveSettings()})),new N.Setting(f).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(w=>w.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async P=>{this.plugin.settings.chatPaneLocation=P,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Retrieval"}),new N.Setting(f).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(w=>w.setValue(this.plugin.settings.enableAgenticRag).onChange(async P=>{this.plugin.settings.enableAgenticRag=P,await this.plugin.saveSettings()})),new N.Setting(f).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(w=>w.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.agenticMaxIters=Number.isFinite(T)?Math.max(1,T):2,await this.plugin.saveSettings()})),new N.Setting(f).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(w=>w.setValue(this.plugin.settings.enableQueryExpansion).onChange(async P=>{this.plugin.settings.enableQueryExpansion=P,await this.plugin.saveSettings()})),new N.Setting(f).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(w=>w.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.queryExpansionCount=Number.isFinite(T)?Math.max(1,T):3,await this.plugin.saveSettings()})),new N.Setting(f).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(w=>w.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async P=>{this.plugin.settings.enableCrossEncoderRerank=P,await this.plugin.saveSettings()})),new N.Setting(f).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(w=>w.setPlaceholder("BAAI/bge-reranker-v2-m3").setValue(this.plugin.settings.rerankModel).onChange(async P=>{this.plugin.settings.rerankModel=P.trim()||"BAAI/bge-reranker-v2-m3",await this.plugin.saveSettings()})),new N.Setting(f).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(w=>w.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(T)?Math.max(1,T):4,await this.plugin.saveSettings()})),new N.Setting(f).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(w=>w.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.rrfK=Number.isFinite(T)?Math.max(1,T):60,await this.plugin.saveSettings()})),new N.Setting(f).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(w=>w.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.rrfLogTop=Number.isFinite(T)?Math.max(0,T):0,await this.plugin.saveSettings()})),new N.Setting(f).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(w=>w.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async P=>{let T=Number.parseInt(P,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(T)?Math.max(0,T):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:f=>{f.createEl("h2",{text:"Release Notes"}),new N.Setting(f).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(k=>k.setButtonText("Show").onClick(async()=>{await this.plugin.openReleaseNotesModal()})),f.createEl("h2",{text:"Logging"}),new N.Setting(f).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(k=>k.setValue(this.plugin.settings.enableFileLogging).onChange(async x=>{this.plugin.settings.enableFileLogging=x,await this.plugin.saveSettings()})),new N.Setting(f).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(k=>k.setPlaceholder(`${Y}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async x=>{this.plugin.settings.logFilePath=x.trim()||`${Y}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new N.Setting(f).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(k=>k.setButtonText("Open log").onClick(async()=>{var x,v;await((v=(x=this.plugin).openLogFile)==null?void 0:v.call(x))})).addButton(k=>k.setButtonText("Clear log").onClick(async()=>{var x,v;await((v=(x=this.plugin).clearLogFile)==null?void 0:v.call(x))})),f.createEl("h2",{text:"Zotero Companion Plugin"}),f.createEl("p",{text:"Download the XPI, then in Zotero go to Tools \u2192 Add-ons \u2192 Install from File and restart."}),new N.Setting(f).setName("Download companion add-on").setDesc("Downloads the companion XPI to your system Downloads folder.").addButton(k=>k.setButtonText("Download XPI").onClick(async()=>{let x=this.getDefaultDownloadDir();if(!x){new N.Notice("Unable to resolve the system Downloads folder.");return}let v=Ie.default.join(x,"zrr-companion.xpi");if(await this.companionXpiExists(v)){new N.Notice(`Companion XPI already exists: ${v}`);return}new N.Notice("Downloading companion XPI..."),await this.downloadCompanionXpi(v)})),new N.Setting(f).setName("Open Zotero").setDesc("Launch Zotero and open the Add-ons window (Tools \u2192 Add-ons).").addButton(k=>k.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new N.Setting(f).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(k=>k.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),f.createEl("h2",{text:"Redis Indexing"}),new N.Setting(f).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(k=>k.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new N.Setting(f).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(k=>k.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(k=>k.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],u=new Map,_=new Map,m=f=>{this.activeTab=f;for(let[k,x]of u){let v=k===f;x.classList.toggle("is-active",v),x.setAttribute("aria-selected",v?"true":"false"),x.setAttribute("tabindex",v?"0":"-1")}for(let[k,x]of _){let v=k===f;x.classList.toggle("is-active",v),x.hidden=!v}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let b=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let f of d){let k=y.createEl("button",{text:f.label,cls:"zrr-settings-tab-button"}),x=`zrr-settings-tab-${f.id}`,v=`zrr-settings-panel-${f.id}`;k.type="button",k.id=x,k.setAttribute("role","tab"),k.setAttribute("aria-controls",v),k.setAttribute("aria-selected","false"),k.addEventListener("click",()=>m(f.id));let R=b.createDiv({cls:"zrr-settings-tab-panel"});R.id=v,R.setAttribute("role","tabpanel"),R.setAttribute("aria-labelledby",x),R.hidden=!0,f.render(R),u.set(f.id,k),_.set(f.id,R)}let C=d.some(f=>f.id===this.activeTab)?this.activeTab:d[0].id;m(C)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Ie.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await Oe.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await Oe.promises.mkdir(Ie.default.dirname(e),{recursive:!0});let t=await(0,N.requestUrl)({url:_n,method:"GET"});if(t.status!==200){new N.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await Oe.promises.writeFile(e,n),new N.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new N.Notice("Failed to download companion XPI. See console for details."),console.warn("Failed to download companion XPI",t)}}};var Rt=require("@codemirror/state"),Lt=require("@codemirror/view"),oe=require("obsidian");var gn=g=>{let p=g.scrollDOM.getBoundingClientRect(),e=g.posAtCoords({x:p.left+8,y:+p.height*.25});return e===null?null:g.state.doc.lineAt(e).number},ze=class{constructor(p,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=p,this.helpers=e}createSyncExtension(){let p=this,e=this.helpers;return Lt.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=e.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=e.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var u,_;let i=this.docId;if(!i)return;let r=gn(t);if(r===null)return;let a=e.findChunkStartLineInDoc(t.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(u=s==null?void 0:s.pageNumber)!=null?u:null,l=(_=s==null?void 0:s.chunkId)!=null?_:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||d)||(this.lastPage=o,this.lastChunkId=l,p.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,t;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((t=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:t.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let p=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(p.docId,p.pageNumber,p.chunkId)}updatePreviewScrollHandler(){var n;let p=this.deps.app.workspace.getActiveViewOfType(oe.MarkdownView);if(!p||p.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=p.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(p);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(p)}async syncPdfSidebarForFile(p){try{let e=await this.deps.app.vault.read(p),t=await this.deps.resolveDocIdForNote(p,e);if(!t)return;let n=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(t,n==null?void 0:n.pageNumber,n==null?void 0:n.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(p,e,t){if(p){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:p,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let n=await this.deps.getDocIndexEntry(p);n||(n=await this.deps.hydrateDocIndexFromCache(p));let i=n!=null&&n.pdf_path?String(n.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let d=(0,oe.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(d)instanceof oe.TFile&&(r=d)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof oe.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:t};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:t};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&t&&(o=await this.resolvePageNumberForChunk(p,t)),o===null||this.pdfSidebarDocId===p&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=p,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,c=o!==null?`${l}#page=${o}`:l;await this.openPdfLinkInLeaf(s,c),this.updatePdfSidebarIcon(s)}finally{this.pdfSyncInFlight=!1;let n=this.queuedPdfSync;this.queuedPdfSync=null,n&&this.syncPdfSidebarForDoc(n.docId,n.pageNumber,n.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(p){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(p)}))}syncPdfSidebarForPreview(p){let e=this.previewScrollEl;if(!e)return;let t=p.getViewData();if(!t)return;let n=Rt.Text.of(t.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(n);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(n,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(p){var n;let e=p.getBoundingClientRect().top,t=p.querySelectorAll("[data-line]");for(let i of Array.from(t))if(i.getBoundingClientRect().bottom>=e+2){let a=(n=i.getAttribute("data-line"))!=null?n:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var n,i;if(this.pdfSidebarLeaf&&((i=(n=this.pdfSidebarLeaf.view)==null?void 0:n.getViewType)==null?void 0:i.call(n))==="pdf")return this.pdfSidebarLeaf;let p=this.deps.app.workspace;if(typeof p.ensureSideLeaf=="function")try{let r=await p.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let t=this.deps.app.workspace.getRightLeaf(!0);return t&&this.isRightSidebarLeaf(t)?(this.pdfSidebarLeaf=t,this.updatePdfSidebarIcon(t),t):null}isRightSidebarLeaf(p){if(!p)return!1;let t=p.containerEl;return!!(t!=null&&t.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(p){if(!p||!this.isRightSidebarLeaf(p))return;let t=p.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let i=p;if(i.tabHeaderEl&&n.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&n.push(i.tabHeaderInnerIconEl),n.length===0)return;let r=new Set;for(let s of n)r.has(s)||(r.add(s),s.innerHTML="",(0,oe.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=p.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(p,e){var r,a,s;let t=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],n=(s=(a=t==null?void 0:t.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof n=="function")try{await n.call(t.lib.workspace,p,e,"",{active:!1});return}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150)}let i=p;if(typeof i.openLinkText=="function"){try{await i.openLinkText(e,"",{active:!1})}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150),await i.openLinkText(e,"",{active:!1})}return}await this.deps.app.workspace.openLinkText(e,"",!1)}isPdfAnnotationRaceError(p){let e=p instanceof Error?p.message:String(p!=null?p:"");return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(p){return new Promise(e=>setTimeout(e,p))}getPluginsRegistry(){var p;return(p=this.deps.app.plugins)==null?void 0:p.plugins}isLeafTabActive(p){var i;let e=p;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===p;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(p,e){var l,c,d,u,_;if(!p||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,p)||e,n=this.chunkPageCache.get(p);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let i=(0,oe.normalizePath)(`${H}/${p}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let m of s){let y=typeof(m==null?void 0:m.chunk_id)=="string"?m.chunk_id.trim():"";if(!y)continue;let b=Number.isFinite((c=m==null?void 0:m.page_start)!=null?c:NaN)?Number(m.page_start):null,C=Number.isFinite((d=m==null?void 0:m.page_end)!=null?d:NaN)?Number(m.page_end):null,f=b!=null?b:C;f!==null&&(o.set(y,f),o.set(`${p}:${y}`,f))}return this.chunkPageCache.set(p,o),(_=(u=o.get(t))!=null?u:o.get(e))!=null?_:null}};var qe={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var _e=require("@codemirror/state"),ae=require("@codemirror/view"),B=require("obsidian");var V=g=>{if(typeof g=="string")return g.trim();if(typeof g=="number"&&Number.isFinite(g))return String(g);if(Array.isArray(g))for(let p of g){if(typeof p=="string"&&p.trim())return p.trim();if(typeof p=="number"&&Number.isFinite(p))return String(p)}if(g&&typeof g=="object"){let p=g[0];if(typeof p=="string"&&p.trim())return p.trim();if(typeof p=="number"&&Number.isFinite(p))return String(p)}return""},Nt=g=>{let p=[g.key,g.itemKey,g.id,g.citationKey];for(let e of p)if(typeof e=="string"&&e.trim())return e.trim();return null},Dt=g=>{var e,t,n;let p=(n=(t=g.key)!=null?t:(e=g.data)==null?void 0:e.key)!=null?n:"";return typeof p=="string"?p:""},ot=g=>{if(!g)return"";let p=g.match(/\b(\d{4})\b/);return p?p[1]:""},Tt=g=>{var e,t,n,i;let p=(i=(n=(e=g.meta)==null?void 0:e.parsedDate)!=null?n:(t=g.data)==null?void 0:t.date)!=null?i:"";return typeof p!="string"?"":ot(p)},he=g=>{if(!g||typeof g!="object")return"";if(g.name)return String(g.name);let p=g.firstName?String(g.firstName):"",e=g.lastName?String(g.lastName):"";return[e,p].filter(Boolean).join(", ")||`${p} ${e}`.trim()},$e=(g,p)=>{let e=[p==null?void 0:p["citation-key"],p==null?void 0:p.citationKey,p==null?void 0:p.citationkey,p==null?void 0:p.citekey,p==null?void 0:p.citeKey,p==null?void 0:p.betterBibtexKey,p==null?void 0:p.betterbibtexkey,g["citation-key"],g.citationKey,g.citationkey,g.citekey,g.citeKey,g.betterBibtexKey,g.betterbibtexkey];for(let i of e){let r=V(i);if(r)return r}let t=typeof g.extra=="string"?g.extra:"";if(!t)return"";let n=t.split(/\r?\n/);for(let i of n){let r=i.match(/^\s*biblatexcitekey\s*\[([^\]]+)\]\s*$/i);if(r&&r[1])return r[1].trim();let a=i.match(/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:\s*(.+)\s*$/i);if(a&&a[2])return a[2].trim()}return""},lt=g=>{if(!g)return"";let p=[g["citation-key"],g.citationKey,g.citationkey,g.citekey,g.citation_key];for(let e of p){let t=V(e);if(t)return t}return""},Ot=g=>{var e,t;if(!g)return"";let p=(t=(e=g["title-short"])!=null?e:g.shortTitle)!=null?t:g.short_title;return typeof p=="string"?p.trim():""},me=g=>{let p=V(g.shortTitle);if(p)return p;let e=V(g.short_title);if(e)return e;let t=V(g["title-short"]);return t||""},It=g=>{let p=typeof g.extra=="string"?g.extra:"";if(!p)return"";let e=p.split(/\r?\n/);for(let n of e){let i=n.match(/^\s*doi\s*:\s*(.+)\s*$/i);if(i&&i[1])return i[1].trim().replace(/[.,;]+$/,"")}let t=p.match(/\b10\.\d{4,9}\/[-._;()/:A-Z0-9]+\b/i);return t?t[0].replace(/[.,;]+$/,""):""},Ft=g=>{var e;if(!g)return"";let p=(e=g.DOI)!=null?e:g.doi;return typeof p=="string"?p.trim().replace(/[.,;]+$/,""):""},fn=g=>{if(!g)return[];let p=[g.attachments,g.children,g.items,g.attachment,g.allAttachments],e=[];for(let t of p)t&&(Array.isArray(t)?e.push(...t):typeof t=="object"&&e.push(t));return e},ct=g=>{var t,n,i,r,a,s,o,l,c,d,u,_,m,y,b;if(((s=(a=(i=(t=g==null?void 0:g.contentType)!=null?t:g==null?void 0:g.mimeType)!=null?i:(n=g==null?void 0:g.data)==null?void 0:n.contentType)!=null?a:(r=g==null?void 0:g.data)==null?void 0:r.mimeType)!=null?s:"")==="application/pdf")return!0;let e=(b=(y=(_=(u=(c=(o=g==null?void 0:g.filename)!=null?o:g==null?void 0:g.fileName)!=null?c:(l=g==null?void 0:g.data)==null?void 0:l.filename)!=null?u:(d=g==null?void 0:g.data)==null?void 0:d.fileName)!=null?_:g==null?void 0:g.path)!=null?y:(m=g==null?void 0:g.data)==null?void 0:m.path)!=null?b:"";return!!(typeof e=="string"&&e.toLowerCase().endsWith(".pdf"))},Mt=g=>{var t;let p=fn(g.data);if(p.length>0)return p.some(i=>ct(i))?"yes":"no";let e=(t=g.meta)==null?void 0:t.numChildren;return typeof e=="number"&&e===0?"no":"unknown"};var hn={artwork:"image",audioRecording:"music",bill:"file-text",blogPost:"globe",book:"book",bookSection:"book-open",case:"scale",computerProgram:"code",conferencePaper:"file-text",dataset:"database",dictionaryEntry:"book",document:"file-text",email:"mail",encyclopediaArticle:"book",film:"film",forumPost:"message-circle",hearing:"file-text",interview:"mic",journalArticle:"file-text",letter:"mail",magazineArticle:"file-text",manuscript:"file-text",map:"map",newspaperArticle:"file-text",patent:"award",podcast:"mic",preprint:"file-text",presentation:"file-text",radioBroadcast:"music",report:"file-text",statute:"scale",thesis:"graduation-cap",tvBroadcast:"film",videoRecording:"film",webpage:"globe"},zt=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],mn="https://github.com/jmiba/zotero-redisearch-rag/blob/main/CHANGELOG.md",yn=g=>g.includes("STDERR")?"zrr-log-stderr":g.includes("ERROR")?"zrr-log-error":g.includes("WARNING")||g.includes("WARN")?"zrr-log-warning":g.includes("INFO")?"zrr-log-info":null,qt=g=>{let p=new _e.RangeSetBuilder;for(let{from:e,to:t}of g.visibleRanges){let n=e;for(;n<=t;){let i=g.state.doc.lineAt(n),r=yn(i.text);r&&p.add(i.from,i.from,ae.Decoration.line({class:r})),n=i.to+1}}return p.finish()},$t=ae.EditorView.theme({".cm-editor":{height:"100%",display:"flex",flexDirection:"column",minHeight:"0"},".cm-scroller":{fontFamily:"var(--font-monospace)",fontSize:"0.85rem",flex:"1",height:"100%",maxHeight:"100%",overflow:"auto"},".zrr-log-error":{color:"var(--text-error)"},".zrr-log-warning":{color:"var(--text-accent)"},".zrr-log-info":{color:"var(--text-muted)"},".zrr-log-stderr":{color:"var(--text-accent)"}}),jt=ae.ViewPlugin.fromClass(class{constructor(g){this.decorations=qt(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=qt(g.view))}},{decorations:g=>g.decorations}),ke=class extends B.Modal{constructor(p,e,t,n,i="Value cannot be empty."){super(p),this.titleText=e,this.placeholder=t,this.onSubmit=n,this.emptyMessage=i}onOpen(){let{contentEl:p}=this;p.empty(),p.createEl("h3",{text:this.titleText});let e=p.createEl("input",{type:"text",placeholder:this.placeholder});e.style.width="100%",e.focus();let t=p.createEl("button",{text:"Submit"});t.style.marginTop="0.75rem";let n=()=>{let i=e.value.trim();if(!i){new B.Notice(this.emptyMessage);return}this.close(),this.onSubmit(i)};t.addEventListener("click",n),e.addEventListener("keydown",i=>{i.key==="Enter"&&n()})}},we=class extends B.Modal{constructor(e,t,n){super(e);this.markdownComponent=null;this.version=t,this.markdown=n}onOpen(){var a;let{contentEl:e}=this;e.empty(),e.addClass("zrr-release-notes-modal"),e.createEl("h3",{text:`What's new in v${this.version}`}),(a=this.markdownComponent)==null||a.unload(),this.markdownComponent=new B.Component,this.markdownComponent.load();let t=String(this.markdown||"").trim();if(t){let s=e.createDiv({cls:"zrr-release-notes-body"});B.MarkdownRenderer.renderMarkdown(t,s,"",this.markdownComponent)}else e.createEl("p",{text:"This version includes improvements and fixes."});let n=e.createDiv({cls:"zrr-release-notes-body"});B.MarkdownRenderer.renderMarkdown(`[Full changelog](${mn})`,n,"",this.markdownComponent),e.createEl("div",{cls:"zrr-release-notes-actions"}).createEl("button",{text:"Close"}).addEventListener("click",()=>this.close())}onClose(){var e;(e=this.markdownComponent)==null||e.unload(),this.markdownComponent=null,this.contentEl.empty()}},je=class extends B.Modal{constructor(p,e,t,n,i){super(p),this.chunkId=e,this.initialTags=t,this.onSubmit=n,this.onRegenerate=i}onOpen(){let{contentEl:p}=this;p.empty(),p.createEl("h3",{text:`Edit tags for ${this.chunkId}`});let e=p.createEl("textarea",{attr:{rows:"3"}});e.style.width="100%",e.placeholder="tag1, tag2, tag3",e.value=this.initialTags.join(", "),e.focus();let t=p.createEl("div");t.style.display="flex",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let n=t.createEl("button",{text:"Save tags"}),i=async()=>{let a=(e.value||"").split(/[,;\n]+/).map(o=>o.trim()).filter(o=>o.length>0),s=Array.from(new Set(a));this.close(),await Promise.resolve(this.onSubmit(s))};if(this.onRegenerate){let r=t.createEl("button",{text:"Regenerate"});r.addEventListener("click",async()=>{var a;r.setAttribute("disabled","true"),n.setAttribute("disabled","true");try{let s=await((a=this.onRegenerate)==null?void 0:a.call(this));s&&s.length>0?(e.value=s.join(", "),await Promise.resolve(this.onSubmit(s))):s&&new B.Notice("No tags were generated.")}finally{r.removeAttribute("disabled"),n.removeAttribute("disabled")}})}n.addEventListener("click",i),e.addEventListener("keydown",r=>{r.key==="Enter"&&(r.metaKey||r.ctrlKey)&&i()})}},Ve=class extends B.Modal{constructor(p,e,t,n=""){super(p),this.titleText=e,this.content=t,this.noteText=n}onOpen(){let{contentEl:p}=this;if(p.empty(),p.createEl("h3",{text:this.titleText}),this.noteText){let t=p.createEl("div",{text:this.noteText});t.className="zrr-indexed-note"}let e=p.createEl("textarea",{attr:{rows:"12",readonly:"true"}});e.style.width="100%",e.value=this.content}},Ze=class extends B.Modal{constructor(e,t,n=""){super(e);this.bodyText="";this.plugin=t,this.initialTerm=n}onOpen(){let{contentEl:e}=this;e.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),e.style.display="flex",e.style.flexDirection="column",e.style.height="100%",e.style.overflow="hidden",e.style.minHeight="0";let t=e.createDiv();t.style.display="flex",t.style.alignItems="center",t.style.justifyContent="space-between",t.style.gap="0.5rem",t.createEl("h3",{text:"Redis index search"});let n=t.createEl("button",{text:"Copy All"});n.style.marginLeft="auto",n.addEventListener("click",()=>{this.copyResultsToClipboard()});let i=e.createDiv();i.style.display="flex",i.style.alignItems="center",i.style.gap="0.5rem",i.style.margin="0.5rem 0";let r=i.createEl("input");r.type="text",r.placeholder="Search term",r.value=this.initialTerm,r.style.flex="1",r.style.minWidth="0",this.inputEl=r,i.createEl("button",{text:"Search"}).addEventListener("click",()=>{this.runSearch()}),r.addEventListener("keydown",c=>{c.key==="Enter"&&(c.preventDefault(),this.runSearch())});let s=e.createDiv();s.style.color="var(--text-muted)",s.style.marginBottom="0.5rem",this.statusEl=s;let o=e.createDiv();o.style.flex="1 1 0",o.style.minHeight="0",o.style.border="1px solid var(--background-modifier-border)",o.style.borderRadius="6px",o.style.display="flex",o.style.flexDirection="column",o.style.overflow="auto";let l=_e.EditorState.create({doc:this.bodyText,extensions:[$t,jt,ae.EditorView.editable.of(!1),_e.EditorState.readOnly.of(!0),ae.EditorView.lineWrapping]});this.editorView=new ae.EditorView({state:l,parent:o}),this.initialTerm&&this.runSearch()}onClose(){var e;(e=this.editorView)==null||e.destroy(),this.editorView=void 0}async runSearch(){var n;let e=(((n=this.inputEl)==null?void 0:n.value)||"").trim();if(!e){this.statusEl&&(this.statusEl.textContent="Enter a search term.");return}this.statusEl&&(this.statusEl.textContent="Searching...");let t=await this.plugin.runRedisSearch(e);this.updateEditor(t),this.statusEl&&(this.statusEl.textContent=`Results for "${e}"`)}updateEditor(e){if(!this.editorView)return;let t=this.editorView,n=t.scrollDOM.scrollTop,i=t.state.selection.main,r=e.length,a=Math.min(i.anchor,r),s=Math.min(i.head,r);t.dispatch({changes:{from:0,to:t.state.doc.length,insert:e},selection:{anchor:a,head:s}}),t.scrollDOM.scrollTop=n,this.bodyText=e}copyResultsToClipboard(){let e=this.bodyText||"";if(!e){new B.Notice("Nothing to copy.");return}navigator.clipboard.writeText(e).then(()=>new B.Notice("Results copied to clipboard.")).catch(()=>new B.Notice("Failed to copy results."))}},ye=class extends B.Modal{constructor(p,e,t,n){super(p),this.titleText=e,this.bodyText=t,this.options=n}onOpen(){var r,a,s,o;let{contentEl:p}=this;p.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),p.style.display="flex",p.style.flexDirection="column",p.style.height="100%",p.style.overflow="hidden",p.style.minHeight="0";let e=p.createDiv();e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="space-between",e.style.gap="0.5rem",e.createEl("h3",{text:this.titleText});let t=e.createDiv();if(t.style.display="flex",t.style.gap="0.5rem",(r=this.options)!=null&&r.onClear){let l=(a=this.options.clearLabel)!=null?a:"Clear log";t.createEl("button",{text:l}).addEventListener("click",async()=>{var d,u;try{await((u=(d=this.options)==null?void 0:d.onClear)==null?void 0:u.call(d))}finally{await this.refreshFromSource()}})}let n=p.createDiv();n.style.flex="1 1 0",n.style.minHeight="0",n.style.border="1px solid var(--background-modifier-border)",n.style.borderRadius="6px",n.style.display="flex",n.style.flexDirection="column",n.style.overflow="auto";let i=_e.EditorState.create({doc:this.bodyText,extensions:[$t,jt,ae.EditorView.editable.of(!0),_e.EditorState.readOnly.of(!1),ae.EditorView.lineWrapping]});if(this.editorView=new ae.EditorView({state:i,parent:n}),this.refreshFromSource(),(s=this.options)!=null&&s.autoRefresh&&this.options.onRefresh){let l=(o=this.options.refreshIntervalMs)!=null?o:2e3;this.refreshTimer=window.setInterval(()=>{this.refreshFromSource()},l)}}onClose(){var p;this.refreshTimer!==void 0&&(window.clearInterval(this.refreshTimer),this.refreshTimer=void 0),(p=this.editorView)==null||p.destroy(),this.editorView=void 0}async refreshFromSource(){var s;if(!((s=this.options)!=null&&s.onRefresh)||!this.editorView)return;let p="";try{p=await this.options.onRefresh()||""}catch(o){return}if(p===this.bodyText)return;let e=this.editorView,t=e.scrollDOM.scrollTop,n=e.state.selection.main,i=p.length,r=Math.min(n.anchor,i),a=Math.min(n.head,i);e.dispatch({changes:{from:0,to:e.state.doc.length,insert:p},selection:{anchor:r,head:a}}),e.scrollDOM.scrollTop=t,this.bodyText=p}},Ue=class extends B.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.filePath=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let t=e.createEl("div");t.style.display="flex",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Overwrite"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Be=class extends B.Modal{constructor(e,t,n,i){super(e);this.resolved=!1;this.notePath=t,this.docId=n,this.onResolve=i}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete note and cached data?"}),e.createEl("p",{text:`This will delete the note and cached chunks/items for doc_id ${this.docId}.`}),e.createEl("p",{text:`Note: ${this.notePath}`});let t=e.createEl("div");t.style.display="flex",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Delete"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Ge=class extends B.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.reason=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Rebuild Redis index?"}),e.createEl("p",{text:this.reason}),e.createEl("p",{text:"This will drop the RedisSearch index (and embeddings) and rebuild it from cached chunks."});let t=e.createEl("div");t.style.display="flex",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Drop & rebuild"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},We=class extends B.Modal{constructor(e,t){super(e);this.resolved=!1;this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Purge Redis orphaned chunks?"}),e.createEl("p",{text:"This removes Redis chunk keys that have no cached item.json or chunk.json on disk."}),e.createEl("p",{text:"Cache files are not deleted. Use this to clean up stale Redis data."});let t=e.createEl("div");t.style.display="flex",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Purge orphans"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},He=class extends B.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve metadata conflicts"}),e.createEl("p",{text:"Choose which values to keep for each field."});let t=e.createEl("div");t.style.display="grid",t.style.gap="0.75rem";for(let l of this.conflicts){let c=t.createEl("div");c.style.display="grid",c.style.gap="0.4rem",c.style.border="1px solid var(--background-modifier-border)",c.style.borderRadius="6px",c.style.padding="0.6rem",c.createEl("div",{text:l.fieldLabel}).style.fontWeight="600";let d=c.createEl("div");d.style.display="grid",d.style.gridTemplateColumns="1fr 1fr",d.style.gap="0.5rem";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});u.style.width="100%",u.value=l.noteValue||"(empty)";let _=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});_.style.width="100%",_.value=l.zoteroValue||"(empty)";let m=c.createEl("div");m.style.display="flex",m.style.gap="0.5rem",m.style.alignItems="center",m.createEl("span",{text:"Decision:"});let y=m.createEl("select");y.add(new Option(l.noteLabel,"note")),y.add(new Option(l.zoteroLabel,"zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.field,y)}let n=e.createEl("div");n.style.display="flex",n.style.flexWrap="wrap",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let i=l=>{for(let c of this.selects.values())c.value=l},r=n.createEl("button",{text:"Use note for all"}),a=n.createEl("button",{text:"Use Zotero for all"}),s=n.createEl("button",{text:"Skip all"}),o=n.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[t,n]of this.selects.entries())e[t]=n.value||"skip";this.onResolve(e)}}},Ke=class extends B.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve annotation conflicts"}),e.createEl("p",{text:"Choose which version to keep for each annotation."});let t=e.createEl("div");t.style.display="grid",t.style.gap="0.75rem";for(let l of this.conflicts){let c=t.createEl("div");c.style.display="grid",c.style.gap="0.4rem",c.style.border="1px solid var(--background-modifier-border)",c.style.borderRadius="6px",c.style.padding="0.6rem",c.createEl("div",{text:l.title}).style.fontWeight="600";let d=c.createEl("div");d.style.display="grid",d.style.gridTemplateColumns="1fr 1fr",d.style.gap="0.5rem";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});u.style.width="100%",u.value=l.noteValue||"(empty)";let _=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});_.style.width="100%",_.value=l.zoteroValue||"(empty)";let m=c.createEl("div");m.style.display="flex",m.style.gap="0.5rem",m.style.alignItems="center",m.createEl("span",{text:"Decision:"});let y=m.createEl("select");y.add(new Option("Use note","note")),y.add(new Option("Use Zotero","zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.key,y)}let n=e.createEl("div");n.style.display="flex",n.style.flexWrap="wrap",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let i=l=>{for(let c of this.selects.values())c.value=l},r=n.createEl("button",{text:"Use note for all"}),a=n.createEl("button",{text:"Use Zotero for all"}),s=n.createEl("button",{text:"Skip all"}),o=n.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[t,n]of this.selects.entries())e[t]=n.value||"skip";this.onResolve(e)}}},Je=class extends B.SuggestModal{constructor(e,t){super(e);this.resolved=!1;this.resolveSelection=t,this.setPlaceholder("Select a language for OCR/quality...")}getSuggestions(e){let t=e.trim().toLowerCase();return t?zt.filter(n=>n.label.toLowerCase().includes(t)||n.value.toLowerCase().includes(t)):zt}renderSuggestion(e,t){t.setText(e.label),t.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new ke(this.app,"Custom language hint","e.g., en, de, fr, de,en",t=>this.resolveSelection(t.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},Xe=class extends B.SuggestModal{constructor(e,t,n){super(e);this.lastError=null;this.indexedDocIds=null;this.querySequence=0;this.queryDebounceMs=200;this.minQueryLength=2;this.maxQueryCacheEntries=100;this.queryCache=new Map;this.plugin=t,this.resolveSelection=n,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){let t=e.trim();if(t.length>0&&t.length<this.minQueryLength)return[];let n=t.toLowerCase(),i=this.queryCache.get(n);if(i)return i;let r=++this.querySequence;try{if(await new Promise(s=>{window.setTimeout(s,this.queryDebounceMs)}),r!==this.querySequence)return[];if(!this.indexedDocIds){let s=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(s))}let a=await this.plugin.searchZoteroItems(t);if(r!==this.querySequence)return[];if(this.queryCache.set(n,a),this.queryCache.size>this.maxQueryCacheEntries){let s=this.queryCache.keys().next().value;s!==void 0&&this.queryCache.delete(s)}return a}catch(a){let s=a instanceof Error?a.message:String(a);return this.lastError!==s&&(this.lastError=s,new B.Notice(s)),console.error("Zotero search failed",a),[]}}renderSuggestion(e,t){var b,C,f,k,x,v;let n=(C=(b=e.data)==null?void 0:b.title)!=null?C:"[No title]",i=Tt(e),r=Dt(e),a=r?(f=this.indexedDocIds)==null?void 0:f.has(r):!1,s=Mt(e),o=String((x=(k=e.data)==null?void 0:k.itemType)!=null?x:"").trim();a&&t.addClass("zrr-indexed-item"),s==="no"&&t.addClass("zrr-no-pdf-item");let l=t.createDiv({cls:"zrr-zotero-suggest-row"}),c=l.createSpan({cls:"zrr-zotero-item-icon"}),d=(v=hn[o])!=null?v:"file-text";(0,B.setIcon)(c,d);let u=l.createDiv({cls:"zrr-zotero-suggest-text"});u.createEl("div",{text:n,cls:"zrr-zotero-suggest-title"});let _=u.createEl("small",{cls:"zrr-zotero-suggest-meta"}),m=!1,y=()=>{m&&_.createSpan({text:" - "})};i&&(_.createSpan({text:i}),m=!0),a&&(y(),_.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),m=!0),s==="no"&&(y(),_.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),m=!0),t.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,t){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}};var Vt={"docling_extract.py":`#!/usr/bin/env python3
# zotero-redisearch-rag tool version: 0.8.3
import argparse
import atexit
import base64
import errno
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.8.3
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.8.3
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.8.3
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.8.3
...
`;n.replaceRange(l,{line:r.startLine+1,ch:0},{line:r.endLine,ch:0}),this.showStatusProgress("Chunk cleaned.",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new h.Notice("Chunk cleaned.")}async requestOcrCleanup(e){var l,c,d,u,_,m,y,b,C;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new h.Notice("OCR cleanup model is not configured."),this.openPluginSettings(),null;let i=Number(this.settings.llmCleanupMaxChars||0);if(i>0&&e.length>i)return new h.Notice("Chunk exceeds OCR cleanup max length. Adjust settings to clean it."),this.openPluginSettings(),null;let r=`${t}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o={model:n,temperature:Number((l=this.settings.llmCleanupTemperature)!=null?l:0),messages:[{role:"system",content:"You are an OCR cleanup assistant. Fix OCR errors without changing meaning. Do not add content. Return corrected text only. Detect footnote references and definitions and format them in Markdown as [^n] and [^n]: (for the note text). Preserve special characters and formatting. Do not create new footnotes or content; only reformat existing footnote markers/lines."},{role:"user",content:e}]};try{let f=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(o)});if(f.statusCode>=400){let R=f.body.toString("utf8");throw new Error(`Cleanup request failed (${f.statusCode}): ${R||"no response body"}`)}let k=JSON.parse(f.body.toString("utf8")),x=(C=(b=(y=(u=(d=(c=k==null?void 0:k.choices)==null?void 0:c[0])==null?void 0:d.message)==null?void 0:u.content)!=null?y:(m=(_=k==null?void 0:k.choices)==null?void 0:_[0])==null?void 0:m.text)!=null?b:k==null?void 0:k.output_text)!=null?C:"",v=String(x||"").trim();return v||(new h.Notice("Cleanup returned empty text."),null)}catch(f){return console.error("OCR cleanup failed",f),new h.Notice("OCR cleanup failed. Check the cleanup model settings."),null}}parseChunkTags(e,t){if(!e)return[];let n=e.trim(),i=[];if(n.startsWith("[")&&n.endsWith("]"))try{let s=JSON.parse(n);Array.isArray(s)&&(i=s.map(o=>String(o)))}catch(s){i=[]}i.length===0&&(i=n.split(/[,;\n]+/));let r=new Set,a=[];for(let s of i){let o=s.trim();if(o=o.replace(/^[-•\d.\)\s]+/,""),o=o.replace(/\s+/g," ").trim(),!o||o.length<2)continue;let l=o.toLowerCase();if(!r.has(l)&&(r.add(l),a.push(o),a.length>=t))break}return a}async requestChunkTags(e){var u,_,m,y,b,C,f,k,x;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new h.Notice("OCR cleanup model is not configured."),this.openPluginSettings(),null;let i=e.trim().slice(0,2e3);if(!i)return[];let r=`${t}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o=5,l="Return 3 to 5 high-signal, concrete noun-phrase tags. Avoid generic terms (study, paper, method), verbs, and filler. Prefer specific entities, methods, datasets, and named concepts. Output comma-separated tags only. No extra text.",c=Number((u=this.settings.llmCleanupTemperature)!=null?u:0),d={model:n,messages:[{role:"system",content:l},{role:"user",content:i}]};Number.isFinite(c)&&(d.temperature=c),this.showStatusProgress("Generating tags...",null);try{let v=async M=>{let O=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(M)});if(O.statusCode>=400){let $=O.body.toString("utf8");throw new Error(`Tag request failed (${O.statusCode}): ${$||"no response body"}`)}return O.body},R;try{R=await v(d)}catch(M){let O=M instanceof Error?M.message:String(M);if("temperature"in d&&/temperature/i.test(O)&&/unsupported|default/i.test(O)){let $={...d};delete $.temperature,R=await v($)}else throw M}let A=JSON.parse(R.toString("utf8")),S=(x=(k=(f=(y=(m=(_=A==null?void 0:A.choices)==null?void 0:_[0])==null?void 0:m.message)==null?void 0:y.content)!=null?f:(C=(b=A==null?void 0:A.choices)==null?void 0:b[0])==null?void 0:C.text)!=null?k:A==null?void 0:A.output_text)!=null?x:"",L=this.parseChunkTags(String(S||""),o);return L.length||new h.Notice("Tag generation returned no tags."),L}catch(v){return console.error("Tag generation failed",v),new h.Notice("Tag generation failed. Check the cleanup model settings."),null}finally{this.clearStatusProgress()}}async renderMarkdownToIndexText(e){if(!e)return"";let t=this.replaceImageMarkersForIndexPreview(e),n=document.createElement("div");try{await h.MarkdownRenderer.renderMarkdown(t,n,"",this)}catch(l){return console.warn("Failed to render markdown for index preview",l),this.normalizeIndexPreviewText(t)}let a=(n.innerHTML||"").replace(/<br\s*\/?>/gi,`
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,t=1200){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},t);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,t=1200,n="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,n)},t);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,t=1200,n="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,n)},t);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let t=this.annotationNoteEditTimes.get(e);if(!t)return 0;let n=Date.now()-t;return n>=Jt?0:Jt-n}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let t=(e.annotation_page_label||"").trim();if(t)return t;let n=e.page_start?String(e.page_start):"",i=e.page_end?String(e.page_end):"";if(n&&(!i||n===i))return n;if(n&&i)return`${n} - ${i}`;let r=(e.pages||"").trim();if(!r)return"?";let a=r.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:r.replace("-"," - ")}normalizeChunkIdForNote(e,t){if(!e)return null;let n=String(e);if(t&&n.startsWith(`${t}:`))return n.slice(t.length+1);if(n.includes(":")){let i=n.split(":");if(i.length>1&&t&&i[0]===t)return i.slice(1).join(":")}return n}async syncNoteToRedis(e){var t,n,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,h.normalizePath)(`${H}/${s}.json`),c=this.app.vault.adapter;if(!await c.exists(l))return;let d=await this.readChunkPayload(l);if(!d)return;let u=Array.isArray(d.chunks)?d.chunks:[],_=new Map;for(let x of u){if(this.isAnnotationChunk(x))continue;let v=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((t=x==null?void 0:x.chunk_id)!=null?t:"");v&&_.set(v,x)}let m=new Set,y=new Set,b=new Set,C=new Set,f=!1;for(let x of o){let v=x.chunkId;if(!v)continue;m.add(v);let R=_.get(v);if(!R){console.warn(`Sync note: chunk id not found in cache (${v})`);continue}if(x.excludeFlag){R.excluded!==!0&&(R.excluded=!0,f=!0);let L=this.normalizeChunkText(x.text);L&&L!==String((n=R.text)!=null?n:"")&&(R.text=L,R.char_count=L.length,f=!0),b.add(v);continue}if(R.excluded&&(R.excluded=!1,f=!0,y.add(v)),!x.text.trim()){b.add(v),C.add(v);continue}let A=this.normalizeChunkText(x.text);if(!A){b.add(v),C.add(v);continue}let S=typeof R.text=="string"?R.text:String((i=R.text)!=null?i:"");A!==S&&(R.text=A,R.char_count=A.length,y.add(v),f=!0)}for(let x of _.keys())m.has(x)||(b.add(x),C.add(x));let k=new Set([...b,...C]);if(k.size){let x=Array.from(k).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==x){this.noteSyncPendingDeletes.set(e.path,x),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!y.size&&!b.size&&!C.size&&!f)return;C.size&&(d.chunks=u.filter(x=>{var R;let v=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((R=x==null?void 0:x.chunk_id)!=null?R:"");return v&&!C.has(v)}),f=!0),(f||C.size)&&await c.write(l,JSON.stringify(d,null,2)),await this.reindexChunkUpdates(s,l,Array.from(y),Array.from(b)),(b.size||C.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,t){var n,i,r;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,t);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),s=await this.resolveDocIdForNote(e,a);if(!s)return;let o=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter;if(!o)return;let l=this.resolveZoteroItemKey(o,s);if(!l)return;let c=await this.fetchZoteroItem(l),d=(i=c==null?void 0:c.data)!=null?i:c;if(!d||typeof d!="object")return;let u=this.extractNoteMetadata(o),_=this.extractZoteroMetadata(d);_.citekey||(_.citekey=await this.resolveZoteroCitekey(d,l,c==null?void 0:c.meta));let m=await this.getMetadataSnapshot(s,o,e),y={},b={},C={},f=[],k=["title","short_title","citekey","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],x={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},v=k.filter(A=>this.hasFrontmatterKey(o,x[A]));if(!v.length)return;let R={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let A of v){let S=u[A],L=_[A];if(this.metadataValuesEqual(A,S,L))continue;let M=m==null?void 0:m[A];if(M!==void 0){let $=!this.metadataValuesEqual(A,S,M),F=!this.metadataValuesEqual(A,L,M);if($&&!F){C[A]="note",this.assignMetadataUpdate(b,A,S);continue}if(!$&&F){C[A]="zotero",this.assignMetadataUpdate(y,A,L);continue}}let O=this.getMetadataDecisionLabels(A,S,L,R);f.push({field:A,fieldLabel:R[A],noteLabel:O.noteLabel,zoteroLabel:O.zoteroLabel,noteValue:this.formatMetadataValue(S),zoteroValue:this.formatMetadataValue(L)})}if(f.length>0){let A=await this.promptMetadataBatchDecision(f);for(let S of f){let L=(r=A[S.field])!=null?r:"skip";C[S.field]=L,L==="note"?this.assignMetadataUpdate(b,S.field,u[S.field]):L==="zotero"&&this.assignMetadataUpdate(y,S.field,_[S.field])}}Object.keys(y).length>0&&await this.applyNoteMetadataUpdates(e,y),Object.keys(b).length>0&&await this.applyZoteroMetadataUpdates(l,d,u,_,b),await this.updateMetadataSnapshot(e,s,u,_,m,C,v)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,t)}}async syncNoteAnnotationsWithZotero(e,t){var n,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,t);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let z=this.ensureDocIdInNoteContent(o,d);z!==o&&await this.writeNoteWithSyncSuppressed(e.path,z)}if(!d)return;let u=(i=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter)!=null?i:{},_=(r=c.attachmentKey)!=null?r:"";if(_||(_=await this.resolveAttachmentKeyForDocId(d,u)),!_)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===_&&await this.updateDocIndex({doc_id:d,attachment_key:_});let m=_,y=await this.fetchZoteroAnnotationsForDoc(d,_),b=y.annotations;_=y.attachmentKey,_&&_!==m&&await this.updateDocIndex({doc_id:d,attachment_key:_});let C=this.parseAnnotationBlock(l.block,_),f=new Map;for(let z of C)z.key&&z.imagePath&&f.set(z.key,{path:z.imagePath,hash:z.imageHash||this.extractAnnotationImageHashFromPath(z.imagePath)});await this.attachAnnotationImages(d,_,b,e.path,f);let k=new Map;for(let z of C)z.key&&k.set(z.key,z);let x=new Map;for(let z of b)x.set(z.key,z);let v=await this.getAnnotationSnapshot(d),R=(a=v==null?void 0:v.annotations)!=null?a:{},A={},S=[],L=!1,M=!1,O=!1;_&&_!==m&&b.length>0&&(M=!0,O=!0);for(let[z,j]of x.entries()){let I=k.get(z);if(!I){M=!0;continue}let D=R[z],q=this.annotationSnapshotFromEntry(I,j.annotationType),U=this.annotationSnapshotFromEntry(j,j.annotationType),J=(q.image_hash||"")!==(U.image_hash||"");if(!D){this.annotationSnapshotsEqualIgnoringImage(q,U)?J&&(M=!0,O=!0):(A[z]="note",L=!0);continue}let Z=!this.annotationSnapshotsEqual(q,D),Q=!this.annotationSnapshotsEqual(U,D),X=(U.color_key||"")!==(D.color_key||""),ie=!this.annotationSnapshotsEqualIgnoringImage(q,D),se=!this.annotationSnapshotsEqualIgnoringImage(U,D);ie&&!se?(A[z]="note",L=!0):!ie&&se?(A[z]="zotero",M=!0):ie&&se&&S.push({key:z,title:this.formatAnnotationConflictTitle(j),noteValue:this.formatAnnotationConflictValue(q,I.tags),zoteroValue:this.formatAnnotationConflictValue(U,j.tags)}),J&&(Z||Q)&&(M=!0,O=!0),X&&(M=!0,O=!0)}if(S.length>0){let z=await this.promptAnnotationBatchDecision(S);for(let j of S){let I=(s=z[j.key])!=null?s:"skip";A[j.key]=I,I==="note"?L=!0:I==="zotero"&&(M=!0,O=!0)}}let $=[];for(let[z,j]of Object.entries(A)){if(j!=="note")continue;let I=k.get(z),D=x.get(z);!I||!D||$.push({entry:D,note:I})}$.length>0&&await this.applyZoteroAnnotationUpdates($),L&&this.annotationNoteEditTimes.set(e.path,Date.now());let F=this.getAnnotationGraceRemaining(e.path);if(M&&F>0&&L&&!O&&(this.scheduleNoteAnnotationSync(e,F+250,t),M=!1),M){let z=this.buildAnnotationBlock(d,_,b),j=this.replaceAnnotationBlock(o,z);if(j&&j!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,j)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,_,b),await this.updateAnnotationChunks(d,_,b)}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,t)}}resolveZoteroItemKey(e,t){let n=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),t];for(let i of n){let r=V(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,t){var l;if(!e)return"";let n=await this.getDocIndexEntry(e);if(n||(n=await this.hydrateDocIndexFromCache(e)),n!=null&&n.attachment_key)return n.attachment_key;let i=(0,h.normalizePath)(`${H}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let d=await this.readChunkPayload(i),u=d!=null&&d.metadata&&typeof d.metadata=="object"?d.metadata:null,_=u==null?void 0:u.attachment_key;if(typeof _=="string"&&_.trim())return await this.updateDocIndex({doc_id:e,attachment_key:_.trim()}),_.trim()}}catch(c){}let r=this.resolveZoteroItemKey(t,e);if(!r)return"";let a=await this.fetchZoteroItem(r),s=(l=a==null?void 0:a.data)!=null?l:a;if(!s||typeof s!="object")return"";let o=await ve(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var C,f,k,x,v,R,A,S,L,M,O,$,F;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString((x=(k=(f=(C=e==null?void 0:e["short title"])!=null?C:e==null?void 0:e.short_title)!=null?f:e==null?void 0:e.shortTitle)!=null?k:e==null?void 0:e["short-title"])!=null?x:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString((S=(A=(R=(v=e==null?void 0:e.citekey)!=null?v:e==null?void 0:e["citation key"])!=null?R:e==null?void 0:e.citation_key)!=null?A:e==null?void 0:e.citationKey)!=null?S:e==null?void 0:e["citation-key"]),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString((L=e==null?void 0:e.abstract)!=null?L:e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((M=e==null?void 0:e.doi)!=null?M:e==null?void 0:e.DOI),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),u=this.normalizeMetadataString(e==null?void 0:e.pages),_=this.normalizeMetadataString((F=($=(O=e==null?void 0:e["item type"])!=null?O:e==null?void 0:e.item_type)!=null?$:e==null?void 0:e.itemType)!=null?F:e==null?void 0:e["item-type"]),m=this.normalizeMetadataList(e==null?void 0:e.tags),y=this.normalizeMetadataList(e==null?void 0:e.authors),b=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:t,short_title:n,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:u,item_type:_,tags:this.sanitizeObsidianTags(m),authors:y,editors:b}}extractZoteroMetadata(e){var f,k,x;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString(me(e)),i=this.normalizeMetadataString($e(e)),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString(e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((f=e==null?void 0:e.DOI)!=null?f:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),u=this.normalizeMetadataString(e==null?void 0:e.pages),_=this.normalizeMetadataString((x=(k=e==null?void 0:e.itemType)!=null?k:e==null?void 0:e.item_type)!=null?x:e==null?void 0:e["item-type"]),m=Array.isArray(e==null?void 0:e.creators)?e.creators:[],y=m.filter(v=>(v==null?void 0:v.creatorType)==="author").map(v=>he(v)).filter(Boolean),b=m.filter(v=>(v==null?void 0:v.creatorType)==="editor"||(v==null?void 0:v.creatorType)==="seriesEditor").map(v=>he(v)).filter(Boolean),C=Array.isArray(e==null?void 0:e.tags)?e.tags.map(v=>typeof v=="string"?v:v==null?void 0:v.tag).filter(v=>typeof v=="string"):[];return{title:t,short_title:n,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:u,item_type:_,tags:this.sanitizeObsidianTags(C),authors:this.normalizeMetadataList(y),editors:this.normalizeMetadataList(b)}}async resolveZoteroCitekey(e,t,n){let i=this.normalizeMetadataString($e(e,n!=null?n:void 0));if(i)return i;if(!t)return"";let r=await this.fetchZoteroItemCsl(t);return this.normalizeMetadataString(lt(r))}extractAnnotationPageInfo(e){var a;let n=V((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:n,pageIndex:i}}extractAnnotationImagePayload(e){var a,s,o,l;let t=(s=(a=e.annotationImage)!=null?a:e.annotationImageData)!=null?s:e.annotationImageBase64;if(!t)return null;let n=null,i="";if(Buffer.isBuffer(t))n=t;else if(ArrayBuffer.isView(t))n=Buffer.from(t.buffer,t.byteOffset,t.byteLength);else if(t instanceof ArrayBuffer)n=Buffer.from(t);else if(typeof t=="string"){let c=t.trim();if(!c)return null;let d=c.match(/^data:([^;]+);base64,(.*)$/i);if(d&&(i=this.normalizeAnnotationImageMime(d[1]),c=d[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;n=Buffer.from(c,"base64")}if(!n||!n.length)return null;i||(i=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(n)||"image/png");let r=this.annotationImageExtensionFromMime(i)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(n))||"png";return{buffer:n,mime:i,ext:r}}parseZoteroAnnotationItem(e,t){var C,f,k,x;let n=(f=(C=e==null?void 0:e.data)!=null?C:e)!=null?f:{},i=V((k=e==null?void 0:e.key)!=null?k:n==null?void 0:n.key);if(!i)return null;let r=V(n.annotationType),a=this.normalizeAnnotationText(n.annotationText),s=this.normalizeAnnotationText(n.annotationComment),o=V(n.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:u,pageIndex:_}=this.extractAnnotationPageInfo(n),m=(x=n.annotationSortIndex)!=null?x:n.annotationSort,y=Number.isFinite(Number(m))?Number(m):0,b=Array.isArray(n.tags)?n.tags.map(v=>typeof v=="string"?v:v==null?void 0:v.tag).filter(v=>typeof v=="string"):[];return{key:i.trim(),attachmentKey:t,pageLabel:u,pageIndex:_,colorKey:l,callout:d,heading:c,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(b),sortIndex:y,rawValues:n}}async fetchZoteroAnnotations(e){if(!e)return[];let t=this.canUseWebApi()||await this.ensureWebApiLibraryId(),n=a=>{var o,l;let s=[];for(let c of a){let d=(l=(o=c==null?void 0:c.data)!=null?o:c)!=null?l:{};if(V(d.itemType)!=="annotation")continue;let u=this.parseZoteroAnnotationItem(c,e);u&&s.push(u)}return s},i=[];try{i=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(a){try{i=await this.fetchZoteroChildrenLocal(e)}catch(s){console.warn("Failed to fetch Zotero annotation items from local API",s)}}let r=n(i);if(!r.length&&t)try{let a=[];try{a=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(o){a=await this.fetchZoteroChildrenWeb(e)}let s=n(a);s.length&&(r=s)}catch(a){console.warn("Failed to fetch Zotero annotation items from Web API",a)}return r}async fetchZoteroAnnotationsForDoc(e,t){var o,l,c;let n=t,i=await this.fetchZoteroAnnotations(n);if(i.length||!e)return i.length||this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i};let r=[];try{r=await this.fetchZoteroChildren(e)}catch(d){return console.warn("Failed to fetch Zotero attachments for annotations",d),this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i}}let a=[],s=new Set(n?[n]:[]);for(let d of r){if(!ct(d))continue;let u=V((c=(l=d==null?void 0:d.key)!=null?l:(o=d==null?void 0:d.data)==null?void 0:o.key)!=null?c:d==null?void 0:d.attachmentKey);!u||s.has(u)||(s.add(u),a.push(u))}for(let d of a){let u=await this.fetchZoteroAnnotations(d);if(u.length)return{attachmentKey:d,annotations:u}}return this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i}}async attachAnnotationImages(e,t,n,i,r){var u;if(!this.settings.includeAnnotationImages||!n.length)return;let a=await this.resolveAnnotationImageOutputDir(i);if(!a)return;let s=this.sanitizeFileName(e||t)||"annotations",o=(0,h.normalizePath)(E.default.join(a.relative||"",s)),l=E.default.normalize(E.default.join(a.absolute,s));o?await this.ensureFolder(o):await G.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,d=new Map;for(let _ of n){let m=String(_.annotationType||"").trim().toLowerCase(),y=m==="image"||m==="ink",b=this.extractAnnotationImagePayload((u=_.rawValues)!=null?u:{});if(!b&&y&&this.settings.zoteroCompanionEnabled&&(b=await this.fetchCompanionAnnotationImage(_.key)),!b){let x=r==null?void 0:r.get(_.key);x!=null&&x.path&&await c.exists(x.path)&&(_.imagePath=x.path,_.imageHash=x.hash,d.set(_.key,x.path));continue}let C=(0,Ee.createHash)("sha1").update(b.buffer).digest("hex").slice(0,12),f=`zrr-annotation-${_.key}-${C}.${b.ext}`,k=(0,h.normalizePath)(E.default.join(o,f));try{await c.exists(k)||await c.writeBinary(k,this.bufferToArrayBuffer(b.buffer)),_.imagePath=k,_.imageHash=C,d.set(_.key,k)}catch(x){console.warn("Failed to write annotation image",{annotationKey:_.key,error:x})}}if(o&&await c.exists(o))try{let _=await c.list(o);for(let m of _.files){let b=E.default.basename(m).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!b)continue;let C=b[1].toUpperCase(),f=d.get(C);(!f||(0,h.normalizePath)(f)!==(0,h.normalizePath)(m))&&await c.remove(m)}}catch(_){console.warn("Failed to clean up annotation images",_)}}async fetchCompanionAnnotationImage(e){let t=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!t)return null;let n=`${t.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,i={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(i.Authorization=`Bearer ${r}`);try{let a=await this.requestLocalApiRaw(n,{headers:i,timeoutMs:5e3});if(a.statusCode===200){let s=a.headers["content-type"],o=Array.isArray(s)?s[0]:s!=null?s:"";return this.buildAnnotationImagePayloadFromBuffer(a.body,o)}if(a.statusCode===204||a.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:a.statusCode})}catch(a){console.warn("Failed to fetch annotation image from Zotero companion",a)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new h.Notice("Zotero companion base URL is not set.");return}let t=`${e.replace(/\/$/,"")}/health`,n={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(n.Authorization=`Bearer ${i}`);try{let r=await this.requestLocalApiRaw(t,{headers:n,timeoutMs:3e3});if(r.statusCode===200){try{let a=JSON.parse(r.body.toString("utf8"));if(a!=null&&a.ok){new h.Notice("Zotero companion: OK.");return}}catch(a){}new h.Notice("Zotero companion responded but did not return OK.");return}if(r.statusCode===401){new h.Notice("Zotero companion: unauthorized (check token).");return}new h.Notice(`Zotero companion: HTTP ${r.statusCode}.`)}catch(r){console.warn("Zotero companion health check failed",r),new h.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new h.Notice("Opened Zotero. Go to Tools \u2192 Add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new h.Notice("Unable to open Zotero automatically. Open Zotero and go to Tools \u2192 Add-ons.")}}async spawnDetached(e){let[t,...n]=e;if(!t)throw new Error("Missing command");await new Promise((i,r)=>{let a=!1,s=(0,te.spawn)(t,n,{detached:!0,stdio:"ignore"});s.on("error",o=>{a||(a=!0,r(o))}),s.unref(),a||(a=!0,i())})}maybeWarnMissingAnnotationApi(e,t){if(this.canUseWebApi()){console.info("No Zotero annotations returned for attachment",{docId:e,attachmentKey:t});return}let n=e||t;!n||this.annotationWebApiWarned.has(n)||(this.annotationWebApiWarned.add(n),new h.Notice("Zotero annotations require Web API access. Configure the Web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
${_}`:f)}let m=c!==null?r?` (${c})`:` page=${c}`:"",b=` id=${l}${r?" section":""}${m}${d?" exclude":""}`;a.push(`<!-- zrr:chunk${b} -->`),_&&a.push(_),a.push("<!-- zrr:chunk end -->"),a.push("")}return a[a.length-1]===""&&a.pop(),a.push("<!-- zrr:sync-end -->"),a.join(`
...
`);for(let a=0;a<r.length;a+=1)if(i.test(r[a]))return a;return null}async openNoteAtChunk(e,t){if(!e||!t)return!1;await this.openNoteInMain(e);let i=this.getMainLeaf().view;if(!(i instanceof h.MarkdownView))return!1;let r=i.editor,a=this.normalizeChunkIdForNote(t)||t,s=this.findChunkLineInText(r.getValue(),a);return s===null?(new h.Notice(`Chunk ${a} not found in note.`),!1):(r.setCursor({line:s,ch:0}),r.scrollIntoView({from:{line:s,ch:0},to:{line:s,ch:0}},!0),!0)}async openNoteAtAnnotation(e,t,n,i){let r=this.buildAnnotationBlockId(t,n,i);if(!e||!r)return!1;await this.openNoteInMain(e);let s=this.getMainLeaf().view;if(!(s instanceof h.MarkdownView))return!1;let o=s.editor,l=this.findAnnotationLineInText(o.getValue(),r);return l===null?(new h.Notice(`Annotation ${t} not found in note.`),!1):(o.setCursor({line:l,ch:0}),o.scrollIntoView({from:{line:l,ch:0},to:{line:l,ch:0}},!0),!0)}async openInternalLinkInMain(e){let t=this.getMainLeaf(),[n,i]=e.split("#"),r=(n||"").trim(),a=(i||"").trim(),s="zrr-chunk:",o=r?this.app.metadataCache.getFirstLinkpathDest(r,""):null;if(o instanceof h.TFile){let l=a.startsWith(s)?a.slice(s.length).trim():"";if(l&&await this.openNoteAtChunk(o.path,l))return;await t.openFile(o,{active:!0}),e.includes("#")&&!l&&(this.app.workspace.setActiveLeaf(t,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1));return}this.app.workspace.setActiveLeaf(t,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1)}async openNoteInNewTab(e){let t=(0,h.normalizePath)(e);await this.app.workspace.openLinkText(t,"","tab")}async openPdfInMain(e,t){if(!e)return!1;if(!E.default.isAbsolute(e)&&!/^[A-Za-z]+:\/\//.test(e)){let a=(0,h.normalizePath)(e),s=t?`#page=${t}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}let n=E.default.normalize(this.getVaultBasePath()),i=E.default.normalize(e),r=n.endsWith(E.default.sep)?n:`${n}${E.default.sep}`;if(i.startsWith(r)){let a=(0,h.normalizePath)(E.default.relative(n,i)),s=t?`#page=${t}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}try{return window.open((0,gt.pathToFileURL)(e).toString()),!0}catch(a){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,t,n,i){if(t){let r=new URLSearchParams;n&&r.set("page",n),i&&r.set("annotation",i);let a=r.toString()?`?${r.toString()}`:"";return`zotero://open-pdf/library/items/${t}${a}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let n=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(n))return n}formatCitationsMarkdown(e){return e.length?e.map(n=>this.formatCitationMarkdown(n)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e){var d,u,_,m,y;let t=e.doc_id||"?",n=this.formatCitationPageLabel(e),i=e.annotation_key||this.extractAnnotationKey(e.chunk_id),r=e.attachment_key||((u=(d=this.docIndex)==null?void 0:d[e.doc_id||""])==null?void 0:u.attachment_key),a=e.page_start?String(e.page_start):"",s=(m=(_=this.docIndex)==null?void 0:_[e.doc_id||""])!=null?m:null,o=this.resolveCitationTitle(s,(y=s==null?void 0:s.note_path)!=null?y:null,e.doc_id),l=this.formatCitationLabel(o,n),c=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&(s!=null&&s.note_path)){if(i){let b=a||(e.page_end?String(e.page_end):"0"),C=this.buildNoteAnnotationLink(s.note_path,i,r||"",b,l);return C?`- ${C}`:`- ${this.buildNoteLink(s.note_path,l)}`}if(c&&!i)return`- ${this.buildNoteChunkLink(s.note_path,c,l)}`}if(r){let b=this.buildZoteroDeepLink(t,r,a,i);return`- [${l}](${b})`}return`- ${l}`}buildNoteChunkLink(e,t,n){let i=(0,h.normalizePath)(e).replace(/\.md$/i,""),r=`zrr-chunk:${t}`,a=this.escapeWikiLabel(n);return`[[${i}#${r}\\|${a}]]`}buildNoteLink(e,t){let n=(0,h.normalizePath)(e).replace(/\.md$/i,""),i=this.escapeWikiLabel(t);return`[[${n}\\|${i}]]`}buildNoteAnnotationLink(e,t,n,i,r){let a=this.buildAnnotationBlockId(t,n,i);if(!a)return null;let s=(0,h.normalizePath)(e).replace(/\.md$/i,""),o=this.escapeWikiLabel(r);return`[[${s}#^${a}\\|${o}]]`}buildAnnotationBlockId(e,t,n){let i=(e||"").trim().toUpperCase(),r=(t||"").trim().toUpperCase();if(!i||!r)return null;let a=(n||"").trim()||"0";return`${i}a${r}p${a}`}escapeWikiLabel(e){return e?e.replace(/\|/g,"\\|"):""}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,h.normalizePath)(`${Y}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var n;let e=this.app.vault.adapter,t=this.getDocIndexPath();if(!await e.exists(t))return{};try{let i=await e.read(t),r=JSON.parse(i);if(r&&typeof r=="object"){let a=(n=r.entries)!=null?n:r;if(Array.isArray(a)){let s={};for(let l of a)l!=null&&l.doc_id&&(s[String(l.doc_id)]=l);let o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(s),s}if(a&&typeof a=="object"){let s=a,o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(s),s}}}catch(i){console.error("Failed to read doc index",i)}return{}}async saveDocIndex(e){await this.ensureFolder(Y);let t=this.app.vault.adapter,n=this.getDocIndexPath(),i={version:1,entries:e};await t.write(n,JSON.stringify(i,null,2)),this.docIndex=e}async pruneDocIndexOrphans(){var c;let e=this.app.vault.adapter,t=await this.getDocIndex(),n=new Set(await this.listDocIds(ne)),i=new Set(await this.listDocIds(H)),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),a=0,s=0,o=!1,l=new Date().toISOString();for(let d of Object.keys(t)){let u=t[d],_=!1,m=u!=null&&u.note_path?u.note_path.trim():"";if(m&&await e.exists(m))_=!0;else if((c=r[d])!=null&&c.note_path){_=!0;let b=r[d];b.note_path&&b.note_path!==u.note_path&&(u.note_path=b.note_path,s+=1,o=!0),b.note_title&&b.note_title!==u.note_title&&(u.note_title=b.note_title,s+=1,o=!0),s>0&&(u.updated_at=l)}let y=n.has(d)||i.has(d);!_&&!y&&(delete t[d],a+=1,o=!0)}return o&&await this.saveDocIndex(t),{removed:a,updated:s}}async updateDocIndex(e){var r;let t=await this.getDocIndex(),n=(r=t[e.doc_id])!=null?r:{doc_id:e.doc_id},i={...n,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&n.note_path&&(i.note_path=n.note_path),e.note_title===void 0&&n.note_title&&(i.note_title=n.note_title),e.zotero_title===void 0&&n.zotero_title&&(i.zotero_title=n.zotero_title),e.short_title===void 0&&n.short_title&&(i.short_title=n.short_title),e.pdf_path===void 0&&n.pdf_path&&(i.pdf_path=n.pdf_path),e.attachment_key===void 0&&n.attachment_key&&(i.attachment_key=n.attachment_key),typeof i.pdf_path=="string"&&(i.pdf_path=this.normalizeDocIndexPdfPath(i.pdf_path)),t[e.doc_id]=i,await this.saveDocIndex(t)}async removeDocIndexEntry(e){let t=await this.getDocIndex();if(!t[e]){await this.removeMetadataSnapshot(e);return}delete t[e],await this.saveDocIndex(t),await this.removeMetadataSnapshot(e)}async hydrateDocIndexFromCache(e){var s,o;if(!e)return null;let t=this.app.vault.adapter,n=await this.getDocIndexEntry(e),i={},r=(0,h.normalizePath)(`${ne}/${e}.json`);if(await t.exists(r))try{let l=await t.read(r),c=JSON.parse(l),d=(o=(s=c==null?void 0:c.data)!=null?s:c)!=null?o:{},u=typeof d.title=="string"?d.title:"";u&&(i.zotero_title=u);let _=me(d);if(_&&(i.short_title=_),!i.note_title||!i.note_path){let m=this.sanitizeFileName(u)||e,y=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${m}.md`),b=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${m}-${e}.md`),C="";await t.exists(y)?C=y:await t.exists(b)&&(C=b),C&&(i.note_path=C,i.note_title=E.default.basename(C,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!i.note_title&&(n!=null&&n.note_path)&&(i.note_title=E.default.basename(n.note_path,".md"));let a=(0,h.normalizePath)(`${H}/${e}.json`);if(await t.exists(a))try{let l=await t.read(a),c=JSON.parse(l);typeof(c==null?void 0:c.source_pdf)=="string"&&(i.pdf_path=c.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(i).length>0&&await this.updateDocIndex({doc_id:e,...i}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var n;return e&&(n=(await this.getDocIndex())[e])!=null?n:null}async inferNotePathFromCache(e){var i,r;let t=this.app.vault.adapter,n=(0,h.normalizePath)(`${ne}/${e}.json`);if(!await t.exists(n))return"";try{let a=await t.read(n),s=JSON.parse(a),o=(r=(i=s==null?void 0:s.data)!=null?i:s)!=null?r:{},l=typeof o.title=="string"?o.title:"",c=this.sanitizeFileName(l)||e,d=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${c}.md`),u=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${c}-${e}.md`);if(await t.exists(d))return d;if(await t.exists(u))return u}catch(a){console.error("Failed to infer note path from cache",a)}return""}async rebuildNoteFromCacheForDocId(e,t){var O,$,F,z,j;try{await this.ensureBundledTools()}catch(I){return t&&new h.Notice("Failed to sync bundled tools. See console for details."),console.error(I),!1}let n=this.app.vault.adapter,i=(0,h.normalizePath)(`${ne}/${e}.json`),r=(0,h.normalizePath)(`${H}/${e}.json`);if(!await n.exists(i)||!await n.exists(r))return t&&new h.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let a;try{let I=await n.read(i);a=JSON.parse(I)}catch(I){return t&&new h.Notice("Failed to read cached item JSON."),console.error(I),this.clearStatusProgress(),!1}let s;try{let I=await n.read(r);s=JSON.parse(I)}catch(I){return t&&new h.Notice("Failed to read cached chunks JSON."),console.error(I),this.clearStatusProgress(),!1}let o=(O=a.data)!=null?O:a,l=typeof o.title=="string"?o.title:"",c=((F=($=a.key)!=null?$:o.key)!=null?F:e).toString(),d=await this.getDocIndexEntry(e),u=typeof((z=s==null?void 0:s.metadata)==null?void 0:z.attachment_key)=="string"?s.metadata.attachment_key:d==null?void 0:d.attachment_key,_=typeof s.source_pdf=="string"?s.source_pdf:"";if(!_||!await this.isFileAccessible(_)){let I=await this.recoverMissingPdfFromAttachment(_,o,c,e,u,l,t);if(!I)return t&&new h.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;_=I.sourcePdf,I.attachmentKey&&(u=I.attachmentKey),await this.updateChunkJsonSourcePdf(r,_)}let m=await this.resolveLanguageHint(o,c),y=this.buildDoclingLanguageHint(m!=null?m:void 0),b="";if(d!=null&&d.note_path&&await n.exists(d.note_path)&&(b=(0,h.normalizePath)(d.note_path)),!b){let I=this.sanitizeFileName(l)||e,D=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${I}.md`),q=await n.exists(D)?I:await this.resolveUniqueBaseName(I,e);b=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${q}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let I=this.getLogFileRelativePath(),D=(0,h.normalizePath)(E.default.dirname(I));D&&await this.ensureFolder(D);let q=this.getSpellcheckerInfoRelativePath(),U=(0,h.normalizePath)(E.default.dirname(q));U&&await this.ensureFolder(U)}}catch(I){return t&&new h.Notice("Failed to create notes folder."),console.error(I),this.clearStatusProgress(),!1}let C=this.getPluginDir(),f=E.default.join(C,"tools","docling_extract.py"),k=E.default.join(C,"tools","index_redisearch.py"),x=null,v=null,R=I=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=I)};try{x=await this.readDoclingQualityLabelFromPdf(_,y),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",x),0);let I=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(f,await this.buildDoclingArgs(_,e,r,b,y,!0),U=>this.handleDoclingProgress(U,x),()=>{},I,"docling_extract",R),this.recreateMissingNotesProcess=null,x=await this.readDoclingQualityLabel(r),u&&await this.annotateChunkJsonWithAttachmentKey(r,u);let D=await this.readDoclingMetadata(r),q=await this.maybeCreateOcrLayeredPdf(_,D,y);q&&(_=q,v=q,await this.updateChunkJsonSourcePdf(r,q))}catch(I){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(t&&new h.Notice("Docling extraction failed. See console for details."),console.error(I),this.clearStatusProgress(),!1)}let A=!1,S=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;if(!await this.ensureRedisAvailable("rebuild"))A=!0,t&&new h.Notice("Redis is unavailable; skipping indexing for this note.");else try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",x),0);let I=["--chunks-json",this.getAbsoluteVaultPath(r),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(I),this.appendEmbedContextArgs(I),this.settings.embedIncludeMetadata&&I.push("--embed-include-metadata"),this.appendChunkTaggingArgs(I,{allowRegenerate:!1}),await this.runPythonStreaming(k,I,D=>{if((D==null?void 0:D.type)==="progress"&&D.total){let q=Math.round(D.current/D.total*100),U=typeof D.message=="string"&&D.message.trim()?D.message:`Indexing chunks ${D.current}/${D.total}`,J=this.formatStatusLabel(U,x);this.showStatusProgress(J,q)}},()=>{},S,"index_redisearch",R),this.recreateMissingNotesProcess=null}catch(I){if(this.recreateMissingNotesAbort)return this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1;t&&new h.Notice("RedisSearch indexing failed; note will still be rebuilt."),console.error(I),A=!0}let M=v?this.buildPdfLinkFromSourcePath(v):this.buildPdfLinkForNote(_,d==null?void 0:d.attachment_key,e);try{let I=await this.app.vault.adapter.read(b),D=await this.readChunkPayload(r),q=this.buildSyncedDoclingContent(e,D,I),U=await this.buildNoteMarkdown(o,(j=a.meta)!=null?j:{},e,M,u,b,i,q);await this.writeNoteWithSyncSuppressed(b,U);let J=this.app.vault.getAbstractFileByPath(b);J instanceof h.TFile&&this.scheduleNoteAnnotationSync(J,2e3,"save")}catch(I){return t&&new h.Notice("Failed to finalize note markdown."),console.error(I),this.clearStatusProgress(),!1}try{let I=me(o);await this.updateDocIndex({doc_id:e,note_path:b,note_title:E.default.basename(b,".md"),zotero_title:l,short_title:I||void 0,pdf_path:_})}catch(I){console.error("Failed to update doc index",I)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],t=await this.fetchZoteroGroupOptions();return t.length&&e.push(...t),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),t=[],n=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!n)return e&&t.push({value:e,label:e}),t;let i=(this.settings.embedApiKey||"").trim(),r=await this.fetchModelIds(n,i);if(r.length){let a=r.filter(o=>/embed/i.test(o)),s=a.length?a:r;t.push(...s.map(o=>({value:o,label:o})))}return!t.length&&e&&t.push({value:e,label:e}),t.sort((a,s)=>a.label.localeCompare(s.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,t,n){let i=n==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),r=[],a=(e||"").trim().replace(/\/$/,"");if(!a)return i&&r.push({value:i,label:i}),r;let s=(t||"").trim(),o=await this.fetchModelIds(a,s);if(o.length){let l=o.filter(d=>!/embed/i.test(d)),c=l.length?l:o;r.push(...c.map(d=>({value:d,label:d})))}return!r.length&&i&&r.push({value:i,label:i}),r.sort((l,c)=>l.label.localeCompare(c.label))}detectEmbeddingProvider(e){let t=e.toLowerCase();return t.includes("anthropic")?"anthropic":t.includes("openrouter")?"openrouter":t.includes("ollama")||t.includes(":11434")?"ollama":t.includes("openai")?"openai":"generic"}async fetchModelIds(e,t){let n=this.detectEmbeddingProvider(e);try{if(n==="anthropic")return await this.fetchAnthropicModels(e,t);let i=await this.fetchOpenAiCompatibleModels(e,t);return!i.length&&n==="ollama"?await this.fetchOllamaModels(e):i}catch(i){return console.warn("Failed to fetch models",i),[]}}async fetchOpenAiCompatibleModels(e,t){let n=`${e}/models`,i={};t&&(i.Authorization=`Bearer ${t}`);let r=await this.requestLocalApiRaw(n,{headers:i});if(r.statusCode>=400)throw new Error(`Model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}async fetchOllamaModels(e){let n=`${e.replace(/\/v1\/?$/,"")}/api/tags`,i=await this.requestLocalApiRaw(n);if(i.statusCode>=400)throw new Error(`Ollama tags request failed (${i.statusCode})`);let r;try{r=JSON.parse(i.body.toString("utf8"))}catch(s){return console.warn("Failed to parse Ollama tags response",s),[]}if(!r||typeof r!="object")return[];let a=r.models;return Array.isArray(a)?a.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}async fetchAnthropicModels(e,t){if(!t)return[];let n=`${e}/models`,i={"x-api-key":t,"anthropic-version":"2023-06-01"},r=await this.requestLocalApiRaw(n,{headers:i});if(r.statusCode>=400)throw new Error(`Anthropic model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}extractModelIds(e){var i,r,a;if(Array.isArray(e))return e.map(s=>this.extractModelId(s)).filter(s=>!!s);if(!e||typeof e!="object")return[];let t=e,n=(a=(r=(i=t.data)!=null?i:t.models)!=null?r:t.model)!=null?a:t.items;return Array.isArray(n)?n.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}extractModelId(e){var r,a,s;if(!e||typeof e!="object")return null;let t=e,n=(s=(a=(r=t.id)!=null?r:t.name)!=null?a:t.model)!=null?s:t.identifier;return typeof n!="string"?null:n.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,t=i=>{for(let r of i)e.has(r.value)||e.set(r.value,r.label)};if(await this.warnIfZoteroLocalApiUnavailable("Zotero groups"))try{let i=this.buildZoteroUrl("/users/0/groups"),r=await this.requestLocalApi(i,`Zotero groups fetch failed for ${i}`);t(this.parseZoteroGroupOptions(r))}catch(i){console.warn("Failed to fetch Zotero groups from local API",i)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let i=(this.settings.webApiLibraryId||"").trim();if(i)try{let r=this.buildWebApiUrl(`/users/${i}/groups`),a=await this.requestWebApi(r,`Zotero Web API groups fetch failed for ${r}`);t(this.parseZoteroGroupOptions(a))}catch(r){console.warn("Failed to fetch Zotero groups from Web API",r)}}return Array.from(e.entries()).map(([i,r])=>({value:i,label:r})).sort((i,r)=>i.label.localeCompare(r.label))}parseZoteroGroupOptions(e){var i,r,a,s,o;let t;try{t=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(t))return[];let n=[];for(let l of t){if(!l||typeof l!="object")continue;let c=(i=l.data)!=null?i:l,d=(a=(r=c.id)!=null?r:l.id)!=null?a:c.key;if(!d)continue;let u=String(d).trim();if(!u)continue;let _=(o=(s=c.name)!=null?s:l.name)!=null?o:u,m=String(_||u).trim()||u;n.push({value:`groups/${u}`,label:`Group: ${m}`})}return n}async ensureFolder(e){let t=this.app.vault.adapter,n=(0,h.normalizePath)(e).split("/").filter(Boolean),i="";for(let r of n)i=i?`${i}/${r}`:r,await t.exists(i)||await t.mkdir(i)}async buildNoteMarkdown(e,t,n,i,r,a,s,o){let l=`[[${s}]]`,c=this.settings.copyPdfToVault&&i.startsWith("[["),d=r?this.buildZoteroDeepLink(n,r):"",u=d||i,_=c?i:d||i,m=_?c?`PDF: !${_}`:`PDF: ${_}`:"",y=m?`${m}

`:"",b=await this.buildTemplateVars(e,t,n,u,l);b.pdf_block=y,b.pdf_line=m,b.docling_markdown=o;let C=(this.settings.noteBodyTemplate||"").trim();/{{\s*annotation_block\s*}}/i.test(C)&&r?b.annotation_block=await this.buildAnnotationBlockForAttachment(n,r,a):b.annotation_block="";let k=this.ensureDocIdInFrontmatter(await this.renderFrontmatter(e,t,n,u,l,b),n),x=k?`---
${k}
---

`:"",v=`${y}${o}`,R=C?this.renderTemplate(C,b,v,{appendDocling:!0}):v;return`${x}${R}`}async buildAnnotationBlockForAttachment(e,t,n){let i=await this.fetchZoteroAnnotationsForDoc(e,t);return i.attachmentKey&&i.attachmentKey!==t&&await this.updateDocIndex({doc_id:e,attachment_key:i.attachmentKey}),await this.attachAnnotationImages(e,i.attachmentKey,i.annotations,n),this.buildAnnotationBlock(e,i.attachmentKey,i.annotations)}buildAnnotationBlock(e,t,n){var u;let i=`<!-- zrr:annotations-start doc_id=${e} attachment_key=${t} -->`,r="<!-- zrr:annotations-end -->";if(!n.length)return`${i}
${r}`;let a=this.getAnnotationColorMap(),s=Object.keys(a),o=new Map;for(let _ of n){let m=_.colorKey||this.normalizeAnnotationColorKey(_.colorKey),y=(u=o.get(m))!=null?u:[];y.push(_),o.set(m,y)}let l=[i],c=new Set,d=[...s,...Array.from(o.keys()).filter(_=>!s.includes(_))];for(let _ of d){let m=o.get(_);if(!m||!m.length)continue;c.add(_);let{heading:y}=this.resolveAnnotationColorMeta(_);l.push("",`## ${y}`),m.sort((b,C)=>{var x,v;let f=(x=b.pageIndex)!=null?x:0,k=(v=C.pageIndex)!=null?v:0;return f!==k?f-k:b.sortIndex!==C.sortIndex?b.sortIndex-C.sortIndex:b.key.localeCompare(C.key)});for(let b of m)l.push(...this.formatAnnotationCallout(b,t,e))}return l.push("",r),l.join(`
`).trim()}formatAnnotationCallout(e,t,n){let i=this.settings.annotationPageLabel||"Page",r=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?"),a=e.pageIndex?String(e.pageIndex):"",s=this.buildZoteroDeepLink(n,t,a,e.key),l=[`> [!${e.callout}] ${i} [${r}](${s})`];e.imagePath&&l.push(`> ![[${e.imagePath}]]`);let c=u=>{if(u)for(let _ of u.split(/\r?\n/))l.push(_.trim()?`> ${_}`:">")};c(e.text),e.comment&&(l.push(">","> ---"),c(e.comment)),e.tags.length&&l.push(`> **Tags:** ${e.tags.map(u=>`#${u}`).join(" ")}`);let d=e.pageIndex?String(e.pageIndex):"0";return l.push(`> ^${e.key}a${t}p${d}`),l.push(""),l}findAnnotationBlockRange(e){let t=Cn.exec(e);if(!t)return null;let n=e.slice(t.index+t[0].length),i=Sn.exec(n);if(!i)return null;let r=t.index,a=t.index+t[0].length+i.index+i[0].length,s=n.slice(0,i.index);return{start:r,end:a,block:s,startMarker:t[0]}}parseAnnotationBlockMarker(e){let t=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i),n=e.match(/attachment_key=([\"']?)([^\"'\s]+)\1/i);return{docId:t?t[2].trim():void 0,attachmentKey:n?n[2].trim():void 0}}parseAnnotationBlock(e,t){let n=e.split(/\r?\n/),i=[],r=0;for(;r<n.length;){if(!n[r].trim().startsWith("> [!")){r+=1;continue}let s=[];for(;r<n.length&&n[r].trim().startsWith(">");)s.push(n[r]),r+=1;let o=this.parseAnnotationCallout(s,t);o&&i.push(o)}return i}parseAnnotationImageLine(e){var o,l;let t=e.trim();if(!t)return null;let n="",i=t.match(/!\[\[([^\]]+)\]\]/);i&&(n=i[1].trim());let r=n?null:t.match(/!\[[^\]]*\]\(([^)]+)\)/);r&&(n=r[1].trim());let a=n?null:t.match(/<img[^>]+src=[\"']([^\"']+)[\"']/i);if(a&&(n=a[1].trim()),!n)return null;let s=(l=(o=n.split("|")[0])==null?void 0:o.trim())!=null?l:"";return s?{path:s,hash:this.extractAnnotationImageHashFromPath(s)}:null}parseAnnotationCallout(e,t){if(!e.length)return null;let n=e[0].replace(/^>\s?/,"").trim(),i=n.match(/\[!([^\]]+)\]/),r=i?i[1].trim():"note",a=n.match(/\((zotero:\/\/open-pdf\/library\/items\/[^)]+)\)/i),s="",o=t,l="",c=null;if(a){let k=a[1],x=k.match(/items\/([A-Z0-9]{8})/i);x&&(o=x[1]);let v=k.match(/annotation=([A-Z0-9]{8})/i);v&&(s=v[1]);let R=k.match(/page=(\d+)/i);R&&(c=Number(R[1]));let A=n.match(/\[([^\]]+)\]\(zotero:\/\//i);A&&(l=A[1].trim())}let d=[],u=[],_=[],m=!1,y="",b="";for(let k=1;k<e.length;k+=1){let x=e[k].replace(/^>\s?/,""),v=x.trim();if(!v){m?_.push(""):u.push("");continue}let R=this.parseAnnotationImageLine(v);if(R){y=R.path,b=R.hash;continue}if(v.startsWith("^")){let A=v.match(/^\^([A-Z0-9]{8})a([A-Z0-9]{8})p(\d+)/i);A&&(s=A[1],o=A[2],c=Number(A[3]));continue}if(/^(\*\*tags:\*\*|tags:)/i.test(v)){d.push(v);continue}if(v==="---"){m=!0;continue}m?_.push(x):u.push(x)}let C=d.join(" "),f=C?C.replace(/\*\*tags:\*\*/i,"").replace(/tags:/i,"").split(/[\s,]+/).map(k=>k.trim().replace(/^#+/,"")).filter(Boolean):[];return s?{key:s,attachmentKey:o,pageLabel:l,pageIndex:c,callout:r,text:this.normalizeAnnotationText(u.join(`
...
`)}async renderFrontmatter(e,t,n,i,r,a){var d;let s=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,t,n,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let t=e.split(/\r?\n/),n=[],i=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<t.length;){let l=t[o],c=l.match(i);if(!c){n.push(l),o+=1;continue}let d=c[1].trim(),u=c[2].trim();if(a.has(d)){n.push(l),o+=1;continue}if(!s(u)){n.push(l),o+=1;continue}let _=o+1,m=[];for(;_<t.length&&t[_].match(r);)m.push(t[_]),_+=1;if(m.length===0){for(o=_;o<t.length&&t[o].trim()==="";)o+=1;continue}let y=m.filter(b=>{let C=b.match(r);if(!C)return!1;let f=C[1].trim();return!s(f)});if(y.length>0&&n.push(l,...y),o=_,y.length===0)for(;o<t.length&&t[o].trim()==="";)o+=1}for(;n.length>0&&n[n.length-1].trim()==="";)n.pop();return n.join(`
...
${t.docling_markdown}`),r.trim()?r:n}async buildTemplateVars(e,t,n,i,r){let a=V(e.title),s=V(e.shortTitle),o=V(e.date),l=typeof(t==null?void 0:t.parsedDate)=="string"?t.parsedDate:"",c=ot(l||o),d=/^\d{4}$/.test(c)?c:"",u=Array.isArray(e.creators)?e.creators:[],_=u.filter(P=>P.creatorType==="author").map(P=>he(P)),m=_.join("; "),y=u.filter(P=>P.creatorType==="editor"||P.creatorType==="seriesEditor").map(P=>he(P)),b=y.join("; "),C=Array.isArray(e.tags)?e.tags.map(P=>typeof P=="string"?P:P==null?void 0:P.tag).filter(Boolean):[],f=this.sanitizeObsidianTags(C),k=f.join("; "),x=await this.resolveCollectionTitles(e),v=x.join("; "),R=this.toObsidianLinks(x),A=R.join("; "),S=V(e.itemType),L=typeof(t==null?void 0:t.creatorSummary)=="string"?t.creatorSummary:"",M=V(e.publicationTitle),O=V(e.bookTitle),$=V(e.journalAbbreviation),F=V(e.volume),z=V(e.issue),j=V(e.pages),I=V(e.dateAdded),D=V(e.dateModified),q=typeof e.key=="string"?e.key:n,U=V(e.DOI);U||(U=It(e));let J=$e(e,t),Z=null;(!U||!s||!J)&&(Z=await this.fetchZoteroItemCsl(q)),U||(U=Ft(Z)),s||(s=Ot(Z)),J||(J=lt(Z));let Q=V(e.ISBN),X=V(e.ISSN),ie=V(e.publisher),se=V(e.place),ge=V(e.url),et=V(e.language),tt=V(e.abstractNote),Re=this.buildZoteroDeepLink(q),re=Array.from(new Set([J,s,U].map(P=>String(P||"").trim()).filter(P=>P.length>0))),nt=re.join("; "),w={doc_id:n,zotero_key:typeof e.key=="string"?e.key:n,item_link:Re,citekey:J,title:a,short_title:s,date:o,year:c,year_number:d,authors:m,editors:b,aliases:nt,tags:k,collection_title:v,collection_titles:v,collections_links:A,item_type:S,creator_summary:L,publication_title:M,book_title:O,journal_abbrev:$,volume:F,issue:z,pages:j,date_added:I,date_modified:D,doi:U,isbn:Q,issn:X,publisher:ie,place:se,url:ge,language:et,abstract:tt,pdf_link:i,item_json:r};for(let[P,T]of Object.entries(w)){let W=this.escapeYamlString(T);w[`${P}_yaml`]=W,w[`${P}_quoted`]=W,w[`${P}_text`]=W}return w.authors_yaml_list=this.toYamlList(_),w.editors_yaml_list=this.toYamlList(y),w.tags_yaml_list=f.length>0?this.toYamlList(f):"",w.aliases_yaml_list=re.length>0?this.toYamlList(re):"",w.collections_yaml_list=this.toYamlList(x),w.collections_links_yaml_list=this.toYamlList(R),w.tags_raw=C.join("; "),w.tags_raw_yaml=this.escapeYamlString(w.tags_raw),w.tags_raw_yaml_list=C.length>0?this.toYamlList(C):"",w.authors_list=w.authors_yaml_list,w.editors_list=w.editors_yaml_list,w.tags_list=w.tags_yaml_list,w.aliases_list=w.aliases_yaml_list,w.collections_list=w.collections_yaml_list,w.collections_links_list=w.collections_links_yaml_list,w}escapeYamlString(e){return`"${String(e).replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n")}"`}toYamlList(e){return e.length?e.map(t=>`  - ${this.escapeYamlString(t)}`).join(`
`):'  - ""'}sanitizeObsidianTags(e){let t=this.settings.tagSanitizeMode||"kebab",n=t==="replace"?"kebab":t;return e.map(i=>this.sanitizeObsidianTag(i,n)).filter(i=>i.length>0)}sanitizeObsidianTag(e,t){let n=String(e||"").trim();if(!n)return"";let i=n.replace(/^#+/,"");if(t==="none")return i;let r=o=>!/^\d+$/.test(o),s=(o=>i.split("/").map(d=>{let _=d.replace(/[^\p{L}\p{N}]+/gu," ").split(/\s+/).filter(Boolean);if(!_.length)return"";if(o==="camel"||o==="pascal"){let[y,...b]=_;return[o==="pascal"?y.charAt(0).toUpperCase()+y.slice(1):y.charAt(0).toLowerCase()+y.slice(1),...b.map(f=>f.charAt(0).toUpperCase()+f.slice(1))].join("")}let m=o==="snake"?"_":"-";return _.join(m)}).filter(Boolean).join("/").replace(/\/{2,}/g,"/").replace(/^\/+|\/+$/g,""))(t);return s&&r(s)?s:""}normalizeZoteroTags(e){let t=new Map;for(let n of e){let i=this.normalizeZoteroTag(n);if(!i)continue;let r=i.toLowerCase();t.has(r)||t.set(r,i)}return Array.from(t.values())}normalizeZoteroTag(e){let t=String(e||"").trim();if(!t)return"";let n=t.replace(/^#+/,"").trim();if(!n)return"";let i=n.split("/").map(r=>{let a=r.trim();return a?(a=a.replace(/[_-]+/g," "),a=a.replace(/([A-Z]+)([A-Z][a-z])/g,"$1 $2"),a=a.replace(/([a-z\\d])([A-Z])/g,"$1 $2"),a=a.replace(/([a-zA-Z])(\\d)/g,"$1 $2"),a=a.replace(/(\\d)([a-zA-Z])/g,"$1 $2"),a=a.replace(/\s+/g," ").trim(),a):""}).filter(Boolean);return i.length?i.join("/"):""}toObsidianLinks(e){return e.map(t=>String(t||"").trim()).filter(t=>t.length>0).map(t=>t.startsWith("[[")&&t.endsWith("]]")?t:`[[${t}]]`)}getVaultBasePath(){var n;let e=this.app.vault.adapter;if(e instanceof h.FileSystemAdapter)return e.getBasePath();let t=(n=e.getBasePath)==null?void 0:n.call(e);if(t)return t;throw new Error("Vault base path is unavailable.")}expandPathValue(e){let t=(e||"").trim();if(!t)return t;let n=t;return n==="~"?n=Se.default.homedir():(n.startsWith("~/")||n.startsWith("~\\"))&&(n=E.default.join(Se.default.homedir(),n.slice(2))),n=n.replace(/\$([A-Za-z_][A-Za-z0-9_]*)|\$\{([^}]+)\}/g,(i,r,a)=>{let s=r||a,o=s?process.env[s]:void 0;return o!==void 0?o:i}),n=n.replace(/%([^%]+)%/g,(i,r)=>{let a=process.env[r];return a!==void 0?a:i}),n}resolvePythonPath(){return this.resolveUserPath(this.settings.pythonPath||"")}getPythonRuntimeMode(){return this.settings.pythonRuntime==="local"?"local":"worker"}usePythonWorker(){return this.getPythonRuntimeMode()==="worker"}getPythonWorkerCacheDir(){return E.default.join(this.getVaultBasePath(),Y,"python-worker-cache")}getComposeServiceNamesForCurrentRuntime(){return this.usePythonWorker()?[Wt,Ae]:[Wt]}toContainerPath(e,t,n){let i=E.default.relative(e,t);if(i.startsWith("..")||E.default.isAbsolute(i))return null;let r=i.split(E.default.sep).filter(Boolean);return r.length?E.default.posix.join(n,...r):n}mapPathForPythonWorker(e){var r,a;if(!E.default.isAbsolute(e))return e;let t=E.default.normalize(e),n=E.default.normalize(this.getPluginDir()),i=E.default.normalize(this.getVaultBasePath());return(a=(r=this.toContainerPath(n,t,Pn))!=null?r:this.toContainerPath(i,t,An))!=null?a:e}getWorkerHostAlias(){return(this.settings.dockerPath||"").toLowerCase().includes("podman")?"host.containers.internal":"host.docker.internal"}mapUrlForPythonWorker(e){let t=(e||"").trim();if(!t)return e;let n;try{n=new URL(t)}catch(i){return e}return!["http:","https:","redis:","rediss:"].includes(n.protocol)||!this.isLocalRedisHost(n.hostname||"")?e:(n.hostname=this.getWorkerHostAlias(),n.toString())}mapPythonArgsForWorker(e){return e.map(t=>{let n=this.mapUrlForPythonWorker(t);if(n!==t)return n;if(!E.default.isAbsolute(t))return t;let i=this.mapPathForPythonWorker(t);if(i===t)throw new Error(`Python worker cannot access path '${t}'. Keep files under your vault or plugin directory.`);return i})}resolveUserPath(e,t){let n=this.expandPathValue(e);return!n||!(n.includes("/")||n.includes("\\"))||E.default.isAbsolute(n)?n:t&&(n.startsWith("./")||n.startsWith(".\\"))?E.default.join(t,n.slice(2)):E.default.join(Se.default.homedir(),n)}getPluginDir(){var i;let e=this.getVaultBasePath(),t=(i=this.manifest.dir)!=null?i:this.manifest.id;if(!t)throw new Error("Plugin directory is unavailable.");let n=E.default.isAbsolute(t)?t:E.default.join(e,t);return E.default.normalize(n)}async ensureBundledTools(){let e=this.getPluginDir(),t=E.default.join(e,"tools");await G.promises.mkdir(t,{recursive:!0});for(let[n,i]of Object.entries(Vt)){let r=E.default.join(t,n),a=!0;try{await G.promises.readFile(r,"utf8")===i&&(a=!1)}catch(s){}a&&await G.promises.writeFile(r,i,"utf8")}}async migrateCachePaths(){let e="zotero/items",t="zotero/chunks",n=ne,i=H,r=this.app.vault.adapter,a=(0,h.normalizePath)(e),s=(0,h.normalizePath)(t),o=(0,h.normalizePath)(n),l=(0,h.normalizePath)(i),c=o.split("/").slice(0,-1).join("/"),d=l.split("/").slice(0,-1).join("/");c&&await this.ensureFolder(c),d&&await this.ensureFolder(d);let u=await r.exists(a),_=await r.exists(s),m=await r.exists(o),y=await r.exists(l);u&&!m&&await r.rename(a,o),_&&!y&&await r.rename(s,l)}getAbsoluteVaultPath(e){let t=this.getVaultBasePath(),n=E.default.isAbsolute(e)?e:E.default.join(t,e);return E.default.normalize(n)}async resolveAttachmentOutputDir(e){let t=e?E.default.isAbsolute(e)?this.toVaultRelativePath(e):(0,h.normalizePath)(e):"";if(!t)return null;let n=this.app.fileManager;if(!(n!=null&&n.getAvailablePathForAttachment))return null;try{let i=`zrr-image-${Date.now()}.png`,r=await n.getAvailablePathForAttachment(i,t);if(!r)return null;let a=E.default.isAbsolute(r)?r:this.getAbsoluteVaultPath(r),s=E.default.normalize(E.default.dirname(a)),o=E.default.normalize(this.getVaultBasePath()),l=this.toVaultRelativePath(s);return!l&&s!==o?null:{absolute:s,relative:l}}catch(i){return console.warn("Failed to resolve attachment output dir",i),null}}async resolveAnnotationImageOutputDir(e){let t=null;if(e&&(t=await this.resolveAttachmentOutputDir(e)),!t){let r=(0,h.normalizePath)(this.settings.outputNoteDir||"");if(!r)return null;t={absolute:this.getAbsoluteVaultPath(r),relative:r}}let n=(0,h.normalizePath)(E.default.join(t.relative||"","zrr-annotations")),i=E.default.normalize(E.default.join(t.absolute,"zrr-annotations"));return n&&await this.ensureFolder(n),{absolute:i,relative:n}}async buildDoclingArgs(e,t,n,i,r,a=!1){let s=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",t,"--out-json",this.getAbsoluteVaultPath(n),"--out-md",this.getAbsoluteVaultPath(i),"--chunking",this.settings.chunkingMode,"--ocr",s];a&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),this.settings.forcePerPageOcr&&o.push("--force-per-page-ocr"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),r&&o.push("--language-hint",r),this.settings.enableLlmCleanup&&(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars)));let l=this.getPluginDir(),c=E.default.join(l,"tools","ocr_wordlist.txt");if((0,G.existsSync)(c)&&o.push("--enable-dictionary-correction","--dictionary-path",c),this.settings.enableFileLogging){let u=this.getLogFileAbsolutePath();u&&o.push("--log-file",u);let _=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());_&&o.push("--spellchecker-info-out",_)}let d=await this.resolveAttachmentOutputDir(i);return d&&(d.relative&&await this.ensureFolder(d.relative),o.push("--image-output-dir",d.absolute)),this.appendOcrEngineArgs(o),o}appendOcrEngineArgs(e){let t=this.settings.ocrEngine,n=(this.settings.paddleApiKey||"").trim(),i=(this.settings.paddleVlApiUrl||"").trim(),r=(this.settings.paddleStructureApiUrl||"").trim(),a=o=>{e.push("--prefer-ocr-engine",o,"--fallback-ocr-engine",o)},s=()=>{e.push("--no-paddle-vl-api","--no-paddle-structure-api")};switch(t){case"tesseract":a("tesseract"),e.push("--no-paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_local":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl"),s();break;case"paddle_vl_local":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_api":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl","--no-paddle-vl-api"),n?(e.push("--paddle-structure-api","--paddle-structure-api-token",n),r&&e.push("--paddle-structure-api-url",r)):e.push("--no-paddle-structure-api");break;case"paddle_vl_api":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3","--no-paddle-structure-api"),n?(e.push("--paddle-vl-api","--paddle-vl-api-token",n),i&&e.push("--paddle-vl-api-url",i)):e.push("--no-paddle-vl-api");break;default:s();break}}appendEmbedSubchunkArgs(e){let t=this.settings.embedSubchunkChars;Number.isFinite(t)&&e.push("--embed-subchunk-chars",String(Math.max(0,Math.trunc(t))));let n=this.settings.embedSubchunkOverlap;Number.isFinite(n)&&e.push("--embed-subchunk-overlap",String(Math.max(0,Math.trunc(n))))}appendEmbedContextArgs(e){let t=this.settings.embedContextWindow;Number.isFinite(t)&&e.push("--embed-context-window",String(Math.max(0,Math.trunc(t))));let n=this.settings.embedContextChars;Number.isFinite(n)&&e.push("--embed-context-chars",String(Math.max(0,Math.trunc(n))))}appendChunkTaggingArgs(e,t){if((t==null?void 0:t.allowRegenerate)===!1||!this.settings.enableChunkTagging)return;let n=(this.settings.llmCleanupBaseUrl||"").trim(),i=(this.settings.llmCleanupModel||"").trim();if(!n||!i)return;e.push("--generate-chunk-tags","--tag-base-url",n,"--tag-model",i);let r=(this.settings.llmCleanupApiKey||"").trim();r&&e.push("--tag-api-key",r),e.push("--tag-temperature",String(this.settings.llmCleanupTemperature))}getRedisDataDir(){let e=this.resolveUserPath(process.env.ZRR_DATA_DIR||"");if(e)return e;let t=this.resolveUserPath(this.settings.redisDataDirOverride||"",this.getVaultBasePath());return!this.settings.autoAssignRedisPort&&t?t:E.default.join(this.getVaultBasePath(),Y,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return E.default.join(e,"tools","docker-compose.yml")}prependBinaryDirToPath(e,t){if(!t||!E.default.isAbsolute(t))return;let n=E.default.dirname(t),i=e.PATH||"";(i?i.split(E.default.delimiter):[]).includes(n)||(e.PATH=i?`${n}${E.default.delimiter}${i}`:n)}async resolveDockerPath(){var c;let e=(c=this.settings.dockerPath)==null?void 0:c.trim(),t=e?this.resolveUserPath(e):"",n=["/opt/homebrew/bin/docker","/usr/local/bin/docker","/usr/bin/docker","/Applications/Docker.app/Contents/Resources/bin/docker"],i=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"],r=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"],a=[];t&&a.push(t);let s=t?this.getContainerCliKind(t):"docker",o=s==="podman-compose"?[r,i,n]:s==="podman"?[i,r,n]:[n,i,r];if(!t||t==="docker"||t==="podman"||t==="podman-compose")for(let d of o)a.push(...d);for(let d of a)if(E.default.isAbsolute(d))try{if(await this.isContainerCliAvailable(d))return d}catch(u){}let l=[t,s==="podman"?"podman":"docker",s==="podman"?"docker":"podman","podman-compose"].filter(d=>!!(d&&d.trim()));for(let d of l)if(await this.isContainerCliAvailable(d))return d;return t||"docker"}async isContainerCliAvailable(e){return new Promise(t=>{let n=(0,te.spawn)(e,["--version"]);n.on("error",()=>t(!1)),n.on("close",i=>t(i===0))})}getContainerCliKind(e){let t=E.default.basename(e);return t==="podman-compose"?"podman-compose":t.includes("podman")?"podman":"docker"}async isContainerDaemonRunning(e){let t=this.getContainerCliKind(e),n=e,i=["info"];if(t==="podman-compose"){let r=await this.resolvePodmanBin();if(!r)return!1;n=r}return new Promise(r=>{let a=(0,te.spawn)(n,i),s=!1,o=c=>{s||(s=!0,r(c))},l=setTimeout(()=>{a.kill(),o(!1)},2e3);a.on("error",()=>{clearTimeout(l),o(!1)}),a.on("close",c=>{clearTimeout(l),o(c===0)})})}getContainerDaemonHint(e){let t=this.getContainerCliKind(e);return t==="podman"||t==="podman-compose"?"Podman machine not running. Run `podman machine start`.":"Docker Desktop is not running. Start Docker Desktop."}async supportsComposeSubcommand(e){return new Promise(t=>{let n=(0,te.spawn)(e,["compose","version"]);n.on("error",()=>t(!1)),n.on("close",i=>t(i===0))})}async findPodmanComposePath(){let e=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"];for(let t of e)try{return await G.promises.access(t),t}catch(n){}return await this.isContainerCliAvailable("podman-compose")?"podman-compose":null}async resolvePodmanBin(){let e=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"];for(let t of e)if(await this.isContainerCliAvailable(t))return t;return await this.isContainerCliAvailable("podman")?"podman":null}async resolveComposeCommand(e){let t=E.default.basename(e);if(t==="podman-compose")return{command:e,argsPrefix:[]};if(t==="podman"){let n=await this.findPodmanComposePath();return n?{command:n,argsPrefix:[]}:await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}return await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}async buildComposeEnvironment(e,t,n){var s;let i={...process.env};if(this.prependBinaryDirToPath(i,e),this.prependBinaryDirToPath(i,t.command),E.default.basename(t.command)==="podman-compose"){let o=await this.resolvePodmanBin();o&&(i.PODMAN_BIN=o,this.prependBinaryDirToPath(i,o))}let r=(n==null?void 0:n.dataDir)||this.getRedisDataDir(),a=(s=n==null?void 0:n.redisPort)!=null?s:this.getRedisPortFromUrl();return i.ZRR_DATA_DIR=r,i.ZRR_PORT=String(a),i.ZRR_VAULT_DIR=this.getVaultBasePath(),i.ZRR_PLUGIN_DIR=this.getPluginDir(),i.ZRR_WORKER_CACHE_DIR=this.getPythonWorkerCacheDir(),i}async resolveComposeProjectContext(e){await this.ensureBundledTools();let t=this.getDockerComposePath(),n=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(n))throw new Error('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');if(!await this.isContainerDaemonRunning(n))throw new Error(this.getContainerDaemonHint(n));let i=await this.resolveComposeCommand(n);if(!i)throw new Error("Compose support not found. Install Docker Desktop or Podman with podman-compose.");let r=await this.buildComposeEnvironment(n,i,e);return{composePath:t,composeCommand:i,composeEnv:r,project:this.getDockerProjectName()}}buildComposeExecArgs(e,t,n){return[...e.composeCommand.argsPrefix,"-p",e.project,"-f",e.composePath,"exec","-T",t,...n]}async autoDetectContainerCliOnLoad(){var o;let e=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(e)){this.notifyContainerOnce("Docker or Podman not found. Install Docker Desktop or Podman and set Docker/Podman path in settings.");return}let t=((o=this.settings.dockerPath)==null?void 0:o.trim())||"docker",n=this.expandPathValue(t);!await this.isContainerCliAvailable(n)&&!(t==="docker"||t==="podman"||t==="podman-compose")&&e&&e!==t&&(this.settings.dockerPath=e,await this.saveSettings());let s=l=>new Promise(c=>setTimeout(c,l));if(!await this.isContainerDaemonRunning(e)){for(let l of[5e3,1e4])if(await s(l),await this.isContainerDaemonRunning(e))return;this.notifyContainerOnce(this.getContainerDaemonHint(e))}}getDockerProjectName(){let e=s=>s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,32),t=(process.env.ZRR_PROJECT_NAME||"").trim();if(t&&!this.settings.autoAssignRedisPort)return e(t)||"zrr";let n=(this.settings.redisProjectName||"").trim();if(n&&!this.settings.autoAssignRedisPort)return e(n)||"zrr";let i=this.getVaultBasePath(),r=E.default.basename(i).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),a=(0,Ee.createHash)("sha1").update(i).digest("hex").slice(0,8);return`zrr-${r||"vault"}-${a}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),t=e.port?Number(e.port):6379;return Number.isFinite(t)&&t>0?t:6379}catch(e){return 6379}}getVaultPreferredRedisPort(){let e=(0,Ee.createHash)("sha1").update(this.getVaultBasePath()).digest("hex");return 6400+Number.parseInt(e.slice(0,4),16)%2e3}getRedisHostFromUrl(){try{return new URL(this.settings.redisUrl).hostname||"127.0.0.1"}catch(e){return"127.0.0.1"}}isLocalRedisHost(e){let t=e.trim().toLowerCase();return t?t==="localhost"||t==="0.0.0.0"||t==="::1"?!0:t.startsWith("127."):!1}getPortCheckHost(e){return this.isLocalRedisHost(e)?"127.0.0.1":e}async isPortFree(e,t){return new Promise(n=>{let i=Ce.default.createServer();i.once("error",()=>n(!1)),i.once("listening",()=>{i.close(()=>n(!0))}),i.listen(t,e)})}async findAvailablePort(e,t){for(let i=0;i<25;i+=1){let r=t+i;if(await this.isPortFree(e,r))return r}return null}updateRedisUrlPort(e,t){try{let n=new URL(e);return n.port=String(t),n.toString()}catch(n){return`redis://127.0.0.1:${t}`}}async isRedisReachable(e){let t="127.0.0.1",n=6379;try{let i=new URL(e);t=i.hostname||t,n=i.port?Number(i.port):n}catch(i){return!1}return t=this.getPortCheckHost(t),new Promise(i=>{let r=new Ce.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(n,t)})}async isZoteroLocalApiReachable(){let e=(this.settings.zoteroBaseUrl||"").trim();if(!e)return!1;let t="127.0.0.1",n=23119;try{let i=new URL(e);if(t=i.hostname||t,i.port){let r=Number(i.port);Number.isFinite(r)&&r>0&&(n=r)}else i.protocol==="https:"?n=443:n=80}catch(i){return!1}return new Promise(i=>{let r=new Ce.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(n,t)})}getRedisNamespace(){let e=this.getVaultBasePath(),t=E.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24),n=(0,Ee.createHash)("sha1").update(e).digest("hex").slice(0,8);return`${t||"vault"}-${n}`}getRedisIndexName(){return`${(this.settings.redisIndex||"idx:zotero").trim()||"idx:zotero"}:${this.getRedisNamespace()}`}getRedisKeyPrefix(){let e=(this.settings.redisPrefix||"zotero:chunk:").trim()||"zotero:chunk:";return`${e.endsWith(":")?e:`${e}:`}${this.getRedisNamespace()}:`}async isComposeProjectRunning(e,t,n,i,r,a=[]){let s=a.length?a:[""];for(let o of s)if(!await new Promise(c=>{let d=o?[o]:[],u=(0,te.spawn)(e,[...t,"-p",i,"-f",n,"ps","-q",...d],{cwd:E.default.dirname(n),env:r}),_="";u.stdout.on("data",m=>{_+=m.toString()}),u.on("error",m=>{console.warn("Redis Stack status check failed",m),c(!1)}),u.on("close",m=>{if(m!==0){c(!1);return}c(_.trim().length>0)})}))return!1;return!0}async startRedisStack(e){var t;try{await this.ensureBundledTools();let n=this.getDockerComposePath(),i=this.getRedisDataDir(),r=this.getPythonWorkerCacheDir();await G.promises.mkdir(i,{recursive:!0}),await G.promises.mkdir(r,{recursive:!0});let a=await this.resolveDockerPath(),s=((t=this.settings.dockerPath)==null?void 0:t.trim())||"docker",o=this.resolveUserPath(s),l=s==="docker"||s==="podman"||s==="podman-compose";if(!await this.isContainerCliAvailable(o)&&!l&&a&&a!==s&&(this.settings.dockerPath=a,await this.saveSettings(),e||new h.Notice(`Docker/Podman path set to ${a}.`)),!await this.isContainerCliAvailable(a)){e||new h.Notice('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');return}if(!await this.isContainerDaemonRunning(a)){e||new h.Notice(this.getContainerDaemonHint(a));return}let u=await this.resolveComposeCommand(a);if(!u){e||new h.Notice("Compose support not found. Install Docker Desktop or Podman with podman-compose.");return}let _=this.getRedisPortFromUrl(),m=await this.buildComposeEnvironment(a,u,{dataDir:i,redisPort:_}),y=this.getDockerProjectName(),b={composePath:n,composeCommand:u,composeEnv:m,project:y},C=this.getComposeServiceNamesForCurrentRuntime();if(await this.isComposeProjectRunning(u.command,u.argsPrefix,n,y,m,C)){e||new h.Notice(this.usePythonWorker()?"Redis Stack and Python worker already running for this vault.":"Redis Stack already running for this vault.");return}let f=this.getRedisHostFromUrl(),k=this.getPortCheckHost(f),x=this.settings.autoAssignRedisPort&&this.isLocalRedisHost(f),v=this.settings.redisUrl,R=_,A=()=>{if(!e){if(!this.settings.autoAssignRedisPort){new h.Notice("Redis already running. If you share Redis across vaults, disable Auto-start Redis in this vault.");return}new h.Notice(`Redis already running at ${v}.`)}};if(x){let L=_===6379?this.getVaultPreferredRedisPort():_,M=await this.findAvailablePort(k,L);if(!M)throw new Error(`No available Redis port found starting at ${L}.`);M!==_&&(R=M,v=this.updateRedisUrlPort(v,R),this.settings.redisUrl=v,await this.saveSettings(),e||new h.Notice(`Using Redis port ${R} for this vault.`))}else{if(this.isLocalRedisHost(f)&&!await this.isPortFree(k,R)){await this.isRedisReachable(v)?(A(),this.usePythonWorker()&&await this.startPythonWorkerService(b)):e||new h.Notice(`Port ${R} is already in use and Redis is not reachable at ${v}. Update the Redis URL or enable auto-assign.`);return}if(await this.isRedisReachable(v)){A(),this.usePythonWorker()&&await this.startPythonWorkerService(b);return}}m.ZRR_PORT=String(R);try{await this.runCommand(u.command,[...u.argsPrefix,"-p",y,"-f",n,"down"],{cwd:E.default.dirname(n),env:m})}catch(L){console.warn("Redis Stack stop before restart failed",L)}let S=[...u.argsPrefix,"-p",y,"-f",n,"up","-d"];this.usePythonWorker()&&S.push("--build"),await this.runCommand(u.command,S,{cwd:E.default.dirname(n),env:m}),e||new h.Notice("Redis Stack started.")}catch(n){e||new h.Notice("Failed to start Redis Stack. Check Docker/Podman and file sharing."),console.error("Failed to start Redis Stack",n)}}async waitForPythonWorkerReady(e,t=900*1e3){let n=Date.now(),i=a=>new Promise(s=>setTimeout(s,a)),r=this.buildComposeExecArgs(e,Ae,[Ht,"--version"]);for(;Date.now()-n<t;)try{await this.runCommand(e.composeCommand.command,r,{cwd:E.default.dirname(e.composePath),env:e.composeEnv});return}catch(a){await i(2e3)}throw new Error("Python worker is still starting. Check compose logs for the python-worker service.")}async startPythonWorkerService(e){let t=e!=null?e:await this.resolveComposeProjectContext({dataDir:this.getRedisDataDir(),redisPort:this.getRedisPortFromUrl()}),n=[...t.composeCommand.argsPrefix,"-p",t.project,"-f",t.composePath,"up","-d","--build",Ae];await this.runCommand(t.composeCommand.command,n,{cwd:E.default.dirname(t.composePath),env:t.composeEnv})}async ensurePythonWorkerContext(e){let t=this.getRedisDataDir();await G.promises.mkdir(t,{recursive:!0}),await G.promises.mkdir(this.getPythonWorkerCacheDir(),{recursive:!0});let n=await this.resolveComposeProjectContext({dataDir:t,redisPort:this.getRedisPortFromUrl()}),i=[Ae];if(!await this.isComposeProjectRunning(n.composeCommand.command,n.composeCommand.argsPrefix,n.composePath,n.project,n.composeEnv,i)&&e&&(await this.startPythonWorkerService(n),n=await this.resolveComposeProjectContext({dataDir:t,redisPort:this.getRedisPortFromUrl()})),!await this.isComposeProjectRunning(n.composeCommand.command,n.composeCommand.argsPrefix,n.composePath,n.project,n.composeEnv,i))throw new Error("Python worker is not running. Start Redis stack now or enable Auto-start Redis stack.");return await this.waitForPythonWorkerReady(n),n}async setupPythonEnv(){if(this.usePythonWorker()){try{new h.Notice("Setting up Python worker environment..."),this.showStatusProgress("Setting up Python worker environment...",null),await this.ensurePythonWorkerContext(!0),this.clearStatusProgress(),new h.Notice("Python worker environment ready.")}catch(r){this.clearStatusProgress(),new h.Notice("Failed to set up Python worker environment. See console for details."),console.error("Python worker setup failed",r)}return}let e=this.getPluginDir(),t=this.getPythonVenvDir(),n=this.getVenvPythonPath(t);await this.ensureBundledTools();let i=this.resolveRequirementsPath(e);if(!i)throw new Error(`requirements.txt not found in ${e}`);try{new h.Notice("Setting up Python environment..."),this.showStatusProgress("Setting up Python environment...",null),console.log(`Python env: using plugin dir ${e}`),console.log(`Python env: venv path ${t}`),await G.promises.mkdir(E.default.dirname(t),{recursive:!0});let r=null,a=async()=>(r||(r=await this.resolveBootstrapPython()),r);if((0,G.existsSync)(n)){let s=await this.getPythonVersion(n,[]);if(s&&this.isUnsupportedPythonVersion(s)){let o=await a();console.log(`Python env: existing venv uses Python ${s.major}.${s.minor}; rebuilding with ${o.command} ${o.args.join(" ")}`),this.showStatusProgress("Rebuilding Python environment...",null),await G.promises.rm(t,{recursive:!0,force:!0})}}if(!(0,G.existsSync)(n)){let s=await a();console.log(`Python env: creating venv with ${s.command} ${s.args.join(" ")}`),await this.runCommand(s.command,[...s.args,"-m","venv",t],{cwd:e})}await this.runCommandStreaming(n,["-m","pip","install","-r",i],{cwd:e},s=>{let o=s.trim();if(!o)return;let l=o.match(/^Collecting\s+([^\s]+)/);if(l){this.showStatusProgress(`Installing ${l[1]}...`,null);return}if(o.startsWith("Installing collected packages")){this.showStatusProgress("Installing packages...",null);return}o.startsWith("Successfully installed")&&this.showStatusProgress("Python environment ready.",100)}),this.settings.pythonPath=n,await this.saveSettings(),this.clearStatusProgress(),new h.Notice("Python environment ready.")}catch(r){this.clearStatusProgress(),new h.Notice("Failed to set up Python environment. See console for details."),console.error("Python env setup failed",r)}}async detectOcrEngines(){if(this.usePythonWorker())return{tesseract:!0,paddleStructureLocal:!0,paddleVlLocal:!0};let e=await this.canRunCommand("tesseract",[]),t=this.resolvePythonPath(),n=[];if(!t)try{let l=await this.resolveBootstrapPython();t=l.command,n=l.args}catch(l){return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1}}let i=["import importlib.util, json","def has_module(name):","    return importlib.util.find_spec(name) is not None","has_paddle = has_module('paddle')","has_paddleocr = has_module('paddleocr')","has_paddlex = has_module('paddlex')","has_vl = False","if has_paddleocr:","    try:","        from paddleocr import PaddleOCRVL","        has_vl = True","    except Exception:","        has_vl = False","print(json.dumps({'paddle': has_paddle, 'paddleocr': has_paddleocr, 'paddlex': has_paddlex, 'paddle_vl': has_vl}))"].join(`
`),r=await new Promise(l=>{let c=(0,te.spawn)(t,[...n,"-c",i],{env:this.buildPythonEnv()}),d="";c.stdout.on("data",u=>{d+=u.toString()}),c.on("error",()=>l({ok:!1})),c.on("close",u=>{if(u!==0){l({ok:!1});return}try{let _=JSON.parse(d.trim());l({ok:!0,data:_})}catch(_){l({ok:!1})}})});if(!r.ok||!r.data)return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1};let a=r.data,s=!!a.paddle,o=!!a.paddleocr;return{tesseract:e,paddleStructureLocal:s&&o&&!!a.paddlex,paddleVlLocal:s&&o&&!!a.paddle_vl}}getSharedPythonEnvRoot(){let e=Se.default.homedir();if(process.platform==="win32"){let n=process.env.LOCALAPPDATA||process.env.APPDATA||E.default.join(e,"AppData","Local");return E.default.join(n,"zotero-redisearch-rag")}let t=process.env.XDG_CACHE_HOME||E.default.join(e,".cache");return E.default.join(t,"zotero-redisearch-rag")}getPythonVenvDir(){return this.settings.pythonEnvLocation==="plugin"?E.default.join(this.getPluginDir(),".venv"):E.default.join(this.getSharedPythonEnvRoot(),"venv")}getVenvPythonPath(e){return process.platform==="win32"?E.default.join(e,"Scripts","python.exe"):E.default.join(e,"bin","python")}resolveRequirementsPath(e){var n;return(n=[E.default.join(e,"requirements.txt"),E.default.join(e,"tools","requirements.txt")].find(i=>(0,G.existsSync)(i)))!=null?n:null}async resolveBootstrapPython(){let e=(this.settings.pythonPath||"").trim(),t=this.expandPathValue(e);if(t&&await this.canRunCommand(t,[])){let i=await this.getPythonVersion(t,[]);if(i&&this.isUnsupportedPythonVersion(i))throw new Error(`Configured Python ${i.major}.${i.minor} is not supported. Install Python 3.11\u20133.13 and update the Python path.`);return{command:t,args:[]}}let n=process.platform==="win32"?[{command:"py",args:["-3.13"]},{command:"py",args:["-3.12"]},{command:"py",args:["-3.11"]},{command:"py",args:["-3.10"]},{command:"py",args:["-3"]},{command:"python",args:[]}]:[{command:"python3.13",args:[]},{command:"python3.12",args:[]},{command:"python3.11",args:[]},{command:"python3.10",args:[]},{command:"python3",args:[]},{command:"python",args:[]}];for(let i of n)if(await this.canRunCommand(i.command,i.args)){let r=await this.getPythonVersion(i.command,i.args);if(r&&this.isUnsupportedPythonVersion(r)){console.log(`Python env: skipping ${i.command} ${i.args.join(" ")} (Python ${r.major}.${r.minor} unsupported)`);continue}return i}throw new Error("No usable Python 3.11\u20133.13 interpreter found on PATH.")}isUnsupportedPythonVersion(e){return e.major>3||e.major===3&&e.minor>=14}async getPythonVersion(e,t){return new Promise(n=>{let i=(0,te.spawn)(e,[...t,"-c","import sys; print(f'{sys.version_info.major}.{sys.version_info.minor}')"]),r="";i.stdout.on("data",a=>{r+=a.toString()}),i.on("error",()=>n(null)),i.on("close",a=>{if(a!==0){n(null);return}let s=r.trim().match(/(\d+)\.(\d+)/);if(!s){n(null);return}n({major:Number(s[1]),minor:Number(s[2])})})})}async canRunCommand(e,t){return new Promise(n=>{let i=(0,te.spawn)(e,[...t,"--version"],{env:this.buildPythonEnv()});i.on("error",()=>n(!1)),i.on("close",r=>n(r===0))})}buildPythonEnv(){let e={...process.env},t=E.default.delimiter,n=e.PATH||"",r=[...process.platform==="win32"?[]:["/opt/homebrew/bin","/usr/local/bin"],n].filter(Boolean).join(t);return e.PATH=r,e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK||(e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK="True"),e.DISABLE_MODEL_SOURCE_CHECK||(e.DISABLE_MODEL_SOURCE_CHECK="True"),e}async resolvePythonScriptInvocation(e,t,n){if(!this.usePythonWorker())return{command:this.resolvePythonPath(),args:[e,...t],cwd:E.default.dirname(e),env:this.buildPythonEnv()};let i=await this.ensurePythonWorkerContext(n),r=this.mapPathForPythonWorker(e);if(r===e)throw new Error(`Python worker cannot access script '${e}'. Keep plugin files under your vault or plugin directory.`);let a=this.mapPythonArgsForWorker(t),s=this.buildComposeExecArgs(i,Ae,[Ht,r,...a]);return{command:i.composeCommand.command,args:s,cwd:E.default.dirname(i.composePath),env:i.composeEnv}}async runPython(e,t){let n;try{n=await this.resolvePythonScriptInvocation(e,t,this.settings.autoStartRedis)}catch(i){throw this.handlePythonProcessError(String(i)),i}return new Promise((i,r)=>{let a=(0,te.spawn)(n.command,n.args,{cwd:n.cwd,env:n.env}),s="",o="";a.stdout.on("data",l=>{s+=l.toString()}),a.stderr.on("data",l=>{o+=l.toString()}),a.on("error",l=>{this.handlePythonProcessError(String(l)),r(l)}),a.on("close",l=>{if(l===0)i();else{let c=o.trim()?o:s;this.handlePythonProcessError(c),r(new Error(o||`Process exited with code ${l}`))}})})}runCommand(e,t,n){return new Promise((i,r)=>{var o;let a=(0,te.spawn)(e,t,{cwd:n==null?void 0:n.cwd,env:(o=n==null?void 0:n.env)!=null?o:this.buildPythonEnv()}),s="";a.stderr.on("data",l=>{s+=l.toString()}),a.on("error",l=>{r(l)}),a.on("close",l=>{l===0?i():r(new Error(s||`Process exited with code ${l}`))})})}async runPythonStreaming(e,t,n,i,r,a="docling_extract",s){let o;try{o=await this.resolvePythonScriptInvocation(e,t,this.settings.autoStartRedis)}catch(l){throw this.handlePythonProcessError(String(l)),l}return new Promise((l,c)=>{let d=(0,te.spawn)(o.command,o.args,{cwd:o.cwd,env:o.env});s&&s(d);let u="",_="",m="",y=null,b=!1,C=f=>{if(f.trim())try{let k=JSON.parse(f);y=k,((k==null?void 0:k.type)==="final"||k!=null&&k.answer)&&(b=!0),n(k)}catch(k){m+=`${f}
`}};d.stdout.on("data",f=>{var x;u+=f.toString();let k=u.split(/\r?\n/);u=(x=k.pop())!=null?x:"";for(let v of k)C(v)}),d.stderr.on("data",f=>{_+=f.toString()}),d.on("error",f=>{this.handlePythonProcessError(String(f)),c(f)}),d.on("close",f=>{if(u.trim()&&C(u),!b&&y&&i(y),r&&this.appendToLogFile(r,_,a,"STDERR"),f===0)l();else{let k=_.trim()?_:m;this.handlePythonProcessError(k),c(new Error(_||`Process exited with code ${f}`))}})})}runCommandStreaming(e,t,n,i){return new Promise((r,a)=>{var c;let s=(0,te.spawn)(e,t,{cwd:n==null?void 0:n.cwd,env:(c=n==null?void 0:n.env)!=null?c:this.buildPythonEnv()}),o=d=>{d.toString().split(/\r?\n/).forEach(_=>{_.trim()&&i(_)})},l="";s.stdout.on("data",o),s.stderr.on("data",d=>{l+=d.toString(),o(d)}),s.on("error",d=>{a(d)}),s.on("close",d=>{d===0?r():a(new Error(l||`Process exited with code ${d}`))})})}handlePythonProcessError(e){if(!e)return;if(/Python worker cannot access path/i.test(e)){this.notifyContainerOnce(e.replace(/^Error:\s*/i,""));return}if(/python-worker/i.test(e)&&/(No such service|is not running|not found|no container)/i.test(e)){this.notifyContainerOnce("Python worker is not running. Start Redis stack now or enable Auto-start Redis stack.");return}if(/Cannot connect to the Docker daemon|docker desktop is not running|podman machine/i.test(e)){this.notifyContainerOnce("Container runtime is not available. Start Docker Desktop or Podman.");return}let t=e.match(/ModuleNotFoundError:\s+No module named ['"]([^'"]+)['"]/);if(t){let n=this.usePythonWorker()?`Python worker missing module '${t[1]}'. Restart Redis stack to rebuild worker env.`:`Python env missing module '${t[1]}'. Open Settings > Python environment > Create/Update.`;this.notifyPythonEnvOnce(n,!0);return}if(/No module named ['"]|ImportError: No module named/i.test(e)){let n=this.usePythonWorker()?"Python worker missing required modules. Restart Redis stack to rebuild worker env.":"Python env missing required modules. Open Settings > Python environment > Create/Update.";this.notifyPythonEnvOnce(n,!0);return}if(/ENOENT|No such file or directory|not found|command not found|spawn .* ENOENT/i.test(e)){let n=this.usePythonWorker()?"Python worker command failed. Start Redis stack and check container logs.":"Python not found. Configure the Python path or use Settings > Python environment > Create/Update.";this.notifyPythonEnvOnce(n,!0)}}notifyPythonEnvOnce(e,t=!1){this.lastPythonEnvNotice!==e&&(this.lastPythonEnvNotice=e,new h.Notice(e),t&&this.openPluginSettings())}notifyContainerOnce(e){this.lastContainerNotice!==e&&(this.lastContainerNotice=e,new h.Notice(e))}notifyRedisOnce(e){this.lastRedisNotice!==e&&(this.lastRedisNotice=e,new h.Notice(e))}async autoDetectRedisOnLoad(){if(this.settings.autoStartRedis)return;let e=(this.settings.redisUrl||"").trim(),n=e||"redis://127.0.0.1:6379";(await this.checkRedisConnectionWithUrl(n,500)).ok&&(e||(this.settings.redisUrl=n,await this.saveSettings()),this.notifyRedisOnce(`Redis detected at ${n}. This instance will be used.`))}notifyZoteroApiOnce(e){this.lastZoteroApiNotice!==e&&(this.lastZoteroApiNotice=e,new h.Notice(e))}async warnIfZoteroLocalApiUnavailable(e){if(await this.isZoteroLocalApiReachable())return this.lastZoteroApiNotice=null,!0;let i=`Zotero Local API is not reachable for ${e?`${e}`:"this action"}. Start Zotero or update the Local API URL in settings.`;return this.notifyZoteroApiOnce(i),!1}openPluginSettings(){let e=this.app.setting;e!=null&&e.open&&e.open(),e!=null&&e.openTabById&&e.openTabById(this.manifest.id)}getLogsDirRelative(){return(0,h.normalizePath)(`${Y}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,h.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,h.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;if(!await t.exists(e)){new h.Notice("Log file not found.");return}try{let n=async()=>{try{return await t.read(e)||"(empty)"}catch(r){return"(empty)"}},i=await n();new ye(this.app,"Log file",i||"(empty)",{autoRefresh:!0,refreshIntervalMs:2e3,onRefresh:n,onClear:async()=>{await this.clearLogFile()}}).open()}catch(n){new h.Notice("Failed to open log file."),console.error(n)}}async clearLogFile(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;try{let n=(0,h.normalizePath)(E.default.dirname(e));n&&await this.ensureFolder(n),await t.write(e,""),new h.Notice("Log file cleared.")}catch(n){new h.Notice("Failed to clear log file."),console.error(n)}}async deleteLogFileIfExists(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;try{await t.exists(e)&&await t.remove(e)}catch(n){console.warn("Failed to delete log file before import",n)}}formatLogLines(e,t,n){let i=e.split(/\r?\n/).map(a=>a.trimEnd()).filter(a=>!!a.trim());if(!i.length)return"";let r=new Date().toISOString().replace("T"," ").replace(".",",");return i.map(a=>`${r} ${n} ${t}: ${a}`).join(`
`)+`
`}async appendToLogFile(e,t,n="docling_extract",i="STDERR"){if(!t||!t.trim())return;let r=this.formatLogLines(t,n,i);if(r)try{await G.promises.mkdir(E.default.dirname(e),{recursive:!0}),await G.promises.appendFile(e,r)}catch(a){console.warn("Failed to append stderr to log file",a)}}async runPythonWithOutput(e,t,n,i="docling_extract"){let r;try{r=await this.resolvePythonScriptInvocation(e,t,this.settings.autoStartRedis)}catch(a){throw this.handlePythonProcessError(String(a)),a}return new Promise((a,s)=>{let o=(0,te.spawn)(r.command,r.args,{cwd:r.cwd,env:r.env}),l="",c="";o.stdout.on("data",d=>{l+=d.toString()}),o.stderr.on("data",d=>{c+=d.toString()}),o.on("error",d=>{this.handlePythonProcessError(String(d)),s(d)}),o.on("close",d=>{if(n&&this.appendToLogFile(n,c,i,"STDERR"),d===0)a(l.trim());else{let u=c.trim()?c:l;this.handlePythonProcessError(u),s(new Error(c||`Process exited with code ${d}`))}})})}};

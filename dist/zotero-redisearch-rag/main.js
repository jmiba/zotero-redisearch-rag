"use strict";var Qn=Object.create;var Ee=Object.defineProperty;var et=Object.getOwnPropertyDescriptor;var nt=Object.getOwnPropertyNames;var tt=Object.getPrototypeOf,it=Object.prototype.hasOwnProperty;var rt=(g,u)=>{for(var e in u)Ee(g,e,{get:u[e],enumerable:!0})},_n=(g,u,e,n)=>{if(u&&typeof u=="object"||typeof u=="function")for(let t of nt(u))!it.call(g,t)&&t!==e&&Ee(g,t,{get:()=>u[t],enumerable:!(n=et(u,t))||n.enumerable});return g};var pe=(g,u,e)=>(e=g!=null?Qn(tt(g)):{},_n(u||!g||!g.__esModule?Ee(e,"default",{value:g,enumerable:!0}):e,g)),at=g=>_n(Ee({},"__esModule",{value:!0}),g);var kt={};rt(kt,{default:()=>Xe});module.exports=at(kt);var h=require("obsidian");var xn=require("@codemirror/state"),Q=require("@codemirror/view"),kn=require("obsidian");var ue=/<!--\s*zrr:sync-start[^>]*-->/i,fe=/<!--\s*zrr:sync-end\s*-->/i,ce=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ne=/<!--\s*zrr:chunk\s+end\s*-->/i,xe=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,gn=g=>{let u=g.trim();if(!u.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(u)){let _=u.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:_?_[2]:void 0}}if(/^zrr:sync-end\b/i.test(u))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(u)){let _=u.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),m=u.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:_?_[2]:void 0,attachmentKey:m?m[2]:void 0}}if(/^zrr:annotations-end\b/i.test(u))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(u))return{type:"chunk-end"};let e=u.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let n=e[1]||"",t=n.match(/\bid=(["']?)([^"'\s]+)\1/i),i=t?t[2]:"",r=n.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:n.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,d=Number.isFinite(s!=null?s:NaN)?s:l,c=/\bexclude\b/i.test(n)||/\bdelete\b/i.test(n),p=/\bsection\b/i.test(n);return{type:"chunk-start",chunkId:i||void 0,excluded:c,pageNumber:Number.isFinite(d!=null?d:NaN)?d:void 0,chunkKind:p?"section":d?"page":"section"}},nn=g=>{var l;if(!g)return null;let u=g.match(ce);if(!u)return null;let e=u[1]||"",n=e.match(/\bid=(["']?)([^"'\s]+)\1/i),t=n?n[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=t&&(l=ot(t))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:t,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Re=g=>{for(let u=1;u<=g.lines;u+=1){let e=g.line(u).text;if(ue.test(e)){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return n?n[2].trim():null}}return null},tn=(g,u)=>{let e=u;for(;e>=1;e-=1){let n=g.line(e).text;if(ce.test(n))return{line:e,text:n};if(ue.test(n)||fe.test(n))break}return null},st=(g,u)=>{for(let e=u;e<=g.lines;e+=1){let n=g.line(e).text;if(Ne.test(n))return e;if(fe.test(n))break}return null},fn=(g,u)=>{let e=tn(g,u);if(!e)return null;let n=st(g,e.line+1);return n===null||u<e.line||u>n?null:{startLine:e.line,endLine:n,text:e.text}},hn=(g,u,e)=>{if(u>e)return!1;for(let n=u;n<=e;n+=1){let t=g.line(n).text;if(xe.test(t))return!0}return!1},ot=g=>{var t;if(!g)return null;let e=(g.includes(":")&&(t=g.split(":").pop())!=null?t:g).match(/^p(\d+)$/i);if(!e)return null;let n=Number.parseInt(e[1],10);return Number.isFinite(n)?n:null};var mn=g=>{if(!g)return null;let u=g.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return u?nn(u[0]):null};var lt=(g,u)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),g.type==="sync-start"||g.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(g.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),g.type==="sync-start"?e.textContent=g.docId?`Redis Index Sync start - ${g.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e;if(g.type==="annotations-start"||g.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),g.type==="annotations-start"){let n=g.docId?` - ${g.docId}`:"";e.textContent=`Zotero annotations start${n}`}else e.textContent="Zotero annotations end";return e}if(g.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=g.chunkKind==="page"?"Page end":"Section end",g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),e;if(g.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),g.excluded&&e.classList.add("is-excluded"),g.pageNumber&&u>0)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber}/${u})`}else e.textContent=`Page ${g.pageNumber}/${u}`;else if(g.pageNumber)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber})`}else e.textContent=`Page ${g.pageNumber}`;else g.chunkId?e.textContent=`Section ${g.chunkId}`:e.textContent="Section";return g.excluded&&(e.textContent=`${e.textContent} - excluded`),e},rn=class extends Q.WidgetType{constructor(u,e,n,t,i){super(),this.plugin=u,this.docId=e,this.chunkId=n,this.startLine=t,this.excluded=i}eq(u){return this.docId===u.docId&&this.chunkId===u.chunkId&&this.startLine===u.startLine&&this.excluded===u.excluded}toDOM(){let u=document.createElement("span");u.className="zrr-chunk-toolbar",u.setAttribute("data-chunk-id",this.chunkId);let e=(d,c)=>{d.setAttribute("title",c),d.setAttribute("aria-label",c),d.setAttribute("data-tooltip-position","top")},n=(d,c,p)=>{let _=document.createElement("span");_.className="zrr-chunk-button-icon",(0,kn.setIcon)(_,c);let m=document.createElement("span");m.className="zrr-chunk-button-label",m.textContent=p,d.appendChild(_),d.appendChild(m)},t=document.createElement("button");t.type="button",t.className="zrr-chunk-button",n(t,"sparkles","Clean"),e(t,"Clean this chunk with the OCR cleanup model"),t.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),u.appendChild(t);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",n(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),u.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",n(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),u.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",n(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),u.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return n(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),u.appendChild(s),u}ignoreEvent(){return!0}},yn=(g,u)=>{var y;let e=g.state.doc,n=Re(e);if(!n)return Q.Decoration.none;let t=g.state.selection.main.head,i=e.lineAt(t).number,r=fn(e,i);if(!r)return Q.Decoration.none;let a=r.text.match(ce);if(!a)return Q.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return Q.Decoration.none;let l=o[2].trim();if(!l)return Q.Decoration.none;let d=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),c=hn(e,r.startLine+1,r.endLine-1),p=d||c,_=e.line(r.startLine),m=Q.Decoration.widget({widget:new rn(u,n,l,r.startLine,p),side:1});return Q.Decoration.set([m.range(_.to)])},an=class extends Q.WidgetType{constructor(u,e){super(),this.info=u,this.totalPages=e}toDOM(){var u;return(u=lt(this.info,this.totalPages))!=null?u:document.createElement("span")}},bn=g=>{var o,l;let u=g.dom.closest(".markdown-source-view");if(!u||!u.classList.contains("is-live-preview"))return Q.Decoration.none;let e=g.state.doc,n=new xn.RangeSetBuilder,t=[],i=[],r=!1,a=!1;for(let d=1;d<=e.lines;d+=1){let c=e.line(d),p=c.text.match(/<!--\s*([^>]*)\s*-->/);if(!p)continue;let _=gn(p[1]);_&&(_.type==="chunk-start"?(_.chunkKind=(o=_.chunkKind)!=null?o:_.pageNumber?"page":"section",_.pageNumber&&(r=!0),_.chunkKind==="section"&&(a=!0)):_.type==="chunk-end"&&(_.chunkKind=(l=_.chunkKind)!=null?l:"section"),t.push({line:d,from:c.from,to:c.to,info:_}),_.pageNumber&&i.push(_.pageNumber))}if(!t.length)return Q.Decoration.none;if(r&&!a)for(let d of t)d.info.type==="chunk-end"&&(d.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let d of t){let c=Q.Decoration.replace({widget:new an(d.info,s)});n.add(d.from,d.to,c)}return n.finish()},vn=()=>Q.ViewPlugin.fromClass(class{constructor(g){this.decorations=bn(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=bn(g.view))}},{decorations:g=>g.decorations}),wn=g=>Q.ViewPlugin.fromClass(class{constructor(u){this.decorations=yn(u,g)}update(u){(u.docChanged||u.selectionSet||u.viewportChanged)&&(this.decorations=yn(u.view,g))}},{decorations:u=>u.decorations});var ne=require("child_process"),W=require("fs"),Kn=pe(require("http")),Jn=pe(require("https")),Pe=pe(require("net")),Ae=pe(require("os")),Xn=pe(require("tls")),N=pe(require("path")),un=require("url"),Ce=require("crypto");var D=require("obsidian"),Pn=require("crypto"),De=require("fs"),Te=pe(require("path")),ee=".zotero-redisearch-rag",te=`${ee}/items`,H=`${ee}/chunks`,An=`${ee}/metadata_snapshots.json`,Cn=`${ee}/annotation_snapshots.json`,ct="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",Ie={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,chatPaneLocation:"right",enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"BAAI/bge-reranker-v2-m3",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${ee}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Oe=class extends D.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async f=>{this.plugin.settings.llmProviderProfiles=f,await this.plugin.saveSettings()},i=f=>{f.inputEl.type="password",f.inputEl.autocomplete="off",f.inputEl.spellcheck=!1},c=[{id:"prerequisites",label:"Prerequisites",render:f=>{f.createEl("h2",{text:"Prerequisites"}),new D.Setting(f).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(P=>P.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async L=>{this.plugin.settings.pythonPath=L.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Python environment").setDesc("Create or update the plugin's Python env (location configured below).").addButton(P=>{P.setButtonText("Create/Update").setCta(),P.onClick(async()=>{P.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{P.setDisabled(!1)}})}),new D.Setting(f).setName("Python env location").setDesc("Shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(P=>{P.addOption("shared","Shared user cache"),P.addOption("plugin","Plugin folder (.venv)"),P.setValue(this.plugin.settings.pythonEnvLocation).onChange(async L=>{L!=="shared"&&L!=="plugin"||(this.plugin.settings.pythonEnvLocation=L,await this.plugin.saveSettings())})}),new D.Setting(f).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(P=>P.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async L=>{this.plugin.settings.dockerPath=L.trim()||"docker",await this.plugin.saveSettings()})),new D.Setting(f).setName("Redis URL").addText(P=>P.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async L=>{this.plugin.settings.redisUrl=L.trim(),await this.plugin.saveSettings()}));let k=null,x=null,w=null,E=null,S=()=>{let P=this.plugin.settings.autoAssignRedisPort;w==null||w.setDisabled(P),E==null||E.setDisabled(P),k==null||k.settingEl.classList.toggle("is-disabled",P),x==null||x.settingEl.classList.toggle("is-disabled",P)};new D.Setting(f).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(P=>P.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async L=>{this.plugin.settings.autoAssignRedisPort=L,await this.plugin.saveSettings(),S()})),k=new D.Setting(f).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(P=>(w=P,P.setPlaceholder("~/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async L=>{this.plugin.settings.redisDataDirOverride=L.trim(),await this.plugin.saveSettings()}))),k.settingEl.addClass("zrr-redis-override-setting"),x=new D.Setting(f).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(P=>(E=P,P.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async L=>{this.plugin.settings.redisProjectName=L.trim(),await this.plugin.saveSettings()}))),x.settingEl.addClass("zrr-redis-override-setting"),S(),new D.Setting(f).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Uses a vault-specific data dir at .obsidian/zotero-redisearch-rag/redis-data unless overridden.").addToggle(P=>P.setValue(this.plugin.settings.autoStartRedis).onChange(async L=>{this.plugin.settings.autoStartRedis=L,await this.plugin.saveSettings()})),new D.Setting(f).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(P=>P.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:f=>{f.createEl("h2",{text:"Zotero Local API"}),new D.Setting(f).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(S=>S.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async P=>{this.plugin.settings.zoteroBaseUrl=P.trim(),await this.plugin.saveSettings()}));let k=new D.Setting(f).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),x=null,w=S=>{if(!x)return;let P=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(S.map(F=>F.value)).has(P)||(S=S.concat([{value:P,label:`Custom (${P})`}])),x.selectEl.options.length=0;for(let F of S)x.addOption(F.value,F.label);x.setValue(P)},E=async()=>{if(x){x.setDisabled(!0);try{let S=await this.plugin.fetchZoteroLibraryOptions();w(S)}finally{x.setDisabled(!1)}}};k.addDropdown(S=>{x=S;let P=(this.plugin.settings.zoteroUserId||"0").trim()||"0";S.addOption(P,"Loading..."),S.setValue(P),S.onChange(async L=>{this.plugin.settings.zoteroUserId=L.trim(),await this.plugin.saveSettings()})}),k.addButton(S=>{S.setButtonText("Refresh").onClick(async()=>{await E()})}),E(),f.createEl("h2",{text:"Zotero Web API"}),new D.Setting(f).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(S=>S.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async P=>{this.plugin.settings.webApiBaseUrl=P.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(S=>S.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async P=>{this.plugin.settings.webApiLibraryType=P,await this.plugin.saveSettings()})),new D.Setting(f).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(S=>S.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async P=>{this.plugin.settings.webApiLibraryId=P.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(S=>{i(S),S.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async P=>{this.plugin.settings.webApiKey=P.trim(),await this.plugin.saveSettings()})}),f.createEl("h2",{text:"Output"}),new D.Setting(f).setName("PDF folder").addText(S=>S.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async P=>{this.plugin.settings.outputPdfDir=P.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Notes folder").addText(S=>S.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async P=>{this.plugin.settings.outputNoteDir=P.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(S=>{S.setValue(this.plugin.settings.frontmatterTemplate).onChange(async P=>{this.plugin.settings.frontmatterTemplate=P,await this.plugin.saveSettings()}),S.inputEl.rows=10,S.inputEl.style.width="100%"}),new D.Setting(f).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(S=>S.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async P=>{this.plugin.settings.tagSanitizeMode=P,await this.plugin.saveSettings()})),new D.Setting(f).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(S=>{S.setValue(this.plugin.settings.noteBodyTemplate).onChange(async P=>{this.plugin.settings.noteBodyTemplate=P,await this.plugin.saveSettings()}),S.inputEl.rows=8,S.inputEl.style.width="100%"}),new D.Setting(f).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(S=>S.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async P=>{this.plugin.settings.chatOutputDir=P.trim()||"zotero/chats",await this.plugin.saveSettings()})),new D.Setting(f).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(S=>S.setValue(this.plugin.settings.copyPdfToVault).onChange(async P=>{this.plugin.settings.copyPdfToVault=P,!P&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new D.Setting(f).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(S=>{let P=this.plugin.settings.copyPdfToVault;S.setValue(P?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!P).onChange(async L=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=L,await this.plugin.saveSettings()})}),new D.Setting(f).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(S=>S.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async P=>{this.plugin.settings.preferObsidianNoteForCitations=P,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:f=>{f.createEl("h2",{text:"Annotations"}),new D.Setting(f).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(E=>E.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async S=>{this.plugin.settings.annotationPageLabel=S.trim()||"Page",await this.plugin.saveSettings()})),new D.Setting(f).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(E=>E.setValue(this.plugin.settings.includeAnnotationImages).onChange(async S=>{this.plugin.settings.includeAnnotationImages=S,await this.plugin.saveSettings()})),f.createEl("h3",{text:"Zotero companion"}),f.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new D.Setting(f).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(E=>E.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async S=>{this.plugin.settings.zoteroCompanionEnabled=S,await this.plugin.saveSettings()})),new D.Setting(f).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(E=>E.setPlaceholder("http://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async S=>{this.plugin.settings.zoteroCompanionBaseUrl=S.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(E=>{i(E),this.companionTokenInput=E,E.setPlaceholder("optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async S=>{this.plugin.settings.zoteroCompanionToken=S.trim(),await this.plugin.saveSettings()})}),new D.Setting(f).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero Companion Plugin token to this value.").addButton(E=>E.setButtonText("Generate token").onClick(async()=>{let S=(0,Pn.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=S,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(S);try{await navigator.clipboard.writeText(S),new D.Notice("Generated and copied companion token.")}catch(P){new D.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",P)}})),f.createEl("h3",{text:"Annotation color map"}),f.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let k=f.createDiv({cls:"zrr-annotation-map"}),x=async E=>{this.plugin.settings.annotationColorMap=E,await this.plugin.saveSettings()},w=()=>{var T,M;k.empty();let E=this.plugin.settings.annotationColorMap||{},S=Object.entries(E);if(S.length||k.createEl("p",{text:"No color mappings configured."}),S.length){let I=k.createDiv({cls:"zrr-annotation-map-row-header"});I.createEl("span",{text:"Color"}),I.createEl("span",{text:"Heading"}),I.createEl("span",{text:"Callout"}),I.createEl("span")}for(let[I,z]of S){let O=k.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),q=O.createEl("input",{type:"text",value:I,cls:"zrr-annotation-map-input"}),$=O.createEl("input",{type:"text",value:(T=z.heading)!=null?T:"",cls:"zrr-annotation-map-input"}),B=O.createEl("input",{type:"text",value:(M=z.callout)!=null?M:"",cls:"zrr-annotation-map-input"}),J=O.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});J.type="button",q.addEventListener("change",async()=>{let V=q.value.trim().toLowerCase();if(!V){q.value=I;return}let Y={...this.plugin.settings.annotationColorMap||{}};if(V!==I&&Y[V]){new D.Notice(`Annotation color '${V}' already exists.`),q.value=I;return}let X=Y[I];delete Y[I],Y[V]=X!=null?X:{heading:"",callout:""},await x(Y),w()}),$.addEventListener("change",async()=>{var X;let V={...this.plugin.settings.annotationColorMap||{}},Y=(X=V[I])!=null?X:{heading:"",callout:""};Y.heading=$.value.trim(),V[I]=Y,await x(V)}),B.addEventListener("change",async()=>{var X;let V={...this.plugin.settings.annotationColorMap||{}},Y=(X=V[I])!=null?X:{heading:"",callout:""};Y.callout=B.value.trim(),V[I]=Y,await x(V)}),J.addEventListener("click",async()=>{let V={...this.plugin.settings.annotationColorMap||{}};delete V[I],await x(V),w()})}let P=k.createDiv({cls:"zrr-annotation-map-actions"}),L=P.createEl("button",{text:"Add mapping"});L.type="button",L.addEventListener("click",async()=>{let I={...this.plugin.settings.annotationColorMap||{}},z="new-color",j=1;for(;I[z];)z=`new-color-${j}`,j+=1;I[z]={heading:"",callout:""},await x(I),w()});let F=P.createEl("button",{text:"Reset to defaults"});F.type="button",F.addEventListener("click",async()=>{await x({...Ie.annotationColorMap}),w()})};w()}},{id:"ocr",label:"OCR",render:f=>{f.createEl("h2",{text:"Docling"});let k=null,x=P=>{if(!k)return;let L=this.plugin.settings.ocrEngine;new Set(P.map(T=>T.value)).has(L)||(P=P.concat([{value:L,label:`Current (unavailable): ${L}`}])),k.selectEl.options.length=0;for(let T of P)k.addOption(T.value,T.label);k.setValue(L)},w=async()=>{if(!k)return;k.setDisabled(!0);let P={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{P=await this.plugin.detectOcrEngines()}catch(T){P={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let L=[{value:"auto",label:"Auto (default)"}];P.tesseract&&L.push({value:"tesseract",label:"Tesseract (local)"}),P.paddleStructureLocal&&L.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),P.paddleVlLocal&&L.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(L.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),L.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),x(L),k.setDisabled(!1)},E=new D.Setting(f).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),S=document.createElement("a");S.href="https://aistudio.baidu.com/paddleocr",S.textContent="https://aistudio.baidu.com/paddleocr",S.target="_blank",S.rel="noopener noreferrer",E.descEl.appendChild(S),E.descEl.append("."),E.addText(P=>{i(P),P.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async L=>{this.plugin.settings.paddleApiKey=L.trim(),await this.plugin.saveSettings(),await w()})}),new D.Setting(f).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(P=>P.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async L=>{this.plugin.settings.paddleVlApiUrl=L.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(P=>P.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async L=>{this.plugin.settings.paddleStructureApiUrl=L.trim(),await this.plugin.saveSettings(),await w()})),new D.Setting(f).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(P=>{k=P,P.addOption("auto","Auto (default)"),P.setValue(this.plugin.settings.ocrEngine),P.onChange(async L=>{this.plugin.settings.ocrEngine=L,await this.plugin.saveSettings()})}),new D.Setting(f).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(P=>P.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async L=>{this.plugin.settings.ocrMode=L,await this.plugin.saveSettings()})),new D.Setting(f).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(P=>P.setValue(this.plugin.settings.forcePerPageOcr).onChange(async L=>{this.plugin.settings.forcePerPageOcr=L,await this.plugin.saveSettings()})),new D.Setting(f).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(P=>{P.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async L=>{this.plugin.settings.ocrQualityThreshold=L,await this.plugin.saveSettings()})}),new D.Setting(f).setName("Chunking").setDesc("page or section").addDropdown(P=>P.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async L=>{this.plugin.settings.chunkingMode=L,await this.plugin.saveSettings()})),w()}},{id:"llms",label:"LLMs",render:f=>{f.createEl("h2",{text:"LLM Provider Profiles"});let k=f.createDiv({cls:"zrr-llm-profiles"}),x=()=>{k.empty();let v=n();v.length||k.createEl("p",{text:"No profiles yet. Add one below."});for(let A of v){let R=k.createEl("details",{cls:"zrr-profile"});v.length===1&&(R.open=!0);let G=R.createEl("summary",{text:A.name||A.id||"Profile"});G.addClass("zrr-profile-title");let Le=R.createDiv({cls:"zrr-profile-body"});new D.Setting(Le).setName("Profile name").addText(le=>le.setPlaceholder("My provider").setValue(A.name||"").onChange(async de=>{A.name=de.trim(),G.textContent=A.name||A.id||"Profile",await t(n())})),new D.Setting(Le).setName("Base URL").addText(le=>le.setPlaceholder("http://localhost:1234/v1").setValue(A.baseUrl||"").onChange(async de=>{A.baseUrl=de.trim(),await t(n())})),new D.Setting(Le).setName("API key").setDesc("Stored in settings (not encrypted).").addText(le=>{i(le),le.setPlaceholder("sk-...").setValue(A.apiKey||"").onChange(async de=>{A.apiKey=de.trim(),await t(n())})}),new D.Setting(Le).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(le=>le.setButtonText("Delete profile").onClick(async()=>{let de=n().filter(Yn=>Yn.id!==A.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===A.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===A.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===A.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(de),x()}))}new D.Setting(k).addButton(A=>A.setButtonText("Add profile").onClick(async()=>{let R=`profile-${Date.now().toString(36)}`,G=n().concat([{id:R,name:"Custom",baseUrl:"",apiKey:""}]);await t(G),x()}))};x(),f.createEl("h2",{text:"OCR cleanup"}),new D.Setting(f).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(v=>v.setValue(this.plugin.settings.enableLlmCleanup).onChange(async A=>{this.plugin.settings.enableLlmCleanup=A,await this.plugin.saveSettings()}));let w=null,E=null,S=null,P=async()=>{},L=async(v,A=!0)=>{let R=v.trim();this.plugin.settings.llmCleanupBaseUrl=R,A&&(this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom")),E&&E.setValue(R),await this.plugin.saveSettings()},F=async v=>{let A=n().find(R=>R.id===v);this.plugin.settings.llmCleanupProviderProfileId=v,A&&(this.plugin.settings.llmCleanupBaseUrl=A.baseUrl,this.plugin.settings.llmCleanupApiKey=A.apiKey,E==null||E.setValue(A.baseUrl),S==null||S.setValue(A.apiKey)),await this.plugin.saveSettings(),await P()};new D.Setting(f).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(v=>{w=v,v.addOption("custom","Custom (manual)");for(let R of n())v.addOption(R.id,R.name||R.id);let A=this.plugin.settings.llmCleanupProviderProfileId;v.setValue(A&&n().some(R=>R.id===A)?A:"custom"),v.onChange(async R=>{if(R==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await F(R)})}),new D.Setting(f).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(v=>{E=v,v.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async A=>{await L(A)})}),new D.Setting(f).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(v=>{S=v,i(v),v.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async A=>{this.plugin.settings.llmCleanupApiKey=A.trim(),this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom"),await this.plugin.saveSettings()})});let T=new D.Setting(f).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),M=null,I=v=>{if(!M)return;let A=(this.plugin.settings.llmCleanupModel||"").trim(),R=new Set(v.map(G=>G.value));A&&!R.has(A)&&(v=v.concat([{value:A,label:`Custom (${A})`}])),M.selectEl.options.length=0;for(let G of v)M.addOption(G.value,G.label);A&&M.setValue(A)};P=async()=>{if(M){M.setDisabled(!0);try{let v=await this.plugin.fetchCleanupModelOptions();I(v)}finally{M.setDisabled(!1)}}},T.addDropdown(v=>{M=v;let A=(this.plugin.settings.llmCleanupModel||"").trim();v.addOption(A||"loading","Loading..."),v.setValue(A||"loading"),v.onChange(async R=>{this.plugin.settings.llmCleanupModel=R.trim(),await this.plugin.saveSettings()})}),T.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await P()})}),P(),new D.Setting(f).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(v=>v.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async A=>{let R=Number.parseFloat(A);this.plugin.settings.llmCleanupTemperature=Number.isFinite(R)?R:0,await this.plugin.saveSettings()})),new D.Setting(f).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(v=>v.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async A=>{this.plugin.settings.llmCleanupMinQuality=A,await this.plugin.saveSettings()})),new D.Setting(f).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(v=>v.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async A=>{let R=Number.parseInt(A,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(R)?R:2e3,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Text Embedding"});let z=null,j=null,O=null,q=async()=>{},$=async(v,A=!0)=>{let R=v.trim();this.plugin.settings.embedBaseUrl=R,A&&(this.plugin.settings.embedProviderProfileId="",z&&z.setValue("custom")),j&&j.setValue(R),await this.plugin.saveSettings()},B=async v=>{let A=n().find(R=>R.id===v);this.plugin.settings.embedProviderProfileId=v,A&&(this.plugin.settings.embedBaseUrl=A.baseUrl,this.plugin.settings.embedApiKey=A.apiKey,j==null||j.setValue(A.baseUrl),O==null||O.setValue(A.apiKey)),await this.plugin.saveSettings(),await q()};new D.Setting(f).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(v=>{z=v,v.addOption("custom","Custom (manual)");for(let R of n())v.addOption(R.id,R.name||R.id);let A=this.plugin.settings.embedProviderProfileId;v.setValue(A&&n().some(R=>R.id===A)?A:"custom"),v.onChange(async R=>{if(R==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await B(R)})}),new D.Setting(f).setName("Embeddings base URL").addText(v=>{j=v,v.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async A=>{await $(A)})}),new D.Setting(f).setName("Embeddings API key").addText(v=>{O=v,i(v),v.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async A=>{this.plugin.settings.embedApiKey=A.trim(),this.plugin.settings.embedProviderProfileId="",z&&z.setValue("custom"),await this.plugin.saveSettings()})});let J=new D.Setting(f).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),V=null,Y=v=>{if(!V)return;let A=(this.plugin.settings.embedModel||"").trim(),R=new Set(v.map(G=>G.value));A&&!R.has(A)&&(v=v.concat([{value:A,label:`Custom (${A})`}])),V.selectEl.options.length=0;for(let G of v)V.addOption(G.value,G.label);A&&V.setValue(A)};q=async()=>{if(V){V.setDisabled(!0);try{let v=await this.plugin.fetchEmbeddingModelOptions();Y(v)}finally{V.setDisabled(!1)}}},J.addDropdown(v=>{V=v;let A=(this.plugin.settings.embedModel||"").trim();v.addOption(A||"loading","Loading..."),v.setValue(A||"loading"),v.onChange(async R=>{this.plugin.settings.embedModel=R.trim(),await this.plugin.saveSettings()})}),J.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await q()})}),q(),new D.Setting(f).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(v=>v.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async A=>{this.plugin.settings.embedIncludeMetadata=A,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(v=>v.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async A=>{let R=Number.parseInt(A,10);this.plugin.settings.embedContextWindow=Number.isFinite(R)?Math.max(0,R):1,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(v=>v.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async A=>{let R=Number.parseInt(A,10);this.plugin.settings.embedContextChars=Number.isFinite(R)?Math.max(0,R):220,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(v=>v.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async A=>{let R=Number.parseInt(A,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(R)?Math.max(0,R):3500,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(v=>v.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async A=>{let R=Number.parseInt(A,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(R)?Math.max(0,R):200,await this.plugin.saveSettings()})),new D.Setting(f).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(v=>v.setValue(this.plugin.settings.enableChunkTagging).onChange(async A=>{this.plugin.settings.enableChunkTagging=A,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Chat LLM"});let X=null,ie=null,se=null,ge=async()=>{},Ye=async(v,A=!0)=>{let R=v.trim();this.plugin.settings.chatBaseUrl=R,A&&(this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom")),ie&&ie.setValue(R),await this.plugin.saveSettings()},Qe=async v=>{let A=n().find(R=>R.id===v);this.plugin.settings.chatProviderProfileId=v,A&&(this.plugin.settings.chatBaseUrl=A.baseUrl,this.plugin.settings.chatApiKey=A.apiKey,ie==null||ie.setValue(A.baseUrl),se==null||se.setValue(A.apiKey)),await this.plugin.saveSettings(),await ge()};new D.Setting(f).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(v=>{X=v,v.addOption("custom","Custom (manual)");for(let R of n())v.addOption(R.id,R.name||R.id);let A=this.plugin.settings.chatProviderProfileId;v.setValue(A&&n().some(R=>R.id===A)?A:"custom"),v.onChange(async R=>{if(R==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await Qe(R)})}),new D.Setting(f).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(v=>{ie=v,v.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async A=>{await Ye(A)})}),new D.Setting(f).setName("Chat API key").addText(v=>{se=v,i(v),v.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async A=>{this.plugin.settings.chatApiKey=A.trim(),this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom"),await this.plugin.saveSettings()})});let Se=new D.Setting(f).setName("Chat model").setDesc("Select a chat-capable model from the provider."),re=null,en=v=>{if(!re)return;let A=(this.plugin.settings.chatModel||"").trim(),R=new Set(v.map(G=>G.value));A&&!R.has(A)&&(v=v.concat([{value:A,label:`Custom (${A})`}])),re.selectEl.options.length=0;for(let G of v)re.addOption(G.value,G.label);A&&re.setValue(A)};ge=async()=>{if(re){re.setDisabled(!0);try{let v=await this.plugin.fetchChatModelOptions();en(v)}finally{re.setDisabled(!1)}}},Se.addDropdown(v=>{re=v;let A=(this.plugin.settings.chatModel||"").trim();v.addOption(A||"loading","Loading..."),v.setValue(A||"loading"),v.onChange(async R=>{this.plugin.settings.chatModel=R.trim(),await this.plugin.saveSettings()})}),Se.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await ge()})}),ge(),new D.Setting(f).setName("Temperature").addText(v=>v.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async A=>{let R=Number.parseFloat(A);this.plugin.settings.chatTemperature=Number.isFinite(R)?R:.2,await this.plugin.saveSettings()})),new D.Setting(f).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(v=>v.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async A=>{let R=Number.parseInt(A,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(R)?Math.max(0,R):6,await this.plugin.saveSettings()})),new D.Setting(f).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(v=>v.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async A=>{this.plugin.settings.chatPaneLocation=A,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Retrieval"}),new D.Setting(f).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(v=>v.setValue(this.plugin.settings.enableQueryExpansion).onChange(async A=>{this.plugin.settings.enableQueryExpansion=A,await this.plugin.saveSettings()})),new D.Setting(f).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(v=>v.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async A=>{let R=Number.parseInt(A,10);this.plugin.settings.queryExpansionCount=Number.isFinite(R)?Math.max(1,R):3,await this.plugin.saveSettings()})),new D.Setting(f).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(v=>v.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async A=>{this.plugin.settings.enableCrossEncoderRerank=A,await this.plugin.saveSettings()})),new D.Setting(f).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(v=>v.setPlaceholder("BAAI/bge-reranker-v2-m3").setValue(this.plugin.settings.rerankModel).onChange(async A=>{this.plugin.settings.rerankModel=A.trim()||"BAAI/bge-reranker-v2-m3",await this.plugin.saveSettings()})),new D.Setting(f).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(v=>v.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async A=>{let R=Number.parseInt(A,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(R)?Math.max(1,R):4,await this.plugin.saveSettings()})),new D.Setting(f).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(v=>v.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async A=>{let R=Number.parseInt(A,10);this.plugin.settings.rrfK=Number.isFinite(R)?Math.max(1,R):60,await this.plugin.saveSettings()})),new D.Setting(f).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(v=>v.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async A=>{let R=Number.parseInt(A,10);this.plugin.settings.rrfLogTop=Number.isFinite(R)?Math.max(0,R):0,await this.plugin.saveSettings()})),new D.Setting(f).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(v=>v.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async A=>{let R=Number.parseInt(A,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(R)?Math.max(0,R):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:f=>{f.createEl("h2",{text:"Logging"}),new D.Setting(f).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(k=>k.setValue(this.plugin.settings.enableFileLogging).onChange(async x=>{this.plugin.settings.enableFileLogging=x,await this.plugin.saveSettings()})),new D.Setting(f).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(k=>k.setPlaceholder(`${ee}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async x=>{this.plugin.settings.logFilePath=x.trim()||`${ee}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new D.Setting(f).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(k=>k.setButtonText("Open log").onClick(async()=>{var x,w;await((w=(x=this.plugin).openLogFile)==null?void 0:w.call(x))})).addButton(k=>k.setButtonText("Clear log").onClick(async()=>{var x,w;await((w=(x=this.plugin).clearLogFile)==null?void 0:w.call(x))})),f.createEl("h2",{text:"Zotero Companion Plugin"}),f.createEl("p",{text:"Download the XPI, then in Zotero go to Tools \u2192 Add-ons \u2192 Install from File and restart."}),new D.Setting(f).setName("Download companion add-on").setDesc("Downloads the companion XPI to your system Downloads folder.").addButton(k=>k.setButtonText("Download XPI").onClick(async()=>{let x=this.getDefaultDownloadDir();if(!x){new D.Notice("Unable to resolve the system Downloads folder.");return}let w=Te.default.join(x,"zrr-companion.xpi");if(await this.companionXpiExists(w)){new D.Notice(`Companion XPI already exists: ${w}`);return}new D.Notice("Downloading companion XPI..."),await this.downloadCompanionXpi(w)})),new D.Setting(f).setName("Open Zotero").setDesc("Launch Zotero and open the Add-ons window (Tools \u2192 Add-ons).").addButton(k=>k.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new D.Setting(f).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(k=>k.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),f.createEl("h2",{text:"Redis Indexing"}),new D.Setting(f).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(k=>k.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new D.Setting(f).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(k=>k.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(k=>k.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],p=new Map,_=new Map,m=f=>{this.activeTab=f;for(let[k,x]of p){let w=k===f;x.classList.toggle("is-active",w),x.setAttribute("aria-selected",w?"true":"false"),x.setAttribute("tabindex",w?"0":"-1")}for(let[k,x]of _){let w=k===f;x.classList.toggle("is-active",w),x.hidden=!w}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let b=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let f of c){let k=y.createEl("button",{text:f.label,cls:"zrr-settings-tab-button"}),x=`zrr-settings-tab-${f.id}`,w=`zrr-settings-panel-${f.id}`;k.type="button",k.id=x,k.setAttribute("role","tab"),k.setAttribute("aria-controls",w),k.setAttribute("aria-selected","false"),k.addEventListener("click",()=>m(f.id));let E=b.createDiv({cls:"zrr-settings-tab-panel"});E.id=w,E.setAttribute("role","tabpanel"),E.setAttribute("aria-labelledby",x),E.hidden=!0,f.render(E),p.set(f.id,k),_.set(f.id,E)}let C=c.some(f=>f.id===this.activeTab)?this.activeTab:c[0].id;m(C)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Te.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await De.promises.access(e),!0}catch(n){return!1}}async downloadCompanionXpi(e){try{await De.promises.mkdir(Te.default.dirname(e),{recursive:!0});let n=await(0,D.requestUrl)({url:ct,method:"GET"});if(n.status!==200){new D.Notice(`Failed to download companion XPI (HTTP ${n.status}).`);return}let t=Buffer.from(n.arrayBuffer);await De.promises.writeFile(e,t),new D.Notice(`Downloaded companion XPI: ${e}`)}catch(n){new D.Notice("Failed to download companion XPI. See console for details."),console.warn("Failed to download companion XPI",n)}}};var Sn=require("@codemirror/state"),Ln=require("@codemirror/view"),oe=require("obsidian");var dt=g=>{let u=g.scrollDOM.getBoundingClientRect(),e=g.posAtCoords({x:u.left+8,y:+u.height*.25});return e===null?null:g.state.doc.lineAt(e).number},Fe=class{constructor(u,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.deps=u,this.helpers=e}createSyncExtension(){let u=this,e=this.helpers;return Ln.ViewPlugin.fromClass(class{constructor(n){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=n,this.docId=e.extractDocIdFromDoc(n.state.doc),this.onScroll=()=>this.scheduleSync(!1),n.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(n){n.docChanged&&(this.docId=e.extractDocIdFromDoc(n.view.state.doc),this.lastPage=null,this.lastChunkId=null),(n.docChanged||n.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(n){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,n)}))}syncPdfSidebar(n,t){var p,_;let i=this.docId;if(!i)return;let r=dt(n);if(r===null)return;let a=e.findChunkStartLineInDoc(n.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(p=s==null?void 0:s.pageNumber)!=null?p:null,l=(_=s==null?void 0:s.chunkId)!=null?_:null;if(!o&&!l)return;let d=o!==null&&this.lastPage===o,c=o===null&&l!==null&&this.lastChunkId===l;!t&&(d||c)||(this.lastPage=o,this.lastChunkId=l,u.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,n;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((n=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:n.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let u=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(u.docId,u.pageNumber,u.chunkId)}updatePreviewScrollHandler(){var t;let u=this.deps.app.workspace.getActiveViewOfType(oe.MarkdownView);if(!u||u.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(t=u.previewMode)==null?void 0:t.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let n=()=>this.schedulePreviewSync(u);e.addEventListener("scroll",n,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=n,this.schedulePreviewSync(u)}async syncPdfSidebarForFile(u){try{let e=await this.deps.app.vault.read(u),n=await this.deps.resolveDocIdForNote(u,e);if(!n)return;let t=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(n,t==null?void 0:t.pageNumber,t==null?void 0:t.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(u,e,n){if(!u)return;let t=await this.deps.getDocIndexEntry(u);t||(t=await this.deps.hydrateDocIndexFromCache(u));let i=t!=null&&t.pdf_path?String(t.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let _=(0,oe.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(_)instanceof oe.TFile&&(r=_)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof oe.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:n};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:n};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&n&&(o=await this.resolvePageNumberForChunk(u,n)),o===null||this.pdfSidebarDocId===u&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=u,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,d=o!==null?`${l}#page=${o}`:l,c=this.deps.app.workspace,p=c.getMostRecentLeaf();c.setActiveLeaf(s,{focus:!1});try{await this.openPdfLinkInLeaf(s,d),this.updatePdfSidebarIcon(s)}finally{p&&c.setActiveLeaf(p,{focus:!1})}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(u){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(u)}))}syncPdfSidebarForPreview(u){let e=this.previewScrollEl;if(!e)return;let n=u.getViewData();if(!n)return;let t=Sn.Text.of(n.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(t);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(t,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(u){var t;let e=u.getBoundingClientRect().top,n=u.querySelectorAll("[data-line]");for(let i of Array.from(n))if(i.getBoundingClientRect().bottom>=e+2){let a=(t=i.getAttribute("data-line"))!=null?t:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var t,i;if(this.pdfSidebarLeaf&&((i=(t=this.pdfSidebarLeaf.view)==null?void 0:t.getViewType)==null?void 0:i.call(t))==="pdf")return this.pdfSidebarLeaf;let u=this.deps.app.workspace;if(typeof u.ensureSideLeaf=="function")try{let r=await u.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let n=this.deps.app.workspace.getRightLeaf(!0);return n&&this.isRightSidebarLeaf(n)?(this.pdfSidebarLeaf=n,this.updatePdfSidebarIcon(n),n):null}isRightSidebarLeaf(u){if(!u)return!1;let n=u.containerEl;return!!(n!=null&&n.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(u){if(!u||!this.isRightSidebarLeaf(u))return;let n=u.containerEl,t=[];n&&t.push(...Array.from(n.querySelectorAll(".view-header-icon")));let i=u;if(i.tabHeaderEl&&t.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&t.push(i.tabHeaderInnerIconEl),t.length===0)return;let r=new Set;for(let s of t)r.has(s)||(r.add(s),s.innerHTML="",(0,oe.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=u.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(u,e){var r,a,s;let n=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],t=(s=(a=n==null?void 0:n.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof t=="function"){await t.call(n.lib.workspace,u,e,"",{active:!1});return}let i=u;if(typeof i.openLinkText=="function"){await i.openLinkText(e,"",{active:!1});return}await this.deps.app.workspace.openLinkText(e,"",!1)}getPluginsRegistry(){var u;return(u=this.deps.app.plugins)==null?void 0:u.plugins}isLeafTabActive(u){var i;let e=u;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===u;let n=e.containerEl;if(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))return!0;let t=e.tabHeaderEl;return!!(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))}async resolvePageNumberForChunk(u,e){var l,d,c,p,_;if(!u||!e)return null;let n=this.deps.normalizeChunkIdForNote(e,u)||e,t=this.chunkPageCache.get(u);if(t&&t.has(n))return(l=t.get(n))!=null?l:null;let i=(0,oe.normalizePath)(`${H}/${u}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let m of s){let y=typeof(m==null?void 0:m.chunk_id)=="string"?m.chunk_id.trim():"";if(!y)continue;let b=Number.isFinite((d=m==null?void 0:m.page_start)!=null?d:NaN)?Number(m.page_start):null,C=Number.isFinite((c=m==null?void 0:m.page_end)!=null?c:NaN)?Number(m.page_end):null,f=b!=null?b:C;f!==null&&(o.set(y,f),o.set(`${u}:${y}`,f))}return this.chunkPageCache.set(u,o),(_=(p=o.get(n))!=null?p:o.get(e))!=null?_:null}};var ze={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var _e=require("@codemirror/state"),ae=require("@codemirror/view"),U=require("obsidian");var Z=g=>{if(typeof g=="string")return g.trim();if(typeof g=="number"&&Number.isFinite(g))return String(g);if(Array.isArray(g))for(let u of g){if(typeof u=="string"&&u.trim())return u.trim();if(typeof u=="number"&&Number.isFinite(u))return String(u)}if(g&&typeof g=="object"){let u=g[0];if(typeof u=="string"&&u.trim())return u.trim();if(typeof u=="number"&&Number.isFinite(u))return String(u)}return""},En=g=>{let u=[g.key,g.itemKey,g.id,g.citationKey];for(let e of u)if(typeof e=="string"&&e.trim())return e.trim();return null},Nn=g=>{var e,n,t;let u=(t=(n=g.key)!=null?n:(e=g.data)==null?void 0:e.key)!=null?t:"";return typeof u=="string"?u:""},sn=g=>{if(!g)return"";let u=g.match(/\b(\d{4})\b/);return u?u[1]:""},Rn=g=>{var e,n,t,i;let u=(i=(t=(e=g.meta)==null?void 0:e.parsedDate)!=null?t:(n=g.data)==null?void 0:n.date)!=null?i:"";return typeof u!="string"?"":sn(u)},he=g=>{if(!g||typeof g!="object")return"";if(g.name)return String(g.name);let u=g.firstName?String(g.firstName):"",e=g.lastName?String(g.lastName):"";return[e,u].filter(Boolean).join(", ")||`${u} ${e}`.trim()},on=(g,u)=>{let e=[u==null?void 0:u["citation-key"],u==null?void 0:u.citationKey,u==null?void 0:u.citationkey,u==null?void 0:u.citekey,u==null?void 0:u.citeKey,u==null?void 0:u.betterBibtexKey,u==null?void 0:u.betterbibtexkey,g["citation-key"],g.citationKey,g.citationkey,g.citekey,g.citeKey,g.betterBibtexKey,g.betterbibtexkey];for(let i of e){let r=Z(i);if(r)return r}let n=typeof g.extra=="string"?g.extra:"";if(!n)return"";let t=n.split(/\r?\n/);for(let i of t){let r=i.match(/^\s*biblatexcitekey\s*\[([^\]]+)\]\s*$/i);if(r&&r[1])return r[1].trim();let a=i.match(/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:\s*(.+)\s*$/i);if(a&&a[2])return a[2].trim()}return""},Dn=g=>{if(!g)return"";let u=[g["citation-key"],g.citationKey,g.citationkey,g.citekey,g.citation_key];for(let e of u){let n=Z(e);if(n)return n}return""},Tn=g=>{var e,n;if(!g)return"";let u=(n=(e=g["title-short"])!=null?e:g.shortTitle)!=null?n:g.short_title;return typeof u=="string"?u.trim():""},me=g=>{let u=Z(g.shortTitle);if(u)return u;let e=Z(g.short_title);if(e)return e;let n=Z(g["title-short"]);return n||""},On=g=>{let u=typeof g.extra=="string"?g.extra:"";if(!u)return"";let e=u.split(/\r?\n/);for(let t of e){let i=t.match(/^\s*doi\s*:\s*(.+)\s*$/i);if(i&&i[1])return i[1].trim().replace(/[.,;]+$/,"")}let n=u.match(/\b10\.\d{4,9}\/[-._;()/:A-Z0-9]+\b/i);return n?n[0].replace(/[.,;]+$/,""):""},In=g=>{var e;if(!g)return"";let u=(e=g.DOI)!=null?e:g.doi;return typeof u=="string"?u.trim().replace(/[.,;]+$/,""):""},pt=g=>{if(!g)return[];let u=[g.attachments,g.children,g.items,g.attachment,g.allAttachments],e=[];for(let n of u)n&&(Array.isArray(n)?e.push(...n):typeof n=="object"&&e.push(n));return e},ln=g=>{var n,t,i,r,a,s,o,l,d,c,p,_,m,y,b;if(((s=(a=(i=(n=g==null?void 0:g.contentType)!=null?n:g==null?void 0:g.mimeType)!=null?i:(t=g==null?void 0:g.data)==null?void 0:t.contentType)!=null?a:(r=g==null?void 0:g.data)==null?void 0:r.mimeType)!=null?s:"")==="application/pdf")return!0;let e=(b=(y=(_=(p=(d=(o=g==null?void 0:g.filename)!=null?o:g==null?void 0:g.fileName)!=null?d:(l=g==null?void 0:g.data)==null?void 0:l.filename)!=null?p:(c=g==null?void 0:g.data)==null?void 0:c.fileName)!=null?_:g==null?void 0:g.path)!=null?y:(m=g==null?void 0:g.data)==null?void 0:m.path)!=null?b:"";return!!(typeof e=="string"&&e.toLowerCase().endsWith(".pdf"))},Fn=g=>{var n;let u=pt(g.data);if(u.length>0)return u.some(i=>ln(i))?"yes":"no";let e=(n=g.meta)==null?void 0:n.numChildren;return typeof e=="number"&&e===0?"no":"unknown"};var ut={artwork:"image",audioRecording:"music",bill:"file-text",blogPost:"globe",book:"book",bookSection:"book-open",case:"scale",computerProgram:"code",conferencePaper:"file-text",dataset:"database",dictionaryEntry:"book",document:"file-text",email:"mail",encyclopediaArticle:"book",film:"film",forumPost:"message-circle",hearing:"file-text",interview:"mic",journalArticle:"file-text",letter:"mail",magazineArticle:"file-text",manuscript:"file-text",map:"map",newspaperArticle:"file-text",patent:"award",podcast:"mic",preprint:"file-text",presentation:"file-text",radioBroadcast:"music",report:"file-text",statute:"scale",thesis:"graduation-cap",tvBroadcast:"film",videoRecording:"film",webpage:"globe"},zn=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],_t=g=>g.includes("STDERR")?"zrr-log-stderr":g.includes("ERROR")?"zrr-log-error":g.includes("WARNING")||g.includes("WARN")?"zrr-log-warning":g.includes("INFO")?"zrr-log-info":null,Mn=g=>{let u=new _e.RangeSetBuilder;for(let{from:e,to:n}of g.visibleRanges){let t=e;for(;t<=n;){let i=g.state.doc.lineAt(t),r=_t(i.text);r&&u.add(i.from,i.from,ae.Decoration.line({class:r})),t=i.to+1}}return u.finish()},qn=ae.EditorView.theme({".cm-editor":{height:"100%",display:"flex",flexDirection:"column",minHeight:"0"},".cm-scroller":{fontFamily:"var(--font-monospace)",fontSize:"0.85rem",flex:"1",height:"100%",maxHeight:"100%",overflow:"auto"},".zrr-log-error":{color:"var(--text-error)"},".zrr-log-warning":{color:"var(--text-accent)"},".zrr-log-info":{color:"var(--text-muted)"},".zrr-log-stderr":{color:"var(--text-accent)"}}),jn=ae.ViewPlugin.fromClass(class{constructor(g){this.decorations=Mn(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=Mn(g.view))}},{decorations:g=>g.decorations}),ke=class extends U.Modal{constructor(u,e,n,t,i="Value cannot be empty."){super(u),this.titleText=e,this.placeholder=n,this.onSubmit=t,this.emptyMessage=i}onOpen(){let{contentEl:u}=this;u.empty(),u.createEl("h3",{text:this.titleText});let e=u.createEl("input",{type:"text",placeholder:this.placeholder});e.style.width="100%",e.focus();let n=u.createEl("button",{text:"Submit"});n.style.marginTop="0.75rem";let t=()=>{let i=e.value.trim();if(!i){new U.Notice(this.emptyMessage);return}this.close(),this.onSubmit(i)};n.addEventListener("click",t),e.addEventListener("keydown",i=>{i.key==="Enter"&&t()})}},Me=class extends U.Modal{constructor(u,e,n,t,i){super(u),this.chunkId=e,this.initialTags=n,this.onSubmit=t,this.onRegenerate=i}onOpen(){let{contentEl:u}=this;u.empty(),u.createEl("h3",{text:`Edit tags for ${this.chunkId}`});let e=u.createEl("textarea",{attr:{rows:"3"}});e.style.width="100%",e.placeholder="tag1, tag2, tag3",e.value=this.initialTags.join(", "),e.focus();let n=u.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Save tags"}),i=async()=>{let a=(e.value||"").split(/[,;\n]+/).map(o=>o.trim()).filter(o=>o.length>0),s=Array.from(new Set(a));this.close(),await Promise.resolve(this.onSubmit(s))};if(this.onRegenerate){let r=n.createEl("button",{text:"Regenerate"});r.addEventListener("click",async()=>{var a;r.setAttribute("disabled","true"),t.setAttribute("disabled","true");try{let s=await((a=this.onRegenerate)==null?void 0:a.call(this));s&&s.length>0?(e.value=s.join(", "),await Promise.resolve(this.onSubmit(s))):s&&new U.Notice("No tags were generated.")}finally{r.removeAttribute("disabled"),t.removeAttribute("disabled")}})}t.addEventListener("click",i),e.addEventListener("keydown",r=>{r.key==="Enter"&&(r.metaKey||r.ctrlKey)&&i()})}},qe=class extends U.Modal{constructor(u,e,n,t=""){super(u),this.titleText=e,this.content=n,this.noteText=t}onOpen(){let{contentEl:u}=this;if(u.empty(),u.createEl("h3",{text:this.titleText}),this.noteText){let n=u.createEl("div",{text:this.noteText});n.className="zrr-indexed-note"}let e=u.createEl("textarea",{attr:{rows:"12",readonly:"true"}});e.style.width="100%",e.value=this.content}},je=class extends U.Modal{constructor(e,n,t=""){super(e);this.bodyText="";this.plugin=n,this.initialTerm=t}onOpen(){let{contentEl:e}=this;e.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),e.style.display="flex",e.style.flexDirection="column",e.style.height="100%",e.style.overflow="hidden",e.style.minHeight="0";let n=e.createDiv();n.style.display="flex",n.style.alignItems="center",n.style.justifyContent="space-between",n.style.gap="0.5rem",n.createEl("h3",{text:"Redis index search"});let t=n.createEl("button",{text:"Copy All"});t.style.marginLeft="auto",t.addEventListener("click",()=>{this.copyResultsToClipboard()});let i=e.createDiv();i.style.display="flex",i.style.alignItems="center",i.style.gap="0.5rem",i.style.margin="0.5rem 0";let r=i.createEl("input");r.type="text",r.placeholder="Search term",r.value=this.initialTerm,r.style.flex="1",r.style.minWidth="0",this.inputEl=r,i.createEl("button",{text:"Search"}).addEventListener("click",()=>{this.runSearch()}),r.addEventListener("keydown",d=>{d.key==="Enter"&&(d.preventDefault(),this.runSearch())});let s=e.createDiv();s.style.color="var(--text-muted)",s.style.marginBottom="0.5rem",this.statusEl=s;let o=e.createDiv();o.style.flex="1 1 0",o.style.minHeight="0",o.style.border="1px solid var(--background-modifier-border)",o.style.borderRadius="6px",o.style.display="flex",o.style.flexDirection="column",o.style.overflow="auto";let l=_e.EditorState.create({doc:this.bodyText,extensions:[qn,jn,ae.EditorView.editable.of(!1),_e.EditorState.readOnly.of(!0),ae.EditorView.lineWrapping]});this.editorView=new ae.EditorView({state:l,parent:o}),this.initialTerm&&this.runSearch()}onClose(){var e;(e=this.editorView)==null||e.destroy(),this.editorView=void 0}async runSearch(){var t;let e=(((t=this.inputEl)==null?void 0:t.value)||"").trim();if(!e){this.statusEl&&(this.statusEl.textContent="Enter a search term.");return}this.statusEl&&(this.statusEl.textContent="Searching...");let n=await this.plugin.runRedisSearch(e);this.updateEditor(n),this.statusEl&&(this.statusEl.textContent=`Results for "${e}"`)}updateEditor(e){if(!this.editorView)return;let n=this.editorView,t=n.scrollDOM.scrollTop,i=n.state.selection.main,r=e.length,a=Math.min(i.anchor,r),s=Math.min(i.head,r);n.dispatch({changes:{from:0,to:n.state.doc.length,insert:e},selection:{anchor:a,head:s}}),n.scrollDOM.scrollTop=t,this.bodyText=e}copyResultsToClipboard(){let e=this.bodyText||"";if(!e){new U.Notice("Nothing to copy.");return}navigator.clipboard.writeText(e).then(()=>new U.Notice("Results copied to clipboard.")).catch(()=>new U.Notice("Failed to copy results."))}},ye=class extends U.Modal{constructor(u,e,n,t){super(u),this.titleText=e,this.bodyText=n,this.options=t}onOpen(){var r,a,s,o;let{contentEl:u}=this;u.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),u.style.display="flex",u.style.flexDirection="column",u.style.height="100%",u.style.overflow="hidden",u.style.minHeight="0";let e=u.createDiv();e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="space-between",e.style.gap="0.5rem",e.createEl("h3",{text:this.titleText});let n=e.createDiv();if(n.style.display="flex",n.style.gap="0.5rem",(r=this.options)!=null&&r.onClear){let l=(a=this.options.clearLabel)!=null?a:"Clear log";n.createEl("button",{text:l}).addEventListener("click",async()=>{var c,p;try{await((p=(c=this.options)==null?void 0:c.onClear)==null?void 0:p.call(c))}finally{await this.refreshFromSource()}})}let t=u.createDiv();t.style.flex="1 1 0",t.style.minHeight="0",t.style.border="1px solid var(--background-modifier-border)",t.style.borderRadius="6px",t.style.display="flex",t.style.flexDirection="column",t.style.overflow="auto";let i=_e.EditorState.create({doc:this.bodyText,extensions:[qn,jn,ae.EditorView.editable.of(!0),_e.EditorState.readOnly.of(!1),ae.EditorView.lineWrapping]});if(this.editorView=new ae.EditorView({state:i,parent:t}),this.refreshFromSource(),(s=this.options)!=null&&s.autoRefresh&&this.options.onRefresh){let l=(o=this.options.refreshIntervalMs)!=null?o:2e3;this.refreshTimer=window.setInterval(()=>{this.refreshFromSource()},l)}}onClose(){var u;this.refreshTimer!==void 0&&(window.clearInterval(this.refreshTimer),this.refreshTimer=void 0),(u=this.editorView)==null||u.destroy(),this.editorView=void 0}async refreshFromSource(){var s;if(!((s=this.options)!=null&&s.onRefresh)||!this.editorView)return;let u="";try{u=await this.options.onRefresh()||""}catch(o){return}if(u===this.bodyText)return;let e=this.editorView,n=e.scrollDOM.scrollTop,t=e.state.selection.main,i=u.length,r=Math.min(t.anchor,i),a=Math.min(t.head,i);e.dispatch({changes:{from:0,to:e.state.doc.length,insert:u},selection:{anchor:r,head:a}}),e.scrollDOM.scrollTop=n,this.bodyText=u}},$e=class extends U.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.filePath=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Overwrite"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Ze=class extends U.Modal{constructor(e,n,t,i){super(e);this.resolved=!1;this.notePath=n,this.docId=t,this.onResolve=i}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete note and cached data?"}),e.createEl("p",{text:`This will delete the note and cached chunks/items for doc_id ${this.docId}.`}),e.createEl("p",{text:`Note: ${this.notePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Delete"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Ve=class extends U.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.reason=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Rebuild Redis index?"}),e.createEl("p",{text:this.reason}),e.createEl("p",{text:"This will drop the RedisSearch index (and embeddings) and rebuild it from cached chunks."});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Drop & rebuild"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Be=class extends U.Modal{constructor(e,n){super(e);this.resolved=!1;this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Purge Redis orphaned chunks?"}),e.createEl("p",{text:"This removes Redis chunk keys that have no cached item.json or chunk.json on disk."}),e.createEl("p",{text:"Cache files are not deleted. Use this to clean up stale Redis data."});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Purge orphans"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Ue=class extends U.Modal{constructor(e,n,t,i,r,a,s){super(e);this.resolved=!1;this.fieldLabel=n,this.noteLabel=t,this.zoteroLabel=i,this.noteValue=r,this.zoteroValue=a,this.onResolve=s}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:`Resolve metadata conflict: ${this.fieldLabel}`});let n=e.createEl("div");n.style.display="grid",n.style.gap="0.5rem",n.createEl("div",{text:"Note value"});let t=n.createEl("textarea",{attr:{readonly:"true",rows:"4"}});t.style.width="100%",t.value=this.noteValue||"(empty)",n.createEl("div",{text:"Zotero value"});let i=n.createEl("textarea",{attr:{readonly:"true",rows:"4"}});i.style.width="100%",i.value=this.zoteroValue||"(empty)";let r=e.createEl("div");r.style.display="flex",r.style.gap="0.5rem",r.style.marginTop="0.75rem";let a=r.createEl("button",{text:this.noteLabel}),s=r.createEl("button",{text:this.zoteroLabel}),o=r.createEl("button",{text:"Skip"});a.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("note")}),s.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("zotero")}),o.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("skip")})}onClose(){this.resolved||this.onResolve("skip")}},Ge=class extends U.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve metadata conflicts"}),e.createEl("p",{text:"Choose which values to keep for each field."});let n=e.createEl("div");n.style.display="grid",n.style.gap="0.75rem";for(let l of this.conflicts){let d=n.createEl("div");d.style.display="grid",d.style.gap="0.4rem",d.style.border="1px solid var(--background-modifier-border)",d.style.borderRadius="6px",d.style.padding="0.6rem",d.createEl("div",{text:l.fieldLabel}).style.fontWeight="600";let c=d.createEl("div");c.style.display="grid",c.style.gridTemplateColumns="1fr 1fr",c.style.gap="0.5rem";let p=c.createEl("textarea",{attr:{readonly:"true",rows:"3"}});p.style.width="100%",p.value=l.noteValue||"(empty)";let _=c.createEl("textarea",{attr:{readonly:"true",rows:"3"}});_.style.width="100%",_.value=l.zoteroValue||"(empty)";let m=d.createEl("div");m.style.display="flex",m.style.gap="0.5rem",m.style.alignItems="center",m.createEl("span",{text:"Decision:"});let y=m.createEl("select");y.add(new Option(l.noteLabel,"note")),y.add(new Option(l.zoteroLabel,"zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.field,y)}let t=e.createEl("div");t.style.display="flex",t.style.flexWrap="wrap",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let i=l=>{for(let d of this.selects.values())d.value=l},r=t.createEl("button",{text:"Use note for all"}),a=t.createEl("button",{text:"Use Zotero for all"}),s=t.createEl("button",{text:"Skip all"}),o=t.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[d,c]of this.selects.entries())l[d]=c.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[n,t]of this.selects.entries())e[n]=t.value||"skip";this.onResolve(e)}}},He=class extends U.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve annotation conflicts"}),e.createEl("p",{text:"Choose which version to keep for each annotation."});let n=e.createEl("div");n.style.display="grid",n.style.gap="0.75rem";for(let l of this.conflicts){let d=n.createEl("div");d.style.display="grid",d.style.gap="0.4rem",d.style.border="1px solid var(--background-modifier-border)",d.style.borderRadius="6px",d.style.padding="0.6rem",d.createEl("div",{text:l.title}).style.fontWeight="600";let c=d.createEl("div");c.style.display="grid",c.style.gridTemplateColumns="1fr 1fr",c.style.gap="0.5rem";let p=c.createEl("textarea",{attr:{readonly:"true",rows:"4"}});p.style.width="100%",p.value=l.noteValue||"(empty)";let _=c.createEl("textarea",{attr:{readonly:"true",rows:"4"}});_.style.width="100%",_.value=l.zoteroValue||"(empty)";let m=d.createEl("div");m.style.display="flex",m.style.gap="0.5rem",m.style.alignItems="center",m.createEl("span",{text:"Decision:"});let y=m.createEl("select");y.add(new Option("Use note","note")),y.add(new Option("Use Zotero","zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.key,y)}let t=e.createEl("div");t.style.display="flex",t.style.flexWrap="wrap",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let i=l=>{for(let d of this.selects.values())d.value=l},r=t.createEl("button",{text:"Use note for all"}),a=t.createEl("button",{text:"Use Zotero for all"}),s=t.createEl("button",{text:"Skip all"}),o=t.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[d,c]of this.selects.entries())l[d]=c.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[n,t]of this.selects.entries())e[n]=t.value||"skip";this.onResolve(e)}}},We=class extends U.SuggestModal{constructor(e,n){super(e);this.resolved=!1;this.resolveSelection=n,this.setPlaceholder("Select a language for OCR/quality...")}getSuggestions(e){let n=e.trim().toLowerCase();return n?zn.filter(t=>t.label.toLowerCase().includes(n)||t.value.toLowerCase().includes(n)):zn}renderSuggestion(e,n){n.setText(e.label),n.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new ke(this.app,"Custom language hint","e.g., en, de, fr, de,en",n=>this.resolveSelection(n.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},Ke=class extends U.SuggestModal{constructor(e,n,t){super(e);this.lastError=null;this.indexedDocIds=null;this.querySequence=0;this.queryDebounceMs=200;this.minQueryLength=2;this.maxQueryCacheEntries=100;this.queryCache=new Map;this.plugin=n,this.resolveSelection=t,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){let n=e.trim();if(n.length>0&&n.length<this.minQueryLength)return[];let t=n.toLowerCase(),i=this.queryCache.get(t);if(i)return i;let r=++this.querySequence;try{if(await new Promise(s=>{window.setTimeout(s,this.queryDebounceMs)}),r!==this.querySequence)return[];if(!this.indexedDocIds){let s=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(s))}let a=await this.plugin.searchZoteroItems(n);if(r!==this.querySequence)return[];if(this.queryCache.set(t,a),this.queryCache.size>this.maxQueryCacheEntries){let s=this.queryCache.keys().next().value;s!==void 0&&this.queryCache.delete(s)}return a}catch(a){let s=a instanceof Error?a.message:String(a);return this.lastError!==s&&(this.lastError=s,new U.Notice(s)),console.error("Zotero search failed",a),[]}}renderSuggestion(e,n){var b,C,f,k,x,w;let t=(C=(b=e.data)==null?void 0:b.title)!=null?C:"[No title]",i=Rn(e),r=Nn(e),a=r?(f=this.indexedDocIds)==null?void 0:f.has(r):!1,s=Fn(e),o=String((x=(k=e.data)==null?void 0:k.itemType)!=null?x:"").trim();a&&n.addClass("zrr-indexed-item"),s==="no"&&n.addClass("zrr-no-pdf-item");let l=n.createDiv({cls:"zrr-zotero-suggest-row"}),d=l.createSpan({cls:"zrr-zotero-item-icon"}),c=(w=ut[o])!=null?w:"file-text";(0,U.setIcon)(d,c);let p=l.createDiv({cls:"zrr-zotero-suggest-text"});p.createEl("div",{text:t,cls:"zrr-zotero-suggest-title"});let _=p.createEl("small",{cls:"zrr-zotero-suggest-meta"}),m=!1,y=()=>{m&&_.createSpan({text:" - "})};i&&(_.createSpan({text:i}),m=!0),a&&(y(),_.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),m=!0),s==="no"&&(y(),_.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),m=!0),n.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,n){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}};var $n={"docling_extract.py":`#!/usr/bin/env python3
# zotero-redisearch-rag tool version: 0.6.8
import argparse
import atexit
import base64
import errno
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.6.8
aai
aam
abb
abge
...
\xF6pnv
\xFCberarb
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.6.8
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.6.8
services:
  redis-stack:
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,n=1200){let t=this.noteSyncTimers.get(e.path);t!==void 0&&window.clearTimeout(t);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},n);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,n=1200,t="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,t)},n);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,n=1200,t="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,t)},n);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let n=this.annotationNoteEditTimes.get(e);if(!n)return 0;let t=Date.now()-n;return t>=Hn?0:Hn-t}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=(e.annotation_page_label||"").trim();if(n)return n;let t=e.page_start?String(e.page_start):"",i=e.page_end?String(e.page_end):"";if(t&&(!i||t===i))return t;if(t&&i)return`${t} - ${i}`;let r=(e.pages||"").trim();if(!r)return"?";let a=r.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:r.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,h.normalizePath)(`${H}/${s}.json`),d=this.app.vault.adapter;if(!await d.exists(l))return;let c=await this.readChunkPayload(l);if(!c)return;let p=Array.isArray(c.chunks)?c.chunks:[],_=new Map;for(let x of p){if(this.isAnnotationChunk(x))continue;let w=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((n=x==null?void 0:x.chunk_id)!=null?n:"");w&&_.set(w,x)}let m=new Set,y=new Set,b=new Set,C=new Set,f=!1;for(let x of o){let w=x.chunkId;if(!w)continue;m.add(w);let E=_.get(w);if(!E){console.warn(`Sync note: chunk id not found in cache (${w})`);continue}if(x.excludeFlag){E.excluded!==!0&&(E.excluded=!0,f=!0);let L=this.normalizeChunkText(x.text);L&&L!==String((t=E.text)!=null?t:"")&&(E.text=L,E.char_count=L.length,f=!0),b.add(w);continue}if(E.excluded&&(E.excluded=!1,f=!0,y.add(w)),!x.text.trim()){b.add(w),C.add(w);continue}let S=this.normalizeChunkText(x.text);if(!S){b.add(w),C.add(w);continue}let P=typeof E.text=="string"?E.text:String((i=E.text)!=null?i:"");S!==P&&(E.text=S,E.char_count=S.length,y.add(w),f=!0)}for(let x of _.keys())m.has(x)||(b.add(x),C.add(x));let k=new Set([...b,...C]);if(k.size){let x=Array.from(k).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==x){this.noteSyncPendingDeletes.set(e.path,x),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!y.size&&!b.size&&!C.size&&!f)return;C.size&&(c.chunks=p.filter(x=>{var E;let w=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((E=x==null?void 0:x.chunk_id)!=null?E:"");return w&&!C.has(w)}),f=!0),(f||C.size)&&await d.write(l,JSON.stringify(c,null,2)),await this.reindexChunkUpdates(s,l,Array.from(y),Array.from(b)),(b.size||C.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,n){var t,i,r;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,n);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),s=await this.resolveDocIdForNote(e,a);if(!s)return;let o=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter;if(!o)return;let l=this.resolveZoteroItemKey(o,s);if(!l)return;let d=await this.fetchZoteroItem(l),c=(i=d==null?void 0:d.data)!=null?i:d;if(!c||typeof c!="object")return;let p=this.extractNoteMetadata(o),_=this.extractZoteroMetadata(c),m=await this.getMetadataSnapshot(s,o,e),y={},b={},C={},f=[],k=["title","short_title","citekey","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],x={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},w=k.filter(P=>this.hasFrontmatterKey(o,x[P]));if(!w.length)return;let E={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"},S=this.hasPinnedCitekeyInExtra(c==null?void 0:c.extra);for(let P of w){let L=p[P],F=_[P];if(P==="citekey"&&!S){this.metadataValuesEqual(P,L,F)||(C[P]="zotero",this.assignMetadataUpdate(y,P,F));continue}if(this.metadataValuesEqual(P,L,F))continue;let T=m==null?void 0:m[P];if(T!==void 0){let I=!this.metadataValuesEqual(P,L,T),z=!this.metadataValuesEqual(P,F,T);if(I&&!z){C[P]="note",this.assignMetadataUpdate(b,P,L);continue}if(!I&&z){C[P]="zotero",this.assignMetadataUpdate(y,P,F);continue}}let M=this.getMetadataDecisionLabels(P,L,F,E);f.push({field:P,fieldLabel:E[P],noteLabel:M.noteLabel,zoteroLabel:M.zoteroLabel,noteValue:this.formatMetadataValue(L),zoteroValue:this.formatMetadataValue(F)})}if(f.length>0){let P=await this.promptMetadataBatchDecision(f);for(let L of f){let F=(r=P[L.field])!=null?r:"skip";C[L.field]=F,F==="note"?this.assignMetadataUpdate(b,L.field,p[L.field]):F==="zotero"&&this.assignMetadataUpdate(y,L.field,_[L.field])}}Object.keys(y).length>0&&await this.applyNoteMetadataUpdates(e,y),Object.keys(b).length>0&&await this.applyZoteroMetadataUpdates(l,c,p,_,b),await this.updateMetadataSnapshot(e,s,p,_,m,C,w)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,n)}}async syncNoteAnnotationsWithZotero(e,n){var t,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,n);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let d=this.parseAnnotationBlockMarker(l.startMarker),c=await this.resolveDocIdForNote(e,o);if(!c&&d.docId){c=d.docId;let z=this.ensureDocIdInNoteContent(o,c);z!==o&&await this.writeNoteWithSyncSuppressed(e.path,z)}if(!c)return;let p=(i=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter)!=null?i:{},_=(r=d.attachmentKey)!=null?r:"";if(_||(_=await this.resolveAttachmentKeyForDocId(c,p)),!_)return;d.attachmentKey&&(!d.docId||d.docId===c)&&d.attachmentKey===_&&await this.updateDocIndex({doc_id:c,attachment_key:_});let m=_,y=await this.fetchZoteroAnnotationsForDoc(c,_),b=y.annotations;_=y.attachmentKey,_&&_!==m&&await this.updateDocIndex({doc_id:c,attachment_key:_});let C=this.parseAnnotationBlock(l.block,_),f=new Map;for(let z of C)z.key&&z.imagePath&&f.set(z.key,{path:z.imagePath,hash:z.imageHash||this.extractAnnotationImageHashFromPath(z.imagePath)});await this.attachAnnotationImages(c,_,b,e.path,f);let k=new Map;for(let z of C)z.key&&k.set(z.key,z);let x=new Map;for(let z of b)x.set(z.key,z);let w=await this.getAnnotationSnapshot(c),E=(a=w==null?void 0:w.annotations)!=null?a:{},S={},P=[],L=!1,F=!1,T=!1;_&&_!==m&&b.length>0&&(F=!0,T=!0);for(let[z,j]of x.entries()){let O=k.get(z);if(!O){F=!0;continue}let q=E[z],$=this.annotationSnapshotFromEntry(O,j.annotationType),B=this.annotationSnapshotFromEntry(j,j.annotationType),J=($.image_hash||"")!==(B.image_hash||"");if(!q){this.annotationSnapshotsEqualIgnoringImage($,B)?J&&(F=!0,T=!0):(S[z]="note",L=!0);continue}let V=!this.annotationSnapshotsEqual($,q),Y=!this.annotationSnapshotsEqual(B,q),X=(B.color_key||"")!==(q.color_key||""),ie=!this.annotationSnapshotsEqualIgnoringImage($,q),se=!this.annotationSnapshotsEqualIgnoringImage(B,q);ie&&!se?(S[z]="note",L=!0):!ie&&se?(S[z]="zotero",F=!0):ie&&se&&P.push({key:z,title:this.formatAnnotationConflictTitle(j),noteValue:this.formatAnnotationConflictValue($,O.tags),zoteroValue:this.formatAnnotationConflictValue(B,j.tags)}),J&&(V||Y)&&(F=!0,T=!0),X&&(F=!0,T=!0)}if(P.length>0){let z=await this.promptAnnotationBatchDecision(P);for(let j of P){let O=(s=z[j.key])!=null?s:"skip";S[j.key]=O,O==="note"?L=!0:O==="zotero"&&(F=!0,T=!0)}}let M=[];for(let[z,j]of Object.entries(S)){if(j!=="note")continue;let O=k.get(z),q=x.get(z);!O||!q||M.push({entry:q,note:O})}M.length>0&&await this.applyZoteroAnnotationUpdates(M),L&&this.annotationNoteEditTimes.set(e.path,Date.now());let I=this.getAnnotationGraceRemaining(e.path);if(F&&I>0&&L&&!T&&(this.scheduleNoteAnnotationSync(e,I+250,n),F=!1),F){let z=this.buildAnnotationBlock(c,_,b),j=this.replaceAnnotationBlock(o,z);if(j&&j!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,j)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(c,_,b),await this.updateAnnotationChunks(c,_,b)}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,n)}}resolveZoteroItemKey(e,n){let t=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),n];for(let i of t){let r=Z(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,n){var l;if(!e)return"";let t=await this.getDocIndexEntry(e);if(t||(t=await this.hydrateDocIndexFromCache(e)),t!=null&&t.attachment_key)return t.attachment_key;let i=(0,h.normalizePath)(`${H}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let c=await this.readChunkPayload(i),p=c!=null&&c.metadata&&typeof c.metadata=="object"?c.metadata:null,_=p==null?void 0:p.attachment_key;if(typeof _=="string"&&_.trim())return await this.updateDocIndex({doc_id:e,attachment_key:_.trim()}),_.trim()}}catch(d){}let r=this.resolveZoteroItemKey(n,e);if(!r)return"";let a=await this.fetchZoteroItem(r),s=(l=a==null?void 0:a.data)!=null?l:a;if(!s||typeof s!="object")return"";let o=await ve(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var C,f,k,x,w,E,S,P,L,F,T,M,I;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString((x=(k=(f=(C=e==null?void 0:e["short title"])!=null?C:e==null?void 0:e.short_title)!=null?f:e==null?void 0:e.shortTitle)!=null?k:e==null?void 0:e["short-title"])!=null?x:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString((P=(S=(E=(w=e==null?void 0:e.citekey)!=null?w:e==null?void 0:e["citation key"])!=null?E:e==null?void 0:e.citation_key)!=null?S:e==null?void 0:e.citationKey)!=null?P:e==null?void 0:e["citation-key"]),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString((L=e==null?void 0:e.abstract)!=null?L:e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((F=e==null?void 0:e.doi)!=null?F:e==null?void 0:e.DOI),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),d=this.normalizeMetadataString(e==null?void 0:e.issue),c=this.normalizeMetadataString(e==null?void 0:e.volume),p=this.normalizeMetadataString(e==null?void 0:e.pages),_=this.normalizeMetadataString((I=(M=(T=e==null?void 0:e["item type"])!=null?T:e==null?void 0:e.item_type)!=null?M:e==null?void 0:e.itemType)!=null?I:e==null?void 0:e["item-type"]),m=this.normalizeMetadataList(e==null?void 0:e.tags),y=this.normalizeMetadataList(e==null?void 0:e.authors),b=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:n,short_title:t,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:d,volume:c,pages:p,item_type:_,tags:this.sanitizeObsidianTags(m),authors:y,editors:b}}extractZoteroMetadata(e){var f,k,x;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString(me(e)),i=this.normalizeMetadataString(on(e)),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString(e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((f=e==null?void 0:e.DOI)!=null?f:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),d=this.normalizeMetadataString(e==null?void 0:e.issue),c=this.normalizeMetadataString(e==null?void 0:e.volume),p=this.normalizeMetadataString(e==null?void 0:e.pages),_=this.normalizeMetadataString((x=(k=e==null?void 0:e.itemType)!=null?k:e==null?void 0:e.item_type)!=null?x:e==null?void 0:e["item-type"]),m=Array.isArray(e==null?void 0:e.creators)?e.creators:[],y=m.filter(w=>(w==null?void 0:w.creatorType)==="author").map(w=>he(w)).filter(Boolean),b=m.filter(w=>(w==null?void 0:w.creatorType)==="editor"||(w==null?void 0:w.creatorType)==="seriesEditor").map(w=>he(w)).filter(Boolean),C=Array.isArray(e==null?void 0:e.tags)?e.tags.map(w=>typeof w=="string"?w:w==null?void 0:w.tag).filter(w=>typeof w=="string"):[];return{title:n,short_title:t,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:d,volume:c,pages:p,item_type:_,tags:this.sanitizeObsidianTags(C),authors:this.normalizeMetadataList(y),editors:this.normalizeMetadataList(b)}}extractAnnotationPageInfo(e){var a;let t=Z((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:t,pageIndex:i}}extractAnnotationImagePayload(e){var a,s,o,l;let n=(s=(a=e.annotationImage)!=null?a:e.annotationImageData)!=null?s:e.annotationImageBase64;if(!n)return null;let t=null,i="";if(Buffer.isBuffer(n))t=n;else if(ArrayBuffer.isView(n))t=Buffer.from(n.buffer,n.byteOffset,n.byteLength);else if(n instanceof ArrayBuffer)t=Buffer.from(n);else if(typeof n=="string"){let d=n.trim();if(!d)return null;let c=d.match(/^data:([^;]+);base64,(.*)$/i);if(c&&(i=this.normalizeAnnotationImageMime(c[1]),d=c[2]),/^(https?|file|zotero):/i.test(d)||(d=d.replace(/^base64,/,"").replace(/\s+/g,""),!d))return null;t=Buffer.from(d,"base64")}if(!t||!t.length)return null;i||(i=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(t)||"image/png");let r=this.annotationImageExtensionFromMime(i)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(t))||"png";return{buffer:t,mime:i,ext:r}}parseZoteroAnnotationItem(e,n){var C,f,k,x;let t=(f=(C=e==null?void 0:e.data)!=null?C:e)!=null?f:{},i=Z((k=e==null?void 0:e.key)!=null?k:t==null?void 0:t.key);if(!i)return null;let r=Z(t.annotationType),a=this.normalizeAnnotationText(t.annotationText),s=this.normalizeAnnotationText(t.annotationComment),o=Z(t.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:d,callout:c}=this.resolveAnnotationColorMeta(l),{pageLabel:p,pageIndex:_}=this.extractAnnotationPageInfo(t),m=(x=t.annotationSortIndex)!=null?x:t.annotationSort,y=Number.isFinite(Number(m))?Number(m):0,b=Array.isArray(t.tags)?t.tags.map(w=>typeof w=="string"?w:w==null?void 0:w.tag).filter(w=>typeof w=="string"):[];return{key:i.trim(),attachmentKey:n,pageLabel:p,pageIndex:_,colorKey:l,callout:c,heading:d,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(b),sortIndex:y,rawValues:t}}async fetchZoteroAnnotations(e){if(!e)return[];let n=this.canUseWebApi()||await this.ensureWebApiLibraryId(),t=a=>{var o,l;let s=[];for(let d of a){let c=(l=(o=d==null?void 0:d.data)!=null?o:d)!=null?l:{};if(Z(c.itemType)!=="annotation")continue;let p=this.parseZoteroAnnotationItem(d,e);p&&s.push(p)}return s},i=[];try{i=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(a){try{i=await this.fetchZoteroChildrenLocal(e)}catch(s){console.warn("Failed to fetch Zotero annotation items from local API",s)}}let r=t(i);if(!r.length&&n)try{let a=[];try{a=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(o){a=await this.fetchZoteroChildrenWeb(e)}let s=t(a);s.length&&(r=s)}catch(a){console.warn("Failed to fetch Zotero annotation items from Web API",a)}return r}async fetchZoteroAnnotationsForDoc(e,n){var o,l,d;let t=n,i=await this.fetchZoteroAnnotations(t);if(i.length||!e)return i.length||this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i};let r=[];try{r=await this.fetchZoteroChildren(e)}catch(c){return console.warn("Failed to fetch Zotero attachments for annotations",c),this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}let a=[],s=new Set(t?[t]:[]);for(let c of r){if(!ln(c))continue;let p=Z((d=(l=c==null?void 0:c.key)!=null?l:(o=c==null?void 0:c.data)==null?void 0:o.key)!=null?d:c==null?void 0:c.attachmentKey);!p||s.has(p)||(s.add(p),a.push(p))}for(let c of a){let p=await this.fetchZoteroAnnotations(c);if(p.length)return{attachmentKey:c,annotations:p}}return this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}async attachAnnotationImages(e,n,t,i,r){var p;if(!this.settings.includeAnnotationImages||!t.length)return;let a=await this.resolveAnnotationImageOutputDir(i);if(!a)return;let s=this.sanitizeFileName(e||n)||"annotations",o=(0,h.normalizePath)(N.default.join(a.relative||"",s)),l=N.default.normalize(N.default.join(a.absolute,s));o?await this.ensureFolder(o):await W.promises.mkdir(l,{recursive:!0});let d=this.app.vault.adapter,c=new Map;for(let _ of t){let m=String(_.annotationType||"").trim().toLowerCase(),y=m==="image"||m==="ink",b=this.extractAnnotationImagePayload((p=_.rawValues)!=null?p:{});if(!b&&y&&this.settings.zoteroCompanionEnabled&&(b=await this.fetchCompanionAnnotationImage(_.key)),!b){let x=r==null?void 0:r.get(_.key);x!=null&&x.path&&await d.exists(x.path)&&(_.imagePath=x.path,_.imageHash=x.hash,c.set(_.key,x.path));continue}let C=(0,Ce.createHash)("sha1").update(b.buffer).digest("hex").slice(0,12),f=`zrr-annotation-${_.key}-${C}.${b.ext}`,k=(0,h.normalizePath)(N.default.join(o,f));try{await d.exists(k)||await d.writeBinary(k,this.bufferToArrayBuffer(b.buffer)),_.imagePath=k,_.imageHash=C,c.set(_.key,k)}catch(x){console.warn("Failed to write annotation image",{annotationKey:_.key,error:x})}}if(o&&await d.exists(o))try{let _=await d.list(o);for(let m of _.files){let b=N.default.basename(m).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!b)continue;let C=b[1].toUpperCase(),f=c.get(C);(!f||(0,h.normalizePath)(f)!==(0,h.normalizePath)(m))&&await d.remove(m)}}catch(_){console.warn("Failed to clean up annotation images",_)}}async fetchCompanionAnnotationImage(e){let n=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!n)return null;let t=`${n.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,i={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(i.Authorization=`Bearer ${r}`);try{let a=await this.requestLocalApiRaw(t,{headers:i,timeoutMs:5e3});if(a.statusCode===200){let s=a.headers["content-type"],o=Array.isArray(s)?s[0]:s!=null?s:"";return this.buildAnnotationImagePayloadFromBuffer(a.body,o)}if(a.statusCode===204||a.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:a.statusCode})}catch(a){console.warn("Failed to fetch annotation image from Zotero companion",a)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new h.Notice("Zotero companion base URL is not set.");return}let n=`${e.replace(/\/$/,"")}/health`,t={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(t.Authorization=`Bearer ${i}`);try{let r=await this.requestLocalApiRaw(n,{headers:t,timeoutMs:3e3});if(r.statusCode===200){try{let a=JSON.parse(r.body.toString("utf8"));if(a!=null&&a.ok){new h.Notice("Zotero companion: OK.");return}}catch(a){}new h.Notice("Zotero companion responded but did not return OK.");return}if(r.statusCode===401){new h.Notice("Zotero companion: unauthorized (check token).");return}new h.Notice(`Zotero companion: HTTP ${r.statusCode}.`)}catch(r){console.warn("Zotero companion health check failed",r),new h.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new h.Notice("Opened Zotero. Go to Tools \u2192 Add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new h.Notice("Unable to open Zotero automatically. Open Zotero and go to Tools \u2192 Add-ons.")}}async spawnDetached(e){let[n,...t]=e;if(!n)throw new Error("Missing command");await new Promise((i,r)=>{let a=!1,s=(0,ne.spawn)(n,t,{detached:!0,stdio:"ignore"});s.on("error",o=>{a||(a=!0,r(o))}),s.unref(),a||(a=!0,i())})}maybeWarnMissingAnnotationApi(e,n){if(this.canUseWebApi()){console.info("No Zotero annotations returned for attachment",{docId:e,attachmentKey:n});return}let t=e||n;!t||this.annotationWebApiWarned.has(t)||(this.annotationWebApiWarned.add(t),new h.Notice("Zotero annotations require Web API access. Configure the Web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
${t}
<!-- zrr:sync-end -->`;let r=i.some(o=>{if(typeof(o==null?void 0:o.section)=="string"?o.section.trim():"")return!0;let d=typeof(o==null?void 0:o.chunk_id)=="string"?o.chunk_id.trim():"";return!!(d&&!/^p\d+$/i.test(d))}),a=[`<!-- zrr:sync-start doc_id=${e} -->`];for(let o of i){let l=typeof(o==null?void 0:o.chunk_id)=="string"?o.chunk_id.trim():"";if(!l)continue;let d=Number.isFinite((s=o==null?void 0:o.page_start)!=null?s:NaN)?Number(o.page_start):null,c=!!(o!=null&&o.excluded||o!=null&&o.exclude),_=typeof(o==null?void 0:o.text)=="string"?o.text.trim():"";if(r){let C=typeof(o==null?void 0:o.section)=="string"?o.section.trim():"",f=C?`## ${C}`:"";f&&!_.startsWith("#")&&(_=_?`${f}

${_}`:f)}let m=d!==null?r?` (${d})`:` page=${d}`:"",b=` id=${l}${r?" section":""}${m}${c?" exclude":""}`;a.push(`<!-- zrr:chunk${b} -->`),_&&a.push(_),a.push("<!-- zrr:chunk end -->"),a.push("")}return a[a.length-1]===""&&a.pop(),a.push("<!-- zrr:sync-end -->"),a.join(`
...
`);for(let a=0;a<r.length;a+=1)if(i.test(r[a]))return a;return null}async openNoteAtChunk(e,n){if(!e||!n)return!1;await this.openNoteInMain(e);let i=this.getMainLeaf().view;if(!(i instanceof h.MarkdownView))return!1;let r=i.editor,a=this.normalizeChunkIdForNote(n)||n,s=this.findChunkLineInText(r.getValue(),a);return s===null?(new h.Notice(`Chunk ${a} not found in note.`),!1):(r.setCursor({line:s,ch:0}),r.scrollIntoView({from:{line:s,ch:0},to:{line:s,ch:0}},!0),!0)}async openNoteAtAnnotation(e,n,t,i){let r=this.buildAnnotationBlockId(n,t,i);if(!e||!r)return!1;await this.openNoteInMain(e);let s=this.getMainLeaf().view;if(!(s instanceof h.MarkdownView))return!1;let o=s.editor,l=this.findAnnotationLineInText(o.getValue(),r);return l===null?(new h.Notice(`Annotation ${n} not found in note.`),!1):(o.setCursor({line:l,ch:0}),o.scrollIntoView({from:{line:l,ch:0},to:{line:l,ch:0}},!0),!0)}async openInternalLinkInMain(e){let n=this.getMainLeaf(),[t,i]=e.split("#"),r=(t||"").trim(),a=(i||"").trim(),s="zrr-chunk:",o=r?this.app.metadataCache.getFirstLinkpathDest(r,""):null;if(o instanceof h.TFile){let l=a.startsWith(s)?a.slice(s.length).trim():"";if(l&&await this.openNoteAtChunk(o.path,l))return;await n.openFile(o,{active:!0}),e.includes("#")&&!l&&(this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1));return}this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1)}async openNoteInNewTab(e){let n=(0,h.normalizePath)(e);await this.app.workspace.openLinkText(n,"","tab")}async openPdfInMain(e,n){if(!e)return!1;if(!N.default.isAbsolute(e)&&!/^[A-Za-z]+:\/\//.test(e)){let a=(0,h.normalizePath)(e),s=n?`#page=${n}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}let t=N.default.normalize(this.getVaultBasePath()),i=N.default.normalize(e),r=t.endsWith(N.default.sep)?t:`${t}${N.default.sep}`;if(i.startsWith(r)){let a=(0,h.normalizePath)(N.default.relative(t,i)),s=n?`#page=${n}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}try{return window.open((0,un.pathToFileURL)(e).toString()),!0}catch(a){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,n,t,i){if(n){let r=new URLSearchParams;t&&r.set("page",t),i&&r.set("annotation",i);let a=r.toString()?`?${r.toString()}`:"";return`zotero://open-pdf/library/items/${n}${a}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let t=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(t))return t}formatCitationsMarkdown(e){return e.length?e.map(t=>this.formatCitationMarkdown(t)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e){var c,p,_,m,y;let n=e.doc_id||"?",t=this.formatCitationPageLabel(e),i=e.annotation_key||this.extractAnnotationKey(e.chunk_id),r=e.attachment_key||((p=(c=this.docIndex)==null?void 0:c[e.doc_id||""])==null?void 0:p.attachment_key),a=e.page_start?String(e.page_start):"",s=(m=(_=this.docIndex)==null?void 0:_[e.doc_id||""])!=null?m:null,o=this.resolveCitationTitle(s,(y=s==null?void 0:s.note_path)!=null?y:null,e.doc_id),l=this.formatCitationLabel(o,t),d=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&(s!=null&&s.note_path)){if(i){let b=a||(e.page_end?String(e.page_end):"0"),C=this.buildNoteAnnotationLink(s.note_path,i,r||"",b,l);return C?`- ${C}`:`- ${this.buildNoteLink(s.note_path,l)}`}if(d&&!i)return`- ${this.buildNoteChunkLink(s.note_path,d,l)}`}if(r){let b=this.buildZoteroDeepLink(n,r,a,i);return`- [${l}](${b})`}return`- ${l}`}buildNoteChunkLink(e,n,t){let i=(0,h.normalizePath)(e).replace(/\.md$/i,""),r=`zrr-chunk:${n}`,a=this.escapeWikiLabel(t);return`[[${i}#${r}\\|${a}]]`}buildNoteLink(e,n){let t=(0,h.normalizePath)(e).replace(/\.md$/i,""),i=this.escapeWikiLabel(n);return`[[${t}\\|${i}]]`}buildNoteAnnotationLink(e,n,t,i,r){let a=this.buildAnnotationBlockId(n,t,i);if(!a)return null;let s=(0,h.normalizePath)(e).replace(/\.md$/i,""),o=this.escapeWikiLabel(r);return`[[${s}#^${a}\\|${o}]]`}buildAnnotationBlockId(e,n,t){let i=(e||"").trim().toUpperCase(),r=(n||"").trim().toUpperCase();if(!i||!r)return null;let a=(t||"").trim()||"0";return`${i}a${r}p${a}`}escapeWikiLabel(e){return e?e.replace(/\|/g,"\\|"):""}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,h.normalizePath)(`${ee}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var t;let e=this.app.vault.adapter,n=this.getDocIndexPath();if(!await e.exists(n))return{};try{let i=await e.read(n),r=JSON.parse(i);if(r&&typeof r=="object"){let a=(t=r.entries)!=null?t:r;if(Array.isArray(a)){let s={};for(let l of a)l!=null&&l.doc_id&&(s[String(l.doc_id)]=l);let o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let d=this.normalizeDocIndexPdfPath(l.pdf_path);d!==l.pdf_path&&(l.pdf_path=d,o=!0)}return o&&await this.saveDocIndex(s),s}if(a&&typeof a=="object"){let s=a,o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let d=this.normalizeDocIndexPdfPath(l.pdf_path);d!==l.pdf_path&&(l.pdf_path=d,o=!0)}return o&&await this.saveDocIndex(s),s}}}catch(i){console.error("Failed to read doc index",i)}return{}}async saveDocIndex(e){await this.ensureFolder(ee);let n=this.app.vault.adapter,t=this.getDocIndexPath(),i={version:1,entries:e};await n.write(t,JSON.stringify(i,null,2)),this.docIndex=e}async pruneDocIndexOrphans(){var d;let e=this.app.vault.adapter,n=await this.getDocIndex(),t=new Set(await this.listDocIds(te)),i=new Set(await this.listDocIds(H)),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),a=0,s=0,o=!1,l=new Date().toISOString();for(let c of Object.keys(n)){let p=n[c],_=!1,m=p!=null&&p.note_path?p.note_path.trim():"";if(m&&await e.exists(m))_=!0;else if((d=r[c])!=null&&d.note_path){_=!0;let b=r[c];b.note_path&&b.note_path!==p.note_path&&(p.note_path=b.note_path,s+=1,o=!0),b.note_title&&b.note_title!==p.note_title&&(p.note_title=b.note_title,s+=1,o=!0),s>0&&(p.updated_at=l)}let y=t.has(c)||i.has(c);!_&&!y&&(delete n[c],a+=1,o=!0)}return o&&await this.saveDocIndex(n),{removed:a,updated:s}}async updateDocIndex(e){var r;let n=await this.getDocIndex(),t=(r=n[e.doc_id])!=null?r:{doc_id:e.doc_id},i={...t,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&t.note_path&&(i.note_path=t.note_path),e.note_title===void 0&&t.note_title&&(i.note_title=t.note_title),e.zotero_title===void 0&&t.zotero_title&&(i.zotero_title=t.zotero_title),e.short_title===void 0&&t.short_title&&(i.short_title=t.short_title),e.pdf_path===void 0&&t.pdf_path&&(i.pdf_path=t.pdf_path),e.attachment_key===void 0&&t.attachment_key&&(i.attachment_key=t.attachment_key),typeof i.pdf_path=="string"&&(i.pdf_path=this.normalizeDocIndexPdfPath(i.pdf_path)),n[e.doc_id]=i,await this.saveDocIndex(n)}async removeDocIndexEntry(e){let n=await this.getDocIndex();if(!n[e]){await this.removeMetadataSnapshot(e);return}delete n[e],await this.saveDocIndex(n),await this.removeMetadataSnapshot(e)}async hydrateDocIndexFromCache(e){var s,o;if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e),i={},r=(0,h.normalizePath)(`${te}/${e}.json`);if(await n.exists(r))try{let l=await n.read(r),d=JSON.parse(l),c=(o=(s=d==null?void 0:d.data)!=null?s:d)!=null?o:{},p=typeof c.title=="string"?c.title:"";p&&(i.zotero_title=p);let _=me(c);if(_&&(i.short_title=_),!i.note_title||!i.note_path){let m=this.sanitizeFileName(p)||e,y=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${m}.md`),b=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${m}-${e}.md`),C="";await n.exists(y)?C=y:await n.exists(b)&&(C=b),C&&(i.note_path=C,i.note_title=N.default.basename(C,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!i.note_title&&(t!=null&&t.note_path)&&(i.note_title=N.default.basename(t.note_path,".md"));let a=(0,h.normalizePath)(`${H}/${e}.json`);if(await n.exists(a))try{let l=await n.read(a),d=JSON.parse(l);typeof(d==null?void 0:d.source_pdf)=="string"&&(i.pdf_path=d.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(i).length>0&&await this.updateDocIndex({doc_id:e,...i}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var t;return e&&(t=(await this.getDocIndex())[e])!=null?t:null}async inferNotePathFromCache(e){var i,r;let n=this.app.vault.adapter,t=(0,h.normalizePath)(`${te}/${e}.json`);if(!await n.exists(t))return"";try{let a=await n.read(t),s=JSON.parse(a),o=(r=(i=s==null?void 0:s.data)!=null?i:s)!=null?r:{},l=typeof o.title=="string"?o.title:"",d=this.sanitizeFileName(l)||e,c=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${d}.md`),p=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${d}-${e}.md`);if(await n.exists(c))return c;if(await n.exists(p))return p}catch(a){console.error("Failed to infer note path from cache",a)}return""}async rebuildNoteFromCacheForDocId(e,n){var T,M,I,z,j;try{await this.ensureBundledTools()}catch(O){return n&&new h.Notice("Failed to sync bundled tools. See console for details."),console.error(O),!1}let t=this.app.vault.adapter,i=(0,h.normalizePath)(`${te}/${e}.json`),r=(0,h.normalizePath)(`${H}/${e}.json`);if(!await t.exists(i)||!await t.exists(r))return n&&new h.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let a;try{let O=await t.read(i);a=JSON.parse(O)}catch(O){return n&&new h.Notice("Failed to read cached item JSON."),console.error(O),this.clearStatusProgress(),!1}let s;try{let O=await t.read(r);s=JSON.parse(O)}catch(O){return n&&new h.Notice("Failed to read cached chunks JSON."),console.error(O),this.clearStatusProgress(),!1}let o=(T=a.data)!=null?T:a,l=typeof o.title=="string"?o.title:"",d=((I=(M=a.key)!=null?M:o.key)!=null?I:e).toString(),c=await this.getDocIndexEntry(e),p=typeof((z=s==null?void 0:s.metadata)==null?void 0:z.attachment_key)=="string"?s.metadata.attachment_key:c==null?void 0:c.attachment_key,_=typeof s.source_pdf=="string"?s.source_pdf:"";if(!_||!await this.isFileAccessible(_)){let O=await this.recoverMissingPdfFromAttachment(_,o,d,e,p,l,n);if(!O)return n&&new h.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;_=O.sourcePdf,O.attachmentKey&&(p=O.attachmentKey),await this.updateChunkJsonSourcePdf(r,_)}let m=await this.resolveLanguageHint(o,d),y=this.buildDoclingLanguageHint(m!=null?m:void 0),b="";if(c!=null&&c.note_path&&await t.exists(c.note_path)&&(b=(0,h.normalizePath)(c.note_path)),!b){let O=this.sanitizeFileName(l)||e,q=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${O}.md`),$=await t.exists(q)?O:await this.resolveUniqueBaseName(O,e);b=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${$}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let O=this.getLogFileRelativePath(),q=(0,h.normalizePath)(N.default.dirname(O));q&&await this.ensureFolder(q);let $=this.getSpellcheckerInfoRelativePath(),B=(0,h.normalizePath)(N.default.dirname($));B&&await this.ensureFolder(B)}}catch(O){return n&&new h.Notice("Failed to create notes folder."),console.error(O),this.clearStatusProgress(),!1}let C=this.getPluginDir(),f=N.default.join(C,"tools","docling_extract.py"),k=N.default.join(C,"tools","index_redisearch.py"),x=null,w=null,E=O=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=O)};try{x=await this.readDoclingQualityLabelFromPdf(_,y),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",x),0);let O=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(f,await this.buildDoclingArgs(_,e,r,b,y,!0),B=>this.handleDoclingProgress(B,x),()=>{},O,"docling_extract",E),this.recreateMissingNotesProcess=null,x=await this.readDoclingQualityLabel(r),p&&await this.annotateChunkJsonWithAttachmentKey(r,p);let q=await this.readDoclingMetadata(r),$=await this.maybeCreateOcrLayeredPdf(_,q,y);$&&(_=$,w=$,await this.updateChunkJsonSourcePdf(r,$))}catch(O){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(n&&new h.Notice("Docling extraction failed. See console for details."),console.error(O),this.clearStatusProgress(),!1)}let S=!1,P=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;if(!await this.ensureRedisAvailable("rebuild"))S=!0,n&&new h.Notice("Redis is unavailable; skipping indexing for this note.");else try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",x),0);let O=["--chunks-json",this.getAbsoluteVaultPath(r),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(O),this.appendEmbedContextArgs(O),this.settings.embedIncludeMetadata&&O.push("--embed-include-metadata"),this.appendChunkTaggingArgs(O,{allowRegenerate:!1}),await this.runPythonStreaming(k,O,q=>{if((q==null?void 0:q.type)==="progress"&&q.total){let $=Math.round(q.current/q.total*100),B=typeof q.message=="string"&&q.message.trim()?q.message:`Indexing chunks ${q.current}/${q.total}`,J=this.formatStatusLabel(B,x);this.showStatusProgress(J,$)}},()=>{},P,"index_redisearch",E),this.recreateMissingNotesProcess=null}catch(O){if(this.recreateMissingNotesAbort)return this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1;n&&new h.Notice("RedisSearch indexing failed; note will still be rebuilt."),console.error(O),S=!0}let F=w?this.buildPdfLinkFromSourcePath(w):this.buildPdfLinkForNote(_,c==null?void 0:c.attachment_key,e);try{let O=await this.app.vault.adapter.read(b),q=await this.readChunkPayload(r),$=this.buildSyncedDoclingContent(e,q,O),B=await this.buildNoteMarkdown(o,(j=a.meta)!=null?j:{},e,F,p,b,i,$);await this.writeNoteWithSyncSuppressed(b,B);let J=this.app.vault.getAbstractFileByPath(b);J instanceof h.TFile&&this.scheduleNoteAnnotationSync(J,2e3,"save")}catch(O){return n&&new h.Notice("Failed to finalize note markdown."),console.error(O),this.clearStatusProgress(),!1}try{let O=me(o);await this.updateDocIndex({doc_id:e,note_path:b,note_title:N.default.basename(b,".md"),zotero_title:l,short_title:O||void 0,pdf_path:_})}catch(O){console.error("Failed to update doc index",O)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],n=await this.fetchZoteroGroupOptions();return n.length&&e.push(...n),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),n=[],t=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!t)return e&&n.push({value:e,label:e}),n;let i=(this.settings.embedApiKey||"").trim(),r=await this.fetchModelIds(t,i);if(r.length){let a=r.filter(o=>/embed/i.test(o)),s=a.length?a:r;n.push(...s.map(o=>({value:o,label:o})))}return!n.length&&e&&n.push({value:e,label:e}),n.sort((a,s)=>a.label.localeCompare(s.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,n,t){let i=t==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),r=[],a=(e||"").trim().replace(/\/$/,"");if(!a)return i&&r.push({value:i,label:i}),r;let s=(n||"").trim(),o=await this.fetchModelIds(a,s);if(o.length){let l=o.filter(c=>!/embed/i.test(c)),d=l.length?l:o;r.push(...d.map(c=>({value:c,label:c})))}return!r.length&&i&&r.push({value:i,label:i}),r.sort((l,d)=>l.label.localeCompare(d.label))}detectEmbeddingProvider(e){let n=e.toLowerCase();return n.includes("anthropic")?"anthropic":n.includes("openrouter")?"openrouter":n.includes("ollama")||n.includes(":11434")?"ollama":n.includes("openai")?"openai":"generic"}async fetchModelIds(e,n){let t=this.detectEmbeddingProvider(e);try{if(t==="anthropic")return await this.fetchAnthropicModels(e,n);let i=await this.fetchOpenAiCompatibleModels(e,n);return!i.length&&t==="ollama"?await this.fetchOllamaModels(e):i}catch(i){return console.warn("Failed to fetch models",i),[]}}async fetchOpenAiCompatibleModels(e,n){let t=`${e}/models`,i={};n&&(i.Authorization=`Bearer ${n}`);let r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}async fetchOllamaModels(e){let t=`${e.replace(/\/v1\/?$/,"")}/api/tags`,i=await this.requestLocalApiRaw(t);if(i.statusCode>=400)throw new Error(`Ollama tags request failed (${i.statusCode})`);let r;try{r=JSON.parse(i.body.toString("utf8"))}catch(s){return console.warn("Failed to parse Ollama tags response",s),[]}if(!r||typeof r!="object")return[];let a=r.models;return Array.isArray(a)?a.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}async fetchAnthropicModels(e,n){if(!n)return[];let t=`${e}/models`,i={"x-api-key":n,"anthropic-version":"2023-06-01"},r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Anthropic model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}extractModelIds(e){var i,r,a;if(Array.isArray(e))return e.map(s=>this.extractModelId(s)).filter(s=>!!s);if(!e||typeof e!="object")return[];let n=e,t=(a=(r=(i=n.data)!=null?i:n.models)!=null?r:n.model)!=null?a:n.items;return Array.isArray(t)?t.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}extractModelId(e){var r,a,s;if(!e||typeof e!="object")return null;let n=e,t=(s=(a=(r=n.id)!=null?r:n.name)!=null?a:n.model)!=null?s:n.identifier;return typeof t!="string"?null:t.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,n=i=>{for(let r of i)e.has(r.value)||e.set(r.value,r.label)};if(await this.warnIfZoteroLocalApiUnavailable("Zotero groups"))try{let i=this.buildZoteroUrl("/users/0/groups"),r=await this.requestLocalApi(i,`Zotero groups fetch failed for ${i}`);n(this.parseZoteroGroupOptions(r))}catch(i){console.warn("Failed to fetch Zotero groups from local API",i)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let i=(this.settings.webApiLibraryId||"").trim();if(i)try{let r=this.buildWebApiUrl(`/users/${i}/groups`),a=await this.requestWebApi(r,`Zotero Web API groups fetch failed for ${r}`);n(this.parseZoteroGroupOptions(a))}catch(r){console.warn("Failed to fetch Zotero groups from Web API",r)}}return Array.from(e.entries()).map(([i,r])=>({value:i,label:r})).sort((i,r)=>i.label.localeCompare(r.label))}parseZoteroGroupOptions(e){var i,r,a,s,o;let n;try{n=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(n))return[];let t=[];for(let l of n){if(!l||typeof l!="object")continue;let d=(i=l.data)!=null?i:l,c=(a=(r=d.id)!=null?r:l.id)!=null?a:d.key;if(!c)continue;let p=String(c).trim();if(!p)continue;let _=(o=(s=d.name)!=null?s:l.name)!=null?o:p,m=String(_||p).trim()||p;t.push({value:`groups/${p}`,label:`Group: ${m}`})}return t}async ensureFolder(e){let n=this.app.vault.adapter,t=(0,h.normalizePath)(e).split("/").filter(Boolean),i="";for(let r of t)i=i?`${i}/${r}`:r,await n.exists(i)||await n.mkdir(i)}async buildNoteMarkdown(e,n,t,i,r,a,s,o){let l=`[[${s}]]`,d=this.settings.copyPdfToVault&&i.startsWith("[["),c=r?this.buildZoteroDeepLink(t,r):"",p=c||i,_=d?i:c||i,m=_?d?`PDF: !${_}`:`PDF: ${_}`:"",y=m?`${m}

`:"",b=await this.buildTemplateVars(e,n,t,p,l);b.pdf_block=y,b.pdf_line=m,b.docling_markdown=o;let C=(this.settings.noteBodyTemplate||"").trim();/{{\s*annotation_block\s*}}/i.test(C)&&r?b.annotation_block=await this.buildAnnotationBlockForAttachment(t,r,a):b.annotation_block="";let k=this.ensureDocIdInFrontmatter(await this.renderFrontmatter(e,n,t,p,l,b),t),x=k?`---
${k}
---

`:"",w=`${y}${o}`,E=C?this.renderTemplate(C,b,w,{appendDocling:!0}):w;return`${x}${E}`}async buildAnnotationBlockForAttachment(e,n,t){let i=await this.fetchZoteroAnnotationsForDoc(e,n);return i.attachmentKey&&i.attachmentKey!==n&&await this.updateDocIndex({doc_id:e,attachment_key:i.attachmentKey}),await this.attachAnnotationImages(e,i.attachmentKey,i.annotations,t),this.buildAnnotationBlock(e,i.attachmentKey,i.annotations)}buildAnnotationBlock(e,n,t){var p;let i=`<!-- zrr:annotations-start doc_id=${e} attachment_key=${n} -->`,r="<!-- zrr:annotations-end -->";if(!t.length)return`${i}
${r}`;let a=this.getAnnotationColorMap(),s=Object.keys(a),o=new Map;for(let _ of t){let m=_.colorKey||this.normalizeAnnotationColorKey(_.colorKey),y=(p=o.get(m))!=null?p:[];y.push(_),o.set(m,y)}let l=[i],d=new Set,c=[...s,...Array.from(o.keys()).filter(_=>!s.includes(_))];for(let _ of c){let m=o.get(_);if(!m||!m.length)continue;d.add(_);let{heading:y}=this.resolveAnnotationColorMeta(_);l.push("",`## ${y}`),m.sort((b,C)=>{var x,w;let f=(x=b.pageIndex)!=null?x:0,k=(w=C.pageIndex)!=null?w:0;return f!==k?f-k:b.sortIndex!==C.sortIndex?b.sortIndex-C.sortIndex:b.key.localeCompare(C.key)});for(let b of m)l.push(...this.formatAnnotationCallout(b,n,e))}return l.push("",r),l.join(`
`).trim()}formatAnnotationCallout(e,n,t){let i=this.settings.annotationPageLabel||"Page",r=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?"),a=e.pageIndex?String(e.pageIndex):"",s=this.buildZoteroDeepLink(t,n,a,e.key),l=[`> [!${e.callout}] ${i} [${r}](${s})`];e.imagePath&&l.push(`> ![[${e.imagePath}]]`);let d=p=>{if(p)for(let _ of p.split(/\r?\n/))l.push(_.trim()?`> ${_}`:">")};d(e.text),e.comment&&(l.push(">","> ---"),d(e.comment)),e.tags.length&&l.push(`> **Tags:** ${e.tags.map(p=>`#${p}`).join(" ")}`);let c=e.pageIndex?String(e.pageIndex):"0";return l.push(`> ^${e.key}a${n}p${c}`),l.push(""),l}findAnnotationBlockRange(e){let n=bt.exec(e);if(!n)return null;let t=e.slice(n.index+n[0].length),i=xt.exec(t);if(!i)return null;let r=n.index,a=n.index+n[0].length+i.index+i[0].length,s=t.slice(0,i.index);return{start:r,end:a,block:s,startMarker:n[0]}}parseAnnotationBlockMarker(e){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i),t=e.match(/attachment_key=([\"']?)([^\"'\s]+)\1/i);return{docId:n?n[2].trim():void 0,attachmentKey:t?t[2].trim():void 0}}parseAnnotationBlock(e,n){let t=e.split(/\r?\n/),i=[],r=0;for(;r<t.length;){if(!t[r].trim().startsWith("> [!")){r+=1;continue}let s=[];for(;r<t.length&&t[r].trim().startsWith(">");)s.push(t[r]),r+=1;let o=this.parseAnnotationCallout(s,n);o&&i.push(o)}return i}parseAnnotationImageLine(e){var o,l;let n=e.trim();if(!n)return null;let t="",i=n.match(/!\[\[([^\]]+)\]\]/);i&&(t=i[1].trim());let r=t?null:n.match(/!\[[^\]]*\]\(([^)]+)\)/);r&&(t=r[1].trim());let a=t?null:n.match(/<img[^>]+src=[\"']([^\"']+)[\"']/i);if(a&&(t=a[1].trim()),!t)return null;let s=(l=(o=t.split("|")[0])==null?void 0:o.trim())!=null?l:"";return s?{path:s,hash:this.extractAnnotationImageHashFromPath(s)}:null}parseAnnotationCallout(e,n){if(!e.length)return null;let t=e[0].replace(/^>\s?/,"").trim(),i=t.match(/\[!([^\]]+)\]/),r=i?i[1].trim():"note",a=t.match(/\((zotero:\/\/open-pdf\/library\/items\/[^)]+)\)/i),s="",o=n,l="",d=null;if(a){let k=a[1],x=k.match(/items\/([A-Z0-9]{8})/i);x&&(o=x[1]);let w=k.match(/annotation=([A-Z0-9]{8})/i);w&&(s=w[1]);let E=k.match(/page=(\d+)/i);E&&(d=Number(E[1]));let S=t.match(/\[([^\]]+)\]\(zotero:\/\//i);S&&(l=S[1].trim())}let c=[],p=[],_=[],m=!1,y="",b="";for(let k=1;k<e.length;k+=1){let x=e[k].replace(/^>\s?/,""),w=x.trim();if(!w){m?_.push(""):p.push("");continue}let E=this.parseAnnotationImageLine(w);if(E){y=E.path,b=E.hash;continue}if(w.startsWith("^")){let S=w.match(/^\^([A-Z0-9]{8})a([A-Z0-9]{8})p(\d+)/i);S&&(s=S[1],o=S[2],d=Number(S[3]));continue}if(/^(\*\*tags:\*\*|tags:)/i.test(w)){c.push(w);continue}if(w==="---"){m=!0;continue}m?_.push(x):p.push(x)}let C=c.join(" "),f=C?C.replace(/\*\*tags:\*\*/i,"").replace(/tags:/i,"").split(/[\s,]+/).map(k=>k.trim().replace(/^#+/,"")).filter(Boolean):[];return s?{key:s,attachmentKey:o,pageLabel:l,pageIndex:d,callout:r,text:this.normalizeAnnotationText(p.join(`
...
`)}async renderFrontmatter(e,n,t,i,r,a){var c;let s=(c=this.settings.frontmatterTemplate)!=null?c:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,n,t,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),d=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(d)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let n=e.split(/\r?\n/),t=[],i=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<n.length;){let l=n[o],d=l.match(i);if(!d){t.push(l),o+=1;continue}let c=d[1].trim(),p=d[2].trim();if(a.has(c)){t.push(l),o+=1;continue}if(!s(p)){t.push(l),o+=1;continue}let _=o+1,m=[];for(;_<n.length&&n[_].match(r);)m.push(n[_]),_+=1;if(m.length===0){for(o=_;o<n.length&&n[o].trim()==="";)o+=1;continue}let y=m.filter(b=>{let C=b.match(r);if(!C)return!1;let f=C[1].trim();return!s(f)});if(y.length>0&&t.push(l,...y),o=_,y.length===0)for(;o<n.length&&n[o].trim()==="";)o+=1}for(;t.length>0&&t[t.length-1].trim()==="";)t.pop();return t.join(`
...
${n.docling_markdown}`),r.trim()?r:t}async buildTemplateVars(e,n,t,i,r){let a=Z(e.title),s=Z(e.shortTitle),o=Z(e.date),l=typeof(n==null?void 0:n.parsedDate)=="string"?n.parsedDate:"",d=sn(l||o),c=/^\d{4}$/.test(d)?d:"",p=Array.isArray(e.creators)?e.creators:[],_=p.filter(A=>A.creatorType==="author").map(A=>he(A)),m=_.join("; "),y=p.filter(A=>A.creatorType==="editor"||A.creatorType==="seriesEditor").map(A=>he(A)),b=y.join("; "),C=Array.isArray(e.tags)?e.tags.map(A=>typeof A=="string"?A:A==null?void 0:A.tag).filter(Boolean):[],f=this.sanitizeObsidianTags(C),k=f.join("; "),x=await this.resolveCollectionTitles(e),w=x.join("; "),E=this.toObsidianLinks(x),S=E.join("; "),P=Z(e.itemType),L=typeof(n==null?void 0:n.creatorSummary)=="string"?n.creatorSummary:"",F=Z(e.publicationTitle),T=Z(e.bookTitle),M=Z(e.journalAbbreviation),I=Z(e.volume),z=Z(e.issue),j=Z(e.pages),O=Z(e.dateAdded),q=Z(e.dateModified),$=typeof e.key=="string"?e.key:t,B=Z(e.DOI);B||(B=On(e));let J=on(e,n),V=null;(!B||!s||!J)&&(V=await this.fetchZoteroItemCsl($)),B||(B=In(V)),s||(s=Tn(V)),J||(J=Dn(V));let Y=Z(e.ISBN),X=Z(e.ISSN),ie=Z(e.publisher),se=Z(e.place),ge=Z(e.url),Ye=Z(e.language),Qe=Z(e.abstractNote),Se=this.buildZoteroDeepLink($),re=Array.from(new Set([J,s,B].map(A=>String(A||"").trim()).filter(A=>A.length>0))),en=re.join("; "),v={doc_id:t,zotero_key:typeof e.key=="string"?e.key:t,item_link:Se,citekey:J,title:a,short_title:s,date:o,year:d,year_number:c,authors:m,editors:b,aliases:en,tags:k,collection_title:w,collection_titles:w,collections_links:S,item_type:P,creator_summary:L,publication_title:F,book_title:T,journal_abbrev:M,volume:I,issue:z,pages:j,date_added:O,date_modified:q,doi:B,isbn:Y,issn:X,publisher:ie,place:se,url:ge,language:Ye,abstract:Qe,pdf_link:i,item_json:r};for(let[A,R]of Object.entries(v)){let G=this.escapeYamlString(R);v[`${A}_yaml`]=G,v[`${A}_quoted`]=G,v[`${A}_text`]=G}return v.authors_yaml_list=this.toYamlList(_),v.editors_yaml_list=this.toYamlList(y),v.tags_yaml_list=f.length>0?this.toYamlList(f):"",v.aliases_yaml_list=re.length>0?this.toYamlList(re):"",v.collections_yaml_list=this.toYamlList(x),v.collections_links_yaml_list=this.toYamlList(E),v.tags_raw=C.join("; "),v.tags_raw_yaml=this.escapeYamlString(v.tags_raw),v.tags_raw_yaml_list=C.length>0?this.toYamlList(C):"",v.authors_list=v.authors_yaml_list,v.editors_list=v.editors_yaml_list,v.tags_list=v.tags_yaml_list,v.aliases_list=v.aliases_yaml_list,v.collections_list=v.collections_yaml_list,v.collections_links_list=v.collections_links_yaml_list,v}escapeYamlString(e){return`"${String(e).replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n")}"`}toYamlList(e){return e.length?e.map(n=>`  - ${this.escapeYamlString(n)}`).join(`
`):'  - ""'}sanitizeObsidianTags(e){let n=this.settings.tagSanitizeMode||"kebab",t=n==="replace"?"kebab":n;return e.map(i=>this.sanitizeObsidianTag(i,t)).filter(i=>i.length>0)}sanitizeObsidianTag(e,n){let t=String(e||"").trim();if(!t)return"";let i=t.replace(/^#+/,"");if(n==="none")return i;let r=o=>!/^\d+$/.test(o),s=(o=>i.split("/").map(c=>{let _=c.replace(/[^\p{L}\p{N}]+/gu," ").split(/\s+/).filter(Boolean);if(!_.length)return"";if(o==="camel"||o==="pascal"){let[y,...b]=_;return[o==="pascal"?y.charAt(0).toUpperCase()+y.slice(1):y.charAt(0).toLowerCase()+y.slice(1),...b.map(f=>f.charAt(0).toUpperCase()+f.slice(1))].join("")}let m=o==="snake"?"_":"-";return _.join(m)}).filter(Boolean).join("/").replace(/\/{2,}/g,"/").replace(/^\/+|\/+$/g,""))(n);return s&&r(s)?s:""}normalizeZoteroTags(e){let n=new Map;for(let t of e){let i=this.normalizeZoteroTag(t);if(!i)continue;let r=i.toLowerCase();n.has(r)||n.set(r,i)}return Array.from(n.values())}normalizeZoteroTag(e){let n=String(e||"").trim();if(!n)return"";let t=n.replace(/^#+/,"").trim();if(!t)return"";let i=t.split("/").map(r=>{let a=r.trim();return a?(a=a.replace(/[_-]+/g," "),a=a.replace(/([A-Z]+)([A-Z][a-z])/g,"$1 $2"),a=a.replace(/([a-z\\d])([A-Z])/g,"$1 $2"),a=a.replace(/([a-zA-Z])(\\d)/g,"$1 $2"),a=a.replace(/(\\d)([a-zA-Z])/g,"$1 $2"),a=a.replace(/\s+/g," ").trim(),a):""}).filter(Boolean);return i.length?i.join("/"):""}toObsidianLinks(e){return e.map(n=>String(n||"").trim()).filter(n=>n.length>0).map(n=>n.startsWith("[[")&&n.endsWith("]]")?n:`[[${n}]]`)}getVaultBasePath(){var t;let e=this.app.vault.adapter;if(e instanceof h.FileSystemAdapter)return e.getBasePath();let n=(t=e.getBasePath)==null?void 0:t.call(e);if(n)return n;throw new Error("Vault base path is unavailable.")}expandPathValue(e){let n=(e||"").trim();if(!n)return n;let t=n;return t==="~"?t=Ae.default.homedir():(t.startsWith("~/")||t.startsWith("~\\"))&&(t=N.default.join(Ae.default.homedir(),t.slice(2))),t=t.replace(/\$([A-Za-z_][A-Za-z0-9_]*)|\$\{([^}]+)\}/g,(i,r,a)=>{let s=r||a,o=s?process.env[s]:void 0;return o!==void 0?o:i}),t=t.replace(/%([^%]+)%/g,(i,r)=>{let a=process.env[r];return a!==void 0?a:i}),t}resolvePythonPath(){return this.resolveUserPath(this.settings.pythonPath||"")}resolveUserPath(e,n){let t=this.expandPathValue(e);return!t||!(t.includes("/")||t.includes("\\"))||N.default.isAbsolute(t)?t:n&&(t.startsWith("./")||t.startsWith(".\\"))?N.default.join(n,t.slice(2)):N.default.join(Ae.default.homedir(),t)}getPluginDir(){var i;let e=this.getVaultBasePath(),n=(i=this.manifest.dir)!=null?i:this.manifest.id;if(!n)throw new Error("Plugin directory is unavailable.");let t=N.default.isAbsolute(n)?n:N.default.join(e,n);return N.default.normalize(t)}async ensureBundledTools(){let e=this.getPluginDir(),n=N.default.join(e,"tools");await W.promises.mkdir(n,{recursive:!0});for(let[t,i]of Object.entries($n)){let r=N.default.join(n,t),a=!0;try{await W.promises.readFile(r,"utf8")===i&&(a=!1)}catch(s){}a&&await W.promises.writeFile(r,i,"utf8")}}async migrateCachePaths(){let e="zotero/items",n="zotero/chunks",t=te,i=H,r=this.app.vault.adapter,a=(0,h.normalizePath)(e),s=(0,h.normalizePath)(n),o=(0,h.normalizePath)(t),l=(0,h.normalizePath)(i),d=o.split("/").slice(0,-1).join("/"),c=l.split("/").slice(0,-1).join("/");d&&await this.ensureFolder(d),c&&await this.ensureFolder(c);let p=await r.exists(a),_=await r.exists(s),m=await r.exists(o),y=await r.exists(l);p&&!m&&await r.rename(a,o),_&&!y&&await r.rename(s,l)}getAbsoluteVaultPath(e){let n=this.getVaultBasePath(),t=N.default.isAbsolute(e)?e:N.default.join(n,e);return N.default.normalize(t)}async resolveAttachmentOutputDir(e){let n=e?N.default.isAbsolute(e)?this.toVaultRelativePath(e):(0,h.normalizePath)(e):"";if(!n)return null;let t=this.app.fileManager;if(!(t!=null&&t.getAvailablePathForAttachment))return null;try{let i=`zrr-image-${Date.now()}.png`,r=await t.getAvailablePathForAttachment(i,n);if(!r)return null;let a=N.default.isAbsolute(r)?r:this.getAbsoluteVaultPath(r),s=N.default.normalize(N.default.dirname(a)),o=N.default.normalize(this.getVaultBasePath()),l=this.toVaultRelativePath(s);return!l&&s!==o?null:{absolute:s,relative:l}}catch(i){return console.warn("Failed to resolve attachment output dir",i),null}}async resolveAnnotationImageOutputDir(e){let n=null;if(e&&(n=await this.resolveAttachmentOutputDir(e)),!n){let r=(0,h.normalizePath)(this.settings.outputNoteDir||"");if(!r)return null;n={absolute:this.getAbsoluteVaultPath(r),relative:r}}let t=(0,h.normalizePath)(N.default.join(n.relative||"","zrr-annotations")),i=N.default.normalize(N.default.join(n.absolute,"zrr-annotations"));return t&&await this.ensureFolder(t),{absolute:i,relative:t}}async buildDoclingArgs(e,n,t,i,r,a=!1){let s=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",n,"--out-json",this.getAbsoluteVaultPath(t),"--out-md",this.getAbsoluteVaultPath(i),"--chunking",this.settings.chunkingMode,"--ocr",s];a&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),this.settings.forcePerPageOcr&&o.push("--force-per-page-ocr"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),r&&o.push("--language-hint",r),this.settings.enableLlmCleanup&&(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars)));let l=this.getPluginDir(),d=N.default.join(l,"tools","ocr_wordlist.txt");if((0,W.existsSync)(d)&&o.push("--enable-dictionary-correction","--dictionary-path",d),this.settings.enableFileLogging){let p=this.getLogFileAbsolutePath();p&&o.push("--log-file",p);let _=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());_&&o.push("--spellchecker-info-out",_)}let c=await this.resolveAttachmentOutputDir(i);return c&&(c.relative&&await this.ensureFolder(c.relative),o.push("--image-output-dir",c.absolute)),this.appendOcrEngineArgs(o),o}appendOcrEngineArgs(e){let n=this.settings.ocrEngine,t=(this.settings.paddleApiKey||"").trim(),i=(this.settings.paddleVlApiUrl||"").trim(),r=(this.settings.paddleStructureApiUrl||"").trim(),a=o=>{e.push("--prefer-ocr-engine",o,"--fallback-ocr-engine",o)},s=()=>{e.push("--no-paddle-vl-api","--no-paddle-structure-api")};switch(n){case"tesseract":a("tesseract"),e.push("--no-paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_local":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl"),s();break;case"paddle_vl_local":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_api":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl","--no-paddle-vl-api"),t?(e.push("--paddle-structure-api","--paddle-structure-api-token",t),r&&e.push("--paddle-structure-api-url",r)):e.push("--no-paddle-structure-api");break;case"paddle_vl_api":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3","--no-paddle-structure-api"),t?(e.push("--paddle-vl-api","--paddle-vl-api-token",t),i&&e.push("--paddle-vl-api-url",i)):e.push("--no-paddle-vl-api");break;default:s();break}}appendEmbedSubchunkArgs(e){let n=this.settings.embedSubchunkChars;Number.isFinite(n)&&e.push("--embed-subchunk-chars",String(Math.max(0,Math.trunc(n))));let t=this.settings.embedSubchunkOverlap;Number.isFinite(t)&&e.push("--embed-subchunk-overlap",String(Math.max(0,Math.trunc(t))))}appendEmbedContextArgs(e){let n=this.settings.embedContextWindow;Number.isFinite(n)&&e.push("--embed-context-window",String(Math.max(0,Math.trunc(n))));let t=this.settings.embedContextChars;Number.isFinite(t)&&e.push("--embed-context-chars",String(Math.max(0,Math.trunc(t))))}appendChunkTaggingArgs(e,n){if((n==null?void 0:n.allowRegenerate)===!1||!this.settings.enableChunkTagging)return;let t=(this.settings.llmCleanupBaseUrl||"").trim(),i=(this.settings.llmCleanupModel||"").trim();if(!t||!i)return;e.push("--generate-chunk-tags","--tag-base-url",t,"--tag-model",i);let r=(this.settings.llmCleanupApiKey||"").trim();r&&e.push("--tag-api-key",r),e.push("--tag-temperature",String(this.settings.llmCleanupTemperature))}getRedisDataDir(){let e=this.resolveUserPath(process.env.ZRR_DATA_DIR||"");if(e)return e;let n=this.resolveUserPath(this.settings.redisDataDirOverride||"",this.getVaultBasePath());return!this.settings.autoAssignRedisPort&&n?n:N.default.join(this.getVaultBasePath(),ee,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return N.default.join(e,"tools","docker-compose.yml")}prependBinaryDirToPath(e,n){if(!n||!N.default.isAbsolute(n))return;let t=N.default.dirname(n),i=e.PATH||"";(i?i.split(N.default.delimiter):[]).includes(t)||(e.PATH=i?`${t}${N.default.delimiter}${i}`:t)}async resolveDockerPath(){var d;let e=(d=this.settings.dockerPath)==null?void 0:d.trim(),n=e?this.resolveUserPath(e):"",t=["/opt/homebrew/bin/docker","/usr/local/bin/docker","/usr/bin/docker","/Applications/Docker.app/Contents/Resources/bin/docker"],i=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"],r=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"],a=[];n&&a.push(n);let s=n?this.getContainerCliKind(n):"docker",o=s==="podman-compose"?[r,i,t]:s==="podman"?[i,r,t]:[t,i,r];if(!n||n==="docker"||n==="podman"||n==="podman-compose")for(let c of o)a.push(...c);for(let c of a)if(N.default.isAbsolute(c))try{if(await this.isContainerCliAvailable(c))return c}catch(p){}let l=[n,s==="podman"?"podman":"docker",s==="podman"?"docker":"podman","podman-compose"].filter(c=>!!(c&&c.trim()));for(let c of l)if(await this.isContainerCliAvailable(c))return c;return n||"docker"}async isContainerCliAvailable(e){return new Promise(n=>{let t=(0,ne.spawn)(e,["--version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}getContainerCliKind(e){let n=N.default.basename(e);return n==="podman-compose"?"podman-compose":n.includes("podman")?"podman":"docker"}async isContainerDaemonRunning(e){let n=this.getContainerCliKind(e),t=e,i=["info"];if(n==="podman-compose"){let r=await this.resolvePodmanBin();if(!r)return!1;t=r}return new Promise(r=>{let a=(0,ne.spawn)(t,i),s=!1,o=d=>{s||(s=!0,r(d))},l=setTimeout(()=>{a.kill(),o(!1)},2e3);a.on("error",()=>{clearTimeout(l),o(!1)}),a.on("close",d=>{clearTimeout(l),o(d===0)})})}getContainerDaemonHint(e){let n=this.getContainerCliKind(e);return n==="podman"||n==="podman-compose"?"Podman machine not running. Run `podman machine start`.":"Docker Desktop is not running. Start Docker Desktop."}async supportsComposeSubcommand(e){return new Promise(n=>{let t=(0,ne.spawn)(e,["compose","version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}async findPodmanComposePath(){let e=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"];for(let n of e)try{return await W.promises.access(n),n}catch(t){}return await this.isContainerCliAvailable("podman-compose")?"podman-compose":null}async resolvePodmanBin(){let e=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"];for(let n of e)if(await this.isContainerCliAvailable(n))return n;return await this.isContainerCliAvailable("podman")?"podman":null}async resolveComposeCommand(e){let n=N.default.basename(e);if(n==="podman-compose")return{command:e,argsPrefix:[]};if(n==="podman"){let t=await this.findPodmanComposePath();return t?{command:t,argsPrefix:[]}:await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}return await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}async autoDetectContainerCliOnLoad(){var o;let e=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(e)){this.notifyContainerOnce("Docker or Podman not found. Install Docker Desktop or Podman and set Docker/Podman path in settings.");return}let n=((o=this.settings.dockerPath)==null?void 0:o.trim())||"docker",t=this.expandPathValue(n);!await this.isContainerCliAvailable(t)&&!(n==="docker"||n==="podman"||n==="podman-compose")&&e&&e!==n&&(this.settings.dockerPath=e,await this.saveSettings());let s=l=>new Promise(d=>setTimeout(d,l));if(!await this.isContainerDaemonRunning(e)){for(let l of[5e3,1e4])if(await s(l),await this.isContainerDaemonRunning(e))return;this.notifyContainerOnce(this.getContainerDaemonHint(e))}}getDockerProjectName(){let e=s=>s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,32),n=(process.env.ZRR_PROJECT_NAME||"").trim();if(n&&!this.settings.autoAssignRedisPort)return e(n)||"zrr";let t=(this.settings.redisProjectName||"").trim();if(t&&!this.settings.autoAssignRedisPort)return e(t)||"zrr";let i=this.getVaultBasePath(),r=N.default.basename(i).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),a=(0,Ce.createHash)("sha1").update(i).digest("hex").slice(0,8);return`zrr-${r||"vault"}-${a}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),n=e.port?Number(e.port):6379;return Number.isFinite(n)&&n>0?n:6379}catch(e){return 6379}}getVaultPreferredRedisPort(){let e=(0,Ce.createHash)("sha1").update(this.getVaultBasePath()).digest("hex");return 6400+Number.parseInt(e.slice(0,4),16)%2e3}getRedisHostFromUrl(){try{return new URL(this.settings.redisUrl).hostname||"127.0.0.1"}catch(e){return"127.0.0.1"}}isLocalRedisHost(e){let n=e.trim().toLowerCase();return n?n==="localhost"||n==="0.0.0.0"||n==="::1"?!0:n.startsWith("127."):!1}getPortCheckHost(e){return this.isLocalRedisHost(e)?"127.0.0.1":e}async isPortFree(e,n){return new Promise(t=>{let i=Pe.default.createServer();i.once("error",()=>t(!1)),i.once("listening",()=>{i.close(()=>t(!0))}),i.listen(n,e)})}async findAvailablePort(e,n){for(let i=0;i<25;i+=1){let r=n+i;if(await this.isPortFree(e,r))return r}return null}updateRedisUrlPort(e,n){try{let t=new URL(e);return t.port=String(n),t.toString()}catch(t){return`redis://127.0.0.1:${n}`}}async isRedisReachable(e){let n="127.0.0.1",t=6379;try{let i=new URL(e);n=i.hostname||n,t=i.port?Number(i.port):t}catch(i){return!1}return n=this.getPortCheckHost(n),new Promise(i=>{let r=new Pe.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(t,n)})}async isZoteroLocalApiReachable(){let e=(this.settings.zoteroBaseUrl||"").trim();if(!e)return!1;let n="127.0.0.1",t=23119;try{let i=new URL(e);if(n=i.hostname||n,i.port){let r=Number(i.port);Number.isFinite(r)&&r>0&&(t=r)}else i.protocol==="https:"?t=443:t=80}catch(i){return!1}return new Promise(i=>{let r=new Pe.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(t,n)})}getRedisNamespace(){let e=this.getVaultBasePath(),n=N.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24),t=(0,Ce.createHash)("sha1").update(e).digest("hex").slice(0,8);return`${n||"vault"}-${t}`}getRedisIndexName(){return`${(this.settings.redisIndex||"idx:zotero").trim()||"idx:zotero"}:${this.getRedisNamespace()}`}getRedisKeyPrefix(){let e=(this.settings.redisPrefix||"zotero:chunk:").trim()||"zotero:chunk:";return`${e.endsWith(":")?e:`${e}:`}${this.getRedisNamespace()}:`}async isComposeProjectRunning(e,n,t,i,r){return new Promise(a=>{let s=(0,ne.spawn)(e,[...n,"-p",i,"-f",t,"ps","-q"],{cwd:N.default.dirname(t),env:r}),o="";s.stdout.on("data",l=>{o+=l.toString()}),s.on("error",l=>{console.warn("Redis Stack status check failed",l),a(!1)}),s.on("close",l=>{if(l!==0){a(!1);return}a(o.trim().length>0)})})}async startRedisStack(e){var n;try{await this.ensureBundledTools();let t=this.getDockerComposePath(),i=this.getRedisDataDir();await W.promises.mkdir(i,{recursive:!0});let r=await this.resolveDockerPath(),a=((n=this.settings.dockerPath)==null?void 0:n.trim())||"docker",s=this.resolveUserPath(a),o=a==="docker"||a==="podman"||a==="podman-compose";if(!await this.isContainerCliAvailable(s)&&!o&&r&&r!==a&&(this.settings.dockerPath=r,await this.saveSettings(),e||new h.Notice(`Docker/Podman path set to ${r}.`)),!await this.isContainerCliAvailable(r)){e||new h.Notice('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');return}if(!await this.isContainerDaemonRunning(r)){e||new h.Notice(this.getContainerDaemonHint(r));return}let c=await this.resolveComposeCommand(r);if(!c){e||new h.Notice("Compose support not found. Install Docker Desktop or Podman with podman-compose.");return}let p={...process.env};if(this.prependBinaryDirToPath(p,r),this.prependBinaryDirToPath(p,c.command),N.default.basename(c.command)==="podman-compose"){let w=await this.resolvePodmanBin();w&&(p.PODMAN_BIN=w,this.prependBinaryDirToPath(p,w))}let _=this.getDockerProjectName();if(await this.isComposeProjectRunning(c.command,c.argsPrefix,t,_,p)){e||new h.Notice("Redis Stack already running for this vault.");return}let m=this.getRedisPortFromUrl(),y=this.getRedisHostFromUrl(),b=this.getPortCheckHost(y),C=this.settings.autoAssignRedisPort&&this.isLocalRedisHost(y),f=this.settings.redisUrl,k=m,x=()=>{if(!e){if(!this.settings.autoAssignRedisPort){new h.Notice("Redis already running. If you share Redis across vaults, disable Auto-start Redis in this vault.");return}new h.Notice(`Redis already running at ${f}.`)}};if(C){let w=m===6379?this.getVaultPreferredRedisPort():m,E=await this.findAvailablePort(b,w);if(!E)throw new Error(`No available Redis port found starting at ${w}.`);E!==m&&(k=E,f=this.updateRedisUrlPort(f,k),this.settings.redisUrl=f,await this.saveSettings(),e||new h.Notice(`Using Redis port ${k} for this vault.`))}else{if(this.isLocalRedisHost(y)&&!await this.isPortFree(b,k)){await this.isRedisReachable(f)?x():e||new h.Notice(`Port ${k} is already in use and Redis is not reachable at ${f}. Update the Redis URL or enable auto-assign.`);return}if(await this.isRedisReachable(f)){x();return}}p.ZRR_DATA_DIR=i,p.ZRR_PORT=String(k);try{await this.runCommand(c.command,[...c.argsPrefix,"-p",_,"-f",t,"down"],{cwd:N.default.dirname(t),env:p})}catch(w){console.warn("Redis Stack stop before restart failed",w)}await this.runCommand(c.command,[...c.argsPrefix,"-p",_,"-f",t,"up","-d"],{cwd:N.default.dirname(t),env:p}),e||new h.Notice("Redis Stack started.")}catch(t){e||new h.Notice("Failed to start Redis Stack. Check Docker/Podman and file sharing."),console.error("Failed to start Redis Stack",t)}}async setupPythonEnv(){let e=this.getPluginDir(),n=this.getPythonVenvDir(),t=this.getVenvPythonPath(n);await this.ensureBundledTools();let i=this.resolveRequirementsPath(e);if(!i)throw new Error(`requirements.txt not found in ${e}`);try{new h.Notice("Setting up Python environment..."),this.showStatusProgress("Setting up Python environment...",null),console.log(`Python env: using plugin dir ${e}`),console.log(`Python env: venv path ${n}`),await W.promises.mkdir(N.default.dirname(n),{recursive:!0});let r=null,a=async()=>(r||(r=await this.resolveBootstrapPython()),r);if((0,W.existsSync)(t)){let s=await this.getPythonVersion(t,[]);if(s&&this.isUnsupportedPythonVersion(s)){let o=await a();console.log(`Python env: existing venv uses Python ${s.major}.${s.minor}; rebuilding with ${o.command} ${o.args.join(" ")}`),this.showStatusProgress("Rebuilding Python environment...",null),await W.promises.rm(n,{recursive:!0,force:!0})}}if(!(0,W.existsSync)(t)){let s=await a();console.log(`Python env: creating venv with ${s.command} ${s.args.join(" ")}`),await this.runCommand(s.command,[...s.args,"-m","venv",n],{cwd:e})}await this.runCommandStreaming(t,["-m","pip","install","-r",i],{cwd:e},s=>{let o=s.trim();if(!o)return;let l=o.match(/^Collecting\s+([^\s]+)/);if(l){this.showStatusProgress(`Installing ${l[1]}...`,null);return}if(o.startsWith("Installing collected packages")){this.showStatusProgress("Installing packages...",null);return}o.startsWith("Successfully installed")&&this.showStatusProgress("Python environment ready.",100)}),this.settings.pythonPath=t,await this.saveSettings(),this.clearStatusProgress(),new h.Notice("Python environment ready.")}catch(r){this.clearStatusProgress(),new h.Notice("Failed to set up Python environment. See console for details."),console.error("Python env setup failed",r)}}async detectOcrEngines(){let e=await this.canRunCommand("tesseract",[]),n=this.resolvePythonPath(),t=[];if(!n)try{let l=await this.resolveBootstrapPython();n=l.command,t=l.args}catch(l){return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1}}let i=["import importlib.util, json","def has_module(name):","    return importlib.util.find_spec(name) is not None","has_paddle = has_module('paddle')","has_paddleocr = has_module('paddleocr')","has_paddlex = has_module('paddlex')","has_vl = False","if has_paddleocr:","    try:","        from paddleocr import PaddleOCRVL","        has_vl = True","    except Exception:","        has_vl = False","print(json.dumps({'paddle': has_paddle, 'paddleocr': has_paddleocr, 'paddlex': has_paddlex, 'paddle_vl': has_vl}))"].join(`
`),r=await new Promise(l=>{let d=(0,ne.spawn)(n,[...t,"-c",i],{env:this.buildPythonEnv()}),c="";d.stdout.on("data",p=>{c+=p.toString()}),d.on("error",()=>l({ok:!1})),d.on("close",p=>{if(p!==0){l({ok:!1});return}try{let _=JSON.parse(c.trim());l({ok:!0,data:_})}catch(_){l({ok:!1})}})});if(!r.ok||!r.data)return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1};let a=r.data,s=!!a.paddle,o=!!a.paddleocr;return{tesseract:e,paddleStructureLocal:s&&o&&!!a.paddlex,paddleVlLocal:s&&o&&!!a.paddle_vl}}getSharedPythonEnvRoot(){let e=Ae.default.homedir();if(process.platform==="win32"){let t=process.env.LOCALAPPDATA||process.env.APPDATA||N.default.join(e,"AppData","Local");return N.default.join(t,"zotero-redisearch-rag")}let n=process.env.XDG_CACHE_HOME||N.default.join(e,".cache");return N.default.join(n,"zotero-redisearch-rag")}getPythonVenvDir(){return this.settings.pythonEnvLocation==="plugin"?N.default.join(this.getPluginDir(),".venv"):N.default.join(this.getSharedPythonEnvRoot(),"venv")}getVenvPythonPath(e){return process.platform==="win32"?N.default.join(e,"Scripts","python.exe"):N.default.join(e,"bin","python")}resolveRequirementsPath(e){var t;return(t=[N.default.join(e,"requirements.txt"),N.default.join(e,"tools","requirements.txt")].find(i=>(0,W.existsSync)(i)))!=null?t:null}async resolveBootstrapPython(){let e=(this.settings.pythonPath||"").trim(),n=this.expandPathValue(e);if(n&&await this.canRunCommand(n,[])){let i=await this.getPythonVersion(n,[]);if(i&&this.isUnsupportedPythonVersion(i))throw new Error(`Configured Python ${i.major}.${i.minor} is not supported. Install Python 3.11\u20133.13 and update the Python path.`);return{command:n,args:[]}}let t=process.platform==="win32"?[{command:"py",args:["-3.13"]},{command:"py",args:["-3.12"]},{command:"py",args:["-3.11"]},{command:"py",args:["-3.10"]},{command:"py",args:["-3"]},{command:"python",args:[]}]:[{command:"python3.13",args:[]},{command:"python3.12",args:[]},{command:"python3.11",args:[]},{command:"python3.10",args:[]},{command:"python3",args:[]},{command:"python",args:[]}];for(let i of t)if(await this.canRunCommand(i.command,i.args)){let r=await this.getPythonVersion(i.command,i.args);if(r&&this.isUnsupportedPythonVersion(r)){console.log(`Python env: skipping ${i.command} ${i.args.join(" ")} (Python ${r.major}.${r.minor} unsupported)`);continue}return i}throw new Error("No usable Python 3.11\u20133.13 interpreter found on PATH.")}isUnsupportedPythonVersion(e){return e.major>3||e.major===3&&e.minor>=14}async getPythonVersion(e,n){return new Promise(t=>{let i=(0,ne.spawn)(e,[...n,"-c","import sys; print(f'{sys.version_info.major}.{sys.version_info.minor}')"]),r="";i.stdout.on("data",a=>{r+=a.toString()}),i.on("error",()=>t(null)),i.on("close",a=>{if(a!==0){t(null);return}let s=r.trim().match(/(\d+)\.(\d+)/);if(!s){t(null);return}t({major:Number(s[1]),minor:Number(s[2])})})})}async canRunCommand(e,n){return new Promise(t=>{let i=(0,ne.spawn)(e,[...n,"--version"],{env:this.buildPythonEnv()});i.on("error",()=>t(!1)),i.on("close",r=>t(r===0))})}buildPythonEnv(){let e={...process.env},n=N.default.delimiter,t=e.PATH||"",r=[...process.platform==="win32"?[]:["/opt/homebrew/bin","/usr/local/bin"],t].filter(Boolean).join(n);return e.PATH=r,e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK||(e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK="True"),e.DISABLE_MODEL_SOURCE_CHECK||(e.DISABLE_MODEL_SOURCE_CHECK="True"),e}runPython(e,n){return new Promise((t,i)=>{let r=this.resolvePythonPath(),a=(0,ne.spawn)(r,[e,...n],{cwd:N.default.dirname(e),env:this.buildPythonEnv()}),s="",o="";a.stdout.on("data",l=>{s+=l.toString()}),a.stderr.on("data",l=>{o+=l.toString()}),a.on("error",l=>{this.handlePythonProcessError(String(l)),i(l)}),a.on("close",l=>{if(l===0)t();else{let d=o.trim()?o:s;this.handlePythonProcessError(d),i(new Error(o||`Process exited with code ${l}`))}})})}runCommand(e,n,t){return new Promise((i,r)=>{var o;let a=(0,ne.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:(o=t==null?void 0:t.env)!=null?o:this.buildPythonEnv()}),s="";a.stderr.on("data",l=>{s+=l.toString()}),a.on("error",l=>{r(l)}),a.on("close",l=>{l===0?i():r(new Error(s||`Process exited with code ${l}`))})})}runPythonStreaming(e,n,t,i,r,a="docling_extract",s){return new Promise((o,l)=>{let d=this.resolvePythonPath(),c=(0,ne.spawn)(d,[e,...n],{cwd:N.default.dirname(e),env:this.buildPythonEnv()});s&&s(c);let p="",_="",m="",y=null,b=!1,C=f=>{if(f.trim())try{let k=JSON.parse(f);y=k,((k==null?void 0:k.type)==="final"||k!=null&&k.answer)&&(b=!0),t(k)}catch(k){m+=`${f}
`}};c.stdout.on("data",f=>{var x;p+=f.toString();let k=p.split(/\r?\n/);p=(x=k.pop())!=null?x:"";for(let w of k)C(w)}),c.stderr.on("data",f=>{_+=f.toString()}),c.on("error",f=>{this.handlePythonProcessError(String(f)),l(f)}),c.on("close",f=>{if(p.trim()&&C(p),!b&&y&&i(y),r&&this.appendToLogFile(r,_,a,"STDERR"),f===0)o();else{let k=_.trim()?_:m;this.handlePythonProcessError(k),l(new Error(_||`Process exited with code ${f}`))}})})}runCommandStreaming(e,n,t,i){return new Promise((r,a)=>{var d;let s=(0,ne.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:(d=t==null?void 0:t.env)!=null?d:this.buildPythonEnv()}),o=c=>{c.toString().split(/\r?\n/).forEach(_=>{_.trim()&&i(_)})},l="";s.stdout.on("data",o),s.stderr.on("data",c=>{l+=c.toString(),o(c)}),s.on("error",c=>{a(c)}),s.on("close",c=>{c===0?r():a(new Error(l||`Process exited with code ${c}`))})})}handlePythonProcessError(e){if(!e)return;let n=e.match(/ModuleNotFoundError:\s+No module named ['"]([^'"]+)['"]/);if(n){let t=`Python env missing module '${n[1]}'. Open Settings > Python environment > Create/Update.`;this.notifyPythonEnvOnce(t,!0);return}if(/No module named ['"]|ImportError: No module named/i.test(e)){this.notifyPythonEnvOnce("Python env missing required modules. Open Settings > Python environment > Create/Update.",!0);return}/ENOENT|No such file or directory|not found|command not found|spawn .* ENOENT/i.test(e)&&this.notifyPythonEnvOnce("Python not found. Configure the Python path or use Settings > Python environment > Create/Update.",!0)}notifyPythonEnvOnce(e,n=!1){this.lastPythonEnvNotice!==e&&(this.lastPythonEnvNotice=e,new h.Notice(e),n&&this.openPluginSettings())}notifyContainerOnce(e){this.lastContainerNotice!==e&&(this.lastContainerNotice=e,new h.Notice(e))}notifyRedisOnce(e){this.lastRedisNotice!==e&&(this.lastRedisNotice=e,new h.Notice(e))}async autoDetectRedisOnLoad(){if(this.settings.autoStartRedis)return;let e=(this.settings.redisUrl||"").trim(),t=e||"redis://127.0.0.1:6379";(await this.checkRedisConnectionWithUrl(t,500)).ok&&(e||(this.settings.redisUrl=t,await this.saveSettings()),this.notifyRedisOnce(`Redis detected at ${t}. This instance will be used.`))}notifyZoteroApiOnce(e){this.lastZoteroApiNotice!==e&&(this.lastZoteroApiNotice=e,new h.Notice(e))}async warnIfZoteroLocalApiUnavailable(e){if(await this.isZoteroLocalApiReachable())return this.lastZoteroApiNotice=null,!0;let i=`Zotero Local API is not reachable for ${e?`${e}`:"this action"}. Start Zotero or update the Local API URL in settings.`;return this.notifyZoteroApiOnce(i),!1}openPluginSettings(){let e=this.app.setting;e!=null&&e.open&&e.open(),e!=null&&e.openTabById&&e.openTabById(this.manifest.id)}getLogsDirRelative(){return(0,h.normalizePath)(`${ee}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,h.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,h.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;if(!await n.exists(e)){new h.Notice("Log file not found.");return}try{let t=async()=>{try{return await n.read(e)||"(empty)"}catch(r){return"(empty)"}},i=await t();new ye(this.app,"Log file",i||"(empty)",{autoRefresh:!0,refreshIntervalMs:2e3,onRefresh:t,onClear:async()=>{await this.clearLogFile()}}).open()}catch(t){new h.Notice("Failed to open log file."),console.error(t)}}async clearLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{let t=(0,h.normalizePath)(N.default.dirname(e));t&&await this.ensureFolder(t),await n.write(e,""),new h.Notice("Log file cleared.")}catch(t){new h.Notice("Failed to clear log file."),console.error(t)}}async deleteLogFileIfExists(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{await n.exists(e)&&await n.remove(e)}catch(t){console.warn("Failed to delete log file before import",t)}}formatLogLines(e,n,t){let i=e.split(/\r?\n/).map(a=>a.trimEnd()).filter(a=>!!a.trim());if(!i.length)return"";let r=new Date().toISOString().replace("T"," ").replace(".",",");return i.map(a=>`${r} ${t} ${n}: ${a}`).join(`
`)+`
`}async appendToLogFile(e,n,t="docling_extract",i="STDERR"){if(!n||!n.trim())return;let r=this.formatLogLines(n,t,i);if(r)try{await W.promises.mkdir(N.default.dirname(e),{recursive:!0}),await W.promises.appendFile(e,r)}catch(a){console.warn("Failed to append stderr to log file",a)}}runPythonWithOutput(e,n,t,i="docling_extract"){return new Promise((r,a)=>{let s=this.resolvePythonPath(),o=(0,ne.spawn)(s,[e,...n],{cwd:N.default.dirname(e),env:this.buildPythonEnv()}),l="",d="";o.stdout.on("data",c=>{l+=c.toString()}),o.stderr.on("data",c=>{d+=c.toString()}),o.on("error",c=>{this.handlePythonProcessError(String(c)),a(c)}),o.on("close",c=>{if(t&&this.appendToLogFile(t,d,i,"STDERR"),c===0)r(l.trim());else{let p=d.trim()?d:l;this.handlePythonProcessError(p),a(new Error(d||`Process exited with code ${c}`))}})})}};

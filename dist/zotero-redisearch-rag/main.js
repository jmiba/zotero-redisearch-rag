"use strict";var he=Object.create;var H=Object.defineProperty;var fe=Object.getOwnPropertyDescriptor;var me=Object.getOwnPropertyNames;var ye=Object.getPrototypeOf,be=Object.prototype.hasOwnProperty;var xe=(C,p)=>{for(var e in p)H(C,e,{get:p[e],enumerable:!0})},oe=(C,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of me(p))!be.call(C,t)&&t!==e&&H(C,t,{get:()=>p[t],enumerable:!(n=fe(p,t))||n.enumerable});return C};var W=(C,p,e)=>(e=C!=null?he(ye(C)):{},oe(p||!C||!C.__esModule?H(e,"default",{value:C,enumerable:!0}):e,C)),we=C=>oe(H({},"__esModule",{value:!0}),C);var Ee={};xe(Ee,{default:()=>Y});module.exports=we(Ee);var d=require("obsidian"),V=require("@codemirror/state"),G=require("@codemirror/view"),z=require("child_process"),D=require("fs"),ge=W(require("http")),_e=W(require("https")),te=W(require("net")),f=W(require("path")),Z=require("url"),J=require("crypto");var w=require("obsidian"),O=".zotero-redisearch-rag",$=`${O}/items`,F=`${O}/chunks`,le={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}

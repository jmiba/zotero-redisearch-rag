"use strict";var mn=Object.create;var qe=Object.defineProperty;var yn=Object.getOwnPropertyDescriptor;var bn=Object.getOwnPropertyNames;var xn=Object.getPrototypeOf,kn=Object.prototype.hasOwnProperty;var wn=(f,_)=>{for(var e in _)qe(f,e,{get:_[e],enumerable:!0})},Et=(f,_,e,t)=>{if(_&&typeof _=="object"||typeof _=="function")for(let n of bn(_))!kn.call(f,n)&&n!==e&&qe(f,n,{get:()=>_[n],enumerable:!(t=yn(_,n))||t.enumerable});return f};var me=(f,_,e)=>(e=f!=null?mn(xn(f)):{},Et(_||!f||!f.__esModule?qe(e,"default",{value:f,enumerable:!0}):e,f)),vn=f=>Et(qe({},"__esModule",{value:!0}),f);var Hn={};wn(Hn,{default:()=>ct});module.exports=vn(Hn);var m=require("obsidian");var It=require("@codemirror/state"),ie=require("@codemirror/view"),Ft=require("obsidian");var ye=/<!--\s*zrr:sync-start[^>]*-->/i,xe=/<!--\s*zrr:sync-end\s*-->/i,he=/<!--\s*zrr:chunk\b([^>]*)-->/i,je=/<!--\s*zrr:chunk\s+end\s*-->/i,Re=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,St=f=>{let _=f.trim();if(!_.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(_)){let u=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:u?u[2]:void 0}}if(/^zrr:sync-end\b/i.test(_))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(_)){let u=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),g=_.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:u?u[2]:void 0,attachmentKey:g?g[2]:void 0}}if(/^zrr:annotations-end\b/i.test(_))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(_))return{type:"chunk-end"};let e=_.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let t=e[1]||"",n=t.match(/\bid=(["']?)([^"'\s]+)\1/i),r=n?n[2]:"",i=t.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),s=i?null:t.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):s?Number.parseInt(s[1],10):void 0,o=r.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(a!=null?a:NaN)?a:l,d=/\bexclude\b/i.test(t)||/\bdelete\b/i.test(t),p=/\bsection\b/i.test(t);return{type:"chunk-start",chunkId:r||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:p?"section":c?"page":"section"}},$e=f=>{var l;if(!f)return null;let _=f.match(he);if(!_)return null;let e=_[1]||"",t=e.match(/\bid=(["']?)([^"'\s]+)\1/i),n=t?t[2].trim():void 0,r=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),i=r?null:e.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):i?Number.parseInt(i[1],10):void 0,a=n&&(l=_t(n))!=null?l:void 0,o=Number.isFinite(s!=null?s:NaN)?s:a;return{chunkId:n,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Ve=f=>{for(let _=1;_<=f.lines;_+=1){let e=f.line(_).text;if(ye.test(e)){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i);return t?t[2].trim():null}}return null},ut=(f,_)=>{let e=_;for(;e>=1;e-=1){let t=f.line(e).text;if(he.test(t))return{line:e,text:t};if(ye.test(t)||xe.test(t))break}return null},Pn=(f,_)=>{for(let e=_;e<=f.lines;e+=1){let t=f.line(e).text;if(je.test(t))return e;if(xe.test(t))break}return null},Nt=(f,_)=>{let e=ut(f,_);if(!e)return null;let t=Pn(f,e.line+1);return t===null||_<e.line||_>t?null:{startLine:e.line,endLine:t,text:e.text}},Lt=(f,_,e)=>{if(_>e)return!1;for(let t=_;t<=e;t+=1){let n=f.line(t).text;if(Re.test(n))return!0}return!1},_t=f=>{var n;if(!f)return null;let e=(f.includes(":")&&(n=f.split(":").pop())!=null?n:f).match(/^p(\d+)$/i);if(!e)return null;let t=Number.parseInt(e[1],10);return Number.isFinite(t)?t:null};var Tt=f=>{if(!f)return null;let _=f.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return _?$e(_[0]):null};var Cn=(f,_)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),f.type==="sync-start"||f.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(f.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),f.type==="sync-start"?e.textContent=f.docId?`Redis Index Sync start - ${f.docId}`:"Redis Index Sync start":e.textContent="Redis index sync end",e;if(f.type==="annotations-start"||f.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),f.type==="annotations-start"){let t=f.docId?` - ${f.docId}`:"";e.textContent=`Zotero annotations start${t}`}else e.textContent="Zotero annotations end";return e}if(f.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=f.chunkKind==="page"?"Page end":"Section end",f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),e;if(f.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),f.excluded&&e.classList.add("is-excluded"),f.pageNumber&&_>0)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber}/${_})`}else e.textContent=`Page ${f.pageNumber}/${_}`;else if(f.pageNumber)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber})`}else e.textContent=`Page ${f.pageNumber}`;else f.chunkId?e.textContent=`Section ${f.chunkId}`:e.textContent="Section";return f.excluded&&(e.textContent=`${e.textContent} - excluded`),e},gt=class extends ie.WidgetType{constructor(_,e,t,n,r){super(),this.plugin=_,this.docId=e,this.chunkId=t,this.startLine=n,this.excluded=r}eq(_){return this.docId===_.docId&&this.chunkId===_.chunkId&&this.startLine===_.startLine&&this.excluded===_.excluded}toDOM(){let _=document.createElement("span");_.className="zrr-chunk-toolbar",_.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},t=(c,d,p)=>{let u=document.createElement("span");u.className="zrr-chunk-button-icon",(0,Ft.setIcon)(u,d);let g=document.createElement("span");g.className="zrr-chunk-button-label",g.textContent=p,c.appendChild(u),c.appendChild(g)},n=document.createElement("button");n.type="button",n.className="zrr-chunk-button",t(n,"sparkles","Clean"),e(n,"Clean this chunk with the OCR cleanup model"),n.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),_.appendChild(n);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",t(r,"tag","Tags"),e(r,"Edit chunk tags"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),_.appendChild(r);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",t(i,"search","Indexed"),e(i,"Preview indexed chunk text"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),_.appendChild(i);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button",t(s,"external-link","Zotero"),e(s,"Open this page in Zotero"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),_.appendChild(s);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return t(a,l,o),e(a,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),_.appendChild(a),_}ignoreEvent(){return!0}},Dt=(f,_)=>{var y;let e=f.state.doc,t=Ve(e);if(!t)return ie.Decoration.none;let n=f.state.selection.main.head,r=e.lineAt(n).number,i=Nt(e,r);if(!i)return ie.Decoration.none;let s=i.text.match(he);if(!s)return ie.Decoration.none;let a=((y=s[1])!=null?y:"").trim(),o=a.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return ie.Decoration.none;let l=o[2].trim();if(!l)return ie.Decoration.none;let c=/\bexclude\b/i.test(a)||/\bdelete\b/i.test(a),d=Lt(e,i.startLine+1,i.endLine-1),p=c||d,u=e.line(i.startLine),g=ie.Decoration.widget({widget:new gt(_,t,l,i.startLine,p),side:1});return ie.Decoration.set([g.range(u.to)])},ht=class extends ie.WidgetType{constructor(_,e){super(),this.info=_,this.totalPages=e}toDOM(){var _;return(_=Cn(this.info,this.totalPages))!=null?_:document.createElement("span")}},Ot=f=>{var o,l;let _=f.dom.closest(".markdown-source-view");if(!_||!_.classList.contains("is-live-preview"))return ie.Decoration.none;let e=f.state.doc,t=new It.RangeSetBuilder,n=[],r=[],i=!1,s=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),p=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!p)continue;let u=St(p[1]);u&&(u.type==="chunk-start"?(u.chunkKind=(o=u.chunkKind)!=null?o:u.pageNumber?"page":"section",u.pageNumber&&(i=!0),u.chunkKind==="section"&&(s=!0)):u.type==="chunk-end"&&(u.chunkKind=(l=u.chunkKind)!=null?l:"section"),n.push({line:c,from:d.from,to:d.to,info:u}),u.pageNumber&&r.push(u.pageNumber))}if(!n.length)return ie.Decoration.none;if(i&&!s)for(let c of n)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let a=r.length?Math.max(...r):0;for(let c of n){let d=ie.Decoration.replace({widget:new ht(c.info,a)});t.add(c.from,c.to,d)}return t.finish()},Mt=()=>ie.ViewPlugin.fromClass(class{constructor(f){this.decorations=Ot(f)}update(f){(f.docChanged||f.viewportChanged)&&(this.decorations=Ot(f.view))}},{decorations:f=>f.decorations}),zt=f=>ie.ViewPlugin.fromClass(class{constructor(_){this.decorations=Dt(_,f)}update(_){(_.docChanged||_.selectionSet||_.viewportChanged)&&(this.decorations=Dt(_.view,f))}},{decorations:_=>_.decorations});var oe=require("child_process"),ee=require("fs"),Pt=me(require("http")),_n=me(require("https")),Oe=me(require("net")),Ie=me(require("os")),gn=me(require("tls")),S=me(require("path")),Ct=require("url"),Fe=require("crypto");var N=require("obsidian"),jt=require("crypto"),Ue=require("fs"),Ze=me(require("path")),re=".zotero-redisearch-rag",le=`${re}/items`,Q=`${re}/chunks`,$t=`${re}/metadata_snapshots.json`,Vt=`${re}/annotation_snapshots.json`,An="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",ke="cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",Ee="__custom__",qt=[{value:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",label:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1 (Fast multilingual)"},{value:"BAAI/bge-reranker-v2-m3",label:"BAAI/bge-reranker-v2-m3 (Best quality, heaviest)"},{value:"jinaai/jina-reranker-v2-base-multilingual",label:"jinaai/jina-reranker-v2-base-multilingual (Balanced multilingual)"}],Ge={pythonRuntime:"worker",pythonRuntimeMigrationV1Done:!1,showAdvancedPythonRuntimeOptions:!1,pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,firstContainerStartupNoticeShown:!1,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:ke,rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${re}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Be=class extends N.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async h=>{this.plugin.settings.llmProviderProfiles=h,await this.plugin.saveSettings()},r=h=>{h.inputEl.type="password",h.inputEl.autocomplete="off",h.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:h=>{new N.Setting(h).setName("Prerequisites").setHeading();let b=null,w=null,R=null,E=null,v=null,A=null,T=null,I=null,L=null,q=(F,j)=>{F&&(F.settingEl.classList.toggle("is-disabled",j),F.settingEl.classList.toggle("zrr-setting-disabled",j))},M=(F,j)=>{F&&F.settingEl.classList.toggle("zrr-setting-hidden",!j)},z=()=>{let F=!!this.plugin.settings.showAdvancedPythonRuntimeOptions,j=this.plugin.settings.pythonRuntime==="local",K=F&&j;w==null||w.setDisabled(!F),q(b,!F),M(R,F),M(E,F),M(v,F),A==null||A.setDisabled(!K),T==null||T.setDisabled(!K),L==null||L.setDisabled(!K),I&&(I.disabled=!K),q(R,!K),q(E,!K),q(v,!K)};new N.Setting(h).setName("Docker/podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(F=>F.setPlaceholder("Docker").setValue(this.plugin.settings.dockerPath).onChange(async j=>{this.plugin.settings.dockerPath=j.trim()||"docker",await this.plugin.saveSettings()})),new N.Setting(h).setName("Advanced python runtime options").setDesc("Show legacy local interpreter/venv controls. Recommended to keep this disabled.").addToggle(F=>F.setValue(this.plugin.settings.showAdvancedPythonRuntimeOptions).onChange(async j=>{this.plugin.settings.showAdvancedPythonRuntimeOptions=j,!j&&this.plugin.settings.pythonRuntime==="local"&&(this.plugin.settings.pythonRuntime="worker",new N.Notice("Switched python runtime to worker mode.")),await this.plugin.saveSettings(),z()})),b=new N.Setting(h).setName("Python runtime").setDesc("Worker runtime is recommended. Enable advanced options to expose local interpreter/venv mode.").addDropdown(F=>{w=F,F.addOption("worker","Python worker container (recommended)"),F.addOption("local","Local interpreter/venv"),F.setValue(this.plugin.settings.pythonRuntime).onChange(async j=>{j!=="worker"&&j!=="local"||(this.plugin.settings.pythonRuntime=j,await this.plugin.saveSettings(),z())})}),R=new N.Setting(h).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(F=>(A=F,F.setPlaceholder("Auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async j=>{this.plugin.settings.pythonPath=j.trim(),await this.plugin.saveSettings()}))),E=new N.Setting(h).setName("Python environment").setDesc("Local mode: create or update the plugin's python env. Worker mode: managed by docker startup.").addButton(F=>{L=F,I=F.buttonEl,F.setButtonText("Create/update").setCta(),F.onClick(async()=>{F.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{F.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),v=new N.Setting(h).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(F=>{T=F,F.addOption("shared","Shared user cache"),F.addOption("plugin","Plugin folder (.venv)"),F.setValue(this.plugin.settings.pythonEnvLocation).onChange(async j=>{j!=="shared"&&j!=="plugin"||(this.plugin.settings.pythonEnvLocation=j,await this.plugin.saveSettings())})}),z(),new N.Setting(h).setName("Redis URL").addText(F=>F.setPlaceholder("Redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async j=>{this.plugin.settings.redisUrl=j.trim(),await this.plugin.saveSettings()}));let $=null,D=null,Z=null,V=null,B=()=>{let F=this.plugin.settings.autoAssignRedisPort;Z==null||Z.setDisabled(F),V==null||V.setDisabled(F),$==null||$.settingEl.classList.toggle("is-disabled",F),D==null||D.settingEl.classList.toggle("is-disabled",F)};new N.Setting(h).setName("Auto-assign redis port").setDesc("When starting redis stack, pick a free local port and update the redis URL.").addToggle(F=>F.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async j=>{this.plugin.settings.autoAssignRedisPort=j,await this.plugin.saveSettings(),B()})),$=new N.Setting(h).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(F=>(Z=F,F.setPlaceholder("~/redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async j=>{this.plugin.settings.redisDataDirOverride=j.trim(),await this.plugin.saveSettings()}))),$.settingEl.addClass("zrr-redis-override-setting"),D=new N.Setting(h).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(F=>(V=F,F.setPlaceholder("Zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async j=>{this.plugin.settings.redisProjectName=j.trim(),await this.plugin.saveSettings()}))),D.settingEl.addClass("zrr-redis-override-setting"),B(),new N.Setting(h).setName("Auto-start redis stack (docker/podman compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(F=>F.setValue(this.plugin.settings.autoStartRedis).onChange(async j=>{this.plugin.settings.autoStartRedis=j,await this.plugin.saveSettings()})),new N.Setting(h).setName("Start redis stack now").setDesc("Starts or restarts redis stack (and python worker in worker mode).").addButton(F=>F.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:h=>{new N.Setting(h).setName("Zotero local API").setHeading(),new N.Setting(h).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. HTTP://127.0.0.1:23119/API").addText(v=>v.setPlaceholder("HTTP://127.0.0.1:23119/API").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async A=>{this.plugin.settings.zoteroBaseUrl=A.trim(),await this.plugin.saveSettings()}));let b=new N.Setting(h).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),w=null,R=v=>{if(!w)return;let A=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(v.map(I=>I.value)).has(A)||(v=v.concat([{value:A,label:`Custom (${A})`}])),w.selectEl.options.length=0;for(let I of v)w.addOption(I.value,I.label);w.setValue(A)},E=async()=>{if(w){w.setDisabled(!0);try{let v=await this.plugin.fetchZoteroLibraryOptions();R(v)}finally{w.setDisabled(!1)}}};b.addDropdown(v=>{w=v;let A=(this.plugin.settings.zoteroUserId||"0").trim()||"0";v.addOption(A,"Loading..."),v.setValue(A),v.onChange(async T=>{this.plugin.settings.zoteroUserId=T.trim(),await this.plugin.saveSettings()})}),b.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await E()})}),E(),new N.Setting(h).setName("Zotero web API").setHeading(),new N.Setting(h).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(v=>v.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async A=>{this.plugin.settings.webApiBaseUrl=A.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API library type").setDesc("Library type for web API writes.").addDropdown(v=>v.addOption("user","User").addOption("group","Group").setValue(this.plugin.settings.webApiLibraryType).onChange(async A=>{this.plugin.settings.webApiLibraryType=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for web API writes.").addText(v=>v.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async A=>{this.plugin.settings.webApiLibraryId=A.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API key").setDesc("Zotero API key for write fallback (from Zotero.org).").addText(v=>{r(v),v.setPlaceholder("Your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async A=>{this.plugin.settings.webApiKey=A.trim(),await this.plugin.saveSettings()})}),new N.Setting(h).setName("Output").setHeading(),new N.Setting(h).setName("PDF folder").addText(v=>v.setPlaceholder("Zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async A=>{this.plugin.settings.outputPdfDir=A.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Notes folder").addText(v=>v.setPlaceholder("Zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async A=>{this.plugin.settings.outputNoteDir=A.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(v=>{v.setValue(this.plugin.settings.frontmatterTemplate).onChange(async A=>{this.plugin.settings.frontmatterTemplate=A,await this.plugin.saveSettings()}),v.inputEl.rows=10,v.inputEl.addClass("zrr-u-width-100")}),new N.Setting(h).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(v=>v.addOption("none","No change").addOption("camel","Camelcase").addOption("pascal","Pascalcase").addOption("snake","Snake_case").addOption("kebab","Kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async A=>{this.plugin.settings.tagSanitizeMode=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(v=>{v.setValue(this.plugin.settings.noteBodyTemplate).onChange(async A=>{this.plugin.settings.noteBodyTemplate=A,await this.plugin.saveSettings()}),v.inputEl.rows=8,v.inputEl.addClass("zrr-u-width-100")}),new N.Setting(h).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(v=>v.setPlaceholder("Zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async A=>{this.plugin.settings.chatOutputDir=A.trim()||"zotero/chats",await this.plugin.saveSettings()})),new N.Setting(h).setName("Copy pdfs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(v=>v.setValue(this.plugin.settings.copyPdfToVault).onChange(async A=>{this.plugin.settings.copyPdfToVault=A,!A&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new N.Setting(h).setName("Create ocr-layered PDF copy").setDesc("When ocr is used, replace the vault PDF with a tesseract text layer (requires copy pdfs into vault).").addToggle(v=>{let A=this.plugin.settings.copyPdfToVault;v.setValue(A?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!A).onChange(async T=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=T,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(v=>v.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async A=>{this.plugin.settings.preferObsidianNoteForCitations=A,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:h=>{new N.Setting(h).setName("Annotations").setHeading(),new N.Setting(h).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(E=>E.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async v=>{this.plugin.settings.annotationPageLabel=v.trim()||"Page",await this.plugin.saveSettings()})),new N.Setting(h).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(E=>E.setValue(this.plugin.settings.includeAnnotationImages).onChange(async v=>{this.plugin.settings.includeAnnotationImages=v,await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion").setHeading(),h.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new N.Setting(h).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(E=>E.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async v=>{this.plugin.settings.zoteroCompanionEnabled=v,await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(E=>E.setPlaceholder("HTTP://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async v=>{this.plugin.settings.zoteroCompanionBaseUrl=v.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(E=>{r(E),this.companionTokenInput=E,E.setPlaceholder("Optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async v=>{this.plugin.settings.zoteroCompanionToken=v.trim(),await this.plugin.saveSettings()})}),new N.Setting(h).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero companion plugin token to this value.").addButton(E=>E.setButtonText("Generate token").onClick(async()=>{let v=(0,jt.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=v,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(v);try{await navigator.clipboard.writeText(v),new N.Notice("Generated and copied companion token.")}catch(A){new N.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",A)}})),new N.Setting(h).setName("Annotation color map").setHeading(),h.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let b=h.createDiv({cls:"zrr-annotation-map"}),w=async E=>{this.plugin.settings.annotationColorMap=E,await this.plugin.saveSettings()},R=()=>{var L,q;b.empty();let E=this.plugin.settings.annotationColorMap||{},v=Object.entries(E);if(v.length||b.createEl("p",{text:"No color mappings configured."}),v.length){let M=b.createDiv({cls:"zrr-annotation-map-row-header"});M.createEl("span",{text:"Color"}),M.createEl("span",{text:"Heading"}),M.createEl("span",{text:"Callout"}),M.createEl("span")}for(let[M,z]of v){let D=b.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),Z=D.createEl("input",{type:"text",value:M,cls:"zrr-annotation-map-input"}),V=D.createEl("input",{type:"text",value:(L=z.heading)!=null?L:"",cls:"zrr-annotation-map-input"}),B=D.createEl("input",{type:"text",value:(q=z.callout)!=null?q:"",cls:"zrr-annotation-map-input"}),F=D.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});F.type="button",Z.addEventListener("change",()=>{(async()=>{let j=Z.value.trim().toLowerCase();if(!j){Z.value=M;return}let K={...this.plugin.settings.annotationColorMap||{}};if(j!==M&&K[j]){new N.Notice(`Annotation color '${j}' already exists.`),Z.value=M;return}let U=K[M];delete K[M],K[j]=U!=null?U:{heading:"",callout:""},await w(K),R()})()}),V.addEventListener("change",()=>{(async()=>{var U;let j={...this.plugin.settings.annotationColorMap||{}},K=(U=j[M])!=null?U:{heading:"",callout:""};K.heading=V.value.trim(),j[M]=K,await w(j)})()}),B.addEventListener("change",()=>{(async()=>{var U;let j={...this.plugin.settings.annotationColorMap||{}},K=(U=j[M])!=null?U:{heading:"",callout:""};K.callout=B.value.trim(),j[M]=K,await w(j)})()}),F.addEventListener("click",()=>{(async()=>{let j={...this.plugin.settings.annotationColorMap||{}};delete j[M],await w(j),R()})()})}let A=b.createDiv({cls:"zrr-annotation-map-actions"}),T=A.createEl("button",{text:"Add mapping"});T.type="button",T.addEventListener("click",()=>{(async()=>{let M={...this.plugin.settings.annotationColorMap||{}},z="new-color",$=1;for(;M[z];)z=`new-color-${$}`,$+=1;M[z]={heading:"",callout:""},await w(M),R()})()});let I=A.createEl("button",{text:"Reset to defaults"});I.type="button",I.addEventListener("click",()=>{(async()=>(await w({...Ge.annotationColorMap}),R()))()})};R()}},{id:"ocr",label:"OCR",render:h=>{new N.Setting(h).setName("Docling").setHeading();let b=null,w=A=>{if(!b)return;let T=this.plugin.settings.ocrEngine;new Set(A.map(L=>L.value)).has(T)||(A=A.concat([{value:T,label:`Current (unavailable): ${T}`}])),b.selectEl.options.length=0;for(let L of A)b.addOption(L.value,L.label);b.setValue(T)},R=async()=>{if(!b)return;b.setDisabled(!0);let A={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{A=await this.plugin.detectOcrEngines()}catch(L){A={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let T=[{value:"auto",label:"Auto (default)"}];A.tesseract&&T.push({value:"tesseract",label:"Tesseract (local)"}),A.paddleStructureLocal&&T.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),A.paddleVlLocal&&T.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(T.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),T.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),w(T),b.setDisabled(!1)},E=new N.Setting(h).setName("Paddle ocr API key").setDesc("API token for paddleocr-vl / pp-structurev3 endpoints. Get a free API key at "),v=document.createElement("a");v.href="https://aistudio.baidu.com/paddleocr",v.textContent="HTTPS://aistudio.baidu.com/paddleocr",v.target="_blank",v.rel="noopener noreferrer",E.descEl.appendChild(v),E.descEl.append("."),E.addText(A=>{r(A),A.setPlaceholder("Your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async T=>{this.plugin.settings.paddleApiKey=T.trim(),await this.plugin.saveSettings(),await R()})}),new N.Setting(h).setName("Paddleocr-vl API URL").setDesc("Optional override for the paddleocr-vl API endpoint.").addText(A=>A.setPlaceholder("HTTPS://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async T=>{this.plugin.settings.paddleVlApiUrl=T.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Pp-structurev3 API URL").setDesc("API endpoint for pp-structurev3 (see baidu AI studio docs).").addText(A=>A.setPlaceholder("HTTPS://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async T=>{this.plugin.settings.paddleStructureApiUrl=T.trim(),await this.plugin.saveSettings(),await R()})),new N.Setting(h).setName("Ocr engine").setDesc("Select the ocr engine to use when ocr is required.").addDropdown(A=>{b=A,A.addOption("auto","Auto (default)"),A.setValue(this.plugin.settings.ocrEngine),A.onChange(async T=>{this.plugin.settings.ocrEngine=T,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Ocr decision (when to ocr)").setDesc("Controls when ocr runs; per-page behavior is configured separately below.").addDropdown(A=>A.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","Ocr only if text is poor").addOption("force","Prefer ocr for full document").setValue(this.plugin.settings.ocrMode).onChange(async T=>{this.plugin.settings.ocrMode=T,await this.plugin.saveSettings()})),new N.Setting(h).setName("Ocr layout override (per-page)").setDesc("Force per-page ocr when ocr runs, bypassing layout heuristics; can be slower for multi-column pdfs.").addToggle(A=>A.setValue(this.plugin.settings.forcePerPageOcr).onChange(async T=>{this.plugin.settings.forcePerPageOcr=T,await this.plugin.saveSettings()})),new N.Setting(h).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(A=>{A.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async T=>{this.plugin.settings.ocrQualityThreshold=T,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Chunking").setDesc("Page or section").addDropdown(A=>A.addOption("page","Page").addOption("section","Section").setValue(this.plugin.settings.chunkingMode).onChange(async T=>{this.plugin.settings.chunkingMode=T,await this.plugin.saveSettings()})),R()}},{id:"llms",label:"LLMs",render:h=>{new N.Setting(h).setName("Model provider profiles").setHeading();let b=h.createDiv({cls:"zrr-llm-profiles"}),w=()=>{b.empty();let P=t();P.length||b.createEl("p",{text:"No profiles yet. Add one below."});for(let C of P){let O=b.createEl("details",{cls:"zrr-profile"});P.length===1&&(O.open=!0);let ne=O.createEl("summary",{text:C.name||C.id||"Profile"});ne.addClass("zrr-profile-title");let ze=O.createDiv({cls:"zrr-profile-body"});new N.Setting(ze).setName("Profile name").addText(ge=>ge.setPlaceholder("My provider").setValue(C.name||"").onChange(async fe=>{C.name=fe.trim(),ne.textContent=C.name||C.id||"Profile",await n(t())})),new N.Setting(ze).setName("Base URL").addText(ge=>ge.setPlaceholder("HTTP://localhost:1234/v1").setValue(C.baseUrl||"").onChange(async fe=>{C.baseUrl=fe.trim(),await n(t())})),new N.Setting(ze).setName("API key").setDesc("Stored in settings (not encrypted).").addText(ge=>{r(ge),ge.setPlaceholder("Sk-...").setValue(C.apiKey||"").onChange(async fe=>{C.apiKey=fe.trim(),await n(t())})}),new N.Setting(ze).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(ge=>ge.setButtonText("Delete profile").onClick(async()=>{let fe=t().filter(fn=>fn.id!==C.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===C.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===C.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===C.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(fe),w()}))}new N.Setting(b).addButton(C=>C.setButtonText("Add profile").onClick(async()=>{let O=`profile-${Date.now().toString(36)}`,ne=t().concat([{id:O,name:"Custom",baseUrl:"",apiKey:""}]);await n(ne),w()}))};w(),new N.Setting(h).setName("Ocr cleanup").setHeading(),new N.Setting(h).setName("Model cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor ocr at import. Can be slow/costly.").addToggle(P=>P.setValue(this.plugin.settings.enableLlmCleanup).onChange(async C=>{this.plugin.settings.enableLlmCleanup=C,await this.plugin.saveSettings()}));let R=null,E=null,v=null,A=()=>Promise.resolve(),T=async(P,C=!0)=>{let O=P.trim();this.plugin.settings.llmCleanupBaseUrl=O,C&&(this.plugin.settings.llmCleanupProviderProfileId="",R&&R.setValue("custom")),E&&E.setValue(O),await this.plugin.saveSettings()},I=async P=>{let C=t().find(O=>O.id===P);this.plugin.settings.llmCleanupProviderProfileId=P,C&&(this.plugin.settings.llmCleanupBaseUrl=C.baseUrl,this.plugin.settings.llmCleanupApiKey=C.apiKey,E==null||E.setValue(C.baseUrl),v==null||v.setValue(C.apiKey)),await this.plugin.saveSettings(),await A()};new N.Setting(h).setName("Cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{R=P,P.addOption("custom","Custom (manual)");for(let O of t())P.addOption(O.id,O.name||O.id);let C=this.plugin.settings.llmCleanupProviderProfileId;P.setValue(C&&t().some(O=>O.id===C)?C:"custom"),P.onChange(async O=>{if(O==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await I(O)})}),new N.Setting(h).setName("Cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. HTTP://127.0.0.1:1234/v1").addText(P=>{E=P,P.setPlaceholder("HTTP://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async C=>{await T(C)})}),new N.Setting(h).setName("Cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(P=>{v=P,r(P),P.setPlaceholder("Sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async C=>{this.plugin.settings.llmCleanupApiKey=C.trim(),this.plugin.settings.llmCleanupProviderProfileId="",R&&R.setValue("custom"),await this.plugin.saveSettings()})});let L=new N.Setting(h).setName("Cleanup model").setDesc("Select a cleanup-capable model from the provider."),q=null,M=P=>{if(!q)return;let C=(this.plugin.settings.llmCleanupModel||"").trim(),O=new Set(P.map(ne=>ne.value));C&&!O.has(C)&&(P=P.concat([{value:C,label:`Custom (${C})`}])),q.selectEl.options.length=0;for(let ne of P)q.addOption(ne.value,ne.label);C&&q.setValue(C)};A=async()=>{if(q){q.setDisabled(!0);try{let P=await this.plugin.fetchCleanupModelOptions();M(P)}finally{q.setDisabled(!1)}}},L.addDropdown(P=>{q=P;let C=(this.plugin.settings.llmCleanupModel||"").trim();P.addOption(C||"loading","Loading..."),P.setValue(C||"loading"),P.onChange(async O=>{this.plugin.settings.llmCleanupModel=O.trim(),await this.plugin.saveSettings()})}),L.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await A()})}),A(),new N.Setting(h).setName("Cleanup temperature").setDesc("Lower is more conservative.").addText(P=>P.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async C=>{let O=Number.parseFloat(C);this.plugin.settings.llmCleanupTemperature=Number.isFinite(O)?O:0,await this.plugin.saveSettings()})),new N.Setting(h).setName("Cleanup minimum quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(P=>P.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async C=>{this.plugin.settings.llmCleanupMinQuality=C,await this.plugin.saveSettings()})),new N.Setting(h).setName("Cleanup maximum chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(P=>P.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(O)?O:2e3,await this.plugin.saveSettings()})),new N.Setting(h).setName("Text embedding").setHeading();let z=null,$=null,D=null,Z=()=>Promise.resolve(),V=async(P,C=!0)=>{let O=P.trim();this.plugin.settings.embedBaseUrl=O,C&&(this.plugin.settings.embedProviderProfileId="",z&&z.setValue("custom")),$&&$.setValue(O),await this.plugin.saveSettings()},B=async P=>{let C=t().find(O=>O.id===P);this.plugin.settings.embedProviderProfileId=P,C&&(this.plugin.settings.embedBaseUrl=C.baseUrl,this.plugin.settings.embedApiKey=C.apiKey,$==null||$.setValue(C.baseUrl),D==null||D.setValue(C.apiKey)),await this.plugin.saveSettings(),await Z()};new N.Setting(h).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{z=P,P.addOption("custom","Custom (manual)");for(let O of t())P.addOption(O.id,O.name||O.id);let C=this.plugin.settings.embedProviderProfileId;P.setValue(C&&t().some(O=>O.id===C)?C:"custom"),P.onChange(async O=>{if(O==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await B(O)})}),new N.Setting(h).setName("Embeddings base URL").addText(P=>{$=P,P.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async C=>{await V(C)})}),new N.Setting(h).setName("Embeddings API key").addText(P=>{D=P,r(P),P.setPlaceholder("Lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async C=>{this.plugin.settings.embedApiKey=C.trim(),this.plugin.settings.embedProviderProfileId="",z&&z.setValue("custom"),await this.plugin.saveSettings()})});let F=new N.Setting(h).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),j=null,K=P=>{if(!j)return;let C=(this.plugin.settings.embedModel||"").trim(),O=new Set(P.map(ne=>ne.value));C&&!O.has(C)&&(P=P.concat([{value:C,label:`Custom (${C})`}])),j.selectEl.options.length=0;for(let ne of P)j.addOption(ne.value,ne.label);C&&j.setValue(C)};Z=async()=>{if(j){j.setDisabled(!0);try{let P=await this.plugin.fetchEmbeddingModelOptions();K(P)}finally{j.setDisabled(!1)}}},F.addDropdown(P=>{j=P;let C=(this.plugin.settings.embedModel||"").trim();P.addOption(C||"loading","Loading..."),P.setValue(C||"loading"),P.onChange(async O=>{this.plugin.settings.embedModel=O.trim(),await this.plugin.saveSettings()})}),F.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await Z()})}),Z(),new N.Setting(h).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(P=>P.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async C=>{this.plugin.settings.embedIncludeMetadata=C,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(P=>P.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.embedContextWindow=Number.isFinite(O)?Math.max(0,O):1,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(P=>P.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.embedContextChars=Number.isFinite(O)?Math.max(0,O):220,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(P=>P.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(O)?Math.max(0,O):3500,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(P=>P.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(O)?Math.max(0,O):200,await this.plugin.saveSettings()})),new N.Setting(h).setName("Generate model tags for chunks").setDesc("Use the ocr cleanup model to tag chunks before indexing.").addToggle(P=>P.setValue(this.plugin.settings.enableChunkTagging).onChange(async C=>{this.plugin.settings.enableChunkTagging=C,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat model").setHeading();let U=null,G=null,H=null,ae=()=>Promise.resolve(),Ae=async(P,C=!0)=>{let O=P.trim();this.plugin.settings.chatBaseUrl=O,C&&(this.plugin.settings.chatProviderProfileId="",U&&U.setValue("custom")),G&&G.setValue(O),await this.plugin.saveSettings()},dt=async P=>{let C=t().find(O=>O.id===P);this.plugin.settings.chatProviderProfileId=P,C&&(this.plugin.settings.chatBaseUrl=C.baseUrl,this.plugin.settings.chatApiKey=C.apiKey,G==null||G.setValue(C.baseUrl),H==null||H.setValue(C.apiKey)),await this.plugin.saveSettings(),await ae()};new N.Setting(h).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{U=P,P.addOption("custom","Custom (manual)");for(let O of t())P.addOption(O.id,O.name||O.id);let C=this.plugin.settings.chatProviderProfileId;P.setValue(C&&t().some(O=>O.id===C)?C:"custom"),P.onChange(async O=>{if(O==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await dt(O)})}),new N.Setting(h).setName("Chat base URL").setDesc("Compatible endpoint for chat requests.").addText(P=>{G=P,P.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async C=>{await Ae(C)})}),new N.Setting(h).setName("Chat API key").addText(P=>{H=P,r(P),P.setPlaceholder("Lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async C=>{this.plugin.settings.chatApiKey=C.trim(),this.plugin.settings.chatProviderProfileId="",U&&U.setValue("custom"),await this.plugin.saveSettings()})});let Me=new N.Setting(h).setName("Chat model").setDesc("Select a chat-capable model from the provider."),ce=null,pt=P=>{if(!ce)return;let C=(this.plugin.settings.chatModel||"").trim(),O=new Set(P.map(ne=>ne.value));C&&!O.has(C)&&(P=P.concat([{value:C,label:`Custom (${C})`}])),ce.selectEl.options.length=0;for(let ne of P)ce.addOption(ne.value,ne.label);C&&ce.setValue(C)};ae=async()=>{if(ce){ce.setDisabled(!0);try{let P=await this.plugin.fetchChatModelOptions();pt(P)}finally{ce.setDisabled(!1)}}},Me.addDropdown(P=>{ce=P;let C=(this.plugin.settings.chatModel||"").trim();P.addOption(C||"loading","Loading..."),P.setValue(C||"loading"),P.onChange(async O=>{this.plugin.settings.chatModel=O.trim(),await this.plugin.saveSettings()})}),Me.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await ae()})}),ae(),new N.Setting(h).setName("Temperature").addText(P=>P.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async C=>{let O=Number.parseFloat(C);this.plugin.settings.chatTemperature=Number.isFinite(O)?O:.2,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(P=>P.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(O)?Math.max(0,O):6,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(P=>P.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async C=>{this.plugin.settings.chatPaneLocation=C,await this.plugin.saveSettings()})),new N.Setting(h).setName("Retrieval").setHeading(),new N.Setting(h).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(P=>P.setValue(this.plugin.settings.enableAgenticRag).onChange(async C=>{this.plugin.settings.enableAgenticRag=C,await this.plugin.saveSettings()})),new N.Setting(h).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(P=>P.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.agenticMaxIters=Number.isFinite(O)?Math.max(1,O):2,await this.plugin.saveSettings()})),new N.Setting(h).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(P=>P.setValue(this.plugin.settings.enableQueryExpansion).onChange(async C=>{this.plugin.settings.enableQueryExpansion=C,await this.plugin.saveSettings()})),new N.Setting(h).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(P=>P.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.queryExpansionCount=Number.isFinite(O)?Math.max(1,O):3,await this.plugin.saveSettings()})),new N.Setting(h).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(P=>P.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async C=>{this.plugin.settings.enableCrossEncoderRerank=C,await this.plugin.saveSettings()}));let X=new Set(qt.map(P=>P.value)),Y=(this.plugin.settings.rerankModel||"").trim()||ke,ue=X.has(Y)?Y:Ee,se=null,At=()=>{if(!se)return;let C=!(ue===Ee);se.setDisabled(C),se.inputEl.disabled=C,se.inputEl.readOnly=C,se.inputEl.classList.toggle("is-disabled",C),se.inputEl.setAttribute("aria-disabled",String(C))},Rt=new N.Setting(h).setName("Cross-encoder model").setDesc("Choose a multilingual preset, or select custom to edit the model ID.");Rt.addDropdown(P=>{for(let C of qt)P.addOption(C.value,C.label);P.addOption(Ee,"Custom"),P.setValue(ue),P.onChange(async C=>{ue=C,C!==Ee?this.plugin.settings.rerankModel=C:(this.plugin.settings.rerankModel||"").trim()||(this.plugin.settings.rerankModel=ke),await this.plugin.saveSettings(),se==null||se.setValue(this.plugin.settings.rerankModel||ke),At()})}),Rt.addText(P=>{se=P,P.setPlaceholder(ke).setValue(Y).onChange(async C=>{ue===Ee&&(this.plugin.settings.rerankModel=C.trim()||ke,await this.plugin.saveSettings())}),At()}),new N.Setting(h).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 n candidates before reranking.").addText(P=>P.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(O)?Math.max(1,O):4,await this.plugin.saveSettings()})),new N.Setting(h).setName("Rrf k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(P=>P.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.rrfK=Number.isFinite(O)?Math.max(1,O):60,await this.plugin.saveSettings()})),new N.Setting(h).setName("Rrf log top n").setDesc("Log the top n rrf-ranked chunks to stderr (0 disables).").addText(P=>P.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.rrfLogTop=Number.isFinite(O)?Math.max(0,O):0,await this.plugin.saveSettings()})),new N.Setting(h).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(P=>P.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async C=>{let O=Number.parseInt(C,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(O)?Math.max(0,O):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:h=>{new N.Setting(h).setName("Python runtime").setHeading(),new N.Setting(h).setName("Use local runtime (legacy)").setDesc("Switch to local interpreter/venv mode and enable advanced runtime settings.").addButton(b=>b.setButtonText("Switch").onClick(async()=>{await this.plugin.switchPythonRuntimeToLocalLegacy()})),new N.Setting(h).setName("Logging").setHeading(),new N.Setting(h).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(b=>b.setValue(this.plugin.settings.enableFileLogging).onChange(async w=>{this.plugin.settings.enableFileLogging=w,await this.plugin.saveSettings()})),new N.Setting(h).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(b=>b.setPlaceholder(`${re}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async w=>{this.plugin.settings.logFilePath=w.trim()||`${re}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new N.Setting(h).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(b=>b.setButtonText("Open log").onClick(async()=>{var w,R;await((R=(w=this.plugin).openLogFile)==null?void 0:R.call(w))})).addButton(b=>b.setButtonText("Clear log").onClick(async()=>{var w,R;await((R=(w=this.plugin).clearLogFile)==null?void 0:R.call(w))})),new N.Setting(h).setName("Zotero companion plugin").setHeading(),h.createEl("p",{text:"Download the xpi, then in Zotero go to tools \u2192 add-ons \u2192 install from file and restart."}),new N.Setting(h).setName("Download companion add-on").setDesc("Downloads the companion xpi to your system downloads folder.").addButton(b=>b.setButtonText("Download xpi").onClick(async()=>{let w=this.getDefaultDownloadDir();if(!w){new N.Notice("Unable to resolve the system downloads folder.");return}let R=Ze.default.join(w,"zrr-companion.xpi");if(await this.companionXpiExists(R)){new N.Notice(`Companion XPI already exists: ${R}`);return}new N.Notice("Downloading companion xpi..."),await this.downloadCompanionXpi(R)})),new N.Setting(h).setName("Open Zotero").setDesc("Launch Zotero and open the add-ons window (tools \u2192 add-ons).").addButton(b=>b.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new N.Setting(h).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(b=>b.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),new N.Setting(h).setName("Redis indexing").setHeading(),new N.Setting(h).setName("Reindex redis from cached chunks").setDesc("Rebuild the redis index from cached chunk JSON files.").addButton(b=>b.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new N.Setting(h).setName("Recreate redis stack").setDesc("Pulls the configured redis image and force-recreates the redis-stack service.").addButton(b=>b.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateRedisStack()})),new N.Setting(h).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(b=>b.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(b=>b.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()})),new N.Setting(h).setName("Release notes").setHeading(),new N.Setting(h).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(b=>b.setButtonText("Show").onClick(()=>{this.plugin.openReleaseNotesModal()}))}}],p=new Map,u=new Map,g=h=>{this.activeTab=h;for(let[b,w]of p){let R=b===h;w.classList.toggle("is-active",R),w.setAttribute("aria-selected",R?"true":"false"),w.setAttribute("tabindex",R?"0":"-1")}for(let[b,w]of u){let R=b===h;w.classList.toggle("is-active",R),w.hidden=!R}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let x=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let h of d){let b=y.createEl("button",{text:h.label,cls:"zrr-settings-tab-button"}),w=`zrr-settings-tab-${h.id}`,R=`zrr-settings-panel-${h.id}`;b.type="button",b.id=w,b.setAttribute("role","tab"),b.setAttribute("aria-controls",R),b.setAttribute("aria-selected","false"),b.addEventListener("click",()=>g(h.id));let E=x.createDiv({cls:"zrr-settings-tab-panel"});E.id=R,E.setAttribute("role","tabpanel"),E.setAttribute("aria-labelledby",w),E.hidden=!0,h.render(E),p.set(h.id,b),u.set(h.id,E)}let k=d.some(h=>h.id===this.activeTab)?this.activeTab:d[0].id;g(k)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Ze.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await Ue.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await Ue.promises.mkdir(Ze.default.dirname(e),{recursive:!0});let t=await(0,N.requestUrl)({url:An,method:"GET"});if(t.status!==200){new N.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await Ue.promises.writeFile(e,n),new N.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new N.Notice("Failed to download companion xpi. See console for details."),console.warn("Failed to download companion XPI",t)}}};var Ut=require("@codemirror/state"),Zt=require("@codemirror/view"),pe=require("obsidian");var Rn=f=>{let _=f.scrollDOM.getBoundingClientRect(),e=f.posAtCoords({x:_.left+8,y:+_.height*.25});return e===null?null:f.state.doc.lineAt(e).number},Se=f=>!f||typeof f!="object"?null:f,We=class{constructor(_,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=_,this.helpers=e}createSyncExtension(){let _=this.helpers,e=this.syncPdfSidebarForDoc.bind(this);return Zt.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=_.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=_.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var p,u;let r=this.docId;if(!r)return;let i=Rn(t);if(i===null)return;let s=_.findChunkStartLineInDoc(t.state.doc,i);if(!s)return;let a=_.parseChunkMarkerLine(s.text),o=(p=a==null?void 0:a.pageNumber)!=null?p:null,l=(u=a==null?void 0:a.chunkId)!=null?u:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||d)||(this.lastPage=o,this.lastChunkId=l,e(r,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(_={}){if(!this.pendingPdfSync||!this.isPdfSidebarLeaf(this.pdfSidebarLeaf)&&!await this.getPdfSidebarLeaf(!!_.allowCreateLeaf)||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let e=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(e.docId,e.pageNumber,e.chunkId)}async revealPdfSidebar(_={}){let e=await this.getPdfSidebarLeaf(!!_.allowCreateLeaf);if(e)try{await this.deps.app.workspace.revealLeaf(e)}catch(t){console.warn("Failed to reveal PDF sidebar leaf",t)}}updatePreviewScrollHandler(){var n;let _=this.deps.app.workspace.getActiveViewOfType(pe.MarkdownView);if(!_||_.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=_.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(_);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(_)}async syncPdfSidebarForFile(_,e={}){try{let t=await this.deps.app.vault.read(_),n=await this.deps.resolveDocIdForNote(_,t);if(!n)return;let r=this.helpers.extractFirstChunkMarkerFromContent(t);await this.syncPdfSidebarForDoc(n,r==null?void 0:r.pageNumber,r==null?void 0:r.chunkId,e)}catch(t){console.warn("Failed to sync PDF sidebar for opened note",t)}}async syncPdfSidebarForDoc(_,e,t,n={}){if(_){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:_,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let r=await this.deps.getDocIndexEntry(_);r||(r=await this.deps.hydrateDocIndexFromCache(_));let i=r!=null&&r.pdf_path?String(r.pdf_path):"";if(!i)return;let s=this.deps.toVaultRelativePath(i);if(!s){let p=(0,pe.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(p)instanceof pe.TFile&&(s=p)}if(!s)return;let a=this.deps.app.vault.getAbstractFileByPath(s);if(!(a instanceof pe.TFile)||a.extension.toLowerCase()!=="pdf")return;let o=await this.getPdfSidebarLeaf(!!n.allowCreateLeaf);if(!o){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:t};return}if(!this.isLeafTabActive(o)&&!n.allowCreateLeaf){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:t};return}let l=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(l===null&&t&&(l=await this.resolvePageNumberForChunk(_,t)),l===null||this.isPdfSidebarLeaf(o)&&this.pdfSidebarLeaf===o&&this.pdfSidebarDocId===_&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===l)return;let c=s,d=l!==null?`${c}#page=${l}`:c;if(await this.openPdfLinkInLeaf(o,a,d),this.pdfSidebarLeaf=o,this.pdfSidebarDocId=_,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=l,this.updatePdfSidebarIcon(o),n.allowCreateLeaf&&!this.isLeafTabActive(o))try{await this.deps.app.workspace.revealLeaf(o)}catch(p){console.warn("Failed to reveal PDF sidebar leaf",p)}}finally{this.pdfSyncInFlight=!1;let r=this.queuedPdfSync;this.queuedPdfSync=null,r&&this.syncPdfSidebarForDoc(r.docId,r.pageNumber,r.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(_){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(_)}))}syncPdfSidebarForPreview(_){let e=this.previewScrollEl;if(!e)return;let t=_.getViewData();if(!t)return;let n=Ut.Text.of(t.split(/\r?\n/)),r=this.helpers.extractDocIdFromDoc(n);if(!r)return;let i=this.getPreviewTopLineNumber(e);if(i===null)return;let s=this.helpers.findChunkStartLineInDoc(n,i+1);if(!s)return;let a=this.helpers.parseChunkMarkerLine(s.text);!(a!=null&&a.pageNumber)&&!(a!=null&&a.chunkId)||this.syncPdfSidebarForDoc(r,a==null?void 0:a.pageNumber,a==null?void 0:a.chunkId)}getPreviewTopLineNumber(_){var n;let e=_.getBoundingClientRect().top,t=_.querySelectorAll("[data-line]");for(let r of Array.from(t))if(r.getBoundingClientRect().bottom>=e+2){let s=(n=r.getAttribute("data-line"))!=null?n:"",a=Number.parseInt(s,10);if(Number.isFinite(a))return a}return null}async getPdfSidebarLeaf(_=!1){if(this.pdfSidebarLeaf&&this.isUsableRightSidebarLeaf(this.pdfSidebarLeaf)&&this.isPdfSidebarLeaf(this.pdfSidebarLeaf))return this.pdfSidebarLeaf;this.resetPdfSidebarLeaf();let e=this.findRightSidebarPdfLeaf();if(e)return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;if(_){let t=this.deps.app.workspace;if(typeof t.ensureSideLeaf=="function")try{let r=await t.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!1});if(this.isUsableRightSidebarLeaf(r))return this.pdfSidebarLeaf=r,r.isDeferred&&await r.loadIfDeferred(),this.updatePdfSidebarIcon(r),r}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let n=this.deps.app.workspace.getRightLeaf(!1);if(this.isUsableRightSidebarLeaf(n))return this.pdfSidebarLeaf=n,n}return null}findRightSidebarPdfLeaf(){let _=this.deps.app.workspace;if(typeof _.iterateAllLeaves!="function")return null;let e=null;return _.iterateAllLeaves(t=>{if(!(!this.isUsableRightSidebarLeaf(t)||!this.isPdfSidebarLeaf(t))){if(this.isLeafTabActive(t)){e=t;return}e||(e=t)}}),e}resetPdfSidebarLeaf(){this.pdfSidebarLeaf=null,this.pdfSidebarDocId=null,this.pdfSidebarPdfPath=null,this.pdfSidebarPage=null}isUsableRightSidebarLeaf(_){var t;return this.isRightSidebarLeaf(_)?!!((t=_.containerEl)!=null&&t.isConnected):!1}getLeafViewType(_){var t,n;if(!_)return"";try{let r=_.getViewState();if(typeof(r==null?void 0:r.type)=="string"&&r.type)return r.type}catch(r){console.debug("Failed to read leaf view state",r)}let e=(n=(t=_.view)==null?void 0:t.getViewType)==null?void 0:n.call(t);return typeof e=="string"?e:""}isPdfSidebarLeaf(_){return this.getLeafViewType(_)==="pdf"}isRightSidebarLeaf(_){if(!_)return!1;let t=_.containerEl;return t?!!t.closest(".workspace-split.mod-right-split, .mod-right-split"):!1}updatePdfSidebarIcon(_){if(!_||!this.isRightSidebarLeaf(_)||!this.isPdfSidebarLeaf(_))return;let t=_.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let r=_;if(r.tabHeaderEl&&n.push(...Array.from(r.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),r.tabHeaderInnerIconEl&&n.push(r.tabHeaderInnerIconEl),n.length===0)return;let i=new Set;for(let a of n)if(!i.has(a)){if(i.add(a),a.replaceChildren(),(0,pe.setIcon)(a,"zrr-pdf"),!a.querySelector("svg")&&this.deps.iconSvg){let o=document.createRange().createContextualFragment(this.deps.iconSvg);a.replaceChildren(o)}a.dataset&&(a.dataset.zrrIcon="zrr-pdf")}let s=_.view;s.icon="zrr-pdf",typeof s.getIcon=="function"&&(s.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(_,e,t){var l;if(!await this.ensurePdfLeafReady(_,e)){await _.openFile(e,{active:!1});return}let r=Se((l=this.getPluginsRegistry())==null?void 0:l["pdf-plus"]),i=Se(r==null?void 0:r.lib),s=Se(i==null?void 0:i.workspace),a=typeof(s==null?void 0:s.openPDFLinkTextInLeaf)=="function"?s.openPDFLinkTextInLeaf:null;if(typeof a=="function")try{await a.call(s,_,t,"",{active:!1});return}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150)}let o=_;if(typeof o.openLinkText=="function"){try{await o.openLinkText(t,"",{active:!1})}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150),await o.openLinkText(t,"",{active:!1})}return}await _.openFile(e,{active:!1})}async ensurePdfLeafReady(_,e){if(this.isPdfSidebarLeaf(_))return!0;try{await _.setViewState({type:"pdf",active:!1})}catch(t){console.debug("Failed to set PDF view state on sidebar leaf",t)}if(_.isDeferred)try{await _.loadIfDeferred()}catch(t){console.debug("Failed to load deferred PDF sidebar leaf",t)}if(this.isPdfSidebarLeaf(_))return!0;try{await _.openFile(e,{active:!1})}catch(t){return console.warn("Failed to open PDF file in sidebar leaf",t),!1}return this.isPdfSidebarLeaf(_)}isPdfAnnotationRaceError(_){let e=_ instanceof Error?_.message:typeof _=="string"?_:"";return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(_){return new Promise(e=>setTimeout(e,_))}getPluginsRegistry(){var e;return(e=this.deps.app.plugins)==null?void 0:e.plugins}isLeafTabActive(_){var r;let e=_;if((r=e.parent)!=null&&r.activeLeaf)return e.parent.activeLeaf===_;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(_,e){var l,c,d,p,u;if(!_||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,_)||e,n=this.chunkPageCache.get(_);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let r=(0,pe.normalizePath)(`${Q}/${_}.json`);if(!await this.deps.app.vault.adapter.exists(r))return null;let s=Se(await this.deps.readChunkPayload(r)),a=Array.isArray(s==null?void 0:s.chunks)?s.chunks:[],o=new Map;for(let g of a){let y=Se(g),x=typeof(y==null?void 0:y.chunk_id)=="string"?y.chunk_id.trim():"";if(!x)continue;let k=Number.isFinite((c=y==null?void 0:y.page_start)!=null?c:NaN)?Number(y==null?void 0:y.page_start):null,h=Number.isFinite((d=y==null?void 0:y.page_end)!=null?d:NaN)?Number(y==null?void 0:y.page_end):null,b=k!=null?k:h;b!==null&&(o.set(x,b),o.set(`${_}:${x}`,b))}return this.chunkPageCache.set(_,o),(u=(p=o.get(t))!=null?p:o.get(e))!=null?u:null}};var He={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var be=require("@codemirror/state"),de=require("@codemirror/view"),J=require("obsidian");var W=f=>{if(typeof f=="string")return f.trim();if(typeof f=="number"&&Number.isFinite(f))return String(f);if(Array.isArray(f))for(let _ of f){if(typeof _=="string"&&_.trim())return _.trim();if(typeof _=="number"&&Number.isFinite(_))return String(_)}if(f&&typeof f=="object"){let _=f[0];if(typeof _=="string"&&_.trim())return _.trim();if(typeof _=="number"&&Number.isFinite(_))return String(_)}return""},Bt=f=>{let _=[f.key,f.itemKey,f.id,f.citationKey];for(let e of _)if(typeof e=="string"&&e.trim())return e.trim();return null},Gt=f=>{var e,t,n;let _=(n=(t=f.key)!=null?t:(e=f.data)==null?void 0:e.key)!=null?n:"";return typeof _=="string"?_:""},ft=f=>{if(!f)return"";let _=f.match(/\b(\d{4})\b/);return _?_[1]:""},Wt=f=>{var e,t,n,r;let _=(r=(n=(e=f.meta)==null?void 0:e.parsedDate)!=null?n:(t=f.data)==null?void 0:t.date)!=null?r:"";return typeof _!="string"?"":ft(_)},we=f=>{if(!f||typeof f!="object")return"";if(f.name)return String(f.name);let _=f.firstName?String(f.firstName):"",e=f.lastName?String(f.lastName):"";return[e,_].filter(Boolean).join(", ")||`${_} ${e}`.trim()},Ke=(f,_)=>{let e=[f.citationKey,f["citation-key"],f.citation_key,_==null?void 0:_.citationKey,_==null?void 0:_["citation-key"],_==null?void 0:_.citation_key,f.citationkey,f.citekey,f.citeKey,f.betterBibtexKey,f.betterbibtexkey,_==null?void 0:_.citationkey,_==null?void 0:_.citekey,_==null?void 0:_.citeKey,_==null?void 0:_.betterBibtexKey,_==null?void 0:_.betterbibtexkey];for(let r of e){let i=W(r);if(i)return i}let t=typeof f.extra=="string"?f.extra:"";if(!t)return"";let n=t.split(/\r?\n/);for(let r of n){let i=r.match(/^\s*biblatexcitekey\s*\[([^\]]+)\]\s*$/i);if(i&&i[1])return i[1].trim();let s=r.match(/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:\s*(.+)\s*$/i);if(s&&s[2])return s[2].trim()}return""},mt=f=>{if(!f)return"";let _=[f["citation-key"],f.citationKey,f.citationkey,f.citekey,f.citation_key];for(let e of _){let t=W(e);if(t)return t}return""},Ht=f=>{var e,t;if(!f)return"";let _=(t=(e=f["title-short"])!=null?e:f.shortTitle)!=null?t:f.short_title;return typeof _=="string"?_.trim():""},ve=f=>{let _=W(f.shortTitle);if(_)return _;let e=W(f.short_title);if(e)return e;let t=W(f["title-short"]);return t||""},Kt=f=>{let _=typeof f.extra=="string"?f.extra:"";if(!_)return"";let e=_.split(/\r?\n/);for(let n of e){let r=n.match(/^\s*doi\s*:\s*(.+)\s*$/i);if(r&&r[1])return r[1].trim().replace(/[.,;]+$/,"")}let t=_.match(/\b10\.\d{4,9}\/[-._;()/:A-Z0-9]+\b/i);return t?t[0].replace(/[.,;]+$/,""):""},Jt=f=>{var e;if(!f)return"";let _=(e=f.DOI)!=null?e:f.doi;return typeof _=="string"?_.trim().replace(/[.,;]+$/,""):""},En=f=>{if(!f)return[];let _=[f.attachments,f.children,f.items,f.attachment,f.allAttachments],e=[];for(let t of _)t&&(Array.isArray(t)?e.push(...t):typeof t=="object"&&e.push(t));return e},yt=f=>{var t,n,r,i,s,a,o,l,c,d,p,u,g,y,x;if(((a=(s=(r=(t=f==null?void 0:f.contentType)!=null?t:f==null?void 0:f.mimeType)!=null?r:(n=f==null?void 0:f.data)==null?void 0:n.contentType)!=null?s:(i=f==null?void 0:f.data)==null?void 0:i.mimeType)!=null?a:"")==="application/pdf")return!0;let e=(x=(y=(u=(p=(c=(o=f==null?void 0:f.filename)!=null?o:f==null?void 0:f.fileName)!=null?c:(l=f==null?void 0:f.data)==null?void 0:l.filename)!=null?p:(d=f==null?void 0:f.data)==null?void 0:d.fileName)!=null?u:f==null?void 0:f.path)!=null?y:(g=f==null?void 0:f.data)==null?void 0:g.path)!=null?x:"";return!!(typeof e=="string"&&e.toLowerCase().endsWith(".pdf"))},Xt=f=>{var t;let _=En(f.data);if(_.length>0)return _.some(r=>yt(r))?"yes":"no";let e=(t=f.meta)==null?void 0:t.numChildren;return typeof e=="number"&&e===0?"no":"unknown"};var Sn={artwork:"image",audioRecording:"music",bill:"file-text",blogPost:"globe",book:"book",bookSection:"book-open",case:"scale",computerProgram:"code",conferencePaper:"file-text",dataset:"database",dictionaryEntry:"book",document:"file-text",email:"mail",encyclopediaArticle:"book",film:"film",forumPost:"message-circle",hearing:"file-text",interview:"mic",journalArticle:"file-text",letter:"mail",magazineArticle:"file-text",manuscript:"file-text",map:"map",newspaperArticle:"file-text",patent:"award",podcast:"mic",preprint:"file-text",presentation:"file-text",radioBroadcast:"music",report:"file-text",statute:"scale",thesis:"graduation-cap",tvBroadcast:"film",videoRecording:"film",webpage:"globe"},Yt=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],Nn="https://github.com/jmiba/zotero-redisearch-rag/blob/main/CHANGELOG.md",Ln=f=>f.includes("STDERR")?"zrr-log-stderr":f.includes("ERROR")?"zrr-log-error":f.includes("WARNING")||f.includes("WARN")?"zrr-log-warning":f.includes("INFO")?"zrr-log-info":null,Qt=f=>{let _=new be.RangeSetBuilder;for(let{from:e,to:t}of f.visibleRanges){let n=e;for(;n<=t;){let r=f.state.doc.lineAt(n),i=Ln(r.text);i&&_.add(r.from,r.from,de.Decoration.line({class:i})),n=r.to+1}}return _.finish()},en=de.EditorView.theme({".cm-editor":{height:"100%",display:"flex",flexDirection:"column",minHeight:"0"},".cm-scroller":{fontFamily:"var(--font-monospace)",fontSize:"0.85rem",flex:"1",height:"100%",maxHeight:"100%",overflow:"auto"},".zrr-log-error":{color:"var(--text-error)"},".zrr-log-warning":{color:"var(--text-accent)"},".zrr-log-info":{color:"var(--text-muted)"},".zrr-log-stderr":{color:"var(--text-accent)"}}),tn=de.ViewPlugin.fromClass(class{constructor(f){this.decorations=Qt(f)}update(f){(f.docChanged||f.viewportChanged)&&(this.decorations=Qt(f.view))}},{decorations:f=>f.decorations}),Ne=class extends J.Modal{constructor(_,e,t,n,r="Value cannot be empty."){super(_),this.titleText=e,this.placeholder=t,this.onSubmit=n,this.emptyMessage=r}onOpen(){let{contentEl:_}=this;_.empty(),_.createEl("h3",{text:this.titleText});let e=_.createEl("input",{type:"text",placeholder:this.placeholder});e.addClass("zrr-u-width-100"),e.focus();let t=_.createEl("button",{text:"Submit"});t.addClass("zrr-u-margin-top-0-75rem");let n=()=>{let r=e.value.trim();if(!r){new J.Notice(this.emptyMessage);return}this.close(),this.onSubmit(r)};t.addEventListener("click",n),e.addEventListener("keydown",r=>{r.key==="Enter"&&n()})}},Le=class extends J.Modal{constructor(e,t,n){super(e);this.markdownComponent=null;this.version=t,this.markdown=n}onOpen(){var s;let{contentEl:e}=this;e.empty(),e.addClass("zrr-release-notes-modal"),e.createEl("h3",{text:"What's new"}),(s=this.markdownComponent)==null||s.unload(),this.markdownComponent=new J.Component,this.markdownComponent.load();let t=String(this.markdown||"").trim();if(t){let a=e.createDiv({cls:"zrr-release-notes-body"});J.MarkdownRenderer.render(this.app,t,a,"",this.markdownComponent)}else e.createEl("p",{text:"This version includes improvements and fixes."});let n=e.createDiv({cls:"zrr-release-notes-body"});J.MarkdownRenderer.render(this.app,`[Full changelog](${Nn})`,n,"",this.markdownComponent),e.createEl("div",{cls:"zrr-release-notes-actions"}).createEl("button",{text:"Close"}).addEventListener("click",()=>this.close())}onClose(){var e;(e=this.markdownComponent)==null||e.unload(),this.markdownComponent=null,this.contentEl.empty()}},Je=class extends J.Modal{constructor(_,e,t,n,r){super(_),this.chunkId=e,this.initialTags=t,this.onSubmit=n,this.onRegenerate=r}onOpen(){let{contentEl:_}=this;_.empty(),_.createEl("h3",{text:`Edit tags for ${this.chunkId}`});let e=_.createEl("textarea",{attr:{rows:"3"}});e.addClass("zrr-u-width-100"),e.placeholder="Tag1, tag2, tag3",e.value=this.initialTags.join(", "),e.focus();let t=_.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Save tags"}),r=async()=>{let s=(e.value||"").split(/[,;\n]+/).map(o=>o.trim()).filter(o=>o.length>0),a=Array.from(new Set(s));this.close(),await Promise.resolve(this.onSubmit(a))};if(this.onRegenerate){let i=t.createEl("button",{text:"Regenerate"});i.addEventListener("click",()=>{(async()=>{var s;i.setAttribute("disabled","true"),n.setAttribute("disabled","true");try{let a=await((s=this.onRegenerate)==null?void 0:s.call(this));a&&a.length>0?(e.value=a.join(", "),await Promise.resolve(this.onSubmit(a))):a&&new J.Notice("No tags were generated.")}finally{i.removeAttribute("disabled"),n.removeAttribute("disabled")}})()})}n.addEventListener("click",()=>{r()}),e.addEventListener("keydown",i=>{i.key==="Enter"&&(i.metaKey||i.ctrlKey)&&r()})}},Xe=class extends J.Modal{constructor(_,e,t,n=""){super(_),this.titleText=e,this.content=t,this.noteText=n}onOpen(){let{contentEl:_}=this;if(_.empty(),_.createEl("h3",{text:this.titleText}),this.noteText){let t=_.createEl("div",{text:this.noteText});t.className="zrr-indexed-note"}let e=_.createEl("textarea",{attr:{rows:"12",readonly:"true"}});e.addClass("zrr-u-width-100"),e.value=this.content}},Ye=class extends J.Modal{constructor(e,t,n=""){super(e);this.bodyText="";this.plugin=t,this.initialTerm=n}onOpen(){let{contentEl:e}=this;e.empty(),this.modalEl&&(this.modalEl.addClass("zrr-u-width-80vw"),this.modalEl.addClass("zrr-u-max-width-1200px"),this.modalEl.addClass("zrr-u-height-80vh"),this.modalEl.addClass("zrr-u-max-height-90vh"),this.modalEl.addClass("zrr-u-resize-both"),this.modalEl.addClass("zrr-u-overflow-hidden")),e.addClass("zrr-u-display-flex"),e.addClass("zrr-u-flex-direction-column"),e.addClass("zrr-u-height-100"),e.addClass("zrr-u-overflow-hidden"),e.addClass("zrr-u-min-height-0");let t=e.createDiv();t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-align-items-center"),t.addClass("zrr-u-justify-content-space-between"),t.addClass("zrr-u-gap-0-5rem"),t.createEl("h3",{text:"Redis index search"});let n=t.createEl("button",{text:"Copy all"});n.addClass("zrr-u-margin-left-auto"),n.addEventListener("click",()=>{this.copyResultsToClipboard()});let r=e.createDiv();r.addClass("zrr-u-display-flex"),r.addClass("zrr-u-align-items-center"),r.addClass("zrr-u-gap-0-5rem"),r.addClass("zrr-u-margin-0-5rem-0");let i=r.createEl("input");i.type="text",i.placeholder="Search term",i.value=this.initialTerm,i.addClass("zrr-u-flex-1"),i.addClass("zrr-u-min-width-0"),this.inputEl=i,r.createEl("button",{text:"Search"}).addEventListener("click",()=>{this.runSearch()}),i.addEventListener("keydown",c=>{c.key==="Enter"&&(c.preventDefault(),this.runSearch())});let a=e.createDiv();a.addClass("zrr-u-color-var-text-muted"),a.addClass("zrr-u-margin-bottom-0-5rem"),this.statusEl=a;let o=e.createDiv();o.addClass("zrr-u-flex-1-1-0"),o.addClass("zrr-u-min-height-0"),o.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),o.addClass("zrr-u-border-radius-6px"),o.addClass("zrr-u-display-flex"),o.addClass("zrr-u-flex-direction-column"),o.addClass("zrr-u-overflow-auto");let l=be.EditorState.create({doc:this.bodyText,extensions:[en,tn,de.EditorView.editable.of(!1),be.EditorState.readOnly.of(!0),de.EditorView.lineWrapping]});this.editorView=new de.EditorView({state:l,parent:o}),this.initialTerm&&this.runSearch()}onClose(){var e;(e=this.editorView)==null||e.destroy(),this.editorView=void 0}async runSearch(){var n;let e=(((n=this.inputEl)==null?void 0:n.value)||"").trim();if(!e){this.statusEl&&(this.statusEl.textContent="Enter a search term.");return}this.statusEl&&(this.statusEl.textContent="Searching...");let t=await this.plugin.runRedisSearch(e);this.updateEditor(t),this.statusEl&&(this.statusEl.textContent=`Results for "${e}"`)}updateEditor(e){if(!this.editorView)return;let t=this.editorView,n=t.scrollDOM.scrollTop,r=t.state.selection.main,i=e.length,s=Math.min(r.anchor,i),a=Math.min(r.head,i);t.dispatch({changes:{from:0,to:t.state.doc.length,insert:e},selection:{anchor:s,head:a}}),t.scrollDOM.scrollTop=n,this.bodyText=e}copyResultsToClipboard(){let e=this.bodyText||"";if(!e){new J.Notice("Nothing to copy.");return}navigator.clipboard.writeText(e).then(()=>new J.Notice("Results copied to clipboard.")).catch(()=>new J.Notice("Failed to copy results."))}},Pe=class extends J.Modal{constructor(_,e,t,n){super(_),this.titleText=e,this.bodyText=t,this.options=n}onOpen(){var i,s,a,o;let{contentEl:_}=this;_.empty(),this.modalEl&&(this.modalEl.addClass("zrr-u-width-80vw"),this.modalEl.addClass("zrr-u-max-width-1200px"),this.modalEl.addClass("zrr-u-height-80vh"),this.modalEl.addClass("zrr-u-max-height-90vh"),this.modalEl.addClass("zrr-u-resize-both"),this.modalEl.addClass("zrr-u-overflow-hidden")),_.addClass("zrr-u-display-flex"),_.addClass("zrr-u-flex-direction-column"),_.addClass("zrr-u-height-100"),_.addClass("zrr-u-overflow-hidden"),_.addClass("zrr-u-min-height-0");let e=_.createDiv();e.addClass("zrr-u-display-flex"),e.addClass("zrr-u-align-items-center"),e.addClass("zrr-u-justify-content-space-between"),e.addClass("zrr-u-gap-0-5rem"),e.createEl("h3",{text:this.titleText});let t=e.createDiv();if(t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),(i=this.options)!=null&&i.onClear){let l=(s=this.options.clearLabel)!=null?s:"Clear log";t.createEl("button",{text:l}).addEventListener("click",()=>{(async()=>{var d,p;try{await((p=(d=this.options)==null?void 0:d.onClear)==null?void 0:p.call(d))}finally{await this.refreshFromSource()}})()})}let n=_.createDiv();n.addClass("zrr-u-flex-1-1-0"),n.addClass("zrr-u-min-height-0"),n.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),n.addClass("zrr-u-border-radius-6px"),n.addClass("zrr-u-display-flex"),n.addClass("zrr-u-flex-direction-column"),n.addClass("zrr-u-overflow-auto");let r=be.EditorState.create({doc:this.bodyText,extensions:[en,tn,de.EditorView.editable.of(!0),be.EditorState.readOnly.of(!1),de.EditorView.lineWrapping]});if(this.editorView=new de.EditorView({state:r,parent:n}),this.refreshFromSource(),(a=this.options)!=null&&a.autoRefresh&&this.options.onRefresh){let l=(o=this.options.refreshIntervalMs)!=null?o:2e3;this.refreshTimer=window.setInterval(()=>{this.refreshFromSource()},l)}}onClose(){var _;this.refreshTimer!==void 0&&(window.clearInterval(this.refreshTimer),this.refreshTimer=void 0),(_=this.editorView)==null||_.destroy(),this.editorView=void 0}async refreshFromSource(){var a;if(!((a=this.options)!=null&&a.onRefresh)||!this.editorView)return;let _="";try{_=await this.options.onRefresh()||""}catch(o){return}if(_===this.bodyText)return;let e=this.editorView,t=e.scrollDOM.scrollTop,n=e.state.selection.main,r=_.length,i=Math.min(n.anchor,r),s=Math.min(n.head,r);e.dispatch({changes:{from:0,to:e.state.doc.length,insert:_},selection:{anchor:i,head:s}}),e.scrollDOM.scrollTop=t,this.bodyText=_}},Qe=class extends J.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.filePath=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),r=t.createEl("button",{text:"Overwrite"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),r.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},et=class extends J.Modal{constructor(e,t,n,r){super(e);this.resolved=!1;this.notePath=t,this.docId=n,this.onResolve=r}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete note and cached data?"}),e.createEl("p",{text:`This will delete the note and cached chunks/items for doc_id ${this.docId}.`}),e.createEl("p",{text:`Note: ${this.notePath}`});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),r=t.createEl("button",{text:"Delete"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),r.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},tt=class extends J.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.reason=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Rebuild redis index?"}),e.createEl("p",{text:this.reason}),e.createEl("p",{text:"This will drop the redissearch index (and embeddings) and rebuild it from cached chunks."});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),r=t.createEl("button",{text:"Drop & rebuild"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),r.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},nt=class extends J.Modal{constructor(e,t){super(e);this.resolved=!1;this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Purge redis orphaned chunks?"}),e.createEl("p",{text:"This removes redis chunk keys that have no cached item.json or chunk files on disk."}),e.createEl("p",{text:"Cache files are not deleted. Use this to clean up stale redis data."});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),r=t.createEl("button",{text:"Purge orphans"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),r.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},rt=class extends J.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve metadata conflicts"}),e.createEl("p",{text:"Choose which values to keep for each field."});let t=e.createEl("div");t.addClass("zrr-u-display-grid"),t.addClass("zrr-u-gap-0-75rem");for(let l of this.conflicts){let c=t.createEl("div");c.addClass("zrr-u-display-grid"),c.addClass("zrr-u-gap-0-4rem"),c.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),c.addClass("zrr-u-border-radius-6px"),c.addClass("zrr-u-padding-0-6rem"),c.createEl("div",{text:l.fieldLabel,cls:"zrr-font-semibold"});let d=c.createEl("div");d.addClass("zrr-u-display-grid"),d.addClass("zrr-u-grid-template-columns-1fr-1fr"),d.addClass("zrr-u-gap-0-5rem");let p=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});p.addClass("zrr-u-width-100"),p.value=l.noteValue||"(empty)";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});u.addClass("zrr-u-width-100"),u.value=l.zoteroValue||"(empty)";let g=c.createEl("div");g.addClass("zrr-u-display-flex"),g.addClass("zrr-u-gap-0-5rem"),g.addClass("zrr-u-align-items-center"),g.createEl("span",{text:"Decision:"});let y=g.createEl("select");y.add(new Option(l.noteLabel,"note")),y.add(new Option(l.zoteroLabel,"zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.field,y)}let n=e.createEl("div");n.addClass("zrr-u-display-flex"),n.addClass("zrr-u-flex-wrap-wrap"),n.addClass("zrr-u-gap-0-5rem"),n.addClass("zrr-u-margin-top-0-75rem");let r=l=>{for(let c of this.selects.values())c.value=l},i=n.createEl("button",{text:"Use note for all"}),s=n.createEl("button",{text:"Use Zotero for all"}),a=n.createEl("button",{text:"Skip all"}),o=n.createEl("button",{text:"Apply"});i.addEventListener("click",()=>r("note")),s.addEventListener("click",()=>r("zotero")),a.addEventListener("click",()=>r("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[t,n]of this.selects.entries())e[t]=n.value||"skip";this.onResolve(e)}}},it=class extends J.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve annotation conflicts"}),e.createEl("p",{text:"Choose which version to keep for each annotation."});let t=e.createEl("div");t.addClass("zrr-u-display-grid"),t.addClass("zrr-u-gap-0-75rem");for(let l of this.conflicts){let c=t.createEl("div");c.addClass("zrr-u-display-grid"),c.addClass("zrr-u-gap-0-4rem"),c.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),c.addClass("zrr-u-border-radius-6px"),c.addClass("zrr-u-padding-0-6rem"),c.createEl("div",{text:l.title,cls:"zrr-font-semibold"});let d=c.createEl("div");d.addClass("zrr-u-display-grid"),d.addClass("zrr-u-grid-template-columns-1fr-1fr"),d.addClass("zrr-u-gap-0-5rem");let p=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});p.addClass("zrr-u-width-100"),p.value=l.noteValue||"(empty)";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});u.addClass("zrr-u-width-100"),u.value=l.zoteroValue||"(empty)";let g=c.createEl("div");g.addClass("zrr-u-display-flex"),g.addClass("zrr-u-gap-0-5rem"),g.addClass("zrr-u-align-items-center"),g.createEl("span",{text:"Decision:"});let y=g.createEl("select");y.add(new Option("Use note","note")),y.add(new Option("Use Zotero","zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.key,y)}let n=e.createEl("div");n.addClass("zrr-u-display-flex"),n.addClass("zrr-u-flex-wrap-wrap"),n.addClass("zrr-u-gap-0-5rem"),n.addClass("zrr-u-margin-top-0-75rem");let r=l=>{for(let c of this.selects.values())c.value=l},i=n.createEl("button",{text:"Use note for all"}),s=n.createEl("button",{text:"Use Zotero for all"}),a=n.createEl("button",{text:"Skip all"}),o=n.createEl("button",{text:"Apply"});i.addEventListener("click",()=>r("note")),s.addEventListener("click",()=>r("zotero")),a.addEventListener("click",()=>r("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[t,n]of this.selects.entries())e[t]=n.value||"skip";this.onResolve(e)}}},at=class extends J.SuggestModal{constructor(e,t){super(e);this.resolved=!1;this.resolveSelection=t,this.setPlaceholder("Select a language for ocr/quality...")}getSuggestions(e){let t=e.trim().toLowerCase();return t?Yt.filter(n=>n.label.toLowerCase().includes(t)||n.value.toLowerCase().includes(t)):Yt}renderSuggestion(e,t){t.setText(e.label),t.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new Ne(this.app,"Custom language hint","e.g., en, de, fr, de,en",t=>this.resolveSelection(t.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},st=class extends J.SuggestModal{constructor(e,t,n){super(e);this.lastError=null;this.indexedDocIds=null;this.querySequence=0;this.queryDebounceMs=200;this.minQueryLength=2;this.maxQueryCacheEntries=100;this.queryCache=new Map;this.plugin=t,this.resolveSelection=n,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){let t=e.trim();if(t.length>0&&t.length<this.minQueryLength)return[];let n=t.toLowerCase(),r=this.queryCache.get(n);if(r)return r;let i=++this.querySequence;try{if(await new Promise(a=>{window.setTimeout(a,this.queryDebounceMs)}),i!==this.querySequence)return[];if(!this.indexedDocIds){let a=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(a))}let s=await this.plugin.searchZoteroItems(t);if(i!==this.querySequence)return[];if(this.queryCache.set(n,s),this.queryCache.size>this.maxQueryCacheEntries){let a=this.queryCache.keys().next().value;a!==void 0&&this.queryCache.delete(a)}return s}catch(s){let a=s instanceof Error?s.message:String(s);return this.lastError!==a&&(this.lastError=a,new J.Notice(a)),console.error("Zotero search failed",s),[]}}renderSuggestion(e,t){var x,k,h,b,w;let n=(k=(x=e.data)==null?void 0:x.title)!=null?k:"[No title]",r=Wt(e),i=Gt(e),s=i?(h=this.indexedDocIds)==null?void 0:h.has(i):!1,a=Xt(e),o=typeof((b=e.data)==null?void 0:b.itemType)=="string"?e.data.itemType.trim():"";s&&t.addClass("zrr-indexed-item"),a==="no"&&t.addClass("zrr-no-pdf-item");let l=t.createDiv({cls:"zrr-zotero-suggest-row"}),c=l.createSpan({cls:"zrr-zotero-item-icon"}),d=(w=Sn[o])!=null?w:"file-text";(0,J.setIcon)(c,d);let p=l.createDiv({cls:"zrr-zotero-suggest-text"});p.createEl("div",{text:n,cls:"zrr-zotero-suggest-title"});let u=p.createEl("small",{cls:"zrr-zotero-suggest-meta"}),g=!1,y=()=>{g&&u.createSpan({text:" - "})};r&&(u.createSpan({text:r}),g=!0),s&&(y(),u.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),g=!0),a==="no"&&(y(),u.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),g=!0),t.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,t){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}};var nn={"docling_extract.py":`#!/usr/bin/env python3
# zotero-redisearch-rag tool version: 0.9.18
import argparse
import atexit
import base64
import errno
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.18
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.18
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.18
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.18
...
`,"redis-stack.conf":`# zotero-redisearch-rag tool version: 0.9.18
# Redis Stack persistence config for local RAG index
appendonly yes
appendfsync everysec

dir /data
`};var bt=require("url"),Te=async(f,_,e)=>{let t=Tn(f);if(t)return t;try{let n=await e.fetchZoteroChildren(_);for(let r of n){let i=an(r);if(i)return i}}catch(n){console.error("Failed to fetch Zotero children",n)}return null},Tn=f=>{let _=Dn(f);for(let e of _){let t=an(e);if(t)return t}return null},Dn=f=>{let _=[f.attachments,f.children,f.items,f.attachment,f.allAttachments],e=[];for(let t of _)t&&(Array.isArray(t)?e.push(...t):typeof t=="object"&&e.push(t));return e},an=f=>{var n,r,i,s,a,o;if(((i=(n=f==null?void 0:f.contentType)!=null?n:f==null?void 0:f.mimeType)!=null?i:(r=f==null?void 0:f.data)==null?void 0:r.contentType)!=="application/pdf")return null;let e=(o=(s=f==null?void 0:f.key)!=null?s:f==null?void 0:f.attachmentKey)!=null?o:(a=f==null?void 0:f.data)==null?void 0:a.key;if(!e)return null;let t=On(f);return t?{key:e,filePath:t}:{key:e}},On=f=>{var e,t,n,r,i,s,a,o;let _=(o=(r=(t=(e=f==null?void 0:f.links)==null?void 0:e.enclosure)==null?void 0:t.href)!=null?r:(n=f==null?void 0:f.enclosure)==null?void 0:n.href)!=null?o:(a=(s=(i=f==null?void 0:f.data)==null?void 0:i.links)==null?void 0:s.enclosure)==null?void 0:a.href;if(typeof _=="string"&&_.startsWith("file://"))try{return(0,bt.fileURLToPath)(_)}catch(l){return null}return null},rn=async(f,_)=>{if(f.statusCode<300||f.statusCode>=400)return null;let e=f.headers.location,t=Array.isArray(e)?e[0]:e;if(!t||typeof t!="string")return null;if(t.startsWith("file://")){let n=(0,bt.fileURLToPath)(t);return _.readFile(n)}return t.startsWith("http://")||t.startsWith("https://")?_.requestLocalApi(t):null},ot=async(f,_)=>{let e=_.buildZoteroUrl(`/${_.getZoteroLibraryPath()}/items/${f}/file`);try{let t=await _.requestLocalApiRaw(e),n=await rn(t,_);if(n)return n;if(t.statusCode>=300)throw new Error(`Request failed, status ${t.statusCode}`);return t.body}catch(t){if(console.warn("Failed to download PDF from local API",t),!_.canUseWebApi())throw t;let n=_.buildWebApiUrl(`/${_.getWebApiLibraryPath()}/items/${f}/file`),r=await _.requestWebApiRaw(n),i=await rn(r,_);if(i)return i;if(r.statusCode>=300)throw new Error(`Web API request failed, status ${r.statusCode}`);return r.body}};var te=require("obsidian"),Ce="zotero-redisearch-rag-chat",De=class extends te.ItemView{constructor(e,t){super(e);this.messages=[];this.activeSessionId="default";this.messageEls=new Map;this.pendingRender=new Map;this.pendingThinking=new Set;this.busy=!1;this.cancelPending=!1;this.plugin=t}getViewType(){return Ce}getDisplayText(){return"Zotero research assistant chat"}getIcon(){return"zrr-chat"}async onOpen(){let{containerEl:e}=this;e.empty(),e.addClass("zrr-chat-view");let t=e.createEl("div",{cls:"zrr-chat-header"});t.createEl("div",{cls:"zrr-chat-title",text:"Zotero research assistant chat"});let n=t.createEl("div",{cls:"zrr-chat-controls"}),r=n.createEl("div",{cls:"zrr-chat-controls-row"});this.sessionSelect=r.createEl("select",{cls:"zrr-chat-session"}),this.sessionSelect.addEventListener("change",()=>{this.switchSession(this.sessionSelect.value)});let i=n.createEl("div",{cls:"zrr-chat-controls-row zrr-chat-controls-actions"});this.renameButton=i.createEl("button",{cls:"zrr-chat-rename",text:"Rename",attr:{title:"Rename the current chat"}}),this.renameButton.addEventListener("click",()=>{this.promptRenameSession()}),this.copyButton=i.createEl("button",{cls:"zrr-chat-copy",text:"Copy",attr:{title:"Copy this chat to a new note"}}),this.copyButton.addEventListener("click",()=>{this.copyChatToNote()}),this.deleteButton=i.createEl("button",{cls:"zrr-chat-delete",text:"Delete",attr:{title:"Delete this chat"}}),this.deleteButton.addEventListener("click",()=>{this.deleteChat()}),this.newButton=i.createEl("button",{cls:"zrr-chat-new",text:"New chat",attr:{title:"Start a new chat session"}}),this.newButton.addEventListener("click",()=>{this.startNewChat()}),this.messagesEl=e.createEl("div",{cls:"zrr-chat-messages"});let s=e.createEl("div",{cls:"zrr-chat-input"});this.inputEl=s.createEl("textarea",{cls:"zrr-chat-textarea",attr:{placeholder:"Ask your Zotero library..."}}),this.sendButton=s.createEl("button",{cls:"zrr-chat-send",attr:{"aria-label":"Send message",title:"Send message"}}),this.updateSendButtonState(),this.sendButton.addEventListener("click",()=>{this.handleSendButtonClick()}),this.inputEl.addEventListener("keydown",a=>{a.key==="Enter"&&!a.shiftKey&&(a.preventDefault(),this.busy||this.handleSend())}),await this.loadSessions(),await this.loadHistory(),await this.renderAll()}focusInput(){var e;(e=this.inputEl)==null||e.focus()}async loadHistory(){try{this.messages=await this.plugin.loadChatHistoryForSession(this.activeSessionId)}catch(e){console.error(e),this.messages=[]}}async saveHistory(){try{await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages),await this.loadSessions()}catch(e){console.error(e)}}async loadSessions(){let e=await this.plugin.listChatSessions();this.activeSessionId=await this.plugin.getActiveChatSessionId(),this.sessionSelect.empty();for(let t of e){let n=this.sessionSelect.createEl("option",{text:t.name});n.value=t.id,t.id===this.activeSessionId&&(n.selected=!0)}!e.some(t=>t.id===this.activeSessionId)&&e.length>0&&(this.activeSessionId=e[0].id,await this.plugin.setActiveChatSessionId(this.activeSessionId),this.sessionSelect.value=this.activeSessionId)}async promptRenameSession(){var r;let t=(await this.plugin.listChatSessions()).find(i=>i.id===this.activeSessionId);new xt(this.app,(r=t==null?void 0:t.name)!=null?r:"New chat",async i=>{await this.plugin.renameChatSession(this.activeSessionId,i),await this.loadSessions()}).open()}async startNewChat(){await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages,{force:!0});let e=await this.plugin.createChatSession("New chat");await this.switchSession(e,{skipSave:!0})}async deleteChat(){let e=await this.plugin.listChatSessions();if(e.length<=1){new te.Notice("You must keep at least one chat.");return}let t=e.find(r=>r.id===this.activeSessionId);if(!t)return;new kt(this.app,t.name,async()=>{await this.plugin.deleteChatSession(this.activeSessionId);let r=await this.plugin.getActiveChatSessionId();await this.switchSession(r,{skipSave:!0})}).open()}async switchSession(e,t={}){!e||e===this.activeSessionId||(t.skipSave||await this.saveHistory(),this.activeSessionId=e,await this.plugin.setActiveChatSessionId(e),await this.loadSessions(),await this.loadHistory(),await this.renderAll())}async renderAll(){this.messagesEl.empty(),this.messageEls.clear();let e=new Set(this.messages.map(t=>t.id));for(let t of Array.from(this.pendingThinking))e.has(t)||this.pendingThinking.delete(t);for(let t of this.messages)await this.renderMessage(t);this.scrollToBottom()}async renderMessage(e){let t=this.messagesEl.createEl("div",{cls:`zrr-chat-message zrr-chat-${e.role}`}),n=t.createEl("div",{cls:"zrr-chat-meta-row"});n.createEl("div",{cls:"zrr-chat-meta"}).setText(e.role==="user"?"You":"Zotero Assistant");let i=n.createEl("div",{cls:"zrr-chat-message-actions"}),s=i.createEl("button",{cls:"zrr-chat-message-copy zrr-chat-icon-button",attr:{title:"Copy this message","aria-label":"Copy this message"}});(0,te.setIcon)(s,"copy"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.copyMessage(e)});let a=i.createEl("button",{cls:"zrr-chat-message-delete zrr-chat-icon-button",attr:{title:"Delete this message","aria-label":"Delete this message"}});(0,te.setIcon)(a,"trash-2"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.deleteMessage(e.id)});let o=t.createEl("div",{cls:"zrr-chat-content"}),l=t.createEl("div",{cls:"zrr-chat-citations"});this.messageEls.set(e.id,{wrapper:t,content:o,citations:l}),await this.renderMessageContent(e)}async copyMessage(e){var r,i,s;let n=(await this.plugin.formatInlineCitations(e.content||"",(r=e.citations)!=null?r:[],(i=e.retrieved)!=null?i:[])||"").trim();if(!n){new te.Notice("Nothing to copy.");return}if(!((s=navigator.clipboard)!=null&&s.writeText)){new te.Notice("Clipboard API unavailable. Select text to copy.");return}try{await navigator.clipboard.writeText(n),new te.Notice("Message copied to clipboard.")}catch(a){console.error("Failed to copy message",a),new te.Notice("Failed to copy message.")}}async deleteMessage(e){let t=this.messages.findIndex(s=>s.id===e);if(t===-1||!await this.confirmDeleteMessage())return;this.messages.splice(t,1);let r=this.messageEls.get(e);r&&r.wrapper.remove(),this.messageEls.delete(e);let i=this.pendingRender.get(e);i!==void 0&&(window.clearTimeout(i),this.pendingRender.delete(e)),this.pendingThinking.delete(e),await this.saveHistory()}async confirmDeleteMessage(){return new Promise(e=>{new wt(this.app,e).open()})}scheduleRender(e){if(this.pendingRender.has(e.id))return;let t=window.setTimeout(()=>{this.pendingRender.delete(e.id),this.renderMessageContent(e).then(()=>{this.scrollToBottom()})},80);this.pendingRender.set(e.id,t)}async renderMessageContent(e){var i,s,a;let t=this.messageEls.get(e.id);if(!t)return;if(e.role==="assistant"&&!e.content.trim()&&this.pendingThinking.has(e.id)){t.content.dataset.lastRendered!=="__thinking__"&&(t.content.empty(),this.renderThinkingIndicator(t.content),t.content.dataset.lastRendered="__thinking__"),t.citations.empty();return}let r=await this.plugin.formatInlineCitations(e.content||"",(i=e.citations)!=null?i:[],(s=e.retrieved)!=null?s:[]);t.content.dataset.lastRendered!==r&&(t.content.empty(),await te.MarkdownRenderer.render(this.app,r,t.content,"",this),this.hookInternalLinks(t.content),t.content.dataset.lastRendered=r),t.citations.empty(),await this.renderCitations(t.citations,(a=e.citations)!=null?a:[])}renderThinkingIndicator(e){let t=e.createEl("div",{cls:"zrr-chat-thinking"});t.setAttr("role","status"),t.setAttr("aria-live","polite"),t.createEl("span",{cls:"zrr-chat-thinking-spinner"}),t.createEl("span",{cls:"zrr-chat-thinking-text",text:"Thinking"});let n=t.createEl("span",{cls:"zrr-chat-thinking-dots"});n.createEl("span"),n.createEl("span"),n.createEl("span")}hookInternalLinks(e){let t=e.querySelectorAll("a.internal-link");for(let n of Array.from(t))n.dataset.zrrBound!=="1"&&(n.dataset.zrrBound="1",this.registerDomEvent(n,"click",r=>{r.preventDefault();let i=n.getAttribute("data-href")||n.getAttribute("href")||"";i&&this.plugin.openInternalLinkInMain(i)}))}async renderCitations(e,t){if(e.empty(),!t.length)return;let n=e.createEl("details",{cls:"zrr-chat-citations-details"});n.createEl("summary",{text:`Relevant context sources (${t.length})`,cls:"zrr-chat-citations-summary"});let r=n.createEl("ul",{cls:"zrr-chat-citation-list"});for(let i of t){let s=await this.plugin.resolveCitationDisplay(i),a=r.createEl("li"),o=`${s.noteTitle} p. ${s.pageLabel}`;a.createEl("a",{text:o,href:"#"}).addEventListener("click",c=>{c.preventDefault(),this.plugin.openCitationTarget(i,s)}),i.annotation_key&&a.createEl("span",{text:"Annotation",cls:"zrr-chat-citation-badge"})}}async copyChatToNote(){var r;let t=(await this.plugin.listChatSessions()).find(i=>i.id===this.activeSessionId),n=(r=t==null?void 0:t.name)!=null?r:"New chat";await this.plugin.createChatNoteFromSession(this.activeSessionId,n,this.messages)}scrollToBottom(){this.messagesEl.scrollTop=this.messagesEl.scrollHeight}updateSendButtonState(){if(this.sendButton){if(this.busy){this.sendButton.disabled=this.cancelPending,(0,te.setIcon)(this.sendButton,this.cancelPending?"loader-2":"square"),this.sendButton.setAttr("aria-label",this.cancelPending?"Canceling...":"Cancel response"),this.sendButton.setAttr("title",this.cancelPending?"Canceling...":"Cancel response");return}this.sendButton.disabled=!1,(0,te.setIcon)(this.sendButton,"send"),this.sendButton.setAttr("aria-label","Send message"),this.sendButton.setAttr("title","Send message")}}isCancellationError(e){let n=(e instanceof Error?e.message:typeof e=="string"?e:"").toLowerCase();return n.includes("request canceled")||n.includes("request cancelled")||n.includes("request aborted")||n.includes("python worker request aborted")||n.includes("client_disconnected")}async handleSendButtonClick(){if(this.busy){if(this.cancelPending)return;this.cancelPending=!0,this.updateSendButtonState(),this.plugin.cancelActiveRagQuery()||(this.cancelPending=!1,this.updateSendButtonState());return}await this.handleSend()}async handleSend(){if(this.busy)return;let e=this.inputEl.value.trim();if(!e){new te.Notice("Query cannot be empty.");return}if(!this.plugin.settings.chatBaseUrl){new te.Notice("Chat base URL must be set in settings.");return}this.inputEl.value="",this.busy=!0,this.cancelPending=!1,this.updateSendButtonState();let t={id:this.generateId(),role:"user",content:e,createdAt:new Date().toISOString()};this.messages.push(t),await this.renderMessage(t),this.scrollToBottom(),await this.saveHistory();let n={id:this.generateId(),role:"assistant",content:"",citations:[],createdAt:new Date().toISOString()};this.messages.push(n),this.pendingThinking.add(n.id),await this.renderMessage(n),this.scrollToBottom();let r=!1,i=!1,s=this.plugin.getRecentChatHistory(this.messages.slice(0,-2));try{await this.plugin.runRagQueryStreaming(e,a=>{this.pendingThinking.delete(n.id),r=!0,n.content+=a,this.scheduleRender(n)},a=>{if(this.pendingThinking.delete(n.id),a!=null&&a.canceled){i=!0,!r&&!n.content.trim()&&(n.content=typeof(a==null?void 0:a.answer)=="string"&&a.answer.trim()?a.answer:"Request canceled."),this.scheduleRender(n);return}(!r&&(a!=null&&a.answer)||a!=null&&a.answer)&&(n.content=a.answer),Array.isArray(a==null?void 0:a.citations)&&(n.citations=a.citations),Array.isArray(a==null?void 0:a.retrieved)&&(n.retrieved=a.retrieved),this.scheduleRender(n)},s)}catch(a){console.error(a),this.pendingThinking.delete(n.id),i||this.isCancellationError(a)?!r&&!n.content.trim()&&(n.content="Request canceled."):n.content="Failed to fetch answer. See console for details.",this.scheduleRender(n)}finally{this.pendingThinking.delete(n.id),this.busy=!1,this.cancelPending=!1,this.updateSendButtonState(),await this.saveHistory()}}generateId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}},xt=class extends te.Modal{constructor(_,e,t){super(_),this.initialValue=e,this.onSubmit=t}onOpen(){let{contentEl:_}=this;_.empty(),_.addClass("zrr-chat-rename-modal"),_.createEl("h3",{text:"Rename chat"});let e=this.initialValue;new te.Setting(_).setName("Name").addText(i=>{i.setValue(e),i.onChange(s=>{e=s})});let t=_.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-1rem"),t.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),t.createEl("button",{text:"Save"}).addEventListener("click",()=>{let i=e.trim();if(!i){new te.Notice("Name cannot be empty.");return}this.close(),Promise.resolve(this.onSubmit(i))})}},kt=class extends te.Modal{constructor(_,e,t){super(_),this.chatName=e,this.onConfirm=t}onOpen(){let{contentEl:_}=this;_.empty(),_.createEl("h3",{text:"Delete chat"}),_.createEl("p",{text:`Delete "${this.chatName}"? This cannot be undone.`});let e=_.createEl("div");e.addClass("zrr-u-display-flex"),e.addClass("zrr-u-gap-0-5rem"),e.addClass("zrr-u-margin-top-1rem"),e.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),e.createEl("button",{text:"Delete"}).addEventListener("click",()=>{this.close(),Promise.resolve(this.onConfirm())})}},wt=class extends te.Modal{constructor(e,t){super(e);this.resolved=!1;this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete message"}),e.createEl("p",{text:"Delete this message? This cannot be undone."});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-1rem"),t.createEl("button",{text:"Cancel"}).addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),t.createEl("button",{text:"Delete"}).addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}};var vt=[{version:"0.9.18",markdown:`- Replace the bundled Redis image with \`redis/redis-stack:7.4.0-v8\` so new and recreated local stacks include Redis Insight.
...
`).trim();let s=i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),a=n[r].replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/[*_`]/g,"").trim();if(!new RegExp(`^#{0,6}\\s*v?${s}(?:\\b|\\s|\\(|-)`,"i").test(a))return n.join(`
`).replace(/\n{3,}/g,`

`).trim();for(n.splice(r,1);r<n.length&&n[r].trim().length===0;)n.splice(r,1);return r<n.length&&/^[-=]{3,}\s*$/.test(n[r].trim())&&n.splice(r,1),n.join(`
`).replace(/\n{3,}/g,`

`).trim()}getBundledReleaseNotesEntries(){var r,i;let e=new Set,t=Array.isArray(vt)?vt:[],n=[];for(let s of t){let a=this.normalizeReleaseVersion(String((r=s==null?void 0:s.version)!=null?r:"")),o=this.sanitizeReleaseNotesMarkdown(String((i=s==null?void 0:s.markdown)!=null?i:""));!a||e.has(a)||(e.add(a),n.push({version:a,markdown:o}))}return n.sort((s,a)=>this.compareReleaseVersions(a.version,s.version))}getReleaseNotesMarkdown(e,t){let n=this.normalizeReleaseVersion(e);if(!n)return"";let r=this.normalizeReleaseVersion(t||""),i=this.getBundledReleaseNotesEntries(),s=i.filter(o=>this.compareReleaseVersions(o.version,n)>0?!1:r?this.compareReleaseVersions(o.version,r)>0:o.version===n),a=s.length?s:i.filter(o=>o.version===n);if(!a.length)return"This version includes improvements and fixes.";if(a.length===1){let o=a[0],l=this.stripLeadingVersionHeading(this.sanitizeReleaseNotesMarkdown(String(o.markdown||"")),o.version);return`### v${o.version}

${l||"This release includes improvements and fixes."}`}return a.map(o=>{let l=this.stripLeadingVersionHeading(this.sanitizeReleaseNotesMarkdown(String(o.markdown||"")),o.version)||"This release includes improvements and fixes.";return`### v${o.version}

${l}`}).join(`

`)}async importZoteroItem(){var A,T,I;try{await this.ensureBundledTools()}catch(L){new m.Notice("Failed to sync bundled tools. See console for details."),console.error(L);return}if(!await this.warnIfZoteroLocalApiUnavailable("import")&&!this.canUseWebApi())return;let t;try{t=await this.promptZoteroItem()}catch(L){new m.Notice("Zotero search failed. See console for details."),console.error(L);return}if(!t){new m.Notice("No Zotero item selected.");return}let n=(A=t.data)!=null?A:t;!n.key&&t.key&&(n.key=t.key);let r=Bt(n);if(!r){new m.Notice("Could not resolve a stable doc_ID from Zotero item.");return}let i=await this.resolveLanguageHint(n,(T=t.key)!=null?T:n.key),s=this.buildDoclingLanguageHint(i!=null?i:void 0),a=await Te(n,r,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});if(!a){new m.Notice("No PDF attachment found for item.");return}if(this.showStatusProgress("Preparing...",5),!await this.ensureRedisAvailable("import")){this.clearStatusProgress();return}let o=typeof n.title=="string"?n.title:"",l=await this.getDocIndexEntry(r);l&&new m.Notice("Item already indexed. Updating cached files and index.");let c=this.sanitizeFileName(o)||r;if(l!=null&&l.note_path)c=this.sanitizeFileName(S.default.basename(l.note_path,".md"))||c;else if(l!=null&&l.pdf_path){let L=this.toVaultRelativePath(l.pdf_path);L&&L.startsWith((0,m.normalizePath)(this.settings.outputPdfDir))&&(c=this.sanitizeFileName(S.default.basename(L,".pdf"))||c)}let d=l?c:await this.resolveUniqueBaseName(c,r),p=(0,m.normalizePath)(`${this.settings.outputPdfDir}/${d}.pdf`),u=(0,m.normalizePath)(`${le}/${r}.json`),g=(0,m.normalizePath)(`${Q}/${r}.json`),y=this.app.vault.adapter,x=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${d}.md`);if(l!=null&&l.note_path&&await y.exists(l.note_path)&&(x=(0,m.normalizePath)(l.note_path)),await y.exists(x)&&!await this.confirmOverwrite(x)){new m.Notice("Import canceled.");return}try{if(await this.ensureFolder(le),await this.ensureFolder(Q),await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let L=this.getLogFileRelativePath(),q=(0,m.normalizePath)(S.default.dirname(L));q&&await this.ensureFolder(q),await this.deleteLogFileIfExists();let M=this.getSpellcheckerInfoRelativePath(),z=(0,m.normalizePath)(S.default.dirname(M));z&&await this.ensureFolder(z)}}catch(L){new m.Notice("Failed to create output folders."),console.error(L),this.clearStatusProgress();return}let k="",h="";try{if(this.settings.copyPdfToVault){let L=a.filePath?await ee.promises.readFile(a.filePath):await ot(a.key,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:ee.promises.readFile});await this.app.vault.adapter.writeBinary(p,this.bufferToArrayBuffer(L)),k=this.getAbsoluteVaultPath(p)}else if(a.filePath)k=a.filePath;else{await this.ensureFolder(this.settings.outputPdfDir);let L=await ot(a.key,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:ee.promises.readFile});await this.app.vault.adapter.writeBinary(p,this.bufferToArrayBuffer(L)),k=this.getAbsoluteVaultPath(p),new m.Notice("Local PDF path unavailable; copied PDF into vault for processing.")}h=this.buildPdfLinkForNote(k,a.key,r)}catch(L){new m.Notice("Failed to download PDF attachment."),console.error(L),this.clearStatusProgress();return}try{await this.app.vault.adapter.write(u,JSON.stringify(t,null,2))}catch(L){new m.Notice("Failed to write Zotero item JSON."),console.error(L),this.clearStatusProgress();return}let b=this.getPluginDir(),w=S.default.join(b,"tools","docling_extract.py"),R=S.default.join(b,"tools","index_redisearch.py"),E=null;try{this.showStatusProgress(this.formatStatusLabel("Docling extraction...",E),0);let L=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(w,await this.buildDoclingArgs(k,r,g,x,s,!0),z=>this.handleDoclingProgress(z,E),()=>{},L),E=await this.readDoclingQualityLabel(g),await this.annotateChunkJsonWithAttachmentKey(g,a.key);let q=await this.readDoclingMetadata(g),M=await this.maybeCreateOcrLayeredPdf(k,q,s);M&&(k=M,h=this.buildPdfLinkFromSourcePath(M),await this.updateChunkJsonSourcePdf(g,M))}catch(L){new m.Notice("Docling extraction failed. See console for details."),console.error(L),this.clearStatusProgress();return}let v=!1;try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",E),0);let L=["--chunks-json",this.getAbsoluteVaultPath(g),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--progress"];this.appendEmbedSubchunkArgs(L),this.appendEmbedContextArgs(L),this.settings.embedIncludeMetadata&&L.push("--embed-include-metadata"),this.appendChunkTaggingArgs(L),await this.runPythonStreaming(R,L,q=>{let M=this.asRecord(q),z=typeof(M==null?void 0:M.total)=="number"?M.total:0,$=typeof(M==null?void 0:M.current)=="number"?M.current:0;if((M==null?void 0:M.type)==="progress"&&z>0){let D=Math.round($/z*100),Z=typeof M.message=="string"&&M.message.trim()?M.message:`Indexing chunks ${$}/${z}`,V=this.formatStatusLabel(Z,E);this.showStatusProgress(V,D)}},()=>{})}catch(L){let q=this.getPythonErrorMessage(L),M=this.classifyIndexingError(q);if(console.error(L),M==="embed_dim_mismatch")if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema. Switch to a model with matching dimensions, or drop/rebuild the index."))try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){this.clearStatusProgress(),this.lastReindexFailure==="embed_failure"?new m.Notice("Embedding provider error detected while rebuilding the Redis index. Fix the provider/model settings and retry import."):new m.Notice("Redis index rebuild did not complete. Import stopped.");return}new m.Notice("Redis index rebuilt; resuming import."),v=!0}catch($){this.clearStatusProgress(),new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error($);return}else{this.clearStatusProgress(),new m.Notice("Indexing aborted due to embedding dimension mismatch. Switch models or drop/rebuild the index.");return}if(!v){if(M==="embed_failure"){this.clearStatusProgress(),new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.");return}this.clearStatusProgress(),new m.Notice("Redissearch indexing failed. See console for details.");return}}try{let L=await this.app.vault.adapter.read(x),q=await this.readChunkPayload(g),M=this.buildSyncedDoclingContent(r,q,L),z=await this.buildNoteMarkdown(n,(I=t.meta)!=null?I:{},r,h,a.key,x,u,M);await this.writeNoteWithSyncSuppressed(x,z);let $=this.app.vault.getAbstractFileByPath(x);$ instanceof m.TFile&&this.scheduleNoteAnnotationSync($,2e3,"save")}catch(L){new m.Notice("Failed to finalize note Markdown."),console.error(L),this.clearStatusProgress();return}try{let L=ve(n);await this.updateDocIndex({doc_id:r,note_path:x,note_title:d,zotero_title:o,short_title:L||void 0,pdf_path:k,attachment_key:a.key});let q=this.app.vault.getAbstractFileByPath(x);q instanceof m.TFile&&(this.pdfSidebar.syncPdfSidebarForFile(q),this.pdfSidebar.maybeSyncPendingPdf())}catch(L){console.error("Failed to update doc index",L)}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice(`Indexed Zotero item ${r}.`)}async askZoteroLibrary(){await this.openChatView(!0)}getCurrentMarkdownFile(){let e=this.app.workspace.getActiveViewOfType(m.MarkdownView),t=e==null?void 0:e.file;if(t instanceof m.TFile&&t.extension==="md")return t;let n=this.app.workspace.getActiveFile();if(n instanceof m.TFile&&n.extension==="md")return n;let r=this.app.workspace.getMostRecentLeaf(this.app.workspace.rootSplit),i=r==null?void 0:r.view;if(i instanceof m.MarkdownView){let o=i.file;if(o instanceof m.TFile&&o.extension==="md")return o}let s=this.app.workspace.getLeavesOfType("markdown")[0],a=s==null?void 0:s.view;if(a instanceof m.MarkdownView){let o=a.file;if(o instanceof m.TFile&&o.extension==="md")return o}return null}async syncPdfSidebarForActiveNote(e={}){let t=this.getCurrentMarkdownFile();if(!(t instanceof m.TFile)||t.extension!=="md"){new m.Notice("Open a Markdown note first.");return}await this.pdfSidebar.syncPdfSidebarForFile(t,{allowCreateLeaf:!0}),await this.pdfSidebar.maybeSyncPendingPdf({allowCreateLeaf:!0}),e.revealSidebar&&await this.pdfSidebar.revealPdfSidebar({allowCreateLeaf:!0})}getChatLeaf(){var t;let e=this.app.workspace.getLeavesOfType(Ce);return e.length>0?e[0]:this.settings.chatPaneLocation==="right"?(t=this.app.workspace.getRightLeaf(!1))!=null?t:this.app.workspace.getLeaf("split"):this.app.workspace.getLeaf("tab")}async openChatView(e=!1){let t=this.getChatLeaf();await t.setViewState({type:Ce,active:!0}),await this.app.workspace.revealLeaf(t);let n=t.view;return n instanceof De&&e&&n.focusInput(),n}async loadChatHistory(){let e=await this.getActiveChatSessionId();return this.loadChatHistoryForSession(e)}async saveChatHistory(e){let t=await this.getActiveChatSessionId();await this.saveChatHistoryForSession(t,e)}getChatSessionsDir(){return(0,m.normalizePath)(`${re}/chats`)}getChatExportDir(){let e=(this.settings.chatOutputDir||"").trim();return e?(0,m.normalizePath)(e):(0,m.normalizePath)("zotero/chats")}getChatSessionsIndexPath(){return(0,m.normalizePath)(`${this.getChatSessionsDir()}/index.json`)}getChatSessionPath(e){return(0,m.normalizePath)(`${this.getChatSessionsDir()}/${e}.json`)}async listChatSessions(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,t=this.getChatSessionsIndexPath();if(!await e.exists(t)){let n=new Date().toISOString(),r=[{id:"default",name:"New chat",createdAt:n,updatedAt:n}];return await this.writeChatSessionsIndex({version:1,active:"default",sessions:r}),r}try{let n=await e.read(t),r=this.asRecord(JSON.parse(n));return(Array.isArray(r==null?void 0:r.sessions)?r.sessions:[]).filter(s=>!!(this.asRecord(s)&&typeof s.id=="string")).map(s=>{let a=typeof s.id=="string"?s.id:"";return{id:a,name:typeof s.name=="string"&&s.name.trim()?s.name.trim():a,createdAt:typeof s.createdAt=="string"?s.createdAt:new Date().toISOString(),updatedAt:typeof s.updatedAt=="string"?s.updatedAt:new Date().toISOString()}})}catch(n){return console.warn("Failed to read chat sessions index",n),[]}}async getActiveChatSessionId(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,t=this.getChatSessionsIndexPath();if(!await e.exists(t))return"default";try{let n=await e.read(t),r=JSON.parse(n);return(typeof(r==null?void 0:r.active)=="string"?r.active:"default")||"default"}catch(n){return"default"}}async setActiveChatSessionId(e){var s,a;await this.migrateLegacyChatHistory();let t=await this.readChatSessionsIndex(),n=((s=t.sessions)!=null?s:[]).some(o=>o.id===e),r=new Date().toISOString(),i=n?t.sessions:[...(a=t.sessions)!=null?a:[],{id:e,name:e,createdAt:r,updatedAt:r}];await this.writeChatSessionsIndex({version:1,active:e,sessions:i})}async createChatSession(e){var a;await this.migrateLegacyChatHistory();let t=this.generateChatId(),n=new Date().toISOString(),r=(e||"").trim()||"New chat",s=[...(a=(await this.readChatSessionsIndex()).sessions)!=null?a:[],{id:t,name:r,createdAt:n,updatedAt:n}];return await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionPath(t),JSON.stringify({version:1,messages:[]},null,2)),await this.writeChatSessionsIndex({version:1,active:t,sessions:s}),t}async renameChatSession(e,t){var s,a;await this.migrateLegacyChatHistory();let n=(t||"").trim();if(!n)return;let r=await this.readChatSessionsIndex(),i=((s=r.sessions)!=null?s:[]).map(o=>o.id===e?{...o,name:n}:o);await this.writeChatSessionsIndex({version:1,active:(a=r.active)!=null?a:"default",sessions:i})}async deleteChatSession(e){var a;if(await this.migrateLegacyChatHistory(),!e)return;let t=this.app.vault.adapter,n=await this.readChatSessionsIndex(),r=(a=n.sessions)!=null?a:[];if(r.length<=1)return;let i=r.filter(o=>o.id!==e);if(!i.length)return;let s=n.active===e?i[0].id:n.active;try{await t.remove(this.getChatSessionPath(e))}catch(o){console.warn("Failed to delete chat session file",o)}await this.writeChatSessionsIndex({version:1,active:s,sessions:i})}async loadChatHistoryForSession(e){await this.migrateLegacyChatHistory();let t=this.app.vault.adapter,n=this.getChatSessionPath(e||"default");if(!await t.exists(n))return[];let r=await t.read(n),i;try{i=JSON.parse(r)}catch(o){return[]}let s=this.asRecord(i),a=Array.isArray(i)?i:Array.isArray(s==null?void 0:s.messages)?s.messages:[];return Array.isArray(a)?a.filter(o=>!!(this.asRecord(o)&&typeof o.content=="string")).map(o=>({id:typeof o.id=="string"?o.id:this.generateChatId(),role:o.role==="assistant"?"assistant":"user",content:typeof o.content=="string"?o.content:"",citations:Array.isArray(o.citations)?o.citations:[],retrieved:Array.isArray(o.retrieved)?o.retrieved:[],createdAt:typeof o.createdAt=="string"?o.createdAt:new Date().toISOString()})):[]}async saveChatHistoryForSession(e,t){var l,c;await this.migrateLegacyChatHistory(),await this.ensureFolder(this.getChatSessionsDir());let n=this.app.vault.adapter,r=this.getChatSessionPath(e||"default"),i={version:1,messages:t};await n.write(r,JSON.stringify(i,null,2));let s=await this.readChatSessionsIndex(),a=new Date().toISOString(),o=((l=s.sessions)!=null?l:[]).map(d=>d.id===e?{...d,updatedAt:a}:d);await this.writeChatSessionsIndex({version:1,active:(c=s.active)!=null?c:e,sessions:o})}getRecentChatHistory(e){let t=Math.max(0,this.settings.chatHistoryMessages||0);return t?e.filter(r=>{var i;return r&&((i=r.content)==null?void 0:i.trim())}).slice(-t):[]}async readChatSessionsIndex(){let e=this.app.vault.adapter,t=this.getChatSessionsIndexPath(),n=new Date().toISOString();if(!await e.exists(t))return{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:n,updatedAt:n}]};try{let r=await e.read(t),i=this.asRecord(JSON.parse(r)),s=Array.isArray(i==null?void 0:i.sessions)?i.sessions:[];return{version:1,active:typeof(i==null?void 0:i.active)=="string"?i.active:"default",sessions:s.map(a=>this.asRecord(a)).filter(a=>!!a).map(a=>{let o=typeof a.id=="string"?a.id:"";return{id:o,name:typeof a.name=="string"&&a.name.trim()?a.name.trim():o,createdAt:typeof a.createdAt=="string"?a.createdAt:n,updatedAt:typeof a.updatedAt=="string"?a.updatedAt:n}})}}catch(r){return console.warn("Failed to parse chat sessions index",r),{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:n,updatedAt:n}]}}}async writeChatSessionsIndex(e){await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionsIndexPath(),JSON.stringify(e,null,2))}async migrateLegacyChatHistory(){let e=this.app.vault.adapter,t=(0,m.normalizePath)(`${re}/chat.json`),n=this.getChatSessionsDir(),r=this.getChatSessionsIndexPath(),i=this.getChatSessionPath("default"),s=await e.exists(t),a=await e.exists(i),o=await e.exists(r);if(!s&&o)return;let l=new Date().toISOString();if(await this.ensureFolder(n),s&&!a)try{await e.rename(t,i)}catch(c){try{let d=await e.read(t);await e.write(i,d),await e.remove(t)}catch(d){console.warn("Failed to migrate legacy chat history",d)}}if(!o){let c=[{id:"default",name:"New chat",createdAt:l,updatedAt:l}];await this.writeChatSessionsIndex({version:1,active:"default",sessions:c})}if(o)try{let c=await e.read(r),d=this.asRecord(JSON.parse(c)),p=Array.isArray(d==null?void 0:d.sessions)?d.sessions:[],u=p.some(y=>{let x=this.asRecord(y);return(x==null?void 0:x.id)==="default"}),g=p.map(y=>this.asRecord(y)).filter(y=>!!y).map(y=>y.id==="default"&&typeof y.name=="string"&&y.name.trim().toLowerCase()==="default"?{...y,name:"New chat"}:y);u&&JSON.stringify(g)!==JSON.stringify(p)&&await this.writeChatSessionsIndex({version:1,active:typeof(d==null?void 0:d.active)=="string"?d.active:"default",sessions:g.map(y=>({id:typeof y.id=="string"?y.id:"",name:typeof y.name=="string"?y.name:"New chat",createdAt:typeof y.createdAt=="string"?y.createdAt:l,updatedAt:typeof y.updatedAt=="string"?y.updatedAt:l}))})}catch(c){}}isPlaceholderChatName(e){let t=(e||"").trim().toLowerCase();return t==="new chat"||t==="default"}normalizeChatTitle(e){let t=(e||"").replace(/\s+/g," ").trim();return t.length>60?`${t.slice(0,57)}...`:t}guessTitleFromMessages(e){let t=e.find(r=>r.role==="user"&&r.content.trim());if(!t)return"New chat";let n=t.content.replace(/\s+/g," ").trim().split(" ").slice(0,8).join(" ");return this.normalizeChatTitle(n||"New chat")}async suggestChatTitleWithLlm(e){var s,a,o;let t=(this.settings.chatBaseUrl||"").trim(),n=(this.settings.chatModel||"").trim();if(!t||!n)return null;let r=t.replace(/\/$/,"");if(r.toLowerCase().includes("api.openai.com")&&(!this.settings.chatApiKey||n.includes("/")))return null;try{let l=`${r}/chat/completions`,c={"Content-Type":"application/json"};this.settings.chatApiKey&&(c.Authorization=`Bearer ${this.settings.chatApiKey}`);let d=e.slice(-8).map(x=>`${x.role.toUpperCase()}: ${x.content}`).join(`
`).slice(0,4e3),u=await(0,m.requestUrl)({url:l,method:"POST",headers:c,body:JSON.stringify({model:n,temperature:.2,messages:[{role:"system",content:"Generate a short, specific title (3-7 words) for the chat. No quotes, no punctuation at the end."},{role:"user",content:d}]}),throw:!1});if(u.status>=400)return null;let g=u.json,y=(o=(a=(s=g==null?void 0:g.choices)==null?void 0:s[0])==null?void 0:a.message)==null?void 0:o.content;return typeof y!="string"?null:this.normalizeChatTitle(y.replace(/^"|"$/g,"").trim())}catch(l){return console.warn("Chat title suggestion failed",l),null}}async finalizeChatSessionNameIfNeeded(e,t,n={}){var c;if(!e)return;let r=t||[];if(!r.some(d=>d.role==="user"&&d.content.trim())||!n.force&&r.length<4)return;let a=((c=(await this.readChatSessionsIndex()).sessions)!=null?c:[]).find(d=>d.id===e);if(!a||!this.isPlaceholderChatName(a.name))return;let l=await this.suggestChatTitleWithLlm(r)||this.guessTitleFromMessages(r);!l||this.isPlaceholderChatName(l)||await this.renameChatSession(e,l)}getRagWorkerTimeoutSec(){let e=Zn;if(this.settings.enableCrossEncoderRerank&&(e+=Bn),this.settings.enableAgenticRag){let t=Number.isFinite(this.settings.agenticMaxIters)?Math.max(1,Math.trunc(this.settings.agenticMaxIters)):2;e+=Math.max(cn,t*cn)}return Math.min(3600,Math.max(60,e))}isRagQueryCancellationMessage(e){let t=(e||"").toLowerCase();return t.includes("python worker request aborted")||t.includes("request aborted")||t.includes("request canceled")||t.includes("request cancelled")||t.includes("canceled_while_waiting_rag_slot")||t.includes("cancelled_while_waiting_rag_slot")||t.includes("client_disconnected")||t.includes("error: canceled")||t.includes("error: cancelled")}cancelActiveRagQuery(){this.activeChatQueryCancelRequested=!0;let e=this.activeChatQueryProcess;if(!e)return!1;if(e.killed)return!0;try{return e.kill("SIGTERM"),!0}catch(t){console.warn("Failed to cancel active RAG query with SIGTERM",t);try{return e.kill(),!0}catch(n){return console.warn("Failed to cancel active RAG query",n),!1}}}async runRagQueryStreaming(e,t,n,r=[]){if(this.activeChatQueryProcess=null,this.activeChatQueryCancelRequested=!1,await this.ensureBundledTools(),!await this.ensureRedisAvailable("chat query")){n({answer:"Redis is not reachable. Please start Redis Stack and try again."});return}let i=this.getPluginDir(),s=S.default.join(i,"tools","rag_query_redisearch.py"),a=["--query",e,"--k","5","--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--chat-base-url",this.settings.chatBaseUrl,"--chat-api-key",this.settings.chatApiKey,"--chat-model",this.settings.chatModel,"--temperature",String(this.settings.chatTemperature),"--stream"];if(this.settings.enableQueryExpansion&&(a.push("--expand-query"),a.push("--expand-count",String(Math.max(1,Math.trunc(this.settings.queryExpansionCount))))),this.settings.enableCrossEncoderRerank){a.push("--rerank");let c=(this.settings.rerankModel||"").trim();c&&a.push("--rerank-model",c)}Number.isFinite(this.settings.rerankCandidateMultiplier)&&a.push("--rerank-candidates",String(Math.max(1,Math.trunc(this.settings.rerankCandidateMultiplier)))),Number.isFinite(this.settings.rrfK)&&a.push("--rrf-k",String(Math.max(1,Math.trunc(this.settings.rrfK)))),Number.isFinite(this.settings.rrfLogTop)&&this.settings.rrfLogTop>0&&a.push("--rrf-log-top",String(Math.max(1,Math.trunc(this.settings.rrfLogTop)))),Number.isFinite(this.settings.maxChunksPerDoc)&&this.settings.maxChunksPerDoc>0&&a.push("--max-per-doc",String(Math.max(1,Math.trunc(this.settings.maxChunksPerDoc)))),this.settings.enableAgenticRag&&(a.push("--agentic","basic"),Number.isFinite(this.settings.agenticMaxIters)&&this.settings.agenticMaxIters>0&&a.push("--agentic-max-iters",String(Math.max(1,Math.trunc(this.settings.agenticMaxIters)))),a.push("--agentic-full-doc-chunks",String(Vn),"--agentic-full-doc-max-chars",String(Un)));let o=this.buildChatHistoryPayload(r),l=await this.writeChatHistoryTemp(o);l!=null&&l.absolutePath&&a.push("--history-file",l.absolutePath);try{let c=this.getRagWorkerTimeoutSec(),d=async()=>{await this.runPythonStreaming(s,a,u=>{let g=this.asRecord(u);if((g==null?void 0:g.type)==="delta"&&typeof g.content=="string"){t(g.content);return}if((g==null?void 0:g.type)==="phase"){this.logPythonWorkerTiming("rag-phase",g);return}if((g==null?void 0:g.type)==="final"){n(g);return}g!=null&&g.answer&&n(g)},n,void 0,"rag_query_redisearch",u=>{if(this.activeChatQueryProcess=u,this.activeChatQueryCancelRequested&&!u.killed)try{u.kill("SIGTERM")}catch(g){console.warn("Failed to cancel queued chat request",g)}},c)},p=!1;for(;;){if(this.activeChatQueryCancelRequested){n({canceled:!0,answer:"Request canceled."});return}try{await d();break}catch(u){let g=this.getPythonErrorMessage(u);if(this.activeChatQueryCancelRequested||this.isRagQueryCancellationMessage(g)){n({canceled:!0,answer:"Request canceled."});return}let y=this.classifyIndexingError(g);if(y==="embed_dim_mismatch"){if(p){n({answer:"Embedding dimension mismatch persists after rebuild. Check the embedding model settings."});return}if(!await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema.")){n({answer:"Embedding dimension mismatch. Switch models or drop/rebuild the Redis index."});return}try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){let h=this.lastReindexFailure==="embed_failure"?"Embedding provider error detected while rebuilding the index. Fix settings and retry.":"Redis index rebuild did not complete. Chat query stopped.";n({answer:h});return}}catch(k){console.error(k),n({answer:"Failed to drop/rebuild the Redis index. See console for details."});return}p=!0;continue}if(y==="embed_failure"){n({answer:"Embedding provider error detected. Fix the provider/model settings and retry."});return}throw u}}}finally{if(l!=null&&l.relativePath)try{await this.app.vault.adapter.remove(l.relativePath)}catch(c){console.warn("Failed to remove chat history temp file",c)}this.activeChatQueryProcess=null,this.activeChatQueryCancelRequested=!1}}buildChatHistoryPayload(e){return this.getRecentChatHistory(e).map(n=>({role:n.role,content:n.content}))}async writeChatHistoryTemp(e){if(!e.length)return null;let t=(0,m.normalizePath)(`${re}/tmp`);await this.ensureFolder(t);let n=`chat_history_${Date.now()}_${Math.random().toString(36).slice(2,8)}.json`,r=(0,m.normalizePath)(`${t}/${n}`),i={version:1,messages:e};return await this.app.vault.adapter.write(r,JSON.stringify(i,null,2)),{relativePath:r,absolutePath:this.getAbsoluteVaultPath(r)}}async resolveCitationDisplay(e){let t=await this.getDocIndexEntry(e.doc_id);(!t||!t.note_title||!t.zotero_title||!t.note_path||!t.pdf_path||t.short_title===void 0)&&(t=await this.hydrateDocIndexFromCache(e.doc_id));let n=e.doc_id?await this.resolveNotePathForDocId(e.doc_id):t==null?void 0:t.note_path,r=this.resolveCitationTitle(t,n,e.doc_id),i=this.formatCitationPageLabel(e),s=e.page_start?String(e.page_start):"",a=(t==null?void 0:t.pdf_path)||e.source_pdf||"",o=e.attachment_key||(t==null?void 0:t.attachment_key),l=e.annotation_key||this.extractAnnotationKey(e.chunk_id),c=e.doc_id?this.buildZoteroDeepLink(e.doc_id,o,s,l):void 0;return{noteTitle:r,pageLabel:i,notePath:n||void 0,pdfPath:a||void 0,zoteroUrl:c,pageStart:s||void 0}}resolveCitationTitle(e,t,n){let r=n||"?",i=(e==null?void 0:e.short_title)||(e==null?void 0:e.zotero_title)||(e==null?void 0:e.note_title)||(t?S.default.basename(t,".md"):"")||r;return this.shortenCitationTitle(i)}shortenCitationTitle(e){let t=String(e||"").trim();if(!t)return"?";if(t.length<=dn)return t;let n=Math.max(0,dn-3);return`${t.slice(0,n).trim()}...`}formatCitationLabel(e,t){let n=e.trim()||"?",r=(t||"").trim();return r?`${n}, p. ${r}`:n}async formatInlineCitations(e,t,n=[]){var c,d,p,u;if(!e)return e;let r=/\[\[?cite:([A-Za-z0-9]+):([^\]\n]+?)\]?\]/g,i=Array.from(e.matchAll(r));if(i.length===0)return e;let s=new Map;for(let g of i){let y=g[0];if(s.has(y))continue;let x=g[1],k=g[2].trim(),h=k.match(/^(\d+)-(\d+)(?::([A-Za-z0-9]+))?$/),b="",w="",R,E,v,A;h?(b=h[1],w=h[2],R=h[3]):A=k;let T=A?n.find(D=>{let Z=typeof D.doc_id=="string"?D.doc_id:"";if(Z&&Z!==x)return!1;let V=typeof D.chunk_id=="string"?D.chunk_id:"";return V?V===A||V===`${x}:${A}`||V.endsWith(`:${A}`):!1}):void 0;T&&(!b&&T.page_start!==void 0&&(b=String(T.page_start)),!w&&T.page_end!==void 0&&(w=String(T.page_end)),!v&&typeof T.attachment_key=="string"&&(v=T.attachment_key),!E&&typeof T.annotation_page_label=="string"&&(E=T.annotation_page_label),!R&&typeof T.chunk_id=="string"&&(R=this.extractAnnotationKey(T.chunk_id)));let I={doc_id:x,chunk_id:T==null?void 0:T.chunk_id,annotation_key:R};v&&(I.attachment_key=v),E&&(I.annotation_page_label=E),(b||w)&&(I.page_start=b||w,I.page_end=w||b,I.pages=`${I.page_start}-${I.page_end}`),T!=null&&T.source_pdf&&(I.source_pdf=String(T.source_pdf));let L=(b||w?t.find(D=>{var Z,V;return D.doc_id===x&&String((Z=D.page_start)!=null?Z:"")===b&&String((V=D.page_end)!=null?V:"")===w}):void 0)||t.find(D=>D.doc_id===x)||I,q=L.annotation_key||R;!L.annotation_key&&q&&(L={...L,annotation_key:q}),!L.attachment_key&&v&&(L={...L,attachment_key:v}),!L.annotation_page_label&&E&&(L={...L,annotation_page_label:E});let M=await this.resolveCitationDisplay(L),z=this.formatCitationLabel(M.noteTitle,M.pageLabel),$=this.normalizeChunkIdForNote(L.chunk_id,x);if(this.settings.preferObsidianNoteForCitations&&M.notePath){if(q){let D=L.attachment_key||v||((d=(c=this.docIndex)==null?void 0:c[x])==null?void 0:d.attachment_key)||"",Z=L.page_start?String(L.page_start):b||w||"0",V=this.buildNoteAnnotationLink(M.notePath,q,D,Z,z);if(V){s.set(y,V);continue}s.set(y,this.buildNoteLink(M.notePath,z));continue}if($&&!q){s.set(y,this.buildNoteChunkLink(M.notePath,$,z));continue}}if(M.zoteroUrl)s.set(y,`[${z}](${M.zoteroUrl})`);else{let D=this.formatCitationLabel(x,M.pageLabel);s.set(y,`(${D})`)}}let a=[],o=0;for(let g of i){let y=g[0],x=(p=g.index)!=null?p:0;if(x<o)continue;a.push(e.slice(o,x));let k=(u=s.get(y))!=null?u:y,h=x>0?e[x-1]:"";h&&!/\s/.test(h)&&!/[([{!]/.test(h)&&a.push(" "),a.push(k),o=x+y.length}a.push(e.slice(o));let l=a.join("");return this.repairTruncatedWikilinks(l)}repairTruncatedWikilinks(e){if(!e||typeof e!="string")return e;let t=e;return t=t.replace(/(\[\[[^\]\n#]+#zrr-chunk:[^\]\n\\|]+)\\\|/g,"$1|"),t=t.replace(/\[\[([^\]\n#]+#zrr-chunk:[^\]\n|]+)(?=\n|$)/g,"[[$1]]"),t=t.replace(/\[\[([^\]\n#]+#zrr-chunk:([^\]\n|]+))\]\]/g,(n,r,i)=>{let s=this.escapeWikiLabel(this.buildDefaultChunkLabel(String(i||"").trim()));return`[[${r}\\|${s}]]`}),t}buildDefaultChunkLabel(e){let t=(e||"").trim(),n=t.match(/^p(\d+)$/i);return n?`p. ${n[1]}`:t||"source"}handleDoclingProgress(e,t){let n=this.asRecord(e);if(!n||n.type!=="progress")return;let r=Number(n.percent);if(!Number.isFinite(r))return;let i=typeof n.message=="string"&&n.message.trim()?n.message:"Docling extraction...";this.showStatusProgress(this.formatStatusLabel(i,t),Math.round(r))}async createChatNoteFromSession(e,t,n){let r=this.getChatExportDir();await this.ensureFolder(r),await this.getDocIndex();let i=this.sanitizeFileName(t)||"Zotero Chat",s=this.formatTimestamp(new Date),a=(0,m.normalizePath)(`${r}/${i}.md`),o=await this.resolveUniqueNotePath(a,`${i}-${s}.md`),l=await this.buildChatTranscript(t,n);await this.app.vault.adapter.write(o,l),await this.openNoteInNewTab(o),new m.Notice(`Chat copied to ${o}`)}async buildChatTranscript(e,t){var r,i,s;let n=[];n.push(`# ${e||"Zotero Chat"}`),n.push(""),n.push(`Created: ${new Date().toISOString()}`),n.push("");for(let a of t){let o=a.role==="user"?"## You":"## Assistant";n.push(o),n.push("");let l=a.role==="assistant"?await this.formatInlineCitations(a.content||"",(r=a.citations)!=null?r:[],(i=a.retrieved)!=null?i:[]):a.content||"";if(n.push(l.trim()),n.push(""),a.role==="assistant"&&((s=a.citations)!=null&&s.length)){n.push("### Relevant context sources");let c=this.formatCitationsMarkdown(a.citations);c&&(n.push(c),n.push(""))}}return n.join(`
`).trim()+`
`}async resolveUniqueNotePath(e,t){let n=this.app.vault.adapter;if(!await n.exists(e))return e;let r=S.default.dirname(e),i=(0,m.normalizePath)(S.default.join(r,t));if(!await n.exists(i))return i;let s=2;for(;s<1e3;){let a=(0,m.normalizePath)(S.default.join(r,`${S.default.basename(t,".md")}-${s}.md`));if(!await n.exists(a))return a;s+=1}return i}formatTimestamp(e){let t=n=>String(n).padStart(2,"0");return[e.getFullYear(),t(e.getMonth()+1),t(e.getDate()),"-",t(e.getHours()),t(e.getMinutes())].join("")}async openCitationTarget(e,t){var a,o;let n=t!=null?t:await this.resolveCitationDisplay(e),r=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id),i=e.annotation_key||this.extractAnnotationKey(e.chunk_id);if(this.settings.preferObsidianNoteForCitations&&n.notePath){if(i){let l=e.attachment_key||((o=(a=this.docIndex)==null?void 0:a[e.doc_id||""])==null?void 0:o.attachment_key)||"",c=e.page_start?String(e.page_start):e.page_end?String(e.page_end):"0";if(await this.openNoteAtAnnotation(n.notePath,i,l,c))return}if(r&&!i&&await this.openNoteAtChunk(n.notePath,r))return;await this.openNoteInMain(n.notePath);return}if(n.zoteroUrl){this.openExternalUrl(n.zoteroUrl);return}if(!(n.pdfPath&&await this.openPdfInMain(n.pdfPath,n.pageStart))){if(n.zoteroUrl){this.openExternalUrl(n.zoteroUrl);return}new m.Notice("Unable to open citation target.")}}async rebuildNoteFromCache(){let e=await this.promptDocId();if(!e){new m.Notice("No doc_ID provided.");return}await this.rebuildNoteFromCacheForDocId(e,!0)&&new m.Notice(`Rebuilt Zotero note for ${e}.`)}async reindexCurrentNoteFromCache(){let e=this.app.workspace.getActiveFile();if(!e){new m.Notice("No active note to reindex.");return}await this.reindexNoteFromCacheForFile(e,!0)}async reindexNoteFromCacheForFile(e,t){try{let n=await this.app.vault.read(e),r=await this.resolveDocIdForNote(e,n);if(!r){t&&new m.Notice("No doc_ID found for this note.");return}let i=(0,m.normalizePath)(`${Q}/${r}.json`);if(!await this.app.vault.adapter.exists(i)&&!await this.restoreMissingChunkCacheFromNote(e,n,r,t))return;await this.reindexDocIdFromCache(r,t)&&t&&new m.Notice(`Reindexed ${r}.`)}catch(n){t&&new m.Notice("Failed to reindex note."),console.error("Failed to reindex note",n)}}async rebuildDocIndexFromCache(){var c,d,p;let e=this.app.vault.adapter,t=await this.listDocIds(le),n=await this.listDocIds(Q),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),i=Object.keys(r),s=Array.from(new Set([...t,...n,...i]));if(s.length===0){new m.Notice("No cached items found.");return}this.showStatusProgress("Rebuilding doc index...",0);let a=await this.getDocIndex(),o=0;for(let u of s){o+=1;let g={},y=r[u];y&&(g.note_path=y.note_path,g.note_title=y.note_title);let x=(0,m.normalizePath)(`${le}/${u}.json`);if(await e.exists(x))try{let b=await e.read(x),w=JSON.parse(b),R=(d=(c=w==null?void 0:w.data)!=null?c:w)!=null?d:{},E=typeof R.title=="string"?R.title:"";E&&(g.zotero_title=E);let v=ve(R);v&&(g.short_title=v);let A=this.sanitizeFileName(E)||u,T=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${A}.md`),I=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${A}-${u}.md`);await e.exists(T)?(g.note_path=T,g.note_title=S.default.basename(T,".md")):await e.exists(I)&&(g.note_path=I,g.note_title=S.default.basename(I,".md"))}catch(b){console.error("Failed to read cached item JSON",b)}let k=(0,m.normalizePath)(`${Q}/${u}.json`);if(await e.exists(k))try{let b=await e.read(k),w=JSON.parse(b);typeof(w==null?void 0:w.source_pdf)=="string"&&(g.pdf_path=w.source_pdf)}catch(b){console.error("Failed to read cached chunks JSON",b)}if(Object.keys(g).length>0){let w={...(p=a[u])!=null?p:{doc_id:u},...g,doc_id:u,updated_at:new Date().toISOString()};!w.note_title&&w.note_path&&(w.note_title=S.default.basename(w.note_path,".md")),typeof w.pdf_path=="string"&&(w.pdf_path=this.normalizeDocIndexPdfPath(w.pdf_path)),a[u]=w}let h=Math.round(o/s.length*100);this.showStatusProgress(`Rebuilding doc index ${o}/${s.length}`,h)}await this.saveDocIndex(a);let l=await this.pruneDocIndexOrphans();this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),l.removed>0?new m.Notice(`Rebuilt doc index for ${s.length} items; pruned ${l.removed} stale entries.`):new m.Notice(`Rebuilt doc index for ${s.length} items.`)}async recreateMissingNotesFromCache(){if(this.recreateMissingNotesActive){new m.Notice("Recreate missing notes is already running.");return}this.recreateMissingNotesActive=!0,this.recreateMissingNotesAbort=!1,this.recreateMissingNotesProcess=null;try{let e=this.app.vault.adapter,t=await this.listDocIds(le),n=await this.listDocIds(Q),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),i=Object.keys(r),s=Array.from(new Set([...t,...n,...i]));if(s.length===0){new m.Notice("No cached items found.");return}let a=[];for(let c of s){if(r[c])continue;let d=await this.getDocIndexEntry(c);if(d!=null&&d.note_path&&await e.exists(d.note_path))continue;let p=await this.inferNotePathFromCache(c);p&&await e.exists(p)||a.push(c)}if(a.length===0){new m.Notice("No missing notes detected.");return}this.showStatusProgress("Recreating missing notes...",0);let o=0,l=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;for(let c=0;c<a.length&&!this.recreateMissingNotesAbort;c+=1){let d=a[c],p=Math.round((c+1)/a.length*100);this.showStatusProgress(`Recreating ${c+1}/${a.length}`,p),l&&this.appendToLogFile(l,`Recreate missing note doc_id ${d} (${c+1}/${a.length})`,"recreate_missing_notes","INFO"),await this.rebuildNoteFromCacheForDocId(d,!1)&&(o+=1)}this.recreateMissingNotesAbort?(this.showStatusProgress("Canceled",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice(`Canceled after ${o}/${a.length} notes.`)):(this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice(`Recreated ${o}/${a.length} missing notes.`))}finally{this.recreateMissingNotesActive=!1,this.recreateMissingNotesProcess=null}}cancelRecreateMissingNotesFromCache(){if(!this.recreateMissingNotesActive){new m.Notice("No recreate job is running.");return}this.recreateMissingNotesAbort=!0;let e=this.recreateMissingNotesProcess;if(e&&!e.killed){try{e.kill("SIGTERM")}catch(t){console.warn("Failed to terminate recreate process",t)}window.setTimeout(()=>{if(e&&!e.killed)try{e.kill("SIGKILL")}catch(t){console.warn("Failed to force-kill recreate process",t)}},2e3)}new m.Notice("Canceling recreate missing notes...")}buildRedisCommand(e){let t=[`*${e.length}\r
`];for(let n of e){let r=String(n);t.push(`$${Buffer.byteLength(r)}\r
${r}\r
`)}return t.join("")}async checkRedisConnectionWithUrl(e,t=2e3){let n=(e||"").trim();if(!n)return{ok:!1,message:"Redis URL is not configured."};let r;try{r=new URL(n)}catch(c){return{ok:!1,message:"Redis URL is invalid."}}let i=r.hostname||"127.0.0.1",s=Number(r.port)||(r.protocol==="rediss:"||r.protocol==="redis+tls:"?6380:6379),a=decodeURIComponent(r.username||""),o=decodeURIComponent(r.password||""),l=r.protocol==="rediss:"||r.protocol==="redis+tls:";return new Promise(c=>{let d=l?gn.default.connect({host:i,port:s,timeout:t,rejectUnauthorized:!1}):Oe.default.createConnection({host:i,port:s,timeout:t}),p="",u=o||a?"auth":"ping",g=!1,y=(k,h)=>{if(!g){g=!0;try{d.end(),d.destroy()}catch(b){}c({ok:k,message:h})}},x=k=>{let h=k.trim();if(h){if(h.startsWith("-NOAUTH")){y(!1,"Redis requires authentication. Check your Redis URL credentials.");return}if(h.startsWith("-WRONGPASS")||h.toLowerCase().includes("invalid password")){y(!1,"Redis authentication failed. Check your Redis URL credentials.");return}if(h.startsWith("-ERR")){y(!1,`Redis error: ${h}`);return}if(u==="auth"){if(h.startsWith("+OK")){u="ping",p="",d.write(this.buildRedisCommand(["PING"]));return}y(!1,`Redis auth failed: ${h}`);return}h.startsWith("+PONG")&&y(!0)}};d.on("connect",()=>{if(u==="auth"){let k=a?["AUTH",a,o]:["AUTH",o];d.write(this.buildRedisCommand(k))}else d.write(this.buildRedisCommand(["PING"]))}),d.on("data",k=>{var b;p+=k.toString();let h=p.split(/\r?\n/);p=(b=h.pop())!=null?b:"";for(let w of h)x(w)}),d.on("timeout",()=>{y(!1,"Timed out connecting to Redis.")}),d.on("error",k=>{y(!1,`Redis connection failed: ${k.message}`)}),d.on("close",()=>{g||y(!1,"Redis connection closed unexpectedly.")})})}async checkRedisConnection(e=2e3){return this.checkRedisConnectionWithUrl(this.settings.redisUrl,e)}async ensureRedisAvailable(e){let t=await this.checkRedisConnection();if(t.ok)return!0;let n=t.message?`Redis unavailable for ${e}: ${t.message}`:`Redis unavailable for ${e}.`;return this.notifyContainerOnce(n),!1}getPythonErrorMessage(e){if(e instanceof Error)return e.message||String(e);if(typeof e=="string")return e;try{return JSON.stringify(e)}catch(t){return String(e)}}classifyIndexingError(e){let t=e.toLowerCase();return t.includes("embedding dim mismatch")||t.includes("dim mismatch")?"embed_dim_mismatch":t.includes("chunks json not found")?"chunks_missing":t.includes("embedding failed")||t.includes("embedding request failed")||t.includes("unloaded")||t.includes("crashed")||t.includes("model does not exist")||t.includes("failed to load model")||t.includes("connection refused")||t.includes("econnrefused")||t.includes("max retries exceeded")||t.includes("failed to establish a new connection")||t.includes("failed to fetch models")?"embed_failure":"unknown"}async confirmRebuildIndex(e){return new Promise(t=>{new tt(this.app,e,t).open()})}async confirmPurgeRedisOrphans(){return new Promise(e=>{new nt(this.app,e).open()})}async dropRedisIndex(e=!1){await this.ensureBundledTools();let t=this.getPluginDir(),n=S.default.join(t,"tools","drop_redis_index.py"),r=["--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName()];e&&r.push("--drop-docs"),await this.runPython(n,r)}async dropAndRebuildRedisIndex(){if(this.reindexCacheActive){new m.Notice("Reindex already running.");return}if(!(!await this.ensureRedisAvailable("drop/rebuild")||!await this.confirmRebuildIndex("This will remove the current RedisSearch index and rebuild it from cached chunks."))){try{await this.dropRedisIndex(!0)}catch(t){let n=t instanceof Error?t.message:String(t);if(n.includes("Unknown Index name")||n.includes("Unknown index name"))console.warn("Redis index missing; skipping drop step.");else{console.error("Failed to drop Redis index",t),new m.Notice("Failed to drop redis index. See console for details.");return}}await this.reindexRedisFromCache()}}async purgeRedisOrphanedKeys(){var i,s,a,o,l;if(!await this.ensureRedisAvailable("purge orphans")||!await this.confirmPurgeRedisOrphans())return;try{await this.ensureBundledTools()}catch(c){new m.Notice("Failed to sync bundled tools. See console for details."),console.error(c);return}let t=this.getPluginDir(),n=S.default.join(t,"tools","purge_redis_orphans.py"),r=["--redis-url",this.settings.redisUrl,"--key-prefix",this.getRedisKeyPrefix(),"--chunk-dir",this.getAbsoluteVaultPath(Q),"--item-dir",this.getAbsoluteVaultPath(le)];try{let c=await this.runPythonWithOutput(n,r),d=null;try{d=c?JSON.parse(c):null}catch(w){console.warn("Failed to parse purge output",w)}if(!d){new m.Notice("Purge completed. See console for details.");return}let p=(i=this.asRecord(d))!=null?i:{},u=Number((s=p.keys_scanned)!=null?s:0),g=Number((a=p.keys_deleted)!=null?a:0),y=Number((o=p.docs_checked)!=null?o:0),x=Number((l=p.orphan_doc_count)!=null?l:0),k=[`Keys scanned: ${u}`,`Keys deleted: ${g}`,`Docs checked: ${y}`,`Orphan docs: ${x}`],h=await this.pruneDocIndexOrphans();k.push(`Doc index entries removed: ${h.removed}`),h.updated>0&&k.push(`Doc index entries updated: ${h.updated}`);let b=Array.isArray(p.sample_orphan_doc_ids)?p.sample_orphan_doc_ids.filter(Boolean):[];b.length&&k.push("","Sample doc_ids:",...b.map(w=>`- ${w}`)),new Pe(this.app,"Redis orphan purge",k.join(`
`)).open(),g===0?new m.Notice("No orphaned redis keys found."):new m.Notice(`Deleted ${g} Redis keys.`)}catch(c){console.error("Failed to purge Redis orphans",c),new m.Notice("Failed to purge redis orphans. See console for details.")}}async reindexRedisFromCache(){if(this.lastReindexFailure=null,this.reindexCacheActive)return new m.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;let e=null,t=0;try{await this.ensureBundledTools()}catch(o){return new m.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let n=await this.listDocIds(Q);if(n.length===0)return new m.Notice("No cached chunks found."),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let r=this.getPluginDir(),i=S.default.join(r,"tools","index_redisearch.py"),s=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null,a=0;this.showStatusProgress("Reindexing cached chunks...",0),s&&this.appendToLogFile(s,`Reindex started: ${n.length} cached items`,"index_redisearch","INFO");for(let o of n){a+=1;let l=Math.round(a/n.length*100);this.showStatusProgress(`Reindexing ${a}/${n.length}`,l);let c=(0,m.normalizePath)(`${Q}/${o}.json`);try{let d=["--chunks-json",this.getAbsoluteVaultPath(c),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(d),this.appendEmbedContextArgs(d),this.settings.embedIncludeMetadata&&d.push("--embed-include-metadata"),this.appendChunkTaggingArgs(d,{allowRegenerate:!1}),s&&this.appendToLogFile(s,`Reindexing doc_id ${o}`,"index_redisearch","INFO"),await this.runPythonStreaming(i,d,p=>{let u=this.asRecord(p);if(!(!s||!u)&&u.type==="progress"&&u.message){let g=typeof u.message=="string"?u.message:"";if(!g)return;this.appendToLogFile(s,g,"index_redisearch","INFO")}},()=>{},s,"index_redisearch")}catch(d){t+=1;let p=this.getPythonErrorMessage(d),u=this.classifyIndexingError(p);if(console.error(`Failed to reindex ${o}`,d),u==="chunks_missing"){new m.Notice(`Chunks cache missing for ${o}. Reimport or rebuild this note.`);continue}if(u==="embed_dim_mismatch"){e={kind:"embed_dim_mismatch",message:p};break}if(u==="embed_failure"){e={kind:"embed_failure",message:p};break}}}if(e){if(this.showStatusProgress("Aborted",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,e.kind==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(l){return new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(l),this.lastReindexFailure="unknown",!1}this.lastReindexFailure="embed_dim_mismatch"}else new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing."),this.lastReindexFailure="embed_failure";return!1}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),t===0?new m.Notice(`Reindexed ${n.length} cached items.`):new m.Notice(`Reindexed ${n.length-t}/${n.length} items (see console).`);try{await this.pruneDocIndexOrphans()}catch(o){console.warn("Failed to prune doc index orphans",o)}return this.reindexCacheActive=!1,this.lastReindexFailure=null,!0}async reindexDocIdFromCache(e,t){if(this.lastReindexFailure=null,this.reindexCacheActive)return t&&new m.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;try{await this.ensureBundledTools()}catch(o){return t&&new m.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let n=(0,m.normalizePath)(`${Q}/${e}.json`);if(!await this.app.vault.adapter.exists(n))return t&&new m.Notice(`Chunks cache missing for ${e}.`),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let i=this.getPluginDir(),s=S.default.join(i,"tools","index_redisearch.py"),a=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;this.showStatusProgress(`Reindexing ${e}...`,0),a&&this.appendToLogFile(a,`Reindexing doc_id ${e}`,"index_redisearch","INFO");try{let o=["--chunks-json",this.getAbsoluteVaultPath(n),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(o),this.appendEmbedContextArgs(o),this.settings.embedIncludeMetadata&&o.push("--embed-include-metadata"),this.appendChunkTaggingArgs(o,{allowRegenerate:!1}),await this.runPythonStreaming(s,o,l=>{let c=this.asRecord(l),d=typeof(c==null?void 0:c.total)=="number"?c.total:0,p=typeof(c==null?void 0:c.current)=="number"?c.current:0;if((c==null?void 0:c.type)==="progress"&&d>0){let u=Math.round(p/d*100),g=typeof c.message=="string"&&c.message.trim()?c.message:`Indexing chunks ${p}/${d}`;this.showStatusProgress(this.formatStatusLabel(g),u)}},()=>{},a,"index_redisearch")}catch(o){let l=this.getPythonErrorMessage(o),c=this.classifyIndexingError(l);if(console.error(`Failed to reindex ${e}`,o),c==="embed_dim_mismatch"){if(this.lastReindexFailure="embed_dim_mismatch",t&&await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),this.reindexCacheActive=!1,await this.reindexRedisFromCache()}catch(p){new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(p),this.lastReindexFailure="unknown"}}else c==="embed_failure"?(this.lastReindexFailure="embed_failure",t&&new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing.")):t&&new m.Notice(`Failed to reindex ${e}. See console for details.`);return this.showStatusProgress("Failed",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!1}return this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!0}async reindexChunkUpdates(e,t,n,r){if(!n.length&&!r.length||!await this.ensureRedisAvailable("reindex updates"))return;let i=this.getPluginDir(),s=S.default.join(i,"tools","index_redisearch.py"),a=["--chunks-json",this.getAbsoluteVaultPath(t),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert"];this.appendEmbedSubchunkArgs(a),this.appendEmbedContextArgs(a),this.settings.embedIncludeMetadata&&a.push("--embed-include-metadata"),this.appendChunkTaggingArgs(a,{allowRegenerate:!1}),n.length&&a.push("--chunk-ids",n.join(",")),r.length&&a.push("--delete-chunk-ids",r.join(","));try{await this.runPython(s,a)}catch(o){let l=this.getPythonErrorMessage(o),c=this.classifyIndexingError(l);if(console.error(`Failed to reindex updated chunks for ${e}`,o),c==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(p){new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(p)}return}c==="embed_failure"&&new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.")}}async promptZoteroItem(){return new Promise(e=>{new st(this.app,this,e).open()})}async listDocIds(e){let t=this.app.vault.adapter,n=(0,m.normalizePath)(e);return await t.exists(n)?(await t.list(n)).files.filter(i=>i.endsWith(".json")).map(i=>S.default.basename(i,".json")):[]}async listMarkdownFiles(e){let t=this.app.vault.adapter,n=(0,m.normalizePath)(e);if(!await t.exists(n))return[];let r=[n],i=[];for(;r.length>0;){let s=r.pop();if(!s)continue;let a=await t.list(s);for(let o of a.files)o.endsWith(".md")&&i.push(o);for(let o of a.folders)r.push(o)}return i}getZoteroFrontmatterKeyVariants(e){let t=e.replace(/_/g," "),n=new Set([t,e,e.replace(/_/g,"-")]);if(e.includes("_")){let r=e.split("_"),i=r[0]+r.slice(1).map(s=>s.charAt(0).toUpperCase()+s.slice(1)).join("");n.add(i)}return Array.from(n)}getFrontmatterValue(e,t){if(!e)return;let n=this.getZoteroFrontmatterKeyVariants(t);for(let r of n)if(Object.prototype.hasOwnProperty.call(e,r))return e[r]}hasFrontmatterKey(e,t){if(!e)return!1;let n=this.getZoteroFrontmatterKeyVariants(t);for(let r of n)if(Object.prototype.hasOwnProperty.call(e,r))return!0;return!1}normalizeZoteroFrontmatterKeys(e){let t=!1;for(let n of un){let r=n.replace(/_/g," "),i=this.getZoteroFrontmatterKeyVariants(n),s=Object.prototype.hasOwnProperty.call(e,r),a=s?e[r]:void 0;if(!s){for(let o of i)if(o!==r&&Object.prototype.hasOwnProperty.call(e,o)){a=e[o];break}}if(a!==void 0){s||(e[r]=a,t=!0);for(let o of i)o!==r&&Object.prototype.hasOwnProperty.call(e,o)&&(delete e[o],t=!0)}}return t}async normalizeZoteroFrontmatterKeysInFile(e){let t=this.app.metadataCache.getFileCache(e),n=t==null?void 0:t.frontmatter;if(!n)return;let r=this.getFrontmatterValue(n,"doc_id"),i=this.getFrontmatterValue(n,"zotero_key");if(!r&&!i)return;let s={...n};if(!this.normalizeZoteroFrontmatterKeys(s))return;let a=e.path;this.noteSyncSuppressed.add(a),this.noteMetadataSyncSuppressed.add(a);try{await this.app.fileManager.processFrontMatter(e,o=>{this.normalizeZoteroFrontmatterKeys(o)})}catch(o){console.warn("Failed to normalize Zotero frontmatter keys",o)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(a),this.noteMetadataSyncSuppressed.delete(a)},1500)}}normalizeFrontmatterKeySpacing(e){return e.trim()?e.split(/\r?\n/).map(r=>{var l,c;if(/^\s+-\s+/.test(r)||!r.includes(":")||((c=(l=r.match(/^\s*/))==null?void 0:l[0])!=null?c:""))return r;let s=r.indexOf(":");if(s<=0)return r;let a=r.slice(0,s).trim(),o=r.slice(s);for(let d of un){let p=d.replace(/_/g," ");if(this.getZoteroFrontmatterKeyVariants(d).includes(a))return`${p}${o}`}return r}).join(`
`):e}extractDocIdFromFrontmatter(e){let t=e.match(/^---\s*\n([\s\S]*?)\n---/);if(!t)return null;let r=t[1].split(/\r?\n/);for(let i of r){let s=i.trim();if(!s||s.startsWith("#"))continue;let a=s.split(":");if(a.length<2)continue;let o=a[0].trim().toLowerCase();if(o!=="doc_id"&&o!=="doc id"&&o!=="doc-id"&&o!=="zotero_key"&&o!=="zotero key"&&o!=="zotero-key")continue;let c=s.slice(s.indexOf(":")+1).trim().replace(/^["']|["']$/g,"").trim();if(c)return c}return null}hasDocIdFieldInFrontmatter(e){let t=e.match(/^---\s*\n([\s\S]*?)\n---/);return t?/^\s*doc(?:[_\s-]?id)\s*:/im.test(t[1]):!1}ensureDocIdInFrontmatter(e,t){let n=e.trim(),r=`doc id: ${this.escapeYamlString(t)}`;return n?/^\s*doc(?:[_\s-]?id)\s*:/im.test(n)?n:`${r}
${n}`:r}ensureDocIdInNoteContent(e,t){var u,g;let n=e.match(/^---\s*\n([\s\S]*?)\n---\s*\n?/),r=`doc id: ${this.escapeYamlString(t)}`;if(!n)return`---
${r}
---

${e.trimStart()}`;let s=((u=n[1])!=null?u:"").split(/\r?\n/),a=!1,o=s.map(y=>/^\s*doc(?:[_\s-]?id)\s*:/i.test(y)?(a=!0,r):y);a||o.unshift(r);let l=o.join(`
`).trim(),c=(g=n.index)!=null?g:0,d=e.slice(0,c),p=e.slice(c+n[0].length).replace(/^\n+/,"");return`${d}---
${l}
---
${p}`}async findDocIdByNotePath(e){let t=(0,m.normalizePath)(e),n=await this.getDocIndex();for(let[r,i]of Object.entries(n))if(i!=null&&i.note_path&&(0,m.normalizePath)(i.note_path)===t)return r;return null}async resolveDocIdForNote(e,t){let n=this.extractDocIdFromFrontmatter(t),r=this.hasDocIdFieldInFrontmatter(t);if(n&&r)return n;let i=this.extractDocIdFromSyncMarker(t),s=await this.findDocIdByNotePath(e.path),a=n||i||s;if(!a)return ye.test(t)&&!this.missingDocIdWarned.has(e.path)&&(new m.Notice("This Zotero note is missing a doc_ID in frontmatter. Reimport or add doc_ID manually."),this.missingDocIdWarned.add(e.path)),null;if(!r||!n){let o=this.ensureDocIdInNoteContent(t,a);o!==t&&await this.writeNoteWithSyncSuppressed(e.path,o)}return a}async scanNotesForDocIds(e){var i;let t=this.app.vault.adapter,n=await this.listMarkdownFiles(e),r={};for(let s of n)try{let a=await t.read(s),o=(i=this.extractDocIdFromFrontmatter(a))!=null?i:this.extractDocIdFromSyncMarker(a);if(!o)continue;r[o]={doc_id:o,note_path:s,note_title:S.default.basename(s,".md"),updated_at:new Date().toISOString()}}catch(a){console.error("Failed to read note for doc_id scan",a)}return r}setupStatusBar(){let e=this.addStatusBarItem();e.addClass("zrr-status-progress"),e.addClass("status-bar-item-segment"),e.hide();let t=e.createEl("span",{text:"Idle"});t.addClass("zrr-status-label");let r=e.createEl("div",{cls:"zrr-status-bar"}).createEl("div",{cls:"zrr-status-bar-inner"});this.statusBarEl=e,this.statusLabelEl=t,this.statusBarInnerEl=r}showStatusProgress(e,t){if(!(!this.statusBarEl||!this.statusLabelEl||!this.statusBarInnerEl))if(this.statusBarEl.show(),this.statusLabelEl.setText(e),t===null)this.statusBarInnerEl.addClass("indeterminate"),this.statusBarInnerEl.addClass("zrr-status-bar-inner--indeterminate-width"),this.statusBarInnerEl.removeClass("zrr-status-bar-inner--zero-width");else{this.statusBarInnerEl.removeClass("indeterminate"),this.statusBarInnerEl.removeClass("zrr-status-bar-inner--indeterminate-width"),this.statusBarInnerEl.removeClass("zrr-status-bar-inner--zero-width");let n=Math.max(0,Math.min(100,t));this.statusBarInnerEl.style.setProperty("width",`${n}%`)}}clearStatusProgress(){!this.statusBarEl||!this.statusBarInnerEl||(this.statusBarEl.hide(),this.statusBarInnerEl.removeClass("indeterminate"),this.statusBarInnerEl.removeClass("zrr-status-bar-inner--indeterminate-width"),this.statusBarInnerEl.addClass("zrr-status-bar-inner--zero-width"))}formatStatusLabel(e,t){return t?`${e} (Text layer quality ${t})`:e}async readDoclingQualityLabel(e){var t,n,r;try{let i=await this.app.vault.adapter.read(e),s=JSON.parse(i),a=(r=(t=s==null?void 0:s.metadata)==null?void 0:t.effective_confidence_proxy)!=null?r:(n=s==null?void 0:s.metadata)==null?void 0:n.confidence_proxy;if(typeof a=="number")return a.toFixed(2)}catch(i){console.warn("Failed to read Docling quality metadata",i)}return null}async readDoclingMetadata(e){try{let t=await this.app.vault.adapter.read(e),n=JSON.parse(t),r=n==null?void 0:n.metadata;if(r&&typeof r=="object")return r}catch(t){console.warn("Failed to read Docling metadata",t)}return null}async readDoclingQualityLabelFromPdf(e,t){var n;try{let r=this.getPluginDir(),i=S.default.join(r,"tools","docling_extract.py"),s=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,a=["--quality-only","--pdf",e,"--ocr",s],o=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;o&&a.push("--log-file",o),this.settings.ocrMode==="force_low_quality"&&a.push("--force-ocr-low-quality"),a.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),t&&a.push("--language-hint",t);let l=await this.runPythonWithOutput(i,a,o),c=JSON.parse(l),d=(n=c==null?void 0:c.effective_confidence_proxy)!=null?n:c==null?void 0:c.confidence_proxy;if(typeof d=="number")return d.toFixed(2)}catch(r){console.warn("Failed to read Docling quality from PDF",r)}return null}async promptDocId(){return new Promise(e=>{new Ne(this.app,"Rebuild Zotero note from cache","Enter Zotero doc_id (e.g., ABC123)",t=>e(t),"Doc ID cannot be empty.").open()})}async promptLanguageHint(){return new Promise(e=>{new at(this.app,e).open()})}registerRibbonIcons(){(0,m.addIcon)("zrr-picker",In),(0,m.addIcon)("zrr-chat",Fn),(0,m.addIcon)("zrr-pdf",on),this.addRibbonIcon("zrr-picker","Import Zotero item and index",()=>this.importZoteroItem()).addClass("zrr-ribbon-picker"),this.addRibbonIcon("zrr-chat","Open Zotero research assistant chat",()=>this.openChatView(!0)).addClass("zrr-ribbon-chat"),this.addRibbonIcon("zrr-pdf","Sync PDF view in right sidebar for current note",()=>{this.syncPdfSidebarForActiveNote({revealSidebar:!0})}).addClass("zrr-ribbon-pdf")}async confirmOverwrite(e){return new Promise(t=>{new Qe(this.app,e,t).open()})}async resolveLanguageHint(e,t){let n=typeof e.language=="string"?e.language:"",r=this.normalizeZoteroLanguage(n);if(r)return r;let i=await this.promptLanguageHint();if(i===null)return console.debug("Language selection canceled."),null;let s=this.normalizeZoteroLanguage(i);if(!s)return console.debug("Language selection empty; skipping Zotero update."),"";if(e.language=s,console.debug("Language selected",{language:s,itemKey:t}),t)try{await this.updateZoteroItemLanguage(t,e,s),new m.Notice("Saved language to Zotero.")}catch(a){new m.Notice("Failed to write language back to Zotero."),console.error(a)}else console.warn("Language selected but itemKey is missing; skipping Zotero update.");return s}normalizeZoteroLanguage(e){return(e||"").trim().toLowerCase()}buildDoclingLanguageHint(e){let t=this.normalizeZoteroLanguage(e!=null?e:"");if(!t)return null;let n=t.split(/[^a-z]+/).filter(Boolean),r=n.some(s=>["de","deu","ger","german"].includes(s)),i=n.some(s=>["en","eng","english"].includes(s));return r&&i?"deu+eng":r?"deu":i?"eng":n.length===1&&sn[n[0]]?sn[n[0]]:t}async fetchZoteroItem(e){try{let t=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),n=await this.requestLocalApi(t,`Zotero item fetch failed for ${t}`);return JSON.parse(n.toString("utf8"))}catch(t){return console.warn("Failed to fetch Zotero item from local API",t),this.canUseWebApi()?this.fetchZoteroItemWeb(e):null}}async fetchZoteroItemCsl(e){try{let t=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}?format=csljson`),n=await this.requestLocalApi(t,`Zotero CSL fetch failed for ${t}`);return this.parseCslPayload(n)}catch(t){return console.warn("Failed to fetch Zotero CSL from local API",t),this.canUseWebApi()?this.fetchZoteroItemCslWeb(e):null}}async fetchZoteroCollectionTitle(e){var i,s,a,o,l,c;let t=(e||"").trim();if(!t)return"";let n=this.collectionTitleCache.get(t);if(n!==void 0)return n;let r=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/collections/${t}`);try{let d=await this.requestLocalApi(r,`Zotero collection fetch failed for ${r}`),p=JSON.parse(d.toString("utf8")),u=String((a=(s=(i=p==null?void 0:p.data)==null?void 0:i.name)!=null?s:p==null?void 0:p.name)!=null?a:"").trim();return this.collectionTitleCache.set(t,u),u}catch(d){if(!this.canUseWebApi())return this.collectionTitleCache.set(t,""),"";try{let p=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/collections/${t}`),u=await this.requestWebApi(p,`Zotero Web API collection fetch failed for ${p}`),g=JSON.parse(u.toString("utf8")),y=String((c=(l=(o=g==null?void 0:g.data)==null?void 0:o.name)!=null?l:g==null?void 0:g.name)!=null?c:"").trim();return this.collectionTitleCache.set(t,y),y}catch(p){return console.warn("Failed to fetch Zotero collection title",p),this.collectionTitleCache.set(t,""),""}}}async resolveCollectionTitles(e){let n=(Array.isArray(e.collections)?e.collections:[]).map(i=>String(i||"").trim()).filter(Boolean);if(!n.length)return[];let r=[];for(let i of n){let s=await this.fetchZoteroCollectionTitle(i);s&&r.push(s)}return r}async fetchZoteroItemWeb(e){try{let t=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}`),n=await this.requestWebApi(t,`Zotero Web API fetch failed for ${t}`);return JSON.parse(n.toString("utf8"))}catch(t){return console.warn("Failed to fetch Zotero item from Web API",t),null}}async fetchZoteroItemCslWeb(e){try{let t=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}?format=csljson`),n=await this.requestWebApi(t,`Zotero Web API CSL fetch failed for ${t}`);return this.parseCslPayload(n)}catch(t){return console.warn("Failed to fetch Zotero CSL from Web API",t),null}}parseCslPayload(e){try{let t=JSON.parse(e.toString("utf8"));return Array.isArray(t)?typeof t[0]=="object"&&t[0]?t[0]:null:typeof t=="object"&&t?t:null}catch(t){return console.warn("Failed to parse CSL payload",t),null}}async searchZoteroItemsWeb(e){let t=e.trim(),n=["data"];for(let r of n){let i=new URLSearchParams;i.set("itemType","-attachment"),i.set("limit","25"),i.set("include",r),t?i.set("q",t):(i.set("sort","dateAdded"),i.set("direction","desc"));let s=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/top?${i.toString()}`);try{let a=await this.requestWebApi(s,`Zotero Web API search failed for ${s}`),o=JSON.parse(a.toString("utf8"));return Array.isArray(o)?this.normalizeZoteroSearchResults(o):[]}catch(a){console.warn("Failed to search Zotero via web API",a)}}return[]}normalizeZoteroSearchResults(e){return e.map(t=>{var a,o,l,c;let n=(a=this.asRecord(t))!=null?a:{},r=(o=this.asRecord(n.data))!=null?o:{},i=(l=this.asRecord(n.meta))!=null?l:{},s=(c=n.key)!=null?c:r.key;return{key:typeof s=="string"?s:"",data:r,meta:i}}).filter(t=>this.isImportableZoteroResult(t))}isImportableZoteroResult(e){var i,s;if(!(typeof e.key=="string"?e.key.trim():""))return!1;let n=typeof((i=e.data)==null?void 0:i.itemType)=="string"?e.data.itemType.trim().toLowerCase():"";return!(n==="attachment"||n==="note"||n==="annotation"||!(typeof((s=e.data)==null?void 0:s.title)=="string"?e.data.title.trim():""))}async updateZoteroItemLanguage(e,t,n){try{await this.updateZoteroItemLanguageLocal(e,t,n);return}catch(r){if(!this.canUseWebApi())throw r;let i=r instanceof Error?r.message:String(r);console.debug("Local Zotero write failed; trying Web API",{itemKey:e,reason:i}),await this.updateZoteroItemLanguageWeb(e,t,n)}}async updateZoteroItemLanguageLocal(e,t,n){var b,w;let r=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),i={...t,language:n},s={"Content-Type":"application/json","Zotero-API-Version":"3"},a=typeof i.version=="number"?i.version:Number(i.version);Number.isNaN(a)||(s["If-Unmodified-Since-Version"]=String(a)),console.debug("Zotero language PUT",{url:r,itemKey:e,language:n});try{let R=await this.requestLocalApiWithBody(r,"PUT",i,s,`Zotero update failed for ${r}`);console.debug("Zotero language PUT response",{status:R.statusCode})}catch(R){if(!(R instanceof Error?R.message:String(R)).includes("status 501"))throw R;let v=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.debug("Zotero language PUT unsupported; trying POST",{postUrl:v});let A=await this.requestLocalApiWithBody(v,"POST",[i],s,`Zotero update failed for ${v}`);console.debug("Zotero language POST response",{status:A.statusCode})}let o=this.asRecord(await this.fetchZoteroItem(e)),l=this.asRecord(o==null?void 0:o.data);if(this.normalizeZoteroLanguage(typeof(l==null?void 0:l.language)=="string"?l.language:"")===this.normalizeZoteroLanguage(n))return;let d={...l!=null?l:t,language:n},p={key:e,version:(w=(b=l==null?void 0:l.version)!=null?b:o==null?void 0:o.version)!=null?w:a,data:d},u={...s},g=typeof p.version=="number"?p.version:Number(p.version);Number.isNaN(g)?delete u["If-Unmodified-Since-Version"]:u["If-Unmodified-Since-Version"]=String(g);let y=await this.requestLocalApiWithBody(r,"PUT",p,u,`Zotero update failed for ${r}`);console.debug("Zotero language PUT retry response",{status:y.statusCode});let x=this.asRecord(await this.fetchZoteroItem(e)),k=this.asRecord(x==null?void 0:x.data);if(this.normalizeZoteroLanguage(typeof(k==null?void 0:k.language)=="string"?k.language:"")!==this.normalizeZoteroLanguage(n))throw new Error("Language update did not persist in Zotero.")}async updateZoteroItemLanguageWeb(e,t,n){var x,k;let r=this.getWebApiLibraryPath();if(!r)throw new Error("Web API library path is not configured.");let i=this.buildWebApiUrl(`/${r}/items/${e}`),s=this.asRecord(await this.fetchZoteroItemWeb(e)),a=this.asRecord(s==null?void 0:s.data),o={...a!=null?a:t,language:n},l={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},c=(k=(x=a==null?void 0:a.version)!=null?x:s==null?void 0:s.version)!=null?k:t==null?void 0:t.version,d=typeof c=="number"?c:Number(c);Number.isNaN(d)||(l["If-Unmodified-Since-Version"]=String(d)),console.debug("Zotero Web API language PUT",{url:i,itemKey:e,language:n});let p=await this.requestWebApiWithBody(i,"PUT",o,l,`Zotero Web API update failed for ${i}`);console.debug("Zotero Web API language PUT response",{status:p.statusCode});let u=this.asRecord(await this.fetchZoteroItemWeb(e)),g=this.asRecord(u==null?void 0:u.data);if(this.normalizeZoteroLanguage(typeof(g==null?void 0:g.language)=="string"?g.language:"")!==this.normalizeZoteroLanguage(n))throw new Error("Language update did not persist in Zotero Web API.")}async updateZoteroItemFields(e,t,n){let r=async(i,s)=>{let a=this.buildCitationKeyFallbackUpdates(n);return!a||!this.isCitationKeyFieldUnsupportedError(s)?!1:(console.debug("Retrying Zotero metadata update without native citationKey field",{itemKey:e}),await i(a),!0)};try{await this.updateZoteroItemFieldsLocal(e,t,n);return}catch(i){if(await r(a=>this.updateZoteroItemFieldsLocal(e,t,a),i))return;if(!this.canUseWebApi())throw i;let s=i instanceof Error?i.message:String(i);console.debug("Local Zotero write failed; trying Web API",{itemKey:e,reason:s});try{await this.updateZoteroItemFieldsWeb(e,t,n)}catch(a){if(await r(o=>this.updateZoteroItemFieldsWeb(e,t,o),a))return;throw a}}}buildCitationKeyFallbackUpdates(e){if(!Object.prototype.hasOwnProperty.call(e,"citationKey"))return null;let t={...e};return delete t.citationKey,t}isCitationKeyFieldUnsupportedError(e){let t=e instanceof Error?e.message:String(e);if(!t)return!1;let n=t.toLowerCase();return!n.includes("citationkey")&&!n.includes("citation-key")&&!n.includes("citation key")?!1:n.includes("unknown field")||n.includes("unknown property")||n.includes("invalid field")||n.includes("invalid property")||n.includes("unsupported")||n.includes("cannot be set")||n.includes("not allowed")||n.includes("status 400")}async updateZoteroItemFieldsLocal(e,t,n){let r=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),i={...t,...n},s={"Content-Type":"application/json","Zotero-API-Version":"3"},a=typeof i.version=="number"?i.version:Number(i.version);Number.isNaN(a)||(s["If-Unmodified-Since-Version"]=String(a)),console.debug("Zotero metadata PUT",{url:r,itemKey:e});try{let o=await this.requestLocalApiWithBody(r,"PUT",i,s,`Zotero update failed for ${r}`);console.debug("Zotero metadata PUT response",{status:o.statusCode})}catch(o){if(!(o instanceof Error?o.message:String(o)).includes("status 501"))throw o;let c=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.debug("Zotero metadata PUT unsupported; trying POST",{postUrl:c});let d=await this.requestLocalApiWithBody(c,"POST",[i],s,`Zotero update failed for ${c}`);console.debug("Zotero metadata POST response",{status:d.statusCode})}}async updateZoteroItemFieldsWeb(e,t,n){var u,g;let r=this.getWebApiLibraryPath();if(!r)throw new Error("Web API library path is not configured.");let i=this.buildWebApiUrl(`/${r}/items/${e}`),s=this.asRecord(await this.fetchZoteroItemWeb(e)),a=this.asRecord(s==null?void 0:s.data),o={...a!=null?a:t,...n},l={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},c=(g=(u=a==null?void 0:a.version)!=null?u:s==null?void 0:s.version)!=null?g:t==null?void 0:t.version,d=typeof c=="number"?c:Number(c);Number.isNaN(d)||(l["If-Unmodified-Since-Version"]=String(d)),console.debug("Zotero Web API metadata PUT",{url:i,itemKey:e});let p=await this.requestWebApiWithBody(i,"PUT",o,l,`Zotero Web API update failed for ${i}`);console.debug("Zotero Web API metadata PUT response",{status:p.statusCode})}sanitizeFileName(e){let t=String(e||"").replace(/[\\/:*?"<>|]/g,"").replace(/\s+/g," ").trim();return t?t.slice(0,120).replace(/[. ]+$/g,"").trim():""}registerNoteRenameHandler(){this.registerEvent(this.app.vault.on("rename",async e=>{var t;if(!(!(e instanceof m.TFile)||e.extension!=="md"))try{let n=await this.app.vault.read(e),r=(t=this.extractDocIdFromFrontmatter(n))!=null?t:this.extractDocIdFromSyncMarker(n);if(!r)return;await this.updateDocIndex({doc_id:r,note_path:e.path,note_title:S.default.basename(e.path,".md")})}catch(n){console.warn("Failed to update doc index for renamed note",n)}}))}registerNoteSyncHandler(){this.registerEvent(this.app.vault.on("modify",e=>{if(!(!(e instanceof m.TFile)||e.extension!=="md")){if(this.noteMetadataSyncSuppressed.has(e.path)){this.noteSyncSuppressed.has(e.path)&&this.scheduleNoteSync(e,2500);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2500),this.scheduleNoteMetadataSync(e,2500,"save"),this.scheduleNoteAnnotationSync(e,2500,"save");return}this.scheduleNoteSync(e),this.scheduleNoteMetadataSync(e,1200,"save"),this.scheduleNoteAnnotationSync(e,1200,"save")}}))}registerNoteOpenHandler(){this.registerEvent(this.app.workspace.on("file-open",e=>{!(e instanceof m.TFile)||e.extension!=="md"||(this.pdfSidebar.syncPdfSidebarForFile(e),this.pdfSidebar.maybeSyncPendingPdf(),this.pdfSidebar.updatePreviewScrollHandler(),this.scheduleNoteMetadataSync(e,600,"open"),this.scheduleNoteAnnotationSync(e,800,"open"),this.normalizeZoteroFrontmatterKeysInFile(e))}))}registerAnnotationFocusSyncHandler(){this.registerDomEvent(window,"focus",()=>{let e=this.app.workspace.getActiveViewOfType(m.MarkdownView),t=e==null?void 0:e.file;!(t instanceof m.TFile)||t.extension!=="md"||this.isZoteroNoteFile(t)&&this.scheduleNoteAnnotationSync(t,600,"open")})}registerPreviewScrollSyncHandlers(){this.registerEvent(this.app.workspace.on("active-leaf-change",()=>{this.pdfSidebar.updatePreviewScrollHandler(),this.pdfSidebar.maybeSyncPendingPdf()})),this.registerEvent(this.app.workspace.on("layout-change",()=>{this.pdfSidebar.updatePreviewScrollHandler(),this.pdfSidebar.maybeSyncPendingPdf()})),this.pdfSidebar.updatePreviewScrollHandler()}registerNoteDeleteMenu(){this.registerEvent(this.app.workspace.on("file-menu",(e,t)=>{if(!(t instanceof m.TFile)||t.extension!=="md")return;let n=(0,m.normalizePath)(this.settings.outputNoteDir),r=(0,m.normalizePath)(t.path);!(n&&(r===n||r.startsWith(`${n}/`)))&&!this.isZoteroNoteFile(t)||(e.addItem(s=>{s.setTitle("Reindex note from cache").onClick(()=>this.reindexNoteFromCacheForFile(t,!0))}),e.addItem(s=>{s.setTitle("Delete Zotero note and cached data").onClick(()=>this.deleteZoteroNoteAndCacheForFile(t))}))}))}findChunkStartLine(e,t){let n=t!=null?t:e.getCursor().line;for(;n>=0;n-=1){let r=e.getLine(n);if(he.test(r))return{line:n,text:r};if(ye.test(r)||xe.test(r))break}return null}findChunkEndLine(e,t){for(let n=t;n<e.lineCount();n+=1){let r=e.getLine(n);if(je.test(r))return n;if(xe.test(r))break}return null}findChunkAtCursor(e,t){let n=t!=null?t:e.getCursor().line,r=this.findChunkStartLine(e,n);if(!r)return null;let i=this.findChunkEndLine(e,r.line+1);return i===null||n<r.line||n>i?null:{startLine:r.line,endLine:i,text:r.text}}toggleChunkExclude(e,t){var d;let n=this.findChunkAtCursor(e,t);if(!n){new m.Notice("No synced chunk found at cursor.");return}let r=n.text.match(he);if(!r){new m.Notice("Invalid chunk marker.");return}let i=((d=r[1])!=null?d:"").trim(),s=n.endLine,a=!1;if(s!==null){for(let p=n.startLine+1;p<s;p+=1)if(Re.test(e.getLine(p))){a=!0;break}}let l=/\bexclude\b/i.test(i)||/\bdelete\b/i.test(i)||a;l?i=i.replace(/\b(delete|exclude)\b/gi,"").replace(/\s{2,}/g," ").trim():i=i?`${i} exclude`:"exclude";let c=`<!-- zrr:chunk${i?" "+i:""} -->`;if(c!==n.text&&e.replaceRange(c,{line:n.startLine,ch:0},{line:n.startLine,ch:n.text.length}),l&&s!==null){let p=[];for(let u=n.startLine+1;u<s;u+=1)Re.test(e.getLine(u))&&p.push(u);for(let u=p.length-1;u>=0;u-=1){let g=p[u],y=e.lineCount();g<y-1?e.replaceRange("",{line:g,ch:0},{line:g+1,ch:0}):e.replaceRange("",{line:g,ch:0},{line:g,ch:e.getLine(g).length})}}new m.Notice(l?"Chunk included.":"Chunk excluded from index.")}toggleChunkExcludeFromToolbar(e){let t=this.app.workspace.getActiveViewOfType(m.MarkdownView);if(!t){new m.Notice("No active editor found.");return}let n=Math.max(0,e-1);this.toggleChunkExclude(t.editor,n)}async openChunkTagEditor(e,t){var d;let n=(0,m.normalizePath)(`${Q}/${e}.json`),r=this.app.vault.adapter;if(!await r.exists(n)){new m.Notice("Chunk cache not found for this document.");return}let i=await this.readChunkPayload(n);if(!i){new m.Notice("Failed to read chunk cache.");return}let s=Array.isArray(i.chunks)?i.chunks:[],a=this.resolveChunkFromPayload(s,t,e);if(!a){new m.Notice(`Chunk ${t} not found in cache.`);return}let o=(d=a.chunk_tags)!=null?d:[],l=Array.isArray(o)?o.map(p=>String(p).trim()).filter(p=>p):(typeof o=="string"?o:"").split(/[|,;\n]+/).map(p=>p.trim()).filter(p=>p),c=typeof a.text=="string"?a.text:"";new Je(this.app,t,l,async p=>{p.length>0?a.chunk_tags=p:delete a.chunk_tags,await r.write(n,JSON.stringify(i,null,2));let u=typeof a.chunk_id=="string"?a.chunk_id:t;await this.reindexChunkUpdates(e,n,[u],[]),new m.Notice("Chunk tags updated.")},async()=>{if(!c.trim())return new m.Notice("Chunk has no text to tag."),null;let p=await this.renderMarkdownToIndexText(c);return this.requestChunkTags(p)}).open()}async openChunkIndexedTextPreview(e,t){let n=(0,m.normalizePath)(`${Q}/${e}.json`);if(!await this.app.vault.adapter.exists(n)){new m.Notice("Chunk cache not found for this document.");return}let i=await this.readChunkPayload(n);if(!i){new m.Notice("Failed to read chunk cache.");return}let s=Array.isArray(i.chunks)?i.chunks:[],a=this.resolveChunkFromPayload(s,t,e);if(!a){new m.Notice(`Chunk ${t} not found in cache.`);return}let o=typeof a.text=="string"?a.text:"",l=await this.renderMarkdownToIndexText(o),c=this.settings.embedIncludeMetadata?"Note: when \u201CInclude metadata in embeddings\u201D is enabled, the indexer prepends title/authors/tags/section info before embedding. The preview below shows only the chunk text.":"";new Xe(this.app,`Indexed text for ${t}`,l,c).open()}async openChunkInZotero(e,t){var u,g,y;let n=(0,m.normalizePath)(`${Q}/${e}.json`),r=this.app.vault.adapter,i=null;await r.exists(n)&&(i=await this.readChunkPayload(n));let s=Array.isArray(i==null?void 0:i.chunks)?i==null?void 0:i.chunks:[],a=this.resolveChunkFromPayload(s,t,e),o=(u=a==null?void 0:a.page_start)!=null?u:a==null?void 0:a.pageStart,l=this.asRecord(i==null?void 0:i.metadata),c=W((g=l==null?void 0:l.attachment_key)!=null?g:l==null?void 0:l.attachmentKey);if(!c){let x=await this.getDocIndexEntry(e);c=(y=x==null?void 0:x.attachment_key)!=null?y:""}if(!c){new m.Notice("Attachment key not found for Zotero deeplink.");return}let d=typeof o=="number"?String(o):"",p=this.buildZoteroDeepLink(e,c,d);this.openExternalUrl(p)}async cleanChunkFromToolbar(e){let t=this.app.workspace.getActiveViewOfType(m.MarkdownView);if(!t){new m.Notice("No active editor found.");return}let n=t.editor,r=Math.max(0,e-1),i=this.findChunkAtCursor(n,r);if(!i){new m.Notice("No synced chunk found at cursor.");return}let s=[];for(let c=i.startLine+1;c<i.endLine;c+=1)s.push(n.getLine(c));let a=s.join(`
...
`;n.replaceRange(l,{line:i.startLine+1,ch:0},{line:i.endLine,ch:0}),this.showStatusProgress("Chunk cleaned.",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice("Chunk cleaned.")}async requestOcrCleanup(e){var l,c,d,p,u,g,y,x,k;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new m.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let r=Number(this.settings.llmCleanupMaxChars||0);if(r>0&&e.length>r)return new m.Notice("Chunk exceeds ocr cleanup max length. Adjust settings to clean it."),this.openPluginSettings(),null;let i=`${t}/chat/completions`,s={"Content-Type":"application/json"},a=(this.settings.llmCleanupApiKey||"").trim();a&&(s.Authorization=`Bearer ${a}`);let o={model:n,temperature:Number((l=this.settings.llmCleanupTemperature)!=null?l:0),messages:[{role:"system",content:"You are an OCR cleanup assistant. Fix OCR errors without changing meaning. Do not add content. Return corrected text only. Detect footnote references and definitions and format them in Markdown as [^n] and [^n]: (for the note text). Preserve special characters and formatting. Do not create new footnotes or content; only reformat existing footnote markers/lines."},{role:"user",content:e}]};try{let h=await this.requestLocalApiRaw(i,{method:"POST",headers:s,body:JSON.stringify(o)});if(h.statusCode>=400){let E=h.body.toString("utf8");throw new Error(`Cleanup request failed (${h.statusCode}): ${E||"no response body"}`)}let b=JSON.parse(h.body.toString("utf8")),w=(k=(x=(y=(p=(d=(c=b==null?void 0:b.choices)==null?void 0:c[0])==null?void 0:d.message)==null?void 0:p.content)!=null?y:(g=(u=b==null?void 0:b.choices)==null?void 0:u[0])==null?void 0:g.text)!=null?x:b==null?void 0:b.output_text)!=null?k:"",R=String(w||"").trim();return R||(new m.Notice("Cleanup returned empty text."),null)}catch(h){return console.error("OCR cleanup failed",h),new m.Notice("Ocr cleanup failed. Check the cleanup model settings."),null}}parseChunkTags(e,t){if(!e)return[];let n=e.trim(),r=[];if(n.startsWith("[")&&n.endsWith("]"))try{let a=JSON.parse(n);Array.isArray(a)&&(r=a.map(o=>String(o)))}catch(a){r=[]}r.length===0&&(r=n.split(/[,;\n]+/));let i=new Set,s=[];for(let a of r){let o=a.trim();if(o=o.replace(/^[-•\d.)\s]+/,""),o=o.replace(/\s+/g," ").trim(),!o||o.length<2)continue;let l=o.toLowerCase();if(!i.has(l)&&(i.add(l),s.push(o),s.length>=t))break}return s}async requestChunkTags(e){var p,u,g,y,x,k,h,b,w;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new m.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let r=e.trim().slice(0,2e3);if(!r)return[];let i=`${t}/chat/completions`,s={"Content-Type":"application/json"},a=(this.settings.llmCleanupApiKey||"").trim();a&&(s.Authorization=`Bearer ${a}`);let o=5,l="Return 3 to 5 high-signal, concrete noun-phrase tags. Avoid generic terms (study, paper, method), verbs, and filler. Prefer specific entities, methods, datasets, and named concepts. Output comma-separated tags only. No extra text.",c=Number((p=this.settings.llmCleanupTemperature)!=null?p:0),d={model:n,messages:[{role:"system",content:l},{role:"user",content:r}]};Number.isFinite(c)&&(d.temperature=c),this.showStatusProgress("Generating tags...",null);try{let R=async I=>{let L=await this.requestLocalApiRaw(i,{method:"POST",headers:s,body:JSON.stringify(I)});if(L.statusCode>=400){let q=L.body.toString("utf8");throw new Error(`Tag request failed (${L.statusCode}): ${q||"no response body"}`)}return L.body},E;try{E=await R(d)}catch(I){let L=I instanceof Error?I.message:String(I);if("temperature"in d&&/temperature/i.test(L)&&/unsupported|default/i.test(L)){let q={...d};delete q.temperature,E=await R(q)}else throw I}let v=JSON.parse(E.toString("utf8")),A=(w=(b=(h=(y=(g=(u=v==null?void 0:v.choices)==null?void 0:u[0])==null?void 0:g.message)==null?void 0:y.content)!=null?h:(k=(x=v==null?void 0:v.choices)==null?void 0:x[0])==null?void 0:k.text)!=null?b:v==null?void 0:v.output_text)!=null?w:"",T=this.parseChunkTags(String(A||""),o);return T.length||new m.Notice("Tag generation returned no tags."),T}catch(R){return console.error("Tag generation failed",R),new m.Notice("Tag generation failed. Check the cleanup model settings."),null}finally{this.clearStatusProgress()}}async renderMarkdownToIndexText(e){if(!e)return"";let t=this.replaceImageMarkersForIndexPreview(e),n=document.createElement("div"),r=new m.Component;r.load();try{await m.MarkdownRenderer.render(this.app,t,n,"",r)}catch(s){return console.warn("Failed to render markdown for index preview",s),this.normalizeIndexPreviewText(t)}finally{r.unload()}let i=n.textContent||t;return this.normalizeIndexPreviewText(i)}replaceImageMarkersForIndexPreview(e){if(!e)return"";let t=r=>{let i=r.trim();return i?`Image caption: ${i}`:"Image"},n=e.replace(/!\[\[([^\]|]+)(?:\|([^\]]+))?\]\]/g,(r,i,s)=>t(s||""));return n=n.replace(/!\[([^\]]*)]\([^)]+\)/g,(r,i)=>t(i||"")),n=n.replace(/<img[^>]*>/gi,r=>{let i=r.match(/\balt=(['"])([^'"]*)\1/i);return t(i?i[2]:"")}),n}normalizeIndexPreviewText(e){return e.replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/[ \t]+/g," ").replace(/\n{3,}/g,`

`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,t=1200){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let r=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},t);this.noteSyncTimers.set(e.path,r)}scheduleNoteMetadataSync(e,t=1200,n="save"){let r=this.noteMetadataSyncTimers.get(e.path);r!==void 0&&window.clearTimeout(r);let i=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,n)},t);this.noteMetadataSyncTimers.set(e.path,i)}scheduleNoteAnnotationSync(e,t=1200,n="save"){let r=this.noteAnnotationSyncTimers.get(e.path);r!==void 0&&window.clearTimeout(r);let i=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,n)},t);this.noteAnnotationSyncTimers.set(e.path,i)}getAnnotationGraceRemaining(e){let t=this.annotationNoteEditTimes.get(e);if(!t)return 0;let n=Date.now()-t;return n>=pn?0:pn-n}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let t=(e.annotation_page_label||"").trim();if(t)return t;let n=e.page_start?String(e.page_start):"",r=e.page_end?String(e.page_end):"";if(n&&(!r||n===r))return n;if(n&&r)return`${n} - ${r}`;let i=(e.pages||"").trim();if(!i)return"?";let s=i.match(/^(\d+)\s*-\s*(\d+)$/);return s?s[1]===s[2]?s[1]:`${s[1]} - ${s[2]}`:i.replace("-"," - ")}normalizeChunkIdForNote(e,t){if(!e)return null;let n=String(e);if(t&&n.startsWith(`${t}:`))return n.slice(t.length+1);if(n.includes(":")){let r=n.split(":");if(r.length>1&&t&&r[0]===t)return r.slice(1).join(":")}return n}async syncNoteToRedis(e){if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let t=await this.app.vault.read(e),n=this.extractSyncSection(t);if(!n)return;let r=await this.resolveDocIdForNote(e,t);if(!r)return;let i=this.parseSyncedChunkBlocks(n);if(!i.length)return;let s=(0,m.normalizePath)(`${Q}/${r}.json`),a=this.app.vault.adapter;if(!await a.exists(s)&&!await this.restoreMissingChunkCacheFromNote(e,t,r,!1))return;let o=await this.readChunkPayload(s);if(!o)return;let l=Array.isArray(o.chunks)?o.chunks:[],c=new Map;for(let k of l){if(this.isAnnotationChunk(k))continue;let h=typeof(k==null?void 0:k.chunk_id)=="string"?k.chunk_id:"";h&&c.set(h,k)}let d=new Set,p=new Set,u=new Set,g=new Set,y=!1;for(let k of i){let h=k.chunkId;if(!h)continue;d.add(h);let b=c.get(h);if(!b){console.warn(`Sync note: chunk id not found in cache (${h})`);continue}if(k.excludeFlag){b.excluded!==!0&&(b.excluded=!0,y=!0);let E=this.normalizeChunkText(k.text),v=typeof b.text=="string"?b.text:"";E&&E!==v&&(b.text=E,b.char_count=E.length,y=!0),u.add(h);continue}if(b.excluded&&(b.excluded=!1,y=!0,p.add(h)),!k.text.trim()){u.add(h),g.add(h);continue}let w=this.normalizeChunkText(k.text);if(!w){u.add(h),g.add(h);continue}let R=typeof b.text=="string"?b.text:"";w!==R&&(b.text=w,b.char_count=w.length,p.add(h),y=!0)}for(let k of c.keys())d.has(k)||(u.add(k),g.add(k));let x=new Set([...u,...g]);if(x.size){let k=Array.from(x).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==k){this.noteSyncPendingDeletes.set(e.path,k),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!p.size&&!u.size&&!g.size&&!y)return;g.size&&(o.chunks=l.filter(k=>{let h=typeof(k==null?void 0:k.chunk_id)=="string"?k.chunk_id:"";return h&&!g.has(h)}),y=!0),(y||g.size)&&await a.write(s,JSON.stringify(o,null,2)),await this.reindexChunkUpdates(r,s,Array.from(p),Array.from(u)),(u.size||g.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(t){console.warn("Failed to sync note edits to Redis",t)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,t){var n,r,i,s;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,t);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),o=await this.resolveDocIdForNote(e,a);if(!o)return;let l=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter;if(!l)return;let c=this.resolveZoteroItemKey(l,o);if(!c)return;let d=this.asRecord(await this.fetchZoteroItem(c)),p=(r=this.asRecord(d==null?void 0:d.data))!=null?r:d;if(!p||typeof p!="object")return;let u=this.extractNoteMetadata(l),g=this.extractZoteroMetadata(p);g.citekey||(g.citekey=await this.resolveZoteroCitekey(p,c,(i=this.asRecord(d==null?void 0:d.meta))!=null?i:{}));let y=await this.getMetadataSnapshot(o,l,e),x={},k={},h={},b=[],w=["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],R={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publication_title:"publication_title",book_title:"book_title",journal_abbrev:"journal_abbrev",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},E=Object.fromEntries(w.map(I=>[I,this.hasFrontmatterKey(l,R[I])])),v=new Set(["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","authors","editors"]),A=w.filter(I=>E[I]||!this.isMetadataValueEmpty(u[I])||!this.isMetadataValueEmpty(g[I]));if(!A.length)return;let T={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publication_title:"Publication title",book_title:"Book title",journal_abbrev:"Journal abbreviation",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let I of A){let L=u[I],q=g[I];if(this.metadataValuesEqual(I,L,q))continue;let M=this.isMetadataValueEmpty(L),z=this.isMetadataValueEmpty(q),$=y==null?void 0:y[I];if($===void 0){if(M&&!z){h[I]="zotero",this.assignMetadataUpdate(x,I,q);continue}if(!M&&z&&v.has(I)){h[I]="note",this.assignMetadataUpdate(k,I,L);continue}}if($!==void 0){let Z=!this.metadataValuesEqual(I,L,$),V=!this.metadataValuesEqual(I,q,$);if(Z&&!V){h[I]="note",this.assignMetadataUpdate(k,I,L);continue}if(!Z&&V){h[I]="zotero",this.assignMetadataUpdate(x,I,q);continue}}let D=this.getMetadataDecisionLabels(I,L,q,T);b.push({field:I,fieldLabel:T[I],noteLabel:D.noteLabel,zoteroLabel:D.zoteroLabel,noteValue:this.formatMetadataValue(L),zoteroValue:this.formatMetadataValue(q)})}if(b.length>0){let I=await this.promptMetadataBatchDecision(b);for(let L of b){let q=(s=I[L.field])!=null?s:"skip";h[L.field]=q,q==="note"?this.assignMetadataUpdate(k,L.field,u[L.field]):q==="zotero"&&this.assignMetadataUpdate(x,L.field,g[L.field])}}Object.keys(x).length>0&&await this.applyNoteMetadataUpdates(e,x),Object.keys(k).length>0&&await this.applyZoteroMetadataUpdates(c,p,u,g,k),await this.updateMetadataSnapshot(e,o,u,g,y,h,A)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,t)}}async syncNoteAnnotationsWithZotero(e,t){var n,r,i,s,a;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,t);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let z=this.ensureDocIdInNoteContent(o,d);z!==o&&await this.writeNoteWithSyncSuppressed(e.path,z)}if(!d)return;let p=(r=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter)!=null?r:{},u=(i=c.attachmentKey)!=null?i:"";if(u||(u=await this.resolveAttachmentKeyForDocId(d,p)),!u)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===u&&await this.updateDocIndex({doc_id:d,attachment_key:u});let g=u,y=await this.fetchZoteroAnnotationsForDoc(d,u),x=y.annotations;u=y.attachmentKey,u&&u!==g&&await this.updateDocIndex({doc_id:d,attachment_key:u});let k=this.parseAnnotationBlock(l.block,u),h=new Map;for(let z of k)z.key&&z.imagePath&&h.set(z.key,{path:z.imagePath,hash:z.imageHash||this.extractAnnotationImageHashFromPath(z.imagePath)});await this.attachAnnotationImages(d,u,x,e.path,h);let b=new Map;for(let z of k)z.key&&b.set(z.key,z);let w=new Map;for(let z of x)w.set(z.key,z);let R=!1,E=!1,v=!1;if(y.hadFetchError)b.size>0&&x.length===0&&console.debug("Skipping annotation-prune sync due incomplete Zotero annotation fetch.",{docId:d,attachmentKey:u,reason:t});else for(let z of b.keys())w.has(z)||(E=!0);let A=await this.getAnnotationSnapshot(d),T=(s=A==null?void 0:A.annotations)!=null?s:{},I={},L=[];u&&u!==g&&x.length>0&&(E=!0,v=!0);for(let[z,$]of w.entries()){let D=b.get(z);if(!D){E=!0;continue}let Z=T[z],V=this.annotationSnapshotFromEntry(D,$.annotationType),B=this.annotationSnapshotFromEntry($,$.annotationType),F=(V.image_hash||"")!==(B.image_hash||"");if(!Z){this.annotationSnapshotsEqualIgnoringImage(V,B)?F&&(E=!0,v=!0):(I[z]="note",R=!0);continue}let j=!this.annotationSnapshotsEqual(V,Z),K=!this.annotationSnapshotsEqual(B,Z),U=(B.color_key||"")!==(Z.color_key||""),G=!this.annotationSnapshotsEqualIgnoringImage(V,Z),H=!this.annotationSnapshotsEqualIgnoringImage(B,Z);G&&!H?(I[z]="note",R=!0):!G&&H?(I[z]="zotero",E=!0):G&&H&&L.push({key:z,title:this.formatAnnotationConflictTitle($),noteValue:this.formatAnnotationConflictValue(V,D.tags),zoteroValue:this.formatAnnotationConflictValue(B,$.tags)}),F&&(j||K)&&(E=!0,v=!0),U&&(E=!0,v=!0)}if(L.length>0){let z=await this.promptAnnotationBatchDecision(L);for(let $ of L){let D=(a=z[$.key])!=null?a:"skip";I[$.key]=D,D==="note"?R=!0:D==="zotero"&&(E=!0,v=!0)}}let q=[];for(let[z,$]of Object.entries(I)){if($!=="note")continue;let D=b.get(z),Z=w.get(z);!D||!Z||q.push({entry:Z,note:D})}q.length>0&&await this.applyZoteroAnnotationUpdates(q),R&&this.annotationNoteEditTimes.set(e.path,Date.now());let M=this.getAnnotationGraceRemaining(e.path);if(E&&M>0&&R&&!v&&(this.scheduleNoteAnnotationSync(e,M+250,t),E=!1),E){let z=this.buildAnnotationBlock(d,u,x),$=this.replaceAnnotationBlock(o,z);if($&&$!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,$)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,u,x),await this.updateAnnotationChunks(d,u,x,{allowDeletes:!y.hadFetchError})}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,t)}}resolveZoteroItemKey(e,t){let n=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),t];for(let r of n){let i=W(r);if(i)return i}return""}async resolveAttachmentKeyForDocId(e,t){var l;if(!e)return"";let n=await this.getDocIndexEntry(e);if(n||(n=await this.hydrateDocIndexFromCache(e)),n!=null&&n.attachment_key)return n.attachment_key;let r=(0,m.normalizePath)(`${Q}/${e}.json`);try{if(await this.app.vault.adapter.exists(r)){let d=await this.readChunkPayload(r),p=this.asRecord(d==null?void 0:d.metadata),u=p==null?void 0:p.attachment_key;if(typeof u=="string"&&u.trim())return await this.updateDocIndex({doc_id:e,attachment_key:u.trim()}),u.trim()}}catch(c){}let i=this.resolveZoteroItemKey(t,e);if(!i)return"";let s=this.asRecord(await this.fetchZoteroItem(i)),a=(l=this.asRecord(s==null?void 0:s.data))!=null?l:s;if(!a||typeof a!="object")return"";let o=await Te(a,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var w,R,E,v,A,T,I,L,q,M,z,$,D,Z,V,B,F,j,K,U,G,H;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString((v=(E=(R=(w=e==null?void 0:e["short title"])!=null?w:e==null?void 0:e.short_title)!=null?R:e==null?void 0:e.shortTitle)!=null?E:e==null?void 0:e["short-title"])!=null?v:e==null?void 0:e["title-short"]),r=this.normalizeMetadataString((L=(I=(T=(A=e==null?void 0:e.citekey)!=null?A:e==null?void 0:e["citation key"])!=null?T:e==null?void 0:e.citation_key)!=null?I:e==null?void 0:e.citationKey)!=null?L:e==null?void 0:e["citation-key"]),i=this.normalizeMetadataString(e==null?void 0:e.date),s=this.normalizeMetadataString((q=e==null?void 0:e.abstract)!=null?q:e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((M=e==null?void 0:e.doi)!=null?M:e==null?void 0:e.DOI),o=this.normalizeMetadataString((D=($=(z=e==null?void 0:e["publication title"])!=null?z:e==null?void 0:e.publication_title)!=null?$:e==null?void 0:e.publicationTitle)!=null?D:e==null?void 0:e["publication-title"]),l=this.normalizeMetadataString((B=(V=(Z=e==null?void 0:e["book title"])!=null?Z:e==null?void 0:e.book_title)!=null?V:e==null?void 0:e.bookTitle)!=null?B:e==null?void 0:e["book-title"]),c=this.normalizeMetadataString((K=(j=(F=e==null?void 0:e["journal abbrev"])!=null?F:e==null?void 0:e.journal_abbrev)!=null?j:e==null?void 0:e.journalAbbrev)!=null?K:e==null?void 0:e["journal-abbrev"]),d=this.normalizeMetadataString(e==null?void 0:e.publisher),p=this.normalizeMetadataString(e==null?void 0:e.place),u=this.normalizeMetadataString(e==null?void 0:e.issue),g=this.normalizeMetadataString(e==null?void 0:e.volume),y=this.normalizeMetadataString(e==null?void 0:e.pages),x=this.normalizeMetadataString((H=(G=(U=e==null?void 0:e["item type"])!=null?U:e==null?void 0:e.item_type)!=null?G:e==null?void 0:e.itemType)!=null?H:e==null?void 0:e["item-type"]),k=this.normalizeMetadataList(e==null?void 0:e.tags),h=this.normalizeMetadataList(e==null?void 0:e.authors),b=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:t,short_title:n,citekey:r,date:i,abstract:s,doi:a,publication_title:o,book_title:l,journal_abbrev:c,publisher:d,place:p,issue:u,volume:g,pages:y,item_type:x,tags:this.sanitizeObsidianTags(k),authors:h,editors:b}}extractZoteroMetadata(e){var R,E,v;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString(ve(e)),r=this.normalizeMetadataString(Ke(e)),i=this.normalizeMetadataString(e==null?void 0:e.date),s=this.normalizeMetadataString(e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((R=e==null?void 0:e.DOI)!=null?R:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publicationTitle),l=this.normalizeMetadataString(e==null?void 0:e.bookTitle),c=this.normalizeMetadataString(e==null?void 0:e.journalAbbreviation),d=this.normalizeMetadataString(e==null?void 0:e.publisher),p=this.normalizeMetadataString(e==null?void 0:e.place),u=this.normalizeMetadataString(e==null?void 0:e.issue),g=this.normalizeMetadataString(e==null?void 0:e.volume),y=this.normalizeMetadataString(e==null?void 0:e.pages),x=this.normalizeMetadataString((v=(E=e==null?void 0:e.itemType)!=null?E:e==null?void 0:e.item_type)!=null?v:e==null?void 0:e["item-type"]),k=Array.isArray(e==null?void 0:e.creators)?e.creators:[],h=k.filter(A=>(A==null?void 0:A.creatorType)==="author").map(A=>we(A)).filter(Boolean),b=k.filter(A=>(A==null?void 0:A.creatorType)==="editor"||(A==null?void 0:A.creatorType)==="seriesEditor").map(A=>we(A)).filter(Boolean),w=Array.isArray(e==null?void 0:e.tags)?e.tags.map(A=>{var T;return typeof A=="string"?A:(T=this.asRecord(A))==null?void 0:T.tag}).filter(A=>typeof A=="string"):[];return{title:t,short_title:n,citekey:r,date:i,abstract:s,doi:a,publication_title:o,book_title:l,journal_abbrev:c,publisher:d,place:p,issue:u,volume:g,pages:y,item_type:x,tags:this.sanitizeObsidianTags(w),authors:this.normalizeMetadataList(h),editors:this.normalizeMetadataList(b)}}async resolveZoteroCitekey(e,t,n){let r=this.normalizeMetadataString(Ke(e,n!=null?n:void 0));if(r)return r;if(!t)return"";let i=await this.fetchZoteroItemCsl(t);return this.normalizeMetadataString(mt(i))}extractAnnotationPageInfo(e){var s;let n=W((s=e.annotationPageLabel)!=null?s:e.annotationPage).trim(),r=null,i=e.annotationPage;if(typeof i=="number"&&Number.isFinite(i))r=i;else if(typeof i=="string"&&i.trim()){let a=Number(i);Number.isFinite(a)&&(r=a)}if(r===null&&typeof e.annotationPosition=="string")try{let a=JSON.parse(e.annotationPosition),o=a==null?void 0:a.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(r=o+1)}catch(a){}return{pageLabel:n,pageIndex:r}}extractAnnotationImagePayload(e){var s,a,o,l;let t=(a=(s=e.annotationImage)!=null?s:e.annotationImageData)!=null?a:e.annotationImageBase64;if(!t)return null;let n=null,r="";if(Buffer.isBuffer(t))n=t;else if(ArrayBuffer.isView(t))n=Buffer.from(t.buffer,t.byteOffset,t.byteLength);else if(t instanceof ArrayBuffer)n=Buffer.from(t);else if(typeof t=="string"){let c=t.trim();if(!c)return null;let d=c.match(/^data:([^;]+);base64,(.*)$/i);if(d&&(r=this.normalizeAnnotationImageMime(d[1]),c=d[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;n=Buffer.from(c,"base64")}if(!n||!n.length)return null;r||(r=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(n)||"image/png");let i=this.annotationImageExtensionFromMime(r)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(n))||"png";return{buffer:n,mime:r,ext:i}}parseZoteroAnnotationItem(e,t){var h,b,w,R;let n=(b=(h=e==null?void 0:e.data)!=null?h:e)!=null?b:{},r=W((w=e==null?void 0:e.key)!=null?w:n==null?void 0:n.key);if(!r)return null;let i=W(n.annotationType),s=this.normalizeAnnotationText(n.annotationText),a=this.normalizeAnnotationText(n.annotationComment),o=W(n.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:p,pageIndex:u}=this.extractAnnotationPageInfo(n),g=(R=n.annotationSortIndex)!=null?R:n.annotationSort,y=W(g).trim(),x=Number.isFinite(Number(y))?Number(y):Number.NaN,k=Array.isArray(n.tags)?n.tags.map(E=>{var v;return typeof E=="string"?E:(v=this.asRecord(E))==null?void 0:v.tag}).filter(E=>typeof E=="string"):[];return{key:r.trim(),attachmentKey:t,pageLabel:p,pageIndex:u,colorKey:l,callout:d,heading:c,annotationType:i,text:s,comment:a,tags:this.normalizeAnnotationTags(k),sortToken:y,sortIndex:x,rawValues:n}}async fetchZoteroAnnotations(e){if(!e)return{annotations:[],hadFetchError:!1};let t=this.canUseWebApi()||await this.ensureWebApiLibraryId(),n=!1,r=!1,i=o=>{var c,d;let l=[];for(let p of o){let u=this.asRecord(p),g=(d=(c=this.asRecord(u==null?void 0:u.data))!=null?c:u)!=null?d:{};if(W(g.itemType)!=="annotation")continue;let y=this.parseZoteroAnnotationItem(p,e);y&&l.push(y)}return l},s=[];try{s=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(o){try{s=await this.fetchZoteroChildrenLocal(e)}catch(l){n=!0,console.warn("Failed to fetch Zotero annotation items from local API",l)}}let a=i(s);if(!a.length&&t)try{let o=[];try{o=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(c){o=await this.fetchZoteroChildrenWeb(e)}r=!0;let l=i(o);l.length&&(a=l)}catch(o){n=!0,console.warn("Failed to fetch Zotero annotation items from Web API",o)}return!a.length&&t&&!r&&(n=!0),!a.length&&!t&&(n=!0),{annotations:a,hadFetchError:n}}async fetchZoteroAnnotationsForDoc(e,t){var l,c;let n=t,r=await this.fetchZoteroAnnotations(n);if(r.annotations.length||!e)return r.annotations.length||this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:r.hadFetchError};let i=[];try{i=await this.fetchZoteroChildren(e)}catch(d){return console.warn("Failed to fetch Zotero attachments for annotations",d),this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:!0}}let s=r.hadFetchError,a=[],o=new Set(n?[n]:[]);for(let d of i){if(!yt(d))continue;let p=this.asRecord(d),u=this.asRecord(p==null?void 0:p.data),g=W((c=(l=p==null?void 0:p.key)!=null?l:u==null?void 0:u.key)!=null?c:p==null?void 0:p.attachmentKey);!g||o.has(g)||(o.add(g),a.push(g))}for(let d of a){let p=await this.fetchZoteroAnnotations(d);if(s=s||p.hadFetchError,p.annotations.length)return{attachmentKey:d,annotations:p.annotations,hadFetchError:s}}return this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:s}}async attachAnnotationImages(e,t,n,r,i){var p;if(!this.settings.includeAnnotationImages||!n.length)return;let s=await this.resolveAnnotationImageOutputDir(r);if(!s)return;let a=this.sanitizeFileName(e||t)||"annotations",o=(0,m.normalizePath)(S.default.join(s.relative||"",a)),l=S.default.normalize(S.default.join(s.absolute,a));o?await this.ensureFolder(o):await ee.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,d=new Map;for(let u of n){let g=String(u.annotationType||"").trim().toLowerCase(),y=g==="image"||g==="ink",x=this.extractAnnotationImagePayload((p=u.rawValues)!=null?p:{});if(!x&&y&&this.settings.zoteroCompanionEnabled&&(x=await this.fetchCompanionAnnotationImage(u.key)),!x){let w=i==null?void 0:i.get(u.key);w!=null&&w.path&&await c.exists(w.path)&&(u.imagePath=w.path,u.imageHash=w.hash,d.set(u.key,w.path));continue}let k=(0,Fe.createHash)("sha1").update(x.buffer).digest("hex").slice(0,12),h=`zrr-annotation-${u.key}-${k}.${x.ext}`,b=(0,m.normalizePath)(S.default.join(o,h));try{await c.exists(b)||await c.writeBinary(b,this.bufferToArrayBuffer(x.buffer)),u.imagePath=b,u.imageHash=k,d.set(u.key,b)}catch(w){console.warn("Failed to write annotation image",{annotationKey:u.key,error:w})}}if(o&&await c.exists(o))try{let u=await c.list(o);for(let g of u.files){let x=S.default.basename(g).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!x)continue;let k=x[1].toUpperCase(),h=d.get(k);(!h||(0,m.normalizePath)(h)!==(0,m.normalizePath)(g))&&await c.remove(g)}}catch(u){console.warn("Failed to clean up annotation images",u)}}async fetchCompanionAnnotationImage(e){let t=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!t)return null;let n=`${t.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,r={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(r.Authorization=`Bearer ${i}`);try{let s=await this.requestLocalApiRaw(n,{headers:r,timeoutMs:5e3});if(s.statusCode===200){let a=s.headers["content-type"],o=Array.isArray(a)?a[0]:a!=null?a:"";return this.buildAnnotationImagePayloadFromBuffer(s.body,o)}if(s.statusCode===204||s.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:s.statusCode})}catch(s){console.warn("Failed to fetch annotation image from Zotero companion",s)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new m.Notice("Zotero companion base URL is not set.");return}let t=`${e.replace(/\/$/,"")}/health`,n={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(n.Authorization=`Bearer ${r}`);try{let i=await this.requestLocalApiRaw(t,{headers:n,timeoutMs:3e3});if(i.statusCode===200){try{let s=JSON.parse(i.body.toString("utf8"));if(s!=null&&s.ok){new m.Notice("Zotero companion: OK.");return}}catch(s){}new m.Notice("Zotero companion responded but did not return OK.");return}if(i.statusCode===401){new m.Notice("Zotero companion: unauthorized (check token).");return}new m.Notice(`Zotero companion: HTTP ${i.statusCode}.`)}catch(i){console.warn("Zotero companion health check failed",i),new m.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new m.Notice("Opened Zotero. Go to tools \u2192 add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new m.Notice("Unable to open Zotero automatically. Open Zotero and go to tools \u2192 add-ons.")}}async spawnDetached(e){let[t,...n]=e;if(!t)throw new Error("Missing command");await new Promise((r,i)=>{let s=!1,a=(0,oe.spawn)(t,n,{detached:!0,stdio:"ignore"});a.on("error",o=>{s||(s=!0,i(o))}),a.unref(),s||(s=!0,r())})}maybeWarnMissingAnnotationApi(e,t){if(this.canUseWebApi()){console.debug("No Zotero annotations returned for attachment",{docId:e,attachmentKey:t});return}let n=e||t;!n||this.annotationWebApiWarned.has(n)||(this.annotationWebApiWarned.add(n),new m.Notice("Zotero annotations require web API access. Configure the web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
`).trim():typeof e=="number"&&Number.isFinite(e)?String(e):""}normalizeMetadataList(e){return Array.isArray(e)?e.map(t=>this.normalizeMetadataString(t)).filter(t=>t.length>0):typeof e=="string"?e.split(/[,;\n]+/).map(t=>t.trim()).filter(t=>t.length>0):[]}coerceMetadataStringValue(e){return Array.isArray(e)?e.join("; ").trim():this.normalizeMetadataString(e)}assignMetadataUpdate(e,t,n){if(t==="tags"||t==="authors"||t==="editors"){e[t]=Array.isArray(n)?n:this.normalizeMetadataList(n);return}e[t]=this.coerceMetadataStringValue(n)}metadataValuesEqual(e,t,n){if(Array.isArray(t)||Array.isArray(n)){let r=Array.isArray(t)?t:this.normalizeMetadataList(t),i=Array.isArray(n)?n:this.normalizeMetadataList(n),s=e==="tags";return this.compareMetadataLists(r,i,s)}return this.normalizeMetadataString(t)===this.normalizeMetadataString(n)}compareMetadataLists(e,t,n){let r=a=>a.replace(/\s+/g," ").trim(),i=e.map(r).filter(Boolean),s=t.map(r).filter(Boolean);if(n&&(i.sort(),s.sort()),i.length!==s.length)return!1;for(let a=0;a<i.length;a+=1)if(i[a]!==s[a])return!1;return!0}isMetadataValueEmpty(e){return Array.isArray(e)?e.length===0:this.normalizeMetadataString(e).length===0}formatMetadataValue(e){return Array.isArray(e)?e.join(`
`):this.normalizeMetadataString(e)}normalizeAnnotationText(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
`).trim():typeof e=="number"&&Number.isFinite(e)?String(e):""}normalizeAnnotationImageMime(e){let t=W(e).toLowerCase();return t?t.includes("/")?t:t==="png"?"image/png":t==="jpg"||t==="jpeg"?"image/jpeg":t==="gif"?"image/gif":t==="webp"?"image/webp":"":""}buildAnnotationImagePayloadFromBuffer(e,t){if(!e||!e.length)return null;let n=this.normalizeAnnotationImageMime(t);n||(n=this.guessAnnotationImageMime(e)||"image/png");let r=this.annotationImageExtensionFromMime(n)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(e))||"png";return{buffer:e,mime:n,ext:r}}guessAnnotationImageMime(e){return e.length>=3&&e[0]===255&&e[1]===216&&e[2]===255?"image/jpeg":e.length>=4&&e[0]===137&&e[1]===80&&e[2]===78&&e[3]===71?"image/png":e.length>=6&&e.subarray(0,3).toString("ascii")==="GIF"?"image/gif":e.length>=12&&e.subarray(0,4).toString("ascii")==="RIFF"&&e.subarray(8,12).toString("ascii")==="WEBP"?"image/webp":""}annotationImageExtensionFromMime(e){switch(e.toLowerCase()){case"image/png":return"png";case"image/jpeg":case"image/jpg":return"jpg";case"image/gif":return"gif";case"image/webp":return"webp";default:return""}}extractAnnotationImageHashFromPath(e){if(!e)return"";let n=S.default.basename(e).match(/^zrr-annotation-[A-Z0-9]{8}-([a-f0-9]{12})\./i);return n?n[1].toLowerCase():""}normalizeAnnotationTags(e){let t=this.sanitizeObsidianTags(e),n=Array.from(new Set(t));return n.sort(),n}getAnnotationColorMap(){let e=this.settings.annotationColorMap;return e&&typeof e=="object"?e:Ge.annotationColorMap}normalizeAnnotationColorKey(e){var r,i;let t=this.getAnnotationColorMap(),n=String(e||"").trim().toLowerCase();if(!n)return(r=Object.keys(t)[0])!=null?r:"gray";if(n==="grey"&&(n="gray"),t[n])return n;if(n.startsWith("#")){let s=this.inferAnnotationColorFromHex(n);if(s&&t[s])return s}return t.gray?"gray":(i=Object.keys(t)[0])!=null?i:"gray"}inferAnnotationColorFromHex(e){let t=e.replace("#","").trim();if(![3,6].includes(t.length))return null;let n=y=>y.length===1?`${y}${y}`:y,r=t.length===3?n(t[0]):t.slice(0,2),i=t.length===3?n(t[1]):t.slice(2,4),s=t.length===3?n(t[2]):t.slice(4,6),a=parseInt(r,16)/255,o=parseInt(i,16)/255,l=parseInt(s,16)/255;if(Number.isNaN(a)||Number.isNaN(o)||Number.isNaN(l))return null;let c=Math.max(a,o,l),d=Math.min(a,o,l),p=c-d,u=(c+d)/2;if(p<.08||u<.12)return"gray";let g=0;return p===0?g=0:c===a?g=(o-l)/p%6:c===o?g=(l-a)/p+2:g=(a-o)/p+4,g=Math.round(g*60),g<0&&(g+=360),g<20||g>=340?"red":g<45?"orange":g<70?"yellow":g<160?"green":g<250?"blue":g<290?"purple":g<330?"magenta":"red"}resolveAnnotationColorMeta(e){let t=this.getAnnotationColorMap(),n=t[e];return n&&n.heading&&n.callout?n:t.gray||t.yellow||{heading:"Annotations",callout:"note"}}getMetadataDecisionLabels(e,t,n,r){let i=this.isMetadataValueEmpty(t),s=this.isMetadataValueEmpty(n),a="Keep note",o="Keep Zotero";return i&&!s?(a="Delete in Zotero",o="Use Zotero value"):!i&&s&&(a="Update Zotero from note",o="Clear note"),{fieldLabel:r[e],noteLabel:a,zoteroLabel:o}}async promptMetadataBatchDecision(e){return new Promise(t=>{new rt(this.app,e.map(n=>({field:n.field,fieldLabel:n.fieldLabel,noteLabel:n.noteLabel,zoteroLabel:n.zoteroLabel,noteValue:n.noteValue,zoteroValue:n.zoteroValue})),n=>t(n)).open()})}formatAnnotationConflictTitle(e){let t=this.settings.annotationPageLabel||"Page",n=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?");return`${t} ${n} (${e.key})`}formatAnnotationConflictValue(e,t){let n=[];e.text&&n.push("Highlight:",e.text),e.comment&&(n.length&&n.push(""),n.push("Comment:",e.comment));let r=this.normalizeAnnotationTags(t);return r.length&&(n.length&&n.push(""),n.push(`Tags: ${r.map(i=>`#${i}`).join(" ")}`)),n.join(`
`).trim()}async promptAnnotationBatchDecision(e){return new Promise(t=>{new it(this.app,e,n=>t(n)).open()})}normalizeSnapshotValue(e,t){return e==="tags"?[...this.normalizeMetadataList(t)].sort():e==="authors"||e==="editors"?this.normalizeMetadataList(t):this.normalizeMetadataString(t)}setMetadataSnapshotValue(e,t,n){e[t]=n}getMetadataSnapshotCachePath(){return(0,m.normalizePath)($t)}normalizeMetadataSnapshotRecord(e){if(!e)return null;let t=e;if(typeof e=="string")try{t=JSON.parse(e)}catch(i){return null}if(!t||typeof t!="object")return null;let n={},r=["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","tags","authors","editors"];for(let i of r)Object.prototype.hasOwnProperty.call(t,i)&&this.setMetadataSnapshotValue(n,i,this.normalizeSnapshotValue(i,t[i]));return Object.keys(n).length>0?n:null}parseLegacyMetadataSnapshot(e){var n;if(!e)return null;let t=(n=e.zrr_metadata_snapshot)!=null?n:e["zrr metadata snapshot"];return t?this.normalizeMetadataSnapshotRecord(t):null}async loadMetadataSnapshotCache(){var n;let e=this.app.vault.adapter,t=this.getMetadataSnapshotCachePath();if(!await e.exists(t))return{};try{let r=await e.read(t),i=JSON.parse(r),s=(n=i==null?void 0:i.entries)!=null?n:i;if(!s||typeof s!="object"||Array.isArray(s))return{};let a={};for(let[o,l]of Object.entries(s)){let c=this.normalizeMetadataSnapshotRecord(l);c&&(a[String(o)]=c)}return a}catch(r){return console.error("Failed to read metadata snapshot cache",r),{}}}async getMetadataSnapshotCache(){return this.metadataSnapshotCache?this.metadataSnapshotCache:(this.metadataSnapshotCache=await this.loadMetadataSnapshotCache(),this.metadataSnapshotCache)}async saveMetadataSnapshotCache(e){await this.ensureFolder(re);let t=this.app.vault.adapter,n=this.getMetadataSnapshotCachePath(),r={version:1,entries:e};await t.write(n,JSON.stringify(r,null,2)),this.metadataSnapshotCache=e}async removeLegacyMetadataSnapshotFrontmatter(e,t){if(!!!(t&&(Object.prototype.hasOwnProperty.call(t,"zrr_metadata_snapshot")||Object.prototype.hasOwnProperty.call(t,"zrr metadata snapshot"))))return;let r=e.path;this.noteSyncSuppressed.add(r),this.noteMetadataSyncSuppressed.add(r);try{await this.app.fileManager.processFrontMatter(e,i=>{delete i.zrr_metadata_snapshot,delete i["zrr metadata snapshot"]})}catch(i){console.warn("Failed to remove legacy metadata snapshot",i)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(r),this.noteMetadataSyncSuppressed.delete(r)},1500)}}async getMetadataSnapshot(e,t,n){if(!e)return null;let r=await this.getMetadataSnapshotCache(),i=r[e];if(i)return i;let s=t?this.parseLegacyMetadataSnapshot(t):null;return s?(r[e]=s,await this.saveMetadataSnapshotCache(r),await this.removeLegacyMetadataSnapshotFrontmatter(n,t),s):null}serializeMetadataSnapshot(e,t){let n={};for(let r of t)e[r]!==void 0&&(n[r]=e[r]);return JSON.stringify(n)}async updateMetadataSnapshot(e,t,n,r,i,s,a){var u,g;if(!t)return;let o=i?{...i}:{};for(let y of a){let x=n[y],k=r[y];if(this.metadataValuesEqual(y,x,k)){this.setMetadataSnapshotValue(o,y,this.normalizeSnapshotValue(y,x));continue}let h=s[y];h==="note"?this.setMetadataSnapshotValue(o,y,this.normalizeSnapshotValue(y,x)):h==="zotero"&&this.setMetadataSnapshotValue(o,y,this.normalizeSnapshotValue(y,k))}let l=this.serializeMetadataSnapshot(o,a),c=await this.getMetadataSnapshotCache(),d=c[t],p=d?this.serializeMetadataSnapshot(d,a):"";if(l!==p){c[t]=o;try{await this.saveMetadataSnapshotCache(c)}catch(y){console.warn("Failed to update metadata snapshot cache",y)}await this.removeLegacyMetadataSnapshotFrontmatter(e,(g=(u=this.app.metadataCache.getFileCache(e))==null?void 0:u.frontmatter)!=null?g:null)}}async removeMetadataSnapshot(e){if(!e)return;let t=await this.getMetadataSnapshotCache();if(t[e]){delete t[e];try{await this.saveMetadataSnapshotCache(t)}catch(n){console.warn("Failed to remove metadata snapshot",n)}}}getAnnotationSnapshotCachePath(){return(0,m.normalizePath)(Vt)}async loadAnnotationSnapshotCache(){var n;let e=this.app.vault.adapter,t=this.getAnnotationSnapshotCachePath();if(!await e.exists(t))return{};try{let r=await e.read(t),i=JSON.parse(r),s=(n=i==null?void 0:i.entries)!=null?n:i;return!s||typeof s!="object"||Array.isArray(s)?{}:s}catch(r){return console.error("Failed to read annotation snapshot cache",r),{}}}async getAnnotationSnapshotCache(){return this.annotationSnapshotCache?this.annotationSnapshotCache:(this.annotationSnapshotCache=await this.loadAnnotationSnapshotCache(),this.annotationSnapshotCache)}async saveAnnotationSnapshotCache(e){await this.ensureFolder(re);let t=this.app.vault.adapter,n=this.getAnnotationSnapshotCachePath(),r={version:1,entries:e};await t.write(n,JSON.stringify(r,null,2)),this.annotationSnapshotCache=e}annotationSnapshotFromEntry(e,t){var o;let n=this.normalizeAnnotationText(e.text),r=this.normalizeAnnotationText(e.comment),i=this.normalizeAnnotationTags((o=e.tags)!=null?o:[]),s=e.imageHash?e.imageHash.toLowerCase():"",a=e.colorKey?this.normalizeAnnotationColorKey(e.colorKey):"";return t==="note"&&!r&&n?{text:"",comment:n,tags:i,image_hash:s,color_key:a}:{text:n,comment:r,tags:i,image_hash:s,color_key:a}}annotationSnapshotsEqual(e,t){if(e.text!==t.text||e.comment!==t.comment||(e.image_hash||"")!==(t.image_hash||"")||e.tags.length!==t.tags.length)return!1;for(let n=0;n<e.tags.length;n+=1)if(e.tags[n]!==t.tags[n])return!1;return!0}annotationSnapshotsEqualIgnoringImage(e,t){if(e.text!==t.text||e.comment!==t.comment||e.tags.length!==t.tags.length)return!1;for(let n=0;n<e.tags.length;n+=1)if(e.tags[n]!==t.tags[n])return!1;return!0}async getAnnotationSnapshot(e){var n;return e&&(n=(await this.getAnnotationSnapshotCache())[e])!=null?n:null}async updateAnnotationSnapshot(e,t,n){if(!e)return;let r=await this.getAnnotationSnapshotCache(),i={attachment_key:t,annotations:{}};for(let s of n)i.annotations[s.key]=this.annotationSnapshotFromEntry(s,s.annotationType);r[e]=i;try{await this.saveAnnotationSnapshotCache(r)}catch(s){console.warn("Failed to update annotation snapshot cache",s)}}async applyNoteMetadataUpdates(e,t){if(!Object.keys(t).length)return;let n=e.path;this.noteSyncSuppressed.add(n),this.noteMetadataSyncSuppressed.add(n);try{await this.app.fileManager.processFrontMatter(e,r=>{var i,s,a,o,l,c,d,p,u,g,y,x,k,h,b;"title"in t&&(r.title=(i=t.title)!=null?i:""),"short_title"in t&&(r["short title"]=(s=t.short_title)!=null?s:"",delete r.short_title,delete r.shortTitle,delete r["title-short"]),"citekey"in t&&(r.citekey=(a=t.citekey)!=null?a:"",delete r.citation_key,delete r.citationKey,delete r["citation key"],delete r["citation-key"]),"date"in t&&(r.date=(o=t.date)!=null?o:""),"abstract"in t&&(r.abstract=(l=t.abstract)!=null?l:""),"doi"in t&&(r.doi=(c=t.doi)!=null?c:""),"publication_title"in t&&(r["publication title"]=(d=t.publication_title)!=null?d:"",delete r.publication_title,delete r.publicationTitle,delete r["publication-title"]),"book_title"in t&&(r["book title"]=(p=t.book_title)!=null?p:"",delete r.book_title,delete r.bookTitle,delete r["book-title"]),"journal_abbrev"in t&&(r["journal abbrev"]=(u=t.journal_abbrev)!=null?u:"",delete r.journal_abbrev,delete r.journalAbbrev,delete r["journal-abbrev"]),"publisher"in t&&(r.publisher=(g=t.publisher)!=null?g:""),"place"in t&&(r.place=(y=t.place)!=null?y:""),"issue"in t&&(r.issue=(x=t.issue)!=null?x:""),"volume"in t&&(r.volume=(k=t.volume)!=null?k:""),"pages"in t&&(r.pages=(h=t.pages)!=null?h:""),"item_type"in t&&(r["item type"]=(b=t.item_type)!=null?b:"",delete r.item_type,delete r.itemType,delete r["item-type"]),"tags"in t&&(r.tags=Array.isArray(t.tags)?t.tags:[]),"authors"in t&&(r.authors=Array.isArray(t.authors)?t.authors:[]),"editors"in t&&(r.editors=Array.isArray(t.editors)?t.editors:[])})}catch(r){console.warn("Failed to update note frontmatter from Zotero",r)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(n),this.noteMetadataSyncSuppressed.delete(n)},1500)}}async applyZoteroMetadataUpdates(e,t,n,r,i){var a,o,l,c,d,p,u,g,y,x,k,h,b,w;if(!Object.keys(i).length)return;let s={};if("title"in i&&(s.title=(a=i.title)!=null?a:""),"short_title"in i&&(s.shortTitle=(o=i.short_title)!=null?o:""),"citekey"in i){let R=(l=i.citekey)!=null?l:"";s.citationKey=R,s.extra=this.updateExtraWithCitekey(t==null?void 0:t.extra,R)}if("date"in i&&(s.date=(c=i.date)!=null?c:""),"abstract"in i&&(s.abstractNote=(d=i.abstract)!=null?d:""),"doi"in i&&(s.DOI=(p=i.doi)!=null?p:""),"publication_title"in i&&(s.publicationTitle=(u=i.publication_title)!=null?u:""),"book_title"in i&&(s.bookTitle=(g=i.book_title)!=null?g:""),"journal_abbrev"in i&&(s.journalAbbreviation=(y=i.journal_abbrev)!=null?y:""),"publisher"in i&&(s.publisher=(x=i.publisher)!=null?x:""),"place"in i&&(s.place=(k=i.place)!=null?k:""),"issue"in i&&(s.issue=(h=i.issue)!=null?h:""),"volume"in i&&(s.volume=(b=i.volume)!=null?b:""),"pages"in i&&(s.pages=(w=i.pages)!=null?w:""),"item_type"in i){let R=this.normalizeMetadataString(i.item_type);R&&(/^[A-Za-z][A-Za-z0-9]*$/.test(R)?s.itemType=R:console.warn("Skipping invalid item_type update",{itemKey:e,itemType:R}))}if("tags"in i&&(s.tags=this.buildZoteroTags(n.tags,t==null?void 0:t.tags)),"authors"in i||"editors"in i){let R="authors"in i?n.authors:r.authors,E="editors"in i?n.editors:r.editors;s.creators=this.buildZoteroCreators(R,E,Array.isArray(t==null?void 0:t.creators)?t.creators:[])}await this.updateZoteroItemFields(e,t,s)}updateExtraWithCitekey(e,t){let n=this.normalizeMetadataString(t),r=this.normalizeMetadataString(e),s=(r?r.split(/\r?\n/):[]).filter(a=>!this.isCitekeyExtraLine(a));return n&&s.push(`Citation Key: ${n}`),s.join(`
`).trim()}isCitekeyExtraLine(e){let t=e.trim();return t?/^biblatexcitekey\s*\[[^\]]*\]\s*$/i.test(t)?!0:/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:/i.test(t):!1}async applyZoteroAnnotationUpdates(e){var t;for(let n of e){let{entry:r,note:i}=n,s=(t=r.rawValues)!=null?t:{},a=this.normalizeAnnotationText(i.text),o=this.normalizeAnnotationText(i.comment),l=String(r.annotationType||"").trim().toLowerCase(),c=l==="highlight"||l==="underline";!c&&!o&&a&&(o=a,a=""),l==="note"&&!o&&a&&(o=a,a="");let d={annotationComment:o,tags:this.buildZoteroTags(i.tags,s==null?void 0:s.tags)};c&&(d.annotationText=a);try{await this.updateZoteroItemFields(r.key,s,d),r.text=c?a:"",r.comment=o,r.tags=this.normalizeAnnotationTags(i.tags)}catch(p){console.warn(`Failed to update Zotero annotation ${r.key}`,p)}}}buildZoteroTags(e,t){let n=this.normalizeZoteroTags(e),r=n.map(o=>({tag:o,type:0})),i=new Set(n.map(o=>o.toLowerCase())),a=(Array.isArray(t)?t.map(o=>this.asRecord(o)).filter(o=>o!==null).filter(o=>Number(o.type)===1).filter(o=>typeof o.tag=="string"):[]).filter(o=>!i.has(String(o.tag).toLowerCase()));return[...r,...a]}buildZoteroCreators(e,t,n){let r=new Map;for(let o of n){let l=this.asRecord(o);if(!l||l.creatorType!=="editor"&&l.creatorType!=="seriesEditor")continue;let c=we(l);c&&r.set(c.trim().toLowerCase(),String(l.creatorType))}let i=n.map(o=>this.asRecord(o)).filter(o=>o?o.creatorType!=="author"&&o.creatorType!=="editor"&&o.creatorType!=="seriesEditor":!1),s=e.map(o=>o.trim()).filter(Boolean).map(o=>({creatorType:"author",...this.parseCreatorName(o)})),a=t.map(o=>o.trim()).filter(Boolean).map(o=>{var l;return{creatorType:(l=r.get(o.trim().toLowerCase()))!=null?l:"editor",...this.parseCreatorName(o)}});return[...s,...a,...i]}parseCreatorName(e){var s;let t=String(e||"").trim();if(!t)return{name:""};if(t.includes(",")){let[a,o]=t.split(",",2).map(l=>l.trim());if(a&&o)return{firstName:o,lastName:a};if(a)return{lastName:a}}let n=t.split(/\s+/).filter(Boolean);if(n.length===1)return{name:t};let r=(s=n.pop())!=null?s:"";return{firstName:n.join(" ").trim(),lastName:r}}extractSyncSection(e){let t=ye.exec(e);if(!t)return null;let n=e.slice(t.index+t[0].length),r=xe.exec(n);return r?n.slice(0,r.index):null}extractDocIdFromSyncMarker(e){var i;let t=ye.exec(e);if(!t)return null;let r=((i=t[0])!=null?i:"").match(/doc_id=(["']?)([^"'\s]+)\1/i);return r?r[2].trim():null}parseSyncedChunkBlocks(e){var c,d;let t=e.split(/\r?\n/),n=[],r="",i=!1,s,a=!1,o=[],l=()=>{r&&(n.push({chunkId:r,text:o.join(`
`).trim(),excludeFlag:i,pageStart:Number.isFinite(s!=null?s:NaN)?Number(s):void 0,sectionChunk:a}),r="",i=!1,s=void 0,a=!1,o=[])};for(let p of t){let u=p.match(he);if(u){l();let g=(c=u[1])!=null?c:"",y=g.match(/id=(["']?)([^"'\s]+)\1/i),x=y?y[2].trim():"";if(!x)continue;let k=$e(p);r=x,i=/\bexclude\b/i.test(g)||/\bdelete\b/i.test(g),s=Number.isFinite((d=k==null?void 0:k.pageNumber)!=null?d:NaN)?Number(k==null?void 0:k.pageNumber):void 0,a=/\bsection\b/i.test(g),o=[];continue}if(je.test(p)){l();continue}if(r){if(Re.test(p)){i=!0;continue}o.push(p)}}return l(),n}inferSectionTitleFromChunkText(e){if(!e)return"";let t=e.split(/\r?\n/);for(let n of t){let r=n.trim();if(!r)continue;let i=r.match(/^#{1,6}\s+(.+)$/);if(i!=null&&i[1])return i[1].trim();break}return""}extractAttachmentKeyFromAnnotationMarker(e){var r,i;let t=this.findAnnotationBlockRange(e);return t&&(i=(r=this.parseAnnotationBlockMarker(t.startMarker).attachmentKey)==null?void 0:r.trim())!=null?i:""}async restoreMissingChunkCacheFromNote(e,t,n,r){var x,k,h,b,w,R;let i=this.app.vault.adapter,s=(0,m.normalizePath)(`${Q}/${n}.json`);if(await i.exists(s))return s;let a=this.extractSyncSection(t);if(!a)return r&&new m.Notice(`Chunks cache missing for ${n}, and no sync section was found in the note.`),null;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return r&&new m.Notice(`Chunks cache missing for ${n}, and no chunk markers were found in the sync section.`),null;let l=[];for(let E of o){let v=String(E.chunkId||"").trim();if(!v)continue;let A=(x=this.normalizeChunkIdForNote(v,n))!=null?x:v,T=this.normalizeChunkText(String(E.text||"")),I=Number.isFinite((k=E.pageStart)!=null?k:NaN)?Number(E.pageStart):(h=_t(A))!=null?h:void 0,L={chunk_id:A,text:T,char_count:T.length};if(E.excludeFlag&&(L.excluded=!0),Number.isFinite(I!=null?I:NaN)&&(L.page_start=Number(I),L.page_end=Number(I)),E.sectionChunk){let q=this.inferSectionTitleFromChunkText(T);q&&(L.section=q)}l.push(L)}if(!l.length)return r&&new m.Notice(`Chunks cache missing for ${n}, and chunk markers contained no usable chunks.`),null;await this.ensureFolder(Q);let c=await this.getDocIndexEntry(n);c||(c=await this.hydrateDocIndexFromCache(n));let d=(w=(b=this.app.metadataCache.getFileCache(e))==null?void 0:b.frontmatter)!=null?w:{},p=this.normalizeDocIndexPdfPath((R=c==null?void 0:c.pdf_path)!=null?R:""),u=(c==null?void 0:c.attachment_key)||this.extractAttachmentKeyFromAnnotationMarker(t)||await this.resolveAttachmentKeyForDocId(n,d),g={doc_id:n,chunks:l};p&&(g.source_pdf=p),u&&(g.metadata={attachment_key:u}),await i.write(s,JSON.stringify(g,null,2));let y={doc_id:n,note_path:e.path,note_title:S.default.basename(e.path,".md")};return p&&(y.pdf_path=p),u&&(y.attachment_key=u),await this.updateDocIndex(y),r&&new m.Notice(`Restored chunk cache from note markers for ${n}.`),s}normalizeChunkText(e){return e.split(/\r?\n/).map(t=>t.replace(/\s+/g," ").trim()).filter((t,n,r)=>!(t===""&&r[n-1]==="")).join(`
...
${n}
<!-- zrr:sync-end -->`;let s=i.some(l=>{if(typeof(l==null?void 0:l.section)=="string"?l.section.trim():"")return!0;let d=typeof(l==null?void 0:l.chunk_id)=="string"?l.chunk_id.trim():"";return!!(d&&!/^p\d+$/i.test(d))}),a=[`<!-- zrr:sync-start doc_id=${e} -->`];for(let l of i){let c=typeof(l==null?void 0:l.chunk_id)=="string"?l.chunk_id.trim():"";if(!c)continue;let d=Number.isFinite((o=l==null?void 0:l.page_start)!=null?o:NaN)?Number(l.page_start):null,p=!!(l!=null&&l.excluded||l!=null&&l.exclude),g=typeof(l==null?void 0:l.text)=="string"?l.text.trim():"";if(s){let h=typeof(l==null?void 0:l.section)=="string"?l.section.trim():"",b=h?`## ${h}`:"";b&&!g.startsWith("#")&&(g=g?`${b}

${g}`:b)}let y=d!==null?s?` (${d})`:` page=${d}`:"",k=` id=${c}${s?" section":""}${y}${p?" exclude":""}`;a.push(`<!-- zrr:chunk${k} -->`),g&&a.push(g),a.push("<!-- zrr:chunk end -->"),a.push("")}return a[a.length-1]===""&&a.pop(),a.push("<!-- zrr:sync-end -->"),a.join(`
`)}async readChunkPayload(e){try{let t=await this.app.vault.adapter.read(e);return JSON.parse(t)}catch(t){return console.warn("Failed to read cached chunks JSON",t),null}}buildAnnotationChunk(e){var s;let t=[];e.text&&t.push(e.text),e.comment&&t.push(e.comment),e.tags.length&&t.push(`Tags: ${e.tags.map(a=>`#${a}`).join(" ")}`);let n=t.join(`

`).trim(),r=(s=e.pageIndex)!=null?s:0,i=e.pageLabel||(e.pageIndex?String(e.pageIndex):"");return{chunk_id:e.key,text:n,page_start:r,page_end:r,annotation_page_label:i,section:e.heading,chunk_tags:e.tags,is_annotation:!0,annotation_key:e.key,annotation_color:e.colorKey,annotation_text:e.text,annotation_comment:e.comment}}annotationChunkSignature(e){var t,n,r,i,s,a,o,l,c;return JSON.stringify({text:(t=e.text)!=null?t:"",page_start:(n=e.page_start)!=null?n:"",page_end:(r=e.page_end)!=null?r:"",section:(i=e.section)!=null?i:"",chunk_tags:Array.isArray(e.chunk_tags)?e.chunk_tags:(s=e.chunk_tags)!=null?s:"",annotation_color:(a=e.annotation_color)!=null?a:"",annotation_page_label:(o=e.annotation_page_label)!=null?o:"",annotation_text:(l=e.annotation_text)!=null?l:"",annotation_comment:(c=e.annotation_comment)!=null?c:""})}async updateAnnotationChunks(e,t,n,r){var x;let i=(r==null?void 0:r.allowDeletes)!==!1,s=(0,m.normalizePath)(`${Q}/${e}.json`),a=this.app.vault.adapter;if(!await a.exists(s))return;let o=await this.readChunkPayload(s);if(!o)return;let l=Array.isArray(o.chunks)?o.chunks:[],c=[],d=new Map;for(let k of l){let h=typeof(k==null?void 0:k.chunk_id)=="string"?k.chunk_id:"";h&&this.isAnnotationChunk(k)?d.set(h,k):c.push(k)}let p=[],u=[],g=new Set;for(let k of n){let h=this.buildAnnotationChunk(k),b=typeof h.chunk_id=="string"?h.chunk_id:"";if(!b)continue;g.add(b),p.push(h);let w=d.get(b);if(!w){u.push(b);continue}this.annotationChunkSignature(w)!==this.annotationChunkSignature(h)&&u.push(b)}let y=[];if(i)for(let k of d.keys())g.has(k)||y.push(k);else for(let[k,h]of d.entries())g.has(k)||p.push(h);if(o.chunks=[...c,...p],await a.write(s,JSON.stringify(o,null,2)),(u.length||y.length)&&await this.reindexChunkUpdates(e,s,u,y),t)try{let k=(x=this.asRecord(o.metadata))!=null?x:{};k.attachment_key!==t&&(k.attachment_key=t,o.metadata=k,await a.write(s,JSON.stringify(o,null,2)))}catch(k){}}resolveChunkFromPayload(e,t,n){let r=this.normalizeChunkIdForNote(t,n)||t,i=new Set([t,r,`${n}:${t}`]);for(let s of e){let a=typeof(s==null?void 0:s.chunk_id)=="string"?s.chunk_id:"";if(a&&i.has(a))return s}return null}async writeNoteWithSyncSuppressed(e,t){this.noteSyncSuppressed.add(e);try{await this.app.vault.adapter.write(e,t)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e)},1500)}}async resolveNotePathForDocId(e){if(!e)return null;let t=this.app.vault.adapter,n=await this.getDocIndexEntry(e);if(n!=null&&n.note_path&&await t.exists(n.note_path))return n.note_path;let i=(await this.scanNotesForDocIds(this.settings.outputNoteDir))[e];return i!=null&&i.note_path?(await this.updateDocIndex({doc_id:e,note_path:i.note_path,note_title:i.note_title}),i.note_path):null}isZoteroNoteFile(e){let t=this.app.metadataCache.getFileCache(e),n=t==null?void 0:t.frontmatter;return!!(this.getFrontmatterValue(n,"doc_id")||this.getFrontmatterValue(n,"zotero_key"))}async deleteZoteroNoteAndCacheForFile(e){var c;let t=e.path,n=await this.app.vault.read(e),r=(c=this.extractDocIdFromFrontmatter(n))!=null?c:this.extractDocIdFromSyncMarker(n);if(!r){new m.Notice("No doc_ID found in this note.");return}if(!await new Promise(d=>{new et(this.app,t,r,d).open()}))return;let s=this.app.vault.adapter,a=(0,m.normalizePath)(`${Q}/${r}.json`),o=(0,m.normalizePath)(`${le}/${r}.json`),l=[];if(await s.exists(a)){let d=await this.readChunkPayload(a);l=(Array.isArray(d==null?void 0:d.chunks)?d==null?void 0:d.chunks:[]).map(u=>typeof(u==null?void 0:u.chunk_id)=="string"?u.chunk_id:"").map(u=>u.startsWith(`${r}:`)?u.slice(r.length+1):u).filter(u=>u)}l.length>0&&await this.reindexChunkUpdates(r,a,[],l);try{await s.exists(a)&&await s.remove(a),await s.exists(o)&&await s.remove(o),await this.removeDocIndexEntry(r),await this.app.fileManager.trashFile(e),new m.Notice(`Deleted note and cache for ${r}.`)}catch(d){console.error("Failed to delete note and cached data",d),new m.Notice("Failed to delete note or cached data. See console for details.")}}async deleteZoteroNoteAndCache(){let e=this.app.workspace.getActiveViewOfType(m.MarkdownView);if(!e||!e.file){new m.Notice("No active Zotero note found.");return}await this.deleteZoteroNoteAndCacheForFile(e.file)}formatRedisSearchResults(e){var u;let t=(u=this.asRecord(e))!=null?u:{},n=typeof t.total=="number"?t.total:0,r=typeof t.query=="string"?t.query:"",i=typeof t.raw_query=="string"?t.raw_query:"",s=t.field_types&&typeof t.field_types=="object"?t.field_types:null,a=!!t.fallback_used,o=typeof t.fallback_reason=="string"?t.fallback_reason:"",l=Array.isArray(t.fallback_queries)?t.fallback_queries:[],c=Array.isArray(t.fallback_failed_fields)?t.fallback_failed_fields:[],d=Array.isArray(t.results)?t.results:[],p=[];if(p.push(`Query: ${i||r}`),r&&i&&r!==i&&p.push(`Expanded: ${r}`),p.push(`Total matches: ${n}`),s&&Object.keys(s).length>0){let g=Object.keys(s).sort().map(y=>{let x=s[y],k=typeof x=="string"||typeof x=="number"||typeof x=="boolean"?String(x):"";return`${y}:${k}`});p.push(`Field types: {${g.join(", ")}}`)}if(a&&p.push(`Fallback: ${o||"true"}`),l.length){p.push("Fallback queries:");for(let g of l)p.push(`  - ${g}`)}if(c.length&&p.push(`Fallback failed fields: ${c.join(", ")}`),p.push(""),!d.length)return p.push("(no results)"),p.join(`
`);for(let g of d){let y=String(g.doc_id||"").trim(),x=String(g.chunk_id||"").trim(),k=String(g.page_start||"").trim(),h=String(g.page_end||"").trim(),b=String(g.title||"").trim(),w=String(g.section||"").trim(),R=String(g.score||"").trim(),E=String(g.authors||"").trim(),v=String(g.item_type||"").trim(),A=String(g.year||"").trim(),T=String(g.tags||"").trim(),I=String(g.chunk_tags||"").trim(),L=String(g.attachment_key||"").trim(),q=String(g.source_pdf||"").trim(),M=String(g.text||"").replace(/\s+/g," ").trim(),z=M.length>220?`${M.slice(0,220)}\u2026`:M,$=[y];x&&$.push(x),(k||h)&&$.push(`p.${k||"?"}-${h||"?"}`),p.push($.filter(Boolean).join(" \u2022 ")),R&&p.push(`  score: ${R}`),b&&p.push(`  title: ${b}`),E&&p.push(`  authors: ${E}`),A&&p.push(`  year: ${A}`),v&&p.push(`  item_type: ${v}`),T&&p.push(`  tags: ${T}`),I&&p.push(`  chunk_tags: ${I}`),L&&p.push(`  attachment_key: ${L}`),w&&p.push(`  section: ${w}`),q&&p.push(`  source_pdf: ${q}`),z&&p.push(`  ${z}`),p.push("")}return p.join(`
`)}searchRedisIndex(){new Ye(this.app,this,this.lastRedisSearchTerm).open()}async runRedisSearch(e){let t=e.trim();if(!t)return"(no query)";if(this.lastRedisSearchTerm=t,!await this.ensureRedisAvailable("index search"))return"Redis is not reachable. Please start Redis Stack and try again.";let n=this.getPluginDir(),r=S.default.join(n,"tools","search_redis.py"),i=["--query",t,"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--limit","10"];try{await this.ensureBundledTools();let s=await this.runPythonWithOutput(r,i),a=JSON.parse(s||"{}");return this.formatRedisSearchResults(a)||"(no results)"}catch(s){return console.error("Redis search failed",s),"Redis search failed. See console for details."}}async showRedisDiagnostics(){if(!await this.ensureRedisAvailable("diagnostics"))return;let e=this.getPluginDir(),t=S.default.join(e,"tools","redis_diagnostics.py"),n=["--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName()];try{await this.ensureBundledTools();let r=await this.runPythonWithOutput(t,n),i=JSON.parse(r||"{}"),s=`\`\`\`json
${JSON.stringify(i,null,2)}
\`\`\``;new Pe(this.app,"Redis diagnostics",s||"(empty)").open()}catch(r){console.error("Redis diagnostics failed",r),new m.Notice("Redis diagnostics failed. See console for details.")}}async resolveUniqueBaseName(e,t){let n=this.app.vault.adapter,r=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${e}.md`),i=(0,m.normalizePath)(`${this.settings.outputPdfDir}/${e}.pdf`),s=await n.exists(r),a=this.settings.copyPdfToVault?await n.exists(i):!1;return s||a?`${e}-${t}`:e}async searchZoteroItems(e){let t=e.trim(),n=["data,meta"];for(let r of n){let i=new URLSearchParams;i.set("itemType","-attachment"),i.set("limit","25"),i.set("include",r),t?i.set("q",t):(i.set("sort","dateAdded"),i.set("direction","desc"));let s=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/top?${i.toString()}`);try{let a=await this.requestLocalApi(s,`Zotero search failed for ${s}`),o=JSON.parse(a.toString("utf8"));return Array.isArray(o)?this.normalizeZoteroSearchResults(o):[]}catch(a){console.warn("Failed to search Zotero via local API",a)}}if(!this.canUseWebApi())throw new Error("Zotero search failed for all include modes.");return this.searchZoteroItemsWeb(t)}async hasProcessableAttachment(e){var i;let t=(i=e.data)!=null?i:e,n=typeof e.key=="string"?e.key:W(t.key);return n?!!await Te(t,n,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)}):!1}async fetchZoteroChildrenLocal(e,t={}){let n=new URLSearchParams;t.includeAnnotationImage&&n.set("include","annotationImage");let r=n.toString()?`?${n.toString()}`:"",i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/children${r}`),s=await this.requestLocalApi(i,`Zotero children request failed for ${i}`);return JSON.parse(s.toString("utf8"))}async fetchZoteroChildrenWeb(e,t={}){if(!this.canUseWebApi()&&(!await this.ensureWebApiLibraryId()||!this.canUseWebApi()))throw new Error("Zotero Web API is not configured.");let n=new URLSearchParams;t.includeAnnotationImage&&n.set("include","annotationImage");let r=n.toString()?`?${n.toString()}`:"",i=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/children${r}`),s=await this.requestWebApi(i,`Zotero Web API children request failed for ${i}`);return JSON.parse(s.toString("utf8"))}async fetchZoteroChildren(e){try{return await this.fetchZoteroChildrenLocal(e)}catch(t){if(console.warn("Failed to fetch Zotero children from local API",t),!this.canUseWebApi())throw t;return this.fetchZoteroChildrenWeb(e)}}buildZoteroUrl(e){return`${this.settings.zoteroBaseUrl.replace(/\/$/,"")}${e}`}canUseWebApi(){return!!((this.settings.webApiBaseUrl||"").trim()&&this.settings.webApiKey&&this.settings.webApiLibraryId)}async ensureWebApiLibraryId(){var r,i,s,a,o;let e=(this.settings.webApiBaseUrl||"").trim(),t=(this.settings.webApiKey||"").trim();if(!e||!t||(this.settings.webApiLibraryId||"").trim())return!!(this.settings.webApiLibraryId||"").trim();let n=this.buildWebApiUrl("/keys/current");try{let l=await this.requestWebApi(n,`Zotero Web API key lookup failed for ${n}`),c=JSON.parse(l.toString("utf8")),d=(o=(s=(r=c==null?void 0:c.userID)!=null?r:c==null?void 0:c.userId)!=null?s:(i=c==null?void 0:c.data)==null?void 0:i.userID)!=null?o:(a=c==null?void 0:c.data)==null?void 0:a.userId;return d?(this.settings.webApiLibraryId=String(d),await this.saveSettings(),console.debug("Resolved Zotero Web API user ID from key",{userId:d}),!0):!1}catch(l){return console.warn("Failed to resolve Zotero Web API user ID",l),!1}}getWebApiLibraryPath(){let e=(this.settings.webApiLibraryId||"").trim();return e?`${this.settings.webApiLibraryType==="group"?"groups":"users"}/${e}`:""}buildWebApiUrl(e){return`${this.settings.webApiBaseUrl.replace(/\/$/,"")}${e}`}isZoteroLocalApiRequest(e){let t=(this.settings.zoteroBaseUrl||"").trim();if(!t)return!1;try{let n=new URL(e),r=new URL(t),i=n.port||(n.protocol==="https:"?"443":"80"),s=r.port||(r.protocol==="https:"?"443":"80");if(n.protocol!==r.protocol||n.hostname!==r.hostname||i!==s)return!1;let a=r.pathname.replace(/\/$/,"");return!a||a==="/"?!0:n.pathname===a||n.pathname.startsWith(`${a}/`)}catch(n){return!1}}notifyZoteroLocalApiConnectionError(){this.notifyZoteroApiOnce("Zotero connection error. Start Zotero and enable 'Allow other applications on this computer to communicate with Zotero' in Settings -> Advanced -> General.")}requestLocalApiRaw(e,t={}){return new Promise((n,r)=>{var y,x,k;let i=this.isZoteroLocalApiRequest(e),s=new URL(e),a=s.protocol==="https:"?_n.default:Pt.default,o=(y=t.method)!=null?y:"GET",l={Accept:"*/*",...(x=t.headers)!=null?x:{}},c=t.body,d=Number.isFinite((k=t.timeoutMs)!=null?k:NaN)?Number(t.timeoutMs):0,p=null;if(c!==void 0&&l["Content-Length"]===void 0){let h=Buffer.isBuffer(c)?c.length:Buffer.byteLength(c);l["Content-Length"]=String(h)}let u=a.request({method:o,hostname:s.hostname,port:s.port||void 0,path:`${s.pathname}${s.search}`,headers:l},h=>{let b=[];h.on("data",w=>b.push(Buffer.from(w))),h.on("end",()=>{var R;p&&clearTimeout(p),i&&(this.lastZoteroApiNotice=null);let w=Buffer.concat(b);n({statusCode:(R=h.statusCode)!=null?R:0,headers:h.headers,body:w})})});d>0&&(p=setTimeout(()=>{u.destroy(new Error(`Request timed out after ${d}ms`))},d)),u.on("error",h=>{p&&clearTimeout(p),i&&this.notifyZoteroLocalApiConnectionError();let b=h instanceof Error?h:new Error(typeof h=="string"?h:"Request failed");r(b)}),c!==void 0&&u.write(c),u.end()})}async requestLocalApi(e,t){let n=await this.requestLocalApiRaw(e);if(n.statusCode>=400){let r=n.body.toString("utf8");throw new Error(`${t!=null?t:"Request failed"}, status ${n.statusCode}: ${r||"no response body"}`)}if(n.statusCode>=300)throw new Error(`${t!=null?t:"Request failed"}, status ${n.statusCode}`);return n.body}async requestLocalApiWithBody(e,t,n,r,i){let s=JSON.stringify(n),a=await this.requestLocalApiRaw(e,{method:t,headers:r,body:s});if(a.statusCode>=400){let o=a.body.toString("utf8");throw new Error(`${i!=null?i:"Request failed"}, status ${a.statusCode}: ${o||"no response body"}`)}if(a.statusCode>=300)throw new Error(`${i!=null?i:"Request failed"}, status ${a.statusCode}`);return{statusCode:a.statusCode,body:a.body}}async requestWebApi(e,t){let n={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},r=await this.requestLocalApiRaw(e,{headers:n});if(r.statusCode>=400){let i=r.body.toString("utf8");throw new Error(`${t!=null?t:"Request failed"}, status ${r.statusCode}: ${i||"no response body"}`)}if(r.statusCode>=300)throw new Error(`${t!=null?t:"Request failed"}, status ${r.statusCode}`);return r.body}requestWebApiRaw(e,t={}){var r;let n={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey,...(r=t.headers)!=null?r:{}};return this.requestLocalApiRaw(e,{...t,headers:n})}async requestWebApiWithBody(e,t,n,r,i){let s=JSON.stringify(n),a=await this.requestLocalApiRaw(e,{method:t,headers:r,body:s});if(a.statusCode>=400){let o=a.body.toString("utf8");throw new Error(`${i!=null?i:"Request failed"}, status ${a.statusCode}: ${o||"no response body"}`)}if(a.statusCode>=300)throw new Error(`${i!=null?i:"Request failed"}, status ${a.statusCode}`);return{statusCode:a.statusCode,body:a.body}}bufferToArrayBuffer(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}async annotateChunkJsonWithAttachmentKey(e,t){if(t)try{let n=await this.app.vault.adapter.read(e),r=JSON.parse(n);if(!r||typeof r!="object")return;let i=r.metadata&&typeof r.metadata=="object"?r.metadata:{};i.attachment_key=t,r.metadata=i,await this.app.vault.adapter.write(e,JSON.stringify(r,null,2))}catch(n){console.warn("Failed to annotate chunks JSON with attachment key",n)}}async updateChunkJsonSourcePdf(e,t){if(t)try{let n=await this.app.vault.adapter.read(e),r=JSON.parse(n);if(!r||typeof r!="object")return;r.source_pdf=t,await this.app.vault.adapter.write(e,JSON.stringify(r,null,2))}catch(n){console.warn("Failed to update chunks JSON source_pdf",n)}}buildPdfLinkFromSourcePath(e){if(!e)return"";let t=this.toVaultRelativePath(e);return t?`[[${t}]]`:`[PDF](${(0,Ct.pathToFileURL)(e).toString()})`}toVaultRelativePath(e){if(!e)return"";if(!S.default.isAbsolute(e)&&!/^[A-Za-z]+:\/\//.test(e))return(0,m.normalizePath)(e);let t=S.default.normalize(this.getVaultBasePath()),n=S.default.normalize(e),r=t.endsWith(S.default.sep)?t:`${t}${S.default.sep}`;if(!n.startsWith(r)){let i=S.default.normalize(ln),s=i.endsWith(S.default.sep)?i:`${i}${S.default.sep}`;return n.startsWith(s)?(0,m.normalizePath)(S.default.relative(i,n)):""}return(0,m.normalizePath)(S.default.relative(t,n))}normalizeDocIndexPdfPath(e){return e&&(this.toVaultRelativePath(e)||e)}async isFileAccessible(e){if(!e)return!1;try{return await ee.promises.access(e),!0}catch(t){return!1}}deriveVaultPdfRelativePath(e,t,n){let r=this.toVaultRelativePath(e);if(r&&r.startsWith((0,m.normalizePath)(this.settings.outputPdfDir)))return r;let i=this.sanitizeFileName(t)||n;return(0,m.normalizePath)(`${this.settings.outputPdfDir}/${i}.pdf`)}async recoverMissingPdfFromAttachment(e,t,n,r,i,s,a){let o=await Te(t,n,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});if(!o&&i&&(o={key:i}),!o)return null;let l=o.key||i,c=o.filePath;if(!this.settings.copyPdfToVault&&c&&await this.isFileAccessible(c))return{sourcePdf:c,attachmentKey:l};try{await this.ensureFolder(this.settings.outputPdfDir)}catch(g){return console.error("Failed to create PDF output folder",g),null}let d=this.deriveVaultPdfRelativePath(e,s,r),p;try{if(c&&await this.isFileAccessible(c))p=await ee.promises.readFile(c);else if(l)p=await ot(l,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:ee.promises.readFile}),!this.settings.copyPdfToVault&&a&&new m.Notice("Local PDF path unavailable; copied PDF into vault for processing.");else return null}catch(g){return console.error("Failed to read or download PDF attachment",g),null}try{await this.app.vault.adapter.writeBinary(d,this.bufferToArrayBuffer(p))}catch(g){return console.error("Failed to write recovered PDF into vault",g),null}return{sourcePdf:this.getAbsoluteVaultPath(d),attachmentKey:l}}buildPdfLinkForNote(e,t,n){return!e&&!t?"":!this.settings.copyPdfToVault&&t?`[PDF](${this.buildZoteroDeepLink(n!=null?n:"",t)})`:this.buildPdfLinkFromSourcePath(e)}async maybeCreateOcrLayeredPdf(e,t,n){if(!this.settings.createOcrLayeredPdf||!this.settings.copyPdfToVault||!e||!((t==null?void 0:t.ocr_used)===!0))return null;if(!this.toVaultRelativePath(e))return console.warn("OCR layered PDF requires a vault-local PDF"),null;try{await this.ensureFolder(this.settings.outputPdfDir)}catch(c){return console.warn("Failed to create OCR PDF output folder",c),null}let i=`${e}.ocr.tmp`,s=typeof(t==null?void 0:t.languages)=="string"?t.languages:"",a=(typeof n=="string"&&n.trim()?n:s||"eng").trim(),o=this.getPluginDir(),l=S.default.join(o,"tools","ocr_layered_pdf.py");try{return this.showStatusProgress("Creating OCR PDF...",0),await this.runPythonStreaming(l,["--pdf",e,"--out-pdf",i,"--language",a,"--progress"],c=>{let d=this.asRecord(c),p=typeof(d==null?void 0:d.total)=="number"?d.total:0,u=typeof(d==null?void 0:d.current)=="number"?d.current:0;if((d==null?void 0:d.type)==="progress"&&p>0){let g=Math.round(u/p*100);this.showStatusProgress(`Creating OCR PDF ${u}/${p}`,g)}},()=>{}),await ee.promises.rename(i,e),e}catch(c){return console.warn("OCR layered PDF creation failed",c),null}}getMainLeaf(){let e=new Set(this.app.workspace.getLeavesOfType(Ce)),t=this.app.workspace.getLeavesOfType("markdown").find(r=>!e.has(r));if(t)return t;let n=this.app.workspace.getLeaf(!1);return n&&!e.has(n)?n:this.app.workspace.getLeaf("tab")}async openNoteInMain(e){let t=(0,m.normalizePath)(e),n=this.app.vault.getAbstractFileByPath(t),r=this.getMainLeaf();if(n instanceof m.TFile){await r.openFile(n,{active:!0});return}await this.app.workspace.openLinkText(t,"",!1)}findChunkLineInText(e,t){if(!e||!t)return null;let n=this.escapeRegExp(t),r=new RegExp(`<!--\\s*zrr:chunk\\b[^>]*\\bid=(["']?)${n}\\1[^>]*-->`,"i"),i=e.split(`
`);for(let s=0;s<i.length;s+=1)if(r.test(i[s]))return s;return null}findAnnotationLineInText(e,t){if(!e||!t)return null;let n=this.escapeRegExp(t),r=new RegExp(`^\\s*>?\\s*\\^${n}\\b`,"i"),i=e.split(`
`);for(let s=0;s<i.length;s+=1)if(r.test(i[s]))return s;return null}extractChunkIdFromAnchor(e){if(!e)return"";let t=String(e).replace(/\\\|/g,"|").trim(),n=t.indexOf("|");return(n>=0?t.slice(0,n):t).trim()}async openNoteAtChunk(e,t){let n=this.extractChunkIdFromAnchor(t);if(!e||!n)return!1;await this.openNoteInMain(e);let i=this.getMainLeaf().view;if(!(i instanceof m.MarkdownView))return!1;let s=i.editor,a=this.normalizeChunkIdForNote(n)||n,o=this.findChunkLineInText(s.getValue(),a);return o===null?(new m.Notice(`Chunk ${a} not found in note.`),!1):(s.setCursor({line:o,ch:0}),s.scrollIntoView({from:{line:o,ch:0},to:{line:o,ch:0}},!0),!0)}async openNoteAtAnnotation(e,t,n,r){let i=this.buildAnnotationBlockId(t,n,r);if(!e||!i)return!1;await this.openNoteInMain(e);let a=this.getMainLeaf().view;if(!(a instanceof m.MarkdownView))return!1;let o=a.editor,l=this.findAnnotationLineInText(o.getValue(),i);return l===null?(new m.Notice(`Annotation ${t} not found in note.`),!1):(o.setCursor({line:l,ch:0}),o.scrollIntoView({from:{line:l,ch:0},to:{line:l,ch:0}},!0),!0)}async openInternalLinkInMain(e){let t=this.getMainLeaf(),[n,...r]=e.split("#"),i=n||"",s=r.join("#").trim(),a="zrr-chunk:",o=null;if(i){let l=Array.from(new Set([i,i.trimEnd(),i.trim()]));for(let c of l){if(!c)continue;let d=this.app.metadataCache.getFirstLinkpathDest(c,"");if(d instanceof m.TFile){o=d;break}}}if(o instanceof m.TFile){let l=s.startsWith(a)?this.extractChunkIdFromAnchor(s.slice(a.length).trim()):"";if(l&&await this.openNoteAtChunk(o.path,l))return;await t.openFile(o,{active:!0}),e.includes("#")&&!l&&await this.openLinkTextInLeaf(t,e);return}await this.openLinkTextInLeaf(t,e)}async openLinkTextInLeaf(e,t){let n=e;if(typeof n.openLinkText=="function"){await n.openLinkText(t,"",{active:!0});return}await this.app.workspace.openLinkText(t,"","tab")}async openNoteInNewTab(e){let t=(0,m.normalizePath)(e);await this.app.workspace.openLinkText(t,"","tab")}async openPdfInMain(e,t){if(!e)return!1;let n=this.toVaultRelativePath(e);if(n){let r=t?`#page=${t}`:"";return await this.app.workspace.openLinkText(`${n}${r}`,"","tab"),!0}try{return window.open((0,Ct.pathToFileURL)(e).toString()),!0}catch(r){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,t,n,r){if(t){let i=new URLSearchParams;n&&i.set("page",n),r&&i.set("annotation",r);let s=i.toString()?`?${i.toString()}`:"";return`zotero://open-pdf/library/items/${t}${s}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let n=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(n))return n}formatCitationsMarkdown(e){return e.length?e.map(n=>this.formatCitationMarkdown(n)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e){var d,p,u,g,y;let t=e.doc_id||"?",n=this.formatCitationPageLabel(e),r=e.annotation_key||this.extractAnnotationKey(e.chunk_id),i=e.attachment_key||((p=(d=this.docIndex)==null?void 0:d[e.doc_id||""])==null?void 0:p.attachment_key),s=e.page_start?String(e.page_start):"",a=(g=(u=this.docIndex)==null?void 0:u[e.doc_id||""])!=null?g:null,o=this.resolveCitationTitle(a,(y=a==null?void 0:a.note_path)!=null?y:null,e.doc_id),l=this.formatCitationLabel(o,n),c=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&(a!=null&&a.note_path)){if(r){let x=s||(e.page_end?String(e.page_end):"0"),k=this.buildNoteAnnotationLink(a.note_path,r,i||"",x,l);return k?`- ${k}`:`- ${this.buildNoteLink(a.note_path,l)}`}if(c&&!r)return`- ${this.buildNoteChunkLink(a.note_path,c,l)}`}if(i){let x=this.buildZoteroDeepLink(t,i,s,r);return`- [${l}](${x})`}return`- ${l}`}buildNoteChunkLink(e,t,n){let r=(0,m.normalizePath)(e).replace(/\.md$/i,""),i=`zrr-chunk:${t}`,s=this.escapeWikiLabel(n);return`[[${r}#${i}|${s}]]`}buildNoteLink(e,t){let n=(0,m.normalizePath)(e).replace(/\.md$/i,""),r=this.escapeWikiLabel(t);return`[[${n}|${r}]]`}buildNoteAnnotationLink(e,t,n,r,i){let s=this.buildAnnotationBlockId(t,n,r);if(!s)return null;let a=(0,m.normalizePath)(e).replace(/\.md$/i,""),o=this.escapeWikiLabel(i);return`[[${a}#^${s}|${o}]]`}buildAnnotationBlockId(e,t,n){let r=(e||"").trim().toUpperCase(),i=(t||"").trim().toUpperCase();if(!r||!i)return null;let s=(n||"").trim()||"0";return`${r}a${i}p${s}`}escapeWikiLabel(e){return e?e.replace(/\|/g," ").replace(/\[/g,"").replace(/\]/g,"").trim():""}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,m.normalizePath)(`${re}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var n;let e=this.app.vault.adapter,t=this.getDocIndexPath();if(!await e.exists(t))return{};try{let r=await e.read(t),i=JSON.parse(r);if(i&&typeof i=="object"){let s=(n=i.entries)!=null?n:i;if(Array.isArray(s)){let a={};for(let l of s)l!=null&&l.doc_id&&(a[String(l.doc_id)]=l);let o=!1;for(let l of Object.values(a))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(a),a}if(s&&typeof s=="object"){let a=s,o=!1;for(let l of Object.values(a))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(a),a}}}catch(r){console.error("Failed to read doc index",r)}return{}}async saveDocIndex(e){await this.ensureFolder(re);let t=this.app.vault.adapter,n=this.getDocIndexPath(),r={version:1,entries:e};await t.write(n,JSON.stringify(r,null,2)),this.docIndex=e}async pruneDocIndexOrphans(){var c;let e=this.app.vault.adapter,t=await this.getDocIndex(),n=new Set(await this.listDocIds(le)),r=new Set(await this.listDocIds(Q)),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),s=0,a=0,o=!1,l=new Date().toISOString();for(let d of Object.keys(t)){let p=t[d],u=!1,g=p!=null&&p.note_path?p.note_path.trim():"";if(g&&await e.exists(g))u=!0;else if((c=i[d])!=null&&c.note_path){u=!0;let x=i[d];x.note_path&&x.note_path!==p.note_path&&(p.note_path=x.note_path,a+=1,o=!0),x.note_title&&x.note_title!==p.note_title&&(p.note_title=x.note_title,a+=1,o=!0),a>0&&(p.updated_at=l)}let y=n.has(d)||r.has(d);!u&&!y&&(delete t[d],s+=1,o=!0)}return o&&await this.saveDocIndex(t),{removed:s,updated:a}}async updateDocIndex(e){var i;let t=await this.getDocIndex(),n=(i=t[e.doc_id])!=null?i:{doc_id:e.doc_id},r={...n,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&n.note_path&&(r.note_path=n.note_path),e.note_title===void 0&&n.note_title&&(r.note_title=n.note_title),e.zotero_title===void 0&&n.zotero_title&&(r.zotero_title=n.zotero_title),e.short_title===void 0&&n.short_title&&(r.short_title=n.short_title),e.pdf_path===void 0&&n.pdf_path&&(r.pdf_path=n.pdf_path),e.attachment_key===void 0&&n.attachment_key&&(r.attachment_key=n.attachment_key),typeof r.pdf_path=="string"&&(r.pdf_path=this.normalizeDocIndexPdfPath(r.pdf_path)),t[e.doc_id]=r,await this.saveDocIndex(t)}async removeDocIndexEntry(e){let t=await this.getDocIndex();if(!t[e]){await this.removeMetadataSnapshot(e);return}delete t[e],await this.saveDocIndex(t),await this.removeMetadataSnapshot(e)}async hydrateDocIndexFromCache(e){var a,o;if(!e)return null;let t=this.app.vault.adapter,n=await this.getDocIndexEntry(e),r={},i=(0,m.normalizePath)(`${le}/${e}.json`);if(await t.exists(i))try{let l=await t.read(i),c=JSON.parse(l),d=(o=(a=c==null?void 0:c.data)!=null?a:c)!=null?o:{},p=typeof d.title=="string"?d.title:"";p&&(r.zotero_title=p);let u=ve(d);if(u&&(r.short_title=u),!r.note_title||!r.note_path){let g=this.sanitizeFileName(p)||e,y=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${g}.md`),x=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${g}-${e}.md`),k="";await t.exists(y)?k=y:await t.exists(x)&&(k=x),k&&(r.note_path=k,r.note_title=S.default.basename(k,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!r.note_title&&(n!=null&&n.note_path)&&(r.note_title=S.default.basename(n.note_path,".md"));let s=(0,m.normalizePath)(`${Q}/${e}.json`);if(await t.exists(s))try{let l=await t.read(s),c=JSON.parse(l);typeof(c==null?void 0:c.source_pdf)=="string"&&(r.pdf_path=c.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(r).length>0&&await this.updateDocIndex({doc_id:e,...r}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var n;return e&&(n=(await this.getDocIndex())[e])!=null?n:null}async inferNotePathFromCache(e){var r,i;let t=this.app.vault.adapter,n=(0,m.normalizePath)(`${le}/${e}.json`);if(!await t.exists(n))return"";try{let s=await t.read(n),a=JSON.parse(s),o=(i=(r=a==null?void 0:a.data)!=null?r:a)!=null?i:{},l=typeof o.title=="string"?o.title:"",c=this.sanitizeFileName(l)||e,d=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${c}.md`),p=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${c}-${e}.md`);if(await t.exists(d))return d;if(await t.exists(p))return p}catch(s){console.error("Failed to infer note path from cache",s)}return""}async rebuildNoteFromCacheForDocId(e,t){var I,L,q,M,z,$;try{await this.ensureBundledTools()}catch(D){return t&&new m.Notice("Failed to sync bundled tools. See console for details."),console.error(D),!1}let n=this.app.vault.adapter,r=(0,m.normalizePath)(`${le}/${e}.json`),i=(0,m.normalizePath)(`${Q}/${e}.json`);if(!await n.exists(r)||!await n.exists(i))return t&&new m.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let s;try{let D=await n.read(r);s=JSON.parse(D)}catch(D){return t&&new m.Notice("Failed to read cached item JSON."),console.error(D),this.clearStatusProgress(),!1}let a;try{let D=await n.read(i);a=JSON.parse(D)}catch(D){return t&&new m.Notice("Failed to read cached chunks JSON."),console.error(D),this.clearStatusProgress(),!1}let o=(I=s.data)!=null?I:s,l=typeof o.title=="string"?o.title:"",c=((q=(L=s.key)!=null?L:o.key)!=null?q:e).toString(),d=await this.getDocIndexEntry(e),p=typeof((M=this.asRecord(a==null?void 0:a.metadata))==null?void 0:M.attachment_key)=="string"?String((z=this.asRecord(a==null?void 0:a.metadata))==null?void 0:z.attachment_key):d==null?void 0:d.attachment_key,u=typeof a.source_pdf=="string"?a.source_pdf:"";if(!u||!await this.isFileAccessible(u)){let D=await this.recoverMissingPdfFromAttachment(u,o,c,e,p,l,t);if(!D)return t&&new m.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;u=D.sourcePdf,D.attachmentKey&&(p=D.attachmentKey),await this.updateChunkJsonSourcePdf(i,u)}let g=await this.resolveLanguageHint(o,c),y=this.buildDoclingLanguageHint(g!=null?g:void 0),x="";if(d!=null&&d.note_path&&await n.exists(d.note_path)&&(x=(0,m.normalizePath)(d.note_path)),!x){let D=this.sanitizeFileName(l)||e,Z=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${D}.md`),V=await n.exists(Z)?D:await this.resolveUniqueBaseName(D,e);x=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${V}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let D=this.getLogFileRelativePath(),Z=(0,m.normalizePath)(S.default.dirname(D));Z&&await this.ensureFolder(Z);let V=this.getSpellcheckerInfoRelativePath(),B=(0,m.normalizePath)(S.default.dirname(V));B&&await this.ensureFolder(B)}}catch(D){return t&&new m.Notice("Failed to create notes folder."),console.error(D),this.clearStatusProgress(),!1}let k=this.getPluginDir(),h=S.default.join(k,"tools","docling_extract.py"),b=S.default.join(k,"tools","index_redisearch.py"),w=null,R=null,E=D=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=D)};try{this.showStatusProgress(this.formatStatusLabel("Docling extraction...",w),0);let D=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(h,await this.buildDoclingArgs(u,e,i,x,y,!0),B=>this.handleDoclingProgress(B,w),()=>{},D,"docling_extract",E),this.recreateMissingNotesProcess=null,w=await this.readDoclingQualityLabel(i),p&&await this.annotateChunkJsonWithAttachmentKey(i,p);let Z=await this.readDoclingMetadata(i),V=await this.maybeCreateOcrLayeredPdf(u,Z,y);V&&(u=V,R=V,await this.updateChunkJsonSourcePdf(i,V))}catch(D){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(t&&new m.Notice("Docling extraction failed. See console for details."),console.error(D),this.clearStatusProgress(),!1)}let v=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;if(!await this.ensureRedisAvailable("rebuild"))t&&new m.Notice("Redis is unavailable; skipping indexing for this note.");else try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",w),0);let D=["--chunks-json",this.getAbsoluteVaultPath(i),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(D),this.appendEmbedContextArgs(D),this.settings.embedIncludeMetadata&&D.push("--embed-include-metadata"),this.appendChunkTaggingArgs(D,{allowRegenerate:!1}),await this.runPythonStreaming(b,D,Z=>{let V=this.asRecord(Z),B=typeof(V==null?void 0:V.total)=="number"?V.total:0,F=typeof(V==null?void 0:V.current)=="number"?V.current:0;if((V==null?void 0:V.type)==="progress"&&B>0){let j=Math.round(F/B*100),K=typeof V.message=="string"&&V.message.trim()?V.message:`Indexing chunks ${F}/${B}`,U=this.formatStatusLabel(K,w);this.showStatusProgress(U,j)}},()=>{},v,"index_redisearch",E),this.recreateMissingNotesProcess=null}catch(D){if(this.recreateMissingNotesAbort)return this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1;t&&new m.Notice("Redissearch indexing failed; note will still be rebuilt."),console.error(D)}let T=R?this.buildPdfLinkFromSourcePath(R):this.buildPdfLinkForNote(u,d==null?void 0:d.attachment_key,e);try{let D=await this.app.vault.adapter.read(x),Z=await this.readChunkPayload(i),V=this.buildSyncedDoclingContent(e,Z,D),B=await this.buildNoteMarkdown(o,($=s.meta)!=null?$:{},e,T,p,x,r,V);await this.writeNoteWithSyncSuppressed(x,B);let F=this.app.vault.getAbstractFileByPath(x);F instanceof m.TFile&&this.scheduleNoteAnnotationSync(F,2e3,"save")}catch(D){return t&&new m.Notice("Failed to finalize note Markdown."),console.error(D),this.clearStatusProgress(),!1}try{let D=ve(o);await this.updateDocIndex({doc_id:e,note_path:x,note_title:S.default.basename(x,".md"),zotero_title:l,short_title:D||void 0,pdf_path:u})}catch(D){console.error("Failed to update doc index",D)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],t=await this.fetchZoteroGroupOptions();return t.length&&e.push(...t),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),t=[],n=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!n)return e&&t.push({value:e,label:e}),t;let r=(this.settings.embedApiKey||"").trim(),i=await this.fetchModelIds(n,r);if(i.length){let s=i.filter(o=>/embed/i.test(o)),a=s.length?s:i;t.push(...a.map(o=>({value:o,label:o})))}return!t.length&&e&&t.push({value:e,label:e}),t.sort((s,a)=>s.label.localeCompare(a.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,t,n){let r=n==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),i=[],s=(e||"").trim().replace(/\/$/,"");if(!s)return r&&i.push({value:r,label:r}),i;let a=(t||"").trim(),o=await this.fetchModelIds(s,a);if(o.length){let l=o.filter(d=>!/embed/i.test(d)),c=l.length?l:o;i.push(...c.map(d=>({value:d,label:d})))}return!i.length&&r&&i.push({value:r,label:r}),i.sort((l,c)=>l.label.localeCompare(c.label))}detectEmbeddingProvider(e){let t=e.toLowerCase();return t.includes("anthropic")?"anthropic":t.includes("openrouter")?"openrouter":t.includes("ollama")||t.includes(":11434")?"ollama":t.includes("openai")?"openai":"generic"}async fetchModelIds(e,t){let n=this.detectEmbeddingProvider(e);try{if(n==="anthropic")return await this.fetchAnthropicModels(e,t);let r=await this.fetchOpenAiCompatibleModels(e,t);return!r.length&&n==="ollama"?await this.fetchOllamaModels(e):r}catch(r){return console.warn("Failed to fetch models",r),[]}}async fetchOpenAiCompatibleModels(e,t){let n=`${e}/models`,r={};t&&(r.Authorization=`Bearer ${t}`);let i=await this.requestLocalApiRaw(n,{headers:r});if(i.statusCode>=400)throw new Error(`Model list request failed (${i.statusCode})`);let s=JSON.parse(i.body.toString("utf8"));return this.extractModelIds(s)}async fetchOllamaModels(e){let n=`${e.replace(/\/v1\/?$/,"")}/api/tags`,r=await this.requestLocalApiRaw(n);if(r.statusCode>=400)throw new Error(`Ollama tags request failed (${r.statusCode})`);let i;try{i=JSON.parse(r.body.toString("utf8"))}catch(a){return console.warn("Failed to parse Ollama tags response",a),[]}if(!i||typeof i!="object")return[];let s=i.models;return Array.isArray(s)?s.map(a=>this.extractModelId(a)).filter(a=>!!a):[]}async fetchAnthropicModels(e,t){if(!t)return[];let n=`${e}/models`,r={"x-api-key":t,"anthropic-version":"2023-06-01"},i=await this.requestLocalApiRaw(n,{headers:r});if(i.statusCode>=400)throw new Error(`Anthropic model list request failed (${i.statusCode})`);let s=JSON.parse(i.body.toString("utf8"));return this.extractModelIds(s)}extractModelIds(e){var r,i,s;if(Array.isArray(e))return e.map(a=>this.extractModelId(a)).filter(a=>!!a);if(!e||typeof e!="object")return[];let t=e,n=(s=(i=(r=t.data)!=null?r:t.models)!=null?i:t.model)!=null?s:t.items;return Array.isArray(n)?n.map(a=>this.extractModelId(a)).filter(a=>!!a):[]}asRecord(e){return!e||typeof e!="object"?null:e}extractModelId(e){var i,s,a;if(!e||typeof e!="object")return null;let t=e,n=(a=(s=(i=t.id)!=null?i:t.name)!=null?s:t.model)!=null?a:t.identifier;return typeof n!="string"?null:n.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,t=r=>{for(let i of r)e.has(i.value)||e.set(i.value,i.label)};if(await this.warnIfZoteroLocalApiUnavailable("Zotero groups"))try{let r=this.buildZoteroUrl("/users/0/groups"),i=await this.requestLocalApi(r,`Zotero groups fetch failed for ${r}`);t(this.parseZoteroGroupOptions(i))}catch(r){console.warn("Failed to fetch Zotero groups from local API",r)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let r=(this.settings.webApiLibraryId||"").trim();if(r)try{let i=this.buildWebApiUrl(`/users/${r}/groups`),s=await this.requestWebApi(i,`Zotero Web API groups fetch failed for ${i}`);t(this.parseZoteroGroupOptions(s))}catch(i){console.warn("Failed to fetch Zotero groups from Web API",i)}}return Array.from(e.entries()).map(([r,i])=>({value:r,label:i})).sort((r,i)=>r.label.localeCompare(i.label))}parseZoteroGroupOptions(e){var r,i,s,a,o;let t;try{t=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(t))return[];let n=[];for(let l of t){if(!l||typeof l!="object")continue;let c=(r=l.data)!=null?r:l,d=(s=(i=c.id)!=null?i:l.id)!=null?s:c.key;if(!d)continue;let p=typeof d=="string"||typeof d=="number"?String(d).trim():"";if(!p)continue;let u=(o=(a=c.name)!=null?a:l.name)!=null?o:p,g=(typeof u=="string"||typeof u=="number")&&String(u).trim()||p;n.push({value:`groups/${p}`,label:`Group: ${g}`})}return n}async ensureFolder(e){let t=this.app.vault.adapter,n=(0,m.normalizePath)(e).split("/").filter(Boolean),r="";for(let i of n)r=r?`${r}/${i}`:i,await t.exists(r)||await t.mkdir(r)}async buildNoteMarkdown(e,t,n,r,i,s,a,o){let l=`[[${a}]]`,c=this.settings.copyPdfToVault&&r.startsWith("[["),d=i?this.buildZoteroDeepLink(n,i):"",p=d||r,u=c?r:d||r,g=u?c?`PDF: !${u}`:`PDF: ${u}`:"",y=g?`${g}

`:"",x=await this.buildTemplateVars(e,t,n,p,l);x.pdf_block=y,x.pdf_line=g,x.docling_markdown=o;let k=(this.settings.noteBodyTemplate||"").trim();/{{\s*annotation_block\s*}}/i.test(k)&&i?x.annotation_block=await this.buildAnnotationBlockForAttachment(n,i,s):x.annotation_block="";let b=this.ensureDocIdInFrontmatter(await this.renderFrontmatter(e,t,n,p,l,x),n),w=b?`---
${b}
---

`:"",R=`${y}${o}`,E=k?this.renderTemplate(k,x,R,{appendDocling:!0}):R;return`${w}${E}`}async buildAnnotationBlockForAttachment(e,t,n){let r=await this.fetchZoteroAnnotationsForDoc(e,t);return r.attachmentKey&&r.attachmentKey!==t&&await this.updateDocIndex({doc_id:e,attachment_key:r.attachmentKey}),await this.attachAnnotationImages(e,r.attachmentKey,r.annotations,n),this.buildAnnotationBlock(e,r.attachmentKey,r.annotations)}buildAnnotationBlock(e,t,n){var p;let r=`<!-- zrr:annotations-start doc_id=${e} attachment_key=${t} -->`,i="<!-- zrr:annotations-end -->";if(!n.length)return`${r}
${i}`;let s=this.getAnnotationColorMap(),a=Object.keys(s),o=new Map;for(let u of n){let g=u.colorKey||this.normalizeAnnotationColorKey(u.colorKey),y=(p=o.get(g))!=null?p:[];y.push(u),o.set(g,y)}let l=[r],c=new Set,d=[...a,...Array.from(o.keys()).filter(u=>!a.includes(u))];for(let u of d){let g=o.get(u);if(!g||!g.length)continue;c.add(u);let{heading:y}=this.resolveAnnotationColorMeta(u);l.push("",`## ${y}`),g.sort((x,k)=>{var A,T;let h=(x.sortToken||"").trim(),b=(k.sortToken||"").trim();if(h&&b&&h!==b)return h.localeCompare(b,void 0,{numeric:!0,sensitivity:"base"});if(h&&!b)return-1;if(!h&&b)return 1;let w=Number.isFinite(x.sortIndex),R=Number.isFinite(k.sortIndex);if(w&&R&&x.sortIndex!==k.sortIndex)return x.sortIndex-k.sortIndex;let E=(A=x.pageIndex)!=null?A:0,v=(T=k.pageIndex)!=null?T:0;return E!==v?E-v:x.key.localeCompare(k.key)});for(let x of g)l.push(...this.formatAnnotationCallout(x,t,e))}return l.push("",i),l.join(`
`).trim()}formatAnnotationCallout(e,t,n){let r=this.settings.annotationPageLabel||"Page",i=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?"),s=e.pageIndex?String(e.pageIndex):"",a=this.buildZoteroDeepLink(n,t,s,e.key),l=[`> [!${e.callout}] ${r} [${i}](${a})`];e.imagePath&&l.push(`> ![[${e.imagePath}]]`);let c=p=>{if(p)for(let u of p.split(/\r?\n/))l.push(u.trim()?`> ${u}`:">")};c(e.text),e.comment&&(l.push(">","> ---"),c(e.comment)),e.tags.length&&l.push(`> **Tags:** ${e.tags.map(p=>`#${p}`).join(" ")}`);let d=e.pageIndex?String(e.pageIndex):"0";return l.push(`> ^${e.key}a${t}p${d}`),l.push(""),l}findAnnotationBlockRange(e){let t=Gn.exec(e);if(!t)return null;let n=e.slice(t.index+t[0].length),r=Wn.exec(n);if(!r)return null;let i=t.index,s=t.index+t[0].length+r.index+r[0].length,a=n.slice(0,r.index);return{start:i,end:s,block:a,startMarker:t[0]}}parseAnnotationBlockMarker(e){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i),n=e.match(/attachment_key=(["']?)([^"'\s]+)\1/i);return{docId:t?t[2].trim():void 0,attachmentKey:n?n[2].trim():void 0}}parseAnnotationBlock(e,t){let n=e.split(/\r?\n/),r=[],i=0;for(;i<n.length;){if(!n[i].trim().startsWith("> [!")){i+=1;continue}let a=[];for(;i<n.length&&n[i].trim().startsWith(">");)a.push(n[i]),i+=1;let o=this.parseAnnotationCallout(a,t);o&&r.push(o)}return r}parseAnnotationImageLine(e){var o,l;let t=e.trim();if(!t)return null;let n="",r=t.match(/!\[\[([^\]]+)\]\]/);r&&(n=r[1].trim());let i=n?null:t.match(/!\[[^\]]*\]\(([^)]+)\)/);i&&(n=i[1].trim());let s=n?null:t.match(/<img[^>]+src=["']([^"']+)["']/i);if(s&&(n=s[1].trim()),!n)return null;let a=(l=(o=n.split("|")[0])==null?void 0:o.trim())!=null?l:"";return a?{path:a,hash:this.extractAnnotationImageHashFromPath(a)}:null}parseAnnotationCallout(e,t){if(!e.length)return null;let n=e[0].replace(/^>\s?/,"").trim(),r=n.match(/\[!([^\]]+)\]/),i=r?r[1].trim():"note",s=n.match(/\((zotero:\/\/open-pdf\/library\/items\/[^)]+)\)/i),a="",o=t,l="",c=null;if(s){let b=s[1],w=b.match(/items\/([A-Z0-9]{8})/i);w&&(o=w[1]);let R=b.match(/annotation=([A-Z0-9]{8})/i);R&&(a=R[1]);let E=b.match(/page=(\d+)/i);E&&(c=Number(E[1]));let v=n.match(/\[([^\]]+)\]\(zotero:\/\//i);v&&(l=v[1].trim())}let d=[],p=[],u=[],g=!1,y="",x="";for(let b=1;b<e.length;b+=1){let w=e[b].replace(/^>\s?/,""),R=w.trim();if(!R){g?u.push(""):p.push("");continue}let E=this.parseAnnotationImageLine(R);if(E){y=E.path,x=E.hash;continue}if(R.startsWith("^")){let v=R.match(/^\^([A-Z0-9]{8})a([A-Z0-9]{8})p(\d+)/i);v&&(a=v[1],o=v[2],c=Number(v[3]));continue}if(/^(\*\*tags:\*\*|tags:)/i.test(R)){d.push(R);continue}if(R==="---"){g=!0;continue}g?u.push(w):p.push(w)}let k=d.join(" "),h=k?k.replace(/\*\*tags:\*\*/i,"").replace(/tags:/i,"").split(/[\s,]+/).map(b=>b.trim().replace(/^#+/,"")).filter(Boolean):[];return a?{key:a,attachmentKey:o,pageLabel:l,pageIndex:c,callout:i,text:this.normalizeAnnotationText(p.join(`
`)),comment:this.normalizeAnnotationText(u.join(`
`)),tags:this.normalizeAnnotationTags(h),imagePath:y||void 0,imageHash:x||void 0}:null}replaceAnnotationBlock(e,t){let n=this.findAnnotationBlockRange(e);if(!n)return null;let r=e.slice(0,n.start),i=e.slice(n.end),s=t.trim()?`${t.trim()}
`:`${t}`;return`${r}${s}${i}`.replace(/\n{4,}/g,`


`)}async renderFrontmatter(e,t,n,r,i,s){var d;let a=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!a.trim())return"";let o=s!=null?s:await this.buildTemplateVars(e,t,n,r,i),l=this.renderTemplate(a,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let t=e.split(/\r?\n/),n=[],r=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,i=/^[ \t]+-\s*(.*)$/,s=new Set(["abstract"]),a=l=>l===""||l==='""'||l==="''",o=0;for(;o<t.length;){let l=t[o],c=l.match(r);if(!c){n.push(l),o+=1;continue}let d=c[1].trim(),p=c[2].trim();if(s.has(d)){n.push(l),o+=1;continue}if(!a(p)){n.push(l),o+=1;continue}let u=o+1,g=[];for(;u<t.length&&t[u].match(i);)g.push(t[u]),u+=1;if(g.length===0){for(o=u;o<t.length&&t[o].trim()==="";)o+=1;continue}let y=g.filter(x=>{let k=x.match(i);if(!k)return!1;let h=k[1].trim();return!a(h)});if(y.length>0&&n.push(l,...y),o=u,y.length===0)for(;o<t.length&&t[o].trim()==="";)o+=1}for(;n.length>0&&n[n.length-1].trim()==="";)n.pop();return n.join(`
`).trim()}renderTemplate(e,t,n,r={}){let i=e.replace(/{{\s*([a-z0-9_]+)\s*}}/gi,(s,a)=>{var o;return(o=t[a])!=null?o:""});return r.appendDocling&&!e.includes("{{docling_markdown}}")&&t.docling_markdown&&(i=`${i}

${t.docling_markdown}`),i.trim()?i:n}async buildTemplateVars(e,t,n,r,i){let s=W(e.title),a=W(e.shortTitle),o=W(e.date),l=typeof(t==null?void 0:t.parsedDate)=="string"?t.parsedDate:"",c=ft(l||o),d=/^\d{4}$/.test(c)?c:"",p=Array.isArray(e.creators)?e.creators:[],u=p.filter(Y=>Y.creatorType==="author").map(Y=>we(Y)),g=u.join("; "),y=p.filter(Y=>Y.creatorType==="editor"||Y.creatorType==="seriesEditor").map(Y=>we(Y)),x=y.join("; "),k=Array.isArray(e.tags)?e.tags.map(Y=>{var ue;return typeof Y=="string"?Y:(ue=this.asRecord(Y))==null?void 0:ue.tag}).filter(Y=>typeof Y=="string"&&Y.length>0):[],h=this.sanitizeObsidianTags(k),b=h.join("; "),w=await this.resolveCollectionTitles(e),R=w.join("; "),E=this.toObsidianLinks(w),v=E.join("; "),A=W(e.itemType),T=typeof(t==null?void 0:t.creatorSummary)=="string"?t.creatorSummary:"",I=W(e.publicationTitle),L=W(e.bookTitle),q=W(e.journalAbbreviation),M=W(e.volume),z=W(e.issue),$=W(e.pages),D=W(e.dateAdded),Z=W(e.dateModified),V=typeof e.key=="string"?e.key:n,B=W(e.DOI);B||(B=Kt(e));let F=Ke(e,t),j=null;(!B||!a||!F)&&(j=await this.fetchZoteroItemCsl(V)),B||(B=Jt(j)),a||(a=Ht(j)),F||(F=mt(j));let K=W(e.ISBN),U=W(e.ISSN),G=W(e.publisher),H=W(e.place),ae=W(e.url),Ae=W(e.language),dt=W(e.abstractNote),Me=this.buildZoteroDeepLink(V),ce=Array.from(new Set([F,a,B].map(Y=>String(Y||"").trim()).filter(Y=>Y.length>0))),pt=ce.join("; "),X={doc_id:n,zotero_key:typeof e.key=="string"?e.key:n,item_link:Me,citekey:F,title:s,short_title:a,date:o,year:c,year_number:d,authors:g,editors:x,aliases:pt,tags:b,collection_title:R,collection_titles:R,collections_links:v,item_type:A,creator_summary:T,publication_title:I,book_title:L,journal_abbrev:q,volume:M,issue:z,pages:$,date_added:D,date_modified:Z,doi:B,isbn:K,issn:U,publisher:G,place:H,url:ae,language:Ae,abstract:dt,pdf_link:r,item_json:i};for(let[Y,ue]of Object.entries(X)){let se=this.escapeYamlString(ue);X[`${Y}_yaml`]=se,X[`${Y}_quoted`]=se,X[`${Y}_text`]=se}return X.authors_yaml_list=this.toYamlList(u),X.editors_yaml_list=this.toYamlList(y),X.tags_yaml_list=h.length>0?this.toYamlList(h):"",X.aliases_yaml_list=ce.length>0?this.toYamlList(ce):"",X.collections_yaml_list=this.toYamlList(w),X.collections_links_yaml_list=this.toYamlList(E),X.tags_raw=k.join("; "),X.tags_raw_yaml=this.escapeYamlString(X.tags_raw),X.tags_raw_yaml_list=k.length>0?this.toYamlList(k):"",X.authors_list=X.authors_yaml_list,X.editors_list=X.editors_yaml_list,X.tags_list=X.tags_yaml_list,X.aliases_list=X.aliases_yaml_list,X.collections_list=X.collections_yaml_list,X.collections_links_list=X.collections_links_yaml_list,X}escapeYamlString(e){return`"${String(e).replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n")}"`}toYamlList(e){return e.length?e.map(t=>`  - ${this.escapeYamlString(t)}`).join(`
`):'  - ""'}sanitizeObsidianTags(e){let t=this.settings.tagSanitizeMode||"kebab",n=t==="replace"?"kebab":t;return e.map(r=>this.sanitizeObsidianTag(r,n)).filter(r=>r.length>0)}sanitizeObsidianTag(e,t){let n=String(e||"").trim();if(!n)return"";let r=n.replace(/^#+/,"");if(t==="none")return r;let i=o=>!/^\d+$/.test(o),a=(o=>r.split("/").map(d=>{let u=d.replace(/[^\p{L}\p{N}]+/gu," ").split(/\s+/).filter(Boolean);if(!u.length)return"";if(o==="camel"||o==="pascal"){let[y,...x]=u;return[o==="pascal"?y.charAt(0).toUpperCase()+y.slice(1):y.charAt(0).toLowerCase()+y.slice(1),...x.map(h=>h.charAt(0).toUpperCase()+h.slice(1))].join("")}let g=o==="snake"?"_":"-";return u.join(g)}).filter(Boolean).join("/").replace(/\/{2,}/g,"/").replace(/^\/+|\/+$/g,""))(t);return a&&i(a)?a:""}normalizeZoteroTags(e){let t=new Map;for(let n of e){let r=this.normalizeZoteroTag(n);if(!r)continue;let i=r.toLowerCase();t.has(i)||t.set(i,r)}return Array.from(t.values())}normalizeZoteroTag(e){let t=String(e||"").trim();if(!t)return"";let n=t.replace(/^#+/,"").trim();if(!n)return"";let r=n.split("/").map(i=>{let s=i.trim();return s?(s=s.replace(/[_-]+/g," "),s=s.replace(/([A-Z]+)([A-Z][a-z])/g,"$1 $2"),s=s.replace(/([a-z\\d])([A-Z])/g,"$1 $2"),s=s.replace(/([a-zA-Z])(\\d)/g,"$1 $2"),s=s.replace(/(\\d)([a-zA-Z])/g,"$1 $2"),s=s.replace(/\s+/g," ").trim(),s):""}).filter(Boolean);return r.length?r.join("/"):""}toObsidianLinks(e){return e.map(t=>String(t||"").trim()).filter(t=>t.length>0).map(t=>t.startsWith("[[")&&t.endsWith("]]")?t:`[[${t}]]`)}getVaultBasePath(){var r;let e=this.app.vault.adapter;if(e instanceof m.FileSystemAdapter)return e.getBasePath();let t=e,n=(r=t.getBasePath)==null?void 0:r.call(t);if(n)return n;throw new Error("Vault base path is unavailable.")}expandPathValue(e){let t=(e||"").trim();if(!t)return t;let n=t;return n==="~"?n=Ie.default.homedir():(n.startsWith("~/")||n.startsWith("~\\"))&&(n=S.default.join(Ie.default.homedir(),n.slice(2))),n=n.replace(/\$([A-Za-z_][A-Za-z0-9_]*)|\$\{([^}]+)\}/g,(r,i,s)=>{let a=i||s,o=a?process.env[a]:void 0;return o!==void 0?o:r}),n=n.replace(/%([^%]+)%/g,(r,i)=>{let s=process.env[i];return s!==void 0?s:r}),n}resolvePythonPath(){return this.resolveUserPath(this.settings.pythonPath||"")}getPythonRuntimeMode(){return this.settings.pythonRuntime==="local"?"local":"worker"}usePythonWorker(){return this.getPythonRuntimeMode()==="worker"}getPythonWorkerCacheDir(){return S.default.join(this.getVaultBasePath(),re,"python-worker-cache")}getPythonWorkerApiPort(e){let n=(Number.isFinite(e!=null?e:NaN)?Number(e):this.getRedisPortFromUrl())+jn;return n>=1024&&n<=65535?n:qn}getPythonWorkerApiBaseUrl(e){let t=Number.isFinite(e!=null?e:NaN)?Number(e):this.getPythonWorkerApiPort();return`http://${zn}:${t}`}getPythonWorkerApiPortFromContext(e){let t=Number.parseInt(String(e.composeEnv.ZRR_WORKER_PORT||""),10);return Number.isFinite(t)&&t>0?t:this.getPythonWorkerApiPort()}nextPythonWorkerRequestId(e){this.pythonWorkerRequestSeq+=1;let t=e.replace(/[^a-zA-Z0-9_.-]/g,"_");return`${Date.now().toString(36)}-${this.pythonWorkerRequestSeq.toString(36)}-${t}`}logPythonWorkerTiming(e,t){console.debug("[zrr-python-worker]",e,t)}async isPythonWorkerApiHealthy(e,t=1500){let n=`${this.getPythonWorkerApiBaseUrl(this.getPythonWorkerApiPortFromContext(e))}/health`;try{let r=await this.requestLocalApiRaw(n,{headers:{Accept:"application/json"},timeoutMs:t});if(r.statusCode<200||r.statusCode>=300)return!1;let i=JSON.parse(r.body.toString("utf8"));return!!(i!=null&&i.ok)}catch(r){return!1}}getWorkerToolName(e){let t=S.default.resolve(this.getPluginDir(),"tools"),n=S.default.resolve(e);if(S.default.dirname(n)!==t)return null;let r=S.default.basename(n);return!r.endsWith(".py")||r.includes(S.default.sep)?null:r}getComposeServiceNamesForCurrentRuntime(){return this.usePythonWorker()?[_e,lt]:[_e]}toContainerPath(e,t,n){let r=S.default.relative(e,t);if(r.startsWith("..")||S.default.isAbsolute(r))return null;let i=r.split(S.default.sep).filter(Boolean);return i.length?S.default.posix.join(n,...i):n}mapPathForPythonWorker(e){var i,s;if(!S.default.isAbsolute(e))return e;let t=S.default.normalize(e),n=S.default.normalize(this.getPluginDir()),r=S.default.normalize(this.getVaultBasePath());return(s=(i=this.toContainerPath(n,t,Mn))!=null?i:this.toContainerPath(r,t,ln))!=null?s:e}getWorkerHostAlias(){return(this.settings.dockerPath||"").toLowerCase().includes("podman")?"host.containers.internal":"host.docker.internal"}mapUrlForPythonWorker(e){let t=(e||"").trim();if(!t)return e;let n;try{n=new URL(t)}catch(r){return e}return!["http:","https:","redis:","rediss:","redis+tls:"].includes(n.protocol)||!this.isLocalRedisHost(n.hostname||"")?e:n.protocol==="redis:"||n.protocol==="rediss:"||n.protocol==="redis+tls:"?(n.hostname=_e,n.port="6379",n.toString()):(n.hostname=this.getWorkerHostAlias(),n.toString())}mapPythonArgsForWorker(e){return e.map((t,n)=>{if(n>0&&e[n-1]==="--redis-url")return this.mapUrlForPythonWorker(t);if(t.startsWith("--redis-url=")){let s=t.slice(12);return`--redis-url=${this.mapUrlForPythonWorker(s)}`}let r=this.mapUrlForPythonWorker(t);if(r!==t)return r;if(!S.default.isAbsolute(t))return t;let i=this.mapPathForPythonWorker(t);if(i===t)throw new Error(`Python worker cannot access path '${t}'. Keep files under your vault or plugin directory.`);return i})}resolveUserPath(e,t){let n=this.expandPathValue(e);return!n||!(n.includes("/")||n.includes("\\"))||S.default.isAbsolute(n)?n:t&&(n.startsWith("./")||n.startsWith(".\\"))?S.default.join(t,n.slice(2)):S.default.join(Ie.default.homedir(),n)}getPluginDir(){var r;let e=this.getVaultBasePath(),t=(r=this.manifest.dir)!=null?r:this.manifest.id;if(!t)throw new Error("Plugin directory is unavailable.");let n=S.default.isAbsolute(t)?t:S.default.join(e,t);return S.default.normalize(n)}async ensureBundledTools(){let e=this.getPluginDir(),t=S.default.join(e,"tools");await ee.promises.mkdir(t,{recursive:!0});for(let[n,r]of Object.entries(nn)){let i=S.default.join(t,n),s=!0;try{await ee.promises.readFile(i,"utf8")===r&&(s=!1)}catch(a){}s&&await ee.promises.writeFile(i,r,"utf8")}}async migrateCachePaths(){let e="zotero/items",t="zotero/chunks",n=le,r=Q,i=this.app.vault.adapter,s=(0,m.normalizePath)(e),a=(0,m.normalizePath)(t),o=(0,m.normalizePath)(n),l=(0,m.normalizePath)(r),c=o.split("/").slice(0,-1).join("/"),d=l.split("/").slice(0,-1).join("/");c&&await this.ensureFolder(c),d&&await this.ensureFolder(d);let p=await i.exists(s),u=await i.exists(a),g=await i.exists(o),y=await i.exists(l);p&&!g&&await i.rename(s,o),u&&!y&&await i.rename(a,l)}getAbsoluteVaultPath(e){let t=this.getVaultBasePath(),n=S.default.isAbsolute(e)?e:S.default.join(t,e);return S.default.normalize(n)}async resolveAttachmentOutputDir(e){let t=e?S.default.isAbsolute(e)?this.toVaultRelativePath(e):(0,m.normalizePath)(e):"";if(!t)return null;let n=this.app.fileManager;if(!(n!=null&&n.getAvailablePathForAttachment))return null;try{let r=`zrr-image-${Date.now()}.png`,i=await n.getAvailablePathForAttachment(r,t);if(!i)return null;let s=S.default.isAbsolute(i)?i:this.getAbsoluteVaultPath(i),a=S.default.normalize(S.default.dirname(s)),o=S.default.normalize(this.getVaultBasePath()),l=this.toVaultRelativePath(a);return!l&&a!==o?null:{absolute:a,relative:l}}catch(r){return console.warn("Failed to resolve attachment output dir",r),null}}async resolveAnnotationImageOutputDir(e){let t=null;if(e&&(t=await this.resolveAttachmentOutputDir(e)),!t){let i=(0,m.normalizePath)(this.settings.outputNoteDir||"");if(!i)return null;t={absolute:this.getAbsoluteVaultPath(i),relative:i}}let n=(0,m.normalizePath)(S.default.join(t.relative||"","zrr-annotations")),r=S.default.normalize(S.default.join(t.absolute,"zrr-annotations"));return n&&await this.ensureFolder(n),{absolute:r,relative:n}}async buildDoclingArgs(e,t,n,r,i,s=!1){let a=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",t,"--out-json",this.getAbsoluteVaultPath(n),"--out-md",this.getAbsoluteVaultPath(r),"--chunking",this.settings.chunkingMode,"--ocr",a];s&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),this.settings.forcePerPageOcr&&o.push("--force-per-page-ocr"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),i&&o.push("--language-hint",i),this.settings.enableLlmCleanup&&(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars)));let l=this.getPluginDir(),c=S.default.join(l,"tools","ocr_wordlist.txt");if((0,ee.existsSync)(c)&&o.push("--enable-dictionary-correction","--dictionary-path",c),this.settings.enableFileLogging){let p=this.getLogFileAbsolutePath();p&&o.push("--log-file",p);let u=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());u&&o.push("--spellchecker-info-out",u)}let d=await this.resolveAttachmentOutputDir(r);return d&&(d.relative&&await this.ensureFolder(d.relative),o.push("--image-output-dir",d.absolute)),this.appendOcrEngineArgs(o),o}appendOcrEngineArgs(e){let t=this.settings.ocrEngine,n=(this.settings.paddleApiKey||"").trim(),r=(this.settings.paddleVlApiUrl||"").trim(),i=(this.settings.paddleStructureApiUrl||"").trim(),s=o=>{e.push("--prefer-ocr-engine",o,"--fallback-ocr-engine",o)},a=()=>{e.push("--no-paddle-vl-api","--no-paddle-structure-api")};switch(t){case"tesseract":s("tesseract"),e.push("--no-paddle-vl","--no-paddle-structure-v3"),a();break;case"paddle_structure_local":s("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl"),a();break;case"paddle_vl_local":s("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3"),a();break;case"paddle_structure_api":s("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl","--no-paddle-vl-api"),n?(e.push("--paddle-structure-api","--paddle-structure-api-token",n),i&&e.push("--paddle-structure-api-url",i)):e.push("--no-paddle-structure-api");break;case"paddle_vl_api":s("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3","--no-paddle-structure-api"),n?(e.push("--paddle-vl-api","--paddle-vl-api-token",n),r&&e.push("--paddle-vl-api-url",r)):e.push("--no-paddle-vl-api");break;default:a();break}}appendEmbedSubchunkArgs(e){let t=this.settings.embedSubchunkChars;Number.isFinite(t)&&e.push("--embed-subchunk-chars",String(Math.max(0,Math.trunc(t))));let n=this.settings.embedSubchunkOverlap;Number.isFinite(n)&&e.push("--embed-subchunk-overlap",String(Math.max(0,Math.trunc(n))))}appendEmbedContextArgs(e){let t=this.settings.embedContextWindow;Number.isFinite(t)&&e.push("--embed-context-window",String(Math.max(0,Math.trunc(t))));let n=this.settings.embedContextChars;Number.isFinite(n)&&e.push("--embed-context-chars",String(Math.max(0,Math.trunc(n))))}appendChunkTaggingArgs(e,t){if((t==null?void 0:t.allowRegenerate)===!1||!this.settings.enableChunkTagging)return;let n=(this.settings.llmCleanupBaseUrl||"").trim(),r=(this.settings.llmCleanupModel||"").trim();if(!n||!r)return;e.push("--generate-chunk-tags","--tag-base-url",n,"--tag-model",r);let i=(this.settings.llmCleanupApiKey||"").trim();i&&e.push("--tag-api-key",i),e.push("--tag-temperature",String(this.settings.llmCleanupTemperature))}getRedisDataDir(){let e=this.resolveUserPath(process.env.ZRR_DATA_DIR||"");if(e)return e;let t=this.resolveUserPath(this.settings.redisDataDirOverride||"",this.getVaultBasePath());return!this.settings.autoAssignRedisPort&&t?t:S.default.join(this.getVaultBasePath(),re,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return S.default.join(e,"tools","docker-compose.yml")}prependBinaryDirToPath(e,t){if(!t||!S.default.isAbsolute(t))return;let n=S.default.dirname(t),r=e.PATH||"";(r?r.split(S.default.delimiter):[]).includes(n)||(e.PATH=r?`${n}${S.default.delimiter}${r}`:n)}async resolveDockerPath(){var c;let e=(c=this.settings.dockerPath)==null?void 0:c.trim(),t=e?this.resolveUserPath(e):"",n=["/opt/homebrew/bin/docker","/usr/local/bin/docker","/usr/bin/docker","/Applications/Docker.app/Contents/Resources/bin/docker"],r=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"],i=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"],s=[];t&&s.push(t);let a=t?this.getContainerCliKind(t):"docker",o=a==="podman-compose"?[i,r,n]:a==="podman"?[r,i,n]:[n,r,i];if(!t||t==="docker"||t==="podman"||t==="podman-compose")for(let d of o)s.push(...d);for(let d of s)if(S.default.isAbsolute(d))try{if(await this.isContainerCliAvailable(d))return d}catch(p){}let l=[t,a==="podman"?"podman":"docker",a==="podman"?"docker":"podman","podman-compose"].filter(d=>!!(d&&d.trim()));for(let d of l)if(await this.isContainerCliAvailable(d))return d;return t||"docker"}async isContainerCliAvailable(e){return new Promise(t=>{let n=(0,oe.spawn)(e,["--version"]);n.on("error",()=>t(!1)),n.on("close",r=>t(r===0))})}getContainerCliKind(e){let t=S.default.basename(e);return t==="podman-compose"?"podman-compose":t.includes("podman")?"podman":"docker"}async isContainerDaemonRunning(e){let t=this.getContainerCliKind(e),n=e,r=["info"];if(t==="podman-compose"){let i=await this.resolvePodmanBin();if(!i)return!1;n=i}return new Promise(i=>{let s=(0,oe.spawn)(n,r),a=!1,o=c=>{a||(a=!0,i(c))},l=setTimeout(()=>{s.kill(),o(!1)},2e3);s.on("error",()=>{clearTimeout(l),o(!1)}),s.on("close",c=>{clearTimeout(l),o(c===0)})})}getContainerDaemonHint(e){let t=this.getContainerCliKind(e);return t==="podman"||t==="podman-compose"?"Podman machine not running. Run `podman machine start`.":"Docker Desktop is not running. Start Docker Desktop."}async supportsComposeSubcommand(e){return new Promise(t=>{let n=(0,oe.spawn)(e,["compose","version"]);n.on("error",()=>t(!1)),n.on("close",r=>t(r===0))})}async findPodmanComposePath(){let e=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"];for(let t of e)try{return await ee.promises.access(t),t}catch(n){}return await this.isContainerCliAvailable("podman-compose")?"podman-compose":null}async resolvePodmanBin(){let e=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"];for(let t of e)if(await this.isContainerCliAvailable(t))return t;return await this.isContainerCliAvailable("podman")?"podman":null}async resolveComposeCommand(e){let t=S.default.basename(e);if(t==="podman-compose")return{command:e,argsPrefix:[]};if(t==="podman"){let n=await this.findPodmanComposePath();return n?{command:n,argsPrefix:[]}:await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}return await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}async buildComposeEnvironment(e,t,n){var a;let r={...process.env};if(this.prependBinaryDirToPath(r,e),this.prependBinaryDirToPath(r,t.command),S.default.basename(t.command)==="podman-compose"){let o=await this.resolvePodmanBin();o&&(r.PODMAN_BIN=o,this.prependBinaryDirToPath(r,o))}let i=(n==null?void 0:n.dataDir)||this.getRedisDataDir(),s=(a=n==null?void 0:n.redisPort)!=null?a:this.getRedisPortFromUrl();return r.ZRR_DATA_DIR=this.toComposePath(i),this.applyComposePortEnvironment(r,s),r.ZRR_VAULT_DIR=this.toComposePath(this.getVaultBasePath()),r.ZRR_PLUGIN_DIR=this.toComposePath(this.getPluginDir()),r.ZRR_WORKER_CACHE_DIR=this.toComposePath(this.getPythonWorkerCacheDir()),r}toComposePath(e){return process.platform!=="win32"?e:e.replace(/\\/g,"/")}async resolveComposeProjectContext(e){await this.ensureBundledTools();let t=this.getDockerComposePath(),n=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(n))throw new Error('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');if(!await this.isContainerDaemonRunning(n))throw new Error(this.getContainerDaemonHint(n));let r=await this.resolveComposeCommand(n);if(!r)throw new Error("Compose support not found. Install Docker Desktop or Podman with podman-compose.");let i=await this.buildComposeEnvironment(n,r,e);return{composePath:t,composeCommand:r,composeEnv:i,project:this.getDockerProjectName()}}async maybeShowFirstContainerStartupNotice(e){if(!(e||this.settings.firstContainerStartupNoticeShown)){this.settings.firstContainerStartupNoticeShown=!0;try{await this.saveSettings()}catch(t){console.warn("Failed to persist first container startup notice flag",t)}new m.Notice("First container startup can take several minutes (sometimes 10+ minutes) while images are pulled and worker dependencies are built.",16e3)}}async autoDetectContainerCliOnLoad(){var o;let e=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(e)){this.notifyContainerOnce("Docker or Podman not found. Install Docker Desktop or Podman and set Docker/Podman path in settings.");return}let t=((o=this.settings.dockerPath)==null?void 0:o.trim())||"docker",n=this.expandPathValue(t);!await this.isContainerCliAvailable(n)&&!(t==="docker"||t==="podman"||t==="podman-compose")&&e&&e!==t&&(this.settings.dockerPath=e,await this.saveSettings());let a=l=>new Promise(c=>setTimeout(c,l));if(!await this.isContainerDaemonRunning(e)){for(let l of[5e3,1e4])if(await a(l),await this.isContainerDaemonRunning(e))return;this.notifyContainerOnce(this.getContainerDaemonHint(e))}}getDockerProjectName(){let e=a=>a.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,32),t=(process.env.ZRR_PROJECT_NAME||"").trim();if(t&&!this.settings.autoAssignRedisPort)return e(t)||"zrr";let n=(this.settings.redisProjectName||"").trim();if(n&&!this.settings.autoAssignRedisPort)return e(n)||"zrr";let r=this.getVaultBasePath(),i=S.default.basename(r).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),s=(0,Fe.createHash)("sha1").update(r).digest("hex").slice(0,8);return`zrr-${i||"vault"}-${s}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),t=e.port?Number(e.port):6379;return Number.isFinite(t)&&t>0?t:6379}catch(e){return 6379}}getRedisInsightPort(e){let n=(Number.isFinite(e!=null?e:NaN)?Number(e):this.getRedisPortFromUrl())+$n;return n>=1024&&n<=65535?n:hn}applyComposePortEnvironment(e,t){e.ZRR_PORT=String(t),e.ZRR_WORKER_PORT=String(this.getPythonWorkerApiPort(t)),e.ZRR_INSIGHT_PORT=String(this.getRedisInsightPort(t))}getVaultPreferredRedisPort(){let e=(0,Fe.createHash)("sha1").update(this.getVaultBasePath()).digest("hex");return 6400+Number.parseInt(e.slice(0,4),16)%2e3}getRedisHostFromUrl(){try{return new URL(this.settings.redisUrl).hostname||"127.0.0.1"}catch(e){return"127.0.0.1"}}isLocalRedisHost(e){let t=e.trim().toLowerCase();return t?t==="localhost"||t==="0.0.0.0"||t==="::1"?!0:t.startsWith("127."):!1}getPortCheckHost(e){return this.isLocalRedisHost(e)?"127.0.0.1":e}async isPortFree(e,t){return new Promise(n=>{let r=Oe.default.createServer();r.once("error",()=>n(!1)),r.once("listening",()=>{r.close(()=>n(!0))}),r.listen(t,e)})}getRequiredComposeHostPorts(e){let t=[e,this.getRedisInsightPort(e)];return this.usePythonWorker()&&t.push(this.getPythonWorkerApiPort(e)),Array.from(new Set(t))}async findAvailableComposeRedisPort(e,t){for(let r=0;r<25;r+=1){let i=t+r,s=this.getRequiredComposeHostPorts(i),a=!0;for(let o of s)if(!await this.isPortFree(e,o)){a=!1;break}if(a)return i}return null}updateRedisUrlPort(e,t){try{let n=new URL(e);return n.port=String(t),n.toString()}catch(n){return`redis://127.0.0.1:${t}`}}async isRedisReachable(e){let t="127.0.0.1",n=6379;try{let r=new URL(e);t=r.hostname||t,n=r.port?Number(r.port):n}catch(r){return!1}return t=this.getPortCheckHost(t),new Promise(r=>{let i=new Oe.default.Socket,s=!1,a=o=>{s||(s=!0,i.destroy(),r(o))};i.setTimeout(500),i.once("connect",()=>a(!0)),i.once("timeout",()=>a(!1)),i.once("error",()=>a(!1)),i.connect(n,t)})}async isZoteroLocalApiReachable(){let e=(this.settings.zoteroBaseUrl||"").trim();if(!e)return!1;let t="127.0.0.1",n=23119;try{let r=new URL(e);if(t=r.hostname||t,r.port){let i=Number(r.port);Number.isFinite(i)&&i>0&&(n=i)}else r.protocol==="https:"?n=443:n=80}catch(r){return!1}return new Promise(r=>{let i=new Oe.default.Socket,s=!1,a=o=>{s||(s=!0,i.destroy(),r(o))};i.setTimeout(500),i.once("connect",()=>a(!0)),i.once("timeout",()=>a(!1)),i.once("error",()=>a(!1)),i.connect(n,t)})}getRedisNamespace(){let e=this.getVaultBasePath(),t=S.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24),n=(0,Fe.createHash)("sha1").update(e).digest("hex").slice(0,8);return`${t||"vault"}-${n}`}getRedisIndexName(){return`${(this.settings.redisIndex||"idx:zotero").trim()||"idx:zotero"}:${this.getRedisNamespace()}`}getRedisKeyPrefix(){let e=(this.settings.redisPrefix||"zotero:chunk:").trim()||"zotero:chunk:";return`${e.endsWith(":")?e:`${e}:`}${this.getRedisNamespace()}:`}async isComposeProjectRunning(e,t,n,r,i,s=[]){let a=s.length?s:[""];for(let o of a)if(!await new Promise(c=>{let d=o?[o]:[],p=(0,oe.spawn)(e,[...t,"-p",r,"-f",n,"ps","-q",...d],{cwd:S.default.dirname(n),env:i}),u="";p.stdout.on("data",g=>{u+=g.toString()}),p.on("error",g=>{console.warn("Redis Stack status check failed",g),c(!1)}),p.on("close",g=>{if(g!==0){c(!1);return}c(u.trim().length>0)})}))return!1;return!0}isContainerNameConflictError(e){return/container name/i.test(e)&&/already in use/i.test(e)}extractConflictingContainerNames(e){let t=new Set,n=/container name\s+["']\/?([^"'\s]+)["']/gi,r;for(;(r=n.exec(e))!==null;){let i=String(r[1]||"").trim().replace(/^\/+/,"");i&&t.add(i)}return Array.from(t)}getExpectedComposeContainerNames(e,t){let n=new Set([...t,_e,lt]);return Array.from(n).map(r=>`${e}-${r}-1`)}async resolveContainerRuntimeCommandForCompose(e){if(S.default.basename(e.composeCommand.command||"")==="podman-compose"){let n=String(e.composeEnv.PODMAN_BIN||"").trim();return n||this.resolvePodmanBin()}return e.composeCommand.command||null}async recoverFromContainerNameConflict(e,t,n){let r=e instanceof Error?e.message:typeof e=="string"?e:"";if(!this.isContainerNameConflictError(r))return!1;let i=this.getExpectedComposeContainerNames(t.project,n),s=this.extractConflictingContainerNames(r),a=`${t.project}-`,o=Array.from(new Set([...i,...s])).map(c=>c.replace(/^\/+/,"").trim()).filter(c=>c.startsWith(a));if(!o.length)return!1;let l=await this.resolveContainerRuntimeCommandForCompose(t);if(!l)return!1;console.warn("Recovering from stale container name conflict",{project:t.project,containers:o});for(let c of o)try{await this.runCommand(l,["rm","-f",c],{cwd:S.default.dirname(t.composePath),env:t.composeEnv})}catch(d){console.warn("Failed to remove stale container during conflict recovery",{name:c,cleanupError:d})}return!0}async startRedisStack(e){var t;try{await this.ensureBundledTools();let n=this.getDockerComposePath(),r=this.getRedisDataDir(),i=this.getPythonWorkerCacheDir();await ee.promises.mkdir(r,{recursive:!0}),await ee.promises.mkdir(i,{recursive:!0});let s=await this.resolveDockerPath(),a=((t=this.settings.dockerPath)==null?void 0:t.trim())||"docker",o=this.resolveUserPath(a),l=a==="docker"||a==="podman"||a==="podman-compose";if(!await this.isContainerCliAvailable(o)&&!l&&s&&s!==a&&(this.settings.dockerPath=s,await this.saveSettings(),e||new m.Notice(`Docker/Podman path set to ${s}.`)),!await this.isContainerCliAvailable(s)){e||new m.Notice('Docker or podman not found. Install docker desktop or podman and set "docker/podman path" in settings.');return}if(!await this.isContainerDaemonRunning(s)){e||new m.Notice(this.getContainerDaemonHint(s));return}let p=await this.resolveComposeCommand(s);if(!p){e||new m.Notice("Compose support not found. Install docker desktop or podman with podman-compose.");return}let u=this.getRedisPortFromUrl(),g=await this.buildComposeEnvironment(s,p,{dataDir:r,redisPort:u}),y=this.getDockerProjectName(),x={composePath:n,composeCommand:p,composeEnv:g,project:y},k=this.getComposeServiceNamesForCurrentRuntime();if(await this.isComposeProjectRunning(p.command,p.argsPrefix,n,y,g,k)){e||new m.Notice(this.usePythonWorker()?"Redis Stack and Python worker already running for this vault.":"Redis Stack already running for this vault.");return}let h=this.getRedisHostFromUrl(),b=this.getPortCheckHost(h),w=this.settings.autoAssignRedisPort&&this.isLocalRedisHost(h),R=this.settings.redisUrl,E=u,v=()=>{if(!e){if(!this.settings.autoAssignRedisPort){new m.Notice("Redis already running. If you share redis across vaults, disable auto-start redis in this vault.");return}new m.Notice(`Redis already running at ${R}.`)}};if(w){let T=u===6379?this.getVaultPreferredRedisPort():u,I=await this.findAvailableComposeRedisPort(b,T);if(!I)throw new Error(`No available Redis port found starting at ${T}.`);I!==u&&(E=I,R=this.updateRedisUrlPort(R,E),this.settings.redisUrl=R,await this.saveSettings(),e||new m.Notice(`Using Redis port ${E} for this vault.`))}else{if(this.isLocalRedisHost(h)&&!await this.isPortFree(b,E)){await this.isRedisReachable(R)?(v(),this.usePythonWorker()&&(await this.maybeShowFirstContainerStartupNotice(e),await this.startPythonWorkerService(x))):e||new m.Notice(`Port ${E} is already in use and Redis is not reachable at ${R}. Update the Redis URL or enable auto-assign.`);return}if(await this.isRedisReachable(R)){v(),this.usePythonWorker()&&(await this.maybeShowFirstContainerStartupNotice(e),await this.startPythonWorkerService(x));return}}this.applyComposePortEnvironment(g,E);try{await this.runCommand(p.command,[...p.argsPrefix,"-p",y,"-f",n,"down"],{cwd:S.default.dirname(n),env:g})}catch(T){console.warn("Redis Stack stop before restart failed",T)}let A=[...p.argsPrefix,"-p",y,"-f",n,"up","-d"];this.usePythonWorker()&&A.push("--build"),A.push(...k),await this.maybeShowFirstContainerStartupNotice(e);try{await this.runCommand(p.command,A,{cwd:S.default.dirname(n),env:g})}catch(T){if(!await this.recoverFromContainerNameConflict(T,x,k))throw T;console.debug("Retrying Redis stack startup after container conflict recovery."),await this.runCommand(p.command,A,{cwd:S.default.dirname(n),env:g})}e||new m.Notice("Redis stack started.")}catch(n){e||new m.Notice("Failed to start redis stack. Check docker/podman and file sharing."),console.error("Failed to start Redis Stack",n)}}async recreateRedisStack(e){try{if(!this.isLocalRedisHost(this.getRedisHostFromUrl())){e||new m.Notice("This command only works for local redis addresses managed by compose.");return}let t=await this.resolveComposeProjectContext({dataDir:this.getRedisDataDir(),redisPort:this.getRedisPortFromUrl()});await this.maybeShowFirstContainerStartupNotice(e),await this.runCommand(t.composeCommand.command,[...t.composeCommand.argsPrefix,"-p",t.project,"-f",t.composePath,"pull",_e],{cwd:S.default.dirname(t.composePath),env:t.composeEnv}),await this.runCommand(t.composeCommand.command,[...t.composeCommand.argsPrefix,"-p",t.project,"-f",t.composePath,"up","-d","--force-recreate",_e],{cwd:S.default.dirname(t.composePath),env:t.composeEnv}),e||new m.Notice("Redis stack recreated.")}catch(t){e||new m.Notice("Failed to recreate redis stack. Check docker/podman and file sharing."),console.error("Failed to recreate Redis Stack",t)}}async waitForPythonWorkerReady(e,t=900*1e3){let n=Date.now(),r=i=>new Promise(s=>setTimeout(s,i));for(;Date.now()-n<t;){if(await this.isPythonWorkerApiHealthy(e))return;await r(2e3)}throw new Error("Python worker is still starting. Check compose logs for the python-worker service.")}async startPythonWorkerService(e){let t=e!=null?e:await this.resolveComposeProjectContext({dataDir:this.getRedisDataDir(),redisPort:this.getRedisPortFromUrl()}),n=[...t.composeCommand.argsPrefix,"-p",t.project,"-f",t.composePath,"up","-d","--build",lt];await this.runCommand(t.composeCommand.command,n,{cwd:S.default.dirname(t.composePath),env:t.composeEnv})}async ensureWorkerRedisService(e,t){if(!this.settings.autoStartRedis||!this.isLocalRedisHost(this.getRedisHostFromUrl()))return;if(!await this.isComposeProjectRunning(e.composeCommand.command,e.composeCommand.argsPrefix,e.composePath,e.project,e.composeEnv,[_e])&&t){let i=[...e.composeCommand.argsPrefix,"-p",e.project,"-f",e.composePath,"up","-d",_e];await this.runCommand(e.composeCommand.command,i,{cwd:S.default.dirname(e.composePath),env:e.composeEnv})}if(!await this.isComposeProjectRunning(e.composeCommand.command,e.composeCommand.argsPrefix,e.composePath,e.project,e.composeEnv,[_e]))throw new Error("Redis service is not running. Start Redis stack now or enable Auto-start Redis stack.")}async ensurePythonWorkerContext(e){let t=this.getRedisDataDir();await ee.promises.mkdir(t,{recursive:!0}),await ee.promises.mkdir(this.getPythonWorkerCacheDir(),{recursive:!0});let n=await this.resolveComposeProjectContext({dataDir:t,redisPort:this.getRedisPortFromUrl()}),r=[lt];if(!await this.isComposeProjectRunning(n.composeCommand.command,n.composeCommand.argsPrefix,n.composePath,n.project,n.composeEnv,r)&&e&&(await this.startPythonWorkerService(n),n=await this.resolveComposeProjectContext({dataDir:t,redisPort:this.getRedisPortFromUrl()})),!await this.isComposeProjectRunning(n.composeCommand.command,n.composeCommand.argsPrefix,n.composePath,n.project,n.composeEnv,r))throw new Error("Python worker is not running. Start Redis stack now or enable Auto-start Redis stack.");return await this.ensureWorkerRedisService(n,e),await this.waitForPythonWorkerReady(n),n}async setupPythonEnv(){if(this.usePythonWorker()){try{new m.Notice("Setting up python worker environment..."),this.showStatusProgress("Setting up Python worker environment...",null),await this.ensurePythonWorkerContext(!0),this.clearStatusProgress(),new m.Notice("Python worker environment ready.")}catch(i){this.clearStatusProgress(),new m.Notice("Failed to set up python worker environment. See console for details."),console.error("Python worker setup failed",i)}return}let e=this.getPluginDir(),t=this.getPythonVenvDir(),n=this.getVenvPythonPath(t);await this.ensureBundledTools();let r=this.resolveRequirementsPath(e);if(!r)throw new Error(`requirements.txt not found in ${e}`);try{new m.Notice("Setting up python environment..."),this.showStatusProgress("Setting up Python environment...",null),console.debug(`Python env: using plugin dir ${e}`),console.debug(`Python env: venv path ${t}`),await ee.promises.mkdir(S.default.dirname(t),{recursive:!0});let i=null,s=async()=>(i||(i=await this.resolveBootstrapPython()),i);if((0,ee.existsSync)(n)){let a=await this.getPythonVersion(n,[]);if(a&&this.isUnsupportedPythonVersion(a)){let o=await s();console.debug(`Python env: existing venv uses Python ${a.major}.${a.minor}; rebuilding with ${o.command} ${o.args.join(" ")}`),this.showStatusProgress("Rebuilding Python environment...",null),await ee.promises.rm(t,{recursive:!0,force:!0})}}if(!(0,ee.existsSync)(n)){let a=await s();console.debug(`Python env: creating venv with ${a.command} ${a.args.join(" ")}`),await this.runCommand(a.command,[...a.args,"-m","venv",t],{cwd:e})}await this.runCommandStreaming(n,["-m","pip","install","-r",r],{cwd:e},a=>{let o=a.trim();if(!o)return;let l=o.match(/^Collecting\s+([^\s]+)/);if(l){this.showStatusProgress(`Installing ${l[1]}...`,null);return}if(o.startsWith("Installing collected packages")){this.showStatusProgress("Installing packages...",null);return}o.startsWith("Successfully installed")&&this.showStatusProgress("Python environment ready.",100)}),this.settings.pythonPath=n,await this.saveSettings(),this.clearStatusProgress(),new m.Notice("Python environment ready.")}catch(i){this.clearStatusProgress(),new m.Notice("Failed to set up python environment. See console for details."),console.error("Python env setup failed",i)}}async detectOcrEngines(){if(this.usePythonWorker())return{tesseract:!0,paddleStructureLocal:!0,paddleVlLocal:!0};let e=await this.canRunCommand("tesseract",[]),t=this.resolvePythonPath(),n=[];if(!t)try{let l=await this.resolveBootstrapPython();t=l.command,n=l.args}catch(l){return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1}}let r=["import importlib.util, json","def has_module(name):","    return importlib.util.find_spec(name) is not None","has_paddle = has_module('paddle')","has_paddleocr = has_module('paddleocr')","has_paddlex = has_module('paddlex')","has_vl = False","if has_paddleocr:","    try:","        from paddleocr import PaddleOCRVL","        has_vl = True","    except Exception:","        has_vl = False","print(json.dumps({'paddle': has_paddle, 'paddleocr': has_paddleocr, 'paddlex': has_paddlex, 'paddle_vl': has_vl}))"].join(`
`),i=await new Promise(l=>{let c=(0,oe.spawn)(t,[...n,"-c",r],{env:this.buildPythonEnv()}),d="";c.stdout.on("data",p=>{d+=p.toString()}),c.on("error",()=>l({ok:!1})),c.on("close",p=>{if(p!==0){l({ok:!1});return}try{let u=JSON.parse(d.trim());l({ok:!0,data:u})}catch(u){l({ok:!1})}})});if(!i.ok||!i.data)return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1};let s=i.data,a=!!s.paddle,o=!!s.paddleocr;return{tesseract:e,paddleStructureLocal:a&&o&&!!s.paddlex,paddleVlLocal:a&&o&&!!s.paddle_vl}}getSharedPythonEnvRoot(){let e=Ie.default.homedir();if(process.platform==="win32"){let n=process.env.LOCALAPPDATA||process.env.APPDATA||S.default.join(e,"AppData","Local");return S.default.join(n,"zotero-redisearch-rag")}let t=process.env.XDG_CACHE_HOME||S.default.join(e,".cache");return S.default.join(t,"zotero-redisearch-rag")}getPythonVenvDir(){return this.settings.pythonEnvLocation==="plugin"?S.default.join(this.getPluginDir(),".venv"):S.default.join(this.getSharedPythonEnvRoot(),"venv")}getVenvPythonPath(e){return process.platform==="win32"?S.default.join(e,"Scripts","python.exe"):S.default.join(e,"bin","python")}resolveRequirementsPath(e){var n;return(n=[S.default.join(e,"requirements.txt"),S.default.join(e,"tools","requirements.txt")].find(r=>(0,ee.existsSync)(r)))!=null?n:null}async resolveBootstrapPython(){let e=(this.settings.pythonPath||"").trim(),t=this.expandPathValue(e);if(t&&await this.canRunCommand(t,[])){let r=await this.getPythonVersion(t,[]);if(r&&this.isUnsupportedPythonVersion(r))throw new Error(`Configured Python ${r.major}.${r.minor} is not supported. Install Python 3.11\u20133.13 and update the Python path.`);return{command:t,args:[]}}let n=process.platform==="win32"?[{command:"py",args:["-3.13"]},{command:"py",args:["-3.12"]},{command:"py",args:["-3.11"]},{command:"py",args:["-3.10"]},{command:"py",args:["-3"]},{command:"python",args:[]}]:[{command:"python3.13",args:[]},{command:"python3.12",args:[]},{command:"python3.11",args:[]},{command:"python3.10",args:[]},{command:"python3",args:[]},{command:"python",args:[]}];for(let r of n)if(await this.canRunCommand(r.command,r.args)){let i=await this.getPythonVersion(r.command,r.args);if(i&&this.isUnsupportedPythonVersion(i)){console.debug(`Python env: skipping ${r.command} ${r.args.join(" ")} (Python ${i.major}.${i.minor} unsupported)`);continue}return r}throw new Error("No usable Python 3.11\u20133.13 interpreter found on PATH.")}isUnsupportedPythonVersion(e){return e.major>3||e.major===3&&e.minor>=14}async getPythonVersion(e,t){return new Promise(n=>{let r=(0,oe.spawn)(e,[...t,"-c","import sys; print(f'{sys.version_info.major}.{sys.version_info.minor}')"]),i="";r.stdout.on("data",s=>{i+=s.toString()}),r.on("error",()=>n(null)),r.on("close",s=>{if(s!==0){n(null);return}let a=i.trim().match(/(\d+)\.(\d+)/);if(!a){n(null);return}n({major:Number(a[1]),minor:Number(a[2])})})})}async canRunCommand(e,t){return new Promise(n=>{let r=(0,oe.spawn)(e,[...t,"--version"],{env:this.buildPythonEnv()});r.on("error",()=>n(!1)),r.on("close",i=>n(i===0))})}buildPythonEnv(){let e={...process.env},t=S.default.delimiter,n=e.PATH||"",i=[...process.platform==="win32"?[]:["/opt/homebrew/bin","/usr/local/bin"],n].filter(Boolean).join(t);return e.PATH=i,e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK||(e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK="True"),e.DISABLE_MODEL_SOURCE_CHECK||(e.DISABLE_MODEL_SOURCE_CHECK="True"),e}getLocalPythonInvocation(e,t){return{command:this.resolvePythonPath(),args:[e,...t],cwd:S.default.dirname(e),env:this.buildPythonEnv()}}async runPython(e,t){if(this.usePythonWorker()){let r=this.getWorkerToolName(e);if(!r)throw new Error(`Python worker can only run bundled tools under '${S.default.join(this.getPluginDir(),"tools")}'.`);await this.runPythonToolWithOutputViaWorkerApi(r,t,this.settings.autoStartRedis);return}let n=this.getLocalPythonInvocation(e,t);return new Promise((r,i)=>{let s=(0,oe.spawn)(n.command,n.args,{cwd:n.cwd,env:n.env}),a="",o="";s.stdout.on("data",l=>{a+=l.toString()}),s.stderr.on("data",l=>{o+=l.toString()}),s.on("error",l=>{this.handlePythonProcessError(String(l)),i(l)}),s.on("close",l=>{if(l===0)r();else{let c=o.trim()?o:a;this.handlePythonProcessError(c),i(new Error(o||`Process exited with code ${l}`))}})})}runCommand(e,t,n){return new Promise((r,i)=>{var o;let s=(0,oe.spawn)(e,t,{cwd:n==null?void 0:n.cwd,env:(o=n==null?void 0:n.env)!=null?o:this.buildPythonEnv()}),a="";s.stderr.on("data",l=>{a+=l.toString()}),s.on("error",l=>{i(l)}),s.on("close",l=>{l===0?r():i(new Error(a||`Process exited with code ${l}`))})})}async runPythonStreaming(e,t,n,r,i,s="docling_extract",a,o){if(this.usePythonWorker()){let c=this.getWorkerToolName(e);if(!c)throw new Error(`Python worker can only run bundled tools under '${S.default.join(this.getPluginDir(),"tools")}'.`);await this.runPythonStreamingViaWorkerApi(c,t,n,r,i,s,this.settings.autoStartRedis,a,o);return}let l=this.getLocalPythonInvocation(e,t);return new Promise((c,d)=>{let p=(0,oe.spawn)(l.command,l.args,{cwd:l.cwd,env:l.env});a&&a(p);let u="",g="",y="",x=null,k=!1,h=b=>{if(b.trim())try{let w=JSON.parse(b);x=w,((w==null?void 0:w.type)==="final"||w!=null&&w.answer)&&(k=!0),n(w)}catch(w){y+=`${b}
`}};p.stdout.on("data",b=>{var R;u+=b.toString();let w=u.split(/\r?\n/);u=(R=w.pop())!=null?R:"";for(let E of w)h(E)}),p.stderr.on("data",b=>{g+=b.toString()}),p.on("error",b=>{this.handlePythonProcessError(String(b)),d(b)}),p.on("close",b=>{if(u.trim()&&h(u),!k&&x&&r(x),i&&this.appendToLogFile(i,g,s,"STDERR"),b===0)c();else{let w=g.trim()?g:y;this.handlePythonProcessError(w),d(new Error(g||`Process exited with code ${b}`))}})})}runCommandStreaming(e,t,n,r){return new Promise((i,s)=>{var c;let a=(0,oe.spawn)(e,t,{cwd:n==null?void 0:n.cwd,env:(c=n==null?void 0:n.env)!=null?c:this.buildPythonEnv()}),o=d=>{d.toString().split(/\r?\n/).forEach(u=>{u.trim()&&r(u)})},l="";a.stdout.on("data",o),a.stderr.on("data",d=>{l+=d.toString(),o(d)}),a.on("error",d=>{s(d)}),a.on("close",d=>{d===0?i():s(new Error(l||`Process exited with code ${d}`))})})}async requestPythonWorkerCancel(e,t,n=2e3){let r=`${e.protocol}//${e.host}/cancel`;try{await this.requestLocalApiRaw(r,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json","X-ZRR-Request-Id":t},body:JSON.stringify({request_id:t}),timeoutMs:n}),this.logPythonWorkerTiming("cancel-request",{requestId:t,cancelUrl:r})}catch(i){this.logPythonWorkerTiming("cancel-request-error",{requestId:t,cancelUrl:r,error:String(i)})}}async runPythonStreamingViaWorkerApi(e,t,n,r,i,s="docling_extract",a=!0,o,l){let c=this.nextPythonWorkerRequestId(e),d=Date.now(),p=await this.ensurePythonWorkerContext(a),u=Date.now(),g=this.mapPythonArgsForWorker(t),y=`${this.getPythonWorkerApiBaseUrl(this.getPythonWorkerApiPortFromContext(p))}/run-stream`,x=new URL(y),k=Number.isFinite(l!=null?l:NaN)?Math.max(1,Math.trunc(Number(l))):600,h=JSON.stringify({tool:e,args:g,timeout_sec:k});return this.logPythonWorkerTiming("stream-start",{requestId:c,tool:e,argsCount:g.length,ensureContextMs:u-d,port:this.getPythonWorkerApiPortFromContext(p),timeoutSec:k}),new Promise((b,w)=>{let R="",E="",v=null,A=!1,T=null,I=!1,L=null,q=null,M=0,z=!1,$=()=>{z=!0},D=Pt.default.request({method:"POST",hostname:x.hostname,port:x.port||void 0,path:`${x.pathname}${x.search}`,headers:{Accept:"application/x-ndjson","Content-Type":"application/json","Content-Length":String(Buffer.byteLength(h)),"X-ZRR-Request-Id":c}},B=>{var K;L=Date.now();let F=U=>{if(U.trim())try{let G=JSON.parse(U);v=G,((G==null?void 0:G.type)==="final"||G!=null&&G.answer)&&(A=!0,!I&&(G!=null&&G.timing)&&typeof G.timing=="object"&&(I=!0,this.logPythonWorkerTiming("stream-tool-timing",{requestId:c,tool:e,timing:G.timing}))),n(G)}catch(G){E+=`${U}
`}},j=U=>{var G;if(U.trim())try{let H=JSON.parse(U);if((H==null?void 0:H.type)==="stdout"){M+=1,q===null&&(q=Date.now()),F(String((G=H.line)!=null?G:""));return}if((H==null?void 0:H.type)==="done"){T=H;return}E+=`${U}
`}catch(H){E+=`${U}
`}};if(((K=B.statusCode)!=null?K:0)>=400){let U=[];B.on("data",G=>U.push(Buffer.from(G))),B.on("end",()=>{var H;$();let G=Buffer.concat(U).toString("utf8");this.logPythonWorkerTiming("stream-http-error",{requestId:c,tool:e,statusCode:(H=B.statusCode)!=null?H:0,durationMs:Date.now()-d}),w(new Error(`Python worker API request failed (${B.statusCode}): ${G||"no response body"}`))});return}B.on("data",U=>{var H;R+=U.toString();let G=R.split(/\r?\n/);R=(H=G.pop())!=null?H:"";for(let ae of G)j(ae)}),B.on("end",()=>{$(),R.trim()&&j(R);let U=this.asRecord(T),G=typeof(U==null?void 0:U.stderr)=="string"?U.stderr:"",H=typeof(U==null?void 0:U.error)=="string"?U.error.trim():"",ae=typeof(U==null?void 0:U.exit_code)=="number"?U.exit_code:Number.parseInt(typeof(U==null?void 0:U.exit_code)=="string"?U.exit_code:"1",10);if(!A&&v&&r(v),i&&G&&this.appendToLogFile(i,G,s,"STDERR"),this.logPythonWorkerTiming("stream-done",{requestId:c,tool:e,exitCode:Number.isFinite(ae)?ae:1,totalMs:Date.now()-d,responseOpenMs:L?L-d:null,firstStdoutMs:q?q-d:null,stdoutEvents:M,stderrBytes:G.length,doneError:H}),Number.isFinite(ae)&&ae===0){b();return}if(/^(canceled|cancelled|client_disconnected)$/i.test(H)){w(new Error(`Python worker request canceled: ${H}`));return}let Ae=G.trim()?G:H||E;this.handlePythonProcessError(Ae),w(new Error(G||H||`Process exited with code ${Number.isFinite(ae)?ae:1}`))})});o&&o({get killed(){return z},kill:B=>z?!1:($(),this.requestPythonWorkerCancel(x,c),D.destroy(new Error("Python worker request aborted")),!0)}),D.setTimeout((k+30)*1e3,()=>{D.destroy(new Error("Python worker streaming request timed out"))}),D.on("error",B=>{$();let F=B instanceof Error?B.message:typeof B=="string"?B:"";this.logPythonWorkerTiming("stream-request-error",{requestId:c,tool:e,durationMs:Date.now()-d,error:F}),this.handlePythonProcessError(F);let j=B instanceof Error?B:new Error(F||"Python worker streaming request failed");w(j)}),D.write(h),D.end()})}handlePythonProcessError(e){if(!e)return;if(/Python worker cannot access path/i.test(e)){this.notifyContainerOnce(e.replace(/^Error:\s*/i,""));return}if(/python-worker/i.test(e)&&/(No such service|is not running|not found|no container)/i.test(e)){this.notifyContainerOnce("Python worker is not running. Start Redis stack now or enable Auto-start Redis stack.");return}if(/Cannot connect to the Docker daemon|docker desktop is not running|podman machine/i.test(e)){this.notifyContainerOnce("Container runtime is not available. Start Docker Desktop or Podman.");return}if(/Python worker API request failed|Python worker streaming request timed out|ECONNREFUSED 127\.0\.0\.1/i.test(e)){this.notifyContainerOnce("Python worker API is not reachable. Start Redis stack now or check python-worker container logs.");return}let t=e.match(/ModuleNotFoundError:\s+No module named ['"]([^'"]+)['"]/);if(t){let n=this.usePythonWorker()?`Python worker missing module '${t[1]}'. Restart Redis stack to rebuild worker env.`:`Python env missing module '${t[1]}'. Open Settings > Python environment > Create/Update.`;this.notifyPythonEnvOnce(n,!0);return}if(/No module named ['"]|ImportError: No module named/i.test(e)){let n=this.usePythonWorker()?"Python worker missing required modules. Restart Redis stack to rebuild worker env.":"Python env missing required modules. Open Settings > Python environment > Create/Update.";this.notifyPythonEnvOnce(n,!0);return}if(/ENOENT|No such file or directory|not found|command not found|spawn .* ENOENT/i.test(e)){let n=this.usePythonWorker()?"Python worker command failed. Start Redis stack and check container logs.":"Python not found. Configure the Python path or use Settings > Python environment > Create/Update.";this.notifyPythonEnvOnce(n,!0)}}notifyPythonEnvOnce(e,t=!1){this.lastPythonEnvNotice!==e&&(this.lastPythonEnvNotice=e,new m.Notice(e),t&&this.openPluginSettings())}notifyContainerOnce(e){this.lastContainerNotice!==e&&(this.lastContainerNotice=e,new m.Notice(e))}notifyRedisOnce(e){this.lastRedisNotice!==e&&(this.lastRedisNotice=e,new m.Notice(e))}async autoDetectRedisOnLoad(){if(this.settings.autoStartRedis)return;let e=(this.settings.redisUrl||"").trim(),n=e||"redis://127.0.0.1:6379";(await this.checkRedisConnectionWithUrl(n,500)).ok&&(e||(this.settings.redisUrl=n,await this.saveSettings()),this.notifyRedisOnce(`Redis detected at ${n}. This instance will be used.`))}notifyZoteroApiOnce(e){this.lastZoteroApiNotice!==e&&(this.lastZoteroApiNotice=e,new m.Notice(e))}async warnIfZoteroLocalApiUnavailable(e){if(await this.isZoteroLocalApiReachable())return this.lastZoteroApiNotice=null,!0;let r=`Zotero Local API is not reachable for ${e?`${e}`:"this action"}. Start Zotero or update the Local API URL in settings.`;return this.notifyZoteroApiOnce(r),!1}openPluginSettings(){var t,n;let e=this.app;(t=e.setting)!=null&&t.open&&e.setting.open(),(n=e.setting)!=null&&n.openTabById&&e.setting.openTabById(this.manifest.id)}getLogsDirRelative(){return(0,m.normalizePath)(`${re}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,m.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,m.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;if(!await t.exists(e)){new m.Notice("Log file not found.");return}try{let n=async()=>{try{return await t.read(e)||"(empty)"}catch(i){return"(empty)"}},r=await n();new Pe(this.app,"Log file",r||"(empty)",{autoRefresh:!0,refreshIntervalMs:2e3,onRefresh:n,onClear:async()=>{await this.clearLogFile()}}).open()}catch(n){new m.Notice("Failed to open log file."),console.error(n)}}async clearLogFile(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;try{let n=(0,m.normalizePath)(S.default.dirname(e));n&&await this.ensureFolder(n),await t.write(e,""),new m.Notice("Log file cleared.")}catch(n){new m.Notice("Failed to clear log file."),console.error(n)}}async deleteLogFileIfExists(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;try{await t.exists(e)&&await t.remove(e)}catch(n){console.warn("Failed to delete log file before import",n)}}formatLogLines(e,t,n){let r=e.split(/\r?\n/).map(s=>s.trimEnd()).filter(s=>!!s.trim());if(!r.length)return"";let i=new Date().toISOString().replace("T"," ").replace(".",",");return r.map(s=>`${i} ${n} ${t}: ${s}`).join(`
`)+`
`}async appendToLogFile(e,t,n="docling_extract",r="STDERR"){if(!t||!t.trim())return;let i=this.formatLogLines(t,n,r);if(i)try{await ee.promises.mkdir(S.default.dirname(e),{recursive:!0}),await ee.promises.appendFile(e,i)}catch(s){console.warn("Failed to append stderr to log file",s)}}async runPythonToolWithOutputViaWorkerApi(e,t,n,r,i="docling_extract",s){var w,R,E;if(!this.usePythonWorker())throw new Error("Worker API is only available in worker runtime mode.");let a=this.nextPythonWorkerRequestId(e),o=Date.now(),l=await this.ensurePythonWorkerContext(n),c=Date.now(),d=this.mapPythonArgsForWorker(t),p=`${this.getPythonWorkerApiBaseUrl(this.getPythonWorkerApiPortFromContext(l))}/run`,u=Number.isFinite(s!=null?s:NaN)?Math.max(1,Math.trunc(Number(s))):600,g=JSON.stringify({tool:e,args:d,timeout_sec:u}),y=await this.requestLocalApiRaw(p,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json","X-ZRR-Request-Id":a},body:g,timeoutMs:(u+30)*1e3});if(y.statusCode<200||y.statusCode>=300){let v=y.body.toString("utf8");throw this.logPythonWorkerTiming("run-http-error",{requestId:a,tool:e,statusCode:y.statusCode,totalMs:Date.now()-o,ensureContextMs:c-o}),new Error(`Python worker API request failed (${y.statusCode}): ${v||"no response body"}`)}let x=JSON.parse(y.body.toString("utf8")||"{}"),k=String((w=x==null?void 0:x.stdout)!=null?w:""),h=String((R=x==null?void 0:x.stderr)!=null?R:"");x!=null&&x.timing&&typeof x.timing=="object"&&this.logPythonWorkerTiming("run-tool-timing",{requestId:a,tool:e,timing:x.timing}),r&&h&&await this.appendToLogFile(r,h,i,"STDERR");let b=Number.parseInt(String((E=x==null?void 0:x.exit_code)!=null?E:1),10);if(this.logPythonWorkerTiming("run-done",{requestId:a,tool:e,exitCode:Number.isFinite(b)?b:1,totalMs:Date.now()-o,ensureContextMs:c-o,requestMs:Date.now()-c,stdoutBytes:k.length,stderrBytes:h.length,timeoutSec:u}),!Number.isFinite(b)||b!==0){let v=h.trim()?h:k;throw this.handlePythonProcessError(v),new Error(h||`Process exited with code ${Number.isFinite(b)?b:1}`)}return k.trim()}async runPythonWithOutput(e,t,n,r="docling_extract",i){if(this.usePythonWorker()){let a=this.getWorkerToolName(e);if(!a)throw new Error(`Python worker can only run bundled tools under '${S.default.join(this.getPluginDir(),"tools")}'.`);return this.runPythonToolWithOutputViaWorkerApi(a,t,this.settings.autoStartRedis,n,r,i)}let s=this.getLocalPythonInvocation(e,t);return new Promise((a,o)=>{let l=(0,oe.spawn)(s.command,s.args,{cwd:s.cwd,env:s.env}),c="",d="";l.stdout.on("data",p=>{c+=p.toString()}),l.stderr.on("data",p=>{d+=p.toString()}),l.on("error",p=>{this.handlePythonProcessError(String(p)),o(p)}),l.on("close",p=>{if(n&&this.appendToLogFile(n,d,r,"STDERR"),p===0)a(c.trim());else{let u=d.trim()?d:c;this.handlePythonProcessError(u),o(new Error(d||`Process exited with code ${p}`))}})})}};

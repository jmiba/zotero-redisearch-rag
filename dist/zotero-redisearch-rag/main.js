"use strict";var yn=Object.create;var $e=Object.defineProperty;var bn=Object.getOwnPropertyDescriptor;var xn=Object.getOwnPropertyNames;var kn=Object.getPrototypeOf,wn=Object.prototype.hasOwnProperty;var vn=(f,u)=>{for(var e in u)$e(f,e,{get:u[e],enumerable:!0})},Et=(f,u,e,t)=>{if(u&&typeof u=="object"||typeof u=="function")for(let n of xn(u))!wn.call(f,n)&&n!==e&&$e(f,n,{get:()=>u[n],enumerable:!(t=bn(u,n))||t.enumerable});return f};var me=(f,u,e)=>(e=f!=null?yn(kn(f)):{},Et(u||!f||!f.__esModule?$e(e,"default",{value:f,enumerable:!0}):e,f)),Pn=f=>Et($e({},"__esModule",{value:!0}),f);var Jn={};vn(Jn,{default:()=>ct});module.exports=Pn(Jn);var m=require("obsidian");var It=require("@codemirror/state"),re=require("@codemirror/view"),Ft=require("obsidian");var ye=/<!--\s*zrr:sync-start[^>]*-->/i,xe=/<!--\s*zrr:sync-end\s*-->/i,_e=/<!--\s*zrr:chunk\b([^>]*)-->/i,Re=/<!--\s*zrr:chunk\s+end\s*-->/i,Ee=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,St=f=>{let u=f.trim();if(!u.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(u)){let _=u.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:_?_[2]:void 0}}if(/^zrr:sync-end\b/i.test(u))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(u)){let _=u.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),g=u.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:_?_[2]:void 0,attachmentKey:g?g[2]:void 0}}if(/^zrr:annotations-end\b/i.test(u))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(u))return{type:"chunk-end"};let e=u.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let t=e[1]||"",n=t.match(/\bid=(["']?)([^"'\s]+)\1/i),r=n?n[2]:"",i=t.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),s=i?null:t.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):s?Number.parseInt(s[1],10):void 0,o=r.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(a!=null?a:NaN)?a:l,d=/\bexclude\b/i.test(t)||/\bdelete\b/i.test(t),p=/\bsection\b/i.test(t);return{type:"chunk-start",chunkId:r||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:p?"section":c?"page":"section"}},Se=f=>{var l;if(!f)return null;let u=f.match(_e);if(!u)return null;let e=u[1]||"",t=e.match(/\bid=(["']?)([^"'\s]+)\1/i),n=t?t[2].trim():void 0,r=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),i=r?null:e.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):i?Number.parseInt(i[1],10):void 0,a=n&&(l=_t(n))!=null?l:void 0,o=Number.isFinite(s!=null?s:NaN)?s:a;return{chunkId:n,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Ve=f=>{for(let u=1;u<=f.lines;u+=1){let e=f.line(u).text;if(ye.test(e)){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i);return t?t[2].trim():null}}return null},ut=(f,u)=>{let e=u;for(;e>=1;e-=1){let t=f.line(e).text;if(_e.test(t))return{line:e,text:t};if(ye.test(t)||xe.test(t))break}return null},Cn=(f,u)=>{for(let e=u;e<=f.lines;e+=1){let t=f.line(e).text;if(Re.test(t))return e;if(xe.test(t))break}return null},Nt=(f,u)=>{let e=ut(f,u);if(!e)return null;let t=Cn(f,e.line+1);return t===null||u<e.line||u>t?null:{startLine:e.line,endLine:t,text:e.text}},Lt=(f,u,e)=>{if(u>e)return!1;for(let t=u;t<=e;t+=1){let n=f.line(t).text;if(Ee.test(n))return!0}return!1},_t=f=>{var n;if(!f)return null;let e=(f.includes(":")&&(n=f.split(":").pop())!=null?n:f).match(/^p(\d+)$/i);if(!e)return null;let t=Number.parseInt(e[1],10);return Number.isFinite(t)?t:null};var Tt=f=>{if(!f)return null;let u=f.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return u?Se(u[0]):null};var An=(f,u)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),f.type==="sync-start"||f.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(f.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),f.type==="sync-start"?e.textContent=f.docId?`Redis Index Sync start - ${f.docId}`:"Redis Index Sync start":e.textContent="Redis index sync end",e;if(f.type==="annotations-start"||f.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),f.type==="annotations-start"){let t=f.docId?` - ${f.docId}`:"";e.textContent=`Zotero annotations start${t}`}else e.textContent="Zotero annotations end";return e}if(f.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=f.chunkKind==="page"?"Page end":"Section end",f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),e;if(f.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),f.excluded&&e.classList.add("is-excluded"),f.pageNumber&&u>0)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber}/${u})`}else e.textContent=`Page ${f.pageNumber}/${u}`;else if(f.pageNumber)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber})`}else e.textContent=`Page ${f.pageNumber}`;else f.chunkId?e.textContent=`Section ${f.chunkId}`:e.textContent="Section";return f.excluded&&(e.textContent=`${e.textContent} - excluded`),e},gt=class extends re.WidgetType{constructor(u,e,t,n,r){super(),this.plugin=u,this.docId=e,this.chunkId=t,this.startLine=n,this.excluded=r}eq(u){return this.docId===u.docId&&this.chunkId===u.chunkId&&this.startLine===u.startLine&&this.excluded===u.excluded}toDOM(){let u=document.createElement("span");u.className="zrr-chunk-toolbar",u.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},t=(c,d,p)=>{let _=document.createElement("span");_.className="zrr-chunk-button-icon",(0,Ft.setIcon)(_,d);let g=document.createElement("span");g.className="zrr-chunk-button-label",g.textContent=p,c.appendChild(_),c.appendChild(g)},n=document.createElement("button");n.type="button",n.className="zrr-chunk-button",t(n,"sparkles","Clean"),e(n,"Clean this chunk with the OCR cleanup model"),n.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),u.appendChild(n);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",t(r,"tag","Tags"),e(r,"Edit chunk tags"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),u.appendChild(r);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",t(i,"search","Indexed"),e(i,"Preview indexed chunk text"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),u.appendChild(i);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button",t(s,"external-link","Zotero"),e(s,"Open this page in Zotero"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),u.appendChild(s);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return t(a,l,o),e(a,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),u.appendChild(a),u}ignoreEvent(){return!0}},Dt=(f,u)=>{var y;let e=f.state.doc,t=Ve(e);if(!t)return re.Decoration.none;let n=f.state.selection.main.head,r=e.lineAt(n).number,i=Nt(e,r);if(!i)return re.Decoration.none;let s=i.text.match(_e);if(!s)return re.Decoration.none;let a=((y=s[1])!=null?y:"").trim(),o=a.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return re.Decoration.none;let l=o[2].trim();if(!l)return re.Decoration.none;let c=/\bexclude\b/i.test(a)||/\bdelete\b/i.test(a),d=Lt(e,i.startLine+1,i.endLine-1),p=c||d,_=e.line(i.startLine),g=re.Decoration.widget({widget:new gt(u,t,l,i.startLine,p),side:1});return re.Decoration.set([g.range(_.to)])},ht=class extends re.WidgetType{constructor(u,e){super(),this.info=u,this.totalPages=e}toDOM(){var u;return(u=An(this.info,this.totalPages))!=null?u:document.createElement("span")}},Ot=f=>{var o,l;let u=f.dom.closest(".markdown-source-view");if(!u||!u.classList.contains("is-live-preview"))return re.Decoration.none;let e=f.state.doc,t=new It.RangeSetBuilder,n=[],r=[],i=!1,s=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),p=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!p)continue;let _=St(p[1]);_&&(_.type==="chunk-start"?(_.chunkKind=(o=_.chunkKind)!=null?o:_.pageNumber?"page":"section",_.pageNumber&&(i=!0),_.chunkKind==="section"&&(s=!0)):_.type==="chunk-end"&&(_.chunkKind=(l=_.chunkKind)!=null?l:"section"),n.push({line:c,from:d.from,to:d.to,info:_}),_.pageNumber&&r.push(_.pageNumber))}if(!n.length)return re.Decoration.none;if(i&&!s)for(let c of n)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let a=r.length?Math.max(...r):0;for(let c of n){let d=re.Decoration.replace({widget:new ht(c.info,a)});t.add(c.from,c.to,d)}return t.finish()},Mt=()=>re.ViewPlugin.fromClass(class{constructor(f){this.decorations=Ot(f)}update(f){(f.docChanged||f.viewportChanged)&&(this.decorations=Ot(f.view))}},{decorations:f=>f.decorations}),zt=f=>re.ViewPlugin.fromClass(class{constructor(u){this.decorations=Dt(u,f)}update(u){(u.docChanged||u.selectionSet||u.viewportChanged)&&(this.decorations=Dt(u.view,f))}},{decorations:u=>u.decorations}),Rn=(f,u)=>{var t,n,r;if(!f||u<0)return null;let e=/\[\[([^\]\n]+)\]\]/g;for(let i of f.matchAll(e)){let s=(t=i[0])!=null?t:"",a=(n=i[1])!=null?n:"",o=(r=i.index)!=null?r:-1;if(o<0)continue;let l=o+s.length;if(u<o||u>l)continue;let c=a.indexOf("|");return(c>=0?a.slice(0,c):a).trim()||null}return null},qt=f=>re.ViewPlugin.fromClass(class{},{eventHandlers:{click(u,e){if(u.defaultPrevented||u.button!==0)return!1;let t=e.dom.closest(".markdown-source-view");if(!t||!t.classList.contains("is-live-preview"))return!1;let n=e.posAtCoords({x:u.clientX,y:u.clientY});if(n===null)return!1;let r=e.state.doc.lineAt(n),i=n-r.from,s=Rn(r.text,i);return!s||!s.includes("#zrr-chunk:")?!1:(u.preventDefault(),u.stopPropagation(),f.openInternalLinkInMain(s,f.getLivePreviewSourcePath()),!0)}}});var oe=require("child_process"),ee=require("fs"),Pt=me(require("http")),gn=me(require("https")),Fe=me(require("net")),Me=me(require("os")),hn=me(require("tls")),S=me(require("path")),Ct=require("url"),ze=require("crypto");var N=require("obsidian"),$t=require("crypto"),Ue=require("fs"),Be=me(require("path")),ie=".zotero-redisearch-rag",le=`${ie}/items`,Q=`${ie}/chunks`,Vt=`${ie}/metadata_snapshots.json`,Ut=`${ie}/annotation_snapshots.json`,En="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",ke="cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",Ne="__custom__",jt=[{value:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",label:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1 (Fast multilingual)"},{value:"BAAI/bge-reranker-v2-m3",label:"BAAI/bge-reranker-v2-m3 (Best quality, heaviest)"},{value:"jinaai/jina-reranker-v2-base-multilingual",label:"jinaai/jina-reranker-v2-base-multilingual (Balanced multilingual)"}],Ge={pythonRuntime:"worker",pythonRuntimeMigrationV1Done:!1,showAdvancedPythonRuntimeOptions:!1,pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,firstContainerStartupNoticeShown:!1,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:ke,rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${ie}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Ze=class extends N.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async h=>{this.plugin.settings.llmProviderProfiles=h,await this.plugin.saveSettings()},r=h=>{h.inputEl.type="password",h.inputEl.autocomplete="off",h.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:h=>{new N.Setting(h).setName("Prerequisites").setHeading();let b=null,w=null,C=null,E=null,v=null,A=null,O=null,T=null,L=null,M=(z,j)=>{z&&(z.settingEl.classList.toggle("is-disabled",j),z.settingEl.classList.toggle("zrr-setting-disabled",j))},q=(z,j)=>{z&&z.settingEl.classList.toggle("zrr-setting-hidden",!j)},F=()=>{let z=!!this.plugin.settings.showAdvancedPythonRuntimeOptions,j=this.plugin.settings.pythonRuntime==="local",K=z&&j;w==null||w.setDisabled(!z),M(b,!z),q(C,z),q(E,z),q(v,z),A==null||A.setDisabled(!K),O==null||O.setDisabled(!K),L==null||L.setDisabled(!K),T&&(T.disabled=!K),M(C,!K),M(E,!K),M(v,!K)};new N.Setting(h).setName("Docker/podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(z=>z.setPlaceholder("Docker").setValue(this.plugin.settings.dockerPath).onChange(async j=>{this.plugin.settings.dockerPath=j.trim()||"docker",await this.plugin.saveSettings()})),new N.Setting(h).setName("Advanced python runtime options").setDesc("Show legacy local interpreter/venv controls. Recommended to keep this disabled.").addToggle(z=>z.setValue(this.plugin.settings.showAdvancedPythonRuntimeOptions).onChange(async j=>{this.plugin.settings.showAdvancedPythonRuntimeOptions=j,!j&&this.plugin.settings.pythonRuntime==="local"&&(this.plugin.settings.pythonRuntime="worker",new N.Notice("Switched python runtime to worker mode.")),await this.plugin.saveSettings(),F()})),b=new N.Setting(h).setName("Python runtime").setDesc("Worker runtime is recommended. Enable advanced options to expose local interpreter/venv mode.").addDropdown(z=>{w=z,z.addOption("worker","Python worker container (recommended)"),z.addOption("local","Local interpreter/venv"),z.setValue(this.plugin.settings.pythonRuntime).onChange(async j=>{j!=="worker"&&j!=="local"||(this.plugin.settings.pythonRuntime=j,await this.plugin.saveSettings(),F())})}),C=new N.Setting(h).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(z=>(A=z,z.setPlaceholder("Auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async j=>{this.plugin.settings.pythonPath=j.trim(),await this.plugin.saveSettings()}))),E=new N.Setting(h).setName("Python environment").setDesc("Local mode: create or update the plugin's python env. Worker mode: managed by docker startup.").addButton(z=>{L=z,T=z.buttonEl,z.setButtonText("Create/update").setCta(),z.onClick(async()=>{z.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{z.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),v=new N.Setting(h).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(z=>{O=z,z.addOption("shared","Shared user cache"),z.addOption("plugin","Plugin folder (.venv)"),z.setValue(this.plugin.settings.pythonEnvLocation).onChange(async j=>{j!=="shared"&&j!=="plugin"||(this.plugin.settings.pythonEnvLocation=j,await this.plugin.saveSettings())})}),F(),new N.Setting(h).setName("Redis URL").addText(z=>z.setPlaceholder("Redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async j=>{this.plugin.settings.redisUrl=j.trim(),await this.plugin.saveSettings()}));let $=null,I=null,U=null,B=null,V=()=>{let z=this.plugin.settings.autoAssignRedisPort;U==null||U.setDisabled(z),B==null||B.setDisabled(z),$==null||$.settingEl.classList.toggle("is-disabled",z),I==null||I.settingEl.classList.toggle("is-disabled",z)};new N.Setting(h).setName("Auto-assign redis port").setDesc("When starting redis stack, pick a free local port and update the redis URL.").addToggle(z=>z.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async j=>{this.plugin.settings.autoAssignRedisPort=j,await this.plugin.saveSettings(),V()})),$=new N.Setting(h).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(z=>(U=z,z.setPlaceholder("~/redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async j=>{this.plugin.settings.redisDataDirOverride=j.trim(),await this.plugin.saveSettings()}))),$.settingEl.addClass("zrr-redis-override-setting"),I=new N.Setting(h).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(z=>(B=z,z.setPlaceholder("Zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async j=>{this.plugin.settings.redisProjectName=j.trim(),await this.plugin.saveSettings()}))),I.settingEl.addClass("zrr-redis-override-setting"),V(),new N.Setting(h).setName("Auto-start redis stack (docker/podman compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(z=>z.setValue(this.plugin.settings.autoStartRedis).onChange(async j=>{this.plugin.settings.autoStartRedis=j,await this.plugin.saveSettings()})),new N.Setting(h).setName("Start redis stack now").setDesc("Starts or restarts redis stack (and python worker in worker mode).").addButton(z=>z.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:h=>{new N.Setting(h).setName("Zotero local API").setHeading(),new N.Setting(h).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. HTTP://127.0.0.1:23119/API").addText(v=>v.setPlaceholder("HTTP://127.0.0.1:23119/API").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async A=>{this.plugin.settings.zoteroBaseUrl=A.trim(),await this.plugin.saveSettings()}));let b=new N.Setting(h).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),w=null,C=v=>{if(!w)return;let A=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(v.map(T=>T.value)).has(A)||(v=v.concat([{value:A,label:`Custom (${A})`}])),w.selectEl.options.length=0;for(let T of v)w.addOption(T.value,T.label);w.setValue(A)},E=async()=>{if(w){w.setDisabled(!0);try{let v=await this.plugin.fetchZoteroLibraryOptions();C(v)}finally{w.setDisabled(!1)}}};b.addDropdown(v=>{w=v;let A=(this.plugin.settings.zoteroUserId||"0").trim()||"0";v.addOption(A,"Loading..."),v.setValue(A),v.onChange(async O=>{this.plugin.settings.zoteroUserId=O.trim(),await this.plugin.saveSettings()})}),b.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await E()})}),E(),new N.Setting(h).setName("Zotero web API").setHeading(),new N.Setting(h).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(v=>v.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async A=>{this.plugin.settings.webApiBaseUrl=A.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API library type").setDesc("Library type for web API writes.").addDropdown(v=>v.addOption("user","User").addOption("group","Group").setValue(this.plugin.settings.webApiLibraryType).onChange(async A=>{this.plugin.settings.webApiLibraryType=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for web API writes.").addText(v=>v.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async A=>{this.plugin.settings.webApiLibraryId=A.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API key").setDesc("Zotero API key for write fallback (from Zotero.org).").addText(v=>{r(v),v.setPlaceholder("Your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async A=>{this.plugin.settings.webApiKey=A.trim(),await this.plugin.saveSettings()})}),new N.Setting(h).setName("Output").setHeading(),new N.Setting(h).setName("PDF folder").addText(v=>v.setPlaceholder("Zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async A=>{this.plugin.settings.outputPdfDir=A.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Notes folder").addText(v=>v.setPlaceholder("Zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async A=>{this.plugin.settings.outputNoteDir=A.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(v=>{v.setValue(this.plugin.settings.frontmatterTemplate).onChange(async A=>{this.plugin.settings.frontmatterTemplate=A,await this.plugin.saveSettings()}),v.inputEl.rows=10,v.inputEl.addClass("zrr-u-width-100")}),new N.Setting(h).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(v=>v.addOption("none","No change").addOption("camel","Camelcase").addOption("pascal","Pascalcase").addOption("snake","Snake_case").addOption("kebab","Kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async A=>{this.plugin.settings.tagSanitizeMode=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(v=>{v.setValue(this.plugin.settings.noteBodyTemplate).onChange(async A=>{this.plugin.settings.noteBodyTemplate=A,await this.plugin.saveSettings()}),v.inputEl.rows=8,v.inputEl.addClass("zrr-u-width-100")}),new N.Setting(h).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(v=>v.setPlaceholder("Zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async A=>{this.plugin.settings.chatOutputDir=A.trim()||"zotero/chats",await this.plugin.saveSettings()})),new N.Setting(h).setName("Copy pdfs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(v=>v.setValue(this.plugin.settings.copyPdfToVault).onChange(async A=>{this.plugin.settings.copyPdfToVault=A,!A&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new N.Setting(h).setName("Create ocr-layered PDF copy").setDesc("When ocr is used, replace the vault PDF with a tesseract text layer (requires copy pdfs into vault).").addToggle(v=>{let A=this.plugin.settings.copyPdfToVault;v.setValue(A?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!A).onChange(async O=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=O,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(v=>v.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async A=>{this.plugin.settings.preferObsidianNoteForCitations=A,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:h=>{new N.Setting(h).setName("Annotations").setHeading(),new N.Setting(h).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(E=>E.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async v=>{this.plugin.settings.annotationPageLabel=v.trim()||"Page",await this.plugin.saveSettings()})),new N.Setting(h).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(E=>E.setValue(this.plugin.settings.includeAnnotationImages).onChange(async v=>{this.plugin.settings.includeAnnotationImages=v,await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion").setHeading(),h.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new N.Setting(h).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(E=>E.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async v=>{this.plugin.settings.zoteroCompanionEnabled=v,await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(E=>E.setPlaceholder("HTTP://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async v=>{this.plugin.settings.zoteroCompanionBaseUrl=v.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(E=>{r(E),this.companionTokenInput=E,E.setPlaceholder("Optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async v=>{this.plugin.settings.zoteroCompanionToken=v.trim(),await this.plugin.saveSettings()})}),new N.Setting(h).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero companion plugin token to this value.").addButton(E=>E.setButtonText("Generate token").onClick(async()=>{let v=(0,$t.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=v,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(v);try{await navigator.clipboard.writeText(v),new N.Notice("Generated and copied companion token.")}catch(A){new N.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",A)}})),new N.Setting(h).setName("Annotation color map").setHeading(),h.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let b=h.createDiv({cls:"zrr-annotation-map"}),w=async E=>{this.plugin.settings.annotationColorMap=E,await this.plugin.saveSettings()},C=()=>{var L,M;b.empty();let E=this.plugin.settings.annotationColorMap||{},v=Object.entries(E);if(v.length||b.createEl("p",{text:"No color mappings configured."}),v.length){let q=b.createDiv({cls:"zrr-annotation-map-row-header"});q.createEl("span",{text:"Color"}),q.createEl("span",{text:"Heading"}),q.createEl("span",{text:"Callout"}),q.createEl("span")}for(let[q,F]of v){let I=b.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),U=I.createEl("input",{type:"text",value:q,cls:"zrr-annotation-map-input"}),B=I.createEl("input",{type:"text",value:(L=F.heading)!=null?L:"",cls:"zrr-annotation-map-input"}),V=I.createEl("input",{type:"text",value:(M=F.callout)!=null?M:"",cls:"zrr-annotation-map-input"}),z=I.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});z.type="button",U.addEventListener("change",()=>{(async()=>{let j=U.value.trim().toLowerCase();if(!j){U.value=q;return}let K={...this.plugin.settings.annotationColorMap||{}};if(j!==q&&K[j]){new N.Notice(`Annotation color '${j}' already exists.`),U.value=q;return}let Z=K[q];delete K[q],K[j]=Z!=null?Z:{heading:"",callout:""},await w(K),C()})()}),B.addEventListener("change",()=>{(async()=>{var Z;let j={...this.plugin.settings.annotationColorMap||{}},K=(Z=j[q])!=null?Z:{heading:"",callout:""};K.heading=B.value.trim(),j[q]=K,await w(j)})()}),V.addEventListener("change",()=>{(async()=>{var Z;let j={...this.plugin.settings.annotationColorMap||{}},K=(Z=j[q])!=null?Z:{heading:"",callout:""};K.callout=V.value.trim(),j[q]=K,await w(j)})()}),z.addEventListener("click",()=>{(async()=>{let j={...this.plugin.settings.annotationColorMap||{}};delete j[q],await w(j),C()})()})}let A=b.createDiv({cls:"zrr-annotation-map-actions"}),O=A.createEl("button",{text:"Add mapping"});O.type="button",O.addEventListener("click",()=>{(async()=>{let q={...this.plugin.settings.annotationColorMap||{}},F="new-color",$=1;for(;q[F];)F=`new-color-${$}`,$+=1;q[F]={heading:"",callout:""},await w(q),C()})()});let T=A.createEl("button",{text:"Reset to defaults"});T.type="button",T.addEventListener("click",()=>{(async()=>(await w({...Ge.annotationColorMap}),C()))()})};C()}},{id:"ocr",label:"OCR",render:h=>{new N.Setting(h).setName("Docling").setHeading();let b=null,w=A=>{if(!b)return;let O=this.plugin.settings.ocrEngine;new Set(A.map(L=>L.value)).has(O)||(A=A.concat([{value:O,label:`Current (unavailable): ${O}`}])),b.selectEl.options.length=0;for(let L of A)b.addOption(L.value,L.label);b.setValue(O)},C=async()=>{if(!b)return;b.setDisabled(!0);let A={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{A=await this.plugin.detectOcrEngines()}catch(L){A={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let O=[{value:"auto",label:"Auto (default)"}];A.tesseract&&O.push({value:"tesseract",label:"Tesseract (local)"}),A.paddleStructureLocal&&O.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),A.paddleVlLocal&&O.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(O.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),O.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),w(O),b.setDisabled(!1)},E=new N.Setting(h).setName("Paddle ocr API key").setDesc("API token for paddleocr-vl / pp-structurev3 endpoints. Get a free API key at "),v=document.createElement("a");v.href="https://aistudio.baidu.com/paddleocr",v.textContent="HTTPS://aistudio.baidu.com/paddleocr",v.target="_blank",v.rel="noopener noreferrer",E.descEl.appendChild(v),E.descEl.append("."),E.addText(A=>{r(A),A.setPlaceholder("Your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async O=>{this.plugin.settings.paddleApiKey=O.trim(),await this.plugin.saveSettings(),await C()})}),new N.Setting(h).setName("Paddleocr-vl API URL").setDesc("Optional override for the paddleocr-vl API endpoint.").addText(A=>A.setPlaceholder("HTTPS://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async O=>{this.plugin.settings.paddleVlApiUrl=O.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Pp-structurev3 API URL").setDesc("API endpoint for pp-structurev3 (see baidu AI studio docs).").addText(A=>A.setPlaceholder("HTTPS://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async O=>{this.plugin.settings.paddleStructureApiUrl=O.trim(),await this.plugin.saveSettings(),await C()})),new N.Setting(h).setName("Ocr engine").setDesc("Select the ocr engine to use when ocr is required.").addDropdown(A=>{b=A,A.addOption("auto","Auto (default)"),A.setValue(this.plugin.settings.ocrEngine),A.onChange(async O=>{this.plugin.settings.ocrEngine=O,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Ocr decision (when to ocr)").setDesc("Controls when ocr runs; per-page behavior is configured separately below.").addDropdown(A=>A.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","Ocr only if text is poor").addOption("force","Prefer ocr for full document").setValue(this.plugin.settings.ocrMode).onChange(async O=>{this.plugin.settings.ocrMode=O,await this.plugin.saveSettings()})),new N.Setting(h).setName("Ocr layout override (per-page)").setDesc("Force per-page ocr when ocr runs, bypassing layout heuristics; can be slower for multi-column pdfs.").addToggle(A=>A.setValue(this.plugin.settings.forcePerPageOcr).onChange(async O=>{this.plugin.settings.forcePerPageOcr=O,await this.plugin.saveSettings()})),new N.Setting(h).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(A=>{A.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async O=>{this.plugin.settings.ocrQualityThreshold=O,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Chunking").setDesc("Page or section").addDropdown(A=>A.addOption("page","Page").addOption("section","Section").setValue(this.plugin.settings.chunkingMode).onChange(async O=>{this.plugin.settings.chunkingMode=O,await this.plugin.saveSettings()})),C()}},{id:"llms",label:"LLMs",render:h=>{new N.Setting(h).setName("Model provider profiles").setHeading();let b=h.createDiv({cls:"zrr-llm-profiles"}),w=()=>{b.empty();let P=t();P.length||b.createEl("p",{text:"No profiles yet. Add one below."});for(let R of P){let D=b.createEl("details",{cls:"zrr-profile"});P.length===1&&(D.open=!0);let ne=D.createEl("summary",{text:R.name||R.id||"Profile"});ne.addClass("zrr-profile-title");let je=D.createDiv({cls:"zrr-profile-body"});new N.Setting(je).setName("Profile name").addText(he=>he.setPlaceholder("My provider").setValue(R.name||"").onChange(async fe=>{R.name=fe.trim(),ne.textContent=R.name||R.id||"Profile",await n(t())})),new N.Setting(je).setName("Base URL").addText(he=>he.setPlaceholder("HTTP://localhost:1234/v1").setValue(R.baseUrl||"").onChange(async fe=>{R.baseUrl=fe.trim(),await n(t())})),new N.Setting(je).setName("API key").setDesc("Stored in settings (not encrypted).").addText(he=>{r(he),he.setPlaceholder("Sk-...").setValue(R.apiKey||"").onChange(async fe=>{R.apiKey=fe.trim(),await n(t())})}),new N.Setting(je).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(he=>he.setButtonText("Delete profile").onClick(async()=>{let fe=t().filter(mn=>mn.id!==R.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===R.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===R.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===R.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(fe),w()}))}new N.Setting(b).addButton(R=>R.setButtonText("Add profile").onClick(async()=>{let D=`profile-${Date.now().toString(36)}`,ne=t().concat([{id:D,name:"Custom",baseUrl:"",apiKey:""}]);await n(ne),w()}))};w(),new N.Setting(h).setName("Ocr cleanup").setHeading(),new N.Setting(h).setName("Model cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor ocr at import. Can be slow/costly.").addToggle(P=>P.setValue(this.plugin.settings.enableLlmCleanup).onChange(async R=>{this.plugin.settings.enableLlmCleanup=R,await this.plugin.saveSettings()}));let C=null,E=null,v=null,A=()=>Promise.resolve(),O=async(P,R=!0)=>{let D=P.trim();this.plugin.settings.llmCleanupBaseUrl=D,R&&(this.plugin.settings.llmCleanupProviderProfileId="",C&&C.setValue("custom")),E&&E.setValue(D),await this.plugin.saveSettings()},T=async P=>{let R=t().find(D=>D.id===P);this.plugin.settings.llmCleanupProviderProfileId=P,R&&(this.plugin.settings.llmCleanupBaseUrl=R.baseUrl,this.plugin.settings.llmCleanupApiKey=R.apiKey,E==null||E.setValue(R.baseUrl),v==null||v.setValue(R.apiKey)),await this.plugin.saveSettings(),await A()};new N.Setting(h).setName("Cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{C=P,P.addOption("custom","Custom (manual)");for(let D of t())P.addOption(D.id,D.name||D.id);let R=this.plugin.settings.llmCleanupProviderProfileId;P.setValue(R&&t().some(D=>D.id===R)?R:"custom"),P.onChange(async D=>{if(D==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await T(D)})}),new N.Setting(h).setName("Cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. HTTP://127.0.0.1:1234/v1").addText(P=>{E=P,P.setPlaceholder("HTTP://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async R=>{await O(R)})}),new N.Setting(h).setName("Cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(P=>{v=P,r(P),P.setPlaceholder("Sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async R=>{this.plugin.settings.llmCleanupApiKey=R.trim(),this.plugin.settings.llmCleanupProviderProfileId="",C&&C.setValue("custom"),await this.plugin.saveSettings()})});let L=new N.Setting(h).setName("Cleanup model").setDesc("Select a cleanup-capable model from the provider."),M=null,q=P=>{if(!M)return;let R=(this.plugin.settings.llmCleanupModel||"").trim(),D=new Set(P.map(ne=>ne.value));R&&!D.has(R)&&(P=P.concat([{value:R,label:`Custom (${R})`}])),M.selectEl.options.length=0;for(let ne of P)M.addOption(ne.value,ne.label);R&&M.setValue(R)};A=async()=>{if(M){M.setDisabled(!0);try{let P=await this.plugin.fetchCleanupModelOptions();q(P)}finally{M.setDisabled(!1)}}},L.addDropdown(P=>{M=P;let R=(this.plugin.settings.llmCleanupModel||"").trim();P.addOption(R||"loading","Loading..."),P.setValue(R||"loading"),P.onChange(async D=>{this.plugin.settings.llmCleanupModel=D.trim(),await this.plugin.saveSettings()})}),L.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await A()})}),A(),new N.Setting(h).setName("Cleanup temperature").setDesc("Lower is more conservative.").addText(P=>P.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async R=>{let D=Number.parseFloat(R);this.plugin.settings.llmCleanupTemperature=Number.isFinite(D)?D:0,await this.plugin.saveSettings()})),new N.Setting(h).setName("Cleanup minimum quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(P=>P.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async R=>{this.plugin.settings.llmCleanupMinQuality=R,await this.plugin.saveSettings()})),new N.Setting(h).setName("Cleanup maximum chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(P=>P.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(D)?D:2e3,await this.plugin.saveSettings()})),new N.Setting(h).setName("Text embedding").setHeading();let F=null,$=null,I=null,U=()=>Promise.resolve(),B=async(P,R=!0)=>{let D=P.trim();this.plugin.settings.embedBaseUrl=D,R&&(this.plugin.settings.embedProviderProfileId="",F&&F.setValue("custom")),$&&$.setValue(D),await this.plugin.saveSettings()},V=async P=>{let R=t().find(D=>D.id===P);this.plugin.settings.embedProviderProfileId=P,R&&(this.plugin.settings.embedBaseUrl=R.baseUrl,this.plugin.settings.embedApiKey=R.apiKey,$==null||$.setValue(R.baseUrl),I==null||I.setValue(R.apiKey)),await this.plugin.saveSettings(),await U()};new N.Setting(h).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{F=P,P.addOption("custom","Custom (manual)");for(let D of t())P.addOption(D.id,D.name||D.id);let R=this.plugin.settings.embedProviderProfileId;P.setValue(R&&t().some(D=>D.id===R)?R:"custom"),P.onChange(async D=>{if(D==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await V(D)})}),new N.Setting(h).setName("Embeddings base URL").addText(P=>{$=P,P.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async R=>{await B(R)})}),new N.Setting(h).setName("Embeddings API key").addText(P=>{I=P,r(P),P.setPlaceholder("Lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async R=>{this.plugin.settings.embedApiKey=R.trim(),this.plugin.settings.embedProviderProfileId="",F&&F.setValue("custom"),await this.plugin.saveSettings()})});let z=new N.Setting(h).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),j=null,K=P=>{if(!j)return;let R=(this.plugin.settings.embedModel||"").trim(),D=new Set(P.map(ne=>ne.value));R&&!D.has(R)&&(P=P.concat([{value:R,label:`Custom (${R})`}])),j.selectEl.options.length=0;for(let ne of P)j.addOption(ne.value,ne.label);R&&j.setValue(R)};U=async()=>{if(j){j.setDisabled(!0);try{let P=await this.plugin.fetchEmbeddingModelOptions();K(P)}finally{j.setDisabled(!1)}}},z.addDropdown(P=>{j=P;let R=(this.plugin.settings.embedModel||"").trim();P.addOption(R||"loading","Loading..."),P.setValue(R||"loading"),P.onChange(async D=>{this.plugin.settings.embedModel=D.trim(),await this.plugin.saveSettings()})}),z.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await U()})}),U(),new N.Setting(h).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(P=>P.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async R=>{this.plugin.settings.embedIncludeMetadata=R,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(P=>P.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.embedContextWindow=Number.isFinite(D)?Math.max(0,D):1,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(P=>P.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.embedContextChars=Number.isFinite(D)?Math.max(0,D):220,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(P=>P.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(D)?Math.max(0,D):3500,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(P=>P.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(D)?Math.max(0,D):200,await this.plugin.saveSettings()})),new N.Setting(h).setName("Generate model tags for chunks").setDesc("Use the ocr cleanup model to tag chunks before indexing.").addToggle(P=>P.setValue(this.plugin.settings.enableChunkTagging).onChange(async R=>{this.plugin.settings.enableChunkTagging=R,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat model").setHeading();let Z=null,G=null,H=null,ae=()=>Promise.resolve(),Ae=async(P,R=!0)=>{let D=P.trim();this.plugin.settings.chatBaseUrl=D,R&&(this.plugin.settings.chatProviderProfileId="",Z&&Z.setValue("custom")),G&&G.setValue(D),await this.plugin.saveSettings()},dt=async P=>{let R=t().find(D=>D.id===P);this.plugin.settings.chatProviderProfileId=P,R&&(this.plugin.settings.chatBaseUrl=R.baseUrl,this.plugin.settings.chatApiKey=R.apiKey,G==null||G.setValue(R.baseUrl),H==null||H.setValue(R.apiKey)),await this.plugin.saveSettings(),await ae()};new N.Setting(h).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{Z=P,P.addOption("custom","Custom (manual)");for(let D of t())P.addOption(D.id,D.name||D.id);let R=this.plugin.settings.chatProviderProfileId;P.setValue(R&&t().some(D=>D.id===R)?R:"custom"),P.onChange(async D=>{if(D==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await dt(D)})}),new N.Setting(h).setName("Chat base URL").setDesc("Compatible endpoint for chat requests.").addText(P=>{G=P,P.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async R=>{await Ae(R)})}),new N.Setting(h).setName("Chat API key").addText(P=>{H=P,r(P),P.setPlaceholder("Lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async R=>{this.plugin.settings.chatApiKey=R.trim(),this.plugin.settings.chatProviderProfileId="",Z&&Z.setValue("custom"),await this.plugin.saveSettings()})});let qe=new N.Setting(h).setName("Chat model").setDesc("Select a chat-capable model from the provider."),ce=null,pt=P=>{if(!ce)return;let R=(this.plugin.settings.chatModel||"").trim(),D=new Set(P.map(ne=>ne.value));R&&!D.has(R)&&(P=P.concat([{value:R,label:`Custom (${R})`}])),ce.selectEl.options.length=0;for(let ne of P)ce.addOption(ne.value,ne.label);R&&ce.setValue(R)};ae=async()=>{if(ce){ce.setDisabled(!0);try{let P=await this.plugin.fetchChatModelOptions();pt(P)}finally{ce.setDisabled(!1)}}},qe.addDropdown(P=>{ce=P;let R=(this.plugin.settings.chatModel||"").trim();P.addOption(R||"loading","Loading..."),P.setValue(R||"loading"),P.onChange(async D=>{this.plugin.settings.chatModel=D.trim(),await this.plugin.saveSettings()})}),qe.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await ae()})}),ae(),new N.Setting(h).setName("Temperature").addText(P=>P.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async R=>{let D=Number.parseFloat(R);this.plugin.settings.chatTemperature=Number.isFinite(D)?D:.2,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(P=>P.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(D)?Math.max(0,D):6,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(P=>P.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async R=>{this.plugin.settings.chatPaneLocation=R,await this.plugin.saveSettings()})),new N.Setting(h).setName("Retrieval").setHeading(),new N.Setting(h).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(P=>P.setValue(this.plugin.settings.enableAgenticRag).onChange(async R=>{this.plugin.settings.enableAgenticRag=R,await this.plugin.saveSettings()})),new N.Setting(h).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(P=>P.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.agenticMaxIters=Number.isFinite(D)?Math.max(1,D):2,await this.plugin.saveSettings()})),new N.Setting(h).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(P=>P.setValue(this.plugin.settings.enableQueryExpansion).onChange(async R=>{this.plugin.settings.enableQueryExpansion=R,await this.plugin.saveSettings()})),new N.Setting(h).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(P=>P.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.queryExpansionCount=Number.isFinite(D)?Math.max(1,D):3,await this.plugin.saveSettings()})),new N.Setting(h).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(P=>P.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async R=>{this.plugin.settings.enableCrossEncoderRerank=R,await this.plugin.saveSettings()}));let X=new Set(jt.map(P=>P.value)),Y=(this.plugin.settings.rerankModel||"").trim()||ke,ue=X.has(Y)?Y:Ne,se=null,At=()=>{if(!se)return;let R=!(ue===Ne);se.setDisabled(R),se.inputEl.disabled=R,se.inputEl.readOnly=R,se.inputEl.classList.toggle("is-disabled",R),se.inputEl.setAttribute("aria-disabled",String(R))},Rt=new N.Setting(h).setName("Cross-encoder model").setDesc("Choose a multilingual preset, or select custom to edit the model ID.");Rt.addDropdown(P=>{for(let R of jt)P.addOption(R.value,R.label);P.addOption(Ne,"Custom"),P.setValue(ue),P.onChange(async R=>{ue=R,R!==Ne?this.plugin.settings.rerankModel=R:(this.plugin.settings.rerankModel||"").trim()||(this.plugin.settings.rerankModel=ke),await this.plugin.saveSettings(),se==null||se.setValue(this.plugin.settings.rerankModel||ke),At()})}),Rt.addText(P=>{se=P,P.setPlaceholder(ke).setValue(Y).onChange(async R=>{ue===Ne&&(this.plugin.settings.rerankModel=R.trim()||ke,await this.plugin.saveSettings())}),At()}),new N.Setting(h).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 n candidates before reranking.").addText(P=>P.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(D)?Math.max(1,D):4,await this.plugin.saveSettings()})),new N.Setting(h).setName("Rrf k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(P=>P.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.rrfK=Number.isFinite(D)?Math.max(1,D):60,await this.plugin.saveSettings()})),new N.Setting(h).setName("Rrf log top n").setDesc("Log the top n rrf-ranked chunks to stderr (0 disables).").addText(P=>P.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.rrfLogTop=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()})),new N.Setting(h).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(P=>P.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async R=>{let D=Number.parseInt(R,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:h=>{new N.Setting(h).setName("Python runtime").setHeading(),new N.Setting(h).setName("Use local runtime (legacy)").setDesc("Switch to local interpreter/venv mode and enable advanced runtime settings.").addButton(b=>b.setButtonText("Switch").onClick(async()=>{await this.plugin.switchPythonRuntimeToLocalLegacy()})),new N.Setting(h).setName("Logging").setHeading(),new N.Setting(h).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(b=>b.setValue(this.plugin.settings.enableFileLogging).onChange(async w=>{this.plugin.settings.enableFileLogging=w,await this.plugin.saveSettings()})),new N.Setting(h).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(b=>b.setPlaceholder(`${ie}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async w=>{this.plugin.settings.logFilePath=w.trim()||`${ie}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new N.Setting(h).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(b=>b.setButtonText("Open log").onClick(async()=>{var w,C;await((C=(w=this.plugin).openLogFile)==null?void 0:C.call(w))})).addButton(b=>b.setButtonText("Clear log").onClick(async()=>{var w,C;await((C=(w=this.plugin).clearLogFile)==null?void 0:C.call(w))})),new N.Setting(h).setName("Zotero companion plugin").setHeading(),h.createEl("p",{text:"Download the xpi, then in Zotero go to tools \u2192 add-ons \u2192 install from file and restart."}),new N.Setting(h).setName("Download companion add-on").setDesc("Downloads the companion xpi to your system downloads folder.").addButton(b=>b.setButtonText("Download xpi").onClick(async()=>{let w=this.getDefaultDownloadDir();if(!w){new N.Notice("Unable to resolve the system downloads folder.");return}let C=Be.default.join(w,"zrr-companion.xpi");if(await this.companionXpiExists(C)){new N.Notice(`Companion XPI already exists: ${C}`);return}new N.Notice("Downloading companion xpi..."),await this.downloadCompanionXpi(C)})),new N.Setting(h).setName("Open Zotero").setDesc("Launch Zotero and open the add-ons window (tools \u2192 add-ons).").addButton(b=>b.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new N.Setting(h).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(b=>b.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),new N.Setting(h).setName("Redis indexing").setHeading(),new N.Setting(h).setName("Reindex redis from cached chunks").setDesc("Rebuild the redis index from cached chunk JSON files.").addButton(b=>b.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new N.Setting(h).setName("Recreate redis stack").setDesc("Pulls the configured redis image and force-recreates the redis-stack service.").addButton(b=>b.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateRedisStack()})),new N.Setting(h).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(b=>b.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(b=>b.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()})),new N.Setting(h).setName("Release notes").setHeading(),new N.Setting(h).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(b=>b.setButtonText("Show").onClick(()=>{this.plugin.openReleaseNotesModal()}))}}],p=new Map,_=new Map,g=h=>{this.activeTab=h;for(let[b,w]of p){let C=b===h;w.classList.toggle("is-active",C),w.setAttribute("aria-selected",C?"true":"false"),w.setAttribute("tabindex",C?"0":"-1")}for(let[b,w]of _){let C=b===h;w.classList.toggle("is-active",C),w.hidden=!C}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let k=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let h of d){let b=y.createEl("button",{text:h.label,cls:"zrr-settings-tab-button"}),w=`zrr-settings-tab-${h.id}`,C=`zrr-settings-panel-${h.id}`;b.type="button",b.id=w,b.setAttribute("role","tab"),b.setAttribute("aria-controls",C),b.setAttribute("aria-selected","false"),b.addEventListener("click",()=>g(h.id));let E=k.createDiv({cls:"zrr-settings-tab-panel"});E.id=C,E.setAttribute("role","tabpanel"),E.setAttribute("aria-labelledby",w),E.hidden=!0,h.render(E),p.set(h.id,b),_.set(h.id,E)}let x=d.some(h=>h.id===this.activeTab)?this.activeTab:d[0].id;g(x)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Be.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await Ue.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await Ue.promises.mkdir(Be.default.dirname(e),{recursive:!0});let t=await(0,N.requestUrl)({url:En,method:"GET"});if(t.status!==200){new N.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await Ue.promises.writeFile(e,n),new N.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new N.Notice("Failed to download companion xpi. See console for details."),console.warn("Failed to download companion XPI",t)}}};var Bt=require("@codemirror/state"),Zt=require("@codemirror/view"),pe=require("obsidian");var Sn=f=>{let u=f.scrollDOM.getBoundingClientRect(),e=f.posAtCoords({x:u.left+8,y:+u.height*.25});return e===null?null:f.state.doc.lineAt(e).number},Le=f=>!f||typeof f!="object"?null:f,We=class{constructor(u,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=u,this.helpers=e}createSyncExtension(){let u=this.helpers,e=this.syncPdfSidebarForDoc.bind(this);return Zt.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=u.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=u.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var p,_;let r=this.docId;if(!r)return;let i=Sn(t);if(i===null)return;let s=u.findChunkStartLineInDoc(t.state.doc,i);if(!s)return;let a=u.parseChunkMarkerLine(s.text),o=(p=a==null?void 0:a.pageNumber)!=null?p:null,l=(_=a==null?void 0:a.chunkId)!=null?_:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||d)||(this.lastPage=o,this.lastChunkId=l,e(r,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(u={}){if(!this.pendingPdfSync||!this.isPdfSidebarLeaf(this.pdfSidebarLeaf)&&!await this.getPdfSidebarLeaf(!!u.allowCreateLeaf)||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let e=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(e.docId,e.pageNumber,e.chunkId)}async revealPdfSidebar(u={}){let e=await this.getPdfSidebarLeaf(!!u.allowCreateLeaf);if(e)try{await this.deps.app.workspace.revealLeaf(e)}catch(t){console.warn("Failed to reveal PDF sidebar leaf",t)}}updatePreviewScrollHandler(){var n;let u=this.deps.app.workspace.getActiveViewOfType(pe.MarkdownView);if(!u||u.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=u.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(u);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(u)}async syncPdfSidebarForFile(u,e={}){try{let t=await this.deps.app.vault.read(u),n=await this.deps.resolveDocIdForNote(u,t);if(!n)return;let r=this.helpers.extractFirstChunkMarkerFromContent(t);await this.syncPdfSidebarForDoc(n,r==null?void 0:r.pageNumber,r==null?void 0:r.chunkId,e)}catch(t){console.warn("Failed to sync PDF sidebar for opened note",t)}}async syncPdfSidebarForDoc(u,e,t,n={}){if(u){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:u,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let r=await this.deps.getDocIndexEntry(u);r||(r=await this.deps.hydrateDocIndexFromCache(u));let i=r!=null&&r.pdf_path?String(r.pdf_path):"";if(!i)return;let s=this.deps.toVaultRelativePath(i);if(!s){let p=(0,pe.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(p)instanceof pe.TFile&&(s=p)}if(!s)return;let a=this.deps.app.vault.getAbstractFileByPath(s);if(!(a instanceof pe.TFile)||a.extension.toLowerCase()!=="pdf")return;let o=await this.getPdfSidebarLeaf(!!n.allowCreateLeaf);if(!o){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}if(!this.isLeafTabActive(o)&&!n.allowCreateLeaf){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}let l=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(l===null&&t&&(l=await this.resolvePageNumberForChunk(u,t)),l===null||this.isPdfSidebarLeaf(o)&&this.pdfSidebarLeaf===o&&this.pdfSidebarDocId===u&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===l)return;let c=s,d=l!==null?`${c}#page=${l}`:c;if(await this.openPdfLinkInLeaf(o,a,d),this.pdfSidebarLeaf=o,this.pdfSidebarDocId=u,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=l,this.updatePdfSidebarIcon(o),n.allowCreateLeaf&&!this.isLeafTabActive(o))try{await this.deps.app.workspace.revealLeaf(o)}catch(p){console.warn("Failed to reveal PDF sidebar leaf",p)}}finally{this.pdfSyncInFlight=!1;let r=this.queuedPdfSync;this.queuedPdfSync=null,r&&this.syncPdfSidebarForDoc(r.docId,r.pageNumber,r.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(u){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(u)}))}syncPdfSidebarForPreview(u){let e=this.previewScrollEl;if(!e)return;let t=u.getViewData();if(!t)return;let n=Bt.Text.of(t.split(/\r?\n/)),r=this.helpers.extractDocIdFromDoc(n);if(!r)return;let i=this.getPreviewTopLineNumber(e);if(i===null)return;let s=this.helpers.findChunkStartLineInDoc(n,i+1);if(!s)return;let a=this.helpers.parseChunkMarkerLine(s.text);!(a!=null&&a.pageNumber)&&!(a!=null&&a.chunkId)||this.syncPdfSidebarForDoc(r,a==null?void 0:a.pageNumber,a==null?void 0:a.chunkId)}getPreviewTopLineNumber(u){var n;let e=u.getBoundingClientRect().top,t=u.querySelectorAll("[data-line]");for(let r of Array.from(t))if(r.getBoundingClientRect().bottom>=e+2){let s=(n=r.getAttribute("data-line"))!=null?n:"",a=Number.parseInt(s,10);if(Number.isFinite(a))return a}return null}async getPdfSidebarLeaf(u=!1){if(this.pdfSidebarLeaf&&this.isUsableRightSidebarLeaf(this.pdfSidebarLeaf)&&this.isPdfSidebarLeaf(this.pdfSidebarLeaf))return this.pdfSidebarLeaf;this.resetPdfSidebarLeaf();let e=this.findRightSidebarPdfLeaf();if(e)return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;if(u){let t=this.deps.app.workspace;if(typeof t.ensureSideLeaf=="function")try{let r=await t.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!1});if(this.isUsableRightSidebarLeaf(r))return this.pdfSidebarLeaf=r,r.isDeferred&&await r.loadIfDeferred(),this.updatePdfSidebarIcon(r),r}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let n=this.deps.app.workspace.getRightLeaf(!1);if(this.isUsableRightSidebarLeaf(n))return this.pdfSidebarLeaf=n,n}return null}findRightSidebarPdfLeaf(){let u=this.deps.app.workspace;if(typeof u.iterateAllLeaves!="function")return null;let e=null;return u.iterateAllLeaves(t=>{if(!(!this.isUsableRightSidebarLeaf(t)||!this.isPdfSidebarLeaf(t))){if(this.isLeafTabActive(t)){e=t;return}e||(e=t)}}),e}resetPdfSidebarLeaf(){this.pdfSidebarLeaf=null,this.pdfSidebarDocId=null,this.pdfSidebarPdfPath=null,this.pdfSidebarPage=null}isUsableRightSidebarLeaf(u){var t;return this.isRightSidebarLeaf(u)?!!((t=u.containerEl)!=null&&t.isConnected):!1}getLeafViewType(u){var t,n;if(!u)return"";try{let r=u.getViewState();if(typeof(r==null?void 0:r.type)=="string"&&r.type)return r.type}catch(r){console.debug("Failed to read leaf view state",r)}let e=(n=(t=u.view)==null?void 0:t.getViewType)==null?void 0:n.call(t);return typeof e=="string"?e:""}isPdfSidebarLeaf(u){return this.getLeafViewType(u)==="pdf"}isRightSidebarLeaf(u){if(!u)return!1;let t=u.containerEl;return t?!!t.closest(".workspace-split.mod-right-split, .mod-right-split"):!1}updatePdfSidebarIcon(u){if(!u||!this.isRightSidebarLeaf(u)||!this.isPdfSidebarLeaf(u))return;let t=u.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let r=u;if(r.tabHeaderEl&&n.push(...Array.from(r.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),r.tabHeaderInnerIconEl&&n.push(r.tabHeaderInnerIconEl),n.length===0)return;let i=new Set;for(let a of n)if(!i.has(a)){if(i.add(a),a.replaceChildren(),(0,pe.setIcon)(a,"zrr-pdf"),!a.querySelector("svg")&&this.deps.iconSvg){let o=document.createRange().createContextualFragment(this.deps.iconSvg);a.replaceChildren(o)}a.dataset&&(a.dataset.zrrIcon="zrr-pdf")}let s=u.view;s.icon="zrr-pdf",typeof s.getIcon=="function"&&(s.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(u,e,t){var l;if(!await this.ensurePdfLeafReady(u,e)){await u.openFile(e,{active:!1});return}let r=Le((l=this.getPluginsRegistry())==null?void 0:l["pdf-plus"]),i=Le(r==null?void 0:r.lib),s=Le(i==null?void 0:i.workspace),a=typeof(s==null?void 0:s.openPDFLinkTextInLeaf)=="function"?s.openPDFLinkTextInLeaf:null;if(typeof a=="function")try{await a.call(s,u,t,"",{active:!1});return}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150)}let o=u;if(typeof o.openLinkText=="function"){try{await o.openLinkText(t,"",{active:!1})}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150),await o.openLinkText(t,"",{active:!1})}return}await u.openFile(e,{active:!1})}async ensurePdfLeafReady(u,e){if(this.isPdfSidebarLeaf(u))return!0;try{await u.setViewState({type:"pdf",active:!1})}catch(t){console.debug("Failed to set PDF view state on sidebar leaf",t)}if(u.isDeferred)try{await u.loadIfDeferred()}catch(t){console.debug("Failed to load deferred PDF sidebar leaf",t)}if(this.isPdfSidebarLeaf(u))return!0;try{await u.openFile(e,{active:!1})}catch(t){return console.warn("Failed to open PDF file in sidebar leaf",t),!1}return this.isPdfSidebarLeaf(u)}isPdfAnnotationRaceError(u){let e=u instanceof Error?u.message:typeof u=="string"?u:"";return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(u){return new Promise(e=>setTimeout(e,u))}getPluginsRegistry(){var e;return(e=this.deps.app.plugins)==null?void 0:e.plugins}isLeafTabActive(u){var r;let e=u;if((r=e.parent)!=null&&r.activeLeaf)return e.parent.activeLeaf===u;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(u,e){var l,c,d,p,_;if(!u||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,u)||e,n=this.chunkPageCache.get(u);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let r=(0,pe.normalizePath)(`${Q}/${u}.json`);if(!await this.deps.app.vault.adapter.exists(r))return null;let s=Le(await this.deps.readChunkPayload(r)),a=Array.isArray(s==null?void 0:s.chunks)?s.chunks:[],o=new Map;for(let g of a){let y=Le(g),k=typeof(y==null?void 0:y.chunk_id)=="string"?y.chunk_id.trim():"";if(!k)continue;let x=Number.isFinite((c=y==null?void 0:y.page_start)!=null?c:NaN)?Number(y==null?void 0:y.page_start):null,h=Number.isFinite((d=y==null?void 0:y.page_end)!=null?d:NaN)?Number(y==null?void 0:y.page_end):null,b=x!=null?x:h;b!==null&&(o.set(k,b),o.set(`${u}:${k}`,b))}return this.chunkPageCache.set(u,o),(_=(p=o.get(t))!=null?p:o.get(e))!=null?_:null}};var He={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.19
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.19
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.19
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.19
...
`;n.replaceRange(l,{line:i.startLine+1,ch:0},{line:i.endLine,ch:0}),this.showStatusProgress("Chunk cleaned.",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice("Chunk cleaned.")}async requestOcrCleanup(e){var l,c,d,p,_,g,y,k,x;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new m.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let r=Number(this.settings.llmCleanupMaxChars||0);if(r>0&&e.length>r)return new m.Notice("Chunk exceeds ocr cleanup max length. Adjust settings to clean it."),this.openPluginSettings(),null;let i=`${t}/chat/completions`,s={"Content-Type":"application/json"},a=(this.settings.llmCleanupApiKey||"").trim();a&&(s.Authorization=`Bearer ${a}`);let o={model:n,temperature:Number((l=this.settings.llmCleanupTemperature)!=null?l:0),messages:[{role:"system",content:"You are an OCR cleanup assistant. Fix OCR errors without changing meaning. Do not add content. Return corrected text only. Detect footnote references and definitions and format them in Markdown as [^n] and [^n]: (for the note text). Preserve special characters and formatting. Do not create new footnotes or content; only reformat existing footnote markers/lines."},{role:"user",content:e}]};try{let h=await this.requestLocalApiRaw(i,{method:"POST",headers:s,body:JSON.stringify(o)});if(h.statusCode>=400){let E=h.body.toString("utf8");throw new Error(`Cleanup request failed (${h.statusCode}): ${E||"no response body"}`)}let b=JSON.parse(h.body.toString("utf8")),w=(x=(k=(y=(p=(d=(c=b==null?void 0:b.choices)==null?void 0:c[0])==null?void 0:d.message)==null?void 0:p.content)!=null?y:(g=(_=b==null?void 0:b.choices)==null?void 0:_[0])==null?void 0:g.text)!=null?k:b==null?void 0:b.output_text)!=null?x:"",C=String(w||"").trim();return C||(new m.Notice("Cleanup returned empty text."),null)}catch(h){return console.error("OCR cleanup failed",h),new m.Notice("Ocr cleanup failed. Check the cleanup model settings."),null}}parseChunkTags(e,t){if(!e)return[];let n=e.trim(),r=[];if(n.startsWith("[")&&n.endsWith("]"))try{let a=JSON.parse(n);Array.isArray(a)&&(r=a.map(o=>String(o)))}catch(a){r=[]}r.length===0&&(r=n.split(/[,;\n]+/));let i=new Set,s=[];for(let a of r){let o=a.trim();if(o=o.replace(/^[-•\d.)\s]+/,""),o=o.replace(/\s+/g," ").trim(),!o||o.length<2)continue;let l=o.toLowerCase();if(!i.has(l)&&(i.add(l),s.push(o),s.length>=t))break}return s}async requestChunkTags(e){var p,_,g,y,k,x,h,b,w;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new m.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let r=e.trim().slice(0,2e3);if(!r)return[];let i=`${t}/chat/completions`,s={"Content-Type":"application/json"},a=(this.settings.llmCleanupApiKey||"").trim();a&&(s.Authorization=`Bearer ${a}`);let o=5,l="Return 3 to 5 high-signal, concrete noun-phrase tags. Avoid generic terms (study, paper, method), verbs, and filler. Prefer specific entities, methods, datasets, and named concepts. Output comma-separated tags only. No extra text.",c=Number((p=this.settings.llmCleanupTemperature)!=null?p:0),d={model:n,messages:[{role:"system",content:l},{role:"user",content:r}]};Number.isFinite(c)&&(d.temperature=c),this.showStatusProgress("Generating tags...",null);try{let C=async T=>{let L=await this.requestLocalApiRaw(i,{method:"POST",headers:s,body:JSON.stringify(T)});if(L.statusCode>=400){let M=L.body.toString("utf8");throw new Error(`Tag request failed (${L.statusCode}): ${M||"no response body"}`)}return L.body},E;try{E=await C(d)}catch(T){let L=T instanceof Error?T.message:String(T);if("temperature"in d&&/temperature/i.test(L)&&/unsupported|default/i.test(L)){let M={...d};delete M.temperature,E=await C(M)}else throw T}let v=JSON.parse(E.toString("utf8")),A=(w=(b=(h=(y=(g=(_=v==null?void 0:v.choices)==null?void 0:_[0])==null?void 0:g.message)==null?void 0:y.content)!=null?h:(x=(k=v==null?void 0:v.choices)==null?void 0:k[0])==null?void 0:x.text)!=null?b:v==null?void 0:v.output_text)!=null?w:"",O=this.parseChunkTags(String(A||""),o);return O.length||new m.Notice("Tag generation returned no tags."),O}catch(C){return console.error("Tag generation failed",C),new m.Notice("Tag generation failed. Check the cleanup model settings."),null}finally{this.clearStatusProgress()}}async renderMarkdownToIndexText(e){if(!e)return"";let t=this.replaceImageMarkersForIndexPreview(e),n=document.createElement("div"),r=new m.Component;r.load();try{await m.MarkdownRenderer.render(this.app,t,n,"",r)}catch(s){return console.warn("Failed to render markdown for index preview",s),this.normalizeIndexPreviewText(t)}finally{r.unload()}let i=n.textContent||t;return this.normalizeIndexPreviewText(i)}replaceImageMarkersForIndexPreview(e){if(!e)return"";let t=r=>{let i=r.trim();return i?`Image caption: ${i}`:"Image"},n=e.replace(/!\[\[([^\]|]+)(?:\|([^\]]+))?\]\]/g,(r,i,s)=>t(s||""));return n=n.replace(/!\[([^\]]*)]\([^)]+\)/g,(r,i)=>t(i||"")),n=n.replace(/<img[^>]*>/gi,r=>{let i=r.match(/\balt=(['"])([^'"]*)\1/i);return t(i?i[2]:"")}),n}normalizeIndexPreviewText(e){return e.replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/[ \t]+/g," ").replace(/\n{3,}/g,`

`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,t=1200){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let r=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},t);this.noteSyncTimers.set(e.path,r)}scheduleNoteMetadataSync(e,t=1200,n="save"){let r=this.noteMetadataSyncTimers.get(e.path);r!==void 0&&window.clearTimeout(r);let i=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,n)},t);this.noteMetadataSyncTimers.set(e.path,i)}scheduleNoteAnnotationSync(e,t=1200,n="save"){let r=this.noteAnnotationSyncTimers.get(e.path);r!==void 0&&window.clearTimeout(r);let i=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,n)},t);this.noteAnnotationSyncTimers.set(e.path,i)}getAnnotationGraceRemaining(e){let t=this.annotationNoteEditTimes.get(e);if(!t)return 0;let n=Date.now()-t;return n>=un?0:un-n}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let t=(e.annotation_page_label||"").trim();if(t)return t;let n=e.page_start?String(e.page_start):"",r=e.page_end?String(e.page_end):"";if(n&&(!r||n===r))return n;if(n&&r)return`${n} - ${r}`;let i=(e.pages||"").trim();if(!i)return"?";let s=i.match(/^(\d+)\s*-\s*(\d+)$/);return s?s[1]===s[2]?s[1]:`${s[1]} - ${s[2]}`:i.replace("-"," - ")}normalizeChunkIdForNote(e,t){if(!e)return null;let n=String(e);if(t&&n.startsWith(`${t}:`))return n.slice(t.length+1);if(n.includes(":")){let r=n.split(":");if(r.length>1&&t&&r[0]===t)return r.slice(1).join(":")}return n}async syncNoteToRedis(e){if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let t=await this.app.vault.read(e),n=this.extractSyncSection(t);if(!n)return;let r=await this.resolveDocIdForNote(e,t);if(!r)return;let i=this.parseSyncedChunkBlocks(n);if(!i.length)return;let s=(0,m.normalizePath)(`${Q}/${r}.json`),a=this.app.vault.adapter;if(!await a.exists(s)&&!await this.restoreMissingChunkCacheFromNote(e,t,r,!1))return;let o=await this.readChunkPayload(s);if(!o)return;let l=Array.isArray(o.chunks)?o.chunks:[],c=new Map;for(let x of l){if(this.isAnnotationChunk(x))continue;let h=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:"";h&&c.set(h,x)}let d=new Set,p=new Set,_=new Set,g=new Set,y=!1;for(let x of i){let h=x.chunkId;if(!h)continue;d.add(h);let b=c.get(h);if(!b){console.warn(`Sync note: chunk id not found in cache (${h})`);continue}if(x.excludeFlag){b.excluded!==!0&&(b.excluded=!0,y=!0);let E=this.normalizeChunkText(x.text),v=typeof b.text=="string"?b.text:"";E&&E!==v&&(b.text=E,b.char_count=E.length,y=!0),_.add(h);continue}if(b.excluded&&(b.excluded=!1,y=!0,p.add(h)),!x.text.trim()){_.add(h),g.add(h);continue}let w=this.normalizeChunkText(x.text);if(!w){_.add(h),g.add(h);continue}let C=typeof b.text=="string"?b.text:"";w!==C&&(b.text=w,b.char_count=w.length,p.add(h),y=!0)}for(let x of c.keys())d.has(x)||(_.add(x),g.add(x));let k=new Set([..._,...g]);if(k.size){let x=Array.from(k).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==x){this.noteSyncPendingDeletes.set(e.path,x),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!p.size&&!_.size&&!g.size&&!y)return;g.size&&(o.chunks=l.filter(x=>{let h=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:"";return h&&!g.has(h)}),y=!0),(y||g.size)&&await a.write(s,JSON.stringify(o,null,2)),await this.reindexChunkUpdates(r,s,Array.from(p),Array.from(_)),(_.size||g.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(t){console.warn("Failed to sync note edits to Redis",t)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,t){var n,r,i,s;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,t);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),o=await this.resolveDocIdForNote(e,a);if(!o)return;let l=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter;if(!l)return;let c=this.resolveZoteroItemKey(l,o);if(!c)return;let d=this.asRecord(await this.fetchZoteroItem(c)),p=(r=this.asRecord(d==null?void 0:d.data))!=null?r:d;if(!p||typeof p!="object")return;let _=this.extractNoteMetadata(l),g=this.extractZoteroMetadata(p);g.citekey||(g.citekey=await this.resolveZoteroCitekey(p,c,(i=this.asRecord(d==null?void 0:d.meta))!=null?i:{}));let y=await this.getMetadataSnapshot(o,l,e),k={},x={},h={},b=[],w=["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],C={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publication_title:"publication_title",book_title:"book_title",journal_abbrev:"journal_abbrev",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},E=Object.fromEntries(w.map(T=>[T,this.hasFrontmatterKey(l,C[T])])),v=new Set(["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","authors","editors"]),A=w.filter(T=>E[T]||!this.isMetadataValueEmpty(_[T])||!this.isMetadataValueEmpty(g[T]));if(!A.length)return;let O={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publication_title:"Publication title",book_title:"Book title",journal_abbrev:"Journal abbreviation",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let T of A){let L=_[T],M=g[T];if(this.metadataValuesEqual(T,L,M))continue;let q=this.isMetadataValueEmpty(L),F=this.isMetadataValueEmpty(M),$=y==null?void 0:y[T];if($===void 0){if(q&&!F){h[T]="zotero",this.assignMetadataUpdate(k,T,M);continue}if(!q&&F&&v.has(T)){h[T]="note",this.assignMetadataUpdate(x,T,L);continue}}if($!==void 0){let U=!this.metadataValuesEqual(T,L,$),B=!this.metadataValuesEqual(T,M,$);if(U&&!B){h[T]="note",this.assignMetadataUpdate(x,T,L);continue}if(!U&&B){h[T]="zotero",this.assignMetadataUpdate(k,T,M);continue}}let I=this.getMetadataDecisionLabels(T,L,M,O);b.push({field:T,fieldLabel:O[T],noteLabel:I.noteLabel,zoteroLabel:I.zoteroLabel,noteValue:this.formatMetadataValue(L),zoteroValue:this.formatMetadataValue(M)})}if(b.length>0){let T=await this.promptMetadataBatchDecision(b);for(let L of b){let M=(s=T[L.field])!=null?s:"skip";h[L.field]=M,M==="note"?this.assignMetadataUpdate(x,L.field,_[L.field]):M==="zotero"&&this.assignMetadataUpdate(k,L.field,g[L.field])}}Object.keys(k).length>0&&await this.applyNoteMetadataUpdates(e,k),Object.keys(x).length>0&&await this.applyZoteroMetadataUpdates(c,p,_,g,x),await this.updateMetadataSnapshot(e,o,_,g,y,h,A)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,t)}}async syncNoteAnnotationsWithZotero(e,t){var n,r,i,s,a;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,t);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let F=this.ensureDocIdInNoteContent(o,d);F!==o&&await this.writeNoteWithSyncSuppressed(e.path,F)}if(!d)return;let p=(r=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter)!=null?r:{},_=(i=c.attachmentKey)!=null?i:"";if(_||(_=await this.resolveAttachmentKeyForDocId(d,p)),!_)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===_&&await this.updateDocIndex({doc_id:d,attachment_key:_});let g=_,y=await this.fetchZoteroAnnotationsForDoc(d,_),k=y.annotations;_=y.attachmentKey,_&&_!==g&&await this.updateDocIndex({doc_id:d,attachment_key:_});let x=this.parseAnnotationBlock(l.block,_),h=new Map;for(let F of x)F.key&&F.imagePath&&h.set(F.key,{path:F.imagePath,hash:F.imageHash||this.extractAnnotationImageHashFromPath(F.imagePath)});await this.attachAnnotationImages(d,_,k,e.path,h);let b=new Map;for(let F of x)F.key&&b.set(F.key,F);let w=new Map;for(let F of k)w.set(F.key,F);let C=!1,E=!1,v=!1;if(y.hadFetchError)b.size>0&&k.length===0&&console.debug("Skipping annotation-prune sync due incomplete Zotero annotation fetch.",{docId:d,attachmentKey:_,reason:t});else for(let F of b.keys())w.has(F)||(E=!0);let A=await this.getAnnotationSnapshot(d),O=(s=A==null?void 0:A.annotations)!=null?s:{},T={},L=[];_&&_!==g&&k.length>0&&(E=!0,v=!0);for(let[F,$]of w.entries()){let I=b.get(F);if(!I){E=!0;continue}let U=O[F],B=this.annotationSnapshotFromEntry(I,$.annotationType),V=this.annotationSnapshotFromEntry($,$.annotationType),z=(B.image_hash||"")!==(V.image_hash||"");if(!U){this.annotationSnapshotsEqualIgnoringImage(B,V)?z&&(E=!0,v=!0):(T[F]="note",C=!0);continue}let j=!this.annotationSnapshotsEqual(B,U),K=!this.annotationSnapshotsEqual(V,U),Z=(V.color_key||"")!==(U.color_key||""),G=!this.annotationSnapshotsEqualIgnoringImage(B,U),H=!this.annotationSnapshotsEqualIgnoringImage(V,U);G&&!H?(T[F]="note",C=!0):!G&&H?(T[F]="zotero",E=!0):G&&H&&L.push({key:F,title:this.formatAnnotationConflictTitle($),noteValue:this.formatAnnotationConflictValue(B,I.tags),zoteroValue:this.formatAnnotationConflictValue(V,$.tags)}),z&&(j||K)&&(E=!0,v=!0),Z&&(E=!0,v=!0)}if(L.length>0){let F=await this.promptAnnotationBatchDecision(L);for(let $ of L){let I=(a=F[$.key])!=null?a:"skip";T[$.key]=I,I==="note"?C=!0:I==="zotero"&&(E=!0,v=!0)}}let M=[];for(let[F,$]of Object.entries(T)){if($!=="note")continue;let I=b.get(F),U=w.get(F);!I||!U||M.push({entry:U,note:I})}M.length>0&&await this.applyZoteroAnnotationUpdates(M),C&&this.annotationNoteEditTimes.set(e.path,Date.now());let q=this.getAnnotationGraceRemaining(e.path);if(E&&q>0&&C&&!v&&(this.scheduleNoteAnnotationSync(e,q+250,t),E=!1),E){let F=this.buildAnnotationBlock(d,_,k),$=this.replaceAnnotationBlock(o,F);if($&&$!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,$)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,_,k),await this.updateAnnotationChunks(d,_,k,{allowDeletes:!y.hadFetchError})}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,t)}}resolveZoteroItemKey(e,t){let n=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),t];for(let r of n){let i=W(r);if(i)return i}return""}async resolveAttachmentKeyForDocId(e,t){var l;if(!e)return"";let n=await this.getDocIndexEntry(e);if(n||(n=await this.hydrateDocIndexFromCache(e)),n!=null&&n.attachment_key)return n.attachment_key;let r=(0,m.normalizePath)(`${Q}/${e}.json`);try{if(await this.app.vault.adapter.exists(r)){let d=await this.readChunkPayload(r),p=this.asRecord(d==null?void 0:d.metadata),_=p==null?void 0:p.attachment_key;if(typeof _=="string"&&_.trim())return await this.updateDocIndex({doc_id:e,attachment_key:_.trim()}),_.trim()}}catch(c){}let i=this.resolveZoteroItemKey(t,e);if(!i)return"";let s=this.asRecord(await this.fetchZoteroItem(i)),a=(l=this.asRecord(s==null?void 0:s.data))!=null?l:s;if(!a||typeof a!="object")return"";let o=await Oe(a,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var w,C,E,v,A,O,T,L,M,q,F,$,I,U,B,V,z,j,K,Z,G,H;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString((v=(E=(C=(w=e==null?void 0:e["short title"])!=null?w:e==null?void 0:e.short_title)!=null?C:e==null?void 0:e.shortTitle)!=null?E:e==null?void 0:e["short-title"])!=null?v:e==null?void 0:e["title-short"]),r=this.normalizeMetadataString((L=(T=(O=(A=e==null?void 0:e.citekey)!=null?A:e==null?void 0:e["citation key"])!=null?O:e==null?void 0:e.citation_key)!=null?T:e==null?void 0:e.citationKey)!=null?L:e==null?void 0:e["citation-key"]),i=this.normalizeMetadataString(e==null?void 0:e.date),s=this.normalizeMetadataString((M=e==null?void 0:e.abstract)!=null?M:e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((q=e==null?void 0:e.doi)!=null?q:e==null?void 0:e.DOI),o=this.normalizeMetadataString((I=($=(F=e==null?void 0:e["publication title"])!=null?F:e==null?void 0:e.publication_title)!=null?$:e==null?void 0:e.publicationTitle)!=null?I:e==null?void 0:e["publication-title"]),l=this.normalizeMetadataString((V=(B=(U=e==null?void 0:e["book title"])!=null?U:e==null?void 0:e.book_title)!=null?B:e==null?void 0:e.bookTitle)!=null?V:e==null?void 0:e["book-title"]),c=this.normalizeMetadataString((K=(j=(z=e==null?void 0:e["journal abbrev"])!=null?z:e==null?void 0:e.journal_abbrev)!=null?j:e==null?void 0:e.journalAbbrev)!=null?K:e==null?void 0:e["journal-abbrev"]),d=this.normalizeMetadataString(e==null?void 0:e.publisher),p=this.normalizeMetadataString(e==null?void 0:e.place),_=this.normalizeMetadataString(e==null?void 0:e.issue),g=this.normalizeMetadataString(e==null?void 0:e.volume),y=this.normalizeMetadataString(e==null?void 0:e.pages),k=this.normalizeMetadataString((H=(G=(Z=e==null?void 0:e["item type"])!=null?Z:e==null?void 0:e.item_type)!=null?G:e==null?void 0:e.itemType)!=null?H:e==null?void 0:e["item-type"]),x=this.normalizeMetadataList(e==null?void 0:e.tags),h=this.normalizeMetadataList(e==null?void 0:e.authors),b=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:t,short_title:n,citekey:r,date:i,abstract:s,doi:a,publication_title:o,book_title:l,journal_abbrev:c,publisher:d,place:p,issue:_,volume:g,pages:y,item_type:k,tags:this.sanitizeObsidianTags(x),authors:h,editors:b}}extractZoteroMetadata(e){var C,E,v;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString(ve(e)),r=this.normalizeMetadataString(Ke(e)),i=this.normalizeMetadataString(e==null?void 0:e.date),s=this.normalizeMetadataString(e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((C=e==null?void 0:e.DOI)!=null?C:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publicationTitle),l=this.normalizeMetadataString(e==null?void 0:e.bookTitle),c=this.normalizeMetadataString(e==null?void 0:e.journalAbbreviation),d=this.normalizeMetadataString(e==null?void 0:e.publisher),p=this.normalizeMetadataString(e==null?void 0:e.place),_=this.normalizeMetadataString(e==null?void 0:e.issue),g=this.normalizeMetadataString(e==null?void 0:e.volume),y=this.normalizeMetadataString(e==null?void 0:e.pages),k=this.normalizeMetadataString((v=(E=e==null?void 0:e.itemType)!=null?E:e==null?void 0:e.item_type)!=null?v:e==null?void 0:e["item-type"]),x=Array.isArray(e==null?void 0:e.creators)?e.creators:[],h=x.filter(A=>(A==null?void 0:A.creatorType)==="author").map(A=>we(A)).filter(Boolean),b=x.filter(A=>(A==null?void 0:A.creatorType)==="editor"||(A==null?void 0:A.creatorType)==="seriesEditor").map(A=>we(A)).filter(Boolean),w=Array.isArray(e==null?void 0:e.tags)?e.tags.map(A=>{var O;return typeof A=="string"?A:(O=this.asRecord(A))==null?void 0:O.tag}).filter(A=>typeof A=="string"):[];return{title:t,short_title:n,citekey:r,date:i,abstract:s,doi:a,publication_title:o,book_title:l,journal_abbrev:c,publisher:d,place:p,issue:_,volume:g,pages:y,item_type:k,tags:this.sanitizeObsidianTags(w),authors:this.normalizeMetadataList(h),editors:this.normalizeMetadataList(b)}}async resolveZoteroCitekey(e,t,n){let r=this.normalizeMetadataString(Ke(e,n!=null?n:void 0));if(r)return r;if(!t)return"";let i=await this.fetchZoteroItemCsl(t);return this.normalizeMetadataString(mt(i))}extractAnnotationPageInfo(e){var s;let n=W((s=e.annotationPageLabel)!=null?s:e.annotationPage).trim(),r=null,i=e.annotationPage;if(typeof i=="number"&&Number.isFinite(i))r=i;else if(typeof i=="string"&&i.trim()){let a=Number(i);Number.isFinite(a)&&(r=a)}if(r===null&&typeof e.annotationPosition=="string")try{let a=JSON.parse(e.annotationPosition),o=a==null?void 0:a.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(r=o+1)}catch(a){}return{pageLabel:n,pageIndex:r}}extractAnnotationImagePayload(e){var s,a,o,l;let t=(a=(s=e.annotationImage)!=null?s:e.annotationImageData)!=null?a:e.annotationImageBase64;if(!t)return null;let n=null,r="";if(Buffer.isBuffer(t))n=t;else if(ArrayBuffer.isView(t))n=Buffer.from(t.buffer,t.byteOffset,t.byteLength);else if(t instanceof ArrayBuffer)n=Buffer.from(t);else if(typeof t=="string"){let c=t.trim();if(!c)return null;let d=c.match(/^data:([^;]+);base64,(.*)$/i);if(d&&(r=this.normalizeAnnotationImageMime(d[1]),c=d[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;n=Buffer.from(c,"base64")}if(!n||!n.length)return null;r||(r=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(n)||"image/png");let i=this.annotationImageExtensionFromMime(r)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(n))||"png";return{buffer:n,mime:r,ext:i}}parseZoteroAnnotationItem(e,t){var h,b,w,C;let n=(b=(h=e==null?void 0:e.data)!=null?h:e)!=null?b:{},r=W((w=e==null?void 0:e.key)!=null?w:n==null?void 0:n.key);if(!r)return null;let i=W(n.annotationType),s=this.normalizeAnnotationText(n.annotationText),a=this.normalizeAnnotationText(n.annotationComment),o=W(n.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:p,pageIndex:_}=this.extractAnnotationPageInfo(n),g=(C=n.annotationSortIndex)!=null?C:n.annotationSort,y=W(g).trim(),k=Number.isFinite(Number(y))?Number(y):Number.NaN,x=Array.isArray(n.tags)?n.tags.map(E=>{var v;return typeof E=="string"?E:(v=this.asRecord(E))==null?void 0:v.tag}).filter(E=>typeof E=="string"):[];return{key:r.trim(),attachmentKey:t,pageLabel:p,pageIndex:_,colorKey:l,callout:d,heading:c,annotationType:i,text:s,comment:a,tags:this.normalizeAnnotationTags(x),sortToken:y,sortIndex:k,rawValues:n}}async fetchZoteroAnnotations(e){if(!e)return{annotations:[],hadFetchError:!1};let t=this.canUseWebApi()||await this.ensureWebApiLibraryId(),n=!1,r=!1,i=o=>{var c,d;let l=[];for(let p of o){let _=this.asRecord(p),g=(d=(c=this.asRecord(_==null?void 0:_.data))!=null?c:_)!=null?d:{};if(W(g.itemType)!=="annotation")continue;let y=this.parseZoteroAnnotationItem(p,e);y&&l.push(y)}return l},s=[];try{s=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(o){try{s=await this.fetchZoteroChildrenLocal(e)}catch(l){n=!0,console.warn("Failed to fetch Zotero annotation items from local API",l)}}let a=i(s);if(!a.length&&t)try{let o=[];try{o=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(c){o=await this.fetchZoteroChildrenWeb(e)}r=!0;let l=i(o);l.length&&(a=l)}catch(o){n=!0,console.warn("Failed to fetch Zotero annotation items from Web API",o)}return!a.length&&t&&!r&&(n=!0),!a.length&&!t&&(n=!0),{annotations:a,hadFetchError:n}}async fetchZoteroAnnotationsForDoc(e,t){var l,c;let n=t,r=await this.fetchZoteroAnnotations(n);if(r.annotations.length||!e)return r.annotations.length||this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:r.hadFetchError};let i=[];try{i=await this.fetchZoteroChildren(e)}catch(d){return console.warn("Failed to fetch Zotero attachments for annotations",d),this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:!0}}let s=r.hadFetchError,a=[],o=new Set(n?[n]:[]);for(let d of i){if(!yt(d))continue;let p=this.asRecord(d),_=this.asRecord(p==null?void 0:p.data),g=W((c=(l=p==null?void 0:p.key)!=null?l:_==null?void 0:_.key)!=null?c:p==null?void 0:p.attachmentKey);!g||o.has(g)||(o.add(g),a.push(g))}for(let d of a){let p=await this.fetchZoteroAnnotations(d);if(s=s||p.hadFetchError,p.annotations.length)return{attachmentKey:d,annotations:p.annotations,hadFetchError:s}}return this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:s}}async attachAnnotationImages(e,t,n,r,i){var p;if(!this.settings.includeAnnotationImages||!n.length)return;let s=await this.resolveAnnotationImageOutputDir(r);if(!s)return;let a=this.sanitizeFileName(e||t)||"annotations",o=(0,m.normalizePath)(S.default.join(s.relative||"",a)),l=S.default.normalize(S.default.join(s.absolute,a));o?await this.ensureFolder(o):await ee.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,d=new Map;for(let _ of n){let g=String(_.annotationType||"").trim().toLowerCase(),y=g==="image"||g==="ink",k=this.extractAnnotationImagePayload((p=_.rawValues)!=null?p:{});if(!k&&y&&this.settings.zoteroCompanionEnabled&&(k=await this.fetchCompanionAnnotationImage(_.key)),!k){let w=i==null?void 0:i.get(_.key);w!=null&&w.path&&await c.exists(w.path)&&(_.imagePath=w.path,_.imageHash=w.hash,d.set(_.key,w.path));continue}let x=(0,ze.createHash)("sha1").update(k.buffer).digest("hex").slice(0,12),h=`zrr-annotation-${_.key}-${x}.${k.ext}`,b=(0,m.normalizePath)(S.default.join(o,h));try{await c.exists(b)||await c.writeBinary(b,this.bufferToArrayBuffer(k.buffer)),_.imagePath=b,_.imageHash=x,d.set(_.key,b)}catch(w){console.warn("Failed to write annotation image",{annotationKey:_.key,error:w})}}if(o&&await c.exists(o))try{let _=await c.list(o);for(let g of _.files){let k=S.default.basename(g).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!k)continue;let x=k[1].toUpperCase(),h=d.get(x);(!h||(0,m.normalizePath)(h)!==(0,m.normalizePath)(g))&&await c.remove(g)}}catch(_){console.warn("Failed to clean up annotation images",_)}}async fetchCompanionAnnotationImage(e){let t=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!t)return null;let n=`${t.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,r={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(r.Authorization=`Bearer ${i}`);try{let s=await this.requestLocalApiRaw(n,{headers:r,timeoutMs:5e3});if(s.statusCode===200){let a=s.headers["content-type"],o=Array.isArray(a)?a[0]:a!=null?a:"";return this.buildAnnotationImagePayloadFromBuffer(s.body,o)}if(s.statusCode===204||s.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:s.statusCode})}catch(s){console.warn("Failed to fetch annotation image from Zotero companion",s)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new m.Notice("Zotero companion base URL is not set.");return}let t=`${e.replace(/\/$/,"")}/health`,n={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(n.Authorization=`Bearer ${r}`);try{let i=await this.requestLocalApiRaw(t,{headers:n,timeoutMs:3e3});if(i.statusCode===200){try{let s=JSON.parse(i.body.toString("utf8"));if(s!=null&&s.ok){new m.Notice("Zotero companion: OK.");return}}catch(s){}new m.Notice("Zotero companion responded but did not return OK.");return}if(i.statusCode===401){new m.Notice("Zotero companion: unauthorized (check token).");return}new m.Notice(`Zotero companion: HTTP ${i.statusCode}.`)}catch(i){console.warn("Zotero companion health check failed",i),new m.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new m.Notice("Opened Zotero. Go to tools \u2192 add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new m.Notice("Unable to open Zotero automatically. Open Zotero and go to tools \u2192 add-ons.")}}async spawnDetached(e){let[t,...n]=e;if(!t)throw new Error("Missing command");await new Promise((r,i)=>{let s=!1,a=(0,oe.spawn)(t,n,{detached:!0,stdio:"ignore"});a.on("error",o=>{s||(s=!0,i(o))}),a.unref(),s||(s=!0,r())})}maybeWarnMissingAnnotationApi(e,t){if(this.canUseWebApi()){console.debug("No Zotero annotations returned for attachment",{docId:e,attachmentKey:t});return}let n=e||t;!n||this.annotationWebApiWarned.has(n)||(this.annotationWebApiWarned.add(n),new m.Notice("Zotero annotations require web API access. Configure the web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
`).trim(),excludeFlag:i,pageStart:Number.isFinite(s!=null?s:NaN)?Number(s):void 0,sectionChunk:a}),r="",i=!1,s=void 0,a=!1,o=[])};for(let p of t){let _=p.match(_e);if(_){l();let g=(c=_[1])!=null?c:"",y=g.match(/id=(["']?)([^"'\s]+)\1/i),k=y?y[2].trim():"";if(!k)continue;let x=Se(p);r=k,i=/\bexclude\b/i.test(g)||/\bdelete\b/i.test(g),s=Number.isFinite((d=x==null?void 0:x.pageNumber)!=null?d:NaN)?Number(x==null?void 0:x.pageNumber):void 0,a=/\bsection\b/i.test(g),o=[];continue}if(Re.test(p)){l();continue}if(r){if(Ee.test(p)){i=!0;continue}this.isChunkBlockIdLine(p)||o.push(p)}}return l(),n}inferSectionTitleFromChunkText(e){if(!e)return"";let t=e.split(/\r?\n/);for(let n of t){let r=n.trim();if(!r)continue;let i=r.match(/^#{1,6}\s+(.+)$/);if(i!=null&&i[1])return i[1].trim();break}return""}extractAttachmentKeyFromAnnotationMarker(e){var r,i;let t=this.findAnnotationBlockRange(e);return t&&(i=(r=this.parseAnnotationBlockMarker(t.startMarker).attachmentKey)==null?void 0:r.trim())!=null?i:""}async restoreMissingChunkCacheFromNote(e,t,n,r){var k,x,h,b,w,C;let i=this.app.vault.adapter,s=(0,m.normalizePath)(`${Q}/${n}.json`);if(await i.exists(s))return s;let a=this.extractSyncSection(t);if(!a)return r&&new m.Notice(`Chunks cache missing for ${n}, and no sync section was found in the note.`),null;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return r&&new m.Notice(`Chunks cache missing for ${n}, and no chunk markers were found in the sync section.`),null;let l=[];for(let E of o){let v=String(E.chunkId||"").trim();if(!v)continue;let A=(k=this.normalizeChunkIdForNote(v,n))!=null?k:v,O=this.normalizeChunkText(String(E.text||"")),T=Number.isFinite((x=E.pageStart)!=null?x:NaN)?Number(E.pageStart):(h=_t(A))!=null?h:void 0,L={chunk_id:A,text:O,char_count:O.length};if(E.excludeFlag&&(L.excluded=!0),Number.isFinite(T!=null?T:NaN)&&(L.page_start=Number(T),L.page_end=Number(T)),E.sectionChunk){let M=this.inferSectionTitleFromChunkText(O);M&&(L.section=M)}l.push(L)}if(!l.length)return r&&new m.Notice(`Chunks cache missing for ${n}, and chunk markers contained no usable chunks.`),null;await this.ensureFolder(Q);let c=await this.getDocIndexEntry(n);c||(c=await this.hydrateDocIndexFromCache(n));let d=(w=(b=this.app.metadataCache.getFileCache(e))==null?void 0:b.frontmatter)!=null?w:{},p=this.normalizeDocIndexPdfPath((C=c==null?void 0:c.pdf_path)!=null?C:""),_=(c==null?void 0:c.attachment_key)||this.extractAttachmentKeyFromAnnotationMarker(t)||await this.resolveAttachmentKeyForDocId(n,d),g={doc_id:n,chunks:l};p&&(g.source_pdf=p),_&&(g.metadata={attachment_key:_}),await i.write(s,JSON.stringify(g,null,2));let y={doc_id:n,note_path:e.path,note_title:S.default.basename(e.path,".md")};return p&&(y.pdf_path=p),_&&(y.attachment_key=_),await this.updateDocIndex(y),r&&new m.Notice(`Restored chunk cache from note markers for ${n}.`),s}normalizeChunkText(e){return e.split(/\r?\n/).filter(t=>!this.isChunkBlockIdLine(t)).map(t=>t.replace(/\s+/g," ").trim()).filter((t,n,r)=>!(t===""&&r[n-1]==="")).join(`
...
${g}`:b)}let y=d!==null?s?` (${d})`:` page=${d}`:"",x=` id=${c}${s?" section":""}${y}${p?" exclude":""}`;a.push(`<!-- zrr:chunk${x} -->`),a.push(""),a.push(`^${this.buildChunkBlockId(c,e)}`),a.push(""),g&&a.push(g),a.push("<!-- zrr:chunk end -->"),a.push("")}return a[a.length-1]===""&&a.pop(),a.push("<!-- zrr:sync-end -->"),a.join(`
...
`).trim(),r=(s=e.pageIndex)!=null?s:0,i=e.pageLabel||(e.pageIndex?String(e.pageIndex):"");return{chunk_id:e.key,text:n,page_start:r,page_end:r,annotation_page_label:i,section:e.heading,chunk_tags:e.tags,is_annotation:!0,annotation_key:e.key,annotation_color:e.colorKey,annotation_text:e.text,annotation_comment:e.comment}}annotationChunkSignature(e){var t,n,r,i,s,a,o,l,c;return JSON.stringify({text:(t=e.text)!=null?t:"",page_start:(n=e.page_start)!=null?n:"",page_end:(r=e.page_end)!=null?r:"",section:(i=e.section)!=null?i:"",chunk_tags:Array.isArray(e.chunk_tags)?e.chunk_tags:(s=e.chunk_tags)!=null?s:"",annotation_color:(a=e.annotation_color)!=null?a:"",annotation_page_label:(o=e.annotation_page_label)!=null?o:"",annotation_text:(l=e.annotation_text)!=null?l:"",annotation_comment:(c=e.annotation_comment)!=null?c:""})}async updateAnnotationChunks(e,t,n,r){var k;let i=(r==null?void 0:r.allowDeletes)!==!1,s=(0,m.normalizePath)(`${Q}/${e}.json`),a=this.app.vault.adapter;if(!await a.exists(s))return;let o=await this.readChunkPayload(s);if(!o)return;let l=Array.isArray(o.chunks)?o.chunks:[],c=[],d=new Map;for(let x of l){let h=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:"";h&&this.isAnnotationChunk(x)?d.set(h,x):c.push(x)}let p=[],_=[],g=new Set;for(let x of n){let h=this.buildAnnotationChunk(x),b=typeof h.chunk_id=="string"?h.chunk_id:"";if(!b)continue;g.add(b),p.push(h);let w=d.get(b);if(!w){_.push(b);continue}this.annotationChunkSignature(w)!==this.annotationChunkSignature(h)&&_.push(b)}let y=[];if(i)for(let x of d.keys())g.has(x)||y.push(x);else for(let[x,h]of d.entries())g.has(x)||p.push(h);if(o.chunks=[...c,...p],await a.write(s,JSON.stringify(o,null,2)),(_.length||y.length)&&await this.reindexChunkUpdates(e,s,_,y),t)try{let x=(k=this.asRecord(o.metadata))!=null?k:{};x.attachment_key!==t&&(x.attachment_key=t,o.metadata=x,await a.write(s,JSON.stringify(o,null,2)))}catch(x){}}resolveChunkFromPayload(e,t,n){let r=this.normalizeChunkIdForNote(t,n)||t,i=new Set([t,r,`${n}:${t}`]);for(let s of e){let a=typeof(s==null?void 0:s.chunk_id)=="string"?s.chunk_id:"";if(a&&i.has(a))return s}return null}async writeNoteWithSyncSuppressed(e,t){this.noteSyncSuppressed.add(e);try{await this.app.vault.adapter.write(e,t)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e)},1500)}}async resolveNotePathForDocId(e){if(!e)return null;let t=this.app.vault.adapter,n=await this.getDocIndexEntry(e);if(n!=null&&n.note_path&&await t.exists(n.note_path))return n.note_path;let i=(await this.scanNotesForDocIds(this.settings.outputNoteDir))[e];return i!=null&&i.note_path?(await this.updateDocIndex({doc_id:e,note_path:i.note_path,note_title:i.note_title}),i.note_path):null}isZoteroNoteFile(e){let t=this.app.metadataCache.getFileCache(e),n=t==null?void 0:t.frontmatter;return!!(this.getFrontmatterValue(n,"doc_id")||this.getFrontmatterValue(n,"zotero_key"))}async deleteZoteroNoteAndCacheForFile(e){var c;let t=e.path,n=await this.app.vault.read(e),r=(c=this.extractDocIdFromFrontmatter(n))!=null?c:this.extractDocIdFromSyncMarker(n);if(!r){new m.Notice("No doc_ID found in this note.");return}if(!await new Promise(d=>{new et(this.app,t,r,d).open()}))return;let s=this.app.vault.adapter,a=(0,m.normalizePath)(`${Q}/${r}.json`),o=(0,m.normalizePath)(`${le}/${r}.json`),l=[];if(await s.exists(a)){let d=await this.readChunkPayload(a);l=(Array.isArray(d==null?void 0:d.chunks)?d==null?void 0:d.chunks:[]).map(_=>typeof(_==null?void 0:_.chunk_id)=="string"?_.chunk_id:"").map(_=>_.startsWith(`${r}:`)?_.slice(r.length+1):_).filter(_=>_)}l.length>0&&await this.reindexChunkUpdates(r,a,[],l);try{await s.exists(a)&&await s.remove(a),await s.exists(o)&&await s.remove(o),await this.removeDocIndexEntry(r),await this.app.fileManager.trashFile(e),new m.Notice(`Deleted note and cache for ${r}.`)}catch(d){console.error("Failed to delete note and cached data",d),new m.Notice("Failed to delete note or cached data. See console for details.")}}async deleteZoteroNoteAndCache(){let e=this.app.workspace.getActiveViewOfType(m.MarkdownView);if(!e||!e.file){new m.Notice("No active Zotero note found.");return}await this.deleteZoteroNoteAndCacheForFile(e.file)}formatRedisSearchResults(e){var _;let t=(_=this.asRecord(e))!=null?_:{},n=typeof t.total=="number"?t.total:0,r=typeof t.query=="string"?t.query:"",i=typeof t.raw_query=="string"?t.raw_query:"",s=t.field_types&&typeof t.field_types=="object"?t.field_types:null,a=!!t.fallback_used,o=typeof t.fallback_reason=="string"?t.fallback_reason:"",l=Array.isArray(t.fallback_queries)?t.fallback_queries:[],c=Array.isArray(t.fallback_failed_fields)?t.fallback_failed_fields:[],d=Array.isArray(t.results)?t.results:[],p=[];if(p.push(`Query: ${i||r}`),r&&i&&r!==i&&p.push(`Expanded: ${r}`),p.push(`Total matches: ${n}`),s&&Object.keys(s).length>0){let g=Object.keys(s).sort().map(y=>{let k=s[y],x=typeof k=="string"||typeof k=="number"||typeof k=="boolean"?String(k):"";return`${y}:${x}`});p.push(`Field types: {${g.join(", ")}}`)}if(a&&p.push(`Fallback: ${o||"true"}`),l.length){p.push("Fallback queries:");for(let g of l)p.push(`  - ${g}`)}if(c.length&&p.push(`Fallback failed fields: ${c.join(", ")}`),p.push(""),!d.length)return p.push("(no results)"),p.join(`
`);for(let g of d){let y=String(g.doc_id||"").trim(),k=String(g.chunk_id||"").trim(),x=String(g.page_start||"").trim(),h=String(g.page_end||"").trim(),b=String(g.title||"").trim(),w=String(g.section||"").trim(),C=String(g.score||"").trim(),E=String(g.authors||"").trim(),v=String(g.item_type||"").trim(),A=String(g.year||"").trim(),O=String(g.tags||"").trim(),T=String(g.chunk_tags||"").trim(),L=String(g.attachment_key||"").trim(),M=String(g.source_pdf||"").trim(),q=String(g.text||"").replace(/\s+/g," ").trim(),F=q.length>220?`${q.slice(0,220)}\u2026`:q,$=[y];k&&$.push(k),(x||h)&&$.push(`p.${x||"?"}-${h||"?"}`),p.push($.filter(Boolean).join(" \u2022 ")),C&&p.push(`  score: ${C}`),b&&p.push(`  title: ${b}`),E&&p.push(`  authors: ${E}`),A&&p.push(`  year: ${A}`),v&&p.push(`  item_type: ${v}`),O&&p.push(`  tags: ${O}`),T&&p.push(`  chunk_tags: ${T}`),L&&p.push(`  attachment_key: ${L}`),w&&p.push(`  section: ${w}`),M&&p.push(`  source_pdf: ${M}`),F&&p.push(`  ${F}`),p.push("")}return p.join(`
...
`);for(let s=0;s<i.length;s+=1)if(r.test(i[s]))return s;return null}extractChunkIdFromAnchor(e){if(!e)return"";let t=String(e).replace(/\\\|/g,"|").trim(),n=t.indexOf("|");return(n>=0?t.slice(0,n):t).trim()}async openNoteAtChunk(e,t){let n=this.extractChunkIdFromAnchor(t);if(!e||!n)return!1;await this.openNoteInMain(e);let i=this.getMainLeaf().view;if(!(i instanceof m.MarkdownView))return!1;let s=i.editor,a=this.normalizeChunkIdForNote(n)||n,o=this.findChunkLineInText(s.getValue(),a);return o===null?(new m.Notice(`Chunk ${a} not found in note.`),!1):(s.setCursor({line:o,ch:0}),s.scrollIntoView({from:{line:o,ch:0},to:{line:o,ch:0}},!0),!0)}async openNoteAtAnnotation(e,t,n,r){let i=this.buildAnnotationBlockId(t,n,r);if(!e||!i)return!1;await this.openNoteInMain(e);let a=this.getMainLeaf().view;if(!(a instanceof m.MarkdownView))return!1;let o=a.editor,l=this.findAnnotationLineInText(o.getValue(),i);return l===null?(new m.Notice(`Annotation ${t} not found in note.`),!1):(o.setCursor({line:l,ch:0}),o.scrollIntoView({from:{line:l,ch:0},to:{line:l,ch:0}},!0),!0)}isZrrChunkInternalLink(e){return String(e||"").replace(/\\\|/g,"|").includes("#zrr-chunk:")}getLivePreviewSourcePath(){var t,n,r;let e=this.app.workspace.getActiveViewOfType(m.MarkdownView);return(t=e==null?void 0:e.file)!=null&&t.path?e.file.path:(r=(n=this.app.workspace.getActiveFile())==null?void 0:n.path)!=null?r:""}hookChunkInternalLinks(e,t){let n=e.querySelectorAll("a.internal-link");for(let r of Array.from(n)){if(r.dataset.zrrChunkBound==="1")continue;let i=r.getAttribute("data-href")||r.getAttribute("href")||"";this.isZrrChunkInternalLink(i)&&(r.dataset.zrrChunkBound="1",this.registerDomEvent(r,"click",s=>{s.preventDefault(),s.stopPropagation(),this.openInternalLinkInMain(i,t)}))}}async openInternalLinkInMain(e,t=""){let n=this.getMainLeaf(),[r,...i]=e.split("#"),s=r||"",a=i.join("#").trim(),o="zrr-chunk:",l=null;if(s){let c=Array.from(new Set([s,s.trimEnd(),s.trim()]));for(let d of c){if(!d)continue;let p=this.app.metadataCache.getFirstLinkpathDest(d,t);if(p instanceof m.TFile){l=p;break}}}if(l instanceof m.TFile){let c=a.startsWith(o)?this.extractChunkIdFromAnchor(a.slice(o.length).trim()):"";if(c&&await this.openNoteAtChunk(l.path,c))return;await n.openFile(l,{active:!0}),e.includes("#")&&!c&&await this.openLinkTextInLeaf(n,e,t);return}await this.openLinkTextInLeaf(n,e,t)}async openLinkTextInLeaf(e,t,n=""){let r=e;if(typeof r.openLinkText=="function"){await r.openLinkText(t,n,{active:!0});return}await this.app.workspace.openLinkText(t,n,"tab")}async openNoteInNewTab(e){let t=(0,m.normalizePath)(e);await this.app.workspace.openLinkText(t,"","tab")}async openPdfInMain(e,t){if(!e)return!1;let n=this.toVaultRelativePath(e);if(n){let r=t?`#page=${t}`:"";return await this.app.workspace.openLinkText(`${n}${r}`,"","tab"),!0}try{return window.open((0,Ct.pathToFileURL)(e).toString()),!0}catch(r){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,t,n,r){if(t){let i=new URLSearchParams;n&&i.set("page",n),r&&i.set("annotation",r);let s=i.toString()?`?${i.toString()}`:"";return`zotero://open-pdf/library/items/${t}${s}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let n=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(n))return n}formatCitationsMarkdown(e,t={}){return e.length?e.map(r=>this.formatCitationMarkdown(r,t)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e,t={}){var p,_,g,y,k;let n=e.doc_id||"?",r=this.formatCitationPageLabel(e),i=e.annotation_key||this.extractAnnotationKey(e.chunk_id),s=e.attachment_key||((_=(p=this.docIndex)==null?void 0:p[e.doc_id||""])==null?void 0:_.attachment_key),a=e.page_start?String(e.page_start):"",o=(y=(g=this.docIndex)==null?void 0:g[e.doc_id||""])!=null?y:null,l=this.resolveCitationTitle(o,(k=o==null?void 0:o.note_path)!=null?k:null,e.doc_id),c=this.formatCitationLabel(l,r),d=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&(o!=null&&o.note_path)){if(i){let x=a||(e.page_end?String(e.page_end):"0"),h=this.buildNoteAnnotationLink(o.note_path,i,s||"",x,c);return h?`- ${h}`:`- ${this.buildNoteLink(o.note_path,c)}`}if(d&&!i)return`- ${this.buildNoteChunkLink(o.note_path,d,c,{nativeAnchor:!!t.nativeObsidianAnchors})}`}if(s){let x=this.buildZoteroDeepLink(n,s,a,i);return`- [${c}](${x})`}return`- ${c}`}buildNoteChunkLink(e,t,n,r={}){let i=(0,m.normalizePath)(e).replace(/\.md$/i,""),s=this.escapeWikiLabel(n);if(r.nativeAnchor)return`[[${i}#^${this.buildChunkBlockId(t)}|${s}]]`;let a=`zrr-chunk:${t}`;return`[[${i}#${a}|${s}]]`}buildChunkBlockId(e,t){let n=(this.normalizeChunkIdForNote(e,t)||e||"").trim();return n?`zrr-chunk-${Array.from(n).map(i=>{var s;return/[A-Za-z0-9]/.test(i)?i.toLowerCase():i==="-"?"-":`-x${((s=i.codePointAt(0))==null?void 0:s.toString(16))||"0"}-`}).join("").replace(/-+/g,"-").replace(/^-|-$/g,"")||"source"}`:"zrr-chunk-source"}isChunkBlockIdLine(e){return/^\s*\^zrr-chunk-[A-Za-z0-9-]+\s*$/.test(e||"")}async ensureChunkBlockIdsForChatExport(e){var n,r;if(!this.settings.preferObsidianNoteForCitations)return;let t=new Map;for(let i of e)if(i.role==="assistant")for(let s of(n=i.citations)!=null?n:[]){let a=(s.doc_id||"").trim();if(!a||s.annotation_key||this.extractAnnotationKey(s.chunk_id))continue;let l=this.normalizeChunkIdForNote(s.chunk_id,a);if(!l)continue;let c=await this.resolveNotePathForDocId(a);if(!c)continue;let d=(r=t.get(c))!=null?r:{docId:a,chunkIds:new Set};d.chunkIds.add(l),t.set(c,d)}for(let[i,s]of t.entries())await this.ensureChunkBlockIdsInNote(i,s.docId,Array.from(s.chunkIds))}async ensureChunkBlockIdsInNote(e,t,n){let r=new Map;for(let l of n){let c=(this.normalizeChunkIdForNote(l,t)||l||"").trim();c&&r.set(c,this.buildChunkBlockId(c,t))}if(!r.size)return;let i=this.app.vault.adapter;if(!await i.exists(e))return;let a=(await i.read(e)).split(/\r?\n/),o=!1;for(let l=0;l<a.length;l+=1){let c=Se(a[l]),d=c!=null&&c.chunkId?this.normalizeChunkIdForNote(c.chunkId,t)||c.chunkId:"";if(!d)continue;let p=r.get(d);if(!p)continue;let _=!1;for(let g=l+1;g<a.length&&!(_e.test(a[g])||Re.test(a[g]));g+=1)if(new RegExp(`^\\s*\\^${this.escapeRegExp(p)}\\s*$`,"i").test(a[g])){_=!0;break}_||(a.splice(l+1,0,"",`^${p}`,""),l+=3,o=!0)}o&&await this.writeNoteWithSyncSuppressed(e,a.join(`
`))}buildNoteLink(e,t){let n=(0,m.normalizePath)(e).replace(/\.md$/i,""),r=this.escapeWikiLabel(t);return`[[${n}|${r}]]`}buildNoteAnnotationLink(e,t,n,r,i){let s=this.buildAnnotationBlockId(t,n,r);if(!s)return null;let a=(0,m.normalizePath)(e).replace(/\.md$/i,""),o=this.escapeWikiLabel(i);return`[[${a}#^${s}|${o}]]`}buildAnnotationBlockId(e,t,n){let r=(e||"").trim().toUpperCase(),i=(t||"").trim().toUpperCase();if(!r||!i)return null;let s=(n||"").trim()||"0";return`${r}a${i}p${s}`}escapeWikiLabel(e){return e?e.replace(/\|/g," ").replace(/\[/g,"").replace(/\]/g,"").trim():""}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,m.normalizePath)(`${ie}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var n;let e=this.app.vault.adapter,t=this.getDocIndexPath();if(!await e.exists(t))return{};try{let r=await e.read(t),i=JSON.parse(r);if(i&&typeof i=="object"){let s=(n=i.entries)!=null?n:i;if(Array.isArray(s)){let a={};for(let l of s)l!=null&&l.doc_id&&(a[String(l.doc_id)]=l);let o=!1;for(let l of Object.values(a))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(a),a}if(s&&typeof s=="object"){let a=s,o=!1;for(let l of Object.values(a))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(a),a}}}catch(r){console.error("Failed to read doc index",r)}return{}}async saveDocIndex(e){await this.ensureFolder(ie);let t=this.app.vault.adapter,n=this.getDocIndexPath(),r={version:1,entries:e};await t.write(n,JSON.stringify(r,null,2)),this.docIndex=e}async pruneDocIndexOrphans(){var c;let e=this.app.vault.adapter,t=await this.getDocIndex(),n=new Set(await this.listDocIds(le)),r=new Set(await this.listDocIds(Q)),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),s=0,a=0,o=!1,l=new Date().toISOString();for(let d of Object.keys(t)){let p=t[d],_=!1,g=p!=null&&p.note_path?p.note_path.trim():"";if(g&&await e.exists(g))_=!0;else if((c=i[d])!=null&&c.note_path){_=!0;let k=i[d];k.note_path&&k.note_path!==p.note_path&&(p.note_path=k.note_path,a+=1,o=!0),k.note_title&&k.note_title!==p.note_title&&(p.note_title=k.note_title,a+=1,o=!0),a>0&&(p.updated_at=l)}let y=n.has(d)||r.has(d);!_&&!y&&(delete t[d],s+=1,o=!0)}return o&&await this.saveDocIndex(t),{removed:s,updated:a}}async updateDocIndex(e){var i;let t=await this.getDocIndex(),n=(i=t[e.doc_id])!=null?i:{doc_id:e.doc_id},r={...n,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&n.note_path&&(r.note_path=n.note_path),e.note_title===void 0&&n.note_title&&(r.note_title=n.note_title),e.zotero_title===void 0&&n.zotero_title&&(r.zotero_title=n.zotero_title),e.short_title===void 0&&n.short_title&&(r.short_title=n.short_title),e.pdf_path===void 0&&n.pdf_path&&(r.pdf_path=n.pdf_path),e.attachment_key===void 0&&n.attachment_key&&(r.attachment_key=n.attachment_key),typeof r.pdf_path=="string"&&(r.pdf_path=this.normalizeDocIndexPdfPath(r.pdf_path)),t[e.doc_id]=r,await this.saveDocIndex(t)}async removeDocIndexEntry(e){let t=await this.getDocIndex();if(!t[e]){await this.removeMetadataSnapshot(e);return}delete t[e],await this.saveDocIndex(t),await this.removeMetadataSnapshot(e)}async hydrateDocIndexFromCache(e){var a,o;if(!e)return null;let t=this.app.vault.adapter,n=await this.getDocIndexEntry(e),r={},i=(0,m.normalizePath)(`${le}/${e}.json`);if(await t.exists(i))try{let l=await t.read(i),c=JSON.parse(l),d=(o=(a=c==null?void 0:c.data)!=null?a:c)!=null?o:{},p=typeof d.title=="string"?d.title:"";p&&(r.zotero_title=p);let _=ve(d);if(_&&(r.short_title=_),!r.note_title||!r.note_path){let g=this.sanitizeFileName(p)||e,y=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${g}.md`),k=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${g}-${e}.md`),x="";await t.exists(y)?x=y:await t.exists(k)&&(x=k),x&&(r.note_path=x,r.note_title=S.default.basename(x,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!r.note_title&&(n!=null&&n.note_path)&&(r.note_title=S.default.basename(n.note_path,".md"));let s=(0,m.normalizePath)(`${Q}/${e}.json`);if(await t.exists(s))try{let l=await t.read(s),c=JSON.parse(l);typeof(c==null?void 0:c.source_pdf)=="string"&&(r.pdf_path=c.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(r).length>0&&await this.updateDocIndex({doc_id:e,...r}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var n;return e&&(n=(await this.getDocIndex())[e])!=null?n:null}async inferNotePathFromCache(e){var r,i;let t=this.app.vault.adapter,n=(0,m.normalizePath)(`${le}/${e}.json`);if(!await t.exists(n))return"";try{let s=await t.read(n),a=JSON.parse(s),o=(i=(r=a==null?void 0:a.data)!=null?r:a)!=null?i:{},l=typeof o.title=="string"?o.title:"",c=this.sanitizeFileName(l)||e,d=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${c}.md`),p=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${c}-${e}.md`);if(await t.exists(d))return d;if(await t.exists(p))return p}catch(s){console.error("Failed to infer note path from cache",s)}return""}async rebuildNoteFromCacheForDocId(e,t){var T,L,M,q,F,$;try{await this.ensureBundledTools()}catch(I){return t&&new m.Notice("Failed to sync bundled tools. See console for details."),console.error(I),!1}let n=this.app.vault.adapter,r=(0,m.normalizePath)(`${le}/${e}.json`),i=(0,m.normalizePath)(`${Q}/${e}.json`);if(!await n.exists(r)||!await n.exists(i))return t&&new m.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let s;try{let I=await n.read(r);s=JSON.parse(I)}catch(I){return t&&new m.Notice("Failed to read cached item JSON."),console.error(I),this.clearStatusProgress(),!1}let a;try{let I=await n.read(i);a=JSON.parse(I)}catch(I){return t&&new m.Notice("Failed to read cached chunks JSON."),console.error(I),this.clearStatusProgress(),!1}let o=(T=s.data)!=null?T:s,l=typeof o.title=="string"?o.title:"",c=((M=(L=s.key)!=null?L:o.key)!=null?M:e).toString(),d=await this.getDocIndexEntry(e),p=typeof((q=this.asRecord(a==null?void 0:a.metadata))==null?void 0:q.attachment_key)=="string"?String((F=this.asRecord(a==null?void 0:a.metadata))==null?void 0:F.attachment_key):d==null?void 0:d.attachment_key,_=typeof a.source_pdf=="string"?a.source_pdf:"";if(!_||!await this.isFileAccessible(_)){let I=await this.recoverMissingPdfFromAttachment(_,o,c,e,p,l,t);if(!I)return t&&new m.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;_=I.sourcePdf,I.attachmentKey&&(p=I.attachmentKey),await this.updateChunkJsonSourcePdf(i,_)}let g=await this.resolveLanguageHint(o,c),y=this.buildDoclingLanguageHint(g!=null?g:void 0),k="";if(d!=null&&d.note_path&&await n.exists(d.note_path)&&(k=(0,m.normalizePath)(d.note_path)),!k){let I=this.sanitizeFileName(l)||e,U=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${I}.md`),B=await n.exists(U)?I:await this.resolveUniqueBaseName(I,e);k=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${B}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let I=this.getLogFileRelativePath(),U=(0,m.normalizePath)(S.default.dirname(I));U&&await this.ensureFolder(U);let B=this.getSpellcheckerInfoRelativePath(),V=(0,m.normalizePath)(S.default.dirname(B));V&&await this.ensureFolder(V)}}catch(I){return t&&new m.Notice("Failed to create notes folder."),console.error(I),this.clearStatusProgress(),!1}let x=this.getPluginDir(),h=S.default.join(x,"tools","docling_extract.py"),b=S.default.join(x,"tools","index_redisearch.py"),w=null,C=null,E=I=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=I)};try{this.showStatusProgress(this.formatStatusLabel("Docling extraction...",w),0);let I=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(h,await this.buildDoclingArgs(_,e,i,k,y,!0),V=>this.handleDoclingProgress(V,w),()=>{},I,"docling_extract",E),this.recreateMissingNotesProcess=null,w=await this.readDoclingQualityLabel(i),p&&await this.annotateChunkJsonWithAttachmentKey(i,p);let U=await this.readDoclingMetadata(i),B=await this.maybeCreateOcrLayeredPdf(_,U,y);B&&(_=B,C=B,await this.updateChunkJsonSourcePdf(i,B))}catch(I){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(t&&new m.Notice("Docling extraction failed. See console for details."),console.error(I),this.clearStatusProgress(),!1)}let v=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;if(!await this.ensureRedisAvailable("rebuild"))t&&new m.Notice("Redis is unavailable; skipping indexing for this note.");else try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",w),0);let I=["--chunks-json",this.getAbsoluteVaultPath(i),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(I),this.appendEmbedContextArgs(I),this.settings.embedIncludeMetadata&&I.push("--embed-include-metadata"),this.appendChunkTaggingArgs(I,{allowRegenerate:!1}),await this.runPythonStreaming(b,I,U=>{let B=this.asRecord(U),V=typeof(B==null?void 0:B.total)=="number"?B.total:0,z=typeof(B==null?void 0:B.current)=="number"?B.current:0;if((B==null?void 0:B.type)==="progress"&&V>0){let j=Math.round(z/V*100),K=typeof B.message=="string"&&B.message.trim()?B.message:`Indexing chunks ${z}/${V}`,Z=this.formatStatusLabel(K,w);this.showStatusProgress(Z,j)}},()=>{},v,"index_redisearch",E),this.recreateMissingNotesProcess=null}catch(I){if(this.recreateMissingNotesAbort)return this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1;t&&new m.Notice("Redissearch indexing failed; note will still be rebuilt."),console.error(I)}let O=C?this.buildPdfLinkFromSourcePath(C):this.buildPdfLinkForNote(_,d==null?void 0:d.attachment_key,e);try{let I=await this.app.vault.adapter.read(k),U=await this.readChunkPayload(i),B=this.buildSyncedDoclingContent(e,U,I),V=await this.buildNoteMarkdown(o,($=s.meta)!=null?$:{},e,O,p,k,r,B);await this.writeNoteWithSyncSuppressed(k,V);let z=this.app.vault.getAbstractFileByPath(k);z instanceof m.TFile&&this.scheduleNoteAnnotationSync(z,2e3,"save")}catch(I){return t&&new m.Notice("Failed to finalize note Markdown."),console.error(I),this.clearStatusProgress(),!1}try{let I=ve(o);await this.updateDocIndex({doc_id:e,note_path:k,note_title:S.default.basename(k,".md"),zotero_title:l,short_title:I||void 0,pdf_path:_})}catch(I){console.error("Failed to update doc index",I)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],t=await this.fetchZoteroGroupOptions();return t.length&&e.push(...t),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),t=[],n=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!n)return e&&t.push({value:e,label:e}),t;let r=(this.settings.embedApiKey||"").trim(),i=await this.fetchModelIds(n,r);if(i.length){let s=i.filter(o=>/embed/i.test(o)),a=s.length?s:i;t.push(...a.map(o=>({value:o,label:o})))}return!t.length&&e&&t.push({value:e,label:e}),t.sort((s,a)=>s.label.localeCompare(a.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,t,n){let r=n==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),i=[],s=(e||"").trim().replace(/\/$/,"");if(!s)return r&&i.push({value:r,label:r}),i;let a=(t||"").trim(),o=await this.fetchModelIds(s,a);if(o.length){let l=o.filter(d=>!/embed/i.test(d)),c=l.length?l:o;i.push(...c.map(d=>({value:d,label:d})))}return!i.length&&r&&i.push({value:r,label:r}),i.sort((l,c)=>l.label.localeCompare(c.label))}detectEmbeddingProvider(e){let t=e.toLowerCase();return t.includes("anthropic")?"anthropic":t.includes("openrouter")?"openrouter":t.includes("ollama")||t.includes(":11434")?"ollama":t.includes("openai")?"openai":"generic"}async fetchModelIds(e,t){let n=this.detectEmbeddingProvider(e);try{if(n==="anthropic")return await this.fetchAnthropicModels(e,t);let r=await this.fetchOpenAiCompatibleModels(e,t);return!r.length&&n==="ollama"?await this.fetchOllamaModels(e):r}catch(r){return console.warn("Failed to fetch models",r),[]}}async fetchOpenAiCompatibleModels(e,t){let n=`${e}/models`,r={};t&&(r.Authorization=`Bearer ${t}`);let i=await this.requestLocalApiRaw(n,{headers:r});if(i.statusCode>=400)throw new Error(`Model list request failed (${i.statusCode})`);let s=JSON.parse(i.body.toString("utf8"));return this.extractModelIds(s)}async fetchOllamaModels(e){let n=`${e.replace(/\/v1\/?$/,"")}/api/tags`,r=await this.requestLocalApiRaw(n);if(r.statusCode>=400)throw new Error(`Ollama tags request failed (${r.statusCode})`);let i;try{i=JSON.parse(r.body.toString("utf8"))}catch(a){return console.warn("Failed to parse Ollama tags response",a),[]}if(!i||typeof i!="object")return[];let s=i.models;return Array.isArray(s)?s.map(a=>this.extractModelId(a)).filter(a=>!!a):[]}async fetchAnthropicModels(e,t){if(!t)return[];let n=`${e}/models`,r={"x-api-key":t,"anthropic-version":"2023-06-01"},i=await this.requestLocalApiRaw(n,{headers:r});if(i.statusCode>=400)throw new Error(`Anthropic model list request failed (${i.statusCode})`);let s=JSON.parse(i.body.toString("utf8"));return this.extractModelIds(s)}extractModelIds(e){var r,i,s;if(Array.isArray(e))return e.map(a=>this.extractModelId(a)).filter(a=>!!a);if(!e||typeof e!="object")return[];let t=e,n=(s=(i=(r=t.data)!=null?r:t.models)!=null?i:t.model)!=null?s:t.items;return Array.isArray(n)?n.map(a=>this.extractModelId(a)).filter(a=>!!a):[]}asRecord(e){return!e||typeof e!="object"?null:e}extractModelId(e){var i,s,a;if(!e||typeof e!="object")return null;let t=e,n=(a=(s=(i=t.id)!=null?i:t.name)!=null?s:t.model)!=null?a:t.identifier;return typeof n!="string"?null:n.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,t=r=>{for(let i of r)e.has(i.value)||e.set(i.value,i.label)};if(await this.warnIfZoteroLocalApiUnavailable("Zotero groups"))try{let r=this.buildZoteroUrl("/users/0/groups"),i=await this.requestLocalApi(r,`Zotero groups fetch failed for ${r}`);t(this.parseZoteroGroupOptions(i))}catch(r){console.warn("Failed to fetch Zotero groups from local API",r)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let r=(this.settings.webApiLibraryId||"").trim();if(r)try{let i=this.buildWebApiUrl(`/users/${r}/groups`),s=await this.requestWebApi(i,`Zotero Web API groups fetch failed for ${i}`);t(this.parseZoteroGroupOptions(s))}catch(i){console.warn("Failed to fetch Zotero groups from Web API",i)}}return Array.from(e.entries()).map(([r,i])=>({value:r,label:i})).sort((r,i)=>r.label.localeCompare(i.label))}parseZoteroGroupOptions(e){var r,i,s,a,o;let t;try{t=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(t))return[];let n=[];for(let l of t){if(!l||typeof l!="object")continue;let c=(r=l.data)!=null?r:l,d=(s=(i=c.id)!=null?i:l.id)!=null?s:c.key;if(!d)continue;let p=typeof d=="string"||typeof d=="number"?String(d).trim():"";if(!p)continue;let _=(o=(a=c.name)!=null?a:l.name)!=null?o:p,g=(typeof _=="string"||typeof _=="number")&&String(_).trim()||p;n.push({value:`groups/${p}`,label:`Group: ${g}`})}return n}async ensureFolder(e){let t=this.app.vault.adapter,n=(0,m.normalizePath)(e).split("/").filter(Boolean),r="";for(let i of n)r=r?`${r}/${i}`:i,await t.exists(r)||await t.mkdir(r)}async buildNoteMarkdown(e,t,n,r,i,s,a,o){let l=`[[${a}]]`,c=this.settings.copyPdfToVault&&r.startsWith("[["),d=i?this.buildZoteroDeepLink(n,i):"",p=d||r,_=c?r:d||r,g=_?c?`PDF: !${_}`:`PDF: ${_}`:"",y=g?`${g}

`:"",k=await this.buildTemplateVars(e,t,n,p,l);k.pdf_block=y,k.pdf_line=g,k.docling_markdown=o;let x=(this.settings.noteBodyTemplate||"").trim();/{{\s*annotation_block\s*}}/i.test(x)&&i?k.annotation_block=await this.buildAnnotationBlockForAttachment(n,i,s):k.annotation_block="";let b=this.ensureDocIdInFrontmatter(await this.renderFrontmatter(e,t,n,p,l,k),n),w=b?`---
${b}
---

`:"",C=`${y}${o}`,E=x?this.renderTemplate(x,k,C,{appendDocling:!0}):C;return`${w}${E}`}async buildAnnotationBlockForAttachment(e,t,n){let r=await this.fetchZoteroAnnotationsForDoc(e,t);return r.attachmentKey&&r.attachmentKey!==t&&await this.updateDocIndex({doc_id:e,attachment_key:r.attachmentKey}),await this.attachAnnotationImages(e,r.attachmentKey,r.annotations,n),this.buildAnnotationBlock(e,r.attachmentKey,r.annotations)}buildAnnotationBlock(e,t,n){var p;let r=`<!-- zrr:annotations-start doc_id=${e} attachment_key=${t} -->`,i="<!-- zrr:annotations-end -->";if(!n.length)return`${r}
${i}`;let s=this.getAnnotationColorMap(),a=Object.keys(s),o=new Map;for(let _ of n){let g=_.colorKey||this.normalizeAnnotationColorKey(_.colorKey),y=(p=o.get(g))!=null?p:[];y.push(_),o.set(g,y)}let l=[r],c=new Set,d=[...a,...Array.from(o.keys()).filter(_=>!a.includes(_))];for(let _ of d){let g=o.get(_);if(!g||!g.length)continue;c.add(_);let{heading:y}=this.resolveAnnotationColorMeta(_);l.push("",`## ${y}`),g.sort((k,x)=>{var A,O;let h=(k.sortToken||"").trim(),b=(x.sortToken||"").trim();if(h&&b&&h!==b)return h.localeCompare(b,void 0,{numeric:!0,sensitivity:"base"});if(h&&!b)return-1;if(!h&&b)return 1;let w=Number.isFinite(k.sortIndex),C=Number.isFinite(x.sortIndex);if(w&&C&&k.sortIndex!==x.sortIndex)return k.sortIndex-x.sortIndex;let E=(A=k.pageIndex)!=null?A:0,v=(O=x.pageIndex)!=null?O:0;return E!==v?E-v:k.key.localeCompare(x.key)});for(let k of g)l.push(...this.formatAnnotationCallout(k,t,e))}return l.push("",i),l.join(`
`).trim()}formatAnnotationCallout(e,t,n){let r=this.settings.annotationPageLabel||"Page",i=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?"),s=e.pageIndex?String(e.pageIndex):"",a=this.buildZoteroDeepLink(n,t,s,e.key),l=[`> [!${e.callout}] ${r} [${i}](${a})`];e.imagePath&&l.push(`> ![[${e.imagePath}]]`);let c=p=>{if(p)for(let _ of p.split(/\r?\n/))l.push(_.trim()?`> ${_}`:">")};c(e.text),e.comment&&(l.push(">","> ---"),c(e.comment)),e.tags.length&&l.push(`> **Tags:** ${e.tags.map(p=>`#${p}`).join(" ")}`);let d=e.pageIndex?String(e.pageIndex):"0";return l.push(`> ^${e.key}a${t}p${d}`),l.push(""),l}findAnnotationBlockRange(e){let t=Hn.exec(e);if(!t)return null;let n=e.slice(t.index+t[0].length),r=Kn.exec(n);if(!r)return null;let i=t.index,s=t.index+t[0].length+r.index+r[0].length,a=n.slice(0,r.index);return{start:i,end:s,block:a,startMarker:t[0]}}parseAnnotationBlockMarker(e){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i),n=e.match(/attachment_key=(["']?)([^"'\s]+)\1/i);return{docId:t?t[2].trim():void 0,attachmentKey:n?n[2].trim():void 0}}parseAnnotationBlock(e,t){let n=e.split(/\r?\n/),r=[],i=0;for(;i<n.length;){if(!n[i].trim().startsWith("> [!")){i+=1;continue}let a=[];for(;i<n.length&&n[i].trim().startsWith(">");)a.push(n[i]),i+=1;let o=this.parseAnnotationCallout(a,t);o&&r.push(o)}return r}parseAnnotationImageLine(e){var o,l;let t=e.trim();if(!t)return null;let n="",r=t.match(/!\[\[([^\]]+)\]\]/);r&&(n=r[1].trim());let i=n?null:t.match(/!\[[^\]]*\]\(([^)]+)\)/);i&&(n=i[1].trim());let s=n?null:t.match(/<img[^>]+src=["']([^"']+)["']/i);if(s&&(n=s[1].trim()),!n)return null;let a=(l=(o=n.split("|")[0])==null?void 0:o.trim())!=null?l:"";return a?{path:a,hash:this.extractAnnotationImageHashFromPath(a)}:null}parseAnnotationCallout(e,t){if(!e.length)return null;let n=e[0].replace(/^>\s?/,"").trim(),r=n.match(/\[!([^\]]+)\]/),i=r?r[1].trim():"note",s=n.match(/\((zotero:\/\/open-pdf\/library\/items\/[^)]+)\)/i),a="",o=t,l="",c=null;if(s){let b=s[1],w=b.match(/items\/([A-Z0-9]{8})/i);w&&(o=w[1]);let C=b.match(/annotation=([A-Z0-9]{8})/i);C&&(a=C[1]);let E=b.match(/page=(\d+)/i);E&&(c=Number(E[1]));let v=n.match(/\[([^\]]+)\]\(zotero:\/\//i);v&&(l=v[1].trim())}let d=[],p=[],_=[],g=!1,y="",k="";for(let b=1;b<e.length;b+=1){let w=e[b].replace(/^>\s?/,""),C=w.trim();if(!C){g?_.push(""):p.push("");continue}let E=this.parseAnnotationImageLine(C);if(E){y=E.path,k=E.hash;continue}if(C.startsWith("^")){let v=C.match(/^\^([A-Z0-9]{8})a([A-Z0-9]{8})p(\d+)/i);v&&(a=v[1],o=v[2],c=Number(v[3]));continue}if(/^(\*\*tags:\*\*|tags:)/i.test(C)){d.push(C);continue}if(C==="---"){g=!0;continue}g?_.push(w):p.push(w)}let x=d.join(" "),h=x?x.replace(/\*\*tags:\*\*/i,"").replace(/tags:/i,"").split(/[\s,]+/).map(b=>b.trim().replace(/^#+/,"")).filter(Boolean):[];return a?{key:a,attachmentKey:o,pageLabel:l,pageIndex:c,callout:i,text:this.normalizeAnnotationText(p.join(`
`)),comment:this.normalizeAnnotationText(_.join(`
`)),tags:this.normalizeAnnotationTags(h),imagePath:y||void 0,imageHash:k||void 0}:null}replaceAnnotationBlock(e,t){let n=this.findAnnotationBlockRange(e);if(!n)return null;let r=e.slice(0,n.start),i=e.slice(n.end),s=t.trim()?`${t.trim()}
`:`${t}`;return`${r}${s}${i}`.replace(/\n{4,}/g,`


`)}async renderFrontmatter(e,t,n,r,i,s){var d;let a=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!a.trim())return"";let o=s!=null?s:await this.buildTemplateVars(e,t,n,r,i),l=this.renderTemplate(a,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let t=e.split(/\r?\n/),n=[],r=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,i=/^[ \t]+-\s*(.*)$/,s=new Set(["abstract"]),a=l=>l===""||l==='""'||l==="''",o=0;for(;o<t.length;){let l=t[o],c=l.match(r);if(!c){n.push(l),o+=1;continue}let d=c[1].trim(),p=c[2].trim();if(s.has(d)){n.push(l),o+=1;continue}if(!a(p)){n.push(l),o+=1;continue}let _=o+1,g=[];for(;_<t.length&&t[_].match(i);)g.push(t[_]),_+=1;if(g.length===0){for(o=_;o<t.length&&t[o].trim()==="";)o+=1;continue}let y=g.filter(k=>{let x=k.match(i);if(!x)return!1;let h=x[1].trim();return!a(h)});if(y.length>0&&n.push(l,...y),o=_,y.length===0)for(;o<t.length&&t[o].trim()==="";)o+=1}for(;n.length>0&&n[n.length-1].trim()==="";)n.pop();return n.join(`

"use strict";var Gn=Object.create;var Le=Object.defineProperty;var Vn=Object.getOwnPropertyDescriptor;var Un=Object.getOwnPropertyNames;var Bn=Object.getPrototypeOf,Zn=Object.prototype.hasOwnProperty;var Hn=(u,c)=>{for(var e in c)Le(u,e,{get:c[e],enumerable:!0})},rn=(u,c,e,n)=>{if(c&&typeof c=="object"||typeof c=="function")for(let t of Un(c))!Zn.call(u,t)&&t!==e&&Le(u,t,{get:()=>c[t],enumerable:!(n=Vn(c,t))||n.enumerable});return u};var ge=(u,c,e)=>(e=u!=null?Gn(Bn(u)):{},rn(c||!u||!u.__esModule?Le(e,"default",{value:u,enumerable:!0}):e,u)),Wn=u=>rn(Le({},"__esModule",{value:!0}),u);var ot={};Hn(ot,{default:()=>Be});module.exports=Wn(ot);var g=require("obsidian");var pn=require("@codemirror/state"),W=require("@codemirror/view"),un=require("obsidian");var de=/<!--\s*zrr:sync-start[^>]*-->/i,fe=/<!--\s*zrr:sync-end\s*-->/i,ae=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ae=/<!--\s*zrr:chunk\s+end\s*-->/i,ke=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,sn=u=>{let c=u.trim();if(!c.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(c)){let p=c.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:p?p[2]:void 0}}if(/^zrr:sync-end\b/i.test(c))return{type:"sync-end"};if(/^zrr:chunk\s+end\b/i.test(c))return{type:"chunk-end"};let e=c.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let n=e[1]||"",t=n.match(/\bid=(["']?)([^"'\s]+)\1/i),i=t?t[2]:"",r=n.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?Number.parseInt(r[2],10):void 0,s=i.match(/^p(\d+)$/i),o=s?Number.parseInt(s[1],10):void 0,l=Number.isFinite(a!=null?a:NaN)?a:o,d=/\bexclude\b/i.test(n)||/\bdelete\b/i.test(n);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(l!=null?l:NaN)?l:void 0,chunkKind:l?"page":"section"}},We=u=>{var o;if(!u)return null;let c=u.match(ae);if(!c)return null;let e=c[1]||"",n=e.match(/\bid=(["']?)([^"'\s]+)\1/i),t=n?n[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?Number.parseInt(i[2],10):void 0,a=t&&(o=Jn(t))!=null?o:void 0,s=Number.isFinite(r!=null?r:NaN)?r:a;return{chunkId:t,pageNumber:Number.isFinite(s!=null?s:NaN)?Number(s):void 0}},Ee=u=>{for(let c=1;c<=u.lines;c+=1){let e=u.line(c).text;if(de.test(e)){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return n?n[2].trim():null}}return null},Ke=(u,c)=>{let e=c;for(;e>=1;e-=1){let n=u.line(e).text;if(ae.test(n))return{line:e,text:n};if(de.test(n)||fe.test(n))break}return null},Kn=(u,c)=>{for(let e=c;e<=u.lines;e+=1){let n=u.line(e).text;if(Ae.test(n))return e;if(fe.test(n))break}return null},an=(u,c)=>{let e=Ke(u,c);if(!e)return null;let n=Kn(u,e.line+1);return n===null||c<e.line||c>n?null:{startLine:e.line,endLine:n,text:e.text}},on=(u,c,e)=>{if(c>e)return!1;for(let n=c;n<=e;n+=1){let t=u.line(n).text;if(ke.test(t))return!0}return!1},Jn=u=>{var t;if(!u)return null;let e=(u.includes(":")&&(t=u.split(":").pop())!=null?t:u).match(/^p(\d+)$/i);if(!e)return null;let n=Number.parseInt(e[1],10);return Number.isFinite(n)?n:null};var ln=u=>{if(!u)return null;let c=u.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return c?We(c[0]):null};var Xn=(u,c)=>{let e=document.createElement("div");return e.classList.add("zrr-sync-badge"),u.type==="sync-start"||u.type==="sync-end"?(e.classList.add("zrr-sync-badge--sync"),e.classList.add(u.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),u.type==="sync-start"?e.textContent=u.docId?`Redis Index Sync start - ${u.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e):u.type==="chunk-end"?(e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=u.chunkKind==="page"?"Page end":"Section end",u.chunkKind&&e.classList.add(`zrr-sync-badge--${u.chunkKind}`),e):u.type!=="chunk-start"?null:(e.classList.add("zrr-sync-badge--chunk"),u.chunkKind&&e.classList.add(`zrr-sync-badge--${u.chunkKind}`),u.excluded&&e.classList.add("is-excluded"),u.pageNumber&&c>0?e.textContent=`Page ${u.pageNumber}/${c}`:u.pageNumber?e.textContent=`Page ${u.pageNumber}`:u.chunkId?e.textContent=`Section ${u.chunkId}`:e.textContent="Section",u.excluded&&(e.textContent=`${e.textContent} - excluded`),e)},Je=class extends W.WidgetType{constructor(c,e,n,t,i){super(),this.plugin=c,this.docId=e,this.chunkId=n,this.startLine=t,this.excluded=i}eq(c){return this.docId===c.docId&&this.chunkId===c.chunkId&&this.startLine===c.startLine&&this.excluded===c.excluded}toDOM(){let c=document.createElement("span");c.className="zrr-chunk-toolbar",c.setAttribute("data-chunk-id",this.chunkId);let e=(d,p)=>{d.setAttribute("title",p),d.setAttribute("aria-label",p),d.setAttribute("data-tooltip-position","top")},n=(d,p,_)=>{let m=document.createElement("span");m.className="zrr-chunk-button-icon",(0,un.setIcon)(m,p);let y=document.createElement("span");y.className="zrr-chunk-button-label",y.textContent=_,d.appendChild(m),d.appendChild(y)},t=document.createElement("button");t.type="button",t.className="zrr-chunk-button",n(t,"sparkles","Clean"),e(t,"Clean this chunk with the OCR cleanup model"),t.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),c.appendChild(t);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",n(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),c.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",n(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),c.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",n(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),c.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return n(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),c.appendChild(s),c}ignoreEvent(){return!0}},dn=(u,c)=>{var x;let e=u.state.doc,n=Ee(e);if(!n)return W.Decoration.none;let t=u.state.selection.main.head,i=e.lineAt(t).number,r=an(e,i);if(!r)return W.Decoration.none;let a=r.text.match(ae);if(!a)return W.Decoration.none;let s=((x=a[1])!=null?x:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return W.Decoration.none;let l=o[2].trim();if(!l)return W.Decoration.none;let d=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),p=on(e,r.startLine+1,r.endLine-1),_=d||p,m=e.line(r.startLine),y=W.Decoration.widget({widget:new Je(c,n,l,r.startLine,_),side:1});return W.Decoration.set([y.range(m.to)])},Xe=class extends W.WidgetType{constructor(c,e){super(),this.info=c,this.totalPages=e}toDOM(){var c;return(c=Xn(this.info,this.totalPages))!=null?c:document.createElement("span")}},cn=u=>{var s,o;let c=u.dom.closest(".markdown-source-view");if(!c||!c.classList.contains("is-live-preview"))return W.Decoration.none;let e=u.state.doc,n=new pn.RangeSetBuilder,t=[],i=[],r=!1;for(let l=1;l<=e.lines;l+=1){let d=e.line(l),p=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!p)continue;let _=sn(p[1]);_&&(_.type==="chunk-start"?(_.chunkKind=(s=_.chunkKind)!=null?s:_.pageNumber?"page":"section",_.pageNumber&&(r=!0)):_.type==="chunk-end"&&(_.chunkKind=(o=_.chunkKind)!=null?o:"section"),t.push({line:l,from:d.from,to:d.to,info:_}),_.pageNumber&&i.push(_.pageNumber))}if(!t.length)return W.Decoration.none;if(r)for(let l of t)l.info.type==="chunk-end"&&(l.info.chunkKind="page");let a=i.length?Math.max(...i):0;for(let l of t){let d=W.Decoration.replace({widget:new Xe(l.info,a)});n.add(l.from,l.to,d)}return n.finish()},_n=()=>W.ViewPlugin.fromClass(class{constructor(u){this.decorations=cn(u)}update(u){(u.docChanged||u.viewportChanged)&&(this.decorations=cn(u.view))}},{decorations:u=>u.decorations}),gn=u=>W.ViewPlugin.fromClass(class{constructor(c){this.decorations=dn(c,u)}update(c){(c.docChanged||c.selectionSet||c.viewportChanged)&&(this.decorations=dn(c.view,u))}},{decorations:c=>c.decorations});var Q=require("child_process"),j=require("fs"),zn=ge(require("http")),qn=ge(require("https")),Pe=ge(require("net")),Mn=ge(require("os")),jn=ge(require("tls")),E=ge(require("path")),tn=require("url"),Ue=require("crypto");var N=require("obsidian"),X=".zotero-redisearch-rag",Y=`${X}/items`,V=`${X}/chunks`,fn={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
`).trim(),excludeFlag:r}),i="",r=!1,a=[])};for(let l of n){let d=l.match(ae);if(d){s();let p=(o=d[1])!=null?o:"",_=p.match(/id=([\"']?)([^\"'\s]+)\1/i),m=_?_[2].trim():"";if(!m)continue;i=m,r=/\bexclude\b/i.test(p)||/\bdelete\b/i.test(p),a=[];continue}if(Ae.test(l)){s();continue}if(i){if(ke.test(l)){r=!0;continue}a.push(l)}}return s(),t}normalizeChunkText(e){return e.split(/\r?\n/).map(n=>n.replace(/\s+/g," ").trim()).filter((n,t,i)=>!(n===""&&i[t-1]==="")).join(`

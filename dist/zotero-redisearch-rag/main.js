"use strict";var Jn=Object.create;var Le=Object.defineProperty;var Xn=Object.getOwnPropertyDescriptor;var Yn=Object.getOwnPropertyNames;var Qn=Object.getPrototypeOf,et=Object.prototype.hasOwnProperty;var nt=(g,p)=>{for(var e in p)Le(g,e,{get:p[e],enumerable:!0})},dn=(g,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of Yn(p))!et.call(g,t)&&t!==e&&Le(g,t,{get:()=>p[t],enumerable:!(n=Xn(p,t))||n.enumerable});return g};var ge=(g,p,e)=>(e=g!=null?Jn(Qn(g)):{},dn(p||!g||!g.__esModule?Le(e,"default",{value:g,enumerable:!0}):e,g)),tt=g=>dn(Le({},"__esModule",{value:!0}),g);var mt={};nt(mt,{default:()=>Ke});module.exports=tt(mt);var h=require("obsidian");var mn=require("@codemirror/state"),Y=require("@codemirror/view"),yn=require("obsidian");var de=/<!--\s*zrr:sync-start[^>]*-->/i,fe=/<!--\s*zrr:sync-end\s*-->/i,le=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ee=/<!--\s*zrr:chunk\s+end\s*-->/i,xe=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,pn=g=>{let p=g.trim();if(!p.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(p)){let _=p.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:_?_[2]:void 0}}if(/^zrr:sync-end\b/i.test(p))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(p)){let _=p.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),m=p.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:_?_[2]:void 0,attachmentKey:m?m[2]:void 0}}if(/^zrr:annotations-end\b/i.test(p))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(p))return{type:"chunk-end"};let e=p.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let n=e[1]||"",t=n.match(/\bid=(["']?)([^"'\s]+)\1/i),i=t?t[2]:"",r=n.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:n.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,d=Number.isFinite(s!=null?s:NaN)?s:l,c=/\bexclude\b/i.test(n)||/\bdelete\b/i.test(n),u=/\bsection\b/i.test(n);return{type:"chunk-start",chunkId:i||void 0,excluded:c,pageNumber:Number.isFinite(d!=null?d:NaN)?d:void 0,chunkKind:u?"section":d?"page":"section"}},Qe=g=>{var l;if(!g)return null;let p=g.match(le);if(!p)return null;let e=p[1]||"",n=e.match(/\bid=(["']?)([^"'\s]+)\1/i),t=n?n[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=t&&(l=rt(t))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:t,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Ne=g=>{for(let p=1;p<=g.lines;p+=1){let e=g.line(p).text;if(de.test(e)){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return n?n[2].trim():null}}return null},en=(g,p)=>{let e=p;for(;e>=1;e-=1){let n=g.line(e).text;if(le.test(n))return{line:e,text:n};if(de.test(n)||fe.test(n))break}return null},it=(g,p)=>{for(let e=p;e<=g.lines;e+=1){let n=g.line(e).text;if(Ee.test(n))return e;if(fe.test(n))break}return null},un=(g,p)=>{let e=en(g,p);if(!e)return null;let n=it(g,e.line+1);return n===null||p<e.line||p>n?null:{startLine:e.line,endLine:n,text:e.text}},_n=(g,p,e)=>{if(p>e)return!1;for(let n=p;n<=e;n+=1){let t=g.line(n).text;if(xe.test(t))return!0}return!1},rt=g=>{var t;if(!g)return null;let e=(g.includes(":")&&(t=g.split(":").pop())!=null?t:g).match(/^p(\d+)$/i);if(!e)return null;let n=Number.parseInt(e[1],10);return Number.isFinite(n)?n:null};var gn=g=>{if(!g)return null;let p=g.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return p?Qe(p[0]):null};var at=(g,p)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),g.type==="sync-start"||g.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(g.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),g.type==="sync-start"?e.textContent=g.docId?`Redis Index Sync start - ${g.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e;if(g.type==="annotations-start"||g.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),g.type==="annotations-start"){let n=g.docId?` - ${g.docId}`:"";e.textContent=`Zotero annotations start${n}`}else e.textContent="Zotero annotations end";return e}if(g.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=g.chunkKind==="page"?"Page end":"Section end",g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),e;if(g.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),g.excluded&&e.classList.add("is-excluded"),g.pageNumber&&p>0)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber}/${p})`}else e.textContent=`Page ${g.pageNumber}/${p}`;else if(g.pageNumber)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber})`}else e.textContent=`Page ${g.pageNumber}`;else g.chunkId?e.textContent=`Section ${g.chunkId}`:e.textContent="Section";return g.excluded&&(e.textContent=`${e.textContent} - excluded`),e},nn=class extends Y.WidgetType{constructor(p,e,n,t,i){super(),this.plugin=p,this.docId=e,this.chunkId=n,this.startLine=t,this.excluded=i}eq(p){return this.docId===p.docId&&this.chunkId===p.chunkId&&this.startLine===p.startLine&&this.excluded===p.excluded}toDOM(){let p=document.createElement("span");p.className="zrr-chunk-toolbar",p.setAttribute("data-chunk-id",this.chunkId);let e=(d,c)=>{d.setAttribute("title",c),d.setAttribute("aria-label",c),d.setAttribute("data-tooltip-position","top")},n=(d,c,u)=>{let _=document.createElement("span");_.className="zrr-chunk-button-icon",(0,yn.setIcon)(_,c);let m=document.createElement("span");m.className="zrr-chunk-button-label",m.textContent=u,d.appendChild(_),d.appendChild(m)},t=document.createElement("button");t.type="button",t.className="zrr-chunk-button",n(t,"sparkles","Clean"),e(t,"Clean this chunk with the OCR cleanup model"),t.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),p.appendChild(t);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",n(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),p.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",n(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),p.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",n(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),p.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return n(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),p.appendChild(s),p}ignoreEvent(){return!0}},fn=(g,p)=>{var y;let e=g.state.doc,n=Ne(e);if(!n)return Y.Decoration.none;let t=g.state.selection.main.head,i=e.lineAt(t).number,r=un(e,i);if(!r)return Y.Decoration.none;let a=r.text.match(le);if(!a)return Y.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return Y.Decoration.none;let l=o[2].trim();if(!l)return Y.Decoration.none;let d=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),c=_n(e,r.startLine+1,r.endLine-1),u=d||c,_=e.line(r.startLine),m=Y.Decoration.widget({widget:new nn(p,n,l,r.startLine,u),side:1});return Y.Decoration.set([m.range(_.to)])},tn=class extends Y.WidgetType{constructor(p,e){super(),this.info=p,this.totalPages=e}toDOM(){var p;return(p=at(this.info,this.totalPages))!=null?p:document.createElement("span")}},hn=g=>{var o,l;let p=g.dom.closest(".markdown-source-view");if(!p||!p.classList.contains("is-live-preview"))return Y.Decoration.none;let e=g.state.doc,n=new mn.RangeSetBuilder,t=[],i=[],r=!1,a=!1;for(let d=1;d<=e.lines;d+=1){let c=e.line(d),u=c.text.match(/<!--\s*([^>]*)\s*-->/);if(!u)continue;let _=pn(u[1]);_&&(_.type==="chunk-start"?(_.chunkKind=(o=_.chunkKind)!=null?o:_.pageNumber?"page":"section",_.pageNumber&&(r=!0),_.chunkKind==="section"&&(a=!0)):_.type==="chunk-end"&&(_.chunkKind=(l=_.chunkKind)!=null?l:"section"),t.push({line:d,from:c.from,to:c.to,info:_}),_.pageNumber&&i.push(_.pageNumber))}if(!t.length)return Y.Decoration.none;if(r&&!a)for(let d of t)d.info.type==="chunk-end"&&(d.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let d of t){let c=Y.Decoration.replace({widget:new tn(d.info,s)});n.add(d.from,d.to,c)}return n.finish()},bn=()=>Y.ViewPlugin.fromClass(class{constructor(g){this.decorations=hn(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=hn(g.view))}},{decorations:g=>g.decorations}),xn=g=>Y.ViewPlugin.fromClass(class{constructor(p){this.decorations=fn(p,g)}update(p){(p.docChanged||p.selectionSet||p.viewportChanged)&&(this.decorations=fn(p.view,g))}},{decorations:p=>p.decorations});var te=require("child_process"),H=require("fs"),Un=ge(require("http")),Wn=ge(require("https")),Pe=ge(require("net")),Ae=ge(require("os")),Hn=ge(require("tls")),L=ge(require("path")),cn=require("url"),He=require("crypto");var O=require("obsidian"),Q=".zotero-redisearch-rag",ne=`${Q}/items`,W=`${Q}/chunks`,kn=`${Q}/metadata_snapshots.json`,vn=`${Q}/annotation_snapshots.json`,De={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{pdf_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Fragen",callout:"question"},red:{heading:"Kritikw\xFCrdiges",callout:"bug"},green:{heading:"Hauptgedanken",callout:"idea"},blue:{heading:"Fakten",callout:"fact"},purple:{heading:"Argumente/L\xF6sungen",callout:"argument"},magenta:{heading:"Meinungen",callout:"opinion"},orange:{heading:"Weiterverfolgen",callout:"pursue"},gray:{heading:"Zitierbare Stellen",callout:"cite"}},llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,chatPaneLocation:"right",enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"BAAI/bge-reranker-v2-m3",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${Q}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Re=class extends O.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async f=>{this.plugin.settings.llmProviderProfiles=f,await this.plugin.saveSettings()},i=f=>{f.inputEl.type="password",f.inputEl.autocomplete="off",f.inputEl.spellcheck=!1},c=[{id:"prerequisites",label:"Prerequisites",render:f=>{f.createEl("h2",{text:"Prerequisites"}),new O.Setting(f).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(x=>x.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async b=>{this.plugin.settings.pythonPath=b.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Python environment").setDesc("Create or update the plugin's Python env (location configured below).").addButton(x=>{x.setButtonText("Create/Update").setCta(),x.onClick(async()=>{x.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{x.setDisabled(!1)}})}),new O.Setting(f).setName("Python env location").setDesc("Shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(x=>{x.addOption("shared","Shared user cache"),x.addOption("plugin","Plugin folder (.venv)"),x.setValue(this.plugin.settings.pythonEnvLocation).onChange(async b=>{b!=="shared"&&b!=="plugin"||(this.plugin.settings.pythonEnvLocation=b,await this.plugin.saveSettings())})}),new O.Setting(f).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(x=>x.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async b=>{this.plugin.settings.dockerPath=b.trim()||"docker",await this.plugin.saveSettings()})),new O.Setting(f).setName("Redis URL").addText(x=>x.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async b=>{this.plugin.settings.redisUrl=b.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(x=>x.setPlaceholder("~/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async b=>{this.plugin.settings.redisDataDirOverride=b.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(x=>x.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async b=>{this.plugin.settings.redisProjectName=b.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(x=>x.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async b=>{this.plugin.settings.autoAssignRedisPort=b,await this.plugin.saveSettings()})),new O.Setting(f).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Uses a vault-specific data dir at .obsidian/zotero-redisearch-rag/redis-data unless overridden.").addToggle(x=>x.setValue(this.plugin.settings.autoStartRedis).onChange(async b=>{this.plugin.settings.autoStartRedis=b,await this.plugin.saveSettings()})),new O.Setting(f).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(x=>x.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:f=>{f.createEl("h2",{text:"Zotero Local API"}),new O.Setting(f).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(A=>A.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async S=>{this.plugin.settings.zoteroBaseUrl=S.trim(),await this.plugin.saveSettings()}));let x=new O.Setting(f).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),b=null,C=A=>{if(!b)return;let S=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(A.map(F=>F.value)).has(S)||(A=A.concat([{value:S,label:`Custom (${S})`}])),b.selectEl.options.length=0;for(let F of A)b.addOption(F.value,F.label);b.setValue(S)},E=async()=>{if(b){b.setDisabled(!0);try{let A=await this.plugin.fetchZoteroLibraryOptions();C(A)}finally{b.setDisabled(!1)}}};x.addDropdown(A=>{b=A;let S=(this.plugin.settings.zoteroUserId||"0").trim()||"0";A.addOption(S,"Loading..."),A.setValue(S),A.onChange(async R=>{this.plugin.settings.zoteroUserId=R.trim(),await this.plugin.saveSettings()})}),x.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await E()})}),E(),f.createEl("h2",{text:"Zotero Web API"}),new O.Setting(f).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(A=>A.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async S=>{this.plugin.settings.webApiBaseUrl=S.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(A=>A.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async S=>{this.plugin.settings.webApiLibraryType=S,await this.plugin.saveSettings()})),new O.Setting(f).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(A=>A.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async S=>{this.plugin.settings.webApiLibraryId=S.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(A=>{i(A),A.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async S=>{this.plugin.settings.webApiKey=S.trim(),await this.plugin.saveSettings()})}),f.createEl("h2",{text:"Output"}),new O.Setting(f).setName("PDF folder").addText(A=>A.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async S=>{this.plugin.settings.outputPdfDir=S.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Notes folder").addText(A=>A.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async S=>{this.plugin.settings.outputNoteDir=S.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(A=>{A.setValue(this.plugin.settings.frontmatterTemplate).onChange(async S=>{this.plugin.settings.frontmatterTemplate=S,await this.plugin.saveSettings()}),A.inputEl.rows=10,A.inputEl.style.width="100%"}),new O.Setting(f).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(A=>A.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async S=>{this.plugin.settings.tagSanitizeMode=S,await this.plugin.saveSettings()})),new O.Setting(f).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(A=>{A.setValue(this.plugin.settings.noteBodyTemplate).onChange(async S=>{this.plugin.settings.noteBodyTemplate=S,await this.plugin.saveSettings()}),A.inputEl.rows=8,A.inputEl.style.width="100%"}),new O.Setting(f).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(A=>A.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async S=>{this.plugin.settings.chatOutputDir=S.trim()||"zotero/chats",await this.plugin.saveSettings()})),new O.Setting(f).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(A=>A.setValue(this.plugin.settings.copyPdfToVault).onChange(async S=>{this.plugin.settings.copyPdfToVault=S,!S&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new O.Setting(f).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(A=>{let S=this.plugin.settings.copyPdfToVault;A.setValue(S?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!S).onChange(async R=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=R,await this.plugin.saveSettings()})}),new O.Setting(f).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(A=>A.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async S=>{this.plugin.settings.preferObsidianNoteForCitations=S,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:f=>{f.createEl("h2",{text:"Annotations"}),new O.Setting(f).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(E=>E.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async A=>{this.plugin.settings.annotationPageLabel=A.trim()||"Page",await this.plugin.saveSettings()})),f.createEl("h3",{text:"Annotation color map"}),f.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let x=f.createDiv({cls:"zrr-annotation-map"}),b=async E=>{this.plugin.settings.annotationColorMap=E,await this.plugin.saveSettings()},C=()=>{var T,z;x.empty();let E=this.plugin.settings.annotationColorMap||{},A=Object.entries(E);if(A.length||x.createEl("p",{text:"No color mappings configured."}),A.length){let D=x.createDiv({cls:"zrr-annotation-map-row-header"});D.createEl("span",{text:"Color"}),D.createEl("span",{text:"Heading"}),D.createEl("span",{text:"Callout"}),D.createEl("span")}for(let[D,M]of A){let I=x.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),q=I.createEl("input",{type:"text",value:D,cls:"zrr-annotation-map-input"}),$=I.createEl("input",{type:"text",value:(T=M.heading)!=null?T:"",cls:"zrr-annotation-map-input"}),G=I.createEl("input",{type:"text",value:(z=M.callout)!=null?z:"",cls:"zrr-annotation-map-input"}),J=I.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});J.type="button",q.addEventListener("change",async()=>{let Z=q.value.trim().toLowerCase();if(!Z){q.value=D;return}let ee={...this.plugin.settings.annotationColorMap||{}};if(Z!==D&&ee[Z]){new O.Notice(`Annotation color '${Z}' already exists.`),q.value=D;return}let X=ee[D];delete ee[D],ee[Z]=X!=null?X:{heading:"",callout:""},await b(ee),C()}),$.addEventListener("change",async()=>{var X;let Z={...this.plugin.settings.annotationColorMap||{}},ee=(X=Z[D])!=null?X:{heading:"",callout:""};ee.heading=$.value.trim(),Z[D]=ee,await b(Z)}),G.addEventListener("change",async()=>{var X;let Z={...this.plugin.settings.annotationColorMap||{}},ee=(X=Z[D])!=null?X:{heading:"",callout:""};ee.callout=G.value.trim(),Z[D]=ee,await b(Z)}),J.addEventListener("click",async()=>{let Z={...this.plugin.settings.annotationColorMap||{}};delete Z[D],await b(Z),C()})}let S=x.createDiv({cls:"zrr-annotation-map-actions"}),R=S.createEl("button",{text:"Add mapping"});R.type="button",R.addEventListener("click",async()=>{let D={...this.plugin.settings.annotationColorMap||{}},M="new-color",j=1;for(;D[M];)M=`new-color-${j}`,j+=1;D[M]={heading:"",callout:""},await b(D),C()});let F=S.createEl("button",{text:"Reset to defaults"});F.type="button",F.addEventListener("click",async()=>{await b({...De.annotationColorMap}),C()})};C()}},{id:"ocr",label:"OCR",render:f=>{f.createEl("h2",{text:"Docling"});let x=null,b=S=>{if(!x)return;let R=this.plugin.settings.ocrEngine;new Set(S.map(T=>T.value)).has(R)||(S=S.concat([{value:R,label:`Current (unavailable): ${R}`}])),x.selectEl.options.length=0;for(let T of S)x.addOption(T.value,T.label);x.setValue(R)},C=async()=>{if(!x)return;x.setDisabled(!0);let S={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{S=await this.plugin.detectOcrEngines()}catch(T){S={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let R=[{value:"auto",label:"Auto (default)"}];S.tesseract&&R.push({value:"tesseract",label:"Tesseract (local)"}),S.paddleStructureLocal&&R.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),S.paddleVlLocal&&R.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(R.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),R.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),b(R),x.setDisabled(!1)},E=new O.Setting(f).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),A=document.createElement("a");A.href="https://aistudio.baidu.com/paddleocr",A.textContent="https://aistudio.baidu.com/paddleocr",A.target="_blank",A.rel="noopener noreferrer",E.descEl.appendChild(A),E.descEl.append("."),E.addText(S=>{i(S),S.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async R=>{this.plugin.settings.paddleApiKey=R.trim(),await this.plugin.saveSettings(),await C()})}),new O.Setting(f).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(S=>S.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async R=>{this.plugin.settings.paddleVlApiUrl=R.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(S=>S.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async R=>{this.plugin.settings.paddleStructureApiUrl=R.trim(),await this.plugin.saveSettings(),await C()})),new O.Setting(f).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(S=>{x=S,S.addOption("auto","Auto (default)"),S.setValue(this.plugin.settings.ocrEngine),S.onChange(async R=>{this.plugin.settings.ocrEngine=R,await this.plugin.saveSettings()})}),new O.Setting(f).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(S=>S.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async R=>{this.plugin.settings.ocrMode=R,await this.plugin.saveSettings()})),new O.Setting(f).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(S=>S.setValue(this.plugin.settings.forcePerPageOcr).onChange(async R=>{this.plugin.settings.forcePerPageOcr=R,await this.plugin.saveSettings()})),new O.Setting(f).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(S=>{S.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async R=>{this.plugin.settings.ocrQualityThreshold=R,await this.plugin.saveSettings()})}),new O.Setting(f).setName("Chunking").setDesc("page or section").addDropdown(S=>S.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async R=>{this.plugin.settings.chunkingMode=R,await this.plugin.saveSettings()})),C()}},{id:"llms",label:"LLMs",render:f=>{f.createEl("h2",{text:"LLM Provider Profiles"});let x=f.createDiv({cls:"zrr-llm-profiles"}),b=()=>{x.empty();let k=n();k.length||x.createEl("p",{text:"No profiles yet. Add one below."});for(let w of k){let N=x.createEl("details",{cls:"zrr-profile"});k.length===1&&(N.open=!0);let U=N.createEl("summary",{text:w.name||w.id||"Profile"});U.addClass("zrr-profile-title");let Se=N.createDiv({cls:"zrr-profile-body"});new O.Setting(Se).setName("Profile name").addText(oe=>oe.setPlaceholder("My provider").setValue(w.name||"").onChange(async ce=>{w.name=ce.trim(),U.textContent=w.name||w.id||"Profile",await t(n())})),new O.Setting(Se).setName("Base URL").addText(oe=>oe.setPlaceholder("http://localhost:1234/v1").setValue(w.baseUrl||"").onChange(async ce=>{w.baseUrl=ce.trim(),await t(n())})),new O.Setting(Se).setName("API key").setDesc("Stored in settings (not encrypted).").addText(oe=>{i(oe),oe.setPlaceholder("sk-...").setValue(w.apiKey||"").onChange(async ce=>{w.apiKey=ce.trim(),await t(n())})}),new O.Setting(Se).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(oe=>oe.setButtonText("Delete profile").onClick(async()=>{let ce=n().filter(Kn=>Kn.id!==w.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===w.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===w.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===w.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(ce),b()}))}new O.Setting(x).addButton(w=>w.setButtonText("Add profile").onClick(async()=>{let N=`profile-${Date.now().toString(36)}`,U=n().concat([{id:N,name:"Custom",baseUrl:"",apiKey:""}]);await t(U),b()}))};b(),f.createEl("h2",{text:"OCR cleanup"}),new O.Setting(f).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(k=>k.setValue(this.plugin.settings.enableLlmCleanup).onChange(async w=>{this.plugin.settings.enableLlmCleanup=w,await this.plugin.saveSettings()}));let C=null,E=null,A=null,S=async()=>{},R=async(k,w=!0)=>{let N=k.trim();this.plugin.settings.llmCleanupBaseUrl=N,w&&(this.plugin.settings.llmCleanupProviderProfileId="",C&&C.setValue("custom")),E&&E.setValue(N),await this.plugin.saveSettings()},F=async k=>{let w=n().find(N=>N.id===k);this.plugin.settings.llmCleanupProviderProfileId=k,w&&(this.plugin.settings.llmCleanupBaseUrl=w.baseUrl,this.plugin.settings.llmCleanupApiKey=w.apiKey,E==null||E.setValue(w.baseUrl),A==null||A.setValue(w.apiKey)),await this.plugin.saveSettings(),await S()};new O.Setting(f).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{C=k,k.addOption("custom","Custom (manual)");for(let N of n())k.addOption(N.id,N.name||N.id);let w=this.plugin.settings.llmCleanupProviderProfileId;k.setValue(w&&n().some(N=>N.id===w)?w:"custom"),k.onChange(async N=>{if(N==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await F(N)})}),new O.Setting(f).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(k=>{E=k,k.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async w=>{await R(w)})}),new O.Setting(f).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(k=>{A=k,i(k),k.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async w=>{this.plugin.settings.llmCleanupApiKey=w.trim(),this.plugin.settings.llmCleanupProviderProfileId="",C&&C.setValue("custom"),await this.plugin.saveSettings()})});let T=new O.Setting(f).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),z=null,D=k=>{if(!z)return;let w=(this.plugin.settings.llmCleanupModel||"").trim(),N=new Set(k.map(U=>U.value));w&&!N.has(w)&&(k=k.concat([{value:w,label:`Custom (${w})`}])),z.selectEl.options.length=0;for(let U of k)z.addOption(U.value,U.label);w&&z.setValue(w)};S=async()=>{if(z){z.setDisabled(!0);try{let k=await this.plugin.fetchCleanupModelOptions();D(k)}finally{z.setDisabled(!1)}}},T.addDropdown(k=>{z=k;let w=(this.plugin.settings.llmCleanupModel||"").trim();k.addOption(w||"loading","Loading..."),k.setValue(w||"loading"),k.onChange(async N=>{this.plugin.settings.llmCleanupModel=N.trim(),await this.plugin.saveSettings()})}),T.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),new O.Setting(f).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(k=>k.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async w=>{let N=Number.parseFloat(w);this.plugin.settings.llmCleanupTemperature=Number.isFinite(N)?N:0,await this.plugin.saveSettings()})),new O.Setting(f).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(k=>k.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async w=>{this.plugin.settings.llmCleanupMinQuality=w,await this.plugin.saveSettings()})),new O.Setting(f).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(k=>k.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async w=>{let N=Number.parseInt(w,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(N)?N:2e3,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Text Embedding"});let M=null,j=null,I=null,q=async()=>{},$=async(k,w=!0)=>{let N=k.trim();this.plugin.settings.embedBaseUrl=N,w&&(this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom")),j&&j.setValue(N),await this.plugin.saveSettings()},G=async k=>{let w=n().find(N=>N.id===k);this.plugin.settings.embedProviderProfileId=k,w&&(this.plugin.settings.embedBaseUrl=w.baseUrl,this.plugin.settings.embedApiKey=w.apiKey,j==null||j.setValue(w.baseUrl),I==null||I.setValue(w.apiKey)),await this.plugin.saveSettings(),await q()};new O.Setting(f).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{M=k,k.addOption("custom","Custom (manual)");for(let N of n())k.addOption(N.id,N.name||N.id);let w=this.plugin.settings.embedProviderProfileId;k.setValue(w&&n().some(N=>N.id===w)?w:"custom"),k.onChange(async N=>{if(N==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await G(N)})}),new O.Setting(f).setName("Embeddings base URL").addText(k=>{j=k,k.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async w=>{await $(w)})}),new O.Setting(f).setName("Embeddings API key").addText(k=>{I=k,i(k),k.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async w=>{this.plugin.settings.embedApiKey=w.trim(),this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom"),await this.plugin.saveSettings()})});let J=new O.Setting(f).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),Z=null,ee=k=>{if(!Z)return;let w=(this.plugin.settings.embedModel||"").trim(),N=new Set(k.map(U=>U.value));w&&!N.has(w)&&(k=k.concat([{value:w,label:`Custom (${w})`}])),Z.selectEl.options.length=0;for(let U of k)Z.addOption(U.value,U.label);w&&Z.setValue(w)};q=async()=>{if(Z){Z.setDisabled(!0);try{let k=await this.plugin.fetchEmbeddingModelOptions();ee(k)}finally{Z.setDisabled(!1)}}},J.addDropdown(k=>{Z=k;let w=(this.plugin.settings.embedModel||"").trim();k.addOption(w||"loading","Loading..."),k.setValue(w||"loading"),k.onChange(async N=>{this.plugin.settings.embedModel=N.trim(),await this.plugin.saveSettings()})}),J.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await q()})}),q(),new O.Setting(f).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(k=>k.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async w=>{this.plugin.settings.embedIncludeMetadata=w,await this.plugin.saveSettings()})),new O.Setting(f).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(k=>k.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async w=>{let N=Number.parseInt(w,10);this.plugin.settings.embedContextWindow=Number.isFinite(N)?Math.max(0,N):1,await this.plugin.saveSettings()})),new O.Setting(f).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(k=>k.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async w=>{let N=Number.parseInt(w,10);this.plugin.settings.embedContextChars=Number.isFinite(N)?Math.max(0,N):220,await this.plugin.saveSettings()})),new O.Setting(f).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(k=>k.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async w=>{let N=Number.parseInt(w,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(N)?Math.max(0,N):3500,await this.plugin.saveSettings()})),new O.Setting(f).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(k=>k.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async w=>{let N=Number.parseInt(w,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(N)?Math.max(0,N):200,await this.plugin.saveSettings()})),new O.Setting(f).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(k=>k.setValue(this.plugin.settings.enableChunkTagging).onChange(async w=>{this.plugin.settings.enableChunkTagging=w,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Chat LLM"});let X=null,se=null,ue=null,_e=async()=>{},Je=async(k,w=!0)=>{let N=k.trim();this.plugin.settings.chatBaseUrl=N,w&&(this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom")),se&&se.setValue(N),await this.plugin.saveSettings()},Xe=async k=>{let w=n().find(N=>N.id===k);this.plugin.settings.chatProviderProfileId=k,w&&(this.plugin.settings.chatBaseUrl=w.baseUrl,this.plugin.settings.chatApiKey=w.apiKey,se==null||se.setValue(w.baseUrl),ue==null||ue.setValue(w.apiKey)),await this.plugin.saveSettings(),await _e()};new O.Setting(f).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{X=k,k.addOption("custom","Custom (manual)");for(let N of n())k.addOption(N.id,N.name||N.id);let w=this.plugin.settings.chatProviderProfileId;k.setValue(w&&n().some(N=>N.id===w)?w:"custom"),k.onChange(async N=>{if(N==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await Xe(N)})}),new O.Setting(f).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(k=>{se=k,k.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async w=>{await Je(w)})}),new O.Setting(f).setName("Chat API key").addText(k=>{ue=k,i(k),k.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async w=>{this.plugin.settings.chatApiKey=w.trim(),this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom"),await this.plugin.saveSettings()})});let Ce=new O.Setting(f).setName("Chat model").setDesc("Select a chat-capable model from the provider."),ie=null,Ye=k=>{if(!ie)return;let w=(this.plugin.settings.chatModel||"").trim(),N=new Set(k.map(U=>U.value));w&&!N.has(w)&&(k=k.concat([{value:w,label:`Custom (${w})`}])),ie.selectEl.options.length=0;for(let U of k)ie.addOption(U.value,U.label);w&&ie.setValue(w)};_e=async()=>{if(ie){ie.setDisabled(!0);try{let k=await this.plugin.fetchChatModelOptions();Ye(k)}finally{ie.setDisabled(!1)}}},Ce.addDropdown(k=>{ie=k;let w=(this.plugin.settings.chatModel||"").trim();k.addOption(w||"loading","Loading..."),k.setValue(w||"loading"),k.onChange(async N=>{this.plugin.settings.chatModel=N.trim(),await this.plugin.saveSettings()})}),Ce.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await _e()})}),_e(),new O.Setting(f).setName("Temperature").addText(k=>k.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async w=>{let N=Number.parseFloat(w);this.plugin.settings.chatTemperature=Number.isFinite(N)?N:.2,await this.plugin.saveSettings()})),new O.Setting(f).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(k=>k.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async w=>{let N=Number.parseInt(w,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(N)?Math.max(0,N):6,await this.plugin.saveSettings()})),new O.Setting(f).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(k=>k.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async w=>{this.plugin.settings.chatPaneLocation=w,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Retrieval"}),new O.Setting(f).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(k=>k.setValue(this.plugin.settings.enableQueryExpansion).onChange(async w=>{this.plugin.settings.enableQueryExpansion=w,await this.plugin.saveSettings()})),new O.Setting(f).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(k=>k.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async w=>{let N=Number.parseInt(w,10);this.plugin.settings.queryExpansionCount=Number.isFinite(N)?Math.max(1,N):3,await this.plugin.saveSettings()})),new O.Setting(f).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(k=>k.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async w=>{this.plugin.settings.enableCrossEncoderRerank=w,await this.plugin.saveSettings()})),new O.Setting(f).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(k=>k.setPlaceholder("BAAI/bge-reranker-v2-m3").setValue(this.plugin.settings.rerankModel).onChange(async w=>{this.plugin.settings.rerankModel=w.trim()||"BAAI/bge-reranker-v2-m3",await this.plugin.saveSettings()})),new O.Setting(f).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(k=>k.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async w=>{let N=Number.parseInt(w,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(N)?Math.max(1,N):4,await this.plugin.saveSettings()})),new O.Setting(f).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(k=>k.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async w=>{let N=Number.parseInt(w,10);this.plugin.settings.rrfK=Number.isFinite(N)?Math.max(1,N):60,await this.plugin.saveSettings()})),new O.Setting(f).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(k=>k.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async w=>{let N=Number.parseInt(w,10);this.plugin.settings.rrfLogTop=Number.isFinite(N)?Math.max(0,N):0,await this.plugin.saveSettings()})),new O.Setting(f).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(k=>k.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async w=>{let N=Number.parseInt(w,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(N)?Math.max(0,N):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:f=>{f.createEl("h2",{text:"Logging"}),new O.Setting(f).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(x=>x.setValue(this.plugin.settings.enableFileLogging).onChange(async b=>{this.plugin.settings.enableFileLogging=b,await this.plugin.saveSettings()})),new O.Setting(f).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(x=>x.setPlaceholder(`${Q}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async b=>{this.plugin.settings.logFilePath=b.trim()||`${Q}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new O.Setting(f).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(x=>x.setButtonText("Open log").onClick(async()=>{var b,C;await((C=(b=this.plugin).openLogFile)==null?void 0:C.call(b))})).addButton(x=>x.setButtonText("Clear log").onClick(async()=>{var b,C;await((C=(b=this.plugin).clearLogFile)==null?void 0:C.call(b))})),f.createEl("h2",{text:"Maintenance"}),new O.Setting(f).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(x=>x.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new O.Setting(f).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(x=>x.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(x=>x.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],u=new Map,_=new Map,m=f=>{this.activeTab=f;for(let[x,b]of u){let C=x===f;b.classList.toggle("is-active",C),b.setAttribute("aria-selected",C?"true":"false"),b.setAttribute("tabindex",C?"0":"-1")}for(let[x,b]of _){let C=x===f;b.classList.toggle("is-active",C),b.hidden=!C}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let v=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let f of c){let x=y.createEl("button",{text:f.label,cls:"zrr-settings-tab-button"}),b=`zrr-settings-tab-${f.id}`,C=`zrr-settings-panel-${f.id}`;x.type="button",x.id=b,x.setAttribute("role","tab"),x.setAttribute("aria-controls",C),x.setAttribute("aria-selected","false"),x.addEventListener("click",()=>m(f.id));let E=v.createDiv({cls:"zrr-settings-tab-panel"});E.id=C,E.setAttribute("role","tabpanel"),E.setAttribute("aria-labelledby",b),E.hidden=!0,f.render(E),u.set(f.id,x),_.set(f.id,E)}let P=c.some(f=>f.id===this.activeTab)?this.activeTab:c[0].id;m(P)}};var wn=require("@codemirror/state"),Pn=require("@codemirror/view"),ae=require("obsidian");var st=g=>{let p=g.scrollDOM.getBoundingClientRect(),e=g.posAtCoords({x:p.left+8,y:+p.height*.25});return e===null?null:g.state.doc.lineAt(e).number},Te=class{constructor(p,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.deps=p,this.helpers=e}createSyncExtension(){let p=this,e=this.helpers;return Pn.ViewPlugin.fromClass(class{constructor(n){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=n,this.docId=e.extractDocIdFromDoc(n.state.doc),this.onScroll=()=>this.scheduleSync(!1),n.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(n){n.docChanged&&(this.docId=e.extractDocIdFromDoc(n.view.state.doc),this.lastPage=null,this.lastChunkId=null),(n.docChanged||n.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(n){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,n)}))}syncPdfSidebar(n,t){var u,_;let i=this.docId;if(!i)return;let r=st(n);if(r===null)return;let a=e.findChunkStartLineInDoc(n.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(u=s==null?void 0:s.pageNumber)!=null?u:null,l=(_=s==null?void 0:s.chunkId)!=null?_:null;if(!o&&!l)return;let d=o!==null&&this.lastPage===o,c=o===null&&l!==null&&this.lastChunkId===l;!t&&(d||c)||(this.lastPage=o,this.lastChunkId=l,p.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,n;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((n=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:n.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let p=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(p.docId,p.pageNumber,p.chunkId)}updatePreviewScrollHandler(){var t;let p=this.deps.app.workspace.getActiveViewOfType(ae.MarkdownView);if(!p||p.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(t=p.previewMode)==null?void 0:t.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let n=()=>this.schedulePreviewSync(p);e.addEventListener("scroll",n,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=n,this.schedulePreviewSync(p)}async syncPdfSidebarForFile(p){try{let e=await this.deps.app.vault.read(p),n=await this.deps.resolveDocIdForNote(p,e);if(!n)return;let t=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(n,t==null?void 0:t.pageNumber,t==null?void 0:t.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(p,e,n){if(!p)return;let t=await this.deps.getDocIndexEntry(p);t||(t=await this.deps.hydrateDocIndexFromCache(p));let i=t!=null&&t.pdf_path?String(t.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let _=(0,ae.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(_)instanceof ae.TFile&&(r=_)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof ae.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:n};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:n};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&n&&(o=await this.resolvePageNumberForChunk(p,n)),o===null||this.pdfSidebarDocId===p&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=p,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,d=o!==null?`${l}#page=${o}`:l,c=this.deps.app.workspace,u=c.getMostRecentLeaf();c.setActiveLeaf(s,{focus:!1});try{await this.openPdfLinkInLeaf(s,d),this.updatePdfSidebarIcon(s)}finally{u&&c.setActiveLeaf(u,{focus:!1})}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(p){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(p)}))}syncPdfSidebarForPreview(p){let e=this.previewScrollEl;if(!e)return;let n=p.getViewData();if(!n)return;let t=wn.Text.of(n.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(t);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(t,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(p){var t;let e=p.getBoundingClientRect().top,n=p.querySelectorAll("[data-line]");for(let i of Array.from(n))if(i.getBoundingClientRect().bottom>=e+2){let a=(t=i.getAttribute("data-line"))!=null?t:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var t,i;if(this.pdfSidebarLeaf&&((i=(t=this.pdfSidebarLeaf.view)==null?void 0:t.getViewType)==null?void 0:i.call(t))==="pdf")return this.pdfSidebarLeaf;let p=this.deps.app.workspace;if(typeof p.ensureSideLeaf=="function")try{let r=await p.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let n=this.deps.app.workspace.getRightLeaf(!0);return n&&this.isRightSidebarLeaf(n)?(this.pdfSidebarLeaf=n,this.updatePdfSidebarIcon(n),n):null}isRightSidebarLeaf(p){if(!p)return!1;let n=p.containerEl;return!!(n!=null&&n.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(p){if(!p||!this.isRightSidebarLeaf(p))return;let n=p.containerEl,t=[];n&&t.push(...Array.from(n.querySelectorAll(".view-header-icon")));let i=p;if(i.tabHeaderEl&&t.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&t.push(i.tabHeaderInnerIconEl),t.length===0)return;let r=new Set;for(let s of t)r.has(s)||(r.add(s),s.innerHTML="",(0,ae.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=p.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(p,e){var r,a,s;let n=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],t=(s=(a=n==null?void 0:n.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof t=="function"){await t.call(n.lib.workspace,p,e,"",{active:!1});return}let i=p;if(typeof i.openLinkText=="function"){await i.openLinkText(e,"",{active:!1});return}await this.deps.app.workspace.openLinkText(e,"",!1)}getPluginsRegistry(){var p;return(p=this.deps.app.plugins)==null?void 0:p.plugins}isLeafTabActive(p){var i;let e=p;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===p;let n=e.containerEl;if(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))return!0;let t=e.tabHeaderEl;return!!(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))}async resolvePageNumberForChunk(p,e){var l,d,c,u,_;if(!p||!e)return null;let n=this.deps.normalizeChunkIdForNote(e,p)||e,t=this.chunkPageCache.get(p);if(t&&t.has(n))return(l=t.get(n))!=null?l:null;let i=(0,ae.normalizePath)(`${W}/${p}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let m of s){let y=typeof(m==null?void 0:m.chunk_id)=="string"?m.chunk_id.trim():"";if(!y)continue;let v=Number.isFinite((d=m==null?void 0:m.page_start)!=null?d:NaN)?Number(m.page_start):null,P=Number.isFinite((c=m==null?void 0:m.page_end)!=null?c:NaN)?Number(m.page_end):null,f=v!=null?v:P;f!==null&&(o.set(y,f),o.set(`${p}:${y}`,f))}return this.chunkPageCache.set(p,o),(_=(u=o.get(n))!=null?u:o.get(e))!=null?_:null}};var Oe={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,n=1200){let t=this.noteSyncTimers.get(e.path);t!==void 0&&window.clearTimeout(t);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},n);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,n=1200,t="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,t)},n);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,n=1200,t="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,t)},n);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let n=this.annotationNoteEditTimes.get(e);if(!n)return 0;let t=Date.now()-n;return t>=Gn?0:Gn-t}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=(e.annotation_page_label||"").trim();if(n)return n;let t=e.page_start?String(e.page_start):"",i=e.page_end?String(e.page_end):"";if(t&&(!i||t===i))return t;if(t&&i)return`${t} - ${i}`;let r=(e.pages||"").trim();if(!r)return"?";let a=r.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:r.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,h.normalizePath)(`${W}/${s}.json`),d=this.app.vault.adapter;if(!await d.exists(l))return;let c=await this.readChunkPayload(l);if(!c)return;let u=Array.isArray(c.chunks)?c.chunks:[],_=new Map;for(let b of u){if(this.isAnnotationChunk(b))continue;let C=typeof(b==null?void 0:b.chunk_id)=="string"?b.chunk_id:String((n=b==null?void 0:b.chunk_id)!=null?n:"");C&&_.set(C,b)}let m=new Set,y=new Set,v=new Set,P=new Set,f=!1;for(let b of o){let C=b.chunkId;if(!C)continue;m.add(C);let E=_.get(C);if(!E){console.warn(`Sync note: chunk id not found in cache (${C})`);continue}if(b.excludeFlag){E.excluded!==!0&&(E.excluded=!0,f=!0);let R=this.normalizeChunkText(b.text);R&&R!==String((t=E.text)!=null?t:"")&&(E.text=R,E.char_count=R.length,f=!0),v.add(C);continue}if(E.excluded&&(E.excluded=!1,f=!0,y.add(C)),!b.text.trim()){v.add(C),P.add(C);continue}let A=this.normalizeChunkText(b.text);if(!A){v.add(C),P.add(C);continue}let S=typeof E.text=="string"?E.text:String((i=E.text)!=null?i:"");A!==S&&(E.text=A,E.char_count=A.length,y.add(C),f=!0)}for(let b of _.keys())m.has(b)||(v.add(b),P.add(b));let x=new Set([...v,...P]);if(x.size){let b=Array.from(x).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==b){this.noteSyncPendingDeletes.set(e.path,b),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!y.size&&!v.size&&!P.size&&!f)return;P.size&&(c.chunks=u.filter(b=>{var E;let C=typeof(b==null?void 0:b.chunk_id)=="string"?b.chunk_id:String((E=b==null?void 0:b.chunk_id)!=null?E:"");return C&&!P.has(C)}),f=!0),(f||P.size)&&await d.write(l,JSON.stringify(c,null,2)),await this.reindexChunkUpdates(s,l,Array.from(y),Array.from(v)),(v.size||P.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,n){var t,i,r;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,n);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),s=await this.resolveDocIdForNote(e,a);if(!s)return;let o=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter;if(!o)return;let l=this.resolveZoteroItemKey(o,s);if(!l)return;let d=await this.fetchZoteroItem(l),c=(i=d==null?void 0:d.data)!=null?i:d;if(!c||typeof c!="object")return;let u=this.extractNoteMetadata(o),_=this.extractZoteroMetadata(c),m=await this.getMetadataSnapshot(s,o,e),y={},v={},P={},f=[],x=["title","short_title","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],b={title:"title",short_title:"short_title",date:"date",abstract:"abstract",doi:"doi",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},C=x.filter(A=>this.hasFrontmatterKey(o,b[A]));if(!C.length)return;let E={title:"Title",short_title:"Short title",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let A of C){let S=u[A],R=_[A];if(this.metadataValuesEqual(A,S,R))continue;let F=m==null?void 0:m[A];if(F!==void 0){let z=!this.metadataValuesEqual(A,S,F),D=!this.metadataValuesEqual(A,R,F);if(z&&!D){P[A]="note",this.assignMetadataUpdate(v,A,S);continue}if(!z&&D){P[A]="zotero",this.assignMetadataUpdate(y,A,R);continue}}let T=this.getMetadataDecisionLabels(A,S,R,E);f.push({field:A,fieldLabel:E[A],noteLabel:T.noteLabel,zoteroLabel:T.zoteroLabel,noteValue:this.formatMetadataValue(S),zoteroValue:this.formatMetadataValue(R)})}if(f.length>0){let A=await this.promptMetadataBatchDecision(f);for(let S of f){let R=(r=A[S.field])!=null?r:"skip";P[S.field]=R,R==="note"?this.assignMetadataUpdate(v,S.field,u[S.field]):R==="zotero"&&this.assignMetadataUpdate(y,S.field,_[S.field])}}Object.keys(y).length>0&&await this.applyNoteMetadataUpdates(e,y),Object.keys(v).length>0&&await this.applyZoteroMetadataUpdates(l,c,u,_,v),await this.updateMetadataSnapshot(e,s,u,_,m,P,C)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,n)}}async syncNoteAnnotationsWithZotero(e,n){var t,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,n);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let d=this.parseAnnotationBlockMarker(l.startMarker),c=await this.resolveDocIdForNote(e,o);if(!c&&d.docId){c=d.docId;let D=this.ensureDocIdInNoteContent(o,c);D!==o&&await this.writeNoteWithSyncSuppressed(e.path,D)}if(!c)return;let u=(i=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter)!=null?i:{},_=(r=d.attachmentKey)!=null?r:"";if(_||(_=await this.resolveAttachmentKeyForDocId(c,u)),!_)return;d.attachmentKey&&(!d.docId||d.docId===c)&&d.attachmentKey===_&&await this.updateDocIndex({doc_id:c,attachment_key:_});let m=_,y=await this.fetchZoteroAnnotationsForDoc(c,_),v=y.annotations;_=y.attachmentKey,_&&_!==m&&await this.updateDocIndex({doc_id:c,attachment_key:_});let P=this.parseAnnotationBlock(l.block,_),f=new Map;for(let D of P)D.key&&f.set(D.key,D);let x=new Map;for(let D of v)x.set(D.key,D);let b=await this.getAnnotationSnapshot(c),C=(a=b==null?void 0:b.annotations)!=null?a:{},E={},A=[],S=!1,R=!1,F=!1;_&&_!==m&&v.length>0&&(R=!0,F=!0);for(let[D,M]of x.entries()){let j=f.get(D);if(!j){R=!0;continue}let I=C[D],q=this.annotationSnapshotFromEntry(j,M.annotationType),$=this.annotationSnapshotFromEntry(M,M.annotationType);if(!I){this.annotationSnapshotsEqual(q,$)||(E[D]="note",S=!0);continue}let G=!this.annotationSnapshotsEqual(q,I),J=!this.annotationSnapshotsEqual($,I);if(G&&!J){E[D]="note",S=!0;continue}if(!G&&J){E[D]="zotero",R=!0;continue}G&&J&&A.push({key:D,title:this.formatAnnotationConflictTitle(M),noteValue:this.formatAnnotationConflictValue(q,j.tags),zoteroValue:this.formatAnnotationConflictValue($,M.tags)})}if(A.length>0){let D=await this.promptAnnotationBatchDecision(A);for(let M of A){let j=(s=D[M.key])!=null?s:"skip";E[M.key]=j,j==="note"?S=!0:j==="zotero"&&(R=!0,F=!0)}}let T=[];for(let[D,M]of Object.entries(E)){if(M!=="note")continue;let j=f.get(D),I=x.get(D);!j||!I||T.push({entry:I,note:j})}T.length>0&&await this.applyZoteroAnnotationUpdates(T),S&&this.annotationNoteEditTimes.set(e.path,Date.now());let z=this.getAnnotationGraceRemaining(e.path);if(R&&z>0&&S&&!F&&(this.scheduleNoteAnnotationSync(e,z+250,n),R=!1),R){let D=this.buildAnnotationBlock(c,_,v),M=this.replaceAnnotationBlock(o,D);if(M&&M!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,M)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(c,_,v),await this.updateAnnotationChunks(c,_,v)}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,n)}}resolveZoteroItemKey(e,n){let t=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),n];for(let i of t){let r=V(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,n){var l;if(!e)return"";let t=await this.getDocIndexEntry(e);if(t||(t=await this.hydrateDocIndexFromCache(e)),t!=null&&t.attachment_key)return t.attachment_key;let i=(0,h.normalizePath)(`${W}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let c=await this.readChunkPayload(i),u=c!=null&&c.metadata&&typeof c.metadata=="object"?c.metadata:null,_=u==null?void 0:u.attachment_key;if(typeof _=="string"&&_.trim())return await this.updateDocIndex({doc_id:e,attachment_key:_.trim()}),_.trim()}}catch(d){}let r=this.resolveZoteroItemKey(n,e);if(!r)return"";let a=await this.fetchZoteroItem(r),s=(l=a==null?void 0:a.data)!=null?l:a;if(!s||typeof s!="object")return"";let o=await ve(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var v,P,f,x,b,C,E,A,S;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString((x=(f=(P=(v=e==null?void 0:e["short title"])!=null?v:e==null?void 0:e.short_title)!=null?P:e==null?void 0:e.shortTitle)!=null?f:e==null?void 0:e["short-title"])!=null?x:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString((b=e==null?void 0:e.abstract)!=null?b:e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((C=e==null?void 0:e.doi)!=null?C:e==null?void 0:e.DOI),s=this.normalizeMetadataString(e==null?void 0:e.publisher),o=this.normalizeMetadataString(e==null?void 0:e.place),l=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),c=this.normalizeMetadataString(e==null?void 0:e.pages),u=this.normalizeMetadataString((S=(A=(E=e==null?void 0:e["item type"])!=null?E:e==null?void 0:e.item_type)!=null?A:e==null?void 0:e.itemType)!=null?S:e==null?void 0:e["item-type"]),_=this.normalizeMetadataList(e==null?void 0:e.tags),m=this.normalizeMetadataList(e==null?void 0:e.authors),y=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:n,short_title:t,date:i,abstract:r,doi:a,publisher:s,place:o,issue:l,volume:d,pages:c,item_type:u,tags:this.sanitizeObsidianTags(_),authors:m,editors:y}}extractZoteroMetadata(e){var P,f,x;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString(me(e)),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString(e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((P=e==null?void 0:e.DOI)!=null?P:e==null?void 0:e.doi),s=this.normalizeMetadataString(e==null?void 0:e.publisher),o=this.normalizeMetadataString(e==null?void 0:e.place),l=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),c=this.normalizeMetadataString(e==null?void 0:e.pages),u=this.normalizeMetadataString((x=(f=e==null?void 0:e.itemType)!=null?f:e==null?void 0:e.item_type)!=null?x:e==null?void 0:e["item-type"]),_=Array.isArray(e==null?void 0:e.creators)?e.creators:[],m=_.filter(b=>(b==null?void 0:b.creatorType)==="author").map(b=>he(b)).filter(Boolean),y=_.filter(b=>(b==null?void 0:b.creatorType)==="editor"||(b==null?void 0:b.creatorType)==="seriesEditor").map(b=>he(b)).filter(Boolean),v=Array.isArray(e==null?void 0:e.tags)?e.tags.map(b=>typeof b=="string"?b:b==null?void 0:b.tag).filter(b=>typeof b=="string"):[];return{title:n,short_title:t,date:i,abstract:r,doi:a,publisher:s,place:o,issue:l,volume:d,pages:c,item_type:u,tags:this.sanitizeObsidianTags(v),authors:this.normalizeMetadataList(m),editors:this.normalizeMetadataList(y)}}extractAnnotationPageInfo(e){var a;let t=V((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:t,pageIndex:i}}parseZoteroAnnotationItem(e,n){var P,f,x,b;let t=(f=(P=e==null?void 0:e.data)!=null?P:e)!=null?f:{},i=V((x=e==null?void 0:e.key)!=null?x:t==null?void 0:t.key);if(!i)return null;let r=V(t.annotationType),a=this.normalizeAnnotationText(t.annotationText),s=this.normalizeAnnotationText(t.annotationComment),o=V(t.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:d,callout:c}=this.resolveAnnotationColorMeta(l),{pageLabel:u,pageIndex:_}=this.extractAnnotationPageInfo(t),m=(b=t.annotationSortIndex)!=null?b:t.annotationSort,y=Number.isFinite(Number(m))?Number(m):0,v=Array.isArray(t.tags)?t.tags.map(C=>typeof C=="string"?C:C==null?void 0:C.tag).filter(C=>typeof C=="string"):[];return{key:i.trim(),attachmentKey:n,pageLabel:u,pageIndex:_,colorKey:l,callout:c,heading:d,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(v),sortIndex:y,rawValues:t}}async fetchZoteroAnnotations(e){if(!e)return[];let n=this.canUseWebApi()||await this.ensureWebApiLibraryId(),t=a=>{var o,l;let s=[];for(let d of a){let c=(l=(o=d==null?void 0:d.data)!=null?o:d)!=null?l:{};if(V(c.itemType)!=="annotation")continue;let u=this.parseZoteroAnnotationItem(d,e);u&&s.push(u)}return s},i=[];try{i=await this.fetchZoteroChildrenLocal(e)}catch(a){console.warn("Failed to fetch Zotero annotation items from local API",a)}let r=t(i);if(!r.length&&n)try{let a=await this.fetchZoteroChildrenWeb(e),s=t(a);s.length&&(r=s)}catch(a){console.warn("Failed to fetch Zotero annotation items from Web API",a)}return r}async fetchZoteroAnnotationsForDoc(e,n){var o,l,d;let t=n,i=await this.fetchZoteroAnnotations(t);if(i.length||!e)return i.length||this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i};let r=[];try{r=await this.fetchZoteroChildren(e)}catch(c){return console.warn("Failed to fetch Zotero attachments for annotations",c),this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}let a=[],s=new Set(t?[t]:[]);for(let c of r){if(!an(c))continue;let u=V((d=(l=c==null?void 0:c.key)!=null?l:(o=c==null?void 0:c.data)==null?void 0:o.key)!=null?d:c==null?void 0:c.attachmentKey);!u||s.has(u)||(s.add(u),a.push(u))}for(let c of a){let u=await this.fetchZoteroAnnotations(c);if(u.length)return{attachmentKey:c,annotations:u}}return this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}maybeWarnMissingAnnotationApi(e,n){if(this.canUseWebApi()){console.info("No Zotero annotations returned for attachment",{docId:e,attachmentKey:n});return}let t=e||n;!t||this.annotationWebApiWarned.has(t)||(this.annotationWebApiWarned.add(t),new h.Notice("Zotero annotations require Web API access. Configure the Web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
`):""}formatCitationMarkdown(e){var c,u,_,m,y;let n=e.doc_id||"?",t=this.formatCitationPageLabel(e),i=e.annotation_key||this.extractAnnotationKey(e.chunk_id),r=e.attachment_key||((u=(c=this.docIndex)==null?void 0:c[e.doc_id||""])==null?void 0:u.attachment_key),a=e.page_start?String(e.page_start):"",s=(m=(_=this.docIndex)==null?void 0:_[e.doc_id||""])!=null?m:null,o=this.resolveCitationTitle(s,(y=s==null?void 0:s.note_path)!=null?y:null,e.doc_id),l=this.formatCitationLabel(o,t),d=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&(s!=null&&s.note_path)){if(i){let v=a||(e.page_end?String(e.page_end):"0"),P=this.buildNoteAnnotationLink(s.note_path,i,r||"",v,l);return P?`- ${P}`:`- ${this.buildNoteLink(s.note_path,l)}`}if(d&&!i)return`- ${this.buildNoteChunkLink(s.note_path,d,l)}`}if(r){let v=this.buildZoteroDeepLink(n,r,a,i);return`- [${l}](${v})`}return`- ${l}`}buildNoteChunkLink(e,n,t){let i=(0,h.normalizePath)(e).replace(/\.md$/i,""),r=`zrr-chunk:${n}`,a=this.escapeWikiLabel(t);return`[[${i}#${r}\\|${a}]]`}buildNoteLink(e,n){let t=(0,h.normalizePath)(e).replace(/\.md$/i,""),i=this.escapeWikiLabel(n);return`[[${t}\\|${i}]]`}buildNoteAnnotationLink(e,n,t,i,r){let a=this.buildAnnotationBlockId(n,t,i);if(!a)return null;let s=(0,h.normalizePath)(e).replace(/\.md$/i,""),o=this.escapeWikiLabel(r);return`[[${s}#^${a}\\|${o}]]`}buildAnnotationBlockId(e,n,t){let i=(e||"").trim().toUpperCase(),r=(n||"").trim().toUpperCase();if(!i||!r)return null;let a=(t||"").trim()||"0";return`${i}a${r}p${a}`}escapeWikiLabel(e){return e?e.replace(/\|/g,"\\|"):""}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,h.normalizePath)(`${Q}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var t;let e=this.app.vault.adapter,n=this.getDocIndexPath();if(!await e.exists(n))return{};try{let i=await e.read(n),r=JSON.parse(i);if(r&&typeof r=="object"){let a=(t=r.entries)!=null?t:r;if(Array.isArray(a)){let s={};for(let l of a)l!=null&&l.doc_id&&(s[String(l.doc_id)]=l);let o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let d=this.normalizeDocIndexPdfPath(l.pdf_path);d!==l.pdf_path&&(l.pdf_path=d,o=!0)}return o&&await this.saveDocIndex(s),s}if(a&&typeof a=="object"){let s=a,o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let d=this.normalizeDocIndexPdfPath(l.pdf_path);d!==l.pdf_path&&(l.pdf_path=d,o=!0)}return o&&await this.saveDocIndex(s),s}}}catch(i){console.error("Failed to read doc index",i)}return{}}async saveDocIndex(e){await this.ensureFolder(Q);let n=this.app.vault.adapter,t=this.getDocIndexPath(),i={version:1,entries:e};await n.write(t,JSON.stringify(i,null,2)),this.docIndex=e}async pruneDocIndexOrphans(){var d;let e=this.app.vault.adapter,n=await this.getDocIndex(),t=new Set(await this.listDocIds(ne)),i=new Set(await this.listDocIds(W)),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),a=0,s=0,o=!1,l=new Date().toISOString();for(let c of Object.keys(n)){let u=n[c],_=!1,m=u!=null&&u.note_path?u.note_path.trim():"";if(m&&await e.exists(m))_=!0;else if((d=r[c])!=null&&d.note_path){_=!0;let v=r[c];v.note_path&&v.note_path!==u.note_path&&(u.note_path=v.note_path,s+=1,o=!0),v.note_title&&v.note_title!==u.note_title&&(u.note_title=v.note_title,s+=1,o=!0),s>0&&(u.updated_at=l)}let y=t.has(c)||i.has(c);!_&&!y&&(delete n[c],a+=1,o=!0)}return o&&await this.saveDocIndex(n),{removed:a,updated:s}}async updateDocIndex(e){var r;let n=await this.getDocIndex(),t=(r=n[e.doc_id])!=null?r:{doc_id:e.doc_id},i={...t,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&t.note_path&&(i.note_path=t.note_path),e.note_title===void 0&&t.note_title&&(i.note_title=t.note_title),e.zotero_title===void 0&&t.zotero_title&&(i.zotero_title=t.zotero_title),e.short_title===void 0&&t.short_title&&(i.short_title=t.short_title),e.pdf_path===void 0&&t.pdf_path&&(i.pdf_path=t.pdf_path),e.attachment_key===void 0&&t.attachment_key&&(i.attachment_key=t.attachment_key),typeof i.pdf_path=="string"&&(i.pdf_path=this.normalizeDocIndexPdfPath(i.pdf_path)),n[e.doc_id]=i,await this.saveDocIndex(n)}async removeDocIndexEntry(e){let n=await this.getDocIndex();if(!n[e]){await this.removeMetadataSnapshot(e);return}delete n[e],await this.saveDocIndex(n),await this.removeMetadataSnapshot(e)}async hydrateDocIndexFromCache(e){var s,o;if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e),i={},r=(0,h.normalizePath)(`${ne}/${e}.json`);if(await n.exists(r))try{let l=await n.read(r),d=JSON.parse(l),c=(o=(s=d==null?void 0:d.data)!=null?s:d)!=null?o:{},u=typeof c.title=="string"?c.title:"";u&&(i.zotero_title=u);let _=me(c);if(_&&(i.short_title=_),!i.note_title||!i.note_path){let m=this.sanitizeFileName(u)||e,y=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${m}.md`),v=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${m}-${e}.md`),P="";await n.exists(y)?P=y:await n.exists(v)&&(P=v),P&&(i.note_path=P,i.note_title=L.default.basename(P,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!i.note_title&&(t!=null&&t.note_path)&&(i.note_title=L.default.basename(t.note_path,".md"));let a=(0,h.normalizePath)(`${W}/${e}.json`);if(await n.exists(a))try{let l=await n.read(a),d=JSON.parse(l);typeof(d==null?void 0:d.source_pdf)=="string"&&(i.pdf_path=d.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(i).length>0&&await this.updateDocIndex({doc_id:e,...i}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var t;return e&&(t=(await this.getDocIndex())[e])!=null?t:null}async inferNotePathFromCache(e){var i,r;let n=this.app.vault.adapter,t=(0,h.normalizePath)(`${ne}/${e}.json`);if(!await n.exists(t))return"";try{let a=await n.read(t),s=JSON.parse(a),o=(r=(i=s==null?void 0:s.data)!=null?i:s)!=null?r:{},l=typeof o.title=="string"?o.title:"",d=this.sanitizeFileName(l)||e,c=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${d}.md`),u=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${d}-${e}.md`);if(await n.exists(c))return c;if(await n.exists(u))return u}catch(a){console.error("Failed to infer note path from cache",a)}return""}async rebuildNoteFromCacheForDocId(e,n){var T,z,D,M,j;try{await this.ensureBundledTools()}catch(I){return n&&new h.Notice("Failed to sync bundled tools. See console for details."),console.error(I),!1}let t=this.app.vault.adapter,i=(0,h.normalizePath)(`${ne}/${e}.json`),r=(0,h.normalizePath)(`${W}/${e}.json`);if(!await t.exists(i)||!await t.exists(r))return n&&new h.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let a;try{let I=await t.read(i);a=JSON.parse(I)}catch(I){return n&&new h.Notice("Failed to read cached item JSON."),console.error(I),this.clearStatusProgress(),!1}let s;try{let I=await t.read(r);s=JSON.parse(I)}catch(I){return n&&new h.Notice("Failed to read cached chunks JSON."),console.error(I),this.clearStatusProgress(),!1}let o=(T=a.data)!=null?T:a,l=typeof o.title=="string"?o.title:"",d=((D=(z=a.key)!=null?z:o.key)!=null?D:e).toString(),c=await this.getDocIndexEntry(e),u=typeof((M=s==null?void 0:s.metadata)==null?void 0:M.attachment_key)=="string"?s.metadata.attachment_key:c==null?void 0:c.attachment_key,_=typeof s.source_pdf=="string"?s.source_pdf:"";if(!_||!await this.isFileAccessible(_)){let I=await this.recoverMissingPdfFromAttachment(_,o,d,e,u,l,n);if(!I)return n&&new h.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;_=I.sourcePdf,I.attachmentKey&&(u=I.attachmentKey),await this.updateChunkJsonSourcePdf(r,_)}let m=await this.resolveLanguageHint(o,d),y=this.buildDoclingLanguageHint(m!=null?m:void 0),v="";if(c!=null&&c.note_path&&await t.exists(c.note_path)&&(v=(0,h.normalizePath)(c.note_path)),!v){let I=this.sanitizeFileName(l)||e,q=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${I}.md`),$=await t.exists(q)?I:await this.resolveUniqueBaseName(I,e);v=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${$}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let I=this.getLogFileRelativePath(),q=(0,h.normalizePath)(L.default.dirname(I));q&&await this.ensureFolder(q);let $=this.getSpellcheckerInfoRelativePath(),G=(0,h.normalizePath)(L.default.dirname($));G&&await this.ensureFolder(G)}}catch(I){return n&&new h.Notice("Failed to create notes folder."),console.error(I),this.clearStatusProgress(),!1}let P=this.getPluginDir(),f=L.default.join(P,"tools","docling_extract.py"),x=L.default.join(P,"tools","index_redisearch.py"),b=null,C=null,E=I=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=I)};try{b=await this.readDoclingQualityLabelFromPdf(_,y),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",b),0);let I=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(f,await this.buildDoclingArgs(_,e,r,v,y,!0),G=>this.handleDoclingProgress(G,b),()=>{},I,"docling_extract",E),this.recreateMissingNotesProcess=null,b=await this.readDoclingQualityLabel(r),u&&await this.annotateChunkJsonWithAttachmentKey(r,u);let q=await this.readDoclingMetadata(r),$=await this.maybeCreateOcrLayeredPdf(_,q,y);$&&(_=$,C=$,await this.updateChunkJsonSourcePdf(r,$))}catch(I){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(n&&new h.Notice("Docling extraction failed. See console for details."),console.error(I),this.clearStatusProgress(),!1)}let A=!1,S=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;if(!await this.ensureRedisAvailable("rebuild"))A=!0,n&&new h.Notice("Redis is unavailable; skipping indexing for this note.");else try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",b),0);let I=["--chunks-json",this.getAbsoluteVaultPath(r),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(I),this.appendEmbedContextArgs(I),this.settings.embedIncludeMetadata&&I.push("--embed-include-metadata"),this.appendChunkTaggingArgs(I,{allowRegenerate:!1}),await this.runPythonStreaming(x,I,q=>{if((q==null?void 0:q.type)==="progress"&&q.total){let $=Math.round(q.current/q.total*100),G=typeof q.message=="string"&&q.message.trim()?q.message:`Indexing chunks ${q.current}/${q.total}`,J=this.formatStatusLabel(G,b);this.showStatusProgress(J,$)}},()=>{},S,"index_redisearch",E),this.recreateMissingNotesProcess=null}catch(I){if(this.recreateMissingNotesAbort)return this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1;n&&new h.Notice("RedisSearch indexing failed; note will still be rebuilt."),console.error(I),A=!0}let F=C?this.buildPdfLinkFromSourcePath(C):this.buildPdfLinkForNote(_,c==null?void 0:c.attachment_key,e);try{let I=await this.app.vault.adapter.read(v),q=await this.readChunkPayload(r),$=this.buildSyncedDoclingContent(e,q,I),G=await this.buildNoteMarkdown(o,(j=a.meta)!=null?j:{},e,F,u,i,$);await this.writeNoteWithSyncSuppressed(v,G);let J=this.app.vault.getAbstractFileByPath(v);J instanceof h.TFile&&this.scheduleNoteAnnotationSync(J,2e3,"save")}catch(I){return n&&new h.Notice("Failed to finalize note markdown."),console.error(I),this.clearStatusProgress(),!1}try{let I=me(o);await this.updateDocIndex({doc_id:e,note_path:v,note_title:L.default.basename(v,".md"),zotero_title:l,short_title:I||void 0,pdf_path:_})}catch(I){console.error("Failed to update doc index",I)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],n=await this.fetchZoteroGroupOptions();return n.length&&e.push(...n),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),n=[],t=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!t)return e&&n.push({value:e,label:e}),n;let i=(this.settings.embedApiKey||"").trim(),r=await this.fetchModelIds(t,i);if(r.length){let a=r.filter(o=>/embed/i.test(o)),s=a.length?a:r;n.push(...s.map(o=>({value:o,label:o})))}return!n.length&&e&&n.push({value:e,label:e}),n.sort((a,s)=>a.label.localeCompare(s.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,n,t){let i=t==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),r=[],a=(e||"").trim().replace(/\/$/,"");if(!a)return i&&r.push({value:i,label:i}),r;let s=(n||"").trim(),o=await this.fetchModelIds(a,s);if(o.length){let l=o.filter(c=>!/embed/i.test(c)),d=l.length?l:o;r.push(...d.map(c=>({value:c,label:c})))}return!r.length&&i&&r.push({value:i,label:i}),r.sort((l,d)=>l.label.localeCompare(d.label))}detectEmbeddingProvider(e){let n=e.toLowerCase();return n.includes("anthropic")?"anthropic":n.includes("openrouter")?"openrouter":n.includes("ollama")||n.includes(":11434")?"ollama":n.includes("openai")?"openai":"generic"}async fetchModelIds(e,n){let t=this.detectEmbeddingProvider(e);try{if(t==="anthropic")return await this.fetchAnthropicModels(e,n);let i=await this.fetchOpenAiCompatibleModels(e,n);return!i.length&&t==="ollama"?await this.fetchOllamaModels(e):i}catch(i){return console.warn("Failed to fetch models",i),[]}}async fetchOpenAiCompatibleModels(e,n){let t=`${e}/models`,i={};n&&(i.Authorization=`Bearer ${n}`);let r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}async fetchOllamaModels(e){let t=`${e.replace(/\/v1\/?$/,"")}/api/tags`,i=await this.requestLocalApiRaw(t);if(i.statusCode>=400)throw new Error(`Ollama tags request failed (${i.statusCode})`);let r;try{r=JSON.parse(i.body.toString("utf8"))}catch(s){return console.warn("Failed to parse Ollama tags response",s),[]}if(!r||typeof r!="object")return[];let a=r.models;return Array.isArray(a)?a.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}async fetchAnthropicModels(e,n){if(!n)return[];let t=`${e}/models`,i={"x-api-key":n,"anthropic-version":"2023-06-01"},r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Anthropic model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}extractModelIds(e){var i,r,a;if(Array.isArray(e))return e.map(s=>this.extractModelId(s)).filter(s=>!!s);if(!e||typeof e!="object")return[];let n=e,t=(a=(r=(i=n.data)!=null?i:n.models)!=null?r:n.model)!=null?a:n.items;return Array.isArray(t)?t.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}extractModelId(e){var r,a,s;if(!e||typeof e!="object")return null;let n=e,t=(s=(a=(r=n.id)!=null?r:n.name)!=null?a:n.model)!=null?s:n.identifier;return typeof t!="string"?null:t.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,n=i=>{for(let r of i)e.has(r.value)||e.set(r.value,r.label)};if(await this.warnIfZoteroLocalApiUnavailable("Zotero groups"))try{let i=this.buildZoteroUrl("/users/0/groups"),r=await this.requestLocalApi(i,`Zotero groups fetch failed for ${i}`);n(this.parseZoteroGroupOptions(r))}catch(i){console.warn("Failed to fetch Zotero groups from local API",i)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let i=(this.settings.webApiLibraryId||"").trim();if(i)try{let r=this.buildWebApiUrl(`/users/${i}/groups`),a=await this.requestWebApi(r,`Zotero Web API groups fetch failed for ${r}`);n(this.parseZoteroGroupOptions(a))}catch(r){console.warn("Failed to fetch Zotero groups from Web API",r)}}return Array.from(e.entries()).map(([i,r])=>({value:i,label:r})).sort((i,r)=>i.label.localeCompare(r.label))}parseZoteroGroupOptions(e){var i,r,a,s,o;let n;try{n=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(n))return[];let t=[];for(let l of n){if(!l||typeof l!="object")continue;let d=(i=l.data)!=null?i:l,c=(a=(r=d.id)!=null?r:l.id)!=null?a:d.key;if(!c)continue;let u=String(c).trim();if(!u)continue;let _=(o=(s=d.name)!=null?s:l.name)!=null?o:u,m=String(_||u).trim()||u;t.push({value:`groups/${u}`,label:`Group: ${m}`})}return t}async ensureFolder(e){let n=this.app.vault.adapter,t=(0,h.normalizePath)(e).split("/").filter(Boolean),i="";for(let r of t)i=i?`${i}/${r}`:r,await n.exists(i)||await n.mkdir(i)}async buildNoteMarkdown(e,n,t,i,r,a,s){let o=`[[${a}]]`,l=this.settings.copyPdfToVault&&i.startsWith("[["),d=r?this.buildZoteroDeepLink(t,r):"",c=d||i,u=l?i:d||i,_=u?l?`PDF: !${u}`:`PDF: ${u}`:"",m=_?`${_}

`:"",y=await this.buildTemplateVars(e,n,t,c,o);y.pdf_block=m,y.pdf_line=_,y.docling_markdown=s;let v=(this.settings.noteBodyTemplate||"").trim();/{{\s*annotation_block\s*}}/i.test(v)&&r?y.annotation_block=await this.buildAnnotationBlockForAttachment(t,r):y.annotation_block="";let f=this.ensureDocIdInFrontmatter(await this.renderFrontmatter(e,n,t,c,o,y),t),x=f?`---
${f}
---

`:"",b=`${m}${s}`,C=v?this.renderTemplate(v,y,b,{appendDocling:!0}):b;return`${x}${C}`}async buildAnnotationBlockForAttachment(e,n){let t=await this.fetchZoteroAnnotationsForDoc(e,n);return t.attachmentKey&&t.attachmentKey!==n&&await this.updateDocIndex({doc_id:e,attachment_key:t.attachmentKey}),this.buildAnnotationBlock(e,t.attachmentKey,t.annotations)}buildAnnotationBlock(e,n,t){var u;let i=`<!-- zrr:annotations-start doc_id=${e} attachment_key=${n} -->`,r="<!-- zrr:annotations-end -->";if(!t.length)return`${i}
${r}`;let a=this.getAnnotationColorMap(),s=Object.keys(a),o=new Map;for(let _ of t){let m=_.colorKey||this.normalizeAnnotationColorKey(_.colorKey),y=(u=o.get(m))!=null?u:[];y.push(_),o.set(m,y)}let l=[i],d=new Set,c=[...s,...Array.from(o.keys()).filter(_=>!s.includes(_))];for(let _ of c){let m=o.get(_);if(!m||!m.length)continue;d.add(_);let{heading:y}=this.resolveAnnotationColorMeta(_);l.push("",`## ${y}`),m.sort((v,P)=>{var b,C;let f=(b=v.pageIndex)!=null?b:0,x=(C=P.pageIndex)!=null?C:0;return f!==x?f-x:v.sortIndex!==P.sortIndex?v.sortIndex-P.sortIndex:v.key.localeCompare(P.key)});for(let v of m)l.push(...this.formatAnnotationCallout(v,n,e))}return l.push("",r),l.join(`
`).trim()}formatAnnotationCallout(e,n,t){let i=this.settings.annotationPageLabel||"Page",r=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?"),a=e.pageIndex?String(e.pageIndex):"",s=this.buildZoteroDeepLink(t,n,a,e.key),l=[`> [!${e.callout}] ${i} [${r}](${s})`],d=u=>{if(u)for(let _ of u.split(/\r?\n/))l.push(_.trim()?`> ${_}`:">")};d(e.text),e.comment&&(l.push(">","> ---"),d(e.comment)),e.tags.length&&l.push(`> **Tags:** ${e.tags.map(u=>`#${u}`).join(" ")}`);let c=e.pageIndex?String(e.pageIndex):"0";return l.push(`> ^${e.key}a${n}p${c}`),l.push(""),l}findAnnotationBlockRange(e){let n=ft.exec(e);if(!n)return null;let t=e.slice(n.index+n[0].length),i=ht.exec(t);if(!i)return null;let r=n.index,a=n.index+n[0].length+i.index+i[0].length,s=t.slice(0,i.index);return{start:r,end:a,block:s,startMarker:n[0]}}parseAnnotationBlockMarker(e){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i),t=e.match(/attachment_key=([\"']?)([^\"'\s]+)\1/i);return{docId:n?n[2].trim():void 0,attachmentKey:t?t[2].trim():void 0}}parseAnnotationBlock(e,n){let t=e.split(/\r?\n/),i=[],r=0;for(;r<t.length;){if(!t[r].trim().startsWith("> [!")){r+=1;continue}let s=[];for(;r<t.length&&t[r].trim().startsWith(">");)s.push(t[r]),r+=1;let o=this.parseAnnotationCallout(s,n);o&&i.push(o)}return i}parseAnnotationCallout(e,n){if(!e.length)return null;let t=e[0].replace(/^>\s?/,"").trim(),i=t.match(/\[!([^\]]+)\]/),r=i?i[1].trim():"note",a=t.match(/\((zotero:\/\/open-pdf\/library\/items\/[^)]+)\)/i),s="",o=n,l="",d=null;if(a){let P=a[1],f=P.match(/items\/([A-Z0-9]{8})/i);f&&(o=f[1]);let x=P.match(/annotation=([A-Z0-9]{8})/i);x&&(s=x[1]);let b=P.match(/page=(\d+)/i);b&&(d=Number(b[1]));let C=t.match(/\[([^\]]+)\]\(zotero:\/\//i);C&&(l=C[1].trim())}let c=[],u=[],_=[],m=!1;for(let P=1;P<e.length;P+=1){let f=e[P].replace(/^>\s?/,""),x=f.trim();if(!x){m?_.push(""):u.push("");continue}if(x.startsWith("^")){let b=x.match(/^\^([A-Z0-9]{8})a([A-Z0-9]{8})p(\d+)/i);b&&(s=b[1],o=b[2],d=Number(b[3]));continue}if(/^(\*\*tags:\*\*|tags:)/i.test(x)){c.push(x);continue}if(x==="---"){m=!0;continue}m?_.push(f):u.push(f)}let y=c.join(" "),v=y?y.replace(/\*\*tags:\*\*/i,"").replace(/tags:/i,"").split(/[\s,]+/).map(P=>P.trim().replace(/^#+/,"")).filter(Boolean):[];return s?{key:s,attachmentKey:o,pageLabel:l,pageIndex:d,callout:r,text:this.normalizeAnnotationText(u.join(`
`)),comment:this.normalizeAnnotationText(_.join(`
`)),tags:this.normalizeAnnotationTags(v)}:null}replaceAnnotationBlock(e,n){let t=this.findAnnotationBlockRange(e);if(!t)return null;let i=e.slice(0,t.start),r=e.slice(t.end),a=n.trim()?`${n.trim()}
`:`${n}`;return`${i}${a}${r}`.replace(/\n{4,}/g,`


`)}async renderFrontmatter(e,n,t,i,r,a){var c;let s=(c=this.settings.frontmatterTemplate)!=null?c:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,n,t,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),d=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(d)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let n=e.split(/\r?\n/),t=[],i=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<n.length;){let l=n[o],d=l.match(i);if(!d){t.push(l),o+=1;continue}let c=d[1].trim(),u=d[2].trim();if(a.has(c)){t.push(l),o+=1;continue}if(!s(u)){t.push(l),o+=1;continue}let _=o+1,m=[];for(;_<n.length&&n[_].match(r);)m.push(n[_]),_+=1;if(m.length===0){for(o=_;o<n.length&&n[o].trim()==="";)o+=1;continue}let y=m.filter(v=>{let P=v.match(r);if(!P)return!1;let f=P[1].trim();return!s(f)});if(y.length>0&&t.push(l,...y),o=_,y.length===0)for(;o<n.length&&n[o].trim()==="";)o+=1}for(;t.length>0&&t[t.length-1].trim()==="";)t.pop();return t.join(`

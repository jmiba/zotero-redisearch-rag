"use strict";var se=Object.create;var Z=Object.defineProperty;var ie=Object.getOwnPropertyDescriptor;var ae=Object.getOwnPropertyNames;var oe=Object.getPrototypeOf,le=Object.prototype.hasOwnProperty;var ce=(P,p)=>{for(var e in p)Z(P,e,{get:p[e],enumerable:!0})},J=(P,p,e,t)=>{if(p&&typeof p=="object"||typeof p=="function")for(let n of ae(p))!le.call(P,n)&&n!==e&&Z(P,n,{get:()=>p[n],enumerable:!(t=ie(p,n))||t.enumerable});return P};var U=(P,p,e)=>(e=P!=null?se(oe(P)):{},J(p||!P||!P.__esModule?Z(e,"default",{value:P,enumerable:!0}):e,P)),de=P=>J(Z({},"__esModule",{value:!0}),P);var ge={};ce(ge,{default:()=>j});module.exports=de(ge);var l=require("obsidian"),$=require("child_process"),I=require("fs"),ee=U(require("http")),te=U(require("https")),h=U(require("path")),N=require("url"),ne=require("crypto");var w=require("obsidian"),R=".zotero-redisearch-rag",E=`${R}/items`,T=`${R}/chunks`,Q={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}
...
item_type: {{item_type}}
pdf_link: {{pdf_link}}
item_json: {{item_json}}`,outputPdfDir:"zotero/pdfs",outputNoteDir:"zotero/notes",chatPaneLocation:"right",redisUrl:"redis://127.0.0.1:6379",redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,ocrMode:"auto",chunkingMode:"page",ocrQualityThreshold:.5,enableLlmCleanup:!1,llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3},M=class extends w.PluginSettingTab{constructor(p,e){super(p,e),this.plugin=e}display(){let{containerEl:p}=this;p.empty(),p.createEl("h2",{text:"Zotero RAG Settings"}),new w.Setting(p).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(e=>e.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async t=>{this.plugin.settings.zoteroBaseUrl=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Zotero user ID").setDesc("Use 0 for local library. You can also enter users/<id> or groups/<id>.").addText(e=>e.setPlaceholder("123456").setValue(this.plugin.settings.zoteroUserId).onChange(async t=>{this.plugin.settings.zoteroUserId=t.trim(),await this.plugin.saveSettings()})),p.createEl("h3",{text:"Zotero Web API (optional fallback)"}),new w.Setting(p).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(e=>e.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async t=>{this.plugin.settings.webApiBaseUrl=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(e=>e.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async t=>{this.plugin.settings.webApiLibraryType=t,await this.plugin.saveSettings()})),new w.Setting(p).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(e=>e.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async t=>{this.plugin.settings.webApiLibraryId=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(e=>e.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async t=>{this.plugin.settings.webApiKey=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Python path").setDesc("Path to python3").addText(e=>e.setPlaceholder("python3").setValue(this.plugin.settings.pythonPath).onChange(async t=>{this.plugin.settings.pythonPath=t.trim()||"python3",await this.plugin.saveSettings()})),new w.Setting(p).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(e=>e.setValue(this.plugin.settings.copyPdfToVault).onChange(async t=>{this.plugin.settings.copyPdfToVault=t,await this.plugin.saveSettings()})),new w.Setting(p).setName("Frontmatter template").setDesc("Use {{doc_id}}, {{zotero_key}}, {{title}}, {{title_yaml}}, {{year}}, {{date}}, {{authors}}, {{authors_yaml}}, {{tags}}, {{item_type}}, {{pdf_link}}, {{item_json}}").addTextArea(e=>{e.inputEl.rows=8,e.setValue(this.plugin.settings.frontmatterTemplate).onChange(async t=>{this.plugin.settings.frontmatterTemplate=t,await this.plugin.saveSettings()})}),new w.Setting(p).setName("Docker path").setDesc("CLI path for Docker (used to start Redis Stack).").addText(e=>e.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async t=>{this.plugin.settings.dockerPath=t.trim()||"docker",await this.plugin.saveSettings()})),p.createEl("h3",{text:"Output folders (vault-relative)"}),new w.Setting(p).setName("PDF folder").addText(e=>e.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async t=>{this.plugin.settings.outputPdfDir=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Notes folder").addText(e=>e.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async t=>{this.plugin.settings.outputNoteDir=t.trim(),await this.plugin.saveSettings()})),p.createEl("h3",{text:"Redis Stack"}),new w.Setting(p).setName("Redis URL").addText(e=>e.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async t=>{this.plugin.settings.redisUrl=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Index name").addText(e=>e.setPlaceholder("idx:zotero").setValue(this.plugin.settings.redisIndex).onChange(async t=>{this.plugin.settings.redisIndex=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Key prefix").addText(e=>e.setPlaceholder("zotero:chunk:").setValue(this.plugin.settings.redisPrefix).onChange(async t=>{this.plugin.settings.redisPrefix=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Auto-start Redis Stack (Docker Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker.").addToggle(e=>e.setValue(this.plugin.settings.autoStartRedis).onChange(async t=>{this.plugin.settings.autoStartRedis=t,await this.plugin.saveSettings()})),new w.Setting(p).setName("Start Redis Stack now").setDesc("Restarts Docker Compose with the vault data directory.").addButton(e=>e.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()})),p.createEl("h3",{text:"Embeddings (LM Studio)"}),new w.Setting(p).setName("Embeddings base URL").addText(e=>e.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async t=>{this.plugin.settings.embedBaseUrl=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Embeddings API key").addText(e=>e.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async t=>{this.plugin.settings.embedApiKey=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Embeddings model").addText(e=>e.setPlaceholder("google/embedding-gemma-300m").setValue(this.plugin.settings.embedModel).onChange(async t=>{this.plugin.settings.embedModel=t.trim(),await this.plugin.saveSettings()})),p.createEl("h3",{text:"Chat LLM"}),new w.Setting(p).setName("Chat base URL").setDesc("OpenAI-compatible chat endpoint base URL").addText(e=>e.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async t=>{this.plugin.settings.chatBaseUrl=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Chat API key").addText(e=>e.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async t=>{this.plugin.settings.chatApiKey=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Chat model").addText(e=>e.setPlaceholder("meta-llama/llama-3.1-405b-instruct").setValue(this.plugin.settings.chatModel).onChange(async t=>{this.plugin.settings.chatModel=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("Temperature").addText(e=>e.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async t=>{let n=Number.parseFloat(t);this.plugin.settings.chatTemperature=Number.isFinite(n)?n:.2,await this.plugin.saveSettings()})),new w.Setting(p).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(e=>e.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async t=>{this.plugin.settings.chatPaneLocation=t,await this.plugin.saveSettings()})),p.createEl("h3",{text:"Docling"}),new w.Setting(p).setName("OCR mode").setDesc("auto: skip OCR when text is readable; force if bad: OCR only when text looks poor; force: always OCR.").addDropdown(e=>e.addOption("auto","auto").addOption("force_low_quality","force if quality is bad").addOption("force","force").setValue(this.plugin.settings.ocrMode).onChange(async t=>{this.plugin.settings.ocrMode=t,await this.plugin.saveSettings()})),new w.Setting(p).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(e=>{e.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async t=>{this.plugin.settings.ocrQualityThreshold=t,await this.plugin.saveSettings()})}),new w.Setting(p).setName("Chunking").setDesc("page or section").addDropdown(e=>e.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async t=>{this.plugin.settings.chunkingMode=t,await this.plugin.saveSettings()})),p.createEl("h4",{text:"OCR cleanup (optional)"}),new w.Setting(p).setName("LLM cleanup for low-quality chunks").setDesc("Optional OpenAI-compatible cleanup for poor OCR. Can be slow/costly.").addToggle(e=>e.setValue(this.plugin.settings.enableLlmCleanup).onChange(async t=>{this.plugin.settings.enableLlmCleanup=t,await this.plugin.saveSettings()})),new w.Setting(p).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(e=>e.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async t=>{this.plugin.settings.llmCleanupBaseUrl=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(e=>e.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async t=>{this.plugin.settings.llmCleanupApiKey=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("LLM cleanup model").setDesc("Model to use for cleanup.").addText(e=>e.setPlaceholder("openai/gpt-oss-20b").setValue(this.plugin.settings.llmCleanupModel).onChange(async t=>{this.plugin.settings.llmCleanupModel=t.trim(),await this.plugin.saveSettings()})),new w.Setting(p).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(e=>e.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async t=>{let n=Number.parseFloat(t);this.plugin.settings.llmCleanupTemperature=Number.isFinite(n)?n:0,await this.plugin.saveSettings()})),new w.Setting(p).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addText(e=>e.setPlaceholder("0.35").setValue(String(this.plugin.settings.llmCleanupMinQuality)).onChange(async t=>{let n=Number.parseFloat(t);this.plugin.settings.llmCleanupMinQuality=Number.isFinite(n)?n:.35,await this.plugin.saveSettings()})),new w.Setting(p).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(e=>e.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async t=>{let n=Number.parseInt(t,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(n)?n:2e3,await this.plugin.saveSettings()}))}};var V={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var K={"docling_extract.py":`#!/usr/bin/env python3
# zotero-redisearch-rag tool version: 0.1.8
import argparse
import json
import logging
import os
...
if __name__ == "__main__":
    sys.exit(main())
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.1.8
...
methode
analyse
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.1.8
services:
  redis-stack:
...
${i}`}renderFrontmatter(e,t,n,r,s){var o;let i=(o=this.settings.frontmatterTemplate)!=null?o:"";if(!i.trim())return"";let a=this.buildTemplateVars(e,t,n,r,s);return i.replace(/{{\s*([a-z0-9_]+)\s*}}/gi,(c,d)=>{var g;return(g=a[d])!=null?g:""}).trim()}buildTemplateVars(e,t,n,r,s){let i=typeof e.title=="string"?e.title:"",a=typeof e.shortTitle=="string"?e.shortTitle:"",o=typeof e.date=="string"?e.date:"",c=typeof(t==null?void 0:t.parsedDate)=="string"?t.parsedDate:"",d=this.extractYear(c||o),m=(Array.isArray(e.creators)?e.creators:[]).filter(b=>b.creatorType==="author").map(b=>this.formatCreatorName(b)),u=m.join("; "),y=Array.isArray(e.tags)?e.tags.map(b=>typeof b=="string"?b:b==null?void 0:b.tag).filter(Boolean):[],x=y.join("; "),k=typeof e.itemType=="string"?e.itemType:"",S=typeof(t==null?void 0:t.creatorSummary)=="string"?t.creatorSummary:"",v={doc_id:n,zotero_key:typeof e.key=="string"?e.key:n,title:i,short_title:a,date:o,year:d,authors:u,tags:x,item_type:k,creator_summary:S,pdf_link:this.escapeYamlString(r),item_json:this.escapeYamlString(s)};for(let[b,L]of Object.entries(v))v[`${b}_yaml`]=this.escapeYamlString(L);return v.authors_yaml=this.toYamlList(m),v.tags_yaml=this.toYamlList(y),v}extractYear(e){if(!e)return"";let t=e.match(/\b(\d{4})\b/);return t?t[1]:""}formatCreatorName(e){if(!e||typeof e!="object")return"";if(e.name)return String(e.name);let t=e.firstName?String(e.firstName):"",n=e.lastName?String(e.lastName):"";return[n,t].filter(Boolean).join(", ")||`${t} ${n}`.trim()}escapeYamlString(e){return`"${String(e).replace(/\\/g,"\\\\").replace(/"/g,'\\"')}"`}toYamlList(e){return e.length?e.map(t=>`  - ${this.escapeYamlString(t)}`).join(`
`):'  - ""'}getVaultBasePath(){var n;let e=this.app.vault.adapter;if(e instanceof l.FileSystemAdapter)return e.getBasePath();let t=(n=e.getBasePath)==null?void 0:n.call(e);if(t)return t;throw new Error("Vault base path is unavailable.")}getPluginDir(){var r;let e=this.getVaultBasePath(),t=(r=this.manifest.dir)!=null?r:this.manifest.id;if(!t)throw new Error("Plugin directory is unavailable.");let n=h.default.isAbsolute(t)?t:h.default.join(e,t);return h.default.normalize(n)}async ensureBundledTools(){let e=this.getPluginDir(),t=h.default.join(e,"tools");await I.promises.mkdir(t,{recursive:!0});for(let[n,r]of Object.entries(K)){let s=h.default.join(t,n),i=!0;try{await I.promises.readFile(s,"utf8")===r&&(i=!1)}catch(a){}i&&await I.promises.writeFile(s,r,"utf8")}}async migrateCachePaths(){let e="zotero/items",t="zotero/chunks",n=E,r=T,s=this.app.vault.adapter,i=(0,l.normalizePath)(e),a=(0,l.normalizePath)(t),o=(0,l.normalizePath)(n),c=(0,l.normalizePath)(r),d=o.split("/").slice(0,-1).join("/"),g=c.split("/").slice(0,-1).join("/");d&&await this.ensureFolder(d),g&&await this.ensureFolder(g);let m=await s.exists(i),u=await s.exists(a),y=await s.exists(o),x=await s.exists(c);m&&!y&&await s.rename(i,o),u&&!x&&await s.rename(a,c)}getAbsoluteVaultPath(e){let t=this.getVaultBasePath(),n=h.default.isAbsolute(e)?e:h.default.join(t,e);return h.default.normalize(n)}buildDoclingArgs(e,t,n,r,s){let i=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,a=["--pdf",e,"--doc-id",t,"--out-json",this.getAbsoluteVaultPath(n),"--out-md",this.getAbsoluteVaultPath(r),"--chunking",this.settings.chunkingMode,"--ocr",i];return this.settings.ocrMode==="force_low_quality"&&a.push("--force-ocr-low-quality"),a.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),s&&a.push("--language-hint",s),this.settings.enableLlmCleanup&&(a.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&a.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&a.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&a.push("--llm-cleanup-model",this.settings.llmCleanupModel),a.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),a.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),a.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars))),a}getRedisDataDir(){return h.default.join(this.getVaultBasePath(),R,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return h.default.join(e,"tools","docker-compose.yml")}getDockerProjectName(){let e=this.getVaultBasePath(),t=h.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),n=(0,ne.createHash)("sha1").update(e).digest("hex").slice(0,8);return`zrr-${t||"vault"}-${n}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),t=e.port?Number(e.port):6379;return Number.isFinite(t)&&t>0?t:6379}catch(e){return 6379}}async startRedisStack(e){var t;try{await this.ensureBundledTools();let n=this.getDockerComposePath(),r=this.getRedisDataDir();await I.promises.mkdir(r,{recursive:!0});let s=((t=this.settings.dockerPath)==null?void 0:t.trim())||"docker",i=this.getDockerProjectName(),a=String(this.getRedisPortFromUrl());try{await this.runCommand(s,["compose","-p",i,"-f",n,"down"],{cwd:h.default.dirname(n)})}catch(o){console.warn("Redis Stack stop before restart failed",o)}await this.runCommand(s,["compose","-p",i,"-f",n,"up","-d"],{cwd:h.default.dirname(n),env:{...process.env,ZRR_DATA_DIR:r,ZRR_PORT:a}}),e||new l.Notice("Redis Stack started.")}catch(n){e||new l.Notice("Failed to start Redis Stack. Check Docker Desktop and File Sharing."),console.error("Failed to start Redis Stack",n)}}runPython(e,t){return new Promise((n,r)=>{let s=(0,$.spawn)(this.settings.pythonPath,[e,...t],{cwd:h.default.dirname(e)}),i="";s.stderr.on("data",a=>{i+=a.toString()}),s.on("close",a=>{a===0?n():r(new Error(i||`Process exited with code ${a}`))})})}runCommand(e,t,n){return new Promise((r,s)=>{let i=(0,$.spawn)(e,t,{cwd:n==null?void 0:n.cwd,env:n==null?void 0:n.env}),a="";i.stderr.on("data",o=>{a+=o.toString()}),i.on("close",o=>{o===0?r():s(new Error(a||`Process exited with code ${o}`))})})}runPythonStreaming(e,t,n,r){return new Promise((s,i)=>{let a=(0,$.spawn)(this.settings.pythonPath,[e,...t],{cwd:h.default.dirname(e)}),o="",c="",d=null,g=!1,m=u=>{if(u.trim())try{let y=JSON.parse(u);d=y,((y==null?void 0:y.type)==="final"||y!=null&&y.answer)&&(g=!0),n(y)}catch(y){}};a.stdout.on("data",u=>{var x;o+=u.toString();let y=o.split(/\r?\n/);o=(x=y.pop())!=null?x:"";for(let k of y)m(k)}),a.stderr.on("data",u=>{c+=u.toString()}),a.on("close",u=>{o.trim()&&m(o),!g&&d&&r(d),u===0?s():i(new Error(c||`Process exited with code ${u}`))})})}runPythonWithOutput(e,t){return new Promise((n,r)=>{let s=(0,$.spawn)(this.settings.pythonPath,[e,...t],{cwd:h.default.dirname(e)}),i="",a="";s.stdout.on("data",o=>{i+=o.toString()}),s.stderr.on("data",o=>{a+=o.toString()}),s.on("close",o=>{o===0?n(i.trim()):r(new Error(a||`Process exited with code ${o}`))})})}},H=class extends l.SuggestModal{constructor(e,t,n){super(e);this.lastError=null;this.indexedDocIds=null;this.plugin=t,this.resolveSelection=n,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){try{if(!this.indexedDocIds){let t=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(t))}return await this.plugin.searchZoteroItems(e)}catch(t){let n=t instanceof Error?t.message:String(t);return this.lastError!==n&&(this.lastError=n,new l.Notice(n)),console.error("Zotero search failed",t),[]}}renderSuggestion(e,t){var g,m,u;let n=(m=(g=e.data)==null?void 0:g.title)!=null?m:"[No title]",r=this.extractYear(e),s=this.getDocId(e),i=s?(u=this.indexedDocIds)==null?void 0:u.has(s):!1,a=this.getPdfStatus(e);i&&t.addClass("zrr-indexed-item"),a==="no"&&t.addClass("zrr-no-pdf-item"),t.createEl("div",{text:n});let o=t.createEl("small"),c=!1,d=()=>{c&&o.createSpan({text:" \u2022 "})};r&&(o.createSpan({text:r}),c=!0),i&&(d(),o.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),c=!0),a==="no"&&(d(),o.createSpan({text:"No PDF",cls:"zrr-no-pdf-flag"}),c=!0),t.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,t){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}getDocId(e){var n,r,s;let t=(s=(r=e.key)!=null?r:(n=e.data)==null?void 0:n.key)!=null?s:"";return typeof t=="string"?t:""}getPdfStatus(e){var r,s,i,a,o,c,d;let t=(c=(o=(i=(r=e.data)==null?void 0:r.attachments)!=null?i:(s=e.data)==null?void 0:s.children)!=null?o:(a=e.data)==null?void 0:a.items)!=null?c:[];if(Array.isArray(t)&&t.length>0)return t.some(m=>this.isPdfAttachment(m))?"yes":"no";let n=(d=e.meta)==null?void 0:d.numChildren;return typeof n=="number"&&n===0?"no":"unknown"}isPdfAttachment(e){var n,r,s,i,a,o;return((o=(a=(s=(n=e==null?void 0:e.contentType)!=null?n:e==null?void 0:e.mimeType)!=null?s:(r=e==null?void 0:e.data)==null?void 0:r.contentType)!=null?a:(i=e==null?void 0:e.data)==null?void 0:i.mimeType)!=null?o:"")==="application/pdf"}extractYear(e){var r,s,i,a;let t=(a=(i=(r=e.meta)==null?void 0:r.parsedDate)!=null?i:(s=e.data)==null?void 0:s.date)!=null?a:"";if(typeof t!="string")return"";let n=t.match(/\b(\d{4})\b/);return n?n[1]:""}};

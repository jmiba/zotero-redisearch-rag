"use strict";var Re=Object.create;var X=Object.defineProperty;var Ne=Object.getOwnPropertyDescriptor;var Te=Object.getOwnPropertyNames;var Oe=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var Ie=(k,p)=>{for(var e in p)X(k,e,{get:p[e],enumerable:!0})},be=(k,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of Te(p))!ze.call(k,t)&&t!==e&&X(k,t,{get:()=>p[t],enumerable:!(n=Ne(p,t))||n.enumerable});return k};var ee=(k,p,e)=>(e=k!=null?Re(Oe(k)):{},be(p||!k||!k.__esModule?X(e,"default",{value:k,enumerable:!0}):e,k)),Fe=k=>be(X({},"__esModule",{value:!0}),k);var Ke={};Ie(Ke,{default:()=>se});module.exports=Fe(Ke);var g=require("obsidian"),Y=require("@codemirror/state"),I=require("@codemirror/view"),G=require("child_process"),z=require("fs"),Se=ee(require("http")),Ee=ee(require("https")),de=ee(require("net")),b=ee(require("path")),H=require("url"),te=require("crypto");var E=require("obsidian"),B=".zotero-redisearch-rag",Z=`${B}/items`,j=`${B}/chunks`,xe={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}
...
pdf_link: {{pdf_link}}
item_json: {{item_json}}`,outputPdfDir:"zotero/pdfs",outputNoteDir:"zotero/notes",chatOutputDir:"zotero/chats",chatPaneLocation:"right",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!0,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,enableChunkTagging:!1,chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,ocrMode:"auto",chunkingMode:"page",maxChunkChars:4e3,chunkOverlapChars:250,ocrQualityThreshold:.5,enableLlmCleanup:!1,llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,enableFileLogging:!1,logFilePath:`${B}/logs/docling_extract.log`,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0},ne=class extends E.PluginSettingTab{constructor(p,e){super(p,e),this.plugin=e}display(){let{containerEl:p}=this;p.empty(),p.createEl("h2",{text:"Prerequisites"}),new E.Setting(p).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env.").addText(c=>c.setPlaceholder("python3").setValue(this.plugin.settings.pythonPath).onChange(async u=>{this.plugin.settings.pythonPath=u.trim(),await this.plugin.saveSettings()})),new E.Setting(p).setName("Python environment").setDesc("Create or update the plugin's Python env (.venv in the plugin folder).").addButton(c=>{c.setButtonText("Create/Update").setCta(),c.onClick(async()=>{c.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{c.setDisabled(!1)}})}),new E.Setting(p).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack).").addText(c=>c.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async u=>{this.plugin.settings.dockerPath=u.trim()||"docker",await this.plugin.saveSettings()})),new E.Setting(p).setName("Redis URL").addText(c=>c.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async u=>{this.plugin.settings.redisUrl=u.trim(),await this.plugin.saveSettings()})),new E.Setting(p).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(c=>c.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async u=>{this.plugin.settings.autoAssignRedisPort=u,await this.plugin.saveSettings()})),new E.Setting(p).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker.").addToggle(c=>c.setValue(this.plugin.settings.autoStartRedis).onChange(async u=>{this.plugin.settings.autoStartRedis=u,await this.plugin.saveSettings()})),new E.Setting(p).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(c=>c.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()})),p.createEl("h2",{text:"Zotero Local API"}),new E.Setting(p).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(c=>c.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async u=>{this.plugin.settings.zoteroBaseUrl=u.trim(),await this.plugin.saveSettings()}));let e=new E.Setting(p).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),n=null,t=c=>{if(!n)return;let u=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(c.map(L=>L.value)).has(u)||(c=c.concat([{value:u,label:`Custom (${u})`}])),n.selectEl.options.length=0;for(let L of c)n.addOption(L.value,L.label);n.setValue(u)},i=async()=>{if(n){n.setDisabled(!0);try{let c=await this.plugin.fetchZoteroLibraryOptions();t(c)}finally{n.setDisabled(!1)}}};e.addDropdown(c=>{n=c;let u=(this.plugin.settings.zoteroUserId||"0").trim()||"0";c.addOption(u,"Loading..."),c.setValue(u),c.onChange(async w=>{this.plugin.settings.zoteroUserId=w.trim(),await this.plugin.saveSettings()})}),e.addButton(c=>{c.setButtonText("Refresh").onClick(async()=>{await i()})}),i(),p.createEl("h2",{text:"Zotero Web API"}),new E.Setting(p).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(c=>c.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async u=>{this.plugin.settings.webApiBaseUrl=u.trim(),await this.plugin.saveSettings()})),new E.Setting(p).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(c=>c.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async u=>{this.plugin.settings.webApiLibraryType=u,await this.plugin.saveSettings()})),new E.Setting(p).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(c=>c.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async u=>{this.plugin.settings.webApiLibraryId=u.trim(),await this.plugin.saveSettings()})),new E.Setting(p).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(c=>c.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async u=>{this.plugin.settings.webApiKey=u.trim(),await this.plugin.saveSettings()})),p.createEl("h2",{text:"Output"}),new E.Setting(p).setName("PDF folder").addText(c=>c.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async u=>{this.plugin.settings.outputPdfDir=u.trim(),await this.plugin.saveSettings()})),new E.Setting(p).setName("Notes folder").addText(c=>c.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async u=>{this.plugin.settings.outputNoteDir=u.trim(),await this.plugin.saveSettings()})),new E.Setting(p).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(c=>{c.setValue(this.plugin.settings.frontmatterTemplate).onChange(async u=>{this.plugin.settings.frontmatterTemplate=u,await this.plugin.saveSettings()}),c.inputEl.rows=10,c.inputEl.style.width="100%"}),new E.Setting(p).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(c=>c.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async u=>{this.plugin.settings.chatOutputDir=u.trim()||"zotero/chats",await this.plugin.saveSettings()})),new E.Setting(p).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(c=>c.setValue(this.plugin.settings.copyPdfToVault).onChange(async u=>{this.plugin.settings.copyPdfToVault=u,!u&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new E.Setting(p).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(c=>{let u=this.plugin.settings.copyPdfToVault;c.setValue(u?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!u).onChange(async w=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=w,await this.plugin.saveSettings()})}),new E.Setting(p).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(c=>c.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async u=>{this.plugin.settings.preferObsidianNoteForCitations=u,await this.plugin.saveSettings()})),p.createEl("h2",{text:"Docling"}),new E.Setting(p).setName("OCR mode").setDesc("auto: skip OCR when text is readable; force if bad: OCR only when text looks poor; force: always OCR.").addDropdown(c=>c.addOption("auto","auto").addOption("force_low_quality","force if quality is bad").addOption("force","force").setValue(this.plugin.settings.ocrMode).onChange(async u=>{this.plugin.settings.ocrMode=u,await this.plugin.saveSettings()})),new E.Setting(p).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(c=>{c.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async u=>{this.plugin.settings.ocrQualityThreshold=u,await this.plugin.saveSettings()})}),new E.Setting(p).setName("Chunking").setDesc("page or section").addDropdown(c=>c.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async u=>{this.plugin.settings.chunkingMode=u,await this.plugin.saveSettings()})),new E.Setting(p).setName("Section chunk max chars").setDesc("Split large section chunks into smaller pieces (section mode only).").addText(c=>c.setPlaceholder("3000").setValue(String(this.plugin.settings.maxChunkChars)).onChange(async u=>{let w=Number.parseInt(u,10);this.plugin.settings.maxChunkChars=Number.isFinite(w)?w:3e3,await this.plugin.saveSettings()})),new E.Setting(p).setName("Section chunk overlap chars").setDesc("Number of characters to overlap when splitting section chunks.").addText(c=>c.setPlaceholder("250").setValue(String(this.plugin.settings.chunkOverlapChars)).onChange(async u=>{let w=Number.parseInt(u,10);this.plugin.settings.chunkOverlapChars=Number.isFinite(w)?w:250,await this.plugin.saveSettings()})),p.createEl("h2",{text:"OCR cleanup (optional)"}),new E.Setting(p).setName("LLM cleanup for low-quality chunks").setDesc("Optional OpenAI-compatible cleanup for poor OCR. Can be slow/costly.").addToggle(c=>c.setValue(this.plugin.settings.enableLlmCleanup).onChange(async u=>{this.plugin.settings.enableLlmCleanup=u,await this.plugin.saveSettings()}));let r=[{value:"http://localhost:1234/v1",label:"LM Studio (http://localhost:1234/v1)"},{value:"http://localhost:11434/v1",label:"Ollama (http://localhost:11434/v1)"},{value:"https://openrouter.ai/api/v1",label:"OpenRouter (https://openrouter.ai/api/v1)"},{value:"https://api.openai.com/v1",label:"OpenAI (https://api.openai.com/v1)"}],s=null,a=async c=>{let u=c.trim();this.plugin.settings.llmCleanupBaseUrl=u,s&&s.setValue(u),await this.plugin.saveSettings()};new E.Setting(p).setName("LLM cleanup provider preset").setDesc("Pick a provider URL or keep a custom value.").addDropdown(c=>{let u=(this.plugin.settings.llmCleanupBaseUrl||"").trim(),w=[...r];u&&!w.some(L=>L.value===u)&&w.push({value:u,label:`Custom (${u})`});for(let L of w)c.addOption(L.value,L.label);c.setValue(u||r[0].value),c.onChange(async L=>{await a(L)})}),new E.Setting(p).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(c=>{s=c,c.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async u=>{await a(u)})}),new E.Setting(p).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(c=>c.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async u=>{this.plugin.settings.llmCleanupApiKey=u.trim(),await this.plugin.saveSettings()}));let l=new E.Setting(p).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),d=null,h=c=>{if(!d)return;let u=(this.plugin.settings.llmCleanupModel||"").trim(),w=new Set(c.map(L=>L.value));u&&!w.has(u)&&(c=c.concat([{value:u,label:`Custom (${u})`}])),d.selectEl.options.length=0;for(let L of c)d.addOption(L.value,L.label);u&&d.setValue(u)},_=async()=>{if(d){d.setDisabled(!0);try{let c=await this.plugin.fetchCleanupModelOptions();h(c)}finally{d.setDisabled(!1)}}};l.addDropdown(c=>{d=c;let u=(this.plugin.settings.llmCleanupModel||"").trim();c.addOption(u||"loading","Loading..."),c.setValue(u||"loading"),c.onChange(async w=>{this.plugin.settings.llmCleanupModel=w.trim(),await this.plugin.saveSettings()})}),l.addButton(c=>{c.setButtonText("Refresh").onClick(async()=>{await _()})}),_(),new E.Setting(p).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(c=>c.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async u=>{let w=Number.parseFloat(u);this.plugin.settings.llmCleanupTemperature=Number.isFinite(w)?w:0,await this.plugin.saveSettings()})),new E.Setting(p).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(c=>c.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async u=>{this.plugin.settings.llmCleanupMinQuality=u,await this.plugin.saveSettings()})),new E.Setting(p).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(c=>c.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async u=>{let w=Number.parseInt(u,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(w)?w:2e3,await this.plugin.saveSettings()})),p.createEl("h2",{text:"Text Embedding"});let f=[{value:"http://localhost:1234/v1",label:"LM Studio (http://localhost:1234/v1)"},{value:"http://localhost:11434/v1",label:"Ollama (http://localhost:11434/v1)"},{value:"https://openrouter.ai/api/v1",label:"OpenRouter (https://openrouter.ai/api/v1)"},{value:"https://api.openai.com/v1",label:"OpenAI (https://api.openai.com/v1)"}],y=null,m=async c=>{let u=c.trim();this.plugin.settings.embedBaseUrl=u,y&&y.setValue(u),await this.plugin.saveSettings()};new E.Setting(p).setName("Embeddings provider preset").setDesc("Pick a provider URL or keep a custom value.").addDropdown(c=>{let u=(this.plugin.settings.embedBaseUrl||"").trim(),w=[...f];u&&!w.some(L=>L.value===u)&&w.push({value:u,label:`Custom (${u})`});for(let L of w)c.addOption(L.value,L.label);c.setValue(u||f[0].value),c.onChange(async L=>{await m(L)})}),new E.Setting(p).setName("Embeddings base URL").addText(c=>{y=c,c.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async u=>{await m(u)})}),new E.Setting(p).setName("Embeddings API key").addText(c=>c.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async u=>{this.plugin.settings.embedApiKey=u.trim(),await this.plugin.saveSettings()}));let S=new E.Setting(p).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),P=null,A=c=>{if(!P)return;let u=(this.plugin.settings.embedModel||"").trim(),w=new Set(c.map(L=>L.value));u&&!w.has(u)&&(c=c.concat([{value:u,label:`Custom (${u})`}])),P.selectEl.options.length=0;for(let L of c)P.addOption(L.value,L.label);u&&P.setValue(u)},C=async()=>{if(P){P.setDisabled(!0);try{let c=await this.plugin.fetchEmbeddingModelOptions();A(c)}finally{P.setDisabled(!1)}}};S.addDropdown(c=>{P=c;let u=(this.plugin.settings.embedModel||"").trim();c.addOption(u||"loading","Loading..."),c.setValue(u||"loading"),c.onChange(async w=>{this.plugin.settings.embedModel=w.trim(),await this.plugin.saveSettings()})}),S.addButton(c=>{c.setButtonText("Refresh").onClick(async()=>{await C()})}),C(),new E.Setting(p).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(c=>c.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async u=>{this.plugin.settings.embedIncludeMetadata=u,await this.plugin.saveSettings()})),new E.Setting(p).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(c=>c.setValue(this.plugin.settings.enableChunkTagging).onChange(async u=>{this.plugin.settings.enableChunkTagging=u,await this.plugin.saveSettings()})),p.createEl("h2",{text:"Chat LLM"});let D=[{value:"http://localhost:1234/v1",label:"LM Studio (http://localhost:1234/v1)"},{value:"http://localhost:11434/v1",label:"Ollama (http://localhost:11434/v1)"},{value:"https://openrouter.ai/api/v1",label:"OpenRouter (https://openrouter.ai/api/v1)"},{value:"https://api.openai.com/v1",label:"OpenAI (https://api.openai.com/v1)"}],N=null,R=async c=>{let u=c.trim();this.plugin.settings.chatBaseUrl=u,N&&N.setValue(u),await this.plugin.saveSettings()};new E.Setting(p).setName("Chat provider preset").setDesc("Pick a provider URL or keep a custom value.").addDropdown(c=>{let u=(this.plugin.settings.chatBaseUrl||"").trim(),w=[...D];u&&!w.some(L=>L.value===u)&&w.push({value:u,label:`Custom (${u})`});for(let L of w)c.addOption(L.value,L.label);c.setValue(u||D[0].value),c.onChange(async L=>{await R(L)})}),new E.Setting(p).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(c=>{N=c,c.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async u=>{await R(u)})}),new E.Setting(p).setName("Chat API key").addText(c=>c.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async u=>{this.plugin.settings.chatApiKey=u.trim(),await this.plugin.saveSettings()}));let v=new E.Setting(p).setName("Chat model").setDesc("Select a chat-capable model from the provider."),T=null,F=c=>{if(!T)return;let u=(this.plugin.settings.chatModel||"").trim(),w=new Set(c.map(L=>L.value));u&&!w.has(u)&&(c=c.concat([{value:u,label:`Custom (${u})`}])),T.selectEl.options.length=0;for(let L of c)T.addOption(L.value,L.label);u&&T.setValue(u)},q=async()=>{if(T){T.setDisabled(!0);try{let c=await this.plugin.fetchChatModelOptions();F(c)}finally{T.setDisabled(!1)}}};v.addDropdown(c=>{T=c;let u=(this.plugin.settings.chatModel||"").trim();c.addOption(u||"loading","Loading..."),c.setValue(u||"loading"),c.onChange(async w=>{this.plugin.settings.chatModel=w.trim(),await this.plugin.saveSettings()})}),v.addButton(c=>{c.setButtonText("Refresh").onClick(async()=>{await q()})}),q(),new E.Setting(p).setName("Temperature").addText(c=>c.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async u=>{let w=Number.parseFloat(u);this.plugin.settings.chatTemperature=Number.isFinite(w)?w:.2,await this.plugin.saveSettings()})),new E.Setting(p).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(c=>c.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async u=>{let w=Number.parseInt(u,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(w)?Math.max(0,w):6,await this.plugin.saveSettings()})),new E.Setting(p).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(c=>c.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async u=>{this.plugin.settings.chatPaneLocation=u,await this.plugin.saveSettings()})),p.createEl("h2",{text:"Logging"}),new E.Setting(p).setName("Enable logging to file").setDesc("Write Docling/Python logs to a file during extraction.").addToggle(c=>c.setValue(this.plugin.settings.enableFileLogging).onChange(async u=>{this.plugin.settings.enableFileLogging=u,await this.plugin.saveSettings()})),new E.Setting(p).setName("Log file path (vault-relative)").setDesc("Where to write logs. Keep inside the vault.").addText(c=>c.setPlaceholder(`${B}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async u=>{this.plugin.settings.logFilePath=u.trim()||`${B}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new E.Setting(p).setName("View or clear log").setDesc("Open the log contents or clear the file.").addButton(c=>c.setButtonText("Open log").onClick(async()=>{var u,w;await((w=(u=this.plugin).openLogFile)==null?void 0:w.call(u))})).addButton(c=>c.setButtonText("Clear log").onClick(async()=>{var u,w;await((w=(u=this.plugin).clearLogFile)==null?void 0:w.call(u))})),p.createEl("h2",{text:"Maintenance"}),new E.Setting(p).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(c=>c.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new E.Setting(p).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(c=>c.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(c=>c.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}};var oe={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
# zotero-redisearch-rag tool version: 0.3.0
import argparse
import json
import math
import logging
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.3.0
aai
aam
abb
abge
...
\xF6pnv
\xFCberarb
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.3.0
docling
paddleocr
paddlex[ocr]
paddlepaddle==3.2.2
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.3.0
services:
  redis-stack:
...
`).replace(/\s+/g," ").trim()}scheduleNoteSync(e){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let t=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},1200);this.noteSyncTimers.set(e.path,t)}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=e.page_start?String(e.page_start):"",t=e.page_end?String(e.page_end):"";if(n&&(!t||n===t))return n;if(n&&t)return`${n} - ${t}`;let i=(e.pages||"").trim();if(!i)return"?";let r=i.match(/^(\d+)\s*-\s*(\d+)$/);return r?r[1]===r[2]?r[1]:`${r[1]} - ${r[2]}`:i.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i,r;if(!this.noteSyncInFlight.has(e.path)&&!this.noteSyncSuppressed.has(e.path)){this.noteSyncInFlight.add(e.path);try{let s=await this.app.vault.read(e),a=this.extractSyncSection(s);if(!a)return;let o=(n=this.extractDocIdFromFrontmatter(s))!=null?n:this.extractDocIdFromSyncMarker(s);if(!o)return;let l=this.parseSyncedChunkBlocks(a);if(!l.length)return;let d=(0,g.normalizePath)(`${j}/${o}.json`),h=this.app.vault.adapter;if(!await h.exists(d))return;let _=await this.readChunkPayload(d);if(!_)return;let f=Array.isArray(_.chunks)?_.chunks:[],y=new Map;for(let C of f){let D=typeof(C==null?void 0:C.chunk_id)=="string"?C.chunk_id:String((t=C==null?void 0:C.chunk_id)!=null?t:"");D&&y.set(D,C)}let m=new Set,x=new Set,S=new Set,P=new Set,A=!1;for(let C of l){let D=C.chunkId;if(!D)continue;m.add(D);let N=y.get(D);if(!N){console.warn(`Sync note: chunk id not found in cache (${D})`);continue}if(C.excludeFlag){N.excluded!==!0&&(N.excluded=!0,A=!0);let v=this.normalizeChunkText(C.text);v&&v!==String((i=N.text)!=null?i:"")&&(N.text=v,N.char_count=v.length,A=!0),S.add(D);continue}if(N.excluded&&(N.excluded=!1,A=!0,x.add(D)),!C.text.trim()){S.add(D),P.add(D);continue}let R=this.normalizeChunkText(C.text);if(!R){S.add(D),P.add(D);continue}let O=typeof N.text=="string"?N.text:String((r=N.text)!=null?r:"");R!==O&&(N.text=R,N.char_count=R.length,x.add(D),A=!0)}for(let C of y.keys())m.has(C)||(S.add(C),P.add(C));if(!x.size&&!S.size&&!P.size&&!A)return;P.size&&(_.chunks=f.filter(C=>{var N;let D=typeof(C==null?void 0:C.chunk_id)=="string"?C.chunk_id:String((N=C==null?void 0:C.chunk_id)!=null?N:"");return D&&!P.has(D)}),A=!0),(A||P.size)&&await h.write(d,JSON.stringify(_,null,2)),await this.reindexChunkUpdates(o,d,Array.from(x),Array.from(S))}catch(s){console.warn("Failed to sync note edits to Redis",s)}finally{this.noteSyncInFlight.delete(e.path)}}}extractSyncSection(e){let n=K.exec(e);if(!n)return null;let t=e.slice(n.index+n[0].length),i=J.exec(t);return i?t.slice(0,i.index):null}extractDocIdFromSyncMarker(e){var r;let n=K.exec(e);if(!n)return null;let i=((r=n[0])!=null?r:"").match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return i?i[2].trim():null}parseSyncedChunkBlocks(e){var o;let n=e.split(/\r?\n/),t=[],i="",r=!1,s=[],a=()=>{i&&(t.push({chunkId:i,text:s.join(`
`).trim(),excludeFlag:r}),i="",r=!1,s=[])};for(let l of n){let d=l.match(Q);if(d){a();let h=(o=d[1])!=null?o:"",_=h.match(/id=([\"']?)([^\"'\s]+)\1/i),f=_?_[2].trim():"";if(!f)continue;i=f,r=/\bexclude\b/i.test(h)||/\bdelete\b/i.test(h),s=[];continue}if(pe.test(l)){a();continue}if(i){if(ie.test(l)){r=!0;continue}s.push(l)}}return a(),t}normalizeChunkText(e){return e.split(/\r?\n/).map(n=>n.replace(/\s+/g," ").trim()).filter((n,t,i)=>!(n===""&&i[t-1]==="")).join(`
...
`)}async readChunkPayload(e){try{let n=await this.app.vault.adapter.read(e);return JSON.parse(n)}catch(n){return console.warn("Failed to read cached chunks JSON",n),null}}resolveChunkFromPayload(e,n,t){var s;let i=this.normalizeChunkIdForNote(n,t)||n,r=new Set([n,i,`${t}:${n}`]);for(let a of e){let o=typeof(a==null?void 0:a.chunk_id)=="string"?a.chunk_id:String((s=a==null?void 0:a.chunk_id)!=null?s:"");if(o&&r.has(o))return a}return null}async writeNoteWithSyncSuppressed(e,n){this.noteSyncSuppressed.add(e);try{await this.app.vault.adapter.write(e,n)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e)},1500)}}async resolveNotePathForDocId(e){if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e);if(t!=null&&t.note_path&&await n.exists(t.note_path))return t.note_path;let r=(await this.scanNotesForDocIds(this.settings.outputNoteDir))[e];return r!=null&&r.note_path?(await this.updateDocIndex({doc_id:e,note_path:r.note_path,note_title:r.note_title}),r.note_path):null}async resolveUniqueBaseName(e,n){let t=this.app.vault.adapter,i=(0,g.normalizePath)(`${this.settings.outputNoteDir}/${e}.md`),r=(0,g.normalizePath)(`${this.settings.outputPdfDir}/${e}.pdf`),s=await t.exists(i),a=this.settings.copyPdfToVault?await t.exists(r):!1;return s||a?`${e}-${n}`:e}async searchZoteroItems(e){let n=new URLSearchParams;n.set("itemType","-attachment"),n.set("limit","25"),n.set("include","data,meta"),e.trim()&&n.set("q",e.trim());let t=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items?${n.toString()}`);try{let i=await this.requestLocalApi(t,`Zotero search failed for ${t}`),r=JSON.parse(i.toString("utf8"));return Array.isArray(r)?r.map(s=>{var a,o,l,d;return{key:(o=s.key)!=null?o:(a=s.data)==null?void 0:a.key,data:(l=s.data)!=null?l:{},meta:(d=s.meta)!=null?d:{}}}).filter(s=>typeof s.key=="string"&&s.key.trim().length>0):[]}catch(i){if(console.warn("Failed to search Zotero via local API",i),!this.canUseWebApi())throw i;return this.searchZoteroItemsWeb(e)}}async resolvePdfAttachment(e,n){let t=this.pickPdfAttachment(e);if(t)return t;try{let i=await this.fetchZoteroChildren(n);for(let r of i){let s=this.toPdfAttachment(r);if(s)return s}}catch(i){console.error("Failed to fetch Zotero children",i)}return null}pickPdfAttachment(e){var t,i,r;let n=(r=(i=(t=e.attachments)!=null?t:e.children)!=null?i:e.items)!=null?r:[];if(!Array.isArray(n))return null;for(let s of n){let a=this.toPdfAttachment(s);if(a)return a}return null}toPdfAttachment(e){var r,s,a,o,l,d;if(((a=(r=e==null?void 0:e.contentType)!=null?r:e==null?void 0:e.mimeType)!=null?a:(s=e==null?void 0:e.data)==null?void 0:s.contentType)!=="application/pdf")return null;let t=(d=(o=e==null?void 0:e.key)!=null?o:e==null?void 0:e.attachmentKey)!=null?d:(l=e==null?void 0:e.data)==null?void 0:l.key;if(!t)return null;let i=this.extractAttachmentPath(e);return i?{key:t,filePath:i}:{key:t}}extractAttachmentPath(e){var t,i,r,s,a,o,l,d;let n=(d=(s=(i=(t=e==null?void 0:e.links)==null?void 0:t.enclosure)==null?void 0:i.href)!=null?s:(r=e==null?void 0:e.enclosure)==null?void 0:r.href)!=null?d:(l=(o=(a=e==null?void 0:e.data)==null?void 0:a.links)==null?void 0:o.enclosure)==null?void 0:l.href;if(typeof n=="string"&&n.startsWith("file://"))try{return(0,H.fileURLToPath)(n)}catch(h){return null}return null}async fetchZoteroChildren(e){let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/children`);try{let t=await this.requestLocalApi(n,`Zotero children request failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(t){if(console.warn("Failed to fetch Zotero children from local API",t),!this.canUseWebApi())throw t;let i=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/children`),r=await this.requestWebApi(i,`Zotero Web API children request failed for ${i}`);return JSON.parse(r.toString("utf8"))}}async downloadZoteroPdf(e){let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/file`);try{let t=await this.requestLocalApiRaw(n),i=await this.followFileRedirect(t);if(i)return i;if(t.statusCode>=300)throw new Error(`Request failed, status ${t.statusCode}`);return t.body}catch(t){if(console.warn("Failed to download PDF from local API",t),!this.canUseWebApi())throw t;let i=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/file`),r=await this.requestWebApiRaw(i),s=await this.followFileRedirect(r);if(s)return s;if(r.statusCode>=300)throw new Error(`Web API request failed, status ${r.statusCode}`);return r.body}}buildZoteroUrl(e){return`${this.settings.zoteroBaseUrl.replace(/\/$/,"")}${e}`}canUseWebApi(){return!!((this.settings.webApiBaseUrl||"").trim()&&this.settings.webApiKey&&this.settings.webApiLibraryId)}getWebApiLibraryPath(){let e=(this.settings.webApiLibraryId||"").trim();return e?`${this.settings.webApiLibraryType==="group"?"groups":"users"}/${e}`:""}buildWebApiUrl(e){return`${this.settings.webApiBaseUrl.replace(/\/$/,"")}${e}`}requestLocalApiRaw(e,n={}){return new Promise((t,i)=>{var h,_;let r=new URL(e),s=r.protocol==="https:"?Ee.default:Se.default,a=(h=n.method)!=null?h:"GET",o={Accept:"*/*",...(_=n.headers)!=null?_:{}},l=n.body;if(l!==void 0&&o["Content-Length"]===void 0){let f=Buffer.isBuffer(l)?l.length:Buffer.byteLength(l);o["Content-Length"]=String(f)}let d=s.request({method:a,hostname:r.hostname,port:r.port||void 0,path:`${r.pathname}${r.search}`,headers:o},f=>{let y=[];f.on("data",m=>y.push(Buffer.from(m))),f.on("end",()=>{var x;let m=Buffer.concat(y);t({statusCode:(x=f.statusCode)!=null?x:0,headers:f.headers,body:m})})});d.on("error",i),l!==void 0&&d.write(l),d.end()})}async requestLocalApi(e,n){let t=await this.requestLocalApiRaw(e);if(t.statusCode>=400){let i=t.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}: ${i||"no response body"}`)}if(t.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}`);return t.body}async requestLocalApiWithBody(e,n,t,i,r){let s=JSON.stringify(t),a=await this.requestLocalApiRaw(e,{method:n,headers:i,body:s});if(a.statusCode>=400){let o=a.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${a.statusCode}: ${o||"no response body"}`)}if(a.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${a.statusCode}`);return{statusCode:a.statusCode,body:a.body}}async requestWebApi(e,n){let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},i=await this.requestLocalApiRaw(e,{headers:t});if(i.statusCode>=400){let r=i.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}: ${r||"no response body"}`)}if(i.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}`);return i.body}requestWebApiRaw(e,n={}){var i;let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey,...(i=n.headers)!=null?i:{}};return this.requestLocalApiRaw(e,{...n,headers:t})}async requestWebApiWithBody(e,n,t,i,r){let s=JSON.stringify(t),a=await this.requestLocalApiRaw(e,{method:n,headers:i,body:s});if(a.statusCode>=400){let o=a.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${a.statusCode}: ${o||"no response body"}`)}if(a.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${a.statusCode}`);return{statusCode:a.statusCode,body:a.body}}async followFileRedirect(e){if(e.statusCode<300||e.statusCode>=400)return null;let n=e.headers.location,t=Array.isArray(n)?n[0]:n;if(!t||typeof t!="string")return null;if(t.startsWith("file://")){let i=(0,H.fileURLToPath)(t);return z.promises.readFile(i)}return t.startsWith("http://")||t.startsWith("https://")?this.requestLocalApi(t):null}bufferToArrayBuffer(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}async annotateChunkJsonWithAttachmentKey(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;let r=i.metadata&&typeof i.metadata=="object"?i.metadata:{};r.attachment_key=n,i.metadata=r,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to annotate chunks JSON with attachment key",t)}}async updateChunkJsonSourcePdf(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;i.source_pdf=n,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to update chunks JSON source_pdf",t)}}buildPdfLinkFromSourcePath(e){if(!e)return"";let n=b.default.normalize(this.getVaultBasePath()),t=b.default.normalize(e),i=n.endsWith(b.default.sep)?n:`${n}${b.default.sep}`;return t.startsWith(i)?`[[${(0,g.normalizePath)(b.default.relative(n,t))}]]`:`[PDF](${(0,H.pathToFileURL)(e).toString()})`}toVaultRelativePath(e){if(!e)return"";let n=b.default.normalize(this.getVaultBasePath()),t=b.default.normalize(e),i=n.endsWith(b.default.sep)?n:`${n}${b.default.sep}`;return t.startsWith(i)?(0,g.normalizePath)(b.default.relative(n,t)):""}async isFileAccessible(e){if(!e)return!1;try{return await z.promises.access(e),!0}catch(n){return!1}}deriveVaultPdfRelativePath(e,n,t){let i=this.toVaultRelativePath(e);if(i&&i.startsWith((0,g.normalizePath)(this.settings.outputPdfDir)))return i;let r=this.sanitizeFileName(n)||t;return(0,g.normalizePath)(`${this.settings.outputPdfDir}/${r}.pdf`)}async recoverMissingPdfFromAttachment(e,n,t,i,r,s,a){let o=await this.resolvePdfAttachment(n,t);if(!o&&r&&(o={key:r}),!o)return null;let l=o.key||r,d=o.filePath;if(!this.settings.copyPdfToVault&&d&&await this.isFileAccessible(d))return{sourcePdf:d,attachmentKey:l};try{await this.ensureFolder(this.settings.outputPdfDir)}catch(y){return console.error("Failed to create PDF output folder",y),null}let h=this.deriveVaultPdfRelativePath(e,s,i),_;try{if(d&&await this.isFileAccessible(d))_=await z.promises.readFile(d);else if(l)_=await this.downloadZoteroPdf(l),!this.settings.copyPdfToVault&&a&&new g.Notice("Local PDF path unavailable; copied PDF into vault for processing.");else return null}catch(y){return console.error("Failed to read or download PDF attachment",y),null}try{await this.app.vault.adapter.writeBinary(h,this.bufferToArrayBuffer(_))}catch(y){return console.error("Failed to write recovered PDF into vault",y),null}return{sourcePdf:this.getAbsoluteVaultPath(h),attachmentKey:l}}buildPdfLinkForNote(e,n,t){return!e&&!n?"":!this.settings.copyPdfToVault&&n?`[PDF](${this.buildZoteroDeepLink(t!=null?t:"",n)})`:this.buildPdfLinkFromSourcePath(e)}buildVaultPdfCitationLink(e,n,t){if(!e)return"";let i=this.toVaultRelativePath(e);if(!i)return"";let r=n?`#page=${n}`:"";return`[[${i}${r}|${t||i}]]`}async maybeCreateOcrLayeredPdf(e,n,t){if(!this.settings.createOcrLayeredPdf||!this.settings.copyPdfToVault||!e||!((n==null?void 0:n.ocr_used)===!0))return null;if(!this.toVaultRelativePath(e))return console.warn("OCR layered PDF requires a vault-local PDF"),null;try{await this.ensureFolder(this.settings.outputPdfDir)}catch(l){return console.warn("Failed to create OCR PDF output folder",l),null}let r=`${e}.ocr.tmp`,s=(t||(n==null?void 0:n.languages)||"eng").toString(),a=this.getPluginDir(),o=b.default.join(a,"tools","ocr_layered_pdf.py");try{return this.showStatusProgress("Creating OCR PDF...",0),await this.runPythonStreaming(o,["--pdf",e,"--out-pdf",r,"--language",s,"--progress"],l=>{if((l==null?void 0:l.type)==="progress"&&l.total){let d=Math.round(l.current/l.total*100);this.showStatusProgress(`Creating OCR PDF ${l.current}/${l.total}`,d)}},()=>{}),await z.promises.rename(r,e),e}catch(l){return console.warn("OCR layered PDF creation failed",l),null}}getMainLeaf(){let e=new Set(this.app.workspace.getLeavesOfType(V)),n=this.app.workspace.getLeavesOfType("markdown").find(i=>!e.has(i));if(n)return n;let t=this.app.workspace.getLeaf(!1);return t&&!e.has(t)?t:this.app.workspace.getLeaf("tab")}async openNoteInMain(e){let n=(0,g.normalizePath)(e),t=this.app.vault.getAbstractFileByPath(n),i=this.getMainLeaf();if(t instanceof g.TFile){await i.openFile(t,{active:!0});return}await this.app.workspace.openLinkText(n,"",!1)}findChunkLineInText(e,n){if(!e||!n)return null;let t=this.escapeRegExp(n),i=new RegExp(`<!--\\s*zrr:chunk\\b[^>]*\\bid=(["']?)${t}\\1[^>]*-->`,"i"),r=e.split(`
`);for(let s=0;s<r.length;s+=1)if(i.test(r[s]))return s;return null}async openNoteAtChunk(e,n){if(!e||!n)return!1;await this.openNoteInMain(e);let i=this.getMainLeaf().view;if(!(i instanceof g.MarkdownView))return!1;let r=i.editor,s=this.normalizeChunkIdForNote(n)||n,a=this.findChunkLineInText(r.getValue(),s);return a===null?(new g.Notice(`Chunk ${s} not found in note.`),!1):(r.setCursor({line:a,ch:0}),r.scrollIntoView({from:{line:a,ch:0},to:{line:a,ch:0}},!0),!0)}async openInternalLinkInMain(e){let n=this.getMainLeaf(),[t,i]=e.split("#"),r=(t||"").trim(),s=(i||"").trim(),a="zrr-chunk:",o=r?this.app.metadataCache.getFirstLinkpathDest(r,""):null;if(o instanceof g.TFile){let l=s.startsWith(a)?s.slice(a.length).trim():"";if(l&&await this.openNoteAtChunk(o.path,l))return;await n.openFile(o,{active:!0}),e.includes("#")&&!l&&(this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1));return}this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1)}async openNoteInNewTab(e){let n=(0,g.normalizePath)(e);await this.app.workspace.openLinkText(n,"","tab")}async openPdfInMain(e,n){if(!e)return!1;let t=b.default.normalize(this.getVaultBasePath()),i=b.default.normalize(e),r=t.endsWith(b.default.sep)?t:`${t}${b.default.sep}`;if(i.startsWith(r)){let s=(0,g.normalizePath)(b.default.relative(t,i)),a=n?`#page=${n}`:"";return await this.app.workspace.openLinkText(`${s}${a}`,"","tab"),!0}try{return window.open((0,H.pathToFileURL)(e).toString()),!0}catch(s){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,n,t,i){if(n){let r=new URLSearchParams;t&&r.set("page",t),i&&r.set("annotation",i);let s=r.toString()?`?${r.toString()}`:"";return`zotero://open-pdf/library/items/${n}${s}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let t=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(t))return t}formatCitationsMarkdown(e){return e.length?e.map(t=>this.formatCitationMarkdown(t)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e){var _,f,y,m;let n=e.doc_id||"?",t=`${n}`,i=this.formatCitationPageLabel(e),r=e.annotation_key||this.extractAnnotationKey(e.chunk_id),s=e.attachment_key||((f=(_=this.docIndex)==null?void 0:_[e.doc_id||""])==null?void 0:f.attachment_key),a=e.page_start?String(e.page_start):"",o=(m=(y=this.docIndex)==null?void 0:y[e.doc_id||""])!=null?m:null,d=`${(o==null?void 0:o.zotero_title)||(o==null?void 0:o.note_title)||t} p. ${i}`,h=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&h&&(o!=null&&o.note_path))return`- ${this.buildNoteChunkLink(o.note_path,h,d)}`;if(s){let x=this.buildZoteroDeepLink(n,s,a,r);return`- [${d}](${x})`}return`- ${d}`}buildNoteChunkLink(e,n,t){let i=(0,g.normalizePath)(e).replace(/\.md$/i,""),r=`zrr-chunk:${n}`;return`[[${i}#${r}|${t}]]`}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,g.normalizePath)(`${B}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var t;let e=this.app.vault.adapter,n=this.getDocIndexPath();if(!await e.exists(n))return{};try{let i=await e.read(n),r=JSON.parse(i);if(r&&typeof r=="object"){let s=(t=r.entries)!=null?t:r;if(Array.isArray(s)){let a={};for(let o of s)o!=null&&o.doc_id&&(a[String(o.doc_id)]=o);return a}if(s&&typeof s=="object")return s}}catch(i){console.error("Failed to read doc index",i)}return{}}async saveDocIndex(e){await this.ensureFolder(B);let n=this.app.vault.adapter,t=this.getDocIndexPath(),i={version:1,entries:e};await n.write(t,JSON.stringify(i,null,2)),this.docIndex=e}async updateDocIndex(e){var r;let n=await this.getDocIndex(),t=(r=n[e.doc_id])!=null?r:{doc_id:e.doc_id},i={...t,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&t.note_path&&(i.note_path=t.note_path),e.note_title===void 0&&t.note_title&&(i.note_title=t.note_title),e.zotero_title===void 0&&t.zotero_title&&(i.zotero_title=t.zotero_title),e.pdf_path===void 0&&t.pdf_path&&(i.pdf_path=t.pdf_path),e.attachment_key===void 0&&t.attachment_key&&(i.attachment_key=t.attachment_key),n[e.doc_id]=i,await this.saveDocIndex(n)}async hydrateDocIndexFromCache(e){var a,o;if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e),i={},r=(0,g.normalizePath)(`${Z}/${e}.json`);if(await n.exists(r))try{let l=await n.read(r),d=JSON.parse(l),h=(o=(a=d==null?void 0:d.data)!=null?a:d)!=null?o:{},_=typeof h.title=="string"?h.title:"";if(_&&(i.zotero_title=_),!i.note_title||!i.note_path){let f=this.sanitizeFileName(_)||e,y=(0,g.normalizePath)(`${this.settings.outputNoteDir}/${f}.md`),m=(0,g.normalizePath)(`${this.settings.outputNoteDir}/${f}-${e}.md`),x="";await n.exists(y)?x=y:await n.exists(m)&&(x=m),x&&(i.note_path=x,i.note_title=b.default.basename(x,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!i.note_title&&(t!=null&&t.note_path)&&(i.note_title=b.default.basename(t.note_path,".md"));let s=(0,g.normalizePath)(`${j}/${e}.json`);if(await n.exists(s))try{let l=await n.read(s),d=JSON.parse(l);typeof(d==null?void 0:d.source_pdf)=="string"&&(i.pdf_path=d.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(i).length>0&&await this.updateDocIndex({doc_id:e,...i}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var t;return e&&(t=(await this.getDocIndex())[e])!=null?t:null}async inferNotePathFromCache(e){var i,r;let n=this.app.vault.adapter,t=(0,g.normalizePath)(`${Z}/${e}.json`);if(!await n.exists(t))return"";try{let s=await n.read(t),a=JSON.parse(s),o=(r=(i=a==null?void 0:a.data)!=null?i:a)!=null?r:{},l=typeof o.title=="string"?o.title:"",d=this.sanitizeFileName(l)||e,h=(0,g.normalizePath)(`${this.settings.outputNoteDir}/${d}.md`),_=(0,g.normalizePath)(`${this.settings.outputNoteDir}/${d}-${e}.md`);if(await n.exists(h))return h;if(await n.exists(_))return _}catch(s){console.error("Failed to infer note path from cache",s)}return""}async rebuildNoteFromCacheForDocId(e,n){var O,v,T,F,q;try{await this.ensureBundledTools()}catch(c){return n&&new g.Notice("Failed to sync bundled tools. See console for details."),console.error(c),!1}let t=this.app.vault.adapter,i=(0,g.normalizePath)(`${Z}/${e}.json`),r=(0,g.normalizePath)(`${j}/${e}.json`);if(!await t.exists(i)||!await t.exists(r))return n&&new g.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let s;try{let c=await t.read(i);s=JSON.parse(c)}catch(c){return n&&new g.Notice("Failed to read cached item JSON."),console.error(c),this.clearStatusProgress(),!1}let a;try{let c=await t.read(r);a=JSON.parse(c)}catch(c){return n&&new g.Notice("Failed to read cached chunks JSON."),console.error(c),this.clearStatusProgress(),!1}let o=(O=s.data)!=null?O:s,l=typeof o.title=="string"?o.title:"",d=((T=(v=s.key)!=null?v:o.key)!=null?T:e).toString(),h=await this.getDocIndexEntry(e),_=typeof((F=a==null?void 0:a.metadata)==null?void 0:F.attachment_key)=="string"?a.metadata.attachment_key:h==null?void 0:h.attachment_key,f=typeof a.source_pdf=="string"?a.source_pdf:"";if(!f||!await this.isFileAccessible(f)){let c=await this.recoverMissingPdfFromAttachment(f,o,d,e,_,l,n);if(!c)return n&&new g.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;f=c.sourcePdf,c.attachmentKey&&(_=c.attachmentKey),await this.updateChunkJsonSourcePdf(r,f)}let y=await this.resolveLanguageHint(o,d),m=this.buildDoclingLanguageHint(y!=null?y:void 0),x="";if(h!=null&&h.note_path&&await t.exists(h.note_path)&&(x=(0,g.normalizePath)(h.note_path)),!x){let c=this.sanitizeFileName(l)||e,u=(0,g.normalizePath)(`${this.settings.outputNoteDir}/${c}.md`),w=await t.exists(u)?c:await this.resolveUniqueBaseName(c,e);x=(0,g.normalizePath)(`${this.settings.outputNoteDir}/${w}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let c=this.getLogFileRelativePath(),u=(0,g.normalizePath)(b.default.dirname(c));u&&await this.ensureFolder(u);let w=this.getSpellcheckerInfoRelativePath(),L=(0,g.normalizePath)(b.default.dirname(w));L&&await this.ensureFolder(L)}}catch(c){return n&&new g.Notice("Failed to create notes folder."),console.error(c),this.clearStatusProgress(),!1}let S=this.getPluginDir(),P=b.default.join(S,"tools","docling_extract.py"),A=b.default.join(S,"tools","index_redisearch.py"),C=null,D=null,N=c=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=c)};try{C=await this.readDoclingQualityLabelFromPdf(f,m),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",C),0);let c=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(P,this.buildDoclingArgs(f,e,r,x,m,!0),L=>this.handleDoclingProgress(L,C),()=>{},c,N),this.recreateMissingNotesProcess=null,C=await this.readDoclingQualityLabel(r),_&&await this.annotateChunkJsonWithAttachmentKey(r,_);let u=await this.readDoclingMetadata(r),w=await this.maybeCreateOcrLayeredPdf(f,u,m);w&&(f=w,D=w,await this.updateChunkJsonSourcePdf(r,w))}catch(c){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(n&&new g.Notice("Docling extraction failed. See console for details."),console.error(c),this.clearStatusProgress(),!1)}try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",C),0);let c=["--chunks-json",this.getAbsoluteVaultPath(r),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.settings.embedIncludeMetadata&&c.push("--embed-include-metadata"),this.appendChunkTaggingArgs(c),await this.runPythonStreaming(A,c,u=>{if((u==null?void 0:u.type)==="progress"&&u.total){let w=Math.round(u.current/u.total*100),L=typeof u.message=="string"&&u.message.trim()?u.message:`Indexing chunks ${u.current}/${u.total}`,ae=this.formatStatusLabel(L,C);this.showStatusProgress(ae,w)}},()=>{},void 0,N),this.recreateMissingNotesProcess=null}catch(c){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(n&&new g.Notice("RedisSearch indexing failed. See console for details."),console.error(c),this.clearStatusProgress(),!1)}let R=D?this.buildPdfLinkFromSourcePath(D):this.buildPdfLinkForNote(f,h==null?void 0:h.attachment_key,e);try{let c=await this.app.vault.adapter.read(x),u=await this.readChunkPayload(r),w=this.buildSyncedDoclingContent(e,u,c),L=await this.buildNoteMarkdown(o,(q=s.meta)!=null?q:{},e,R,_,i,w);await this.writeNoteWithSyncSuppressed(x,L)}catch(c){return n&&new g.Notice("Failed to finalize note markdown."),console.error(c),this.clearStatusProgress(),!1}try{await this.updateDocIndex({doc_id:e,note_path:x,note_title:b.default.basename(x,".md"),zotero_title:l,pdf_path:f})}catch(c){console.error("Failed to update doc index",c)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],n=await this.fetchZoteroGroupOptions();return n.length&&e.push(...n),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),n=[],t=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!t)return e&&n.push({value:e,label:e}),n;let i=(this.settings.embedApiKey||"").trim(),r=await this.fetchModelIds(t,i);if(r.length){let s=r.filter(o=>/embed/i.test(o)),a=s.length?s:r;n.push(...a.map(o=>({value:o,label:o})))}return!n.length&&e&&n.push({value:e,label:e}),n.sort((s,a)=>s.label.localeCompare(a.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,n,t){let i=t==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),r=[],s=(e||"").trim().replace(/\/$/,"");if(!s)return i&&r.push({value:i,label:i}),r;let a=(n||"").trim(),o=await this.fetchModelIds(s,a);if(o.length){let l=o.filter(h=>!/embed/i.test(h)),d=l.length?l:o;r.push(...d.map(h=>({value:h,label:h})))}return!r.length&&i&&r.push({value:i,label:i}),r.sort((l,d)=>l.label.localeCompare(d.label))}detectEmbeddingProvider(e){let n=e.toLowerCase();return n.includes("anthropic")?"anthropic":n.includes("openrouter")?"openrouter":n.includes("ollama")||n.includes(":11434")?"ollama":n.includes("openai")?"openai":"generic"}async fetchModelIds(e,n){let t=this.detectEmbeddingProvider(e);try{if(t==="anthropic")return await this.fetchAnthropicModels(e,n);let i=await this.fetchOpenAiCompatibleModels(e,n);return!i.length&&t==="ollama"?await this.fetchOllamaModels(e):i}catch(i){return console.warn("Failed to fetch models",i),[]}}async fetchOpenAiCompatibleModels(e,n){let t=`${e}/models`,i={};n&&(i.Authorization=`Bearer ${n}`);let r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Model list request failed (${r.statusCode})`);let s=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(s)}async fetchOllamaModels(e){let t=`${e.replace(/\/v1\/?$/,"")}/api/tags`,i=await this.requestLocalApiRaw(t);if(i.statusCode>=400)throw new Error(`Ollama tags request failed (${i.statusCode})`);let r;try{r=JSON.parse(i.body.toString("utf8"))}catch(a){return console.warn("Failed to parse Ollama tags response",a),[]}if(!r||typeof r!="object")return[];let s=r.models;return Array.isArray(s)?s.map(a=>this.extractModelId(a)).filter(a=>!!a):[]}async fetchAnthropicModels(e,n){if(!n)return[];let t=`${e}/models`,i={"x-api-key":n,"anthropic-version":"2023-06-01"},r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Anthropic model list request failed (${r.statusCode})`);let s=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(s)}extractModelIds(e){var i,r,s;if(Array.isArray(e))return e.map(a=>this.extractModelId(a)).filter(a=>!!a);if(!e||typeof e!="object")return[];let n=e,t=(s=(r=(i=n.data)!=null?i:n.models)!=null?r:n.model)!=null?s:n.items;return Array.isArray(t)?t.map(a=>this.extractModelId(a)).filter(a=>!!a):[]}extractModelId(e){var r,s,a;if(!e||typeof e!="object")return null;let n=e,t=(a=(s=(r=n.id)!=null?r:n.name)!=null?s:n.model)!=null?a:n.identifier;return typeof t!="string"?null:t.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,n=t=>{for(let i of t)e.has(i.value)||e.set(i.value,i.label)};try{let t=this.buildZoteroUrl("/users/0/groups"),i=await this.requestLocalApi(t,`Zotero groups fetch failed for ${t}`);n(this.parseZoteroGroupOptions(i))}catch(t){console.warn("Failed to fetch Zotero groups from local API",t)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let t=(this.settings.webApiLibraryId||"").trim();if(t)try{let i=this.buildWebApiUrl(`/users/${t}/groups`),r=await this.requestWebApi(i,`Zotero Web API groups fetch failed for ${i}`);n(this.parseZoteroGroupOptions(r))}catch(i){console.warn("Failed to fetch Zotero groups from Web API",i)}}return Array.from(e.entries()).map(([t,i])=>({value:t,label:i})).sort((t,i)=>t.label.localeCompare(i.label))}parseZoteroGroupOptions(e){var i,r,s,a,o;let n;try{n=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(n))return[];let t=[];for(let l of n){if(!l||typeof l!="object")continue;let d=(i=l.data)!=null?i:l,h=(s=(r=d.id)!=null?r:l.id)!=null?s:d.key;if(!h)continue;let _=String(h).trim();if(!_)continue;let f=(o=(a=d.name)!=null?a:l.name)!=null?o:_,y=String(f||_).trim()||_;t.push({value:`groups/${_}`,label:`Group: ${y}`})}return t}async ensureFolder(e){let n=this.app.vault.adapter,t=(0,g.normalizePath)(e).split("/").filter(Boolean),i="";for(let r of t)i=i?`${i}/${r}`:r,await n.exists(i)||await n.mkdir(i)}async buildNoteMarkdown(e,n,t,i,r,s,a){let o=`[[${s}]]`,l=this.settings.copyPdfToVault&&i.startsWith("[["),d=r?this.buildZoteroDeepLink(t,r):"",h=d||i,_=l?i:d||i,f=_?l?`PDF: !${_}`:`PDF: ${_}`:"",y=f?`${f}

`:"",m=await this.renderFrontmatter(e,n,t,h,o);return`${m?`---
${m}
---

`:""}${y}${a}`}async renderFrontmatter(e,n,t,i,r){var o;let s=(o=this.settings.frontmatterTemplate)!=null?o:"";if(!s.trim())return"";let a=await this.buildTemplateVars(e,n,t,i,r);return s.replace(/{{\s*([a-z0-9_]+)\s*}}/gi,(l,d)=>{var h;return(h=a[d])!=null?h:""}).trim()}async buildTemplateVars(e,n,t,i,r){let s=typeof e.title=="string"?e.title:"",a=typeof e.shortTitle=="string"?e.shortTitle:"",o=typeof e.date=="string"?e.date:"",l=typeof(n==null?void 0:n.parsedDate)=="string"?n.parsedDate:"",d=this.extractYear(l||o),h=Array.isArray(e.creators)?e.creators:[],_=h.filter(M=>M.creatorType==="author").map(M=>this.formatCreatorName(M)),f=_.join("; "),y=h.filter(M=>M.creatorType==="editor"||M.creatorType==="seriesEditor").map(M=>this.formatCreatorName(M)),m=y.join("; "),x=Array.isArray(e.tags)?e.tags.map(M=>typeof M=="string"?M:M==null?void 0:M.tag).filter(Boolean):[],S=x.join("; "),P=await this.resolveCollectionTitles(e),A=P.join("; "),C=typeof e.itemType=="string"?e.itemType:"",D=typeof(n==null?void 0:n.creatorSummary)=="string"?n.creatorSummary:"",N=typeof e.publicationTitle=="string"?e.publicationTitle:"",R=typeof e.bookTitle=="string"?e.bookTitle:"",O=typeof e.journalAbbreviation=="string"?e.journalAbbreviation:"",v=typeof e.volume=="string"?e.volume:"",T=typeof e.issue=="string"?e.issue:"",F=typeof e.pages=="string"?e.pages:"",q=typeof e.DOI=="string"?e.DOI:"",c=typeof e.ISBN=="string"?e.ISBN:"",u=typeof e.ISSN=="string"?e.ISSN:"",w=typeof e.publisher=="string"?e.publisher:"",L=typeof e.place=="string"?e.place:"",ae=typeof e.url=="string"?e.url:"",Le=typeof e.language=="string"?e.language:"",Ae=typeof e.abstractNote=="string"?e.abstractNote:"",U={doc_id:t,zotero_key:typeof e.key=="string"?e.key:t,title:s,short_title:a,date:o,year:d,authors:f,editors:m,tags:S,collection_title:A,item_type:C,creator_summary:D,publication_title:N,book_title:R,journal_abbrev:O,volume:v,issue:T,pages:F,doi:q,isbn:c,issn:u,publisher:w,place:L,url:ae,language:Le,abstract:Ae,pdf_link:this.escapeYamlString(i),item_json:this.escapeYamlString(r)};for(let[M,De]of Object.entries(U))U[`${M}_yaml`]=this.escapeYamlString(De);return U.authors_yaml=this.toYamlList(_),U.editors_yaml=this.toYamlList(y),U.tags_yaml=this.toYamlList(x),U.collections_yaml=this.toYamlList(P),U}extractYear(e){if(!e)return"";let n=e.match(/\b(\d{4})\b/);return n?n[1]:""}formatCreatorName(e){if(!e||typeof e!="object")return"";if(e.name)return String(e.name);let n=e.firstName?String(e.firstName):"",t=e.lastName?String(e.lastName):"";return[t,n].filter(Boolean).join(", ")||`${n} ${t}`.trim()}escapeYamlString(e){return`"${String(e).replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n")}"`}toYamlList(e){return e.length?e.map(n=>`  - ${this.escapeYamlString(n)}`).join(`
`):'  - ""'}getVaultBasePath(){var t;let e=this.app.vault.adapter;if(e instanceof g.FileSystemAdapter)return e.getBasePath();let n=(t=e.getBasePath)==null?void 0:t.call(e);if(n)return n;throw new Error("Vault base path is unavailable.")}getPluginDir(){var i;let e=this.getVaultBasePath(),n=(i=this.manifest.dir)!=null?i:this.manifest.id;if(!n)throw new Error("Plugin directory is unavailable.");let t=b.default.isAbsolute(n)?n:b.default.join(e,n);return b.default.normalize(t)}async ensureBundledTools(){let e=this.getPluginDir(),n=b.default.join(e,"tools");await z.promises.mkdir(n,{recursive:!0});for(let[t,i]of Object.entries(we)){let r=b.default.join(n,t),s=!0;try{await z.promises.readFile(r,"utf8")===i&&(s=!1)}catch(a){}s&&await z.promises.writeFile(r,i,"utf8")}}async migrateCachePaths(){let e="zotero/items",n="zotero/chunks",t=Z,i=j,r=this.app.vault.adapter,s=(0,g.normalizePath)(e),a=(0,g.normalizePath)(n),o=(0,g.normalizePath)(t),l=(0,g.normalizePath)(i),d=o.split("/").slice(0,-1).join("/"),h=l.split("/").slice(0,-1).join("/");d&&await this.ensureFolder(d),h&&await this.ensureFolder(h);let _=await r.exists(s),f=await r.exists(a),y=await r.exists(o),m=await r.exists(l);_&&!y&&await r.rename(s,o),f&&!m&&await r.rename(a,l)}getAbsoluteVaultPath(e){let n=this.getVaultBasePath(),t=b.default.isAbsolute(e)?e:b.default.join(n,e);return b.default.normalize(t)}buildDoclingArgs(e,n,t,i,r,s=!1){let a=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",n,"--out-json",this.getAbsoluteVaultPath(t),"--out-md",this.getAbsoluteVaultPath(i),"--chunking",this.settings.chunkingMode,"--ocr",a];s&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),r&&o.push("--language-hint",r),this.settings.maxChunkChars>0&&o.push("--max-chunk-chars",String(this.settings.maxChunkChars)),this.settings.chunkOverlapChars>0&&o.push("--chunk-overlap-chars",String(this.settings.chunkOverlapChars)),this.settings.enableLlmCleanup&&(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars)));let l=this.getPluginDir(),d=b.default.join(l,"tools","ocr_wordlist.txt");if((0,z.existsSync)(d)&&o.push("--enable-dictionary-correction","--dictionary-path",d),this.settings.enableFileLogging){let h=this.getLogFileAbsolutePath();h&&o.push("--log-file",h);let _=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());_&&o.push("--spellchecker-info-out",_)}return o}appendChunkTaggingArgs(e){if(!this.settings.enableChunkTagging)return;let n=(this.settings.llmCleanupBaseUrl||"").trim(),t=(this.settings.llmCleanupModel||"").trim();if(!n||!t)return;e.push("--generate-chunk-tags","--tag-base-url",n,"--tag-model",t);let i=(this.settings.llmCleanupApiKey||"").trim();i&&e.push("--tag-api-key",i),e.push("--tag-temperature",String(this.settings.llmCleanupTemperature))}getRedisDataDir(){return b.default.join(this.getVaultBasePath(),B,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return b.default.join(e,"tools","docker-compose.yml")}async resolveDockerPath(){var l;let e=(l=this.settings.dockerPath)==null?void 0:l.trim(),n=["/opt/homebrew/bin/docker","/usr/local/bin/docker","/usr/bin/docker","/Applications/Docker.app/Contents/Resources/bin/docker"],t=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"],i=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"],r=[];e&&r.push(e);let s=e?this.getContainerCliKind(e):"docker",a=s==="podman-compose"?[i,t,n]:s==="podman"?[t,i,n]:[n,t,i];if(!e||e==="docker"||e==="podman"||e==="podman-compose")for(let d of a)r.push(...d);for(let d of r)if(b.default.isAbsolute(d))try{if(await this.isContainerCliAvailable(d))return d}catch(h){}let o=[e,s==="podman"?"podman":"docker",s==="podman"?"docker":"podman","podman-compose"].filter(d=>!!(d&&d.trim()));for(let d of o)if(await this.isContainerCliAvailable(d))return d;return e||"docker"}async isContainerCliAvailable(e){return new Promise(n=>{let t=(0,G.spawn)(e,["--version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}getContainerCliKind(e){let n=b.default.basename(e);return n==="podman-compose"?"podman-compose":n.includes("podman")?"podman":"docker"}async isContainerDaemonRunning(e){let n=this.getContainerCliKind(e),t=e,i=["info"];if(n==="podman-compose"){let r=await this.resolvePodmanBin();if(!r)return!1;t=r}return new Promise(r=>{let s=(0,G.spawn)(t,i),a=!1,o=d=>{a||(a=!0,r(d))},l=setTimeout(()=>{s.kill(),o(!1)},2e3);s.on("error",()=>{clearTimeout(l),o(!1)}),s.on("close",d=>{clearTimeout(l),o(d===0)})})}getContainerDaemonHint(e){let n=this.getContainerCliKind(e);return n==="podman"||n==="podman-compose"?"Podman machine not running. Run `podman machine start`.":"Docker Desktop is not running. Start Docker Desktop."}async supportsComposeSubcommand(e){return new Promise(n=>{let t=(0,G.spawn)(e,["compose","version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}async findPodmanComposePath(){let e=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"];for(let n of e)try{return await z.promises.access(n),n}catch(t){}return await this.isContainerCliAvailable("podman-compose")?"podman-compose":null}async resolvePodmanBin(){let e=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"];for(let n of e)if(await this.isContainerCliAvailable(n))return n;return await this.isContainerCliAvailable("podman")?"podman":null}async resolveComposeCommand(e){let n=b.default.basename(e);if(n==="podman-compose")return{command:e,argsPrefix:[]};if(n==="podman"){let t=await this.findPodmanComposePath();return t?{command:t,argsPrefix:[]}:await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}return await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}async autoDetectContainerCliOnLoad(){var r;let e=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(e)){this.notifyContainerOnce("Docker or Podman not found. Install Docker Desktop or Podman and set Docker/Podman path in settings.");return}let n=((r=this.settings.dockerPath)==null?void 0:r.trim())||"docker";(!await this.isContainerCliAvailable(n)||n==="docker"||n==="podman"||n==="podman-compose")&&e&&e!==n&&(this.settings.dockerPath=e,await this.saveSettings()),await this.isContainerDaemonRunning(e)||this.notifyContainerOnce(this.getContainerDaemonHint(e))}getDockerProjectName(){let e=this.getVaultBasePath(),n=b.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),t=(0,te.createHash)("sha1").update(e).digest("hex").slice(0,8);return`zrr-${n||"vault"}-${t}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),n=e.port?Number(e.port):6379;return Number.isFinite(n)&&n>0?n:6379}catch(e){return 6379}}getVaultPreferredRedisPort(){let e=(0,te.createHash)("sha1").update(this.getVaultBasePath()).digest("hex");return 6400+Number.parseInt(e.slice(0,4),16)%2e3}getRedisHostFromUrl(){try{return new URL(this.settings.redisUrl).hostname||"127.0.0.1"}catch(e){return"127.0.0.1"}}isLocalRedisHost(e){let n=e.trim().toLowerCase();return n?n==="localhost"||n==="0.0.0.0"||n==="::1"?!0:n.startsWith("127."):!1}getPortCheckHost(e){return this.isLocalRedisHost(e)?"127.0.0.1":e}async isPortFree(e,n){return new Promise(t=>{let i=de.default.createServer();i.once("error",()=>t(!1)),i.once("listening",()=>{i.close(()=>t(!0))}),i.listen(n,e)})}async findAvailablePort(e,n){for(let i=0;i<25;i+=1){let r=n+i;if(await this.isPortFree(e,r))return r}return null}updateRedisUrlPort(e,n){try{let t=new URL(e);return t.port=String(n),t.toString()}catch(t){return`redis://127.0.0.1:${n}`}}async isRedisReachable(e){let n="127.0.0.1",t=6379;try{let i=new URL(e);n=i.hostname||n,t=i.port?Number(i.port):t}catch(i){return!1}return new Promise(i=>{let r=new de.default.Socket,s=!1,a=o=>{s||(s=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>a(!0)),r.once("timeout",()=>a(!1)),r.once("error",()=>a(!1)),r.connect(t,n)})}getRedisNamespace(){let e=this.getVaultBasePath(),n=b.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24),t=(0,te.createHash)("sha1").update(e).digest("hex").slice(0,8);return`${n||"vault"}-${t}`}getRedisIndexName(){return`${(this.settings.redisIndex||"idx:zotero").trim()||"idx:zotero"}:${this.getRedisNamespace()}`}getRedisKeyPrefix(){let e=(this.settings.redisPrefix||"zotero:chunk:").trim()||"zotero:chunk:";return`${e.endsWith(":")?e:`${e}:`}${this.getRedisNamespace()}:`}async isComposeProjectRunning(e,n,t,i,r){return new Promise(s=>{let a=(0,G.spawn)(e,[...n,"-p",i,"-f",t,"ps","-q"],{cwd:b.default.dirname(t),env:r}),o="";a.stdout.on("data",l=>{o+=l.toString()}),a.on("error",l=>{console.warn("Redis Stack status check failed",l),s(!1)}),a.on("close",l=>{if(l!==0){s(!1);return}s(o.trim().length>0)})})}async startRedisStack(e){var n;try{await this.ensureBundledTools();let t=this.getDockerComposePath(),i=this.getRedisDataDir();await z.promises.mkdir(i,{recursive:!0});let r=await this.resolveDockerPath(),s=((n=this.settings.dockerPath)==null?void 0:n.trim())||"docker";if((!await this.isContainerCliAvailable(s)||!s||s==="docker"||s==="podman"||s==="podman-compose")&&r&&r!==s&&(this.settings.dockerPath=r,await this.saveSettings(),e||new g.Notice(`Docker/Podman path set to ${r}.`)),!await this.isContainerCliAvailable(r)){e||new g.Notice('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');return}if(!await this.isContainerDaemonRunning(r)){e||new g.Notice(this.getContainerDaemonHint(r));return}let o=await this.resolveComposeCommand(r);if(!o){e||new g.Notice("Compose support not found. Install Docker Desktop or Podman with podman-compose.");return}let l={...process.env};if(b.default.basename(o.command)==="podman-compose"){let S=await this.resolvePodmanBin();if(S&&(l.PODMAN_BIN=S,b.default.isAbsolute(S))){let P=b.default.dirname(S),A=l.PATH||"";A.split(b.default.delimiter).includes(P)||(l.PATH=`${P}${b.default.delimiter}${A}`)}}let d=this.getDockerProjectName();if(await this.isComposeProjectRunning(o.command,o.argsPrefix,t,d,l)){e||new g.Notice("Redis Stack already running for this vault.");return}let h=this.getRedisPortFromUrl(),_=this.getRedisHostFromUrl(),f=this.getPortCheckHost(_),y=this.settings.autoAssignRedisPort&&this.isLocalRedisHost(_),m=this.settings.redisUrl,x=h;if(y){let S=h===6379?this.getVaultPreferredRedisPort():h,P=await this.findAvailablePort(f,S);if(!P)throw new Error(`No available Redis port found starting at ${S}.`);P!==h&&(x=P,m=this.updateRedisUrlPort(m,x),this.settings.redisUrl=m,await this.saveSettings(),e||new g.Notice(`Using Redis port ${x} for this vault.`))}else if(await this.isRedisReachable(m)){e||new g.Notice(`Redis already running at ${m}.`);return}l.ZRR_DATA_DIR=i,l.ZRR_PORT=String(x);try{await this.runCommand(o.command,[...o.argsPrefix,"-p",d,"-f",t,"down"],{cwd:b.default.dirname(t),env:l})}catch(S){console.warn("Redis Stack stop before restart failed",S)}await this.runCommand(o.command,[...o.argsPrefix,"-p",d,"-f",t,"up","-d"],{cwd:b.default.dirname(t),env:l}),e||new g.Notice("Redis Stack started.")}catch(t){e||new g.Notice("Failed to start Redis Stack. Check Docker/Podman and file sharing."),console.error("Failed to start Redis Stack",t)}}async setupPythonEnv(){let e=this.getPluginDir(),n=this.getPythonVenvDir(),t=this.getVenvPythonPath(n);await this.ensureBundledTools();let i=this.resolveRequirementsPath(e);if(!i)throw new Error(`requirements.txt not found in ${e}`);try{new g.Notice("Setting up Python environment..."),this.showStatusProgress("Setting up Python environment...",null),console.log(`Python env: using plugin dir ${e}`),console.log(`Python env: venv path ${n}`);let r=null,s=async()=>(r||(r=await this.resolveBootstrapPython()),r);if((0,z.existsSync)(t)){let a=await this.getPythonVersion(t,[]);if(a&&this.isUnsupportedPythonVersion(a)){let o=await s();console.log(`Python env: existing venv uses Python ${a.major}.${a.minor}; rebuilding with ${o.command} ${o.args.join(" ")}`),this.showStatusProgress("Rebuilding Python environment...",null),await z.promises.rm(n,{recursive:!0,force:!0})}}if(!(0,z.existsSync)(t)){let a=await s();console.log(`Python env: creating venv with ${a.command} ${a.args.join(" ")}`),await this.runCommand(a.command,[...a.args,"-m","venv",n],{cwd:e})}await this.runCommandStreaming(t,["-m","pip","install","-r",i],{cwd:e},a=>{let o=a.trim();if(!o)return;let l=o.match(/^Collecting\s+([^\s]+)/);if(l){this.showStatusProgress(`Installing ${l[1]}...`,null);return}if(o.startsWith("Installing collected packages")){this.showStatusProgress("Installing packages...",null);return}o.startsWith("Successfully installed")&&this.showStatusProgress("Python environment ready.",100)}),this.settings.pythonPath=t,await this.saveSettings(),this.clearStatusProgress(),new g.Notice("Python environment ready.")}catch(r){this.clearStatusProgress(),new g.Notice("Failed to set up Python environment. See console for details."),console.error("Python env setup failed",r)}}getPythonVenvDir(){return b.default.join(this.getPluginDir(),".venv")}getVenvPythonPath(e){return process.platform==="win32"?b.default.join(e,"Scripts","python.exe"):b.default.join(e,"bin","python")}resolveRequirementsPath(e){var t;return(t=[b.default.join(e,"requirements.txt"),b.default.join(e,"tools","requirements.txt")].find(i=>(0,z.existsSync)(i)))!=null?t:null}async resolveBootstrapPython(){let e=(this.settings.pythonPath||"").trim();if(e&&await this.canRunCommand(e,[])){let t=await this.getPythonVersion(e,[]);if(t&&this.isUnsupportedPythonVersion(t))throw new Error(`Configured Python ${t.major}.${t.minor} is not supported. Install Python 3.11 or 3.12 and update the Python path.`);return{command:e,args:[]}}let n=process.platform==="win32"?[{command:"py",args:["-3.12"]},{command:"py",args:["-3.11"]},{command:"py",args:["-3.10"]},{command:"py",args:["-3"]},{command:"python",args:[]}]:[{command:"python3.12",args:[]},{command:"python3.11",args:[]},{command:"python3.10",args:[]},{command:"python3",args:[]},{command:"python",args:[]}];for(let t of n)if(await this.canRunCommand(t.command,t.args)){let i=await this.getPythonVersion(t.command,t.args);if(i&&this.isUnsupportedPythonVersion(i)){console.log(`Python env: skipping ${t.command} ${t.args.join(" ")} (Python ${i.major}.${i.minor} unsupported)`);continue}return t}throw new Error("No usable Python 3.11/3.12 interpreter found on PATH.")}isUnsupportedPythonVersion(e){return e.major>3||e.major===3&&e.minor>=13}async getPythonVersion(e,n){return new Promise(t=>{let i=(0,G.spawn)(e,[...n,"-c","import sys; print(f'{sys.version_info.major}.{sys.version_info.minor}')"]),r="";i.stdout.on("data",s=>{r+=s.toString()}),i.on("error",()=>t(null)),i.on("close",s=>{if(s!==0){t(null);return}let a=r.trim().match(/(\d+)\.(\d+)/);if(!a){t(null);return}t({major:Number(a[1]),minor:Number(a[2])})})})}async canRunCommand(e,n){return new Promise(t=>{let i=(0,G.spawn)(e,[...n,"--version"],{env:this.buildPythonEnv()});i.on("error",()=>t(!1)),i.on("close",r=>t(r===0))})}buildPythonEnv(){let e={...process.env},n=b.default.delimiter,t=e.PATH||"",r=[...process.platform==="win32"?[]:["/opt/homebrew/bin","/usr/local/bin"],t].filter(Boolean).join(n);return e.PATH=r,e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK||(e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK="True"),e.DISABLE_MODEL_SOURCE_CHECK||(e.DISABLE_MODEL_SOURCE_CHECK="True"),e}runPython(e,n){return new Promise((t,i)=>{let r=(0,G.spawn)(this.settings.pythonPath,[e,...n],{cwd:b.default.dirname(e),env:this.buildPythonEnv()}),s="";r.stderr.on("data",a=>{s+=a.toString()}),r.on("error",a=>{this.handlePythonProcessError(String(a)),i(a)}),r.on("close",a=>{a===0?t():(this.handlePythonProcessError(s),i(new Error(s||`Process exited with code ${a}`)))})})}runCommand(e,n,t){return new Promise((i,r)=>{var o;let s=(0,G.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:(o=t==null?void 0:t.env)!=null?o:this.buildPythonEnv()}),a="";s.stderr.on("data",l=>{a+=l.toString()}),s.on("error",l=>{r(l)}),s.on("close",l=>{l===0?i():r(new Error(a||`Process exited with code ${l}`))})})}runPythonStreaming(e,n,t,i,r,s){return new Promise((a,o)=>{let l=(0,G.spawn)(this.settings.pythonPath,[e,...n],{cwd:b.default.dirname(e),env:this.buildPythonEnv()});s&&s(l);let d="",h="",_=null,f=!1,y=m=>{if(m.trim())try{let x=JSON.parse(m);_=x,((x==null?void 0:x.type)==="final"||x!=null&&x.answer)&&(f=!0),t(x)}catch(x){}};l.stdout.on("data",m=>{var S;d+=m.toString();let x=d.split(/\r?\n/);d=(S=x.pop())!=null?S:"";for(let P of x)y(P)}),l.stderr.on("data",m=>{h+=m.toString()}),l.on("error",m=>{this.handlePythonProcessError(String(m)),o(m)}),l.on("close",m=>{d.trim()&&y(d),!f&&_&&i(_),r&&this.appendToLogFile(r,h),m===0?a():(this.handlePythonProcessError(h),o(new Error(h||`Process exited with code ${m}`)))})})}runCommandStreaming(e,n,t,i){return new Promise((r,s)=>{var d;let a=(0,G.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:(d=t==null?void 0:t.env)!=null?d:this.buildPythonEnv()}),o=h=>{h.toString().split(/\r?\n/).forEach(f=>{f.trim()&&i(f)})},l="";a.stdout.on("data",o),a.stderr.on("data",h=>{l+=h.toString(),o(h)}),a.on("error",h=>{s(h)}),a.on("close",h=>{h===0?r():s(new Error(l||`Process exited with code ${h}`))})})}handlePythonProcessError(e){if(!e)return;let n=e.match(/ModuleNotFoundError:\s+No module named ['"]([^'"]+)['"]/);if(n){let t=`Python env missing module '${n[1]}'. Run "Python environment" in settings.`;this.notifyPythonEnvOnce(t);return}if(/No module named ['"]/.test(e)){this.notifyPythonEnvOnce('Python env missing required modules. Run "Python environment" in settings.');return}/ENOENT|No such file or directory|not found/.test(e)&&this.notifyPythonEnvOnce('Python not found. Configure Python path or run "Python environment" in settings.')}notifyPythonEnvOnce(e){this.lastPythonEnvNotice!==e&&(this.lastPythonEnvNotice=e,new g.Notice(e))}notifyContainerOnce(e){this.lastContainerNotice!==e&&(this.lastContainerNotice=e,new g.Notice(e))}getLogsDirRelative(){return(0,g.normalizePath)(`${B}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,g.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,g.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;if(!await n.exists(e)){new g.Notice("Log file not found.");return}try{let t=async()=>{try{return await n.read(e)||"(empty)"}catch(r){return"(empty)"}},i=await t();new _e(this.app,"Docling log",i||"(empty)",{autoRefresh:!0,refreshIntervalMs:2e3,onRefresh:t,onClear:async()=>{await this.clearLogFile()}}).open()}catch(t){new g.Notice("Failed to open log file."),console.error(t)}}async clearLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{let t=(0,g.normalizePath)(b.default.dirname(e));t&&await this.ensureFolder(t),await n.write(e,""),new g.Notice("Log file cleared.")}catch(t){new g.Notice("Failed to clear log file."),console.error(t)}}formatStderrForLog(e){let n=e.split(/\r?\n/).map(i=>i.trimEnd()).filter(i=>!!i.trim());if(!n.length)return"";let t=new Date().toISOString().replace("T"," ").replace("Z","").replace(".",",");return n.map(i=>`${t} STDERR docling_extract: ${i}`).join(`
`)+`
`}async appendToLogFile(e,n){if(!n||!n.trim())return;let t=this.formatStderrForLog(n);if(t)try{await z.promises.mkdir(b.default.dirname(e),{recursive:!0}),await z.promises.appendFile(e,t)}catch(i){console.warn("Failed to append stderr to log file",i)}}runPythonWithOutput(e,n,t){return new Promise((i,r)=>{let s=(0,G.spawn)(this.settings.pythonPath,[e,...n],{cwd:b.default.dirname(e),env:this.buildPythonEnv()}),a="",o="";s.stdout.on("data",l=>{a+=l.toString()}),s.stderr.on("data",l=>{o+=l.toString()}),s.on("error",l=>{this.handlePythonProcessError(String(l)),r(l)}),s.on("close",l=>{t&&this.appendToLogFile(t,o),l===0?i(a.trim()):(this.handlePythonProcessError(o),r(new Error(o||`Process exited with code ${l}`)))})})}},ye=class extends g.SuggestModal{constructor(e,n,t){super(e);this.lastError=null;this.indexedDocIds=null;this.plugin=n,this.resolveSelection=t,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){try{if(!this.indexedDocIds){let n=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(n))}return await this.plugin.searchZoteroItems(e)}catch(n){let t=n instanceof Error?n.message:String(n);return this.lastError!==t&&(this.lastError=t,new g.Notice(t)),console.error("Zotero search failed",n),[]}}renderSuggestion(e,n){var h,_,f;let t=(_=(h=e.data)==null?void 0:h.title)!=null?_:"[No title]",i=this.extractYear(e),r=this.getDocId(e),s=r?(f=this.indexedDocIds)==null?void 0:f.has(r):!1,a=this.getPdfStatus(e);s&&n.addClass("zrr-indexed-item"),a==="no"&&n.addClass("zrr-no-pdf-item"),n.createEl("div",{text:t});let o=n.createEl("small"),l=!1,d=()=>{l&&o.createSpan({text:" \u2022 "})};i&&(o.createSpan({text:i}),l=!0),s&&(d(),o.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),l=!0),a==="no"&&(d(),o.createSpan({text:"No attachment",cls:"zrr-no-pdf-flag"}),l=!0),n.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,n){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}getDocId(e){var t,i,r;let n=(r=(i=e.key)!=null?i:(t=e.data)==null?void 0:t.key)!=null?r:"";return typeof n=="string"?n:""}getPdfStatus(e){var i,r,s,a,o,l,d;let n=(l=(o=(s=(i=e.data)==null?void 0:i.attachments)!=null?s:(r=e.data)==null?void 0:r.children)!=null?o:(a=e.data)==null?void 0:a.items)!=null?l:[];if(Array.isArray(n)&&n.length>0)return n.some(_=>this.isPdfAttachment(_))?"yes":"no";let t=(d=e.meta)==null?void 0:d.numChildren;return typeof t=="number"&&t===0?"no":"unknown"}isPdfAttachment(e){var t,i,r,s,a,o;return((o=(a=(r=(t=e==null?void 0:e.contentType)!=null?t:e==null?void 0:e.mimeType)!=null?r:(i=e==null?void 0:e.data)==null?void 0:i.contentType)!=null?a:(s=e==null?void 0:e.data)==null?void 0:s.mimeType)!=null?o:"")==="application/pdf"}extractYear(e){var i,r,s,a;let n=(a=(s=(i=e.meta)==null?void 0:i.parsedDate)!=null?s:(r=e.data)==null?void 0:r.date)!=null?a:"";if(typeof n!="string")return"";let t=n.match(/\b(\d{4})\b/);return t?t[1]:""}};

"use strict";var ue=Object.create;var U=Object.defineProperty;var ge=Object.getOwnPropertyDescriptor;var he=Object.getOwnPropertyNames;var fe=Object.getPrototypeOf,_e=Object.prototype.hasOwnProperty;var me=(L,u)=>{for(var e in u)U(L,e,{get:u[e],enumerable:!0})},ae=(L,u,e,n)=>{if(u&&typeof u=="object"||typeof u=="function")for(let t of he(u))!_e.call(L,t)&&t!==e&&U(L,t,{get:()=>u[t],enumerable:!(n=ge(u,t))||n.enumerable});return L};var G=(L,u,e)=>(e=L!=null?ue(fe(L)):{},ae(u||!L||!L.__esModule?U(e,"default",{value:L,enumerable:!0}):e,L)),ye=L=>ae(U({},"__esModule",{value:!0}),L);var xe={};me(xe,{default:()=>J});module.exports=ye(xe);var d=require("obsidian"),F=require("child_process"),R=require("fs"),de=G(require("http")),pe=G(require("https")),X=G(require("net")),f=G(require("path")),B=require("url"),H=require("crypto");var w=require("obsidian"),O=".zotero-redisearch-rag",q=`${O}/items`,I=`${O}/chunks`,se={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}
...
item_type: {{item_type}}
pdf_link: {{pdf_link}}
item_json: {{item_json}}`,outputPdfDir:"zotero/pdfs",outputNoteDir:"zotero/notes",chatOutputDir:"zotero/chats",chatPaneLocation:"right",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!0,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,ocrMode:"auto",chunkingMode:"page",maxChunkChars:4e3,chunkOverlapChars:250,removeImagePlaceholders:!0,ocrQualityThreshold:.5,enableLlmCleanup:!1,llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,enableFileLogging:!1,logFilePath:`${O}/logs/docling_extract.log`,createOcrLayeredPdf:!1,preferVaultPdfForCitations:!1},V=class extends w.PluginSettingTab{constructor(u,e){super(u,e),this.plugin=e}display(){let{containerEl:u}=this;u.empty(),u.createEl("h2",{text:"Zotero RAG Settings"}),new w.Setting(u).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(e=>e.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async n=>{this.plugin.settings.zoteroBaseUrl=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("Zotero user ID").setDesc("Use 0 for local library. You can also enter users/<id> or groups/<id>.").addText(e=>e.setPlaceholder("123456").setValue(this.plugin.settings.zoteroUserId).onChange(async n=>{this.plugin.settings.zoteroUserId=n.trim(),await this.plugin.saveSettings()})),u.createEl("h3",{text:"Zotero Web API (optional fallback)"}),new w.Setting(u).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(e=>e.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async n=>{this.plugin.settings.webApiBaseUrl=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(e=>e.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async n=>{this.plugin.settings.webApiLibraryType=n,await this.plugin.saveSettings()})),new w.Setting(u).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(e=>e.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async n=>{this.plugin.settings.webApiLibraryId=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(e=>e.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async n=>{this.plugin.settings.webApiKey=n.trim(),await this.plugin.saveSettings()})),u.createEl("h3",{text:"Prerequisites"}),new w.Setting(u).setName("Python environment").setDesc("Create or update the plugin's Python env (.venv in the plugin folder).").addButton(e=>{e.setButtonText("Create/Update").setCta(),e.onClick(async()=>{e.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{e.setDisabled(!1)}})}),new w.Setting(u).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack).").addText(e=>e.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async n=>{this.plugin.settings.dockerPath=n.trim()||"docker",await this.plugin.saveSettings()})),new w.Setting(u).setName("Redis URL").addText(e=>e.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async n=>{this.plugin.settings.redisUrl=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("Auto-assign Redis port").setDesc("When starting Redis Stack, pick a free local port and update the Redis URL.").addToggle(e=>e.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async n=>{this.plugin.settings.autoAssignRedisPort=n,await this.plugin.saveSettings()})),new w.Setting(u).setName("Auto-start Redis Stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker.").addToggle(e=>e.setValue(this.plugin.settings.autoStartRedis).onChange(async n=>{this.plugin.settings.autoStartRedis=n,await this.plugin.saveSettings()})),new w.Setting(u).setName("Start Redis Stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(e=>e.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()})),new w.Setting(u).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(e=>e.setValue(this.plugin.settings.copyPdfToVault).onChange(async n=>{this.plugin.settings.copyPdfToVault=n,!n&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new w.Setting(u).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(e=>{let n=this.plugin.settings.copyPdfToVault;e.setValue(n?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!n).onChange(async t=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=t,await this.plugin.saveSettings()})}),new w.Setting(u).setName("Frontmatter template").setDesc("Use {{doc_id}}, {{zotero_key}}, {{title}}, {{title_yaml}}, {{year}}, {{date}}, {{authors}}, {{authors_yaml}}, {{tags}}, {{item_type}}, {{pdf_link}}, {{item_json}}").addTextArea(e=>{e.inputEl.rows=8,e.setValue(this.plugin.settings.frontmatterTemplate).onChange(async n=>{this.plugin.settings.frontmatterTemplate=n,await this.plugin.saveSettings()})}),u.createEl("h3",{text:"Output folders (vault-relative)"}),new w.Setting(u).setName("PDF folder").addText(e=>e.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async n=>{this.plugin.settings.outputPdfDir=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("Notes folder").addText(e=>e.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async n=>{this.plugin.settings.outputNoteDir=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(e=>e.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async n=>{this.plugin.settings.chatOutputDir=n.trim()||"zotero/chats",await this.plugin.saveSettings()})),new w.Setting(u).setName("Prefer vault PDF for citations").setDesc("Use vault PDFs for citation links when available instead of Zotero deep links.").addToggle(e=>e.setValue(this.plugin.settings.preferVaultPdfForCitations).onChange(async n=>{this.plugin.settings.preferVaultPdfForCitations=n,await this.plugin.saveSettings()})),u.createEl("h3",{text:"Embeddings (LM Studio)"}),new w.Setting(u).setName("Embeddings base URL").addText(e=>e.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async n=>{this.plugin.settings.embedBaseUrl=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("Embeddings API key").addText(e=>e.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async n=>{this.plugin.settings.embedApiKey=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("Embeddings model").addText(e=>e.setPlaceholder("google/embedding-gemma-300m").setValue(this.plugin.settings.embedModel).onChange(async n=>{this.plugin.settings.embedModel=n.trim(),await this.plugin.saveSettings()})),u.createEl("h3",{text:"Chat LLM"}),new w.Setting(u).setName("Chat base URL").setDesc("OpenAI-compatible chat endpoint base URL").addText(e=>e.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async n=>{this.plugin.settings.chatBaseUrl=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("Chat API key").addText(e=>e.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async n=>{this.plugin.settings.chatApiKey=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("Chat model").addText(e=>e.setPlaceholder("meta-llama/llama-3.1-405b-instruct").setValue(this.plugin.settings.chatModel).onChange(async n=>{this.plugin.settings.chatModel=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("Temperature").addText(e=>e.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async n=>{let t=Number.parseFloat(n);this.plugin.settings.chatTemperature=Number.isFinite(t)?t:.2,await this.plugin.saveSettings()})),new w.Setting(u).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(e=>e.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async n=>{let t=Number.parseInt(n,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(t)?Math.max(0,t):6,await this.plugin.saveSettings()})),new w.Setting(u).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(e=>e.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async n=>{this.plugin.settings.chatPaneLocation=n,await this.plugin.saveSettings()})),u.createEl("h3",{text:"Docling"}),new w.Setting(u).setName("OCR mode").setDesc("auto: skip OCR when text is readable; force if bad: OCR only when text looks poor; force: always OCR.").addDropdown(e=>e.addOption("auto","auto").addOption("force_low_quality","force if quality is bad").addOption("force","force").setValue(this.plugin.settings.ocrMode).onChange(async n=>{this.plugin.settings.ocrMode=n,await this.plugin.saveSettings()})),new w.Setting(u).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(e=>{e.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async n=>{this.plugin.settings.ocrQualityThreshold=n,await this.plugin.saveSettings()})}),new w.Setting(u).setName("Chunking").setDesc("page or section").addDropdown(e=>e.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async n=>{this.plugin.settings.chunkingMode=n,await this.plugin.saveSettings()})),new w.Setting(u).setName("Section chunk max chars").setDesc("Split large section chunks into smaller pieces (section mode only).").addText(e=>e.setPlaceholder("3000").setValue(String(this.plugin.settings.maxChunkChars)).onChange(async n=>{let t=Number.parseInt(n,10);this.plugin.settings.maxChunkChars=Number.isFinite(t)?t:3e3,await this.plugin.saveSettings()})),new w.Setting(u).setName("Section chunk overlap chars").setDesc("Number of characters to overlap when splitting section chunks.").addText(e=>e.setPlaceholder("250").setValue(String(this.plugin.settings.chunkOverlapChars)).onChange(async n=>{let t=Number.parseInt(n,10);this.plugin.settings.chunkOverlapChars=Number.isFinite(t)?t:250,await this.plugin.saveSettings()})),new w.Setting(u).setName("Remove image placeholders").setDesc("Strip '<!-- image -->' tags before chunking.").addToggle(e=>e.setValue(this.plugin.settings.removeImagePlaceholders).onChange(async n=>{this.plugin.settings.removeImagePlaceholders=n,await this.plugin.saveSettings()})),u.createEl("h4",{text:"OCR cleanup (optional)"}),new w.Setting(u).setName("LLM cleanup for low-quality chunks").setDesc("Optional OpenAI-compatible cleanup for poor OCR. Can be slow/costly.").addToggle(e=>e.setValue(this.plugin.settings.enableLlmCleanup).onChange(async n=>{this.plugin.settings.enableLlmCleanup=n,await this.plugin.saveSettings()})),new w.Setting(u).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(e=>e.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async n=>{this.plugin.settings.llmCleanupBaseUrl=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(e=>e.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async n=>{this.plugin.settings.llmCleanupApiKey=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("LLM cleanup model").setDesc("Model to use for cleanup.").addText(e=>e.setPlaceholder("openai/gpt-oss-20b").setValue(this.plugin.settings.llmCleanupModel).onChange(async n=>{this.plugin.settings.llmCleanupModel=n.trim(),await this.plugin.saveSettings()})),new w.Setting(u).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(e=>e.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async n=>{let t=Number.parseFloat(n);this.plugin.settings.llmCleanupTemperature=Number.isFinite(t)?t:0,await this.plugin.saveSettings()})),new w.Setting(u).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(e=>e.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async n=>{this.plugin.settings.llmCleanupMinQuality=n,await this.plugin.saveSettings()})),new w.Setting(u).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(e=>e.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async n=>{let t=Number.parseInt(n,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(t)?t:2e3,await this.plugin.saveSettings()})),u.createEl("h3",{text:"Logging"}),new w.Setting(u).setName("Enable logging to file").setDesc("Write Docling/Python logs to a file during extraction.").addToggle(e=>e.setValue(this.plugin.settings.enableFileLogging).onChange(async n=>{this.plugin.settings.enableFileLogging=n,await this.plugin.saveSettings()})),new w.Setting(u).setName("Log file path (vault-relative)").setDesc("Where to write logs. Keep inside the vault.").addText(e=>e.setPlaceholder(`${O}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async n=>{this.plugin.settings.logFilePath=n.trim()||`${O}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new w.Setting(u).setName("View or clear log").setDesc("Open the log contents or clear the file.").addButton(e=>e.setButtonText("Open log").onClick(async()=>{var n,t;await((t=(n=this.plugin).openLogFile)==null?void 0:t.call(n))})).addButton(e=>e.setButtonText("Clear log").onClick(async()=>{var n,t;await((t=(n=this.plugin).clearLogFile)==null?void 0:t.call(n))})),u.createEl("h3",{text:"Maintenance"}),new w.Setting(u).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(e=>e.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new w.Setting(u).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(e=>e.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()}))}};var K={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var oe={"docling_extract.py":`#!/usr/bin/env python3
...
dir /data
`};var N=require("obsidian"),M="zotero-redisearch-rag-chat",Z=class extends N.ItemView{constructor(e,n){super(e);this.messages=[];this.activeSessionId="default";this.messageEls=new Map;this.pendingRender=new Map;this.busy=!1;this.plugin=n}getViewType(){return M}getDisplayText(){return"Zotero RAG Chat"}getIcon(){return"zrr-chat"}async onOpen(){let{containerEl:e}=this;e.empty(),e.addClass("zrr-chat-view");let n=e.createEl("div",{cls:"zrr-chat-header"});n.createEl("div",{cls:"zrr-chat-title",text:"Zotero RAG Chat"});let t=n.createEl("div",{cls:"zrr-chat-controls"}),i=t.createEl("div",{cls:"zrr-chat-controls-row"});this.sessionSelect=i.createEl("select",{cls:"zrr-chat-session"}),this.sessionSelect.addEventListener("change",async()=>{await this.switchSession(this.sessionSelect.value)});let r=t.createEl("div",{cls:"zrr-chat-controls-row zrr-chat-controls-actions"});this.renameButton=r.createEl("button",{cls:"zrr-chat-rename",text:"Rename",attr:{title:"Rename the current chat"}}),this.renameButton.addEventListener("click",async()=>{await this.promptRenameSession()}),this.copyButton=r.createEl("button",{cls:"zrr-chat-copy",text:"Copy",attr:{title:"Copy this chat to a new note"}}),this.copyButton.addEventListener("click",async()=>{await this.copyChatToNote()}),this.deleteButton=r.createEl("button",{cls:"zrr-chat-delete",text:"Delete",attr:{title:"Delete this chat"}}),this.deleteButton.addEventListener("click",async()=>{await this.deleteChat()}),this.newButton=r.createEl("button",{cls:"zrr-chat-new",text:"New chat",attr:{title:"Start a new chat session"}}),this.newButton.addEventListener("click",async()=>{await this.startNewChat()}),this.messagesEl=e.createEl("div",{cls:"zrr-chat-messages"});let a=e.createEl("div",{cls:"zrr-chat-input"});this.inputEl=a.createEl("textarea",{cls:"zrr-chat-textarea",attr:{placeholder:"Ask your Zotero library..."}}),this.sendButton=a.createEl("button",{cls:"zrr-chat-send",text:"Send"}),this.sendButton.addEventListener("click",()=>this.handleSend()),this.inputEl.addEventListener("keydown",s=>{s.key==="Enter"&&!s.shiftKey&&(s.preventDefault(),this.handleSend())}),await this.loadSessions(),await this.loadHistory(),await this.renderAll()}focusInput(){var e;(e=this.inputEl)==null||e.focus()}async loadHistory(){try{this.messages=await this.plugin.loadChatHistoryForSession(this.activeSessionId)}catch(e){console.error(e),this.messages=[]}}async saveHistory(){try{await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages),await this.loadSessions()}catch(e){console.error(e)}}async loadSessions(){let e=await this.plugin.listChatSessions();this.activeSessionId=await this.plugin.getActiveChatSessionId(),this.sessionSelect.empty();for(let n of e){let t=this.sessionSelect.createEl("option",{text:n.name});t.value=n.id,n.id===this.activeSessionId&&(t.selected=!0)}!e.some(n=>n.id===this.activeSessionId)&&e.length>0&&(this.activeSessionId=e[0].id,await this.plugin.setActiveChatSessionId(this.activeSessionId),this.sessionSelect.value=this.activeSessionId)}async promptRenameSession(){var i;let n=(await this.plugin.listChatSessions()).find(r=>r.id===this.activeSessionId);new Q(this.app,(i=n==null?void 0:n.name)!=null?i:"New chat",async r=>{await this.plugin.renameChatSession(this.activeSessionId,r),await this.loadSessions()}).open()}async startNewChat(){await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages,{force:!0});let e=await this.plugin.createChatSession("New chat");await this.switchSession(e,{skipSave:!0})}async deleteChat(){let e=await this.plugin.listChatSessions();if(e.length<=1){new N.Notice("You must keep at least one chat.");return}let n=e.find(i=>i.id===this.activeSessionId);if(!n)return;new Y(this.app,n.name,async()=>{await this.plugin.deleteChatSession(this.activeSessionId);let i=await this.plugin.getActiveChatSessionId();await this.switchSession(i,{skipSave:!0})}).open()}async switchSession(e,n={}){!e||e===this.activeSessionId||(n.skipSave||await this.saveHistory(),this.activeSessionId=e,await this.plugin.setActiveChatSessionId(e),await this.loadSessions(),await this.loadHistory(),await this.renderAll())}async renderAll(){this.messagesEl.empty(),this.messageEls.clear();for(let e of this.messages)await this.renderMessage(e);this.scrollToBottom()}async renderMessage(e){let n=this.messagesEl.createEl("div",{cls:`zrr-chat-message zrr-chat-${e.role}`});n.createEl("div",{cls:"zrr-chat-meta"}).setText(e.role==="user"?"You":"Assistant");let i=n.createEl("div",{cls:"zrr-chat-content"}),r=n.createEl("div",{cls:"zrr-chat-citations"});this.messageEls.set(e.id,{wrapper:n,content:i,citations:r}),await this.renderMessageContent(e)}scheduleRender(e){if(this.pendingRender.has(e.id))return;let n=window.setTimeout(async()=>{this.pendingRender.delete(e.id),await this.renderMessageContent(e),this.scrollToBottom()},80);this.pendingRender.set(e.id,n)}async renderMessageContent(e){var i,r,a;let n=this.messageEls.get(e.id);if(!n)return;let t=await this.plugin.formatInlineCitations(e.content||"",(i=e.citations)!=null?i:[],(r=e.retrieved)!=null?r:[]);n.content.dataset.lastRendered!==t&&(n.content.empty(),await N.MarkdownRenderer.renderMarkdown(t,n.content,"",this.plugin),this.hookInternalLinks(n.content),n.content.dataset.lastRendered=t),n.citations.empty(),await this.renderCitations(n.citations,(a=e.citations)!=null?a:[])}hookInternalLinks(e){let n=e.querySelectorAll("a.internal-link");for(let t of Array.from(n))t.dataset.zrrBound!=="1"&&(t.dataset.zrrBound="1",this.registerDomEvent(t,"click",i=>{i.preventDefault();let r=t.getAttribute("data-href")||t.getAttribute("href")||"";r&&this.plugin.openInternalLinkInMain(r)}))}async renderCitations(e,n){if(e.empty(),!n.length)return;let t=e.createEl("details",{cls:"zrr-chat-citations-details"});t.createEl("summary",{text:`Relevant context sources (${n.length})`,cls:"zrr-chat-citations-summary"});let i=t.createEl("ul",{cls:"zrr-chat-citation-list"});for(let r of n){let a=await this.plugin.resolveCitationDisplay(r),s=i.createEl("li");s.createEl("a",{text:a.noteTitle,href:"#"}).addEventListener("click",c=>{c.preventDefault(),a.notePath&&this.plugin.openNoteInMain(a.notePath)}),s.createEl("span",{text:", p. "}),s.createEl("a",{text:a.pageLabel,href:"#"}).addEventListener("click",c=>{if(c.preventDefault(),a.zoteroUrl){this.plugin.openExternalUrl(a.zoteroUrl);return}if(a.pdfPath){this.plugin.openPdfInMain(a.pdfPath,a.pageStart);return}this.plugin.openCitationTarget(r,a)})}}async copyChatToNote(){var i;let n=(await this.plugin.listChatSessions()).find(r=>r.id===this.activeSessionId),t=(i=n==null?void 0:n.name)!=null?i:"New chat";await this.plugin.createChatNoteFromSession(this.activeSessionId,t,this.messages)}scrollToBottom(){this.messagesEl.scrollTop=this.messagesEl.scrollHeight}async handleSend(){if(this.busy)return;let e=this.inputEl.value.trim();if(!e){new N.Notice("Query cannot be empty.");return}if(!this.plugin.settings.chatBaseUrl){new N.Notice("Chat base URL must be set in settings.");return}this.inputEl.value="",this.busy=!0,this.sendButton.disabled=!0;let n={id:this.generateId(),role:"user",content:e,createdAt:new Date().toISOString()};this.messages.push(n),await this.renderMessage(n),this.scrollToBottom(),await this.saveHistory();let t={id:this.generateId(),role:"assistant",content:"",citations:[],createdAt:new Date().toISOString()};this.messages.push(t),await this.renderMessage(t),this.scrollToBottom();let i=!1,r=this.plugin.getRecentChatHistory(this.messages.slice(0,-2));try{await this.plugin.runRagQueryStreaming(e,a=>{i=!0,t.content+=a,this.scheduleRender(t)},a=>{(!i&&(a!=null&&a.answer)||a!=null&&a.answer)&&(t.content=a.answer),Array.isArray(a==null?void 0:a.citations)&&(t.citations=a.citations),Array.isArray(a==null?void 0:a.retrieved)&&(t.retrieved=a.retrieved),this.scheduleRender(t)},r)}catch(a){console.error(a),t.content="Failed to fetch answer. See console for details.",this.scheduleRender(t)}finally{this.busy=!1,this.sendButton.disabled=!1,await this.saveHistory()}}generateId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}},Q=class extends N.Modal{constructor(u,e,n){super(u),this.initialValue=e,this.onSubmit=n}onOpen(){let{contentEl:u}=this;u.empty(),u.createEl("h3",{text:"Rename chat"});let e=this.initialValue;new N.Setting(u).setName("Name").addText(r=>{r.setValue(e),r.onChange(a=>{e=a})});let n=u.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="1rem",n.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),n.createEl("button",{text:"Save"}).addEventListener("click",()=>{let r=e.trim();if(!r){new N.Notice("Name cannot be empty.");return}this.close(),this.onSubmit(r)})}},Y=class extends N.Modal{constructor(u,e,n){super(u),this.chatName=e,this.onConfirm=n}onOpen(){let{contentEl:u}=this;u.empty(),u.createEl("h3",{text:"Delete chat"}),u.createEl("p",{text:`Delete "${this.chatName}"? This cannot be undone.`});let e=u.createEl("div");e.style.display="flex",e.style.gap="0.5rem",e.style.marginTop="1rem",e.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),e.createEl("button",{text:"Delete"}).addEventListener("click",()=>{this.close(),this.onConfirm()})}};var le=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],ce={en:"eng",de:"deu",fr:"fra",es:"spa",it:"ita",nl:"nld",pt:"por",pl:"pol",sv:"swe"},be=K["zrr-picker"],we=K["zrr-chat"],W=class extends d.Modal{constructor(u,e,n,t,i="Value cannot be empty."){super(u),this.titleText=e,this.placeholder=n,this.onSubmit=t,this.emptyMessage=i}onOpen(){let{contentEl:u}=this;u.empty(),u.createEl("h3",{text:this.titleText});let e=u.createEl("input",{type:"text",placeholder:this.placeholder});e.style.width="100%",e.focus();let n=u.createEl("button",{text:"Submit"});n.style.marginTop="0.75rem";let t=()=>{let i=e.value.trim();if(!i){new d.Notice(this.emptyMessage);return}this.close(),this.onSubmit(i)};n.addEventListener("click",t),e.addEventListener("keydown",i=>{i.key==="Enter"&&t()})}},ee=class extends d.Modal{constructor(u,e,n){super(u),this.titleText=e,this.bodyText=n}onOpen(){let{contentEl:u}=this;u.empty(),u.createEl("h3",{text:this.titleText}),u.createEl("pre").setText(this.bodyText)}},ne=class extends d.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.filePath=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Overwrite"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},te=class extends d.SuggestModal{constructor(e,n){super(e);this.resolved=!1;this.resolveSelection=n,this.setPlaceholder("Select a language for OCR/quality...")}getSuggestions(e){let n=e.trim().toLowerCase();return n?le.filter(t=>t.label.toLowerCase().includes(n)||t.value.toLowerCase().includes(n)):le}renderSuggestion(e,n){n.setText(e.label),n.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new W(this.app,"Custom language hint","e.g., en, de, fr, de,en",n=>this.resolveSelection(n.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},J=class extends d.Plugin{constructor(){super(...arguments);this.docIndex=null;this.lastPythonEnvNotice=null;this.lastContainerNotice=null}async onload(){await this.loadSettings(),await this.migrateCachePaths(),this.addSettingTab(new V(this.app,this)),this.registerRibbonIcons(),this.registerView(M,e=>new Z(e,this)),this.setupStatusBar(),this.registerNoteRenameHandler();try{await this.ensureBundledTools()}catch(e){console.error("Failed to sync bundled tools",e)}this.addCommand({id:"import-zotero-item-index",name:"Import Zotero item and index (Docling -> RedisSearch)",callback:()=>this.importZoteroItem()}),this.addCommand({id:"ask-zotero-library",name:"Ask my Zotero library (RAG via RedisSearch)",callback:()=>this.askZoteroLibrary()}),this.addCommand({id:"open-zotero-chat",name:"Open Zotero RAG chat panel",callback:()=>this.openChatView(!0)}),this.addCommand({id:"rebuild-zotero-note-cache",name:"Rebuild Zotero note from cache (Docling + RedisSearch)",callback:()=>this.rebuildNoteFromCache()}),this.addCommand({id:"rebuild-doc-index-cache",name:"Rebuild doc index from cache",callback:()=>this.rebuildDocIndexFromCache()}),this.addCommand({id:"recreate-missing-notes-cache",name:"Recreate missing notes from cache (Docling + RedisSearch)",callback:()=>this.recreateMissingNotesFromCache()}),this.addCommand({id:"reindex-redis-from-cache",name:"Reindex Redis from cached chunks",callback:()=>this.reindexRedisFromCache()}),this.addCommand({id:"start-redis-stack",name:"Start Redis Stack (Docker/Podman Compose)",callback:()=>this.startRedisStack()}),this.autoDetectContainerCliOnLoad(),this.settings.autoStartRedis&&this.startRedisStack(!0)}async loadSettings(){this.settings=Object.assign({},se,await this.loadData())}async saveSettings(){await this.saveData(this.settings)}async importZoteroItem(){var T,C,D;try{await this.ensureBundledTools()}catch(y){new d.Notice("Failed to sync bundled tools. See console for details."),console.error(y);return}let e;try{e=await this.promptZoteroItem()}catch(y){new d.Notice("Zotero search failed. See console for details."),console.error(y);return}if(!e){new d.Notice("No Zotero item selected.");return}let n=(T=e.data)!=null?T:e;!n.key&&e.key&&(n.key=e.key);let t=this.getDocId(n);if(!t){new d.Notice("Could not resolve a stable doc_id from Zotero item.");return}let i=await this.resolveLanguageHint(n,(C=e.key)!=null?C:n.key),r=this.buildDoclingLanguageHint(i!=null?i:void 0),a=await this.resolvePdfAttachment(n,t);if(!a){new d.Notice("No PDF attachment found for item.");return}this.showStatusProgress("Preparing...",5);let s=typeof n.title=="string"?n.title:"",o=await this.getDocIndexEntry(t);o&&new d.Notice("Item already indexed. Updating cached files and index.");let l=this.sanitizeFileName(s)||t;if(o!=null&&o.note_path)l=f.default.basename(o.note_path,".md")||l;else if(o!=null&&o.pdf_path){let y=this.toVaultRelativePath(o.pdf_path);y&&y.startsWith((0,d.normalizePath)(this.settings.outputPdfDir))&&(l=f.default.basename(y,".pdf")||l)}let c=o?l:await this.resolveUniqueBaseName(l,t),p=(0,d.normalizePath)(`${this.settings.outputPdfDir}/${c}.pdf`),h=(0,d.normalizePath)(`${q}/${t}.json`),g=(0,d.normalizePath)(`${I}/${t}.json`),m=this.app.vault.adapter,_=(0,d.normalizePath)(`${this.settings.outputNoteDir}/${c}.md`);if(o!=null&&o.note_path&&await m.exists(o.note_path)&&(_=(0,d.normalizePath)(o.note_path)),await m.exists(_)&&!await this.confirmOverwrite(_)){new d.Notice("Import canceled.");return}try{if(await this.ensureFolder(q),await this.ensureFolder(I),await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let y=this.getLogFileRelativePath(),A=(0,d.normalizePath)(f.default.dirname(y));A&&await this.ensureFolder(A);let $=this.getSpellcheckerInfoRelativePath(),v=(0,d.normalizePath)(f.default.dirname($));v&&await this.ensureFolder(v)}}catch(y){new d.Notice("Failed to create output folders."),console.error(y),this.clearStatusProgress();return}let b="",k="";try{if(this.settings.copyPdfToVault){let y=a.filePath?await R.promises.readFile(a.filePath):await this.downloadZoteroPdf(a.key);await this.app.vault.adapter.writeBinary(p,this.bufferToArrayBuffer(y)),b=this.getAbsoluteVaultPath(p)}else if(a.filePath)b=a.filePath;else{await this.ensureFolder(this.settings.outputPdfDir);let y=await this.downloadZoteroPdf(a.key);await this.app.vault.adapter.writeBinary(p,this.bufferToArrayBuffer(y)),b=this.getAbsoluteVaultPath(p),new d.Notice("Local PDF path unavailable; copied PDF into vault for processing.")}k=this.buildPdfLinkForNote(b,a.key,t)}catch(y){new d.Notice("Failed to download PDF attachment."),console.error(y),this.clearStatusProgress();return}try{await this.app.vault.adapter.write(h,JSON.stringify(e,null,2))}catch(y){new d.Notice("Failed to write Zotero item JSON."),console.error(y),this.clearStatusProgress();return}let P=this.getPluginDir(),x=f.default.join(P,"tools","docling_extract.py"),S=f.default.join(P,"tools","index_redisearch.py"),E=null;try{E=await this.readDoclingQualityLabelFromPdf(b,r),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",E),0),await this.runPythonStreaming(x,this.buildDoclingArgs(b,t,g,_,r,!0),$=>this.handleDoclingProgress($,E),()=>{}),E=await this.readDoclingQualityLabel(g),await this.annotateChunkJsonWithAttachmentKey(g,a.key);let y=await this.readDoclingMetadata(g),A=await this.maybeCreateOcrLayeredPdf(b,y,r);A&&(b=A,k=this.buildPdfLinkFromSourcePath(A),await this.updateChunkJsonSourcePdf(g,A))}catch(y){new d.Notice("Docling extraction failed. See console for details."),console.error(y),this.clearStatusProgress();return}try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",E),0),await this.runPythonStreaming(S,["--chunks-json",this.getAbsoluteVaultPath(g),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--progress"],y=>{if((y==null?void 0:y.type)==="progress"&&y.total){let A=Math.round(y.current/y.total*100),$=this.formatStatusLabel(`Indexing chunks ${y.current}/${y.total}`,E);this.showStatusProgress($,A)}},()=>{})}catch(y){new d.Notice("RedisSearch indexing failed. See console for details."),console.error(y),this.clearStatusProgress();return}try{let y=await this.app.vault.adapter.read(_),A=this.buildNoteMarkdown(n,(D=e.meta)!=null?D:{},t,k,h,y);await this.app.vault.adapter.write(_,A)}catch(y){new d.Notice("Failed to finalize note markdown."),console.error(y),this.clearStatusProgress();return}try{await this.updateDocIndex({doc_id:t,note_path:_,note_title:c,zotero_title:s,pdf_path:b,attachment_key:a.key})}catch(y){console.error("Failed to update doc index",y)}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new d.Notice(`Indexed Zotero item ${t}.`)}async askZoteroLibrary(){await this.openChatView(!0)}getChatLeaf(){var n;let e=this.app.workspace.getLeavesOfType(M);return e.length>0?e[0]:this.settings.chatPaneLocation==="right"?(n=this.app.workspace.getRightLeaf(!1))!=null?n:this.app.workspace.getLeaf("split"):this.app.workspace.getLeaf("tab")}async openChatView(e=!1){let n=this.getChatLeaf();await n.setViewState({type:M,active:!0}),this.app.workspace.revealLeaf(n);let t=n.view;return t instanceof Z&&e&&t.focusInput(),t}async loadChatHistory(){let e=await this.getActiveChatSessionId();return this.loadChatHistoryForSession(e)}async saveChatHistory(e){let n=await this.getActiveChatSessionId();await this.saveChatHistoryForSession(n,e)}getChatSessionsDir(){return(0,d.normalizePath)(`${O}/chats`)}getChatExportDir(){let e=(this.settings.chatOutputDir||"").trim();return e?(0,d.normalizePath)(e):(0,d.normalizePath)("zotero/chats")}getChatSessionsIndexPath(){return(0,d.normalizePath)(`${this.getChatSessionsDir()}/index.json`)}getChatSessionPath(e){return(0,d.normalizePath)(`${this.getChatSessionsDir()}/${e}.json`)}async listChatSessions(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath();if(!await e.exists(n)){let t=new Date().toISOString(),i=[{id:"default",name:"New chat",createdAt:t,updatedAt:t}];return await this.writeChatSessionsIndex({version:1,active:"default",sessions:i}),i}try{let t=await e.read(n),i=JSON.parse(t);return(Array.isArray(i==null?void 0:i.sessions)?i.sessions:[]).filter(a=>a&&typeof a.id=="string").map(a=>({id:String(a.id),name:typeof a.name=="string"&&a.name.trim()?a.name.trim():String(a.id),createdAt:typeof a.createdAt=="string"?a.createdAt:new Date().toISOString(),updatedAt:typeof a.updatedAt=="string"?a.updatedAt:new Date().toISOString()}))}catch(t){return console.warn("Failed to read chat sessions index",t),[]}}async getActiveChatSessionId(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath();if(!await e.exists(n))return"default";try{let t=await e.read(n),i=JSON.parse(t);return(typeof(i==null?void 0:i.active)=="string"?i.active:"default")||"default"}catch(t){return"default"}}async setActiveChatSessionId(e){var a,s;await this.migrateLegacyChatHistory();let n=await this.readChatSessionsIndex(),t=((a=n.sessions)!=null?a:[]).some(o=>o.id===e),i=new Date().toISOString(),r=t?n.sessions:[...(s=n.sessions)!=null?s:[],{id:e,name:e,createdAt:i,updatedAt:i}];await this.writeChatSessionsIndex({version:1,active:e,sessions:r})}async createChatSession(e){var s;await this.migrateLegacyChatHistory();let n=this.generateChatId(),t=new Date().toISOString(),i=(e||"").trim()||"New chat",a=[...(s=(await this.readChatSessionsIndex()).sessions)!=null?s:[],{id:n,name:i,createdAt:t,updatedAt:t}];return await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionPath(n),JSON.stringify({version:1,messages:[]},null,2)),await this.writeChatSessionsIndex({version:1,active:n,sessions:a}),n}async renameChatSession(e,n){var a,s;await this.migrateLegacyChatHistory();let t=(n||"").trim();if(!t)return;let i=await this.readChatSessionsIndex(),r=((a=i.sessions)!=null?a:[]).map(o=>o.id===e?{...o,name:t}:o);await this.writeChatSessionsIndex({version:1,active:(s=i.active)!=null?s:"default",sessions:r})}async deleteChatSession(e){var s;if(await this.migrateLegacyChatHistory(),!e)return;let n=this.app.vault.adapter,t=await this.readChatSessionsIndex(),i=(s=t.sessions)!=null?s:[];if(i.length<=1)return;let r=i.filter(o=>o.id!==e);if(!r.length)return;let a=t.active===e?r[0].id:t.active;try{await n.remove(this.getChatSessionPath(e))}catch(o){console.warn("Failed to delete chat session file",o)}await this.writeChatSessionsIndex({version:1,active:a,sessions:r})}async loadChatHistoryForSession(e){await this.migrateLegacyChatHistory();let n=this.app.vault.adapter,t=this.getChatSessionPath(e||"default");if(!await n.exists(t))return[];let i=await n.read(t),r;try{r=JSON.parse(i)}catch(s){return[]}let a=Array.isArray(r)?r:r==null?void 0:r.messages;return Array.isArray(a)?a.filter(s=>s&&typeof s.content=="string").map(s=>({id:s.id||this.generateChatId(),role:s.role==="assistant"?"assistant":"user",content:s.content,citations:Array.isArray(s.citations)?s.citations:[],retrieved:Array.isArray(s.retrieved)?s.retrieved:[],createdAt:s.createdAt||new Date().toISOString()})):[]}async saveChatHistoryForSession(e,n){var l,c;await this.migrateLegacyChatHistory(),await this.ensureFolder(this.getChatSessionsDir());let t=this.app.vault.adapter,i=this.getChatSessionPath(e||"default"),r={version:1,messages:n};await t.write(i,JSON.stringify(r,null,2));let a=await this.readChatSessionsIndex(),s=new Date().toISOString(),o=((l=a.sessions)!=null?l:[]).map(p=>p.id===e?{...p,updatedAt:s}:p);await this.writeChatSessionsIndex({version:1,active:(c=a.active)!=null?c:e,sessions:o})}getRecentChatHistory(e){let n=Math.max(0,this.settings.chatHistoryMessages||0);return n?e.filter(i=>{var r;return i&&((r=i.content)==null?void 0:r.trim())}).slice(-n):[]}async readChatSessionsIndex(){let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath(),t=new Date().toISOString();if(!await e.exists(n))return{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:t,updatedAt:t}]};try{let i=await e.read(n),r=JSON.parse(i),a=Array.isArray(r==null?void 0:r.sessions)?r.sessions:[];return{version:1,active:typeof(r==null?void 0:r.active)=="string"?r.active:"default",sessions:a.map(s=>({id:String(s.id),name:typeof s.name=="string"&&s.name.trim()?s.name.trim():String(s.id),createdAt:typeof s.createdAt=="string"?s.createdAt:t,updatedAt:typeof s.updatedAt=="string"?s.updatedAt:t}))}}catch(i){return console.warn("Failed to parse chat sessions index",i),{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:t,updatedAt:t}]}}}async writeChatSessionsIndex(e){await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionsIndexPath(),JSON.stringify(e,null,2))}async migrateLegacyChatHistory(){let e=this.app.vault.adapter,n=(0,d.normalizePath)(`${O}/chat.json`),t=this.getChatSessionsDir(),i=this.getChatSessionsIndexPath(),r=this.getChatSessionPath("default"),a=await e.exists(n),s=await e.exists(r),o=await e.exists(i);if(!a&&o)return;let l=new Date().toISOString();if(await this.ensureFolder(t),a&&!s)try{await e.rename(n,r)}catch(c){try{let p=await e.read(n);await e.write(r,p),await e.remove(n)}catch(p){console.warn("Failed to migrate legacy chat history",p)}}if(!o){let c=[{id:"default",name:"New chat",createdAt:l,updatedAt:l}];await this.writeChatSessionsIndex({version:1,active:"default",sessions:c})}if(o)try{let c=await e.read(i),p=JSON.parse(c),h=Array.isArray(p==null?void 0:p.sessions)?p.sessions:[],g=h.some(_=>(_==null?void 0:_.id)==="default"),m=h.map(_=>(_==null?void 0:_.id)==="default"&&typeof(_==null?void 0:_.name)=="string"&&_.name.trim().toLowerCase()==="default"?{..._,name:"New chat"}:_);g&&JSON.stringify(m)!==JSON.stringify(h)&&await this.writeChatSessionsIndex({version:1,active:typeof(p==null?void 0:p.active)=="string"?p.active:"default",sessions:m.map(_=>({id:String(_.id),name:typeof _.name=="string"?_.name:"New chat",createdAt:typeof _.createdAt=="string"?_.createdAt:l,updatedAt:typeof _.updatedAt=="string"?_.updatedAt:l}))})}catch(c){}}isPlaceholderChatName(e){let n=(e||"").trim().toLowerCase();return n==="new chat"||n==="default"}normalizeChatTitle(e){let n=(e||"").replace(/\s+/g," ").trim();return n.length>60?`${n.slice(0,57)}...`:n}guessTitleFromMessages(e){let n=e.find(i=>i.role==="user"&&i.content.trim());if(!n)return"New chat";let t=n.content.replace(/\s+/g," ").trim().split(" ").slice(0,8).join(" ");return this.normalizeChatTitle(t||"New chat")}async suggestChatTitleWithLlm(e){var i,r,a;let n=(this.settings.chatBaseUrl||"").trim(),t=(this.settings.chatModel||"").trim();if(!n||!t)return null;try{let s=`${n.replace(/\/$/,"")}/chat/completions`,o={"Content-Type":"application/json"};this.settings.chatApiKey&&(o.Authorization=`Bearer ${this.settings.chatApiKey}`);let l=e.slice(-8).map(m=>`${m.role.toUpperCase()}: ${m.content}`).join(`
`).slice(0,4e3),p=await fetch(s,{method:"POST",headers:o,body:JSON.stringify({model:t,temperature:.2,messages:[{role:"system",content:"Generate a short, specific title (3-7 words) for the chat. No quotes, no punctuation at the end."},{role:"user",content:l}]})});if(!p.ok)return null;let h=await p.json(),g=(a=(r=(i=h==null?void 0:h.choices)==null?void 0:i[0])==null?void 0:r.message)==null?void 0:a.content;return typeof g!="string"?null:this.normalizeChatTitle(g.replace(/^\"|\"$/g,"").trim())}catch(s){return console.warn("Chat title suggestion failed",s),null}}async finalizeChatSessionNameIfNeeded(e,n,t={}){var c;if(!e)return;let i=n||[];if(!i.some(p=>p.role==="user"&&p.content.trim())||!t.force&&i.length<4)return;let s=((c=(await this.readChatSessionsIndex()).sessions)!=null?c:[]).find(p=>p.id===e);if(!s||!this.isPlaceholderChatName(s.name))return;let l=await this.suggestChatTitleWithLlm(i)||this.guessTitleFromMessages(i);!l||this.isPlaceholderChatName(l)||await this.renameChatSession(e,l)}async runRagQueryStreaming(e,n,t,i=[]){await this.ensureBundledTools();let r=this.getPluginDir(),a=f.default.join(r,"tools","rag_query_redisearch.py"),s=["--query",e,"--k","5","--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--chat-base-url",this.settings.chatBaseUrl,"--chat-api-key",this.settings.chatApiKey,"--chat-model",this.settings.chatModel,"--temperature",String(this.settings.chatTemperature),"--stream"],o=this.buildChatHistoryPayload(i),l=await this.writeChatHistoryTemp(o);l!=null&&l.absolutePath&&s.push("--history-file",l.absolutePath);try{await this.runPythonStreaming(a,s,c=>{if((c==null?void 0:c.type)==="delta"&&typeof c.content=="string"){n(c.content);return}if((c==null?void 0:c.type)==="final"){t(c);return}c!=null&&c.answer&&t(c)},t)}finally{if(l!=null&&l.relativePath)try{await this.app.vault.adapter.remove(l.relativePath)}catch(c){console.warn("Failed to remove chat history temp file",c)}}}buildChatHistoryPayload(e){return this.getRecentChatHistory(e).map(t=>({role:t.role,content:t.content}))}async writeChatHistoryTemp(e){if(!e.length)return null;let n=(0,d.normalizePath)(`${O}/tmp`);await this.ensureFolder(n);let t=`chat_history_${Date.now()}_${Math.random().toString(36).slice(2,8)}.json`,i=(0,d.normalizePath)(`${n}/${t}`),r={version:1,messages:e};return await this.app.vault.adapter.write(i,JSON.stringify(r,null,2)),{relativePath:i,absolutePath:this.getAbsoluteVaultPath(i)}}async resolveCitationDisplay(e){var h,g;let n=await this.getDocIndexEntry(e.doc_id);(!n||!n.note_title||!n.zotero_title||!n.note_path||!n.pdf_path)&&(n=await this.hydrateDocIndexFromCache(e.doc_id));let t=e.doc_id?await this.resolveNotePathForDocId(e.doc_id):n==null?void 0:n.note_path,i=(n==null?void 0:n.zotero_title)||(n==null?void 0:n.note_title)||(t?f.default.basename(t,".md"):e.doc_id||"?"),r=e.pages||`${(h=e.page_start)!=null?h:"?"}-${(g=e.page_end)!=null?g:"?"}`,a=r.includes("-")?r.replace("-"," - "):r,s=e.page_start?String(e.page_start):"",o=(n==null?void 0:n.pdf_path)||e.source_pdf||"",l=e.attachment_key||(n==null?void 0:n.attachment_key),c=e.annotation_key||this.extractAnnotationKey(e.chunk_id),p=e.doc_id?this.buildZoteroDeepLink(e.doc_id,l,s,c):void 0;return this.settings.preferVaultPdfForCitations&&o&&this.toVaultRelativePath(o)&&(p=void 0),{noteTitle:i,pageLabel:a,notePath:t||void 0,pdfPath:o||void 0,zoteroUrl:p,pageStart:s||void 0}}async formatInlineCitations(e,n,t=[]){if(!e)return e;let i=/\[\[?cite:([A-Za-z0-9]+):([^\]\n]+?)\]?\]/g,r=Array.from(e.matchAll(i));if(r.length===0)return e;let a=new Map;for(let o of r){let l=o[0];if(a.has(l))continue;let c=o[1],p=o[2].trim(),h=p.match(/^(\d+)-(\d+)(?::([A-Za-z0-9]+))?$/),g="",m="",_,b;h?(g=h[1],m=h[2],_=h[3]):b=p;let k=b?t.find(C=>{let D=typeof C.doc_id=="string"?C.doc_id:"";if(D&&D!==c)return!1;let y=typeof C.chunk_id=="string"?C.chunk_id:"";return y?y===b||y===`${c}:${b}`||y.endsWith(`:${b}`):!1}):void 0;k&&(!g&&k.page_start!==void 0&&(g=String(k.page_start)),!m&&k.page_end!==void 0&&(m=String(k.page_end)),!_&&typeof k.chunk_id=="string"&&(_=this.extractAnnotationKey(k.chunk_id)));let P={doc_id:c,chunk_id:k==null?void 0:k.chunk_id,annotation_key:_};(g||m)&&(P.page_start=g||m,P.page_end=m||g,P.pages=`${P.page_start}-${P.page_end}`),k!=null&&k.source_pdf&&(P.source_pdf=String(k.source_pdf));let x=(g||m?n.find(C=>{var D,y;return C.doc_id===c&&String((D=C.page_start)!=null?D:"")===g&&String((y=C.page_end)!=null?y:"")===m}):void 0)||n.find(C=>C.doc_id===c)||P;!x.annotation_key&&_&&(x={...x,annotation_key:_});let S=await this.resolveCitationDisplay(x),E=`${S.noteTitle} p. ${S.pageLabel}`,T=this.settings.preferVaultPdfForCitations?this.buildVaultPdfCitationLink(S.pdfPath||"",S.pageStart,E):"";if(T)a.set(l,T);else if(S.zoteroUrl)a.set(l,`[${E}](${S.zoteroUrl})`);else{let C=S.pageLabel?`${c} p. ${S.pageLabel}`:`${c}`;a.set(l,`(${C})`)}}let s=e;for(let[o,l]of a)s=s.split(o).join(l);return s}handleDoclingProgress(e,n){if(!e||e.type!=="progress")return;let t=Number(e.percent);if(!Number.isFinite(t))return;let i=typeof e.message=="string"&&e.message.trim()?e.message:"Docling extraction...";this.showStatusProgress(this.formatStatusLabel(i,n),Math.round(t))}async createChatNoteFromSession(e,n,t){let i=this.getChatExportDir();await this.ensureFolder(i),await this.getDocIndex();let r=this.sanitizeFileName(n)||"Zotero Chat",a=this.formatTimestamp(new Date),s=(0,d.normalizePath)(`${i}/${r}.md`),o=await this.resolveUniqueNotePath(s,`${r}-${a}.md`),l=await this.buildChatTranscript(n,t);await this.app.vault.adapter.write(o,l),await this.openNoteInNewTab(o),new d.Notice(`Chat copied to ${o}`)}async buildChatTranscript(e,n){var i,r,a;let t=[];t.push(`# ${e||"Zotero Chat"}`),t.push(""),t.push(`Created: ${new Date().toISOString()}`),t.push("");for(let s of n){let o=s.role==="user"?"## You":"## Assistant";t.push(o),t.push("");let l=s.role==="assistant"?await this.formatInlineCitations(s.content||"",(i=s.citations)!=null?i:[],(r=s.retrieved)!=null?r:[]):s.content||"";if(t.push(l.trim()),t.push(""),s.role==="assistant"&&((a=s.citations)!=null&&a.length)){t.push("### Relevant context sources");let c=this.formatCitationsMarkdown(s.citations);c&&(t.push(c),t.push(""))}}return t.join(`
`).trim()+`
`}async resolveUniqueNotePath(e,n){let t=this.app.vault.adapter;if(!await t.exists(e))return e;let i=f.default.dirname(e),r=(0,d.normalizePath)(f.default.join(i,n));if(!await t.exists(r))return r;let a=2;for(;a<1e3;){let s=(0,d.normalizePath)(f.default.join(i,`${f.default.basename(n,".md")}-${a}.md`));if(!await t.exists(s))return s;a+=1}return r}formatTimestamp(e){let n=t=>String(t).padStart(2,"0");return[e.getFullYear(),n(e.getMonth()+1),n(e.getDate()),"-",n(e.getHours()),n(e.getMinutes())].join("")}async openCitationTarget(e,n){let t=n!=null?n:await this.resolveCitationDisplay(e);if(t.notePath){await this.openNoteInMain(t.notePath);return}if(!(t.pdfPath&&await this.openPdfInMain(t.pdfPath,t.pageStart))){if(t.zoteroUrl){this.openExternalUrl(t.zoteroUrl);return}new d.Notice("Unable to open citation target.")}}async rebuildNoteFromCache(){let e=await this.promptDocId();if(!e){new d.Notice("No doc_id provided.");return}await this.rebuildNoteFromCacheForDocId(e,!0)&&new d.Notice(`Rebuilt Zotero note for ${e}.`)}async rebuildDocIndexFromCache(){var l,c,p;let e=this.app.vault.adapter,n=await this.listDocIds(q),t=await this.listDocIds(I),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),r=Object.keys(i),a=Array.from(new Set([...n,...t,...r]));if(a.length===0){new d.Notice("No cached items found.");return}this.showStatusProgress("Rebuilding doc index...",0);let s=await this.getDocIndex(),o=0;for(let h of a){o+=1;let g={},m=i[h];m&&(g.note_path=m.note_path,g.note_title=m.note_title);let _=(0,d.normalizePath)(`${q}/${h}.json`);if(await e.exists(_))try{let P=await e.read(_),x=JSON.parse(P),S=(c=(l=x==null?void 0:x.data)!=null?l:x)!=null?c:{},E=typeof S.title=="string"?S.title:"";E&&(g.zotero_title=E);let T=this.sanitizeFileName(E)||h,C=(0,d.normalizePath)(`${this.settings.outputNoteDir}/${T}.md`),D=(0,d.normalizePath)(`${this.settings.outputNoteDir}/${T}-${h}.md`);await e.exists(C)?(g.note_path=C,g.note_title=f.default.basename(C,".md")):await e.exists(D)&&(g.note_path=D,g.note_title=f.default.basename(D,".md"))}catch(P){console.error("Failed to read cached item JSON",P)}let b=(0,d.normalizePath)(`${I}/${h}.json`);if(await e.exists(b))try{let P=await e.read(b),x=JSON.parse(P);typeof(x==null?void 0:x.source_pdf)=="string"&&(g.pdf_path=x.source_pdf)}catch(P){console.error("Failed to read cached chunks JSON",P)}if(Object.keys(g).length>0){let x={...(p=s[h])!=null?p:{doc_id:h},...g,doc_id:h,updated_at:new Date().toISOString()};!x.note_title&&x.note_path&&(x.note_title=f.default.basename(x.note_path,".md")),s[h]=x}let k=Math.round(o/a.length*100);this.showStatusProgress(`Rebuilding doc index ${o}/${a.length}`,k)}await this.saveDocIndex(s),this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new d.Notice(`Rebuilt doc index for ${a.length} items.`)}async recreateMissingNotesFromCache(){let e=this.app.vault.adapter,n=await this.listDocIds(q),t=await this.listDocIds(I),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),r=Object.keys(i),a=Array.from(new Set([...n,...t,...r]));if(a.length===0){new d.Notice("No cached items found.");return}let s=[];for(let l of a){if(i[l])continue;let c=await this.getDocIndexEntry(l);if(c!=null&&c.note_path&&await e.exists(c.note_path))continue;let p=await this.inferNotePathFromCache(l);p&&await e.exists(p)||s.push(l)}if(s.length===0){new d.Notice("No missing notes detected.");return}this.showStatusProgress("Recreating missing notes...",0);let o=0;for(let l=0;l<s.length;l+=1){let c=s[l],p=Math.round((l+1)/s.length*100);this.showStatusProgress(`Recreating ${l+1}/${s.length}`,p),await this.rebuildNoteFromCacheForDocId(c,!1)&&(o+=1)}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new d.Notice(`Recreated ${o}/${s.length} missing notes.`)}async reindexRedisFromCache(){try{await this.ensureBundledTools()}catch(a){new d.Notice("Failed to sync bundled tools. See console for details."),console.error(a);return}let e=await this.listDocIds(I);if(e.length===0){new d.Notice("No cached chunks found.");return}let n=this.getPluginDir(),t=f.default.join(n,"tools","index_redisearch.py"),i=0,r=0;this.showStatusProgress("Reindexing cached chunks...",0);for(let a of e){i+=1;let s=Math.round(i/e.length*100);this.showStatusProgress(`Reindexing ${i}/${e.length}`,s);let o=(0,d.normalizePath)(`${I}/${a}.json`);try{await this.runPython(t,["--chunks-json",this.getAbsoluteVaultPath(o),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert"])}catch(l){r+=1,console.error(`Failed to reindex ${a}`,l)}}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),r===0?new d.Notice(`Reindexed ${e.length} cached items.`):new d.Notice(`Reindexed ${e.length-r}/${e.length} items (see console).`)}async promptZoteroItem(){return new Promise(e=>{new ie(this.app,this,e).open()})}async listDocIds(e){let n=this.app.vault.adapter,t=(0,d.normalizePath)(e);return await n.exists(t)?(await n.list(t)).files.filter(r=>r.endsWith(".json")).map(r=>f.default.basename(r,".json")):[]}async listMarkdownFiles(e){let n=this.app.vault.adapter,t=(0,d.normalizePath)(e);if(!await n.exists(t))return[];let i=[t],r=[];for(;i.length>0;){let a=i.pop();if(!a)continue;let s=await n.list(a);for(let o of s.files)o.endsWith(".md")&&r.push(o);for(let o of s.folders)i.push(o)}return r}extractDocIdFromFrontmatter(e){let n=e.match(/^---\s*\n([\s\S]*?)\n---/);if(!n)return null;let i=n[1].split(/\r?\n/);for(let r of i){let a=r.trim();if(!a||a.startsWith("#"))continue;let s=a.split(":");if(s.length<2)continue;let o=s[0].trim().toLowerCase();if(o!=="doc_id"&&o!=="zotero_key")continue;let c=a.slice(a.indexOf(":")+1).trim().replace(/^["']|["']$/g,"").trim();if(c)return c}return null}async scanNotesForDocIds(e){let n=this.app.vault.adapter,t=await this.listMarkdownFiles(e),i={};for(let r of t)try{let a=await n.read(r),s=this.extractDocIdFromFrontmatter(a);if(!s)continue;i[s]={doc_id:s,note_path:r,note_title:f.default.basename(r,".md"),updated_at:new Date().toISOString()}}catch(a){console.error("Failed to read note for doc_id scan",a)}return i}setupStatusBar(){let e=this.addStatusBarItem();e.addClass("zrr-status-progress"),e.addClass("status-bar-item-segment"),e.style.display="none";let n=e.createEl("span",{text:"Idle"});n.addClass("zrr-status-label");let i=e.createEl("div",{cls:"zrr-status-bar"}).createEl("div",{cls:"zrr-status-bar-inner"});this.statusBarEl=e,this.statusLabelEl=n,this.statusBarInnerEl=i}showStatusProgress(e,n){if(!(!this.statusBarEl||!this.statusLabelEl||!this.statusBarInnerEl))if(this.statusBarEl.style.display="flex",this.statusLabelEl.setText(e),n===null)this.statusBarInnerEl.addClass("indeterminate"),this.statusBarInnerEl.style.width="40%";else{this.statusBarInnerEl.removeClass("indeterminate");let t=Math.max(0,Math.min(100,n));this.statusBarInnerEl.style.width=`${t}%`}}clearStatusProgress(){!this.statusBarEl||!this.statusBarInnerEl||(this.statusBarEl.style.display="none",this.statusBarInnerEl.removeClass("indeterminate"),this.statusBarInnerEl.style.width="0%")}formatStatusLabel(e,n){return n?`${e} (Text layer quality ${n})`:e}async readDoclingQualityLabel(e){var n;try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t),r=(n=i==null?void 0:i.metadata)==null?void 0:n.confidence_proxy;if(typeof r=="number")return r.toFixed(2)}catch(t){console.warn("Failed to read Docling quality metadata",t)}return null}async readDoclingMetadata(e){try{let n=await this.app.vault.adapter.read(e),t=JSON.parse(n),i=t==null?void 0:t.metadata;if(i&&typeof i=="object")return i}catch(n){console.warn("Failed to read Docling metadata",n)}return null}async readDoclingQualityLabelFromPdf(e,n){try{let t=this.getPluginDir(),i=f.default.join(t,"tools","docling_extract.py"),r=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,a=["--quality-only","--pdf",e,"--ocr",r];this.settings.ocrMode==="force_low_quality"&&a.push("--force-ocr-low-quality"),a.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),n&&a.push("--language-hint",n);let s=await this.runPythonWithOutput(i,a),o=JSON.parse(s),l=o==null?void 0:o.confidence_proxy;if(typeof l=="number")return l.toFixed(2)}catch(t){console.warn("Failed to read Docling quality from PDF",t)}return null}async promptDocId(){return new Promise(e=>{new W(this.app,"Rebuild Zotero note from cache","Enter Zotero doc_id (e.g., ABC123)",n=>e(n),"Doc ID cannot be empty.").open()})}async promptLanguageHint(){return new Promise(e=>{new te(this.app,e).open()})}registerRibbonIcons(){(0,d.addIcon)("zrr-picker",be),(0,d.addIcon)("zrr-chat",we),this.addRibbonIcon("zrr-picker","Import Zotero item and index",()=>this.importZoteroItem()).addClass("zrr-ribbon-picker"),this.addRibbonIcon("zrr-chat","Open Zotero RAG chat",()=>this.openChatView(!0)).addClass("zrr-ribbon-chat")}async confirmOverwrite(e){return new Promise(n=>{new ne(this.app,e,n).open()})}async resolveLanguageHint(e,n){let t=typeof e.language=="string"?e.language:"",i=this.normalizeZoteroLanguage(t);if(i)return i;let r=await this.promptLanguageHint();if(r===null)return console.info("Language selection canceled."),null;let a=this.normalizeZoteroLanguage(r);if(!a)return console.info("Language selection empty; skipping Zotero update."),"";if(e.language=a,console.info("Language selected",{language:a,itemKey:n}),n)try{await this.updateZoteroItemLanguage(n,e,a),new d.Notice("Saved language to Zotero.")}catch(s){new d.Notice("Failed to write language back to Zotero."),console.error(s)}else console.warn("Language selected but itemKey is missing; skipping Zotero update.");return a}normalizeZoteroLanguage(e){return(e||"").trim().toLowerCase()}buildDoclingLanguageHint(e){let n=this.normalizeZoteroLanguage(e!=null?e:"");if(!n)return null;let t=n.split(/[^a-z]+/).filter(Boolean),i=t.some(a=>["de","deu","ger","german"].includes(a)),r=t.some(a=>["en","eng","english"].includes(a));return i&&r?"deu+eng":i?"deu":r?"eng":t.length===1&&ce[t[0]]?ce[t[0]]:n}async fetchZoteroItem(e){try{let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),t=await this.requestLocalApi(n,`Zotero item fetch failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(n){return console.warn("Failed to fetch Zotero item from local API",n),this.canUseWebApi()?this.fetchZoteroItemWeb(e):null}}async fetchZoteroItemWeb(e){try{let n=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}`),t=await this.requestWebApi(n,`Zotero Web API fetch failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(n){return console.warn("Failed to fetch Zotero item from Web API",n),null}}async searchZoteroItemsWeb(e){let n=new URLSearchParams;n.set("itemType","-attachment"),n.set("limit","25"),n.set("include","data,meta"),e.trim()&&n.set("q",e.trim());let t=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items?${n.toString()}`),i=await this.requestWebApi(t,`Zotero Web API search failed for ${t}`),r=JSON.parse(i.toString("utf8"));return Array.isArray(r)?r.map(a=>{var s,o,l,c;return{key:(o=a.key)!=null?o:(s=a.data)==null?void 0:s.key,data:(l=a.data)!=null?l:{},meta:(c=a.meta)!=null?c:{}}}).filter(a=>typeof a.key=="string"&&a.key.trim().length>0):[]}async updateZoteroItemLanguage(e,n,t){try{await this.updateZoteroItemLanguageLocal(e,n,t);return}catch(i){if(!this.canUseWebApi())throw i;let r=i instanceof Error?i.message:String(i);console.info("Local Zotero write failed; trying Web API",{itemKey:e,reason:r}),await this.updateZoteroItemLanguageWeb(e,n,t)}}async updateZoteroItemLanguageLocal(e,n,t){var k,P,x,S,E,T;let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),r={...n,language:t},a={"Content-Type":"application/json","Zotero-API-Version":"3"},s=typeof r.version=="number"?r.version:Number(r.version);Number.isNaN(s)||(a["If-Unmodified-Since-Version"]=String(s)),console.info("Zotero language PUT",{url:i,itemKey:e,language:t});try{let C=await this.requestLocalApiWithBody(i,"PUT",r,a,`Zotero update failed for ${i}`);console.info("Zotero language PUT response",{status:C.statusCode})}catch(C){if(!(C instanceof Error?C.message:String(C)).includes("status 501"))throw C;let y=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.info("Zotero language PUT unsupported; trying POST",{postUrl:y});let A=await this.requestLocalApiWithBody(y,"POST",[r],a,`Zotero update failed for ${y}`);console.info("Zotero language POST response",{status:A.statusCode})}let o=await this.fetchZoteroItem(e);if(this.normalizeZoteroLanguage(typeof((k=o==null?void 0:o.data)==null?void 0:k.language)=="string"?o.data.language:"")===this.normalizeZoteroLanguage(t))return;let c={...(P=o==null?void 0:o.data)!=null?P:n,language:t},p={key:e,version:(E=(S=(x=o==null?void 0:o.data)==null?void 0:x.version)!=null?S:o==null?void 0:o.version)!=null?E:s,data:c},h={...a},g=typeof p.version=="number"?p.version:Number(p.version);Number.isNaN(g)?delete h["If-Unmodified-Since-Version"]:h["If-Unmodified-Since-Version"]=String(g);let m=await this.requestLocalApiWithBody(i,"PUT",p,h,`Zotero update failed for ${i}`);console.info("Zotero language PUT retry response",{status:m.statusCode});let _=await this.fetchZoteroItem(e);if(this.normalizeZoteroLanguage(typeof((T=_==null?void 0:_.data)==null?void 0:T.language)=="string"?_.data.language:"")!==this.normalizeZoteroLanguage(t))throw new Error("Language update did not persist in Zotero.")}async updateZoteroItemLanguageWeb(e,n,t){var m,_,b,k,P;let i=this.getWebApiLibraryPath();if(!i)throw new Error("Web API library path is not configured.");let r=this.buildWebApiUrl(`/${i}/items/${e}`),a=await this.fetchZoteroItemWeb(e),s={...(m=a==null?void 0:a.data)!=null?m:n,language:t},o={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},l=(k=(b=(_=a==null?void 0:a.data)==null?void 0:_.version)!=null?b:a==null?void 0:a.version)!=null?k:n==null?void 0:n.version,c=typeof l=="number"?l:Number(l);Number.isNaN(c)||(o["If-Unmodified-Since-Version"]=String(c)),console.info("Zotero Web API language PUT",{url:r,itemKey:e,language:t});let p=await this.requestWebApiWithBody(r,"PUT",s,o,`Zotero Web API update failed for ${r}`);console.info("Zotero Web API language PUT response",{status:p.statusCode});let h=await this.fetchZoteroItemWeb(e);if(this.normalizeZoteroLanguage(typeof((P=h==null?void 0:h.data)==null?void 0:P.language)=="string"?h.data.language:"")!==this.normalizeZoteroLanguage(t))throw new Error("Language update did not persist in Zotero Web API.")}getDocId(e){let n=[e.key,e.itemKey,e.id,e.citationKey];for(let t of n)if(typeof t=="string"&&t.trim())return t.trim();return null}sanitizeFileName(e){let n=e.replace(/[\\/:*?"<>|]/g,"").replace(/\s+/g," ").trim();return n?n.replace(/[.]+$/g,"").trim().slice(0,120):""}registerNoteRenameHandler(){this.registerEvent(this.app.vault.on("rename",async e=>{if(!(!(e instanceof d.TFile)||e.extension!=="md"))try{let n=await this.app.vault.read(e),t=this.extractDocIdFromFrontmatter(n);if(!t)return;await this.updateDocIndex({doc_id:t,note_path:e.path,note_title:f.default.basename(e.path,".md")})}catch(n){console.warn("Failed to update doc index for renamed note",n)}}))}async resolveNotePathForDocId(e){if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e);if(t!=null&&t.note_path&&await n.exists(t.note_path))return t.note_path;let r=(await this.scanNotesForDocIds(this.settings.outputNoteDir))[e];return r!=null&&r.note_path?(await this.updateDocIndex({doc_id:e,note_path:r.note_path,note_title:r.note_title}),r.note_path):null}async resolveUniqueBaseName(e,n){let t=this.app.vault.adapter,i=(0,d.normalizePath)(`${this.settings.outputNoteDir}/${e}.md`),r=(0,d.normalizePath)(`${this.settings.outputPdfDir}/${e}.pdf`),a=await t.exists(i),s=this.settings.copyPdfToVault?await t.exists(r):!1;return a||s?`${e}-${n}`:e}async searchZoteroItems(e){let n=new URLSearchParams;n.set("itemType","-attachment"),n.set("limit","25"),n.set("include","data,meta"),e.trim()&&n.set("q",e.trim());let t=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items?${n.toString()}`);try{let i=await this.requestLocalApi(t,`Zotero search failed for ${t}`),r=JSON.parse(i.toString("utf8"));return Array.isArray(r)?r.map(a=>{var s,o,l,c;return{key:(o=a.key)!=null?o:(s=a.data)==null?void 0:s.key,data:(l=a.data)!=null?l:{},meta:(c=a.meta)!=null?c:{}}}).filter(a=>typeof a.key=="string"&&a.key.trim().length>0):[]}catch(i){if(console.warn("Failed to search Zotero via local API",i),!this.canUseWebApi())throw i;return this.searchZoteroItemsWeb(e)}}async resolvePdfAttachment(e,n){let t=this.pickPdfAttachment(e);if(t)return t;try{let i=await this.fetchZoteroChildren(n);for(let r of i){let a=this.toPdfAttachment(r);if(a)return a}}catch(i){console.error("Failed to fetch Zotero children",i)}return null}pickPdfAttachment(e){var t,i,r;let n=(r=(i=(t=e.attachments)!=null?t:e.children)!=null?i:e.items)!=null?r:[];if(!Array.isArray(n))return null;for(let a of n){let s=this.toPdfAttachment(a);if(s)return s}return null}toPdfAttachment(e){var r,a,s,o,l,c;if(((s=(r=e==null?void 0:e.contentType)!=null?r:e==null?void 0:e.mimeType)!=null?s:(a=e==null?void 0:e.data)==null?void 0:a.contentType)!=="application/pdf")return null;let t=(c=(o=e==null?void 0:e.key)!=null?o:e==null?void 0:e.attachmentKey)!=null?c:(l=e==null?void 0:e.data)==null?void 0:l.key;if(!t)return null;let i=this.extractAttachmentPath(e);return i?{key:t,filePath:i}:{key:t}}extractAttachmentPath(e){var t,i,r,a,s,o,l,c;let n=(c=(a=(i=(t=e==null?void 0:e.links)==null?void 0:t.enclosure)==null?void 0:i.href)!=null?a:(r=e==null?void 0:e.enclosure)==null?void 0:r.href)!=null?c:(l=(o=(s=e==null?void 0:e.data)==null?void 0:s.links)==null?void 0:o.enclosure)==null?void 0:l.href;if(typeof n=="string"&&n.startsWith("file://"))try{return(0,B.fileURLToPath)(n)}catch(p){return null}return null}async fetchZoteroChildren(e){let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/children`);try{let t=await this.requestLocalApi(n,`Zotero children request failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(t){if(console.warn("Failed to fetch Zotero children from local API",t),!this.canUseWebApi())throw t;let i=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/children`),r=await this.requestWebApi(i,`Zotero Web API children request failed for ${i}`);return JSON.parse(r.toString("utf8"))}}async downloadZoteroPdf(e){let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/file`);try{let t=await this.requestLocalApiRaw(n),i=await this.followFileRedirect(t);if(i)return i;if(t.statusCode>=300)throw new Error(`Request failed, status ${t.statusCode}`);return t.body}catch(t){if(console.warn("Failed to download PDF from local API",t),!this.canUseWebApi())throw t;let i=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/file`),r=await this.requestWebApiRaw(i),a=await this.followFileRedirect(r);if(a)return a;if(r.statusCode>=300)throw new Error(`Web API request failed, status ${r.statusCode}`);return r.body}}buildZoteroUrl(e){return`${this.settings.zoteroBaseUrl.replace(/\/$/,"")}${e}`}canUseWebApi(){return!!((this.settings.webApiBaseUrl||"").trim()&&this.settings.webApiKey&&this.settings.webApiLibraryId)}getWebApiLibraryPath(){let e=(this.settings.webApiLibraryId||"").trim();return e?`${this.settings.webApiLibraryType==="group"?"groups":"users"}/${e}`:""}buildWebApiUrl(e){return`${this.settings.webApiBaseUrl.replace(/\/$/,"")}${e}`}requestLocalApiRaw(e,n={}){return new Promise((t,i)=>{var p,h;let r=new URL(e),a=r.protocol==="https:"?pe.default:de.default,s=(p=n.method)!=null?p:"GET",o={Accept:"*/*",...(h=n.headers)!=null?h:{}},l=n.body;if(l!==void 0&&o["Content-Length"]===void 0){let g=Buffer.isBuffer(l)?l.length:Buffer.byteLength(l);o["Content-Length"]=String(g)}let c=a.request({method:s,hostname:r.hostname,port:r.port||void 0,path:`${r.pathname}${r.search}`,headers:o},g=>{let m=[];g.on("data",_=>m.push(Buffer.from(_))),g.on("end",()=>{var b;let _=Buffer.concat(m);t({statusCode:(b=g.statusCode)!=null?b:0,headers:g.headers,body:_})})});c.on("error",i),l!==void 0&&c.write(l),c.end()})}async requestLocalApi(e,n){let t=await this.requestLocalApiRaw(e);if(t.statusCode>=400){let i=t.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}: ${i||"no response body"}`)}if(t.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}`);return t.body}async requestLocalApiWithBody(e,n,t,i,r){let a=JSON.stringify(t),s=await this.requestLocalApiRaw(e,{method:n,headers:i,body:a});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}async requestWebApi(e,n){let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},i=await this.requestLocalApiRaw(e,{headers:t});if(i.statusCode>=400){let r=i.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}: ${r||"no response body"}`)}if(i.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}`);return i.body}requestWebApiRaw(e,n={}){var i;let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey,...(i=n.headers)!=null?i:{}};return this.requestLocalApiRaw(e,{...n,headers:t})}async requestWebApiWithBody(e,n,t,i,r){let a=JSON.stringify(t),s=await this.requestLocalApiRaw(e,{method:n,headers:i,body:a});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}async followFileRedirect(e){if(e.statusCode<300||e.statusCode>=400)return null;let n=e.headers.location,t=Array.isArray(n)?n[0]:n;if(!t||typeof t!="string")return null;if(t.startsWith("file://")){let i=(0,B.fileURLToPath)(t);return R.promises.readFile(i)}return t.startsWith("http://")||t.startsWith("https://")?this.requestLocalApi(t):null}bufferToArrayBuffer(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}async annotateChunkJsonWithAttachmentKey(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;let r=i.metadata&&typeof i.metadata=="object"?i.metadata:{};r.attachment_key=n,i.metadata=r,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to annotate chunks JSON with attachment key",t)}}async updateChunkJsonSourcePdf(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;i.source_pdf=n,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to update chunks JSON source_pdf",t)}}buildPdfLinkFromSourcePath(e){if(!e)return"";let n=f.default.normalize(this.getVaultBasePath()),t=f.default.normalize(e),i=n.endsWith(f.default.sep)?n:`${n}${f.default.sep}`;return t.startsWith(i)?`[[${(0,d.normalizePath)(f.default.relative(n,t))}]]`:`[PDF](${(0,B.pathToFileURL)(e).toString()})`}toVaultRelativePath(e){if(!e)return"";let n=f.default.normalize(this.getVaultBasePath()),t=f.default.normalize(e),i=n.endsWith(f.default.sep)?n:`${n}${f.default.sep}`;return t.startsWith(i)?(0,d.normalizePath)(f.default.relative(n,t)):""}async isFileAccessible(e){if(!e)return!1;try{return await R.promises.access(e),!0}catch(n){return!1}}deriveVaultPdfRelativePath(e,n,t){let i=this.toVaultRelativePath(e);if(i&&i.startsWith((0,d.normalizePath)(this.settings.outputPdfDir)))return i;let r=this.sanitizeFileName(n)||t;return(0,d.normalizePath)(`${this.settings.outputPdfDir}/${r}.pdf`)}async recoverMissingPdfFromAttachment(e,n,t,i,r,a,s){let o=await this.resolvePdfAttachment(n,t);if(!o&&r&&(o={key:r}),!o)return null;let l=o.key||r,c=o.filePath;if(!this.settings.copyPdfToVault&&c&&await this.isFileAccessible(c))return{sourcePdf:c,attachmentKey:l};try{await this.ensureFolder(this.settings.outputPdfDir)}catch(m){return console.error("Failed to create PDF output folder",m),null}let p=this.deriveVaultPdfRelativePath(e,a,i),h;try{if(c&&await this.isFileAccessible(c))h=await R.promises.readFile(c);else if(l)h=await this.downloadZoteroPdf(l),!this.settings.copyPdfToVault&&s&&new d.Notice("Local PDF path unavailable; copied PDF into vault for processing.");else return null}catch(m){return console.error("Failed to read or download PDF attachment",m),null}try{await this.app.vault.adapter.writeBinary(p,this.bufferToArrayBuffer(h))}catch(m){return console.error("Failed to write recovered PDF into vault",m),null}return{sourcePdf:this.getAbsoluteVaultPath(p),attachmentKey:l}}buildPdfLinkForNote(e,n,t){return!e&&!n?"":!this.settings.copyPdfToVault&&n?`[PDF](${this.buildZoteroDeepLink(t!=null?t:"",n)})`:this.buildPdfLinkFromSourcePath(e)}buildVaultPdfCitationLink(e,n,t){if(!e)return"";let i=this.toVaultRelativePath(e);if(!i)return"";let r=n?`#page=${n}`:"";return`[[${i}${r}|${t||i}]]`}async maybeCreateOcrLayeredPdf(e,n,t){if(!this.settings.createOcrLayeredPdf||!this.settings.copyPdfToVault||!e||!((n==null?void 0:n.ocr_used)===!0))return null;if(!this.toVaultRelativePath(e))return console.warn("OCR layered PDF requires a vault-local PDF"),null;try{await this.ensureFolder(this.settings.outputPdfDir)}catch(l){return console.warn("Failed to create OCR PDF output folder",l),null}let r=`${e}.ocr.tmp`,a=(t||(n==null?void 0:n.languages)||"eng").toString(),s=this.getPluginDir(),o=f.default.join(s,"tools","ocr_layered_pdf.py");try{return this.showStatusProgress("Creating OCR PDF...",0),await this.runPythonStreaming(o,["--pdf",e,"--out-pdf",r,"--language",a,"--progress"],l=>{if((l==null?void 0:l.type)==="progress"&&l.total){let c=Math.round(l.current/l.total*100);this.showStatusProgress(`Creating OCR PDF ${l.current}/${l.total}`,c)}},()=>{}),await R.promises.rename(r,e),e}catch(l){return console.warn("OCR layered PDF creation failed",l),null}}getMainLeaf(){let e=new Set(this.app.workspace.getLeavesOfType(M)),n=this.app.workspace.getLeavesOfType("markdown").find(i=>!e.has(i));if(n)return n;let t=this.app.workspace.getLeaf(!1);return t&&!e.has(t)?t:this.app.workspace.getLeaf("tab")}async openNoteInMain(e){let n=(0,d.normalizePath)(e),t=this.app.vault.getAbstractFileByPath(n),i=this.getMainLeaf();if(t instanceof d.TFile){await i.openFile(t,{active:!0});return}await this.app.workspace.openLinkText(n,"",!1)}async openInternalLinkInMain(e){let n=this.getMainLeaf(),t=e.split("#")[0].trim(),i=t?this.app.metadataCache.getFirstLinkpathDest(t,""):null;if(i instanceof d.TFile){await n.openFile(i,{active:!0}),e.includes("#")&&(this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1));return}this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1)}async openNoteInNewTab(e){let n=(0,d.normalizePath)(e);await this.app.workspace.openLinkText(n,"","tab")}async openPdfInMain(e,n){if(!e)return!1;let t=f.default.normalize(this.getVaultBasePath()),i=f.default.normalize(e),r=t.endsWith(f.default.sep)?t:`${t}${f.default.sep}`;if(i.startsWith(r)){let a=(0,d.normalizePath)(f.default.relative(t,i)),s=n?`#page=${n}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}try{return window.open((0,B.pathToFileURL)(e).toString()),!0}catch(a){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,n,t,i){if(n){let r=new URLSearchParams;t&&r.set("page",t),i&&r.set("annotation",i);let a=r.toString()?`?${r.toString()}`:"";return`zotero://open-pdf/library/items/${n}${a}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let t=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(t))return t}formatCitationsMarkdown(e){return e.length?e.map(t=>this.formatCitationMarkdown(t)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e){var g,m,_,b,k,P;let n=e.doc_id||"?",t=e.pages||`${(g=e.page_start)!=null?g:"?"}-${(m=e.page_end)!=null?m:"?"}`,i=`${n}`,r=t.includes("-")?t.replace("-"," - "):t,a=e.annotation_key||this.extractAnnotationKey(e.chunk_id),s=e.attachment_key||((b=(_=this.docIndex)==null?void 0:_[e.doc_id||""])==null?void 0:b.attachment_key),o=e.page_start?String(e.page_start):"",l=(P=(k=this.docIndex)==null?void 0:k[e.doc_id||""])!=null?P:null,c=(l==null?void 0:l.zotero_title)||(l==null?void 0:l.note_title)||i,p=l!=null&&l.note_path?(0,d.normalizePath)(l.note_path).replace(/\.md$/i,""):this.sanitizeFileName(c)||c,h=p&&p!==c?`[[${p}|${c}]]`:`[[${c}]]`;if(this.settings.preferVaultPdfForCitations){let x=(l==null?void 0:l.pdf_path)||e.source_pdf||"",S=this.buildVaultPdfCitationLink(x,o,r);if(S)return`- ${h}, p. ${S}`}if(s){let x=this.buildZoteroDeepLink(n,s,o,a);return`- ${h}, p. [${r}](${x})`}return`- ${h}, p. ${r}`}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,d.normalizePath)(`${O}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var t;let e=this.app.vault.adapter,n=this.getDocIndexPath();if(!await e.exists(n))return{};try{let i=await e.read(n),r=JSON.parse(i);if(r&&typeof r=="object"){let a=(t=r.entries)!=null?t:r;if(Array.isArray(a)){let s={};for(let o of a)o!=null&&o.doc_id&&(s[String(o.doc_id)]=o);return s}if(a&&typeof a=="object")return a}}catch(i){console.error("Failed to read doc index",i)}return{}}async saveDocIndex(e){await this.ensureFolder(O);let n=this.app.vault.adapter,t=this.getDocIndexPath(),i={version:1,entries:e};await n.write(t,JSON.stringify(i,null,2)),this.docIndex=e}async updateDocIndex(e){var r;let n=await this.getDocIndex(),t=(r=n[e.doc_id])!=null?r:{doc_id:e.doc_id},i={...t,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&t.note_path&&(i.note_path=t.note_path),e.note_title===void 0&&t.note_title&&(i.note_title=t.note_title),e.zotero_title===void 0&&t.zotero_title&&(i.zotero_title=t.zotero_title),e.pdf_path===void 0&&t.pdf_path&&(i.pdf_path=t.pdf_path),e.attachment_key===void 0&&t.attachment_key&&(i.attachment_key=t.attachment_key),n[e.doc_id]=i,await this.saveDocIndex(n)}async hydrateDocIndexFromCache(e){var s,o;if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e),i={},r=(0,d.normalizePath)(`${q}/${e}.json`);if(await n.exists(r))try{let l=await n.read(r),c=JSON.parse(l),p=(o=(s=c==null?void 0:c.data)!=null?s:c)!=null?o:{},h=typeof p.title=="string"?p.title:"";if(h&&(i.zotero_title=h),!i.note_title||!i.note_path){let g=this.sanitizeFileName(h)||e,m=(0,d.normalizePath)(`${this.settings.outputNoteDir}/${g}.md`),_=(0,d.normalizePath)(`${this.settings.outputNoteDir}/${g}-${e}.md`),b="";await n.exists(m)?b=m:await n.exists(_)&&(b=_),b&&(i.note_path=b,i.note_title=f.default.basename(b,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!i.note_title&&(t!=null&&t.note_path)&&(i.note_title=f.default.basename(t.note_path,".md"));let a=(0,d.normalizePath)(`${I}/${e}.json`);if(await n.exists(a))try{let l=await n.read(a),c=JSON.parse(l);typeof(c==null?void 0:c.source_pdf)=="string"&&(i.pdf_path=c.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(i).length>0&&await this.updateDocIndex({doc_id:e,...i}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var t;return e&&(t=(await this.getDocIndex())[e])!=null?t:null}async inferNotePathFromCache(e){var i,r;let n=this.app.vault.adapter,t=(0,d.normalizePath)(`${q}/${e}.json`);if(!await n.exists(t))return"";try{let a=await n.read(t),s=JSON.parse(a),o=(r=(i=s==null?void 0:s.data)!=null?i:s)!=null?r:{},l=typeof o.title=="string"?o.title:"",c=this.sanitizeFileName(l)||e,p=(0,d.normalizePath)(`${this.settings.outputNoteDir}/${c}.md`),h=(0,d.normalizePath)(`${this.settings.outputNoteDir}/${c}-${e}.md`);if(await n.exists(p))return p;if(await n.exists(h))return h}catch(a){console.error("Failed to infer note path from cache",a)}return""}async rebuildNoteFromCacheForDocId(e,n){var C,D,y,A,$;try{await this.ensureBundledTools()}catch(v){return n&&new d.Notice("Failed to sync bundled tools. See console for details."),console.error(v),!1}let t=this.app.vault.adapter,i=(0,d.normalizePath)(`${q}/${e}.json`),r=(0,d.normalizePath)(`${I}/${e}.json`);if(!await t.exists(i)||!await t.exists(r))return n&&new d.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let a;try{let v=await t.read(i);a=JSON.parse(v)}catch(v){return n&&new d.Notice("Failed to read cached item JSON."),console.error(v),this.clearStatusProgress(),!1}let s;try{let v=await t.read(r);s=JSON.parse(v)}catch(v){return n&&new d.Notice("Failed to read cached chunks JSON."),console.error(v),this.clearStatusProgress(),!1}let o=(C=a.data)!=null?C:a,l=typeof o.title=="string"?o.title:"",c=((y=(D=a.key)!=null?D:o.key)!=null?y:e).toString(),p=await this.getDocIndexEntry(e),h=typeof((A=s==null?void 0:s.metadata)==null?void 0:A.attachment_key)=="string"?s.metadata.attachment_key:p==null?void 0:p.attachment_key,g=typeof s.source_pdf=="string"?s.source_pdf:"";if(!g||!await this.isFileAccessible(g)){let v=await this.recoverMissingPdfFromAttachment(g,o,c,e,h,l,n);if(!v)return n&&new d.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;g=v.sourcePdf,v.attachmentKey&&(h=v.attachmentKey),await this.updateChunkJsonSourcePdf(r,g)}let m=await this.resolveLanguageHint(o,c),_=this.buildDoclingLanguageHint(m!=null?m:void 0),b="";if(p!=null&&p.note_path&&await t.exists(p.note_path)&&(b=(0,d.normalizePath)(p.note_path)),!b){let v=this.sanitizeFileName(l)||e,z=(0,d.normalizePath)(`${this.settings.outputNoteDir}/${v}.md`),j=await t.exists(z)?v:await this.resolveUniqueBaseName(v,e);b=(0,d.normalizePath)(`${this.settings.outputNoteDir}/${j}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let v=this.getLogFileRelativePath(),z=(0,d.normalizePath)(f.default.dirname(v));z&&await this.ensureFolder(z);let j=this.getSpellcheckerInfoRelativePath(),re=(0,d.normalizePath)(f.default.dirname(j));re&&await this.ensureFolder(re)}}catch(v){return n&&new d.Notice("Failed to create notes folder."),console.error(v),this.clearStatusProgress(),!1}let k=this.getPluginDir(),P=f.default.join(k,"tools","docling_extract.py"),x=f.default.join(k,"tools","index_redisearch.py"),S=null,E=null;try{S=await this.readDoclingQualityLabelFromPdf(g,_),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",S),0),await this.runPythonStreaming(P,this.buildDoclingArgs(g,e,r,b,_,!0),j=>this.handleDoclingProgress(j,S),()=>{}),S=await this.readDoclingQualityLabel(r),h&&await this.annotateChunkJsonWithAttachmentKey(r,h);let v=await this.readDoclingMetadata(r),z=await this.maybeCreateOcrLayeredPdf(g,v,_);z&&(g=z,E=z,await this.updateChunkJsonSourcePdf(r,z))}catch(v){return n&&new d.Notice("Docling extraction failed. See console for details."),console.error(v),this.clearStatusProgress(),!1}try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",S),0),await this.runPythonStreaming(x,["--chunks-json",this.getAbsoluteVaultPath(r),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"],v=>{if((v==null?void 0:v.type)==="progress"&&v.total){let z=Math.round(v.current/v.total*100),j=this.formatStatusLabel(`Indexing chunks ${v.current}/${v.total}`,S);this.showStatusProgress(j,z)}},()=>{})}catch(v){return n&&new d.Notice("RedisSearch indexing failed. See console for details."),console.error(v),this.clearStatusProgress(),!1}let T=E?this.buildPdfLinkFromSourcePath(E):this.buildPdfLinkForNote(g,p==null?void 0:p.attachment_key,e);try{let v=await this.app.vault.adapter.read(b),z=this.buildNoteMarkdown(o,($=a.meta)!=null?$:{},e,T,i,v);await this.app.vault.adapter.write(b,z)}catch(v){return n&&new d.Notice("Failed to finalize note markdown."),console.error(v),this.clearStatusProgress(),!1}try{await this.updateDocIndex({doc_id:e,note_path:b,note_title:f.default.basename(b,".md"),zotero_title:l,pdf_path:g})}catch(v){console.error("Failed to update doc index",v)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async ensureFolder(e){let n=this.app.vault.adapter,t=(0,d.normalizePath)(e).split("/").filter(Boolean),i="";for(let r of t)i=i?`${i}/${r}`:r,await n.exists(i)||await n.mkdir(i)}buildNoteMarkdown(e,n,t,i,r,a){let s=`[[${r}]]`,o=this.renderFrontmatter(e,n,t,i,s);return`${o?`---
${o}
---
...
${a}`}renderFrontmatter(e,n,t,i,r){var o;let a=(o=this.settings.frontmatterTemplate)!=null?o:"";if(!a.trim())return"";let s=this.buildTemplateVars(e,n,t,i,r);return a.replace(/{{\s*([a-z0-9_]+)\s*}}/gi,(l,c)=>{var p;return(p=s[c])!=null?p:""}).trim()}buildTemplateVars(e,n,t,i,r){let a=typeof e.title=="string"?e.title:"",s=typeof e.shortTitle=="string"?e.shortTitle:"",o=typeof e.date=="string"?e.date:"",l=typeof(n==null?void 0:n.parsedDate)=="string"?n.parsedDate:"",c=this.extractYear(l||o),h=(Array.isArray(e.creators)?e.creators:[]).filter(x=>x.creatorType==="author").map(x=>this.formatCreatorName(x)),g=h.join("; "),m=Array.isArray(e.tags)?e.tags.map(x=>typeof x=="string"?x:x==null?void 0:x.tag).filter(Boolean):[],_=m.join("; "),b=typeof e.itemType=="string"?e.itemType:"",k=typeof(n==null?void 0:n.creatorSummary)=="string"?n.creatorSummary:"",P={doc_id:t,zotero_key:typeof e.key=="string"?e.key:t,title:a,short_title:s,date:o,year:c,authors:g,tags:_,item_type:b,creator_summary:k,pdf_link:this.escapeYamlString(i),item_json:this.escapeYamlString(r)};for(let[x,S]of Object.entries(P))P[`${x}_yaml`]=this.escapeYamlString(S);return P.authors_yaml=this.toYamlList(h),P.tags_yaml=this.toYamlList(m),P}extractYear(e){if(!e)return"";let n=e.match(/\b(\d{4})\b/);return n?n[1]:""}formatCreatorName(e){if(!e||typeof e!="object")return"";if(e.name)return String(e.name);let n=e.firstName?String(e.firstName):"",t=e.lastName?String(e.lastName):"";return[t,n].filter(Boolean).join(", ")||`${n} ${t}`.trim()}escapeYamlString(e){return`"${String(e).replace(/\\/g,"\\\\").replace(/"/g,'\\"')}"`}toYamlList(e){return e.length?e.map(n=>`  - ${this.escapeYamlString(n)}`).join(`
`):'  - ""'}getVaultBasePath(){var t;let e=this.app.vault.adapter;if(e instanceof d.FileSystemAdapter)return e.getBasePath();let n=(t=e.getBasePath)==null?void 0:t.call(e);if(n)return n;throw new Error("Vault base path is unavailable.")}getPluginDir(){var i;let e=this.getVaultBasePath(),n=(i=this.manifest.dir)!=null?i:this.manifest.id;if(!n)throw new Error("Plugin directory is unavailable.");let t=f.default.isAbsolute(n)?n:f.default.join(e,n);return f.default.normalize(t)}async ensureBundledTools(){let e=this.getPluginDir(),n=f.default.join(e,"tools");await R.promises.mkdir(n,{recursive:!0});for(let[t,i]of Object.entries(oe)){let r=f.default.join(n,t),a=!0;try{await R.promises.readFile(r,"utf8")===i&&(a=!1)}catch(s){}a&&await R.promises.writeFile(r,i,"utf8")}}async migrateCachePaths(){let e="zotero/items",n="zotero/chunks",t=q,i=I,r=this.app.vault.adapter,a=(0,d.normalizePath)(e),s=(0,d.normalizePath)(n),o=(0,d.normalizePath)(t),l=(0,d.normalizePath)(i),c=o.split("/").slice(0,-1).join("/"),p=l.split("/").slice(0,-1).join("/");c&&await this.ensureFolder(c),p&&await this.ensureFolder(p);let h=await r.exists(a),g=await r.exists(s),m=await r.exists(o),_=await r.exists(l);h&&!m&&await r.rename(a,o),g&&!_&&await r.rename(s,l)}getAbsoluteVaultPath(e){let n=this.getVaultBasePath(),t=f.default.isAbsolute(e)?e:f.default.join(n,e);return f.default.normalize(t)}buildDoclingArgs(e,n,t,i,r,a=!1){let s=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",n,"--out-json",this.getAbsoluteVaultPath(t),"--out-md",this.getAbsoluteVaultPath(i),"--chunking",this.settings.chunkingMode,"--ocr",s];a&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),r&&o.push("--language-hint",r),this.settings.maxChunkChars>0&&o.push("--max-chunk-chars",String(this.settings.maxChunkChars)),this.settings.chunkOverlapChars>0&&o.push("--chunk-overlap-chars",String(this.settings.chunkOverlapChars)),this.settings.removeImagePlaceholders||o.push("--keep-image-tags"),this.settings.enableLlmCleanup&&(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars)));let l=this.getPluginDir(),c=f.default.join(l,"tools","ocr_wordlist.txt");if((0,R.existsSync)(c)&&o.push("--enable-dictionary-correction","--dictionary-path",c),this.settings.enableFileLogging){let p=this.getLogFileAbsolutePath();p&&o.push("--log-file",p);let h=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());h&&o.push("--spellchecker-info-out",h)}return o}getRedisDataDir(){return f.default.join(this.getVaultBasePath(),O,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return f.default.join(e,"tools","docker-compose.yml")}async resolveDockerPath(){var l;let e=(l=this.settings.dockerPath)==null?void 0:l.trim(),n=["/opt/homebrew/bin/docker","/usr/local/bin/docker","/usr/bin/docker","/Applications/Docker.app/Contents/Resources/bin/docker"],t=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"],i=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"],r=[];e&&r.push(e);let a=e?this.getContainerCliKind(e):"docker",s=a==="podman-compose"?[i,t,n]:a==="podman"?[t,i,n]:[n,t,i];if(!e||e==="docker"||e==="podman"||e==="podman-compose")for(let c of s)r.push(...c);for(let c of r)if(f.default.isAbsolute(c))try{if(await this.isContainerCliAvailable(c))return c}catch(p){}let o=[e,a==="podman"?"podman":"docker",a==="podman"?"docker":"podman","podman-compose"].filter(c=>!!(c&&c.trim()));for(let c of o)if(await this.isContainerCliAvailable(c))return c;return e||"docker"}async isContainerCliAvailable(e){return new Promise(n=>{let t=(0,F.spawn)(e,["--version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}getContainerCliKind(e){let n=f.default.basename(e);return n==="podman-compose"?"podman-compose":n.includes("podman")?"podman":"docker"}async isContainerDaemonRunning(e){let n=this.getContainerCliKind(e),t=e,i=["info"];if(n==="podman-compose"){let r=await this.resolvePodmanBin();if(!r)return!1;t=r}return new Promise(r=>{let a=(0,F.spawn)(t,i),s=!1,o=c=>{s||(s=!0,r(c))},l=setTimeout(()=>{a.kill(),o(!1)},2e3);a.on("error",()=>{clearTimeout(l),o(!1)}),a.on("close",c=>{clearTimeout(l),o(c===0)})})}getContainerDaemonHint(e){let n=this.getContainerCliKind(e);return n==="podman"||n==="podman-compose"?"Podman machine not running. Run `podman machine start`.":"Docker Desktop is not running. Start Docker Desktop."}async supportsComposeSubcommand(e){return new Promise(n=>{let t=(0,F.spawn)(e,["compose","version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}async findPodmanComposePath(){let e=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"];for(let n of e)try{return await R.promises.access(n),n}catch(t){}return await this.isContainerCliAvailable("podman-compose")?"podman-compose":null}async resolvePodmanBin(){let e=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"];for(let n of e)if(await this.isContainerCliAvailable(n))return n;return await this.isContainerCliAvailable("podman")?"podman":null}async resolveComposeCommand(e){let n=f.default.basename(e);if(n==="podman-compose")return{command:e,argsPrefix:[]};if(n==="podman"){let t=await this.findPodmanComposePath();return t?{command:t,argsPrefix:[]}:await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}return await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}async autoDetectContainerCliOnLoad(){var r;let e=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(e)){this.notifyContainerOnce("Docker or Podman not found. Install Docker Desktop or Podman and set Docker/Podman path in settings.");return}let n=((r=this.settings.dockerPath)==null?void 0:r.trim())||"docker";(!await this.isContainerCliAvailable(n)||n==="docker"||n==="podman"||n==="podman-compose")&&e&&e!==n&&(this.settings.dockerPath=e,await this.saveSettings()),await this.isContainerDaemonRunning(e)||this.notifyContainerOnce(this.getContainerDaemonHint(e))}getDockerProjectName(){let e=this.getVaultBasePath(),n=f.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),t=(0,H.createHash)("sha1").update(e).digest("hex").slice(0,8);return`zrr-${n||"vault"}-${t}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),n=e.port?Number(e.port):6379;return Number.isFinite(n)&&n>0?n:6379}catch(e){return 6379}}getVaultPreferredRedisPort(){let e=(0,H.createHash)("sha1").update(this.getVaultBasePath()).digest("hex");return 6400+Number.parseInt(e.slice(0,4),16)%2e3}getRedisHostFromUrl(){try{return new URL(this.settings.redisUrl).hostname||"127.0.0.1"}catch(e){return"127.0.0.1"}}isLocalRedisHost(e){let n=e.trim().toLowerCase();return n?n==="localhost"||n==="0.0.0.0"||n==="::1"?!0:n.startsWith("127."):!1}getPortCheckHost(e){return this.isLocalRedisHost(e)?"127.0.0.1":e}async isPortFree(e,n){return new Promise(t=>{let i=X.default.createServer();i.once("error",()=>t(!1)),i.once("listening",()=>{i.close(()=>t(!0))}),i.listen(n,e)})}async findAvailablePort(e,n){for(let i=0;i<25;i+=1){let r=n+i;if(await this.isPortFree(e,r))return r}return null}updateRedisUrlPort(e,n){try{let t=new URL(e);return t.port=String(n),t.toString()}catch(t){return`redis://127.0.0.1:${n}`}}async isRedisReachable(e){let n="127.0.0.1",t=6379;try{let i=new URL(e);n=i.hostname||n,t=i.port?Number(i.port):t}catch(i){return!1}return new Promise(i=>{let r=new X.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(t,n)})}getRedisNamespace(){let e=this.getVaultBasePath(),n=f.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24),t=(0,H.createHash)("sha1").update(e).digest("hex").slice(0,8);return`${n||"vault"}-${t}`}getRedisIndexName(){return`${(this.settings.redisIndex||"idx:zotero").trim()||"idx:zotero"}:${this.getRedisNamespace()}`}getRedisKeyPrefix(){let e=(this.settings.redisPrefix||"zotero:chunk:").trim()||"zotero:chunk:";return`${e.endsWith(":")?e:`${e}:`}${this.getRedisNamespace()}:`}async isComposeProjectRunning(e,n,t,i,r){return new Promise(a=>{let s=(0,F.spawn)(e,[...n,"-p",i,"-f",t,"ps","-q"],{cwd:f.default.dirname(t),env:r}),o="";s.stdout.on("data",l=>{o+=l.toString()}),s.on("error",l=>{console.warn("Redis Stack status check failed",l),a(!1)}),s.on("close",l=>{if(l!==0){a(!1);return}a(o.trim().length>0)})})}async startRedisStack(e){var n;try{await this.ensureBundledTools();let t=this.getDockerComposePath(),i=this.getRedisDataDir();await R.promises.mkdir(i,{recursive:!0});let r=await this.resolveDockerPath(),a=((n=this.settings.dockerPath)==null?void 0:n.trim())||"docker";if((!await this.isContainerCliAvailable(a)||!a||a==="docker"||a==="podman"||a==="podman-compose")&&r&&r!==a&&(this.settings.dockerPath=r,await this.saveSettings(),e||new d.Notice(`Docker/Podman path set to ${r}.`)),!await this.isContainerCliAvailable(r)){e||new d.Notice('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');return}if(!await this.isContainerDaemonRunning(r)){e||new d.Notice(this.getContainerDaemonHint(r));return}let o=await this.resolveComposeCommand(r);if(!o){e||new d.Notice("Compose support not found. Install Docker Desktop or Podman with podman-compose.");return}let l={...process.env};if(f.default.basename(o.command)==="podman-compose"){let k=await this.resolvePodmanBin();if(k&&(l.PODMAN_BIN=k,f.default.isAbsolute(k))){let P=f.default.dirname(k),x=l.PATH||"";x.split(f.default.delimiter).includes(P)||(l.PATH=`${P}${f.default.delimiter}${x}`)}}let c=this.getDockerProjectName();if(await this.isComposeProjectRunning(o.command,o.argsPrefix,t,c,l)){e||new d.Notice("Redis Stack already running for this vault.");return}let p=this.getRedisPortFromUrl(),h=this.getRedisHostFromUrl(),g=this.getPortCheckHost(h),m=this.settings.autoAssignRedisPort&&this.isLocalRedisHost(h),_=this.settings.redisUrl,b=p;if(m){let k=p===6379?this.getVaultPreferredRedisPort():p,P=await this.findAvailablePort(g,k);if(!P)throw new Error(`No available Redis port found starting at ${k}.`);P!==p&&(b=P,_=this.updateRedisUrlPort(_,b),this.settings.redisUrl=_,await this.saveSettings(),e||new d.Notice(`Using Redis port ${b} for this vault.`))}else if(await this.isRedisReachable(_)){e||new d.Notice(`Redis already running at ${_}.`);return}l.ZRR_DATA_DIR=i,l.ZRR_PORT=String(b);try{await this.runCommand(o.command,[...o.argsPrefix,"-p",c,"-f",t,"down"],{cwd:f.default.dirname(t),env:l})}catch(k){console.warn("Redis Stack stop before restart failed",k)}await this.runCommand(o.command,[...o.argsPrefix,"-p",c,"-f",t,"up","-d"],{cwd:f.default.dirname(t),env:l}),e||new d.Notice("Redis Stack started.")}catch(t){e||new d.Notice("Failed to start Redis Stack. Check Docker/Podman and file sharing."),console.error("Failed to start Redis Stack",t)}}async setupPythonEnv(){let e=this.getPluginDir(),n=this.getPythonVenvDir(),t=this.getVenvPythonPath(n);await this.ensureBundledTools();let i=this.resolveRequirementsPath(e);if(!i)throw new Error(`requirements.txt not found in ${e}`);try{if(new d.Notice("Setting up Python environment..."),this.showStatusProgress("Setting up Python environment...",null),console.log(`Python env: using plugin dir ${e}`),console.log(`Python env: venv path ${n}`),!(0,R.existsSync)(t)){let r=await this.resolveBootstrapPython();console.log(`Python env: creating venv with ${r.command} ${r.args.join(" ")}`),await this.runCommand(r.command,[...r.args,"-m","venv",n],{cwd:e})}await this.runCommandStreaming(t,["-m","pip","install","-r",i],{cwd:e},r=>{let a=r.trim();if(!a)return;let s=a.match(/^Collecting\s+([^\s]+)/);if(s){this.showStatusProgress(`Installing ${s[1]}...`,null);return}if(a.startsWith("Installing collected packages")){this.showStatusProgress("Installing packages...",null);return}a.startsWith("Successfully installed")&&this.showStatusProgress("Python environment ready.",100)}),this.settings.pythonPath=t,await this.saveSettings(),this.clearStatusProgress(),new d.Notice("Python environment ready.")}catch(r){this.clearStatusProgress(),new d.Notice("Failed to set up Python environment. See console for details."),console.error("Python env setup failed",r)}}getPythonVenvDir(){return f.default.join(this.getPluginDir(),".venv")}getVenvPythonPath(e){return process.platform==="win32"?f.default.join(e,"Scripts","python.exe"):f.default.join(e,"bin","python")}resolveRequirementsPath(e){var t;return(t=[f.default.join(e,"requirements.txt"),f.default.join(e,"tools","requirements.txt")].find(i=>(0,R.existsSync)(i)))!=null?t:null}async resolveBootstrapPython(){let e=(this.settings.pythonPath||"").trim();if(e&&await this.canRunCommand(e,[]))return{command:e,args:[]};let n=process.platform==="win32"?[{command:"py",args:["-3"]},{command:"python",args:[]}]:[{command:"python3",args:[]},{command:"python",args:[]}];for(let t of n)if(await this.canRunCommand(t.command,t.args))return t;throw new Error("No usable Python interpreter found on PATH.")}async canRunCommand(e,n){return new Promise(t=>{let i=(0,F.spawn)(e,[...n,"--version"]);i.on("error",()=>t(!1)),i.on("close",r=>t(r===0))})}runPython(e,n){return new Promise((t,i)=>{let r=(0,F.spawn)(this.settings.pythonPath,[e,...n],{cwd:f.default.dirname(e)}),a="";r.stderr.on("data",s=>{a+=s.toString()}),r.on("error",s=>{this.handlePythonProcessError(String(s)),i(s)}),r.on("close",s=>{s===0?t():(this.handlePythonProcessError(a),i(new Error(a||`Process exited with code ${s}`)))})})}runCommand(e,n,t){return new Promise((i,r)=>{let a=(0,F.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:t==null?void 0:t.env}),s="";a.stderr.on("data",o=>{s+=o.toString()}),a.on("error",o=>{r(o)}),a.on("close",o=>{o===0?i():r(new Error(s||`Process exited with code ${o}`))})})}runPythonStreaming(e,n,t,i){return new Promise((r,a)=>{let s=(0,F.spawn)(this.settings.pythonPath,[e,...n],{cwd:f.default.dirname(e)}),o="",l="",c=null,p=!1,h=g=>{if(g.trim())try{let m=JSON.parse(g);c=m,((m==null?void 0:m.type)==="final"||m!=null&&m.answer)&&(p=!0),t(m)}catch(m){}};s.stdout.on("data",g=>{var _;o+=g.toString();let m=o.split(/\r?\n/);o=(_=m.pop())!=null?_:"";for(let b of m)h(b)}),s.stderr.on("data",g=>{l+=g.toString()}),s.on("error",g=>{this.handlePythonProcessError(String(g)),a(g)}),s.on("close",g=>{o.trim()&&h(o),!p&&c&&i(c),g===0?r():(this.handlePythonProcessError(l),a(new Error(l||`Process exited with code ${g}`)))})})}runCommandStreaming(e,n,t,i){return new Promise((r,a)=>{let s=(0,F.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:t==null?void 0:t.env}),o=c=>{c.toString().split(/\r?\n/).forEach(h=>{h.trim()&&i(h)})},l="";s.stdout.on("data",o),s.stderr.on("data",c=>{l+=c.toString(),o(c)}),s.on("error",c=>{a(c)}),s.on("close",c=>{c===0?r():a(new Error(l||`Process exited with code ${c}`))})})}handlePythonProcessError(e){if(!e)return;let n=e.match(/ModuleNotFoundError:\s+No module named ['"]([^'"]+)['"]/);if(n){let t=`Python env missing module '${n[1]}'. Run "Python environment" in settings.`;this.notifyPythonEnvOnce(t);return}if(/No module named ['"]/.test(e)){this.notifyPythonEnvOnce('Python env missing required modules. Run "Python environment" in settings.');return}/ENOENT|No such file or directory|not found/.test(e)&&this.notifyPythonEnvOnce('Python not found. Configure Python path or run "Python environment" in settings.')}notifyPythonEnvOnce(e){this.lastPythonEnvNotice!==e&&(this.lastPythonEnvNotice=e,new d.Notice(e))}notifyContainerOnce(e){this.lastContainerNotice!==e&&(this.lastContainerNotice=e,new d.Notice(e))}getLogsDirRelative(){return(0,d.normalizePath)(`${O}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,d.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,d.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;if(!await n.exists(e)){new d.Notice("Log file not found.");return}try{let t=await n.read(e);new ee(this.app,"Docling log",t||"(empty)").open()}catch(t){new d.Notice("Failed to open log file."),console.error(t)}}async clearLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{let t=(0,d.normalizePath)(f.default.dirname(e));t&&await this.ensureFolder(t),await n.write(e,""),new d.Notice("Log file cleared.")}catch(t){new d.Notice("Failed to clear log file."),console.error(t)}}runPythonWithOutput(e,n){return new Promise((t,i)=>{let r=(0,F.spawn)(this.settings.pythonPath,[e,...n],{cwd:f.default.dirname(e)}),a="",s="";r.stdout.on("data",o=>{a+=o.toString()}),r.stderr.on("data",o=>{s+=o.toString()}),r.on("error",o=>{this.handlePythonProcessError(String(o)),i(o)}),r.on("close",o=>{o===0?t(a.trim()):(this.handlePythonProcessError(s),i(new Error(s||`Process exited with code ${o}`)))})})}},ie=class extends d.SuggestModal{constructor(e,n,t){super(e);this.lastError=null;this.indexedDocIds=null;this.plugin=n,this.resolveSelection=t,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){try{if(!this.indexedDocIds){let n=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(n))}return await this.plugin.searchZoteroItems(e)}catch(n){let t=n instanceof Error?n.message:String(n);return this.lastError!==t&&(this.lastError=t,new d.Notice(t)),console.error("Zotero search failed",n),[]}}renderSuggestion(e,n){var p,h,g;let t=(h=(p=e.data)==null?void 0:p.title)!=null?h:"[No title]",i=this.extractYear(e),r=this.getDocId(e),a=r?(g=this.indexedDocIds)==null?void 0:g.has(r):!1,s=this.getPdfStatus(e);a&&n.addClass("zrr-indexed-item"),s==="no"&&n.addClass("zrr-no-pdf-item"),n.createEl("div",{text:t});let o=n.createEl("small"),l=!1,c=()=>{l&&o.createSpan({text:" \u2022 "})};i&&(o.createSpan({text:i}),l=!0),a&&(c(),o.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),l=!0),s==="no"&&(c(),o.createSpan({text:"No attachment",cls:"zrr-no-pdf-flag"}),l=!0),n.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,n){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}getDocId(e){var t,i,r;let n=(r=(i=e.key)!=null?i:(t=e.data)==null?void 0:t.key)!=null?r:"";return typeof n=="string"?n:""}getPdfStatus(e){var i,r,a,s,o,l,c;let n=(l=(o=(a=(i=e.data)==null?void 0:i.attachments)!=null?a:(r=e.data)==null?void 0:r.children)!=null?o:(s=e.data)==null?void 0:s.items)!=null?l:[];if(Array.isArray(n)&&n.length>0)return n.some(h=>this.isPdfAttachment(h))?"yes":"no";let t=(c=e.meta)==null?void 0:c.numChildren;return typeof t=="number"&&t===0?"no":"unknown"}isPdfAttachment(e){var t,i,r,a,s,o;return((o=(s=(r=(t=e==null?void 0:e.contentType)!=null?t:e==null?void 0:e.mimeType)!=null?r:(i=e==null?void 0:e.data)==null?void 0:i.contentType)!=null?s:(a=e==null?void 0:e.data)==null?void 0:a.mimeType)!=null?o:"")==="application/pdf"}extractYear(e){var i,r,a,s;let n=(s=(a=(i=e.meta)==null?void 0:i.parsedDate)!=null?a:(r=e.data)==null?void 0:r.date)!=null?s:"";if(typeof n!="string")return"";let t=n.match(/\b(\d{4})\b/);return t?t[1]:""}};

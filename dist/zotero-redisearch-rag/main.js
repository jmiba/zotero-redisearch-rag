...
`:"",f=(this.settings.noteBodyTemplate||"").trim(),v=`${y}${s}`,w=f?this.renderTemplate(f,b,v,{appendDocling:!0}):v;return`${_}${w}`}async renderFrontmatter(e,n,t,i,r,a){var l;let s=(l=this.settings.frontmatterTemplate)!=null?l:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,n,t,i,r);return this.renderTemplate(s,o,"",{appendDocling:!1}).trim()}renderTemplate(e,n,t,i={}){let r=e.replace(/{{\s*([a-z0-9_]+)\s*}}/gi,(a,s)=>{var o;return(o=n[s])!=null?o:""});return i.appendDocling&&!e.includes("{{docling_markdown}}")&&n.docling_markdown&&(r=`${r}

"use strict";var ue=Object.create;var U=Object.defineProperty;var ge=Object.getOwnPropertyDescriptor;var he=Object.getOwnPropertyNames;var _e=Object.getPrototypeOf,fe=Object.prototype.hasOwnProperty;var me=(L,u)=>{for(var e in u)U(L,e,{get:u[e],enumerable:!0})},ae=(L,u,e,n)=>{if(u&&typeof u=="object"||typeof u=="function")for(let t of he(u))!fe.call(L,t)&&t!==e&&U(L,t,{get:()=>u[t],enumerable:!(n=ge(u,t))||n.enumerable});return L};var V=(L,u,e)=>(e=L!=null?ue(_e(L)):{},ae(u||!L||!L.__esModule?U(e,"default",{value:L,enumerable:!0}):e,L)),ye=L=>ae(U({},"__esModule",{value:!0}),L);var xe={};me(xe,{default:()=>K});module.exports=ye(xe);var d=require("obsidian"),O=require("child_process"),D=require("fs"),de=V(require("http")),pe=V(require("https")),ee=V(require("net")),f=V(require("path")),G=require("url"),W=require("crypto");var x=require("obsidian"),z=".zotero-redisearch-rag",$=`${z}/items`,F=`${z}/chunks`,se={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}

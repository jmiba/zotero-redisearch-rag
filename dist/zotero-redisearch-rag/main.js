"use strict";var bn=Object.create;var Ue=Object.defineProperty;var xn=Object.getOwnPropertyDescriptor;var kn=Object.getOwnPropertyNames;var wn=Object.getPrototypeOf,vn=Object.prototype.hasOwnProperty;var Pn=(f,u)=>{for(var e in u)Ue(f,e,{get:u[e],enumerable:!0})},Rt=(f,u,e,t)=>{if(u&&typeof u=="object"||typeof u=="function")for(let n of kn(u))!vn.call(f,n)&&n!==e&&Ue(f,n,{get:()=>u[n],enumerable:!(t=xn(u,n))||t.enumerable});return f};var be=(f,u,e)=>(e=f!=null?bn(wn(f)):{},Rt(u||!f||!f.__esModule?Ue(e,"default",{value:f,enumerable:!0}):e,f)),Cn=f=>Rt(Ue({},"__esModule",{value:!0}),f);var Xn={};Pn(Xn,{default:()=>pt});module.exports=Cn(Xn);var m=require("obsidian");var Ft=require("@codemirror/state"),re=require("@codemirror/view"),Mt=require("obsidian");var xe=/<!--\s*zrr:sync-start[^>]*-->/i,Pe=/<!--\s*zrr:sync-end\s*-->/i,ge=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ne=/<!--\s*zrr:chunk\s+end\s*-->/i,Le=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,Nt=f=>{let u=f.trim();if(!u.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(u)){let _=u.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:_?_[2]:void 0}}if(/^zrr:sync-end\b/i.test(u))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(u)){let _=u.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),g=u.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:_?_[2]:void 0,attachmentKey:g?g[2]:void 0}}if(/^zrr:annotations-end\b/i.test(u))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(u))return{type:"chunk-end"};let e=u.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let t=e[1]||"",n=t.match(/\bid=(["']?)([^"'\s]+)\1/i),i=n?n[2]:"",r=t.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:t.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(t)||/\bdelete\b/i.test(t),p=/\bsection\b/i.test(t);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:p?"section":c?"page":"section"}},De=f=>{var l;if(!f)return null;let u=f.match(ge);if(!u)return null;let e=u[1]||"",t=e.match(/\bid=(["']?)([^"'\s]+)\1/i),n=t?t[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=n&&(l=gt(n))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:n,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Ze=f=>{for(let u=1;u<=f.lines;u+=1){let e=f.line(u).text;if(xe.test(e)){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i);return t?t[2].trim():null}}return null},_t=(f,u)=>{let e=u;for(;e>=1;e-=1){let t=f.line(e).text;if(ge.test(t))return{line:e,text:t};if(xe.test(t)||Pe.test(t))break}return null},An=(f,u)=>{for(let e=u;e<=f.lines;e+=1){let t=f.line(e).text;if(Ne.test(t))return e;if(Pe.test(t))break}return null},Lt=(f,u)=>{let e=_t(f,u);if(!e)return null;let t=An(f,e.line+1);return t===null||u<e.line||u>t?null:{startLine:e.line,endLine:t,text:e.text}},Dt=(f,u,e)=>{if(u>e)return!1;for(let t=u;t<=e;t+=1){let n=f.line(t).text;if(Le.test(n))return!0}return!1},gt=f=>{var n;if(!f)return null;let e=(f.includes(":")&&(n=f.split(":").pop())!=null?n:f).match(/^p(\d+)$/i);if(!e)return null;let t=Number.parseInt(e[1],10);return Number.isFinite(t)?t:null};var Tt=f=>{if(!f)return null;let u=f.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return u?De(u[0]):null};var En=(f,u)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),f.type==="sync-start"||f.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(f.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),f.type==="sync-start"?e.textContent=f.docId?`Redis Index Sync start - ${f.docId}`:"Redis Index Sync start":e.textContent="Redis index sync end",e;if(f.type==="annotations-start"||f.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),f.type==="annotations-start"){let t=f.docId?` - ${f.docId}`:"";e.textContent=`Zotero annotations start${t}`}else e.textContent="Zotero annotations end";return e}if(f.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=f.chunkKind==="page"?"Page end":"Section end",f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),e;if(f.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),f.excluded&&e.classList.add("is-excluded"),f.pageNumber&&u>0)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber}/${u})`}else e.textContent=`Page ${f.pageNumber}/${u}`;else if(f.pageNumber)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber})`}else e.textContent=`Page ${f.pageNumber}`;else f.chunkId?e.textContent=`Section ${f.chunkId}`:e.textContent="Section";return f.excluded&&(e.textContent=`${e.textContent} - excluded`),e},ht=class extends re.WidgetType{constructor(u,e,t,n,i){super(),this.plugin=u,this.docId=e,this.chunkId=t,this.startLine=n,this.excluded=i}eq(u){return this.docId===u.docId&&this.chunkId===u.chunkId&&this.startLine===u.startLine&&this.excluded===u.excluded}toDOM(){let u=document.createElement("span");u.className="zrr-chunk-toolbar",u.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},t=(c,d,p)=>{let _=document.createElement("span");_.className="zrr-chunk-button-icon",(0,Mt.setIcon)(_,d);let g=document.createElement("span");g.className="zrr-chunk-button-label",g.textContent=p,c.appendChild(_),c.appendChild(g)},n=document.createElement("button");n.type="button",n.className="zrr-chunk-button",t(n,"sparkles","Clean"),e(n,"Clean this chunk with the OCR cleanup model"),n.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),u.appendChild(n);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",t(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),u.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",t(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),u.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",t(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),u.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return t(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),u.appendChild(s),u}ignoreEvent(){return!0}},Ot=(f,u)=>{var y;let e=f.state.doc,t=Ze(e);if(!t)return re.Decoration.none;let n=f.state.selection.main.head,i=e.lineAt(n).number,r=Lt(e,i);if(!r)return re.Decoration.none;let a=r.text.match(ge);if(!a)return re.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return re.Decoration.none;let l=o[2].trim();if(!l)return re.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=Dt(e,r.startLine+1,r.endLine-1),p=c||d,_=e.line(r.startLine),g=re.Decoration.widget({widget:new ht(u,t,l,r.startLine,p),side:1});return re.Decoration.set([g.range(_.to)])},ft=class extends re.WidgetType{constructor(u,e){super(),this.info=u,this.totalPages=e}toDOM(){var u;return(u=En(this.info,this.totalPages))!=null?u:document.createElement("span")}},It=f=>{var o,l;let u=f.dom.closest(".markdown-source-view");if(!u||!u.classList.contains("is-live-preview"))return re.Decoration.none;let e=f.state.doc,t=new Ft.RangeSetBuilder,n=[],i=[],r=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),p=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!p)continue;let _=Nt(p[1]);_&&(_.type==="chunk-start"?(_.chunkKind=(o=_.chunkKind)!=null?o:_.pageNumber?"page":"section",_.pageNumber&&(r=!0),_.chunkKind==="section"&&(a=!0)):_.type==="chunk-end"&&(_.chunkKind=(l=_.chunkKind)!=null?l:"section"),n.push({line:c,from:d.from,to:d.to,info:_}),_.pageNumber&&i.push(_.pageNumber))}if(!n.length)return re.Decoration.none;if(r&&!a)for(let c of n)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let c of n){let d=re.Decoration.replace({widget:new ft(c.info,s)});t.add(c.from,c.to,d)}return t.finish()},zt=()=>re.ViewPlugin.fromClass(class{constructor(f){this.decorations=It(f)}update(f){(f.docChanged||f.viewportChanged)&&(this.decorations=It(f.view))}},{decorations:f=>f.decorations}),qt=f=>re.ViewPlugin.fromClass(class{constructor(u){this.decorations=Ot(u,f)}update(u){(u.docChanged||u.selectionSet||u.viewportChanged)&&(this.decorations=Ot(u.view,f))}},{decorations:u=>u.decorations}),Sn=(f,u)=>{var t,n,i;if(!f||u<0)return null;let e=/\[\[([^\]\n]+)\]\]/g;for(let r of f.matchAll(e)){let a=(t=r[0])!=null?t:"",s=(n=r[1])!=null?n:"",o=(i=r.index)!=null?i:-1;if(o<0)continue;let l=o+a.length;if(u<o||u>l)continue;let c=s.indexOf("|");return(c>=0?s.slice(0,c):s).trim()||null}return null},jt=f=>re.ViewPlugin.fromClass(class{},{eventHandlers:{click(u,e){if(u.defaultPrevented||u.button!==0)return!1;let t=e.dom.closest(".markdown-source-view");if(!t||!t.classList.contains("is-live-preview"))return!1;let n=e.posAtCoords({x:u.clientX,y:u.clientY});if(n===null)return!1;let i=e.state.doc.lineAt(n),r=n-i.from,a=Sn(i.text,r);return!a||!a.includes("#zrr-chunk:")?!1:(u.preventDefault(),u.stopPropagation(),f.openInternalLinkInMain(a,f.getLivePreviewSourcePath()),!0)}}});var oe=require("child_process"),ee=require("fs"),Ct=be(require("http")),hn=be(require("https")),qe=be(require("net")),je=be(require("os")),fn=be(require("tls")),R=be(require("path")),At=require("url"),$e=require("crypto");var N=require("obsidian"),Vt=require("crypto"),Be=require("fs"),Ge=be(require("path")),ae=".zotero-redisearch-rag",le=`${ae}/items`,Q=`${ae}/chunks`,Ut=`${ae}/metadata_snapshots.json`,Zt=`${ae}/annotation_snapshots.json`,Rn="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",Ce="cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",Te="__custom__",$t=[{value:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",label:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1 (Fast multilingual)"},{value:"BAAI/bge-reranker-v2-m3",label:"BAAI/bge-reranker-v2-m3 (Best quality, heaviest)"},{value:"jinaai/jina-reranker-v2-base-multilingual",label:"jinaai/jina-reranker-v2-base-multilingual (Balanced multilingual)"}],He={pythonRuntime:"worker",pythonRuntimeMigrationV1Done:!1,showAdvancedPythonRuntimeOptions:!1,pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,firstContainerStartupNoticeShown:!1,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:Ce,rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${ae}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},We=class extends N.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async h=>{this.plugin.settings.llmProviderProfiles=h,await this.plugin.saveSettings()},i=h=>{h.inputEl.type="password",h.inputEl.autocomplete="off",h.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:h=>{new N.Setting(h).setName("Prerequisites").setHeading();let b=null,w=null,v=null,S=null,P=null,E=null,T=null,L=null,q=null,F=(I,j)=>{I&&(I.settingEl.classList.toggle("is-disabled",j),I.settingEl.classList.toggle("zrr-setting-disabled",j))},W=(I,j)=>{I&&I.settingEl.classList.toggle("zrr-setting-hidden",!j)},M=()=>{let I=!!this.plugin.settings.showAdvancedPythonRuntimeOptions,j=this.plugin.settings.pythonRuntime==="local",$=I&&j;w==null||w.setDisabled(!I),F(b,!I),W(v,I),W(S,I),W(P,I),E==null||E.setDisabled(!$),T==null||T.setDisabled(!$),q==null||q.setDisabled(!$),L&&(L.disabled=!$),F(v,!$),F(S,!$),F(P,!$)};new N.Setting(h).setName("Docker/podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(I=>I.setPlaceholder("Docker").setValue(this.plugin.settings.dockerPath).onChange(async j=>{this.plugin.settings.dockerPath=j.trim()||"docker",await this.plugin.saveSettings()})),new N.Setting(h).setName("Advanced python runtime options").setDesc("Show legacy local interpreter/venv controls. Recommended to keep this disabled.").addToggle(I=>I.setValue(this.plugin.settings.showAdvancedPythonRuntimeOptions).onChange(async j=>{this.plugin.settings.showAdvancedPythonRuntimeOptions=j,!j&&this.plugin.settings.pythonRuntime==="local"&&(this.plugin.settings.pythonRuntime="worker",new N.Notice("Switched python runtime to worker mode.")),await this.plugin.saveSettings(),M()})),b=new N.Setting(h).setName("Python runtime").setDesc("Worker runtime is recommended. Enable advanced options to expose local interpreter/venv mode.").addDropdown(I=>{w=I,I.addOption("worker","Python worker container (recommended)"),I.addOption("local","Local interpreter/venv"),I.setValue(this.plugin.settings.pythonRuntime).onChange(async j=>{j!=="worker"&&j!=="local"||(this.plugin.settings.pythonRuntime=j,await this.plugin.saveSettings(),M())})}),v=new N.Setting(h).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(I=>(E=I,I.setPlaceholder("Auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async j=>{this.plugin.settings.pythonPath=j.trim(),await this.plugin.saveSettings()}))),S=new N.Setting(h).setName("Python environment").setDesc("Local mode: create or update the plugin's python env. Worker mode: managed by docker startup.").addButton(I=>{q=I,L=I.buttonEl,I.setButtonText("Create/update").setCta(),I.onClick(async()=>{I.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{I.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),P=new N.Setting(h).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(I=>{T=I,I.addOption("shared","Shared user cache"),I.addOption("plugin","Plugin folder (.venv)"),I.setValue(this.plugin.settings.pythonEnvLocation).onChange(async j=>{j!=="shared"&&j!=="plugin"||(this.plugin.settings.pythonEnvLocation=j,await this.plugin.saveSettings())})}),M(),new N.Setting(h).setName("Redis URL").addText(I=>I.setPlaceholder("Redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async j=>{this.plugin.settings.redisUrl=j.trim(),await this.plugin.saveSettings()}));let G=null,O=null,Z=null,B=null,U=()=>{let I=this.plugin.settings.autoAssignRedisPort;Z==null||Z.setDisabled(I),B==null||B.setDisabled(I),G==null||G.settingEl.classList.toggle("is-disabled",I),O==null||O.settingEl.classList.toggle("is-disabled",I)};new N.Setting(h).setName("Auto-assign redis port").setDesc("When starting redis stack, pick a free local port and update the redis URL.").addToggle(I=>I.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async j=>{this.plugin.settings.autoAssignRedisPort=j,await this.plugin.saveSettings(),U()})),G=new N.Setting(h).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(I=>(Z=I,I.setPlaceholder("~/redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async j=>{this.plugin.settings.redisDataDirOverride=j.trim(),await this.plugin.saveSettings()}))),G.settingEl.addClass("zrr-redis-override-setting"),O=new N.Setting(h).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(I=>(B=I,I.setPlaceholder("Zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async j=>{this.plugin.settings.redisProjectName=j.trim(),await this.plugin.saveSettings()}))),O.settingEl.addClass("zrr-redis-override-setting"),U(),new N.Setting(h).setName("Auto-start redis stack (docker/podman compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(I=>I.setValue(this.plugin.settings.autoStartRedis).onChange(async j=>{this.plugin.settings.autoStartRedis=j,await this.plugin.saveSettings()})),new N.Setting(h).setName("Start redis stack now").setDesc("Starts or restarts redis stack (and python worker in worker mode).").addButton(I=>I.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:h=>{new N.Setting(h).setName("Zotero local API").setHeading(),new N.Setting(h).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. HTTP://127.0.0.1:23119/API").addText(P=>P.setPlaceholder("HTTP://127.0.0.1:23119/API").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async E=>{this.plugin.settings.zoteroBaseUrl=E.trim(),await this.plugin.saveSettings()}));let b=new N.Setting(h).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),w=null,v=P=>{if(!w)return;let E=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(P.map(L=>L.value)).has(E)||(P=P.concat([{value:E,label:`Custom (${E})`}])),w.selectEl.options.length=0;for(let L of P)w.addOption(L.value,L.label);w.setValue(E)},S=async()=>{if(w){w.setDisabled(!0);try{let P=await this.plugin.fetchZoteroLibraryOptions();v(P)}finally{w.setDisabled(!1)}}};b.addDropdown(P=>{w=P;let E=(this.plugin.settings.zoteroUserId||"0").trim()||"0";P.addOption(E,"Loading..."),P.setValue(E),P.onChange(async T=>{this.plugin.settings.zoteroUserId=T.trim(),await this.plugin.saveSettings()})}),b.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),new N.Setting(h).setName("Zotero web API").setHeading(),new N.Setting(h).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(P=>P.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async E=>{this.plugin.settings.webApiBaseUrl=E.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API library type").setDesc("Library type for web API writes.").addDropdown(P=>P.addOption("user","User").addOption("group","Group").setValue(this.plugin.settings.webApiLibraryType).onChange(async E=>{this.plugin.settings.webApiLibraryType=E,await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for web API writes.").addText(P=>P.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async E=>{this.plugin.settings.webApiLibraryId=E.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API key").setDesc("Zotero API key for write fallback (from Zotero.org).").addText(P=>{i(P),P.setPlaceholder("Your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async E=>{this.plugin.settings.webApiKey=E.trim(),await this.plugin.saveSettings()})}),new N.Setting(h).setName("Output").setHeading(),new N.Setting(h).setName("PDF folder").addText(P=>P.setPlaceholder("Zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async E=>{this.plugin.settings.outputPdfDir=E.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Notes folder").addText(P=>P.setPlaceholder("Zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async E=>{this.plugin.settings.outputNoteDir=E.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(P=>{P.setValue(this.plugin.settings.frontmatterTemplate).onChange(async E=>{this.plugin.settings.frontmatterTemplate=E,await this.plugin.saveSettings()}),P.inputEl.rows=10,P.inputEl.addClass("zrr-u-width-100")}),new N.Setting(h).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(P=>P.addOption("none","No change").addOption("camel","Camelcase").addOption("pascal","Pascalcase").addOption("snake","Snake_case").addOption("kebab","Kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async E=>{this.plugin.settings.tagSanitizeMode=E,await this.plugin.saveSettings()})),new N.Setting(h).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(P=>{P.setValue(this.plugin.settings.noteBodyTemplate).onChange(async E=>{this.plugin.settings.noteBodyTemplate=E,await this.plugin.saveSettings()}),P.inputEl.rows=8,P.inputEl.addClass("zrr-u-width-100")}),new N.Setting(h).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(P=>P.setPlaceholder("Zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async E=>{this.plugin.settings.chatOutputDir=E.trim()||"zotero/chats",await this.plugin.saveSettings()})),new N.Setting(h).setName("Copy pdfs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(P=>P.setValue(this.plugin.settings.copyPdfToVault).onChange(async E=>{this.plugin.settings.copyPdfToVault=E,!E&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new N.Setting(h).setName("Create ocr-layered PDF copy").setDesc("When ocr is used, replace the vault PDF with a tesseract text layer (requires copy pdfs into vault).").addToggle(P=>{let E=this.plugin.settings.copyPdfToVault;P.setValue(E?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!E).onChange(async T=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=T,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(P=>P.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async E=>{this.plugin.settings.preferObsidianNoteForCitations=E,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:h=>{new N.Setting(h).setName("Annotations").setHeading(),new N.Setting(h).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(S=>S.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async P=>{this.plugin.settings.annotationPageLabel=P.trim()||"Page",await this.plugin.saveSettings()})),new N.Setting(h).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(S=>S.setValue(this.plugin.settings.includeAnnotationImages).onChange(async P=>{this.plugin.settings.includeAnnotationImages=P,await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion").setHeading(),h.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new N.Setting(h).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(S=>S.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async P=>{this.plugin.settings.zoteroCompanionEnabled=P,await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(S=>S.setPlaceholder("HTTP://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async P=>{this.plugin.settings.zoteroCompanionBaseUrl=P.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(S=>{i(S),this.companionTokenInput=S,S.setPlaceholder("Optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async P=>{this.plugin.settings.zoteroCompanionToken=P.trim(),await this.plugin.saveSettings()})}),new N.Setting(h).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero companion plugin token to this value.").addButton(S=>S.setButtonText("Generate token").onClick(async()=>{let P=(0,Vt.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=P,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(P);try{await navigator.clipboard.writeText(P),new N.Notice("Generated and copied companion token.")}catch(E){new N.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",E)}})),new N.Setting(h).setName("Annotation color map").setHeading(),h.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let b=h.createDiv({cls:"zrr-annotation-map"}),w=async S=>{this.plugin.settings.annotationColorMap=S,await this.plugin.saveSettings()},v=()=>{var q,F;b.empty();let S=this.plugin.settings.annotationColorMap||{},P=Object.entries(S);if(P.length||b.createEl("p",{text:"No color mappings configured."}),P.length){let W=b.createDiv({cls:"zrr-annotation-map-row-header"});W.createEl("span",{text:"Color"}),W.createEl("span",{text:"Heading"}),W.createEl("span",{text:"Callout"}),W.createEl("span")}for(let[W,M]of P){let O=b.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),Z=O.createEl("input",{type:"text",value:W,cls:"zrr-annotation-map-input"}),B=O.createEl("input",{type:"text",value:(q=M.heading)!=null?q:"",cls:"zrr-annotation-map-input"}),U=O.createEl("input",{type:"text",value:(F=M.callout)!=null?F:"",cls:"zrr-annotation-map-input"}),I=O.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});I.type="button",Z.addEventListener("change",()=>{(async()=>{let j=Z.value.trim().toLowerCase();if(!j){Z.value=W;return}let $={...this.plugin.settings.annotationColorMap||{}};if(j!==W&&$[j]){new N.Notice(`Annotation color '${j}' already exists.`),Z.value=W;return}let z=$[W];delete $[W],$[j]=z!=null?z:{heading:"",callout:""},await w($),v()})()}),B.addEventListener("change",()=>{(async()=>{var z;let j={...this.plugin.settings.annotationColorMap||{}},$=(z=j[W])!=null?z:{heading:"",callout:""};$.heading=B.value.trim(),j[W]=$,await w(j)})()}),U.addEventListener("change",()=>{(async()=>{var z;let j={...this.plugin.settings.annotationColorMap||{}},$=(z=j[W])!=null?z:{heading:"",callout:""};$.callout=U.value.trim(),j[W]=$,await w(j)})()}),I.addEventListener("click",()=>{(async()=>{let j={...this.plugin.settings.annotationColorMap||{}};delete j[W],await w(j),v()})()})}let E=b.createDiv({cls:"zrr-annotation-map-actions"}),T=E.createEl("button",{text:"Add mapping"});T.type="button",T.addEventListener("click",()=>{(async()=>{let W={...this.plugin.settings.annotationColorMap||{}},M="new-color",G=1;for(;W[M];)M=`new-color-${G}`,G+=1;W[M]={heading:"",callout:""},await w(W),v()})()});let L=E.createEl("button",{text:"Reset to defaults"});L.type="button",L.addEventListener("click",()=>{(async()=>(await w({...He.annotationColorMap}),v()))()})};v()}},{id:"ocr",label:"OCR",render:h=>{new N.Setting(h).setName("Docling").setHeading();let b=null,w=E=>{if(!b)return;let T=this.plugin.settings.ocrEngine;new Set(E.map(q=>q.value)).has(T)||(E=E.concat([{value:T,label:`Current (unavailable): ${T}`}])),b.selectEl.options.length=0;for(let q of E)b.addOption(q.value,q.label);b.setValue(T)},v=async()=>{if(!b)return;b.setDisabled(!0);let E={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{E=await this.plugin.detectOcrEngines()}catch(q){E={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let T=[{value:"auto",label:"Auto (default)"}];E.tesseract&&T.push({value:"tesseract",label:"Tesseract (local)"}),E.paddleStructureLocal&&T.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),E.paddleVlLocal&&T.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(T.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),T.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),w(T),b.setDisabled(!1)},S=new N.Setting(h).setName("Paddle ocr API key").setDesc("API token for paddleocr-vl / pp-structurev3 endpoints. Get a free API key at "),P=document.createElement("a");P.href="https://aistudio.baidu.com/paddleocr",P.textContent="HTTPS://aistudio.baidu.com/paddleocr",P.target="_blank",P.rel="noopener noreferrer",S.descEl.appendChild(P),S.descEl.append("."),S.addText(E=>{i(E),E.setPlaceholder("Your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async T=>{this.plugin.settings.paddleApiKey=T.trim(),await this.plugin.saveSettings(),await v()})}),new N.Setting(h).setName("Paddleocr-vl API URL").setDesc("Optional override for the paddleocr-vl API endpoint.").addText(E=>E.setPlaceholder("HTTPS://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async T=>{this.plugin.settings.paddleVlApiUrl=T.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Pp-structurev3 API URL").setDesc("API endpoint for pp-structurev3 (see baidu AI studio docs).").addText(E=>E.setPlaceholder("HTTPS://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async T=>{this.plugin.settings.paddleStructureApiUrl=T.trim(),await this.plugin.saveSettings(),await v()})),new N.Setting(h).setName("Ocr engine").setDesc("Select the ocr engine to use when ocr is required.").addDropdown(E=>{b=E,E.addOption("auto","Auto (default)"),E.setValue(this.plugin.settings.ocrEngine),E.onChange(async T=>{this.plugin.settings.ocrEngine=T,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Ocr decision (when to ocr)").setDesc("Controls when ocr runs; per-page behavior is configured separately below.").addDropdown(E=>E.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","Ocr only if text is poor").addOption("force","Prefer ocr for full document").setValue(this.plugin.settings.ocrMode).onChange(async T=>{this.plugin.settings.ocrMode=T,await this.plugin.saveSettings()})),new N.Setting(h).setName("Ocr layout override (per-page)").setDesc("Force per-page ocr when ocr runs, bypassing layout heuristics; can be slower for multi-column pdfs.").addToggle(E=>E.setValue(this.plugin.settings.forcePerPageOcr).onChange(async T=>{this.plugin.settings.forcePerPageOcr=T,await this.plugin.saveSettings()})),new N.Setting(h).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(E=>{E.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async T=>{this.plugin.settings.ocrQualityThreshold=T,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Chunking").setDesc("Page or section").addDropdown(E=>E.addOption("page","Page").addOption("section","Section").setValue(this.plugin.settings.chunkingMode).onChange(async T=>{this.plugin.settings.chunkingMode=T,await this.plugin.saveSettings()})),v()}},{id:"llms",label:"LLMs",render:h=>{new N.Setting(h).setName("Model provider profiles").setHeading();let b=h.createDiv({cls:"zrr-llm-profiles"}),w=()=>{b.empty();let C=t();C.length||b.createEl("p",{text:"No profiles yet. Add one below."});for(let A of C){let D=b.createEl("details",{cls:"zrr-profile"});C.length===1&&(D.open=!0);let ie=D.createEl("summary",{text:A.name||A.id||"Profile"});ie.addClass("zrr-profile-title");let Ve=D.createDiv({cls:"zrr-profile-body"});new N.Setting(Ve).setName("Profile name").addText(me=>me.setPlaceholder("My provider").setValue(A.name||"").onChange(async ye=>{A.name=ye.trim(),ie.textContent=A.name||A.id||"Profile",await n(t())})),new N.Setting(Ve).setName("Base URL").addText(me=>me.setPlaceholder("HTTP://localhost:1234/v1").setValue(A.baseUrl||"").onChange(async ye=>{A.baseUrl=ye.trim(),await n(t())})),new N.Setting(Ve).setName("API key").setDesc("Stored in settings (not encrypted).").addText(me=>{i(me),me.setPlaceholder("Sk-...").setValue(A.apiKey||"").onChange(async ye=>{A.apiKey=ye.trim(),await n(t())})}),new N.Setting(Ve).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(me=>me.setButtonText("Delete profile").onClick(async()=>{let ye=t().filter(yn=>yn.id!==A.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===A.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===A.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===A.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(ye),w()}))}new N.Setting(b).addButton(A=>A.setButtonText("Add profile").onClick(async()=>{let D=`profile-${Date.now().toString(36)}`,ie=t().concat([{id:D,name:"Custom",baseUrl:"",apiKey:""}]);await n(ie),w()}))};w(),new N.Setting(h).setName("Ocr cleanup").setHeading(),new N.Setting(h).setName("Model cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor ocr at import. Can be slow/costly.").addToggle(C=>C.setValue(this.plugin.settings.enableLlmCleanup).onChange(async A=>{this.plugin.settings.enableLlmCleanup=A,await this.plugin.saveSettings()}));let v=null,S=null,P=null,E=()=>Promise.resolve(),T=async(C,A=!0)=>{let D=C.trim();this.plugin.settings.llmCleanupBaseUrl=D,A&&(this.plugin.settings.llmCleanupProviderProfileId="",v&&v.setValue("custom")),S&&S.setValue(D),await this.plugin.saveSettings()},L=async C=>{let A=t().find(D=>D.id===C);this.plugin.settings.llmCleanupProviderProfileId=C,A&&(this.plugin.settings.llmCleanupBaseUrl=A.baseUrl,this.plugin.settings.llmCleanupApiKey=A.apiKey,S==null||S.setValue(A.baseUrl),P==null||P.setValue(A.apiKey)),await this.plugin.saveSettings(),await E()};new N.Setting(h).setName("Cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{v=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let A=this.plugin.settings.llmCleanupProviderProfileId;C.setValue(A&&t().some(D=>D.id===A)?A:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await L(D)})}),new N.Setting(h).setName("Cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. HTTP://127.0.0.1:1234/v1").addText(C=>{S=C,C.setPlaceholder("HTTP://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async A=>{await T(A)})}),new N.Setting(h).setName("Cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(C=>{P=C,i(C),C.setPlaceholder("Sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async A=>{this.plugin.settings.llmCleanupApiKey=A.trim(),this.plugin.settings.llmCleanupProviderProfileId="",v&&v.setValue("custom"),await this.plugin.saveSettings()})});let q=new N.Setting(h).setName("Cleanup model").setDesc("Select a cleanup-capable model from the provider."),F=null,W=C=>{if(!F)return;let A=(this.plugin.settings.llmCleanupModel||"").trim(),D=new Set(C.map(ie=>ie.value));A&&!D.has(A)&&(C=C.concat([{value:A,label:`Custom (${A})`}])),F.selectEl.options.length=0;for(let ie of C)F.addOption(ie.value,ie.label);A&&F.setValue(A)};E=async()=>{if(F){F.setDisabled(!0);try{let C=await this.plugin.fetchCleanupModelOptions();W(C)}finally{F.setDisabled(!1)}}},q.addDropdown(C=>{F=C;let A=(this.plugin.settings.llmCleanupModel||"").trim();C.addOption(A||"loading","Loading..."),C.setValue(A||"loading"),C.onChange(async D=>{this.plugin.settings.llmCleanupModel=D.trim(),await this.plugin.saveSettings()})}),q.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await E()})}),E(),new N.Setting(h).setName("Cleanup temperature").setDesc("Lower is more conservative.").addText(C=>C.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async A=>{let D=Number.parseFloat(A);this.plugin.settings.llmCleanupTemperature=Number.isFinite(D)?D:0,await this.plugin.saveSettings()})),new N.Setting(h).setName("Cleanup minimum quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(C=>C.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async A=>{this.plugin.settings.llmCleanupMinQuality=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Cleanup maximum chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(C=>C.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(D)?D:2e3,await this.plugin.saveSettings()})),new N.Setting(h).setName("Text embedding").setHeading();let M=null,G=null,O=null,Z=()=>Promise.resolve(),B=async(C,A=!0)=>{let D=C.trim();this.plugin.settings.embedBaseUrl=D,A&&(this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom")),G&&G.setValue(D),await this.plugin.saveSettings()},U=async C=>{let A=t().find(D=>D.id===C);this.plugin.settings.embedProviderProfileId=C,A&&(this.plugin.settings.embedBaseUrl=A.baseUrl,this.plugin.settings.embedApiKey=A.apiKey,G==null||G.setValue(A.baseUrl),O==null||O.setValue(A.apiKey)),await this.plugin.saveSettings(),await Z()};new N.Setting(h).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{M=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let A=this.plugin.settings.embedProviderProfileId;C.setValue(A&&t().some(D=>D.id===A)?A:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await U(D)})}),new N.Setting(h).setName("Embeddings base URL").addText(C=>{G=C,C.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async A=>{await B(A)})}),new N.Setting(h).setName("Embeddings API key").addText(C=>{O=C,i(C),C.setPlaceholder("Lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async A=>{this.plugin.settings.embedApiKey=A.trim(),this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom"),await this.plugin.saveSettings()})});let I=new N.Setting(h).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),j=null,$=C=>{if(!j)return;let A=(this.plugin.settings.embedModel||"").trim(),D=new Set(C.map(ie=>ie.value));A&&!D.has(A)&&(C=C.concat([{value:A,label:`Custom (${A})`}])),j.selectEl.options.length=0;for(let ie of C)j.addOption(ie.value,ie.label);A&&j.setValue(A)};Z=async()=>{if(j){j.setDisabled(!0);try{let C=await this.plugin.fetchEmbeddingModelOptions();$(C)}finally{j.setDisabled(!1)}}},I.addDropdown(C=>{j=C;let A=(this.plugin.settings.embedModel||"").trim();C.addOption(A||"loading","Loading..."),C.setValue(A||"loading"),C.onChange(async D=>{this.plugin.settings.embedModel=D.trim(),await this.plugin.saveSettings()})}),I.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await Z()})}),Z(),new N.Setting(h).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(C=>C.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async A=>{this.plugin.settings.embedIncludeMetadata=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(C=>C.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedContextWindow=Number.isFinite(D)?Math.max(0,D):1,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(C=>C.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedContextChars=Number.isFinite(D)?Math.max(0,D):220,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(C=>C.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(D)?Math.max(0,D):3500,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(C=>C.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(D)?Math.max(0,D):200,await this.plugin.saveSettings()})),new N.Setting(h).setName("Generate model tags for chunks").setDesc("Use the ocr cleanup model to tag chunks before indexing.").addToggle(C=>C.setValue(this.plugin.settings.enableChunkTagging).onChange(async A=>{this.plugin.settings.enableChunkTagging=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat model").setHeading();let z=null,V=null,H=null,ne=()=>Promise.resolve(),pe=async(C,A=!0)=>{let D=C.trim();this.plugin.settings.chatBaseUrl=D,A&&(this.plugin.settings.chatProviderProfileId="",z&&z.setValue("custom")),V&&V.setValue(D),await this.plugin.saveSettings()},fe=async C=>{let A=t().find(D=>D.id===C);this.plugin.settings.chatProviderProfileId=C,A&&(this.plugin.settings.chatBaseUrl=A.baseUrl,this.plugin.settings.chatApiKey=A.apiKey,V==null||V.setValue(A.baseUrl),H==null||H.setValue(A.apiKey)),await this.plugin.saveSettings(),await ne()};new N.Setting(h).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{z=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let A=this.plugin.settings.chatProviderProfileId;C.setValue(A&&t().some(D=>D.id===A)?A:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await fe(D)})}),new N.Setting(h).setName("Chat base URL").setDesc("Compatible endpoint for chat requests.").addText(C=>{V=C,C.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async A=>{await pe(A)})}),new N.Setting(h).setName("Chat API key").addText(C=>{H=C,i(C),C.setPlaceholder("Lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async A=>{this.plugin.settings.chatApiKey=A.trim(),this.plugin.settings.chatProviderProfileId="",z&&z.setValue("custom"),await this.plugin.saveSettings()})});let ve=new N.Setting(h).setName("Chat model").setDesc("Select a chat-capable model from the provider."),ce=null,ut=C=>{if(!ce)return;let A=(this.plugin.settings.chatModel||"").trim(),D=new Set(C.map(ie=>ie.value));A&&!D.has(A)&&(C=C.concat([{value:A,label:`Custom (${A})`}])),ce.selectEl.options.length=0;for(let ie of C)ce.addOption(ie.value,ie.label);A&&ce.setValue(A)};ne=async()=>{if(ce){ce.setDisabled(!0);try{let C=await this.plugin.fetchChatModelOptions();ut(C)}finally{ce.setDisabled(!1)}}},ve.addDropdown(C=>{ce=C;let A=(this.plugin.settings.chatModel||"").trim();C.addOption(A||"loading","Loading..."),C.setValue(A||"loading"),C.onChange(async D=>{this.plugin.settings.chatModel=D.trim(),await this.plugin.saveSettings()})}),ve.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await ne()})}),ne(),new N.Setting(h).setName("Temperature").addText(C=>C.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async A=>{let D=Number.parseFloat(A);this.plugin.settings.chatTemperature=Number.isFinite(D)?D:.2,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(C=>C.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(D)?Math.max(0,D):6,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(C=>C.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async A=>{this.plugin.settings.chatPaneLocation=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Retrieval").setHeading(),new N.Setting(h).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(C=>C.setValue(this.plugin.settings.enableAgenticRag).onChange(async A=>{this.plugin.settings.enableAgenticRag=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(C=>C.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.agenticMaxIters=Number.isFinite(D)?Math.max(1,D):2,await this.plugin.saveSettings()})),new N.Setting(h).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(C=>C.setValue(this.plugin.settings.enableQueryExpansion).onChange(async A=>{this.plugin.settings.enableQueryExpansion=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(C=>C.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.queryExpansionCount=Number.isFinite(D)?Math.max(1,D):3,await this.plugin.saveSettings()})),new N.Setting(h).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(C=>C.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async A=>{this.plugin.settings.enableCrossEncoderRerank=A,await this.plugin.saveSettings()}));let X=new Set($t.map(C=>C.value)),Y=(this.plugin.settings.rerankModel||"").trim()||Ce,_e=X.has(Y)?Y:Te,se=null,Et=()=>{if(!se)return;let A=!(_e===Te);se.setDisabled(A),se.inputEl.disabled=A,se.inputEl.readOnly=A,se.inputEl.classList.toggle("is-disabled",A),se.inputEl.setAttribute("aria-disabled",String(A))},St=new N.Setting(h).setName("Cross-encoder model").setDesc("Choose a multilingual preset, or select custom to edit the model ID.");St.addDropdown(C=>{for(let A of $t)C.addOption(A.value,A.label);C.addOption(Te,"Custom"),C.setValue(_e),C.onChange(async A=>{_e=A,A!==Te?this.plugin.settings.rerankModel=A:(this.plugin.settings.rerankModel||"").trim()||(this.plugin.settings.rerankModel=Ce),await this.plugin.saveSettings(),se==null||se.setValue(this.plugin.settings.rerankModel||Ce),Et()})}),St.addText(C=>{se=C,C.setPlaceholder(Ce).setValue(Y).onChange(async A=>{_e===Te&&(this.plugin.settings.rerankModel=A.trim()||Ce,await this.plugin.saveSettings())}),Et()}),new N.Setting(h).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 n candidates before reranking.").addText(C=>C.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(D)?Math.max(1,D):4,await this.plugin.saveSettings()})),new N.Setting(h).setName("Rrf k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(C=>C.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rrfK=Number.isFinite(D)?Math.max(1,D):60,await this.plugin.saveSettings()})),new N.Setting(h).setName("Rrf log top n").setDesc("Log the top n rrf-ranked chunks to stderr (0 disables).").addText(C=>C.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rrfLogTop=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()})),new N.Setting(h).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(C=>C.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:h=>{new N.Setting(h).setName("Python runtime").setHeading(),new N.Setting(h).setName("Use local runtime (legacy)").setDesc("Switch to local interpreter/venv mode and enable advanced runtime settings.").addButton(b=>b.setButtonText("Switch").onClick(async()=>{await this.plugin.switchPythonRuntimeToLocalLegacy()})),new N.Setting(h).setName("Logging").setHeading(),new N.Setting(h).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(b=>b.setValue(this.plugin.settings.enableFileLogging).onChange(async w=>{this.plugin.settings.enableFileLogging=w,await this.plugin.saveSettings()})),new N.Setting(h).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(b=>b.setPlaceholder(`${ae}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async w=>{this.plugin.settings.logFilePath=w.trim()||`${ae}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new N.Setting(h).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(b=>b.setButtonText("Open log").onClick(async()=>{var w,v;await((v=(w=this.plugin).openLogFile)==null?void 0:v.call(w))})).addButton(b=>b.setButtonText("Clear log").onClick(async()=>{var w,v;await((v=(w=this.plugin).clearLogFile)==null?void 0:v.call(w))})),new N.Setting(h).setName("Zotero companion plugin").setHeading(),h.createEl("p",{text:"Download the xpi, then in Zotero go to tools \u2192 add-ons \u2192 install from file and restart."}),new N.Setting(h).setName("Download companion add-on").setDesc("Downloads the companion xpi to your system downloads folder.").addButton(b=>b.setButtonText("Download xpi").onClick(async()=>{let w=this.getDefaultDownloadDir();if(!w){new N.Notice("Unable to resolve the system downloads folder.");return}let v=Ge.default.join(w,"zrr-companion.xpi");if(await this.companionXpiExists(v)){new N.Notice(`Companion XPI already exists: ${v}`);return}new N.Notice("Downloading companion xpi..."),await this.downloadCompanionXpi(v)})),new N.Setting(h).setName("Open Zotero").setDesc("Launch Zotero and open the add-ons window (tools \u2192 add-ons).").addButton(b=>b.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new N.Setting(h).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(b=>b.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),new N.Setting(h).setName("Redis indexing").setHeading(),new N.Setting(h).setName("Reindex redis from cached chunks").setDesc("Rebuild the redis index from cached chunk JSON files.").addButton(b=>b.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new N.Setting(h).setName("Recreate redis stack").setDesc("Pulls the configured redis image and force-recreates the redis-stack service.").addButton(b=>b.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateRedisStack()})),new N.Setting(h).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(b=>b.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(b=>b.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()})),new N.Setting(h).setName("Release notes").setHeading(),new N.Setting(h).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(b=>b.setButtonText("Show").onClick(()=>{this.plugin.openReleaseNotesModal()}))}}],p=new Map,_=new Map,g=h=>{this.activeTab=h;for(let[b,w]of p){let v=b===h;w.classList.toggle("is-active",v),w.setAttribute("aria-selected",v?"true":"false"),w.setAttribute("tabindex",v?"0":"-1")}for(let[b,w]of _){let v=b===h;w.classList.toggle("is-active",v),w.hidden=!v}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let k=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let h of d){let b=y.createEl("button",{text:h.label,cls:"zrr-settings-tab-button"}),w=`zrr-settings-tab-${h.id}`,v=`zrr-settings-panel-${h.id}`;b.type="button",b.id=w,b.setAttribute("role","tab"),b.setAttribute("aria-controls",v),b.setAttribute("aria-selected","false"),b.addEventListener("click",()=>g(h.id));let S=k.createDiv({cls:"zrr-settings-tab-panel"});S.id=v,S.setAttribute("role","tabpanel"),S.setAttribute("aria-labelledby",w),S.hidden=!0,h.render(S),p.set(h.id,b),_.set(h.id,S)}let x=d.some(h=>h.id===this.activeTab)?this.activeTab:d[0].id;g(x)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Ge.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await Be.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await Be.promises.mkdir(Ge.default.dirname(e),{recursive:!0});let t=await(0,N.requestUrl)({url:Rn,method:"GET"});if(t.status!==200){new N.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await Be.promises.writeFile(e,n),new N.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new N.Notice("Failed to download companion xpi. See console for details."),console.warn("Failed to download companion XPI",t)}}};var Bt=require("@codemirror/state"),Gt=require("@codemirror/view"),ue=require("obsidian");var Nn=f=>{let u=f.scrollDOM.getBoundingClientRect(),e=f.posAtCoords({x:u.left+8,y:+u.height*.25});return e===null?null:f.state.doc.lineAt(e).number},Oe=f=>!f||typeof f!="object"?null:f,Ke=class{constructor(u,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=u,this.helpers=e}createSyncExtension(){let u=this.helpers,e=this.syncPdfSidebarForDoc.bind(this);return Gt.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=u.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=u.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var p,_;let i=this.docId;if(!i)return;let r=Nn(t);if(r===null)return;let a=u.findChunkStartLineInDoc(t.state.doc,r);if(!a)return;let s=u.parseChunkMarkerLine(a.text),o=(p=s==null?void 0:s.pageNumber)!=null?p:null,l=(_=s==null?void 0:s.chunkId)!=null?_:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||d)||(this.lastPage=o,this.lastChunkId=l,e(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(u={}){if(!this.pendingPdfSync||!this.isPdfSidebarLeaf(this.pdfSidebarLeaf)&&!await this.getPdfSidebarLeaf(!!u.allowCreateLeaf)||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let e=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(e.docId,e.pageNumber,e.chunkId)}async revealPdfSidebar(u={}){let e=await this.getPdfSidebarLeaf(!!u.allowCreateLeaf);if(e)try{await this.deps.app.workspace.revealLeaf(e)}catch(t){console.warn("Failed to reveal PDF sidebar leaf",t)}}updatePreviewScrollHandler(){var n;let u=this.deps.app.workspace.getActiveViewOfType(ue.MarkdownView);if(!u||u.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=u.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(u);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(u)}async syncPdfSidebarForFile(u,e={}){try{let t=await this.deps.app.vault.read(u),n=await this.deps.resolveDocIdForNote(u,t);if(!n)return;let i=this.helpers.extractFirstChunkMarkerFromContent(t);await this.syncPdfSidebarForDoc(n,i==null?void 0:i.pageNumber,i==null?void 0:i.chunkId,e)}catch(t){console.warn("Failed to sync PDF sidebar for opened note",t)}}async syncPdfSidebarForDoc(u,e,t,n={}){if(u){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:u,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let i=await this.deps.getDocIndexEntry(u);i||(i=await this.deps.hydrateDocIndexFromCache(u));let r=i!=null&&i.pdf_path?String(i.pdf_path):"";if(!r)return;let a=this.deps.toVaultRelativePath(r);if(!a){let p=(0,ue.normalizePath)(r);this.deps.app.vault.getAbstractFileByPath(p)instanceof ue.TFile&&(a=p)}if(!a)return;let s=this.deps.app.vault.getAbstractFileByPath(a);if(!(s instanceof ue.TFile)||s.extension.toLowerCase()!=="pdf")return;let o=await this.getPdfSidebarLeaf(!!n.allowCreateLeaf);if(!o){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}if(!this.isLeafTabActive(o)&&!n.allowCreateLeaf){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}let l=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(l===null&&t&&(l=await this.resolvePageNumberForChunk(u,t)),l===null||this.isPdfSidebarLeaf(o)&&this.pdfSidebarLeaf===o&&this.pdfSidebarDocId===u&&this.pdfSidebarPdfPath===s.path&&this.pdfSidebarPage===l)return;let c=a,d=l!==null?`${c}#page=${l}`:c;if(await this.openPdfLinkInLeaf(o,s,d),this.pdfSidebarLeaf=o,this.pdfSidebarDocId=u,this.pdfSidebarPdfPath=s.path,this.pdfSidebarPage=l,this.updatePdfSidebarIcon(o),n.allowCreateLeaf&&!this.isLeafTabActive(o))try{await this.deps.app.workspace.revealLeaf(o)}catch(p){console.warn("Failed to reveal PDF sidebar leaf",p)}}finally{this.pdfSyncInFlight=!1;let i=this.queuedPdfSync;this.queuedPdfSync=null,i&&this.syncPdfSidebarForDoc(i.docId,i.pageNumber,i.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(u){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(u)}))}syncPdfSidebarForPreview(u){let e=this.previewScrollEl;if(!e)return;let t=u.getViewData();if(!t)return;let n=Bt.Text.of(t.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(n);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(n,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(u){var n;let e=u.getBoundingClientRect().top,t=u.querySelectorAll("[data-line]");for(let i of Array.from(t))if(i.getBoundingClientRect().bottom>=e+2){let a=(n=i.getAttribute("data-line"))!=null?n:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(u=!1){if(this.pdfSidebarLeaf&&this.isUsableRightSidebarLeaf(this.pdfSidebarLeaf)&&this.isPdfSidebarLeaf(this.pdfSidebarLeaf))return this.pdfSidebarLeaf;this.resetPdfSidebarLeaf();let e=this.findRightSidebarPdfLeaf();if(e)return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;if(u){let t=this.deps.app.workspace;if(typeof t.ensureSideLeaf=="function")try{let i=await t.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!1});if(this.isUsableRightSidebarLeaf(i))return this.pdfSidebarLeaf=i,i.isDeferred&&await i.loadIfDeferred(),this.updatePdfSidebarIcon(i),i}catch(i){console.warn("Failed to ensure PDF side leaf",i)}let n=this.deps.app.workspace.getRightLeaf(!1);if(this.isUsableRightSidebarLeaf(n))return this.pdfSidebarLeaf=n,n}return null}findRightSidebarPdfLeaf(){let u=this.deps.app.workspace;if(typeof u.iterateAllLeaves!="function")return null;let e=null;return u.iterateAllLeaves(t=>{if(!(!this.isUsableRightSidebarLeaf(t)||!this.isPdfSidebarLeaf(t))){if(this.isLeafTabActive(t)){e=t;return}e||(e=t)}}),e}resetPdfSidebarLeaf(){this.pdfSidebarLeaf=null,this.pdfSidebarDocId=null,this.pdfSidebarPdfPath=null,this.pdfSidebarPage=null}isUsableRightSidebarLeaf(u){var t;return this.isRightSidebarLeaf(u)?!!((t=u.containerEl)!=null&&t.isConnected):!1}getLeafViewType(u){var t,n;if(!u)return"";try{let i=u.getViewState();if(typeof(i==null?void 0:i.type)=="string"&&i.type)return i.type}catch(i){console.debug("Failed to read leaf view state",i)}let e=(n=(t=u.view)==null?void 0:t.getViewType)==null?void 0:n.call(t);return typeof e=="string"?e:""}isPdfSidebarLeaf(u){return this.getLeafViewType(u)==="pdf"}isRightSidebarLeaf(u){if(!u)return!1;let t=u.containerEl;return t?!!t.closest(".workspace-split.mod-right-split, .mod-right-split"):!1}updatePdfSidebarIcon(u){if(!u||!this.isRightSidebarLeaf(u)||!this.isPdfSidebarLeaf(u))return;let t=u.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let i=u;if(i.tabHeaderEl&&n.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&n.push(i.tabHeaderInnerIconEl),n.length===0)return;let r=new Set;for(let s of n)if(!r.has(s)){if(r.add(s),s.replaceChildren(),(0,ue.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg){let o=document.createRange().createContextualFragment(this.deps.iconSvg);s.replaceChildren(o)}s.dataset&&(s.dataset.zrrIcon="zrr-pdf")}let a=u.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(u,e,t){var l;if(!await this.ensurePdfLeafReady(u,e)){await u.openFile(e,{active:!1});return}let i=Oe((l=this.getPluginsRegistry())==null?void 0:l["pdf-plus"]),r=Oe(i==null?void 0:i.lib),a=Oe(r==null?void 0:r.workspace),s=typeof(a==null?void 0:a.openPDFLinkTextInLeaf)=="function"?a.openPDFLinkTextInLeaf:null;if(typeof s=="function")try{await s.call(a,u,t,"",{active:!1});return}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150)}let o=u;if(typeof o.openLinkText=="function"){try{await o.openLinkText(t,"",{active:!1})}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150),await o.openLinkText(t,"",{active:!1})}return}await u.openFile(e,{active:!1})}async ensurePdfLeafReady(u,e){if(this.isPdfSidebarLeaf(u))return!0;try{await u.setViewState({type:"pdf",active:!1})}catch(t){console.debug("Failed to set PDF view state on sidebar leaf",t)}if(u.isDeferred)try{await u.loadIfDeferred()}catch(t){console.debug("Failed to load deferred PDF sidebar leaf",t)}if(this.isPdfSidebarLeaf(u))return!0;try{await u.openFile(e,{active:!1})}catch(t){return console.warn("Failed to open PDF file in sidebar leaf",t),!1}return this.isPdfSidebarLeaf(u)}isPdfAnnotationRaceError(u){let e=u instanceof Error?u.message:typeof u=="string"?u:"";return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(u){return new Promise(e=>setTimeout(e,u))}getPluginsRegistry(){var e;return(e=this.deps.app.plugins)==null?void 0:e.plugins}isLeafTabActive(u){var i;let e=u;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===u;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(u,e){var l,c,d,p,_;if(!u||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,u)||e,n=this.chunkPageCache.get(u);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let i=(0,ue.normalizePath)(`${Q}/${u}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=Oe(await this.deps.readChunkPayload(i)),s=Array.isArray(a==null?void 0:a.chunks)?a.chunks:[],o=new Map;for(let g of s){let y=Oe(g),k=typeof(y==null?void 0:y.chunk_id)=="string"?y.chunk_id.trim():"";if(!k)continue;let x=Number.isFinite((c=y==null?void 0:y.page_start)!=null?c:NaN)?Number(y==null?void 0:y.page_start):null,h=Number.isFinite((d=y==null?void 0:y.page_end)!=null?d:NaN)?Number(y==null?void 0:y.page_end):null,b=x!=null?x:h;b!==null&&(o.set(k,b),o.set(`${u}:${k}`,b))}return this.chunkPageCache.set(u,o),(_=(p=o.get(t))!=null?p:o.get(e))!=null?_:null}};var Je={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.22
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.22
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.22
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.22
...
${n}`:i}ensureDocIdInNoteContent(e,t){var _,g;let n=e.match(/^---\s*\n([\s\S]*?)\n---\s*\n?/),i=`doc id: ${this.escapeYamlString(t)}`;if(!n)return`---
${i}
---
...
`;n.replaceRange(l,{line:r.startLine+1,ch:0},{line:r.endLine,ch:0}),this.showStatusProgress("Chunk cleaned.",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice("Chunk cleaned.")}async requestOcrCleanup(e){var l,c,d,p,_,g,y,k,x;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new m.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let i=Number(this.settings.llmCleanupMaxChars||0);if(i>0&&e.length>i)return new m.Notice("Chunk exceeds ocr cleanup max length. Adjust settings to clean it."),this.openPluginSettings(),null;let r=`${t}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o={model:n,temperature:Number((l=this.settings.llmCleanupTemperature)!=null?l:0),messages:[{role:"system",content:this.getOcrCleanupSystemPrompt()},{role:"user",content:e}]};try{let h=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(o)});if(h.statusCode>=400){let S=h.body.toString("utf8");throw new Error(`Cleanup request failed (${h.statusCode}): ${S||"no response body"}`)}let b=JSON.parse(h.body.toString("utf8")),w=(x=(k=(y=(p=(d=(c=b==null?void 0:b.choices)==null?void 0:c[0])==null?void 0:d.message)==null?void 0:p.content)!=null?y:(g=(_=b==null?void 0:b.choices)==null?void 0:_[0])==null?void 0:g.text)!=null?k:b==null?void 0:b.output_text)!=null?x:"",v=this.escapeGenderStars(String(w||"").trim());return v||(new m.Notice("Cleanup returned empty text."),null)}catch(h){return console.error("OCR cleanup failed",h),new m.Notice("Ocr cleanup failed. Check the cleanup model settings."),null}}getOcrCleanupSystemPrompt(){return["You clean OCR text into Markdown.","Correct OCR errors only when the intended text is clear.","Do not add, remove, or invent content.","Preserve wording, punctuation, and special characters.","Return only the corrected text.","Reformat existing footnote references as [^n].","Reformat existing footnote definitions as [^n]: ....","Do not create new footnotes; only reformat footnotes that already exist.","If paragraph breaks are completely missing, insert them only where the sentence structure clearly supports them.","Do not escape asterisks used for Markdown emphasis, list bullets, multiplication, or other non-gender uses.","Adding the backslash for escaping literal gender stars is allowed and does not count as adding content."].join(" ")}escapeGenderStars(e){return e&&e.replace(/(?<!\\)\b([A-Za-zÄÖÜäöüß]{2,})\*(in(?:nen)?|r|n|m|s)\b/g,(t,n,i)=>`${n}\\*${i}`)}parseChunkTags(e,t){if(!e)return[];let n=e.trim(),i=[];if(n.startsWith("[")&&n.endsWith("]"))try{let s=JSON.parse(n);Array.isArray(s)&&(i=s.map(o=>String(o)))}catch(s){i=[]}i.length===0&&(i=n.split(/[,;\n]+/));let r=new Set,a=[];for(let s of i){let o=s.trim();if(o=o.replace(/^[-•\d.)\s]+/,""),o=o.replace(/\s+/g," ").trim(),!o||o.length<2)continue;let l=o.toLowerCase();if(!r.has(l)&&(r.add(l),a.push(o),a.length>=t))break}return a}async requestChunkTags(e){var p,_,g,y,k,x,h,b,w;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new m.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let i=e.trim().slice(0,2e3);if(!i)return[];let r=`${t}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o=5,l="Return 3 to 5 high-signal, concrete noun-phrase tags. Avoid generic terms (study, paper, method), verbs, and filler. Prefer specific entities, methods, datasets, and named concepts. Output comma-separated tags only. No extra text.",c=Number((p=this.settings.llmCleanupTemperature)!=null?p:0),d={model:n,messages:[{role:"system",content:l},{role:"user",content:i}]};Number.isFinite(c)&&(d.temperature=c),this.showStatusProgress("Generating tags...",null);try{let v=async L=>{let q=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(L)});if(q.statusCode>=400){let F=q.body.toString("utf8");throw new Error(`Tag request failed (${q.statusCode}): ${F||"no response body"}`)}return q.body},S;try{S=await v(d)}catch(L){let q=L instanceof Error?L.message:String(L);if("temperature"in d&&/temperature/i.test(q)&&/unsupported|default/i.test(q)){let F={...d};delete F.temperature,S=await v(F)}else throw L}let P=JSON.parse(S.toString("utf8")),E=(w=(b=(h=(y=(g=(_=P==null?void 0:P.choices)==null?void 0:_[0])==null?void 0:g.message)==null?void 0:y.content)!=null?h:(x=(k=P==null?void 0:P.choices)==null?void 0:k[0])==null?void 0:x.text)!=null?b:P==null?void 0:P.output_text)!=null?w:"",T=this.parseChunkTags(String(E||""),o);return T.length||new m.Notice("Tag generation returned no tags."),T}catch(v){return console.error("Tag generation failed",v),new m.Notice("Tag generation failed. Check the cleanup model settings."),null}finally{this.clearStatusProgress()}}async renderMarkdownToIndexText(e){if(!e)return"";let t=this.replaceImageMarkersForIndexPreview(e),n=document.createElement("div"),i=new m.Component;i.load();try{await m.MarkdownRenderer.render(this.app,t,n,"",i)}catch(a){return console.warn("Failed to render markdown for index preview",a),this.normalizeIndexPreviewText(t)}finally{i.unload()}let r=n.textContent||t;return this.normalizeIndexPreviewText(r)}replaceImageMarkersForIndexPreview(e){if(!e)return"";let t=i=>{let r=i.trim();return r?`Image caption: ${r}`:"Image"},n=e.replace(/!\[\[([^\]|]+)(?:\|([^\]]+))?\]\]/g,(i,r,a)=>t(a||""));return n=n.replace(/!\[([^\]]*)]\([^)]+\)/g,(i,r)=>t(r||"")),n=n.replace(/<img[^>]*>/gi,i=>{let r=i.match(/\balt=(['"])([^'"]*)\1/i);return t(r?r[2]:"")}),n}normalizeIndexPreviewText(e){return e.replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/[ \t]+/g," ").replace(/\n{3,}/g,`

`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,t=1200){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},t);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,t=1200,n="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,n)},t);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,t=1200,n="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,n)},t);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let t=this.annotationNoteEditTimes.get(e);if(!t)return 0;let n=Date.now()-t;return n>=_n?0:_n-n}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let t=(e.annotation_page_label||"").trim();if(t)return t;let n=e.page_start?String(e.page_start):"",i=e.page_end?String(e.page_end):"";if(n&&(!i||n===i))return n;if(n&&i)return`${n} - ${i}`;let r=(e.pages||"").trim();if(!r)return"?";let a=r.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:r.replace("-"," - ")}normalizeChunkIdForNote(e,t){if(!e)return null;let n=String(e);if(t&&n.startsWith(`${t}:`))return n.slice(t.length+1);if(n.includes(":")){let i=n.split(":");if(i.length>1&&t&&i[0]===t)return i.slice(1).join(":")}return n}async syncNoteToRedis(e){if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let t=await this.app.vault.read(e),n=this.extractSyncSection(t);if(!n)return;let i=await this.resolveDocIdForNote(e,t);if(!i)return;let r=this.parseSyncedChunkBlocks(n);if(!r.length)return;let a=(0,m.normalizePath)(`${Q}/${i}.json`),s=this.app.vault.adapter;if(!await s.exists(a)&&!await this.restoreMissingChunkCacheFromNote(e,t,i,!1))return;let o=await this.readChunkPayload(a);if(!o)return;let l=Array.isArray(o.chunks)?o.chunks:[],c=new Map;for(let x of l){if(this.isAnnotationChunk(x))continue;let h=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:"";h&&c.set(h,x)}let d=new Set,p=new Set,_=new Set,g=new Set,y=!1;for(let x of r){let h=x.chunkId;if(!h)continue;d.add(h);let b=c.get(h);if(!b){console.warn(`Sync note: chunk id not found in cache (${h})`);continue}if(x.excludeFlag){b.excluded!==!0&&(b.excluded=!0,y=!0);let S=this.normalizeChunkText(x.text),P=typeof b.text=="string"?b.text:"";S&&S!==P&&(b.text=S,b.char_count=S.length,y=!0),_.add(h);continue}if(b.excluded&&(b.excluded=!1,y=!0,p.add(h)),!x.text.trim()){_.add(h),g.add(h);continue}let w=this.normalizeChunkText(x.text);if(!w){_.add(h),g.add(h);continue}let v=typeof b.text=="string"?b.text:"";w!==v&&(b.text=w,b.char_count=w.length,p.add(h),y=!0)}for(let x of c.keys())d.has(x)||(_.add(x),g.add(x));let k=new Set([..._,...g]);if(k.size){let x=Array.from(k).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==x){this.noteSyncPendingDeletes.set(e.path,x),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!p.size&&!_.size&&!g.size&&!y)return;g.size&&(o.chunks=l.filter(x=>{let h=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:"";return h&&!g.has(h)}),y=!0),(y||g.size)&&await s.write(a,JSON.stringify(o,null,2)),await this.reindexChunkUpdates(i,a,Array.from(p),Array.from(_)),(_.size||g.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(t){console.warn("Failed to sync note edits to Redis",t)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,t){var n,i,r,a;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,t);return}this.noteMetadataSyncInFlight.add(e.path);try{let s=await this.app.vault.read(e),o=await this.resolveDocIdForNote(e,s);if(!o)return;let l=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter;if(!l)return;let c=this.resolveZoteroItemKey(l,o);if(!c)return;let d=this.asRecord(await this.fetchZoteroItem(c)),p=(i=this.asRecord(d==null?void 0:d.data))!=null?i:d;if(!p||typeof p!="object")return;let _=this.extractNoteMetadata(l),g=this.extractZoteroMetadata(p);g.citekey||(g.citekey=await this.resolveZoteroCitekey(p,c,(r=this.asRecord(d==null?void 0:d.meta))!=null?r:{}));let y=await this.getMetadataSnapshot(o,l,e),k={},x={},h={},b=[],w=["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],v={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publication_title:"publication_title",book_title:"book_title",journal_abbrev:"journal_abbrev",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},S=Object.fromEntries(w.map(L=>[L,this.hasFrontmatterKey(l,v[L])])),P=new Set(["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","authors","editors"]),E=w.filter(L=>S[L]||!this.isMetadataValueEmpty(_[L])||!this.isMetadataValueEmpty(g[L]));if(!E.length)return;let T={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publication_title:"Publication title",book_title:"Book title",journal_abbrev:"Journal abbreviation",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let L of E){let q=_[L],F=g[L];if(this.metadataValuesEqual(L,q,F))continue;let W=this.isMetadataValueEmpty(q),M=this.isMetadataValueEmpty(F),G=y==null?void 0:y[L];if(G===void 0){if(W&&!M){h[L]="zotero",this.assignMetadataUpdate(k,L,F);continue}if(!W&&M&&P.has(L)){h[L]="note",this.assignMetadataUpdate(x,L,q);continue}}if(G!==void 0){let Z=!this.metadataValuesEqual(L,q,G),B=!this.metadataValuesEqual(L,F,G);if(Z&&!B){h[L]="note",this.assignMetadataUpdate(x,L,q);continue}if(!Z&&B){h[L]="zotero",this.assignMetadataUpdate(k,L,F);continue}}let O=this.getMetadataDecisionLabels(L,q,F,T);b.push({field:L,fieldLabel:T[L],noteLabel:O.noteLabel,zoteroLabel:O.zoteroLabel,noteValue:this.formatMetadataValue(q),zoteroValue:this.formatMetadataValue(F)})}if(b.length>0){let L=await this.promptMetadataBatchDecision(b);for(let q of b){let F=(a=L[q.field])!=null?a:"skip";h[q.field]=F,F==="note"?this.assignMetadataUpdate(x,q.field,_[q.field]):F==="zotero"&&this.assignMetadataUpdate(k,q.field,g[q.field])}}Object.keys(k).length>0&&await this.applyNoteMetadataUpdates(e,k),Object.keys(x).length>0&&await this.applyZoteroMetadataUpdates(c,p,_,g,x),await this.updateMetadataSnapshot(e,o,_,g,y,h,E)}catch(s){console.warn("Failed to sync note metadata with Zotero",s)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,t)}}async syncNoteAnnotationsWithZotero(e,t){var n,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,t);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let M=this.ensureDocIdInNoteContent(o,d);M!==o&&await this.writeNoteWithSyncSuppressed(e.path,M)}if(!d)return;let p=(i=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter)!=null?i:{},_=(r=c.attachmentKey)!=null?r:"";if(_||(_=await this.resolveAttachmentKeyForDocId(d,p)),!_)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===_&&await this.updateDocIndex({doc_id:d,attachment_key:_});let g=_,y=await this.fetchZoteroAnnotationsForDoc(d,_),k=y.annotations;_=y.attachmentKey,_&&_!==g&&await this.updateDocIndex({doc_id:d,attachment_key:_});let x=this.parseAnnotationBlock(l.block,_),h=new Map;for(let M of x)M.key&&M.imagePath&&h.set(M.key,{path:M.imagePath,hash:M.imageHash||this.extractAnnotationImageHashFromPath(M.imagePath)});await this.attachAnnotationImages(d,_,k,e.path,h);let b=new Map;for(let M of x)M.key&&b.set(M.key,M);let w=new Map;for(let M of k)w.set(M.key,M);let v=!1,S=!1,P=!1;if(y.hadFetchError)b.size>0&&k.length===0&&console.debug("Skipping annotation-prune sync due incomplete Zotero annotation fetch.",{docId:d,attachmentKey:_,reason:t});else for(let M of b.keys())w.has(M)||(S=!0);let E=await this.getAnnotationSnapshot(d),T=(a=E==null?void 0:E.annotations)!=null?a:{},L={},q=[];_&&_!==g&&k.length>0&&(S=!0,P=!0);for(let[M,G]of w.entries()){let O=b.get(M);if(!O){S=!0;continue}let Z=T[M],B=this.annotationSnapshotFromEntry(O,G.annotationType),U=this.annotationSnapshotFromEntry(G,G.annotationType),I=(B.image_hash||"")!==(U.image_hash||"");if(!Z){this.annotationSnapshotsEqualIgnoringImage(B,U)?I&&(S=!0,P=!0):(L[M]="note",v=!0);continue}let j=!this.annotationSnapshotsEqual(B,Z),$=!this.annotationSnapshotsEqual(U,Z),z=(U.color_key||"")!==(Z.color_key||""),V=!this.annotationSnapshotsEqualIgnoringImage(B,Z),H=!this.annotationSnapshotsEqualIgnoringImage(U,Z);V&&!H?(L[M]="note",v=!0):!V&&H?(L[M]="zotero",S=!0):V&&H&&q.push({key:M,title:this.formatAnnotationConflictTitle(G),noteValue:this.formatAnnotationConflictValue(B,O.tags),zoteroValue:this.formatAnnotationConflictValue(U,G.tags)}),I&&(j||$)&&(S=!0,P=!0),z&&(S=!0,P=!0)}if(q.length>0){let M=await this.promptAnnotationBatchDecision(q);for(let G of q){let O=(s=M[G.key])!=null?s:"skip";L[G.key]=O,O==="note"?v=!0:O==="zotero"&&(S=!0,P=!0)}}let F=[];for(let[M,G]of Object.entries(L)){if(G!=="note")continue;let O=b.get(M),Z=w.get(M);!O||!Z||F.push({entry:Z,note:O})}F.length>0&&await this.applyZoteroAnnotationUpdates(F),v&&this.annotationNoteEditTimes.set(e.path,Date.now());let W=this.getAnnotationGraceRemaining(e.path);if(S&&W>0&&v&&!P&&(this.scheduleNoteAnnotationSync(e,W+250,t),S=!1),S){let M=this.buildAnnotationBlock(d,_,k),G=this.replaceAnnotationBlock(o,M);if(G&&G!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,G)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,_,k),await this.updateAnnotationChunks(d,_,k,{allowDeletes:!y.hadFetchError})}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,t)}}resolveZoteroItemKey(e,t){let n=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),t];for(let i of n){let r=K(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,t){var l;if(!e)return"";let n=await this.getDocIndexEntry(e);if(n||(n=await this.hydrateDocIndexFromCache(e)),n!=null&&n.attachment_key)return n.attachment_key;let i=(0,m.normalizePath)(`${Q}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let d=await this.readChunkPayload(i),p=this.asRecord(d==null?void 0:d.metadata),_=p==null?void 0:p.attachment_key;if(typeof _=="string"&&_.trim())return await this.updateDocIndex({doc_id:e,attachment_key:_.trim()}),_.trim()}}catch(c){}let r=this.resolveZoteroItemKey(t,e);if(!r)return"";let a=this.asRecord(await this.fetchZoteroItem(r)),s=(l=this.asRecord(a==null?void 0:a.data))!=null?l:a;if(!s||typeof s!="object")return"";let o=await Me(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var w,v,S,P,E,T,L,q,F,W,M,G,O,Z,B,U,I,j,$,z,V,H;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString((P=(S=(v=(w=e==null?void 0:e["short title"])!=null?w:e==null?void 0:e.short_title)!=null?v:e==null?void 0:e.shortTitle)!=null?S:e==null?void 0:e["short-title"])!=null?P:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString((q=(L=(T=(E=e==null?void 0:e.citekey)!=null?E:e==null?void 0:e["citation key"])!=null?T:e==null?void 0:e.citation_key)!=null?L:e==null?void 0:e.citationKey)!=null?q:e==null?void 0:e["citation-key"]),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString((F=e==null?void 0:e.abstract)!=null?F:e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((W=e==null?void 0:e.doi)!=null?W:e==null?void 0:e.DOI),o=this.normalizeMetadataString((O=(G=(M=e==null?void 0:e["publication title"])!=null?M:e==null?void 0:e.publication_title)!=null?G:e==null?void 0:e.publicationTitle)!=null?O:e==null?void 0:e["publication-title"]),l=this.normalizeMetadataString((U=(B=(Z=e==null?void 0:e["book title"])!=null?Z:e==null?void 0:e.book_title)!=null?B:e==null?void 0:e.bookTitle)!=null?U:e==null?void 0:e["book-title"]),c=this.normalizeMetadataString(($=(j=(I=e==null?void 0:e["journal abbrev"])!=null?I:e==null?void 0:e.journal_abbrev)!=null?j:e==null?void 0:e.journalAbbrev)!=null?$:e==null?void 0:e["journal-abbrev"]),d=this.normalizeMetadataString(e==null?void 0:e.publisher),p=this.normalizeMetadataString(e==null?void 0:e.place),_=this.normalizeMetadataString(e==null?void 0:e.issue),g=this.normalizeMetadataString(e==null?void 0:e.volume),y=this.normalizeMetadataString(e==null?void 0:e.pages),k=this.normalizeMetadataString((H=(V=(z=e==null?void 0:e["item type"])!=null?z:e==null?void 0:e.item_type)!=null?V:e==null?void 0:e.itemType)!=null?H:e==null?void 0:e["item-type"]),x=this.normalizeMetadataList(e==null?void 0:e.tags),h=this.normalizeMetadataList(e==null?void 0:e.authors),b=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:t,short_title:n,citekey:i,date:r,abstract:a,doi:s,publication_title:o,book_title:l,journal_abbrev:c,publisher:d,place:p,issue:_,volume:g,pages:y,item_type:k,tags:this.sanitizeObsidianTags(x),authors:h,editors:b}}extractZoteroMetadata(e){var v,S,P;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString(Ee(e)),i=this.normalizeMetadataString(Xe(e)),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString(e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((v=e==null?void 0:e.DOI)!=null?v:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publicationTitle),l=this.normalizeMetadataString(e==null?void 0:e.bookTitle),c=this.normalizeMetadataString(e==null?void 0:e.journalAbbreviation),d=this.normalizeMetadataString(e==null?void 0:e.publisher),p=this.normalizeMetadataString(e==null?void 0:e.place),_=this.normalizeMetadataString(e==null?void 0:e.issue),g=this.normalizeMetadataString(e==null?void 0:e.volume),y=this.normalizeMetadataString(e==null?void 0:e.pages),k=this.normalizeMetadataString((P=(S=e==null?void 0:e.itemType)!=null?S:e==null?void 0:e.item_type)!=null?P:e==null?void 0:e["item-type"]),x=Array.isArray(e==null?void 0:e.creators)?e.creators:[],h=x.filter(E=>(E==null?void 0:E.creatorType)==="author").map(E=>Ae(E)).filter(Boolean),b=x.filter(E=>(E==null?void 0:E.creatorType)==="editor"||(E==null?void 0:E.creatorType)==="seriesEditor").map(E=>Ae(E)).filter(Boolean),w=Array.isArray(e==null?void 0:e.tags)?e.tags.map(E=>{var T;return typeof E=="string"?E:(T=this.asRecord(E))==null?void 0:T.tag}).filter(E=>typeof E=="string"):[];return{title:t,short_title:n,citekey:i,date:r,abstract:a,doi:s,publication_title:o,book_title:l,journal_abbrev:c,publisher:d,place:p,issue:_,volume:g,pages:y,item_type:k,tags:this.sanitizeObsidianTags(w),authors:this.normalizeMetadataList(h),editors:this.normalizeMetadataList(b)}}async resolveZoteroCitekey(e,t,n){let i=this.normalizeMetadataString(Xe(e,n!=null?n:void 0));if(i)return i;if(!t)return"";let r=await this.fetchZoteroItemCsl(t);return this.normalizeMetadataString(yt(r))}extractAnnotationPageInfo(e){var a;let n=K((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:n,pageIndex:i}}extractAnnotationImagePayload(e){var a,s,o,l;let t=(s=(a=e.annotationImage)!=null?a:e.annotationImageData)!=null?s:e.annotationImageBase64;if(!t)return null;let n=null,i="";if(Buffer.isBuffer(t))n=t;else if(ArrayBuffer.isView(t))n=Buffer.from(t.buffer,t.byteOffset,t.byteLength);else if(t instanceof ArrayBuffer)n=Buffer.from(t);else if(typeof t=="string"){let c=t.trim();if(!c)return null;let d=c.match(/^data:([^;]+);base64,(.*)$/i);if(d&&(i=this.normalizeAnnotationImageMime(d[1]),c=d[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;n=Buffer.from(c,"base64")}if(!n||!n.length)return null;i||(i=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(n)||"image/png");let r=this.annotationImageExtensionFromMime(i)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(n))||"png";return{buffer:n,mime:i,ext:r}}parseZoteroAnnotationItem(e,t){var h,b,w,v;let n=(b=(h=e==null?void 0:e.data)!=null?h:e)!=null?b:{},i=K((w=e==null?void 0:e.key)!=null?w:n==null?void 0:n.key);if(!i)return null;let r=K(n.annotationType),a=this.normalizeAnnotationText(n.annotationText),s=this.normalizeAnnotationText(n.annotationComment),o=K(n.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:p,pageIndex:_}=this.extractAnnotationPageInfo(n),g=(v=n.annotationSortIndex)!=null?v:n.annotationSort,y=K(g).trim(),k=Number.isFinite(Number(y))?Number(y):Number.NaN,x=Array.isArray(n.tags)?n.tags.map(S=>{var P;return typeof S=="string"?S:(P=this.asRecord(S))==null?void 0:P.tag}).filter(S=>typeof S=="string"):[];return{key:i.trim(),attachmentKey:t,pageLabel:p,pageIndex:_,colorKey:l,callout:d,heading:c,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(x),sortToken:y,sortIndex:k,rawValues:n}}async fetchZoteroAnnotations(e){if(!e)return{annotations:[],hadFetchError:!1};let t=this.canUseWebApi()||await this.ensureWebApiLibraryId(),n=!1,i=!1,r=o=>{var c,d;let l=[];for(let p of o){let _=this.asRecord(p),g=(d=(c=this.asRecord(_==null?void 0:_.data))!=null?c:_)!=null?d:{};if(K(g.itemType)!=="annotation")continue;let y=this.parseZoteroAnnotationItem(p,e);y&&l.push(y)}return l},a=[];try{a=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(o){try{a=await this.fetchZoteroChildrenLocal(e)}catch(l){n=!0,console.warn("Failed to fetch Zotero annotation items from local API",l)}}let s=r(a);if(!s.length&&t)try{let o=[];try{o=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(c){o=await this.fetchZoteroChildrenWeb(e)}i=!0;let l=r(o);l.length&&(s=l)}catch(o){n=!0,this.logOptionalLookupFailure("Failed to fetch Zotero annotation items from Web API",o)}return!s.length&&t&&!i&&(n=!0),!s.length&&!t&&(n=!0),{annotations:s,hadFetchError:n}}async fetchZoteroAnnotationsForDoc(e,t){var l,c;let n=t,i=await this.fetchZoteroAnnotations(n);if(i.annotations.length||!e)return i.annotations.length||this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i.annotations,hadFetchError:i.hadFetchError};let r=[];try{r=await this.fetchZoteroChildren(e)}catch(d){return console.warn("Failed to fetch Zotero attachments for annotations",d),this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i.annotations,hadFetchError:!0}}let a=i.hadFetchError,s=[],o=new Set(n?[n]:[]);for(let d of r){if(!bt(d))continue;let p=this.asRecord(d),_=this.asRecord(p==null?void 0:p.data),g=K((c=(l=p==null?void 0:p.key)!=null?l:_==null?void 0:_.key)!=null?c:p==null?void 0:p.attachmentKey);!g||o.has(g)||(o.add(g),s.push(g))}for(let d of s){let p=await this.fetchZoteroAnnotations(d);if(a=a||p.hadFetchError,p.annotations.length)return{attachmentKey:d,annotations:p.annotations,hadFetchError:a}}return this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i.annotations,hadFetchError:a}}async attachAnnotationImages(e,t,n,i,r){var p;if(!this.settings.includeAnnotationImages||!n.length)return;let a=await this.resolveAnnotationImageOutputDir(i);if(!a)return;let s=this.sanitizeFileName(e||t)||"annotations",o=(0,m.normalizePath)(R.default.join(a.relative||"",s)),l=R.default.normalize(R.default.join(a.absolute,s));o?await this.ensureFolder(o):await ee.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,d=new Map;for(let _ of n){let g=String(_.annotationType||"").trim().toLowerCase(),y=g==="image"||g==="ink",k=this.extractAnnotationImagePayload((p=_.rawValues)!=null?p:{});if(!k&&y&&this.settings.zoteroCompanionEnabled&&(k=await this.fetchCompanionAnnotationImage(_.key)),!k){let w=r==null?void 0:r.get(_.key);w!=null&&w.path&&await c.exists(w.path)&&(_.imagePath=w.path,_.imageHash=w.hash,d.set(_.key,w.path));continue}let x=(0,$e.createHash)("sha1").update(k.buffer).digest("hex").slice(0,12),h=`zrr-annotation-${_.key}-${x}.${k.ext}`,b=(0,m.normalizePath)(R.default.join(o,h));try{await c.exists(b)||await c.writeBinary(b,this.bufferToArrayBuffer(k.buffer)),_.imagePath=b,_.imageHash=x,d.set(_.key,b)}catch(w){console.warn("Failed to write annotation image",{annotationKey:_.key,error:w})}}if(o&&await c.exists(o))try{let _=await c.list(o);for(let g of _.files){let k=R.default.basename(g).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!k)continue;let x=k[1].toUpperCase(),h=d.get(x);(!h||(0,m.normalizePath)(h)!==(0,m.normalizePath)(g))&&await c.remove(g)}}catch(_){console.warn("Failed to clean up annotation images",_)}}async fetchCompanionAnnotationImage(e){let t=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!t)return null;let n=`${t.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,i={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(i.Authorization=`Bearer ${r}`);try{let a=await this.requestLocalApiRaw(n,{headers:i,timeoutMs:5e3});if(a.statusCode===200){let s=a.headers["content-type"],o=Array.isArray(s)?s[0]:s!=null?s:"";return this.buildAnnotationImagePayloadFromBuffer(a.body,o)}if(a.statusCode===204||a.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:a.statusCode})}catch(a){console.warn("Failed to fetch annotation image from Zotero companion",a)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new m.Notice("Zotero companion base URL is not set.");return}let t=`${e.replace(/\/$/,"")}/health`,n={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(n.Authorization=`Bearer ${i}`);try{let r=await this.requestLocalApiRaw(t,{headers:n,timeoutMs:3e3});if(r.statusCode===200){try{let a=JSON.parse(r.body.toString("utf8"));if(a!=null&&a.ok){new m.Notice("Zotero companion: OK.");return}}catch(a){}new m.Notice("Zotero companion responded but did not return OK.");return}if(r.statusCode===401){new m.Notice("Zotero companion: unauthorized (check token).");return}new m.Notice(`Zotero companion: HTTP ${r.statusCode}.`)}catch(r){console.warn("Zotero companion health check failed",r),new m.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new m.Notice("Opened Zotero. Go to tools \u2192 add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new m.Notice("Unable to open Zotero automatically. Open Zotero and go to tools \u2192 add-ons.")}}async spawnDetached(e){let[t,...n]=e;if(!t)throw new Error("Missing command");await new Promise((i,r)=>{let a=!1,s=(0,oe.spawn)(t,n,{detached:!0,stdio:"ignore"});s.on("error",o=>{a||(a=!0,r(o))}),s.unref(),a||(a=!0,i())})}maybeWarnMissingAnnotationApi(e,t){if(this.canUseWebApi()){console.debug("No Zotero annotations returned for attachment",{docId:e,attachmentKey:t});return}let n=e||t;!n||this.annotationWebApiWarned.has(n)||(this.annotationWebApiWarned.add(n),new m.Notice("Zotero annotations require web API access. Configure the web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
${g}`:b)}let y=d!==null?a?` (${d})`:` page=${d}`:"",x=` id=${c}${a?" section":""}${y}${p?" exclude":""}`;s.push(`<!-- zrr:chunk${x} -->`),g&&s.push(g),s.push("<!-- zrr:chunk end -->"),s.push("")}return s[s.length-1]===""&&s.pop(),s.push("<!-- zrr:sync-end -->"),s.join(`

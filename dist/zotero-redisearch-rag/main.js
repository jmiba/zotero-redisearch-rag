"use strict";var Wn=Object.create;var Se=Object.defineProperty;var Kn=Object.getOwnPropertyDescriptor;var Jn=Object.getOwnPropertyNames;var Xn=Object.getPrototypeOf,Yn=Object.prototype.hasOwnProperty;var Qn=(g,p)=>{for(var e in p)Se(g,e,{get:p[e],enumerable:!0})},on=(g,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of Jn(p))!Yn.call(g,t)&&t!==e&&Se(g,t,{get:()=>p[t],enumerable:!(n=Kn(p,t))||n.enumerable});return g};var ge=(g,p,e)=>(e=g!=null?Wn(Xn(g)):{},on(p||!g||!g.__esModule?Se(e,"default",{value:g,enumerable:!0}):e,g)),et=g=>on(Se({},"__esModule",{value:!0}),g);var ht={};Qn(ht,{default:()=>He});module.exports=et(ht);var m=require("obsidian");var gn=require("@codemirror/state"),J=require("@codemirror/view"),fn=require("obsidian");var ce=/<!--\s*zrr:sync-start[^>]*-->/i,fe=/<!--\s*zrr:sync-end\s*-->/i,se=/<!--\s*zrr:chunk\b([^>]*)-->/i,Le=/<!--\s*zrr:chunk\s+end\s*-->/i,ke=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,ln=g=>{let p=g.trim();if(!p.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(p)){let _=p.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:_?_[2]:void 0}}if(/^zrr:sync-end\b/i.test(p))return{type:"sync-end"};if(/^zrr:chunk\s+end\b/i.test(p))return{type:"chunk-end"};let e=p.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let n=e[1]||"",t=n.match(/\bid=(["']?)([^"'\s]+)\1/i),i=t?t[2]:"",r=n.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:n.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(n)||/\bdelete\b/i.test(n),u=/\bsection\b/i.test(n);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:u?"section":c?"page":"section"}},Je=g=>{var l;if(!g)return null;let p=g.match(se);if(!p)return null;let e=p[1]||"",n=e.match(/\bid=(["']?)([^"'\s]+)\1/i),t=n?n[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=t&&(l=tt(t))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:t,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Ee=g=>{for(let p=1;p<=g.lines;p+=1){let e=g.line(p).text;if(ce.test(e)){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return n?n[2].trim():null}}return null},Xe=(g,p)=>{let e=p;for(;e>=1;e-=1){let n=g.line(e).text;if(se.test(n))return{line:e,text:n};if(ce.test(n)||fe.test(n))break}return null},nt=(g,p)=>{for(let e=p;e<=g.lines;e+=1){let n=g.line(e).text;if(Le.test(n))return e;if(fe.test(n))break}return null},cn=(g,p)=>{let e=Xe(g,p);if(!e)return null;let n=nt(g,e.line+1);return n===null||p<e.line||p>n?null:{startLine:e.line,endLine:n,text:e.text}},dn=(g,p,e)=>{if(p>e)return!1;for(let n=p;n<=e;n+=1){let t=g.line(n).text;if(ke.test(t))return!0}return!1},tt=g=>{var t;if(!g)return null;let e=(g.includes(":")&&(t=g.split(":").pop())!=null?t:g).match(/^p(\d+)$/i);if(!e)return null;let n=Number.parseInt(e[1],10);return Number.isFinite(n)?n:null};var pn=g=>{if(!g)return null;let p=g.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return p?Je(p[0]):null};var it=(g,p)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),g.type==="sync-start"||g.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(g.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),g.type==="sync-start"?e.textContent=g.docId?`Redis Index Sync start - ${g.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e;if(g.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=g.chunkKind==="page"?"Page end":"Section end",g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),e;if(g.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),g.excluded&&e.classList.add("is-excluded"),g.pageNumber&&p>0)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber}/${p})`}else e.textContent=`Page ${g.pageNumber}/${p}`;else if(g.pageNumber)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber})`}else e.textContent=`Page ${g.pageNumber}`;else g.chunkId?e.textContent=`Section ${g.chunkId}`:e.textContent="Section";return g.excluded&&(e.textContent=`${e.textContent} - excluded`),e},Ye=class extends J.WidgetType{constructor(p,e,n,t,i){super(),this.plugin=p,this.docId=e,this.chunkId=n,this.startLine=t,this.excluded=i}eq(p){return this.docId===p.docId&&this.chunkId===p.chunkId&&this.startLine===p.startLine&&this.excluded===p.excluded}toDOM(){let p=document.createElement("span");p.className="zrr-chunk-toolbar",p.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},n=(c,d,u)=>{let _=document.createElement("span");_.className="zrr-chunk-button-icon",(0,fn.setIcon)(_,d);let h=document.createElement("span");h.className="zrr-chunk-button-label",h.textContent=u,c.appendChild(_),c.appendChild(h)},t=document.createElement("button");t.type="button",t.className="zrr-chunk-button",n(t,"sparkles","Clean"),e(t,"Clean this chunk with the OCR cleanup model"),t.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),p.appendChild(t);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",n(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),p.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",n(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),p.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",n(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),p.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return n(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),p.appendChild(s),p}ignoreEvent(){return!0}},un=(g,p)=>{var y;let e=g.state.doc,n=Ee(e);if(!n)return J.Decoration.none;let t=g.state.selection.main.head,i=e.lineAt(t).number,r=cn(e,i);if(!r)return J.Decoration.none;let a=r.text.match(se);if(!a)return J.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return J.Decoration.none;let l=o[2].trim();if(!l)return J.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=dn(e,r.startLine+1,r.endLine-1),u=c||d,_=e.line(r.startLine),h=J.Decoration.widget({widget:new Ye(p,n,l,r.startLine,u),side:1});return J.Decoration.set([h.range(_.to)])},Qe=class extends J.WidgetType{constructor(p,e){super(),this.info=p,this.totalPages=e}toDOM(){var p;return(p=it(this.info,this.totalPages))!=null?p:document.createElement("span")}},_n=g=>{var o,l;let p=g.dom.closest(".markdown-source-view");if(!p||!p.classList.contains("is-live-preview"))return J.Decoration.none;let e=g.state.doc,n=new gn.RangeSetBuilder,t=[],i=[],r=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),u=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!u)continue;let _=ln(u[1]);_&&(_.type==="chunk-start"?(_.chunkKind=(o=_.chunkKind)!=null?o:_.pageNumber?"page":"section",_.pageNumber&&(r=!0),_.chunkKind==="section"&&(a=!0)):_.type==="chunk-end"&&(_.chunkKind=(l=_.chunkKind)!=null?l:"section"),t.push({line:c,from:d.from,to:d.to,info:_}),_.pageNumber&&i.push(_.pageNumber))}if(!t.length)return J.Decoration.none;if(r&&!a)for(let c of t)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let c of t){let d=J.Decoration.replace({widget:new Qe(c.info,s)});n.add(c.from,c.to,d)}return n.finish()},hn=()=>J.ViewPlugin.fromClass(class{constructor(g){this.decorations=_n(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=_n(g.view))}},{decorations:g=>g.decorations}),mn=g=>J.ViewPlugin.fromClass(class{constructor(p){this.decorations=un(p,g)}update(p){(p.docChanged||p.selectionSet||p.viewportChanged)&&(this.decorations=un(p.view,g))}},{decorations:p=>p.decorations});var Q=require("child_process"),G=require("fs"),Gn=ge(require("http")),Bn=ge(require("https")),Ce=ge(require("net")),Zn=ge(require("os")),Un=ge(require("tls")),N=ge(require("path")),sn=require("url"),Ue=require("crypto");var R=require("obsidian"),X=".zotero-redisearch-rag",Y=`${X}/items`,V=`${X}/chunks`,yn=`${X}/metadata_snapshots.json`,bn=`${X}/annotation_snapshots.json`,en={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{pdf_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Fragen",callout:"question"},red:{heading:"Kritikw\xFCrdiges",callout:"bug"},green:{heading:"Hauptgedanken",callout:"idea"},blue:{heading:"Fakten",callout:"fact"},purple:{heading:"Argumente/L\xF6sungen",callout:"argument"},magenta:{heading:"Meinungen",callout:"opinion"},orange:{heading:"Weiterverfolgen",callout:"pursue"},gray:{heading:"Zitierbare Stellen",callout:"cite"}},llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,chatPaneLocation:"right",enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"BAAI/bge-reranker-v2-m3",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${X}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Ne=class extends R.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async f=>{this.plugin.settings.llmProviderProfiles=f,await this.plugin.saveSettings()},i=f=>{f.inputEl.type="password",f.inputEl.autocomplete="off",f.inputEl.spellcheck=!1},c=[{id:"prerequisites",label:"Prerequisites",render:f=>{f.createEl("h2",{text:"Prerequisites"}),new R.Setting(f).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows).").addText(b=>b.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async w=>{this.plugin.settings.pythonPath=w.trim(),await this.plugin.saveSettings()})),new R.Setting(f).setName("Python environment").setDesc("Create or update the plugin's Python env (location configured below).").addButton(b=>{b.setButtonText("Create/Update").setCta(),b.onClick(async()=>{b.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{b.setDisabled(!1)}})}),new R.Setting(f).setName("Python env location").setDesc("Shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(b=>{b.addOption("shared","Shared user cache"),b.addOption("plugin","Plugin folder (.venv)"),b.setValue(this.plugin.settings.pythonEnvLocation).onChange(async w=>{w!=="shared"&&w!=="plugin"||(this.plugin.settings.pythonEnvLocation=w,await this.plugin.saveSettings())})}),new R.Setting(f).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack).").addText(b=>b.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async w=>{this.plugin.settings.dockerPath=w.trim()||"docker",await this.plugin.saveSettings()})),new R.Setting(f).setName("Redis URL").addText(b=>b.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async w=>{this.plugin.settings.redisUrl=w.trim(),await this.plugin.saveSettings()})),new R.Setting(f).setName("Redis data directory override").setDesc("Optional absolute path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting.").addText(b=>b.setPlaceholder("/Users/you/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async w=>{this.plugin.settings.redisDataDirOverride=w.trim(),await this.plugin.saveSettings()})),new R.Setting(f).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(b=>b.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async w=>{this.plugin.settings.redisProjectName=w.trim(),await this.plugin.saveSettings()})),new R.Setting(f).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(b=>b.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async w=>{this.plugin.settings.autoAssignRedisPort=w,await this.plugin.saveSettings()})),new R.Setting(f).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Uses a vault-specific data dir at .obsidian/zotero-redisearch-rag/redis-data unless overridden.").addToggle(b=>b.setValue(this.plugin.settings.autoStartRedis).onChange(async w=>{this.plugin.settings.autoStartRedis=w,await this.plugin.saveSettings()})),new R.Setting(f).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(b=>b.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:f=>{f.createEl("h2",{text:"Zotero Local API"}),new R.Setting(f).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(C=>C.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async A=>{this.plugin.settings.zoteroBaseUrl=A.trim(),await this.plugin.saveSettings()}));let b=new R.Setting(f).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),w=null,x=C=>{if(!w)return;let A=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(C.map(F=>F.value)).has(A)||(C=C.concat([{value:A,label:`Custom (${A})`}])),w.selectEl.options.length=0;for(let F of C)w.addOption(F.value,F.label);w.setValue(A)},L=async()=>{if(w){w.setDisabled(!0);try{let C=await this.plugin.fetchZoteroLibraryOptions();x(C)}finally{w.setDisabled(!1)}}};b.addDropdown(C=>{w=C;let A=(this.plugin.settings.zoteroUserId||"0").trim()||"0";C.addOption(A,"Loading..."),C.setValue(A),C.onChange(async D=>{this.plugin.settings.zoteroUserId=D.trim(),await this.plugin.saveSettings()})}),b.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await L()})}),L(),f.createEl("h2",{text:"Zotero Web API"}),new R.Setting(f).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(C=>C.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async A=>{this.plugin.settings.webApiBaseUrl=A.trim(),await this.plugin.saveSettings()})),new R.Setting(f).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(C=>C.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async A=>{this.plugin.settings.webApiLibraryType=A,await this.plugin.saveSettings()})),new R.Setting(f).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(C=>C.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async A=>{this.plugin.settings.webApiLibraryId=A.trim(),await this.plugin.saveSettings()})),new R.Setting(f).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(C=>{i(C),C.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async A=>{this.plugin.settings.webApiKey=A.trim(),await this.plugin.saveSettings()})}),f.createEl("h2",{text:"Output"}),new R.Setting(f).setName("PDF folder").addText(C=>C.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async A=>{this.plugin.settings.outputPdfDir=A.trim(),await this.plugin.saveSettings()})),new R.Setting(f).setName("Notes folder").addText(C=>C.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async A=>{this.plugin.settings.outputNoteDir=A.trim(),await this.plugin.saveSettings()})),new R.Setting(f).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(C=>{C.setValue(this.plugin.settings.frontmatterTemplate).onChange(async A=>{this.plugin.settings.frontmatterTemplate=A,await this.plugin.saveSettings()}),C.inputEl.rows=10,C.inputEl.style.width="100%"}),new R.Setting(f).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(C=>C.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async A=>{this.plugin.settings.tagSanitizeMode=A,await this.plugin.saveSettings()})),new R.Setting(f).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(C=>{C.setValue(this.plugin.settings.noteBodyTemplate).onChange(async A=>{this.plugin.settings.noteBodyTemplate=A,await this.plugin.saveSettings()}),C.inputEl.rows=8,C.inputEl.style.width="100%"}),new R.Setting(f).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(C=>C.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async A=>{this.plugin.settings.chatOutputDir=A.trim()||"zotero/chats",await this.plugin.saveSettings()})),new R.Setting(f).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(C=>C.setValue(this.plugin.settings.copyPdfToVault).onChange(async A=>{this.plugin.settings.copyPdfToVault=A,!A&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new R.Setting(f).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(C=>{let A=this.plugin.settings.copyPdfToVault;C.setValue(A?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!A).onChange(async D=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=D,await this.plugin.saveSettings()})}),new R.Setting(f).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(C=>C.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async A=>{this.plugin.settings.preferObsidianNoteForCitations=A,await this.plugin.saveSettings()}))}},{id:"ocr",label:"OCR",render:f=>{f.createEl("h2",{text:"Docling"});let b=null,w=A=>{if(!b)return;let D=this.plugin.settings.ocrEngine;new Set(A.map(z=>z.value)).has(D)||(A=A.concat([{value:D,label:`Current (unavailable): ${D}`}])),b.selectEl.options.length=0;for(let z of A)b.addOption(z.value,z.label);b.setValue(D)},x=async()=>{if(!b)return;b.setDisabled(!0);let A={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{A=await this.plugin.detectOcrEngines()}catch(z){A={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let D=[{value:"auto",label:"Auto (default)"}];A.tesseract&&D.push({value:"tesseract",label:"Tesseract (local)"}),A.paddleStructureLocal&&D.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),A.paddleVlLocal&&D.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(D.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),D.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),w(D),b.setDisabled(!1)},L=new R.Setting(f).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),C=document.createElement("a");C.href="https://aistudio.baidu.com/paddleocr",C.textContent="https://aistudio.baidu.com/paddleocr",C.target="_blank",C.rel="noopener noreferrer",L.descEl.appendChild(C),L.descEl.append("."),L.addText(A=>{i(A),A.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async D=>{this.plugin.settings.paddleApiKey=D.trim(),await this.plugin.saveSettings(),await x()})}),new R.Setting(f).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(A=>A.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async D=>{this.plugin.settings.paddleVlApiUrl=D.trim(),await this.plugin.saveSettings()})),new R.Setting(f).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(A=>A.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async D=>{this.plugin.settings.paddleStructureApiUrl=D.trim(),await this.plugin.saveSettings(),await x()})),new R.Setting(f).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(A=>{b=A,A.addOption("auto","Auto (default)"),A.setValue(this.plugin.settings.ocrEngine),A.onChange(async D=>{this.plugin.settings.ocrEngine=D,await this.plugin.saveSettings()})}),new R.Setting(f).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(A=>A.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async D=>{this.plugin.settings.ocrMode=D,await this.plugin.saveSettings()})),new R.Setting(f).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(A=>A.setValue(this.plugin.settings.forcePerPageOcr).onChange(async D=>{this.plugin.settings.forcePerPageOcr=D,await this.plugin.saveSettings()})),new R.Setting(f).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(A=>{A.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async D=>{this.plugin.settings.ocrQualityThreshold=D,await this.plugin.saveSettings()})}),new R.Setting(f).setName("Chunking").setDesc("page or section").addDropdown(A=>A.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async D=>{this.plugin.settings.chunkingMode=D,await this.plugin.saveSettings()})),x()}},{id:"llms",label:"LLMs",render:f=>{f.createEl("h2",{text:"LLM Provider Profiles"});let b=f.createDiv({cls:"zrr-llm-profiles"}),w=()=>{b.empty();let P=n();P.length||b.createEl("p",{text:"No profiles yet. Add one below."});for(let k of P){let S=b.createEl("details",{cls:"zrr-profile"});P.length===1&&(S.open=!0);let U=S.createEl("summary",{text:k.name||k.id||"Profile"});U.addClass("zrr-profile-title");let re=S.createDiv({cls:"zrr-profile-body"});new R.Setting(re).setName("Profile name").addText(ae=>ae.setPlaceholder("My provider").setValue(k.name||"").onChange(async le=>{k.name=le.trim(),U.textContent=k.name||k.id||"Profile",await t(n())})),new R.Setting(re).setName("Base URL").addText(ae=>ae.setPlaceholder("http://localhost:1234/v1").setValue(k.baseUrl||"").onChange(async le=>{k.baseUrl=le.trim(),await t(n())})),new R.Setting(re).setName("API key").setDesc("Stored in settings (not encrypted).").addText(ae=>{i(ae),ae.setPlaceholder("sk-...").setValue(k.apiKey||"").onChange(async le=>{k.apiKey=le.trim(),await t(n())})}),new R.Setting(re).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(ae=>ae.setButtonText("Delete profile").onClick(async()=>{let le=n().filter(Hn=>Hn.id!==k.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===k.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===k.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===k.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(le),w()}))}new R.Setting(b).addButton(k=>k.setButtonText("Add profile").onClick(async()=>{let S=`profile-${Date.now().toString(36)}`,U=n().concat([{id:S,name:"Custom",baseUrl:"",apiKey:""}]);await t(U),w()}))};w(),f.createEl("h2",{text:"OCR cleanup"}),new R.Setting(f).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(P=>P.setValue(this.plugin.settings.enableLlmCleanup).onChange(async k=>{this.plugin.settings.enableLlmCleanup=k,await this.plugin.saveSettings()}));let x=null,L=null,C=null,A=async()=>{},D=async(P,k=!0)=>{let S=P.trim();this.plugin.settings.llmCleanupBaseUrl=S,k&&(this.plugin.settings.llmCleanupProviderProfileId="",x&&x.setValue("custom")),L&&L.setValue(S),await this.plugin.saveSettings()},F=async P=>{let k=n().find(S=>S.id===P);this.plugin.settings.llmCleanupProviderProfileId=P,k&&(this.plugin.settings.llmCleanupBaseUrl=k.baseUrl,this.plugin.settings.llmCleanupApiKey=k.apiKey,L==null||L.setValue(k.baseUrl),C==null||C.setValue(k.apiKey)),await this.plugin.saveSettings(),await A()};new R.Setting(f).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{x=P,P.addOption("custom","Custom (manual)");for(let S of n())P.addOption(S.id,S.name||S.id);let k=this.plugin.settings.llmCleanupProviderProfileId;P.setValue(k&&n().some(S=>S.id===k)?k:"custom"),P.onChange(async S=>{if(S==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await F(S)})}),new R.Setting(f).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(P=>{L=P,P.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async k=>{await D(k)})}),new R.Setting(f).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(P=>{C=P,i(P),P.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async k=>{this.plugin.settings.llmCleanupApiKey=k.trim(),this.plugin.settings.llmCleanupProviderProfileId="",x&&x.setValue("custom"),await this.plugin.saveSettings()})});let z=new R.Setting(f).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),E=null,I=P=>{if(!E)return;let k=(this.plugin.settings.llmCleanupModel||"").trim(),S=new Set(P.map(U=>U.value));k&&!S.has(k)&&(P=P.concat([{value:k,label:`Custom (${k})`}])),E.selectEl.options.length=0;for(let U of P)E.addOption(U.value,U.label);k&&E.setValue(k)};A=async()=>{if(E){E.setDisabled(!0);try{let P=await this.plugin.fetchCleanupModelOptions();I(P)}finally{E.setDisabled(!1)}}},z.addDropdown(P=>{E=P;let k=(this.plugin.settings.llmCleanupModel||"").trim();P.addOption(k||"loading","Loading..."),P.setValue(k||"loading"),P.onChange(async S=>{this.plugin.settings.llmCleanupModel=S.trim(),await this.plugin.saveSettings()})}),z.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await A()})}),A(),new R.Setting(f).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(P=>P.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async k=>{let S=Number.parseFloat(k);this.plugin.settings.llmCleanupTemperature=Number.isFinite(S)?S:0,await this.plugin.saveSettings()})),new R.Setting(f).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(P=>P.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async k=>{this.plugin.settings.llmCleanupMinQuality=k,await this.plugin.saveSettings()})),new R.Setting(f).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(P=>P.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async k=>{let S=Number.parseInt(k,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(S)?S:2e3,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Text Embedding"});let T=null,q=null,B=null,O=async()=>{},j=async(P,k=!0)=>{let S=P.trim();this.plugin.settings.embedBaseUrl=S,k&&(this.plugin.settings.embedProviderProfileId="",T&&T.setValue("custom")),q&&q.setValue(S),await this.plugin.saveSettings()},Z=async P=>{let k=n().find(S=>S.id===P);this.plugin.settings.embedProviderProfileId=P,k&&(this.plugin.settings.embedBaseUrl=k.baseUrl,this.plugin.settings.embedApiKey=k.apiKey,q==null||q.setValue(k.baseUrl),B==null||B.setValue(k.apiKey)),await this.plugin.saveSettings(),await O()};new R.Setting(f).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{T=P,P.addOption("custom","Custom (manual)");for(let S of n())P.addOption(S.id,S.name||S.id);let k=this.plugin.settings.embedProviderProfileId;P.setValue(k&&n().some(S=>S.id===k)?k:"custom"),P.onChange(async S=>{if(S==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await Z(S)})}),new R.Setting(f).setName("Embeddings base URL").addText(P=>{q=P,P.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async k=>{await j(k)})}),new R.Setting(f).setName("Embeddings API key").addText(P=>{B=P,i(P),P.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async k=>{this.plugin.settings.embedApiKey=k.trim(),this.plugin.settings.embedProviderProfileId="",T&&T.setValue("custom"),await this.plugin.saveSettings()})});let W=new R.Setting(f).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),K=null,pe=P=>{if(!K)return;let k=(this.plugin.settings.embedModel||"").trim(),S=new Set(P.map(U=>U.value));k&&!S.has(k)&&(P=P.concat([{value:k,label:`Custom (${k})`}])),K.selectEl.options.length=0;for(let U of P)K.addOption(U.value,U.label);k&&K.setValue(k)};O=async()=>{if(K){K.setDisabled(!0);try{let P=await this.plugin.fetchEmbeddingModelOptions();pe(P)}finally{K.setDisabled(!1)}}},W.addDropdown(P=>{K=P;let k=(this.plugin.settings.embedModel||"").trim();P.addOption(k||"loading","Loading..."),P.setValue(k||"loading"),P.onChange(async S=>{this.plugin.settings.embedModel=S.trim(),await this.plugin.saveSettings()})}),W.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await O()})}),O(),new R.Setting(f).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(P=>P.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async k=>{this.plugin.settings.embedIncludeMetadata=k,await this.plugin.saveSettings()})),new R.Setting(f).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(P=>P.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async k=>{let S=Number.parseInt(k,10);this.plugin.settings.embedContextWindow=Number.isFinite(S)?Math.max(0,S):1,await this.plugin.saveSettings()})),new R.Setting(f).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(P=>P.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async k=>{let S=Number.parseInt(k,10);this.plugin.settings.embedContextChars=Number.isFinite(S)?Math.max(0,S):220,await this.plugin.saveSettings()})),new R.Setting(f).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(P=>P.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async k=>{let S=Number.parseInt(k,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(S)?Math.max(0,S):3500,await this.plugin.saveSettings()})),new R.Setting(f).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(P=>P.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async k=>{let S=Number.parseInt(k,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(S)?Math.max(0,S):200,await this.plugin.saveSettings()})),new R.Setting(f).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(P=>P.setValue(this.plugin.settings.enableChunkTagging).onChange(async k=>{this.plugin.settings.enableChunkTagging=k,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Chat LLM"});let oe=null,ie=null,ue=null,_e=async()=>{},We=async(P,k=!0)=>{let S=P.trim();this.plugin.settings.chatBaseUrl=S,k&&(this.plugin.settings.chatProviderProfileId="",oe&&oe.setValue("custom")),ie&&ie.setValue(S),await this.plugin.saveSettings()},Ke=async P=>{let k=n().find(S=>S.id===P);this.plugin.settings.chatProviderProfileId=P,k&&(this.plugin.settings.chatBaseUrl=k.baseUrl,this.plugin.settings.chatApiKey=k.apiKey,ie==null||ie.setValue(k.baseUrl),ue==null||ue.setValue(k.apiKey)),await this.plugin.saveSettings(),await _e()};new R.Setting(f).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{oe=P,P.addOption("custom","Custom (manual)");for(let S of n())P.addOption(S.id,S.name||S.id);let k=this.plugin.settings.chatProviderProfileId;P.setValue(k&&n().some(S=>S.id===k)?k:"custom"),P.onChange(async S=>{if(S==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await Ke(S)})}),new R.Setting(f).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(P=>{ie=P,P.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async k=>{await We(k)})}),new R.Setting(f).setName("Chat API key").addText(P=>{ue=P,i(P),P.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async k=>{this.plugin.settings.chatApiKey=k.trim(),this.plugin.settings.chatProviderProfileId="",oe&&oe.setValue("custom"),await this.plugin.saveSettings()})});let Ae=new R.Setting(f).setName("Chat model").setDesc("Select a chat-capable model from the provider."),ne=null,xe=P=>{if(!ne)return;let k=(this.plugin.settings.chatModel||"").trim(),S=new Set(P.map(U=>U.value));k&&!S.has(k)&&(P=P.concat([{value:k,label:`Custom (${k})`}])),ne.selectEl.options.length=0;for(let U of P)ne.addOption(U.value,U.label);k&&ne.setValue(k)};_e=async()=>{if(ne){ne.setDisabled(!0);try{let P=await this.plugin.fetchChatModelOptions();xe(P)}finally{ne.setDisabled(!1)}}},Ae.addDropdown(P=>{ne=P;let k=(this.plugin.settings.chatModel||"").trim();P.addOption(k||"loading","Loading..."),P.setValue(k||"loading"),P.onChange(async S=>{this.plugin.settings.chatModel=S.trim(),await this.plugin.saveSettings()})}),Ae.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await _e()})}),_e(),new R.Setting(f).setName("Temperature").addText(P=>P.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async k=>{let S=Number.parseFloat(k);this.plugin.settings.chatTemperature=Number.isFinite(S)?S:.2,await this.plugin.saveSettings()})),new R.Setting(f).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(P=>P.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async k=>{let S=Number.parseInt(k,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(S)?Math.max(0,S):6,await this.plugin.saveSettings()})),new R.Setting(f).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(P=>P.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async k=>{this.plugin.settings.chatPaneLocation=k,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Retrieval"}),new R.Setting(f).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(P=>P.setValue(this.plugin.settings.enableQueryExpansion).onChange(async k=>{this.plugin.settings.enableQueryExpansion=k,await this.plugin.saveSettings()})),new R.Setting(f).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(P=>P.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async k=>{let S=Number.parseInt(k,10);this.plugin.settings.queryExpansionCount=Number.isFinite(S)?Math.max(1,S):3,await this.plugin.saveSettings()})),new R.Setting(f).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(P=>P.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async k=>{this.plugin.settings.enableCrossEncoderRerank=k,await this.plugin.saveSettings()})),new R.Setting(f).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(P=>P.setPlaceholder("BAAI/bge-reranker-v2-m3").setValue(this.plugin.settings.rerankModel).onChange(async k=>{this.plugin.settings.rerankModel=k.trim()||"BAAI/bge-reranker-v2-m3",await this.plugin.saveSettings()})),new R.Setting(f).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(P=>P.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async k=>{let S=Number.parseInt(k,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(S)?Math.max(1,S):4,await this.plugin.saveSettings()})),new R.Setting(f).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(P=>P.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async k=>{let S=Number.parseInt(k,10);this.plugin.settings.rrfK=Number.isFinite(S)?Math.max(1,S):60,await this.plugin.saveSettings()})),new R.Setting(f).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(P=>P.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async k=>{let S=Number.parseInt(k,10);this.plugin.settings.rrfLogTop=Number.isFinite(S)?Math.max(0,S):0,await this.plugin.saveSettings()})),new R.Setting(f).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(P=>P.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async k=>{let S=Number.parseInt(k,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(S)?Math.max(0,S):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:f=>{f.createEl("h2",{text:"Logging"}),new R.Setting(f).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(b=>b.setValue(this.plugin.settings.enableFileLogging).onChange(async w=>{this.plugin.settings.enableFileLogging=w,await this.plugin.saveSettings()})),new R.Setting(f).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(b=>b.setPlaceholder(`${X}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async w=>{this.plugin.settings.logFilePath=w.trim()||`${X}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new R.Setting(f).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(b=>b.setButtonText("Open log").onClick(async()=>{var w,x;await((x=(w=this.plugin).openLogFile)==null?void 0:x.call(w))})).addButton(b=>b.setButtonText("Clear log").onClick(async()=>{var w,x;await((x=(w=this.plugin).clearLogFile)==null?void 0:x.call(w))})),f.createEl("h2",{text:"Maintenance"}),new R.Setting(f).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(b=>b.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new R.Setting(f).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(b=>b.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(b=>b.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],d=new Map,u=new Map,_=f=>{this.activeTab=f;for(let[b,w]of d){let x=b===f;w.classList.toggle("is-active",x),w.setAttribute("aria-selected",x?"true":"false"),w.setAttribute("tabindex",x?"0":"-1")}for(let[b,w]of u){let x=b===f;w.classList.toggle("is-active",x),w.hidden=!x}},h=e.createDiv({cls:"zrr-settings-tabs"});h.setAttribute("role","tablist");let y=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let f of c){let b=h.createEl("button",{text:f.label,cls:"zrr-settings-tab-button"}),w=`zrr-settings-tab-${f.id}`,x=`zrr-settings-panel-${f.id}`;b.type="button",b.id=w,b.setAttribute("role","tab"),b.setAttribute("aria-controls",x),b.setAttribute("aria-selected","false"),b.addEventListener("click",()=>_(f.id));let L=y.createDiv({cls:"zrr-settings-tab-panel"});L.id=x,L.setAttribute("role","tabpanel"),L.setAttribute("aria-labelledby",w),L.hidden=!0,f.render(L),d.set(f.id,b),u.set(f.id,L)}let v=c.some(f=>f.id===this.activeTab)?this.activeTab:c[0].id;_(v)}};var xn=require("@codemirror/state"),kn=require("@codemirror/view"),te=require("obsidian");var rt=g=>{let p=g.scrollDOM.getBoundingClientRect(),e=g.posAtCoords({x:p.left+8,y:+p.height*.25});return e===null?null:g.state.doc.lineAt(e).number},Re=class{constructor(p,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.deps=p,this.helpers=e}createSyncExtension(){let p=this,e=this.helpers;return kn.ViewPlugin.fromClass(class{constructor(n){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=n,this.docId=e.extractDocIdFromDoc(n.state.doc),this.onScroll=()=>this.scheduleSync(!1),n.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(n){n.docChanged&&(this.docId=e.extractDocIdFromDoc(n.view.state.doc),this.lastPage=null,this.lastChunkId=null),(n.docChanged||n.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(n){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,n)}))}syncPdfSidebar(n,t){var u,_;let i=this.docId;if(!i)return;let r=rt(n);if(r===null)return;let a=e.findChunkStartLineInDoc(n.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(u=s==null?void 0:s.pageNumber)!=null?u:null,l=(_=s==null?void 0:s.chunkId)!=null?_:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!t&&(c||d)||(this.lastPage=o,this.lastChunkId=l,p.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,n;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((n=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:n.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let p=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(p.docId,p.pageNumber,p.chunkId)}updatePreviewScrollHandler(){var t;let p=this.deps.app.workspace.getActiveViewOfType(te.MarkdownView);if(!p||p.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(t=p.previewMode)==null?void 0:t.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let n=()=>this.schedulePreviewSync(p);e.addEventListener("scroll",n,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=n,this.schedulePreviewSync(p)}async syncPdfSidebarForFile(p){try{let e=await this.deps.app.vault.read(p),n=await this.deps.resolveDocIdForNote(p,e);if(!n)return;let t=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(n,t==null?void 0:t.pageNumber,t==null?void 0:t.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(p,e,n){if(!p)return;let t=await this.deps.getDocIndexEntry(p);t||(t=await this.deps.hydrateDocIndexFromCache(p));let i=t!=null&&t.pdf_path?String(t.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let _=(0,te.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(_)instanceof te.TFile&&(r=_)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof te.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:n};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:n};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&n&&(o=await this.resolvePageNumberForChunk(p,n)),o===null||this.pdfSidebarDocId===p&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=p,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,c=o!==null?`${l}#page=${o}`:l,d=this.deps.app.workspace,u=d.getMostRecentLeaf();d.setActiveLeaf(s,{focus:!1});try{await this.openPdfLinkInLeaf(s,c),this.updatePdfSidebarIcon(s)}finally{u&&d.setActiveLeaf(u,{focus:!1})}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(p){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(p)}))}syncPdfSidebarForPreview(p){let e=this.previewScrollEl;if(!e)return;let n=p.getViewData();if(!n)return;let t=xn.Text.of(n.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(t);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(t,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(p){var t;let e=p.getBoundingClientRect().top,n=p.querySelectorAll("[data-line]");for(let i of Array.from(n))if(i.getBoundingClientRect().bottom>=e+2){let a=(t=i.getAttribute("data-line"))!=null?t:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var t,i;if(this.pdfSidebarLeaf&&((i=(t=this.pdfSidebarLeaf.view)==null?void 0:t.getViewType)==null?void 0:i.call(t))==="pdf")return this.pdfSidebarLeaf;let p=this.deps.app.workspace;if(typeof p.ensureSideLeaf=="function")try{let r=await p.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let n=this.deps.app.workspace.getRightLeaf(!0);return n&&this.isRightSidebarLeaf(n)?(this.pdfSidebarLeaf=n,this.updatePdfSidebarIcon(n),n):null}isRightSidebarLeaf(p){if(!p)return!1;let n=p.containerEl;return!!(n!=null&&n.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(p){if(!p||!this.isRightSidebarLeaf(p))return;let n=p.containerEl,t=[];n&&t.push(...Array.from(n.querySelectorAll(".view-header-icon")));let i=p;if(i.tabHeaderEl&&t.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&t.push(i.tabHeaderInnerIconEl),t.length===0)return;let r=new Set;for(let s of t)r.has(s)||(r.add(s),s.innerHTML="",(0,te.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=p.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(p,e){var r,a,s;let n=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],t=(s=(a=n==null?void 0:n.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof t=="function"){await t.call(n.lib.workspace,p,e,"",{active:!1});return}let i=p;if(typeof i.openLinkText=="function"){await i.openLinkText(e,"",{active:!1});return}await this.deps.app.workspace.openLinkText(e,"",!1)}getPluginsRegistry(){var p;return(p=this.deps.app.plugins)==null?void 0:p.plugins}isLeafTabActive(p){var i;let e=p;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===p;let n=e.containerEl;if(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))return!0;let t=e.tabHeaderEl;return!!(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))}async resolvePageNumberForChunk(p,e){var l,c,d,u,_;if(!p||!e)return null;let n=this.deps.normalizeChunkIdForNote(e,p)||e,t=this.chunkPageCache.get(p);if(t&&t.has(n))return(l=t.get(n))!=null?l:null;let i=(0,te.normalizePath)(`${V}/${p}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let h of s){let y=typeof(h==null?void 0:h.chunk_id)=="string"?h.chunk_id.trim():"";if(!y)continue;let v=Number.isFinite((c=h==null?void 0:h.page_start)!=null?c:NaN)?Number(h.page_start):null,f=Number.isFinite((d=h==null?void 0:h.page_end)!=null?d:NaN)?Number(h.page_end):null,b=v!=null?v:f;b!==null&&(o.set(y,b),o.set(`${p}:${y}`,b))}return this.chunkPageCache.set(p,o),(_=(u=o.get(n))!=null?u:o.get(e))!=null?_:null}};var De={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var de=require("@codemirror/state"),ee=require("@codemirror/view"),$=require("obsidian");var M=g=>{if(typeof g=="string")return g.trim();if(typeof g=="number"&&Number.isFinite(g))return String(g);if(Array.isArray(g))for(let p of g){if(typeof p=="string"&&p.trim())return p.trim();if(typeof p=="number"&&Number.isFinite(p))return String(p)}if(g&&typeof g=="object"){let p=g[0];if(typeof p=="string"&&p.trim())return p.trim();if(typeof p=="number"&&Number.isFinite(p))return String(p)}return""},vn=g=>{let p=[g.key,g.itemKey,g.id,g.citationKey];for(let e of p)if(typeof e=="string"&&e.trim())return e.trim();return null},wn=g=>{var e,n,t;let p=(t=(n=g.key)!=null?n:(e=g.data)==null?void 0:e.key)!=null?t:"";return typeof p=="string"?p:""},nn=g=>{if(!g)return"";let p=g.match(/\b(\d{4})\b/);return p?p[1]:""},Pn=g=>{var e,n,t,i;let p=(i=(t=(e=g.meta)==null?void 0:e.parsedDate)!=null?t:(n=g.data)==null?void 0:n.date)!=null?i:"";return typeof p!="string"?"":nn(p)},he=g=>{if(!g||typeof g!="object")return"";if(g.name)return String(g.name);let p=g.firstName?String(g.firstName):"",e=g.lastName?String(g.lastName):"";return[e,p].filter(Boolean).join(", ")||`${p} ${e}`.trim()},Cn=(g,p)=>{let e=[p==null?void 0:p["citation-key"],p==null?void 0:p.citationKey,p==null?void 0:p.citationkey,p==null?void 0:p.citekey,p==null?void 0:p.citeKey,p==null?void 0:p.betterBibtexKey,p==null?void 0:p.betterbibtexkey,g["citation-key"],g.citationKey,g.citationkey,g.citekey,g.citeKey,g.betterBibtexKey,g.betterbibtexkey];for(let i of e){let r=M(i);if(r)return r}let n=typeof g.extra=="string"?g.extra:"";if(!n)return"";let t=n.split(/\r?\n/);for(let i of t){let r=i.match(/^\s*biblatexcitekey\s*\[([^\]]+)\]\s*$/i);if(r&&r[1])return r[1].trim();let a=i.match(/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:\s*(.+)\s*$/i);if(a&&a[2])return a[2].trim()}return""},An=g=>{if(!g)return"";let p=[g["citation-key"],g.citationKey,g.citationkey,g.citekey,g.citation_key];for(let e of p){let n=M(e);if(n)return n}return""},Sn=g=>{var e,n;if(!g)return"";let p=(n=(e=g["title-short"])!=null?e:g.shortTitle)!=null?n:g.short_title;return typeof p=="string"?p.trim():""},me=g=>{let p=M(g.shortTitle);if(p)return p;let e=M(g.short_title);if(e)return e;let n=M(g["title-short"]);return n||""},Ln=g=>{let p=typeof g.extra=="string"?g.extra:"";if(!p)return"";let e=p.split(/\r?\n/);for(let t of e){let i=t.match(/^\s*doi\s*:\s*(.+)\s*$/i);if(i&&i[1])return i[1].trim().replace(/[.,;]+$/,"")}let n=p.match(/\b10\.\d{4,9}\/[-._;()/:A-Z0-9]+\b/i);return n?n[0].replace(/[.,;]+$/,""):""},En=g=>{var e;if(!g)return"";let p=(e=g.DOI)!=null?e:g.doi;return typeof p=="string"?p.trim().replace(/[.,;]+$/,""):""},at=g=>{if(!g)return[];let p=[g.attachments,g.children,g.items,g.attachment,g.allAttachments],e=[];for(let n of p)n&&(Array.isArray(n)?e.push(...n):typeof n=="object"&&e.push(n));return e},st=g=>{var n,t,i,r,a,s,o,l,c,d,u,_,h,y,v;if(((s=(a=(i=(n=g==null?void 0:g.contentType)!=null?n:g==null?void 0:g.mimeType)!=null?i:(t=g==null?void 0:g.data)==null?void 0:t.contentType)!=null?a:(r=g==null?void 0:g.data)==null?void 0:r.mimeType)!=null?s:"")==="application/pdf")return!0;let e=(v=(y=(_=(u=(c=(o=g==null?void 0:g.filename)!=null?o:g==null?void 0:g.fileName)!=null?c:(l=g==null?void 0:g.data)==null?void 0:l.filename)!=null?u:(d=g==null?void 0:g.data)==null?void 0:d.fileName)!=null?_:g==null?void 0:g.path)!=null?y:(h=g==null?void 0:g.data)==null?void 0:h.path)!=null?v:"";return!!(typeof e=="string"&&e.toLowerCase().endsWith(".pdf"))},Nn=g=>{var n;let p=at(g.data);if(p.length>0)return p.some(i=>st(i))?"yes":"no";let e=(n=g.meta)==null?void 0:n.numChildren;return typeof e=="number"&&e===0?"no":"unknown"};var ot={artwork:"image",audioRecording:"music",bill:"file-text",blogPost:"globe",book:"book",bookSection:"book-open",case:"scale",computerProgram:"code",conferencePaper:"file-text",dataset:"database",dictionaryEntry:"book",document:"file-text",email:"mail",encyclopediaArticle:"book",film:"film",forumPost:"message-circle",hearing:"file-text",interview:"mic",journalArticle:"file-text",letter:"mail",magazineArticle:"file-text",manuscript:"file-text",map:"map",newspaperArticle:"file-text",patent:"award",podcast:"mic",preprint:"file-text",presentation:"file-text",radioBroadcast:"music",report:"file-text",statute:"scale",thesis:"graduation-cap",tvBroadcast:"film",videoRecording:"film",webpage:"globe"},Rn=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],lt=g=>g.includes("STDERR")?"zrr-log-stderr":g.includes("ERROR")?"zrr-log-error":g.includes("WARNING")||g.includes("WARN")?"zrr-log-warning":g.includes("INFO")?"zrr-log-info":null,Dn=g=>{let p=new de.RangeSetBuilder;for(let{from:e,to:n}of g.visibleRanges){let t=e;for(;t<=n;){let i=g.state.doc.lineAt(t),r=lt(i.text);r&&p.add(i.from,i.from,ee.Decoration.line({class:r})),t=i.to+1}}return p.finish()},Tn=ee.EditorView.theme({".cm-editor":{height:"100%",display:"flex",flexDirection:"column",minHeight:"0"},".cm-scroller":{fontFamily:"var(--font-monospace)",fontSize:"0.85rem",flex:"1",height:"100%",maxHeight:"100%",overflow:"auto"},".zrr-log-error":{color:"var(--text-error)"},".zrr-log-warning":{color:"var(--text-accent)"},".zrr-log-info":{color:"var(--text-muted)"},".zrr-log-stderr":{color:"var(--text-accent)"}}),On=ee.ViewPlugin.fromClass(class{constructor(g){this.decorations=Dn(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=Dn(g.view))}},{decorations:g=>g.decorations}),ve=class extends $.Modal{constructor(p,e,n,t,i="Value cannot be empty."){super(p),this.titleText=e,this.placeholder=n,this.onSubmit=t,this.emptyMessage=i}onOpen(){let{contentEl:p}=this;p.empty(),p.createEl("h3",{text:this.titleText});let e=p.createEl("input",{type:"text",placeholder:this.placeholder});e.style.width="100%",e.focus();let n=p.createEl("button",{text:"Submit"});n.style.marginTop="0.75rem";let t=()=>{let i=e.value.trim();if(!i){new $.Notice(this.emptyMessage);return}this.close(),this.onSubmit(i)};n.addEventListener("click",t),e.addEventListener("keydown",i=>{i.key==="Enter"&&t()})}},Te=class extends $.Modal{constructor(p,e,n,t,i){super(p),this.chunkId=e,this.initialTags=n,this.onSubmit=t,this.onRegenerate=i}onOpen(){let{contentEl:p}=this;p.empty(),p.createEl("h3",{text:`Edit tags for ${this.chunkId}`});let e=p.createEl("textarea",{attr:{rows:"3"}});e.style.width="100%",e.placeholder="tag1, tag2, tag3",e.value=this.initialTags.join(", "),e.focus();let n=p.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Save tags"}),i=async()=>{let a=(e.value||"").split(/[,;\n]+/).map(o=>o.trim()).filter(o=>o.length>0),s=Array.from(new Set(a));this.close(),await Promise.resolve(this.onSubmit(s))};if(this.onRegenerate){let r=n.createEl("button",{text:"Regenerate"});r.addEventListener("click",async()=>{var a;r.setAttribute("disabled","true"),t.setAttribute("disabled","true");try{let s=await((a=this.onRegenerate)==null?void 0:a.call(this));s&&s.length>0?(e.value=s.join(", "),await Promise.resolve(this.onSubmit(s))):s&&new $.Notice("No tags were generated.")}finally{r.removeAttribute("disabled"),t.removeAttribute("disabled")}})}t.addEventListener("click",i),e.addEventListener("keydown",r=>{r.key==="Enter"&&(r.metaKey||r.ctrlKey)&&i()})}},Oe=class extends $.Modal{constructor(p,e,n,t=""){super(p),this.titleText=e,this.content=n,this.noteText=t}onOpen(){let{contentEl:p}=this;if(p.empty(),p.createEl("h3",{text:this.titleText}),this.noteText){let n=p.createEl("div",{text:this.noteText});n.className="zrr-indexed-note"}let e=p.createEl("textarea",{attr:{rows:"12",readonly:"true"}});e.style.width="100%",e.value=this.content}},Ie=class extends $.Modal{constructor(e,n,t=""){super(e);this.bodyText="";this.plugin=n,this.initialTerm=t}onOpen(){let{contentEl:e}=this;e.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),e.style.display="flex",e.style.flexDirection="column",e.style.height="100%",e.style.overflow="hidden",e.style.minHeight="0";let n=e.createDiv();n.style.display="flex",n.style.alignItems="center",n.style.justifyContent="space-between",n.style.gap="0.5rem",n.createEl("h3",{text:"Redis index search"});let t=n.createEl("button",{text:"Copy All"});t.style.marginLeft="auto",t.addEventListener("click",()=>{this.copyResultsToClipboard()});let i=e.createDiv();i.style.display="flex",i.style.alignItems="center",i.style.gap="0.5rem",i.style.margin="0.5rem 0";let r=i.createEl("input");r.type="text",r.placeholder="Search term",r.value=this.initialTerm,r.style.flex="1",r.style.minWidth="0",this.inputEl=r,i.createEl("button",{text:"Search"}).addEventListener("click",()=>{this.runSearch()}),r.addEventListener("keydown",c=>{c.key==="Enter"&&(c.preventDefault(),this.runSearch())});let s=e.createDiv();s.style.color="var(--text-muted)",s.style.marginBottom="0.5rem",this.statusEl=s;let o=e.createDiv();o.style.flex="1 1 0",o.style.minHeight="0",o.style.border="1px solid var(--background-modifier-border)",o.style.borderRadius="6px",o.style.display="flex",o.style.flexDirection="column",o.style.overflow="auto";let l=de.EditorState.create({doc:this.bodyText,extensions:[Tn,On,ee.EditorView.editable.of(!1),de.EditorState.readOnly.of(!0),ee.EditorView.lineWrapping]});this.editorView=new ee.EditorView({state:l,parent:o}),this.initialTerm&&this.runSearch()}onClose(){var e;(e=this.editorView)==null||e.destroy(),this.editorView=void 0}async runSearch(){var t;let e=(((t=this.inputEl)==null?void 0:t.value)||"").trim();if(!e){this.statusEl&&(this.statusEl.textContent="Enter a search term.");return}this.statusEl&&(this.statusEl.textContent="Searching...");let n=await this.plugin.runRedisSearch(e);this.updateEditor(n),this.statusEl&&(this.statusEl.textContent=`Results for "${e}"`)}updateEditor(e){if(!this.editorView)return;let n=this.editorView,t=n.scrollDOM.scrollTop,i=n.state.selection.main,r=e.length,a=Math.min(i.anchor,r),s=Math.min(i.head,r);n.dispatch({changes:{from:0,to:n.state.doc.length,insert:e},selection:{anchor:a,head:s}}),n.scrollDOM.scrollTop=t,this.bodyText=e}copyResultsToClipboard(){let e=this.bodyText||"";if(!e){new $.Notice("Nothing to copy.");return}navigator.clipboard.writeText(e).then(()=>new $.Notice("Results copied to clipboard.")).catch(()=>new $.Notice("Failed to copy results."))}},ye=class extends $.Modal{constructor(p,e,n,t){super(p),this.titleText=e,this.bodyText=n,this.options=t}onOpen(){var r,a,s,o;let{contentEl:p}=this;p.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),p.style.display="flex",p.style.flexDirection="column",p.style.height="100%",p.style.overflow="hidden",p.style.minHeight="0";let e=p.createDiv();e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="space-between",e.style.gap="0.5rem",e.createEl("h3",{text:this.titleText});let n=e.createDiv();if(n.style.display="flex",n.style.gap="0.5rem",(r=this.options)!=null&&r.onClear){let l=(a=this.options.clearLabel)!=null?a:"Clear log";n.createEl("button",{text:l}).addEventListener("click",async()=>{var d,u;try{await((u=(d=this.options)==null?void 0:d.onClear)==null?void 0:u.call(d))}finally{await this.refreshFromSource()}})}let t=p.createDiv();t.style.flex="1 1 0",t.style.minHeight="0",t.style.border="1px solid var(--background-modifier-border)",t.style.borderRadius="6px",t.style.display="flex",t.style.flexDirection="column",t.style.overflow="auto";let i=de.EditorState.create({doc:this.bodyText,extensions:[Tn,On,ee.EditorView.editable.of(!0),de.EditorState.readOnly.of(!1),ee.EditorView.lineWrapping]});if(this.editorView=new ee.EditorView({state:i,parent:t}),this.refreshFromSource(),(s=this.options)!=null&&s.autoRefresh&&this.options.onRefresh){let l=(o=this.options.refreshIntervalMs)!=null?o:2e3;this.refreshTimer=window.setInterval(()=>{this.refreshFromSource()},l)}}onClose(){var p;this.refreshTimer!==void 0&&(window.clearInterval(this.refreshTimer),this.refreshTimer=void 0),(p=this.editorView)==null||p.destroy(),this.editorView=void 0}async refreshFromSource(){var s;if(!((s=this.options)!=null&&s.onRefresh)||!this.editorView)return;let p="";try{p=await this.options.onRefresh()||""}catch(o){return}if(p===this.bodyText)return;let e=this.editorView,n=e.scrollDOM.scrollTop,t=e.state.selection.main,i=p.length,r=Math.min(t.anchor,i),a=Math.min(t.head,i);e.dispatch({changes:{from:0,to:e.state.doc.length,insert:p},selection:{anchor:r,head:a}}),e.scrollDOM.scrollTop=n,this.bodyText=p}},Fe=class extends $.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.filePath=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Overwrite"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},ze=class extends $.Modal{constructor(e,n,t,i){super(e);this.resolved=!1;this.notePath=n,this.docId=t,this.onResolve=i}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete note and cached data?"}),e.createEl("p",{text:`This will delete the note and cached chunks/items for doc_id ${this.docId}.`}),e.createEl("p",{text:`Note: ${this.notePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Delete"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Me=class extends $.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.reason=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Rebuild Redis index?"}),e.createEl("p",{text:this.reason}),e.createEl("p",{text:"This will drop the RedisSearch index (and embeddings) and rebuild it from cached chunks."});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Drop & rebuild"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},qe=class extends $.Modal{constructor(e,n){super(e);this.resolved=!1;this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Purge Redis orphaned chunks?"}),e.createEl("p",{text:"This removes Redis chunk keys that have no cached item.json or chunk.json on disk."}),e.createEl("p",{text:"Cache files are not deleted. Use this to clean up stale Redis data."});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Purge orphans"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},je=class extends $.Modal{constructor(e,n,t,i,r,a,s){super(e);this.resolved=!1;this.fieldLabel=n,this.noteLabel=t,this.zoteroLabel=i,this.noteValue=r,this.zoteroValue=a,this.onResolve=s}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:`Resolve metadata conflict: ${this.fieldLabel}`});let n=e.createEl("div");n.style.display="grid",n.style.gap="0.5rem",n.createEl("div",{text:"Note value"});let t=n.createEl("textarea",{attr:{readonly:"true",rows:"4"}});t.style.width="100%",t.value=this.noteValue||"(empty)",n.createEl("div",{text:"Zotero value"});let i=n.createEl("textarea",{attr:{readonly:"true",rows:"4"}});i.style.width="100%",i.value=this.zoteroValue||"(empty)";let r=e.createEl("div");r.style.display="flex",r.style.gap="0.5rem",r.style.marginTop="0.75rem";let a=r.createEl("button",{text:this.noteLabel}),s=r.createEl("button",{text:this.zoteroLabel}),o=r.createEl("button",{text:"Skip"});a.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("note")}),s.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("zotero")}),o.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("skip")})}onClose(){this.resolved||this.onResolve("skip")}},$e=class extends $.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve metadata conflicts"}),e.createEl("p",{text:"Choose which values to keep for each field."});let n=e.createEl("div");n.style.display="grid",n.style.gap="0.75rem";for(let l of this.conflicts){let c=n.createEl("div");c.style.display="grid",c.style.gap="0.4rem",c.style.border="1px solid var(--background-modifier-border)",c.style.borderRadius="6px",c.style.padding="0.6rem",c.createEl("div",{text:l.fieldLabel}).style.fontWeight="600";let d=c.createEl("div");d.style.display="grid",d.style.gridTemplateColumns="1fr 1fr",d.style.gap="0.5rem";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});u.style.width="100%",u.value=l.noteValue||"(empty)";let _=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});_.style.width="100%",_.value=l.zoteroValue||"(empty)";let h=c.createEl("div");h.style.display="flex",h.style.gap="0.5rem",h.style.alignItems="center",h.createEl("span",{text:"Decision:"});let y=h.createEl("select");y.add(new Option(l.noteLabel,"note")),y.add(new Option(l.zoteroLabel,"zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.field,y)}let t=e.createEl("div");t.style.display="flex",t.style.flexWrap="wrap",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let i=l=>{for(let c of this.selects.values())c.value=l},r=t.createEl("button",{text:"Use note for all"}),a=t.createEl("button",{text:"Use Zotero for all"}),s=t.createEl("button",{text:"Skip all"}),o=t.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[n,t]of this.selects.entries())e[n]=t.value||"skip";this.onResolve(e)}}},Ve=class extends $.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve annotation conflicts"}),e.createEl("p",{text:"Choose which version to keep for each annotation."});let n=e.createEl("div");n.style.display="grid",n.style.gap="0.75rem";for(let l of this.conflicts){let c=n.createEl("div");c.style.display="grid",c.style.gap="0.4rem",c.style.border="1px solid var(--background-modifier-border)",c.style.borderRadius="6px",c.style.padding="0.6rem",c.createEl("div",{text:l.title}).style.fontWeight="600";let d=c.createEl("div");d.style.display="grid",d.style.gridTemplateColumns="1fr 1fr",d.style.gap="0.5rem";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});u.style.width="100%",u.value=l.noteValue||"(empty)";let _=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});_.style.width="100%",_.value=l.zoteroValue||"(empty)";let h=c.createEl("div");h.style.display="flex",h.style.gap="0.5rem",h.style.alignItems="center",h.createEl("span",{text:"Decision:"});let y=h.createEl("select");y.add(new Option("Use note","note")),y.add(new Option("Use Zotero","zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.key,y)}let t=e.createEl("div");t.style.display="flex",t.style.flexWrap="wrap",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let i=l=>{for(let c of this.selects.values())c.value=l},r=t.createEl("button",{text:"Use note for all"}),a=t.createEl("button",{text:"Use Zotero for all"}),s=t.createEl("button",{text:"Skip all"}),o=t.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[n,t]of this.selects.entries())e[n]=t.value||"skip";this.onResolve(e)}}},Ge=class extends $.SuggestModal{constructor(e,n){super(e);this.resolved=!1;this.resolveSelection=n,this.setPlaceholder("Select a language for OCR/quality...")}getSuggestions(e){let n=e.trim().toLowerCase();return n?Rn.filter(t=>t.label.toLowerCase().includes(n)||t.value.toLowerCase().includes(n)):Rn}renderSuggestion(e,n){n.setText(e.label),n.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new ve(this.app,"Custom language hint","e.g., en, de, fr, de,en",n=>this.resolveSelection(n.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},Be=class extends $.SuggestModal{constructor(e,n,t){super(e);this.lastError=null;this.indexedDocIds=null;this.attachmentStatusCache=new Map;this.attachmentChecks=new Set;this.plugin=n,this.resolveSelection=t,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){try{if(!this.indexedDocIds){let n=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(n))}return await this.plugin.searchZoteroItems(e)}catch(n){let t=n instanceof Error?n.message:String(n);return this.lastError!==t&&(this.lastError=t,new $.Notice(t)),console.error("Zotero search failed",n),[]}}renderSuggestion(e,n){var v,f,b,w,x,L;let t=(f=(v=e.data)==null?void 0:v.title)!=null?f:"[No title]",i=Pn(e),r=wn(e),a=r?(b=this.indexedDocIds)==null?void 0:b.has(r):!1,s=Nn(e),o=String((x=(w=e.data)==null?void 0:w.itemType)!=null?x:"").trim();a&&n.addClass("zrr-indexed-item"),s==="no"&&n.addClass("zrr-no-pdf-item");let l=n.createDiv({cls:"zrr-zotero-suggest-row"}),c=l.createSpan({cls:"zrr-zotero-item-icon"}),d=(L=ot[o])!=null?L:"file-text";(0,$.setIcon)(c,d);let u=l.createDiv({cls:"zrr-zotero-suggest-text"});u.createEl("div",{text:t,cls:"zrr-zotero-suggest-title"});let _=u.createEl("small",{cls:"zrr-zotero-suggest-meta"}),h=!1,y=()=>{h&&_.createSpan({text:" - "})};if(i&&(_.createSpan({text:i}),h=!0),a&&(y(),_.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),h=!0),s==="no"&&(y(),_.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),h=!0),s==="unknown"){let C=r?this.attachmentStatusCache.get(r):void 0;C==="no"?(y(),_.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),h=!0,n.addClass("zrr-no-pdf-item")):C==="yes"||r&&this.refreshAttachmentStatus(r,e,n,_)}n.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,n){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}async refreshAttachmentStatus(e,n,t,i){if(!this.attachmentChecks.has(e)){this.attachmentChecks.add(e);try{let r=await this.plugin.hasProcessableAttachment(n);this.attachmentStatusCache.set(e,r?"yes":"no"),!r&&i.isConnected&&t.isConnected&&(i.querySelector(".zrr-no-pdf-flag")||(i.childNodes.length>0&&i.createSpan({text:" - "}),i.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"})),t.addClass("zrr-no-pdf-item"))}finally{this.attachmentChecks.delete(e)}}}};var In={"docling_extract.py":`#!/usr/bin/env python3
# zotero-redisearch-rag tool version: 0.4.9
import argparse
import atexit
import base64
import errno
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.4.9
aai
aam
abb
abge
...
\xF6pnv
\xFCberarb
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.4.9
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.4.9
services:
  redis-stack:
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,n=1200){let t=this.noteSyncTimers.get(e.path);t!==void 0&&window.clearTimeout(t);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},n);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,n=1200,t="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,t)},n);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,n=1200,t="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,t)},n);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let n=this.annotationNoteEditTimes.get(e);if(!n)return 0;let t=Date.now()-n;return t>=$n?0:$n-t}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=e.page_start?String(e.page_start):"",t=e.page_end?String(e.page_end):"";if(n&&(!t||n===t))return n;if(n&&t)return`${n} - ${t}`;let i=(e.pages||"").trim();if(!i)return"?";let r=i.match(/^(\d+)\s*-\s*(\d+)$/);return r?r[1]===r[2]?r[1]:`${r[1]} - ${r[2]}`:i.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,m.normalizePath)(`${V}/${s}.json`),c=this.app.vault.adapter;if(!await c.exists(l))return;let d=await this.readChunkPayload(l);if(!d)return;let u=Array.isArray(d.chunks)?d.chunks:[],_=new Map;for(let x of u){if(this.isAnnotationChunk(x))continue;let L=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((n=x==null?void 0:x.chunk_id)!=null?n:"");L&&_.set(L,x)}let h=new Set,y=new Set,v=new Set,f=new Set,b=!1;for(let x of o){let L=x.chunkId;if(!L)continue;h.add(L);let C=_.get(L);if(!C){console.warn(`Sync note: chunk id not found in cache (${L})`);continue}if(x.excludeFlag){C.excluded!==!0&&(C.excluded=!0,b=!0);let F=this.normalizeChunkText(x.text);F&&F!==String((t=C.text)!=null?t:"")&&(C.text=F,C.char_count=F.length,b=!0),v.add(L);continue}if(C.excluded&&(C.excluded=!1,b=!0,y.add(L)),!x.text.trim()){v.add(L),f.add(L);continue}let A=this.normalizeChunkText(x.text);if(!A){v.add(L),f.add(L);continue}let D=typeof C.text=="string"?C.text:String((i=C.text)!=null?i:"");A!==D&&(C.text=A,C.char_count=A.length,y.add(L),b=!0)}for(let x of _.keys())h.has(x)||(v.add(x),f.add(x));let w=new Set([...v,...f]);if(w.size){let x=Array.from(w).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==x){this.noteSyncPendingDeletes.set(e.path,x),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!y.size&&!v.size&&!f.size&&!b)return;f.size&&(d.chunks=u.filter(x=>{var C;let L=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((C=x==null?void 0:x.chunk_id)!=null?C:"");return L&&!f.has(L)}),b=!0),(b||f.size)&&await c.write(l,JSON.stringify(d,null,2)),await this.reindexChunkUpdates(s,l,Array.from(y),Array.from(v)),(v.size||f.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,n){var t,i,r,a;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,n);return}this.noteMetadataSyncInFlight.add(e.path);try{let s=await this.app.vault.read(e),o=await this.resolveDocIdForNote(e,s);if(!o)return;let l=(i=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter)!=null?i:{},c=this.resolveZoteroItemKey(l,o);if(!c)return;let d=await this.fetchZoteroItem(c),u=(r=d==null?void 0:d.data)!=null?r:d;if(!u||typeof u!="object")return;let _=this.extractNoteMetadata(l),h=this.extractZoteroMetadata(u),y=await this.getMetadataSnapshot(o,l,e),v={},f={},b={},w=[],x=["title","short_title","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],L={title:"Title",short_title:"Short title",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let C of x){let A=_[C],D=h[C];if(this.metadataValuesEqual(C,A,D))continue;let F=y==null?void 0:y[C];if(F!==void 0){let E=!this.metadataValuesEqual(C,A,F),I=!this.metadataValuesEqual(C,D,F);if(E&&!I){b[C]="note",this.assignMetadataUpdate(f,C,A);continue}if(!E&&I){b[C]="zotero",this.assignMetadataUpdate(v,C,D);continue}}let z=this.getMetadataDecisionLabels(C,A,D,L);w.push({field:C,fieldLabel:L[C],noteLabel:z.noteLabel,zoteroLabel:z.zoteroLabel,noteValue:this.formatMetadataValue(A),zoteroValue:this.formatMetadataValue(D)})}if(w.length>0){let C=await this.promptMetadataBatchDecision(w);for(let A of w){let D=(a=C[A.field])!=null?a:"skip";b[A.field]=D,D==="note"?this.assignMetadataUpdate(f,A.field,_[A.field]):D==="zotero"&&this.assignMetadataUpdate(v,A.field,h[A.field])}}Object.keys(v).length>0&&await this.applyNoteMetadataUpdates(e,v),Object.keys(f).length>0&&await this.applyZoteroMetadataUpdates(c,u,_,h,f),await this.updateMetadataSnapshot(e,o,_,h,y,b,x)}catch(s){console.warn("Failed to sync note metadata with Zotero",s)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,n)}}async syncNoteAnnotationsWithZotero(e,n){var t,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,n);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let E=this.ensureDocIdInNoteContent(o,d);E!==o&&await this.writeNoteWithSyncSuppressed(e.path,E)}if(!d)return;let u=(i=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter)!=null?i:{},_=(r=c.attachmentKey)!=null?r:"";if(_||(_=await this.resolveAttachmentKeyForDocId(d,u)),!_)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===_&&await this.updateDocIndex({doc_id:d,attachment_key:_});let h=await this.fetchZoteroAnnotations(_),y=this.parseAnnotationBlock(l.block,_),v=new Map;for(let E of y)E.key&&v.set(E.key,E);let f=new Map;for(let E of h)f.set(E.key,E);let b=await this.getAnnotationSnapshot(d),w=(a=b==null?void 0:b.annotations)!=null?a:{},x={},L=[],C=!1,A=!1,D=!1;for(let[E,I]of f.entries()){let T=v.get(E);if(!T){A=!0;continue}let q=w[E],B=this.annotationSnapshotFromEntry(T,I.annotationType),O=this.annotationSnapshotFromEntry(I,I.annotationType);if(!q){this.annotationSnapshotsEqual(B,O)||(x[E]="note",C=!0);continue}let j=!this.annotationSnapshotsEqual(B,q),Z=!this.annotationSnapshotsEqual(O,q);if(j&&!Z){x[E]="note",C=!0;continue}if(!j&&Z){x[E]="zotero",A=!0;continue}j&&Z&&L.push({key:E,title:this.formatAnnotationConflictTitle(I),noteValue:this.formatAnnotationConflictValue(B,T.tags),zoteroValue:this.formatAnnotationConflictValue(O,I.tags)})}if(L.length>0){let E=await this.promptAnnotationBatchDecision(L);for(let I of L){let T=(s=E[I.key])!=null?s:"skip";x[I.key]=T,T==="note"?C=!0:T==="zotero"&&(A=!0,D=!0)}}let F=[];for(let[E,I]of Object.entries(x)){if(I!=="note")continue;let T=v.get(E),q=f.get(E);!T||!q||F.push({entry:q,note:T})}F.length>0&&await this.applyZoteroAnnotationUpdates(F),C&&this.annotationNoteEditTimes.set(e.path,Date.now());let z=this.getAnnotationGraceRemaining(e.path);if(A&&z>0&&C&&!D&&(this.scheduleNoteAnnotationSync(e,z+250,n),A=!1),A){let E=this.buildAnnotationBlock(d,_,h),I=this.replaceAnnotationBlock(o,E);if(I&&I!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,I)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,_,h),await this.updateAnnotationChunks(d,_,h)}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,n)}}resolveZoteroItemKey(e,n){let t=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),n];for(let i of t){let r=M(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,n){var l;if(!e)return"";let t=await this.getDocIndexEntry(e);if(t||(t=await this.hydrateDocIndexFromCache(e)),t!=null&&t.attachment_key)return t.attachment_key;let i=(0,m.normalizePath)(`${V}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let d=await this.readChunkPayload(i),u=d!=null&&d.metadata&&typeof d.metadata=="object"?d.metadata:null,_=u==null?void 0:u.attachment_key;if(typeof _=="string"&&_.trim())return await this.updateDocIndex({doc_id:e,attachment_key:_.trim()}),_.trim()}}catch(c){}let r=this.resolveZoteroItemKey(n,e);if(!r)return"";let a=await this.fetchZoteroItem(r),s=(l=a==null?void 0:a.data)!=null?l:a;if(!s||typeof s!="object")return"";let o=await we(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var v,f,b,w,x,L,C,A,D;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString((w=(b=(f=(v=e==null?void 0:e["short title"])!=null?v:e==null?void 0:e.short_title)!=null?f:e==null?void 0:e.shortTitle)!=null?b:e==null?void 0:e["short-title"])!=null?w:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString((x=e==null?void 0:e.abstract)!=null?x:e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((L=e==null?void 0:e.doi)!=null?L:e==null?void 0:e.DOI),s=this.normalizeMetadataString(e==null?void 0:e.publisher),o=this.normalizeMetadataString(e==null?void 0:e.place),l=this.normalizeMetadataString(e==null?void 0:e.issue),c=this.normalizeMetadataString(e==null?void 0:e.volume),d=this.normalizeMetadataString(e==null?void 0:e.pages),u=this.normalizeMetadataString((D=(A=(C=e==null?void 0:e["item type"])!=null?C:e==null?void 0:e.item_type)!=null?A:e==null?void 0:e.itemType)!=null?D:e==null?void 0:e["item-type"]),_=this.normalizeMetadataList(e==null?void 0:e.tags),h=this.normalizeMetadataList(e==null?void 0:e.authors),y=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:n,short_title:t,date:i,abstract:r,doi:a,publisher:s,place:o,issue:l,volume:c,pages:d,item_type:u,tags:this.sanitizeObsidianTags(_),authors:h,editors:y}}extractZoteroMetadata(e){var f,b,w;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString(me(e)),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString(e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((f=e==null?void 0:e.DOI)!=null?f:e==null?void 0:e.doi),s=this.normalizeMetadataString(e==null?void 0:e.publisher),o=this.normalizeMetadataString(e==null?void 0:e.place),l=this.normalizeMetadataString(e==null?void 0:e.issue),c=this.normalizeMetadataString(e==null?void 0:e.volume),d=this.normalizeMetadataString(e==null?void 0:e.pages),u=this.normalizeMetadataString((w=(b=e==null?void 0:e.itemType)!=null?b:e==null?void 0:e.item_type)!=null?w:e==null?void 0:e["item-type"]),_=Array.isArray(e==null?void 0:e.creators)?e.creators:[],h=_.filter(x=>(x==null?void 0:x.creatorType)==="author").map(x=>he(x)).filter(Boolean),y=_.filter(x=>(x==null?void 0:x.creatorType)==="editor"||(x==null?void 0:x.creatorType)==="seriesEditor").map(x=>he(x)).filter(Boolean),v=Array.isArray(e==null?void 0:e.tags)?e.tags.map(x=>typeof x=="string"?x:x==null?void 0:x.tag).filter(x=>typeof x=="string"):[];return{title:n,short_title:t,date:i,abstract:r,doi:a,publisher:s,place:o,issue:l,volume:c,pages:d,item_type:u,tags:this.sanitizeObsidianTags(v),authors:this.normalizeMetadataList(h),editors:this.normalizeMetadataList(y)}}extractAnnotationPageInfo(e){var a;let t=M((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:t,pageIndex:i}}parseZoteroAnnotationItem(e,n){var f,b,w,x;let t=(b=(f=e==null?void 0:e.data)!=null?f:e)!=null?b:{},i=M((w=e==null?void 0:e.key)!=null?w:t==null?void 0:t.key);if(!i)return null;let r=M(t.annotationType),a=this.normalizeAnnotationText(t.annotationText),s=this.normalizeAnnotationText(t.annotationComment),o=M(t.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:u,pageIndex:_}=this.extractAnnotationPageInfo(t),h=(x=t.annotationSortIndex)!=null?x:t.annotationSort,y=Number.isFinite(Number(h))?Number(h):0,v=Array.isArray(t.tags)?t.tags.map(L=>typeof L=="string"?L:L==null?void 0:L.tag).filter(L=>typeof L=="string"):[];return{key:i.trim(),attachmentKey:n,pageLabel:u,pageIndex:_,colorKey:l,callout:d,heading:c,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(v),sortIndex:y,rawValues:t}}async fetchZoteroAnnotations(e){var i,r;if(!e)return[];let n=[];try{n=await this.fetchZoteroChildren(e)}catch(a){return console.warn("Failed to fetch Zotero annotation items",a),[]}let t=[];for(let a of n){let s=(r=(i=a==null?void 0:a.data)!=null?i:a)!=null?r:{};if(M(s.itemType)!=="annotation")continue;let o=this.parseZoteroAnnotationItem(a,e);o&&t.push(o)}return t}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
`)}async renderFrontmatter(e,n,t,i,r,a){var d;let s=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,n,t,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let n=e.split(/\r?\n/),t=[],i=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<n.length;){let l=n[o],c=l.match(i);if(!c){t.push(l),o+=1;continue}let d=c[1].trim(),u=c[2].trim();if(a.has(d)){t.push(l),o+=1;continue}if(!s(u)){t.push(l),o+=1;continue}let _=o+1,h=[];for(;_<n.length&&n[_].match(r);)h.push(n[_]),_+=1;if(h.length===0){for(o=_;o<n.length&&n[o].trim()==="";)o+=1;continue}let y=h.filter(v=>{let f=v.match(r);if(!f)return!1;let b=f[1].trim();return!s(b)});if(y.length>0&&t.push(l,...y),o=_,y.length===0)for(;o<n.length&&n[o].trim()==="";)o+=1}for(;t.length>0&&t[t.length-1].trim()==="";)t.pop();return t.join(`

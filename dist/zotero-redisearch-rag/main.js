...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{pdf_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Fragen",callout:"question"},red:{heading:"Kritikw\xFCrdiges",callout:"bug"},green:{heading:"Hauptgedanken",callout:"idea"},blue:{heading:"Fakten",callout:"fact"},purple:{heading:"Argumente/L\xF6sungen",callout:"argument"},magenta:{heading:"Meinungen",callout:"opinion"},orange:{heading:"Weiterverfolgen",callout:"pursue"},gray:{heading:"Zitierbare Stellen",callout:"cite"}},llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,chatPaneLocation:"right",enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"BAAI/bge-reranker-v2-m3",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${Q}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Re=class extends O.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async f=>{this.plugin.settings.llmProviderProfiles=f,await this.plugin.saveSettings()},i=f=>{f.inputEl.type="password",f.inputEl.autocomplete="off",f.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:f=>{f.createEl("h2",{text:"Prerequisites"}),new O.Setting(f).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(x=>x.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async b=>{this.plugin.settings.pythonPath=b.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Python environment").setDesc("Create or update the plugin's Python env (location configured below).").addButton(x=>{x.setButtonText("Create/Update").setCta(),x.onClick(async()=>{x.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{x.setDisabled(!1)}})}),new O.Setting(f).setName("Python env location").setDesc("Shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(x=>{x.addOption("shared","Shared user cache"),x.addOption("plugin","Plugin folder (.venv)"),x.setValue(this.plugin.settings.pythonEnvLocation).onChange(async b=>{b!=="shared"&&b!=="plugin"||(this.plugin.settings.pythonEnvLocation=b,await this.plugin.saveSettings())})}),new O.Setting(f).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(x=>x.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async b=>{this.plugin.settings.dockerPath=b.trim()||"docker",await this.plugin.saveSettings()})),new O.Setting(f).setName("Redis URL").addText(x=>x.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async b=>{this.plugin.settings.redisUrl=b.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(x=>x.setPlaceholder("~/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async b=>{this.plugin.settings.redisDataDirOverride=b.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(x=>x.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async b=>{this.plugin.settings.redisProjectName=b.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(x=>x.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async b=>{this.plugin.settings.autoAssignRedisPort=b,await this.plugin.saveSettings()})),new O.Setting(f).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Uses a vault-specific data dir at .obsidian/zotero-redisearch-rag/redis-data unless overridden.").addToggle(x=>x.setValue(this.plugin.settings.autoStartRedis).onChange(async b=>{this.plugin.settings.autoStartRedis=b,await this.plugin.saveSettings()})),new O.Setting(f).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(x=>x.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:f=>{f.createEl("h2",{text:"Zotero Local API"}),new O.Setting(f).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(A=>A.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async C=>{this.plugin.settings.zoteroBaseUrl=C.trim(),await this.plugin.saveSettings()}));let x=new O.Setting(f).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),b=null,S=A=>{if(!b)return;let C=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(A.map(F=>F.value)).has(C)||(A=A.concat([{value:C,label:`Custom (${C})`}])),b.selectEl.options.length=0;for(let F of A)b.addOption(F.value,F.label);b.setValue(C)},R=async()=>{if(b){b.setDisabled(!0);try{let A=await this.plugin.fetchZoteroLibraryOptions();S(A)}finally{b.setDisabled(!1)}}};x.addDropdown(A=>{b=A;let C=(this.plugin.settings.zoteroUserId||"0").trim()||"0";A.addOption(C,"Loading..."),A.setValue(C),A.onChange(async N=>{this.plugin.settings.zoteroUserId=N.trim(),await this.plugin.saveSettings()})}),x.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await R()})}),R(),f.createEl("h2",{text:"Zotero Web API"}),new O.Setting(f).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(A=>A.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async C=>{this.plugin.settings.webApiBaseUrl=C.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(A=>A.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async C=>{this.plugin.settings.webApiLibraryType=C,await this.plugin.saveSettings()})),new O.Setting(f).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(A=>A.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async C=>{this.plugin.settings.webApiLibraryId=C.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(A=>{i(A),A.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async C=>{this.plugin.settings.webApiKey=C.trim(),await this.plugin.saveSettings()})}),f.createEl("h2",{text:"Output"}),new O.Setting(f).setName("PDF folder").addText(A=>A.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async C=>{this.plugin.settings.outputPdfDir=C.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Notes folder").addText(A=>A.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async C=>{this.plugin.settings.outputNoteDir=C.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(A=>{A.setValue(this.plugin.settings.frontmatterTemplate).onChange(async C=>{this.plugin.settings.frontmatterTemplate=C,await this.plugin.saveSettings()}),A.inputEl.rows=10,A.inputEl.style.width="100%"}),new O.Setting(f).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(A=>A.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async C=>{this.plugin.settings.tagSanitizeMode=C,await this.plugin.saveSettings()})),new O.Setting(f).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(A=>{A.setValue(this.plugin.settings.noteBodyTemplate).onChange(async C=>{this.plugin.settings.noteBodyTemplate=C,await this.plugin.saveSettings()}),A.inputEl.rows=8,A.inputEl.style.width="100%"}),new O.Setting(f).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(A=>A.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async C=>{this.plugin.settings.chatOutputDir=C.trim()||"zotero/chats",await this.plugin.saveSettings()})),new O.Setting(f).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(A=>A.setValue(this.plugin.settings.copyPdfToVault).onChange(async C=>{this.plugin.settings.copyPdfToVault=C,!C&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new O.Setting(f).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(A=>{let C=this.plugin.settings.copyPdfToVault;A.setValue(C?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!C).onChange(async N=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=N,await this.plugin.saveSettings()})}),new O.Setting(f).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(A=>A.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async C=>{this.plugin.settings.preferObsidianNoteForCitations=C,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:f=>{f.createEl("h2",{text:"Annotations"}),new O.Setting(f).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(R=>R.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async A=>{this.plugin.settings.annotationPageLabel=A.trim()||"Page",await this.plugin.saveSettings()})),f.createEl("h3",{text:"Annotation color map"}),f.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let x=f.createDiv({cls:"zrr-annotation-map"}),b=async R=>{this.plugin.settings.annotationColorMap=R,await this.plugin.saveSettings()},S=()=>{var T,z;x.empty();let R=this.plugin.settings.annotationColorMap||{},A=Object.entries(R);if(A.length||x.createEl("p",{text:"No color mappings configured."}),A.length){let D=x.createDiv({cls:"zrr-annotation-map-row-header"});D.createEl("span",{text:"Color"}),D.createEl("span",{text:"Heading"}),D.createEl("span",{text:"Callout"}),D.createEl("span")}for(let[D,M]of A){let I=x.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),q=I.createEl("input",{type:"text",value:D,cls:"zrr-annotation-map-input"}),$=I.createEl("input",{type:"text",value:(T=M.heading)!=null?T:"",cls:"zrr-annotation-map-input"}),G=I.createEl("input",{type:"text",value:(z=M.callout)!=null?z:"",cls:"zrr-annotation-map-input"}),J=I.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});J.type="button",q.addEventListener("change",async()=>{let Z=q.value.trim().toLowerCase();if(!Z){q.value=D;return}let ee={...this.plugin.settings.annotationColorMap||{}};if(Z!==D&&ee[Z]){new O.Notice(`Annotation color '${Z}' already exists.`),q.value=D;return}let X=ee[D];delete ee[D],ee[Z]=X!=null?X:{heading:"",callout:""},await b(ee),S()}),$.addEventListener("change",async()=>{var X;let Z={...this.plugin.settings.annotationColorMap||{}},ee=(X=Z[D])!=null?X:{heading:"",callout:""};ee.heading=$.value.trim(),Z[D]=ee,await b(Z)}),G.addEventListener("change",async()=>{var X;let Z={...this.plugin.settings.annotationColorMap||{}},ee=(X=Z[D])!=null?X:{heading:"",callout:""};ee.callout=G.value.trim(),Z[D]=ee,await b(Z)}),J.addEventListener("click",async()=>{let Z={...this.plugin.settings.annotationColorMap||{}};delete Z[D],await b(Z),S()})}let C=x.createDiv({cls:"zrr-annotation-map-actions"}),N=C.createEl("button",{text:"Add mapping"});N.type="button",N.addEventListener("click",async()=>{let D={...this.plugin.settings.annotationColorMap||{}},M="new-color",j=1;for(;D[M];)M=`new-color-${j}`,j+=1;D[M]={heading:"",callout:""},await b(D),S()});let F=C.createEl("button",{text:"Reset to defaults"});F.type="button",F.addEventListener("click",async()=>{await b({...De.annotationColorMap}),S()})};S()}},{id:"ocr",label:"OCR",render:f=>{f.createEl("h2",{text:"Docling"});let x=null,b=C=>{if(!x)return;let N=this.plugin.settings.ocrEngine;new Set(C.map(T=>T.value)).has(N)||(C=C.concat([{value:N,label:`Current (unavailable): ${N}`}])),x.selectEl.options.length=0;for(let T of C)x.addOption(T.value,T.label);x.setValue(N)},S=async()=>{if(!x)return;x.setDisabled(!0);let C={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{C=await this.plugin.detectOcrEngines()}catch(T){C={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let N=[{value:"auto",label:"Auto (default)"}];C.tesseract&&N.push({value:"tesseract",label:"Tesseract (local)"}),C.paddleStructureLocal&&N.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),C.paddleVlLocal&&N.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(N.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),N.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),b(N),x.setDisabled(!1)},R=new O.Setting(f).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),A=document.createElement("a");A.href="https://aistudio.baidu.com/paddleocr",A.textContent="https://aistudio.baidu.com/paddleocr",A.target="_blank",A.rel="noopener noreferrer",R.descEl.appendChild(A),R.descEl.append("."),R.addText(C=>{i(C),C.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async N=>{this.plugin.settings.paddleApiKey=N.trim(),await this.plugin.saveSettings(),await S()})}),new O.Setting(f).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(C=>C.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async N=>{this.plugin.settings.paddleVlApiUrl=N.trim(),await this.plugin.saveSettings()})),new O.Setting(f).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(C=>C.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async N=>{this.plugin.settings.paddleStructureApiUrl=N.trim(),await this.plugin.saveSettings(),await S()})),new O.Setting(f).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(C=>{x=C,C.addOption("auto","Auto (default)"),C.setValue(this.plugin.settings.ocrEngine),C.onChange(async N=>{this.plugin.settings.ocrEngine=N,await this.plugin.saveSettings()})}),new O.Setting(f).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(C=>C.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async N=>{this.plugin.settings.ocrMode=N,await this.plugin.saveSettings()})),new O.Setting(f).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(C=>C.setValue(this.plugin.settings.forcePerPageOcr).onChange(async N=>{this.plugin.settings.forcePerPageOcr=N,await this.plugin.saveSettings()})),new O.Setting(f).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(C=>{C.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async N=>{this.plugin.settings.ocrQualityThreshold=N,await this.plugin.saveSettings()})}),new O.Setting(f).setName("Chunking").setDesc("page or section").addDropdown(C=>C.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async N=>{this.plugin.settings.chunkingMode=N,await this.plugin.saveSettings()})),S()}},{id:"llms",label:"LLMs",render:f=>{f.createEl("h2",{text:"LLM Provider Profiles"});let x=f.createDiv({cls:"zrr-llm-profiles"}),b=()=>{x.empty();let k=n();k.length||x.createEl("p",{text:"No profiles yet. Add one below."});for(let w of k){let E=x.createEl("details",{cls:"zrr-profile"});k.length===1&&(E.open=!0);let U=E.createEl("summary",{text:w.name||w.id||"Profile"});U.addClass("zrr-profile-title");let Se=E.createDiv({cls:"zrr-profile-body"});new O.Setting(Se).setName("Profile name").addText(oe=>oe.setPlaceholder("My provider").setValue(w.name||"").onChange(async ce=>{w.name=ce.trim(),U.textContent=w.name||w.id||"Profile",await t(n())})),new O.Setting(Se).setName("Base URL").addText(oe=>oe.setPlaceholder("http://localhost:1234/v1").setValue(w.baseUrl||"").onChange(async ce=>{w.baseUrl=ce.trim(),await t(n())})),new O.Setting(Se).setName("API key").setDesc("Stored in settings (not encrypted).").addText(oe=>{i(oe),oe.setPlaceholder("sk-...").setValue(w.apiKey||"").onChange(async ce=>{w.apiKey=ce.trim(),await t(n())})}),new O.Setting(Se).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(oe=>oe.setButtonText("Delete profile").onClick(async()=>{let ce=n().filter(Kn=>Kn.id!==w.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===w.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===w.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===w.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(ce),b()}))}new O.Setting(x).addButton(w=>w.setButtonText("Add profile").onClick(async()=>{let E=`profile-${Date.now().toString(36)}`,U=n().concat([{id:E,name:"Custom",baseUrl:"",apiKey:""}]);await t(U),b()}))};b(),f.createEl("h2",{text:"OCR cleanup"}),new O.Setting(f).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(k=>k.setValue(this.plugin.settings.enableLlmCleanup).onChange(async w=>{this.plugin.settings.enableLlmCleanup=w,await this.plugin.saveSettings()}));let S=null,R=null,A=null,C=async()=>{},N=async(k,w=!0)=>{let E=k.trim();this.plugin.settings.llmCleanupBaseUrl=E,w&&(this.plugin.settings.llmCleanupProviderProfileId="",S&&S.setValue("custom")),R&&R.setValue(E),await this.plugin.saveSettings()},F=async k=>{let w=n().find(E=>E.id===k);this.plugin.settings.llmCleanupProviderProfileId=k,w&&(this.plugin.settings.llmCleanupBaseUrl=w.baseUrl,this.plugin.settings.llmCleanupApiKey=w.apiKey,R==null||R.setValue(w.baseUrl),A==null||A.setValue(w.apiKey)),await this.plugin.saveSettings(),await C()};new O.Setting(f).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{S=k,k.addOption("custom","Custom (manual)");for(let E of n())k.addOption(E.id,E.name||E.id);let w=this.plugin.settings.llmCleanupProviderProfileId;k.setValue(w&&n().some(E=>E.id===w)?w:"custom"),k.onChange(async E=>{if(E==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await F(E)})}),new O.Setting(f).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(k=>{R=k,k.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async w=>{await N(w)})}),new O.Setting(f).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(k=>{A=k,i(k),k.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async w=>{this.plugin.settings.llmCleanupApiKey=w.trim(),this.plugin.settings.llmCleanupProviderProfileId="",S&&S.setValue("custom"),await this.plugin.saveSettings()})});let T=new O.Setting(f).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),z=null,D=k=>{if(!z)return;let w=(this.plugin.settings.llmCleanupModel||"").trim(),E=new Set(k.map(U=>U.value));w&&!E.has(w)&&(k=k.concat([{value:w,label:`Custom (${w})`}])),z.selectEl.options.length=0;for(let U of k)z.addOption(U.value,U.label);w&&z.setValue(w)};C=async()=>{if(z){z.setDisabled(!0);try{let k=await this.plugin.fetchCleanupModelOptions();D(k)}finally{z.setDisabled(!1)}}},T.addDropdown(k=>{z=k;let w=(this.plugin.settings.llmCleanupModel||"").trim();k.addOption(w||"loading","Loading..."),k.setValue(w||"loading"),k.onChange(async E=>{this.plugin.settings.llmCleanupModel=E.trim(),await this.plugin.saveSettings()})}),T.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await C()})}),C(),new O.Setting(f).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(k=>k.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async w=>{let E=Number.parseFloat(w);this.plugin.settings.llmCleanupTemperature=Number.isFinite(E)?E:0,await this.plugin.saveSettings()})),new O.Setting(f).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(k=>k.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async w=>{this.plugin.settings.llmCleanupMinQuality=w,await this.plugin.saveSettings()})),new O.Setting(f).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(k=>k.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async w=>{let E=Number.parseInt(w,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(E)?E:2e3,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Text Embedding"});let M=null,j=null,I=null,q=async()=>{},$=async(k,w=!0)=>{let E=k.trim();this.plugin.settings.embedBaseUrl=E,w&&(this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom")),j&&j.setValue(E),await this.plugin.saveSettings()},G=async k=>{let w=n().find(E=>E.id===k);this.plugin.settings.embedProviderProfileId=k,w&&(this.plugin.settings.embedBaseUrl=w.baseUrl,this.plugin.settings.embedApiKey=w.apiKey,j==null||j.setValue(w.baseUrl),I==null||I.setValue(w.apiKey)),await this.plugin.saveSettings(),await q()};new O.Setting(f).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{M=k,k.addOption("custom","Custom (manual)");for(let E of n())k.addOption(E.id,E.name||E.id);let w=this.plugin.settings.embedProviderProfileId;k.setValue(w&&n().some(E=>E.id===w)?w:"custom"),k.onChange(async E=>{if(E==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await G(E)})}),new O.Setting(f).setName("Embeddings base URL").addText(k=>{j=k,k.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async w=>{await $(w)})}),new O.Setting(f).setName("Embeddings API key").addText(k=>{I=k,i(k),k.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async w=>{this.plugin.settings.embedApiKey=w.trim(),this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom"),await this.plugin.saveSettings()})});let J=new O.Setting(f).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),Z=null,ee=k=>{if(!Z)return;let w=(this.plugin.settings.embedModel||"").trim(),E=new Set(k.map(U=>U.value));w&&!E.has(w)&&(k=k.concat([{value:w,label:`Custom (${w})`}])),Z.selectEl.options.length=0;for(let U of k)Z.addOption(U.value,U.label);w&&Z.setValue(w)};q=async()=>{if(Z){Z.setDisabled(!0);try{let k=await this.plugin.fetchEmbeddingModelOptions();ee(k)}finally{Z.setDisabled(!1)}}},J.addDropdown(k=>{Z=k;let w=(this.plugin.settings.embedModel||"").trim();k.addOption(w||"loading","Loading..."),k.setValue(w||"loading"),k.onChange(async E=>{this.plugin.settings.embedModel=E.trim(),await this.plugin.saveSettings()})}),J.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await q()})}),q(),new O.Setting(f).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(k=>k.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async w=>{this.plugin.settings.embedIncludeMetadata=w,await this.plugin.saveSettings()})),new O.Setting(f).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(k=>k.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async w=>{let E=Number.parseInt(w,10);this.plugin.settings.embedContextWindow=Number.isFinite(E)?Math.max(0,E):1,await this.plugin.saveSettings()})),new O.Setting(f).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(k=>k.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async w=>{let E=Number.parseInt(w,10);this.plugin.settings.embedContextChars=Number.isFinite(E)?Math.max(0,E):220,await this.plugin.saveSettings()})),new O.Setting(f).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(k=>k.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async w=>{let E=Number.parseInt(w,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(E)?Math.max(0,E):3500,await this.plugin.saveSettings()})),new O.Setting(f).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(k=>k.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async w=>{let E=Number.parseInt(w,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(E)?Math.max(0,E):200,await this.plugin.saveSettings()})),new O.Setting(f).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(k=>k.setValue(this.plugin.settings.enableChunkTagging).onChange(async w=>{this.plugin.settings.enableChunkTagging=w,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Chat LLM"});let X=null,se=null,ue=null,_e=async()=>{},Je=async(k,w=!0)=>{let E=k.trim();this.plugin.settings.chatBaseUrl=E,w&&(this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom")),se&&se.setValue(E),await this.plugin.saveSettings()},Xe=async k=>{let w=n().find(E=>E.id===k);this.plugin.settings.chatProviderProfileId=k,w&&(this.plugin.settings.chatBaseUrl=w.baseUrl,this.plugin.settings.chatApiKey=w.apiKey,se==null||se.setValue(w.baseUrl),ue==null||ue.setValue(w.apiKey)),await this.plugin.saveSettings(),await _e()};new O.Setting(f).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{X=k,k.addOption("custom","Custom (manual)");for(let E of n())k.addOption(E.id,E.name||E.id);let w=this.plugin.settings.chatProviderProfileId;k.setValue(w&&n().some(E=>E.id===w)?w:"custom"),k.onChange(async E=>{if(E==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await Xe(E)})}),new O.Setting(f).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(k=>{se=k,k.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async w=>{await Je(w)})}),new O.Setting(f).setName("Chat API key").addText(k=>{ue=k,i(k),k.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async w=>{this.plugin.settings.chatApiKey=w.trim(),this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom"),await this.plugin.saveSettings()})});let Ce=new O.Setting(f).setName("Chat model").setDesc("Select a chat-capable model from the provider."),ie=null,Ye=k=>{if(!ie)return;let w=(this.plugin.settings.chatModel||"").trim(),E=new Set(k.map(U=>U.value));w&&!E.has(w)&&(k=k.concat([{value:w,label:`Custom (${w})`}])),ie.selectEl.options.length=0;for(let U of k)ie.addOption(U.value,U.label);w&&ie.setValue(w)};_e=async()=>{if(ie){ie.setDisabled(!0);try{let k=await this.plugin.fetchChatModelOptions();Ye(k)}finally{ie.setDisabled(!1)}}},Ce.addDropdown(k=>{ie=k;let w=(this.plugin.settings.chatModel||"").trim();k.addOption(w||"loading","Loading..."),k.setValue(w||"loading"),k.onChange(async E=>{this.plugin.settings.chatModel=E.trim(),await this.plugin.saveSettings()})}),Ce.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await _e()})}),_e(),new O.Setting(f).setName("Temperature").addText(k=>k.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async w=>{let E=Number.parseFloat(w);this.plugin.settings.chatTemperature=Number.isFinite(E)?E:.2,await this.plugin.saveSettings()})),new O.Setting(f).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(k=>k.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async w=>{let E=Number.parseInt(w,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(E)?Math.max(0,E):6,await this.plugin.saveSettings()})),new O.Setting(f).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(k=>k.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async w=>{this.plugin.settings.chatPaneLocation=w,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Retrieval"}),new O.Setting(f).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(k=>k.setValue(this.plugin.settings.enableQueryExpansion).onChange(async w=>{this.plugin.settings.enableQueryExpansion=w,await this.plugin.saveSettings()})),new O.Setting(f).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(k=>k.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async w=>{let E=Number.parseInt(w,10);this.plugin.settings.queryExpansionCount=Number.isFinite(E)?Math.max(1,E):3,await this.plugin.saveSettings()})),new O.Setting(f).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(k=>k.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async w=>{this.plugin.settings.enableCrossEncoderRerank=w,await this.plugin.saveSettings()})),new O.Setting(f).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(k=>k.setPlaceholder("BAAI/bge-reranker-v2-m3").setValue(this.plugin.settings.rerankModel).onChange(async w=>{this.plugin.settings.rerankModel=w.trim()||"BAAI/bge-reranker-v2-m3",await this.plugin.saveSettings()})),new O.Setting(f).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(k=>k.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async w=>{let E=Number.parseInt(w,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(E)?Math.max(1,E):4,await this.plugin.saveSettings()})),new O.Setting(f).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(k=>k.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async w=>{let E=Number.parseInt(w,10);this.plugin.settings.rrfK=Number.isFinite(E)?Math.max(1,E):60,await this.plugin.saveSettings()})),new O.Setting(f).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(k=>k.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async w=>{let E=Number.parseInt(w,10);this.plugin.settings.rrfLogTop=Number.isFinite(E)?Math.max(0,E):0,await this.plugin.saveSettings()})),new O.Setting(f).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(k=>k.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async w=>{let E=Number.parseInt(w,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(E)?Math.max(0,E):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:f=>{f.createEl("h2",{text:"Logging"}),new O.Setting(f).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(x=>x.setValue(this.plugin.settings.enableFileLogging).onChange(async b=>{this.plugin.settings.enableFileLogging=b,await this.plugin.saveSettings()})),new O.Setting(f).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(x=>x.setPlaceholder(`${Q}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async b=>{this.plugin.settings.logFilePath=b.trim()||`${Q}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new O.Setting(f).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(x=>x.setButtonText("Open log").onClick(async()=>{var b,S;await((S=(b=this.plugin).openLogFile)==null?void 0:S.call(b))})).addButton(x=>x.setButtonText("Clear log").onClick(async()=>{var b,S;await((S=(b=this.plugin).clearLogFile)==null?void 0:S.call(b))})),f.createEl("h2",{text:"Maintenance"}),new O.Setting(f).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(x=>x.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new O.Setting(f).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(x=>x.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(x=>x.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],u=new Map,_=new Map,y=f=>{this.activeTab=f;for(let[x,b]of u){let S=x===f;b.classList.toggle("is-active",S),b.setAttribute("aria-selected",S?"true":"false"),b.setAttribute("tabindex",S?"0":"-1")}for(let[x,b]of _){let S=x===f;b.classList.toggle("is-active",S),b.hidden=!S}},h=e.createDiv({cls:"zrr-settings-tabs"});h.setAttribute("role","tablist");let v=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let f of d){let x=h.createEl("button",{text:f.label,cls:"zrr-settings-tab-button"}),b=`zrr-settings-tab-${f.id}`,S=`zrr-settings-panel-${f.id}`;x.type="button",x.id=b,x.setAttribute("role","tab"),x.setAttribute("aria-controls",S),x.setAttribute("aria-selected","false"),x.addEventListener("click",()=>y(f.id));let R=v.createDiv({cls:"zrr-settings-tab-panel"});R.id=S,R.setAttribute("role","tabpanel"),R.setAttribute("aria-labelledby",b),R.hidden=!0,f.render(R),u.set(f.id,x),_.set(f.id,R)}let P=d.some(f=>f.id===this.activeTab)?this.activeTab:d[0].id;y(P)}};var wn=require("@codemirror/state"),Pn=require("@codemirror/view"),ae=require("obsidian");var st=g=>{let p=g.scrollDOM.getBoundingClientRect(),e=g.posAtCoords({x:p.left+8,y:+p.height*.25});return e===null?null:g.state.doc.lineAt(e).number},Te=class{constructor(p,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.deps=p,this.helpers=e}createSyncExtension(){let p=this,e=this.helpers;return Pn.ViewPlugin.fromClass(class{constructor(n){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=n,this.docId=e.extractDocIdFromDoc(n.state.doc),this.onScroll=()=>this.scheduleSync(!1),n.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(n){n.docChanged&&(this.docId=e.extractDocIdFromDoc(n.view.state.doc),this.lastPage=null,this.lastChunkId=null),(n.docChanged||n.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(n){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,n)}))}syncPdfSidebar(n,t){var u,_;let i=this.docId;if(!i)return;let r=st(n);if(r===null)return;let a=e.findChunkStartLineInDoc(n.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(u=s==null?void 0:s.pageNumber)!=null?u:null,l=(_=s==null?void 0:s.chunkId)!=null?_:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!t&&(c||d)||(this.lastPage=o,this.lastChunkId=l,p.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,n;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((n=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:n.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let p=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(p.docId,p.pageNumber,p.chunkId)}updatePreviewScrollHandler(){var t;let p=this.deps.app.workspace.getActiveViewOfType(ae.MarkdownView);if(!p||p.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(t=p.previewMode)==null?void 0:t.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let n=()=>this.schedulePreviewSync(p);e.addEventListener("scroll",n,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=n,this.schedulePreviewSync(p)}async syncPdfSidebarForFile(p){try{let e=await this.deps.app.vault.read(p),n=await this.deps.resolveDocIdForNote(p,e);if(!n)return;let t=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(n,t==null?void 0:t.pageNumber,t==null?void 0:t.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(p,e,n){if(!p)return;let t=await this.deps.getDocIndexEntry(p);t||(t=await this.deps.hydrateDocIndexFromCache(p));let i=t!=null&&t.pdf_path?String(t.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let _=(0,ae.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(_)instanceof ae.TFile&&(r=_)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof ae.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:n};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:n};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&n&&(o=await this.resolvePageNumberForChunk(p,n)),o===null||this.pdfSidebarDocId===p&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=p,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,c=o!==null?`${l}#page=${o}`:l,d=this.deps.app.workspace,u=d.getMostRecentLeaf();d.setActiveLeaf(s,{focus:!1});try{await this.openPdfLinkInLeaf(s,c),this.updatePdfSidebarIcon(s)}finally{u&&d.setActiveLeaf(u,{focus:!1})}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(p){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(p)}))}syncPdfSidebarForPreview(p){let e=this.previewScrollEl;if(!e)return;let n=p.getViewData();if(!n)return;let t=wn.Text.of(n.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(t);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(t,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(p){var t;let e=p.getBoundingClientRect().top,n=p.querySelectorAll("[data-line]");for(let i of Array.from(n))if(i.getBoundingClientRect().bottom>=e+2){let a=(t=i.getAttribute("data-line"))!=null?t:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var t,i;if(this.pdfSidebarLeaf&&((i=(t=this.pdfSidebarLeaf.view)==null?void 0:t.getViewType)==null?void 0:i.call(t))==="pdf")return this.pdfSidebarLeaf;let p=this.deps.app.workspace;if(typeof p.ensureSideLeaf=="function")try{let r=await p.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let n=this.deps.app.workspace.getRightLeaf(!0);return n&&this.isRightSidebarLeaf(n)?(this.pdfSidebarLeaf=n,this.updatePdfSidebarIcon(n),n):null}isRightSidebarLeaf(p){if(!p)return!1;let n=p.containerEl;return!!(n!=null&&n.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(p){if(!p||!this.isRightSidebarLeaf(p))return;let n=p.containerEl,t=[];n&&t.push(...Array.from(n.querySelectorAll(".view-header-icon")));let i=p;if(i.tabHeaderEl&&t.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&t.push(i.tabHeaderInnerIconEl),t.length===0)return;let r=new Set;for(let s of t)r.has(s)||(r.add(s),s.innerHTML="",(0,ae.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=p.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(p,e){var r,a,s;let n=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],t=(s=(a=n==null?void 0:n.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof t=="function"){await t.call(n.lib.workspace,p,e,"",{active:!1});return}let i=p;if(typeof i.openLinkText=="function"){await i.openLinkText(e,"",{active:!1});return}await this.deps.app.workspace.openLinkText(e,"",!1)}getPluginsRegistry(){var p;return(p=this.deps.app.plugins)==null?void 0:p.plugins}isLeafTabActive(p){var i;let e=p;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===p;let n=e.containerEl;if(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))return!0;let t=e.tabHeaderEl;return!!(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))}async resolvePageNumberForChunk(p,e){var l,c,d,u,_;if(!p||!e)return null;let n=this.deps.normalizeChunkIdForNote(e,p)||e,t=this.chunkPageCache.get(p);if(t&&t.has(n))return(l=t.get(n))!=null?l:null;let i=(0,ae.normalizePath)(`${W}/${p}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let y of s){let h=typeof(y==null?void 0:y.chunk_id)=="string"?y.chunk_id.trim():"";if(!h)continue;let v=Number.isFinite((c=y==null?void 0:y.page_start)!=null?c:NaN)?Number(y.page_start):null,P=Number.isFinite((d=y==null?void 0:y.page_end)!=null?d:NaN)?Number(y.page_end):null,f=v!=null?v:P;f!==null&&(o.set(h,f),o.set(`${p}:${h}`,f))}return this.chunkPageCache.set(p,o),(_=(u=o.get(n))!=null?u:o.get(e))!=null?_:null}};var Oe={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,n=1200){let t=this.noteSyncTimers.get(e.path);t!==void 0&&window.clearTimeout(t);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},n);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,n=1200,t="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,t)},n);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,n=1200,t="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,t)},n);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let n=this.annotationNoteEditTimes.get(e);if(!n)return 0;let t=Date.now()-n;return t>=Gn?0:Gn-t}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=(e.annotation_page_label||"").trim();if(n)return n;let t=e.page_start?String(e.page_start):"",i=e.page_end?String(e.page_end):"";if(t&&(!i||t===i))return t;if(t&&i)return`${t} - ${i}`;let r=(e.pages||"").trim();if(!r)return"?";let a=r.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:r.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,m.normalizePath)(`${W}/${s}.json`),c=this.app.vault.adapter;if(!await c.exists(l))return;let d=await this.readChunkPayload(l);if(!d)return;let u=Array.isArray(d.chunks)?d.chunks:[],_=new Map;for(let b of u){if(this.isAnnotationChunk(b))continue;let S=typeof(b==null?void 0:b.chunk_id)=="string"?b.chunk_id:String((n=b==null?void 0:b.chunk_id)!=null?n:"");S&&_.set(S,b)}let y=new Set,h=new Set,v=new Set,P=new Set,f=!1;for(let b of o){let S=b.chunkId;if(!S)continue;y.add(S);let R=_.get(S);if(!R){console.warn(`Sync note: chunk id not found in cache (${S})`);continue}if(b.excludeFlag){R.excluded!==!0&&(R.excluded=!0,f=!0);let N=this.normalizeChunkText(b.text);N&&N!==String((t=R.text)!=null?t:"")&&(R.text=N,R.char_count=N.length,f=!0),v.add(S);continue}if(R.excluded&&(R.excluded=!1,f=!0,h.add(S)),!b.text.trim()){v.add(S),P.add(S);continue}let A=this.normalizeChunkText(b.text);if(!A){v.add(S),P.add(S);continue}let C=typeof R.text=="string"?R.text:String((i=R.text)!=null?i:"");A!==C&&(R.text=A,R.char_count=A.length,h.add(S),f=!0)}for(let b of _.keys())y.has(b)||(v.add(b),P.add(b));let x=new Set([...v,...P]);if(x.size){let b=Array.from(x).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==b){this.noteSyncPendingDeletes.set(e.path,b),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!h.size&&!v.size&&!P.size&&!f)return;P.size&&(d.chunks=u.filter(b=>{var R;let S=typeof(b==null?void 0:b.chunk_id)=="string"?b.chunk_id:String((R=b==null?void 0:b.chunk_id)!=null?R:"");return S&&!P.has(S)}),f=!0),(f||P.size)&&await c.write(l,JSON.stringify(d,null,2)),await this.reindexChunkUpdates(s,l,Array.from(h),Array.from(v)),(v.size||P.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,n){var t,i,r;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,n);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),s=await this.resolveDocIdForNote(e,a);if(!s)return;let o=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter;if(!o)return;let l=this.resolveZoteroItemKey(o,s);if(!l)return;let c=await this.fetchZoteroItem(l),d=(i=c==null?void 0:c.data)!=null?i:c;if(!d||typeof d!="object")return;let u=this.extractNoteMetadata(o),_=this.extractZoteroMetadata(d),y=await this.getMetadataSnapshot(s,o,e),h={},v={},P={},f=[],x=["title","short_title","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],b={title:"title",short_title:"short_title",date:"date",abstract:"abstract",doi:"doi",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},S=x.filter(A=>this.hasFrontmatterKey(o,b[A]));if(!S.length)return;let R={title:"Title",short_title:"Short title",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let A of S){let C=u[A],N=_[A];if(this.metadataValuesEqual(A,C,N))continue;let F=y==null?void 0:y[A];if(F!==void 0){let z=!this.metadataValuesEqual(A,C,F),D=!this.metadataValuesEqual(A,N,F);if(z&&!D){P[A]="note",this.assignMetadataUpdate(v,A,C);continue}if(!z&&D){P[A]="zotero",this.assignMetadataUpdate(h,A,N);continue}}let T=this.getMetadataDecisionLabels(A,C,N,R);f.push({field:A,fieldLabel:R[A],noteLabel:T.noteLabel,zoteroLabel:T.zoteroLabel,noteValue:this.formatMetadataValue(C),zoteroValue:this.formatMetadataValue(N)})}if(f.length>0){let A=await this.promptMetadataBatchDecision(f);for(let C of f){let N=(r=A[C.field])!=null?r:"skip";P[C.field]=N,N==="note"?this.assignMetadataUpdate(v,C.field,u[C.field]):N==="zotero"&&this.assignMetadataUpdate(h,C.field,_[C.field])}}Object.keys(h).length>0&&await this.applyNoteMetadataUpdates(e,h),Object.keys(v).length>0&&await this.applyZoteroMetadataUpdates(l,d,u,_,v),await this.updateMetadataSnapshot(e,s,u,_,y,P,S)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,n)}}async syncNoteAnnotationsWithZotero(e,n){var t,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,n);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let D=this.ensureDocIdInNoteContent(o,d);D!==o&&await this.writeNoteWithSyncSuppressed(e.path,D)}if(!d)return;let u=(i=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter)!=null?i:{},_=(r=c.attachmentKey)!=null?r:"";if(_||(_=await this.resolveAttachmentKeyForDocId(d,u)),!_)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===_&&await this.updateDocIndex({doc_id:d,attachment_key:_});let y=_,h=await this.fetchZoteroAnnotationsForDoc(d,_),v=h.annotations;_=h.attachmentKey,_&&_!==y&&await this.updateDocIndex({doc_id:d,attachment_key:_});let P=this.parseAnnotationBlock(l.block,_),f=new Map;for(let D of P)D.key&&f.set(D.key,D);let x=new Map;for(let D of v)x.set(D.key,D);let b=await this.getAnnotationSnapshot(d),S=(a=b==null?void 0:b.annotations)!=null?a:{},R={},A=[],C=!1,N=!1,F=!1;_&&_!==y&&v.length>0&&(N=!0,F=!0);for(let[D,M]of x.entries()){let j=f.get(D);if(!j){N=!0;continue}let I=S[D],q=this.annotationSnapshotFromEntry(j,M.annotationType),$=this.annotationSnapshotFromEntry(M,M.annotationType);if(!I){this.annotationSnapshotsEqual(q,$)||(R[D]="note",C=!0);continue}let G=!this.annotationSnapshotsEqual(q,I),J=!this.annotationSnapshotsEqual($,I);if(G&&!J){R[D]="note",C=!0;continue}if(!G&&J){R[D]="zotero",N=!0;continue}G&&J&&A.push({key:D,title:this.formatAnnotationConflictTitle(M),noteValue:this.formatAnnotationConflictValue(q,j.tags),zoteroValue:this.formatAnnotationConflictValue($,M.tags)})}if(A.length>0){let D=await this.promptAnnotationBatchDecision(A);for(let M of A){let j=(s=D[M.key])!=null?s:"skip";R[M.key]=j,j==="note"?C=!0:j==="zotero"&&(N=!0,F=!0)}}let T=[];for(let[D,M]of Object.entries(R)){if(M!=="note")continue;let j=f.get(D),I=x.get(D);!j||!I||T.push({entry:I,note:j})}T.length>0&&await this.applyZoteroAnnotationUpdates(T),C&&this.annotationNoteEditTimes.set(e.path,Date.now());let z=this.getAnnotationGraceRemaining(e.path);if(N&&z>0&&C&&!F&&(this.scheduleNoteAnnotationSync(e,z+250,n),N=!1),N){let D=this.buildAnnotationBlock(d,_,v),M=this.replaceAnnotationBlock(o,D);if(M&&M!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,M)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,_,v),await this.updateAnnotationChunks(d,_,v)}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,n)}}resolveZoteroItemKey(e,n){let t=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),n];for(let i of t){let r=V(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,n){var l;if(!e)return"";let t=await this.getDocIndexEntry(e);if(t||(t=await this.hydrateDocIndexFromCache(e)),t!=null&&t.attachment_key)return t.attachment_key;let i=(0,m.normalizePath)(`${W}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let d=await this.readChunkPayload(i),u=d!=null&&d.metadata&&typeof d.metadata=="object"?d.metadata:null,_=u==null?void 0:u.attachment_key;if(typeof _=="string"&&_.trim())return await this.updateDocIndex({doc_id:e,attachment_key:_.trim()}),_.trim()}}catch(c){}let r=this.resolveZoteroItemKey(n,e);if(!r)return"";let a=await this.fetchZoteroItem(r),s=(l=a==null?void 0:a.data)!=null?l:a;if(!s||typeof s!="object")return"";let o=await ve(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var v,P,f,x,b,S,R,A,C;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString((x=(f=(P=(v=e==null?void 0:e["short title"])!=null?v:e==null?void 0:e.short_title)!=null?P:e==null?void 0:e.shortTitle)!=null?f:e==null?void 0:e["short-title"])!=null?x:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString((b=e==null?void 0:e.abstract)!=null?b:e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((S=e==null?void 0:e.doi)!=null?S:e==null?void 0:e.DOI),s=this.normalizeMetadataString(e==null?void 0:e.publisher),o=this.normalizeMetadataString(e==null?void 0:e.place),l=this.normalizeMetadataString(e==null?void 0:e.issue),c=this.normalizeMetadataString(e==null?void 0:e.volume),d=this.normalizeMetadataString(e==null?void 0:e.pages),u=this.normalizeMetadataString((C=(A=(R=e==null?void 0:e["item type"])!=null?R:e==null?void 0:e.item_type)!=null?A:e==null?void 0:e.itemType)!=null?C:e==null?void 0:e["item-type"]),_=this.normalizeMetadataList(e==null?void 0:e.tags),y=this.normalizeMetadataList(e==null?void 0:e.authors),h=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:n,short_title:t,date:i,abstract:r,doi:a,publisher:s,place:o,issue:l,volume:c,pages:d,item_type:u,tags:this.sanitizeObsidianTags(_),authors:y,editors:h}}extractZoteroMetadata(e){var P,f,x;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString(me(e)),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString(e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((P=e==null?void 0:e.DOI)!=null?P:e==null?void 0:e.doi),s=this.normalizeMetadataString(e==null?void 0:e.publisher),o=this.normalizeMetadataString(e==null?void 0:e.place),l=this.normalizeMetadataString(e==null?void 0:e.issue),c=this.normalizeMetadataString(e==null?void 0:e.volume),d=this.normalizeMetadataString(e==null?void 0:e.pages),u=this.normalizeMetadataString((x=(f=e==null?void 0:e.itemType)!=null?f:e==null?void 0:e.item_type)!=null?x:e==null?void 0:e["item-type"]),_=Array.isArray(e==null?void 0:e.creators)?e.creators:[],y=_.filter(b=>(b==null?void 0:b.creatorType)==="author").map(b=>he(b)).filter(Boolean),h=_.filter(b=>(b==null?void 0:b.creatorType)==="editor"||(b==null?void 0:b.creatorType)==="seriesEditor").map(b=>he(b)).filter(Boolean),v=Array.isArray(e==null?void 0:e.tags)?e.tags.map(b=>typeof b=="string"?b:b==null?void 0:b.tag).filter(b=>typeof b=="string"):[];return{title:n,short_title:t,date:i,abstract:r,doi:a,publisher:s,place:o,issue:l,volume:c,pages:d,item_type:u,tags:this.sanitizeObsidianTags(v),authors:this.normalizeMetadataList(y),editors:this.normalizeMetadataList(h)}}extractAnnotationPageInfo(e){var a;let t=V((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:t,pageIndex:i}}parseZoteroAnnotationItem(e,n){var P,f,x,b;let t=(f=(P=e==null?void 0:e.data)!=null?P:e)!=null?f:{},i=V((x=e==null?void 0:e.key)!=null?x:t==null?void 0:t.key);if(!i)return null;let r=V(t.annotationType),a=this.normalizeAnnotationText(t.annotationText),s=this.normalizeAnnotationText(t.annotationComment),o=V(t.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:u,pageIndex:_}=this.extractAnnotationPageInfo(t),y=(b=t.annotationSortIndex)!=null?b:t.annotationSort,h=Number.isFinite(Number(y))?Number(y):0,v=Array.isArray(t.tags)?t.tags.map(S=>typeof S=="string"?S:S==null?void 0:S.tag).filter(S=>typeof S=="string"):[];return{key:i.trim(),attachmentKey:n,pageLabel:u,pageIndex:_,colorKey:l,callout:d,heading:c,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(v),sortIndex:h,rawValues:t}}async fetchZoteroAnnotations(e){if(!e)return[];let n=this.canUseWebApi()||await this.ensureWebApiLibraryId(),t=a=>{var o,l;let s=[];for(let c of a){let d=(l=(o=c==null?void 0:c.data)!=null?o:c)!=null?l:{};if(V(d.itemType)!=="annotation")continue;let u=this.parseZoteroAnnotationItem(c,e);u&&s.push(u)}return s},i=[];try{i=await this.fetchZoteroChildrenLocal(e)}catch(a){console.warn("Failed to fetch Zotero annotation items from local API",a)}let r=t(i);if(!r.length&&n)try{let a=await this.fetchZoteroChildrenWeb(e),s=t(a);s.length&&(r=s)}catch(a){console.warn("Failed to fetch Zotero annotation items from Web API",a)}return r}async fetchZoteroAnnotationsForDoc(e,n){var o,l,c;let t=n,i=await this.fetchZoteroAnnotations(t);if(i.length||!e)return i.length||this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i};let r=[];try{r=await this.fetchZoteroChildren(e)}catch(d){return console.warn("Failed to fetch Zotero attachments for annotations",d),this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}let a=[],s=new Set(t?[t]:[]);for(let d of r){if(!an(d))continue;let u=V((c=(l=d==null?void 0:d.key)!=null?l:(o=d==null?void 0:d.data)==null?void 0:o.key)!=null?c:d==null?void 0:d.attachmentKey);!u||s.has(u)||(s.add(u),a.push(u))}for(let d of a){let u=await this.fetchZoteroAnnotations(d);if(u.length)return{attachmentKey:d,annotations:u}}return this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}maybeWarnMissingAnnotationApi(e,n){if(this.canUseWebApi()){console.info("No Zotero annotations returned for attachment",{docId:e,attachmentKey:n});return}let t=e||n;!t||this.annotationWebApiWarned.has(t)||(this.annotationWebApiWarned.add(t),new m.Notice("Zotero annotations require Web API access. Configure the Web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
${t}
<!-- zrr:sync-end -->`;let r=i.some(o=>{if(typeof(o==null?void 0:o.section)=="string"?o.section.trim():"")return!0;let c=typeof(o==null?void 0:o.chunk_id)=="string"?o.chunk_id.trim():"";return!!(c&&!/^p\d+$/i.test(c))}),a=[`<!-- zrr:sync-start doc_id=${e} -->`];for(let o of i){let l=typeof(o==null?void 0:o.chunk_id)=="string"?o.chunk_id.trim():"";if(!l)continue;let c=Number.isFinite((s=o==null?void 0:o.page_start)!=null?s:NaN)?Number(o.page_start):null,d=!!(o!=null&&o.excluded||o!=null&&o.exclude),_=typeof(o==null?void 0:o.text)=="string"?o.text.trim():"";if(r){let P=typeof(o==null?void 0:o.section)=="string"?o.section.trim():"",f=P?`## ${P}`:"";f&&!_.startsWith("#")&&(_=_?`${f}

${_}`:f)}let y=c!==null?r?` (${c})`:` page=${c}`:"",v=` id=${l}${r?" section":""}${y}${d?" exclude":""}`;a.push(`<!-- zrr:chunk${v} -->`),_&&a.push(_),a.push("<!-- zrr:chunk end -->"),a.push("")}return a[a.length-1]===""&&a.pop(),a.push("<!-- zrr:sync-end -->"),a.join(`
...
`);for(let a=0;a<r.length;a+=1)if(i.test(r[a]))return a;return null}async openNoteAtChunk(e,n){if(!e||!n)return!1;await this.openNoteInMain(e);let i=this.getMainLeaf().view;if(!(i instanceof m.MarkdownView))return!1;let r=i.editor,a=this.normalizeChunkIdForNote(n)||n,s=this.findChunkLineInText(r.getValue(),a);return s===null?(new m.Notice(`Chunk ${a} not found in note.`),!1):(r.setCursor({line:s,ch:0}),r.scrollIntoView({from:{line:s,ch:0},to:{line:s,ch:0}},!0),!0)}async openNoteAtAnnotation(e,n,t,i){let r=this.buildAnnotationBlockId(n,t,i);if(!e||!r)return!1;await this.openNoteInMain(e);let s=this.getMainLeaf().view;if(!(s instanceof m.MarkdownView))return!1;let o=s.editor,l=this.findAnnotationLineInText(o.getValue(),r);return l===null?(new m.Notice(`Annotation ${n} not found in note.`),!1):(o.setCursor({line:l,ch:0}),o.scrollIntoView({from:{line:l,ch:0},to:{line:l,ch:0}},!0),!0)}async openInternalLinkInMain(e){let n=this.getMainLeaf(),[t,i]=e.split("#"),r=(t||"").trim(),a=(i||"").trim(),s="zrr-chunk:",o=r?this.app.metadataCache.getFirstLinkpathDest(r,""):null;if(o instanceof m.TFile){let l=a.startsWith(s)?a.slice(s.length).trim():"";if(l&&await this.openNoteAtChunk(o.path,l))return;await n.openFile(o,{active:!0}),e.includes("#")&&!l&&(this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1));return}this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1)}async openNoteInNewTab(e){let n=(0,m.normalizePath)(e);await this.app.workspace.openLinkText(n,"","tab")}async openPdfInMain(e,n){if(!e)return!1;if(!L.default.isAbsolute(e)&&!/^[A-Za-z]+:\/\//.test(e)){let a=(0,m.normalizePath)(e),s=n?`#page=${n}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}let t=L.default.normalize(this.getVaultBasePath()),i=L.default.normalize(e),r=t.endsWith(L.default.sep)?t:`${t}${L.default.sep}`;if(i.startsWith(r)){let a=(0,m.normalizePath)(L.default.relative(t,i)),s=n?`#page=${n}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}try{return window.open((0,cn.pathToFileURL)(e).toString()),!0}catch(a){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,n,t,i){if(n){let r=new URLSearchParams;t&&r.set("page",t),i&&r.set("annotation",i);let a=r.toString()?`?${r.toString()}`:"";return`zotero://open-pdf/library/items/${n}${a}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let t=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(t))return t}formatCitationsMarkdown(e){return e.length?e.map(t=>this.formatCitationMarkdown(t)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e){var d,u,_,y,h;let n=e.doc_id||"?",t=this.formatCitationPageLabel(e),i=e.annotation_key||this.extractAnnotationKey(e.chunk_id),r=e.attachment_key||((u=(d=this.docIndex)==null?void 0:d[e.doc_id||""])==null?void 0:u.attachment_key),a=e.page_start?String(e.page_start):"",s=(y=(_=this.docIndex)==null?void 0:_[e.doc_id||""])!=null?y:null,o=this.resolveCitationTitle(s,(h=s==null?void 0:s.note_path)!=null?h:null,e.doc_id),l=this.formatCitationLabel(o,t),c=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&(s!=null&&s.note_path)){if(i){let v=a||(e.page_end?String(e.page_end):"0"),P=this.buildNoteAnnotationLink(s.note_path,i,r||"",v,l);return P?`- ${P}`:`- ${this.buildNoteLink(s.note_path,l)}`}if(c&&!i)return`- ${this.buildNoteChunkLink(s.note_path,c,l)}`}if(r){let v=this.buildZoteroDeepLink(n,r,a,i);return`- [${l}](${v})`}return`- ${l}`}buildNoteChunkLink(e,n,t){let i=(0,m.normalizePath)(e).replace(/\.md$/i,""),r=`zrr-chunk:${n}`,a=this.escapeWikiLabel(t);return`[[${i}#${r}\\|${a}]]`}buildNoteLink(e,n){let t=(0,m.normalizePath)(e).replace(/\.md$/i,""),i=this.escapeWikiLabel(n);return`[[${t}\\|${i}]]`}buildNoteAnnotationLink(e,n,t,i,r){let a=this.buildAnnotationBlockId(n,t,i);if(!a)return null;let s=(0,m.normalizePath)(e).replace(/\.md$/i,""),o=this.escapeWikiLabel(r);return`[[${s}#^${a}\\|${o}]]`}buildAnnotationBlockId(e,n,t){let i=(e||"").trim().toUpperCase(),r=(n||"").trim().toUpperCase();if(!i||!r)return null;let a=(t||"").trim()||"0";return`${i}a${r}p${a}`}escapeWikiLabel(e){return e?e.replace(/\|/g,"\\|"):""}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,m.normalizePath)(`${Q}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var t;let e=this.app.vault.adapter,n=this.getDocIndexPath();if(!await e.exists(n))return{};try{let i=await e.read(n),r=JSON.parse(i);if(r&&typeof r=="object"){let a=(t=r.entries)!=null?t:r;if(Array.isArray(a)){let s={};for(let l of a)l!=null&&l.doc_id&&(s[String(l.doc_id)]=l);let o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(s),s}if(a&&typeof a=="object"){let s=a,o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(s),s}}}catch(i){console.error("Failed to read doc index",i)}return{}}async saveDocIndex(e){await this.ensureFolder(Q);let n=this.app.vault.adapter,t=this.getDocIndexPath(),i={version:1,entries:e};await n.write(t,JSON.stringify(i,null,2)),this.docIndex=e}async pruneDocIndexOrphans(){var c;let e=this.app.vault.adapter,n=await this.getDocIndex(),t=new Set(await this.listDocIds(ne)),i=new Set(await this.listDocIds(W)),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),a=0,s=0,o=!1,l=new Date().toISOString();for(let d of Object.keys(n)){let u=n[d],_=!1,y=u!=null&&u.note_path?u.note_path.trim():"";if(y&&await e.exists(y))_=!0;else if((c=r[d])!=null&&c.note_path){_=!0;let v=r[d];v.note_path&&v.note_path!==u.note_path&&(u.note_path=v.note_path,s+=1,o=!0),v.note_title&&v.note_title!==u.note_title&&(u.note_title=v.note_title,s+=1,o=!0),s>0&&(u.updated_at=l)}let h=t.has(d)||i.has(d);!_&&!h&&(delete n[d],a+=1,o=!0)}return o&&await this.saveDocIndex(n),{removed:a,updated:s}}async updateDocIndex(e){var r;let n=await this.getDocIndex(),t=(r=n[e.doc_id])!=null?r:{doc_id:e.doc_id},i={...t,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&t.note_path&&(i.note_path=t.note_path),e.note_title===void 0&&t.note_title&&(i.note_title=t.note_title),e.zotero_title===void 0&&t.zotero_title&&(i.zotero_title=t.zotero_title),e.short_title===void 0&&t.short_title&&(i.short_title=t.short_title),e.pdf_path===void 0&&t.pdf_path&&(i.pdf_path=t.pdf_path),e.attachment_key===void 0&&t.attachment_key&&(i.attachment_key=t.attachment_key),typeof i.pdf_path=="string"&&(i.pdf_path=this.normalizeDocIndexPdfPath(i.pdf_path)),n[e.doc_id]=i,await this.saveDocIndex(n)}async removeDocIndexEntry(e){let n=await this.getDocIndex();if(!n[e]){await this.removeMetadataSnapshot(e);return}delete n[e],await this.saveDocIndex(n),await this.removeMetadataSnapshot(e)}async hydrateDocIndexFromCache(e){var s,o;if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e),i={},r=(0,m.normalizePath)(`${ne}/${e}.json`);if(await n.exists(r))try{let l=await n.read(r),c=JSON.parse(l),d=(o=(s=c==null?void 0:c.data)!=null?s:c)!=null?o:{},u=typeof d.title=="string"?d.title:"";u&&(i.zotero_title=u);let _=me(d);if(_&&(i.short_title=_),!i.note_title||!i.note_path){let y=this.sanitizeFileName(u)||e,h=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${y}.md`),v=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${y}-${e}.md`),P="";await n.exists(h)?P=h:await n.exists(v)&&(P=v),P&&(i.note_path=P,i.note_title=L.default.basename(P,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!i.note_title&&(t!=null&&t.note_path)&&(i.note_title=L.default.basename(t.note_path,".md"));let a=(0,m.normalizePath)(`${W}/${e}.json`);if(await n.exists(a))try{let l=await n.read(a),c=JSON.parse(l);typeof(c==null?void 0:c.source_pdf)=="string"&&(i.pdf_path=c.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(i).length>0&&await this.updateDocIndex({doc_id:e,...i}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var t;return e&&(t=(await this.getDocIndex())[e])!=null?t:null}async inferNotePathFromCache(e){var i,r;let n=this.app.vault.adapter,t=(0,m.normalizePath)(`${ne}/${e}.json`);if(!await n.exists(t))return"";try{let a=await n.read(t),s=JSON.parse(a),o=(r=(i=s==null?void 0:s.data)!=null?i:s)!=null?r:{},l=typeof o.title=="string"?o.title:"",c=this.sanitizeFileName(l)||e,d=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${c}.md`),u=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${c}-${e}.md`);if(await n.exists(d))return d;if(await n.exists(u))return u}catch(a){console.error("Failed to infer note path from cache",a)}return""}async rebuildNoteFromCacheForDocId(e,n){var T,z,D,M,j;try{await this.ensureBundledTools()}catch(I){return n&&new m.Notice("Failed to sync bundled tools. See console for details."),console.error(I),!1}let t=this.app.vault.adapter,i=(0,m.normalizePath)(`${ne}/${e}.json`),r=(0,m.normalizePath)(`${W}/${e}.json`);if(!await t.exists(i)||!await t.exists(r))return n&&new m.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let a;try{let I=await t.read(i);a=JSON.parse(I)}catch(I){return n&&new m.Notice("Failed to read cached item JSON."),console.error(I),this.clearStatusProgress(),!1}let s;try{let I=await t.read(r);s=JSON.parse(I)}catch(I){return n&&new m.Notice("Failed to read cached chunks JSON."),console.error(I),this.clearStatusProgress(),!1}let o=(T=a.data)!=null?T:a,l=typeof o.title=="string"?o.title:"",c=((D=(z=a.key)!=null?z:o.key)!=null?D:e).toString(),d=await this.getDocIndexEntry(e),u=typeof((M=s==null?void 0:s.metadata)==null?void 0:M.attachment_key)=="string"?s.metadata.attachment_key:d==null?void 0:d.attachment_key,_=typeof s.source_pdf=="string"?s.source_pdf:"";if(!_||!await this.isFileAccessible(_)){let I=await this.recoverMissingPdfFromAttachment(_,o,c,e,u,l,n);if(!I)return n&&new m.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;_=I.sourcePdf,I.attachmentKey&&(u=I.attachmentKey),await this.updateChunkJsonSourcePdf(r,_)}let y=await this.resolveLanguageHint(o,c),h=this.buildDoclingLanguageHint(y!=null?y:void 0),v="";if(d!=null&&d.note_path&&await t.exists(d.note_path)&&(v=(0,m.normalizePath)(d.note_path)),!v){let I=this.sanitizeFileName(l)||e,q=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${I}.md`),$=await t.exists(q)?I:await this.resolveUniqueBaseName(I,e);v=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${$}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let I=this.getLogFileRelativePath(),q=(0,m.normalizePath)(L.default.dirname(I));q&&await this.ensureFolder(q);let $=this.getSpellcheckerInfoRelativePath(),G=(0,m.normalizePath)(L.default.dirname($));G&&await this.ensureFolder(G)}}catch(I){return n&&new m.Notice("Failed to create notes folder."),console.error(I),this.clearStatusProgress(),!1}let P=this.getPluginDir(),f=L.default.join(P,"tools","docling_extract.py"),x=L.default.join(P,"tools","index_redisearch.py"),b=null,S=null,R=I=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=I)};try{b=await this.readDoclingQualityLabelFromPdf(_,h),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",b),0);let I=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(f,await this.buildDoclingArgs(_,e,r,v,h,!0),G=>this.handleDoclingProgress(G,b),()=>{},I,"docling_extract",R),this.recreateMissingNotesProcess=null,b=await this.readDoclingQualityLabel(r),u&&await this.annotateChunkJsonWithAttachmentKey(r,u);let q=await this.readDoclingMetadata(r),$=await this.maybeCreateOcrLayeredPdf(_,q,h);$&&(_=$,S=$,await this.updateChunkJsonSourcePdf(r,$))}catch(I){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(n&&new m.Notice("Docling extraction failed. See console for details."),console.error(I),this.clearStatusProgress(),!1)}let A=!1,C=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;if(!await this.ensureRedisAvailable("rebuild"))A=!0,n&&new m.Notice("Redis is unavailable; skipping indexing for this note.");else try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",b),0);let I=["--chunks-json",this.getAbsoluteVaultPath(r),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(I),this.appendEmbedContextArgs(I),this.settings.embedIncludeMetadata&&I.push("--embed-include-metadata"),this.appendChunkTaggingArgs(I,{allowRegenerate:!1}),await this.runPythonStreaming(x,I,q=>{if((q==null?void 0:q.type)==="progress"&&q.total){let $=Math.round(q.current/q.total*100),G=typeof q.message=="string"&&q.message.trim()?q.message:`Indexing chunks ${q.current}/${q.total}`,J=this.formatStatusLabel(G,b);this.showStatusProgress(J,$)}},()=>{},C,"index_redisearch",R),this.recreateMissingNotesProcess=null}catch(I){if(this.recreateMissingNotesAbort)return this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1;n&&new m.Notice("RedisSearch indexing failed; note will still be rebuilt."),console.error(I),A=!0}let F=S?this.buildPdfLinkFromSourcePath(S):this.buildPdfLinkForNote(_,d==null?void 0:d.attachment_key,e);try{let I=await this.app.vault.adapter.read(v),q=await this.readChunkPayload(r),$=this.buildSyncedDoclingContent(e,q,I),G=await this.buildNoteMarkdown(o,(j=a.meta)!=null?j:{},e,F,u,i,$);await this.writeNoteWithSyncSuppressed(v,G);let J=this.app.vault.getAbstractFileByPath(v);J instanceof m.TFile&&this.scheduleNoteAnnotationSync(J,2e3,"save")}catch(I){return n&&new m.Notice("Failed to finalize note markdown."),console.error(I),this.clearStatusProgress(),!1}try{let I=me(o);await this.updateDocIndex({doc_id:e,note_path:v,note_title:L.default.basename(v,".md"),zotero_title:l,short_title:I||void 0,pdf_path:_})}catch(I){console.error("Failed to update doc index",I)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],n=await this.fetchZoteroGroupOptions();return n.length&&e.push(...n),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),n=[],t=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!t)return e&&n.push({value:e,label:e}),n;let i=(this.settings.embedApiKey||"").trim(),r=await this.fetchModelIds(t,i);if(r.length){let a=r.filter(o=>/embed/i.test(o)),s=a.length?a:r;n.push(...s.map(o=>({value:o,label:o})))}return!n.length&&e&&n.push({value:e,label:e}),n.sort((a,s)=>a.label.localeCompare(s.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,n,t){let i=t==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),r=[],a=(e||"").trim().replace(/\/$/,"");if(!a)return i&&r.push({value:i,label:i}),r;let s=(n||"").trim(),o=await this.fetchModelIds(a,s);if(o.length){let l=o.filter(d=>!/embed/i.test(d)),c=l.length?l:o;r.push(...c.map(d=>({value:d,label:d})))}return!r.length&&i&&r.push({value:i,label:i}),r.sort((l,c)=>l.label.localeCompare(c.label))}detectEmbeddingProvider(e){let n=e.toLowerCase();return n.includes("anthropic")?"anthropic":n.includes("openrouter")?"openrouter":n.includes("ollama")||n.includes(":11434")?"ollama":n.includes("openai")?"openai":"generic"}async fetchModelIds(e,n){let t=this.detectEmbeddingProvider(e);try{if(t==="anthropic")return await this.fetchAnthropicModels(e,n);let i=await this.fetchOpenAiCompatibleModels(e,n);return!i.length&&t==="ollama"?await this.fetchOllamaModels(e):i}catch(i){return console.warn("Failed to fetch models",i),[]}}async fetchOpenAiCompatibleModels(e,n){let t=`${e}/models`,i={};n&&(i.Authorization=`Bearer ${n}`);let r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}async fetchOllamaModels(e){let t=`${e.replace(/\/v1\/?$/,"")}/api/tags`,i=await this.requestLocalApiRaw(t);if(i.statusCode>=400)throw new Error(`Ollama tags request failed (${i.statusCode})`);let r;try{r=JSON.parse(i.body.toString("utf8"))}catch(s){return console.warn("Failed to parse Ollama tags response",s),[]}if(!r||typeof r!="object")return[];let a=r.models;return Array.isArray(a)?a.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}async fetchAnthropicModels(e,n){if(!n)return[];let t=`${e}/models`,i={"x-api-key":n,"anthropic-version":"2023-06-01"},r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Anthropic model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}extractModelIds(e){var i,r,a;if(Array.isArray(e))return e.map(s=>this.extractModelId(s)).filter(s=>!!s);if(!e||typeof e!="object")return[];let n=e,t=(a=(r=(i=n.data)!=null?i:n.models)!=null?r:n.model)!=null?a:n.items;return Array.isArray(t)?t.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}extractModelId(e){var r,a,s;if(!e||typeof e!="object")return null;let n=e,t=(s=(a=(r=n.id)!=null?r:n.name)!=null?a:n.model)!=null?s:n.identifier;return typeof t!="string"?null:t.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,n=i=>{for(let r of i)e.has(r.value)||e.set(r.value,r.label)};if(await this.warnIfZoteroLocalApiUnavailable("Zotero groups"))try{let i=this.buildZoteroUrl("/users/0/groups"),r=await this.requestLocalApi(i,`Zotero groups fetch failed for ${i}`);n(this.parseZoteroGroupOptions(r))}catch(i){console.warn("Failed to fetch Zotero groups from local API",i)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let i=(this.settings.webApiLibraryId||"").trim();if(i)try{let r=this.buildWebApiUrl(`/users/${i}/groups`),a=await this.requestWebApi(r,`Zotero Web API groups fetch failed for ${r}`);n(this.parseZoteroGroupOptions(a))}catch(r){console.warn("Failed to fetch Zotero groups from Web API",r)}}return Array.from(e.entries()).map(([i,r])=>({value:i,label:r})).sort((i,r)=>i.label.localeCompare(r.label))}parseZoteroGroupOptions(e){var i,r,a,s,o;let n;try{n=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(n))return[];let t=[];for(let l of n){if(!l||typeof l!="object")continue;let c=(i=l.data)!=null?i:l,d=(a=(r=c.id)!=null?r:l.id)!=null?a:c.key;if(!d)continue;let u=String(d).trim();if(!u)continue;let _=(o=(s=c.name)!=null?s:l.name)!=null?o:u,y=String(_||u).trim()||u;t.push({value:`groups/${u}`,label:`Group: ${y}`})}return t}async ensureFolder(e){let n=this.app.vault.adapter,t=(0,m.normalizePath)(e).split("/").filter(Boolean),i="";for(let r of t)i=i?`${i}/${r}`:r,await n.exists(i)||await n.mkdir(i)}async buildNoteMarkdown(e,n,t,i,r,a,s){let o=`[[${a}]]`,l=this.settings.copyPdfToVault&&i.startsWith("[["),c=r?this.buildZoteroDeepLink(t,r):"",d=c||i,u=l?i:c||i,_=u?l?`PDF: !${u}`:`PDF: ${u}`:"",y=_?`${_}

`:"",h=await this.buildTemplateVars(e,n,t,d,o);h.pdf_block=y,h.pdf_line=_,h.docling_markdown=s;let v=(this.settings.noteBodyTemplate||"").trim();/{{\s*annotation_block\s*}}/i.test(v)&&r?h.annotation_block=await this.buildAnnotationBlockForAttachment(t,r):h.annotation_block="";let f=this.ensureDocIdInFrontmatter(await this.renderFrontmatter(e,n,t,d,o,h),t),x=f?`---
${f}
---

`:"",b=`${y}${s}`,S=v?this.renderTemplate(v,h,b,{appendDocling:!0}):b;return`${x}${S}`}async buildAnnotationBlockForAttachment(e,n){let t=await this.fetchZoteroAnnotationsForDoc(e,n);return t.attachmentKey&&t.attachmentKey!==n&&await this.updateDocIndex({doc_id:e,attachment_key:t.attachmentKey}),this.buildAnnotationBlock(e,t.attachmentKey,t.annotations)}buildAnnotationBlock(e,n,t){var u;let i=`<!-- zrr:annotations-start doc_id=${e} attachment_key=${n} -->`,r="<!-- zrr:annotations-end -->";if(!t.length)return`${i}
${r}`;let a=this.getAnnotationColorMap(),s=Object.keys(a),o=new Map;for(let _ of t){let y=_.colorKey||this.normalizeAnnotationColorKey(_.colorKey),h=(u=o.get(y))!=null?u:[];h.push(_),o.set(y,h)}let l=[i],c=new Set,d=[...s,...Array.from(o.keys()).filter(_=>!s.includes(_))];for(let _ of d){let y=o.get(_);if(!y||!y.length)continue;c.add(_);let{heading:h}=this.resolveAnnotationColorMeta(_);l.push("",`## ${h}`),y.sort((v,P)=>{var b,S;let f=(b=v.pageIndex)!=null?b:0,x=(S=P.pageIndex)!=null?S:0;return f!==x?f-x:v.sortIndex!==P.sortIndex?v.sortIndex-P.sortIndex:v.key.localeCompare(P.key)});for(let v of y)l.push(...this.formatAnnotationCallout(v,n,e))}return l.push("",r),l.join(`
`).trim()}formatAnnotationCallout(e,n,t){let i=this.settings.annotationPageLabel||"Page",r=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?"),a=e.pageIndex?String(e.pageIndex):"",s=this.buildZoteroDeepLink(t,n,a,e.key),l=[`> [!${e.callout}] ${i} [${r}](${s})`],c=u=>{if(u)for(let _ of u.split(/\r?\n/))l.push(_.trim()?`> ${_}`:">")};c(e.text),e.comment&&(l.push(">","> ---"),c(e.comment)),e.tags.length&&l.push(`> **Tags:** ${e.tags.map(u=>`#${u}`).join(" ")}`);let d=e.pageIndex?String(e.pageIndex):"0";return l.push(`> ^${e.key}a${n}p${d}`),l.push(""),l}findAnnotationBlockRange(e){let n=ft.exec(e);if(!n)return null;let t=e.slice(n.index+n[0].length),i=ht.exec(t);if(!i)return null;let r=n.index,a=n.index+n[0].length+i.index+i[0].length,s=t.slice(0,i.index);return{start:r,end:a,block:s,startMarker:n[0]}}parseAnnotationBlockMarker(e){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i),t=e.match(/attachment_key=([\"']?)([^\"'\s]+)\1/i);return{docId:n?n[2].trim():void 0,attachmentKey:t?t[2].trim():void 0}}parseAnnotationBlock(e,n){let t=e.split(/\r?\n/),i=[],r=0;for(;r<t.length;){if(!t[r].trim().startsWith("> [!")){r+=1;continue}let s=[];for(;r<t.length&&t[r].trim().startsWith(">");)s.push(t[r]),r+=1;let o=this.parseAnnotationCallout(s,n);o&&i.push(o)}return i}parseAnnotationCallout(e,n){if(!e.length)return null;let t=e[0].replace(/^>\s?/,"").trim(),i=t.match(/\[!([^\]]+)\]/),r=i?i[1].trim():"note",a=t.match(/\((zotero:\/\/open-pdf\/library\/items\/[^)]+)\)/i),s="",o=n,l="",c=null;if(a){let P=a[1],f=P.match(/items\/([A-Z0-9]{8})/i);f&&(o=f[1]);let x=P.match(/annotation=([A-Z0-9]{8})/i);x&&(s=x[1]);let b=P.match(/page=(\d+)/i);b&&(c=Number(b[1]));let S=t.match(/\[([^\]]+)\]\(zotero:\/\//i);S&&(l=S[1].trim())}let d=[],u=[],_=[],y=!1;for(let P=1;P<e.length;P+=1){let f=e[P].replace(/^>\s?/,""),x=f.trim();if(!x){y?_.push(""):u.push("");continue}if(x.startsWith("^")){let b=x.match(/^\^([A-Z0-9]{8})a([A-Z0-9]{8})p(\d+)/i);b&&(s=b[1],o=b[2],c=Number(b[3]));continue}if(/^(\*\*tags:\*\*|tags:)/i.test(x)){d.push(x);continue}if(x==="---"){y=!0;continue}y?_.push(f):u.push(f)}let h=d.join(" "),v=h?h.replace(/\*\*tags:\*\*/i,"").replace(/tags:/i,"").split(/[\s,]+/).map(P=>P.trim().replace(/^#+/,"")).filter(Boolean):[];return s?{key:s,attachmentKey:o,pageLabel:l,pageIndex:c,callout:r,text:this.normalizeAnnotationText(u.join(`
...
`)}async renderFrontmatter(e,n,t,i,r,a){var d;let s=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,n,t,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let n=e.split(/\r?\n/),t=[],i=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<n.length;){let l=n[o],c=l.match(i);if(!c){t.push(l),o+=1;continue}let d=c[1].trim(),u=c[2].trim();if(a.has(d)){t.push(l),o+=1;continue}if(!s(u)){t.push(l),o+=1;continue}let _=o+1,y=[];for(;_<n.length&&n[_].match(r);)y.push(n[_]),_+=1;if(y.length===0){for(o=_;o<n.length&&n[o].trim()==="";)o+=1;continue}let h=y.filter(v=>{let P=v.match(r);if(!P)return!1;let f=P[1].trim();return!s(f)});if(h.length>0&&t.push(l,...h),o=_,h.length===0)for(;o<n.length&&n[o].trim()==="";)o+=1}for(;t.length>0&&t[t.length-1].trim()==="";)t.pop();return t.join(`

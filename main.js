"use strict";var He=Object.create;var de=Object.defineProperty;var We=Object.getOwnPropertyDescriptor;var Ke=Object.getOwnPropertyNames;var Je=Object.getPrototypeOf,Ye=Object.prototype.hasOwnProperty;var Qe=(b,p)=>{for(var e in p)de(b,e,{get:p[e],enumerable:!0})},Re=(b,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of Ke(p))!Ye.call(b,t)&&t!==e&&de(b,t,{get:()=>p[t],enumerable:!(n=We(p,t))||n.enumerable});return b};var pe=(b,p,e)=>(e=b!=null?He(Je(b)):{},Re(p||!b||!b.__esModule?de(e,"default",{value:b,enumerable:!0}):e,b)),Xe=b=>Re(de({},"__esModule",{value:!0}),b);var gn={};Qe(gn,{default:()=>fe});module.exports=Xe(gn);var g=require("obsidian"),ie=require("@codemirror/state"),j=require("@codemirror/view"),W=require("child_process"),G=require("fs"),$e=pe(require("http")),Be=pe(require("https")),ke=pe(require("net")),v=pe(require("path")),re=require("url"),ge=require("crypto");var L=require("obsidian"),H=".zotero-redisearch-rag",Y=`${H}/items`,Z=`${H}/chunks`,Oe={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}
...
`};var ze={"docling_extract.py":`#!/usr/bin/env python3

...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.16
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.16
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.16
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.16
...
`).trim()}getBundledReleaseNotesEntries(){var r,i;let e=new Set,t=Array.isArray(vt)?vt:[],n=[];for(let a of t){let s=this.normalizeReleaseVersion(String((r=a==null?void 0:a.version)!=null?r:"")),o=this.sanitizeReleaseNotesMarkdown(String((i=a==null?void 0:a.markdown)!=null?i:""));!s||e.has(s)||(e.add(s),n.push({version:s,markdown:o}))}return n.sort((a,s)=>this.compareReleaseVersions(s.version,a.version))}getReleaseNotesMarkdown(e,t){let n=this.normalizeReleaseVersion(e);if(!n)return"";let r=this.normalizeReleaseVersion(t||""),i=this.getBundledReleaseNotesEntries(),a=i.filter(o=>this.compareReleaseVersions(o.version,n)>0?!1:r?this.compareReleaseVersions(o.version,r)>0:o.version===n),s=a.length?a:i.filter(o=>o.version===n);if(!s.length)return"This version includes improvements and fixes.";if(s.length===1){let o=s[0],l=this.stripLeadingVersionHeading(this.sanitizeReleaseNotesMarkdown(String(o.markdown||"")),o.version);return`### v${o.version}

"use strict";var qe=Object.create;var oe=Object.defineProperty;var Me=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var $e=Object.getPrototypeOf,Be=Object.prototype.hasOwnProperty;var Ge=(S,u)=>{for(var e in u)oe(S,e,{get:u[e],enumerable:!0})},Le=(S,u,e,n)=>{if(u&&typeof u=="object"||typeof u=="function")for(let t of je(u))!Be.call(S,t)&&t!==e&&oe(S,t,{get:()=>u[t],enumerable:!(n=Me(u,t))||n.enumerable});return S};var le=(S,u,e)=>(e=S!=null?qe($e(S)):{},Le(u||!S||!S.__esModule?oe(e,"default",{value:S,enumerable:!0}):e,S)),Ue=S=>Le(oe({},"__esModule",{value:!0}),S);var tn={};Ge(tn,{default:()=>ge});module.exports=Ue(tn);var p=require("obsidian"),se=require("@codemirror/state"),$=require("@codemirror/view"),W=require("child_process"),j=require("fs"),ze=le(require("http")),Ie=le(require("https")),be=le(require("net")),k=le(require("path")),X=require("url"),de=require("crypto");var L=require("obsidian"),V=".zotero-redisearch-rag",J=`${V}/items`,U=`${V}/chunks`,Ae={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,noteBodyTemplate:"{{pdf_block}}{{docling_markdown}}",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],embedProviderProfileId:"lm-studio",chatProviderProfileId:"lm-studio",llmCleanupProviderProfileId:"lm-studio",tagSanitizeMode:"replace",tagSanitizeReplacement:"-",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",chatOutputDir:"Zotero/Chats",chatPaneLocation:"right",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!0,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,enableChunkTagging:!1,chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,ocrMode:"auto",chunkingMode:"page",maxChunkChars:4e3,chunkOverlapChars:250,ocrQualityThreshold:.5,enableLlmCleanup:!1,llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,enableFileLogging:!1,logFilePath:`${V}/logs/docling_extract.log`,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0},ce=class extends L.PluginSettingTab{constructor(u,e){super(u,e),this.plugin=e}display(){let{containerEl:u}=this;u.empty();let e=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async d=>{this.plugin.settings.llmProviderProfiles=d,await this.plugin.saveSettings()},t=d=>{d.inputEl.type="password",d.inputEl.autocomplete="off",d.inputEl.spellcheck=!1};u.createEl("h2",{text:"Prerequisites"}),new L.Setting(u).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env.").addText(d=>d.setPlaceholder("python3").setValue(this.plugin.settings.pythonPath).onChange(async g=>{this.plugin.settings.pythonPath=g.trim(),await this.plugin.saveSettings()})),new L.Setting(u).setName("Python environment").setDesc("Create or update the plugin's Python env (.venv in the plugin folder).").addButton(d=>{d.setButtonText("Create/Update").setCta(),d.onClick(async()=>{d.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{d.setDisabled(!1)}})}),new L.Setting(u).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack).").addText(d=>d.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async g=>{this.plugin.settings.dockerPath=g.trim()||"docker",await this.plugin.saveSettings()})),new L.Setting(u).setName("Redis URL").addText(d=>d.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async g=>{this.plugin.settings.redisUrl=g.trim(),await this.plugin.saveSettings()})),new L.Setting(u).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(d=>d.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async g=>{this.plugin.settings.autoAssignRedisPort=g,await this.plugin.saveSettings()})),new L.Setting(u).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker.").addToggle(d=>d.setValue(this.plugin.settings.autoStartRedis).onChange(async g=>{this.plugin.settings.autoStartRedis=g,await this.plugin.saveSettings()})),new L.Setting(u).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(d=>d.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()})),u.createEl("h2",{text:"Zotero Local API"}),new L.Setting(u).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(d=>d.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async g=>{this.plugin.settings.zoteroBaseUrl=g.trim(),await this.plugin.saveSettings()}));let i=new L.Setting(u).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),r=null,s=d=>{if(!r)return;let g=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(d.map(O=>O.value)).has(g)||(d=d.concat([{value:g,label:`Custom (${g})`}])),r.selectEl.options.length=0;for(let O of d)r.addOption(O.value,O.label);r.setValue(g)},a=async()=>{if(r){r.setDisabled(!0);try{let d=await this.plugin.fetchZoteroLibraryOptions();s(d)}finally{r.setDisabled(!1)}}};i.addDropdown(d=>{r=d;let g=(this.plugin.settings.zoteroUserId||"0").trim()||"0";d.addOption(g,"Loading..."),d.setValue(g),d.onChange(async x=>{this.plugin.settings.zoteroUserId=x.trim(),await this.plugin.saveSettings()})}),i.addButton(d=>{d.setButtonText("Refresh").onClick(async()=>{await a()})}),a(),u.createEl("h2",{text:"Zotero Web API"}),new L.Setting(u).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(d=>d.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async g=>{this.plugin.settings.webApiBaseUrl=g.trim(),await this.plugin.saveSettings()})),new L.Setting(u).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(d=>d.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async g=>{this.plugin.settings.webApiLibraryType=g,await this.plugin.saveSettings()})),new L.Setting(u).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(d=>d.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async g=>{this.plugin.settings.webApiLibraryId=g.trim(),await this.plugin.saveSettings()})),new L.Setting(u).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(d=>{t(d),d.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async g=>{this.plugin.settings.webApiKey=g.trim(),await this.plugin.saveSettings()})}),u.createEl("h2",{text:"Output"}),new L.Setting(u).setName("PDF folder").addText(d=>d.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async g=>{this.plugin.settings.outputPdfDir=g.trim(),await this.plugin.saveSettings()})),new L.Setting(u).setName("Notes folder").addText(d=>d.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async g=>{this.plugin.settings.outputNoteDir=g.trim(),await this.plugin.saveSettings()})),new L.Setting(u).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(d=>{d.setValue(this.plugin.settings.frontmatterTemplate).onChange(async g=>{this.plugin.settings.frontmatterTemplate=g,await this.plugin.saveSettings()}),d.inputEl.rows=10,d.inputEl.style.width="100%"}),new L.Setting(u).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces).").addDropdown(d=>d.addOption("none","No change").addOption("replace","Replace spaces").addOption("camel","camelCase").setValue(this.plugin.settings.tagSanitizeMode).onChange(async g=>{this.plugin.settings.tagSanitizeMode=g,await this.plugin.saveSettings()})).addText(d=>d.setPlaceholder("-").setValue(this.plugin.settings.tagSanitizeReplacement).onChange(async g=>{this.plugin.settings.tagSanitizeReplacement=g.trim()||"-",await this.plugin.saveSettings()})),new L.Setting(u).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}} and {{docling_markdown}} placeholders.").addTextArea(d=>{d.setValue(this.plugin.settings.noteBodyTemplate).onChange(async g=>{this.plugin.settings.noteBodyTemplate=g,await this.plugin.saveSettings()}),d.inputEl.rows=8,d.inputEl.style.width="100%"}),u.createEl("h2",{text:"LLM Provider Profiles"});let o=u.createDiv({cls:"zrr-llm-profiles"}),l=()=>{o.empty();let d=e();d.length||o.createEl("p",{text:"No profiles yet. Add one below."});for(let g of d)o.createEl("h6",{text:g.name||g.id||"Profile"}).addClass("zrr-profile-title"),new L.Setting(o).setName("Profile name").addText(O=>O.setPlaceholder("My provider").setValue(g.name||"").onChange(async Q=>{g.name=Q.trim(),await n(e())})),new L.Setting(o).setName("Base URL").addText(O=>O.setPlaceholder("http://localhost:1234/v1").setValue(g.baseUrl||"").onChange(async Q=>{g.baseUrl=Q.trim(),await n(e())})),new L.Setting(o).setName("API key").setDesc("Stored in settings (not encrypted).").addText(O=>{t(O),O.setPlaceholder("sk-...").setValue(g.apiKey||"").onChange(async Q=>{g.apiKey=Q.trim(),await n(e())})}),new L.Setting(o).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(O=>O.setButtonText("Delete profile").onClick(async()=>{let Q=e().filter(I=>I.id!==g.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===g.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===g.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===g.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(Q),l()}));new L.Setting(o).setName("Add profile").addButton(g=>g.setButtonText("Add").onClick(async()=>{let x=`profile-${Date.now().toString(36)}`,O=e().concat([{id:x,name:"Custom",baseUrl:"",apiKey:""}]);await n(O),l()}))};l(),new L.Setting(u).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(d=>d.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async g=>{this.plugin.settings.chatOutputDir=g.trim()||"zotero/chats",await this.plugin.saveSettings()})),new L.Setting(u).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(d=>d.setValue(this.plugin.settings.copyPdfToVault).onChange(async g=>{this.plugin.settings.copyPdfToVault=g,!g&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new L.Setting(u).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(d=>{let g=this.plugin.settings.copyPdfToVault;d.setValue(g?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!g).onChange(async x=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=x,await this.plugin.saveSettings()})}),new L.Setting(u).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(d=>d.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async g=>{this.plugin.settings.preferObsidianNoteForCitations=g,await this.plugin.saveSettings()})),u.createEl("h2",{text:"Docling"}),new L.Setting(u).setName("OCR mode").setDesc("auto: skip OCR when text is readable; force if bad: OCR only when text looks poor; force: always OCR.").addDropdown(d=>d.addOption("auto","auto").addOption("force_low_quality","force if quality is bad").addOption("force","force").setValue(this.plugin.settings.ocrMode).onChange(async g=>{this.plugin.settings.ocrMode=g,await this.plugin.saveSettings()})),new L.Setting(u).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(d=>{d.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async g=>{this.plugin.settings.ocrQualityThreshold=g,await this.plugin.saveSettings()})}),new L.Setting(u).setName("Chunking").setDesc("page or section").addDropdown(d=>d.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async g=>{this.plugin.settings.chunkingMode=g,await this.plugin.saveSettings()})),new L.Setting(u).setName("Section chunk max chars").setDesc("Split large section chunks into smaller pieces (section mode only).").addText(d=>d.setPlaceholder("3000").setValue(String(this.plugin.settings.maxChunkChars)).onChange(async g=>{let x=Number.parseInt(g,10);this.plugin.settings.maxChunkChars=Number.isFinite(x)?x:3e3,await this.plugin.saveSettings()})),new L.Setting(u).setName("Section chunk overlap chars").setDesc("Number of characters to overlap when splitting section chunks.").addText(d=>d.setPlaceholder("250").setValue(String(this.plugin.settings.chunkOverlapChars)).onChange(async g=>{let x=Number.parseInt(g,10);this.plugin.settings.chunkOverlapChars=Number.isFinite(x)?x:250,await this.plugin.saveSettings()})),u.createEl("h2",{text:"Automatic OCR cleanup"}),new L.Setting(u).setName("LLM cleanup for low-quality chunks").setDesc("Optional OpenAI-compatible cleanup for poor OCR. Can be slow/costly.").addToggle(d=>d.setValue(this.plugin.settings.enableLlmCleanup).onChange(async g=>{this.plugin.settings.enableLlmCleanup=g,await this.plugin.saveSettings()}));let c=null,h=null,_=null,f=async()=>{},y=async(d,g=!0)=>{let x=d.trim();this.plugin.settings.llmCleanupBaseUrl=x,g&&(this.plugin.settings.llmCleanupProviderProfileId="",c&&c.setValue("custom")),h&&h.setValue(x),await this.plugin.saveSettings()},m=async d=>{let g=e().find(x=>x.id===d);this.plugin.settings.llmCleanupProviderProfileId=d,g&&(this.plugin.settings.llmCleanupBaseUrl=g.baseUrl,this.plugin.settings.llmCleanupApiKey=g.apiKey,h==null||h.setValue(g.baseUrl),_==null||_.setValue(g.apiKey)),await this.plugin.saveSettings(),await f()};new L.Setting(u).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(d=>{c=d,d.addOption("custom","Custom (manual)");for(let x of e())d.addOption(x.id,x.name||x.id);let g=this.plugin.settings.llmCleanupProviderProfileId;d.setValue(g&&e().some(x=>x.id===g)?g:"custom"),d.onChange(async x=>{if(x==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await m(x)})}),new L.Setting(u).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(d=>{h=d,d.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async g=>{await y(g)})}),new L.Setting(u).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(d=>{_=d,t(d),d.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async g=>{this.plugin.settings.llmCleanupApiKey=g.trim(),this.plugin.settings.llmCleanupProviderProfileId="",c&&c.setValue("custom"),await this.plugin.saveSettings()})});let b=new L.Setting(u).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),w=null,C=d=>{if(!w)return;let g=(this.plugin.settings.llmCleanupModel||"").trim(),x=new Set(d.map(O=>O.value));g&&!x.has(g)&&(d=d.concat([{value:g,label:`Custom (${g})`}])),w.selectEl.options.length=0;for(let O of d)w.addOption(O.value,O.label);g&&w.setValue(g)};f=async()=>{if(w){w.setDisabled(!0);try{let d=await this.plugin.fetchCleanupModelOptions();C(d)}finally{w.setDisabled(!1)}}},b.addDropdown(d=>{w=d;let g=(this.plugin.settings.llmCleanupModel||"").trim();d.addOption(g||"loading","Loading..."),d.setValue(g||"loading"),d.onChange(async x=>{this.plugin.settings.llmCleanupModel=x.trim(),await this.plugin.saveSettings()})}),b.addButton(d=>{d.setButtonText("Refresh").onClick(async()=>{await f()})}),f(),new L.Setting(u).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(d=>d.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async g=>{let x=Number.parseFloat(g);this.plugin.settings.llmCleanupTemperature=Number.isFinite(x)?x:0,await this.plugin.saveSettings()})),new L.Setting(u).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(d=>d.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async g=>{this.plugin.settings.llmCleanupMinQuality=g,await this.plugin.saveSettings()})),new L.Setting(u).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(d=>d.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async g=>{let x=Number.parseInt(g,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(x)?x:2e3,await this.plugin.saveSettings()})),u.createEl("h2",{text:"Text Embedding"});let P=null,v=null,A=null,R=async()=>{},T=async(d,g=!0)=>{let x=d.trim();this.plugin.settings.embedBaseUrl=x,g&&(this.plugin.settings.embedProviderProfileId="",P&&P.setValue("custom")),v&&v.setValue(x),await this.plugin.saveSettings()},F=async d=>{let g=e().find(x=>x.id===d);this.plugin.settings.embedProviderProfileId=d,g&&(this.plugin.settings.embedBaseUrl=g.baseUrl,this.plugin.settings.embedApiKey=g.apiKey,v==null||v.setValue(g.baseUrl),A==null||A.setValue(g.apiKey)),await this.plugin.saveSettings(),await R()};new L.Setting(u).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(d=>{P=d,d.addOption("custom","Custom (manual)");for(let x of e())d.addOption(x.id,x.name||x.id);let g=this.plugin.settings.embedProviderProfileId;d.setValue(g&&e().some(x=>x.id===g)?g:"custom"),d.onChange(async x=>{if(x==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await F(x)})}),new L.Setting(u).setName("Embeddings base URL").addText(d=>{v=d,d.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async g=>{await T(g)})}),new L.Setting(u).setName("Embeddings API key").addText(d=>{A=d,t(d),d.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async g=>{this.plugin.settings.embedApiKey=g.trim(),this.plugin.settings.embedProviderProfileId="",P&&P.setValue("custom"),await this.plugin.saveSettings()})});let E=new L.Setting(u).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),N=null,G=d=>{if(!N)return;let g=(this.plugin.settings.embedModel||"").trim(),x=new Set(d.map(O=>O.value));g&&!x.has(g)&&(d=d.concat([{value:g,label:`Custom (${g})`}])),N.selectEl.options.length=0;for(let O of d)N.addOption(O.value,O.label);g&&N.setValue(g)};R=async()=>{if(N){N.setDisabled(!0);try{let d=await this.plugin.fetchEmbeddingModelOptions();G(d)}finally{N.setDisabled(!1)}}},E.addDropdown(d=>{N=d;let g=(this.plugin.settings.embedModel||"").trim();d.addOption(g||"loading","Loading..."),d.setValue(g||"loading"),d.onChange(async x=>{this.plugin.settings.embedModel=x.trim(),await this.plugin.saveSettings()})}),E.addButton(d=>{d.setButtonText("Refresh").onClick(async()=>{await R()})}),R(),new L.Setting(u).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(d=>d.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async g=>{this.plugin.settings.embedIncludeMetadata=g,await this.plugin.saveSettings()})),new L.Setting(u).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(d=>d.setValue(this.plugin.settings.enableChunkTagging).onChange(async g=>{this.plugin.settings.enableChunkTagging=g,await this.plugin.saveSettings()})),u.createEl("h2",{text:"Chat LLM"});let q=null,D=null,z=null,M=async()=>{},H=async(d,g=!0)=>{let x=d.trim();this.plugin.settings.chatBaseUrl=x,g&&(this.plugin.settings.chatProviderProfileId="",q&&q.setValue("custom")),D&&D.setValue(x),await this.plugin.saveSettings()},ee=async d=>{let g=e().find(x=>x.id===d);this.plugin.settings.chatProviderProfileId=d,g&&(this.plugin.settings.chatBaseUrl=g.baseUrl,this.plugin.settings.chatApiKey=g.apiKey,D==null||D.setValue(g.baseUrl),z==null||z.setValue(g.apiKey)),await this.plugin.saveSettings(),await M()};new L.Setting(u).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(d=>{q=d,d.addOption("custom","Custom (manual)");for(let x of e())d.addOption(x.id,x.name||x.id);let g=this.plugin.settings.chatProviderProfileId;d.setValue(g&&e().some(x=>x.id===g)?g:"custom"),d.onChange(async x=>{if(x==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await ee(x)})}),new L.Setting(u).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(d=>{D=d,d.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async g=>{await H(g)})}),new L.Setting(u).setName("Chat API key").addText(d=>{z=d,t(d),d.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async g=>{this.plugin.settings.chatApiKey=g.trim(),this.plugin.settings.chatProviderProfileId="",q&&q.setValue("custom"),await this.plugin.saveSettings()})});let ae=new L.Setting(u).setName("Chat model").setDesc("Select a chat-capable model from the provider."),K=null,he=d=>{if(!K)return;let g=(this.plugin.settings.chatModel||"").trim(),x=new Set(d.map(O=>O.value));g&&!x.has(g)&&(d=d.concat([{value:g,label:`Custom (${g})`}])),K.selectEl.options.length=0;for(let O of d)K.addOption(O.value,O.label);g&&K.setValue(g)};M=async()=>{if(K){K.setDisabled(!0);try{let d=await this.plugin.fetchChatModelOptions();he(d)}finally{K.setDisabled(!1)}}},ae.addDropdown(d=>{K=d;let g=(this.plugin.settings.chatModel||"").trim();d.addOption(g||"loading","Loading..."),d.setValue(g||"loading"),d.onChange(async x=>{this.plugin.settings.chatModel=x.trim(),await this.plugin.saveSettings()})}),ae.addButton(d=>{d.setButtonText("Refresh").onClick(async()=>{await M()})}),M(),new L.Setting(u).setName("Temperature").addText(d=>d.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async g=>{let x=Number.parseFloat(g);this.plugin.settings.chatTemperature=Number.isFinite(x)?x:.2,await this.plugin.saveSettings()})),new L.Setting(u).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(d=>d.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async g=>{let x=Number.parseInt(g,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(x)?Math.max(0,x):6,await this.plugin.saveSettings()})),new L.Setting(u).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(d=>d.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async g=>{this.plugin.settings.chatPaneLocation=g,await this.plugin.saveSettings()})),u.createEl("h2",{text:"Logging"}),new L.Setting(u).setName("Enable logging to file").setDesc("Write Docling/Python logs to a file during extraction.").addToggle(d=>d.setValue(this.plugin.settings.enableFileLogging).onChange(async g=>{this.plugin.settings.enableFileLogging=g,await this.plugin.saveSettings()})),new L.Setting(u).setName("Log file path (vault-relative)").setDesc("Where to write logs. Keep inside the vault.").addText(d=>d.setPlaceholder(`${V}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async g=>{this.plugin.settings.logFilePath=g.trim()||`${V}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new L.Setting(u).setName("View or clear log").setDesc("Open the log contents or clear the file.").addButton(d=>d.setButtonText("Open log").onClick(async()=>{var g,x;await((x=(g=this.plugin).openLogFile)==null?void 0:x.call(g))})).addButton(d=>d.setButtonText("Clear log").onClick(async()=>{var g,x;await((x=(g=this.plugin).clearLogFile)==null?void 0:x.call(g))})),u.createEl("h2",{text:"Maintenance"}),new L.Setting(u).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(d=>d.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new L.Setting(u).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(d=>d.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(d=>d.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}};var fe={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var De={"docling_extract.py":`#!/usr/bin/env python3
...
`;t.replaceRange(l,{line:r.startLine+1,ch:0},{line:r.endLine,ch:0}),this.showStatusProgress("Chunk cleaned.",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new p.Notice("Chunk cleaned.")}async requestOcrCleanup(e){var l,c,h,_,f,y,m,b,w;let n=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),t=(this.settings.llmCleanupModel||"").trim();if(!n||!t)return new p.Notice("OCR cleanup model is not configured."),this.openPluginSettings(),null;let i=Number(this.settings.llmCleanupMaxChars||0);if(i>0&&e.length>i)return new p.Notice("Chunk exceeds OCR cleanup max length. Adjust settings to clean it."),this.openPluginSettings(),null;let r=`${n}/chat/completions`,s={"Content-Type":"application/json"},a=(this.settings.llmCleanupApiKey||"").trim();a&&(s.Authorization=`Bearer ${a}`);let o={model:t,temperature:Number((l=this.settings.llmCleanupTemperature)!=null?l:0),messages:[{role:"system",content:"You are an OCR cleanup assistant. Fix OCR errors without changing meaning. Do not add content. Return corrected text only."},{role:"user",content:e}]};try{let C=await this.requestLocalApiRaw(r,{method:"POST",headers:s,body:JSON.stringify(o)});if(C.statusCode>=400){let R=C.body.toString("utf8");throw new Error(`Cleanup request failed (${C.statusCode}): ${R||"no response body"}`)}let P=JSON.parse(C.body.toString("utf8")),v=(w=(b=(m=(_=(h=(c=P==null?void 0:P.choices)==null?void 0:c[0])==null?void 0:h.message)==null?void 0:_.content)!=null?m:(y=(f=P==null?void 0:P.choices)==null?void 0:f[0])==null?void 0:y.text)!=null?b:P==null?void 0:P.output_text)!=null?w:"",A=String(v||"").trim();return A||(new p.Notice("Cleanup returned empty text."),null)}catch(C){return console.error("OCR cleanup failed",C),new p.Notice("OCR cleanup failed. Check the cleanup model settings."),null}}parseChunkTags(e,n){if(!e)return[];let t=e.trim(),i=[];if(t.startsWith("[")&&t.endsWith("]"))try{let a=JSON.parse(t);Array.isArray(a)&&(i=a.map(o=>String(o)))}catch(a){i=[]}i.length===0&&(i=t.split(/[,;\n]+/));let r=new Set,s=[];for(let a of i){let o=a.trim();if(o=o.replace(/^[-•\d.\)\s]+/,""),o=o.replace(/\s+/g," ").trim(),!o||o.length<2)continue;let l=o.toLowerCase();if(!r.has(l)&&(r.add(l),s.push(o),s.length>=n))break}return s}async requestChunkTags(e){var h,_,f,y,m,b,w,C,P;let n=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),t=(this.settings.llmCleanupModel||"").trim();if(!n||!t)return new p.Notice("OCR cleanup model is not configured."),this.openPluginSettings(),null;let i=e.trim().slice(0,2e3);if(!i)return[];let r=`${n}/chat/completions`,s={"Content-Type":"application/json"},a=(this.settings.llmCleanupApiKey||"").trim();a&&(s.Authorization=`Bearer ${a}`);let o=5,c={model:t,temperature:Number((h=this.settings.llmCleanupTemperature)!=null?h:0),messages:[{role:"system",content:"Return 3 to 5 high-signal, concrete noun-phrase tags. Avoid generic terms (study, paper, method), verbs, and filler. Prefer specific entities, methods, datasets, and named concepts. Output comma-separated tags only. No extra text."},{role:"user",content:i}]};this.showStatusProgress("Generating tags...",null);try{let v=await this.requestLocalApiRaw(r,{method:"POST",headers:s,body:JSON.stringify(c)});if(v.statusCode>=400){let F=v.body.toString("utf8");throw new Error(`Tag request failed (${v.statusCode}): ${F||"no response body"}`)}let A=JSON.parse(v.body.toString("utf8")),R=(P=(C=(w=(y=(f=(_=A==null?void 0:A.choices)==null?void 0:_[0])==null?void 0:f.message)==null?void 0:y.content)!=null?w:(b=(m=A==null?void 0:A.choices)==null?void 0:m[0])==null?void 0:b.text)!=null?C:A==null?void 0:A.output_text)!=null?P:"",T=this.parseChunkTags(String(R||""),o);return T.length||new p.Notice("Tag generation returned no tags."),T}catch(v){return console.error("Tag generation failed",v),new p.Notice("Tag generation failed. Check the cleanup model settings."),null}finally{this.clearStatusProgress()}}async renderMarkdownToIndexText(e){if(!e)return"";let n=document.createElement("div");try{await p.MarkdownRenderer.renderMarkdown(e,n,"",this)}catch(o){return console.warn("Failed to render markdown for index preview",o),this.normalizeIndexPreviewText(e)}let r=(n.innerHTML||"").replace(/<br\s*\/?>/gi,`
...
`).replace(/\s+/g," ").trim()}scheduleNoteSync(e){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let t=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},1200);this.noteSyncTimers.set(e.path,t)}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=e.page_start?String(e.page_start):"",t=e.page_end?String(e.page_end):"";if(n&&(!t||n===t))return n;if(n&&t)return`${n} - ${t}`;let i=(e.pages||"").trim();if(!i)return"?";let r=i.match(/^(\d+)\s*-\s*(\d+)$/);return r?r[1]===r[2]?r[1]:`${r[1]} - ${r[2]}`:i.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i,r;if(!this.noteSyncInFlight.has(e.path)&&!this.noteSyncSuppressed.has(e.path)){this.noteSyncInFlight.add(e.path);try{let s=await this.app.vault.read(e),a=this.extractSyncSection(s);if(!a)return;let o=(n=this.extractDocIdFromFrontmatter(s))!=null?n:this.extractDocIdFromSyncMarker(s);if(!o)return;let l=this.parseSyncedChunkBlocks(a);if(!l.length)return;let c=(0,p.normalizePath)(`${U}/${o}.json`),h=this.app.vault.adapter;if(!await h.exists(c))return;let _=await this.readChunkPayload(c);if(!_)return;let f=Array.isArray(_.chunks)?_.chunks:[],y=new Map;for(let v of f){let A=typeof(v==null?void 0:v.chunk_id)=="string"?v.chunk_id:String((t=v==null?void 0:v.chunk_id)!=null?t:"");A&&y.set(A,v)}let m=new Set,b=new Set,w=new Set,C=new Set,P=!1;for(let v of l){let A=v.chunkId;if(!A)continue;m.add(A);let R=y.get(A);if(!R){console.warn(`Sync note: chunk id not found in cache (${A})`);continue}if(v.excludeFlag){R.excluded!==!0&&(R.excluded=!0,P=!0);let E=this.normalizeChunkText(v.text);E&&E!==String((i=R.text)!=null?i:"")&&(R.text=E,R.char_count=E.length,P=!0),w.add(A);continue}if(R.excluded&&(R.excluded=!1,P=!0,b.add(A)),!v.text.trim()){w.add(A),C.add(A);continue}let T=this.normalizeChunkText(v.text);if(!T){w.add(A),C.add(A);continue}let F=typeof R.text=="string"?R.text:String((r=R.text)!=null?r:"");T!==F&&(R.text=T,R.char_count=T.length,b.add(A),P=!0)}for(let v of y.keys())m.has(v)||(w.add(v),C.add(v));if(!b.size&&!w.size&&!C.size&&!P)return;C.size&&(_.chunks=f.filter(v=>{var R;let A=typeof(v==null?void 0:v.chunk_id)=="string"?v.chunk_id:String((R=v==null?void 0:v.chunk_id)!=null?R:"");return A&&!C.has(A)}),P=!0),(P||C.size)&&await h.write(c,JSON.stringify(_,null,2)),await this.reindexChunkUpdates(o,c,Array.from(b),Array.from(w))}catch(s){console.warn("Failed to sync note edits to Redis",s)}finally{this.noteSyncInFlight.delete(e.path)}}}extractSyncSection(e){let n=te.exec(e);if(!n)return null;let t=e.slice(n.index+n[0].length),i=ie.exec(t);return i?t.slice(0,i.index):null}extractDocIdFromSyncMarker(e){var r;let n=te.exec(e);if(!n)return null;let i=((r=n[0])!=null?r:"").match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return i?i[2].trim():null}parseSyncedChunkBlocks(e){var o;let n=e.split(/\r?\n/),t=[],i="",r=!1,s=[],a=()=>{i&&(t.push({chunkId:i,text:s.join(`
`).trim(),excludeFlag:r}),i="",r=!1,s=[])};for(let l of n){let c=l.match(re);if(c){a();let h=(o=c[1])!=null?o:"",_=h.match(/id=([\"']?)([^\"'\s]+)\1/i),f=_?_[2].trim():"";if(!f)continue;i=f,r=/\bexclude\b/i.test(h)||/\bdelete\b/i.test(h),s=[];continue}if(xe.test(l)){a();continue}if(i){if(pe.test(l)){r=!0;continue}s.push(l)}}return a(),t}normalizeChunkText(e){return e.split(/\r?\n/).map(n=>n.replace(/\s+/g," ").trim()).filter((n,t,i)=>!(n===""&&i[t-1]==="")).join(`

"use strict";var ue=Object.create;var U=Object.defineProperty;var ge=Object.getOwnPropertyDescriptor;var he=Object.getOwnPropertyNames;var fe=Object.getPrototypeOf,me=Object.prototype.hasOwnProperty;var _e=(L,p)=>{for(var e in p)U(L,e,{get:p[e],enumerable:!0})},ae=(L,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of he(p))!me.call(L,t)&&t!==e&&U(L,t,{get:()=>p[t],enumerable:!(n=ge(p,t))||n.enumerable});return L};var V=(L,p,e)=>(e=L!=null?ue(fe(L)):{},ae(p||!L||!L.__esModule?U(e,"default",{value:L,enumerable:!0}):e,L)),ye=L=>ae(U({},"__esModule",{value:!0}),L);var xe={};_e(xe,{default:()=>J});module.exports=ye(xe);var d=require("obsidian"),q=require("child_process"),N=require("fs"),de=V(require("http")),pe=V(require("https")),X=V(require("net")),f=V(require("path")),B=require("url"),H=require("crypto");var w=require("obsidian"),O=".zotero-redisearch-rag",F=`${O}/items`,I=`${O}/chunks`,se={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}

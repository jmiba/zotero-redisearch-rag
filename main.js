"use strict";var dn=Object.create;var be=Object.defineProperty;var cn=Object.getOwnPropertyDescriptor;var pn=Object.getOwnPropertyNames;var un=Object.getPrototypeOf,_n=Object.prototype.hasOwnProperty;var gn=(k,m)=>{for(var e in m)be(k,e,{get:m[e],enumerable:!0})},Ze=(k,m,e,n)=>{if(m&&typeof m=="object"||typeof m=="function")for(let t of pn(m))!_n.call(k,t)&&t!==e&&be(k,t,{get:()=>m[t],enumerable:!(n=cn(m,t))||n.enumerable});return k};var le=(k,m,e)=>(e=k!=null?dn(un(k)):{},Ze(m||!k||!k.__esModule?be(e,"default",{value:k,enumerable:!0}):e,k)),fn=k=>Ze(be({},"__esModule",{value:!0}),k);var Rn={};gn(Rn,{default:()=>Le});module.exports=fn(Rn);var p=require("obsidian"),ee=require("@codemirror/state"),j=require("@codemirror/view"),X=require("child_process"),B=require("fs"),nn=le(require("http")),tn=le(require("https")),ge=le(require("net")),rn=le(require("os")),sn=le(require("tls")),A=le(require("path")),ue=require("url"),ve=require("crypto");var R=require("obsidian"),K=".zotero-redisearch-rag",J=`${K}/items`,V=`${K}/chunks`,He={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{pdf_block}}{{docling_markdown}}",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,chatPaneLocation:"right",enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"cross-encoder/ms-marco-MiniLM-L-6-v2",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${K}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},xe=class extends R.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async _=>{this.plugin.settings.llmProviderProfiles=_,await this.plugin.saveSettings()},i=_=>{_.inputEl.type="password",_.inputEl.autocomplete="off",_.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:_=>{_.createEl("h2",{text:"Prerequisites"}),new R.Setting(_).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows).").addText(f=>f.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async v=>{this.plugin.settings.pythonPath=v.trim(),await this.plugin.saveSettings()})),new R.Setting(_).setName("Python environment").setDesc("Create or update the plugin's Python env (location configured below).").addButton(f=>{f.setButtonText("Create/Update").setCta(),f.onClick(async()=>{f.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{f.setDisabled(!1)}})}),new R.Setting(_).setName("Python env location").setDesc("Shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(f=>{f.addOption("shared","Shared user cache"),f.addOption("plugin","Plugin folder (.venv)"),f.setValue(this.plugin.settings.pythonEnvLocation).onChange(async v=>{v!=="shared"&&v!=="plugin"||(this.plugin.settings.pythonEnvLocation=v,await this.plugin.saveSettings())})}),new R.Setting(_).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack).").addText(f=>f.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async v=>{this.plugin.settings.dockerPath=v.trim()||"docker",await this.plugin.saveSettings()})),new R.Setting(_).setName("Redis URL").addText(f=>f.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async v=>{this.plugin.settings.redisUrl=v.trim(),await this.plugin.saveSettings()})),new R.Setting(_).setName("Redis data directory override").setDesc("Optional absolute path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting.").addText(f=>f.setPlaceholder("/Users/you/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async v=>{this.plugin.settings.redisDataDirOverride=v.trim(),await this.plugin.saveSettings()})),new R.Setting(_).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(f=>f.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async v=>{this.plugin.settings.redisProjectName=v.trim(),await this.plugin.saveSettings()})),new R.Setting(_).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(f=>f.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async v=>{this.plugin.settings.autoAssignRedisPort=v,await this.plugin.saveSettings()})),new R.Setting(_).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Uses a vault-specific data dir at .obsidian/zotero-redisearch-rag/redis-data unless overridden.").addToggle(f=>f.setValue(this.plugin.settings.autoStartRedis).onChange(async v=>{this.plugin.settings.autoStartRedis=v,await this.plugin.saveSettings()})),new R.Setting(_).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(f=>f.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:_=>{_.createEl("h2",{text:"Zotero Local API"}),new R.Setting(_).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(C=>C.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async w=>{this.plugin.settings.zoteroBaseUrl=w.trim(),await this.plugin.saveSettings()}));let f=new R.Setting(_).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),v=null,P=C=>{if(!v)return;let w=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(C.map(I=>I.value)).has(w)||(C=C.concat([{value:w,label:`Custom (${w})`}])),v.selectEl.options.length=0;for(let I of C)v.addOption(I.value,I.label);v.setValue(w)},N=async()=>{if(v){v.setDisabled(!0);try{let C=await this.plugin.fetchZoteroLibraryOptions();P(C)}finally{v.setDisabled(!1)}}};f.addDropdown(C=>{v=C;let w=(this.plugin.settings.zoteroUserId||"0").trim()||"0";C.addOption(w,"Loading..."),C.setValue(w),C.onChange(async D=>{this.plugin.settings.zoteroUserId=D.trim(),await this.plugin.saveSettings()})}),f.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await N()})}),N(),_.createEl("h2",{text:"Zotero Web API"}),new R.Setting(_).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(C=>C.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async w=>{this.plugin.settings.webApiBaseUrl=w.trim(),await this.plugin.saveSettings()})),new R.Setting(_).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(C=>C.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async w=>{this.plugin.settings.webApiLibraryType=w,await this.plugin.saveSettings()})),new R.Setting(_).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(C=>C.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async w=>{this.plugin.settings.webApiLibraryId=w.trim(),await this.plugin.saveSettings()})),new R.Setting(_).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(C=>{i(C),C.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async w=>{this.plugin.settings.webApiKey=w.trim(),await this.plugin.saveSettings()})}),_.createEl("h2",{text:"Output"}),new R.Setting(_).setName("PDF folder").addText(C=>C.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async w=>{this.plugin.settings.outputPdfDir=w.trim(),await this.plugin.saveSettings()})),new R.Setting(_).setName("Notes folder").addText(C=>C.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async w=>{this.plugin.settings.outputNoteDir=w.trim(),await this.plugin.saveSettings()})),new R.Setting(_).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(C=>{C.setValue(this.plugin.settings.frontmatterTemplate).onChange(async w=>{this.plugin.settings.frontmatterTemplate=w,await this.plugin.saveSettings()}),C.inputEl.rows=10,C.inputEl.style.width="100%"}),new R.Setting(_).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(C=>C.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async w=>{this.plugin.settings.tagSanitizeMode=w,await this.plugin.saveSettings()})),new R.Setting(_).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}} and {{docling_markdown}} placeholders.").addTextArea(C=>{C.setValue(this.plugin.settings.noteBodyTemplate).onChange(async w=>{this.plugin.settings.noteBodyTemplate=w,await this.plugin.saveSettings()}),C.inputEl.rows=8,C.inputEl.style.width="100%"}),new R.Setting(_).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(C=>C.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async w=>{this.plugin.settings.chatOutputDir=w.trim()||"zotero/chats",await this.plugin.saveSettings()})),new R.Setting(_).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(C=>C.setValue(this.plugin.settings.copyPdfToVault).onChange(async w=>{this.plugin.settings.copyPdfToVault=w,!w&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new R.Setting(_).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(C=>{let w=this.plugin.settings.copyPdfToVault;C.setValue(w?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!w).onChange(async D=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=D,await this.plugin.saveSettings()})}),new R.Setting(_).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(C=>C.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async w=>{this.plugin.settings.preferObsidianNoteForCitations=w,await this.plugin.saveSettings()}))}},{id:"ocr",label:"OCR",render:_=>{_.createEl("h2",{text:"Docling"});let f=null,v=w=>{if(!f)return;let D=this.plugin.settings.ocrEngine;new Set(w.map(z=>z.value)).has(D)||(w=w.concat([{value:D,label:`Current (unavailable): ${D}`}])),f.selectEl.options.length=0;for(let z of w)f.addOption(z.value,z.label);f.setValue(D)},P=async()=>{if(!f)return;f.setDisabled(!0);let w={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{w=await this.plugin.detectOcrEngines()}catch(z){w={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let D=[{value:"auto",label:"Auto (default)"}];w.tesseract&&D.push({value:"tesseract",label:"Tesseract (local)"}),w.paddleStructureLocal&&D.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),w.paddleVlLocal&&D.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(D.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),D.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),v(D),f.setDisabled(!1)},N=new R.Setting(_).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),C=document.createElement("a");C.href="https://aistudio.baidu.com/paddleocr",C.textContent="https://aistudio.baidu.com/paddleocr",C.target="_blank",C.rel="noopener noreferrer",N.descEl.appendChild(C),N.descEl.append("."),N.addText(w=>{i(w),w.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async D=>{this.plugin.settings.paddleApiKey=D.trim(),await this.plugin.saveSettings(),await P()})}),new R.Setting(_).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(w=>w.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async D=>{this.plugin.settings.paddleVlApiUrl=D.trim(),await this.plugin.saveSettings()})),new R.Setting(_).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(w=>w.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async D=>{this.plugin.settings.paddleStructureApiUrl=D.trim(),await this.plugin.saveSettings(),await P()})),new R.Setting(_).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(w=>{f=w,w.addOption("auto","Auto (default)"),w.setValue(this.plugin.settings.ocrEngine),w.onChange(async D=>{this.plugin.settings.ocrEngine=D,await this.plugin.saveSettings()})}),new R.Setting(_).setName("OCR mode").setDesc("auto: skip OCR when text is readable; force if bad: OCR only when text looks poor; force: always OCR.").addDropdown(w=>w.addOption("auto","auto").addOption("force_low_quality","force if quality is bad").addOption("force","force").setValue(this.plugin.settings.ocrMode).onChange(async D=>{this.plugin.settings.ocrMode=D,await this.plugin.saveSettings()})),new R.Setting(_).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(w=>{w.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async D=>{this.plugin.settings.ocrQualityThreshold=D,await this.plugin.saveSettings()})}),new R.Setting(_).setName("Chunking").setDesc("page or section").addDropdown(w=>w.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async D=>{this.plugin.settings.chunkingMode=D,await this.plugin.saveSettings()})),P()}},{id:"llms",label:"LLMs",render:_=>{_.createEl("h2",{text:"LLM Provider Profiles"});let f=_.createDiv({cls:"zrr-llm-profiles"}),v=()=>{f.empty();let h=n();h.length||f.createEl("p",{text:"No profiles yet. Add one below."});for(let x of h){let E=f.createEl("details",{cls:"zrr-profile"});h.length===1&&(E.open=!0);let U=E.createEl("summary",{text:x.name||x.id||"Profile"});U.addClass("zrr-profile-title");let ye=E.createDiv({cls:"zrr-profile-body"});new R.Setting(ye).setName("Profile name").addText(te=>te.setPlaceholder("My provider").setValue(x.name||"").onChange(async re=>{x.name=re.trim(),U.textContent=x.name||x.id||"Profile",await t(n())})),new R.Setting(ye).setName("Base URL").addText(te=>te.setPlaceholder("http://localhost:1234/v1").setValue(x.baseUrl||"").onChange(async re=>{x.baseUrl=re.trim(),await t(n())})),new R.Setting(ye).setName("API key").setDesc("Stored in settings (not encrypted).").addText(te=>{i(te),te.setPlaceholder("sk-...").setValue(x.apiKey||"").onChange(async re=>{x.apiKey=re.trim(),await t(n())})}),new R.Setting(ye).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(te=>te.setButtonText("Delete profile").onClick(async()=>{let re=n().filter(ln=>ln.id!==x.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===x.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===x.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===x.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(re),v()}))}new R.Setting(f).addButton(x=>x.setButtonText("Add profile").onClick(async()=>{let E=`profile-${Date.now().toString(36)}`,U=n().concat([{id:E,name:"Custom",baseUrl:"",apiKey:""}]);await t(U),v()}))};v(),_.createEl("h2",{text:"OCR cleanup"}),new R.Setting(_).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(h=>h.setValue(this.plugin.settings.enableLlmCleanup).onChange(async x=>{this.plugin.settings.enableLlmCleanup=x,await this.plugin.saveSettings()}));let P=null,N=null,C=null,w=async()=>{},D=async(h,x=!0)=>{let E=h.trim();this.plugin.settings.llmCleanupBaseUrl=E,x&&(this.plugin.settings.llmCleanupProviderProfileId="",P&&P.setValue("custom")),N&&N.setValue(E),await this.plugin.saveSettings()},I=async h=>{let x=n().find(E=>E.id===h);this.plugin.settings.llmCleanupProviderProfileId=h,x&&(this.plugin.settings.llmCleanupBaseUrl=x.baseUrl,this.plugin.settings.llmCleanupApiKey=x.apiKey,N==null||N.setValue(x.baseUrl),C==null||C.setValue(x.apiKey)),await this.plugin.saveSettings(),await w()};new R.Setting(_).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(h=>{P=h,h.addOption("custom","Custom (manual)");for(let E of n())h.addOption(E.id,E.name||E.id);let x=this.plugin.settings.llmCleanupProviderProfileId;h.setValue(x&&n().some(E=>E.id===x)?x:"custom"),h.onChange(async E=>{if(E==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await I(E)})}),new R.Setting(_).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(h=>{N=h,h.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async x=>{await D(x)})}),new R.Setting(_).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(h=>{C=h,i(h),h.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async x=>{this.plugin.settings.llmCleanupApiKey=x.trim(),this.plugin.settings.llmCleanupProviderProfileId="",P&&P.setValue("custom"),await this.plugin.saveSettings()})});let z=new R.Setting(_).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),S=null,F=h=>{if(!S)return;let x=(this.plugin.settings.llmCleanupModel||"").trim(),E=new Set(h.map(U=>U.value));x&&!E.has(x)&&(h=h.concat([{value:x,label:`Custom (${x})`}])),S.selectEl.options.length=0;for(let U of h)S.addOption(U.value,U.label);x&&S.setValue(x)};w=async()=>{if(S){S.setDisabled(!0);try{let h=await this.plugin.fetchCleanupModelOptions();F(h)}finally{S.setDisabled(!1)}}},z.addDropdown(h=>{S=h;let x=(this.plugin.settings.llmCleanupModel||"").trim();h.addOption(x||"loading","Loading..."),h.setValue(x||"loading"),h.onChange(async E=>{this.plugin.settings.llmCleanupModel=E.trim(),await this.plugin.saveSettings()})}),z.addButton(h=>{h.setButtonText("Refresh").onClick(async()=>{await w()})}),w(),new R.Setting(_).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(h=>h.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async x=>{let E=Number.parseFloat(x);this.plugin.settings.llmCleanupTemperature=Number.isFinite(E)?E:0,await this.plugin.saveSettings()})),new R.Setting(_).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(h=>h.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async x=>{this.plugin.settings.llmCleanupMinQuality=x,await this.plugin.saveSettings()})),new R.Setting(_).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(h=>h.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(E)?E:2e3,await this.plugin.saveSettings()})),_.createEl("h2",{text:"Text Embedding"});let T=null,$=null,H=null,O=async()=>{},q=async(h,x=!0)=>{let E=h.trim();this.plugin.settings.embedBaseUrl=E,x&&(this.plugin.settings.embedProviderProfileId="",T&&T.setValue("custom")),$&&$.setValue(E),await this.plugin.saveSettings()},Z=async h=>{let x=n().find(E=>E.id===h);this.plugin.settings.embedProviderProfileId=h,x&&(this.plugin.settings.embedBaseUrl=x.baseUrl,this.plugin.settings.embedApiKey=x.apiKey,$==null||$.setValue(x.baseUrl),H==null||H.setValue(x.apiKey)),await this.plugin.saveSettings(),await O()};new R.Setting(_).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(h=>{T=h,h.addOption("custom","Custom (manual)");for(let E of n())h.addOption(E.id,E.name||E.id);let x=this.plugin.settings.embedProviderProfileId;h.setValue(x&&n().some(E=>E.id===x)?x:"custom"),h.onChange(async E=>{if(E==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await Z(E)})}),new R.Setting(_).setName("Embeddings base URL").addText(h=>{$=h,h.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async x=>{await q(x)})}),new R.Setting(_).setName("Embeddings API key").addText(h=>{H=h,i(h),h.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async x=>{this.plugin.settings.embedApiKey=x.trim(),this.plugin.settings.embedProviderProfileId="",T&&T.setValue("custom"),await this.plugin.saveSettings()})});let W=new R.Setting(_).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),Y=null,Ee=h=>{if(!Y)return;let x=(this.plugin.settings.embedModel||"").trim(),E=new Set(h.map(U=>U.value));x&&!E.has(x)&&(h=h.concat([{value:x,label:`Custom (${x})`}])),Y.selectEl.options.length=0;for(let U of h)Y.addOption(U.value,U.label);x&&Y.setValue(x)};O=async()=>{if(Y){Y.setDisabled(!0);try{let h=await this.plugin.fetchEmbeddingModelOptions();Ee(h)}finally{Y.setDisabled(!1)}}},W.addDropdown(h=>{Y=h;let x=(this.plugin.settings.embedModel||"").trim();h.addOption(x||"loading","Loading..."),h.setValue(x||"loading"),h.onChange(async E=>{this.plugin.settings.embedModel=E.trim(),await this.plugin.saveSettings()})}),W.addButton(h=>{h.setButtonText("Refresh").onClick(async()=>{await O()})}),O(),new R.Setting(_).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(h=>h.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async x=>{this.plugin.settings.embedIncludeMetadata=x,await this.plugin.saveSettings()})),new R.Setting(_).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(h=>h.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.embedContextWindow=Number.isFinite(E)?Math.max(0,E):1,await this.plugin.saveSettings()})),new R.Setting(_).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(h=>h.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.embedContextChars=Number.isFinite(E)?Math.max(0,E):220,await this.plugin.saveSettings()})),new R.Setting(_).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(h=>h.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(E)?Math.max(0,E):3500,await this.plugin.saveSettings()})),new R.Setting(_).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(h=>h.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(E)?Math.max(0,E):200,await this.plugin.saveSettings()})),new R.Setting(_).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(h=>h.setValue(this.plugin.settings.enableChunkTagging).onChange(async x=>{this.plugin.settings.enableChunkTagging=x,await this.plugin.saveSettings()})),_.createEl("h2",{text:"Chat LLM"});let ie=null,ne=null,se=null,ae=async()=>{},he=async(h,x=!0)=>{let E=h.trim();this.plugin.settings.chatBaseUrl=E,x&&(this.plugin.settings.chatProviderProfileId="",ie&&ie.setValue("custom")),ne&&ne.setValue(E),await this.plugin.saveSettings()},Ae=async h=>{let x=n().find(E=>E.id===h);this.plugin.settings.chatProviderProfileId=h,x&&(this.plugin.settings.chatBaseUrl=x.baseUrl,this.plugin.settings.chatApiKey=x.apiKey,ne==null||ne.setValue(x.baseUrl),se==null||se.setValue(x.apiKey)),await this.plugin.saveSettings(),await ae()};new R.Setting(_).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(h=>{ie=h,h.addOption("custom","Custom (manual)");for(let E of n())h.addOption(E.id,E.name||E.id);let x=this.plugin.settings.chatProviderProfileId;h.setValue(x&&n().some(E=>E.id===x)?x:"custom"),h.onChange(async E=>{if(E==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await Ae(E)})}),new R.Setting(_).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(h=>{ne=h,h.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async x=>{await he(x)})}),new R.Setting(_).setName("Chat API key").addText(h=>{se=h,i(h),h.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async x=>{this.plugin.settings.chatApiKey=x.trim(),this.plugin.settings.chatProviderProfileId="",ie&&ie.setValue("custom"),await this.plugin.saveSettings()})});let oe=new R.Setting(_).setName("Chat model").setDesc("Select a chat-capable model from the provider."),Q=null,M=h=>{if(!Q)return;let x=(this.plugin.settings.chatModel||"").trim(),E=new Set(h.map(U=>U.value));x&&!E.has(x)&&(h=h.concat([{value:x,label:`Custom (${x})`}])),Q.selectEl.options.length=0;for(let U of h)Q.addOption(U.value,U.label);x&&Q.setValue(x)};ae=async()=>{if(Q){Q.setDisabled(!0);try{let h=await this.plugin.fetchChatModelOptions();M(h)}finally{Q.setDisabled(!1)}}},oe.addDropdown(h=>{Q=h;let x=(this.plugin.settings.chatModel||"").trim();h.addOption(x||"loading","Loading..."),h.setValue(x||"loading"),h.onChange(async E=>{this.plugin.settings.chatModel=E.trim(),await this.plugin.saveSettings()})}),oe.addButton(h=>{h.setButtonText("Refresh").onClick(async()=>{await ae()})}),ae(),new R.Setting(_).setName("Temperature").addText(h=>h.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async x=>{let E=Number.parseFloat(x);this.plugin.settings.chatTemperature=Number.isFinite(E)?E:.2,await this.plugin.saveSettings()})),new R.Setting(_).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(h=>h.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(E)?Math.max(0,E):6,await this.plugin.saveSettings()})),new R.Setting(_).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(h=>h.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async x=>{this.plugin.settings.chatPaneLocation=x,await this.plugin.saveSettings()})),_.createEl("h2",{text:"Retrieval"}),new R.Setting(_).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(h=>h.setValue(this.plugin.settings.enableQueryExpansion).onChange(async x=>{this.plugin.settings.enableQueryExpansion=x,await this.plugin.saveSettings()})),new R.Setting(_).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(h=>h.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.queryExpansionCount=Number.isFinite(E)?Math.max(1,E):3,await this.plugin.saveSettings()})),new R.Setting(_).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(h=>h.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async x=>{this.plugin.settings.enableCrossEncoderRerank=x,await this.plugin.saveSettings()})),new R.Setting(_).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(h=>h.setPlaceholder("cross-encoder/ms-marco-MiniLM-L-6-v2").setValue(this.plugin.settings.rerankModel).onChange(async x=>{this.plugin.settings.rerankModel=x.trim()||"cross-encoder/ms-marco-MiniLM-L-6-v2",await this.plugin.saveSettings()})),new R.Setting(_).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(h=>h.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(E)?Math.max(1,E):4,await this.plugin.saveSettings()})),new R.Setting(_).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(h=>h.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.rrfK=Number.isFinite(E)?Math.max(1,E):60,await this.plugin.saveSettings()})),new R.Setting(_).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(h=>h.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.rrfLogTop=Number.isFinite(E)?Math.max(0,E):0,await this.plugin.saveSettings()})),new R.Setting(_).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(h=>h.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(E)?Math.max(0,E):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:_=>{_.createEl("h2",{text:"Logging"}),new R.Setting(_).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(f=>f.setValue(this.plugin.settings.enableFileLogging).onChange(async v=>{this.plugin.settings.enableFileLogging=v,await this.plugin.saveSettings()})),new R.Setting(_).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(f=>f.setPlaceholder(`${K}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async v=>{this.plugin.settings.logFilePath=v.trim()||`${K}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new R.Setting(_).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(f=>f.setButtonText("Open log").onClick(async()=>{var v,P;await((P=(v=this.plugin).openLogFile)==null?void 0:P.call(v))})).addButton(f=>f.setButtonText("Clear log").onClick(async()=>{var v,P;await((P=(v=this.plugin).clearLogFile)==null?void 0:P.call(v))})),_.createEl("h2",{text:"Maintenance"}),new R.Setting(_).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(f=>f.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new R.Setting(_).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(f=>f.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(f=>f.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],c=new Map,u=new Map,g=_=>{this.activeTab=_;for(let[f,v]of c){let P=f===_;v.classList.toggle("is-active",P),v.setAttribute("aria-selected",P?"true":"false"),v.setAttribute("tabindex",P?"0":"-1")}for(let[f,v]of u){let P=f===_;v.classList.toggle("is-active",P),v.hidden=!P}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let b=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let _ of d){let f=y.createEl("button",{text:_.label,cls:"zrr-settings-tab-button"}),v=`zrr-settings-tab-${_.id}`,P=`zrr-settings-panel-${_.id}`;f.type="button",f.id=v,f.setAttribute("role","tab"),f.setAttribute("aria-controls",P),f.setAttribute("aria-selected","false"),f.addEventListener("click",()=>g(_.id));let N=b.createDiv({cls:"zrr-settings-tab-panel"});N.id=P,N.setAttribute("role","tabpanel"),N.setAttribute("aria-labelledby",v),N.hidden=!0,_.render(N),c.set(_.id,f),u.set(_.id,N)}let L=d.some(_=>_.id===this.activeTab)?this.activeTab:d[0].id;g(L)}};var ke={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">

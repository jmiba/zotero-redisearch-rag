"use strict";var fe=Object.create;var H=Object.defineProperty;var me=Object.getOwnPropertyDescriptor;var ye=Object.getOwnPropertyNames;var be=Object.getPrototypeOf,xe=Object.prototype.hasOwnProperty;var we=(C,u)=>{for(var e in u)H(C,e,{get:u[e],enumerable:!0})},oe=(C,u,e,n)=>{if(u&&typeof u=="object"||typeof u=="function")for(let t of ye(u))!xe.call(C,t)&&t!==e&&H(C,t,{get:()=>u[t],enumerable:!(n=me(u,t))||n.enumerable});return C};var W=(C,u,e)=>(e=C!=null?fe(be(C)):{},oe(u||!C||!C.__esModule?H(e,"default",{value:C,enumerable:!0}):e,C)),ve=C=>oe(H({},"__esModule",{value:!0}),C);var Ne={};we(Ne,{default:()=>Y});module.exports=ve(Ne);var d=require("obsidian"),V=require("@codemirror/state"),M=require("@codemirror/view"),q=require("child_process"),D=require("fs"),_e=W(require("http")),he=W(require("https")),te=W(require("net")),f=W(require("path")),Z=require("url"),J=require("crypto");var P=require("obsidian"),z=".zotero-redisearch-rag",$=`${z}/items`,F=`${z}/chunks`,le={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}

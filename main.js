"use strict";var _n=Object.create;var qe=Object.defineProperty;var gn=Object.getOwnPropertyDescriptor;var hn=Object.getOwnPropertyNames;var fn=Object.getPrototypeOf,mn=Object.prototype.hasOwnProperty;var yn=(h,_)=>{for(var e in _)qe(h,e,{get:_[e],enumerable:!0})},At=(h,_,e,t)=>{if(_&&typeof _=="object"||typeof _=="function")for(let n of hn(_))!mn.call(h,n)&&n!==e&&qe(h,n,{get:()=>_[n],enumerable:!(t=gn(_,n))||t.enumerable});return h};var me=(h,_,e)=>(e=h!=null?_n(fn(h)):{},At(_||!h||!h.__esModule?qe(e,"default",{value:h,enumerable:!0}):e,h)),bn=h=>At(qe({},"__esModule",{value:!0}),h);var Bn={};yn(Bn,{default:()=>lt});module.exports=bn(Bn);var m=require("obsidian");var Dt=require("@codemirror/state"),ie=require("@codemirror/view"),Ot=require("obsidian");var ye=/<!--\s*zrr:sync-start[^>]*-->/i,ve=/<!--\s*zrr:sync-end\s*-->/i,ge=/<!--\s*zrr:chunk\b([^>]*)-->/i,je=/<!--\s*zrr:chunk\s+end\s*-->/i,Se=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,Et=h=>{let _=h.trim();if(!_.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(_)){let p=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:p?p[2]:void 0}}if(/^zrr:sync-end\b/i.test(_))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(_)){let p=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),g=_.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:p?p[2]:void 0,attachmentKey:g?g[2]:void 0}}if(/^zrr:annotations-end\b/i.test(_))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(_))return{type:"chunk-end"};let e=_.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let t=e[1]||"",n=t.match(/\bid=(["']?)([^"'\s]+)\1/i),r=n?n[2]:"",i=t.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=i?null:t.match(/\(\s*(\d+)\s*\)/),s=i?Number.parseInt(i[2],10):a?Number.parseInt(a[1],10):void 0,o=r.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(t)||/\bdelete\b/i.test(t),u=/\bsection\b/i.test(t);return{type:"chunk-start",chunkId:r||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:u?"section":c?"page":"section"}},dt=h=>{var l;if(!h)return null;let _=h.match(ge);if(!_)return null;let e=_[1]||"",t=e.match(/\bid=(["']?)([^"'\s]+)\1/i),n=t?t[2].trim():void 0,r=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),i=r?null:e.match(/\(\s*(\d+)\s*\)/),a=r?Number.parseInt(r[2],10):i?Number.parseInt(i[1],10):void 0,s=n&&(l=kn(n))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:n,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},$e=h=>{for(let _=1;_<=h.lines;_+=1){let e=h.line(_).text;if(ye.test(e)){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i);return t?t[2].trim():null}}return null},pt=(h,_)=>{let e=_;for(;e>=1;e-=1){let t=h.line(e).text;if(ge.test(t))return{line:e,text:t};if(ye.test(t)||ve.test(t))break}return null},xn=(h,_)=>{for(let e=_;e<=h.lines;e+=1){let t=h.line(e).text;if(je.test(t))return e;if(ve.test(t))break}return null},Rt=(h,_)=>{let e=pt(h,_);if(!e)return null;let t=xn(h,e.line+1);return t===null||_<e.line||_>t?null:{startLine:e.line,endLine:t,text:e.text}},St=(h,_,e)=>{if(_>e)return!1;for(let t=_;t<=e;t+=1){let n=h.line(t).text;if(Se.test(n))return!0}return!1},kn=h=>{var n;if(!h)return null;let e=(h.includes(":")&&(n=h.split(":").pop())!=null?n:h).match(/^p(\d+)$/i);if(!e)return null;let t=Number.parseInt(e[1],10);return Number.isFinite(t)?t:null};var Nt=h=>{if(!h)return null;let _=h.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return _?dt(_[0]):null};var wn=(h,_)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),h.type==="sync-start"||h.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(h.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),h.type==="sync-start"?e.textContent=h.docId?`Redis Index Sync start - ${h.docId}`:"Redis Index Sync start":e.textContent="Redis index sync end",e;if(h.type==="annotations-start"||h.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),h.type==="annotations-start"){let t=h.docId?` - ${h.docId}`:"";e.textContent=`Zotero annotations start${t}`}else e.textContent="Zotero annotations end";return e}if(h.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=h.chunkKind==="page"?"Page end":"Section end",h.chunkKind&&e.classList.add(`zrr-sync-badge--${h.chunkKind}`),e;if(h.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),h.chunkKind&&e.classList.add(`zrr-sync-badge--${h.chunkKind}`),h.excluded&&e.classList.add("is-excluded"),h.pageNumber&&_>0)if(h.chunkKind==="section"){let t=h.chunkId?`Section ${h.chunkId}`:"Section";e.textContent=`${t} (p${h.pageNumber}/${_})`}else e.textContent=`Page ${h.pageNumber}/${_}`;else if(h.pageNumber)if(h.chunkKind==="section"){let t=h.chunkId?`Section ${h.chunkId}`:"Section";e.textContent=`${t} (p${h.pageNumber})`}else e.textContent=`Page ${h.pageNumber}`;else h.chunkId?e.textContent=`Section ${h.chunkId}`:e.textContent="Section";return h.excluded&&(e.textContent=`${e.textContent} - excluded`),e},ut=class extends ie.WidgetType{constructor(_,e,t,n,r){super(),this.plugin=_,this.docId=e,this.chunkId=t,this.startLine=n,this.excluded=r}eq(_){return this.docId===_.docId&&this.chunkId===_.chunkId&&this.startLine===_.startLine&&this.excluded===_.excluded}toDOM(){let _=document.createElement("span");_.className="zrr-chunk-toolbar",_.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},t=(c,d,u)=>{let p=document.createElement("span");p.className="zrr-chunk-button-icon",(0,Ot.setIcon)(p,d);let g=document.createElement("span");g.className="zrr-chunk-button-label",g.textContent=u,c.appendChild(p),c.appendChild(g)},n=document.createElement("button");n.type="button",n.className="zrr-chunk-button",t(n,"sparkles","Clean"),e(n,"Clean this chunk with the OCR cleanup model"),n.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),_.appendChild(n);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",t(r,"tag","Tags"),e(r,"Edit chunk tags"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),_.appendChild(r);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",t(i,"search","Indexed"),e(i,"Preview indexed chunk text"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),_.appendChild(i);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",t(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),_.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return t(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),_.appendChild(s),_}ignoreEvent(){return!0}},Lt=(h,_)=>{var b;let e=h.state.doc,t=$e(e);if(!t)return ie.Decoration.none;let n=h.state.selection.main.head,r=e.lineAt(n).number,i=Rt(e,r);if(!i)return ie.Decoration.none;let a=i.text.match(ge);if(!a)return ie.Decoration.none;let s=((b=a[1])!=null?b:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return ie.Decoration.none;let l=o[2].trim();if(!l)return ie.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=St(e,i.startLine+1,i.endLine-1),u=c||d,p=e.line(i.startLine),g=ie.Decoration.widget({widget:new ut(_,t,l,i.startLine,u),side:1});return ie.Decoration.set([g.range(p.to)])},_t=class extends ie.WidgetType{constructor(_,e){super(),this.info=_,this.totalPages=e}toDOM(){var _;return(_=wn(this.info,this.totalPages))!=null?_:document.createElement("span")}},Tt=h=>{var o,l;let _=h.dom.closest(".markdown-source-view");if(!_||!_.classList.contains("is-live-preview"))return ie.Decoration.none;let e=h.state.doc,t=new Dt.RangeSetBuilder,n=[],r=[],i=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),u=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!u)continue;let p=Et(u[1]);p&&(p.type==="chunk-start"?(p.chunkKind=(o=p.chunkKind)!=null?o:p.pageNumber?"page":"section",p.pageNumber&&(i=!0),p.chunkKind==="section"&&(a=!0)):p.type==="chunk-end"&&(p.chunkKind=(l=p.chunkKind)!=null?l:"section"),n.push({line:c,from:d.from,to:d.to,info:p}),p.pageNumber&&r.push(p.pageNumber))}if(!n.length)return ie.Decoration.none;if(i&&!a)for(let c of n)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=r.length?Math.max(...r):0;for(let c of n){let d=ie.Decoration.replace({widget:new _t(c.info,s)});t.add(c.from,c.to,d)}return t.finish()},It=()=>ie.ViewPlugin.fromClass(class{constructor(h){this.decorations=Tt(h)}update(h){(h.docChanged||h.viewportChanged)&&(this.decorations=Tt(h.view))}},{decorations:h=>h.decorations}),Ft=h=>ie.ViewPlugin.fromClass(class{constructor(_){this.decorations=Lt(_,h)}update(_){(_.docChanged||_.selectionSet||_.viewportChanged)&&(this.decorations=Lt(_.view,h))}},{decorations:_=>_.decorations});var ae=require("child_process"),Y=require("fs"),wt=me(require("http")),dn=me(require("https")),Ie=me(require("net")),Fe=me(require("os")),pn=me(require("tls")),R=me(require("path")),vt=require("url"),Me=require("crypto");var N=require("obsidian"),zt=require("crypto"),Ve=require("fs"),Ue=me(require("path")),re=".zotero-redisearch-rag",oe=`${re}/items`,ee=`${re}/chunks`,qt=`${re}/metadata_snapshots.json`,jt=`${re}/annotation_snapshots.json`,vn="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",Pe="cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",Ne="__custom__",Mt=[{value:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",label:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1 (Fast multilingual)"},{value:"BAAI/bge-reranker-v2-m3",label:"BAAI/bge-reranker-v2-m3 (Best quality, heaviest)"},{value:"jinaai/jina-reranker-v2-base-multilingual",label:"jinaai/jina-reranker-v2-base-multilingual (Balanced multilingual)"}],Be={pythonRuntime:"worker",pythonRuntimeMigrationV1Done:!1,showAdvancedPythonRuntimeOptions:!1,pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,firstContainerStartupNoticeShown:!1,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:Pe,rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${re}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Ze=class extends N.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async f=>{this.plugin.settings.llmProviderProfiles=f,await this.plugin.saveSettings()},r=f=>{f.inputEl.type="password",f.inputEl.autocomplete="off",f.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:f=>{new N.Setting(f).setName("Prerequisites").setHeading();let k=null,x=null,w=null,E=null,P=null,S=null,T=null,I=null,L=null,j=(z,$)=>{z&&(z.settingEl.classList.toggle("is-disabled",$),z.settingEl.classList.toggle("zrr-setting-disabled",$))},F=(z,$)=>{z&&z.settingEl.classList.toggle("zrr-setting-hidden",!$)},M=()=>{let z=!!this.plugin.settings.showAdvancedPythonRuntimeOptions,$=this.plugin.settings.pythonRuntime==="local",B=z&&$;x==null||x.setDisabled(!z),j(k,!z),F(w,z),F(E,z),F(P,z),S==null||S.setDisabled(!B),T==null||T.setDisabled(!B),L==null||L.setDisabled(!B),I&&(I.disabled=!B),j(w,!B),j(E,!B),j(P,!B)};new N.Setting(f).setName("Docker/podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(z=>z.setPlaceholder("Docker").setValue(this.plugin.settings.dockerPath).onChange(async $=>{this.plugin.settings.dockerPath=$.trim()||"docker",await this.plugin.saveSettings()})),new N.Setting(f).setName("Advanced python runtime options").setDesc("Show legacy local interpreter/venv controls. Recommended to keep this disabled.").addToggle(z=>z.setValue(this.plugin.settings.showAdvancedPythonRuntimeOptions).onChange(async $=>{this.plugin.settings.showAdvancedPythonRuntimeOptions=$,!$&&this.plugin.settings.pythonRuntime==="local"&&(this.plugin.settings.pythonRuntime="worker",new N.Notice("Switched python runtime to worker mode.")),await this.plugin.saveSettings(),M()})),k=new N.Setting(f).setName("Python runtime").setDesc("Worker runtime is recommended. Enable advanced options to expose local interpreter/venv mode.").addDropdown(z=>{x=z,z.addOption("worker","Python worker container (recommended)"),z.addOption("local","Local interpreter/venv"),z.setValue(this.plugin.settings.pythonRuntime).onChange(async $=>{$!=="worker"&&$!=="local"||(this.plugin.settings.pythonRuntime=$,await this.plugin.saveSettings(),M())})}),w=new N.Setting(f).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(z=>(S=z,z.setPlaceholder("Auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async $=>{this.plugin.settings.pythonPath=$.trim(),await this.plugin.saveSettings()}))),E=new N.Setting(f).setName("Python environment").setDesc("Local mode: create or update the plugin's python env. Worker mode: managed by docker startup.").addButton(z=>{L=z,I=z.buttonEl,z.setButtonText("Create/update").setCta(),z.onClick(async()=>{z.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{z.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),P=new N.Setting(f).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(z=>{T=z,z.addOption("shared","Shared user cache"),z.addOption("plugin","Plugin folder (.venv)"),z.setValue(this.plugin.settings.pythonEnvLocation).onChange(async $=>{$!=="shared"&&$!=="plugin"||(this.plugin.settings.pythonEnvLocation=$,await this.plugin.saveSettings())})}),M(),new N.Setting(f).setName("Redis URL").addText(z=>z.setPlaceholder("Redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async $=>{this.plugin.settings.redisUrl=$.trim(),await this.plugin.saveSettings()}));let V=null,O=null,Z=null,q=null,W=()=>{let z=this.plugin.settings.autoAssignRedisPort;Z==null||Z.setDisabled(z),q==null||q.setDisabled(z),V==null||V.settingEl.classList.toggle("is-disabled",z),O==null||O.settingEl.classList.toggle("is-disabled",z)};new N.Setting(f).setName("Auto-assign redis port").setDesc("When starting redis stack, pick a free local port and update the redis URL.").addToggle(z=>z.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async $=>{this.plugin.settings.autoAssignRedisPort=$,await this.plugin.saveSettings(),W()})),V=new N.Setting(f).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(z=>(Z=z,z.setPlaceholder("~/redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async $=>{this.plugin.settings.redisDataDirOverride=$.trim(),await this.plugin.saveSettings()}))),V.settingEl.addClass("zrr-redis-override-setting"),O=new N.Setting(f).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(z=>(q=z,z.setPlaceholder("Zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async $=>{this.plugin.settings.redisProjectName=$.trim(),await this.plugin.saveSettings()}))),O.settingEl.addClass("zrr-redis-override-setting"),W(),new N.Setting(f).setName("Auto-start redis stack (docker/podman compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(z=>z.setValue(this.plugin.settings.autoStartRedis).onChange(async $=>{this.plugin.settings.autoStartRedis=$,await this.plugin.saveSettings()})),new N.Setting(f).setName("Start redis stack now").setDesc("Starts or restarts redis stack (and python worker in worker mode).").addButton(z=>z.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:f=>{new N.Setting(f).setName("Zotero local API").setHeading(),new N.Setting(f).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. HTTP://127.0.0.1:23119/API").addText(P=>P.setPlaceholder("HTTP://127.0.0.1:23119/API").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async S=>{this.plugin.settings.zoteroBaseUrl=S.trim(),await this.plugin.saveSettings()}));let k=new N.Setting(f).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),x=null,w=P=>{if(!x)return;let S=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(P.map(I=>I.value)).has(S)||(P=P.concat([{value:S,label:`Custom (${S})`}])),x.selectEl.options.length=0;for(let I of P)x.addOption(I.value,I.label);x.setValue(S)},E=async()=>{if(x){x.setDisabled(!0);try{let P=await this.plugin.fetchZoteroLibraryOptions();w(P)}finally{x.setDisabled(!1)}}};k.addDropdown(P=>{x=P;let S=(this.plugin.settings.zoteroUserId||"0").trim()||"0";P.addOption(S,"Loading..."),P.setValue(S),P.onChange(async T=>{this.plugin.settings.zoteroUserId=T.trim(),await this.plugin.saveSettings()})}),k.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await E()})}),E(),new N.Setting(f).setName("Zotero web API").setHeading(),new N.Setting(f).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(P=>P.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async S=>{this.plugin.settings.webApiBaseUrl=S.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Web API library type").setDesc("Library type for web API writes.").addDropdown(P=>P.addOption("user","User").addOption("group","Group").setValue(this.plugin.settings.webApiLibraryType).onChange(async S=>{this.plugin.settings.webApiLibraryType=S,await this.plugin.saveSettings()})),new N.Setting(f).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for web API writes.").addText(P=>P.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async S=>{this.plugin.settings.webApiLibraryId=S.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Web API key").setDesc("Zotero API key for write fallback (from Zotero.org).").addText(P=>{r(P),P.setPlaceholder("Your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async S=>{this.plugin.settings.webApiKey=S.trim(),await this.plugin.saveSettings()})}),new N.Setting(f).setName("Output").setHeading(),new N.Setting(f).setName("PDF folder").addText(P=>P.setPlaceholder("Zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async S=>{this.plugin.settings.outputPdfDir=S.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Notes folder").addText(P=>P.setPlaceholder("Zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async S=>{this.plugin.settings.outputNoteDir=S.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(P=>{P.setValue(this.plugin.settings.frontmatterTemplate).onChange(async S=>{this.plugin.settings.frontmatterTemplate=S,await this.plugin.saveSettings()}),P.inputEl.rows=10,P.inputEl.addClass("zrr-u-width-100")}),new N.Setting(f).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(P=>P.addOption("none","No change").addOption("camel","Camelcase").addOption("pascal","Pascalcase").addOption("snake","Snake_case").addOption("kebab","Kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async S=>{this.plugin.settings.tagSanitizeMode=S,await this.plugin.saveSettings()})),new N.Setting(f).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(P=>{P.setValue(this.plugin.settings.noteBodyTemplate).onChange(async S=>{this.plugin.settings.noteBodyTemplate=S,await this.plugin.saveSettings()}),P.inputEl.rows=8,P.inputEl.addClass("zrr-u-width-100")}),new N.Setting(f).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(P=>P.setPlaceholder("Zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async S=>{this.plugin.settings.chatOutputDir=S.trim()||"zotero/chats",await this.plugin.saveSettings()})),new N.Setting(f).setName("Copy pdfs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(P=>P.setValue(this.plugin.settings.copyPdfToVault).onChange(async S=>{this.plugin.settings.copyPdfToVault=S,!S&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new N.Setting(f).setName("Create ocr-layered PDF copy").setDesc("When ocr is used, replace the vault PDF with a tesseract text layer (requires copy pdfs into vault).").addToggle(P=>{let S=this.plugin.settings.copyPdfToVault;P.setValue(S?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!S).onChange(async T=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=T,await this.plugin.saveSettings()})}),new N.Setting(f).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(P=>P.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async S=>{this.plugin.settings.preferObsidianNoteForCitations=S,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:f=>{new N.Setting(f).setName("Annotations").setHeading(),new N.Setting(f).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(E=>E.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async P=>{this.plugin.settings.annotationPageLabel=P.trim()||"Page",await this.plugin.saveSettings()})),new N.Setting(f).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(E=>E.setValue(this.plugin.settings.includeAnnotationImages).onChange(async P=>{this.plugin.settings.includeAnnotationImages=P,await this.plugin.saveSettings()})),new N.Setting(f).setName("Zotero companion").setHeading(),f.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new N.Setting(f).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(E=>E.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async P=>{this.plugin.settings.zoteroCompanionEnabled=P,await this.plugin.saveSettings()})),new N.Setting(f).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(E=>E.setPlaceholder("HTTP://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async P=>{this.plugin.settings.zoteroCompanionBaseUrl=P.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(E=>{r(E),this.companionTokenInput=E,E.setPlaceholder("Optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async P=>{this.plugin.settings.zoteroCompanionToken=P.trim(),await this.plugin.saveSettings()})}),new N.Setting(f).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero companion plugin token to this value.").addButton(E=>E.setButtonText("Generate token").onClick(async()=>{let P=(0,zt.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=P,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(P);try{await navigator.clipboard.writeText(P),new N.Notice("Generated and copied companion token.")}catch(S){new N.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",S)}})),new N.Setting(f).setName("Annotation color map").setHeading(),f.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let k=f.createDiv({cls:"zrr-annotation-map"}),x=async E=>{this.plugin.settings.annotationColorMap=E,await this.plugin.saveSettings()},w=()=>{var L,j;k.empty();let E=this.plugin.settings.annotationColorMap||{},P=Object.entries(E);if(P.length||k.createEl("p",{text:"No color mappings configured."}),P.length){let F=k.createDiv({cls:"zrr-annotation-map-row-header"});F.createEl("span",{text:"Color"}),F.createEl("span",{text:"Heading"}),F.createEl("span",{text:"Callout"}),F.createEl("span")}for(let[F,M]of P){let O=k.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),Z=O.createEl("input",{type:"text",value:F,cls:"zrr-annotation-map-input"}),q=O.createEl("input",{type:"text",value:(L=M.heading)!=null?L:"",cls:"zrr-annotation-map-input"}),W=O.createEl("input",{type:"text",value:(j=M.callout)!=null?j:"",cls:"zrr-annotation-map-input"}),z=O.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});z.type="button",Z.addEventListener("change",async()=>{let $=Z.value.trim().toLowerCase();if(!$){Z.value=F;return}let B={...this.plugin.settings.annotationColorMap||{}};if($!==F&&B[$]){new N.Notice(`Annotation color '${$}' already exists.`),Z.value=F;return}let U=B[F];delete B[F],B[$]=U!=null?U:{heading:"",callout:""},await x(B),w()}),q.addEventListener("change",async()=>{var U;let $={...this.plugin.settings.annotationColorMap||{}},B=(U=$[F])!=null?U:{heading:"",callout:""};B.heading=q.value.trim(),$[F]=B,await x($)}),W.addEventListener("change",async()=>{var U;let $={...this.plugin.settings.annotationColorMap||{}},B=(U=$[F])!=null?U:{heading:"",callout:""};B.callout=W.value.trim(),$[F]=B,await x($)}),z.addEventListener("click",async()=>{let $={...this.plugin.settings.annotationColorMap||{}};delete $[F],await x($),w()})}let S=k.createDiv({cls:"zrr-annotation-map-actions"}),T=S.createEl("button",{text:"Add mapping"});T.type="button",T.addEventListener("click",async()=>{let F={...this.plugin.settings.annotationColorMap||{}},M="new-color",V=1;for(;F[M];)M=`new-color-${V}`,V+=1;F[M]={heading:"",callout:""},await x(F),w()});let I=S.createEl("button",{text:"Reset to defaults"});I.type="button",I.addEventListener("click",async()=>{await x({...Be.annotationColorMap}),w()})};w()}},{id:"ocr",label:"OCR",render:f=>{new N.Setting(f).setName("Docling").setHeading();let k=null,x=S=>{if(!k)return;let T=this.plugin.settings.ocrEngine;new Set(S.map(L=>L.value)).has(T)||(S=S.concat([{value:T,label:`Current (unavailable): ${T}`}])),k.selectEl.options.length=0;for(let L of S)k.addOption(L.value,L.label);k.setValue(T)},w=async()=>{if(!k)return;k.setDisabled(!0);let S={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{S=await this.plugin.detectOcrEngines()}catch(L){S={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let T=[{value:"auto",label:"Auto (default)"}];S.tesseract&&T.push({value:"tesseract",label:"Tesseract (local)"}),S.paddleStructureLocal&&T.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),S.paddleVlLocal&&T.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(T.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),T.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),x(T),k.setDisabled(!1)},E=new N.Setting(f).setName("Paddle ocr API key").setDesc("API token for paddleocr-vl / pp-structurev3 endpoints. Get a free API key at "),P=document.createElement("a");P.href="https://aistudio.baidu.com/paddleocr",P.textContent="HTTPS://aistudio.baidu.com/paddleocr",P.target="_blank",P.rel="noopener noreferrer",E.descEl.appendChild(P),E.descEl.append("."),E.addText(S=>{r(S),S.setPlaceholder("Your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async T=>{this.plugin.settings.paddleApiKey=T.trim(),await this.plugin.saveSettings(),await w()})}),new N.Setting(f).setName("Paddleocr-vl API URL").setDesc("Optional override for the paddleocr-vl API endpoint.").addText(S=>S.setPlaceholder("HTTPS://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async T=>{this.plugin.settings.paddleVlApiUrl=T.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Pp-structurev3 API URL").setDesc("API endpoint for pp-structurev3 (see baidu AI studio docs).").addText(S=>S.setPlaceholder("HTTPS://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async T=>{this.plugin.settings.paddleStructureApiUrl=T.trim(),await this.plugin.saveSettings(),await w()})),new N.Setting(f).setName("Ocr engine").setDesc("Select the ocr engine to use when ocr is required.").addDropdown(S=>{k=S,S.addOption("auto","Auto (default)"),S.setValue(this.plugin.settings.ocrEngine),S.onChange(async T=>{this.plugin.settings.ocrEngine=T,await this.plugin.saveSettings()})}),new N.Setting(f).setName("Ocr decision (when to ocr)").setDesc("Controls when ocr runs; per-page behavior is configured separately below.").addDropdown(S=>S.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","Ocr only if text is poor").addOption("force","Prefer ocr for full document").setValue(this.plugin.settings.ocrMode).onChange(async T=>{this.plugin.settings.ocrMode=T,await this.plugin.saveSettings()})),new N.Setting(f).setName("Ocr layout override (per-page)").setDesc("Force per-page ocr when ocr runs, bypassing layout heuristics; can be slower for multi-column pdfs.").addToggle(S=>S.setValue(this.plugin.settings.forcePerPageOcr).onChange(async T=>{this.plugin.settings.forcePerPageOcr=T,await this.plugin.saveSettings()})),new N.Setting(f).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(S=>{S.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async T=>{this.plugin.settings.ocrQualityThreshold=T,await this.plugin.saveSettings()})}),new N.Setting(f).setName("Chunking").setDesc("Page or section").addDropdown(S=>S.addOption("page","Page").addOption("section","Section").setValue(this.plugin.settings.chunkingMode).onChange(async T=>{this.plugin.settings.chunkingMode=T,await this.plugin.saveSettings()})),w()}},{id:"llms",label:"LLMs",render:f=>{new N.Setting(f).setName("LLM provider profiles").setHeading();let k=f.createDiv({cls:"zrr-llm-profiles"}),x=()=>{k.empty();let C=t();C.length||k.createEl("p",{text:"No profiles yet. Add one below."});for(let A of C){let D=k.createEl("details",{cls:"zrr-profile"});C.length===1&&(D.open=!0);let ne=D.createEl("summary",{text:A.name||A.id||"Profile"});ne.addClass("zrr-profile-title");let ze=D.createDiv({cls:"zrr-profile-body"});new N.Setting(ze).setName("Profile name").addText(_e=>_e.setPlaceholder("My provider").setValue(A.name||"").onChange(async fe=>{A.name=fe.trim(),ne.textContent=A.name||A.id||"Profile",await n(t())})),new N.Setting(ze).setName("Base URL").addText(_e=>_e.setPlaceholder("HTTP://localhost:1234/v1").setValue(A.baseUrl||"").onChange(async fe=>{A.baseUrl=fe.trim(),await n(t())})),new N.Setting(ze).setName("API key").setDesc("Stored in settings (not encrypted).").addText(_e=>{r(_e),_e.setPlaceholder("Sk-...").setValue(A.apiKey||"").onChange(async fe=>{A.apiKey=fe.trim(),await n(t())})}),new N.Setting(ze).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(_e=>_e.setButtonText("Delete profile").onClick(async()=>{let fe=t().filter(un=>un.id!==A.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===A.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===A.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===A.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(fe),x()}))}new N.Setting(k).addButton(A=>A.setButtonText("Add profile").onClick(async()=>{let D=`profile-${Date.now().toString(36)}`,ne=t().concat([{id:D,name:"Custom",baseUrl:"",apiKey:""}]);await n(ne),x()}))};x(),new N.Setting(f).setName("Ocr cleanup").setHeading(),new N.Setting(f).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor ocr at import. Can be slow/costly.").addToggle(C=>C.setValue(this.plugin.settings.enableLlmCleanup).onChange(async A=>{this.plugin.settings.enableLlmCleanup=A,await this.plugin.saveSettings()}));let w=null,E=null,P=null,S=async()=>{},T=async(C,A=!0)=>{let D=C.trim();this.plugin.settings.llmCleanupBaseUrl=D,A&&(this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom")),E&&E.setValue(D),await this.plugin.saveSettings()},I=async C=>{let A=t().find(D=>D.id===C);this.plugin.settings.llmCleanupProviderProfileId=C,A&&(this.plugin.settings.llmCleanupBaseUrl=A.baseUrl,this.plugin.settings.llmCleanupApiKey=A.apiKey,E==null||E.setValue(A.baseUrl),P==null||P.setValue(A.apiKey)),await this.plugin.saveSettings(),await S()};new N.Setting(f).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{w=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let A=this.plugin.settings.llmCleanupProviderProfileId;C.setValue(A&&t().some(D=>D.id===A)?A:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await I(D)})}),new N.Setting(f).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. HTTP://127.0.0.1:1234/v1").addText(C=>{E=C,C.setPlaceholder("HTTP://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async A=>{await T(A)})}),new N.Setting(f).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(C=>{P=C,r(C),C.setPlaceholder("Sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async A=>{this.plugin.settings.llmCleanupApiKey=A.trim(),this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom"),await this.plugin.saveSettings()})});let L=new N.Setting(f).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),j=null,F=C=>{if(!j)return;let A=(this.plugin.settings.llmCleanupModel||"").trim(),D=new Set(C.map(ne=>ne.value));A&&!D.has(A)&&(C=C.concat([{value:A,label:`Custom (${A})`}])),j.selectEl.options.length=0;for(let ne of C)j.addOption(ne.value,ne.label);A&&j.setValue(A)};S=async()=>{if(j){j.setDisabled(!0);try{let C=await this.plugin.fetchCleanupModelOptions();F(C)}finally{j.setDisabled(!1)}}},L.addDropdown(C=>{j=C;let A=(this.plugin.settings.llmCleanupModel||"").trim();C.addOption(A||"loading","Loading..."),C.setValue(A||"loading"),C.onChange(async D=>{this.plugin.settings.llmCleanupModel=D.trim(),await this.plugin.saveSettings()})}),L.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),new N.Setting(f).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(C=>C.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async A=>{let D=Number.parseFloat(A);this.plugin.settings.llmCleanupTemperature=Number.isFinite(D)?D:0,await this.plugin.saveSettings()})),new N.Setting(f).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(C=>C.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async A=>{this.plugin.settings.llmCleanupMinQuality=A,await this.plugin.saveSettings()})),new N.Setting(f).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(C=>C.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(D)?D:2e3,await this.plugin.saveSettings()})),new N.Setting(f).setName("Text embedding").setHeading();let M=null,V=null,O=null,Z=async()=>{},q=async(C,A=!0)=>{let D=C.trim();this.plugin.settings.embedBaseUrl=D,A&&(this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom")),V&&V.setValue(D),await this.plugin.saveSettings()},W=async C=>{let A=t().find(D=>D.id===C);this.plugin.settings.embedProviderProfileId=C,A&&(this.plugin.settings.embedBaseUrl=A.baseUrl,this.plugin.settings.embedApiKey=A.apiKey,V==null||V.setValue(A.baseUrl),O==null||O.setValue(A.apiKey)),await this.plugin.saveSettings(),await Z()};new N.Setting(f).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{M=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let A=this.plugin.settings.embedProviderProfileId;C.setValue(A&&t().some(D=>D.id===A)?A:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await W(D)})}),new N.Setting(f).setName("Embeddings base URL").addText(C=>{V=C,C.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async A=>{await q(A)})}),new N.Setting(f).setName("Embeddings API key").addText(C=>{O=C,r(C),C.setPlaceholder("Lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async A=>{this.plugin.settings.embedApiKey=A.trim(),this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom"),await this.plugin.saveSettings()})});let z=new N.Setting(f).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),$=null,B=C=>{if(!$)return;let A=(this.plugin.settings.embedModel||"").trim(),D=new Set(C.map(ne=>ne.value));A&&!D.has(A)&&(C=C.concat([{value:A,label:`Custom (${A})`}])),$.selectEl.options.length=0;for(let ne of C)$.addOption(ne.value,ne.label);A&&$.setValue(A)};Z=async()=>{if($){$.setDisabled(!0);try{let C=await this.plugin.fetchEmbeddingModelOptions();B(C)}finally{$.setDisabled(!1)}}},z.addDropdown(C=>{$=C;let A=(this.plugin.settings.embedModel||"").trim();C.addOption(A||"loading","Loading..."),C.setValue(A||"loading"),C.onChange(async D=>{this.plugin.settings.embedModel=D.trim(),await this.plugin.saveSettings()})}),z.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await Z()})}),Z(),new N.Setting(f).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(C=>C.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async A=>{this.plugin.settings.embedIncludeMetadata=A,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(C=>C.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedContextWindow=Number.isFinite(D)?Math.max(0,D):1,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(C=>C.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedContextChars=Number.isFinite(D)?Math.max(0,D):220,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(C=>C.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(D)?Math.max(0,D):3500,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(C=>C.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(D)?Math.max(0,D):200,await this.plugin.saveSettings()})),new N.Setting(f).setName("Generate LLM tags for chunks").setDesc("Use the ocr cleanup model to tag chunks before indexing.").addToggle(C=>C.setValue(this.plugin.settings.enableChunkTagging).onChange(async A=>{this.plugin.settings.enableChunkTagging=A,await this.plugin.saveSettings()})),new N.Setting(f).setName("Chat LLM").setHeading();let U=null,H=null,te=null,ue=async()=>{},ke=async(C,A=!0)=>{let D=C.trim();this.plugin.settings.chatBaseUrl=D,A&&(this.plugin.settings.chatProviderProfileId="",U&&U.setValue("custom")),H&&H.setValue(D),await this.plugin.saveSettings()},we=async C=>{let A=t().find(D=>D.id===C);this.plugin.settings.chatProviderProfileId=C,A&&(this.plugin.settings.chatBaseUrl=A.baseUrl,this.plugin.settings.chatApiKey=A.apiKey,H==null||H.setValue(A.baseUrl),te==null||te.setValue(A.apiKey)),await this.plugin.saveSettings(),await ue()};new N.Setting(f).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{U=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let A=this.plugin.settings.chatProviderProfileId;C.setValue(A&&t().some(D=>D.id===A)?A:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await we(D)})}),new N.Setting(f).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(C=>{H=C,C.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async A=>{await ke(A)})}),new N.Setting(f).setName("Chat API key").addText(C=>{te=C,r(C),C.setPlaceholder("Lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async A=>{this.plugin.settings.chatApiKey=A.trim(),this.plugin.settings.chatProviderProfileId="",U&&U.setValue("custom"),await this.plugin.saveSettings()})});let he=new N.Setting(f).setName("Chat model").setDesc("Select a chat-capable model from the provider."),le=null,ct=C=>{if(!le)return;let A=(this.plugin.settings.chatModel||"").trim(),D=new Set(C.map(ne=>ne.value));A&&!D.has(A)&&(C=C.concat([{value:A,label:`Custom (${A})`}])),le.selectEl.options.length=0;for(let ne of C)le.addOption(ne.value,ne.label);A&&le.setValue(A)};ue=async()=>{if(le){le.setDisabled(!0);try{let C=await this.plugin.fetchChatModelOptions();ct(C)}finally{le.setDisabled(!1)}}},he.addDropdown(C=>{le=C;let A=(this.plugin.settings.chatModel||"").trim();C.addOption(A||"loading","Loading..."),C.setValue(A||"loading"),C.onChange(async D=>{this.plugin.settings.chatModel=D.trim(),await this.plugin.saveSettings()})}),he.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await ue()})}),ue(),new N.Setting(f).setName("Temperature").addText(C=>C.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async A=>{let D=Number.parseFloat(A);this.plugin.settings.chatTemperature=Number.isFinite(D)?D:.2,await this.plugin.saveSettings()})),new N.Setting(f).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(C=>C.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(D)?Math.max(0,D):6,await this.plugin.saveSettings()})),new N.Setting(f).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(C=>C.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async A=>{this.plugin.settings.chatPaneLocation=A,await this.plugin.saveSettings()})),new N.Setting(f).setName("Retrieval").setHeading(),new N.Setting(f).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(C=>C.setValue(this.plugin.settings.enableAgenticRag).onChange(async A=>{this.plugin.settings.enableAgenticRag=A,await this.plugin.saveSettings()})),new N.Setting(f).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(C=>C.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.agenticMaxIters=Number.isFinite(D)?Math.max(1,D):2,await this.plugin.saveSettings()})),new N.Setting(f).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(C=>C.setValue(this.plugin.settings.enableQueryExpansion).onChange(async A=>{this.plugin.settings.enableQueryExpansion=A,await this.plugin.saveSettings()})),new N.Setting(f).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(C=>C.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.queryExpansionCount=Number.isFinite(D)?Math.max(1,D):3,await this.plugin.saveSettings()})),new N.Setting(f).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(C=>C.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async A=>{this.plugin.settings.enableCrossEncoderRerank=A,await this.plugin.saveSettings()}));let J=new Set(Mt.map(C=>C.value)),X=(this.plugin.settings.rerankModel||"").trim()||Pe,pe=J.has(X)?X:Ne,se=null,Pt=()=>{if(!se)return;let A=!(pe===Ne);se.setDisabled(A),se.inputEl.disabled=A,se.inputEl.readOnly=A,se.inputEl.classList.toggle("is-disabled",A),se.inputEl.setAttribute("aria-disabled",String(A))},Ct=new N.Setting(f).setName("Cross-encoder model").setDesc("Choose a multilingual preset, or select custom to edit the model ID.");Ct.addDropdown(C=>{for(let A of Mt)C.addOption(A.value,A.label);C.addOption(Ne,"Custom"),C.setValue(pe),C.onChange(async A=>{pe=A,A!==Ne?this.plugin.settings.rerankModel=A:(this.plugin.settings.rerankModel||"").trim()||(this.plugin.settings.rerankModel=Pe),await this.plugin.saveSettings(),se==null||se.setValue(this.plugin.settings.rerankModel||Pe),Pt()})}),Ct.addText(C=>{se=C,C.setPlaceholder(Pe).setValue(X).onChange(async A=>{pe===Ne&&(this.plugin.settings.rerankModel=A.trim()||Pe,await this.plugin.saveSettings())}),Pt()}),new N.Setting(f).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 n candidates before reranking.").addText(C=>C.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(D)?Math.max(1,D):4,await this.plugin.saveSettings()})),new N.Setting(f).setName("Rrf k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(C=>C.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rrfK=Number.isFinite(D)?Math.max(1,D):60,await this.plugin.saveSettings()})),new N.Setting(f).setName("Rrf log top n").setDesc("Log the top n rrf-ranked chunks to stderr (0 disables).").addText(C=>C.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rrfLogTop=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()})),new N.Setting(f).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(C=>C.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:f=>{new N.Setting(f).setName("Python runtime").setHeading(),new N.Setting(f).setName("Use local runtime (legacy)").setDesc("Switch to local interpreter/venv mode and enable advanced runtime settings.").addButton(k=>k.setButtonText("Switch").onClick(async()=>{await this.plugin.switchPythonRuntimeToLocalLegacy()})),new N.Setting(f).setName("Logging").setHeading(),new N.Setting(f).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(k=>k.setValue(this.plugin.settings.enableFileLogging).onChange(async x=>{this.plugin.settings.enableFileLogging=x,await this.plugin.saveSettings()})),new N.Setting(f).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(k=>k.setPlaceholder(`${re}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async x=>{this.plugin.settings.logFilePath=x.trim()||`${re}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new N.Setting(f).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(k=>k.setButtonText("Open log").onClick(async()=>{var x,w;await((w=(x=this.plugin).openLogFile)==null?void 0:w.call(x))})).addButton(k=>k.setButtonText("Clear log").onClick(async()=>{var x,w;await((w=(x=this.plugin).clearLogFile)==null?void 0:w.call(x))})),new N.Setting(f).setName("Zotero companion plugin").setHeading(),f.createEl("p",{text:"Download the xpi, then in Zotero go to tools \u2192 add-ons \u2192 install from file and restart."}),new N.Setting(f).setName("Download companion add-on").setDesc("Downloads the companion xpi to your system downloads folder.").addButton(k=>k.setButtonText("Download xpi").onClick(async()=>{let x=this.getDefaultDownloadDir();if(!x){new N.Notice("Unable to resolve the system downloads folder.");return}let w=Ue.default.join(x,"zrr-companion.xpi");if(await this.companionXpiExists(w)){new N.Notice(`Companion XPI already exists: ${w}`);return}new N.Notice("Downloading companion xpi..."),await this.downloadCompanionXpi(w)})),new N.Setting(f).setName("Open Zotero").setDesc("Launch Zotero and open the add-ons window (tools \u2192 add-ons).").addButton(k=>k.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new N.Setting(f).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(k=>k.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),new N.Setting(f).setName("Redis indexing").setHeading(),new N.Setting(f).setName("Reindex redis from cached chunks").setDesc("Rebuild the redis index from cached chunk JSON files.").addButton(k=>k.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new N.Setting(f).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(k=>k.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(k=>k.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()})),new N.Setting(f).setName("Release notes").setHeading(),new N.Setting(f).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(k=>k.setButtonText("Show").onClick(()=>{this.plugin.openReleaseNotesModal()}))}}],u=new Map,p=new Map,g=f=>{this.activeTab=f;for(let[k,x]of u){let w=k===f;x.classList.toggle("is-active",w),x.setAttribute("aria-selected",w?"true":"false"),x.setAttribute("tabindex",w?"0":"-1")}for(let[k,x]of p){let w=k===f;x.classList.toggle("is-active",w),x.hidden=!w}},b=e.createDiv({cls:"zrr-settings-tabs"});b.setAttribute("role","tablist");let y=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let f of d){let k=b.createEl("button",{text:f.label,cls:"zrr-settings-tab-button"}),x=`zrr-settings-tab-${f.id}`,w=`zrr-settings-panel-${f.id}`;k.type="button",k.id=x,k.setAttribute("role","tab"),k.setAttribute("aria-controls",w),k.setAttribute("aria-selected","false"),k.addEventListener("click",()=>g(f.id));let E=y.createDiv({cls:"zrr-settings-tab-panel"});E.id=w,E.setAttribute("role","tabpanel"),E.setAttribute("aria-labelledby",x),E.hidden=!0,f.render(E),u.set(f.id,k),p.set(f.id,E)}let v=d.some(f=>f.id===this.activeTab)?this.activeTab:d[0].id;g(v)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Ue.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await Ve.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await Ve.promises.mkdir(Ue.default.dirname(e),{recursive:!0});let t=await(0,N.requestUrl)({url:vn,method:"GET"});if(t.status!==200){new N.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await Ve.promises.writeFile(e,n),new N.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new N.Notice("Failed to download companion xpi. See console for details."),console.warn("Failed to download companion XPI",t)}}};var $t=require("@codemirror/state"),Vt=require("@codemirror/view"),de=require("obsidian");var Pn=h=>{let _=h.scrollDOM.getBoundingClientRect(),e=h.posAtCoords({x:_.left+8,y:+_.height*.25});return e===null?null:h.state.doc.lineAt(e).number},Ge=class{constructor(_,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=_,this.helpers=e}createSyncExtension(){let _=this.helpers,e=this.syncPdfSidebarForDoc.bind(this);return Vt.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=_.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=_.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var u,p;let r=this.docId;if(!r)return;let i=Pn(t);if(i===null)return;let a=_.findChunkStartLineInDoc(t.state.doc,i);if(!a)return;let s=_.parseChunkMarkerLine(a.text),o=(u=s==null?void 0:s.pageNumber)!=null?u:null,l=(p=s==null?void 0:s.chunkId)!=null?p:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||d)||(this.lastPage=o,this.lastChunkId=l,e(r,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,t;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((t=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:t.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let _=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(_.docId,_.pageNumber,_.chunkId)}updatePreviewScrollHandler(){var n;let _=this.deps.app.workspace.getActiveViewOfType(de.MarkdownView);if(!_||_.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=_.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(_);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(_)}async syncPdfSidebarForFile(_){try{let e=await this.deps.app.vault.read(_),t=await this.deps.resolveDocIdForNote(_,e);if(!t)return;let n=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(t,n==null?void 0:n.pageNumber,n==null?void 0:n.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(_,e,t){if(_){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:_,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let n=await this.deps.getDocIndexEntry(_);n||(n=await this.deps.hydrateDocIndexFromCache(_));let r=n!=null&&n.pdf_path?String(n.pdf_path):"";if(!r)return;let i=this.deps.toVaultRelativePath(r);if(!i){let d=(0,de.normalizePath)(r);this.deps.app.vault.getAbstractFileByPath(d)instanceof de.TFile&&(i=d)}if(!i)return;let a=this.deps.app.vault.getAbstractFileByPath(i);if(!(a instanceof de.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:t};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:t};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&t&&(o=await this.resolvePageNumberForChunk(_,t)),o===null||this.pdfSidebarDocId===_&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=_,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=i,c=o!==null?`${l}#page=${o}`:l;await this.openPdfLinkInLeaf(s,c),this.updatePdfSidebarIcon(s)}finally{this.pdfSyncInFlight=!1;let n=this.queuedPdfSync;this.queuedPdfSync=null,n&&this.syncPdfSidebarForDoc(n.docId,n.pageNumber,n.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(_){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(_)}))}syncPdfSidebarForPreview(_){let e=this.previewScrollEl;if(!e)return;let t=_.getViewData();if(!t)return;let n=$t.Text.of(t.split(/\r?\n/)),r=this.helpers.extractDocIdFromDoc(n);if(!r)return;let i=this.getPreviewTopLineNumber(e);if(i===null)return;let a=this.helpers.findChunkStartLineInDoc(n,i+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(r,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(_){var n;let e=_.getBoundingClientRect().top,t=_.querySelectorAll("[data-line]");for(let r of Array.from(t))if(r.getBoundingClientRect().bottom>=e+2){let a=(n=r.getAttribute("data-line"))!=null?n:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var n,r;if(this.pdfSidebarLeaf&&((r=(n=this.pdfSidebarLeaf.view)==null?void 0:n.getViewType)==null?void 0:r.call(n))==="pdf")return this.pdfSidebarLeaf;let _=this.deps.app.workspace;if(typeof _.ensureSideLeaf=="function")try{let i=await _.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(i)?(this.pdfSidebarLeaf=i,this.updatePdfSidebarIcon(i),i):null}catch(i){console.warn("Failed to ensure PDF side leaf",i)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let t=this.deps.app.workspace.getRightLeaf(!0);return t&&this.isRightSidebarLeaf(t)?(this.pdfSidebarLeaf=t,this.updatePdfSidebarIcon(t),t):null}isRightSidebarLeaf(_){if(!_)return!1;let t=_.containerEl;return!!(t!=null&&t.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(_){if(!_||!this.isRightSidebarLeaf(_))return;let t=_.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let r=_;if(r.tabHeaderEl&&n.push(...Array.from(r.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),r.tabHeaderInnerIconEl&&n.push(r.tabHeaderInnerIconEl),n.length===0)return;let i=new Set;for(let s of n)if(!i.has(s)){if(i.add(s),s.replaceChildren(),(0,de.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg){let o=document.createRange().createContextualFragment(this.deps.iconSvg);s.replaceChildren(o)}s.dataset&&(s.dataset.zrrIcon="zrr-pdf")}let a=_.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(_,e){var i,a,s;let t=(i=this.getPluginsRegistry())==null?void 0:i["pdf-plus"],n=(s=(a=t==null?void 0:t.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof n=="function")try{await n.call(t.lib.workspace,_,e,"",{active:!1});return}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150)}let r=_;if(typeof r.openLinkText=="function"){try{await r.openLinkText(e,"",{active:!1})}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150),await r.openLinkText(e,"",{active:!1})}return}await this.deps.app.workspace.openLinkText(e,"",!1)}isPdfAnnotationRaceError(_){let e=_ instanceof Error?_.message:String(_!=null?_:"");return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(_){return new Promise(e=>setTimeout(e,_))}getPluginsRegistry(){var _;return(_=this.deps.app.plugins)==null?void 0:_.plugins}isLeafTabActive(_){var r;let e=_;if((r=e.parent)!=null&&r.activeLeaf)return e.parent.activeLeaf===_;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(_,e){var l,c,d,u,p;if(!_||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,_)||e,n=this.chunkPageCache.get(_);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let r=(0,de.normalizePath)(`${ee}/${_}.json`);if(!await this.deps.app.vault.adapter.exists(r))return null;let a=await this.deps.readChunkPayload(r),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let g of s){let b=typeof(g==null?void 0:g.chunk_id)=="string"?g.chunk_id.trim():"";if(!b)continue;let y=Number.isFinite((c=g==null?void 0:g.page_start)!=null?c:NaN)?Number(g.page_start):null,v=Number.isFinite((d=g==null?void 0:g.page_end)!=null?d:NaN)?Number(g.page_end):null,f=y!=null?y:v;f!==null&&(o.set(b,f),o.set(`${_}:${b}`,f))}return this.chunkPageCache.set(_,o),(p=(u=o.get(t))!=null?u:o.get(e))!=null?p:null}};var We={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var be=require("@codemirror/state"),ce=require("@codemirror/view"),K=require("obsidian");var G=h=>{if(typeof h=="string")return h.trim();if(typeof h=="number"&&Number.isFinite(h))return String(h);if(Array.isArray(h))for(let _ of h){if(typeof _=="string"&&_.trim())return _.trim();if(typeof _=="number"&&Number.isFinite(_))return String(_)}if(h&&typeof h=="object"){let _=h[0];if(typeof _=="string"&&_.trim())return _.trim();if(typeof _=="number"&&Number.isFinite(_))return String(_)}return""},Ut=h=>{let _=[h.key,h.itemKey,h.id,h.citationKey];for(let e of _)if(typeof e=="string"&&e.trim())return e.trim();return null},Zt=h=>{var e,t,n;let _=(n=(t=h.key)!=null?t:(e=h.data)==null?void 0:e.key)!=null?n:"";return typeof _=="string"?_:""},gt=h=>{if(!h)return"";let _=h.match(/\b(\d{4})\b/);return _?_[1]:""},Bt=h=>{var e,t,n,r;let _=(r=(n=(e=h.meta)==null?void 0:e.parsedDate)!=null?n:(t=h.data)==null?void 0:t.date)!=null?r:"";return typeof _!="string"?"":gt(_)},Ce=h=>{if(!h||typeof h!="object")return"";if(h.name)return String(h.name);let _=h.firstName?String(h.firstName):"",e=h.lastName?String(h.lastName):"";return[e,_].filter(Boolean).join(", ")||`${_} ${e}`.trim()},He=(h,_)=>{let e=[h.citationKey,h["citation-key"],h.citation_key,_==null?void 0:_.citationKey,_==null?void 0:_["citation-key"],_==null?void 0:_.citation_key,h.citationkey,h.citekey,h.citeKey,h.betterBibtexKey,h.betterbibtexkey,_==null?void 0:_.citationkey,_==null?void 0:_.citekey,_==null?void 0:_.citeKey,_==null?void 0:_.betterBibtexKey,_==null?void 0:_.betterbibtexkey];for(let r of e){let i=G(r);if(i)return i}let t=typeof h.extra=="string"?h.extra:"";if(!t)return"";let n=t.split(/\r?\n/);for(let r of n){let i=r.match(/^\s*biblatexcitekey\s*\[([^\]]+)\]\s*$/i);if(i&&i[1])return i[1].trim();let a=r.match(/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:\s*(.+)\s*$/i);if(a&&a[2])return a[2].trim()}return""},ht=h=>{if(!h)return"";let _=[h["citation-key"],h.citationKey,h.citationkey,h.citekey,h.citation_key];for(let e of _){let t=G(e);if(t)return t}return""},Gt=h=>{var e,t;if(!h)return"";let _=(t=(e=h["title-short"])!=null?e:h.shortTitle)!=null?t:h.short_title;return typeof _=="string"?_.trim():""},Ae=h=>{let _=G(h.shortTitle);if(_)return _;let e=G(h.short_title);if(e)return e;let t=G(h["title-short"]);return t||""},Wt=h=>{let _=typeof h.extra=="string"?h.extra:"";if(!_)return"";let e=_.split(/\r?\n/);for(let n of e){let r=n.match(/^\s*doi\s*:\s*(.+)\s*$/i);if(r&&r[1])return r[1].trim().replace(/[.,;]+$/,"")}let t=_.match(/\b10\.\d{4,9}\/[-._;()/:A-Z0-9]+\b/i);return t?t[0].replace(/[.,;]+$/,""):""},Ht=h=>{var e;if(!h)return"";let _=(e=h.DOI)!=null?e:h.doi;return typeof _=="string"?_.trim().replace(/[.,;]+$/,""):""},Cn=h=>{if(!h)return[];let _=[h.attachments,h.children,h.items,h.attachment,h.allAttachments],e=[];for(let t of _)t&&(Array.isArray(t)?e.push(...t):typeof t=="object"&&e.push(t));return e},ft=h=>{var t,n,r,i,a,s,o,l,c,d,u,p,g,b,y;if(((s=(a=(r=(t=h==null?void 0:h.contentType)!=null?t:h==null?void 0:h.mimeType)!=null?r:(n=h==null?void 0:h.data)==null?void 0:n.contentType)!=null?a:(i=h==null?void 0:h.data)==null?void 0:i.mimeType)!=null?s:"")==="application/pdf")return!0;let e=(y=(b=(p=(u=(c=(o=h==null?void 0:h.filename)!=null?o:h==null?void 0:h.fileName)!=null?c:(l=h==null?void 0:h.data)==null?void 0:l.filename)!=null?u:(d=h==null?void 0:h.data)==null?void 0:d.fileName)!=null?p:h==null?void 0:h.path)!=null?b:(g=h==null?void 0:h.data)==null?void 0:g.path)!=null?y:"";return!!(typeof e=="string"&&e.toLowerCase().endsWith(".pdf"))},Kt=h=>{var t;let _=Cn(h.data);if(_.length>0)return _.some(r=>ft(r))?"yes":"no";let e=(t=h.meta)==null?void 0:t.numChildren;return typeof e=="number"&&e===0?"no":"unknown"};var An={artwork:"image",audioRecording:"music",bill:"file-text",blogPost:"globe",book:"book",bookSection:"book-open",case:"scale",computerProgram:"code",conferencePaper:"file-text",dataset:"database",dictionaryEntry:"book",document:"file-text",email:"mail",encyclopediaArticle:"book",film:"film",forumPost:"message-circle",hearing:"file-text",interview:"mic",journalArticle:"file-text",letter:"mail",magazineArticle:"file-text",manuscript:"file-text",map:"map",newspaperArticle:"file-text",patent:"award",podcast:"mic",preprint:"file-text",presentation:"file-text",radioBroadcast:"music",report:"file-text",statute:"scale",thesis:"graduation-cap",tvBroadcast:"film",videoRecording:"film",webpage:"globe"},Jt=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],En="https://github.com/jmiba/zotero-redisearch-rag/blob/main/CHANGELOG.md",Rn=h=>h.includes("STDERR")?"zrr-log-stderr":h.includes("ERROR")?"zrr-log-error":h.includes("WARNING")||h.includes("WARN")?"zrr-log-warning":h.includes("INFO")?"zrr-log-info":null,Xt=h=>{let _=new be.RangeSetBuilder;for(let{from:e,to:t}of h.visibleRanges){let n=e;for(;n<=t;){let r=h.state.doc.lineAt(n),i=Rn(r.text);i&&_.add(r.from,r.from,ce.Decoration.line({class:i})),n=r.to+1}}return _.finish()},Yt=ce.EditorView.theme({".cm-editor":{height:"100%",display:"flex",flexDirection:"column",minHeight:"0"},".cm-scroller":{fontFamily:"var(--font-monospace)",fontSize:"0.85rem",flex:"1",height:"100%",maxHeight:"100%",overflow:"auto"},".zrr-log-error":{color:"var(--text-error)"},".zrr-log-warning":{color:"var(--text-accent)"},".zrr-log-info":{color:"var(--text-muted)"},".zrr-log-stderr":{color:"var(--text-accent)"}}),Qt=ce.ViewPlugin.fromClass(class{constructor(h){this.decorations=Xt(h)}update(h){(h.docChanged||h.viewportChanged)&&(this.decorations=Xt(h.view))}},{decorations:h=>h.decorations}),Le=class extends K.Modal{constructor(_,e,t,n,r="Value cannot be empty."){super(_),this.titleText=e,this.placeholder=t,this.onSubmit=n,this.emptyMessage=r}onOpen(){let{contentEl:_}=this;_.empty(),_.createEl("h3",{text:this.titleText});let e=_.createEl("input",{type:"text",placeholder:this.placeholder});e.addClass("zrr-u-width-100"),e.focus();let t=_.createEl("button",{text:"Submit"});t.addClass("zrr-u-margin-top-0-75rem");let n=()=>{let r=e.value.trim();if(!r){new K.Notice(this.emptyMessage);return}this.close(),this.onSubmit(r)};t.addEventListener("click",n),e.addEventListener("keydown",r=>{r.key==="Enter"&&n()})}},Te=class extends K.Modal{constructor(e,t,n){super(e);this.markdownComponent=null;this.version=t,this.markdown=n}onOpen(){var a;let{contentEl:e}=this;e.empty(),e.addClass("zrr-release-notes-modal"),e.createEl("h3",{text:"What's new"}),(a=this.markdownComponent)==null||a.unload(),this.markdownComponent=new K.Component,this.markdownComponent.load();let t=String(this.markdown||"").trim();if(t){let s=e.createDiv({cls:"zrr-release-notes-body"});K.MarkdownRenderer.render(this.app,t,s,"",this.markdownComponent)}else e.createEl("p",{text:"This version includes improvements and fixes."});let n=e.createDiv({cls:"zrr-release-notes-body"});K.MarkdownRenderer.render(this.app,`[Full changelog](${En})`,n,"",this.markdownComponent),e.createEl("div",{cls:"zrr-release-notes-actions"}).createEl("button",{text:"Close"}).addEventListener("click",()=>this.close())}onClose(){var e;(e=this.markdownComponent)==null||e.unload(),this.markdownComponent=null,this.contentEl.empty()}},Ke=class extends K.Modal{constructor(_,e,t,n,r){super(_),this.chunkId=e,this.initialTags=t,this.onSubmit=n,this.onRegenerate=r}onOpen(){let{contentEl:_}=this;_.empty(),_.createEl("h3",{text:`Edit tags for ${this.chunkId}`});let e=_.createEl("textarea",{attr:{rows:"3"}});e.addClass("zrr-u-width-100"),e.placeholder="Tag1, tag2, tag3",e.value=this.initialTags.join(", "),e.focus();let t=_.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Save tags"}),r=async()=>{let a=(e.value||"").split(/[,;\n]+/).map(o=>o.trim()).filter(o=>o.length>0),s=Array.from(new Set(a));this.close(),await Promise.resolve(this.onSubmit(s))};if(this.onRegenerate){let i=t.createEl("button",{text:"Regenerate"});i.addEventListener("click",async()=>{var a;i.setAttribute("disabled","true"),n.setAttribute("disabled","true");try{let s=await((a=this.onRegenerate)==null?void 0:a.call(this));s&&s.length>0?(e.value=s.join(", "),await Promise.resolve(this.onSubmit(s))):s&&new K.Notice("No tags were generated.")}finally{i.removeAttribute("disabled"),n.removeAttribute("disabled")}})}n.addEventListener("click",r),e.addEventListener("keydown",i=>{i.key==="Enter"&&(i.metaKey||i.ctrlKey)&&r()})}},Je=class extends K.Modal{constructor(_,e,t,n=""){super(_),this.titleText=e,this.content=t,this.noteText=n}onOpen(){let{contentEl:_}=this;if(_.empty(),_.createEl("h3",{text:this.titleText}),this.noteText){let t=_.createEl("div",{text:this.noteText});t.className="zrr-indexed-note"}let e=_.createEl("textarea",{attr:{rows:"12",readonly:"true"}});e.addClass("zrr-u-width-100"),e.value=this.content}},Xe=class extends K.Modal{constructor(e,t,n=""){super(e);this.bodyText="";this.plugin=t,this.initialTerm=n}onOpen(){let{contentEl:e}=this;e.empty(),this.modalEl&&(this.modalEl.addClass("zrr-u-width-80vw"),this.modalEl.addClass("zrr-u-max-width-1200px"),this.modalEl.addClass("zrr-u-height-80vh"),this.modalEl.addClass("zrr-u-max-height-90vh"),this.modalEl.addClass("zrr-u-resize-both"),this.modalEl.addClass("zrr-u-overflow-hidden")),e.addClass("zrr-u-display-flex"),e.addClass("zrr-u-flex-direction-column"),e.addClass("zrr-u-height-100"),e.addClass("zrr-u-overflow-hidden"),e.addClass("zrr-u-min-height-0");let t=e.createDiv();t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-align-items-center"),t.addClass("zrr-u-justify-content-space-between"),t.addClass("zrr-u-gap-0-5rem"),t.createEl("h3",{text:"Redis index search"});let n=t.createEl("button",{text:"Copy all"});n.addClass("zrr-u-margin-left-auto"),n.addEventListener("click",()=>{this.copyResultsToClipboard()});let r=e.createDiv();r.addClass("zrr-u-display-flex"),r.addClass("zrr-u-align-items-center"),r.addClass("zrr-u-gap-0-5rem"),r.addClass("zrr-u-margin-0-5rem-0");let i=r.createEl("input");i.type="text",i.placeholder="Search term",i.value=this.initialTerm,i.addClass("zrr-u-flex-1"),i.addClass("zrr-u-min-width-0"),this.inputEl=i,r.createEl("button",{text:"Search"}).addEventListener("click",()=>{this.runSearch()}),i.addEventListener("keydown",c=>{c.key==="Enter"&&(c.preventDefault(),this.runSearch())});let s=e.createDiv();s.addClass("zrr-u-color-var-text-muted"),s.addClass("zrr-u-margin-bottom-0-5rem"),this.statusEl=s;let o=e.createDiv();o.addClass("zrr-u-flex-1-1-0"),o.addClass("zrr-u-min-height-0"),o.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),o.addClass("zrr-u-border-radius-6px"),o.addClass("zrr-u-display-flex"),o.addClass("zrr-u-flex-direction-column"),o.addClass("zrr-u-overflow-auto");let l=be.EditorState.create({doc:this.bodyText,extensions:[Yt,Qt,ce.EditorView.editable.of(!1),be.EditorState.readOnly.of(!0),ce.EditorView.lineWrapping]});this.editorView=new ce.EditorView({state:l,parent:o}),this.initialTerm&&this.runSearch()}onClose(){var e;(e=this.editorView)==null||e.destroy(),this.editorView=void 0}async runSearch(){var n;let e=(((n=this.inputEl)==null?void 0:n.value)||"").trim();if(!e){this.statusEl&&(this.statusEl.textContent="Enter a search term.");return}this.statusEl&&(this.statusEl.textContent="Searching...");let t=await this.plugin.runRedisSearch(e);this.updateEditor(t),this.statusEl&&(this.statusEl.textContent=`Results for "${e}"`)}updateEditor(e){if(!this.editorView)return;let t=this.editorView,n=t.scrollDOM.scrollTop,r=t.state.selection.main,i=e.length,a=Math.min(r.anchor,i),s=Math.min(r.head,i);t.dispatch({changes:{from:0,to:t.state.doc.length,insert:e},selection:{anchor:a,head:s}}),t.scrollDOM.scrollTop=n,this.bodyText=e}copyResultsToClipboard(){let e=this.bodyText||"";if(!e){new K.Notice("Nothing to copy.");return}navigator.clipboard.writeText(e).then(()=>new K.Notice("Results copied to clipboard.")).catch(()=>new K.Notice("Failed to copy results."))}},Ee=class extends K.Modal{constructor(_,e,t,n){super(_),this.titleText=e,this.bodyText=t,this.options=n}onOpen(){var i,a,s,o;let{contentEl:_}=this;_.empty(),this.modalEl&&(this.modalEl.addClass("zrr-u-width-80vw"),this.modalEl.addClass("zrr-u-max-width-1200px"),this.modalEl.addClass("zrr-u-height-80vh"),this.modalEl.addClass("zrr-u-max-height-90vh"),this.modalEl.addClass("zrr-u-resize-both"),this.modalEl.addClass("zrr-u-overflow-hidden")),_.addClass("zrr-u-display-flex"),_.addClass("zrr-u-flex-direction-column"),_.addClass("zrr-u-height-100"),_.addClass("zrr-u-overflow-hidden"),_.addClass("zrr-u-min-height-0");let e=_.createDiv();e.addClass("zrr-u-display-flex"),e.addClass("zrr-u-align-items-center"),e.addClass("zrr-u-justify-content-space-between"),e.addClass("zrr-u-gap-0-5rem"),e.createEl("h3",{text:this.titleText});let t=e.createDiv();if(t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),(i=this.options)!=null&&i.onClear){let l=(a=this.options.clearLabel)!=null?a:"Clear log";t.createEl("button",{text:l}).addEventListener("click",async()=>{var d,u;try{await((u=(d=this.options)==null?void 0:d.onClear)==null?void 0:u.call(d))}finally{await this.refreshFromSource()}})}let n=_.createDiv();n.addClass("zrr-u-flex-1-1-0"),n.addClass("zrr-u-min-height-0"),n.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),n.addClass("zrr-u-border-radius-6px"),n.addClass("zrr-u-display-flex"),n.addClass("zrr-u-flex-direction-column"),n.addClass("zrr-u-overflow-auto");let r=be.EditorState.create({doc:this.bodyText,extensions:[Yt,Qt,ce.EditorView.editable.of(!0),be.EditorState.readOnly.of(!1),ce.EditorView.lineWrapping]});if(this.editorView=new ce.EditorView({state:r,parent:n}),this.refreshFromSource(),(s=this.options)!=null&&s.autoRefresh&&this.options.onRefresh){let l=(o=this.options.refreshIntervalMs)!=null?o:2e3;this.refreshTimer=window.setInterval(()=>{this.refreshFromSource()},l)}}onClose(){var _;this.refreshTimer!==void 0&&(window.clearInterval(this.refreshTimer),this.refreshTimer=void 0),(_=this.editorView)==null||_.destroy(),this.editorView=void 0}async refreshFromSource(){var s;if(!((s=this.options)!=null&&s.onRefresh)||!this.editorView)return;let _="";try{_=await this.options.onRefresh()||""}catch(o){return}if(_===this.bodyText)return;let e=this.editorView,t=e.scrollDOM.scrollTop,n=e.state.selection.main,r=_.length,i=Math.min(n.anchor,r),a=Math.min(n.head,r);e.dispatch({changes:{from:0,to:e.state.doc.length,insert:_},selection:{anchor:i,head:a}}),e.scrollDOM.scrollTop=t,this.bodyText=_}},Ye=class extends K.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.filePath=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),r=t.createEl("button",{text:"Overwrite"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),r.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Qe=class extends K.Modal{constructor(e,t,n,r){super(e);this.resolved=!1;this.notePath=t,this.docId=n,this.onResolve=r}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete note and cached data?"}),e.createEl("p",{text:`This will delete the note and cached chunks/items for doc_id ${this.docId}.`}),e.createEl("p",{text:`Note: ${this.notePath}`});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),r=t.createEl("button",{text:"Delete"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),r.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},et=class extends K.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.reason=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Rebuild redis index?"}),e.createEl("p",{text:this.reason}),e.createEl("p",{text:"This will drop the redissearch index (and embeddings) and rebuild it from cached chunks."});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),r=t.createEl("button",{text:"Drop & rebuild"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),r.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},tt=class extends K.Modal{constructor(e,t){super(e);this.resolved=!1;this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Purge redis orphaned chunks?"}),e.createEl("p",{text:"This removes Redis chunk keys that have no cached item.json or chunk.json on disk."}),e.createEl("p",{text:"Cache files are not deleted. Use this to clean up stale redis data."});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),r=t.createEl("button",{text:"Purge orphans"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),r.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},nt=class extends K.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve metadata conflicts"}),e.createEl("p",{text:"Choose which values to keep for each field."});let t=e.createEl("div");t.addClass("zrr-u-display-grid"),t.addClass("zrr-u-gap-0-75rem");for(let l of this.conflicts){let c=t.createEl("div");c.addClass("zrr-u-display-grid"),c.addClass("zrr-u-gap-0-4rem"),c.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),c.addClass("zrr-u-border-radius-6px"),c.addClass("zrr-u-padding-0-6rem"),c.createEl("div",{text:l.fieldLabel,cls:"zrr-font-semibold"});let d=c.createEl("div");d.addClass("zrr-u-display-grid"),d.addClass("zrr-u-grid-template-columns-1fr-1fr"),d.addClass("zrr-u-gap-0-5rem");let u=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});u.addClass("zrr-u-width-100"),u.value=l.noteValue||"(empty)";let p=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});p.addClass("zrr-u-width-100"),p.value=l.zoteroValue||"(empty)";let g=c.createEl("div");g.addClass("zrr-u-display-flex"),g.addClass("zrr-u-gap-0-5rem"),g.addClass("zrr-u-align-items-center"),g.createEl("span",{text:"Decision:"});let b=g.createEl("select");b.add(new Option(l.noteLabel,"note")),b.add(new Option(l.zoteroLabel,"zotero")),b.add(new Option("Skip","skip")),b.value="skip",this.selects.set(l.field,b)}let n=e.createEl("div");n.addClass("zrr-u-display-flex"),n.addClass("zrr-u-flex-wrap-wrap"),n.addClass("zrr-u-gap-0-5rem"),n.addClass("zrr-u-margin-top-0-75rem");let r=l=>{for(let c of this.selects.values())c.value=l},i=n.createEl("button",{text:"Use note for all"}),a=n.createEl("button",{text:"Use Zotero for all"}),s=n.createEl("button",{text:"Skip all"}),o=n.createEl("button",{text:"Apply"});i.addEventListener("click",()=>r("note")),a.addEventListener("click",()=>r("zotero")),s.addEventListener("click",()=>r("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[t,n]of this.selects.entries())e[t]=n.value||"skip";this.onResolve(e)}}},rt=class extends K.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve annotation conflicts"}),e.createEl("p",{text:"Choose which version to keep for each annotation."});let t=e.createEl("div");t.addClass("zrr-u-display-grid"),t.addClass("zrr-u-gap-0-75rem");for(let l of this.conflicts){let c=t.createEl("div");c.addClass("zrr-u-display-grid"),c.addClass("zrr-u-gap-0-4rem"),c.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),c.addClass("zrr-u-border-radius-6px"),c.addClass("zrr-u-padding-0-6rem"),c.createEl("div",{text:l.title,cls:"zrr-font-semibold"});let d=c.createEl("div");d.addClass("zrr-u-display-grid"),d.addClass("zrr-u-grid-template-columns-1fr-1fr"),d.addClass("zrr-u-gap-0-5rem");let u=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});u.addClass("zrr-u-width-100"),u.value=l.noteValue||"(empty)";let p=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});p.addClass("zrr-u-width-100"),p.value=l.zoteroValue||"(empty)";let g=c.createEl("div");g.addClass("zrr-u-display-flex"),g.addClass("zrr-u-gap-0-5rem"),g.addClass("zrr-u-align-items-center"),g.createEl("span",{text:"Decision:"});let b=g.createEl("select");b.add(new Option("Use note","note")),b.add(new Option("Use Zotero","zotero")),b.add(new Option("Skip","skip")),b.value="skip",this.selects.set(l.key,b)}let n=e.createEl("div");n.addClass("zrr-u-display-flex"),n.addClass("zrr-u-flex-wrap-wrap"),n.addClass("zrr-u-gap-0-5rem"),n.addClass("zrr-u-margin-top-0-75rem");let r=l=>{for(let c of this.selects.values())c.value=l},i=n.createEl("button",{text:"Use note for all"}),a=n.createEl("button",{text:"Use Zotero for all"}),s=n.createEl("button",{text:"Skip all"}),o=n.createEl("button",{text:"Apply"});i.addEventListener("click",()=>r("note")),a.addEventListener("click",()=>r("zotero")),s.addEventListener("click",()=>r("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[t,n]of this.selects.entries())e[t]=n.value||"skip";this.onResolve(e)}}},it=class extends K.SuggestModal{constructor(e,t){super(e);this.resolved=!1;this.resolveSelection=t,this.setPlaceholder("Select a language for ocr/quality...")}getSuggestions(e){let t=e.trim().toLowerCase();return t?Jt.filter(n=>n.label.toLowerCase().includes(t)||n.value.toLowerCase().includes(t)):Jt}renderSuggestion(e,t){t.setText(e.label),t.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new Le(this.app,"Custom language hint","e.g., en, de, fr, de,en",t=>this.resolveSelection(t.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},st=class extends K.SuggestModal{constructor(e,t,n){super(e);this.lastError=null;this.indexedDocIds=null;this.querySequence=0;this.queryDebounceMs=200;this.minQueryLength=2;this.maxQueryCacheEntries=100;this.queryCache=new Map;this.plugin=t,this.resolveSelection=n,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){let t=e.trim();if(t.length>0&&t.length<this.minQueryLength)return[];let n=t.toLowerCase(),r=this.queryCache.get(n);if(r)return r;let i=++this.querySequence;try{if(await new Promise(s=>{window.setTimeout(s,this.queryDebounceMs)}),i!==this.querySequence)return[];if(!this.indexedDocIds){let s=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(s))}let a=await this.plugin.searchZoteroItems(t);if(i!==this.querySequence)return[];if(this.queryCache.set(n,a),this.queryCache.size>this.maxQueryCacheEntries){let s=this.queryCache.keys().next().value;s!==void 0&&this.queryCache.delete(s)}return a}catch(a){let s=a instanceof Error?a.message:String(a);return this.lastError!==s&&(this.lastError=s,new K.Notice(s)),console.error("Zotero search failed",a),[]}}renderSuggestion(e,t){var y,v,f,k,x,w;let n=(v=(y=e.data)==null?void 0:y.title)!=null?v:"[No title]",r=Bt(e),i=Zt(e),a=i?(f=this.indexedDocIds)==null?void 0:f.has(i):!1,s=Kt(e),o=String((x=(k=e.data)==null?void 0:k.itemType)!=null?x:"").trim();a&&t.addClass("zrr-indexed-item"),s==="no"&&t.addClass("zrr-no-pdf-item");let l=t.createDiv({cls:"zrr-zotero-suggest-row"}),c=l.createSpan({cls:"zrr-zotero-item-icon"}),d=(w=An[o])!=null?w:"file-text";(0,K.setIcon)(c,d);let u=l.createDiv({cls:"zrr-zotero-suggest-text"});u.createEl("div",{text:n,cls:"zrr-zotero-suggest-title"});let p=u.createEl("small",{cls:"zrr-zotero-suggest-meta"}),g=!1,b=()=>{g&&p.createSpan({text:" - "})};r&&(p.createSpan({text:r}),g=!0),a&&(b(),p.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),g=!0),s==="no"&&(b(),p.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),g=!0),t.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,t){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}};var en={"docling_extract.py":`#!/usr/bin/env python3
# zotero-redisearch-rag tool version: 0.9.8
import argparse
import atexit
import base64
import errno
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.8
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.8
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.8
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.8
...
`,"redis-stack.conf":`# zotero-redisearch-rag tool version: 0.9.8
# Redis Stack persistence config for local RAG index
appendonly yes
appendfsync everysec

dir /data
`};var mt=require("url"),De=async(h,_,e)=>{let t=Sn(h);if(t)return t;try{let n=await e.fetchZoteroChildren(_);for(let r of n){let i=nn(r);if(i)return i}}catch(n){console.error("Failed to fetch Zotero children",n)}return null},Sn=h=>{let _=Nn(h);for(let e of _){let t=nn(e);if(t)return t}return null},Nn=h=>{let _=[h.attachments,h.children,h.items,h.attachment,h.allAttachments],e=[];for(let t of _)t&&(Array.isArray(t)?e.push(...t):typeof t=="object"&&e.push(t));return e},nn=h=>{var n,r,i,a,s,o;if(((i=(n=h==null?void 0:h.contentType)!=null?n:h==null?void 0:h.mimeType)!=null?i:(r=h==null?void 0:h.data)==null?void 0:r.contentType)!=="application/pdf")return null;let e=(o=(a=h==null?void 0:h.key)!=null?a:h==null?void 0:h.attachmentKey)!=null?o:(s=h==null?void 0:h.data)==null?void 0:s.key;if(!e)return null;let t=Ln(h);return t?{key:e,filePath:t}:{key:e}},Ln=h=>{var e,t,n,r,i,a,s,o;let _=(o=(r=(t=(e=h==null?void 0:h.links)==null?void 0:e.enclosure)==null?void 0:t.href)!=null?r:(n=h==null?void 0:h.enclosure)==null?void 0:n.href)!=null?o:(s=(a=(i=h==null?void 0:h.data)==null?void 0:i.links)==null?void 0:a.enclosure)==null?void 0:s.href;if(typeof _=="string"&&_.startsWith("file://"))try{return(0,mt.fileURLToPath)(_)}catch(l){return null}return null},tn=async(h,_)=>{if(h.statusCode<300||h.statusCode>=400)return null;let e=h.headers.location,t=Array.isArray(e)?e[0]:e;if(!t||typeof t!="string")return null;if(t.startsWith("file://")){let n=(0,mt.fileURLToPath)(t);return _.readFile(n)}return t.startsWith("http://")||t.startsWith("https://")?_.requestLocalApi(t):null},at=async(h,_)=>{let e=_.buildZoteroUrl(`/${_.getZoteroLibraryPath()}/items/${h}/file`);try{let t=await _.requestLocalApiRaw(e),n=await tn(t,_);if(n)return n;if(t.statusCode>=300)throw new Error(`Request failed, status ${t.statusCode}`);return t.body}catch(t){if(console.warn("Failed to download PDF from local API",t),!_.canUseWebApi())throw t;let n=_.buildWebApiUrl(`/${_.getWebApiLibraryPath()}/items/${h}/file`),r=await _.requestWebApiRaw(n),i=await tn(r,_);if(i)return i;if(r.statusCode>=300)throw new Error(`Web API request failed, status ${r.statusCode}`);return r.body}};var Q=require("obsidian"),Re="zotero-redisearch-rag-chat",Oe=class extends Q.ItemView{constructor(e,t){super(e);this.messages=[];this.activeSessionId="default";this.messageEls=new Map;this.pendingRender=new Map;this.pendingThinking=new Set;this.busy=!1;this.cancelPending=!1;this.plugin=t}getViewType(){return Re}getDisplayText(){return"Zotero research assistant chat"}getIcon(){return"zrr-chat"}async onOpen(){let{containerEl:e}=this;e.empty(),e.addClass("zrr-chat-view");let t=e.createEl("div",{cls:"zrr-chat-header"});t.createEl("div",{cls:"zrr-chat-title",text:"Zotero research assistant chat"});let n=t.createEl("div",{cls:"zrr-chat-controls"}),r=n.createEl("div",{cls:"zrr-chat-controls-row"});this.sessionSelect=r.createEl("select",{cls:"zrr-chat-session"}),this.sessionSelect.addEventListener("change",async()=>{await this.switchSession(this.sessionSelect.value)});let i=n.createEl("div",{cls:"zrr-chat-controls-row zrr-chat-controls-actions"});this.renameButton=i.createEl("button",{cls:"zrr-chat-rename",text:"Rename",attr:{title:"Rename the current chat"}}),this.renameButton.addEventListener("click",async()=>{await this.promptRenameSession()}),this.copyButton=i.createEl("button",{cls:"zrr-chat-copy",text:"Copy",attr:{title:"Copy this chat to a new note"}}),this.copyButton.addEventListener("click",async()=>{await this.copyChatToNote()}),this.deleteButton=i.createEl("button",{cls:"zrr-chat-delete",text:"Delete",attr:{title:"Delete this chat"}}),this.deleteButton.addEventListener("click",async()=>{await this.deleteChat()}),this.newButton=i.createEl("button",{cls:"zrr-chat-new",text:"New chat",attr:{title:"Start a new chat session"}}),this.newButton.addEventListener("click",async()=>{await this.startNewChat()}),this.messagesEl=e.createEl("div",{cls:"zrr-chat-messages"});let a=e.createEl("div",{cls:"zrr-chat-input"});this.inputEl=a.createEl("textarea",{cls:"zrr-chat-textarea",attr:{placeholder:"Ask your Zotero library..."}}),this.sendButton=a.createEl("button",{cls:"zrr-chat-send",attr:{"aria-label":"Send message",title:"Send message"}}),this.updateSendButtonState(),this.sendButton.addEventListener("click",()=>{this.handleSendButtonClick()}),this.inputEl.addEventListener("keydown",s=>{s.key==="Enter"&&!s.shiftKey&&(s.preventDefault(),this.busy||this.handleSend())}),await this.loadSessions(),await this.loadHistory(),await this.renderAll()}focusInput(){var e;(e=this.inputEl)==null||e.focus()}async loadHistory(){try{this.messages=await this.plugin.loadChatHistoryForSession(this.activeSessionId)}catch(e){console.error(e),this.messages=[]}}async saveHistory(){try{await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages),await this.loadSessions()}catch(e){console.error(e)}}async loadSessions(){let e=await this.plugin.listChatSessions();this.activeSessionId=await this.plugin.getActiveChatSessionId(),this.sessionSelect.empty();for(let t of e){let n=this.sessionSelect.createEl("option",{text:t.name});n.value=t.id,t.id===this.activeSessionId&&(n.selected=!0)}!e.some(t=>t.id===this.activeSessionId)&&e.length>0&&(this.activeSessionId=e[0].id,await this.plugin.setActiveChatSessionId(this.activeSessionId),this.sessionSelect.value=this.activeSessionId)}async promptRenameSession(){var r;let t=(await this.plugin.listChatSessions()).find(i=>i.id===this.activeSessionId);new yt(this.app,(r=t==null?void 0:t.name)!=null?r:"New chat",async i=>{await this.plugin.renameChatSession(this.activeSessionId,i),await this.loadSessions()}).open()}async startNewChat(){await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages,{force:!0});let e=await this.plugin.createChatSession("New chat");await this.switchSession(e,{skipSave:!0})}async deleteChat(){let e=await this.plugin.listChatSessions();if(e.length<=1){new Q.Notice("You must keep at least one chat.");return}let t=e.find(r=>r.id===this.activeSessionId);if(!t)return;new bt(this.app,t.name,async()=>{await this.plugin.deleteChatSession(this.activeSessionId);let r=await this.plugin.getActiveChatSessionId();await this.switchSession(r,{skipSave:!0})}).open()}async switchSession(e,t={}){!e||e===this.activeSessionId||(t.skipSave||await this.saveHistory(),this.activeSessionId=e,await this.plugin.setActiveChatSessionId(e),await this.loadSessions(),await this.loadHistory(),await this.renderAll())}async renderAll(){this.messagesEl.empty(),this.messageEls.clear();let e=new Set(this.messages.map(t=>t.id));for(let t of Array.from(this.pendingThinking))e.has(t)||this.pendingThinking.delete(t);for(let t of this.messages)await this.renderMessage(t);this.scrollToBottom()}async renderMessage(e){let t=this.messagesEl.createEl("div",{cls:`zrr-chat-message zrr-chat-${e.role}`}),n=t.createEl("div",{cls:"zrr-chat-meta-row"});n.createEl("div",{cls:"zrr-chat-meta"}).setText(e.role==="user"?"You":"Zotero Assistant");let i=n.createEl("div",{cls:"zrr-chat-message-actions"}),a=i.createEl("button",{cls:"zrr-chat-message-copy zrr-chat-icon-button",attr:{title:"Copy this message","aria-label":"Copy this message"}});(0,Q.setIcon)(a,"copy"),a.addEventListener("click",async c=>{c.preventDefault(),c.stopPropagation(),await this.copyMessage(e)});let s=i.createEl("button",{cls:"zrr-chat-message-delete zrr-chat-icon-button",attr:{title:"Delete this message","aria-label":"Delete this message"}});(0,Q.setIcon)(s,"trash-2"),s.addEventListener("click",async c=>{c.preventDefault(),c.stopPropagation(),await this.deleteMessage(e.id)});let o=t.createEl("div",{cls:"zrr-chat-content"}),l=t.createEl("div",{cls:"zrr-chat-citations"});this.messageEls.set(e.id,{wrapper:t,content:o,citations:l}),await this.renderMessageContent(e)}async copyMessage(e){var r,i,a;let n=(await this.plugin.formatInlineCitations(e.content||"",(r=e.citations)!=null?r:[],(i=e.retrieved)!=null?i:[])||"").trim();if(!n){new Q.Notice("Nothing to copy.");return}if(!((a=navigator.clipboard)!=null&&a.writeText)){new Q.Notice("Clipboard API unavailable. Select text to copy.");return}try{await navigator.clipboard.writeText(n),new Q.Notice("Message copied to clipboard.")}catch(s){console.error("Failed to copy message",s),new Q.Notice("Failed to copy message.")}}async deleteMessage(e){let t=this.messages.findIndex(a=>a.id===e);if(t===-1||!await this.confirmDeleteMessage())return;this.messages.splice(t,1);let r=this.messageEls.get(e);r&&r.wrapper.remove(),this.messageEls.delete(e);let i=this.pendingRender.get(e);i!==void 0&&(window.clearTimeout(i),this.pendingRender.delete(e)),this.pendingThinking.delete(e),await this.saveHistory()}async confirmDeleteMessage(){return new Promise(e=>{new xt(this.app,e).open()})}scheduleRender(e){if(this.pendingRender.has(e.id))return;let t=window.setTimeout(async()=>{this.pendingRender.delete(e.id),await this.renderMessageContent(e),this.scrollToBottom()},80);this.pendingRender.set(e.id,t)}async renderMessageContent(e){var i,a,s;let t=this.messageEls.get(e.id);if(!t)return;if(e.role==="assistant"&&!e.content.trim()&&this.pendingThinking.has(e.id)){t.content.dataset.lastRendered!=="__thinking__"&&(t.content.empty(),this.renderThinkingIndicator(t.content),t.content.dataset.lastRendered="__thinking__"),t.citations.empty();return}let r=await this.plugin.formatInlineCitations(e.content||"",(i=e.citations)!=null?i:[],(a=e.retrieved)!=null?a:[]);t.content.dataset.lastRendered!==r&&(t.content.empty(),await Q.MarkdownRenderer.render(this.app,r,t.content,"",this),this.hookInternalLinks(t.content),t.content.dataset.lastRendered=r),t.citations.empty(),await this.renderCitations(t.citations,(s=e.citations)!=null?s:[])}renderThinkingIndicator(e){let t=e.createEl("div",{cls:"zrr-chat-thinking"});t.setAttr("role","status"),t.setAttr("aria-live","polite"),t.createEl("span",{cls:"zrr-chat-thinking-spinner"}),t.createEl("span",{cls:"zrr-chat-thinking-text",text:"Thinking"});let n=t.createEl("span",{cls:"zrr-chat-thinking-dots"});n.createEl("span"),n.createEl("span"),n.createEl("span")}hookInternalLinks(e){let t=e.querySelectorAll("a.internal-link");for(let n of Array.from(t))n.dataset.zrrBound!=="1"&&(n.dataset.zrrBound="1",this.registerDomEvent(n,"click",r=>{r.preventDefault();let i=n.getAttribute("data-href")||n.getAttribute("href")||"";i&&this.plugin.openInternalLinkInMain(i)}))}async renderCitations(e,t){if(e.empty(),!t.length)return;let n=e.createEl("details",{cls:"zrr-chat-citations-details"});n.createEl("summary",{text:`Relevant context sources (${t.length})`,cls:"zrr-chat-citations-summary"});let r=n.createEl("ul",{cls:"zrr-chat-citation-list"});for(let i of t){let a=await this.plugin.resolveCitationDisplay(i),s=r.createEl("li"),o=`${a.noteTitle} p. ${a.pageLabel}`;s.createEl("a",{text:o,href:"#"}).addEventListener("click",c=>{c.preventDefault(),this.plugin.openCitationTarget(i,a)}),i.annotation_key&&s.createEl("span",{text:"Annotation",cls:"zrr-chat-citation-badge"})}}async copyChatToNote(){var r;let t=(await this.plugin.listChatSessions()).find(i=>i.id===this.activeSessionId),n=(r=t==null?void 0:t.name)!=null?r:"New chat";await this.plugin.createChatNoteFromSession(this.activeSessionId,n,this.messages)}scrollToBottom(){this.messagesEl.scrollTop=this.messagesEl.scrollHeight}updateSendButtonState(){if(this.sendButton){if(this.busy){this.sendButton.disabled=this.cancelPending,(0,Q.setIcon)(this.sendButton,this.cancelPending?"loader-2":"square"),this.sendButton.setAttr("aria-label",this.cancelPending?"Canceling...":"Cancel response"),this.sendButton.setAttr("title",this.cancelPending?"Canceling...":"Cancel response");return}this.sendButton.disabled=!1,(0,Q.setIcon)(this.sendButton,"send"),this.sendButton.setAttr("aria-label","Send message"),this.sendButton.setAttr("title","Send message")}}isCancellationError(e){let n=(e instanceof Error?e.message:String(e!=null?e:"")).toLowerCase();return n.includes("request canceled")||n.includes("request cancelled")||n.includes("request aborted")||n.includes("python worker request aborted")||n.includes("client_disconnected")}async handleSendButtonClick(){if(this.busy){if(this.cancelPending)return;this.cancelPending=!0,this.updateSendButtonState(),this.plugin.cancelActiveRagQuery()||(this.cancelPending=!1,this.updateSendButtonState());return}await this.handleSend()}async handleSend(){if(this.busy)return;let e=this.inputEl.value.trim();if(!e){new Q.Notice("Query cannot be empty.");return}if(!this.plugin.settings.chatBaseUrl){new Q.Notice("Chat base URL must be set in settings.");return}this.inputEl.value="",this.busy=!0,this.cancelPending=!1,this.updateSendButtonState();let t={id:this.generateId(),role:"user",content:e,createdAt:new Date().toISOString()};this.messages.push(t),await this.renderMessage(t),this.scrollToBottom(),await this.saveHistory();let n={id:this.generateId(),role:"assistant",content:"",citations:[],createdAt:new Date().toISOString()};this.messages.push(n),this.pendingThinking.add(n.id),await this.renderMessage(n),this.scrollToBottom();let r=!1,i=!1,a=this.plugin.getRecentChatHistory(this.messages.slice(0,-2));try{await this.plugin.runRagQueryStreaming(e,s=>{this.pendingThinking.delete(n.id),r=!0,n.content+=s,this.scheduleRender(n)},s=>{if(this.pendingThinking.delete(n.id),s!=null&&s.canceled){i=!0,!r&&!n.content.trim()&&(n.content=typeof(s==null?void 0:s.answer)=="string"&&s.answer.trim()?s.answer:"Request canceled."),this.scheduleRender(n);return}(!r&&(s!=null&&s.answer)||s!=null&&s.answer)&&(n.content=s.answer),Array.isArray(s==null?void 0:s.citations)&&(n.citations=s.citations),Array.isArray(s==null?void 0:s.retrieved)&&(n.retrieved=s.retrieved),this.scheduleRender(n)},a)}catch(s){console.error(s),this.pendingThinking.delete(n.id),i||this.isCancellationError(s)?!r&&!n.content.trim()&&(n.content="Request canceled."):n.content="Failed to fetch answer. See console for details.",this.scheduleRender(n)}finally{this.pendingThinking.delete(n.id),this.busy=!1,this.cancelPending=!1,this.updateSendButtonState(),await this.saveHistory()}}generateId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}},yt=class extends Q.Modal{constructor(_,e,t){super(_),this.initialValue=e,this.onSubmit=t}onOpen(){let{contentEl:_}=this;_.empty(),_.addClass("zrr-chat-rename-modal"),_.createEl("h3",{text:"Rename chat"});let e=this.initialValue;new Q.Setting(_).setName("Name").addText(i=>{i.setValue(e),i.onChange(a=>{e=a})});let t=_.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-1rem"),t.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),t.createEl("button",{text:"Save"}).addEventListener("click",()=>{let i=e.trim();if(!i){new Q.Notice("Name cannot be empty.");return}this.close(),Promise.resolve(this.onSubmit(i))})}},bt=class extends Q.Modal{constructor(_,e,t){super(_),this.chatName=e,this.onConfirm=t}onOpen(){let{contentEl:_}=this;_.empty(),_.createEl("h3",{text:"Delete chat"}),_.createEl("p",{text:`Delete "${this.chatName}"? This cannot be undone.`});let e=_.createEl("div");e.addClass("zrr-u-display-flex"),e.addClass("zrr-u-gap-0-5rem"),e.addClass("zrr-u-margin-top-1rem"),e.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),e.createEl("button",{text:"Delete"}).addEventListener("click",()=>{this.close(),Promise.resolve(this.onConfirm())})}},xt=class extends Q.Modal{constructor(e,t){super(e);this.resolved=!1;this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete message"}),e.createEl("p",{text:"Delete this message? This cannot be undone."});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-1rem"),t.createEl("button",{text:"Cancel"}).addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),t.createEl("button",{text:"Delete"}).addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}};var kt=[{version:"0.9.1",markdown:"- Rebrand the plugin display name to **Zotero Research Assistant** across Obsidian UI labels and user-facing docs.\n- Rename chat UI labels and command text to match the new product name.\n- Rebrand the Zotero add-on package to **Zotero Research Assistant Companion** in the add-on manifest and preferences pane.\n- Publish companion add-on update `0.1.4` and refresh `zotero-companion/updates.json` hash for update distribution."},{version:"0.9.0",markdown:`- Make Python worker runtime the graceful default path for legacy installs, with one-time migration and preserved local settings.
...
`).trim()}getBundledReleaseNotesEntries(){var r,i;let e=new Set,t=Array.isArray(kt)?kt:[],n=[];for(let a of t){let s=this.normalizeReleaseVersion(String((r=a==null?void 0:a.version)!=null?r:"")),o=this.sanitizeReleaseNotesMarkdown(String((i=a==null?void 0:a.markdown)!=null?i:""));!s||e.has(s)||(e.add(s),n.push({version:s,markdown:o}))}return n.sort((a,s)=>this.compareReleaseVersions(s.version,a.version))}getReleaseNotesMarkdown(e,t){let n=this.normalizeReleaseVersion(e);if(!n)return"";let r=this.normalizeReleaseVersion(t||""),i=this.getBundledReleaseNotesEntries(),a=i.filter(o=>this.compareReleaseVersions(o.version,n)>0?!1:r?this.compareReleaseVersions(o.version,r)>0:o.version===n),s=a.length?a:i.filter(o=>o.version===n);if(!s.length)return"This version includes improvements and fixes.";if(s.length===1){let o=s[0],l=this.stripLeadingVersionHeading(this.sanitizeReleaseNotesMarkdown(String(o.markdown||"")),o.version);return`### v${o.version}
...
`)}async importZoteroItem(){var S,T,I;try{await this.ensureBundledTools()}catch(L){new m.Notice("Failed to sync bundled tools. See console for details."),console.error(L);return}if(!await this.warnIfZoteroLocalApiUnavailable("import")&&!this.canUseWebApi())return;let t;try{t=await this.promptZoteroItem()}catch(L){new m.Notice("Zotero search failed. See console for details."),console.error(L);return}if(!t){new m.Notice("No Zotero item selected.");return}let n=(S=t.data)!=null?S:t;!n.key&&t.key&&(n.key=t.key);let r=Ut(n);if(!r){new m.Notice("Could not resolve a stable doc_ID from Zotero item.");return}let i=await this.resolveLanguageHint(n,(T=t.key)!=null?T:n.key),a=this.buildDoclingLanguageHint(i!=null?i:void 0),s=await De(n,r,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});if(!s){new m.Notice("No PDF attachment found for item.");return}if(this.showStatusProgress("Preparing...",5),!await this.ensureRedisAvailable("import")){this.clearStatusProgress();return}let o=typeof n.title=="string"?n.title:"",l=await this.getDocIndexEntry(r);l&&new m.Notice("Item already indexed. Updating cached files and index.");let c=this.sanitizeFileName(o)||r;if(l!=null&&l.note_path)c=R.default.basename(l.note_path,".md")||c;else if(l!=null&&l.pdf_path){let L=this.toVaultRelativePath(l.pdf_path);L&&L.startsWith((0,m.normalizePath)(this.settings.outputPdfDir))&&(c=R.default.basename(L,".pdf")||c)}let d=l?c:await this.resolveUniqueBaseName(c,r),u=(0,m.normalizePath)(`${this.settings.outputPdfDir}/${d}.pdf`),p=(0,m.normalizePath)(`${oe}/${r}.json`),g=(0,m.normalizePath)(`${ee}/${r}.json`),b=this.app.vault.adapter,y=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${d}.md`);if(l!=null&&l.note_path&&await b.exists(l.note_path)&&(y=(0,m.normalizePath)(l.note_path)),await b.exists(y)&&!await this.confirmOverwrite(y)){new m.Notice("Import canceled.");return}try{if(await this.ensureFolder(oe),await this.ensureFolder(ee),await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let L=this.getLogFileRelativePath(),j=(0,m.normalizePath)(R.default.dirname(L));j&&await this.ensureFolder(j),await this.deleteLogFileIfExists();let F=this.getSpellcheckerInfoRelativePath(),M=(0,m.normalizePath)(R.default.dirname(F));M&&await this.ensureFolder(M)}}catch(L){new m.Notice("Failed to create output folders."),console.error(L),this.clearStatusProgress();return}let v="",f="";try{if(this.settings.copyPdfToVault){let L=s.filePath?await Y.promises.readFile(s.filePath):await at(s.key,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:Y.promises.readFile});await this.app.vault.adapter.writeBinary(u,this.bufferToArrayBuffer(L)),v=this.getAbsoluteVaultPath(u)}else if(s.filePath)v=s.filePath;else{await this.ensureFolder(this.settings.outputPdfDir);let L=await at(s.key,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:Y.promises.readFile});await this.app.vault.adapter.writeBinary(u,this.bufferToArrayBuffer(L)),v=this.getAbsoluteVaultPath(u),new m.Notice("Local PDF path unavailable; copied PDF into vault for processing.")}f=this.buildPdfLinkForNote(v,s.key,r)}catch(L){new m.Notice("Failed to download PDF attachment."),console.error(L),this.clearStatusProgress();return}try{await this.app.vault.adapter.write(p,JSON.stringify(t,null,2))}catch(L){new m.Notice("Failed to write Zotero item JSON."),console.error(L),this.clearStatusProgress();return}let k=this.getPluginDir(),x=R.default.join(k,"tools","docling_extract.py"),w=R.default.join(k,"tools","index_redisearch.py"),E=null;try{this.showStatusProgress(this.formatStatusLabel("Docling extraction...",E),0);let L=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(x,await this.buildDoclingArgs(v,r,g,y,a,!0),M=>this.handleDoclingProgress(M,E),()=>{},L),E=await this.readDoclingQualityLabel(g),await this.annotateChunkJsonWithAttachmentKey(g,s.key);let j=await this.readDoclingMetadata(g),F=await this.maybeCreateOcrLayeredPdf(v,j,a);F&&(v=F,f=this.buildPdfLinkFromSourcePath(F),await this.updateChunkJsonSourcePdf(g,F))}catch(L){new m.Notice("Docling extraction failed. See console for details."),console.error(L),this.clearStatusProgress();return}let P=!1;try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",E),0);let L=["--chunks-json",this.getAbsoluteVaultPath(g),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--progress"];this.appendEmbedSubchunkArgs(L),this.appendEmbedContextArgs(L),this.settings.embedIncludeMetadata&&L.push("--embed-include-metadata"),this.appendChunkTaggingArgs(L),await this.runPythonStreaming(w,L,j=>{let F=this.asRecord(j),M=typeof(F==null?void 0:F.total)=="number"?F.total:0,V=typeof(F==null?void 0:F.current)=="number"?F.current:0;if((F==null?void 0:F.type)==="progress"&&M>0){let O=Math.round(V/M*100),Z=typeof F.message=="string"&&F.message.trim()?F.message:`Indexing chunks ${V}/${M}`,q=this.formatStatusLabel(Z,E);this.showStatusProgress(q,O)}},()=>{})}catch(L){let j=this.getPythonErrorMessage(L),F=this.classifyIndexingError(j);if(console.error(L),F==="embed_dim_mismatch")if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema. Switch to a model with matching dimensions, or drop/rebuild the index."))try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){this.clearStatusProgress(),this.lastReindexFailure==="embed_failure"?new m.Notice("Embedding provider error detected while rebuilding the Redis index. Fix the provider/model settings and retry import."):new m.Notice("Redis index rebuild did not complete. Import stopped.");return}new m.Notice("Redis index rebuilt; resuming import."),P=!0}catch(V){this.clearStatusProgress(),new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(V);return}else{this.clearStatusProgress(),new m.Notice("Indexing aborted due to embedding dimension mismatch. Switch models or drop/rebuild the index.");return}if(!P){if(F==="embed_failure"){this.clearStatusProgress(),new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.");return}this.clearStatusProgress(),new m.Notice("Redissearch indexing failed. See console for details.");return}}try{let L=await this.app.vault.adapter.read(y),j=await this.readChunkPayload(g),F=this.buildSyncedDoclingContent(r,j,L),M=await this.buildNoteMarkdown(n,(I=t.meta)!=null?I:{},r,f,s.key,y,p,F);await this.writeNoteWithSyncSuppressed(y,M);let V=this.app.vault.getAbstractFileByPath(y);V instanceof m.TFile&&this.scheduleNoteAnnotationSync(V,2e3,"save")}catch(L){new m.Notice("Failed to finalize note Markdown."),console.error(L),this.clearStatusProgress();return}try{let L=Ae(n);await this.updateDocIndex({doc_id:r,note_path:y,note_title:d,zotero_title:o,short_title:L||void 0,pdf_path:v,attachment_key:s.key})}catch(L){console.error("Failed to update doc index",L)}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice(`Indexed Zotero item ${r}.`)}async askZoteroLibrary(){await this.openChatView(!0)}getChatLeaf(){var t;let e=this.app.workspace.getLeavesOfType(Re);return e.length>0?e[0]:this.settings.chatPaneLocation==="right"?(t=this.app.workspace.getRightLeaf(!1))!=null?t:this.app.workspace.getLeaf("split"):this.app.workspace.getLeaf("tab")}async openChatView(e=!1){let t=this.getChatLeaf();await t.setViewState({type:Re,active:!0}),await this.app.workspace.revealLeaf(t);let n=t.view;return n instanceof Oe&&e&&n.focusInput(),n}async loadChatHistory(){let e=await this.getActiveChatSessionId();return this.loadChatHistoryForSession(e)}async saveChatHistory(e){let t=await this.getActiveChatSessionId();await this.saveChatHistoryForSession(t,e)}getChatSessionsDir(){return(0,m.normalizePath)(`${re}/chats`)}getChatExportDir(){let e=(this.settings.chatOutputDir||"").trim();return e?(0,m.normalizePath)(e):(0,m.normalizePath)("zotero/chats")}getChatSessionsIndexPath(){return(0,m.normalizePath)(`${this.getChatSessionsDir()}/index.json`)}getChatSessionPath(e){return(0,m.normalizePath)(`${this.getChatSessionsDir()}/${e}.json`)}async listChatSessions(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,t=this.getChatSessionsIndexPath();if(!await e.exists(t)){let n=new Date().toISOString(),r=[{id:"default",name:"New chat",createdAt:n,updatedAt:n}];return await this.writeChatSessionsIndex({version:1,active:"default",sessions:r}),r}try{let n=await e.read(t),r=this.asRecord(JSON.parse(n));return(Array.isArray(r==null?void 0:r.sessions)?r.sessions:[]).filter(a=>!!(this.asRecord(a)&&typeof a.id=="string")).map(a=>({id:String(a.id),name:typeof a.name=="string"&&a.name.trim()?a.name.trim():String(a.id),createdAt:typeof a.createdAt=="string"?a.createdAt:new Date().toISOString(),updatedAt:typeof a.updatedAt=="string"?a.updatedAt:new Date().toISOString()}))}catch(n){return console.warn("Failed to read chat sessions index",n),[]}}async getActiveChatSessionId(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,t=this.getChatSessionsIndexPath();if(!await e.exists(t))return"default";try{let n=await e.read(t),r=JSON.parse(n);return(typeof(r==null?void 0:r.active)=="string"?r.active:"default")||"default"}catch(n){return"default"}}async setActiveChatSessionId(e){var a,s;await this.migrateLegacyChatHistory();let t=await this.readChatSessionsIndex(),n=((a=t.sessions)!=null?a:[]).some(o=>o.id===e),r=new Date().toISOString(),i=n?t.sessions:[...(s=t.sessions)!=null?s:[],{id:e,name:e,createdAt:r,updatedAt:r}];await this.writeChatSessionsIndex({version:1,active:e,sessions:i})}async createChatSession(e){var s;await this.migrateLegacyChatHistory();let t=this.generateChatId(),n=new Date().toISOString(),r=(e||"").trim()||"New chat",a=[...(s=(await this.readChatSessionsIndex()).sessions)!=null?s:[],{id:t,name:r,createdAt:n,updatedAt:n}];return await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionPath(t),JSON.stringify({version:1,messages:[]},null,2)),await this.writeChatSessionsIndex({version:1,active:t,sessions:a}),t}async renameChatSession(e,t){var a,s;await this.migrateLegacyChatHistory();let n=(t||"").trim();if(!n)return;let r=await this.readChatSessionsIndex(),i=((a=r.sessions)!=null?a:[]).map(o=>o.id===e?{...o,name:n}:o);await this.writeChatSessionsIndex({version:1,active:(s=r.active)!=null?s:"default",sessions:i})}async deleteChatSession(e){var s;if(await this.migrateLegacyChatHistory(),!e)return;let t=this.app.vault.adapter,n=await this.readChatSessionsIndex(),r=(s=n.sessions)!=null?s:[];if(r.length<=1)return;let i=r.filter(o=>o.id!==e);if(!i.length)return;let a=n.active===e?i[0].id:n.active;try{await t.remove(this.getChatSessionPath(e))}catch(o){console.warn("Failed to delete chat session file",o)}await this.writeChatSessionsIndex({version:1,active:a,sessions:i})}async loadChatHistoryForSession(e){await this.migrateLegacyChatHistory();let t=this.app.vault.adapter,n=this.getChatSessionPath(e||"default");if(!await t.exists(n))return[];let r=await t.read(n),i;try{i=JSON.parse(r)}catch(o){return[]}let a=this.asRecord(i),s=Array.isArray(i)?i:Array.isArray(a==null?void 0:a.messages)?a.messages:[];return Array.isArray(s)?s.filter(o=>!!(this.asRecord(o)&&typeof o.content=="string")).map(o=>{var l;return{id:typeof o.id=="string"?o.id:this.generateChatId(),role:o.role==="assistant"?"assistant":"user",content:String((l=o.content)!=null?l:""),citations:Array.isArray(o.citations)?o.citations:[],retrieved:Array.isArray(o.retrieved)?o.retrieved:[],createdAt:typeof o.createdAt=="string"?o.createdAt:new Date().toISOString()}}):[]}async saveChatHistoryForSession(e,t){var l,c;await this.migrateLegacyChatHistory(),await this.ensureFolder(this.getChatSessionsDir());let n=this.app.vault.adapter,r=this.getChatSessionPath(e||"default"),i={version:1,messages:t};await n.write(r,JSON.stringify(i,null,2));let a=await this.readChatSessionsIndex(),s=new Date().toISOString(),o=((l=a.sessions)!=null?l:[]).map(d=>d.id===e?{...d,updatedAt:s}:d);await this.writeChatSessionsIndex({version:1,active:(c=a.active)!=null?c:e,sessions:o})}getRecentChatHistory(e){let t=Math.max(0,this.settings.chatHistoryMessages||0);return t?e.filter(r=>{var i;return r&&((i=r.content)==null?void 0:i.trim())}).slice(-t):[]}async readChatSessionsIndex(){let e=this.app.vault.adapter,t=this.getChatSessionsIndexPath(),n=new Date().toISOString();if(!await e.exists(t))return{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:n,updatedAt:n}]};try{let r=await e.read(t),i=this.asRecord(JSON.parse(r)),a=Array.isArray(i==null?void 0:i.sessions)?i.sessions:[];return{version:1,active:typeof(i==null?void 0:i.active)=="string"?i.active:"default",sessions:a.map(s=>this.asRecord(s)).filter(s=>!!s).map(s=>{var o,l;return{id:String((o=s.id)!=null?o:""),name:typeof s.name=="string"&&s.name.trim()?s.name.trim():String((l=s.id)!=null?l:""),createdAt:typeof s.createdAt=="string"?s.createdAt:n,updatedAt:typeof s.updatedAt=="string"?s.updatedAt:n}})}}catch(r){return console.warn("Failed to parse chat sessions index",r),{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:n,updatedAt:n}]}}}async writeChatSessionsIndex(e){await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionsIndexPath(),JSON.stringify(e,null,2))}async migrateLegacyChatHistory(){let e=this.app.vault.adapter,t=(0,m.normalizePath)(`${re}/chat.json`),n=this.getChatSessionsDir(),r=this.getChatSessionsIndexPath(),i=this.getChatSessionPath("default"),a=await e.exists(t),s=await e.exists(i),o=await e.exists(r);if(!a&&o)return;let l=new Date().toISOString();if(await this.ensureFolder(n),a&&!s)try{await e.rename(t,i)}catch(c){try{let d=await e.read(t);await e.write(i,d),await e.remove(t)}catch(d){console.warn("Failed to migrate legacy chat history",d)}}if(!o){let c=[{id:"default",name:"New chat",createdAt:l,updatedAt:l}];await this.writeChatSessionsIndex({version:1,active:"default",sessions:c})}if(o)try{let c=await e.read(r),d=this.asRecord(JSON.parse(c)),u=Array.isArray(d==null?void 0:d.sessions)?d.sessions:[],p=u.some(b=>{let y=this.asRecord(b);return(y==null?void 0:y.id)==="default"}),g=u.map(b=>this.asRecord(b)).filter(b=>!!b).map(b=>b.id==="default"&&typeof b.name=="string"&&b.name.trim().toLowerCase()==="default"?{...b,name:"New chat"}:b);p&&JSON.stringify(g)!==JSON.stringify(u)&&await this.writeChatSessionsIndex({version:1,active:typeof(d==null?void 0:d.active)=="string"?d.active:"default",sessions:g.map(b=>{var y;return{id:String((y=b.id)!=null?y:""),name:typeof b.name=="string"?b.name:"New chat",createdAt:typeof b.createdAt=="string"?b.createdAt:l,updatedAt:typeof b.updatedAt=="string"?b.updatedAt:l}})})}catch(c){}}isPlaceholderChatName(e){let t=(e||"").trim().toLowerCase();return t==="new chat"||t==="default"}normalizeChatTitle(e){let t=(e||"").replace(/\s+/g," ").trim();return t.length>60?`${t.slice(0,57)}...`:t}guessTitleFromMessages(e){let t=e.find(r=>r.role==="user"&&r.content.trim());if(!t)return"New chat";let n=t.content.replace(/\s+/g," ").trim().split(" ").slice(0,8).join(" ");return this.normalizeChatTitle(n||"New chat")}async suggestChatTitleWithLlm(e){var a,s,o;let t=(this.settings.chatBaseUrl||"").trim(),n=(this.settings.chatModel||"").trim();if(!t||!n)return null;let r=t.replace(/\/$/,"");if(r.toLowerCase().includes("api.openai.com")&&(!this.settings.chatApiKey||n.includes("/")))return null;try{let l=`${r}/chat/completions`,c={"Content-Type":"application/json"};this.settings.chatApiKey&&(c.Authorization=`Bearer ${this.settings.chatApiKey}`);let d=e.slice(-8).map(y=>`${y.role.toUpperCase()}: ${y.content}`).join(`
`).slice(0,4e3),p=await(0,m.requestUrl)({url:l,method:"POST",headers:c,body:JSON.stringify({model:n,temperature:.2,messages:[{role:"system",content:"Generate a short, specific title (3-7 words) for the chat. No quotes, no punctuation at the end."},{role:"user",content:d}]}),throw:!1});if(p.status>=400)return null;let g=p.json,b=(o=(s=(a=g==null?void 0:g.choices)==null?void 0:a[0])==null?void 0:s.message)==null?void 0:o.content;return typeof b!="string"?null:this.normalizeChatTitle(b.replace(/^"|"$/g,"").trim())}catch(l){return console.warn("Chat title suggestion failed",l),null}}async finalizeChatSessionNameIfNeeded(e,t,n={}){var c;if(!e)return;let r=t||[];if(!r.some(d=>d.role==="user"&&d.content.trim())||!n.force&&r.length<4)return;let s=((c=(await this.readChatSessionsIndex()).sessions)!=null?c:[]).find(d=>d.id===e);if(!s||!this.isPlaceholderChatName(s.name))return;let l=await this.suggestChatTitleWithLlm(r)||this.guessTitleFromMessages(r);!l||this.isPlaceholderChatName(l)||await this.renameChatSession(e,l)}getRagWorkerTimeoutSec(){let e=$n;if(this.settings.enableCrossEncoderRerank&&(e+=Vn),this.settings.enableAgenticRag){let t=Number.isFinite(this.settings.agenticMaxIters)?Math.max(1,Math.trunc(this.settings.agenticMaxIters)):2;e+=Math.max(an,t*an)}return Math.min(3600,Math.max(60,e))}isRagQueryCancellationMessage(e){let t=(e||"").toLowerCase();return t.includes("python worker request aborted")||t.includes("request aborted")||t.includes("request canceled")||t.includes("request cancelled")||t.includes("canceled_while_waiting_rag_slot")||t.includes("cancelled_while_waiting_rag_slot")||t.includes("client_disconnected")||t.includes("error: canceled")||t.includes("error: cancelled")}cancelActiveRagQuery(){this.activeChatQueryCancelRequested=!0;let e=this.activeChatQueryProcess;if(!e)return!1;if(e.killed)return!0;try{return e.kill("SIGTERM"),!0}catch(t){console.warn("Failed to cancel active RAG query with SIGTERM",t);try{return e.kill(),!0}catch(n){return console.warn("Failed to cancel active RAG query",n),!1}}}async runRagQueryStreaming(e,t,n,r=[]){if(this.activeChatQueryProcess=null,this.activeChatQueryCancelRequested=!1,await this.ensureBundledTools(),!await this.ensureRedisAvailable("chat query")){n({answer:"Redis is not reachable. Please start Redis Stack and try again."});return}let i=this.getPluginDir(),a=R.default.join(i,"tools","rag_query_redisearch.py"),s=["--query",e,"--k","5","--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--chat-base-url",this.settings.chatBaseUrl,"--chat-api-key",this.settings.chatApiKey,"--chat-model",this.settings.chatModel,"--temperature",String(this.settings.chatTemperature),"--stream"];if(this.settings.enableQueryExpansion&&(s.push("--expand-query"),s.push("--expand-count",String(Math.max(1,Math.trunc(this.settings.queryExpansionCount))))),this.settings.enableCrossEncoderRerank){s.push("--rerank");let c=(this.settings.rerankModel||"").trim();c&&s.push("--rerank-model",c)}Number.isFinite(this.settings.rerankCandidateMultiplier)&&s.push("--rerank-candidates",String(Math.max(1,Math.trunc(this.settings.rerankCandidateMultiplier)))),Number.isFinite(this.settings.rrfK)&&s.push("--rrf-k",String(Math.max(1,Math.trunc(this.settings.rrfK)))),Number.isFinite(this.settings.rrfLogTop)&&this.settings.rrfLogTop>0&&s.push("--rrf-log-top",String(Math.max(1,Math.trunc(this.settings.rrfLogTop)))),Number.isFinite(this.settings.maxChunksPerDoc)&&this.settings.maxChunksPerDoc>0&&s.push("--max-per-doc",String(Math.max(1,Math.trunc(this.settings.maxChunksPerDoc)))),this.settings.enableAgenticRag&&(s.push("--agentic","basic"),Number.isFinite(this.settings.agenticMaxIters)&&this.settings.agenticMaxIters>0&&s.push("--agentic-max-iters",String(Math.max(1,Math.trunc(this.settings.agenticMaxIters)))),s.push("--agentic-full-doc-chunks",String(qn),"--agentic-full-doc-max-chars",String(jn)));let o=this.buildChatHistoryPayload(r),l=await this.writeChatHistoryTemp(o);l!=null&&l.absolutePath&&s.push("--history-file",l.absolutePath);try{let c=this.getRagWorkerTimeoutSec(),d=async()=>{await this.runPythonStreaming(a,s,p=>{let g=this.asRecord(p);if((g==null?void 0:g.type)==="delta"&&typeof g.content=="string"){t(g.content);return}if((g==null?void 0:g.type)==="phase"){this.logPythonWorkerTiming("rag-phase",g);return}if((g==null?void 0:g.type)==="final"){n(g);return}g!=null&&g.answer&&n(g)},n,void 0,"rag_query_redisearch",p=>{if(this.activeChatQueryProcess=p,this.activeChatQueryCancelRequested&&!p.killed)try{p.kill("SIGTERM")}catch(g){console.warn("Failed to cancel queued chat request",g)}},c)},u=!1;for(;;){if(this.activeChatQueryCancelRequested){n({canceled:!0,answer:"Request canceled."});return}try{await d();break}catch(p){let g=this.getPythonErrorMessage(p);if(this.activeChatQueryCancelRequested||this.isRagQueryCancellationMessage(g)){n({canceled:!0,answer:"Request canceled."});return}let b=this.classifyIndexingError(g);if(b==="embed_dim_mismatch"){if(u){n({answer:"Embedding dimension mismatch persists after rebuild. Check the embedding model settings."});return}if(!await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema.")){n({answer:"Embedding dimension mismatch. Switch models or drop/rebuild the Redis index."});return}try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){let f=this.lastReindexFailure==="embed_failure"?"Embedding provider error detected while rebuilding the index. Fix settings and retry.":"Redis index rebuild did not complete. Chat query stopped.";n({answer:f});return}}catch(v){console.error(v),n({answer:"Failed to drop/rebuild the Redis index. See console for details."});return}u=!0;continue}if(b==="embed_failure"){n({answer:"Embedding provider error detected. Fix the provider/model settings and retry."});return}throw p}}}finally{if(l!=null&&l.relativePath)try{await this.app.vault.adapter.remove(l.relativePath)}catch(c){console.warn("Failed to remove chat history temp file",c)}this.activeChatQueryProcess=null,this.activeChatQueryCancelRequested=!1}}buildChatHistoryPayload(e){return this.getRecentChatHistory(e).map(n=>({role:n.role,content:n.content}))}async writeChatHistoryTemp(e){if(!e.length)return null;let t=(0,m.normalizePath)(`${re}/tmp`);await this.ensureFolder(t);let n=`chat_history_${Date.now()}_${Math.random().toString(36).slice(2,8)}.json`,r=(0,m.normalizePath)(`${t}/${n}`),i={version:1,messages:e};return await this.app.vault.adapter.write(r,JSON.stringify(i,null,2)),{relativePath:r,absolutePath:this.getAbsoluteVaultPath(r)}}async resolveCitationDisplay(e){let t=await this.getDocIndexEntry(e.doc_id);(!t||!t.note_title||!t.zotero_title||!t.note_path||!t.pdf_path||t.short_title===void 0)&&(t=await this.hydrateDocIndexFromCache(e.doc_id));let n=e.doc_id?await this.resolveNotePathForDocId(e.doc_id):t==null?void 0:t.note_path,r=this.resolveCitationTitle(t,n,e.doc_id),i=this.formatCitationPageLabel(e),a=e.page_start?String(e.page_start):"",s=(t==null?void 0:t.pdf_path)||e.source_pdf||"",o=e.attachment_key||(t==null?void 0:t.attachment_key),l=e.annotation_key||this.extractAnnotationKey(e.chunk_id),c=e.doc_id?this.buildZoteroDeepLink(e.doc_id,o,a,l):void 0;return{noteTitle:r,pageLabel:i,notePath:n||void 0,pdfPath:s||void 0,zoteroUrl:c,pageStart:a||void 0}}resolveCitationTitle(e,t,n){let r=n||"?",i=(e==null?void 0:e.short_title)||(e==null?void 0:e.zotero_title)||(e==null?void 0:e.note_title)||(t?R.default.basename(t,".md"):"")||r;return this.shortenCitationTitle(i)}shortenCitationTitle(e){let t=String(e||"").trim();if(!t)return"?";if(t.length<=on)return t;let n=Math.max(0,on-3);return`${t.slice(0,n).trim()}...`}formatCitationLabel(e,t){let n=e.trim()||"?",r=(t||"").trim();return r?`${n}, p. ${r}`:n}async formatInlineCitations(e,t,n=[]){var c,d,u,p;if(!e)return e;let r=/\[\[?cite:([A-Za-z0-9]+):([^\]\n]+?)\]?\]/g,i=Array.from(e.matchAll(r));if(i.length===0)return e;let a=new Map;for(let g of i){let b=g[0];if(a.has(b))continue;let y=g[1],v=g[2].trim(),f=v.match(/^(\d+)-(\d+)(?::([A-Za-z0-9]+))?$/),k="",x="",w,E,P,S;f?(k=f[1],x=f[2],w=f[3]):S=v;let T=S?n.find(O=>{let Z=typeof O.doc_id=="string"?O.doc_id:"";if(Z&&Z!==y)return!1;let q=typeof O.chunk_id=="string"?O.chunk_id:"";return q?q===S||q===`${y}:${S}`||q.endsWith(`:${S}`):!1}):void 0;T&&(!k&&T.page_start!==void 0&&(k=String(T.page_start)),!x&&T.page_end!==void 0&&(x=String(T.page_end)),!P&&typeof T.attachment_key=="string"&&(P=T.attachment_key),!E&&typeof T.annotation_page_label=="string"&&(E=T.annotation_page_label),!w&&typeof T.chunk_id=="string"&&(w=this.extractAnnotationKey(T.chunk_id)));let I={doc_id:y,chunk_id:T==null?void 0:T.chunk_id,annotation_key:w};P&&(I.attachment_key=P),E&&(I.annotation_page_label=E),(k||x)&&(I.page_start=k||x,I.page_end=x||k,I.pages=`${I.page_start}-${I.page_end}`),T!=null&&T.source_pdf&&(I.source_pdf=String(T.source_pdf));let L=(k||x?t.find(O=>{var Z,q;return O.doc_id===y&&String((Z=O.page_start)!=null?Z:"")===k&&String((q=O.page_end)!=null?q:"")===x}):void 0)||t.find(O=>O.doc_id===y)||I,j=L.annotation_key||w;!L.annotation_key&&j&&(L={...L,annotation_key:j}),!L.attachment_key&&P&&(L={...L,attachment_key:P}),!L.annotation_page_label&&E&&(L={...L,annotation_page_label:E});let F=await this.resolveCitationDisplay(L),M=this.formatCitationLabel(F.noteTitle,F.pageLabel),V=this.normalizeChunkIdForNote(L.chunk_id,y);if(this.settings.preferObsidianNoteForCitations&&F.notePath){if(j){let O=L.attachment_key||P||((d=(c=this.docIndex)==null?void 0:c[y])==null?void 0:d.attachment_key)||"",Z=L.page_start?String(L.page_start):k||x||"0",q=this.buildNoteAnnotationLink(F.notePath,j,O,Z,M);if(q){a.set(b,q);continue}a.set(b,this.buildNoteLink(F.notePath,M));continue}if(V&&!j){a.set(b,this.buildNoteChunkLink(F.notePath,V,M));continue}}if(F.zoteroUrl)a.set(b,`[${M}](${F.zoteroUrl})`);else{let O=this.formatCitationLabel(y,F.pageLabel);a.set(b,`(${O})`)}}let s=[],o=0;for(let g of i){let b=g[0],y=(u=g.index)!=null?u:0;if(y<o)continue;s.push(e.slice(o,y));let v=(p=a.get(b))!=null?p:b,f=y>0?e[y-1]:"";f&&!/\s/.test(f)&&!/[([{!]/.test(f)&&s.push(" "),s.push(v),o=y+b.length}s.push(e.slice(o));let l=s.join("");return this.repairTruncatedWikilinks(l)}repairTruncatedWikilinks(e){if(!e||typeof e!="string")return e;let t=e;return t=t.replace(/\[\[([^\]\n#]+#zrr-chunk:[^\]\n|]+)(?=\n|$)/g,"[[$1]]"),t=t.replace(/\[\[([^\]\n#]+#zrr-chunk:([^\]\n|]+))\]\]/g,(n,r,i)=>{let a=this.escapeWikiLabel(this.buildDefaultChunkLabel(String(i||"").trim()));return`[[${r}\\|${a}]]`}),t}buildDefaultChunkLabel(e){let t=(e||"").trim(),n=t.match(/^p(\d+)$/i);return n?`p. ${n[1]}`:t||"source"}handleDoclingProgress(e,t){let n=this.asRecord(e);if(!n||n.type!=="progress")return;let r=Number(n.percent);if(!Number.isFinite(r))return;let i=typeof n.message=="string"&&n.message.trim()?n.message:"Docling extraction...";this.showStatusProgress(this.formatStatusLabel(i,t),Math.round(r))}async createChatNoteFromSession(e,t,n){let r=this.getChatExportDir();await this.ensureFolder(r),await this.getDocIndex();let i=this.sanitizeFileName(t)||"Zotero Chat",a=this.formatTimestamp(new Date),s=(0,m.normalizePath)(`${r}/${i}.md`),o=await this.resolveUniqueNotePath(s,`${i}-${a}.md`),l=await this.buildChatTranscript(t,n);await this.app.vault.adapter.write(o,l),await this.openNoteInNewTab(o),new m.Notice(`Chat copied to ${o}`)}async buildChatTranscript(e,t){var r,i,a;let n=[];n.push(`# ${e||"Zotero Chat"}`),n.push(""),n.push(`Created: ${new Date().toISOString()}`),n.push("");for(let s of t){let o=s.role==="user"?"## You":"## Assistant";n.push(o),n.push("");let l=s.role==="assistant"?await this.formatInlineCitations(s.content||"",(r=s.citations)!=null?r:[],(i=s.retrieved)!=null?i:[]):s.content||"";if(n.push(l.trim()),n.push(""),s.role==="assistant"&&((a=s.citations)!=null&&a.length)){n.push("### Relevant context sources");let c=this.formatCitationsMarkdown(s.citations);c&&(n.push(c),n.push(""))}}return n.join(`
`).trim()+`
`}async resolveUniqueNotePath(e,t){let n=this.app.vault.adapter;if(!await n.exists(e))return e;let r=R.default.dirname(e),i=(0,m.normalizePath)(R.default.join(r,t));if(!await n.exists(i))return i;let a=2;for(;a<1e3;){let s=(0,m.normalizePath)(R.default.join(r,`${R.default.basename(t,".md")}-${a}.md`));if(!await n.exists(s))return s;a+=1}return i}formatTimestamp(e){let t=n=>String(n).padStart(2,"0");return[e.getFullYear(),t(e.getMonth()+1),t(e.getDate()),"-",t(e.getHours()),t(e.getMinutes())].join("")}async openCitationTarget(e,t){var s,o;let n=t!=null?t:await this.resolveCitationDisplay(e),r=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id),i=e.annotation_key||this.extractAnnotationKey(e.chunk_id);if(this.settings.preferObsidianNoteForCitations&&n.notePath){if(i){let l=e.attachment_key||((o=(s=this.docIndex)==null?void 0:s[e.doc_id||""])==null?void 0:o.attachment_key)||"",c=e.page_start?String(e.page_start):e.page_end?String(e.page_end):"0";if(await this.openNoteAtAnnotation(n.notePath,i,l,c))return}if(r&&!i&&await this.openNoteAtChunk(n.notePath,r))return;await this.openNoteInMain(n.notePath);return}if(n.zoteroUrl){this.openExternalUrl(n.zoteroUrl);return}if(!(n.pdfPath&&await this.openPdfInMain(n.pdfPath,n.pageStart))){if(n.zoteroUrl){this.openExternalUrl(n.zoteroUrl);return}new m.Notice("Unable to open citation target.")}}async rebuildNoteFromCache(){let e=await this.promptDocId();if(!e){new m.Notice("No doc_ID provided.");return}await this.rebuildNoteFromCacheForDocId(e,!0)&&new m.Notice(`Rebuilt Zotero note for ${e}.`)}async reindexCurrentNoteFromCache(){let e=this.app.workspace.getActiveFile();if(!e){new m.Notice("No active note to reindex.");return}await this.reindexNoteFromCacheForFile(e,!0)}async reindexNoteFromCacheForFile(e,t){try{let n=await this.app.vault.read(e),r=await this.resolveDocIdForNote(e,n);if(!r){t&&new m.Notice("No doc_ID found for this note.");return}await this.reindexDocIdFromCache(r,t)&&t&&new m.Notice(`Reindexed ${r}.`)}catch(n){t&&new m.Notice("Failed to reindex note."),console.error("Failed to reindex note",n)}}async rebuildDocIndexFromCache(){var c,d,u;let e=this.app.vault.adapter,t=await this.listDocIds(oe),n=await this.listDocIds(ee),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),i=Object.keys(r),a=Array.from(new Set([...t,...n,...i]));if(a.length===0){new m.Notice("No cached items found.");return}this.showStatusProgress("Rebuilding doc index...",0);let s=await this.getDocIndex(),o=0;for(let p of a){o+=1;let g={},b=r[p];b&&(g.note_path=b.note_path,g.note_title=b.note_title);let y=(0,m.normalizePath)(`${oe}/${p}.json`);if(await e.exists(y))try{let k=await e.read(y),x=JSON.parse(k),w=(d=(c=x==null?void 0:x.data)!=null?c:x)!=null?d:{},E=typeof w.title=="string"?w.title:"";E&&(g.zotero_title=E);let P=Ae(w);P&&(g.short_title=P);let S=this.sanitizeFileName(E)||p,T=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${S}.md`),I=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${S}-${p}.md`);await e.exists(T)?(g.note_path=T,g.note_title=R.default.basename(T,".md")):await e.exists(I)&&(g.note_path=I,g.note_title=R.default.basename(I,".md"))}catch(k){console.error("Failed to read cached item JSON",k)}let v=(0,m.normalizePath)(`${ee}/${p}.json`);if(await e.exists(v))try{let k=await e.read(v),x=JSON.parse(k);typeof(x==null?void 0:x.source_pdf)=="string"&&(g.pdf_path=x.source_pdf)}catch(k){console.error("Failed to read cached chunks JSON",k)}if(Object.keys(g).length>0){let x={...(u=s[p])!=null?u:{doc_id:p},...g,doc_id:p,updated_at:new Date().toISOString()};!x.note_title&&x.note_path&&(x.note_title=R.default.basename(x.note_path,".md")),typeof x.pdf_path=="string"&&(x.pdf_path=this.normalizeDocIndexPdfPath(x.pdf_path)),s[p]=x}let f=Math.round(o/a.length*100);this.showStatusProgress(`Rebuilding doc index ${o}/${a.length}`,f)}await this.saveDocIndex(s);let l=await this.pruneDocIndexOrphans();this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),l.removed>0?new m.Notice(`Rebuilt doc index for ${a.length} items; pruned ${l.removed} stale entries.`):new m.Notice(`Rebuilt doc index for ${a.length} items.`)}async recreateMissingNotesFromCache(){if(this.recreateMissingNotesActive){new m.Notice("Recreate missing notes is already running.");return}this.recreateMissingNotesActive=!0,this.recreateMissingNotesAbort=!1,this.recreateMissingNotesProcess=null;try{let e=this.app.vault.adapter,t=await this.listDocIds(oe),n=await this.listDocIds(ee),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),i=Object.keys(r),a=Array.from(new Set([...t,...n,...i]));if(a.length===0){new m.Notice("No cached items found.");return}let s=[];for(let c of a){if(r[c])continue;let d=await this.getDocIndexEntry(c);if(d!=null&&d.note_path&&await e.exists(d.note_path))continue;let u=await this.inferNotePathFromCache(c);u&&await e.exists(u)||s.push(c)}if(s.length===0){new m.Notice("No missing notes detected.");return}this.showStatusProgress("Recreating missing notes...",0);let o=0,l=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;for(let c=0;c<s.length&&!this.recreateMissingNotesAbort;c+=1){let d=s[c],u=Math.round((c+1)/s.length*100);this.showStatusProgress(`Recreating ${c+1}/${s.length}`,u),l&&this.appendToLogFile(l,`Recreate missing note doc_id ${d} (${c+1}/${s.length})`,"recreate_missing_notes","INFO"),await this.rebuildNoteFromCacheForDocId(d,!1)&&(o+=1)}this.recreateMissingNotesAbort?(this.showStatusProgress("Canceled",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice(`Canceled after ${o}/${s.length} notes.`)):(this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice(`Recreated ${o}/${s.length} missing notes.`))}finally{this.recreateMissingNotesActive=!1,this.recreateMissingNotesProcess=null}}cancelRecreateMissingNotesFromCache(){if(!this.recreateMissingNotesActive){new m.Notice("No recreate job is running.");return}this.recreateMissingNotesAbort=!0;let e=this.recreateMissingNotesProcess;if(e&&!e.killed){try{e.kill("SIGTERM")}catch(t){console.warn("Failed to terminate recreate process",t)}window.setTimeout(()=>{if(e&&!e.killed)try{e.kill("SIGKILL")}catch(t){console.warn("Failed to force-kill recreate process",t)}},2e3)}new m.Notice("Canceling recreate missing notes...")}buildRedisCommand(e){let t=[`*${e.length}\r
`];for(let n of e){let r=String(n);t.push(`$${Buffer.byteLength(r)}\r
${r}\r
`)}return t.join("")}async checkRedisConnectionWithUrl(e,t=2e3){let n=(e||"").trim();if(!n)return{ok:!1,message:"Redis URL is not configured."};let r;try{r=new URL(n)}catch(c){return{ok:!1,message:"Redis URL is invalid."}}let i=r.hostname||"127.0.0.1",a=Number(r.port)||(r.protocol==="rediss:"||r.protocol==="redis+tls:"?6380:6379),s=decodeURIComponent(r.username||""),o=decodeURIComponent(r.password||""),l=r.protocol==="rediss:"||r.protocol==="redis+tls:";return new Promise(c=>{let d=l?pn.default.connect({host:i,port:a,timeout:t,rejectUnauthorized:!1}):Ie.default.createConnection({host:i,port:a,timeout:t}),u="",p=o||s?"auth":"ping",g=!1,b=(v,f)=>{if(!g){g=!0;try{d.end(),d.destroy()}catch(k){}c({ok:v,message:f})}},y=v=>{let f=v.trim();if(f){if(f.startsWith("-NOAUTH")){b(!1,"Redis requires authentication. Check your Redis URL credentials.");return}if(f.startsWith("-WRONGPASS")||f.toLowerCase().includes("invalid password")){b(!1,"Redis authentication failed. Check your Redis URL credentials.");return}if(f.startsWith("-ERR")){b(!1,`Redis error: ${f}`);return}if(p==="auth"){if(f.startsWith("+OK")){p="ping",u="",d.write(this.buildRedisCommand(["PING"]));return}b(!1,`Redis auth failed: ${f}`);return}f.startsWith("+PONG")&&b(!0)}};d.on("connect",()=>{if(p==="auth"){let v=s?["AUTH",s,o]:["AUTH",o];d.write(this.buildRedisCommand(v))}else d.write(this.buildRedisCommand(["PING"]))}),d.on("data",v=>{var k;u+=v.toString();let f=u.split(/\r?\n/);u=(k=f.pop())!=null?k:"";for(let x of f)y(x)}),d.on("timeout",()=>{b(!1,"Timed out connecting to Redis.")}),d.on("error",v=>{b(!1,`Redis connection failed: ${v.message}`)}),d.on("close",()=>{g||b(!1,"Redis connection closed unexpectedly.")})})}async checkRedisConnection(e=2e3){return this.checkRedisConnectionWithUrl(this.settings.redisUrl,e)}async ensureRedisAvailable(e){let t=await this.checkRedisConnection();if(t.ok)return!0;let n=t.message?`Redis unavailable for ${e}: ${t.message}`:`Redis unavailable for ${e}.`;return this.notifyContainerOnce(n),!1}getPythonErrorMessage(e){if(e instanceof Error)return e.message||String(e);if(typeof e=="string")return e;try{return JSON.stringify(e)}catch(t){return String(e)}}classifyIndexingError(e){let t=e.toLowerCase();return t.includes("embedding dim mismatch")||t.includes("dim mismatch")?"embed_dim_mismatch":t.includes("chunks json not found")?"chunks_missing":t.includes("embedding failed")||t.includes("embedding request failed")||t.includes("unloaded")||t.includes("crashed")||t.includes("model does not exist")||t.includes("failed to load model")||t.includes("connection refused")||t.includes("econnrefused")||t.includes("max retries exceeded")||t.includes("failed to establish a new connection")||t.includes("failed to fetch models")?"embed_failure":"unknown"}async confirmRebuildIndex(e){return new Promise(t=>{new et(this.app,e,t).open()})}async confirmPurgeRedisOrphans(){return new Promise(e=>{new tt(this.app,e).open()})}async dropRedisIndex(e=!1){await this.ensureBundledTools();let t=this.getPluginDir(),n=R.default.join(t,"tools","drop_redis_index.py"),r=["--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName()];e&&r.push("--drop-docs"),await this.runPython(n,r)}async dropAndRebuildRedisIndex(){if(this.reindexCacheActive){new m.Notice("Reindex already running.");return}if(!(!await this.ensureRedisAvailable("drop/rebuild")||!await this.confirmRebuildIndex("This will remove the current RedisSearch index and rebuild it from cached chunks."))){try{await this.dropRedisIndex(!0)}catch(t){let n=t instanceof Error?t.message:String(t);if(n.includes("Unknown Index name")||n.includes("Unknown index name"))console.warn("Redis index missing; skipping drop step.");else{console.error("Failed to drop Redis index",t),new m.Notice("Failed to drop redis index. See console for details.");return}}await this.reindexRedisFromCache()}}async purgeRedisOrphanedKeys(){var i,a,s,o,l;if(!await this.ensureRedisAvailable("purge orphans")||!await this.confirmPurgeRedisOrphans())return;try{await this.ensureBundledTools()}catch(c){new m.Notice("Failed to sync bundled tools. See console for details."),console.error(c);return}let t=this.getPluginDir(),n=R.default.join(t,"tools","purge_redis_orphans.py"),r=["--redis-url",this.settings.redisUrl,"--key-prefix",this.getRedisKeyPrefix(),"--chunk-dir",this.getAbsoluteVaultPath(ee),"--item-dir",this.getAbsoluteVaultPath(oe)];try{let c=await this.runPythonWithOutput(n,r),d=null;try{d=c?JSON.parse(c):null}catch(x){console.warn("Failed to parse purge output",x)}if(!d){new m.Notice("Purge completed. See console for details.");return}let u=(i=this.asRecord(d))!=null?i:{},p=Number((a=u.keys_scanned)!=null?a:0),g=Number((s=u.keys_deleted)!=null?s:0),b=Number((o=u.docs_checked)!=null?o:0),y=Number((l=u.orphan_doc_count)!=null?l:0),v=[`Keys scanned: ${p}`,`Keys deleted: ${g}`,`Docs checked: ${b}`,`Orphan docs: ${y}`],f=await this.pruneDocIndexOrphans();v.push(`Doc index entries removed: ${f.removed}`),f.updated>0&&v.push(`Doc index entries updated: ${f.updated}`);let k=Array.isArray(u.sample_orphan_doc_ids)?u.sample_orphan_doc_ids.filter(Boolean):[];k.length&&v.push("","Sample doc_ids:",...k.map(x=>`- ${x}`)),new Ee(this.app,"Redis orphan purge",v.join(`
`)).open(),g===0?new m.Notice("No orphaned redis keys found."):new m.Notice(`Deleted ${g} Redis keys.`)}catch(c){console.error("Failed to purge Redis orphans",c),new m.Notice("Failed to purge redis orphans. See console for details.")}}async reindexRedisFromCache(){if(this.lastReindexFailure=null,this.reindexCacheActive)return new m.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;let e=null,t=0;try{await this.ensureBundledTools()}catch(o){return new m.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let n=await this.listDocIds(ee);if(n.length===0)return new m.Notice("No cached chunks found."),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let r=this.getPluginDir(),i=R.default.join(r,"tools","index_redisearch.py"),a=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null,s=0;this.showStatusProgress("Reindexing cached chunks...",0),a&&this.appendToLogFile(a,`Reindex started: ${n.length} cached items`,"index_redisearch","INFO");for(let o of n){s+=1;let l=Math.round(s/n.length*100);this.showStatusProgress(`Reindexing ${s}/${n.length}`,l);let c=(0,m.normalizePath)(`${ee}/${o}.json`);try{let d=["--chunks-json",this.getAbsoluteVaultPath(c),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(d),this.appendEmbedContextArgs(d),this.settings.embedIncludeMetadata&&d.push("--embed-include-metadata"),this.appendChunkTaggingArgs(d,{allowRegenerate:!1}),a&&this.appendToLogFile(a,`Reindexing doc_id ${o}`,"index_redisearch","INFO"),await this.runPythonStreaming(i,d,u=>{let p=this.asRecord(u);!a||!p||p.type==="progress"&&p.message&&this.appendToLogFile(a,String(p.message),"index_redisearch","INFO")},()=>{},a,"index_redisearch")}catch(d){t+=1;let u=this.getPythonErrorMessage(d),p=this.classifyIndexingError(u);if(console.error(`Failed to reindex ${o}`,d),p==="chunks_missing"){new m.Notice(`Chunks cache missing for ${o}. Reimport or rebuild this note.`);continue}if(p==="embed_dim_mismatch"){e={kind:"embed_dim_mismatch",message:u};break}if(p==="embed_failure"){e={kind:"embed_failure",message:u};break}}}if(e){if(this.showStatusProgress("Aborted",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,e.kind==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(l){return new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(l),this.lastReindexFailure="unknown",!1}this.lastReindexFailure="embed_dim_mismatch"}else new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing."),this.lastReindexFailure="embed_failure";return!1}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),t===0?new m.Notice(`Reindexed ${n.length} cached items.`):new m.Notice(`Reindexed ${n.length-t}/${n.length} items (see console).`);try{await this.pruneDocIndexOrphans()}catch(o){console.warn("Failed to prune doc index orphans",o)}return this.reindexCacheActive=!1,this.lastReindexFailure=null,!0}async reindexDocIdFromCache(e,t){if(this.lastReindexFailure=null,this.reindexCacheActive)return t&&new m.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;try{await this.ensureBundledTools()}catch(o){return t&&new m.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let n=(0,m.normalizePath)(`${ee}/${e}.json`);if(!await this.app.vault.adapter.exists(n))return t&&new m.Notice(`Chunks cache missing for ${e}.`),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let i=this.getPluginDir(),a=R.default.join(i,"tools","index_redisearch.py"),s=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;this.showStatusProgress(`Reindexing ${e}...`,0),s&&this.appendToLogFile(s,`Reindexing doc_id ${e}`,"index_redisearch","INFO");try{let o=["--chunks-json",this.getAbsoluteVaultPath(n),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(o),this.appendEmbedContextArgs(o),this.settings.embedIncludeMetadata&&o.push("--embed-include-metadata"),this.appendChunkTaggingArgs(o,{allowRegenerate:!1}),await this.runPythonStreaming(a,o,l=>{let c=this.asRecord(l),d=typeof(c==null?void 0:c.total)=="number"?c.total:0,u=typeof(c==null?void 0:c.current)=="number"?c.current:0;if((c==null?void 0:c.type)==="progress"&&d>0){let p=Math.round(u/d*100),g=typeof c.message=="string"&&c.message.trim()?c.message:`Indexing chunks ${u}/${d}`;this.showStatusProgress(this.formatStatusLabel(g),p)}},()=>{},s,"index_redisearch")}catch(o){let l=this.getPythonErrorMessage(o),c=this.classifyIndexingError(l);if(console.error(`Failed to reindex ${e}`,o),c==="embed_dim_mismatch"){if(this.lastReindexFailure="embed_dim_mismatch",t&&await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),this.reindexCacheActive=!1,await this.reindexRedisFromCache()}catch(u){new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(u),this.lastReindexFailure="unknown"}}else c==="embed_failure"?(this.lastReindexFailure="embed_failure",t&&new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing.")):t&&new m.Notice(`Failed to reindex ${e}. See console for details.`);return this.showStatusProgress("Failed",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!1}return this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!0}async reindexChunkUpdates(e,t,n,r){if(!n.length&&!r.length||!await this.ensureRedisAvailable("reindex updates"))return;let i=this.getPluginDir(),a=R.default.join(i,"tools","index_redisearch.py"),s=["--chunks-json",this.getAbsoluteVaultPath(t),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert"];this.appendEmbedSubchunkArgs(s),this.appendEmbedContextArgs(s),this.settings.embedIncludeMetadata&&s.push("--embed-include-metadata"),this.appendChunkTaggingArgs(s,{allowRegenerate:!1}),n.length&&s.push("--chunk-ids",n.join(",")),r.length&&s.push("--delete-chunk-ids",r.join(","));try{await this.runPython(a,s)}catch(o){let l=this.getPythonErrorMessage(o),c=this.classifyIndexingError(l);if(console.error(`Failed to reindex updated chunks for ${e}`,o),c==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(u){new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(u)}return}c==="embed_failure"&&new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.")}}async promptZoteroItem(){return new Promise(e=>{new st(this.app,this,e).open()})}async listDocIds(e){let t=this.app.vault.adapter,n=(0,m.normalizePath)(e);return await t.exists(n)?(await t.list(n)).files.filter(i=>i.endsWith(".json")).map(i=>R.default.basename(i,".json")):[]}async listMarkdownFiles(e){let t=this.app.vault.adapter,n=(0,m.normalizePath)(e);if(!await t.exists(n))return[];let r=[n],i=[];for(;r.length>0;){let a=r.pop();if(!a)continue;let s=await t.list(a);for(let o of s.files)o.endsWith(".md")&&i.push(o);for(let o of s.folders)r.push(o)}return i}getZoteroFrontmatterKeyVariants(e){let t=e.replace(/_/g," "),n=new Set([t,e,e.replace(/_/g,"-")]);if(e.includes("_")){let r=e.split("_"),i=r[0]+r.slice(1).map(a=>a.charAt(0).toUpperCase()+a.slice(1)).join("");n.add(i)}return Array.from(n)}getFrontmatterValue(e,t){if(!e)return;let n=this.getZoteroFrontmatterKeyVariants(t);for(let r of n)if(Object.prototype.hasOwnProperty.call(e,r))return e[r]}hasFrontmatterKey(e,t){if(!e)return!1;let n=this.getZoteroFrontmatterKeyVariants(t);for(let r of n)if(Object.prototype.hasOwnProperty.call(e,r))return!0;return!1}normalizeZoteroFrontmatterKeys(e){let t=!1;for(let n of cn){let r=n.replace(/_/g," "),i=this.getZoteroFrontmatterKeyVariants(n),a=Object.prototype.hasOwnProperty.call(e,r),s=a?e[r]:void 0;if(!a){for(let o of i)if(o!==r&&Object.prototype.hasOwnProperty.call(e,o)){s=e[o];break}}if(s!==void 0){a||(e[r]=s,t=!0);for(let o of i)o!==r&&Object.prototype.hasOwnProperty.call(e,o)&&(delete e[o],t=!0)}}return t}async normalizeZoteroFrontmatterKeysInFile(e){let t=this.app.metadataCache.getFileCache(e),n=t==null?void 0:t.frontmatter;if(!n)return;let r=this.getFrontmatterValue(n,"doc_id"),i=this.getFrontmatterValue(n,"zotero_key");if(!r&&!i)return;let a={...n};if(!this.normalizeZoteroFrontmatterKeys(a))return;let s=e.path;this.noteSyncSuppressed.add(s),this.noteMetadataSyncSuppressed.add(s);try{await this.app.fileManager.processFrontMatter(e,o=>{this.normalizeZoteroFrontmatterKeys(o)})}catch(o){console.warn("Failed to normalize Zotero frontmatter keys",o)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(s),this.noteMetadataSyncSuppressed.delete(s)},1500)}}normalizeFrontmatterKeySpacing(e){return e.trim()?e.split(/\r?\n/).map(r=>{var l,c;if(/^\s+-\s+/.test(r)||!r.includes(":")||((c=(l=r.match(/^\s*/))==null?void 0:l[0])!=null?c:""))return r;let a=r.indexOf(":");if(a<=0)return r;let s=r.slice(0,a).trim(),o=r.slice(a);for(let d of cn){let u=d.replace(/_/g," ");if(this.getZoteroFrontmatterKeyVariants(d).includes(s))return`${u}${o}`}return r}).join(`
...
`;n.replaceRange(l,{line:i.startLine+1,ch:0},{line:i.endLine,ch:0}),this.showStatusProgress("Chunk cleaned.",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice("Chunk cleaned.")}async requestOcrCleanup(e){var l,c,d,u,p,g,b,y,v;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new m.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let r=Number(this.settings.llmCleanupMaxChars||0);if(r>0&&e.length>r)return new m.Notice("Chunk exceeds ocr cleanup max length. Adjust settings to clean it."),this.openPluginSettings(),null;let i=`${t}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o={model:n,temperature:Number((l=this.settings.llmCleanupTemperature)!=null?l:0),messages:[{role:"system",content:"You are an OCR cleanup assistant. Fix OCR errors without changing meaning. Do not add content. Return corrected text only. Detect footnote references and definitions and format them in Markdown as [^n] and [^n]: (for the note text). Preserve special characters and formatting. Do not create new footnotes or content; only reformat existing footnote markers/lines."},{role:"user",content:e}]};try{let f=await this.requestLocalApiRaw(i,{method:"POST",headers:a,body:JSON.stringify(o)});if(f.statusCode>=400){let E=f.body.toString("utf8");throw new Error(`Cleanup request failed (${f.statusCode}): ${E||"no response body"}`)}let k=JSON.parse(f.body.toString("utf8")),x=(v=(y=(b=(u=(d=(c=k==null?void 0:k.choices)==null?void 0:c[0])==null?void 0:d.message)==null?void 0:u.content)!=null?b:(g=(p=k==null?void 0:k.choices)==null?void 0:p[0])==null?void 0:g.text)!=null?y:k==null?void 0:k.output_text)!=null?v:"",w=String(x||"").trim();return w||(new m.Notice("Cleanup returned empty text."),null)}catch(f){return console.error("OCR cleanup failed",f),new m.Notice("Ocr cleanup failed. Check the cleanup model settings."),null}}parseChunkTags(e,t){if(!e)return[];let n=e.trim(),r=[];if(n.startsWith("[")&&n.endsWith("]"))try{let s=JSON.parse(n);Array.isArray(s)&&(r=s.map(o=>String(o)))}catch(s){r=[]}r.length===0&&(r=n.split(/[,;\n]+/));let i=new Set,a=[];for(let s of r){let o=s.trim();if(o=o.replace(/^[-•\d.)\s]+/,""),o=o.replace(/\s+/g," ").trim(),!o||o.length<2)continue;let l=o.toLowerCase();if(!i.has(l)&&(i.add(l),a.push(o),a.length>=t))break}return a}async requestChunkTags(e){var u,p,g,b,y,v,f,k,x;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new m.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let r=e.trim().slice(0,2e3);if(!r)return[];let i=`${t}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o=5,l="Return 3 to 5 high-signal, concrete noun-phrase tags. Avoid generic terms (study, paper, method), verbs, and filler. Prefer specific entities, methods, datasets, and named concepts. Output comma-separated tags only. No extra text.",c=Number((u=this.settings.llmCleanupTemperature)!=null?u:0),d={model:n,messages:[{role:"system",content:l},{role:"user",content:r}]};Number.isFinite(c)&&(d.temperature=c),this.showStatusProgress("Generating tags...",null);try{let w=async I=>{let L=await this.requestLocalApiRaw(i,{method:"POST",headers:a,body:JSON.stringify(I)});if(L.statusCode>=400){let j=L.body.toString("utf8");throw new Error(`Tag request failed (${L.statusCode}): ${j||"no response body"}`)}return L.body},E;try{E=await w(d)}catch(I){let L=I instanceof Error?I.message:String(I);if("temperature"in d&&/temperature/i.test(L)&&/unsupported|default/i.test(L)){let j={...d};delete j.temperature,E=await w(j)}else throw I}let P=JSON.parse(E.toString("utf8")),S=(x=(k=(f=(b=(g=(p=P==null?void 0:P.choices)==null?void 0:p[0])==null?void 0:g.message)==null?void 0:b.content)!=null?f:(v=(y=P==null?void 0:P.choices)==null?void 0:y[0])==null?void 0:v.text)!=null?k:P==null?void 0:P.output_text)!=null?x:"",T=this.parseChunkTags(String(S||""),o);return T.length||new m.Notice("Tag generation returned no tags."),T}catch(w){return console.error("Tag generation failed",w),new m.Notice("Tag generation failed. Check the cleanup model settings."),null}finally{this.clearStatusProgress()}}async renderMarkdownToIndexText(e){if(!e)return"";let t=this.replaceImageMarkersForIndexPreview(e),n=document.createElement("div"),r=new m.Component;r.load();try{await m.MarkdownRenderer.render(this.app,t,n,"",r)}catch(a){return console.warn("Failed to render markdown for index preview",a),this.normalizeIndexPreviewText(t)}finally{r.unload()}let i=n.textContent||t;return this.normalizeIndexPreviewText(i)}replaceImageMarkersForIndexPreview(e){if(!e)return"";let t=r=>{let i=r.trim();return i?`Image caption: ${i}`:"Image"},n=e.replace(/!\[\[([^\]|]+)(?:\|([^\]]+))?\]\]/g,(r,i,a)=>t(a||""));return n=n.replace(/!\[([^\]]*)]\([^)]+\)/g,(r,i)=>t(i||"")),n=n.replace(/<img[^>]*>/gi,r=>{let i=r.match(/\balt=(['"])([^'"]*)\1/i);return t(i?i[2]:"")}),n}normalizeIndexPreviewText(e){return e.replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/[ \t]+/g," ").replace(/\n{3,}/g,`

`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,t=1200){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let r=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},t);this.noteSyncTimers.set(e.path,r)}scheduleNoteMetadataSync(e,t=1200,n="save"){let r=this.noteMetadataSyncTimers.get(e.path);r!==void 0&&window.clearTimeout(r);let i=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,n)},t);this.noteMetadataSyncTimers.set(e.path,i)}scheduleNoteAnnotationSync(e,t=1200,n="save"){let r=this.noteAnnotationSyncTimers.get(e.path);r!==void 0&&window.clearTimeout(r);let i=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,n)},t);this.noteAnnotationSyncTimers.set(e.path,i)}getAnnotationGraceRemaining(e){let t=this.annotationNoteEditTimes.get(e);if(!t)return 0;let n=Date.now()-t;return n>=ln?0:ln-n}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let t=(e.annotation_page_label||"").trim();if(t)return t;let n=e.page_start?String(e.page_start):"",r=e.page_end?String(e.page_end):"";if(n&&(!r||n===r))return n;if(n&&r)return`${n} - ${r}`;let i=(e.pages||"").trim();if(!i)return"?";let a=i.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:i.replace("-"," - ")}normalizeChunkIdForNote(e,t){if(!e)return null;let n=String(e);if(t&&n.startsWith(`${t}:`))return n.slice(t.length+1);if(n.includes(":")){let r=n.split(":");if(r.length>1&&t&&r[0]===t)return r.slice(1).join(":")}return n}async syncNoteToRedis(e){var t,n,r;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let i=await this.app.vault.read(e),a=this.extractSyncSection(i);if(!a)return;let s=await this.resolveDocIdForNote(e,i);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,m.normalizePath)(`${ee}/${s}.json`),c=this.app.vault.adapter;if(!await c.exists(l))return;let d=await this.readChunkPayload(l);if(!d)return;let u=Array.isArray(d.chunks)?d.chunks:[],p=new Map;for(let x of u){if(this.isAnnotationChunk(x))continue;let w=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((t=x==null?void 0:x.chunk_id)!=null?t:"");w&&p.set(w,x)}let g=new Set,b=new Set,y=new Set,v=new Set,f=!1;for(let x of o){let w=x.chunkId;if(!w)continue;g.add(w);let E=p.get(w);if(!E){console.warn(`Sync note: chunk id not found in cache (${w})`);continue}if(x.excludeFlag){E.excluded!==!0&&(E.excluded=!0,f=!0);let T=this.normalizeChunkText(x.text);T&&T!==String((n=E.text)!=null?n:"")&&(E.text=T,E.char_count=T.length,f=!0),y.add(w);continue}if(E.excluded&&(E.excluded=!1,f=!0,b.add(w)),!x.text.trim()){y.add(w),v.add(w);continue}let P=this.normalizeChunkText(x.text);if(!P){y.add(w),v.add(w);continue}let S=typeof E.text=="string"?E.text:String((r=E.text)!=null?r:"");P!==S&&(E.text=P,E.char_count=P.length,b.add(w),f=!0)}for(let x of p.keys())g.has(x)||(y.add(x),v.add(x));let k=new Set([...y,...v]);if(k.size){let x=Array.from(k).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==x){this.noteSyncPendingDeletes.set(e.path,x),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!b.size&&!y.size&&!v.size&&!f)return;v.size&&(d.chunks=u.filter(x=>{var E;let w=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((E=x==null?void 0:x.chunk_id)!=null?E:"");return w&&!v.has(w)}),f=!0),(f||v.size)&&await c.write(l,JSON.stringify(d,null,2)),await this.reindexChunkUpdates(s,l,Array.from(b),Array.from(y)),(y.size||v.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(i){console.warn("Failed to sync note edits to Redis",i)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,t){var n,r,i,a;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,t);return}this.noteMetadataSyncInFlight.add(e.path);try{let s=await this.app.vault.read(e),o=await this.resolveDocIdForNote(e,s);if(!o)return;let l=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter;if(!l)return;let c=this.resolveZoteroItemKey(l,o);if(!c)return;let d=this.asRecord(await this.fetchZoteroItem(c)),u=(r=this.asRecord(d==null?void 0:d.data))!=null?r:d;if(!u||typeof u!="object")return;let p=this.extractNoteMetadata(l),g=this.extractZoteroMetadata(u);g.citekey||(g.citekey=await this.resolveZoteroCitekey(u,c,(i=this.asRecord(d==null?void 0:d.meta))!=null?i:{}));let b=await this.getMetadataSnapshot(o,l,e),y={},v={},f={},k=[],x=["title","short_title","citekey","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],w={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},E=Object.fromEntries(x.map(I=>[I,this.hasFrontmatterKey(l,w[I])])),P=new Set(["title","short_title","citekey","date","abstract","doi","publisher","place","issue","volume","pages","item_type","authors","editors"]),S=x.filter(I=>E[I]||!this.isMetadataValueEmpty(p[I])||!this.isMetadataValueEmpty(g[I]));if(!S.length)return;let T={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let I of S){let L=p[I],j=g[I];if(this.metadataValuesEqual(I,L,j))continue;let F=this.isMetadataValueEmpty(L),M=this.isMetadataValueEmpty(j),V=b==null?void 0:b[I];if(V===void 0){if(F&&!M){f[I]="zotero",this.assignMetadataUpdate(y,I,j);continue}if(!F&&M&&P.has(I)){f[I]="note",this.assignMetadataUpdate(v,I,L);continue}}if(V!==void 0){let Z=!this.metadataValuesEqual(I,L,V),q=!this.metadataValuesEqual(I,j,V);if(Z&&!q){f[I]="note",this.assignMetadataUpdate(v,I,L);continue}if(!Z&&q){f[I]="zotero",this.assignMetadataUpdate(y,I,j);continue}}let O=this.getMetadataDecisionLabels(I,L,j,T);k.push({field:I,fieldLabel:T[I],noteLabel:O.noteLabel,zoteroLabel:O.zoteroLabel,noteValue:this.formatMetadataValue(L),zoteroValue:this.formatMetadataValue(j)})}if(k.length>0){let I=await this.promptMetadataBatchDecision(k);for(let L of k){let j=(a=I[L.field])!=null?a:"skip";f[L.field]=j,j==="note"?this.assignMetadataUpdate(v,L.field,p[L.field]):j==="zotero"&&this.assignMetadataUpdate(y,L.field,g[L.field])}}Object.keys(y).length>0&&await this.applyNoteMetadataUpdates(e,y),Object.keys(v).length>0&&await this.applyZoteroMetadataUpdates(c,u,p,g,v),await this.updateMetadataSnapshot(e,o,p,g,b,f,S)}catch(s){console.warn("Failed to sync note metadata with Zotero",s)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,t)}}async syncNoteAnnotationsWithZotero(e,t){var n,r,i,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,t);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let M=this.ensureDocIdInNoteContent(o,d);M!==o&&await this.writeNoteWithSyncSuppressed(e.path,M)}if(!d)return;let u=(r=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter)!=null?r:{},p=(i=c.attachmentKey)!=null?i:"";if(p||(p=await this.resolveAttachmentKeyForDocId(d,u)),!p)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===p&&await this.updateDocIndex({doc_id:d,attachment_key:p});let g=p,b=await this.fetchZoteroAnnotationsForDoc(d,p),y=b.annotations;p=b.attachmentKey,p&&p!==g&&await this.updateDocIndex({doc_id:d,attachment_key:p});let v=this.parseAnnotationBlock(l.block,p),f=new Map;for(let M of v)M.key&&M.imagePath&&f.set(M.key,{path:M.imagePath,hash:M.imageHash||this.extractAnnotationImageHashFromPath(M.imagePath)});await this.attachAnnotationImages(d,p,y,e.path,f);let k=new Map;for(let M of v)M.key&&k.set(M.key,M);let x=new Map;for(let M of y)x.set(M.key,M);let w=!1,E=!1,P=!1;if(b.hadFetchError)k.size>0&&y.length===0&&console.debug("Skipping annotation-prune sync due incomplete Zotero annotation fetch.",{docId:d,attachmentKey:p,reason:t});else for(let M of k.keys())x.has(M)||(E=!0);let S=await this.getAnnotationSnapshot(d),T=(a=S==null?void 0:S.annotations)!=null?a:{},I={},L=[];p&&p!==g&&y.length>0&&(E=!0,P=!0);for(let[M,V]of x.entries()){let O=k.get(M);if(!O){E=!0;continue}let Z=T[M],q=this.annotationSnapshotFromEntry(O,V.annotationType),W=this.annotationSnapshotFromEntry(V,V.annotationType),z=(q.image_hash||"")!==(W.image_hash||"");if(!Z){this.annotationSnapshotsEqualIgnoringImage(q,W)?z&&(E=!0,P=!0):(I[M]="note",w=!0);continue}let $=!this.annotationSnapshotsEqual(q,Z),B=!this.annotationSnapshotsEqual(W,Z),U=(W.color_key||"")!==(Z.color_key||""),H=!this.annotationSnapshotsEqualIgnoringImage(q,Z),te=!this.annotationSnapshotsEqualIgnoringImage(W,Z);H&&!te?(I[M]="note",w=!0):!H&&te?(I[M]="zotero",E=!0):H&&te&&L.push({key:M,title:this.formatAnnotationConflictTitle(V),noteValue:this.formatAnnotationConflictValue(q,O.tags),zoteroValue:this.formatAnnotationConflictValue(W,V.tags)}),z&&($||B)&&(E=!0,P=!0),U&&(E=!0,P=!0)}if(L.length>0){let M=await this.promptAnnotationBatchDecision(L);for(let V of L){let O=(s=M[V.key])!=null?s:"skip";I[V.key]=O,O==="note"?w=!0:O==="zotero"&&(E=!0,P=!0)}}let j=[];for(let[M,V]of Object.entries(I)){if(V!=="note")continue;let O=k.get(M),Z=x.get(M);!O||!Z||j.push({entry:Z,note:O})}j.length>0&&await this.applyZoteroAnnotationUpdates(j),w&&this.annotationNoteEditTimes.set(e.path,Date.now());let F=this.getAnnotationGraceRemaining(e.path);if(E&&F>0&&w&&!P&&(this.scheduleNoteAnnotationSync(e,F+250,t),E=!1),E){let M=this.buildAnnotationBlock(d,p,y),V=this.replaceAnnotationBlock(o,M);if(V&&V!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,V)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,p,y),await this.updateAnnotationChunks(d,p,y)}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,t)}}resolveZoteroItemKey(e,t){let n=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),t];for(let r of n){let i=G(r);if(i)return i}return""}async resolveAttachmentKeyForDocId(e,t){var l;if(!e)return"";let n=await this.getDocIndexEntry(e);if(n||(n=await this.hydrateDocIndexFromCache(e)),n!=null&&n.attachment_key)return n.attachment_key;let r=(0,m.normalizePath)(`${ee}/${e}.json`);try{if(await this.app.vault.adapter.exists(r)){let d=await this.readChunkPayload(r),u=this.asRecord(d==null?void 0:d.metadata),p=u==null?void 0:u.attachment_key;if(typeof p=="string"&&p.trim())return await this.updateDocIndex({doc_id:e,attachment_key:p.trim()}),p.trim()}}catch(c){}let i=this.resolveZoteroItemKey(t,e);if(!i)return"";let a=this.asRecord(await this.fetchZoteroItem(i)),s=(l=this.asRecord(a==null?void 0:a.data))!=null?l:a;if(!s||typeof s!="object")return"";let o=await De(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var v,f,k,x,w,E,P,S,T,I,L,j,F;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString((x=(k=(f=(v=e==null?void 0:e["short title"])!=null?v:e==null?void 0:e.short_title)!=null?f:e==null?void 0:e.shortTitle)!=null?k:e==null?void 0:e["short-title"])!=null?x:e==null?void 0:e["title-short"]),r=this.normalizeMetadataString((S=(P=(E=(w=e==null?void 0:e.citekey)!=null?w:e==null?void 0:e["citation key"])!=null?E:e==null?void 0:e.citation_key)!=null?P:e==null?void 0:e.citationKey)!=null?S:e==null?void 0:e["citation-key"]),i=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString((T=e==null?void 0:e.abstract)!=null?T:e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((I=e==null?void 0:e.doi)!=null?I:e==null?void 0:e.DOI),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),u=this.normalizeMetadataString(e==null?void 0:e.pages),p=this.normalizeMetadataString((F=(j=(L=e==null?void 0:e["item type"])!=null?L:e==null?void 0:e.item_type)!=null?j:e==null?void 0:e.itemType)!=null?F:e==null?void 0:e["item-type"]),g=this.normalizeMetadataList(e==null?void 0:e.tags),b=this.normalizeMetadataList(e==null?void 0:e.authors),y=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:t,short_title:n,citekey:r,date:i,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:u,item_type:p,tags:this.sanitizeObsidianTags(g),authors:b,editors:y}}extractZoteroMetadata(e){var f,k,x;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString(Ae(e)),r=this.normalizeMetadataString(He(e)),i=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString(e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((f=e==null?void 0:e.DOI)!=null?f:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),u=this.normalizeMetadataString(e==null?void 0:e.pages),p=this.normalizeMetadataString((x=(k=e==null?void 0:e.itemType)!=null?k:e==null?void 0:e.item_type)!=null?x:e==null?void 0:e["item-type"]),g=Array.isArray(e==null?void 0:e.creators)?e.creators:[],b=g.filter(w=>(w==null?void 0:w.creatorType)==="author").map(w=>Ce(w)).filter(Boolean),y=g.filter(w=>(w==null?void 0:w.creatorType)==="editor"||(w==null?void 0:w.creatorType)==="seriesEditor").map(w=>Ce(w)).filter(Boolean),v=Array.isArray(e==null?void 0:e.tags)?e.tags.map(w=>{var E;return typeof w=="string"?w:(E=this.asRecord(w))==null?void 0:E.tag}).filter(w=>typeof w=="string"):[];return{title:t,short_title:n,citekey:r,date:i,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:u,item_type:p,tags:this.sanitizeObsidianTags(v),authors:this.normalizeMetadataList(b),editors:this.normalizeMetadataList(y)}}async resolveZoteroCitekey(e,t,n){let r=this.normalizeMetadataString(He(e,n!=null?n:void 0));if(r)return r;if(!t)return"";let i=await this.fetchZoteroItemCsl(t);return this.normalizeMetadataString(ht(i))}extractAnnotationPageInfo(e){var a;let n=G((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),r=null,i=e.annotationPage;if(typeof i=="number"&&Number.isFinite(i))r=i;else if(typeof i=="string"&&i.trim()){let s=Number(i);Number.isFinite(s)&&(r=s)}if(r===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(r=o+1)}catch(s){}return{pageLabel:n,pageIndex:r}}extractAnnotationImagePayload(e){var a,s,o,l;let t=(s=(a=e.annotationImage)!=null?a:e.annotationImageData)!=null?s:e.annotationImageBase64;if(!t)return null;let n=null,r="";if(Buffer.isBuffer(t))n=t;else if(ArrayBuffer.isView(t))n=Buffer.from(t.buffer,t.byteOffset,t.byteLength);else if(t instanceof ArrayBuffer)n=Buffer.from(t);else if(typeof t=="string"){let c=t.trim();if(!c)return null;let d=c.match(/^data:([^;]+);base64,(.*)$/i);if(d&&(r=this.normalizeAnnotationImageMime(d[1]),c=d[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;n=Buffer.from(c,"base64")}if(!n||!n.length)return null;r||(r=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(n)||"image/png");let i=this.annotationImageExtensionFromMime(r)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(n))||"png";return{buffer:n,mime:r,ext:i}}parseZoteroAnnotationItem(e,t){var f,k,x,w;let n=(k=(f=e==null?void 0:e.data)!=null?f:e)!=null?k:{},r=G((x=e==null?void 0:e.key)!=null?x:n==null?void 0:n.key);if(!r)return null;let i=G(n.annotationType),a=this.normalizeAnnotationText(n.annotationText),s=this.normalizeAnnotationText(n.annotationComment),o=G(n.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:u,pageIndex:p}=this.extractAnnotationPageInfo(n),g=(w=n.annotationSortIndex)!=null?w:n.annotationSort,b=G(g).trim(),y=Number.isFinite(Number(b))?Number(b):Number.NaN,v=Array.isArray(n.tags)?n.tags.map(E=>{var P;return typeof E=="string"?E:(P=this.asRecord(E))==null?void 0:P.tag}).filter(E=>typeof E=="string"):[];return{key:r.trim(),attachmentKey:t,pageLabel:u,pageIndex:p,colorKey:l,callout:d,heading:c,annotationType:i,text:a,comment:s,tags:this.normalizeAnnotationTags(v),sortToken:b,sortIndex:y,rawValues:n}}async fetchZoteroAnnotations(e){if(!e)return{annotations:[],hadFetchError:!1};let t=this.canUseWebApi()||await this.ensureWebApiLibraryId(),n=!1,r=!1,i=o=>{var c,d;let l=[];for(let u of o){let p=this.asRecord(u),g=(d=(c=this.asRecord(p==null?void 0:p.data))!=null?c:p)!=null?d:{};if(G(g.itemType)!=="annotation")continue;let b=this.parseZoteroAnnotationItem(u,e);b&&l.push(b)}return l},a=[];try{a=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(o){try{a=await this.fetchZoteroChildrenLocal(e)}catch(l){n=!0,console.warn("Failed to fetch Zotero annotation items from local API",l)}}let s=i(a);if(!s.length&&t)try{let o=[];try{o=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(c){o=await this.fetchZoteroChildrenWeb(e)}r=!0;let l=i(o);l.length&&(s=l)}catch(o){n=!0,console.warn("Failed to fetch Zotero annotation items from Web API",o)}return!s.length&&t&&!r&&(n=!0),!s.length&&!t&&(n=!0),{annotations:s,hadFetchError:n}}async fetchZoteroAnnotationsForDoc(e,t){var l,c;let n=t,r=await this.fetchZoteroAnnotations(n);if(r.annotations.length||!e)return r.annotations.length||this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:r.hadFetchError};let i=[];try{i=await this.fetchZoteroChildren(e)}catch(d){return console.warn("Failed to fetch Zotero attachments for annotations",d),this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:!0}}let a=r.hadFetchError,s=[],o=new Set(n?[n]:[]);for(let d of i){if(!ft(d))continue;let u=this.asRecord(d),p=this.asRecord(u==null?void 0:u.data),g=G((c=(l=u==null?void 0:u.key)!=null?l:p==null?void 0:p.key)!=null?c:u==null?void 0:u.attachmentKey);!g||o.has(g)||(o.add(g),s.push(g))}for(let d of s){let u=await this.fetchZoteroAnnotations(d);if(a=a||u.hadFetchError,u.annotations.length)return{attachmentKey:d,annotations:u.annotations,hadFetchError:a}}return this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:r.annotations,hadFetchError:a}}async attachAnnotationImages(e,t,n,r,i){var u;if(!this.settings.includeAnnotationImages||!n.length)return;let a=await this.resolveAnnotationImageOutputDir(r);if(!a)return;let s=this.sanitizeFileName(e||t)||"annotations",o=(0,m.normalizePath)(R.default.join(a.relative||"",s)),l=R.default.normalize(R.default.join(a.absolute,s));o?await this.ensureFolder(o):await Y.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,d=new Map;for(let p of n){let g=String(p.annotationType||"").trim().toLowerCase(),b=g==="image"||g==="ink",y=this.extractAnnotationImagePayload((u=p.rawValues)!=null?u:{});if(!y&&b&&this.settings.zoteroCompanionEnabled&&(y=await this.fetchCompanionAnnotationImage(p.key)),!y){let x=i==null?void 0:i.get(p.key);x!=null&&x.path&&await c.exists(x.path)&&(p.imagePath=x.path,p.imageHash=x.hash,d.set(p.key,x.path));continue}let v=(0,Me.createHash)("sha1").update(y.buffer).digest("hex").slice(0,12),f=`zrr-annotation-${p.key}-${v}.${y.ext}`,k=(0,m.normalizePath)(R.default.join(o,f));try{await c.exists(k)||await c.writeBinary(k,this.bufferToArrayBuffer(y.buffer)),p.imagePath=k,p.imageHash=v,d.set(p.key,k)}catch(x){console.warn("Failed to write annotation image",{annotationKey:p.key,error:x})}}if(o&&await c.exists(o))try{let p=await c.list(o);for(let g of p.files){let y=R.default.basename(g).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!y)continue;let v=y[1].toUpperCase(),f=d.get(v);(!f||(0,m.normalizePath)(f)!==(0,m.normalizePath)(g))&&await c.remove(g)}}catch(p){console.warn("Failed to clean up annotation images",p)}}async fetchCompanionAnnotationImage(e){let t=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!t)return null;let n=`${t.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,r={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(r.Authorization=`Bearer ${i}`);try{let a=await this.requestLocalApiRaw(n,{headers:r,timeoutMs:5e3});if(a.statusCode===200){let s=a.headers["content-type"],o=Array.isArray(s)?s[0]:s!=null?s:"";return this.buildAnnotationImagePayloadFromBuffer(a.body,o)}if(a.statusCode===204||a.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:a.statusCode})}catch(a){console.warn("Failed to fetch annotation image from Zotero companion",a)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new m.Notice("Zotero companion base URL is not set.");return}let t=`${e.replace(/\/$/,"")}/health`,n={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(n.Authorization=`Bearer ${r}`);try{let i=await this.requestLocalApiRaw(t,{headers:n,timeoutMs:3e3});if(i.statusCode===200){try{let a=JSON.parse(i.body.toString("utf8"));if(a!=null&&a.ok){new m.Notice("Zotero companion: OK.");return}}catch(a){}new m.Notice("Zotero companion responded but did not return OK.");return}if(i.statusCode===401){new m.Notice("Zotero companion: unauthorized (check token).");return}new m.Notice(`Zotero companion: HTTP ${i.statusCode}.`)}catch(i){console.warn("Zotero companion health check failed",i),new m.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new m.Notice("Opened Zotero. Go to tools \u2192 add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new m.Notice("Unable to open Zotero automatically. Open Zotero and go to tools \u2192 add-ons.")}}async spawnDetached(e){let[t,...n]=e;if(!t)throw new Error("Missing command");await new Promise((r,i)=>{let a=!1,s=(0,ae.spawn)(t,n,{detached:!0,stdio:"ignore"});s.on("error",o=>{a||(a=!0,i(o))}),s.unref(),a||(a=!0,r())})}maybeWarnMissingAnnotationApi(e,t){if(this.canUseWebApi()){console.debug("No Zotero annotations returned for attachment",{docId:e,attachmentKey:t});return}let n=e||t;!n||this.annotationWebApiWarned.has(n)||(this.annotationWebApiWarned.add(n),new m.Notice("Zotero annotations require web API access. Configure the web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
${n}
<!-- zrr:sync-end -->`;let a=i.some(l=>{if(typeof(l==null?void 0:l.section)=="string"?l.section.trim():"")return!0;let d=typeof(l==null?void 0:l.chunk_id)=="string"?l.chunk_id.trim():"";return!!(d&&!/^p\d+$/i.test(d))}),s=[`<!-- zrr:sync-start doc_id=${e} -->`];for(let l of i){let c=typeof(l==null?void 0:l.chunk_id)=="string"?l.chunk_id.trim():"";if(!c)continue;let d=Number.isFinite((o=l==null?void 0:l.page_start)!=null?o:NaN)?Number(l.page_start):null,u=!!(l!=null&&l.excluded||l!=null&&l.exclude),g=typeof(l==null?void 0:l.text)=="string"?l.text.trim():"";if(a){let f=typeof(l==null?void 0:l.section)=="string"?l.section.trim():"",k=f?`## ${f}`:"";k&&!g.startsWith("#")&&(g=g?`${k}

${g}`:k)}let b=d!==null?a?` (${d})`:` page=${d}`:"",v=` id=${c}${a?" section":""}${b}${u?" exclude":""}`;s.push(`<!-- zrr:chunk${v} -->`),g&&s.push(g),s.push("<!-- zrr:chunk end -->"),s.push("")}return s[s.length-1]===""&&s.pop(),s.push("<!-- zrr:sync-end -->"),s.join(`
...
`);for(let a=0;a<i.length;a+=1)if(r.test(i[a]))return a;return null}async openNoteAtChunk(e,t){if(!e||!t)return!1;await this.openNoteInMain(e);let r=this.getMainLeaf().view;if(!(r instanceof m.MarkdownView))return!1;let i=r.editor,a=this.normalizeChunkIdForNote(t)||t,s=this.findChunkLineInText(i.getValue(),a);return s===null?(new m.Notice(`Chunk ${a} not found in note.`),!1):(i.setCursor({line:s,ch:0}),i.scrollIntoView({from:{line:s,ch:0},to:{line:s,ch:0}},!0),!0)}async openNoteAtAnnotation(e,t,n,r){let i=this.buildAnnotationBlockId(t,n,r);if(!e||!i)return!1;await this.openNoteInMain(e);let s=this.getMainLeaf().view;if(!(s instanceof m.MarkdownView))return!1;let o=s.editor,l=this.findAnnotationLineInText(o.getValue(),i);return l===null?(new m.Notice(`Annotation ${t} not found in note.`),!1):(o.setCursor({line:l,ch:0}),o.scrollIntoView({from:{line:l,ch:0},to:{line:l,ch:0}},!0),!0)}async openInternalLinkInMain(e){let t=this.getMainLeaf(),[n,r]=e.split("#"),i=(n||"").trim(),a=(r||"").trim(),s="zrr-chunk:",o=i?this.app.metadataCache.getFirstLinkpathDest(i,""):null;if(o instanceof m.TFile){let l=a.startsWith(s)?a.slice(s.length).trim():"";if(l&&await this.openNoteAtChunk(o.path,l))return;await t.openFile(o,{active:!0}),e.includes("#")&&!l&&await this.openLinkTextInLeaf(t,e);return}await this.openLinkTextInLeaf(t,e)}async openLinkTextInLeaf(e,t){let n=e;if(typeof n.openLinkText=="function"){await n.openLinkText(t,"",{active:!0});return}await this.app.workspace.openLinkText(t,"","tab")}async openNoteInNewTab(e){let t=(0,m.normalizePath)(e);await this.app.workspace.openLinkText(t,"","tab")}async openPdfInMain(e,t){if(!e)return!1;if(!R.default.isAbsolute(e)&&!/^[A-Za-z]+:\/\//.test(e)){let a=(0,m.normalizePath)(e),s=t?`#page=${t}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}let n=R.default.normalize(this.getVaultBasePath()),r=R.default.normalize(e),i=n.endsWith(R.default.sep)?n:`${n}${R.default.sep}`;if(r.startsWith(i)){let a=(0,m.normalizePath)(R.default.relative(n,r)),s=t?`#page=${t}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}try{return window.open((0,vt.pathToFileURL)(e).toString()),!0}catch(a){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,t,n,r){if(t){let i=new URLSearchParams;n&&i.set("page",n),r&&i.set("annotation",r);let a=i.toString()?`?${i.toString()}`:"";return`zotero://open-pdf/library/items/${t}${a}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let n=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(n))return n}formatCitationsMarkdown(e){return e.length?e.map(n=>this.formatCitationMarkdown(n)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e){var d,u,p,g,b;let t=e.doc_id||"?",n=this.formatCitationPageLabel(e),r=e.annotation_key||this.extractAnnotationKey(e.chunk_id),i=e.attachment_key||((u=(d=this.docIndex)==null?void 0:d[e.doc_id||""])==null?void 0:u.attachment_key),a=e.page_start?String(e.page_start):"",s=(g=(p=this.docIndex)==null?void 0:p[e.doc_id||""])!=null?g:null,o=this.resolveCitationTitle(s,(b=s==null?void 0:s.note_path)!=null?b:null,e.doc_id),l=this.formatCitationLabel(o,n),c=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&(s!=null&&s.note_path)){if(r){let y=a||(e.page_end?String(e.page_end):"0"),v=this.buildNoteAnnotationLink(s.note_path,r,i||"",y,l);return v?`- ${v}`:`- ${this.buildNoteLink(s.note_path,l)}`}if(c&&!r)return`- ${this.buildNoteChunkLink(s.note_path,c,l)}`}if(i){let y=this.buildZoteroDeepLink(t,i,a,r);return`- [${l}](${y})`}return`- ${l}`}buildNoteChunkLink(e,t,n){let r=(0,m.normalizePath)(e).replace(/\.md$/i,""),i=`zrr-chunk:${t}`,a=this.escapeWikiLabel(n);return`[[${r}#${i}\\|${a}]]`}buildNoteLink(e,t){let n=(0,m.normalizePath)(e).replace(/\.md$/i,""),r=this.escapeWikiLabel(t);return`[[${n}\\|${r}]]`}buildNoteAnnotationLink(e,t,n,r,i){let a=this.buildAnnotationBlockId(t,n,r);if(!a)return null;let s=(0,m.normalizePath)(e).replace(/\.md$/i,""),o=this.escapeWikiLabel(i);return`[[${s}#^${a}\\|${o}]]`}buildAnnotationBlockId(e,t,n){let r=(e||"").trim().toUpperCase(),i=(t||"").trim().toUpperCase();if(!r||!i)return null;let a=(n||"").trim()||"0";return`${r}a${i}p${a}`}escapeWikiLabel(e){return e?e.replace(/\|/g,"\\|"):""}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,m.normalizePath)(`${re}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var n;let e=this.app.vault.adapter,t=this.getDocIndexPath();if(!await e.exists(t))return{};try{let r=await e.read(t),i=JSON.parse(r);if(i&&typeof i=="object"){let a=(n=i.entries)!=null?n:i;if(Array.isArray(a)){let s={};for(let l of a)l!=null&&l.doc_id&&(s[String(l.doc_id)]=l);let o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(s),s}if(a&&typeof a=="object"){let s=a,o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(s),s}}}catch(r){console.error("Failed to read doc index",r)}return{}}async saveDocIndex(e){await this.ensureFolder(re);let t=this.app.vault.adapter,n=this.getDocIndexPath(),r={version:1,entries:e};await t.write(n,JSON.stringify(r,null,2)),this.docIndex=e}async pruneDocIndexOrphans(){var c;let e=this.app.vault.adapter,t=await this.getDocIndex(),n=new Set(await this.listDocIds(oe)),r=new Set(await this.listDocIds(ee)),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),a=0,s=0,o=!1,l=new Date().toISOString();for(let d of Object.keys(t)){let u=t[d],p=!1,g=u!=null&&u.note_path?u.note_path.trim():"";if(g&&await e.exists(g))p=!0;else if((c=i[d])!=null&&c.note_path){p=!0;let y=i[d];y.note_path&&y.note_path!==u.note_path&&(u.note_path=y.note_path,s+=1,o=!0),y.note_title&&y.note_title!==u.note_title&&(u.note_title=y.note_title,s+=1,o=!0),s>0&&(u.updated_at=l)}let b=n.has(d)||r.has(d);!p&&!b&&(delete t[d],a+=1,o=!0)}return o&&await this.saveDocIndex(t),{removed:a,updated:s}}async updateDocIndex(e){var i;let t=await this.getDocIndex(),n=(i=t[e.doc_id])!=null?i:{doc_id:e.doc_id},r={...n,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&n.note_path&&(r.note_path=n.note_path),e.note_title===void 0&&n.note_title&&(r.note_title=n.note_title),e.zotero_title===void 0&&n.zotero_title&&(r.zotero_title=n.zotero_title),e.short_title===void 0&&n.short_title&&(r.short_title=n.short_title),e.pdf_path===void 0&&n.pdf_path&&(r.pdf_path=n.pdf_path),e.attachment_key===void 0&&n.attachment_key&&(r.attachment_key=n.attachment_key),typeof r.pdf_path=="string"&&(r.pdf_path=this.normalizeDocIndexPdfPath(r.pdf_path)),t[e.doc_id]=r,await this.saveDocIndex(t)}async removeDocIndexEntry(e){let t=await this.getDocIndex();if(!t[e]){await this.removeMetadataSnapshot(e);return}delete t[e],await this.saveDocIndex(t),await this.removeMetadataSnapshot(e)}async hydrateDocIndexFromCache(e){var s,o;if(!e)return null;let t=this.app.vault.adapter,n=await this.getDocIndexEntry(e),r={},i=(0,m.normalizePath)(`${oe}/${e}.json`);if(await t.exists(i))try{let l=await t.read(i),c=JSON.parse(l),d=(o=(s=c==null?void 0:c.data)!=null?s:c)!=null?o:{},u=typeof d.title=="string"?d.title:"";u&&(r.zotero_title=u);let p=Ae(d);if(p&&(r.short_title=p),!r.note_title||!r.note_path){let g=this.sanitizeFileName(u)||e,b=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${g}.md`),y=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${g}-${e}.md`),v="";await t.exists(b)?v=b:await t.exists(y)&&(v=y),v&&(r.note_path=v,r.note_title=R.default.basename(v,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!r.note_title&&(n!=null&&n.note_path)&&(r.note_title=R.default.basename(n.note_path,".md"));let a=(0,m.normalizePath)(`${ee}/${e}.json`);if(await t.exists(a))try{let l=await t.read(a),c=JSON.parse(l);typeof(c==null?void 0:c.source_pdf)=="string"&&(r.pdf_path=c.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(r).length>0&&await this.updateDocIndex({doc_id:e,...r}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var n;return e&&(n=(await this.getDocIndex())[e])!=null?n:null}async inferNotePathFromCache(e){var r,i;let t=this.app.vault.adapter,n=(0,m.normalizePath)(`${oe}/${e}.json`);if(!await t.exists(n))return"";try{let a=await t.read(n),s=JSON.parse(a),o=(i=(r=s==null?void 0:s.data)!=null?r:s)!=null?i:{},l=typeof o.title=="string"?o.title:"",c=this.sanitizeFileName(l)||e,d=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${c}.md`),u=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${c}-${e}.md`);if(await t.exists(d))return d;if(await t.exists(u))return u}catch(a){console.error("Failed to infer note path from cache",a)}return""}async rebuildNoteFromCacheForDocId(e,t){var I,L,j,F,M,V;try{await this.ensureBundledTools()}catch(O){return t&&new m.Notice("Failed to sync bundled tools. See console for details."),console.error(O),!1}let n=this.app.vault.adapter,r=(0,m.normalizePath)(`${oe}/${e}.json`),i=(0,m.normalizePath)(`${ee}/${e}.json`);if(!await n.exists(r)||!await n.exists(i))return t&&new m.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let a;try{let O=await n.read(r);a=JSON.parse(O)}catch(O){return t&&new m.Notice("Failed to read cached item JSON."),console.error(O),this.clearStatusProgress(),!1}let s;try{let O=await n.read(i);s=JSON.parse(O)}catch(O){return t&&new m.Notice("Failed to read cached chunks JSON."),console.error(O),this.clearStatusProgress(),!1}let o=(I=a.data)!=null?I:a,l=typeof o.title=="string"?o.title:"",c=((j=(L=a.key)!=null?L:o.key)!=null?j:e).toString(),d=await this.getDocIndexEntry(e),u=typeof((F=this.asRecord(s==null?void 0:s.metadata))==null?void 0:F.attachment_key)=="string"?String((M=this.asRecord(s==null?void 0:s.metadata))==null?void 0:M.attachment_key):d==null?void 0:d.attachment_key,p=typeof s.source_pdf=="string"?s.source_pdf:"";if(!p||!await this.isFileAccessible(p)){let O=await this.recoverMissingPdfFromAttachment(p,o,c,e,u,l,t);if(!O)return t&&new m.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;p=O.sourcePdf,O.attachmentKey&&(u=O.attachmentKey),await this.updateChunkJsonSourcePdf(i,p)}let g=await this.resolveLanguageHint(o,c),b=this.buildDoclingLanguageHint(g!=null?g:void 0),y="";if(d!=null&&d.note_path&&await n.exists(d.note_path)&&(y=(0,m.normalizePath)(d.note_path)),!y){let O=this.sanitizeFileName(l)||e,Z=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${O}.md`),q=await n.exists(Z)?O:await this.resolveUniqueBaseName(O,e);y=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${q}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let O=this.getLogFileRelativePath(),Z=(0,m.normalizePath)(R.default.dirname(O));Z&&await this.ensureFolder(Z);let q=this.getSpellcheckerInfoRelativePath(),W=(0,m.normalizePath)(R.default.dirname(q));W&&await this.ensureFolder(W)}}catch(O){return t&&new m.Notice("Failed to create notes folder."),console.error(O),this.clearStatusProgress(),!1}let v=this.getPluginDir(),f=R.default.join(v,"tools","docling_extract.py"),k=R.default.join(v,"tools","index_redisearch.py"),x=null,w=null,E=O=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=O)};try{this.showStatusProgress(this.formatStatusLabel("Docling extraction...",x),0);let O=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(f,await this.buildDoclingArgs(p,e,i,y,b,!0),W=>this.handleDoclingProgress(W,x),()=>{},O,"docling_extract",E),this.recreateMissingNotesProcess=null,x=await this.readDoclingQualityLabel(i),u&&await this.annotateChunkJsonWithAttachmentKey(i,u);let Z=await this.readDoclingMetadata(i),q=await this.maybeCreateOcrLayeredPdf(p,Z,b);q&&(p=q,w=q,await this.updateChunkJsonSourcePdf(i,q))}catch(O){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(t&&new m.Notice("Docling extraction failed. See console for details."),console.error(O),this.clearStatusProgress(),!1)}let P=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;if(!await this.ensureRedisAvailable("rebuild"))t&&new m.Notice("Redis is unavailable; skipping indexing for this note.");else try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",x),0);let O=["--chunks-json",this.getAbsoluteVaultPath(i),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(O),this.appendEmbedContextArgs(O),this.settings.embedIncludeMetadata&&O.push("--embed-include-metadata"),this.appendChunkTaggingArgs(O,{allowRegenerate:!1}),await this.runPythonStreaming(k,O,Z=>{let q=this.asRecord(Z),W=typeof(q==null?void 0:q.total)=="number"?q.total:0,z=typeof(q==null?void 0:q.current)=="number"?q.current:0;if((q==null?void 0:q.type)==="progress"&&W>0){let $=Math.round(z/W*100),B=typeof q.message=="string"&&q.message.trim()?q.message:`Indexing chunks ${z}/${W}`,U=this.formatStatusLabel(B,x);this.showStatusProgress(U,$)}},()=>{},P,"index_redisearch",E),this.recreateMissingNotesProcess=null}catch(O){if(this.recreateMissingNotesAbort)return this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1;t&&new m.Notice("Redissearch indexing failed; note will still be rebuilt."),console.error(O)}let T=w?this.buildPdfLinkFromSourcePath(w):this.buildPdfLinkForNote(p,d==null?void 0:d.attachment_key,e);try{let O=await this.app.vault.adapter.read(y),Z=await this.readChunkPayload(i),q=this.buildSyncedDoclingContent(e,Z,O),W=await this.buildNoteMarkdown(o,(V=a.meta)!=null?V:{},e,T,u,y,r,q);await this.writeNoteWithSyncSuppressed(y,W);let z=this.app.vault.getAbstractFileByPath(y);z instanceof m.TFile&&this.scheduleNoteAnnotationSync(z,2e3,"save")}catch(O){return t&&new m.Notice("Failed to finalize note Markdown."),console.error(O),this.clearStatusProgress(),!1}try{let O=Ae(o);await this.updateDocIndex({doc_id:e,note_path:y,note_title:R.default.basename(y,".md"),zotero_title:l,short_title:O||void 0,pdf_path:p})}catch(O){console.error("Failed to update doc index",O)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],t=await this.fetchZoteroGroupOptions();return t.length&&e.push(...t),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),t=[],n=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!n)return e&&t.push({value:e,label:e}),t;let r=(this.settings.embedApiKey||"").trim(),i=await this.fetchModelIds(n,r);if(i.length){let a=i.filter(o=>/embed/i.test(o)),s=a.length?a:i;t.push(...s.map(o=>({value:o,label:o})))}return!t.length&&e&&t.push({value:e,label:e}),t.sort((a,s)=>a.label.localeCompare(s.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,t,n){let r=n==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),i=[],a=(e||"").trim().replace(/\/$/,"");if(!a)return r&&i.push({value:r,label:r}),i;let s=(t||"").trim(),o=await this.fetchModelIds(a,s);if(o.length){let l=o.filter(d=>!/embed/i.test(d)),c=l.length?l:o;i.push(...c.map(d=>({value:d,label:d})))}return!i.length&&r&&i.push({value:r,label:r}),i.sort((l,c)=>l.label.localeCompare(c.label))}detectEmbeddingProvider(e){let t=e.toLowerCase();return t.includes("anthropic")?"anthropic":t.includes("openrouter")?"openrouter":t.includes("ollama")||t.includes(":11434")?"ollama":t.includes("openai")?"openai":"generic"}async fetchModelIds(e,t){let n=this.detectEmbeddingProvider(e);try{if(n==="anthropic")return await this.fetchAnthropicModels(e,t);let r=await this.fetchOpenAiCompatibleModels(e,t);return!r.length&&n==="ollama"?await this.fetchOllamaModels(e):r}catch(r){return console.warn("Failed to fetch models",r),[]}}async fetchOpenAiCompatibleModels(e,t){let n=`${e}/models`,r={};t&&(r.Authorization=`Bearer ${t}`);let i=await this.requestLocalApiRaw(n,{headers:r});if(i.statusCode>=400)throw new Error(`Model list request failed (${i.statusCode})`);let a=JSON.parse(i.body.toString("utf8"));return this.extractModelIds(a)}async fetchOllamaModels(e){let n=`${e.replace(/\/v1\/?$/,"")}/api/tags`,r=await this.requestLocalApiRaw(n);if(r.statusCode>=400)throw new Error(`Ollama tags request failed (${r.statusCode})`);let i;try{i=JSON.parse(r.body.toString("utf8"))}catch(s){return console.warn("Failed to parse Ollama tags response",s),[]}if(!i||typeof i!="object")return[];let a=i.models;return Array.isArray(a)?a.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}async fetchAnthropicModels(e,t){if(!t)return[];let n=`${e}/models`,r={"x-api-key":t,"anthropic-version":"2023-06-01"},i=await this.requestLocalApiRaw(n,{headers:r});if(i.statusCode>=400)throw new Error(`Anthropic model list request failed (${i.statusCode})`);let a=JSON.parse(i.body.toString("utf8"));return this.extractModelIds(a)}extractModelIds(e){var r,i,a;if(Array.isArray(e))return e.map(s=>this.extractModelId(s)).filter(s=>!!s);if(!e||typeof e!="object")return[];let t=e,n=(a=(i=(r=t.data)!=null?r:t.models)!=null?i:t.model)!=null?a:t.items;return Array.isArray(n)?n.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}asRecord(e){return!e||typeof e!="object"?null:e}extractModelId(e){var i,a,s;if(!e||typeof e!="object")return null;let t=e,n=(s=(a=(i=t.id)!=null?i:t.name)!=null?a:t.model)!=null?s:t.identifier;return typeof n!="string"?null:n.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,t=r=>{for(let i of r)e.has(i.value)||e.set(i.value,i.label)};if(await this.warnIfZoteroLocalApiUnavailable("Zotero groups"))try{let r=this.buildZoteroUrl("/users/0/groups"),i=await this.requestLocalApi(r,`Zotero groups fetch failed for ${r}`);t(this.parseZoteroGroupOptions(i))}catch(r){console.warn("Failed to fetch Zotero groups from local API",r)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let r=(this.settings.webApiLibraryId||"").trim();if(r)try{let i=this.buildWebApiUrl(`/users/${r}/groups`),a=await this.requestWebApi(i,`Zotero Web API groups fetch failed for ${i}`);t(this.parseZoteroGroupOptions(a))}catch(i){console.warn("Failed to fetch Zotero groups from Web API",i)}}return Array.from(e.entries()).map(([r,i])=>({value:r,label:i})).sort((r,i)=>r.label.localeCompare(i.label))}parseZoteroGroupOptions(e){var r,i,a,s,o;let t;try{t=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(t))return[];let n=[];for(let l of t){if(!l||typeof l!="object")continue;let c=(r=l.data)!=null?r:l,d=(a=(i=c.id)!=null?i:l.id)!=null?a:c.key;if(!d)continue;let u=String(d).trim();if(!u)continue;let p=(o=(s=c.name)!=null?s:l.name)!=null?o:u,g=String(p||u).trim()||u;n.push({value:`groups/${u}`,label:`Group: ${g}`})}return n}async ensureFolder(e){let t=this.app.vault.adapter,n=(0,m.normalizePath)(e).split("/").filter(Boolean),r="";for(let i of n)r=r?`${r}/${i}`:i,await t.exists(r)||await t.mkdir(r)}async buildNoteMarkdown(e,t,n,r,i,a,s,o){let l=`[[${s}]]`,c=this.settings.copyPdfToVault&&r.startsWith("[["),d=i?this.buildZoteroDeepLink(n,i):"",u=d||r,p=c?r:d||r,g=p?c?`PDF: !${p}`:`PDF: ${p}`:"",b=g?`${g}

`:"",y=await this.buildTemplateVars(e,t,n,u,l);y.pdf_block=b,y.pdf_line=g,y.docling_markdown=o;let v=(this.settings.noteBodyTemplate||"").trim();/{{\s*annotation_block\s*}}/i.test(v)&&i?y.annotation_block=await this.buildAnnotationBlockForAttachment(n,i,a):y.annotation_block="";let k=this.ensureDocIdInFrontmatter(await this.renderFrontmatter(e,t,n,u,l,y),n),x=k?`---
${k}
---

`:"",w=`${b}${o}`,E=v?this.renderTemplate(v,y,w,{appendDocling:!0}):w;return`${x}${E}`}async buildAnnotationBlockForAttachment(e,t,n){let r=await this.fetchZoteroAnnotationsForDoc(e,t);return r.attachmentKey&&r.attachmentKey!==t&&await this.updateDocIndex({doc_id:e,attachment_key:r.attachmentKey}),await this.attachAnnotationImages(e,r.attachmentKey,r.annotations,n),this.buildAnnotationBlock(e,r.attachmentKey,r.annotations)}buildAnnotationBlock(e,t,n){var u;let r=`<!-- zrr:annotations-start doc_id=${e} attachment_key=${t} -->`,i="<!-- zrr:annotations-end -->";if(!n.length)return`${r}
${i}`;let a=this.getAnnotationColorMap(),s=Object.keys(a),o=new Map;for(let p of n){let g=p.colorKey||this.normalizeAnnotationColorKey(p.colorKey),b=(u=o.get(g))!=null?u:[];b.push(p),o.set(g,b)}let l=[r],c=new Set,d=[...s,...Array.from(o.keys()).filter(p=>!s.includes(p))];for(let p of d){let g=o.get(p);if(!g||!g.length)continue;c.add(p);let{heading:b}=this.resolveAnnotationColorMeta(p);l.push("",`## ${b}`),g.sort((y,v)=>{var S,T;let f=(y.sortToken||"").trim(),k=(v.sortToken||"").trim();if(f&&k&&f!==k)return f.localeCompare(k,void 0,{numeric:!0,sensitivity:"base"});if(f&&!k)return-1;if(!f&&k)return 1;let x=Number.isFinite(y.sortIndex),w=Number.isFinite(v.sortIndex);if(x&&w&&y.sortIndex!==v.sortIndex)return y.sortIndex-v.sortIndex;let E=(S=y.pageIndex)!=null?S:0,P=(T=v.pageIndex)!=null?T:0;return E!==P?E-P:y.key.localeCompare(v.key)});for(let y of g)l.push(...this.formatAnnotationCallout(y,t,e))}return l.push("",i),l.join(`
`).trim()}formatAnnotationCallout(e,t,n){let r=this.settings.annotationPageLabel||"Page",i=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?"),a=e.pageIndex?String(e.pageIndex):"",s=this.buildZoteroDeepLink(n,t,a,e.key),l=[`> [!${e.callout}] ${r} [${i}](${s})`];e.imagePath&&l.push(`> ![[${e.imagePath}]]`);let c=u=>{if(u)for(let p of u.split(/\r?\n/))l.push(p.trim()?`> ${p}`:">")};c(e.text),e.comment&&(l.push(">","> ---"),c(e.comment)),e.tags.length&&l.push(`> **Tags:** ${e.tags.map(u=>`#${u}`).join(" ")}`);let d=e.pageIndex?String(e.pageIndex):"0";return l.push(`> ^${e.key}a${t}p${d}`),l.push(""),l}findAnnotationBlockRange(e){let t=Un.exec(e);if(!t)return null;let n=e.slice(t.index+t[0].length),r=Zn.exec(n);if(!r)return null;let i=t.index,a=t.index+t[0].length+r.index+r[0].length,s=n.slice(0,r.index);return{start:i,end:a,block:s,startMarker:t[0]}}parseAnnotationBlockMarker(e){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i),n=e.match(/attachment_key=(["']?)([^"'\s]+)\1/i);return{docId:t?t[2].trim():void 0,attachmentKey:n?n[2].trim():void 0}}parseAnnotationBlock(e,t){let n=e.split(/\r?\n/),r=[],i=0;for(;i<n.length;){if(!n[i].trim().startsWith("> [!")){i+=1;continue}let s=[];for(;i<n.length&&n[i].trim().startsWith(">");)s.push(n[i]),i+=1;let o=this.parseAnnotationCallout(s,t);o&&r.push(o)}return r}parseAnnotationImageLine(e){var o,l;let t=e.trim();if(!t)return null;let n="",r=t.match(/!\[\[([^\]]+)\]\]/);r&&(n=r[1].trim());let i=n?null:t.match(/!\[[^\]]*\]\(([^)]+)\)/);i&&(n=i[1].trim());let a=n?null:t.match(/<img[^>]+src=["']([^"']+)["']/i);if(a&&(n=a[1].trim()),!n)return null;let s=(l=(o=n.split("|")[0])==null?void 0:o.trim())!=null?l:"";return s?{path:s,hash:this.extractAnnotationImageHashFromPath(s)}:null}parseAnnotationCallout(e,t){if(!e.length)return null;let n=e[0].replace(/^>\s?/,"").trim(),r=n.match(/\[!([^\]]+)\]/),i=r?r[1].trim():"note",a=n.match(/\((zotero:\/\/open-pdf\/library\/items\/[^)]+)\)/i),s="",o=t,l="",c=null;if(a){let k=a[1],x=k.match(/items\/([A-Z0-9]{8})/i);x&&(o=x[1]);let w=k.match(/annotation=([A-Z0-9]{8})/i);w&&(s=w[1]);let E=k.match(/page=(\d+)/i);E&&(c=Number(E[1]));let P=n.match(/\[([^\]]+)\]\(zotero:\/\//i);P&&(l=P[1].trim())}let d=[],u=[],p=[],g=!1,b="",y="";for(let k=1;k<e.length;k+=1){let x=e[k].replace(/^>\s?/,""),w=x.trim();if(!w){g?p.push(""):u.push("");continue}let E=this.parseAnnotationImageLine(w);if(E){b=E.path,y=E.hash;continue}if(w.startsWith("^")){let P=w.match(/^\^([A-Z0-9]{8})a([A-Z0-9]{8})p(\d+)/i);P&&(s=P[1],o=P[2],c=Number(P[3]));continue}if(/^(\*\*tags:\*\*|tags:)/i.test(w)){d.push(w);continue}if(w==="---"){g=!0;continue}g?p.push(x):u.push(x)}let v=d.join(" "),f=v?v.replace(/\*\*tags:\*\*/i,"").replace(/tags:/i,"").split(/[\s,]+/).map(k=>k.trim().replace(/^#+/,"")).filter(Boolean):[];return s?{key:s,attachmentKey:o,pageLabel:l,pageIndex:c,callout:i,text:this.normalizeAnnotationText(u.join(`
`)),comment:this.normalizeAnnotationText(p.join(`
`)),tags:this.normalizeAnnotationTags(f),imagePath:b||void 0,imageHash:y||void 0}:null}replaceAnnotationBlock(e,t){let n=this.findAnnotationBlockRange(e);if(!n)return null;let r=e.slice(0,n.start),i=e.slice(n.end),a=t.trim()?`${t.trim()}
`:`${t}`;return`${r}${a}${i}`.replace(/\n{4,}/g,`


`)}async renderFrontmatter(e,t,n,r,i,a){var d;let s=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,t,n,r,i),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let t=e.split(/\r?\n/),n=[],r=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,i=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<t.length;){let l=t[o],c=l.match(r);if(!c){n.push(l),o+=1;continue}let d=c[1].trim(),u=c[2].trim();if(a.has(d)){n.push(l),o+=1;continue}if(!s(u)){n.push(l),o+=1;continue}let p=o+1,g=[];for(;p<t.length&&t[p].match(i);)g.push(t[p]),p+=1;if(g.length===0){for(o=p;o<t.length&&t[o].trim()==="";)o+=1;continue}let b=g.filter(y=>{let v=y.match(i);if(!v)return!1;let f=v[1].trim();return!s(f)});if(b.length>0&&n.push(l,...b),o=p,b.length===0)for(;o<t.length&&t[o].trim()==="";)o+=1}for(;n.length>0&&n[n.length-1].trim()==="";)n.pop();return n.join(`
...
${t.docling_markdown}`),i.trim()?i:n}async buildTemplateVars(e,t,n,r,i){let a=G(e.title),s=G(e.shortTitle),o=G(e.date),l=typeof(t==null?void 0:t.parsedDate)=="string"?t.parsedDate:"",c=gt(l||o),d=/^\d{4}$/.test(c)?c:"",u=Array.isArray(e.creators)?e.creators:[],p=u.filter(X=>X.creatorType==="author").map(X=>Ce(X)),g=p.join("; "),b=u.filter(X=>X.creatorType==="editor"||X.creatorType==="seriesEditor").map(X=>Ce(X)),y=b.join("; "),v=Array.isArray(e.tags)?e.tags.map(X=>{var pe;return typeof X=="string"?X:(pe=this.asRecord(X))==null?void 0:pe.tag}).filter(X=>typeof X=="string"&&X.length>0):[],f=this.sanitizeObsidianTags(v),k=f.join("; "),x=await this.resolveCollectionTitles(e),w=x.join("; "),E=this.toObsidianLinks(x),P=E.join("; "),S=G(e.itemType),T=typeof(t==null?void 0:t.creatorSummary)=="string"?t.creatorSummary:"",I=G(e.publicationTitle),L=G(e.bookTitle),j=G(e.journalAbbreviation),F=G(e.volume),M=G(e.issue),V=G(e.pages),O=G(e.dateAdded),Z=G(e.dateModified),q=typeof e.key=="string"?e.key:n,W=G(e.DOI);W||(W=Wt(e));let z=He(e,t),$=null;(!W||!s||!z)&&($=await this.fetchZoteroItemCsl(q)),W||(W=Ht($)),s||(s=Gt($)),z||(z=ht($));let B=G(e.ISBN),U=G(e.ISSN),H=G(e.publisher),te=G(e.place),ue=G(e.url),ke=G(e.language),we=G(e.abstractNote),he=this.buildZoteroDeepLink(q),le=Array.from(new Set([z,s,W].map(X=>String(X||"").trim()).filter(X=>X.length>0))),ct=le.join("; "),J={doc_id:n,zotero_key:typeof e.key=="string"?e.key:n,item_link:he,citekey:z,title:a,short_title:s,date:o,year:c,year_number:d,authors:g,editors:y,aliases:ct,tags:k,collection_title:w,collection_titles:w,collections_links:P,item_type:S,creator_summary:T,publication_title:I,book_title:L,journal_abbrev:j,volume:F,issue:M,pages:V,date_added:O,date_modified:Z,doi:W,isbn:B,issn:U,publisher:H,place:te,url:ue,language:ke,abstract:we,pdf_link:r,item_json:i};for(let[X,pe]of Object.entries(J)){let se=this.escapeYamlString(pe);J[`${X}_yaml`]=se,J[`${X}_quoted`]=se,J[`${X}_text`]=se}return J.authors_yaml_list=this.toYamlList(p),J.editors_yaml_list=this.toYamlList(b),J.tags_yaml_list=f.length>0?this.toYamlList(f):"",J.aliases_yaml_list=le.length>0?this.toYamlList(le):"",J.collections_yaml_list=this.toYamlList(x),J.collections_links_yaml_list=this.toYamlList(E),J.tags_raw=v.join("; "),J.tags_raw_yaml=this.escapeYamlString(J.tags_raw),J.tags_raw_yaml_list=v.length>0?this.toYamlList(v):"",J.authors_list=J.authors_yaml_list,J.editors_list=J.editors_yaml_list,J.tags_list=J.tags_yaml_list,J.aliases_list=J.aliases_yaml_list,J.collections_list=J.collections_yaml_list,J.collections_links_list=J.collections_links_yaml_list,J}escapeYamlString(e){return`"${String(e).replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n")}"`}toYamlList(e){return e.length?e.map(t=>`  - ${this.escapeYamlString(t)}`).join(`
`):'  - ""'}sanitizeObsidianTags(e){let t=this.settings.tagSanitizeMode||"kebab",n=t==="replace"?"kebab":t;return e.map(r=>this.sanitizeObsidianTag(r,n)).filter(r=>r.length>0)}sanitizeObsidianTag(e,t){let n=String(e||"").trim();if(!n)return"";let r=n.replace(/^#+/,"");if(t==="none")return r;let i=o=>!/^\d+$/.test(o),s=(o=>r.split("/").map(d=>{let p=d.replace(/[^\p{L}\p{N}]+/gu," ").split(/\s+/).filter(Boolean);if(!p.length)return"";if(o==="camel"||o==="pascal"){let[b,...y]=p;return[o==="pascal"?b.charAt(0).toUpperCase()+b.slice(1):b.charAt(0).toLowerCase()+b.slice(1),...y.map(f=>f.charAt(0).toUpperCase()+f.slice(1))].join("")}let g=o==="snake"?"_":"-";return p.join(g)}).filter(Boolean).join("/").replace(/\/{2,}/g,"/").replace(/^\/+|\/+$/g,""))(t);return s&&i(s)?s:""}normalizeZoteroTags(e){let t=new Map;for(let n of e){let r=this.normalizeZoteroTag(n);if(!r)continue;let i=r.toLowerCase();t.has(i)||t.set(i,r)}return Array.from(t.values())}normalizeZoteroTag(e){let t=String(e||"").trim();if(!t)return"";let n=t.replace(/^#+/,"").trim();if(!n)return"";let r=n.split("/").map(i=>{let a=i.trim();return a?(a=a.replace(/[_-]+/g," "),a=a.replace(/([A-Z]+)([A-Z][a-z])/g,"$1 $2"),a=a.replace(/([a-z\\d])([A-Z])/g,"$1 $2"),a=a.replace(/([a-zA-Z])(\\d)/g,"$1 $2"),a=a.replace(/(\\d)([a-zA-Z])/g,"$1 $2"),a=a.replace(/\s+/g," ").trim(),a):""}).filter(Boolean);return r.length?r.join("/"):""}toObsidianLinks(e){return e.map(t=>String(t||"").trim()).filter(t=>t.length>0).map(t=>t.startsWith("[[")&&t.endsWith("]]")?t:`[[${t}]]`)}getVaultBasePath(){var r;let e=this.app.vault.adapter;if(e instanceof m.FileSystemAdapter)return e.getBasePath();let t=e,n=(r=t.getBasePath)==null?void 0:r.call(t);if(n)return n;throw new Error("Vault base path is unavailable.")}expandPathValue(e){let t=(e||"").trim();if(!t)return t;let n=t;return n==="~"?n=Fe.default.homedir():(n.startsWith("~/")||n.startsWith("~\\"))&&(n=R.default.join(Fe.default.homedir(),n.slice(2))),n=n.replace(/\$([A-Za-z_][A-Za-z0-9_]*)|\$\{([^}]+)\}/g,(r,i,a)=>{let s=i||a,o=s?process.env[s]:void 0;return o!==void 0?o:r}),n=n.replace(/%([^%]+)%/g,(r,i)=>{let a=process.env[i];return a!==void 0?a:r}),n}resolvePythonPath(){return this.resolveUserPath(this.settings.pythonPath||"")}getPythonRuntimeMode(){return this.settings.pythonRuntime==="local"?"local":"worker"}usePythonWorker(){return this.getPythonRuntimeMode()==="worker"}getPythonWorkerCacheDir(){return R.default.join(this.getVaultBasePath(),re,"python-worker-cache")}getPythonWorkerApiPort(e){let n=(Number.isFinite(e!=null?e:NaN)?Number(e):this.getRedisPortFromUrl())+zn;return n>=1024&&n<=65535?n:Mn}getPythonWorkerApiBaseUrl(e){let t=Number.isFinite(e!=null?e:NaN)?Number(e):this.getPythonWorkerApiPort();return`http://${Fn}:${t}`}getPythonWorkerApiPortFromContext(e){let t=Number.parseInt(String(e.composeEnv.ZRR_WORKER_PORT||""),10);return Number.isFinite(t)&&t>0?t:this.getPythonWorkerApiPort()}nextPythonWorkerRequestId(e){this.pythonWorkerRequestSeq+=1;let t=e.replace(/[^a-zA-Z0-9_.-]/g,"_");return`${Date.now().toString(36)}-${this.pythonWorkerRequestSeq.toString(36)}-${t}`}logPythonWorkerTiming(e,t){console.debug("[zrr-python-worker]",e,t)}async isPythonWorkerApiHealthy(e,t=1500){let n=`${this.getPythonWorkerApiBaseUrl(this.getPythonWorkerApiPortFromContext(e))}/health`;try{let r=await this.requestLocalApiRaw(n,{headers:{Accept:"application/json"},timeoutMs:t});if(r.statusCode<200||r.statusCode>=300)return!1;let i=JSON.parse(r.body.toString("utf8"));return!!(i!=null&&i.ok)}catch(r){return!1}}getWorkerToolName(e){let t=R.default.resolve(this.getPluginDir(),"tools"),n=R.default.resolve(e);if(R.default.dirname(n)!==t)return null;let r=R.default.basename(n);return!r.endsWith(".py")||r.includes(R.default.sep)?null:r}getComposeServiceNamesForCurrentRuntime(){return this.usePythonWorker()?[xe,ot]:[xe]}toContainerPath(e,t,n){let r=R.default.relative(e,t);if(r.startsWith("..")||R.default.isAbsolute(r))return null;let i=r.split(R.default.sep).filter(Boolean);return i.length?R.default.posix.join(n,...i):n}mapPathForPythonWorker(e){var i,a;if(!R.default.isAbsolute(e))return e;let t=R.default.normalize(e),n=R.default.normalize(this.getPluginDir()),r=R.default.normalize(this.getVaultBasePath());return(a=(i=this.toContainerPath(n,t,On))!=null?i:this.toContainerPath(r,t,In))!=null?a:e}getWorkerHostAlias(){return(this.settings.dockerPath||"").toLowerCase().includes("podman")?"host.containers.internal":"host.docker.internal"}mapUrlForPythonWorker(e){let t=(e||"").trim();if(!t)return e;let n;try{n=new URL(t)}catch(r){return e}return!["http:","https:","redis:","rediss:","redis+tls:"].includes(n.protocol)||!this.isLocalRedisHost(n.hostname||"")?e:n.protocol==="redis:"||n.protocol==="rediss:"||n.protocol==="redis+tls:"?(n.hostname=xe,n.port="6379",n.toString()):(n.hostname=this.getWorkerHostAlias(),n.toString())}mapPythonArgsForWorker(e){return e.map((t,n)=>{if(n>0&&e[n-1]==="--redis-url")return this.mapUrlForPythonWorker(t);if(t.startsWith("--redis-url=")){let a=t.slice(12);return`--redis-url=${this.mapUrlForPythonWorker(a)}`}let r=this.mapUrlForPythonWorker(t);if(r!==t)return r;if(!R.default.isAbsolute(t))return t;let i=this.mapPathForPythonWorker(t);if(i===t)throw new Error(`Python worker cannot access path '${t}'. Keep files under your vault or plugin directory.`);return i})}resolveUserPath(e,t){let n=this.expandPathValue(e);return!n||!(n.includes("/")||n.includes("\\"))||R.default.isAbsolute(n)?n:t&&(n.startsWith("./")||n.startsWith(".\\"))?R.default.join(t,n.slice(2)):R.default.join(Fe.default.homedir(),n)}getPluginDir(){var r;let e=this.getVaultBasePath(),t=(r=this.manifest.dir)!=null?r:this.manifest.id;if(!t)throw new Error("Plugin directory is unavailable.");let n=R.default.isAbsolute(t)?t:R.default.join(e,t);return R.default.normalize(n)}async ensureBundledTools(){let e=this.getPluginDir(),t=R.default.join(e,"tools");await Y.promises.mkdir(t,{recursive:!0});for(let[n,r]of Object.entries(en)){let i=R.default.join(t,n),a=!0;try{await Y.promises.readFile(i,"utf8")===r&&(a=!1)}catch(s){}a&&await Y.promises.writeFile(i,r,"utf8")}}async migrateCachePaths(){let e="zotero/items",t="zotero/chunks",n=oe,r=ee,i=this.app.vault.adapter,a=(0,m.normalizePath)(e),s=(0,m.normalizePath)(t),o=(0,m.normalizePath)(n),l=(0,m.normalizePath)(r),c=o.split("/").slice(0,-1).join("/"),d=l.split("/").slice(0,-1).join("/");c&&await this.ensureFolder(c),d&&await this.ensureFolder(d);let u=await i.exists(a),p=await i.exists(s),g=await i.exists(o),b=await i.exists(l);u&&!g&&await i.rename(a,o),p&&!b&&await i.rename(s,l)}getAbsoluteVaultPath(e){let t=this.getVaultBasePath(),n=R.default.isAbsolute(e)?e:R.default.join(t,e);return R.default.normalize(n)}async resolveAttachmentOutputDir(e){let t=e?R.default.isAbsolute(e)?this.toVaultRelativePath(e):(0,m.normalizePath)(e):"";if(!t)return null;let n=this.app.fileManager;if(!(n!=null&&n.getAvailablePathForAttachment))return null;try{let r=`zrr-image-${Date.now()}.png`,i=await n.getAvailablePathForAttachment(r,t);if(!i)return null;let a=R.default.isAbsolute(i)?i:this.getAbsoluteVaultPath(i),s=R.default.normalize(R.default.dirname(a)),o=R.default.normalize(this.getVaultBasePath()),l=this.toVaultRelativePath(s);return!l&&s!==o?null:{absolute:s,relative:l}}catch(r){return console.warn("Failed to resolve attachment output dir",r),null}}async resolveAnnotationImageOutputDir(e){let t=null;if(e&&(t=await this.resolveAttachmentOutputDir(e)),!t){let i=(0,m.normalizePath)(this.settings.outputNoteDir||"");if(!i)return null;t={absolute:this.getAbsoluteVaultPath(i),relative:i}}let n=(0,m.normalizePath)(R.default.join(t.relative||"","zrr-annotations")),r=R.default.normalize(R.default.join(t.absolute,"zrr-annotations"));return n&&await this.ensureFolder(n),{absolute:r,relative:n}}async buildDoclingArgs(e,t,n,r,i,a=!1){let s=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",t,"--out-json",this.getAbsoluteVaultPath(n),"--out-md",this.getAbsoluteVaultPath(r),"--chunking",this.settings.chunkingMode,"--ocr",s];a&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),this.settings.forcePerPageOcr&&o.push("--force-per-page-ocr"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),i&&o.push("--language-hint",i),this.settings.enableLlmCleanup&&(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars)));let l=this.getPluginDir(),c=R.default.join(l,"tools","ocr_wordlist.txt");if((0,Y.existsSync)(c)&&o.push("--enable-dictionary-correction","--dictionary-path",c),this.settings.enableFileLogging){let u=this.getLogFileAbsolutePath();u&&o.push("--log-file",u);let p=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());p&&o.push("--spellchecker-info-out",p)}let d=await this.resolveAttachmentOutputDir(r);return d&&(d.relative&&await this.ensureFolder(d.relative),o.push("--image-output-dir",d.absolute)),this.appendOcrEngineArgs(o),o}appendOcrEngineArgs(e){let t=this.settings.ocrEngine,n=(this.settings.paddleApiKey||"").trim(),r=(this.settings.paddleVlApiUrl||"").trim(),i=(this.settings.paddleStructureApiUrl||"").trim(),a=o=>{e.push("--prefer-ocr-engine",o,"--fallback-ocr-engine",o)},s=()=>{e.push("--no-paddle-vl-api","--no-paddle-structure-api")};switch(t){case"tesseract":a("tesseract"),e.push("--no-paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_local":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl"),s();break;case"paddle_vl_local":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_api":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl","--no-paddle-vl-api"),n?(e.push("--paddle-structure-api","--paddle-structure-api-token",n),i&&e.push("--paddle-structure-api-url",i)):e.push("--no-paddle-structure-api");break;case"paddle_vl_api":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3","--no-paddle-structure-api"),n?(e.push("--paddle-vl-api","--paddle-vl-api-token",n),r&&e.push("--paddle-vl-api-url",r)):e.push("--no-paddle-vl-api");break;default:s();break}}appendEmbedSubchunkArgs(e){let t=this.settings.embedSubchunkChars;Number.isFinite(t)&&e.push("--embed-subchunk-chars",String(Math.max(0,Math.trunc(t))));let n=this.settings.embedSubchunkOverlap;Number.isFinite(n)&&e.push("--embed-subchunk-overlap",String(Math.max(0,Math.trunc(n))))}appendEmbedContextArgs(e){let t=this.settings.embedContextWindow;Number.isFinite(t)&&e.push("--embed-context-window",String(Math.max(0,Math.trunc(t))));let n=this.settings.embedContextChars;Number.isFinite(n)&&e.push("--embed-context-chars",String(Math.max(0,Math.trunc(n))))}appendChunkTaggingArgs(e,t){if((t==null?void 0:t.allowRegenerate)===!1||!this.settings.enableChunkTagging)return;let n=(this.settings.llmCleanupBaseUrl||"").trim(),r=(this.settings.llmCleanupModel||"").trim();if(!n||!r)return;e.push("--generate-chunk-tags","--tag-base-url",n,"--tag-model",r);let i=(this.settings.llmCleanupApiKey||"").trim();i&&e.push("--tag-api-key",i),e.push("--tag-temperature",String(this.settings.llmCleanupTemperature))}getRedisDataDir(){let e=this.resolveUserPath(process.env.ZRR_DATA_DIR||"");if(e)return e;let t=this.resolveUserPath(this.settings.redisDataDirOverride||"",this.getVaultBasePath());return!this.settings.autoAssignRedisPort&&t?t:R.default.join(this.getVaultBasePath(),re,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return R.default.join(e,"tools","docker-compose.yml")}prependBinaryDirToPath(e,t){if(!t||!R.default.isAbsolute(t))return;let n=R.default.dirname(t),r=e.PATH||"";(r?r.split(R.default.delimiter):[]).includes(n)||(e.PATH=r?`${n}${R.default.delimiter}${r}`:n)}async resolveDockerPath(){var c;let e=(c=this.settings.dockerPath)==null?void 0:c.trim(),t=e?this.resolveUserPath(e):"",n=["/opt/homebrew/bin/docker","/usr/local/bin/docker","/usr/bin/docker","/Applications/Docker.app/Contents/Resources/bin/docker"],r=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"],i=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"],a=[];t&&a.push(t);let s=t?this.getContainerCliKind(t):"docker",o=s==="podman-compose"?[i,r,n]:s==="podman"?[r,i,n]:[n,r,i];if(!t||t==="docker"||t==="podman"||t==="podman-compose")for(let d of o)a.push(...d);for(let d of a)if(R.default.isAbsolute(d))try{if(await this.isContainerCliAvailable(d))return d}catch(u){}let l=[t,s==="podman"?"podman":"docker",s==="podman"?"docker":"podman","podman-compose"].filter(d=>!!(d&&d.trim()));for(let d of l)if(await this.isContainerCliAvailable(d))return d;return t||"docker"}async isContainerCliAvailable(e){return new Promise(t=>{let n=(0,ae.spawn)(e,["--version"]);n.on("error",()=>t(!1)),n.on("close",r=>t(r===0))})}getContainerCliKind(e){let t=R.default.basename(e);return t==="podman-compose"?"podman-compose":t.includes("podman")?"podman":"docker"}async isContainerDaemonRunning(e){let t=this.getContainerCliKind(e),n=e,r=["info"];if(t==="podman-compose"){let i=await this.resolvePodmanBin();if(!i)return!1;n=i}return new Promise(i=>{let a=(0,ae.spawn)(n,r),s=!1,o=c=>{s||(s=!0,i(c))},l=setTimeout(()=>{a.kill(),o(!1)},2e3);a.on("error",()=>{clearTimeout(l),o(!1)}),a.on("close",c=>{clearTimeout(l),o(c===0)})})}getContainerDaemonHint(e){let t=this.getContainerCliKind(e);return t==="podman"||t==="podman-compose"?"Podman machine not running. Run `podman machine start`.":"Docker Desktop is not running. Start Docker Desktop."}async supportsComposeSubcommand(e){return new Promise(t=>{let n=(0,ae.spawn)(e,["compose","version"]);n.on("error",()=>t(!1)),n.on("close",r=>t(r===0))})}async findPodmanComposePath(){let e=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"];for(let t of e)try{return await Y.promises.access(t),t}catch(n){}return await this.isContainerCliAvailable("podman-compose")?"podman-compose":null}async resolvePodmanBin(){let e=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"];for(let t of e)if(await this.isContainerCliAvailable(t))return t;return await this.isContainerCliAvailable("podman")?"podman":null}async resolveComposeCommand(e){let t=R.default.basename(e);if(t==="podman-compose")return{command:e,argsPrefix:[]};if(t==="podman"){let n=await this.findPodmanComposePath();return n?{command:n,argsPrefix:[]}:await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}return await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}async buildComposeEnvironment(e,t,n){var o;let r={...process.env};if(this.prependBinaryDirToPath(r,e),this.prependBinaryDirToPath(r,t.command),R.default.basename(t.command)==="podman-compose"){let l=await this.resolvePodmanBin();l&&(r.PODMAN_BIN=l,this.prependBinaryDirToPath(r,l))}let i=(n==null?void 0:n.dataDir)||this.getRedisDataDir(),a=(o=n==null?void 0:n.redisPort)!=null?o:this.getRedisPortFromUrl(),s=this.getPythonWorkerApiPort(a);return r.ZRR_DATA_DIR=this.toComposePath(i),r.ZRR_PORT=String(a),r.ZRR_WORKER_PORT=String(s),r.ZRR_VAULT_DIR=this.toComposePath(this.getVaultBasePath()),r.ZRR_PLUGIN_DIR=this.toComposePath(this.getPluginDir()),r.ZRR_WORKER_CACHE_DIR=this.toComposePath(this.getPythonWorkerCacheDir()),r}toComposePath(e){return process.platform!=="win32"?e:e.replace(/\\/g,"/")}async resolveComposeProjectContext(e){await this.ensureBundledTools();let t=this.getDockerComposePath(),n=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(n))throw new Error('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');if(!await this.isContainerDaemonRunning(n))throw new Error(this.getContainerDaemonHint(n));let r=await this.resolveComposeCommand(n);if(!r)throw new Error("Compose support not found. Install Docker Desktop or Podman with podman-compose.");let i=await this.buildComposeEnvironment(n,r,e);return{composePath:t,composeCommand:r,composeEnv:i,project:this.getDockerProjectName()}}async maybeShowFirstContainerStartupNotice(e){if(!(e||this.settings.firstContainerStartupNoticeShown)){this.settings.firstContainerStartupNoticeShown=!0;try{await this.saveSettings()}catch(t){console.warn("Failed to persist first container startup notice flag",t)}new m.Notice("First container startup can take several minutes (sometimes 10+ minutes) while images are pulled and worker dependencies are built.",16e3)}}async autoDetectContainerCliOnLoad(){var o;let e=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(e)){this.notifyContainerOnce("Docker or Podman not found. Install Docker Desktop or Podman and set Docker/Podman path in settings.");return}let t=((o=this.settings.dockerPath)==null?void 0:o.trim())||"docker",n=this.expandPathValue(t);!await this.isContainerCliAvailable(n)&&!(t==="docker"||t==="podman"||t==="podman-compose")&&e&&e!==t&&(this.settings.dockerPath=e,await this.saveSettings());let s=l=>new Promise(c=>setTimeout(c,l));if(!await this.isContainerDaemonRunning(e)){for(let l of[5e3,1e4])if(await s(l),await this.isContainerDaemonRunning(e))return;this.notifyContainerOnce(this.getContainerDaemonHint(e))}}getDockerProjectName(){let e=s=>s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,32),t=(process.env.ZRR_PROJECT_NAME||"").trim();if(t&&!this.settings.autoAssignRedisPort)return e(t)||"zrr";let n=(this.settings.redisProjectName||"").trim();if(n&&!this.settings.autoAssignRedisPort)return e(n)||"zrr";let r=this.getVaultBasePath(),i=R.default.basename(r).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),a=(0,Me.createHash)("sha1").update(r).digest("hex").slice(0,8);return`zrr-${i||"vault"}-${a}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),t=e.port?Number(e.port):6379;return Number.isFinite(t)&&t>0?t:6379}catch(e){return 6379}}getVaultPreferredRedisPort(){let e=(0,Me.createHash)("sha1").update(this.getVaultBasePath()).digest("hex");return 6400+Number.parseInt(e.slice(0,4),16)%2e3}getRedisHostFromUrl(){try{return new URL(this.settings.redisUrl).hostname||"127.0.0.1"}catch(e){return"127.0.0.1"}}isLocalRedisHost(e){let t=e.trim().toLowerCase();return t?t==="localhost"||t==="0.0.0.0"||t==="::1"?!0:t.startsWith("127."):!1}getPortCheckHost(e){return this.isLocalRedisHost(e)?"127.0.0.1":e}async isPortFree(e,t){return new Promise(n=>{let r=Ie.default.createServer();r.once("error",()=>n(!1)),r.once("listening",()=>{r.close(()=>n(!0))}),r.listen(t,e)})}async findAvailablePort(e,t){for(let r=0;r<25;r+=1){let i=t+r;if(await this.isPortFree(e,i))return i}return null}updateRedisUrlPort(e,t){try{let n=new URL(e);return n.port=String(t),n.toString()}catch(n){return`redis://127.0.0.1:${t}`}}async isRedisReachable(e){let t="127.0.0.1",n=6379;try{let r=new URL(e);t=r.hostname||t,n=r.port?Number(r.port):n}catch(r){return!1}return t=this.getPortCheckHost(t),new Promise(r=>{let i=new Ie.default.Socket,a=!1,s=o=>{a||(a=!0,i.destroy(),r(o))};i.setTimeout(500),i.once("connect",()=>s(!0)),i.once("timeout",()=>s(!1)),i.once("error",()=>s(!1)),i.connect(n,t)})}async isZoteroLocalApiReachable(){let e=(this.settings.zoteroBaseUrl||"").trim();if(!e)return!1;let t="127.0.0.1",n=23119;try{let r=new URL(e);if(t=r.hostname||t,r.port){let i=Number(r.port);Number.isFinite(i)&&i>0&&(n=i)}else r.protocol==="https:"?n=443:n=80}catch(r){return!1}return new Promise(r=>{let i=new Ie.default.Socket,a=!1,s=o=>{a||(a=!0,i.destroy(),r(o))};i.setTimeout(500),i.once("connect",()=>s(!0)),i.once("timeout",()=>s(!1)),i.once("error",()=>s(!1)),i.connect(n,t)})}getRedisNamespace(){let e=this.getVaultBasePath(),t=R.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24),n=(0,Me.createHash)("sha1").update(e).digest("hex").slice(0,8);return`${t||"vault"}-${n}`}getRedisIndexName(){return`${(this.settings.redisIndex||"idx:zotero").trim()||"idx:zotero"}:${this.getRedisNamespace()}`}getRedisKeyPrefix(){let e=(this.settings.redisPrefix||"zotero:chunk:").trim()||"zotero:chunk:";return`${e.endsWith(":")?e:`${e}:`}${this.getRedisNamespace()}:`}async isComposeProjectRunning(e,t,n,r,i,a=[]){let s=a.length?a:[""];for(let o of s)if(!await new Promise(c=>{let d=o?[o]:[],u=(0,ae.spawn)(e,[...t,"-p",r,"-f",n,"ps","-q",...d],{cwd:R.default.dirname(n),env:i}),p="";u.stdout.on("data",g=>{p+=g.toString()}),u.on("error",g=>{console.warn("Redis Stack status check failed",g),c(!1)}),u.on("close",g=>{if(g!==0){c(!1);return}c(p.trim().length>0)})}))return!1;return!0}isContainerNameConflictError(e){return/container name/i.test(e)&&/already in use/i.test(e)}extractConflictingContainerNames(e){let t=new Set,n=/container name\s+["']\/?([^"'\s]+)["']/gi,r;for(;(r=n.exec(e))!==null;){let i=String(r[1]||"").trim().replace(/^\/+/,"");i&&t.add(i)}return Array.from(t)}getExpectedComposeContainerNames(e,t){let n=new Set([...t,xe,ot]);return Array.from(n).map(r=>`${e}-${r}-1`)}async resolveContainerRuntimeCommandForCompose(e){if(R.default.basename(e.composeCommand.command||"")==="podman-compose"){let n=String(e.composeEnv.PODMAN_BIN||"").trim();return n||this.resolvePodmanBin()}return e.composeCommand.command||null}async recoverFromContainerNameConflict(e,t,n){let r=e instanceof Error?e.message:String(e!=null?e:"");if(!this.isContainerNameConflictError(r))return!1;let i=this.getExpectedComposeContainerNames(t.project,n),a=this.extractConflictingContainerNames(r),s=`${t.project}-`,o=Array.from(new Set([...i,...a])).map(c=>c.replace(/^\/+/,"").trim()).filter(c=>c.startsWith(s));if(!o.length)return!1;let l=await this.resolveContainerRuntimeCommandForCompose(t);if(!l)return!1;console.warn("Recovering from stale container name conflict",{project:t.project,containers:o});for(let c of o)try{await this.runCommand(l,["rm","-f",c],{cwd:R.default.dirname(t.composePath),env:t.composeEnv})}catch(d){console.warn("Failed to remove stale container during conflict recovery",{name:c,cleanupError:d})}return!0}async startRedisStack(e){var t;try{await this.ensureBundledTools();let n=this.getDockerComposePath(),r=this.getRedisDataDir(),i=this.getPythonWorkerCacheDir();await Y.promises.mkdir(r,{recursive:!0}),await Y.promises.mkdir(i,{recursive:!0});let a=await this.resolveDockerPath(),s=((t=this.settings.dockerPath)==null?void 0:t.trim())||"docker",o=this.resolveUserPath(s),l=s==="docker"||s==="podman"||s==="podman-compose";if(!await this.isContainerCliAvailable(o)&&!l&&a&&a!==s&&(this.settings.dockerPath=a,await this.saveSettings(),e||new m.Notice(`Docker/Podman path set to ${a}.`)),!await this.isContainerCliAvailable(a)){e||new m.Notice('Docker or podman not found. Install docker desktop or podman and set "docker/podman path" in settings.');return}if(!await this.isContainerDaemonRunning(a)){e||new m.Notice(this.getContainerDaemonHint(a));return}let u=await this.resolveComposeCommand(a);if(!u){e||new m.Notice("Compose support not found. Install docker desktop or podman with podman-compose.");return}let p=this.getRedisPortFromUrl(),g=await this.buildComposeEnvironment(a,u,{dataDir:r,redisPort:p}),b=this.getDockerProjectName(),y={composePath:n,composeCommand:u,composeEnv:g,project:b},v=this.getComposeServiceNamesForCurrentRuntime();if(await this.isComposeProjectRunning(u.command,u.argsPrefix,n,b,g,v)){e||new m.Notice(this.usePythonWorker()?"Redis Stack and Python worker already running for this vault.":"Redis Stack already running for this vault.");return}let f=this.getRedisHostFromUrl(),k=this.getPortCheckHost(f),x=this.settings.autoAssignRedisPort&&this.isLocalRedisHost(f),w=this.settings.redisUrl,E=p,P=()=>{if(!e){if(!this.settings.autoAssignRedisPort){new m.Notice("Redis already running. If you share redis across vaults, disable auto-start redis in this vault.");return}new m.Notice(`Redis already running at ${w}.`)}};if(x){let T=p===6379?this.getVaultPreferredRedisPort():p,I=await this.findAvailablePort(k,T);if(!I)throw new Error(`No available Redis port found starting at ${T}.`);I!==p&&(E=I,w=this.updateRedisUrlPort(w,E),this.settings.redisUrl=w,await this.saveSettings(),e||new m.Notice(`Using Redis port ${E} for this vault.`))}else{if(this.isLocalRedisHost(f)&&!await this.isPortFree(k,E)){await this.isRedisReachable(w)?(P(),this.usePythonWorker()&&(await this.maybeShowFirstContainerStartupNotice(e),await this.startPythonWorkerService(y))):e||new m.Notice(`Port ${E} is already in use and Redis is not reachable at ${w}. Update the Redis URL or enable auto-assign.`);return}if(await this.isRedisReachable(w)){P(),this.usePythonWorker()&&(await this.maybeShowFirstContainerStartupNotice(e),await this.startPythonWorkerService(y));return}}g.ZRR_PORT=String(E);try{await this.runCommand(u.command,[...u.argsPrefix,"-p",b,"-f",n,"down"],{cwd:R.default.dirname(n),env:g})}catch(T){console.warn("Redis Stack stop before restart failed",T)}let S=[...u.argsPrefix,"-p",b,"-f",n,"up","-d"];this.usePythonWorker()&&S.push("--build"),S.push(...v),await this.maybeShowFirstContainerStartupNotice(e);try{await this.runCommand(u.command,S,{cwd:R.default.dirname(n),env:g})}catch(T){if(!await this.recoverFromContainerNameConflict(T,y,v))throw T;console.debug("Retrying Redis stack startup after container conflict recovery."),await this.runCommand(u.command,S,{cwd:R.default.dirname(n),env:g})}e||new m.Notice("Redis stack started.")}catch(n){e||new m.Notice("Failed to start redis stack. Check docker/podman and file sharing."),console.error("Failed to start Redis Stack",n)}}async waitForPythonWorkerReady(e,t=900*1e3){let n=Date.now(),r=i=>new Promise(a=>setTimeout(a,i));for(;Date.now()-n<t;){if(await this.isPythonWorkerApiHealthy(e))return;await r(2e3)}throw new Error("Python worker is still starting. Check compose logs for the python-worker service.")}async startPythonWorkerService(e){let t=e!=null?e:await this.resolveComposeProjectContext({dataDir:this.getRedisDataDir(),redisPort:this.getRedisPortFromUrl()}),n=[...t.composeCommand.argsPrefix,"-p",t.project,"-f",t.composePath,"up","-d","--build",ot];await this.runCommand(t.composeCommand.command,n,{cwd:R.default.dirname(t.composePath),env:t.composeEnv})}async ensureWorkerRedisService(e,t){if(!this.settings.autoStartRedis||!this.isLocalRedisHost(this.getRedisHostFromUrl()))return;if(!await this.isComposeProjectRunning(e.composeCommand.command,e.composeCommand.argsPrefix,e.composePath,e.project,e.composeEnv,[xe])&&t){let i=[...e.composeCommand.argsPrefix,"-p",e.project,"-f",e.composePath,"up","-d",xe];await this.runCommand(e.composeCommand.command,i,{cwd:R.default.dirname(e.composePath),env:e.composeEnv})}if(!await this.isComposeProjectRunning(e.composeCommand.command,e.composeCommand.argsPrefix,e.composePath,e.project,e.composeEnv,[xe]))throw new Error("Redis service is not running. Start Redis stack now or enable Auto-start Redis stack.")}async ensurePythonWorkerContext(e){let t=this.getRedisDataDir();await Y.promises.mkdir(t,{recursive:!0}),await Y.promises.mkdir(this.getPythonWorkerCacheDir(),{recursive:!0});let n=await this.resolveComposeProjectContext({dataDir:t,redisPort:this.getRedisPortFromUrl()}),r=[ot];if(!await this.isComposeProjectRunning(n.composeCommand.command,n.composeCommand.argsPrefix,n.composePath,n.project,n.composeEnv,r)&&e&&(await this.startPythonWorkerService(n),n=await this.resolveComposeProjectContext({dataDir:t,redisPort:this.getRedisPortFromUrl()})),!await this.isComposeProjectRunning(n.composeCommand.command,n.composeCommand.argsPrefix,n.composePath,n.project,n.composeEnv,r))throw new Error("Python worker is not running. Start Redis stack now or enable Auto-start Redis stack.");return await this.ensureWorkerRedisService(n,e),await this.waitForPythonWorkerReady(n),n}async setupPythonEnv(){if(this.usePythonWorker()){try{new m.Notice("Setting up python worker environment..."),this.showStatusProgress("Setting up Python worker environment...",null),await this.ensurePythonWorkerContext(!0),this.clearStatusProgress(),new m.Notice("Python worker environment ready.")}catch(i){this.clearStatusProgress(),new m.Notice("Failed to set up python worker environment. See console for details."),console.error("Python worker setup failed",i)}return}let e=this.getPluginDir(),t=this.getPythonVenvDir(),n=this.getVenvPythonPath(t);await this.ensureBundledTools();let r=this.resolveRequirementsPath(e);if(!r)throw new Error(`requirements.txt not found in ${e}`);try{new m.Notice("Setting up python environment..."),this.showStatusProgress("Setting up Python environment...",null),console.debug(`Python env: using plugin dir ${e}`),console.debug(`Python env: venv path ${t}`),await Y.promises.mkdir(R.default.dirname(t),{recursive:!0});let i=null,a=async()=>(i||(i=await this.resolveBootstrapPython()),i);if((0,Y.existsSync)(n)){let s=await this.getPythonVersion(n,[]);if(s&&this.isUnsupportedPythonVersion(s)){let o=await a();console.debug(`Python env: existing venv uses Python ${s.major}.${s.minor}; rebuilding with ${o.command} ${o.args.join(" ")}`),this.showStatusProgress("Rebuilding Python environment...",null),await Y.promises.rm(t,{recursive:!0,force:!0})}}if(!(0,Y.existsSync)(n)){let s=await a();console.debug(`Python env: creating venv with ${s.command} ${s.args.join(" ")}`),await this.runCommand(s.command,[...s.args,"-m","venv",t],{cwd:e})}await this.runCommandStreaming(n,["-m","pip","install","-r",r],{cwd:e},s=>{let o=s.trim();if(!o)return;let l=o.match(/^Collecting\s+([^\s]+)/);if(l){this.showStatusProgress(`Installing ${l[1]}...`,null);return}if(o.startsWith("Installing collected packages")){this.showStatusProgress("Installing packages...",null);return}o.startsWith("Successfully installed")&&this.showStatusProgress("Python environment ready.",100)}),this.settings.pythonPath=n,await this.saveSettings(),this.clearStatusProgress(),new m.Notice("Python environment ready.")}catch(i){this.clearStatusProgress(),new m.Notice("Failed to set up python environment. See console for details."),console.error("Python env setup failed",i)}}async detectOcrEngines(){if(this.usePythonWorker())return{tesseract:!0,paddleStructureLocal:!0,paddleVlLocal:!0};let e=await this.canRunCommand("tesseract",[]),t=this.resolvePythonPath(),n=[];if(!t)try{let l=await this.resolveBootstrapPython();t=l.command,n=l.args}catch(l){return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1}}let r=["import importlib.util, json","def has_module(name):","    return importlib.util.find_spec(name) is not None","has_paddle = has_module('paddle')","has_paddleocr = has_module('paddleocr')","has_paddlex = has_module('paddlex')","has_vl = False","if has_paddleocr:","    try:","        from paddleocr import PaddleOCRVL","        has_vl = True","    except Exception:","        has_vl = False","print(json.dumps({'paddle': has_paddle, 'paddleocr': has_paddleocr, 'paddlex': has_paddlex, 'paddle_vl': has_vl}))"].join(`
`),i=await new Promise(l=>{let c=(0,ae.spawn)(t,[...n,"-c",r],{env:this.buildPythonEnv()}),d="";c.stdout.on("data",u=>{d+=u.toString()}),c.on("error",()=>l({ok:!1})),c.on("close",u=>{if(u!==0){l({ok:!1});return}try{let p=JSON.parse(d.trim());l({ok:!0,data:p})}catch(p){l({ok:!1})}})});if(!i.ok||!i.data)return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1};let a=i.data,s=!!a.paddle,o=!!a.paddleocr;return{tesseract:e,paddleStructureLocal:s&&o&&!!a.paddlex,paddleVlLocal:s&&o&&!!a.paddle_vl}}getSharedPythonEnvRoot(){let e=Fe.default.homedir();if(process.platform==="win32"){let n=process.env.LOCALAPPDATA||process.env.APPDATA||R.default.join(e,"AppData","Local");return R.default.join(n,"zotero-redisearch-rag")}let t=process.env.XDG_CACHE_HOME||R.default.join(e,".cache");return R.default.join(t,"zotero-redisearch-rag")}getPythonVenvDir(){return this.settings.pythonEnvLocation==="plugin"?R.default.join(this.getPluginDir(),".venv"):R.default.join(this.getSharedPythonEnvRoot(),"venv")}getVenvPythonPath(e){return process.platform==="win32"?R.default.join(e,"Scripts","python.exe"):R.default.join(e,"bin","python")}resolveRequirementsPath(e){var n;return(n=[R.default.join(e,"requirements.txt"),R.default.join(e,"tools","requirements.txt")].find(r=>(0,Y.existsSync)(r)))!=null?n:null}async resolveBootstrapPython(){let e=(this.settings.pythonPath||"").trim(),t=this.expandPathValue(e);if(t&&await this.canRunCommand(t,[])){let r=await this.getPythonVersion(t,[]);if(r&&this.isUnsupportedPythonVersion(r))throw new Error(`Configured Python ${r.major}.${r.minor} is not supported. Install Python 3.11\u20133.13 and update the Python path.`);return{command:t,args:[]}}let n=process.platform==="win32"?[{command:"py",args:["-3.13"]},{command:"py",args:["-3.12"]},{command:"py",args:["-3.11"]},{command:"py",args:["-3.10"]},{command:"py",args:["-3"]},{command:"python",args:[]}]:[{command:"python3.13",args:[]},{command:"python3.12",args:[]},{command:"python3.11",args:[]},{command:"python3.10",args:[]},{command:"python3",args:[]},{command:"python",args:[]}];for(let r of n)if(await this.canRunCommand(r.command,r.args)){let i=await this.getPythonVersion(r.command,r.args);if(i&&this.isUnsupportedPythonVersion(i)){console.debug(`Python env: skipping ${r.command} ${r.args.join(" ")} (Python ${i.major}.${i.minor} unsupported)`);continue}return r}throw new Error("No usable Python 3.11\u20133.13 interpreter found on PATH.")}isUnsupportedPythonVersion(e){return e.major>3||e.major===3&&e.minor>=14}async getPythonVersion(e,t){return new Promise(n=>{let r=(0,ae.spawn)(e,[...t,"-c","import sys; print(f'{sys.version_info.major}.{sys.version_info.minor}')"]),i="";r.stdout.on("data",a=>{i+=a.toString()}),r.on("error",()=>n(null)),r.on("close",a=>{if(a!==0){n(null);return}let s=i.trim().match(/(\d+)\.(\d+)/);if(!s){n(null);return}n({major:Number(s[1]),minor:Number(s[2])})})})}async canRunCommand(e,t){return new Promise(n=>{let r=(0,ae.spawn)(e,[...t,"--version"],{env:this.buildPythonEnv()});r.on("error",()=>n(!1)),r.on("close",i=>n(i===0))})}buildPythonEnv(){let e={...process.env},t=R.default.delimiter,n=e.PATH||"",i=[...process.platform==="win32"?[]:["/opt/homebrew/bin","/usr/local/bin"],n].filter(Boolean).join(t);return e.PATH=i,e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK||(e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK="True"),e.DISABLE_MODEL_SOURCE_CHECK||(e.DISABLE_MODEL_SOURCE_CHECK="True"),e}getLocalPythonInvocation(e,t){return{command:this.resolvePythonPath(),args:[e,...t],cwd:R.default.dirname(e),env:this.buildPythonEnv()}}async runPython(e,t){if(this.usePythonWorker()){let r=this.getWorkerToolName(e);if(!r)throw new Error(`Python worker can only run bundled tools under '${R.default.join(this.getPluginDir(),"tools")}'.`);await this.runPythonToolWithOutputViaWorkerApi(r,t,this.settings.autoStartRedis);return}let n=this.getLocalPythonInvocation(e,t);return new Promise((r,i)=>{let a=(0,ae.spawn)(n.command,n.args,{cwd:n.cwd,env:n.env}),s="",o="";a.stdout.on("data",l=>{s+=l.toString()}),a.stderr.on("data",l=>{o+=l.toString()}),a.on("error",l=>{this.handlePythonProcessError(String(l)),i(l)}),a.on("close",l=>{if(l===0)r();else{let c=o.trim()?o:s;this.handlePythonProcessError(c),i(new Error(o||`Process exited with code ${l}`))}})})}runCommand(e,t,n){return new Promise((r,i)=>{var o;let a=(0,ae.spawn)(e,t,{cwd:n==null?void 0:n.cwd,env:(o=n==null?void 0:n.env)!=null?o:this.buildPythonEnv()}),s="";a.stderr.on("data",l=>{s+=l.toString()}),a.on("error",l=>{i(l)}),a.on("close",l=>{l===0?r():i(new Error(s||`Process exited with code ${l}`))})})}async runPythonStreaming(e,t,n,r,i,a="docling_extract",s,o){if(this.usePythonWorker()){let c=this.getWorkerToolName(e);if(!c)throw new Error(`Python worker can only run bundled tools under '${R.default.join(this.getPluginDir(),"tools")}'.`);await this.runPythonStreamingViaWorkerApi(c,t,n,r,i,a,this.settings.autoStartRedis,s,o);return}let l=this.getLocalPythonInvocation(e,t);return new Promise((c,d)=>{let u=(0,ae.spawn)(l.command,l.args,{cwd:l.cwd,env:l.env});s&&s(u);let p="",g="",b="",y=null,v=!1,f=k=>{if(k.trim())try{let x=JSON.parse(k);y=x,((x==null?void 0:x.type)==="final"||x!=null&&x.answer)&&(v=!0),n(x)}catch(x){b+=`${k}
`}};u.stdout.on("data",k=>{var w;p+=k.toString();let x=p.split(/\r?\n/);p=(w=x.pop())!=null?w:"";for(let E of x)f(E)}),u.stderr.on("data",k=>{g+=k.toString()}),u.on("error",k=>{this.handlePythonProcessError(String(k)),d(k)}),u.on("close",k=>{if(p.trim()&&f(p),!v&&y&&r(y),i&&this.appendToLogFile(i,g,a,"STDERR"),k===0)c();else{let x=g.trim()?g:b;this.handlePythonProcessError(x),d(new Error(g||`Process exited with code ${k}`))}})})}runCommandStreaming(e,t,n,r){return new Promise((i,a)=>{var c;let s=(0,ae.spawn)(e,t,{cwd:n==null?void 0:n.cwd,env:(c=n==null?void 0:n.env)!=null?c:this.buildPythonEnv()}),o=d=>{d.toString().split(/\r?\n/).forEach(p=>{p.trim()&&r(p)})},l="";s.stdout.on("data",o),s.stderr.on("data",d=>{l+=d.toString(),o(d)}),s.on("error",d=>{a(d)}),s.on("close",d=>{d===0?i():a(new Error(l||`Process exited with code ${d}`))})})}async requestPythonWorkerCancel(e,t,n=2e3){let r=`${e.protocol}//${e.host}/cancel`;try{await this.requestLocalApiRaw(r,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json","X-ZRR-Request-Id":t},body:JSON.stringify({request_id:t}),timeoutMs:n}),this.logPythonWorkerTiming("cancel-request",{requestId:t,cancelUrl:r})}catch(i){this.logPythonWorkerTiming("cancel-request-error",{requestId:t,cancelUrl:r,error:String(i)})}}async runPythonStreamingViaWorkerApi(e,t,n,r,i,a="docling_extract",s=!0,o,l){let c=this.nextPythonWorkerRequestId(e),d=Date.now(),u=await this.ensurePythonWorkerContext(s),p=Date.now(),g=this.mapPythonArgsForWorker(t),b=`${this.getPythonWorkerApiBaseUrl(this.getPythonWorkerApiPortFromContext(u))}/run-stream`,y=new URL(b),v=Number.isFinite(l!=null?l:NaN)?Math.max(1,Math.trunc(Number(l))):600,f=JSON.stringify({tool:e,args:g,timeout_sec:v});return this.logPythonWorkerTiming("stream-start",{requestId:c,tool:e,argsCount:g.length,ensureContextMs:p-d,port:this.getPythonWorkerApiPortFromContext(u),timeoutSec:v}),new Promise((k,x)=>{let w="",E="",P=null,S=!1,T=null,I=!1,L=null,j=null,F=0,M=!1,V=()=>{M=!0},O=wt.default.request({method:"POST",hostname:y.hostname,port:y.port||void 0,path:`${y.pathname}${y.search}`,headers:{Accept:"application/x-ndjson","Content-Type":"application/json","Content-Length":String(Buffer.byteLength(f)),"X-ZRR-Request-Id":c}},q=>{var $;L=Date.now();let W=B=>{if(B.trim())try{let U=JSON.parse(B);P=U,((U==null?void 0:U.type)==="final"||U!=null&&U.answer)&&(S=!0,!I&&(U!=null&&U.timing)&&typeof U.timing=="object"&&(I=!0,this.logPythonWorkerTiming("stream-tool-timing",{requestId:c,tool:e,timing:U.timing}))),n(U)}catch(U){E+=`${B}
`}},z=B=>{var U;if(B.trim())try{let H=JSON.parse(B);if((H==null?void 0:H.type)==="stdout"){F+=1,j===null&&(j=Date.now()),W(String((U=H.line)!=null?U:""));return}if((H==null?void 0:H.type)==="done"){T=H;return}E+=`${B}
`}catch(H){E+=`${B}
`}};if((($=q.statusCode)!=null?$:0)>=400){let B=[];q.on("data",U=>B.push(Buffer.from(U))),q.on("end",()=>{var H;V();let U=Buffer.concat(B).toString("utf8");this.logPythonWorkerTiming("stream-http-error",{requestId:c,tool:e,statusCode:(H=q.statusCode)!=null?H:0,durationMs:Date.now()-d}),x(new Error(`Python worker API request failed (${q.statusCode}): ${U||"no response body"}`))});return}q.on("data",B=>{var H;w+=B.toString();let U=w.split(/\r?\n/);w=(H=U.pop())!=null?H:"";for(let te of U)z(te)}),q.on("end",()=>{var ke,we,he;V(),w.trim()&&z(w);let B=this.asRecord(T),U=String((ke=B==null?void 0:B.stderr)!=null?ke:""),H=String((we=B==null?void 0:B.error)!=null?we:"").trim(),te=Number.parseInt(String((he=B==null?void 0:B.exit_code)!=null?he:1),10);if(!S&&P&&r(P),i&&U&&this.appendToLogFile(i,U,a,"STDERR"),this.logPythonWorkerTiming("stream-done",{requestId:c,tool:e,exitCode:Number.isFinite(te)?te:1,totalMs:Date.now()-d,responseOpenMs:L?L-d:null,firstStdoutMs:j?j-d:null,stdoutEvents:F,stderrBytes:U.length,doneError:H}),Number.isFinite(te)&&te===0){k();return}if(/^(canceled|cancelled|client_disconnected)$/i.test(H)){x(new Error(`Python worker request canceled: ${H}`));return}let ue=U.trim()?U:H||E;this.handlePythonProcessError(ue),x(new Error(U||H||`Process exited with code ${Number.isFinite(te)?te:1}`))})});o&&o({get killed(){return M},kill:q=>M?!1:(V(),this.requestPythonWorkerCancel(y,c),O.destroy(new Error("Python worker request aborted")),!0)}),O.setTimeout((v+30)*1e3,()=>{O.destroy(new Error("Python worker streaming request timed out"))}),O.on("error",q=>{V(),this.logPythonWorkerTiming("stream-request-error",{requestId:c,tool:e,durationMs:Date.now()-d,error:String(q)}),this.handlePythonProcessError(String(q)),x(q)}),O.write(f),O.end()})}handlePythonProcessError(e){if(!e)return;if(/Python worker cannot access path/i.test(e)){this.notifyContainerOnce(e.replace(/^Error:\s*/i,""));return}if(/python-worker/i.test(e)&&/(No such service|is not running|not found|no container)/i.test(e)){this.notifyContainerOnce("Python worker is not running. Start Redis stack now or enable Auto-start Redis stack.");return}if(/Cannot connect to the Docker daemon|docker desktop is not running|podman machine/i.test(e)){this.notifyContainerOnce("Container runtime is not available. Start Docker Desktop or Podman.");return}if(/Python worker API request failed|Python worker streaming request timed out|ECONNREFUSED 127\.0\.0\.1/i.test(e)){this.notifyContainerOnce("Python worker API is not reachable. Start Redis stack now or check python-worker container logs.");return}let t=e.match(/ModuleNotFoundError:\s+No module named ['"]([^'"]+)['"]/);if(t){let n=this.usePythonWorker()?`Python worker missing module '${t[1]}'. Restart Redis stack to rebuild worker env.`:`Python env missing module '${t[1]}'. Open Settings > Python environment > Create/Update.`;this.notifyPythonEnvOnce(n,!0);return}if(/No module named ['"]|ImportError: No module named/i.test(e)){let n=this.usePythonWorker()?"Python worker missing required modules. Restart Redis stack to rebuild worker env.":"Python env missing required modules. Open Settings > Python environment > Create/Update.";this.notifyPythonEnvOnce(n,!0);return}if(/ENOENT|No such file or directory|not found|command not found|spawn .* ENOENT/i.test(e)){let n=this.usePythonWorker()?"Python worker command failed. Start Redis stack and check container logs.":"Python not found. Configure the Python path or use Settings > Python environment > Create/Update.";this.notifyPythonEnvOnce(n,!0)}}notifyPythonEnvOnce(e,t=!1){this.lastPythonEnvNotice!==e&&(this.lastPythonEnvNotice=e,new m.Notice(e),t&&this.openPluginSettings())}notifyContainerOnce(e){this.lastContainerNotice!==e&&(this.lastContainerNotice=e,new m.Notice(e))}notifyRedisOnce(e){this.lastRedisNotice!==e&&(this.lastRedisNotice=e,new m.Notice(e))}async autoDetectRedisOnLoad(){if(this.settings.autoStartRedis)return;let e=(this.settings.redisUrl||"").trim(),n=e||"redis://127.0.0.1:6379";(await this.checkRedisConnectionWithUrl(n,500)).ok&&(e||(this.settings.redisUrl=n,await this.saveSettings()),this.notifyRedisOnce(`Redis detected at ${n}. This instance will be used.`))}notifyZoteroApiOnce(e){this.lastZoteroApiNotice!==e&&(this.lastZoteroApiNotice=e,new m.Notice(e))}async warnIfZoteroLocalApiUnavailable(e){if(await this.isZoteroLocalApiReachable())return this.lastZoteroApiNotice=null,!0;let r=`Zotero Local API is not reachable for ${e?`${e}`:"this action"}. Start Zotero or update the Local API URL in settings.`;return this.notifyZoteroApiOnce(r),!1}openPluginSettings(){var t,n;let e=this.app;(t=e.setting)!=null&&t.open&&e.setting.open(),(n=e.setting)!=null&&n.openTabById&&e.setting.openTabById(this.manifest.id)}getLogsDirRelative(){return(0,m.normalizePath)(`${re}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,m.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,m.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;if(!await t.exists(e)){new m.Notice("Log file not found.");return}try{let n=async()=>{try{return await t.read(e)||"(empty)"}catch(i){return"(empty)"}},r=await n();new Ee(this.app,"Log file",r||"(empty)",{autoRefresh:!0,refreshIntervalMs:2e3,onRefresh:n,onClear:async()=>{await this.clearLogFile()}}).open()}catch(n){new m.Notice("Failed to open log file."),console.error(n)}}async clearLogFile(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;try{let n=(0,m.normalizePath)(R.default.dirname(e));n&&await this.ensureFolder(n),await t.write(e,""),new m.Notice("Log file cleared.")}catch(n){new m.Notice("Failed to clear log file."),console.error(n)}}async deleteLogFileIfExists(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;try{await t.exists(e)&&await t.remove(e)}catch(n){console.warn("Failed to delete log file before import",n)}}formatLogLines(e,t,n){let r=e.split(/\r?\n/).map(a=>a.trimEnd()).filter(a=>!!a.trim());if(!r.length)return"";let i=new Date().toISOString().replace("T"," ").replace(".",",");return r.map(a=>`${i} ${n} ${t}: ${a}`).join(`
`)+`
`}async appendToLogFile(e,t,n="docling_extract",r="STDERR"){if(!t||!t.trim())return;let i=this.formatLogLines(t,n,r);if(i)try{await Y.promises.mkdir(R.default.dirname(e),{recursive:!0}),await Y.promises.appendFile(e,i)}catch(a){console.warn("Failed to append stderr to log file",a)}}async runPythonToolWithOutputViaWorkerApi(e,t,n,r,i="docling_extract",a){var x,w,E;if(!this.usePythonWorker())throw new Error("Worker API is only available in worker runtime mode.");let s=this.nextPythonWorkerRequestId(e),o=Date.now(),l=await this.ensurePythonWorkerContext(n),c=Date.now(),d=this.mapPythonArgsForWorker(t),u=`${this.getPythonWorkerApiBaseUrl(this.getPythonWorkerApiPortFromContext(l))}/run`,p=Number.isFinite(a!=null?a:NaN)?Math.max(1,Math.trunc(Number(a))):600,g=JSON.stringify({tool:e,args:d,timeout_sec:p}),b=await this.requestLocalApiRaw(u,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json","X-ZRR-Request-Id":s},body:g,timeoutMs:(p+30)*1e3});if(b.statusCode<200||b.statusCode>=300){let P=b.body.toString("utf8");throw this.logPythonWorkerTiming("run-http-error",{requestId:s,tool:e,statusCode:b.statusCode,totalMs:Date.now()-o,ensureContextMs:c-o}),new Error(`Python worker API request failed (${b.statusCode}): ${P||"no response body"}`)}let y=JSON.parse(b.body.toString("utf8")||"{}"),v=String((x=y==null?void 0:y.stdout)!=null?x:""),f=String((w=y==null?void 0:y.stderr)!=null?w:"");y!=null&&y.timing&&typeof y.timing=="object"&&this.logPythonWorkerTiming("run-tool-timing",{requestId:s,tool:e,timing:y.timing}),r&&f&&await this.appendToLogFile(r,f,i,"STDERR");let k=Number.parseInt(String((E=y==null?void 0:y.exit_code)!=null?E:1),10);if(this.logPythonWorkerTiming("run-done",{requestId:s,tool:e,exitCode:Number.isFinite(k)?k:1,totalMs:Date.now()-o,ensureContextMs:c-o,requestMs:Date.now()-c,stdoutBytes:v.length,stderrBytes:f.length,timeoutSec:p}),!Number.isFinite(k)||k!==0){let P=f.trim()?f:v;throw this.handlePythonProcessError(P),new Error(f||`Process exited with code ${Number.isFinite(k)?k:1}`)}return v.trim()}async runPythonWithOutput(e,t,n,r="docling_extract",i){if(this.usePythonWorker()){let s=this.getWorkerToolName(e);if(!s)throw new Error(`Python worker can only run bundled tools under '${R.default.join(this.getPluginDir(),"tools")}'.`);return this.runPythonToolWithOutputViaWorkerApi(s,t,this.settings.autoStartRedis,n,r,i)}let a=this.getLocalPythonInvocation(e,t);return new Promise((s,o)=>{let l=(0,ae.spawn)(a.command,a.args,{cwd:a.cwd,env:a.env}),c="",d="";l.stdout.on("data",u=>{c+=u.toString()}),l.stderr.on("data",u=>{d+=u.toString()}),l.on("error",u=>{this.handlePythonProcessError(String(u)),o(u)}),l.on("close",u=>{if(n&&this.appendToLogFile(n,d,r,"STDERR"),u===0)s(c.trim());else{let p=d.trim()?d:c;this.handlePythonProcessError(p),o(new Error(d||`Process exited with code ${u}`))}})})}};

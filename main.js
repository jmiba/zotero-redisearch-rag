"use strict";var ce=Object.create;var B=Object.defineProperty;var de=Object.getOwnPropertyDescriptor;var pe=Object.getOwnPropertyNames;var ue=Object.getPrototypeOf,ge=Object.prototype.hasOwnProperty;var he=(L,p)=>{for(var e in p)B(L,e,{get:p[e],enumerable:!0})},te=(L,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of pe(p))!ge.call(L,t)&&t!==e&&B(L,t,{get:()=>p[t],enumerable:!(n=de(p,t))||n.enumerable});return L};var V=(L,p,e)=>(e=L!=null?ce(ue(L)):{},te(p||!L||!L.__esModule?B(e,"default",{value:L,enumerable:!0}):e,L)),fe=L=>te(B({},"__esModule",{value:!0}),L);var ye={};he(ye,{default:()=>G});module.exports=fe(ye);var c=require("obsidian"),j=require("child_process"),z=require("fs"),oe=V(require("http")),le=V(require("https")),f=V(require("path")),$=require("url"),K=require("crypto");var w=require("obsidian"),R=".zotero-redisearch-rag",q=`${R}/items`,O=`${R}/chunks`,ie={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}
...
`};var ae={"docling_extract.py":`#!/usr/bin/env python3
...
\xF6pnv
\xFCberarb
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.2.3
docling
paddleocr
pdf2image
pypdf
...
dir /data
`};var N=require("obsidian"),F="zotero-redisearch-rag-chat",M=class extends N.ItemView{constructor(e,n){super(e);this.messages=[];this.activeSessionId="default";this.messageEls=new Map;this.pendingRender=new Map;this.busy=!1;this.plugin=n}getViewType(){return F}getDisplayText(){return"Zotero RAG Chat"}getIcon(){return"zrr-chat"}async onOpen(){let{containerEl:e}=this;e.empty(),e.addClass("zrr-chat-view");let n=e.createEl("div",{cls:"zrr-chat-header"});n.createEl("div",{cls:"zrr-chat-title",text:"Zotero RAG Chat"});let t=n.createEl("div",{cls:"zrr-chat-controls"}),i=t.createEl("div",{cls:"zrr-chat-controls-row"});this.sessionSelect=i.createEl("select",{cls:"zrr-chat-session"}),this.sessionSelect.addEventListener("change",async()=>{await this.switchSession(this.sessionSelect.value)});let a=t.createEl("div",{cls:"zrr-chat-controls-row zrr-chat-controls-actions"});this.renameButton=a.createEl("button",{cls:"zrr-chat-rename",text:"Rename",attr:{title:"Rename the current chat"}}),this.renameButton.addEventListener("click",async()=>{await this.promptRenameSession()}),this.copyButton=a.createEl("button",{cls:"zrr-chat-copy",text:"Copy",attr:{title:"Copy this chat to a new note"}}),this.copyButton.addEventListener("click",async()=>{await this.copyChatToNote()}),this.deleteButton=a.createEl("button",{cls:"zrr-chat-delete",text:"Delete",attr:{title:"Delete this chat"}}),this.deleteButton.addEventListener("click",async()=>{await this.deleteChat()}),this.newButton=a.createEl("button",{cls:"zrr-chat-new",text:"New chat",attr:{title:"Start a new chat session"}}),this.newButton.addEventListener("click",async()=>{await this.startNewChat()}),this.messagesEl=e.createEl("div",{cls:"zrr-chat-messages"});let r=e.createEl("div",{cls:"zrr-chat-input"});this.inputEl=r.createEl("textarea",{cls:"zrr-chat-textarea",attr:{placeholder:"Ask your Zotero library..."}}),this.sendButton=r.createEl("button",{cls:"zrr-chat-send",text:"Send"}),this.sendButton.addEventListener("click",()=>this.handleSend()),this.inputEl.addEventListener("keydown",s=>{s.key==="Enter"&&!s.shiftKey&&(s.preventDefault(),this.handleSend())}),await this.loadSessions(),await this.loadHistory(),await this.renderAll()}focusInput(){var e;(e=this.inputEl)==null||e.focus()}async loadHistory(){try{this.messages=await this.plugin.loadChatHistoryForSession(this.activeSessionId)}catch(e){console.error(e),this.messages=[]}}async saveHistory(){try{await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages),await this.loadSessions()}catch(e){console.error(e)}}async loadSessions(){let e=await this.plugin.listChatSessions();this.activeSessionId=await this.plugin.getActiveChatSessionId(),this.sessionSelect.empty();for(let n of e){let t=this.sessionSelect.createEl("option",{text:n.name});t.value=n.id,n.id===this.activeSessionId&&(t.selected=!0)}!e.some(n=>n.id===this.activeSessionId)&&e.length>0&&(this.activeSessionId=e[0].id,await this.plugin.setActiveChatSessionId(this.activeSessionId),this.sessionSelect.value=this.activeSessionId)}async promptRenameSession(){var i;let n=(await this.plugin.listChatSessions()).find(a=>a.id===this.activeSessionId);new W(this.app,(i=n==null?void 0:n.name)!=null?i:"New chat",async a=>{await this.plugin.renameChatSession(this.activeSessionId,a),await this.loadSessions()}).open()}async startNewChat(){await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages,{force:!0});let e=await this.plugin.createChatSession("New chat");await this.switchSession(e,{skipSave:!0})}async deleteChat(){let e=await this.plugin.listChatSessions();if(e.length<=1){new N.Notice("You must keep at least one chat.");return}let n=e.find(i=>i.id===this.activeSessionId);if(!n)return;new J(this.app,n.name,async()=>{await this.plugin.deleteChatSession(this.activeSessionId);let i=await this.plugin.getActiveChatSessionId();await this.switchSession(i,{skipSave:!0})}).open()}async switchSession(e,n={}){!e||e===this.activeSessionId||(n.skipSave||await this.saveHistory(),this.activeSessionId=e,await this.plugin.setActiveChatSessionId(e),await this.loadSessions(),await this.loadHistory(),await this.renderAll())}async renderAll(){this.messagesEl.empty(),this.messageEls.clear();for(let e of this.messages)await this.renderMessage(e);this.scrollToBottom()}async renderMessage(e){let n=this.messagesEl.createEl("div",{cls:`zrr-chat-message zrr-chat-${e.role}`});n.createEl("div",{cls:"zrr-chat-meta"}).setText(e.role==="user"?"You":"Assistant");let i=n.createEl("div",{cls:"zrr-chat-content"}),a=n.createEl("div",{cls:"zrr-chat-citations"});this.messageEls.set(e.id,{wrapper:n,content:i,citations:a}),await this.renderMessageContent(e)}scheduleRender(e){if(this.pendingRender.has(e.id))return;let n=window.setTimeout(async()=>{this.pendingRender.delete(e.id),await this.renderMessageContent(e),this.scrollToBottom()},80);this.pendingRender.set(e.id,n)}async renderMessageContent(e){var i,a,r;let n=this.messageEls.get(e.id);if(!n)return;let t=await this.plugin.formatInlineCitations(e.content||"",(i=e.citations)!=null?i:[],(a=e.retrieved)!=null?a:[]);n.content.dataset.lastRendered!==t&&(n.content.empty(),await N.MarkdownRenderer.renderMarkdown(t,n.content,"",this.plugin),this.hookInternalLinks(n.content),n.content.dataset.lastRendered=t),n.citations.empty(),await this.renderCitations(n.citations,(r=e.citations)!=null?r:[])}hookInternalLinks(e){let n=e.querySelectorAll("a.internal-link");for(let t of Array.from(n))t.dataset.zrrBound!=="1"&&(t.dataset.zrrBound="1",this.registerDomEvent(t,"click",i=>{i.preventDefault();let a=t.getAttribute("data-href")||t.getAttribute("href")||"";a&&this.plugin.openInternalLinkInMain(a)}))}async renderCitations(e,n){if(e.empty(),!n.length)return;let t=e.createEl("details",{cls:"zrr-chat-citations-details"});t.createEl("summary",{text:`Relevant context sources (${n.length})`,cls:"zrr-chat-citations-summary"});let i=t.createEl("ul",{cls:"zrr-chat-citation-list"});for(let a of n){let r=await this.plugin.resolveCitationDisplay(a),s=i.createEl("li");s.createEl("a",{text:r.noteTitle,href:"#"}).addEventListener("click",d=>{d.preventDefault(),r.notePath&&this.plugin.openNoteInMain(r.notePath)}),s.createEl("span",{text:", p. "}),s.createEl("a",{text:r.pageLabel,href:"#"}).addEventListener("click",d=>{if(d.preventDefault(),r.zoteroUrl){this.plugin.openExternalUrl(r.zoteroUrl);return}if(r.pdfPath){this.plugin.openPdfInMain(r.pdfPath,r.pageStart);return}this.plugin.openCitationTarget(a,r)})}}async copyChatToNote(){var i;let n=(await this.plugin.listChatSessions()).find(a=>a.id===this.activeSessionId),t=(i=n==null?void 0:n.name)!=null?i:"New chat";await this.plugin.createChatNoteFromSession(this.activeSessionId,t,this.messages)}scrollToBottom(){this.messagesEl.scrollTop=this.messagesEl.scrollHeight}async handleSend(){if(this.busy)return;let e=this.inputEl.value.trim();if(!e){new N.Notice("Query cannot be empty.");return}if(!this.plugin.settings.chatBaseUrl){new N.Notice("Chat base URL must be set in settings.");return}this.inputEl.value="",this.busy=!0,this.sendButton.disabled=!0;let n={id:this.generateId(),role:"user",content:e,createdAt:new Date().toISOString()};this.messages.push(n),await this.renderMessage(n),this.scrollToBottom(),await this.saveHistory();let t={id:this.generateId(),role:"assistant",content:"",citations:[],createdAt:new Date().toISOString()};this.messages.push(t),await this.renderMessage(t),this.scrollToBottom();let i=!1,a=this.plugin.getRecentChatHistory(this.messages.slice(0,-2));try{await this.plugin.runRagQueryStreaming(e,r=>{i=!0,t.content+=r,this.scheduleRender(t)},r=>{(!i&&(r!=null&&r.answer)||r!=null&&r.answer)&&(t.content=r.answer),Array.isArray(r==null?void 0:r.citations)&&(t.citations=r.citations),Array.isArray(r==null?void 0:r.retrieved)&&(t.retrieved=r.retrieved),this.scheduleRender(t)},a)}catch(r){console.error(r),t.content="Failed to fetch answer. See console for details.",this.scheduleRender(t)}finally{this.busy=!1,this.sendButton.disabled=!1,await this.saveHistory()}}generateId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}},W=class extends N.Modal{constructor(p,e,n){super(p),this.initialValue=e,this.onSubmit=n}onOpen(){let{contentEl:p}=this;p.empty(),p.createEl("h3",{text:"Rename chat"});let e=this.initialValue;new N.Setting(p).setName("Name").addText(a=>{a.setValue(e),a.onChange(r=>{e=r})});let n=p.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="1rem",n.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),n.createEl("button",{text:"Save"}).addEventListener("click",()=>{let a=e.trim();if(!a){new N.Notice("Name cannot be empty.");return}this.close(),this.onSubmit(a)})}},J=class extends N.Modal{constructor(p,e,n){super(p),this.chatName=e,this.onConfirm=n}onOpen(){let{contentEl:p}=this;p.empty(),p.createEl("h3",{text:"Delete chat"}),p.createEl("p",{text:`Delete "${this.chatName}"? This cannot be undone.`});let e=p.createEl("div");e.style.display="flex",e.style.gap="0.5rem",e.style.marginTop="1rem",e.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),e.createEl("button",{text:"Delete"}).addEventListener("click",()=>{this.close(),this.onConfirm()})}};var re=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],se={en:"eng",de:"deu",fr:"fra",es:"spa",it:"ita",nl:"nld",pt:"por",pl:"pol",sv:"swe"},_e=H["zrr-picker"],me=H["zrr-chat"],U=class extends c.Modal{constructor(p,e,n,t,i="Value cannot be empty."){super(p),this.titleText=e,this.placeholder=n,this.onSubmit=t,this.emptyMessage=i}onOpen(){let{contentEl:p}=this;p.empty(),p.createEl("h3",{text:this.titleText});let e=p.createEl("input",{type:"text",placeholder:this.placeholder});e.style.width="100%",e.focus();let n=p.createEl("button",{text:"Submit"});n.style.marginTop="0.75rem";let t=()=>{let i=e.value.trim();if(!i){new c.Notice(this.emptyMessage);return}this.close(),this.onSubmit(i)};n.addEventListener("click",t),e.addEventListener("keydown",i=>{i.key==="Enter"&&t()})}},Q=class extends c.Modal{constructor(p,e,n){super(p),this.titleText=e,this.bodyText=n}onOpen(){let{contentEl:p}=this;p.empty(),p.createEl("h3",{text:this.titleText}),p.createEl("pre").setText(this.bodyText)}},Y=class extends c.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.filePath=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Overwrite"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},X=class extends c.SuggestModal{constructor(e,n){super(e);this.resolved=!1;this.resolveSelection=n,this.setPlaceholder("Select a language for OCR/quality...")}getSuggestions(e){let n=e.trim().toLowerCase();return n?re.filter(t=>t.label.toLowerCase().includes(n)||t.value.toLowerCase().includes(n)):re}renderSuggestion(e,n){n.setText(e.label),n.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new U(this.app,"Custom language hint","e.g., en, de, fr, de,en",n=>this.resolveSelection(n.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},G=class extends c.Plugin{constructor(){super(...arguments);this.docIndex=null}async onload(){await this.loadSettings(),await this.migrateCachePaths(),this.addSettingTab(new Z(this.app,this)),this.registerRibbonIcons(),this.registerView(F,e=>new M(e,this)),this.setupStatusBar(),this.registerNoteRenameHandler();try{await this.ensureBundledTools()}catch(e){console.error("Failed to sync bundled tools",e)}this.addCommand({id:"import-zotero-item-index",name:"Import Zotero item and index (Docling -> RedisSearch)",callback:()=>this.importZoteroItem()}),this.addCommand({id:"ask-zotero-library",name:"Ask my Zotero library (RAG via RedisSearch)",callback:()=>this.askZoteroLibrary()}),this.addCommand({id:"open-zotero-chat",name:"Open Zotero RAG chat panel",callback:()=>this.openChatView(!0)}),this.addCommand({id:"rebuild-zotero-note-cache",name:"Rebuild Zotero note from cache (Docling + RedisSearch)",callback:()=>this.rebuildNoteFromCache()}),this.addCommand({id:"rebuild-doc-index-cache",name:"Rebuild doc index from cache",callback:()=>this.rebuildDocIndexFromCache()}),this.addCommand({id:"recreate-missing-notes-cache",name:"Recreate missing notes from cache (Docling + RedisSearch)",callback:()=>this.recreateMissingNotesFromCache()}),this.addCommand({id:"reindex-redis-from-cache",name:"Reindex Redis from cached chunks",callback:()=>this.reindexRedisFromCache()}),this.addCommand({id:"start-redis-stack",name:"Start Redis Stack (Docker Compose)",callback:()=>this.startRedisStack()}),this.settings.autoStartRedis&&this.startRedisStack(!0)}async loadSettings(){this.settings=Object.assign({},ie,await this.loadData())}async saveSettings(){await this.saveData(this.settings)}async importZoteroItem(){var T,C,A;try{await this.ensureBundledTools()}catch(y){new c.Notice("Failed to sync bundled tools. See console for details."),console.error(y);return}let e;try{e=await this.promptZoteroItem()}catch(y){new c.Notice("Zotero search failed. See console for details."),console.error(y);return}if(!e){new c.Notice("No Zotero item selected.");return}let n=(T=e.data)!=null?T:e;!n.key&&e.key&&(n.key=e.key);let t=this.getDocId(n);if(!t){new c.Notice("Could not resolve a stable doc_id from Zotero item.");return}let i=await this.resolveLanguageHint(n,(C=e.key)!=null?C:n.key),a=this.buildDoclingLanguageHint(i!=null?i:void 0),r=await this.resolvePdfAttachment(n,t);if(!r){new c.Notice("No PDF attachment found for item.");return}this.showStatusProgress("Preparing...",5);let s=typeof n.title=="string"?n.title:"",o=await this.getDocIndexEntry(t);o&&new c.Notice("Item already indexed. Updating cached files and index.");let l=this.sanitizeFileName(s)||t;if(o!=null&&o.note_path)l=f.default.basename(o.note_path,".md")||l;else if(o!=null&&o.pdf_path){let y=this.toVaultRelativePath(o.pdf_path);y&&y.startsWith((0,c.normalizePath)(this.settings.outputPdfDir))&&(l=f.default.basename(y,".pdf")||l)}let d=o?l:await this.resolveUniqueBaseName(l,t),u=(0,c.normalizePath)(`${this.settings.outputPdfDir}/${d}.pdf`),h=(0,c.normalizePath)(`${q}/${t}.json`),g=(0,c.normalizePath)(`${O}/${t}.json`),m=this.app.vault.adapter,_=(0,c.normalizePath)(`${this.settings.outputNoteDir}/${d}.md`);if(o!=null&&o.note_path&&await m.exists(o.note_path)&&(_=(0,c.normalizePath)(o.note_path)),await m.exists(_)&&!await this.confirmOverwrite(_)){new c.Notice("Import canceled.");return}try{if(await this.ensureFolder(q),await this.ensureFolder(O),await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let y=this.getLogFileRelativePath(),b=(0,c.normalizePath)(f.default.dirname(y));b&&await this.ensureFolder(b);let E=this.getSpellcheckerInfoRelativePath(),I=(0,c.normalizePath)(f.default.dirname(E));I&&await this.ensureFolder(I)}}catch(y){new c.Notice("Failed to create output folders."),console.error(y),this.clearStatusProgress();return}let v="",P="";try{if(this.settings.copyPdfToVault){let y=r.filePath?await z.promises.readFile(r.filePath):await this.downloadZoteroPdf(r.key);await this.app.vault.adapter.writeBinary(u,this.bufferToArrayBuffer(y)),v=this.getAbsoluteVaultPath(u)}else if(r.filePath)v=r.filePath;else{await this.ensureFolder(this.settings.outputPdfDir);let y=await this.downloadZoteroPdf(r.key);await this.app.vault.adapter.writeBinary(u,this.bufferToArrayBuffer(y)),v=this.getAbsoluteVaultPath(u),new c.Notice("Local PDF path unavailable; copied PDF into vault for processing.")}P=this.buildPdfLinkForNote(v,r.key,t)}catch(y){new c.Notice("Failed to download PDF attachment."),console.error(y),this.clearStatusProgress();return}try{await this.app.vault.adapter.write(h,JSON.stringify(e,null,2))}catch(y){new c.Notice("Failed to write Zotero item JSON."),console.error(y),this.clearStatusProgress();return}let k=this.getPluginDir(),x=f.default.join(k,"tools","docling_extract.py"),S=f.default.join(k,"tools","index_redisearch.py"),D=null;try{D=await this.readDoclingQualityLabelFromPdf(v,a),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",D),0),await this.runPythonStreaming(x,this.buildDoclingArgs(v,t,g,_,a,!0),E=>this.handleDoclingProgress(E,D),()=>{}),D=await this.readDoclingQualityLabel(g),await this.annotateChunkJsonWithAttachmentKey(g,r.key);let y=await this.readDoclingMetadata(g),b=await this.maybeCreateOcrLayeredPdf(v,y,a);b&&(v=b,P=this.buildPdfLinkFromSourcePath(b),await this.updateChunkJsonSourcePdf(g,b))}catch(y){new c.Notice("Docling extraction failed. See console for details."),console.error(y),this.clearStatusProgress();return}try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",D),0),await this.runPythonStreaming(S,["--chunks-json",this.getAbsoluteVaultPath(g),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--progress"],y=>{if((y==null?void 0:y.type)==="progress"&&y.total){let b=Math.round(y.current/y.total*100),E=this.formatStatusLabel(`Indexing chunks ${y.current}/${y.total}`,D);this.showStatusProgress(E,b)}},()=>{})}catch(y){new c.Notice("RedisSearch indexing failed. See console for details."),console.error(y),this.clearStatusProgress();return}try{let y=await this.app.vault.adapter.read(_),b=this.buildNoteMarkdown(n,(A=e.meta)!=null?A:{},t,P,h,y);await this.app.vault.adapter.write(_,b)}catch(y){new c.Notice("Failed to finalize note markdown."),console.error(y),this.clearStatusProgress();return}try{await this.updateDocIndex({doc_id:t,note_path:_,note_title:d,zotero_title:s,pdf_path:v,attachment_key:r.key})}catch(y){console.error("Failed to update doc index",y)}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new c.Notice(`Indexed Zotero item ${t}.`)}async askZoteroLibrary(){await this.openChatView(!0)}getChatLeaf(){var n;let e=this.app.workspace.getLeavesOfType(F);return e.length>0?e[0]:this.settings.chatPaneLocation==="right"?(n=this.app.workspace.getRightLeaf(!1))!=null?n:this.app.workspace.getLeaf("split"):this.app.workspace.getLeaf("tab")}async openChatView(e=!1){let n=this.getChatLeaf();await n.setViewState({type:F,active:!0}),this.app.workspace.revealLeaf(n);let t=n.view;return t instanceof M&&e&&t.focusInput(),t}async loadChatHistory(){let e=await this.getActiveChatSessionId();return this.loadChatHistoryForSession(e)}async saveChatHistory(e){let n=await this.getActiveChatSessionId();await this.saveChatHistoryForSession(n,e)}getChatSessionsDir(){return(0,c.normalizePath)(`${R}/chats`)}getChatExportDir(){let e=(this.settings.chatOutputDir||"").trim();return e?(0,c.normalizePath)(e):(0,c.normalizePath)("zotero/chats")}getChatSessionsIndexPath(){return(0,c.normalizePath)(`${this.getChatSessionsDir()}/index.json`)}getChatSessionPath(e){return(0,c.normalizePath)(`${this.getChatSessionsDir()}/${e}.json`)}async listChatSessions(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath();if(!await e.exists(n)){let t=new Date().toISOString(),i=[{id:"default",name:"New chat",createdAt:t,updatedAt:t}];return await this.writeChatSessionsIndex({version:1,active:"default",sessions:i}),i}try{let t=await e.read(n),i=JSON.parse(t);return(Array.isArray(i==null?void 0:i.sessions)?i.sessions:[]).filter(r=>r&&typeof r.id=="string").map(r=>({id:String(r.id),name:typeof r.name=="string"&&r.name.trim()?r.name.trim():String(r.id),createdAt:typeof r.createdAt=="string"?r.createdAt:new Date().toISOString(),updatedAt:typeof r.updatedAt=="string"?r.updatedAt:new Date().toISOString()}))}catch(t){return console.warn("Failed to read chat sessions index",t),[]}}async getActiveChatSessionId(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath();if(!await e.exists(n))return"default";try{let t=await e.read(n),i=JSON.parse(t);return(typeof(i==null?void 0:i.active)=="string"?i.active:"default")||"default"}catch(t){return"default"}}async setActiveChatSessionId(e){var r,s;await this.migrateLegacyChatHistory();let n=await this.readChatSessionsIndex(),t=((r=n.sessions)!=null?r:[]).some(o=>o.id===e),i=new Date().toISOString(),a=t?n.sessions:[...(s=n.sessions)!=null?s:[],{id:e,name:e,createdAt:i,updatedAt:i}];await this.writeChatSessionsIndex({version:1,active:e,sessions:a})}async createChatSession(e){var s;await this.migrateLegacyChatHistory();let n=this.generateChatId(),t=new Date().toISOString(),i=(e||"").trim()||"New chat",r=[...(s=(await this.readChatSessionsIndex()).sessions)!=null?s:[],{id:n,name:i,createdAt:t,updatedAt:t}];return await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionPath(n),JSON.stringify({version:1,messages:[]},null,2)),await this.writeChatSessionsIndex({version:1,active:n,sessions:r}),n}async renameChatSession(e,n){var r,s;await this.migrateLegacyChatHistory();let t=(n||"").trim();if(!t)return;let i=await this.readChatSessionsIndex(),a=((r=i.sessions)!=null?r:[]).map(o=>o.id===e?{...o,name:t}:o);await this.writeChatSessionsIndex({version:1,active:(s=i.active)!=null?s:"default",sessions:a})}async deleteChatSession(e){var s;if(await this.migrateLegacyChatHistory(),!e)return;let n=this.app.vault.adapter,t=await this.readChatSessionsIndex(),i=(s=t.sessions)!=null?s:[];if(i.length<=1)return;let a=i.filter(o=>o.id!==e);if(!a.length)return;let r=t.active===e?a[0].id:t.active;try{await n.remove(this.getChatSessionPath(e))}catch(o){console.warn("Failed to delete chat session file",o)}await this.writeChatSessionsIndex({version:1,active:r,sessions:a})}async loadChatHistoryForSession(e){await this.migrateLegacyChatHistory();let n=this.app.vault.adapter,t=this.getChatSessionPath(e||"default");if(!await n.exists(t))return[];let i=await n.read(t),a;try{a=JSON.parse(i)}catch(s){return[]}let r=Array.isArray(a)?a:a==null?void 0:a.messages;return Array.isArray(r)?r.filter(s=>s&&typeof s.content=="string").map(s=>({id:s.id||this.generateChatId(),role:s.role==="assistant"?"assistant":"user",content:s.content,citations:Array.isArray(s.citations)?s.citations:[],retrieved:Array.isArray(s.retrieved)?s.retrieved:[],createdAt:s.createdAt||new Date().toISOString()})):[]}async saveChatHistoryForSession(e,n){var l,d;await this.migrateLegacyChatHistory(),await this.ensureFolder(this.getChatSessionsDir());let t=this.app.vault.adapter,i=this.getChatSessionPath(e||"default"),a={version:1,messages:n};await t.write(i,JSON.stringify(a,null,2));let r=await this.readChatSessionsIndex(),s=new Date().toISOString(),o=((l=r.sessions)!=null?l:[]).map(u=>u.id===e?{...u,updatedAt:s}:u);await this.writeChatSessionsIndex({version:1,active:(d=r.active)!=null?d:e,sessions:o})}getRecentChatHistory(e){let n=Math.max(0,this.settings.chatHistoryMessages||0);return n?e.filter(i=>{var a;return i&&((a=i.content)==null?void 0:a.trim())}).slice(-n):[]}async readChatSessionsIndex(){let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath(),t=new Date().toISOString();if(!await e.exists(n))return{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:t,updatedAt:t}]};try{let i=await e.read(n),a=JSON.parse(i),r=Array.isArray(a==null?void 0:a.sessions)?a.sessions:[];return{version:1,active:typeof(a==null?void 0:a.active)=="string"?a.active:"default",sessions:r.map(s=>({id:String(s.id),name:typeof s.name=="string"&&s.name.trim()?s.name.trim():String(s.id),createdAt:typeof s.createdAt=="string"?s.createdAt:t,updatedAt:typeof s.updatedAt=="string"?s.updatedAt:t}))}}catch(i){return console.warn("Failed to parse chat sessions index",i),{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:t,updatedAt:t}]}}}async writeChatSessionsIndex(e){await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionsIndexPath(),JSON.stringify(e,null,2))}async migrateLegacyChatHistory(){let e=this.app.vault.adapter,n=(0,c.normalizePath)(`${R}/chat.json`),t=this.getChatSessionsDir(),i=this.getChatSessionsIndexPath(),a=this.getChatSessionPath("default"),r=await e.exists(n),s=await e.exists(a),o=await e.exists(i);if(!r&&o)return;let l=new Date().toISOString();if(await this.ensureFolder(t),r&&!s)try{await e.rename(n,a)}catch(d){try{let u=await e.read(n);await e.write(a,u),await e.remove(n)}catch(u){console.warn("Failed to migrate legacy chat history",u)}}if(!o){let d=[{id:"default",name:"New chat",createdAt:l,updatedAt:l}];await this.writeChatSessionsIndex({version:1,active:"default",sessions:d})}if(o)try{let d=await e.read(i),u=JSON.parse(d),h=Array.isArray(u==null?void 0:u.sessions)?u.sessions:[],g=h.some(_=>(_==null?void 0:_.id)==="default"),m=h.map(_=>(_==null?void 0:_.id)==="default"&&typeof(_==null?void 0:_.name)=="string"&&_.name.trim().toLowerCase()==="default"?{..._,name:"New chat"}:_);g&&JSON.stringify(m)!==JSON.stringify(h)&&await this.writeChatSessionsIndex({version:1,active:typeof(u==null?void 0:u.active)=="string"?u.active:"default",sessions:m.map(_=>({id:String(_.id),name:typeof _.name=="string"?_.name:"New chat",createdAt:typeof _.createdAt=="string"?_.createdAt:l,updatedAt:typeof _.updatedAt=="string"?_.updatedAt:l}))})}catch(d){}}isPlaceholderChatName(e){let n=(e||"").trim().toLowerCase();return n==="new chat"||n==="default"}normalizeChatTitle(e){let n=(e||"").replace(/\s+/g," ").trim();return n.length>60?`${n.slice(0,57)}...`:n}guessTitleFromMessages(e){let n=e.find(i=>i.role==="user"&&i.content.trim());if(!n)return"New chat";let t=n.content.replace(/\s+/g," ").trim().split(" ").slice(0,8).join(" ");return this.normalizeChatTitle(t||"New chat")}async suggestChatTitleWithLlm(e){var i,a,r;let n=(this.settings.chatBaseUrl||"").trim(),t=(this.settings.chatModel||"").trim();if(!n||!t)return null;try{let s=`${n.replace(/\/$/,"")}/chat/completions`,o={"Content-Type":"application/json"};this.settings.chatApiKey&&(o.Authorization=`Bearer ${this.settings.chatApiKey}`);let l=e.slice(-8).map(m=>`${m.role.toUpperCase()}: ${m.content}`).join(`
`).slice(0,4e3),u=await fetch(s,{method:"POST",headers:o,body:JSON.stringify({model:t,temperature:.2,messages:[{role:"system",content:"Generate a short, specific title (3-7 words) for the chat. No quotes, no punctuation at the end."},{role:"user",content:l}]})});if(!u.ok)return null;let h=await u.json(),g=(r=(a=(i=h==null?void 0:h.choices)==null?void 0:i[0])==null?void 0:a.message)==null?void 0:r.content;return typeof g!="string"?null:this.normalizeChatTitle(g.replace(/^\"|\"$/g,"").trim())}catch(s){return console.warn("Chat title suggestion failed",s),null}}async finalizeChatSessionNameIfNeeded(e,n,t={}){var d;if(!e)return;let i=n||[];if(!i.some(u=>u.role==="user"&&u.content.trim())||!t.force&&i.length<4)return;let s=((d=(await this.readChatSessionsIndex()).sessions)!=null?d:[]).find(u=>u.id===e);if(!s||!this.isPlaceholderChatName(s.name))return;let l=await this.suggestChatTitleWithLlm(i)||this.guessTitleFromMessages(i);!l||this.isPlaceholderChatName(l)||await this.renameChatSession(e,l)}async runRagQueryStreaming(e,n,t,i=[]){await this.ensureBundledTools();let a=this.getPluginDir(),r=f.default.join(a,"tools","rag_query_redisearch.py"),s=["--query",e,"--k","5","--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--chat-base-url",this.settings.chatBaseUrl,"--chat-api-key",this.settings.chatApiKey,"--chat-model",this.settings.chatModel,"--temperature",String(this.settings.chatTemperature),"--stream"],o=this.buildChatHistoryPayload(i),l=await this.writeChatHistoryTemp(o);l!=null&&l.absolutePath&&s.push("--history-file",l.absolutePath);try{await this.runPythonStreaming(r,s,d=>{if((d==null?void 0:d.type)==="delta"&&typeof d.content=="string"){n(d.content);return}if((d==null?void 0:d.type)==="final"){t(d);return}d!=null&&d.answer&&t(d)},t)}finally{if(l!=null&&l.relativePath)try{await this.app.vault.adapter.remove(l.relativePath)}catch(d){console.warn("Failed to remove chat history temp file",d)}}}buildChatHistoryPayload(e){return this.getRecentChatHistory(e).map(t=>({role:t.role,content:t.content}))}async writeChatHistoryTemp(e){if(!e.length)return null;let n=(0,c.normalizePath)(`${R}/tmp`);await this.ensureFolder(n);let t=`chat_history_${Date.now()}_${Math.random().toString(36).slice(2,8)}.json`,i=(0,c.normalizePath)(`${n}/${t}`),a={version:1,messages:e};return await this.app.vault.adapter.write(i,JSON.stringify(a,null,2)),{relativePath:i,absolutePath:this.getAbsoluteVaultPath(i)}}async resolveCitationDisplay(e){var h,g;let n=await this.getDocIndexEntry(e.doc_id);(!n||!n.note_title||!n.zotero_title||!n.note_path||!n.pdf_path)&&(n=await this.hydrateDocIndexFromCache(e.doc_id));let t=e.doc_id?await this.resolveNotePathForDocId(e.doc_id):n==null?void 0:n.note_path,i=(n==null?void 0:n.zotero_title)||(n==null?void 0:n.note_title)||(t?f.default.basename(t,".md"):e.doc_id||"?"),a=e.pages||`${(h=e.page_start)!=null?h:"?"}-${(g=e.page_end)!=null?g:"?"}`,r=a.includes("-")?a.replace("-"," - "):a,s=e.page_start?String(e.page_start):"",o=(n==null?void 0:n.pdf_path)||e.source_pdf||"",l=e.attachment_key||(n==null?void 0:n.attachment_key),d=e.annotation_key||this.extractAnnotationKey(e.chunk_id),u=e.doc_id?this.buildZoteroDeepLink(e.doc_id,l,s,d):void 0;return this.settings.preferVaultPdfForCitations&&o&&this.toVaultRelativePath(o)&&(u=void 0),{noteTitle:i,pageLabel:r,notePath:t||void 0,pdfPath:o||void 0,zoteroUrl:u,pageStart:s||void 0}}async formatInlineCitations(e,n,t=[]){if(!e)return e;let i=/\[\[?cite:([A-Za-z0-9]+):([^\]\n]+?)\]?\]/g,a=Array.from(e.matchAll(i));if(a.length===0)return e;let r=new Map;for(let o of a){let l=o[0];if(r.has(l))continue;let d=o[1],u=o[2].trim(),h=u.match(/^(\d+)-(\d+)(?::([A-Za-z0-9]+))?$/),g="",m="",_,v;h?(g=h[1],m=h[2],_=h[3]):v=u;let P=v?t.find(C=>{let A=typeof C.doc_id=="string"?C.doc_id:"";if(A&&A!==d)return!1;let y=typeof C.chunk_id=="string"?C.chunk_id:"";return y?y===v||y===`${d}:${v}`||y.endsWith(`:${v}`):!1}):void 0;P&&(!g&&P.page_start!==void 0&&(g=String(P.page_start)),!m&&P.page_end!==void 0&&(m=String(P.page_end)),!_&&typeof P.chunk_id=="string"&&(_=this.extractAnnotationKey(P.chunk_id)));let k={doc_id:d,chunk_id:P==null?void 0:P.chunk_id,annotation_key:_};(g||m)&&(k.page_start=g||m,k.page_end=m||g,k.pages=`${k.page_start}-${k.page_end}`),P!=null&&P.source_pdf&&(k.source_pdf=String(P.source_pdf));let x=(g||m?n.find(C=>{var A,y;return C.doc_id===d&&String((A=C.page_start)!=null?A:"")===g&&String((y=C.page_end)!=null?y:"")===m}):void 0)||n.find(C=>C.doc_id===d)||k;!x.annotation_key&&_&&(x={...x,annotation_key:_});let S=await this.resolveCitationDisplay(x),D=`${S.noteTitle} p. ${S.pageLabel}`,T=this.settings.preferVaultPdfForCitations?this.buildVaultPdfCitationLink(S.pdfPath||"",S.pageStart,D):"";if(T)r.set(l,T);else if(S.zoteroUrl)r.set(l,`[${D}](${S.zoteroUrl})`);else{let C=S.pageLabel?`${d} p. ${S.pageLabel}`:`${d}`;r.set(l,`(${C})`)}}let s=e;for(let[o,l]of r)s=s.split(o).join(l);return s}handleDoclingProgress(e,n){if(!e||e.type!=="progress")return;let t=Number(e.percent);if(!Number.isFinite(t))return;let i=typeof e.message=="string"&&e.message.trim()?e.message:"Docling extraction...";this.showStatusProgress(this.formatStatusLabel(i,n),Math.round(t))}async createChatNoteFromSession(e,n,t){let i=this.getChatExportDir();await this.ensureFolder(i),await this.getDocIndex();let a=this.sanitizeFileName(n)||"Zotero Chat",r=this.formatTimestamp(new Date),s=(0,c.normalizePath)(`${i}/${a}.md`),o=await this.resolveUniqueNotePath(s,`${a}-${r}.md`),l=await this.buildChatTranscript(n,t);await this.app.vault.adapter.write(o,l),await this.openNoteInNewTab(o),new c.Notice(`Chat copied to ${o}`)}async buildChatTranscript(e,n){var i,a,r;let t=[];t.push(`# ${e||"Zotero Chat"}`),t.push(""),t.push(`Created: ${new Date().toISOString()}`),t.push("");for(let s of n){let o=s.role==="user"?"## You":"## Assistant";t.push(o),t.push("");let l=s.role==="assistant"?await this.formatInlineCitations(s.content||"",(i=s.citations)!=null?i:[],(a=s.retrieved)!=null?a:[]):s.content||"";if(t.push(l.trim()),t.push(""),s.role==="assistant"&&((r=s.citations)!=null&&r.length)){t.push("### Relevant context sources");let d=this.formatCitationsMarkdown(s.citations);d&&(t.push(d),t.push(""))}}return t.join(`
`).trim()+`
`}async resolveUniqueNotePath(e,n){let t=this.app.vault.adapter;if(!await t.exists(e))return e;let i=f.default.dirname(e),a=(0,c.normalizePath)(f.default.join(i,n));if(!await t.exists(a))return a;let r=2;for(;r<1e3;){let s=(0,c.normalizePath)(f.default.join(i,`${f.default.basename(n,".md")}-${r}.md`));if(!await t.exists(s))return s;r+=1}return a}formatTimestamp(e){let n=t=>String(t).padStart(2,"0");return[e.getFullYear(),n(e.getMonth()+1),n(e.getDate()),"-",n(e.getHours()),n(e.getMinutes())].join("")}async openCitationTarget(e,n){let t=n!=null?n:await this.resolveCitationDisplay(e);if(t.notePath){await this.openNoteInMain(t.notePath);return}if(!(t.pdfPath&&await this.openPdfInMain(t.pdfPath,t.pageStart))){if(t.zoteroUrl){this.openExternalUrl(t.zoteroUrl);return}new c.Notice("Unable to open citation target.")}}async rebuildNoteFromCache(){let e=await this.promptDocId();if(!e){new c.Notice("No doc_id provided.");return}await this.rebuildNoteFromCacheForDocId(e,!0)&&new c.Notice(`Rebuilt Zotero note for ${e}.`)}async rebuildDocIndexFromCache(){var l,d,u;let e=this.app.vault.adapter,n=await this.listDocIds(q),t=await this.listDocIds(O),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),a=Object.keys(i),r=Array.from(new Set([...n,...t,...a]));if(r.length===0){new c.Notice("No cached items found.");return}this.showStatusProgress("Rebuilding doc index...",0);let s=await this.getDocIndex(),o=0;for(let h of r){o+=1;let g={},m=i[h];m&&(g.note_path=m.note_path,g.note_title=m.note_title);let _=(0,c.normalizePath)(`${q}/${h}.json`);if(await e.exists(_))try{let k=await e.read(_),x=JSON.parse(k),S=(d=(l=x==null?void 0:x.data)!=null?l:x)!=null?d:{},D=typeof S.title=="string"?S.title:"";D&&(g.zotero_title=D);let T=this.sanitizeFileName(D)||h,C=(0,c.normalizePath)(`${this.settings.outputNoteDir}/${T}.md`),A=(0,c.normalizePath)(`${this.settings.outputNoteDir}/${T}-${h}.md`);await e.exists(C)?(g.note_path=C,g.note_title=f.default.basename(C,".md")):await e.exists(A)&&(g.note_path=A,g.note_title=f.default.basename(A,".md"))}catch(k){console.error("Failed to read cached item JSON",k)}let v=(0,c.normalizePath)(`${O}/${h}.json`);if(await e.exists(v))try{let k=await e.read(v),x=JSON.parse(k);typeof(x==null?void 0:x.source_pdf)=="string"&&(g.pdf_path=x.source_pdf)}catch(k){console.error("Failed to read cached chunks JSON",k)}if(Object.keys(g).length>0){let x={...(u=s[h])!=null?u:{doc_id:h},...g,doc_id:h,updated_at:new Date().toISOString()};!x.note_title&&x.note_path&&(x.note_title=f.default.basename(x.note_path,".md")),s[h]=x}let P=Math.round(o/r.length*100);this.showStatusProgress(`Rebuilding doc index ${o}/${r.length}`,P)}await this.saveDocIndex(s),this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new c.Notice(`Rebuilt doc index for ${r.length} items.`)}async recreateMissingNotesFromCache(){let e=this.app.vault.adapter,n=await this.listDocIds(q),t=await this.listDocIds(O),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),a=Object.keys(i),r=Array.from(new Set([...n,...t,...a]));if(r.length===0){new c.Notice("No cached items found.");return}let s=[];for(let l of r){if(i[l])continue;let d=await this.getDocIndexEntry(l);if(d!=null&&d.note_path&&await e.exists(d.note_path))continue;let u=await this.inferNotePathFromCache(l);u&&await e.exists(u)||s.push(l)}if(s.length===0){new c.Notice("No missing notes detected.");return}this.showStatusProgress("Recreating missing notes...",0);let o=0;for(let l=0;l<s.length;l+=1){let d=s[l],u=Math.round((l+1)/s.length*100);this.showStatusProgress(`Recreating ${l+1}/${s.length}`,u),await this.rebuildNoteFromCacheForDocId(d,!1)&&(o+=1)}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new c.Notice(`Recreated ${o}/${s.length} missing notes.`)}async reindexRedisFromCache(){try{await this.ensureBundledTools()}catch(r){new c.Notice("Failed to sync bundled tools. See console for details."),console.error(r);return}let e=await this.listDocIds(O);if(e.length===0){new c.Notice("No cached chunks found.");return}let n=this.getPluginDir(),t=f.default.join(n,"tools","index_redisearch.py"),i=0,a=0;this.showStatusProgress("Reindexing cached chunks...",0);for(let r of e){i+=1;let s=Math.round(i/e.length*100);this.showStatusProgress(`Reindexing ${i}/${e.length}`,s);let o=(0,c.normalizePath)(`${O}/${r}.json`);try{await this.runPython(t,["--chunks-json",this.getAbsoluteVaultPath(o),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert"])}catch(l){a+=1,console.error(`Failed to reindex ${r}`,l)}}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),a===0?new c.Notice(`Reindexed ${e.length} cached items.`):new c.Notice(`Reindexed ${e.length-a}/${e.length} items (see console).`)}async promptZoteroItem(){return new Promise(e=>{new ee(this.app,this,e).open()})}async listDocIds(e){let n=this.app.vault.adapter,t=(0,c.normalizePath)(e);return await n.exists(t)?(await n.list(t)).files.filter(a=>a.endsWith(".json")).map(a=>f.default.basename(a,".json")):[]}async listMarkdownFiles(e){let n=this.app.vault.adapter,t=(0,c.normalizePath)(e);if(!await n.exists(t))return[];let i=[t],a=[];for(;i.length>0;){let r=i.pop();if(!r)continue;let s=await n.list(r);for(let o of s.files)o.endsWith(".md")&&a.push(o);for(let o of s.folders)i.push(o)}return a}extractDocIdFromFrontmatter(e){let n=e.match(/^---\s*\n([\s\S]*?)\n---/);if(!n)return null;let i=n[1].split(/\r?\n/);for(let a of i){let r=a.trim();if(!r||r.startsWith("#"))continue;let s=r.split(":");if(s.length<2)continue;let o=s[0].trim().toLowerCase();if(o!=="doc_id"&&o!=="zotero_key")continue;let d=r.slice(r.indexOf(":")+1).trim().replace(/^["']|["']$/g,"").trim();if(d)return d}return null}async scanNotesForDocIds(e){let n=this.app.vault.adapter,t=await this.listMarkdownFiles(e),i={};for(let a of t)try{let r=await n.read(a),s=this.extractDocIdFromFrontmatter(r);if(!s)continue;i[s]={doc_id:s,note_path:a,note_title:f.default.basename(a,".md"),updated_at:new Date().toISOString()}}catch(r){console.error("Failed to read note for doc_id scan",r)}return i}setupStatusBar(){let e=this.addStatusBarItem();e.addClass("zrr-status-progress"),e.addClass("status-bar-item-segment"),e.style.display="none";let n=e.createEl("span",{text:"Idle"});n.addClass("zrr-status-label");let i=e.createEl("div",{cls:"zrr-status-bar"}).createEl("div",{cls:"zrr-status-bar-inner"});this.statusBarEl=e,this.statusLabelEl=n,this.statusBarInnerEl=i}showStatusProgress(e,n){if(!(!this.statusBarEl||!this.statusLabelEl||!this.statusBarInnerEl))if(this.statusBarEl.style.display="flex",this.statusLabelEl.setText(e),n===null)this.statusBarInnerEl.addClass("indeterminate"),this.statusBarInnerEl.style.width="40%";else{this.statusBarInnerEl.removeClass("indeterminate");let t=Math.max(0,Math.min(100,n));this.statusBarInnerEl.style.width=`${t}%`}}clearStatusProgress(){!this.statusBarEl||!this.statusBarInnerEl||(this.statusBarEl.style.display="none",this.statusBarInnerEl.removeClass("indeterminate"),this.statusBarInnerEl.style.width="0%")}formatStatusLabel(e,n){return n?`${e} (Text layer quality ${n})`:e}async readDoclingQualityLabel(e){var n;try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t),a=(n=i==null?void 0:i.metadata)==null?void 0:n.confidence_proxy;if(typeof a=="number")return a.toFixed(2)}catch(t){console.warn("Failed to read Docling quality metadata",t)}return null}async readDoclingMetadata(e){try{let n=await this.app.vault.adapter.read(e),t=JSON.parse(n),i=t==null?void 0:t.metadata;if(i&&typeof i=="object")return i}catch(n){console.warn("Failed to read Docling metadata",n)}return null}async readDoclingQualityLabelFromPdf(e,n){try{let t=this.getPluginDir(),i=f.default.join(t,"tools","docling_extract.py"),a=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,r=["--quality-only","--pdf",e,"--ocr",a];this.settings.ocrMode==="force_low_quality"&&r.push("--force-ocr-low-quality"),r.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),n&&r.push("--language-hint",n);let s=await this.runPythonWithOutput(i,r),o=JSON.parse(s),l=o==null?void 0:o.confidence_proxy;if(typeof l=="number")return l.toFixed(2)}catch(t){console.warn("Failed to read Docling quality from PDF",t)}return null}async promptDocId(){return new Promise(e=>{new U(this.app,"Rebuild Zotero note from cache","Enter Zotero doc_id (e.g., ABC123)",n=>e(n),"Doc ID cannot be empty.").open()})}async promptLanguageHint(){return new Promise(e=>{new X(this.app,e).open()})}registerRibbonIcons(){(0,c.addIcon)("zrr-picker",_e),(0,c.addIcon)("zrr-chat",me),this.addRibbonIcon("zrr-picker","Import Zotero item and index",()=>this.importZoteroItem()).addClass("zrr-ribbon-picker"),this.addRibbonIcon("zrr-chat","Open Zotero RAG chat",()=>this.openChatView(!0)).addClass("zrr-ribbon-chat")}async confirmOverwrite(e){return new Promise(n=>{new Y(this.app,e,n).open()})}async resolveLanguageHint(e,n){let t=typeof e.language=="string"?e.language:"",i=this.normalizeZoteroLanguage(t);if(i)return i;let a=await this.promptLanguageHint();if(a===null)return console.info("Language selection canceled."),null;let r=this.normalizeZoteroLanguage(a);if(!r)return console.info("Language selection empty; skipping Zotero update."),"";if(e.language=r,console.info("Language selected",{language:r,itemKey:n}),n)try{await this.updateZoteroItemLanguage(n,e,r),new c.Notice("Saved language to Zotero.")}catch(s){new c.Notice("Failed to write language back to Zotero."),console.error(s)}else console.warn("Language selected but itemKey is missing; skipping Zotero update.");return r}normalizeZoteroLanguage(e){return(e||"").trim().toLowerCase()}buildDoclingLanguageHint(e){let n=this.normalizeZoteroLanguage(e!=null?e:"");if(!n)return null;let t=n.split(/[^a-z]+/).filter(Boolean),i=t.some(r=>["de","deu","ger","german"].includes(r)),a=t.some(r=>["en","eng","english"].includes(r));return i&&a?"deu+eng":i?"deu":a?"eng":t.length===1&&se[t[0]]?se[t[0]]:n}async fetchZoteroItem(e){try{let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),t=await this.requestLocalApi(n,`Zotero item fetch failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(n){return console.warn("Failed to fetch Zotero item from local API",n),this.canUseWebApi()?this.fetchZoteroItemWeb(e):null}}async fetchZoteroItemWeb(e){try{let n=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}`),t=await this.requestWebApi(n,`Zotero Web API fetch failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(n){return console.warn("Failed to fetch Zotero item from Web API",n),null}}async searchZoteroItemsWeb(e){let n=new URLSearchParams;n.set("itemType","-attachment"),n.set("limit","25"),n.set("include","data,meta"),e.trim()&&n.set("q",e.trim());let t=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items?${n.toString()}`),i=await this.requestWebApi(t,`Zotero Web API search failed for ${t}`),a=JSON.parse(i.toString("utf8"));return Array.isArray(a)?a.map(r=>{var s,o,l,d;return{key:(o=r.key)!=null?o:(s=r.data)==null?void 0:s.key,data:(l=r.data)!=null?l:{},meta:(d=r.meta)!=null?d:{}}}).filter(r=>typeof r.key=="string"&&r.key.trim().length>0):[]}async updateZoteroItemLanguage(e,n,t){try{await this.updateZoteroItemLanguageLocal(e,n,t);return}catch(i){if(!this.canUseWebApi())throw i;let a=i instanceof Error?i.message:String(i);console.info("Local Zotero write failed; trying Web API",{itemKey:e,reason:a}),await this.updateZoteroItemLanguageWeb(e,n,t)}}async updateZoteroItemLanguageLocal(e,n,t){var P,k,x,S,D,T;let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),a={...n,language:t},r={"Content-Type":"application/json","Zotero-API-Version":"3"},s=typeof a.version=="number"?a.version:Number(a.version);Number.isNaN(s)||(r["If-Unmodified-Since-Version"]=String(s)),console.info("Zotero language PUT",{url:i,itemKey:e,language:t});try{let C=await this.requestLocalApiWithBody(i,"PUT",a,r,`Zotero update failed for ${i}`);console.info("Zotero language PUT response",{status:C.statusCode})}catch(C){if(!(C instanceof Error?C.message:String(C)).includes("status 501"))throw C;let y=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.info("Zotero language PUT unsupported; trying POST",{postUrl:y});let b=await this.requestLocalApiWithBody(y,"POST",[a],r,`Zotero update failed for ${y}`);console.info("Zotero language POST response",{status:b.statusCode})}let o=await this.fetchZoteroItem(e);if(this.normalizeZoteroLanguage(typeof((P=o==null?void 0:o.data)==null?void 0:P.language)=="string"?o.data.language:"")===this.normalizeZoteroLanguage(t))return;let d={...(k=o==null?void 0:o.data)!=null?k:n,language:t},u={key:e,version:(D=(S=(x=o==null?void 0:o.data)==null?void 0:x.version)!=null?S:o==null?void 0:o.version)!=null?D:s,data:d},h={...r},g=typeof u.version=="number"?u.version:Number(u.version);Number.isNaN(g)?delete h["If-Unmodified-Since-Version"]:h["If-Unmodified-Since-Version"]=String(g);let m=await this.requestLocalApiWithBody(i,"PUT",u,h,`Zotero update failed for ${i}`);console.info("Zotero language PUT retry response",{status:m.statusCode});let _=await this.fetchZoteroItem(e);if(this.normalizeZoteroLanguage(typeof((T=_==null?void 0:_.data)==null?void 0:T.language)=="string"?_.data.language:"")!==this.normalizeZoteroLanguage(t))throw new Error("Language update did not persist in Zotero.")}async updateZoteroItemLanguageWeb(e,n,t){var m,_,v,P,k;let i=this.getWebApiLibraryPath();if(!i)throw new Error("Web API library path is not configured.");let a=this.buildWebApiUrl(`/${i}/items/${e}`),r=await this.fetchZoteroItemWeb(e),s={...(m=r==null?void 0:r.data)!=null?m:n,language:t},o={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},l=(P=(v=(_=r==null?void 0:r.data)==null?void 0:_.version)!=null?v:r==null?void 0:r.version)!=null?P:n==null?void 0:n.version,d=typeof l=="number"?l:Number(l);Number.isNaN(d)||(o["If-Unmodified-Since-Version"]=String(d)),console.info("Zotero Web API language PUT",{url:a,itemKey:e,language:t});let u=await this.requestWebApiWithBody(a,"PUT",s,o,`Zotero Web API update failed for ${a}`);console.info("Zotero Web API language PUT response",{status:u.statusCode});let h=await this.fetchZoteroItemWeb(e);if(this.normalizeZoteroLanguage(typeof((k=h==null?void 0:h.data)==null?void 0:k.language)=="string"?h.data.language:"")!==this.normalizeZoteroLanguage(t))throw new Error("Language update did not persist in Zotero Web API.")}getDocId(e){let n=[e.key,e.itemKey,e.id,e.citationKey];for(let t of n)if(typeof t=="string"&&t.trim())return t.trim();return null}sanitizeFileName(e){let n=e.replace(/[\\/:*?"<>|]/g,"").replace(/\s+/g," ").trim();return n?n.replace(/[.]+$/g,"").trim().slice(0,120):""}registerNoteRenameHandler(){this.registerEvent(this.app.vault.on("rename",async e=>{if(!(!(e instanceof c.TFile)||e.extension!=="md"))try{let n=await this.app.vault.read(e),t=this.extractDocIdFromFrontmatter(n);if(!t)return;await this.updateDocIndex({doc_id:t,note_path:e.path,note_title:f.default.basename(e.path,".md")})}catch(n){console.warn("Failed to update doc index for renamed note",n)}}))}async resolveNotePathForDocId(e){if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e);if(t!=null&&t.note_path&&await n.exists(t.note_path))return t.note_path;let a=(await this.scanNotesForDocIds(this.settings.outputNoteDir))[e];return a!=null&&a.note_path?(await this.updateDocIndex({doc_id:e,note_path:a.note_path,note_title:a.note_title}),a.note_path):null}async resolveUniqueBaseName(e,n){let t=this.app.vault.adapter,i=(0,c.normalizePath)(`${this.settings.outputNoteDir}/${e}.md`),a=(0,c.normalizePath)(`${this.settings.outputPdfDir}/${e}.pdf`),r=await t.exists(i),s=this.settings.copyPdfToVault?await t.exists(a):!1;return r||s?`${e}-${n}`:e}async searchZoteroItems(e){let n=new URLSearchParams;n.set("itemType","-attachment"),n.set("limit","25"),n.set("include","data,meta"),e.trim()&&n.set("q",e.trim());let t=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items?${n.toString()}`);try{let i=await this.requestLocalApi(t,`Zotero search failed for ${t}`),a=JSON.parse(i.toString("utf8"));return Array.isArray(a)?a.map(r=>{var s,o,l,d;return{key:(o=r.key)!=null?o:(s=r.data)==null?void 0:s.key,data:(l=r.data)!=null?l:{},meta:(d=r.meta)!=null?d:{}}}).filter(r=>typeof r.key=="string"&&r.key.trim().length>0):[]}catch(i){if(console.warn("Failed to search Zotero via local API",i),!this.canUseWebApi())throw i;return this.searchZoteroItemsWeb(e)}}async resolvePdfAttachment(e,n){let t=this.pickPdfAttachment(e);if(t)return t;try{let i=await this.fetchZoteroChildren(n);for(let a of i){let r=this.toPdfAttachment(a);if(r)return r}}catch(i){console.error("Failed to fetch Zotero children",i)}return null}pickPdfAttachment(e){var t,i,a;let n=(a=(i=(t=e.attachments)!=null?t:e.children)!=null?i:e.items)!=null?a:[];if(!Array.isArray(n))return null;for(let r of n){let s=this.toPdfAttachment(r);if(s)return s}return null}toPdfAttachment(e){var a,r,s,o,l,d;if(((s=(a=e==null?void 0:e.contentType)!=null?a:e==null?void 0:e.mimeType)!=null?s:(r=e==null?void 0:e.data)==null?void 0:r.contentType)!=="application/pdf")return null;let t=(d=(o=e==null?void 0:e.key)!=null?o:e==null?void 0:e.attachmentKey)!=null?d:(l=e==null?void 0:e.data)==null?void 0:l.key;if(!t)return null;let i=this.extractAttachmentPath(e);return i?{key:t,filePath:i}:{key:t}}extractAttachmentPath(e){var t,i,a,r,s,o,l,d;let n=(d=(r=(i=(t=e==null?void 0:e.links)==null?void 0:t.enclosure)==null?void 0:i.href)!=null?r:(a=e==null?void 0:e.enclosure)==null?void 0:a.href)!=null?d:(l=(o=(s=e==null?void 0:e.data)==null?void 0:s.links)==null?void 0:o.enclosure)==null?void 0:l.href;if(typeof n=="string"&&n.startsWith("file://"))try{return(0,$.fileURLToPath)(n)}catch(u){return null}return null}async fetchZoteroChildren(e){let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/children`);try{let t=await this.requestLocalApi(n,`Zotero children request failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(t){if(console.warn("Failed to fetch Zotero children from local API",t),!this.canUseWebApi())throw t;let i=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/children`),a=await this.requestWebApi(i,`Zotero Web API children request failed for ${i}`);return JSON.parse(a.toString("utf8"))}}async downloadZoteroPdf(e){let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/file`);try{let t=await this.requestLocalApiRaw(n),i=await this.followFileRedirect(t);if(i)return i;if(t.statusCode>=300)throw new Error(`Request failed, status ${t.statusCode}`);return t.body}catch(t){if(console.warn("Failed to download PDF from local API",t),!this.canUseWebApi())throw t;let i=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/file`),a=await this.requestWebApiRaw(i),r=await this.followFileRedirect(a);if(r)return r;if(a.statusCode>=300)throw new Error(`Web API request failed, status ${a.statusCode}`);return a.body}}buildZoteroUrl(e){return`${this.settings.zoteroBaseUrl.replace(/\/$/,"")}${e}`}canUseWebApi(){return!!((this.settings.webApiBaseUrl||"").trim()&&this.settings.webApiKey&&this.settings.webApiLibraryId)}getWebApiLibraryPath(){let e=(this.settings.webApiLibraryId||"").trim();return e?`${this.settings.webApiLibraryType==="group"?"groups":"users"}/${e}`:""}buildWebApiUrl(e){return`${this.settings.webApiBaseUrl.replace(/\/$/,"")}${e}`}requestLocalApiRaw(e,n={}){return new Promise((t,i)=>{var u,h;let a=new URL(e),r=a.protocol==="https:"?le.default:oe.default,s=(u=n.method)!=null?u:"GET",o={Accept:"*/*",...(h=n.headers)!=null?h:{}},l=n.body;if(l!==void 0&&o["Content-Length"]===void 0){let g=Buffer.isBuffer(l)?l.length:Buffer.byteLength(l);o["Content-Length"]=String(g)}let d=r.request({method:s,hostname:a.hostname,port:a.port||void 0,path:`${a.pathname}${a.search}`,headers:o},g=>{let m=[];g.on("data",_=>m.push(Buffer.from(_))),g.on("end",()=>{var v;let _=Buffer.concat(m);t({statusCode:(v=g.statusCode)!=null?v:0,headers:g.headers,body:_})})});d.on("error",i),l!==void 0&&d.write(l),d.end()})}async requestLocalApi(e,n){let t=await this.requestLocalApiRaw(e);if(t.statusCode>=400){let i=t.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}: ${i||"no response body"}`)}if(t.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}`);return t.body}async requestLocalApiWithBody(e,n,t,i,a){let r=JSON.stringify(t),s=await this.requestLocalApiRaw(e,{method:n,headers:i,body:r});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${a!=null?a:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${a!=null?a:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}async requestWebApi(e,n){let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},i=await this.requestLocalApiRaw(e,{headers:t});if(i.statusCode>=400){let a=i.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}: ${a||"no response body"}`)}if(i.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}`);return i.body}requestWebApiRaw(e,n={}){var i;let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey,...(i=n.headers)!=null?i:{}};return this.requestLocalApiRaw(e,{...n,headers:t})}async requestWebApiWithBody(e,n,t,i,a){let r=JSON.stringify(t),s=await this.requestLocalApiRaw(e,{method:n,headers:i,body:r});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${a!=null?a:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${a!=null?a:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}async followFileRedirect(e){if(e.statusCode<300||e.statusCode>=400)return null;let n=e.headers.location,t=Array.isArray(n)?n[0]:n;if(!t||typeof t!="string")return null;if(t.startsWith("file://")){let i=(0,$.fileURLToPath)(t);return z.promises.readFile(i)}return t.startsWith("http://")||t.startsWith("https://")?this.requestLocalApi(t):null}bufferToArrayBuffer(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}async annotateChunkJsonWithAttachmentKey(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;let a=i.metadata&&typeof i.metadata=="object"?i.metadata:{};a.attachment_key=n,i.metadata=a,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to annotate chunks JSON with attachment key",t)}}async updateChunkJsonSourcePdf(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;i.source_pdf=n,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to update chunks JSON source_pdf",t)}}buildPdfLinkFromSourcePath(e){if(!e)return"";let n=f.default.normalize(this.getVaultBasePath()),t=f.default.normalize(e),i=n.endsWith(f.default.sep)?n:`${n}${f.default.sep}`;return t.startsWith(i)?`[[${(0,c.normalizePath)(f.default.relative(n,t))}]]`:`[PDF](${(0,$.pathToFileURL)(e).toString()})`}toVaultRelativePath(e){if(!e)return"";let n=f.default.normalize(this.getVaultBasePath()),t=f.default.normalize(e),i=n.endsWith(f.default.sep)?n:`${n}${f.default.sep}`;return t.startsWith(i)?(0,c.normalizePath)(f.default.relative(n,t)):""}buildPdfLinkForNote(e,n,t){return!e&&!n?"":!this.settings.copyPdfToVault&&n?`[PDF](${this.buildZoteroDeepLink(t!=null?t:"",n)})`:this.buildPdfLinkFromSourcePath(e)}buildVaultPdfCitationLink(e,n,t){if(!e)return"";let i=this.toVaultRelativePath(e);if(!i)return"";let a=n?`#page=${n}`:"";return`[[${i}${a}|${t||i}]]`}async maybeCreateOcrLayeredPdf(e,n,t){if(!this.settings.createOcrLayeredPdf||!this.settings.copyPdfToVault||!e||!((n==null?void 0:n.ocr_used)===!0))return null;if(!this.toVaultRelativePath(e))return console.warn("OCR layered PDF requires a vault-local PDF"),null;try{await this.ensureFolder(this.settings.outputPdfDir)}catch(l){return console.warn("Failed to create OCR PDF output folder",l),null}let a=`${e}.ocr.tmp`,r=(t||(n==null?void 0:n.languages)||"eng").toString(),s=this.getPluginDir(),o=f.default.join(s,"tools","ocr_layered_pdf.py");try{return this.showStatusProgress("Creating OCR PDF...",0),await this.runPythonStreaming(o,["--pdf",e,"--out-pdf",a,"--language",r,"--progress"],l=>{if((l==null?void 0:l.type)==="progress"&&l.total){let d=Math.round(l.current/l.total*100);this.showStatusProgress(`Creating OCR PDF ${l.current}/${l.total}`,d)}},()=>{}),await z.promises.rename(a,e),e}catch(l){return console.warn("OCR layered PDF creation failed",l),null}}getMainLeaf(){let e=new Set(this.app.workspace.getLeavesOfType(F)),n=this.app.workspace.getLeavesOfType("markdown").find(i=>!e.has(i));if(n)return n;let t=this.app.workspace.getLeaf(!1);return t&&!e.has(t)?t:this.app.workspace.getLeaf("tab")}async openNoteInMain(e){let n=(0,c.normalizePath)(e),t=this.app.vault.getAbstractFileByPath(n),i=this.getMainLeaf();if(t instanceof c.TFile){await i.openFile(t,{active:!0});return}await this.app.workspace.openLinkText(n,"",!1)}async openInternalLinkInMain(e){let n=this.getMainLeaf(),t=e.split("#")[0].trim(),i=t?this.app.metadataCache.getFirstLinkpathDest(t,""):null;if(i instanceof c.TFile){await n.openFile(i,{active:!0}),e.includes("#")&&(this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1));return}this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1)}async openNoteInNewTab(e){let n=(0,c.normalizePath)(e);await this.app.workspace.openLinkText(n,"","tab")}async openPdfInMain(e,n){if(!e)return!1;let t=f.default.normalize(this.getVaultBasePath()),i=f.default.normalize(e),a=t.endsWith(f.default.sep)?t:`${t}${f.default.sep}`;if(i.startsWith(a)){let r=(0,c.normalizePath)(f.default.relative(t,i)),s=n?`#page=${n}`:"";return await this.app.workspace.openLinkText(`${r}${s}`,"","tab"),!0}try{return window.open((0,$.pathToFileURL)(e).toString()),!0}catch(r){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,n,t,i){if(n){let a=new URLSearchParams;t&&a.set("page",t),i&&a.set("annotation",i);let r=a.toString()?`?${a.toString()}`:"";return`zotero://open-pdf/library/items/${n}${r}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let t=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(t))return t}formatCitationsMarkdown(e){return e.length?e.map(t=>this.formatCitationMarkdown(t)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e){var g,m,_,v,P,k;let n=e.doc_id||"?",t=e.pages||`${(g=e.page_start)!=null?g:"?"}-${(m=e.page_end)!=null?m:"?"}`,i=`${n}`,a=t.includes("-")?t.replace("-"," - "):t,r=e.annotation_key||this.extractAnnotationKey(e.chunk_id),s=e.attachment_key||((v=(_=this.docIndex)==null?void 0:_[e.doc_id||""])==null?void 0:v.attachment_key),o=e.page_start?String(e.page_start):"",l=(k=(P=this.docIndex)==null?void 0:P[e.doc_id||""])!=null?k:null,d=(l==null?void 0:l.zotero_title)||(l==null?void 0:l.note_title)||i,u=l!=null&&l.note_path?(0,c.normalizePath)(l.note_path).replace(/\.md$/i,""):this.sanitizeFileName(d)||d,h=u&&u!==d?`[[${u}|${d}]]`:`[[${d}]]`;if(this.settings.preferVaultPdfForCitations){let x=(l==null?void 0:l.pdf_path)||e.source_pdf||"",S=this.buildVaultPdfCitationLink(x,o,a);if(S)return`- ${h}, p. ${S}`}if(s){let x=this.buildZoteroDeepLink(n,s,o,r);return`- ${h}, p. [${a}](${x})`}return`- ${h}, p. ${a}`}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,c.normalizePath)(`${R}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var t;let e=this.app.vault.adapter,n=this.getDocIndexPath();if(!await e.exists(n))return{};try{let i=await e.read(n),a=JSON.parse(i);if(a&&typeof a=="object"){let r=(t=a.entries)!=null?t:a;if(Array.isArray(r)){let s={};for(let o of r)o!=null&&o.doc_id&&(s[String(o.doc_id)]=o);return s}if(r&&typeof r=="object")return r}}catch(i){console.error("Failed to read doc index",i)}return{}}async saveDocIndex(e){await this.ensureFolder(R);let n=this.app.vault.adapter,t=this.getDocIndexPath(),i={version:1,entries:e};await n.write(t,JSON.stringify(i,null,2)),this.docIndex=e}async updateDocIndex(e){var a;let n=await this.getDocIndex(),t=(a=n[e.doc_id])!=null?a:{doc_id:e.doc_id},i={...t,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&t.note_path&&(i.note_path=t.note_path),e.note_title===void 0&&t.note_title&&(i.note_title=t.note_title),e.zotero_title===void 0&&t.zotero_title&&(i.zotero_title=t.zotero_title),e.pdf_path===void 0&&t.pdf_path&&(i.pdf_path=t.pdf_path),e.attachment_key===void 0&&t.attachment_key&&(i.attachment_key=t.attachment_key),n[e.doc_id]=i,await this.saveDocIndex(n)}async hydrateDocIndexFromCache(e){var s,o;if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e),i={},a=(0,c.normalizePath)(`${q}/${e}.json`);if(await n.exists(a))try{let l=await n.read(a),d=JSON.parse(l),u=(o=(s=d==null?void 0:d.data)!=null?s:d)!=null?o:{},h=typeof u.title=="string"?u.title:"";if(h&&(i.zotero_title=h),!i.note_title||!i.note_path){let g=this.sanitizeFileName(h)||e,m=(0,c.normalizePath)(`${this.settings.outputNoteDir}/${g}.md`),_=(0,c.normalizePath)(`${this.settings.outputNoteDir}/${g}-${e}.md`),v="";await n.exists(m)?v=m:await n.exists(_)&&(v=_),v&&(i.note_path=v,i.note_title=f.default.basename(v,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!i.note_title&&(t!=null&&t.note_path)&&(i.note_title=f.default.basename(t.note_path,".md"));let r=(0,c.normalizePath)(`${O}/${e}.json`);if(await n.exists(r))try{let l=await n.read(r),d=JSON.parse(l);typeof(d==null?void 0:d.source_pdf)=="string"&&(i.pdf_path=d.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(i).length>0&&await this.updateDocIndex({doc_id:e,...i}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var t;return e&&(t=(await this.getDocIndex())[e])!=null?t:null}async inferNotePathFromCache(e){var i,a;let n=this.app.vault.adapter,t=(0,c.normalizePath)(`${q}/${e}.json`);if(!await n.exists(t))return"";try{let r=await n.read(t),s=JSON.parse(r),o=(a=(i=s==null?void 0:s.data)!=null?i:s)!=null?a:{},l=typeof o.title=="string"?o.title:"",d=this.sanitizeFileName(l)||e,u=(0,c.normalizePath)(`${this.settings.outputNoteDir}/${d}.md`),h=(0,c.normalizePath)(`${this.settings.outputNoteDir}/${d}-${e}.md`);if(await n.exists(u))return u;if(await n.exists(h))return h}catch(r){console.error("Failed to infer note path from cache",r)}return""}async rebuildNoteFromCacheForDocId(e,n){var T,C,A,y;try{await this.ensureBundledTools()}catch(b){return n&&new c.Notice("Failed to sync bundled tools. See console for details."),console.error(b),!1}let t=this.app.vault.adapter,i=(0,c.normalizePath)(`${q}/${e}.json`),a=(0,c.normalizePath)(`${O}/${e}.json`);if(!await t.exists(i)||!await t.exists(a))return n&&new c.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let r;try{let b=await t.read(i);r=JSON.parse(b)}catch(b){return n&&new c.Notice("Failed to read cached item JSON."),console.error(b),this.clearStatusProgress(),!1}let s;try{let b=await t.read(a);s=JSON.parse(b)}catch(b){return n&&new c.Notice("Failed to read cached chunks JSON."),console.error(b),this.clearStatusProgress(),!1}let o=typeof s.source_pdf=="string"?s.source_pdf:"";if(!o)return n&&new c.Notice("Cached chunk JSON is missing source_pdf."),this.clearStatusProgress(),!1;try{await z.promises.access(o)}catch(b){return n&&new c.Notice("Cached source PDF path is not accessible."),console.error(b),this.clearStatusProgress(),!1}let l=(T=r.data)!=null?T:r,d=typeof l.title=="string"?l.title:"",u=await this.resolveLanguageHint(l,(C=r.key)!=null?C:l.key),h=this.buildDoclingLanguageHint(u!=null?u:void 0),g="",m=await this.getDocIndexEntry(e),_=typeof((A=s==null?void 0:s.metadata)==null?void 0:A.attachment_key)=="string"?s.metadata.attachment_key:m==null?void 0:m.attachment_key;if(m!=null&&m.note_path&&await t.exists(m.note_path)&&(g=(0,c.normalizePath)(m.note_path)),!g){let b=this.sanitizeFileName(d)||e,E=(0,c.normalizePath)(`${this.settings.outputNoteDir}/${b}.md`),I=await t.exists(E)?b:await this.resolveUniqueBaseName(b,e);g=(0,c.normalizePath)(`${this.settings.outputNoteDir}/${I}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let b=this.getLogFileRelativePath(),E=(0,c.normalizePath)(f.default.dirname(b));E&&await this.ensureFolder(E);let I=this.getSpellcheckerInfoRelativePath(),ne=(0,c.normalizePath)(f.default.dirname(I));ne&&await this.ensureFolder(ne)}}catch(b){return n&&new c.Notice("Failed to create notes folder."),console.error(b),this.clearStatusProgress(),!1}let v=this.getPluginDir(),P=f.default.join(v,"tools","docling_extract.py"),k=f.default.join(v,"tools","index_redisearch.py"),x=null,S=null;try{x=await this.readDoclingQualityLabelFromPdf(o,h),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",x),0),await this.runPythonStreaming(P,this.buildDoclingArgs(o,e,a,g,h,!0),I=>this.handleDoclingProgress(I,x),()=>{}),x=await this.readDoclingQualityLabel(a),_&&await this.annotateChunkJsonWithAttachmentKey(a,_);let b=await this.readDoclingMetadata(a),E=await this.maybeCreateOcrLayeredPdf(o,b,h);E&&(o=E,S=E,await this.updateChunkJsonSourcePdf(a,E))}catch(b){return n&&new c.Notice("Docling extraction failed. See console for details."),console.error(b),this.clearStatusProgress(),!1}try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",x),0),await this.runPythonStreaming(k,["--chunks-json",this.getAbsoluteVaultPath(a),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"],b=>{if((b==null?void 0:b.type)==="progress"&&b.total){let E=Math.round(b.current/b.total*100),I=this.formatStatusLabel(`Indexing chunks ${b.current}/${b.total}`,x);this.showStatusProgress(I,E)}},()=>{})}catch(b){return n&&new c.Notice("RedisSearch indexing failed. See console for details."),console.error(b),this.clearStatusProgress(),!1}let D=S?this.buildPdfLinkFromSourcePath(S):this.buildPdfLinkForNote(o,m==null?void 0:m.attachment_key,e);try{let b=await this.app.vault.adapter.read(g),E=this.buildNoteMarkdown(l,(y=r.meta)!=null?y:{},e,D,i,b);await this.app.vault.adapter.write(g,E)}catch(b){return n&&new c.Notice("Failed to finalize note markdown."),console.error(b),this.clearStatusProgress(),!1}try{await this.updateDocIndex({doc_id:e,note_path:g,note_title:f.default.basename(g,".md"),zotero_title:d,pdf_path:o})}catch(b){console.error("Failed to update doc index",b)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async ensureFolder(e){let n=this.app.vault.adapter,t=(0,c.normalizePath)(e).split("/").filter(Boolean),i="";for(let a of t)i=i?`${i}/${a}`:a,await n.exists(i)||await n.mkdir(i)}buildNoteMarkdown(e,n,t,i,a,r){let s=`[[${a}]]`,o=this.renderFrontmatter(e,n,t,i,s);return`${o?`---
${o}
---
...
${r}`}renderFrontmatter(e,n,t,i,a){var o;let r=(o=this.settings.frontmatterTemplate)!=null?o:"";if(!r.trim())return"";let s=this.buildTemplateVars(e,n,t,i,a);return r.replace(/{{\s*([a-z0-9_]+)\s*}}/gi,(l,d)=>{var u;return(u=s[d])!=null?u:""}).trim()}buildTemplateVars(e,n,t,i,a){let r=typeof e.title=="string"?e.title:"",s=typeof e.shortTitle=="string"?e.shortTitle:"",o=typeof e.date=="string"?e.date:"",l=typeof(n==null?void 0:n.parsedDate)=="string"?n.parsedDate:"",d=this.extractYear(l||o),h=(Array.isArray(e.creators)?e.creators:[]).filter(x=>x.creatorType==="author").map(x=>this.formatCreatorName(x)),g=h.join("; "),m=Array.isArray(e.tags)?e.tags.map(x=>typeof x=="string"?x:x==null?void 0:x.tag).filter(Boolean):[],_=m.join("; "),v=typeof e.itemType=="string"?e.itemType:"",P=typeof(n==null?void 0:n.creatorSummary)=="string"?n.creatorSummary:"",k={doc_id:t,zotero_key:typeof e.key=="string"?e.key:t,title:r,short_title:s,date:o,year:d,authors:g,tags:_,item_type:v,creator_summary:P,pdf_link:this.escapeYamlString(i),item_json:this.escapeYamlString(a)};for(let[x,S]of Object.entries(k))k[`${x}_yaml`]=this.escapeYamlString(S);return k.authors_yaml=this.toYamlList(h),k.tags_yaml=this.toYamlList(m),k}extractYear(e){if(!e)return"";let n=e.match(/\b(\d{4})\b/);return n?n[1]:""}formatCreatorName(e){if(!e||typeof e!="object")return"";if(e.name)return String(e.name);let n=e.firstName?String(e.firstName):"",t=e.lastName?String(e.lastName):"";return[t,n].filter(Boolean).join(", ")||`${n} ${t}`.trim()}escapeYamlString(e){return`"${String(e).replace(/\\/g,"\\\\").replace(/"/g,'\\"')}"`}toYamlList(e){return e.length?e.map(n=>`  - ${this.escapeYamlString(n)}`).join(`
`):'  - ""'}getVaultBasePath(){var t;let e=this.app.vault.adapter;if(e instanceof c.FileSystemAdapter)return e.getBasePath();let n=(t=e.getBasePath)==null?void 0:t.call(e);if(n)return n;throw new Error("Vault base path is unavailable.")}getPluginDir(){var i;let e=this.getVaultBasePath(),n=(i=this.manifest.dir)!=null?i:this.manifest.id;if(!n)throw new Error("Plugin directory is unavailable.");let t=f.default.isAbsolute(n)?n:f.default.join(e,n);return f.default.normalize(t)}async ensureBundledTools(){let e=this.getPluginDir(),n=f.default.join(e,"tools");await z.promises.mkdir(n,{recursive:!0});for(let[t,i]of Object.entries(ae)){let a=f.default.join(n,t),r=!0;try{await z.promises.readFile(a,"utf8")===i&&(r=!1)}catch(s){}r&&await z.promises.writeFile(a,i,"utf8")}}async migrateCachePaths(){let e="zotero/items",n="zotero/chunks",t=q,i=O,a=this.app.vault.adapter,r=(0,c.normalizePath)(e),s=(0,c.normalizePath)(n),o=(0,c.normalizePath)(t),l=(0,c.normalizePath)(i),d=o.split("/").slice(0,-1).join("/"),u=l.split("/").slice(0,-1).join("/");d&&await this.ensureFolder(d),u&&await this.ensureFolder(u);let h=await a.exists(r),g=await a.exists(s),m=await a.exists(o),_=await a.exists(l);h&&!m&&await a.rename(r,o),g&&!_&&await a.rename(s,l)}getAbsoluteVaultPath(e){let n=this.getVaultBasePath(),t=f.default.isAbsolute(e)?e:f.default.join(n,e);return f.default.normalize(t)}buildDoclingArgs(e,n,t,i,a,r=!1){let s=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",n,"--out-json",this.getAbsoluteVaultPath(t),"--out-md",this.getAbsoluteVaultPath(i),"--chunking",this.settings.chunkingMode,"--ocr",s];r&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),a&&o.push("--language-hint",a),this.settings.maxChunkChars>0&&o.push("--max-chunk-chars",String(this.settings.maxChunkChars)),this.settings.chunkOverlapChars>0&&o.push("--chunk-overlap-chars",String(this.settings.chunkOverlapChars)),this.settings.removeImagePlaceholders||o.push("--keep-image-tags"),this.settings.enableLlmCleanup&&(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars))),this.settings.postprocessTextLayer&&o.push("--postprocess-text-layer");let l=this.getPluginDir(),d=f.default.join(l,"tools","ocr_wordlist.txt");if((0,z.existsSync)(d)&&o.push("--enable-dictionary-correction","--dictionary-path",d),this.settings.enableFileLogging){let u=this.getLogFileAbsolutePath();u&&o.push("--log-file",u);let h=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());h&&o.push("--spellchecker-info-out",h)}return o}getRedisDataDir(){return f.default.join(this.getVaultBasePath(),R,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return f.default.join(e,"tools","docker-compose.yml")}getDockerProjectName(){let e=this.getVaultBasePath(),n=f.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),t=(0,K.createHash)("sha1").update(e).digest("hex").slice(0,8);return`zrr-${n||"vault"}-${t}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),n=e.port?Number(e.port):6379;return Number.isFinite(n)&&n>0?n:6379}catch(e){return 6379}}getRedisNamespace(){let e=this.getVaultBasePath(),n=f.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24),t=(0,K.createHash)("sha1").update(e).digest("hex").slice(0,8);return`${n||"vault"}-${t}`}getRedisIndexName(){return`${(this.settings.redisIndex||"idx:zotero").trim()||"idx:zotero"}:${this.getRedisNamespace()}`}getRedisKeyPrefix(){let e=(this.settings.redisPrefix||"zotero:chunk:").trim()||"zotero:chunk:";return`${e.endsWith(":")?e:`${e}:`}${this.getRedisNamespace()}:`}async startRedisStack(e){var n;try{await this.ensureBundledTools();let t=this.getDockerComposePath(),i=this.getRedisDataDir();await z.promises.mkdir(i,{recursive:!0});let a=((n=this.settings.dockerPath)==null?void 0:n.trim())||"docker",r=this.getDockerProjectName(),s=String(this.getRedisPortFromUrl());try{await this.runCommand(a,["compose","-p",r,"-f",t,"down"],{cwd:f.default.dirname(t)})}catch(o){console.warn("Redis Stack stop before restart failed",o)}await this.runCommand(a,["compose","-p",r,"-f",t,"up","-d"],{cwd:f.default.dirname(t),env:{...process.env,ZRR_DATA_DIR:i,ZRR_PORT:s}}),e||new c.Notice("Redis Stack started.")}catch(t){e||new c.Notice("Failed to start Redis Stack. Check Docker Desktop and File Sharing."),console.error("Failed to start Redis Stack",t)}}async setupPythonEnv(){let e=this.getPluginDir(),n=this.getPythonVenvDir(),t=this.getVenvPythonPath(n);await this.ensureBundledTools();let i=this.resolveRequirementsPath(e);if(!i)throw new Error(`requirements.txt not found in ${e}`);try{if(new c.Notice("Setting up Python environment..."),!(0,z.existsSync)(t)){let a=await this.resolveBootstrapPython();await this.runCommand(a.command,[...a.args,"-m","venv",n],{cwd:e})}await this.runCommand(t,["-m","pip","install","-r",i],{cwd:e}),this.settings.pythonPath=t,await this.saveSettings(),new c.Notice("Python environment ready.")}catch(a){new c.Notice("Failed to set up Python environment. See console for details."),console.error("Python env setup failed",a)}}getPythonVenvDir(){return f.default.join(this.getPluginDir(),".venv")}getVenvPythonPath(e){return process.platform==="win32"?f.default.join(e,"Scripts","python.exe"):f.default.join(e,"bin","python")}resolveRequirementsPath(e){var t;return(t=[f.default.join(e,"requirements.txt"),f.default.join(e,"tools","requirements.txt")].find(i=>(0,z.existsSync)(i)))!=null?t:null}async resolveBootstrapPython(){let e=(this.settings.pythonPath||"").trim();if(e&&await this.canRunCommand(e,[]))return{command:e,args:[]};let n=process.platform==="win32"?[{command:"py",args:["-3"]},{command:"python",args:[]}]:[{command:"python3",args:[]},{command:"python",args:[]}];for(let t of n)if(await this.canRunCommand(t.command,t.args))return t;throw new Error("No usable Python interpreter found on PATH.")}async canRunCommand(e,n){return new Promise(t=>{let i=(0,j.spawn)(e,[...n,"--version"]);i.on("error",()=>t(!1)),i.on("close",a=>t(a===0))})}runPython(e,n){return new Promise((t,i)=>{let a=(0,j.spawn)(this.settings.pythonPath,[e,...n],{cwd:f.default.dirname(e)}),r="";a.stderr.on("data",s=>{r+=s.toString()}),a.on("close",s=>{s===0?t():i(new Error(r||`Process exited with code ${s}`))})})}runCommand(e,n,t){return new Promise((i,a)=>{let r=(0,j.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:t==null?void 0:t.env}),s="";r.stderr.on("data",o=>{s+=o.toString()}),r.on("close",o=>{o===0?i():a(new Error(s||`Process exited with code ${o}`))})})}runPythonStreaming(e,n,t,i){return new Promise((a,r)=>{let s=(0,j.spawn)(this.settings.pythonPath,[e,...n],{cwd:f.default.dirname(e)}),o="",l="",d=null,u=!1,h=g=>{if(g.trim())try{let m=JSON.parse(g);d=m,((m==null?void 0:m.type)==="final"||m!=null&&m.answer)&&(u=!0),t(m)}catch(m){}};s.stdout.on("data",g=>{var _;o+=g.toString();let m=o.split(/\r?\n/);o=(_=m.pop())!=null?_:"";for(let v of m)h(v)}),s.stderr.on("data",g=>{l+=g.toString()}),s.on("close",g=>{o.trim()&&h(o),!u&&d&&i(d),g===0?a():r(new Error(l||`Process exited with code ${g}`))})})}getLogsDirRelative(){return(0,c.normalizePath)(`${R}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,c.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,c.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;if(!await n.exists(e)){new c.Notice("Log file not found.");return}try{let t=await n.read(e);new Q(this.app,"Docling log",t||"(empty)").open()}catch(t){new c.Notice("Failed to open log file."),console.error(t)}}async clearLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{let t=(0,c.normalizePath)(f.default.dirname(e));t&&await this.ensureFolder(t),await n.write(e,""),new c.Notice("Log file cleared.")}catch(t){new c.Notice("Failed to clear log file."),console.error(t)}}runPythonWithOutput(e,n){return new Promise((t,i)=>{let a=(0,j.spawn)(this.settings.pythonPath,[e,...n],{cwd:f.default.dirname(e)}),r="",s="";a.stdout.on("data",o=>{r+=o.toString()}),a.stderr.on("data",o=>{s+=o.toString()}),a.on("close",o=>{o===0?t(r.trim()):i(new Error(s||`Process exited with code ${o}`))})})}},ee=class extends c.SuggestModal{constructor(e,n,t){super(e);this.lastError=null;this.indexedDocIds=null;this.plugin=n,this.resolveSelection=t,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){try{if(!this.indexedDocIds){let n=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(n))}return await this.plugin.searchZoteroItems(e)}catch(n){let t=n instanceof Error?n.message:String(n);return this.lastError!==t&&(this.lastError=t,new c.Notice(t)),console.error("Zotero search failed",n),[]}}renderSuggestion(e,n){var u,h,g;let t=(h=(u=e.data)==null?void 0:u.title)!=null?h:"[No title]",i=this.extractYear(e),a=this.getDocId(e),r=a?(g=this.indexedDocIds)==null?void 0:g.has(a):!1,s=this.getPdfStatus(e);r&&n.addClass("zrr-indexed-item"),s==="no"&&n.addClass("zrr-no-pdf-item"),n.createEl("div",{text:t});let o=n.createEl("small"),l=!1,d=()=>{l&&o.createSpan({text:" \u2022 "})};i&&(o.createSpan({text:i}),l=!0),r&&(d(),o.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),l=!0),s==="no"&&(d(),o.createSpan({text:"No attachment",cls:"zrr-no-pdf-flag"}),l=!0),n.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,n){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}getDocId(e){var t,i,a;let n=(a=(i=e.key)!=null?i:(t=e.data)==null?void 0:t.key)!=null?a:"";return typeof n=="string"?n:""}getPdfStatus(e){var i,a,r,s,o,l,d;let n=(l=(o=(r=(i=e.data)==null?void 0:i.attachments)!=null?r:(a=e.data)==null?void 0:a.children)!=null?o:(s=e.data)==null?void 0:s.items)!=null?l:[];if(Array.isArray(n)&&n.length>0)return n.some(h=>this.isPdfAttachment(h))?"yes":"no";let t=(d=e.meta)==null?void 0:d.numChildren;return typeof t=="number"&&t===0?"no":"unknown"}isPdfAttachment(e){var t,i,a,r,s,o;return((o=(s=(a=(t=e==null?void 0:e.contentType)!=null?t:e==null?void 0:e.mimeType)!=null?a:(i=e==null?void 0:e.data)==null?void 0:i.contentType)!=null?s:(r=e==null?void 0:e.data)==null?void 0:r.mimeType)!=null?o:"")==="application/pdf"}extractYear(e){var i,a,r,s;let n=(s=(r=(i=e.meta)==null?void 0:i.parsedDate)!=null?r:(a=e.data)==null?void 0:a.date)!=null?s:"";if(typeof n!="string")return"";let t=n.match(/\b(\d{4})\b/);return t?t[1]:""}};

"use strict";var Gn=Object.create;var Le=Object.defineProperty;var Vn=Object.getOwnPropertyDescriptor;var Un=Object.getOwnPropertyNames;var Bn=Object.getPrototypeOf,Zn=Object.prototype.hasOwnProperty;var Hn=(u,c)=>{for(var e in c)Le(u,e,{get:c[e],enumerable:!0})},rn=(u,c,e,n)=>{if(c&&typeof c=="object"||typeof c=="function")for(let t of Un(c))!Zn.call(u,t)&&t!==e&&Le(u,t,{get:()=>c[t],enumerable:!(n=Vn(c,t))||n.enumerable});return u};var ge=(u,c,e)=>(e=u!=null?Gn(Bn(u)):{},rn(c||!u||!u.__esModule?Le(e,"default",{value:u,enumerable:!0}):e,u)),Wn=u=>rn(Le({},"__esModule",{value:!0}),u);var ot={};Hn(ot,{default:()=>Be});module.exports=Wn(ot);var f=require("obsidian");var pn=require("@codemirror/state"),W=require("@codemirror/view"),un=require("obsidian");var de=/<!--\s*zrr:sync-start[^>]*-->/i,fe=/<!--\s*zrr:sync-end\s*-->/i,ae=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ae=/<!--\s*zrr:chunk\s+end\s*-->/i,ke=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,sn=u=>{let c=u.trim();if(!c.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(c)){let g=c.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:g?g[2]:void 0}}if(/^zrr:sync-end\b/i.test(c))return{type:"sync-end"};if(/^zrr:chunk\s+end\b/i.test(c))return{type:"chunk-end"};let e=c.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let n=e[1]||"",t=n.match(/\bid=(["']?)([^"'\s]+)\1/i),i=t?t[2]:"",r=n.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:n.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,d=Number.isFinite(s!=null?s:NaN)?s:l,p=/\bexclude\b/i.test(n)||/\bdelete\b/i.test(n),_=/\bsection\b/i.test(n);return{type:"chunk-start",chunkId:i||void 0,excluded:p,pageNumber:Number.isFinite(d!=null?d:NaN)?d:void 0,chunkKind:_?"section":d?"page":"section"}},We=u=>{var l;if(!u)return null;let c=u.match(ae);if(!c)return null;let e=c[1]||"",n=e.match(/\bid=(["']?)([^"'\s]+)\1/i),t=n?n[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=t&&(l=Jn(t))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:t,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Ee=u=>{for(let c=1;c<=u.lines;c+=1){let e=u.line(c).text;if(de.test(e)){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return n?n[2].trim():null}}return null},Ke=(u,c)=>{let e=c;for(;e>=1;e-=1){let n=u.line(e).text;if(ae.test(n))return{line:e,text:n};if(de.test(n)||fe.test(n))break}return null},Kn=(u,c)=>{for(let e=c;e<=u.lines;e+=1){let n=u.line(e).text;if(Ae.test(n))return e;if(fe.test(n))break}return null},an=(u,c)=>{let e=Ke(u,c);if(!e)return null;let n=Kn(u,e.line+1);return n===null||c<e.line||c>n?null:{startLine:e.line,endLine:n,text:e.text}},on=(u,c,e)=>{if(c>e)return!1;for(let n=c;n<=e;n+=1){let t=u.line(n).text;if(ke.test(t))return!0}return!1},Jn=u=>{var t;if(!u)return null;let e=(u.includes(":")&&(t=u.split(":").pop())!=null?t:u).match(/^p(\d+)$/i);if(!e)return null;let n=Number.parseInt(e[1],10);return Number.isFinite(n)?n:null};var ln=u=>{if(!u)return null;let c=u.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return c?We(c[0]):null};var Xn=(u,c)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),u.type==="sync-start"||u.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(u.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),u.type==="sync-start"?e.textContent=u.docId?`Redis Index Sync start - ${u.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e;if(u.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=u.chunkKind==="page"?"Page end":"Section end",u.chunkKind&&e.classList.add(`zrr-sync-badge--${u.chunkKind}`),e;if(u.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),u.chunkKind&&e.classList.add(`zrr-sync-badge--${u.chunkKind}`),u.excluded&&e.classList.add("is-excluded"),u.pageNumber&&c>0)if(u.chunkKind==="section"){let n=u.chunkId?`Section ${u.chunkId}`:"Section";e.textContent=`${n} (p${u.pageNumber}/${c})`}else e.textContent=`Page ${u.pageNumber}/${c}`;else if(u.pageNumber)if(u.chunkKind==="section"){let n=u.chunkId?`Section ${u.chunkId}`:"Section";e.textContent=`${n} (p${u.pageNumber})`}else e.textContent=`Page ${u.pageNumber}`;else u.chunkId?e.textContent=`Section ${u.chunkId}`:e.textContent="Section";return u.excluded&&(e.textContent=`${e.textContent} - excluded`),e},Je=class extends W.WidgetType{constructor(c,e,n,t,i){super(),this.plugin=c,this.docId=e,this.chunkId=n,this.startLine=t,this.excluded=i}eq(c){return this.docId===c.docId&&this.chunkId===c.chunkId&&this.startLine===c.startLine&&this.excluded===c.excluded}toDOM(){let c=document.createElement("span");c.className="zrr-chunk-toolbar",c.setAttribute("data-chunk-id",this.chunkId);let e=(d,p)=>{d.setAttribute("title",p),d.setAttribute("aria-label",p),d.setAttribute("data-tooltip-position","top")},n=(d,p,_)=>{let g=document.createElement("span");g.className="zrr-chunk-button-icon",(0,un.setIcon)(g,p);let y=document.createElement("span");y.className="zrr-chunk-button-label",y.textContent=_,d.appendChild(g),d.appendChild(y)},t=document.createElement("button");t.type="button",t.className="zrr-chunk-button",n(t,"sparkles","Clean"),e(t,"Clean this chunk with the OCR cleanup model"),t.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),c.appendChild(t);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",n(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),c.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",n(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),c.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",n(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),c.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return n(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),c.appendChild(s),c}ignoreEvent(){return!0}},dn=(u,c)=>{var x;let e=u.state.doc,n=Ee(e);if(!n)return W.Decoration.none;let t=u.state.selection.main.head,i=e.lineAt(t).number,r=an(e,i);if(!r)return W.Decoration.none;let a=r.text.match(ae);if(!a)return W.Decoration.none;let s=((x=a[1])!=null?x:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return W.Decoration.none;let l=o[2].trim();if(!l)return W.Decoration.none;let d=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),p=on(e,r.startLine+1,r.endLine-1),_=d||p,g=e.line(r.startLine),y=W.Decoration.widget({widget:new Je(c,n,l,r.startLine,_),side:1});return W.Decoration.set([y.range(g.to)])},Xe=class extends W.WidgetType{constructor(c,e){super(),this.info=c,this.totalPages=e}toDOM(){var c;return(c=Xn(this.info,this.totalPages))!=null?c:document.createElement("span")}},cn=u=>{var o,l;let c=u.dom.closest(".markdown-source-view");if(!c||!c.classList.contains("is-live-preview"))return W.Decoration.none;let e=u.state.doc,n=new pn.RangeSetBuilder,t=[],i=[],r=!1,a=!1;for(let d=1;d<=e.lines;d+=1){let p=e.line(d),_=p.text.match(/<!--\s*([^>]*)\s*-->/);if(!_)continue;let g=sn(_[1]);g&&(g.type==="chunk-start"?(g.chunkKind=(o=g.chunkKind)!=null?o:g.pageNumber?"page":"section",g.pageNumber&&(r=!0),g.chunkKind==="section"&&(a=!0)):g.type==="chunk-end"&&(g.chunkKind=(l=g.chunkKind)!=null?l:"section"),t.push({line:d,from:p.from,to:p.to,info:g}),g.pageNumber&&i.push(g.pageNumber))}if(!t.length)return W.Decoration.none;if(r&&!a)for(let d of t)d.info.type==="chunk-end"&&(d.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let d of t){let p=W.Decoration.replace({widget:new Xe(d.info,s)});n.add(d.from,d.to,p)}return n.finish()},_n=()=>W.ViewPlugin.fromClass(class{constructor(u){this.decorations=cn(u)}update(u){(u.docChanged||u.viewportChanged)&&(this.decorations=cn(u.view))}},{decorations:u=>u.decorations}),gn=u=>W.ViewPlugin.fromClass(class{constructor(c){this.decorations=dn(c,u)}update(c){(c.docChanged||c.selectionSet||c.viewportChanged)&&(this.decorations=dn(c.view,u))}},{decorations:c=>c.decorations});var Q=require("child_process"),j=require("fs"),zn=ge(require("http")),qn=ge(require("https")),Pe=ge(require("net")),Mn=ge(require("os")),jn=ge(require("tls")),E=ge(require("path")),tn=require("url"),Ue=require("crypto");var N=require("obsidian"),X=".zotero-redisearch-rag",Y=`${X}/items`,V=`${X}/chunks`,fn={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{pdf_block}}{{docling_markdown}}",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,chatPaneLocation:"right",enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"BAAI/bge-reranker-v2-m3",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${X}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Se=class extends N.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async m=>{this.plugin.settings.llmProviderProfiles=m,await this.plugin.saveSettings()},i=m=>{m.inputEl.type="password",m.inputEl.autocomplete="off",m.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:m=>{m.createEl("h2",{text:"Prerequisites"}),new N.Setting(m).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows).").addText(h=>h.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async w=>{this.plugin.settings.pythonPath=w.trim(),await this.plugin.saveSettings()})),new N.Setting(m).setName("Python environment").setDesc("Create or update the plugin's Python env (location configured below).").addButton(h=>{h.setButtonText("Create/Update").setCta(),h.onClick(async()=>{h.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{h.setDisabled(!1)}})}),new N.Setting(m).setName("Python env location").setDesc("Shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(h=>{h.addOption("shared","Shared user cache"),h.addOption("plugin","Plugin folder (.venv)"),h.setValue(this.plugin.settings.pythonEnvLocation).onChange(async w=>{w!=="shared"&&w!=="plugin"||(this.plugin.settings.pythonEnvLocation=w,await this.plugin.saveSettings())})}),new N.Setting(m).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack).").addText(h=>h.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async w=>{this.plugin.settings.dockerPath=w.trim()||"docker",await this.plugin.saveSettings()})),new N.Setting(m).setName("Redis URL").addText(h=>h.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async w=>{this.plugin.settings.redisUrl=w.trim(),await this.plugin.saveSettings()})),new N.Setting(m).setName("Redis data directory override").setDesc("Optional absolute path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting.").addText(h=>h.setPlaceholder("/Users/you/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async w=>{this.plugin.settings.redisDataDirOverride=w.trim(),await this.plugin.saveSettings()})),new N.Setting(m).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(h=>h.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async w=>{this.plugin.settings.redisProjectName=w.trim(),await this.plugin.saveSettings()})),new N.Setting(m).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(h=>h.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async w=>{this.plugin.settings.autoAssignRedisPort=w,await this.plugin.saveSettings()})),new N.Setting(m).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Uses a vault-specific data dir at .obsidian/zotero-redisearch-rag/redis-data unless overridden.").addToggle(h=>h.setValue(this.plugin.settings.autoStartRedis).onChange(async w=>{this.plugin.settings.autoStartRedis=w,await this.plugin.saveSettings()})),new N.Setting(m).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(h=>h.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:m=>{m.createEl("h2",{text:"Zotero Local API"}),new N.Setting(m).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(L=>L.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async C=>{this.plugin.settings.zoteroBaseUrl=C.trim(),await this.plugin.saveSettings()}));let h=new N.Setting(m).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),w=null,P=L=>{if(!w)return;let C=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(L.map(I=>I.value)).has(C)||(L=L.concat([{value:C,label:`Custom (${C})`}])),w.selectEl.options.length=0;for(let I of L)w.addOption(I.value,I.label);w.setValue(C)},S=async()=>{if(w){w.setDisabled(!0);try{let L=await this.plugin.fetchZoteroLibraryOptions();P(L)}finally{w.setDisabled(!1)}}};h.addDropdown(L=>{w=L;let C=(this.plugin.settings.zoteroUserId||"0").trim()||"0";L.addOption(C,"Loading..."),L.setValue(C),L.onChange(async D=>{this.plugin.settings.zoteroUserId=D.trim(),await this.plugin.saveSettings()})}),h.addButton(L=>{L.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),m.createEl("h2",{text:"Zotero Web API"}),new N.Setting(m).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(L=>L.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async C=>{this.plugin.settings.webApiBaseUrl=C.trim(),await this.plugin.saveSettings()})),new N.Setting(m).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(L=>L.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async C=>{this.plugin.settings.webApiLibraryType=C,await this.plugin.saveSettings()})),new N.Setting(m).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(L=>L.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async C=>{this.plugin.settings.webApiLibraryId=C.trim(),await this.plugin.saveSettings()})),new N.Setting(m).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(L=>{i(L),L.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async C=>{this.plugin.settings.webApiKey=C.trim(),await this.plugin.saveSettings()})}),m.createEl("h2",{text:"Output"}),new N.Setting(m).setName("PDF folder").addText(L=>L.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async C=>{this.plugin.settings.outputPdfDir=C.trim(),await this.plugin.saveSettings()})),new N.Setting(m).setName("Notes folder").addText(L=>L.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async C=>{this.plugin.settings.outputNoteDir=C.trim(),await this.plugin.saveSettings()})),new N.Setting(m).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(L=>{L.setValue(this.plugin.settings.frontmatterTemplate).onChange(async C=>{this.plugin.settings.frontmatterTemplate=C,await this.plugin.saveSettings()}),L.inputEl.rows=10,L.inputEl.style.width="100%"}),new N.Setting(m).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(L=>L.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async C=>{this.plugin.settings.tagSanitizeMode=C,await this.plugin.saveSettings()})),new N.Setting(m).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}} and {{docling_markdown}} placeholders.").addTextArea(L=>{L.setValue(this.plugin.settings.noteBodyTemplate).onChange(async C=>{this.plugin.settings.noteBodyTemplate=C,await this.plugin.saveSettings()}),L.inputEl.rows=8,L.inputEl.style.width="100%"}),new N.Setting(m).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(L=>L.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async C=>{this.plugin.settings.chatOutputDir=C.trim()||"zotero/chats",await this.plugin.saveSettings()})),new N.Setting(m).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(L=>L.setValue(this.plugin.settings.copyPdfToVault).onChange(async C=>{this.plugin.settings.copyPdfToVault=C,!C&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new N.Setting(m).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(L=>{let C=this.plugin.settings.copyPdfToVault;L.setValue(C?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!C).onChange(async D=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=D,await this.plugin.saveSettings()})}),new N.Setting(m).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(L=>L.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async C=>{this.plugin.settings.preferObsidianNoteForCitations=C,await this.plugin.saveSettings()}))}},{id:"ocr",label:"OCR",render:m=>{m.createEl("h2",{text:"Docling"});let h=null,w=C=>{if(!h)return;let D=this.plugin.settings.ocrEngine;new Set(C.map(z=>z.value)).has(D)||(C=C.concat([{value:D,label:`Current (unavailable): ${D}`}])),h.selectEl.options.length=0;for(let z of C)h.addOption(z.value,z.label);h.setValue(D)},P=async()=>{if(!h)return;h.setDisabled(!0);let C={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{C=await this.plugin.detectOcrEngines()}catch(z){C={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let D=[{value:"auto",label:"Auto (default)"}];C.tesseract&&D.push({value:"tesseract",label:"Tesseract (local)"}),C.paddleStructureLocal&&D.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),C.paddleVlLocal&&D.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(D.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),D.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),w(D),h.setDisabled(!1)},S=new N.Setting(m).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),L=document.createElement("a");L.href="https://aistudio.baidu.com/paddleocr",L.textContent="https://aistudio.baidu.com/paddleocr",L.target="_blank",L.rel="noopener noreferrer",S.descEl.appendChild(L),S.descEl.append("."),S.addText(C=>{i(C),C.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async D=>{this.plugin.settings.paddleApiKey=D.trim(),await this.plugin.saveSettings(),await P()})}),new N.Setting(m).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(C=>C.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async D=>{this.plugin.settings.paddleVlApiUrl=D.trim(),await this.plugin.saveSettings()})),new N.Setting(m).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(C=>C.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async D=>{this.plugin.settings.paddleStructureApiUrl=D.trim(),await this.plugin.saveSettings(),await P()})),new N.Setting(m).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(C=>{h=C,C.addOption("auto","Auto (default)"),C.setValue(this.plugin.settings.ocrEngine),C.onChange(async D=>{this.plugin.settings.ocrEngine=D,await this.plugin.saveSettings()})}),new N.Setting(m).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(C=>C.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async D=>{this.plugin.settings.ocrMode=D,await this.plugin.saveSettings()})),new N.Setting(m).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(C=>C.setValue(this.plugin.settings.forcePerPageOcr).onChange(async D=>{this.plugin.settings.forcePerPageOcr=D,await this.plugin.saveSettings()})),new N.Setting(m).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(C=>{C.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async D=>{this.plugin.settings.ocrQualityThreshold=D,await this.plugin.saveSettings()})}),new N.Setting(m).setName("Chunking").setDesc("page or section").addDropdown(C=>C.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async D=>{this.plugin.settings.chunkingMode=D,await this.plugin.saveSettings()})),P()}},{id:"llms",label:"LLMs",render:m=>{m.createEl("h2",{text:"LLM Provider Profiles"});let h=m.createDiv({cls:"zrr-llm-profiles"}),w=()=>{h.empty();let k=n();k.length||h.createEl("p",{text:"No profiles yet. Add one below."});for(let b of k){let v=h.createEl("details",{cls:"zrr-profile"});k.length===1&&(v.open=!0);let G=v.createEl("summary",{text:b.name||b.id||"Profile"});G.addClass("zrr-profile-title");let re=v.createDiv({cls:"zrr-profile-body"});new N.Setting(re).setName("Profile name").addText(se=>se.setPlaceholder("My provider").setValue(b.name||"").onChange(async le=>{b.name=le.trim(),G.textContent=b.name||b.id||"Profile",await t(n())})),new N.Setting(re).setName("Base URL").addText(se=>se.setPlaceholder("http://localhost:1234/v1").setValue(b.baseUrl||"").onChange(async le=>{b.baseUrl=le.trim(),await t(n())})),new N.Setting(re).setName("API key").setDesc("Stored in settings (not encrypted).").addText(se=>{i(se),se.setPlaceholder("sk-...").setValue(b.apiKey||"").onChange(async le=>{b.apiKey=le.trim(),await t(n())})}),new N.Setting(re).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(se=>se.setButtonText("Delete profile").onClick(async()=>{let le=n().filter($n=>$n.id!==b.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===b.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===b.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===b.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(le),w()}))}new N.Setting(h).addButton(b=>b.setButtonText("Add profile").onClick(async()=>{let v=`profile-${Date.now().toString(36)}`,G=n().concat([{id:v,name:"Custom",baseUrl:"",apiKey:""}]);await t(G),w()}))};w(),m.createEl("h2",{text:"OCR cleanup"}),new N.Setting(m).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(k=>k.setValue(this.plugin.settings.enableLlmCleanup).onChange(async b=>{this.plugin.settings.enableLlmCleanup=b,await this.plugin.saveSettings()}));let P=null,S=null,L=null,C=async()=>{},D=async(k,b=!0)=>{let v=k.trim();this.plugin.settings.llmCleanupBaseUrl=v,b&&(this.plugin.settings.llmCleanupProviderProfileId="",P&&P.setValue("custom")),S&&S.setValue(v),await this.plugin.saveSettings()},I=async k=>{let b=n().find(v=>v.id===k);this.plugin.settings.llmCleanupProviderProfileId=k,b&&(this.plugin.settings.llmCleanupBaseUrl=b.baseUrl,this.plugin.settings.llmCleanupApiKey=b.apiKey,S==null||S.setValue(b.baseUrl),L==null||L.setValue(b.apiKey)),await this.plugin.saveSettings(),await C()};new N.Setting(m).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{P=k,k.addOption("custom","Custom (manual)");for(let v of n())k.addOption(v.id,v.name||v.id);let b=this.plugin.settings.llmCleanupProviderProfileId;k.setValue(b&&n().some(v=>v.id===b)?b:"custom"),k.onChange(async v=>{if(v==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await I(v)})}),new N.Setting(m).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(k=>{S=k,k.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async b=>{await D(b)})}),new N.Setting(m).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(k=>{L=k,i(k),k.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async b=>{this.plugin.settings.llmCleanupApiKey=b.trim(),this.plugin.settings.llmCleanupProviderProfileId="",P&&P.setValue("custom"),await this.plugin.saveSettings()})});let z=new N.Setting(m).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),R=null,F=k=>{if(!R)return;let b=(this.plugin.settings.llmCleanupModel||"").trim(),v=new Set(k.map(G=>G.value));b&&!v.has(b)&&(k=k.concat([{value:b,label:`Custom (${b})`}])),R.selectEl.options.length=0;for(let G of k)R.addOption(G.value,G.label);b&&R.setValue(b)};C=async()=>{if(R){R.setDisabled(!0);try{let k=await this.plugin.fetchCleanupModelOptions();F(k)}finally{R.setDisabled(!1)}}},z.addDropdown(k=>{R=k;let b=(this.plugin.settings.llmCleanupModel||"").trim();k.addOption(b||"loading","Loading..."),k.setValue(b||"loading"),k.onChange(async v=>{this.plugin.settings.llmCleanupModel=v.trim(),await this.plugin.saveSettings()})}),z.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await C()})}),C(),new N.Setting(m).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(k=>k.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async b=>{let v=Number.parseFloat(b);this.plugin.settings.llmCleanupTemperature=Number.isFinite(v)?v:0,await this.plugin.saveSettings()})),new N.Setting(m).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(k=>k.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async b=>{this.plugin.settings.llmCleanupMinQuality=b,await this.plugin.saveSettings()})),new N.Setting(m).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(k=>k.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async b=>{let v=Number.parseInt(b,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(v)?v:2e3,await this.plugin.saveSettings()})),m.createEl("h2",{text:"Text Embedding"});let O=null,$=null,J=null,T=async()=>{},M=async(k,b=!0)=>{let v=k.trim();this.plugin.settings.embedBaseUrl=v,b&&(this.plugin.settings.embedProviderProfileId="",O&&O.setValue("custom")),$&&$.setValue(v),await this.plugin.saveSettings()},H=async k=>{let b=n().find(v=>v.id===k);this.plugin.settings.embedProviderProfileId=k,b&&(this.plugin.settings.embedBaseUrl=b.baseUrl,this.plugin.settings.embedApiKey=b.apiKey,$==null||$.setValue(b.baseUrl),J==null||J.setValue(b.apiKey)),await this.plugin.saveSettings(),await T()};new N.Setting(m).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{O=k,k.addOption("custom","Custom (manual)");for(let v of n())k.addOption(v.id,v.name||v.id);let b=this.plugin.settings.embedProviderProfileId;k.setValue(b&&n().some(v=>v.id===b)?b:"custom"),k.onChange(async v=>{if(v==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await H(v)})}),new N.Setting(m).setName("Embeddings base URL").addText(k=>{$=k,k.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async b=>{await M(b)})}),new N.Setting(m).setName("Embeddings API key").addText(k=>{J=k,i(k),k.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async b=>{this.plugin.settings.embedApiKey=b.trim(),this.plugin.settings.embedProviderProfileId="",O&&O.setValue("custom"),await this.plugin.saveSettings()})});let Z=new N.Setting(m).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),K=null,pe=k=>{if(!K)return;let b=(this.plugin.settings.embedModel||"").trim(),v=new Set(k.map(G=>G.value));b&&!v.has(b)&&(k=k.concat([{value:b,label:`Custom (${b})`}])),K.selectEl.options.length=0;for(let G of k)K.addOption(G.value,G.label);b&&K.setValue(b)};T=async()=>{if(K){K.setDisabled(!0);try{let k=await this.plugin.fetchEmbeddingModelOptions();pe(k)}finally{K.setDisabled(!1)}}},Z.addDropdown(k=>{K=k;let b=(this.plugin.settings.embedModel||"").trim();k.addOption(b||"loading","Loading..."),k.setValue(b||"loading"),k.onChange(async v=>{this.plugin.settings.embedModel=v.trim(),await this.plugin.saveSettings()})}),Z.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await T()})}),T(),new N.Setting(m).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(k=>k.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async b=>{this.plugin.settings.embedIncludeMetadata=b,await this.plugin.saveSettings()})),new N.Setting(m).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(k=>k.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async b=>{let v=Number.parseInt(b,10);this.plugin.settings.embedContextWindow=Number.isFinite(v)?Math.max(0,v):1,await this.plugin.saveSettings()})),new N.Setting(m).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(k=>k.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async b=>{let v=Number.parseInt(b,10);this.plugin.settings.embedContextChars=Number.isFinite(v)?Math.max(0,v):220,await this.plugin.saveSettings()})),new N.Setting(m).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(k=>k.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async b=>{let v=Number.parseInt(b,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(v)?Math.max(0,v):3500,await this.plugin.saveSettings()})),new N.Setting(m).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(k=>k.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async b=>{let v=Number.parseInt(b,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(v)?Math.max(0,v):200,await this.plugin.saveSettings()})),new N.Setting(m).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(k=>k.setValue(this.plugin.settings.enableChunkTagging).onChange(async b=>{this.plugin.settings.enableChunkTagging=b,await this.plugin.saveSettings()})),m.createEl("h2",{text:"Chat LLM"});let oe=null,ie=null,ue=null,_e=async()=>{},Ze=async(k,b=!0)=>{let v=k.trim();this.plugin.settings.chatBaseUrl=v,b&&(this.plugin.settings.chatProviderProfileId="",oe&&oe.setValue("custom")),ie&&ie.setValue(v),await this.plugin.saveSettings()},He=async k=>{let b=n().find(v=>v.id===k);this.plugin.settings.chatProviderProfileId=k,b&&(this.plugin.settings.chatBaseUrl=b.baseUrl,this.plugin.settings.chatApiKey=b.apiKey,ie==null||ie.setValue(b.baseUrl),ue==null||ue.setValue(b.apiKey)),await this.plugin.saveSettings(),await _e()};new N.Setting(m).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{oe=k,k.addOption("custom","Custom (manual)");for(let v of n())k.addOption(v.id,v.name||v.id);let b=this.plugin.settings.chatProviderProfileId;k.setValue(b&&n().some(v=>v.id===b)?b:"custom"),k.onChange(async v=>{if(v==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await He(v)})}),new N.Setting(m).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(k=>{ie=k,k.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async b=>{await Ze(b)})}),new N.Setting(m).setName("Chat API key").addText(k=>{ue=k,i(k),k.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async b=>{this.plugin.settings.chatApiKey=b.trim(),this.plugin.settings.chatProviderProfileId="",oe&&oe.setValue("custom"),await this.plugin.saveSettings()})});let Ce=new N.Setting(m).setName("Chat model").setDesc("Select a chat-capable model from the provider."),ne=null,xe=k=>{if(!ne)return;let b=(this.plugin.settings.chatModel||"").trim(),v=new Set(k.map(G=>G.value));b&&!v.has(b)&&(k=k.concat([{value:b,label:`Custom (${b})`}])),ne.selectEl.options.length=0;for(let G of k)ne.addOption(G.value,G.label);b&&ne.setValue(b)};_e=async()=>{if(ne){ne.setDisabled(!0);try{let k=await this.plugin.fetchChatModelOptions();xe(k)}finally{ne.setDisabled(!1)}}},Ce.addDropdown(k=>{ne=k;let b=(this.plugin.settings.chatModel||"").trim();k.addOption(b||"loading","Loading..."),k.setValue(b||"loading"),k.onChange(async v=>{this.plugin.settings.chatModel=v.trim(),await this.plugin.saveSettings()})}),Ce.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await _e()})}),_e(),new N.Setting(m).setName("Temperature").addText(k=>k.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async b=>{let v=Number.parseFloat(b);this.plugin.settings.chatTemperature=Number.isFinite(v)?v:.2,await this.plugin.saveSettings()})),new N.Setting(m).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(k=>k.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async b=>{let v=Number.parseInt(b,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(v)?Math.max(0,v):6,await this.plugin.saveSettings()})),new N.Setting(m).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(k=>k.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async b=>{this.plugin.settings.chatPaneLocation=b,await this.plugin.saveSettings()})),m.createEl("h2",{text:"Retrieval"}),new N.Setting(m).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(k=>k.setValue(this.plugin.settings.enableQueryExpansion).onChange(async b=>{this.plugin.settings.enableQueryExpansion=b,await this.plugin.saveSettings()})),new N.Setting(m).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(k=>k.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async b=>{let v=Number.parseInt(b,10);this.plugin.settings.queryExpansionCount=Number.isFinite(v)?Math.max(1,v):3,await this.plugin.saveSettings()})),new N.Setting(m).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(k=>k.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async b=>{this.plugin.settings.enableCrossEncoderRerank=b,await this.plugin.saveSettings()})),new N.Setting(m).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(k=>k.setPlaceholder("BAAI/bge-reranker-v2-m3").setValue(this.plugin.settings.rerankModel).onChange(async b=>{this.plugin.settings.rerankModel=b.trim()||"BAAI/bge-reranker-v2-m3",await this.plugin.saveSettings()})),new N.Setting(m).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(k=>k.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async b=>{let v=Number.parseInt(b,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(v)?Math.max(1,v):4,await this.plugin.saveSettings()})),new N.Setting(m).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(k=>k.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async b=>{let v=Number.parseInt(b,10);this.plugin.settings.rrfK=Number.isFinite(v)?Math.max(1,v):60,await this.plugin.saveSettings()})),new N.Setting(m).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(k=>k.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async b=>{let v=Number.parseInt(b,10);this.plugin.settings.rrfLogTop=Number.isFinite(v)?Math.max(0,v):0,await this.plugin.saveSettings()})),new N.Setting(m).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(k=>k.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async b=>{let v=Number.parseInt(b,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(v)?Math.max(0,v):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:m=>{m.createEl("h2",{text:"Logging"}),new N.Setting(m).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(h=>h.setValue(this.plugin.settings.enableFileLogging).onChange(async w=>{this.plugin.settings.enableFileLogging=w,await this.plugin.saveSettings()})),new N.Setting(m).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(h=>h.setPlaceholder(`${X}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async w=>{this.plugin.settings.logFilePath=w.trim()||`${X}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new N.Setting(m).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(h=>h.setButtonText("Open log").onClick(async()=>{var w,P;await((P=(w=this.plugin).openLogFile)==null?void 0:P.call(w))})).addButton(h=>h.setButtonText("Clear log").onClick(async()=>{var w,P;await((P=(w=this.plugin).clearLogFile)==null?void 0:P.call(w))})),m.createEl("h2",{text:"Maintenance"}),new N.Setting(m).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(h=>h.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new N.Setting(m).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(h=>h.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(h=>h.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],p=new Map,_=new Map,g=m=>{this.activeTab=m;for(let[h,w]of p){let P=h===m;w.classList.toggle("is-active",P),w.setAttribute("aria-selected",P?"true":"false"),w.setAttribute("tabindex",P?"0":"-1")}for(let[h,w]of _){let P=h===m;w.classList.toggle("is-active",P),w.hidden=!P}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let x=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let m of d){let h=y.createEl("button",{text:m.label,cls:"zrr-settings-tab-button"}),w=`zrr-settings-tab-${m.id}`,P=`zrr-settings-panel-${m.id}`;h.type="button",h.id=w,h.setAttribute("role","tab"),h.setAttribute("aria-controls",P),h.setAttribute("aria-selected","false"),h.addEventListener("click",()=>g(m.id));let S=x.createDiv({cls:"zrr-settings-tab-panel"});S.id=P,S.setAttribute("role","tabpanel"),S.setAttribute("aria-labelledby",w),S.hidden=!0,m.render(S),p.set(m.id,h),_.set(m.id,S)}let A=d.some(m=>m.id===this.activeTab)?this.activeTab:d[0].id;g(A)}};var mn=require("@codemirror/state"),hn=require("@codemirror/view"),te=require("obsidian");var Yn=u=>{let c=u.scrollDOM.getBoundingClientRect(),e=u.posAtCoords({x:c.left+8,y:+c.height*.25});return e===null?null:u.state.doc.lineAt(e).number},Ne=class{constructor(c,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.deps=c,this.helpers=e}createSyncExtension(){let c=this,e=this.helpers;return hn.ViewPlugin.fromClass(class{constructor(n){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=n,this.docId=e.extractDocIdFromDoc(n.state.doc),this.onScroll=()=>this.scheduleSync(!1),n.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(n){n.docChanged&&(this.docId=e.extractDocIdFromDoc(n.view.state.doc),this.lastPage=null,this.lastChunkId=null),(n.docChanged||n.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(n){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,n)}))}syncPdfSidebar(n,t){var _,g;let i=this.docId;if(!i)return;let r=Yn(n);if(r===null)return;let a=e.findChunkStartLineInDoc(n.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(_=s==null?void 0:s.pageNumber)!=null?_:null,l=(g=s==null?void 0:s.chunkId)!=null?g:null;if(!o&&!l)return;let d=o!==null&&this.lastPage===o,p=o===null&&l!==null&&this.lastChunkId===l;!t&&(d||p)||(this.lastPage=o,this.lastChunkId=l,c.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,n;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((n=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:n.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let c=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(c.docId,c.pageNumber,c.chunkId)}updatePreviewScrollHandler(){var t;let c=this.deps.app.workspace.getActiveViewOfType(te.MarkdownView);if(!c||c.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(t=c.previewMode)==null?void 0:t.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let n=()=>this.schedulePreviewSync(c);e.addEventListener("scroll",n,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=n,this.schedulePreviewSync(c)}async syncPdfSidebarForFile(c){try{let e=await this.deps.app.vault.read(c),n=await this.deps.resolveDocIdForNote(c,e);if(!n)return;let t=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(n,t==null?void 0:t.pageNumber,t==null?void 0:t.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(c,e,n){if(!c)return;let t=await this.deps.getDocIndexEntry(c);t||(t=await this.deps.hydrateDocIndexFromCache(c));let i=t!=null&&t.pdf_path?String(t.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let g=(0,te.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(g)instanceof te.TFile&&(r=g)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof te.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:c,pageNumber:e,chunkId:n};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:c,pageNumber:e,chunkId:n};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&n&&(o=await this.resolvePageNumberForChunk(c,n)),o===null||this.pdfSidebarDocId===c&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=c,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,d=o!==null?`${l}#page=${o}`:l,p=this.deps.app.workspace,_=p.getMostRecentLeaf();p.setActiveLeaf(s,{focus:!1});try{await this.openPdfLinkInLeaf(s,d),this.updatePdfSidebarIcon(s)}finally{_&&p.setActiveLeaf(_,{focus:!1})}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(c){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(c)}))}syncPdfSidebarForPreview(c){let e=this.previewScrollEl;if(!e)return;let n=c.getViewData();if(!n)return;let t=mn.Text.of(n.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(t);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(t,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(c){var t;let e=c.getBoundingClientRect().top,n=c.querySelectorAll("[data-line]");for(let i of Array.from(n))if(i.getBoundingClientRect().bottom>=e+2){let a=(t=i.getAttribute("data-line"))!=null?t:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var t,i;if(this.pdfSidebarLeaf&&((i=(t=this.pdfSidebarLeaf.view)==null?void 0:t.getViewType)==null?void 0:i.call(t))==="pdf")return this.pdfSidebarLeaf;let c=this.deps.app.workspace;if(typeof c.ensureSideLeaf=="function")try{let r=await c.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let n=this.deps.app.workspace.getRightLeaf(!0);return n&&this.isRightSidebarLeaf(n)?(this.pdfSidebarLeaf=n,this.updatePdfSidebarIcon(n),n):null}isRightSidebarLeaf(c){if(!c)return!1;let n=c.containerEl;return!!(n!=null&&n.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(c){if(!c||!this.isRightSidebarLeaf(c))return;let n=c.containerEl,t=[];n&&t.push(...Array.from(n.querySelectorAll(".view-header-icon")));let i=c;if(i.tabHeaderEl&&t.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&t.push(i.tabHeaderInnerIconEl),t.length===0)return;let r=new Set;for(let s of t)r.has(s)||(r.add(s),s.innerHTML="",(0,te.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=c.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(c,e){var r,a,s;let n=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],t=(s=(a=n==null?void 0:n.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof t=="function"){await t.call(n.lib.workspace,c,e,"",{active:!1});return}let i=c;if(typeof i.openLinkText=="function"){await i.openLinkText(e,"",{active:!1});return}await this.deps.app.workspace.openLinkText(e,"",!1)}getPluginsRegistry(){var c;return(c=this.deps.app.plugins)==null?void 0:c.plugins}isLeafTabActive(c){var i;let e=c;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===c;let n=e.containerEl;if(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))return!0;let t=e.tabHeaderEl;return!!(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))}async resolvePageNumberForChunk(c,e){var l,d,p,_,g;if(!c||!e)return null;let n=this.deps.normalizeChunkIdForNote(e,c)||e,t=this.chunkPageCache.get(c);if(t&&t.has(n))return(l=t.get(n))!=null?l:null;let i=(0,te.normalizePath)(`${V}/${c}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let y of s){let x=typeof(y==null?void 0:y.chunk_id)=="string"?y.chunk_id.trim():"";if(!x)continue;let A=Number.isFinite((d=y==null?void 0:y.page_start)!=null?d:NaN)?Number(y.page_start):null,m=Number.isFinite((p=y==null?void 0:y.page_end)!=null?p:NaN)?Number(y.page_end):null,h=A!=null?A:m;h!==null&&(o.set(x,h),o.set(`${c}:${x}`,h))}return this.chunkPageCache.set(c,o),(g=(_=o.get(n))!=null?_:o.get(e))!=null?g:null}};var Re={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var ce=require("@codemirror/state"),ee=require("@codemirror/view"),U=require("obsidian");var q=u=>{if(typeof u=="string")return u.trim();if(typeof u=="number"&&Number.isFinite(u))return String(u);if(Array.isArray(u))for(let c of u){if(typeof c=="string"&&c.trim())return c.trim();if(typeof c=="number"&&Number.isFinite(c))return String(c)}if(u&&typeof u=="object"){let c=u[0];if(typeof c=="string"&&c.trim())return c.trim();if(typeof c=="number"&&Number.isFinite(c))return String(c)}return""},yn=u=>{let c=[u.key,u.itemKey,u.id,u.citationKey];for(let e of c)if(typeof e=="string"&&e.trim())return e.trim();return null},bn=u=>{var e,n,t;let c=(t=(n=u.key)!=null?n:(e=u.data)==null?void 0:e.key)!=null?t:"";return typeof c=="string"?c:""},Ye=u=>{if(!u)return"";let c=u.match(/\b(\d{4})\b/);return c?c[1]:""},xn=u=>{var e,n,t,i;let c=(i=(t=(e=u.meta)==null?void 0:e.parsedDate)!=null?t:(n=u.data)==null?void 0:n.date)!=null?i:"";return typeof c!="string"?"":Ye(c)},me=u=>{if(!u||typeof u!="object")return"";if(u.name)return String(u.name);let c=u.firstName?String(u.firstName):"",e=u.lastName?String(u.lastName):"";return[e,c].filter(Boolean).join(", ")||`${c} ${e}`.trim()},kn=(u,c)=>{let e=[c==null?void 0:c["citation-key"],c==null?void 0:c.citationKey,c==null?void 0:c.citationkey,c==null?void 0:c.citekey,c==null?void 0:c.citeKey,c==null?void 0:c.betterBibtexKey,c==null?void 0:c.betterbibtexkey,u["citation-key"],u.citationKey,u.citationkey,u.citekey,u.citeKey,u.betterBibtexKey,u.betterbibtexkey];for(let i of e){let r=q(i);if(r)return r}let n=typeof u.extra=="string"?u.extra:"";if(!n)return"";let t=n.split(/\r?\n/);for(let i of t){let r=i.match(/^\s*biblatexcitekey\s*\[([^\]]+)\]\s*$/i);if(r&&r[1])return r[1].trim();let a=i.match(/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:\s*(.+)\s*$/i);if(a&&a[2])return a[2].trim()}return""},vn=u=>{if(!u)return"";let c=[u["citation-key"],u.citationKey,u.citationkey,u.citekey,u.citation_key];for(let e of c){let n=q(e);if(n)return n}return""},wn=u=>{var e,n;if(!u)return"";let c=(n=(e=u["title-short"])!=null?e:u.shortTitle)!=null?n:u.short_title;return typeof c=="string"?c.trim():""},he=u=>{let c=q(u.shortTitle);if(c)return c;let e=q(u.short_title);if(e)return e;let n=q(u["title-short"]);return n||""},Pn=u=>{let c=typeof u.extra=="string"?u.extra:"";if(!c)return"";let e=c.split(/\r?\n/);for(let t of e){let i=t.match(/^\s*doi\s*:\s*(.+)\s*$/i);if(i&&i[1])return i[1].trim().replace(/[.,;]+$/,"")}let n=c.match(/\b10\.\d{4,9}\/[-._;()/:A-Z0-9]+\b/i);return n?n[0].replace(/[.,;]+$/,""):""},Cn=u=>{var e;if(!u)return"";let c=(e=u.DOI)!=null?e:u.doi;return typeof c=="string"?c.trim().replace(/[.,;]+$/,""):""},Qn=u=>{if(!u)return[];let c=[u.attachments,u.children,u.items,u.attachment,u.allAttachments],e=[];for(let n of c)n&&(Array.isArray(n)?e.push(...n):typeof n=="object"&&e.push(n));return e},et=u=>{var n,t,i,r,a,s,o,l,d,p,_,g,y,x,A;if(((s=(a=(i=(n=u==null?void 0:u.contentType)!=null?n:u==null?void 0:u.mimeType)!=null?i:(t=u==null?void 0:u.data)==null?void 0:t.contentType)!=null?a:(r=u==null?void 0:u.data)==null?void 0:r.mimeType)!=null?s:"")==="application/pdf")return!0;let e=(A=(x=(g=(_=(d=(o=u==null?void 0:u.filename)!=null?o:u==null?void 0:u.fileName)!=null?d:(l=u==null?void 0:u.data)==null?void 0:l.filename)!=null?_:(p=u==null?void 0:u.data)==null?void 0:p.fileName)!=null?g:u==null?void 0:u.path)!=null?x:(y=u==null?void 0:u.data)==null?void 0:y.path)!=null?A:"";return!!(typeof e=="string"&&e.toLowerCase().endsWith(".pdf"))},Ln=u=>{var n;let c=Qn(u.data);if(c.length>0)return c.some(i=>et(i))?"yes":"no";let e=(n=u.meta)==null?void 0:n.numChildren;return typeof e=="number"&&e===0?"no":"unknown"};var An=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],nt=u=>u.includes("STDERR")?"zrr-log-stderr":u.includes("ERROR")?"zrr-log-error":u.includes("WARNING")||u.includes("WARN")?"zrr-log-warning":u.includes("INFO")?"zrr-log-info":null,En=u=>{let c=new ce.RangeSetBuilder;for(let{from:e,to:n}of u.visibleRanges){let t=e;for(;t<=n;){let i=u.state.doc.lineAt(t),r=nt(i.text);r&&c.add(i.from,i.from,ee.Decoration.line({class:r})),t=i.to+1}}return c.finish()},Sn=ee.EditorView.theme({".cm-editor":{height:"100%",display:"flex",flexDirection:"column",minHeight:"0"},".cm-scroller":{fontFamily:"var(--font-monospace)",fontSize:"0.85rem",flex:"1",height:"100%",maxHeight:"100%",overflow:"auto"},".zrr-log-error":{color:"var(--text-error)"},".zrr-log-warning":{color:"var(--text-accent)"},".zrr-log-info":{color:"var(--text-muted)"},".zrr-log-stderr":{color:"var(--text-accent)"}}),Nn=ee.ViewPlugin.fromClass(class{constructor(u){this.decorations=En(u)}update(u){(u.docChanged||u.viewportChanged)&&(this.decorations=En(u.view))}},{decorations:u=>u.decorations}),ve=class extends U.Modal{constructor(c,e,n,t,i="Value cannot be empty."){super(c),this.titleText=e,this.placeholder=n,this.onSubmit=t,this.emptyMessage=i}onOpen(){let{contentEl:c}=this;c.empty(),c.createEl("h3",{text:this.titleText});let e=c.createEl("input",{type:"text",placeholder:this.placeholder});e.style.width="100%",e.focus();let n=c.createEl("button",{text:"Submit"});n.style.marginTop="0.75rem";let t=()=>{let i=e.value.trim();if(!i){new U.Notice(this.emptyMessage);return}this.close(),this.onSubmit(i)};n.addEventListener("click",t),e.addEventListener("keydown",i=>{i.key==="Enter"&&t()})}},De=class extends U.Modal{constructor(c,e,n,t,i){super(c),this.chunkId=e,this.initialTags=n,this.onSubmit=t,this.onRegenerate=i}onOpen(){let{contentEl:c}=this;c.empty(),c.createEl("h3",{text:`Edit tags for ${this.chunkId}`});let e=c.createEl("textarea",{attr:{rows:"3"}});e.style.width="100%",e.placeholder="tag1, tag2, tag3",e.value=this.initialTags.join(", "),e.focus();let n=c.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Save tags"}),i=async()=>{let a=(e.value||"").split(/[,;\n]+/).map(o=>o.trim()).filter(o=>o.length>0),s=Array.from(new Set(a));this.close(),await Promise.resolve(this.onSubmit(s))};if(this.onRegenerate){let r=n.createEl("button",{text:"Regenerate"});r.addEventListener("click",async()=>{var a;r.setAttribute("disabled","true"),t.setAttribute("disabled","true");try{let s=await((a=this.onRegenerate)==null?void 0:a.call(this));s&&s.length>0?(e.value=s.join(", "),await Promise.resolve(this.onSubmit(s))):s&&new U.Notice("No tags were generated.")}finally{r.removeAttribute("disabled"),t.removeAttribute("disabled")}})}t.addEventListener("click",i),e.addEventListener("keydown",r=>{r.key==="Enter"&&(r.metaKey||r.ctrlKey)&&i()})}},Te=class extends U.Modal{constructor(c,e,n,t=""){super(c),this.titleText=e,this.content=n,this.noteText=t}onOpen(){let{contentEl:c}=this;if(c.empty(),c.createEl("h3",{text:this.titleText}),this.noteText){let n=c.createEl("div",{text:this.noteText});n.className="zrr-indexed-note"}let e=c.createEl("textarea",{attr:{rows:"12",readonly:"true"}});e.style.width="100%",e.value=this.content}},Oe=class extends U.Modal{constructor(e,n,t=""){super(e);this.bodyText="";this.plugin=n,this.initialTerm=t}onOpen(){let{contentEl:e}=this;e.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),e.style.display="flex",e.style.flexDirection="column",e.style.height="100%",e.style.overflow="hidden",e.style.minHeight="0";let n=e.createDiv();n.style.display="flex",n.style.alignItems="center",n.style.justifyContent="space-between",n.style.gap="0.5rem",n.createEl("h3",{text:"Redis index search"});let t=n.createEl("button",{text:"Copy All"});t.style.marginLeft="auto",t.addEventListener("click",()=>{this.copyResultsToClipboard()});let i=e.createDiv();i.style.display="flex",i.style.alignItems="center",i.style.gap="0.5rem",i.style.margin="0.5rem 0";let r=i.createEl("input");r.type="text",r.placeholder="Search term",r.value=this.initialTerm,r.style.flex="1",r.style.minWidth="0",this.inputEl=r,i.createEl("button",{text:"Search"}).addEventListener("click",()=>{this.runSearch()}),r.addEventListener("keydown",d=>{d.key==="Enter"&&(d.preventDefault(),this.runSearch())});let s=e.createDiv();s.style.color="var(--text-muted)",s.style.marginBottom="0.5rem",this.statusEl=s;let o=e.createDiv();o.style.flex="1 1 0",o.style.minHeight="0",o.style.border="1px solid var(--background-modifier-border)",o.style.borderRadius="6px",o.style.display="flex",o.style.flexDirection="column",o.style.overflow="auto";let l=ce.EditorState.create({doc:this.bodyText,extensions:[Sn,Nn,ee.EditorView.editable.of(!1),ce.EditorState.readOnly.of(!0),ee.EditorView.lineWrapping]});this.editorView=new ee.EditorView({state:l,parent:o}),this.initialTerm&&this.runSearch()}onClose(){var e;(e=this.editorView)==null||e.destroy(),this.editorView=void 0}async runSearch(){var t;let e=(((t=this.inputEl)==null?void 0:t.value)||"").trim();if(!e){this.statusEl&&(this.statusEl.textContent="Enter a search term.");return}this.statusEl&&(this.statusEl.textContent="Searching...");let n=await this.plugin.runRedisSearch(e);this.updateEditor(n),this.statusEl&&(this.statusEl.textContent=`Results for "${e}"`)}updateEditor(e){if(!this.editorView)return;let n=this.editorView,t=n.scrollDOM.scrollTop,i=n.state.selection.main,r=e.length,a=Math.min(i.anchor,r),s=Math.min(i.head,r);n.dispatch({changes:{from:0,to:n.state.doc.length,insert:e},selection:{anchor:a,head:s}}),n.scrollDOM.scrollTop=t,this.bodyText=e}copyResultsToClipboard(){let e=this.bodyText||"";if(!e){new U.Notice("Nothing to copy.");return}navigator.clipboard.writeText(e).then(()=>new U.Notice("Results copied to clipboard.")).catch(()=>new U.Notice("Failed to copy results."))}},ye=class extends U.Modal{constructor(c,e,n,t){super(c),this.titleText=e,this.bodyText=n,this.options=t}onOpen(){var r,a,s,o;let{contentEl:c}=this;c.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),c.style.display="flex",c.style.flexDirection="column",c.style.height="100%",c.style.overflow="hidden",c.style.minHeight="0";let e=c.createDiv();e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="space-between",e.style.gap="0.5rem",e.createEl("h3",{text:this.titleText});let n=e.createDiv();if(n.style.display="flex",n.style.gap="0.5rem",(r=this.options)!=null&&r.onClear){let l=(a=this.options.clearLabel)!=null?a:"Clear log";n.createEl("button",{text:l}).addEventListener("click",async()=>{var p,_;try{await((_=(p=this.options)==null?void 0:p.onClear)==null?void 0:_.call(p))}finally{await this.refreshFromSource()}})}let t=c.createDiv();t.style.flex="1 1 0",t.style.minHeight="0",t.style.border="1px solid var(--background-modifier-border)",t.style.borderRadius="6px",t.style.display="flex",t.style.flexDirection="column",t.style.overflow="auto";let i=ce.EditorState.create({doc:this.bodyText,extensions:[Sn,Nn,ee.EditorView.editable.of(!0),ce.EditorState.readOnly.of(!1),ee.EditorView.lineWrapping]});if(this.editorView=new ee.EditorView({state:i,parent:t}),this.refreshFromSource(),(s=this.options)!=null&&s.autoRefresh&&this.options.onRefresh){let l=(o=this.options.refreshIntervalMs)!=null?o:2e3;this.refreshTimer=window.setInterval(()=>{this.refreshFromSource()},l)}}onClose(){var c;this.refreshTimer!==void 0&&(window.clearInterval(this.refreshTimer),this.refreshTimer=void 0),(c=this.editorView)==null||c.destroy(),this.editorView=void 0}async refreshFromSource(){var s;if(!((s=this.options)!=null&&s.onRefresh)||!this.editorView)return;let c="";try{c=await this.options.onRefresh()||""}catch(o){return}if(c===this.bodyText)return;let e=this.editorView,n=e.scrollDOM.scrollTop,t=e.state.selection.main,i=c.length,r=Math.min(t.anchor,i),a=Math.min(t.head,i);e.dispatch({changes:{from:0,to:e.state.doc.length,insert:c},selection:{anchor:r,head:a}}),e.scrollDOM.scrollTop=n,this.bodyText=c}},Ie=class extends U.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.filePath=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Overwrite"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Fe=class extends U.Modal{constructor(e,n,t,i){super(e);this.resolved=!1;this.notePath=n,this.docId=t,this.onResolve=i}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete note and cached data?"}),e.createEl("p",{text:`This will delete the note and cached chunks/items for doc_id ${this.docId}.`}),e.createEl("p",{text:`Note: ${this.notePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Delete"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},ze=class extends U.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.reason=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Rebuild Redis index?"}),e.createEl("p",{text:this.reason}),e.createEl("p",{text:"This will drop the RedisSearch index (and embeddings) and rebuild it from cached chunks."});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Drop & rebuild"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},qe=class extends U.Modal{constructor(e,n){super(e);this.resolved=!1;this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Purge Redis orphaned chunks?"}),e.createEl("p",{text:"This removes Redis chunk keys that have no cached item.json or chunk.json on disk."}),e.createEl("p",{text:"Cache files are not deleted. Use this to clean up stale Redis data."});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Purge orphans"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Me=class extends U.Modal{constructor(e,n,t,i,r,a,s){super(e);this.resolved=!1;this.fieldLabel=n,this.noteLabel=t,this.zoteroLabel=i,this.noteValue=r,this.zoteroValue=a,this.onResolve=s}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:`Resolve metadata conflict: ${this.fieldLabel}`});let n=e.createEl("div");n.style.display="grid",n.style.gap="0.5rem",n.createEl("div",{text:"Note value"});let t=n.createEl("textarea",{attr:{readonly:"true",rows:"4"}});t.style.width="100%",t.value=this.noteValue||"(empty)",n.createEl("div",{text:"Zotero value"});let i=n.createEl("textarea",{attr:{readonly:"true",rows:"4"}});i.style.width="100%",i.value=this.zoteroValue||"(empty)";let r=e.createEl("div");r.style.display="flex",r.style.gap="0.5rem",r.style.marginTop="0.75rem";let a=r.createEl("button",{text:this.noteLabel}),s=r.createEl("button",{text:this.zoteroLabel}),o=r.createEl("button",{text:"Skip"});a.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("note")}),s.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("zotero")}),o.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("skip")})}onClose(){this.resolved||this.onResolve("skip")}},je=class extends U.SuggestModal{constructor(e,n){super(e);this.resolved=!1;this.resolveSelection=n,this.setPlaceholder("Select a language for OCR/quality...")}getSuggestions(e){let n=e.trim().toLowerCase();return n?An.filter(t=>t.label.toLowerCase().includes(n)||t.value.toLowerCase().includes(n)):An}renderSuggestion(e,n){n.setText(e.label),n.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new ve(this.app,"Custom language hint","e.g., en, de, fr, de,en",n=>this.resolveSelection(n.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},$e=class extends U.SuggestModal{constructor(e,n,t){super(e);this.lastError=null;this.indexedDocIds=null;this.attachmentStatusCache=new Map;this.attachmentChecks=new Set;this.plugin=n,this.resolveSelection=t,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){try{if(!this.indexedDocIds){let n=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(n))}return await this.plugin.searchZoteroItems(e)}catch(n){let t=n instanceof Error?n.message:String(n);return this.lastError!==t&&(this.lastError=t,new U.Notice(t)),console.error("Zotero search failed",n),[]}}renderSuggestion(e,n){var p,_,g;let t=(_=(p=e.data)==null?void 0:p.title)!=null?_:"[No title]",i=xn(e),r=bn(e),a=r?(g=this.indexedDocIds)==null?void 0:g.has(r):!1,s=Ln(e);a&&n.addClass("zrr-indexed-item"),s==="no"&&n.addClass("zrr-no-pdf-item"),n.createEl("div",{text:t});let o=n.createEl("small"),l=!1,d=()=>{l&&o.createSpan({text:" - "})};if(i&&(o.createSpan({text:i}),l=!0),a&&(d(),o.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),l=!0),s==="no"&&(d(),o.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),l=!0),s==="unknown"){let y=r?this.attachmentStatusCache.get(r):void 0;y==="no"?(d(),o.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),l=!0,n.addClass("zrr-no-pdf-item")):y==="yes"||r&&this.refreshAttachmentStatus(r,e,n,o)}n.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,n){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}async refreshAttachmentStatus(e,n,t,i){if(!this.attachmentChecks.has(e)){this.attachmentChecks.add(e);try{let r=await this.plugin.hasProcessableAttachment(n);this.attachmentStatusCache.set(e,r?"yes":"no"),!r&&i.isConnected&&t.isConnected&&(i.querySelector(".zrr-no-pdf-flag")||(i.childNodes.length>0&&i.createSpan({text:" - "}),i.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"})),t.addClass("zrr-no-pdf-item"))}finally{this.attachmentChecks.delete(e)}}}};var Rn={"docling_extract.py":`#!/usr/bin/env python3
# zotero-redisearch-rag tool version: 0.4.7
import argparse
import atexit
import base64
import errno
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.4.7
aai
aam
abb
abge
...
\xF6pnv
\xFCberarb
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.4.7
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.4.7
services:
  redis-stack:
...
`,"redis-stack.conf":`# zotero-redisearch-rag tool version: 0.4.7
# Redis Stack persistence config for local RAG index
appendonly yes
appendfsync everysec

dir /data
`};var Qe=require("url"),Ge=async(u,c,e)=>{let n=tt(u);if(n)return n;try{let t=await e.fetchZoteroChildren(c);for(let i of t){let r=Tn(i);if(r)return r}}catch(t){console.error("Failed to fetch Zotero children",t)}return null},tt=u=>{let c=it(u);for(let e of c){let n=Tn(e);if(n)return n}return null},it=u=>{let c=[u.attachments,u.children,u.items,u.attachment,u.allAttachments],e=[];for(let n of c)n&&(Array.isArray(n)?e.push(...n):typeof n=="object"&&e.push(n));return e},Tn=u=>{var t,i,r,a,s,o;if(((r=(t=u==null?void 0:u.contentType)!=null?t:u==null?void 0:u.mimeType)!=null?r:(i=u==null?void 0:u.data)==null?void 0:i.contentType)!=="application/pdf")return null;let e=(o=(a=u==null?void 0:u.key)!=null?a:u==null?void 0:u.attachmentKey)!=null?o:(s=u==null?void 0:u.data)==null?void 0:s.key;if(!e)return null;let n=rt(u);return n?{key:e,filePath:n}:{key:e}},rt=u=>{var e,n,t,i,r,a,s,o;let c=(o=(i=(n=(e=u==null?void 0:u.links)==null?void 0:e.enclosure)==null?void 0:n.href)!=null?i:(t=u==null?void 0:u.enclosure)==null?void 0:t.href)!=null?o:(s=(a=(r=u==null?void 0:u.data)==null?void 0:r.links)==null?void 0:a.enclosure)==null?void 0:s.href;if(typeof c=="string"&&c.startsWith("file://"))try{return(0,Qe.fileURLToPath)(c)}catch(l){return null}return null},Dn=async(u,c)=>{if(u.statusCode<300||u.statusCode>=400)return null;let e=u.headers.location,n=Array.isArray(e)?e[0]:e;if(!n||typeof n!="string")return null;if(n.startsWith("file://")){let t=(0,Qe.fileURLToPath)(n);return c.readFile(t)}return n.startsWith("http://")||n.startsWith("https://")?c.requestLocalApi(n):null},Ve=async(u,c)=>{let e=c.buildZoteroUrl(`/${c.getZoteroLibraryPath()}/items/${u}/file`);try{let n=await c.requestLocalApiRaw(e),t=await Dn(n,c);if(t)return t;if(n.statusCode>=300)throw new Error(`Request failed, status ${n.statusCode}`);return n.body}catch(n){if(console.warn("Failed to download PDF from local API",n),!c.canUseWebApi())throw n;let t=c.buildWebApiUrl(`/${c.getWebApiLibraryPath()}/items/${u}/file`),i=await c.requestWebApiRaw(t),r=await Dn(i,c);if(r)return r;if(i.statusCode>=300)throw new Error(`Web API request failed, status ${i.statusCode}`);return i.body}};var B=require("obsidian"),be="zotero-redisearch-rag-chat",we=class extends B.ItemView{constructor(e,n){super(e);this.messages=[];this.activeSessionId="default";this.messageEls=new Map;this.pendingRender=new Map;this.busy=!1;this.plugin=n}getViewType(){return be}getDisplayText(){return"Zotero RAG Chat"}getIcon(){return"zrr-chat"}async onOpen(){let{containerEl:e}=this;e.empty(),e.addClass("zrr-chat-view");let n=e.createEl("div",{cls:"zrr-chat-header"});n.createEl("div",{cls:"zrr-chat-title",text:"Zotero RAG Chat"});let t=n.createEl("div",{cls:"zrr-chat-controls"}),i=t.createEl("div",{cls:"zrr-chat-controls-row"});this.sessionSelect=i.createEl("select",{cls:"zrr-chat-session"}),this.sessionSelect.addEventListener("change",async()=>{await this.switchSession(this.sessionSelect.value)});let r=t.createEl("div",{cls:"zrr-chat-controls-row zrr-chat-controls-actions"});this.renameButton=r.createEl("button",{cls:"zrr-chat-rename",text:"Rename",attr:{title:"Rename the current chat"}}),this.renameButton.addEventListener("click",async()=>{await this.promptRenameSession()}),this.copyButton=r.createEl("button",{cls:"zrr-chat-copy",text:"Copy",attr:{title:"Copy this chat to a new note"}}),this.copyButton.addEventListener("click",async()=>{await this.copyChatToNote()}),this.deleteButton=r.createEl("button",{cls:"zrr-chat-delete",text:"Delete",attr:{title:"Delete this chat"}}),this.deleteButton.addEventListener("click",async()=>{await this.deleteChat()}),this.newButton=r.createEl("button",{cls:"zrr-chat-new",text:"New chat",attr:{title:"Start a new chat session"}}),this.newButton.addEventListener("click",async()=>{await this.startNewChat()}),this.messagesEl=e.createEl("div",{cls:"zrr-chat-messages"});let a=e.createEl("div",{cls:"zrr-chat-input"});this.inputEl=a.createEl("textarea",{cls:"zrr-chat-textarea",attr:{placeholder:"Ask your Zotero library..."}}),this.sendButton=a.createEl("button",{cls:"zrr-chat-send",text:"Send"}),this.sendButton.addEventListener("click",()=>this.handleSend()),this.inputEl.addEventListener("keydown",s=>{s.key==="Enter"&&!s.shiftKey&&(s.preventDefault(),this.handleSend())}),await this.loadSessions(),await this.loadHistory(),await this.renderAll()}focusInput(){var e;(e=this.inputEl)==null||e.focus()}async loadHistory(){try{this.messages=await this.plugin.loadChatHistoryForSession(this.activeSessionId)}catch(e){console.error(e),this.messages=[]}}async saveHistory(){try{await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages),await this.loadSessions()}catch(e){console.error(e)}}async loadSessions(){let e=await this.plugin.listChatSessions();this.activeSessionId=await this.plugin.getActiveChatSessionId(),this.sessionSelect.empty();for(let n of e){let t=this.sessionSelect.createEl("option",{text:n.name});t.value=n.id,n.id===this.activeSessionId&&(t.selected=!0)}!e.some(n=>n.id===this.activeSessionId)&&e.length>0&&(this.activeSessionId=e[0].id,await this.plugin.setActiveChatSessionId(this.activeSessionId),this.sessionSelect.value=this.activeSessionId)}async promptRenameSession(){var i;let n=(await this.plugin.listChatSessions()).find(r=>r.id===this.activeSessionId);new en(this.app,(i=n==null?void 0:n.name)!=null?i:"New chat",async r=>{await this.plugin.renameChatSession(this.activeSessionId,r),await this.loadSessions()}).open()}async startNewChat(){await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages,{force:!0});let e=await this.plugin.createChatSession("New chat");await this.switchSession(e,{skipSave:!0})}async deleteChat(){let e=await this.plugin.listChatSessions();if(e.length<=1){new B.Notice("You must keep at least one chat.");return}let n=e.find(i=>i.id===this.activeSessionId);if(!n)return;new nn(this.app,n.name,async()=>{await this.plugin.deleteChatSession(this.activeSessionId);let i=await this.plugin.getActiveChatSessionId();await this.switchSession(i,{skipSave:!0})}).open()}async switchSession(e,n={}){!e||e===this.activeSessionId||(n.skipSave||await this.saveHistory(),this.activeSessionId=e,await this.plugin.setActiveChatSessionId(e),await this.loadSessions(),await this.loadHistory(),await this.renderAll())}async renderAll(){this.messagesEl.empty(),this.messageEls.clear();for(let e of this.messages)await this.renderMessage(e);this.scrollToBottom()}async renderMessage(e){let n=this.messagesEl.createEl("div",{cls:`zrr-chat-message zrr-chat-${e.role}`}),t=n.createEl("div",{cls:"zrr-chat-meta-row"});t.createEl("div",{cls:"zrr-chat-meta"}).setText(e.role==="user"?"You":"Zotero Assistant");let r=t.createEl("div",{cls:"zrr-chat-message-actions"}),a=r.createEl("button",{cls:"zrr-chat-message-copy zrr-chat-icon-button",attr:{title:"Copy this message","aria-label":"Copy this message"}});(0,B.setIcon)(a,"copy"),a.addEventListener("click",async d=>{d.preventDefault(),d.stopPropagation(),await this.copyMessage(e)});let s=r.createEl("button",{cls:"zrr-chat-message-delete zrr-chat-icon-button",attr:{title:"Delete this message","aria-label":"Delete this message"}});(0,B.setIcon)(s,"trash-2"),s.addEventListener("click",async d=>{d.preventDefault(),d.stopPropagation(),await this.deleteMessage(e.id)});let o=n.createEl("div",{cls:"zrr-chat-content"}),l=n.createEl("div",{cls:"zrr-chat-citations"});this.messageEls.set(e.id,{wrapper:n,content:o,citations:l}),await this.renderMessageContent(e)}async copyMessage(e){var i,r,a;let t=(await this.plugin.formatInlineCitations(e.content||"",(i=e.citations)!=null?i:[],(r=e.retrieved)!=null?r:[])||"").trim();if(!t){new B.Notice("Nothing to copy.");return}if(!((a=navigator.clipboard)!=null&&a.writeText)){new B.Notice("Clipboard API unavailable. Select text to copy.");return}try{await navigator.clipboard.writeText(t),new B.Notice("Message copied to clipboard.")}catch(s){console.error("Failed to copy message",s),new B.Notice("Failed to copy message.")}}async deleteMessage(e){let n=this.messages.findIndex(a=>a.id===e);if(n===-1||!window.confirm("Delete this message? This cannot be undone."))return;this.messages.splice(n,1);let i=this.messageEls.get(e);i&&i.wrapper.remove(),this.messageEls.delete(e);let r=this.pendingRender.get(e);r!==void 0&&(window.clearTimeout(r),this.pendingRender.delete(e)),await this.saveHistory()}scheduleRender(e){if(this.pendingRender.has(e.id))return;let n=window.setTimeout(async()=>{this.pendingRender.delete(e.id),await this.renderMessageContent(e),this.scrollToBottom()},80);this.pendingRender.set(e.id,n)}async renderMessageContent(e){var i,r,a;let n=this.messageEls.get(e.id);if(!n)return;let t=await this.plugin.formatInlineCitations(e.content||"",(i=e.citations)!=null?i:[],(r=e.retrieved)!=null?r:[]);n.content.dataset.lastRendered!==t&&(n.content.empty(),await B.MarkdownRenderer.renderMarkdown(t,n.content,"",this.plugin),this.hookInternalLinks(n.content),n.content.dataset.lastRendered=t),n.citations.empty(),await this.renderCitations(n.citations,(a=e.citations)!=null?a:[])}hookInternalLinks(e){let n=e.querySelectorAll("a.internal-link");for(let t of Array.from(n))t.dataset.zrrBound!=="1"&&(t.dataset.zrrBound="1",this.registerDomEvent(t,"click",i=>{i.preventDefault();let r=t.getAttribute("data-href")||t.getAttribute("href")||"";r&&this.plugin.openInternalLinkInMain(r)}))}async renderCitations(e,n){if(e.empty(),!n.length)return;let t=e.createEl("details",{cls:"zrr-chat-citations-details"});t.createEl("summary",{text:`Relevant context sources (${n.length})`,cls:"zrr-chat-citations-summary"});let i=t.createEl("ul",{cls:"zrr-chat-citation-list"});for(let r of n){let a=await this.plugin.resolveCitationDisplay(r),s=i.createEl("li"),o=`${a.noteTitle} p. ${a.pageLabel}`;s.createEl("a",{text:o,href:"#"}).addEventListener("click",d=>{d.preventDefault(),this.plugin.openCitationTarget(r,a)})}}async copyChatToNote(){var i;let n=(await this.plugin.listChatSessions()).find(r=>r.id===this.activeSessionId),t=(i=n==null?void 0:n.name)!=null?i:"New chat";await this.plugin.createChatNoteFromSession(this.activeSessionId,t,this.messages)}scrollToBottom(){this.messagesEl.scrollTop=this.messagesEl.scrollHeight}async handleSend(){if(this.busy)return;let e=this.inputEl.value.trim();if(!e){new B.Notice("Query cannot be empty.");return}if(!this.plugin.settings.chatBaseUrl){new B.Notice("Chat base URL must be set in settings.");return}this.inputEl.value="",this.busy=!0,this.sendButton.disabled=!0;let n={id:this.generateId(),role:"user",content:e,createdAt:new Date().toISOString()};this.messages.push(n),await this.renderMessage(n),this.scrollToBottom(),await this.saveHistory();let t={id:this.generateId(),role:"assistant",content:"",citations:[],createdAt:new Date().toISOString()};this.messages.push(t),await this.renderMessage(t),this.scrollToBottom();let i=!1,r=this.plugin.getRecentChatHistory(this.messages.slice(0,-2));try{await this.plugin.runRagQueryStreaming(e,a=>{i=!0,t.content+=a,this.scheduleRender(t)},a=>{(!i&&(a!=null&&a.answer)||a!=null&&a.answer)&&(t.content=a.answer),Array.isArray(a==null?void 0:a.citations)&&(t.citations=a.citations),Array.isArray(a==null?void 0:a.retrieved)&&(t.retrieved=a.retrieved),this.scheduleRender(t)},r)}catch(a){console.error(a),t.content="Failed to fetch answer. See console for details.",this.scheduleRender(t)}finally{this.busy=!1,this.sendButton.disabled=!1,await this.saveHistory()}}generateId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}},en=class extends B.Modal{constructor(c,e,n){super(c),this.initialValue=e,this.onSubmit=n}onOpen(){let{contentEl:c}=this;c.empty(),c.addClass("zrr-chat-rename-modal"),c.createEl("h3",{text:"Rename chat"});let e=this.initialValue;new B.Setting(c).setName("Name").addText(r=>{r.setValue(e),r.onChange(a=>{e=a})});let n=c.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="1rem",n.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),n.createEl("button",{text:"Save"}).addEventListener("click",()=>{let r=e.trim();if(!r){new B.Notice("Name cannot be empty.");return}this.close(),this.onSubmit(r)})}},nn=class extends B.Modal{constructor(c,e,n){super(c),this.chatName=e,this.onConfirm=n}onOpen(){let{contentEl:c}=this;c.empty(),c.createEl("h3",{text:"Delete chat"}),c.createEl("p",{text:`Delete "${this.chatName}"? This cannot be undone.`});let e=c.createEl("div");e.style.display="flex",e.style.gap="0.5rem",e.style.marginTop="1rem",e.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),e.createEl("button",{text:"Delete"}).addEventListener("click",()=>{this.close(),this.onConfirm()})}};var On={en:"eng",de:"deu",fr:"fra",es:"spa",it:"ita",nl:"nld",pt:"por",pl:"pol",sv:"swe"},st=Re["zrr-picker"],at=Re["zrr-chat"],In=Re["zrr-pdf"],Fn=80,Be=class extends f.Plugin{constructor(){super(...arguments);this.docIndex=null;this.lastPythonEnvNotice=null;this.lastContainerNotice=null;this.lastZoteroApiNotice=null;this.lastRedisNotice=null;this.noteSyncTimers=new Map;this.noteSyncInFlight=new Set;this.noteSyncPending=new Set;this.noteSyncPendingDeletes=new Map;this.noteSyncSuppressed=new Set;this.noteMetadataSyncTimers=new Map;this.noteMetadataSyncInFlight=new Set;this.noteMetadataSyncPending=new Set;this.noteMetadataSyncSuppressed=new Set;this.missingDocIdWarned=new Set;this.collectionTitleCache=new Map;this.recreateMissingNotesActive=!1;this.recreateMissingNotesAbort=!1;this.recreateMissingNotesProcess=null;this.reindexCacheActive=!1;this.lastReindexFailure=null;this.lastRedisSearchTerm=""}async onload(){await this.loadSettings(),await this.migrateCachePaths(),this.addSettingTab(new Se(this.app,this)),this.pdfSidebar=new Ne({app:this.app,iconSvg:In,resolveDocIdForNote:this.resolveDocIdForNote.bind(this),getDocIndexEntry:this.getDocIndexEntry.bind(this),hydrateDocIndexFromCache:this.hydrateDocIndexFromCache.bind(this),toVaultRelativePath:this.toVaultRelativePath.bind(this),normalizeChunkIdForNote:this.normalizeChunkIdForNote.bind(this),readChunkPayload:this.readChunkPayload.bind(this)},{extractDocIdFromDoc:Ee,findChunkStartLineInDoc:Ke,parseChunkMarkerLine:We,extractFirstChunkMarkerFromContent:ln}),this.registerRibbonIcons(),this.registerView(be,e=>new we(e,this)),this.setupStatusBar(),this.registerNoteRenameHandler(),this.registerNoteSyncHandler(),this.registerNoteOpenHandler(),this.registerPreviewScrollSyncHandlers(),this.registerNoteDeleteMenu(),this.registerEditorExtension(gn(this)),this.registerEditorExtension(_n()),this.registerEditorExtension(this.pdfSidebar.createSyncExtension());try{await this.ensureBundledTools()}catch(e){console.error("Failed to sync bundled tools",e)}this.autoDetectRedisOnLoad(),this.addCommand({id:"import-zotero-item-index",name:"Import Zotero item and index (Docling -> RedisSearch)",callback:()=>this.importZoteroItem()}),this.addCommand({id:"ask-zotero-library",name:"Ask my Zotero library (RAG via RedisSearch)",callback:()=>this.askZoteroLibrary()}),this.addCommand({id:"open-zotero-chat",name:"Open Zotero RAG chat panel",callback:()=>this.openChatView(!0)}),this.addCommand({id:"rebuild-zotero-note-cache",name:"Rebuild Zotero note from cache (Docling + RedisSearch)",callback:()=>this.rebuildNoteFromCache()}),this.addCommand({id:"rebuild-doc-index-cache",name:"Rebuild doc index from cache",callback:()=>this.rebuildDocIndexFromCache()}),this.addCommand({id:"recreate-missing-notes-cache",name:"Recreate missing notes from cache (Docling + RedisSearch)",callback:()=>this.recreateMissingNotesFromCache()}),this.addCommand({id:"reindex-redis-from-cache",name:"Reindex Redis from cached chunks",callback:()=>this.reindexRedisFromCache()}),this.addCommand({id:"reindex-current-note",name:"Reindex current note from cache",callback:()=>this.reindexCurrentNoteFromCache()}),this.addCommand({id:"drop-rebuild-redis-index",name:"Drop & rebuild Redis index",callback:()=>this.dropAndRebuildRedisIndex()}),this.addCommand({id:"start-redis-stack",name:"Start Redis Stack (Docker/Podman Compose)",callback:()=>this.startRedisStack()}),this.addCommand({id:"open-docling-log",name:"Open log file",callback:()=>this.openLogFile()}),this.addCommand({id:"clear-docling-log",name:"Clear log file",callback:()=>this.clearLogFile()}),this.addCommand({id:"toggle-zrr-chunk-delete",name:"Toggle ZRR chunk exclude at cursor",editorCallback:e=>this.toggleChunkExclude(e)}),this.addCommand({id:"delete-zotero-note-cache",name:"Delete Zotero note and cached data",callback:()=>this.deleteZoteroNoteAndCache()}),this.addCommand({id:"search-redis-index",name:"Search Redis index for term",callback:()=>this.searchRedisIndex()}),this.addCommand({id:"redis-diagnostics",name:"Show Redis diagnostics",callback:()=>this.showRedisDiagnostics()}),this.addCommand({id:"purge-redis-orphans",name:"Purge Redis orphaned chunks (missing cache files)",callback:()=>this.purgeRedisOrphanedKeys()}),this.autoDetectContainerCliOnLoad(),this.settings.autoStartRedis&&this.startRedisStack(!0)}async loadSettings(){var t;let e=(t=await this.loadData())!=null?t:{},n=Object.assign({},fn,e);n.preferObsidianNoteForCitations===void 0&&typeof e.preferVaultPdfForCitations=="boolean"&&(n.preferObsidianNoteForCitations=e.preferVaultPdfForCitations),this.settings=n}async saveSettings(){await this.saveData(this.settings)}async importZoteroItem(){var D,I,z;try{await this.ensureBundledTools()}catch(R){new f.Notice("Failed to sync bundled tools. See console for details."),console.error(R);return}if(!await this.warnIfZoteroLocalApiUnavailable("import")&&!this.canUseWebApi())return;let n;try{n=await this.promptZoteroItem()}catch(R){new f.Notice("Zotero search failed. See console for details."),console.error(R);return}if(!n){new f.Notice("No Zotero item selected.");return}let t=(D=n.data)!=null?D:n;!t.key&&n.key&&(t.key=n.key);let i=yn(t);if(!i){new f.Notice("Could not resolve a stable doc_id from Zotero item.");return}let r=await this.resolveLanguageHint(t,(I=n.key)!=null?I:t.key),a=this.buildDoclingLanguageHint(r!=null?r:void 0),s=await Ge(t,i,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});if(!s){new f.Notice("No PDF attachment found for item.");return}if(this.showStatusProgress("Preparing...",5),!await this.ensureRedisAvailable("import")){this.clearStatusProgress();return}let o=typeof t.title=="string"?t.title:"",l=await this.getDocIndexEntry(i);l&&new f.Notice("Item already indexed. Updating cached files and index.");let d=this.sanitizeFileName(o)||i;if(l!=null&&l.note_path)d=E.default.basename(l.note_path,".md")||d;else if(l!=null&&l.pdf_path){let R=this.toVaultRelativePath(l.pdf_path);R&&R.startsWith((0,f.normalizePath)(this.settings.outputPdfDir))&&(d=E.default.basename(R,".pdf")||d)}let p=l?d:await this.resolveUniqueBaseName(d,i),_=(0,f.normalizePath)(`${this.settings.outputPdfDir}/${p}.pdf`),g=(0,f.normalizePath)(`${Y}/${i}.json`),y=(0,f.normalizePath)(`${V}/${i}.json`),x=this.app.vault.adapter,A=(0,f.normalizePath)(`${this.settings.outputNoteDir}/${p}.md`);if(l!=null&&l.note_path&&await x.exists(l.note_path)&&(A=(0,f.normalizePath)(l.note_path)),await x.exists(A)&&!await this.confirmOverwrite(A)){new f.Notice("Import canceled.");return}try{if(await this.ensureFolder(Y),await this.ensureFolder(V),await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let R=this.getLogFileRelativePath(),F=(0,f.normalizePath)(E.default.dirname(R));F&&await this.ensureFolder(F),await this.deleteLogFileIfExists();let O=this.getSpellcheckerInfoRelativePath(),$=(0,f.normalizePath)(E.default.dirname(O));$&&await this.ensureFolder($)}}catch(R){new f.Notice("Failed to create output folders."),console.error(R),this.clearStatusProgress();return}let m="",h="";try{if(this.settings.copyPdfToVault){let R=s.filePath?await j.promises.readFile(s.filePath):await Ve(s.key,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:j.promises.readFile});await this.app.vault.adapter.writeBinary(_,this.bufferToArrayBuffer(R)),m=this.getAbsoluteVaultPath(_)}else if(s.filePath)m=s.filePath;else{await this.ensureFolder(this.settings.outputPdfDir);let R=await Ve(s.key,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:j.promises.readFile});await this.app.vault.adapter.writeBinary(_,this.bufferToArrayBuffer(R)),m=this.getAbsoluteVaultPath(_),new f.Notice("Local PDF path unavailable; copied PDF into vault for processing.")}h=this.buildPdfLinkForNote(m,s.key,i)}catch(R){new f.Notice("Failed to download PDF attachment."),console.error(R),this.clearStatusProgress();return}try{await this.app.vault.adapter.write(g,JSON.stringify(n,null,2))}catch(R){new f.Notice("Failed to write Zotero item JSON."),console.error(R),this.clearStatusProgress();return}let w=this.getPluginDir(),P=E.default.join(w,"tools","docling_extract.py"),S=E.default.join(w,"tools","index_redisearch.py"),L=null;try{L=await this.readDoclingQualityLabelFromPdf(m,a),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",L),0);let R=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(P,await this.buildDoclingArgs(m,i,y,A,a,!0),$=>this.handleDoclingProgress($,L),()=>{},R),L=await this.readDoclingQualityLabel(y),await this.annotateChunkJsonWithAttachmentKey(y,s.key);let F=await this.readDoclingMetadata(y),O=await this.maybeCreateOcrLayeredPdf(m,F,a);O&&(m=O,h=this.buildPdfLinkFromSourcePath(O),await this.updateChunkJsonSourcePdf(y,O))}catch(R){new f.Notice("Docling extraction failed. See console for details."),console.error(R),this.clearStatusProgress();return}let C=!1;try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",L),0);let R=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null,F=["--chunks-json",this.getAbsoluteVaultPath(y),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--progress"];this.appendEmbedSubchunkArgs(F),this.appendEmbedContextArgs(F),this.settings.embedIncludeMetadata&&F.push("--embed-include-metadata"),this.appendChunkTaggingArgs(F),await this.runPythonStreaming(S,F,O=>{if((O==null?void 0:O.type)==="progress"&&O.total){let $=Math.round(O.current/O.total*100),J=typeof O.message=="string"&&O.message.trim()?O.message:`Indexing chunks ${O.current}/${O.total}`,T=this.formatStatusLabel(J,L);this.showStatusProgress(T,$)}},()=>{})}catch(R){let F=this.getPythonErrorMessage(R),O=this.classifyIndexingError(F);if(console.error(R),O==="embed_dim_mismatch")if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema. Switch to a model with matching dimensions, or drop/rebuild the index."))try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){this.clearStatusProgress(),this.lastReindexFailure==="embed_failure"?new f.Notice("Embedding provider error detected while rebuilding the Redis index. Fix the provider/model settings and retry import."):new f.Notice("Redis index rebuild did not complete. Import stopped.");return}new f.Notice("Redis index rebuilt; resuming import."),C=!0}catch(J){this.clearStatusProgress(),new f.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error(J);return}else{this.clearStatusProgress(),new f.Notice("Indexing aborted due to embedding dimension mismatch. Switch models or drop/rebuild the index.");return}if(!C){if(O==="embed_failure"){this.clearStatusProgress(),new f.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.");return}this.clearStatusProgress(),new f.Notice("RedisSearch indexing failed. See console for details.");return}}try{let R=await this.app.vault.adapter.read(A),F=await this.readChunkPayload(y),O=this.buildSyncedDoclingContent(i,F,R),$=await this.buildNoteMarkdown(t,(z=n.meta)!=null?z:{},i,h,s.key,g,O);await this.writeNoteWithSyncSuppressed(A,$)}catch(R){new f.Notice("Failed to finalize note markdown."),console.error(R),this.clearStatusProgress();return}try{let R=he(t);await this.updateDocIndex({doc_id:i,note_path:A,note_title:p,zotero_title:o,short_title:R||void 0,pdf_path:m,attachment_key:s.key})}catch(R){console.error("Failed to update doc index",R)}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new f.Notice(`Indexed Zotero item ${i}.`)}async askZoteroLibrary(){await this.openChatView(!0)}getChatLeaf(){var n;let e=this.app.workspace.getLeavesOfType(be);return e.length>0?e[0]:this.settings.chatPaneLocation==="right"?(n=this.app.workspace.getRightLeaf(!1))!=null?n:this.app.workspace.getLeaf("split"):this.app.workspace.getLeaf("tab")}async openChatView(e=!1){let n=this.getChatLeaf();await n.setViewState({type:be,active:!0}),this.app.workspace.revealLeaf(n);let t=n.view;return t instanceof we&&e&&t.focusInput(),t}async loadChatHistory(){let e=await this.getActiveChatSessionId();return this.loadChatHistoryForSession(e)}async saveChatHistory(e){let n=await this.getActiveChatSessionId();await this.saveChatHistoryForSession(n,e)}getChatSessionsDir(){return(0,f.normalizePath)(`${X}/chats`)}getChatExportDir(){let e=(this.settings.chatOutputDir||"").trim();return e?(0,f.normalizePath)(e):(0,f.normalizePath)("zotero/chats")}getChatSessionsIndexPath(){return(0,f.normalizePath)(`${this.getChatSessionsDir()}/index.json`)}getChatSessionPath(e){return(0,f.normalizePath)(`${this.getChatSessionsDir()}/${e}.json`)}async listChatSessions(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath();if(!await e.exists(n)){let t=new Date().toISOString(),i=[{id:"default",name:"New chat",createdAt:t,updatedAt:t}];return await this.writeChatSessionsIndex({version:1,active:"default",sessions:i}),i}try{let t=await e.read(n),i=JSON.parse(t);return(Array.isArray(i==null?void 0:i.sessions)?i.sessions:[]).filter(a=>a&&typeof a.id=="string").map(a=>({id:String(a.id),name:typeof a.name=="string"&&a.name.trim()?a.name.trim():String(a.id),createdAt:typeof a.createdAt=="string"?a.createdAt:new Date().toISOString(),updatedAt:typeof a.updatedAt=="string"?a.updatedAt:new Date().toISOString()}))}catch(t){return console.warn("Failed to read chat sessions index",t),[]}}async getActiveChatSessionId(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath();if(!await e.exists(n))return"default";try{let t=await e.read(n),i=JSON.parse(t);return(typeof(i==null?void 0:i.active)=="string"?i.active:"default")||"default"}catch(t){return"default"}}async setActiveChatSessionId(e){var a,s;await this.migrateLegacyChatHistory();let n=await this.readChatSessionsIndex(),t=((a=n.sessions)!=null?a:[]).some(o=>o.id===e),i=new Date().toISOString(),r=t?n.sessions:[...(s=n.sessions)!=null?s:[],{id:e,name:e,createdAt:i,updatedAt:i}];await this.writeChatSessionsIndex({version:1,active:e,sessions:r})}async createChatSession(e){var s;await this.migrateLegacyChatHistory();let n=this.generateChatId(),t=new Date().toISOString(),i=(e||"").trim()||"New chat",a=[...(s=(await this.readChatSessionsIndex()).sessions)!=null?s:[],{id:n,name:i,createdAt:t,updatedAt:t}];return await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionPath(n),JSON.stringify({version:1,messages:[]},null,2)),await this.writeChatSessionsIndex({version:1,active:n,sessions:a}),n}async renameChatSession(e,n){var a,s;await this.migrateLegacyChatHistory();let t=(n||"").trim();if(!t)return;let i=await this.readChatSessionsIndex(),r=((a=i.sessions)!=null?a:[]).map(o=>o.id===e?{...o,name:t}:o);await this.writeChatSessionsIndex({version:1,active:(s=i.active)!=null?s:"default",sessions:r})}async deleteChatSession(e){var s;if(await this.migrateLegacyChatHistory(),!e)return;let n=this.app.vault.adapter,t=await this.readChatSessionsIndex(),i=(s=t.sessions)!=null?s:[];if(i.length<=1)return;let r=i.filter(o=>o.id!==e);if(!r.length)return;let a=t.active===e?r[0].id:t.active;try{await n.remove(this.getChatSessionPath(e))}catch(o){console.warn("Failed to delete chat session file",o)}await this.writeChatSessionsIndex({version:1,active:a,sessions:r})}async loadChatHistoryForSession(e){await this.migrateLegacyChatHistory();let n=this.app.vault.adapter,t=this.getChatSessionPath(e||"default");if(!await n.exists(t))return[];let i=await n.read(t),r;try{r=JSON.parse(i)}catch(s){return[]}let a=Array.isArray(r)?r:r==null?void 0:r.messages;return Array.isArray(a)?a.filter(s=>s&&typeof s.content=="string").map(s=>({id:s.id||this.generateChatId(),role:s.role==="assistant"?"assistant":"user",content:s.content,citations:Array.isArray(s.citations)?s.citations:[],retrieved:Array.isArray(s.retrieved)?s.retrieved:[],createdAt:s.createdAt||new Date().toISOString()})):[]}async saveChatHistoryForSession(e,n){var l,d;await this.migrateLegacyChatHistory(),await this.ensureFolder(this.getChatSessionsDir());let t=this.app.vault.adapter,i=this.getChatSessionPath(e||"default"),r={version:1,messages:n};await t.write(i,JSON.stringify(r,null,2));let a=await this.readChatSessionsIndex(),s=new Date().toISOString(),o=((l=a.sessions)!=null?l:[]).map(p=>p.id===e?{...p,updatedAt:s}:p);await this.writeChatSessionsIndex({version:1,active:(d=a.active)!=null?d:e,sessions:o})}getRecentChatHistory(e){let n=Math.max(0,this.settings.chatHistoryMessages||0);return n?e.filter(i=>{var r;return i&&((r=i.content)==null?void 0:r.trim())}).slice(-n):[]}async readChatSessionsIndex(){let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath(),t=new Date().toISOString();if(!await e.exists(n))return{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:t,updatedAt:t}]};try{let i=await e.read(n),r=JSON.parse(i),a=Array.isArray(r==null?void 0:r.sessions)?r.sessions:[];return{version:1,active:typeof(r==null?void 0:r.active)=="string"?r.active:"default",sessions:a.map(s=>({id:String(s.id),name:typeof s.name=="string"&&s.name.trim()?s.name.trim():String(s.id),createdAt:typeof s.createdAt=="string"?s.createdAt:t,updatedAt:typeof s.updatedAt=="string"?s.updatedAt:t}))}}catch(i){return console.warn("Failed to parse chat sessions index",i),{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:t,updatedAt:t}]}}}async writeChatSessionsIndex(e){await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionsIndexPath(),JSON.stringify(e,null,2))}async migrateLegacyChatHistory(){let e=this.app.vault.adapter,n=(0,f.normalizePath)(`${X}/chat.json`),t=this.getChatSessionsDir(),i=this.getChatSessionsIndexPath(),r=this.getChatSessionPath("default"),a=await e.exists(n),s=await e.exists(r),o=await e.exists(i);if(!a&&o)return;let l=new Date().toISOString();if(await this.ensureFolder(t),a&&!s)try{await e.rename(n,r)}catch(d){try{let p=await e.read(n);await e.write(r,p),await e.remove(n)}catch(p){console.warn("Failed to migrate legacy chat history",p)}}if(!o){let d=[{id:"default",name:"New chat",createdAt:l,updatedAt:l}];await this.writeChatSessionsIndex({version:1,active:"default",sessions:d})}if(o)try{let d=await e.read(i),p=JSON.parse(d),_=Array.isArray(p==null?void 0:p.sessions)?p.sessions:[],g=_.some(x=>(x==null?void 0:x.id)==="default"),y=_.map(x=>(x==null?void 0:x.id)==="default"&&typeof(x==null?void 0:x.name)=="string"&&x.name.trim().toLowerCase()==="default"?{...x,name:"New chat"}:x);g&&JSON.stringify(y)!==JSON.stringify(_)&&await this.writeChatSessionsIndex({version:1,active:typeof(p==null?void 0:p.active)=="string"?p.active:"default",sessions:y.map(x=>({id:String(x.id),name:typeof x.name=="string"?x.name:"New chat",createdAt:typeof x.createdAt=="string"?x.createdAt:l,updatedAt:typeof x.updatedAt=="string"?x.updatedAt:l}))})}catch(d){}}isPlaceholderChatName(e){let n=(e||"").trim().toLowerCase();return n==="new chat"||n==="default"}normalizeChatTitle(e){let n=(e||"").replace(/\s+/g," ").trim();return n.length>60?`${n.slice(0,57)}...`:n}guessTitleFromMessages(e){let n=e.find(i=>i.role==="user"&&i.content.trim());if(!n)return"New chat";let t=n.content.replace(/\s+/g," ").trim().split(" ").slice(0,8).join(" ");return this.normalizeChatTitle(t||"New chat")}async suggestChatTitleWithLlm(e){var a,s,o;let n=(this.settings.chatBaseUrl||"").trim(),t=(this.settings.chatModel||"").trim();if(!n||!t)return null;let i=n.replace(/\/$/,"");if(i.toLowerCase().includes("api.openai.com")&&(!this.settings.chatApiKey||t.includes("/")))return null;try{let l=`${i}/chat/completions`,d={"Content-Type":"application/json"};this.settings.chatApiKey&&(d.Authorization=`Bearer ${this.settings.chatApiKey}`);let p=e.slice(-8).map(A=>`${A.role.toUpperCase()}: ${A.content}`).join(`
`).slice(0,4e3),g=await fetch(l,{method:"POST",headers:d,body:JSON.stringify({model:t,temperature:.2,messages:[{role:"system",content:"Generate a short, specific title (3-7 words) for the chat. No quotes, no punctuation at the end."},{role:"user",content:p}]})});if(!g.ok)return null;let y=await g.json(),x=(o=(s=(a=y==null?void 0:y.choices)==null?void 0:a[0])==null?void 0:s.message)==null?void 0:o.content;return typeof x!="string"?null:this.normalizeChatTitle(x.replace(/^\"|\"$/g,"").trim())}catch(l){return console.warn("Chat title suggestion failed",l),null}}async finalizeChatSessionNameIfNeeded(e,n,t={}){var d;if(!e)return;let i=n||[];if(!i.some(p=>p.role==="user"&&p.content.trim())||!t.force&&i.length<4)return;let s=((d=(await this.readChatSessionsIndex()).sessions)!=null?d:[]).find(p=>p.id===e);if(!s||!this.isPlaceholderChatName(s.name))return;let l=await this.suggestChatTitleWithLlm(i)||this.guessTitleFromMessages(i);!l||this.isPlaceholderChatName(l)||await this.renameChatSession(e,l)}async runRagQueryStreaming(e,n,t,i=[]){if(await this.ensureBundledTools(),!await this.ensureRedisAvailable("chat query")){t({answer:"Redis is not reachable. Please start Redis Stack and try again."});return}let r=this.getPluginDir(),a=E.default.join(r,"tools","rag_query_redisearch.py"),s=["--query",e,"--k","5","--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--chat-base-url",this.settings.chatBaseUrl,"--chat-api-key",this.settings.chatApiKey,"--chat-model",this.settings.chatModel,"--temperature",String(this.settings.chatTemperature),"--stream"];if(this.settings.enableQueryExpansion&&(s.push("--expand-query"),s.push("--expand-count",String(Math.max(1,Math.trunc(this.settings.queryExpansionCount))))),this.settings.enableCrossEncoderRerank){s.push("--rerank");let d=(this.settings.rerankModel||"").trim();d&&s.push("--rerank-model",d)}Number.isFinite(this.settings.rerankCandidateMultiplier)&&s.push("--rerank-candidates",String(Math.max(1,Math.trunc(this.settings.rerankCandidateMultiplier)))),Number.isFinite(this.settings.rrfK)&&s.push("--rrf-k",String(Math.max(1,Math.trunc(this.settings.rrfK)))),Number.isFinite(this.settings.rrfLogTop)&&this.settings.rrfLogTop>0&&s.push("--rrf-log-top",String(Math.max(1,Math.trunc(this.settings.rrfLogTop)))),Number.isFinite(this.settings.maxChunksPerDoc)&&this.settings.maxChunksPerDoc>0&&s.push("--max-per-doc",String(Math.max(1,Math.trunc(this.settings.maxChunksPerDoc))));let o=this.buildChatHistoryPayload(i),l=await this.writeChatHistoryTemp(o);l!=null&&l.absolutePath&&s.push("--history-file",l.absolutePath);try{let d=async()=>{await this.runPythonStreaming(a,s,_=>{if((_==null?void 0:_.type)==="delta"&&typeof _.content=="string"){n(_.content);return}if((_==null?void 0:_.type)==="final"){t(_);return}_!=null&&_.answer&&t(_)},t)},p=!1;for(;;)try{await d();break}catch(_){let g=this.getPythonErrorMessage(_),y=this.classifyIndexingError(g);if(y==="embed_dim_mismatch"){if(p){t({answer:"Embedding dimension mismatch persists after rebuild. Check the embedding model settings."});return}if(!await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema.")){t({answer:"Embedding dimension mismatch. Switch models or drop/rebuild the Redis index."});return}try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){let m=this.lastReindexFailure==="embed_failure"?"Embedding provider error detected while rebuilding the index. Fix settings and retry.":"Redis index rebuild did not complete. Chat query stopped.";t({answer:m});return}}catch(A){console.error(A),t({answer:"Failed to drop/rebuild the Redis index. See console for details."});return}p=!0;continue}if(y==="embed_failure"){t({answer:"Embedding provider error detected. Fix the provider/model settings and retry."});return}throw _}}finally{if(l!=null&&l.relativePath)try{await this.app.vault.adapter.remove(l.relativePath)}catch(d){console.warn("Failed to remove chat history temp file",d)}}}buildChatHistoryPayload(e){return this.getRecentChatHistory(e).map(t=>({role:t.role,content:t.content}))}async writeChatHistoryTemp(e){if(!e.length)return null;let n=(0,f.normalizePath)(`${X}/tmp`);await this.ensureFolder(n);let t=`chat_history_${Date.now()}_${Math.random().toString(36).slice(2,8)}.json`,i=(0,f.normalizePath)(`${n}/${t}`),r={version:1,messages:e};return await this.app.vault.adapter.write(i,JSON.stringify(r,null,2)),{relativePath:i,absolutePath:this.getAbsoluteVaultPath(i)}}async resolveCitationDisplay(e){let n=await this.getDocIndexEntry(e.doc_id);(!n||!n.note_title||!n.zotero_title||!n.note_path||!n.pdf_path||n.short_title===void 0)&&(n=await this.hydrateDocIndexFromCache(e.doc_id));let t=e.doc_id?await this.resolveNotePathForDocId(e.doc_id):n==null?void 0:n.note_path,i=this.resolveCitationTitle(n,t,e.doc_id),r=this.formatCitationPageLabel(e),a=e.page_start?String(e.page_start):"",s=(n==null?void 0:n.pdf_path)||e.source_pdf||"",o=e.attachment_key||(n==null?void 0:n.attachment_key),l=e.annotation_key||this.extractAnnotationKey(e.chunk_id),d=e.doc_id?this.buildZoteroDeepLink(e.doc_id,o,a,l):void 0;return{noteTitle:i,pageLabel:r,notePath:t||void 0,pdfPath:s||void 0,zoteroUrl:d,pageStart:a||void 0}}resolveCitationTitle(e,n,t){let i=t||"?",r=(e==null?void 0:e.short_title)||(e==null?void 0:e.zotero_title)||(e==null?void 0:e.note_title)||(n?E.default.basename(n,".md"):"")||i;return this.shortenCitationTitle(r)}shortenCitationTitle(e){let n=String(e||"").trim();if(!n)return"?";if(n.length<=Fn)return n;let t=Math.max(0,Fn-3);return`${n.slice(0,t).trim()}...`}formatCitationLabel(e,n){let t=e.trim()||"?",i=(n||"").trim();return i?`${t}, p. ${i}`:t}async formatInlineCitations(e,n,t=[]){var d,p;if(!e)return e;let i=/\[\[?cite:([A-Za-z0-9]+):([^\]\n]+?)\]?\]/g,r=Array.from(e.matchAll(i));if(r.length===0)return e;let a=new Map;for(let _ of r){let g=_[0];if(a.has(g))continue;let y=_[1],x=_[2].trim(),A=x.match(/^(\d+)-(\d+)(?::([A-Za-z0-9]+))?$/),m="",h="",w,P;A?(m=A[1],h=A[2],w=A[3]):P=x;let S=P?t.find(R=>{let F=typeof R.doc_id=="string"?R.doc_id:"";if(F&&F!==y)return!1;let O=typeof R.chunk_id=="string"?R.chunk_id:"";return O?O===P||O===`${y}:${P}`||O.endsWith(`:${P}`):!1}):void 0;S&&(!m&&S.page_start!==void 0&&(m=String(S.page_start)),!h&&S.page_end!==void 0&&(h=String(S.page_end)),!w&&typeof S.chunk_id=="string"&&(w=this.extractAnnotationKey(S.chunk_id)));let L={doc_id:y,chunk_id:S==null?void 0:S.chunk_id,annotation_key:w};(m||h)&&(L.page_start=m||h,L.page_end=h||m,L.pages=`${L.page_start}-${L.page_end}`),S!=null&&S.source_pdf&&(L.source_pdf=String(S.source_pdf));let C=(m||h?n.find(R=>{var F,O;return R.doc_id===y&&String((F=R.page_start)!=null?F:"")===m&&String((O=R.page_end)!=null?O:"")===h}):void 0)||n.find(R=>R.doc_id===y)||L;!C.annotation_key&&w&&(C={...C,annotation_key:w});let D=await this.resolveCitationDisplay(C),I=this.formatCitationLabel(D.noteTitle,D.pageLabel),z=this.normalizeChunkIdForNote(C.chunk_id,y);if(this.settings.preferObsidianNoteForCitations&&D.notePath&&z)a.set(g,this.buildNoteChunkLink(D.notePath,z,I));else if(D.zoteroUrl)a.set(g,`[${I}](${D.zoteroUrl})`);else{let R=this.formatCitationLabel(y,D.pageLabel);a.set(g,`(${R})`)}}let s=[],o=0;for(let _ of r){let g=_[0],y=(d=_.index)!=null?d:0;if(y<o)continue;s.push(e.slice(o,y));let x=(p=a.get(g))!=null?p:g,A=y>0?e[y-1]:"";A&&!/\s/.test(A)&&!/[\(\[\{!]/.test(A)&&s.push(" "),s.push(x),o=y+g.length}s.push(e.slice(o));let l=s.join("");return this.repairTruncatedWikilinks(l)}repairTruncatedWikilinks(e){if(!e||typeof e!="string")return e;let n=e;return n=n.replace(/\[\[([^\]\n#]+#zrr-chunk:[^\]\n|]+)(?=\n|$)/g,"[[$1]]"),n=n.replace(/\[\[([^\]\n#]+#zrr-chunk:([^\]\n|]+))\]\]/g,(t,i,r)=>{let a=this.escapeWikiLabel(this.buildDefaultChunkLabel(String(r||"").trim()));return`[[${i}\\|${a}]]`}),n}buildDefaultChunkLabel(e){let n=(e||"").trim(),t=n.match(/^p(\d+)$/i);return t?`p. ${t[1]}`:n||"source"}handleDoclingProgress(e,n){if(!e||e.type!=="progress")return;let t=Number(e.percent);if(!Number.isFinite(t))return;let i=typeof e.message=="string"&&e.message.trim()?e.message:"Docling extraction...";this.showStatusProgress(this.formatStatusLabel(i,n),Math.round(t))}async createChatNoteFromSession(e,n,t){let i=this.getChatExportDir();await this.ensureFolder(i),await this.getDocIndex();let r=this.sanitizeFileName(n)||"Zotero Chat",a=this.formatTimestamp(new Date),s=(0,f.normalizePath)(`${i}/${r}.md`),o=await this.resolveUniqueNotePath(s,`${r}-${a}.md`),l=await this.buildChatTranscript(n,t);await this.app.vault.adapter.write(o,l),await this.openNoteInNewTab(o),new f.Notice(`Chat copied to ${o}`)}async buildChatTranscript(e,n){var i,r,a;let t=[];t.push(`# ${e||"Zotero Chat"}`),t.push(""),t.push(`Created: ${new Date().toISOString()}`),t.push("");for(let s of n){let o=s.role==="user"?"## You":"## Assistant";t.push(o),t.push("");let l=s.role==="assistant"?await this.formatInlineCitations(s.content||"",(i=s.citations)!=null?i:[],(r=s.retrieved)!=null?r:[]):s.content||"";if(t.push(l.trim()),t.push(""),s.role==="assistant"&&((a=s.citations)!=null&&a.length)){t.push("### Relevant context sources");let d=this.formatCitationsMarkdown(s.citations);d&&(t.push(d),t.push(""))}}return t.join(`
`).trim()+`
`}async resolveUniqueNotePath(e,n){let t=this.app.vault.adapter;if(!await t.exists(e))return e;let i=E.default.dirname(e),r=(0,f.normalizePath)(E.default.join(i,n));if(!await t.exists(r))return r;let a=2;for(;a<1e3;){let s=(0,f.normalizePath)(E.default.join(i,`${E.default.basename(n,".md")}-${a}.md`));if(!await t.exists(s))return s;a+=1}return r}formatTimestamp(e){let n=t=>String(t).padStart(2,"0");return[e.getFullYear(),n(e.getMonth()+1),n(e.getDate()),"-",n(e.getHours()),n(e.getMinutes())].join("")}async openCitationTarget(e,n){let t=n!=null?n:await this.resolveCitationDisplay(e),i=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id),r=this.settings.preferObsidianNoteForCitations;if(!(r&&t.notePath&&i&&await this.openNoteAtChunk(t.notePath,i))){if(r&&t.notePath){await this.openNoteInMain(t.notePath);return}if(!r&&t.zoteroUrl){this.openExternalUrl(t.zoteroUrl);return}if(!(t.pdfPath&&await this.openPdfInMain(t.pdfPath,t.pageStart))){if(t.zoteroUrl){this.openExternalUrl(t.zoteroUrl);return}new f.Notice("Unable to open citation target.")}}}async rebuildNoteFromCache(){let e=await this.promptDocId();if(!e){new f.Notice("No doc_id provided.");return}await this.rebuildNoteFromCacheForDocId(e,!0)&&new f.Notice(`Rebuilt Zotero note for ${e}.`)}async reindexCurrentNoteFromCache(){let e=this.app.workspace.getActiveFile();if(!e){new f.Notice("No active note to reindex.");return}await this.reindexNoteFromCacheForFile(e,!0)}async reindexNoteFromCacheForFile(e,n){try{let t=await this.app.vault.read(e),i=await this.resolveDocIdForNote(e,t);if(!i){n&&new f.Notice("No doc_id found for this note.");return}await this.reindexDocIdFromCache(i,n)&&n&&new f.Notice(`Reindexed ${i}.`)}catch(t){n&&new f.Notice("Failed to reindex note."),console.error("Failed to reindex note",t)}}async rebuildDocIndexFromCache(){var d,p,_;let e=this.app.vault.adapter,n=await this.listDocIds(Y),t=await this.listDocIds(V),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),r=Object.keys(i),a=Array.from(new Set([...n,...t,...r]));if(a.length===0){new f.Notice("No cached items found.");return}this.showStatusProgress("Rebuilding doc index...",0);let s=await this.getDocIndex(),o=0;for(let g of a){o+=1;let y={},x=i[g];x&&(y.note_path=x.note_path,y.note_title=x.note_title);let A=(0,f.normalizePath)(`${Y}/${g}.json`);if(await e.exists(A))try{let w=await e.read(A),P=JSON.parse(w),S=(p=(d=P==null?void 0:P.data)!=null?d:P)!=null?p:{},L=typeof S.title=="string"?S.title:"";L&&(y.zotero_title=L);let C=he(S);C&&(y.short_title=C);let D=this.sanitizeFileName(L)||g,I=(0,f.normalizePath)(`${this.settings.outputNoteDir}/${D}.md`),z=(0,f.normalizePath)(`${this.settings.outputNoteDir}/${D}-${g}.md`);await e.exists(I)?(y.note_path=I,y.note_title=E.default.basename(I,".md")):await e.exists(z)&&(y.note_path=z,y.note_title=E.default.basename(z,".md"))}catch(w){console.error("Failed to read cached item JSON",w)}let m=(0,f.normalizePath)(`${V}/${g}.json`);if(await e.exists(m))try{let w=await e.read(m),P=JSON.parse(w);typeof(P==null?void 0:P.source_pdf)=="string"&&(y.pdf_path=P.source_pdf)}catch(w){console.error("Failed to read cached chunks JSON",w)}if(Object.keys(y).length>0){let P={...(_=s[g])!=null?_:{doc_id:g},...y,doc_id:g,updated_at:new Date().toISOString()};!P.note_title&&P.note_path&&(P.note_title=E.default.basename(P.note_path,".md")),s[g]=P}let h=Math.round(o/a.length*100);this.showStatusProgress(`Rebuilding doc index ${o}/${a.length}`,h)}await this.saveDocIndex(s);let l=await this.pruneDocIndexOrphans();this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),l.removed>0?new f.Notice(`Rebuilt doc index for ${a.length} items; pruned ${l.removed} stale entries.`):new f.Notice(`Rebuilt doc index for ${a.length} items.`)}async recreateMissingNotesFromCache(){if(this.recreateMissingNotesActive){new f.Notice("Recreate missing notes is already running.");return}this.recreateMissingNotesActive=!0,this.recreateMissingNotesAbort=!1,this.recreateMissingNotesProcess=null;try{let e=this.app.vault.adapter,n=await this.listDocIds(Y),t=await this.listDocIds(V),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),r=Object.keys(i),a=Array.from(new Set([...n,...t,...r]));if(a.length===0){new f.Notice("No cached items found.");return}let s=[];for(let d of a){if(i[d])continue;let p=await this.getDocIndexEntry(d);if(p!=null&&p.note_path&&await e.exists(p.note_path))continue;let _=await this.inferNotePathFromCache(d);_&&await e.exists(_)||s.push(d)}if(s.length===0){new f.Notice("No missing notes detected.");return}this.showStatusProgress("Recreating missing notes...",0);let o=0,l=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;for(let d=0;d<s.length&&!this.recreateMissingNotesAbort;d+=1){let p=s[d],_=Math.round((d+1)/s.length*100);this.showStatusProgress(`Recreating ${d+1}/${s.length}`,_),l&&this.appendToLogFile(l,`Recreate missing note doc_id ${p} (${d+1}/${s.length})`,"recreate_missing_notes","INFO"),await this.rebuildNoteFromCacheForDocId(p,!1)&&(o+=1)}this.recreateMissingNotesAbort?(this.showStatusProgress("Canceled",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new f.Notice(`Canceled after ${o}/${s.length} notes.`)):(this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new f.Notice(`Recreated ${o}/${s.length} missing notes.`))}finally{this.recreateMissingNotesActive=!1,this.recreateMissingNotesProcess=null}}cancelRecreateMissingNotesFromCache(){if(!this.recreateMissingNotesActive){new f.Notice("No recreate job is running.");return}this.recreateMissingNotesAbort=!0;let e=this.recreateMissingNotesProcess;if(e&&!e.killed){try{e.kill("SIGTERM")}catch(n){console.warn("Failed to terminate recreate process",n)}window.setTimeout(()=>{if(e&&!e.killed)try{e.kill("SIGKILL")}catch(n){console.warn("Failed to force-kill recreate process",n)}},2e3)}new f.Notice("Canceling recreate missing notes...")}buildRedisCommand(e){let n=[`*${e.length}\r
`];for(let t of e){let i=String(t);n.push(`$${Buffer.byteLength(i)}\r
${i}\r
`)}return n.join("")}async checkRedisConnectionWithUrl(e,n=2e3){let t=(e||"").trim();if(!t)return{ok:!1,message:"Redis URL is not configured."};let i;try{i=new URL(t)}catch(d){return{ok:!1,message:"Redis URL is invalid."}}let r=i.hostname||"127.0.0.1",a=Number(i.port)||(i.protocol==="rediss:"||i.protocol==="redis+tls:"?6380:6379),s=decodeURIComponent(i.username||""),o=decodeURIComponent(i.password||""),l=i.protocol==="rediss:"||i.protocol==="redis+tls:";return new Promise(d=>{let p=l?jn.default.connect({host:r,port:a,timeout:n,rejectUnauthorized:!1}):Pe.default.createConnection({host:r,port:a,timeout:n}),_="",g=o||s?"auth":"ping",y=!1,x=(m,h)=>{if(!y){y=!0;try{p.end(),p.destroy()}catch(w){}d({ok:m,message:h})}},A=m=>{let h=m.trim();if(h){if(h.startsWith("-NOAUTH")){x(!1,"Redis requires authentication. Check your Redis URL credentials.");return}if(h.startsWith("-WRONGPASS")||h.toLowerCase().includes("invalid password")){x(!1,"Redis authentication failed. Check your Redis URL credentials.");return}if(h.startsWith("-ERR")){x(!1,`Redis error: ${h}`);return}if(g==="auth"){if(h.startsWith("+OK")){g="ping",_="",p.write(this.buildRedisCommand(["PING"]));return}x(!1,`Redis auth failed: ${h}`);return}h.startsWith("+PONG")&&x(!0)}};p.on("connect",()=>{if(g==="auth"){let m=s?["AUTH",s,o]:["AUTH",o];p.write(this.buildRedisCommand(m))}else p.write(this.buildRedisCommand(["PING"]))}),p.on("data",m=>{var w;_+=m.toString();let h=_.split(/\r?\n/);_=(w=h.pop())!=null?w:"";for(let P of h)A(P)}),p.on("timeout",()=>{x(!1,"Timed out connecting to Redis.")}),p.on("error",m=>{x(!1,`Redis connection failed: ${m.message}`)}),p.on("close",()=>{y||x(!1,"Redis connection closed unexpectedly.")})})}async checkRedisConnection(e=2e3){return this.checkRedisConnectionWithUrl(this.settings.redisUrl,e)}async ensureRedisAvailable(e){let n=await this.checkRedisConnection();if(n.ok)return!0;let t=n.message?`Redis unavailable for ${e}: ${n.message}`:`Redis unavailable for ${e}.`;return this.notifyContainerOnce(t),!1}getPythonErrorMessage(e){if(e instanceof Error)return e.message||String(e);if(typeof e=="string")return e;try{return JSON.stringify(e)}catch(n){return String(e)}}classifyIndexingError(e){let n=e.toLowerCase();return n.includes("embedding dim mismatch")||n.includes("dim mismatch")?"embed_dim_mismatch":n.includes("chunks json not found")?"chunks_missing":n.includes("embedding failed")||n.includes("embedding request failed")||n.includes("unloaded")||n.includes("crashed")||n.includes("model does not exist")||n.includes("failed to load model")||n.includes("connection refused")||n.includes("econnrefused")||n.includes("max retries exceeded")||n.includes("failed to establish a new connection")||n.includes("failed to fetch models")?"embed_failure":"unknown"}async confirmRebuildIndex(e){return new Promise(n=>{new ze(this.app,e,n).open()})}async confirmPurgeRedisOrphans(){return new Promise(e=>{new qe(this.app,e).open()})}async dropRedisIndex(e=!1){await this.ensureBundledTools();let n=this.getPluginDir(),t=E.default.join(n,"tools","drop_redis_index.py"),i=["--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName()];e&&i.push("--drop-docs"),await this.runPython(t,i)}async dropAndRebuildRedisIndex(){if(this.reindexCacheActive){new f.Notice("Reindex already running.");return}if(!(!await this.ensureRedisAvailable("drop/rebuild")||!await this.confirmRebuildIndex("This will remove the current RedisSearch index and rebuild it from cached chunks."))){try{await this.dropRedisIndex(!0)}catch(n){let t=n instanceof Error?n.message:String(n);if(t.includes("Unknown Index name")||t.includes("Unknown index name"))console.warn("Redis index missing; skipping drop step.");else{console.error("Failed to drop Redis index",n),new f.Notice("Failed to drop Redis index. See console for details.");return}}await this.reindexRedisFromCache()}}async purgeRedisOrphanedKeys(){var r,a,s,o,l;if(!await this.ensureRedisAvailable("purge orphans")||!await this.confirmPurgeRedisOrphans())return;try{await this.ensureBundledTools()}catch(d){new f.Notice("Failed to sync bundled tools. See console for details."),console.error(d);return}let n=this.getPluginDir(),t=E.default.join(n,"tools","purge_redis_orphans.py"),i=["--redis-url",this.settings.redisUrl,"--key-prefix",this.getRedisKeyPrefix(),"--chunk-dir",this.getAbsoluteVaultPath(V),"--item-dir",this.getAbsoluteVaultPath(Y)];try{let d=await this.runPythonWithOutput(t,i),p=null;try{p=d?JSON.parse(d):null}catch(x){console.warn("Failed to parse purge output",x)}if(!p){new f.Notice("Purge completed. See console for details.");return}let _=[`Keys scanned: ${(r=p.keys_scanned)!=null?r:0}`,`Keys deleted: ${(a=p.keys_deleted)!=null?a:0}`,`Docs checked: ${(s=p.docs_checked)!=null?s:0}`,`Orphan docs: ${(o=p.orphan_doc_count)!=null?o:0}`],g=await this.pruneDocIndexOrphans();_.push(`Doc index entries removed: ${g.removed}`),g.updated>0&&_.push(`Doc index entries updated: ${g.updated}`);let y=Array.isArray(p.sample_orphan_doc_ids)?p.sample_orphan_doc_ids.filter(Boolean):[];y.length&&_.push("","Sample doc_ids:",...y.map(x=>`- ${x}`)),new ye(this.app,"Redis orphan purge",_.join(`
`)).open(),((l=p.keys_deleted)!=null?l:0)===0?new f.Notice("No orphaned Redis keys found."):new f.Notice(`Deleted ${p.keys_deleted} Redis keys.`)}catch(d){console.error("Failed to purge Redis orphans",d),new f.Notice("Failed to purge Redis orphans. See console for details.")}}async reindexRedisFromCache(){if(this.lastReindexFailure=null,this.reindexCacheActive)return new f.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;let e=null,n=0;try{await this.ensureBundledTools()}catch(o){return new f.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let t=await this.listDocIds(V);if(t.length===0)return new f.Notice("No cached chunks found."),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let i=this.getPluginDir(),r=E.default.join(i,"tools","index_redisearch.py"),a=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null,s=0;this.showStatusProgress("Reindexing cached chunks...",0),a&&this.appendToLogFile(a,`Reindex started: ${t.length} cached items`,"index_redisearch","INFO");for(let o of t){s+=1;let l=Math.round(s/t.length*100);this.showStatusProgress(`Reindexing ${s}/${t.length}`,l);let d=(0,f.normalizePath)(`${V}/${o}.json`);try{let p=["--chunks-json",this.getAbsoluteVaultPath(d),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(p),this.appendEmbedContextArgs(p),this.settings.embedIncludeMetadata&&p.push("--embed-include-metadata"),this.appendChunkTaggingArgs(p,{allowRegenerate:!1}),a&&this.appendToLogFile(a,`Reindexing doc_id ${o}`,"index_redisearch","INFO"),await this.runPythonStreaming(r,p,_=>{!a||!_||(_==null?void 0:_.type)==="progress"&&_.message&&this.appendToLogFile(a,String(_.message),"index_redisearch","INFO")},()=>{},a,"index_redisearch")}catch(p){n+=1;let _=this.getPythonErrorMessage(p),g=this.classifyIndexingError(_);if(console.error(`Failed to reindex ${o}`,p),g==="chunks_missing"){new f.Notice(`Chunks cache missing for ${o}. Reimport or rebuild this note.`);continue}if(g==="embed_dim_mismatch"){e={kind:"embed_dim_mismatch",message:_};break}if(g==="embed_failure"){e={kind:"embed_failure",message:_};break}}}if(e){if(this.showStatusProgress("Aborted",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,e.kind==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(l){return new f.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error(l),this.lastReindexFailure="unknown",!1}this.lastReindexFailure="embed_dim_mismatch"}else new f.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing."),this.lastReindexFailure="embed_failure";return!1}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),n===0?new f.Notice(`Reindexed ${t.length} cached items.`):new f.Notice(`Reindexed ${t.length-n}/${t.length} items (see console).`);try{await this.pruneDocIndexOrphans()}catch(o){console.warn("Failed to prune doc index orphans",o)}return this.reindexCacheActive=!1,this.lastReindexFailure=null,!0}async reindexDocIdFromCache(e,n){if(this.lastReindexFailure=null,this.reindexCacheActive)return n&&new f.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;try{await this.ensureBundledTools()}catch(o){return n&&new f.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let t=(0,f.normalizePath)(`${V}/${e}.json`);if(!await this.app.vault.adapter.exists(t))return n&&new f.Notice(`Chunks cache missing for ${e}.`),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let r=this.getPluginDir(),a=E.default.join(r,"tools","index_redisearch.py"),s=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;this.showStatusProgress(`Reindexing ${e}...`,0),s&&this.appendToLogFile(s,`Reindexing doc_id ${e}`,"index_redisearch","INFO");try{let o=["--chunks-json",this.getAbsoluteVaultPath(t),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(o),this.appendEmbedContextArgs(o),this.settings.embedIncludeMetadata&&o.push("--embed-include-metadata"),this.appendChunkTaggingArgs(o,{allowRegenerate:!1}),await this.runPythonStreaming(a,o,l=>{if((l==null?void 0:l.type)==="progress"&&l.total){let d=Math.round(l.current/l.total*100),p=typeof l.message=="string"&&l.message.trim()?l.message:`Indexing chunks ${l.current}/${l.total}`;this.showStatusProgress(this.formatStatusLabel(p),d)}},()=>{},s,"index_redisearch")}catch(o){let l=this.getPythonErrorMessage(o),d=this.classifyIndexingError(l);if(console.error(`Failed to reindex ${e}`,o),d==="embed_dim_mismatch"){if(this.lastReindexFailure="embed_dim_mismatch",n&&await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),this.reindexCacheActive=!1,await this.reindexRedisFromCache()}catch(_){new f.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error(_),this.lastReindexFailure="unknown"}}else d==="embed_failure"?(this.lastReindexFailure="embed_failure",n&&new f.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing.")):n&&new f.Notice(`Failed to reindex ${e}. See console for details.`);return this.showStatusProgress("Failed",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!1}return this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!0}async reindexChunkUpdates(e,n,t,i){if(!t.length&&!i.length||!await this.ensureRedisAvailable("reindex updates"))return;let r=this.getPluginDir(),a=E.default.join(r,"tools","index_redisearch.py"),s=["--chunks-json",this.getAbsoluteVaultPath(n),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert"];this.appendEmbedSubchunkArgs(s),this.appendEmbedContextArgs(s),this.settings.embedIncludeMetadata&&s.push("--embed-include-metadata"),this.appendChunkTaggingArgs(s,{allowRegenerate:!1}),t.length&&s.push("--chunk-ids",t.join(",")),i.length&&s.push("--delete-chunk-ids",i.join(","));try{await this.runPython(a,s)}catch(o){let l=this.getPythonErrorMessage(o),d=this.classifyIndexingError(l);if(console.error(`Failed to reindex updated chunks for ${e}`,o),d==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(_){new f.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error(_)}return}d==="embed_failure"&&new f.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.")}}async promptZoteroItem(){return new Promise(e=>{new $e(this.app,this,e).open()})}async listDocIds(e){let n=this.app.vault.adapter,t=(0,f.normalizePath)(e);return await n.exists(t)?(await n.list(t)).files.filter(r=>r.endsWith(".json")).map(r=>E.default.basename(r,".json")):[]}async listMarkdownFiles(e){let n=this.app.vault.adapter,t=(0,f.normalizePath)(e);if(!await n.exists(t))return[];let i=[t],r=[];for(;i.length>0;){let a=i.pop();if(!a)continue;let s=await n.list(a);for(let o of s.files)o.endsWith(".md")&&r.push(o);for(let o of s.folders)i.push(o)}return r}extractDocIdFromFrontmatter(e){let n=e.match(/^---\s*\n([\s\S]*?)\n---/);if(!n)return null;let i=n[1].split(/\r?\n/);for(let r of i){let a=r.trim();if(!a||a.startsWith("#"))continue;let s=a.split(":");if(s.length<2)continue;let o=s[0].trim().toLowerCase();if(o!=="doc_id"&&o!=="zotero_key")continue;let d=a.slice(a.indexOf(":")+1).trim().replace(/^["']|["']$/g,"").trim();if(d)return d}return null}hasDocIdFieldInFrontmatter(e){let n=e.match(/^---\s*\n([\s\S]*?)\n---/);return n?/^\s*doc_id\s*:/im.test(n[1]):!1}ensureDocIdInFrontmatter(e,n){let t=e.trim(),i=`doc_id: ${this.escapeYamlString(n)}`;return t?/^\s*doc_id\s*:/im.test(t)?t:`${i}
${t}`:i}ensureDocIdInNoteContent(e,n){var g,y;let t=e.match(/^---\s*\n([\s\S]*?)\n---\s*\n?/),i=`doc_id: ${this.escapeYamlString(n)}`;if(!t)return`---
${i}
---

${e.trimStart()}`;let a=((g=t[1])!=null?g:"").split(/\r?\n/),s=!1,o=a.map(x=>/^\s*doc_id\s*:/i.test(x)?(s=!0,i):x);s||o.unshift(i);let l=o.join(`
`).trim(),d=(y=t.index)!=null?y:0,p=e.slice(0,d),_=e.slice(d+t[0].length).replace(/^\n+/,"");return`${p}---
${l}
---
${_}`}async findDocIdByNotePath(e){let n=(0,f.normalizePath)(e),t=await this.getDocIndex();for(let[i,r]of Object.entries(t))if(r!=null&&r.note_path&&(0,f.normalizePath)(r.note_path)===n)return i;return null}async resolveDocIdForNote(e,n){let t=this.extractDocIdFromFrontmatter(n),i=this.hasDocIdFieldInFrontmatter(n);if(t&&i)return t;let r=this.extractDocIdFromSyncMarker(n),a=await this.findDocIdByNotePath(e.path),s=t||r||a;if(!s)return de.test(n)&&!this.missingDocIdWarned.has(e.path)&&(new f.Notice("This Zotero note is missing a doc_id in frontmatter. Reimport or add doc_id manually."),this.missingDocIdWarned.add(e.path)),null;if(!i||!t){let o=this.ensureDocIdInNoteContent(n,s);o!==n&&await this.writeNoteWithSyncSuppressed(e.path,o)}return s}async scanNotesForDocIds(e){var r;let n=this.app.vault.adapter,t=await this.listMarkdownFiles(e),i={};for(let a of t)try{let s=await n.read(a),o=(r=this.extractDocIdFromFrontmatter(s))!=null?r:this.extractDocIdFromSyncMarker(s);if(!o)continue;i[o]={doc_id:o,note_path:a,note_title:E.default.basename(a,".md"),updated_at:new Date().toISOString()}}catch(s){console.error("Failed to read note for doc_id scan",s)}return i}setupStatusBar(){let e=this.addStatusBarItem();e.addClass("zrr-status-progress"),e.addClass("status-bar-item-segment"),e.style.display="none";let n=e.createEl("span",{text:"Idle"});n.addClass("zrr-status-label");let i=e.createEl("div",{cls:"zrr-status-bar"}).createEl("div",{cls:"zrr-status-bar-inner"});this.statusBarEl=e,this.statusLabelEl=n,this.statusBarInnerEl=i}showStatusProgress(e,n){if(!(!this.statusBarEl||!this.statusLabelEl||!this.statusBarInnerEl))if(this.statusBarEl.style.display="flex",this.statusLabelEl.setText(e),n===null)this.statusBarInnerEl.addClass("indeterminate"),this.statusBarInnerEl.style.width="40%";else{this.statusBarInnerEl.removeClass("indeterminate");let t=Math.max(0,Math.min(100,n));this.statusBarInnerEl.style.width=`${t}%`}}clearStatusProgress(){!this.statusBarEl||!this.statusBarInnerEl||(this.statusBarEl.style.display="none",this.statusBarInnerEl.removeClass("indeterminate"),this.statusBarInnerEl.style.width="0%")}formatStatusLabel(e,n){return n?`${e} (Text layer quality ${n})`:e}async readDoclingQualityLabel(e){var n,t,i;try{let r=await this.app.vault.adapter.read(e),a=JSON.parse(r),s=(i=(n=a==null?void 0:a.metadata)==null?void 0:n.effective_confidence_proxy)!=null?i:(t=a==null?void 0:a.metadata)==null?void 0:t.confidence_proxy;if(typeof s=="number")return s.toFixed(2)}catch(r){console.warn("Failed to read Docling quality metadata",r)}return null}async readDoclingMetadata(e){try{let n=await this.app.vault.adapter.read(e),t=JSON.parse(n),i=t==null?void 0:t.metadata;if(i&&typeof i=="object")return i}catch(n){console.warn("Failed to read Docling metadata",n)}return null}async readDoclingQualityLabelFromPdf(e,n){var t;try{let i=this.getPluginDir(),r=E.default.join(i,"tools","docling_extract.py"),a=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,s=["--quality-only","--pdf",e,"--ocr",a],o=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;o&&s.push("--log-file",o),this.settings.ocrMode==="force_low_quality"&&s.push("--force-ocr-low-quality"),s.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),n&&s.push("--language-hint",n);let l=await this.runPythonWithOutput(r,s,o),d=JSON.parse(l),p=(t=d==null?void 0:d.effective_confidence_proxy)!=null?t:d==null?void 0:d.confidence_proxy;if(typeof p=="number")return p.toFixed(2)}catch(i){console.warn("Failed to read Docling quality from PDF",i)}return null}async promptDocId(){return new Promise(e=>{new ve(this.app,"Rebuild Zotero note from cache","Enter Zotero doc_id (e.g., ABC123)",n=>e(n),"Doc ID cannot be empty.").open()})}async promptLanguageHint(){return new Promise(e=>{new je(this.app,e).open()})}registerRibbonIcons(){(0,f.addIcon)("zrr-picker",st),(0,f.addIcon)("zrr-chat",at),(0,f.addIcon)("zrr-pdf",In),this.addRibbonIcon("zrr-picker","Import Zotero item and index",()=>this.importZoteroItem()).addClass("zrr-ribbon-picker"),this.addRibbonIcon("zrr-chat","Open Zotero RAG chat",()=>this.openChatView(!0)).addClass("zrr-ribbon-chat")}async confirmOverwrite(e){return new Promise(n=>{new Ie(this.app,e,n).open()})}async resolveLanguageHint(e,n){let t=typeof e.language=="string"?e.language:"",i=this.normalizeZoteroLanguage(t);if(i)return i;let r=await this.promptLanguageHint();if(r===null)return console.info("Language selection canceled."),null;let a=this.normalizeZoteroLanguage(r);if(!a)return console.info("Language selection empty; skipping Zotero update."),"";if(e.language=a,console.info("Language selected",{language:a,itemKey:n}),n)try{await this.updateZoteroItemLanguage(n,e,a),new f.Notice("Saved language to Zotero.")}catch(s){new f.Notice("Failed to write language back to Zotero."),console.error(s)}else console.warn("Language selected but itemKey is missing; skipping Zotero update.");return a}normalizeZoteroLanguage(e){return(e||"").trim().toLowerCase()}buildDoclingLanguageHint(e){let n=this.normalizeZoteroLanguage(e!=null?e:"");if(!n)return null;let t=n.split(/[^a-z]+/).filter(Boolean),i=t.some(a=>["de","deu","ger","german"].includes(a)),r=t.some(a=>["en","eng","english"].includes(a));return i&&r?"deu+eng":i?"deu":r?"eng":t.length===1&&On[t[0]]?On[t[0]]:n}async fetchZoteroItem(e){try{let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),t=await this.requestLocalApi(n,`Zotero item fetch failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(n){return console.warn("Failed to fetch Zotero item from local API",n),this.canUseWebApi()?this.fetchZoteroItemWeb(e):null}}async fetchZoteroItemCsl(e){try{let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}?format=csljson`),t=await this.requestLocalApi(n,`Zotero CSL fetch failed for ${n}`);return this.parseCslPayload(t)}catch(n){return console.warn("Failed to fetch Zotero CSL from local API",n),this.canUseWebApi()?this.fetchZoteroItemCslWeb(e):null}}async fetchZoteroCollectionTitle(e){var r,a,s,o,l,d;let n=(e||"").trim();if(!n)return"";let t=this.collectionTitleCache.get(n);if(t!==void 0)return t;let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/collections/${n}`);try{let p=await this.requestLocalApi(i,`Zotero collection fetch failed for ${i}`),_=JSON.parse(p.toString("utf8")),g=String((s=(a=(r=_==null?void 0:_.data)==null?void 0:r.name)!=null?a:_==null?void 0:_.name)!=null?s:"").trim();return this.collectionTitleCache.set(n,g),g}catch(p){if(!this.canUseWebApi())return this.collectionTitleCache.set(n,""),"";try{let _=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/collections/${n}`),g=await this.requestWebApi(_,`Zotero Web API collection fetch failed for ${_}`),y=JSON.parse(g.toString("utf8")),x=String((d=(l=(o=y==null?void 0:y.data)==null?void 0:o.name)!=null?l:y==null?void 0:y.name)!=null?d:"").trim();return this.collectionTitleCache.set(n,x),x}catch(_){return console.warn("Failed to fetch Zotero collection title",_),this.collectionTitleCache.set(n,""),""}}}async resolveCollectionTitles(e){let t=(Array.isArray(e.collections)?e.collections:[]).map(r=>String(r||"").trim()).filter(Boolean);if(!t.length)return[];let i=[];for(let r of t){let a=await this.fetchZoteroCollectionTitle(r);a&&i.push(a)}return i}async fetchZoteroItemWeb(e){try{let n=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}`),t=await this.requestWebApi(n,`Zotero Web API fetch failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(n){return console.warn("Failed to fetch Zotero item from Web API",n),null}}async fetchZoteroItemCslWeb(e){try{let n=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}?format=csljson`),t=await this.requestWebApi(n,`Zotero Web API CSL fetch failed for ${n}`);return this.parseCslPayload(t)}catch(n){return console.warn("Failed to fetch Zotero CSL from Web API",n),null}}parseCslPayload(e){try{let n=JSON.parse(e.toString("utf8"));return Array.isArray(n)?typeof n[0]=="object"&&n[0]?n[0]:null:typeof n=="object"&&n?n:null}catch(n){return console.warn("Failed to parse CSL payload",n),null}}async searchZoteroItemsWeb(e){let n=["data,meta,children","data,meta"];for(let t of n){let i=new URLSearchParams;i.set("itemType","-attachment"),i.set("limit","25"),i.set("include",t),e.trim()&&i.set("q",e.trim());let r=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items?${i.toString()}`);try{let a=await this.requestWebApi(r,`Zotero Web API search failed for ${r}`),s=JSON.parse(a.toString("utf8"));return Array.isArray(s)?s.map(o=>{var l,d,p,_;return{key:(d=o.key)!=null?d:(l=o.data)==null?void 0:l.key,data:(p=o.data)!=null?p:{},meta:(_=o.meta)!=null?_:{}}}).filter(o=>typeof o.key=="string"&&o.key.trim().length>0):[]}catch(a){console.warn("Failed to search Zotero via web API",a)}}return[]}async updateZoteroItemLanguage(e,n,t){try{await this.updateZoteroItemLanguageLocal(e,n,t);return}catch(i){if(!this.canUseWebApi())throw i;let r=i instanceof Error?i.message:String(i);console.info("Local Zotero write failed; trying Web API",{itemKey:e,reason:r}),await this.updateZoteroItemLanguageWeb(e,n,t)}}async updateZoteroItemLanguageLocal(e,n,t){var m,h,w,P,S,L;let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),r={...n,language:t},a={"Content-Type":"application/json","Zotero-API-Version":"3"},s=typeof r.version=="number"?r.version:Number(r.version);Number.isNaN(s)||(a["If-Unmodified-Since-Version"]=String(s)),console.info("Zotero language PUT",{url:i,itemKey:e,language:t});try{let C=await this.requestLocalApiWithBody(i,"PUT",r,a,`Zotero update failed for ${i}`);console.info("Zotero language PUT response",{status:C.statusCode})}catch(C){if(!(C instanceof Error?C.message:String(C)).includes("status 501"))throw C;let I=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.info("Zotero language PUT unsupported; trying POST",{postUrl:I});let z=await this.requestLocalApiWithBody(I,"POST",[r],a,`Zotero update failed for ${I}`);console.info("Zotero language POST response",{status:z.statusCode})}let o=await this.fetchZoteroItem(e);if(this.normalizeZoteroLanguage(typeof((m=o==null?void 0:o.data)==null?void 0:m.language)=="string"?o.data.language:"")===this.normalizeZoteroLanguage(t))return;let d={...(h=o==null?void 0:o.data)!=null?h:n,language:t},p={key:e,version:(S=(P=(w=o==null?void 0:o.data)==null?void 0:w.version)!=null?P:o==null?void 0:o.version)!=null?S:s,data:d},_={...a},g=typeof p.version=="number"?p.version:Number(p.version);Number.isNaN(g)?delete _["If-Unmodified-Since-Version"]:_["If-Unmodified-Since-Version"]=String(g);let y=await this.requestLocalApiWithBody(i,"PUT",p,_,`Zotero update failed for ${i}`);console.info("Zotero language PUT retry response",{status:y.statusCode});let x=await this.fetchZoteroItem(e);if(this.normalizeZoteroLanguage(typeof((L=x==null?void 0:x.data)==null?void 0:L.language)=="string"?x.data.language:"")!==this.normalizeZoteroLanguage(t))throw new Error("Language update did not persist in Zotero.")}async updateZoteroItemLanguageWeb(e,n,t){var y,x,A,m,h;let i=this.getWebApiLibraryPath();if(!i)throw new Error("Web API library path is not configured.");let r=this.buildWebApiUrl(`/${i}/items/${e}`),a=await this.fetchZoteroItemWeb(e),s={...(y=a==null?void 0:a.data)!=null?y:n,language:t},o={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},l=(m=(A=(x=a==null?void 0:a.data)==null?void 0:x.version)!=null?A:a==null?void 0:a.version)!=null?m:n==null?void 0:n.version,d=typeof l=="number"?l:Number(l);Number.isNaN(d)||(o["If-Unmodified-Since-Version"]=String(d)),console.info("Zotero Web API language PUT",{url:r,itemKey:e,language:t});let p=await this.requestWebApiWithBody(r,"PUT",s,o,`Zotero Web API update failed for ${r}`);console.info("Zotero Web API language PUT response",{status:p.statusCode});let _=await this.fetchZoteroItemWeb(e);if(this.normalizeZoteroLanguage(typeof((h=_==null?void 0:_.data)==null?void 0:h.language)=="string"?_.data.language:"")!==this.normalizeZoteroLanguage(t))throw new Error("Language update did not persist in Zotero Web API.")}async updateZoteroItemFields(e,n,t){try{await this.updateZoteroItemFieldsLocal(e,n,t);return}catch(i){if(!this.canUseWebApi())throw i;let r=i instanceof Error?i.message:String(i);console.info("Local Zotero write failed; trying Web API",{itemKey:e,reason:r}),await this.updateZoteroItemFieldsWeb(e,n,t)}}async updateZoteroItemFieldsLocal(e,n,t){let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),r={...n,...t},a={"Content-Type":"application/json","Zotero-API-Version":"3"},s=typeof r.version=="number"?r.version:Number(r.version);Number.isNaN(s)||(a["If-Unmodified-Since-Version"]=String(s)),console.info("Zotero metadata PUT",{url:i,itemKey:e});try{let o=await this.requestLocalApiWithBody(i,"PUT",r,a,`Zotero update failed for ${i}`);console.info("Zotero metadata PUT response",{status:o.statusCode})}catch(o){if(!(o instanceof Error?o.message:String(o)).includes("status 501"))throw o;let d=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.info("Zotero metadata PUT unsupported; trying POST",{postUrl:d});let p=await this.requestLocalApiWithBody(d,"POST",[r],a,`Zotero update failed for ${d}`);console.info("Zotero metadata POST response",{status:p.statusCode})}}async updateZoteroItemFieldsWeb(e,n,t){var _,g,y,x;let i=this.getWebApiLibraryPath();if(!i)throw new Error("Web API library path is not configured.");let r=this.buildWebApiUrl(`/${i}/items/${e}`),a=await this.fetchZoteroItemWeb(e),s={...(_=a==null?void 0:a.data)!=null?_:n,...t},o={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},l=(x=(y=(g=a==null?void 0:a.data)==null?void 0:g.version)!=null?y:a==null?void 0:a.version)!=null?x:n==null?void 0:n.version,d=typeof l=="number"?l:Number(l);Number.isNaN(d)||(o["If-Unmodified-Since-Version"]=String(d)),console.info("Zotero Web API metadata PUT",{url:r,itemKey:e});let p=await this.requestWebApiWithBody(r,"PUT",s,o,`Zotero Web API update failed for ${r}`);console.info("Zotero Web API metadata PUT response",{status:p.statusCode})}sanitizeFileName(e){let n=e.replace(/[\\/:*?"<>|]/g,"").replace(/\s+/g," ").trim();return n?n.replace(/[.]+$/g,"").trim().slice(0,120):""}registerNoteRenameHandler(){this.registerEvent(this.app.vault.on("rename",async e=>{var n;if(!(!(e instanceof f.TFile)||e.extension!=="md"))try{let t=await this.app.vault.read(e),i=(n=this.extractDocIdFromFrontmatter(t))!=null?n:this.extractDocIdFromSyncMarker(t);if(!i)return;await this.updateDocIndex({doc_id:i,note_path:e.path,note_title:E.default.basename(e.path,".md")})}catch(t){console.warn("Failed to update doc index for renamed note",t)}}))}registerNoteSyncHandler(){this.registerEvent(this.app.vault.on("modify",e=>{if(!(!(e instanceof f.TFile)||e.extension!=="md")){if(this.noteMetadataSyncSuppressed.has(e.path)){this.noteSyncSuppressed.has(e.path)&&this.scheduleNoteSync(e,2500);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2500),this.scheduleNoteMetadataSync(e,2500,"save");return}this.scheduleNoteSync(e),this.scheduleNoteMetadataSync(e,1200,"save")}}))}registerNoteOpenHandler(){this.registerEvent(this.app.workspace.on("file-open",e=>{!(e instanceof f.TFile)||e.extension!=="md"||(this.pdfSidebar.syncPdfSidebarForFile(e),this.pdfSidebar.updatePreviewScrollHandler(),this.scheduleNoteMetadataSync(e,600,"open"))}))}registerPreviewScrollSyncHandlers(){this.registerEvent(this.app.workspace.on("active-leaf-change",()=>{this.pdfSidebar.updatePreviewScrollHandler(),this.pdfSidebar.maybeSyncPendingPdf()})),this.registerEvent(this.app.workspace.on("layout-change",()=>{this.pdfSidebar.updatePreviewScrollHandler(),this.pdfSidebar.maybeSyncPendingPdf()})),this.pdfSidebar.updatePreviewScrollHandler()}registerNoteDeleteMenu(){this.registerEvent(this.app.workspace.on("file-menu",(e,n)=>{if(!(n instanceof f.TFile)||n.extension!=="md")return;let t=(0,f.normalizePath)(this.settings.outputNoteDir),i=(0,f.normalizePath)(n.path);!(t&&(i===t||i.startsWith(`${t}/`)))&&!this.isZoteroNoteFile(n)||(e.addItem(a=>{a.setTitle("Reindex note from cache").onClick(()=>this.reindexNoteFromCacheForFile(n,!0))}),e.addItem(a=>{a.setTitle("Delete Zotero note and cached data").onClick(()=>this.deleteZoteroNoteAndCacheForFile(n))}))}))}findChunkStartLine(e,n){let t=n!=null?n:e.getCursor().line;for(;t>=0;t-=1){let i=e.getLine(t);if(ae.test(i))return{line:t,text:i};if(de.test(i)||fe.test(i))break}return null}findChunkEndLine(e,n){for(let t=n;t<e.lineCount();t+=1){let i=e.getLine(t);if(Ae.test(i))return t;if(fe.test(i))break}return null}findChunkAtCursor(e,n){let t=n!=null?n:e.getCursor().line,i=this.findChunkStartLine(e,t);if(!i)return null;let r=this.findChunkEndLine(e,i.line+1);return r===null||t<i.line||t>r?null:{startLine:i.line,endLine:r,text:i.text}}toggleChunkExclude(e,n){var p;let t=this.findChunkAtCursor(e,n);if(!t){new f.Notice("No synced chunk found at cursor.");return}let i=t.text.match(ae);if(!i){new f.Notice("Invalid chunk marker.");return}let r=((p=i[1])!=null?p:"").trim(),a=t.endLine,s=!1;if(a!==null){for(let _=t.startLine+1;_<a;_+=1)if(ke.test(e.getLine(_))){s=!0;break}}let l=/\bexclude\b/i.test(r)||/\bdelete\b/i.test(r)||s;l?r=r.replace(/\b(delete|exclude)\b/gi,"").replace(/\s{2,}/g," ").trim():r=r?`${r} exclude`:"exclude";let d=`<!-- zrr:chunk${r?" "+r:""} -->`;if(d!==t.text&&e.replaceRange(d,{line:t.startLine,ch:0},{line:t.startLine,ch:t.text.length}),l&&a!==null){let _=[];for(let g=t.startLine+1;g<a;g+=1)ke.test(e.getLine(g))&&_.push(g);for(let g=_.length-1;g>=0;g-=1){let y=_[g],x=e.lineCount();y<x-1?e.replaceRange("",{line:y,ch:0},{line:y+1,ch:0}):e.replaceRange("",{line:y,ch:0},{line:y,ch:e.getLine(y).length})}}new f.Notice(l?"Chunk included.":"Chunk excluded from index.")}toggleChunkExcludeFromToolbar(e){let n=this.app.workspace.getActiveViewOfType(f.MarkdownView);if(!n){new f.Notice("No active editor found.");return}let t=Math.max(0,e-1);this.toggleChunkExclude(n.editor,t)}async openChunkTagEditor(e,n){var p,_;let t=(0,f.normalizePath)(`${V}/${e}.json`),i=this.app.vault.adapter;if(!await i.exists(t)){new f.Notice("Chunk cache not found for this document.");return}let r=await this.readChunkPayload(t);if(!r){new f.Notice("Failed to read chunk cache.");return}let a=Array.isArray(r.chunks)?r.chunks:[],s=this.resolveChunkFromPayload(a,n,e);if(!s){new f.Notice(`Chunk ${n} not found in cache.`);return}let o=(p=s.chunk_tags)!=null?p:[],l=Array.isArray(o)?o.map(g=>String(g).trim()).filter(g=>g):String(o).split(/[|,;\n]+/).map(g=>g.trim()).filter(g=>g),d=typeof s.text=="string"?s.text:String((_=s.text)!=null?_:"");new De(this.app,n,l,async g=>{g.length>0?s.chunk_tags=g:delete s.chunk_tags,await i.write(t,JSON.stringify(r,null,2)),await this.reindexChunkUpdates(e,t,[String(s.chunk_id||n)],[]),new f.Notice("Chunk tags updated.")},async()=>{if(!d.trim())return new f.Notice("Chunk has no text to tag."),null;let g=await this.renderMarkdownToIndexText(d);return this.requestChunkTags(g)}).open()}async openChunkIndexedTextPreview(e,n){var p;let t=(0,f.normalizePath)(`${V}/${e}.json`);if(!await this.app.vault.adapter.exists(t)){new f.Notice("Chunk cache not found for this document.");return}let r=await this.readChunkPayload(t);if(!r){new f.Notice("Failed to read chunk cache.");return}let a=Array.isArray(r.chunks)?r.chunks:[],s=this.resolveChunkFromPayload(a,n,e);if(!s){new f.Notice(`Chunk ${n} not found in cache.`);return}let o=typeof s.text=="string"?s.text:String((p=s.text)!=null?p:""),l=await this.renderMarkdownToIndexText(o),d=this.settings.embedIncludeMetadata?"Note: when \u201CInclude metadata in embeddings\u201D is enabled, the indexer prepends title/authors/tags/section info before embedding. The preview below shows only the chunk text.":"";new Te(this.app,`Indexed text for ${n}`,l,d).open()}async openChunkInZotero(e,n){var _,g,y,x,A,m;let t=(0,f.normalizePath)(`${V}/${e}.json`),i=this.app.vault.adapter,r=null;await i.exists(t)&&(r=await this.readChunkPayload(t));let a=Array.isArray(r==null?void 0:r.chunks)?r==null?void 0:r.chunks:[],s=this.resolveChunkFromPayload(a,n,e),o=(_=s==null?void 0:s.page_start)!=null?_:s==null?void 0:s.pageStart,l=(A=(x=(g=r==null?void 0:r.metadata)==null?void 0:g.attachment_key)!=null?x:(y=r==null?void 0:r.metadata)==null?void 0:y.attachmentKey)!=null?A:"";if(!l){let h=await this.getDocIndexEntry(e);l=(m=h==null?void 0:h.attachment_key)!=null?m:""}if(!l){new f.Notice("Attachment key not found for Zotero deeplink.");return}let d=typeof o=="number"?String(o):"",p=this.buildZoteroDeepLink(e,l,d);this.openExternalUrl(p)}async cleanChunkFromToolbar(e){let n=this.app.workspace.getActiveViewOfType(f.MarkdownView);if(!n){new f.Notice("No active editor found.");return}let t=n.editor,i=Math.max(0,e-1),r=this.findChunkAtCursor(t,i);if(!r){new f.Notice("No synced chunk found at cursor.");return}let a=[];for(let d=r.startLine+1;d<r.endLine;d+=1)a.push(t.getLine(d));let s=a.join(`
`).trim();if(!s){new f.Notice("Chunk has no text to clean.");return}this.showStatusProgress("Cleaning chunk...",null);let o=null;try{o=await this.requestOcrCleanup(s)}finally{o||this.clearStatusProgress()}if(!o)return;if(o.trim()===s.trim()){new f.Notice("Cleanup produced no changes."),this.clearStatusProgress();return}let l=`${o.trim()}
`;t.replaceRange(l,{line:r.startLine+1,ch:0},{line:r.endLine,ch:0}),this.showStatusProgress("Chunk cleaned.",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new f.Notice("Chunk cleaned.")}async requestOcrCleanup(e){var l,d,p,_,g,y,x,A,m;let n=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),t=(this.settings.llmCleanupModel||"").trim();if(!n||!t)return new f.Notice("OCR cleanup model is not configured."),this.openPluginSettings(),null;let i=Number(this.settings.llmCleanupMaxChars||0);if(i>0&&e.length>i)return new f.Notice("Chunk exceeds OCR cleanup max length. Adjust settings to clean it."),this.openPluginSettings(),null;let r=`${n}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o={model:t,temperature:Number((l=this.settings.llmCleanupTemperature)!=null?l:0),messages:[{role:"system",content:"You are an OCR cleanup assistant. Fix OCR errors without changing meaning. Do not add content. Return corrected text only. Detect footnote references and definitions and format them in Markdown as [^n] and [^n]: (for the note text). Preserve special characters and formatting. Do not create new footnotes or content; only reformat existing footnote markers/lines."},{role:"user",content:e}]};try{let h=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(o)});if(h.statusCode>=400){let L=h.body.toString("utf8");throw new Error(`Cleanup request failed (${h.statusCode}): ${L||"no response body"}`)}let w=JSON.parse(h.body.toString("utf8")),P=(m=(A=(x=(_=(p=(d=w==null?void 0:w.choices)==null?void 0:d[0])==null?void 0:p.message)==null?void 0:_.content)!=null?x:(y=(g=w==null?void 0:w.choices)==null?void 0:g[0])==null?void 0:y.text)!=null?A:w==null?void 0:w.output_text)!=null?m:"",S=String(P||"").trim();return S||(new f.Notice("Cleanup returned empty text."),null)}catch(h){return console.error("OCR cleanup failed",h),new f.Notice("OCR cleanup failed. Check the cleanup model settings."),null}}parseChunkTags(e,n){if(!e)return[];let t=e.trim(),i=[];if(t.startsWith("[")&&t.endsWith("]"))try{let s=JSON.parse(t);Array.isArray(s)&&(i=s.map(o=>String(o)))}catch(s){i=[]}i.length===0&&(i=t.split(/[,;\n]+/));let r=new Set,a=[];for(let s of i){let o=s.trim();if(o=o.replace(/^[-•\d.\)\s]+/,""),o=o.replace(/\s+/g," ").trim(),!o||o.length<2)continue;let l=o.toLowerCase();if(!r.has(l)&&(r.add(l),a.push(o),a.length>=n))break}return a}async requestChunkTags(e){var _,g,y,x,A,m,h,w,P;let n=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),t=(this.settings.llmCleanupModel||"").trim();if(!n||!t)return new f.Notice("OCR cleanup model is not configured."),this.openPluginSettings(),null;let i=e.trim().slice(0,2e3);if(!i)return[];let r=`${n}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o=5,l="Return 3 to 5 high-signal, concrete noun-phrase tags. Avoid generic terms (study, paper, method), verbs, and filler. Prefer specific entities, methods, datasets, and named concepts. Output comma-separated tags only. No extra text.",d=Number((_=this.settings.llmCleanupTemperature)!=null?_:0),p={model:t,messages:[{role:"system",content:l},{role:"user",content:i}]};Number.isFinite(d)&&(p.temperature=d),this.showStatusProgress("Generating tags...",null);try{let S=async z=>{let R=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(z)});if(R.statusCode>=400){let F=R.body.toString("utf8");throw new Error(`Tag request failed (${R.statusCode}): ${F||"no response body"}`)}return R.body},L;try{L=await S(p)}catch(z){let R=z instanceof Error?z.message:String(z);if("temperature"in p&&/temperature/i.test(R)&&/unsupported|default/i.test(R)){let F={...p};delete F.temperature,L=await S(F)}else throw z}let C=JSON.parse(L.toString("utf8")),D=(P=(w=(h=(x=(y=(g=C==null?void 0:C.choices)==null?void 0:g[0])==null?void 0:y.message)==null?void 0:x.content)!=null?h:(m=(A=C==null?void 0:C.choices)==null?void 0:A[0])==null?void 0:m.text)!=null?w:C==null?void 0:C.output_text)!=null?P:"",I=this.parseChunkTags(String(D||""),o);return I.length||new f.Notice("Tag generation returned no tags."),I}catch(S){return console.error("Tag generation failed",S),new f.Notice("Tag generation failed. Check the cleanup model settings."),null}finally{this.clearStatusProgress()}}async renderMarkdownToIndexText(e){if(!e)return"";let n=this.replaceImageMarkersForIndexPreview(e),t=document.createElement("div");try{await f.MarkdownRenderer.renderMarkdown(n,t,"",this)}catch(l){return console.warn("Failed to render markdown for index preview",l),this.normalizeIndexPreviewText(n)}let a=(t.innerHTML||"").replace(/<br\s*\/?>/gi,`
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,n=1200){let t=this.noteSyncTimers.get(e.path);t!==void 0&&window.clearTimeout(t);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},n);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,n=1200,t="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,t)},n);this.noteMetadataSyncTimers.set(e.path,r)}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=e.page_start?String(e.page_start):"",t=e.page_end?String(e.page_end):"";if(n&&(!t||n===t))return n;if(n&&t)return`${n} - ${t}`;let i=(e.pages||"").trim();if(!i)return"?";let r=i.match(/^(\d+)\s*-\s*(\d+)$/);return r?r[1]===r[2]?r[1]:`${r[1]} - ${r[2]}`:i.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,f.normalizePath)(`${V}/${s}.json`),d=this.app.vault.adapter;if(!await d.exists(l))return;let p=await this.readChunkPayload(l);if(!p)return;let _=Array.isArray(p.chunks)?p.chunks:[],g=new Map;for(let P of _){let S=typeof(P==null?void 0:P.chunk_id)=="string"?P.chunk_id:String((n=P==null?void 0:P.chunk_id)!=null?n:"");S&&g.set(S,P)}let y=new Set,x=new Set,A=new Set,m=new Set,h=!1;for(let P of o){let S=P.chunkId;if(!S)continue;y.add(S);let L=g.get(S);if(!L){console.warn(`Sync note: chunk id not found in cache (${S})`);continue}if(P.excludeFlag){L.excluded!==!0&&(L.excluded=!0,h=!0);let I=this.normalizeChunkText(P.text);I&&I!==String((t=L.text)!=null?t:"")&&(L.text=I,L.char_count=I.length,h=!0),A.add(S);continue}if(L.excluded&&(L.excluded=!1,h=!0,x.add(S)),!P.text.trim()){A.add(S),m.add(S);continue}let C=this.normalizeChunkText(P.text);if(!C){A.add(S),m.add(S);continue}let D=typeof L.text=="string"?L.text:String((i=L.text)!=null?i:"");C!==D&&(L.text=C,L.char_count=C.length,x.add(S),h=!0)}for(let P of g.keys())y.has(P)||(A.add(P),m.add(P));let w=new Set([...A,...m]);if(w.size){let P=Array.from(w).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==P){this.noteSyncPendingDeletes.set(e.path,P),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!x.size&&!A.size&&!m.size&&!h)return;m.size&&(p.chunks=_.filter(P=>{var L;let S=typeof(P==null?void 0:P.chunk_id)=="string"?P.chunk_id:String((L=P==null?void 0:P.chunk_id)!=null?L:"");return S&&!m.has(S)}),h=!0),(h||m.size)&&await d.write(l,JSON.stringify(p,null,2)),await this.reindexChunkUpdates(s,l,Array.from(x),Array.from(A)),(A.size||m.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,n){var t,i,r;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,n);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),s=await this.resolveDocIdForNote(e,a);if(!s)return;let o=(i=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter)!=null?i:{},l=this.resolveZoteroItemKey(o,s);if(!l)return;let d=await this.fetchZoteroItem(l),p=(r=d==null?void 0:d.data)!=null?r:d;if(!p||typeof p!="object")return;let _=this.extractNoteMetadata(o),g=this.extractZoteroMetadata(p),y={},x={},A=["title","short_title","date","abstract","tags","authors","editors"];for(let m of A){let h=_[m],w=g[m];if(this.metadataValuesEqual(m,h,w))continue;let P=await this.promptMetadataDecision(m,h,w);P==="note"?this.assignMetadataUpdate(x,m,h):P==="zotero"&&this.assignMetadataUpdate(y,m,w)}Object.keys(y).length>0&&await this.applyNoteMetadataUpdates(e,y),Object.keys(x).length>0&&await this.applyZoteroMetadataUpdates(l,p,_,g,x)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,n)}}resolveZoteroItemKey(e,n){let t=[e==null?void 0:e.zotero_key,e==null?void 0:e.zoteroKey,e==null?void 0:e.item_key,e==null?void 0:e.itemKey,n];for(let i of t){let r=q(i);if(r)return r}return""}extractNoteMetadata(e){var l,d,p;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString((d=(l=e==null?void 0:e.short_title)!=null?l:e==null?void 0:e.shortTitle)!=null?d:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString((p=e==null?void 0:e.abstract)!=null?p:e==null?void 0:e.abstractNote),a=this.normalizeMetadataList(e==null?void 0:e.tags),s=this.normalizeMetadataList(e==null?void 0:e.authors),o=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:n,short_title:t,date:i,abstract:r,tags:this.sanitizeObsidianTags(a),authors:s,editors:o}}extractZoteroMetadata(e){let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString(he(e)),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString(e==null?void 0:e.abstractNote),a=Array.isArray(e==null?void 0:e.creators)?e.creators:[],s=a.filter(d=>(d==null?void 0:d.creatorType)==="author").map(d=>me(d)).filter(Boolean),o=a.filter(d=>(d==null?void 0:d.creatorType)==="editor"||(d==null?void 0:d.creatorType)==="seriesEditor").map(d=>me(d)).filter(Boolean),l=Array.isArray(e==null?void 0:e.tags)?e.tags.map(d=>typeof d=="string"?d:d==null?void 0:d.tag).filter(d=>typeof d=="string"):[];return{title:n,short_title:t,date:i,abstract:r,tags:this.sanitizeObsidianTags(l),authors:this.normalizeMetadataList(s),editors:this.normalizeMetadataList(o)}}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
`):this.normalizeMetadataString(e)}async promptMetadataDecision(e,n,t){let i={title:"Title",short_title:"Short title",date:"Date",abstract:"Abstract",tags:"Tags",authors:"Authors",editors:"Editors"},r=this.isMetadataValueEmpty(n),a=this.isMetadataValueEmpty(t),s="Keep note",o="Keep Zotero";return r&&!a?(s="Delete in Zotero",o="Use Zotero value"):!r&&a&&(s="Update Zotero from note",o="Clear note"),new Promise(l=>{new Me(this.app,i[e],s,o,this.formatMetadataValue(n),this.formatMetadataValue(t),l).open()})}async applyNoteMetadataUpdates(e,n){if(!Object.keys(n).length)return;let t=e.path;this.noteSyncSuppressed.add(t),this.noteMetadataSyncSuppressed.add(t);try{await this.app.fileManager.processFrontMatter(e,i=>{var r,a,s,o;"title"in n&&(i.title=(r=n.title)!=null?r:""),"short_title"in n&&(i.short_title=(a=n.short_title)!=null?a:""),"date"in n&&(i.date=(s=n.date)!=null?s:""),"abstract"in n&&(i.abstract=(o=n.abstract)!=null?o:""),"tags"in n&&(i.tags=Array.isArray(n.tags)?n.tags:[]),"authors"in n&&(i.authors=Array.isArray(n.authors)?n.authors:[]),"editors"in n&&(i.editors=Array.isArray(n.editors)?n.editors:[])})}catch(i){console.warn("Failed to update note frontmatter from Zotero",i)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(t),this.noteMetadataSyncSuppressed.delete(t)},1500)}}async applyZoteroMetadataUpdates(e,n,t,i,r){var s,o,l,d;if(!Object.keys(r).length)return;let a={};if("title"in r&&(a.title=(s=r.title)!=null?s:""),"short_title"in r&&(a.shortTitle=(o=r.short_title)!=null?o:""),"date"in r&&(a.date=(l=r.date)!=null?l:""),"abstract"in r&&(a.abstractNote=(d=r.abstract)!=null?d:""),"tags"in r&&(a.tags=this.buildZoteroTags(t.tags,n==null?void 0:n.tags)),"authors"in r||"editors"in r){let p="authors"in r?t.authors:i.authors,_="editors"in r?t.editors:i.editors;a.creators=this.buildZoteroCreators(p,_,Array.isArray(n==null?void 0:n.creators)?n.creators:[])}await this.updateZoteroItemFields(e,n,a)}buildZoteroTags(e,n){let t=this.sanitizeObsidianTags(e),i=Array.from(new Set(t)),r=i.map(l=>({tag:l,type:0})),a=new Set(i),o=(Array.isArray(n)?n.filter(l=>l&&typeof l=="object"&&Number(l.type)===1).filter(l=>typeof l.tag=="string"):[]).filter(l=>!a.has(String(l.tag)));return[...r,...o]}buildZoteroCreators(e,n,t){let i=new Map;for(let o of t){if((o==null?void 0:o.creatorType)!=="editor"&&(o==null?void 0:o.creatorType)!=="seriesEditor")continue;let l=me(o);l&&i.set(l.trim().toLowerCase(),o.creatorType)}let r=t.filter(o=>(o==null?void 0:o.creatorType)!=="author"&&(o==null?void 0:o.creatorType)!=="editor"&&(o==null?void 0:o.creatorType)!=="seriesEditor"),a=e.map(o=>o.trim()).filter(Boolean).map(o=>({creatorType:"author",...this.parseCreatorName(o)})),s=n.map(o=>o.trim()).filter(Boolean).map(o=>{var l;return{creatorType:(l=i.get(o.trim().toLowerCase()))!=null?l:"editor",...this.parseCreatorName(o)}});return[...a,...s,...r]}parseCreatorName(e){var a;let n=String(e||"").trim();if(!n)return{name:""};if(n.includes(",")){let[s,o]=n.split(",",2).map(l=>l.trim());if(s&&o)return{firstName:o,lastName:s};if(s)return{lastName:s}}let t=n.split(/\s+/).filter(Boolean);if(t.length===1)return{name:n};let i=(a=t.pop())!=null?a:"";return{firstName:t.join(" ").trim(),lastName:i}}extractSyncSection(e){let n=de.exec(e);if(!n)return null;let t=e.slice(n.index+n[0].length),i=fe.exec(t);return i?t.slice(0,i.index):null}extractDocIdFromSyncMarker(e){var r;let n=de.exec(e);if(!n)return null;let i=((r=n[0])!=null?r:"").match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return i?i[2].trim():null}parseSyncedChunkBlocks(e){var o;let n=e.split(/\r?\n/),t=[],i="",r=!1,a=[],s=()=>{i&&(t.push({chunkId:i,text:a.join(`
`).trim(),excludeFlag:r}),i="",r=!1,a=[])};for(let l of n){let d=l.match(ae);if(d){s();let p=(o=d[1])!=null?o:"",_=p.match(/id=([\"']?)([^\"'\s]+)\1/i),g=_?_[2].trim():"";if(!g)continue;i=g,r=/\bexclude\b/i.test(p)||/\bdelete\b/i.test(p),a=[];continue}if(Ae.test(l)){s();continue}if(i){if(ke.test(l)){r=!0;continue}a.push(l)}}return s(),t}normalizeChunkText(e){return e.split(/\r?\n/).map(n=>n.replace(/\s+/g," ").trim()).filter((n,t,i)=>!(n===""&&i[t-1]==="")).join(`
`).trim()}buildSyncedDoclingContent(e,n,t){var s;let i=Array.isArray(n==null?void 0:n.chunks)?n==null?void 0:n.chunks:[];if(!i.length)return`<!-- zrr:sync-start doc_id=${e} -->
${t}
<!-- zrr:sync-end -->`;let r=i.some(o=>{if(typeof(o==null?void 0:o.section)=="string"?o.section.trim():"")return!0;let d=typeof(o==null?void 0:o.chunk_id)=="string"?o.chunk_id.trim():"";return!!(d&&!/^p\d+$/i.test(d))}),a=[`<!-- zrr:sync-start doc_id=${e} -->`];for(let o of i){let l=typeof(o==null?void 0:o.chunk_id)=="string"?o.chunk_id.trim():"";if(!l)continue;let d=Number.isFinite((s=o==null?void 0:o.page_start)!=null?s:NaN)?Number(o.page_start):null,p=!!(o!=null&&o.excluded||o!=null&&o.exclude),g=typeof(o==null?void 0:o.text)=="string"?o.text.trim():"";if(r){let m=typeof(o==null?void 0:o.section)=="string"?o.section.trim():"",h=m?`## ${m}`:"";h&&!g.startsWith("#")&&(g=g?`${h}

${g}`:h)}let y=d!==null?r?` (${d})`:` page=${d}`:"",A=` id=${l}${r?" section":""}${y}${p?" exclude":""}`;a.push(`<!-- zrr:chunk${A} -->`),g&&a.push(g),a.push("<!-- zrr:chunk end -->"),a.push("")}return a[a.length-1]===""&&a.pop(),a.push("<!-- zrr:sync-end -->"),a.join(`
`)}async readChunkPayload(e){try{let n=await this.app.vault.adapter.read(e);return JSON.parse(n)}catch(n){return console.warn("Failed to read cached chunks JSON",n),null}}resolveChunkFromPayload(e,n,t){var a;let i=this.normalizeChunkIdForNote(n,t)||n,r=new Set([n,i,`${t}:${n}`]);for(let s of e){let o=typeof(s==null?void 0:s.chunk_id)=="string"?s.chunk_id:String((a=s==null?void 0:s.chunk_id)!=null?a:"");if(o&&r.has(o))return s}return null}async writeNoteWithSyncSuppressed(e,n){this.noteSyncSuppressed.add(e);try{await this.app.vault.adapter.write(e,n)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e)},1500)}}async resolveNotePathForDocId(e){if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e);if(t!=null&&t.note_path&&await n.exists(t.note_path))return t.note_path;let r=(await this.scanNotesForDocIds(this.settings.outputNoteDir))[e];return r!=null&&r.note_path?(await this.updateDocIndex({doc_id:e,note_path:r.note_path,note_title:r.note_title}),r.note_path):null}isZoteroNoteFile(e){let n=this.app.metadataCache.getFileCache(e),t=n==null?void 0:n.frontmatter;return!!(t!=null&&t.doc_id||t!=null&&t.zotero_key)}async deleteZoteroNoteAndCacheForFile(e){var d;let n=e.path,t=await this.app.vault.read(e),i=(d=this.extractDocIdFromFrontmatter(t))!=null?d:this.extractDocIdFromSyncMarker(t);if(!i){new f.Notice("No doc_id found in this note.");return}if(!await new Promise(p=>{new Fe(this.app,n,i,p).open()}))return;let a=this.app.vault.adapter,s=(0,f.normalizePath)(`${V}/${i}.json`),o=(0,f.normalizePath)(`${Y}/${i}.json`),l=[];if(await a.exists(s)){let p=await this.readChunkPayload(s);l=(Array.isArray(p==null?void 0:p.chunks)?p==null?void 0:p.chunks:[]).map(g=>{var y;return String((y=g==null?void 0:g.chunk_id)!=null?y:"")}).map(g=>g.startsWith(`${i}:`)?g.slice(i.length+1):g).filter(g=>g)}l.length>0&&await this.reindexChunkUpdates(i,s,[],l);try{await a.exists(s)&&await a.remove(s),await a.exists(o)&&await a.remove(o),await this.removeDocIndexEntry(i),await this.app.vault.delete(e,!0),new f.Notice(`Deleted note and cache for ${i}.`)}catch(p){console.error("Failed to delete note and cached data",p),new f.Notice("Failed to delete note or cached data. See console for details.")}}async deleteZoteroNoteAndCache(){let e=this.app.workspace.getActiveViewOfType(f.MarkdownView);if(!e||!e.file){new f.Notice("No active Zotero note found.");return}await this.deleteZoteroNoteAndCacheForFile(e.file)}formatRedisSearchResults(e){let n=typeof(e==null?void 0:e.total)=="number"?e.total:0,t=typeof(e==null?void 0:e.query)=="string"?e.query:"",i=typeof(e==null?void 0:e.raw_query)=="string"?e.raw_query:"",r=e!=null&&e.field_types&&typeof e.field_types=="object"?e.field_types:null,a=!!(e!=null&&e.fallback_used),s=typeof(e==null?void 0:e.fallback_reason)=="string"?e.fallback_reason:"",o=Array.isArray(e==null?void 0:e.fallback_queries)?e.fallback_queries:[],l=Array.isArray(e==null?void 0:e.fallback_failed_fields)?e.fallback_failed_fields:[],d=Array.isArray(e==null?void 0:e.results)?e.results:[],p=[];if(p.push(`Query: ${i||t}`),t&&i&&t!==i&&p.push(`Expanded: ${t}`),p.push(`Total matches: ${n}`),r&&Object.keys(r).length>0){let _=Object.keys(r).sort().map(g=>`${g}:${r[g]}`);p.push(`Field types: {${_.join(", ")}}`)}if(a&&p.push(`Fallback: ${s||"true"}`),o.length){p.push("Fallback queries:");for(let _ of o)p.push(`  - ${_}`)}if(l.length&&p.push(`Fallback failed fields: ${l.join(", ")}`),p.push(""),!d.length)return p.push("(no results)"),p.join(`
`);for(let _ of d){let g=String(_.doc_id||"").trim(),y=String(_.chunk_id||"").trim(),x=String(_.page_start||"").trim(),A=String(_.page_end||"").trim(),m=String(_.title||"").trim(),h=String(_.section||"").trim(),w=String(_.score||"").trim(),P=String(_.authors||"").trim(),S=String(_.item_type||"").trim(),L=String(_.year||"").trim(),C=String(_.tags||"").trim(),D=String(_.chunk_tags||"").trim(),I=String(_.attachment_key||"").trim(),z=String(_.source_pdf||"").trim(),R=String(_.text||"").replace(/\s+/g," ").trim(),F=R.length>220?`${R.slice(0,220)}\u2026`:R,O=[g];y&&O.push(y),(x||A)&&O.push(`p.${x||"?"}-${A||"?"}`),p.push(O.filter(Boolean).join(" \u2022 ")),w&&p.push(`  score: ${w}`),m&&p.push(`  title: ${m}`),P&&p.push(`  authors: ${P}`),L&&p.push(`  year: ${L}`),S&&p.push(`  item_type: ${S}`),C&&p.push(`  tags: ${C}`),D&&p.push(`  chunk_tags: ${D}`),I&&p.push(`  attachment_key: ${I}`),h&&p.push(`  section: ${h}`),z&&p.push(`  source_pdf: ${z}`),F&&p.push(`  ${F}`),p.push("")}return p.join(`
...
\`\`\``;new ye(this.app,"Redis diagnostics",a||"(empty)").open()}catch(i){console.error("Redis diagnostics failed",i),new f.Notice("Redis diagnostics failed. See console for details.")}}async resolveUniqueBaseName(e,n){let t=this.app.vault.adapter,i=(0,f.normalizePath)(`${this.settings.outputNoteDir}/${e}.md`),r=(0,f.normalizePath)(`${this.settings.outputPdfDir}/${e}.pdf`),a=await t.exists(i),s=this.settings.copyPdfToVault?await t.exists(r):!1;return a||s?`${e}-${n}`:e}async searchZoteroItems(e){let n=["data,meta,children","data,meta"];for(let t of n){let i=new URLSearchParams;i.set("itemType","-attachment"),i.set("limit","25"),i.set("include",t),e.trim()&&i.set("q",e.trim());let r=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items?${i.toString()}`);try{let a=await this.requestLocalApi(r,`Zotero search failed for ${r}`),s=JSON.parse(a.toString("utf8"));return Array.isArray(s)?s.map(o=>{var l,d,p,_;return{key:(d=o.key)!=null?d:(l=o.data)==null?void 0:l.key,data:(p=o.data)!=null?p:{},meta:(_=o.meta)!=null?_:{}}}).filter(o=>typeof o.key=="string"&&o.key.trim().length>0):[]}catch(a){console.warn("Failed to search Zotero via local API",a)}}if(!this.canUseWebApi())throw new Error("Zotero search failed for all include modes.");return this.searchZoteroItemsWeb(e)}async hasProcessableAttachment(e){var r;let n=(r=e.data)!=null?r:e,t=typeof e.key=="string"?e.key:q(n.key);return t?!!await Ge(n,t,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)}):!1}async fetchZoteroChildren(e){let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/children`);try{let t=await this.requestLocalApi(n,`Zotero children request failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(t){if(console.warn("Failed to fetch Zotero children from local API",t),!this.canUseWebApi())throw t;let i=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/children`),r=await this.requestWebApi(i,`Zotero Web API children request failed for ${i}`);return JSON.parse(r.toString("utf8"))}}buildZoteroUrl(e){return`${this.settings.zoteroBaseUrl.replace(/\/$/,"")}${e}`}canUseWebApi(){return!!((this.settings.webApiBaseUrl||"").trim()&&this.settings.webApiKey&&this.settings.webApiLibraryId)}getWebApiLibraryPath(){let e=(this.settings.webApiLibraryId||"").trim();return e?`${this.settings.webApiLibraryType==="group"?"groups":"users"}/${e}`:""}buildWebApiUrl(e){return`${this.settings.webApiBaseUrl.replace(/\/$/,"")}${e}`}requestLocalApiRaw(e,n={}){return new Promise((t,i)=>{var p,_;let r=new URL(e),a=r.protocol==="https:"?qn.default:zn.default,s=(p=n.method)!=null?p:"GET",o={Accept:"*/*",...(_=n.headers)!=null?_:{}},l=n.body;if(l!==void 0&&o["Content-Length"]===void 0){let g=Buffer.isBuffer(l)?l.length:Buffer.byteLength(l);o["Content-Length"]=String(g)}let d=a.request({method:s,hostname:r.hostname,port:r.port||void 0,path:`${r.pathname}${r.search}`,headers:o},g=>{let y=[];g.on("data",x=>y.push(Buffer.from(x))),g.on("end",()=>{var A;let x=Buffer.concat(y);t({statusCode:(A=g.statusCode)!=null?A:0,headers:g.headers,body:x})})});d.on("error",i),l!==void 0&&d.write(l),d.end()})}async requestLocalApi(e,n){let t=await this.requestLocalApiRaw(e);if(t.statusCode>=400){let i=t.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}: ${i||"no response body"}`)}if(t.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}`);return t.body}async requestLocalApiWithBody(e,n,t,i,r){let a=JSON.stringify(t),s=await this.requestLocalApiRaw(e,{method:n,headers:i,body:a});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}async requestWebApi(e,n){let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},i=await this.requestLocalApiRaw(e,{headers:t});if(i.statusCode>=400){let r=i.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}: ${r||"no response body"}`)}if(i.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}`);return i.body}requestWebApiRaw(e,n={}){var i;let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey,...(i=n.headers)!=null?i:{}};return this.requestLocalApiRaw(e,{...n,headers:t})}async requestWebApiWithBody(e,n,t,i,r){let a=JSON.stringify(t),s=await this.requestLocalApiRaw(e,{method:n,headers:i,body:a});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}bufferToArrayBuffer(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}async annotateChunkJsonWithAttachmentKey(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;let r=i.metadata&&typeof i.metadata=="object"?i.metadata:{};r.attachment_key=n,i.metadata=r,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to annotate chunks JSON with attachment key",t)}}async updateChunkJsonSourcePdf(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;i.source_pdf=n,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to update chunks JSON source_pdf",t)}}buildPdfLinkFromSourcePath(e){if(!e)return"";let n=E.default.normalize(this.getVaultBasePath()),t=E.default.normalize(e),i=n.endsWith(E.default.sep)?n:`${n}${E.default.sep}`;return t.startsWith(i)?`[[${(0,f.normalizePath)(E.default.relative(n,t))}]]`:`[PDF](${(0,tn.pathToFileURL)(e).toString()})`}toVaultRelativePath(e){if(!e)return"";let n=E.default.normalize(this.getVaultBasePath()),t=E.default.normalize(e),i=n.endsWith(E.default.sep)?n:`${n}${E.default.sep}`;return t.startsWith(i)?(0,f.normalizePath)(E.default.relative(n,t)):""}async isFileAccessible(e){if(!e)return!1;try{return await j.promises.access(e),!0}catch(n){return!1}}deriveVaultPdfRelativePath(e,n,t){let i=this.toVaultRelativePath(e);if(i&&i.startsWith((0,f.normalizePath)(this.settings.outputPdfDir)))return i;let r=this.sanitizeFileName(n)||t;return(0,f.normalizePath)(`${this.settings.outputPdfDir}/${r}.pdf`)}async recoverMissingPdfFromAttachment(e,n,t,i,r,a,s){let o=await Ge(n,t,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});if(!o&&r&&(o={key:r}),!o)return null;let l=o.key||r,d=o.filePath;if(!this.settings.copyPdfToVault&&d&&await this.isFileAccessible(d))return{sourcePdf:d,attachmentKey:l};try{await this.ensureFolder(this.settings.outputPdfDir)}catch(y){return console.error("Failed to create PDF output folder",y),null}let p=this.deriveVaultPdfRelativePath(e,a,i),_;try{if(d&&await this.isFileAccessible(d))_=await j.promises.readFile(d);else if(l)_=await Ve(l,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:j.promises.readFile}),!this.settings.copyPdfToVault&&s&&new f.Notice("Local PDF path unavailable; copied PDF into vault for processing.");else return null}catch(y){return console.error("Failed to read or download PDF attachment",y),null}try{await this.app.vault.adapter.writeBinary(p,this.bufferToArrayBuffer(_))}catch(y){return console.error("Failed to write recovered PDF into vault",y),null}return{sourcePdf:this.getAbsoluteVaultPath(p),attachmentKey:l}}buildPdfLinkForNote(e,n,t){return!e&&!n?"":!this.settings.copyPdfToVault&&n?`[PDF](${this.buildZoteroDeepLink(t!=null?t:"",n)})`:this.buildPdfLinkFromSourcePath(e)}buildVaultPdfCitationLink(e,n,t){if(!e)return"";let i=this.toVaultRelativePath(e);if(!i)return"";let r=n?`#page=${n}`:"";return`[[${i}${r}|${t||i}]]`}async maybeCreateOcrLayeredPdf(e,n,t){if(!this.settings.createOcrLayeredPdf||!this.settings.copyPdfToVault||!e||!((n==null?void 0:n.ocr_used)===!0))return null;if(!this.toVaultRelativePath(e))return console.warn("OCR layered PDF requires a vault-local PDF"),null;try{await this.ensureFolder(this.settings.outputPdfDir)}catch(l){return console.warn("Failed to create OCR PDF output folder",l),null}let r=`${e}.ocr.tmp`,a=(t||(n==null?void 0:n.languages)||"eng").toString(),s=this.getPluginDir(),o=E.default.join(s,"tools","ocr_layered_pdf.py");try{return this.showStatusProgress("Creating OCR PDF...",0),await this.runPythonStreaming(o,["--pdf",e,"--out-pdf",r,"--language",a,"--progress"],l=>{if((l==null?void 0:l.type)==="progress"&&l.total){let d=Math.round(l.current/l.total*100);this.showStatusProgress(`Creating OCR PDF ${l.current}/${l.total}`,d)}},()=>{}),await j.promises.rename(r,e),e}catch(l){return console.warn("OCR layered PDF creation failed",l),null}}getMainLeaf(){let e=new Set(this.app.workspace.getLeavesOfType(be)),n=this.app.workspace.getLeavesOfType("markdown").find(i=>!e.has(i));if(n)return n;let t=this.app.workspace.getLeaf(!1);return t&&!e.has(t)?t:this.app.workspace.getLeaf("tab")}async openNoteInMain(e){let n=(0,f.normalizePath)(e),t=this.app.vault.getAbstractFileByPath(n),i=this.getMainLeaf();if(t instanceof f.TFile){await i.openFile(t,{active:!0});return}await this.app.workspace.openLinkText(n,"",!1)}findChunkLineInText(e,n){if(!e||!n)return null;let t=this.escapeRegExp(n),i=new RegExp(`<!--\\s*zrr:chunk\\b[^>]*\\bid=(["']?)${t}\\1[^>]*-->`,"i"),r=e.split(`
`);for(let a=0;a<r.length;a+=1)if(i.test(r[a]))return a;return null}async openNoteAtChunk(e,n){if(!e||!n)return!1;await this.openNoteInMain(e);let i=this.getMainLeaf().view;if(!(i instanceof f.MarkdownView))return!1;let r=i.editor,a=this.normalizeChunkIdForNote(n)||n,s=this.findChunkLineInText(r.getValue(),a);return s===null?(new f.Notice(`Chunk ${a} not found in note.`),!1):(r.setCursor({line:s,ch:0}),r.scrollIntoView({from:{line:s,ch:0},to:{line:s,ch:0}},!0),!0)}async openInternalLinkInMain(e){let n=this.getMainLeaf(),[t,i]=e.split("#"),r=(t||"").trim(),a=(i||"").trim(),s="zrr-chunk:",o=r?this.app.metadataCache.getFirstLinkpathDest(r,""):null;if(o instanceof f.TFile){let l=a.startsWith(s)?a.slice(s.length).trim():"";if(l&&await this.openNoteAtChunk(o.path,l))return;await n.openFile(o,{active:!0}),e.includes("#")&&!l&&(this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1));return}this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1)}async openNoteInNewTab(e){let n=(0,f.normalizePath)(e);await this.app.workspace.openLinkText(n,"","tab")}async openPdfInMain(e,n){if(!e)return!1;let t=E.default.normalize(this.getVaultBasePath()),i=E.default.normalize(e),r=t.endsWith(E.default.sep)?t:`${t}${E.default.sep}`;if(i.startsWith(r)){let a=(0,f.normalizePath)(E.default.relative(t,i)),s=n?`#page=${n}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}try{return window.open((0,tn.pathToFileURL)(e).toString()),!0}catch(a){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,n,t,i){if(n){let r=new URLSearchParams;t&&r.set("page",t),i&&r.set("annotation",i);let a=r.toString()?`?${r.toString()}`:"";return`zotero://open-pdf/library/items/${n}${a}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let t=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(t))return t}formatCitationsMarkdown(e){return e.length?e.map(t=>this.formatCitationMarkdown(t)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e){var p,_,g,y,x;let n=e.doc_id||"?",t=this.formatCitationPageLabel(e),i=e.annotation_key||this.extractAnnotationKey(e.chunk_id),r=e.attachment_key||((_=(p=this.docIndex)==null?void 0:p[e.doc_id||""])==null?void 0:_.attachment_key),a=e.page_start?String(e.page_start):"",s=(y=(g=this.docIndex)==null?void 0:g[e.doc_id||""])!=null?y:null,o=this.resolveCitationTitle(s,(x=s==null?void 0:s.note_path)!=null?x:null,e.doc_id),l=this.formatCitationLabel(o,t),d=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&d&&(s!=null&&s.note_path))return`- ${this.buildNoteChunkLink(s.note_path,d,l)}`;if(r){let A=this.buildZoteroDeepLink(n,r,a,i);return`- [${l}](${A})`}return`- ${l}`}buildNoteChunkLink(e,n,t){let i=(0,f.normalizePath)(e).replace(/\.md$/i,""),r=`zrr-chunk:${n}`,a=this.escapeWikiLabel(t);return`[[${i}#${r}\\|${a}]]`}escapeWikiLabel(e){return e?e.replace(/\|/g,"\\|"):""}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,f.normalizePath)(`${X}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var t;let e=this.app.vault.adapter,n=this.getDocIndexPath();if(!await e.exists(n))return{};try{let i=await e.read(n),r=JSON.parse(i);if(r&&typeof r=="object"){let a=(t=r.entries)!=null?t:r;if(Array.isArray(a)){let s={};for(let o of a)o!=null&&o.doc_id&&(s[String(o.doc_id)]=o);return s}if(a&&typeof a=="object")return a}}catch(i){console.error("Failed to read doc index",i)}return{}}async saveDocIndex(e){await this.ensureFolder(X);let n=this.app.vault.adapter,t=this.getDocIndexPath(),i={version:1,entries:e};await n.write(t,JSON.stringify(i,null,2)),this.docIndex=e}async pruneDocIndexOrphans(){var d;let e=this.app.vault.adapter,n=await this.getDocIndex(),t=new Set(await this.listDocIds(Y)),i=new Set(await this.listDocIds(V)),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),a=0,s=0,o=!1,l=new Date().toISOString();for(let p of Object.keys(n)){let _=n[p],g=!1,y=_!=null&&_.note_path?_.note_path.trim():"";if(y&&await e.exists(y))g=!0;else if((d=r[p])!=null&&d.note_path){g=!0;let A=r[p];A.note_path&&A.note_path!==_.note_path&&(_.note_path=A.note_path,s+=1,o=!0),A.note_title&&A.note_title!==_.note_title&&(_.note_title=A.note_title,s+=1,o=!0),s>0&&(_.updated_at=l)}let x=t.has(p)||i.has(p);!g&&!x&&(delete n[p],a+=1,o=!0)}return o&&await this.saveDocIndex(n),{removed:a,updated:s}}async updateDocIndex(e){var r;let n=await this.getDocIndex(),t=(r=n[e.doc_id])!=null?r:{doc_id:e.doc_id},i={...t,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&t.note_path&&(i.note_path=t.note_path),e.note_title===void 0&&t.note_title&&(i.note_title=t.note_title),e.zotero_title===void 0&&t.zotero_title&&(i.zotero_title=t.zotero_title),e.short_title===void 0&&t.short_title&&(i.short_title=t.short_title),e.pdf_path===void 0&&t.pdf_path&&(i.pdf_path=t.pdf_path),e.attachment_key===void 0&&t.attachment_key&&(i.attachment_key=t.attachment_key),n[e.doc_id]=i,await this.saveDocIndex(n)}async removeDocIndexEntry(e){let n=await this.getDocIndex();n[e]&&(delete n[e],await this.saveDocIndex(n))}async hydrateDocIndexFromCache(e){var s,o;if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e),i={},r=(0,f.normalizePath)(`${Y}/${e}.json`);if(await n.exists(r))try{let l=await n.read(r),d=JSON.parse(l),p=(o=(s=d==null?void 0:d.data)!=null?s:d)!=null?o:{},_=typeof p.title=="string"?p.title:"";_&&(i.zotero_title=_);let g=he(p);if(g&&(i.short_title=g),!i.note_title||!i.note_path){let y=this.sanitizeFileName(_)||e,x=(0,f.normalizePath)(`${this.settings.outputNoteDir}/${y}.md`),A=(0,f.normalizePath)(`${this.settings.outputNoteDir}/${y}-${e}.md`),m="";await n.exists(x)?m=x:await n.exists(A)&&(m=A),m&&(i.note_path=m,i.note_title=E.default.basename(m,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!i.note_title&&(t!=null&&t.note_path)&&(i.note_title=E.default.basename(t.note_path,".md"));let a=(0,f.normalizePath)(`${V}/${e}.json`);if(await n.exists(a))try{let l=await n.read(a),d=JSON.parse(l);typeof(d==null?void 0:d.source_pdf)=="string"&&(i.pdf_path=d.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(i).length>0&&await this.updateDocIndex({doc_id:e,...i}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var t;return e&&(t=(await this.getDocIndex())[e])!=null?t:null}async inferNotePathFromCache(e){var i,r;let n=this.app.vault.adapter,t=(0,f.normalizePath)(`${Y}/${e}.json`);if(!await n.exists(t))return"";try{let a=await n.read(t),s=JSON.parse(a),o=(r=(i=s==null?void 0:s.data)!=null?i:s)!=null?r:{},l=typeof o.title=="string"?o.title:"",d=this.sanitizeFileName(l)||e,p=(0,f.normalizePath)(`${this.settings.outputNoteDir}/${d}.md`),_=(0,f.normalizePath)(`${this.settings.outputNoteDir}/${d}-${e}.md`);if(await n.exists(p))return p;if(await n.exists(_))return _}catch(a){console.error("Failed to infer note path from cache",a)}return""}async rebuildNoteFromCacheForDocId(e,n){var R,F,O,$,J;try{await this.ensureBundledTools()}catch(T){return n&&new f.Notice("Failed to sync bundled tools. See console for details."),console.error(T),!1}let t=this.app.vault.adapter,i=(0,f.normalizePath)(`${Y}/${e}.json`),r=(0,f.normalizePath)(`${V}/${e}.json`);if(!await t.exists(i)||!await t.exists(r))return n&&new f.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let a;try{let T=await t.read(i);a=JSON.parse(T)}catch(T){return n&&new f.Notice("Failed to read cached item JSON."),console.error(T),this.clearStatusProgress(),!1}let s;try{let T=await t.read(r);s=JSON.parse(T)}catch(T){return n&&new f.Notice("Failed to read cached chunks JSON."),console.error(T),this.clearStatusProgress(),!1}let o=(R=a.data)!=null?R:a,l=typeof o.title=="string"?o.title:"",d=((O=(F=a.key)!=null?F:o.key)!=null?O:e).toString(),p=await this.getDocIndexEntry(e),_=typeof(($=s==null?void 0:s.metadata)==null?void 0:$.attachment_key)=="string"?s.metadata.attachment_key:p==null?void 0:p.attachment_key,g=typeof s.source_pdf=="string"?s.source_pdf:"";if(!g||!await this.isFileAccessible(g)){let T=await this.recoverMissingPdfFromAttachment(g,o,d,e,_,l,n);if(!T)return n&&new f.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;g=T.sourcePdf,T.attachmentKey&&(_=T.attachmentKey),await this.updateChunkJsonSourcePdf(r,g)}let y=await this.resolveLanguageHint(o,d),x=this.buildDoclingLanguageHint(y!=null?y:void 0),A="";if(p!=null&&p.note_path&&await t.exists(p.note_path)&&(A=(0,f.normalizePath)(p.note_path)),!A){let T=this.sanitizeFileName(l)||e,M=(0,f.normalizePath)(`${this.settings.outputNoteDir}/${T}.md`),H=await t.exists(M)?T:await this.resolveUniqueBaseName(T,e);A=(0,f.normalizePath)(`${this.settings.outputNoteDir}/${H}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let T=this.getLogFileRelativePath(),M=(0,f.normalizePath)(E.default.dirname(T));M&&await this.ensureFolder(M);let H=this.getSpellcheckerInfoRelativePath(),Z=(0,f.normalizePath)(E.default.dirname(H));Z&&await this.ensureFolder(Z)}}catch(T){return n&&new f.Notice("Failed to create notes folder."),console.error(T),this.clearStatusProgress(),!1}let m=this.getPluginDir(),h=E.default.join(m,"tools","docling_extract.py"),w=E.default.join(m,"tools","index_redisearch.py"),P=null,S=null,L=T=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=T)};try{P=await this.readDoclingQualityLabelFromPdf(g,x),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",P),0);let T=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(h,await this.buildDoclingArgs(g,e,r,A,x,!0),Z=>this.handleDoclingProgress(Z,P),()=>{},T,"docling_extract",L),this.recreateMissingNotesProcess=null,P=await this.readDoclingQualityLabel(r),_&&await this.annotateChunkJsonWithAttachmentKey(r,_);let M=await this.readDoclingMetadata(r),H=await this.maybeCreateOcrLayeredPdf(g,M,x);H&&(g=H,S=H,await this.updateChunkJsonSourcePdf(r,H))}catch(T){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(n&&new f.Notice("Docling extraction failed. See console for details."),console.error(T),this.clearStatusProgress(),!1)}let C=!1,D=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;if(!await this.ensureRedisAvailable("rebuild"))C=!0,n&&new f.Notice("Redis is unavailable; skipping indexing for this note.");else try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",P),0);let T=["--chunks-json",this.getAbsoluteVaultPath(r),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(T),this.appendEmbedContextArgs(T),this.settings.embedIncludeMetadata&&T.push("--embed-include-metadata"),this.appendChunkTaggingArgs(T,{allowRegenerate:!1}),await this.runPythonStreaming(w,T,M=>{if((M==null?void 0:M.type)==="progress"&&M.total){let H=Math.round(M.current/M.total*100),Z=typeof M.message=="string"&&M.message.trim()?M.message:`Indexing chunks ${M.current}/${M.total}`,K=this.formatStatusLabel(Z,P);this.showStatusProgress(K,H)}},()=>{},D,"index_redisearch",L),this.recreateMissingNotesProcess=null}catch(T){if(this.recreateMissingNotesAbort)return this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1;n&&new f.Notice("RedisSearch indexing failed; note will still be rebuilt."),console.error(T),C=!0}let z=S?this.buildPdfLinkFromSourcePath(S):this.buildPdfLinkForNote(g,p==null?void 0:p.attachment_key,e);try{let T=await this.app.vault.adapter.read(A),M=await this.readChunkPayload(r),H=this.buildSyncedDoclingContent(e,M,T),Z=await this.buildNoteMarkdown(o,(J=a.meta)!=null?J:{},e,z,_,i,H);await this.writeNoteWithSyncSuppressed(A,Z)}catch(T){return n&&new f.Notice("Failed to finalize note markdown."),console.error(T),this.clearStatusProgress(),!1}try{let T=he(o);await this.updateDocIndex({doc_id:e,note_path:A,note_title:E.default.basename(A,".md"),zotero_title:l,short_title:T||void 0,pdf_path:g})}catch(T){console.error("Failed to update doc index",T)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],n=await this.fetchZoteroGroupOptions();return n.length&&e.push(...n),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),n=[],t=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!t)return e&&n.push({value:e,label:e}),n;let i=(this.settings.embedApiKey||"").trim(),r=await this.fetchModelIds(t,i);if(r.length){let a=r.filter(o=>/embed/i.test(o)),s=a.length?a:r;n.push(...s.map(o=>({value:o,label:o})))}return!n.length&&e&&n.push({value:e,label:e}),n.sort((a,s)=>a.label.localeCompare(s.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,n,t){let i=t==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),r=[],a=(e||"").trim().replace(/\/$/,"");if(!a)return i&&r.push({value:i,label:i}),r;let s=(n||"").trim(),o=await this.fetchModelIds(a,s);if(o.length){let l=o.filter(p=>!/embed/i.test(p)),d=l.length?l:o;r.push(...d.map(p=>({value:p,label:p})))}return!r.length&&i&&r.push({value:i,label:i}),r.sort((l,d)=>l.label.localeCompare(d.label))}detectEmbeddingProvider(e){let n=e.toLowerCase();return n.includes("anthropic")?"anthropic":n.includes("openrouter")?"openrouter":n.includes("ollama")||n.includes(":11434")?"ollama":n.includes("openai")?"openai":"generic"}async fetchModelIds(e,n){let t=this.detectEmbeddingProvider(e);try{if(t==="anthropic")return await this.fetchAnthropicModels(e,n);let i=await this.fetchOpenAiCompatibleModels(e,n);return!i.length&&t==="ollama"?await this.fetchOllamaModels(e):i}catch(i){return console.warn("Failed to fetch models",i),[]}}async fetchOpenAiCompatibleModels(e,n){let t=`${e}/models`,i={};n&&(i.Authorization=`Bearer ${n}`);let r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}async fetchOllamaModels(e){let t=`${e.replace(/\/v1\/?$/,"")}/api/tags`,i=await this.requestLocalApiRaw(t);if(i.statusCode>=400)throw new Error(`Ollama tags request failed (${i.statusCode})`);let r;try{r=JSON.parse(i.body.toString("utf8"))}catch(s){return console.warn("Failed to parse Ollama tags response",s),[]}if(!r||typeof r!="object")return[];let a=r.models;return Array.isArray(a)?a.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}async fetchAnthropicModels(e,n){if(!n)return[];let t=`${e}/models`,i={"x-api-key":n,"anthropic-version":"2023-06-01"},r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Anthropic model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}extractModelIds(e){var i,r,a;if(Array.isArray(e))return e.map(s=>this.extractModelId(s)).filter(s=>!!s);if(!e||typeof e!="object")return[];let n=e,t=(a=(r=(i=n.data)!=null?i:n.models)!=null?r:n.model)!=null?a:n.items;return Array.isArray(t)?t.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}extractModelId(e){var r,a,s;if(!e||typeof e!="object")return null;let n=e,t=(s=(a=(r=n.id)!=null?r:n.name)!=null?a:n.model)!=null?s:n.identifier;return typeof t!="string"?null:t.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,n=i=>{for(let r of i)e.has(r.value)||e.set(r.value,r.label)};if(await this.warnIfZoteroLocalApiUnavailable("Zotero groups"))try{let i=this.buildZoteroUrl("/users/0/groups"),r=await this.requestLocalApi(i,`Zotero groups fetch failed for ${i}`);n(this.parseZoteroGroupOptions(r))}catch(i){console.warn("Failed to fetch Zotero groups from local API",i)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let i=(this.settings.webApiLibraryId||"").trim();if(i)try{let r=this.buildWebApiUrl(`/users/${i}/groups`),a=await this.requestWebApi(r,`Zotero Web API groups fetch failed for ${r}`);n(this.parseZoteroGroupOptions(a))}catch(r){console.warn("Failed to fetch Zotero groups from Web API",r)}}return Array.from(e.entries()).map(([i,r])=>({value:i,label:r})).sort((i,r)=>i.label.localeCompare(r.label))}parseZoteroGroupOptions(e){var i,r,a,s,o;let n;try{n=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(n))return[];let t=[];for(let l of n){if(!l||typeof l!="object")continue;let d=(i=l.data)!=null?i:l,p=(a=(r=d.id)!=null?r:l.id)!=null?a:d.key;if(!p)continue;let _=String(p).trim();if(!_)continue;let g=(o=(s=d.name)!=null?s:l.name)!=null?o:_,y=String(g||_).trim()||_;t.push({value:`groups/${_}`,label:`Group: ${y}`})}return t}async ensureFolder(e){let n=this.app.vault.adapter,t=(0,f.normalizePath)(e).split("/").filter(Boolean),i="";for(let r of t)i=i?`${i}/${r}`:r,await n.exists(i)||await n.mkdir(i)}async buildNoteMarkdown(e,n,t,i,r,a,s){let o=`[[${a}]]`,l=this.settings.copyPdfToVault&&i.startsWith("[["),d=r?this.buildZoteroDeepLink(t,r):"",p=d||i,_=l?i:d||i,g=_?l?`PDF: !${_}`:`PDF: ${_}`:"",y=g?`${g}

`:"",x=await this.buildTemplateVars(e,n,t,p,o);x.pdf_block=y,x.pdf_line=g,x.docling_markdown=s;let A=this.ensureDocIdInFrontmatter(await this.renderFrontmatter(e,n,t,p,o,x),t),m=A?`---
${A}
---

`:"",h=(this.settings.noteBodyTemplate||"").trim(),w=`${y}${s}`,P=h?this.renderTemplate(h,x,w,{appendDocling:!0}):w;return`${m}${P}`}async renderFrontmatter(e,n,t,i,r,a){var d;let s=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,n,t,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim();return this.stripEmptyFrontmatterFields(l)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let n=e.split(/\r?\n/),t=[],i=/^([A-Za-z0-9_-]+)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<n.length;){let l=n[o],d=l.match(i);if(!d){t.push(l),o+=1;continue}let p=d[1],_=d[2].trim();if(a.has(p)){t.push(l),o+=1;continue}if(!s(_)){t.push(l),o+=1;continue}let g=o+1,y=[];for(;g<n.length&&n[g].match(r);)y.push(n[g]),g+=1;if(y.length===0){for(o=g;o<n.length&&n[o].trim()==="";)o+=1;continue}let x=y.filter(A=>{let m=A.match(r);if(!m)return!1;let h=m[1].trim();return!s(h)});if(x.length>0&&t.push(l,...x),o=g,x.length===0)for(;o<n.length&&n[o].trim()==="";)o+=1}for(;t.length>0&&t[t.length-1].trim()==="";)t.pop();return t.join(`
...
${n.docling_markdown}`),r.trim()?r:t}async buildTemplateVars(e,n,t,i,r){let a=q(e.title),s=q(e.shortTitle),o=q(e.date),l=typeof(n==null?void 0:n.parsedDate)=="string"?n.parsedDate:"",d=Ye(l||o),p=/^\d{4}$/.test(d)?d:"",_=Array.isArray(e.creators)?e.creators:[],g=_.filter(v=>v.creatorType==="author").map(v=>me(v)),y=g.join("; "),x=_.filter(v=>v.creatorType==="editor"||v.creatorType==="seriesEditor").map(v=>me(v)),A=x.join("; "),m=Array.isArray(e.tags)?e.tags.map(v=>typeof v=="string"?v:v==null?void 0:v.tag).filter(Boolean):[],h=this.sanitizeObsidianTags(m),w=h.join("; "),P=await this.resolveCollectionTitles(e),S=P.join("; "),L=this.toObsidianLinks(P),C=L.join("; "),D=q(e.itemType),I=typeof(n==null?void 0:n.creatorSummary)=="string"?n.creatorSummary:"",z=q(e.publicationTitle),R=q(e.bookTitle),F=q(e.journalAbbreviation),O=q(e.volume),$=q(e.issue),J=q(e.pages),T=q(e.dateAdded),M=q(e.dateModified),H=typeof e.key=="string"?e.key:t,Z=q(e.DOI);Z||(Z=Pn(e));let K=kn(e,n),pe=null;(!Z||!s||!K)&&(pe=await this.fetchZoteroItemCsl(H)),Z||(Z=Cn(pe)),s||(s=wn(pe)),K||(K=vn(pe));let oe=q(e.ISBN),ie=q(e.ISSN),ue=q(e.publisher),_e=q(e.place),Ze=q(e.url),He=q(e.language),Ce=q(e.abstractNote),ne=this.buildZoteroDeepLink(H),xe=Array.from(new Set([K,s,Z].map(v=>String(v||"").trim()).filter(v=>v.length>0))),k=xe.join("; "),b={doc_id:t,zotero_key:typeof e.key=="string"?e.key:t,item_link:ne,citekey:K,title:a,short_title:s,date:o,year:d,year_number:p,authors:y,editors:A,aliases:k,tags:w,collection_title:S,collection_titles:S,collections_links:C,item_type:D,creator_summary:I,publication_title:z,book_title:R,journal_abbrev:F,volume:O,issue:$,pages:J,date_added:T,date_modified:M,doi:Z,isbn:oe,issn:ie,publisher:ue,place:_e,url:Ze,language:He,abstract:Ce,pdf_link:i,item_json:r};for(let[v,G]of Object.entries(b)){let re=this.escapeYamlString(G);b[`${v}_yaml`]=re,b[`${v}_quoted`]=re,b[`${v}_text`]=re}return b.authors_yaml_list=this.toYamlList(g),b.editors_yaml_list=this.toYamlList(x),b.tags_yaml_list=h.length>0?this.toYamlList(h):"",b.aliases_yaml_list=xe.length>0?this.toYamlList(xe):"",b.collections_yaml_list=this.toYamlList(P),b.collections_links_yaml_list=this.toYamlList(L),b.tags_raw=m.join("; "),b.tags_raw_yaml=this.escapeYamlString(b.tags_raw),b.tags_raw_yaml_list=m.length>0?this.toYamlList(m):"",b.authors_list=b.authors_yaml_list,b.editors_list=b.editors_yaml_list,b.tags_list=b.tags_yaml_list,b.aliases_list=b.aliases_yaml_list,b.collections_list=b.collections_yaml_list,b.collections_links_list=b.collections_links_yaml_list,b}escapeYamlString(e){return`"${String(e).replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n")}"`}toYamlList(e){return e.length?e.map(n=>`  - ${this.escapeYamlString(n)}`).join(`
`):'  - ""'}sanitizeObsidianTags(e){let n=this.settings.tagSanitizeMode||"kebab",t=n==="replace"?"kebab":n;return e.map(i=>this.sanitizeObsidianTag(i,t)).filter(i=>i.length>0)}sanitizeObsidianTag(e,n){let t=String(e||"").trim();if(!t)return"";let i=t.replace(/^#+/,"");if(n==="none")return i;let r=o=>!/^\d+$/.test(o),s=(o=>i.split("/").map(p=>{let g=p.replace(/[^\p{L}\p{N}]+/gu," ").split(/\s+/).filter(Boolean);if(!g.length)return"";if(o==="camel"||o==="pascal"){let[x,...A]=g;return[o==="pascal"?x.charAt(0).toUpperCase()+x.slice(1):x.charAt(0).toLowerCase()+x.slice(1),...A.map(h=>h.charAt(0).toUpperCase()+h.slice(1))].join("")}let y=o==="snake"?"_":"-";return g.join(y)}).filter(Boolean).join("/").replace(/\/{2,}/g,"/").replace(/^\/+|\/+$/g,""))(n);return s&&r(s)?s:""}toObsidianLinks(e){return e.map(n=>String(n||"").trim()).filter(n=>n.length>0).map(n=>n.startsWith("[[")&&n.endsWith("]]")?n:`[[${n}]]`)}getVaultBasePath(){var t;let e=this.app.vault.adapter;if(e instanceof f.FileSystemAdapter)return e.getBasePath();let n=(t=e.getBasePath)==null?void 0:t.call(e);if(n)return n;throw new Error("Vault base path is unavailable.")}getPluginDir(){var i;let e=this.getVaultBasePath(),n=(i=this.manifest.dir)!=null?i:this.manifest.id;if(!n)throw new Error("Plugin directory is unavailable.");let t=E.default.isAbsolute(n)?n:E.default.join(e,n);return E.default.normalize(t)}async ensureBundledTools(){let e=this.getPluginDir(),n=E.default.join(e,"tools");await j.promises.mkdir(n,{recursive:!0});for(let[t,i]of Object.entries(Rn)){let r=E.default.join(n,t),a=!0;try{await j.promises.readFile(r,"utf8")===i&&(a=!1)}catch(s){}a&&await j.promises.writeFile(r,i,"utf8")}}async migrateCachePaths(){let e="zotero/items",n="zotero/chunks",t=Y,i=V,r=this.app.vault.adapter,a=(0,f.normalizePath)(e),s=(0,f.normalizePath)(n),o=(0,f.normalizePath)(t),l=(0,f.normalizePath)(i),d=o.split("/").slice(0,-1).join("/"),p=l.split("/").slice(0,-1).join("/");d&&await this.ensureFolder(d),p&&await this.ensureFolder(p);let _=await r.exists(a),g=await r.exists(s),y=await r.exists(o),x=await r.exists(l);_&&!y&&await r.rename(a,o),g&&!x&&await r.rename(s,l)}getAbsoluteVaultPath(e){let n=this.getVaultBasePath(),t=E.default.isAbsolute(e)?e:E.default.join(n,e);return E.default.normalize(t)}async resolveAttachmentOutputDir(e){let n=e?E.default.isAbsolute(e)?this.toVaultRelativePath(e):(0,f.normalizePath)(e):"";if(!n)return null;let t=this.app.fileManager;if(!(t!=null&&t.getAvailablePathForAttachment))return null;try{let i=`zrr-image-${Date.now()}.png`,r=await t.getAvailablePathForAttachment(i,n);if(!r)return null;let a=E.default.isAbsolute(r)?r:this.getAbsoluteVaultPath(r),s=E.default.normalize(E.default.dirname(a)),o=E.default.normalize(this.getVaultBasePath()),l=this.toVaultRelativePath(s);return!l&&s!==o?null:{absolute:s,relative:l}}catch(i){return console.warn("Failed to resolve attachment output dir",i),null}}async buildDoclingArgs(e,n,t,i,r,a=!1){let s=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",n,"--out-json",this.getAbsoluteVaultPath(t),"--out-md",this.getAbsoluteVaultPath(i),"--chunking",this.settings.chunkingMode,"--ocr",s];a&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),this.settings.forcePerPageOcr&&o.push("--force-per-page-ocr"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),r&&o.push("--language-hint",r),this.settings.enableLlmCleanup&&(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars)));let l=this.getPluginDir(),d=E.default.join(l,"tools","ocr_wordlist.txt");if((0,j.existsSync)(d)&&o.push("--enable-dictionary-correction","--dictionary-path",d),this.settings.enableFileLogging){let _=this.getLogFileAbsolutePath();_&&o.push("--log-file",_);let g=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());g&&o.push("--spellchecker-info-out",g)}let p=await this.resolveAttachmentOutputDir(i);return p&&(p.relative&&await this.ensureFolder(p.relative),o.push("--image-output-dir",p.absolute)),this.appendOcrEngineArgs(o),o}appendOcrEngineArgs(e){let n=this.settings.ocrEngine,t=(this.settings.paddleApiKey||"").trim(),i=(this.settings.paddleVlApiUrl||"").trim(),r=(this.settings.paddleStructureApiUrl||"").trim(),a=o=>{e.push("--prefer-ocr-engine",o,"--fallback-ocr-engine",o)},s=()=>{e.push("--no-paddle-vl-api","--no-paddle-structure-api")};switch(n){case"tesseract":a("tesseract"),e.push("--no-paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_local":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl"),s();break;case"paddle_vl_local":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_api":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl","--no-paddle-vl-api"),t?(e.push("--paddle-structure-api","--paddle-structure-api-token",t),r&&e.push("--paddle-structure-api-url",r)):e.push("--no-paddle-structure-api");break;case"paddle_vl_api":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3","--no-paddle-structure-api"),t?(e.push("--paddle-vl-api","--paddle-vl-api-token",t),i&&e.push("--paddle-vl-api-url",i)):e.push("--no-paddle-vl-api");break;default:s();break}}appendEmbedSubchunkArgs(e){let n=this.settings.embedSubchunkChars;Number.isFinite(n)&&e.push("--embed-subchunk-chars",String(Math.max(0,Math.trunc(n))));let t=this.settings.embedSubchunkOverlap;Number.isFinite(t)&&e.push("--embed-subchunk-overlap",String(Math.max(0,Math.trunc(t))))}appendEmbedContextArgs(e){let n=this.settings.embedContextWindow;Number.isFinite(n)&&e.push("--embed-context-window",String(Math.max(0,Math.trunc(n))));let t=this.settings.embedContextChars;Number.isFinite(t)&&e.push("--embed-context-chars",String(Math.max(0,Math.trunc(t))))}appendChunkTaggingArgs(e,n){if((n==null?void 0:n.allowRegenerate)===!1||!this.settings.enableChunkTagging)return;let t=(this.settings.llmCleanupBaseUrl||"").trim(),i=(this.settings.llmCleanupModel||"").trim();if(!t||!i)return;e.push("--generate-chunk-tags","--tag-base-url",t,"--tag-model",i);let r=(this.settings.llmCleanupApiKey||"").trim();r&&e.push("--tag-api-key",r),e.push("--tag-temperature",String(this.settings.llmCleanupTemperature))}getRedisDataDir(){let e=(process.env.ZRR_DATA_DIR||"").trim();if(e)return e;let n=(this.settings.redisDataDirOverride||"").trim();return!this.settings.autoAssignRedisPort&&n?E.default.isAbsolute(n)?n:E.default.join(this.getVaultBasePath(),n):E.default.join(this.getVaultBasePath(),X,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return E.default.join(e,"tools","docker-compose.yml")}async resolveDockerPath(){var l;let e=(l=this.settings.dockerPath)==null?void 0:l.trim(),n=["/opt/homebrew/bin/docker","/usr/local/bin/docker","/usr/bin/docker","/Applications/Docker.app/Contents/Resources/bin/docker"],t=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"],i=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"],r=[];e&&r.push(e);let a=e?this.getContainerCliKind(e):"docker",s=a==="podman-compose"?[i,t,n]:a==="podman"?[t,i,n]:[n,t,i];if(!e||e==="docker"||e==="podman"||e==="podman-compose")for(let d of s)r.push(...d);for(let d of r)if(E.default.isAbsolute(d))try{if(await this.isContainerCliAvailable(d))return d}catch(p){}let o=[e,a==="podman"?"podman":"docker",a==="podman"?"docker":"podman","podman-compose"].filter(d=>!!(d&&d.trim()));for(let d of o)if(await this.isContainerCliAvailable(d))return d;return e||"docker"}async isContainerCliAvailable(e){return new Promise(n=>{let t=(0,Q.spawn)(e,["--version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}getContainerCliKind(e){let n=E.default.basename(e);return n==="podman-compose"?"podman-compose":n.includes("podman")?"podman":"docker"}async isContainerDaemonRunning(e){let n=this.getContainerCliKind(e),t=e,i=["info"];if(n==="podman-compose"){let r=await this.resolvePodmanBin();if(!r)return!1;t=r}return new Promise(r=>{let a=(0,Q.spawn)(t,i),s=!1,o=d=>{s||(s=!0,r(d))},l=setTimeout(()=>{a.kill(),o(!1)},2e3);a.on("error",()=>{clearTimeout(l),o(!1)}),a.on("close",d=>{clearTimeout(l),o(d===0)})})}getContainerDaemonHint(e){let n=this.getContainerCliKind(e);return n==="podman"||n==="podman-compose"?"Podman machine not running. Run `podman machine start`.":"Docker Desktop is not running. Start Docker Desktop."}async supportsComposeSubcommand(e){return new Promise(n=>{let t=(0,Q.spawn)(e,["compose","version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}async findPodmanComposePath(){let e=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"];for(let n of e)try{return await j.promises.access(n),n}catch(t){}return await this.isContainerCliAvailable("podman-compose")?"podman-compose":null}async resolvePodmanBin(){let e=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"];for(let n of e)if(await this.isContainerCliAvailable(n))return n;return await this.isContainerCliAvailable("podman")?"podman":null}async resolveComposeCommand(e){let n=E.default.basename(e);if(n==="podman-compose")return{command:e,argsPrefix:[]};if(n==="podman"){let t=await this.findPodmanComposePath();return t?{command:t,argsPrefix:[]}:await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}return await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}async autoDetectContainerCliOnLoad(){var a;let e=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(e)){this.notifyContainerOnce("Docker or Podman not found. Install Docker Desktop or Podman and set Docker/Podman path in settings.");return}let n=((a=this.settings.dockerPath)==null?void 0:a.trim())||"docker";(!await this.isContainerCliAvailable(n)||n==="docker"||n==="podman"||n==="podman-compose")&&e&&e!==n&&(this.settings.dockerPath=e,await this.saveSettings());let r=s=>new Promise(o=>setTimeout(o,s));if(!await this.isContainerDaemonRunning(e)){for(let s of[5e3,1e4])if(await r(s),await this.isContainerDaemonRunning(e))return;this.notifyContainerOnce(this.getContainerDaemonHint(e))}}getDockerProjectName(){let e=s=>s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,32),n=(process.env.ZRR_PROJECT_NAME||"").trim();if(n&&!this.settings.autoAssignRedisPort)return e(n)||"zrr";let t=(this.settings.redisProjectName||"").trim();if(t&&!this.settings.autoAssignRedisPort)return e(t)||"zrr";let i=this.getVaultBasePath(),r=E.default.basename(i).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),a=(0,Ue.createHash)("sha1").update(i).digest("hex").slice(0,8);return`zrr-${r||"vault"}-${a}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),n=e.port?Number(e.port):6379;return Number.isFinite(n)&&n>0?n:6379}catch(e){return 6379}}getVaultPreferredRedisPort(){let e=(0,Ue.createHash)("sha1").update(this.getVaultBasePath()).digest("hex");return 6400+Number.parseInt(e.slice(0,4),16)%2e3}getRedisHostFromUrl(){try{return new URL(this.settings.redisUrl).hostname||"127.0.0.1"}catch(e){return"127.0.0.1"}}isLocalRedisHost(e){let n=e.trim().toLowerCase();return n?n==="localhost"||n==="0.0.0.0"||n==="::1"?!0:n.startsWith("127."):!1}getPortCheckHost(e){return this.isLocalRedisHost(e)?"127.0.0.1":e}async isPortFree(e,n){return new Promise(t=>{let i=Pe.default.createServer();i.once("error",()=>t(!1)),i.once("listening",()=>{i.close(()=>t(!0))}),i.listen(n,e)})}async findAvailablePort(e,n){for(let i=0;i<25;i+=1){let r=n+i;if(await this.isPortFree(e,r))return r}return null}updateRedisUrlPort(e,n){try{let t=new URL(e);return t.port=String(n),t.toString()}catch(t){return`redis://127.0.0.1:${n}`}}async isRedisReachable(e){let n="127.0.0.1",t=6379;try{let i=new URL(e);n=i.hostname||n,t=i.port?Number(i.port):t}catch(i){return!1}return n=this.getPortCheckHost(n),new Promise(i=>{let r=new Pe.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(t,n)})}async isZoteroLocalApiReachable(){let e=(this.settings.zoteroBaseUrl||"").trim();if(!e)return!1;let n="127.0.0.1",t=23119;try{let i=new URL(e);if(n=i.hostname||n,i.port){let r=Number(i.port);Number.isFinite(r)&&r>0&&(t=r)}else i.protocol==="https:"?t=443:t=80}catch(i){return!1}return new Promise(i=>{let r=new Pe.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(t,n)})}getRedisNamespace(){let e=this.getVaultBasePath(),n=E.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24),t=(0,Ue.createHash)("sha1").update(e).digest("hex").slice(0,8);return`${n||"vault"}-${t}`}getRedisIndexName(){return`${(this.settings.redisIndex||"idx:zotero").trim()||"idx:zotero"}:${this.getRedisNamespace()}`}getRedisKeyPrefix(){let e=(this.settings.redisPrefix||"zotero:chunk:").trim()||"zotero:chunk:";return`${e.endsWith(":")?e:`${e}:`}${this.getRedisNamespace()}:`}async isComposeProjectRunning(e,n,t,i,r){return new Promise(a=>{let s=(0,Q.spawn)(e,[...n,"-p",i,"-f",t,"ps","-q"],{cwd:E.default.dirname(t),env:r}),o="";s.stdout.on("data",l=>{o+=l.toString()}),s.on("error",l=>{console.warn("Redis Stack status check failed",l),a(!1)}),s.on("close",l=>{if(l!==0){a(!1);return}a(o.trim().length>0)})})}async startRedisStack(e){var n;try{await this.ensureBundledTools();let t=this.getDockerComposePath(),i=this.getRedisDataDir();await j.promises.mkdir(i,{recursive:!0});let r=await this.resolveDockerPath(),a=((n=this.settings.dockerPath)==null?void 0:n.trim())||"docker";if((!await this.isContainerCliAvailable(a)||!a||a==="docker"||a==="podman"||a==="podman-compose")&&r&&r!==a&&(this.settings.dockerPath=r,await this.saveSettings(),e||new f.Notice(`Docker/Podman path set to ${r}.`)),!await this.isContainerCliAvailable(r)){e||new f.Notice('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');return}if(!await this.isContainerDaemonRunning(r)){e||new f.Notice(this.getContainerDaemonHint(r));return}let o=await this.resolveComposeCommand(r);if(!o){e||new f.Notice("Compose support not found. Install Docker Desktop or Podman with podman-compose.");return}let l={...process.env};if(E.default.basename(o.command)==="podman-compose"){let h=await this.resolvePodmanBin();if(h&&(l.PODMAN_BIN=h,E.default.isAbsolute(h))){let w=E.default.dirname(h),P=l.PATH||"";P.split(E.default.delimiter).includes(w)||(l.PATH=`${w}${E.default.delimiter}${P}`)}}let d=this.getDockerProjectName();if(await this.isComposeProjectRunning(o.command,o.argsPrefix,t,d,l)){e||new f.Notice("Redis Stack already running for this vault.");return}let p=this.getRedisPortFromUrl(),_=this.getRedisHostFromUrl(),g=this.getPortCheckHost(_),y=this.settings.autoAssignRedisPort&&this.isLocalRedisHost(_),x=this.settings.redisUrl,A=p,m=()=>{if(!e){if(!this.settings.autoAssignRedisPort){new f.Notice("Redis already running. If you share Redis across vaults, disable Auto-start Redis in this vault.");return}new f.Notice(`Redis already running at ${x}.`)}};if(y){let h=p===6379?this.getVaultPreferredRedisPort():p,w=await this.findAvailablePort(g,h);if(!w)throw new Error(`No available Redis port found starting at ${h}.`);w!==p&&(A=w,x=this.updateRedisUrlPort(x,A),this.settings.redisUrl=x,await this.saveSettings(),e||new f.Notice(`Using Redis port ${A} for this vault.`))}else{if(this.isLocalRedisHost(_)&&!await this.isPortFree(g,A)){await this.isRedisReachable(x)?m():e||new f.Notice(`Port ${A} is already in use and Redis is not reachable at ${x}. Update the Redis URL or enable auto-assign.`);return}if(await this.isRedisReachable(x)){m();return}}l.ZRR_DATA_DIR=i,l.ZRR_PORT=String(A);try{await this.runCommand(o.command,[...o.argsPrefix,"-p",d,"-f",t,"down"],{cwd:E.default.dirname(t),env:l})}catch(h){console.warn("Redis Stack stop before restart failed",h)}await this.runCommand(o.command,[...o.argsPrefix,"-p",d,"-f",t,"up","-d"],{cwd:E.default.dirname(t),env:l}),e||new f.Notice("Redis Stack started.")}catch(t){e||new f.Notice("Failed to start Redis Stack. Check Docker/Podman and file sharing."),console.error("Failed to start Redis Stack",t)}}async setupPythonEnv(){let e=this.getPluginDir(),n=this.getPythonVenvDir(),t=this.getVenvPythonPath(n);await this.ensureBundledTools();let i=this.resolveRequirementsPath(e);if(!i)throw new Error(`requirements.txt not found in ${e}`);try{new f.Notice("Setting up Python environment..."),this.showStatusProgress("Setting up Python environment...",null),console.log(`Python env: using plugin dir ${e}`),console.log(`Python env: venv path ${n}`),await j.promises.mkdir(E.default.dirname(n),{recursive:!0});let r=null,a=async()=>(r||(r=await this.resolveBootstrapPython()),r);if((0,j.existsSync)(t)){let s=await this.getPythonVersion(t,[]);if(s&&this.isUnsupportedPythonVersion(s)){let o=await a();console.log(`Python env: existing venv uses Python ${s.major}.${s.minor}; rebuilding with ${o.command} ${o.args.join(" ")}`),this.showStatusProgress("Rebuilding Python environment...",null),await j.promises.rm(n,{recursive:!0,force:!0})}}if(!(0,j.existsSync)(t)){let s=await a();console.log(`Python env: creating venv with ${s.command} ${s.args.join(" ")}`),await this.runCommand(s.command,[...s.args,"-m","venv",n],{cwd:e})}await this.runCommandStreaming(t,["-m","pip","install","-r",i],{cwd:e},s=>{let o=s.trim();if(!o)return;let l=o.match(/^Collecting\s+([^\s]+)/);if(l){this.showStatusProgress(`Installing ${l[1]}...`,null);return}if(o.startsWith("Installing collected packages")){this.showStatusProgress("Installing packages...",null);return}o.startsWith("Successfully installed")&&this.showStatusProgress("Python environment ready.",100)}),this.settings.pythonPath=t,await this.saveSettings(),this.clearStatusProgress(),new f.Notice("Python environment ready.")}catch(r){this.clearStatusProgress(),new f.Notice("Failed to set up Python environment. See console for details."),console.error("Python env setup failed",r)}}async detectOcrEngines(){let e=await this.canRunCommand("tesseract",[]),n=(this.settings.pythonPath||"").trim(),t=[];if(!n)try{let l=await this.resolveBootstrapPython();n=l.command,t=l.args}catch(l){return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1}}let i=["import importlib.util, json","def has_module(name):","    return importlib.util.find_spec(name) is not None","has_paddle = has_module('paddle')","has_paddleocr = has_module('paddleocr')","has_paddlex = has_module('paddlex')","has_vl = False","if has_paddleocr:","    try:","        from paddleocr import PaddleOCRVL","        has_vl = True","    except Exception:","        has_vl = False","print(json.dumps({'paddle': has_paddle, 'paddleocr': has_paddleocr, 'paddlex': has_paddlex, 'paddle_vl': has_vl}))"].join(`
`),r=await new Promise(l=>{let d=(0,Q.spawn)(n,[...t,"-c",i],{env:this.buildPythonEnv()}),p="";d.stdout.on("data",_=>{p+=_.toString()}),d.on("error",()=>l({ok:!1})),d.on("close",_=>{if(_!==0){l({ok:!1});return}try{let g=JSON.parse(p.trim());l({ok:!0,data:g})}catch(g){l({ok:!1})}})});if(!r.ok||!r.data)return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1};let a=r.data,s=!!a.paddle,o=!!a.paddleocr;return{tesseract:e,paddleStructureLocal:s&&o&&!!a.paddlex,paddleVlLocal:s&&o&&!!a.paddle_vl}}getSharedPythonEnvRoot(){let e=Mn.default.homedir();if(process.platform==="win32"){let t=process.env.LOCALAPPDATA||process.env.APPDATA||E.default.join(e,"AppData","Local");return E.default.join(t,"zotero-redisearch-rag")}let n=process.env.XDG_CACHE_HOME||E.default.join(e,".cache");return E.default.join(n,"zotero-redisearch-rag")}getPythonVenvDir(){return this.settings.pythonEnvLocation==="plugin"?E.default.join(this.getPluginDir(),".venv"):E.default.join(this.getSharedPythonEnvRoot(),"venv")}getVenvPythonPath(e){return process.platform==="win32"?E.default.join(e,"Scripts","python.exe"):E.default.join(e,"bin","python")}resolveRequirementsPath(e){var t;return(t=[E.default.join(e,"requirements.txt"),E.default.join(e,"tools","requirements.txt")].find(i=>(0,j.existsSync)(i)))!=null?t:null}async resolveBootstrapPython(){let e=(this.settings.pythonPath||"").trim();if(e&&await this.canRunCommand(e,[])){let t=await this.getPythonVersion(e,[]);if(t&&this.isUnsupportedPythonVersion(t))throw new Error(`Configured Python ${t.major}.${t.minor} is not supported. Install Python 3.11\u20133.13 and update the Python path.`);return{command:e,args:[]}}let n=process.platform==="win32"?[{command:"py",args:["-3.13"]},{command:"py",args:["-3.12"]},{command:"py",args:["-3.11"]},{command:"py",args:["-3.10"]},{command:"py",args:["-3"]},{command:"python",args:[]}]:[{command:"python3.13",args:[]},{command:"python3.12",args:[]},{command:"python3.11",args:[]},{command:"python3.10",args:[]},{command:"python3",args:[]},{command:"python",args:[]}];for(let t of n)if(await this.canRunCommand(t.command,t.args)){let i=await this.getPythonVersion(t.command,t.args);if(i&&this.isUnsupportedPythonVersion(i)){console.log(`Python env: skipping ${t.command} ${t.args.join(" ")} (Python ${i.major}.${i.minor} unsupported)`);continue}return t}throw new Error("No usable Python 3.11\u20133.13 interpreter found on PATH.")}isUnsupportedPythonVersion(e){return e.major>3||e.major===3&&e.minor>=14}async getPythonVersion(e,n){return new Promise(t=>{let i=(0,Q.spawn)(e,[...n,"-c","import sys; print(f'{sys.version_info.major}.{sys.version_info.minor}')"]),r="";i.stdout.on("data",a=>{r+=a.toString()}),i.on("error",()=>t(null)),i.on("close",a=>{if(a!==0){t(null);return}let s=r.trim().match(/(\d+)\.(\d+)/);if(!s){t(null);return}t({major:Number(s[1]),minor:Number(s[2])})})})}async canRunCommand(e,n){return new Promise(t=>{let i=(0,Q.spawn)(e,[...n,"--version"],{env:this.buildPythonEnv()});i.on("error",()=>t(!1)),i.on("close",r=>t(r===0))})}buildPythonEnv(){let e={...process.env},n=E.default.delimiter,t=e.PATH||"",r=[...process.platform==="win32"?[]:["/opt/homebrew/bin","/usr/local/bin"],t].filter(Boolean).join(n);return e.PATH=r,e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK||(e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK="True"),e.DISABLE_MODEL_SOURCE_CHECK||(e.DISABLE_MODEL_SOURCE_CHECK="True"),e}runPython(e,n){return new Promise((t,i)=>{let r=(0,Q.spawn)(this.settings.pythonPath,[e,...n],{cwd:E.default.dirname(e),env:this.buildPythonEnv()}),a="",s="";r.stdout.on("data",o=>{a+=o.toString()}),r.stderr.on("data",o=>{s+=o.toString()}),r.on("error",o=>{this.handlePythonProcessError(String(o)),i(o)}),r.on("close",o=>{if(o===0)t();else{let l=s.trim()?s:a;this.handlePythonProcessError(l),i(new Error(s||`Process exited with code ${o}`))}})})}runCommand(e,n,t){return new Promise((i,r)=>{var o;let a=(0,Q.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:(o=t==null?void 0:t.env)!=null?o:this.buildPythonEnv()}),s="";a.stderr.on("data",l=>{s+=l.toString()}),a.on("error",l=>{r(l)}),a.on("close",l=>{l===0?i():r(new Error(s||`Process exited with code ${l}`))})})}runPythonStreaming(e,n,t,i,r,a="docling_extract",s){return new Promise((o,l)=>{let d=(0,Q.spawn)(this.settings.pythonPath,[e,...n],{cwd:E.default.dirname(e),env:this.buildPythonEnv()});s&&s(d);let p="",_="",g="",y=null,x=!1,A=m=>{if(m.trim())try{let h=JSON.parse(m);y=h,((h==null?void 0:h.type)==="final"||h!=null&&h.answer)&&(x=!0),t(h)}catch(h){g+=`${m}
`}};d.stdout.on("data",m=>{var w;p+=m.toString();let h=p.split(/\r?\n/);p=(w=h.pop())!=null?w:"";for(let P of h)A(P)}),d.stderr.on("data",m=>{_+=m.toString()}),d.on("error",m=>{this.handlePythonProcessError(String(m)),l(m)}),d.on("close",m=>{if(p.trim()&&A(p),!x&&y&&i(y),r&&this.appendToLogFile(r,_,a,"STDERR"),m===0)o();else{let h=_.trim()?_:g;this.handlePythonProcessError(h),l(new Error(_||`Process exited with code ${m}`))}})})}runCommandStreaming(e,n,t,i){return new Promise((r,a)=>{var d;let s=(0,Q.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:(d=t==null?void 0:t.env)!=null?d:this.buildPythonEnv()}),o=p=>{p.toString().split(/\r?\n/).forEach(g=>{g.trim()&&i(g)})},l="";s.stdout.on("data",o),s.stderr.on("data",p=>{l+=p.toString(),o(p)}),s.on("error",p=>{a(p)}),s.on("close",p=>{p===0?r():a(new Error(l||`Process exited with code ${p}`))})})}handlePythonProcessError(e){if(!e)return;let n=e.match(/ModuleNotFoundError:\s+No module named ['"]([^'"]+)['"]/);if(n){let t=`Python env missing module '${n[1]}'. Open Settings > Python environment > Create/Update.`;this.notifyPythonEnvOnce(t,!0);return}if(/No module named ['"]|ImportError: No module named/i.test(e)){this.notifyPythonEnvOnce("Python env missing required modules. Open Settings > Python environment > Create/Update.",!0);return}/ENOENT|No such file or directory|not found|command not found|spawn .* ENOENT/i.test(e)&&this.notifyPythonEnvOnce("Python not found. Configure the Python path or use Settings > Python environment > Create/Update.",!0)}notifyPythonEnvOnce(e,n=!1){this.lastPythonEnvNotice!==e&&(this.lastPythonEnvNotice=e,new f.Notice(e),n&&this.openPluginSettings())}notifyContainerOnce(e){this.lastContainerNotice!==e&&(this.lastContainerNotice=e,new f.Notice(e))}notifyRedisOnce(e){this.lastRedisNotice!==e&&(this.lastRedisNotice=e,new f.Notice(e))}async autoDetectRedisOnLoad(){if(this.settings.autoStartRedis)return;let e=(this.settings.redisUrl||"").trim(),t=e||"redis://127.0.0.1:6379";(await this.checkRedisConnectionWithUrl(t,500)).ok&&(e||(this.settings.redisUrl=t,await this.saveSettings()),this.notifyRedisOnce(`Redis detected at ${t}. This instance will be used.`))}notifyZoteroApiOnce(e){this.lastZoteroApiNotice!==e&&(this.lastZoteroApiNotice=e,new f.Notice(e))}async warnIfZoteroLocalApiUnavailable(e){if(await this.isZoteroLocalApiReachable())return this.lastZoteroApiNotice=null,!0;let i=`Zotero Local API is not reachable for ${e?`${e}`:"this action"}. Start Zotero or update the Local API URL in settings.`;return this.notifyZoteroApiOnce(i),!1}openPluginSettings(){let e=this.app.setting;e!=null&&e.open&&e.open(),e!=null&&e.openTabById&&e.openTabById(this.manifest.id)}getLogsDirRelative(){return(0,f.normalizePath)(`${X}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,f.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,f.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;if(!await n.exists(e)){new f.Notice("Log file not found.");return}try{let t=async()=>{try{return await n.read(e)||"(empty)"}catch(r){return"(empty)"}},i=await t();new ye(this.app,"Log file",i||"(empty)",{autoRefresh:!0,refreshIntervalMs:2e3,onRefresh:t,onClear:async()=>{await this.clearLogFile()}}).open()}catch(t){new f.Notice("Failed to open log file."),console.error(t)}}async clearLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{let t=(0,f.normalizePath)(E.default.dirname(e));t&&await this.ensureFolder(t),await n.write(e,""),new f.Notice("Log file cleared.")}catch(t){new f.Notice("Failed to clear log file."),console.error(t)}}async deleteLogFileIfExists(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{await n.exists(e)&&await n.remove(e)}catch(t){console.warn("Failed to delete log file before import",t)}}formatLogLines(e,n,t){let i=e.split(/\r?\n/).map(a=>a.trimEnd()).filter(a=>!!a.trim());if(!i.length)return"";let r=new Date().toISOString().replace("T"," ").replace(".",",");return i.map(a=>`${r} ${t} ${n}: ${a}`).join(`
`)+`
`}async appendToLogFile(e,n,t="docling_extract",i="STDERR"){if(!n||!n.trim())return;let r=this.formatLogLines(n,t,i);if(r)try{await j.promises.mkdir(E.default.dirname(e),{recursive:!0}),await j.promises.appendFile(e,r)}catch(a){console.warn("Failed to append stderr to log file",a)}}runPythonWithOutput(e,n,t,i="docling_extract"){return new Promise((r,a)=>{let s=(0,Q.spawn)(this.settings.pythonPath,[e,...n],{cwd:E.default.dirname(e),env:this.buildPythonEnv()}),o="",l="";s.stdout.on("data",d=>{o+=d.toString()}),s.stderr.on("data",d=>{l+=d.toString()}),s.on("error",d=>{this.handlePythonProcessError(String(d)),a(d)}),s.on("close",d=>{if(t&&this.appendToLogFile(t,l,i,"STDERR"),d===0)r(o.trim());else{let p=l.trim()?l:o;this.handlePythonProcessError(p),a(new Error(l||`Process exited with code ${d}`))}})})}};

"use strict";var ce=Object.create;var Z=Object.defineProperty;var de=Object.getOwnPropertyDescriptor;var pe=Object.getOwnPropertyNames;var ue=Object.getPrototypeOf,ge=Object.prototype.hasOwnProperty;var he=(L,p)=>{for(var e in p)Z(L,e,{get:p[e],enumerable:!0})},ne=(L,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of pe(p))!ge.call(L,t)&&t!==e&&Z(L,t,{get:()=>p[t],enumerable:!(n=de(p,t))||n.enumerable});return L};var V=(L,p,e)=>(e=L!=null?ce(ue(L)):{},ne(p||!L||!L.__esModule?Z(e,"default",{value:L,enumerable:!0}):e,L)),fe=L=>ne(Z({},"__esModule",{value:!0}),L);var ye={};he(ye,{default:()=>G});module.exports=fe(ye);var d=require("obsidian"),M=require("child_process"),I=require("fs"),se=V(require("http")),oe=V(require("https")),m=V(require("path")),j=require("url"),le=require("crypto");var w=require("obsidian"),R=".zotero-redisearch-rag",F=`${R}/items`,z=`${R}/chunks`,te={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}

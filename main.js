"use strict";var xe=Object.create;var H=Object.defineProperty;var we=Object.getOwnPropertyDescriptor;var ve=Object.getOwnPropertyNames;var ke=Object.getPrototypeOf,Pe=Object.prototype.hasOwnProperty;var Ce=(C,u)=>{for(var e in u)H(C,e,{get:u[e],enumerable:!0})},pe=(C,u,e,n)=>{if(u&&typeof u=="object"||typeof u=="function")for(let t of ve(u))!Pe.call(C,t)&&t!==e&&H(C,t,{get:()=>u[t],enumerable:!(n=we(u,t))||n.enumerable});return C};var W=(C,u,e)=>(e=C!=null?xe(ke(C)):{},pe(u||!C||!C.__esModule?H(e,"default",{value:C,enumerable:!0}):e,C)),Se=C=>pe(H({},"__esModule",{value:!0}),C);var Ne={};Ce(Ne,{default:()=>Y});module.exports=Se(Ne);var d=require("obsidian"),V=require("@codemirror/state"),M=require("@codemirror/view"),q=require("child_process"),D=require("fs"),ye=W(require("http")),be=W(require("https")),ae=W(require("net")),f=W(require("path")),Z=require("url"),J=require("crypto");var P=require("obsidian"),z=".zotero-redisearch-rag",$=`${z}/items`,F=`${z}/chunks`,ue={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}
...
`};var ge={"docling_extract.py":`#!/usr/bin/env python3

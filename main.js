"use strict";var dn=Object.create;var be=Object.defineProperty;var cn=Object.getOwnPropertyDescriptor;var pn=Object.getOwnPropertyNames;var un=Object.getPrototypeOf,_n=Object.prototype.hasOwnProperty;var gn=(k,m)=>{for(var e in m)be(k,e,{get:m[e],enumerable:!0})},Ze=(k,m,e,n)=>{if(m&&typeof m=="object"||typeof m=="function")for(let t of pn(m))!_n.call(k,t)&&t!==e&&be(k,t,{get:()=>m[t],enumerable:!(n=cn(m,t))||n.enumerable});return k};var le=(k,m,e)=>(e=k!=null?dn(un(k)):{},Ze(m||!k||!k.__esModule?be(e,"default",{value:k,enumerable:!0}):e,k)),fn=k=>Ze(be({},"__esModule",{value:!0}),k);var Sn={};gn(Sn,{default:()=>Le});module.exports=fn(Sn);var p=require("obsidian"),ee=require("@codemirror/state"),j=require("@codemirror/view"),X=require("child_process"),B=require("fs"),nn=le(require("http")),tn=le(require("https")),ge=le(require("net")),rn=le(require("os")),sn=le(require("tls")),A=le(require("path")),ue=require("url"),ve=require("crypto");var N=require("obsidian"),K=".zotero-redisearch-rag",J=`${K}/items`,V=`${K}/chunks`,He={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{pdf_block}}{{docling_markdown}}",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,chatPaneLocation:"right",enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"cross-encoder/ms-marco-MiniLM-L-6-v2",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${K}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},xe=class extends N.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async _=>{this.plugin.settings.llmProviderProfiles=_,await this.plugin.saveSettings()},i=_=>{_.inputEl.type="password",_.inputEl.autocomplete="off",_.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:_=>{_.createEl("h2",{text:"Prerequisites"}),new N.Setting(_).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows).").addText(f=>f.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async w=>{this.plugin.settings.pythonPath=w.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Python environment").setDesc("Create or update the plugin's Python env (location configured below).").addButton(f=>{f.setButtonText("Create/Update").setCta(),f.onClick(async()=>{f.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{f.setDisabled(!1)}})}),new N.Setting(_).setName("Python env location").setDesc("Shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(f=>{f.addOption("shared","Shared user cache"),f.addOption("plugin","Plugin folder (.venv)"),f.setValue(this.plugin.settings.pythonEnvLocation).onChange(async w=>{w!=="shared"&&w!=="plugin"||(this.plugin.settings.pythonEnvLocation=w,await this.plugin.saveSettings())})}),new N.Setting(_).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack).").addText(f=>f.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async w=>{this.plugin.settings.dockerPath=w.trim()||"docker",await this.plugin.saveSettings()})),new N.Setting(_).setName("Redis URL").addText(f=>f.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async w=>{this.plugin.settings.redisUrl=w.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Redis data directory override").setDesc("Optional absolute path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting.").addText(f=>f.setPlaceholder("/Users/you/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async w=>{this.plugin.settings.redisDataDirOverride=w.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(f=>f.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async w=>{this.plugin.settings.redisProjectName=w.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(f=>f.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async w=>{this.plugin.settings.autoAssignRedisPort=w,await this.plugin.saveSettings()})),new N.Setting(_).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Uses a vault-specific data dir at .obsidian/zotero-redisearch-rag/redis-data unless overridden.").addToggle(f=>f.setValue(this.plugin.settings.autoStartRedis).onChange(async w=>{this.plugin.settings.autoStartRedis=w,await this.plugin.saveSettings()})),new N.Setting(_).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(f=>f.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:_=>{_.createEl("h2",{text:"Zotero Local API"}),new N.Setting(_).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(C=>C.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async v=>{this.plugin.settings.zoteroBaseUrl=v.trim(),await this.plugin.saveSettings()}));let f=new N.Setting(_).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),w=null,P=C=>{if(!w)return;let v=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(C.map(T=>T.value)).has(v)||(C=C.concat([{value:v,label:`Custom (${v})`}])),w.selectEl.options.length=0;for(let T of C)w.addOption(T.value,T.label);w.setValue(v)},S=async()=>{if(w){w.setDisabled(!0);try{let C=await this.plugin.fetchZoteroLibraryOptions();P(C)}finally{w.setDisabled(!1)}}};f.addDropdown(C=>{w=C;let v=(this.plugin.settings.zoteroUserId||"0").trim()||"0";C.addOption(v,"Loading..."),C.setValue(v),C.onChange(async D=>{this.plugin.settings.zoteroUserId=D.trim(),await this.plugin.saveSettings()})}),f.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),_.createEl("h2",{text:"Zotero Web API"}),new N.Setting(_).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(C=>C.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async v=>{this.plugin.settings.webApiBaseUrl=v.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(C=>C.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async v=>{this.plugin.settings.webApiLibraryType=v,await this.plugin.saveSettings()})),new N.Setting(_).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(C=>C.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async v=>{this.plugin.settings.webApiLibraryId=v.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(C=>{i(C),C.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async v=>{this.plugin.settings.webApiKey=v.trim(),await this.plugin.saveSettings()})}),_.createEl("h2",{text:"Output"}),new N.Setting(_).setName("PDF folder").addText(C=>C.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async v=>{this.plugin.settings.outputPdfDir=v.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Notes folder").addText(C=>C.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async v=>{this.plugin.settings.outputNoteDir=v.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(C=>{C.setValue(this.plugin.settings.frontmatterTemplate).onChange(async v=>{this.plugin.settings.frontmatterTemplate=v,await this.plugin.saveSettings()}),C.inputEl.rows=10,C.inputEl.style.width="100%"}),new N.Setting(_).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(C=>C.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async v=>{this.plugin.settings.tagSanitizeMode=v,await this.plugin.saveSettings()})),new N.Setting(_).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}} and {{docling_markdown}} placeholders.").addTextArea(C=>{C.setValue(this.plugin.settings.noteBodyTemplate).onChange(async v=>{this.plugin.settings.noteBodyTemplate=v,await this.plugin.saveSettings()}),C.inputEl.rows=8,C.inputEl.style.width="100%"}),new N.Setting(_).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(C=>C.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async v=>{this.plugin.settings.chatOutputDir=v.trim()||"zotero/chats",await this.plugin.saveSettings()})),new N.Setting(_).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(C=>C.setValue(this.plugin.settings.copyPdfToVault).onChange(async v=>{this.plugin.settings.copyPdfToVault=v,!v&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new N.Setting(_).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(C=>{let v=this.plugin.settings.copyPdfToVault;C.setValue(v?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!v).onChange(async D=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=D,await this.plugin.saveSettings()})}),new N.Setting(_).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(C=>C.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async v=>{this.plugin.settings.preferObsidianNoteForCitations=v,await this.plugin.saveSettings()}))}},{id:"ocr",label:"OCR",render:_=>{_.createEl("h2",{text:"Docling"});let f=null,w=v=>{if(!f)return;let D=this.plugin.settings.ocrEngine;new Set(v.map(F=>F.value)).has(D)||(v=v.concat([{value:D,label:`Current (unavailable): ${D}`}])),f.selectEl.options.length=0;for(let F of v)f.addOption(F.value,F.label);f.setValue(D)},P=async()=>{if(!f)return;f.setDisabled(!0);let v={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{v=await this.plugin.detectOcrEngines()}catch(F){v={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let D=[{value:"auto",label:"Auto (default)"}];v.tesseract&&D.push({value:"tesseract",label:"Tesseract (local)"}),v.paddleStructureLocal&&D.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),v.paddleVlLocal&&D.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(D.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),D.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),w(D),f.setDisabled(!1)},S=new N.Setting(_).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),C=document.createElement("a");C.href="https://aistudio.baidu.com/paddleocr",C.textContent="https://aistudio.baidu.com/paddleocr",C.target="_blank",C.rel="noopener noreferrer",S.descEl.appendChild(C),S.descEl.append("."),S.addText(v=>{i(v),v.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async D=>{this.plugin.settings.paddleApiKey=D.trim(),await this.plugin.saveSettings(),await P()})}),new N.Setting(_).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(v=>v.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async D=>{this.plugin.settings.paddleVlApiUrl=D.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(v=>v.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async D=>{this.plugin.settings.paddleStructureApiUrl=D.trim(),await this.plugin.saveSettings(),await P()})),new N.Setting(_).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(v=>{f=v,v.addOption("auto","Auto (default)"),v.setValue(this.plugin.settings.ocrEngine),v.onChange(async D=>{this.plugin.settings.ocrEngine=D,await this.plugin.saveSettings()})}),new N.Setting(_).setName("OCR mode").setDesc("auto: skip OCR when text is readable; force if bad: OCR only when text looks poor; force: always OCR.").addDropdown(v=>v.addOption("auto","auto").addOption("force_low_quality","force if quality is bad").addOption("force","force").setValue(this.plugin.settings.ocrMode).onChange(async D=>{this.plugin.settings.ocrMode=D,await this.plugin.saveSettings()})),new N.Setting(_).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(v=>{v.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async D=>{this.plugin.settings.ocrQualityThreshold=D,await this.plugin.saveSettings()})}),new N.Setting(_).setName("Chunking").setDesc("page or section").addDropdown(v=>v.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async D=>{this.plugin.settings.chunkingMode=D,await this.plugin.saveSettings()})),P()}},{id:"llms",label:"LLMs",render:_=>{_.createEl("h2",{text:"LLM Provider Profiles"});let f=_.createDiv({cls:"zrr-llm-profiles"}),w=()=>{f.empty();let h=n();h.length||f.createEl("p",{text:"No profiles yet. Add one below."});for(let x of h){let L=f.createEl("details",{cls:"zrr-profile"});h.length===1&&(L.open=!0);let U=L.createEl("summary",{text:x.name||x.id||"Profile"});U.addClass("zrr-profile-title");let ye=L.createDiv({cls:"zrr-profile-body"});new N.Setting(ye).setName("Profile name").addText(te=>te.setPlaceholder("My provider").setValue(x.name||"").onChange(async re=>{x.name=re.trim(),U.textContent=x.name||x.id||"Profile",await t(n())})),new N.Setting(ye).setName("Base URL").addText(te=>te.setPlaceholder("http://localhost:1234/v1").setValue(x.baseUrl||"").onChange(async re=>{x.baseUrl=re.trim(),await t(n())})),new N.Setting(ye).setName("API key").setDesc("Stored in settings (not encrypted).").addText(te=>{i(te),te.setPlaceholder("sk-...").setValue(x.apiKey||"").onChange(async re=>{x.apiKey=re.trim(),await t(n())})}),new N.Setting(ye).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(te=>te.setButtonText("Delete profile").onClick(async()=>{let re=n().filter(ln=>ln.id!==x.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===x.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===x.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===x.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(re),w()}))}new N.Setting(f).addButton(x=>x.setButtonText("Add profile").onClick(async()=>{let L=`profile-${Date.now().toString(36)}`,U=n().concat([{id:L,name:"Custom",baseUrl:"",apiKey:""}]);await t(U),w()}))};w(),_.createEl("h2",{text:"OCR cleanup"}),new N.Setting(_).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(h=>h.setValue(this.plugin.settings.enableLlmCleanup).onChange(async x=>{this.plugin.settings.enableLlmCleanup=x,await this.plugin.saveSettings()}));let P=null,S=null,C=null,v=async()=>{},D=async(h,x=!0)=>{let L=h.trim();this.plugin.settings.llmCleanupBaseUrl=L,x&&(this.plugin.settings.llmCleanupProviderProfileId="",P&&P.setValue("custom")),S&&S.setValue(L),await this.plugin.saveSettings()},T=async h=>{let x=n().find(L=>L.id===h);this.plugin.settings.llmCleanupProviderProfileId=h,x&&(this.plugin.settings.llmCleanupBaseUrl=x.baseUrl,this.plugin.settings.llmCleanupApiKey=x.apiKey,S==null||S.setValue(x.baseUrl),C==null||C.setValue(x.apiKey)),await this.plugin.saveSettings(),await v()};new N.Setting(_).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(h=>{P=h,h.addOption("custom","Custom (manual)");for(let L of n())h.addOption(L.id,L.name||L.id);let x=this.plugin.settings.llmCleanupProviderProfileId;h.setValue(x&&n().some(L=>L.id===x)?x:"custom"),h.onChange(async L=>{if(L==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await T(L)})}),new N.Setting(_).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(h=>{S=h,h.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async x=>{await D(x)})}),new N.Setting(_).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(h=>{C=h,i(h),h.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async x=>{this.plugin.settings.llmCleanupApiKey=x.trim(),this.plugin.settings.llmCleanupProviderProfileId="",P&&P.setValue("custom"),await this.plugin.saveSettings()})});let F=new N.Setting(_).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),R=null,q=h=>{if(!R)return;let x=(this.plugin.settings.llmCleanupModel||"").trim(),L=new Set(h.map(U=>U.value));x&&!L.has(x)&&(h=h.concat([{value:x,label:`Custom (${x})`}])),R.selectEl.options.length=0;for(let U of h)R.addOption(U.value,U.label);x&&R.setValue(x)};v=async()=>{if(R){R.setDisabled(!0);try{let h=await this.plugin.fetchCleanupModelOptions();q(h)}finally{R.setDisabled(!1)}}},F.addDropdown(h=>{R=h;let x=(this.plugin.settings.llmCleanupModel||"").trim();h.addOption(x||"loading","Loading..."),h.setValue(x||"loading"),h.onChange(async L=>{this.plugin.settings.llmCleanupModel=L.trim(),await this.plugin.saveSettings()})}),F.addButton(h=>{h.setButtonText("Refresh").onClick(async()=>{await v()})}),v(),new N.Setting(_).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(h=>h.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async x=>{let L=Number.parseFloat(x);this.plugin.settings.llmCleanupTemperature=Number.isFinite(L)?L:0,await this.plugin.saveSettings()})),new N.Setting(_).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(h=>h.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async x=>{this.plugin.settings.llmCleanupMinQuality=x,await this.plugin.saveSettings()})),new N.Setting(_).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(h=>h.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async x=>{let L=Number.parseInt(x,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(L)?L:2e3,await this.plugin.saveSettings()})),_.createEl("h2",{text:"Text Embedding"});let I=null,$=null,H=null,O=async()=>{},z=async(h,x=!0)=>{let L=h.trim();this.plugin.settings.embedBaseUrl=L,x&&(this.plugin.settings.embedProviderProfileId="",I&&I.setValue("custom")),$&&$.setValue(L),await this.plugin.saveSettings()},Z=async h=>{let x=n().find(L=>L.id===h);this.plugin.settings.embedProviderProfileId=h,x&&(this.plugin.settings.embedBaseUrl=x.baseUrl,this.plugin.settings.embedApiKey=x.apiKey,$==null||$.setValue(x.baseUrl),H==null||H.setValue(x.apiKey)),await this.plugin.saveSettings(),await O()};new N.Setting(_).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(h=>{I=h,h.addOption("custom","Custom (manual)");for(let L of n())h.addOption(L.id,L.name||L.id);let x=this.plugin.settings.embedProviderProfileId;h.setValue(x&&n().some(L=>L.id===x)?x:"custom"),h.onChange(async L=>{if(L==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await Z(L)})}),new N.Setting(_).setName("Embeddings base URL").addText(h=>{$=h,h.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async x=>{await z(x)})}),new N.Setting(_).setName("Embeddings API key").addText(h=>{H=h,i(h),h.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async x=>{this.plugin.settings.embedApiKey=x.trim(),this.plugin.settings.embedProviderProfileId="",I&&I.setValue("custom"),await this.plugin.saveSettings()})});let W=new N.Setting(_).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),Q=null,Ee=h=>{if(!Q)return;let x=(this.plugin.settings.embedModel||"").trim(),L=new Set(h.map(U=>U.value));x&&!L.has(x)&&(h=h.concat([{value:x,label:`Custom (${x})`}])),Q.selectEl.options.length=0;for(let U of h)Q.addOption(U.value,U.label);x&&Q.setValue(x)};O=async()=>{if(Q){Q.setDisabled(!0);try{let h=await this.plugin.fetchEmbeddingModelOptions();Ee(h)}finally{Q.setDisabled(!1)}}},W.addDropdown(h=>{Q=h;let x=(this.plugin.settings.embedModel||"").trim();h.addOption(x||"loading","Loading..."),h.setValue(x||"loading"),h.onChange(async L=>{this.plugin.settings.embedModel=L.trim(),await this.plugin.saveSettings()})}),W.addButton(h=>{h.setButtonText("Refresh").onClick(async()=>{await O()})}),O(),new N.Setting(_).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(h=>h.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async x=>{this.plugin.settings.embedIncludeMetadata=x,await this.plugin.saveSettings()})),new N.Setting(_).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(h=>h.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async x=>{let L=Number.parseInt(x,10);this.plugin.settings.embedContextWindow=Number.isFinite(L)?Math.max(0,L):1,await this.plugin.saveSettings()})),new N.Setting(_).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(h=>h.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async x=>{let L=Number.parseInt(x,10);this.plugin.settings.embedContextChars=Number.isFinite(L)?Math.max(0,L):220,await this.plugin.saveSettings()})),new N.Setting(_).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(h=>h.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async x=>{let L=Number.parseInt(x,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(L)?Math.max(0,L):3500,await this.plugin.saveSettings()})),new N.Setting(_).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(h=>h.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async x=>{let L=Number.parseInt(x,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(L)?Math.max(0,L):200,await this.plugin.saveSettings()})),new N.Setting(_).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(h=>h.setValue(this.plugin.settings.enableChunkTagging).onChange(async x=>{this.plugin.settings.enableChunkTagging=x,await this.plugin.saveSettings()})),_.createEl("h2",{text:"Chat LLM"});let ie=null,ne=null,se=null,ae=async()=>{},he=async(h,x=!0)=>{let L=h.trim();this.plugin.settings.chatBaseUrl=L,x&&(this.plugin.settings.chatProviderProfileId="",ie&&ie.setValue("custom")),ne&&ne.setValue(L),await this.plugin.saveSettings()},Ae=async h=>{let x=n().find(L=>L.id===h);this.plugin.settings.chatProviderProfileId=h,x&&(this.plugin.settings.chatBaseUrl=x.baseUrl,this.plugin.settings.chatApiKey=x.apiKey,ne==null||ne.setValue(x.baseUrl),se==null||se.setValue(x.apiKey)),await this.plugin.saveSettings(),await ae()};new N.Setting(_).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(h=>{ie=h,h.addOption("custom","Custom (manual)");for(let L of n())h.addOption(L.id,L.name||L.id);let x=this.plugin.settings.chatProviderProfileId;h.setValue(x&&n().some(L=>L.id===x)?x:"custom"),h.onChange(async L=>{if(L==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await Ae(L)})}),new N.Setting(_).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(h=>{ne=h,h.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async x=>{await he(x)})}),new N.Setting(_).setName("Chat API key").addText(h=>{se=h,i(h),h.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async x=>{this.plugin.settings.chatApiKey=x.trim(),this.plugin.settings.chatProviderProfileId="",ie&&ie.setValue("custom"),await this.plugin.saveSettings()})});let oe=new N.Setting(_).setName("Chat model").setDesc("Select a chat-capable model from the provider."),Y=null,M=h=>{if(!Y)return;let x=(this.plugin.settings.chatModel||"").trim(),L=new Set(h.map(U=>U.value));x&&!L.has(x)&&(h=h.concat([{value:x,label:`Custom (${x})`}])),Y.selectEl.options.length=0;for(let U of h)Y.addOption(U.value,U.label);x&&Y.setValue(x)};ae=async()=>{if(Y){Y.setDisabled(!0);try{let h=await this.plugin.fetchChatModelOptions();M(h)}finally{Y.setDisabled(!1)}}},oe.addDropdown(h=>{Y=h;let x=(this.plugin.settings.chatModel||"").trim();h.addOption(x||"loading","Loading..."),h.setValue(x||"loading"),h.onChange(async L=>{this.plugin.settings.chatModel=L.trim(),await this.plugin.saveSettings()})}),oe.addButton(h=>{h.setButtonText("Refresh").onClick(async()=>{await ae()})}),ae(),new N.Setting(_).setName("Temperature").addText(h=>h.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async x=>{let L=Number.parseFloat(x);this.plugin.settings.chatTemperature=Number.isFinite(L)?L:.2,await this.plugin.saveSettings()})),new N.Setting(_).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(h=>h.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async x=>{let L=Number.parseInt(x,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(L)?Math.max(0,L):6,await this.plugin.saveSettings()})),new N.Setting(_).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(h=>h.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async x=>{this.plugin.settings.chatPaneLocation=x,await this.plugin.saveSettings()})),_.createEl("h2",{text:"Retrieval"}),new N.Setting(_).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(h=>h.setValue(this.plugin.settings.enableQueryExpansion).onChange(async x=>{this.plugin.settings.enableQueryExpansion=x,await this.plugin.saveSettings()})),new N.Setting(_).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(h=>h.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async x=>{let L=Number.parseInt(x,10);this.plugin.settings.queryExpansionCount=Number.isFinite(L)?Math.max(1,L):3,await this.plugin.saveSettings()})),new N.Setting(_).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(h=>h.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async x=>{this.plugin.settings.enableCrossEncoderRerank=x,await this.plugin.saveSettings()})),new N.Setting(_).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(h=>h.setPlaceholder("cross-encoder/ms-marco-MiniLM-L-6-v2").setValue(this.plugin.settings.rerankModel).onChange(async x=>{this.plugin.settings.rerankModel=x.trim()||"cross-encoder/ms-marco-MiniLM-L-6-v2",await this.plugin.saveSettings()})),new N.Setting(_).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(h=>h.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async x=>{let L=Number.parseInt(x,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(L)?Math.max(1,L):4,await this.plugin.saveSettings()})),new N.Setting(_).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(h=>h.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async x=>{let L=Number.parseInt(x,10);this.plugin.settings.rrfK=Number.isFinite(L)?Math.max(1,L):60,await this.plugin.saveSettings()})),new N.Setting(_).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(h=>h.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async x=>{let L=Number.parseInt(x,10);this.plugin.settings.rrfLogTop=Number.isFinite(L)?Math.max(0,L):0,await this.plugin.saveSettings()})),new N.Setting(_).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(h=>h.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async x=>{let L=Number.parseInt(x,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(L)?Math.max(0,L):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:_=>{_.createEl("h2",{text:"Logging"}),new N.Setting(_).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(f=>f.setValue(this.plugin.settings.enableFileLogging).onChange(async w=>{this.plugin.settings.enableFileLogging=w,await this.plugin.saveSettings()})),new N.Setting(_).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(f=>f.setPlaceholder(`${K}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async w=>{this.plugin.settings.logFilePath=w.trim()||`${K}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new N.Setting(_).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(f=>f.setButtonText("Open log").onClick(async()=>{var w,P;await((P=(w=this.plugin).openLogFile)==null?void 0:P.call(w))})).addButton(f=>f.setButtonText("Clear log").onClick(async()=>{var w,P;await((P=(w=this.plugin).clearLogFile)==null?void 0:P.call(w))})),_.createEl("h2",{text:"Maintenance"}),new N.Setting(_).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(f=>f.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new N.Setting(_).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(f=>f.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(f=>f.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],c=new Map,u=new Map,g=_=>{this.activeTab=_;for(let[f,w]of c){let P=f===_;w.classList.toggle("is-active",P),w.setAttribute("aria-selected",P?"true":"false"),w.setAttribute("tabindex",P?"0":"-1")}for(let[f,w]of u){let P=f===_;w.classList.toggle("is-active",P),w.hidden=!P}},b=e.createDiv({cls:"zrr-settings-tabs"});b.setAttribute("role","tablist");let y=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let _ of d){let f=b.createEl("button",{text:_.label,cls:"zrr-settings-tab-button"}),w=`zrr-settings-tab-${_.id}`,P=`zrr-settings-panel-${_.id}`;f.type="button",f.id=w,f.setAttribute("role","tab"),f.setAttribute("aria-controls",P),f.setAttribute("aria-selected","false"),f.addEventListener("click",()=>g(_.id));let S=y.createDiv({cls:"zrr-settings-tab-panel"});S.id=P,S.setAttribute("role","tabpanel"),S.setAttribute("aria-labelledby",w),S.hidden=!0,_.render(S),c.set(_.id,f),u.set(_.id,S)}let E=d.some(_=>_.id===this.activeTab)?this.activeTab:d[0].id;g(E)}};var ke={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,n=1200){let t=this.noteSyncTimers.get(e.path);t!==void 0&&window.clearTimeout(t);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},n);this.noteSyncTimers.set(e.path,i)}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=e.page_start?String(e.page_start):"",t=e.page_end?String(e.page_end):"";if(n&&(!t||n===t))return n;if(n&&t)return`${n} - ${t}`;let i=(e.pages||"").trim();if(!i)return"?";let r=i.match(/^(\d+)\s*-\s*(\d+)$/);return r?r[1]===r[2]?r[1]:`${r[1]} - ${r[2]}`:i.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,p.normalizePath)(`${V}/${s}.json`),d=this.app.vault.adapter;if(!await d.exists(l))return;let c=await this.readChunkPayload(l);if(!c)return;let u=Array.isArray(c.chunks)?c.chunks:[],g=new Map;for(let P of u){let S=typeof(P==null?void 0:P.chunk_id)=="string"?P.chunk_id:String((n=P==null?void 0:P.chunk_id)!=null?n:"");S&&g.set(S,P)}let b=new Set,y=new Set,E=new Set,_=new Set,f=!1;for(let P of o){let S=P.chunkId;if(!S)continue;b.add(S);let C=g.get(S);if(!C){console.warn(`Sync note: chunk id not found in cache (${S})`);continue}if(P.excludeFlag){C.excluded!==!0&&(C.excluded=!0,f=!0);let T=this.normalizeChunkText(P.text);T&&T!==String((t=C.text)!=null?t:"")&&(C.text=T,C.char_count=T.length,f=!0),E.add(S);continue}if(C.excluded&&(C.excluded=!1,f=!0,y.add(S)),!P.text.trim()){E.add(S),_.add(S);continue}let v=this.normalizeChunkText(P.text);if(!v){E.add(S),_.add(S);continue}let D=typeof C.text=="string"?C.text:String((i=C.text)!=null?i:"");v!==D&&(C.text=v,C.char_count=v.length,y.add(S),f=!0)}for(let P of g.keys())b.has(P)||(E.add(P),_.add(P));let w=new Set([...E,..._]);if(w.size){let P=Array.from(w).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==P){this.noteSyncPendingDeletes.set(e.path,P),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!y.size&&!E.size&&!_.size&&!f)return;_.size&&(c.chunks=u.filter(P=>{var C;let S=typeof(P==null?void 0:P.chunk_id)=="string"?P.chunk_id:String((C=P==null?void 0:P.chunk_id)!=null?C:"");return S&&!_.has(S)}),f=!0),(f||_.size)&&await d.write(l,JSON.stringify(c,null,2)),await this.reindexChunkUpdates(s,l,Array.from(y),Array.from(E)),(E.size||_.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}extractSyncSection(e){let n=ce.exec(e);if(!n)return null;let t=e.slice(n.index+n[0].length),i=fe.exec(t);return i?t.slice(0,i.index):null}extractDocIdFromSyncMarker(e){var r;let n=ce.exec(e);if(!n)return null;let i=((r=n[0])!=null?r:"").match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return i?i[2].trim():null}parseSyncedChunkBlocks(e){var o;let n=e.split(/\r?\n/),t=[],i="",r=!1,a=[],s=()=>{i&&(t.push({chunkId:i,text:a.join(`
`).trim(),excludeFlag:r}),i="",r=!1,a=[])};for(let l of n){let d=l.match(pe);if(d){s();let c=(o=d[1])!=null?o:"",u=c.match(/id=([\"']?)([^\"'\s]+)\1/i),g=u?u[2].trim():"";if(!g)continue;i=g,r=/\bexclude\b/i.test(c)||/\bdelete\b/i.test(c),a=[];continue}if(De.test(l)){s();continue}if(i){if(we.test(l)){r=!0;continue}a.push(l)}}return s(),t}normalizeChunkText(e){return e.split(/\r?\n/).map(n=>n.replace(/\s+/g," ").trim()).filter((n,t,i)=>!(n===""&&i[t-1]==="")).join(`

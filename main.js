"use strict";var Ve=Object.create;var le=Object.defineProperty;var He=Object.getOwnPropertyDescriptor;var We=Object.getOwnPropertyNames;var Ke=Object.getPrototypeOf,Je=Object.prototype.hasOwnProperty;var Ye=(b,p)=>{for(var e in p)le(b,e,{get:p[e],enumerable:!0})},Re=(b,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of We(p))!Je.call(b,t)&&t!==e&&le(b,t,{get:()=>p[t],enumerable:!(n=He(p,t))||n.enumerable});return b};var ce=(b,p,e)=>(e=b!=null?Ve(Ke(b)):{},Re(p||!b||!b.__esModule?le(e,"default",{value:b,enumerable:!0}):e,b)),Qe=b=>Re(le({},"__esModule",{value:!0}),b);var un={};Ye(un,{default:()=>he});module.exports=Qe(un);var u=require("obsidian"),ne=require("@codemirror/state"),q=require("@codemirror/view"),W=require("child_process"),B=require("fs"),Me=ce(require("http")),$e=ce(require("https")),we=ce(require("net")),v=ce(require("path")),te=require("url"),pe=require("crypto");var L=require("obsidian"),H=".zotero-redisearch-rag",Y=`${H}/items`,Z=`${H}/chunks`,Te={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}
...
`};var Ne={"docling_extract.py":`#!/usr/bin/env python3

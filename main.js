"use strict";var bn=Object.create;var Ue=Object.defineProperty;var xn=Object.getOwnPropertyDescriptor;var kn=Object.getOwnPropertyNames;var wn=Object.getPrototypeOf,vn=Object.prototype.hasOwnProperty;var Pn=(f,_)=>{for(var e in _)Ue(f,e,{get:_[e],enumerable:!0})},Rt=(f,_,e,t)=>{if(_&&typeof _=="object"||typeof _=="function")for(let n of kn(_))!vn.call(f,n)&&n!==e&&Ue(f,n,{get:()=>_[n],enumerable:!(t=xn(_,n))||t.enumerable});return f};var be=(f,_,e)=>(e=f!=null?bn(wn(f)):{},Rt(_||!f||!f.__esModule?Ue(e,"default",{value:f,enumerable:!0}):e,f)),Cn=f=>Rt(Ue({},"__esModule",{value:!0}),f);var Qn={};Pn(Qn,{default:()=>ut});module.exports=Cn(Qn);var m=require("obsidian");var Ft=require("@codemirror/state"),re=require("@codemirror/view"),Mt=require("obsidian");var xe=/<!--\s*zrr:sync-start[^>]*-->/i,Ce=/<!--\s*zrr:sync-end\s*-->/i,ge=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ne=/<!--\s*zrr:chunk\s+end\s*-->/i,Le=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,Nt=f=>{let _=f.trim();if(!_.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(_)){let u=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:u?u[2]:void 0}}if(/^zrr:sync-end\b/i.test(_))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(_)){let u=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),g=_.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:u?u[2]:void 0,attachmentKey:g?g[2]:void 0}}if(/^zrr:annotations-end\b/i.test(_))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(_))return{type:"chunk-end"};let e=_.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let t=e[1]||"",n=t.match(/\bid=(["']?)([^"'\s]+)\1/i),i=n?n[2]:"",r=t.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:t.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(t)||/\bdelete\b/i.test(t),p=/\bsection\b/i.test(t);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:p?"section":c?"page":"section"}},Te=f=>{var l;if(!f)return null;let _=f.match(ge);if(!_)return null;let e=_[1]||"",t=e.match(/\bid=(["']?)([^"'\s]+)\1/i),n=t?t[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=n&&(l=ht(n))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:n,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Be=f=>{for(let _=1;_<=f.lines;_+=1){let e=f.line(_).text;if(xe.test(e)){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i);return t?t[2].trim():null}}return null},gt=(f,_)=>{let e=_;for(;e>=1;e-=1){let t=f.line(e).text;if(ge.test(t))return{line:e,text:t};if(xe.test(t)||Ce.test(t))break}return null},An=(f,_)=>{for(let e=_;e<=f.lines;e+=1){let t=f.line(e).text;if(Ne.test(t))return e;if(Ce.test(t))break}return null},Lt=(f,_)=>{let e=gt(f,_);if(!e)return null;let t=An(f,e.line+1);return t===null||_<e.line||_>t?null:{startLine:e.line,endLine:t,text:e.text}},Tt=(f,_,e)=>{if(_>e)return!1;for(let t=_;t<=e;t+=1){let n=f.line(t).text;if(Le.test(n))return!0}return!1},ht=f=>{var n;if(!f)return null;let e=(f.includes(":")&&(n=f.split(":").pop())!=null?n:f).match(/^p(\d+)$/i);if(!e)return null;let t=Number.parseInt(e[1],10);return Number.isFinite(t)?t:null};var Dt=f=>{if(!f)return null;let _=f.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return _?Te(_[0]):null};var En=(f,_)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),f.type==="sync-start"||f.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(f.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),f.type==="sync-start"?e.textContent=f.docId?`Redis Index Sync start - ${f.docId}`:"Redis Index Sync start":e.textContent="Redis index sync end",e;if(f.type==="annotations-start"||f.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),f.type==="annotations-start"){let t=f.docId?` - ${f.docId}`:"";e.textContent=`Zotero annotations start${t}`}else e.textContent="Zotero annotations end";return e}if(f.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=f.chunkKind==="page"?"Page end":"Section end",f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),e;if(f.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),f.excluded&&e.classList.add("is-excluded"),f.pageNumber&&_>0)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber}/${_})`}else e.textContent=`Page ${f.pageNumber}/${_}`;else if(f.pageNumber)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber})`}else e.textContent=`Page ${f.pageNumber}`;else f.chunkId?e.textContent=`Section ${f.chunkId}`:e.textContent="Section";return f.excluded&&(e.textContent=`${e.textContent} - excluded`),e},ft=class extends re.WidgetType{constructor(_,e,t,n,i){super(),this.plugin=_,this.docId=e,this.chunkId=t,this.startLine=n,this.excluded=i}eq(_){return this.docId===_.docId&&this.chunkId===_.chunkId&&this.startLine===_.startLine&&this.excluded===_.excluded}toDOM(){let _=document.createElement("span");_.className="zrr-chunk-toolbar",_.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},t=(c,d,p)=>{let u=document.createElement("span");u.className="zrr-chunk-button-icon",(0,Mt.setIcon)(u,d);let g=document.createElement("span");g.className="zrr-chunk-button-label",g.textContent=p,c.appendChild(u),c.appendChild(g)},n=document.createElement("button");n.type="button",n.className="zrr-chunk-button",t(n,"sparkles","Clean"),e(n,"Clean this chunk with the OCR cleanup model"),n.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),_.appendChild(n);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",t(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),_.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",t(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),_.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",t(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),_.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return t(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),_.appendChild(s),_}ignoreEvent(){return!0}},It=(f,_)=>{var y;let e=f.state.doc,t=Be(e);if(!t)return re.Decoration.none;let n=f.state.selection.main.head,i=e.lineAt(n).number,r=Lt(e,i);if(!r)return re.Decoration.none;let a=r.text.match(ge);if(!a)return re.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return re.Decoration.none;let l=o[2].trim();if(!l)return re.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=Tt(e,r.startLine+1,r.endLine-1),p=c||d,u=e.line(r.startLine),g=re.Decoration.widget({widget:new ft(_,t,l,r.startLine,p),side:1});return re.Decoration.set([g.range(u.to)])},mt=class extends re.WidgetType{constructor(_,e){super(),this.info=_,this.totalPages=e}toDOM(){var _;return(_=En(this.info,this.totalPages))!=null?_:document.createElement("span")}},Ot=f=>{var o,l;let _=f.dom.closest(".markdown-source-view");if(!_||!_.classList.contains("is-live-preview"))return re.Decoration.none;let e=f.state.doc,t=new Ft.RangeSetBuilder,n=[],i=[],r=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),p=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!p)continue;let u=Nt(p[1]);u&&(u.type==="chunk-start"?(u.chunkKind=(o=u.chunkKind)!=null?o:u.pageNumber?"page":"section",u.pageNumber&&(r=!0),u.chunkKind==="section"&&(a=!0)):u.type==="chunk-end"&&(u.chunkKind=(l=u.chunkKind)!=null?l:"section"),n.push({line:c,from:d.from,to:d.to,info:u}),u.pageNumber&&i.push(u.pageNumber))}if(!n.length)return re.Decoration.none;if(r&&!a)for(let c of n)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let c of n){let d=re.Decoration.replace({widget:new mt(c.info,s)});t.add(c.from,c.to,d)}return t.finish()},zt=()=>re.ViewPlugin.fromClass(class{constructor(f){this.decorations=Ot(f)}update(f){(f.docChanged||f.viewportChanged)&&(this.decorations=Ot(f.view))}},{decorations:f=>f.decorations}),qt=f=>re.ViewPlugin.fromClass(class{constructor(_){this.decorations=It(_,f)}update(_){(_.docChanged||_.selectionSet||_.viewportChanged)&&(this.decorations=It(_.view,f))}},{decorations:_=>_.decorations}),Sn=(f,_)=>{var t,n,i;if(!f||_<0)return null;let e=/\[\[([^\]\n]+)\]\]/g;for(let r of f.matchAll(e)){let a=(t=r[0])!=null?t:"",s=(n=r[1])!=null?n:"",o=(i=r.index)!=null?i:-1;if(o<0)continue;let l=o+a.length;if(_<o||_>l)continue;let c=s.indexOf("|");return(c>=0?s.slice(0,c):s).trim()||null}return null},jt=f=>re.ViewPlugin.fromClass(class{},{eventHandlers:{click(_,e){if(_.defaultPrevented||_.button!==0)return!1;let t=e.dom.closest(".markdown-source-view");if(!t||!t.classList.contains("is-live-preview"))return!1;let n=e.posAtCoords({x:_.clientX,y:_.clientY});if(n===null)return!1;let i=e.state.doc.lineAt(n),r=n-i.from,a=Sn(i.text,r);return!a||!a.includes("#zrr-chunk:")?!1:(_.preventDefault(),_.stopPropagation(),f.openInternalLinkInMain(a,f.getLivePreviewSourcePath()),!0)}}});var le=require("child_process"),ee=require("fs"),Ct=be(require("http")),hn=be(require("https")),je=be(require("net")),$e=be(require("os")),fn=be(require("tls")),R=be(require("path")),At=require("url"),Ve=require("crypto");var N=require("obsidian"),Vt=require("crypto"),Ge=require("fs"),We=be(require("path")),ae=".zotero-redisearch-rag",oe=`${ae}/items`,Y=`${ae}/chunks`,Zt=`${ae}/metadata_snapshots.json`,Ut=`${ae}/annotation_snapshots.json`,Rn="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",Ae="cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",De="__custom__",$t=[{value:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",label:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1 (Fast multilingual)"},{value:"BAAI/bge-reranker-v2-m3",label:"BAAI/bge-reranker-v2-m3 (Best quality, heaviest)"},{value:"jinaai/jina-reranker-v2-base-multilingual",label:"jinaai/jina-reranker-v2-base-multilingual (Balanced multilingual)"}],Ke={pythonRuntime:"worker",pythonRuntimeMigrationV1Done:!1,showAdvancedPythonRuntimeOptions:!1,pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,firstContainerStartupNoticeShown:!1,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",chatExportTemplatePath:"",chatExportPostCreateCommandId:"",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:Ae,rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${ae}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},He=class extends N.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async h=>{this.plugin.settings.llmProviderProfiles=h,await this.plugin.saveSettings()},i=h=>{h.inputEl.type="password",h.inputEl.autocomplete="off",h.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:h=>{new N.Setting(h).setName("Prerequisites").setHeading();let b=null,w=null,P=null,S=null,v=null,C=null,D=null,L=null,q=null,F=(O,j)=>{O&&(O.settingEl.classList.toggle("is-disabled",j),O.settingEl.classList.toggle("zrr-setting-disabled",j))},W=(O,j)=>{O&&O.settingEl.classList.toggle("zrr-setting-hidden",!j)},M=()=>{let O=!!this.plugin.settings.showAdvancedPythonRuntimeOptions,j=this.plugin.settings.pythonRuntime==="local",$=O&&j;w==null||w.setDisabled(!O),F(b,!O),W(P,O),W(S,O),W(v,O),C==null||C.setDisabled(!$),D==null||D.setDisabled(!$),q==null||q.setDisabled(!$),L&&(L.disabled=!$),F(P,!$),F(S,!$),F(v,!$)};new N.Setting(h).setName("Docker/podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(O=>O.setPlaceholder("Docker").setValue(this.plugin.settings.dockerPath).onChange(async j=>{this.plugin.settings.dockerPath=j.trim()||"docker",await this.plugin.saveSettings()})),new N.Setting(h).setName("Advanced python runtime options").setDesc("Show legacy local interpreter/venv controls. Recommended to keep this disabled.").addToggle(O=>O.setValue(this.plugin.settings.showAdvancedPythonRuntimeOptions).onChange(async j=>{this.plugin.settings.showAdvancedPythonRuntimeOptions=j,!j&&this.plugin.settings.pythonRuntime==="local"&&(this.plugin.settings.pythonRuntime="worker",new N.Notice("Switched python runtime to worker mode.")),await this.plugin.saveSettings(),M()})),b=new N.Setting(h).setName("Python runtime").setDesc("Worker runtime is recommended. Enable advanced options to expose local interpreter/venv mode.").addDropdown(O=>{w=O,O.addOption("worker","Python worker container (recommended)"),O.addOption("local","Local interpreter/venv"),O.setValue(this.plugin.settings.pythonRuntime).onChange(async j=>{j!=="worker"&&j!=="local"||(this.plugin.settings.pythonRuntime=j,await this.plugin.saveSettings(),M())})}),P=new N.Setting(h).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(O=>(C=O,O.setPlaceholder("Auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async j=>{this.plugin.settings.pythonPath=j.trim(),await this.plugin.saveSettings()}))),S=new N.Setting(h).setName("Python environment").setDesc("Local mode: create or update the plugin's python env. Worker mode: managed by docker startup.").addButton(O=>{q=O,L=O.buttonEl,O.setButtonText("Create/update").setCta(),O.onClick(async()=>{O.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{O.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),v=new N.Setting(h).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(O=>{D=O,O.addOption("shared","Shared user cache"),O.addOption("plugin","Plugin folder (.venv)"),O.setValue(this.plugin.settings.pythonEnvLocation).onChange(async j=>{j!=="shared"&&j!=="plugin"||(this.plugin.settings.pythonEnvLocation=j,await this.plugin.saveSettings())})}),M(),new N.Setting(h).setName("Redis URL").addText(O=>O.setPlaceholder("Redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async j=>{this.plugin.settings.redisUrl=j.trim(),await this.plugin.saveSettings()}));let G=null,I=null,U=null,B=null,Z=()=>{let O=this.plugin.settings.autoAssignRedisPort;U==null||U.setDisabled(O),B==null||B.setDisabled(O),G==null||G.settingEl.classList.toggle("is-disabled",O),I==null||I.settingEl.classList.toggle("is-disabled",O)};new N.Setting(h).setName("Auto-assign redis port").setDesc("When starting redis stack, pick a free local port and update the redis URL.").addToggle(O=>O.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async j=>{this.plugin.settings.autoAssignRedisPort=j,await this.plugin.saveSettings(),Z()})),G=new N.Setting(h).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(O=>(U=O,O.setPlaceholder("~/redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async j=>{this.plugin.settings.redisDataDirOverride=j.trim(),await this.plugin.saveSettings()}))),G.settingEl.addClass("zrr-redis-override-setting"),I=new N.Setting(h).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(O=>(B=O,O.setPlaceholder("Zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async j=>{this.plugin.settings.redisProjectName=j.trim(),await this.plugin.saveSettings()}))),I.settingEl.addClass("zrr-redis-override-setting"),Z(),new N.Setting(h).setName("Auto-start redis stack (docker/podman compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(O=>O.setValue(this.plugin.settings.autoStartRedis).onChange(async j=>{this.plugin.settings.autoStartRedis=j,await this.plugin.saveSettings()})),new N.Setting(h).setName("Start redis stack now").setDesc("Starts or restarts redis stack (and python worker in worker mode).").addButton(O=>O.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:h=>{new N.Setting(h).setName("Zotero local API").setHeading(),new N.Setting(h).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. HTTP://127.0.0.1:23119/API").addText(v=>v.setPlaceholder("HTTP://127.0.0.1:23119/API").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async C=>{this.plugin.settings.zoteroBaseUrl=C.trim(),await this.plugin.saveSettings()}));let b=new N.Setting(h).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),w=null,P=v=>{if(!w)return;let C=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(v.map(L=>L.value)).has(C)||(v=v.concat([{value:C,label:`Custom (${C})`}])),w.selectEl.options.length=0;for(let L of v)w.addOption(L.value,L.label);w.setValue(C)},S=async()=>{if(w){w.setDisabled(!0);try{let v=await this.plugin.fetchZoteroLibraryOptions();P(v)}finally{w.setDisabled(!1)}}};b.addDropdown(v=>{w=v;let C=(this.plugin.settings.zoteroUserId||"0").trim()||"0";v.addOption(C,"Loading..."),v.setValue(C),v.onChange(async D=>{this.plugin.settings.zoteroUserId=D.trim(),await this.plugin.saveSettings()})}),b.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),new N.Setting(h).setName("Zotero web API").setHeading(),new N.Setting(h).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(v=>v.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async C=>{this.plugin.settings.webApiBaseUrl=C.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API library type").setDesc("Library type for web API writes.").addDropdown(v=>v.addOption("user","User").addOption("group","Group").setValue(this.plugin.settings.webApiLibraryType).onChange(async C=>{this.plugin.settings.webApiLibraryType=C,await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for web API writes.").addText(v=>v.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async C=>{this.plugin.settings.webApiLibraryId=C.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API key").setDesc("Zotero API key for write fallback (from Zotero.org).").addText(v=>{i(v),v.setPlaceholder("Your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async C=>{this.plugin.settings.webApiKey=C.trim(),await this.plugin.saveSettings()})}),new N.Setting(h).setName("Output").setHeading(),new N.Setting(h).setName("PDF folder").addText(v=>v.setPlaceholder("Zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async C=>{this.plugin.settings.outputPdfDir=C.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Notes folder").addText(v=>v.setPlaceholder("Zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async C=>{this.plugin.settings.outputNoteDir=C.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(v=>{v.setValue(this.plugin.settings.frontmatterTemplate).onChange(async C=>{this.plugin.settings.frontmatterTemplate=C,await this.plugin.saveSettings()}),v.inputEl.rows=10,v.inputEl.addClass("zrr-u-width-100")}),new N.Setting(h).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(v=>v.addOption("none","No change").addOption("camel","Camelcase").addOption("pascal","Pascalcase").addOption("snake","Snake_case").addOption("kebab","Kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async C=>{this.plugin.settings.tagSanitizeMode=C,await this.plugin.saveSettings()})),new N.Setting(h).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(v=>{v.setValue(this.plugin.settings.noteBodyTemplate).onChange(async C=>{this.plugin.settings.noteBodyTemplate=C,await this.plugin.saveSettings()}),v.inputEl.rows=8,v.inputEl.addClass("zrr-u-width-100")}),new N.Setting(h).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(v=>v.setPlaceholder("Zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async C=>{this.plugin.settings.chatOutputDir=C.trim()||"zotero/chats",await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat export template").setDesc("Optional vault-relative template file for copied chat notes. Use {{chat_body}} to control where the transcript is inserted (otherwise template text is appended after the transcript).").addText(v=>v.setPlaceholder("Path to chat export template note").setValue(this.plugin.settings.chatExportTemplatePath).onChange(async C=>{this.plugin.settings.chatExportTemplatePath=C.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat export post-create command").setDesc("Optional command ID to run after the chat note is created and opened. Useful for templater workflows that need the full note body already present.").addText(v=>v.setPlaceholder("Command ID to run after note creation").setValue(this.plugin.settings.chatExportPostCreateCommandId).onChange(async C=>{this.plugin.settings.chatExportPostCreateCommandId=C.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Copy pdfs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(v=>v.setValue(this.plugin.settings.copyPdfToVault).onChange(async C=>{this.plugin.settings.copyPdfToVault=C,!C&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new N.Setting(h).setName("Create ocr-layered PDF copy").setDesc("When ocr is used, replace the vault PDF with a tesseract text layer (requires copy pdfs into vault).").addToggle(v=>{let C=this.plugin.settings.copyPdfToVault;v.setValue(C?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!C).onChange(async D=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=D,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(v=>v.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async C=>{this.plugin.settings.preferObsidianNoteForCitations=C,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:h=>{new N.Setting(h).setName("Annotations").setHeading(),new N.Setting(h).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(S=>S.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async v=>{this.plugin.settings.annotationPageLabel=v.trim()||"Page",await this.plugin.saveSettings()})),new N.Setting(h).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(S=>S.setValue(this.plugin.settings.includeAnnotationImages).onChange(async v=>{this.plugin.settings.includeAnnotationImages=v,await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion").setHeading(),h.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new N.Setting(h).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(S=>S.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async v=>{this.plugin.settings.zoteroCompanionEnabled=v,await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(S=>S.setPlaceholder("HTTP://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async v=>{this.plugin.settings.zoteroCompanionBaseUrl=v.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(S=>{i(S),this.companionTokenInput=S,S.setPlaceholder("Optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async v=>{this.plugin.settings.zoteroCompanionToken=v.trim(),await this.plugin.saveSettings()})}),new N.Setting(h).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero companion plugin token to this value.").addButton(S=>S.setButtonText("Generate token").onClick(async()=>{let v=(0,Vt.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=v,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(v);try{await navigator.clipboard.writeText(v),new N.Notice("Generated and copied companion token.")}catch(C){new N.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",C)}})),new N.Setting(h).setName("Annotation color map").setHeading(),h.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let b=h.createDiv({cls:"zrr-annotation-map"}),w=async S=>{this.plugin.settings.annotationColorMap=S,await this.plugin.saveSettings()},P=()=>{var q,F;b.empty();let S=this.plugin.settings.annotationColorMap||{},v=Object.entries(S);if(v.length||b.createEl("p",{text:"No color mappings configured."}),v.length){let W=b.createDiv({cls:"zrr-annotation-map-row-header"});W.createEl("span",{text:"Color"}),W.createEl("span",{text:"Heading"}),W.createEl("span",{text:"Callout"}),W.createEl("span")}for(let[W,M]of v){let I=b.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),U=I.createEl("input",{type:"text",value:W,cls:"zrr-annotation-map-input"}),B=I.createEl("input",{type:"text",value:(q=M.heading)!=null?q:"",cls:"zrr-annotation-map-input"}),Z=I.createEl("input",{type:"text",value:(F=M.callout)!=null?F:"",cls:"zrr-annotation-map-input"}),O=I.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});O.type="button",U.addEventListener("change",()=>{(async()=>{let j=U.value.trim().toLowerCase();if(!j){U.value=W;return}let $={...this.plugin.settings.annotationColorMap||{}};if(j!==W&&$[j]){new N.Notice(`Annotation color '${j}' already exists.`),U.value=W;return}let z=$[W];delete $[W],$[j]=z!=null?z:{heading:"",callout:""},await w($),P()})()}),B.addEventListener("change",()=>{(async()=>{var z;let j={...this.plugin.settings.annotationColorMap||{}},$=(z=j[W])!=null?z:{heading:"",callout:""};$.heading=B.value.trim(),j[W]=$,await w(j)})()}),Z.addEventListener("change",()=>{(async()=>{var z;let j={...this.plugin.settings.annotationColorMap||{}},$=(z=j[W])!=null?z:{heading:"",callout:""};$.callout=Z.value.trim(),j[W]=$,await w(j)})()}),O.addEventListener("click",()=>{(async()=>{let j={...this.plugin.settings.annotationColorMap||{}};delete j[W],await w(j),P()})()})}let C=b.createDiv({cls:"zrr-annotation-map-actions"}),D=C.createEl("button",{text:"Add mapping"});D.type="button",D.addEventListener("click",()=>{(async()=>{let W={...this.plugin.settings.annotationColorMap||{}},M="new-color",G=1;for(;W[M];)M=`new-color-${G}`,G+=1;W[M]={heading:"",callout:""},await w(W),P()})()});let L=C.createEl("button",{text:"Reset to defaults"});L.type="button",L.addEventListener("click",()=>{(async()=>(await w({...Ke.annotationColorMap}),P()))()})};P()}},{id:"ocr",label:"OCR",render:h=>{new N.Setting(h).setName("Docling").setHeading();let b=null,w=C=>{if(!b)return;let D=this.plugin.settings.ocrEngine;new Set(C.map(q=>q.value)).has(D)||(C=C.concat([{value:D,label:`Current (unavailable): ${D}`}])),b.selectEl.options.length=0;for(let q of C)b.addOption(q.value,q.label);b.setValue(D)},P=async()=>{if(!b)return;b.setDisabled(!0);let C={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{C=await this.plugin.detectOcrEngines()}catch(q){C={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let D=[{value:"auto",label:"Auto (default)"}];C.tesseract&&D.push({value:"tesseract",label:"Tesseract (local)"}),C.paddleStructureLocal&&D.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),C.paddleVlLocal&&D.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(D.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),D.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),w(D),b.setDisabled(!1)},S=new N.Setting(h).setName("Paddle ocr API key").setDesc("API token for paddleocr-vl / pp-structurev3 endpoints. Get a free API key at "),v=document.createElement("a");v.href="https://aistudio.baidu.com/paddleocr",v.textContent="HTTPS://aistudio.baidu.com/paddleocr",v.target="_blank",v.rel="noopener noreferrer",S.descEl.appendChild(v),S.descEl.append("."),S.addText(C=>{i(C),C.setPlaceholder("Your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async D=>{this.plugin.settings.paddleApiKey=D.trim(),await this.plugin.saveSettings(),await P()})}),new N.Setting(h).setName("Paddleocr-vl API URL").setDesc("Optional override for the paddleocr-vl API endpoint.").addText(C=>C.setPlaceholder("HTTPS://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async D=>{this.plugin.settings.paddleVlApiUrl=D.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Pp-structurev3 API URL").setDesc("API endpoint for pp-structurev3 (see baidu AI studio docs).").addText(C=>C.setPlaceholder("HTTPS://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async D=>{this.plugin.settings.paddleStructureApiUrl=D.trim(),await this.plugin.saveSettings(),await P()})),new N.Setting(h).setName("Ocr engine").setDesc("Select the ocr engine to use when ocr is required.").addDropdown(C=>{b=C,C.addOption("auto","Auto (default)"),C.setValue(this.plugin.settings.ocrEngine),C.onChange(async D=>{this.plugin.settings.ocrEngine=D,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Ocr decision (when to ocr)").setDesc("Controls when ocr runs; per-page behavior is configured separately below.").addDropdown(C=>C.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","Ocr only if text is poor").addOption("force","Prefer ocr for full document").setValue(this.plugin.settings.ocrMode).onChange(async D=>{this.plugin.settings.ocrMode=D,await this.plugin.saveSettings()})),new N.Setting(h).setName("Ocr layout override (per-page)").setDesc("Force per-page ocr when ocr runs, bypassing layout heuristics; can be slower for multi-column pdfs.").addToggle(C=>C.setValue(this.plugin.settings.forcePerPageOcr).onChange(async D=>{this.plugin.settings.forcePerPageOcr=D,await this.plugin.saveSettings()})),new N.Setting(h).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(C=>{C.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async D=>{this.plugin.settings.ocrQualityThreshold=D,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Chunking").setDesc("Page or section").addDropdown(C=>C.addOption("page","Page").addOption("section","Section").setValue(this.plugin.settings.chunkingMode).onChange(async D=>{this.plugin.settings.chunkingMode=D,await this.plugin.saveSettings()})),P()}},{id:"llms",label:"LLMs",render:h=>{new N.Setting(h).setName("Model provider profiles").setHeading();let b=h.createDiv({cls:"zrr-llm-profiles"}),w=()=>{b.empty();let A=t();A.length||b.createEl("p",{text:"No profiles yet. Add one below."});for(let E of A){let T=b.createEl("details",{cls:"zrr-profile"});A.length===1&&(T.open=!0);let ie=T.createEl("summary",{text:E.name||E.id||"Profile"});ie.addClass("zrr-profile-title");let Ze=T.createDiv({cls:"zrr-profile-body"});new N.Setting(Ze).setName("Profile name").addText(me=>me.setPlaceholder("My provider").setValue(E.name||"").onChange(async ye=>{E.name=ye.trim(),ie.textContent=E.name||E.id||"Profile",await n(t())})),new N.Setting(Ze).setName("Base URL").addText(me=>me.setPlaceholder("HTTP://localhost:1234/v1").setValue(E.baseUrl||"").onChange(async ye=>{E.baseUrl=ye.trim(),await n(t())})),new N.Setting(Ze).setName("API key").setDesc("Stored in settings (not encrypted).").addText(me=>{i(me),me.setPlaceholder("Sk-...").setValue(E.apiKey||"").onChange(async ye=>{E.apiKey=ye.trim(),await n(t())})}),new N.Setting(Ze).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(me=>me.setButtonText("Delete profile").onClick(async()=>{let ye=t().filter(yn=>yn.id!==E.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===E.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===E.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===E.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(ye),w()}))}new N.Setting(b).addButton(E=>E.setButtonText("Add profile").onClick(async()=>{let T=`profile-${Date.now().toString(36)}`,ie=t().concat([{id:T,name:"Custom",baseUrl:"",apiKey:""}]);await n(ie),w()}))};w(),new N.Setting(h).setName("Ocr cleanup").setHeading(),new N.Setting(h).setName("Model cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor ocr at import. Can be slow/costly.").addToggle(A=>A.setValue(this.plugin.settings.enableLlmCleanup).onChange(async E=>{this.plugin.settings.enableLlmCleanup=E,await this.plugin.saveSettings()}));let P=null,S=null,v=null,C=()=>Promise.resolve(),D=async(A,E=!0)=>{let T=A.trim();this.plugin.settings.llmCleanupBaseUrl=T,E&&(this.plugin.settings.llmCleanupProviderProfileId="",P&&P.setValue("custom")),S&&S.setValue(T),await this.plugin.saveSettings()},L=async A=>{let E=t().find(T=>T.id===A);this.plugin.settings.llmCleanupProviderProfileId=A,E&&(this.plugin.settings.llmCleanupBaseUrl=E.baseUrl,this.plugin.settings.llmCleanupApiKey=E.apiKey,S==null||S.setValue(E.baseUrl),v==null||v.setValue(E.apiKey)),await this.plugin.saveSettings(),await C()};new N.Setting(h).setName("Cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{P=A,A.addOption("custom","Custom (manual)");for(let T of t())A.addOption(T.id,T.name||T.id);let E=this.plugin.settings.llmCleanupProviderProfileId;A.setValue(E&&t().some(T=>T.id===E)?E:"custom"),A.onChange(async T=>{if(T==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await L(T)})}),new N.Setting(h).setName("Cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. HTTP://127.0.0.1:1234/v1").addText(A=>{S=A,A.setPlaceholder("HTTP://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async E=>{await D(E)})}),new N.Setting(h).setName("Cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(A=>{v=A,i(A),A.setPlaceholder("Sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async E=>{this.plugin.settings.llmCleanupApiKey=E.trim(),this.plugin.settings.llmCleanupProviderProfileId="",P&&P.setValue("custom"),await this.plugin.saveSettings()})});let q=new N.Setting(h).setName("Cleanup model").setDesc("Select a cleanup-capable model from the provider."),F=null,W=A=>{if(!F)return;let E=(this.plugin.settings.llmCleanupModel||"").trim(),T=new Set(A.map(ie=>ie.value));E&&!T.has(E)&&(A=A.concat([{value:E,label:`Custom (${E})`}])),F.selectEl.options.length=0;for(let ie of A)F.addOption(ie.value,ie.label);E&&F.setValue(E)};C=async()=>{if(F){F.setDisabled(!0);try{let A=await this.plugin.fetchCleanupModelOptions();W(A)}finally{F.setDisabled(!1)}}},q.addDropdown(A=>{F=A;let E=(this.plugin.settings.llmCleanupModel||"").trim();A.addOption(E||"loading","Loading..."),A.setValue(E||"loading"),A.onChange(async T=>{this.plugin.settings.llmCleanupModel=T.trim(),await this.plugin.saveSettings()})}),q.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await C()})}),C(),new N.Setting(h).setName("Cleanup temperature").setDesc("Lower is more conservative.").addText(A=>A.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async E=>{let T=Number.parseFloat(E);this.plugin.settings.llmCleanupTemperature=Number.isFinite(T)?T:0,await this.plugin.saveSettings()})),new N.Setting(h).setName("Cleanup minimum quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(A=>A.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async E=>{this.plugin.settings.llmCleanupMinQuality=E,await this.plugin.saveSettings()})),new N.Setting(h).setName("Cleanup maximum chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(A=>A.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(T)?T:2e3,await this.plugin.saveSettings()})),new N.Setting(h).setName("Text embedding").setHeading();let M=null,G=null,I=null,U=()=>Promise.resolve(),B=async(A,E=!0)=>{let T=A.trim();this.plugin.settings.embedBaseUrl=T,E&&(this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom")),G&&G.setValue(T),await this.plugin.saveSettings()},Z=async A=>{let E=t().find(T=>T.id===A);this.plugin.settings.embedProviderProfileId=A,E&&(this.plugin.settings.embedBaseUrl=E.baseUrl,this.plugin.settings.embedApiKey=E.apiKey,G==null||G.setValue(E.baseUrl),I==null||I.setValue(E.apiKey)),await this.plugin.saveSettings(),await U()};new N.Setting(h).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{M=A,A.addOption("custom","Custom (manual)");for(let T of t())A.addOption(T.id,T.name||T.id);let E=this.plugin.settings.embedProviderProfileId;A.setValue(E&&t().some(T=>T.id===E)?E:"custom"),A.onChange(async T=>{if(T==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await Z(T)})}),new N.Setting(h).setName("Embeddings base URL").addText(A=>{G=A,A.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async E=>{await B(E)})}),new N.Setting(h).setName("Embeddings API key").addText(A=>{I=A,i(A),A.setPlaceholder("Lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async E=>{this.plugin.settings.embedApiKey=E.trim(),this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom"),await this.plugin.saveSettings()})});let O=new N.Setting(h).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),j=null,$=A=>{if(!j)return;let E=(this.plugin.settings.embedModel||"").trim(),T=new Set(A.map(ie=>ie.value));E&&!T.has(E)&&(A=A.concat([{value:E,label:`Custom (${E})`}])),j.selectEl.options.length=0;for(let ie of A)j.addOption(ie.value,ie.label);E&&j.setValue(E)};U=async()=>{if(j){j.setDisabled(!0);try{let A=await this.plugin.fetchEmbeddingModelOptions();$(A)}finally{j.setDisabled(!1)}}},O.addDropdown(A=>{j=A;let E=(this.plugin.settings.embedModel||"").trim();A.addOption(E||"loading","Loading..."),A.setValue(E||"loading"),A.onChange(async T=>{this.plugin.settings.embedModel=T.trim(),await this.plugin.saveSettings()})}),O.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await U()})}),U(),new N.Setting(h).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(A=>A.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async E=>{this.plugin.settings.embedIncludeMetadata=E,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(A=>A.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.embedContextWindow=Number.isFinite(T)?Math.max(0,T):1,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(A=>A.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.embedContextChars=Number.isFinite(T)?Math.max(0,T):220,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(A=>A.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(T)?Math.max(0,T):3500,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(A=>A.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(T)?Math.max(0,T):200,await this.plugin.saveSettings()})),new N.Setting(h).setName("Generate model tags for chunks").setDesc("Use the ocr cleanup model to tag chunks before indexing.").addToggle(A=>A.setValue(this.plugin.settings.enableChunkTagging).onChange(async E=>{this.plugin.settings.enableChunkTagging=E,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat model").setHeading();let z=null,V=null,K=null,ne=()=>Promise.resolve(),pe=async(A,E=!0)=>{let T=A.trim();this.plugin.settings.chatBaseUrl=T,E&&(this.plugin.settings.chatProviderProfileId="",z&&z.setValue("custom")),V&&V.setValue(T),await this.plugin.saveSettings()},fe=async A=>{let E=t().find(T=>T.id===A);this.plugin.settings.chatProviderProfileId=A,E&&(this.plugin.settings.chatBaseUrl=E.baseUrl,this.plugin.settings.chatApiKey=E.apiKey,V==null||V.setValue(E.baseUrl),K==null||K.setValue(E.apiKey)),await this.plugin.saveSettings(),await ne()};new N.Setting(h).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{z=A,A.addOption("custom","Custom (manual)");for(let T of t())A.addOption(T.id,T.name||T.id);let E=this.plugin.settings.chatProviderProfileId;A.setValue(E&&t().some(T=>T.id===E)?E:"custom"),A.onChange(async T=>{if(T==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await fe(T)})}),new N.Setting(h).setName("Chat base URL").setDesc("Compatible endpoint for chat requests.").addText(A=>{V=A,A.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async E=>{await pe(E)})}),new N.Setting(h).setName("Chat API key").addText(A=>{K=A,i(A),A.setPlaceholder("Lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async E=>{this.plugin.settings.chatApiKey=E.trim(),this.plugin.settings.chatProviderProfileId="",z&&z.setValue("custom"),await this.plugin.saveSettings()})});let Pe=new N.Setting(h).setName("Chat model").setDesc("Select a chat-capable model from the provider."),ce=null,_t=A=>{if(!ce)return;let E=(this.plugin.settings.chatModel||"").trim(),T=new Set(A.map(ie=>ie.value));E&&!T.has(E)&&(A=A.concat([{value:E,label:`Custom (${E})`}])),ce.selectEl.options.length=0;for(let ie of A)ce.addOption(ie.value,ie.label);E&&ce.setValue(E)};ne=async()=>{if(ce){ce.setDisabled(!0);try{let A=await this.plugin.fetchChatModelOptions();_t(A)}finally{ce.setDisabled(!1)}}},Pe.addDropdown(A=>{ce=A;let E=(this.plugin.settings.chatModel||"").trim();A.addOption(E||"loading","Loading..."),A.setValue(E||"loading"),A.onChange(async T=>{this.plugin.settings.chatModel=T.trim(),await this.plugin.saveSettings()})}),Pe.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await ne()})}),ne(),new N.Setting(h).setName("Temperature").addText(A=>A.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async E=>{let T=Number.parseFloat(E);this.plugin.settings.chatTemperature=Number.isFinite(T)?T:.2,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(A=>A.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(T)?Math.max(0,T):6,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(A=>A.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async E=>{this.plugin.settings.chatPaneLocation=E,await this.plugin.saveSettings()})),new N.Setting(h).setName("Retrieval").setHeading(),new N.Setting(h).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(A=>A.setValue(this.plugin.settings.enableAgenticRag).onChange(async E=>{this.plugin.settings.enableAgenticRag=E,await this.plugin.saveSettings()})),new N.Setting(h).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(A=>A.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.agenticMaxIters=Number.isFinite(T)?Math.max(1,T):2,await this.plugin.saveSettings()})),new N.Setting(h).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(A=>A.setValue(this.plugin.settings.enableQueryExpansion).onChange(async E=>{this.plugin.settings.enableQueryExpansion=E,await this.plugin.saveSettings()})),new N.Setting(h).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(A=>A.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.queryExpansionCount=Number.isFinite(T)?Math.max(1,T):3,await this.plugin.saveSettings()})),new N.Setting(h).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(A=>A.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async E=>{this.plugin.settings.enableCrossEncoderRerank=E,await this.plugin.saveSettings()}));let X=new Set($t.map(A=>A.value)),Q=(this.plugin.settings.rerankModel||"").trim()||Ae,_e=X.has(Q)?Q:De,se=null,Et=()=>{if(!se)return;let E=!(_e===De);se.setDisabled(E),se.inputEl.disabled=E,se.inputEl.readOnly=E,se.inputEl.classList.toggle("is-disabled",E),se.inputEl.setAttribute("aria-disabled",String(E))},St=new N.Setting(h).setName("Cross-encoder model").setDesc("Choose a multilingual preset, or select custom to edit the model ID.");St.addDropdown(A=>{for(let E of $t)A.addOption(E.value,E.label);A.addOption(De,"Custom"),A.setValue(_e),A.onChange(async E=>{_e=E,E!==De?this.plugin.settings.rerankModel=E:(this.plugin.settings.rerankModel||"").trim()||(this.plugin.settings.rerankModel=Ae),await this.plugin.saveSettings(),se==null||se.setValue(this.plugin.settings.rerankModel||Ae),Et()})}),St.addText(A=>{se=A,A.setPlaceholder(Ae).setValue(Q).onChange(async E=>{_e===De&&(this.plugin.settings.rerankModel=E.trim()||Ae,await this.plugin.saveSettings())}),Et()}),new N.Setting(h).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 n candidates before reranking.").addText(A=>A.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(T)?Math.max(1,T):4,await this.plugin.saveSettings()})),new N.Setting(h).setName("Rrf k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(A=>A.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.rrfK=Number.isFinite(T)?Math.max(1,T):60,await this.plugin.saveSettings()})),new N.Setting(h).setName("Rrf log top n").setDesc("Log the top n rrf-ranked chunks to stderr (0 disables).").addText(A=>A.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.rrfLogTop=Number.isFinite(T)?Math.max(0,T):0,await this.plugin.saveSettings()})),new N.Setting(h).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(A=>A.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async E=>{let T=Number.parseInt(E,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(T)?Math.max(0,T):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:h=>{new N.Setting(h).setName("Python runtime").setHeading(),new N.Setting(h).setName("Use local runtime (legacy)").setDesc("Switch to local interpreter/venv mode and enable advanced runtime settings.").addButton(b=>b.setButtonText("Switch").onClick(async()=>{await this.plugin.switchPythonRuntimeToLocalLegacy()})),new N.Setting(h).setName("Logging").setHeading(),new N.Setting(h).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(b=>b.setValue(this.plugin.settings.enableFileLogging).onChange(async w=>{this.plugin.settings.enableFileLogging=w,await this.plugin.saveSettings()})),new N.Setting(h).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(b=>b.setPlaceholder(`${ae}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async w=>{this.plugin.settings.logFilePath=w.trim()||`${ae}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new N.Setting(h).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(b=>b.setButtonText("Open log").onClick(async()=>{var w,P;await((P=(w=this.plugin).openLogFile)==null?void 0:P.call(w))})).addButton(b=>b.setButtonText("Clear log").onClick(async()=>{var w,P;await((P=(w=this.plugin).clearLogFile)==null?void 0:P.call(w))})),new N.Setting(h).setName("Zotero companion plugin").setHeading(),h.createEl("p",{text:"Download the xpi, then in Zotero go to tools \u2192 add-ons \u2192 install from file and restart."}),new N.Setting(h).setName("Download companion add-on").setDesc("Downloads the companion xpi to your system downloads folder.").addButton(b=>b.setButtonText("Download xpi").onClick(async()=>{let w=this.getDefaultDownloadDir();if(!w){new N.Notice("Unable to resolve the system downloads folder.");return}let P=We.default.join(w,"zrr-companion.xpi");if(await this.companionXpiExists(P)){new N.Notice(`Companion XPI already exists: ${P}`);return}new N.Notice("Downloading companion xpi..."),await this.downloadCompanionXpi(P)})),new N.Setting(h).setName("Open Zotero").setDesc("Launch Zotero and open the add-ons window (tools \u2192 add-ons).").addButton(b=>b.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new N.Setting(h).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(b=>b.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),new N.Setting(h).setName("Redis indexing").setHeading(),new N.Setting(h).setName("Reindex redis from cached chunks").setDesc("Rebuild the redis index from cached chunk JSON files.").addButton(b=>b.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new N.Setting(h).setName("Recreate redis stack").setDesc("Pulls the configured redis image and force-recreates the redis-stack service.").addButton(b=>b.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateRedisStack()})),new N.Setting(h).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(b=>b.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(b=>b.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()})),new N.Setting(h).setName("Release notes").setHeading(),new N.Setting(h).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(b=>b.setButtonText("Show").onClick(()=>{this.plugin.openReleaseNotesModal()}))}}],p=new Map,u=new Map,g=h=>{this.activeTab=h;for(let[b,w]of p){let P=b===h;w.classList.toggle("is-active",P),w.setAttribute("aria-selected",P?"true":"false"),w.setAttribute("tabindex",P?"0":"-1")}for(let[b,w]of u){let P=b===h;w.classList.toggle("is-active",P),w.hidden=!P}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let x=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let h of d){let b=y.createEl("button",{text:h.label,cls:"zrr-settings-tab-button"}),w=`zrr-settings-tab-${h.id}`,P=`zrr-settings-panel-${h.id}`;b.type="button",b.id=w,b.setAttribute("role","tab"),b.setAttribute("aria-controls",P),b.setAttribute("aria-selected","false"),b.addEventListener("click",()=>g(h.id));let S=x.createDiv({cls:"zrr-settings-tab-panel"});S.id=P,S.setAttribute("role","tabpanel"),S.setAttribute("aria-labelledby",w),S.hidden=!0,h.render(S),p.set(h.id,b),u.set(h.id,S)}let k=d.some(h=>h.id===this.activeTab)?this.activeTab:d[0].id;g(k)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?We.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await Ge.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await Ge.promises.mkdir(We.default.dirname(e),{recursive:!0});let t=await(0,N.requestUrl)({url:Rn,method:"GET"});if(t.status!==200){new N.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await Ge.promises.writeFile(e,n),new N.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new N.Notice("Failed to download companion xpi. See console for details."),console.warn("Failed to download companion XPI",t)}}};var Bt=require("@codemirror/state"),Gt=require("@codemirror/view"),ue=require("obsidian");var Nn=f=>{let _=f.scrollDOM.getBoundingClientRect(),e=f.posAtCoords({x:_.left+8,y:+_.height*.25});return e===null?null:f.state.doc.lineAt(e).number},Ie=f=>!f||typeof f!="object"?null:f,Je=class{constructor(_,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=_,this.helpers=e}createSyncExtension(){let _=this.helpers,e=this.syncPdfSidebarForDoc.bind(this);return Gt.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=_.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=_.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var p,u;let i=this.docId;if(!i)return;let r=Nn(t);if(r===null)return;let a=_.findChunkStartLineInDoc(t.state.doc,r);if(!a)return;let s=_.parseChunkMarkerLine(a.text),o=(p=s==null?void 0:s.pageNumber)!=null?p:null,l=(u=s==null?void 0:s.chunkId)!=null?u:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||d)||(this.lastPage=o,this.lastChunkId=l,e(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(_={}){if(!this.pendingPdfSync||!this.isPdfSidebarLeaf(this.pdfSidebarLeaf)&&!await this.getPdfSidebarLeaf(!!_.allowCreateLeaf)||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let e=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(e.docId,e.pageNumber,e.chunkId)}async revealPdfSidebar(_={}){let e=await this.getPdfSidebarLeaf(!!_.allowCreateLeaf);if(e)try{await this.deps.app.workspace.revealLeaf(e)}catch(t){console.warn("Failed to reveal PDF sidebar leaf",t)}}updatePreviewScrollHandler(){var n;let _=this.deps.app.workspace.getActiveViewOfType(ue.MarkdownView);if(!_||_.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=_.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(_);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(_)}async syncPdfSidebarForFile(_,e={}){try{let t=await this.deps.app.vault.read(_),n=await this.deps.resolveDocIdForNote(_,t);if(!n)return;let i=this.helpers.extractFirstChunkMarkerFromContent(t);await this.syncPdfSidebarForDoc(n,i==null?void 0:i.pageNumber,i==null?void 0:i.chunkId,e)}catch(t){console.warn("Failed to sync PDF sidebar for opened note",t)}}async syncPdfSidebarForDoc(_,e,t,n={}){if(_){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:_,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let i=await this.deps.getDocIndexEntry(_);i||(i=await this.deps.hydrateDocIndexFromCache(_));let r=i!=null&&i.pdf_path?String(i.pdf_path):"";if(!r)return;let a=this.deps.toVaultRelativePath(r);if(!a){let p=(0,ue.normalizePath)(r);this.deps.app.vault.getAbstractFileByPath(p)instanceof ue.TFile&&(a=p)}if(!a)return;let s=this.deps.app.vault.getAbstractFileByPath(a);if(!(s instanceof ue.TFile)||s.extension.toLowerCase()!=="pdf")return;let o=await this.getPdfSidebarLeaf(!!n.allowCreateLeaf);if(!o){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:t};return}if(!this.isLeafTabActive(o)&&!n.allowCreateLeaf){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:t};return}let l=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(l===null&&t&&(l=await this.resolvePageNumberForChunk(_,t)),l===null||this.isPdfSidebarLeaf(o)&&this.pdfSidebarLeaf===o&&this.pdfSidebarDocId===_&&this.pdfSidebarPdfPath===s.path&&this.pdfSidebarPage===l)return;let c=a,d=l!==null?`${c}#page=${l}`:c;if(await this.openPdfLinkInLeaf(o,s,d),this.pdfSidebarLeaf=o,this.pdfSidebarDocId=_,this.pdfSidebarPdfPath=s.path,this.pdfSidebarPage=l,this.updatePdfSidebarIcon(o),n.allowCreateLeaf&&!this.isLeafTabActive(o))try{await this.deps.app.workspace.revealLeaf(o)}catch(p){console.warn("Failed to reveal PDF sidebar leaf",p)}}finally{this.pdfSyncInFlight=!1;let i=this.queuedPdfSync;this.queuedPdfSync=null,i&&this.syncPdfSidebarForDoc(i.docId,i.pageNumber,i.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(_){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(_)}))}syncPdfSidebarForPreview(_){let e=this.previewScrollEl;if(!e)return;let t=_.getViewData();if(!t)return;let n=Bt.Text.of(t.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(n);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(n,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(_){var n;let e=_.getBoundingClientRect().top,t=_.querySelectorAll("[data-line]");for(let i of Array.from(t))if(i.getBoundingClientRect().bottom>=e+2){let a=(n=i.getAttribute("data-line"))!=null?n:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(_=!1){if(this.pdfSidebarLeaf&&this.isUsableRightSidebarLeaf(this.pdfSidebarLeaf)&&this.isPdfSidebarLeaf(this.pdfSidebarLeaf))return this.pdfSidebarLeaf;this.resetPdfSidebarLeaf();let e=this.findRightSidebarPdfLeaf();if(e)return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;if(_){let t=this.deps.app.workspace;if(typeof t.ensureSideLeaf=="function")try{let i=await t.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!1});if(this.isUsableRightSidebarLeaf(i))return this.pdfSidebarLeaf=i,i.isDeferred&&await i.loadIfDeferred(),this.updatePdfSidebarIcon(i),i}catch(i){console.warn("Failed to ensure PDF side leaf",i)}let n=this.deps.app.workspace.getRightLeaf(!1);if(this.isUsableRightSidebarLeaf(n))return this.pdfSidebarLeaf=n,n}return null}findRightSidebarPdfLeaf(){let _=this.deps.app.workspace;if(typeof _.iterateAllLeaves!="function")return null;let e=null;return _.iterateAllLeaves(t=>{if(!(!this.isUsableRightSidebarLeaf(t)||!this.isPdfSidebarLeaf(t))){if(this.isLeafTabActive(t)){e=t;return}e||(e=t)}}),e}resetPdfSidebarLeaf(){this.pdfSidebarLeaf=null,this.pdfSidebarDocId=null,this.pdfSidebarPdfPath=null,this.pdfSidebarPage=null}isUsableRightSidebarLeaf(_){var t;return this.isRightSidebarLeaf(_)?!!((t=_.containerEl)!=null&&t.isConnected):!1}getLeafViewType(_){var t,n;if(!_)return"";try{let i=_.getViewState();if(typeof(i==null?void 0:i.type)=="string"&&i.type)return i.type}catch(i){console.debug("Failed to read leaf view state",i)}let e=(n=(t=_.view)==null?void 0:t.getViewType)==null?void 0:n.call(t);return typeof e=="string"?e:""}isPdfSidebarLeaf(_){return this.getLeafViewType(_)==="pdf"}isRightSidebarLeaf(_){if(!_)return!1;let t=_.containerEl;return t?!!t.closest(".workspace-split.mod-right-split, .mod-right-split"):!1}updatePdfSidebarIcon(_){if(!_||!this.isRightSidebarLeaf(_)||!this.isPdfSidebarLeaf(_))return;let t=_.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let i=_;if(i.tabHeaderEl&&n.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&n.push(i.tabHeaderInnerIconEl),n.length===0)return;let r=new Set;for(let s of n)if(!r.has(s)){if(r.add(s),s.replaceChildren(),(0,ue.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg){let o=document.createRange().createContextualFragment(this.deps.iconSvg);s.replaceChildren(o)}s.dataset&&(s.dataset.zrrIcon="zrr-pdf")}let a=_.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(_,e,t){var l;if(!await this.ensurePdfLeafReady(_,e)){await _.openFile(e,{active:!1});return}let i=Ie((l=this.getPluginsRegistry())==null?void 0:l["pdf-plus"]),r=Ie(i==null?void 0:i.lib),a=Ie(r==null?void 0:r.workspace),s=typeof(a==null?void 0:a.openPDFLinkTextInLeaf)=="function"?a.openPDFLinkTextInLeaf:null;if(typeof s=="function")try{await s.call(a,_,t,"",{active:!1});return}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150)}let o=_;if(typeof o.openLinkText=="function"){try{await o.openLinkText(t,"",{active:!1})}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150),await o.openLinkText(t,"",{active:!1})}return}await _.openFile(e,{active:!1})}async ensurePdfLeafReady(_,e){if(this.isPdfSidebarLeaf(_))return!0;try{await _.setViewState({type:"pdf",active:!1})}catch(t){console.debug("Failed to set PDF view state on sidebar leaf",t)}if(_.isDeferred)try{await _.loadIfDeferred()}catch(t){console.debug("Failed to load deferred PDF sidebar leaf",t)}if(this.isPdfSidebarLeaf(_))return!0;try{await _.openFile(e,{active:!1})}catch(t){return console.warn("Failed to open PDF file in sidebar leaf",t),!1}return this.isPdfSidebarLeaf(_)}isPdfAnnotationRaceError(_){let e=_ instanceof Error?_.message:typeof _=="string"?_:"";return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(_){return new Promise(e=>setTimeout(e,_))}getPluginsRegistry(){var e;return(e=this.deps.app.plugins)==null?void 0:e.plugins}isLeafTabActive(_){var i;let e=_;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===_;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(_,e){var l,c,d,p,u;if(!_||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,_)||e,n=this.chunkPageCache.get(_);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let i=(0,ue.normalizePath)(`${Y}/${_}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=Ie(await this.deps.readChunkPayload(i)),s=Array.isArray(a==null?void 0:a.chunks)?a.chunks:[],o=new Map;for(let g of s){let y=Ie(g),x=typeof(y==null?void 0:y.chunk_id)=="string"?y.chunk_id.trim():"";if(!x)continue;let k=Number.isFinite((c=y==null?void 0:y.page_start)!=null?c:NaN)?Number(y==null?void 0:y.page_start):null,h=Number.isFinite((d=y==null?void 0:y.page_end)!=null?d:NaN)?Number(y==null?void 0:y.page_end):null,b=k!=null?k:h;b!==null&&(o.set(x,b),o.set(`${_}:${x}`,b))}return this.chunkPageCache.set(_,o),(u=(p=o.get(t))!=null?p:o.get(e))!=null?u:null}};var Xe={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var ve=require("@codemirror/state"),de=require("@codemirror/view"),J=require("obsidian");var H=f=>{if(typeof f=="string")return f.trim();if(typeof f=="number"&&Number.isFinite(f))return String(f);if(Array.isArray(f))for(let _ of f){if(typeof _=="string"&&_.trim())return _.trim();if(typeof _=="number"&&Number.isFinite(_))return String(_)}if(f&&typeof f=="object"){let _=f[0];if(typeof _=="string"&&_.trim())return _.trim();if(typeof _=="number"&&Number.isFinite(_))return String(_)}return""},Wt=f=>{let _=[f.key,f.itemKey,f.id,f.citationKey];for(let e of _)if(typeof e=="string"&&e.trim())return e.trim();return null},Ee=f=>{var e,t,n;let _=(n=(t=f.key)!=null?t:(e=f.data)==null?void 0:e.key)!=null?n:"";return typeof _=="string"?_:""},Qe=f=>{if(!f)return"";let _=f.match(/\b(\d{4})\b/);return _?_[1]:""},Ht=f=>{var e,t,n,i;let _=(i=(n=(e=f.meta)==null?void 0:e.parsedDate)!=null?n:(t=f.data)==null?void 0:t.date)!=null?i:"";return typeof _!="string"?"":Qe(_)},ke=f=>{if(!f||typeof f!="object")return"";if(f.name)return String(f.name);let _=f.firstName?String(f.firstName):"",e=f.lastName?String(f.lastName):"";return[e,_].filter(Boolean).join(", ")||`${_} ${e}`.trim()},Oe=(f,_)=>{let e=[f.citationKey,f["citation-key"],f.citation_key,_==null?void 0:_.citationKey,_==null?void 0:_["citation-key"],_==null?void 0:_.citation_key,f.citationkey,f.citekey,f.citeKey,f.betterBibtexKey,f.betterbibtexkey,_==null?void 0:_.citationkey,_==null?void 0:_.citekey,_==null?void 0:_.citeKey,_==null?void 0:_.betterBibtexKey,_==null?void 0:_.betterbibtexkey];for(let i of e){let r=H(i);if(r)return r}let t=typeof f.extra=="string"?f.extra:"";if(!t)return"";let n=t.split(/\r?\n/);for(let i of n){let r=i.match(/^\s*biblatexcitekey\s*\[([^\]]+)\]\s*$/i);if(r&&r[1])return r[1].trim();let a=i.match(/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:\s*(.+)\s*$/i);if(a&&a[2])return a[2].trim()}return""},yt=f=>{if(!f)return"";let _=[f["citation-key"],f.citationKey,f.citationkey,f.citekey,f.citation_key];for(let e of _){let t=H(e);if(t)return t}return""},Kt=f=>{var e,t;if(!f)return"";let _=(t=(e=f["title-short"])!=null?e:f.shortTitle)!=null?t:f.short_title;return typeof _=="string"?_.trim():""},we=f=>{let _=H(f.shortTitle);if(_)return _;let e=H(f.short_title);if(e)return e;let t=H(f["title-short"]);return t||""},Jt=f=>{let _=typeof f.extra=="string"?f.extra:"";if(!_)return"";let e=_.split(/\r?\n/);for(let n of e){let i=n.match(/^\s*doi\s*:\s*(.+)\s*$/i);if(i&&i[1])return i[1].trim().replace(/[.,;]+$/,"")}let t=_.match(/\b10\.\d{4,9}\/[-._;()/:A-Z0-9]+\b/i);return t?t[0].replace(/[.,;]+$/,""):""},Xt=f=>{var e;if(!f)return"";let _=(e=f.DOI)!=null?e:f.doi;return typeof _=="string"?_.trim().replace(/[.,;]+$/,""):""},Ln=f=>{if(!f)return[];let _=[f.attachments,f.children,f.items,f.attachment,f.allAttachments],e=[];for(let t of _)t&&(Array.isArray(t)?e.push(...t):typeof t=="object"&&e.push(t));return e},bt=f=>{var t,n,i,r,a,s,o,l,c,d,p,u,g,y,x;if(((s=(a=(i=(t=f==null?void 0:f.contentType)!=null?t:f==null?void 0:f.mimeType)!=null?i:(n=f==null?void 0:f.data)==null?void 0:n.contentType)!=null?a:(r=f==null?void 0:f.data)==null?void 0:r.mimeType)!=null?s:"")==="application/pdf")return!0;let e=(x=(y=(u=(p=(c=(o=f==null?void 0:f.filename)!=null?o:f==null?void 0:f.fileName)!=null?c:(l=f==null?void 0:f.data)==null?void 0:l.filename)!=null?p:(d=f==null?void 0:f.data)==null?void 0:d.fileName)!=null?u:f==null?void 0:f.path)!=null?y:(g=f==null?void 0:f.data)==null?void 0:g.path)!=null?x:"";return!!(typeof e=="string"&&e.toLowerCase().endsWith(".pdf"))},Qt=f=>{var t;let _=Ln(f.data);if(_.length>0)return _.some(i=>bt(i))?"yes":"no";let e=(t=f.meta)==null?void 0:t.numChildren;return typeof e=="number"&&e===0?"no":"unknown"};var Tn={artwork:"image",audioRecording:"music",bill:"file-text",blogPost:"globe",book:"book",bookSection:"book-open",case:"scale",computerProgram:"code",conferencePaper:"file-text",dataset:"database",dictionaryEntry:"book",document:"file-text",email:"mail",encyclopediaArticle:"book",film:"film",forumPost:"message-circle",hearing:"file-text",interview:"mic",journalArticle:"file-text",letter:"mail",magazineArticle:"file-text",manuscript:"file-text",map:"map",newspaperArticle:"file-text",patent:"award",podcast:"mic",preprint:"file-text",presentation:"file-text",radioBroadcast:"music",report:"file-text",statute:"scale",thesis:"graduation-cap",tvBroadcast:"film",videoRecording:"film",webpage:"globe"},Yt=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],Dn="https://github.com/jmiba/zotero-redisearch-rag/blob/main/CHANGELOG.md",In=f=>f.includes("STDERR")?"zrr-log-stderr":f.includes("ERROR")?"zrr-log-error":f.includes("WARNING")||f.includes("WARN")?"zrr-log-warning":f.includes("INFO")?"zrr-log-info":null,en=f=>{let _=new ve.RangeSetBuilder;for(let{from:e,to:t}of f.visibleRanges){let n=e;for(;n<=t;){let i=f.state.doc.lineAt(n),r=In(i.text);r&&_.add(i.from,i.from,de.Decoration.line({class:r})),n=i.to+1}}return _.finish()},tn=de.EditorView.theme({".cm-editor":{height:"100%",display:"flex",flexDirection:"column",minHeight:"0"},".cm-scroller":{fontFamily:"var(--font-monospace)",fontSize:"0.85rem",flex:"1",height:"100%",maxHeight:"100%",overflow:"auto"},".zrr-log-error":{color:"var(--text-error)"},".zrr-log-warning":{color:"var(--text-accent)"},".zrr-log-info":{color:"var(--text-muted)"},".zrr-log-stderr":{color:"var(--text-accent)"}}),nn=de.ViewPlugin.fromClass(class{constructor(f){this.decorations=en(f)}update(f){(f.docChanged||f.viewportChanged)&&(this.decorations=en(f.view))}},{decorations:f=>f.decorations}),Fe=class extends J.Modal{constructor(_,e,t,n,i="Value cannot be empty."){super(_),this.titleText=e,this.placeholder=t,this.onSubmit=n,this.emptyMessage=i}onOpen(){let{contentEl:_}=this;_.empty(),_.createEl("h3",{text:this.titleText});let e=_.createEl("input",{type:"text",placeholder:this.placeholder});e.addClass("zrr-u-width-100"),e.focus();let t=_.createEl("button",{text:"Submit"});t.addClass("zrr-u-margin-top-0-75rem");let n=()=>{let i=e.value.trim();if(!i){new J.Notice(this.emptyMessage);return}this.close(),this.onSubmit(i)};t.addEventListener("click",n),e.addEventListener("keydown",i=>{i.key==="Enter"&&n()})}},Me=class extends J.Modal{constructor(e,t,n){super(e);this.markdownComponent=null;this.version=t,this.markdown=n}onOpen(){var a;let{contentEl:e}=this;e.empty(),e.addClass("zrr-release-notes-modal"),e.createEl("h3",{text:"What's new"}),(a=this.markdownComponent)==null||a.unload(),this.markdownComponent=new J.Component,this.markdownComponent.load();let t=String(this.markdown||"").trim();if(t){let s=e.createDiv({cls:"zrr-release-notes-body"});J.MarkdownRenderer.render(this.app,t,s,"",this.markdownComponent)}else e.createEl("p",{text:"This version includes improvements and fixes."});let n=e.createDiv({cls:"zrr-release-notes-body"});J.MarkdownRenderer.render(this.app,`[Full changelog](${Dn})`,n,"",this.markdownComponent),e.createEl("div",{cls:"zrr-release-notes-actions"}).createEl("button",{text:"Close"}).addEventListener("click",()=>this.close())}onClose(){var e;(e=this.markdownComponent)==null||e.unload(),this.markdownComponent=null,this.contentEl.empty()}},Ye=class extends J.Modal{constructor(_,e,t,n,i){super(_),this.chunkId=e,this.initialTags=t,this.onSubmit=n,this.onRegenerate=i}onOpen(){let{contentEl:_}=this;_.empty(),_.createEl("h3",{text:`Edit tags for ${this.chunkId}`});let e=_.createEl("textarea",{attr:{rows:"3"}});e.addClass("zrr-u-width-100"),e.placeholder="Tag1, tag2, tag3",e.value=this.initialTags.join(", "),e.focus();let t=_.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Save tags"}),i=async()=>{let a=(e.value||"").split(/[,;\n]+/).map(o=>o.trim()).filter(o=>o.length>0),s=Array.from(new Set(a));this.close(),await Promise.resolve(this.onSubmit(s))};if(this.onRegenerate){let r=t.createEl("button",{text:"Regenerate"});r.addEventListener("click",()=>{(async()=>{var a;r.setAttribute("disabled","true"),n.setAttribute("disabled","true");try{let s=await((a=this.onRegenerate)==null?void 0:a.call(this));s&&s.length>0?(e.value=s.join(", "),await Promise.resolve(this.onSubmit(s))):s&&new J.Notice("No tags were generated.")}finally{r.removeAttribute("disabled"),n.removeAttribute("disabled")}})()})}n.addEventListener("click",()=>{i()}),e.addEventListener("keydown",r=>{r.key==="Enter"&&(r.metaKey||r.ctrlKey)&&i()})}},et=class extends J.Modal{constructor(_,e,t,n=""){super(_),this.titleText=e,this.content=t,this.noteText=n}onOpen(){let{contentEl:_}=this;if(_.empty(),_.createEl("h3",{text:this.titleText}),this.noteText){let t=_.createEl("div",{text:this.noteText});t.className="zrr-indexed-note"}let e=_.createEl("textarea",{attr:{rows:"12",readonly:"true"}});e.addClass("zrr-u-width-100"),e.value=this.content}},tt=class extends J.Modal{constructor(e,t,n=""){super(e);this.bodyText="";this.plugin=t,this.initialTerm=n}onOpen(){let{contentEl:e}=this;e.empty(),this.modalEl&&(this.modalEl.addClass("zrr-u-width-80vw"),this.modalEl.addClass("zrr-u-max-width-1200px"),this.modalEl.addClass("zrr-u-height-80vh"),this.modalEl.addClass("zrr-u-max-height-90vh"),this.modalEl.addClass("zrr-u-resize-both"),this.modalEl.addClass("zrr-u-overflow-hidden")),e.addClass("zrr-u-display-flex"),e.addClass("zrr-u-flex-direction-column"),e.addClass("zrr-u-height-100"),e.addClass("zrr-u-overflow-hidden"),e.addClass("zrr-u-min-height-0");let t=e.createDiv();t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-align-items-center"),t.addClass("zrr-u-justify-content-space-between"),t.addClass("zrr-u-gap-0-5rem"),t.createEl("h3",{text:"Redis index search"});let n=t.createEl("button",{text:"Copy all"});n.addClass("zrr-u-margin-left-auto"),n.addEventListener("click",()=>{this.copyResultsToClipboard()});let i=e.createDiv();i.addClass("zrr-u-display-flex"),i.addClass("zrr-u-align-items-center"),i.addClass("zrr-u-gap-0-5rem"),i.addClass("zrr-u-margin-0-5rem-0");let r=i.createEl("input");r.type="text",r.placeholder="Search term",r.value=this.initialTerm,r.addClass("zrr-u-flex-1"),r.addClass("zrr-u-min-width-0"),this.inputEl=r,i.createEl("button",{text:"Search"}).addEventListener("click",()=>{this.runSearch()}),r.addEventListener("keydown",c=>{c.key==="Enter"&&(c.preventDefault(),this.runSearch())});let s=e.createDiv();s.addClass("zrr-u-color-var-text-muted"),s.addClass("zrr-u-margin-bottom-0-5rem"),this.statusEl=s;let o=e.createDiv();o.addClass("zrr-u-flex-1-1-0"),o.addClass("zrr-u-min-height-0"),o.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),o.addClass("zrr-u-border-radius-6px"),o.addClass("zrr-u-display-flex"),o.addClass("zrr-u-flex-direction-column"),o.addClass("zrr-u-overflow-auto");let l=ve.EditorState.create({doc:this.bodyText,extensions:[tn,nn,de.EditorView.editable.of(!1),ve.EditorState.readOnly.of(!0),de.EditorView.lineWrapping]});this.editorView=new de.EditorView({state:l,parent:o}),this.initialTerm&&this.runSearch()}onClose(){var e;(e=this.editorView)==null||e.destroy(),this.editorView=void 0}async runSearch(){var n;let e=(((n=this.inputEl)==null?void 0:n.value)||"").trim();if(!e){this.statusEl&&(this.statusEl.textContent="Enter a search term.");return}this.statusEl&&(this.statusEl.textContent="Searching...");let t=await this.plugin.runRedisSearch(e);this.updateEditor(t),this.statusEl&&(this.statusEl.textContent=`Results for "${e}"`)}updateEditor(e){if(!this.editorView)return;let t=this.editorView,n=t.scrollDOM.scrollTop,i=t.state.selection.main,r=e.length,a=Math.min(i.anchor,r),s=Math.min(i.head,r);t.dispatch({changes:{from:0,to:t.state.doc.length,insert:e},selection:{anchor:a,head:s}}),t.scrollDOM.scrollTop=n,this.bodyText=e}copyResultsToClipboard(){let e=this.bodyText||"";if(!e){new J.Notice("Nothing to copy.");return}navigator.clipboard.writeText(e).then(()=>new J.Notice("Results copied to clipboard.")).catch(()=>new J.Notice("Failed to copy results."))}},Se=class extends J.Modal{constructor(_,e,t,n){super(_),this.titleText=e,this.bodyText=t,this.options=n}onOpen(){var r,a,s,o;let{contentEl:_}=this;_.empty(),this.modalEl&&(this.modalEl.addClass("zrr-u-width-80vw"),this.modalEl.addClass("zrr-u-max-width-1200px"),this.modalEl.addClass("zrr-u-height-80vh"),this.modalEl.addClass("zrr-u-max-height-90vh"),this.modalEl.addClass("zrr-u-resize-both"),this.modalEl.addClass("zrr-u-overflow-hidden")),_.addClass("zrr-u-display-flex"),_.addClass("zrr-u-flex-direction-column"),_.addClass("zrr-u-height-100"),_.addClass("zrr-u-overflow-hidden"),_.addClass("zrr-u-min-height-0");let e=_.createDiv();e.addClass("zrr-u-display-flex"),e.addClass("zrr-u-align-items-center"),e.addClass("zrr-u-justify-content-space-between"),e.addClass("zrr-u-gap-0-5rem"),e.createEl("h3",{text:this.titleText});let t=e.createDiv();if(t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),(r=this.options)!=null&&r.onClear){let l=(a=this.options.clearLabel)!=null?a:"Clear log";t.createEl("button",{text:l}).addEventListener("click",()=>{(async()=>{var d,p;try{await((p=(d=this.options)==null?void 0:d.onClear)==null?void 0:p.call(d))}finally{await this.refreshFromSource()}})()})}let n=_.createDiv();n.addClass("zrr-u-flex-1-1-0"),n.addClass("zrr-u-min-height-0"),n.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),n.addClass("zrr-u-border-radius-6px"),n.addClass("zrr-u-display-flex"),n.addClass("zrr-u-flex-direction-column"),n.addClass("zrr-u-overflow-auto");let i=ve.EditorState.create({doc:this.bodyText,extensions:[tn,nn,de.EditorView.editable.of(!0),ve.EditorState.readOnly.of(!1),de.EditorView.lineWrapping]});if(this.editorView=new de.EditorView({state:i,parent:n}),this.refreshFromSource(),(s=this.options)!=null&&s.autoRefresh&&this.options.onRefresh){let l=(o=this.options.refreshIntervalMs)!=null?o:2e3;this.refreshTimer=window.setInterval(()=>{this.refreshFromSource()},l)}}onClose(){var _;this.refreshTimer!==void 0&&(window.clearInterval(this.refreshTimer),this.refreshTimer=void 0),(_=this.editorView)==null||_.destroy(),this.editorView=void 0}async refreshFromSource(){var s;if(!((s=this.options)!=null&&s.onRefresh)||!this.editorView)return;let _="";try{_=await this.options.onRefresh()||""}catch(o){return}if(_===this.bodyText)return;let e=this.editorView,t=e.scrollDOM.scrollTop,n=e.state.selection.main,i=_.length,r=Math.min(n.anchor,i),a=Math.min(n.head,i);e.dispatch({changes:{from:0,to:e.state.doc.length,insert:_},selection:{anchor:r,head:a}}),e.scrollDOM.scrollTop=t,this.bodyText=_}},nt=class extends J.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.filePath=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Overwrite"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},it=class extends J.Modal{constructor(e,t,n,i){super(e);this.resolved=!1;this.notePath=t,this.docId=n,this.onResolve=i}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete note and cached data?"}),e.createEl("p",{text:`This will delete the note and cached chunks/items for doc_id ${this.docId}.`}),e.createEl("p",{text:`Note: ${this.notePath}`});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Delete"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},rt=class extends J.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.reason=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Rebuild redis index?"}),e.createEl("p",{text:this.reason}),e.createEl("p",{text:"This will drop the redissearch index (and embeddings) and rebuild it from cached chunks."});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Drop & rebuild"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},at=class extends J.Modal{constructor(e,t){super(e);this.resolved=!1;this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Purge redis orphaned chunks?"}),e.createEl("p",{text:"This removes redis chunk keys that have no cached item.json or chunk files on disk."}),e.createEl("p",{text:"Cache files are not deleted. Use this to clean up stale redis data."});let t=e.createEl("div");t.addClass("zrr-u-display-flex"),t.addClass("zrr-u-gap-0-5rem"),t.addClass("zrr-u-margin-top-0-75rem");let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Purge orphans"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},st=class extends J.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve metadata conflicts"}),e.createEl("p",{text:"Choose which values to keep for each field."});let t=e.createEl("div");t.addClass("zrr-u-display-grid"),t.addClass("zrr-u-gap-0-75rem");for(let l of this.conflicts){let c=t.createEl("div");c.addClass("zrr-u-display-grid"),c.addClass("zrr-u-gap-0-4rem"),c.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),c.addClass("zrr-u-border-radius-6px"),c.addClass("zrr-u-padding-0-6rem"),c.createEl("div",{text:l.fieldLabel,cls:"zrr-font-semibold"});let d=c.createEl("div");d.addClass("zrr-u-display-grid"),d.addClass("zrr-u-grid-template-columns-1fr-1fr"),d.addClass("zrr-u-gap-0-5rem");let p=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});p.addClass("zrr-u-width-100"),p.value=l.noteValue||"(empty)";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});u.addClass("zrr-u-width-100"),u.value=l.zoteroValue||"(empty)";let g=c.createEl("div");g.addClass("zrr-u-display-flex"),g.addClass("zrr-u-gap-0-5rem"),g.addClass("zrr-u-align-items-center"),g.createEl("span",{text:"Decision:"});let y=g.createEl("select");y.add(new Option(l.noteLabel,"note")),y.add(new Option(l.zoteroLabel,"zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.field,y)}let n=e.createEl("div");n.addClass("zrr-u-display-flex"),n.addClass("zrr-u-flex-wrap-wrap"),n.addClass("zrr-u-gap-0-5rem"),n.addClass("zrr-u-margin-top-0-75rem");let i=l=>{for(let c of this.selects.values())c.value=l},r=n.createEl("button",{text:"Use note for all"}),a=n.createEl("button",{text:"Use Zotero for all"}),s=n.createEl("button",{text:"Skip all"}),o=n.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[t,n]of this.selects.entries())e[t]=n.value||"skip";this.onResolve(e)}}},ot=class extends J.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve annotation conflicts"}),e.createEl("p",{text:"Choose which version to keep for each annotation."});let t=e.createEl("div");t.addClass("zrr-u-display-grid"),t.addClass("zrr-u-gap-0-75rem");for(let l of this.conflicts){let c=t.createEl("div");c.addClass("zrr-u-display-grid"),c.addClass("zrr-u-gap-0-4rem"),c.addClass("zrr-u-border-1px-solid-var-background-modifier-border"),c.addClass("zrr-u-border-radius-6px"),c.addClass("zrr-u-padding-0-6rem"),c.createEl("div",{text:l.title,cls:"zrr-font-semibold"});let d=c.createEl("div");d.addClass("zrr-u-display-grid"),d.addClass("zrr-u-grid-template-columns-1fr-1fr"),d.addClass("zrr-u-gap-0-5rem");let p=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});p.addClass("zrr-u-width-100"),p.value=l.noteValue||"(empty)";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});u.addClass("zrr-u-width-100"),u.value=l.zoteroValue||"(empty)";let g=c.createEl("div");g.addClass("zrr-u-display-flex"),g.addClass("zrr-u-gap-0-5rem"),g.addClass("zrr-u-align-items-center"),g.createEl("span",{text:"Decision:"});let y=g.createEl("select");y.add(new Option("Use note","note")),y.add(new Option("Use Zotero","zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.key,y)}let n=e.createEl("div");n.addClass("zrr-u-display-flex"),n.addClass("zrr-u-flex-wrap-wrap"),n.addClass("zrr-u-gap-0-5rem"),n.addClass("zrr-u-margin-top-0-75rem");let i=l=>{for(let c of this.selects.values())c.value=l},r=n.createEl("button",{text:"Use note for all"}),a=n.createEl("button",{text:"Use Zotero for all"}),s=n.createEl("button",{text:"Skip all"}),o=n.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[t,n]of this.selects.entries())e[t]=n.value||"skip";this.onResolve(e)}}},lt=class extends J.SuggestModal{constructor(e,t){super(e);this.resolved=!1;this.resolveSelection=t,this.setPlaceholder("Select a language for ocr/quality...")}getSuggestions(e){let t=e.trim().toLowerCase();return t?Yt.filter(n=>n.label.toLowerCase().includes(t)||n.value.toLowerCase().includes(t)):Yt}renderSuggestion(e,t){t.setText(e.label),t.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new Fe(this.app,"Custom language hint","e.g., en, de, fr, de,en",t=>this.resolveSelection(t.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},ct=class extends J.SuggestModal{constructor(e,t,n,i){var r,a;super(e);this.includeOnlyIndexed=!1;this.lastError=null;this.indexedDocIds=null;this.querySequence=0;this.queryDebounceMs=200;this.minQueryLength=2;this.maxQueryCacheEntries=100;this.queryCache=new Map;this.plugin=t,this.resolveSelection=n,this.initialQuery=(a=(r=i==null?void 0:i.initialQuery)==null?void 0:r.trim())!=null?a:"",this.includeOnlyIndexed=(i==null?void 0:i.includeOnlyIndexed)===!0,typeof(i==null?void 0:i.minQueryLength)=="number"&&(this.minQueryLength=Math.max(1,Math.floor(i.minQueryLength))),this.setPlaceholder((i==null?void 0:i.placeholder)||"Search Zotero items...")}onOpen(){var t;if(super.onOpen(),!this.initialQuery)return;let e=this;e.inputEl&&(e.inputEl.value=this.initialQuery,(t=e.onInputChanged)==null||t.call(e))}async getSuggestions(e){let t=e.trim();if(t.length>0&&t.length<this.minQueryLength)return[];let n=t.toLowerCase(),i=this.queryCache.get(n);if(i)return i;let r=++this.querySequence;try{if(await new Promise(o=>{window.setTimeout(o,this.queryDebounceMs)}),r!==this.querySequence)return[];if(!this.indexedDocIds){let o=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(o))}let a=await this.plugin.searchZoteroItems(t);if(r!==this.querySequence)return[];let s=this.includeOnlyIndexed?a.filter(o=>{var c;let l=Ee(o);return!!(l&&((c=this.indexedDocIds)!=null&&c.has(l)))}):a;if(this.queryCache.set(n,s),this.queryCache.size>this.maxQueryCacheEntries){let o=this.queryCache.keys().next().value;o!==void 0&&this.queryCache.delete(o)}return s}catch(a){let s=a instanceof Error?a.message:String(a);return this.lastError!==s&&(this.lastError=s,new J.Notice(s)),console.error("Zotero search failed",a),[]}}renderSuggestion(e,t){var k,h,b,w;let n=(k=e.data)==null?void 0:k.title,i=typeof n=="string"&&n.trim()?n:"[No title]",r=Ht(e),a=Ee(e),s=a?(h=this.indexedDocIds)==null?void 0:h.has(a):!1,o=Qt(e),l=typeof((b=e.data)==null?void 0:b.itemType)=="string"?e.data.itemType.trim():"";s&&t.addClass("zrr-indexed-item"),o==="no"&&t.addClass("zrr-no-pdf-item");let c=t.createDiv({cls:"zrr-zotero-suggest-row"}),d=c.createSpan({cls:"zrr-zotero-item-icon"}),p=(w=Tn[l])!=null?w:"file-text";(0,J.setIcon)(d,p);let u=c.createDiv({cls:"zrr-zotero-suggest-text"});u.createEl("div",{text:i,cls:"zrr-zotero-suggest-title"});let g=u.createEl("small",{cls:"zrr-zotero-suggest-meta"}),y=!1,x=()=>{y&&g.createSpan({text:" - "})};r&&(g.createSpan({text:r}),y=!0),s&&(x(),g.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),y=!0),o==="no"&&(x(),g.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),y=!0),t.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,t){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}};var rn={"docling_extract.py":`#!/usr/bin/env python3
# zotero-redisearch-rag tool version: 0.9.23
import argparse
import atexit
import base64
import errno
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.23
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.23
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.23
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.23
...
`).trim()}getBundledReleaseNotesEntries(){var i,r;let e=new Set,t=Array.isArray(Pt)?Pt:[],n=[];for(let a of t){let s=this.normalizeReleaseVersion(String((i=a==null?void 0:a.version)!=null?i:"")),o=this.sanitizeReleaseNotesMarkdown(String((r=a==null?void 0:a.markdown)!=null?r:""));!s||e.has(s)||(e.add(s),n.push({version:s,markdown:o}))}return n.sort((a,s)=>this.compareReleaseVersions(s.version,a.version))}getReleaseNotesMarkdown(e,t){let n=this.normalizeReleaseVersion(e);if(!n)return"";let i=this.normalizeReleaseVersion(t||""),r=this.getBundledReleaseNotesEntries(),a=r.filter(o=>this.compareReleaseVersions(o.version,n)>0?!1:i?this.compareReleaseVersions(o.version,i)>0:o.version===n),s=a.length?a:r.filter(o=>o.version===n);if(!s.length)return"This version includes improvements and fixes.";if(s.length===1){let o=s[0],l=this.stripLeadingVersionHeading(this.sanitizeReleaseNotesMarkdown(String(o.markdown||"")),o.version);return`### v${o.version}
...
`)}async importZoteroItem(){var Z,O,j;try{await this.ensureBundledTools()}catch($){new m.Notice("Failed to sync bundled tools. See console for details."),console.error($);return}if(!await this.warnIfZoteroLocalApiUnavailable("import")&&!this.canUseWebApi())return;let t;try{t=await this.promptZoteroItem()}catch($){new m.Notice("Zotero search failed. See console for details."),console.error($);return}if(!t){new m.Notice("No Zotero item selected.");return}let n=(Z=t.data)!=null?Z:t;!n.key&&t.key&&(n.key=t.key);let i=Wt(n);if(!i){new m.Notice("Could not resolve a stable doc_ID from Zotero item.");return}let r=await this.resolveLanguageHint(n,(O=t.key)!=null?O:n.key),a=this.buildDoclingLanguageHint(r!=null?r:void 0),s=await ze(n,i,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});if(!s){new m.Notice("No PDF attachment found for item.");return}if(this.showStatusProgress("Preparing...",5),!await this.ensureRedisAvailable("import")){this.clearStatusProgress();return}let o=typeof n.title=="string"?n.title:"",l=await this.getDocIndexEntry(i);l&&new m.Notice("Item already indexed. Updating cached files and index.");let c=this.sanitizeFileName(o)||i;if(l!=null&&l.note_path)c=this.sanitizeFileName(R.default.basename(l.note_path,".md"))||c;else if(l!=null&&l.pdf_path){let $=this.toVaultRelativePath(l.pdf_path);$&&$.startsWith((0,m.normalizePath)(this.settings.outputPdfDir))&&(c=this.sanitizeFileName(R.default.basename($,".pdf"))||c)}let d=l?c:await this.resolveUniqueBaseName(c,i),p=(0,m.normalizePath)(`${this.settings.outputPdfDir}/${d}.pdf`),u=(0,m.normalizePath)(`${oe}/${i}.json`),g=(0,m.normalizePath)(`${Y}/${i}.json`),y=this.app.vault.adapter,x=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${d}.md`);l!=null&&l.note_path&&await y.exists(l.note_path)&&(x=(0,m.normalizePath)(l.note_path));let k=await y.exists(x),h=await y.exists(u),b=await y.exists(g),w=this.buildImportTempPath(u,"item"),P=this.buildImportTempPath(g,"chunk"),S=this.buildImportTempPath(x,"note"),v=this.settings.copyPdfToVault||!s.filePath,C=v?await y.exists(p):!1,D=v?this.buildImportTempPath(p,"pdf"):null,L=async()=>{await this.removeVaultFilesIfExist([w,P,S,D])},q=async()=>{await this.removeVaultFilesIfExist([h?null:u,b?null:g,k?null:x,C?null:p])};if(await y.exists(x)&&!await this.confirmOverwrite(x)){new m.Notice("Import canceled.");return}try{if(await this.ensureFolder(oe),await this.ensureFolder(Y),await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let $=this.getLogFileRelativePath(),z=(0,m.normalizePath)(R.default.dirname($));z&&await this.ensureFolder(z),await this.deleteLogFileIfExists();let V=this.getSpellcheckerInfoRelativePath(),K=(0,m.normalizePath)(R.default.dirname(V));K&&await this.ensureFolder(K)}}catch($){new m.Notice("Failed to create output folders."),console.error($),this.clearStatusProgress();return}let F="",W="";try{if(this.settings.copyPdfToVault){let $=s.filePath?await ee.promises.readFile(s.filePath):await dt(s.key,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:ee.promises.readFile}),z=D||p;await this.app.vault.adapter.writeBinary(z,this.bufferToArrayBuffer($)),F=this.getAbsoluteVaultPath(z)}else if(s.filePath)F=s.filePath;else{await this.ensureFolder(this.settings.outputPdfDir);let $=await dt(s.key,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:ee.promises.readFile}),z=D||p;await this.app.vault.adapter.writeBinary(z,this.bufferToArrayBuffer($)),F=this.getAbsoluteVaultPath(z),new m.Notice("Local PDF path unavailable; copied PDF into vault for processing.")}W=this.buildPdfLinkForNote(F,s.key,i)}catch($){await L(),new m.Notice("Failed to download PDF attachment."),console.error($),this.clearStatusProgress();return}try{await this.app.vault.adapter.write(w,JSON.stringify(t,null,2))}catch($){await L(),new m.Notice("Failed to write Zotero item JSON."),console.error($),this.clearStatusProgress();return}let M=this.getPluginDir(),G=R.default.join(M,"tools","docling_extract.py"),I=R.default.join(M,"tools","index_redisearch.py"),U=null;try{this.showStatusProgress(this.formatStatusLabel("Docling extraction...",U),0);let $=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(G,await this.buildDoclingArgs(F,i,P,S,a,!0),K=>this.handleDoclingProgress(K,U),()=>{},$,"docling_extract",void 0,pn),U=await this.readDoclingQualityLabel(P),await this.annotateChunkJsonWithAttachmentKey(P,s.key);let z=await this.readDoclingMetadata(P),V=await this.maybeCreateOcrLayeredPdf(F,z,a);V&&(F=V,W=this.buildPdfLinkFromSourcePath(V),await this.updateChunkJsonSourcePdf(P,V))}catch($){let z=this.getPythonErrorMessage($);await L(),this.isTimeoutLikeErrorMessage(z)?new m.Notice("Docling extraction timed out. Incomplete import files were cleaned up."):new m.Notice("Docling extraction failed. Incomplete import files were cleaned up."),console.error($),this.clearStatusProgress();return}let B=!1;try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",U),0);let $=["--chunks-json",this.getAbsoluteVaultPath(P),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--progress"];this.appendEmbedSubchunkArgs($),this.appendEmbedContextArgs($),this.settings.embedIncludeMetadata&&$.push("--embed-include-metadata"),this.appendChunkTaggingArgs($),await this.runPythonStreaming(I,$,z=>{let V=this.asRecord(z),K=typeof(V==null?void 0:V.total)=="number"?V.total:0,ne=typeof(V==null?void 0:V.current)=="number"?V.current:0;if((V==null?void 0:V.type)==="progress"&&K>0){let pe=Math.round(ne/K*100),fe=typeof V.message=="string"&&V.message.trim()?V.message:`Indexing chunks ${ne}/${K}`,Pe=this.formatStatusLabel(fe,U);this.showStatusProgress(Pe,pe)}},()=>{},null,"docling_extract",void 0,pn)}catch($){let z=this.getPythonErrorMessage($),V=this.classifyIndexingError(z);if(console.error($),V==="embed_dim_mismatch")if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema. Switch to a model with matching dimensions, or drop/rebuild the index."))try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){this.clearStatusProgress(),this.lastReindexFailure==="embed_failure"?new m.Notice("Embedding provider error detected while rebuilding the Redis index. Fix the provider/model settings and retry import."):new m.Notice("Redis index rebuild did not complete. Import stopped.");return}new m.Notice("Redis index rebuilt; resuming import."),B=!0}catch(ne){this.clearStatusProgress(),new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(ne);return}else{this.clearStatusProgress(),new m.Notice("Indexing aborted due to embedding dimension mismatch. Switch models or drop/rebuild the index.");return}if(!B){if(await this.cleanupIndexedChunksForDoc(i),await L(),V==="embed_failure"){this.clearStatusProgress(),new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.");return}if(this.isTimeoutLikeErrorMessage(z)){this.clearStatusProgress(),new m.Notice("Chunk indexing timed out. Incomplete import files were cleaned up.");return}this.clearStatusProgress(),new m.Notice("Redissearch indexing failed. Incomplete import files were cleaned up.");return}}try{let $=D?this.getAbsoluteVaultPath(p):F,z=D?this.buildPdfLinkForNote($,s.key,i):W,V=await this.app.vault.adapter.read(S),K=await this.readChunkPayload(P),ne=this.buildSyncedDoclingContent(i,K,V),pe=await this.buildNoteMarkdown(n,(j=t.meta)!=null?j:{},i,z,s.key,x,u,ne);await this.app.vault.adapter.write(S,pe),await this.replaceVaultFile(w,u),await this.replaceVaultFile(P,g),D&&(await this.replaceVaultFile(D,p),F=$),await this.replaceVaultFile(S,x);let fe=this.app.vault.getAbstractFileByPath(x);fe instanceof m.TFile&&this.scheduleNoteAnnotationSync(fe,2e3,"save")}catch($){await this.cleanupIndexedChunksForDoc(i),await L(),await q(),new m.Notice("Failed to finalize note Markdown. Incomplete import files were cleaned up."),console.error($),this.clearStatusProgress();return}try{let $=we(n);await this.updateDocIndex({doc_id:i,note_path:x,note_title:d,zotero_title:o,short_title:$||void 0,pdf_path:F,attachment_key:s.key});let z=this.app.vault.getAbstractFileByPath(x);z instanceof m.TFile&&(this.pdfSidebar.syncPdfSidebarForFile(z),this.pdfSidebar.maybeSyncPendingPdf())}catch($){console.error("Failed to update doc index",$)}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice(`Indexed Zotero item ${i}.`)}async askZoteroLibrary(){await this.openChatView(!0)}getCurrentMarkdownFile(){let e=this.app.workspace.getActiveViewOfType(m.MarkdownView),t=e==null?void 0:e.file;if(t instanceof m.TFile&&t.extension==="md")return t;let n=this.app.workspace.getActiveFile();if(n instanceof m.TFile&&n.extension==="md")return n;let i=this.app.workspace.getMostRecentLeaf(this.app.workspace.rootSplit),r=i==null?void 0:i.view;if(r instanceof m.MarkdownView){let o=r.file;if(o instanceof m.TFile&&o.extension==="md")return o}let a=this.app.workspace.getLeavesOfType("markdown")[0],s=a==null?void 0:a.view;if(s instanceof m.MarkdownView){let o=s.file;if(o instanceof m.TFile&&o.extension==="md")return o}return null}async syncPdfSidebarForActiveNote(e={}){let t=this.getCurrentMarkdownFile();if(!(t instanceof m.TFile)||t.extension!=="md"){new m.Notice("Open a Markdown note first.");return}await this.pdfSidebar.syncPdfSidebarForFile(t,{allowCreateLeaf:!0}),await this.pdfSidebar.maybeSyncPendingPdf({allowCreateLeaf:!0}),e.revealSidebar&&await this.pdfSidebar.revealPdfSidebar({allowCreateLeaf:!0})}getChatLeaf(){var t;let e=this.app.workspace.getLeavesOfType(Re);return e.length>0?e[0]:this.settings.chatPaneLocation==="right"?(t=this.app.workspace.getRightLeaf(!1))!=null?t:this.app.workspace.getLeaf("split"):this.app.workspace.getLeaf("tab")}async openChatView(e=!1){let t=this.getChatLeaf();await t.setViewState({type:Re,active:!0}),await this.app.workspace.revealLeaf(t);let n=t.view;return n instanceof qe&&e&&n.focusInput(),n}async loadChatHistory(){let e=await this.getActiveChatSessionId();return this.loadChatHistoryForSession(e)}async saveChatHistory(e){let t=await this.getActiveChatSessionId();await this.saveChatHistoryForSession(t,e)}getChatSessionsDir(){return(0,m.normalizePath)(`${ae}/chats`)}getChatExportDir(){let e=(this.settings.chatOutputDir||"").trim();return e?(0,m.normalizePath)(e):(0,m.normalizePath)("zotero/chats")}getChatSessionsIndexPath(){return(0,m.normalizePath)(`${this.getChatSessionsDir()}/index.json`)}getChatSessionPath(e){return(0,m.normalizePath)(`${this.getChatSessionsDir()}/${e}.json`)}async listChatSessions(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,t=this.getChatSessionsIndexPath();if(!await e.exists(t)){let n=new Date().toISOString(),i=[{id:"default",name:"New chat",createdAt:n,updatedAt:n}];return await this.writeChatSessionsIndex({version:1,active:"default",sessions:i}),i}try{let n=await e.read(t),i=this.asRecord(JSON.parse(n));return(Array.isArray(i==null?void 0:i.sessions)?i.sessions:[]).filter(a=>!!(this.asRecord(a)&&typeof a.id=="string")).map(a=>{let s=typeof a.id=="string"?a.id:"";return{id:s,name:typeof a.name=="string"&&a.name.trim()?a.name.trim():s,createdAt:typeof a.createdAt=="string"?a.createdAt:new Date().toISOString(),updatedAt:typeof a.updatedAt=="string"?a.updatedAt:new Date().toISOString()}})}catch(n){return console.warn("Failed to read chat sessions index",n),[]}}async getActiveChatSessionId(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,t=this.getChatSessionsIndexPath();if(!await e.exists(t))return"default";try{let n=await e.read(t),i=JSON.parse(n);return(typeof(i==null?void 0:i.active)=="string"?i.active:"default")||"default"}catch(n){return"default"}}async setActiveChatSessionId(e){var a,s;await this.migrateLegacyChatHistory();let t=await this.readChatSessionsIndex(),n=((a=t.sessions)!=null?a:[]).some(o=>o.id===e),i=new Date().toISOString(),r=n?t.sessions:[...(s=t.sessions)!=null?s:[],{id:e,name:e,createdAt:i,updatedAt:i}];await this.writeChatSessionsIndex({version:1,active:e,sessions:r})}async createChatSession(e){var s;await this.migrateLegacyChatHistory();let t=this.generateChatId(),n=new Date().toISOString(),i=(e||"").trim()||"New chat",a=[...(s=(await this.readChatSessionsIndex()).sessions)!=null?s:[],{id:t,name:i,createdAt:n,updatedAt:n}];return await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionPath(t),JSON.stringify({version:1,messages:[]},null,2)),await this.writeChatSessionsIndex({version:1,active:t,sessions:a}),t}async renameChatSession(e,t){var a,s;await this.migrateLegacyChatHistory();let n=(t||"").trim();if(!n)return;let i=await this.readChatSessionsIndex(),r=((a=i.sessions)!=null?a:[]).map(o=>o.id===e?{...o,name:n}:o);await this.writeChatSessionsIndex({version:1,active:(s=i.active)!=null?s:"default",sessions:r})}async deleteChatSession(e){var s;if(await this.migrateLegacyChatHistory(),!e)return;let t=this.app.vault.adapter,n=await this.readChatSessionsIndex(),i=(s=n.sessions)!=null?s:[];if(i.length<=1)return;let r=i.filter(o=>o.id!==e);if(!r.length)return;let a=n.active===e?r[0].id:n.active;try{await t.remove(this.getChatSessionPath(e))}catch(o){console.warn("Failed to delete chat session file",o)}await this.writeChatSessionsIndex({version:1,active:a,sessions:r})}async loadChatHistoryForSession(e){await this.migrateLegacyChatHistory();let t=this.app.vault.adapter,n=this.getChatSessionPath(e||"default");if(!await t.exists(n))return[];let i=await t.read(n),r;try{r=JSON.parse(i)}catch(o){return[]}let a=this.asRecord(r),s=Array.isArray(r)?r:Array.isArray(a==null?void 0:a.messages)?a.messages:[];return Array.isArray(s)?s.filter(o=>!!(this.asRecord(o)&&typeof o.content=="string")).map(o=>({id:typeof o.id=="string"?o.id:this.generateChatId(),role:o.role==="assistant"?"assistant":"user",content:typeof o.content=="string"?o.content:"",citations:Array.isArray(o.citations)?o.citations:[],retrieved:Array.isArray(o.retrieved)?o.retrieved:[],createdAt:typeof o.createdAt=="string"?o.createdAt:new Date().toISOString()})):[]}async saveChatHistoryForSession(e,t){var l,c;await this.migrateLegacyChatHistory(),await this.ensureFolder(this.getChatSessionsDir());let n=this.app.vault.adapter,i=this.getChatSessionPath(e||"default"),r={version:1,messages:t};await n.write(i,JSON.stringify(r,null,2));let a=await this.readChatSessionsIndex(),s=new Date().toISOString(),o=((l=a.sessions)!=null?l:[]).map(d=>d.id===e?{...d,updatedAt:s}:d);await this.writeChatSessionsIndex({version:1,active:(c=a.active)!=null?c:e,sessions:o})}getRecentChatHistory(e){let t=Math.max(0,this.settings.chatHistoryMessages||0);return t?e.filter(i=>{var r;return i&&((r=i.content)==null?void 0:r.trim())}).slice(-t):[]}async readChatSessionsIndex(){let e=this.app.vault.adapter,t=this.getChatSessionsIndexPath(),n=new Date().toISOString();if(!await e.exists(t))return{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:n,updatedAt:n}]};try{let i=await e.read(t),r=this.asRecord(JSON.parse(i)),a=Array.isArray(r==null?void 0:r.sessions)?r.sessions:[];return{version:1,active:typeof(r==null?void 0:r.active)=="string"?r.active:"default",sessions:a.map(s=>this.asRecord(s)).filter(s=>!!s).map(s=>{let o=typeof s.id=="string"?s.id:"";return{id:o,name:typeof s.name=="string"&&s.name.trim()?s.name.trim():o,createdAt:typeof s.createdAt=="string"?s.createdAt:n,updatedAt:typeof s.updatedAt=="string"?s.updatedAt:n}})}}catch(i){return console.warn("Failed to parse chat sessions index",i),{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:n,updatedAt:n}]}}}async writeChatSessionsIndex(e){await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionsIndexPath(),JSON.stringify(e,null,2))}async migrateLegacyChatHistory(){let e=this.app.vault.adapter,t=(0,m.normalizePath)(`${ae}/chat.json`),n=this.getChatSessionsDir(),i=this.getChatSessionsIndexPath(),r=this.getChatSessionPath("default"),a=await e.exists(t),s=await e.exists(r),o=await e.exists(i);if(!a&&o)return;let l=new Date().toISOString();if(await this.ensureFolder(n),a&&!s)try{await e.rename(t,r)}catch(c){try{let d=await e.read(t);await e.write(r,d),await e.remove(t)}catch(d){console.warn("Failed to migrate legacy chat history",d)}}if(!o){let c=[{id:"default",name:"New chat",createdAt:l,updatedAt:l}];await this.writeChatSessionsIndex({version:1,active:"default",sessions:c})}if(o)try{let c=await e.read(i),d=this.asRecord(JSON.parse(c)),p=Array.isArray(d==null?void 0:d.sessions)?d.sessions:[],u=p.some(y=>{let x=this.asRecord(y);return(x==null?void 0:x.id)==="default"}),g=p.map(y=>this.asRecord(y)).filter(y=>!!y).map(y=>y.id==="default"&&typeof y.name=="string"&&y.name.trim().toLowerCase()==="default"?{...y,name:"New chat"}:y);u&&JSON.stringify(g)!==JSON.stringify(p)&&await this.writeChatSessionsIndex({version:1,active:typeof(d==null?void 0:d.active)=="string"?d.active:"default",sessions:g.map(y=>({id:typeof y.id=="string"?y.id:"",name:typeof y.name=="string"?y.name:"New chat",createdAt:typeof y.createdAt=="string"?y.createdAt:l,updatedAt:typeof y.updatedAt=="string"?y.updatedAt:l}))})}catch(c){}}isPlaceholderChatName(e){let t=(e||"").trim().toLowerCase();return t==="new chat"||t==="default"}normalizeChatTitle(e){let t=(e||"").replace(/\s+/g," ").trim();return t.length>60?`${t.slice(0,57)}...`:t}guessTitleFromMessages(e){let t=e.find(i=>i.role==="user"&&i.content.trim());if(!t)return"New chat";let n=t.content.replace(/\s+/g," ").trim().split(" ").slice(0,8).join(" ");return this.normalizeChatTitle(n||"New chat")}async suggestChatTitleWithLlm(e){var a,s,o;let t=(this.settings.chatBaseUrl||"").trim(),n=(this.settings.chatModel||"").trim();if(!t||!n)return null;let i=t.replace(/\/$/,"");if(i.toLowerCase().includes("api.openai.com")&&(!this.settings.chatApiKey||n.includes("/")))return null;try{let l=`${i}/chat/completions`,c={"Content-Type":"application/json"};this.settings.chatApiKey&&(c.Authorization=`Bearer ${this.settings.chatApiKey}`);let d=e.slice(-8).map(x=>`${x.role.toUpperCase()}: ${x.content}`).join(`
`).slice(0,4e3),u=await(0,m.requestUrl)({url:l,method:"POST",headers:c,body:JSON.stringify({model:n,temperature:.2,messages:[{role:"system",content:"Generate a short, specific title (3-7 words) for the chat. No quotes, no punctuation at the end."},{role:"user",content:d}]}),throw:!1});if(u.status>=400)return null;let g=u.json,y=(o=(s=(a=g==null?void 0:g.choices)==null?void 0:a[0])==null?void 0:s.message)==null?void 0:o.content;return typeof y!="string"?null:this.normalizeChatTitle(y.replace(/^"|"$/g,"").trim())}catch(l){return console.warn("Chat title suggestion failed",l),null}}async finalizeChatSessionNameIfNeeded(e,t,n={}){var c;if(!e)return;let i=t||[];if(!i.some(d=>d.role==="user"&&d.content.trim())||!n.force&&i.length<4)return;let s=((c=(await this.readChatSessionsIndex()).sessions)!=null?c:[]).find(d=>d.id===e);if(!s||!this.isPlaceholderChatName(s.name))return;let l=await this.suggestChatTitleWithLlm(i)||this.guessTitleFromMessages(i);!l||this.isPlaceholderChatName(l)||await this.renameChatSession(e,l)}getRagWorkerTimeoutSec(){let e=Hn;if(this.settings.enableCrossEncoderRerank&&(e+=Kn),this.settings.enableAgenticRag){let t=Number.isFinite(this.settings.agenticMaxIters)?Math.max(1,Math.trunc(this.settings.agenticMaxIters)):2;e+=Math.max(dn,t*dn)}return Math.min(3600,Math.max(60,e))}isRagQueryCancellationMessage(e){let t=(e||"").toLowerCase();return t.includes("python worker request aborted")||t.includes("request aborted")||t.includes("request canceled")||t.includes("request cancelled")||t.includes("canceled_while_waiting_rag_slot")||t.includes("cancelled_while_waiting_rag_slot")||t.includes("client_disconnected")||t.includes("error: canceled")||t.includes("error: cancelled")}cancelActiveRagQuery(){this.activeChatQueryCancelRequested=!0;let e=this.activeChatQueryProcess;if(!e)return!1;if(e.killed)return!0;try{return e.kill("SIGTERM"),!0}catch(t){console.warn("Failed to cancel active RAG query with SIGTERM",t);try{return e.kill(),!0}catch(n){return console.warn("Failed to cancel active RAG query",n),!1}}}async runRagQueryStreaming(e,t,n,i=[]){if(this.activeChatQueryProcess=null,this.activeChatQueryCancelRequested=!1,await this.ensureBundledTools(),!await this.ensureRedisAvailable("chat query")){n({answer:"Redis is not reachable. Please start Redis Stack and try again."});return}let r=this.getPluginDir(),a=R.default.join(r,"tools","rag_query_redisearch.py"),s=["--query",e,"--k","5","--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--chat-base-url",this.settings.chatBaseUrl,"--chat-api-key",this.settings.chatApiKey,"--chat-model",this.settings.chatModel,"--temperature",String(this.settings.chatTemperature),"--stream"];if(this.settings.enableQueryExpansion&&(s.push("--expand-query"),s.push("--expand-count",String(Math.max(1,Math.trunc(this.settings.queryExpansionCount))))),this.settings.enableCrossEncoderRerank){s.push("--rerank");let c=(this.settings.rerankModel||"").trim();c&&s.push("--rerank-model",c)}Number.isFinite(this.settings.rerankCandidateMultiplier)&&s.push("--rerank-candidates",String(Math.max(1,Math.trunc(this.settings.rerankCandidateMultiplier)))),Number.isFinite(this.settings.rrfK)&&s.push("--rrf-k",String(Math.max(1,Math.trunc(this.settings.rrfK)))),Number.isFinite(this.settings.rrfLogTop)&&this.settings.rrfLogTop>0&&s.push("--rrf-log-top",String(Math.max(1,Math.trunc(this.settings.rrfLogTop)))),Number.isFinite(this.settings.maxChunksPerDoc)&&this.settings.maxChunksPerDoc>0&&s.push("--max-per-doc",String(Math.max(1,Math.trunc(this.settings.maxChunksPerDoc)))),this.settings.enableAgenticRag&&(s.push("--agentic","basic"),Number.isFinite(this.settings.agenticMaxIters)&&this.settings.agenticMaxIters>0&&s.push("--agentic-max-iters",String(Math.max(1,Math.trunc(this.settings.agenticMaxIters)))),s.push("--agentic-full-doc-chunks",String(Gn),"--agentic-full-doc-max-chars",String(Wn)));let o=this.buildChatHistoryPayload(i),l=await this.writeChatHistoryTemp(o);l!=null&&l.absolutePath&&s.push("--history-file",l.absolutePath);try{let c=this.getRagWorkerTimeoutSec(),d=async()=>{await this.runPythonStreaming(a,s,u=>{let g=this.asRecord(u);if((g==null?void 0:g.type)==="delta"&&typeof g.content=="string"){t(g.content);return}if((g==null?void 0:g.type)==="phase"){this.logPythonWorkerTiming("rag-phase",g);return}if((g==null?void 0:g.type)==="final"){n(g);return}g!=null&&g.answer&&n(g)},n,void 0,"rag_query_redisearch",u=>{if(this.activeChatQueryProcess=u,this.activeChatQueryCancelRequested&&!u.killed)try{u.kill("SIGTERM")}catch(g){console.warn("Failed to cancel queued chat request",g)}},c)},p=!1;for(;;){if(this.activeChatQueryCancelRequested){n({canceled:!0,answer:"Request canceled."});return}try{await d();break}catch(u){let g=this.getPythonErrorMessage(u);if(this.activeChatQueryCancelRequested||this.isRagQueryCancellationMessage(g)){n({canceled:!0,answer:"Request canceled."});return}let y=this.classifyIndexingError(g);if(y==="embed_dim_mismatch"){if(p){n({answer:"Embedding dimension mismatch persists after rebuild. Check the embedding model settings."});return}if(!await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema.")){n({answer:"Embedding dimension mismatch. Switch models or drop/rebuild the Redis index."});return}try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){let h=this.lastReindexFailure==="embed_failure"?"Embedding provider error detected while rebuilding the index. Fix settings and retry.":"Redis index rebuild did not complete. Chat query stopped.";n({answer:h});return}}catch(k){console.error(k),n({answer:"Failed to drop/rebuild the Redis index. See console for details."});return}p=!0;continue}if(y==="embed_failure"){n({answer:"Embedding provider error detected. Fix the provider/model settings and retry."});return}throw u}}}finally{if(l!=null&&l.relativePath)try{await this.app.vault.adapter.remove(l.relativePath)}catch(c){console.warn("Failed to remove chat history temp file",c)}this.activeChatQueryProcess=null,this.activeChatQueryCancelRequested=!1}}buildChatHistoryPayload(e){return this.getRecentChatHistory(e).map(n=>({role:n.role,content:n.content}))}async writeChatHistoryTemp(e){if(!e.length)return null;let t=(0,m.normalizePath)(`${ae}/tmp`);await this.ensureFolder(t);let n=`chat_history_${Date.now()}_${Math.random().toString(36).slice(2,8)}.json`,i=(0,m.normalizePath)(`${t}/${n}`),r={version:1,messages:e};return await this.app.vault.adapter.write(i,JSON.stringify(r,null,2)),{relativePath:i,absolutePath:this.getAbsoluteVaultPath(i)}}async resolveCitationDisplay(e){let t=await this.getDocIndexEntry(e.doc_id);(!t||!t.note_title||!t.zotero_title||!t.note_path||!t.pdf_path||t.short_title===void 0)&&(t=await this.hydrateDocIndexFromCache(e.doc_id));let n=e.doc_id?await this.resolveNotePathForDocId(e.doc_id):t==null?void 0:t.note_path,i=this.resolveCitationTitle(t,n,e.doc_id),r=this.formatCitationPageLabel(e),a=e.page_start?String(e.page_start):"",s=(t==null?void 0:t.pdf_path)||e.source_pdf||"",o=e.attachment_key||(t==null?void 0:t.attachment_key),l=e.annotation_key||this.extractAnnotationKey(e.chunk_id),c=e.doc_id?this.buildZoteroDeepLink(e.doc_id,o,a,l):void 0;return{noteTitle:i,pageLabel:r,notePath:n||void 0,pdfPath:s||void 0,zoteroUrl:c,pageStart:a||void 0}}resolveCitationTitle(e,t,n){let i=n||"?",r=(e==null?void 0:e.short_title)||(e==null?void 0:e.zotero_title)||(e==null?void 0:e.note_title)||(t?R.default.basename(t,".md"):"")||i;return this.shortenCitationTitle(r)}shortenCitationTitle(e){let t=String(e||"").trim();if(!t)return"?";if(t.length<=un)return t;let n=Math.max(0,un-3);return`${t.slice(0,n).trim()}...`}formatCitationLabel(e,t){let n=e.trim()||"?",i=(t||"").trim();return i?`${n}, p. ${i}`:n}async formatInlineCitations(e,t,n=[],i={}){var d,p,u,g;if(!e)return e;let r=/\[\[?cite:([A-Za-z0-9]+):([^\]\n]+?)\]?\]/g,a=Array.from(e.matchAll(r));if(a.length===0)return e;let s=new Map;for(let y of a){let x=y[0];if(s.has(x))continue;let k=y[1],h=y[2].trim(),b=h.match(/^(\d+)-(\d+)(?::([A-Za-z0-9]+))?$/),w="",P="",S,v,C,D;b?(w=b[1],P=b[2],S=b[3]):D=h;let L=D?n.find(U=>{let B=typeof U.doc_id=="string"?U.doc_id:"";if(B&&B!==k)return!1;let Z=typeof U.chunk_id=="string"?U.chunk_id:"";return Z?Z===D||Z===`${k}:${D}`||Z.endsWith(`:${D}`):!1}):void 0;L&&(!w&&L.page_start!==void 0&&(w=String(L.page_start)),!P&&L.page_end!==void 0&&(P=String(L.page_end)),!C&&typeof L.attachment_key=="string"&&(C=L.attachment_key),!v&&typeof L.annotation_page_label=="string"&&(v=L.annotation_page_label),!S&&typeof L.chunk_id=="string"&&(S=this.extractAnnotationKey(L.chunk_id)));let q={doc_id:k,chunk_id:L==null?void 0:L.chunk_id,annotation_key:S};C&&(q.attachment_key=C),v&&(q.annotation_page_label=v),(w||P)&&(q.page_start=w||P,q.page_end=P||w,q.pages=`${q.page_start}-${q.page_end}`),L!=null&&L.source_pdf&&(q.source_pdf=String(L.source_pdf));let F=(w||P?t.find(U=>{var B,Z;return U.doc_id===k&&String((B=U.page_start)!=null?B:"")===w&&String((Z=U.page_end)!=null?Z:"")===P}):void 0)||t.find(U=>U.doc_id===k)||q,W=F.annotation_key||S;!F.annotation_key&&W&&(F={...F,annotation_key:W}),!F.attachment_key&&C&&(F={...F,attachment_key:C}),!F.annotation_page_label&&v&&(F={...F,annotation_page_label:v});let M=await this.resolveCitationDisplay(F),G=this.formatCitationLabel(M.noteTitle,M.pageLabel),I=this.normalizeChunkIdForNote(F.chunk_id,k);if(this.settings.preferObsidianNoteForCitations&&M.notePath){if(W){let U=F.attachment_key||C||((p=(d=this.docIndex)==null?void 0:d[k])==null?void 0:p.attachment_key)||"",B=F.page_start?String(F.page_start):w||P||"0",Z=this.buildNoteAnnotationLink(M.notePath,W,U,B,G);if(Z){s.set(x,Z);continue}s.set(x,this.buildNoteLink(M.notePath,G));continue}if(I&&!W){s.set(x,this.buildNoteChunkLink(M.notePath,I,G,{nativeAnchor:!!i.nativeObsidianAnchors}));continue}}if(M.zoteroUrl)s.set(x,`[${G}](${M.zoteroUrl})`);else{let U=this.formatCitationLabel(k,M.pageLabel);s.set(x,`(${U})`)}}let o=[],l=0;for(let y of a){let x=y[0],k=(u=y.index)!=null?u:0;if(k<l)continue;o.push(e.slice(l,k));let h=(g=s.get(x))!=null?g:x,b=k>0?e[k-1]:"";b&&!/\s/.test(b)&&!/[([{!]/.test(b)&&o.push(" "),o.push(h),l=k+x.length}o.push(e.slice(l));let c=o.join("");return this.repairTruncatedWikilinks(c)}repairTruncatedWikilinks(e){if(!e||typeof e!="string")return e;let t=e;return t=t.replace(/(\[\[[^\]\n#]+#zrr-chunk:[^\]\n\\|]+)\\\|/g,"$1|"),t=t.replace(/\[\[([^\]\n#]+#zrr-chunk:[^\]\n|]+)(?=\n|$)/g,"[[$1]]"),t=t.replace(/\[\[([^\]\n#]+#zrr-chunk:([^\]\n|]+))\]\]/g,(n,i,r)=>{let a=this.escapeWikiLabel(this.buildDefaultChunkLabel(String(r||"").trim()));return`[[${i}\\|${a}]]`}),t}buildDefaultChunkLabel(e){let t=(e||"").trim(),n=t.match(/^p(\d+)$/i);return n?`p. ${n[1]}`:t||"source"}handleDoclingProgress(e,t){let n=this.asRecord(e);if(!n||n.type!=="progress")return;let i=Number(n.percent);if(!Number.isFinite(i))return;let r=typeof n.message=="string"&&n.message.trim()?n.message:"Docling extraction...";this.showStatusProgress(this.formatStatusLabel(r,t),Math.round(i))}async createChatNoteFromSession(e,t,n){let i=this.getChatExportDir();await this.ensureFolder(i),await this.getDocIndex();let r=this.sanitizeFileName(t)||"Zotero Chat",a=this.formatTimestamp(new Date),s=(0,m.normalizePath)(`${i}/${r}.md`),o=await this.resolveUniqueNotePath(s,`${r}-${a}.md`),l=await this.buildChatTranscript(t,n),c=await this.applyChatExportTemplate(t,l);await this.app.vault.adapter.write(o,c),await this.openNoteInNewTab(o),await this.runChatExportPostCreateCommand(o),new m.Notice(`Chat copied to ${o}`)}async applyChatExportTemplate(e,t){let n=(this.settings.chatExportTemplatePath||"").trim();if(!n)return t;let i=(0,m.normalizePath)(n),r=this.app.vault.getAbstractFileByPath(i);if(!(r instanceof m.TFile))return new m.Notice(`Chat export template not found: ${i}`),t;let a="";try{a=await this.app.vault.read(r)}catch(p){return console.error("Failed to read chat export template",p),new m.Notice("Failed to read chat export template."),t}let s=t.trim(),o=(e||"Zotero Chat").trim(),l=new Date().toISOString(),c=a.replace(/{{\s*chat_title\s*}}/gi,o).replace(/{{\s*chat_created_at\s*}}/gi,l);if(/{{\s*chat_body\s*}}/i.test(c))return c=c.replace(/{{\s*chat_body\s*}}/gi,s),`${c.trim()}
`;let d=c.trim();return d?`${s}

${d}
`:`${s}
`}async runChatExportPostCreateCommand(e){let t=(this.settings.chatExportPostCreateCommandId||"").trim();if(!t)return;await this.openNoteInMain(e);let n=this.app.commands;n!=null&&n.executeCommandById&&n.executeCommandById(t)||new m.Notice(`Chat export command not found: ${t}`)}async buildChatTranscript(e,t){var i,r,a;let n=[];n.push(`# ${e||"Zotero Chat"}`),n.push(""),n.push(`Created: ${new Date().toISOString()}`),n.push("");for(let s of t){let o=s.role==="user"?"## You":"## Assistant";n.push(o),n.push("");let l=s.role==="assistant"?await this.formatInlineCitations(s.content||"",(i=s.citations)!=null?i:[],(r=s.retrieved)!=null?r:[]):s.content||"";if(n.push(l.trim()),n.push(""),s.role==="assistant"&&((a=s.citations)!=null&&a.length)){n.push("### Relevant context sources");let c=this.formatCitationsMarkdown(s.citations);c&&(n.push(c),n.push(""))}}return n.join(`
`).trim()+`
`}async resolveUniqueNotePath(e,t){let n=this.app.vault.adapter;if(!await n.exists(e))return e;let i=R.default.dirname(e),r=(0,m.normalizePath)(R.default.join(i,t));if(!await n.exists(r))return r;let a=2;for(;a<1e3;){let s=(0,m.normalizePath)(R.default.join(i,`${R.default.basename(t,".md")}-${a}.md`));if(!await n.exists(s))return s;a+=1}return r}formatTimestamp(e){let t=n=>String(n).padStart(2,"0");return[e.getFullYear(),t(e.getMonth()+1),t(e.getDate()),"-",t(e.getHours()),t(e.getMinutes())].join("")}async openCitationTarget(e,t){var s,o;let n=t!=null?t:await this.resolveCitationDisplay(e),i=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id),r=e.annotation_key||this.extractAnnotationKey(e.chunk_id);if(this.settings.preferObsidianNoteForCitations&&n.notePath){if(r){let l=e.attachment_key||((o=(s=this.docIndex)==null?void 0:s[e.doc_id||""])==null?void 0:o.attachment_key)||"",c=e.page_start?String(e.page_start):e.page_end?String(e.page_end):"0";if(await this.openNoteAtAnnotation(n.notePath,r,l,c))return}if(i&&!r&&await this.openNoteAtChunk(n.notePath,i))return;await this.openNoteInMain(n.notePath);return}if(n.zoteroUrl){this.openExternalUrl(n.zoteroUrl);return}if(!(n.pdfPath&&await this.openPdfInMain(n.pdfPath,n.pageStart))){if(n.zoteroUrl){this.openExternalUrl(n.zoteroUrl);return}new m.Notice("Unable to open citation target.")}}async rebuildNoteFromCache(){let e=await this.promptDocId();if(!e){new m.Notice("No doc_ID provided.");return}await this.rebuildNoteFromCacheForDocId(e,!0)&&new m.Notice(`Rebuilt Zotero note for ${e}.`)}async reindexCurrentNoteFromCache(){let e=this.app.workspace.getActiveFile();if(!e){new m.Notice("No active note to reindex.");return}await this.reindexNoteFromCacheForFile(e,!0)}async reindexNoteFromCacheForFile(e,t){try{let n=await this.app.vault.read(e),i=await this.resolveDocIdForNote(e,n);if(!i){t&&new m.Notice("No doc_ID found for this note.");return}let r=(0,m.normalizePath)(`${Y}/${i}.json`);if(!await this.app.vault.adapter.exists(r)&&!await this.restoreMissingChunkCacheFromNote(e,n,i,t))return;await this.reindexDocIdFromCache(i,t)&&t&&new m.Notice(`Reindexed ${i}.`)}catch(n){t&&new m.Notice("Failed to reindex note."),console.error("Failed to reindex note",n)}}async rebuildDocIndexFromCache(){var c,d,p;let e=this.app.vault.adapter,t=await this.listDocIds(oe),n=await this.listDocIds(Y),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),r=Object.keys(i),a=Array.from(new Set([...t,...n,...r]));if(a.length===0){new m.Notice("No cached items found.");return}this.showStatusProgress("Rebuilding doc index...",0);let s=await this.getDocIndex(),o=0;for(let u of a){o+=1;let g={},y=i[u];y&&(g.note_path=y.note_path,g.note_title=y.note_title);let x=(0,m.normalizePath)(`${oe}/${u}.json`);if(await e.exists(x))try{let b=await e.read(x),w=JSON.parse(b),P=(d=(c=w==null?void 0:w.data)!=null?c:w)!=null?d:{},S=typeof P.title=="string"?P.title:"";S&&(g.zotero_title=S);let v=we(P);v&&(g.short_title=v);let C=this.sanitizeFileName(S)||u,D=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${C}.md`),L=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${C}-${u}.md`);await e.exists(D)?(g.note_path=D,g.note_title=R.default.basename(D,".md")):await e.exists(L)&&(g.note_path=L,g.note_title=R.default.basename(L,".md"))}catch(b){console.error("Failed to read cached item JSON",b)}let k=(0,m.normalizePath)(`${Y}/${u}.json`);if(await e.exists(k))try{let b=await e.read(k),w=JSON.parse(b);typeof(w==null?void 0:w.source_pdf)=="string"&&(g.pdf_path=w.source_pdf)}catch(b){console.error("Failed to read cached chunks JSON",b)}if(Object.keys(g).length>0){let w={...(p=s[u])!=null?p:{doc_id:u},...g,doc_id:u,updated_at:new Date().toISOString()};!w.note_title&&w.note_path&&(w.note_title=R.default.basename(w.note_path,".md")),typeof w.pdf_path=="string"&&(w.pdf_path=this.normalizeDocIndexPdfPath(w.pdf_path)),s[u]=w}let h=Math.round(o/a.length*100);this.showStatusProgress(`Rebuilding doc index ${o}/${a.length}`,h)}await this.saveDocIndex(s);let l=await this.pruneDocIndexOrphans();this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),l.removed>0?new m.Notice(`Rebuilt doc index for ${a.length} items; pruned ${l.removed} stale entries.`):new m.Notice(`Rebuilt doc index for ${a.length} items.`)}async recreateMissingNotesFromCache(){if(this.recreateMissingNotesActive){new m.Notice("Recreate missing notes is already running.");return}this.recreateMissingNotesActive=!0,this.recreateMissingNotesAbort=!1,this.recreateMissingNotesProcess=null;try{let e=this.app.vault.adapter,t=await this.listDocIds(oe),n=await this.listDocIds(Y),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),r=Object.keys(i),a=Array.from(new Set([...t,...n,...r]));if(a.length===0){new m.Notice("No cached items found.");return}let s=[];for(let c of a){if(i[c])continue;let d=await this.getDocIndexEntry(c);if(d!=null&&d.note_path&&await e.exists(d.note_path))continue;let p=await this.inferNotePathFromCache(c);p&&await e.exists(p)||s.push(c)}if(s.length===0){new m.Notice("No missing notes detected.");return}this.showStatusProgress("Recreating missing notes...",0);let o=0,l=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;for(let c=0;c<s.length&&!this.recreateMissingNotesAbort;c+=1){let d=s[c],p=Math.round((c+1)/s.length*100);this.showStatusProgress(`Recreating ${c+1}/${s.length}`,p),l&&this.appendToLogFile(l,`Recreate missing note doc_id ${d} (${c+1}/${s.length})`,"recreate_missing_notes","INFO"),await this.rebuildNoteFromCacheForDocId(d,!1)&&(o+=1)}this.recreateMissingNotesAbort?(this.showStatusProgress("Canceled",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice(`Canceled after ${o}/${s.length} notes.`)):(this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice(`Recreated ${o}/${s.length} missing notes.`))}finally{this.recreateMissingNotesActive=!1,this.recreateMissingNotesProcess=null}}cancelRecreateMissingNotesFromCache(){if(!this.recreateMissingNotesActive){new m.Notice("No recreate job is running.");return}this.recreateMissingNotesAbort=!0;let e=this.recreateMissingNotesProcess;if(e&&!e.killed){try{e.kill("SIGTERM")}catch(t){console.warn("Failed to terminate recreate process",t)}window.setTimeout(()=>{if(e&&!e.killed)try{e.kill("SIGKILL")}catch(t){console.warn("Failed to force-kill recreate process",t)}},2e3)}new m.Notice("Canceling recreate missing notes...")}buildRedisCommand(e){let t=[`*${e.length}\r
`];for(let n of e){let i=String(n);t.push(`$${Buffer.byteLength(i)}\r
${i}\r
`)}return t.join("")}async checkRedisConnectionWithUrl(e,t=2e3){let n=(e||"").trim();if(!n)return{ok:!1,message:"Redis URL is not configured."};let i;try{i=new URL(n)}catch(c){return{ok:!1,message:"Redis URL is invalid."}}let r=i.hostname||"127.0.0.1",a=Number(i.port)||(i.protocol==="rediss:"||i.protocol==="redis+tls:"?6380:6379),s=decodeURIComponent(i.username||""),o=decodeURIComponent(i.password||""),l=i.protocol==="rediss:"||i.protocol==="redis+tls:";return new Promise(c=>{let d=l?fn.default.connect({host:r,port:a,timeout:t,rejectUnauthorized:!1}):je.default.createConnection({host:r,port:a,timeout:t}),p="",u=o||s?"auth":"ping",g=!1,y=(k,h)=>{if(!g){g=!0;try{d.end(),d.destroy()}catch(b){}c({ok:k,message:h})}},x=k=>{let h=k.trim();if(h){if(h.startsWith("-NOAUTH")){y(!1,"Redis requires authentication. Check your Redis URL credentials.");return}if(h.startsWith("-WRONGPASS")||h.toLowerCase().includes("invalid password")){y(!1,"Redis authentication failed. Check your Redis URL credentials.");return}if(h.startsWith("-ERR")){y(!1,`Redis error: ${h}`);return}if(u==="auth"){if(h.startsWith("+OK")){u="ping",p="",d.write(this.buildRedisCommand(["PING"]));return}y(!1,`Redis auth failed: ${h}`);return}h.startsWith("+PONG")&&y(!0)}};d.on("connect",()=>{if(u==="auth"){let k=s?["AUTH",s,o]:["AUTH",o];d.write(this.buildRedisCommand(k))}else d.write(this.buildRedisCommand(["PING"]))}),d.on("data",k=>{var b;p+=k.toString();let h=p.split(/\r?\n/);p=(b=h.pop())!=null?b:"";for(let w of h)x(w)}),d.on("timeout",()=>{y(!1,"Timed out connecting to Redis.")}),d.on("error",k=>{y(!1,`Redis connection failed: ${k.message}`)}),d.on("close",()=>{g||y(!1,"Redis connection closed unexpectedly.")})})}async checkRedisConnection(e=2e3){return this.checkRedisConnectionWithUrl(this.settings.redisUrl,e)}async ensureRedisAvailable(e){let t=await this.checkRedisConnection();if(t.ok)return!0;let n=t.message?`Redis unavailable for ${e}: ${t.message}`:`Redis unavailable for ${e}.`;return this.notifyContainerOnce(n),!1}isOptionalLookupNetworkError(e){let t=this.getPythonErrorMessage(e).toLowerCase();return t.includes("enotfound")||t.includes("getaddrinfo")||t.includes("eai_again")||t.includes("timed out")||t.includes("etimedout")||t.includes("econnrefused")||t.includes("econnreset")||t.includes("ehostunreach")||t.includes("enetunreach")}isTimeoutLikeErrorMessage(e){let t=(e||"").toLowerCase();return t.includes("timed out")||t.includes("timeout")||t.includes("request timed out")||t.includes("timeout_while_waiting")||t.includes("python worker streaming request timed out")}logOptionalLookupFailure(e,t){if(this.isOptionalLookupNetworkError(t)){console.debug(`${e} (network unavailable)`,t);return}console.warn(e,t)}getPythonErrorMessage(e){if(e instanceof Error)return e.message||String(e);if(typeof e=="string")return e;try{return JSON.stringify(e)}catch(t){return String(e)}}summarizePythonDiagnostic(e,t){let n=e.split(/\r?\n/).map(a=>a.trimEnd()).filter(a=>!!a.trim());if(!n.length)return t;let i=n.findIndex(a=>a.startsWith("Traceback"));if(i>=0)return n.slice(i).slice(-12).join(`
`);let r=[...n].reverse().find(a=>/(^error[:\s]|exception|traceback|failed|timed out|timeout|no module named|not found|enoent|econnrefused|enotfound|valueerror|typeerror|runtimeerror|importerror)/i.test(a));return r||n.slice(-8).join(`
`)}buildImportTempPath(e,t){let n=(0,m.normalizePath)(R.default.dirname(e)),i=R.default.extname(e),r=R.default.basename(e,i),a=`${Date.now()}-${Math.random().toString(36).slice(2,8)}`;return(0,m.normalizePath)(R.default.join(n,`${r}.zrr-${t}-${a}${i}`))}async removeVaultFilesIfExist(e){let t=this.app.vault.adapter;for(let n of e){let i=(0,m.normalizePath)(n||"");if(i)try{await t.exists(i)&&await t.remove(i)}catch(r){console.warn("Failed to remove temporary import file",{target:i,error:r})}}}async replaceVaultFile(e,t){let n=this.app.vault.adapter,i=(0,m.normalizePath)(e),r=(0,m.normalizePath)(t);if(!i||!r||i===r)return;let a=(0,m.normalizePath)(R.default.dirname(r));a&&await this.ensureFolder(a),await n.exists(r)&&await n.remove(r),await n.rename(i,r)}async cleanupIndexedChunksForDoc(e){if(e)try{let t=this.getPluginDir(),n=R.default.join(t,"tools","delete_redis_doc_chunks.py");await this.runPython(n,["--redis-url",this.settings.redisUrl,"--prefix",this.getRedisKeyPrefix(),"--doc-id",e])}catch(t){console.warn("Failed to clean up Redis chunks after import failure",{docId:e,error:t})}}classifyIndexingError(e){let t=e.toLowerCase();return t.includes("embedding dim mismatch")||t.includes("dim mismatch")?"embed_dim_mismatch":t.includes("chunks json not found")?"chunks_missing":t.includes("embedding failed")||t.includes("embedding request failed")||t.includes("unloaded")||t.includes("crashed")||t.includes("model does not exist")||t.includes("failed to load model")||t.includes("connection refused")||t.includes("econnrefused")||t.includes("max retries exceeded")||t.includes("failed to establish a new connection")||t.includes("failed to fetch models")?"embed_failure":"unknown"}async confirmRebuildIndex(e){return new Promise(t=>{new rt(this.app,e,t).open()})}async confirmPurgeRedisOrphans(){return new Promise(e=>{new at(this.app,e).open()})}async dropRedisIndex(e=!1){await this.ensureBundledTools();let t=this.getPluginDir(),n=R.default.join(t,"tools","drop_redis_index.py"),i=["--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName()];e&&i.push("--drop-docs"),await this.runPython(n,i)}async dropAndRebuildRedisIndex(){if(this.reindexCacheActive){new m.Notice("Reindex already running.");return}if(!(!await this.ensureRedisAvailable("drop/rebuild")||!await this.confirmRebuildIndex("This will remove the current RedisSearch index and rebuild it from cached chunks."))){try{await this.dropRedisIndex(!0)}catch(t){let n=t instanceof Error?t.message:String(t);if(n.includes("Unknown Index name")||n.includes("Unknown index name"))console.warn("Redis index missing; skipping drop step.");else{console.error("Failed to drop Redis index",t),new m.Notice("Failed to drop redis index. See console for details.");return}}await this.reindexRedisFromCache()}}async purgeRedisOrphanedKeys(){var r,a,s,o,l;if(!await this.ensureRedisAvailable("purge orphans")||!await this.confirmPurgeRedisOrphans())return;try{await this.ensureBundledTools()}catch(c){new m.Notice("Failed to sync bundled tools. See console for details."),console.error(c);return}let t=this.getPluginDir(),n=R.default.join(t,"tools","purge_redis_orphans.py"),i=["--redis-url",this.settings.redisUrl,"--key-prefix",this.getRedisKeyPrefix(),"--chunk-dir",this.getAbsoluteVaultPath(Y),"--item-dir",this.getAbsoluteVaultPath(oe)];try{let c=await this.runPythonWithOutput(n,i),d=null;try{d=c?JSON.parse(c):null}catch(w){console.warn("Failed to parse purge output",w)}if(!d){new m.Notice("Purge completed. See console for details.");return}let p=(r=this.asRecord(d))!=null?r:{},u=Number((a=p.keys_scanned)!=null?a:0),g=Number((s=p.keys_deleted)!=null?s:0),y=Number((o=p.docs_checked)!=null?o:0),x=Number((l=p.orphan_doc_count)!=null?l:0),k=[`Keys scanned: ${u}`,`Keys deleted: ${g}`,`Docs checked: ${y}`,`Orphan docs: ${x}`],h=await this.pruneDocIndexOrphans();k.push(`Doc index entries removed: ${h.removed}`),h.updated>0&&k.push(`Doc index entries updated: ${h.updated}`);let b=Array.isArray(p.sample_orphan_doc_ids)?p.sample_orphan_doc_ids.filter(Boolean):[];b.length&&k.push("","Sample doc_ids:",...b.map(w=>`- ${w}`)),new Se(this.app,"Redis orphan purge",k.join(`
`)).open(),g===0?new m.Notice("No orphaned redis keys found."):new m.Notice(`Deleted ${g} Redis keys.`)}catch(c){console.error("Failed to purge Redis orphans",c),new m.Notice("Failed to purge redis orphans. See console for details.")}}async reindexRedisFromCache(){if(this.lastReindexFailure=null,this.reindexCacheActive)return new m.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;let e=null,t=0;try{await this.ensureBundledTools()}catch(o){return new m.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let n=await this.listDocIds(Y);if(n.length===0)return new m.Notice("No cached chunks found."),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let i=this.getPluginDir(),r=R.default.join(i,"tools","index_redisearch.py"),a=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null,s=0;this.showStatusProgress("Reindexing cached chunks...",0),a&&this.appendToLogFile(a,`Reindex started: ${n.length} cached items`,"index_redisearch","INFO");for(let o of n){s+=1;let l=Math.round(s/n.length*100);this.showStatusProgress(`Reindexing ${s}/${n.length}`,l);let c=(0,m.normalizePath)(`${Y}/${o}.json`);try{let d=["--chunks-json",this.getAbsoluteVaultPath(c),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(d),this.appendEmbedContextArgs(d),this.settings.embedIncludeMetadata&&d.push("--embed-include-metadata"),this.appendChunkTaggingArgs(d,{allowRegenerate:!1}),a&&this.appendToLogFile(a,`Reindexing doc_id ${o}`,"index_redisearch","INFO"),await this.runPythonStreaming(r,d,p=>{let u=this.asRecord(p);if(!(!a||!u)&&u.type==="progress"&&u.message){let g=typeof u.message=="string"?u.message:"";if(!g)return;this.appendToLogFile(a,g,"index_redisearch","INFO")}},()=>{},a,"index_redisearch")}catch(d){t+=1;let p=this.getPythonErrorMessage(d),u=this.classifyIndexingError(p);if(console.error(`Failed to reindex ${o}`,d),u==="chunks_missing"){new m.Notice(`Chunks cache missing for ${o}. Reimport or rebuild this note.`);continue}if(u==="embed_dim_mismatch"){e={kind:"embed_dim_mismatch",message:p};break}if(u==="embed_failure"){e={kind:"embed_failure",message:p};break}}}if(e){if(this.showStatusProgress("Aborted",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,e.kind==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(l){return new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(l),this.lastReindexFailure="unknown",!1}this.lastReindexFailure="embed_dim_mismatch"}else new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing."),this.lastReindexFailure="embed_failure";return!1}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),t===0?new m.Notice(`Reindexed ${n.length} cached items.`):new m.Notice(`Reindexed ${n.length-t}/${n.length} items (see console).`);try{await this.pruneDocIndexOrphans()}catch(o){console.warn("Failed to prune doc index orphans",o)}return this.reindexCacheActive=!1,this.lastReindexFailure=null,!0}async reindexDocIdFromCache(e,t){if(this.lastReindexFailure=null,this.reindexCacheActive)return t&&new m.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;try{await this.ensureBundledTools()}catch(o){return t&&new m.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let n=(0,m.normalizePath)(`${Y}/${e}.json`);if(!await this.app.vault.adapter.exists(n))return t&&new m.Notice(`Chunks cache missing for ${e}.`),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let r=this.getPluginDir(),a=R.default.join(r,"tools","index_redisearch.py"),s=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;this.showStatusProgress(`Reindexing ${e}...`,0),s&&this.appendToLogFile(s,`Reindexing doc_id ${e}`,"index_redisearch","INFO");try{let o=["--chunks-json",this.getAbsoluteVaultPath(n),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(o),this.appendEmbedContextArgs(o),this.settings.embedIncludeMetadata&&o.push("--embed-include-metadata"),this.appendChunkTaggingArgs(o,{allowRegenerate:!1}),await this.runPythonStreaming(a,o,l=>{let c=this.asRecord(l),d=typeof(c==null?void 0:c.total)=="number"?c.total:0,p=typeof(c==null?void 0:c.current)=="number"?c.current:0;if((c==null?void 0:c.type)==="progress"&&d>0){let u=Math.round(p/d*100),g=typeof c.message=="string"&&c.message.trim()?c.message:`Indexing chunks ${p}/${d}`;this.showStatusProgress(this.formatStatusLabel(g),u)}},()=>{},s,"index_redisearch")}catch(o){let l=this.getPythonErrorMessage(o),c=this.classifyIndexingError(l);if(console.error(`Failed to reindex ${e}`,o),c==="embed_dim_mismatch"){if(this.lastReindexFailure="embed_dim_mismatch",t&&await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),this.reindexCacheActive=!1,await this.reindexRedisFromCache()}catch(p){new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(p),this.lastReindexFailure="unknown"}}else c==="embed_failure"?(this.lastReindexFailure="embed_failure",t&&new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing.")):t&&new m.Notice(`Failed to reindex ${e}. See console for details.`);return this.showStatusProgress("Failed",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!1}return this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!0}async reindexChunkUpdates(e,t,n,i){if(!n.length&&!i.length||!await this.ensureRedisAvailable("reindex updates"))return;let r=this.getPluginDir(),a=R.default.join(r,"tools","index_redisearch.py"),s=["--chunks-json",this.getAbsoluteVaultPath(t),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert"];this.appendEmbedSubchunkArgs(s),this.appendEmbedContextArgs(s),this.settings.embedIncludeMetadata&&s.push("--embed-include-metadata"),this.appendChunkTaggingArgs(s,{allowRegenerate:!1}),n.length&&s.push("--chunk-ids",n.join(",")),i.length&&s.push("--delete-chunk-ids",i.join(","));try{await this.runPython(a,s)}catch(o){let l=this.getPythonErrorMessage(o),c=this.classifyIndexingError(l);if(console.error(`Failed to reindex updated chunks for ${e}`,o),c==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(p){new m.Notice("Failed to drop/rebuild the redis index. See console for details."),console.error(p)}return}c==="embed_failure"&&new m.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.")}}async promptZoteroItem(){return new Promise(e=>{new ct(this.app,this,e).open()})}async listDocIds(e){let t=this.app.vault.adapter,n=(0,m.normalizePath)(e);return await t.exists(n)?(await t.list(n)).files.filter(r=>r.endsWith(".json")).map(r=>R.default.basename(r,".json")):[]}async listMarkdownFiles(e){let t=this.app.vault.adapter,n=(0,m.normalizePath)(e);if(!await t.exists(n))return[];let i=[n],r=[];for(;i.length>0;){let a=i.pop();if(!a)continue;let s=await t.list(a);for(let o of s.files)o.endsWith(".md")&&r.push(o);for(let o of s.folders)i.push(o)}return r}getZoteroFrontmatterKeyVariants(e){let t=e.replace(/_/g," "),n=new Set([t,e,e.replace(/_/g,"-")]);if(e.includes("_")){let i=e.split("_"),r=i[0]+i.slice(1).map(a=>a.charAt(0).toUpperCase()+a.slice(1)).join("");n.add(r)}return Array.from(n)}getFrontmatterValue(e,t){if(!e)return;let n=this.getZoteroFrontmatterKeyVariants(t);for(let i of n)if(Object.prototype.hasOwnProperty.call(e,i))return e[i]}hasFrontmatterKey(e,t){if(!e)return!1;let n=this.getZoteroFrontmatterKeyVariants(t);for(let i of n)if(Object.prototype.hasOwnProperty.call(e,i))return!0;return!1}normalizeZoteroFrontmatterKeys(e){let t=!1;for(let n of gn){let i=n.replace(/_/g," "),r=this.getZoteroFrontmatterKeyVariants(n),a=Object.prototype.hasOwnProperty.call(e,i),s=a?e[i]:void 0;if(!a){for(let o of r)if(o!==i&&Object.prototype.hasOwnProperty.call(e,o)){s=e[o];break}}if(s!==void 0){a||(e[i]=s,t=!0);for(let o of r)o!==i&&Object.prototype.hasOwnProperty.call(e,o)&&(delete e[o],t=!0)}}return t}async normalizeZoteroFrontmatterKeysInFile(e){let t=this.app.metadataCache.getFileCache(e),n=t==null?void 0:t.frontmatter;if(!n)return;let i=this.getFrontmatterValue(n,"doc_id"),r=this.getFrontmatterValue(n,"zotero_key");if(!i&&!r)return;let a={...n};if(!this.normalizeZoteroFrontmatterKeys(a))return;let s=e.path;this.noteSyncSuppressed.add(s),this.noteMetadataSyncSuppressed.add(s);try{await this.app.fileManager.processFrontMatter(e,o=>{this.normalizeZoteroFrontmatterKeys(o)})}catch(o){console.warn("Failed to normalize Zotero frontmatter keys",o)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(s),this.noteMetadataSyncSuppressed.delete(s)},1500)}}normalizeFrontmatterKeySpacing(e){return e.trim()?e.split(/\r?\n/).map(i=>{var l,c;if(/^\s+-\s+/.test(i)||!i.includes(":")||((c=(l=i.match(/^\s*/))==null?void 0:l[0])!=null?c:""))return i;let a=i.indexOf(":");if(a<=0)return i;let s=i.slice(0,a).trim(),o=i.slice(a);for(let d of gn){let p=d.replace(/_/g," ");if(this.getZoteroFrontmatterKeyVariants(d).includes(s))return`${p}${o}`}return i}).join(`
...
${n}`:i}ensureDocIdInNoteContent(e,t){var u,g;let n=e.match(/^---\s*\n([\s\S]*?)\n---\s*\n?/),i=`doc id: ${this.escapeYamlString(t)}`;if(!n)return`---
${i}
---

${e.trimStart()}`;let a=((u=n[1])!=null?u:"").split(/\r?\n/),s=!1,o=a.map(y=>/^\s*doc(?:[_\s-]?id)\s*:/i.test(y)?(s=!0,i):y);s||o.unshift(i);let l=o.join(`
`).trim(),c=(g=n.index)!=null?g:0,d=e.slice(0,c),p=e.slice(c+n[0].length).replace(/^\n+/,"");return`${d}---
${l}
---
${p}`}async findDocIdByNotePath(e){let t=(0,m.normalizePath)(e),n=await this.getDocIndex();for(let[i,r]of Object.entries(n))if(r!=null&&r.note_path&&(0,m.normalizePath)(r.note_path)===t)return i;return null}async resolveDocIdForNote(e,t){let n=this.extractDocIdFromFrontmatter(t),i=this.hasDocIdFieldInFrontmatter(t);if(n&&i)return n;let r=this.extractDocIdFromSyncMarker(t),a=await this.findDocIdByNotePath(e.path),s=n||r||a;if(!s)return xe.test(t)&&!this.missingDocIdWarned.has(e.path)&&(new m.Notice("This Zotero note is missing a doc_ID in frontmatter. Reimport or add doc_ID manually."),this.missingDocIdWarned.add(e.path)),null;if(!i||!n){let o=this.ensureDocIdInNoteContent(t,s);o!==t&&await this.writeNoteWithSyncSuppressed(e.path,o)}return s}async scanNotesForDocIds(e){var r;let t=this.app.vault.adapter,n=await this.listMarkdownFiles(e),i={};for(let a of n)try{let s=await t.read(a),o=(r=this.extractDocIdFromFrontmatter(s))!=null?r:this.extractDocIdFromSyncMarker(s);if(!o)continue;i[o]={doc_id:o,note_path:a,note_title:R.default.basename(a,".md"),updated_at:new Date().toISOString()}}catch(s){console.error("Failed to read note for doc_id scan",s)}return i}setupStatusBar(){let e=this.addStatusBarItem();e.addClass("zrr-status-progress"),e.addClass("status-bar-item-segment"),e.hide();let t=e.createEl("span",{text:"Idle"});t.addClass("zrr-status-label");let i=e.createEl("div",{cls:"zrr-status-bar"}).createEl("div",{cls:"zrr-status-bar-inner"});this.statusBarEl=e,this.statusLabelEl=t,this.statusBarInnerEl=i}showStatusProgress(e,t){if(!(!this.statusBarEl||!this.statusLabelEl||!this.statusBarInnerEl))if(this.statusBarEl.show(),this.statusLabelEl.setText(e),t===null)this.statusBarInnerEl.addClass("indeterminate"),this.statusBarInnerEl.addClass("zrr-status-bar-inner--indeterminate-width"),this.statusBarInnerEl.removeClass("zrr-status-bar-inner--zero-width");else{this.statusBarInnerEl.removeClass("indeterminate"),this.statusBarInnerEl.removeClass("zrr-status-bar-inner--indeterminate-width"),this.statusBarInnerEl.removeClass("zrr-status-bar-inner--zero-width");let n=Math.max(0,Math.min(100,t));this.statusBarInnerEl.style.setProperty("width",`${n}%`)}}clearStatusProgress(){!this.statusBarEl||!this.statusBarInnerEl||(this.statusBarEl.hide(),this.statusBarInnerEl.removeClass("indeterminate"),this.statusBarInnerEl.removeClass("zrr-status-bar-inner--indeterminate-width"),this.statusBarInnerEl.addClass("zrr-status-bar-inner--zero-width"))}formatStatusLabel(e,t){return t?`${e} (Text layer quality ${t})`:e}async readDoclingQualityLabel(e){var t,n,i;try{let r=await this.app.vault.adapter.read(e),a=JSON.parse(r),s=(i=(t=a==null?void 0:a.metadata)==null?void 0:t.effective_confidence_proxy)!=null?i:(n=a==null?void 0:a.metadata)==null?void 0:n.confidence_proxy;if(typeof s=="number")return s.toFixed(2)}catch(r){console.warn("Failed to read Docling quality metadata",r)}return null}async readDoclingMetadata(e){try{let t=await this.app.vault.adapter.read(e),n=JSON.parse(t),i=n==null?void 0:n.metadata;if(i&&typeof i=="object")return i}catch(t){console.warn("Failed to read Docling metadata",t)}return null}async readDoclingQualityLabelFromPdf(e,t){var n;try{let i=this.getPluginDir(),r=R.default.join(i,"tools","docling_extract.py"),a=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,s=["--quality-only","--pdf",e,"--ocr",a],o=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;o&&s.push("--log-file",o),this.settings.ocrMode==="force_low_quality"&&s.push("--force-ocr-low-quality"),s.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),t&&s.push("--language-hint",t);let l=await this.runPythonWithOutput(r,s,o),c=JSON.parse(l),d=(n=c==null?void 0:c.effective_confidence_proxy)!=null?n:c==null?void 0:c.confidence_proxy;if(typeof d=="number")return d.toFixed(2)}catch(i){console.warn("Failed to read Docling quality from PDF",i)}return null}async promptDocId(){return new Promise(e=>{new Fe(this.app,"Rebuild Zotero note from cache","Enter Zotero doc_id (e.g., ABC123)",t=>e(t),"Doc ID cannot be empty.").open()})}async promptLanguageHint(){return new Promise(e=>{new lt(this.app,e).open()})}registerRibbonIcons(){(0,m.addIcon)("zrr-picker",qn),(0,m.addIcon)("zrr-chat",jn),(0,m.addIcon)("zrr-pdf",ln),this.addRibbonIcon("zrr-picker","Import Zotero item and index",()=>this.importZoteroItem()).addClass("zrr-ribbon-picker"),this.addRibbonIcon("zrr-chat","Open Zotero research assistant chat",()=>this.openChatView(!0)).addClass("zrr-ribbon-chat"),this.addRibbonIcon("zrr-pdf","Sync PDF view in right sidebar for current note",()=>{this.syncPdfSidebarForActiveNote({revealSidebar:!0})}).addClass("zrr-ribbon-pdf")}async confirmOverwrite(e){return new Promise(t=>{new nt(this.app,e,t).open()})}async resolveLanguageHint(e,t){let n=typeof e.language=="string"?e.language:"",i=this.normalizeZoteroLanguage(n);if(i)return i;let r=await this.promptLanguageHint();if(r===null)return console.debug("Language selection canceled."),null;let a=this.normalizeZoteroLanguage(r);if(!a)return console.debug("Language selection empty; skipping Zotero update."),"";if(e.language=a,console.debug("Language selected",{language:a,itemKey:t}),t)try{await this.updateZoteroItemLanguage(t,e,a),new m.Notice("Saved language to Zotero.")}catch(s){new m.Notice("Failed to write language back to Zotero."),console.error(s)}else console.warn("Language selected but itemKey is missing; skipping Zotero update.");return a}normalizeZoteroLanguage(e){return(e||"").trim().toLowerCase()}buildDoclingLanguageHint(e){let t=this.normalizeZoteroLanguage(e!=null?e:"");if(!t)return null;let n=t.split(/[^a-z]+/).filter(Boolean),i=n.some(a=>["de","deu","ger","german"].includes(a)),r=n.some(a=>["en","eng","english"].includes(a));return i&&r?"deu+eng":i?"deu":r?"eng":n.length===1&&on[n[0]]?on[n[0]]:t}async fetchZoteroItem(e){try{let t=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),n=await this.requestLocalApi(t,`Zotero item fetch failed for ${t}`);return JSON.parse(n.toString("utf8"))}catch(t){return console.warn("Failed to fetch Zotero item from local API",t),this.canUseWebApi()?this.fetchZoteroItemWeb(e):null}}async fetchZoteroItemCsl(e){try{let t=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}?format=csljson`),n=await this.requestLocalApi(t,`Zotero CSL fetch failed for ${t}`);return this.parseCslPayload(n)}catch(t){return console.warn("Failed to fetch Zotero CSL from local API",t),this.canUseWebApi()?this.fetchZoteroItemCslWeb(e):null}}async fetchZoteroCollectionTitle(e){var r,a,s,o,l,c;let t=(e||"").trim();if(!t)return"";let n=this.collectionTitleCache.get(t);if(n!==void 0)return n;let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/collections/${t}`);try{let d=await this.requestLocalApi(i,`Zotero collection fetch failed for ${i}`),p=JSON.parse(d.toString("utf8")),u=String((s=(a=(r=p==null?void 0:p.data)==null?void 0:r.name)!=null?a:p==null?void 0:p.name)!=null?s:"").trim();return this.collectionTitleCache.set(t,u),u}catch(d){if(!this.canUseWebApi())return this.collectionTitleCache.set(t,""),"";try{let p=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/collections/${t}`),u=await this.requestWebApi(p,`Zotero Web API collection fetch failed for ${p}`),g=JSON.parse(u.toString("utf8")),y=String((c=(l=(o=g==null?void 0:g.data)==null?void 0:o.name)!=null?l:g==null?void 0:g.name)!=null?c:"").trim();return this.collectionTitleCache.set(t,y),y}catch(p){return console.warn("Failed to fetch Zotero collection title",p),this.collectionTitleCache.set(t,""),""}}}async resolveCollectionTitles(e){let n=(Array.isArray(e.collections)?e.collections:[]).map(r=>String(r||"").trim()).filter(Boolean);if(!n.length)return[];let i=[];for(let r of n){let a=await this.fetchZoteroCollectionTitle(r);a&&i.push(a)}return i}async fetchZoteroItemWeb(e){try{let t=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}`),n=await this.requestWebApi(t,`Zotero Web API fetch failed for ${t}`);return JSON.parse(n.toString("utf8"))}catch(t){return console.warn("Failed to fetch Zotero item from Web API",t),null}}async fetchZoteroItemCslWeb(e){try{let t=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}?format=csljson`),n=await this.requestWebApi(t,`Zotero Web API CSL fetch failed for ${t}`);return this.parseCslPayload(n)}catch(t){return console.warn("Failed to fetch Zotero CSL from Web API",t),null}}parseCslPayload(e){try{let t=JSON.parse(e.toString("utf8"));return Array.isArray(t)?typeof t[0]=="object"&&t[0]?t[0]:null:typeof t=="object"&&t?t:null}catch(t){return console.warn("Failed to parse CSL payload",t),null}}async searchZoteroItemsWeb(e){let t=e.trim(),n=["data"];for(let i of n){let r=new URLSearchParams;r.set("itemType","-attachment"),r.set("limit","25"),r.set("include",i),t?r.set("q",t):(r.set("sort","dateAdded"),r.set("direction","desc"));let a=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/top?${r.toString()}`);try{let s=await this.requestWebApi(a,`Zotero Web API search failed for ${a}`),o=JSON.parse(s.toString("utf8"));return Array.isArray(o)?this.normalizeZoteroSearchResults(o):[]}catch(s){console.warn("Failed to search Zotero via web API",s)}}return[]}normalizeZoteroSearchResults(e){return e.map(t=>{var s,o,l,c;let n=(s=this.asRecord(t))!=null?s:{},i=(o=this.asRecord(n.data))!=null?o:{},r=(l=this.asRecord(n.meta))!=null?l:{},a=(c=n.key)!=null?c:i.key;return{key:typeof a=="string"?a:"",data:i,meta:r}}).filter(t=>this.isImportableZoteroResult(t))}isImportableZoteroResult(e){var r,a;if(!(typeof e.key=="string"?e.key.trim():""))return!1;let n=typeof((r=e.data)==null?void 0:r.itemType)=="string"?e.data.itemType.trim().toLowerCase():"";return!(n==="attachment"||n==="note"||n==="annotation"||!(typeof((a=e.data)==null?void 0:a.title)=="string"?e.data.title.trim():""))}async updateZoteroItemLanguage(e,t,n){try{await this.updateZoteroItemLanguageLocal(e,t,n);return}catch(i){if(!this.canUseWebApi())throw i;let r=i instanceof Error?i.message:String(i);console.debug("Local Zotero write failed; trying Web API",{itemKey:e,reason:r}),await this.updateZoteroItemLanguageWeb(e,t,n)}}async updateZoteroItemLanguageLocal(e,t,n){var b,w;let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),r={...t,language:n},a={"Content-Type":"application/json","Zotero-API-Version":"3"},s=typeof r.version=="number"?r.version:Number(r.version);Number.isNaN(s)||(a["If-Unmodified-Since-Version"]=String(s)),console.debug("Zotero language PUT",{url:i,itemKey:e,language:n});try{let P=await this.requestLocalApiWithBody(i,"PUT",r,a,`Zotero update failed for ${i}`);console.debug("Zotero language PUT response",{status:P.statusCode})}catch(P){if(!(P instanceof Error?P.message:String(P)).includes("status 501"))throw P;let v=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.debug("Zotero language PUT unsupported; trying POST",{postUrl:v});let C=await this.requestLocalApiWithBody(v,"POST",[r],a,`Zotero update failed for ${v}`);console.debug("Zotero language POST response",{status:C.statusCode})}let o=this.asRecord(await this.fetchZoteroItem(e)),l=this.asRecord(o==null?void 0:o.data);if(this.normalizeZoteroLanguage(typeof(l==null?void 0:l.language)=="string"?l.language:"")===this.normalizeZoteroLanguage(n))return;let d={...l!=null?l:t,language:n},p={key:e,version:(w=(b=l==null?void 0:l.version)!=null?b:o==null?void 0:o.version)!=null?w:s,data:d},u={...a},g=typeof p.version=="number"?p.version:Number(p.version);Number.isNaN(g)?delete u["If-Unmodified-Since-Version"]:u["If-Unmodified-Since-Version"]=String(g);let y=await this.requestLocalApiWithBody(i,"PUT",p,u,`Zotero update failed for ${i}`);console.debug("Zotero language PUT retry response",{status:y.statusCode});let x=this.asRecord(await this.fetchZoteroItem(e)),k=this.asRecord(x==null?void 0:x.data);if(this.normalizeZoteroLanguage(typeof(k==null?void 0:k.language)=="string"?k.language:"")!==this.normalizeZoteroLanguage(n))throw new Error("Language update did not persist in Zotero.")}async updateZoteroItemLanguageWeb(e,t,n){var x,k;let i=this.getWebApiLibraryPath();if(!i)throw new Error("Web API library path is not configured.");let r=this.buildWebApiUrl(`/${i}/items/${e}`),a=this.asRecord(await this.fetchZoteroItemWeb(e)),s=this.asRecord(a==null?void 0:a.data),o={...s!=null?s:t,language:n},l={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},c=(k=(x=s==null?void 0:s.version)!=null?x:a==null?void 0:a.version)!=null?k:t==null?void 0:t.version,d=typeof c=="number"?c:Number(c);Number.isNaN(d)||(l["If-Unmodified-Since-Version"]=String(d)),console.debug("Zotero Web API language PUT",{url:r,itemKey:e,language:n});let p=await this.requestWebApiWithBody(r,"PUT",o,l,`Zotero Web API update failed for ${r}`);console.debug("Zotero Web API language PUT response",{status:p.statusCode});let u=this.asRecord(await this.fetchZoteroItemWeb(e)),g=this.asRecord(u==null?void 0:u.data);if(this.normalizeZoteroLanguage(typeof(g==null?void 0:g.language)=="string"?g.language:"")!==this.normalizeZoteroLanguage(n))throw new Error("Language update did not persist in Zotero Web API.")}async updateZoteroItemFields(e,t,n){let i=async(r,a)=>{let s=this.buildCitationKeyFallbackUpdates(n);return!s||!this.isCitationKeyFieldUnsupportedError(a)?!1:(console.debug("Retrying Zotero metadata update without native citationKey field",{itemKey:e}),await r(s),!0)};try{await this.updateZoteroItemFieldsLocal(e,t,n);return}catch(r){if(await i(s=>this.updateZoteroItemFieldsLocal(e,t,s),r))return;if(!this.canUseWebApi())throw r;let a=r instanceof Error?r.message:String(r);console.debug("Local Zotero write failed; trying Web API",{itemKey:e,reason:a});try{await this.updateZoteroItemFieldsWeb(e,t,n)}catch(s){if(await i(o=>this.updateZoteroItemFieldsWeb(e,t,o),s))return;throw s}}}buildCitationKeyFallbackUpdates(e){if(!Object.prototype.hasOwnProperty.call(e,"citationKey"))return null;let t={...e};return delete t.citationKey,t}isCitationKeyFieldUnsupportedError(e){let t=e instanceof Error?e.message:String(e);if(!t)return!1;let n=t.toLowerCase();return!n.includes("citationkey")&&!n.includes("citation-key")&&!n.includes("citation key")?!1:n.includes("unknown field")||n.includes("unknown property")||n.includes("invalid field")||n.includes("invalid property")||n.includes("unsupported")||n.includes("cannot be set")||n.includes("not allowed")||n.includes("status 400")}async updateZoteroItemFieldsLocal(e,t,n){let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),r={...t,...n},a={"Content-Type":"application/json","Zotero-API-Version":"3"},s=typeof r.version=="number"?r.version:Number(r.version);Number.isNaN(s)||(a["If-Unmodified-Since-Version"]=String(s)),console.debug("Zotero metadata PUT",{url:i,itemKey:e});try{let o=await this.requestLocalApiWithBody(i,"PUT",r,a,`Zotero update failed for ${i}`);console.debug("Zotero metadata PUT response",{status:o.statusCode})}catch(o){if(!(o instanceof Error?o.message:String(o)).includes("status 501"))throw o;let c=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.debug("Zotero metadata PUT unsupported; trying POST",{postUrl:c});let d=await this.requestLocalApiWithBody(c,"POST",[r],a,`Zotero update failed for ${c}`);console.debug("Zotero metadata POST response",{status:d.statusCode})}}async updateZoteroItemFieldsWeb(e,t,n){var u,g;let i=this.getWebApiLibraryPath();if(!i)throw new Error("Web API library path is not configured.");let r=this.buildWebApiUrl(`/${i}/items/${e}`),a=this.asRecord(await this.fetchZoteroItemWeb(e)),s=this.asRecord(a==null?void 0:a.data),o={...s!=null?s:t,...n},l={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},c=(g=(u=s==null?void 0:s.version)!=null?u:a==null?void 0:a.version)!=null?g:t==null?void 0:t.version,d=typeof c=="number"?c:Number(c);Number.isNaN(d)||(l["If-Unmodified-Since-Version"]=String(d)),console.debug("Zotero Web API metadata PUT",{url:r,itemKey:e});let p=await this.requestWebApiWithBody(r,"PUT",o,l,`Zotero Web API update failed for ${r}`);console.debug("Zotero Web API metadata PUT response",{status:p.statusCode})}sanitizeFileName(e){let t=String(e||"").replace(/[\\/:*?"<>|]/g,"").replace(/\s+/g," ").trim();return t?t.slice(0,120).replace(/[. ]+$/g,"").trim():""}registerNoteRenameHandler(){this.registerEvent(this.app.vault.on("rename",async e=>{var t;if(!(!(e instanceof m.TFile)||e.extension!=="md"))try{let n=await this.app.vault.read(e),i=(t=this.extractDocIdFromFrontmatter(n))!=null?t:this.extractDocIdFromSyncMarker(n);if(!i)return;await this.updateDocIndex({doc_id:i,note_path:e.path,note_title:R.default.basename(e.path,".md")})}catch(n){console.warn("Failed to update doc index for renamed note",n)}}))}registerNoteSyncHandler(){this.registerEvent(this.app.vault.on("modify",e=>{if(!(!(e instanceof m.TFile)||e.extension!=="md")){if(this.noteMetadataSyncSuppressed.has(e.path)){this.noteSyncSuppressed.has(e.path)&&this.scheduleNoteSync(e,2500);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2500),this.scheduleNoteMetadataSync(e,2500,"save"),this.scheduleNoteAnnotationSync(e,2500,"save");return}this.scheduleNoteSync(e),this.scheduleNoteMetadataSync(e,1200,"save"),this.scheduleNoteAnnotationSync(e,1200,"save")}}))}registerNoteOpenHandler(){this.registerEvent(this.app.workspace.on("file-open",e=>{!(e instanceof m.TFile)||e.extension!=="md"||(this.pdfSidebar.syncPdfSidebarForFile(e),this.pdfSidebar.maybeSyncPendingPdf(),this.pdfSidebar.updatePreviewScrollHandler(),this.scheduleNoteMetadataSync(e,600,"open"),this.scheduleNoteAnnotationSync(e,800,"open"),this.normalizeZoteroFrontmatterKeysInFile(e))}))}registerAnnotationFocusSyncHandler(){this.registerDomEvent(window,"focus",()=>{let e=this.app.workspace.getActiveViewOfType(m.MarkdownView),t=e==null?void 0:e.file;!(t instanceof m.TFile)||t.extension!=="md"||this.isZoteroNoteFile(t)&&this.scheduleNoteAnnotationSync(t,600,"open")})}registerPreviewScrollSyncHandlers(){this.registerEvent(this.app.workspace.on("active-leaf-change",()=>{this.pdfSidebar.updatePreviewScrollHandler(),this.pdfSidebar.maybeSyncPendingPdf()})),this.registerEvent(this.app.workspace.on("layout-change",()=>{this.pdfSidebar.updatePreviewScrollHandler(),this.pdfSidebar.maybeSyncPendingPdf()})),this.pdfSidebar.updatePreviewScrollHandler()}registerNoteDeleteMenu(){this.registerEvent(this.app.workspace.on("file-menu",(e,t)=>{if(!(t instanceof m.TFile)||t.extension!=="md")return;let n=(0,m.normalizePath)(this.settings.outputNoteDir),i=(0,m.normalizePath)(t.path);!(n&&(i===n||i.startsWith(`${n}/`)))&&!this.isZoteroNoteFile(t)||(e.addItem(a=>{a.setTitle("Reindex note from cache").onClick(()=>this.reindexNoteFromCacheForFile(t,!0))}),e.addItem(a=>{a.setTitle("Delete Zotero note and cached data").onClick(()=>this.deleteZoteroNoteAndCacheForFile(t))}))}))}findChunkStartLine(e,t){let n=t!=null?t:e.getCursor().line;for(;n>=0;n-=1){let i=e.getLine(n);if(ge.test(i))return{line:n,text:i};if(xe.test(i)||Ce.test(i))break}return null}findChunkEndLine(e,t){for(let n=t;n<e.lineCount();n+=1){let i=e.getLine(n);if(Ne.test(i))return n;if(Ce.test(i))break}return null}findChunkAtCursor(e,t){let n=t!=null?t:e.getCursor().line,i=this.findChunkStartLine(e,n);if(!i)return null;let r=this.findChunkEndLine(e,i.line+1);return r===null||n<i.line||n>r?null:{startLine:i.line,endLine:r,text:i.text}}toggleChunkExclude(e,t){var d;let n=this.findChunkAtCursor(e,t);if(!n){new m.Notice("No synced chunk found at cursor.");return}let i=n.text.match(ge);if(!i){new m.Notice("Invalid chunk marker.");return}let r=((d=i[1])!=null?d:"").trim(),a=n.endLine,s=!1;if(a!==null){for(let p=n.startLine+1;p<a;p+=1)if(Le.test(e.getLine(p))){s=!0;break}}let l=/\bexclude\b/i.test(r)||/\bdelete\b/i.test(r)||s;l?r=r.replace(/\b(delete|exclude)\b/gi,"").replace(/\s{2,}/g," ").trim():r=r?`${r} exclude`:"exclude";let c=`<!-- zrr:chunk${r?" "+r:""} -->`;if(c!==n.text&&e.replaceRange(c,{line:n.startLine,ch:0},{line:n.startLine,ch:n.text.length}),l&&a!==null){let p=[];for(let u=n.startLine+1;u<a;u+=1)Le.test(e.getLine(u))&&p.push(u);for(let u=p.length-1;u>=0;u-=1){let g=p[u],y=e.lineCount();g<y-1?e.replaceRange("",{line:g,ch:0},{line:g+1,ch:0}):e.replaceRange("",{line:g,ch:0},{line:g,ch:e.getLine(g).length})}}new m.Notice(l?"Chunk included.":"Chunk excluded from index.")}toggleChunkExcludeFromToolbar(e){let t=this.app.workspace.getActiveViewOfType(m.MarkdownView);if(!t){new m.Notice("No active editor found.");return}let n=Math.max(0,e-1);this.toggleChunkExclude(t.editor,n)}async openChunkTagEditor(e,t){var d;let n=(0,m.normalizePath)(`${Y}/${e}.json`),i=this.app.vault.adapter;if(!await i.exists(n)){new m.Notice("Chunk cache not found for this document.");return}let r=await this.readChunkPayload(n);if(!r){new m.Notice("Failed to read chunk cache.");return}let a=Array.isArray(r.chunks)?r.chunks:[],s=this.resolveChunkFromPayload(a,t,e);if(!s){new m.Notice(`Chunk ${t} not found in cache.`);return}let o=(d=s.chunk_tags)!=null?d:[],l=Array.isArray(o)?o.map(p=>String(p).trim()).filter(p=>p):(typeof o=="string"?o:"").split(/[|,;\n]+/).map(p=>p.trim()).filter(p=>p),c=typeof s.text=="string"?s.text:"";new Ye(this.app,t,l,async p=>{p.length>0?s.chunk_tags=p:delete s.chunk_tags,await i.write(n,JSON.stringify(r,null,2));let u=typeof s.chunk_id=="string"?s.chunk_id:t;await this.reindexChunkUpdates(e,n,[u],[]),new m.Notice("Chunk tags updated.")},async()=>{if(!c.trim())return new m.Notice("Chunk has no text to tag."),null;let p=await this.renderMarkdownToIndexText(c);return this.requestChunkTags(p)}).open()}async openChunkIndexedTextPreview(e,t){let n=(0,m.normalizePath)(`${Y}/${e}.json`);if(!await this.app.vault.adapter.exists(n)){new m.Notice("Chunk cache not found for this document.");return}let r=await this.readChunkPayload(n);if(!r){new m.Notice("Failed to read chunk cache.");return}let a=Array.isArray(r.chunks)?r.chunks:[],s=this.resolveChunkFromPayload(a,t,e);if(!s){new m.Notice(`Chunk ${t} not found in cache.`);return}let o=typeof s.text=="string"?s.text:"",l=await this.renderMarkdownToIndexText(o),c=this.settings.embedIncludeMetadata?"Note: when \u201CInclude metadata in embeddings\u201D is enabled, the indexer prepends title/authors/tags/section info before embedding. The preview below shows only the chunk text.":"";new et(this.app,`Indexed text for ${t}`,l,c).open()}async openChunkInZotero(e,t){var u,g,y;let n=(0,m.normalizePath)(`${Y}/${e}.json`),i=this.app.vault.adapter,r=null;await i.exists(n)&&(r=await this.readChunkPayload(n));let a=Array.isArray(r==null?void 0:r.chunks)?r==null?void 0:r.chunks:[],s=this.resolveChunkFromPayload(a,t,e),o=(u=s==null?void 0:s.page_start)!=null?u:s==null?void 0:s.pageStart,l=this.asRecord(r==null?void 0:r.metadata),c=H((g=l==null?void 0:l.attachment_key)!=null?g:l==null?void 0:l.attachmentKey);if(!c){let x=await this.getDocIndexEntry(e);c=(y=x==null?void 0:x.attachment_key)!=null?y:""}if(!c){new m.Notice("Attachment key not found for Zotero deeplink.");return}let d=typeof o=="number"?String(o):"",p=this.buildZoteroDeepLink(e,c,d);this.openExternalUrl(p)}async cleanChunkFromToolbar(e){let t=this.app.workspace.getActiveViewOfType(m.MarkdownView);if(!t){new m.Notice("No active editor found.");return}let n=t.editor,i=Math.max(0,e-1),r=this.findChunkAtCursor(n,i);if(!r){new m.Notice("No synced chunk found at cursor.");return}let a=[];for(let c=r.startLine+1;c<r.endLine;c+=1)a.push(n.getLine(c));let s=a.join(`
...
`;n.replaceRange(l,{line:r.startLine+1,ch:0},{line:r.endLine,ch:0}),this.showStatusProgress("Chunk cleaned.",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new m.Notice("Chunk cleaned.")}async requestOcrCleanup(e){var l,c,d,p,u,g,y,x,k;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new m.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let i=Number(this.settings.llmCleanupMaxChars||0);if(i>0&&e.length>i)return new m.Notice("Chunk exceeds ocr cleanup max length. Adjust settings to clean it."),this.openPluginSettings(),null;let r=`${t}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o={model:n,temperature:Number((l=this.settings.llmCleanupTemperature)!=null?l:0),messages:[{role:"system",content:this.getOcrCleanupSystemPrompt()},{role:"user",content:e}]};try{let h=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(o)});if(h.statusCode>=400){let S=h.body.toString("utf8");throw new Error(`Cleanup request failed (${h.statusCode}): ${S||"no response body"}`)}let b=JSON.parse(h.body.toString("utf8")),w=(k=(x=(y=(p=(d=(c=b==null?void 0:b.choices)==null?void 0:c[0])==null?void 0:d.message)==null?void 0:p.content)!=null?y:(g=(u=b==null?void 0:b.choices)==null?void 0:u[0])==null?void 0:g.text)!=null?x:b==null?void 0:b.output_text)!=null?k:"",P=this.escapeGenderStars(String(w||"").trim());return P||(new m.Notice("Cleanup returned empty text."),null)}catch(h){return console.error("OCR cleanup failed",h),new m.Notice("Ocr cleanup failed. Check the cleanup model settings."),null}}getOcrCleanupSystemPrompt(){return["You clean OCR text into Markdown.","Correct OCR errors only when the intended text is clear.","Do not add, remove, or invent content.","Preserve wording, punctuation, and special characters.","Return only the corrected text.","Reformat existing footnote references as [^n].","Reformat existing footnote definitions as [^n]: ....","Do not create new footnotes; only reformat footnotes that already exist.","If paragraph breaks are completely missing, insert them only where the sentence structure clearly supports them.","Do not escape asterisks used for Markdown emphasis, list bullets, multiplication, or other non-gender uses.","Adding the backslash for escaping literal gender stars is allowed and does not count as adding content."].join(" ")}escapeGenderStars(e){return e&&e.replace(/(?<!\\)\b([A-Za-zÄÖÜäöüß]{2,})\*(in(?:nen)?|r|n|m|s)\b/g,(t,n,i)=>`${n}\\*${i}`)}parseChunkTags(e,t){if(!e)return[];let n=e.trim(),i=[];if(n.startsWith("[")&&n.endsWith("]"))try{let s=JSON.parse(n);Array.isArray(s)&&(i=s.map(o=>String(o)))}catch(s){i=[]}i.length===0&&(i=n.split(/[,;\n]+/));let r=new Set,a=[];for(let s of i){let o=s.trim();if(o=o.replace(/^[-•\d.)\s]+/,""),o=o.replace(/\s+/g," ").trim(),!o||o.length<2)continue;let l=o.toLowerCase();if(!r.has(l)&&(r.add(l),a.push(o),a.length>=t))break}return a}async requestChunkTags(e){var p,u,g,y,x,k,h,b,w;let t=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),n=(this.settings.llmCleanupModel||"").trim();if(!t||!n)return new m.Notice("Ocr cleanup model is not configured."),this.openPluginSettings(),null;let i=e.trim().slice(0,2e3);if(!i)return[];let r=`${t}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o=5,l="Return 3 to 5 high-signal, concrete noun-phrase tags. Avoid generic terms (study, paper, method), verbs, and filler. Prefer specific entities, methods, datasets, and named concepts. Output comma-separated tags only. No extra text.",c=Number((p=this.settings.llmCleanupTemperature)!=null?p:0),d={model:n,messages:[{role:"system",content:l},{role:"user",content:i}]};Number.isFinite(c)&&(d.temperature=c),this.showStatusProgress("Generating tags...",null);try{let P=async L=>{let q=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(L)});if(q.statusCode>=400){let F=q.body.toString("utf8");throw new Error(`Tag request failed (${q.statusCode}): ${F||"no response body"}`)}return q.body},S;try{S=await P(d)}catch(L){let q=L instanceof Error?L.message:String(L);if("temperature"in d&&/temperature/i.test(q)&&/unsupported|default/i.test(q)){let F={...d};delete F.temperature,S=await P(F)}else throw L}let v=JSON.parse(S.toString("utf8")),C=(w=(b=(h=(y=(g=(u=v==null?void 0:v.choices)==null?void 0:u[0])==null?void 0:g.message)==null?void 0:y.content)!=null?h:(k=(x=v==null?void 0:v.choices)==null?void 0:x[0])==null?void 0:k.text)!=null?b:v==null?void 0:v.output_text)!=null?w:"",D=this.parseChunkTags(String(C||""),o);return D.length||new m.Notice("Tag generation returned no tags."),D}catch(P){return console.error("Tag generation failed",P),new m.Notice("Tag generation failed. Check the cleanup model settings."),null}finally{this.clearStatusProgress()}}async renderMarkdownToIndexText(e){if(!e)return"";let t=this.replaceImageMarkersForIndexPreview(e),n=document.createElement("div"),i=new m.Component;i.load();try{await m.MarkdownRenderer.render(this.app,t,n,"",i)}catch(a){return console.warn("Failed to render markdown for index preview",a),this.normalizeIndexPreviewText(t)}finally{i.unload()}let r=n.textContent||t;return this.normalizeIndexPreviewText(r)}replaceImageMarkersForIndexPreview(e){if(!e)return"";let t=i=>{let r=i.trim();return r?`Image caption: ${r}`:"Image"},n=e.replace(/!\[\[([^\]|]+)(?:\|([^\]]+))?\]\]/g,(i,r,a)=>t(a||""));return n=n.replace(/!\[([^\]]*)]\([^)]+\)/g,(i,r)=>t(r||"")),n=n.replace(/<img[^>]*>/gi,i=>{let r=i.match(/\balt=(['"])([^'"]*)\1/i);return t(r?r[2]:"")}),n}normalizeIndexPreviewText(e){return e.replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/[ \t]+/g," ").replace(/\n{3,}/g,`

`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,t=1200){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},t);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,t=1200,n="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,n)},t);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,t=1200,n="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,n)},t);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let t=this.annotationNoteEditTimes.get(e);if(!t)return 0;let n=Date.now()-t;return n>=_n?0:_n-n}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let t=(e.annotation_page_label||"").trim();if(t)return t;let n=e.page_start?String(e.page_start):"",i=e.page_end?String(e.page_end):"";if(n&&(!i||n===i))return n;if(n&&i)return`${n} - ${i}`;let r=(e.pages||"").trim();if(!r)return"?";let a=r.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:r.replace("-"," - ")}normalizeChunkIdForNote(e,t){if(!e)return null;let n=String(e);if(t&&n.startsWith(`${t}:`))return n.slice(t.length+1);if(n.includes(":")){let i=n.split(":");if(i.length>1&&t&&i[0]===t)return i.slice(1).join(":")}return n}async syncNoteToRedis(e){if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let t=await this.app.vault.read(e),n=this.extractSyncSection(t);if(!n)return;let i=await this.resolveDocIdForNote(e,t);if(!i)return;let r=this.parseSyncedChunkBlocks(n);if(!r.length)return;let a=(0,m.normalizePath)(`${Y}/${i}.json`),s=this.app.vault.adapter;if(!await s.exists(a)&&!await this.restoreMissingChunkCacheFromNote(e,t,i,!1))return;let o=await this.readChunkPayload(a);if(!o)return;let l=Array.isArray(o.chunks)?o.chunks:[],c=new Map;for(let k of l){if(this.isAnnotationChunk(k))continue;let h=typeof(k==null?void 0:k.chunk_id)=="string"?k.chunk_id:"";h&&c.set(h,k)}let d=new Set,p=new Set,u=new Set,g=new Set,y=!1;for(let k of r){let h=k.chunkId;if(!h)continue;d.add(h);let b=c.get(h);if(!b){console.warn(`Sync note: chunk id not found in cache (${h})`);continue}if(k.excludeFlag){b.excluded!==!0&&(b.excluded=!0,y=!0);let S=this.normalizeChunkText(k.text),v=typeof b.text=="string"?b.text:"";S&&S!==v&&(b.text=S,b.char_count=S.length,y=!0),u.add(h);continue}if(b.excluded&&(b.excluded=!1,y=!0,p.add(h)),!k.text.trim()){u.add(h),g.add(h);continue}let w=this.normalizeChunkText(k.text);if(!w){u.add(h),g.add(h);continue}let P=typeof b.text=="string"?b.text:"";w!==P&&(b.text=w,b.char_count=w.length,p.add(h),y=!0)}for(let k of c.keys())d.has(k)||(u.add(k),g.add(k));let x=new Set([...u,...g]);if(x.size){let k=Array.from(x).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==k){this.noteSyncPendingDeletes.set(e.path,k),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!p.size&&!u.size&&!g.size&&!y)return;g.size&&(o.chunks=l.filter(k=>{let h=typeof(k==null?void 0:k.chunk_id)=="string"?k.chunk_id:"";return h&&!g.has(h)}),y=!0),(y||g.size)&&await s.write(a,JSON.stringify(o,null,2)),await this.reindexChunkUpdates(i,a,Array.from(p),Array.from(u)),(u.size||g.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(t){console.warn("Failed to sync note edits to Redis",t)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,t){var n,i,r,a;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,t);return}this.noteMetadataSyncInFlight.add(e.path);try{let s=await this.app.vault.read(e),o=await this.resolveDocIdForNote(e,s);if(!o)return;let l=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter;if(!l)return;let c=this.resolveZoteroItemKey(l,o);if(!c)return;let d=this.asRecord(await this.fetchZoteroItem(c)),p=(i=this.asRecord(d==null?void 0:d.data))!=null?i:d;if(!p||typeof p!="object")return;let u=this.extractNoteMetadata(l),g=this.extractZoteroMetadata(p);g.citekey||(g.citekey=await this.resolveZoteroCitekey(p,c,(r=this.asRecord(d==null?void 0:d.meta))!=null?r:{}));let y=await this.getMetadataSnapshot(o,l,e),x={},k={},h={},b=[],w=["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],P={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publication_title:"publication_title",book_title:"book_title",journal_abbrev:"journal_abbrev",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},S=Object.fromEntries(w.map(L=>[L,this.hasFrontmatterKey(l,P[L])])),v=new Set(["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","authors","editors"]),C=w.filter(L=>S[L]||!this.isMetadataValueEmpty(u[L])||!this.isMetadataValueEmpty(g[L]));if(!C.length)return;let D={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publication_title:"Publication title",book_title:"Book title",journal_abbrev:"Journal abbreviation",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let L of C){let q=u[L],F=g[L];if(this.metadataValuesEqual(L,q,F))continue;let W=this.isMetadataValueEmpty(q),M=this.isMetadataValueEmpty(F),G=y==null?void 0:y[L];if(G===void 0){if(W&&!M){h[L]="zotero",this.assignMetadataUpdate(x,L,F);continue}if(!W&&M&&v.has(L)){h[L]="note",this.assignMetadataUpdate(k,L,q);continue}}if(G!==void 0){let U=!this.metadataValuesEqual(L,q,G),B=!this.metadataValuesEqual(L,F,G);if(U&&!B){h[L]="note",this.assignMetadataUpdate(k,L,q);continue}if(!U&&B){h[L]="zotero",this.assignMetadataUpdate(x,L,F);continue}}let I=this.getMetadataDecisionLabels(L,q,F,D);b.push({field:L,fieldLabel:D[L],noteLabel:I.noteLabel,zoteroLabel:I.zoteroLabel,noteValue:this.formatMetadataValue(q),zoteroValue:this.formatMetadataValue(F)})}if(b.length>0){let L=await this.promptMetadataBatchDecision(b);for(let q of b){let F=(a=L[q.field])!=null?a:"skip";h[q.field]=F,F==="note"?this.assignMetadataUpdate(k,q.field,u[q.field]):F==="zotero"&&this.assignMetadataUpdate(x,q.field,g[q.field])}}Object.keys(x).length>0&&await this.applyNoteMetadataUpdates(e,x),Object.keys(k).length>0&&await this.applyZoteroMetadataUpdates(c,p,u,g,k),await this.updateMetadataSnapshot(e,o,u,g,y,h,C)}catch(s){console.warn("Failed to sync note metadata with Zotero",s)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,t)}}async syncNoteAnnotationsWithZotero(e,t){var n,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,t);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let M=this.ensureDocIdInNoteContent(o,d);M!==o&&await this.writeNoteWithSyncSuppressed(e.path,M)}if(!d)return;let p=(i=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter)!=null?i:{},u=(r=c.attachmentKey)!=null?r:"";if(u||(u=await this.resolveAttachmentKeyForDocId(d,p)),!u)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===u&&await this.updateDocIndex({doc_id:d,attachment_key:u});let g=u,y=await this.fetchZoteroAnnotationsForDoc(d,u),x=y.annotations;u=y.attachmentKey,u&&u!==g&&await this.updateDocIndex({doc_id:d,attachment_key:u});let k=this.parseAnnotationBlock(l.block,u),h=new Map;for(let M of k)M.key&&M.imagePath&&h.set(M.key,{path:M.imagePath,hash:M.imageHash||this.extractAnnotationImageHashFromPath(M.imagePath)});await this.attachAnnotationImages(d,u,x,e.path,h);let b=new Map;for(let M of k)M.key&&b.set(M.key,M);let w=new Map;for(let M of x)w.set(M.key,M);let P=!1,S=!1,v=!1;if(y.hadFetchError)b.size>0&&x.length===0&&console.debug("Skipping annotation-prune sync due incomplete Zotero annotation fetch.",{docId:d,attachmentKey:u,reason:t});else for(let M of b.keys())w.has(M)||(S=!0);let C=await this.getAnnotationSnapshot(d),D=(a=C==null?void 0:C.annotations)!=null?a:{},L={},q=[];u&&u!==g&&x.length>0&&(S=!0,v=!0);for(let[M,G]of w.entries()){let I=b.get(M);if(!I){S=!0;continue}let U=D[M],B=this.annotationSnapshotFromEntry(I,G.annotationType),Z=this.annotationSnapshotFromEntry(G,G.annotationType),O=(B.image_hash||"")!==(Z.image_hash||"");if(!U){this.annotationSnapshotsEqualIgnoringImage(B,Z)?O&&(S=!0,v=!0):(L[M]="note",P=!0);continue}let j=!this.annotationSnapshotsEqual(B,U),$=!this.annotationSnapshotsEqual(Z,U),z=(Z.color_key||"")!==(U.color_key||""),V=!this.annotationSnapshotsEqualIgnoringImage(B,U),K=!this.annotationSnapshotsEqualIgnoringImage(Z,U);V&&!K?(L[M]="note",P=!0):!V&&K?(L[M]="zotero",S=!0):V&&K&&q.push({key:M,title:this.formatAnnotationConflictTitle(G),noteValue:this.formatAnnotationConflictValue(B,I.tags),zoteroValue:this.formatAnnotationConflictValue(Z,G.tags)}),O&&(j||$)&&(S=!0,v=!0),z&&(S=!0,v=!0)}if(q.length>0){let M=await this.promptAnnotationBatchDecision(q);for(let G of q){let I=(s=M[G.key])!=null?s:"skip";L[G.key]=I,I==="note"?P=!0:I==="zotero"&&(S=!0,v=!0)}}let F=[];for(let[M,G]of Object.entries(L)){if(G!=="note")continue;let I=b.get(M),U=w.get(M);!I||!U||F.push({entry:U,note:I})}F.length>0&&await this.applyZoteroAnnotationUpdates(F),P&&this.annotationNoteEditTimes.set(e.path,Date.now());let W=this.getAnnotationGraceRemaining(e.path);if(S&&W>0&&P&&!v&&(this.scheduleNoteAnnotationSync(e,W+250,t),S=!1),S){let M=this.buildAnnotationBlock(d,u,x),G=this.replaceAnnotationBlock(o,M);if(G&&G!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,G)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,u,x),await this.updateAnnotationChunks(d,u,x,{allowDeletes:!y.hadFetchError})}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,t)}}resolveZoteroItemKey(e,t){let n=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),t];for(let i of n){let r=H(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,t){var l;if(!e)return"";let n=await this.getDocIndexEntry(e);if(n||(n=await this.hydrateDocIndexFromCache(e)),n!=null&&n.attachment_key)return n.attachment_key;let i=(0,m.normalizePath)(`${Y}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let d=await this.readChunkPayload(i),p=this.asRecord(d==null?void 0:d.metadata),u=p==null?void 0:p.attachment_key;if(typeof u=="string"&&u.trim())return await this.updateDocIndex({doc_id:e,attachment_key:u.trim()}),u.trim()}}catch(c){}let r=this.resolveZoteroItemKey(t,e);if(!r)return"";let a=this.asRecord(await this.fetchZoteroItem(r)),s=(l=this.asRecord(a==null?void 0:a.data))!=null?l:a;if(!s||typeof s!="object")return"";let o=await ze(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var w,P,S,v,C,D,L,q,F,W,M,G,I,U,B,Z,O,j,$,z,V,K;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString((v=(S=(P=(w=e==null?void 0:e["short title"])!=null?w:e==null?void 0:e.short_title)!=null?P:e==null?void 0:e.shortTitle)!=null?S:e==null?void 0:e["short-title"])!=null?v:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString((q=(L=(D=(C=e==null?void 0:e.citekey)!=null?C:e==null?void 0:e["citation key"])!=null?D:e==null?void 0:e.citation_key)!=null?L:e==null?void 0:e.citationKey)!=null?q:e==null?void 0:e["citation-key"]),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString((F=e==null?void 0:e.abstract)!=null?F:e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((W=e==null?void 0:e.doi)!=null?W:e==null?void 0:e.DOI),o=this.normalizeMetadataString((I=(G=(M=e==null?void 0:e["publication title"])!=null?M:e==null?void 0:e.publication_title)!=null?G:e==null?void 0:e.publicationTitle)!=null?I:e==null?void 0:e["publication-title"]),l=this.normalizeMetadataString((Z=(B=(U=e==null?void 0:e["book title"])!=null?U:e==null?void 0:e.book_title)!=null?B:e==null?void 0:e.bookTitle)!=null?Z:e==null?void 0:e["book-title"]),c=this.normalizeMetadataString(($=(j=(O=e==null?void 0:e["journal abbrev"])!=null?O:e==null?void 0:e.journal_abbrev)!=null?j:e==null?void 0:e.journalAbbrev)!=null?$:e==null?void 0:e["journal-abbrev"]),d=this.normalizeMetadataString(e==null?void 0:e.publisher),p=this.normalizeMetadataString(e==null?void 0:e.place),u=this.normalizeMetadataString(e==null?void 0:e.issue),g=this.normalizeMetadataString(e==null?void 0:e.volume),y=this.normalizeMetadataString(e==null?void 0:e.pages),x=this.normalizeMetadataString((K=(V=(z=e==null?void 0:e["item type"])!=null?z:e==null?void 0:e.item_type)!=null?V:e==null?void 0:e.itemType)!=null?K:e==null?void 0:e["item-type"]),k=this.normalizeMetadataList(e==null?void 0:e.tags),h=this.normalizeMetadataList(e==null?void 0:e.authors),b=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:t,short_title:n,citekey:i,date:r,abstract:a,doi:s,publication_title:o,book_title:l,journal_abbrev:c,publisher:d,place:p,issue:u,volume:g,pages:y,item_type:x,tags:this.sanitizeObsidianTags(k),authors:h,editors:b}}extractZoteroMetadata(e){var P,S,v;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString(we(e)),i=this.normalizeMetadataString(Oe(e)),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString(e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((P=e==null?void 0:e.DOI)!=null?P:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publicationTitle),l=this.normalizeMetadataString(e==null?void 0:e.bookTitle),c=this.normalizeMetadataString(e==null?void 0:e.journalAbbreviation),d=this.normalizeMetadataString(e==null?void 0:e.publisher),p=this.normalizeMetadataString(e==null?void 0:e.place),u=this.normalizeMetadataString(e==null?void 0:e.issue),g=this.normalizeMetadataString(e==null?void 0:e.volume),y=this.normalizeMetadataString(e==null?void 0:e.pages),x=this.normalizeMetadataString((v=(S=e==null?void 0:e.itemType)!=null?S:e==null?void 0:e.item_type)!=null?v:e==null?void 0:e["item-type"]),k=Array.isArray(e==null?void 0:e.creators)?e.creators:[],h=k.filter(C=>(C==null?void 0:C.creatorType)==="author").map(C=>ke(C)).filter(Boolean),b=k.filter(C=>(C==null?void 0:C.creatorType)==="editor"||(C==null?void 0:C.creatorType)==="seriesEditor").map(C=>ke(C)).filter(Boolean),w=Array.isArray(e==null?void 0:e.tags)?e.tags.map(C=>{var D;return typeof C=="string"?C:(D=this.asRecord(C))==null?void 0:D.tag}).filter(C=>typeof C=="string"):[];return{title:t,short_title:n,citekey:i,date:r,abstract:a,doi:s,publication_title:o,book_title:l,journal_abbrev:c,publisher:d,place:p,issue:u,volume:g,pages:y,item_type:x,tags:this.sanitizeObsidianTags(w),authors:this.normalizeMetadataList(h),editors:this.normalizeMetadataList(b)}}async resolveZoteroCitekey(e,t,n){let i=this.normalizeMetadataString(Oe(e,n!=null?n:void 0));if(i)return i;if(!t)return"";let r=await this.fetchZoteroItemCsl(t);return this.normalizeMetadataString(yt(r))}extractAnnotationPageInfo(e){var a;let n=H((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:n,pageIndex:i}}extractAnnotationImagePayload(e){var a,s,o,l;let t=(s=(a=e.annotationImage)!=null?a:e.annotationImageData)!=null?s:e.annotationImageBase64;if(!t)return null;let n=null,i="";if(Buffer.isBuffer(t))n=t;else if(ArrayBuffer.isView(t))n=Buffer.from(t.buffer,t.byteOffset,t.byteLength);else if(t instanceof ArrayBuffer)n=Buffer.from(t);else if(typeof t=="string"){let c=t.trim();if(!c)return null;let d=c.match(/^data:([^;]+);base64,(.*)$/i);if(d&&(i=this.normalizeAnnotationImageMime(d[1]),c=d[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;n=Buffer.from(c,"base64")}if(!n||!n.length)return null;i||(i=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(n)||"image/png");let r=this.annotationImageExtensionFromMime(i)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(n))||"png";return{buffer:n,mime:i,ext:r}}parseZoteroAnnotationItem(e,t){var h,b,w,P;let n=(b=(h=e==null?void 0:e.data)!=null?h:e)!=null?b:{},i=H((w=e==null?void 0:e.key)!=null?w:n==null?void 0:n.key);if(!i)return null;let r=H(n.annotationType),a=this.normalizeAnnotationText(n.annotationText),s=this.normalizeAnnotationText(n.annotationComment),o=H(n.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:p,pageIndex:u}=this.extractAnnotationPageInfo(n),g=(P=n.annotationSortIndex)!=null?P:n.annotationSort,y=H(g).trim(),x=Number.isFinite(Number(y))?Number(y):Number.NaN,k=Array.isArray(n.tags)?n.tags.map(S=>{var v;return typeof S=="string"?S:(v=this.asRecord(S))==null?void 0:v.tag}).filter(S=>typeof S=="string"):[];return{key:i.trim(),attachmentKey:t,pageLabel:p,pageIndex:u,colorKey:l,callout:d,heading:c,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(k),sortToken:y,sortIndex:x,rawValues:n}}async fetchZoteroAnnotations(e){if(!e)return{annotations:[],hadFetchError:!1};let t=this.canUseWebApi()||await this.ensureWebApiLibraryId(),n=!1,i=!1,r=o=>{var c,d;let l=[];for(let p of o){let u=this.asRecord(p),g=(d=(c=this.asRecord(u==null?void 0:u.data))!=null?c:u)!=null?d:{};if(H(g.itemType)!=="annotation")continue;let y=this.parseZoteroAnnotationItem(p,e);y&&l.push(y)}return l},a=[];try{a=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(o){try{a=await this.fetchZoteroChildrenLocal(e)}catch(l){n=!0,console.warn("Failed to fetch Zotero annotation items from local API",l)}}let s=r(a);if(!s.length&&t)try{let o=[];try{o=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(c){o=await this.fetchZoteroChildrenWeb(e)}i=!0;let l=r(o);l.length&&(s=l)}catch(o){n=!0,this.logOptionalLookupFailure("Failed to fetch Zotero annotation items from Web API",o)}return!s.length&&t&&!i&&(n=!0),!s.length&&!t&&(n=!0),{annotations:s,hadFetchError:n}}async fetchZoteroAnnotationsForDoc(e,t){var l,c;let n=t,i=await this.fetchZoteroAnnotations(n);if(i.annotations.length||!e)return i.annotations.length||this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i.annotations,hadFetchError:i.hadFetchError};let r=[];try{r=await this.fetchZoteroChildren(e)}catch(d){return console.warn("Failed to fetch Zotero attachments for annotations",d),this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i.annotations,hadFetchError:!0}}let a=i.hadFetchError,s=[],o=new Set(n?[n]:[]);for(let d of r){if(!bt(d))continue;let p=this.asRecord(d),u=this.asRecord(p==null?void 0:p.data),g=H((c=(l=p==null?void 0:p.key)!=null?l:u==null?void 0:u.key)!=null?c:p==null?void 0:p.attachmentKey);!g||o.has(g)||(o.add(g),s.push(g))}for(let d of s){let p=await this.fetchZoteroAnnotations(d);if(a=a||p.hadFetchError,p.annotations.length)return{attachmentKey:d,annotations:p.annotations,hadFetchError:a}}return this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i.annotations,hadFetchError:a}}async attachAnnotationImages(e,t,n,i,r){var p;if(!this.settings.includeAnnotationImages||!n.length)return;let a=await this.resolveAnnotationImageOutputDir(i);if(!a)return;let s=this.sanitizeFileName(e||t)||"annotations",o=(0,m.normalizePath)(R.default.join(a.relative||"",s)),l=R.default.normalize(R.default.join(a.absolute,s));o?await this.ensureFolder(o):await ee.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,d=new Map;for(let u of n){let g=String(u.annotationType||"").trim().toLowerCase(),y=g==="image"||g==="ink",x=this.extractAnnotationImagePayload((p=u.rawValues)!=null?p:{});if(!x&&y&&this.settings.zoteroCompanionEnabled&&(x=await this.fetchCompanionAnnotationImage(u.key)),!x){let w=r==null?void 0:r.get(u.key);w!=null&&w.path&&await c.exists(w.path)&&(u.imagePath=w.path,u.imageHash=w.hash,d.set(u.key,w.path));continue}let k=(0,Ve.createHash)("sha1").update(x.buffer).digest("hex").slice(0,12),h=`zrr-annotation-${u.key}-${k}.${x.ext}`,b=(0,m.normalizePath)(R.default.join(o,h));try{await c.exists(b)||await c.writeBinary(b,this.bufferToArrayBuffer(x.buffer)),u.imagePath=b,u.imageHash=k,d.set(u.key,b)}catch(w){console.warn("Failed to write annotation image",{annotationKey:u.key,error:w})}}if(o&&await c.exists(o))try{let u=await c.list(o);for(let g of u.files){let x=R.default.basename(g).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!x)continue;let k=x[1].toUpperCase(),h=d.get(k);(!h||(0,m.normalizePath)(h)!==(0,m.normalizePath)(g))&&await c.remove(g)}}catch(u){console.warn("Failed to clean up annotation images",u)}}async fetchCompanionAnnotationImage(e){let t=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!t)return null;let n=`${t.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,i={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(i.Authorization=`Bearer ${r}`);try{let a=await this.requestLocalApiRaw(n,{headers:i,timeoutMs:5e3});if(a.statusCode===200){let s=a.headers["content-type"],o=Array.isArray(s)?s[0]:s!=null?s:"";return this.buildAnnotationImagePayloadFromBuffer(a.body,o)}if(a.statusCode===204||a.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:a.statusCode})}catch(a){console.warn("Failed to fetch annotation image from Zotero companion",a)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new m.Notice("Zotero companion base URL is not set.");return}let t=`${e.replace(/\/$/,"")}/health`,n={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(n.Authorization=`Bearer ${i}`);try{let r=await this.requestLocalApiRaw(t,{headers:n,timeoutMs:3e3});if(r.statusCode===200){try{let a=JSON.parse(r.body.toString("utf8"));if(a!=null&&a.ok){new m.Notice("Zotero companion: OK.");return}}catch(a){}new m.Notice("Zotero companion responded but did not return OK.");return}if(r.statusCode===401){new m.Notice("Zotero companion: unauthorized (check token).");return}new m.Notice(`Zotero companion: HTTP ${r.statusCode}.`)}catch(r){console.warn("Zotero companion health check failed",r),new m.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new m.Notice("Opened Zotero. Go to tools \u2192 add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new m.Notice("Unable to open Zotero automatically. Open Zotero and go to tools \u2192 add-ons.")}}async spawnDetached(e){let[t,...n]=e;if(!t)throw new Error("Missing command");await new Promise((i,r)=>{let a=!1,s=(0,le.spawn)(t,n,{detached:!0,stdio:"ignore"});s.on("error",o=>{a||(a=!0,r(o))}),s.unref(),a||(a=!0,i())})}maybeWarnMissingAnnotationApi(e,t){if(this.canUseWebApi()){console.debug("No Zotero annotations returned for attachment",{docId:e,attachmentKey:t});return}let n=e||t;!n||this.annotationWebApiWarned.has(n)||(this.annotationWebApiWarned.add(n),new m.Notice("Zotero annotations require web API access. Configure the web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
`).replace(/\r/g,`
`).trim():typeof e=="number"&&Number.isFinite(e)?String(e):""}normalizeAnnotationImageMime(e){let t=H(e).toLowerCase();return t?t.includes("/")?t:t==="png"?"image/png":t==="jpg"||t==="jpeg"?"image/jpeg":t==="gif"?"image/gif":t==="webp"?"image/webp":"":""}buildAnnotationImagePayloadFromBuffer(e,t){if(!e||!e.length)return null;let n=this.normalizeAnnotationImageMime(t);n||(n=this.guessAnnotationImageMime(e)||"image/png");let i=this.annotationImageExtensionFromMime(n)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(e))||"png";return{buffer:e,mime:n,ext:i}}guessAnnotationImageMime(e){return e.length>=3&&e[0]===255&&e[1]===216&&e[2]===255?"image/jpeg":e.length>=4&&e[0]===137&&e[1]===80&&e[2]===78&&e[3]===71?"image/png":e.length>=6&&e.subarray(0,3).toString("ascii")==="GIF"?"image/gif":e.length>=12&&e.subarray(0,4).toString("ascii")==="RIFF"&&e.subarray(8,12).toString("ascii")==="WEBP"?"image/webp":""}annotationImageExtensionFromMime(e){switch(e.toLowerCase()){case"image/png":return"png";case"image/jpeg":case"image/jpg":return"jpg";case"image/gif":return"gif";case"image/webp":return"webp";default:return""}}extractAnnotationImageHashFromPath(e){if(!e)return"";let n=R.default.basename(e).match(/^zrr-annotation-[A-Z0-9]{8}-([a-f0-9]{12})\./i);return n?n[1].toLowerCase():""}normalizeAnnotationTags(e){let t=this.sanitizeObsidianTags(e),n=Array.from(new Set(t));return n.sort(),n}getAnnotationColorMap(){let e=this.settings.annotationColorMap;return e&&typeof e=="object"?e:Ke.annotationColorMap}normalizeAnnotationColorKey(e){var i,r;let t=this.getAnnotationColorMap(),n=String(e||"").trim().toLowerCase();if(!n)return(i=Object.keys(t)[0])!=null?i:"gray";if(n==="grey"&&(n="gray"),t[n])return n;if(n.startsWith("#")){let a=this.inferAnnotationColorFromHex(n);if(a&&t[a])return a}return t.gray?"gray":(r=Object.keys(t)[0])!=null?r:"gray"}inferAnnotationColorFromHex(e){let t=e.replace("#","").trim();if(![3,6].includes(t.length))return null;let n=y=>y.length===1?`${y}${y}`:y,i=t.length===3?n(t[0]):t.slice(0,2),r=t.length===3?n(t[1]):t.slice(2,4),a=t.length===3?n(t[2]):t.slice(4,6),s=parseInt(i,16)/255,o=parseInt(r,16)/255,l=parseInt(a,16)/255;if(Number.isNaN(s)||Number.isNaN(o)||Number.isNaN(l))return null;let c=Math.max(s,o,l),d=Math.min(s,o,l),p=c-d,u=(c+d)/2;if(p<.08||u<.12)return"gray";let g=0;return p===0?g=0:c===s?g=(o-l)/p%6:c===o?g=(l-s)/p+2:g=(s-o)/p+4,g=Math.round(g*60),g<0&&(g+=360),g<20||g>=340?"red":g<45?"orange":g<70?"yellow":g<160?"green":g<250?"blue":g<290?"purple":g<330?"magenta":"red"}resolveAnnotationColorMeta(e){let t=this.getAnnotationColorMap(),n=t[e];return n&&n.heading&&n.callout?n:t.gray||t.yellow||{heading:"Annotations",callout:"note"}}getMetadataDecisionLabels(e,t,n,i){let r=this.isMetadataValueEmpty(t),a=this.isMetadataValueEmpty(n),s="Keep note",o="Keep Zotero";return r&&!a?(s="Delete in Zotero",o="Use Zotero value"):!r&&a&&(s="Update Zotero from note",o="Clear note"),{fieldLabel:i[e],noteLabel:s,zoteroLabel:o}}async promptMetadataBatchDecision(e){return new Promise(t=>{new st(this.app,e.map(n=>({field:n.field,fieldLabel:n.fieldLabel,noteLabel:n.noteLabel,zoteroLabel:n.zoteroLabel,noteValue:n.noteValue,zoteroValue:n.zoteroValue})),n=>t(n)).open()})}formatAnnotationConflictTitle(e){let t=this.settings.annotationPageLabel||"Page",n=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?");return`${t} ${n} (${e.key})`}formatAnnotationConflictValue(e,t){let n=[];e.text&&n.push("Highlight:",e.text),e.comment&&(n.length&&n.push(""),n.push("Comment:",e.comment));let i=this.normalizeAnnotationTags(t);return i.length&&(n.length&&n.push(""),n.push(`Tags: ${i.map(r=>`#${r}`).join(" ")}`)),n.join(`
`).trim()}async promptAnnotationBatchDecision(e){return new Promise(t=>{new ot(this.app,e,n=>t(n)).open()})}normalizeSnapshotValue(e,t){return e==="tags"?[...this.normalizeMetadataList(t)].sort():e==="authors"||e==="editors"?this.normalizeMetadataList(t):this.normalizeMetadataString(t)}setMetadataSnapshotValue(e,t,n){e[t]=n}getMetadataSnapshotCachePath(){return(0,m.normalizePath)(Zt)}normalizeMetadataSnapshotRecord(e){if(!e)return null;let t=e;if(typeof e=="string")try{t=JSON.parse(e)}catch(r){return null}if(!t||typeof t!="object")return null;let n={},i=["title","short_title","citekey","date","abstract","doi","publication_title","book_title","journal_abbrev","publisher","place","issue","volume","pages","item_type","tags","authors","editors"];for(let r of i)Object.prototype.hasOwnProperty.call(t,r)&&this.setMetadataSnapshotValue(n,r,this.normalizeSnapshotValue(r,t[r]));return Object.keys(n).length>0?n:null}parseLegacyMetadataSnapshot(e){var n;if(!e)return null;let t=(n=e.zrr_metadata_snapshot)!=null?n:e["zrr metadata snapshot"];return t?this.normalizeMetadataSnapshotRecord(t):null}async loadMetadataSnapshotCache(){var n;let e=this.app.vault.adapter,t=this.getMetadataSnapshotCachePath();if(!await e.exists(t))return{};try{let i=await e.read(t),r=JSON.parse(i),a=(n=r==null?void 0:r.entries)!=null?n:r;if(!a||typeof a!="object"||Array.isArray(a))return{};let s={};for(let[o,l]of Object.entries(a)){let c=this.normalizeMetadataSnapshotRecord(l);c&&(s[String(o)]=c)}return s}catch(i){return console.error("Failed to read metadata snapshot cache",i),{}}}async getMetadataSnapshotCache(){return this.metadataSnapshotCache?this.metadataSnapshotCache:(this.metadataSnapshotCache=await this.loadMetadataSnapshotCache(),this.metadataSnapshotCache)}async saveMetadataSnapshotCache(e){await this.ensureFolder(ae);let t=this.app.vault.adapter,n=this.getMetadataSnapshotCachePath(),i={version:1,entries:e};await t.write(n,JSON.stringify(i,null,2)),this.metadataSnapshotCache=e}async removeLegacyMetadataSnapshotFrontmatter(e,t){if(!!!(t&&(Object.prototype.hasOwnProperty.call(t,"zrr_metadata_snapshot")||Object.prototype.hasOwnProperty.call(t,"zrr metadata snapshot"))))return;let i=e.path;this.noteSyncSuppressed.add(i),this.noteMetadataSyncSuppressed.add(i);try{await this.app.fileManager.processFrontMatter(e,r=>{delete r.zrr_metadata_snapshot,delete r["zrr metadata snapshot"]})}catch(r){console.warn("Failed to remove legacy metadata snapshot",r)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(i),this.noteMetadataSyncSuppressed.delete(i)},1500)}}async getMetadataSnapshot(e,t,n){if(!e)return null;let i=await this.getMetadataSnapshotCache(),r=i[e];if(r)return r;let a=t?this.parseLegacyMetadataSnapshot(t):null;return a?(i[e]=a,await this.saveMetadataSnapshotCache(i),await this.removeLegacyMetadataSnapshotFrontmatter(n,t),a):null}serializeMetadataSnapshot(e,t){let n={};for(let i of t)e[i]!==void 0&&(n[i]=e[i]);return JSON.stringify(n)}async updateMetadataSnapshot(e,t,n,i,r,a,s){var u,g;if(!t)return;let o=r?{...r}:{};for(let y of s){let x=n[y],k=i[y];if(this.metadataValuesEqual(y,x,k)){this.setMetadataSnapshotValue(o,y,this.normalizeSnapshotValue(y,x));continue}let h=a[y];h==="note"?this.setMetadataSnapshotValue(o,y,this.normalizeSnapshotValue(y,x)):h==="zotero"&&this.setMetadataSnapshotValue(o,y,this.normalizeSnapshotValue(y,k))}let l=this.serializeMetadataSnapshot(o,s),c=await this.getMetadataSnapshotCache(),d=c[t],p=d?this.serializeMetadataSnapshot(d,s):"";if(l!==p){c[t]=o;try{await this.saveMetadataSnapshotCache(c)}catch(y){console.warn("Failed to update metadata snapshot cache",y)}await this.removeLegacyMetadataSnapshotFrontmatter(e,(g=(u=this.app.metadataCache.getFileCache(e))==null?void 0:u.frontmatter)!=null?g:null)}}async removeMetadataSnapshot(e){if(!e)return;let t=await this.getMetadataSnapshotCache();if(t[e]){delete t[e];try{await this.saveMetadataSnapshotCache(t)}catch(n){console.warn("Failed to remove metadata snapshot",n)}}}getAnnotationSnapshotCachePath(){return(0,m.normalizePath)(Ut)}async loadAnnotationSnapshotCache(){var n;let e=this.app.vault.adapter,t=this.getAnnotationSnapshotCachePath();if(!await e.exists(t))return{};try{let i=await e.read(t),r=JSON.parse(i),a=(n=r==null?void 0:r.entries)!=null?n:r;return!a||typeof a!="object"||Array.isArray(a)?{}:a}catch(i){return console.error("Failed to read annotation snapshot cache",i),{}}}async getAnnotationSnapshotCache(){return this.annotationSnapshotCache?this.annotationSnapshotCache:(this.annotationSnapshotCache=await this.loadAnnotationSnapshotCache(),this.annotationSnapshotCache)}async saveAnnotationSnapshotCache(e){await this.ensureFolder(ae);let t=this.app.vault.adapter,n=this.getAnnotationSnapshotCachePath(),i={version:1,entries:e};await t.write(n,JSON.stringify(i,null,2)),this.annotationSnapshotCache=e}annotationSnapshotFromEntry(e,t){var o;let n=this.normalizeAnnotationText(e.text),i=this.normalizeAnnotationText(e.comment),r=this.normalizeAnnotationTags((o=e.tags)!=null?o:[]),a=e.imageHash?e.imageHash.toLowerCase():"",s=e.colorKey?this.normalizeAnnotationColorKey(e.colorKey):"";return t==="note"&&!i&&n?{text:"",comment:n,tags:r,image_hash:a,color_key:s}:{text:n,comment:i,tags:r,image_hash:a,color_key:s}}annotationSnapshotsEqual(e,t){if(e.text!==t.text||e.comment!==t.comment||(e.image_hash||"")!==(t.image_hash||"")||e.tags.length!==t.tags.length)return!1;for(let n=0;n<e.tags.length;n+=1)if(e.tags[n]!==t.tags[n])return!1;return!0}annotationSnapshotsEqualIgnoringImage(e,t){if(e.text!==t.text||e.comment!==t.comment||e.tags.length!==t.tags.length)return!1;for(let n=0;n<e.tags.length;n+=1)if(e.tags[n]!==t.tags[n])return!1;return!0}async getAnnotationSnapshot(e){var n;return e&&(n=(await this.getAnnotationSnapshotCache())[e])!=null?n:null}async updateAnnotationSnapshot(e,t,n){if(!e)return;let i=await this.getAnnotationSnapshotCache(),r={attachment_key:t,annotations:{}};for(let a of n)r.annotations[a.key]=this.annotationSnapshotFromEntry(a,a.annotationType);i[e]=r;try{await this.saveAnnotationSnapshotCache(i)}catch(a){console.warn("Failed to update annotation snapshot cache",a)}}async applyNoteMetadataUpdates(e,t){if(!Object.keys(t).length)return;let n=e.path;this.noteSyncSuppressed.add(n),this.noteMetadataSyncSuppressed.add(n);try{await this.app.fileManager.processFrontMatter(e,i=>{var r,a,s,o,l,c,d,p,u,g,y,x,k,h,b;"title"in t&&(i.title=(r=t.title)!=null?r:""),"short_title"in t&&(i["short title"]=(a=t.short_title)!=null?a:"",delete i.short_title,delete i.shortTitle,delete i["title-short"]),"citekey"in t&&(i.citekey=(s=t.citekey)!=null?s:"",delete i.citation_key,delete i.citationKey,delete i["citation key"],delete i["citation-key"]),"date"in t&&(i.date=(o=t.date)!=null?o:""),"abstract"in t&&(i.abstract=(l=t.abstract)!=null?l:""),"doi"in t&&(i.doi=(c=t.doi)!=null?c:""),"publication_title"in t&&(i["publication title"]=(d=t.publication_title)!=null?d:"",delete i.publication_title,delete i.publicationTitle,delete i["publication-title"]),"book_title"in t&&(i["book title"]=(p=t.book_title)!=null?p:"",delete i.book_title,delete i.bookTitle,delete i["book-title"]),"journal_abbrev"in t&&(i["journal abbrev"]=(u=t.journal_abbrev)!=null?u:"",delete i.journal_abbrev,delete i.journalAbbrev,delete i["journal-abbrev"]),"publisher"in t&&(i.publisher=(g=t.publisher)!=null?g:""),"place"in t&&(i.place=(y=t.place)!=null?y:""),"issue"in t&&(i.issue=(x=t.issue)!=null?x:""),"volume"in t&&(i.volume=(k=t.volume)!=null?k:""),"pages"in t&&(i.pages=(h=t.pages)!=null?h:""),"item_type"in t&&(i["item type"]=(b=t.item_type)!=null?b:"",delete i.item_type,delete i.itemType,delete i["item-type"]),"tags"in t&&(i.tags=Array.isArray(t.tags)?t.tags:[]),"authors"in t&&(i.authors=Array.isArray(t.authors)?t.authors:[]),"editors"in t&&(i.editors=Array.isArray(t.editors)?t.editors:[])})}catch(i){console.warn("Failed to update note frontmatter from Zotero",i)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(n),this.noteMetadataSyncSuppressed.delete(n)},1500)}}async applyZoteroMetadataUpdates(e,t,n,i,r){var s,o,l,c,d,p,u,g,y,x,k,h,b,w;if(!Object.keys(r).length)return;let a={};if("title"in r&&(a.title=(s=r.title)!=null?s:""),"short_title"in r&&(a.shortTitle=(o=r.short_title)!=null?o:""),"citekey"in r){let P=(l=r.citekey)!=null?l:"";a.citationKey=P,a.extra=this.updateExtraWithCitekey(t==null?void 0:t.extra,P)}if("date"in r&&(a.date=(c=r.date)!=null?c:""),"abstract"in r&&(a.abstractNote=(d=r.abstract)!=null?d:""),"doi"in r&&(a.DOI=(p=r.doi)!=null?p:""),"publication_title"in r&&(a.publicationTitle=(u=r.publication_title)!=null?u:""),"book_title"in r&&(a.bookTitle=(g=r.book_title)!=null?g:""),"journal_abbrev"in r&&(a.journalAbbreviation=(y=r.journal_abbrev)!=null?y:""),"publisher"in r&&(a.publisher=(x=r.publisher)!=null?x:""),"place"in r&&(a.place=(k=r.place)!=null?k:""),"issue"in r&&(a.issue=(h=r.issue)!=null?h:""),"volume"in r&&(a.volume=(b=r.volume)!=null?b:""),"pages"in r&&(a.pages=(w=r.pages)!=null?w:""),"item_type"in r){let P=this.normalizeMetadataString(r.item_type);P&&(/^[A-Za-z][A-Za-z0-9]*$/.test(P)?a.itemType=P:console.warn("Skipping invalid item_type update",{itemKey:e,itemType:P}))}if("tags"in r&&(a.tags=this.buildZoteroTags(n.tags,t==null?void 0:t.tags)),"authors"in r||"editors"in r){let P="authors"in r?n.authors:i.authors,S="editors"in r?n.editors:i.editors;a.creators=this.buildZoteroCreators(P,S,Array.isArray(t==null?void 0:t.creators)?t.creators:[])}await this.updateZoteroItemFields(e,t,a)}updateExtraWithCitekey(e,t){let n=this.normalizeMetadataString(t),i=this.normalizeMetadataString(e),a=(i?i.split(/\r?\n/):[]).filter(s=>!this.isCitekeyExtraLine(s));return n&&a.push(`Citation Key: ${n}`),a.join(`
`).trim()}isCitekeyExtraLine(e){let t=e.trim();return t?/^biblatexcitekey\s*\[[^\]]*\]\s*$/i.test(t)?!0:/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:/i.test(t):!1}async applyZoteroAnnotationUpdates(e){var t;for(let n of e){let{entry:i,note:r}=n,a=(t=i.rawValues)!=null?t:{},s=this.normalizeAnnotationText(r.text),o=this.normalizeAnnotationText(r.comment),l=String(i.annotationType||"").trim().toLowerCase(),c=l==="highlight"||l==="underline";!c&&!o&&s&&(o=s,s=""),l==="note"&&!o&&s&&(o=s,s="");let d={annotationComment:o,tags:this.buildZoteroTags(r.tags,a==null?void 0:a.tags)};c&&(d.annotationText=s);try{await this.updateZoteroItemFields(i.key,a,d),i.text=c?s:"",i.comment=o,i.tags=this.normalizeAnnotationTags(r.tags)}catch(p){console.warn(`Failed to update Zotero annotation ${i.key}`,p)}}}buildZoteroTags(e,t){let n=this.normalizeZoteroTags(e),i=n.map(o=>({tag:o,type:0})),r=new Set(n.map(o=>o.toLowerCase())),s=(Array.isArray(t)?t.map(o=>this.asRecord(o)).filter(o=>o!==null).filter(o=>Number(o.type)===1).filter(o=>typeof o.tag=="string"):[]).filter(o=>!r.has(String(o.tag).toLowerCase()));return[...i,...s]}buildZoteroCreators(e,t,n){let i=new Map;for(let o of n){let l=this.asRecord(o);if(!l||l.creatorType!=="editor"&&l.creatorType!=="seriesEditor")continue;let c=ke(l);c&&i.set(c.trim().toLowerCase(),String(l.creatorType))}let r=n.map(o=>this.asRecord(o)).filter(o=>o?o.creatorType!=="author"&&o.creatorType!=="editor"&&o.creatorType!=="seriesEditor":!1),a=e.map(o=>o.trim()).filter(Boolean).map(o=>({creatorType:"author",...this.parseCreatorName(o)})),s=t.map(o=>o.trim()).filter(Boolean).map(o=>{var l;return{creatorType:(l=i.get(o.trim().toLowerCase()))!=null?l:"editor",...this.parseCreatorName(o)}});return[...a,...s,...r]}parseCreatorName(e){var a;let t=String(e||"").trim();if(!t)return{name:""};if(t.includes(",")){let[s,o]=t.split(",",2).map(l=>l.trim());if(s&&o)return{firstName:o,lastName:s};if(s)return{lastName:s}}let n=t.split(/\s+/).filter(Boolean);if(n.length===1)return{name:t};let i=(a=n.pop())!=null?a:"";return{firstName:n.join(" ").trim(),lastName:i}}extractSyncSection(e){let t=xe.exec(e);if(!t)return null;let n=e.slice(t.index+t[0].length),i=Ce.exec(n);return i?n.slice(0,i.index):null}extractDocIdFromSyncMarker(e){var r;let t=xe.exec(e);if(!t)return null;let i=((r=t[0])!=null?r:"").match(/doc_id=(["']?)([^"'\s]+)\1/i);return i?i[2].trim():null}parseSyncedChunkBlocks(e){var c,d;let t=e.split(/\r?\n/),n=[],i="",r=!1,a,s=!1,o=[],l=()=>{i&&(n.push({chunkId:i,text:o.join(`
`).trim(),excludeFlag:r,pageStart:Number.isFinite(a!=null?a:NaN)?Number(a):void 0,sectionChunk:s}),i="",r=!1,a=void 0,s=!1,o=[])};for(let p of t){let u=p.match(ge);if(u){l();let g=(c=u[1])!=null?c:"",y=g.match(/id=(["']?)([^"'\s]+)\1/i),x=y?y[2].trim():"";if(!x)continue;let k=Te(p);i=x,r=/\bexclude\b/i.test(g)||/\bdelete\b/i.test(g),a=Number.isFinite((d=k==null?void 0:k.pageNumber)!=null?d:NaN)?Number(k==null?void 0:k.pageNumber):void 0,s=/\bsection\b/i.test(g),o=[];continue}if(Ne.test(p)){l();continue}if(i){if(Le.test(p)){r=!0;continue}this.isChunkBlockIdLine(p)||o.push(p)}}return l(),n}inferSectionTitleFromChunkText(e){if(!e)return"";let t=e.split(/\r?\n/);for(let n of t){let i=n.trim();if(!i)continue;let r=i.match(/^#{1,6}\s+(.+)$/);if(r!=null&&r[1])return r[1].trim();break}return""}extractAttachmentKeyFromAnnotationMarker(e){var i,r;let t=this.findAnnotationBlockRange(e);return t&&(r=(i=this.parseAnnotationBlockMarker(t.startMarker).attachmentKey)==null?void 0:i.trim())!=null?r:""}async restoreMissingChunkCacheFromNote(e,t,n,i){var x,k,h,b,w,P;let r=this.app.vault.adapter,a=(0,m.normalizePath)(`${Y}/${n}.json`);if(await r.exists(a))return a;let s=this.extractSyncSection(t);if(!s)return i&&new m.Notice(`Chunks cache missing for ${n}, and no sync section was found in the note.`),null;let o=this.parseSyncedChunkBlocks(s);if(!o.length)return i&&new m.Notice(`Chunks cache missing for ${n}, and no chunk markers were found in the sync section.`),null;let l=[];for(let S of o){let v=String(S.chunkId||"").trim();if(!v)continue;let C=(x=this.normalizeChunkIdForNote(v,n))!=null?x:v,D=this.normalizeChunkText(String(S.text||"")),L=Number.isFinite((k=S.pageStart)!=null?k:NaN)?Number(S.pageStart):(h=ht(C))!=null?h:void 0,q={chunk_id:C,text:D,char_count:D.length};if(S.excludeFlag&&(q.excluded=!0),Number.isFinite(L!=null?L:NaN)&&(q.page_start=Number(L),q.page_end=Number(L)),S.sectionChunk){let F=this.inferSectionTitleFromChunkText(D);F&&(q.section=F)}l.push(q)}if(!l.length)return i&&new m.Notice(`Chunks cache missing for ${n}, and chunk markers contained no usable chunks.`),null;await this.ensureFolder(Y);let c=await this.getDocIndexEntry(n);c||(c=await this.hydrateDocIndexFromCache(n));let d=(w=(b=this.app.metadataCache.getFileCache(e))==null?void 0:b.frontmatter)!=null?w:{},p=this.normalizeDocIndexPdfPath((P=c==null?void 0:c.pdf_path)!=null?P:""),u=(c==null?void 0:c.attachment_key)||this.extractAttachmentKeyFromAnnotationMarker(t)||await this.resolveAttachmentKeyForDocId(n,d),g={doc_id:n,chunks:l};p&&(g.source_pdf=p),u&&(g.metadata={attachment_key:u}),await r.write(a,JSON.stringify(g,null,2));let y={doc_id:n,note_path:e.path,note_title:R.default.basename(e.path,".md")};return p&&(y.pdf_path=p),u&&(y.attachment_key=u),await this.updateDocIndex(y),i&&new m.Notice(`Restored chunk cache from note markers for ${n}.`),a}normalizeChunkText(e){return e.split(/\r?\n/).filter(t=>!this.isChunkBlockIdLine(t)).map(t=>t.replace(/\s+/g," ").trim()).filter((t,n,i)=>!(t===""&&i[n-1]==="")).join(`
`).trim()}isAnnotationChunk(e){return!e||typeof e!="object"?!1:!!(e.is_annotation||e.annotation||e.annotation_key)}buildSyncedDoclingContent(e,t,n){var o;let i=t==null?void 0:t.chunks,r=(Array.isArray(i)?i:[]).filter(l=>!this.isAnnotationChunk(l));if(!r.length)return`<!-- zrr:sync-start doc_id=${e} -->
${n}
<!-- zrr:sync-end -->`;let a=r.some(l=>{if(typeof(l==null?void 0:l.section)=="string"?l.section.trim():"")return!0;let d=typeof(l==null?void 0:l.chunk_id)=="string"?l.chunk_id.trim():"";return!!(d&&!/^p\d+$/i.test(d))}),s=[`<!-- zrr:sync-start doc_id=${e} -->`];for(let l of r){let c=typeof(l==null?void 0:l.chunk_id)=="string"?l.chunk_id.trim():"";if(!c)continue;let d=Number.isFinite((o=l==null?void 0:l.page_start)!=null?o:NaN)?Number(l.page_start):null,p=!!(l!=null&&l.excluded||l!=null&&l.exclude),g=typeof(l==null?void 0:l.text)=="string"?l.text.trim():"";if(a){let h=typeof(l==null?void 0:l.section)=="string"?l.section.trim():"",b=h?`## ${h}`:"";b&&!g.startsWith("#")&&(g=g?`${b}

${g}`:b)}let y=d!==null?a?` (${d})`:` page=${d}`:"",k=` id=${c}${a?" section":""}${y}${p?" exclude":""}`;s.push(`<!-- zrr:chunk${k} -->`),g&&s.push(g),s.push("<!-- zrr:chunk end -->"),s.push("")}return s[s.length-1]===""&&s.pop(),s.push("<!-- zrr:sync-end -->"),s.join(`
...
`).trim(),i=(a=e.pageIndex)!=null?a:0,r=e.pageLabel||(e.pageIndex?String(e.pageIndex):"");return{chunk_id:e.key,text:n,page_start:i,page_end:i,annotation_page_label:r,section:e.heading,chunk_tags:e.tags,is_annotation:!0,annotation_key:e.key,annotation_color:e.colorKey,annotation_text:e.text,annotation_comment:e.comment}}annotationChunkSignature(e){var t,n,i,r,a,s,o,l,c;return JSON.stringify({text:(t=e.text)!=null?t:"",page_start:(n=e.page_start)!=null?n:"",page_end:(i=e.page_end)!=null?i:"",section:(r=e.section)!=null?r:"",chunk_tags:Array.isArray(e.chunk_tags)?e.chunk_tags:(a=e.chunk_tags)!=null?a:"",annotation_color:(s=e.annotation_color)!=null?s:"",annotation_page_label:(o=e.annotation_page_label)!=null?o:"",annotation_text:(l=e.annotation_text)!=null?l:"",annotation_comment:(c=e.annotation_comment)!=null?c:""})}async updateAnnotationChunks(e,t,n,i){var x;let r=(i==null?void 0:i.allowDeletes)!==!1,a=(0,m.normalizePath)(`${Y}/${e}.json`),s=this.app.vault.adapter;if(!await s.exists(a))return;let o=await this.readChunkPayload(a);if(!o)return;let l=Array.isArray(o.chunks)?o.chunks:[],c=[],d=new Map;for(let k of l){let h=typeof(k==null?void 0:k.chunk_id)=="string"?k.chunk_id:"";h&&this.isAnnotationChunk(k)?d.set(h,k):c.push(k)}let p=[],u=[],g=new Set;for(let k of n){let h=this.buildAnnotationChunk(k),b=typeof h.chunk_id=="string"?h.chunk_id:"";if(!b)continue;g.add(b),p.push(h);let w=d.get(b);if(!w){u.push(b);continue}this.annotationChunkSignature(w)!==this.annotationChunkSignature(h)&&u.push(b)}let y=[];if(r)for(let k of d.keys())g.has(k)||y.push(k);else for(let[k,h]of d.entries())g.has(k)||p.push(h);if(o.chunks=[...c,...p],await s.write(a,JSON.stringify(o,null,2)),(u.length||y.length)&&await this.reindexChunkUpdates(e,a,u,y),t)try{let k=(x=this.asRecord(o.metadata))!=null?x:{};k.attachment_key!==t&&(k.attachment_key=t,o.metadata=k,await s.write(a,JSON.stringify(o,null,2)))}catch(k){}}resolveChunkFromPayload(e,t,n){let i=this.normalizeChunkIdForNote(t,n)||t,r=new Set([t,i,`${n}:${t}`]);for(let a of e){let s=typeof(a==null?void 0:a.chunk_id)=="string"?a.chunk_id:"";if(s&&r.has(s))return a}return null}async writeNoteWithSyncSuppressed(e,t){this.noteSyncSuppressed.add(e);try{await this.app.vault.adapter.write(e,t)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e)},1500)}}async resolveNotePathForDocId(e){if(!e)return null;let t=this.app.vault.adapter,n=await this.getDocIndexEntry(e);if(n!=null&&n.note_path&&await t.exists(n.note_path))return n.note_path;let r=(await this.scanNotesForDocIds(this.settings.outputNoteDir))[e];return r!=null&&r.note_path?(await this.updateDocIndex({doc_id:e,note_path:r.note_path,note_title:r.note_title}),r.note_path):null}isZoteroNoteFile(e){let t=this.app.metadataCache.getFileCache(e),n=t==null?void 0:t.frontmatter;return!!(this.getFrontmatterValue(n,"doc_id")||this.getFrontmatterValue(n,"zotero_key"))}async deleteZoteroNoteAndCacheForFile(e){var p,u;let t=e.path,n=await this.app.vault.read(e),i=(p=this.extractDocIdFromFrontmatter(n))!=null?p:this.extractDocIdFromSyncMarker(n);if(!i){new m.Notice("No doc_ID found in this note.");return}if(!await new Promise(g=>{new it(this.app,t,i,g).open()}))return;let a=this.app.vault.adapter,s=(0,m.normalizePath)(`${Y}/${i}.json`),o=(0,m.normalizePath)(`${oe}/${i}.json`),l=await this.getDocIndexEntry(i),c="",d=[];if(await a.exists(s)){let g=await this.readChunkPayload(s);d=(Array.isArray(g==null?void 0:g.chunks)?g==null?void 0:g.chunks:[]).map(h=>typeof(h==null?void 0:h.chunk_id)=="string"?h.chunk_id:"").map(h=>h.startsWith(`${i}:`)?h.slice(i.length+1):h).filter(h=>h);let x=typeof(g==null?void 0:g.source_pdf)=="string"?g.source_pdf:"",k=this.normalizeDocIndexPdfPath(x);k&&k.startsWith((0,m.normalizePath)(this.settings.outputPdfDir))&&await a.exists(k)&&(c=k)}if(!c){let g=this.normalizeDocIndexPdfPath((u=l==null?void 0:l.pdf_path)!=null?u:"");g&&g.startsWith((0,m.normalizePath)(this.settings.outputPdfDir))&&await a.exists(g)&&(c=g)}d.length>0&&await this.reindexChunkUpdates(i,s,[],d);try{if(await a.exists(s)&&await a.remove(s),await a.exists(o)&&await a.remove(o),await this.removeDocIndexEntry(i),c){let g=this.app.vault.getAbstractFileByPath(c);g instanceof m.TFile?await this.app.fileManager.trashFile(g):await a.exists(c)&&await a.remove(c)}await this.app.fileManager.trashFile(e),new m.Notice(`Deleted note and cache for ${i}.`)}catch(g){console.error("Failed to delete note and cached data",g),new m.Notice("Failed to delete note or cached data. See console for details.")}}async deleteZoteroNoteAndCache(){let e=this.app.workspace.getActiveViewOfType(m.MarkdownView);if(!e||!e.file){new m.Notice("No active Zotero note found.");return}await this.deleteZoteroNoteAndCacheForFile(e.file)}formatRedisSearchResults(e){var u;let t=(u=this.asRecord(e))!=null?u:{},n=typeof t.total=="number"?t.total:0,i=typeof t.query=="string"?t.query:"",r=typeof t.raw_query=="string"?t.raw_query:"",a=t.field_types&&typeof t.field_types=="object"?t.field_types:null,s=!!t.fallback_used,o=typeof t.fallback_reason=="string"?t.fallback_reason:"",l=Array.isArray(t.fallback_queries)?t.fallback_queries:[],c=Array.isArray(t.fallback_failed_fields)?t.fallback_failed_fields:[],d=Array.isArray(t.results)?t.results:[],p=[];if(p.push(`Query: ${r||i}`),i&&r&&i!==r&&p.push(`Expanded: ${i}`),p.push(`Total matches: ${n}`),a&&Object.keys(a).length>0){let g=Object.keys(a).sort().map(y=>{let x=a[y],k=typeof x=="string"||typeof x=="number"||typeof x=="boolean"?String(x):"";return`${y}:${k}`});p.push(`Field types: {${g.join(", ")}}`)}if(s&&p.push(`Fallback: ${o||"true"}`),l.length){p.push("Fallback queries:");for(let g of l)p.push(`  - ${g}`)}if(c.length&&p.push(`Fallback failed fields: ${c.join(", ")}`),p.push(""),!d.length)return p.push("(no results)"),p.join(`
`);for(let g of d){let y=String(g.doc_id||"").trim(),x=String(g.chunk_id||"").trim(),k=String(g.page_start||"").trim(),h=String(g.page_end||"").trim(),b=String(g.title||"").trim(),w=String(g.section||"").trim(),P=String(g.score||"").trim(),S=String(g.authors||"").trim(),v=String(g.item_type||"").trim(),C=String(g.year||"").trim(),D=String(g.tags||"").trim(),L=String(g.chunk_tags||"").trim(),q=String(g.attachment_key||"").trim(),F=String(g.source_pdf||"").trim(),W=String(g.text||"").replace(/\s+/g," ").trim(),M=W.length>220?`${W.slice(0,220)}\u2026`:W,G=[y];x&&G.push(x),(k||h)&&G.push(`p.${k||"?"}-${h||"?"}`),p.push(G.filter(Boolean).join(" \u2022 ")),P&&p.push(`  score: ${P}`),b&&p.push(`  title: ${b}`),S&&p.push(`  authors: ${S}`),C&&p.push(`  year: ${C}`),v&&p.push(`  item_type: ${v}`),D&&p.push(`  tags: ${D}`),L&&p.push(`  chunk_tags: ${L}`),q&&p.push(`  attachment_key: ${q}`),w&&p.push(`  section: ${w}`),F&&p.push(`  source_pdf: ${F}`),M&&p.push(`  ${M}`),p.push("")}return p.join(`
`)}searchRedisIndex(){new tt(this.app,this,this.lastRedisSearchTerm).open()}async runRedisSearch(e){let t=e.trim();if(!t)return"(no query)";if(this.lastRedisSearchTerm=t,!await this.ensureRedisAvailable("index search"))return"Redis is not reachable. Please start Redis Stack and try again.";let n=this.getPluginDir(),i=R.default.join(n,"tools","search_redis.py"),r=["--query",t,"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--limit","10"];try{await this.ensureBundledTools();let a=await this.runPythonWithOutput(i,r),s=JSON.parse(a||"{}");return this.formatRedisSearchResults(s)||"(no results)"}catch(a){return console.error("Redis search failed",a),"Redis search failed. See console for details."}}async showRedisDiagnostics(){if(!await this.ensureRedisAvailable("diagnostics"))return;let e=this.getPluginDir(),t=R.default.join(e,"tools","redis_diagnostics.py"),n=["--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName()];try{await this.ensureBundledTools();let i=await this.runPythonWithOutput(t,n),r=JSON.parse(i||"{}"),a=`\`\`\`json
${JSON.stringify(r,null,2)}
\`\`\``;new Se(this.app,"Redis diagnostics",a||"(empty)").open()}catch(i){console.error("Redis diagnostics failed",i),new m.Notice("Redis diagnostics failed. See console for details.")}}async resolveUniqueBaseName(e,t){let n=this.app.vault.adapter,i=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${e}.md`),r=(0,m.normalizePath)(`${this.settings.outputPdfDir}/${e}.pdf`),a=await n.exists(i),s=this.settings.copyPdfToVault?await n.exists(r):!1;return a||s?`${e}-${t}`:e}async searchZoteroItems(e){let t=e.trim(),n=["data,meta"];for(let i of n){let r=new URLSearchParams;r.set("itemType","-attachment"),r.set("limit","25"),r.set("include",i),t?r.set("q",t):(r.set("sort","dateAdded"),r.set("direction","desc"));let a=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/top?${r.toString()}`);try{let s=await this.requestLocalApi(a,`Zotero search failed for ${a}`),o=JSON.parse(s.toString("utf8"));return Array.isArray(o)?this.normalizeZoteroSearchResults(o):[]}catch(s){console.warn("Failed to search Zotero via local API",s)}}if(!this.canUseWebApi())throw new Error("Zotero search failed for all include modes.");return this.searchZoteroItemsWeb(t)}async searchIndexedZoteroItems(e,t=25){let n=e.trim(),i=this.normalizeIndexedSearchQuery(n),r=Math.max(1,Math.floor(t)),a=await this.getDocIndex(),s=await this.getMetadataSnapshotCache(),o=Object.keys(a);if(!o.length)return[];let l=this.app.vault.adapter,c=[];for(let p of o){let u=a[p],g=s[p],y=(0,m.normalizePath)(`${oe}/${p}.json`),x=null;if(await l.exists(y))try{let h=await l.read(y),b=JSON.parse(h);x=this.normalizeIndexedSearchItem(b,p)}catch(h){console.debug("Failed to parse indexed Zotero cache item",{docId:p,error:h})}if(x||(x=this.buildIndexedSearchFallbackItem(p,u)),!x||!this.isImportableZoteroResult(x))continue;let k=this.buildIndexedSearchFields(x,u,g);c.push({item:x,title:k.title,citekey:k.citekey,searchable:k.searchable,updatedAt:this.parseIndexTimestamp(u==null?void 0:u.updated_at)})}return i?c.map((p,u)=>({idx:u,item:p.item,updatedAt:p.updatedAt,score:this.scoreIndexedSearchEntry(i,p.title,p.citekey,p.searchable)})).filter(p=>p.score>0).sort((p,u)=>u.score!==p.score?u.score-p.score:u.updatedAt!==p.updatedAt?u.updatedAt-p.updatedAt:p.idx-u.idx).slice(0,r).map(p=>p.item):c.sort((p,u)=>u.updatedAt-p.updatedAt).slice(0,r).map(p=>p.item)}normalizeIndexedSearchItem(e,t){var s,o;let n=this.asRecord(e);if(!n)return null;let i=(s=this.asRecord(n.data))!=null?s:n,r=(o=this.asRecord(n.meta))!=null?o:{};return{key:H(n.key)||H(i.key)||t,data:i,meta:r}}buildIndexedSearchFallbackItem(e,t){let n=H(t==null?void 0:t.zotero_title)||H(t==null?void 0:t.short_title)||H(t==null?void 0:t.note_title);return n?{key:e,data:{key:e,title:n},meta:{}}:null}collectIndexedSearchTags(e){let t=e.tags;if(!Array.isArray(t))return[];let n=[];for(let i of t){if(typeof i=="string"){let r=i.trim();r&&n.push(r);continue}if(i&&typeof i=="object"){let r=this.asRecord(i),a=r?H(r.tag):"";a&&n.push(a)}}return n}collectIndexedSearchCreators(e){let t=e.creators;if(!Array.isArray(t))return[];let n=[];for(let i of t){let r=ke(i).trim();r&&n.push(r)}return n}buildIndexedSearchFields(e,t,n){let i=e.data,r=H(i.title)||this.normalizeMetadataString(n==null?void 0:n.title)||H(t==null?void 0:t.zotero_title)||H(t==null?void 0:t.note_title),a=we(i)||this.normalizeMetadataString(n==null?void 0:n.short_title)||H(t==null?void 0:t.short_title),s=Oe(i,e.meta)||this.normalizeMetadataString(n==null?void 0:n.citekey),o=H(i.itemType)||this.normalizeMetadataString(n==null?void 0:n.item_type),l=H(i.publicationTitle)||this.normalizeMetadataString(n==null?void 0:n.publication_title),c=H(i.bookTitle)||this.normalizeMetadataString(n==null?void 0:n.book_title),d=H(i.journalAbbreviation)||this.normalizeMetadataString(n==null?void 0:n.journal_abbrev),p=Qe(H(i.date)||this.normalizeMetadataString(n==null?void 0:n.date)),u=this.collectIndexedSearchTags(e.data),g=this.collectIndexedSearchCreators(e.data),y=this.normalizeMetadataList(n==null?void 0:n.tags),x=this.normalizeMetadataList(n==null?void 0:n.authors),k=this.normalizeMetadataList(n==null?void 0:n.editors),h=[r,a,s,e.key,o,l,c,d,p,...u,...g,...y,...x,...k].filter(b=>!!(b&&String(b).trim())).join(" ").toLowerCase();return{title:r,citekey:s,searchable:h}}scoreIndexedSearchEntry(e,t,n,i){if(!i)return 0;let r=t.toLowerCase(),a=n.toLowerCase(),s=0;a&&(a===e?s+=140:a.startsWith(e)?s+=110:a.includes(e)&&(s+=90)),r&&(r===e?s+=90:r.startsWith(e)?s+=65:r.includes(e)&&(s+=45)),i.includes(e)&&(s+=25);let o=e.split(/\s+/).filter(Boolean);if(o.length>1){let l=0;for(let c of o)i.includes(c)&&(l+=1);if(l===0)return 0;s+=l*10}return s}normalizeIndexedSearchQuery(e){return e.trim().replace(/^@+/,"").replace(/^[\s.,;:!?()[\]{}<>"'`]+/,"").replace(/[\s.,;:!?()[\]{}<>"'`]+$/,"").replace(/\s+/g," ").toLowerCase()}parseIndexTimestamp(e){if(!e)return 0;let t=Date.parse(e);return Number.isFinite(t)?t:0}async hasProcessableAttachment(e){var r;let t=(r=e.data)!=null?r:e,n=typeof e.key=="string"?e.key:H(t.key);return n?!!await ze(t,n,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)}):!1}async fetchZoteroChildrenLocal(e,t={}){let n=new URLSearchParams;t.includeAnnotationImage&&n.set("include","annotationImage");let i=n.toString()?`?${n.toString()}`:"",r=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/children${i}`),a=await this.requestLocalApi(r,`Zotero children request failed for ${r}`);return JSON.parse(a.toString("utf8"))}async fetchZoteroChildrenWeb(e,t={}){if(!this.canUseWebApi()&&(!await this.ensureWebApiLibraryId()||!this.canUseWebApi()))throw new Error("Zotero Web API is not configured.");let n=new URLSearchParams;t.includeAnnotationImage&&n.set("include","annotationImage");let i=n.toString()?`?${n.toString()}`:"",r=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/children${i}`),a=await this.requestWebApi(r,`Zotero Web API children request failed for ${r}`);return JSON.parse(a.toString("utf8"))}async fetchZoteroChildren(e){try{return await this.fetchZoteroChildrenLocal(e)}catch(t){if(console.warn("Failed to fetch Zotero children from local API",t),!this.canUseWebApi())throw t;return this.fetchZoteroChildrenWeb(e)}}buildZoteroUrl(e){return`${this.settings.zoteroBaseUrl.replace(/\/$/,"")}${e}`}canUseWebApi(){return!!((this.settings.webApiBaseUrl||"").trim()&&this.settings.webApiKey&&this.settings.webApiLibraryId)}async ensureWebApiLibraryId(){var i,r,a,s,o;let e=(this.settings.webApiBaseUrl||"").trim(),t=(this.settings.webApiKey||"").trim();if(!e||!t||(this.settings.webApiLibraryId||"").trim())return!!(this.settings.webApiLibraryId||"").trim();let n=this.buildWebApiUrl("/keys/current");try{let l=await this.requestWebApi(n,`Zotero Web API key lookup failed for ${n}`),c=JSON.parse(l.toString("utf8")),d=(o=(a=(i=c==null?void 0:c.userID)!=null?i:c==null?void 0:c.userId)!=null?a:(r=c==null?void 0:c.data)==null?void 0:r.userID)!=null?o:(s=c==null?void 0:c.data)==null?void 0:s.userId;return d?(this.settings.webApiLibraryId=String(d),await this.saveSettings(),console.debug("Resolved Zotero Web API user ID from key",{userId:d}),!0):!1}catch(l){return this.logOptionalLookupFailure("Failed to resolve Zotero Web API user ID",l),!1}}getWebApiLibraryPath(){let e=(this.settings.webApiLibraryId||"").trim();return e?`${this.settings.webApiLibraryType==="group"?"groups":"users"}/${e}`:""}buildWebApiUrl(e){return`${this.settings.webApiBaseUrl.replace(/\/$/,"")}${e}`}isZoteroLocalApiRequest(e){let t=(this.settings.zoteroBaseUrl||"").trim();if(!t)return!1;try{let n=new URL(e),i=new URL(t),r=n.port||(n.protocol==="https:"?"443":"80"),a=i.port||(i.protocol==="https:"?"443":"80");if(n.protocol!==i.protocol||n.hostname!==i.hostname||r!==a)return!1;let s=i.pathname.replace(/\/$/,"");return!s||s==="/"?!0:n.pathname===s||n.pathname.startsWith(`${s}/`)}catch(n){return!1}}notifyZoteroLocalApiConnectionError(){this.notifyZoteroApiOnce("Zotero connection error. Start Zotero and enable 'Allow other applications on this computer to communicate with Zotero' in Settings -> Advanced -> General.")}requestLocalApiRaw(e,t={}){return new Promise((n,i)=>{var y,x,k;let r=this.isZoteroLocalApiRequest(e),a=new URL(e),s=a.protocol==="https:"?hn.default:Ct.default,o=(y=t.method)!=null?y:"GET",l={Accept:"*/*",...(x=t.headers)!=null?x:{}},c=t.body,d=Number.isFinite((k=t.timeoutMs)!=null?k:NaN)?Number(t.timeoutMs):0,p=null;if(c!==void 0&&l["Content-Length"]===void 0){let h=Buffer.isBuffer(c)?c.length:Buffer.byteLength(c);l["Content-Length"]=String(h)}let u=s.request({method:o,hostname:a.hostname,port:a.port||void 0,path:`${a.pathname}${a.search}`,headers:l},h=>{let b=[];h.on("data",w=>b.push(Buffer.from(w))),h.on("end",()=>{var P;p&&clearTimeout(p),r&&(this.lastZoteroApiNotice=null);let w=Buffer.concat(b);n({statusCode:(P=h.statusCode)!=null?P:0,headers:h.headers,body:w})})});d>0&&(p=setTimeout(()=>{u.destroy(new Error(`Request timed out after ${d}ms`))},d)),u.on("error",h=>{p&&clearTimeout(p),r&&this.notifyZoteroLocalApiConnectionError();let b=h instanceof Error?h:new Error(typeof h=="string"?h:"Request failed");i(b)}),c!==void 0&&u.write(c),u.end()})}async requestLocalApi(e,t){let n=await this.requestLocalApiRaw(e);if(n.statusCode>=400){let i=n.body.toString("utf8");throw new Error(`${t!=null?t:"Request failed"}, status ${n.statusCode}: ${i||"no response body"}`)}if(n.statusCode>=300)throw new Error(`${t!=null?t:"Request failed"}, status ${n.statusCode}`);return n.body}async requestLocalApiWithBody(e,t,n,i,r){let a=JSON.stringify(n),s=await this.requestLocalApiRaw(e,{method:t,headers:i,body:a});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}async requestWebApi(e,t){let n={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},i=await this.requestLocalApiRaw(e,{headers:n});if(i.statusCode>=400){let r=i.body.toString("utf8");throw new Error(`${t!=null?t:"Request failed"}, status ${i.statusCode}: ${r||"no response body"}`)}if(i.statusCode>=300)throw new Error(`${t!=null?t:"Request failed"}, status ${i.statusCode}`);return i.body}requestWebApiRaw(e,t={}){var i;let n={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey,...(i=t.headers)!=null?i:{}};return this.requestLocalApiRaw(e,{...t,headers:n})}async requestWebApiWithBody(e,t,n,i,r){let a=JSON.stringify(n),s=await this.requestLocalApiRaw(e,{method:t,headers:i,body:a});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}bufferToArrayBuffer(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}async annotateChunkJsonWithAttachmentKey(e,t){if(t)try{let n=await this.app.vault.adapter.read(e),i=JSON.parse(n);if(!i||typeof i!="object")return;let r=i.metadata&&typeof i.metadata=="object"?i.metadata:{};r.attachment_key=t,i.metadata=r,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(n){console.warn("Failed to annotate chunks JSON with attachment key",n)}}async updateChunkJsonSourcePdf(e,t){if(t)try{let n=await this.app.vault.adapter.read(e),i=JSON.parse(n);if(!i||typeof i!="object")return;i.source_pdf=t,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(n){console.warn("Failed to update chunks JSON source_pdf",n)}}buildPdfLinkFromSourcePath(e){if(!e)return"";let t=this.toVaultRelativePath(e);return t?`[[${t}]]`:`[PDF](${(0,At.pathToFileURL)(e).toString()})`}toVaultRelativePath(e){if(!e)return"";if(!R.default.isAbsolute(e)&&!/^[A-Za-z]+:\/\//.test(e))return(0,m.normalizePath)(e);let t=R.default.normalize(this.getVaultBasePath()),n=R.default.normalize(e),i=t.endsWith(R.default.sep)?t:`${t}${R.default.sep}`;if(!n.startsWith(i)){let r=R.default.normalize(cn),a=r.endsWith(R.default.sep)?r:`${r}${R.default.sep}`;return n.startsWith(a)?(0,m.normalizePath)(R.default.relative(r,n)):""}return(0,m.normalizePath)(R.default.relative(t,n))}normalizeDocIndexPdfPath(e){return e&&(this.toVaultRelativePath(e)||e)}async isFileAccessible(e){if(!e)return!1;try{return await ee.promises.access(e),!0}catch(t){return!1}}deriveVaultPdfRelativePath(e,t,n){let i=this.toVaultRelativePath(e);if(i&&i.startsWith((0,m.normalizePath)(this.settings.outputPdfDir)))return i;let r=this.sanitizeFileName(t)||n;return(0,m.normalizePath)(`${this.settings.outputPdfDir}/${r}.pdf`)}async recoverMissingPdfFromAttachment(e,t,n,i,r,a,s){let o=await ze(t,n,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});if(!o&&r&&(o={key:r}),!o)return null;let l=o.key||r,c=o.filePath;if(!this.settings.copyPdfToVault&&c&&await this.isFileAccessible(c))return{sourcePdf:c,attachmentKey:l};try{await this.ensureFolder(this.settings.outputPdfDir)}catch(g){return console.error("Failed to create PDF output folder",g),null}let d=this.deriveVaultPdfRelativePath(e,a,i),p;try{if(c&&await this.isFileAccessible(c))p=await ee.promises.readFile(c);else if(l)p=await dt(l,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:ee.promises.readFile}),!this.settings.copyPdfToVault&&s&&new m.Notice("Local PDF path unavailable; copied PDF into vault for processing.");else return null}catch(g){return console.error("Failed to read or download PDF attachment",g),null}try{await this.app.vault.adapter.writeBinary(d,this.bufferToArrayBuffer(p))}catch(g){return console.error("Failed to write recovered PDF into vault",g),null}return{sourcePdf:this.getAbsoluteVaultPath(d),attachmentKey:l}}buildPdfLinkForNote(e,t,n){return!e&&!t?"":!this.settings.copyPdfToVault&&t?`[PDF](${this.buildZoteroDeepLink(n!=null?n:"",t)})`:this.buildPdfLinkFromSourcePath(e)}async maybeCreateOcrLayeredPdf(e,t,n){if(!this.settings.createOcrLayeredPdf||!this.settings.copyPdfToVault||!e||!((t==null?void 0:t.ocr_used)===!0))return null;if(!this.toVaultRelativePath(e))return console.warn("OCR layered PDF requires a vault-local PDF"),null;try{await this.ensureFolder(this.settings.outputPdfDir)}catch(c){return console.warn("Failed to create OCR PDF output folder",c),null}let r=`${e}.ocr.tmp`,a=typeof(t==null?void 0:t.languages)=="string"?t.languages:"",s=(typeof n=="string"&&n.trim()?n:a||"eng").trim(),o=this.getPluginDir(),l=R.default.join(o,"tools","ocr_layered_pdf.py");try{return this.showStatusProgress("Creating OCR PDF...",0),await this.runPythonStreaming(l,["--pdf",e,"--out-pdf",r,"--language",s,"--progress"],c=>{let d=this.asRecord(c),p=typeof(d==null?void 0:d.total)=="number"?d.total:0,u=typeof(d==null?void 0:d.current)=="number"?d.current:0;if((d==null?void 0:d.type)==="progress"&&p>0){let g=Math.round(u/p*100);this.showStatusProgress(`Creating OCR PDF ${u}/${p}`,g)}},()=>{}),await ee.promises.rename(r,e),e}catch(c){return console.warn("OCR layered PDF creation failed",c),null}}getMainLeaf(){let e=new Set(this.app.workspace.getLeavesOfType(Re)),t=this.app.workspace.getLeavesOfType("markdown").find(i=>!e.has(i));if(t)return t;let n=this.app.workspace.getLeaf(!1);return n&&!e.has(n)?n:this.app.workspace.getLeaf("tab")}async openNoteInMain(e){let t=(0,m.normalizePath)(e),n=this.app.vault.getAbstractFileByPath(t),i=this.getMainLeaf();if(n instanceof m.TFile){await i.openFile(n,{active:!0});return}await this.app.workspace.openLinkText(t,"",!1)}findChunkLineInText(e,t){if(!e||!t)return null;let n=this.escapeRegExp(t),i=new RegExp(`<!--\\s*zrr:chunk\\b[^>]*\\bid=(["']?)${n}\\1[^>]*-->`,"i"),r=e.split(`
...
`);for(let a=0;a<r.length;a+=1)if(i.test(r[a]))return a;return null}extractChunkIdFromAnchor(e){if(!e)return"";let t=String(e).replace(/\\\|/g,"|").trim(),n=t.indexOf("|");return(n>=0?t.slice(0,n):t).trim()}async openNoteAtChunk(e,t){let n=this.extractChunkIdFromAnchor(t);if(!e||!n)return!1;await this.openNoteInMain(e);let r=this.getMainLeaf().view;if(!(r instanceof m.MarkdownView))return!1;let a=r.editor,s=this.normalizeChunkIdForNote(n)||n,o=this.findChunkLineInText(a.getValue(),s);return o===null?(new m.Notice(`Chunk ${s} not found in note.`),!1):(a.setCursor({line:o,ch:0}),a.scrollIntoView({from:{line:o,ch:0},to:{line:o,ch:0}},!0),!0)}async openNoteAtAnnotation(e,t,n,i){let r=this.buildAnnotationBlockId(t,n,i);if(!e||!r)return!1;await this.openNoteInMain(e);let s=this.getMainLeaf().view;if(!(s instanceof m.MarkdownView))return!1;let o=s.editor,l=this.findAnnotationLineInText(o.getValue(),r);return l===null?(new m.Notice(`Annotation ${t} not found in note.`),!1):(o.setCursor({line:l,ch:0}),o.scrollIntoView({from:{line:l,ch:0},to:{line:l,ch:0}},!0),!0)}isZrrChunkInternalLink(e){return String(e||"").replace(/\\\|/g,"|").includes("#zrr-chunk:")}getLivePreviewSourcePath(){var t,n,i;let e=this.app.workspace.getActiveViewOfType(m.MarkdownView);return(t=e==null?void 0:e.file)!=null&&t.path?e.file.path:(i=(n=this.app.workspace.getActiveFile())==null?void 0:n.path)!=null?i:""}hookChunkInternalLinks(e,t){let n=e.querySelectorAll("a.internal-link");for(let i of Array.from(n)){if(i.dataset.zrrChunkBound==="1")continue;let r=i.getAttribute("data-href")||i.getAttribute("href")||"";this.isZrrChunkInternalLink(r)&&(i.dataset.zrrChunkBound="1",this.registerDomEvent(i,"click",a=>{a.preventDefault(),a.stopPropagation(),this.openInternalLinkInMain(r,t)}))}}async openInternalLinkInMain(e,t=""){let n=this.getMainLeaf(),[i,...r]=e.split("#"),a=i||"",s=r.join("#").trim(),o="zrr-chunk:",l=null;if(a){let c=Array.from(new Set([a,a.trimEnd(),a.trim()]));for(let d of c){if(!d)continue;let p=this.app.metadataCache.getFirstLinkpathDest(d,t);if(p instanceof m.TFile){l=p;break}}}if(l instanceof m.TFile){let c=s.startsWith(o)?this.extractChunkIdFromAnchor(s.slice(o.length).trim()):"";if(c&&await this.openNoteAtChunk(l.path,c))return;await n.openFile(l,{active:!0}),e.includes("#")&&!c&&await this.openLinkTextInLeaf(n,e,t);return}await this.openLinkTextInLeaf(n,e,t)}async openLinkTextInLeaf(e,t,n=""){let i=e;if(typeof i.openLinkText=="function"){await i.openLinkText(t,n,{active:!0});return}await this.app.workspace.openLinkText(t,n,"tab")}async openNoteInNewTab(e){let t=(0,m.normalizePath)(e);await this.app.workspace.openLinkText(t,"","tab")}async openPdfInMain(e,t){if(!e)return!1;let n=this.toVaultRelativePath(e);if(n){let i=t?`#page=${t}`:"";return await this.app.workspace.openLinkText(`${n}${i}`,"","tab"),!0}try{return window.open((0,At.pathToFileURL)(e).toString()),!0}catch(i){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,t,n,i){if(t){let r=new URLSearchParams;n&&r.set("page",n),i&&r.set("annotation",i);let a=r.toString()?`?${r.toString()}`:"";return`zotero://open-pdf/library/items/${t}${a}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let n=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(n))return n}formatCitationsMarkdown(e,t={}){return e.length?e.map(i=>this.formatCitationMarkdown(i,t)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e,t={}){var p,u,g,y,x;let n=e.doc_id||"?",i=this.formatCitationPageLabel(e),r=e.annotation_key||this.extractAnnotationKey(e.chunk_id),a=e.attachment_key||((u=(p=this.docIndex)==null?void 0:p[e.doc_id||""])==null?void 0:u.attachment_key),s=e.page_start?String(e.page_start):"",o=(y=(g=this.docIndex)==null?void 0:g[e.doc_id||""])!=null?y:null,l=this.resolveCitationTitle(o,(x=o==null?void 0:o.note_path)!=null?x:null,e.doc_id),c=this.formatCitationLabel(l,i),d=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&(o!=null&&o.note_path)){if(r){let k=s||(e.page_end?String(e.page_end):"0"),h=this.buildNoteAnnotationLink(o.note_path,r,a||"",k,c);return h?`- ${h}`:`- ${this.buildNoteLink(o.note_path,c)}`}if(d&&!r)return`- ${this.buildNoteChunkLink(o.note_path,d,c,{nativeAnchor:!!t.nativeObsidianAnchors})}`}if(a){let k=this.buildZoteroDeepLink(n,a,s,r);return`- [${c}](${k})`}return`- ${c}`}buildNoteChunkLink(e,t,n,i={}){let r=(0,m.normalizePath)(e).replace(/\.md$/i,""),a=this.escapeWikiLabel(n);if(i.nativeAnchor)return`[[${r}#^${this.buildChunkBlockId(t)}|${a}]]`;let s=`zrr-chunk:${t}`;return`[[${r}#${s}|${a}]]`}buildChunkBlockId(e,t){let n=(this.normalizeChunkIdForNote(e,t)||e||"").trim();return n?`zrr-chunk-${Array.from(n).map(r=>{var a;return/[A-Za-z0-9]/.test(r)?r.toLowerCase():r==="-"?"-":`-x${((a=r.codePointAt(0))==null?void 0:a.toString(16))||"0"}-`}).join("").replace(/-+/g,"-").replace(/^-|-$/g,"")||"source"}`:"zrr-chunk-source"}isChunkBlockIdLine(e){return/^\s*\^zrr-chunk-[A-Za-z0-9-]+\s*$/.test(e||"")}async ensureChunkBlockIdsForChatExport(e){var n,i;if(!this.settings.preferObsidianNoteForCitations)return;let t=new Map;for(let r of e)if(r.role==="assistant")for(let a of(n=r.citations)!=null?n:[]){let s=(a.doc_id||"").trim();if(!s||a.annotation_key||this.extractAnnotationKey(a.chunk_id))continue;let l=this.normalizeChunkIdForNote(a.chunk_id,s);if(!l)continue;let c=await this.resolveNotePathForDocId(s);if(!c)continue;let d=(i=t.get(c))!=null?i:{docId:s,chunkIds:new Set};d.chunkIds.add(l),t.set(c,d)}for(let[r,a]of t.entries())await this.ensureChunkBlockIdsInNote(r,a.docId,Array.from(a.chunkIds))}async ensureChunkBlockIdsInNote(e,t,n){let i=new Map;for(let l of n){let c=(this.normalizeChunkIdForNote(l,t)||l||"").trim();c&&i.set(c,this.buildChunkBlockId(c,t))}if(!i.size)return;let r=this.app.vault.adapter;if(!await r.exists(e))return;let s=(await r.read(e)).split(/\r?\n/),o=!1;for(let l=0;l<s.length;l+=1){let c=Te(s[l]),d=c!=null&&c.chunkId?this.normalizeChunkIdForNote(c.chunkId,t)||c.chunkId:"";if(!d)continue;let p=i.get(d);if(!p)continue;let u=!1;for(let g=l+1;g<s.length&&!(ge.test(s[g])||Ne.test(s[g]));g+=1)if(new RegExp(`^\\s*\\^${this.escapeRegExp(p)}\\s*$`,"i").test(s[g])){u=!0;break}u||(s.splice(l+1,0,"",`^${p}`,""),l+=3,o=!0)}o&&await this.writeNoteWithSyncSuppressed(e,s.join(`
`))}buildNoteLink(e,t){let n=(0,m.normalizePath)(e).replace(/\.md$/i,""),i=this.escapeWikiLabel(t);return`[[${n}|${i}]]`}buildNoteAnnotationLink(e,t,n,i,r){let a=this.buildAnnotationBlockId(t,n,i);if(!a)return null;let s=(0,m.normalizePath)(e).replace(/\.md$/i,""),o=this.escapeWikiLabel(r);return`[[${s}#^${a}|${o}]]`}buildAnnotationBlockId(e,t,n){let i=(e||"").trim().toUpperCase(),r=(t||"").trim().toUpperCase();if(!i||!r)return null;let a=(n||"").trim()||"0";return`${i}a${r}p${a}`}escapeWikiLabel(e){return e?e.replace(/\|/g," ").replace(/\[/g,"").replace(/\]/g,"").trim():""}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,m.normalizePath)(`${ae}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var n;let e=this.app.vault.adapter,t=this.getDocIndexPath();if(!await e.exists(t))return{};try{let i=await e.read(t),r=JSON.parse(i);if(r&&typeof r=="object"){let a=(n=r.entries)!=null?n:r;if(Array.isArray(a)){let s={};for(let l of a)l!=null&&l.doc_id&&(s[String(l.doc_id)]=l);let o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(s),s}if(a&&typeof a=="object"){let s=a,o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(s),s}}}catch(i){console.error("Failed to read doc index",i)}return{}}async saveDocIndex(e){await this.ensureFolder(ae);let t=this.app.vault.adapter,n=this.getDocIndexPath(),i={version:1,entries:e};await t.write(n,JSON.stringify(i,null,2)),this.docIndex=e}async pruneDocIndexOrphans(){var c;let e=this.app.vault.adapter,t=await this.getDocIndex(),n=new Set(await this.listDocIds(oe)),i=new Set(await this.listDocIds(Y)),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),a=0,s=0,o=!1,l=new Date().toISOString();for(let d of Object.keys(t)){let p=t[d],u=!1,g=p!=null&&p.note_path?p.note_path.trim():"";if(g&&await e.exists(g))u=!0;else if((c=r[d])!=null&&c.note_path){u=!0;let x=r[d];x.note_path&&x.note_path!==p.note_path&&(p.note_path=x.note_path,s+=1,o=!0),x.note_title&&x.note_title!==p.note_title&&(p.note_title=x.note_title,s+=1,o=!0),s>0&&(p.updated_at=l)}let y=n.has(d)||i.has(d);!u&&!y&&(delete t[d],a+=1,o=!0)}return o&&await this.saveDocIndex(t),{removed:a,updated:s}}async updateDocIndex(e){var r;let t=await this.getDocIndex(),n=(r=t[e.doc_id])!=null?r:{doc_id:e.doc_id},i={...n,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&n.note_path&&(i.note_path=n.note_path),e.note_title===void 0&&n.note_title&&(i.note_title=n.note_title),e.zotero_title===void 0&&n.zotero_title&&(i.zotero_title=n.zotero_title),e.short_title===void 0&&n.short_title&&(i.short_title=n.short_title),e.pdf_path===void 0&&n.pdf_path&&(i.pdf_path=n.pdf_path),e.attachment_key===void 0&&n.attachment_key&&(i.attachment_key=n.attachment_key),typeof i.pdf_path=="string"&&(i.pdf_path=this.normalizeDocIndexPdfPath(i.pdf_path)),t[e.doc_id]=i,await this.saveDocIndex(t)}async removeDocIndexEntry(e){let t=await this.getDocIndex();if(!t[e]){await this.removeMetadataSnapshot(e);return}delete t[e],await this.saveDocIndex(t),await this.removeMetadataSnapshot(e)}async hydrateDocIndexFromCache(e){var s,o;if(!e)return null;let t=this.app.vault.adapter,n=await this.getDocIndexEntry(e),i={},r=(0,m.normalizePath)(`${oe}/${e}.json`);if(await t.exists(r))try{let l=await t.read(r),c=JSON.parse(l),d=(o=(s=c==null?void 0:c.data)!=null?s:c)!=null?o:{},p=typeof d.title=="string"?d.title:"";p&&(i.zotero_title=p);let u=we(d);if(u&&(i.short_title=u),!i.note_title||!i.note_path){let g=this.sanitizeFileName(p)||e,y=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${g}.md`),x=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${g}-${e}.md`),k="";await t.exists(y)?k=y:await t.exists(x)&&(k=x),k&&(i.note_path=k,i.note_title=R.default.basename(k,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!i.note_title&&(n!=null&&n.note_path)&&(i.note_title=R.default.basename(n.note_path,".md"));let a=(0,m.normalizePath)(`${Y}/${e}.json`);if(await t.exists(a))try{let l=await t.read(a),c=JSON.parse(l);typeof(c==null?void 0:c.source_pdf)=="string"&&(i.pdf_path=c.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(i).length>0&&await this.updateDocIndex({doc_id:e,...i}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var n;return e&&(n=(await this.getDocIndex())[e])!=null?n:null}async inferNotePathFromCache(e){var i,r;let t=this.app.vault.adapter,n=(0,m.normalizePath)(`${oe}/${e}.json`);if(!await t.exists(n))return"";try{let a=await t.read(n),s=JSON.parse(a),o=(r=(i=s==null?void 0:s.data)!=null?i:s)!=null?r:{},l=typeof o.title=="string"?o.title:"",c=this.sanitizeFileName(l)||e,d=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${c}.md`),p=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${c}-${e}.md`);if(await t.exists(d))return d;if(await t.exists(p))return p}catch(a){console.error("Failed to infer note path from cache",a)}return""}async rebuildNoteFromCacheForDocId(e,t){var L,q,F,W,M,G;try{await this.ensureBundledTools()}catch(I){return t&&new m.Notice("Failed to sync bundled tools. See console for details."),console.error(I),!1}let n=this.app.vault.adapter,i=(0,m.normalizePath)(`${oe}/${e}.json`),r=(0,m.normalizePath)(`${Y}/${e}.json`);if(!await n.exists(i)||!await n.exists(r))return t&&new m.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let a;try{let I=await n.read(i);a=JSON.parse(I)}catch(I){return t&&new m.Notice("Failed to read cached item JSON."),console.error(I),this.clearStatusProgress(),!1}let s;try{let I=await n.read(r);s=JSON.parse(I)}catch(I){return t&&new m.Notice("Failed to read cached chunks JSON."),console.error(I),this.clearStatusProgress(),!1}let o=(L=a.data)!=null?L:a,l=typeof o.title=="string"?o.title:"",c=((F=(q=a.key)!=null?q:o.key)!=null?F:e).toString(),d=await this.getDocIndexEntry(e),p=typeof((W=this.asRecord(s==null?void 0:s.metadata))==null?void 0:W.attachment_key)=="string"?String((M=this.asRecord(s==null?void 0:s.metadata))==null?void 0:M.attachment_key):d==null?void 0:d.attachment_key,u=typeof s.source_pdf=="string"?s.source_pdf:"";if(!u||!await this.isFileAccessible(u)){let I=await this.recoverMissingPdfFromAttachment(u,o,c,e,p,l,t);if(!I)return t&&new m.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;u=I.sourcePdf,I.attachmentKey&&(p=I.attachmentKey),await this.updateChunkJsonSourcePdf(r,u)}let g=await this.resolveLanguageHint(o,c),y=this.buildDoclingLanguageHint(g!=null?g:void 0),x="";if(d!=null&&d.note_path&&await n.exists(d.note_path)&&(x=(0,m.normalizePath)(d.note_path)),!x){let I=this.sanitizeFileName(l)||e,U=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${I}.md`),B=await n.exists(U)?I:await this.resolveUniqueBaseName(I,e);x=(0,m.normalizePath)(`${this.settings.outputNoteDir}/${B}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let I=this.getLogFileRelativePath(),U=(0,m.normalizePath)(R.default.dirname(I));U&&await this.ensureFolder(U);let B=this.getSpellcheckerInfoRelativePath(),Z=(0,m.normalizePath)(R.default.dirname(B));Z&&await this.ensureFolder(Z)}}catch(I){return t&&new m.Notice("Failed to create notes folder."),console.error(I),this.clearStatusProgress(),!1}let k=this.getPluginDir(),h=R.default.join(k,"tools","docling_extract.py"),b=R.default.join(k,"tools","index_redisearch.py"),w=null,P=null,S=I=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=I)};try{this.showStatusProgress(this.formatStatusLabel("Docling extraction...",w),0);let I=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(h,await this.buildDoclingArgs(u,e,r,x,y,!0),Z=>this.handleDoclingProgress(Z,w),()=>{},I,"docling_extract",S),this.recreateMissingNotesProcess=null,w=await this.readDoclingQualityLabel(r),p&&await this.annotateChunkJsonWithAttachmentKey(r,p);let U=await this.readDoclingMetadata(r),B=await this.maybeCreateOcrLayeredPdf(u,U,y);B&&(u=B,P=B,await this.updateChunkJsonSourcePdf(r,B))}catch(I){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(t&&new m.Notice("Docling extraction failed. See console for details."),console.error(I),this.clearStatusProgress(),!1)}let v=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;if(!await this.ensureRedisAvailable("rebuild"))t&&new m.Notice("Redis is unavailable; skipping indexing for this note.");else try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",w),0);let I=["--chunks-json",this.getAbsoluteVaultPath(r),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(I),this.appendEmbedContextArgs(I),this.settings.embedIncludeMetadata&&I.push("--embed-include-metadata"),this.appendChunkTaggingArgs(I,{allowRegenerate:!1}),await this.runPythonStreaming(b,I,U=>{let B=this.asRecord(U),Z=typeof(B==null?void 0:B.total)=="number"?B.total:0,O=typeof(B==null?void 0:B.current)=="number"?B.current:0;if((B==null?void 0:B.type)==="progress"&&Z>0){let j=Math.round(O/Z*100),$=typeof B.message=="string"&&B.message.trim()?B.message:`Indexing chunks ${O}/${Z}`,z=this.formatStatusLabel($,w);this.showStatusProgress(z,j)}},()=>{},v,"index_redisearch",S),this.recreateMissingNotesProcess=null}catch(I){if(this.recreateMissingNotesAbort)return this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1;t&&new m.Notice("Redissearch indexing failed; note will still be rebuilt."),console.error(I)}let D=P?this.buildPdfLinkFromSourcePath(P):this.buildPdfLinkForNote(u,d==null?void 0:d.attachment_key,e);try{let I=await this.app.vault.adapter.read(x),U=await this.readChunkPayload(r),B=this.buildSyncedDoclingContent(e,U,I),Z=await this.buildNoteMarkdown(o,(G=a.meta)!=null?G:{},e,D,p,x,i,B);await this.writeNoteWithSyncSuppressed(x,Z);let O=this.app.vault.getAbstractFileByPath(x);O instanceof m.TFile&&this.scheduleNoteAnnotationSync(O,2e3,"save")}catch(I){return t&&new m.Notice("Failed to finalize note Markdown."),console.error(I),this.clearStatusProgress(),!1}try{let I=we(o);await this.updateDocIndex({doc_id:e,note_path:x,note_title:R.default.basename(x,".md"),zotero_title:l,short_title:I||void 0,pdf_path:u})}catch(I){console.error("Failed to update doc index",I)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],t=await this.fetchZoteroGroupOptions();return t.length&&e.push(...t),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),t=[],n=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!n)return e&&t.push({value:e,label:e}),t;let i=(this.settings.embedApiKey||"").trim(),r=await this.fetchModelIds(n,i);if(r.length){let a=r.filter(o=>/embed/i.test(o)),s=a.length?a:r;t.push(...s.map(o=>({value:o,label:o})))}return!t.length&&e&&t.push({value:e,label:e}),t.sort((a,s)=>a.label.localeCompare(s.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,t,n){let i=n==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),r=[],a=(e||"").trim().replace(/\/$/,"");if(!a)return i&&r.push({value:i,label:i}),r;let s=(t||"").trim(),o=await this.fetchModelIds(a,s);if(o.length){let l=o.filter(d=>!/embed/i.test(d)),c=l.length?l:o;r.push(...c.map(d=>({value:d,label:d})))}return!r.length&&i&&r.push({value:i,label:i}),r.sort((l,c)=>l.label.localeCompare(c.label))}detectEmbeddingProvider(e){let t=e.toLowerCase();return t.includes("anthropic")?"anthropic":t.includes("openrouter")?"openrouter":t.includes("ollama")||t.includes(":11434")?"ollama":t.includes("openai")?"openai":"generic"}async fetchModelIds(e,t){let n=this.detectEmbeddingProvider(e);try{if(n==="anthropic")return await this.fetchAnthropicModels(e,t);let i=await this.fetchOpenAiCompatibleModels(e,t);return!i.length&&n==="ollama"?await this.fetchOllamaModels(e):i}catch(i){return this.logOptionalLookupFailure("Failed to fetch models",i),[]}}async fetchOpenAiCompatibleModels(e,t){let n=`${e}/models`,i={};t&&(i.Authorization=`Bearer ${t}`);let r=await this.requestLocalApiRaw(n,{headers:i});if(r.statusCode>=400)throw new Error(`Model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}async fetchOllamaModels(e){let n=`${e.replace(/\/v1\/?$/,"")}/api/tags`,i=await this.requestLocalApiRaw(n);if(i.statusCode>=400)throw new Error(`Ollama tags request failed (${i.statusCode})`);let r;try{r=JSON.parse(i.body.toString("utf8"))}catch(s){return console.warn("Failed to parse Ollama tags response",s),[]}if(!r||typeof r!="object")return[];let a=r.models;return Array.isArray(a)?a.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}async fetchAnthropicModels(e,t){if(!t)return[];let n=`${e}/models`,i={"x-api-key":t,"anthropic-version":"2023-06-01"},r=await this.requestLocalApiRaw(n,{headers:i});if(r.statusCode>=400)throw new Error(`Anthropic model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}extractModelIds(e){var i,r,a;if(Array.isArray(e))return e.map(s=>this.extractModelId(s)).filter(s=>!!s);if(!e||typeof e!="object")return[];let t=e,n=(a=(r=(i=t.data)!=null?i:t.models)!=null?r:t.model)!=null?a:t.items;return Array.isArray(n)?n.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}asRecord(e){return!e||typeof e!="object"?null:e}extractModelId(e){var r,a,s;if(!e||typeof e!="object")return null;let t=e,n=(s=(a=(r=t.id)!=null?r:t.name)!=null?a:t.model)!=null?s:t.identifier;return typeof n!="string"?null:n.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,t=i=>{for(let r of i)e.has(r.value)||e.set(r.value,r.label)};if(await this.warnIfZoteroLocalApiUnavailable("Zotero groups"))try{let i=this.buildZoteroUrl("/users/0/groups"),r=await this.requestLocalApi(i,`Zotero groups fetch failed for ${i}`);t(this.parseZoteroGroupOptions(r))}catch(i){console.warn("Failed to fetch Zotero groups from local API",i)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let i=(this.settings.webApiLibraryId||"").trim();if(i)try{let r=this.buildWebApiUrl(`/users/${i}/groups`),a=await this.requestWebApi(r,`Zotero Web API groups fetch failed for ${r}`);t(this.parseZoteroGroupOptions(a))}catch(r){this.logOptionalLookupFailure("Failed to fetch Zotero groups from Web API",r)}}return Array.from(e.entries()).map(([i,r])=>({value:i,label:r})).sort((i,r)=>i.label.localeCompare(r.label))}parseZoteroGroupOptions(e){var i,r,a,s,o;let t;try{t=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(t))return[];let n=[];for(let l of t){if(!l||typeof l!="object")continue;let c=(i=l.data)!=null?i:l,d=(a=(r=c.id)!=null?r:l.id)!=null?a:c.key;if(!d)continue;let p=typeof d=="string"||typeof d=="number"?String(d).trim():"";if(!p)continue;let u=(o=(s=c.name)!=null?s:l.name)!=null?o:p,g=(typeof u=="string"||typeof u=="number")&&String(u).trim()||p;n.push({value:`groups/${p}`,label:`Group: ${g}`})}return n}async ensureFolder(e){let t=this.app.vault.adapter,n=(0,m.normalizePath)(e).split("/").filter(Boolean),i="";for(let r of n)i=i?`${i}/${r}`:r,await t.exists(i)||await t.mkdir(i)}async buildNoteMarkdown(e,t,n,i,r,a,s,o){let l=`[[${s}]]`,c=this.settings.copyPdfToVault&&i.startsWith("[["),d=r?this.buildZoteroDeepLink(n,r):"",p=d||i,u=c?i:d||i,g=u?c?`PDF: !${u}`:`PDF: ${u}`:"",y=g?`${g}

`:"",x=await this.buildTemplateVars(e,t,n,p,l);x.pdf_block=y,x.pdf_line=g,x.docling_markdown=o;let k=(this.settings.noteBodyTemplate||"").trim();/{{\s*annotation_block\s*}}/i.test(k)&&r?x.annotation_block=await this.buildAnnotationBlockForAttachment(n,r,a):x.annotation_block="";let b=this.ensureDocIdInFrontmatter(await this.renderFrontmatter(e,t,n,p,l,x),n),w=b?`---
${b}
---

`:"",P=`${y}${o}`,S=k?this.renderTemplate(k,x,P,{appendDocling:!0}):P;return`${w}${S}`}async buildAnnotationBlockForAttachment(e,t,n){let i=await this.fetchZoteroAnnotationsForDoc(e,t);return i.attachmentKey&&i.attachmentKey!==t&&await this.updateDocIndex({doc_id:e,attachment_key:i.attachmentKey}),await this.attachAnnotationImages(e,i.attachmentKey,i.annotations,n),this.buildAnnotationBlock(e,i.attachmentKey,i.annotations)}buildAnnotationBlock(e,t,n){var p;let i=`<!-- zrr:annotations-start doc_id=${e} attachment_key=${t} -->`,r="<!-- zrr:annotations-end -->";if(!n.length)return`${i}
${r}`;let a=this.getAnnotationColorMap(),s=Object.keys(a),o=new Map;for(let u of n){let g=u.colorKey||this.normalizeAnnotationColorKey(u.colorKey),y=(p=o.get(g))!=null?p:[];y.push(u),o.set(g,y)}let l=[i],c=new Set,d=[...s,...Array.from(o.keys()).filter(u=>!s.includes(u))];for(let u of d){let g=o.get(u);if(!g||!g.length)continue;c.add(u);let{heading:y}=this.resolveAnnotationColorMeta(u);l.push("",`## ${y}`),g.sort((x,k)=>{var C,D;let h=(x.sortToken||"").trim(),b=(k.sortToken||"").trim();if(h&&b&&h!==b)return h.localeCompare(b,void 0,{numeric:!0,sensitivity:"base"});if(h&&!b)return-1;if(!h&&b)return 1;let w=Number.isFinite(x.sortIndex),P=Number.isFinite(k.sortIndex);if(w&&P&&x.sortIndex!==k.sortIndex)return x.sortIndex-k.sortIndex;let S=(C=x.pageIndex)!=null?C:0,v=(D=k.pageIndex)!=null?D:0;return S!==v?S-v:x.key.localeCompare(k.key)});for(let x of g)l.push(...this.formatAnnotationCallout(x,t,e))}return l.push("",r),l.join(`
`).trim()}formatAnnotationCallout(e,t,n){let i=this.settings.annotationPageLabel||"Page",r=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?"),a=e.pageIndex?String(e.pageIndex):"",s=this.buildZoteroDeepLink(n,t,a,e.key),l=[`> [!${e.callout}] ${i} [${r}](${s})`];e.imagePath&&l.push(`> ![[${e.imagePath}]]`);let c=p=>{if(p)for(let u of p.split(/\r?\n/))l.push(u.trim()?`> ${u}`:">")};c(e.text),e.comment&&(l.push(">","> ---"),c(e.comment)),e.tags.length&&l.push(`> **Tags:** ${e.tags.map(p=>`#${p}`).join(" ")}`);let d=e.pageIndex?String(e.pageIndex):"0";return l.push(`> ^${e.key}a${t}p${d}`),l.push(""),l}findAnnotationBlockRange(e){let t=Jn.exec(e);if(!t)return null;let n=e.slice(t.index+t[0].length),i=Xn.exec(n);if(!i)return null;let r=t.index,a=t.index+t[0].length+i.index+i[0].length,s=n.slice(0,i.index);return{start:r,end:a,block:s,startMarker:t[0]}}parseAnnotationBlockMarker(e){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i),n=e.match(/attachment_key=(["']?)([^"'\s]+)\1/i);return{docId:t?t[2].trim():void 0,attachmentKey:n?n[2].trim():void 0}}parseAnnotationBlock(e,t){let n=e.split(/\r?\n/),i=[],r=0;for(;r<n.length;){if(!n[r].trim().startsWith("> [!")){r+=1;continue}let s=[];for(;r<n.length&&n[r].trim().startsWith(">");)s.push(n[r]),r+=1;let o=this.parseAnnotationCallout(s,t);o&&i.push(o)}return i}parseAnnotationImageLine(e){var o,l;let t=e.trim();if(!t)return null;let n="",i=t.match(/!\[\[([^\]]+)\]\]/);i&&(n=i[1].trim());let r=n?null:t.match(/!\[[^\]]*\]\(([^)]+)\)/);r&&(n=r[1].trim());let a=n?null:t.match(/<img[^>]+src=["']([^"']+)["']/i);if(a&&(n=a[1].trim()),!n)return null;let s=(l=(o=n.split("|")[0])==null?void 0:o.trim())!=null?l:"";return s?{path:s,hash:this.extractAnnotationImageHashFromPath(s)}:null}parseAnnotationCallout(e,t){if(!e.length)return null;let n=e[0].replace(/^>\s?/,"").trim(),i=n.match(/\[!([^\]]+)\]/),r=i?i[1].trim():"note",a=n.match(/\((zotero:\/\/open-pdf\/library\/items\/[^)]+)\)/i),s="",o=t,l="",c=null;if(a){let b=a[1],w=b.match(/items\/([A-Z0-9]{8})/i);w&&(o=w[1]);let P=b.match(/annotation=([A-Z0-9]{8})/i);P&&(s=P[1]);let S=b.match(/page=(\d+)/i);S&&(c=Number(S[1]));let v=n.match(/\[([^\]]+)\]\(zotero:\/\//i);v&&(l=v[1].trim())}let d=[],p=[],u=[],g=!1,y="",x="";for(let b=1;b<e.length;b+=1){let w=e[b].replace(/^>\s?/,""),P=w.trim();if(!P){g?u.push(""):p.push("");continue}let S=this.parseAnnotationImageLine(P);if(S){y=S.path,x=S.hash;continue}if(P.startsWith("^")){let v=P.match(/^\^([A-Z0-9]{8})a([A-Z0-9]{8})p(\d+)/i);v&&(s=v[1],o=v[2],c=Number(v[3]));continue}if(/^(\*\*tags:\*\*|tags:)/i.test(P)){d.push(P);continue}if(P==="---"){g=!0;continue}g?u.push(w):p.push(w)}let k=d.join(" "),h=k?k.replace(/\*\*tags:\*\*/i,"").replace(/tags:/i,"").split(/[\s,]+/).map(b=>b.trim().replace(/^#+/,"")).filter(Boolean):[];return s?{key:s,attachmentKey:o,pageLabel:l,pageIndex:c,callout:r,text:this.normalizeAnnotationText(p.join(`
`)),comment:this.normalizeAnnotationText(u.join(`
`)),tags:this.normalizeAnnotationTags(h),imagePath:y||void 0,imageHash:x||void 0}:null}replaceAnnotationBlock(e,t){let n=this.findAnnotationBlockRange(e);if(!n)return null;let i=e.slice(0,n.start),r=e.slice(n.end),a=t.trim()?`${t.trim()}
`:`${t}`;return`${i}${a}${r}`.replace(/\n{4,}/g,`


`)}async renderFrontmatter(e,t,n,i,r,a){var d;let s=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,t,n,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let t=e.split(/\r?\n/),n=[],i=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<t.length;){let l=t[o],c=l.match(i);if(!c){n.push(l),o+=1;continue}let d=c[1].trim(),p=c[2].trim();if(a.has(d)){n.push(l),o+=1;continue}if(!s(p)){n.push(l),o+=1;continue}let u=o+1,g=[];for(;u<t.length&&t[u].match(r);)g.push(t[u]),u+=1;if(g.length===0){for(o=u;o<t.length&&t[o].trim()==="";)o+=1;continue}let y=g.filter(x=>{let k=x.match(r);if(!k)return!1;let h=k[1].trim();return!s(h)});if(y.length>0&&n.push(l,...y),o=u,y.length===0)for(;o<t.length&&t[o].trim()==="";)o+=1}for(;n.length>0&&n[n.length-1].trim()==="";)n.pop();return n.join(`
...
${t.docling_markdown}`),r.trim()?r:n}async buildTemplateVars(e,t,n,i,r){let a=H(e.title),s=H(e.shortTitle),o=H(e.date),l=typeof(t==null?void 0:t.parsedDate)=="string"?t.parsedDate:"",c=Qe(l||o),d=/^\d{4}$/.test(c)?c:"",p=Array.isArray(e.creators)?e.creators:[],u=p.filter(Q=>Q.creatorType==="author").map(Q=>ke(Q)),g=u.join("; "),y=p.filter(Q=>Q.creatorType==="editor"||Q.creatorType==="seriesEditor").map(Q=>ke(Q)),x=y.join("; "),k=Array.isArray(e.tags)?e.tags.map(Q=>{var _e;return typeof Q=="string"?Q:(_e=this.asRecord(Q))==null?void 0:_e.tag}).filter(Q=>typeof Q=="string"&&Q.length>0):[],h=this.sanitizeObsidianTags(k),b=h.join("; "),w=await this.resolveCollectionTitles(e),P=w.join("; "),S=this.toObsidianLinks(w),v=S.join("; "),C=H(e.itemType),D=typeof(t==null?void 0:t.creatorSummary)=="string"?t.creatorSummary:"",L=H(e.publicationTitle),q=H(e.bookTitle),F=H(e.journalAbbreviation),W=H(e.volume),M=H(e.issue),G=H(e.pages),I=H(e.dateAdded),U=H(e.dateModified),B=typeof e.key=="string"?e.key:n,Z=H(e.DOI);Z||(Z=Jt(e));let O=Oe(e,t),j=null;(!Z||!s||!O)&&(j=await this.fetchZoteroItemCsl(B)),Z||(Z=Xt(j)),s||(s=Kt(j)),O||(O=yt(j));let $=H(e.ISBN),z=H(e.ISSN),V=H(e.publisher),K=H(e.place),ne=H(e.url),pe=H(e.language),fe=H(e.abstractNote),Pe=this.buildZoteroDeepLink(B),ce=Array.from(new Set([O,s,Z].map(Q=>String(Q||"").trim()).filter(Q=>Q.length>0))),_t=ce.join("; "),X={doc_id:n,zotero_key:typeof e.key=="string"?e.key:n,item_link:Pe,citekey:O,title:a,short_title:s,date:o,year:c,year_number:d,authors:g,editors:x,aliases:_t,tags:b,collection_title:P,collection_titles:P,collections_links:v,item_type:C,creator_summary:D,publication_title:L,book_title:q,journal_abbrev:F,volume:W,issue:M,pages:G,date_added:I,date_modified:U,doi:Z,isbn:$,issn:z,publisher:V,place:K,url:ne,language:pe,abstract:fe,pdf_link:i,item_json:r};for(let[Q,_e]of Object.entries(X)){let se=this.escapeYamlString(_e);X[`${Q}_yaml`]=se,X[`${Q}_quoted`]=se,X[`${Q}_text`]=se}return X.authors_yaml_list=this.toYamlList(u),X.editors_yaml_list=this.toYamlList(y),X.tags_yaml_list=h.length>0?this.toYamlList(h):"",X.aliases_yaml_list=ce.length>0?this.toYamlList(ce):"",X.collections_yaml_list=this.toYamlList(w),X.collections_links_yaml_list=this.toYamlList(S),X.tags_raw=k.join("; "),X.tags_raw_yaml=this.escapeYamlString(X.tags_raw),X.tags_raw_yaml_list=k.length>0?this.toYamlList(k):"",X.authors_list=X.authors_yaml_list,X.editors_list=X.editors_yaml_list,X.tags_list=X.tags_yaml_list,X.aliases_list=X.aliases_yaml_list,X.collections_list=X.collections_yaml_list,X.collections_links_list=X.collections_links_yaml_list,X}escapeYamlString(e){return`"${String(e).replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n")}"`}toYamlList(e){return e.length?e.map(t=>`  - ${this.escapeYamlString(t)}`).join(`
`):'  - ""'}sanitizeObsidianTags(e){let t=this.settings.tagSanitizeMode||"kebab",n=t==="replace"?"kebab":t;return e.map(i=>this.sanitizeObsidianTag(i,n)).filter(i=>i.length>0)}sanitizeObsidianTag(e,t){let n=String(e||"").trim();if(!n)return"";let i=n.replace(/^#+/,"");if(t==="none")return i;let r=o=>!/^\d+$/.test(o),s=(o=>i.split("/").map(d=>{let u=d.replace(/[^\p{L}\p{N}]+/gu," ").split(/\s+/).filter(Boolean);if(!u.length)return"";if(o==="camel"||o==="pascal"){let[y,...x]=u;return[o==="pascal"?y.charAt(0).toUpperCase()+y.slice(1):y.charAt(0).toLowerCase()+y.slice(1),...x.map(h=>h.charAt(0).toUpperCase()+h.slice(1))].join("")}let g=o==="snake"?"_":"-";return u.join(g)}).filter(Boolean).join("/").replace(/\/{2,}/g,"/").replace(/^\/+|\/+$/g,""))(t);return s&&r(s)?s:""}normalizeZoteroTags(e){let t=new Map;for(let n of e){let i=this.normalizeZoteroTag(n);if(!i)continue;let r=i.toLowerCase();t.has(r)||t.set(r,i)}return Array.from(t.values())}normalizeZoteroTag(e){let t=String(e||"").trim();if(!t)return"";let n=t.replace(/^#+/,"").trim();if(!n)return"";let i=n.split("/").map(r=>{let a=r.trim();return a?(a=a.replace(/[_-]+/g," "),a=a.replace(/([A-Z]+)([A-Z][a-z])/g,"$1 $2"),a=a.replace(/([a-z\\d])([A-Z])/g,"$1 $2"),a=a.replace(/([a-zA-Z])(\\d)/g,"$1 $2"),a=a.replace(/(\\d)([a-zA-Z])/g,"$1 $2"),a=a.replace(/\s+/g," ").trim(),a):""}).filter(Boolean);return i.length?i.join("/"):""}toObsidianLinks(e){return e.map(t=>String(t||"").trim()).filter(t=>t.length>0).map(t=>t.startsWith("[[")&&t.endsWith("]]")?t:`[[${t}]]`)}getVaultBasePath(){var i;let e=this.app.vault.adapter;if(e instanceof m.FileSystemAdapter)return e.getBasePath();let t=e,n=(i=t.getBasePath)==null?void 0:i.call(t);if(n)return n;throw new Error("Vault base path is unavailable.")}expandPathValue(e){let t=(e||"").trim();if(!t)return t;let n=t;return n==="~"?n=$e.default.homedir():(n.startsWith("~/")||n.startsWith("~\\"))&&(n=R.default.join($e.default.homedir(),n.slice(2))),n=n.replace(/\$([A-Za-z_][A-Za-z0-9_]*)|\$\{([^}]+)\}/g,(i,r,a)=>{let s=r||a,o=s?process.env[s]:void 0;return o!==void 0?o:i}),n=n.replace(/%([^%]+)%/g,(i,r)=>{let a=process.env[r];return a!==void 0?a:i}),n}resolvePythonPath(){return this.resolveUserPath(this.settings.pythonPath||"")}getPythonRuntimeMode(){return this.settings.pythonRuntime==="local"?"local":"worker"}usePythonWorker(){return this.getPythonRuntimeMode()==="worker"}getPythonWorkerCacheDir(){return R.default.join(this.getVaultBasePath(),ae,"python-worker-cache")}getPythonWorkerApiPort(e){let n=(Number.isFinite(e!=null?e:NaN)?Number(e):this.getRedisPortFromUrl())+Un;return n>=1024&&n<=65535?n:Zn}getPythonWorkerApiBaseUrl(e){let t=Number.isFinite(e!=null?e:NaN)?Number(e):this.getPythonWorkerApiPort();return`http://${Vn}:${t}`}getPythonWorkerApiPortFromContext(e){let t=Number.parseInt(String(e.composeEnv.ZRR_WORKER_PORT||""),10);return Number.isFinite(t)&&t>0?t:this.getPythonWorkerApiPort()}nextPythonWorkerRequestId(e){this.pythonWorkerRequestSeq+=1;let t=e.replace(/[^a-zA-Z0-9_.-]/g,"_");return`${Date.now().toString(36)}-${this.pythonWorkerRequestSeq.toString(36)}-${t}`}logPythonWorkerTiming(e,t){console.debug("[zrr-python-worker]",e,t)}async isPythonWorkerApiHealthy(e,t=1500){let n=`${this.getPythonWorkerApiBaseUrl(this.getPythonWorkerApiPortFromContext(e))}/health`;try{let i=await this.requestLocalApiRaw(n,{headers:{Accept:"application/json"},timeoutMs:t});if(i.statusCode<200||i.statusCode>=300)return!1;let r=JSON.parse(i.body.toString("utf8"));return!!(r!=null&&r.ok)}catch(i){return!1}}getWorkerToolName(e){let t=R.default.resolve(this.getPluginDir(),"tools"),n=R.default.resolve(e);if(R.default.dirname(n)!==t)return null;let i=R.default.basename(n);return!i.endsWith(".py")||i.includes(R.default.sep)?null:i}getComposeServiceNamesForCurrentRuntime(){return this.usePythonWorker()?[he,pt]:[he]}toContainerPath(e,t,n){let i=R.default.relative(e,t);if(i.startsWith("..")||R.default.isAbsolute(i))return null;let r=i.split(R.default.sep).filter(Boolean);return r.length?R.default.posix.join(n,...r):n}mapPathForPythonWorker(e){var r,a;if(!R.default.isAbsolute(e))return e;let t=R.default.normalize(e),n=R.default.normalize(this.getPluginDir()),i=R.default.normalize(this.getVaultBasePath());return(a=(r=this.toContainerPath(n,t,$n))!=null?r:this.toContainerPath(i,t,cn))!=null?a:e}getWorkerHostAlias(){return(this.settings.dockerPath||"").toLowerCase().includes("podman")?"host.containers.internal":"host.docker.internal"}mapUrlForPythonWorker(e){let t=(e||"").trim();if(!t)return e;let n;try{n=new URL(t)}catch(i){return e}return!["http:","https:","redis:","rediss:","redis+tls:"].includes(n.protocol)||!this.isLocalRedisHost(n.hostname||"")?e:n.protocol==="redis:"||n.protocol==="rediss:"||n.protocol==="redis+tls:"?(n.hostname=he,n.port="6379",n.toString()):(n.hostname=this.getWorkerHostAlias(),n.toString())}mapPythonArgsForWorker(e){return e.map((t,n)=>{if(n>0&&e[n-1]==="--redis-url")return this.mapUrlForPythonWorker(t);if(t.startsWith("--redis-url=")){let a=t.slice(12);return`--redis-url=${this.mapUrlForPythonWorker(a)}`}let i=this.mapUrlForPythonWorker(t);if(i!==t)return i;if(!R.default.isAbsolute(t))return t;let r=this.mapPathForPythonWorker(t);if(r===t)throw new Error(`Python worker cannot access path '${t}'. Keep files under your vault or plugin directory.`);return r})}resolveUserPath(e,t){let n=this.expandPathValue(e);return!n||!(n.includes("/")||n.includes("\\"))||R.default.isAbsolute(n)?n:t&&(n.startsWith("./")||n.startsWith(".\\"))?R.default.join(t,n.slice(2)):R.default.join($e.default.homedir(),n)}getPluginDir(){var i;let e=this.getVaultBasePath(),t=(i=this.manifest.dir)!=null?i:this.manifest.id;if(!t)throw new Error("Plugin directory is unavailable.");let n=R.default.isAbsolute(t)?t:R.default.join(e,t);return R.default.normalize(n)}async ensureBundledTools(){let e=this.getPluginDir(),t=R.default.join(e,"tools");await ee.promises.mkdir(t,{recursive:!0});for(let[n,i]of Object.entries(rn)){let r=R.default.join(t,n),a=!0;try{await ee.promises.readFile(r,"utf8")===i&&(a=!1)}catch(s){}a&&await ee.promises.writeFile(r,i,"utf8")}}async migrateCachePaths(){let e="zotero/items",t="zotero/chunks",n=oe,i=Y,r=this.app.vault.adapter,a=(0,m.normalizePath)(e),s=(0,m.normalizePath)(t),o=(0,m.normalizePath)(n),l=(0,m.normalizePath)(i),c=o.split("/").slice(0,-1).join("/"),d=l.split("/").slice(0,-1).join("/");c&&await this.ensureFolder(c),d&&await this.ensureFolder(d);let p=await r.exists(a),u=await r.exists(s),g=await r.exists(o),y=await r.exists(l);p&&!g&&await r.rename(a,o),u&&!y&&await r.rename(s,l)}getAbsoluteVaultPath(e){let t=this.getVaultBasePath(),n=R.default.isAbsolute(e)?e:R.default.join(t,e);return R.default.normalize(n)}async resolveAttachmentOutputDir(e){let t=e?R.default.isAbsolute(e)?this.toVaultRelativePath(e):(0,m.normalizePath)(e):"";if(!t)return null;let n=this.app.fileManager;if(!(n!=null&&n.getAvailablePathForAttachment))return null;try{let i=`zrr-image-${Date.now()}.png`,r=await n.getAvailablePathForAttachment(i,t);if(!r)return null;let a=R.default.isAbsolute(r)?r:this.getAbsoluteVaultPath(r),s=R.default.normalize(R.default.dirname(a)),o=R.default.normalize(this.getVaultBasePath()),l=this.toVaultRelativePath(s);return!l&&s!==o?null:{absolute:s,relative:l}}catch(i){return console.warn("Failed to resolve attachment output dir",i),null}}async resolveAnnotationImageOutputDir(e){let t=null;if(e&&(t=await this.resolveAttachmentOutputDir(e)),!t){let r=(0,m.normalizePath)(this.settings.outputNoteDir||"");if(!r)return null;t={absolute:this.getAbsoluteVaultPath(r),relative:r}}let n=(0,m.normalizePath)(R.default.join(t.relative||"","zrr-annotations")),i=R.default.normalize(R.default.join(t.absolute,"zrr-annotations"));return n&&await this.ensureFolder(n),{absolute:i,relative:n}}async buildDoclingArgs(e,t,n,i,r,a=!1){let s=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",t,"--out-json",this.getAbsoluteVaultPath(n),"--out-md",this.getAbsoluteVaultPath(i),"--chunking",this.settings.chunkingMode,"--ocr",s];a&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),this.settings.forcePerPageOcr&&o.push("--force-per-page-ocr"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),r&&o.push("--language-hint",r),this.settings.enableLlmCleanup?(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars))):o.push("--no-llm-cleanup");let l=this.getPluginDir(),c=R.default.join(l,"tools","ocr_wordlist.txt");if((0,ee.existsSync)(c)&&o.push("--enable-dictionary-correction","--dictionary-path",c),this.settings.enableFileLogging){let p=this.getLogFileAbsolutePath();p&&o.push("--log-file",p);let u=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());u&&o.push("--spellchecker-info-out",u)}let d=await this.resolveAttachmentOutputDir(i);return d&&(d.relative&&await this.ensureFolder(d.relative),o.push("--image-output-dir",d.absolute)),this.appendOcrEngineArgs(o),o}appendOcrEngineArgs(e){let t=this.settings.ocrEngine,n=(this.settings.paddleApiKey||"").trim(),i=(this.settings.paddleVlApiUrl||"").trim(),r=(this.settings.paddleStructureApiUrl||"").trim(),a=o=>{e.push("--prefer-ocr-engine",o,"--fallback-ocr-engine",o)},s=()=>{e.push("--no-paddle-vl-api","--no-paddle-structure-api")};switch(t){case"tesseract":a("tesseract"),e.push("--no-paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_local":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl"),s();break;case"paddle_vl_local":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_api":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl","--no-paddle-vl-api"),n?(e.push("--paddle-structure-api","--paddle-structure-api-token",n),r&&e.push("--paddle-structure-api-url",r)):e.push("--no-paddle-structure-api");break;case"paddle_vl_api":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3","--no-paddle-structure-api"),n?(e.push("--paddle-vl-api","--paddle-vl-api-token",n),i&&e.push("--paddle-vl-api-url",i)):e.push("--no-paddle-vl-api");break;default:s();break}}appendEmbedSubchunkArgs(e){let t=this.settings.embedSubchunkChars;Number.isFinite(t)&&e.push("--embed-subchunk-chars",String(Math.max(0,Math.trunc(t))));let n=this.settings.embedSubchunkOverlap;Number.isFinite(n)&&e.push("--embed-subchunk-overlap",String(Math.max(0,Math.trunc(n))))}appendEmbedContextArgs(e){let t=this.settings.embedContextWindow;Number.isFinite(t)&&e.push("--embed-context-window",String(Math.max(0,Math.trunc(t))));let n=this.settings.embedContextChars;Number.isFinite(n)&&e.push("--embed-context-chars",String(Math.max(0,Math.trunc(n))))}appendChunkTaggingArgs(e,t){if((t==null?void 0:t.allowRegenerate)===!1||!this.settings.enableChunkTagging)return;let n=(this.settings.llmCleanupBaseUrl||"").trim(),i=(this.settings.llmCleanupModel||"").trim();if(!n||!i)return;e.push("--generate-chunk-tags","--tag-base-url",n,"--tag-model",i);let r=(this.settings.llmCleanupApiKey||"").trim();r&&e.push("--tag-api-key",r),e.push("--tag-temperature",String(this.settings.llmCleanupTemperature))}getRedisDataDir(){let e=this.resolveUserPath(process.env.ZRR_DATA_DIR||"");if(e)return e;let t=this.resolveUserPath(this.settings.redisDataDirOverride||"",this.getVaultBasePath());return!this.settings.autoAssignRedisPort&&t?t:R.default.join(this.getVaultBasePath(),ae,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return R.default.join(e,"tools","docker-compose.yml")}prependBinaryDirToPath(e,t){if(!t||!R.default.isAbsolute(t))return;let n=R.default.dirname(t),i=e.PATH||"";(i?i.split(R.default.delimiter):[]).includes(n)||(e.PATH=i?`${n}${R.default.delimiter}${i}`:n)}async resolveDockerPath(){var c;let e=(c=this.settings.dockerPath)==null?void 0:c.trim(),t=e?this.resolveUserPath(e):"",n=["/opt/homebrew/bin/docker","/usr/local/bin/docker","/usr/bin/docker","/Applications/Docker.app/Contents/Resources/bin/docker"],i=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"],r=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"],a=[];t&&a.push(t);let s=t?this.getContainerCliKind(t):"docker",o=s==="podman-compose"?[r,i,n]:s==="podman"?[i,r,n]:[n,i,r];if(!t||t==="docker"||t==="podman"||t==="podman-compose")for(let d of o)a.push(...d);for(let d of a)if(R.default.isAbsolute(d))try{if(await this.isContainerCliAvailable(d))return d}catch(p){}let l=[t,s==="podman"?"podman":"docker",s==="podman"?"docker":"podman","podman-compose"].filter(d=>!!(d&&d.trim()));for(let d of l)if(await this.isContainerCliAvailable(d))return d;return t||"docker"}async isContainerCliAvailable(e){return new Promise(t=>{let n=(0,le.spawn)(e,["--version"]);n.on("error",()=>t(!1)),n.on("close",i=>t(i===0))})}getContainerCliKind(e){let t=R.default.basename(e);return t==="podman-compose"?"podman-compose":t.includes("podman")?"podman":"docker"}async isContainerDaemonRunning(e){let t=this.getContainerCliKind(e),n=e,i=["info"];if(t==="podman-compose"){let r=await this.resolvePodmanBin();if(!r)return!1;n=r}return new Promise(r=>{let a=(0,le.spawn)(n,i),s=!1,o=c=>{s||(s=!0,r(c))},l=setTimeout(()=>{a.kill(),o(!1)},2e3);a.on("error",()=>{clearTimeout(l),o(!1)}),a.on("close",c=>{clearTimeout(l),o(c===0)})})}getContainerDaemonHint(e){let t=this.getContainerCliKind(e);return t==="podman"||t==="podman-compose"?"Podman machine not running. Run `podman machine start`.":"Docker Desktop is not running. Start Docker Desktop."}async supportsComposeSubcommand(e){return new Promise(t=>{let n=(0,le.spawn)(e,["compose","version"]);n.on("error",()=>t(!1)),n.on("close",i=>t(i===0))})}async findPodmanComposePath(){let e=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"];for(let t of e)try{return await ee.promises.access(t),t}catch(n){}return await this.isContainerCliAvailable("podman-compose")?"podman-compose":null}async resolvePodmanBin(){let e=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"];for(let t of e)if(await this.isContainerCliAvailable(t))return t;return await this.isContainerCliAvailable("podman")?"podman":null}async resolveComposeCommand(e){let t=R.default.basename(e);if(t==="podman-compose")return{command:e,argsPrefix:[]};if(t==="podman"){let n=await this.findPodmanComposePath();return n?{command:n,argsPrefix:[]}:await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}return await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}async buildComposeEnvironment(e,t,n){var s;let i={...process.env};if(this.prependBinaryDirToPath(i,e),this.prependBinaryDirToPath(i,t.command),R.default.basename(t.command)==="podman-compose"){let o=await this.resolvePodmanBin();o&&(i.PODMAN_BIN=o,this.prependBinaryDirToPath(i,o))}let r=(n==null?void 0:n.dataDir)||this.getRedisDataDir(),a=(s=n==null?void 0:n.redisPort)!=null?s:this.getRedisPortFromUrl();return i.ZRR_DATA_DIR=this.toComposePath(r),this.applyComposePortEnvironment(i,a),i.ZRR_VAULT_DIR=this.toComposePath(this.getVaultBasePath()),i.ZRR_PLUGIN_DIR=this.toComposePath(this.getPluginDir()),i.ZRR_WORKER_CACHE_DIR=this.toComposePath(this.getPythonWorkerCacheDir()),i}toComposePath(e){return process.platform!=="win32"?e:e.replace(/\\/g,"/")}async resolveComposeProjectContext(e){await this.ensureBundledTools();let t=this.getDockerComposePath(),n=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(n))throw new Error('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');if(!await this.isContainerDaemonRunning(n))throw new Error(this.getContainerDaemonHint(n));let i=await this.resolveComposeCommand(n);if(!i)throw new Error("Compose support not found. Install Docker Desktop or Podman with podman-compose.");let r=await this.buildComposeEnvironment(n,i,e);return{composePath:t,composeCommand:i,composeEnv:r,project:this.getDockerProjectName()}}async maybeShowFirstContainerStartupNotice(e){if(!(e||this.settings.firstContainerStartupNoticeShown)){this.settings.firstContainerStartupNoticeShown=!0;try{await this.saveSettings()}catch(t){console.warn("Failed to persist first container startup notice flag",t)}new m.Notice("First container startup can take several minutes (sometimes 10+ minutes) while images are pulled and worker dependencies are built.",16e3)}}async autoDetectContainerCliOnLoad(){var o;let e=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(e)){this.notifyContainerOnce("Docker or Podman not found. Install Docker Desktop or Podman and set Docker/Podman path in settings.");return}let t=((o=this.settings.dockerPath)==null?void 0:o.trim())||"docker",n=this.expandPathValue(t);!await this.isContainerCliAvailable(n)&&!(t==="docker"||t==="podman"||t==="podman-compose")&&e&&e!==t&&(this.settings.dockerPath=e,await this.saveSettings());let s=l=>new Promise(c=>setTimeout(c,l));if(!await this.isContainerDaemonRunning(e)){for(let l of[5e3,1e4])if(await s(l),await this.isContainerDaemonRunning(e))return;this.notifyContainerOnce(this.getContainerDaemonHint(e))}}getDockerProjectName(){let e=s=>s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,32),t=(process.env.ZRR_PROJECT_NAME||"").trim();if(t&&!this.settings.autoAssignRedisPort)return e(t)||"zrr";let n=(this.settings.redisProjectName||"").trim();if(n&&!this.settings.autoAssignRedisPort)return e(n)||"zrr";let i=this.getVaultBasePath(),r=R.default.basename(i).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),a=(0,Ve.createHash)("sha1").update(i).digest("hex").slice(0,8);return`zrr-${r||"vault"}-${a}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),t=e.port?Number(e.port):6379;return Number.isFinite(t)&&t>0?t:6379}catch(e){return 6379}}getRedisInsightPort(e){let n=(Number.isFinite(e!=null?e:NaN)?Number(e):this.getRedisPortFromUrl())+Bn;return n>=1024&&n<=65535?n:mn}applyComposePortEnvironment(e,t){e.ZRR_PORT=String(t),e.ZRR_WORKER_PORT=String(this.getPythonWorkerApiPort(t)),e.ZRR_INSIGHT_PORT=String(this.getRedisInsightPort(t))}getVaultPreferredRedisPort(){let e=(0,Ve.createHash)("sha1").update(this.getVaultBasePath()).digest("hex");return 6400+Number.parseInt(e.slice(0,4),16)%2e3}getRedisHostFromUrl(){try{return new URL(this.settings.redisUrl).hostname||"127.0.0.1"}catch(e){return"127.0.0.1"}}isLocalRedisHost(e){let t=e.trim().toLowerCase();return t?t==="localhost"||t==="0.0.0.0"||t==="::1"?!0:t.startsWith("127."):!1}getPortCheckHost(e){return this.isLocalRedisHost(e)?"127.0.0.1":e}async isPortFree(e,t){return new Promise(n=>{let i=je.default.createServer();i.once("error",()=>n(!1)),i.once("listening",()=>{i.close(()=>n(!0))}),i.listen(t,e)})}getRequiredComposeHostPorts(e){let t=[e,this.getRedisInsightPort(e)];return this.usePythonWorker()&&t.push(this.getPythonWorkerApiPort(e)),Array.from(new Set(t))}async findAvailableComposeRedisPort(e,t){for(let i=0;i<25;i+=1){let r=t+i,a=this.getRequiredComposeHostPorts(r),s=!0;for(let o of a)if(!await this.isPortFree(e,o)){s=!1;break}if(s)return r}return null}updateRedisUrlPort(e,t){try{let n=new URL(e);return n.port=String(t),n.toString()}catch(n){return`redis://127.0.0.1:${t}`}}async isRedisReachable(e){let t="127.0.0.1",n=6379;try{let i=new URL(e);t=i.hostname||t,n=i.port?Number(i.port):n}catch(i){return!1}return t=this.getPortCheckHost(t),new Promise(i=>{let r=new je.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(n,t)})}async isZoteroLocalApiReachable(){let e=(this.settings.zoteroBaseUrl||"").trim();if(!e)return!1;let t="127.0.0.1",n=23119;try{let i=new URL(e);if(t=i.hostname||t,i.port){let r=Number(i.port);Number.isFinite(r)&&r>0&&(n=r)}else i.protocol==="https:"?n=443:n=80}catch(i){return!1}return new Promise(i=>{let r=new je.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(n,t)})}getRedisNamespace(){let e=this.getVaultBasePath(),t=R.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24),n=(0,Ve.createHash)("sha1").update(e).digest("hex").slice(0,8);return`${t||"vault"}-${n}`}getRedisIndexName(){return`${(this.settings.redisIndex||"idx:zotero").trim()||"idx:zotero"}:${this.getRedisNamespace()}`}getRedisKeyPrefix(){let e=(this.settings.redisPrefix||"zotero:chunk:").trim()||"zotero:chunk:";return`${e.endsWith(":")?e:`${e}:`}${this.getRedisNamespace()}:`}async isComposeProjectRunning(e,t,n,i,r,a=[]){let s=a.length?a:[""];for(let o of s)if(!await new Promise(c=>{let d=o?[o]:[],p=(0,le.spawn)(e,[...t,"-p",i,"-f",n,"ps","-q",...d],{cwd:R.default.dirname(n),env:r}),u="";p.stdout.on("data",g=>{u+=g.toString()}),p.on("error",g=>{console.warn("Redis Stack status check failed",g),c(!1)}),p.on("close",g=>{if(g!==0){c(!1);return}c(u.trim().length>0)})}))return!1;return!0}isContainerNameConflictError(e){return/container name/i.test(e)&&/already in use/i.test(e)}extractConflictingContainerNames(e){let t=new Set,n=/container name\s+["']\/?([^"'\s]+)["']/gi,i;for(;(i=n.exec(e))!==null;){let r=String(i[1]||"").trim().replace(/^\/+/,"");r&&t.add(r)}return Array.from(t)}getExpectedComposeContainerNames(e,t){let n=new Set([...t,he,pt]);return Array.from(n).map(i=>`${e}-${i}-1`)}async resolveContainerRuntimeCommandForCompose(e){if(R.default.basename(e.composeCommand.command||"")==="podman-compose"){let n=String(e.composeEnv.PODMAN_BIN||"").trim();return n||this.resolvePodmanBin()}return e.composeCommand.command||null}async recoverFromContainerNameConflict(e,t,n){let i=e instanceof Error?e.message:typeof e=="string"?e:"";if(!this.isContainerNameConflictError(i))return!1;let r=this.getExpectedComposeContainerNames(t.project,n),a=this.extractConflictingContainerNames(i),s=`${t.project}-`,o=Array.from(new Set([...r,...a])).map(c=>c.replace(/^\/+/,"").trim()).filter(c=>c.startsWith(s));if(!o.length)return!1;let l=await this.resolveContainerRuntimeCommandForCompose(t);if(!l)return!1;console.warn("Recovering from stale container name conflict",{project:t.project,containers:o});for(let c of o)try{await this.runCommand(l,["rm","-f",c],{cwd:R.default.dirname(t.composePath),env:t.composeEnv})}catch(d){console.warn("Failed to remove stale container during conflict recovery",{name:c,cleanupError:d})}return!0}async startRedisStack(e){var t;try{await this.ensureBundledTools();let n=this.getDockerComposePath(),i=this.getRedisDataDir(),r=this.getPythonWorkerCacheDir();await ee.promises.mkdir(i,{recursive:!0}),await ee.promises.mkdir(r,{recursive:!0});let a=await this.resolveDockerPath(),s=((t=this.settings.dockerPath)==null?void 0:t.trim())||"docker",o=this.resolveUserPath(s),l=s==="docker"||s==="podman"||s==="podman-compose";if(!await this.isContainerCliAvailable(o)&&!l&&a&&a!==s&&(this.settings.dockerPath=a,await this.saveSettings(),e||new m.Notice(`Docker/Podman path set to ${a}.`)),!await this.isContainerCliAvailable(a)){e||new m.Notice('Docker or podman not found. Install docker desktop or podman and set "docker/podman path" in settings.');return}if(!await this.isContainerDaemonRunning(a)){e||new m.Notice(this.getContainerDaemonHint(a));return}let p=await this.resolveComposeCommand(a);if(!p){e||new m.Notice("Compose support not found. Install docker desktop or podman with podman-compose.");return}let u=this.getRedisPortFromUrl(),g=await this.buildComposeEnvironment(a,p,{dataDir:i,redisPort:u}),y=this.getDockerProjectName(),x={composePath:n,composeCommand:p,composeEnv:g,project:y},k=this.getComposeServiceNamesForCurrentRuntime();if(await this.isComposeProjectRunning(p.command,p.argsPrefix,n,y,g,k)){e||new m.Notice(this.usePythonWorker()?"Redis Stack and Python worker already running for this vault.":"Redis Stack already running for this vault.");return}let h=this.getRedisHostFromUrl(),b=this.getPortCheckHost(h),w=this.settings.autoAssignRedisPort&&this.isLocalRedisHost(h),P=this.settings.redisUrl,S=u,v=()=>{if(!e){if(!this.settings.autoAssignRedisPort){new m.Notice("Redis already running. If you share redis across vaults, disable auto-start redis in this vault.");return}new m.Notice(`Redis already running at ${P}.`)}};if(w){let D=u===6379?this.getVaultPreferredRedisPort():u,L=await this.findAvailableComposeRedisPort(b,D);if(!L)throw new Error(`No available Redis port found starting at ${D}.`);L!==u&&(S=L,P=this.updateRedisUrlPort(P,S),this.settings.redisUrl=P,await this.saveSettings(),e||new m.Notice(`Using Redis port ${S} for this vault.`))}else{if(this.isLocalRedisHost(h)&&!await this.isPortFree(b,S)){await this.isRedisReachable(P)?(v(),this.usePythonWorker()&&(await this.maybeShowFirstContainerStartupNotice(e),await this.startPythonWorkerService(x))):e||new m.Notice(`Port ${S} is already in use and Redis is not reachable at ${P}. Update the Redis URL or enable auto-assign.`);return}if(await this.isRedisReachable(P)){v(),this.usePythonWorker()&&(await this.maybeShowFirstContainerStartupNotice(e),await this.startPythonWorkerService(x));return}}this.applyComposePortEnvironment(g,S);try{await this.runCommand(p.command,[...p.argsPrefix,"-p",y,"-f",n,"down"],{cwd:R.default.dirname(n),env:g})}catch(D){console.warn("Redis Stack stop before restart failed",D)}let C=[...p.argsPrefix,"-p",y,"-f",n,"up","-d"];this.usePythonWorker()&&C.push("--build"),C.push(...k),await this.maybeShowFirstContainerStartupNotice(e);try{await this.runCommand(p.command,C,{cwd:R.default.dirname(n),env:g})}catch(D){if(!await this.recoverFromContainerNameConflict(D,x,k))throw D;console.debug("Retrying Redis stack startup after container conflict recovery."),await this.runCommand(p.command,C,{cwd:R.default.dirname(n),env:g})}e||new m.Notice("Redis stack started.")}catch(n){e||new m.Notice("Failed to start redis stack. Check docker/podman and file sharing."),console.error("Failed to start Redis Stack",n)}}async recreateRedisStack(e){try{if(!this.isLocalRedisHost(this.getRedisHostFromUrl())){e||new m.Notice("This command only works for local redis addresses managed by compose.");return}let t=await this.resolveComposeProjectContext({dataDir:this.getRedisDataDir(),redisPort:this.getRedisPortFromUrl()});await this.maybeShowFirstContainerStartupNotice(e),await this.runCommand(t.composeCommand.command,[...t.composeCommand.argsPrefix,"-p",t.project,"-f",t.composePath,"pull",he],{cwd:R.default.dirname(t.composePath),env:t.composeEnv}),await this.runCommand(t.composeCommand.command,[...t.composeCommand.argsPrefix,"-p",t.project,"-f",t.composePath,"up","-d","--force-recreate",he],{cwd:R.default.dirname(t.composePath),env:t.composeEnv}),e||new m.Notice("Redis stack recreated.")}catch(t){e||new m.Notice("Failed to recreate redis stack. Check docker/podman and file sharing."),console.error("Failed to recreate Redis Stack",t)}}async waitForPythonWorkerReady(e,t=900*1e3){let n=Date.now(),i=r=>new Promise(a=>setTimeout(a,r));for(;Date.now()-n<t;){if(await this.isPythonWorkerApiHealthy(e))return;await i(2e3)}throw new Error("Python worker is still starting. Check compose logs for the python-worker service.")}async startPythonWorkerService(e){let t=e!=null?e:await this.resolveComposeProjectContext({dataDir:this.getRedisDataDir(),redisPort:this.getRedisPortFromUrl()}),n=[...t.composeCommand.argsPrefix,"-p",t.project,"-f",t.composePath,"up","-d","--build",pt];await this.runCommand(t.composeCommand.command,n,{cwd:R.default.dirname(t.composePath),env:t.composeEnv})}async ensureWorkerRedisService(e,t){if(!this.settings.autoStartRedis||!this.isLocalRedisHost(this.getRedisHostFromUrl()))return;if(!await this.isComposeProjectRunning(e.composeCommand.command,e.composeCommand.argsPrefix,e.composePath,e.project,e.composeEnv,[he])&&t){let r=[...e.composeCommand.argsPrefix,"-p",e.project,"-f",e.composePath,"up","-d",he];await this.runCommand(e.composeCommand.command,r,{cwd:R.default.dirname(e.composePath),env:e.composeEnv})}if(!await this.isComposeProjectRunning(e.composeCommand.command,e.composeCommand.argsPrefix,e.composePath,e.project,e.composeEnv,[he]))throw new Error("Redis service is not running. Start Redis stack now or enable Auto-start Redis stack.")}async ensurePythonWorkerContext(e){let t=this.getRedisDataDir();await ee.promises.mkdir(t,{recursive:!0}),await ee.promises.mkdir(this.getPythonWorkerCacheDir(),{recursive:!0});let n=await this.resolveComposeProjectContext({dataDir:t,redisPort:this.getRedisPortFromUrl()}),i=[pt];if(!await this.isComposeProjectRunning(n.composeCommand.command,n.composeCommand.argsPrefix,n.composePath,n.project,n.composeEnv,i)&&e&&(await this.startPythonWorkerService(n),n=await this.resolveComposeProjectContext({dataDir:t,redisPort:this.getRedisPortFromUrl()})),!await this.isComposeProjectRunning(n.composeCommand.command,n.composeCommand.argsPrefix,n.composePath,n.project,n.composeEnv,i))throw new Error("Python worker is not running. Start Redis stack now or enable Auto-start Redis stack.");return await this.ensureWorkerRedisService(n,e),await this.waitForPythonWorkerReady(n),n}async setupPythonEnv(){if(this.usePythonWorker()){try{new m.Notice("Setting up python worker environment..."),this.showStatusProgress("Setting up Python worker environment...",null),await this.ensurePythonWorkerContext(!0),this.clearStatusProgress(),new m.Notice("Python worker environment ready.")}catch(r){this.clearStatusProgress(),new m.Notice("Failed to set up python worker environment. See console for details."),console.error("Python worker setup failed",r)}return}let e=this.getPluginDir(),t=this.getPythonVenvDir(),n=this.getVenvPythonPath(t);await this.ensureBundledTools();let i=this.resolveRequirementsPath(e);if(!i)throw new Error(`requirements.txt not found in ${e}`);try{new m.Notice("Setting up python environment..."),this.showStatusProgress("Setting up Python environment...",null),console.debug(`Python env: using plugin dir ${e}`),console.debug(`Python env: venv path ${t}`),await ee.promises.mkdir(R.default.dirname(t),{recursive:!0});let r=null,a=async()=>(r||(r=await this.resolveBootstrapPython()),r);if((0,ee.existsSync)(n)){let s=await this.getPythonVersion(n,[]);if(s&&this.isUnsupportedPythonVersion(s)){let o=await a();console.debug(`Python env: existing venv uses Python ${s.major}.${s.minor}; rebuilding with ${o.command} ${o.args.join(" ")}`),this.showStatusProgress("Rebuilding Python environment...",null),await ee.promises.rm(t,{recursive:!0,force:!0})}}if(!(0,ee.existsSync)(n)){let s=await a();console.debug(`Python env: creating venv with ${s.command} ${s.args.join(" ")}`),await this.runCommand(s.command,[...s.args,"-m","venv",t],{cwd:e})}await this.runCommandStreaming(n,["-m","pip","install","-r",i],{cwd:e},s=>{let o=s.trim();if(!o)return;let l=o.match(/^Collecting\s+([^\s]+)/);if(l){this.showStatusProgress(`Installing ${l[1]}...`,null);return}if(o.startsWith("Installing collected packages")){this.showStatusProgress("Installing packages...",null);return}o.startsWith("Successfully installed")&&this.showStatusProgress("Python environment ready.",100)}),this.settings.pythonPath=n,await this.saveSettings(),this.clearStatusProgress(),new m.Notice("Python environment ready.")}catch(r){this.clearStatusProgress(),new m.Notice("Failed to set up python environment. See console for details."),console.error("Python env setup failed",r)}}async detectOcrEngines(){if(this.usePythonWorker())return{tesseract:!0,paddleStructureLocal:!0,paddleVlLocal:!0};let e=await this.canRunCommand("tesseract",[]),t=this.resolvePythonPath(),n=[];if(!t)try{let l=await this.resolveBootstrapPython();t=l.command,n=l.args}catch(l){return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1}}let i=["import importlib.util, json","def has_module(name):","    return importlib.util.find_spec(name) is not None","has_paddle = has_module('paddle')","has_paddleocr = has_module('paddleocr')","has_paddlex = has_module('paddlex')","has_vl = False","if has_paddleocr:","    try:","        from paddleocr import PaddleOCRVL","        has_vl = True","    except Exception:","        has_vl = False","print(json.dumps({'paddle': has_paddle, 'paddleocr': has_paddleocr, 'paddlex': has_paddlex, 'paddle_vl': has_vl}))"].join(`
`),r=await new Promise(l=>{let c=(0,le.spawn)(t,[...n,"-c",i],{env:this.buildPythonEnv()}),d="";c.stdout.on("data",p=>{d+=p.toString()}),c.on("error",()=>l({ok:!1})),c.on("close",p=>{if(p!==0){l({ok:!1});return}try{let u=JSON.parse(d.trim());l({ok:!0,data:u})}catch(u){l({ok:!1})}})});if(!r.ok||!r.data)return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1};let a=r.data,s=!!a.paddle,o=!!a.paddleocr;return{tesseract:e,paddleStructureLocal:s&&o&&!!a.paddlex,paddleVlLocal:s&&o&&!!a.paddle_vl}}getSharedPythonEnvRoot(){let e=$e.default.homedir();if(process.platform==="win32"){let n=process.env.LOCALAPPDATA||process.env.APPDATA||R.default.join(e,"AppData","Local");return R.default.join(n,"zotero-redisearch-rag")}let t=process.env.XDG_CACHE_HOME||R.default.join(e,".cache");return R.default.join(t,"zotero-redisearch-rag")}getPythonVenvDir(){return this.settings.pythonEnvLocation==="plugin"?R.default.join(this.getPluginDir(),".venv"):R.default.join(this.getSharedPythonEnvRoot(),"venv")}getVenvPythonPath(e){return process.platform==="win32"?R.default.join(e,"Scripts","python.exe"):R.default.join(e,"bin","python")}resolveRequirementsPath(e){var n;return(n=[R.default.join(e,"requirements.txt"),R.default.join(e,"tools","requirements.txt")].find(i=>(0,ee.existsSync)(i)))!=null?n:null}async resolveBootstrapPython(){let e=(this.settings.pythonPath||"").trim(),t=this.expandPathValue(e);if(t&&await this.canRunCommand(t,[])){let i=await this.getPythonVersion(t,[]);if(i&&this.isUnsupportedPythonVersion(i))throw new Error(`Configured Python ${i.major}.${i.minor} is not supported. Install Python 3.11\u20133.13 and update the Python path.`);return{command:t,args:[]}}let n=process.platform==="win32"?[{command:"py",args:["-3.13"]},{command:"py",args:["-3.12"]},{command:"py",args:["-3.11"]},{command:"py",args:["-3.10"]},{command:"py",args:["-3"]},{command:"python",args:[]}]:[{command:"python3.13",args:[]},{command:"python3.12",args:[]},{command:"python3.11",args:[]},{command:"python3.10",args:[]},{command:"python3",args:[]},{command:"python",args:[]}];for(let i of n)if(await this.canRunCommand(i.command,i.args)){let r=await this.getPythonVersion(i.command,i.args);if(r&&this.isUnsupportedPythonVersion(r)){console.debug(`Python env: skipping ${i.command} ${i.args.join(" ")} (Python ${r.major}.${r.minor} unsupported)`);continue}return i}throw new Error("No usable Python 3.11\u20133.13 interpreter found on PATH.")}isUnsupportedPythonVersion(e){return e.major>3||e.major===3&&e.minor>=14}async getPythonVersion(e,t){return new Promise(n=>{let i=(0,le.spawn)(e,[...t,"-c","import sys; print(f'{sys.version_info.major}.{sys.version_info.minor}')"]),r="";i.stdout.on("data",a=>{r+=a.toString()}),i.on("error",()=>n(null)),i.on("close",a=>{if(a!==0){n(null);return}let s=r.trim().match(/(\d+)\.(\d+)/);if(!s){n(null);return}n({major:Number(s[1]),minor:Number(s[2])})})})}async canRunCommand(e,t){return new Promise(n=>{let i=(0,le.spawn)(e,[...t,"--version"],{env:this.buildPythonEnv()});i.on("error",()=>n(!1)),i.on("close",r=>n(r===0))})}buildPythonEnv(){let e={...process.env},t=R.default.delimiter,n=e.PATH||"",r=[...process.platform==="win32"?[]:["/opt/homebrew/bin","/usr/local/bin"],n].filter(Boolean).join(t);return e.PATH=r,e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK||(e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK="True"),e.DISABLE_MODEL_SOURCE_CHECK||(e.DISABLE_MODEL_SOURCE_CHECK="True"),e}getLocalPythonInvocation(e,t){return{command:this.resolvePythonPath(),args:[e,...t],cwd:R.default.dirname(e),env:this.buildPythonEnv()}}async runPython(e,t){if(this.usePythonWorker()){let i=this.getWorkerToolName(e);if(!i)throw new Error(`Python worker can only run bundled tools under '${R.default.join(this.getPluginDir(),"tools")}'.`);await this.runPythonToolWithOutputViaWorkerApi(i,t,this.settings.autoStartRedis);return}let n=this.getLocalPythonInvocation(e,t);return new Promise((i,r)=>{let a=(0,le.spawn)(n.command,n.args,{cwd:n.cwd,env:n.env}),s="",o="";a.stdout.on("data",l=>{s+=l.toString()}),a.stderr.on("data",l=>{o+=l.toString()}),a.on("error",l=>{this.handlePythonProcessError(String(l)),r(l)}),a.on("close",l=>{if(l===0)i();else{let c=o.trim()?o:s;this.handlePythonProcessError(c),r(new Error(o||`Process exited with code ${l}`))}})})}runCommand(e,t,n){return new Promise((i,r)=>{var o;let a=(0,le.spawn)(e,t,{cwd:n==null?void 0:n.cwd,env:(o=n==null?void 0:n.env)!=null?o:this.buildPythonEnv()}),s="";a.stderr.on("data",l=>{s+=l.toString()}),a.on("error",l=>{r(l)}),a.on("close",l=>{l===0?i():r(new Error(s||`Process exited with code ${l}`))})})}async runPythonStreaming(e,t,n,i,r,a="docling_extract",s,o){if(this.usePythonWorker()){let c=this.getWorkerToolName(e);if(!c)throw new Error(`Python worker can only run bundled tools under '${R.default.join(this.getPluginDir(),"tools")}'.`);await this.runPythonStreamingViaWorkerApi(c,t,n,i,r,a,this.settings.autoStartRedis,s,o);return}let l=this.getLocalPythonInvocation(e,t);return new Promise((c,d)=>{let p=(0,le.spawn)(l.command,l.args,{cwd:l.cwd,env:l.env});s&&s(p);let u="",g="",y="",x=null,k=!1,h=b=>{if(b.trim())try{let w=JSON.parse(b);x=w,((w==null?void 0:w.type)==="final"||w!=null&&w.answer)&&(k=!0),n(w)}catch(w){y+=`${b}
`}};p.stdout.on("data",b=>{var P;u+=b.toString();let w=u.split(/\r?\n/);u=(P=w.pop())!=null?P:"";for(let S of w)h(S)}),p.stderr.on("data",b=>{g+=b.toString()}),p.on("error",b=>{this.handlePythonProcessError(String(b)),d(b)}),p.on("close",b=>{if(u.trim()&&h(u),!k&&x&&i(x),r&&this.appendToLogFile(r,g,a,"STDERR"),b===0)c();else{let w=g.trim()?g:y;this.handlePythonProcessError(w),d(new Error(this.summarizePythonDiagnostic(w,`Process exited with code ${b}`)))}})})}runCommandStreaming(e,t,n,i){return new Promise((r,a)=>{var c;let s=(0,le.spawn)(e,t,{cwd:n==null?void 0:n.cwd,env:(c=n==null?void 0:n.env)!=null?c:this.buildPythonEnv()}),o=d=>{d.toString().split(/\r?\n/).forEach(u=>{u.trim()&&i(u)})},l="";s.stdout.on("data",o),s.stderr.on("data",d=>{l+=d.toString(),o(d)}),s.on("error",d=>{a(d)}),s.on("close",d=>{d===0?r():a(new Error(l||`Process exited with code ${d}`))})})}async requestPythonWorkerCancel(e,t,n=2e3){let i=`${e.protocol}//${e.host}/cancel`;try{await this.requestLocalApiRaw(i,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json","X-ZRR-Request-Id":t},body:JSON.stringify({request_id:t}),timeoutMs:n}),this.logPythonWorkerTiming("cancel-request",{requestId:t,cancelUrl:i})}catch(r){this.logPythonWorkerTiming("cancel-request-error",{requestId:t,cancelUrl:i,error:String(r)})}}async runPythonStreamingViaWorkerApi(e,t,n,i,r,a="docling_extract",s=!0,o,l){let c=this.nextPythonWorkerRequestId(e),d=Date.now(),p=await this.ensurePythonWorkerContext(s),u=Date.now(),g=this.mapPythonArgsForWorker(t),y=`${this.getPythonWorkerApiBaseUrl(this.getPythonWorkerApiPortFromContext(p))}/run-stream`,x=new URL(y),k=Number.isFinite(l!=null?l:NaN)?Math.max(1,Math.trunc(Number(l))):600,h=JSON.stringify({tool:e,args:g,timeout_sec:k});return this.logPythonWorkerTiming("stream-start",{requestId:c,tool:e,argsCount:g.length,ensureContextMs:u-d,port:this.getPythonWorkerApiPortFromContext(p),timeoutSec:k}),new Promise((b,w)=>{let P="",S="",v=null,C=!1,D=null,L=!1,q=null,F=null,W=0,M=!1,G=()=>{M=!0},I=Ct.default.request({method:"POST",hostname:x.hostname,port:x.port||void 0,path:`${x.pathname}${x.search}`,headers:{Accept:"application/x-ndjson","Content-Type":"application/json","Content-Length":String(Buffer.byteLength(h)),"X-ZRR-Request-Id":c}},Z=>{var $;q=Date.now();let O=z=>{if(z.trim())try{let V=JSON.parse(z);v=V,((V==null?void 0:V.type)==="final"||V!=null&&V.answer)&&(C=!0,!L&&(V!=null&&V.timing)&&typeof V.timing=="object"&&(L=!0,this.logPythonWorkerTiming("stream-tool-timing",{requestId:c,tool:e,timing:V.timing}))),n(V)}catch(V){S+=`${z}
`}},j=z=>{var V;if(z.trim())try{let K=JSON.parse(z);if((K==null?void 0:K.type)==="stdout"){W+=1,F===null&&(F=Date.now()),O(String((V=K.line)!=null?V:""));return}if((K==null?void 0:K.type)==="done"){D=K;return}S+=`${z}
`}catch(K){S+=`${z}
`}};if((($=Z.statusCode)!=null?$:0)>=400){let z=[];Z.on("data",V=>z.push(Buffer.from(V))),Z.on("end",()=>{var K;G();let V=Buffer.concat(z).toString("utf8");this.logPythonWorkerTiming("stream-http-error",{requestId:c,tool:e,statusCode:(K=Z.statusCode)!=null?K:0,durationMs:Date.now()-d}),w(new Error(`Python worker API request failed (${Z.statusCode}): ${V||"no response body"}`))});return}Z.on("data",z=>{var K;P+=z.toString();let V=P.split(/\r?\n/);P=(K=V.pop())!=null?K:"";for(let ne of V)j(ne)}),Z.on("end",()=>{G(),P.trim()&&j(P);let z=this.asRecord(D),V=typeof(z==null?void 0:z.stderr)=="string"?z.stderr:"",K=typeof(z==null?void 0:z.error)=="string"?z.error.trim():"",ne=typeof(z==null?void 0:z.exit_code)=="number"?z.exit_code:Number.parseInt(typeof(z==null?void 0:z.exit_code)=="string"?z.exit_code:"1",10);if(!C&&v&&i(v),r&&V&&this.appendToLogFile(r,V,a,"STDERR"),this.logPythonWorkerTiming("stream-done",{requestId:c,tool:e,exitCode:Number.isFinite(ne)?ne:1,totalMs:Date.now()-d,responseOpenMs:q?q-d:null,firstStdoutMs:F?F-d:null,stdoutEvents:W,stderrBytes:V.length,doneError:K}),Number.isFinite(ne)&&ne===0){b();return}if(/^(canceled|cancelled|client_disconnected)$/i.test(K)){w(new Error(`Python worker request canceled: ${K}`));return}let pe=/^(timeout|canceled|cancelled|client_disconnected)$/i.test(K)?`${K}
${V||S}`.trim():V.trim()?V:K||S;this.handlePythonProcessError(pe),w(new Error(this.summarizePythonDiagnostic(pe,`Process exited with code ${Number.isFinite(ne)?ne:1}`)))})});o&&o({get killed(){return M},kill:Z=>M?!1:(G(),this.requestPythonWorkerCancel(x,c),I.destroy(new Error("Python worker request aborted")),!0)}),I.setTimeout((k+30)*1e3,()=>{I.destroy(new Error("Python worker streaming request timed out"))}),I.on("error",Z=>{G();let O=Z instanceof Error?Z.message:typeof Z=="string"?Z:"";this.logPythonWorkerTiming("stream-request-error",{requestId:c,tool:e,durationMs:Date.now()-d,error:O}),this.handlePythonProcessError(O);let j=Z instanceof Error?Z:new Error(O||"Python worker streaming request failed");w(j)}),I.write(h),I.end()})}handlePythonProcessError(e){if(!e)return;if(/Python worker cannot access path/i.test(e)){this.notifyContainerOnce(e.replace(/^Error:\s*/i,""));return}if(/python-worker/i.test(e)&&/(No such service|is not running|not found|no container)/i.test(e)){this.notifyContainerOnce("Python worker is not running. Start Redis stack now or enable Auto-start Redis stack.");return}if(/Cannot connect to the Docker daemon|docker desktop is not running|podman machine/i.test(e)){this.notifyContainerOnce("Container runtime is not available. Start Docker Desktop or Podman.");return}if(/Python worker API request failed|Python worker streaming request timed out|ECONNREFUSED 127\.0\.0\.1/i.test(e)){this.notifyContainerOnce("Python worker API is not reachable. Start Redis stack now or check python-worker container logs.");return}let t=e.match(/ModuleNotFoundError:\s+No module named ['"]([^'"]+)['"]/);if(t){let n=this.usePythonWorker()?`Python worker missing module '${t[1]}'. Restart Redis stack to rebuild worker env.`:`Python env missing module '${t[1]}'. Open Settings > Python environment > Create/Update.`;this.notifyPythonEnvOnce(n,!0);return}if(/No module named ['"]|ImportError: No module named/i.test(e)){let n=this.usePythonWorker()?"Python worker missing required modules. Restart Redis stack to rebuild worker env.":"Python env missing required modules. Open Settings > Python environment > Create/Update.";this.notifyPythonEnvOnce(n,!0);return}if(/ENOENT|No such file or directory|not found|command not found|spawn .* ENOENT/i.test(e)){let n=this.usePythonWorker()?"Python worker command failed. Start Redis stack and check container logs.":"Python not found. Configure the Python path or use Settings > Python environment > Create/Update.";this.notifyPythonEnvOnce(n,!0)}}notifyPythonEnvOnce(e,t=!1){this.lastPythonEnvNotice!==e&&(this.lastPythonEnvNotice=e,new m.Notice(e),t&&this.openPluginSettings())}notifyContainerOnce(e){this.lastContainerNotice!==e&&(this.lastContainerNotice=e,new m.Notice(e))}notifyRedisOnce(e){this.lastRedisNotice!==e&&(this.lastRedisNotice=e,new m.Notice(e))}async autoDetectRedisOnLoad(){if(this.settings.autoStartRedis)return;let e=(this.settings.redisUrl||"").trim(),n=e||"redis://127.0.0.1:6379";(await this.checkRedisConnectionWithUrl(n,500)).ok&&(e||(this.settings.redisUrl=n,await this.saveSettings()),this.notifyRedisOnce(`Redis detected at ${n}. This instance will be used.`))}notifyZoteroApiOnce(e){this.lastZoteroApiNotice!==e&&(this.lastZoteroApiNotice=e,new m.Notice(e))}async warnIfZoteroLocalApiUnavailable(e){if(await this.isZoteroLocalApiReachable())return this.lastZoteroApiNotice=null,!0;let i=`Zotero Local API is not reachable for ${e?`${e}`:"this action"}. Start Zotero or update the Local API URL in settings.`;return this.notifyZoteroApiOnce(i),!1}openPluginSettings(){var t,n;let e=this.app;(t=e.setting)!=null&&t.open&&e.setting.open(),(n=e.setting)!=null&&n.openTabById&&e.setting.openTabById(this.manifest.id)}getLogsDirRelative(){return(0,m.normalizePath)(`${ae}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,m.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,m.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;if(!await t.exists(e)){new m.Notice("Log file not found.");return}try{let n=async()=>{try{return await t.read(e)||"(empty)"}catch(r){return"(empty)"}},i=await n();new Se(this.app,"Log file",i||"(empty)",{autoRefresh:!0,refreshIntervalMs:2e3,onRefresh:n,onClear:async()=>{await this.clearLogFile()}}).open()}catch(n){new m.Notice("Failed to open log file."),console.error(n)}}async clearLogFile(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;try{let n=(0,m.normalizePath)(R.default.dirname(e));n&&await this.ensureFolder(n),await t.write(e,""),new m.Notice("Log file cleared.")}catch(n){new m.Notice("Failed to clear log file."),console.error(n)}}async deleteLogFileIfExists(){let e=this.getLogFileRelativePath(),t=this.app.vault.adapter;try{await t.exists(e)&&await t.remove(e)}catch(n){console.warn("Failed to delete log file before import",n)}}formatLogLines(e,t,n){let i=e.split(/\r?\n/).map(a=>a.trimEnd()).filter(a=>!!a.trim());if(!i.length)return"";let r=new Date().toISOString().replace("T"," ").replace(".",",");return i.map(a=>`${r} ${n} ${t}: ${a}`).join(`
`)+`
`}async appendToLogFile(e,t,n="docling_extract",i="STDERR"){if(!t||!t.trim())return;let r=this.formatLogLines(t,n,i);if(r)try{await ee.promises.mkdir(R.default.dirname(e),{recursive:!0}),await ee.promises.appendFile(e,r)}catch(a){console.warn("Failed to append stderr to log file",a)}}async runPythonToolWithOutputViaWorkerApi(e,t,n,i,r="docling_extract",a){var w,P,S;if(!this.usePythonWorker())throw new Error("Worker API is only available in worker runtime mode.");let s=this.nextPythonWorkerRequestId(e),o=Date.now(),l=await this.ensurePythonWorkerContext(n),c=Date.now(),d=this.mapPythonArgsForWorker(t),p=`${this.getPythonWorkerApiBaseUrl(this.getPythonWorkerApiPortFromContext(l))}/run`,u=Number.isFinite(a!=null?a:NaN)?Math.max(1,Math.trunc(Number(a))):600,g=JSON.stringify({tool:e,args:d,timeout_sec:u}),y=await this.requestLocalApiRaw(p,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json","X-ZRR-Request-Id":s},body:g,timeoutMs:(u+30)*1e3});if(y.statusCode<200||y.statusCode>=300){let v=y.body.toString("utf8");throw this.logPythonWorkerTiming("run-http-error",{requestId:s,tool:e,statusCode:y.statusCode,totalMs:Date.now()-o,ensureContextMs:c-o}),new Error(`Python worker API request failed (${y.statusCode}): ${v||"no response body"}`)}let x=JSON.parse(y.body.toString("utf8")||"{}"),k=String((w=x==null?void 0:x.stdout)!=null?w:""),h=String((P=x==null?void 0:x.stderr)!=null?P:"");x!=null&&x.timing&&typeof x.timing=="object"&&this.logPythonWorkerTiming("run-tool-timing",{requestId:s,tool:e,timing:x.timing}),i&&h&&await this.appendToLogFile(i,h,r,"STDERR");let b=Number.parseInt(String((S=x==null?void 0:x.exit_code)!=null?S:1),10);if(this.logPythonWorkerTiming("run-done",{requestId:s,tool:e,exitCode:Number.isFinite(b)?b:1,totalMs:Date.now()-o,ensureContextMs:c-o,requestMs:Date.now()-c,stdoutBytes:k.length,stderrBytes:h.length,timeoutSec:u}),!Number.isFinite(b)||b!==0){let v=h.trim()?h:k;throw this.handlePythonProcessError(v),new Error(h||`Process exited with code ${Number.isFinite(b)?b:1}`)}return k.trim()}async runPythonWithOutput(e,t,n,i="docling_extract",r){if(this.usePythonWorker()){let s=this.getWorkerToolName(e);if(!s)throw new Error(`Python worker can only run bundled tools under '${R.default.join(this.getPluginDir(),"tools")}'.`);return this.runPythonToolWithOutputViaWorkerApi(s,t,this.settings.autoStartRedis,n,i,r)}let a=this.getLocalPythonInvocation(e,t);return new Promise((s,o)=>{let l=(0,le.spawn)(a.command,a.args,{cwd:a.cwd,env:a.env}),c="",d="";l.stdout.on("data",p=>{c+=p.toString()}),l.stderr.on("data",p=>{d+=p.toString()}),l.on("error",p=>{this.handlePythonProcessError(String(p)),o(p)}),l.on("close",p=>{if(n&&this.appendToLogFile(n,d,i,"STDERR"),p===0)s(c.trim());else{let u=d.trim()?d:c;this.handlePythonProcessError(u),o(new Error(this.summarizePythonDiagnostic(u,`Process exited with code ${p}`)))}})})}};

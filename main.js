"use strict";var _n=Object.create;var ze=Object.defineProperty;var gn=Object.getOwnPropertyDescriptor;var hn=Object.getOwnPropertyNames;var fn=Object.getPrototypeOf,mn=Object.prototype.hasOwnProperty;var yn=(f,_)=>{for(var e in _)ze(f,e,{get:_[e],enumerable:!0})},At=(f,_,e,t)=>{if(_&&typeof _=="object"||typeof _=="function")for(let n of hn(_))!mn.call(f,n)&&n!==e&&ze(f,n,{get:()=>_[n],enumerable:!(t=gn(_,n))||t.enumerable});return f};var fe=(f,_,e)=>(e=f!=null?_n(fn(f)):{},At(_||!f||!f.__esModule?ze(e,"default",{value:f,enumerable:!0}):e,f)),bn=f=>At(ze({},"__esModule",{value:!0}),f);var Bn={};yn(Bn,{default:()=>ot});module.exports=bn(Bn);var m=require("obsidian");var Dt=require("@codemirror/state"),ie=require("@codemirror/view"),Ot=require("obsidian");var me=/<!--\s*zrr:sync-start[^>]*-->/i,xe=/<!--\s*zrr:sync-end\s*-->/i,ge=/<!--\s*zrr:chunk\b([^>]*)-->/i,qe=/<!--\s*zrr:chunk\s+end\s*-->/i,Ee=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,Et=f=>{let _=f.trim();if(!_.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(_)){let u=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:u?u[2]:void 0}}if(/^zrr:sync-end\b/i.test(_))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(_)){let u=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),g=_.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:u?u[2]:void 0,attachmentKey:g?g[2]:void 0}}if(/^zrr:annotations-end\b/i.test(_))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(_))return{type:"chunk-end"};let e=_.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let t=e[1]||"",n=t.match(/\bid=(["']?)([^"'\s]+)\1/i),r=n?n[2]:"",i=t.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=i?null:t.match(/\(\s*(\d+)\s*\)/),s=i?Number.parseInt(i[2],10):a?Number.parseInt(a[1],10):void 0,o=r.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(t)||/\bdelete\b/i.test(t),p=/\bsection\b/i.test(t);return{type:"chunk-start",chunkId:r||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:p?"section":c?"page":"section"}},dt=f=>{var l;if(!f)return null;let _=f.match(ge);if(!_)return null;let e=_[1]||"",t=e.match(/\bid=(["']?)([^"'\s]+)\1/i),n=t?t[2].trim():void 0,r=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),i=r?null:e.match(/\(\s*(\d+)\s*\)/),a=r?Number.parseInt(r[2],10):i?Number.parseInt(i[1],10):void 0,s=n&&(l=kn(n))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:n,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},je=f=>{for(let _=1;_<=f.lines;_+=1){let e=f.line(_).text;if(me.test(e)){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i);return t?t[2].trim():null}}return null},pt=(f,_)=>{let e=_;for(;e>=1;e-=1){let t=f.line(e).text;if(ge.test(t))return{line:e,text:t};if(me.test(t)||xe.test(t))break}return null},xn=(f,_)=>{for(let e=_;e<=f.lines;e+=1){let t=f.line(e).text;if(qe.test(t))return e;if(xe.test(t))break}return null},Rt=(f,_)=>{let e=pt(f,_);if(!e)return null;let t=xn(f,e.line+1);return t===null||_<e.line||_>t?null:{startLine:e.line,endLine:t,text:e.text}},St=(f,_,e)=>{if(_>e)return!1;for(let t=_;t<=e;t+=1){let n=f.line(t).text;if(Ee.test(n))return!0}return!1},kn=f=>{var n;if(!f)return null;let e=(f.includes(":")&&(n=f.split(":").pop())!=null?n:f).match(/^p(\d+)$/i);if(!e)return null;let t=Number.parseInt(e[1],10);return Number.isFinite(t)?t:null};var Nt=f=>{if(!f)return null;let _=f.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return _?dt(_[0]):null};var wn=(f,_)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),f.type==="sync-start"||f.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(f.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),f.type==="sync-start"?e.textContent=f.docId?`Redis Index Sync start - ${f.docId}`:"Redis Index Sync start":e.textContent="Redis index sync end",e;if(f.type==="annotations-start"||f.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),f.type==="annotations-start"){let t=f.docId?` - ${f.docId}`:"";e.textContent=`Zotero annotations start${t}`}else e.textContent="Zotero annotations end";return e}if(f.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=f.chunkKind==="page"?"Page end":"Section end",f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),e;if(f.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),f.excluded&&e.classList.add("is-excluded"),f.pageNumber&&_>0)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber}/${_})`}else e.textContent=`Page ${f.pageNumber}/${_}`;else if(f.pageNumber)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber})`}else e.textContent=`Page ${f.pageNumber}`;else f.chunkId?e.textContent=`Section ${f.chunkId}`:e.textContent="Section";return f.excluded&&(e.textContent=`${e.textContent} - excluded`),e},ut=class extends ie.WidgetType{constructor(_,e,t,n,r){super(),this.plugin=_,this.docId=e,this.chunkId=t,this.startLine=n,this.excluded=r}eq(_){return this.docId===_.docId&&this.chunkId===_.chunkId&&this.startLine===_.startLine&&this.excluded===_.excluded}toDOM(){let _=document.createElement("span");_.className="zrr-chunk-toolbar",_.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},t=(c,d,p)=>{let u=document.createElement("span");u.className="zrr-chunk-button-icon",(0,Ot.setIcon)(u,d);let g=document.createElement("span");g.className="zrr-chunk-button-label",g.textContent=p,c.appendChild(u),c.appendChild(g)},n=document.createElement("button");n.type="button",n.className="zrr-chunk-button",t(n,"sparkles","Clean"),e(n,"Clean this chunk with the OCR cleanup model"),n.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),_.appendChild(n);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",t(r,"tag","Tags"),e(r,"Edit chunk tags"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),_.appendChild(r);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",t(i,"search","Indexed"),e(i,"Preview indexed chunk text"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),_.appendChild(i);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",t(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),_.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return t(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),_.appendChild(s),_}ignoreEvent(){return!0}},Lt=(f,_)=>{var y;let e=f.state.doc,t=je(e);if(!t)return ie.Decoration.none;let n=f.state.selection.main.head,r=e.lineAt(n).number,i=Rt(e,r);if(!i)return ie.Decoration.none;let a=i.text.match(ge);if(!a)return ie.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return ie.Decoration.none;let l=o[2].trim();if(!l)return ie.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=St(e,i.startLine+1,i.endLine-1),p=c||d,u=e.line(i.startLine),g=ie.Decoration.widget({widget:new ut(_,t,l,i.startLine,p),side:1});return ie.Decoration.set([g.range(u.to)])},_t=class extends ie.WidgetType{constructor(_,e){super(),this.info=_,this.totalPages=e}toDOM(){var _;return(_=wn(this.info,this.totalPages))!=null?_:document.createElement("span")}},Tt=f=>{var o,l;let _=f.dom.closest(".markdown-source-view");if(!_||!_.classList.contains("is-live-preview"))return ie.Decoration.none;let e=f.state.doc,t=new Dt.RangeSetBuilder,n=[],r=[],i=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),p=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!p)continue;let u=Et(p[1]);u&&(u.type==="chunk-start"?(u.chunkKind=(o=u.chunkKind)!=null?o:u.pageNumber?"page":"section",u.pageNumber&&(i=!0),u.chunkKind==="section"&&(a=!0)):u.type==="chunk-end"&&(u.chunkKind=(l=u.chunkKind)!=null?l:"section"),n.push({line:c,from:d.from,to:d.to,info:u}),u.pageNumber&&r.push(u.pageNumber))}if(!n.length)return ie.Decoration.none;if(i&&!a)for(let c of n)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=r.length?Math.max(...r):0;for(let c of n){let d=ie.Decoration.replace({widget:new _t(c.info,s)});t.add(c.from,c.to,d)}return t.finish()},It=()=>ie.ViewPlugin.fromClass(class{constructor(f){this.decorations=Tt(f)}update(f){(f.docChanged||f.viewportChanged)&&(this.decorations=Tt(f.view))}},{decorations:f=>f.decorations}),Ft=f=>ie.ViewPlugin.fromClass(class{constructor(_){this.decorations=Lt(_,f)}update(_){(_.docChanged||_.selectionSet||_.viewportChanged)&&(this.decorations=Lt(_.view,f))}},{decorations:_=>_.decorations});var oe=require("child_process"),Q=require("fs"),wt=fe(require("http")),dn=fe(require("https")),De=fe(require("net")),Oe=fe(require("os")),pn=fe(require("tls")),R=fe(require("path")),vt=require("url"),Ie=require("crypto");var N=require("obsidian"),zt=require("crypto"),$e=require("fs"),Ve=fe(require("path")),re=".zotero-redisearch-rag",le=`${re}/items`,te=`${re}/chunks`,qt=`${re}/metadata_snapshots.json`,jt=`${re}/annotation_snapshots.json`,vn="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",ke="cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",Re="__custom__",Mt=[{value:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",label:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1 (Fast multilingual)"},{value:"BAAI/bge-reranker-v2-m3",label:"BAAI/bge-reranker-v2-m3 (Best quality, heaviest)"},{value:"jinaai/jina-reranker-v2-base-multilingual",label:"jinaai/jina-reranker-v2-base-multilingual (Balanced multilingual)"}],Ze={pythonRuntime:"worker",pythonRuntimeMigrationV1Done:!1,showAdvancedPythonRuntimeOptions:!1,pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,firstContainerStartupNoticeShown:!1,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
`).trim(),excludeFlag:i}),r="",i=!1,a=[])};for(let l of t){let c=l.match(ge);if(c){s();let d=(o=c[1])!=null?o:"",p=d.match(/id=(["']?)([^"'\s]+)\1/i),u=p?p[2].trim():"";if(!u)continue;r=u,i=/\bexclude\b/i.test(d)||/\bdelete\b/i.test(d),a=[];continue}if(qe.test(l)){s();continue}if(r){if(Ee.test(l)){i=!0;continue}a.push(l)}}return s(),n}normalizeChunkText(e){return e.split(/\r?\n/).map(t=>t.replace(/\s+/g," ").trim()).filter((t,n,r)=>!(t===""&&r[n-1]==="")).join(`

"use strict";var cn=Object.create;var be=Object.defineProperty;var pn=Object.getOwnPropertyDescriptor;var un=Object.getOwnPropertyNames;var _n=Object.getPrototypeOf,gn=Object.prototype.hasOwnProperty;var fn=(k,m)=>{for(var e in m)be(k,e,{get:m[e],enumerable:!0})},He=(k,m,e,n)=>{if(m&&typeof m=="object"||typeof m=="function")for(let t of un(m))!gn.call(k,t)&&t!==e&&be(k,t,{get:()=>m[t],enumerable:!(n=pn(m,t))||n.enumerable});return k};var le=(k,m,e)=>(e=k!=null?cn(_n(k)):{},He(m||!k||!k.__esModule?be(e,"default",{value:k,enumerable:!0}):e,k)),mn=k=>He(be({},"__esModule",{value:!0}),k);var Rn={};fn(Rn,{default:()=>Le});module.exports=mn(Rn);var u=require("obsidian"),ee=require("@codemirror/state"),j=require("@codemirror/view"),X=require("child_process"),B=require("fs"),tn=le(require("http")),rn=le(require("https")),ge=le(require("net")),sn=le(require("os")),an=le(require("tls")),A=le(require("path")),ue=require("url"),ve=require("crypto");var N=require("obsidian"),K=".zotero-redisearch-rag",J=`${K}/items`,V=`${K}/chunks`,We={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{pdf_block}}{{docling_markdown}}",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,chatPaneLocation:"right",enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"cross-encoder/ms-marco-MiniLM-L-6-v2",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${K}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},xe=class extends N.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async _=>{this.plugin.settings.llmProviderProfiles=_,await this.plugin.saveSettings()},i=_=>{_.inputEl.type="password",_.inputEl.autocomplete="off",_.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:_=>{_.createEl("h2",{text:"Prerequisites"}),new N.Setting(_).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows).").addText(f=>f.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async v=>{this.plugin.settings.pythonPath=v.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Python environment").setDesc("Create or update the plugin's Python env (location configured below).").addButton(f=>{f.setButtonText("Create/Update").setCta(),f.onClick(async()=>{f.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{f.setDisabled(!1)}})}),new N.Setting(_).setName("Python env location").setDesc("Shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(f=>{f.addOption("shared","Shared user cache"),f.addOption("plugin","Plugin folder (.venv)"),f.setValue(this.plugin.settings.pythonEnvLocation).onChange(async v=>{v!=="shared"&&v!=="plugin"||(this.plugin.settings.pythonEnvLocation=v,await this.plugin.saveSettings())})}),new N.Setting(_).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack).").addText(f=>f.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async v=>{this.plugin.settings.dockerPath=v.trim()||"docker",await this.plugin.saveSettings()})),new N.Setting(_).setName("Redis URL").addText(f=>f.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async v=>{this.plugin.settings.redisUrl=v.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Redis data directory override").setDesc("Optional absolute path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting.").addText(f=>f.setPlaceholder("/Users/you/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async v=>{this.plugin.settings.redisDataDirOverride=v.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(f=>f.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async v=>{this.plugin.settings.redisProjectName=v.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(f=>f.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async v=>{this.plugin.settings.autoAssignRedisPort=v,await this.plugin.saveSettings()})),new N.Setting(_).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Uses a vault-specific data dir at .obsidian/zotero-redisearch-rag/redis-data unless overridden.").addToggle(f=>f.setValue(this.plugin.settings.autoStartRedis).onChange(async v=>{this.plugin.settings.autoStartRedis=v,await this.plugin.saveSettings()})),new N.Setting(_).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(f=>f.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:_=>{_.createEl("h2",{text:"Zotero Local API"}),new N.Setting(_).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(C=>C.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async P=>{this.plugin.settings.zoteroBaseUrl=P.trim(),await this.plugin.saveSettings()}));let f=new N.Setting(_).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),v=null,w=C=>{if(!v)return;let P=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(C.map(I=>I.value)).has(P)||(C=C.concat([{value:P,label:`Custom (${P})`}])),v.selectEl.options.length=0;for(let I of C)v.addOption(I.value,I.label);v.setValue(P)},S=async()=>{if(v){v.setDisabled(!0);try{let C=await this.plugin.fetchZoteroLibraryOptions();w(C)}finally{v.setDisabled(!1)}}};f.addDropdown(C=>{v=C;let P=(this.plugin.settings.zoteroUserId||"0").trim()||"0";C.addOption(P,"Loading..."),C.setValue(P),C.onChange(async D=>{this.plugin.settings.zoteroUserId=D.trim(),await this.plugin.saveSettings()})}),f.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),_.createEl("h2",{text:"Zotero Web API"}),new N.Setting(_).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(C=>C.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async P=>{this.plugin.settings.webApiBaseUrl=P.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(C=>C.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async P=>{this.plugin.settings.webApiLibraryType=P,await this.plugin.saveSettings()})),new N.Setting(_).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(C=>C.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async P=>{this.plugin.settings.webApiLibraryId=P.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(C=>{i(C),C.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async P=>{this.plugin.settings.webApiKey=P.trim(),await this.plugin.saveSettings()})}),_.createEl("h2",{text:"Output"}),new N.Setting(_).setName("PDF folder").addText(C=>C.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async P=>{this.plugin.settings.outputPdfDir=P.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Notes folder").addText(C=>C.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async P=>{this.plugin.settings.outputNoteDir=P.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(C=>{C.setValue(this.plugin.settings.frontmatterTemplate).onChange(async P=>{this.plugin.settings.frontmatterTemplate=P,await this.plugin.saveSettings()}),C.inputEl.rows=10,C.inputEl.style.width="100%"}),new N.Setting(_).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(C=>C.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async P=>{this.plugin.settings.tagSanitizeMode=P,await this.plugin.saveSettings()})),new N.Setting(_).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}} and {{docling_markdown}} placeholders.").addTextArea(C=>{C.setValue(this.plugin.settings.noteBodyTemplate).onChange(async P=>{this.plugin.settings.noteBodyTemplate=P,await this.plugin.saveSettings()}),C.inputEl.rows=8,C.inputEl.style.width="100%"}),new N.Setting(_).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(C=>C.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async P=>{this.plugin.settings.chatOutputDir=P.trim()||"zotero/chats",await this.plugin.saveSettings()})),new N.Setting(_).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(C=>C.setValue(this.plugin.settings.copyPdfToVault).onChange(async P=>{this.plugin.settings.copyPdfToVault=P,!P&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new N.Setting(_).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(C=>{let P=this.plugin.settings.copyPdfToVault;C.setValue(P?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!P).onChange(async D=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=D,await this.plugin.saveSettings()})}),new N.Setting(_).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(C=>C.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async P=>{this.plugin.settings.preferObsidianNoteForCitations=P,await this.plugin.saveSettings()}))}},{id:"ocr",label:"OCR",render:_=>{_.createEl("h2",{text:"Docling"});let f=null,v=P=>{if(!f)return;let D=this.plugin.settings.ocrEngine;new Set(P.map(z=>z.value)).has(D)||(P=P.concat([{value:D,label:`Current (unavailable): ${D}`}])),f.selectEl.options.length=0;for(let z of P)f.addOption(z.value,z.label);f.setValue(D)},w=async()=>{if(!f)return;f.setDisabled(!0);let P={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{P=await this.plugin.detectOcrEngines()}catch(z){P={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let D=[{value:"auto",label:"Auto (default)"}];P.tesseract&&D.push({value:"tesseract",label:"Tesseract (local)"}),P.paddleStructureLocal&&D.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),P.paddleVlLocal&&D.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(D.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),D.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),v(D),f.setDisabled(!1)},S=new N.Setting(_).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),C=document.createElement("a");C.href="https://aistudio.baidu.com/paddleocr",C.textContent="https://aistudio.baidu.com/paddleocr",C.target="_blank",C.rel="noopener noreferrer",S.descEl.appendChild(C),S.descEl.append("."),S.addText(P=>{i(P),P.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async D=>{this.plugin.settings.paddleApiKey=D.trim(),await this.plugin.saveSettings(),await w()})}),new N.Setting(_).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(P=>P.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async D=>{this.plugin.settings.paddleVlApiUrl=D.trim(),await this.plugin.saveSettings()})),new N.Setting(_).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(P=>P.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async D=>{this.plugin.settings.paddleStructureApiUrl=D.trim(),await this.plugin.saveSettings(),await w()})),new N.Setting(_).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(P=>{f=P,P.addOption("auto","Auto (default)"),P.setValue(this.plugin.settings.ocrEngine),P.onChange(async D=>{this.plugin.settings.ocrEngine=D,await this.plugin.saveSettings()})}),new N.Setting(_).setName("OCR mode").setDesc("auto: skip OCR when text is readable; force if bad: OCR only when text looks poor; force: always OCR.").addDropdown(P=>P.addOption("auto","auto").addOption("force_low_quality","force if quality is bad").addOption("force","force").setValue(this.plugin.settings.ocrMode).onChange(async D=>{this.plugin.settings.ocrMode=D,await this.plugin.saveSettings()})),new N.Setting(_).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(P=>{P.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async D=>{this.plugin.settings.ocrQualityThreshold=D,await this.plugin.saveSettings()})}),new N.Setting(_).setName("Chunking").setDesc("page or section").addDropdown(P=>P.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async D=>{this.plugin.settings.chunkingMode=D,await this.plugin.saveSettings()})),w()}},{id:"llms",label:"LLMs",render:_=>{_.createEl("h2",{text:"LLM Provider Profiles"});let f=_.createDiv({cls:"zrr-llm-profiles"}),v=()=>{f.empty();let h=n();h.length||f.createEl("p",{text:"No profiles yet. Add one below."});for(let x of h){let E=f.createEl("details",{cls:"zrr-profile"});h.length===1&&(E.open=!0);let U=E.createEl("summary",{text:x.name||x.id||"Profile"});U.addClass("zrr-profile-title");let ye=E.createDiv({cls:"zrr-profile-body"});new N.Setting(ye).setName("Profile name").addText(te=>te.setPlaceholder("My provider").setValue(x.name||"").onChange(async re=>{x.name=re.trim(),U.textContent=x.name||x.id||"Profile",await t(n())})),new N.Setting(ye).setName("Base URL").addText(te=>te.setPlaceholder("http://localhost:1234/v1").setValue(x.baseUrl||"").onChange(async re=>{x.baseUrl=re.trim(),await t(n())})),new N.Setting(ye).setName("API key").setDesc("Stored in settings (not encrypted).").addText(te=>{i(te),te.setPlaceholder("sk-...").setValue(x.apiKey||"").onChange(async re=>{x.apiKey=re.trim(),await t(n())})}),new N.Setting(ye).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(te=>te.setButtonText("Delete profile").onClick(async()=>{let re=n().filter(dn=>dn.id!==x.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===x.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===x.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===x.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(re),v()}))}new N.Setting(f).addButton(x=>x.setButtonText("Add profile").onClick(async()=>{let E=`profile-${Date.now().toString(36)}`,U=n().concat([{id:E,name:"Custom",baseUrl:"",apiKey:""}]);await t(U),v()}))};v(),_.createEl("h2",{text:"OCR cleanup"}),new N.Setting(_).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(h=>h.setValue(this.plugin.settings.enableLlmCleanup).onChange(async x=>{this.plugin.settings.enableLlmCleanup=x,await this.plugin.saveSettings()}));let w=null,S=null,C=null,P=async()=>{},D=async(h,x=!0)=>{let E=h.trim();this.plugin.settings.llmCleanupBaseUrl=E,x&&(this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom")),S&&S.setValue(E),await this.plugin.saveSettings()},I=async h=>{let x=n().find(E=>E.id===h);this.plugin.settings.llmCleanupProviderProfileId=h,x&&(this.plugin.settings.llmCleanupBaseUrl=x.baseUrl,this.plugin.settings.llmCleanupApiKey=x.apiKey,S==null||S.setValue(x.baseUrl),C==null||C.setValue(x.apiKey)),await this.plugin.saveSettings(),await P()};new N.Setting(_).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(h=>{w=h,h.addOption("custom","Custom (manual)");for(let E of n())h.addOption(E.id,E.name||E.id);let x=this.plugin.settings.llmCleanupProviderProfileId;h.setValue(x&&n().some(E=>E.id===x)?x:"custom"),h.onChange(async E=>{if(E==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await I(E)})}),new N.Setting(_).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(h=>{S=h,h.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async x=>{await D(x)})}),new N.Setting(_).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(h=>{C=h,i(h),h.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async x=>{this.plugin.settings.llmCleanupApiKey=x.trim(),this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom"),await this.plugin.saveSettings()})});let z=new N.Setting(_).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),R=null,F=h=>{if(!R)return;let x=(this.plugin.settings.llmCleanupModel||"").trim(),E=new Set(h.map(U=>U.value));x&&!E.has(x)&&(h=h.concat([{value:x,label:`Custom (${x})`}])),R.selectEl.options.length=0;for(let U of h)R.addOption(U.value,U.label);x&&R.setValue(x)};P=async()=>{if(R){R.setDisabled(!0);try{let h=await this.plugin.fetchCleanupModelOptions();F(h)}finally{R.setDisabled(!1)}}},z.addDropdown(h=>{R=h;let x=(this.plugin.settings.llmCleanupModel||"").trim();h.addOption(x||"loading","Loading..."),h.setValue(x||"loading"),h.onChange(async E=>{this.plugin.settings.llmCleanupModel=E.trim(),await this.plugin.saveSettings()})}),z.addButton(h=>{h.setButtonText("Refresh").onClick(async()=>{await P()})}),P(),new N.Setting(_).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(h=>h.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async x=>{let E=Number.parseFloat(x);this.plugin.settings.llmCleanupTemperature=Number.isFinite(E)?E:0,await this.plugin.saveSettings()})),new N.Setting(_).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(h=>h.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async x=>{this.plugin.settings.llmCleanupMinQuality=x,await this.plugin.saveSettings()})),new N.Setting(_).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(h=>h.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(E)?E:2e3,await this.plugin.saveSettings()})),_.createEl("h2",{text:"Text Embedding"});let O=null,$=null,H=null,T=async()=>{},q=async(h,x=!0)=>{let E=h.trim();this.plugin.settings.embedBaseUrl=E,x&&(this.plugin.settings.embedProviderProfileId="",O&&O.setValue("custom")),$&&$.setValue(E),await this.plugin.saveSettings()},Z=async h=>{let x=n().find(E=>E.id===h);this.plugin.settings.embedProviderProfileId=h,x&&(this.plugin.settings.embedBaseUrl=x.baseUrl,this.plugin.settings.embedApiKey=x.apiKey,$==null||$.setValue(x.baseUrl),H==null||H.setValue(x.apiKey)),await this.plugin.saveSettings(),await T()};new N.Setting(_).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(h=>{O=h,h.addOption("custom","Custom (manual)");for(let E of n())h.addOption(E.id,E.name||E.id);let x=this.plugin.settings.embedProviderProfileId;h.setValue(x&&n().some(E=>E.id===x)?x:"custom"),h.onChange(async E=>{if(E==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await Z(E)})}),new N.Setting(_).setName("Embeddings base URL").addText(h=>{$=h,h.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async x=>{await q(x)})}),new N.Setting(_).setName("Embeddings API key").addText(h=>{H=h,i(h),h.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async x=>{this.plugin.settings.embedApiKey=x.trim(),this.plugin.settings.embedProviderProfileId="",O&&O.setValue("custom"),await this.plugin.saveSettings()})});let W=new N.Setting(_).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),Y=null,Ee=h=>{if(!Y)return;let x=(this.plugin.settings.embedModel||"").trim(),E=new Set(h.map(U=>U.value));x&&!E.has(x)&&(h=h.concat([{value:x,label:`Custom (${x})`}])),Y.selectEl.options.length=0;for(let U of h)Y.addOption(U.value,U.label);x&&Y.setValue(x)};T=async()=>{if(Y){Y.setDisabled(!0);try{let h=await this.plugin.fetchEmbeddingModelOptions();Ee(h)}finally{Y.setDisabled(!1)}}},W.addDropdown(h=>{Y=h;let x=(this.plugin.settings.embedModel||"").trim();h.addOption(x||"loading","Loading..."),h.setValue(x||"loading"),h.onChange(async E=>{this.plugin.settings.embedModel=E.trim(),await this.plugin.saveSettings()})}),W.addButton(h=>{h.setButtonText("Refresh").onClick(async()=>{await T()})}),T(),new N.Setting(_).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(h=>h.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async x=>{this.plugin.settings.embedIncludeMetadata=x,await this.plugin.saveSettings()})),new N.Setting(_).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(h=>h.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.embedContextWindow=Number.isFinite(E)?Math.max(0,E):1,await this.plugin.saveSettings()})),new N.Setting(_).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(h=>h.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.embedContextChars=Number.isFinite(E)?Math.max(0,E):220,await this.plugin.saveSettings()})),new N.Setting(_).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(h=>h.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(E)?Math.max(0,E):3500,await this.plugin.saveSettings()})),new N.Setting(_).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(h=>h.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(E)?Math.max(0,E):200,await this.plugin.saveSettings()})),new N.Setting(_).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(h=>h.setValue(this.plugin.settings.enableChunkTagging).onChange(async x=>{this.plugin.settings.enableChunkTagging=x,await this.plugin.saveSettings()})),_.createEl("h2",{text:"Chat LLM"});let ie=null,ne=null,se=null,ae=async()=>{},he=async(h,x=!0)=>{let E=h.trim();this.plugin.settings.chatBaseUrl=E,x&&(this.plugin.settings.chatProviderProfileId="",ie&&ie.setValue("custom")),ne&&ne.setValue(E),await this.plugin.saveSettings()},Ae=async h=>{let x=n().find(E=>E.id===h);this.plugin.settings.chatProviderProfileId=h,x&&(this.plugin.settings.chatBaseUrl=x.baseUrl,this.plugin.settings.chatApiKey=x.apiKey,ne==null||ne.setValue(x.baseUrl),se==null||se.setValue(x.apiKey)),await this.plugin.saveSettings(),await ae()};new N.Setting(_).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(h=>{ie=h,h.addOption("custom","Custom (manual)");for(let E of n())h.addOption(E.id,E.name||E.id);let x=this.plugin.settings.chatProviderProfileId;h.setValue(x&&n().some(E=>E.id===x)?x:"custom"),h.onChange(async E=>{if(E==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await Ae(E)})}),new N.Setting(_).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(h=>{ne=h,h.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async x=>{await he(x)})}),new N.Setting(_).setName("Chat API key").addText(h=>{se=h,i(h),h.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async x=>{this.plugin.settings.chatApiKey=x.trim(),this.plugin.settings.chatProviderProfileId="",ie&&ie.setValue("custom"),await this.plugin.saveSettings()})});let oe=new N.Setting(_).setName("Chat model").setDesc("Select a chat-capable model from the provider."),Q=null,M=h=>{if(!Q)return;let x=(this.plugin.settings.chatModel||"").trim(),E=new Set(h.map(U=>U.value));x&&!E.has(x)&&(h=h.concat([{value:x,label:`Custom (${x})`}])),Q.selectEl.options.length=0;for(let U of h)Q.addOption(U.value,U.label);x&&Q.setValue(x)};ae=async()=>{if(Q){Q.setDisabled(!0);try{let h=await this.plugin.fetchChatModelOptions();M(h)}finally{Q.setDisabled(!1)}}},oe.addDropdown(h=>{Q=h;let x=(this.plugin.settings.chatModel||"").trim();h.addOption(x||"loading","Loading..."),h.setValue(x||"loading"),h.onChange(async E=>{this.plugin.settings.chatModel=E.trim(),await this.plugin.saveSettings()})}),oe.addButton(h=>{h.setButtonText("Refresh").onClick(async()=>{await ae()})}),ae(),new N.Setting(_).setName("Temperature").addText(h=>h.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async x=>{let E=Number.parseFloat(x);this.plugin.settings.chatTemperature=Number.isFinite(E)?E:.2,await this.plugin.saveSettings()})),new N.Setting(_).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(h=>h.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(E)?Math.max(0,E):6,await this.plugin.saveSettings()})),new N.Setting(_).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(h=>h.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async x=>{this.plugin.settings.chatPaneLocation=x,await this.plugin.saveSettings()})),_.createEl("h2",{text:"Retrieval"}),new N.Setting(_).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(h=>h.setValue(this.plugin.settings.enableQueryExpansion).onChange(async x=>{this.plugin.settings.enableQueryExpansion=x,await this.plugin.saveSettings()})),new N.Setting(_).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(h=>h.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.queryExpansionCount=Number.isFinite(E)?Math.max(1,E):3,await this.plugin.saveSettings()})),new N.Setting(_).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(h=>h.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async x=>{this.plugin.settings.enableCrossEncoderRerank=x,await this.plugin.saveSettings()})),new N.Setting(_).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(h=>h.setPlaceholder("cross-encoder/ms-marco-MiniLM-L-6-v2").setValue(this.plugin.settings.rerankModel).onChange(async x=>{this.plugin.settings.rerankModel=x.trim()||"cross-encoder/ms-marco-MiniLM-L-6-v2",await this.plugin.saveSettings()})),new N.Setting(_).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(h=>h.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(E)?Math.max(1,E):4,await this.plugin.saveSettings()})),new N.Setting(_).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(h=>h.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.rrfK=Number.isFinite(E)?Math.max(1,E):60,await this.plugin.saveSettings()})),new N.Setting(_).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(h=>h.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.rrfLogTop=Number.isFinite(E)?Math.max(0,E):0,await this.plugin.saveSettings()})),new N.Setting(_).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(h=>h.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async x=>{let E=Number.parseInt(x,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(E)?Math.max(0,E):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:_=>{_.createEl("h2",{text:"Logging"}),new N.Setting(_).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(f=>f.setValue(this.plugin.settings.enableFileLogging).onChange(async v=>{this.plugin.settings.enableFileLogging=v,await this.plugin.saveSettings()})),new N.Setting(_).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(f=>f.setPlaceholder(`${K}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async v=>{this.plugin.settings.logFilePath=v.trim()||`${K}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new N.Setting(_).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(f=>f.setButtonText("Open log").onClick(async()=>{var v,w;await((w=(v=this.plugin).openLogFile)==null?void 0:w.call(v))})).addButton(f=>f.setButtonText("Clear log").onClick(async()=>{var v,w;await((w=(v=this.plugin).clearLogFile)==null?void 0:w.call(v))})),_.createEl("h2",{text:"Maintenance"}),new N.Setting(_).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(f=>f.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new N.Setting(_).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(f=>f.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(f=>f.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],c=new Map,p=new Map,g=_=>{this.activeTab=_;for(let[f,v]of c){let w=f===_;v.classList.toggle("is-active",w),v.setAttribute("aria-selected",w?"true":"false"),v.setAttribute("tabindex",w?"0":"-1")}for(let[f,v]of p){let w=f===_;v.classList.toggle("is-active",w),v.hidden=!w}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let b=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let _ of d){let f=y.createEl("button",{text:_.label,cls:"zrr-settings-tab-button"}),v=`zrr-settings-tab-${_.id}`,w=`zrr-settings-panel-${_.id}`;f.type="button",f.id=v,f.setAttribute("role","tab"),f.setAttribute("aria-controls",w),f.setAttribute("aria-selected","false"),f.addEventListener("click",()=>g(_.id));let S=b.createDiv({cls:"zrr-settings-tab-panel"});S.id=w,S.setAttribute("role","tabpanel"),S.setAttribute("aria-labelledby",v),S.hidden=!0,_.render(S),c.set(_.id,f),p.set(_.id,S)}let L=d.some(_=>_.id===this.activeTab)?this.activeTab:d[0].id;g(L)}};var ke={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var Ke={"docling_extract.py":`#!/usr/bin/env python3
# zotero-redisearch-rag tool version: 0.4.4
import argparse
import atexit
import base64
import errno
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.4.4
aai
aam
abb
abge
...
\xF6pnv
\xFCberarb
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.4.4
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.4.4
services:
  redis-stack:
...
`,"redis-stack.conf":`# zotero-redisearch-rag tool version: 0.4.4
# Redis Stack persistence config for local RAG index
appendonly yes
appendfsync everysec

dir /data
`};var G=require("obsidian"),de="zotero-redisearch-rag-chat",_e=class extends G.ItemView{constructor(e,n){super(e);this.messages=[];this.activeSessionId="default";this.messageEls=new Map;this.pendingRender=new Map;this.busy=!1;this.plugin=n}getViewType(){return de}getDisplayText(){return"Zotero RAG Chat"}getIcon(){return"zrr-chat"}async onOpen(){let{containerEl:e}=this;e.empty(),e.addClass("zrr-chat-view");let n=e.createEl("div",{cls:"zrr-chat-header"});n.createEl("div",{cls:"zrr-chat-title",text:"Zotero RAG Chat"});let t=n.createEl("div",{cls:"zrr-chat-controls"}),i=t.createEl("div",{cls:"zrr-chat-controls-row"});this.sessionSelect=i.createEl("select",{cls:"zrr-chat-session"}),this.sessionSelect.addEventListener("change",async()=>{await this.switchSession(this.sessionSelect.value)});let r=t.createEl("div",{cls:"zrr-chat-controls-row zrr-chat-controls-actions"});this.renameButton=r.createEl("button",{cls:"zrr-chat-rename",text:"Rename",attr:{title:"Rename the current chat"}}),this.renameButton.addEventListener("click",async()=>{await this.promptRenameSession()}),this.copyButton=r.createEl("button",{cls:"zrr-chat-copy",text:"Copy",attr:{title:"Copy this chat to a new note"}}),this.copyButton.addEventListener("click",async()=>{await this.copyChatToNote()}),this.deleteButton=r.createEl("button",{cls:"zrr-chat-delete",text:"Delete",attr:{title:"Delete this chat"}}),this.deleteButton.addEventListener("click",async()=>{await this.deleteChat()}),this.newButton=r.createEl("button",{cls:"zrr-chat-new",text:"New chat",attr:{title:"Start a new chat session"}}),this.newButton.addEventListener("click",async()=>{await this.startNewChat()}),this.messagesEl=e.createEl("div",{cls:"zrr-chat-messages"});let a=e.createEl("div",{cls:"zrr-chat-input"});this.inputEl=a.createEl("textarea",{cls:"zrr-chat-textarea",attr:{placeholder:"Ask your Zotero library..."}}),this.sendButton=a.createEl("button",{cls:"zrr-chat-send",text:"Send"}),this.sendButton.addEventListener("click",()=>this.handleSend()),this.inputEl.addEventListener("keydown",s=>{s.key==="Enter"&&!s.shiftKey&&(s.preventDefault(),this.handleSend())}),await this.loadSessions(),await this.loadHistory(),await this.renderAll()}focusInput(){var e;(e=this.inputEl)==null||e.focus()}async loadHistory(){try{this.messages=await this.plugin.loadChatHistoryForSession(this.activeSessionId)}catch(e){console.error(e),this.messages=[]}}async saveHistory(){try{await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages),await this.loadSessions()}catch(e){console.error(e)}}async loadSessions(){let e=await this.plugin.listChatSessions();this.activeSessionId=await this.plugin.getActiveChatSessionId(),this.sessionSelect.empty();for(let n of e){let t=this.sessionSelect.createEl("option",{text:n.name});t.value=n.id,n.id===this.activeSessionId&&(t.selected=!0)}!e.some(n=>n.id===this.activeSessionId)&&e.length>0&&(this.activeSessionId=e[0].id,await this.plugin.setActiveChatSessionId(this.activeSessionId),this.sessionSelect.value=this.activeSessionId)}async promptRenameSession(){var i;let n=(await this.plugin.listChatSessions()).find(r=>r.id===this.activeSessionId);new Se(this.app,(i=n==null?void 0:n.name)!=null?i:"New chat",async r=>{await this.plugin.renameChatSession(this.activeSessionId,r),await this.loadSessions()}).open()}async startNewChat(){await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages,{force:!0});let e=await this.plugin.createChatSession("New chat");await this.switchSession(e,{skipSave:!0})}async deleteChat(){let e=await this.plugin.listChatSessions();if(e.length<=1){new G.Notice("You must keep at least one chat.");return}let n=e.find(i=>i.id===this.activeSessionId);if(!n)return;new Ne(this.app,n.name,async()=>{await this.plugin.deleteChatSession(this.activeSessionId);let i=await this.plugin.getActiveChatSessionId();await this.switchSession(i,{skipSave:!0})}).open()}async switchSession(e,n={}){!e||e===this.activeSessionId||(n.skipSave||await this.saveHistory(),this.activeSessionId=e,await this.plugin.setActiveChatSessionId(e),await this.loadSessions(),await this.loadHistory(),await this.renderAll())}async renderAll(){this.messagesEl.empty(),this.messageEls.clear();for(let e of this.messages)await this.renderMessage(e);this.scrollToBottom()}async renderMessage(e){let n=this.messagesEl.createEl("div",{cls:`zrr-chat-message zrr-chat-${e.role}`}),t=n.createEl("div",{cls:"zrr-chat-meta-row"});t.createEl("div",{cls:"zrr-chat-meta"}).setText(e.role==="user"?"You":"Zotero Assistant");let r=t.createEl("div",{cls:"zrr-chat-message-actions"}),a=r.createEl("button",{cls:"zrr-chat-message-copy zrr-chat-icon-button",attr:{title:"Copy this message","aria-label":"Copy this message"}});(0,G.setIcon)(a,"copy"),a.addEventListener("click",async d=>{d.preventDefault(),d.stopPropagation(),await this.copyMessage(e)});let s=r.createEl("button",{cls:"zrr-chat-message-delete zrr-chat-icon-button",attr:{title:"Delete this message","aria-label":"Delete this message"}});(0,G.setIcon)(s,"trash-2"),s.addEventListener("click",async d=>{d.preventDefault(),d.stopPropagation(),await this.deleteMessage(e.id)});let o=n.createEl("div",{cls:"zrr-chat-content"}),l=n.createEl("div",{cls:"zrr-chat-citations"});this.messageEls.set(e.id,{wrapper:n,content:o,citations:l}),await this.renderMessageContent(e)}async copyMessage(e){var i,r,a;let t=(await this.plugin.formatInlineCitations(e.content||"",(i=e.citations)!=null?i:[],(r=e.retrieved)!=null?r:[])||"").trim();if(!t){new G.Notice("Nothing to copy.");return}if(!((a=navigator.clipboard)!=null&&a.writeText)){new G.Notice("Clipboard API unavailable. Select text to copy.");return}try{await navigator.clipboard.writeText(t),new G.Notice("Message copied to clipboard.")}catch(s){console.error("Failed to copy message",s),new G.Notice("Failed to copy message.")}}async deleteMessage(e){let n=this.messages.findIndex(a=>a.id===e);if(n===-1||!window.confirm("Delete this message? This cannot be undone."))return;this.messages.splice(n,1);let i=this.messageEls.get(e);i&&i.wrapper.remove(),this.messageEls.delete(e);let r=this.pendingRender.get(e);r!==void 0&&(window.clearTimeout(r),this.pendingRender.delete(e)),await this.saveHistory()}scheduleRender(e){if(this.pendingRender.has(e.id))return;let n=window.setTimeout(async()=>{this.pendingRender.delete(e.id),await this.renderMessageContent(e),this.scrollToBottom()},80);this.pendingRender.set(e.id,n)}async renderMessageContent(e){var i,r,a;let n=this.messageEls.get(e.id);if(!n)return;let t=await this.plugin.formatInlineCitations(e.content||"",(i=e.citations)!=null?i:[],(r=e.retrieved)!=null?r:[]);n.content.dataset.lastRendered!==t&&(n.content.empty(),await G.MarkdownRenderer.renderMarkdown(t,n.content,"",this.plugin),this.hookInternalLinks(n.content),n.content.dataset.lastRendered=t),n.citations.empty(),await this.renderCitations(n.citations,(a=e.citations)!=null?a:[])}hookInternalLinks(e){let n=e.querySelectorAll("a.internal-link");for(let t of Array.from(n))t.dataset.zrrBound!=="1"&&(t.dataset.zrrBound="1",this.registerDomEvent(t,"click",i=>{i.preventDefault();let r=t.getAttribute("data-href")||t.getAttribute("href")||"";r&&this.plugin.openInternalLinkInMain(r)}))}async renderCitations(e,n){if(e.empty(),!n.length)return;let t=e.createEl("details",{cls:"zrr-chat-citations-details"});t.createEl("summary",{text:`Relevant context sources (${n.length})`,cls:"zrr-chat-citations-summary"});let i=t.createEl("ul",{cls:"zrr-chat-citation-list"});for(let r of n){let a=await this.plugin.resolveCitationDisplay(r),s=i.createEl("li"),o=`${a.noteTitle} p. ${a.pageLabel}`;s.createEl("a",{text:o,href:"#"}).addEventListener("click",d=>{d.preventDefault(),this.plugin.openCitationTarget(r,a)})}}async copyChatToNote(){var i;let n=(await this.plugin.listChatSessions()).find(r=>r.id===this.activeSessionId),t=(i=n==null?void 0:n.name)!=null?i:"New chat";await this.plugin.createChatNoteFromSession(this.activeSessionId,t,this.messages)}scrollToBottom(){this.messagesEl.scrollTop=this.messagesEl.scrollHeight}async handleSend(){if(this.busy)return;let e=this.inputEl.value.trim();if(!e){new G.Notice("Query cannot be empty.");return}if(!this.plugin.settings.chatBaseUrl){new G.Notice("Chat base URL must be set in settings.");return}this.inputEl.value="",this.busy=!0,this.sendButton.disabled=!0;let n={id:this.generateId(),role:"user",content:e,createdAt:new Date().toISOString()};this.messages.push(n),await this.renderMessage(n),this.scrollToBottom(),await this.saveHistory();let t={id:this.generateId(),role:"assistant",content:"",citations:[],createdAt:new Date().toISOString()};this.messages.push(t),await this.renderMessage(t),this.scrollToBottom();let i=!1,r=this.plugin.getRecentChatHistory(this.messages.slice(0,-2));try{await this.plugin.runRagQueryStreaming(e,a=>{i=!0,t.content+=a,this.scheduleRender(t)},a=>{(!i&&(a!=null&&a.answer)||a!=null&&a.answer)&&(t.content=a.answer),Array.isArray(a==null?void 0:a.citations)&&(t.citations=a.citations),Array.isArray(a==null?void 0:a.retrieved)&&(t.retrieved=a.retrieved),this.scheduleRender(t)},r)}catch(a){console.error(a),t.content="Failed to fetch answer. See console for details.",this.scheduleRender(t)}finally{this.busy=!1,this.sendButton.disabled=!1,await this.saveHistory()}}generateId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}},Se=class extends G.Modal{constructor(m,e,n){super(m),this.initialValue=e,this.onSubmit=n}onOpen(){let{contentEl:m}=this;m.empty(),m.addClass("zrr-chat-rename-modal"),m.createEl("h3",{text:"Rename chat"});let e=this.initialValue;new G.Setting(m).setName("Name").addText(r=>{r.setValue(e),r.onChange(a=>{e=a})});let n=m.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="1rem",n.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),n.createEl("button",{text:"Save"}).addEventListener("click",()=>{let r=e.trim();if(!r){new G.Notice("Name cannot be empty.");return}this.close(),this.onSubmit(r)})}},Ne=class extends G.Modal{constructor(m,e,n){super(m),this.chatName=e,this.onConfirm=n}onOpen(){let{contentEl:m}=this;m.empty(),m.createEl("h3",{text:"Delete chat"}),m.createEl("p",{text:`Delete "${this.chatName}"? This cannot be undone.`});let e=m.createEl("div");e.style.display="flex",e.style.gap="0.5rem",e.style.marginTop="1rem",e.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),e.createEl("button",{text:"Delete"}).addEventListener("click",()=>{this.close(),this.onConfirm()})}};var Je=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],Xe={en:"eng",de:"deu",fr:"fra",es:"spa",it:"ita",nl:"nld",pt:"por",pl:"pol",sv:"swe"},hn=ke["zrr-picker"],yn=ke["zrr-chat"],Re=ke["zrr-pdf"],Ye=80,ce=/<!--\s*zrr:sync-start[^>]*-->/i,fe=/<!--\s*zrr:sync-end\s*-->/i,pe=/<!--\s*zrr:chunk\b([^>]*)-->/i,De=/<!--\s*zrr:chunk\s+end\s*-->/i,we=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,bn=k=>{let m=k.trim();if(!m.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(m)){let c=m.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:c?c[2]:void 0}}if(/^zrr:sync-end\b/i.test(m))return{type:"sync-end"};if(/^zrr:chunk\s+end\b/i.test(m))return{type:"chunk-end"};let e=m.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let n=e[1]||"",t=n.match(/\bid=(["']?)([^"'\s]+)\1/i),i=t?t[2]:"",r=n.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?Number.parseInt(r[2],10):void 0,s=i.match(/^p(\d+)$/i),o=s?Number.parseInt(s[1],10):void 0,l=Number.isFinite(a!=null?a:NaN)?a:o,d=/\bexclude\b/i.test(n)||/\bdelete\b/i.test(n);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(l!=null?l:NaN)?l:void 0,chunkKind:l?"page":"section"}},Ue=k=>{var o;if(!k)return null;let m=k.match(pe);if(!m)return null;let e=m[1]||"",n=e.match(/\bid=(["']?)([^"'\s]+)\1/i),t=n?n[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?Number.parseInt(i[2],10):void 0,a=t&&(o=Cn(t))!=null?o:void 0,s=Number.isFinite(r!=null?r:NaN)?r:a;return{chunkId:t,pageNumber:Number.isFinite(s!=null?s:NaN)?Number(s):void 0}},xn=(k,m)=>{let e=document.createElement("div");return e.classList.add("zrr-sync-badge"),k.type==="sync-start"||k.type==="sync-end"?(e.classList.add("zrr-sync-badge--sync"),e.classList.add(k.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),k.type==="sync-start"?e.textContent=k.docId?`Redis Index Sync start \u2022 ${k.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e):k.type==="chunk-end"?(e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=k.chunkKind==="page"?"Page end":"Section end",k.chunkKind&&e.classList.add(`zrr-sync-badge--${k.chunkKind}`),e):k.type!=="chunk-start"?null:(e.classList.add("zrr-sync-badge--chunk"),k.chunkKind&&e.classList.add(`zrr-sync-badge--${k.chunkKind}`),k.excluded&&e.classList.add("is-excluded"),k.pageNumber&&m>0?e.textContent=`Page ${k.pageNumber}/${m}`:k.pageNumber?e.textContent=`Page ${k.pageNumber}`:k.chunkId?e.textContent=`Section ${k.chunkId}`:e.textContent="Section",k.excluded&&(e.textContent=`${e.textContent} \u2022 excluded`),e)},Pe=class extends u.Modal{constructor(m,e,n,t,i="Value cannot be empty."){super(m),this.titleText=e,this.placeholder=n,this.onSubmit=t,this.emptyMessage=i}onOpen(){let{contentEl:m}=this;m.empty(),m.createEl("h3",{text:this.titleText});let e=m.createEl("input",{type:"text",placeholder:this.placeholder});e.style.width="100%",e.focus();let n=m.createEl("button",{text:"Submit"});n.style.marginTop="0.75rem";let t=()=>{let i=e.value.trim();if(!i){new u.Notice(this.emptyMessage);return}this.close(),this.onSubmit(i)};n.addEventListener("click",t),e.addEventListener("keydown",i=>{i.key==="Enter"&&t()})}},Te=class extends u.Modal{constructor(m,e,n,t,i){super(m),this.chunkId=e,this.initialTags=n,this.onSubmit=t,this.onRegenerate=i}onOpen(){let{contentEl:m}=this;m.empty(),m.createEl("h3",{text:`Edit tags for ${this.chunkId}`});let e=m.createEl("textarea",{attr:{rows:"3"}});e.style.width="100%",e.placeholder="tag1, tag2, tag3",e.value=this.initialTags.join(", "),e.focus();let n=m.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Save tags"}),i=async()=>{let a=(e.value||"").split(/[,;\n]+/).map(o=>o.trim()).filter(o=>o.length>0),s=Array.from(new Set(a));this.close(),await Promise.resolve(this.onSubmit(s))};if(this.onRegenerate){let r=n.createEl("button",{text:"Regenerate"});r.addEventListener("click",async()=>{var a;r.setAttribute("disabled","true"),t.setAttribute("disabled","true");try{let s=await((a=this.onRegenerate)==null?void 0:a.call(this));s&&s.length>0?(e.value=s.join(", "),await Promise.resolve(this.onSubmit(s))):s&&new u.Notice("No tags were generated.")}finally{r.removeAttribute("disabled"),t.removeAttribute("disabled")}})}t.addEventListener("click",i),e.addEventListener("keydown",r=>{r.key==="Enter"&&(r.metaKey||r.ctrlKey)&&i()})}},Oe=class extends u.Modal{constructor(m,e,n,t=""){super(m),this.titleText=e,this.content=n,this.noteText=t}onOpen(){let{contentEl:m}=this;if(m.empty(),m.createEl("h3",{text:this.titleText}),this.noteText){let n=m.createEl("div",{text:this.noteText});n.className="zrr-indexed-note"}let e=m.createEl("textarea",{attr:{rows:"12",readonly:"true"}});e.style.width="100%",e.value=this.content}},kn=k=>k.includes("STDERR")?"zrr-log-stderr":k.includes("ERROR")?"zrr-log-error":k.includes("WARNING")||k.includes("WARN")?"zrr-log-warning":k.includes("INFO")?"zrr-log-info":null,Qe=k=>{let m=new ee.RangeSetBuilder;for(let{from:e,to:n}of k.visibleRanges){let t=e;for(;t<=n;){let i=k.state.doc.lineAt(t),r=kn(i.text);r&&m.add(i.from,i.from,j.Decoration.line({class:r})),t=i.to+1}}return m.finish()},on=j.EditorView.theme({".cm-editor":{height:"100%",display:"flex",flexDirection:"column",minHeight:"0"},".cm-scroller":{fontFamily:"var(--font-monospace)",fontSize:"0.85rem",flex:"1",height:"100%",maxHeight:"100%",overflow:"auto"},".zrr-log-error":{color:"var(--text-error)"},".zrr-log-warning":{color:"var(--text-accent)"},".zrr-log-info":{color:"var(--text-muted)"},".zrr-log-stderr":{color:"var(--text-accent)"}}),Ce=k=>{for(let m=1;m<=k.lines;m+=1){let e=k.line(m).text;if(ce.test(e)){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return n?n[2].trim():null}}return null},Ze=(k,m)=>{let e=m;for(;e>=1;e-=1){let n=k.line(e).text;if(pe.test(n))return{line:e,text:n};if(ce.test(n)||fe.test(n))break}return null},vn=(k,m)=>{for(let e=m;e<=k.lines;e+=1){let n=k.line(e).text;if(De.test(n))return e;if(fe.test(n))break}return null},wn=(k,m)=>{let e=Ze(k,m);if(!e)return null;let n=vn(k,e.line+1);return n===null||m<e.line||m>n?null:{startLine:e.line,endLine:n,text:e.text}},Pn=(k,m,e)=>{if(m>e)return!1;for(let n=m;n<=e;n+=1){let t=k.line(n).text;if(we.test(t))return!0}return!1},Cn=k=>{var t;if(!k)return null;let e=(k.includes(":")&&(t=k.split(":").pop())!=null?t:k).match(/^p(\d+)$/i);if(!e)return null;let n=Number.parseInt(e[1],10);return Number.isFinite(n)?n:null};var Ln=k=>{if(!k)return null;let m=k.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return m?Ue(m[0]):null},En=k=>{let m=k.scrollDOM.getBoundingClientRect(),e=k.posAtCoords({x:m.left+8,y:m.top+4});return e===null?null:k.state.doc.lineAt(e).number},Ie=class extends j.WidgetType{constructor(m,e,n,t,i){super(),this.plugin=m,this.docId=e,this.chunkId=n,this.startLine=t,this.excluded=i}eq(m){return this.docId===m.docId&&this.chunkId===m.chunkId&&this.startLine===m.startLine&&this.excluded===m.excluded}toDOM(){let m=document.createElement("span");m.className="zrr-chunk-toolbar",m.setAttribute("data-chunk-id",this.chunkId);let e=(d,c)=>{d.setAttribute("title",c),d.setAttribute("aria-label",c),d.setAttribute("data-tooltip-position","top")},n=(d,c,p)=>{let g=document.createElement("span");g.className="zrr-chunk-button-icon",(0,u.setIcon)(g,c);let y=document.createElement("span");y.className="zrr-chunk-button-label",y.textContent=p,d.appendChild(g),d.appendChild(y)},t=document.createElement("button");t.type="button",t.className="zrr-chunk-button",n(t,"sparkles","Clean"),e(t,"Clean this chunk with the OCR cleanup model"),t.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),m.appendChild(t);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",n(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),m.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",n(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),m.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",n(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),m.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return n(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),m.appendChild(s),m}ignoreEvent(){return!0}},en=(k,m)=>{var b;let e=k.state.doc,n=Ce(e);if(!n)return j.Decoration.none;let t=k.state.selection.main.head,i=e.lineAt(t).number,r=wn(e,i);if(!r)return j.Decoration.none;let a=r.text.match(pe);if(!a)return j.Decoration.none;let s=((b=a[1])!=null?b:"").trim(),o=s.match(/id=([\"']?)([^\"'\s]+)\1/i);if(!o)return j.Decoration.none;let l=o[2].trim();if(!l)return j.Decoration.none;let d=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),c=Pn(e,r.startLine+1,r.endLine-1),p=d||c,g=e.line(r.startLine),y=j.Decoration.widget({widget:new Ie(m,n,l,r.startLine,p),side:1});return j.Decoration.set([y.range(g.to)])},Fe=class extends j.WidgetType{constructor(m,e){super(),this.info=m,this.totalPages=e}toDOM(){var m;return(m=xn(this.info,this.totalPages))!=null?m:document.createElement("span")}},nn=k=>{var s,o;let m=k.dom.closest(".markdown-source-view");if(!m||!m.classList.contains("is-live-preview"))return j.Decoration.none;let e=k.state.doc,n=new ee.RangeSetBuilder,t=[],i=[],r=!1;for(let l=1;l<=e.lines;l+=1){let d=e.line(l),c=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!c)continue;let p=bn(c[1]);p&&(p.type==="chunk-start"?(p.chunkKind=(s=p.chunkKind)!=null?s:p.pageNumber?"page":"section",p.pageNumber&&(r=!0)):p.type==="chunk-end"&&(p.chunkKind=(o=p.chunkKind)!=null?o:"section"),t.push({line:l,from:d.from,to:d.to,info:p}),p.pageNumber&&i.push(p.pageNumber))}if(!t.length)return j.Decoration.none;if(r)for(let l of t)l.info.type==="chunk-end"&&(l.info.chunkKind="page");let a=i.length?Math.max(...i):0;for(let l of t){let d=j.Decoration.replace({widget:new Fe(l.info,a)});n.add(l.from,l.to,d)}return n.finish()},An=()=>j.ViewPlugin.fromClass(class{constructor(k){this.decorations=nn(k)}update(k){(k.docChanged||k.viewportChanged)&&(this.decorations=nn(k.view))}},{decorations:k=>k.decorations}),Sn=k=>j.ViewPlugin.fromClass(class{constructor(m){this.decorations=en(m,k)}update(m){(m.docChanged||m.selectionSet||m.viewportChanged)&&(this.decorations=en(m.view,k))}},{decorations:m=>m.decorations}),Nn=k=>j.ViewPlugin.fromClass(class{constructor(m){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=m,this.docId=Ce(m.state.doc),this.onScroll=()=>this.scheduleSync(!1),m.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(m){m.docChanged&&(this.docId=Ce(m.view.state.doc),this.lastPage=null,this.lastChunkId=null),(m.docChanged||m.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(m){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,m)}))}syncPdfSidebar(m,e){var d,c;let n=this.docId;if(!n)return;let t=En(m);if(t===null)return;let i=Ze(m.state.doc,t);if(!i)return;let r=Ue(i.text),a=(d=r==null?void 0:r.pageNumber)!=null?d:null,s=(c=r==null?void 0:r.chunkId)!=null?c:null;if(!a&&!s)return;let o=a!==null&&this.lastPage===a,l=a===null&&s!==null&&this.lastChunkId===s;!e&&(o||l)||(this.lastPage=a,this.lastChunkId=s,k.syncPdfSidebarForDoc(n,a!=null?a:void 0,s!=null?s:void 0))}}),ln=j.ViewPlugin.fromClass(class{constructor(k){this.decorations=Qe(k)}update(k){(k.docChanged||k.viewportChanged)&&(this.decorations=Qe(k.view))}},{decorations:k=>k.decorations}),ze=class extends u.Modal{constructor(e,n,t=""){super(e);this.bodyText="";this.plugin=n,this.initialTerm=t}onOpen(){let{contentEl:e}=this;e.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),e.style.display="flex",e.style.flexDirection="column",e.style.height="100%",e.style.overflow="hidden",e.style.minHeight="0";let n=e.createDiv();n.style.display="flex",n.style.alignItems="center",n.style.justifyContent="space-between",n.style.gap="0.5rem",n.createEl("h3",{text:"Redis index search"});let t=n.createEl("button",{text:"Copy All"});t.style.marginLeft="auto",t.addEventListener("click",()=>{this.copyResultsToClipboard()});let i=e.createDiv();i.style.display="flex",i.style.alignItems="center",i.style.gap="0.5rem",i.style.margin="0.5rem 0";let r=i.createEl("input");r.type="text",r.placeholder="Search term",r.value=this.initialTerm,r.style.flex="1",r.style.minWidth="0",this.inputEl=r,i.createEl("button",{text:"Search"}).addEventListener("click",()=>{this.runSearch()}),r.addEventListener("keydown",d=>{d.key==="Enter"&&(d.preventDefault(),this.runSearch())});let s=e.createDiv();s.style.color="var(--text-muted)",s.style.marginBottom="0.5rem",this.statusEl=s;let o=e.createDiv();o.style.flex="1 1 0",o.style.minHeight="0",o.style.border="1px solid var(--background-modifier-border)",o.style.borderRadius="6px",o.style.display="flex",o.style.flexDirection="column",o.style.overflow="auto";let l=ee.EditorState.create({doc:this.bodyText,extensions:[on,ln,j.EditorView.editable.of(!1),ee.EditorState.readOnly.of(!0),j.EditorView.lineWrapping]});this.editorView=new j.EditorView({state:l,parent:o}),this.initialTerm&&this.runSearch()}onClose(){var e;(e=this.editorView)==null||e.destroy(),this.editorView=void 0}async runSearch(){var t;let e=(((t=this.inputEl)==null?void 0:t.value)||"").trim();if(!e){this.statusEl&&(this.statusEl.textContent="Enter a search term.");return}this.statusEl&&(this.statusEl.textContent="Searching...");let n=await this.plugin.runRedisSearch(e);this.updateEditor(n),this.statusEl&&(this.statusEl.textContent=`Results for \u201C${e}\u201D`)}updateEditor(e){if(!this.editorView)return;let n=this.editorView,t=n.scrollDOM.scrollTop,i=n.state.selection.main,r=e.length,a=Math.min(i.anchor,r),s=Math.min(i.head,r);n.dispatch({changes:{from:0,to:n.state.doc.length,insert:e},selection:{anchor:a,head:s}}),n.scrollDOM.scrollTop=t,this.bodyText=e}copyResultsToClipboard(){let e=this.bodyText||"";if(!e){new u.Notice("Nothing to copy.");return}navigator.clipboard.writeText(e).then(()=>new u.Notice("Results copied to clipboard.")).catch(()=>new u.Notice("Failed to copy results."))}},me=class extends u.Modal{constructor(m,e,n,t){super(m),this.titleText=e,this.bodyText=n,this.options=t}onOpen(){var r,a,s,o;let{contentEl:m}=this;m.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),m.style.display="flex",m.style.flexDirection="column",m.style.height="100%",m.style.overflow="hidden",m.style.minHeight="0";let e=m.createDiv();e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="space-between",e.style.gap="0.5rem",e.createEl("h3",{text:this.titleText});let n=e.createDiv();if(n.style.display="flex",n.style.gap="0.5rem",(r=this.options)!=null&&r.onClear){let l=(a=this.options.clearLabel)!=null?a:"Clear log";n.createEl("button",{text:l}).addEventListener("click",async()=>{var c,p;try{await((p=(c=this.options)==null?void 0:c.onClear)==null?void 0:p.call(c))}finally{await this.refreshFromSource()}})}let t=m.createDiv();t.style.flex="1 1 0",t.style.minHeight="0",t.style.border="1px solid var(--background-modifier-border)",t.style.borderRadius="6px",t.style.display="flex",t.style.flexDirection="column",t.style.overflow="auto";let i=ee.EditorState.create({doc:this.bodyText,extensions:[on,ln,j.EditorView.editable.of(!0),ee.EditorState.readOnly.of(!1),j.EditorView.lineWrapping]});if(this.editorView=new j.EditorView({state:i,parent:t}),this.refreshFromSource(),(s=this.options)!=null&&s.autoRefresh&&this.options.onRefresh){let l=(o=this.options.refreshIntervalMs)!=null?o:2e3;this.refreshTimer=window.setInterval(()=>{this.refreshFromSource()},l)}}onClose(){var m;this.refreshTimer!==void 0&&(window.clearInterval(this.refreshTimer),this.refreshTimer=void 0),(m=this.editorView)==null||m.destroy(),this.editorView=void 0}async refreshFromSource(){var s;if(!((s=this.options)!=null&&s.onRefresh)||!this.editorView)return;let m="";try{m=await this.options.onRefresh()||""}catch(o){return}if(m===this.bodyText)return;let e=this.editorView,n=e.scrollDOM.scrollTop,t=e.state.selection.main,i=m.length,r=Math.min(t.anchor,i),a=Math.min(t.head,i);e.dispatch({changes:{from:0,to:e.state.doc.length,insert:m},selection:{anchor:r,head:a}}),e.scrollDOM.scrollTop=n,this.bodyText=m}},qe=class extends u.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.filePath=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Overwrite"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Me=class extends u.Modal{constructor(e,n,t,i){super(e);this.resolved=!1;this.notePath=n,this.docId=t,this.onResolve=i}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete note and cached data?"}),e.createEl("p",{text:`This will delete the note and cached chunks/items for doc_id ${this.docId}.`}),e.createEl("p",{text:`Note: ${this.notePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Delete"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},je=class extends u.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.reason=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Rebuild Redis index?"}),e.createEl("p",{text:this.reason}),e.createEl("p",{text:"This will drop the RedisSearch index (and embeddings) and rebuild it from cached chunks."});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Drop & rebuild"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},$e=class extends u.Modal{constructor(e,n){super(e);this.resolved=!1;this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Purge Redis orphaned chunks?"}),e.createEl("p",{text:"This removes Redis chunk keys that have no cached item.json or chunk.json on disk."}),e.createEl("p",{text:"Cache files are not deleted. Use this to clean up stale Redis data."});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Purge orphans"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Ge=class extends u.Modal{constructor(e,n,t,i,r,a,s){super(e);this.resolved=!1;this.fieldLabel=n,this.noteLabel=t,this.zoteroLabel=i,this.noteValue=r,this.zoteroValue=a,this.onResolve=s}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:`Resolve metadata conflict: ${this.fieldLabel}`});let n=e.createEl("div");n.style.display="grid",n.style.gap="0.5rem",n.createEl("div",{text:"Note value"});let t=n.createEl("textarea",{attr:{readonly:"true",rows:"4"}});t.style.width="100%",t.value=this.noteValue||"(empty)",n.createEl("div",{text:"Zotero value"});let i=n.createEl("textarea",{attr:{readonly:"true",rows:"4"}});i.style.width="100%",i.value=this.zoteroValue||"(empty)";let r=e.createEl("div");r.style.display="flex",r.style.gap="0.5rem",r.style.marginTop="0.75rem";let a=r.createEl("button",{text:this.noteLabel}),s=r.createEl("button",{text:this.zoteroLabel}),o=r.createEl("button",{text:"Skip"});a.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("note")}),s.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("zotero")}),o.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("skip")})}onClose(){this.resolved||this.onResolve("skip")}},Ve=class extends u.SuggestModal{constructor(e,n){super(e);this.resolved=!1;this.resolveSelection=n,this.setPlaceholder("Select a language for OCR/quality...")}getSuggestions(e){let n=e.trim().toLowerCase();return n?Je.filter(t=>t.label.toLowerCase().includes(n)||t.value.toLowerCase().includes(n)):Je}renderSuggestion(e,n){n.setText(e.label),n.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new Pe(this.app,"Custom language hint","e.g., en, de, fr, de,en",n=>this.resolveSelection(n.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},Le=class extends u.Plugin{constructor(){super(...arguments);this.docIndex=null;this.lastPythonEnvNotice=null;this.lastContainerNotice=null;this.lastZoteroApiNotice=null;this.lastRedisNotice=null;this.noteSyncTimers=new Map;this.noteSyncInFlight=new Set;this.noteSyncPending=new Set;this.noteSyncPendingDeletes=new Map;this.noteSyncSuppressed=new Set;this.noteMetadataSyncTimers=new Map;this.noteMetadataSyncInFlight=new Set;this.noteMetadataSyncPending=new Set;this.noteMetadataSyncSuppressed=new Set;this.missingDocIdWarned=new Set;this.collectionTitleCache=new Map;this.recreateMissingNotesActive=!1;this.recreateMissingNotesAbort=!1;this.recreateMissingNotesProcess=null;this.reindexCacheActive=!1;this.lastReindexFailure=null;this.lastRedisSearchTerm="";this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null}async onload(){await this.loadSettings(),await this.migrateCachePaths(),this.addSettingTab(new xe(this.app,this)),this.registerRibbonIcons(),this.registerView(de,e=>new _e(e,this)),this.setupStatusBar(),this.registerNoteRenameHandler(),this.registerNoteSyncHandler(),this.registerNoteOpenHandler(),this.registerPreviewScrollSyncHandlers(),this.registerNoteDeleteMenu(),this.registerEditorExtension(Sn(this)),this.registerEditorExtension(An()),this.registerEditorExtension(Nn(this));try{await this.ensureBundledTools()}catch(e){console.error("Failed to sync bundled tools",e)}this.autoDetectRedisOnLoad(),this.addCommand({id:"import-zotero-item-index",name:"Import Zotero item and index (Docling -> RedisSearch)",callback:()=>this.importZoteroItem()}),this.addCommand({id:"ask-zotero-library",name:"Ask my Zotero library (RAG via RedisSearch)",callback:()=>this.askZoteroLibrary()}),this.addCommand({id:"open-zotero-chat",name:"Open Zotero RAG chat panel",callback:()=>this.openChatView(!0)}),this.addCommand({id:"rebuild-zotero-note-cache",name:"Rebuild Zotero note from cache (Docling + RedisSearch)",callback:()=>this.rebuildNoteFromCache()}),this.addCommand({id:"rebuild-doc-index-cache",name:"Rebuild doc index from cache",callback:()=>this.rebuildDocIndexFromCache()}),this.addCommand({id:"recreate-missing-notes-cache",name:"Recreate missing notes from cache (Docling + RedisSearch)",callback:()=>this.recreateMissingNotesFromCache()}),this.addCommand({id:"reindex-redis-from-cache",name:"Reindex Redis from cached chunks",callback:()=>this.reindexRedisFromCache()}),this.addCommand({id:"reindex-current-note",name:"Reindex current note from cache",callback:()=>this.reindexCurrentNoteFromCache()}),this.addCommand({id:"drop-rebuild-redis-index",name:"Drop & rebuild Redis index",callback:()=>this.dropAndRebuildRedisIndex()}),this.addCommand({id:"start-redis-stack",name:"Start Redis Stack (Docker/Podman Compose)",callback:()=>this.startRedisStack()}),this.addCommand({id:"open-docling-log",name:"Open log file",callback:()=>this.openLogFile()}),this.addCommand({id:"clear-docling-log",name:"Clear log file",callback:()=>this.clearLogFile()}),this.addCommand({id:"toggle-zrr-chunk-delete",name:"Toggle ZRR chunk exclude at cursor",editorCallback:e=>this.toggleChunkExclude(e)}),this.addCommand({id:"delete-zotero-note-cache",name:"Delete Zotero note and cached data",callback:()=>this.deleteZoteroNoteAndCache()}),this.addCommand({id:"search-redis-index",name:"Search Redis index for term",callback:()=>this.searchRedisIndex()}),this.addCommand({id:"redis-diagnostics",name:"Show Redis diagnostics",callback:()=>this.showRedisDiagnostics()}),this.addCommand({id:"purge-redis-orphans",name:"Purge Redis orphaned chunks (missing cache files)",callback:()=>this.purgeRedisOrphanedKeys()}),this.autoDetectContainerCliOnLoad(),this.settings.autoStartRedis&&this.startRedisStack(!0)}async loadSettings(){var t;let e=(t=await this.loadData())!=null?t:{},n=Object.assign({},We,e);n.preferObsidianNoteForCitations===void 0&&typeof e.preferVaultPdfForCitations=="boolean"&&(n.preferObsidianNoteForCitations=e.preferVaultPdfForCitations),this.settings=n}async saveSettings(){await this.saveData(this.settings)}async importZoteroItem(){var D,I,z;try{await this.ensureBundledTools()}catch(R){new u.Notice("Failed to sync bundled tools. See console for details."),console.error(R);return}if(!await this.warnIfZoteroLocalApiUnavailable("import")&&!this.canUseWebApi())return;let n;try{n=await this.promptZoteroItem()}catch(R){new u.Notice("Zotero search failed. See console for details."),console.error(R);return}if(!n){new u.Notice("No Zotero item selected.");return}let t=(D=n.data)!=null?D:n;!t.key&&n.key&&(t.key=n.key);let i=this.getDocId(t);if(!i){new u.Notice("Could not resolve a stable doc_id from Zotero item.");return}let r=await this.resolveLanguageHint(t,(I=n.key)!=null?I:t.key),a=this.buildDoclingLanguageHint(r!=null?r:void 0),s=await this.resolvePdfAttachment(t,i);if(!s){new u.Notice("No PDF attachment found for item.");return}if(this.showStatusProgress("Preparing...",5),!await this.ensureRedisAvailable("import")){this.clearStatusProgress();return}let o=typeof t.title=="string"?t.title:"",l=await this.getDocIndexEntry(i);l&&new u.Notice("Item already indexed. Updating cached files and index.");let d=this.sanitizeFileName(o)||i;if(l!=null&&l.note_path)d=A.default.basename(l.note_path,".md")||d;else if(l!=null&&l.pdf_path){let R=this.toVaultRelativePath(l.pdf_path);R&&R.startsWith((0,u.normalizePath)(this.settings.outputPdfDir))&&(d=A.default.basename(R,".pdf")||d)}let c=l?d:await this.resolveUniqueBaseName(d,i),p=(0,u.normalizePath)(`${this.settings.outputPdfDir}/${c}.pdf`),g=(0,u.normalizePath)(`${J}/${i}.json`),y=(0,u.normalizePath)(`${V}/${i}.json`),b=this.app.vault.adapter,L=(0,u.normalizePath)(`${this.settings.outputNoteDir}/${c}.md`);if(l!=null&&l.note_path&&await b.exists(l.note_path)&&(L=(0,u.normalizePath)(l.note_path)),await b.exists(L)&&!await this.confirmOverwrite(L)){new u.Notice("Import canceled.");return}try{if(await this.ensureFolder(J),await this.ensureFolder(V),await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let R=this.getLogFileRelativePath(),F=(0,u.normalizePath)(A.default.dirname(R));F&&await this.ensureFolder(F),await this.deleteLogFileIfExists();let O=this.getSpellcheckerInfoRelativePath(),$=(0,u.normalizePath)(A.default.dirname(O));$&&await this.ensureFolder($)}}catch(R){new u.Notice("Failed to create output folders."),console.error(R),this.clearStatusProgress();return}let _="",f="";try{if(this.settings.copyPdfToVault){let R=s.filePath?await B.promises.readFile(s.filePath):await this.downloadZoteroPdf(s.key);await this.app.vault.adapter.writeBinary(p,this.bufferToArrayBuffer(R)),_=this.getAbsoluteVaultPath(p)}else if(s.filePath)_=s.filePath;else{await this.ensureFolder(this.settings.outputPdfDir);let R=await this.downloadZoteroPdf(s.key);await this.app.vault.adapter.writeBinary(p,this.bufferToArrayBuffer(R)),_=this.getAbsoluteVaultPath(p),new u.Notice("Local PDF path unavailable; copied PDF into vault for processing.")}f=this.buildPdfLinkForNote(_,s.key,i)}catch(R){new u.Notice("Failed to download PDF attachment."),console.error(R),this.clearStatusProgress();return}try{await this.app.vault.adapter.write(g,JSON.stringify(n,null,2))}catch(R){new u.Notice("Failed to write Zotero item JSON."),console.error(R),this.clearStatusProgress();return}let v=this.getPluginDir(),w=A.default.join(v,"tools","docling_extract.py"),S=A.default.join(v,"tools","index_redisearch.py"),C=null;try{C=await this.readDoclingQualityLabelFromPdf(_,a),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",C),0);let R=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(w,await this.buildDoclingArgs(_,i,y,L,a,!0),$=>this.handleDoclingProgress($,C),()=>{},R),C=await this.readDoclingQualityLabel(y),await this.annotateChunkJsonWithAttachmentKey(y,s.key);let F=await this.readDoclingMetadata(y),O=await this.maybeCreateOcrLayeredPdf(_,F,a);O&&(_=O,f=this.buildPdfLinkFromSourcePath(O),await this.updateChunkJsonSourcePdf(y,O))}catch(R){new u.Notice("Docling extraction failed. See console for details."),console.error(R),this.clearStatusProgress();return}let P=!1;try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",C),0);let R=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null,F=["--chunks-json",this.getAbsoluteVaultPath(y),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--progress"];this.appendEmbedSubchunkArgs(F),this.appendEmbedContextArgs(F),this.settings.embedIncludeMetadata&&F.push("--embed-include-metadata"),this.appendChunkTaggingArgs(F),await this.runPythonStreaming(S,F,O=>{if((O==null?void 0:O.type)==="progress"&&O.total){let $=Math.round(O.current/O.total*100),H=typeof O.message=="string"&&O.message.trim()?O.message:`Indexing chunks ${O.current}/${O.total}`,T=this.formatStatusLabel(H,C);this.showStatusProgress(T,$)}},()=>{})}catch(R){let F=this.getPythonErrorMessage(R),O=this.classifyIndexingError(F);if(console.error(R),O==="embed_dim_mismatch")if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema. Switch to a model with matching dimensions, or drop/rebuild the index."))try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){this.clearStatusProgress(),this.lastReindexFailure==="embed_failure"?new u.Notice("Embedding provider error detected while rebuilding the Redis index. Fix the provider/model settings and retry import."):new u.Notice("Redis index rebuild did not complete. Import stopped.");return}new u.Notice("Redis index rebuilt; resuming import."),P=!0}catch(H){this.clearStatusProgress(),new u.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error(H);return}else{this.clearStatusProgress(),new u.Notice("Indexing aborted due to embedding dimension mismatch. Switch models or drop/rebuild the index.");return}if(!P){if(O==="embed_failure"){this.clearStatusProgress(),new u.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.");return}this.clearStatusProgress(),new u.Notice("RedisSearch indexing failed. See console for details.");return}}try{let R=await this.app.vault.adapter.read(L),F=await this.readChunkPayload(y),O=this.buildSyncedDoclingContent(i,F,R),$=await this.buildNoteMarkdown(t,(z=n.meta)!=null?z:{},i,f,s.key,g,O);await this.writeNoteWithSyncSuppressed(L,$)}catch(R){new u.Notice("Failed to finalize note markdown."),console.error(R),this.clearStatusProgress();return}try{let R=this.extractShortTitleFromValues(t);await this.updateDocIndex({doc_id:i,note_path:L,note_title:c,zotero_title:o,short_title:R||void 0,pdf_path:_,attachment_key:s.key})}catch(R){console.error("Failed to update doc index",R)}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new u.Notice(`Indexed Zotero item ${i}.`)}async askZoteroLibrary(){await this.openChatView(!0)}getChatLeaf(){var n;let e=this.app.workspace.getLeavesOfType(de);return e.length>0?e[0]:this.settings.chatPaneLocation==="right"?(n=this.app.workspace.getRightLeaf(!1))!=null?n:this.app.workspace.getLeaf("split"):this.app.workspace.getLeaf("tab")}async openChatView(e=!1){let n=this.getChatLeaf();await n.setViewState({type:de,active:!0}),this.app.workspace.revealLeaf(n);let t=n.view;return t instanceof _e&&e&&t.focusInput(),t}async loadChatHistory(){let e=await this.getActiveChatSessionId();return this.loadChatHistoryForSession(e)}async saveChatHistory(e){let n=await this.getActiveChatSessionId();await this.saveChatHistoryForSession(n,e)}getChatSessionsDir(){return(0,u.normalizePath)(`${K}/chats`)}getChatExportDir(){let e=(this.settings.chatOutputDir||"").trim();return e?(0,u.normalizePath)(e):(0,u.normalizePath)("zotero/chats")}getChatSessionsIndexPath(){return(0,u.normalizePath)(`${this.getChatSessionsDir()}/index.json`)}getChatSessionPath(e){return(0,u.normalizePath)(`${this.getChatSessionsDir()}/${e}.json`)}async listChatSessions(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath();if(!await e.exists(n)){let t=new Date().toISOString(),i=[{id:"default",name:"New chat",createdAt:t,updatedAt:t}];return await this.writeChatSessionsIndex({version:1,active:"default",sessions:i}),i}try{let t=await e.read(n),i=JSON.parse(t);return(Array.isArray(i==null?void 0:i.sessions)?i.sessions:[]).filter(a=>a&&typeof a.id=="string").map(a=>({id:String(a.id),name:typeof a.name=="string"&&a.name.trim()?a.name.trim():String(a.id),createdAt:typeof a.createdAt=="string"?a.createdAt:new Date().toISOString(),updatedAt:typeof a.updatedAt=="string"?a.updatedAt:new Date().toISOString()}))}catch(t){return console.warn("Failed to read chat sessions index",t),[]}}async getActiveChatSessionId(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath();if(!await e.exists(n))return"default";try{let t=await e.read(n),i=JSON.parse(t);return(typeof(i==null?void 0:i.active)=="string"?i.active:"default")||"default"}catch(t){return"default"}}async setActiveChatSessionId(e){var a,s;await this.migrateLegacyChatHistory();let n=await this.readChatSessionsIndex(),t=((a=n.sessions)!=null?a:[]).some(o=>o.id===e),i=new Date().toISOString(),r=t?n.sessions:[...(s=n.sessions)!=null?s:[],{id:e,name:e,createdAt:i,updatedAt:i}];await this.writeChatSessionsIndex({version:1,active:e,sessions:r})}async createChatSession(e){var s;await this.migrateLegacyChatHistory();let n=this.generateChatId(),t=new Date().toISOString(),i=(e||"").trim()||"New chat",a=[...(s=(await this.readChatSessionsIndex()).sessions)!=null?s:[],{id:n,name:i,createdAt:t,updatedAt:t}];return await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionPath(n),JSON.stringify({version:1,messages:[]},null,2)),await this.writeChatSessionsIndex({version:1,active:n,sessions:a}),n}async renameChatSession(e,n){var a,s;await this.migrateLegacyChatHistory();let t=(n||"").trim();if(!t)return;let i=await this.readChatSessionsIndex(),r=((a=i.sessions)!=null?a:[]).map(o=>o.id===e?{...o,name:t}:o);await this.writeChatSessionsIndex({version:1,active:(s=i.active)!=null?s:"default",sessions:r})}async deleteChatSession(e){var s;if(await this.migrateLegacyChatHistory(),!e)return;let n=this.app.vault.adapter,t=await this.readChatSessionsIndex(),i=(s=t.sessions)!=null?s:[];if(i.length<=1)return;let r=i.filter(o=>o.id!==e);if(!r.length)return;let a=t.active===e?r[0].id:t.active;try{await n.remove(this.getChatSessionPath(e))}catch(o){console.warn("Failed to delete chat session file",o)}await this.writeChatSessionsIndex({version:1,active:a,sessions:r})}async loadChatHistoryForSession(e){await this.migrateLegacyChatHistory();let n=this.app.vault.adapter,t=this.getChatSessionPath(e||"default");if(!await n.exists(t))return[];let i=await n.read(t),r;try{r=JSON.parse(i)}catch(s){return[]}let a=Array.isArray(r)?r:r==null?void 0:r.messages;return Array.isArray(a)?a.filter(s=>s&&typeof s.content=="string").map(s=>({id:s.id||this.generateChatId(),role:s.role==="assistant"?"assistant":"user",content:s.content,citations:Array.isArray(s.citations)?s.citations:[],retrieved:Array.isArray(s.retrieved)?s.retrieved:[],createdAt:s.createdAt||new Date().toISOString()})):[]}async saveChatHistoryForSession(e,n){var l,d;await this.migrateLegacyChatHistory(),await this.ensureFolder(this.getChatSessionsDir());let t=this.app.vault.adapter,i=this.getChatSessionPath(e||"default"),r={version:1,messages:n};await t.write(i,JSON.stringify(r,null,2));let a=await this.readChatSessionsIndex(),s=new Date().toISOString(),o=((l=a.sessions)!=null?l:[]).map(c=>c.id===e?{...c,updatedAt:s}:c);await this.writeChatSessionsIndex({version:1,active:(d=a.active)!=null?d:e,sessions:o})}getRecentChatHistory(e){let n=Math.max(0,this.settings.chatHistoryMessages||0);return n?e.filter(i=>{var r;return i&&((r=i.content)==null?void 0:r.trim())}).slice(-n):[]}async readChatSessionsIndex(){let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath(),t=new Date().toISOString();if(!await e.exists(n))return{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:t,updatedAt:t}]};try{let i=await e.read(n),r=JSON.parse(i),a=Array.isArray(r==null?void 0:r.sessions)?r.sessions:[];return{version:1,active:typeof(r==null?void 0:r.active)=="string"?r.active:"default",sessions:a.map(s=>({id:String(s.id),name:typeof s.name=="string"&&s.name.trim()?s.name.trim():String(s.id),createdAt:typeof s.createdAt=="string"?s.createdAt:t,updatedAt:typeof s.updatedAt=="string"?s.updatedAt:t}))}}catch(i){return console.warn("Failed to parse chat sessions index",i),{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:t,updatedAt:t}]}}}async writeChatSessionsIndex(e){await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionsIndexPath(),JSON.stringify(e,null,2))}async migrateLegacyChatHistory(){let e=this.app.vault.adapter,n=(0,u.normalizePath)(`${K}/chat.json`),t=this.getChatSessionsDir(),i=this.getChatSessionsIndexPath(),r=this.getChatSessionPath("default"),a=await e.exists(n),s=await e.exists(r),o=await e.exists(i);if(!a&&o)return;let l=new Date().toISOString();if(await this.ensureFolder(t),a&&!s)try{await e.rename(n,r)}catch(d){try{let c=await e.read(n);await e.write(r,c),await e.remove(n)}catch(c){console.warn("Failed to migrate legacy chat history",c)}}if(!o){let d=[{id:"default",name:"New chat",createdAt:l,updatedAt:l}];await this.writeChatSessionsIndex({version:1,active:"default",sessions:d})}if(o)try{let d=await e.read(i),c=JSON.parse(d),p=Array.isArray(c==null?void 0:c.sessions)?c.sessions:[],g=p.some(b=>(b==null?void 0:b.id)==="default"),y=p.map(b=>(b==null?void 0:b.id)==="default"&&typeof(b==null?void 0:b.name)=="string"&&b.name.trim().toLowerCase()==="default"?{...b,name:"New chat"}:b);g&&JSON.stringify(y)!==JSON.stringify(p)&&await this.writeChatSessionsIndex({version:1,active:typeof(c==null?void 0:c.active)=="string"?c.active:"default",sessions:y.map(b=>({id:String(b.id),name:typeof b.name=="string"?b.name:"New chat",createdAt:typeof b.createdAt=="string"?b.createdAt:l,updatedAt:typeof b.updatedAt=="string"?b.updatedAt:l}))})}catch(d){}}isPlaceholderChatName(e){let n=(e||"").trim().toLowerCase();return n==="new chat"||n==="default"}normalizeChatTitle(e){let n=(e||"").replace(/\s+/g," ").trim();return n.length>60?`${n.slice(0,57)}...`:n}guessTitleFromMessages(e){let n=e.find(i=>i.role==="user"&&i.content.trim());if(!n)return"New chat";let t=n.content.replace(/\s+/g," ").trim().split(" ").slice(0,8).join(" ");return this.normalizeChatTitle(t||"New chat")}async suggestChatTitleWithLlm(e){var a,s,o;let n=(this.settings.chatBaseUrl||"").trim(),t=(this.settings.chatModel||"").trim();if(!n||!t)return null;let i=n.replace(/\/$/,"");if(i.toLowerCase().includes("api.openai.com")&&(!this.settings.chatApiKey||t.includes("/")))return null;try{let l=`${i}/chat/completions`,d={"Content-Type":"application/json"};this.settings.chatApiKey&&(d.Authorization=`Bearer ${this.settings.chatApiKey}`);let c=e.slice(-8).map(L=>`${L.role.toUpperCase()}: ${L.content}`).join(`
`).slice(0,4e3),g=await fetch(l,{method:"POST",headers:d,body:JSON.stringify({model:t,temperature:.2,messages:[{role:"system",content:"Generate a short, specific title (3-7 words) for the chat. No quotes, no punctuation at the end."},{role:"user",content:c}]})});if(!g.ok)return null;let y=await g.json(),b=(o=(s=(a=y==null?void 0:y.choices)==null?void 0:a[0])==null?void 0:s.message)==null?void 0:o.content;return typeof b!="string"?null:this.normalizeChatTitle(b.replace(/^\"|\"$/g,"").trim())}catch(l){return console.warn("Chat title suggestion failed",l),null}}async finalizeChatSessionNameIfNeeded(e,n,t={}){var d;if(!e)return;let i=n||[];if(!i.some(c=>c.role==="user"&&c.content.trim())||!t.force&&i.length<4)return;let s=((d=(await this.readChatSessionsIndex()).sessions)!=null?d:[]).find(c=>c.id===e);if(!s||!this.isPlaceholderChatName(s.name))return;let l=await this.suggestChatTitleWithLlm(i)||this.guessTitleFromMessages(i);!l||this.isPlaceholderChatName(l)||await this.renameChatSession(e,l)}async runRagQueryStreaming(e,n,t,i=[]){if(await this.ensureBundledTools(),!await this.ensureRedisAvailable("chat query")){t({answer:"Redis is not reachable. Please start Redis Stack and try again."});return}let r=this.getPluginDir(),a=A.default.join(r,"tools","rag_query_redisearch.py"),s=["--query",e,"--k","5","--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--chat-base-url",this.settings.chatBaseUrl,"--chat-api-key",this.settings.chatApiKey,"--chat-model",this.settings.chatModel,"--temperature",String(this.settings.chatTemperature),"--stream"];if(this.settings.enableQueryExpansion&&(s.push("--expand-query"),s.push("--expand-count",String(Math.max(1,Math.trunc(this.settings.queryExpansionCount))))),this.settings.enableCrossEncoderRerank){s.push("--rerank");let d=(this.settings.rerankModel||"").trim();d&&s.push("--rerank-model",d)}Number.isFinite(this.settings.rerankCandidateMultiplier)&&s.push("--rerank-candidates",String(Math.max(1,Math.trunc(this.settings.rerankCandidateMultiplier)))),Number.isFinite(this.settings.rrfK)&&s.push("--rrf-k",String(Math.max(1,Math.trunc(this.settings.rrfK)))),Number.isFinite(this.settings.rrfLogTop)&&this.settings.rrfLogTop>0&&s.push("--rrf-log-top",String(Math.max(1,Math.trunc(this.settings.rrfLogTop)))),Number.isFinite(this.settings.maxChunksPerDoc)&&this.settings.maxChunksPerDoc>0&&s.push("--max-per-doc",String(Math.max(1,Math.trunc(this.settings.maxChunksPerDoc))));let o=this.buildChatHistoryPayload(i),l=await this.writeChatHistoryTemp(o);l!=null&&l.absolutePath&&s.push("--history-file",l.absolutePath);try{let d=async()=>{await this.runPythonStreaming(a,s,p=>{if((p==null?void 0:p.type)==="delta"&&typeof p.content=="string"){n(p.content);return}if((p==null?void 0:p.type)==="final"){t(p);return}p!=null&&p.answer&&t(p)},t)},c=!1;for(;;)try{await d();break}catch(p){let g=this.getPythonErrorMessage(p),y=this.classifyIndexingError(g);if(y==="embed_dim_mismatch"){if(c){t({answer:"Embedding dimension mismatch persists after rebuild. Check the embedding model settings."});return}if(!await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema.")){t({answer:"Embedding dimension mismatch. Switch models or drop/rebuild the Redis index."});return}try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){let _=this.lastReindexFailure==="embed_failure"?"Embedding provider error detected while rebuilding the index. Fix settings and retry.":"Redis index rebuild did not complete. Chat query stopped.";t({answer:_});return}}catch(L){console.error(L),t({answer:"Failed to drop/rebuild the Redis index. See console for details."});return}c=!0;continue}if(y==="embed_failure"){t({answer:"Embedding provider error detected. Fix the provider/model settings and retry."});return}throw p}}finally{if(l!=null&&l.relativePath)try{await this.app.vault.adapter.remove(l.relativePath)}catch(d){console.warn("Failed to remove chat history temp file",d)}}}buildChatHistoryPayload(e){return this.getRecentChatHistory(e).map(t=>({role:t.role,content:t.content}))}async writeChatHistoryTemp(e){if(!e.length)return null;let n=(0,u.normalizePath)(`${K}/tmp`);await this.ensureFolder(n);let t=`chat_history_${Date.now()}_${Math.random().toString(36).slice(2,8)}.json`,i=(0,u.normalizePath)(`${n}/${t}`),r={version:1,messages:e};return await this.app.vault.adapter.write(i,JSON.stringify(r,null,2)),{relativePath:i,absolutePath:this.getAbsoluteVaultPath(i)}}async resolveCitationDisplay(e){let n=await this.getDocIndexEntry(e.doc_id);(!n||!n.note_title||!n.zotero_title||!n.note_path||!n.pdf_path||n.short_title===void 0)&&(n=await this.hydrateDocIndexFromCache(e.doc_id));let t=e.doc_id?await this.resolveNotePathForDocId(e.doc_id):n==null?void 0:n.note_path,i=this.resolveCitationTitle(n,t,e.doc_id),r=this.formatCitationPageLabel(e),a=e.page_start?String(e.page_start):"",s=(n==null?void 0:n.pdf_path)||e.source_pdf||"",o=e.attachment_key||(n==null?void 0:n.attachment_key),l=e.annotation_key||this.extractAnnotationKey(e.chunk_id),d=e.doc_id?this.buildZoteroDeepLink(e.doc_id,o,a,l):void 0;return{noteTitle:i,pageLabel:r,notePath:t||void 0,pdfPath:s||void 0,zoteroUrl:d,pageStart:a||void 0}}resolveCitationTitle(e,n,t){let i=t||"?",r=(e==null?void 0:e.short_title)||(e==null?void 0:e.zotero_title)||(e==null?void 0:e.note_title)||(n?A.default.basename(n,".md"):"")||i;return this.shortenCitationTitle(r)}shortenCitationTitle(e){let n=String(e||"").trim();if(!n)return"?";if(n.length<=Ye)return n;let t=Math.max(0,Ye-3);return`${n.slice(0,t).trim()}...`}formatCitationLabel(e,n){let t=e.trim()||"?",i=(n||"").trim();return i?`${t}, p. ${i}`:t}async formatInlineCitations(e,n,t=[]){var d,c;if(!e)return e;let i=/\[\[?cite:([A-Za-z0-9]+):([^\]\n]+?)\]?\]/g,r=Array.from(e.matchAll(i));if(r.length===0)return e;let a=new Map;for(let p of r){let g=p[0];if(a.has(g))continue;let y=p[1],b=p[2].trim(),L=b.match(/^(\d+)-(\d+)(?::([A-Za-z0-9]+))?$/),_="",f="",v,w;L?(_=L[1],f=L[2],v=L[3]):w=b;let S=w?t.find(R=>{let F=typeof R.doc_id=="string"?R.doc_id:"";if(F&&F!==y)return!1;let O=typeof R.chunk_id=="string"?R.chunk_id:"";return O?O===w||O===`${y}:${w}`||O.endsWith(`:${w}`):!1}):void 0;S&&(!_&&S.page_start!==void 0&&(_=String(S.page_start)),!f&&S.page_end!==void 0&&(f=String(S.page_end)),!v&&typeof S.chunk_id=="string"&&(v=this.extractAnnotationKey(S.chunk_id)));let C={doc_id:y,chunk_id:S==null?void 0:S.chunk_id,annotation_key:v};(_||f)&&(C.page_start=_||f,C.page_end=f||_,C.pages=`${C.page_start}-${C.page_end}`),S!=null&&S.source_pdf&&(C.source_pdf=String(S.source_pdf));let P=(_||f?n.find(R=>{var F,O;return R.doc_id===y&&String((F=R.page_start)!=null?F:"")===_&&String((O=R.page_end)!=null?O:"")===f}):void 0)||n.find(R=>R.doc_id===y)||C;!P.annotation_key&&v&&(P={...P,annotation_key:v});let D=await this.resolveCitationDisplay(P),I=this.formatCitationLabel(D.noteTitle,D.pageLabel),z=this.normalizeChunkIdForNote(P.chunk_id,y);if(this.settings.preferObsidianNoteForCitations&&D.notePath&&z)a.set(g,this.buildNoteChunkLink(D.notePath,z,I));else if(D.zoteroUrl)a.set(g,`[${I}](${D.zoteroUrl})`);else{let R=this.formatCitationLabel(y,D.pageLabel);a.set(g,`(${R})`)}}let s=[],o=0;for(let p of r){let g=p[0],y=(d=p.index)!=null?d:0;if(y<o)continue;s.push(e.slice(o,y));let b=(c=a.get(g))!=null?c:g,L=y>0?e[y-1]:"";L&&!/\s/.test(L)&&!/[\(\[\{!]/.test(L)&&s.push(" "),s.push(b),o=y+g.length}s.push(e.slice(o));let l=s.join("");return this.repairTruncatedWikilinks(l)}repairTruncatedWikilinks(e){if(!e||typeof e!="string")return e;let n=e;return n=n.replace(/\[\[([^\]\n#]+#zrr-chunk:[^\]\n|]+)(?=\n|$)/g,"[[$1]]"),n=n.replace(/\[\[([^\]\n#]+#zrr-chunk:([^\]\n|]+))\]\]/g,(t,i,r)=>{let a=this.escapeWikiLabel(this.buildDefaultChunkLabel(String(r||"").trim()));return`[[${i}\\|${a}]]`}),n}buildDefaultChunkLabel(e){let n=(e||"").trim(),t=n.match(/^p(\d+)$/i);return t?`p. ${t[1]}`:n||"source"}handleDoclingProgress(e,n){if(!e||e.type!=="progress")return;let t=Number(e.percent);if(!Number.isFinite(t))return;let i=typeof e.message=="string"&&e.message.trim()?e.message:"Docling extraction...";this.showStatusProgress(this.formatStatusLabel(i,n),Math.round(t))}async createChatNoteFromSession(e,n,t){let i=this.getChatExportDir();await this.ensureFolder(i),await this.getDocIndex();let r=this.sanitizeFileName(n)||"Zotero Chat",a=this.formatTimestamp(new Date),s=(0,u.normalizePath)(`${i}/${r}.md`),o=await this.resolveUniqueNotePath(s,`${r}-${a}.md`),l=await this.buildChatTranscript(n,t);await this.app.vault.adapter.write(o,l),await this.openNoteInNewTab(o),new u.Notice(`Chat copied to ${o}`)}async buildChatTranscript(e,n){var i,r,a;let t=[];t.push(`# ${e||"Zotero Chat"}`),t.push(""),t.push(`Created: ${new Date().toISOString()}`),t.push("");for(let s of n){let o=s.role==="user"?"## You":"## Assistant";t.push(o),t.push("");let l=s.role==="assistant"?await this.formatInlineCitations(s.content||"",(i=s.citations)!=null?i:[],(r=s.retrieved)!=null?r:[]):s.content||"";if(t.push(l.trim()),t.push(""),s.role==="assistant"&&((a=s.citations)!=null&&a.length)){t.push("### Relevant context sources");let d=this.formatCitationsMarkdown(s.citations);d&&(t.push(d),t.push(""))}}return t.join(`
`).trim()+`
`}async resolveUniqueNotePath(e,n){let t=this.app.vault.adapter;if(!await t.exists(e))return e;let i=A.default.dirname(e),r=(0,u.normalizePath)(A.default.join(i,n));if(!await t.exists(r))return r;let a=2;for(;a<1e3;){let s=(0,u.normalizePath)(A.default.join(i,`${A.default.basename(n,".md")}-${a}.md`));if(!await t.exists(s))return s;a+=1}return r}formatTimestamp(e){let n=t=>String(t).padStart(2,"0");return[e.getFullYear(),n(e.getMonth()+1),n(e.getDate()),"-",n(e.getHours()),n(e.getMinutes())].join("")}async openCitationTarget(e,n){let t=n!=null?n:await this.resolveCitationDisplay(e),i=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id),r=this.settings.preferObsidianNoteForCitations;if(!(r&&t.notePath&&i&&await this.openNoteAtChunk(t.notePath,i))){if(r&&t.notePath){await this.openNoteInMain(t.notePath);return}if(!r&&t.zoteroUrl){this.openExternalUrl(t.zoteroUrl);return}if(!(t.pdfPath&&await this.openPdfInMain(t.pdfPath,t.pageStart))){if(t.zoteroUrl){this.openExternalUrl(t.zoteroUrl);return}new u.Notice("Unable to open citation target.")}}}async rebuildNoteFromCache(){let e=await this.promptDocId();if(!e){new u.Notice("No doc_id provided.");return}await this.rebuildNoteFromCacheForDocId(e,!0)&&new u.Notice(`Rebuilt Zotero note for ${e}.`)}async reindexCurrentNoteFromCache(){let e=this.app.workspace.getActiveFile();if(!e){new u.Notice("No active note to reindex.");return}await this.reindexNoteFromCacheForFile(e,!0)}async reindexNoteFromCacheForFile(e,n){try{let t=await this.app.vault.read(e),i=await this.resolveDocIdForNote(e,t);if(!i){n&&new u.Notice("No doc_id found for this note.");return}await this.reindexDocIdFromCache(i,n)&&n&&new u.Notice(`Reindexed ${i}.`)}catch(t){n&&new u.Notice("Failed to reindex note."),console.error("Failed to reindex note",t)}}async rebuildDocIndexFromCache(){var d,c,p;let e=this.app.vault.adapter,n=await this.listDocIds(J),t=await this.listDocIds(V),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),r=Object.keys(i),a=Array.from(new Set([...n,...t,...r]));if(a.length===0){new u.Notice("No cached items found.");return}this.showStatusProgress("Rebuilding doc index...",0);let s=await this.getDocIndex(),o=0;for(let g of a){o+=1;let y={},b=i[g];b&&(y.note_path=b.note_path,y.note_title=b.note_title);let L=(0,u.normalizePath)(`${J}/${g}.json`);if(await e.exists(L))try{let v=await e.read(L),w=JSON.parse(v),S=(c=(d=w==null?void 0:w.data)!=null?d:w)!=null?c:{},C=typeof S.title=="string"?S.title:"";C&&(y.zotero_title=C);let P=this.extractShortTitleFromValues(S);P&&(y.short_title=P);let D=this.sanitizeFileName(C)||g,I=(0,u.normalizePath)(`${this.settings.outputNoteDir}/${D}.md`),z=(0,u.normalizePath)(`${this.settings.outputNoteDir}/${D}-${g}.md`);await e.exists(I)?(y.note_path=I,y.note_title=A.default.basename(I,".md")):await e.exists(z)&&(y.note_path=z,y.note_title=A.default.basename(z,".md"))}catch(v){console.error("Failed to read cached item JSON",v)}let _=(0,u.normalizePath)(`${V}/${g}.json`);if(await e.exists(_))try{let v=await e.read(_),w=JSON.parse(v);typeof(w==null?void 0:w.source_pdf)=="string"&&(y.pdf_path=w.source_pdf)}catch(v){console.error("Failed to read cached chunks JSON",v)}if(Object.keys(y).length>0){let w={...(p=s[g])!=null?p:{doc_id:g},...y,doc_id:g,updated_at:new Date().toISOString()};!w.note_title&&w.note_path&&(w.note_title=A.default.basename(w.note_path,".md")),s[g]=w}let f=Math.round(o/a.length*100);this.showStatusProgress(`Rebuilding doc index ${o}/${a.length}`,f)}await this.saveDocIndex(s);let l=await this.pruneDocIndexOrphans();this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),l.removed>0?new u.Notice(`Rebuilt doc index for ${a.length} items; pruned ${l.removed} stale entries.`):new u.Notice(`Rebuilt doc index for ${a.length} items.`)}async recreateMissingNotesFromCache(){if(this.recreateMissingNotesActive){new u.Notice("Recreate missing notes is already running.");return}this.recreateMissingNotesActive=!0,this.recreateMissingNotesAbort=!1,this.recreateMissingNotesProcess=null;try{let e=this.app.vault.adapter,n=await this.listDocIds(J),t=await this.listDocIds(V),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),r=Object.keys(i),a=Array.from(new Set([...n,...t,...r]));if(a.length===0){new u.Notice("No cached items found.");return}let s=[];for(let d of a){if(i[d])continue;let c=await this.getDocIndexEntry(d);if(c!=null&&c.note_path&&await e.exists(c.note_path))continue;let p=await this.inferNotePathFromCache(d);p&&await e.exists(p)||s.push(d)}if(s.length===0){new u.Notice("No missing notes detected.");return}this.showStatusProgress("Recreating missing notes...",0);let o=0,l=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;for(let d=0;d<s.length&&!this.recreateMissingNotesAbort;d+=1){let c=s[d],p=Math.round((d+1)/s.length*100);this.showStatusProgress(`Recreating ${d+1}/${s.length}`,p),l&&this.appendToLogFile(l,`Recreate missing note doc_id ${c} (${d+1}/${s.length})`,"recreate_missing_notes","INFO"),await this.rebuildNoteFromCacheForDocId(c,!1)&&(o+=1)}this.recreateMissingNotesAbort?(this.showStatusProgress("Canceled",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new u.Notice(`Canceled after ${o}/${s.length} notes.`)):(this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new u.Notice(`Recreated ${o}/${s.length} missing notes.`))}finally{this.recreateMissingNotesActive=!1,this.recreateMissingNotesProcess=null}}cancelRecreateMissingNotesFromCache(){if(!this.recreateMissingNotesActive){new u.Notice("No recreate job is running.");return}this.recreateMissingNotesAbort=!0;let e=this.recreateMissingNotesProcess;if(e&&!e.killed){try{e.kill("SIGTERM")}catch(n){console.warn("Failed to terminate recreate process",n)}window.setTimeout(()=>{if(e&&!e.killed)try{e.kill("SIGKILL")}catch(n){console.warn("Failed to force-kill recreate process",n)}},2e3)}new u.Notice("Canceling recreate missing notes...")}buildRedisCommand(e){let n=[`*${e.length}\r
`];for(let t of e){let i=String(t);n.push(`$${Buffer.byteLength(i)}\r
${i}\r
`)}return n.join("")}async checkRedisConnectionWithUrl(e,n=2e3){let t=(e||"").trim();if(!t)return{ok:!1,message:"Redis URL is not configured."};let i;try{i=new URL(t)}catch(d){return{ok:!1,message:"Redis URL is invalid."}}let r=i.hostname||"127.0.0.1",a=Number(i.port)||(i.protocol==="rediss:"||i.protocol==="redis+tls:"?6380:6379),s=decodeURIComponent(i.username||""),o=decodeURIComponent(i.password||""),l=i.protocol==="rediss:"||i.protocol==="redis+tls:";return new Promise(d=>{let c=l?an.default.connect({host:r,port:a,timeout:n,rejectUnauthorized:!1}):ge.default.createConnection({host:r,port:a,timeout:n}),p="",g=o||s?"auth":"ping",y=!1,b=(_,f)=>{if(!y){y=!0;try{c.end(),c.destroy()}catch(v){}d({ok:_,message:f})}},L=_=>{let f=_.trim();if(f){if(f.startsWith("-NOAUTH")){b(!1,"Redis requires authentication. Check your Redis URL credentials.");return}if(f.startsWith("-WRONGPASS")||f.toLowerCase().includes("invalid password")){b(!1,"Redis authentication failed. Check your Redis URL credentials.");return}if(f.startsWith("-ERR")){b(!1,`Redis error: ${f}`);return}if(g==="auth"){if(f.startsWith("+OK")){g="ping",p="",c.write(this.buildRedisCommand(["PING"]));return}b(!1,`Redis auth failed: ${f}`);return}f.startsWith("+PONG")&&b(!0)}};c.on("connect",()=>{if(g==="auth"){let _=s?["AUTH",s,o]:["AUTH",o];c.write(this.buildRedisCommand(_))}else c.write(this.buildRedisCommand(["PING"]))}),c.on("data",_=>{var v;p+=_.toString();let f=p.split(/\r?\n/);p=(v=f.pop())!=null?v:"";for(let w of f)L(w)}),c.on("timeout",()=>{b(!1,"Timed out connecting to Redis.")}),c.on("error",_=>{b(!1,`Redis connection failed: ${_.message}`)}),c.on("close",()=>{y||b(!1,"Redis connection closed unexpectedly.")})})}async checkRedisConnection(e=2e3){return this.checkRedisConnectionWithUrl(this.settings.redisUrl,e)}async ensureRedisAvailable(e){let n=await this.checkRedisConnection();if(n.ok)return!0;let t=n.message?`Redis unavailable for ${e}: ${n.message}`:`Redis unavailable for ${e}.`;return this.notifyContainerOnce(t),!1}getPythonErrorMessage(e){if(e instanceof Error)return e.message||String(e);if(typeof e=="string")return e;try{return JSON.stringify(e)}catch(n){return String(e)}}classifyIndexingError(e){let n=e.toLowerCase();return n.includes("embedding dim mismatch")||n.includes("dim mismatch")?"embed_dim_mismatch":n.includes("chunks json not found")?"chunks_missing":n.includes("embedding failed")||n.includes("embedding request failed")||n.includes("unloaded")||n.includes("crashed")||n.includes("model does not exist")||n.includes("failed to load model")||n.includes("connection refused")||n.includes("econnrefused")||n.includes("max retries exceeded")||n.includes("failed to establish a new connection")||n.includes("failed to fetch models")?"embed_failure":"unknown"}async confirmRebuildIndex(e){return new Promise(n=>{new je(this.app,e,n).open()})}async confirmPurgeRedisOrphans(){return new Promise(e=>{new $e(this.app,e).open()})}async dropRedisIndex(e=!1){await this.ensureBundledTools();let n=this.getPluginDir(),t=A.default.join(n,"tools","drop_redis_index.py"),i=["--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName()];e&&i.push("--drop-docs"),await this.runPython(t,i)}async dropAndRebuildRedisIndex(){if(this.reindexCacheActive){new u.Notice("Reindex already running.");return}if(!(!await this.ensureRedisAvailable("drop/rebuild")||!await this.confirmRebuildIndex("This will remove the current RedisSearch index and rebuild it from cached chunks."))){try{await this.dropRedisIndex(!0)}catch(n){let t=n instanceof Error?n.message:String(n);if(t.includes("Unknown Index name")||t.includes("Unknown index name"))console.warn("Redis index missing; skipping drop step.");else{console.error("Failed to drop Redis index",n),new u.Notice("Failed to drop Redis index. See console for details.");return}}await this.reindexRedisFromCache()}}async purgeRedisOrphanedKeys(){var r,a,s,o,l;if(!await this.ensureRedisAvailable("purge orphans")||!await this.confirmPurgeRedisOrphans())return;try{await this.ensureBundledTools()}catch(d){new u.Notice("Failed to sync bundled tools. See console for details."),console.error(d);return}let n=this.getPluginDir(),t=A.default.join(n,"tools","purge_redis_orphans.py"),i=["--redis-url",this.settings.redisUrl,"--key-prefix",this.getRedisKeyPrefix(),"--chunk-dir",this.getAbsoluteVaultPath(V),"--item-dir",this.getAbsoluteVaultPath(J)];try{let d=await this.runPythonWithOutput(t,i),c=null;try{c=d?JSON.parse(d):null}catch(b){console.warn("Failed to parse purge output",b)}if(!c){new u.Notice("Purge completed. See console for details.");return}let p=[`Keys scanned: ${(r=c.keys_scanned)!=null?r:0}`,`Keys deleted: ${(a=c.keys_deleted)!=null?a:0}`,`Docs checked: ${(s=c.docs_checked)!=null?s:0}`,`Orphan docs: ${(o=c.orphan_doc_count)!=null?o:0}`],g=await this.pruneDocIndexOrphans();p.push(`Doc index entries removed: ${g.removed}`),g.updated>0&&p.push(`Doc index entries updated: ${g.updated}`);let y=Array.isArray(c.sample_orphan_doc_ids)?c.sample_orphan_doc_ids.filter(Boolean):[];y.length&&p.push("","Sample doc_ids:",...y.map(b=>`- ${b}`)),new me(this.app,"Redis orphan purge",p.join(`
`)).open(),((l=c.keys_deleted)!=null?l:0)===0?new u.Notice("No orphaned Redis keys found."):new u.Notice(`Deleted ${c.keys_deleted} Redis keys.`)}catch(d){console.error("Failed to purge Redis orphans",d),new u.Notice("Failed to purge Redis orphans. See console for details.")}}async reindexRedisFromCache(){if(this.lastReindexFailure=null,this.reindexCacheActive)return new u.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;let e=null,n=0;try{await this.ensureBundledTools()}catch(o){return new u.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let t=await this.listDocIds(V);if(t.length===0)return new u.Notice("No cached chunks found."),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let i=this.getPluginDir(),r=A.default.join(i,"tools","index_redisearch.py"),a=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null,s=0;this.showStatusProgress("Reindexing cached chunks...",0),a&&this.appendToLogFile(a,`Reindex started: ${t.length} cached items`,"index_redisearch","INFO");for(let o of t){s+=1;let l=Math.round(s/t.length*100);this.showStatusProgress(`Reindexing ${s}/${t.length}`,l);let d=(0,u.normalizePath)(`${V}/${o}.json`);try{let c=["--chunks-json",this.getAbsoluteVaultPath(d),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(c),this.appendEmbedContextArgs(c),this.settings.embedIncludeMetadata&&c.push("--embed-include-metadata"),this.appendChunkTaggingArgs(c,{allowRegenerate:!1}),a&&this.appendToLogFile(a,`Reindexing doc_id ${o}`,"index_redisearch","INFO"),await this.runPythonStreaming(r,c,p=>{!a||!p||(p==null?void 0:p.type)==="progress"&&p.message&&this.appendToLogFile(a,String(p.message),"index_redisearch","INFO")},()=>{},a,"index_redisearch")}catch(c){n+=1;let p=this.getPythonErrorMessage(c),g=this.classifyIndexingError(p);if(console.error(`Failed to reindex ${o}`,c),g==="chunks_missing"){new u.Notice(`Chunks cache missing for ${o}. Reimport or rebuild this note.`);continue}if(g==="embed_dim_mismatch"){e={kind:"embed_dim_mismatch",message:p};break}if(g==="embed_failure"){e={kind:"embed_failure",message:p};break}}}if(e){if(this.showStatusProgress("Aborted",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,e.kind==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(l){return new u.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error(l),this.lastReindexFailure="unknown",!1}this.lastReindexFailure="embed_dim_mismatch"}else new u.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing."),this.lastReindexFailure="embed_failure";return!1}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),n===0?new u.Notice(`Reindexed ${t.length} cached items.`):new u.Notice(`Reindexed ${t.length-n}/${t.length} items (see console).`);try{await this.pruneDocIndexOrphans()}catch(o){console.warn("Failed to prune doc index orphans",o)}return this.reindexCacheActive=!1,this.lastReindexFailure=null,!0}async reindexDocIdFromCache(e,n){if(this.lastReindexFailure=null,this.reindexCacheActive)return n&&new u.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;try{await this.ensureBundledTools()}catch(o){return n&&new u.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let t=(0,u.normalizePath)(`${V}/${e}.json`);if(!await this.app.vault.adapter.exists(t))return n&&new u.Notice(`Chunks cache missing for ${e}.`),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let r=this.getPluginDir(),a=A.default.join(r,"tools","index_redisearch.py"),s=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;this.showStatusProgress(`Reindexing ${e}...`,0),s&&this.appendToLogFile(s,`Reindexing doc_id ${e}`,"index_redisearch","INFO");try{let o=["--chunks-json",this.getAbsoluteVaultPath(t),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(o),this.appendEmbedContextArgs(o),this.settings.embedIncludeMetadata&&o.push("--embed-include-metadata"),this.appendChunkTaggingArgs(o,{allowRegenerate:!1}),await this.runPythonStreaming(a,o,l=>{if((l==null?void 0:l.type)==="progress"&&l.total){let d=Math.round(l.current/l.total*100),c=typeof l.message=="string"&&l.message.trim()?l.message:`Indexing chunks ${l.current}/${l.total}`;this.showStatusProgress(this.formatStatusLabel(c),d)}},()=>{},s,"index_redisearch")}catch(o){let l=this.getPythonErrorMessage(o),d=this.classifyIndexingError(l);if(console.error(`Failed to reindex ${e}`,o),d==="embed_dim_mismatch"){if(this.lastReindexFailure="embed_dim_mismatch",n&&await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),this.reindexCacheActive=!1,await this.reindexRedisFromCache()}catch(p){new u.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error(p),this.lastReindexFailure="unknown"}}else d==="embed_failure"?(this.lastReindexFailure="embed_failure",n&&new u.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing.")):n&&new u.Notice(`Failed to reindex ${e}. See console for details.`);return this.showStatusProgress("Failed",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!1}return this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!0}async reindexChunkUpdates(e,n,t,i){if(!t.length&&!i.length||!await this.ensureRedisAvailable("reindex updates"))return;let r=this.getPluginDir(),a=A.default.join(r,"tools","index_redisearch.py"),s=["--chunks-json",this.getAbsoluteVaultPath(n),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert"];this.appendEmbedSubchunkArgs(s),this.appendEmbedContextArgs(s),this.settings.embedIncludeMetadata&&s.push("--embed-include-metadata"),this.appendChunkTaggingArgs(s,{allowRegenerate:!1}),t.length&&s.push("--chunk-ids",t.join(",")),i.length&&s.push("--delete-chunk-ids",i.join(","));try{await this.runPython(a,s)}catch(o){let l=this.getPythonErrorMessage(o),d=this.classifyIndexingError(l);if(console.error(`Failed to reindex updated chunks for ${e}`,o),d==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(p){new u.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error(p)}return}d==="embed_failure"&&new u.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.")}}async promptZoteroItem(){return new Promise(e=>{new Be(this.app,this,e).open()})}async listDocIds(e){let n=this.app.vault.adapter,t=(0,u.normalizePath)(e);return await n.exists(t)?(await n.list(t)).files.filter(r=>r.endsWith(".json")).map(r=>A.default.basename(r,".json")):[]}async listMarkdownFiles(e){let n=this.app.vault.adapter,t=(0,u.normalizePath)(e);if(!await n.exists(t))return[];let i=[t],r=[];for(;i.length>0;){let a=i.pop();if(!a)continue;let s=await n.list(a);for(let o of s.files)o.endsWith(".md")&&r.push(o);for(let o of s.folders)i.push(o)}return r}extractDocIdFromFrontmatter(e){let n=e.match(/^---\s*\n([\s\S]*?)\n---/);if(!n)return null;let i=n[1].split(/\r?\n/);for(let r of i){let a=r.trim();if(!a||a.startsWith("#"))continue;let s=a.split(":");if(s.length<2)continue;let o=s[0].trim().toLowerCase();if(o!=="doc_id"&&o!=="zotero_key")continue;let d=a.slice(a.indexOf(":")+1).trim().replace(/^["']|["']$/g,"").trim();if(d)return d}return null}hasDocIdFieldInFrontmatter(e){let n=e.match(/^---\s*\n([\s\S]*?)\n---/);return n?/^\s*doc_id\s*:/im.test(n[1]):!1}ensureDocIdInFrontmatter(e,n){let t=e.trim(),i=`doc_id: ${this.escapeYamlString(n)}`;return t?/^\s*doc_id\s*:/im.test(t)?t:`${i}
${t}`:i}ensureDocIdInNoteContent(e,n){var g,y;let t=e.match(/^---\s*\n([\s\S]*?)\n---\s*\n?/),i=`doc_id: ${this.escapeYamlString(n)}`;if(!t)return`---
${i}
---

${e.trimStart()}`;let a=((g=t[1])!=null?g:"").split(/\r?\n/),s=!1,o=a.map(b=>/^\s*doc_id\s*:/i.test(b)?(s=!0,i):b);s||o.unshift(i);let l=o.join(`
`).trim(),d=(y=t.index)!=null?y:0,c=e.slice(0,d),p=e.slice(d+t[0].length).replace(/^\n+/,"");return`${c}---
${l}
---
${p}`}async findDocIdByNotePath(e){let n=(0,u.normalizePath)(e),t=await this.getDocIndex();for(let[i,r]of Object.entries(t))if(r!=null&&r.note_path&&(0,u.normalizePath)(r.note_path)===n)return i;return null}async resolveDocIdForNote(e,n){let t=this.extractDocIdFromFrontmatter(n),i=this.hasDocIdFieldInFrontmatter(n);if(t&&i)return t;let r=this.extractDocIdFromSyncMarker(n),a=await this.findDocIdByNotePath(e.path),s=t||r||a;if(!s)return ce.test(n)&&!this.missingDocIdWarned.has(e.path)&&(new u.Notice("This Zotero note is missing a doc_id in frontmatter. Reimport or add doc_id manually."),this.missingDocIdWarned.add(e.path)),null;if(!i||!t){let o=this.ensureDocIdInNoteContent(n,s);o!==n&&await this.writeNoteWithSyncSuppressed(e.path,o)}return s}async scanNotesForDocIds(e){var r;let n=this.app.vault.adapter,t=await this.listMarkdownFiles(e),i={};for(let a of t)try{let s=await n.read(a),o=(r=this.extractDocIdFromFrontmatter(s))!=null?r:this.extractDocIdFromSyncMarker(s);if(!o)continue;i[o]={doc_id:o,note_path:a,note_title:A.default.basename(a,".md"),updated_at:new Date().toISOString()}}catch(s){console.error("Failed to read note for doc_id scan",s)}return i}setupStatusBar(){let e=this.addStatusBarItem();e.addClass("zrr-status-progress"),e.addClass("status-bar-item-segment"),e.style.display="none";let n=e.createEl("span",{text:"Idle"});n.addClass("zrr-status-label");let i=e.createEl("div",{cls:"zrr-status-bar"}).createEl("div",{cls:"zrr-status-bar-inner"});this.statusBarEl=e,this.statusLabelEl=n,this.statusBarInnerEl=i}showStatusProgress(e,n){if(!(!this.statusBarEl||!this.statusLabelEl||!this.statusBarInnerEl))if(this.statusBarEl.style.display="flex",this.statusLabelEl.setText(e),n===null)this.statusBarInnerEl.addClass("indeterminate"),this.statusBarInnerEl.style.width="40%";else{this.statusBarInnerEl.removeClass("indeterminate");let t=Math.max(0,Math.min(100,n));this.statusBarInnerEl.style.width=`${t}%`}}clearStatusProgress(){!this.statusBarEl||!this.statusBarInnerEl||(this.statusBarEl.style.display="none",this.statusBarInnerEl.removeClass("indeterminate"),this.statusBarInnerEl.style.width="0%")}formatStatusLabel(e,n){return n?`${e} (Text layer quality ${n})`:e}async readDoclingQualityLabel(e){var n,t,i;try{let r=await this.app.vault.adapter.read(e),a=JSON.parse(r),s=(i=(n=a==null?void 0:a.metadata)==null?void 0:n.effective_confidence_proxy)!=null?i:(t=a==null?void 0:a.metadata)==null?void 0:t.confidence_proxy;if(typeof s=="number")return s.toFixed(2)}catch(r){console.warn("Failed to read Docling quality metadata",r)}return null}async readDoclingMetadata(e){try{let n=await this.app.vault.adapter.read(e),t=JSON.parse(n),i=t==null?void 0:t.metadata;if(i&&typeof i=="object")return i}catch(n){console.warn("Failed to read Docling metadata",n)}return null}async readDoclingQualityLabelFromPdf(e,n){var t;try{let i=this.getPluginDir(),r=A.default.join(i,"tools","docling_extract.py"),a=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,s=["--quality-only","--pdf",e,"--ocr",a],o=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;o&&s.push("--log-file",o),this.settings.ocrMode==="force_low_quality"&&s.push("--force-ocr-low-quality"),s.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),n&&s.push("--language-hint",n);let l=await this.runPythonWithOutput(r,s,o),d=JSON.parse(l),c=(t=d==null?void 0:d.effective_confidence_proxy)!=null?t:d==null?void 0:d.confidence_proxy;if(typeof c=="number")return c.toFixed(2)}catch(i){console.warn("Failed to read Docling quality from PDF",i)}return null}async promptDocId(){return new Promise(e=>{new Pe(this.app,"Rebuild Zotero note from cache","Enter Zotero doc_id (e.g., ABC123)",n=>e(n),"Doc ID cannot be empty.").open()})}async promptLanguageHint(){return new Promise(e=>{new Ve(this.app,e).open()})}registerRibbonIcons(){(0,u.addIcon)("zrr-picker",hn),(0,u.addIcon)("zrr-chat",yn),(0,u.addIcon)("zrr-pdf",Re),this.addRibbonIcon("zrr-picker","Import Zotero item and index",()=>this.importZoteroItem()).addClass("zrr-ribbon-picker"),this.addRibbonIcon("zrr-chat","Open Zotero RAG chat",()=>this.openChatView(!0)).addClass("zrr-ribbon-chat")}async confirmOverwrite(e){return new Promise(n=>{new qe(this.app,e,n).open()})}async resolveLanguageHint(e,n){let t=typeof e.language=="string"?e.language:"",i=this.normalizeZoteroLanguage(t);if(i)return i;let r=await this.promptLanguageHint();if(r===null)return console.info("Language selection canceled."),null;let a=this.normalizeZoteroLanguage(r);if(!a)return console.info("Language selection empty; skipping Zotero update."),"";if(e.language=a,console.info("Language selected",{language:a,itemKey:n}),n)try{await this.updateZoteroItemLanguage(n,e,a),new u.Notice("Saved language to Zotero.")}catch(s){new u.Notice("Failed to write language back to Zotero."),console.error(s)}else console.warn("Language selected but itemKey is missing; skipping Zotero update.");return a}normalizeZoteroLanguage(e){return(e||"").trim().toLowerCase()}buildDoclingLanguageHint(e){let n=this.normalizeZoteroLanguage(e!=null?e:"");if(!n)return null;let t=n.split(/[^a-z]+/).filter(Boolean),i=t.some(a=>["de","deu","ger","german"].includes(a)),r=t.some(a=>["en","eng","english"].includes(a));return i&&r?"deu+eng":i?"deu":r?"eng":t.length===1&&Xe[t[0]]?Xe[t[0]]:n}async fetchZoteroItem(e){try{let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),t=await this.requestLocalApi(n,`Zotero item fetch failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(n){return console.warn("Failed to fetch Zotero item from local API",n),this.canUseWebApi()?this.fetchZoteroItemWeb(e):null}}async fetchZoteroItemCsl(e){try{let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}?format=csljson`),t=await this.requestLocalApi(n,`Zotero CSL fetch failed for ${n}`);return this.parseCslPayload(t)}catch(n){return console.warn("Failed to fetch Zotero CSL from local API",n),this.canUseWebApi()?this.fetchZoteroItemCslWeb(e):null}}async fetchZoteroCollectionTitle(e){var r,a,s,o,l,d;let n=(e||"").trim();if(!n)return"";let t=this.collectionTitleCache.get(n);if(t!==void 0)return t;let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/collections/${n}`);try{let c=await this.requestLocalApi(i,`Zotero collection fetch failed for ${i}`),p=JSON.parse(c.toString("utf8")),g=String((s=(a=(r=p==null?void 0:p.data)==null?void 0:r.name)!=null?a:p==null?void 0:p.name)!=null?s:"").trim();return this.collectionTitleCache.set(n,g),g}catch(c){if(!this.canUseWebApi())return this.collectionTitleCache.set(n,""),"";try{let p=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/collections/${n}`),g=await this.requestWebApi(p,`Zotero Web API collection fetch failed for ${p}`),y=JSON.parse(g.toString("utf8")),b=String((d=(l=(o=y==null?void 0:y.data)==null?void 0:o.name)!=null?l:y==null?void 0:y.name)!=null?d:"").trim();return this.collectionTitleCache.set(n,b),b}catch(p){return console.warn("Failed to fetch Zotero collection title",p),this.collectionTitleCache.set(n,""),""}}}async resolveCollectionTitles(e){let t=(Array.isArray(e.collections)?e.collections:[]).map(r=>String(r||"").trim()).filter(Boolean);if(!t.length)return[];let i=[];for(let r of t){let a=await this.fetchZoteroCollectionTitle(r);a&&i.push(a)}return i}async fetchZoteroItemWeb(e){try{let n=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}`),t=await this.requestWebApi(n,`Zotero Web API fetch failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(n){return console.warn("Failed to fetch Zotero item from Web API",n),null}}async fetchZoteroItemCslWeb(e){try{let n=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}?format=csljson`),t=await this.requestWebApi(n,`Zotero Web API CSL fetch failed for ${n}`);return this.parseCslPayload(t)}catch(n){return console.warn("Failed to fetch Zotero CSL from Web API",n),null}}parseCslPayload(e){try{let n=JSON.parse(e.toString("utf8"));return Array.isArray(n)?typeof n[0]=="object"&&n[0]?n[0]:null:typeof n=="object"&&n?n:null}catch(n){return console.warn("Failed to parse CSL payload",n),null}}async searchZoteroItemsWeb(e){let n=["data,meta,children","data,meta"];for(let t of n){let i=new URLSearchParams;i.set("itemType","-attachment"),i.set("limit","25"),i.set("include",t),e.trim()&&i.set("q",e.trim());let r=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items?${i.toString()}`);try{let a=await this.requestWebApi(r,`Zotero Web API search failed for ${r}`),s=JSON.parse(a.toString("utf8"));return Array.isArray(s)?s.map(o=>{var l,d,c,p;return{key:(d=o.key)!=null?d:(l=o.data)==null?void 0:l.key,data:(c=o.data)!=null?c:{},meta:(p=o.meta)!=null?p:{}}}).filter(o=>typeof o.key=="string"&&o.key.trim().length>0):[]}catch(a){console.warn("Failed to search Zotero via web API",a)}}return[]}async updateZoteroItemLanguage(e,n,t){try{await this.updateZoteroItemLanguageLocal(e,n,t);return}catch(i){if(!this.canUseWebApi())throw i;let r=i instanceof Error?i.message:String(i);console.info("Local Zotero write failed; trying Web API",{itemKey:e,reason:r}),await this.updateZoteroItemLanguageWeb(e,n,t)}}async updateZoteroItemLanguageLocal(e,n,t){var _,f,v,w,S,C;let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),r={...n,language:t},a={"Content-Type":"application/json","Zotero-API-Version":"3"},s=typeof r.version=="number"?r.version:Number(r.version);Number.isNaN(s)||(a["If-Unmodified-Since-Version"]=String(s)),console.info("Zotero language PUT",{url:i,itemKey:e,language:t});try{let P=await this.requestLocalApiWithBody(i,"PUT",r,a,`Zotero update failed for ${i}`);console.info("Zotero language PUT response",{status:P.statusCode})}catch(P){if(!(P instanceof Error?P.message:String(P)).includes("status 501"))throw P;let I=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.info("Zotero language PUT unsupported; trying POST",{postUrl:I});let z=await this.requestLocalApiWithBody(I,"POST",[r],a,`Zotero update failed for ${I}`);console.info("Zotero language POST response",{status:z.statusCode})}let o=await this.fetchZoteroItem(e);if(this.normalizeZoteroLanguage(typeof((_=o==null?void 0:o.data)==null?void 0:_.language)=="string"?o.data.language:"")===this.normalizeZoteroLanguage(t))return;let d={...(f=o==null?void 0:o.data)!=null?f:n,language:t},c={key:e,version:(S=(w=(v=o==null?void 0:o.data)==null?void 0:v.version)!=null?w:o==null?void 0:o.version)!=null?S:s,data:d},p={...a},g=typeof c.version=="number"?c.version:Number(c.version);Number.isNaN(g)?delete p["If-Unmodified-Since-Version"]:p["If-Unmodified-Since-Version"]=String(g);let y=await this.requestLocalApiWithBody(i,"PUT",c,p,`Zotero update failed for ${i}`);console.info("Zotero language PUT retry response",{status:y.statusCode});let b=await this.fetchZoteroItem(e);if(this.normalizeZoteroLanguage(typeof((C=b==null?void 0:b.data)==null?void 0:C.language)=="string"?b.data.language:"")!==this.normalizeZoteroLanguage(t))throw new Error("Language update did not persist in Zotero.")}async updateZoteroItemLanguageWeb(e,n,t){var y,b,L,_,f;let i=this.getWebApiLibraryPath();if(!i)throw new Error("Web API library path is not configured.");let r=this.buildWebApiUrl(`/${i}/items/${e}`),a=await this.fetchZoteroItemWeb(e),s={...(y=a==null?void 0:a.data)!=null?y:n,language:t},o={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},l=(_=(L=(b=a==null?void 0:a.data)==null?void 0:b.version)!=null?L:a==null?void 0:a.version)!=null?_:n==null?void 0:n.version,d=typeof l=="number"?l:Number(l);Number.isNaN(d)||(o["If-Unmodified-Since-Version"]=String(d)),console.info("Zotero Web API language PUT",{url:r,itemKey:e,language:t});let c=await this.requestWebApiWithBody(r,"PUT",s,o,`Zotero Web API update failed for ${r}`);console.info("Zotero Web API language PUT response",{status:c.statusCode});let p=await this.fetchZoteroItemWeb(e);if(this.normalizeZoteroLanguage(typeof((f=p==null?void 0:p.data)==null?void 0:f.language)=="string"?p.data.language:"")!==this.normalizeZoteroLanguage(t))throw new Error("Language update did not persist in Zotero Web API.")}async updateZoteroItemFields(e,n,t){try{await this.updateZoteroItemFieldsLocal(e,n,t);return}catch(i){if(!this.canUseWebApi())throw i;let r=i instanceof Error?i.message:String(i);console.info("Local Zotero write failed; trying Web API",{itemKey:e,reason:r}),await this.updateZoteroItemFieldsWeb(e,n,t)}}async updateZoteroItemFieldsLocal(e,n,t){let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),r={...n,...t},a={"Content-Type":"application/json","Zotero-API-Version":"3"},s=typeof r.version=="number"?r.version:Number(r.version);Number.isNaN(s)||(a["If-Unmodified-Since-Version"]=String(s)),console.info("Zotero metadata PUT",{url:i,itemKey:e});try{let o=await this.requestLocalApiWithBody(i,"PUT",r,a,`Zotero update failed for ${i}`);console.info("Zotero metadata PUT response",{status:o.statusCode})}catch(o){if(!(o instanceof Error?o.message:String(o)).includes("status 501"))throw o;let d=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.info("Zotero metadata PUT unsupported; trying POST",{postUrl:d});let c=await this.requestLocalApiWithBody(d,"POST",[r],a,`Zotero update failed for ${d}`);console.info("Zotero metadata POST response",{status:c.statusCode})}}async updateZoteroItemFieldsWeb(e,n,t){var p,g,y,b;let i=this.getWebApiLibraryPath();if(!i)throw new Error("Web API library path is not configured.");let r=this.buildWebApiUrl(`/${i}/items/${e}`),a=await this.fetchZoteroItemWeb(e),s={...(p=a==null?void 0:a.data)!=null?p:n,...t},o={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},l=(b=(y=(g=a==null?void 0:a.data)==null?void 0:g.version)!=null?y:a==null?void 0:a.version)!=null?b:n==null?void 0:n.version,d=typeof l=="number"?l:Number(l);Number.isNaN(d)||(o["If-Unmodified-Since-Version"]=String(d)),console.info("Zotero Web API metadata PUT",{url:r,itemKey:e});let c=await this.requestWebApiWithBody(r,"PUT",s,o,`Zotero Web API update failed for ${r}`);console.info("Zotero Web API metadata PUT response",{status:c.statusCode})}getDocId(e){let n=[e.key,e.itemKey,e.id,e.citationKey];for(let t of n)if(typeof t=="string"&&t.trim())return t.trim();return null}sanitizeFileName(e){let n=e.replace(/[\\/:*?"<>|]/g,"").replace(/\s+/g," ").trim();return n?n.replace(/[.]+$/g,"").trim().slice(0,120):""}registerNoteRenameHandler(){this.registerEvent(this.app.vault.on("rename",async e=>{var n;if(!(!(e instanceof u.TFile)||e.extension!=="md"))try{let t=await this.app.vault.read(e),i=(n=this.extractDocIdFromFrontmatter(t))!=null?n:this.extractDocIdFromSyncMarker(t);if(!i)return;await this.updateDocIndex({doc_id:i,note_path:e.path,note_title:A.default.basename(e.path,".md")})}catch(t){console.warn("Failed to update doc index for renamed note",t)}}))}registerNoteSyncHandler(){this.registerEvent(this.app.vault.on("modify",e=>{if(!(!(e instanceof u.TFile)||e.extension!=="md")){if(this.noteMetadataSyncSuppressed.has(e.path)){this.noteSyncSuppressed.has(e.path)&&this.scheduleNoteSync(e,2500);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2500),this.scheduleNoteMetadataSync(e,2500,"save");return}this.scheduleNoteSync(e),this.scheduleNoteMetadataSync(e,1200,"save")}}))}registerNoteOpenHandler(){this.registerEvent(this.app.workspace.on("file-open",e=>{!(e instanceof u.TFile)||e.extension!=="md"||(this.syncPdfSidebarForFile(e),this.updatePreviewScrollHandler(),this.scheduleNoteMetadataSync(e,600,"open"))}))}registerPreviewScrollSyncHandlers(){this.registerEvent(this.app.workspace.on("active-leaf-change",()=>{this.updatePreviewScrollHandler(),this.maybeSyncPendingPdf()})),this.registerEvent(this.app.workspace.on("layout-change",()=>{this.updatePreviewScrollHandler(),this.maybeSyncPendingPdf()})),this.updatePreviewScrollHandler()}async maybeSyncPendingPdf(){var n,t;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((t=(n=this.pdfSidebarLeaf.view)==null?void 0:n.getViewType)==null?void 0:t.call(n))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let e=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(e.docId,e.pageNumber,e.chunkId)}updatePreviewScrollHandler(){var i;let e=this.app.workspace.getActiveViewOfType(u.MarkdownView);if(!e||e.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let n=(i=e.previewMode)==null?void 0:i.containerEl;if(!n){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===n)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(e);n.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=n,this.previewScrollHandler=t,this.schedulePreviewSync(e)}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(e){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(e)}))}syncPdfSidebarForPreview(e){let n=this.previewScrollEl;if(!n)return;let t=e.getViewData();if(!t)return;let i=ee.Text.of(t.split(/\r?\n/)),r=Ce(i);if(!r)return;let a=this.getPreviewTopLineNumber(n);if(a===null)return;let s=Ze(i,a+1);if(!s)return;let o=Ue(s.text);!(o!=null&&o.pageNumber)&&!(o!=null&&o.chunkId)||this.syncPdfSidebarForDoc(r,o==null?void 0:o.pageNumber,o==null?void 0:o.chunkId)}getPreviewTopLineNumber(e){var i;let n=e.getBoundingClientRect().top,t=e.querySelectorAll("[data-line]");for(let r of Array.from(t))if(r.getBoundingClientRect().bottom>=n+2){let s=(i=r.getAttribute("data-line"))!=null?i:"",o=Number.parseInt(s,10);if(Number.isFinite(o))return o}return null}registerNoteDeleteMenu(){this.registerEvent(this.app.workspace.on("file-menu",(e,n)=>{if(!(n instanceof u.TFile)||n.extension!=="md")return;let t=(0,u.normalizePath)(this.settings.outputNoteDir),i=(0,u.normalizePath)(n.path);!(t&&(i===t||i.startsWith(`${t}/`)))&&!this.isZoteroNoteFile(n)||(e.addItem(a=>{a.setTitle("Reindex note from cache").onClick(()=>this.reindexNoteFromCacheForFile(n,!0))}),e.addItem(a=>{a.setTitle("Delete Zotero note and cached data").onClick(()=>this.deleteZoteroNoteAndCacheForFile(n))}))}))}findChunkStartLine(e,n){let t=n!=null?n:e.getCursor().line;for(;t>=0;t-=1){let i=e.getLine(t);if(pe.test(i))return{line:t,text:i};if(ce.test(i)||fe.test(i))break}return null}findChunkEndLine(e,n){for(let t=n;t<e.lineCount();t+=1){let i=e.getLine(t);if(De.test(i))return t;if(fe.test(i))break}return null}findChunkAtCursor(e,n){let t=n!=null?n:e.getCursor().line,i=this.findChunkStartLine(e,t);if(!i)return null;let r=this.findChunkEndLine(e,i.line+1);return r===null||t<i.line||t>r?null:{startLine:i.line,endLine:r,text:i.text}}toggleChunkExclude(e,n){var c;let t=this.findChunkAtCursor(e,n);if(!t){new u.Notice("No synced chunk found at cursor.");return}let i=t.text.match(pe);if(!i){new u.Notice("Invalid chunk marker.");return}let r=((c=i[1])!=null?c:"").trim(),a=t.endLine,s=!1;if(a!==null){for(let p=t.startLine+1;p<a;p+=1)if(we.test(e.getLine(p))){s=!0;break}}let l=/\bexclude\b/i.test(r)||/\bdelete\b/i.test(r)||s;l?r=r.replace(/\b(delete|exclude)\b/gi,"").replace(/\s{2,}/g," ").trim():r=r?`${r} exclude`:"exclude";let d=`<!-- zrr:chunk${r?" "+r:""} -->`;if(d!==t.text&&e.replaceRange(d,{line:t.startLine,ch:0},{line:t.startLine,ch:t.text.length}),l&&a!==null){let p=[];for(let g=t.startLine+1;g<a;g+=1)we.test(e.getLine(g))&&p.push(g);for(let g=p.length-1;g>=0;g-=1){let y=p[g],b=e.lineCount();y<b-1?e.replaceRange("",{line:y,ch:0},{line:y+1,ch:0}):e.replaceRange("",{line:y,ch:0},{line:y,ch:e.getLine(y).length})}}new u.Notice(l?"Chunk included.":"Chunk excluded from index.")}toggleChunkExcludeFromToolbar(e){let n=this.app.workspace.getActiveViewOfType(u.MarkdownView);if(!n){new u.Notice("No active editor found.");return}let t=Math.max(0,e-1);this.toggleChunkExclude(n.editor,t)}async openChunkTagEditor(e,n){var c,p;let t=(0,u.normalizePath)(`${V}/${e}.json`),i=this.app.vault.adapter;if(!await i.exists(t)){new u.Notice("Chunk cache not found for this document.");return}let r=await this.readChunkPayload(t);if(!r){new u.Notice("Failed to read chunk cache.");return}let a=Array.isArray(r.chunks)?r.chunks:[],s=this.resolveChunkFromPayload(a,n,e);if(!s){new u.Notice(`Chunk ${n} not found in cache.`);return}let o=(c=s.chunk_tags)!=null?c:[],l=Array.isArray(o)?o.map(g=>String(g).trim()).filter(g=>g):String(o).split(/[|,;\n]+/).map(g=>g.trim()).filter(g=>g),d=typeof s.text=="string"?s.text:String((p=s.text)!=null?p:"");new Te(this.app,n,l,async g=>{g.length>0?s.chunk_tags=g:delete s.chunk_tags,await i.write(t,JSON.stringify(r,null,2)),await this.reindexChunkUpdates(e,t,[String(s.chunk_id||n)],[]),new u.Notice("Chunk tags updated.")},async()=>{if(!d.trim())return new u.Notice("Chunk has no text to tag."),null;let g=await this.renderMarkdownToIndexText(d);return this.requestChunkTags(g)}).open()}async openChunkIndexedTextPreview(e,n){var c;let t=(0,u.normalizePath)(`${V}/${e}.json`);if(!await this.app.vault.adapter.exists(t)){new u.Notice("Chunk cache not found for this document.");return}let r=await this.readChunkPayload(t);if(!r){new u.Notice("Failed to read chunk cache.");return}let a=Array.isArray(r.chunks)?r.chunks:[],s=this.resolveChunkFromPayload(a,n,e);if(!s){new u.Notice(`Chunk ${n} not found in cache.`);return}let o=typeof s.text=="string"?s.text:String((c=s.text)!=null?c:""),l=await this.renderMarkdownToIndexText(o),d=this.settings.embedIncludeMetadata?"Note: when \u201CInclude metadata in embeddings\u201D is enabled, the indexer prepends title/authors/tags/section info before embedding. The preview below shows only the chunk text.":"";new Oe(this.app,`Indexed text for ${n}`,l,d).open()}async openChunkInZotero(e,n){var p,g,y,b,L,_;let t=(0,u.normalizePath)(`${V}/${e}.json`),i=this.app.vault.adapter,r=null;await i.exists(t)&&(r=await this.readChunkPayload(t));let a=Array.isArray(r==null?void 0:r.chunks)?r==null?void 0:r.chunks:[],s=this.resolveChunkFromPayload(a,n,e),o=(p=s==null?void 0:s.page_start)!=null?p:s==null?void 0:s.pageStart,l=(L=(b=(g=r==null?void 0:r.metadata)==null?void 0:g.attachment_key)!=null?b:(y=r==null?void 0:r.metadata)==null?void 0:y.attachmentKey)!=null?L:"";if(!l){let f=await this.getDocIndexEntry(e);l=(_=f==null?void 0:f.attachment_key)!=null?_:""}if(!l){new u.Notice("Attachment key not found for Zotero deeplink.");return}let d=typeof o=="number"?String(o):"",c=this.buildZoteroDeepLink(e,l,d);this.openExternalUrl(c)}async cleanChunkFromToolbar(e){let n=this.app.workspace.getActiveViewOfType(u.MarkdownView);if(!n){new u.Notice("No active editor found.");return}let t=n.editor,i=Math.max(0,e-1),r=this.findChunkAtCursor(t,i);if(!r){new u.Notice("No synced chunk found at cursor.");return}let a=[];for(let d=r.startLine+1;d<r.endLine;d+=1)a.push(t.getLine(d));let s=a.join(`
`).trim();if(!s){new u.Notice("Chunk has no text to clean.");return}this.showStatusProgress("Cleaning chunk...",null);let o=null;try{o=await this.requestOcrCleanup(s)}finally{o||this.clearStatusProgress()}if(!o)return;if(o.trim()===s.trim()){new u.Notice("Cleanup produced no changes."),this.clearStatusProgress();return}let l=`${o.trim()}
`;t.replaceRange(l,{line:r.startLine+1,ch:0},{line:r.endLine,ch:0}),this.showStatusProgress("Chunk cleaned.",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new u.Notice("Chunk cleaned.")}async requestOcrCleanup(e){var l,d,c,p,g,y,b,L,_;let n=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),t=(this.settings.llmCleanupModel||"").trim();if(!n||!t)return new u.Notice("OCR cleanup model is not configured."),this.openPluginSettings(),null;let i=Number(this.settings.llmCleanupMaxChars||0);if(i>0&&e.length>i)return new u.Notice("Chunk exceeds OCR cleanup max length. Adjust settings to clean it."),this.openPluginSettings(),null;let r=`${n}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o={model:t,temperature:Number((l=this.settings.llmCleanupTemperature)!=null?l:0),messages:[{role:"system",content:"You are an OCR cleanup assistant. Fix OCR errors without changing meaning. Do not add content. Return corrected text only. Detect footnote references and definitions and format them in Markdown as [^n] and [^n]: (for the note text). Preserve special characters and formatting. Do not create new footnotes or content; only reformat existing footnote markers/lines."},{role:"user",content:e}]};try{let f=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(o)});if(f.statusCode>=400){let C=f.body.toString("utf8");throw new Error(`Cleanup request failed (${f.statusCode}): ${C||"no response body"}`)}let v=JSON.parse(f.body.toString("utf8")),w=(_=(L=(b=(p=(c=(d=v==null?void 0:v.choices)==null?void 0:d[0])==null?void 0:c.message)==null?void 0:p.content)!=null?b:(y=(g=v==null?void 0:v.choices)==null?void 0:g[0])==null?void 0:y.text)!=null?L:v==null?void 0:v.output_text)!=null?_:"",S=String(w||"").trim();return S||(new u.Notice("Cleanup returned empty text."),null)}catch(f){return console.error("OCR cleanup failed",f),new u.Notice("OCR cleanup failed. Check the cleanup model settings."),null}}parseChunkTags(e,n){if(!e)return[];let t=e.trim(),i=[];if(t.startsWith("[")&&t.endsWith("]"))try{let s=JSON.parse(t);Array.isArray(s)&&(i=s.map(o=>String(o)))}catch(s){i=[]}i.length===0&&(i=t.split(/[,;\n]+/));let r=new Set,a=[];for(let s of i){let o=s.trim();if(o=o.replace(/^[-•\d.\)\s]+/,""),o=o.replace(/\s+/g," ").trim(),!o||o.length<2)continue;let l=o.toLowerCase();if(!r.has(l)&&(r.add(l),a.push(o),a.length>=n))break}return a}async requestChunkTags(e){var p,g,y,b,L,_,f,v,w;let n=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),t=(this.settings.llmCleanupModel||"").trim();if(!n||!t)return new u.Notice("OCR cleanup model is not configured."),this.openPluginSettings(),null;let i=e.trim().slice(0,2e3);if(!i)return[];let r=`${n}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o=5,l="Return 3 to 5 high-signal, concrete noun-phrase tags. Avoid generic terms (study, paper, method), verbs, and filler. Prefer specific entities, methods, datasets, and named concepts. Output comma-separated tags only. No extra text.",d=Number((p=this.settings.llmCleanupTemperature)!=null?p:0),c={model:t,messages:[{role:"system",content:l},{role:"user",content:i}]};Number.isFinite(d)&&(c.temperature=d),this.showStatusProgress("Generating tags...",null);try{let S=async z=>{let R=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(z)});if(R.statusCode>=400){let F=R.body.toString("utf8");throw new Error(`Tag request failed (${R.statusCode}): ${F||"no response body"}`)}return R.body},C;try{C=await S(c)}catch(z){let R=z instanceof Error?z.message:String(z);if("temperature"in c&&/temperature/i.test(R)&&/unsupported|default/i.test(R)){let F={...c};delete F.temperature,C=await S(F)}else throw z}let P=JSON.parse(C.toString("utf8")),D=(w=(v=(f=(b=(y=(g=P==null?void 0:P.choices)==null?void 0:g[0])==null?void 0:y.message)==null?void 0:b.content)!=null?f:(_=(L=P==null?void 0:P.choices)==null?void 0:L[0])==null?void 0:_.text)!=null?v:P==null?void 0:P.output_text)!=null?w:"",I=this.parseChunkTags(String(D||""),o);return I.length||new u.Notice("Tag generation returned no tags."),I}catch(S){return console.error("Tag generation failed",S),new u.Notice("Tag generation failed. Check the cleanup model settings."),null}finally{this.clearStatusProgress()}}async renderMarkdownToIndexText(e){if(!e)return"";let n=this.replaceImageMarkersForIndexPreview(e),t=document.createElement("div");try{await u.MarkdownRenderer.renderMarkdown(n,t,"",this)}catch(l){return console.warn("Failed to render markdown for index preview",l),this.normalizeIndexPreviewText(n)}let a=(t.innerHTML||"").replace(/<br\s*\/?>/gi,`
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,n=1200){let t=this.noteSyncTimers.get(e.path);t!==void 0&&window.clearTimeout(t);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},n);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,n=1200,t="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,t)},n);this.noteMetadataSyncTimers.set(e.path,r)}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=e.page_start?String(e.page_start):"",t=e.page_end?String(e.page_end):"";if(n&&(!t||n===t))return n;if(n&&t)return`${n} - ${t}`;let i=(e.pages||"").trim();if(!i)return"?";let r=i.match(/^(\d+)\s*-\s*(\d+)$/);return r?r[1]===r[2]?r[1]:`${r[1]} - ${r[2]}`:i.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,u.normalizePath)(`${V}/${s}.json`),d=this.app.vault.adapter;if(!await d.exists(l))return;let c=await this.readChunkPayload(l);if(!c)return;let p=Array.isArray(c.chunks)?c.chunks:[],g=new Map;for(let w of p){let S=typeof(w==null?void 0:w.chunk_id)=="string"?w.chunk_id:String((n=w==null?void 0:w.chunk_id)!=null?n:"");S&&g.set(S,w)}let y=new Set,b=new Set,L=new Set,_=new Set,f=!1;for(let w of o){let S=w.chunkId;if(!S)continue;y.add(S);let C=g.get(S);if(!C){console.warn(`Sync note: chunk id not found in cache (${S})`);continue}if(w.excludeFlag){C.excluded!==!0&&(C.excluded=!0,f=!0);let I=this.normalizeChunkText(w.text);I&&I!==String((t=C.text)!=null?t:"")&&(C.text=I,C.char_count=I.length,f=!0),L.add(S);continue}if(C.excluded&&(C.excluded=!1,f=!0,b.add(S)),!w.text.trim()){L.add(S),_.add(S);continue}let P=this.normalizeChunkText(w.text);if(!P){L.add(S),_.add(S);continue}let D=typeof C.text=="string"?C.text:String((i=C.text)!=null?i:"");P!==D&&(C.text=P,C.char_count=P.length,b.add(S),f=!0)}for(let w of g.keys())y.has(w)||(L.add(w),_.add(w));let v=new Set([...L,..._]);if(v.size){let w=Array.from(v).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==w){this.noteSyncPendingDeletes.set(e.path,w),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!b.size&&!L.size&&!_.size&&!f)return;_.size&&(c.chunks=p.filter(w=>{var C;let S=typeof(w==null?void 0:w.chunk_id)=="string"?w.chunk_id:String((C=w==null?void 0:w.chunk_id)!=null?C:"");return S&&!_.has(S)}),f=!0),(f||_.size)&&await d.write(l,JSON.stringify(c,null,2)),await this.reindexChunkUpdates(s,l,Array.from(b),Array.from(L)),(L.size||_.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,n){var t,i,r;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,n);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),s=await this.resolveDocIdForNote(e,a);if(!s)return;let o=(i=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter)!=null?i:{},l=this.resolveZoteroItemKey(o,s);if(!l)return;let d=await this.fetchZoteroItem(l),c=(r=d==null?void 0:d.data)!=null?r:d;if(!c||typeof c!="object")return;let p=this.extractNoteMetadata(o),g=this.extractZoteroMetadata(c),y={},b={},L=["title","short_title","date","abstract","tags","authors","editors"];for(let _ of L){let f=p[_],v=g[_];if(this.metadataValuesEqual(_,f,v))continue;let w=await this.promptMetadataDecision(_,f,v);w==="note"?this.assignMetadataUpdate(b,_,f):w==="zotero"&&this.assignMetadataUpdate(y,_,v)}Object.keys(y).length>0&&await this.applyNoteMetadataUpdates(e,y),Object.keys(b).length>0&&await this.applyZoteroMetadataUpdates(l,c,p,g,b)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,n)}}resolveZoteroItemKey(e,n){let t=[e==null?void 0:e.zotero_key,e==null?void 0:e.zoteroKey,e==null?void 0:e.item_key,e==null?void 0:e.itemKey,n];for(let i of t){let r=this.coerceString(i);if(r)return r}return""}extractNoteMetadata(e){var l,d,c;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString((d=(l=e==null?void 0:e.short_title)!=null?l:e==null?void 0:e.shortTitle)!=null?d:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString((c=e==null?void 0:e.abstract)!=null?c:e==null?void 0:e.abstractNote),a=this.normalizeMetadataList(e==null?void 0:e.tags),s=this.normalizeMetadataList(e==null?void 0:e.authors),o=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:n,short_title:t,date:i,abstract:r,tags:this.sanitizeObsidianTags(a),authors:s,editors:o}}extractZoteroMetadata(e){let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString(this.extractShortTitleFromValues(e)),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString(e==null?void 0:e.abstractNote),a=Array.isArray(e==null?void 0:e.creators)?e.creators:[],s=a.filter(d=>(d==null?void 0:d.creatorType)==="author").map(d=>this.formatCreatorName(d)).filter(Boolean),o=a.filter(d=>(d==null?void 0:d.creatorType)==="editor"||(d==null?void 0:d.creatorType)==="seriesEditor").map(d=>this.formatCreatorName(d)).filter(Boolean),l=Array.isArray(e==null?void 0:e.tags)?e.tags.map(d=>typeof d=="string"?d:d==null?void 0:d.tag).filter(d=>typeof d=="string"):[];return{title:n,short_title:t,date:i,abstract:r,tags:this.sanitizeObsidianTags(l),authors:this.normalizeMetadataList(s),editors:this.normalizeMetadataList(o)}}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
${t}
<!-- zrr:sync-end -->`;let r=[`<!-- zrr:sync-start doc_id=${e} -->`];for(let s of i){let o=typeof(s==null?void 0:s.chunk_id)=="string"?s.chunk_id.trim():"";if(!o)continue;let l=Number.isFinite((a=s==null?void 0:s.page_start)!=null?a:NaN)?Number(s.page_start):null,d=!!(s!=null&&s.excluded||s!=null&&s.exclude),c=typeof(s==null?void 0:s.text)=="string"?s.text.trim():"",p=l!==null?` page=${l}`:"",g=` id=${o}${p}${d?" exclude":""}`;r.push(`<!-- zrr:chunk${g} -->`),c&&r.push(c),r.push("<!-- zrr:chunk end -->"),r.push("")}return r[r.length-1]===""&&r.pop(),r.push("<!-- zrr:sync-end -->"),r.join(`
`)}async readChunkPayload(e){try{let n=await this.app.vault.adapter.read(e);return JSON.parse(n)}catch(n){return console.warn("Failed to read cached chunks JSON",n),null}}resolveChunkFromPayload(e,n,t){var a;let i=this.normalizeChunkIdForNote(n,t)||n,r=new Set([n,i,`${t}:${n}`]);for(let s of e){let o=typeof(s==null?void 0:s.chunk_id)=="string"?s.chunk_id:String((a=s==null?void 0:s.chunk_id)!=null?a:"");if(o&&r.has(o))return s}return null}async writeNoteWithSyncSuppressed(e,n){this.noteSyncSuppressed.add(e);try{await this.app.vault.adapter.write(e,n)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e)},1500)}}async resolveNotePathForDocId(e){if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e);if(t!=null&&t.note_path&&await n.exists(t.note_path))return t.note_path;let r=(await this.scanNotesForDocIds(this.settings.outputNoteDir))[e];return r!=null&&r.note_path?(await this.updateDocIndex({doc_id:e,note_path:r.note_path,note_title:r.note_title}),r.note_path):null}isZoteroNoteFile(e){let n=this.app.metadataCache.getFileCache(e),t=n==null?void 0:n.frontmatter;return!!(t!=null&&t.doc_id||t!=null&&t.zotero_key)}async deleteZoteroNoteAndCacheForFile(e){var d;let n=e.path,t=await this.app.vault.read(e),i=(d=this.extractDocIdFromFrontmatter(t))!=null?d:this.extractDocIdFromSyncMarker(t);if(!i){new u.Notice("No doc_id found in this note.");return}if(!await new Promise(c=>{new Me(this.app,n,i,c).open()}))return;let a=this.app.vault.adapter,s=(0,u.normalizePath)(`${V}/${i}.json`),o=(0,u.normalizePath)(`${J}/${i}.json`),l=[];if(await a.exists(s)){let c=await this.readChunkPayload(s);l=(Array.isArray(c==null?void 0:c.chunks)?c==null?void 0:c.chunks:[]).map(g=>{var y;return String((y=g==null?void 0:g.chunk_id)!=null?y:"")}).map(g=>g.startsWith(`${i}:`)?g.slice(i.length+1):g).filter(g=>g)}l.length>0&&await this.reindexChunkUpdates(i,s,[],l);try{await a.exists(s)&&await a.remove(s),await a.exists(o)&&await a.remove(o),await this.removeDocIndexEntry(i),await this.app.vault.delete(e,!0),new u.Notice(`Deleted note and cache for ${i}.`)}catch(c){console.error("Failed to delete note and cached data",c),new u.Notice("Failed to delete note or cached data. See console for details.")}}async deleteZoteroNoteAndCache(){let e=this.app.workspace.getActiveViewOfType(u.MarkdownView);if(!e||!e.file){new u.Notice("No active Zotero note found.");return}await this.deleteZoteroNoteAndCacheForFile(e.file)}formatRedisSearchResults(e){let n=typeof(e==null?void 0:e.total)=="number"?e.total:0,t=typeof(e==null?void 0:e.query)=="string"?e.query:"",i=typeof(e==null?void 0:e.raw_query)=="string"?e.raw_query:"",r=e!=null&&e.field_types&&typeof e.field_types=="object"?e.field_types:null,a=!!(e!=null&&e.fallback_used),s=typeof(e==null?void 0:e.fallback_reason)=="string"?e.fallback_reason:"",o=Array.isArray(e==null?void 0:e.fallback_queries)?e.fallback_queries:[],l=Array.isArray(e==null?void 0:e.fallback_failed_fields)?e.fallback_failed_fields:[],d=Array.isArray(e==null?void 0:e.results)?e.results:[],c=[];if(c.push(`Query: ${i||t}`),t&&i&&t!==i&&c.push(`Expanded: ${t}`),c.push(`Total matches: ${n}`),r&&Object.keys(r).length>0){let p=Object.keys(r).sort().map(g=>`${g}:${r[g]}`);c.push(`Field types: {${p.join(", ")}}`)}if(a&&c.push(`Fallback: ${s||"true"}`),o.length){c.push("Fallback queries:");for(let p of o)c.push(`  - ${p}`)}if(l.length&&c.push(`Fallback failed fields: ${l.join(", ")}`),c.push(""),!d.length)return c.push("(no results)"),c.join(`
`);for(let p of d){let g=String(p.doc_id||"").trim(),y=String(p.chunk_id||"").trim(),b=String(p.page_start||"").trim(),L=String(p.page_end||"").trim(),_=String(p.title||"").trim(),f=String(p.section||"").trim(),v=String(p.score||"").trim(),w=String(p.authors||"").trim(),S=String(p.item_type||"").trim(),C=String(p.year||"").trim(),P=String(p.tags||"").trim(),D=String(p.chunk_tags||"").trim(),I=String(p.attachment_key||"").trim(),z=String(p.source_pdf||"").trim(),R=String(p.text||"").replace(/\s+/g," ").trim(),F=R.length>220?`${R.slice(0,220)}\u2026`:R,O=[g];y&&O.push(y),(b||L)&&O.push(`p.${b||"?"}-${L||"?"}`),c.push(O.filter(Boolean).join(" \u2022 ")),v&&c.push(`  score: ${v}`),_&&c.push(`  title: ${_}`),w&&c.push(`  authors: ${w}`),C&&c.push(`  year: ${C}`),S&&c.push(`  item_type: ${S}`),P&&c.push(`  tags: ${P}`),D&&c.push(`  chunk_tags: ${D}`),I&&c.push(`  attachment_key: ${I}`),f&&c.push(`  section: ${f}`),z&&c.push(`  source_pdf: ${z}`),F&&c.push(`  ${F}`),c.push("")}return c.join(`
...
\`\`\``;new me(this.app,"Redis diagnostics",a||"(empty)").open()}catch(i){console.error("Redis diagnostics failed",i),new u.Notice("Redis diagnostics failed. See console for details.")}}async resolveUniqueBaseName(e,n){let t=this.app.vault.adapter,i=(0,u.normalizePath)(`${this.settings.outputNoteDir}/${e}.md`),r=(0,u.normalizePath)(`${this.settings.outputPdfDir}/${e}.pdf`),a=await t.exists(i),s=this.settings.copyPdfToVault?await t.exists(r):!1;return a||s?`${e}-${n}`:e}async searchZoteroItems(e){let n=["data,meta,children","data,meta"];for(let t of n){let i=new URLSearchParams;i.set("itemType","-attachment"),i.set("limit","25"),i.set("include",t),e.trim()&&i.set("q",e.trim());let r=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items?${i.toString()}`);try{let a=await this.requestLocalApi(r,`Zotero search failed for ${r}`),s=JSON.parse(a.toString("utf8"));return Array.isArray(s)?s.map(o=>{var l,d,c,p;return{key:(d=o.key)!=null?d:(l=o.data)==null?void 0:l.key,data:(c=o.data)!=null?c:{},meta:(p=o.meta)!=null?p:{}}}).filter(o=>typeof o.key=="string"&&o.key.trim().length>0):[]}catch(a){console.warn("Failed to search Zotero via local API",a)}}if(!this.canUseWebApi())throw new Error("Zotero search failed for all include modes.");return this.searchZoteroItemsWeb(e)}async hasProcessableAttachment(e){var r;let n=(r=e.data)!=null?r:e,t=typeof e.key=="string"?e.key:this.coerceString(n.key);return t?!!await this.resolvePdfAttachment(n,t):!1}async resolvePdfAttachment(e,n){let t=this.pickPdfAttachment(e);if(t)return t;try{let i=await this.fetchZoteroChildren(n);for(let r of i){let a=this.toPdfAttachment(r);if(a)return a}}catch(i){console.error("Failed to fetch Zotero children",i)}return null}pickPdfAttachment(e){let n=this.collectAttachmentCandidates(e);for(let t of n){let i=this.toPdfAttachment(t);if(i)return i}return null}collectAttachmentCandidates(e){let n=[e.attachments,e.children,e.items,e.attachment,e.allAttachments],t=[];for(let i of n)i&&(Array.isArray(i)?t.push(...i):typeof i=="object"&&t.push(i));return t}toPdfAttachment(e){var r,a,s,o,l,d;if(((s=(r=e==null?void 0:e.contentType)!=null?r:e==null?void 0:e.mimeType)!=null?s:(a=e==null?void 0:e.data)==null?void 0:a.contentType)!=="application/pdf")return null;let t=(d=(o=e==null?void 0:e.key)!=null?o:e==null?void 0:e.attachmentKey)!=null?d:(l=e==null?void 0:e.data)==null?void 0:l.key;if(!t)return null;let i=this.extractAttachmentPath(e);return i?{key:t,filePath:i}:{key:t}}extractAttachmentPath(e){var t,i,r,a,s,o,l,d;let n=(d=(a=(i=(t=e==null?void 0:e.links)==null?void 0:t.enclosure)==null?void 0:i.href)!=null?a:(r=e==null?void 0:e.enclosure)==null?void 0:r.href)!=null?d:(l=(o=(s=e==null?void 0:e.data)==null?void 0:s.links)==null?void 0:o.enclosure)==null?void 0:l.href;if(typeof n=="string"&&n.startsWith("file://"))try{return(0,ue.fileURLToPath)(n)}catch(c){return null}return null}async fetchZoteroChildren(e){let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/children`);try{let t=await this.requestLocalApi(n,`Zotero children request failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(t){if(console.warn("Failed to fetch Zotero children from local API",t),!this.canUseWebApi())throw t;let i=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/children`),r=await this.requestWebApi(i,`Zotero Web API children request failed for ${i}`);return JSON.parse(r.toString("utf8"))}}async downloadZoteroPdf(e){let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/file`);try{let t=await this.requestLocalApiRaw(n),i=await this.followFileRedirect(t);if(i)return i;if(t.statusCode>=300)throw new Error(`Request failed, status ${t.statusCode}`);return t.body}catch(t){if(console.warn("Failed to download PDF from local API",t),!this.canUseWebApi())throw t;let i=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/file`),r=await this.requestWebApiRaw(i),a=await this.followFileRedirect(r);if(a)return a;if(r.statusCode>=300)throw new Error(`Web API request failed, status ${r.statusCode}`);return r.body}}buildZoteroUrl(e){return`${this.settings.zoteroBaseUrl.replace(/\/$/,"")}${e}`}canUseWebApi(){return!!((this.settings.webApiBaseUrl||"").trim()&&this.settings.webApiKey&&this.settings.webApiLibraryId)}getWebApiLibraryPath(){let e=(this.settings.webApiLibraryId||"").trim();return e?`${this.settings.webApiLibraryType==="group"?"groups":"users"}/${e}`:""}buildWebApiUrl(e){return`${this.settings.webApiBaseUrl.replace(/\/$/,"")}${e}`}requestLocalApiRaw(e,n={}){return new Promise((t,i)=>{var c,p;let r=new URL(e),a=r.protocol==="https:"?rn.default:tn.default,s=(c=n.method)!=null?c:"GET",o={Accept:"*/*",...(p=n.headers)!=null?p:{}},l=n.body;if(l!==void 0&&o["Content-Length"]===void 0){let g=Buffer.isBuffer(l)?l.length:Buffer.byteLength(l);o["Content-Length"]=String(g)}let d=a.request({method:s,hostname:r.hostname,port:r.port||void 0,path:`${r.pathname}${r.search}`,headers:o},g=>{let y=[];g.on("data",b=>y.push(Buffer.from(b))),g.on("end",()=>{var L;let b=Buffer.concat(y);t({statusCode:(L=g.statusCode)!=null?L:0,headers:g.headers,body:b})})});d.on("error",i),l!==void 0&&d.write(l),d.end()})}async requestLocalApi(e,n){let t=await this.requestLocalApiRaw(e);if(t.statusCode>=400){let i=t.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}: ${i||"no response body"}`)}if(t.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}`);return t.body}async requestLocalApiWithBody(e,n,t,i,r){let a=JSON.stringify(t),s=await this.requestLocalApiRaw(e,{method:n,headers:i,body:a});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}async requestWebApi(e,n){let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},i=await this.requestLocalApiRaw(e,{headers:t});if(i.statusCode>=400){let r=i.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}: ${r||"no response body"}`)}if(i.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}`);return i.body}requestWebApiRaw(e,n={}){var i;let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey,...(i=n.headers)!=null?i:{}};return this.requestLocalApiRaw(e,{...n,headers:t})}async requestWebApiWithBody(e,n,t,i,r){let a=JSON.stringify(t),s=await this.requestLocalApiRaw(e,{method:n,headers:i,body:a});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}async followFileRedirect(e){if(e.statusCode<300||e.statusCode>=400)return null;let n=e.headers.location,t=Array.isArray(n)?n[0]:n;if(!t||typeof t!="string")return null;if(t.startsWith("file://")){let i=(0,ue.fileURLToPath)(t);return B.promises.readFile(i)}return t.startsWith("http://")||t.startsWith("https://")?this.requestLocalApi(t):null}bufferToArrayBuffer(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}async annotateChunkJsonWithAttachmentKey(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;let r=i.metadata&&typeof i.metadata=="object"?i.metadata:{};r.attachment_key=n,i.metadata=r,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to annotate chunks JSON with attachment key",t)}}async updateChunkJsonSourcePdf(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;i.source_pdf=n,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to update chunks JSON source_pdf",t)}}buildPdfLinkFromSourcePath(e){if(!e)return"";let n=A.default.normalize(this.getVaultBasePath()),t=A.default.normalize(e),i=n.endsWith(A.default.sep)?n:`${n}${A.default.sep}`;return t.startsWith(i)?`[[${(0,u.normalizePath)(A.default.relative(n,t))}]]`:`[PDF](${(0,ue.pathToFileURL)(e).toString()})`}toVaultRelativePath(e){if(!e)return"";let n=A.default.normalize(this.getVaultBasePath()),t=A.default.normalize(e),i=n.endsWith(A.default.sep)?n:`${n}${A.default.sep}`;return t.startsWith(i)?(0,u.normalizePath)(A.default.relative(n,t)):""}async isFileAccessible(e){if(!e)return!1;try{return await B.promises.access(e),!0}catch(n){return!1}}deriveVaultPdfRelativePath(e,n,t){let i=this.toVaultRelativePath(e);if(i&&i.startsWith((0,u.normalizePath)(this.settings.outputPdfDir)))return i;let r=this.sanitizeFileName(n)||t;return(0,u.normalizePath)(`${this.settings.outputPdfDir}/${r}.pdf`)}async recoverMissingPdfFromAttachment(e,n,t,i,r,a,s){let o=await this.resolvePdfAttachment(n,t);if(!o&&r&&(o={key:r}),!o)return null;let l=o.key||r,d=o.filePath;if(!this.settings.copyPdfToVault&&d&&await this.isFileAccessible(d))return{sourcePdf:d,attachmentKey:l};try{await this.ensureFolder(this.settings.outputPdfDir)}catch(y){return console.error("Failed to create PDF output folder",y),null}let c=this.deriveVaultPdfRelativePath(e,a,i),p;try{if(d&&await this.isFileAccessible(d))p=await B.promises.readFile(d);else if(l)p=await this.downloadZoteroPdf(l),!this.settings.copyPdfToVault&&s&&new u.Notice("Local PDF path unavailable; copied PDF into vault for processing.");else return null}catch(y){return console.error("Failed to read or download PDF attachment",y),null}try{await this.app.vault.adapter.writeBinary(c,this.bufferToArrayBuffer(p))}catch(y){return console.error("Failed to write recovered PDF into vault",y),null}return{sourcePdf:this.getAbsoluteVaultPath(c),attachmentKey:l}}buildPdfLinkForNote(e,n,t){return!e&&!n?"":!this.settings.copyPdfToVault&&n?`[PDF](${this.buildZoteroDeepLink(t!=null?t:"",n)})`:this.buildPdfLinkFromSourcePath(e)}buildVaultPdfCitationLink(e,n,t){if(!e)return"";let i=this.toVaultRelativePath(e);if(!i)return"";let r=n?`#page=${n}`:"";return`[[${i}${r}|${t||i}]]`}async maybeCreateOcrLayeredPdf(e,n,t){if(!this.settings.createOcrLayeredPdf||!this.settings.copyPdfToVault||!e||!((n==null?void 0:n.ocr_used)===!0))return null;if(!this.toVaultRelativePath(e))return console.warn("OCR layered PDF requires a vault-local PDF"),null;try{await this.ensureFolder(this.settings.outputPdfDir)}catch(l){return console.warn("Failed to create OCR PDF output folder",l),null}let r=`${e}.ocr.tmp`,a=(t||(n==null?void 0:n.languages)||"eng").toString(),s=this.getPluginDir(),o=A.default.join(s,"tools","ocr_layered_pdf.py");try{return this.showStatusProgress("Creating OCR PDF...",0),await this.runPythonStreaming(o,["--pdf",e,"--out-pdf",r,"--language",a,"--progress"],l=>{if((l==null?void 0:l.type)==="progress"&&l.total){let d=Math.round(l.current/l.total*100);this.showStatusProgress(`Creating OCR PDF ${l.current}/${l.total}`,d)}},()=>{}),await B.promises.rename(r,e),e}catch(l){return console.warn("OCR layered PDF creation failed",l),null}}getMainLeaf(){let e=new Set(this.app.workspace.getLeavesOfType(de)),n=this.app.workspace.getLeavesOfType("markdown").find(i=>!e.has(i));if(n)return n;let t=this.app.workspace.getLeaf(!1);return t&&!e.has(t)?t:this.app.workspace.getLeaf("tab")}async getPdfSidebarLeaf(){var i,r;if(this.pdfSidebarLeaf&&((r=(i=this.pdfSidebarLeaf.view)==null?void 0:i.getViewType)==null?void 0:r.call(i))==="pdf")return this.pdfSidebarLeaf;let e=this.app.workspace;if(typeof e.ensureSideLeaf=="function")try{let a=await e.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(a)?(this.pdfSidebarLeaf=a,this.updatePdfSidebarIcon(a),a):null}catch(a){console.warn("Failed to ensure PDF side leaf",a)}let n=this.app.workspace.getRightLeaf(!1);if(n&&this.isRightSidebarLeaf(n))return this.pdfSidebarLeaf=n,this.updatePdfSidebarIcon(n),n;let t=this.app.workspace.getRightLeaf(!0);return t&&this.isRightSidebarLeaf(t)?(this.pdfSidebarLeaf=t,this.updatePdfSidebarIcon(t),t):null}isRightSidebarLeaf(e){if(!e)return!1;let t=e.containerEl;return!!(t!=null&&t.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(e){if(!e||!this.isRightSidebarLeaf(e))return;let t=e.containerEl,i=[];t&&i.push(...Array.from(t.querySelectorAll(".view-header-icon")));let r=e;if(r.tabHeaderEl&&i.push(...Array.from(r.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),r.tabHeaderInnerIconEl&&i.push(r.tabHeaderInnerIconEl),i.length===0)return;let a=new Set;for(let o of i)a.has(o)||(a.add(o),o.innerHTML="",(0,u.setIcon)(o,"zrr-pdf"),!o.querySelector("svg")&&Re&&(o.innerHTML=Re),o.dataset&&(o.dataset.zrrIcon="zrr-pdf"));let s=e.view;s.icon="zrr-pdf",typeof s.getIcon=="function"&&(s.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(e,n){var a,s,o;let t=(a=this.getPluginsRegistry())==null?void 0:a["pdf-plus"],i=(o=(s=t==null?void 0:t.lib)==null?void 0:s.workspace)==null?void 0:o.openPDFLinkTextInLeaf;if(typeof i=="function"){await i.call(t.lib.workspace,e,n,"",{active:!1});return}let r=e;if(typeof r.openLinkText=="function"){await r.openLinkText(n,"",{active:!1});return}await this.app.workspace.openLinkText(n,"",!1)}getPluginsRegistry(){var e;return(e=this.app.plugins)==null?void 0:e.plugins}isLeafTabActive(e){var r;let n=e;if((r=n.parent)!=null&&r.activeLeaf)return n.parent.activeLeaf===e;let t=n.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let i=n.tabHeaderEl;return!!(i!=null&&i.classList.contains("is-active")||i!=null&&i.classList.contains("mod-active"))}async syncPdfSidebarForFile(e){try{let n=await this.app.vault.read(e),t=await this.resolveDocIdForNote(e,n);if(!t)return;let i=Ln(n);await this.syncPdfSidebarForDoc(t,i==null?void 0:i.pageNumber,i==null?void 0:i.chunkId)}catch(n){console.warn("Failed to sync PDF sidebar for opened note",n)}}async resolvePageNumberForChunk(e,n){var d,c,p,g,y;if(!e||!n)return null;let t=this.normalizeChunkIdForNote(n,e)||n,i=this.chunkPageCache.get(e);if(i&&i.has(t))return(d=i.get(t))!=null?d:null;let r=(0,u.normalizePath)(`${V}/${e}.json`);if(!await this.app.vault.adapter.exists(r))return null;let s=await this.readChunkPayload(r),o=Array.isArray(s==null?void 0:s.chunks)?s==null?void 0:s.chunks:[],l=new Map;for(let b of o){let L=typeof(b==null?void 0:b.chunk_id)=="string"?b.chunk_id.trim():"";if(!L)continue;let _=Number.isFinite((c=b==null?void 0:b.page_start)!=null?c:NaN)?Number(b.page_start):null,f=Number.isFinite((p=b==null?void 0:b.page_end)!=null?p:NaN)?Number(b.page_end):null,v=_!=null?_:f;v!==null&&(l.set(L,v),l.set(`${e}:${L}`,v))}return this.chunkPageCache.set(e,l),(y=(g=l.get(t))!=null?g:l.get(n))!=null?y:null}async syncPdfSidebarForDoc(e,n,t){if(!e)return;let i=await this.getDocIndexEntry(e);i||(i=await this.hydrateDocIndexFromCache(e));let r=i!=null&&i.pdf_path?String(i.pdf_path):"";if(!r)return;let a=this.toVaultRelativePath(r);if(!a){let y=(0,u.normalizePath)(r);this.app.vault.getAbstractFileByPath(y)instanceof u.TFile&&(a=y)}if(!a)return;let s=this.app.vault.getAbstractFileByPath(a);if(!(s instanceof u.TFile)||s.extension.toLowerCase()!=="pdf")return;let o=await this.getPdfSidebarLeaf();if(!o){this.pendingPdfSync={docId:e,pageNumber:n,chunkId:t};return}if(this.updatePdfSidebarIcon(o),!this.isLeafTabActive(o)){this.pendingPdfSync={docId:e,pageNumber:n,chunkId:t};return}let l=Number.isFinite(n!=null?n:NaN)?Number(n):null;if(l===null&&t&&(l=await this.resolvePageNumberForChunk(e,t)),l===null||this.pdfSidebarDocId===e&&this.pdfSidebarPdfPath===s.path&&this.pdfSidebarPage===l)return;this.pdfSidebarDocId=e,this.pdfSidebarPdfPath=s.path,this.pdfSidebarPage=l;let d=a,c=l!==null?`${d}#page=${l}`:d,p=this.app.workspace,g=p.getMostRecentLeaf();p.setActiveLeaf(o,{focus:!1});try{await this.openPdfLinkInLeaf(o,c),this.updatePdfSidebarIcon(o)}finally{g&&p.setActiveLeaf(g,{focus:!1})}}async openNoteInMain(e){let n=(0,u.normalizePath)(e),t=this.app.vault.getAbstractFileByPath(n),i=this.getMainLeaf();if(t instanceof u.TFile){await i.openFile(t,{active:!0});return}await this.app.workspace.openLinkText(n,"",!1)}findChunkLineInText(e,n){if(!e||!n)return null;let t=this.escapeRegExp(n),i=new RegExp(`<!--\\s*zrr:chunk\\b[^>]*\\bid=(["']?)${t}\\1[^>]*-->`,"i"),r=e.split(`
`);for(let a=0;a<r.length;a+=1)if(i.test(r[a]))return a;return null}async openNoteAtChunk(e,n){if(!e||!n)return!1;await this.openNoteInMain(e);let i=this.getMainLeaf().view;if(!(i instanceof u.MarkdownView))return!1;let r=i.editor,a=this.normalizeChunkIdForNote(n)||n,s=this.findChunkLineInText(r.getValue(),a);return s===null?(new u.Notice(`Chunk ${a} not found in note.`),!1):(r.setCursor({line:s,ch:0}),r.scrollIntoView({from:{line:s,ch:0},to:{line:s,ch:0}},!0),!0)}async openInternalLinkInMain(e){let n=this.getMainLeaf(),[t,i]=e.split("#"),r=(t||"").trim(),a=(i||"").trim(),s="zrr-chunk:",o=r?this.app.metadataCache.getFirstLinkpathDest(r,""):null;if(o instanceof u.TFile){let l=a.startsWith(s)?a.slice(s.length).trim():"";if(l&&await this.openNoteAtChunk(o.path,l))return;await n.openFile(o,{active:!0}),e.includes("#")&&!l&&(this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1));return}this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1)}async openNoteInNewTab(e){let n=(0,u.normalizePath)(e);await this.app.workspace.openLinkText(n,"","tab")}async openPdfInMain(e,n){if(!e)return!1;let t=A.default.normalize(this.getVaultBasePath()),i=A.default.normalize(e),r=t.endsWith(A.default.sep)?t:`${t}${A.default.sep}`;if(i.startsWith(r)){let a=(0,u.normalizePath)(A.default.relative(t,i)),s=n?`#page=${n}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}try{return window.open((0,ue.pathToFileURL)(e).toString()),!0}catch(a){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,n,t,i){if(n){let r=new URLSearchParams;t&&r.set("page",t),i&&r.set("annotation",i);let a=r.toString()?`?${r.toString()}`:"";return`zotero://open-pdf/library/items/${n}${a}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let t=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(t))return t}formatCitationsMarkdown(e){return e.length?e.map(t=>this.formatCitationMarkdown(t)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e){var c,p,g,y,b;let n=e.doc_id||"?",t=this.formatCitationPageLabel(e),i=e.annotation_key||this.extractAnnotationKey(e.chunk_id),r=e.attachment_key||((p=(c=this.docIndex)==null?void 0:c[e.doc_id||""])==null?void 0:p.attachment_key),a=e.page_start?String(e.page_start):"",s=(y=(g=this.docIndex)==null?void 0:g[e.doc_id||""])!=null?y:null,o=this.resolveCitationTitle(s,(b=s==null?void 0:s.note_path)!=null?b:null,e.doc_id),l=this.formatCitationLabel(o,t),d=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&d&&(s!=null&&s.note_path))return`- ${this.buildNoteChunkLink(s.note_path,d,l)}`;if(r){let L=this.buildZoteroDeepLink(n,r,a,i);return`- [${l}](${L})`}return`- ${l}`}buildNoteChunkLink(e,n,t){let i=(0,u.normalizePath)(e).replace(/\.md$/i,""),r=`zrr-chunk:${n}`,a=this.escapeWikiLabel(t);return`[[${i}#${r}\\|${a}]]`}escapeWikiLabel(e){return e?e.replace(/\|/g,"\\|"):""}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,u.normalizePath)(`${K}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var t;let e=this.app.vault.adapter,n=this.getDocIndexPath();if(!await e.exists(n))return{};try{let i=await e.read(n),r=JSON.parse(i);if(r&&typeof r=="object"){let a=(t=r.entries)!=null?t:r;if(Array.isArray(a)){let s={};for(let o of a)o!=null&&o.doc_id&&(s[String(o.doc_id)]=o);return s}if(a&&typeof a=="object")return a}}catch(i){console.error("Failed to read doc index",i)}return{}}async saveDocIndex(e){await this.ensureFolder(K);let n=this.app.vault.adapter,t=this.getDocIndexPath(),i={version:1,entries:e};await n.write(t,JSON.stringify(i,null,2)),this.docIndex=e}async pruneDocIndexOrphans(){var d;let e=this.app.vault.adapter,n=await this.getDocIndex(),t=new Set(await this.listDocIds(J)),i=new Set(await this.listDocIds(V)),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),a=0,s=0,o=!1,l=new Date().toISOString();for(let c of Object.keys(n)){let p=n[c],g=!1,y=p!=null&&p.note_path?p.note_path.trim():"";if(y&&await e.exists(y))g=!0;else if((d=r[c])!=null&&d.note_path){g=!0;let L=r[c];L.note_path&&L.note_path!==p.note_path&&(p.note_path=L.note_path,s+=1,o=!0),L.note_title&&L.note_title!==p.note_title&&(p.note_title=L.note_title,s+=1,o=!0),s>0&&(p.updated_at=l)}let b=t.has(c)||i.has(c);!g&&!b&&(delete n[c],a+=1,o=!0)}return o&&await this.saveDocIndex(n),{removed:a,updated:s}}async updateDocIndex(e){var r;let n=await this.getDocIndex(),t=(r=n[e.doc_id])!=null?r:{doc_id:e.doc_id},i={...t,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&t.note_path&&(i.note_path=t.note_path),e.note_title===void 0&&t.note_title&&(i.note_title=t.note_title),e.zotero_title===void 0&&t.zotero_title&&(i.zotero_title=t.zotero_title),e.short_title===void 0&&t.short_title&&(i.short_title=t.short_title),e.pdf_path===void 0&&t.pdf_path&&(i.pdf_path=t.pdf_path),e.attachment_key===void 0&&t.attachment_key&&(i.attachment_key=t.attachment_key),n[e.doc_id]=i,await this.saveDocIndex(n)}async removeDocIndexEntry(e){let n=await this.getDocIndex();n[e]&&(delete n[e],await this.saveDocIndex(n))}async hydrateDocIndexFromCache(e){var s,o;if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e),i={},r=(0,u.normalizePath)(`${J}/${e}.json`);if(await n.exists(r))try{let l=await n.read(r),d=JSON.parse(l),c=(o=(s=d==null?void 0:d.data)!=null?s:d)!=null?o:{},p=typeof c.title=="string"?c.title:"";p&&(i.zotero_title=p);let g=this.extractShortTitleFromValues(c);if(g&&(i.short_title=g),!i.note_title||!i.note_path){let y=this.sanitizeFileName(p)||e,b=(0,u.normalizePath)(`${this.settings.outputNoteDir}/${y}.md`),L=(0,u.normalizePath)(`${this.settings.outputNoteDir}/${y}-${e}.md`),_="";await n.exists(b)?_=b:await n.exists(L)&&(_=L),_&&(i.note_path=_,i.note_title=A.default.basename(_,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!i.note_title&&(t!=null&&t.note_path)&&(i.note_title=A.default.basename(t.note_path,".md"));let a=(0,u.normalizePath)(`${V}/${e}.json`);if(await n.exists(a))try{let l=await n.read(a),d=JSON.parse(l);typeof(d==null?void 0:d.source_pdf)=="string"&&(i.pdf_path=d.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(i).length>0&&await this.updateDocIndex({doc_id:e,...i}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var t;return e&&(t=(await this.getDocIndex())[e])!=null?t:null}async inferNotePathFromCache(e){var i,r;let n=this.app.vault.adapter,t=(0,u.normalizePath)(`${J}/${e}.json`);if(!await n.exists(t))return"";try{let a=await n.read(t),s=JSON.parse(a),o=(r=(i=s==null?void 0:s.data)!=null?i:s)!=null?r:{},l=typeof o.title=="string"?o.title:"",d=this.sanitizeFileName(l)||e,c=(0,u.normalizePath)(`${this.settings.outputNoteDir}/${d}.md`),p=(0,u.normalizePath)(`${this.settings.outputNoteDir}/${d}-${e}.md`);if(await n.exists(c))return c;if(await n.exists(p))return p}catch(a){console.error("Failed to infer note path from cache",a)}return""}async rebuildNoteFromCacheForDocId(e,n){var R,F,O,$,H;try{await this.ensureBundledTools()}catch(T){return n&&new u.Notice("Failed to sync bundled tools. See console for details."),console.error(T),!1}let t=this.app.vault.adapter,i=(0,u.normalizePath)(`${J}/${e}.json`),r=(0,u.normalizePath)(`${V}/${e}.json`);if(!await t.exists(i)||!await t.exists(r))return n&&new u.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let a;try{let T=await t.read(i);a=JSON.parse(T)}catch(T){return n&&new u.Notice("Failed to read cached item JSON."),console.error(T),this.clearStatusProgress(),!1}let s;try{let T=await t.read(r);s=JSON.parse(T)}catch(T){return n&&new u.Notice("Failed to read cached chunks JSON."),console.error(T),this.clearStatusProgress(),!1}let o=(R=a.data)!=null?R:a,l=typeof o.title=="string"?o.title:"",d=((O=(F=a.key)!=null?F:o.key)!=null?O:e).toString(),c=await this.getDocIndexEntry(e),p=typeof(($=s==null?void 0:s.metadata)==null?void 0:$.attachment_key)=="string"?s.metadata.attachment_key:c==null?void 0:c.attachment_key,g=typeof s.source_pdf=="string"?s.source_pdf:"";if(!g||!await this.isFileAccessible(g)){let T=await this.recoverMissingPdfFromAttachment(g,o,d,e,p,l,n);if(!T)return n&&new u.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;g=T.sourcePdf,T.attachmentKey&&(p=T.attachmentKey),await this.updateChunkJsonSourcePdf(r,g)}let y=await this.resolveLanguageHint(o,d),b=this.buildDoclingLanguageHint(y!=null?y:void 0),L="";if(c!=null&&c.note_path&&await t.exists(c.note_path)&&(L=(0,u.normalizePath)(c.note_path)),!L){let T=this.sanitizeFileName(l)||e,q=(0,u.normalizePath)(`${this.settings.outputNoteDir}/${T}.md`),Z=await t.exists(q)?T:await this.resolveUniqueBaseName(T,e);L=(0,u.normalizePath)(`${this.settings.outputNoteDir}/${Z}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let T=this.getLogFileRelativePath(),q=(0,u.normalizePath)(A.default.dirname(T));q&&await this.ensureFolder(q);let Z=this.getSpellcheckerInfoRelativePath(),W=(0,u.normalizePath)(A.default.dirname(Z));W&&await this.ensureFolder(W)}}catch(T){return n&&new u.Notice("Failed to create notes folder."),console.error(T),this.clearStatusProgress(),!1}let _=this.getPluginDir(),f=A.default.join(_,"tools","docling_extract.py"),v=A.default.join(_,"tools","index_redisearch.py"),w=null,S=null,C=T=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=T)};try{w=await this.readDoclingQualityLabelFromPdf(g,b),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",w),0);let T=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(f,await this.buildDoclingArgs(g,e,r,L,b,!0),W=>this.handleDoclingProgress(W,w),()=>{},T,"docling_extract",C),this.recreateMissingNotesProcess=null,w=await this.readDoclingQualityLabel(r),p&&await this.annotateChunkJsonWithAttachmentKey(r,p);let q=await this.readDoclingMetadata(r),Z=await this.maybeCreateOcrLayeredPdf(g,q,b);Z&&(g=Z,S=Z,await this.updateChunkJsonSourcePdf(r,Z))}catch(T){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(n&&new u.Notice("Docling extraction failed. See console for details."),console.error(T),this.clearStatusProgress(),!1)}let P=!1,D=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;if(!await this.ensureRedisAvailable("rebuild"))P=!0,n&&new u.Notice("Redis is unavailable; skipping indexing for this note.");else try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",w),0);let T=["--chunks-json",this.getAbsoluteVaultPath(r),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(T),this.appendEmbedContextArgs(T),this.settings.embedIncludeMetadata&&T.push("--embed-include-metadata"),this.appendChunkTaggingArgs(T,{allowRegenerate:!1}),await this.runPythonStreaming(v,T,q=>{if((q==null?void 0:q.type)==="progress"&&q.total){let Z=Math.round(q.current/q.total*100),W=typeof q.message=="string"&&q.message.trim()?q.message:`Indexing chunks ${q.current}/${q.total}`,Y=this.formatStatusLabel(W,w);this.showStatusProgress(Y,Z)}},()=>{},D,"index_redisearch",C),this.recreateMissingNotesProcess=null}catch(T){if(this.recreateMissingNotesAbort)return this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1;n&&new u.Notice("RedisSearch indexing failed; note will still be rebuilt."),console.error(T),P=!0}let z=S?this.buildPdfLinkFromSourcePath(S):this.buildPdfLinkForNote(g,c==null?void 0:c.attachment_key,e);try{let T=await this.app.vault.adapter.read(L),q=await this.readChunkPayload(r),Z=this.buildSyncedDoclingContent(e,q,T),W=await this.buildNoteMarkdown(o,(H=a.meta)!=null?H:{},e,z,p,i,Z);await this.writeNoteWithSyncSuppressed(L,W)}catch(T){return n&&new u.Notice("Failed to finalize note markdown."),console.error(T),this.clearStatusProgress(),!1}try{let T=this.extractShortTitleFromValues(o);await this.updateDocIndex({doc_id:e,note_path:L,note_title:A.default.basename(L,".md"),zotero_title:l,short_title:T||void 0,pdf_path:g})}catch(T){console.error("Failed to update doc index",T)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],n=await this.fetchZoteroGroupOptions();return n.length&&e.push(...n),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),n=[],t=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!t)return e&&n.push({value:e,label:e}),n;let i=(this.settings.embedApiKey||"").trim(),r=await this.fetchModelIds(t,i);if(r.length){let a=r.filter(o=>/embed/i.test(o)),s=a.length?a:r;n.push(...s.map(o=>({value:o,label:o})))}return!n.length&&e&&n.push({value:e,label:e}),n.sort((a,s)=>a.label.localeCompare(s.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,n,t){let i=t==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),r=[],a=(e||"").trim().replace(/\/$/,"");if(!a)return i&&r.push({value:i,label:i}),r;let s=(n||"").trim(),o=await this.fetchModelIds(a,s);if(o.length){let l=o.filter(c=>!/embed/i.test(c)),d=l.length?l:o;r.push(...d.map(c=>({value:c,label:c})))}return!r.length&&i&&r.push({value:i,label:i}),r.sort((l,d)=>l.label.localeCompare(d.label))}detectEmbeddingProvider(e){let n=e.toLowerCase();return n.includes("anthropic")?"anthropic":n.includes("openrouter")?"openrouter":n.includes("ollama")||n.includes(":11434")?"ollama":n.includes("openai")?"openai":"generic"}async fetchModelIds(e,n){let t=this.detectEmbeddingProvider(e);try{if(t==="anthropic")return await this.fetchAnthropicModels(e,n);let i=await this.fetchOpenAiCompatibleModels(e,n);return!i.length&&t==="ollama"?await this.fetchOllamaModels(e):i}catch(i){return console.warn("Failed to fetch models",i),[]}}async fetchOpenAiCompatibleModels(e,n){let t=`${e}/models`,i={};n&&(i.Authorization=`Bearer ${n}`);let r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}async fetchOllamaModels(e){let t=`${e.replace(/\/v1\/?$/,"")}/api/tags`,i=await this.requestLocalApiRaw(t);if(i.statusCode>=400)throw new Error(`Ollama tags request failed (${i.statusCode})`);let r;try{r=JSON.parse(i.body.toString("utf8"))}catch(s){return console.warn("Failed to parse Ollama tags response",s),[]}if(!r||typeof r!="object")return[];let a=r.models;return Array.isArray(a)?a.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}async fetchAnthropicModels(e,n){if(!n)return[];let t=`${e}/models`,i={"x-api-key":n,"anthropic-version":"2023-06-01"},r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Anthropic model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}extractModelIds(e){var i,r,a;if(Array.isArray(e))return e.map(s=>this.extractModelId(s)).filter(s=>!!s);if(!e||typeof e!="object")return[];let n=e,t=(a=(r=(i=n.data)!=null?i:n.models)!=null?r:n.model)!=null?a:n.items;return Array.isArray(t)?t.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}extractModelId(e){var r,a,s;if(!e||typeof e!="object")return null;let n=e,t=(s=(a=(r=n.id)!=null?r:n.name)!=null?a:n.model)!=null?s:n.identifier;return typeof t!="string"?null:t.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,n=i=>{for(let r of i)e.has(r.value)||e.set(r.value,r.label)};if(await this.warnIfZoteroLocalApiUnavailable("Zotero groups"))try{let i=this.buildZoteroUrl("/users/0/groups"),r=await this.requestLocalApi(i,`Zotero groups fetch failed for ${i}`);n(this.parseZoteroGroupOptions(r))}catch(i){console.warn("Failed to fetch Zotero groups from local API",i)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let i=(this.settings.webApiLibraryId||"").trim();if(i)try{let r=this.buildWebApiUrl(`/users/${i}/groups`),a=await this.requestWebApi(r,`Zotero Web API groups fetch failed for ${r}`);n(this.parseZoteroGroupOptions(a))}catch(r){console.warn("Failed to fetch Zotero groups from Web API",r)}}return Array.from(e.entries()).map(([i,r])=>({value:i,label:r})).sort((i,r)=>i.label.localeCompare(r.label))}parseZoteroGroupOptions(e){var i,r,a,s,o;let n;try{n=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(n))return[];let t=[];for(let l of n){if(!l||typeof l!="object")continue;let d=(i=l.data)!=null?i:l,c=(a=(r=d.id)!=null?r:l.id)!=null?a:d.key;if(!c)continue;let p=String(c).trim();if(!p)continue;let g=(o=(s=d.name)!=null?s:l.name)!=null?o:p,y=String(g||p).trim()||p;t.push({value:`groups/${p}`,label:`Group: ${y}`})}return t}async ensureFolder(e){let n=this.app.vault.adapter,t=(0,u.normalizePath)(e).split("/").filter(Boolean),i="";for(let r of t)i=i?`${i}/${r}`:r,await n.exists(i)||await n.mkdir(i)}async buildNoteMarkdown(e,n,t,i,r,a,s){let o=`[[${a}]]`,l=this.settings.copyPdfToVault&&i.startsWith("[["),d=r?this.buildZoteroDeepLink(t,r):"",c=d||i,p=l?i:d||i,g=p?l?`PDF: !${p}`:`PDF: ${p}`:"",y=g?`${g}

`:"",b=await this.buildTemplateVars(e,n,t,c,o);b.pdf_block=y,b.pdf_line=g,b.docling_markdown=s;let L=this.ensureDocIdInFrontmatter(await this.renderFrontmatter(e,n,t,c,o,b),t),_=L?`---
${L}
---

`:"",f=(this.settings.noteBodyTemplate||"").trim(),v=`${y}${s}`,w=f?this.renderTemplate(f,b,v,{appendDocling:!0}):v;return`${_}${w}`}async renderFrontmatter(e,n,t,i,r,a){var d;let s=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,n,t,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim();return this.stripEmptyFrontmatterFields(l)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let n=e.split(/\r?\n/),t=[],i=/^([A-Za-z0-9_-]+)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<n.length;){let l=n[o],d=l.match(i);if(!d){t.push(l),o+=1;continue}let c=d[1],p=d[2].trim();if(a.has(c)){t.push(l),o+=1;continue}if(!s(p)){t.push(l),o+=1;continue}let g=o+1,y=[];for(;g<n.length&&n[g].match(r);)y.push(n[g]),g+=1;if(y.length===0){for(o=g;o<n.length&&n[o].trim()==="";)o+=1;continue}let b=y.filter(L=>{let _=L.match(r);if(!_)return!1;let f=_[1].trim();return!s(f)});if(b.length>0&&t.push(l,...b),o=g,b.length===0)for(;o<n.length&&n[o].trim()==="";)o+=1}for(;t.length>0&&t[t.length-1].trim()==="";)t.pop();return t.join(`
...
${n.docling_markdown}`),r.trim()?r:t}async buildTemplateVars(e,n,t,i,r){let a=this.coerceString(e.title),s=this.coerceString(e.shortTitle),o=this.coerceString(e.date),l=typeof(n==null?void 0:n.parsedDate)=="string"?n.parsedDate:"",d=this.extractYear(l||o),c=/^\d{4}$/.test(d)?d:"",p=Array.isArray(e.creators)?e.creators:[],g=p.filter(h=>h.creatorType==="author").map(h=>this.formatCreatorName(h)),y=g.join("; "),b=p.filter(h=>h.creatorType==="editor"||h.creatorType==="seriesEditor").map(h=>this.formatCreatorName(h)),L=b.join("; "),_=Array.isArray(e.tags)?e.tags.map(h=>typeof h=="string"?h:h==null?void 0:h.tag).filter(Boolean):[],f=this.sanitizeObsidianTags(_),v=f.join("; "),w=await this.resolveCollectionTitles(e),S=w.join("; "),C=this.toObsidianLinks(w),P=C.join("; "),D=this.coerceString(e.itemType),I=typeof(n==null?void 0:n.creatorSummary)=="string"?n.creatorSummary:"",z=this.coerceString(e.publicationTitle),R=this.coerceString(e.bookTitle),F=this.coerceString(e.journalAbbreviation),O=this.coerceString(e.volume),$=this.coerceString(e.issue),H=this.coerceString(e.pages),T=typeof e.key=="string"?e.key:t,q=this.coerceString(e.DOI);q||(q=this.extractDoiFromExtra(e));let Z=null;(!q||!s)&&(Z=await this.fetchZoteroItemCsl(T)),q||(q=this.extractDoiFromCsl(Z)),s||(s=this.extractShortTitleFromCsl(Z));let W=this.coerceString(e.ISBN),Y=this.coerceString(e.ISSN),Ee=this.coerceString(e.publisher),ie=this.coerceString(e.place),ne=this.coerceString(e.url),se=this.coerceString(e.language),ae=this.coerceString(e.abstractNote),he=this.extractCitekey(e,n),Ae=this.buildZoteroDeepLink(T),oe=Array.from(new Set([he,s,q].map(h=>String(h||"").trim()).filter(h=>h.length>0))),Q=oe.join("; "),M={doc_id:t,zotero_key:typeof e.key=="string"?e.key:t,item_link:Ae,citekey:he,title:a,short_title:s,date:o,year:d,year_number:c,authors:y,editors:L,aliases:Q,tags:v,collection_title:S,collection_titles:S,collections_links:P,item_type:D,creator_summary:I,publication_title:z,book_title:R,journal_abbrev:F,volume:O,issue:$,pages:H,doi:q,isbn:W,issn:Y,publisher:Ee,place:ie,url:ne,language:se,abstract:ae,pdf_link:i,item_json:r};for(let[h,x]of Object.entries(M)){let E=this.escapeYamlString(x);M[`${h}_yaml`]=E,M[`${h}_quoted`]=E,M[`${h}_text`]=E}return M.authors_yaml_list=this.toYamlList(g),M.editors_yaml_list=this.toYamlList(b),M.tags_yaml_list=f.length>0?this.toYamlList(f):"",M.aliases_yaml_list=oe.length>0?this.toYamlList(oe):"",M.collections_yaml_list=this.toYamlList(w),M.collections_links_yaml_list=this.toYamlList(C),M.tags_raw=_.join("; "),M.tags_raw_yaml=this.escapeYamlString(M.tags_raw),M.tags_raw_yaml_list=_.length>0?this.toYamlList(_):"",M.authors_list=M.authors_yaml_list,M.editors_list=M.editors_yaml_list,M.tags_list=M.tags_yaml_list,M.aliases_list=M.aliases_yaml_list,M.collections_list=M.collections_yaml_list,M.collections_links_list=M.collections_links_yaml_list,M}extractYear(e){if(!e)return"";let n=e.match(/\b(\d{4})\b/);return n?n[1]:""}formatCreatorName(e){if(!e||typeof e!="object")return"";if(e.name)return String(e.name);let n=e.firstName?String(e.firstName):"",t=e.lastName?String(e.lastName):"";return[t,n].filter(Boolean).join(", ")||`${n} ${t}`.trim()}extractCitekey(e,n){let t=[n==null?void 0:n.citationKey,n==null?void 0:n.citekey,n==null?void 0:n.citeKey,n==null?void 0:n.betterBibtexKey,n==null?void 0:n.betterbibtexkey,e.citationKey,e.citekey,e.citeKey,e.betterBibtexKey,e.betterbibtexkey];for(let a of t){let s=this.coerceString(a);if(s)return s}let i=typeof e.extra=="string"?e.extra:"";if(!i)return"";let r=i.split(/\r?\n/);for(let a of r){let s=a.match(/^\s*(citation key|citekey|citation-key|bibtex key|bibtexkey)\s*:\s*(.+)\s*$/i);if(s&&s[2])return s[2].trim()}return""}extractShortTitleFromCsl(e){var t,i;if(!e)return"";let n=(i=(t=e["title-short"])!=null?t:e.shortTitle)!=null?i:e.short_title;return typeof n=="string"?n.trim():""}extractShortTitleFromValues(e){let n=this.coerceString(e.shortTitle);if(n)return n;let t=this.coerceString(e.short_title);if(t)return t;let i=this.coerceString(e["title-short"]);return i||""}extractDoiFromExtra(e){let n=typeof e.extra=="string"?e.extra:"";if(!n)return"";let t=n.split(/\r?\n/);for(let r of t){let a=r.match(/^\s*doi\s*:\s*(.+)\s*$/i);if(a&&a[1])return a[1].trim().replace(/[.,;]+$/,"")}let i=n.match(/\b10\.\d{4,9}\/[-._;()/:A-Z0-9]+\b/i);return i?i[0].replace(/[.,;]+$/,""):""}extractDoiFromCsl(e){var t;if(!e)return"";let n=(t=e.DOI)!=null?t:e.doi;return typeof n=="string"?n.trim().replace(/[.,;]+$/,""):""}coerceString(e){if(typeof e=="string")return e.trim();if(typeof e=="number"&&Number.isFinite(e))return String(e);if(Array.isArray(e))for(let n of e){if(typeof n=="string"&&n.trim())return n.trim();if(typeof n=="number"&&Number.isFinite(n))return String(n)}if(e&&typeof e=="object"){let n=e[0];if(typeof n=="string"&&n.trim())return n.trim();if(typeof n=="number"&&Number.isFinite(n))return String(n)}return""}escapeYamlString(e){return`"${String(e).replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n")}"`}toYamlList(e){return e.length?e.map(n=>`  - ${this.escapeYamlString(n)}`).join(`
`):'  - ""'}sanitizeObsidianTags(e){let n=this.settings.tagSanitizeMode||"kebab",t=n==="replace"?"kebab":n;return e.map(i=>this.sanitizeObsidianTag(i,t)).filter(i=>i.length>0)}sanitizeObsidianTag(e,n){let t=String(e||"").trim();if(!t)return"";let i=t.replace(/^#+/,"");if(n==="none")return i;let r=o=>!/^\d+$/.test(o),s=(o=>i.split("/").map(c=>{let g=c.replace(/[^\p{L}\p{N}]+/gu," ").split(/\s+/).filter(Boolean);if(!g.length)return"";if(o==="camel"||o==="pascal"){let[b,...L]=g;return[o==="pascal"?b.charAt(0).toUpperCase()+b.slice(1):b.charAt(0).toLowerCase()+b.slice(1),...L.map(f=>f.charAt(0).toUpperCase()+f.slice(1))].join("")}let y=o==="snake"?"_":"-";return g.join(y)}).filter(Boolean).join("/").replace(/\/{2,}/g,"/").replace(/^\/+|\/+$/g,""))(n);return s&&r(s)?s:""}toObsidianLinks(e){return e.map(n=>String(n||"").trim()).filter(n=>n.length>0).map(n=>n.startsWith("[[")&&n.endsWith("]]")?n:`[[${n}]]`)}getVaultBasePath(){var t;let e=this.app.vault.adapter;if(e instanceof u.FileSystemAdapter)return e.getBasePath();let n=(t=e.getBasePath)==null?void 0:t.call(e);if(n)return n;throw new Error("Vault base path is unavailable.")}getPluginDir(){var i;let e=this.getVaultBasePath(),n=(i=this.manifest.dir)!=null?i:this.manifest.id;if(!n)throw new Error("Plugin directory is unavailable.");let t=A.default.isAbsolute(n)?n:A.default.join(e,n);return A.default.normalize(t)}async ensureBundledTools(){let e=this.getPluginDir(),n=A.default.join(e,"tools");await B.promises.mkdir(n,{recursive:!0});for(let[t,i]of Object.entries(Ke)){let r=A.default.join(n,t),a=!0;try{await B.promises.readFile(r,"utf8")===i&&(a=!1)}catch(s){}a&&await B.promises.writeFile(r,i,"utf8")}}async migrateCachePaths(){let e="zotero/items",n="zotero/chunks",t=J,i=V,r=this.app.vault.adapter,a=(0,u.normalizePath)(e),s=(0,u.normalizePath)(n),o=(0,u.normalizePath)(t),l=(0,u.normalizePath)(i),d=o.split("/").slice(0,-1).join("/"),c=l.split("/").slice(0,-1).join("/");d&&await this.ensureFolder(d),c&&await this.ensureFolder(c);let p=await r.exists(a),g=await r.exists(s),y=await r.exists(o),b=await r.exists(l);p&&!y&&await r.rename(a,o),g&&!b&&await r.rename(s,l)}getAbsoluteVaultPath(e){let n=this.getVaultBasePath(),t=A.default.isAbsolute(e)?e:A.default.join(n,e);return A.default.normalize(t)}async resolveAttachmentOutputDir(e){let n=e?A.default.isAbsolute(e)?this.toVaultRelativePath(e):(0,u.normalizePath)(e):"";if(!n)return null;let t=this.app.fileManager;if(!(t!=null&&t.getAvailablePathForAttachment))return null;try{let i=`zrr-image-${Date.now()}.png`,r=await t.getAvailablePathForAttachment(i,n);if(!r)return null;let a=A.default.isAbsolute(r)?r:this.getAbsoluteVaultPath(r),s=A.default.normalize(A.default.dirname(a)),o=A.default.normalize(this.getVaultBasePath()),l=this.toVaultRelativePath(s);return!l&&s!==o?null:{absolute:s,relative:l}}catch(i){return console.warn("Failed to resolve attachment output dir",i),null}}async buildDoclingArgs(e,n,t,i,r,a=!1){let s=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",n,"--out-json",this.getAbsoluteVaultPath(t),"--out-md",this.getAbsoluteVaultPath(i),"--chunking",this.settings.chunkingMode,"--ocr",s];a&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),r&&o.push("--language-hint",r),this.settings.enableLlmCleanup&&(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars)));let l=this.getPluginDir(),d=A.default.join(l,"tools","ocr_wordlist.txt");if((0,B.existsSync)(d)&&o.push("--enable-dictionary-correction","--dictionary-path",d),this.settings.enableFileLogging){let p=this.getLogFileAbsolutePath();p&&o.push("--log-file",p);let g=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());g&&o.push("--spellchecker-info-out",g)}let c=await this.resolveAttachmentOutputDir(i);return c&&(c.relative&&await this.ensureFolder(c.relative),o.push("--image-output-dir",c.absolute)),this.appendOcrEngineArgs(o),o}appendOcrEngineArgs(e){let n=this.settings.ocrEngine,t=(this.settings.paddleApiKey||"").trim(),i=(this.settings.paddleVlApiUrl||"").trim(),r=(this.settings.paddleStructureApiUrl||"").trim(),a=o=>{e.push("--prefer-ocr-engine",o,"--fallback-ocr-engine",o)},s=()=>{e.push("--no-paddle-vl-api","--no-paddle-structure-api")};switch(n){case"tesseract":a("tesseract"),e.push("--no-paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_local":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl"),s();break;case"paddle_vl_local":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_api":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl","--no-paddle-vl-api"),t?(e.push("--paddle-structure-api","--paddle-structure-api-token",t),r&&e.push("--paddle-structure-api-url",r)):e.push("--no-paddle-structure-api");break;case"paddle_vl_api":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3","--no-paddle-structure-api"),t?(e.push("--paddle-vl-api","--paddle-vl-api-token",t),i&&e.push("--paddle-vl-api-url",i)):e.push("--no-paddle-vl-api");break;default:s();break}}appendEmbedSubchunkArgs(e){let n=this.settings.embedSubchunkChars;Number.isFinite(n)&&e.push("--embed-subchunk-chars",String(Math.max(0,Math.trunc(n))));let t=this.settings.embedSubchunkOverlap;Number.isFinite(t)&&e.push("--embed-subchunk-overlap",String(Math.max(0,Math.trunc(t))))}appendEmbedContextArgs(e){let n=this.settings.embedContextWindow;Number.isFinite(n)&&e.push("--embed-context-window",String(Math.max(0,Math.trunc(n))));let t=this.settings.embedContextChars;Number.isFinite(t)&&e.push("--embed-context-chars",String(Math.max(0,Math.trunc(t))))}appendChunkTaggingArgs(e,n){if((n==null?void 0:n.allowRegenerate)===!1||!this.settings.enableChunkTagging)return;let t=(this.settings.llmCleanupBaseUrl||"").trim(),i=(this.settings.llmCleanupModel||"").trim();if(!t||!i)return;e.push("--generate-chunk-tags","--tag-base-url",t,"--tag-model",i);let r=(this.settings.llmCleanupApiKey||"").trim();r&&e.push("--tag-api-key",r),e.push("--tag-temperature",String(this.settings.llmCleanupTemperature))}getRedisDataDir(){let e=(process.env.ZRR_DATA_DIR||"").trim();if(e)return e;let n=(this.settings.redisDataDirOverride||"").trim();return!this.settings.autoAssignRedisPort&&n?A.default.isAbsolute(n)?n:A.default.join(this.getVaultBasePath(),n):A.default.join(this.getVaultBasePath(),K,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return A.default.join(e,"tools","docker-compose.yml")}async resolveDockerPath(){var l;let e=(l=this.settings.dockerPath)==null?void 0:l.trim(),n=["/opt/homebrew/bin/docker","/usr/local/bin/docker","/usr/bin/docker","/Applications/Docker.app/Contents/Resources/bin/docker"],t=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"],i=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"],r=[];e&&r.push(e);let a=e?this.getContainerCliKind(e):"docker",s=a==="podman-compose"?[i,t,n]:a==="podman"?[t,i,n]:[n,t,i];if(!e||e==="docker"||e==="podman"||e==="podman-compose")for(let d of s)r.push(...d);for(let d of r)if(A.default.isAbsolute(d))try{if(await this.isContainerCliAvailable(d))return d}catch(c){}let o=[e,a==="podman"?"podman":"docker",a==="podman"?"docker":"podman","podman-compose"].filter(d=>!!(d&&d.trim()));for(let d of o)if(await this.isContainerCliAvailable(d))return d;return e||"docker"}async isContainerCliAvailable(e){return new Promise(n=>{let t=(0,X.spawn)(e,["--version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}getContainerCliKind(e){let n=A.default.basename(e);return n==="podman-compose"?"podman-compose":n.includes("podman")?"podman":"docker"}async isContainerDaemonRunning(e){let n=this.getContainerCliKind(e),t=e,i=["info"];if(n==="podman-compose"){let r=await this.resolvePodmanBin();if(!r)return!1;t=r}return new Promise(r=>{let a=(0,X.spawn)(t,i),s=!1,o=d=>{s||(s=!0,r(d))},l=setTimeout(()=>{a.kill(),o(!1)},2e3);a.on("error",()=>{clearTimeout(l),o(!1)}),a.on("close",d=>{clearTimeout(l),o(d===0)})})}getContainerDaemonHint(e){let n=this.getContainerCliKind(e);return n==="podman"||n==="podman-compose"?"Podman machine not running. Run `podman machine start`.":"Docker Desktop is not running. Start Docker Desktop."}async supportsComposeSubcommand(e){return new Promise(n=>{let t=(0,X.spawn)(e,["compose","version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}async findPodmanComposePath(){let e=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"];for(let n of e)try{return await B.promises.access(n),n}catch(t){}return await this.isContainerCliAvailable("podman-compose")?"podman-compose":null}async resolvePodmanBin(){let e=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"];for(let n of e)if(await this.isContainerCliAvailable(n))return n;return await this.isContainerCliAvailable("podman")?"podman":null}async resolveComposeCommand(e){let n=A.default.basename(e);if(n==="podman-compose")return{command:e,argsPrefix:[]};if(n==="podman"){let t=await this.findPodmanComposePath();return t?{command:t,argsPrefix:[]}:await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}return await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}async autoDetectContainerCliOnLoad(){var a;let e=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(e)){this.notifyContainerOnce("Docker or Podman not found. Install Docker Desktop or Podman and set Docker/Podman path in settings.");return}let n=((a=this.settings.dockerPath)==null?void 0:a.trim())||"docker";(!await this.isContainerCliAvailable(n)||n==="docker"||n==="podman"||n==="podman-compose")&&e&&e!==n&&(this.settings.dockerPath=e,await this.saveSettings());let r=s=>new Promise(o=>setTimeout(o,s));if(!await this.isContainerDaemonRunning(e)){for(let s of[5e3,1e4])if(await r(s),await this.isContainerDaemonRunning(e))return;this.notifyContainerOnce(this.getContainerDaemonHint(e))}}getDockerProjectName(){let e=s=>s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,32),n=(process.env.ZRR_PROJECT_NAME||"").trim();if(n&&!this.settings.autoAssignRedisPort)return e(n)||"zrr";let t=(this.settings.redisProjectName||"").trim();if(t&&!this.settings.autoAssignRedisPort)return e(t)||"zrr";let i=this.getVaultBasePath(),r=A.default.basename(i).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),a=(0,ve.createHash)("sha1").update(i).digest("hex").slice(0,8);return`zrr-${r||"vault"}-${a}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),n=e.port?Number(e.port):6379;return Number.isFinite(n)&&n>0?n:6379}catch(e){return 6379}}getVaultPreferredRedisPort(){let e=(0,ve.createHash)("sha1").update(this.getVaultBasePath()).digest("hex");return 6400+Number.parseInt(e.slice(0,4),16)%2e3}getRedisHostFromUrl(){try{return new URL(this.settings.redisUrl).hostname||"127.0.0.1"}catch(e){return"127.0.0.1"}}isLocalRedisHost(e){let n=e.trim().toLowerCase();return n?n==="localhost"||n==="0.0.0.0"||n==="::1"?!0:n.startsWith("127."):!1}getPortCheckHost(e){return this.isLocalRedisHost(e)?"127.0.0.1":e}async isPortFree(e,n){return new Promise(t=>{let i=ge.default.createServer();i.once("error",()=>t(!1)),i.once("listening",()=>{i.close(()=>t(!0))}),i.listen(n,e)})}async findAvailablePort(e,n){for(let i=0;i<25;i+=1){let r=n+i;if(await this.isPortFree(e,r))return r}return null}updateRedisUrlPort(e,n){try{let t=new URL(e);return t.port=String(n),t.toString()}catch(t){return`redis://127.0.0.1:${n}`}}async isRedisReachable(e){let n="127.0.0.1",t=6379;try{let i=new URL(e);n=i.hostname||n,t=i.port?Number(i.port):t}catch(i){return!1}return n=this.getPortCheckHost(n),new Promise(i=>{let r=new ge.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(t,n)})}async isZoteroLocalApiReachable(){let e=(this.settings.zoteroBaseUrl||"").trim();if(!e)return!1;let n="127.0.0.1",t=23119;try{let i=new URL(e);if(n=i.hostname||n,i.port){let r=Number(i.port);Number.isFinite(r)&&r>0&&(t=r)}else i.protocol==="https:"?t=443:t=80}catch(i){return!1}return new Promise(i=>{let r=new ge.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(t,n)})}getRedisNamespace(){let e=this.getVaultBasePath(),n=A.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24),t=(0,ve.createHash)("sha1").update(e).digest("hex").slice(0,8);return`${n||"vault"}-${t}`}getRedisIndexName(){return`${(this.settings.redisIndex||"idx:zotero").trim()||"idx:zotero"}:${this.getRedisNamespace()}`}getRedisKeyPrefix(){let e=(this.settings.redisPrefix||"zotero:chunk:").trim()||"zotero:chunk:";return`${e.endsWith(":")?e:`${e}:`}${this.getRedisNamespace()}:`}async isComposeProjectRunning(e,n,t,i,r){return new Promise(a=>{let s=(0,X.spawn)(e,[...n,"-p",i,"-f",t,"ps","-q"],{cwd:A.default.dirname(t),env:r}),o="";s.stdout.on("data",l=>{o+=l.toString()}),s.on("error",l=>{console.warn("Redis Stack status check failed",l),a(!1)}),s.on("close",l=>{if(l!==0){a(!1);return}a(o.trim().length>0)})})}async startRedisStack(e){var n;try{await this.ensureBundledTools();let t=this.getDockerComposePath(),i=this.getRedisDataDir();await B.promises.mkdir(i,{recursive:!0});let r=await this.resolveDockerPath(),a=((n=this.settings.dockerPath)==null?void 0:n.trim())||"docker";if((!await this.isContainerCliAvailable(a)||!a||a==="docker"||a==="podman"||a==="podman-compose")&&r&&r!==a&&(this.settings.dockerPath=r,await this.saveSettings(),e||new u.Notice(`Docker/Podman path set to ${r}.`)),!await this.isContainerCliAvailable(r)){e||new u.Notice('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');return}if(!await this.isContainerDaemonRunning(r)){e||new u.Notice(this.getContainerDaemonHint(r));return}let o=await this.resolveComposeCommand(r);if(!o){e||new u.Notice("Compose support not found. Install Docker Desktop or Podman with podman-compose.");return}let l={...process.env};if(A.default.basename(o.command)==="podman-compose"){let f=await this.resolvePodmanBin();if(f&&(l.PODMAN_BIN=f,A.default.isAbsolute(f))){let v=A.default.dirname(f),w=l.PATH||"";w.split(A.default.delimiter).includes(v)||(l.PATH=`${v}${A.default.delimiter}${w}`)}}let d=this.getDockerProjectName();if(await this.isComposeProjectRunning(o.command,o.argsPrefix,t,d,l)){e||new u.Notice("Redis Stack already running for this vault.");return}let c=this.getRedisPortFromUrl(),p=this.getRedisHostFromUrl(),g=this.getPortCheckHost(p),y=this.settings.autoAssignRedisPort&&this.isLocalRedisHost(p),b=this.settings.redisUrl,L=c,_=()=>{if(!e){if(!this.settings.autoAssignRedisPort){new u.Notice("Redis already running. If you share Redis across vaults, disable Auto-start Redis in this vault.");return}new u.Notice(`Redis already running at ${b}.`)}};if(y){let f=c===6379?this.getVaultPreferredRedisPort():c,v=await this.findAvailablePort(g,f);if(!v)throw new Error(`No available Redis port found starting at ${f}.`);v!==c&&(L=v,b=this.updateRedisUrlPort(b,L),this.settings.redisUrl=b,await this.saveSettings(),e||new u.Notice(`Using Redis port ${L} for this vault.`))}else{if(this.isLocalRedisHost(p)&&!await this.isPortFree(g,L)){await this.isRedisReachable(b)?_():e||new u.Notice(`Port ${L} is already in use and Redis is not reachable at ${b}. Update the Redis URL or enable auto-assign.`);return}if(await this.isRedisReachable(b)){_();return}}l.ZRR_DATA_DIR=i,l.ZRR_PORT=String(L);try{await this.runCommand(o.command,[...o.argsPrefix,"-p",d,"-f",t,"down"],{cwd:A.default.dirname(t),env:l})}catch(f){console.warn("Redis Stack stop before restart failed",f)}await this.runCommand(o.command,[...o.argsPrefix,"-p",d,"-f",t,"up","-d"],{cwd:A.default.dirname(t),env:l}),e||new u.Notice("Redis Stack started.")}catch(t){e||new u.Notice("Failed to start Redis Stack. Check Docker/Podman and file sharing."),console.error("Failed to start Redis Stack",t)}}async setupPythonEnv(){let e=this.getPluginDir(),n=this.getPythonVenvDir(),t=this.getVenvPythonPath(n);await this.ensureBundledTools();let i=this.resolveRequirementsPath(e);if(!i)throw new Error(`requirements.txt not found in ${e}`);try{new u.Notice("Setting up Python environment..."),this.showStatusProgress("Setting up Python environment...",null),console.log(`Python env: using plugin dir ${e}`),console.log(`Python env: venv path ${n}`),await B.promises.mkdir(A.default.dirname(n),{recursive:!0});let r=null,a=async()=>(r||(r=await this.resolveBootstrapPython()),r);if((0,B.existsSync)(t)){let s=await this.getPythonVersion(t,[]);if(s&&this.isUnsupportedPythonVersion(s)){let o=await a();console.log(`Python env: existing venv uses Python ${s.major}.${s.minor}; rebuilding with ${o.command} ${o.args.join(" ")}`),this.showStatusProgress("Rebuilding Python environment...",null),await B.promises.rm(n,{recursive:!0,force:!0})}}if(!(0,B.existsSync)(t)){let s=await a();console.log(`Python env: creating venv with ${s.command} ${s.args.join(" ")}`),await this.runCommand(s.command,[...s.args,"-m","venv",n],{cwd:e})}await this.runCommandStreaming(t,["-m","pip","install","-r",i],{cwd:e},s=>{let o=s.trim();if(!o)return;let l=o.match(/^Collecting\s+([^\s]+)/);if(l){this.showStatusProgress(`Installing ${l[1]}...`,null);return}if(o.startsWith("Installing collected packages")){this.showStatusProgress("Installing packages...",null);return}o.startsWith("Successfully installed")&&this.showStatusProgress("Python environment ready.",100)}),this.settings.pythonPath=t,await this.saveSettings(),this.clearStatusProgress(),new u.Notice("Python environment ready.")}catch(r){this.clearStatusProgress(),new u.Notice("Failed to set up Python environment. See console for details."),console.error("Python env setup failed",r)}}async detectOcrEngines(){let e=await this.canRunCommand("tesseract",[]),n=(this.settings.pythonPath||"").trim(),t=[];if(!n)try{let l=await this.resolveBootstrapPython();n=l.command,t=l.args}catch(l){return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1}}let i=["import importlib.util, json","def has_module(name):","    return importlib.util.find_spec(name) is not None","has_paddle = has_module('paddle')","has_paddleocr = has_module('paddleocr')","has_paddlex = has_module('paddlex')","has_vl = False","if has_paddleocr:","    try:","        from paddleocr import PaddleOCRVL","        has_vl = True","    except Exception:","        has_vl = False","print(json.dumps({'paddle': has_paddle, 'paddleocr': has_paddleocr, 'paddlex': has_paddlex, 'paddle_vl': has_vl}))"].join(`
`),r=await new Promise(l=>{let d=(0,X.spawn)(n,[...t,"-c",i],{env:this.buildPythonEnv()}),c="";d.stdout.on("data",p=>{c+=p.toString()}),d.on("error",()=>l({ok:!1})),d.on("close",p=>{if(p!==0){l({ok:!1});return}try{let g=JSON.parse(c.trim());l({ok:!0,data:g})}catch(g){l({ok:!1})}})});if(!r.ok||!r.data)return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1};let a=r.data,s=!!a.paddle,o=!!a.paddleocr;return{tesseract:e,paddleStructureLocal:s&&o&&!!a.paddlex,paddleVlLocal:s&&o&&!!a.paddle_vl}}getSharedPythonEnvRoot(){let e=sn.default.homedir();if(process.platform==="win32"){let t=process.env.LOCALAPPDATA||process.env.APPDATA||A.default.join(e,"AppData","Local");return A.default.join(t,"zotero-redisearch-rag")}let n=process.env.XDG_CACHE_HOME||A.default.join(e,".cache");return A.default.join(n,"zotero-redisearch-rag")}getPythonVenvDir(){return this.settings.pythonEnvLocation==="plugin"?A.default.join(this.getPluginDir(),".venv"):A.default.join(this.getSharedPythonEnvRoot(),"venv")}getVenvPythonPath(e){return process.platform==="win32"?A.default.join(e,"Scripts","python.exe"):A.default.join(e,"bin","python")}resolveRequirementsPath(e){var t;return(t=[A.default.join(e,"requirements.txt"),A.default.join(e,"tools","requirements.txt")].find(i=>(0,B.existsSync)(i)))!=null?t:null}async resolveBootstrapPython(){let e=(this.settings.pythonPath||"").trim();if(e&&await this.canRunCommand(e,[])){let t=await this.getPythonVersion(e,[]);if(t&&this.isUnsupportedPythonVersion(t))throw new Error(`Configured Python ${t.major}.${t.minor} is not supported. Install Python 3.11\u20133.13 and update the Python path.`);return{command:e,args:[]}}let n=process.platform==="win32"?[{command:"py",args:["-3.13"]},{command:"py",args:["-3.12"]},{command:"py",args:["-3.11"]},{command:"py",args:["-3.10"]},{command:"py",args:["-3"]},{command:"python",args:[]}]:[{command:"python3.13",args:[]},{command:"python3.12",args:[]},{command:"python3.11",args:[]},{command:"python3.10",args:[]},{command:"python3",args:[]},{command:"python",args:[]}];for(let t of n)if(await this.canRunCommand(t.command,t.args)){let i=await this.getPythonVersion(t.command,t.args);if(i&&this.isUnsupportedPythonVersion(i)){console.log(`Python env: skipping ${t.command} ${t.args.join(" ")} (Python ${i.major}.${i.minor} unsupported)`);continue}return t}throw new Error("No usable Python 3.11\u20133.13 interpreter found on PATH.")}isUnsupportedPythonVersion(e){return e.major>3||e.major===3&&e.minor>=14}async getPythonVersion(e,n){return new Promise(t=>{let i=(0,X.spawn)(e,[...n,"-c","import sys; print(f'{sys.version_info.major}.{sys.version_info.minor}')"]),r="";i.stdout.on("data",a=>{r+=a.toString()}),i.on("error",()=>t(null)),i.on("close",a=>{if(a!==0){t(null);return}let s=r.trim().match(/(\d+)\.(\d+)/);if(!s){t(null);return}t({major:Number(s[1]),minor:Number(s[2])})})})}async canRunCommand(e,n){return new Promise(t=>{let i=(0,X.spawn)(e,[...n,"--version"],{env:this.buildPythonEnv()});i.on("error",()=>t(!1)),i.on("close",r=>t(r===0))})}buildPythonEnv(){let e={...process.env},n=A.default.delimiter,t=e.PATH||"",r=[...process.platform==="win32"?[]:["/opt/homebrew/bin","/usr/local/bin"],t].filter(Boolean).join(n);return e.PATH=r,e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK||(e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK="True"),e.DISABLE_MODEL_SOURCE_CHECK||(e.DISABLE_MODEL_SOURCE_CHECK="True"),e}runPython(e,n){return new Promise((t,i)=>{let r=(0,X.spawn)(this.settings.pythonPath,[e,...n],{cwd:A.default.dirname(e),env:this.buildPythonEnv()}),a="",s="";r.stdout.on("data",o=>{a+=o.toString()}),r.stderr.on("data",o=>{s+=o.toString()}),r.on("error",o=>{this.handlePythonProcessError(String(o)),i(o)}),r.on("close",o=>{if(o===0)t();else{let l=s.trim()?s:a;this.handlePythonProcessError(l),i(new Error(s||`Process exited with code ${o}`))}})})}runCommand(e,n,t){return new Promise((i,r)=>{var o;let a=(0,X.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:(o=t==null?void 0:t.env)!=null?o:this.buildPythonEnv()}),s="";a.stderr.on("data",l=>{s+=l.toString()}),a.on("error",l=>{r(l)}),a.on("close",l=>{l===0?i():r(new Error(s||`Process exited with code ${l}`))})})}runPythonStreaming(e,n,t,i,r,a="docling_extract",s){return new Promise((o,l)=>{let d=(0,X.spawn)(this.settings.pythonPath,[e,...n],{cwd:A.default.dirname(e),env:this.buildPythonEnv()});s&&s(d);let c="",p="",g="",y=null,b=!1,L=_=>{if(_.trim())try{let f=JSON.parse(_);y=f,((f==null?void 0:f.type)==="final"||f!=null&&f.answer)&&(b=!0),t(f)}catch(f){g+=`${_}
`}};d.stdout.on("data",_=>{var v;c+=_.toString();let f=c.split(/\r?\n/);c=(v=f.pop())!=null?v:"";for(let w of f)L(w)}),d.stderr.on("data",_=>{p+=_.toString()}),d.on("error",_=>{this.handlePythonProcessError(String(_)),l(_)}),d.on("close",_=>{if(c.trim()&&L(c),!b&&y&&i(y),r&&this.appendToLogFile(r,p,a,"STDERR"),_===0)o();else{let f=p.trim()?p:g;this.handlePythonProcessError(f),l(new Error(p||`Process exited with code ${_}`))}})})}runCommandStreaming(e,n,t,i){return new Promise((r,a)=>{var d;let s=(0,X.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:(d=t==null?void 0:t.env)!=null?d:this.buildPythonEnv()}),o=c=>{c.toString().split(/\r?\n/).forEach(g=>{g.trim()&&i(g)})},l="";s.stdout.on("data",o),s.stderr.on("data",c=>{l+=c.toString(),o(c)}),s.on("error",c=>{a(c)}),s.on("close",c=>{c===0?r():a(new Error(l||`Process exited with code ${c}`))})})}handlePythonProcessError(e){if(!e)return;let n=e.match(/ModuleNotFoundError:\s+No module named ['"]([^'"]+)['"]/);if(n){let t=`Python env missing module '${n[1]}'. Open Settings > Python environment > Create/Update.`;this.notifyPythonEnvOnce(t,!0);return}if(/No module named ['"]|ImportError: No module named/i.test(e)){this.notifyPythonEnvOnce("Python env missing required modules. Open Settings > Python environment > Create/Update.",!0);return}/ENOENT|No such file or directory|not found|command not found|spawn .* ENOENT/i.test(e)&&this.notifyPythonEnvOnce("Python not found. Configure the Python path or use Settings > Python environment > Create/Update.",!0)}notifyPythonEnvOnce(e,n=!1){this.lastPythonEnvNotice!==e&&(this.lastPythonEnvNotice=e,new u.Notice(e),n&&this.openPluginSettings())}notifyContainerOnce(e){this.lastContainerNotice!==e&&(this.lastContainerNotice=e,new u.Notice(e))}notifyRedisOnce(e){this.lastRedisNotice!==e&&(this.lastRedisNotice=e,new u.Notice(e))}async autoDetectRedisOnLoad(){if(this.settings.autoStartRedis)return;let e=(this.settings.redisUrl||"").trim(),t=e||"redis://127.0.0.1:6379";(await this.checkRedisConnectionWithUrl(t,500)).ok&&(e||(this.settings.redisUrl=t,await this.saveSettings()),this.notifyRedisOnce(`Redis detected at ${t}. This instance will be used.`))}notifyZoteroApiOnce(e){this.lastZoteroApiNotice!==e&&(this.lastZoteroApiNotice=e,new u.Notice(e))}async warnIfZoteroLocalApiUnavailable(e){if(await this.isZoteroLocalApiReachable())return this.lastZoteroApiNotice=null,!0;let i=`Zotero Local API is not reachable for ${e?`${e}`:"this action"}. Start Zotero or update the Local API URL in settings.`;return this.notifyZoteroApiOnce(i),!1}openPluginSettings(){let e=this.app.setting;e!=null&&e.open&&e.open(),e!=null&&e.openTabById&&e.openTabById(this.manifest.id)}getLogsDirRelative(){return(0,u.normalizePath)(`${K}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,u.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,u.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;if(!await n.exists(e)){new u.Notice("Log file not found.");return}try{let t=async()=>{try{return await n.read(e)||"(empty)"}catch(r){return"(empty)"}},i=await t();new me(this.app,"Log file",i||"(empty)",{autoRefresh:!0,refreshIntervalMs:2e3,onRefresh:t,onClear:async()=>{await this.clearLogFile()}}).open()}catch(t){new u.Notice("Failed to open log file."),console.error(t)}}async clearLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{let t=(0,u.normalizePath)(A.default.dirname(e));t&&await this.ensureFolder(t),await n.write(e,""),new u.Notice("Log file cleared.")}catch(t){new u.Notice("Failed to clear log file."),console.error(t)}}async deleteLogFileIfExists(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{await n.exists(e)&&await n.remove(e)}catch(t){console.warn("Failed to delete log file before import",t)}}formatLogLines(e,n,t){let i=e.split(/\r?\n/).map(a=>a.trimEnd()).filter(a=>!!a.trim());if(!i.length)return"";let r=new Date().toISOString().replace("T"," ").replace(".",",");return i.map(a=>`${r} ${t} ${n}: ${a}`).join(`
`)+`
`}async appendToLogFile(e,n,t="docling_extract",i="STDERR"){if(!n||!n.trim())return;let r=this.formatLogLines(n,t,i);if(r)try{await B.promises.mkdir(A.default.dirname(e),{recursive:!0}),await B.promises.appendFile(e,r)}catch(a){console.warn("Failed to append stderr to log file",a)}}runPythonWithOutput(e,n,t,i="docling_extract"){return new Promise((r,a)=>{let s=(0,X.spawn)(this.settings.pythonPath,[e,...n],{cwd:A.default.dirname(e),env:this.buildPythonEnv()}),o="",l="";s.stdout.on("data",d=>{o+=d.toString()}),s.stderr.on("data",d=>{l+=d.toString()}),s.on("error",d=>{this.handlePythonProcessError(String(d)),a(d)}),s.on("close",d=>{if(t&&this.appendToLogFile(t,l,i,"STDERR"),d===0)r(o.trim());else{let c=l.trim()?l:o;this.handlePythonProcessError(c),a(new Error(l||`Process exited with code ${d}`))}})})}},Be=class extends u.SuggestModal{constructor(e,n,t){super(e);this.lastError=null;this.indexedDocIds=null;this.attachmentStatusCache=new Map;this.attachmentChecks=new Set;this.plugin=n,this.resolveSelection=t,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){try{if(!this.indexedDocIds){let n=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(n))}return await this.plugin.searchZoteroItems(e)}catch(n){let t=n instanceof Error?n.message:String(n);return this.lastError!==t&&(this.lastError=t,new u.Notice(t)),console.error("Zotero search failed",n),[]}}renderSuggestion(e,n){var c,p,g;let t=(p=(c=e.data)==null?void 0:c.title)!=null?p:"[No title]",i=this.extractYear(e),r=this.getDocId(e),a=r?(g=this.indexedDocIds)==null?void 0:g.has(r):!1,s=this.getPdfStatus(e);a&&n.addClass("zrr-indexed-item"),s==="no"&&n.addClass("zrr-no-pdf-item"),n.createEl("div",{text:t});let o=n.createEl("small"),l=!1,d=()=>{l&&o.createSpan({text:" \u2022 "})};if(i&&(o.createSpan({text:i}),l=!0),a&&(d(),o.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),l=!0),s==="no"&&(d(),o.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),l=!0),s==="unknown"){let y=r?this.attachmentStatusCache.get(r):void 0;y==="no"?(d(),o.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),l=!0,n.addClass("zrr-no-pdf-item")):y==="yes"||r&&this.refreshAttachmentStatus(r,e,n,o)}n.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,n){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}getDocId(e){var t,i,r;let n=(r=(i=e.key)!=null?i:(t=e.data)==null?void 0:t.key)!=null?r:"";return typeof n=="string"?n:""}getPdfStatus(e){var i;let n=this.collectItemAttachments(e.data);if(n.length>0)return n.some(a=>this.isPdfAttachment(a))?"yes":"no";let t=(i=e.meta)==null?void 0:i.numChildren;return typeof t=="number"&&t===0?"no":"unknown"}collectItemAttachments(e){if(!e)return[];let n=[e.attachments,e.children,e.items,e.attachment,e.allAttachments],t=[];for(let i of n)i&&(Array.isArray(i)?t.push(...i):typeof i=="object"&&t.push(i));return t}isPdfAttachment(e){var i,r,a,s,o,l,d,c,p,g,y,b,L,_,f;if(((l=(o=(a=(i=e==null?void 0:e.contentType)!=null?i:e==null?void 0:e.mimeType)!=null?a:(r=e==null?void 0:e.data)==null?void 0:r.contentType)!=null?o:(s=e==null?void 0:e.data)==null?void 0:s.mimeType)!=null?l:"")==="application/pdf")return!0;let t=(f=(_=(b=(y=(p=(d=e==null?void 0:e.filename)!=null?d:e==null?void 0:e.fileName)!=null?p:(c=e==null?void 0:e.data)==null?void 0:c.filename)!=null?y:(g=e==null?void 0:e.data)==null?void 0:g.fileName)!=null?b:e==null?void 0:e.path)!=null?_:(L=e==null?void 0:e.data)==null?void 0:L.path)!=null?f:"";return!!(typeof t=="string"&&t.toLowerCase().endsWith(".pdf"))}extractYear(e){var i,r,a,s;let n=(s=(a=(i=e.meta)==null?void 0:i.parsedDate)!=null?a:(r=e.data)==null?void 0:r.date)!=null?s:"";if(typeof n!="string")return"";let t=n.match(/\b(\d{4})\b/);return t?t[1]:""}async refreshAttachmentStatus(e,n,t,i){if(!this.attachmentChecks.has(e)){this.attachmentChecks.add(e);try{let r=await this.plugin.hasProcessableAttachment(n);this.attachmentStatusCache.set(e,r?"yes":"no"),!r&&i.isConnected&&t.isConnected&&(i.querySelector(".zrr-no-pdf-flag")||(i.childNodes.length>0&&i.createSpan({text:" \u2022 "}),i.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"})),t.addClass("zrr-no-pdf-item"))}finally{this.attachmentChecks.delete(e)}}}};

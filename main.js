"use strict";var dn=Object.create;var be=Object.defineProperty;var cn=Object.getOwnPropertyDescriptor;var pn=Object.getOwnPropertyNames;var un=Object.getPrototypeOf,_n=Object.prototype.hasOwnProperty;var gn=(k,m)=>{for(var e in m)be(k,e,{get:m[e],enumerable:!0})},Ze=(k,m,e,n)=>{if(m&&typeof m=="object"||typeof m=="function")for(let t of pn(m))!_n.call(k,t)&&t!==e&&be(k,t,{get:()=>m[t],enumerable:!(n=cn(m,t))||n.enumerable});return k};var le=(k,m,e)=>(e=k!=null?dn(un(k)):{},Ze(m||!k||!k.__esModule?be(e,"default",{value:k,enumerable:!0}):e,k)),fn=k=>Ze(be({},"__esModule",{value:!0}),k);var Nn={};gn(Nn,{default:()=>Le});module.exports=fn(Nn);var u=require("obsidian"),ee=require("@codemirror/state"),M=require("@codemirror/view"),X=require("child_process"),G=require("fs"),nn=le(require("http")),tn=le(require("https")),ge=le(require("net")),rn=le(require("os")),sn=le(require("tls")),L=le(require("path")),ue=require("url"),ve=require("crypto");var N=require("obsidian"),K=".zotero-redisearch-rag",J=`${K}/items`,V=`${K}/chunks`,He={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}

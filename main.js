"use strict";var kn=Object.create;var Ze=Object.defineProperty;var wn=Object.getOwnPropertyDescriptor;var vn=Object.getOwnPropertyNames;var Pn=Object.getPrototypeOf,Cn=Object.prototype.hasOwnProperty;var An=(y,u)=>{for(var e in u)Ze(y,e,{get:u[e],enumerable:!0})},Nt=(y,u,e,t)=>{if(u&&typeof u=="object"||typeof u=="function")for(let n of vn(u))!Cn.call(y,n)&&n!==e&&Ze(y,n,{get:()=>u[n],enumerable:!(t=wn(u,n))||t.enumerable});return y};var xe=(y,u,e)=>(e=y!=null?kn(Pn(y)):{},Nt(u||!y||!y.__esModule?Ze(e,"default",{value:y,enumerable:!0}):e,y)),En=y=>Nt(Ze({},"__esModule",{value:!0}),y);var ei={};An(ei,{default:()=>_t});module.exports=En(ei);var m=require("obsidian");var zt=require("@codemirror/state"),re=require("@codemirror/view"),qt=require("obsidian");var ke=/<!--\s*zrr:sync-start[^>]*-->/i,Ae=/<!--\s*zrr:sync-end\s*-->/i,ye=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ue=/<!--\s*zrr:chunk\s+end\s*-->/i,Ne=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,Tt=y=>{let u=y.trim();if(!u.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(u)){let _=u.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:_?_[2]:void 0}}if(/^zrr:sync-end\b/i.test(u))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(u)){let _=u.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),g=u.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:_?_[2]:void 0,attachmentKey:g?g[2]:void 0}}if(/^zrr:annotations-end\b/i.test(u))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(u))return{type:"chunk-end"};let e=u.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let t=e[1]||"",n=t.match(/\bid=(["']?)([^"'\s]+)\1/i),i=n?n[2]:"",r=t.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:t.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(t)||/\bdelete\b/i.test(t),p=/\bsection\b/i.test(t);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:p?"section":c?"page":"section"}},Be=y=>{var l;if(!y)return null;let u=y.match(ye);if(!u)return null;let e=u[1]||"",t=e.match(/\bid=(["']?)([^"'\s]+)\1/i),n=t?t[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=n&&(l=mt(n))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:n,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Ge=y=>{for(let u=1;u<=y.lines;u+=1){let e=y.line(u).text;if(ke.test(e)){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i);return t?t[2].trim():null}}return null},ht=(y,u)=>{let e=u;for(;e>=1;e-=1){let t=y.line(e).text;if(ye.test(t))return{line:e,text:t};if(ke.test(t)||Ae.test(t))break}return null},Rn=(y,u)=>{for(let e=u;e<=y.lines;e+=1){let t=y.line(e).text;if(Ue.test(t))return e;if(Ae.test(t))break}return null},Dt=(y,u)=>{let e=ht(y,u);if(!e)return null;let t=Rn(y,e.line+1);return t===null||u<e.line||u>t?null:{startLine:e.line,endLine:t,text:e.text}},Ot=(y,u,e)=>{if(u>e)return!1;for(let t=u;t<=e;t+=1){let n=y.line(t).text;if(Ne.test(n))return!0}return!1},mt=y=>{var n;if(!y)return null;let e=(y.includes(":")&&(n=y.split(":").pop())!=null?n:y).match(/^p(\d+)$/i);if(!e)return null;let t=Number.parseInt(e[1],10);return Number.isFinite(t)?t:null};var It=y=>{if(!y)return null;let u=y.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return u?Be(u[0]):null};var Sn=(y,u)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),y.type==="sync-start"||y.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(y.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),y.type==="sync-start"?e.textContent=y.docId?`Redis Index Sync start - ${y.docId}`:"Redis Index Sync start":e.textContent="Redis index sync end",e;if(y.type==="annotations-start"||y.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),y.type==="annotations-start"){let t=y.docId?` - ${y.docId}`:"";e.textContent=`Zotero annotations start${t}`}else e.textContent="Zotero annotations end";return e}if(y.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=y.chunkKind==="page"?"Page end":"Section end",y.chunkKind&&e.classList.add(`zrr-sync-badge--${y.chunkKind}`),e;if(y.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),y.chunkKind&&e.classList.add(`zrr-sync-badge--${y.chunkKind}`),y.excluded&&e.classList.add("is-excluded"),y.pageNumber&&u>0)if(y.chunkKind==="section"){let t=y.chunkId?`Section ${y.chunkId}`:"Section";e.textContent=`${t} (p${y.pageNumber}/${u})`}else e.textContent=`Page ${y.pageNumber}/${u}`;else if(y.pageNumber)if(y.chunkKind==="section"){let t=y.chunkId?`Section ${y.chunkId}`:"Section";e.textContent=`${t} (p${y.pageNumber})`}else e.textContent=`Page ${y.pageNumber}`;else y.chunkId?e.textContent=`Section ${y.chunkId}`:e.textContent="Section";return y.excluded&&(e.textContent=`${e.textContent} - excluded`),e},ft=class extends re.WidgetType{constructor(u,e,t,n,i){super(),this.plugin=u,this.docId=e,this.chunkId=t,this.startLine=n,this.excluded=i}eq(u){return this.docId===u.docId&&this.chunkId===u.chunkId&&this.startLine===u.startLine&&this.excluded===u.excluded}toDOM(){let u=document.createElement("span");u.className="zrr-chunk-toolbar",u.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},t=(c,d,p)=>{let _=document.createElement("span");_.className="zrr-chunk-button-icon",(0,qt.setIcon)(_,d);let g=document.createElement("span");g.className="zrr-chunk-button-label",g.textContent=p,c.appendChild(_),c.appendChild(g)},n=document.createElement("button");n.type="button",n.className="zrr-chunk-button",t(n,"sparkles","Clean"),e(n,"Clean this chunk with the OCR cleanup model"),n.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),u.appendChild(n);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",t(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),u.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",t(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),u.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",t(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),u.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return t(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),u.appendChild(s),u}ignoreEvent(){return!0}},Ft=(y,u)=>{var f;let e=y.state.doc,t=Ge(e);if(!t)return re.Decoration.none;let n=y.state.selection.main.head,i=e.lineAt(n).number,r=Dt(e,i);if(!r)return re.Decoration.none;let a=r.text.match(ye);if(!a)return re.Decoration.none;let s=((f=a[1])!=null?f:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return re.Decoration.none;let l=o[2].trim();if(!l)return re.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=Ot(e,r.startLine+1,r.endLine-1),p=c||d,_=e.line(r.startLine),g=re.Decoration.widget({widget:new ft(u,t,l,r.startLine,p),side:1});return re.Decoration.set([g.range(_.to)])},yt=class extends re.WidgetType{constructor(u,e){super(),this.info=u,this.totalPages=e}toDOM(){var u;return(u=Sn(this.info,this.totalPages))!=null?u:document.createElement("span")}},Mt=y=>{var o,l;let u=y.dom.closest(".markdown-source-view");if(!u||!u.classList.contains("is-live-preview"))return re.Decoration.none;let e=y.state.doc,t=new zt.RangeSetBuilder,n=[],i=[],r=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),p=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!p)continue;let _=Tt(p[1]);_&&(_.type==="chunk-start"?(_.chunkKind=(o=_.chunkKind)!=null?o:_.pageNumber?"page":"section",_.pageNumber&&(r=!0),_.chunkKind==="section"&&(a=!0)):_.type==="chunk-end"&&(_.chunkKind=(l=_.chunkKind)!=null?l:"section"),n.push({line:c,from:d.from,to:d.to,info:_}),_.pageNumber&&i.push(_.pageNumber))}if(!n.length)return re.Decoration.none;if(r&&!a)for(let c of n)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let c of n){let d=re.Decoration.replace({widget:new yt(c.info,s)});t.add(c.from,c.to,d)}return t.finish()},jt=()=>re.ViewPlugin.fromClass(class{constructor(y){this.decorations=Mt(y)}update(y){(y.docChanged||y.viewportChanged)&&(this.decorations=Mt(y.view))}},{decorations:y=>y.decorations}),$t=y=>re.ViewPlugin.fromClass(class{constructor(u){this.decorations=Ft(u,y)}update(u){(u.docChanged||u.selectionSet||u.viewportChanged)&&(this.decorations=Ft(u.view,y))}},{decorations:u=>u.decorations}),Ln=(y,u)=>{var t,n,i;if(!y||u<0)return null;let e=/\[\[([^\]\n]+)\]\]/g;for(let r of y.matchAll(e)){let a=(t=r[0])!=null?t:"",s=(n=r[1])!=null?n:"",o=(i=r.index)!=null?i:-1;if(o<0)continue;let l=o+a.length;if(u<o||u>l)continue;let c=s.indexOf("|");return(c>=0?s.slice(0,c):s).trim()||null}return null},Vt=y=>re.ViewPlugin.fromClass(class{},{eventHandlers:{click(u,e){if(u.defaultPrevented||u.button!==0)return!1;let t=e.dom.closest(".markdown-source-view");if(!t||!t.classList.contains("is-live-preview"))return!1;let n=e.posAtCoords({x:u.clientX,y:u.clientY});if(n===null)return!1;let i=e.state.doc.lineAt(n),r=n-i.from,a=Ln(i.text,r);return!a||!a.includes("#zrr-chunk:")?!1:(u.preventDefault(),u.stopPropagation(),y.openInternalLinkInMain(a,y.getLivePreviewSourcePath()),!0)}}});var le=require("child_process"),ee=require("fs"),Et=xe(require("http")),fn=xe(require("https")),qe=xe(require("net")),je=xe(require("os")),yn=xe(require("tls")),S=xe(require("path")),Rt=require("url"),$e=require("crypto");var L=require("obsidian"),Ut=require("crypto"),We=require("fs"),He=xe(require("path")),ae=".zotero-redisearch-rag",oe=`${ae}/items`,Y=`${ae}/chunks`,Bt=`${ae}/metadata_snapshots.json`,Gt=`${ae}/annotation_snapshots.json`,Nn="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",Ee="cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",Te="__custom__",Zt=[{value:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",label:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1 (Fast multilingual)"},{value:"BAAI/bge-reranker-v2-m3",label:"BAAI/bge-reranker-v2-m3 (Best quality, heaviest)"},{value:"jinaai/jina-reranker-v2-base-multilingual",label:"jinaai/jina-reranker-v2-base-multilingual (Balanced multilingual)"}],Je={pythonRuntime:"worker",pythonRuntimeMigrationV1Done:!1,showAdvancedPythonRuntimeOptions:!1,pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,firstContainerStartupNoticeShown:!1,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.25
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.25
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.25
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.25
...
`).trim()}getBundledReleaseNotesEntries(){var i,r;let e=new Set,t=Array.isArray(At)?At:[],n=[];for(let a of t){let s=this.normalizeReleaseVersion(String((i=a==null?void 0:a.version)!=null?i:"")),o=this.sanitizeReleaseNotesMarkdown(String((r=a==null?void 0:a.markdown)!=null?r:""));!s||e.has(s)||(e.add(s),n.push({version:s,markdown:o}))}return n.sort((a,s)=>this.compareReleaseVersions(s.version,a.version))}getReleaseNotesMarkdown(e,t){let n=this.normalizeReleaseVersion(e);if(!n)return"";let i=this.normalizeReleaseVersion(t||""),r=this.getBundledReleaseNotesEntries(),a=r.filter(o=>this.compareReleaseVersions(o.version,n)>0?!1:i?this.compareReleaseVersions(o.version,i)>0:o.version===n),s=a.length?a:r.filter(o=>o.version===n);if(!s.length)return"This version includes improvements and fixes.";if(s.length===1){let o=s[0],l=this.stripLeadingVersionHeading(this.sanitizeReleaseNotesMarkdown(String(o.markdown||"")),o.version);return`### v${o.version}
...
${g}`:b)}let f=d!==null?a?` (${d})`:` page=${d}`:"",k=` id=${c}${a?" section":""}${f}${p?" exclude":""}`;s.push(`<!-- zrr:chunk${k} -->`),g&&s.push(g),s.push("<!-- zrr:chunk end -->"),s.push("")}return s[s.length-1]===""&&s.pop(),s.push("<!-- zrr:sync-end -->"),s.join(`

"use strict";var ce=Object.create;var B=Object.defineProperty;var de=Object.getOwnPropertyDescriptor;var pe=Object.getOwnPropertyNames;var ue=Object.getPrototypeOf,ge=Object.prototype.hasOwnProperty;var he=(L,p)=>{for(var e in p)B(L,e,{get:p[e],enumerable:!0})},ne=(L,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of pe(p))!ge.call(L,t)&&t!==e&&B(L,t,{get:()=>p[t],enumerable:!(n=de(p,t))||n.enumerable});return L};var H=(L,p,e)=>(e=L!=null?ce(ue(L)):{},ne(p||!L||!L.__esModule?B(e,"default",{value:L,enumerable:!0}):e,L)),fe=L=>ne(B({},"__esModule",{value:!0}),L);var ye={};he(ye,{default:()=>V});module.exports=fe(ye);var d=require("obsidian"),Z=require("child_process"),F=require("fs"),se=H(require("http")),oe=H(require("https")),y=H(require("path")),j=require("url"),le=require("crypto");var b=require("obsidian"),R=".zotero-redisearch-rag",O=`${R}/items`,I=`${R}/chunks`,te={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}
...
`};var ie={"docling_extract.py":`#!/usr/bin/env python3
...
${r}`}renderFrontmatter(e,n,t,i,a){var o;let r=(o=this.settings.frontmatterTemplate)!=null?o:"";if(!r.trim())return"";let s=this.buildTemplateVars(e,n,t,i,a);return r.replace(/{{\s*([a-z0-9_]+)\s*}}/gi,(l,c)=>{var u;return(u=s[c])!=null?u:""}).trim()}buildTemplateVars(e,n,t,i,a){let r=typeof e.title=="string"?e.title:"",s=typeof e.shortTitle=="string"?e.shortTitle:"",o=typeof e.date=="string"?e.date:"",l=typeof(n==null?void 0:n.parsedDate)=="string"?n.parsedDate:"",c=this.extractYear(l||o),f=(Array.isArray(e.creators)?e.creators:[]).filter(w=>w.creatorType==="author").map(w=>this.formatCreatorName(w)),h=f.join("; "),m=Array.isArray(e.tags)?e.tags.map(w=>typeof w=="string"?w:w==null?void 0:w.tag).filter(Boolean):[],_=m.join("; "),x=typeof e.itemType=="string"?e.itemType:"",k=typeof(n==null?void 0:n.creatorSummary)=="string"?n.creatorSummary:"",v={doc_id:t,zotero_key:typeof e.key=="string"?e.key:t,title:r,short_title:s,date:o,year:c,authors:h,tags:_,item_type:x,creator_summary:k,pdf_link:this.escapeYamlString(i),item_json:this.escapeYamlString(a)};for(let[w,C]of Object.entries(v))v[`${w}_yaml`]=this.escapeYamlString(C);return v.authors_yaml=this.toYamlList(f),v.tags_yaml=this.toYamlList(m),v}extractYear(e){if(!e)return"";let n=e.match(/\b(\d{4})\b/);return n?n[1]:""}formatCreatorName(e){if(!e||typeof e!="object")return"";if(e.name)return String(e.name);let n=e.firstName?String(e.firstName):"",t=e.lastName?String(e.lastName):"";return[t,n].filter(Boolean).join(", ")||`${n} ${t}`.trim()}escapeYamlString(e){return`"${String(e).replace(/\\/g,"\\\\").replace(/"/g,'\\"')}"`}toYamlList(e){return e.length?e.map(n=>`  - ${this.escapeYamlString(n)}`).join(`
`):'  - ""'}getVaultBasePath(){var t;let e=this.app.vault.adapter;if(e instanceof d.FileSystemAdapter)return e.getBasePath();let n=(t=e.getBasePath)==null?void 0:t.call(e);if(n)return n;throw new Error("Vault base path is unavailable.")}getPluginDir(){var i;let e=this.getVaultBasePath(),n=(i=this.manifest.dir)!=null?i:this.manifest.id;if(!n)throw new Error("Plugin directory is unavailable.");let t=y.default.isAbsolute(n)?n:y.default.join(e,n);return y.default.normalize(t)}async ensureBundledTools(){let e=this.getPluginDir(),n=y.default.join(e,"tools");await F.promises.mkdir(n,{recursive:!0});for(let[t,i]of Object.entries(ie)){let a=y.default.join(n,t),r=!0;try{await F.promises.readFile(a,"utf8")===i&&(r=!1)}catch(s){}r&&await F.promises.writeFile(a,i,"utf8")}}async migrateCachePaths(){let e="zotero/items",n="zotero/chunks",t=O,i=I,a=this.app.vault.adapter,r=(0,d.normalizePath)(e),s=(0,d.normalizePath)(n),o=(0,d.normalizePath)(t),l=(0,d.normalizePath)(i),c=o.split("/").slice(0,-1).join("/"),u=l.split("/").slice(0,-1).join("/");c&&await this.ensureFolder(c),u&&await this.ensureFolder(u);let f=await a.exists(r),h=await a.exists(s),m=await a.exists(o),_=await a.exists(l);f&&!m&&await a.rename(r,o),h&&!_&&await a.rename(s,l)}getAbsoluteVaultPath(e){let n=this.getVaultBasePath(),t=y.default.isAbsolute(e)?e:y.default.join(n,e);return y.default.normalize(t)}buildDoclingArgs(e,n,t,i,a,r=!1){let s=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",n,"--out-json",this.getAbsoluteVaultPath(t),"--out-md",this.getAbsoluteVaultPath(i),"--chunking",this.settings.chunkingMode,"--ocr",s];r&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),a&&o.push("--language-hint",a),this.settings.maxChunkChars>0&&o.push("--max-chunk-chars",String(this.settings.maxChunkChars)),this.settings.chunkOverlapChars>0&&o.push("--chunk-overlap-chars",String(this.settings.chunkOverlapChars)),this.settings.removeImagePlaceholders||o.push("--keep-image-tags"),this.settings.enableLlmCleanup&&(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars)));let l=this.getPluginDir(),c=y.default.join(l,"tools","ocr_wordlist.txt");if((0,F.existsSync)(c)&&o.push("--enable-dictionary-correction","--dictionary-path",c),this.settings.enableFileLogging){let u=this.getLogFileAbsolutePath();u&&o.push("--log-file",u);let f=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());f&&o.push("--spellchecker-info-out",f)}return o}getRedisDataDir(){return y.default.join(this.getVaultBasePath(),R,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return y.default.join(e,"tools","docker-compose.yml")}getDockerProjectName(){let e=this.getVaultBasePath(),n=y.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),t=(0,le.createHash)("sha1").update(e).digest("hex").slice(0,8);return`zrr-${n||"vault"}-${t}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),n=e.port?Number(e.port):6379;return Number.isFinite(n)&&n>0?n:6379}catch(e){return 6379}}async startRedisStack(e){var n;try{await this.ensureBundledTools();let t=this.getDockerComposePath(),i=this.getRedisDataDir();await F.promises.mkdir(i,{recursive:!0});let a=((n=this.settings.dockerPath)==null?void 0:n.trim())||"docker",r=this.getDockerProjectName(),s=String(this.getRedisPortFromUrl());try{await this.runCommand(a,["compose","-p",r,"-f",t,"down"],{cwd:y.default.dirname(t)})}catch(o){console.warn("Redis Stack stop before restart failed",o)}await this.runCommand(a,["compose","-p",r,"-f",t,"up","-d"],{cwd:y.default.dirname(t),env:{...process.env,ZRR_DATA_DIR:i,ZRR_PORT:s}}),e||new d.Notice("Redis Stack started.")}catch(t){e||new d.Notice("Failed to start Redis Stack. Check Docker Desktop and File Sharing."),console.error("Failed to start Redis Stack",t)}}runPython(e,n){return new Promise((t,i)=>{let a=(0,Z.spawn)(this.settings.pythonPath,[e,...n],{cwd:y.default.dirname(e)}),r="";a.stderr.on("data",s=>{r+=s.toString()}),a.on("close",s=>{s===0?t():i(new Error(r||`Process exited with code ${s}`))})})}runCommand(e,n,t){return new Promise((i,a)=>{let r=(0,Z.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:t==null?void 0:t.env}),s="";r.stderr.on("data",o=>{s+=o.toString()}),r.on("close",o=>{o===0?i():a(new Error(s||`Process exited with code ${o}`))})})}runPythonStreaming(e,n,t,i){return new Promise((a,r)=>{let s=(0,Z.spawn)(this.settings.pythonPath,[e,...n],{cwd:y.default.dirname(e)}),o="",l="",c=null,u=!1,f=h=>{if(h.trim())try{let m=JSON.parse(h);c=m,((m==null?void 0:m.type)==="final"||m!=null&&m.answer)&&(u=!0),t(m)}catch(m){}};s.stdout.on("data",h=>{var _;o+=h.toString();let m=o.split(/\r?\n/);o=(_=m.pop())!=null?_:"";for(let x of m)f(x)}),s.stderr.on("data",h=>{l+=h.toString()}),s.on("close",h=>{o.trim()&&f(o),!u&&c&&i(c),h===0?a():r(new Error(l||`Process exited with code ${h}`))})})}getLogsDirRelative(){return(0,d.normalizePath)(`${R}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,d.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,d.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;if(!await n.exists(e)){new d.Notice("Log file not found.");return}try{let t=await n.read(e);new Q(this.app,"Docling log",t||"(empty)").open()}catch(t){new d.Notice("Failed to open log file."),console.error(t)}}async clearLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{let t=(0,d.normalizePath)(y.default.dirname(e));t&&await this.ensureFolder(t),await n.write(e,""),new d.Notice("Log file cleared.")}catch(t){new d.Notice("Failed to clear log file."),console.error(t)}}runPythonWithOutput(e,n){return new Promise((t,i)=>{let a=(0,Z.spawn)(this.settings.pythonPath,[e,...n],{cwd:y.default.dirname(e)}),r="",s="";a.stdout.on("data",o=>{r+=o.toString()}),a.stderr.on("data",o=>{s+=o.toString()}),a.on("close",o=>{o===0?t(r.trim()):i(new Error(s||`Process exited with code ${o}`))})})}},ee=class extends d.SuggestModal{constructor(e,n,t){super(e);this.lastError=null;this.indexedDocIds=null;this.plugin=n,this.resolveSelection=t,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){try{if(!this.indexedDocIds){let n=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(n))}return await this.plugin.searchZoteroItems(e)}catch(n){let t=n instanceof Error?n.message:String(n);return this.lastError!==t&&(this.lastError=t,new d.Notice(t)),console.error("Zotero search failed",n),[]}}renderSuggestion(e,n){var u,f,h;let t=(f=(u=e.data)==null?void 0:u.title)!=null?f:"[No title]",i=this.extractYear(e),a=this.getDocId(e),r=a?(h=this.indexedDocIds)==null?void 0:h.has(a):!1,s=this.getPdfStatus(e);r&&n.addClass("zrr-indexed-item"),s==="no"&&n.addClass("zrr-no-pdf-item"),n.createEl("div",{text:t});let o=n.createEl("small"),l=!1,c=()=>{l&&o.createSpan({text:" \u2022 "})};i&&(o.createSpan({text:i}),l=!0),r&&(c(),o.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),l=!0),s==="no"&&(c(),o.createSpan({text:"No attachment",cls:"zrr-no-pdf-flag"}),l=!0),n.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,n){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}getDocId(e){var t,i,a;let n=(a=(i=e.key)!=null?i:(t=e.data)==null?void 0:t.key)!=null?a:"";return typeof n=="string"?n:""}getPdfStatus(e){var i,a,r,s,o,l,c;let n=(l=(o=(r=(i=e.data)==null?void 0:i.attachments)!=null?r:(a=e.data)==null?void 0:a.children)!=null?o:(s=e.data)==null?void 0:s.items)!=null?l:[];if(Array.isArray(n)&&n.length>0)return n.some(f=>this.isPdfAttachment(f))?"yes":"no";let t=(c=e.meta)==null?void 0:c.numChildren;return typeof t=="number"&&t===0?"no":"unknown"}isPdfAttachment(e){var t,i,a,r,s,o;return((o=(s=(a=(t=e==null?void 0:e.contentType)!=null?t:e==null?void 0:e.mimeType)!=null?a:(i=e==null?void 0:e.data)==null?void 0:i.contentType)!=null?s:(r=e==null?void 0:e.data)==null?void 0:r.mimeType)!=null?o:"")==="application/pdf"}extractYear(e){var i,a,r,s;let n=(s=(r=(i=e.meta)==null?void 0:i.parsedDate)!=null?r:(a=e.data)==null?void 0:a.date)!=null?s:"";if(typeof n!="string")return"";let t=n.match(/\b(\d{4})\b/);return t?t[1]:""}};

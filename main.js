...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.9
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.9
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.9
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.9
...
`,"redis-stack.conf":`# zotero-redisearch-rag tool version: 0.9.9
...
${g}`:x)}let b=d!==null?a?` (${d})`:` page=${d}`:"",P=` id=${c}${a?" section":""}${b}${p?" exclude":""}`;s.push(`<!-- zrr:chunk${P} -->`),g&&s.push(g),s.push("<!-- zrr:chunk end -->"),s.push("")}return s[s.length-1]===""&&s.pop(),s.push("<!-- zrr:sync-end -->"),s.join(`

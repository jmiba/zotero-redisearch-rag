"use strict";var Qn=Object.create;var Ee=Object.defineProperty;var et=Object.getOwnPropertyDescriptor;var nt=Object.getOwnPropertyNames;var tt=Object.getPrototypeOf,it=Object.prototype.hasOwnProperty;var rt=(g,_)=>{for(var e in _)Ee(g,e,{get:_[e],enumerable:!0})},gn=(g,_,e,n)=>{if(_&&typeof _=="object"||typeof _=="function")for(let t of nt(_))!it.call(g,t)&&t!==e&&Ee(g,t,{get:()=>_[t],enumerable:!(n=et(_,t))||n.enumerable});return g};var pe=(g,_,e)=>(e=g!=null?Qn(tt(g)):{},gn(_||!g||!g.__esModule?Ee(e,"default",{value:g,enumerable:!0}):e,g)),at=g=>gn(Ee({},"__esModule",{value:!0}),g);var kt={};rt(kt,{default:()=>Ye});module.exports=at(kt);var h=require("obsidian");var kn=require("@codemirror/state"),Q=require("@codemirror/view"),vn=require("obsidian");var ue=/<!--\s*zrr:sync-start[^>]*-->/i,fe=/<!--\s*zrr:sync-end\s*-->/i,ce=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ne=/<!--\s*zrr:chunk\s+end\s*-->/i,xe=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,fn=g=>{let _=g.trim();if(!_.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(_)){let p=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:p?p[2]:void 0}}if(/^zrr:sync-end\b/i.test(_))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(_)){let p=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),m=_.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:p?p[2]:void 0,attachmentKey:m?m[2]:void 0}}if(/^zrr:annotations-end\b/i.test(_))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(_))return{type:"chunk-end"};let e=_.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let n=e[1]||"",t=n.match(/\bid=(["']?)([^"'\s]+)\1/i),i=t?t[2]:"",r=n.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:n.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(n)||/\bdelete\b/i.test(n),u=/\bsection\b/i.test(n);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:u?"section":c?"page":"section"}},tn=g=>{var l;if(!g)return null;let _=g.match(ce);if(!_)return null;let e=_[1]||"",n=e.match(/\bid=(["']?)([^"'\s]+)\1/i),t=n?n[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=t&&(l=ot(t))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:t,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Re=g=>{for(let _=1;_<=g.lines;_+=1){let e=g.line(_).text;if(ue.test(e)){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return n?n[2].trim():null}}return null},rn=(g,_)=>{let e=_;for(;e>=1;e-=1){let n=g.line(e).text;if(ce.test(n))return{line:e,text:n};if(ue.test(n)||fe.test(n))break}return null},st=(g,_)=>{for(let e=_;e<=g.lines;e+=1){let n=g.line(e).text;if(Ne.test(n))return e;if(fe.test(n))break}return null},hn=(g,_)=>{let e=rn(g,_);if(!e)return null;let n=st(g,e.line+1);return n===null||_<e.line||_>n?null:{startLine:e.line,endLine:n,text:e.text}},mn=(g,_,e)=>{if(_>e)return!1;for(let n=_;n<=e;n+=1){let t=g.line(n).text;if(xe.test(t))return!0}return!1},ot=g=>{var t;if(!g)return null;let e=(g.includes(":")&&(t=g.split(":").pop())!=null?t:g).match(/^p(\d+)$/i);if(!e)return null;let n=Number.parseInt(e[1],10);return Number.isFinite(n)?n:null};var yn=g=>{if(!g)return null;let _=g.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return _?tn(_[0]):null};var lt=(g,_)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),g.type==="sync-start"||g.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(g.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),g.type==="sync-start"?e.textContent=g.docId?`Redis Index Sync start - ${g.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e;if(g.type==="annotations-start"||g.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),g.type==="annotations-start"){let n=g.docId?` - ${g.docId}`:"";e.textContent=`Zotero annotations start${n}`}else e.textContent="Zotero annotations end";return e}if(g.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=g.chunkKind==="page"?"Page end":"Section end",g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),e;if(g.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),g.excluded&&e.classList.add("is-excluded"),g.pageNumber&&_>0)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber}/${_})`}else e.textContent=`Page ${g.pageNumber}/${_}`;else if(g.pageNumber)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber})`}else e.textContent=`Page ${g.pageNumber}`;else g.chunkId?e.textContent=`Section ${g.chunkId}`:e.textContent="Section";return g.excluded&&(e.textContent=`${e.textContent} - excluded`),e},an=class extends Q.WidgetType{constructor(_,e,n,t,i){super(),this.plugin=_,this.docId=e,this.chunkId=n,this.startLine=t,this.excluded=i}eq(_){return this.docId===_.docId&&this.chunkId===_.chunkId&&this.startLine===_.startLine&&this.excluded===_.excluded}toDOM(){let _=document.createElement("span");_.className="zrr-chunk-toolbar",_.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},n=(c,d,u)=>{let p=document.createElement("span");p.className="zrr-chunk-button-icon",(0,vn.setIcon)(p,d);let m=document.createElement("span");m.className="zrr-chunk-button-label",m.textContent=u,c.appendChild(p),c.appendChild(m)},t=document.createElement("button");t.type="button",t.className="zrr-chunk-button",n(t,"sparkles","Clean"),e(t,"Clean this chunk with the OCR cleanup model"),t.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),_.appendChild(t);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",n(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),_.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",n(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),_.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",n(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),_.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return n(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),_.appendChild(s),_}ignoreEvent(){return!0}},bn=(g,_)=>{var y;let e=g.state.doc,n=Re(e);if(!n)return Q.Decoration.none;let t=g.state.selection.main.head,i=e.lineAt(t).number,r=hn(e,i);if(!r)return Q.Decoration.none;let a=r.text.match(ce);if(!a)return Q.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return Q.Decoration.none;let l=o[2].trim();if(!l)return Q.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=mn(e,r.startLine+1,r.endLine-1),u=c||d,p=e.line(r.startLine),m=Q.Decoration.widget({widget:new an(_,n,l,r.startLine,u),side:1});return Q.Decoration.set([m.range(p.to)])},sn=class extends Q.WidgetType{constructor(_,e){super(),this.info=_,this.totalPages=e}toDOM(){var _;return(_=lt(this.info,this.totalPages))!=null?_:document.createElement("span")}},xn=g=>{var o,l;let _=g.dom.closest(".markdown-source-view");if(!_||!_.classList.contains("is-live-preview"))return Q.Decoration.none;let e=g.state.doc,n=new kn.RangeSetBuilder,t=[],i=[],r=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),u=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!u)continue;let p=fn(u[1]);p&&(p.type==="chunk-start"?(p.chunkKind=(o=p.chunkKind)!=null?o:p.pageNumber?"page":"section",p.pageNumber&&(r=!0),p.chunkKind==="section"&&(a=!0)):p.type==="chunk-end"&&(p.chunkKind=(l=p.chunkKind)!=null?l:"section"),t.push({line:c,from:d.from,to:d.to,info:p}),p.pageNumber&&i.push(p.pageNumber))}if(!t.length)return Q.Decoration.none;if(r&&!a)for(let c of t)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let c of t){let d=Q.Decoration.replace({widget:new sn(c.info,s)});n.add(c.from,c.to,d)}return n.finish()},wn=()=>Q.ViewPlugin.fromClass(class{constructor(g){this.decorations=xn(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=xn(g.view))}},{decorations:g=>g.decorations}),Pn=g=>Q.ViewPlugin.fromClass(class{constructor(_){this.decorations=bn(_,g)}update(_){(_.docChanged||_.selectionSet||_.viewportChanged)&&(this.decorations=bn(_.view,g))}},{decorations:_=>_.decorations});var ne=require("child_process"),W=require("fs"),Kn=pe(require("http")),Jn=pe(require("https")),Pe=pe(require("net")),Ae=pe(require("os")),Xn=pe(require("tls")),N=pe(require("path")),_n=require("url"),Ce=require("crypto");var D=require("obsidian"),An=require("crypto"),De=require("fs"),Te=pe(require("path")),ee=".zotero-redisearch-rag",te=`${ee}/items`,H=`${ee}/chunks`,Cn=`${ee}/metadata_snapshots.json`,Sn=`${ee}/annotation_snapshots.json`,ct="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",Ie={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,chatPaneLocation:"right",enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"BAAI/bge-reranker-v2-m3",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${ee}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Oe=class extends D.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async f=>{this.plugin.settings.llmProviderProfiles=f,await this.plugin.saveSettings()},i=f=>{f.inputEl.type="password",f.inputEl.autocomplete="off",f.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:f=>{f.createEl("h2",{text:"Prerequisites"}),new D.Setting(f).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(C=>C.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async L=>{this.plugin.settings.pythonPath=L.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Python environment").setDesc("Create or update the plugin's Python env (location configured below).").addButton(C=>{C.setButtonText("Create/Update").setCta(),C.onClick(async()=>{C.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{C.setDisabled(!1)}})}),new D.Setting(f).setName("Python env location").setDesc("Shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(C=>{C.addOption("shared","Shared user cache"),C.addOption("plugin","Plugin folder (.venv)"),C.setValue(this.plugin.settings.pythonEnvLocation).onChange(async L=>{L!=="shared"&&L!=="plugin"||(this.plugin.settings.pythonEnvLocation=L,await this.plugin.saveSettings())})}),new D.Setting(f).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(C=>C.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async L=>{this.plugin.settings.dockerPath=L.trim()||"docker",await this.plugin.saveSettings()})),new D.Setting(f).setName("Redis URL").addText(C=>C.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async L=>{this.plugin.settings.redisUrl=L.trim(),await this.plugin.saveSettings()}));let k=null,x=null,w=null,E=null,A=()=>{let C=this.plugin.settings.autoAssignRedisPort;w==null||w.setDisabled(C),E==null||E.setDisabled(C),k==null||k.settingEl.classList.toggle("is-disabled",C),x==null||x.settingEl.classList.toggle("is-disabled",C)};new D.Setting(f).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(C=>C.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async L=>{this.plugin.settings.autoAssignRedisPort=L,await this.plugin.saveSettings(),A()})),k=new D.Setting(f).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(C=>(w=C,C.setPlaceholder("~/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async L=>{this.plugin.settings.redisDataDirOverride=L.trim(),await this.plugin.saveSettings()}))),k.settingEl.addClass("zrr-redis-override-setting"),x=new D.Setting(f).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(C=>(E=C,C.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async L=>{this.plugin.settings.redisProjectName=L.trim(),await this.plugin.saveSettings()}))),x.settingEl.addClass("zrr-redis-override-setting"),A(),new D.Setting(f).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Uses a vault-specific data dir at .obsidian/zotero-redisearch-rag/redis-data unless overridden.").addToggle(C=>C.setValue(this.plugin.settings.autoStartRedis).onChange(async L=>{this.plugin.settings.autoStartRedis=L,await this.plugin.saveSettings()})),new D.Setting(f).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(C=>C.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:f=>{f.createEl("h2",{text:"Zotero Local API"}),new D.Setting(f).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(A=>A.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async C=>{this.plugin.settings.zoteroBaseUrl=C.trim(),await this.plugin.saveSettings()}));let k=new D.Setting(f).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),x=null,w=A=>{if(!x)return;let C=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(A.map(z=>z.value)).has(C)||(A=A.concat([{value:C,label:`Custom (${C})`}])),x.selectEl.options.length=0;for(let z of A)x.addOption(z.value,z.label);x.setValue(C)},E=async()=>{if(x){x.setDisabled(!0);try{let A=await this.plugin.fetchZoteroLibraryOptions();w(A)}finally{x.setDisabled(!1)}}};k.addDropdown(A=>{x=A;let C=(this.plugin.settings.zoteroUserId||"0").trim()||"0";A.addOption(C,"Loading..."),A.setValue(C),A.onChange(async L=>{this.plugin.settings.zoteroUserId=L.trim(),await this.plugin.saveSettings()})}),k.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await E()})}),E(),f.createEl("h2",{text:"Zotero Web API"}),new D.Setting(f).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(A=>A.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async C=>{this.plugin.settings.webApiBaseUrl=C.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(A=>A.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async C=>{this.plugin.settings.webApiLibraryType=C,await this.plugin.saveSettings()})),new D.Setting(f).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(A=>A.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async C=>{this.plugin.settings.webApiLibraryId=C.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(A=>{i(A),A.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async C=>{this.plugin.settings.webApiKey=C.trim(),await this.plugin.saveSettings()})}),f.createEl("h2",{text:"Output"}),new D.Setting(f).setName("PDF folder").addText(A=>A.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async C=>{this.plugin.settings.outputPdfDir=C.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Notes folder").addText(A=>A.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async C=>{this.plugin.settings.outputNoteDir=C.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(A=>{A.setValue(this.plugin.settings.frontmatterTemplate).onChange(async C=>{this.plugin.settings.frontmatterTemplate=C,await this.plugin.saveSettings()}),A.inputEl.rows=10,A.inputEl.style.width="100%"}),new D.Setting(f).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(A=>A.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async C=>{this.plugin.settings.tagSanitizeMode=C,await this.plugin.saveSettings()})),new D.Setting(f).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(A=>{A.setValue(this.plugin.settings.noteBodyTemplate).onChange(async C=>{this.plugin.settings.noteBodyTemplate=C,await this.plugin.saveSettings()}),A.inputEl.rows=8,A.inputEl.style.width="100%"}),new D.Setting(f).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(A=>A.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async C=>{this.plugin.settings.chatOutputDir=C.trim()||"zotero/chats",await this.plugin.saveSettings()})),new D.Setting(f).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(A=>A.setValue(this.plugin.settings.copyPdfToVault).onChange(async C=>{this.plugin.settings.copyPdfToVault=C,!C&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new D.Setting(f).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(A=>{let C=this.plugin.settings.copyPdfToVault;A.setValue(C?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!C).onChange(async L=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=L,await this.plugin.saveSettings()})}),new D.Setting(f).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(A=>A.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async C=>{this.plugin.settings.preferObsidianNoteForCitations=C,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:f=>{f.createEl("h2",{text:"Annotations"}),new D.Setting(f).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(E=>E.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async A=>{this.plugin.settings.annotationPageLabel=A.trim()||"Page",await this.plugin.saveSettings()})),new D.Setting(f).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(E=>E.setValue(this.plugin.settings.includeAnnotationImages).onChange(async A=>{this.plugin.settings.includeAnnotationImages=A,await this.plugin.saveSettings()})),f.createEl("h3",{text:"Zotero companion"}),f.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new D.Setting(f).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(E=>E.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async A=>{this.plugin.settings.zoteroCompanionEnabled=A,await this.plugin.saveSettings()})),new D.Setting(f).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(E=>E.setPlaceholder("http://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async A=>{this.plugin.settings.zoteroCompanionBaseUrl=A.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(E=>{i(E),this.companionTokenInput=E,E.setPlaceholder("optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async A=>{this.plugin.settings.zoteroCompanionToken=A.trim(),await this.plugin.saveSettings()})}),new D.Setting(f).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero Companion Plugin token to this value.").addButton(E=>E.setButtonText("Generate token").onClick(async()=>{let A=(0,An.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=A,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(A);try{await navigator.clipboard.writeText(A),new D.Notice("Generated and copied companion token.")}catch(C){new D.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",C)}})),f.createEl("h3",{text:"Annotation color map"}),f.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let k=f.createDiv({cls:"zrr-annotation-map"}),x=async E=>{this.plugin.settings.annotationColorMap=E,await this.plugin.saveSettings()},w=()=>{var T,M;k.empty();let E=this.plugin.settings.annotationColorMap||{},A=Object.entries(E);if(A.length||k.createEl("p",{text:"No color mappings configured."}),A.length){let I=k.createDiv({cls:"zrr-annotation-map-row-header"});I.createEl("span",{text:"Color"}),I.createEl("span",{text:"Heading"}),I.createEl("span",{text:"Callout"}),I.createEl("span")}for(let[I,F]of A){let O=k.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),q=O.createEl("input",{type:"text",value:I,cls:"zrr-annotation-map-input"}),$=O.createEl("input",{type:"text",value:(T=F.heading)!=null?T:"",cls:"zrr-annotation-map-input"}),B=O.createEl("input",{type:"text",value:(M=F.callout)!=null?M:"",cls:"zrr-annotation-map-input"}),J=O.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});J.type="button",q.addEventListener("change",async()=>{let V=q.value.trim().toLowerCase();if(!V){q.value=I;return}let Y={...this.plugin.settings.annotationColorMap||{}};if(V!==I&&Y[V]){new D.Notice(`Annotation color '${V}' already exists.`),q.value=I;return}let X=Y[I];delete Y[I],Y[V]=X!=null?X:{heading:"",callout:""},await x(Y),w()}),$.addEventListener("change",async()=>{var X;let V={...this.plugin.settings.annotationColorMap||{}},Y=(X=V[I])!=null?X:{heading:"",callout:""};Y.heading=$.value.trim(),V[I]=Y,await x(V)}),B.addEventListener("change",async()=>{var X;let V={...this.plugin.settings.annotationColorMap||{}},Y=(X=V[I])!=null?X:{heading:"",callout:""};Y.callout=B.value.trim(),V[I]=Y,await x(V)}),J.addEventListener("click",async()=>{let V={...this.plugin.settings.annotationColorMap||{}};delete V[I],await x(V),w()})}let C=k.createDiv({cls:"zrr-annotation-map-actions"}),L=C.createEl("button",{text:"Add mapping"});L.type="button",L.addEventListener("click",async()=>{let I={...this.plugin.settings.annotationColorMap||{}},F="new-color",j=1;for(;I[F];)F=`new-color-${j}`,j+=1;I[F]={heading:"",callout:""},await x(I),w()});let z=C.createEl("button",{text:"Reset to defaults"});z.type="button",z.addEventListener("click",async()=>{await x({...Ie.annotationColorMap}),w()})};w()}},{id:"ocr",label:"OCR",render:f=>{f.createEl("h2",{text:"Docling"});let k=null,x=C=>{if(!k)return;let L=this.plugin.settings.ocrEngine;new Set(C.map(T=>T.value)).has(L)||(C=C.concat([{value:L,label:`Current (unavailable): ${L}`}])),k.selectEl.options.length=0;for(let T of C)k.addOption(T.value,T.label);k.setValue(L)},w=async()=>{if(!k)return;k.setDisabled(!0);let C={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{C=await this.plugin.detectOcrEngines()}catch(T){C={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let L=[{value:"auto",label:"Auto (default)"}];C.tesseract&&L.push({value:"tesseract",label:"Tesseract (local)"}),C.paddleStructureLocal&&L.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),C.paddleVlLocal&&L.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(L.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),L.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),x(L),k.setDisabled(!1)},E=new D.Setting(f).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),A=document.createElement("a");A.href="https://aistudio.baidu.com/paddleocr",A.textContent="https://aistudio.baidu.com/paddleocr",A.target="_blank",A.rel="noopener noreferrer",E.descEl.appendChild(A),E.descEl.append("."),E.addText(C=>{i(C),C.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async L=>{this.plugin.settings.paddleApiKey=L.trim(),await this.plugin.saveSettings(),await w()})}),new D.Setting(f).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(C=>C.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async L=>{this.plugin.settings.paddleVlApiUrl=L.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(C=>C.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async L=>{this.plugin.settings.paddleStructureApiUrl=L.trim(),await this.plugin.saveSettings(),await w()})),new D.Setting(f).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(C=>{k=C,C.addOption("auto","Auto (default)"),C.setValue(this.plugin.settings.ocrEngine),C.onChange(async L=>{this.plugin.settings.ocrEngine=L,await this.plugin.saveSettings()})}),new D.Setting(f).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(C=>C.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async L=>{this.plugin.settings.ocrMode=L,await this.plugin.saveSettings()})),new D.Setting(f).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(C=>C.setValue(this.plugin.settings.forcePerPageOcr).onChange(async L=>{this.plugin.settings.forcePerPageOcr=L,await this.plugin.saveSettings()})),new D.Setting(f).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(C=>{C.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async L=>{this.plugin.settings.ocrQualityThreshold=L,await this.plugin.saveSettings()})}),new D.Setting(f).setName("Chunking").setDesc("page or section").addDropdown(C=>C.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async L=>{this.plugin.settings.chunkingMode=L,await this.plugin.saveSettings()})),w()}},{id:"llms",label:"LLMs",render:f=>{f.createEl("h2",{text:"LLM Provider Profiles"});let k=f.createDiv({cls:"zrr-llm-profiles"}),x=()=>{k.empty();let v=n();v.length||k.createEl("p",{text:"No profiles yet. Add one below."});for(let P of v){let R=k.createEl("details",{cls:"zrr-profile"});v.length===1&&(R.open=!0);let G=R.createEl("summary",{text:P.name||P.id||"Profile"});G.addClass("zrr-profile-title");let Le=R.createDiv({cls:"zrr-profile-body"});new D.Setting(Le).setName("Profile name").addText(le=>le.setPlaceholder("My provider").setValue(P.name||"").onChange(async de=>{P.name=de.trim(),G.textContent=P.name||P.id||"Profile",await t(n())})),new D.Setting(Le).setName("Base URL").addText(le=>le.setPlaceholder("http://localhost:1234/v1").setValue(P.baseUrl||"").onChange(async de=>{P.baseUrl=de.trim(),await t(n())})),new D.Setting(Le).setName("API key").setDesc("Stored in settings (not encrypted).").addText(le=>{i(le),le.setPlaceholder("sk-...").setValue(P.apiKey||"").onChange(async de=>{P.apiKey=de.trim(),await t(n())})}),new D.Setting(Le).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(le=>le.setButtonText("Delete profile").onClick(async()=>{let de=n().filter(Yn=>Yn.id!==P.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===P.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===P.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===P.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(de),x()}))}new D.Setting(k).addButton(P=>P.setButtonText("Add profile").onClick(async()=>{let R=`profile-${Date.now().toString(36)}`,G=n().concat([{id:R,name:"Custom",baseUrl:"",apiKey:""}]);await t(G),x()}))};x(),f.createEl("h2",{text:"OCR cleanup"}),new D.Setting(f).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(v=>v.setValue(this.plugin.settings.enableLlmCleanup).onChange(async P=>{this.plugin.settings.enableLlmCleanup=P,await this.plugin.saveSettings()}));let w=null,E=null,A=null,C=async()=>{},L=async(v,P=!0)=>{let R=v.trim();this.plugin.settings.llmCleanupBaseUrl=R,P&&(this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom")),E&&E.setValue(R),await this.plugin.saveSettings()},z=async v=>{let P=n().find(R=>R.id===v);this.plugin.settings.llmCleanupProviderProfileId=v,P&&(this.plugin.settings.llmCleanupBaseUrl=P.baseUrl,this.plugin.settings.llmCleanupApiKey=P.apiKey,E==null||E.setValue(P.baseUrl),A==null||A.setValue(P.apiKey)),await this.plugin.saveSettings(),await C()};new D.Setting(f).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(v=>{w=v,v.addOption("custom","Custom (manual)");for(let R of n())v.addOption(R.id,R.name||R.id);let P=this.plugin.settings.llmCleanupProviderProfileId;v.setValue(P&&n().some(R=>R.id===P)?P:"custom"),v.onChange(async R=>{if(R==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await z(R)})}),new D.Setting(f).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(v=>{E=v,v.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async P=>{await L(P)})}),new D.Setting(f).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(v=>{A=v,i(v),v.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async P=>{this.plugin.settings.llmCleanupApiKey=P.trim(),this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom"),await this.plugin.saveSettings()})});let T=new D.Setting(f).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),M=null,I=v=>{if(!M)return;let P=(this.plugin.settings.llmCleanupModel||"").trim(),R=new Set(v.map(G=>G.value));P&&!R.has(P)&&(v=v.concat([{value:P,label:`Custom (${P})`}])),M.selectEl.options.length=0;for(let G of v)M.addOption(G.value,G.label);P&&M.setValue(P)};C=async()=>{if(M){M.setDisabled(!0);try{let v=await this.plugin.fetchCleanupModelOptions();I(v)}finally{M.setDisabled(!1)}}},T.addDropdown(v=>{M=v;let P=(this.plugin.settings.llmCleanupModel||"").trim();v.addOption(P||"loading","Loading..."),v.setValue(P||"loading"),v.onChange(async R=>{this.plugin.settings.llmCleanupModel=R.trim(),await this.plugin.saveSettings()})}),T.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await C()})}),C(),new D.Setting(f).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(v=>v.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async P=>{let R=Number.parseFloat(P);this.plugin.settings.llmCleanupTemperature=Number.isFinite(R)?R:0,await this.plugin.saveSettings()})),new D.Setting(f).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(v=>v.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async P=>{this.plugin.settings.llmCleanupMinQuality=P,await this.plugin.saveSettings()})),new D.Setting(f).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(v=>v.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async P=>{let R=Number.parseInt(P,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(R)?R:2e3,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Text Embedding"});let F=null,j=null,O=null,q=async()=>{},$=async(v,P=!0)=>{let R=v.trim();this.plugin.settings.embedBaseUrl=R,P&&(this.plugin.settings.embedProviderProfileId="",F&&F.setValue("custom")),j&&j.setValue(R),await this.plugin.saveSettings()},B=async v=>{let P=n().find(R=>R.id===v);this.plugin.settings.embedProviderProfileId=v,P&&(this.plugin.settings.embedBaseUrl=P.baseUrl,this.plugin.settings.embedApiKey=P.apiKey,j==null||j.setValue(P.baseUrl),O==null||O.setValue(P.apiKey)),await this.plugin.saveSettings(),await q()};new D.Setting(f).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(v=>{F=v,v.addOption("custom","Custom (manual)");for(let R of n())v.addOption(R.id,R.name||R.id);let P=this.plugin.settings.embedProviderProfileId;v.setValue(P&&n().some(R=>R.id===P)?P:"custom"),v.onChange(async R=>{if(R==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await B(R)})}),new D.Setting(f).setName("Embeddings base URL").addText(v=>{j=v,v.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async P=>{await $(P)})}),new D.Setting(f).setName("Embeddings API key").addText(v=>{O=v,i(v),v.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async P=>{this.plugin.settings.embedApiKey=P.trim(),this.plugin.settings.embedProviderProfileId="",F&&F.setValue("custom"),await this.plugin.saveSettings()})});let J=new D.Setting(f).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),V=null,Y=v=>{if(!V)return;let P=(this.plugin.settings.embedModel||"").trim(),R=new Set(v.map(G=>G.value));P&&!R.has(P)&&(v=v.concat([{value:P,label:`Custom (${P})`}])),V.selectEl.options.length=0;for(let G of v)V.addOption(G.value,G.label);P&&V.setValue(P)};q=async()=>{if(V){V.setDisabled(!0);try{let v=await this.plugin.fetchEmbeddingModelOptions();Y(v)}finally{V.setDisabled(!1)}}},J.addDropdown(v=>{V=v;let P=(this.plugin.settings.embedModel||"").trim();v.addOption(P||"loading","Loading..."),v.setValue(P||"loading"),v.onChange(async R=>{this.plugin.settings.embedModel=R.trim(),await this.plugin.saveSettings()})}),J.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await q()})}),q(),new D.Setting(f).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(v=>v.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async P=>{this.plugin.settings.embedIncludeMetadata=P,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(v=>v.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async P=>{let R=Number.parseInt(P,10);this.plugin.settings.embedContextWindow=Number.isFinite(R)?Math.max(0,R):1,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(v=>v.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async P=>{let R=Number.parseInt(P,10);this.plugin.settings.embedContextChars=Number.isFinite(R)?Math.max(0,R):220,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(v=>v.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async P=>{let R=Number.parseInt(P,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(R)?Math.max(0,R):3500,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(v=>v.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async P=>{let R=Number.parseInt(P,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(R)?Math.max(0,R):200,await this.plugin.saveSettings()})),new D.Setting(f).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(v=>v.setValue(this.plugin.settings.enableChunkTagging).onChange(async P=>{this.plugin.settings.enableChunkTagging=P,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Chat LLM"});let X=null,ie=null,se=null,ge=async()=>{},Qe=async(v,P=!0)=>{let R=v.trim();this.plugin.settings.chatBaseUrl=R,P&&(this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom")),ie&&ie.setValue(R),await this.plugin.saveSettings()},en=async v=>{let P=n().find(R=>R.id===v);this.plugin.settings.chatProviderProfileId=v,P&&(this.plugin.settings.chatBaseUrl=P.baseUrl,this.plugin.settings.chatApiKey=P.apiKey,ie==null||ie.setValue(P.baseUrl),se==null||se.setValue(P.apiKey)),await this.plugin.saveSettings(),await ge()};new D.Setting(f).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(v=>{X=v,v.addOption("custom","Custom (manual)");for(let R of n())v.addOption(R.id,R.name||R.id);let P=this.plugin.settings.chatProviderProfileId;v.setValue(P&&n().some(R=>R.id===P)?P:"custom"),v.onChange(async R=>{if(R==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await en(R)})}),new D.Setting(f).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(v=>{ie=v,v.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async P=>{await Qe(P)})}),new D.Setting(f).setName("Chat API key").addText(v=>{se=v,i(v),v.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async P=>{this.plugin.settings.chatApiKey=P.trim(),this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom"),await this.plugin.saveSettings()})});let Se=new D.Setting(f).setName("Chat model").setDesc("Select a chat-capable model from the provider."),re=null,nn=v=>{if(!re)return;let P=(this.plugin.settings.chatModel||"").trim(),R=new Set(v.map(G=>G.value));P&&!R.has(P)&&(v=v.concat([{value:P,label:`Custom (${P})`}])),re.selectEl.options.length=0;for(let G of v)re.addOption(G.value,G.label);P&&re.setValue(P)};ge=async()=>{if(re){re.setDisabled(!0);try{let v=await this.plugin.fetchChatModelOptions();nn(v)}finally{re.setDisabled(!1)}}},Se.addDropdown(v=>{re=v;let P=(this.plugin.settings.chatModel||"").trim();v.addOption(P||"loading","Loading..."),v.setValue(P||"loading"),v.onChange(async R=>{this.plugin.settings.chatModel=R.trim(),await this.plugin.saveSettings()})}),Se.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await ge()})}),ge(),new D.Setting(f).setName("Temperature").addText(v=>v.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async P=>{let R=Number.parseFloat(P);this.plugin.settings.chatTemperature=Number.isFinite(R)?R:.2,await this.plugin.saveSettings()})),new D.Setting(f).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(v=>v.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async P=>{let R=Number.parseInt(P,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(R)?Math.max(0,R):6,await this.plugin.saveSettings()})),new D.Setting(f).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(v=>v.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async P=>{this.plugin.settings.chatPaneLocation=P,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Retrieval"}),new D.Setting(f).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(v=>v.setValue(this.plugin.settings.enableQueryExpansion).onChange(async P=>{this.plugin.settings.enableQueryExpansion=P,await this.plugin.saveSettings()})),new D.Setting(f).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(v=>v.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async P=>{let R=Number.parseInt(P,10);this.plugin.settings.queryExpansionCount=Number.isFinite(R)?Math.max(1,R):3,await this.plugin.saveSettings()})),new D.Setting(f).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(v=>v.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async P=>{this.plugin.settings.enableCrossEncoderRerank=P,await this.plugin.saveSettings()})),new D.Setting(f).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(v=>v.setPlaceholder("BAAI/bge-reranker-v2-m3").setValue(this.plugin.settings.rerankModel).onChange(async P=>{this.plugin.settings.rerankModel=P.trim()||"BAAI/bge-reranker-v2-m3",await this.plugin.saveSettings()})),new D.Setting(f).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(v=>v.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async P=>{let R=Number.parseInt(P,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(R)?Math.max(1,R):4,await this.plugin.saveSettings()})),new D.Setting(f).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(v=>v.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async P=>{let R=Number.parseInt(P,10);this.plugin.settings.rrfK=Number.isFinite(R)?Math.max(1,R):60,await this.plugin.saveSettings()})),new D.Setting(f).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(v=>v.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async P=>{let R=Number.parseInt(P,10);this.plugin.settings.rrfLogTop=Number.isFinite(R)?Math.max(0,R):0,await this.plugin.saveSettings()})),new D.Setting(f).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(v=>v.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async P=>{let R=Number.parseInt(P,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(R)?Math.max(0,R):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:f=>{f.createEl("h2",{text:"Logging"}),new D.Setting(f).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(k=>k.setValue(this.plugin.settings.enableFileLogging).onChange(async x=>{this.plugin.settings.enableFileLogging=x,await this.plugin.saveSettings()})),new D.Setting(f).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(k=>k.setPlaceholder(`${ee}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async x=>{this.plugin.settings.logFilePath=x.trim()||`${ee}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new D.Setting(f).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(k=>k.setButtonText("Open log").onClick(async()=>{var x,w;await((w=(x=this.plugin).openLogFile)==null?void 0:w.call(x))})).addButton(k=>k.setButtonText("Clear log").onClick(async()=>{var x,w;await((w=(x=this.plugin).clearLogFile)==null?void 0:w.call(x))})),f.createEl("h2",{text:"Zotero Companion Plugin"}),f.createEl("p",{text:"Download the XPI, then in Zotero go to Tools \u2192 Add-ons \u2192 Install from File and restart."}),new D.Setting(f).setName("Download companion add-on").setDesc("Downloads the companion XPI to your system Downloads folder.").addButton(k=>k.setButtonText("Download XPI").onClick(async()=>{let x=this.getDefaultDownloadDir();if(!x){new D.Notice("Unable to resolve the system Downloads folder.");return}let w=Te.default.join(x,"zrr-companion.xpi");if(await this.companionXpiExists(w)){new D.Notice(`Companion XPI already exists: ${w}`);return}new D.Notice("Downloading companion XPI..."),await this.downloadCompanionXpi(w)})),new D.Setting(f).setName("Open Zotero").setDesc("Launch Zotero and open the Add-ons window (Tools \u2192 Add-ons).").addButton(k=>k.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new D.Setting(f).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(k=>k.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),f.createEl("h2",{text:"Redis Indexing"}),new D.Setting(f).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(k=>k.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new D.Setting(f).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(k=>k.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(k=>k.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],u=new Map,p=new Map,m=f=>{this.activeTab=f;for(let[k,x]of u){let w=k===f;x.classList.toggle("is-active",w),x.setAttribute("aria-selected",w?"true":"false"),x.setAttribute("tabindex",w?"0":"-1")}for(let[k,x]of p){let w=k===f;x.classList.toggle("is-active",w),x.hidden=!w}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let b=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let f of d){let k=y.createEl("button",{text:f.label,cls:"zrr-settings-tab-button"}),x=`zrr-settings-tab-${f.id}`,w=`zrr-settings-panel-${f.id}`;k.type="button",k.id=x,k.setAttribute("role","tab"),k.setAttribute("aria-controls",w),k.setAttribute("aria-selected","false"),k.addEventListener("click",()=>m(f.id));let E=b.createDiv({cls:"zrr-settings-tab-panel"});E.id=w,E.setAttribute("role","tabpanel"),E.setAttribute("aria-labelledby",x),E.hidden=!0,f.render(E),u.set(f.id,k),p.set(f.id,E)}let S=d.some(f=>f.id===this.activeTab)?this.activeTab:d[0].id;m(S)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Te.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await De.promises.access(e),!0}catch(n){return!1}}async downloadCompanionXpi(e){try{await De.promises.mkdir(Te.default.dirname(e),{recursive:!0});let n=await(0,D.requestUrl)({url:ct,method:"GET"});if(n.status!==200){new D.Notice(`Failed to download companion XPI (HTTP ${n.status}).`);return}let t=Buffer.from(n.arrayBuffer);await De.promises.writeFile(e,t),new D.Notice(`Downloaded companion XPI: ${e}`)}catch(n){new D.Notice("Failed to download companion XPI. See console for details."),console.warn("Failed to download companion XPI",n)}}};var Ln=require("@codemirror/state"),En=require("@codemirror/view"),oe=require("obsidian");var dt=g=>{let _=g.scrollDOM.getBoundingClientRect(),e=g.posAtCoords({x:_.left+8,y:+_.height*.25});return e===null?null:g.state.doc.lineAt(e).number},Fe=class{constructor(_,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.deps=_,this.helpers=e}createSyncExtension(){let _=this,e=this.helpers;return En.ViewPlugin.fromClass(class{constructor(n){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=n,this.docId=e.extractDocIdFromDoc(n.state.doc),this.onScroll=()=>this.scheduleSync(!1),n.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(n){n.docChanged&&(this.docId=e.extractDocIdFromDoc(n.view.state.doc),this.lastPage=null,this.lastChunkId=null),(n.docChanged||n.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(n){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,n)}))}syncPdfSidebar(n,t){var u,p;let i=this.docId;if(!i)return;let r=dt(n);if(r===null)return;let a=e.findChunkStartLineInDoc(n.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(u=s==null?void 0:s.pageNumber)!=null?u:null,l=(p=s==null?void 0:s.chunkId)!=null?p:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!t&&(c||d)||(this.lastPage=o,this.lastChunkId=l,_.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,n;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((n=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:n.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let _=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(_.docId,_.pageNumber,_.chunkId)}updatePreviewScrollHandler(){var t;let _=this.deps.app.workspace.getActiveViewOfType(oe.MarkdownView);if(!_||_.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(t=_.previewMode)==null?void 0:t.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let n=()=>this.schedulePreviewSync(_);e.addEventListener("scroll",n,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=n,this.schedulePreviewSync(_)}async syncPdfSidebarForFile(_){try{let e=await this.deps.app.vault.read(_),n=await this.deps.resolveDocIdForNote(_,e);if(!n)return;let t=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(n,t==null?void 0:t.pageNumber,t==null?void 0:t.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(_,e,n){if(!_)return;let t=await this.deps.getDocIndexEntry(_);t||(t=await this.deps.hydrateDocIndexFromCache(_));let i=t!=null&&t.pdf_path?String(t.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let p=(0,oe.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(p)instanceof oe.TFile&&(r=p)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof oe.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:n};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:n};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&n&&(o=await this.resolvePageNumberForChunk(_,n)),o===null||this.pdfSidebarDocId===_&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=_,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,c=o!==null?`${l}#page=${o}`:l,d=this.deps.app.workspace,u=d.getMostRecentLeaf();d.setActiveLeaf(s,{focus:!1});try{await this.openPdfLinkInLeaf(s,c),this.updatePdfSidebarIcon(s)}finally{u&&d.setActiveLeaf(u,{focus:!1})}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(_){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(_)}))}syncPdfSidebarForPreview(_){let e=this.previewScrollEl;if(!e)return;let n=_.getViewData();if(!n)return;let t=Ln.Text.of(n.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(t);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(t,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(_){var t;let e=_.getBoundingClientRect().top,n=_.querySelectorAll("[data-line]");for(let i of Array.from(n))if(i.getBoundingClientRect().bottom>=e+2){let a=(t=i.getAttribute("data-line"))!=null?t:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var t,i;if(this.pdfSidebarLeaf&&((i=(t=this.pdfSidebarLeaf.view)==null?void 0:t.getViewType)==null?void 0:i.call(t))==="pdf")return this.pdfSidebarLeaf;let _=this.deps.app.workspace;if(typeof _.ensureSideLeaf=="function")try{let r=await _.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let n=this.deps.app.workspace.getRightLeaf(!0);return n&&this.isRightSidebarLeaf(n)?(this.pdfSidebarLeaf=n,this.updatePdfSidebarIcon(n),n):null}isRightSidebarLeaf(_){if(!_)return!1;let n=_.containerEl;return!!(n!=null&&n.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(_){if(!_||!this.isRightSidebarLeaf(_))return;let n=_.containerEl,t=[];n&&t.push(...Array.from(n.querySelectorAll(".view-header-icon")));let i=_;if(i.tabHeaderEl&&t.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&t.push(i.tabHeaderInnerIconEl),t.length===0)return;let r=new Set;for(let s of t)r.has(s)||(r.add(s),s.innerHTML="",(0,oe.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=_.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(_,e){var r,a,s;let n=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],t=(s=(a=n==null?void 0:n.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof t=="function"){await t.call(n.lib.workspace,_,e,"",{active:!1});return}let i=_;if(typeof i.openLinkText=="function"){await i.openLinkText(e,"",{active:!1});return}await this.deps.app.workspace.openLinkText(e,"",!1)}getPluginsRegistry(){var _;return(_=this.deps.app.plugins)==null?void 0:_.plugins}isLeafTabActive(_){var i;let e=_;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===_;let n=e.containerEl;if(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))return!0;let t=e.tabHeaderEl;return!!(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))}async resolvePageNumberForChunk(_,e){var l,c,d,u,p;if(!_||!e)return null;let n=this.deps.normalizeChunkIdForNote(e,_)||e,t=this.chunkPageCache.get(_);if(t&&t.has(n))return(l=t.get(n))!=null?l:null;let i=(0,oe.normalizePath)(`${H}/${_}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let m of s){let y=typeof(m==null?void 0:m.chunk_id)=="string"?m.chunk_id.trim():"";if(!y)continue;let b=Number.isFinite((c=m==null?void 0:m.page_start)!=null?c:NaN)?Number(m.page_start):null,S=Number.isFinite((d=m==null?void 0:m.page_end)!=null?d:NaN)?Number(m.page_end):null,f=b!=null?b:S;f!==null&&(o.set(y,f),o.set(`${_}:${y}`,f))}return this.chunkPageCache.set(_,o),(p=(u=o.get(n))!=null?u:o.get(e))!=null?p:null}};var ze={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.6.9
aai
aam
abb
abge
...
\xF6pnv
\xFCberarb
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.6.9
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.6.9
services:
  redis-stack:
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,n=1200){let t=this.noteSyncTimers.get(e.path);t!==void 0&&window.clearTimeout(t);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},n);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,n=1200,t="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,t)},n);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,n=1200,t="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,t)},n);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let n=this.annotationNoteEditTimes.get(e);if(!n)return 0;let t=Date.now()-n;return t>=Hn?0:Hn-t}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=(e.annotation_page_label||"").trim();if(n)return n;let t=e.page_start?String(e.page_start):"",i=e.page_end?String(e.page_end):"";if(t&&(!i||t===i))return t;if(t&&i)return`${t} - ${i}`;let r=(e.pages||"").trim();if(!r)return"?";let a=r.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:r.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,h.normalizePath)(`${H}/${s}.json`),c=this.app.vault.adapter;if(!await c.exists(l))return;let d=await this.readChunkPayload(l);if(!d)return;let u=Array.isArray(d.chunks)?d.chunks:[],p=new Map;for(let x of u){if(this.isAnnotationChunk(x))continue;let w=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((n=x==null?void 0:x.chunk_id)!=null?n:"");w&&p.set(w,x)}let m=new Set,y=new Set,b=new Set,S=new Set,f=!1;for(let x of o){let w=x.chunkId;if(!w)continue;m.add(w);let E=p.get(w);if(!E){console.warn(`Sync note: chunk id not found in cache (${w})`);continue}if(x.excludeFlag){E.excluded!==!0&&(E.excluded=!0,f=!0);let L=this.normalizeChunkText(x.text);L&&L!==String((t=E.text)!=null?t:"")&&(E.text=L,E.char_count=L.length,f=!0),b.add(w);continue}if(E.excluded&&(E.excluded=!1,f=!0,y.add(w)),!x.text.trim()){b.add(w),S.add(w);continue}let A=this.normalizeChunkText(x.text);if(!A){b.add(w),S.add(w);continue}let C=typeof E.text=="string"?E.text:String((i=E.text)!=null?i:"");A!==C&&(E.text=A,E.char_count=A.length,y.add(w),f=!0)}for(let x of p.keys())m.has(x)||(b.add(x),S.add(x));let k=new Set([...b,...S]);if(k.size){let x=Array.from(k).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==x){this.noteSyncPendingDeletes.set(e.path,x),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!y.size&&!b.size&&!S.size&&!f)return;S.size&&(d.chunks=u.filter(x=>{var E;let w=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((E=x==null?void 0:x.chunk_id)!=null?E:"");return w&&!S.has(w)}),f=!0),(f||S.size)&&await c.write(l,JSON.stringify(d,null,2)),await this.reindexChunkUpdates(s,l,Array.from(y),Array.from(b)),(b.size||S.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,n){var t,i,r;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,n);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),s=await this.resolveDocIdForNote(e,a);if(!s)return;let o=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter;if(!o)return;let l=this.resolveZoteroItemKey(o,s);if(!l)return;let c=await this.fetchZoteroItem(l),d=(i=c==null?void 0:c.data)!=null?i:c;if(!d||typeof d!="object")return;let u=this.extractNoteMetadata(o),p=this.extractZoteroMetadata(d);p.citekey||(p.citekey=await this.resolveZoteroCitekey(d,l,c==null?void 0:c.meta));let m=await this.getMetadataSnapshot(s,o,e),y={},b={},S={},f=[],k=["title","short_title","citekey","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],x={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},w=k.filter(A=>this.hasFrontmatterKey(o,x[A]));if(!w.length)return;let E={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let A of w){let C=u[A],L=p[A];if(this.metadataValuesEqual(A,C,L))continue;let z=m==null?void 0:m[A];if(z!==void 0){let M=!this.metadataValuesEqual(A,C,z),I=!this.metadataValuesEqual(A,L,z);if(M&&!I){S[A]="note",this.assignMetadataUpdate(b,A,C);continue}if(!M&&I){S[A]="zotero",this.assignMetadataUpdate(y,A,L);continue}}let T=this.getMetadataDecisionLabels(A,C,L,E);f.push({field:A,fieldLabel:E[A],noteLabel:T.noteLabel,zoteroLabel:T.zoteroLabel,noteValue:this.formatMetadataValue(C),zoteroValue:this.formatMetadataValue(L)})}if(f.length>0){let A=await this.promptMetadataBatchDecision(f);for(let C of f){let L=(r=A[C.field])!=null?r:"skip";S[C.field]=L,L==="note"?this.assignMetadataUpdate(b,C.field,u[C.field]):L==="zotero"&&this.assignMetadataUpdate(y,C.field,p[C.field])}}Object.keys(y).length>0&&await this.applyNoteMetadataUpdates(e,y),Object.keys(b).length>0&&await this.applyZoteroMetadataUpdates(l,d,u,p,b),await this.updateMetadataSnapshot(e,s,u,p,m,S,w)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,n)}}async syncNoteAnnotationsWithZotero(e,n){var t,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,n);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let F=this.ensureDocIdInNoteContent(o,d);F!==o&&await this.writeNoteWithSyncSuppressed(e.path,F)}if(!d)return;let u=(i=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter)!=null?i:{},p=(r=c.attachmentKey)!=null?r:"";if(p||(p=await this.resolveAttachmentKeyForDocId(d,u)),!p)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===p&&await this.updateDocIndex({doc_id:d,attachment_key:p});let m=p,y=await this.fetchZoteroAnnotationsForDoc(d,p),b=y.annotations;p=y.attachmentKey,p&&p!==m&&await this.updateDocIndex({doc_id:d,attachment_key:p});let S=this.parseAnnotationBlock(l.block,p),f=new Map;for(let F of S)F.key&&F.imagePath&&f.set(F.key,{path:F.imagePath,hash:F.imageHash||this.extractAnnotationImageHashFromPath(F.imagePath)});await this.attachAnnotationImages(d,p,b,e.path,f);let k=new Map;for(let F of S)F.key&&k.set(F.key,F);let x=new Map;for(let F of b)x.set(F.key,F);let w=await this.getAnnotationSnapshot(d),E=(a=w==null?void 0:w.annotations)!=null?a:{},A={},C=[],L=!1,z=!1,T=!1;p&&p!==m&&b.length>0&&(z=!0,T=!0);for(let[F,j]of x.entries()){let O=k.get(F);if(!O){z=!0;continue}let q=E[F],$=this.annotationSnapshotFromEntry(O,j.annotationType),B=this.annotationSnapshotFromEntry(j,j.annotationType),J=($.image_hash||"")!==(B.image_hash||"");if(!q){this.annotationSnapshotsEqualIgnoringImage($,B)?J&&(z=!0,T=!0):(A[F]="note",L=!0);continue}let V=!this.annotationSnapshotsEqual($,q),Y=!this.annotationSnapshotsEqual(B,q),X=(B.color_key||"")!==(q.color_key||""),ie=!this.annotationSnapshotsEqualIgnoringImage($,q),se=!this.annotationSnapshotsEqualIgnoringImage(B,q);ie&&!se?(A[F]="note",L=!0):!ie&&se?(A[F]="zotero",z=!0):ie&&se&&C.push({key:F,title:this.formatAnnotationConflictTitle(j),noteValue:this.formatAnnotationConflictValue($,O.tags),zoteroValue:this.formatAnnotationConflictValue(B,j.tags)}),J&&(V||Y)&&(z=!0,T=!0),X&&(z=!0,T=!0)}if(C.length>0){let F=await this.promptAnnotationBatchDecision(C);for(let j of C){let O=(s=F[j.key])!=null?s:"skip";A[j.key]=O,O==="note"?L=!0:O==="zotero"&&(z=!0,T=!0)}}let M=[];for(let[F,j]of Object.entries(A)){if(j!=="note")continue;let O=k.get(F),q=x.get(F);!O||!q||M.push({entry:q,note:O})}M.length>0&&await this.applyZoteroAnnotationUpdates(M),L&&this.annotationNoteEditTimes.set(e.path,Date.now());let I=this.getAnnotationGraceRemaining(e.path);if(z&&I>0&&L&&!T&&(this.scheduleNoteAnnotationSync(e,I+250,n),z=!1),z){let F=this.buildAnnotationBlock(d,p,b),j=this.replaceAnnotationBlock(o,F);if(j&&j!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,j)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,p,b),await this.updateAnnotationChunks(d,p,b)}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,n)}}resolveZoteroItemKey(e,n){let t=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),n];for(let i of t){let r=Z(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,n){var l;if(!e)return"";let t=await this.getDocIndexEntry(e);if(t||(t=await this.hydrateDocIndexFromCache(e)),t!=null&&t.attachment_key)return t.attachment_key;let i=(0,h.normalizePath)(`${H}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let d=await this.readChunkPayload(i),u=d!=null&&d.metadata&&typeof d.metadata=="object"?d.metadata:null,p=u==null?void 0:u.attachment_key;if(typeof p=="string"&&p.trim())return await this.updateDocIndex({doc_id:e,attachment_key:p.trim()}),p.trim()}}catch(c){}let r=this.resolveZoteroItemKey(n,e);if(!r)return"";let a=await this.fetchZoteroItem(r),s=(l=a==null?void 0:a.data)!=null?l:a;if(!s||typeof s!="object")return"";let o=await ve(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var S,f,k,x,w,E,A,C,L,z,T,M,I;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString((x=(k=(f=(S=e==null?void 0:e["short title"])!=null?S:e==null?void 0:e.short_title)!=null?f:e==null?void 0:e.shortTitle)!=null?k:e==null?void 0:e["short-title"])!=null?x:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString((C=(A=(E=(w=e==null?void 0:e.citekey)!=null?w:e==null?void 0:e["citation key"])!=null?E:e==null?void 0:e.citation_key)!=null?A:e==null?void 0:e.citationKey)!=null?C:e==null?void 0:e["citation-key"]),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString((L=e==null?void 0:e.abstract)!=null?L:e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((z=e==null?void 0:e.doi)!=null?z:e==null?void 0:e.DOI),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),u=this.normalizeMetadataString(e==null?void 0:e.pages),p=this.normalizeMetadataString((I=(M=(T=e==null?void 0:e["item type"])!=null?T:e==null?void 0:e.item_type)!=null?M:e==null?void 0:e.itemType)!=null?I:e==null?void 0:e["item-type"]),m=this.normalizeMetadataList(e==null?void 0:e.tags),y=this.normalizeMetadataList(e==null?void 0:e.authors),b=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:n,short_title:t,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:u,item_type:p,tags:this.sanitizeObsidianTags(m),authors:y,editors:b}}extractZoteroMetadata(e){var f,k,x;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString(me(e)),i=this.normalizeMetadataString(Me(e)),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString(e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((f=e==null?void 0:e.DOI)!=null?f:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),u=this.normalizeMetadataString(e==null?void 0:e.pages),p=this.normalizeMetadataString((x=(k=e==null?void 0:e.itemType)!=null?k:e==null?void 0:e.item_type)!=null?x:e==null?void 0:e["item-type"]),m=Array.isArray(e==null?void 0:e.creators)?e.creators:[],y=m.filter(w=>(w==null?void 0:w.creatorType)==="author").map(w=>he(w)).filter(Boolean),b=m.filter(w=>(w==null?void 0:w.creatorType)==="editor"||(w==null?void 0:w.creatorType)==="seriesEditor").map(w=>he(w)).filter(Boolean),S=Array.isArray(e==null?void 0:e.tags)?e.tags.map(w=>typeof w=="string"?w:w==null?void 0:w.tag).filter(w=>typeof w=="string"):[];return{title:n,short_title:t,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:u,item_type:p,tags:this.sanitizeObsidianTags(S),authors:this.normalizeMetadataList(y),editors:this.normalizeMetadataList(b)}}async resolveZoteroCitekey(e,n,t){let i=this.normalizeMetadataString(Me(e,t!=null?t:void 0));if(i)return i;if(!n)return"";let r=await this.fetchZoteroItemCsl(n);return this.normalizeMetadataString(ln(r))}extractAnnotationPageInfo(e){var a;let t=Z((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:t,pageIndex:i}}extractAnnotationImagePayload(e){var a,s,o,l;let n=(s=(a=e.annotationImage)!=null?a:e.annotationImageData)!=null?s:e.annotationImageBase64;if(!n)return null;let t=null,i="";if(Buffer.isBuffer(n))t=n;else if(ArrayBuffer.isView(n))t=Buffer.from(n.buffer,n.byteOffset,n.byteLength);else if(n instanceof ArrayBuffer)t=Buffer.from(n);else if(typeof n=="string"){let c=n.trim();if(!c)return null;let d=c.match(/^data:([^;]+);base64,(.*)$/i);if(d&&(i=this.normalizeAnnotationImageMime(d[1]),c=d[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;t=Buffer.from(c,"base64")}if(!t||!t.length)return null;i||(i=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(t)||"image/png");let r=this.annotationImageExtensionFromMime(i)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(t))||"png";return{buffer:t,mime:i,ext:r}}parseZoteroAnnotationItem(e,n){var S,f,k,x;let t=(f=(S=e==null?void 0:e.data)!=null?S:e)!=null?f:{},i=Z((k=e==null?void 0:e.key)!=null?k:t==null?void 0:t.key);if(!i)return null;let r=Z(t.annotationType),a=this.normalizeAnnotationText(t.annotationText),s=this.normalizeAnnotationText(t.annotationComment),o=Z(t.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:u,pageIndex:p}=this.extractAnnotationPageInfo(t),m=(x=t.annotationSortIndex)!=null?x:t.annotationSort,y=Number.isFinite(Number(m))?Number(m):0,b=Array.isArray(t.tags)?t.tags.map(w=>typeof w=="string"?w:w==null?void 0:w.tag).filter(w=>typeof w=="string"):[];return{key:i.trim(),attachmentKey:n,pageLabel:u,pageIndex:p,colorKey:l,callout:d,heading:c,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(b),sortIndex:y,rawValues:t}}async fetchZoteroAnnotations(e){if(!e)return[];let n=this.canUseWebApi()||await this.ensureWebApiLibraryId(),t=a=>{var o,l;let s=[];for(let c of a){let d=(l=(o=c==null?void 0:c.data)!=null?o:c)!=null?l:{};if(Z(d.itemType)!=="annotation")continue;let u=this.parseZoteroAnnotationItem(c,e);u&&s.push(u)}return s},i=[];try{i=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(a){try{i=await this.fetchZoteroChildrenLocal(e)}catch(s){console.warn("Failed to fetch Zotero annotation items from local API",s)}}let r=t(i);if(!r.length&&n)try{let a=[];try{a=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(o){a=await this.fetchZoteroChildrenWeb(e)}let s=t(a);s.length&&(r=s)}catch(a){console.warn("Failed to fetch Zotero annotation items from Web API",a)}return r}async fetchZoteroAnnotationsForDoc(e,n){var o,l,c;let t=n,i=await this.fetchZoteroAnnotations(t);if(i.length||!e)return i.length||this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i};let r=[];try{r=await this.fetchZoteroChildren(e)}catch(d){return console.warn("Failed to fetch Zotero attachments for annotations",d),this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}let a=[],s=new Set(t?[t]:[]);for(let d of r){if(!cn(d))continue;let u=Z((c=(l=d==null?void 0:d.key)!=null?l:(o=d==null?void 0:d.data)==null?void 0:o.key)!=null?c:d==null?void 0:d.attachmentKey);!u||s.has(u)||(s.add(u),a.push(u))}for(let d of a){let u=await this.fetchZoteroAnnotations(d);if(u.length)return{attachmentKey:d,annotations:u}}return this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}async attachAnnotationImages(e,n,t,i,r){var u;if(!this.settings.includeAnnotationImages||!t.length)return;let a=await this.resolveAnnotationImageOutputDir(i);if(!a)return;let s=this.sanitizeFileName(e||n)||"annotations",o=(0,h.normalizePath)(N.default.join(a.relative||"",s)),l=N.default.normalize(N.default.join(a.absolute,s));o?await this.ensureFolder(o):await W.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,d=new Map;for(let p of t){let m=String(p.annotationType||"").trim().toLowerCase(),y=m==="image"||m==="ink",b=this.extractAnnotationImagePayload((u=p.rawValues)!=null?u:{});if(!b&&y&&this.settings.zoteroCompanionEnabled&&(b=await this.fetchCompanionAnnotationImage(p.key)),!b){let x=r==null?void 0:r.get(p.key);x!=null&&x.path&&await c.exists(x.path)&&(p.imagePath=x.path,p.imageHash=x.hash,d.set(p.key,x.path));continue}let S=(0,Ce.createHash)("sha1").update(b.buffer).digest("hex").slice(0,12),f=`zrr-annotation-${p.key}-${S}.${b.ext}`,k=(0,h.normalizePath)(N.default.join(o,f));try{await c.exists(k)||await c.writeBinary(k,this.bufferToArrayBuffer(b.buffer)),p.imagePath=k,p.imageHash=S,d.set(p.key,k)}catch(x){console.warn("Failed to write annotation image",{annotationKey:p.key,error:x})}}if(o&&await c.exists(o))try{let p=await c.list(o);for(let m of p.files){let b=N.default.basename(m).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!b)continue;let S=b[1].toUpperCase(),f=d.get(S);(!f||(0,h.normalizePath)(f)!==(0,h.normalizePath)(m))&&await c.remove(m)}}catch(p){console.warn("Failed to clean up annotation images",p)}}async fetchCompanionAnnotationImage(e){let n=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!n)return null;let t=`${n.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,i={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(i.Authorization=`Bearer ${r}`);try{let a=await this.requestLocalApiRaw(t,{headers:i,timeoutMs:5e3});if(a.statusCode===200){let s=a.headers["content-type"],o=Array.isArray(s)?s[0]:s!=null?s:"";return this.buildAnnotationImagePayloadFromBuffer(a.body,o)}if(a.statusCode===204||a.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:a.statusCode})}catch(a){console.warn("Failed to fetch annotation image from Zotero companion",a)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new h.Notice("Zotero companion base URL is not set.");return}let n=`${e.replace(/\/$/,"")}/health`,t={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(t.Authorization=`Bearer ${i}`);try{let r=await this.requestLocalApiRaw(n,{headers:t,timeoutMs:3e3});if(r.statusCode===200){try{let a=JSON.parse(r.body.toString("utf8"));if(a!=null&&a.ok){new h.Notice("Zotero companion: OK.");return}}catch(a){}new h.Notice("Zotero companion responded but did not return OK.");return}if(r.statusCode===401){new h.Notice("Zotero companion: unauthorized (check token).");return}new h.Notice(`Zotero companion: HTTP ${r.statusCode}.`)}catch(r){console.warn("Zotero companion health check failed",r),new h.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new h.Notice("Opened Zotero. Go to Tools \u2192 Add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new h.Notice("Unable to open Zotero automatically. Open Zotero and go to Tools \u2192 Add-ons.")}}async spawnDetached(e){let[n,...t]=e;if(!n)throw new Error("Missing command");await new Promise((i,r)=>{let a=!1,s=(0,ne.spawn)(n,t,{detached:!0,stdio:"ignore"});s.on("error",o=>{a||(a=!0,r(o))}),s.unref(),a||(a=!0,i())})}maybeWarnMissingAnnotationApi(e,n){if(this.canUseWebApi()){console.info("No Zotero annotations returned for attachment",{docId:e,attachmentKey:n});return}let t=e||n;!t||this.annotationWebApiWarned.has(t)||(this.annotationWebApiWarned.add(t),new h.Notice("Zotero annotations require Web API access. Configure the Web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
`)}async renderFrontmatter(e,n,t,i,r,a){var d;let s=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,n,t,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let n=e.split(/\r?\n/),t=[],i=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<n.length;){let l=n[o],c=l.match(i);if(!c){t.push(l),o+=1;continue}let d=c[1].trim(),u=c[2].trim();if(a.has(d)){t.push(l),o+=1;continue}if(!s(u)){t.push(l),o+=1;continue}let p=o+1,m=[];for(;p<n.length&&n[p].match(r);)m.push(n[p]),p+=1;if(m.length===0){for(o=p;o<n.length&&n[o].trim()==="";)o+=1;continue}let y=m.filter(b=>{let S=b.match(r);if(!S)return!1;let f=S[1].trim();return!s(f)});if(y.length>0&&t.push(l,...y),o=p,y.length===0)for(;o<n.length&&n[o].trim()==="";)o+=1}for(;t.length>0&&t[t.length-1].trim()==="";)t.pop();return t.join(`

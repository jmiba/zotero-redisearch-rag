"use strict";var rt=Object.create;var Le=Object.defineProperty;var at=Object.getOwnPropertyDescriptor;var st=Object.getOwnPropertyNames;var ot=Object.getPrototypeOf,lt=Object.prototype.hasOwnProperty;var ct=(g,p)=>{for(var e in p)Le(g,e,{get:p[e],enumerable:!0})},hn=(g,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of st(p))!lt.call(g,t)&&t!==e&&Le(g,t,{get:()=>p[t],enumerable:!(n=at(p,t))||n.enumerable});return g};var pe=(g,p,e)=>(e=g!=null?rt(ot(g)):{},hn(p||!g||!g.__esModule?Le(e,"default",{value:g,enumerable:!0}):e,g)),dt=g=>hn(Le({},"__esModule",{value:!0}),g);var Et={};ct(Et,{default:()=>en});module.exports=dt(Et);var h=require("obsidian");var wn=require("@codemirror/state"),ee=require("@codemirror/view"),Pn=require("obsidian");var ue=/<!--\s*zrr:sync-start[^>]*-->/i,fe=/<!--\s*zrr:sync-end\s*-->/i,ce=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ne=/<!--\s*zrr:chunk\s+end\s*-->/i,xe=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,mn=g=>{let p=g.trim();if(!p.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(p)){let u=p.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:u?u[2]:void 0}}if(/^zrr:sync-end\b/i.test(p))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(p)){let u=p.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),m=p.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:u?u[2]:void 0,attachmentKey:m?m[2]:void 0}}if(/^zrr:annotations-end\b/i.test(p))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(p))return{type:"chunk-end"};let e=p.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let n=e[1]||"",t=n.match(/\bid=(["']?)([^"'\s]+)\1/i),i=t?t[2]:"",r=n.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:n.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(n)||/\bdelete\b/i.test(n),_=/\bsection\b/i.test(n);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:_?"section":c?"page":"section"}},an=g=>{var l;if(!g)return null;let p=g.match(ce);if(!p)return null;let e=p[1]||"",n=e.match(/\bid=(["']?)([^"'\s]+)\1/i),t=n?n[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=t&&(l=ut(t))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:t,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},De=g=>{for(let p=1;p<=g.lines;p+=1){let e=g.line(p).text;if(ue.test(e)){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return n?n[2].trim():null}}return null},sn=(g,p)=>{let e=p;for(;e>=1;e-=1){let n=g.line(e).text;if(ce.test(n))return{line:e,text:n};if(ue.test(n)||fe.test(n))break}return null},pt=(g,p)=>{for(let e=p;e<=g.lines;e+=1){let n=g.line(e).text;if(Ne.test(n))return e;if(fe.test(n))break}return null},yn=(g,p)=>{let e=sn(g,p);if(!e)return null;let n=pt(g,e.line+1);return n===null||p<e.line||p>n?null:{startLine:e.line,endLine:n,text:e.text}},bn=(g,p,e)=>{if(p>e)return!1;for(let n=p;n<=e;n+=1){let t=g.line(n).text;if(xe.test(t))return!0}return!1},ut=g=>{var t;if(!g)return null;let e=(g.includes(":")&&(t=g.split(":").pop())!=null?t:g).match(/^p(\d+)$/i);if(!e)return null;let n=Number.parseInt(e[1],10);return Number.isFinite(n)?n:null};var xn=g=>{if(!g)return null;let p=g.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return p?an(p[0]):null};var _t=(g,p)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),g.type==="sync-start"||g.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(g.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),g.type==="sync-start"?e.textContent=g.docId?`Redis Index Sync start - ${g.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e;if(g.type==="annotations-start"||g.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),g.type==="annotations-start"){let n=g.docId?` - ${g.docId}`:"";e.textContent=`Zotero annotations start${n}`}else e.textContent="Zotero annotations end";return e}if(g.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=g.chunkKind==="page"?"Page end":"Section end",g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),e;if(g.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),g.excluded&&e.classList.add("is-excluded"),g.pageNumber&&p>0)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber}/${p})`}else e.textContent=`Page ${g.pageNumber}/${p}`;else if(g.pageNumber)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber})`}else e.textContent=`Page ${g.pageNumber}`;else g.chunkId?e.textContent=`Section ${g.chunkId}`:e.textContent="Section";return g.excluded&&(e.textContent=`${e.textContent} - excluded`),e},on=class extends ee.WidgetType{constructor(p,e,n,t,i){super(),this.plugin=p,this.docId=e,this.chunkId=n,this.startLine=t,this.excluded=i}eq(p){return this.docId===p.docId&&this.chunkId===p.chunkId&&this.startLine===p.startLine&&this.excluded===p.excluded}toDOM(){let p=document.createElement("span");p.className="zrr-chunk-toolbar",p.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},n=(c,d,_)=>{let u=document.createElement("span");u.className="zrr-chunk-button-icon",(0,Pn.setIcon)(u,d);let m=document.createElement("span");m.className="zrr-chunk-button-label",m.textContent=_,c.appendChild(u),c.appendChild(m)},t=document.createElement("button");t.type="button",t.className="zrr-chunk-button",n(t,"sparkles","Clean"),e(t,"Clean this chunk with the OCR cleanup model"),t.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),p.appendChild(t);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",n(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),p.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",n(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),p.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",n(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),p.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return n(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),p.appendChild(s),p}ignoreEvent(){return!0}},kn=(g,p)=>{var y;let e=g.state.doc,n=De(e);if(!n)return ee.Decoration.none;let t=g.state.selection.main.head,i=e.lineAt(t).number,r=yn(e,i);if(!r)return ee.Decoration.none;let a=r.text.match(ce);if(!a)return ee.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return ee.Decoration.none;let l=o[2].trim();if(!l)return ee.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=bn(e,r.startLine+1,r.endLine-1),_=c||d,u=e.line(r.startLine),m=ee.Decoration.widget({widget:new on(p,n,l,r.startLine,_),side:1});return ee.Decoration.set([m.range(u.to)])},ln=class extends ee.WidgetType{constructor(p,e){super(),this.info=p,this.totalPages=e}toDOM(){var p;return(p=_t(this.info,this.totalPages))!=null?p:document.createElement("span")}},vn=g=>{var o,l;let p=g.dom.closest(".markdown-source-view");if(!p||!p.classList.contains("is-live-preview"))return ee.Decoration.none;let e=g.state.doc,n=new wn.RangeSetBuilder,t=[],i=[],r=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),_=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!_)continue;let u=mn(_[1]);u&&(u.type==="chunk-start"?(u.chunkKind=(o=u.chunkKind)!=null?o:u.pageNumber?"page":"section",u.pageNumber&&(r=!0),u.chunkKind==="section"&&(a=!0)):u.type==="chunk-end"&&(u.chunkKind=(l=u.chunkKind)!=null?l:"section"),t.push({line:c,from:d.from,to:d.to,info:u}),u.pageNumber&&i.push(u.pageNumber))}if(!t.length)return ee.Decoration.none;if(r&&!a)for(let c of t)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let c of t){let d=ee.Decoration.replace({widget:new ln(c.info,s)});n.add(c.from,c.to,d)}return n.finish()},An=()=>ee.ViewPlugin.fromClass(class{constructor(g){this.decorations=vn(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=vn(g.view))}},{decorations:g=>g.decorations}),Cn=g=>ee.ViewPlugin.fromClass(class{constructor(p){this.decorations=kn(p,g)}update(p){(p.docChanged||p.selectionSet||p.viewportChanged)&&(this.decorations=kn(p.view,g))}},{decorations:p=>p.decorations});var ne=require("child_process"),G=require("fs"),et=pe(require("http")),nt=pe(require("https")),Ae=pe(require("net")),Ce=pe(require("os")),tt=pe(require("tls")),E=pe(require("path")),fn=require("url"),Se=require("crypto");var T=require("obsidian"),Sn=require("crypto"),Te=require("fs"),Oe=pe(require("path")),Y=".zotero-redisearch-rag",te=`${Y}/items`,H=`${Y}/chunks`,En=`${Y}/metadata_snapshots.json`,Rn=`${Y}/annotation_snapshots.json`,gt="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",Fe={pythonRuntime:"worker",pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"BAAI/bge-reranker-v2-m3",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${Y}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Ie=class extends T.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async f=>{this.plugin.settings.llmProviderProfiles=f,await this.plugin.saveSettings()},i=f=>{f.inputEl.type="password",f.inputEl.autocomplete="off",f.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:f=>{f.createEl("h2",{text:"Prerequisites"});let v=null,x=null,w=null,R=null,A=null,S=null,L=null,z=(N,q)=>{if(!N)return;N.settingEl.classList.toggle("is-disabled",q),N.settingEl.style.opacity=q?"0.55":"";let U=N.settingEl.querySelector(".setting-item-description");U&&(U.style.color=q?"var(--text-faint)":"")},O=()=>{let N=this.plugin.settings.pythonRuntime==="local";R==null||R.setDisabled(!N),A==null||A.setDisabled(!N),L==null||L.setDisabled(!N),S&&(S.disabled=!N),z(v,!N),z(x,!N),z(w,!N)};new T.Setting(f).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(N=>N.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async q=>{this.plugin.settings.dockerPath=q.trim()||"docker",await this.plugin.saveSettings()})),new T.Setting(f).setName("Python runtime").setDesc("Recommended: Worker container (Docker/Podman Compose). Local interpreter mode is optional.").addDropdown(N=>{N.addOption("worker","Python worker container (recommended)"),N.addOption("local","Local interpreter/venv"),N.setValue(this.plugin.settings.pythonRuntime).onChange(async q=>{q!=="worker"&&q!=="local"||(this.plugin.settings.pythonRuntime=q,await this.plugin.saveSettings(),O())})}),v=new T.Setting(f).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(N=>(R=N,N.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async q=>{this.plugin.settings.pythonPath=q.trim(),await this.plugin.saveSettings()}))),x=new T.Setting(f).setName("Python environment").setDesc("Local mode: create or update the plugin's Python env. Worker mode: managed by Docker startup.").addButton(N=>{L=N,S=N.buttonEl,N.setButtonText("Create/Update").setCta(),N.onClick(async()=>{N.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{N.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),w=new T.Setting(f).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(N=>{A=N,N.addOption("shared","Shared user cache"),N.addOption("plugin","Plugin folder (.venv)"),N.setValue(this.plugin.settings.pythonEnvLocation).onChange(async q=>{q!=="shared"&&q!=="plugin"||(this.plugin.settings.pythonEnvLocation=q,await this.plugin.saveSettings())})}),O(),new T.Setting(f).setName("Redis URL").addText(N=>N.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async q=>{this.plugin.settings.redisUrl=q.trim(),await this.plugin.saveSettings()}));let j=null,F=null,M=null,$=null,I=()=>{let N=this.plugin.settings.autoAssignRedisPort;M==null||M.setDisabled(N),$==null||$.setDisabled(N),j==null||j.settingEl.classList.toggle("is-disabled",N),F==null||F.settingEl.classList.toggle("is-disabled",N)};new T.Setting(f).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(N=>N.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async q=>{this.plugin.settings.autoAssignRedisPort=q,await this.plugin.saveSettings(),I()})),j=new T.Setting(f).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(N=>(M=N,N.setPlaceholder("~/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async q=>{this.plugin.settings.redisDataDirOverride=q.trim(),await this.plugin.saveSettings()}))),j.settingEl.addClass("zrr-redis-override-setting"),F=new T.Setting(f).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(N=>($=N,N.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async q=>{this.plugin.settings.redisProjectName=q.trim(),await this.plugin.saveSettings()}))),F.settingEl.addClass("zrr-redis-override-setting"),I(),new T.Setting(f).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(N=>N.setValue(this.plugin.settings.autoStartRedis).onChange(async q=>{this.plugin.settings.autoStartRedis=q,await this.plugin.saveSettings()})),new T.Setting(f).setName("Start Redis stack now").setDesc("Starts or restarts Redis stack (and Python worker in worker mode).").addButton(N=>N.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:f=>{f.createEl("h2",{text:"Zotero Local API"}),new T.Setting(f).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(A=>A.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async S=>{this.plugin.settings.zoteroBaseUrl=S.trim(),await this.plugin.saveSettings()}));let v=new T.Setting(f).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),x=null,w=A=>{if(!x)return;let S=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(A.map(z=>z.value)).has(S)||(A=A.concat([{value:S,label:`Custom (${S})`}])),x.selectEl.options.length=0;for(let z of A)x.addOption(z.value,z.label);x.setValue(S)},R=async()=>{if(x){x.setDisabled(!0);try{let A=await this.plugin.fetchZoteroLibraryOptions();w(A)}finally{x.setDisabled(!1)}}};v.addDropdown(A=>{x=A;let S=(this.plugin.settings.zoteroUserId||"0").trim()||"0";A.addOption(S,"Loading..."),A.setValue(S),A.onChange(async L=>{this.plugin.settings.zoteroUserId=L.trim(),await this.plugin.saveSettings()})}),v.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await R()})}),R(),f.createEl("h2",{text:"Zotero Web API"}),new T.Setting(f).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(A=>A.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async S=>{this.plugin.settings.webApiBaseUrl=S.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(A=>A.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async S=>{this.plugin.settings.webApiLibraryType=S,await this.plugin.saveSettings()})),new T.Setting(f).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(A=>A.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async S=>{this.plugin.settings.webApiLibraryId=S.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(A=>{i(A),A.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async S=>{this.plugin.settings.webApiKey=S.trim(),await this.plugin.saveSettings()})}),f.createEl("h2",{text:"Output"}),new T.Setting(f).setName("PDF folder").addText(A=>A.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async S=>{this.plugin.settings.outputPdfDir=S.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("Notes folder").addText(A=>A.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async S=>{this.plugin.settings.outputNoteDir=S.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(A=>{A.setValue(this.plugin.settings.frontmatterTemplate).onChange(async S=>{this.plugin.settings.frontmatterTemplate=S,await this.plugin.saveSettings()}),A.inputEl.rows=10,A.inputEl.style.width="100%"}),new T.Setting(f).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(A=>A.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async S=>{this.plugin.settings.tagSanitizeMode=S,await this.plugin.saveSettings()})),new T.Setting(f).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(A=>{A.setValue(this.plugin.settings.noteBodyTemplate).onChange(async S=>{this.plugin.settings.noteBodyTemplate=S,await this.plugin.saveSettings()}),A.inputEl.rows=8,A.inputEl.style.width="100%"}),new T.Setting(f).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(A=>A.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async S=>{this.plugin.settings.chatOutputDir=S.trim()||"zotero/chats",await this.plugin.saveSettings()})),new T.Setting(f).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(A=>A.setValue(this.plugin.settings.copyPdfToVault).onChange(async S=>{this.plugin.settings.copyPdfToVault=S,!S&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new T.Setting(f).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(A=>{let S=this.plugin.settings.copyPdfToVault;A.setValue(S?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!S).onChange(async L=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=L,await this.plugin.saveSettings()})}),new T.Setting(f).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(A=>A.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async S=>{this.plugin.settings.preferObsidianNoteForCitations=S,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:f=>{f.createEl("h2",{text:"Annotations"}),new T.Setting(f).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(R=>R.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async A=>{this.plugin.settings.annotationPageLabel=A.trim()||"Page",await this.plugin.saveSettings()})),new T.Setting(f).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(R=>R.setValue(this.plugin.settings.includeAnnotationImages).onChange(async A=>{this.plugin.settings.includeAnnotationImages=A,await this.plugin.saveSettings()})),f.createEl("h3",{text:"Zotero companion"}),f.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new T.Setting(f).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(R=>R.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async A=>{this.plugin.settings.zoteroCompanionEnabled=A,await this.plugin.saveSettings()})),new T.Setting(f).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(R=>R.setPlaceholder("http://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async A=>{this.plugin.settings.zoteroCompanionBaseUrl=A.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(R=>{i(R),this.companionTokenInput=R,R.setPlaceholder("optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async A=>{this.plugin.settings.zoteroCompanionToken=A.trim(),await this.plugin.saveSettings()})}),new T.Setting(f).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero Companion Plugin token to this value.").addButton(R=>R.setButtonText("Generate token").onClick(async()=>{let A=(0,Sn.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=A,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(A);try{await navigator.clipboard.writeText(A),new T.Notice("Generated and copied companion token.")}catch(S){new T.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",S)}})),f.createEl("h3",{text:"Annotation color map"}),f.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let v=f.createDiv({cls:"zrr-annotation-map"}),x=async R=>{this.plugin.settings.annotationColorMap=R,await this.plugin.saveSettings()},w=()=>{var O,j;v.empty();let R=this.plugin.settings.annotationColorMap||{},A=Object.entries(R);if(A.length||v.createEl("p",{text:"No color mappings configured."}),A.length){let F=v.createDiv({cls:"zrr-annotation-map-row-header"});F.createEl("span",{text:"Color"}),F.createEl("span",{text:"Heading"}),F.createEl("span",{text:"Callout"}),F.createEl("span")}for(let[F,M]of A){let I=v.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),N=I.createEl("input",{type:"text",value:F,cls:"zrr-annotation-map-input"}),q=I.createEl("input",{type:"text",value:(O=M.heading)!=null?O:"",cls:"zrr-annotation-map-input"}),U=I.createEl("input",{type:"text",value:(j=M.callout)!=null?j:"",cls:"zrr-annotation-map-input"}),J=I.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});J.type="button",N.addEventListener("change",async()=>{let Z=N.value.trim().toLowerCase();if(!Z){N.value=F;return}let Q={...this.plugin.settings.annotationColorMap||{}};if(Z!==F&&Q[Z]){new T.Notice(`Annotation color '${Z}' already exists.`),N.value=F;return}let X=Q[F];delete Q[F],Q[Z]=X!=null?X:{heading:"",callout:""},await x(Q),w()}),q.addEventListener("change",async()=>{var X;let Z={...this.plugin.settings.annotationColorMap||{}},Q=(X=Z[F])!=null?X:{heading:"",callout:""};Q.heading=q.value.trim(),Z[F]=Q,await x(Z)}),U.addEventListener("change",async()=>{var X;let Z={...this.plugin.settings.annotationColorMap||{}},Q=(X=Z[F])!=null?X:{heading:"",callout:""};Q.callout=U.value.trim(),Z[F]=Q,await x(Z)}),J.addEventListener("click",async()=>{let Z={...this.plugin.settings.annotationColorMap||{}};delete Z[F],await x(Z),w()})}let S=v.createDiv({cls:"zrr-annotation-map-actions"}),L=S.createEl("button",{text:"Add mapping"});L.type="button",L.addEventListener("click",async()=>{let F={...this.plugin.settings.annotationColorMap||{}},M="new-color",$=1;for(;F[M];)M=`new-color-${$}`,$+=1;F[M]={heading:"",callout:""},await x(F),w()});let z=S.createEl("button",{text:"Reset to defaults"});z.type="button",z.addEventListener("click",async()=>{await x({...Fe.annotationColorMap}),w()})};w()}},{id:"ocr",label:"OCR",render:f=>{f.createEl("h2",{text:"Docling"});let v=null,x=S=>{if(!v)return;let L=this.plugin.settings.ocrEngine;new Set(S.map(O=>O.value)).has(L)||(S=S.concat([{value:L,label:`Current (unavailable): ${L}`}])),v.selectEl.options.length=0;for(let O of S)v.addOption(O.value,O.label);v.setValue(L)},w=async()=>{if(!v)return;v.setDisabled(!0);let S={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{S=await this.plugin.detectOcrEngines()}catch(O){S={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let L=[{value:"auto",label:"Auto (default)"}];S.tesseract&&L.push({value:"tesseract",label:"Tesseract (local)"}),S.paddleStructureLocal&&L.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),S.paddleVlLocal&&L.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(L.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),L.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),x(L),v.setDisabled(!1)},R=new T.Setting(f).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),A=document.createElement("a");A.href="https://aistudio.baidu.com/paddleocr",A.textContent="https://aistudio.baidu.com/paddleocr",A.target="_blank",A.rel="noopener noreferrer",R.descEl.appendChild(A),R.descEl.append("."),R.addText(S=>{i(S),S.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async L=>{this.plugin.settings.paddleApiKey=L.trim(),await this.plugin.saveSettings(),await w()})}),new T.Setting(f).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(S=>S.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async L=>{this.plugin.settings.paddleVlApiUrl=L.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(S=>S.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async L=>{this.plugin.settings.paddleStructureApiUrl=L.trim(),await this.plugin.saveSettings(),await w()})),new T.Setting(f).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(S=>{v=S,S.addOption("auto","Auto (default)"),S.setValue(this.plugin.settings.ocrEngine),S.onChange(async L=>{this.plugin.settings.ocrEngine=L,await this.plugin.saveSettings()})}),new T.Setting(f).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(S=>S.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async L=>{this.plugin.settings.ocrMode=L,await this.plugin.saveSettings()})),new T.Setting(f).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(S=>S.setValue(this.plugin.settings.forcePerPageOcr).onChange(async L=>{this.plugin.settings.forcePerPageOcr=L,await this.plugin.saveSettings()})),new T.Setting(f).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(S=>{S.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async L=>{this.plugin.settings.ocrQualityThreshold=L,await this.plugin.saveSettings()})}),new T.Setting(f).setName("Chunking").setDesc("page or section").addDropdown(S=>S.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async L=>{this.plugin.settings.chunkingMode=L,await this.plugin.saveSettings()})),w()}},{id:"llms",label:"LLMs",render:f=>{f.createEl("h2",{text:"LLM Provider Profiles"});let v=f.createDiv({cls:"zrr-llm-profiles"}),x=()=>{v.empty();let k=n();k.length||v.createEl("p",{text:"No profiles yet. Add one below."});for(let P of k){let D=v.createEl("details",{cls:"zrr-profile"});k.length===1&&(D.open=!0);let W=D.createEl("summary",{text:P.name||P.id||"Profile"});W.addClass("zrr-profile-title");let Re=D.createDiv({cls:"zrr-profile-body"});new T.Setting(Re).setName("Profile name").addText(le=>le.setPlaceholder("My provider").setValue(P.name||"").onChange(async de=>{P.name=de.trim(),W.textContent=P.name||P.id||"Profile",await t(n())})),new T.Setting(Re).setName("Base URL").addText(le=>le.setPlaceholder("http://localhost:1234/v1").setValue(P.baseUrl||"").onChange(async de=>{P.baseUrl=de.trim(),await t(n())})),new T.Setting(Re).setName("API key").setDesc("Stored in settings (not encrypted).").addText(le=>{i(le),le.setPlaceholder("sk-...").setValue(P.apiKey||"").onChange(async de=>{P.apiKey=de.trim(),await t(n())})}),new T.Setting(Re).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(le=>le.setButtonText("Delete profile").onClick(async()=>{let de=n().filter(it=>it.id!==P.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===P.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===P.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===P.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(de),x()}))}new T.Setting(v).addButton(P=>P.setButtonText("Add profile").onClick(async()=>{let D=`profile-${Date.now().toString(36)}`,W=n().concat([{id:D,name:"Custom",baseUrl:"",apiKey:""}]);await t(W),x()}))};x(),f.createEl("h2",{text:"OCR cleanup"}),new T.Setting(f).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(k=>k.setValue(this.plugin.settings.enableLlmCleanup).onChange(async P=>{this.plugin.settings.enableLlmCleanup=P,await this.plugin.saveSettings()}));let w=null,R=null,A=null,S=async()=>{},L=async(k,P=!0)=>{let D=k.trim();this.plugin.settings.llmCleanupBaseUrl=D,P&&(this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom")),R&&R.setValue(D),await this.plugin.saveSettings()},z=async k=>{let P=n().find(D=>D.id===k);this.plugin.settings.llmCleanupProviderProfileId=k,P&&(this.plugin.settings.llmCleanupBaseUrl=P.baseUrl,this.plugin.settings.llmCleanupApiKey=P.apiKey,R==null||R.setValue(P.baseUrl),A==null||A.setValue(P.apiKey)),await this.plugin.saveSettings(),await S()};new T.Setting(f).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{w=k,k.addOption("custom","Custom (manual)");for(let D of n())k.addOption(D.id,D.name||D.id);let P=this.plugin.settings.llmCleanupProviderProfileId;k.setValue(P&&n().some(D=>D.id===P)?P:"custom"),k.onChange(async D=>{if(D==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await z(D)})}),new T.Setting(f).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(k=>{R=k,k.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async P=>{await L(P)})}),new T.Setting(f).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(k=>{A=k,i(k),k.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async P=>{this.plugin.settings.llmCleanupApiKey=P.trim(),this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom"),await this.plugin.saveSettings()})});let O=new T.Setting(f).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),j=null,F=k=>{if(!j)return;let P=(this.plugin.settings.llmCleanupModel||"").trim(),D=new Set(k.map(W=>W.value));P&&!D.has(P)&&(k=k.concat([{value:P,label:`Custom (${P})`}])),j.selectEl.options.length=0;for(let W of k)j.addOption(W.value,W.label);P&&j.setValue(P)};S=async()=>{if(j){j.setDisabled(!0);try{let k=await this.plugin.fetchCleanupModelOptions();F(k)}finally{j.setDisabled(!1)}}},O.addDropdown(k=>{j=k;let P=(this.plugin.settings.llmCleanupModel||"").trim();k.addOption(P||"loading","Loading..."),k.setValue(P||"loading"),k.onChange(async D=>{this.plugin.settings.llmCleanupModel=D.trim(),await this.plugin.saveSettings()})}),O.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),new T.Setting(f).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(k=>k.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async P=>{let D=Number.parseFloat(P);this.plugin.settings.llmCleanupTemperature=Number.isFinite(D)?D:0,await this.plugin.saveSettings()})),new T.Setting(f).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(k=>k.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async P=>{this.plugin.settings.llmCleanupMinQuality=P,await this.plugin.saveSettings()})),new T.Setting(f).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(k=>k.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(D)?D:2e3,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Text Embedding"});let M=null,$=null,I=null,N=async()=>{},q=async(k,P=!0)=>{let D=k.trim();this.plugin.settings.embedBaseUrl=D,P&&(this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom")),$&&$.setValue(D),await this.plugin.saveSettings()},U=async k=>{let P=n().find(D=>D.id===k);this.plugin.settings.embedProviderProfileId=k,P&&(this.plugin.settings.embedBaseUrl=P.baseUrl,this.plugin.settings.embedApiKey=P.apiKey,$==null||$.setValue(P.baseUrl),I==null||I.setValue(P.apiKey)),await this.plugin.saveSettings(),await N()};new T.Setting(f).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{M=k,k.addOption("custom","Custom (manual)");for(let D of n())k.addOption(D.id,D.name||D.id);let P=this.plugin.settings.embedProviderProfileId;k.setValue(P&&n().some(D=>D.id===P)?P:"custom"),k.onChange(async D=>{if(D==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await U(D)})}),new T.Setting(f).setName("Embeddings base URL").addText(k=>{$=k,k.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async P=>{await q(P)})}),new T.Setting(f).setName("Embeddings API key").addText(k=>{I=k,i(k),k.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async P=>{this.plugin.settings.embedApiKey=P.trim(),this.plugin.settings.embedProviderProfileId="",M&&M.setValue("custom"),await this.plugin.saveSettings()})});let J=new T.Setting(f).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),Z=null,Q=k=>{if(!Z)return;let P=(this.plugin.settings.embedModel||"").trim(),D=new Set(k.map(W=>W.value));P&&!D.has(P)&&(k=k.concat([{value:P,label:`Custom (${P})`}])),Z.selectEl.options.length=0;for(let W of k)Z.addOption(W.value,W.label);P&&Z.setValue(P)};N=async()=>{if(Z){Z.setDisabled(!0);try{let k=await this.plugin.fetchEmbeddingModelOptions();Q(k)}finally{Z.setDisabled(!1)}}},J.addDropdown(k=>{Z=k;let P=(this.plugin.settings.embedModel||"").trim();k.addOption(P||"loading","Loading..."),k.setValue(P||"loading"),k.onChange(async D=>{this.plugin.settings.embedModel=D.trim(),await this.plugin.saveSettings()})}),J.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await N()})}),N(),new T.Setting(f).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(k=>k.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async P=>{this.plugin.settings.embedIncludeMetadata=P,await this.plugin.saveSettings()})),new T.Setting(f).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(k=>k.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedContextWindow=Number.isFinite(D)?Math.max(0,D):1,await this.plugin.saveSettings()})),new T.Setting(f).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(k=>k.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedContextChars=Number.isFinite(D)?Math.max(0,D):220,await this.plugin.saveSettings()})),new T.Setting(f).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(k=>k.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(D)?Math.max(0,D):3500,await this.plugin.saveSettings()})),new T.Setting(f).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(k=>k.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(D)?Math.max(0,D):200,await this.plugin.saveSettings()})),new T.Setting(f).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(k=>k.setValue(this.plugin.settings.enableChunkTagging).onChange(async P=>{this.plugin.settings.enableChunkTagging=P,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Chat LLM"});let X=null,ie=null,se=null,ge=async()=>{},nn=async(k,P=!0)=>{let D=k.trim();this.plugin.settings.chatBaseUrl=D,P&&(this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom")),ie&&ie.setValue(D),await this.plugin.saveSettings()},tn=async k=>{let P=n().find(D=>D.id===k);this.plugin.settings.chatProviderProfileId=k,P&&(this.plugin.settings.chatBaseUrl=P.baseUrl,this.plugin.settings.chatApiKey=P.apiKey,ie==null||ie.setValue(P.baseUrl),se==null||se.setValue(P.apiKey)),await this.plugin.saveSettings(),await ge()};new T.Setting(f).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(k=>{X=k,k.addOption("custom","Custom (manual)");for(let D of n())k.addOption(D.id,D.name||D.id);let P=this.plugin.settings.chatProviderProfileId;k.setValue(P&&n().some(D=>D.id===P)?P:"custom"),k.onChange(async D=>{if(D==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await tn(D)})}),new T.Setting(f).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(k=>{ie=k,k.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async P=>{await nn(P)})}),new T.Setting(f).setName("Chat API key").addText(k=>{se=k,i(k),k.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async P=>{this.plugin.settings.chatApiKey=P.trim(),this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom"),await this.plugin.saveSettings()})});let Ee=new T.Setting(f).setName("Chat model").setDesc("Select a chat-capable model from the provider."),re=null,rn=k=>{if(!re)return;let P=(this.plugin.settings.chatModel||"").trim(),D=new Set(k.map(W=>W.value));P&&!D.has(P)&&(k=k.concat([{value:P,label:`Custom (${P})`}])),re.selectEl.options.length=0;for(let W of k)re.addOption(W.value,W.label);P&&re.setValue(P)};ge=async()=>{if(re){re.setDisabled(!0);try{let k=await this.plugin.fetchChatModelOptions();rn(k)}finally{re.setDisabled(!1)}}},Ee.addDropdown(k=>{re=k;let P=(this.plugin.settings.chatModel||"").trim();k.addOption(P||"loading","Loading..."),k.setValue(P||"loading"),k.onChange(async D=>{this.plugin.settings.chatModel=D.trim(),await this.plugin.saveSettings()})}),Ee.addButton(k=>{k.setButtonText("Refresh").onClick(async()=>{await ge()})}),ge(),new T.Setting(f).setName("Temperature").addText(k=>k.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async P=>{let D=Number.parseFloat(P);this.plugin.settings.chatTemperature=Number.isFinite(D)?D:.2,await this.plugin.saveSettings()})),new T.Setting(f).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(k=>k.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(D)?Math.max(0,D):6,await this.plugin.saveSettings()})),new T.Setting(f).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(k=>k.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async P=>{this.plugin.settings.chatPaneLocation=P,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Retrieval"}),new T.Setting(f).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(k=>k.setValue(this.plugin.settings.enableAgenticRag).onChange(async P=>{this.plugin.settings.enableAgenticRag=P,await this.plugin.saveSettings()})),new T.Setting(f).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(k=>k.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.agenticMaxIters=Number.isFinite(D)?Math.max(1,D):2,await this.plugin.saveSettings()})),new T.Setting(f).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(k=>k.setValue(this.plugin.settings.enableQueryExpansion).onChange(async P=>{this.plugin.settings.enableQueryExpansion=P,await this.plugin.saveSettings()})),new T.Setting(f).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(k=>k.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.queryExpansionCount=Number.isFinite(D)?Math.max(1,D):3,await this.plugin.saveSettings()})),new T.Setting(f).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(k=>k.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async P=>{this.plugin.settings.enableCrossEncoderRerank=P,await this.plugin.saveSettings()})),new T.Setting(f).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(k=>k.setPlaceholder("BAAI/bge-reranker-v2-m3").setValue(this.plugin.settings.rerankModel).onChange(async P=>{this.plugin.settings.rerankModel=P.trim()||"BAAI/bge-reranker-v2-m3",await this.plugin.saveSettings()})),new T.Setting(f).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(k=>k.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(D)?Math.max(1,D):4,await this.plugin.saveSettings()})),new T.Setting(f).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(k=>k.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.rrfK=Number.isFinite(D)?Math.max(1,D):60,await this.plugin.saveSettings()})),new T.Setting(f).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(k=>k.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.rrfLogTop=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()})),new T.Setting(f).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(k=>k.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:f=>{f.createEl("h2",{text:"Logging"}),new T.Setting(f).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(v=>v.setValue(this.plugin.settings.enableFileLogging).onChange(async x=>{this.plugin.settings.enableFileLogging=x,await this.plugin.saveSettings()})),new T.Setting(f).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(v=>v.setPlaceholder(`${Y}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async x=>{this.plugin.settings.logFilePath=x.trim()||`${Y}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new T.Setting(f).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(v=>v.setButtonText("Open log").onClick(async()=>{var x,w;await((w=(x=this.plugin).openLogFile)==null?void 0:w.call(x))})).addButton(v=>v.setButtonText("Clear log").onClick(async()=>{var x,w;await((w=(x=this.plugin).clearLogFile)==null?void 0:w.call(x))})),f.createEl("h2",{text:"Zotero Companion Plugin"}),f.createEl("p",{text:"Download the XPI, then in Zotero go to Tools \u2192 Add-ons \u2192 Install from File and restart."}),new T.Setting(f).setName("Download companion add-on").setDesc("Downloads the companion XPI to your system Downloads folder.").addButton(v=>v.setButtonText("Download XPI").onClick(async()=>{let x=this.getDefaultDownloadDir();if(!x){new T.Notice("Unable to resolve the system Downloads folder.");return}let w=Oe.default.join(x,"zrr-companion.xpi");if(await this.companionXpiExists(w)){new T.Notice(`Companion XPI already exists: ${w}`);return}new T.Notice("Downloading companion XPI..."),await this.downloadCompanionXpi(w)})),new T.Setting(f).setName("Open Zotero").setDesc("Launch Zotero and open the Add-ons window (Tools \u2192 Add-ons).").addButton(v=>v.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new T.Setting(f).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(v=>v.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),f.createEl("h2",{text:"Redis Indexing"}),new T.Setting(f).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(v=>v.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new T.Setting(f).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(v=>v.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(v=>v.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],_=new Map,u=new Map,m=f=>{this.activeTab=f;for(let[v,x]of _){let w=v===f;x.classList.toggle("is-active",w),x.setAttribute("aria-selected",w?"true":"false"),x.setAttribute("tabindex",w?"0":"-1")}for(let[v,x]of u){let w=v===f;x.classList.toggle("is-active",w),x.hidden=!w}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let b=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let f of d){let v=y.createEl("button",{text:f.label,cls:"zrr-settings-tab-button"}),x=`zrr-settings-tab-${f.id}`,w=`zrr-settings-panel-${f.id}`;v.type="button",v.id=x,v.setAttribute("role","tab"),v.setAttribute("aria-controls",w),v.setAttribute("aria-selected","false"),v.addEventListener("click",()=>m(f.id));let R=b.createDiv({cls:"zrr-settings-tab-panel"});R.id=w,R.setAttribute("role","tabpanel"),R.setAttribute("aria-labelledby",x),R.hidden=!0,f.render(R),_.set(f.id,v),u.set(f.id,R)}let C=d.some(f=>f.id===this.activeTab)?this.activeTab:d[0].id;m(C)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Oe.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await Te.promises.access(e),!0}catch(n){return!1}}async downloadCompanionXpi(e){try{await Te.promises.mkdir(Oe.default.dirname(e),{recursive:!0});let n=await(0,T.requestUrl)({url:gt,method:"GET"});if(n.status!==200){new T.Notice(`Failed to download companion XPI (HTTP ${n.status}).`);return}let t=Buffer.from(n.arrayBuffer);await Te.promises.writeFile(e,t),new T.Notice(`Downloaded companion XPI: ${e}`)}catch(n){new T.Notice("Failed to download companion XPI. See console for details."),console.warn("Failed to download companion XPI",n)}}};var Ln=require("@codemirror/state"),Nn=require("@codemirror/view"),oe=require("obsidian");var ft=g=>{let p=g.scrollDOM.getBoundingClientRect(),e=g.posAtCoords({x:p.left+8,y:+p.height*.25});return e===null?null:g.state.doc.lineAt(e).number},ze=class{constructor(p,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=p,this.helpers=e}createSyncExtension(){let p=this,e=this.helpers;return Nn.ViewPlugin.fromClass(class{constructor(n){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=n,this.docId=e.extractDocIdFromDoc(n.state.doc),this.onScroll=()=>this.scheduleSync(!1),n.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(n){n.docChanged&&(this.docId=e.extractDocIdFromDoc(n.view.state.doc),this.lastPage=null,this.lastChunkId=null),(n.docChanged||n.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(n){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,n)}))}syncPdfSidebar(n,t){var _,u;let i=this.docId;if(!i)return;let r=ft(n);if(r===null)return;let a=e.findChunkStartLineInDoc(n.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(_=s==null?void 0:s.pageNumber)!=null?_:null,l=(u=s==null?void 0:s.chunkId)!=null?u:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!t&&(c||d)||(this.lastPage=o,this.lastChunkId=l,p.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,n;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((n=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:n.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let p=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(p.docId,p.pageNumber,p.chunkId)}updatePreviewScrollHandler(){var t;let p=this.deps.app.workspace.getActiveViewOfType(oe.MarkdownView);if(!p||p.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(t=p.previewMode)==null?void 0:t.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let n=()=>this.schedulePreviewSync(p);e.addEventListener("scroll",n,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=n,this.schedulePreviewSync(p)}async syncPdfSidebarForFile(p){try{let e=await this.deps.app.vault.read(p),n=await this.deps.resolveDocIdForNote(p,e);if(!n)return;let t=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(n,t==null?void 0:t.pageNumber,t==null?void 0:t.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(p,e,n){if(p){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:p,pageNumber:e,chunkId:n};return}this.pdfSyncInFlight=!0;try{let t=await this.deps.getDocIndexEntry(p);t||(t=await this.deps.hydrateDocIndexFromCache(p));let i=t!=null&&t.pdf_path?String(t.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let d=(0,oe.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(d)instanceof oe.TFile&&(r=d)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof oe.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:n};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:n};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&n&&(o=await this.resolvePageNumberForChunk(p,n)),o===null||this.pdfSidebarDocId===p&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=p,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,c=o!==null?`${l}#page=${o}`:l;await this.openPdfLinkInLeaf(s,c),this.updatePdfSidebarIcon(s)}finally{this.pdfSyncInFlight=!1;let t=this.queuedPdfSync;this.queuedPdfSync=null,t&&this.syncPdfSidebarForDoc(t.docId,t.pageNumber,t.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(p){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(p)}))}syncPdfSidebarForPreview(p){let e=this.previewScrollEl;if(!e)return;let n=p.getViewData();if(!n)return;let t=Ln.Text.of(n.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(t);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(t,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(p){var t;let e=p.getBoundingClientRect().top,n=p.querySelectorAll("[data-line]");for(let i of Array.from(n))if(i.getBoundingClientRect().bottom>=e+2){let a=(t=i.getAttribute("data-line"))!=null?t:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var t,i;if(this.pdfSidebarLeaf&&((i=(t=this.pdfSidebarLeaf.view)==null?void 0:t.getViewType)==null?void 0:i.call(t))==="pdf")return this.pdfSidebarLeaf;let p=this.deps.app.workspace;if(typeof p.ensureSideLeaf=="function")try{let r=await p.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let n=this.deps.app.workspace.getRightLeaf(!0);return n&&this.isRightSidebarLeaf(n)?(this.pdfSidebarLeaf=n,this.updatePdfSidebarIcon(n),n):null}isRightSidebarLeaf(p){if(!p)return!1;let n=p.containerEl;return!!(n!=null&&n.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(p){if(!p||!this.isRightSidebarLeaf(p))return;let n=p.containerEl,t=[];n&&t.push(...Array.from(n.querySelectorAll(".view-header-icon")));let i=p;if(i.tabHeaderEl&&t.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&t.push(i.tabHeaderInnerIconEl),t.length===0)return;let r=new Set;for(let s of t)r.has(s)||(r.add(s),s.innerHTML="",(0,oe.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=p.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(p,e){var r,a,s;let n=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],t=(s=(a=n==null?void 0:n.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof t=="function")try{await t.call(n.lib.workspace,p,e,"",{active:!1});return}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150)}let i=p;if(typeof i.openLinkText=="function"){try{await i.openLinkText(e,"",{active:!1})}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150),await i.openLinkText(e,"",{active:!1})}return}await this.deps.app.workspace.openLinkText(e,"",!1)}isPdfAnnotationRaceError(p){let e=p instanceof Error?p.message:String(p!=null?p:"");return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(p){return new Promise(e=>setTimeout(e,p))}getPluginsRegistry(){var p;return(p=this.deps.app.plugins)==null?void 0:p.plugins}isLeafTabActive(p){var i;let e=p;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===p;let n=e.containerEl;if(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))return!0;let t=e.tabHeaderEl;return!!(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))}async resolvePageNumberForChunk(p,e){var l,c,d,_,u;if(!p||!e)return null;let n=this.deps.normalizeChunkIdForNote(e,p)||e,t=this.chunkPageCache.get(p);if(t&&t.has(n))return(l=t.get(n))!=null?l:null;let i=(0,oe.normalizePath)(`${H}/${p}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let m of s){let y=typeof(m==null?void 0:m.chunk_id)=="string"?m.chunk_id.trim():"";if(!y)continue;let b=Number.isFinite((c=m==null?void 0:m.page_start)!=null?c:NaN)?Number(m.page_start):null,C=Number.isFinite((d=m==null?void 0:m.page_end)!=null?d:NaN)?Number(m.page_end):null,f=b!=null?b:C;f!==null&&(o.set(y,f),o.set(`${p}:${y}`,f))}return this.chunkPageCache.set(p,o),(u=(_=o.get(n))!=null?_:o.get(e))!=null?u:null}};var Me={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var _e=require("@codemirror/state"),ae=require("@codemirror/view"),B=require("obsidian");var V=g=>{if(typeof g=="string")return g.trim();if(typeof g=="number"&&Number.isFinite(g))return String(g);if(Array.isArray(g))for(let p of g){if(typeof p=="string"&&p.trim())return p.trim();if(typeof p=="number"&&Number.isFinite(p))return String(p)}if(g&&typeof g=="object"){let p=g[0];if(typeof p=="string"&&p.trim())return p.trim();if(typeof p=="number"&&Number.isFinite(p))return String(p)}return""},Dn=g=>{let p=[g.key,g.itemKey,g.id,g.citationKey];for(let e of p)if(typeof e=="string"&&e.trim())return e.trim();return null},Tn=g=>{var e,n,t;let p=(t=(n=g.key)!=null?n:(e=g.data)==null?void 0:e.key)!=null?t:"";return typeof p=="string"?p:""},cn=g=>{if(!g)return"";let p=g.match(/\b(\d{4})\b/);return p?p[1]:""},On=g=>{var e,n,t,i;let p=(i=(t=(e=g.meta)==null?void 0:e.parsedDate)!=null?t:(n=g.data)==null?void 0:n.date)!=null?i:"";return typeof p!="string"?"":cn(p)},he=g=>{if(!g||typeof g!="object")return"";if(g.name)return String(g.name);let p=g.firstName?String(g.firstName):"",e=g.lastName?String(g.lastName):"";return[e,p].filter(Boolean).join(", ")||`${p} ${e}`.trim()},qe=(g,p)=>{let e=[p==null?void 0:p["citation-key"],p==null?void 0:p.citationKey,p==null?void 0:p.citationkey,p==null?void 0:p.citekey,p==null?void 0:p.citeKey,p==null?void 0:p.betterBibtexKey,p==null?void 0:p.betterbibtexkey,g["citation-key"],g.citationKey,g.citationkey,g.citekey,g.citeKey,g.betterBibtexKey,g.betterbibtexkey];for(let i of e){let r=V(i);if(r)return r}let n=typeof g.extra=="string"?g.extra:"";if(!n)return"";let t=n.split(/\r?\n/);for(let i of t){let r=i.match(/^\s*biblatexcitekey\s*\[([^\]]+)\]\s*$/i);if(r&&r[1])return r[1].trim();let a=i.match(/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:\s*(.+)\s*$/i);if(a&&a[2])return a[2].trim()}return""},dn=g=>{if(!g)return"";let p=[g["citation-key"],g.citationKey,g.citationkey,g.citekey,g.citation_key];for(let e of p){let n=V(e);if(n)return n}return""},In=g=>{var e,n;if(!g)return"";let p=(n=(e=g["title-short"])!=null?e:g.shortTitle)!=null?n:g.short_title;return typeof p=="string"?p.trim():""},me=g=>{let p=V(g.shortTitle);if(p)return p;let e=V(g.short_title);if(e)return e;let n=V(g["title-short"]);return n||""},Fn=g=>{let p=typeof g.extra=="string"?g.extra:"";if(!p)return"";let e=p.split(/\r?\n/);for(let t of e){let i=t.match(/^\s*doi\s*:\s*(.+)\s*$/i);if(i&&i[1])return i[1].trim().replace(/[.,;]+$/,"")}let n=p.match(/\b10\.\d{4,9}\/[-._;()/:A-Z0-9]+\b/i);return n?n[0].replace(/[.,;]+$/,""):""},zn=g=>{var e;if(!g)return"";let p=(e=g.DOI)!=null?e:g.doi;return typeof p=="string"?p.trim().replace(/[.,;]+$/,""):""},ht=g=>{if(!g)return[];let p=[g.attachments,g.children,g.items,g.attachment,g.allAttachments],e=[];for(let n of p)n&&(Array.isArray(n)?e.push(...n):typeof n=="object"&&e.push(n));return e},pn=g=>{var n,t,i,r,a,s,o,l,c,d,_,u,m,y,b;if(((s=(a=(i=(n=g==null?void 0:g.contentType)!=null?n:g==null?void 0:g.mimeType)!=null?i:(t=g==null?void 0:g.data)==null?void 0:t.contentType)!=null?a:(r=g==null?void 0:g.data)==null?void 0:r.mimeType)!=null?s:"")==="application/pdf")return!0;let e=(b=(y=(u=(_=(c=(o=g==null?void 0:g.filename)!=null?o:g==null?void 0:g.fileName)!=null?c:(l=g==null?void 0:g.data)==null?void 0:l.filename)!=null?_:(d=g==null?void 0:g.data)==null?void 0:d.fileName)!=null?u:g==null?void 0:g.path)!=null?y:(m=g==null?void 0:g.data)==null?void 0:m.path)!=null?b:"";return!!(typeof e=="string"&&e.toLowerCase().endsWith(".pdf"))},Mn=g=>{var n;let p=ht(g.data);if(p.length>0)return p.some(i=>pn(i))?"yes":"no";let e=(n=g.meta)==null?void 0:n.numChildren;return typeof e=="number"&&e===0?"no":"unknown"};var mt={artwork:"image",audioRecording:"music",bill:"file-text",blogPost:"globe",book:"book",bookSection:"book-open",case:"scale",computerProgram:"code",conferencePaper:"file-text",dataset:"database",dictionaryEntry:"book",document:"file-text",email:"mail",encyclopediaArticle:"book",film:"film",forumPost:"message-circle",hearing:"file-text",interview:"mic",journalArticle:"file-text",letter:"mail",magazineArticle:"file-text",manuscript:"file-text",map:"map",newspaperArticle:"file-text",patent:"award",podcast:"mic",preprint:"file-text",presentation:"file-text",radioBroadcast:"music",report:"file-text",statute:"scale",thesis:"graduation-cap",tvBroadcast:"film",videoRecording:"film",webpage:"globe"},qn=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],yt=g=>g.includes("STDERR")?"zrr-log-stderr":g.includes("ERROR")?"zrr-log-error":g.includes("WARNING")||g.includes("WARN")?"zrr-log-warning":g.includes("INFO")?"zrr-log-info":null,jn=g=>{let p=new _e.RangeSetBuilder;for(let{from:e,to:n}of g.visibleRanges){let t=e;for(;t<=n;){let i=g.state.doc.lineAt(t),r=yt(i.text);r&&p.add(i.from,i.from,ae.Decoration.line({class:r})),t=i.to+1}}return p.finish()},$n=ae.EditorView.theme({".cm-editor":{height:"100%",display:"flex",flexDirection:"column",minHeight:"0"},".cm-scroller":{fontFamily:"var(--font-monospace)",fontSize:"0.85rem",flex:"1",height:"100%",maxHeight:"100%",overflow:"auto"},".zrr-log-error":{color:"var(--text-error)"},".zrr-log-warning":{color:"var(--text-accent)"},".zrr-log-info":{color:"var(--text-muted)"},".zrr-log-stderr":{color:"var(--text-accent)"}}),Vn=ae.ViewPlugin.fromClass(class{constructor(g){this.decorations=jn(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=jn(g.view))}},{decorations:g=>g.decorations}),ke=class extends B.Modal{constructor(p,e,n,t,i="Value cannot be empty."){super(p),this.titleText=e,this.placeholder=n,this.onSubmit=t,this.emptyMessage=i}onOpen(){let{contentEl:p}=this;p.empty(),p.createEl("h3",{text:this.titleText});let e=p.createEl("input",{type:"text",placeholder:this.placeholder});e.style.width="100%",e.focus();let n=p.createEl("button",{text:"Submit"});n.style.marginTop="0.75rem";let t=()=>{let i=e.value.trim();if(!i){new B.Notice(this.emptyMessage);return}this.close(),this.onSubmit(i)};n.addEventListener("click",t),e.addEventListener("keydown",i=>{i.key==="Enter"&&t()})}},je=class extends B.Modal{constructor(p,e,n){super(p),this.version=e,this.entries=n}onOpen(){let{contentEl:p}=this;if(p.empty(),p.addClass("zrr-release-notes-modal"),p.createEl("h3",{text:`What's new in v${this.version}`}),this.entries.length>0){let t=p.createEl("ul",{cls:"zrr-release-notes-list"});for(let i of this.entries)t.createEl("li",{text:i})}else p.createEl("p",{text:"This version includes improvements and fixes. See CHANGELOG.md in the plugin folder for details."});p.createEl("div",{cls:"zrr-release-notes-actions"}).createEl("button",{text:"Close"}).addEventListener("click",()=>this.close())}},$e=class extends B.Modal{constructor(p,e,n,t,i){super(p),this.chunkId=e,this.initialTags=n,this.onSubmit=t,this.onRegenerate=i}onOpen(){let{contentEl:p}=this;p.empty(),p.createEl("h3",{text:`Edit tags for ${this.chunkId}`});let e=p.createEl("textarea",{attr:{rows:"3"}});e.style.width="100%",e.placeholder="tag1, tag2, tag3",e.value=this.initialTags.join(", "),e.focus();let n=p.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Save tags"}),i=async()=>{let a=(e.value||"").split(/[,;\n]+/).map(o=>o.trim()).filter(o=>o.length>0),s=Array.from(new Set(a));this.close(),await Promise.resolve(this.onSubmit(s))};if(this.onRegenerate){let r=n.createEl("button",{text:"Regenerate"});r.addEventListener("click",async()=>{var a;r.setAttribute("disabled","true"),t.setAttribute("disabled","true");try{let s=await((a=this.onRegenerate)==null?void 0:a.call(this));s&&s.length>0?(e.value=s.join(", "),await Promise.resolve(this.onSubmit(s))):s&&new B.Notice("No tags were generated.")}finally{r.removeAttribute("disabled"),t.removeAttribute("disabled")}})}t.addEventListener("click",i),e.addEventListener("keydown",r=>{r.key==="Enter"&&(r.metaKey||r.ctrlKey)&&i()})}},Ve=class extends B.Modal{constructor(p,e,n,t=""){super(p),this.titleText=e,this.content=n,this.noteText=t}onOpen(){let{contentEl:p}=this;if(p.empty(),p.createEl("h3",{text:this.titleText}),this.noteText){let n=p.createEl("div",{text:this.noteText});n.className="zrr-indexed-note"}let e=p.createEl("textarea",{attr:{rows:"12",readonly:"true"}});e.style.width="100%",e.value=this.content}},Ze=class extends B.Modal{constructor(e,n,t=""){super(e);this.bodyText="";this.plugin=n,this.initialTerm=t}onOpen(){let{contentEl:e}=this;e.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),e.style.display="flex",e.style.flexDirection="column",e.style.height="100%",e.style.overflow="hidden",e.style.minHeight="0";let n=e.createDiv();n.style.display="flex",n.style.alignItems="center",n.style.justifyContent="space-between",n.style.gap="0.5rem",n.createEl("h3",{text:"Redis index search"});let t=n.createEl("button",{text:"Copy All"});t.style.marginLeft="auto",t.addEventListener("click",()=>{this.copyResultsToClipboard()});let i=e.createDiv();i.style.display="flex",i.style.alignItems="center",i.style.gap="0.5rem",i.style.margin="0.5rem 0";let r=i.createEl("input");r.type="text",r.placeholder="Search term",r.value=this.initialTerm,r.style.flex="1",r.style.minWidth="0",this.inputEl=r,i.createEl("button",{text:"Search"}).addEventListener("click",()=>{this.runSearch()}),r.addEventListener("keydown",c=>{c.key==="Enter"&&(c.preventDefault(),this.runSearch())});let s=e.createDiv();s.style.color="var(--text-muted)",s.style.marginBottom="0.5rem",this.statusEl=s;let o=e.createDiv();o.style.flex="1 1 0",o.style.minHeight="0",o.style.border="1px solid var(--background-modifier-border)",o.style.borderRadius="6px",o.style.display="flex",o.style.flexDirection="column",o.style.overflow="auto";let l=_e.EditorState.create({doc:this.bodyText,extensions:[$n,Vn,ae.EditorView.editable.of(!1),_e.EditorState.readOnly.of(!0),ae.EditorView.lineWrapping]});this.editorView=new ae.EditorView({state:l,parent:o}),this.initialTerm&&this.runSearch()}onClose(){var e;(e=this.editorView)==null||e.destroy(),this.editorView=void 0}async runSearch(){var t;let e=(((t=this.inputEl)==null?void 0:t.value)||"").trim();if(!e){this.statusEl&&(this.statusEl.textContent="Enter a search term.");return}this.statusEl&&(this.statusEl.textContent="Searching...");let n=await this.plugin.runRedisSearch(e);this.updateEditor(n),this.statusEl&&(this.statusEl.textContent=`Results for "${e}"`)}updateEditor(e){if(!this.editorView)return;let n=this.editorView,t=n.scrollDOM.scrollTop,i=n.state.selection.main,r=e.length,a=Math.min(i.anchor,r),s=Math.min(i.head,r);n.dispatch({changes:{from:0,to:n.state.doc.length,insert:e},selection:{anchor:a,head:s}}),n.scrollDOM.scrollTop=t,this.bodyText=e}copyResultsToClipboard(){let e=this.bodyText||"";if(!e){new B.Notice("Nothing to copy.");return}navigator.clipboard.writeText(e).then(()=>new B.Notice("Results copied to clipboard.")).catch(()=>new B.Notice("Failed to copy results."))}},ye=class extends B.Modal{constructor(p,e,n,t){super(p),this.titleText=e,this.bodyText=n,this.options=t}onOpen(){var r,a,s,o;let{contentEl:p}=this;p.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),p.style.display="flex",p.style.flexDirection="column",p.style.height="100%",p.style.overflow="hidden",p.style.minHeight="0";let e=p.createDiv();e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="space-between",e.style.gap="0.5rem",e.createEl("h3",{text:this.titleText});let n=e.createDiv();if(n.style.display="flex",n.style.gap="0.5rem",(r=this.options)!=null&&r.onClear){let l=(a=this.options.clearLabel)!=null?a:"Clear log";n.createEl("button",{text:l}).addEventListener("click",async()=>{var d,_;try{await((_=(d=this.options)==null?void 0:d.onClear)==null?void 0:_.call(d))}finally{await this.refreshFromSource()}})}let t=p.createDiv();t.style.flex="1 1 0",t.style.minHeight="0",t.style.border="1px solid var(--background-modifier-border)",t.style.borderRadius="6px",t.style.display="flex",t.style.flexDirection="column",t.style.overflow="auto";let i=_e.EditorState.create({doc:this.bodyText,extensions:[$n,Vn,ae.EditorView.editable.of(!0),_e.EditorState.readOnly.of(!1),ae.EditorView.lineWrapping]});if(this.editorView=new ae.EditorView({state:i,parent:t}),this.refreshFromSource(),(s=this.options)!=null&&s.autoRefresh&&this.options.onRefresh){let l=(o=this.options.refreshIntervalMs)!=null?o:2e3;this.refreshTimer=window.setInterval(()=>{this.refreshFromSource()},l)}}onClose(){var p;this.refreshTimer!==void 0&&(window.clearInterval(this.refreshTimer),this.refreshTimer=void 0),(p=this.editorView)==null||p.destroy(),this.editorView=void 0}async refreshFromSource(){var s;if(!((s=this.options)!=null&&s.onRefresh)||!this.editorView)return;let p="";try{p=await this.options.onRefresh()||""}catch(o){return}if(p===this.bodyText)return;let e=this.editorView,n=e.scrollDOM.scrollTop,t=e.state.selection.main,i=p.length,r=Math.min(t.anchor,i),a=Math.min(t.head,i);e.dispatch({changes:{from:0,to:e.state.doc.length,insert:p},selection:{anchor:r,head:a}}),e.scrollDOM.scrollTop=n,this.bodyText=p}},Ue=class extends B.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.filePath=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Overwrite"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Be=class extends B.Modal{constructor(e,n,t,i){super(e);this.resolved=!1;this.notePath=n,this.docId=t,this.onResolve=i}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete note and cached data?"}),e.createEl("p",{text:`This will delete the note and cached chunks/items for doc_id ${this.docId}.`}),e.createEl("p",{text:`Note: ${this.notePath}`});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Delete"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Ge=class extends B.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.reason=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Rebuild Redis index?"}),e.createEl("p",{text:this.reason}),e.createEl("p",{text:"This will drop the RedisSearch index (and embeddings) and rebuild it from cached chunks."});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Drop & rebuild"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},We=class extends B.Modal{constructor(e,n){super(e);this.resolved=!1;this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Purge Redis orphaned chunks?"}),e.createEl("p",{text:"This removes Redis chunk keys that have no cached item.json or chunk.json on disk."}),e.createEl("p",{text:"Cache files are not deleted. Use this to clean up stale Redis data."});let n=e.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let t=n.createEl("button",{text:"Cancel"}),i=n.createEl("button",{text:"Purge orphans"});t.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},He=class extends B.Modal{constructor(e,n,t,i,r,a,s){super(e);this.resolved=!1;this.fieldLabel=n,this.noteLabel=t,this.zoteroLabel=i,this.noteValue=r,this.zoteroValue=a,this.onResolve=s}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:`Resolve metadata conflict: ${this.fieldLabel}`});let n=e.createEl("div");n.style.display="grid",n.style.gap="0.5rem",n.createEl("div",{text:"Note value"});let t=n.createEl("textarea",{attr:{readonly:"true",rows:"4"}});t.style.width="100%",t.value=this.noteValue||"(empty)",n.createEl("div",{text:"Zotero value"});let i=n.createEl("textarea",{attr:{readonly:"true",rows:"4"}});i.style.width="100%",i.value=this.zoteroValue||"(empty)";let r=e.createEl("div");r.style.display="flex",r.style.gap="0.5rem",r.style.marginTop="0.75rem";let a=r.createEl("button",{text:this.noteLabel}),s=r.createEl("button",{text:this.zoteroLabel}),o=r.createEl("button",{text:"Skip"});a.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("note")}),s.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("zotero")}),o.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve("skip")})}onClose(){this.resolved||this.onResolve("skip")}},Ke=class extends B.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve metadata conflicts"}),e.createEl("p",{text:"Choose which values to keep for each field."});let n=e.createEl("div");n.style.display="grid",n.style.gap="0.75rem";for(let l of this.conflicts){let c=n.createEl("div");c.style.display="grid",c.style.gap="0.4rem",c.style.border="1px solid var(--background-modifier-border)",c.style.borderRadius="6px",c.style.padding="0.6rem",c.createEl("div",{text:l.fieldLabel}).style.fontWeight="600";let d=c.createEl("div");d.style.display="grid",d.style.gridTemplateColumns="1fr 1fr",d.style.gap="0.5rem";let _=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});_.style.width="100%",_.value=l.noteValue||"(empty)";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});u.style.width="100%",u.value=l.zoteroValue||"(empty)";let m=c.createEl("div");m.style.display="flex",m.style.gap="0.5rem",m.style.alignItems="center",m.createEl("span",{text:"Decision:"});let y=m.createEl("select");y.add(new Option(l.noteLabel,"note")),y.add(new Option(l.zoteroLabel,"zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.field,y)}let t=e.createEl("div");t.style.display="flex",t.style.flexWrap="wrap",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let i=l=>{for(let c of this.selects.values())c.value=l},r=t.createEl("button",{text:"Use note for all"}),a=t.createEl("button",{text:"Use Zotero for all"}),s=t.createEl("button",{text:"Skip all"}),o=t.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[n,t]of this.selects.entries())e[n]=t.value||"skip";this.onResolve(e)}}},Je=class extends B.Modal{constructor(e,n,t){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=n,this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve annotation conflicts"}),e.createEl("p",{text:"Choose which version to keep for each annotation."});let n=e.createEl("div");n.style.display="grid",n.style.gap="0.75rem";for(let l of this.conflicts){let c=n.createEl("div");c.style.display="grid",c.style.gap="0.4rem",c.style.border="1px solid var(--background-modifier-border)",c.style.borderRadius="6px",c.style.padding="0.6rem",c.createEl("div",{text:l.title}).style.fontWeight="600";let d=c.createEl("div");d.style.display="grid",d.style.gridTemplateColumns="1fr 1fr",d.style.gap="0.5rem";let _=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});_.style.width="100%",_.value=l.noteValue||"(empty)";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});u.style.width="100%",u.value=l.zoteroValue||"(empty)";let m=c.createEl("div");m.style.display="flex",m.style.gap="0.5rem",m.style.alignItems="center",m.createEl("span",{text:"Decision:"});let y=m.createEl("select");y.add(new Option("Use note","note")),y.add(new Option("Use Zotero","zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.key,y)}let t=e.createEl("div");t.style.display="flex",t.style.flexWrap="wrap",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let i=l=>{for(let c of this.selects.values())c.value=l},r=t.createEl("button",{text:"Use note for all"}),a=t.createEl("button",{text:"Use Zotero for all"}),s=t.createEl("button",{text:"Skip all"}),o=t.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[n,t]of this.selects.entries())e[n]=t.value||"skip";this.onResolve(e)}}},Xe=class extends B.SuggestModal{constructor(e,n){super(e);this.resolved=!1;this.resolveSelection=n,this.setPlaceholder("Select a language for OCR/quality...")}getSuggestions(e){let n=e.trim().toLowerCase();return n?qn.filter(t=>t.label.toLowerCase().includes(n)||t.value.toLowerCase().includes(n)):qn}renderSuggestion(e,n){n.setText(e.label),n.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new ke(this.app,"Custom language hint","e.g., en, de, fr, de,en",n=>this.resolveSelection(n.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},Ye=class extends B.SuggestModal{constructor(e,n,t){super(e);this.lastError=null;this.indexedDocIds=null;this.querySequence=0;this.queryDebounceMs=200;this.minQueryLength=2;this.maxQueryCacheEntries=100;this.queryCache=new Map;this.plugin=n,this.resolveSelection=t,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){let n=e.trim();if(n.length>0&&n.length<this.minQueryLength)return[];let t=n.toLowerCase(),i=this.queryCache.get(t);if(i)return i;let r=++this.querySequence;try{if(await new Promise(s=>{window.setTimeout(s,this.queryDebounceMs)}),r!==this.querySequence)return[];if(!this.indexedDocIds){let s=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(s))}let a=await this.plugin.searchZoteroItems(n);if(r!==this.querySequence)return[];if(this.queryCache.set(t,a),this.queryCache.size>this.maxQueryCacheEntries){let s=this.queryCache.keys().next().value;s!==void 0&&this.queryCache.delete(s)}return a}catch(a){let s=a instanceof Error?a.message:String(a);return this.lastError!==s&&(this.lastError=s,new B.Notice(s)),console.error("Zotero search failed",a),[]}}renderSuggestion(e,n){var b,C,f,v,x,w;let t=(C=(b=e.data)==null?void 0:b.title)!=null?C:"[No title]",i=On(e),r=Tn(e),a=r?(f=this.indexedDocIds)==null?void 0:f.has(r):!1,s=Mn(e),o=String((x=(v=e.data)==null?void 0:v.itemType)!=null?x:"").trim();a&&n.addClass("zrr-indexed-item"),s==="no"&&n.addClass("zrr-no-pdf-item");let l=n.createDiv({cls:"zrr-zotero-suggest-row"}),c=l.createSpan({cls:"zrr-zotero-item-icon"}),d=(w=mt[o])!=null?w:"file-text";(0,B.setIcon)(c,d);let _=l.createDiv({cls:"zrr-zotero-suggest-text"});_.createEl("div",{text:t,cls:"zrr-zotero-suggest-title"});let u=_.createEl("small",{cls:"zrr-zotero-suggest-meta"}),m=!1,y=()=>{m&&u.createSpan({text:" - "})};i&&(u.createSpan({text:i}),m=!0),a&&(y(),u.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),m=!0),s==="no"&&(y(),u.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),m=!0),n.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,n){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}};var Zn={"docling_extract.py":`#!/usr/bin/env python3
# zotero-redisearch-rag tool version: 0.8.1
import argparse
import atexit
import base64
import errno
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.8.1
aai
aam
abb
abge
...
\xF6pnv
\xFCberarb
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.8.1
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.8.1
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.8.1
...
exec "$@"
`,"redis-stack.conf":`# zotero-redisearch-rag tool version: 0.8.1
# Redis Stack persistence config for local RAG index
appendonly yes
appendfsync everysec

dir /data
`};var un=require("url"),ve=async(g,p,e)=>{let n=bt(g);if(n)return n;try{let t=await e.fetchZoteroChildren(p);for(let i of t){let r=Bn(i);if(r)return r}}catch(t){console.error("Failed to fetch Zotero children",t)}return null},bt=g=>{let p=xt(g);for(let e of p){let n=Bn(e);if(n)return n}return null},xt=g=>{let p=[g.attachments,g.children,g.items,g.attachment,g.allAttachments],e=[];for(let n of p)n&&(Array.isArray(n)?e.push(...n):typeof n=="object"&&e.push(n));return e},Bn=g=>{var t,i,r,a,s,o;if(((r=(t=g==null?void 0:g.contentType)!=null?t:g==null?void 0:g.mimeType)!=null?r:(i=g==null?void 0:g.data)==null?void 0:i.contentType)!=="application/pdf")return null;let e=(o=(a=g==null?void 0:g.key)!=null?a:g==null?void 0:g.attachmentKey)!=null?o:(s=g==null?void 0:g.data)==null?void 0:s.key;if(!e)return null;let n=kt(g);return n?{key:e,filePath:n}:{key:e}},kt=g=>{var e,n,t,i,r,a,s,o;let p=(o=(i=(n=(e=g==null?void 0:g.links)==null?void 0:e.enclosure)==null?void 0:n.href)!=null?i:(t=g==null?void 0:g.enclosure)==null?void 0:t.href)!=null?o:(s=(a=(r=g==null?void 0:g.data)==null?void 0:r.links)==null?void 0:a.enclosure)==null?void 0:s.href;if(typeof p=="string"&&p.startsWith("file://"))try{return(0,un.fileURLToPath)(p)}catch(l){return null}return null},Un=async(g,p)=>{if(g.statusCode<300||g.statusCode>=400)return null;let e=g.headers.location,n=Array.isArray(e)?e[0]:e;if(!n||typeof n!="string")return null;if(n.startsWith("file://")){let t=(0,un.fileURLToPath)(n);return p.readFile(t)}return n.startsWith("http://")||n.startsWith("https://")?p.requestLocalApi(n):null},Qe=async(g,p)=>{let e=p.buildZoteroUrl(`/${p.getZoteroLibraryPath()}/items/${g}/file`);try{let n=await p.requestLocalApiRaw(e),t=await Un(n,p);if(t)return t;if(n.statusCode>=300)throw new Error(`Request failed, status ${n.statusCode}`);return n.body}catch(n){if(console.warn("Failed to download PDF from local API",n),!p.canUseWebApi())throw n;let t=p.buildWebApiUrl(`/${p.getWebApiLibraryPath()}/items/${g}/file`),i=await p.requestWebApiRaw(t),r=await Un(i,p);if(r)return r;if(i.statusCode>=300)throw new Error(`Web API request failed, status ${i.statusCode}`);return i.body}};var K=require("obsidian"),be="zotero-redisearch-rag-chat",we=class extends K.ItemView{constructor(e,n){super(e);this.messages=[];this.activeSessionId="default";this.messageEls=new Map;this.pendingRender=new Map;this.pendingThinking=new Set;this.busy=!1;this.plugin=n}getViewType(){return be}getDisplayText(){return"Zotero RAG Chat"}getIcon(){return"zrr-chat"}async onOpen(){let{containerEl:e}=this;e.empty(),e.addClass("zrr-chat-view");let n=e.createEl("div",{cls:"zrr-chat-header"});n.createEl("div",{cls:"zrr-chat-title",text:"Zotero RAG Chat"});let t=n.createEl("div",{cls:"zrr-chat-controls"}),i=t.createEl("div",{cls:"zrr-chat-controls-row"});this.sessionSelect=i.createEl("select",{cls:"zrr-chat-session"}),this.sessionSelect.addEventListener("change",async()=>{await this.switchSession(this.sessionSelect.value)});let r=t.createEl("div",{cls:"zrr-chat-controls-row zrr-chat-controls-actions"});this.renameButton=r.createEl("button",{cls:"zrr-chat-rename",text:"Rename",attr:{title:"Rename the current chat"}}),this.renameButton.addEventListener("click",async()=>{await this.promptRenameSession()}),this.copyButton=r.createEl("button",{cls:"zrr-chat-copy",text:"Copy",attr:{title:"Copy this chat to a new note"}}),this.copyButton.addEventListener("click",async()=>{await this.copyChatToNote()}),this.deleteButton=r.createEl("button",{cls:"zrr-chat-delete",text:"Delete",attr:{title:"Delete this chat"}}),this.deleteButton.addEventListener("click",async()=>{await this.deleteChat()}),this.newButton=r.createEl("button",{cls:"zrr-chat-new",text:"New chat",attr:{title:"Start a new chat session"}}),this.newButton.addEventListener("click",async()=>{await this.startNewChat()}),this.messagesEl=e.createEl("div",{cls:"zrr-chat-messages"});let a=e.createEl("div",{cls:"zrr-chat-input"});this.inputEl=a.createEl("textarea",{cls:"zrr-chat-textarea",attr:{placeholder:"Ask your Zotero library..."}}),this.sendButton=a.createEl("button",{cls:"zrr-chat-send",text:"Send"}),this.sendButton.addEventListener("click",()=>this.handleSend()),this.inputEl.addEventListener("keydown",s=>{s.key==="Enter"&&!s.shiftKey&&(s.preventDefault(),this.handleSend())}),await this.loadSessions(),await this.loadHistory(),await this.renderAll()}focusInput(){var e;(e=this.inputEl)==null||e.focus()}async loadHistory(){try{this.messages=await this.plugin.loadChatHistoryForSession(this.activeSessionId)}catch(e){console.error(e),this.messages=[]}}async saveHistory(){try{await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages),await this.loadSessions()}catch(e){console.error(e)}}async loadSessions(){let e=await this.plugin.listChatSessions();this.activeSessionId=await this.plugin.getActiveChatSessionId(),this.sessionSelect.empty();for(let n of e){let t=this.sessionSelect.createEl("option",{text:n.name});t.value=n.id,n.id===this.activeSessionId&&(t.selected=!0)}!e.some(n=>n.id===this.activeSessionId)&&e.length>0&&(this.activeSessionId=e[0].id,await this.plugin.setActiveChatSessionId(this.activeSessionId),this.sessionSelect.value=this.activeSessionId)}async promptRenameSession(){var i;let n=(await this.plugin.listChatSessions()).find(r=>r.id===this.activeSessionId);new _n(this.app,(i=n==null?void 0:n.name)!=null?i:"New chat",async r=>{await this.plugin.renameChatSession(this.activeSessionId,r),await this.loadSessions()}).open()}async startNewChat(){await this.plugin.saveChatHistoryForSession(this.activeSessionId,this.messages),await this.plugin.finalizeChatSessionNameIfNeeded(this.activeSessionId,this.messages,{force:!0});let e=await this.plugin.createChatSession("New chat");await this.switchSession(e,{skipSave:!0})}async deleteChat(){let e=await this.plugin.listChatSessions();if(e.length<=1){new K.Notice("You must keep at least one chat.");return}let n=e.find(i=>i.id===this.activeSessionId);if(!n)return;new gn(this.app,n.name,async()=>{await this.plugin.deleteChatSession(this.activeSessionId);let i=await this.plugin.getActiveChatSessionId();await this.switchSession(i,{skipSave:!0})}).open()}async switchSession(e,n={}){!e||e===this.activeSessionId||(n.skipSave||await this.saveHistory(),this.activeSessionId=e,await this.plugin.setActiveChatSessionId(e),await this.loadSessions(),await this.loadHistory(),await this.renderAll())}async renderAll(){this.messagesEl.empty(),this.messageEls.clear();let e=new Set(this.messages.map(n=>n.id));for(let n of Array.from(this.pendingThinking))e.has(n)||this.pendingThinking.delete(n);for(let n of this.messages)await this.renderMessage(n);this.scrollToBottom()}async renderMessage(e){let n=this.messagesEl.createEl("div",{cls:`zrr-chat-message zrr-chat-${e.role}`}),t=n.createEl("div",{cls:"zrr-chat-meta-row"});t.createEl("div",{cls:"zrr-chat-meta"}).setText(e.role==="user"?"You":"Zotero Assistant");let r=t.createEl("div",{cls:"zrr-chat-message-actions"}),a=r.createEl("button",{cls:"zrr-chat-message-copy zrr-chat-icon-button",attr:{title:"Copy this message","aria-label":"Copy this message"}});(0,K.setIcon)(a,"copy"),a.addEventListener("click",async c=>{c.preventDefault(),c.stopPropagation(),await this.copyMessage(e)});let s=r.createEl("button",{cls:"zrr-chat-message-delete zrr-chat-icon-button",attr:{title:"Delete this message","aria-label":"Delete this message"}});(0,K.setIcon)(s,"trash-2"),s.addEventListener("click",async c=>{c.preventDefault(),c.stopPropagation(),await this.deleteMessage(e.id)});let o=n.createEl("div",{cls:"zrr-chat-content"}),l=n.createEl("div",{cls:"zrr-chat-citations"});this.messageEls.set(e.id,{wrapper:n,content:o,citations:l}),await this.renderMessageContent(e)}async copyMessage(e){var i,r,a;let t=(await this.plugin.formatInlineCitations(e.content||"",(i=e.citations)!=null?i:[],(r=e.retrieved)!=null?r:[])||"").trim();if(!t){new K.Notice("Nothing to copy.");return}if(!((a=navigator.clipboard)!=null&&a.writeText)){new K.Notice("Clipboard API unavailable. Select text to copy.");return}try{await navigator.clipboard.writeText(t),new K.Notice("Message copied to clipboard.")}catch(s){console.error("Failed to copy message",s),new K.Notice("Failed to copy message.")}}async deleteMessage(e){let n=this.messages.findIndex(a=>a.id===e);if(n===-1||!window.confirm("Delete this message? This cannot be undone."))return;this.messages.splice(n,1);let i=this.messageEls.get(e);i&&i.wrapper.remove(),this.messageEls.delete(e);let r=this.pendingRender.get(e);r!==void 0&&(window.clearTimeout(r),this.pendingRender.delete(e)),this.pendingThinking.delete(e),await this.saveHistory()}scheduleRender(e){if(this.pendingRender.has(e.id))return;let n=window.setTimeout(async()=>{this.pendingRender.delete(e.id),await this.renderMessageContent(e),this.scrollToBottom()},80);this.pendingRender.set(e.id,n)}async renderMessageContent(e){var r,a,s;let n=this.messageEls.get(e.id);if(!n)return;if(e.role==="assistant"&&!e.content.trim()&&this.pendingThinking.has(e.id)){n.content.dataset.lastRendered!=="__thinking__"&&(n.content.empty(),this.renderThinkingIndicator(n.content),n.content.dataset.lastRendered="__thinking__"),n.citations.empty();return}let i=await this.plugin.formatInlineCitations(e.content||"",(r=e.citations)!=null?r:[],(a=e.retrieved)!=null?a:[]);n.content.dataset.lastRendered!==i&&(n.content.empty(),await K.MarkdownRenderer.renderMarkdown(i,n.content,"",this.plugin),this.hookInternalLinks(n.content),n.content.dataset.lastRendered=i),n.citations.empty(),await this.renderCitations(n.citations,(s=e.citations)!=null?s:[])}renderThinkingIndicator(e){let n=e.createEl("div",{cls:"zrr-chat-thinking"});n.setAttr("role","status"),n.setAttr("aria-live","polite"),n.createEl("span",{cls:"zrr-chat-thinking-spinner"}),n.createEl("span",{cls:"zrr-chat-thinking-text",text:"Thinking"});let t=n.createEl("span",{cls:"zrr-chat-thinking-dots"});t.createEl("span"),t.createEl("span"),t.createEl("span")}hookInternalLinks(e){let n=e.querySelectorAll("a.internal-link");for(let t of Array.from(n))t.dataset.zrrBound!=="1"&&(t.dataset.zrrBound="1",this.registerDomEvent(t,"click",i=>{i.preventDefault();let r=t.getAttribute("data-href")||t.getAttribute("href")||"";r&&this.plugin.openInternalLinkInMain(r)}))}async renderCitations(e,n){if(e.empty(),!n.length)return;let t=e.createEl("details",{cls:"zrr-chat-citations-details"});t.createEl("summary",{text:`Relevant context sources (${n.length})`,cls:"zrr-chat-citations-summary"});let i=t.createEl("ul",{cls:"zrr-chat-citation-list"});for(let r of n){let a=await this.plugin.resolveCitationDisplay(r),s=i.createEl("li"),o=`${a.noteTitle} p. ${a.pageLabel}`;s.createEl("a",{text:o,href:"#"}).addEventListener("click",c=>{c.preventDefault(),this.plugin.openCitationTarget(r,a)}),r.annotation_key&&s.createEl("span",{text:"Annotation",cls:"zrr-chat-citation-badge"})}}async copyChatToNote(){var i;let n=(await this.plugin.listChatSessions()).find(r=>r.id===this.activeSessionId),t=(i=n==null?void 0:n.name)!=null?i:"New chat";await this.plugin.createChatNoteFromSession(this.activeSessionId,t,this.messages)}scrollToBottom(){this.messagesEl.scrollTop=this.messagesEl.scrollHeight}async handleSend(){if(this.busy)return;let e=this.inputEl.value.trim();if(!e){new K.Notice("Query cannot be empty.");return}if(!this.plugin.settings.chatBaseUrl){new K.Notice("Chat base URL must be set in settings.");return}this.inputEl.value="",this.busy=!0,this.sendButton.disabled=!0;let n={id:this.generateId(),role:"user",content:e,createdAt:new Date().toISOString()};this.messages.push(n),await this.renderMessage(n),this.scrollToBottom(),await this.saveHistory();let t={id:this.generateId(),role:"assistant",content:"",citations:[],createdAt:new Date().toISOString()};this.messages.push(t),this.pendingThinking.add(t.id),await this.renderMessage(t),this.scrollToBottom();let i=!1,r=this.plugin.getRecentChatHistory(this.messages.slice(0,-2));try{await this.plugin.runRagQueryStreaming(e,a=>{this.pendingThinking.delete(t.id),i=!0,t.content+=a,this.scheduleRender(t)},a=>{this.pendingThinking.delete(t.id),(!i&&(a!=null&&a.answer)||a!=null&&a.answer)&&(t.content=a.answer),Array.isArray(a==null?void 0:a.citations)&&(t.citations=a.citations),Array.isArray(a==null?void 0:a.retrieved)&&(t.retrieved=a.retrieved),this.scheduleRender(t)},r)}catch(a){console.error(a),this.pendingThinking.delete(t.id),t.content="Failed to fetch answer. See console for details.",this.scheduleRender(t)}finally{this.pendingThinking.delete(t.id),this.busy=!1,this.sendButton.disabled=!1,await this.saveHistory()}}generateId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}},_n=class extends K.Modal{constructor(p,e,n){super(p),this.initialValue=e,this.onSubmit=n}onOpen(){let{contentEl:p}=this;p.empty(),p.addClass("zrr-chat-rename-modal"),p.createEl("h3",{text:"Rename chat"});let e=this.initialValue;new K.Setting(p).setName("Name").addText(r=>{r.setValue(e),r.onChange(a=>{e=a})});let n=p.createEl("div");n.style.display="flex",n.style.gap="0.5rem",n.style.marginTop="1rem",n.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),n.createEl("button",{text:"Save"}).addEventListener("click",()=>{let r=e.trim();if(!r){new K.Notice("Name cannot be empty.");return}this.close(),this.onSubmit(r)})}},gn=class extends K.Modal{constructor(p,e,n){super(p),this.chatName=e,this.onConfirm=n}onOpen(){let{contentEl:p}=this;p.empty(),p.createEl("h3",{text:"Delete chat"}),p.createEl("p",{text:`Delete "${this.chatName}"? This cannot be undone.`});let e=p.createEl("div");e.style.display="flex",e.style.gap="0.5rem",e.style.marginTop="1rem",e.createEl("button",{text:"Cancel"}).addEventListener("click",()=>this.close()),e.createEl("button",{text:"Delete"}).addEventListener("click",()=>{this.close(),this.onConfirm()})}};var Gn={"0.8.1":["Switch What's New splash content to bundled versioned release notes instead of changelog parsing.","Improve update-splash reliability while keeping once-per-version display behavior."],"0.8.0":["Add optional agentic retrieval mode with a lightweight planner step before answer generation.","Add agentic retrieval actions: keep current context, expansion-retry retrieval, and full-document retrieval for synthesis-heavy queries.","Add agentic controls in settings: Enable agentic retrieval and Agentic max iterations.","Extend RAG output with agentic_mode and agentic_trace for debugging and tuning.","Add an animated Thinking indicator in the assistant bubble before response streaming starts.","Add an automatic What's New splash shown once after plugin version updates."]};var Wn={en:"eng",de:"deu",fr:"fra",es:"spa",it:"ita",nl:"nld",pt:"por",pl:"pol",sv:"swe"},vt=Me["zrr-picker"],wt=Me["zrr-chat"],Hn=Me["zrr-pdf"],Kn="redis-stack",Pe="python-worker",Jn="/workspace/cache/venv/bin/python",Pt="/workspace/plugin",At="/workspace/vault",Xn=80,Yn=12e4,Ct=/<!--\s*zrr:annotations-start\b[^>]*-->/i,St=/<!--\s*zrr:annotations-end\s*-->/i,Qn=["doc_id","zotero_key","zotero_link","item_link","item_key","citekey","title","short_title","date","year","year_number","authors","editors","aliases","tags","collection_title","collection_titles","collections","collections_links","item_type","creator_summary","publication_title","book_title","journal_abbrev","volume","issue","pages","date_added","date_modified","doi","isbn","issn","publisher","place","url","language","abstract","pdf_link","item_json"],en=class extends h.Plugin{constructor(){super(...arguments);this.docIndex=null;this.metadataSnapshotCache=null;this.annotationSnapshotCache=null;this.lastPythonEnvNotice=null;this.lastContainerNotice=null;this.lastZoteroApiNotice=null;this.lastRedisNotice=null;this.noteSyncTimers=new Map;this.noteSyncInFlight=new Set;this.noteSyncPending=new Set;this.noteSyncPendingDeletes=new Map;this.noteSyncSuppressed=new Set;this.noteMetadataSyncTimers=new Map;this.noteMetadataSyncInFlight=new Set;this.noteMetadataSyncPending=new Set;this.noteMetadataSyncSuppressed=new Set;this.noteAnnotationSyncTimers=new Map;this.noteAnnotationSyncInFlight=new Set;this.noteAnnotationSyncPending=new Set;this.noteAnnotationSyncSuppressed=new Set;this.annotationNoteEditTimes=new Map;this.missingDocIdWarned=new Set;this.annotationWebApiWarned=new Set;this.collectionTitleCache=new Map;this.recreateMissingNotesActive=!1;this.recreateMissingNotesAbort=!1;this.recreateMissingNotesProcess=null;this.reindexCacheActive=!1;this.lastReindexFailure=null;this.lastRedisSearchTerm="";this.hadSavedSettingsData=!1}async onload(){await this.loadSettings(),await this.migrateCachePaths(),this.addSettingTab(new Ie(this.app,this)),this.pdfSidebar=new ze({app:this.app,iconSvg:Hn,resolveDocIdForNote:this.resolveDocIdForNote.bind(this),getDocIndexEntry:this.getDocIndexEntry.bind(this),hydrateDocIndexFromCache:this.hydrateDocIndexFromCache.bind(this),toVaultRelativePath:this.toVaultRelativePath.bind(this),normalizeChunkIdForNote:this.normalizeChunkIdForNote.bind(this),readChunkPayload:this.readChunkPayload.bind(this)},{extractDocIdFromDoc:De,findChunkStartLineInDoc:sn,parseChunkMarkerLine:an,extractFirstChunkMarkerFromContent:xn}),this.registerRibbonIcons(),this.registerView(be,e=>new we(e,this)),this.setupStatusBar(),this.registerNoteRenameHandler(),this.registerNoteSyncHandler(),this.registerNoteOpenHandler(),this.registerPreviewScrollSyncHandlers(),this.registerNoteDeleteMenu(),this.registerEditorExtension(Cn(this)),this.registerEditorExtension(An()),this.registerEditorExtension(this.pdfSidebar.createSyncExtension());try{await this.ensureBundledTools()}catch(e){console.error("Failed to sync bundled tools",e)}this.autoDetectRedisOnLoad(),this.addCommand({id:"import-zotero-item-index",name:"Import Zotero item and index (Docling -> RedisSearch)",callback:()=>this.importZoteroItem()}),this.addCommand({id:"ask-zotero-library",name:"Ask my Zotero library (RAG via RedisSearch)",callback:()=>this.askZoteroLibrary()}),this.addCommand({id:"open-zotero-chat",name:"Open Zotero RAG chat panel",callback:()=>this.openChatView(!0)}),this.addCommand({id:"rebuild-zotero-note-cache",name:"Rebuild Zotero note from cache (Docling + RedisSearch)",callback:()=>this.rebuildNoteFromCache()}),this.addCommand({id:"rebuild-doc-index-cache",name:"Rebuild doc index from cache",callback:()=>this.rebuildDocIndexFromCache()}),this.addCommand({id:"recreate-missing-notes-cache",name:"Recreate missing notes from cache (Docling + RedisSearch)",callback:()=>this.recreateMissingNotesFromCache()}),this.addCommand({id:"reindex-redis-from-cache",name:"Reindex Redis from cached chunks",callback:()=>this.reindexRedisFromCache()}),this.addCommand({id:"reindex-current-note",name:"Reindex current note from cache",callback:()=>this.reindexCurrentNoteFromCache()}),this.addCommand({id:"drop-rebuild-redis-index",name:"Drop & rebuild Redis index",callback:()=>this.dropAndRebuildRedisIndex()}),this.addCommand({id:"start-redis-stack",name:"Start Redis Stack (Docker/Podman Compose)",callback:()=>this.startRedisStack()}),this.addCommand({id:"open-docling-log",name:"Open log file",callback:()=>this.openLogFile()}),this.addCommand({id:"clear-docling-log",name:"Clear log file",callback:()=>this.clearLogFile()}),this.addCommand({id:"toggle-zrr-chunk-delete",name:"Toggle ZRR chunk exclude at cursor",editorCallback:e=>this.toggleChunkExclude(e)}),this.addCommand({id:"delete-zotero-note-cache",name:"Delete Zotero note and cached data",callback:()=>this.deleteZoteroNoteAndCache()}),this.addCommand({id:"search-redis-index",name:"Search Redis index for term",callback:()=>this.searchRedisIndex()}),this.addCommand({id:"redis-diagnostics",name:"Show Redis diagnostics",callback:()=>this.showRedisDiagnostics()}),this.addCommand({id:"zotero-companion-health",name:"Check Zotero companion status",callback:()=>this.checkZoteroCompanionHealth()}),this.addCommand({id:"zotero-open-addons",name:"Open Zotero Add-ons",callback:()=>this.openZoteroAddons()}),this.addCommand({id:"purge-redis-orphans",name:"Purge Redis orphaned chunks (missing cache files)",callback:()=>this.purgeRedisOrphanedKeys()}),this.maybeShowReleaseNotesModal(),this.autoDetectContainerCliOnLoad(),this.settings.autoStartRedis&&this.startRedisStack(!0)}async loadSettings(){var t;let e=(t=await this.loadData())!=null?t:{};this.hadSavedSettingsData=Object.keys(e).length>0;let n=Object.assign({},Fe,e);e.pythonRuntime===void 0&&(n.pythonRuntime="local"),n.preferObsidianNoteForCitations===void 0&&typeof e.preferVaultPdfForCitations=="boolean"&&(n.preferObsidianNoteForCitations=e.preferVaultPdfForCitations),this.settings=n}async saveSettings(){await this.saveData(this.settings)}async maybeShowReleaseNotesModal(){let e=String(this.manifest.version||"").trim();if(!e)return;let n=String(this.settings.lastSeenReleaseNotesVersion||"").trim();if(!n&&!this.hadSavedSettingsData){this.settings.lastSeenReleaseNotesVersion=e,await this.saveSettings();return}if(n===e)return;let t=this.getReleaseNotesEntries(e);this.settings.lastSeenReleaseNotesVersion=e,await this.saveSettings(),new je(this.app,e,t).open()}getReleaseNotesEntries(e){let n=String(e||"").trim();if(!n)return[];let t=Gn[n];return Array.isArray(t)?t.map(i=>String(i||"").trim()).filter(i=>i.length>0).slice(0,12):[]}async importZoteroItem(){var S,L,z;try{await this.ensureBundledTools()}catch(O){new h.Notice("Failed to sync bundled tools. See console for details."),console.error(O);return}if(!await this.warnIfZoteroLocalApiUnavailable("import")&&!this.canUseWebApi())return;let n;try{n=await this.promptZoteroItem()}catch(O){new h.Notice("Zotero search failed. See console for details."),console.error(O);return}if(!n){new h.Notice("No Zotero item selected.");return}let t=(S=n.data)!=null?S:n;!t.key&&n.key&&(t.key=n.key);let i=Dn(t);if(!i){new h.Notice("Could not resolve a stable doc_id from Zotero item.");return}let r=await this.resolveLanguageHint(t,(L=n.key)!=null?L:t.key),a=this.buildDoclingLanguageHint(r!=null?r:void 0),s=await ve(t,i,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});if(!s){new h.Notice("No PDF attachment found for item.");return}if(this.showStatusProgress("Preparing...",5),!await this.ensureRedisAvailable("import")){this.clearStatusProgress();return}let o=typeof t.title=="string"?t.title:"",l=await this.getDocIndexEntry(i);l&&new h.Notice("Item already indexed. Updating cached files and index.");let c=this.sanitizeFileName(o)||i;if(l!=null&&l.note_path)c=E.default.basename(l.note_path,".md")||c;else if(l!=null&&l.pdf_path){let O=this.toVaultRelativePath(l.pdf_path);O&&O.startsWith((0,h.normalizePath)(this.settings.outputPdfDir))&&(c=E.default.basename(O,".pdf")||c)}let d=l?c:await this.resolveUniqueBaseName(c,i),_=(0,h.normalizePath)(`${this.settings.outputPdfDir}/${d}.pdf`),u=(0,h.normalizePath)(`${te}/${i}.json`),m=(0,h.normalizePath)(`${H}/${i}.json`),y=this.app.vault.adapter,b=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${d}.md`);if(l!=null&&l.note_path&&await y.exists(l.note_path)&&(b=(0,h.normalizePath)(l.note_path)),await y.exists(b)&&!await this.confirmOverwrite(b)){new h.Notice("Import canceled.");return}try{if(await this.ensureFolder(te),await this.ensureFolder(H),await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let O=this.getLogFileRelativePath(),j=(0,h.normalizePath)(E.default.dirname(O));j&&await this.ensureFolder(j),await this.deleteLogFileIfExists();let F=this.getSpellcheckerInfoRelativePath(),M=(0,h.normalizePath)(E.default.dirname(F));M&&await this.ensureFolder(M)}}catch(O){new h.Notice("Failed to create output folders."),console.error(O),this.clearStatusProgress();return}let C="",f="";try{if(this.settings.copyPdfToVault){let O=s.filePath?await G.promises.readFile(s.filePath):await Qe(s.key,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:G.promises.readFile});await this.app.vault.adapter.writeBinary(_,this.bufferToArrayBuffer(O)),C=this.getAbsoluteVaultPath(_)}else if(s.filePath)C=s.filePath;else{await this.ensureFolder(this.settings.outputPdfDir);let O=await Qe(s.key,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:G.promises.readFile});await this.app.vault.adapter.writeBinary(_,this.bufferToArrayBuffer(O)),C=this.getAbsoluteVaultPath(_),new h.Notice("Local PDF path unavailable; copied PDF into vault for processing.")}f=this.buildPdfLinkForNote(C,s.key,i)}catch(O){new h.Notice("Failed to download PDF attachment."),console.error(O),this.clearStatusProgress();return}try{await this.app.vault.adapter.write(u,JSON.stringify(n,null,2))}catch(O){new h.Notice("Failed to write Zotero item JSON."),console.error(O),this.clearStatusProgress();return}let v=this.getPluginDir(),x=E.default.join(v,"tools","docling_extract.py"),w=E.default.join(v,"tools","index_redisearch.py"),R=null;try{R=await this.readDoclingQualityLabelFromPdf(C,a),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",R),0);let O=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(x,await this.buildDoclingArgs(C,i,m,b,a,!0),M=>this.handleDoclingProgress(M,R),()=>{},O),R=await this.readDoclingQualityLabel(m),await this.annotateChunkJsonWithAttachmentKey(m,s.key);let j=await this.readDoclingMetadata(m),F=await this.maybeCreateOcrLayeredPdf(C,j,a);F&&(C=F,f=this.buildPdfLinkFromSourcePath(F),await this.updateChunkJsonSourcePdf(m,F))}catch(O){new h.Notice("Docling extraction failed. See console for details."),console.error(O),this.clearStatusProgress();return}let A=!1;try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",R),0);let O=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null,j=["--chunks-json",this.getAbsoluteVaultPath(m),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--progress"];this.appendEmbedSubchunkArgs(j),this.appendEmbedContextArgs(j),this.settings.embedIncludeMetadata&&j.push("--embed-include-metadata"),this.appendChunkTaggingArgs(j),await this.runPythonStreaming(w,j,F=>{if((F==null?void 0:F.type)==="progress"&&F.total){let M=Math.round(F.current/F.total*100),$=typeof F.message=="string"&&F.message.trim()?F.message:`Indexing chunks ${F.current}/${F.total}`,I=this.formatStatusLabel($,R);this.showStatusProgress(I,M)}},()=>{})}catch(O){let j=this.getPythonErrorMessage(O),F=this.classifyIndexingError(j);if(console.error(O),F==="embed_dim_mismatch")if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema. Switch to a model with matching dimensions, or drop/rebuild the index."))try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){this.clearStatusProgress(),this.lastReindexFailure==="embed_failure"?new h.Notice("Embedding provider error detected while rebuilding the Redis index. Fix the provider/model settings and retry import."):new h.Notice("Redis index rebuild did not complete. Import stopped.");return}new h.Notice("Redis index rebuilt; resuming import."),A=!0}catch($){this.clearStatusProgress(),new h.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error($);return}else{this.clearStatusProgress(),new h.Notice("Indexing aborted due to embedding dimension mismatch. Switch models or drop/rebuild the index.");return}if(!A){if(F==="embed_failure"){this.clearStatusProgress(),new h.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.");return}this.clearStatusProgress(),new h.Notice("RedisSearch indexing failed. See console for details.");return}}try{let O=await this.app.vault.adapter.read(b),j=await this.readChunkPayload(m),F=this.buildSyncedDoclingContent(i,j,O),M=await this.buildNoteMarkdown(t,(z=n.meta)!=null?z:{},i,f,s.key,b,u,F);await this.writeNoteWithSyncSuppressed(b,M);let $=this.app.vault.getAbstractFileByPath(b);$ instanceof h.TFile&&this.scheduleNoteAnnotationSync($,2e3,"save")}catch(O){new h.Notice("Failed to finalize note markdown."),console.error(O),this.clearStatusProgress();return}try{let O=me(t);await this.updateDocIndex({doc_id:i,note_path:b,note_title:d,zotero_title:o,short_title:O||void 0,pdf_path:C,attachment_key:s.key})}catch(O){console.error("Failed to update doc index",O)}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new h.Notice(`Indexed Zotero item ${i}.`)}async askZoteroLibrary(){await this.openChatView(!0)}getChatLeaf(){var n;let e=this.app.workspace.getLeavesOfType(be);return e.length>0?e[0]:this.settings.chatPaneLocation==="right"?(n=this.app.workspace.getRightLeaf(!1))!=null?n:this.app.workspace.getLeaf("split"):this.app.workspace.getLeaf("tab")}async openChatView(e=!1){let n=this.getChatLeaf();await n.setViewState({type:be,active:!0}),this.app.workspace.revealLeaf(n);let t=n.view;return t instanceof we&&e&&t.focusInput(),t}async loadChatHistory(){let e=await this.getActiveChatSessionId();return this.loadChatHistoryForSession(e)}async saveChatHistory(e){let n=await this.getActiveChatSessionId();await this.saveChatHistoryForSession(n,e)}getChatSessionsDir(){return(0,h.normalizePath)(`${Y}/chats`)}getChatExportDir(){let e=(this.settings.chatOutputDir||"").trim();return e?(0,h.normalizePath)(e):(0,h.normalizePath)("zotero/chats")}getChatSessionsIndexPath(){return(0,h.normalizePath)(`${this.getChatSessionsDir()}/index.json`)}getChatSessionPath(e){return(0,h.normalizePath)(`${this.getChatSessionsDir()}/${e}.json`)}async listChatSessions(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath();if(!await e.exists(n)){let t=new Date().toISOString(),i=[{id:"default",name:"New chat",createdAt:t,updatedAt:t}];return await this.writeChatSessionsIndex({version:1,active:"default",sessions:i}),i}try{let t=await e.read(n),i=JSON.parse(t);return(Array.isArray(i==null?void 0:i.sessions)?i.sessions:[]).filter(a=>a&&typeof a.id=="string").map(a=>({id:String(a.id),name:typeof a.name=="string"&&a.name.trim()?a.name.trim():String(a.id),createdAt:typeof a.createdAt=="string"?a.createdAt:new Date().toISOString(),updatedAt:typeof a.updatedAt=="string"?a.updatedAt:new Date().toISOString()}))}catch(t){return console.warn("Failed to read chat sessions index",t),[]}}async getActiveChatSessionId(){await this.migrateLegacyChatHistory();let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath();if(!await e.exists(n))return"default";try{let t=await e.read(n),i=JSON.parse(t);return(typeof(i==null?void 0:i.active)=="string"?i.active:"default")||"default"}catch(t){return"default"}}async setActiveChatSessionId(e){var a,s;await this.migrateLegacyChatHistory();let n=await this.readChatSessionsIndex(),t=((a=n.sessions)!=null?a:[]).some(o=>o.id===e),i=new Date().toISOString(),r=t?n.sessions:[...(s=n.sessions)!=null?s:[],{id:e,name:e,createdAt:i,updatedAt:i}];await this.writeChatSessionsIndex({version:1,active:e,sessions:r})}async createChatSession(e){var s;await this.migrateLegacyChatHistory();let n=this.generateChatId(),t=new Date().toISOString(),i=(e||"").trim()||"New chat",a=[...(s=(await this.readChatSessionsIndex()).sessions)!=null?s:[],{id:n,name:i,createdAt:t,updatedAt:t}];return await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionPath(n),JSON.stringify({version:1,messages:[]},null,2)),await this.writeChatSessionsIndex({version:1,active:n,sessions:a}),n}async renameChatSession(e,n){var a,s;await this.migrateLegacyChatHistory();let t=(n||"").trim();if(!t)return;let i=await this.readChatSessionsIndex(),r=((a=i.sessions)!=null?a:[]).map(o=>o.id===e?{...o,name:t}:o);await this.writeChatSessionsIndex({version:1,active:(s=i.active)!=null?s:"default",sessions:r})}async deleteChatSession(e){var s;if(await this.migrateLegacyChatHistory(),!e)return;let n=this.app.vault.adapter,t=await this.readChatSessionsIndex(),i=(s=t.sessions)!=null?s:[];if(i.length<=1)return;let r=i.filter(o=>o.id!==e);if(!r.length)return;let a=t.active===e?r[0].id:t.active;try{await n.remove(this.getChatSessionPath(e))}catch(o){console.warn("Failed to delete chat session file",o)}await this.writeChatSessionsIndex({version:1,active:a,sessions:r})}async loadChatHistoryForSession(e){await this.migrateLegacyChatHistory();let n=this.app.vault.adapter,t=this.getChatSessionPath(e||"default");if(!await n.exists(t))return[];let i=await n.read(t),r;try{r=JSON.parse(i)}catch(s){return[]}let a=Array.isArray(r)?r:r==null?void 0:r.messages;return Array.isArray(a)?a.filter(s=>s&&typeof s.content=="string").map(s=>({id:s.id||this.generateChatId(),role:s.role==="assistant"?"assistant":"user",content:s.content,citations:Array.isArray(s.citations)?s.citations:[],retrieved:Array.isArray(s.retrieved)?s.retrieved:[],createdAt:s.createdAt||new Date().toISOString()})):[]}async saveChatHistoryForSession(e,n){var l,c;await this.migrateLegacyChatHistory(),await this.ensureFolder(this.getChatSessionsDir());let t=this.app.vault.adapter,i=this.getChatSessionPath(e||"default"),r={version:1,messages:n};await t.write(i,JSON.stringify(r,null,2));let a=await this.readChatSessionsIndex(),s=new Date().toISOString(),o=((l=a.sessions)!=null?l:[]).map(d=>d.id===e?{...d,updatedAt:s}:d);await this.writeChatSessionsIndex({version:1,active:(c=a.active)!=null?c:e,sessions:o})}getRecentChatHistory(e){let n=Math.max(0,this.settings.chatHistoryMessages||0);return n?e.filter(i=>{var r;return i&&((r=i.content)==null?void 0:r.trim())}).slice(-n):[]}async readChatSessionsIndex(){let e=this.app.vault.adapter,n=this.getChatSessionsIndexPath(),t=new Date().toISOString();if(!await e.exists(n))return{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:t,updatedAt:t}]};try{let i=await e.read(n),r=JSON.parse(i),a=Array.isArray(r==null?void 0:r.sessions)?r.sessions:[];return{version:1,active:typeof(r==null?void 0:r.active)=="string"?r.active:"default",sessions:a.map(s=>({id:String(s.id),name:typeof s.name=="string"&&s.name.trim()?s.name.trim():String(s.id),createdAt:typeof s.createdAt=="string"?s.createdAt:t,updatedAt:typeof s.updatedAt=="string"?s.updatedAt:t}))}}catch(i){return console.warn("Failed to parse chat sessions index",i),{version:1,active:"default",sessions:[{id:"default",name:"New chat",createdAt:t,updatedAt:t}]}}}async writeChatSessionsIndex(e){await this.ensureFolder(this.getChatSessionsDir()),await this.app.vault.adapter.write(this.getChatSessionsIndexPath(),JSON.stringify(e,null,2))}async migrateLegacyChatHistory(){let e=this.app.vault.adapter,n=(0,h.normalizePath)(`${Y}/chat.json`),t=this.getChatSessionsDir(),i=this.getChatSessionsIndexPath(),r=this.getChatSessionPath("default"),a=await e.exists(n),s=await e.exists(r),o=await e.exists(i);if(!a&&o)return;let l=new Date().toISOString();if(await this.ensureFolder(t),a&&!s)try{await e.rename(n,r)}catch(c){try{let d=await e.read(n);await e.write(r,d),await e.remove(n)}catch(d){console.warn("Failed to migrate legacy chat history",d)}}if(!o){let c=[{id:"default",name:"New chat",createdAt:l,updatedAt:l}];await this.writeChatSessionsIndex({version:1,active:"default",sessions:c})}if(o)try{let c=await e.read(i),d=JSON.parse(c),_=Array.isArray(d==null?void 0:d.sessions)?d.sessions:[],u=_.some(y=>(y==null?void 0:y.id)==="default"),m=_.map(y=>(y==null?void 0:y.id)==="default"&&typeof(y==null?void 0:y.name)=="string"&&y.name.trim().toLowerCase()==="default"?{...y,name:"New chat"}:y);u&&JSON.stringify(m)!==JSON.stringify(_)&&await this.writeChatSessionsIndex({version:1,active:typeof(d==null?void 0:d.active)=="string"?d.active:"default",sessions:m.map(y=>({id:String(y.id),name:typeof y.name=="string"?y.name:"New chat",createdAt:typeof y.createdAt=="string"?y.createdAt:l,updatedAt:typeof y.updatedAt=="string"?y.updatedAt:l}))})}catch(c){}}isPlaceholderChatName(e){let n=(e||"").trim().toLowerCase();return n==="new chat"||n==="default"}normalizeChatTitle(e){let n=(e||"").replace(/\s+/g," ").trim();return n.length>60?`${n.slice(0,57)}...`:n}guessTitleFromMessages(e){let n=e.find(i=>i.role==="user"&&i.content.trim());if(!n)return"New chat";let t=n.content.replace(/\s+/g," ").trim().split(" ").slice(0,8).join(" ");return this.normalizeChatTitle(t||"New chat")}async suggestChatTitleWithLlm(e){var a,s,o;let n=(this.settings.chatBaseUrl||"").trim(),t=(this.settings.chatModel||"").trim();if(!n||!t)return null;let i=n.replace(/\/$/,"");if(i.toLowerCase().includes("api.openai.com")&&(!this.settings.chatApiKey||t.includes("/")))return null;try{let l=`${i}/chat/completions`,c={"Content-Type":"application/json"};this.settings.chatApiKey&&(c.Authorization=`Bearer ${this.settings.chatApiKey}`);let d=e.slice(-8).map(b=>`${b.role.toUpperCase()}: ${b.content}`).join(`
`).slice(0,4e3),u=await fetch(l,{method:"POST",headers:c,body:JSON.stringify({model:t,temperature:.2,messages:[{role:"system",content:"Generate a short, specific title (3-7 words) for the chat. No quotes, no punctuation at the end."},{role:"user",content:d}]})});if(!u.ok)return null;let m=await u.json(),y=(o=(s=(a=m==null?void 0:m.choices)==null?void 0:a[0])==null?void 0:s.message)==null?void 0:o.content;return typeof y!="string"?null:this.normalizeChatTitle(y.replace(/^\"|\"$/g,"").trim())}catch(l){return console.warn("Chat title suggestion failed",l),null}}async finalizeChatSessionNameIfNeeded(e,n,t={}){var c;if(!e)return;let i=n||[];if(!i.some(d=>d.role==="user"&&d.content.trim())||!t.force&&i.length<4)return;let s=((c=(await this.readChatSessionsIndex()).sessions)!=null?c:[]).find(d=>d.id===e);if(!s||!this.isPlaceholderChatName(s.name))return;let l=await this.suggestChatTitleWithLlm(i)||this.guessTitleFromMessages(i);!l||this.isPlaceholderChatName(l)||await this.renameChatSession(e,l)}async runRagQueryStreaming(e,n,t,i=[]){if(await this.ensureBundledTools(),!await this.ensureRedisAvailable("chat query")){t({answer:"Redis is not reachable. Please start Redis Stack and try again."});return}let r=this.getPluginDir(),a=E.default.join(r,"tools","rag_query_redisearch.py"),s=["--query",e,"--k","5","--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--chat-base-url",this.settings.chatBaseUrl,"--chat-api-key",this.settings.chatApiKey,"--chat-model",this.settings.chatModel,"--temperature",String(this.settings.chatTemperature),"--stream"];if(this.settings.enableQueryExpansion&&(s.push("--expand-query"),s.push("--expand-count",String(Math.max(1,Math.trunc(this.settings.queryExpansionCount))))),this.settings.enableCrossEncoderRerank){s.push("--rerank");let c=(this.settings.rerankModel||"").trim();c&&s.push("--rerank-model",c)}Number.isFinite(this.settings.rerankCandidateMultiplier)&&s.push("--rerank-candidates",String(Math.max(1,Math.trunc(this.settings.rerankCandidateMultiplier)))),Number.isFinite(this.settings.rrfK)&&s.push("--rrf-k",String(Math.max(1,Math.trunc(this.settings.rrfK)))),Number.isFinite(this.settings.rrfLogTop)&&this.settings.rrfLogTop>0&&s.push("--rrf-log-top",String(Math.max(1,Math.trunc(this.settings.rrfLogTop)))),Number.isFinite(this.settings.maxChunksPerDoc)&&this.settings.maxChunksPerDoc>0&&s.push("--max-per-doc",String(Math.max(1,Math.trunc(this.settings.maxChunksPerDoc)))),this.settings.enableAgenticRag&&(s.push("--agentic","basic"),Number.isFinite(this.settings.agenticMaxIters)&&this.settings.agenticMaxIters>0&&s.push("--agentic-max-iters",String(Math.max(1,Math.trunc(this.settings.agenticMaxIters)))));let o=this.buildChatHistoryPayload(i),l=await this.writeChatHistoryTemp(o);l!=null&&l.absolutePath&&s.push("--history-file",l.absolutePath);try{let c=async()=>{await this.runPythonStreaming(a,s,_=>{if((_==null?void 0:_.type)==="delta"&&typeof _.content=="string"){n(_.content);return}if((_==null?void 0:_.type)==="final"){t(_);return}_!=null&&_.answer&&t(_)},t)},d=!1;for(;;)try{await c();break}catch(_){let u=this.getPythonErrorMessage(_),m=this.classifyIndexingError(u);if(m==="embed_dim_mismatch"){if(d){t({answer:"Embedding dimension mismatch persists after rebuild. Check the embedding model settings."});return}if(!await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema.")){t({answer:"Embedding dimension mismatch. Switch models or drop/rebuild the Redis index."});return}try{if(await this.dropRedisIndex(!0),!await this.reindexRedisFromCache()){let C=this.lastReindexFailure==="embed_failure"?"Embedding provider error detected while rebuilding the index. Fix settings and retry.":"Redis index rebuild did not complete. Chat query stopped.";t({answer:C});return}}catch(b){console.error(b),t({answer:"Failed to drop/rebuild the Redis index. See console for details."});return}d=!0;continue}if(m==="embed_failure"){t({answer:"Embedding provider error detected. Fix the provider/model settings and retry."});return}throw _}}finally{if(l!=null&&l.relativePath)try{await this.app.vault.adapter.remove(l.relativePath)}catch(c){console.warn("Failed to remove chat history temp file",c)}}}buildChatHistoryPayload(e){return this.getRecentChatHistory(e).map(t=>({role:t.role,content:t.content}))}async writeChatHistoryTemp(e){if(!e.length)return null;let n=(0,h.normalizePath)(`${Y}/tmp`);await this.ensureFolder(n);let t=`chat_history_${Date.now()}_${Math.random().toString(36).slice(2,8)}.json`,i=(0,h.normalizePath)(`${n}/${t}`),r={version:1,messages:e};return await this.app.vault.adapter.write(i,JSON.stringify(r,null,2)),{relativePath:i,absolutePath:this.getAbsoluteVaultPath(i)}}async resolveCitationDisplay(e){let n=await this.getDocIndexEntry(e.doc_id);(!n||!n.note_title||!n.zotero_title||!n.note_path||!n.pdf_path||n.short_title===void 0)&&(n=await this.hydrateDocIndexFromCache(e.doc_id));let t=e.doc_id?await this.resolveNotePathForDocId(e.doc_id):n==null?void 0:n.note_path,i=this.resolveCitationTitle(n,t,e.doc_id),r=this.formatCitationPageLabel(e),a=e.page_start?String(e.page_start):"",s=(n==null?void 0:n.pdf_path)||e.source_pdf||"",o=e.attachment_key||(n==null?void 0:n.attachment_key),l=e.annotation_key||this.extractAnnotationKey(e.chunk_id),c=e.doc_id?this.buildZoteroDeepLink(e.doc_id,o,a,l):void 0;return{noteTitle:i,pageLabel:r,notePath:t||void 0,pdfPath:s||void 0,zoteroUrl:c,pageStart:a||void 0}}resolveCitationTitle(e,n,t){let i=t||"?",r=(e==null?void 0:e.short_title)||(e==null?void 0:e.zotero_title)||(e==null?void 0:e.note_title)||(n?E.default.basename(n,".md"):"")||i;return this.shortenCitationTitle(r)}shortenCitationTitle(e){let n=String(e||"").trim();if(!n)return"?";if(n.length<=Xn)return n;let t=Math.max(0,Xn-3);return`${n.slice(0,t).trim()}...`}formatCitationLabel(e,n){let t=e.trim()||"?",i=(n||"").trim();return i?`${t}, p. ${i}`:t}async formatInlineCitations(e,n,t=[]){var c,d,_,u;if(!e)return e;let i=/\[\[?cite:([A-Za-z0-9]+):([^\]\n]+?)\]?\]/g,r=Array.from(e.matchAll(i));if(r.length===0)return e;let a=new Map;for(let m of r){let y=m[0];if(a.has(y))continue;let b=m[1],C=m[2].trim(),f=C.match(/^(\d+)-(\d+)(?::([A-Za-z0-9]+))?$/),v="",x="",w,R,A,S;f?(v=f[1],x=f[2],w=f[3]):S=C;let L=S?t.find(I=>{let N=typeof I.doc_id=="string"?I.doc_id:"";if(N&&N!==b)return!1;let q=typeof I.chunk_id=="string"?I.chunk_id:"";return q?q===S||q===`${b}:${S}`||q.endsWith(`:${S}`):!1}):void 0;L&&(!v&&L.page_start!==void 0&&(v=String(L.page_start)),!x&&L.page_end!==void 0&&(x=String(L.page_end)),!A&&typeof L.attachment_key=="string"&&(A=L.attachment_key),!R&&typeof L.annotation_page_label=="string"&&(R=L.annotation_page_label),!w&&typeof L.chunk_id=="string"&&(w=this.extractAnnotationKey(L.chunk_id)));let z={doc_id:b,chunk_id:L==null?void 0:L.chunk_id,annotation_key:w};A&&(z.attachment_key=A),R&&(z.annotation_page_label=R),(v||x)&&(z.page_start=v||x,z.page_end=x||v,z.pages=`${z.page_start}-${z.page_end}`),L!=null&&L.source_pdf&&(z.source_pdf=String(L.source_pdf));let O=(v||x?n.find(I=>{var N,q;return I.doc_id===b&&String((N=I.page_start)!=null?N:"")===v&&String((q=I.page_end)!=null?q:"")===x}):void 0)||n.find(I=>I.doc_id===b)||z,j=O.annotation_key||w;!O.annotation_key&&j&&(O={...O,annotation_key:j}),!O.attachment_key&&A&&(O={...O,attachment_key:A}),!O.annotation_page_label&&R&&(O={...O,annotation_page_label:R});let F=await this.resolveCitationDisplay(O),M=this.formatCitationLabel(F.noteTitle,F.pageLabel),$=this.normalizeChunkIdForNote(O.chunk_id,b);if(this.settings.preferObsidianNoteForCitations&&F.notePath){if(j){let I=O.attachment_key||A||((d=(c=this.docIndex)==null?void 0:c[b])==null?void 0:d.attachment_key)||"",N=O.page_start?String(O.page_start):v||x||"0",q=this.buildNoteAnnotationLink(F.notePath,j,I,N,M);if(q){a.set(y,q);continue}a.set(y,this.buildNoteLink(F.notePath,M));continue}if($&&!j){a.set(y,this.buildNoteChunkLink(F.notePath,$,M));continue}}if(F.zoteroUrl)a.set(y,`[${M}](${F.zoteroUrl})`);else{let I=this.formatCitationLabel(b,F.pageLabel);a.set(y,`(${I})`)}}let s=[],o=0;for(let m of r){let y=m[0],b=(_=m.index)!=null?_:0;if(b<o)continue;s.push(e.slice(o,b));let C=(u=a.get(y))!=null?u:y,f=b>0?e[b-1]:"";f&&!/\s/.test(f)&&!/[\(\[\{!]/.test(f)&&s.push(" "),s.push(C),o=b+y.length}s.push(e.slice(o));let l=s.join("");return this.repairTruncatedWikilinks(l)}repairTruncatedWikilinks(e){if(!e||typeof e!="string")return e;let n=e;return n=n.replace(/\[\[([^\]\n#]+#zrr-chunk:[^\]\n|]+)(?=\n|$)/g,"[[$1]]"),n=n.replace(/\[\[([^\]\n#]+#zrr-chunk:([^\]\n|]+))\]\]/g,(t,i,r)=>{let a=this.escapeWikiLabel(this.buildDefaultChunkLabel(String(r||"").trim()));return`[[${i}\\|${a}]]`}),n}buildDefaultChunkLabel(e){let n=(e||"").trim(),t=n.match(/^p(\d+)$/i);return t?`p. ${t[1]}`:n||"source"}handleDoclingProgress(e,n){if(!e||e.type!=="progress")return;let t=Number(e.percent);if(!Number.isFinite(t))return;let i=typeof e.message=="string"&&e.message.trim()?e.message:"Docling extraction...";this.showStatusProgress(this.formatStatusLabel(i,n),Math.round(t))}async createChatNoteFromSession(e,n,t){let i=this.getChatExportDir();await this.ensureFolder(i),await this.getDocIndex();let r=this.sanitizeFileName(n)||"Zotero Chat",a=this.formatTimestamp(new Date),s=(0,h.normalizePath)(`${i}/${r}.md`),o=await this.resolveUniqueNotePath(s,`${r}-${a}.md`),l=await this.buildChatTranscript(n,t);await this.app.vault.adapter.write(o,l),await this.openNoteInNewTab(o),new h.Notice(`Chat copied to ${o}`)}async buildChatTranscript(e,n){var i,r,a;let t=[];t.push(`# ${e||"Zotero Chat"}`),t.push(""),t.push(`Created: ${new Date().toISOString()}`),t.push("");for(let s of n){let o=s.role==="user"?"## You":"## Assistant";t.push(o),t.push("");let l=s.role==="assistant"?await this.formatInlineCitations(s.content||"",(i=s.citations)!=null?i:[],(r=s.retrieved)!=null?r:[]):s.content||"";if(t.push(l.trim()),t.push(""),s.role==="assistant"&&((a=s.citations)!=null&&a.length)){t.push("### Relevant context sources");let c=this.formatCitationsMarkdown(s.citations);c&&(t.push(c),t.push(""))}}return t.join(`
`).trim()+`
`}async resolveUniqueNotePath(e,n){let t=this.app.vault.adapter;if(!await t.exists(e))return e;let i=E.default.dirname(e),r=(0,h.normalizePath)(E.default.join(i,n));if(!await t.exists(r))return r;let a=2;for(;a<1e3;){let s=(0,h.normalizePath)(E.default.join(i,`${E.default.basename(n,".md")}-${a}.md`));if(!await t.exists(s))return s;a+=1}return r}formatTimestamp(e){let n=t=>String(t).padStart(2,"0");return[e.getFullYear(),n(e.getMonth()+1),n(e.getDate()),"-",n(e.getHours()),n(e.getMinutes())].join("")}async openCitationTarget(e,n){var s,o;let t=n!=null?n:await this.resolveCitationDisplay(e),i=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id),r=e.annotation_key||this.extractAnnotationKey(e.chunk_id);if(this.settings.preferObsidianNoteForCitations&&t.notePath){if(r){let l=e.attachment_key||((o=(s=this.docIndex)==null?void 0:s[e.doc_id||""])==null?void 0:o.attachment_key)||"",c=e.page_start?String(e.page_start):e.page_end?String(e.page_end):"0";if(await this.openNoteAtAnnotation(t.notePath,r,l,c))return}if(i&&!r&&await this.openNoteAtChunk(t.notePath,i))return;await this.openNoteInMain(t.notePath);return}if(t.zoteroUrl){this.openExternalUrl(t.zoteroUrl);return}if(!(t.pdfPath&&await this.openPdfInMain(t.pdfPath,t.pageStart))){if(t.zoteroUrl){this.openExternalUrl(t.zoteroUrl);return}new h.Notice("Unable to open citation target.")}}async rebuildNoteFromCache(){let e=await this.promptDocId();if(!e){new h.Notice("No doc_id provided.");return}await this.rebuildNoteFromCacheForDocId(e,!0)&&new h.Notice(`Rebuilt Zotero note for ${e}.`)}async reindexCurrentNoteFromCache(){let e=this.app.workspace.getActiveFile();if(!e){new h.Notice("No active note to reindex.");return}await this.reindexNoteFromCacheForFile(e,!0)}async reindexNoteFromCacheForFile(e,n){try{let t=await this.app.vault.read(e),i=await this.resolveDocIdForNote(e,t);if(!i){n&&new h.Notice("No doc_id found for this note.");return}await this.reindexDocIdFromCache(i,n)&&n&&new h.Notice(`Reindexed ${i}.`)}catch(t){n&&new h.Notice("Failed to reindex note."),console.error("Failed to reindex note",t)}}async rebuildDocIndexFromCache(){var c,d,_;let e=this.app.vault.adapter,n=await this.listDocIds(te),t=await this.listDocIds(H),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),r=Object.keys(i),a=Array.from(new Set([...n,...t,...r]));if(a.length===0){new h.Notice("No cached items found.");return}this.showStatusProgress("Rebuilding doc index...",0);let s=await this.getDocIndex(),o=0;for(let u of a){o+=1;let m={},y=i[u];y&&(m.note_path=y.note_path,m.note_title=y.note_title);let b=(0,h.normalizePath)(`${te}/${u}.json`);if(await e.exists(b))try{let v=await e.read(b),x=JSON.parse(v),w=(d=(c=x==null?void 0:x.data)!=null?c:x)!=null?d:{},R=typeof w.title=="string"?w.title:"";R&&(m.zotero_title=R);let A=me(w);A&&(m.short_title=A);let S=this.sanitizeFileName(R)||u,L=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${S}.md`),z=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${S}-${u}.md`);await e.exists(L)?(m.note_path=L,m.note_title=E.default.basename(L,".md")):await e.exists(z)&&(m.note_path=z,m.note_title=E.default.basename(z,".md"))}catch(v){console.error("Failed to read cached item JSON",v)}let C=(0,h.normalizePath)(`${H}/${u}.json`);if(await e.exists(C))try{let v=await e.read(C),x=JSON.parse(v);typeof(x==null?void 0:x.source_pdf)=="string"&&(m.pdf_path=x.source_pdf)}catch(v){console.error("Failed to read cached chunks JSON",v)}if(Object.keys(m).length>0){let x={...(_=s[u])!=null?_:{doc_id:u},...m,doc_id:u,updated_at:new Date().toISOString()};!x.note_title&&x.note_path&&(x.note_title=E.default.basename(x.note_path,".md")),typeof x.pdf_path=="string"&&(x.pdf_path=this.normalizeDocIndexPdfPath(x.pdf_path)),s[u]=x}let f=Math.round(o/a.length*100);this.showStatusProgress(`Rebuilding doc index ${o}/${a.length}`,f)}await this.saveDocIndex(s);let l=await this.pruneDocIndexOrphans();this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),l.removed>0?new h.Notice(`Rebuilt doc index for ${a.length} items; pruned ${l.removed} stale entries.`):new h.Notice(`Rebuilt doc index for ${a.length} items.`)}async recreateMissingNotesFromCache(){if(this.recreateMissingNotesActive){new h.Notice("Recreate missing notes is already running.");return}this.recreateMissingNotesActive=!0,this.recreateMissingNotesAbort=!1,this.recreateMissingNotesProcess=null;try{let e=this.app.vault.adapter,n=await this.listDocIds(te),t=await this.listDocIds(H),i=await this.scanNotesForDocIds(this.settings.outputNoteDir),r=Object.keys(i),a=Array.from(new Set([...n,...t,...r]));if(a.length===0){new h.Notice("No cached items found.");return}let s=[];for(let c of a){if(i[c])continue;let d=await this.getDocIndexEntry(c);if(d!=null&&d.note_path&&await e.exists(d.note_path))continue;let _=await this.inferNotePathFromCache(c);_&&await e.exists(_)||s.push(c)}if(s.length===0){new h.Notice("No missing notes detected.");return}this.showStatusProgress("Recreating missing notes...",0);let o=0,l=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;for(let c=0;c<s.length&&!this.recreateMissingNotesAbort;c+=1){let d=s[c],_=Math.round((c+1)/s.length*100);this.showStatusProgress(`Recreating ${c+1}/${s.length}`,_),l&&this.appendToLogFile(l,`Recreate missing note doc_id ${d} (${c+1}/${s.length})`,"recreate_missing_notes","INFO"),await this.rebuildNoteFromCacheForDocId(d,!1)&&(o+=1)}this.recreateMissingNotesAbort?(this.showStatusProgress("Canceled",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new h.Notice(`Canceled after ${o}/${s.length} notes.`)):(this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new h.Notice(`Recreated ${o}/${s.length} missing notes.`))}finally{this.recreateMissingNotesActive=!1,this.recreateMissingNotesProcess=null}}cancelRecreateMissingNotesFromCache(){if(!this.recreateMissingNotesActive){new h.Notice("No recreate job is running.");return}this.recreateMissingNotesAbort=!0;let e=this.recreateMissingNotesProcess;if(e&&!e.killed){try{e.kill("SIGTERM")}catch(n){console.warn("Failed to terminate recreate process",n)}window.setTimeout(()=>{if(e&&!e.killed)try{e.kill("SIGKILL")}catch(n){console.warn("Failed to force-kill recreate process",n)}},2e3)}new h.Notice("Canceling recreate missing notes...")}buildRedisCommand(e){let n=[`*${e.length}\r
`];for(let t of e){let i=String(t);n.push(`$${Buffer.byteLength(i)}\r
${i}\r
`)}return n.join("")}async checkRedisConnectionWithUrl(e,n=2e3){let t=(e||"").trim();if(!t)return{ok:!1,message:"Redis URL is not configured."};let i;try{i=new URL(t)}catch(c){return{ok:!1,message:"Redis URL is invalid."}}let r=i.hostname||"127.0.0.1",a=Number(i.port)||(i.protocol==="rediss:"||i.protocol==="redis+tls:"?6380:6379),s=decodeURIComponent(i.username||""),o=decodeURIComponent(i.password||""),l=i.protocol==="rediss:"||i.protocol==="redis+tls:";return new Promise(c=>{let d=l?tt.default.connect({host:r,port:a,timeout:n,rejectUnauthorized:!1}):Ae.default.createConnection({host:r,port:a,timeout:n}),_="",u=o||s?"auth":"ping",m=!1,y=(C,f)=>{if(!m){m=!0;try{d.end(),d.destroy()}catch(v){}c({ok:C,message:f})}},b=C=>{let f=C.trim();if(f){if(f.startsWith("-NOAUTH")){y(!1,"Redis requires authentication. Check your Redis URL credentials.");return}if(f.startsWith("-WRONGPASS")||f.toLowerCase().includes("invalid password")){y(!1,"Redis authentication failed. Check your Redis URL credentials.");return}if(f.startsWith("-ERR")){y(!1,`Redis error: ${f}`);return}if(u==="auth"){if(f.startsWith("+OK")){u="ping",_="",d.write(this.buildRedisCommand(["PING"]));return}y(!1,`Redis auth failed: ${f}`);return}f.startsWith("+PONG")&&y(!0)}};d.on("connect",()=>{if(u==="auth"){let C=s?["AUTH",s,o]:["AUTH",o];d.write(this.buildRedisCommand(C))}else d.write(this.buildRedisCommand(["PING"]))}),d.on("data",C=>{var v;_+=C.toString();let f=_.split(/\r?\n/);_=(v=f.pop())!=null?v:"";for(let x of f)b(x)}),d.on("timeout",()=>{y(!1,"Timed out connecting to Redis.")}),d.on("error",C=>{y(!1,`Redis connection failed: ${C.message}`)}),d.on("close",()=>{m||y(!1,"Redis connection closed unexpectedly.")})})}async checkRedisConnection(e=2e3){return this.checkRedisConnectionWithUrl(this.settings.redisUrl,e)}async ensureRedisAvailable(e){let n=await this.checkRedisConnection();if(n.ok)return!0;let t=n.message?`Redis unavailable for ${e}: ${n.message}`:`Redis unavailable for ${e}.`;return this.notifyContainerOnce(t),!1}getPythonErrorMessage(e){if(e instanceof Error)return e.message||String(e);if(typeof e=="string")return e;try{return JSON.stringify(e)}catch(n){return String(e)}}classifyIndexingError(e){let n=e.toLowerCase();return n.includes("embedding dim mismatch")||n.includes("dim mismatch")?"embed_dim_mismatch":n.includes("chunks json not found")?"chunks_missing":n.includes("embedding failed")||n.includes("embedding request failed")||n.includes("unloaded")||n.includes("crashed")||n.includes("model does not exist")||n.includes("failed to load model")||n.includes("connection refused")||n.includes("econnrefused")||n.includes("max retries exceeded")||n.includes("failed to establish a new connection")||n.includes("failed to fetch models")?"embed_failure":"unknown"}async confirmRebuildIndex(e){return new Promise(n=>{new Ge(this.app,e,n).open()})}async confirmPurgeRedisOrphans(){return new Promise(e=>{new We(this.app,e).open()})}async dropRedisIndex(e=!1){await this.ensureBundledTools();let n=this.getPluginDir(),t=E.default.join(n,"tools","drop_redis_index.py"),i=["--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName()];e&&i.push("--drop-docs"),await this.runPython(t,i)}async dropAndRebuildRedisIndex(){if(this.reindexCacheActive){new h.Notice("Reindex already running.");return}if(!(!await this.ensureRedisAvailable("drop/rebuild")||!await this.confirmRebuildIndex("This will remove the current RedisSearch index and rebuild it from cached chunks."))){try{await this.dropRedisIndex(!0)}catch(n){let t=n instanceof Error?n.message:String(n);if(t.includes("Unknown Index name")||t.includes("Unknown index name"))console.warn("Redis index missing; skipping drop step.");else{console.error("Failed to drop Redis index",n),new h.Notice("Failed to drop Redis index. See console for details.");return}}await this.reindexRedisFromCache()}}async purgeRedisOrphanedKeys(){var r,a,s,o,l;if(!await this.ensureRedisAvailable("purge orphans")||!await this.confirmPurgeRedisOrphans())return;try{await this.ensureBundledTools()}catch(c){new h.Notice("Failed to sync bundled tools. See console for details."),console.error(c);return}let n=this.getPluginDir(),t=E.default.join(n,"tools","purge_redis_orphans.py"),i=["--redis-url",this.settings.redisUrl,"--key-prefix",this.getRedisKeyPrefix(),"--chunk-dir",this.getAbsoluteVaultPath(H),"--item-dir",this.getAbsoluteVaultPath(te)];try{let c=await this.runPythonWithOutput(t,i),d=null;try{d=c?JSON.parse(c):null}catch(y){console.warn("Failed to parse purge output",y)}if(!d){new h.Notice("Purge completed. See console for details.");return}let _=[`Keys scanned: ${(r=d.keys_scanned)!=null?r:0}`,`Keys deleted: ${(a=d.keys_deleted)!=null?a:0}`,`Docs checked: ${(s=d.docs_checked)!=null?s:0}`,`Orphan docs: ${(o=d.orphan_doc_count)!=null?o:0}`],u=await this.pruneDocIndexOrphans();_.push(`Doc index entries removed: ${u.removed}`),u.updated>0&&_.push(`Doc index entries updated: ${u.updated}`);let m=Array.isArray(d.sample_orphan_doc_ids)?d.sample_orphan_doc_ids.filter(Boolean):[];m.length&&_.push("","Sample doc_ids:",...m.map(y=>`- ${y}`)),new ye(this.app,"Redis orphan purge",_.join(`
`)).open(),((l=d.keys_deleted)!=null?l:0)===0?new h.Notice("No orphaned Redis keys found."):new h.Notice(`Deleted ${d.keys_deleted} Redis keys.`)}catch(c){console.error("Failed to purge Redis orphans",c),new h.Notice("Failed to purge Redis orphans. See console for details.")}}async reindexRedisFromCache(){if(this.lastReindexFailure=null,this.reindexCacheActive)return new h.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;let e=null,n=0;try{await this.ensureBundledTools()}catch(o){return new h.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let t=await this.listDocIds(H);if(t.length===0)return new h.Notice("No cached chunks found."),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let i=this.getPluginDir(),r=E.default.join(i,"tools","index_redisearch.py"),a=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null,s=0;this.showStatusProgress("Reindexing cached chunks...",0),a&&this.appendToLogFile(a,`Reindex started: ${t.length} cached items`,"index_redisearch","INFO");for(let o of t){s+=1;let l=Math.round(s/t.length*100);this.showStatusProgress(`Reindexing ${s}/${t.length}`,l);let c=(0,h.normalizePath)(`${H}/${o}.json`);try{let d=["--chunks-json",this.getAbsoluteVaultPath(c),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(d),this.appendEmbedContextArgs(d),this.settings.embedIncludeMetadata&&d.push("--embed-include-metadata"),this.appendChunkTaggingArgs(d,{allowRegenerate:!1}),a&&this.appendToLogFile(a,`Reindexing doc_id ${o}`,"index_redisearch","INFO"),await this.runPythonStreaming(r,d,_=>{!a||!_||(_==null?void 0:_.type)==="progress"&&_.message&&this.appendToLogFile(a,String(_.message),"index_redisearch","INFO")},()=>{},a,"index_redisearch")}catch(d){n+=1;let _=this.getPythonErrorMessage(d),u=this.classifyIndexingError(_);if(console.error(`Failed to reindex ${o}`,d),u==="chunks_missing"){new h.Notice(`Chunks cache missing for ${o}. Reimport or rebuild this note.`);continue}if(u==="embed_dim_mismatch"){e={kind:"embed_dim_mismatch",message:_};break}if(u==="embed_failure"){e={kind:"embed_failure",message:_};break}}}if(e){if(this.showStatusProgress("Aborted",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,e.kind==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(l){return new h.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error(l),this.lastReindexFailure="unknown",!1}this.lastReindexFailure="embed_dim_mismatch"}else new h.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing."),this.lastReindexFailure="embed_failure";return!1}this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),n===0?new h.Notice(`Reindexed ${t.length} cached items.`):new h.Notice(`Reindexed ${t.length-n}/${t.length} items (see console).`);try{await this.pruneDocIndexOrphans()}catch(o){console.warn("Failed to prune doc index orphans",o)}return this.reindexCacheActive=!1,this.lastReindexFailure=null,!0}async reindexDocIdFromCache(e,n){if(this.lastReindexFailure=null,this.reindexCacheActive)return n&&new h.Notice("Reindex already running."),this.lastReindexFailure="busy",!1;this.reindexCacheActive=!0;try{await this.ensureBundledTools()}catch(o){return n&&new h.Notice("Failed to sync bundled tools. See console for details."),console.error(o),this.reindexCacheActive=!1,this.lastReindexFailure="tools_error",!1}if(!await this.ensureRedisAvailable("reindex"))return this.reindexCacheActive=!1,this.lastReindexFailure="redis_unavailable",!1;let t=(0,h.normalizePath)(`${H}/${e}.json`);if(!await this.app.vault.adapter.exists(t))return n&&new h.Notice(`Chunks cache missing for ${e}.`),this.reindexCacheActive=!1,this.lastReindexFailure="no_cache",!1;let r=this.getPluginDir(),a=E.default.join(r,"tools","index_redisearch.py"),s=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;this.showStatusProgress(`Reindexing ${e}...`,0),s&&this.appendToLogFile(s,`Reindexing doc_id ${e}`,"index_redisearch","INFO");try{let o=["--chunks-json",this.getAbsoluteVaultPath(t),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(o),this.appendEmbedContextArgs(o),this.settings.embedIncludeMetadata&&o.push("--embed-include-metadata"),this.appendChunkTaggingArgs(o,{allowRegenerate:!1}),await this.runPythonStreaming(a,o,l=>{if((l==null?void 0:l.type)==="progress"&&l.total){let c=Math.round(l.current/l.total*100),d=typeof l.message=="string"&&l.message.trim()?l.message:`Indexing chunks ${l.current}/${l.total}`;this.showStatusProgress(this.formatStatusLabel(d),c)}},()=>{},s,"index_redisearch")}catch(o){let l=this.getPythonErrorMessage(o),c=this.classifyIndexingError(l);if(console.error(`Failed to reindex ${e}`,o),c==="embed_dim_mismatch"){if(this.lastReindexFailure="embed_dim_mismatch",n&&await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{return await this.dropRedisIndex(!0),this.reindexCacheActive=!1,await this.reindexRedisFromCache()}catch(_){new h.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error(_),this.lastReindexFailure="unknown"}}else c==="embed_failure"?(this.lastReindexFailure="embed_failure",n&&new h.Notice("Embedding provider error detected. Fix the provider/model settings and rerun reindexing.")):n&&new h.Notice(`Failed to reindex ${e}. See console for details.`);return this.showStatusProgress("Failed",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!1}return this.showStatusProgress("Done",100),window.setTimeout(()=>this.clearStatusProgress(),1200),this.reindexCacheActive=!1,!0}async reindexChunkUpdates(e,n,t,i){if(!t.length&&!i.length||!await this.ensureRedisAvailable("reindex updates"))return;let r=this.getPluginDir(),a=E.default.join(r,"tools","index_redisearch.py"),s=["--chunks-json",this.getAbsoluteVaultPath(n),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert"];this.appendEmbedSubchunkArgs(s),this.appendEmbedContextArgs(s),this.settings.embedIncludeMetadata&&s.push("--embed-include-metadata"),this.appendChunkTaggingArgs(s,{allowRegenerate:!1}),t.length&&s.push("--chunk-ids",t.join(",")),i.length&&s.push("--delete-chunk-ids",i.join(","));try{await this.runPython(a,s)}catch(o){let l=this.getPythonErrorMessage(o),c=this.classifyIndexingError(l);if(console.error(`Failed to reindex updated chunks for ${e}`,o),c==="embed_dim_mismatch"){if(await this.confirmRebuildIndex("Embedding model output dimension does not match the Redis index schema."))try{await this.dropRedisIndex(!0),await this.reindexRedisFromCache()}catch(_){new h.Notice("Failed to drop/rebuild the Redis index. See console for details."),console.error(_)}return}c==="embed_failure"&&new h.Notice("Embedding provider error detected. Fix the provider/model settings and rerun.")}}async promptZoteroItem(){return new Promise(e=>{new Ye(this.app,this,e).open()})}async listDocIds(e){let n=this.app.vault.adapter,t=(0,h.normalizePath)(e);return await n.exists(t)?(await n.list(t)).files.filter(r=>r.endsWith(".json")).map(r=>E.default.basename(r,".json")):[]}async listMarkdownFiles(e){let n=this.app.vault.adapter,t=(0,h.normalizePath)(e);if(!await n.exists(t))return[];let i=[t],r=[];for(;i.length>0;){let a=i.pop();if(!a)continue;let s=await n.list(a);for(let o of s.files)o.endsWith(".md")&&r.push(o);for(let o of s.folders)i.push(o)}return r}getZoteroFrontmatterKeyVariants(e){let n=e.replace(/_/g," "),t=new Set([n,e,e.replace(/_/g,"-")]);if(e.includes("_")){let i=e.split("_"),r=i[0]+i.slice(1).map(a=>a.charAt(0).toUpperCase()+a.slice(1)).join("");t.add(r)}return Array.from(t)}getFrontmatterValue(e,n){if(!e)return;let t=this.getZoteroFrontmatterKeyVariants(n);for(let i of t)if(Object.prototype.hasOwnProperty.call(e,i))return e[i]}hasFrontmatterKey(e,n){if(!e)return!1;let t=this.getZoteroFrontmatterKeyVariants(n);for(let i of t)if(Object.prototype.hasOwnProperty.call(e,i))return!0;return!1}normalizeZoteroFrontmatterKeys(e){let n=!1;for(let t of Qn){let i=t.replace(/_/g," "),r=this.getZoteroFrontmatterKeyVariants(t),a=Object.prototype.hasOwnProperty.call(e,i),s=a?e[i]:void 0;if(!a){for(let o of r)if(o!==i&&Object.prototype.hasOwnProperty.call(e,o)){s=e[o];break}}if(s!==void 0){a||(e[i]=s,n=!0);for(let o of r)o!==i&&Object.prototype.hasOwnProperty.call(e,o)&&(delete e[o],n=!0)}}return n}async normalizeZoteroFrontmatterKeysInFile(e){let n=this.app.metadataCache.getFileCache(e),t=n==null?void 0:n.frontmatter;if(!t)return;let i=this.getFrontmatterValue(t,"doc_id"),r=this.getFrontmatterValue(t,"zotero_key");if(!i&&!r)return;let a={...t};if(!this.normalizeZoteroFrontmatterKeys(a))return;let s=e.path;this.noteSyncSuppressed.add(s),this.noteMetadataSyncSuppressed.add(s);try{await this.app.fileManager.processFrontMatter(e,o=>{this.normalizeZoteroFrontmatterKeys(o)})}catch(o){console.warn("Failed to normalize Zotero frontmatter keys",o)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(s),this.noteMetadataSyncSuppressed.delete(s)},1500)}}normalizeFrontmatterKeySpacing(e){return e.trim()?e.split(/\r?\n/).map(i=>{var l,c;if(/^\s+-\s+/.test(i)||!i.includes(":")||((c=(l=i.match(/^\s*/))==null?void 0:l[0])!=null?c:""))return i;let a=i.indexOf(":");if(a<=0)return i;let s=i.slice(0,a).trim(),o=i.slice(a);for(let d of Qn){let _=d.replace(/_/g," ");if(this.getZoteroFrontmatterKeyVariants(d).includes(s))return`${_}${o}`}return i}).join(`
`):e}extractDocIdFromFrontmatter(e){let n=e.match(/^---\s*\n([\s\S]*?)\n---/);if(!n)return null;let i=n[1].split(/\r?\n/);for(let r of i){let a=r.trim();if(!a||a.startsWith("#"))continue;let s=a.split(":");if(s.length<2)continue;let o=s[0].trim().toLowerCase();if(o!=="doc_id"&&o!=="doc id"&&o!=="doc-id"&&o!=="zotero_key"&&o!=="zotero key"&&o!=="zotero-key")continue;let c=a.slice(a.indexOf(":")+1).trim().replace(/^["']|["']$/g,"").trim();if(c)return c}return null}hasDocIdFieldInFrontmatter(e){let n=e.match(/^---\s*\n([\s\S]*?)\n---/);return n?/^\s*doc(?:[_\s-]?id)\s*:/im.test(n[1]):!1}ensureDocIdInFrontmatter(e,n){let t=e.trim(),i=`doc id: ${this.escapeYamlString(n)}`;return t?/^\s*doc(?:[_\s-]?id)\s*:/im.test(t)?t:`${i}
${t}`:i}ensureDocIdInNoteContent(e,n){var u,m;let t=e.match(/^---\s*\n([\s\S]*?)\n---\s*\n?/),i=`doc id: ${this.escapeYamlString(n)}`;if(!t)return`---
${i}
---

${e.trimStart()}`;let a=((u=t[1])!=null?u:"").split(/\r?\n/),s=!1,o=a.map(y=>/^\s*doc(?:[_\s-]?id)\s*:/i.test(y)?(s=!0,i):y);s||o.unshift(i);let l=o.join(`
`).trim(),c=(m=t.index)!=null?m:0,d=e.slice(0,c),_=e.slice(c+t[0].length).replace(/^\n+/,"");return`${d}---
${l}
---
${_}`}async findDocIdByNotePath(e){let n=(0,h.normalizePath)(e),t=await this.getDocIndex();for(let[i,r]of Object.entries(t))if(r!=null&&r.note_path&&(0,h.normalizePath)(r.note_path)===n)return i;return null}async resolveDocIdForNote(e,n){let t=this.extractDocIdFromFrontmatter(n),i=this.hasDocIdFieldInFrontmatter(n);if(t&&i)return t;let r=this.extractDocIdFromSyncMarker(n),a=await this.findDocIdByNotePath(e.path),s=t||r||a;if(!s)return ue.test(n)&&!this.missingDocIdWarned.has(e.path)&&(new h.Notice("This Zotero note is missing a doc_id in frontmatter. Reimport or add doc_id manually."),this.missingDocIdWarned.add(e.path)),null;if(!i||!t){let o=this.ensureDocIdInNoteContent(n,s);o!==n&&await this.writeNoteWithSyncSuppressed(e.path,o)}return s}async scanNotesForDocIds(e){var r;let n=this.app.vault.adapter,t=await this.listMarkdownFiles(e),i={};for(let a of t)try{let s=await n.read(a),o=(r=this.extractDocIdFromFrontmatter(s))!=null?r:this.extractDocIdFromSyncMarker(s);if(!o)continue;i[o]={doc_id:o,note_path:a,note_title:E.default.basename(a,".md"),updated_at:new Date().toISOString()}}catch(s){console.error("Failed to read note for doc_id scan",s)}return i}setupStatusBar(){let e=this.addStatusBarItem();e.addClass("zrr-status-progress"),e.addClass("status-bar-item-segment"),e.style.display="none";let n=e.createEl("span",{text:"Idle"});n.addClass("zrr-status-label");let i=e.createEl("div",{cls:"zrr-status-bar"}).createEl("div",{cls:"zrr-status-bar-inner"});this.statusBarEl=e,this.statusLabelEl=n,this.statusBarInnerEl=i}showStatusProgress(e,n){if(!(!this.statusBarEl||!this.statusLabelEl||!this.statusBarInnerEl))if(this.statusBarEl.style.display="flex",this.statusLabelEl.setText(e),n===null)this.statusBarInnerEl.addClass("indeterminate"),this.statusBarInnerEl.style.width="40%";else{this.statusBarInnerEl.removeClass("indeterminate");let t=Math.max(0,Math.min(100,n));this.statusBarInnerEl.style.width=`${t}%`}}clearStatusProgress(){!this.statusBarEl||!this.statusBarInnerEl||(this.statusBarEl.style.display="none",this.statusBarInnerEl.removeClass("indeterminate"),this.statusBarInnerEl.style.width="0%")}formatStatusLabel(e,n){return n?`${e} (Text layer quality ${n})`:e}async readDoclingQualityLabel(e){var n,t,i;try{let r=await this.app.vault.adapter.read(e),a=JSON.parse(r),s=(i=(n=a==null?void 0:a.metadata)==null?void 0:n.effective_confidence_proxy)!=null?i:(t=a==null?void 0:a.metadata)==null?void 0:t.confidence_proxy;if(typeof s=="number")return s.toFixed(2)}catch(r){console.warn("Failed to read Docling quality metadata",r)}return null}async readDoclingMetadata(e){try{let n=await this.app.vault.adapter.read(e),t=JSON.parse(n),i=t==null?void 0:t.metadata;if(i&&typeof i=="object")return i}catch(n){console.warn("Failed to read Docling metadata",n)}return null}async readDoclingQualityLabelFromPdf(e,n){var t;try{let i=this.getPluginDir(),r=E.default.join(i,"tools","docling_extract.py"),a=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,s=["--quality-only","--pdf",e,"--ocr",a],o=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;o&&s.push("--log-file",o),this.settings.ocrMode==="force_low_quality"&&s.push("--force-ocr-low-quality"),s.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),n&&s.push("--language-hint",n);let l=await this.runPythonWithOutput(r,s,o),c=JSON.parse(l),d=(t=c==null?void 0:c.effective_confidence_proxy)!=null?t:c==null?void 0:c.confidence_proxy;if(typeof d=="number")return d.toFixed(2)}catch(i){console.warn("Failed to read Docling quality from PDF",i)}return null}async promptDocId(){return new Promise(e=>{new ke(this.app,"Rebuild Zotero note from cache","Enter Zotero doc_id (e.g., ABC123)",n=>e(n),"Doc ID cannot be empty.").open()})}async promptLanguageHint(){return new Promise(e=>{new Xe(this.app,e).open()})}registerRibbonIcons(){(0,h.addIcon)("zrr-picker",vt),(0,h.addIcon)("zrr-chat",wt),(0,h.addIcon)("zrr-pdf",Hn),this.addRibbonIcon("zrr-picker","Import Zotero item and index",()=>this.importZoteroItem()).addClass("zrr-ribbon-picker"),this.addRibbonIcon("zrr-chat","Open Zotero RAG chat",()=>this.openChatView(!0)).addClass("zrr-ribbon-chat")}async confirmOverwrite(e){return new Promise(n=>{new Ue(this.app,e,n).open()})}async resolveLanguageHint(e,n){let t=typeof e.language=="string"?e.language:"",i=this.normalizeZoteroLanguage(t);if(i)return i;let r=await this.promptLanguageHint();if(r===null)return console.info("Language selection canceled."),null;let a=this.normalizeZoteroLanguage(r);if(!a)return console.info("Language selection empty; skipping Zotero update."),"";if(e.language=a,console.info("Language selected",{language:a,itemKey:n}),n)try{await this.updateZoteroItemLanguage(n,e,a),new h.Notice("Saved language to Zotero.")}catch(s){new h.Notice("Failed to write language back to Zotero."),console.error(s)}else console.warn("Language selected but itemKey is missing; skipping Zotero update.");return a}normalizeZoteroLanguage(e){return(e||"").trim().toLowerCase()}buildDoclingLanguageHint(e){let n=this.normalizeZoteroLanguage(e!=null?e:"");if(!n)return null;let t=n.split(/[^a-z]+/).filter(Boolean),i=t.some(a=>["de","deu","ger","german"].includes(a)),r=t.some(a=>["en","eng","english"].includes(a));return i&&r?"deu+eng":i?"deu":r?"eng":t.length===1&&Wn[t[0]]?Wn[t[0]]:n}async fetchZoteroItem(e){try{let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),t=await this.requestLocalApi(n,`Zotero item fetch failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(n){return console.warn("Failed to fetch Zotero item from local API",n),this.canUseWebApi()?this.fetchZoteroItemWeb(e):null}}async fetchZoteroItemCsl(e){try{let n=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}?format=csljson`),t=await this.requestLocalApi(n,`Zotero CSL fetch failed for ${n}`);return this.parseCslPayload(t)}catch(n){return console.warn("Failed to fetch Zotero CSL from local API",n),this.canUseWebApi()?this.fetchZoteroItemCslWeb(e):null}}async fetchZoteroCollectionTitle(e){var r,a,s,o,l,c;let n=(e||"").trim();if(!n)return"";let t=this.collectionTitleCache.get(n);if(t!==void 0)return t;let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/collections/${n}`);try{let d=await this.requestLocalApi(i,`Zotero collection fetch failed for ${i}`),_=JSON.parse(d.toString("utf8")),u=String((s=(a=(r=_==null?void 0:_.data)==null?void 0:r.name)!=null?a:_==null?void 0:_.name)!=null?s:"").trim();return this.collectionTitleCache.set(n,u),u}catch(d){if(!this.canUseWebApi())return this.collectionTitleCache.set(n,""),"";try{let _=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/collections/${n}`),u=await this.requestWebApi(_,`Zotero Web API collection fetch failed for ${_}`),m=JSON.parse(u.toString("utf8")),y=String((c=(l=(o=m==null?void 0:m.data)==null?void 0:o.name)!=null?l:m==null?void 0:m.name)!=null?c:"").trim();return this.collectionTitleCache.set(n,y),y}catch(_){return console.warn("Failed to fetch Zotero collection title",_),this.collectionTitleCache.set(n,""),""}}}async resolveCollectionTitles(e){let t=(Array.isArray(e.collections)?e.collections:[]).map(r=>String(r||"").trim()).filter(Boolean);if(!t.length)return[];let i=[];for(let r of t){let a=await this.fetchZoteroCollectionTitle(r);a&&i.push(a)}return i}async fetchZoteroItemWeb(e){try{let n=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}`),t=await this.requestWebApi(n,`Zotero Web API fetch failed for ${n}`);return JSON.parse(t.toString("utf8"))}catch(n){return console.warn("Failed to fetch Zotero item from Web API",n),null}}async fetchZoteroItemCslWeb(e){try{let n=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}?format=csljson`),t=await this.requestWebApi(n,`Zotero Web API CSL fetch failed for ${n}`);return this.parseCslPayload(t)}catch(n){return console.warn("Failed to fetch Zotero CSL from Web API",n),null}}parseCslPayload(e){try{let n=JSON.parse(e.toString("utf8"));return Array.isArray(n)?typeof n[0]=="object"&&n[0]?n[0]:null:typeof n=="object"&&n?n:null}catch(n){return console.warn("Failed to parse CSL payload",n),null}}async searchZoteroItemsWeb(e){let n=e.trim(),t=["data,meta"];for(let i of t){let r=new URLSearchParams;r.set("itemType","-attachment"),r.set("limit","25"),r.set("include",i),n?r.set("q",n):(r.set("sort","dateAdded"),r.set("direction","desc"));let a=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/top?${r.toString()}`);try{let s=await this.requestWebApi(a,`Zotero Web API search failed for ${a}`),o=JSON.parse(s.toString("utf8"));return Array.isArray(o)?this.normalizeZoteroSearchResults(o):[]}catch(s){console.warn("Failed to search Zotero via web API",s)}}return[]}normalizeZoteroSearchResults(e){return e.map(n=>{var t,i,r,a;return{key:(i=n.key)!=null?i:(t=n.data)==null?void 0:t.key,data:(r=n.data)!=null?r:{},meta:(a=n.meta)!=null?a:{}}}).filter(n=>this.isImportableZoteroResult(n))}isImportableZoteroResult(e){var r,a,s;if(!(typeof e.key=="string"?e.key.trim():""))return!1;let t=String((a=(r=e.data)==null?void 0:r.itemType)!=null?a:"").trim().toLowerCase();return!(t==="attachment"||t==="note"||t==="annotation"||!(typeof((s=e.data)==null?void 0:s.title)=="string"?e.data.title.trim():""))}async updateZoteroItemLanguage(e,n,t){try{await this.updateZoteroItemLanguageLocal(e,n,t);return}catch(i){if(!this.canUseWebApi())throw i;let r=i instanceof Error?i.message:String(i);console.info("Local Zotero write failed; trying Web API",{itemKey:e,reason:r}),await this.updateZoteroItemLanguageWeb(e,n,t)}}async updateZoteroItemLanguageLocal(e,n,t){var C,f,v,x,w,R;let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),r={...n,language:t},a={"Content-Type":"application/json","Zotero-API-Version":"3"},s=typeof r.version=="number"?r.version:Number(r.version);Number.isNaN(s)||(a["If-Unmodified-Since-Version"]=String(s)),console.info("Zotero language PUT",{url:i,itemKey:e,language:t});try{let A=await this.requestLocalApiWithBody(i,"PUT",r,a,`Zotero update failed for ${i}`);console.info("Zotero language PUT response",{status:A.statusCode})}catch(A){if(!(A instanceof Error?A.message:String(A)).includes("status 501"))throw A;let L=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.info("Zotero language PUT unsupported; trying POST",{postUrl:L});let z=await this.requestLocalApiWithBody(L,"POST",[r],a,`Zotero update failed for ${L}`);console.info("Zotero language POST response",{status:z.statusCode})}let o=await this.fetchZoteroItem(e);if(this.normalizeZoteroLanguage(typeof((C=o==null?void 0:o.data)==null?void 0:C.language)=="string"?o.data.language:"")===this.normalizeZoteroLanguage(t))return;let c={...(f=o==null?void 0:o.data)!=null?f:n,language:t},d={key:e,version:(w=(x=(v=o==null?void 0:o.data)==null?void 0:v.version)!=null?x:o==null?void 0:o.version)!=null?w:s,data:c},_={...a},u=typeof d.version=="number"?d.version:Number(d.version);Number.isNaN(u)?delete _["If-Unmodified-Since-Version"]:_["If-Unmodified-Since-Version"]=String(u);let m=await this.requestLocalApiWithBody(i,"PUT",d,_,`Zotero update failed for ${i}`);console.info("Zotero language PUT retry response",{status:m.statusCode});let y=await this.fetchZoteroItem(e);if(this.normalizeZoteroLanguage(typeof((R=y==null?void 0:y.data)==null?void 0:R.language)=="string"?y.data.language:"")!==this.normalizeZoteroLanguage(t))throw new Error("Language update did not persist in Zotero.")}async updateZoteroItemLanguageWeb(e,n,t){var m,y,b,C,f;let i=this.getWebApiLibraryPath();if(!i)throw new Error("Web API library path is not configured.");let r=this.buildWebApiUrl(`/${i}/items/${e}`),a=await this.fetchZoteroItemWeb(e),s={...(m=a==null?void 0:a.data)!=null?m:n,language:t},o={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},l=(C=(b=(y=a==null?void 0:a.data)==null?void 0:y.version)!=null?b:a==null?void 0:a.version)!=null?C:n==null?void 0:n.version,c=typeof l=="number"?l:Number(l);Number.isNaN(c)||(o["If-Unmodified-Since-Version"]=String(c)),console.info("Zotero Web API language PUT",{url:r,itemKey:e,language:t});let d=await this.requestWebApiWithBody(r,"PUT",s,o,`Zotero Web API update failed for ${r}`);console.info("Zotero Web API language PUT response",{status:d.statusCode});let _=await this.fetchZoteroItemWeb(e);if(this.normalizeZoteroLanguage(typeof((f=_==null?void 0:_.data)==null?void 0:f.language)=="string"?_.data.language:"")!==this.normalizeZoteroLanguage(t))throw new Error("Language update did not persist in Zotero Web API.")}async updateZoteroItemFields(e,n,t){try{await this.updateZoteroItemFieldsLocal(e,n,t);return}catch(i){if(!this.canUseWebApi())throw i;let r=i instanceof Error?i.message:String(i);console.info("Local Zotero write failed; trying Web API",{itemKey:e,reason:r}),await this.updateZoteroItemFieldsWeb(e,n,t)}}async updateZoteroItemFieldsLocal(e,n,t){let i=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}`),r={...n,...t},a={"Content-Type":"application/json","Zotero-API-Version":"3"},s=typeof r.version=="number"?r.version:Number(r.version);Number.isNaN(s)||(a["If-Unmodified-Since-Version"]=String(s)),console.info("Zotero metadata PUT",{url:i,itemKey:e});try{let o=await this.requestLocalApiWithBody(i,"PUT",r,a,`Zotero update failed for ${i}`);console.info("Zotero metadata PUT response",{status:o.statusCode})}catch(o){if(!(o instanceof Error?o.message:String(o)).includes("status 501"))throw o;let c=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items`);console.info("Zotero metadata PUT unsupported; trying POST",{postUrl:c});let d=await this.requestLocalApiWithBody(c,"POST",[r],a,`Zotero update failed for ${c}`);console.info("Zotero metadata POST response",{status:d.statusCode})}}async updateZoteroItemFieldsWeb(e,n,t){var _,u,m,y;let i=this.getWebApiLibraryPath();if(!i)throw new Error("Web API library path is not configured.");let r=this.buildWebApiUrl(`/${i}/items/${e}`),a=await this.fetchZoteroItemWeb(e),s={...(_=a==null?void 0:a.data)!=null?_:n,...t},o={"Content-Type":"application/json","Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},l=(y=(m=(u=a==null?void 0:a.data)==null?void 0:u.version)!=null?m:a==null?void 0:a.version)!=null?y:n==null?void 0:n.version,c=typeof l=="number"?l:Number(l);Number.isNaN(c)||(o["If-Unmodified-Since-Version"]=String(c)),console.info("Zotero Web API metadata PUT",{url:r,itemKey:e});let d=await this.requestWebApiWithBody(r,"PUT",s,o,`Zotero Web API update failed for ${r}`);console.info("Zotero Web API metadata PUT response",{status:d.statusCode})}sanitizeFileName(e){let n=e.replace(/[\\/:*?"<>|]/g,"").replace(/\s+/g," ").trim();return n?n.replace(/[.]+$/g,"").trim().slice(0,120):""}registerNoteRenameHandler(){this.registerEvent(this.app.vault.on("rename",async e=>{var n;if(!(!(e instanceof h.TFile)||e.extension!=="md"))try{let t=await this.app.vault.read(e),i=(n=this.extractDocIdFromFrontmatter(t))!=null?n:this.extractDocIdFromSyncMarker(t);if(!i)return;await this.updateDocIndex({doc_id:i,note_path:e.path,note_title:E.default.basename(e.path,".md")})}catch(t){console.warn("Failed to update doc index for renamed note",t)}}))}registerNoteSyncHandler(){this.registerEvent(this.app.vault.on("modify",e=>{if(!(!(e instanceof h.TFile)||e.extension!=="md")){if(this.noteMetadataSyncSuppressed.has(e.path)){this.noteSyncSuppressed.has(e.path)&&this.scheduleNoteSync(e,2500);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2500),this.scheduleNoteMetadataSync(e,2500,"save"),this.scheduleNoteAnnotationSync(e,2500,"save");return}this.scheduleNoteSync(e),this.scheduleNoteMetadataSync(e,1200,"save"),this.scheduleNoteAnnotationSync(e,1200,"save")}}))}registerNoteOpenHandler(){this.registerEvent(this.app.workspace.on("file-open",e=>{!(e instanceof h.TFile)||e.extension!=="md"||(this.pdfSidebar.syncPdfSidebarForFile(e),this.pdfSidebar.updatePreviewScrollHandler(),this.scheduleNoteMetadataSync(e,600,"open"),this.scheduleNoteAnnotationSync(e,800,"open"),this.normalizeZoteroFrontmatterKeysInFile(e))}))}registerPreviewScrollSyncHandlers(){this.registerEvent(this.app.workspace.on("active-leaf-change",()=>{this.pdfSidebar.updatePreviewScrollHandler(),this.pdfSidebar.maybeSyncPendingPdf()})),this.registerEvent(this.app.workspace.on("layout-change",()=>{this.pdfSidebar.updatePreviewScrollHandler(),this.pdfSidebar.maybeSyncPendingPdf()})),this.pdfSidebar.updatePreviewScrollHandler()}registerNoteDeleteMenu(){this.registerEvent(this.app.workspace.on("file-menu",(e,n)=>{if(!(n instanceof h.TFile)||n.extension!=="md")return;let t=(0,h.normalizePath)(this.settings.outputNoteDir),i=(0,h.normalizePath)(n.path);!(t&&(i===t||i.startsWith(`${t}/`)))&&!this.isZoteroNoteFile(n)||(e.addItem(a=>{a.setTitle("Reindex note from cache").onClick(()=>this.reindexNoteFromCacheForFile(n,!0))}),e.addItem(a=>{a.setTitle("Delete Zotero note and cached data").onClick(()=>this.deleteZoteroNoteAndCacheForFile(n))}))}))}findChunkStartLine(e,n){let t=n!=null?n:e.getCursor().line;for(;t>=0;t-=1){let i=e.getLine(t);if(ce.test(i))return{line:t,text:i};if(ue.test(i)||fe.test(i))break}return null}findChunkEndLine(e,n){for(let t=n;t<e.lineCount();t+=1){let i=e.getLine(t);if(Ne.test(i))return t;if(fe.test(i))break}return null}findChunkAtCursor(e,n){let t=n!=null?n:e.getCursor().line,i=this.findChunkStartLine(e,t);if(!i)return null;let r=this.findChunkEndLine(e,i.line+1);return r===null||t<i.line||t>r?null:{startLine:i.line,endLine:r,text:i.text}}toggleChunkExclude(e,n){var d;let t=this.findChunkAtCursor(e,n);if(!t){new h.Notice("No synced chunk found at cursor.");return}let i=t.text.match(ce);if(!i){new h.Notice("Invalid chunk marker.");return}let r=((d=i[1])!=null?d:"").trim(),a=t.endLine,s=!1;if(a!==null){for(let _=t.startLine+1;_<a;_+=1)if(xe.test(e.getLine(_))){s=!0;break}}let l=/\bexclude\b/i.test(r)||/\bdelete\b/i.test(r)||s;l?r=r.replace(/\b(delete|exclude)\b/gi,"").replace(/\s{2,}/g," ").trim():r=r?`${r} exclude`:"exclude";let c=`<!-- zrr:chunk${r?" "+r:""} -->`;if(c!==t.text&&e.replaceRange(c,{line:t.startLine,ch:0},{line:t.startLine,ch:t.text.length}),l&&a!==null){let _=[];for(let u=t.startLine+1;u<a;u+=1)xe.test(e.getLine(u))&&_.push(u);for(let u=_.length-1;u>=0;u-=1){let m=_[u],y=e.lineCount();m<y-1?e.replaceRange("",{line:m,ch:0},{line:m+1,ch:0}):e.replaceRange("",{line:m,ch:0},{line:m,ch:e.getLine(m).length})}}new h.Notice(l?"Chunk included.":"Chunk excluded from index.")}toggleChunkExcludeFromToolbar(e){let n=this.app.workspace.getActiveViewOfType(h.MarkdownView);if(!n){new h.Notice("No active editor found.");return}let t=Math.max(0,e-1);this.toggleChunkExclude(n.editor,t)}async openChunkTagEditor(e,n){var d,_;let t=(0,h.normalizePath)(`${H}/${e}.json`),i=this.app.vault.adapter;if(!await i.exists(t)){new h.Notice("Chunk cache not found for this document.");return}let r=await this.readChunkPayload(t);if(!r){new h.Notice("Failed to read chunk cache.");return}let a=Array.isArray(r.chunks)?r.chunks:[],s=this.resolveChunkFromPayload(a,n,e);if(!s){new h.Notice(`Chunk ${n} not found in cache.`);return}let o=(d=s.chunk_tags)!=null?d:[],l=Array.isArray(o)?o.map(u=>String(u).trim()).filter(u=>u):String(o).split(/[|,;\n]+/).map(u=>u.trim()).filter(u=>u),c=typeof s.text=="string"?s.text:String((_=s.text)!=null?_:"");new $e(this.app,n,l,async u=>{u.length>0?s.chunk_tags=u:delete s.chunk_tags,await i.write(t,JSON.stringify(r,null,2)),await this.reindexChunkUpdates(e,t,[String(s.chunk_id||n)],[]),new h.Notice("Chunk tags updated.")},async()=>{if(!c.trim())return new h.Notice("Chunk has no text to tag."),null;let u=await this.renderMarkdownToIndexText(c);return this.requestChunkTags(u)}).open()}async openChunkIndexedTextPreview(e,n){var d;let t=(0,h.normalizePath)(`${H}/${e}.json`);if(!await this.app.vault.adapter.exists(t)){new h.Notice("Chunk cache not found for this document.");return}let r=await this.readChunkPayload(t);if(!r){new h.Notice("Failed to read chunk cache.");return}let a=Array.isArray(r.chunks)?r.chunks:[],s=this.resolveChunkFromPayload(a,n,e);if(!s){new h.Notice(`Chunk ${n} not found in cache.`);return}let o=typeof s.text=="string"?s.text:String((d=s.text)!=null?d:""),l=await this.renderMarkdownToIndexText(o),c=this.settings.embedIncludeMetadata?"Note: when \u201CInclude metadata in embeddings\u201D is enabled, the indexer prepends title/authors/tags/section info before embedding. The preview below shows only the chunk text.":"";new Ve(this.app,`Indexed text for ${n}`,l,c).open()}async openChunkInZotero(e,n){var _,u,m,y,b,C;let t=(0,h.normalizePath)(`${H}/${e}.json`),i=this.app.vault.adapter,r=null;await i.exists(t)&&(r=await this.readChunkPayload(t));let a=Array.isArray(r==null?void 0:r.chunks)?r==null?void 0:r.chunks:[],s=this.resolveChunkFromPayload(a,n,e),o=(_=s==null?void 0:s.page_start)!=null?_:s==null?void 0:s.pageStart,l=(b=(y=(u=r==null?void 0:r.metadata)==null?void 0:u.attachment_key)!=null?y:(m=r==null?void 0:r.metadata)==null?void 0:m.attachmentKey)!=null?b:"";if(!l){let f=await this.getDocIndexEntry(e);l=(C=f==null?void 0:f.attachment_key)!=null?C:""}if(!l){new h.Notice("Attachment key not found for Zotero deeplink.");return}let c=typeof o=="number"?String(o):"",d=this.buildZoteroDeepLink(e,l,c);this.openExternalUrl(d)}async cleanChunkFromToolbar(e){let n=this.app.workspace.getActiveViewOfType(h.MarkdownView);if(!n){new h.Notice("No active editor found.");return}let t=n.editor,i=Math.max(0,e-1),r=this.findChunkAtCursor(t,i);if(!r){new h.Notice("No synced chunk found at cursor.");return}let a=[];for(let c=r.startLine+1;c<r.endLine;c+=1)a.push(t.getLine(c));let s=a.join(`
...
`;t.replaceRange(l,{line:r.startLine+1,ch:0},{line:r.endLine,ch:0}),this.showStatusProgress("Chunk cleaned.",100),window.setTimeout(()=>this.clearStatusProgress(),1200),new h.Notice("Chunk cleaned.")}async requestOcrCleanup(e){var l,c,d,_,u,m,y,b,C;let n=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),t=(this.settings.llmCleanupModel||"").trim();if(!n||!t)return new h.Notice("OCR cleanup model is not configured."),this.openPluginSettings(),null;let i=Number(this.settings.llmCleanupMaxChars||0);if(i>0&&e.length>i)return new h.Notice("Chunk exceeds OCR cleanup max length. Adjust settings to clean it."),this.openPluginSettings(),null;let r=`${n}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o={model:t,temperature:Number((l=this.settings.llmCleanupTemperature)!=null?l:0),messages:[{role:"system",content:"You are an OCR cleanup assistant. Fix OCR errors without changing meaning. Do not add content. Return corrected text only. Detect footnote references and definitions and format them in Markdown as [^n] and [^n]: (for the note text). Preserve special characters and formatting. Do not create new footnotes or content; only reformat existing footnote markers/lines."},{role:"user",content:e}]};try{let f=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(o)});if(f.statusCode>=400){let R=f.body.toString("utf8");throw new Error(`Cleanup request failed (${f.statusCode}): ${R||"no response body"}`)}let v=JSON.parse(f.body.toString("utf8")),x=(C=(b=(y=(_=(d=(c=v==null?void 0:v.choices)==null?void 0:c[0])==null?void 0:d.message)==null?void 0:_.content)!=null?y:(m=(u=v==null?void 0:v.choices)==null?void 0:u[0])==null?void 0:m.text)!=null?b:v==null?void 0:v.output_text)!=null?C:"",w=String(x||"").trim();return w||(new h.Notice("Cleanup returned empty text."),null)}catch(f){return console.error("OCR cleanup failed",f),new h.Notice("OCR cleanup failed. Check the cleanup model settings."),null}}parseChunkTags(e,n){if(!e)return[];let t=e.trim(),i=[];if(t.startsWith("[")&&t.endsWith("]"))try{let s=JSON.parse(t);Array.isArray(s)&&(i=s.map(o=>String(o)))}catch(s){i=[]}i.length===0&&(i=t.split(/[,;\n]+/));let r=new Set,a=[];for(let s of i){let o=s.trim();if(o=o.replace(/^[-•\d.\)\s]+/,""),o=o.replace(/\s+/g," ").trim(),!o||o.length<2)continue;let l=o.toLowerCase();if(!r.has(l)&&(r.add(l),a.push(o),a.length>=n))break}return a}async requestChunkTags(e){var _,u,m,y,b,C,f,v,x;let n=(this.settings.llmCleanupBaseUrl||"").trim().replace(/\/$/,""),t=(this.settings.llmCleanupModel||"").trim();if(!n||!t)return new h.Notice("OCR cleanup model is not configured."),this.openPluginSettings(),null;let i=e.trim().slice(0,2e3);if(!i)return[];let r=`${n}/chat/completions`,a={"Content-Type":"application/json"},s=(this.settings.llmCleanupApiKey||"").trim();s&&(a.Authorization=`Bearer ${s}`);let o=5,l="Return 3 to 5 high-signal, concrete noun-phrase tags. Avoid generic terms (study, paper, method), verbs, and filler. Prefer specific entities, methods, datasets, and named concepts. Output comma-separated tags only. No extra text.",c=Number((_=this.settings.llmCleanupTemperature)!=null?_:0),d={model:t,messages:[{role:"system",content:l},{role:"user",content:i}]};Number.isFinite(c)&&(d.temperature=c),this.showStatusProgress("Generating tags...",null);try{let w=async z=>{let O=await this.requestLocalApiRaw(r,{method:"POST",headers:a,body:JSON.stringify(z)});if(O.statusCode>=400){let j=O.body.toString("utf8");throw new Error(`Tag request failed (${O.statusCode}): ${j||"no response body"}`)}return O.body},R;try{R=await w(d)}catch(z){let O=z instanceof Error?z.message:String(z);if("temperature"in d&&/temperature/i.test(O)&&/unsupported|default/i.test(O)){let j={...d};delete j.temperature,R=await w(j)}else throw z}let A=JSON.parse(R.toString("utf8")),S=(x=(v=(f=(y=(m=(u=A==null?void 0:A.choices)==null?void 0:u[0])==null?void 0:m.message)==null?void 0:y.content)!=null?f:(C=(b=A==null?void 0:A.choices)==null?void 0:b[0])==null?void 0:C.text)!=null?v:A==null?void 0:A.output_text)!=null?x:"",L=this.parseChunkTags(String(S||""),o);return L.length||new h.Notice("Tag generation returned no tags."),L}catch(w){return console.error("Tag generation failed",w),new h.Notice("Tag generation failed. Check the cleanup model settings."),null}finally{this.clearStatusProgress()}}async renderMarkdownToIndexText(e){if(!e)return"";let n=this.replaceImageMarkersForIndexPreview(e),t=document.createElement("div");try{await h.MarkdownRenderer.renderMarkdown(n,t,"",this)}catch(l){return console.warn("Failed to render markdown for index preview",l),this.normalizeIndexPreviewText(n)}let a=(t.innerHTML||"").replace(/<br\s*\/?>/gi,`
`).replace(/<[^>]+>/g," "),s=document.createElement("textarea");s.innerHTML=a;let o=s.value||a;return this.normalizeIndexPreviewText(o)}replaceImageMarkersForIndexPreview(e){if(!e)return"";let n=i=>{let r=i.trim();return r?`Image caption: ${r}`:"Image"},t=e.replace(/!\[\[([^\]|]+)(?:\|([^\]]+))?\]\]/g,(i,r,a)=>n(a||""));return t=t.replace(/!\[([^\]]*)]\([^)]+\)/g,(i,r)=>n(r||"")),t=t.replace(/<img[^>]*>/gi,i=>{let r=i.match(/\balt=(['"])([^'"]*)\1/i);return n(r?r[2]:"")}),t}normalizeIndexPreviewText(e){return e.replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/[ \t]+/g," ").replace(/\n{3,}/g,`

`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,n=1200){let t=this.noteSyncTimers.get(e.path);t!==void 0&&window.clearTimeout(t);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},n);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,n=1200,t="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,t)},n);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,n=1200,t="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,t)},n);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let n=this.annotationNoteEditTimes.get(e);if(!n)return 0;let t=Date.now()-n;return t>=Yn?0:Yn-t}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=(e.annotation_page_label||"").trim();if(n)return n;let t=e.page_start?String(e.page_start):"",i=e.page_end?String(e.page_end):"";if(t&&(!i||t===i))return t;if(t&&i)return`${t} - ${i}`;let r=(e.pages||"").trim();if(!r)return"?";let a=r.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:r.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,h.normalizePath)(`${H}/${s}.json`),c=this.app.vault.adapter;if(!await c.exists(l))return;let d=await this.readChunkPayload(l);if(!d)return;let _=Array.isArray(d.chunks)?d.chunks:[],u=new Map;for(let x of _){if(this.isAnnotationChunk(x))continue;let w=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((n=x==null?void 0:x.chunk_id)!=null?n:"");w&&u.set(w,x)}let m=new Set,y=new Set,b=new Set,C=new Set,f=!1;for(let x of o){let w=x.chunkId;if(!w)continue;m.add(w);let R=u.get(w);if(!R){console.warn(`Sync note: chunk id not found in cache (${w})`);continue}if(x.excludeFlag){R.excluded!==!0&&(R.excluded=!0,f=!0);let L=this.normalizeChunkText(x.text);L&&L!==String((t=R.text)!=null?t:"")&&(R.text=L,R.char_count=L.length,f=!0),b.add(w);continue}if(R.excluded&&(R.excluded=!1,f=!0,y.add(w)),!x.text.trim()){b.add(w),C.add(w);continue}let A=this.normalizeChunkText(x.text);if(!A){b.add(w),C.add(w);continue}let S=typeof R.text=="string"?R.text:String((i=R.text)!=null?i:"");A!==S&&(R.text=A,R.char_count=A.length,y.add(w),f=!0)}for(let x of u.keys())m.has(x)||(b.add(x),C.add(x));let v=new Set([...b,...C]);if(v.size){let x=Array.from(v).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==x){this.noteSyncPendingDeletes.set(e.path,x),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!y.size&&!b.size&&!C.size&&!f)return;C.size&&(d.chunks=_.filter(x=>{var R;let w=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((R=x==null?void 0:x.chunk_id)!=null?R:"");return w&&!C.has(w)}),f=!0),(f||C.size)&&await c.write(l,JSON.stringify(d,null,2)),await this.reindexChunkUpdates(s,l,Array.from(y),Array.from(b)),(b.size||C.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,n){var t,i,r;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,n);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),s=await this.resolveDocIdForNote(e,a);if(!s)return;let o=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter;if(!o)return;let l=this.resolveZoteroItemKey(o,s);if(!l)return;let c=await this.fetchZoteroItem(l),d=(i=c==null?void 0:c.data)!=null?i:c;if(!d||typeof d!="object")return;let _=this.extractNoteMetadata(o),u=this.extractZoteroMetadata(d);u.citekey||(u.citekey=await this.resolveZoteroCitekey(d,l,c==null?void 0:c.meta));let m=await this.getMetadataSnapshot(s,o,e),y={},b={},C={},f=[],v=["title","short_title","citekey","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],x={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},w=v.filter(A=>this.hasFrontmatterKey(o,x[A]));if(!w.length)return;let R={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let A of w){let S=_[A],L=u[A];if(this.metadataValuesEqual(A,S,L))continue;let z=m==null?void 0:m[A];if(z!==void 0){let j=!this.metadataValuesEqual(A,S,z),F=!this.metadataValuesEqual(A,L,z);if(j&&!F){C[A]="note",this.assignMetadataUpdate(b,A,S);continue}if(!j&&F){C[A]="zotero",this.assignMetadataUpdate(y,A,L);continue}}let O=this.getMetadataDecisionLabels(A,S,L,R);f.push({field:A,fieldLabel:R[A],noteLabel:O.noteLabel,zoteroLabel:O.zoteroLabel,noteValue:this.formatMetadataValue(S),zoteroValue:this.formatMetadataValue(L)})}if(f.length>0){let A=await this.promptMetadataBatchDecision(f);for(let S of f){let L=(r=A[S.field])!=null?r:"skip";C[S.field]=L,L==="note"?this.assignMetadataUpdate(b,S.field,_[S.field]):L==="zotero"&&this.assignMetadataUpdate(y,S.field,u[S.field])}}Object.keys(y).length>0&&await this.applyNoteMetadataUpdates(e,y),Object.keys(b).length>0&&await this.applyZoteroMetadataUpdates(l,d,_,u,b),await this.updateMetadataSnapshot(e,s,_,u,m,C,w)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,n)}}async syncNoteAnnotationsWithZotero(e,n){var t,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,n);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let M=this.ensureDocIdInNoteContent(o,d);M!==o&&await this.writeNoteWithSyncSuppressed(e.path,M)}if(!d)return;let _=(i=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter)!=null?i:{},u=(r=c.attachmentKey)!=null?r:"";if(u||(u=await this.resolveAttachmentKeyForDocId(d,_)),!u)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===u&&await this.updateDocIndex({doc_id:d,attachment_key:u});let m=u,y=await this.fetchZoteroAnnotationsForDoc(d,u),b=y.annotations;u=y.attachmentKey,u&&u!==m&&await this.updateDocIndex({doc_id:d,attachment_key:u});let C=this.parseAnnotationBlock(l.block,u),f=new Map;for(let M of C)M.key&&M.imagePath&&f.set(M.key,{path:M.imagePath,hash:M.imageHash||this.extractAnnotationImageHashFromPath(M.imagePath)});await this.attachAnnotationImages(d,u,b,e.path,f);let v=new Map;for(let M of C)M.key&&v.set(M.key,M);let x=new Map;for(let M of b)x.set(M.key,M);let w=await this.getAnnotationSnapshot(d),R=(a=w==null?void 0:w.annotations)!=null?a:{},A={},S=[],L=!1,z=!1,O=!1;u&&u!==m&&b.length>0&&(z=!0,O=!0);for(let[M,$]of x.entries()){let I=v.get(M);if(!I){z=!0;continue}let N=R[M],q=this.annotationSnapshotFromEntry(I,$.annotationType),U=this.annotationSnapshotFromEntry($,$.annotationType),J=(q.image_hash||"")!==(U.image_hash||"");if(!N){this.annotationSnapshotsEqualIgnoringImage(q,U)?J&&(z=!0,O=!0):(A[M]="note",L=!0);continue}let Z=!this.annotationSnapshotsEqual(q,N),Q=!this.annotationSnapshotsEqual(U,N),X=(U.color_key||"")!==(N.color_key||""),ie=!this.annotationSnapshotsEqualIgnoringImage(q,N),se=!this.annotationSnapshotsEqualIgnoringImage(U,N);ie&&!se?(A[M]="note",L=!0):!ie&&se?(A[M]="zotero",z=!0):ie&&se&&S.push({key:M,title:this.formatAnnotationConflictTitle($),noteValue:this.formatAnnotationConflictValue(q,I.tags),zoteroValue:this.formatAnnotationConflictValue(U,$.tags)}),J&&(Z||Q)&&(z=!0,O=!0),X&&(z=!0,O=!0)}if(S.length>0){let M=await this.promptAnnotationBatchDecision(S);for(let $ of S){let I=(s=M[$.key])!=null?s:"skip";A[$.key]=I,I==="note"?L=!0:I==="zotero"&&(z=!0,O=!0)}}let j=[];for(let[M,$]of Object.entries(A)){if($!=="note")continue;let I=v.get(M),N=x.get(M);!I||!N||j.push({entry:N,note:I})}j.length>0&&await this.applyZoteroAnnotationUpdates(j),L&&this.annotationNoteEditTimes.set(e.path,Date.now());let F=this.getAnnotationGraceRemaining(e.path);if(z&&F>0&&L&&!O&&(this.scheduleNoteAnnotationSync(e,F+250,n),z=!1),z){let M=this.buildAnnotationBlock(d,u,b),$=this.replaceAnnotationBlock(o,M);if($&&$!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,$)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,u,b),await this.updateAnnotationChunks(d,u,b)}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,n)}}resolveZoteroItemKey(e,n){let t=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),n];for(let i of t){let r=V(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,n){var l;if(!e)return"";let t=await this.getDocIndexEntry(e);if(t||(t=await this.hydrateDocIndexFromCache(e)),t!=null&&t.attachment_key)return t.attachment_key;let i=(0,h.normalizePath)(`${H}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let d=await this.readChunkPayload(i),_=d!=null&&d.metadata&&typeof d.metadata=="object"?d.metadata:null,u=_==null?void 0:_.attachment_key;if(typeof u=="string"&&u.trim())return await this.updateDocIndex({doc_id:e,attachment_key:u.trim()}),u.trim()}}catch(c){}let r=this.resolveZoteroItemKey(n,e);if(!r)return"";let a=await this.fetchZoteroItem(r),s=(l=a==null?void 0:a.data)!=null?l:a;if(!s||typeof s!="object")return"";let o=await ve(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var C,f,v,x,w,R,A,S,L,z,O,j,F;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString((x=(v=(f=(C=e==null?void 0:e["short title"])!=null?C:e==null?void 0:e.short_title)!=null?f:e==null?void 0:e.shortTitle)!=null?v:e==null?void 0:e["short-title"])!=null?x:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString((S=(A=(R=(w=e==null?void 0:e.citekey)!=null?w:e==null?void 0:e["citation key"])!=null?R:e==null?void 0:e.citation_key)!=null?A:e==null?void 0:e.citationKey)!=null?S:e==null?void 0:e["citation-key"]),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString((L=e==null?void 0:e.abstract)!=null?L:e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((z=e==null?void 0:e.doi)!=null?z:e==null?void 0:e.DOI),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),_=this.normalizeMetadataString(e==null?void 0:e.pages),u=this.normalizeMetadataString((F=(j=(O=e==null?void 0:e["item type"])!=null?O:e==null?void 0:e.item_type)!=null?j:e==null?void 0:e.itemType)!=null?F:e==null?void 0:e["item-type"]),m=this.normalizeMetadataList(e==null?void 0:e.tags),y=this.normalizeMetadataList(e==null?void 0:e.authors),b=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:n,short_title:t,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:_,item_type:u,tags:this.sanitizeObsidianTags(m),authors:y,editors:b}}extractZoteroMetadata(e){var f,v,x;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString(me(e)),i=this.normalizeMetadataString(qe(e)),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString(e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((f=e==null?void 0:e.DOI)!=null?f:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),_=this.normalizeMetadataString(e==null?void 0:e.pages),u=this.normalizeMetadataString((x=(v=e==null?void 0:e.itemType)!=null?v:e==null?void 0:e.item_type)!=null?x:e==null?void 0:e["item-type"]),m=Array.isArray(e==null?void 0:e.creators)?e.creators:[],y=m.filter(w=>(w==null?void 0:w.creatorType)==="author").map(w=>he(w)).filter(Boolean),b=m.filter(w=>(w==null?void 0:w.creatorType)==="editor"||(w==null?void 0:w.creatorType)==="seriesEditor").map(w=>he(w)).filter(Boolean),C=Array.isArray(e==null?void 0:e.tags)?e.tags.map(w=>typeof w=="string"?w:w==null?void 0:w.tag).filter(w=>typeof w=="string"):[];return{title:n,short_title:t,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:_,item_type:u,tags:this.sanitizeObsidianTags(C),authors:this.normalizeMetadataList(y),editors:this.normalizeMetadataList(b)}}async resolveZoteroCitekey(e,n,t){let i=this.normalizeMetadataString(qe(e,t!=null?t:void 0));if(i)return i;if(!n)return"";let r=await this.fetchZoteroItemCsl(n);return this.normalizeMetadataString(dn(r))}extractAnnotationPageInfo(e){var a;let t=V((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:t,pageIndex:i}}extractAnnotationImagePayload(e){var a,s,o,l;let n=(s=(a=e.annotationImage)!=null?a:e.annotationImageData)!=null?s:e.annotationImageBase64;if(!n)return null;let t=null,i="";if(Buffer.isBuffer(n))t=n;else if(ArrayBuffer.isView(n))t=Buffer.from(n.buffer,n.byteOffset,n.byteLength);else if(n instanceof ArrayBuffer)t=Buffer.from(n);else if(typeof n=="string"){let c=n.trim();if(!c)return null;let d=c.match(/^data:([^;]+);base64,(.*)$/i);if(d&&(i=this.normalizeAnnotationImageMime(d[1]),c=d[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;t=Buffer.from(c,"base64")}if(!t||!t.length)return null;i||(i=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(t)||"image/png");let r=this.annotationImageExtensionFromMime(i)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(t))||"png";return{buffer:t,mime:i,ext:r}}parseZoteroAnnotationItem(e,n){var C,f,v,x;let t=(f=(C=e==null?void 0:e.data)!=null?C:e)!=null?f:{},i=V((v=e==null?void 0:e.key)!=null?v:t==null?void 0:t.key);if(!i)return null;let r=V(t.annotationType),a=this.normalizeAnnotationText(t.annotationText),s=this.normalizeAnnotationText(t.annotationComment),o=V(t.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:_,pageIndex:u}=this.extractAnnotationPageInfo(t),m=(x=t.annotationSortIndex)!=null?x:t.annotationSort,y=Number.isFinite(Number(m))?Number(m):0,b=Array.isArray(t.tags)?t.tags.map(w=>typeof w=="string"?w:w==null?void 0:w.tag).filter(w=>typeof w=="string"):[];return{key:i.trim(),attachmentKey:n,pageLabel:_,pageIndex:u,colorKey:l,callout:d,heading:c,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(b),sortIndex:y,rawValues:t}}async fetchZoteroAnnotations(e){if(!e)return[];let n=this.canUseWebApi()||await this.ensureWebApiLibraryId(),t=a=>{var o,l;let s=[];for(let c of a){let d=(l=(o=c==null?void 0:c.data)!=null?o:c)!=null?l:{};if(V(d.itemType)!=="annotation")continue;let _=this.parseZoteroAnnotationItem(c,e);_&&s.push(_)}return s},i=[];try{i=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(a){try{i=await this.fetchZoteroChildrenLocal(e)}catch(s){console.warn("Failed to fetch Zotero annotation items from local API",s)}}let r=t(i);if(!r.length&&n)try{let a=[];try{a=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(o){a=await this.fetchZoteroChildrenWeb(e)}let s=t(a);s.length&&(r=s)}catch(a){console.warn("Failed to fetch Zotero annotation items from Web API",a)}return r}async fetchZoteroAnnotationsForDoc(e,n){var o,l,c;let t=n,i=await this.fetchZoteroAnnotations(t);if(i.length||!e)return i.length||this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i};let r=[];try{r=await this.fetchZoteroChildren(e)}catch(d){return console.warn("Failed to fetch Zotero attachments for annotations",d),this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}let a=[],s=new Set(t?[t]:[]);for(let d of r){if(!pn(d))continue;let _=V((c=(l=d==null?void 0:d.key)!=null?l:(o=d==null?void 0:d.data)==null?void 0:o.key)!=null?c:d==null?void 0:d.attachmentKey);!_||s.has(_)||(s.add(_),a.push(_))}for(let d of a){let _=await this.fetchZoteroAnnotations(d);if(_.length)return{attachmentKey:d,annotations:_}}return this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}async attachAnnotationImages(e,n,t,i,r){var _;if(!this.settings.includeAnnotationImages||!t.length)return;let a=await this.resolveAnnotationImageOutputDir(i);if(!a)return;let s=this.sanitizeFileName(e||n)||"annotations",o=(0,h.normalizePath)(E.default.join(a.relative||"",s)),l=E.default.normalize(E.default.join(a.absolute,s));o?await this.ensureFolder(o):await G.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,d=new Map;for(let u of t){let m=String(u.annotationType||"").trim().toLowerCase(),y=m==="image"||m==="ink",b=this.extractAnnotationImagePayload((_=u.rawValues)!=null?_:{});if(!b&&y&&this.settings.zoteroCompanionEnabled&&(b=await this.fetchCompanionAnnotationImage(u.key)),!b){let x=r==null?void 0:r.get(u.key);x!=null&&x.path&&await c.exists(x.path)&&(u.imagePath=x.path,u.imageHash=x.hash,d.set(u.key,x.path));continue}let C=(0,Se.createHash)("sha1").update(b.buffer).digest("hex").slice(0,12),f=`zrr-annotation-${u.key}-${C}.${b.ext}`,v=(0,h.normalizePath)(E.default.join(o,f));try{await c.exists(v)||await c.writeBinary(v,this.bufferToArrayBuffer(b.buffer)),u.imagePath=v,u.imageHash=C,d.set(u.key,v)}catch(x){console.warn("Failed to write annotation image",{annotationKey:u.key,error:x})}}if(o&&await c.exists(o))try{let u=await c.list(o);for(let m of u.files){let b=E.default.basename(m).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!b)continue;let C=b[1].toUpperCase(),f=d.get(C);(!f||(0,h.normalizePath)(f)!==(0,h.normalizePath)(m))&&await c.remove(m)}}catch(u){console.warn("Failed to clean up annotation images",u)}}async fetchCompanionAnnotationImage(e){let n=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!n)return null;let t=`${n.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,i={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(i.Authorization=`Bearer ${r}`);try{let a=await this.requestLocalApiRaw(t,{headers:i,timeoutMs:5e3});if(a.statusCode===200){let s=a.headers["content-type"],o=Array.isArray(s)?s[0]:s!=null?s:"";return this.buildAnnotationImagePayloadFromBuffer(a.body,o)}if(a.statusCode===204||a.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:a.statusCode})}catch(a){console.warn("Failed to fetch annotation image from Zotero companion",a)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new h.Notice("Zotero companion base URL is not set.");return}let n=`${e.replace(/\/$/,"")}/health`,t={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(t.Authorization=`Bearer ${i}`);try{let r=await this.requestLocalApiRaw(n,{headers:t,timeoutMs:3e3});if(r.statusCode===200){try{let a=JSON.parse(r.body.toString("utf8"));if(a!=null&&a.ok){new h.Notice("Zotero companion: OK.");return}}catch(a){}new h.Notice("Zotero companion responded but did not return OK.");return}if(r.statusCode===401){new h.Notice("Zotero companion: unauthorized (check token).");return}new h.Notice(`Zotero companion: HTTP ${r.statusCode}.`)}catch(r){console.warn("Zotero companion health check failed",r),new h.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new h.Notice("Opened Zotero. Go to Tools \u2192 Add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new h.Notice("Unable to open Zotero automatically. Open Zotero and go to Tools \u2192 Add-ons.")}}async spawnDetached(e){let[n,...t]=e;if(!n)throw new Error("Missing command");await new Promise((i,r)=>{let a=!1,s=(0,ne.spawn)(n,t,{detached:!0,stdio:"ignore"});s.on("error",o=>{a||(a=!0,r(o))}),s.unref(),a||(a=!0,i())})}maybeWarnMissingAnnotationApi(e,n){if(this.canUseWebApi()){console.info("No Zotero annotations returned for attachment",{docId:e,attachmentKey:n});return}let t=e||n;!t||this.annotationWebApiWarned.has(t)||(this.annotationWebApiWarned.add(t),new h.Notice("Zotero annotations require Web API access. Configure the Web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
`).trim():typeof e=="number"&&Number.isFinite(e)?String(e):""}normalizeMetadataList(e){return Array.isArray(e)?e.map(n=>this.normalizeMetadataString(n)).filter(n=>n.length>0):typeof e=="string"?e.split(/[,;\n]+/).map(n=>n.trim()).filter(n=>n.length>0):[]}coerceMetadataStringValue(e){return Array.isArray(e)?e.join("; ").trim():this.normalizeMetadataString(e)}assignMetadataUpdate(e,n,t){if(n==="tags"||n==="authors"||n==="editors"){e[n]=Array.isArray(t)?t:this.normalizeMetadataList(t);return}e[n]=this.coerceMetadataStringValue(t)}metadataValuesEqual(e,n,t){if(Array.isArray(n)||Array.isArray(t)){let i=Array.isArray(n)?n:this.normalizeMetadataList(n),r=Array.isArray(t)?t:this.normalizeMetadataList(t),a=e==="tags";return this.compareMetadataLists(i,r,a)}return this.normalizeMetadataString(n)===this.normalizeMetadataString(t)}compareMetadataLists(e,n,t){let i=s=>s.replace(/\s+/g," ").trim(),r=e.map(i).filter(Boolean),a=n.map(i).filter(Boolean);if(t&&(r.sort(),a.sort()),r.length!==a.length)return!1;for(let s=0;s<r.length;s+=1)if(r[s]!==a[s])return!1;return!0}isMetadataValueEmpty(e){return Array.isArray(e)?e.length===0:this.normalizeMetadataString(e).length===0}formatMetadataValue(e){return Array.isArray(e)?e.join(`
`):this.normalizeMetadataString(e)}normalizeAnnotationText(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
`).trim():typeof e=="number"&&Number.isFinite(e)?String(e):""}normalizeAnnotationImageMime(e){let n=V(e).toLowerCase();return n?n.includes("/")?n:n==="png"?"image/png":n==="jpg"||n==="jpeg"?"image/jpeg":n==="gif"?"image/gif":n==="webp"?"image/webp":"":""}buildAnnotationImagePayloadFromBuffer(e,n){if(!e||!e.length)return null;let t=this.normalizeAnnotationImageMime(n);t||(t=this.guessAnnotationImageMime(e)||"image/png");let i=this.annotationImageExtensionFromMime(t)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(e))||"png";return{buffer:e,mime:t,ext:i}}guessAnnotationImageMime(e){return e.length>=3&&e[0]===255&&e[1]===216&&e[2]===255?"image/jpeg":e.length>=4&&e[0]===137&&e[1]===80&&e[2]===78&&e[3]===71?"image/png":e.length>=6&&e.slice(0,3).toString("ascii")==="GIF"?"image/gif":e.length>=12&&e.slice(0,4).toString("ascii")==="RIFF"&&e.slice(8,12).toString("ascii")==="WEBP"?"image/webp":""}annotationImageExtensionFromMime(e){switch(e.toLowerCase()){case"image/png":return"png";case"image/jpeg":case"image/jpg":return"jpg";case"image/gif":return"gif";case"image/webp":return"webp";default:return""}}extractAnnotationImageHashFromPath(e){if(!e)return"";let t=E.default.basename(e).match(/^zrr-annotation-[A-Z0-9]{8}-([a-f0-9]{12})\./i);return t?t[1].toLowerCase():""}normalizeAnnotationTags(e){let n=this.sanitizeObsidianTags(e),t=Array.from(new Set(n));return t.sort(),t}getAnnotationColorMap(){let e=this.settings.annotationColorMap;return e&&typeof e=="object"?e:Fe.annotationColorMap}normalizeAnnotationColorKey(e){var i,r;let n=this.getAnnotationColorMap(),t=String(e||"").trim().toLowerCase();if(!t)return(i=Object.keys(n)[0])!=null?i:"gray";if(t==="grey"&&(t="gray"),n[t])return t;if(t.startsWith("#")){let a=this.inferAnnotationColorFromHex(t);if(a&&n[a])return a}return n.gray?"gray":(r=Object.keys(n)[0])!=null?r:"gray"}inferAnnotationColorFromHex(e){let n=e.replace("#","").trim();if(![3,6].includes(n.length))return null;let t=y=>y.length===1?`${y}${y}`:y,i=n.length===3?t(n[0]):n.slice(0,2),r=n.length===3?t(n[1]):n.slice(2,4),a=n.length===3?t(n[2]):n.slice(4,6),s=parseInt(i,16)/255,o=parseInt(r,16)/255,l=parseInt(a,16)/255;if(Number.isNaN(s)||Number.isNaN(o)||Number.isNaN(l))return null;let c=Math.max(s,o,l),d=Math.min(s,o,l),_=c-d,u=(c+d)/2;if(_<.08||u<.12)return"gray";let m=0;return _===0?m=0:c===s?m=(o-l)/_%6:c===o?m=(l-s)/_+2:m=(s-o)/_+4,m=Math.round(m*60),m<0&&(m+=360),m<20||m>=340?"red":m<45?"orange":m<70?"yellow":m<160?"green":m<250?"blue":m<290?"purple":m<330?"magenta":"red"}resolveAnnotationColorMeta(e){let n=this.getAnnotationColorMap(),t=n[e];return t&&t.heading&&t.callout?t:n.gray||n.yellow||{heading:"Annotations",callout:"note"}}getMetadataDecisionLabels(e,n,t,i){let r=this.isMetadataValueEmpty(n),a=this.isMetadataValueEmpty(t),s="Keep note",o="Keep Zotero";return r&&!a?(s="Delete in Zotero",o="Use Zotero value"):!r&&a&&(s="Update Zotero from note",o="Clear note"),{fieldLabel:i[e],noteLabel:s,zoteroLabel:o}}async promptMetadataDecision(e,n,t){let i={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"},r=this.getMetadataDecisionLabels(e,n,t,i);return new Promise(a=>{new He(this.app,r.fieldLabel,r.noteLabel,r.zoteroLabel,this.formatMetadataValue(n),this.formatMetadataValue(t),a).open()})}async promptMetadataBatchDecision(e){return new Promise(n=>{new Ke(this.app,e.map(t=>({field:t.field,fieldLabel:t.fieldLabel,noteLabel:t.noteLabel,zoteroLabel:t.zoteroLabel,noteValue:t.noteValue,zoteroValue:t.zoteroValue})),t=>n(t)).open()})}formatAnnotationConflictTitle(e){let n=this.settings.annotationPageLabel||"Page",t=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?");return`${n} ${t} (${e.key})`}formatAnnotationConflictValue(e,n){let t=[];e.text&&t.push("Highlight:",e.text),e.comment&&(t.length&&t.push(""),t.push("Comment:",e.comment));let i=this.normalizeAnnotationTags(n);return i.length&&(t.length&&t.push(""),t.push(`Tags: ${i.map(r=>`#${r}`).join(" ")}`)),t.join(`
`).trim()}async promptAnnotationBatchDecision(e){return new Promise(n=>{new Je(this.app,e,t=>n(t)).open()})}normalizeSnapshotValue(e,n){return e==="tags"?[...this.normalizeMetadataList(n)].sort():e==="authors"||e==="editors"?this.normalizeMetadataList(n):this.normalizeMetadataString(n)}setMetadataSnapshotValue(e,n,t){e[n]=t}getMetadataSnapshotCachePath(){return(0,h.normalizePath)(En)}normalizeMetadataSnapshotRecord(e){if(!e)return null;let n=e;if(typeof e=="string")try{n=JSON.parse(e)}catch(r){return null}if(!n||typeof n!="object")return null;let t={},i=["title","short_title","citekey","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"];for(let r of i)Object.prototype.hasOwnProperty.call(n,r)&&this.setMetadataSnapshotValue(t,r,this.normalizeSnapshotValue(r,n[r]));return Object.keys(t).length>0?t:null}parseLegacyMetadataSnapshot(e){var t;if(!e)return null;let n=(t=e.zrr_metadata_snapshot)!=null?t:e["zrr metadata snapshot"];return n?this.normalizeMetadataSnapshotRecord(n):null}async loadMetadataSnapshotCache(){var t;let e=this.app.vault.adapter,n=this.getMetadataSnapshotCachePath();if(!await e.exists(n))return{};try{let i=await e.read(n),r=JSON.parse(i),a=(t=r==null?void 0:r.entries)!=null?t:r;if(!a||typeof a!="object"||Array.isArray(a))return{};let s={};for(let[o,l]of Object.entries(a)){let c=this.normalizeMetadataSnapshotRecord(l);c&&(s[String(o)]=c)}return s}catch(i){return console.error("Failed to read metadata snapshot cache",i),{}}}async getMetadataSnapshotCache(){return this.metadataSnapshotCache?this.metadataSnapshotCache:(this.metadataSnapshotCache=await this.loadMetadataSnapshotCache(),this.metadataSnapshotCache)}async saveMetadataSnapshotCache(e){await this.ensureFolder(Y);let n=this.app.vault.adapter,t=this.getMetadataSnapshotCachePath(),i={version:1,entries:e};await n.write(t,JSON.stringify(i,null,2)),this.metadataSnapshotCache=e}async removeLegacyMetadataSnapshotFrontmatter(e,n){if(!!!(n&&(Object.prototype.hasOwnProperty.call(n,"zrr_metadata_snapshot")||Object.prototype.hasOwnProperty.call(n,"zrr metadata snapshot"))))return;let i=e.path;this.noteSyncSuppressed.add(i),this.noteMetadataSyncSuppressed.add(i);try{await this.app.fileManager.processFrontMatter(e,r=>{delete r.zrr_metadata_snapshot,delete r["zrr metadata snapshot"]})}catch(r){console.warn("Failed to remove legacy metadata snapshot",r)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(i),this.noteMetadataSyncSuppressed.delete(i)},1500)}}async getMetadataSnapshot(e,n,t){if(!e)return null;let i=await this.getMetadataSnapshotCache(),r=i[e];if(r)return r;let a=n?this.parseLegacyMetadataSnapshot(n):null;return a?(i[e]=a,await this.saveMetadataSnapshotCache(i),await this.removeLegacyMetadataSnapshotFrontmatter(t,n),a):null}serializeMetadataSnapshot(e,n){let t={};for(let i of n)e[i]!==void 0&&(t[i]=e[i]);return JSON.stringify(t)}async updateMetadataSnapshot(e,n,t,i,r,a,s){var u,m;if(!n)return;let o=r?{...r}:{};for(let y of s){let b=t[y],C=i[y];if(this.metadataValuesEqual(y,b,C)){this.setMetadataSnapshotValue(o,y,this.normalizeSnapshotValue(y,b));continue}let f=a[y];f==="note"?this.setMetadataSnapshotValue(o,y,this.normalizeSnapshotValue(y,b)):f==="zotero"&&this.setMetadataSnapshotValue(o,y,this.normalizeSnapshotValue(y,C))}let l=this.serializeMetadataSnapshot(o,s),c=await this.getMetadataSnapshotCache(),d=c[n],_=d?this.serializeMetadataSnapshot(d,s):"";if(l!==_){c[n]=o;try{await this.saveMetadataSnapshotCache(c)}catch(y){console.warn("Failed to update metadata snapshot cache",y)}await this.removeLegacyMetadataSnapshotFrontmatter(e,(m=(u=this.app.metadataCache.getFileCache(e))==null?void 0:u.frontmatter)!=null?m:null)}}async removeMetadataSnapshot(e){if(!e)return;let n=await this.getMetadataSnapshotCache();if(n[e]){delete n[e];try{await this.saveMetadataSnapshotCache(n)}catch(t){console.warn("Failed to remove metadata snapshot",t)}}}getAnnotationSnapshotCachePath(){return(0,h.normalizePath)(Rn)}async loadAnnotationSnapshotCache(){var t;let e=this.app.vault.adapter,n=this.getAnnotationSnapshotCachePath();if(!await e.exists(n))return{};try{let i=await e.read(n),r=JSON.parse(i),a=(t=r==null?void 0:r.entries)!=null?t:r;return!a||typeof a!="object"||Array.isArray(a)?{}:a}catch(i){return console.error("Failed to read annotation snapshot cache",i),{}}}async getAnnotationSnapshotCache(){return this.annotationSnapshotCache?this.annotationSnapshotCache:(this.annotationSnapshotCache=await this.loadAnnotationSnapshotCache(),this.annotationSnapshotCache)}async saveAnnotationSnapshotCache(e){await this.ensureFolder(Y);let n=this.app.vault.adapter,t=this.getAnnotationSnapshotCachePath(),i={version:1,entries:e};await n.write(t,JSON.stringify(i,null,2)),this.annotationSnapshotCache=e}annotationSnapshotFromEntry(e,n){var o;let t=this.normalizeAnnotationText(e.text),i=this.normalizeAnnotationText(e.comment),r=this.normalizeAnnotationTags((o=e.tags)!=null?o:[]),a=e.imageHash?e.imageHash.toLowerCase():"",s=e.colorKey?this.normalizeAnnotationColorKey(e.colorKey):"";return n==="note"&&!i&&t?{text:"",comment:t,tags:r,image_hash:a,color_key:s}:{text:t,comment:i,tags:r,image_hash:a,color_key:s}}annotationSnapshotsEqual(e,n){if(e.text!==n.text||e.comment!==n.comment||(e.image_hash||"")!==(n.image_hash||"")||e.tags.length!==n.tags.length)return!1;for(let t=0;t<e.tags.length;t+=1)if(e.tags[t]!==n.tags[t])return!1;return!0}annotationSnapshotsEqualIgnoringImage(e,n){if(e.text!==n.text||e.comment!==n.comment||e.tags.length!==n.tags.length)return!1;for(let t=0;t<e.tags.length;t+=1)if(e.tags[t]!==n.tags[t])return!1;return!0}async getAnnotationSnapshot(e){var t;return e&&(t=(await this.getAnnotationSnapshotCache())[e])!=null?t:null}async updateAnnotationSnapshot(e,n,t){if(!e)return;let i=await this.getAnnotationSnapshotCache(),r={attachment_key:n,annotations:{}};for(let a of t)r.annotations[a.key]=this.annotationSnapshotFromEntry(a,a.annotationType);i[e]=r;try{await this.saveAnnotationSnapshotCache(i)}catch(a){console.warn("Failed to update annotation snapshot cache",a)}}async applyNoteMetadataUpdates(e,n){if(!Object.keys(n).length)return;let t=e.path;this.noteSyncSuppressed.add(t),this.noteMetadataSyncSuppressed.add(t);try{await this.app.fileManager.processFrontMatter(e,i=>{var r,a,s,o,l,c,d,_,u,m,y,b;"title"in n&&(i.title=(r=n.title)!=null?r:""),"short_title"in n&&(i["short title"]=(a=n.short_title)!=null?a:"",delete i.short_title,delete i.shortTitle,delete i["title-short"]),"citekey"in n&&(i.citekey=(s=n.citekey)!=null?s:"",delete i.citation_key,delete i.citationKey,delete i["citation key"],delete i["citation-key"]),"date"in n&&(i.date=(o=n.date)!=null?o:""),"abstract"in n&&(i.abstract=(l=n.abstract)!=null?l:""),"doi"in n&&(i.doi=(c=n.doi)!=null?c:""),"publisher"in n&&(i.publisher=(d=n.publisher)!=null?d:""),"place"in n&&(i.place=(_=n.place)!=null?_:""),"issue"in n&&(i.issue=(u=n.issue)!=null?u:""),"volume"in n&&(i.volume=(m=n.volume)!=null?m:""),"pages"in n&&(i.pages=(y=n.pages)!=null?y:""),"item_type"in n&&(i["item type"]=(b=n.item_type)!=null?b:"",delete i.item_type,delete i.itemType,delete i["item-type"]),"tags"in n&&(i.tags=Array.isArray(n.tags)?n.tags:[]),"authors"in n&&(i.authors=Array.isArray(n.authors)?n.authors:[]),"editors"in n&&(i.editors=Array.isArray(n.editors)?n.editors:[])})}catch(i){console.warn("Failed to update note frontmatter from Zotero",i)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(t),this.noteMetadataSyncSuppressed.delete(t)},1500)}}async applyZoteroMetadataUpdates(e,n,t,i,r){var s,o,l,c,d,_,u,m,y,b,C;if(!Object.keys(r).length)return;let a={};if("title"in r&&(a.title=(s=r.title)!=null?s:""),"short_title"in r&&(a.shortTitle=(o=r.short_title)!=null?o:""),"citekey"in r&&(a.extra=this.updateExtraWithCitekey(n==null?void 0:n.extra,(l=r.citekey)!=null?l:"")),"date"in r&&(a.date=(c=r.date)!=null?c:""),"abstract"in r&&(a.abstractNote=(d=r.abstract)!=null?d:""),"doi"in r&&(a.DOI=(_=r.doi)!=null?_:""),"publisher"in r&&(a.publisher=(u=r.publisher)!=null?u:""),"place"in r&&(a.place=(m=r.place)!=null?m:""),"issue"in r&&(a.issue=(y=r.issue)!=null?y:""),"volume"in r&&(a.volume=(b=r.volume)!=null?b:""),"pages"in r&&(a.pages=(C=r.pages)!=null?C:""),"item_type"in r){let f=this.normalizeMetadataString(r.item_type);f&&(/^[A-Za-z][A-Za-z0-9]*$/.test(f)?a.itemType=f:console.warn("Skipping invalid item_type update",{itemKey:e,itemType:f}))}if("tags"in r&&(a.tags=this.buildZoteroTags(t.tags,n==null?void 0:n.tags)),"authors"in r||"editors"in r){let f="authors"in r?t.authors:i.authors,v="editors"in r?t.editors:i.editors;a.creators=this.buildZoteroCreators(f,v,Array.isArray(n==null?void 0:n.creators)?n.creators:[])}await this.updateZoteroItemFields(e,n,a)}updateExtraWithCitekey(e,n){let t=this.normalizeMetadataString(n),i=this.normalizeMetadataString(e),a=(i?i.split(/\r?\n/):[]).filter(s=>!this.isCitekeyExtraLine(s));return t&&a.push(`Citation Key: ${t}`),a.join(`
`).trim()}isCitekeyExtraLine(e){let n=e.trim();return n?/^biblatexcitekey\s*\[[^\]]*\]\s*$/i.test(n)?!0:/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:/i.test(n):!1}async applyZoteroAnnotationUpdates(e){var n;for(let t of e){let{entry:i,note:r}=t,a=(n=i.rawValues)!=null?n:{},s=this.normalizeAnnotationText(r.text),o=this.normalizeAnnotationText(r.comment),l=String(i.annotationType||"").trim().toLowerCase(),c=l==="highlight"||l==="underline";!c&&!o&&s&&(o=s,s=""),l==="note"&&!o&&s&&(o=s,s="");let d={annotationComment:o,tags:this.buildZoteroTags(r.tags,a==null?void 0:a.tags)};c&&(d.annotationText=s);try{await this.updateZoteroItemFields(i.key,a,d),i.text=c?s:"",i.comment=o,i.tags=this.normalizeAnnotationTags(r.tags)}catch(_){console.warn(`Failed to update Zotero annotation ${i.key}`,_)}}}buildZoteroTags(e,n){let t=this.normalizeZoteroTags(e),i=t.map(o=>({tag:o,type:0})),r=new Set(t.map(o=>o.toLowerCase())),s=(Array.isArray(n)?n.filter(o=>o&&typeof o=="object"&&Number(o.type)===1).filter(o=>typeof o.tag=="string"):[]).filter(o=>!r.has(String(o.tag).toLowerCase()));return[...i,...s]}buildZoteroCreators(e,n,t){let i=new Map;for(let o of t){if((o==null?void 0:o.creatorType)!=="editor"&&(o==null?void 0:o.creatorType)!=="seriesEditor")continue;let l=he(o);l&&i.set(l.trim().toLowerCase(),o.creatorType)}let r=t.filter(o=>(o==null?void 0:o.creatorType)!=="author"&&(o==null?void 0:o.creatorType)!=="editor"&&(o==null?void 0:o.creatorType)!=="seriesEditor"),a=e.map(o=>o.trim()).filter(Boolean).map(o=>({creatorType:"author",...this.parseCreatorName(o)})),s=n.map(o=>o.trim()).filter(Boolean).map(o=>{var l;return{creatorType:(l=i.get(o.trim().toLowerCase()))!=null?l:"editor",...this.parseCreatorName(o)}});return[...a,...s,...r]}parseCreatorName(e){var a;let n=String(e||"").trim();if(!n)return{name:""};if(n.includes(",")){let[s,o]=n.split(",",2).map(l=>l.trim());if(s&&o)return{firstName:o,lastName:s};if(s)return{lastName:s}}let t=n.split(/\s+/).filter(Boolean);if(t.length===1)return{name:n};let i=(a=t.pop())!=null?a:"";return{firstName:t.join(" ").trim(),lastName:i}}extractSyncSection(e){let n=ue.exec(e);if(!n)return null;let t=e.slice(n.index+n[0].length),i=fe.exec(t);return i?t.slice(0,i.index):null}extractDocIdFromSyncMarker(e){var r;let n=ue.exec(e);if(!n)return null;let i=((r=n[0])!=null?r:"").match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return i?i[2].trim():null}parseSyncedChunkBlocks(e){var o;let n=e.split(/\r?\n/),t=[],i="",r=!1,a=[],s=()=>{i&&(t.push({chunkId:i,text:a.join(`
`).trim(),excludeFlag:r}),i="",r=!1,a=[])};for(let l of n){let c=l.match(ce);if(c){s();let d=(o=c[1])!=null?o:"",_=d.match(/id=([\"']?)([^\"'\s]+)\1/i),u=_?_[2].trim():"";if(!u)continue;i=u,r=/\bexclude\b/i.test(d)||/\bdelete\b/i.test(d),a=[];continue}if(Ne.test(l)){s();continue}if(i){if(xe.test(l)){r=!0;continue}a.push(l)}}return s(),t}normalizeChunkText(e){return e.split(/\r?\n/).map(n=>n.replace(/\s+/g," ").trim()).filter((n,t,i)=>!(n===""&&i[t-1]==="")).join(`
`).trim()}isAnnotationChunk(e){return!e||typeof e!="object"?!1:!!(e.is_annotation||e.annotation||e.annotation_key)}buildSyncedDoclingContent(e,n,t){var s;let i=(Array.isArray(n==null?void 0:n.chunks)?n==null?void 0:n.chunks:[]).filter(o=>!this.isAnnotationChunk(o));if(!i.length)return`<!-- zrr:sync-start doc_id=${e} -->
${t}
<!-- zrr:sync-end -->`;let r=i.some(o=>{if(typeof(o==null?void 0:o.section)=="string"?o.section.trim():"")return!0;let c=typeof(o==null?void 0:o.chunk_id)=="string"?o.chunk_id.trim():"";return!!(c&&!/^p\d+$/i.test(c))}),a=[`<!-- zrr:sync-start doc_id=${e} -->`];for(let o of i){let l=typeof(o==null?void 0:o.chunk_id)=="string"?o.chunk_id.trim():"";if(!l)continue;let c=Number.isFinite((s=o==null?void 0:o.page_start)!=null?s:NaN)?Number(o.page_start):null,d=!!(o!=null&&o.excluded||o!=null&&o.exclude),u=typeof(o==null?void 0:o.text)=="string"?o.text.trim():"";if(r){let C=typeof(o==null?void 0:o.section)=="string"?o.section.trim():"",f=C?`## ${C}`:"";f&&!u.startsWith("#")&&(u=u?`${f}

${u}`:f)}let m=c!==null?r?` (${c})`:` page=${c}`:"",b=` id=${l}${r?" section":""}${m}${d?" exclude":""}`;a.push(`<!-- zrr:chunk${b} -->`),u&&a.push(u),a.push("<!-- zrr:chunk end -->"),a.push("")}return a[a.length-1]===""&&a.pop(),a.push("<!-- zrr:sync-end -->"),a.join(`
`)}async readChunkPayload(e){try{let n=await this.app.vault.adapter.read(e);return JSON.parse(n)}catch(n){return console.warn("Failed to read cached chunks JSON",n),null}}buildAnnotationChunk(e){var a;let n=[];e.text&&n.push(e.text),e.comment&&n.push(e.comment),e.tags.length&&n.push(`Tags: ${e.tags.map(s=>`#${s}`).join(" ")}`);let t=n.join(`

`).trim(),i=(a=e.pageIndex)!=null?a:0,r=e.pageLabel||(e.pageIndex?String(e.pageIndex):"");return{chunk_id:e.key,text:t,page_start:i,page_end:i,annotation_page_label:r,section:e.heading,chunk_tags:e.tags,is_annotation:!0,annotation_key:e.key,annotation_color:e.colorKey,annotation_text:e.text,annotation_comment:e.comment}}annotationChunkSignature(e){var n,t,i,r,a,s,o,l,c;return JSON.stringify({text:(n=e.text)!=null?n:"",page_start:(t=e.page_start)!=null?t:"",page_end:(i=e.page_end)!=null?i:"",section:(r=e.section)!=null?r:"",chunk_tags:Array.isArray(e.chunk_tags)?e.chunk_tags:(a=e.chunk_tags)!=null?a:"",annotation_color:(s=e.annotation_color)!=null?s:"",annotation_page_label:(o=e.annotation_page_label)!=null?o:"",annotation_text:(l=e.annotation_text)!=null?l:"",annotation_comment:(c=e.annotation_comment)!=null?c:""})}async updateAnnotationChunks(e,n,t){var m;let i=(0,h.normalizePath)(`${H}/${e}.json`),r=this.app.vault.adapter;if(!await r.exists(i))return;let a=await this.readChunkPayload(i);if(!a)return;let s=Array.isArray(a.chunks)?a.chunks:[],o=[],l=new Map;for(let y of s){let b=typeof(y==null?void 0:y.chunk_id)=="string"?y.chunk_id:String((m=y==null?void 0:y.chunk_id)!=null?m:"");b&&this.isAnnotationChunk(y)?l.set(b,y):o.push(y)}let c=[],d=[],_=new Set;for(let y of t){let b=this.buildAnnotationChunk(y),C=String(b.chunk_id||"");if(!C)continue;_.add(C),c.push(b);let f=l.get(C);if(!f){d.push(C);continue}this.annotationChunkSignature(f)!==this.annotationChunkSignature(b)&&d.push(C)}let u=[];for(let y of l.keys())_.has(y)||u.push(y);if(a.chunks=[...o,...c],await r.write(i,JSON.stringify(a,null,2)),(d.length||u.length)&&await this.reindexChunkUpdates(e,i,d,u),n)try{let y=a.metadata&&typeof a.metadata=="object"?a.metadata:{};y.attachment_key!==n&&(y.attachment_key=n,a.metadata=y,await r.write(i,JSON.stringify(a,null,2)))}catch(y){}}resolveChunkFromPayload(e,n,t){var a;let i=this.normalizeChunkIdForNote(n,t)||n,r=new Set([n,i,`${t}:${n}`]);for(let s of e){let o=typeof(s==null?void 0:s.chunk_id)=="string"?s.chunk_id:String((a=s==null?void 0:s.chunk_id)!=null?a:"");if(o&&r.has(o))return s}return null}async writeNoteWithSyncSuppressed(e,n){this.noteSyncSuppressed.add(e);try{await this.app.vault.adapter.write(e,n)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e)},1500)}}async resolveNotePathForDocId(e){if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e);if(t!=null&&t.note_path&&await n.exists(t.note_path))return t.note_path;let r=(await this.scanNotesForDocIds(this.settings.outputNoteDir))[e];return r!=null&&r.note_path?(await this.updateDocIndex({doc_id:e,note_path:r.note_path,note_title:r.note_title}),r.note_path):null}isZoteroNoteFile(e){let n=this.app.metadataCache.getFileCache(e),t=n==null?void 0:n.frontmatter;return!!(this.getFrontmatterValue(t,"doc_id")||this.getFrontmatterValue(t,"zotero_key"))}async deleteZoteroNoteAndCacheForFile(e){var c;let n=e.path,t=await this.app.vault.read(e),i=(c=this.extractDocIdFromFrontmatter(t))!=null?c:this.extractDocIdFromSyncMarker(t);if(!i){new h.Notice("No doc_id found in this note.");return}if(!await new Promise(d=>{new Be(this.app,n,i,d).open()}))return;let a=this.app.vault.adapter,s=(0,h.normalizePath)(`${H}/${i}.json`),o=(0,h.normalizePath)(`${te}/${i}.json`),l=[];if(await a.exists(s)){let d=await this.readChunkPayload(s);l=(Array.isArray(d==null?void 0:d.chunks)?d==null?void 0:d.chunks:[]).map(u=>{var m;return String((m=u==null?void 0:u.chunk_id)!=null?m:"")}).map(u=>u.startsWith(`${i}:`)?u.slice(i.length+1):u).filter(u=>u)}l.length>0&&await this.reindexChunkUpdates(i,s,[],l);try{await a.exists(s)&&await a.remove(s),await a.exists(o)&&await a.remove(o),await this.removeDocIndexEntry(i),await this.app.vault.delete(e,!0),new h.Notice(`Deleted note and cache for ${i}.`)}catch(d){console.error("Failed to delete note and cached data",d),new h.Notice("Failed to delete note or cached data. See console for details.")}}async deleteZoteroNoteAndCache(){let e=this.app.workspace.getActiveViewOfType(h.MarkdownView);if(!e||!e.file){new h.Notice("No active Zotero note found.");return}await this.deleteZoteroNoteAndCacheForFile(e.file)}formatRedisSearchResults(e){let n=typeof(e==null?void 0:e.total)=="number"?e.total:0,t=typeof(e==null?void 0:e.query)=="string"?e.query:"",i=typeof(e==null?void 0:e.raw_query)=="string"?e.raw_query:"",r=e!=null&&e.field_types&&typeof e.field_types=="object"?e.field_types:null,a=!!(e!=null&&e.fallback_used),s=typeof(e==null?void 0:e.fallback_reason)=="string"?e.fallback_reason:"",o=Array.isArray(e==null?void 0:e.fallback_queries)?e.fallback_queries:[],l=Array.isArray(e==null?void 0:e.fallback_failed_fields)?e.fallback_failed_fields:[],c=Array.isArray(e==null?void 0:e.results)?e.results:[],d=[];if(d.push(`Query: ${i||t}`),t&&i&&t!==i&&d.push(`Expanded: ${t}`),d.push(`Total matches: ${n}`),r&&Object.keys(r).length>0){let _=Object.keys(r).sort().map(u=>`${u}:${r[u]}`);d.push(`Field types: {${_.join(", ")}}`)}if(a&&d.push(`Fallback: ${s||"true"}`),o.length){d.push("Fallback queries:");for(let _ of o)d.push(`  - ${_}`)}if(l.length&&d.push(`Fallback failed fields: ${l.join(", ")}`),d.push(""),!c.length)return d.push("(no results)"),d.join(`
`);for(let _ of c){let u=String(_.doc_id||"").trim(),m=String(_.chunk_id||"").trim(),y=String(_.page_start||"").trim(),b=String(_.page_end||"").trim(),C=String(_.title||"").trim(),f=String(_.section||"").trim(),v=String(_.score||"").trim(),x=String(_.authors||"").trim(),w=String(_.item_type||"").trim(),R=String(_.year||"").trim(),A=String(_.tags||"").trim(),S=String(_.chunk_tags||"").trim(),L=String(_.attachment_key||"").trim(),z=String(_.source_pdf||"").trim(),O=String(_.text||"").replace(/\s+/g," ").trim(),j=O.length>220?`${O.slice(0,220)}\u2026`:O,F=[u];m&&F.push(m),(y||b)&&F.push(`p.${y||"?"}-${b||"?"}`),d.push(F.filter(Boolean).join(" \u2022 ")),v&&d.push(`  score: ${v}`),C&&d.push(`  title: ${C}`),x&&d.push(`  authors: ${x}`),R&&d.push(`  year: ${R}`),w&&d.push(`  item_type: ${w}`),A&&d.push(`  tags: ${A}`),S&&d.push(`  chunk_tags: ${S}`),L&&d.push(`  attachment_key: ${L}`),f&&d.push(`  section: ${f}`),z&&d.push(`  source_pdf: ${z}`),j&&d.push(`  ${j}`),d.push("")}return d.join(`
`)}async searchRedisIndex(){new Ze(this.app,this,this.lastRedisSearchTerm).open()}async runRedisSearch(e){let n=e.trim();if(!n)return"(no query)";if(this.lastRedisSearchTerm=n,!await this.ensureRedisAvailable("index search"))return"Redis is not reachable. Please start Redis Stack and try again.";let t=this.getPluginDir(),i=E.default.join(t,"tools","search_redis.py"),r=["--query",n,"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--limit","10"];try{await this.ensureBundledTools();let a=await this.runPythonWithOutput(i,r),s=JSON.parse(a||"{}");return this.formatRedisSearchResults(s)||"(no results)"}catch(a){return console.error("Redis search failed",a),"Redis search failed. See console for details."}}async showRedisDiagnostics(){if(!await this.ensureRedisAvailable("diagnostics"))return;let e=this.getPluginDir(),n=E.default.join(e,"tools","redis_diagnostics.py"),t=["--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName()];try{await this.ensureBundledTools();let i=await this.runPythonWithOutput(n,t),r=JSON.parse(i||"{}"),a=`\`\`\`json
${JSON.stringify(r,null,2)}
\`\`\``;new ye(this.app,"Redis diagnostics",a||"(empty)").open()}catch(i){console.error("Redis diagnostics failed",i),new h.Notice("Redis diagnostics failed. See console for details.")}}async resolveUniqueBaseName(e,n){let t=this.app.vault.adapter,i=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${e}.md`),r=(0,h.normalizePath)(`${this.settings.outputPdfDir}/${e}.pdf`),a=await t.exists(i),s=this.settings.copyPdfToVault?await t.exists(r):!1;return a||s?`${e}-${n}`:e}async searchZoteroItems(e){let n=e.trim(),t=["data,meta"];for(let i of t){let r=new URLSearchParams;r.set("itemType","-attachment"),r.set("limit","25"),r.set("include",i),n?r.set("q",n):(r.set("sort","dateAdded"),r.set("direction","desc"));let a=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/top?${r.toString()}`);try{let s=await this.requestLocalApi(a,`Zotero search failed for ${a}`),o=JSON.parse(s.toString("utf8"));return Array.isArray(o)?this.normalizeZoteroSearchResults(o):[]}catch(s){console.warn("Failed to search Zotero via local API",s)}}if(!this.canUseWebApi())throw new Error("Zotero search failed for all include modes.");return this.searchZoteroItemsWeb(n)}async hasProcessableAttachment(e){var r;let n=(r=e.data)!=null?r:e,t=typeof e.key=="string"?e.key:V(n.key);return t?!!await ve(n,t,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)}):!1}async fetchZoteroChildrenLocal(e,n={}){let t=new URLSearchParams;n.includeAnnotationImage&&t.set("include","annotationImage");let i=t.toString()?`?${t.toString()}`:"",r=this.buildZoteroUrl(`/${this.getZoteroLibraryPath()}/items/${e}/children${i}`),a=await this.requestLocalApi(r,`Zotero children request failed for ${r}`);return JSON.parse(a.toString("utf8"))}async fetchZoteroChildrenWeb(e,n={}){if(!this.canUseWebApi()&&(!await this.ensureWebApiLibraryId()||!this.canUseWebApi()))throw new Error("Zotero Web API is not configured.");let t=new URLSearchParams;n.includeAnnotationImage&&t.set("include","annotationImage");let i=t.toString()?`?${t.toString()}`:"",r=this.buildWebApiUrl(`/${this.getWebApiLibraryPath()}/items/${e}/children${i}`),a=await this.requestWebApi(r,`Zotero Web API children request failed for ${r}`);return JSON.parse(a.toString("utf8"))}async fetchZoteroChildren(e){try{return await this.fetchZoteroChildrenLocal(e)}catch(n){if(console.warn("Failed to fetch Zotero children from local API",n),!this.canUseWebApi())throw n;return this.fetchZoteroChildrenWeb(e)}}buildZoteroUrl(e){return`${this.settings.zoteroBaseUrl.replace(/\/$/,"")}${e}`}canUseWebApi(){return!!((this.settings.webApiBaseUrl||"").trim()&&this.settings.webApiKey&&this.settings.webApiLibraryId)}async ensureWebApiLibraryId(){var i,r,a,s,o;let e=(this.settings.webApiBaseUrl||"").trim(),n=(this.settings.webApiKey||"").trim();if(!e||!n||(this.settings.webApiLibraryId||"").trim())return!!(this.settings.webApiLibraryId||"").trim();let t=this.buildWebApiUrl("/keys/current");try{let l=await this.requestWebApi(t,`Zotero Web API key lookup failed for ${t}`),c=JSON.parse(l.toString("utf8")),d=(o=(a=(i=c==null?void 0:c.userID)!=null?i:c==null?void 0:c.userId)!=null?a:(r=c==null?void 0:c.data)==null?void 0:r.userID)!=null?o:(s=c==null?void 0:c.data)==null?void 0:s.userId;return d?(this.settings.webApiLibraryId=String(d),await this.saveSettings(),console.info("Resolved Zotero Web API user ID from key",{userId:d}),!0):!1}catch(l){return console.warn("Failed to resolve Zotero Web API user ID",l),!1}}getWebApiLibraryPath(){let e=(this.settings.webApiLibraryId||"").trim();return e?`${this.settings.webApiLibraryType==="group"?"groups":"users"}/${e}`:""}buildWebApiUrl(e){return`${this.settings.webApiBaseUrl.replace(/\/$/,"")}${e}`}requestLocalApiRaw(e,n={}){return new Promise((t,i)=>{var u,m,y;let r=new URL(e),a=r.protocol==="https:"?nt.default:et.default,s=(u=n.method)!=null?u:"GET",o={Accept:"*/*",...(m=n.headers)!=null?m:{}},l=n.body,c=Number.isFinite((y=n.timeoutMs)!=null?y:NaN)?Number(n.timeoutMs):0,d=null;if(l!==void 0&&o["Content-Length"]===void 0){let b=Buffer.isBuffer(l)?l.length:Buffer.byteLength(l);o["Content-Length"]=String(b)}let _=a.request({method:s,hostname:r.hostname,port:r.port||void 0,path:`${r.pathname}${r.search}`,headers:o},b=>{let C=[];b.on("data",f=>C.push(Buffer.from(f))),b.on("end",()=>{var v;d&&clearTimeout(d);let f=Buffer.concat(C);t({statusCode:(v=b.statusCode)!=null?v:0,headers:b.headers,body:f})})});c>0&&(d=setTimeout(()=>{_.destroy(new Error(`Request timed out after ${c}ms`))},c)),_.on("error",b=>{d&&clearTimeout(d),i(b)}),l!==void 0&&_.write(l),_.end()})}async requestLocalApi(e,n){let t=await this.requestLocalApiRaw(e);if(t.statusCode>=400){let i=t.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}: ${i||"no response body"}`)}if(t.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${t.statusCode}`);return t.body}async requestLocalApiWithBody(e,n,t,i,r){let a=JSON.stringify(t),s=await this.requestLocalApiRaw(e,{method:n,headers:i,body:a});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}async requestWebApi(e,n){let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey},i=await this.requestLocalApiRaw(e,{headers:t});if(i.statusCode>=400){let r=i.body.toString("utf8");throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}: ${r||"no response body"}`)}if(i.statusCode>=300)throw new Error(`${n!=null?n:"Request failed"}, status ${i.statusCode}`);return i.body}requestWebApiRaw(e,n={}){var i;let t={"Zotero-API-Version":"3","Zotero-API-Key":this.settings.webApiKey,...(i=n.headers)!=null?i:{}};return this.requestLocalApiRaw(e,{...n,headers:t})}async requestWebApiWithBody(e,n,t,i,r){let a=JSON.stringify(t),s=await this.requestLocalApiRaw(e,{method:n,headers:i,body:a});if(s.statusCode>=400){let o=s.body.toString("utf8");throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}: ${o||"no response body"}`)}if(s.statusCode>=300)throw new Error(`${r!=null?r:"Request failed"}, status ${s.statusCode}`);return{statusCode:s.statusCode,body:s.body}}bufferToArrayBuffer(e){return e.buffer.slice(e.byteOffset,e.byteOffset+e.byteLength)}async annotateChunkJsonWithAttachmentKey(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;let r=i.metadata&&typeof i.metadata=="object"?i.metadata:{};r.attachment_key=n,i.metadata=r,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to annotate chunks JSON with attachment key",t)}}async updateChunkJsonSourcePdf(e,n){if(n)try{let t=await this.app.vault.adapter.read(e),i=JSON.parse(t);if(!i||typeof i!="object")return;i.source_pdf=n,await this.app.vault.adapter.write(e,JSON.stringify(i,null,2))}catch(t){console.warn("Failed to update chunks JSON source_pdf",t)}}buildPdfLinkFromSourcePath(e){if(!e)return"";if(!E.default.isAbsolute(e)&&!/^[A-Za-z]+:\/\//.test(e))return`[[${(0,h.normalizePath)(e)}]]`;let n=E.default.normalize(this.getVaultBasePath()),t=E.default.normalize(e),i=n.endsWith(E.default.sep)?n:`${n}${E.default.sep}`;return t.startsWith(i)?`[[${(0,h.normalizePath)(E.default.relative(n,t))}]]`:`[PDF](${(0,fn.pathToFileURL)(e).toString()})`}toVaultRelativePath(e){if(!e)return"";if(!E.default.isAbsolute(e)&&!/^[A-Za-z]+:\/\//.test(e))return(0,h.normalizePath)(e);let n=E.default.normalize(this.getVaultBasePath()),t=E.default.normalize(e),i=n.endsWith(E.default.sep)?n:`${n}${E.default.sep}`;return t.startsWith(i)?(0,h.normalizePath)(E.default.relative(n,t)):""}normalizeDocIndexPdfPath(e){return e&&(this.toVaultRelativePath(e)||e)}async isFileAccessible(e){if(!e)return!1;try{return await G.promises.access(e),!0}catch(n){return!1}}deriveVaultPdfRelativePath(e,n,t){let i=this.toVaultRelativePath(e);if(i&&i.startsWith((0,h.normalizePath)(this.settings.outputPdfDir)))return i;let r=this.sanitizeFileName(n)||t;return(0,h.normalizePath)(`${this.settings.outputPdfDir}/${r}.pdf`)}async recoverMissingPdfFromAttachment(e,n,t,i,r,a,s){let o=await ve(n,t,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});if(!o&&r&&(o={key:r}),!o)return null;let l=o.key||r,c=o.filePath;if(!this.settings.copyPdfToVault&&c&&await this.isFileAccessible(c))return{sourcePdf:c,attachmentKey:l};try{await this.ensureFolder(this.settings.outputPdfDir)}catch(m){return console.error("Failed to create PDF output folder",m),null}let d=this.deriveVaultPdfRelativePath(e,a,i),_;try{if(c&&await this.isFileAccessible(c))_=await G.promises.readFile(c);else if(l)_=await Qe(l,{buildZoteroUrl:this.buildZoteroUrl.bind(this),getZoteroLibraryPath:this.getZoteroLibraryPath.bind(this),canUseWebApi:this.canUseWebApi.bind(this),buildWebApiUrl:this.buildWebApiUrl.bind(this),getWebApiLibraryPath:this.getWebApiLibraryPath.bind(this),requestLocalApiRaw:this.requestLocalApiRaw.bind(this),requestWebApiRaw:this.requestWebApiRaw.bind(this),requestLocalApi:this.requestLocalApi.bind(this),readFile:G.promises.readFile}),!this.settings.copyPdfToVault&&s&&new h.Notice("Local PDF path unavailable; copied PDF into vault for processing.");else return null}catch(m){return console.error("Failed to read or download PDF attachment",m),null}try{await this.app.vault.adapter.writeBinary(d,this.bufferToArrayBuffer(_))}catch(m){return console.error("Failed to write recovered PDF into vault",m),null}return{sourcePdf:this.getAbsoluteVaultPath(d),attachmentKey:l}}buildPdfLinkForNote(e,n,t){return!e&&!n?"":!this.settings.copyPdfToVault&&n?`[PDF](${this.buildZoteroDeepLink(t!=null?t:"",n)})`:this.buildPdfLinkFromSourcePath(e)}buildVaultPdfCitationLink(e,n,t){if(!e)return"";let i=this.toVaultRelativePath(e);if(!i)return"";let r=n?`#page=${n}`:"";return`[[${i}${r}|${t||i}]]`}async maybeCreateOcrLayeredPdf(e,n,t){if(!this.settings.createOcrLayeredPdf||!this.settings.copyPdfToVault||!e||!((n==null?void 0:n.ocr_used)===!0))return null;if(!this.toVaultRelativePath(e))return console.warn("OCR layered PDF requires a vault-local PDF"),null;try{await this.ensureFolder(this.settings.outputPdfDir)}catch(l){return console.warn("Failed to create OCR PDF output folder",l),null}let r=`${e}.ocr.tmp`,a=(t||(n==null?void 0:n.languages)||"eng").toString(),s=this.getPluginDir(),o=E.default.join(s,"tools","ocr_layered_pdf.py");try{return this.showStatusProgress("Creating OCR PDF...",0),await this.runPythonStreaming(o,["--pdf",e,"--out-pdf",r,"--language",a,"--progress"],l=>{if((l==null?void 0:l.type)==="progress"&&l.total){let c=Math.round(l.current/l.total*100);this.showStatusProgress(`Creating OCR PDF ${l.current}/${l.total}`,c)}},()=>{}),await G.promises.rename(r,e),e}catch(l){return console.warn("OCR layered PDF creation failed",l),null}}getMainLeaf(){let e=new Set(this.app.workspace.getLeavesOfType(be)),n=this.app.workspace.getLeavesOfType("markdown").find(i=>!e.has(i));if(n)return n;let t=this.app.workspace.getLeaf(!1);return t&&!e.has(t)?t:this.app.workspace.getLeaf("tab")}async openNoteInMain(e){let n=(0,h.normalizePath)(e),t=this.app.vault.getAbstractFileByPath(n),i=this.getMainLeaf();if(t instanceof h.TFile){await i.openFile(t,{active:!0});return}await this.app.workspace.openLinkText(n,"",!1)}findChunkLineInText(e,n){if(!e||!n)return null;let t=this.escapeRegExp(n),i=new RegExp(`<!--\\s*zrr:chunk\\b[^>]*\\bid=(["']?)${t}\\1[^>]*-->`,"i"),r=e.split(`
`);for(let a=0;a<r.length;a+=1)if(i.test(r[a]))return a;return null}findAnnotationLineInText(e,n){if(!e||!n)return null;let t=this.escapeRegExp(n),i=new RegExp(`^\\s*>?\\s*\\^${t}\\b`,"i"),r=e.split(`
`);for(let a=0;a<r.length;a+=1)if(i.test(r[a]))return a;return null}async openNoteAtChunk(e,n){if(!e||!n)return!1;await this.openNoteInMain(e);let i=this.getMainLeaf().view;if(!(i instanceof h.MarkdownView))return!1;let r=i.editor,a=this.normalizeChunkIdForNote(n)||n,s=this.findChunkLineInText(r.getValue(),a);return s===null?(new h.Notice(`Chunk ${a} not found in note.`),!1):(r.setCursor({line:s,ch:0}),r.scrollIntoView({from:{line:s,ch:0},to:{line:s,ch:0}},!0),!0)}async openNoteAtAnnotation(e,n,t,i){let r=this.buildAnnotationBlockId(n,t,i);if(!e||!r)return!1;await this.openNoteInMain(e);let s=this.getMainLeaf().view;if(!(s instanceof h.MarkdownView))return!1;let o=s.editor,l=this.findAnnotationLineInText(o.getValue(),r);return l===null?(new h.Notice(`Annotation ${n} not found in note.`),!1):(o.setCursor({line:l,ch:0}),o.scrollIntoView({from:{line:l,ch:0},to:{line:l,ch:0}},!0),!0)}async openInternalLinkInMain(e){let n=this.getMainLeaf(),[t,i]=e.split("#"),r=(t||"").trim(),a=(i||"").trim(),s="zrr-chunk:",o=r?this.app.metadataCache.getFirstLinkpathDest(r,""):null;if(o instanceof h.TFile){let l=a.startsWith(s)?a.slice(s.length).trim():"";if(l&&await this.openNoteAtChunk(o.path,l))return;await n.openFile(o,{active:!0}),e.includes("#")&&!l&&(this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1));return}this.app.workspace.setActiveLeaf(n,{focus:!0}),await this.app.workspace.openLinkText(e,"",!1)}async openNoteInNewTab(e){let n=(0,h.normalizePath)(e);await this.app.workspace.openLinkText(n,"","tab")}async openPdfInMain(e,n){if(!e)return!1;if(!E.default.isAbsolute(e)&&!/^[A-Za-z]+:\/\//.test(e)){let a=(0,h.normalizePath)(e),s=n?`#page=${n}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}let t=E.default.normalize(this.getVaultBasePath()),i=E.default.normalize(e),r=t.endsWith(E.default.sep)?t:`${t}${E.default.sep}`;if(i.startsWith(r)){let a=(0,h.normalizePath)(E.default.relative(t,i)),s=n?`#page=${n}`:"";return await this.app.workspace.openLinkText(`${a}${s}`,"","tab"),!0}try{return window.open((0,fn.pathToFileURL)(e).toString()),!0}catch(a){return!1}}openExternalUrl(e){e&&window.open(e)}buildZoteroDeepLink(e,n,t,i){if(n){let r=new URLSearchParams;t&&r.set("page",t),i&&r.set("annotation",i);let a=r.toString()?`?${r.toString()}`:"";return`zotero://open-pdf/library/items/${n}${a}`}return`zotero://select/library/items/${e}`}extractAnnotationKey(e){if(!e)return;let t=(e.includes(":")?e.split(":").slice(1).join(":"):e).trim().toUpperCase();if(/^[A-Z0-9]{8}$/.test(t))return t}formatCitationsMarkdown(e){return e.length?e.map(t=>this.formatCitationMarkdown(t)).filter(Boolean).join(`
`):""}formatCitationMarkdown(e){var d,_,u,m,y;let n=e.doc_id||"?",t=this.formatCitationPageLabel(e),i=e.annotation_key||this.extractAnnotationKey(e.chunk_id),r=e.attachment_key||((_=(d=this.docIndex)==null?void 0:d[e.doc_id||""])==null?void 0:_.attachment_key),a=e.page_start?String(e.page_start):"",s=(m=(u=this.docIndex)==null?void 0:u[e.doc_id||""])!=null?m:null,o=this.resolveCitationTitle(s,(y=s==null?void 0:s.note_path)!=null?y:null,e.doc_id),l=this.formatCitationLabel(o,t),c=this.normalizeChunkIdForNote(e.chunk_id,e.doc_id);if(this.settings.preferObsidianNoteForCitations&&(s!=null&&s.note_path)){if(i){let b=a||(e.page_end?String(e.page_end):"0"),C=this.buildNoteAnnotationLink(s.note_path,i,r||"",b,l);return C?`- ${C}`:`- ${this.buildNoteLink(s.note_path,l)}`}if(c&&!i)return`- ${this.buildNoteChunkLink(s.note_path,c,l)}`}if(r){let b=this.buildZoteroDeepLink(n,r,a,i);return`- [${l}](${b})`}return`- ${l}`}buildNoteChunkLink(e,n,t){let i=(0,h.normalizePath)(e).replace(/\.md$/i,""),r=`zrr-chunk:${n}`,a=this.escapeWikiLabel(t);return`[[${i}#${r}\\|${a}]]`}buildNoteLink(e,n){let t=(0,h.normalizePath)(e).replace(/\.md$/i,""),i=this.escapeWikiLabel(n);return`[[${t}\\|${i}]]`}buildNoteAnnotationLink(e,n,t,i,r){let a=this.buildAnnotationBlockId(n,t,i);if(!a)return null;let s=(0,h.normalizePath)(e).replace(/\.md$/i,""),o=this.escapeWikiLabel(r);return`[[${s}#^${a}\\|${o}]]`}buildAnnotationBlockId(e,n,t){let i=(e||"").trim().toUpperCase(),r=(n||"").trim().toUpperCase();if(!i||!r)return null;let a=(t||"").trim()||"0";return`${i}a${r}p${a}`}escapeWikiLabel(e){return e?e.replace(/\|/g,"\\|"):""}generateChatId(){return typeof crypto!="undefined"&&"randomUUID"in crypto?crypto.randomUUID():`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,8)}`}getDocIndexPath(){return(0,h.normalizePath)(`${Y}/doc_index.json`)}async getDocIndex(){return this.docIndex?this.docIndex:(this.docIndex=await this.loadDocIndexFromDisk(),this.docIndex)}async loadDocIndexFromDisk(){var t;let e=this.app.vault.adapter,n=this.getDocIndexPath();if(!await e.exists(n))return{};try{let i=await e.read(n),r=JSON.parse(i);if(r&&typeof r=="object"){let a=(t=r.entries)!=null?t:r;if(Array.isArray(a)){let s={};for(let l of a)l!=null&&l.doc_id&&(s[String(l.doc_id)]=l);let o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(s),s}if(a&&typeof a=="object"){let s=a,o=!1;for(let l of Object.values(s))if(l&&typeof l.pdf_path=="string"){let c=this.normalizeDocIndexPdfPath(l.pdf_path);c!==l.pdf_path&&(l.pdf_path=c,o=!0)}return o&&await this.saveDocIndex(s),s}}}catch(i){console.error("Failed to read doc index",i)}return{}}async saveDocIndex(e){await this.ensureFolder(Y);let n=this.app.vault.adapter,t=this.getDocIndexPath(),i={version:1,entries:e};await n.write(t,JSON.stringify(i,null,2)),this.docIndex=e}async pruneDocIndexOrphans(){var c;let e=this.app.vault.adapter,n=await this.getDocIndex(),t=new Set(await this.listDocIds(te)),i=new Set(await this.listDocIds(H)),r=await this.scanNotesForDocIds(this.settings.outputNoteDir),a=0,s=0,o=!1,l=new Date().toISOString();for(let d of Object.keys(n)){let _=n[d],u=!1,m=_!=null&&_.note_path?_.note_path.trim():"";if(m&&await e.exists(m))u=!0;else if((c=r[d])!=null&&c.note_path){u=!0;let b=r[d];b.note_path&&b.note_path!==_.note_path&&(_.note_path=b.note_path,s+=1,o=!0),b.note_title&&b.note_title!==_.note_title&&(_.note_title=b.note_title,s+=1,o=!0),s>0&&(_.updated_at=l)}let y=t.has(d)||i.has(d);!u&&!y&&(delete n[d],a+=1,o=!0)}return o&&await this.saveDocIndex(n),{removed:a,updated:s}}async updateDocIndex(e){var r;let n=await this.getDocIndex(),t=(r=n[e.doc_id])!=null?r:{doc_id:e.doc_id},i={...t,...e,doc_id:e.doc_id,updated_at:new Date().toISOString()};e.note_path===void 0&&t.note_path&&(i.note_path=t.note_path),e.note_title===void 0&&t.note_title&&(i.note_title=t.note_title),e.zotero_title===void 0&&t.zotero_title&&(i.zotero_title=t.zotero_title),e.short_title===void 0&&t.short_title&&(i.short_title=t.short_title),e.pdf_path===void 0&&t.pdf_path&&(i.pdf_path=t.pdf_path),e.attachment_key===void 0&&t.attachment_key&&(i.attachment_key=t.attachment_key),typeof i.pdf_path=="string"&&(i.pdf_path=this.normalizeDocIndexPdfPath(i.pdf_path)),n[e.doc_id]=i,await this.saveDocIndex(n)}async removeDocIndexEntry(e){let n=await this.getDocIndex();if(!n[e]){await this.removeMetadataSnapshot(e);return}delete n[e],await this.saveDocIndex(n),await this.removeMetadataSnapshot(e)}async hydrateDocIndexFromCache(e){var s,o;if(!e)return null;let n=this.app.vault.adapter,t=await this.getDocIndexEntry(e),i={},r=(0,h.normalizePath)(`${te}/${e}.json`);if(await n.exists(r))try{let l=await n.read(r),c=JSON.parse(l),d=(o=(s=c==null?void 0:c.data)!=null?s:c)!=null?o:{},_=typeof d.title=="string"?d.title:"";_&&(i.zotero_title=_);let u=me(d);if(u&&(i.short_title=u),!i.note_title||!i.note_path){let m=this.sanitizeFileName(_)||e,y=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${m}.md`),b=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${m}-${e}.md`),C="";await n.exists(y)?C=y:await n.exists(b)&&(C=b),C&&(i.note_path=C,i.note_title=E.default.basename(C,".md"))}}catch(l){console.error("Failed to read cached item JSON",l)}!i.note_title&&(t!=null&&t.note_path)&&(i.note_title=E.default.basename(t.note_path,".md"));let a=(0,h.normalizePath)(`${H}/${e}.json`);if(await n.exists(a))try{let l=await n.read(a),c=JSON.parse(l);typeof(c==null?void 0:c.source_pdf)=="string"&&(i.pdf_path=c.source_pdf)}catch(l){console.error("Failed to read cached chunks JSON",l)}return Object.keys(i).length>0&&await this.updateDocIndex({doc_id:e,...i}),this.getDocIndexEntry(e)}async getDocIndexEntry(e){var t;return e&&(t=(await this.getDocIndex())[e])!=null?t:null}async inferNotePathFromCache(e){var i,r;let n=this.app.vault.adapter,t=(0,h.normalizePath)(`${te}/${e}.json`);if(!await n.exists(t))return"";try{let a=await n.read(t),s=JSON.parse(a),o=(r=(i=s==null?void 0:s.data)!=null?i:s)!=null?r:{},l=typeof o.title=="string"?o.title:"",c=this.sanitizeFileName(l)||e,d=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${c}.md`),_=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${c}-${e}.md`);if(await n.exists(d))return d;if(await n.exists(_))return _}catch(a){console.error("Failed to infer note path from cache",a)}return""}async rebuildNoteFromCacheForDocId(e,n){var O,j,F,M,$;try{await this.ensureBundledTools()}catch(I){return n&&new h.Notice("Failed to sync bundled tools. See console for details."),console.error(I),!1}let t=this.app.vault.adapter,i=(0,h.normalizePath)(`${te}/${e}.json`),r=(0,h.normalizePath)(`${H}/${e}.json`);if(!await t.exists(i)||!await t.exists(r))return n&&new h.Notice("Cached item or chunks JSON not found."),!1;this.showStatusProgress("Preparing...",5);let a;try{let I=await t.read(i);a=JSON.parse(I)}catch(I){return n&&new h.Notice("Failed to read cached item JSON."),console.error(I),this.clearStatusProgress(),!1}let s;try{let I=await t.read(r);s=JSON.parse(I)}catch(I){return n&&new h.Notice("Failed to read cached chunks JSON."),console.error(I),this.clearStatusProgress(),!1}let o=(O=a.data)!=null?O:a,l=typeof o.title=="string"?o.title:"",c=((F=(j=a.key)!=null?j:o.key)!=null?F:e).toString(),d=await this.getDocIndexEntry(e),_=typeof((M=s==null?void 0:s.metadata)==null?void 0:M.attachment_key)=="string"?s.metadata.attachment_key:d==null?void 0:d.attachment_key,u=typeof s.source_pdf=="string"?s.source_pdf:"";if(!u||!await this.isFileAccessible(u)){let I=await this.recoverMissingPdfFromAttachment(u,o,c,e,_,l,n);if(!I)return n&&new h.Notice("Cached source PDF is missing and could not be recovered."),this.clearStatusProgress(),!1;u=I.sourcePdf,I.attachmentKey&&(_=I.attachmentKey),await this.updateChunkJsonSourcePdf(r,u)}let m=await this.resolveLanguageHint(o,c),y=this.buildDoclingLanguageHint(m!=null?m:void 0),b="";if(d!=null&&d.note_path&&await t.exists(d.note_path)&&(b=(0,h.normalizePath)(d.note_path)),!b){let I=this.sanitizeFileName(l)||e,N=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${I}.md`),q=await t.exists(N)?I:await this.resolveUniqueBaseName(I,e);b=(0,h.normalizePath)(`${this.settings.outputNoteDir}/${q}.md`)}try{if(await this.ensureFolder(this.settings.outputNoteDir),this.settings.copyPdfToVault&&await this.ensureFolder(this.settings.outputPdfDir),this.settings.enableFileLogging){let I=this.getLogFileRelativePath(),N=(0,h.normalizePath)(E.default.dirname(I));N&&await this.ensureFolder(N);let q=this.getSpellcheckerInfoRelativePath(),U=(0,h.normalizePath)(E.default.dirname(q));U&&await this.ensureFolder(U)}}catch(I){return n&&new h.Notice("Failed to create notes folder."),console.error(I),this.clearStatusProgress(),!1}let C=this.getPluginDir(),f=E.default.join(C,"tools","docling_extract.py"),v=E.default.join(C,"tools","index_redisearch.py"),x=null,w=null,R=I=>{this.recreateMissingNotesActive&&(this.recreateMissingNotesProcess=I)};try{x=await this.readDoclingQualityLabelFromPdf(u,y),this.showStatusProgress(this.formatStatusLabel("Docling extraction...",x),0);let I=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;await this.runPythonStreaming(f,await this.buildDoclingArgs(u,e,r,b,y,!0),U=>this.handleDoclingProgress(U,x),()=>{},I,"docling_extract",R),this.recreateMissingNotesProcess=null,x=await this.readDoclingQualityLabel(r),_&&await this.annotateChunkJsonWithAttachmentKey(r,_);let N=await this.readDoclingMetadata(r),q=await this.maybeCreateOcrLayeredPdf(u,N,y);q&&(u=q,w=q,await this.updateChunkJsonSourcePdf(r,q))}catch(I){return this.recreateMissingNotesAbort?(this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1):(n&&new h.Notice("Docling extraction failed. See console for details."),console.error(I),this.clearStatusProgress(),!1)}let A=!1,S=this.settings.enableFileLogging?this.getLogFileAbsolutePath():null;if(!await this.ensureRedisAvailable("rebuild"))A=!0,n&&new h.Notice("Redis is unavailable; skipping indexing for this note.");else try{this.showStatusProgress(this.formatStatusLabel("Indexing chunks...",x),0);let I=["--chunks-json",this.getAbsoluteVaultPath(r),"--redis-url",this.settings.redisUrl,"--index",this.getRedisIndexName(),"--prefix",this.getRedisKeyPrefix(),"--embed-base-url",this.settings.embedBaseUrl,"--embed-api-key",this.settings.embedApiKey,"--embed-model",this.settings.embedModel,"--upsert","--progress"];this.appendEmbedSubchunkArgs(I),this.appendEmbedContextArgs(I),this.settings.embedIncludeMetadata&&I.push("--embed-include-metadata"),this.appendChunkTaggingArgs(I,{allowRegenerate:!1}),await this.runPythonStreaming(v,I,N=>{if((N==null?void 0:N.type)==="progress"&&N.total){let q=Math.round(N.current/N.total*100),U=typeof N.message=="string"&&N.message.trim()?N.message:`Indexing chunks ${N.current}/${N.total}`,J=this.formatStatusLabel(U,x);this.showStatusProgress(J,q)}},()=>{},S,"index_redisearch",R),this.recreateMissingNotesProcess=null}catch(I){if(this.recreateMissingNotesAbort)return this.recreateMissingNotesProcess=null,this.clearStatusProgress(),!1;n&&new h.Notice("RedisSearch indexing failed; note will still be rebuilt."),console.error(I),A=!0}let z=w?this.buildPdfLinkFromSourcePath(w):this.buildPdfLinkForNote(u,d==null?void 0:d.attachment_key,e);try{let I=await this.app.vault.adapter.read(b),N=await this.readChunkPayload(r),q=this.buildSyncedDoclingContent(e,N,I),U=await this.buildNoteMarkdown(o,($=a.meta)!=null?$:{},e,z,_,b,i,q);await this.writeNoteWithSyncSuppressed(b,U);let J=this.app.vault.getAbstractFileByPath(b);J instanceof h.TFile&&this.scheduleNoteAnnotationSync(J,2e3,"save")}catch(I){return n&&new h.Notice("Failed to finalize note markdown."),console.error(I),this.clearStatusProgress(),!1}try{let I=me(o);await this.updateDocIndex({doc_id:e,note_path:b,note_title:E.default.basename(b,".md"),zotero_title:l,short_title:I||void 0,pdf_path:u})}catch(I){console.error("Failed to update doc index",I)}return!0}getZoteroLibraryPath(){let e=(this.settings.zoteroUserId||"0").trim();return!e||e==="0"?"users/0":e.startsWith("users/")||e.startsWith("groups/")?e:`users/${e}`}async fetchZoteroLibraryOptions(){let e=[{value:"0",label:"My Library (local)"}],n=await this.fetchZoteroGroupOptions();return n.length&&e.push(...n),e}async fetchEmbeddingModelOptions(){let e=(this.settings.embedModel||"").trim(),n=[],t=(this.settings.embedBaseUrl||"").trim().replace(/\/$/,"");if(!t)return e&&n.push({value:e,label:e}),n;let i=(this.settings.embedApiKey||"").trim(),r=await this.fetchModelIds(t,i);if(r.length){let a=r.filter(o=>/embed/i.test(o)),s=a.length?a:r;n.push(...s.map(o=>({value:o,label:o})))}return!n.length&&e&&n.push({value:e,label:e}),n.sort((a,s)=>a.label.localeCompare(s.label))}async fetchChatModelOptions(){return this.fetchLlmModelOptions(this.settings.chatBaseUrl,this.settings.chatApiKey,"chat")}async fetchCleanupModelOptions(){return this.fetchLlmModelOptions(this.settings.llmCleanupBaseUrl,this.settings.llmCleanupApiKey,"cleanup")}async fetchLlmModelOptions(e,n,t){let i=t==="cleanup"?(this.settings.llmCleanupModel||"").trim():(this.settings.chatModel||"").trim(),r=[],a=(e||"").trim().replace(/\/$/,"");if(!a)return i&&r.push({value:i,label:i}),r;let s=(n||"").trim(),o=await this.fetchModelIds(a,s);if(o.length){let l=o.filter(d=>!/embed/i.test(d)),c=l.length?l:o;r.push(...c.map(d=>({value:d,label:d})))}return!r.length&&i&&r.push({value:i,label:i}),r.sort((l,c)=>l.label.localeCompare(c.label))}detectEmbeddingProvider(e){let n=e.toLowerCase();return n.includes("anthropic")?"anthropic":n.includes("openrouter")?"openrouter":n.includes("ollama")||n.includes(":11434")?"ollama":n.includes("openai")?"openai":"generic"}async fetchModelIds(e,n){let t=this.detectEmbeddingProvider(e);try{if(t==="anthropic")return await this.fetchAnthropicModels(e,n);let i=await this.fetchOpenAiCompatibleModels(e,n);return!i.length&&t==="ollama"?await this.fetchOllamaModels(e):i}catch(i){return console.warn("Failed to fetch models",i),[]}}async fetchOpenAiCompatibleModels(e,n){let t=`${e}/models`,i={};n&&(i.Authorization=`Bearer ${n}`);let r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}async fetchOllamaModels(e){let t=`${e.replace(/\/v1\/?$/,"")}/api/tags`,i=await this.requestLocalApiRaw(t);if(i.statusCode>=400)throw new Error(`Ollama tags request failed (${i.statusCode})`);let r;try{r=JSON.parse(i.body.toString("utf8"))}catch(s){return console.warn("Failed to parse Ollama tags response",s),[]}if(!r||typeof r!="object")return[];let a=r.models;return Array.isArray(a)?a.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}async fetchAnthropicModels(e,n){if(!n)return[];let t=`${e}/models`,i={"x-api-key":n,"anthropic-version":"2023-06-01"},r=await this.requestLocalApiRaw(t,{headers:i});if(r.statusCode>=400)throw new Error(`Anthropic model list request failed (${r.statusCode})`);let a=JSON.parse(r.body.toString("utf8"));return this.extractModelIds(a)}extractModelIds(e){var i,r,a;if(Array.isArray(e))return e.map(s=>this.extractModelId(s)).filter(s=>!!s);if(!e||typeof e!="object")return[];let n=e,t=(a=(r=(i=n.data)!=null?i:n.models)!=null?r:n.model)!=null?a:n.items;return Array.isArray(t)?t.map(s=>this.extractModelId(s)).filter(s=>!!s):[]}extractModelId(e){var r,a,s;if(!e||typeof e!="object")return null;let n=e,t=(s=(a=(r=n.id)!=null?r:n.name)!=null?a:n.model)!=null?s:n.identifier;return typeof t!="string"?null:t.trim()||null}async fetchZoteroGroupOptions(){let e=new Map,n=i=>{for(let r of i)e.has(r.value)||e.set(r.value,r.label)};if(await this.warnIfZoteroLocalApiUnavailable("Zotero groups"))try{let i=this.buildZoteroUrl("/users/0/groups"),r=await this.requestLocalApi(i,`Zotero groups fetch failed for ${i}`);n(this.parseZoteroGroupOptions(r))}catch(i){console.warn("Failed to fetch Zotero groups from local API",i)}if(this.canUseWebApi()&&this.settings.webApiLibraryType==="user"){let i=(this.settings.webApiLibraryId||"").trim();if(i)try{let r=this.buildWebApiUrl(`/users/${i}/groups`),a=await this.requestWebApi(r,`Zotero Web API groups fetch failed for ${r}`);n(this.parseZoteroGroupOptions(a))}catch(r){console.warn("Failed to fetch Zotero groups from Web API",r)}}return Array.from(e.entries()).map(([i,r])=>({value:i,label:r})).sort((i,r)=>i.label.localeCompare(r.label))}parseZoteroGroupOptions(e){var i,r,a,s,o;let n;try{n=JSON.parse(e.toString("utf8"))}catch(l){return console.warn("Failed to parse Zotero group payload",l),[]}if(!Array.isArray(n))return[];let t=[];for(let l of n){if(!l||typeof l!="object")continue;let c=(i=l.data)!=null?i:l,d=(a=(r=c.id)!=null?r:l.id)!=null?a:c.key;if(!d)continue;let _=String(d).trim();if(!_)continue;let u=(o=(s=c.name)!=null?s:l.name)!=null?o:_,m=String(u||_).trim()||_;t.push({value:`groups/${_}`,label:`Group: ${m}`})}return t}async ensureFolder(e){let n=this.app.vault.adapter,t=(0,h.normalizePath)(e).split("/").filter(Boolean),i="";for(let r of t)i=i?`${i}/${r}`:r,await n.exists(i)||await n.mkdir(i)}async buildNoteMarkdown(e,n,t,i,r,a,s,o){let l=`[[${s}]]`,c=this.settings.copyPdfToVault&&i.startsWith("[["),d=r?this.buildZoteroDeepLink(t,r):"",_=d||i,u=c?i:d||i,m=u?c?`PDF: !${u}`:`PDF: ${u}`:"",y=m?`${m}

`:"",b=await this.buildTemplateVars(e,n,t,_,l);b.pdf_block=y,b.pdf_line=m,b.docling_markdown=o;let C=(this.settings.noteBodyTemplate||"").trim();/{{\s*annotation_block\s*}}/i.test(C)&&r?b.annotation_block=await this.buildAnnotationBlockForAttachment(t,r,a):b.annotation_block="";let v=this.ensureDocIdInFrontmatter(await this.renderFrontmatter(e,n,t,_,l,b),t),x=v?`---
${v}
---

`:"",w=`${y}${o}`,R=C?this.renderTemplate(C,b,w,{appendDocling:!0}):w;return`${x}${R}`}async buildAnnotationBlockForAttachment(e,n,t){let i=await this.fetchZoteroAnnotationsForDoc(e,n);return i.attachmentKey&&i.attachmentKey!==n&&await this.updateDocIndex({doc_id:e,attachment_key:i.attachmentKey}),await this.attachAnnotationImages(e,i.attachmentKey,i.annotations,t),this.buildAnnotationBlock(e,i.attachmentKey,i.annotations)}buildAnnotationBlock(e,n,t){var _;let i=`<!-- zrr:annotations-start doc_id=${e} attachment_key=${n} -->`,r="<!-- zrr:annotations-end -->";if(!t.length)return`${i}
${r}`;let a=this.getAnnotationColorMap(),s=Object.keys(a),o=new Map;for(let u of t){let m=u.colorKey||this.normalizeAnnotationColorKey(u.colorKey),y=(_=o.get(m))!=null?_:[];y.push(u),o.set(m,y)}let l=[i],c=new Set,d=[...s,...Array.from(o.keys()).filter(u=>!s.includes(u))];for(let u of d){let m=o.get(u);if(!m||!m.length)continue;c.add(u);let{heading:y}=this.resolveAnnotationColorMeta(u);l.push("",`## ${y}`),m.sort((b,C)=>{var x,w;let f=(x=b.pageIndex)!=null?x:0,v=(w=C.pageIndex)!=null?w:0;return f!==v?f-v:b.sortIndex!==C.sortIndex?b.sortIndex-C.sortIndex:b.key.localeCompare(C.key)});for(let b of m)l.push(...this.formatAnnotationCallout(b,n,e))}return l.push("",r),l.join(`
`).trim()}formatAnnotationCallout(e,n,t){let i=this.settings.annotationPageLabel||"Page",r=e.pageLabel||(e.pageIndex?String(e.pageIndex):"?"),a=e.pageIndex?String(e.pageIndex):"",s=this.buildZoteroDeepLink(t,n,a,e.key),l=[`> [!${e.callout}] ${i} [${r}](${s})`];e.imagePath&&l.push(`> ![[${e.imagePath}]]`);let c=_=>{if(_)for(let u of _.split(/\r?\n/))l.push(u.trim()?`> ${u}`:">")};c(e.text),e.comment&&(l.push(">","> ---"),c(e.comment)),e.tags.length&&l.push(`> **Tags:** ${e.tags.map(_=>`#${_}`).join(" ")}`);let d=e.pageIndex?String(e.pageIndex):"0";return l.push(`> ^${e.key}a${n}p${d}`),l.push(""),l}findAnnotationBlockRange(e){let n=Ct.exec(e);if(!n)return null;let t=e.slice(n.index+n[0].length),i=St.exec(t);if(!i)return null;let r=n.index,a=n.index+n[0].length+i.index+i[0].length,s=t.slice(0,i.index);return{start:r,end:a,block:s,startMarker:n[0]}}parseAnnotationBlockMarker(e){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i),t=e.match(/attachment_key=([\"']?)([^\"'\s]+)\1/i);return{docId:n?n[2].trim():void 0,attachmentKey:t?t[2].trim():void 0}}parseAnnotationBlock(e,n){let t=e.split(/\r?\n/),i=[],r=0;for(;r<t.length;){if(!t[r].trim().startsWith("> [!")){r+=1;continue}let s=[];for(;r<t.length&&t[r].trim().startsWith(">");)s.push(t[r]),r+=1;let o=this.parseAnnotationCallout(s,n);o&&i.push(o)}return i}parseAnnotationImageLine(e){var o,l;let n=e.trim();if(!n)return null;let t="",i=n.match(/!\[\[([^\]]+)\]\]/);i&&(t=i[1].trim());let r=t?null:n.match(/!\[[^\]]*\]\(([^)]+)\)/);r&&(t=r[1].trim());let a=t?null:n.match(/<img[^>]+src=[\"']([^\"']+)[\"']/i);if(a&&(t=a[1].trim()),!t)return null;let s=(l=(o=t.split("|")[0])==null?void 0:o.trim())!=null?l:"";return s?{path:s,hash:this.extractAnnotationImageHashFromPath(s)}:null}parseAnnotationCallout(e,n){if(!e.length)return null;let t=e[0].replace(/^>\s?/,"").trim(),i=t.match(/\[!([^\]]+)\]/),r=i?i[1].trim():"note",a=t.match(/\((zotero:\/\/open-pdf\/library\/items\/[^)]+)\)/i),s="",o=n,l="",c=null;if(a){let v=a[1],x=v.match(/items\/([A-Z0-9]{8})/i);x&&(o=x[1]);let w=v.match(/annotation=([A-Z0-9]{8})/i);w&&(s=w[1]);let R=v.match(/page=(\d+)/i);R&&(c=Number(R[1]));let A=t.match(/\[([^\]]+)\]\(zotero:\/\//i);A&&(l=A[1].trim())}let d=[],_=[],u=[],m=!1,y="",b="";for(let v=1;v<e.length;v+=1){let x=e[v].replace(/^>\s?/,""),w=x.trim();if(!w){m?u.push(""):_.push("");continue}let R=this.parseAnnotationImageLine(w);if(R){y=R.path,b=R.hash;continue}if(w.startsWith("^")){let A=w.match(/^\^([A-Z0-9]{8})a([A-Z0-9]{8})p(\d+)/i);A&&(s=A[1],o=A[2],c=Number(A[3]));continue}if(/^(\*\*tags:\*\*|tags:)/i.test(w)){d.push(w);continue}if(w==="---"){m=!0;continue}m?u.push(x):_.push(x)}let C=d.join(" "),f=C?C.replace(/\*\*tags:\*\*/i,"").replace(/tags:/i,"").split(/[\s,]+/).map(v=>v.trim().replace(/^#+/,"")).filter(Boolean):[];return s?{key:s,attachmentKey:o,pageLabel:l,pageIndex:c,callout:r,text:this.normalizeAnnotationText(_.join(`
`)),comment:this.normalizeAnnotationText(u.join(`
`)),tags:this.normalizeAnnotationTags(f),imagePath:y||void 0,imageHash:b||void 0}:null}replaceAnnotationBlock(e,n){let t=this.findAnnotationBlockRange(e);if(!t)return null;let i=e.slice(0,t.start),r=e.slice(t.end),a=n.trim()?`${n.trim()}
`:`${n}`;return`${i}${a}${r}`.replace(/\n{4,}/g,`


`)}async renderFrontmatter(e,n,t,i,r,a){var d;let s=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,n,t,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let n=e.split(/\r?\n/),t=[],i=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<n.length;){let l=n[o],c=l.match(i);if(!c){t.push(l),o+=1;continue}let d=c[1].trim(),_=c[2].trim();if(a.has(d)){t.push(l),o+=1;continue}if(!s(_)){t.push(l),o+=1;continue}let u=o+1,m=[];for(;u<n.length&&n[u].match(r);)m.push(n[u]),u+=1;if(m.length===0){for(o=u;o<n.length&&n[o].trim()==="";)o+=1;continue}let y=m.filter(b=>{let C=b.match(r);if(!C)return!1;let f=C[1].trim();return!s(f)});if(y.length>0&&t.push(l,...y),o=u,y.length===0)for(;o<n.length&&n[o].trim()==="";)o+=1}for(;t.length>0&&t[t.length-1].trim()==="";)t.pop();return t.join(`
`).trim()}renderTemplate(e,n,t,i={}){let r=e.replace(/{{\s*([a-z0-9_]+)\s*}}/gi,(a,s)=>{var o;return(o=n[s])!=null?o:""});return i.appendDocling&&!e.includes("{{docling_markdown}}")&&n.docling_markdown&&(r=`${r}

${n.docling_markdown}`),r.trim()?r:t}async buildTemplateVars(e,n,t,i,r){let a=V(e.title),s=V(e.shortTitle),o=V(e.date),l=typeof(n==null?void 0:n.parsedDate)=="string"?n.parsedDate:"",c=cn(l||o),d=/^\d{4}$/.test(c)?c:"",_=Array.isArray(e.creators)?e.creators:[],u=_.filter(P=>P.creatorType==="author").map(P=>he(P)),m=u.join("; "),y=_.filter(P=>P.creatorType==="editor"||P.creatorType==="seriesEditor").map(P=>he(P)),b=y.join("; "),C=Array.isArray(e.tags)?e.tags.map(P=>typeof P=="string"?P:P==null?void 0:P.tag).filter(Boolean):[],f=this.sanitizeObsidianTags(C),v=f.join("; "),x=await this.resolveCollectionTitles(e),w=x.join("; "),R=this.toObsidianLinks(x),A=R.join("; "),S=V(e.itemType),L=typeof(n==null?void 0:n.creatorSummary)=="string"?n.creatorSummary:"",z=V(e.publicationTitle),O=V(e.bookTitle),j=V(e.journalAbbreviation),F=V(e.volume),M=V(e.issue),$=V(e.pages),I=V(e.dateAdded),N=V(e.dateModified),q=typeof e.key=="string"?e.key:t,U=V(e.DOI);U||(U=Fn(e));let J=qe(e,n),Z=null;(!U||!s||!J)&&(Z=await this.fetchZoteroItemCsl(q)),U||(U=zn(Z)),s||(s=In(Z)),J||(J=dn(Z));let Q=V(e.ISBN),X=V(e.ISSN),ie=V(e.publisher),se=V(e.place),ge=V(e.url),nn=V(e.language),tn=V(e.abstractNote),Ee=this.buildZoteroDeepLink(q),re=Array.from(new Set([J,s,U].map(P=>String(P||"").trim()).filter(P=>P.length>0))),rn=re.join("; "),k={doc_id:t,zotero_key:typeof e.key=="string"?e.key:t,item_link:Ee,citekey:J,title:a,short_title:s,date:o,year:c,year_number:d,authors:m,editors:b,aliases:rn,tags:v,collection_title:w,collection_titles:w,collections_links:A,item_type:S,creator_summary:L,publication_title:z,book_title:O,journal_abbrev:j,volume:F,issue:M,pages:$,date_added:I,date_modified:N,doi:U,isbn:Q,issn:X,publisher:ie,place:se,url:ge,language:nn,abstract:tn,pdf_link:i,item_json:r};for(let[P,D]of Object.entries(k)){let W=this.escapeYamlString(D);k[`${P}_yaml`]=W,k[`${P}_quoted`]=W,k[`${P}_text`]=W}return k.authors_yaml_list=this.toYamlList(u),k.editors_yaml_list=this.toYamlList(y),k.tags_yaml_list=f.length>0?this.toYamlList(f):"",k.aliases_yaml_list=re.length>0?this.toYamlList(re):"",k.collections_yaml_list=this.toYamlList(x),k.collections_links_yaml_list=this.toYamlList(R),k.tags_raw=C.join("; "),k.tags_raw_yaml=this.escapeYamlString(k.tags_raw),k.tags_raw_yaml_list=C.length>0?this.toYamlList(C):"",k.authors_list=k.authors_yaml_list,k.editors_list=k.editors_yaml_list,k.tags_list=k.tags_yaml_list,k.aliases_list=k.aliases_yaml_list,k.collections_list=k.collections_yaml_list,k.collections_links_list=k.collections_links_yaml_list,k}escapeYamlString(e){return`"${String(e).replace(/\r\n/g,`
`).replace(/\r/g,`
`).replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n")}"`}toYamlList(e){return e.length?e.map(n=>`  - ${this.escapeYamlString(n)}`).join(`
`):'  - ""'}sanitizeObsidianTags(e){let n=this.settings.tagSanitizeMode||"kebab",t=n==="replace"?"kebab":n;return e.map(i=>this.sanitizeObsidianTag(i,t)).filter(i=>i.length>0)}sanitizeObsidianTag(e,n){let t=String(e||"").trim();if(!t)return"";let i=t.replace(/^#+/,"");if(n==="none")return i;let r=o=>!/^\d+$/.test(o),s=(o=>i.split("/").map(d=>{let u=d.replace(/[^\p{L}\p{N}]+/gu," ").split(/\s+/).filter(Boolean);if(!u.length)return"";if(o==="camel"||o==="pascal"){let[y,...b]=u;return[o==="pascal"?y.charAt(0).toUpperCase()+y.slice(1):y.charAt(0).toLowerCase()+y.slice(1),...b.map(f=>f.charAt(0).toUpperCase()+f.slice(1))].join("")}let m=o==="snake"?"_":"-";return u.join(m)}).filter(Boolean).join("/").replace(/\/{2,}/g,"/").replace(/^\/+|\/+$/g,""))(n);return s&&r(s)?s:""}normalizeZoteroTags(e){let n=new Map;for(let t of e){let i=this.normalizeZoteroTag(t);if(!i)continue;let r=i.toLowerCase();n.has(r)||n.set(r,i)}return Array.from(n.values())}normalizeZoteroTag(e){let n=String(e||"").trim();if(!n)return"";let t=n.replace(/^#+/,"").trim();if(!t)return"";let i=t.split("/").map(r=>{let a=r.trim();return a?(a=a.replace(/[_-]+/g," "),a=a.replace(/([A-Z]+)([A-Z][a-z])/g,"$1 $2"),a=a.replace(/([a-z\\d])([A-Z])/g,"$1 $2"),a=a.replace(/([a-zA-Z])(\\d)/g,"$1 $2"),a=a.replace(/(\\d)([a-zA-Z])/g,"$1 $2"),a=a.replace(/\s+/g," ").trim(),a):""}).filter(Boolean);return i.length?i.join("/"):""}toObsidianLinks(e){return e.map(n=>String(n||"").trim()).filter(n=>n.length>0).map(n=>n.startsWith("[[")&&n.endsWith("]]")?n:`[[${n}]]`)}getVaultBasePath(){var t;let e=this.app.vault.adapter;if(e instanceof h.FileSystemAdapter)return e.getBasePath();let n=(t=e.getBasePath)==null?void 0:t.call(e);if(n)return n;throw new Error("Vault base path is unavailable.")}expandPathValue(e){let n=(e||"").trim();if(!n)return n;let t=n;return t==="~"?t=Ce.default.homedir():(t.startsWith("~/")||t.startsWith("~\\"))&&(t=E.default.join(Ce.default.homedir(),t.slice(2))),t=t.replace(/\$([A-Za-z_][A-Za-z0-9_]*)|\$\{([^}]+)\}/g,(i,r,a)=>{let s=r||a,o=s?process.env[s]:void 0;return o!==void 0?o:i}),t=t.replace(/%([^%]+)%/g,(i,r)=>{let a=process.env[r];return a!==void 0?a:i}),t}resolvePythonPath(){return this.resolveUserPath(this.settings.pythonPath||"")}getPythonRuntimeMode(){return this.settings.pythonRuntime==="local"?"local":"worker"}usePythonWorker(){return this.getPythonRuntimeMode()==="worker"}getPythonWorkerCacheDir(){return E.default.join(this.getVaultBasePath(),Y,"python-worker-cache")}getComposeServiceNamesForCurrentRuntime(){return this.usePythonWorker()?[Kn,Pe]:[Kn]}toContainerPath(e,n,t){let i=E.default.relative(e,n);if(i.startsWith("..")||E.default.isAbsolute(i))return null;let r=i.split(E.default.sep).filter(Boolean);return r.length?E.default.posix.join(t,...r):t}mapPathForPythonWorker(e){var r,a;if(!E.default.isAbsolute(e))return e;let n=E.default.normalize(e),t=E.default.normalize(this.getPluginDir()),i=E.default.normalize(this.getVaultBasePath());return(a=(r=this.toContainerPath(t,n,Pt))!=null?r:this.toContainerPath(i,n,At))!=null?a:e}getWorkerHostAlias(){return(this.settings.dockerPath||"").toLowerCase().includes("podman")?"host.containers.internal":"host.docker.internal"}mapUrlForPythonWorker(e){let n=(e||"").trim();if(!n)return e;let t;try{t=new URL(n)}catch(i){return e}return!["http:","https:","redis:","rediss:"].includes(t.protocol)||!this.isLocalRedisHost(t.hostname||"")?e:(t.hostname=this.getWorkerHostAlias(),t.toString())}mapPythonArgsForWorker(e){return e.map(n=>{let t=this.mapUrlForPythonWorker(n);if(t!==n)return t;if(!E.default.isAbsolute(n))return n;let i=this.mapPathForPythonWorker(n);if(i===n)throw new Error(`Python worker cannot access path '${n}'. Keep files under your vault or plugin directory.`);return i})}resolveUserPath(e,n){let t=this.expandPathValue(e);return!t||!(t.includes("/")||t.includes("\\"))||E.default.isAbsolute(t)?t:n&&(t.startsWith("./")||t.startsWith(".\\"))?E.default.join(n,t.slice(2)):E.default.join(Ce.default.homedir(),t)}getPluginDir(){var i;let e=this.getVaultBasePath(),n=(i=this.manifest.dir)!=null?i:this.manifest.id;if(!n)throw new Error("Plugin directory is unavailable.");let t=E.default.isAbsolute(n)?n:E.default.join(e,n);return E.default.normalize(t)}async ensureBundledTools(){let e=this.getPluginDir(),n=E.default.join(e,"tools");await G.promises.mkdir(n,{recursive:!0});for(let[t,i]of Object.entries(Zn)){let r=E.default.join(n,t),a=!0;try{await G.promises.readFile(r,"utf8")===i&&(a=!1)}catch(s){}a&&await G.promises.writeFile(r,i,"utf8")}}async migrateCachePaths(){let e="zotero/items",n="zotero/chunks",t=te,i=H,r=this.app.vault.adapter,a=(0,h.normalizePath)(e),s=(0,h.normalizePath)(n),o=(0,h.normalizePath)(t),l=(0,h.normalizePath)(i),c=o.split("/").slice(0,-1).join("/"),d=l.split("/").slice(0,-1).join("/");c&&await this.ensureFolder(c),d&&await this.ensureFolder(d);let _=await r.exists(a),u=await r.exists(s),m=await r.exists(o),y=await r.exists(l);_&&!m&&await r.rename(a,o),u&&!y&&await r.rename(s,l)}getAbsoluteVaultPath(e){let n=this.getVaultBasePath(),t=E.default.isAbsolute(e)?e:E.default.join(n,e);return E.default.normalize(t)}async resolveAttachmentOutputDir(e){let n=e?E.default.isAbsolute(e)?this.toVaultRelativePath(e):(0,h.normalizePath)(e):"";if(!n)return null;let t=this.app.fileManager;if(!(t!=null&&t.getAvailablePathForAttachment))return null;try{let i=`zrr-image-${Date.now()}.png`,r=await t.getAvailablePathForAttachment(i,n);if(!r)return null;let a=E.default.isAbsolute(r)?r:this.getAbsoluteVaultPath(r),s=E.default.normalize(E.default.dirname(a)),o=E.default.normalize(this.getVaultBasePath()),l=this.toVaultRelativePath(s);return!l&&s!==o?null:{absolute:s,relative:l}}catch(i){return console.warn("Failed to resolve attachment output dir",i),null}}async resolveAnnotationImageOutputDir(e){let n=null;if(e&&(n=await this.resolveAttachmentOutputDir(e)),!n){let r=(0,h.normalizePath)(this.settings.outputNoteDir||"");if(!r)return null;n={absolute:this.getAbsoluteVaultPath(r),relative:r}}let t=(0,h.normalizePath)(E.default.join(n.relative||"","zrr-annotations")),i=E.default.normalize(E.default.join(n.absolute,"zrr-annotations"));return t&&await this.ensureFolder(t),{absolute:i,relative:t}}async buildDoclingArgs(e,n,t,i,r,a=!1){let s=this.settings.ocrMode==="force_low_quality"?"auto":this.settings.ocrMode,o=["--pdf",e,"--doc-id",n,"--out-json",this.getAbsoluteVaultPath(t),"--out-md",this.getAbsoluteVaultPath(i),"--chunking",this.settings.chunkingMode,"--ocr",s];a&&o.push("--progress"),this.settings.ocrMode==="force_low_quality"&&o.push("--force-ocr-low-quality"),this.settings.forcePerPageOcr&&o.push("--force-per-page-ocr"),o.push("--quality-threshold",String(this.settings.ocrQualityThreshold)),r&&o.push("--language-hint",r),this.settings.enableLlmCleanup&&(o.push("--enable-llm-cleanup"),this.settings.llmCleanupBaseUrl&&o.push("--llm-cleanup-base-url",this.settings.llmCleanupBaseUrl),this.settings.llmCleanupApiKey&&o.push("--llm-cleanup-api-key",this.settings.llmCleanupApiKey),this.settings.llmCleanupModel&&o.push("--llm-cleanup-model",this.settings.llmCleanupModel),o.push("--llm-cleanup-temperature",String(this.settings.llmCleanupTemperature)),o.push("--llm-cleanup-min-quality",String(this.settings.llmCleanupMinQuality)),o.push("--llm-cleanup-max-chars",String(this.settings.llmCleanupMaxChars)));let l=this.getPluginDir(),c=E.default.join(l,"tools","ocr_wordlist.txt");if((0,G.existsSync)(c)&&o.push("--enable-dictionary-correction","--dictionary-path",c),this.settings.enableFileLogging){let _=this.getLogFileAbsolutePath();_&&o.push("--log-file",_);let u=this.getAbsoluteVaultPath(this.getSpellcheckerInfoRelativePath());u&&o.push("--spellchecker-info-out",u)}let d=await this.resolveAttachmentOutputDir(i);return d&&(d.relative&&await this.ensureFolder(d.relative),o.push("--image-output-dir",d.absolute)),this.appendOcrEngineArgs(o),o}appendOcrEngineArgs(e){let n=this.settings.ocrEngine,t=(this.settings.paddleApiKey||"").trim(),i=(this.settings.paddleVlApiUrl||"").trim(),r=(this.settings.paddleStructureApiUrl||"").trim(),a=o=>{e.push("--prefer-ocr-engine",o,"--fallback-ocr-engine",o)},s=()=>{e.push("--no-paddle-vl-api","--no-paddle-structure-api")};switch(n){case"tesseract":a("tesseract"),e.push("--no-paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_local":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl"),s();break;case"paddle_vl_local":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3"),s();break;case"paddle_structure_api":a("paddle"),e.push("--paddle-structure-v3","--no-paddle-vl","--no-paddle-vl-api"),t?(e.push("--paddle-structure-api","--paddle-structure-api-token",t),r&&e.push("--paddle-structure-api-url",r)):e.push("--no-paddle-structure-api");break;case"paddle_vl_api":a("paddle"),e.push("--paddle-vl","--no-paddle-structure-v3","--no-paddle-structure-api"),t?(e.push("--paddle-vl-api","--paddle-vl-api-token",t),i&&e.push("--paddle-vl-api-url",i)):e.push("--no-paddle-vl-api");break;default:s();break}}appendEmbedSubchunkArgs(e){let n=this.settings.embedSubchunkChars;Number.isFinite(n)&&e.push("--embed-subchunk-chars",String(Math.max(0,Math.trunc(n))));let t=this.settings.embedSubchunkOverlap;Number.isFinite(t)&&e.push("--embed-subchunk-overlap",String(Math.max(0,Math.trunc(t))))}appendEmbedContextArgs(e){let n=this.settings.embedContextWindow;Number.isFinite(n)&&e.push("--embed-context-window",String(Math.max(0,Math.trunc(n))));let t=this.settings.embedContextChars;Number.isFinite(t)&&e.push("--embed-context-chars",String(Math.max(0,Math.trunc(t))))}appendChunkTaggingArgs(e,n){if((n==null?void 0:n.allowRegenerate)===!1||!this.settings.enableChunkTagging)return;let t=(this.settings.llmCleanupBaseUrl||"").trim(),i=(this.settings.llmCleanupModel||"").trim();if(!t||!i)return;e.push("--generate-chunk-tags","--tag-base-url",t,"--tag-model",i);let r=(this.settings.llmCleanupApiKey||"").trim();r&&e.push("--tag-api-key",r),e.push("--tag-temperature",String(this.settings.llmCleanupTemperature))}getRedisDataDir(){let e=this.resolveUserPath(process.env.ZRR_DATA_DIR||"");if(e)return e;let n=this.resolveUserPath(this.settings.redisDataDirOverride||"",this.getVaultBasePath());return!this.settings.autoAssignRedisPort&&n?n:E.default.join(this.getVaultBasePath(),Y,"redis-data")}getDockerComposePath(){let e=this.getPluginDir();return E.default.join(e,"tools","docker-compose.yml")}prependBinaryDirToPath(e,n){if(!n||!E.default.isAbsolute(n))return;let t=E.default.dirname(n),i=e.PATH||"";(i?i.split(E.default.delimiter):[]).includes(t)||(e.PATH=i?`${t}${E.default.delimiter}${i}`:t)}async resolveDockerPath(){var c;let e=(c=this.settings.dockerPath)==null?void 0:c.trim(),n=e?this.resolveUserPath(e):"",t=["/opt/homebrew/bin/docker","/usr/local/bin/docker","/usr/bin/docker","/Applications/Docker.app/Contents/Resources/bin/docker"],i=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"],r=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"],a=[];n&&a.push(n);let s=n?this.getContainerCliKind(n):"docker",o=s==="podman-compose"?[r,i,t]:s==="podman"?[i,r,t]:[t,i,r];if(!n||n==="docker"||n==="podman"||n==="podman-compose")for(let d of o)a.push(...d);for(let d of a)if(E.default.isAbsolute(d))try{if(await this.isContainerCliAvailable(d))return d}catch(_){}let l=[n,s==="podman"?"podman":"docker",s==="podman"?"docker":"podman","podman-compose"].filter(d=>!!(d&&d.trim()));for(let d of l)if(await this.isContainerCliAvailable(d))return d;return n||"docker"}async isContainerCliAvailable(e){return new Promise(n=>{let t=(0,ne.spawn)(e,["--version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}getContainerCliKind(e){let n=E.default.basename(e);return n==="podman-compose"?"podman-compose":n.includes("podman")?"podman":"docker"}async isContainerDaemonRunning(e){let n=this.getContainerCliKind(e),t=e,i=["info"];if(n==="podman-compose"){let r=await this.resolvePodmanBin();if(!r)return!1;t=r}return new Promise(r=>{let a=(0,ne.spawn)(t,i),s=!1,o=c=>{s||(s=!0,r(c))},l=setTimeout(()=>{a.kill(),o(!1)},2e3);a.on("error",()=>{clearTimeout(l),o(!1)}),a.on("close",c=>{clearTimeout(l),o(c===0)})})}getContainerDaemonHint(e){let n=this.getContainerCliKind(e);return n==="podman"||n==="podman-compose"?"Podman machine not running. Run `podman machine start`.":"Docker Desktop is not running. Start Docker Desktop."}async supportsComposeSubcommand(e){return new Promise(n=>{let t=(0,ne.spawn)(e,["compose","version"]);t.on("error",()=>n(!1)),t.on("close",i=>n(i===0))})}async findPodmanComposePath(){let e=["/opt/homebrew/bin/podman-compose","/usr/local/bin/podman-compose","/usr/bin/podman-compose"];for(let n of e)try{return await G.promises.access(n),n}catch(t){}return await this.isContainerCliAvailable("podman-compose")?"podman-compose":null}async resolvePodmanBin(){let e=["/opt/homebrew/bin/podman","/usr/local/bin/podman","/usr/bin/podman"];for(let n of e)if(await this.isContainerCliAvailable(n))return n;return await this.isContainerCliAvailable("podman")?"podman":null}async resolveComposeCommand(e){let n=E.default.basename(e);if(n==="podman-compose")return{command:e,argsPrefix:[]};if(n==="podman"){let t=await this.findPodmanComposePath();return t?{command:t,argsPrefix:[]}:await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}return await this.supportsComposeSubcommand(e)?{command:e,argsPrefix:["compose"]}:null}async buildComposeEnvironment(e,n,t){var s;let i={...process.env};if(this.prependBinaryDirToPath(i,e),this.prependBinaryDirToPath(i,n.command),E.default.basename(n.command)==="podman-compose"){let o=await this.resolvePodmanBin();o&&(i.PODMAN_BIN=o,this.prependBinaryDirToPath(i,o))}let r=(t==null?void 0:t.dataDir)||this.getRedisDataDir(),a=(s=t==null?void 0:t.redisPort)!=null?s:this.getRedisPortFromUrl();return i.ZRR_DATA_DIR=r,i.ZRR_PORT=String(a),i.ZRR_VAULT_DIR=this.getVaultBasePath(),i.ZRR_PLUGIN_DIR=this.getPluginDir(),i.ZRR_WORKER_CACHE_DIR=this.getPythonWorkerCacheDir(),i}async resolveComposeProjectContext(e){await this.ensureBundledTools();let n=this.getDockerComposePath(),t=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(t))throw new Error('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');if(!await this.isContainerDaemonRunning(t))throw new Error(this.getContainerDaemonHint(t));let i=await this.resolveComposeCommand(t);if(!i)throw new Error("Compose support not found. Install Docker Desktop or Podman with podman-compose.");let r=await this.buildComposeEnvironment(t,i,e);return{composePath:n,composeCommand:i,composeEnv:r,project:this.getDockerProjectName()}}buildComposeExecArgs(e,n,t){return[...e.composeCommand.argsPrefix,"-p",e.project,"-f",e.composePath,"exec","-T",n,...t]}async autoDetectContainerCliOnLoad(){var o;let e=await this.resolveDockerPath();if(!await this.isContainerCliAvailable(e)){this.notifyContainerOnce("Docker or Podman not found. Install Docker Desktop or Podman and set Docker/Podman path in settings.");return}let n=((o=this.settings.dockerPath)==null?void 0:o.trim())||"docker",t=this.expandPathValue(n);!await this.isContainerCliAvailable(t)&&!(n==="docker"||n==="podman"||n==="podman-compose")&&e&&e!==n&&(this.settings.dockerPath=e,await this.saveSettings());let s=l=>new Promise(c=>setTimeout(c,l));if(!await this.isContainerDaemonRunning(e)){for(let l of[5e3,1e4])if(await s(l),await this.isContainerDaemonRunning(e))return;this.notifyContainerOnce(this.getContainerDaemonHint(e))}}getDockerProjectName(){let e=s=>s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,32),n=(process.env.ZRR_PROJECT_NAME||"").trim();if(n&&!this.settings.autoAssignRedisPort)return e(n)||"zrr";let t=(this.settings.redisProjectName||"").trim();if(t&&!this.settings.autoAssignRedisPort)return e(t)||"zrr";let i=this.getVaultBasePath(),r=E.default.basename(i).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,18),a=(0,Se.createHash)("sha1").update(i).digest("hex").slice(0,8);return`zrr-${r||"vault"}-${a}`}getRedisPortFromUrl(){try{let e=new URL(this.settings.redisUrl),n=e.port?Number(e.port):6379;return Number.isFinite(n)&&n>0?n:6379}catch(e){return 6379}}getVaultPreferredRedisPort(){let e=(0,Se.createHash)("sha1").update(this.getVaultBasePath()).digest("hex");return 6400+Number.parseInt(e.slice(0,4),16)%2e3}getRedisHostFromUrl(){try{return new URL(this.settings.redisUrl).hostname||"127.0.0.1"}catch(e){return"127.0.0.1"}}isLocalRedisHost(e){let n=e.trim().toLowerCase();return n?n==="localhost"||n==="0.0.0.0"||n==="::1"?!0:n.startsWith("127."):!1}getPortCheckHost(e){return this.isLocalRedisHost(e)?"127.0.0.1":e}async isPortFree(e,n){return new Promise(t=>{let i=Ae.default.createServer();i.once("error",()=>t(!1)),i.once("listening",()=>{i.close(()=>t(!0))}),i.listen(n,e)})}async findAvailablePort(e,n){for(let i=0;i<25;i+=1){let r=n+i;if(await this.isPortFree(e,r))return r}return null}updateRedisUrlPort(e,n){try{let t=new URL(e);return t.port=String(n),t.toString()}catch(t){return`redis://127.0.0.1:${n}`}}async isRedisReachable(e){let n="127.0.0.1",t=6379;try{let i=new URL(e);n=i.hostname||n,t=i.port?Number(i.port):t}catch(i){return!1}return n=this.getPortCheckHost(n),new Promise(i=>{let r=new Ae.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(t,n)})}async isZoteroLocalApiReachable(){let e=(this.settings.zoteroBaseUrl||"").trim();if(!e)return!1;let n="127.0.0.1",t=23119;try{let i=new URL(e);if(n=i.hostname||n,i.port){let r=Number(i.port);Number.isFinite(r)&&r>0&&(t=r)}else i.protocol==="https:"?t=443:t=80}catch(i){return!1}return new Promise(i=>{let r=new Ae.default.Socket,a=!1,s=o=>{a||(a=!0,r.destroy(),i(o))};r.setTimeout(500),r.once("connect",()=>s(!0)),r.once("timeout",()=>s(!1)),r.once("error",()=>s(!1)),r.connect(t,n)})}getRedisNamespace(){let e=this.getVaultBasePath(),n=E.default.basename(e).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24),t=(0,Se.createHash)("sha1").update(e).digest("hex").slice(0,8);return`${n||"vault"}-${t}`}getRedisIndexName(){return`${(this.settings.redisIndex||"idx:zotero").trim()||"idx:zotero"}:${this.getRedisNamespace()}`}getRedisKeyPrefix(){let e=(this.settings.redisPrefix||"zotero:chunk:").trim()||"zotero:chunk:";return`${e.endsWith(":")?e:`${e}:`}${this.getRedisNamespace()}:`}async isComposeProjectRunning(e,n,t,i,r,a=[]){let s=a.length?a:[""];for(let o of s)if(!await new Promise(c=>{let d=o?[o]:[],_=(0,ne.spawn)(e,[...n,"-p",i,"-f",t,"ps","-q",...d],{cwd:E.default.dirname(t),env:r}),u="";_.stdout.on("data",m=>{u+=m.toString()}),_.on("error",m=>{console.warn("Redis Stack status check failed",m),c(!1)}),_.on("close",m=>{if(m!==0){c(!1);return}c(u.trim().length>0)})}))return!1;return!0}async startRedisStack(e){var n;try{await this.ensureBundledTools();let t=this.getDockerComposePath(),i=this.getRedisDataDir(),r=this.getPythonWorkerCacheDir();await G.promises.mkdir(i,{recursive:!0}),await G.promises.mkdir(r,{recursive:!0});let a=await this.resolveDockerPath(),s=((n=this.settings.dockerPath)==null?void 0:n.trim())||"docker",o=this.resolveUserPath(s),l=s==="docker"||s==="podman"||s==="podman-compose";if(!await this.isContainerCliAvailable(o)&&!l&&a&&a!==s&&(this.settings.dockerPath=a,await this.saveSettings(),e||new h.Notice(`Docker/Podman path set to ${a}.`)),!await this.isContainerCliAvailable(a)){e||new h.Notice('Docker or Podman not found. Install Docker Desktop or Podman and set "Docker/Podman path" in settings.');return}if(!await this.isContainerDaemonRunning(a)){e||new h.Notice(this.getContainerDaemonHint(a));return}let _=await this.resolveComposeCommand(a);if(!_){e||new h.Notice("Compose support not found. Install Docker Desktop or Podman with podman-compose.");return}let u=this.getRedisPortFromUrl(),m=await this.buildComposeEnvironment(a,_,{dataDir:i,redisPort:u}),y=this.getDockerProjectName(),b={composePath:t,composeCommand:_,composeEnv:m,project:y},C=this.getComposeServiceNamesForCurrentRuntime();if(await this.isComposeProjectRunning(_.command,_.argsPrefix,t,y,m,C)){e||new h.Notice(this.usePythonWorker()?"Redis Stack and Python worker already running for this vault.":"Redis Stack already running for this vault.");return}let f=this.getRedisHostFromUrl(),v=this.getPortCheckHost(f),x=this.settings.autoAssignRedisPort&&this.isLocalRedisHost(f),w=this.settings.redisUrl,R=u,A=()=>{if(!e){if(!this.settings.autoAssignRedisPort){new h.Notice("Redis already running. If you share Redis across vaults, disable Auto-start Redis in this vault.");return}new h.Notice(`Redis already running at ${w}.`)}};if(x){let L=u===6379?this.getVaultPreferredRedisPort():u,z=await this.findAvailablePort(v,L);if(!z)throw new Error(`No available Redis port found starting at ${L}.`);z!==u&&(R=z,w=this.updateRedisUrlPort(w,R),this.settings.redisUrl=w,await this.saveSettings(),e||new h.Notice(`Using Redis port ${R} for this vault.`))}else{if(this.isLocalRedisHost(f)&&!await this.isPortFree(v,R)){await this.isRedisReachable(w)?(A(),this.usePythonWorker()&&await this.startPythonWorkerService(b)):e||new h.Notice(`Port ${R} is already in use and Redis is not reachable at ${w}. Update the Redis URL or enable auto-assign.`);return}if(await this.isRedisReachable(w)){A(),this.usePythonWorker()&&await this.startPythonWorkerService(b);return}}m.ZRR_PORT=String(R);try{await this.runCommand(_.command,[..._.argsPrefix,"-p",y,"-f",t,"down"],{cwd:E.default.dirname(t),env:m})}catch(L){console.warn("Redis Stack stop before restart failed",L)}let S=[..._.argsPrefix,"-p",y,"-f",t,"up","-d"];this.usePythonWorker()&&S.push("--build"),await this.runCommand(_.command,S,{cwd:E.default.dirname(t),env:m}),e||new h.Notice("Redis Stack started.")}catch(t){e||new h.Notice("Failed to start Redis Stack. Check Docker/Podman and file sharing."),console.error("Failed to start Redis Stack",t)}}async waitForPythonWorkerReady(e,n=900*1e3){let t=Date.now(),i=a=>new Promise(s=>setTimeout(s,a)),r=this.buildComposeExecArgs(e,Pe,[Jn,"--version"]);for(;Date.now()-t<n;)try{await this.runCommand(e.composeCommand.command,r,{cwd:E.default.dirname(e.composePath),env:e.composeEnv});return}catch(a){await i(2e3)}throw new Error("Python worker is still starting. Check compose logs for the python-worker service.")}async startPythonWorkerService(e){let n=e!=null?e:await this.resolveComposeProjectContext({dataDir:this.getRedisDataDir(),redisPort:this.getRedisPortFromUrl()}),t=[...n.composeCommand.argsPrefix,"-p",n.project,"-f",n.composePath,"up","-d","--build",Pe];await this.runCommand(n.composeCommand.command,t,{cwd:E.default.dirname(n.composePath),env:n.composeEnv})}async ensurePythonWorkerContext(e){let n=this.getRedisDataDir();await G.promises.mkdir(n,{recursive:!0}),await G.promises.mkdir(this.getPythonWorkerCacheDir(),{recursive:!0});let t=await this.resolveComposeProjectContext({dataDir:n,redisPort:this.getRedisPortFromUrl()}),i=[Pe];if(!await this.isComposeProjectRunning(t.composeCommand.command,t.composeCommand.argsPrefix,t.composePath,t.project,t.composeEnv,i)&&e&&(await this.startPythonWorkerService(t),t=await this.resolveComposeProjectContext({dataDir:n,redisPort:this.getRedisPortFromUrl()})),!await this.isComposeProjectRunning(t.composeCommand.command,t.composeCommand.argsPrefix,t.composePath,t.project,t.composeEnv,i))throw new Error("Python worker is not running. Start Redis stack now or enable Auto-start Redis stack.");return await this.waitForPythonWorkerReady(t),t}async setupPythonEnv(){if(this.usePythonWorker()){try{new h.Notice("Setting up Python worker environment..."),this.showStatusProgress("Setting up Python worker environment...",null),await this.ensurePythonWorkerContext(!0),this.clearStatusProgress(),new h.Notice("Python worker environment ready.")}catch(r){this.clearStatusProgress(),new h.Notice("Failed to set up Python worker environment. See console for details."),console.error("Python worker setup failed",r)}return}let e=this.getPluginDir(),n=this.getPythonVenvDir(),t=this.getVenvPythonPath(n);await this.ensureBundledTools();let i=this.resolveRequirementsPath(e);if(!i)throw new Error(`requirements.txt not found in ${e}`);try{new h.Notice("Setting up Python environment..."),this.showStatusProgress("Setting up Python environment...",null),console.log(`Python env: using plugin dir ${e}`),console.log(`Python env: venv path ${n}`),await G.promises.mkdir(E.default.dirname(n),{recursive:!0});let r=null,a=async()=>(r||(r=await this.resolveBootstrapPython()),r);if((0,G.existsSync)(t)){let s=await this.getPythonVersion(t,[]);if(s&&this.isUnsupportedPythonVersion(s)){let o=await a();console.log(`Python env: existing venv uses Python ${s.major}.${s.minor}; rebuilding with ${o.command} ${o.args.join(" ")}`),this.showStatusProgress("Rebuilding Python environment...",null),await G.promises.rm(n,{recursive:!0,force:!0})}}if(!(0,G.existsSync)(t)){let s=await a();console.log(`Python env: creating venv with ${s.command} ${s.args.join(" ")}`),await this.runCommand(s.command,[...s.args,"-m","venv",n],{cwd:e})}await this.runCommandStreaming(t,["-m","pip","install","-r",i],{cwd:e},s=>{let o=s.trim();if(!o)return;let l=o.match(/^Collecting\s+([^\s]+)/);if(l){this.showStatusProgress(`Installing ${l[1]}...`,null);return}if(o.startsWith("Installing collected packages")){this.showStatusProgress("Installing packages...",null);return}o.startsWith("Successfully installed")&&this.showStatusProgress("Python environment ready.",100)}),this.settings.pythonPath=t,await this.saveSettings(),this.clearStatusProgress(),new h.Notice("Python environment ready.")}catch(r){this.clearStatusProgress(),new h.Notice("Failed to set up Python environment. See console for details."),console.error("Python env setup failed",r)}}async detectOcrEngines(){if(this.usePythonWorker())return{tesseract:!0,paddleStructureLocal:!0,paddleVlLocal:!0};let e=await this.canRunCommand("tesseract",[]),n=this.resolvePythonPath(),t=[];if(!n)try{let l=await this.resolveBootstrapPython();n=l.command,t=l.args}catch(l){return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1}}let i=["import importlib.util, json","def has_module(name):","    return importlib.util.find_spec(name) is not None","has_paddle = has_module('paddle')","has_paddleocr = has_module('paddleocr')","has_paddlex = has_module('paddlex')","has_vl = False","if has_paddleocr:","    try:","        from paddleocr import PaddleOCRVL","        has_vl = True","    except Exception:","        has_vl = False","print(json.dumps({'paddle': has_paddle, 'paddleocr': has_paddleocr, 'paddlex': has_paddlex, 'paddle_vl': has_vl}))"].join(`
`),r=await new Promise(l=>{let c=(0,ne.spawn)(n,[...t,"-c",i],{env:this.buildPythonEnv()}),d="";c.stdout.on("data",_=>{d+=_.toString()}),c.on("error",()=>l({ok:!1})),c.on("close",_=>{if(_!==0){l({ok:!1});return}try{let u=JSON.parse(d.trim());l({ok:!0,data:u})}catch(u){l({ok:!1})}})});if(!r.ok||!r.data)return{tesseract:e,paddleStructureLocal:!1,paddleVlLocal:!1};let a=r.data,s=!!a.paddle,o=!!a.paddleocr;return{tesseract:e,paddleStructureLocal:s&&o&&!!a.paddlex,paddleVlLocal:s&&o&&!!a.paddle_vl}}getSharedPythonEnvRoot(){let e=Ce.default.homedir();if(process.platform==="win32"){let t=process.env.LOCALAPPDATA||process.env.APPDATA||E.default.join(e,"AppData","Local");return E.default.join(t,"zotero-redisearch-rag")}let n=process.env.XDG_CACHE_HOME||E.default.join(e,".cache");return E.default.join(n,"zotero-redisearch-rag")}getPythonVenvDir(){return this.settings.pythonEnvLocation==="plugin"?E.default.join(this.getPluginDir(),".venv"):E.default.join(this.getSharedPythonEnvRoot(),"venv")}getVenvPythonPath(e){return process.platform==="win32"?E.default.join(e,"Scripts","python.exe"):E.default.join(e,"bin","python")}resolveRequirementsPath(e){var t;return(t=[E.default.join(e,"requirements.txt"),E.default.join(e,"tools","requirements.txt")].find(i=>(0,G.existsSync)(i)))!=null?t:null}async resolveBootstrapPython(){let e=(this.settings.pythonPath||"").trim(),n=this.expandPathValue(e);if(n&&await this.canRunCommand(n,[])){let i=await this.getPythonVersion(n,[]);if(i&&this.isUnsupportedPythonVersion(i))throw new Error(`Configured Python ${i.major}.${i.minor} is not supported. Install Python 3.11\u20133.13 and update the Python path.`);return{command:n,args:[]}}let t=process.platform==="win32"?[{command:"py",args:["-3.13"]},{command:"py",args:["-3.12"]},{command:"py",args:["-3.11"]},{command:"py",args:["-3.10"]},{command:"py",args:["-3"]},{command:"python",args:[]}]:[{command:"python3.13",args:[]},{command:"python3.12",args:[]},{command:"python3.11",args:[]},{command:"python3.10",args:[]},{command:"python3",args:[]},{command:"python",args:[]}];for(let i of t)if(await this.canRunCommand(i.command,i.args)){let r=await this.getPythonVersion(i.command,i.args);if(r&&this.isUnsupportedPythonVersion(r)){console.log(`Python env: skipping ${i.command} ${i.args.join(" ")} (Python ${r.major}.${r.minor} unsupported)`);continue}return i}throw new Error("No usable Python 3.11\u20133.13 interpreter found on PATH.")}isUnsupportedPythonVersion(e){return e.major>3||e.major===3&&e.minor>=14}async getPythonVersion(e,n){return new Promise(t=>{let i=(0,ne.spawn)(e,[...n,"-c","import sys; print(f'{sys.version_info.major}.{sys.version_info.minor}')"]),r="";i.stdout.on("data",a=>{r+=a.toString()}),i.on("error",()=>t(null)),i.on("close",a=>{if(a!==0){t(null);return}let s=r.trim().match(/(\d+)\.(\d+)/);if(!s){t(null);return}t({major:Number(s[1]),minor:Number(s[2])})})})}async canRunCommand(e,n){return new Promise(t=>{let i=(0,ne.spawn)(e,[...n,"--version"],{env:this.buildPythonEnv()});i.on("error",()=>t(!1)),i.on("close",r=>t(r===0))})}buildPythonEnv(){let e={...process.env},n=E.default.delimiter,t=e.PATH||"",r=[...process.platform==="win32"?[]:["/opt/homebrew/bin","/usr/local/bin"],t].filter(Boolean).join(n);return e.PATH=r,e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK||(e.PADDLE_PDX_DISABLE_MODEL_SOURCE_CHECK="True"),e.DISABLE_MODEL_SOURCE_CHECK||(e.DISABLE_MODEL_SOURCE_CHECK="True"),e}async resolvePythonScriptInvocation(e,n,t){if(!this.usePythonWorker())return{command:this.resolvePythonPath(),args:[e,...n],cwd:E.default.dirname(e),env:this.buildPythonEnv()};let i=await this.ensurePythonWorkerContext(t),r=this.mapPathForPythonWorker(e);if(r===e)throw new Error(`Python worker cannot access script '${e}'. Keep plugin files under your vault or plugin directory.`);let a=this.mapPythonArgsForWorker(n),s=this.buildComposeExecArgs(i,Pe,[Jn,r,...a]);return{command:i.composeCommand.command,args:s,cwd:E.default.dirname(i.composePath),env:i.composeEnv}}async runPython(e,n){let t;try{t=await this.resolvePythonScriptInvocation(e,n,this.settings.autoStartRedis)}catch(i){throw this.handlePythonProcessError(String(i)),i}return new Promise((i,r)=>{let a=(0,ne.spawn)(t.command,t.args,{cwd:t.cwd,env:t.env}),s="",o="";a.stdout.on("data",l=>{s+=l.toString()}),a.stderr.on("data",l=>{o+=l.toString()}),a.on("error",l=>{this.handlePythonProcessError(String(l)),r(l)}),a.on("close",l=>{if(l===0)i();else{let c=o.trim()?o:s;this.handlePythonProcessError(c),r(new Error(o||`Process exited with code ${l}`))}})})}runCommand(e,n,t){return new Promise((i,r)=>{var o;let a=(0,ne.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:(o=t==null?void 0:t.env)!=null?o:this.buildPythonEnv()}),s="";a.stderr.on("data",l=>{s+=l.toString()}),a.on("error",l=>{r(l)}),a.on("close",l=>{l===0?i():r(new Error(s||`Process exited with code ${l}`))})})}async runPythonStreaming(e,n,t,i,r,a="docling_extract",s){let o;try{o=await this.resolvePythonScriptInvocation(e,n,this.settings.autoStartRedis)}catch(l){throw this.handlePythonProcessError(String(l)),l}return new Promise((l,c)=>{let d=(0,ne.spawn)(o.command,o.args,{cwd:o.cwd,env:o.env});s&&s(d);let _="",u="",m="",y=null,b=!1,C=f=>{if(f.trim())try{let v=JSON.parse(f);y=v,((v==null?void 0:v.type)==="final"||v!=null&&v.answer)&&(b=!0),t(v)}catch(v){m+=`${f}
`}};d.stdout.on("data",f=>{var x;_+=f.toString();let v=_.split(/\r?\n/);_=(x=v.pop())!=null?x:"";for(let w of v)C(w)}),d.stderr.on("data",f=>{u+=f.toString()}),d.on("error",f=>{this.handlePythonProcessError(String(f)),c(f)}),d.on("close",f=>{if(_.trim()&&C(_),!b&&y&&i(y),r&&this.appendToLogFile(r,u,a,"STDERR"),f===0)l();else{let v=u.trim()?u:m;this.handlePythonProcessError(v),c(new Error(u||`Process exited with code ${f}`))}})})}runCommandStreaming(e,n,t,i){return new Promise((r,a)=>{var c;let s=(0,ne.spawn)(e,n,{cwd:t==null?void 0:t.cwd,env:(c=t==null?void 0:t.env)!=null?c:this.buildPythonEnv()}),o=d=>{d.toString().split(/\r?\n/).forEach(u=>{u.trim()&&i(u)})},l="";s.stdout.on("data",o),s.stderr.on("data",d=>{l+=d.toString(),o(d)}),s.on("error",d=>{a(d)}),s.on("close",d=>{d===0?r():a(new Error(l||`Process exited with code ${d}`))})})}handlePythonProcessError(e){if(!e)return;if(/Python worker cannot access path/i.test(e)){this.notifyContainerOnce(e.replace(/^Error:\s*/i,""));return}if(/python-worker/i.test(e)&&/(No such service|is not running|not found|no container)/i.test(e)){this.notifyContainerOnce("Python worker is not running. Start Redis stack now or enable Auto-start Redis stack.");return}if(/Cannot connect to the Docker daemon|docker desktop is not running|podman machine/i.test(e)){this.notifyContainerOnce("Container runtime is not available. Start Docker Desktop or Podman.");return}let n=e.match(/ModuleNotFoundError:\s+No module named ['"]([^'"]+)['"]/);if(n){let t=this.usePythonWorker()?`Python worker missing module '${n[1]}'. Restart Redis stack to rebuild worker env.`:`Python env missing module '${n[1]}'. Open Settings > Python environment > Create/Update.`;this.notifyPythonEnvOnce(t,!0);return}if(/No module named ['"]|ImportError: No module named/i.test(e)){let t=this.usePythonWorker()?"Python worker missing required modules. Restart Redis stack to rebuild worker env.":"Python env missing required modules. Open Settings > Python environment > Create/Update.";this.notifyPythonEnvOnce(t,!0);return}if(/ENOENT|No such file or directory|not found|command not found|spawn .* ENOENT/i.test(e)){let t=this.usePythonWorker()?"Python worker command failed. Start Redis stack and check container logs.":"Python not found. Configure the Python path or use Settings > Python environment > Create/Update.";this.notifyPythonEnvOnce(t,!0)}}notifyPythonEnvOnce(e,n=!1){this.lastPythonEnvNotice!==e&&(this.lastPythonEnvNotice=e,new h.Notice(e),n&&this.openPluginSettings())}notifyContainerOnce(e){this.lastContainerNotice!==e&&(this.lastContainerNotice=e,new h.Notice(e))}notifyRedisOnce(e){this.lastRedisNotice!==e&&(this.lastRedisNotice=e,new h.Notice(e))}async autoDetectRedisOnLoad(){if(this.settings.autoStartRedis)return;let e=(this.settings.redisUrl||"").trim(),t=e||"redis://127.0.0.1:6379";(await this.checkRedisConnectionWithUrl(t,500)).ok&&(e||(this.settings.redisUrl=t,await this.saveSettings()),this.notifyRedisOnce(`Redis detected at ${t}. This instance will be used.`))}notifyZoteroApiOnce(e){this.lastZoteroApiNotice!==e&&(this.lastZoteroApiNotice=e,new h.Notice(e))}async warnIfZoteroLocalApiUnavailable(e){if(await this.isZoteroLocalApiReachable())return this.lastZoteroApiNotice=null,!0;let i=`Zotero Local API is not reachable for ${e?`${e}`:"this action"}. Start Zotero or update the Local API URL in settings.`;return this.notifyZoteroApiOnce(i),!1}openPluginSettings(){let e=this.app.setting;e!=null&&e.open&&e.open(),e!=null&&e.openTabById&&e.openTabById(this.manifest.id)}getLogsDirRelative(){return(0,h.normalizePath)(`${Y}/logs`)}getLogFileRelativePath(){let e=(this.settings.logFilePath||"").trim();return(0,h.normalizePath)(e||`${this.getLogsDirRelative()}/docling_extract.log`)}getLogFileAbsolutePath(){return this.getAbsoluteVaultPath(this.getLogFileRelativePath())}getSpellcheckerInfoRelativePath(){return(0,h.normalizePath)(`${this.getLogsDirRelative()}/spellchecker_info.json`)}async openLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;if(!await n.exists(e)){new h.Notice("Log file not found.");return}try{let t=async()=>{try{return await n.read(e)||"(empty)"}catch(r){return"(empty)"}},i=await t();new ye(this.app,"Log file",i||"(empty)",{autoRefresh:!0,refreshIntervalMs:2e3,onRefresh:t,onClear:async()=>{await this.clearLogFile()}}).open()}catch(t){new h.Notice("Failed to open log file."),console.error(t)}}async clearLogFile(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{let t=(0,h.normalizePath)(E.default.dirname(e));t&&await this.ensureFolder(t),await n.write(e,""),new h.Notice("Log file cleared.")}catch(t){new h.Notice("Failed to clear log file."),console.error(t)}}async deleteLogFileIfExists(){let e=this.getLogFileRelativePath(),n=this.app.vault.adapter;try{await n.exists(e)&&await n.remove(e)}catch(t){console.warn("Failed to delete log file before import",t)}}formatLogLines(e,n,t){let i=e.split(/\r?\n/).map(a=>a.trimEnd()).filter(a=>!!a.trim());if(!i.length)return"";let r=new Date().toISOString().replace("T"," ").replace(".",",");return i.map(a=>`${r} ${t} ${n}: ${a}`).join(`
`)+`
`}async appendToLogFile(e,n,t="docling_extract",i="STDERR"){if(!n||!n.trim())return;let r=this.formatLogLines(n,t,i);if(r)try{await G.promises.mkdir(E.default.dirname(e),{recursive:!0}),await G.promises.appendFile(e,r)}catch(a){console.warn("Failed to append stderr to log file",a)}}async runPythonWithOutput(e,n,t,i="docling_extract"){let r;try{r=await this.resolvePythonScriptInvocation(e,n,this.settings.autoStartRedis)}catch(a){throw this.handlePythonProcessError(String(a)),a}return new Promise((a,s)=>{let o=(0,ne.spawn)(r.command,r.args,{cwd:r.cwd,env:r.env}),l="",c="";o.stdout.on("data",d=>{l+=d.toString()}),o.stderr.on("data",d=>{c+=d.toString()}),o.on("error",d=>{this.handlePythonProcessError(String(d)),s(d)}),o.on("close",d=>{if(t&&this.appendToLogFile(t,c,i,"STDERR"),d===0)a(l.trim());else{let _=c.trim()?c:l;this.handlePythonProcessError(_),s(new Error(c||`Process exited with code ${d}`))}})})}};

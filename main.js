...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:we,rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${ne}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Ue=class extends T.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async f=>{this.plugin.settings.llmProviderProfiles=f,await this.plugin.saveSettings()},i=f=>{f.inputEl.type="password",f.inputEl.autocomplete="off",f.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:f=>{f.createEl("h2",{text:"Prerequisites"});let k=null,x=null,w=null,S=null,v=null,N=null,R=null,I=null,L=null,j=(M,z)=>{if(!M)return;M.settingEl.classList.toggle("is-disabled",z),M.settingEl.style.opacity=z?"0.55":"";let Z=M.settingEl.querySelector(".setting-item-description");Z&&(Z.style.color=z?"var(--text-faint)":"")},F=(M,z)=>{M&&(M.settingEl.style.display=z?"":"none")},q=()=>{let M=!!this.plugin.settings.showAdvancedPythonRuntimeOptions,z=this.plugin.settings.pythonRuntime==="local",Z=M&&z;x==null||x.setDisabled(!M),j(k,!M),F(w,M),F(S,M),F(v,M),N==null||N.setDisabled(!Z),R==null||R.setDisabled(!Z),L==null||L.setDisabled(!Z),I&&(I.disabled=!Z),j(w,!Z),j(S,!Z),j(v,!Z)};new T.Setting(f).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(M=>M.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async z=>{this.plugin.settings.dockerPath=z.trim()||"docker",await this.plugin.saveSettings()})),new T.Setting(f).setName("Advanced Python runtime options").setDesc("Show legacy local interpreter/venv controls. Recommended to keep this disabled.").addToggle(M=>M.setValue(this.plugin.settings.showAdvancedPythonRuntimeOptions).onChange(async z=>{this.plugin.settings.showAdvancedPythonRuntimeOptions=z,!z&&this.plugin.settings.pythonRuntime==="local"&&(this.plugin.settings.pythonRuntime="worker",new T.Notice("Switched Python runtime to worker mode.")),await this.plugin.saveSettings(),q()})),k=new T.Setting(f).setName("Python runtime").setDesc("Worker runtime is recommended. Enable advanced options to expose local interpreter/venv mode.").addDropdown(M=>{x=M,M.addOption("worker","Python worker container (recommended)"),M.addOption("local","Local interpreter/venv"),M.setValue(this.plugin.settings.pythonRuntime).onChange(async z=>{z!=="worker"&&z!=="local"||(this.plugin.settings.pythonRuntime=z,await this.plugin.saveSettings(),q())})}),w=new T.Setting(f).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(M=>(N=M,M.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async z=>{this.plugin.settings.pythonPath=z.trim(),await this.plugin.saveSettings()}))),S=new T.Setting(f).setName("Python environment").setDesc("Local mode: create or update the plugin's Python env. Worker mode: managed by Docker startup.").addButton(M=>{L=M,I=M.buttonEl,M.setButtonText("Create/Update").setCta(),M.onClick(async()=>{M.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{M.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),v=new T.Setting(f).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(M=>{R=M,M.addOption("shared","Shared user cache"),M.addOption("plugin","Plugin folder (.venv)"),M.setValue(this.plugin.settings.pythonEnvLocation).onChange(async z=>{z!=="shared"&&z!=="plugin"||(this.plugin.settings.pythonEnvLocation=z,await this.plugin.saveSettings())})}),q(),new T.Setting(f).setName("Redis URL").addText(M=>M.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async z=>{this.plugin.settings.redisUrl=z.trim(),await this.plugin.saveSettings()}));let V=null,O=null,$=null,U=null,H=()=>{let M=this.plugin.settings.autoAssignRedisPort;$==null||$.setDisabled(M),U==null||U.setDisabled(M),V==null||V.settingEl.classList.toggle("is-disabled",M),O==null||O.settingEl.classList.toggle("is-disabled",M)};new T.Setting(f).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(M=>M.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async z=>{this.plugin.settings.autoAssignRedisPort=z,await this.plugin.saveSettings(),H()})),V=new T.Setting(f).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(M=>($=M,M.setPlaceholder("~/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async z=>{this.plugin.settings.redisDataDirOverride=z.trim(),await this.plugin.saveSettings()}))),V.settingEl.addClass("zrr-redis-override-setting"),O=new T.Setting(f).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(M=>(U=M,M.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async z=>{this.plugin.settings.redisProjectName=z.trim(),await this.plugin.saveSettings()}))),O.settingEl.addClass("zrr-redis-override-setting"),H(),new T.Setting(f).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(M=>M.setValue(this.plugin.settings.autoStartRedis).onChange(async z=>{this.plugin.settings.autoStartRedis=z,await this.plugin.saveSettings()})),new T.Setting(f).setName("Start Redis stack now").setDesc("Starts or restarts Redis stack (and Python worker in worker mode).").addButton(M=>M.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:f=>{f.createEl("h2",{text:"Zotero Local API"}),new T.Setting(f).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(v=>v.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async N=>{this.plugin.settings.zoteroBaseUrl=N.trim(),await this.plugin.saveSettings()}));let k=new T.Setting(f).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),x=null,w=v=>{if(!x)return;let N=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(v.map(I=>I.value)).has(N)||(v=v.concat([{value:N,label:`Custom (${N})`}])),x.selectEl.options.length=0;for(let I of v)x.addOption(I.value,I.label);x.setValue(N)},S=async()=>{if(x){x.setDisabled(!0);try{let v=await this.plugin.fetchZoteroLibraryOptions();w(v)}finally{x.setDisabled(!1)}}};k.addDropdown(v=>{x=v;let N=(this.plugin.settings.zoteroUserId||"0").trim()||"0";v.addOption(N,"Loading..."),v.setValue(N),v.onChange(async R=>{this.plugin.settings.zoteroUserId=R.trim(),await this.plugin.saveSettings()})}),k.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),f.createEl("h2",{text:"Zotero Web API"}),new T.Setting(f).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(v=>v.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async N=>{this.plugin.settings.webApiBaseUrl=N.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(v=>v.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async N=>{this.plugin.settings.webApiLibraryType=N,await this.plugin.saveSettings()})),new T.Setting(f).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(v=>v.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async N=>{this.plugin.settings.webApiLibraryId=N.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(v=>{i(v),v.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async N=>{this.plugin.settings.webApiKey=N.trim(),await this.plugin.saveSettings()})}),f.createEl("h2",{text:"Output"}),new T.Setting(f).setName("PDF folder").addText(v=>v.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async N=>{this.plugin.settings.outputPdfDir=N.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("Notes folder").addText(v=>v.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async N=>{this.plugin.settings.outputNoteDir=N.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(v=>{v.setValue(this.plugin.settings.frontmatterTemplate).onChange(async N=>{this.plugin.settings.frontmatterTemplate=N,await this.plugin.saveSettings()}),v.inputEl.rows=10,v.inputEl.style.width="100%"}),new T.Setting(f).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(v=>v.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async N=>{this.plugin.settings.tagSanitizeMode=N,await this.plugin.saveSettings()})),new T.Setting(f).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(v=>{v.setValue(this.plugin.settings.noteBodyTemplate).onChange(async N=>{this.plugin.settings.noteBodyTemplate=N,await this.plugin.saveSettings()}),v.inputEl.rows=8,v.inputEl.style.width="100%"}),new T.Setting(f).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(v=>v.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async N=>{this.plugin.settings.chatOutputDir=N.trim()||"zotero/chats",await this.plugin.saveSettings()})),new T.Setting(f).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(v=>v.setValue(this.plugin.settings.copyPdfToVault).onChange(async N=>{this.plugin.settings.copyPdfToVault=N,!N&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new T.Setting(f).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(v=>{let N=this.plugin.settings.copyPdfToVault;v.setValue(N?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!N).onChange(async R=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=R,await this.plugin.saveSettings()})}),new T.Setting(f).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(v=>v.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async N=>{this.plugin.settings.preferObsidianNoteForCitations=N,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:f=>{f.createEl("h2",{text:"Annotations"}),new T.Setting(f).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(S=>S.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async v=>{this.plugin.settings.annotationPageLabel=v.trim()||"Page",await this.plugin.saveSettings()})),new T.Setting(f).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(S=>S.setValue(this.plugin.settings.includeAnnotationImages).onChange(async v=>{this.plugin.settings.includeAnnotationImages=v,await this.plugin.saveSettings()})),f.createEl("h3",{text:"Zotero companion"}),f.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new T.Setting(f).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(S=>S.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async v=>{this.plugin.settings.zoteroCompanionEnabled=v,await this.plugin.saveSettings()})),new T.Setting(f).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(S=>S.setPlaceholder("http://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async v=>{this.plugin.settings.zoteroCompanionBaseUrl=v.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(S=>{i(S),this.companionTokenInput=S,S.setPlaceholder("optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async v=>{this.plugin.settings.zoteroCompanionToken=v.trim(),await this.plugin.saveSettings()})}),new T.Setting(f).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero Companion Plugin token to this value.").addButton(S=>S.setButtonText("Generate token").onClick(async()=>{let v=(0,Ft.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=v,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(v);try{await navigator.clipboard.writeText(v),new T.Notice("Generated and copied companion token.")}catch(N){new T.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",N)}})),f.createEl("h3",{text:"Annotation color map"}),f.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let k=f.createDiv({cls:"zrr-annotation-map"}),x=async S=>{this.plugin.settings.annotationColorMap=S,await this.plugin.saveSettings()},w=()=>{var L,j;k.empty();let S=this.plugin.settings.annotationColorMap||{},v=Object.entries(S);if(v.length||k.createEl("p",{text:"No color mappings configured."}),v.length){let F=k.createDiv({cls:"zrr-annotation-map-row-header"});F.createEl("span",{text:"Color"}),F.createEl("span",{text:"Heading"}),F.createEl("span",{text:"Callout"}),F.createEl("span")}for(let[F,q]of v){let O=k.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),$=O.createEl("input",{type:"text",value:F,cls:"zrr-annotation-map-input"}),U=O.createEl("input",{type:"text",value:(L=q.heading)!=null?L:"",cls:"zrr-annotation-map-input"}),H=O.createEl("input",{type:"text",value:(j=q.callout)!=null?j:"",cls:"zrr-annotation-map-input"}),M=O.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});M.type="button",$.addEventListener("change",async()=>{let z=$.value.trim().toLowerCase();if(!z){$.value=F;return}let Z={...this.plugin.settings.annotationColorMap||{}};if(z!==F&&Z[z]){new T.Notice(`Annotation color '${z}' already exists.`),$.value=F;return}let B=Z[F];delete Z[F],Z[z]=B!=null?B:{heading:"",callout:""},await x(Z),w()}),U.addEventListener("change",async()=>{var B;let z={...this.plugin.settings.annotationColorMap||{}},Z=(B=z[F])!=null?B:{heading:"",callout:""};Z.heading=U.value.trim(),z[F]=Z,await x(z)}),H.addEventListener("change",async()=>{var B;let z={...this.plugin.settings.annotationColorMap||{}},Z=(B=z[F])!=null?B:{heading:"",callout:""};Z.callout=H.value.trim(),z[F]=Z,await x(z)}),M.addEventListener("click",async()=>{let z={...this.plugin.settings.annotationColorMap||{}};delete z[F],await x(z),w()})}let N=k.createDiv({cls:"zrr-annotation-map-actions"}),R=N.createEl("button",{text:"Add mapping"});R.type="button",R.addEventListener("click",async()=>{let F={...this.plugin.settings.annotationColorMap||{}},q="new-color",V=1;for(;F[q];)q=`new-color-${V}`,V+=1;F[q]={heading:"",callout:""},await x(F),w()});let I=N.createEl("button",{text:"Reset to defaults"});I.type="button",I.addEventListener("click",async()=>{await x({...Be.annotationColorMap}),w()})};w()}},{id:"ocr",label:"OCR",render:f=>{f.createEl("h2",{text:"Docling"});let k=null,x=N=>{if(!k)return;let R=this.plugin.settings.ocrEngine;new Set(N.map(L=>L.value)).has(R)||(N=N.concat([{value:R,label:`Current (unavailable): ${R}`}])),k.selectEl.options.length=0;for(let L of N)k.addOption(L.value,L.label);k.setValue(R)},w=async()=>{if(!k)return;k.setDisabled(!0);let N={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{N=await this.plugin.detectOcrEngines()}catch(L){N={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let R=[{value:"auto",label:"Auto (default)"}];N.tesseract&&R.push({value:"tesseract",label:"Tesseract (local)"}),N.paddleStructureLocal&&R.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),N.paddleVlLocal&&R.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(R.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),R.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),x(R),k.setDisabled(!1)},S=new T.Setting(f).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),v=document.createElement("a");v.href="https://aistudio.baidu.com/paddleocr",v.textContent="https://aistudio.baidu.com/paddleocr",v.target="_blank",v.rel="noopener noreferrer",S.descEl.appendChild(v),S.descEl.append("."),S.addText(N=>{i(N),N.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async R=>{this.plugin.settings.paddleApiKey=R.trim(),await this.plugin.saveSettings(),await w()})}),new T.Setting(f).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(N=>N.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async R=>{this.plugin.settings.paddleVlApiUrl=R.trim(),await this.plugin.saveSettings()})),new T.Setting(f).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(N=>N.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async R=>{this.plugin.settings.paddleStructureApiUrl=R.trim(),await this.plugin.saveSettings(),await w()})),new T.Setting(f).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(N=>{k=N,N.addOption("auto","Auto (default)"),N.setValue(this.plugin.settings.ocrEngine),N.onChange(async R=>{this.plugin.settings.ocrEngine=R,await this.plugin.saveSettings()})}),new T.Setting(f).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(N=>N.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async R=>{this.plugin.settings.ocrMode=R,await this.plugin.saveSettings()})),new T.Setting(f).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(N=>N.setValue(this.plugin.settings.forcePerPageOcr).onChange(async R=>{this.plugin.settings.forcePerPageOcr=R,await this.plugin.saveSettings()})),new T.Setting(f).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(N=>{N.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async R=>{this.plugin.settings.ocrQualityThreshold=R,await this.plugin.saveSettings()})}),new T.Setting(f).setName("Chunking").setDesc("page or section").addDropdown(N=>N.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async R=>{this.plugin.settings.chunkingMode=R,await this.plugin.saveSettings()})),w()}},{id:"llms",label:"LLMs",render:f=>{f.createEl("h2",{text:"LLM Provider Profiles"});let k=f.createDiv({cls:"zrr-llm-profiles"}),x=()=>{k.empty();let A=t();A.length||k.createEl("p",{text:"No profiles yet. Add one below."});for(let C of A){let D=k.createEl("details",{cls:"zrr-profile"});A.length===1&&(D.open=!0);let te=D.createEl("summary",{text:C.name||C.id||"Profile"});te.addClass("zrr-profile-title");let Me=D.createDiv({cls:"zrr-profile-body"});new T.Setting(Me).setName("Profile name").addText(ue=>ue.setPlaceholder("My provider").setValue(C.name||"").onChange(async ge=>{C.name=ge.trim(),te.textContent=C.name||C.id||"Profile",await n(t())})),new T.Setting(Me).setName("Base URL").addText(ue=>ue.setPlaceholder("http://localhost:1234/v1").setValue(C.baseUrl||"").onChange(async ge=>{C.baseUrl=ge.trim(),await n(t())})),new T.Setting(Me).setName("API key").setDesc("Stored in settings (not encrypted).").addText(ue=>{i(ue),ue.setPlaceholder("sk-...").setValue(C.apiKey||"").onChange(async ge=>{C.apiKey=ge.trim(),await n(t())})}),new T.Setting(Me).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(ue=>ue.setButtonText("Delete profile").onClick(async()=>{let ge=t().filter(pn=>pn.id!==C.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===C.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===C.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===C.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(ge),x()}))}new T.Setting(k).addButton(C=>C.setButtonText("Add profile").onClick(async()=>{let D=`profile-${Date.now().toString(36)}`,te=t().concat([{id:D,name:"Custom",baseUrl:"",apiKey:""}]);await n(te),x()}))};x(),f.createEl("h2",{text:"OCR cleanup"}),new T.Setting(f).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(A=>A.setValue(this.plugin.settings.enableLlmCleanup).onChange(async C=>{this.plugin.settings.enableLlmCleanup=C,await this.plugin.saveSettings()}));let w=null,S=null,v=null,N=async()=>{},R=async(A,C=!0)=>{let D=A.trim();this.plugin.settings.llmCleanupBaseUrl=D,C&&(this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom")),S&&S.setValue(D),await this.plugin.saveSettings()},I=async A=>{let C=t().find(D=>D.id===A);this.plugin.settings.llmCleanupProviderProfileId=A,C&&(this.plugin.settings.llmCleanupBaseUrl=C.baseUrl,this.plugin.settings.llmCleanupApiKey=C.apiKey,S==null||S.setValue(C.baseUrl),v==null||v.setValue(C.apiKey)),await this.plugin.saveSettings(),await N()};new T.Setting(f).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{w=A,A.addOption("custom","Custom (manual)");for(let D of t())A.addOption(D.id,D.name||D.id);let C=this.plugin.settings.llmCleanupProviderProfileId;A.setValue(C&&t().some(D=>D.id===C)?C:"custom"),A.onChange(async D=>{if(D==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await I(D)})}),new T.Setting(f).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(A=>{S=A,A.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async C=>{await R(C)})}),new T.Setting(f).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(A=>{v=A,i(A),A.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async C=>{this.plugin.settings.llmCleanupApiKey=C.trim(),this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom"),await this.plugin.saveSettings()})});let L=new T.Setting(f).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),j=null,F=A=>{if(!j)return;let C=(this.plugin.settings.llmCleanupModel||"").trim(),D=new Set(A.map(te=>te.value));C&&!D.has(C)&&(A=A.concat([{value:C,label:`Custom (${C})`}])),j.selectEl.options.length=0;for(let te of A)j.addOption(te.value,te.label);C&&j.setValue(C)};N=async()=>{if(j){j.setDisabled(!0);try{let A=await this.plugin.fetchCleanupModelOptions();F(A)}finally{j.setDisabled(!1)}}},L.addDropdown(A=>{j=A;let C=(this.plugin.settings.llmCleanupModel||"").trim();A.addOption(C||"loading","Loading..."),A.setValue(C||"loading"),A.onChange(async D=>{this.plugin.settings.llmCleanupModel=D.trim(),await this.plugin.saveSettings()})}),L.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await N()})}),N(),new T.Setting(f).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(A=>A.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async C=>{let D=Number.parseFloat(C);this.plugin.settings.llmCleanupTemperature=Number.isFinite(D)?D:0,await this.plugin.saveSettings()})),new T.Setting(f).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(A=>A.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async C=>{this.plugin.settings.llmCleanupMinQuality=C,await this.plugin.saveSettings()})),new T.Setting(f).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(A=>A.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(D)?D:2e3,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Text Embedding"});let q=null,V=null,O=null,$=async()=>{},U=async(A,C=!0)=>{let D=A.trim();this.plugin.settings.embedBaseUrl=D,C&&(this.plugin.settings.embedProviderProfileId="",q&&q.setValue("custom")),V&&V.setValue(D),await this.plugin.saveSettings()},H=async A=>{let C=t().find(D=>D.id===A);this.plugin.settings.embedProviderProfileId=A,C&&(this.plugin.settings.embedBaseUrl=C.baseUrl,this.plugin.settings.embedApiKey=C.apiKey,V==null||V.setValue(C.baseUrl),O==null||O.setValue(C.apiKey)),await this.plugin.saveSettings(),await $()};new T.Setting(f).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{q=A,A.addOption("custom","Custom (manual)");for(let D of t())A.addOption(D.id,D.name||D.id);let C=this.plugin.settings.embedProviderProfileId;A.setValue(C&&t().some(D=>D.id===C)?C:"custom"),A.onChange(async D=>{if(D==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await H(D)})}),new T.Setting(f).setName("Embeddings base URL").addText(A=>{V=A,A.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async C=>{await U(C)})}),new T.Setting(f).setName("Embeddings API key").addText(A=>{O=A,i(A),A.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async C=>{this.plugin.settings.embedApiKey=C.trim(),this.plugin.settings.embedProviderProfileId="",q&&q.setValue("custom"),await this.plugin.saveSettings()})});let M=new T.Setting(f).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),z=null,Z=A=>{if(!z)return;let C=(this.plugin.settings.embedModel||"").trim(),D=new Set(A.map(te=>te.value));C&&!D.has(C)&&(A=A.concat([{value:C,label:`Custom (${C})`}])),z.selectEl.options.length=0;for(let te of A)z.addOption(te.value,te.label);C&&z.setValue(C)};$=async()=>{if(z){z.setDisabled(!0);try{let A=await this.plugin.fetchEmbeddingModelOptions();Z(A)}finally{z.setDisabled(!1)}}},M.addDropdown(A=>{z=A;let C=(this.plugin.settings.embedModel||"").trim();A.addOption(C||"loading","Loading..."),A.setValue(C||"loading"),A.onChange(async D=>{this.plugin.settings.embedModel=D.trim(),await this.plugin.saveSettings()})}),M.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await $()})}),$(),new T.Setting(f).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(A=>A.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async C=>{this.plugin.settings.embedIncludeMetadata=C,await this.plugin.saveSettings()})),new T.Setting(f).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(A=>A.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.embedContextWindow=Number.isFinite(D)?Math.max(0,D):1,await this.plugin.saveSettings()})),new T.Setting(f).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(A=>A.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.embedContextChars=Number.isFinite(D)?Math.max(0,D):220,await this.plugin.saveSettings()})),new T.Setting(f).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(A=>A.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(D)?Math.max(0,D):3500,await this.plugin.saveSettings()})),new T.Setting(f).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(A=>A.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(D)?Math.max(0,D):200,await this.plugin.saveSettings()})),new T.Setting(f).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(A=>A.setValue(this.plugin.settings.enableChunkTagging).onChange(async C=>{this.plugin.settings.enableChunkTagging=C,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Chat LLM"});let B=null,G=null,re=null,pe=async()=>{},ye=async(A,C=!0)=>{let D=A.trim();this.plugin.settings.chatBaseUrl=D,C&&(this.plugin.settings.chatProviderProfileId="",B&&B.setValue("custom")),G&&G.setValue(D),await this.plugin.saveSettings()},be=async A=>{let C=t().find(D=>D.id===A);this.plugin.settings.chatProviderProfileId=A,C&&(this.plugin.settings.chatBaseUrl=C.baseUrl,this.plugin.settings.chatApiKey=C.apiKey,G==null||G.setValue(C.baseUrl),re==null||re.setValue(C.apiKey)),await this.plugin.saveSettings(),await pe()};new T.Setting(f).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{B=A,A.addOption("custom","Custom (manual)");for(let D of t())A.addOption(D.id,D.name||D.id);let C=this.plugin.settings.chatProviderProfileId;A.setValue(C&&t().some(D=>D.id===C)?C:"custom"),A.onChange(async D=>{if(D==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await be(D)})}),new T.Setting(f).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(A=>{G=A,A.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async C=>{await ye(C)})}),new T.Setting(f).setName("Chat API key").addText(A=>{re=A,i(A),A.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async C=>{this.plugin.settings.chatApiKey=C.trim(),this.plugin.settings.chatProviderProfileId="",B&&B.setValue("custom"),await this.plugin.saveSettings()})});let Fe=new T.Setting(f).setName("Chat model").setDesc("Select a chat-capable model from the provider."),le=null,ot=A=>{if(!le)return;let C=(this.plugin.settings.chatModel||"").trim(),D=new Set(A.map(te=>te.value));C&&!D.has(C)&&(A=A.concat([{value:C,label:`Custom (${C})`}])),le.selectEl.options.length=0;for(let te of A)le.addOption(te.value,te.label);C&&le.setValue(C)};pe=async()=>{if(le){le.setDisabled(!0);try{let A=await this.plugin.fetchChatModelOptions();ot(A)}finally{le.setDisabled(!1)}}},Fe.addDropdown(A=>{le=A;let C=(this.plugin.settings.chatModel||"").trim();A.addOption(C||"loading","Loading..."),A.setValue(C||"loading"),A.onChange(async D=>{this.plugin.settings.chatModel=D.trim(),await this.plugin.saveSettings()})}),Fe.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await pe()})}),pe(),new T.Setting(f).setName("Temperature").addText(A=>A.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async C=>{let D=Number.parseFloat(C);this.plugin.settings.chatTemperature=Number.isFinite(D)?D:.2,await this.plugin.saveSettings()})),new T.Setting(f).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(A=>A.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(D)?Math.max(0,D):6,await this.plugin.saveSettings()})),new T.Setting(f).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(A=>A.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async C=>{this.plugin.settings.chatPaneLocation=C,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Retrieval"}),new T.Setting(f).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(A=>A.setValue(this.plugin.settings.enableAgenticRag).onChange(async C=>{this.plugin.settings.enableAgenticRag=C,await this.plugin.saveSettings()})),new T.Setting(f).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(A=>A.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.agenticMaxIters=Number.isFinite(D)?Math.max(1,D):2,await this.plugin.saveSettings()})),new T.Setting(f).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(A=>A.setValue(this.plugin.settings.enableQueryExpansion).onChange(async C=>{this.plugin.settings.enableQueryExpansion=C,await this.plugin.saveSettings()})),new T.Setting(f).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(A=>A.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.queryExpansionCount=Number.isFinite(D)?Math.max(1,D):3,await this.plugin.saveSettings()})),new T.Setting(f).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(A=>A.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async C=>{this.plugin.settings.enableCrossEncoderRerank=C,await this.plugin.saveSettings()}));let J=new Set(It.map(A=>A.value)),X=(this.plugin.settings.rerankModel||"").trim()||we,xe=J.has(X)?X:Ee,se=null,wt=()=>{if(!se)return;let C=!(xe===Ee);se.setDisabled(C),se.inputEl.disabled=C,se.inputEl.readOnly=C,se.inputEl.classList.toggle("is-disabled",C),se.inputEl.setAttribute("aria-disabled",String(C))},vt=new T.Setting(f).setName("Cross-encoder model").setDesc("Choose a multilingual preset, or select Custom to edit the model id.");vt.addDropdown(A=>{for(let C of It)A.addOption(C.value,C.label);A.addOption(Ee,"Custom"),A.setValue(xe),A.onChange(async C=>{xe=C,C!==Ee?this.plugin.settings.rerankModel=C:(this.plugin.settings.rerankModel||"").trim()||(this.plugin.settings.rerankModel=we),await this.plugin.saveSettings(),se==null||se.setValue(this.plugin.settings.rerankModel||we),wt()})}),vt.addText(A=>{se=A,A.setPlaceholder(we).setValue(X).onChange(async C=>{xe===Ee&&(this.plugin.settings.rerankModel=C.trim()||we,await this.plugin.saveSettings())}),wt()}),new T.Setting(f).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(A=>A.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(D)?Math.max(1,D):4,await this.plugin.saveSettings()})),new T.Setting(f).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(A=>A.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.rrfK=Number.isFinite(D)?Math.max(1,D):60,await this.plugin.saveSettings()})),new T.Setting(f).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(A=>A.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.rrfLogTop=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()})),new T.Setting(f).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(A=>A.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async C=>{let D=Number.parseInt(C,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:f=>{f.createEl("h2",{text:"Python Runtime"}),new T.Setting(f).setName("Use local runtime (legacy)").setDesc("Switch to local interpreter/venv mode and enable advanced runtime settings.").addButton(k=>k.setButtonText("Switch").onClick(async()=>{await this.plugin.switchPythonRuntimeToLocalLegacy()})),f.createEl("h2",{text:"Logging"}),new T.Setting(f).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(k=>k.setValue(this.plugin.settings.enableFileLogging).onChange(async x=>{this.plugin.settings.enableFileLogging=x,await this.plugin.saveSettings()})),new T.Setting(f).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(k=>k.setPlaceholder(`${ne}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async x=>{this.plugin.settings.logFilePath=x.trim()||`${ne}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new T.Setting(f).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(k=>k.setButtonText("Open log").onClick(async()=>{var x,w;await((w=(x=this.plugin).openLogFile)==null?void 0:w.call(x))})).addButton(k=>k.setButtonText("Clear log").onClick(async()=>{var x,w;await((w=(x=this.plugin).clearLogFile)==null?void 0:w.call(x))})),f.createEl("h2",{text:"Zotero Companion Plugin"}),f.createEl("p",{text:"Download the XPI, then in Zotero go to Tools \u2192 Add-ons \u2192 Install from File and restart."}),new T.Setting(f).setName("Download companion add-on").setDesc("Downloads the companion XPI to your system Downloads folder.").addButton(k=>k.setButtonText("Download XPI").onClick(async()=>{let x=this.getDefaultDownloadDir();if(!x){new T.Notice("Unable to resolve the system Downloads folder.");return}let w=Ve.default.join(x,"zrr-companion.xpi");if(await this.companionXpiExists(w)){new T.Notice(`Companion XPI already exists: ${w}`);return}new T.Notice("Downloading companion XPI..."),await this.downloadCompanionXpi(w)})),new T.Setting(f).setName("Open Zotero").setDesc("Launch Zotero and open the Add-ons window (Tools \u2192 Add-ons).").addButton(k=>k.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new T.Setting(f).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(k=>k.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),f.createEl("h2",{text:"Redis Indexing"}),new T.Setting(f).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(k=>k.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new T.Setting(f).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(k=>k.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(k=>k.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()})),f.createEl("h2",{text:"Release Notes"}),new T.Setting(f).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(k=>k.setButtonText("Show").onClick(async()=>{await this.plugin.openReleaseNotesModal()}))}}],_=new Map,p=new Map,h=f=>{this.activeTab=f;for(let[k,x]of _){let w=k===f;x.classList.toggle("is-active",w),x.setAttribute("aria-selected",w?"true":"false"),x.setAttribute("tabindex",w?"0":"-1")}for(let[k,x]of p){let w=k===f;x.classList.toggle("is-active",w),x.hidden=!w}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let b=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let f of d){let k=y.createEl("button",{text:f.label,cls:"zrr-settings-tab-button"}),x=`zrr-settings-tab-${f.id}`,w=`zrr-settings-panel-${f.id}`;k.type="button",k.id=x,k.setAttribute("role","tab"),k.setAttribute("aria-controls",w),k.setAttribute("aria-selected","false"),k.addEventListener("click",()=>h(f.id));let S=b.createDiv({cls:"zrr-settings-tab-panel"});S.id=w,S.setAttribute("role","tabpanel"),S.setAttribute("aria-labelledby",x),S.hidden=!0,f.render(S),_.set(f.id,k),p.set(f.id,S)}let P=d.some(f=>f.id===this.activeTab)?this.activeTab:d[0].id;h(P)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Ve.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await $e.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await $e.promises.mkdir(Ve.default.dirname(e),{recursive:!0});let t=await(0,T.requestUrl)({url:wn,method:"GET"});if(t.status!==200){new T.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await $e.promises.writeFile(e,n),new T.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new T.Notice("Failed to download companion XPI. See console for details."),console.warn("Failed to download companion XPI",t)}}};var zt=require("@codemirror/state"),jt=require("@codemirror/view"),de=require("obsidian");var vn=g=>{let u=g.scrollDOM.getBoundingClientRect(),e=g.posAtCoords({x:u.left+8,y:+u.height*.25});return e===null?null:g.state.doc.lineAt(e).number},Ze=class{constructor(u,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=u,this.helpers=e}createSyncExtension(){let u=this,e=this.helpers;return jt.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=e.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=e.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var _,p;let i=this.docId;if(!i)return;let r=vn(t);if(r===null)return;let a=e.findChunkStartLineInDoc(t.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(_=s==null?void 0:s.pageNumber)!=null?_:null,l=(p=s==null?void 0:s.chunkId)!=null?p:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||d)||(this.lastPage=o,this.lastChunkId=l,u.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,t;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((t=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:t.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let u=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(u.docId,u.pageNumber,u.chunkId)}updatePreviewScrollHandler(){var n;let u=this.deps.app.workspace.getActiveViewOfType(de.MarkdownView);if(!u||u.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=u.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(u);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(u)}async syncPdfSidebarForFile(u){try{let e=await this.deps.app.vault.read(u),t=await this.deps.resolveDocIdForNote(u,e);if(!t)return;let n=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(t,n==null?void 0:n.pageNumber,n==null?void 0:n.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(u,e,t){if(u){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:u,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let n=await this.deps.getDocIndexEntry(u);n||(n=await this.deps.hydrateDocIndexFromCache(u));let i=n!=null&&n.pdf_path?String(n.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let d=(0,de.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(d)instanceof de.TFile&&(r=d)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof de.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&t&&(o=await this.resolvePageNumberForChunk(u,t)),o===null||this.pdfSidebarDocId===u&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=u,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,c=o!==null?`${l}#page=${o}`:l;await this.openPdfLinkInLeaf(s,c),this.updatePdfSidebarIcon(s)}finally{this.pdfSyncInFlight=!1;let n=this.queuedPdfSync;this.queuedPdfSync=null,n&&this.syncPdfSidebarForDoc(n.docId,n.pageNumber,n.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(u){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(u)}))}syncPdfSidebarForPreview(u){let e=this.previewScrollEl;if(!e)return;let t=u.getViewData();if(!t)return;let n=zt.Text.of(t.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(n);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(n,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(u){var n;let e=u.getBoundingClientRect().top,t=u.querySelectorAll("[data-line]");for(let i of Array.from(t))if(i.getBoundingClientRect().bottom>=e+2){let a=(n=i.getAttribute("data-line"))!=null?n:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var n,i;if(this.pdfSidebarLeaf&&((i=(n=this.pdfSidebarLeaf.view)==null?void 0:n.getViewType)==null?void 0:i.call(n))==="pdf")return this.pdfSidebarLeaf;let u=this.deps.app.workspace;if(typeof u.ensureSideLeaf=="function")try{let r=await u.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let t=this.deps.app.workspace.getRightLeaf(!0);return t&&this.isRightSidebarLeaf(t)?(this.pdfSidebarLeaf=t,this.updatePdfSidebarIcon(t),t):null}isRightSidebarLeaf(u){if(!u)return!1;let t=u.containerEl;return!!(t!=null&&t.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(u){if(!u||!this.isRightSidebarLeaf(u))return;let t=u.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let i=u;if(i.tabHeaderEl&&n.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&n.push(i.tabHeaderInnerIconEl),n.length===0)return;let r=new Set;for(let s of n)r.has(s)||(r.add(s),s.innerHTML="",(0,de.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=u.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(u,e){var r,a,s;let t=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],n=(s=(a=t==null?void 0:t.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof n=="function")try{await n.call(t.lib.workspace,u,e,"",{active:!1});return}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150)}let i=u;if(typeof i.openLinkText=="function"){try{await i.openLinkText(e,"",{active:!1})}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150),await i.openLinkText(e,"",{active:!1})}return}await this.deps.app.workspace.openLinkText(e,"",!1)}isPdfAnnotationRaceError(u){let e=u instanceof Error?u.message:String(u!=null?u:"");return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(u){return new Promise(e=>setTimeout(e,u))}getPluginsRegistry(){var u;return(u=this.deps.app.plugins)==null?void 0:u.plugins}isLeafTabActive(u){var i;let e=u;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===u;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(u,e){var l,c,d,_,p;if(!u||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,u)||e,n=this.chunkPageCache.get(u);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let i=(0,de.normalizePath)(`${Q}/${u}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let h of s){let y=typeof(h==null?void 0:h.chunk_id)=="string"?h.chunk_id.trim():"";if(!y)continue;let b=Number.isFinite((c=h==null?void 0:h.page_start)!=null?c:NaN)?Number(h.page_start):null,P=Number.isFinite((d=h==null?void 0:h.page_end)!=null?d:NaN)?Number(h.page_end):null,f=b!=null?b:P;f!==null&&(o.set(y,f),o.set(`${u}:${y}`,f))}return this.chunkPageCache.set(u,o),(p=(_=o.get(t))!=null?_:o.get(e))!=null?p:null}};var Ge={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.2
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.2
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.2
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.2
...
`,"redis-stack.conf":`# zotero-redisearch-rag tool version: 0.9.2
...
`)}async renderFrontmatter(e,t,n,i,r,a){var d;let s=(d=this.settings.frontmatterTemplate)!=null?d:"";if(!s.trim())return"";let o=a!=null?a:await this.buildTemplateVars(e,t,n,i,r),l=this.renderTemplate(s,o,"",{appendDocling:!1}).trim(),c=this.stripEmptyFrontmatterFields(l);return this.normalizeFrontmatterKeySpacing(c)}stripEmptyFrontmatterFields(e){if(!e.trim())return"";let t=e.split(/\r?\n/),n=[],i=/^([A-Za-z0-9][A-Za-z0-9 _-]*)\s*:\s*(.*)$/,r=/^[ \t]+-\s*(.*)$/,a=new Set(["abstract"]),s=l=>l===""||l==='""'||l==="''",o=0;for(;o<t.length;){let l=t[o],c=l.match(i);if(!c){n.push(l),o+=1;continue}let d=c[1].trim(),_=c[2].trim();if(a.has(d)){n.push(l),o+=1;continue}if(!s(_)){n.push(l),o+=1;continue}let p=o+1,h=[];for(;p<t.length&&t[p].match(r);)h.push(t[p]),p+=1;if(h.length===0){for(o=p;o<t.length&&t[o].trim()==="";)o+=1;continue}let y=h.filter(b=>{let P=b.match(r);if(!P)return!1;let f=P[1].trim();return!s(f)});if(y.length>0&&n.push(l,...y),o=p,y.length===0)for(;o<t.length&&t[o].trim()==="";)o+=1}for(;n.length>0&&n[n.length-1].trim()==="";)n.pop();return n.join(`

"use strict";var Je=Object.create;var he=Object.defineProperty;var Ye=Object.getOwnPropertyDescriptor;var Qe=Object.getOwnPropertyNames;var Xe=Object.getPrototypeOf,en=Object.prototype.hasOwnProperty;var nn=(w,g)=>{for(var e in g)he(w,e,{get:g[e],enumerable:!0})},Ie=(w,g,e,n)=>{if(g&&typeof g=="object"||typeof g=="function")for(let t of Qe(g))!en.call(w,t)&&t!==e&&he(w,t,{get:()=>g[t],enumerable:!(n=Ye(g,t))||n.enumerable});return w};var le=(w,g,e)=>(e=w!=null?Je(Xe(w)):{},Ie(g||!w||!w.__esModule?he(e,"default",{value:w,enumerable:!0}):e,w)),tn=w=>Ie(he({},"__esModule",{value:!0}),w);var fn={};nn(fn,{default:()=>be});module.exports=tn(fn);var p=require("obsidian"),re=require("@codemirror/state"),j=require("@codemirror/view"),J=require("child_process"),U=require("fs"),Ge=le(require("http")),Ue=le(require("https")),fe=le(require("net")),Ze=le(require("tls")),v=le(require("path")),se=require("url"),me=require("crypto");var L=require("obsidian"),W=".zotero-redisearch-rag",K=`${W}/items`,Z=`${W}/chunks`,ze={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,noteBodyTemplate:"{{pdf_block}}{{docling_markdown}}",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],embedProviderProfileId:"lm-studio",chatProviderProfileId:"lm-studio",llmCleanupProviderProfileId:"lm-studio",tagSanitizeMode:"kebab",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",chatOutputDir:"Zotero/Chats",chatPaneLocation:"right",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!0,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,enableChunkTagging:!1,chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,ocrMode:"auto",chunkingMode:"page",maxChunkChars:4e3,chunkOverlapChars:250,ocrQualityThreshold:.5,enableLlmCleanup:!1,llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,enableFileLogging:!1,logFilePath:`${W}/logs/docling_extract.log`,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0},_e=class extends L.PluginSettingTab{constructor(g,e){super(g,e),this.plugin=e}display(){let{containerEl:g}=this;g.empty();let e=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async u=>{this.plugin.settings.llmProviderProfiles=u,await this.plugin.saveSettings()},t=u=>{u.inputEl.type="password",u.inputEl.autocomplete="off",u.inputEl.spellcheck=!1};g.createEl("h2",{text:"Prerequisites"}),new L.Setting(g).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env.").addText(u=>u.setPlaceholder("python3").setValue(this.plugin.settings.pythonPath).onChange(async _=>{this.plugin.settings.pythonPath=_.trim(),await this.plugin.saveSettings()})),new L.Setting(g).setName("Python environment").setDesc("Create or update the plugin's Python env (.venv in the plugin folder).").addButton(u=>{u.setButtonText("Create/Update").setCta(),u.onClick(async()=>{u.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{u.setDisabled(!1)}})}),new L.Setting(g).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack).").addText(u=>u.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async _=>{this.plugin.settings.dockerPath=_.trim()||"docker",await this.plugin.saveSettings()})),new L.Setting(g).setName("Redis URL").addText(u=>u.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async _=>{this.plugin.settings.redisUrl=_.trim(),await this.plugin.saveSettings()})),new L.Setting(g).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(u=>u.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async _=>{this.plugin.settings.autoAssignRedisPort=_,await this.plugin.saveSettings()})),new L.Setting(g).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker.").addToggle(u=>u.setValue(this.plugin.settings.autoStartRedis).onChange(async _=>{this.plugin.settings.autoStartRedis=_,await this.plugin.saveSettings()})),new L.Setting(g).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(u=>u.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()})),g.createEl("h2",{text:"Zotero Local API"}),new L.Setting(g).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(u=>u.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async _=>{this.plugin.settings.zoteroBaseUrl=_.trim(),await this.plugin.saveSettings()}));let i=new L.Setting(g).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),r=null,s=u=>{if(!r)return;let _=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(u.map(F=>F.value)).has(_)||(u=u.concat([{value:_,label:`Custom (${_})`}])),r.selectEl.options.length=0;for(let F of u)r.addOption(F.value,F.label);r.setValue(_)},a=async()=>{if(r){r.setDisabled(!0);try{let u=await this.plugin.fetchZoteroLibraryOptions();s(u)}finally{r.setDisabled(!1)}}};i.addDropdown(u=>{r=u;let _=(this.plugin.settings.zoteroUserId||"0").trim()||"0";u.addOption(_,"Loading..."),u.setValue(_),u.onChange(async k=>{this.plugin.settings.zoteroUserId=k.trim(),await this.plugin.saveSettings()})}),i.addButton(u=>{u.setButtonText("Refresh").onClick(async()=>{await a()})}),a(),g.createEl("h2",{text:"Zotero Web API"}),new L.Setting(g).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(u=>u.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async _=>{this.plugin.settings.webApiBaseUrl=_.trim(),await this.plugin.saveSettings()})),new L.Setting(g).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(u=>u.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async _=>{this.plugin.settings.webApiLibraryType=_,await this.plugin.saveSettings()})),new L.Setting(g).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(u=>u.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async _=>{this.plugin.settings.webApiLibraryId=_.trim(),await this.plugin.saveSettings()})),new L.Setting(g).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(u=>{t(u),u.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async _=>{this.plugin.settings.webApiKey=_.trim(),await this.plugin.saveSettings()})}),g.createEl("h2",{text:"Output"}),new L.Setting(g).setName("PDF folder").addText(u=>u.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async _=>{this.plugin.settings.outputPdfDir=_.trim(),await this.plugin.saveSettings()})),new L.Setting(g).setName("Notes folder").addText(u=>u.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async _=>{this.plugin.settings.outputNoteDir=_.trim(),await this.plugin.saveSettings()})),new L.Setting(g).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(u=>{u.setValue(this.plugin.settings.frontmatterTemplate).onChange(async _=>{this.plugin.settings.frontmatterTemplate=_,await this.plugin.saveSettings()}),u.inputEl.rows=10,u.inputEl.style.width="100%"}),new L.Setting(g).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(u=>u.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async _=>{this.plugin.settings.tagSanitizeMode=_,await this.plugin.saveSettings()})),new L.Setting(g).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}} and {{docling_markdown}} placeholders.").addTextArea(u=>{u.setValue(this.plugin.settings.noteBodyTemplate).onChange(async _=>{this.plugin.settings.noteBodyTemplate=_,await this.plugin.saveSettings()}),u.inputEl.rows=8,u.inputEl.style.width="100%"}),g.createEl("h2",{text:"LLM Provider Profiles"});let o=g.createDiv({cls:"zrr-llm-profiles"}),c=()=>{o.empty();let u=e();u.length||o.createEl("p",{text:"No profiles yet. Add one below."});for(let _ of u){let k=o.createEl("details",{cls:"zrr-profile"});u.length===1&&(k.open=!0);let F=k.createEl("summary",{text:_.name||_.id||"Profile"});F.addClass("zrr-profile-title");let ne=k.createDiv({cls:"zrr-profile-body"});new L.Setting(ne).setName("Profile name").addText(Q=>Q.setPlaceholder("My provider").setValue(_.name||"").onChange(async ee=>{_.name=ee.trim(),F.textContent=_.name||_.id||"Profile",await n(e())})),new L.Setting(ne).setName("Base URL").addText(Q=>Q.setPlaceholder("http://localhost:1234/v1").setValue(_.baseUrl||"").onChange(async ee=>{_.baseUrl=ee.trim(),await n(e())})),new L.Setting(ne).setName("API key").setDesc("Stored in settings (not encrypted).").addText(Q=>{t(Q),Q.setPlaceholder("sk-...").setValue(_.apiKey||"").onChange(async ee=>{_.apiKey=ee.trim(),await n(e())})}),new L.Setting(ne).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(Q=>Q.setButtonText("Delete profile").onClick(async()=>{let ee=e().filter(oe=>oe.id!==_.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===_.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===_.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===_.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(ee),c()}))}new L.Setting(o).addButton(_=>_.setButtonText("Add profile").onClick(async()=>{let k=`profile-${Date.now().toString(36)}`,F=e().concat([{id:k,name:"Custom",baseUrl:"",apiKey:""}]);await n(F),c()}))};c(),new L.Setting(g).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(u=>u.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async _=>{this.plugin.settings.chatOutputDir=_.trim()||"zotero/chats",await this.plugin.saveSettings()})),new L.Setting(g).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(u=>u.setValue(this.plugin.settings.copyPdfToVault).onChange(async _=>{this.plugin.settings.copyPdfToVault=_,!_&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new L.Setting(g).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(u=>{let _=this.plugin.settings.copyPdfToVault;u.setValue(_?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!_).onChange(async k=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=k,await this.plugin.saveSettings()})}),new L.Setting(g).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(u=>u.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async _=>{this.plugin.settings.preferObsidianNoteForCitations=_,await this.plugin.saveSettings()})),g.createEl("h2",{text:"Docling"}),new L.Setting(g).setName("OCR mode").setDesc("auto: skip OCR when text is readable; force if bad: OCR only when text looks poor; force: always OCR.").addDropdown(u=>u.addOption("auto","auto").addOption("force_low_quality","force if quality is bad").addOption("force","force").setValue(this.plugin.settings.ocrMode).onChange(async _=>{this.plugin.settings.ocrMode=_,await this.plugin.saveSettings()})),new L.Setting(g).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(u=>{u.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async _=>{this.plugin.settings.ocrQualityThreshold=_,await this.plugin.saveSettings()})}),new L.Setting(g).setName("Chunking").setDesc("page or section").addDropdown(u=>u.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async _=>{this.plugin.settings.chunkingMode=_,await this.plugin.saveSettings()})),new L.Setting(g).setName("Section chunk max chars").setDesc("Split large section chunks into smaller pieces (section mode only).").addText(u=>u.setPlaceholder("3000").setValue(String(this.plugin.settings.maxChunkChars)).onChange(async _=>{let k=Number.parseInt(_,10);this.plugin.settings.maxChunkChars=Number.isFinite(k)?k:3e3,await this.plugin.saveSettings()})),new L.Setting(g).setName("Section chunk overlap chars").setDesc("Number of characters to overlap when splitting section chunks.").addText(u=>u.setPlaceholder("250").setValue(String(this.plugin.settings.chunkOverlapChars)).onChange(async _=>{let k=Number.parseInt(_,10);this.plugin.settings.chunkOverlapChars=Number.isFinite(k)?k:250,await this.plugin.saveSettings()})),g.createEl("h2",{text:"Automatic OCR cleanup"}),new L.Setting(g).setName("LLM cleanup for low-quality chunks").setDesc("Optional OpenAI-compatible cleanup for poor OCR. Can be slow/costly.").addToggle(u=>u.setValue(this.plugin.settings.enableLlmCleanup).onChange(async _=>{this.plugin.settings.enableLlmCleanup=_,await this.plugin.saveSettings()}));let l=null,d=null,h=null,f=async()=>{},m=async(u,_=!0)=>{let k=u.trim();this.plugin.settings.llmCleanupBaseUrl=k,_&&(this.plugin.settings.llmCleanupProviderProfileId="",l&&l.setValue("custom")),d&&d.setValue(k),await this.plugin.saveSettings()},y=async u=>{let _=e().find(k=>k.id===u);this.plugin.settings.llmCleanupProviderProfileId=u,_&&(this.plugin.settings.llmCleanupBaseUrl=_.baseUrl,this.plugin.settings.llmCleanupApiKey=_.apiKey,d==null||d.setValue(_.baseUrl),h==null||h.setValue(_.apiKey)),await this.plugin.saveSettings(),await f()};new L.Setting(g).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(u=>{l=u,u.addOption("custom","Custom (manual)");for(let k of e())u.addOption(k.id,k.name||k.id);let _=this.plugin.settings.llmCleanupProviderProfileId;u.setValue(_&&e().some(k=>k.id===_)?_:"custom"),u.onChange(async k=>{if(k==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await y(k)})}),new L.Setting(g).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(u=>{d=u,u.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async _=>{await m(_)})}),new L.Setting(g).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(u=>{h=u,t(u),u.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async _=>{this.plugin.settings.llmCleanupApiKey=_.trim(),this.plugin.settings.llmCleanupProviderProfileId="",l&&l.setValue("custom"),await this.plugin.saveSettings()})});let x=new L.Setting(g).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),b=null,P=u=>{if(!b)return;let _=(this.plugin.settings.llmCleanupModel||"").trim(),k=new Set(u.map(F=>F.value));_&&!k.has(_)&&(u=u.concat([{value:_,label:`Custom (${_})`}])),b.selectEl.options.length=0;for(let F of u)b.addOption(F.value,F.label);_&&b.setValue(_)};f=async()=>{if(b){b.setDisabled(!0);try{let u=await this.plugin.fetchCleanupModelOptions();P(u)}finally{b.setDisabled(!1)}}},x.addDropdown(u=>{b=u;let _=(this.plugin.settings.llmCleanupModel||"").trim();u.addOption(_||"loading","Loading..."),u.setValue(_||"loading"),u.onChange(async k=>{this.plugin.settings.llmCleanupModel=k.trim(),await this.plugin.saveSettings()})}),x.addButton(u=>{u.setButtonText("Refresh").onClick(async()=>{await f()})}),f(),new L.Setting(g).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(u=>u.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async _=>{let k=Number.parseFloat(_);this.plugin.settings.llmCleanupTemperature=Number.isFinite(k)?k:0,await this.plugin.saveSettings()})),new L.Setting(g).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(u=>u.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async _=>{this.plugin.settings.llmCleanupMinQuality=_,await this.plugin.saveSettings()})),new L.Setting(g).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(u=>u.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async _=>{let k=Number.parseInt(_,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(k)?k:2e3,await this.plugin.saveSettings()})),g.createEl("h2",{text:"Text Embedding"});let E=null,C=null,A=null,D=async()=>{},R=async(u,_=!0)=>{let k=u.trim();this.plugin.settings.embedBaseUrl=k,_&&(this.plugin.settings.embedProviderProfileId="",E&&E.setValue("custom")),C&&C.setValue(k),await this.plugin.saveSettings()},$=async u=>{let _=e().find(k=>k.id===u);this.plugin.settings.embedProviderProfileId=u,_&&(this.plugin.settings.embedBaseUrl=_.baseUrl,this.plugin.settings.embedApiKey=_.apiKey,C==null||C.setValue(_.baseUrl),A==null||A.setValue(_.apiKey)),await this.plugin.saveSettings(),await D()};new L.Setting(g).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(u=>{E=u,u.addOption("custom","Custom (manual)");for(let k of e())u.addOption(k.id,k.name||k.id);let _=this.plugin.settings.embedProviderProfileId;u.setValue(_&&e().some(k=>k.id===_)?_:"custom"),u.onChange(async k=>{if(k==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await $(k)})}),new L.Setting(g).setName("Embeddings base URL").addText(u=>{C=u,u.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async _=>{await R(_)})}),new L.Setting(g).setName("Embeddings API key").addText(u=>{A=u,t(u),u.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async _=>{this.plugin.settings.embedApiKey=_.trim(),this.plugin.settings.embedProviderProfileId="",E&&E.setValue("custom"),await this.plugin.saveSettings()})});let S=new L.Setting(g).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),O=null,N=u=>{if(!O)return;let _=(this.plugin.settings.embedModel||"").trim(),k=new Set(u.map(F=>F.value));_&&!k.has(_)&&(u=u.concat([{value:_,label:`Custom (${_})`}])),O.selectEl.options.length=0;for(let F of u)O.addOption(F.value,F.label);_&&O.setValue(_)};D=async()=>{if(O){O.setDisabled(!0);try{let u=await this.plugin.fetchEmbeddingModelOptions();N(u)}finally{O.setDisabled(!1)}}},S.addDropdown(u=>{O=u;let _=(this.plugin.settings.embedModel||"").trim();u.addOption(_||"loading","Loading..."),u.setValue(_||"loading"),u.onChange(async k=>{this.plugin.settings.embedModel=k.trim(),await this.plugin.saveSettings()})}),S.addButton(u=>{u.setButtonText("Refresh").onClick(async()=>{await D()})}),D(),new L.Setting(g).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(u=>u.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async _=>{this.plugin.settings.embedIncludeMetadata=_,await this.plugin.saveSettings()})),new L.Setting(g).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(u=>u.setValue(this.plugin.settings.enableChunkTagging).onChange(async _=>{this.plugin.settings.enableChunkTagging=_,await this.plugin.saveSettings()})),g.createEl("h2",{text:"Chat LLM"});let q=null,H=null,Y=null,X=async()=>{},T=async(u,_=!0)=>{let k=u.trim();this.plugin.settings.chatBaseUrl=k,_&&(this.plugin.settings.chatProviderProfileId="",q&&q.setValue("custom")),H&&H.setValue(k),await this.plugin.saveSettings()},I=async u=>{let _=e().find(k=>k.id===u);this.plugin.settings.chatProviderProfileId=u,_&&(this.plugin.settings.chatBaseUrl=_.baseUrl,this.plugin.settings.chatApiKey=_.apiKey,H==null||H.setValue(_.baseUrl),Y==null||Y.setValue(_.apiKey)),await this.plugin.saveSettings(),await X()};new L.Setting(g).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(u=>{q=u,u.addOption("custom","Custom (manual)");for(let k of e())u.addOption(k.id,k.name||k.id);let _=this.plugin.settings.chatProviderProfileId;u.setValue(_&&e().some(k=>k.id===_)?_:"custom"),u.onChange(async k=>{if(k==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await I(k)})}),new L.Setting(g).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(u=>{H=u,u.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async _=>{await T(_)})}),new L.Setting(g).setName("Chat API key").addText(u=>{Y=u,t(u),u.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async _=>{this.plugin.settings.chatApiKey=_.trim(),this.plugin.settings.chatProviderProfileId="",q&&q.setValue("custom"),await this.plugin.saveSettings()})});let B=new L.Setting(g).setName("Chat model").setDesc("Select a chat-capable model from the provider."),G=null,ae=u=>{if(!G)return;let _=(this.plugin.settings.chatModel||"").trim(),k=new Set(u.map(F=>F.value));_&&!k.has(_)&&(u=u.concat([{value:_,label:`Custom (${_})`}])),G.selectEl.options.length=0;for(let F of u)G.addOption(F.value,F.label);_&&G.setValue(_)};X=async()=>{if(G){G.setDisabled(!0);try{let u=await this.plugin.fetchChatModelOptions();ae(u)}finally{G.setDisabled(!1)}}},B.addDropdown(u=>{G=u;let _=(this.plugin.settings.chatModel||"").trim();u.addOption(_||"loading","Loading..."),u.setValue(_||"loading"),u.onChange(async k=>{this.plugin.settings.chatModel=k.trim(),await this.plugin.saveSettings()})}),B.addButton(u=>{u.setButtonText("Refresh").onClick(async()=>{await X()})}),X(),new L.Setting(g).setName("Temperature").addText(u=>u.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async _=>{let k=Number.parseFloat(_);this.plugin.settings.chatTemperature=Number.isFinite(k)?k:.2,await this.plugin.saveSettings()})),new L.Setting(g).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(u=>u.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async _=>{let k=Number.parseInt(_,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(k)?Math.max(0,k):6,await this.plugin.saveSettings()})),new L.Setting(g).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(u=>u.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async _=>{this.plugin.settings.chatPaneLocation=_,await this.plugin.saveSettings()})),g.createEl("h2",{text:"Logging"}),new L.Setting(g).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(u=>u.setValue(this.plugin.settings.enableFileLogging).onChange(async _=>{this.plugin.settings.enableFileLogging=_,await this.plugin.saveSettings()})),new L.Setting(g).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(u=>u.setPlaceholder(`${W}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async _=>{this.plugin.settings.logFilePath=_.trim()||`${W}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new L.Setting(g).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(u=>u.setButtonText("Open log").onClick(async()=>{var _,k;await((k=(_=this.plugin).openLogFile)==null?void 0:k.call(_))})).addButton(u=>u.setButtonText("Clear log").onClick(async()=>{var _,k;await((k=(_=this.plugin).clearLogFile)==null?void 0:k.call(_))})),g.createEl("h2",{text:"Maintenance"}),new L.Setting(g).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(u=>u.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new L.Setting(g).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(u=>u.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(u=>u.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}};var we={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var Fe={"docling_extract.py":`#!/usr/bin/env python3
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let t=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},1200);this.noteSyncTimers.set(e.path,t)}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=e.page_start?String(e.page_start):"",t=e.page_end?String(e.page_end):"";if(n&&(!t||n===t))return n;if(n&&t)return`${n} - ${t}`;let i=(e.pages||"").trim();if(!i)return"?";let r=i.match(/^(\d+)\s*-\s*(\d+)$/);return r?r[1]===r[2]?r[1]:`${r[1]} - ${r[2]}`:i.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i,r;if(!this.noteSyncInFlight.has(e.path)&&!this.noteSyncSuppressed.has(e.path)){this.noteSyncInFlight.add(e.path);try{let s=await this.app.vault.read(e),a=this.extractSyncSection(s);if(!a)return;let o=(n=this.extractDocIdFromFrontmatter(s))!=null?n:this.extractDocIdFromSyncMarker(s);if(!o)return;let c=this.parseSyncedChunkBlocks(a);if(!c.length)return;let l=(0,p.normalizePath)(`${Z}/${o}.json`),d=this.app.vault.adapter;if(!await d.exists(l))return;let h=await this.readChunkPayload(l);if(!h)return;let f=Array.isArray(h.chunks)?h.chunks:[],m=new Map;for(let C of f){let A=typeof(C==null?void 0:C.chunk_id)=="string"?C.chunk_id:String((t=C==null?void 0:C.chunk_id)!=null?t:"");A&&m.set(A,C)}let y=new Set,x=new Set,b=new Set,P=new Set,E=!1;for(let C of c){let A=C.chunkId;if(!A)continue;y.add(A);let D=m.get(A);if(!D){console.warn(`Sync note: chunk id not found in cache (${A})`);continue}if(C.excludeFlag){D.excluded!==!0&&(D.excluded=!0,E=!0);let S=this.normalizeChunkText(C.text);S&&S!==String((i=D.text)!=null?i:"")&&(D.text=S,D.char_count=S.length,E=!0),b.add(A);continue}if(D.excluded&&(D.excluded=!1,E=!0,x.add(A)),!C.text.trim()){b.add(A),P.add(A);continue}let R=this.normalizeChunkText(C.text);if(!R){b.add(A),P.add(A);continue}let $=typeof D.text=="string"?D.text:String((r=D.text)!=null?r:"");R!==$&&(D.text=R,D.char_count=R.length,x.add(A),E=!0)}for(let C of m.keys())y.has(C)||(b.add(C),P.add(C));if(!x.size&&!b.size&&!P.size&&!E)return;P.size&&(h.chunks=f.filter(C=>{var D;let A=typeof(C==null?void 0:C.chunk_id)=="string"?C.chunk_id:String((D=C==null?void 0:C.chunk_id)!=null?D:"");return A&&!P.has(A)}),E=!0),(E||P.size)&&await d.write(l,JSON.stringify(h,null,2)),await this.reindexChunkUpdates(o,l,Array.from(x),Array.from(b))}catch(s){console.warn("Failed to sync note edits to Redis",s)}finally{this.noteSyncInFlight.delete(e.path)}}}extractSyncSection(e){let n=de.exec(e);if(!n)return null;let t=e.slice(n.index+n[0].length),i=pe.exec(t);return i?t.slice(0,i.index):null}extractDocIdFromSyncMarker(e){var r;let n=de.exec(e);if(!n)return null;let i=((r=n[0])!=null?r:"").match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return i?i[2].trim():null}parseSyncedChunkBlocks(e){var o;let n=e.split(/\r?\n/),t=[],i="",r=!1,s=[],a=()=>{i&&(t.push({chunkId:i,text:s.join(`
`).trim(),excludeFlag:r}),i="",r=!1,s=[])};for(let c of n){let l=c.match(ue);if(l){a();let d=(o=l[1])!=null?o:"",h=d.match(/id=([\"']?)([^\"'\s]+)\1/i),f=h?h[2].trim():"";if(!f)continue;i=f,r=/\bexclude\b/i.test(d)||/\bdelete\b/i.test(d),s=[];continue}if(Pe.test(c)){a();continue}if(i){if(ye.test(c)){r=!0;continue}s.push(c)}}return a(),t}normalizeChunkText(e){return e.split(/\r?\n/).map(n=>n.replace(/\s+/g," ").trim()).filter((n,t,i)=>!(n===""&&i[t-1]==="")).join(`
`).trim()}registerSyncCommentBadges(){this.registerMarkdownPostProcessor(e=>{var c,l;let n=document.createNodeIterator(e,NodeFilter.SHOW_COMMENT),t=[],i=n.nextNode();for(;i;)i instanceof Comment&&t.push(i),i=n.nextNode();let r=t.map(d=>({comment:d,info:Ve(d.data||"")})).filter(d=>d.info!==null);if(!r.length)return;let s=r.map(d=>d.info).filter(d=>!!(d!=null&&d.pageNumber)).map(d=>d.pageNumber||0),a=s.length?Math.max(...s):0,o=null;for(let d of r){let h=d.info;if(!h)continue;h.type==="chunk-start"?o=(c=h.chunkKind)!=null?c:h.pageNumber?"page":"section":h.type==="chunk-end"&&(h.chunkKind=o!=null?o:"section",o=null);let f=He(h,a);f&&((l=d.comment.parentNode)==null||l.insertBefore(f,d.comment),d.comment.remove())}})}buildSyncedDoclingContent(e,n,t){let i=Array.isArray(n==null?void 0:n.chunks)?n==null?void 0:n.chunks:[];if(!i.length)return`<!-- zrr:sync-start doc_id=${e} -->
${t}

"use strict";var He=Object.create;var le=Object.defineProperty;var We=Object.getOwnPropertyDescriptor;var Ke=Object.getOwnPropertyNames;var Je=Object.getPrototypeOf,Ye=Object.prototype.hasOwnProperty;var Qe=(b,p)=>{for(var e in p)le(b,e,{get:p[e],enumerable:!0})},Te=(b,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of Ke(p))!Ye.call(b,t)&&t!==e&&le(b,t,{get:()=>p[t],enumerable:!(n=We(p,t))||n.enumerable});return b};var ce=(b,p,e)=>(e=b!=null?He(Je(b)):{},Te(p||!b||!b.__esModule?le(e,"default",{value:b,enumerable:!0}):e,b)),Xe=b=>Te(le({},"__esModule",{value:!0}),b);var gn={};Qe(gn,{default:()=>he});module.exports=Xe(gn);var g=require("obsidian"),ne=require("@codemirror/state"),j=require("@codemirror/view"),W=require("child_process"),G=require("fs"),je=ce(require("http")),$e=ce(require("https")),we=ce(require("net")),v=ce(require("path")),te=require("url"),pe=require("crypto");var L=require("obsidian"),H=".zotero-redisearch-rag",J=`${H}/items`,Z=`${H}/chunks`,Re={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}

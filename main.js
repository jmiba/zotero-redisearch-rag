...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",chatExportTemplatePath:"",chatExportPostCreateCommandId:"",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,llmCleanupReasoningMode:"auto",llmCleanupModeMemory:{},embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:Ee,rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${ae}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Ke=class extends L.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async m=>{this.plugin.settings.llmProviderProfiles=m,await this.plugin.saveSettings()},r=m=>{m.inputEl.type="password",m.inputEl.autocomplete="off",m.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:m=>{new L.Setting(m).setName("Prerequisites").setHeading();let x=null,w=null,E=null,R=null,v=null,C=null,N=null,O=null,q=null,U=(I,M)=>{I&&(I.settingEl.classList.toggle("is-disabled",M),I.settingEl.classList.toggle("zrr-setting-disabled",M))},B=(I,M)=>{I&&I.settingEl.classList.toggle("zrr-setting-hidden",!M)},j=()=>{let I=!!this.plugin.settings.showAdvancedPythonRuntimeOptions,M=this.plugin.settings.pythonRuntime==="local",z=I&&M;w==null||w.setDisabled(!I),U(x,!I),B(E,I),B(R,I),B(v,I),C==null||C.setDisabled(!z),N==null||N.setDisabled(!z),q==null||q.setDisabled(!z),O&&(O.disabled=!z),U(E,!z),U(R,!z),U(v,!z)};new L.Setting(m).setName("Docker/podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(I=>I.setPlaceholder("Docker").setValue(this.plugin.settings.dockerPath).onChange(async M=>{this.plugin.settings.dockerPath=M.trim()||"docker",await this.plugin.saveSettings()})),new L.Setting(m).setName("Advanced python runtime options").setDesc("Show legacy local interpreter/venv controls. Recommended to keep this disabled.").addToggle(I=>I.setValue(this.plugin.settings.showAdvancedPythonRuntimeOptions).onChange(async M=>{this.plugin.settings.showAdvancedPythonRuntimeOptions=M,!M&&this.plugin.settings.pythonRuntime==="local"&&(this.plugin.settings.pythonRuntime="worker",new L.Notice("Switched python runtime to worker mode.")),await this.plugin.saveSettings(),j()})),x=new L.Setting(m).setName("Python runtime").setDesc("Worker runtime is recommended. Enable advanced options to expose local interpreter/venv mode.").addDropdown(I=>{w=I,I.addOption("worker","Python worker container (recommended)"),I.addOption("local","Local interpreter/venv"),I.setValue(this.plugin.settings.pythonRuntime).onChange(async M=>{M!=="worker"&&M!=="local"||(this.plugin.settings.pythonRuntime=M,await this.plugin.saveSettings(),j())})}),E=new L.Setting(m).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(I=>(C=I,I.setPlaceholder("Auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async M=>{this.plugin.settings.pythonPath=M.trim(),await this.plugin.saveSettings()}))),R=new L.Setting(m).setName("Python environment").setDesc("Local mode: create or update the plugin's python env. Worker mode: managed by docker startup.").addButton(I=>{q=I,O=I.buttonEl,I.setButtonText("Create/update").setCta(),I.onClick(async()=>{I.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{I.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),v=new L.Setting(m).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(I=>{N=I,I.addOption("shared","Shared user cache"),I.addOption("plugin","Plugin folder (.venv)"),I.setValue(this.plugin.settings.pythonEnvLocation).onChange(async M=>{M!=="shared"&&M!=="plugin"||(this.plugin.settings.pythonEnvLocation=M,await this.plugin.saveSettings())})}),j(),new L.Setting(m).setName("Redis URL").addText(I=>I.setPlaceholder("Redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async M=>{this.plugin.settings.redisUrl=M.trim(),await this.plugin.saveSettings()}));let G=null,T=null,W=null,V=null,H=()=>{let I=this.plugin.settings.autoAssignRedisPort;W==null||W.setDisabled(I),V==null||V.setDisabled(I),G==null||G.settingEl.classList.toggle("is-disabled",I),T==null||T.settingEl.classList.toggle("is-disabled",I)};new L.Setting(m).setName("Auto-assign redis port").setDesc("When starting redis stack, pick a free local port and update the redis URL.").addToggle(I=>I.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async M=>{this.plugin.settings.autoAssignRedisPort=M,await this.plugin.saveSettings(),H()})),G=new L.Setting(m).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(I=>(W=I,I.setPlaceholder("~/redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async M=>{this.plugin.settings.redisDataDirOverride=M.trim(),await this.plugin.saveSettings()}))),G.settingEl.addClass("zrr-redis-override-setting"),T=new L.Setting(m).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(I=>(V=I,I.setPlaceholder("Zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async M=>{this.plugin.settings.redisProjectName=M.trim(),await this.plugin.saveSettings()}))),T.settingEl.addClass("zrr-redis-override-setting"),H(),new L.Setting(m).setName("Auto-start redis stack (docker/podman compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(I=>I.setValue(this.plugin.settings.autoStartRedis).onChange(async M=>{this.plugin.settings.autoStartRedis=M,await this.plugin.saveSettings()})),new L.Setting(m).setName("Start redis stack now").setDesc("Starts or restarts redis stack (and python worker in worker mode).").addButton(I=>I.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:m=>{new L.Setting(m).setName("Zotero local API").setHeading(),new L.Setting(m).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. HTTP://127.0.0.1:23119/API").addText(v=>v.setPlaceholder("HTTP://127.0.0.1:23119/API").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async C=>{this.plugin.settings.zoteroBaseUrl=C.trim(),await this.plugin.saveSettings()}));let x=new L.Setting(m).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),w=null,E=v=>{if(!w)return;let C=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(v.map(O=>O.value)).has(C)||(v=v.concat([{value:C,label:`Custom (${C})`}])),w.selectEl.options.length=0;for(let O of v)w.addOption(O.value,O.label);w.setValue(C)},R=async()=>{if(w){w.setDisabled(!0);try{let v=await this.plugin.fetchZoteroLibraryOptions();E(v)}finally{w.setDisabled(!1)}}};x.addDropdown(v=>{w=v;let C=(this.plugin.settings.zoteroUserId||"0").trim()||"0";v.addOption(C,"Loading..."),v.setValue(C),v.onChange(async N=>{this.plugin.settings.zoteroUserId=N.trim(),await this.plugin.saveSettings()})}),x.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await R()})}),R(),new L.Setting(m).setName("Zotero web API").setHeading(),new L.Setting(m).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(v=>v.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async C=>{this.plugin.settings.webApiBaseUrl=C.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Web API library type").setDesc("Library type for web API writes.").addDropdown(v=>v.addOption("user","User").addOption("group","Group").setValue(this.plugin.settings.webApiLibraryType).onChange(async C=>{this.plugin.settings.webApiLibraryType=C,await this.plugin.saveSettings()})),new L.Setting(m).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for web API writes.").addText(v=>v.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async C=>{this.plugin.settings.webApiLibraryId=C.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Web API key").setDesc("Zotero API key for write fallback (from Zotero.org).").addText(v=>{r(v),v.setPlaceholder("Your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async C=>{this.plugin.settings.webApiKey=C.trim(),await this.plugin.saveSettings()})}),new L.Setting(m).setName("Output").setHeading(),new L.Setting(m).setName("PDF folder").addText(v=>v.setPlaceholder("Zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async C=>{this.plugin.settings.outputPdfDir=C.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Notes folder").addText(v=>v.setPlaceholder("Zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async C=>{this.plugin.settings.outputNoteDir=C.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(v=>{v.setValue(this.plugin.settings.frontmatterTemplate).onChange(async C=>{this.plugin.settings.frontmatterTemplate=C,await this.plugin.saveSettings()}),v.inputEl.rows=10,v.inputEl.addClass("zrr-u-width-100")}),new L.Setting(m).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(v=>v.addOption("none","No change").addOption("camel","Camelcase").addOption("pascal","Pascalcase").addOption("snake","Snake_case").addOption("kebab","Kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async C=>{this.plugin.settings.tagSanitizeMode=C,await this.plugin.saveSettings()})),new L.Setting(m).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(v=>{v.setValue(this.plugin.settings.noteBodyTemplate).onChange(async C=>{this.plugin.settings.noteBodyTemplate=C,await this.plugin.saveSettings()}),v.inputEl.rows=8,v.inputEl.addClass("zrr-u-width-100")}),new L.Setting(m).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(v=>v.setPlaceholder("Zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async C=>{this.plugin.settings.chatOutputDir=C.trim()||"zotero/chats",await this.plugin.saveSettings()})),new L.Setting(m).setName("Chat export template").setDesc("Optional vault-relative template file for copied chat notes. Use {{chat_body}} to control where the transcript is inserted (otherwise template text is appended after the transcript).").addText(v=>v.setPlaceholder("Path to chat export template note").setValue(this.plugin.settings.chatExportTemplatePath).onChange(async C=>{this.plugin.settings.chatExportTemplatePath=C.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Chat export post-create command").setDesc("Optional command ID to run after the chat note is created and opened. Useful for templater workflows that need the full note body already present.").addText(v=>v.setPlaceholder("Command ID to run after note creation").setValue(this.plugin.settings.chatExportPostCreateCommandId).onChange(async C=>{this.plugin.settings.chatExportPostCreateCommandId=C.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Copy pdfs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(v=>v.setValue(this.plugin.settings.copyPdfToVault).onChange(async C=>{this.plugin.settings.copyPdfToVault=C,!C&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new L.Setting(m).setName("Create ocr-layered PDF copy").setDesc("When ocr is used, replace the vault PDF with a tesseract text layer (requires copy pdfs into vault).").addToggle(v=>{let C=this.plugin.settings.copyPdfToVault;v.setValue(C?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!C).onChange(async N=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=N,await this.plugin.saveSettings()})}),new L.Setting(m).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(v=>v.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async C=>{this.plugin.settings.preferObsidianNoteForCitations=C,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:m=>{new L.Setting(m).setName("Annotations").setHeading(),new L.Setting(m).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(R=>R.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async v=>{this.plugin.settings.annotationPageLabel=v.trim()||"Page",await this.plugin.saveSettings()})),new L.Setting(m).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(R=>R.setValue(this.plugin.settings.includeAnnotationImages).onChange(async v=>{this.plugin.settings.includeAnnotationImages=v,await this.plugin.saveSettings()})),new L.Setting(m).setName("Zotero companion").setHeading(),m.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new L.Setting(m).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(R=>R.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async v=>{this.plugin.settings.zoteroCompanionEnabled=v,await this.plugin.saveSettings()})),new L.Setting(m).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(R=>R.setPlaceholder("HTTP://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async v=>{this.plugin.settings.zoteroCompanionBaseUrl=v.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(R=>{r(R),this.companionTokenInput=R,R.setPlaceholder("Optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async v=>{this.plugin.settings.zoteroCompanionToken=v.trim(),await this.plugin.saveSettings()})}),new L.Setting(m).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero companion plugin token to this value.").addButton(R=>R.setButtonText("Generate token").onClick(async()=>{let v=(0,Zt.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=v,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(v);try{await navigator.clipboard.writeText(v),new L.Notice("Generated and copied companion token.")}catch(C){new L.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",C)}})),new L.Setting(m).setName("Annotation color map").setHeading(),m.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let x=m.createDiv({cls:"zrr-annotation-map"}),w=async R=>{this.plugin.settings.annotationColorMap=R,await this.plugin.saveSettings()},E=()=>{var q,U;x.empty();let R=this.plugin.settings.annotationColorMap||{},v=Object.entries(R);if(v.length||x.createEl("p",{text:"No color mappings configured."}),v.length){let B=x.createDiv({cls:"zrr-annotation-map-row-header"});B.createEl("span",{text:"Color"}),B.createEl("span",{text:"Heading"}),B.createEl("span",{text:"Callout"}),B.createEl("span")}for(let[B,j]of v){let T=x.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),W=T.createEl("input",{type:"text",value:B,cls:"zrr-annotation-map-input"}),V=T.createEl("input",{type:"text",value:(q=j.heading)!=null?q:"",cls:"zrr-annotation-map-input"}),H=T.createEl("input",{type:"text",value:(U=j.callout)!=null?U:"",cls:"zrr-annotation-map-input"}),I=T.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});I.type="button",W.addEventListener("change",()=>{(async()=>{let M=W.value.trim().toLowerCase();if(!M){W.value=B;return}let z={...this.plugin.settings.annotationColorMap||{}};if(M!==B&&z[M]){new L.Notice(`Annotation color '${M}' already exists.`),W.value=B;return}let F=z[B];delete z[B],z[M]=F!=null?F:{heading:"",callout:""},await w(z),E()})()}),V.addEventListener("change",()=>{(async()=>{var F;let M={...this.plugin.settings.annotationColorMap||{}},z=(F=M[B])!=null?F:{heading:"",callout:""};z.heading=V.value.trim(),M[B]=z,await w(M)})()}),H.addEventListener("change",()=>{(async()=>{var F;let M={...this.plugin.settings.annotationColorMap||{}},z=(F=M[B])!=null?F:{heading:"",callout:""};z.callout=H.value.trim(),M[B]=z,await w(M)})()}),I.addEventListener("click",()=>{(async()=>{let M={...this.plugin.settings.annotationColorMap||{}};delete M[B],await w(M),E()})()})}let C=x.createDiv({cls:"zrr-annotation-map-actions"}),N=C.createEl("button",{text:"Add mapping"});N.type="button",N.addEventListener("click",()=>{(async()=>{let B={...this.plugin.settings.annotationColorMap||{}},j="new-color",G=1;for(;B[j];)j=`new-color-${G}`,G+=1;B[j]={heading:"",callout:""},await w(B),E()})()});let O=C.createEl("button",{text:"Reset to defaults"});O.type="button",O.addEventListener("click",()=>{(async()=>(await w({...Je.annotationColorMap}),E()))()})};E()}},{id:"ocr",label:"OCR",render:m=>{new L.Setting(m).setName("Docling").setHeading();let x=null,w=C=>{if(!x)return;let N=this.plugin.settings.ocrEngine;new Set(C.map(q=>q.value)).has(N)||(C=C.concat([{value:N,label:`Current (unavailable): ${N}`}])),x.selectEl.options.length=0;for(let q of C)x.addOption(q.value,q.label);x.setValue(N)},E=async()=>{if(!x)return;x.setDisabled(!0);let C={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{C=await this.plugin.detectOcrEngines()}catch(q){C={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let N=[{value:"auto",label:"Auto (default)"}];C.tesseract&&N.push({value:"tesseract",label:"Tesseract (local)"}),C.paddleStructureLocal&&N.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),C.paddleVlLocal&&N.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(N.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),N.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),w(N),x.setDisabled(!1)},R=new L.Setting(m).setName("Paddle ocr API key").setDesc("API token for paddleocr-vl / pp-structurev3 endpoints. Get a free API key at "),v=document.createElement("a");v.href="https://aistudio.baidu.com/paddleocr",v.textContent="HTTPS://aistudio.baidu.com/paddleocr",v.target="_blank",v.rel="noopener noreferrer",R.descEl.appendChild(v),R.descEl.append("."),R.addText(C=>{r(C),C.setPlaceholder("Your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async N=>{this.plugin.settings.paddleApiKey=N.trim(),await this.plugin.saveSettings(),await E()})}),new L.Setting(m).setName("Paddleocr-vl API URL").setDesc("Optional override for the paddleocr-vl API endpoint.").addText(C=>C.setPlaceholder("HTTPS://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async N=>{this.plugin.settings.paddleVlApiUrl=N.trim(),await this.plugin.saveSettings()})),new L.Setting(m).setName("Pp-structurev3 API URL").setDesc("API endpoint for pp-structurev3 (see baidu AI studio docs).").addText(C=>C.setPlaceholder("HTTPS://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async N=>{this.plugin.settings.paddleStructureApiUrl=N.trim(),await this.plugin.saveSettings(),await E()})),new L.Setting(m).setName("Ocr engine").setDesc("Select the ocr engine to use when ocr is required.").addDropdown(C=>{x=C,C.addOption("auto","Auto (default)"),C.setValue(this.plugin.settings.ocrEngine),C.onChange(async N=>{this.plugin.settings.ocrEngine=N,await this.plugin.saveSettings()})}),new L.Setting(m).setName("Ocr decision (when to ocr)").setDesc("Controls when ocr runs; per-page behavior is configured separately below.").addDropdown(C=>C.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","Ocr only if text is poor").addOption("force","Prefer ocr for full document").setValue(this.plugin.settings.ocrMode).onChange(async N=>{this.plugin.settings.ocrMode=N,await this.plugin.saveSettings()})),new L.Setting(m).setName("Ocr layout override (per-page)").setDesc("Force per-page ocr when ocr runs, bypassing layout heuristics; can be slower for multi-column pdfs.").addToggle(C=>C.setValue(this.plugin.settings.forcePerPageOcr).onChange(async N=>{this.plugin.settings.forcePerPageOcr=N,await this.plugin.saveSettings()})),new L.Setting(m).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(C=>{C.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async N=>{this.plugin.settings.ocrQualityThreshold=N,await this.plugin.saveSettings()})}),new L.Setting(m).setName("Chunking").setDesc("Page or section").addDropdown(C=>C.addOption("page","Page").addOption("section","Section").setValue(this.plugin.settings.chunkingMode).onChange(async N=>{this.plugin.settings.chunkingMode=N,await this.plugin.saveSettings()})),E()}},{id:"llms",label:"LLMs",render:m=>{new L.Setting(m).setName("Model provider profiles").setHeading();let x=m.createDiv({cls:"zrr-llm-profiles"}),w=()=>{x.empty();let A=t();A.length||x.createEl("p",{text:"No profiles yet. Add one below."});for(let P of A){let D=x.createEl("details",{cls:"zrr-profile"});A.length===1&&(D.open=!0);let re=D.createEl("summary",{text:P.name||P.id||"Profile"});re.addClass("zrr-profile-title");let Ue=D.createDiv({cls:"zrr-profile-body"});new L.Setting(Ue).setName("Profile name").addText(fe=>fe.setPlaceholder("My provider").setValue(P.name||"").onChange(async be=>{P.name=be.trim(),re.textContent=P.name||P.id||"Profile",await n(t())})),new L.Setting(Ue).setName("Base URL").addText(fe=>fe.setPlaceholder("HTTP://localhost:1234/v1").setValue(P.baseUrl||"").onChange(async be=>{P.baseUrl=be.trim(),await n(t())})),new L.Setting(Ue).setName("API key").setDesc("Stored in settings (not encrypted).").addText(fe=>{r(fe),fe.setPlaceholder("Sk-...").setValue(P.apiKey||"").onChange(async be=>{P.apiKey=be.trim(),await n(t())})}),new L.Setting(Ue).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(fe=>fe.setButtonText("Delete profile").onClick(async()=>{let be=t().filter(xn=>xn.id!==P.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===P.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===P.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===P.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(be),w()}))}new L.Setting(x).addButton(P=>P.setButtonText("Add profile").onClick(async()=>{let D=`profile-${Date.now().toString(36)}`,re=t().concat([{id:D,name:"Custom",baseUrl:"",apiKey:""}]);await n(re),w()}))};w(),new L.Setting(m).setName("Ocr cleanup").setHeading(),new L.Setting(m).setName("Model cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor ocr at import. Can be slow/costly.").addToggle(A=>A.setValue(this.plugin.settings.enableLlmCleanup).onChange(async P=>{this.plugin.settings.enableLlmCleanup=P,await this.plugin.saveSettings()}));let E=null,R=null,v=null,C=()=>Promise.resolve(),N=async(A,P=!0)=>{let D=A.trim();this.plugin.settings.llmCleanupBaseUrl=D,P&&(this.plugin.settings.llmCleanupProviderProfileId="",E&&E.setValue("custom")),R&&R.setValue(D),await this.plugin.saveSettings()},O=async A=>{let P=t().find(D=>D.id===A);this.plugin.settings.llmCleanupProviderProfileId=A,P&&(this.plugin.settings.llmCleanupBaseUrl=P.baseUrl,this.plugin.settings.llmCleanupApiKey=P.apiKey,R==null||R.setValue(P.baseUrl),v==null||v.setValue(P.apiKey)),await this.plugin.saveSettings(),await C()};new L.Setting(m).setName("Cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{E=A,A.addOption("custom","Custom (manual)");for(let D of t())A.addOption(D.id,D.name||D.id);let P=this.plugin.settings.llmCleanupProviderProfileId;A.setValue(P&&t().some(D=>D.id===P)?P:"custom"),A.onChange(async D=>{if(D==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await O(D)})}),new L.Setting(m).setName("Cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. HTTP://127.0.0.1:1234/v1").addText(A=>{R=A,A.setPlaceholder("HTTP://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async P=>{await N(P)})}),new L.Setting(m).setName("Cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(A=>{v=A,r(A),A.setPlaceholder("Sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async P=>{this.plugin.settings.llmCleanupApiKey=P.trim(),this.plugin.settings.llmCleanupProviderProfileId="",E&&E.setValue("custom"),await this.plugin.saveSettings()})});let q=new L.Setting(m).setName("Cleanup model").setDesc("Select a cleanup-capable model from the provider."),U=null,B=A=>{if(!U)return;let P=(this.plugin.settings.llmCleanupModel||"").trim(),D=new Set(A.map(re=>re.value));P&&!D.has(P)&&(A=A.concat([{value:P,label:`Custom (${P})`}])),U.selectEl.options.length=0;for(let re of A)U.addOption(re.value,re.label);P&&U.setValue(P)};C=async()=>{if(U){U.setDisabled(!0);try{let A=await this.plugin.fetchCleanupModelOptions();B(A)}finally{U.setDisabled(!1)}}},q.addDropdown(A=>{U=A;let P=(this.plugin.settings.llmCleanupModel||"").trim();A.addOption(P||"loading","Loading..."),A.setValue(P||"loading"),A.onChange(async D=>{this.plugin.settings.llmCleanupModel=D.trim(),await this.plugin.saveSettings()})}),q.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await C()})}),C(),new L.Setting(m).setName("Cleanup temperature").setDesc("Lower is more conservative.").addText(A=>A.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async P=>{let D=Number.parseFloat(P);this.plugin.settings.llmCleanupTemperature=Number.isFinite(D)?D:0,await this.plugin.saveSettings()})),new L.Setting(m).setName("Cleanup reasoning mode").setDesc("Automatically learn the best cleanup mode for the selected provider and model, and reprobe reasoning every 30 days.").addDropdown(A=>A.addOption("auto","Automatic").addOption("on","Reasoning on").addOption("off","Reasoning off").setValue(this.plugin.settings.llmCleanupReasoningMode).onChange(async P=>{this.plugin.settings.llmCleanupReasoningMode=P==="on"||P==="off"?P:"auto",await this.plugin.saveSettings()})),new L.Setting(m).setName("Cleanup minimum quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(A=>A.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async P=>{this.plugin.settings.llmCleanupMinQuality=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Cleanup maximum chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(A=>A.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(D)?D:2e3,await this.plugin.saveSettings()})),new L.Setting(m).setName("Text embedding").setHeading();let j=null,G=null,T=null,W=()=>Promise.resolve(),V=async(A,P=!0)=>{let D=A.trim();this.plugin.settings.embedBaseUrl=D,P&&(this.plugin.settings.embedProviderProfileId="",j&&j.setValue("custom")),G&&G.setValue(D),await this.plugin.saveSettings()},H=async A=>{let P=t().find(D=>D.id===A);this.plugin.settings.embedProviderProfileId=A,P&&(this.plugin.settings.embedBaseUrl=P.baseUrl,this.plugin.settings.embedApiKey=P.apiKey,G==null||G.setValue(P.baseUrl),T==null||T.setValue(P.apiKey)),await this.plugin.saveSettings(),await W()};new L.Setting(m).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{j=A,A.addOption("custom","Custom (manual)");for(let D of t())A.addOption(D.id,D.name||D.id);let P=this.plugin.settings.embedProviderProfileId;A.setValue(P&&t().some(D=>D.id===P)?P:"custom"),A.onChange(async D=>{if(D==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await H(D)})}),new L.Setting(m).setName("Embeddings base URL").addText(A=>{G=A,A.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async P=>{await V(P)})}),new L.Setting(m).setName("Embeddings API key").addText(A=>{T=A,r(A),A.setPlaceholder("Lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async P=>{this.plugin.settings.embedApiKey=P.trim(),this.plugin.settings.embedProviderProfileId="",j&&j.setValue("custom"),await this.plugin.saveSettings()})});let I=new L.Setting(m).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),M=null,z=A=>{if(!M)return;let P=(this.plugin.settings.embedModel||"").trim(),D=new Set(A.map(re=>re.value));P&&!D.has(P)&&(A=A.concat([{value:P,label:`Custom (${P})`}])),M.selectEl.options.length=0;for(let re of A)M.addOption(re.value,re.label);P&&M.setValue(P)};W=async()=>{if(M){M.setDisabled(!0);try{let A=await this.plugin.fetchEmbeddingModelOptions();z(A)}finally{M.setDisabled(!1)}}},I.addDropdown(A=>{M=A;let P=(this.plugin.settings.embedModel||"").trim();A.addOption(P||"loading","Loading..."),A.setValue(P||"loading"),A.onChange(async D=>{this.plugin.settings.embedModel=D.trim(),await this.plugin.saveSettings()})}),I.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await W()})}),W(),new L.Setting(m).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(A=>A.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async P=>{this.plugin.settings.embedIncludeMetadata=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(A=>A.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedContextWindow=Number.isFinite(D)?Math.max(0,D):1,await this.plugin.saveSettings()})),new L.Setting(m).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(A=>A.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedContextChars=Number.isFinite(D)?Math.max(0,D):220,await this.plugin.saveSettings()})),new L.Setting(m).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(A=>A.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(D)?Math.max(0,D):3500,await this.plugin.saveSettings()})),new L.Setting(m).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(A=>A.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(D)?Math.max(0,D):200,await this.plugin.saveSettings()})),new L.Setting(m).setName("Generate model tags for chunks").setDesc("Use the ocr cleanup model to tag chunks before indexing.").addToggle(A=>A.setValue(this.plugin.settings.enableChunkTagging).onChange(async P=>{this.plugin.settings.enableChunkTagging=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Chat model").setHeading();let F=null,$=null,K=null,ne=()=>Promise.resolve(),pe=async(A,P=!0)=>{let D=A.trim();this.plugin.settings.chatBaseUrl=D,P&&(this.plugin.settings.chatProviderProfileId="",F&&F.setValue("custom")),$&&$.setValue(D),await this.plugin.saveSettings()},he=async A=>{let P=t().find(D=>D.id===A);this.plugin.settings.chatProviderProfileId=A,P&&(this.plugin.settings.chatBaseUrl=P.baseUrl,this.plugin.settings.chatApiKey=P.apiKey,$==null||$.setValue(P.baseUrl),K==null||K.setValue(P.apiKey)),await this.plugin.saveSettings(),await ne()};new L.Setting(m).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(A=>{F=A,A.addOption("custom","Custom (manual)");for(let D of t())A.addOption(D.id,D.name||D.id);let P=this.plugin.settings.chatProviderProfileId;A.setValue(P&&t().some(D=>D.id===P)?P:"custom"),A.onChange(async D=>{if(D==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await he(D)})}),new L.Setting(m).setName("Chat base URL").setDesc("Compatible endpoint for chat requests.").addText(A=>{$=A,A.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async P=>{await pe(P)})}),new L.Setting(m).setName("Chat API key").addText(A=>{K=A,r(A),A.setPlaceholder("Lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async P=>{this.plugin.settings.chatApiKey=P.trim(),this.plugin.settings.chatProviderProfileId="",F&&F.setValue("custom"),await this.plugin.saveSettings()})});let Ce=new L.Setting(m).setName("Chat model").setDesc("Select a chat-capable model from the provider."),ce=null,gt=A=>{if(!ce)return;let P=(this.plugin.settings.chatModel||"").trim(),D=new Set(A.map(re=>re.value));P&&!D.has(P)&&(A=A.concat([{value:P,label:`Custom (${P})`}])),ce.selectEl.options.length=0;for(let re of A)ce.addOption(re.value,re.label);P&&ce.setValue(P)};ne=async()=>{if(ce){ce.setDisabled(!0);try{let A=await this.plugin.fetchChatModelOptions();gt(A)}finally{ce.setDisabled(!1)}}},Ce.addDropdown(A=>{ce=A;let P=(this.plugin.settings.chatModel||"").trim();A.addOption(P||"loading","Loading..."),A.setValue(P||"loading"),A.onChange(async D=>{this.plugin.settings.chatModel=D.trim(),await this.plugin.saveSettings()})}),Ce.addButton(A=>{A.setButtonText("Refresh").onClick(async()=>{await ne()})}),ne(),new L.Setting(m).setName("Temperature").addText(A=>A.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async P=>{let D=Number.parseFloat(P);this.plugin.settings.chatTemperature=Number.isFinite(D)?D:.2,await this.plugin.saveSettings()})),new L.Setting(m).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(A=>A.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(D)?Math.max(0,D):6,await this.plugin.saveSettings()})),new L.Setting(m).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(A=>A.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async P=>{this.plugin.settings.chatPaneLocation=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Retrieval").setHeading(),new L.Setting(m).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(A=>A.setValue(this.plugin.settings.enableAgenticRag).onChange(async P=>{this.plugin.settings.enableAgenticRag=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(A=>A.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.agenticMaxIters=Number.isFinite(D)?Math.max(1,D):2,await this.plugin.saveSettings()})),new L.Setting(m).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(A=>A.setValue(this.plugin.settings.enableQueryExpansion).onChange(async P=>{this.plugin.settings.enableQueryExpansion=P,await this.plugin.saveSettings()})),new L.Setting(m).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(A=>A.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.queryExpansionCount=Number.isFinite(D)?Math.max(1,D):3,await this.plugin.saveSettings()})),new L.Setting(m).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(A=>A.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async P=>{this.plugin.settings.enableCrossEncoderRerank=P,await this.plugin.saveSettings()}));let X=new Set(Vt.map(A=>A.value)),Q=(this.plugin.settings.rerankModel||"").trim()||Ee,_e=X.has(Q)?Q:Te,se=null,St=()=>{if(!se)return;let P=!(_e===Te);se.setDisabled(P),se.inputEl.disabled=P,se.inputEl.readOnly=P,se.inputEl.classList.toggle("is-disabled",P),se.inputEl.setAttribute("aria-disabled",String(P))},Lt=new L.Setting(m).setName("Cross-encoder model").setDesc("Choose a multilingual preset, or select custom to edit the model ID.");Lt.addDropdown(A=>{for(let P of Vt)A.addOption(P.value,P.label);A.addOption(Te,"Custom"),A.setValue(_e),A.onChange(async P=>{_e=P,P!==Te?this.plugin.settings.rerankModel=P:(this.plugin.settings.rerankModel||"").trim()||(this.plugin.settings.rerankModel=Ee),await this.plugin.saveSettings(),se==null||se.setValue(this.plugin.settings.rerankModel||Ee),St()})}),Lt.addText(A=>{se=A,A.setPlaceholder(Ee).setValue(Q).onChange(async P=>{_e===Te&&(this.plugin.settings.rerankModel=P.trim()||Ee,await this.plugin.saveSettings())}),St()}),new L.Setting(m).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 n candidates before reranking.").addText(A=>A.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(D)?Math.max(1,D):4,await this.plugin.saveSettings()})),new L.Setting(m).setName("Rrf k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(A=>A.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.rrfK=Number.isFinite(D)?Math.max(1,D):60,await this.plugin.saveSettings()})),new L.Setting(m).setName("Rrf log top n").setDesc("Log the top n rrf-ranked chunks to stderr (0 disables).").addText(A=>A.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.rrfLogTop=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()})),new L.Setting(m).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(A=>A.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async P=>{let D=Number.parseInt(P,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:m=>{new L.Setting(m).setName("Python runtime").setHeading(),new L.Setting(m).setName("Use local runtime (legacy)").setDesc("Switch to local interpreter/venv mode and enable advanced runtime settings.").addButton(x=>x.setButtonText("Switch").onClick(async()=>{await this.plugin.switchPythonRuntimeToLocalLegacy()})),new L.Setting(m).setName("Logging").setHeading(),new L.Setting(m).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(x=>x.setValue(this.plugin.settings.enableFileLogging).onChange(async w=>{this.plugin.settings.enableFileLogging=w,await this.plugin.saveSettings()})),new L.Setting(m).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(x=>x.setPlaceholder(`${ae}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async w=>{this.plugin.settings.logFilePath=w.trim()||`${ae}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new L.Setting(m).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(x=>x.setButtonText("Open log").onClick(async()=>{var w,E;await((E=(w=this.plugin).openLogFile)==null?void 0:E.call(w))})).addButton(x=>x.setButtonText("Clear log").onClick(async()=>{var w,E;await((E=(w=this.plugin).clearLogFile)==null?void 0:E.call(w))})),new L.Setting(m).setName("Zotero companion plugin").setHeading(),m.createEl("p",{text:"Download the xpi, then in Zotero go to tools \u2192 add-ons \u2192 install from file and restart."}),new L.Setting(m).setName("Download companion add-on").setDesc("Downloads the companion xpi to your system downloads folder.").addButton(x=>x.setButtonText("Download xpi").onClick(async()=>{let w=this.getDefaultDownloadDir();if(!w){new L.Notice("Unable to resolve the system downloads folder.");return}let E=He.default.join(w,"zrr-companion.xpi");if(await this.companionXpiExists(E)){new L.Notice(`Companion XPI already exists: ${E}`);return}new L.Notice("Downloading companion xpi..."),await this.downloadCompanionXpi(E)})),new L.Setting(m).setName("Open Zotero").setDesc("Launch Zotero and open the add-ons window (tools \u2192 add-ons).").addButton(x=>x.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new L.Setting(m).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(x=>x.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),new L.Setting(m).setName("Redis indexing").setHeading(),new L.Setting(m).setName("Reindex redis from cached chunks").setDesc("Rebuild the redis index from cached chunk JSON files.").addButton(x=>x.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new L.Setting(m).setName("Recreate redis stack").setDesc("Pulls the configured redis image and force-recreates the redis-stack service.").addButton(x=>x.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateRedisStack()})),new L.Setting(m).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(x=>x.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(x=>x.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()})),new L.Setting(m).setName("Release notes").setHeading(),new L.Setting(m).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(x=>x.setButtonText("Show").onClick(()=>{this.plugin.openReleaseNotesModal()}))}}],p=new Map,_=new Map,g=m=>{this.activeTab=m;for(let[x,w]of p){let E=x===m;w.classList.toggle("is-active",E),w.setAttribute("aria-selected",E?"true":"false"),w.setAttribute("tabindex",E?"0":"-1")}for(let[x,w]of _){let E=x===m;w.classList.toggle("is-active",E),w.hidden=!E}},f=e.createDiv({cls:"zrr-settings-tabs"});f.setAttribute("role","tablist");let b=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let m of d){let x=f.createEl("button",{text:m.label,cls:"zrr-settings-tab-button"}),w=`zrr-settings-tab-${m.id}`,E=`zrr-settings-panel-${m.id}`;x.type="button",x.id=w,x.setAttribute("role","tab"),x.setAttribute("aria-controls",E),x.setAttribute("aria-selected","false"),x.addEventListener("click",()=>g(m.id));let R=b.createDiv({cls:"zrr-settings-tab-panel"});R.id=E,R.setAttribute("role","tabpanel"),R.setAttribute("aria-labelledby",w),R.hidden=!0,m.render(R),p.set(m.id,x),_.set(m.id,R)}let k=d.some(m=>m.id===this.activeTab)?this.activeTab:d[0].id;g(k)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?He.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await We.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await We.promises.mkdir(He.default.dirname(e),{recursive:!0});let t=await(0,L.requestUrl)({url:Nn,method:"GET"});if(t.status!==200){new L.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await We.promises.writeFile(e,n),new L.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new L.Notice("Failed to download companion xpi. See console for details."),console.warn("Failed to download companion XPI",t)}}};var Wt=require("@codemirror/state"),Ht=require("@codemirror/view"),ue=require("obsidian");var Tn=y=>{let u=y.scrollDOM.getBoundingClientRect(),e=y.posAtCoords({x:u.left+8,y:+u.height*.25});return e===null?null:y.state.doc.lineAt(e).number},De=y=>!y||typeof y!="object"?null:y,Xe=class{constructor(u,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=u,this.helpers=e}createSyncExtension(){let u=this.helpers,e=this.syncPdfSidebarForDoc.bind(this);return Ht.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=u.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=u.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var p,_;let r=this.docId;if(!r)return;let i=Tn(t);if(i===null)return;let a=u.findChunkStartLineInDoc(t.state.doc,i);if(!a)return;let s=u.parseChunkMarkerLine(a.text),o=(p=s==null?void 0:s.pageNumber)!=null?p:null,l=(_=s==null?void 0:s.chunkId)!=null?_:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||d)||(this.lastPage=o,this.lastChunkId=l,e(r,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(u={}){if(!this.pendingPdfSync||!this.isPdfSidebarLeaf(this.pdfSidebarLeaf)&&!await this.getPdfSidebarLeaf(!!u.allowCreateLeaf)||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let e=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(e.docId,e.pageNumber,e.chunkId)}async revealPdfSidebar(u={}){let e=await this.getPdfSidebarLeaf(!!u.allowCreateLeaf);if(e)try{await this.deps.app.workspace.revealLeaf(e)}catch(t){console.warn("Failed to reveal PDF sidebar leaf",t)}}updatePreviewScrollHandler(){var n;let u=this.deps.app.workspace.getActiveViewOfType(ue.MarkdownView);if(!u||u.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=u.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(u);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(u)}async syncPdfSidebarForFile(u,e={}){try{let t=await this.deps.app.vault.read(u),n=await this.deps.resolveDocIdForNote(u,t);if(!n)return;let r=this.helpers.extractFirstChunkMarkerFromContent(t);await this.syncPdfSidebarForDoc(n,r==null?void 0:r.pageNumber,r==null?void 0:r.chunkId,e)}catch(t){console.warn("Failed to sync PDF sidebar for opened note",t)}}async syncPdfSidebarForDoc(u,e,t,n={}){if(u){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:u,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let r=await this.deps.getDocIndexEntry(u);r||(r=await this.deps.hydrateDocIndexFromCache(u));let i=r!=null&&r.pdf_path?String(r.pdf_path):"";if(!i)return;let a=this.deps.toVaultRelativePath(i);if(!a){let p=(0,ue.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(p)instanceof ue.TFile&&(a=p)}if(!a)return;let s=this.deps.app.vault.getAbstractFileByPath(a);if(!(s instanceof ue.TFile)||s.extension.toLowerCase()!=="pdf")return;let o=await this.getPdfSidebarLeaf(!!n.allowCreateLeaf);if(!o){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}if(!this.isLeafTabActive(o)&&!n.allowCreateLeaf){this.pendingPdfSync={docId:u,pageNumber:e,chunkId:t};return}let l=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(l===null&&t&&(l=await this.resolvePageNumberForChunk(u,t)),l===null||this.isPdfSidebarLeaf(o)&&this.pdfSidebarLeaf===o&&this.pdfSidebarDocId===u&&this.pdfSidebarPdfPath===s.path&&this.pdfSidebarPage===l)return;let c=a,d=l!==null?`${c}#page=${l}`:c;if(await this.openPdfLinkInLeaf(o,s,d),this.pdfSidebarLeaf=o,this.pdfSidebarDocId=u,this.pdfSidebarPdfPath=s.path,this.pdfSidebarPage=l,this.updatePdfSidebarIcon(o),n.allowCreateLeaf&&!this.isLeafTabActive(o))try{await this.deps.app.workspace.revealLeaf(o)}catch(p){console.warn("Failed to reveal PDF sidebar leaf",p)}}finally{this.pdfSyncInFlight=!1;let r=this.queuedPdfSync;this.queuedPdfSync=null,r&&this.syncPdfSidebarForDoc(r.docId,r.pageNumber,r.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(u){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(u)}))}syncPdfSidebarForPreview(u){let e=this.previewScrollEl;if(!e)return;let t=u.getViewData();if(!t)return;let n=Wt.Text.of(t.split(/\r?\n/)),r=this.helpers.extractDocIdFromDoc(n);if(!r)return;let i=this.getPreviewTopLineNumber(e);if(i===null)return;let a=this.helpers.findChunkStartLineInDoc(n,i+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(r,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(u){var n;let e=u.getBoundingClientRect().top,t=u.querySelectorAll("[data-line]");for(let r of Array.from(t))if(r.getBoundingClientRect().bottom>=e+2){let a=(n=r.getAttribute("data-line"))!=null?n:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(u=!1){if(this.pdfSidebarLeaf&&this.isUsableRightSidebarLeaf(this.pdfSidebarLeaf)&&this.isPdfSidebarLeaf(this.pdfSidebarLeaf))return this.pdfSidebarLeaf;this.resetPdfSidebarLeaf();let e=this.findRightSidebarPdfLeaf();if(e)return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;if(u){let t=this.deps.app.workspace;if(typeof t.ensureSideLeaf=="function")try{let r=await t.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!1});if(this.isUsableRightSidebarLeaf(r))return this.pdfSidebarLeaf=r,r.isDeferred&&await r.loadIfDeferred(),this.updatePdfSidebarIcon(r),r}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let n=this.deps.app.workspace.getRightLeaf(!1);if(this.isUsableRightSidebarLeaf(n))return this.pdfSidebarLeaf=n,n}return null}findRightSidebarPdfLeaf(){let u=this.deps.app.workspace;if(typeof u.iterateAllLeaves!="function")return null;let e=null;return u.iterateAllLeaves(t=>{if(!(!this.isUsableRightSidebarLeaf(t)||!this.isPdfSidebarLeaf(t))){if(this.isLeafTabActive(t)){e=t;return}e||(e=t)}}),e}resetPdfSidebarLeaf(){this.pdfSidebarLeaf=null,this.pdfSidebarDocId=null,this.pdfSidebarPdfPath=null,this.pdfSidebarPage=null}isUsableRightSidebarLeaf(u){var t;return this.isRightSidebarLeaf(u)?!!((t=u.containerEl)!=null&&t.isConnected):!1}getLeafViewType(u){var t,n;if(!u)return"";try{let r=u.getViewState();if(typeof(r==null?void 0:r.type)=="string"&&r.type)return r.type}catch(r){console.debug("Failed to read leaf view state",r)}let e=(n=(t=u.view)==null?void 0:t.getViewType)==null?void 0:n.call(t);return typeof e=="string"?e:""}isPdfSidebarLeaf(u){return this.getLeafViewType(u)==="pdf"}isRightSidebarLeaf(u){if(!u)return!1;let t=u.containerEl;return t?!!t.closest(".workspace-split.mod-right-split, .mod-right-split"):!1}updatePdfSidebarIcon(u){if(!u||!this.isRightSidebarLeaf(u)||!this.isPdfSidebarLeaf(u))return;let t=u.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let r=u;if(r.tabHeaderEl&&n.push(...Array.from(r.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),r.tabHeaderInnerIconEl&&n.push(r.tabHeaderInnerIconEl),n.length===0)return;let i=new Set;for(let s of n)if(!i.has(s)){if(i.add(s),s.replaceChildren(),(0,ue.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg){let o=document.createRange().createContextualFragment(this.deps.iconSvg);s.replaceChildren(o)}s.dataset&&(s.dataset.zrrIcon="zrr-pdf")}let a=u.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(u,e,t){var l;if(!await this.ensurePdfLeafReady(u,e)){await u.openFile(e,{active:!1});return}let r=De((l=this.getPluginsRegistry())==null?void 0:l["pdf-plus"]),i=De(r==null?void 0:r.lib),a=De(i==null?void 0:i.workspace),s=typeof(a==null?void 0:a.openPDFLinkTextInLeaf)=="function"?a.openPDFLinkTextInLeaf:null;if(typeof s=="function")try{await s.call(a,u,t,"",{active:!1});return}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150)}let o=u;if(typeof o.openLinkText=="function"){try{await o.openLinkText(t,"",{active:!1})}catch(c){if(!this.isPdfAnnotationRaceError(c))throw c;await this.delay(150),await o.openLinkText(t,"",{active:!1})}return}await u.openFile(e,{active:!1})}async ensurePdfLeafReady(u,e){if(this.isPdfSidebarLeaf(u))return!0;try{await u.setViewState({type:"pdf",active:!1})}catch(t){console.debug("Failed to set PDF view state on sidebar leaf",t)}if(u.isDeferred)try{await u.loadIfDeferred()}catch(t){console.debug("Failed to load deferred PDF sidebar leaf",t)}if(this.isPdfSidebarLeaf(u))return!0;try{await u.openFile(e,{active:!1})}catch(t){return console.warn("Failed to open PDF file in sidebar leaf",t),!1}return this.isPdfSidebarLeaf(u)}isPdfAnnotationRaceError(u){let e=u instanceof Error?u.message:typeof u=="string"?u:"";return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(u){return new Promise(e=>setTimeout(e,u))}getPluginsRegistry(){var e;return(e=this.deps.app.plugins)==null?void 0:e.plugins}isLeafTabActive(u){var r;let e=u;if((r=e.parent)!=null&&r.activeLeaf)return e.parent.activeLeaf===u;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(u,e){var l,c,d,p,_;if(!u||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,u)||e,n=this.chunkPageCache.get(u);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let r=(0,ue.normalizePath)(`${Y}/${u}.json`);if(!await this.deps.app.vault.adapter.exists(r))return null;let a=De(await this.deps.readChunkPayload(r)),s=Array.isArray(a==null?void 0:a.chunks)?a.chunks:[],o=new Map;for(let g of s){let f=De(g),b=typeof(f==null?void 0:f.chunk_id)=="string"?f.chunk_id.trim():"";if(!b)continue;let k=Number.isFinite((c=f==null?void 0:f.page_start)!=null?c:NaN)?Number(f==null?void 0:f.page_start):null,m=Number.isFinite((d=f==null?void 0:f.page_end)!=null?d:NaN)?Number(f==null?void 0:f.page_end):null,x=k!=null?k:m;x!==null&&(o.set(b,x),o.set(`${u}:${b}`,x))}return this.chunkPageCache.set(u,o),(_=(p=o.get(t))!=null?p:o.get(e))!=null?_:null}};var Qe={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">

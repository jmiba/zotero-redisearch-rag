"use strict";var le=Object.create;var Z=Object.defineProperty;var ce=Object.getOwnPropertyDescriptor;var de=Object.getOwnPropertyNames;var pe=Object.getPrototypeOf,ue=Object.prototype.hasOwnProperty;var ge=(S,p)=>{for(var e in p)Z(S,e,{get:p[e],enumerable:!0})},ee=(S,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of de(p))!ue.call(S,t)&&t!==e&&Z(S,t,{get:()=>p[t],enumerable:!(n=ce(p,t))||n.enumerable});return S};var V=(S,p,e)=>(e=S!=null?le(pe(S)):{},ee(p||!S||!S.__esModule?Z(e,"default",{value:S,enumerable:!0}):e,S)),he=S=>ee(Z({},"__esModule",{value:!0}),S);var _e={};ge(_e,{default:()=>G});module.exports=he(_e);var c=require("obsidian"),M=require("child_process"),I=require("fs"),se=V(require("http")),re=V(require("https")),y=V(require("path")),F=require("url"),oe=require("crypto");var b=require("obsidian"),T=".zotero-redisearch-rag",R=`${T}/items`,z=`${T}/chunks`,ne={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}

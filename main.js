"use strict";var gn=Object.create;var qe=Object.defineProperty;var hn=Object.getOwnPropertyDescriptor;var fn=Object.getOwnPropertyNames;var mn=Object.getPrototypeOf,yn=Object.prototype.hasOwnProperty;var bn=(f,_)=>{for(var e in _)qe(f,e,{get:_[e],enumerable:!0})},Et=(f,_,e,t)=>{if(_&&typeof _=="object"||typeof _=="function")for(let n of fn(_))!yn.call(f,n)&&n!==e&&qe(f,n,{get:()=>_[n],enumerable:!(t=hn(_,n))||t.enumerable});return f};var fe=(f,_,e)=>(e=f!=null?gn(mn(f)):{},Et(_||!f||!f.__esModule?qe(e,"default",{value:f,enumerable:!0}):e,f)),xn=f=>Et(qe({},"__esModule",{value:!0}),f);var Gn={};bn(Gn,{default:()=>lt});module.exports=xn(Gn);var m=require("obsidian");var Ot=require("@codemirror/state"),ie=require("@codemirror/view"),It=require("obsidian");var me=/<!--\s*zrr:sync-start[^>]*-->/i,xe=/<!--\s*zrr:sync-end\s*-->/i,ge=/<!--\s*zrr:chunk\b([^>]*)-->/i,je=/<!--\s*zrr:chunk\s+end\s*-->/i,Ee=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,Rt=f=>{let _=f.trim();if(!_.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(_)){let u=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:u?u[2]:void 0}}if(/^zrr:sync-end\b/i.test(_))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(_)){let u=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),g=_.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:u?u[2]:void 0,attachmentKey:g?g[2]:void 0}}if(/^zrr:annotations-end\b/i.test(_))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(_))return{type:"chunk-end"};let e=_.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let t=e[1]||"",n=t.match(/\bid=(["']?)([^"'\s]+)\1/i),r=n?n[2]:"",i=t.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=i?null:t.match(/\(\s*(\d+)\s*\)/),s=i?Number.parseInt(i[2],10):a?Number.parseInt(a[1],10):void 0,o=r.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(t)||/\bdelete\b/i.test(t),p=/\bsection\b/i.test(t);return{type:"chunk-start",chunkId:r||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:p?"section":c?"page":"section"}},pt=f=>{var l;if(!f)return null;let _=f.match(ge);if(!_)return null;let e=_[1]||"",t=e.match(/\bid=(["']?)([^"'\s]+)\1/i),n=t?t[2].trim():void 0,r=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),i=r?null:e.match(/\(\s*(\d+)\s*\)/),a=r?Number.parseInt(r[2],10):i?Number.parseInt(i[1],10):void 0,s=n&&(l=wn(n))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:n,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},$e=f=>{for(let _=1;_<=f.lines;_+=1){let e=f.line(_).text;if(me.test(e)){let t=e.match(/doc_id=(["']?)([^"'\s]+)\1/i);return t?t[2].trim():null}}return null},ut=(f,_)=>{let e=_;for(;e>=1;e-=1){let t=f.line(e).text;if(ge.test(t))return{line:e,text:t};if(me.test(t)||xe.test(t))break}return null},kn=(f,_)=>{for(let e=_;e<=f.lines;e+=1){let t=f.line(e).text;if(je.test(t))return e;if(xe.test(t))break}return null},St=(f,_)=>{let e=ut(f,_);if(!e)return null;let t=kn(f,e.line+1);return t===null||_<e.line||_>t?null:{startLine:e.line,endLine:t,text:e.text}},Nt=(f,_,e)=>{if(_>e)return!1;for(let t=_;t<=e;t+=1){let n=f.line(t).text;if(Ee.test(n))return!0}return!1},wn=f=>{var n;if(!f)return null;let e=(f.includes(":")&&(n=f.split(":").pop())!=null?n:f).match(/^p(\d+)$/i);if(!e)return null;let t=Number.parseInt(e[1],10);return Number.isFinite(t)?t:null};var Lt=f=>{if(!f)return null;let _=f.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return _?pt(_[0]):null};var vn=(f,_)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),f.type==="sync-start"||f.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(f.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),f.type==="sync-start"?e.textContent=f.docId?`Redis Index Sync start - ${f.docId}`:"Redis Index Sync start":e.textContent="Redis index sync end",e;if(f.type==="annotations-start"||f.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),f.type==="annotations-start"){let t=f.docId?` - ${f.docId}`:"";e.textContent=`Zotero annotations start${t}`}else e.textContent="Zotero annotations end";return e}if(f.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=f.chunkKind==="page"?"Page end":"Section end",f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),e;if(f.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),f.chunkKind&&e.classList.add(`zrr-sync-badge--${f.chunkKind}`),f.excluded&&e.classList.add("is-excluded"),f.pageNumber&&_>0)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber}/${_})`}else e.textContent=`Page ${f.pageNumber}/${_}`;else if(f.pageNumber)if(f.chunkKind==="section"){let t=f.chunkId?`Section ${f.chunkId}`:"Section";e.textContent=`${t} (p${f.pageNumber})`}else e.textContent=`Page ${f.pageNumber}`;else f.chunkId?e.textContent=`Section ${f.chunkId}`:e.textContent="Section";return f.excluded&&(e.textContent=`${e.textContent} - excluded`),e},_t=class extends ie.WidgetType{constructor(_,e,t,n,r){super(),this.plugin=_,this.docId=e,this.chunkId=t,this.startLine=n,this.excluded=r}eq(_){return this.docId===_.docId&&this.chunkId===_.chunkId&&this.startLine===_.startLine&&this.excluded===_.excluded}toDOM(){let _=document.createElement("span");_.className="zrr-chunk-toolbar",_.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},t=(c,d,p)=>{let u=document.createElement("span");u.className="zrr-chunk-button-icon",(0,It.setIcon)(u,d);let g=document.createElement("span");g.className="zrr-chunk-button-label",g.textContent=p,c.appendChild(u),c.appendChild(g)},n=document.createElement("button");n.type="button",n.className="zrr-chunk-button",t(n,"sparkles","Clean"),e(n,"Clean this chunk with the OCR cleanup model"),n.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),_.appendChild(n);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",t(r,"tag","Tags"),e(r,"Edit chunk tags"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),_.appendChild(r);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",t(i,"search","Indexed"),e(i,"Preview indexed chunk text"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),_.appendChild(i);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",t(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),_.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return t(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),_.appendChild(s),_}ignoreEvent(){return!0}},Tt=(f,_)=>{var y;let e=f.state.doc,t=$e(e);if(!t)return ie.Decoration.none;let n=f.state.selection.main.head,r=e.lineAt(n).number,i=St(e,r);if(!i)return ie.Decoration.none;let a=i.text.match(ge);if(!a)return ie.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return ie.Decoration.none;let l=o[2].trim();if(!l)return ie.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=Nt(e,i.startLine+1,i.endLine-1),p=c||d,u=e.line(i.startLine),g=ie.Decoration.widget({widget:new _t(_,t,l,i.startLine,p),side:1});return ie.Decoration.set([g.range(u.to)])},gt=class extends ie.WidgetType{constructor(_,e){super(),this.info=_,this.totalPages=e}toDOM(){var _;return(_=vn(this.info,this.totalPages))!=null?_:document.createElement("span")}},Dt=f=>{var o,l;let _=f.dom.closest(".markdown-source-view");if(!_||!_.classList.contains("is-live-preview"))return ie.Decoration.none;let e=f.state.doc,t=new Ot.RangeSetBuilder,n=[],r=[],i=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),p=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!p)continue;let u=Rt(p[1]);u&&(u.type==="chunk-start"?(u.chunkKind=(o=u.chunkKind)!=null?o:u.pageNumber?"page":"section",u.pageNumber&&(i=!0),u.chunkKind==="section"&&(a=!0)):u.type==="chunk-end"&&(u.chunkKind=(l=u.chunkKind)!=null?l:"section"),n.push({line:c,from:d.from,to:d.to,info:u}),u.pageNumber&&r.push(u.pageNumber))}if(!n.length)return ie.Decoration.none;if(i&&!a)for(let c of n)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=r.length?Math.max(...r):0;for(let c of n){let d=ie.Decoration.replace({widget:new gt(c.info,s)});t.add(c.from,c.to,d)}return t.finish()},Ft=()=>ie.ViewPlugin.fromClass(class{constructor(f){this.decorations=Dt(f)}update(f){(f.docChanged||f.viewportChanged)&&(this.decorations=Dt(f.view))}},{decorations:f=>f.decorations}),Mt=f=>ie.ViewPlugin.fromClass(class{constructor(_){this.decorations=Tt(_,f)}update(_){(_.docChanged||_.selectionSet||_.viewportChanged)&&(this.decorations=Tt(_.view,f))}},{decorations:_=>_.decorations});var oe=require("child_process"),Q=require("fs"),vt=fe(require("http")),pn=fe(require("https")),Oe=fe(require("net")),Ie=fe(require("os")),un=fe(require("tls")),R=fe(require("path")),Pt=require("url"),Fe=require("crypto");var N=require("obsidian"),qt=require("crypto"),Ve=require("fs"),Ue=fe(require("path")),re=".zotero-redisearch-rag",le=`${re}/items`,te=`${re}/chunks`,jt=`${re}/metadata_snapshots.json`,$t=`${re}/annotation_snapshots.json`,Pn="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",ke="cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",Re="__custom__",zt=[{value:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",label:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1 (Fast multilingual)"},{value:"BAAI/bge-reranker-v2-m3",label:"BAAI/bge-reranker-v2-m3 (Best quality, heaviest)"},{value:"jinaai/jina-reranker-v2-base-multilingual",label:"jinaai/jina-reranker-v2-base-multilingual (Balanced multilingual)"}],Be={pythonRuntime:"worker",pythonRuntimeMigrationV1Done:!1,showAdvancedPythonRuntimeOptions:!1,pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,firstContainerStartupNoticeShown:!1,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:ke,rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${re}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Ze=class extends N.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async h=>{this.plugin.settings.llmProviderProfiles=h,await this.plugin.saveSettings()},r=h=>{h.inputEl.type="password",h.inputEl.autocomplete="off",h.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:h=>{new N.Setting(h).setName("Prerequisites").setHeading();let b=null,w=null,v=null,E=null,C=null,S=null,T=null,I=null,L=null,q=(M,j)=>{M&&(M.settingEl.classList.toggle("is-disabled",j),M.settingEl.classList.toggle("zrr-setting-disabled",j))},F=(M,j)=>{M&&M.settingEl.classList.toggle("zrr-setting-hidden",!j)},z=()=>{let M=!!this.plugin.settings.showAdvancedPythonRuntimeOptions,j=this.plugin.settings.pythonRuntime==="local",K=M&&j;w==null||w.setDisabled(!M),q(b,!M),F(v,M),F(E,M),F(C,M),S==null||S.setDisabled(!K),T==null||T.setDisabled(!K),L==null||L.setDisabled(!K),I&&(I.disabled=!K),q(v,!K),q(E,!K),q(C,!K)};new N.Setting(h).setName("Docker/podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(M=>M.setPlaceholder("Docker").setValue(this.plugin.settings.dockerPath).onChange(async j=>{this.plugin.settings.dockerPath=j.trim()||"docker",await this.plugin.saveSettings()})),new N.Setting(h).setName("Advanced python runtime options").setDesc("Show legacy local interpreter/venv controls. Recommended to keep this disabled.").addToggle(M=>M.setValue(this.plugin.settings.showAdvancedPythonRuntimeOptions).onChange(async j=>{this.plugin.settings.showAdvancedPythonRuntimeOptions=j,!j&&this.plugin.settings.pythonRuntime==="local"&&(this.plugin.settings.pythonRuntime="worker",new N.Notice("Switched python runtime to worker mode.")),await this.plugin.saveSettings(),z()})),b=new N.Setting(h).setName("Python runtime").setDesc("Worker runtime is recommended. Enable advanced options to expose local interpreter/venv mode.").addDropdown(M=>{w=M,M.addOption("worker","Python worker container (recommended)"),M.addOption("local","Local interpreter/venv"),M.setValue(this.plugin.settings.pythonRuntime).onChange(async j=>{j!=="worker"&&j!=="local"||(this.plugin.settings.pythonRuntime=j,await this.plugin.saveSettings(),z())})}),v=new N.Setting(h).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(M=>(S=M,M.setPlaceholder("Auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async j=>{this.plugin.settings.pythonPath=j.trim(),await this.plugin.saveSettings()}))),E=new N.Setting(h).setName("Python environment").setDesc("Local mode: create or update the plugin's python env. Worker mode: managed by docker startup.").addButton(M=>{L=M,I=M.buttonEl,M.setButtonText("Create/update").setCta(),M.onClick(async()=>{M.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{M.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),C=new N.Setting(h).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(M=>{T=M,M.addOption("shared","Shared user cache"),M.addOption("plugin","Plugin folder (.venv)"),M.setValue(this.plugin.settings.pythonEnvLocation).onChange(async j=>{j!=="shared"&&j!=="plugin"||(this.plugin.settings.pythonEnvLocation=j,await this.plugin.saveSettings())})}),z(),new N.Setting(h).setName("Redis URL").addText(M=>M.setPlaceholder("Redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async j=>{this.plugin.settings.redisUrl=j.trim(),await this.plugin.saveSettings()}));let $=null,O=null,Z=null,V=null,B=()=>{let M=this.plugin.settings.autoAssignRedisPort;Z==null||Z.setDisabled(M),V==null||V.setDisabled(M),$==null||$.settingEl.classList.toggle("is-disabled",M),O==null||O.settingEl.classList.toggle("is-disabled",M)};new N.Setting(h).setName("Auto-assign redis port").setDesc("When starting redis stack, pick a free local port and update the redis URL.").addToggle(M=>M.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async j=>{this.plugin.settings.autoAssignRedisPort=j,await this.plugin.saveSettings(),B()})),$=new N.Setting(h).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(M=>(Z=M,M.setPlaceholder("~/redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async j=>{this.plugin.settings.redisDataDirOverride=j.trim(),await this.plugin.saveSettings()}))),$.settingEl.addClass("zrr-redis-override-setting"),O=new N.Setting(h).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(M=>(V=M,M.setPlaceholder("Zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async j=>{this.plugin.settings.redisProjectName=j.trim(),await this.plugin.saveSettings()}))),O.settingEl.addClass("zrr-redis-override-setting"),B(),new N.Setting(h).setName("Auto-start redis stack (docker/podman compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(M=>M.setValue(this.plugin.settings.autoStartRedis).onChange(async j=>{this.plugin.settings.autoStartRedis=j,await this.plugin.saveSettings()})),new N.Setting(h).setName("Start redis stack now").setDesc("Starts or restarts redis stack (and python worker in worker mode).").addButton(M=>M.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:h=>{new N.Setting(h).setName("Zotero local API").setHeading(),new N.Setting(h).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. HTTP://127.0.0.1:23119/API").addText(C=>C.setPlaceholder("HTTP://127.0.0.1:23119/API").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async S=>{this.plugin.settings.zoteroBaseUrl=S.trim(),await this.plugin.saveSettings()}));let b=new N.Setting(h).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),w=null,v=C=>{if(!w)return;let S=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(C.map(I=>I.value)).has(S)||(C=C.concat([{value:S,label:`Custom (${S})`}])),w.selectEl.options.length=0;for(let I of C)w.addOption(I.value,I.label);w.setValue(S)},E=async()=>{if(w){w.setDisabled(!0);try{let C=await this.plugin.fetchZoteroLibraryOptions();v(C)}finally{w.setDisabled(!1)}}};b.addDropdown(C=>{w=C;let S=(this.plugin.settings.zoteroUserId||"0").trim()||"0";C.addOption(S,"Loading..."),C.setValue(S),C.onChange(async T=>{this.plugin.settings.zoteroUserId=T.trim(),await this.plugin.saveSettings()})}),b.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await E()})}),E(),new N.Setting(h).setName("Zotero web API").setHeading(),new N.Setting(h).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(C=>C.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async S=>{this.plugin.settings.webApiBaseUrl=S.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API library type").setDesc("Library type for web API writes.").addDropdown(C=>C.addOption("user","User").addOption("group","Group").setValue(this.plugin.settings.webApiLibraryType).onChange(async S=>{this.plugin.settings.webApiLibraryType=S,await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for web API writes.").addText(C=>C.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async S=>{this.plugin.settings.webApiLibraryId=S.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Web API key").setDesc("Zotero API key for write fallback (from Zotero.org).").addText(C=>{r(C),C.setPlaceholder("Your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async S=>{this.plugin.settings.webApiKey=S.trim(),await this.plugin.saveSettings()})}),new N.Setting(h).setName("Output").setHeading(),new N.Setting(h).setName("PDF folder").addText(C=>C.setPlaceholder("Zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async S=>{this.plugin.settings.outputPdfDir=S.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Notes folder").addText(C=>C.setPlaceholder("Zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async S=>{this.plugin.settings.outputNoteDir=S.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(C=>{C.setValue(this.plugin.settings.frontmatterTemplate).onChange(async S=>{this.plugin.settings.frontmatterTemplate=S,await this.plugin.saveSettings()}),C.inputEl.rows=10,C.inputEl.addClass("zrr-u-width-100")}),new N.Setting(h).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(C=>C.addOption("none","No change").addOption("camel","Camelcase").addOption("pascal","Pascalcase").addOption("snake","Snake_case").addOption("kebab","Kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async S=>{this.plugin.settings.tagSanitizeMode=S,await this.plugin.saveSettings()})),new N.Setting(h).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(C=>{C.setValue(this.plugin.settings.noteBodyTemplate).onChange(async S=>{this.plugin.settings.noteBodyTemplate=S,await this.plugin.saveSettings()}),C.inputEl.rows=8,C.inputEl.addClass("zrr-u-width-100")}),new N.Setting(h).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(C=>C.setPlaceholder("Zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async S=>{this.plugin.settings.chatOutputDir=S.trim()||"zotero/chats",await this.plugin.saveSettings()})),new N.Setting(h).setName("Copy pdfs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(C=>C.setValue(this.plugin.settings.copyPdfToVault).onChange(async S=>{this.plugin.settings.copyPdfToVault=S,!S&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new N.Setting(h).setName("Create ocr-layered PDF copy").setDesc("When ocr is used, replace the vault PDF with a tesseract text layer (requires copy pdfs into vault).").addToggle(C=>{let S=this.plugin.settings.copyPdfToVault;C.setValue(S?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!S).onChange(async T=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=T,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(C=>C.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async S=>{this.plugin.settings.preferObsidianNoteForCitations=S,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:h=>{new N.Setting(h).setName("Annotations").setHeading(),new N.Setting(h).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(E=>E.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async C=>{this.plugin.settings.annotationPageLabel=C.trim()||"Page",await this.plugin.saveSettings()})),new N.Setting(h).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(E=>E.setValue(this.plugin.settings.includeAnnotationImages).onChange(async C=>{this.plugin.settings.includeAnnotationImages=C,await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion").setHeading(),h.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new N.Setting(h).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(E=>E.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async C=>{this.plugin.settings.zoteroCompanionEnabled=C,await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(E=>E.setPlaceholder("HTTP://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async C=>{this.plugin.settings.zoteroCompanionBaseUrl=C.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(E=>{r(E),this.companionTokenInput=E,E.setPlaceholder("Optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async C=>{this.plugin.settings.zoteroCompanionToken=C.trim(),await this.plugin.saveSettings()})}),new N.Setting(h).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero companion plugin token to this value.").addButton(E=>E.setButtonText("Generate token").onClick(async()=>{let C=(0,qt.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=C,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(C);try{await navigator.clipboard.writeText(C),new N.Notice("Generated and copied companion token.")}catch(S){new N.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",S)}})),new N.Setting(h).setName("Annotation color map").setHeading(),h.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let b=h.createDiv({cls:"zrr-annotation-map"}),w=async E=>{this.plugin.settings.annotationColorMap=E,await this.plugin.saveSettings()},v=()=>{var L,q;b.empty();let E=this.plugin.settings.annotationColorMap||{},C=Object.entries(E);if(C.length||b.createEl("p",{text:"No color mappings configured."}),C.length){let F=b.createDiv({cls:"zrr-annotation-map-row-header"});F.createEl("span",{text:"Color"}),F.createEl("span",{text:"Heading"}),F.createEl("span",{text:"Callout"}),F.createEl("span")}for(let[F,z]of C){let O=b.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),Z=O.createEl("input",{type:"text",value:F,cls:"zrr-annotation-map-input"}),V=O.createEl("input",{type:"text",value:(L=z.heading)!=null?L:"",cls:"zrr-annotation-map-input"}),B=O.createEl("input",{type:"text",value:(q=z.callout)!=null?q:"",cls:"zrr-annotation-map-input"}),M=O.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});M.type="button",Z.addEventListener("change",()=>{(async()=>{let j=Z.value.trim().toLowerCase();if(!j){Z.value=F;return}let K={...this.plugin.settings.annotationColorMap||{}};if(j!==F&&K[j]){new N.Notice(`Annotation color '${j}' already exists.`),Z.value=F;return}let U=K[F];delete K[F],K[j]=U!=null?U:{heading:"",callout:""},await w(K),v()})()}),V.addEventListener("change",()=>{(async()=>{var U;let j={...this.plugin.settings.annotationColorMap||{}},K=(U=j[F])!=null?U:{heading:"",callout:""};K.heading=V.value.trim(),j[F]=K,await w(j)})()}),B.addEventListener("change",()=>{(async()=>{var U;let j={...this.plugin.settings.annotationColorMap||{}},K=(U=j[F])!=null?U:{heading:"",callout:""};K.callout=B.value.trim(),j[F]=K,await w(j)})()}),M.addEventListener("click",()=>{(async()=>{let j={...this.plugin.settings.annotationColorMap||{}};delete j[F],await w(j),v()})()})}let S=b.createDiv({cls:"zrr-annotation-map-actions"}),T=S.createEl("button",{text:"Add mapping"});T.type="button",T.addEventListener("click",()=>{(async()=>{let F={...this.plugin.settings.annotationColorMap||{}},z="new-color",$=1;for(;F[z];)z=`new-color-${$}`,$+=1;F[z]={heading:"",callout:""},await w(F),v()})()});let I=S.createEl("button",{text:"Reset to defaults"});I.type="button",I.addEventListener("click",()=>{(async()=>(await w({...Be.annotationColorMap}),v()))()})};v()}},{id:"ocr",label:"OCR",render:h=>{new N.Setting(h).setName("Docling").setHeading();let b=null,w=S=>{if(!b)return;let T=this.plugin.settings.ocrEngine;new Set(S.map(L=>L.value)).has(T)||(S=S.concat([{value:T,label:`Current (unavailable): ${T}`}])),b.selectEl.options.length=0;for(let L of S)b.addOption(L.value,L.label);b.setValue(T)},v=async()=>{if(!b)return;b.setDisabled(!0);let S={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{S=await this.plugin.detectOcrEngines()}catch(L){S={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let T=[{value:"auto",label:"Auto (default)"}];S.tesseract&&T.push({value:"tesseract",label:"Tesseract (local)"}),S.paddleStructureLocal&&T.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),S.paddleVlLocal&&T.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(T.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),T.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),w(T),b.setDisabled(!1)},E=new N.Setting(h).setName("Paddle ocr API key").setDesc("API token for paddleocr-vl / pp-structurev3 endpoints. Get a free API key at "),C=document.createElement("a");C.href="https://aistudio.baidu.com/paddleocr",C.textContent="HTTPS://aistudio.baidu.com/paddleocr",C.target="_blank",C.rel="noopener noreferrer",E.descEl.appendChild(C),E.descEl.append("."),E.addText(S=>{r(S),S.setPlaceholder("Your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async T=>{this.plugin.settings.paddleApiKey=T.trim(),await this.plugin.saveSettings(),await v()})}),new N.Setting(h).setName("Paddleocr-vl API URL").setDesc("Optional override for the paddleocr-vl API endpoint.").addText(S=>S.setPlaceholder("HTTPS://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async T=>{this.plugin.settings.paddleVlApiUrl=T.trim(),await this.plugin.saveSettings()})),new N.Setting(h).setName("Pp-structurev3 API URL").setDesc("API endpoint for pp-structurev3 (see baidu AI studio docs).").addText(S=>S.setPlaceholder("HTTPS://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async T=>{this.plugin.settings.paddleStructureApiUrl=T.trim(),await this.plugin.saveSettings(),await v()})),new N.Setting(h).setName("Ocr engine").setDesc("Select the ocr engine to use when ocr is required.").addDropdown(S=>{b=S,S.addOption("auto","Auto (default)"),S.setValue(this.plugin.settings.ocrEngine),S.onChange(async T=>{this.plugin.settings.ocrEngine=T,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Ocr decision (when to ocr)").setDesc("Controls when ocr runs; per-page behavior is configured separately below.").addDropdown(S=>S.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","Ocr only if text is poor").addOption("force","Prefer ocr for full document").setValue(this.plugin.settings.ocrMode).onChange(async T=>{this.plugin.settings.ocrMode=T,await this.plugin.saveSettings()})),new N.Setting(h).setName("Ocr layout override (per-page)").setDesc("Force per-page ocr when ocr runs, bypassing layout heuristics; can be slower for multi-column pdfs.").addToggle(S=>S.setValue(this.plugin.settings.forcePerPageOcr).onChange(async T=>{this.plugin.settings.forcePerPageOcr=T,await this.plugin.saveSettings()})),new N.Setting(h).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(S=>{S.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async T=>{this.plugin.settings.ocrQualityThreshold=T,await this.plugin.saveSettings()})}),new N.Setting(h).setName("Chunking").setDesc("Page or section").addDropdown(S=>S.addOption("page","Page").addOption("section","Section").setValue(this.plugin.settings.chunkingMode).onChange(async T=>{this.plugin.settings.chunkingMode=T,await this.plugin.saveSettings()})),v()}},{id:"llms",label:"LLMs",render:h=>{new N.Setting(h).setName("Model provider profiles").setHeading();let b=h.createDiv({cls:"zrr-llm-profiles"}),w=()=>{b.empty();let P=t();P.length||b.createEl("p",{text:"No profiles yet. Add one below."});for(let A of P){let D=b.createEl("details",{cls:"zrr-profile"});P.length===1&&(D.open=!0);let ne=D.createEl("summary",{text:A.name||A.id||"Profile"});ne.addClass("zrr-profile-title");let ze=D.createDiv({cls:"zrr-profile-body"});new N.Setting(ze).setName("Profile name").addText(_e=>_e.setPlaceholder("My provider").setValue(A.name||"").onChange(async he=>{A.name=he.trim(),ne.textContent=A.name||A.id||"Profile",await n(t())})),new N.Setting(ze).setName("Base URL").addText(_e=>_e.setPlaceholder("HTTP://localhost:1234/v1").setValue(A.baseUrl||"").onChange(async he=>{A.baseUrl=he.trim(),await n(t())})),new N.Setting(ze).setName("API key").setDesc("Stored in settings (not encrypted).").addText(_e=>{r(_e),_e.setPlaceholder("Sk-...").setValue(A.apiKey||"").onChange(async he=>{A.apiKey=he.trim(),await n(t())})}),new N.Setting(ze).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(_e=>_e.setButtonText("Delete profile").onClick(async()=>{let he=t().filter(_n=>_n.id!==A.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===A.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===A.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===A.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(he),w()}))}new N.Setting(b).addButton(A=>A.setButtonText("Add profile").onClick(async()=>{let D=`profile-${Date.now().toString(36)}`,ne=t().concat([{id:D,name:"Custom",baseUrl:"",apiKey:""}]);await n(ne),w()}))};w(),new N.Setting(h).setName("Ocr cleanup").setHeading(),new N.Setting(h).setName("Model cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor ocr at import. Can be slow/costly.").addToggle(P=>P.setValue(this.plugin.settings.enableLlmCleanup).onChange(async A=>{this.plugin.settings.enableLlmCleanup=A,await this.plugin.saveSettings()}));let v=null,E=null,C=null,S=()=>Promise.resolve(),T=async(P,A=!0)=>{let D=P.trim();this.plugin.settings.llmCleanupBaseUrl=D,A&&(this.plugin.settings.llmCleanupProviderProfileId="",v&&v.setValue("custom")),E&&E.setValue(D),await this.plugin.saveSettings()},I=async P=>{let A=t().find(D=>D.id===P);this.plugin.settings.llmCleanupProviderProfileId=P,A&&(this.plugin.settings.llmCleanupBaseUrl=A.baseUrl,this.plugin.settings.llmCleanupApiKey=A.apiKey,E==null||E.setValue(A.baseUrl),C==null||C.setValue(A.apiKey)),await this.plugin.saveSettings(),await S()};new N.Setting(h).setName("Cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{v=P,P.addOption("custom","Custom (manual)");for(let D of t())P.addOption(D.id,D.name||D.id);let A=this.plugin.settings.llmCleanupProviderProfileId;P.setValue(A&&t().some(D=>D.id===A)?A:"custom"),P.onChange(async D=>{if(D==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await I(D)})}),new N.Setting(h).setName("Cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. HTTP://127.0.0.1:1234/v1").addText(P=>{E=P,P.setPlaceholder("HTTP://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async A=>{await T(A)})}),new N.Setting(h).setName("Cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(P=>{C=P,r(P),P.setPlaceholder("Sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async A=>{this.plugin.settings.llmCleanupApiKey=A.trim(),this.plugin.settings.llmCleanupProviderProfileId="",v&&v.setValue("custom"),await this.plugin.saveSettings()})});let L=new N.Setting(h).setName("Cleanup model").setDesc("Select a cleanup-capable model from the provider."),q=null,F=P=>{if(!q)return;let A=(this.plugin.settings.llmCleanupModel||"").trim(),D=new Set(P.map(ne=>ne.value));A&&!D.has(A)&&(P=P.concat([{value:A,label:`Custom (${A})`}])),q.selectEl.options.length=0;for(let ne of P)q.addOption(ne.value,ne.label);A&&q.setValue(A)};S=async()=>{if(q){q.setDisabled(!0);try{let P=await this.plugin.fetchCleanupModelOptions();F(P)}finally{q.setDisabled(!1)}}},L.addDropdown(P=>{q=P;let A=(this.plugin.settings.llmCleanupModel||"").trim();P.addOption(A||"loading","Loading..."),P.setValue(A||"loading"),P.onChange(async D=>{this.plugin.settings.llmCleanupModel=D.trim(),await this.plugin.saveSettings()})}),L.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),new N.Setting(h).setName("Cleanup temperature").setDesc("Lower is more conservative.").addText(P=>P.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async A=>{let D=Number.parseFloat(A);this.plugin.settings.llmCleanupTemperature=Number.isFinite(D)?D:0,await this.plugin.saveSettings()})),new N.Setting(h).setName("Cleanup minimum quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(P=>P.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async A=>{this.plugin.settings.llmCleanupMinQuality=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Cleanup maximum chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(P=>P.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(D)?D:2e3,await this.plugin.saveSettings()})),new N.Setting(h).setName("Text embedding").setHeading();let z=null,$=null,O=null,Z=()=>Promise.resolve(),V=async(P,A=!0)=>{let D=P.trim();this.plugin.settings.embedBaseUrl=D,A&&(this.plugin.settings.embedProviderProfileId="",z&&z.setValue("custom")),$&&$.setValue(D),await this.plugin.saveSettings()},B=async P=>{let A=t().find(D=>D.id===P);this.plugin.settings.embedProviderProfileId=P,A&&(this.plugin.settings.embedBaseUrl=A.baseUrl,this.plugin.settings.embedApiKey=A.apiKey,$==null||$.setValue(A.baseUrl),O==null||O.setValue(A.apiKey)),await this.plugin.saveSettings(),await Z()};new N.Setting(h).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{z=P,P.addOption("custom","Custom (manual)");for(let D of t())P.addOption(D.id,D.name||D.id);let A=this.plugin.settings.embedProviderProfileId;P.setValue(A&&t().some(D=>D.id===A)?A:"custom"),P.onChange(async D=>{if(D==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await B(D)})}),new N.Setting(h).setName("Embeddings base URL").addText(P=>{$=P,P.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async A=>{await V(A)})}),new N.Setting(h).setName("Embeddings API key").addText(P=>{O=P,r(P),P.setPlaceholder("Lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async A=>{this.plugin.settings.embedApiKey=A.trim(),this.plugin.settings.embedProviderProfileId="",z&&z.setValue("custom"),await this.plugin.saveSettings()})});let M=new N.Setting(h).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),j=null,K=P=>{if(!j)return;let A=(this.plugin.settings.embedModel||"").trim(),D=new Set(P.map(ne=>ne.value));A&&!D.has(A)&&(P=P.concat([{value:A,label:`Custom (${A})`}])),j.selectEl.options.length=0;for(let ne of P)j.addOption(ne.value,ne.label);A&&j.setValue(A)};Z=async()=>{if(j){j.setDisabled(!0);try{let P=await this.plugin.fetchEmbeddingModelOptions();K(P)}finally{j.setDisabled(!1)}}},M.addDropdown(P=>{j=P;let A=(this.plugin.settings.embedModel||"").trim();P.addOption(A||"loading","Loading..."),P.setValue(A||"loading"),P.onChange(async D=>{this.plugin.settings.embedModel=D.trim(),await this.plugin.saveSettings()})}),M.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await Z()})}),Z(),new N.Setting(h).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(P=>P.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async A=>{this.plugin.settings.embedIncludeMetadata=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(P=>P.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedContextWindow=Number.isFinite(D)?Math.max(0,D):1,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(P=>P.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedContextChars=Number.isFinite(D)?Math.max(0,D):220,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(P=>P.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(D)?Math.max(0,D):3500,await this.plugin.saveSettings()})),new N.Setting(h).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(P=>P.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(D)?Math.max(0,D):200,await this.plugin.saveSettings()})),new N.Setting(h).setName("Generate model tags for chunks").setDesc("Use the ocr cleanup model to tag chunks before indexing.").addToggle(P=>P.setValue(this.plugin.settings.enableChunkTagging).onChange(async A=>{this.plugin.settings.enableChunkTagging=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat model").setHeading();let U=null,G=null,H=null,se=()=>Promise.resolve(),Ae=async(P,A=!0)=>{let D=P.trim();this.plugin.settings.chatBaseUrl=D,A&&(this.plugin.settings.chatProviderProfileId="",U&&U.setValue("custom")),G&&G.setValue(D),await this.plugin.saveSettings()},ct=async P=>{let A=t().find(D=>D.id===P);this.plugin.settings.chatProviderProfileId=P,A&&(this.plugin.settings.chatBaseUrl=A.baseUrl,this.plugin.settings.chatApiKey=A.apiKey,G==null||G.setValue(A.baseUrl),H==null||H.setValue(A.apiKey)),await this.plugin.saveSettings(),await se()};new N.Setting(h).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(P=>{U=P,P.addOption("custom","Custom (manual)");for(let D of t())P.addOption(D.id,D.name||D.id);let A=this.plugin.settings.chatProviderProfileId;P.setValue(A&&t().some(D=>D.id===A)?A:"custom"),P.onChange(async D=>{if(D==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await ct(D)})}),new N.Setting(h).setName("Chat base URL").setDesc("Compatible endpoint for chat requests.").addText(P=>{G=P,P.setPlaceholder("HTTP://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async A=>{await Ae(A)})}),new N.Setting(h).setName("Chat API key").addText(P=>{H=P,r(P),P.setPlaceholder("Lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async A=>{this.plugin.settings.chatApiKey=A.trim(),this.plugin.settings.chatProviderProfileId="",U&&U.setValue("custom"),await this.plugin.saveSettings()})});let Me=new N.Setting(h).setName("Chat model").setDesc("Select a chat-capable model from the provider."),ce=null,dt=P=>{if(!ce)return;let A=(this.plugin.settings.chatModel||"").trim(),D=new Set(P.map(ne=>ne.value));A&&!D.has(A)&&(P=P.concat([{value:A,label:`Custom (${A})`}])),ce.selectEl.options.length=0;for(let ne of P)ce.addOption(ne.value,ne.label);A&&ce.setValue(A)};se=async()=>{if(ce){ce.setDisabled(!0);try{let P=await this.plugin.fetchChatModelOptions();dt(P)}finally{ce.setDisabled(!1)}}},Me.addDropdown(P=>{ce=P;let A=(this.plugin.settings.chatModel||"").trim();P.addOption(A||"loading","Loading..."),P.setValue(A||"loading"),P.onChange(async D=>{this.plugin.settings.chatModel=D.trim(),await this.plugin.saveSettings()})}),Me.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await se()})}),se(),new N.Setting(h).setName("Temperature").addText(P=>P.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async A=>{let D=Number.parseFloat(A);this.plugin.settings.chatTemperature=Number.isFinite(D)?D:.2,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(P=>P.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(D)?Math.max(0,D):6,await this.plugin.saveSettings()})),new N.Setting(h).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(P=>P.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async A=>{this.plugin.settings.chatPaneLocation=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Retrieval").setHeading(),new N.Setting(h).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(P=>P.setValue(this.plugin.settings.enableAgenticRag).onChange(async A=>{this.plugin.settings.enableAgenticRag=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(P=>P.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.agenticMaxIters=Number.isFinite(D)?Math.max(1,D):2,await this.plugin.saveSettings()})),new N.Setting(h).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(P=>P.setValue(this.plugin.settings.enableQueryExpansion).onChange(async A=>{this.plugin.settings.enableQueryExpansion=A,await this.plugin.saveSettings()})),new N.Setting(h).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(P=>P.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.queryExpansionCount=Number.isFinite(D)?Math.max(1,D):3,await this.plugin.saveSettings()})),new N.Setting(h).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(P=>P.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async A=>{this.plugin.settings.enableCrossEncoderRerank=A,await this.plugin.saveSettings()}));let X=new Set(zt.map(P=>P.value)),Y=(this.plugin.settings.rerankModel||"").trim()||ke,ue=X.has(Y)?Y:Re,ae=null,Ct=()=>{if(!ae)return;let A=!(ue===Re);ae.setDisabled(A),ae.inputEl.disabled=A,ae.inputEl.readOnly=A,ae.inputEl.classList.toggle("is-disabled",A),ae.inputEl.setAttribute("aria-disabled",String(A))},At=new N.Setting(h).setName("Cross-encoder model").setDesc("Choose a multilingual preset, or select custom to edit the model ID.");At.addDropdown(P=>{for(let A of zt)P.addOption(A.value,A.label);P.addOption(Re,"Custom"),P.setValue(ue),P.onChange(async A=>{ue=A,A!==Re?this.plugin.settings.rerankModel=A:(this.plugin.settings.rerankModel||"").trim()||(this.plugin.settings.rerankModel=ke),await this.plugin.saveSettings(),ae==null||ae.setValue(this.plugin.settings.rerankModel||ke),Ct()})}),At.addText(P=>{ae=P,P.setPlaceholder(ke).setValue(Y).onChange(async A=>{ue===Re&&(this.plugin.settings.rerankModel=A.trim()||ke,await this.plugin.saveSettings())}),Ct()}),new N.Setting(h).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 n candidates before reranking.").addText(P=>P.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(D)?Math.max(1,D):4,await this.plugin.saveSettings()})),new N.Setting(h).setName("Rrf k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(P=>P.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rrfK=Number.isFinite(D)?Math.max(1,D):60,await this.plugin.saveSettings()})),new N.Setting(h).setName("Rrf log top n").setDesc("Log the top n rrf-ranked chunks to stderr (0 disables).").addText(P=>P.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rrfLogTop=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()})),new N.Setting(h).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(P=>P.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:h=>{new N.Setting(h).setName("Python runtime").setHeading(),new N.Setting(h).setName("Use local runtime (legacy)").setDesc("Switch to local interpreter/venv mode and enable advanced runtime settings.").addButton(b=>b.setButtonText("Switch").onClick(async()=>{await this.plugin.switchPythonRuntimeToLocalLegacy()})),new N.Setting(h).setName("Logging").setHeading(),new N.Setting(h).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(b=>b.setValue(this.plugin.settings.enableFileLogging).onChange(async w=>{this.plugin.settings.enableFileLogging=w,await this.plugin.saveSettings()})),new N.Setting(h).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(b=>b.setPlaceholder(`${re}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async w=>{this.plugin.settings.logFilePath=w.trim()||`${re}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new N.Setting(h).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(b=>b.setButtonText("Open log").onClick(async()=>{var w,v;await((v=(w=this.plugin).openLogFile)==null?void 0:v.call(w))})).addButton(b=>b.setButtonText("Clear log").onClick(async()=>{var w,v;await((v=(w=this.plugin).clearLogFile)==null?void 0:v.call(w))})),new N.Setting(h).setName("Zotero companion plugin").setHeading(),h.createEl("p",{text:"Download the xpi, then in Zotero go to tools \u2192 add-ons \u2192 install from file and restart."}),new N.Setting(h).setName("Download companion add-on").setDesc("Downloads the companion xpi to your system downloads folder.").addButton(b=>b.setButtonText("Download xpi").onClick(async()=>{let w=this.getDefaultDownloadDir();if(!w){new N.Notice("Unable to resolve the system downloads folder.");return}let v=Ue.default.join(w,"zrr-companion.xpi");if(await this.companionXpiExists(v)){new N.Notice(`Companion XPI already exists: ${v}`);return}new N.Notice("Downloading companion xpi..."),await this.downloadCompanionXpi(v)})),new N.Setting(h).setName("Open Zotero").setDesc("Launch Zotero and open the add-ons window (tools \u2192 add-ons).").addButton(b=>b.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new N.Setting(h).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(b=>b.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),new N.Setting(h).setName("Redis indexing").setHeading(),new N.Setting(h).setName("Reindex redis from cached chunks").setDesc("Rebuild the redis index from cached chunk JSON files.").addButton(b=>b.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new N.Setting(h).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(b=>b.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(b=>b.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()})),new N.Setting(h).setName("Release notes").setHeading(),new N.Setting(h).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(b=>b.setButtonText("Show").onClick(()=>{this.plugin.openReleaseNotesModal()}))}}],p=new Map,u=new Map,g=h=>{this.activeTab=h;for(let[b,w]of p){let v=b===h;w.classList.toggle("is-active",v),w.setAttribute("aria-selected",v?"true":"false"),w.setAttribute("tabindex",v?"0":"-1")}for(let[b,w]of u){let v=b===h;w.classList.toggle("is-active",v),w.hidden=!v}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let x=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let h of d){let b=y.createEl("button",{text:h.label,cls:"zrr-settings-tab-button"}),w=`zrr-settings-tab-${h.id}`,v=`zrr-settings-panel-${h.id}`;b.type="button",b.id=w,b.setAttribute("role","tab"),b.setAttribute("aria-controls",v),b.setAttribute("aria-selected","false"),b.addEventListener("click",()=>g(h.id));let E=x.createDiv({cls:"zrr-settings-tab-panel"});E.id=v,E.setAttribute("role","tabpanel"),E.setAttribute("aria-labelledby",w),E.hidden=!0,h.render(E),p.set(h.id,b),u.set(h.id,E)}let k=d.some(h=>h.id===this.activeTab)?this.activeTab:d[0].id;g(k)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Ue.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await Ve.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await Ve.promises.mkdir(Ue.default.dirname(e),{recursive:!0});let t=await(0,N.requestUrl)({url:Pn,method:"GET"});if(t.status!==200){new N.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await Ve.promises.writeFile(e,n),new N.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new N.Notice("Failed to download companion xpi. See console for details."),console.warn("Failed to download companion XPI",t)}}};var Vt=require("@codemirror/state"),Ut=require("@codemirror/view"),pe=require("obsidian");var Cn=f=>{let _=f.scrollDOM.getBoundingClientRect(),e=f.posAtCoords({x:_.left+8,y:+_.height*.25});return e===null?null:f.state.doc.lineAt(e).number},Se=f=>!f||typeof f!="object"?null:f,Ge=class{constructor(_,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=_,this.helpers=e}createSyncExtension(){let _=this.helpers,e=this.syncPdfSidebarForDoc.bind(this);return Ut.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=_.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=_.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var p,u;let r=this.docId;if(!r)return;let i=Cn(t);if(i===null)return;let a=_.findChunkStartLineInDoc(t.state.doc,i);if(!a)return;let s=_.parseChunkMarkerLine(a.text),o=(p=s==null?void 0:s.pageNumber)!=null?p:null,l=(u=s==null?void 0:s.chunkId)!=null?u:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||d)||(this.lastPage=o,this.lastChunkId=l,e(r,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,t;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((t=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:t.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let _=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(_.docId,_.pageNumber,_.chunkId)}updatePreviewScrollHandler(){var n;let _=this.deps.app.workspace.getActiveViewOfType(pe.MarkdownView);if(!_||_.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=_.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(_);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(_)}async syncPdfSidebarForFile(_){try{let e=await this.deps.app.vault.read(_),t=await this.deps.resolveDocIdForNote(_,e);if(!t)return;let n=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(t,n==null?void 0:n.pageNumber,n==null?void 0:n.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(_,e,t){if(_){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:_,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let n=await this.deps.getDocIndexEntry(_);n||(n=await this.deps.hydrateDocIndexFromCache(_));let r=n!=null&&n.pdf_path?String(n.pdf_path):"";if(!r)return;let i=this.deps.toVaultRelativePath(r);if(!i){let d=(0,pe.normalizePath)(r);this.deps.app.vault.getAbstractFileByPath(d)instanceof pe.TFile&&(i=d)}if(!i)return;let a=this.deps.app.vault.getAbstractFileByPath(i);if(!(a instanceof pe.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:t};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:t};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&t&&(o=await this.resolvePageNumberForChunk(_,t)),o===null||this.pdfSidebarDocId===_&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=_,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=i,c=o!==null?`${l}#page=${o}`:l;await this.openPdfLinkInLeaf(s,c),this.updatePdfSidebarIcon(s)}finally{this.pdfSyncInFlight=!1;let n=this.queuedPdfSync;this.queuedPdfSync=null,n&&this.syncPdfSidebarForDoc(n.docId,n.pageNumber,n.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(_){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(_)}))}syncPdfSidebarForPreview(_){let e=this.previewScrollEl;if(!e)return;let t=_.getViewData();if(!t)return;let n=Vt.Text.of(t.split(/\r?\n/)),r=this.helpers.extractDocIdFromDoc(n);if(!r)return;let i=this.getPreviewTopLineNumber(e);if(i===null)return;let a=this.helpers.findChunkStartLineInDoc(n,i+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(r,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(_){var n;let e=_.getBoundingClientRect().top,t=_.querySelectorAll("[data-line]");for(let r of Array.from(t))if(r.getBoundingClientRect().bottom>=e+2){let a=(n=r.getAttribute("data-line"))!=null?n:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var n,r;if(this.pdfSidebarLeaf&&((r=(n=this.pdfSidebarLeaf.view)==null?void 0:n.getViewType)==null?void 0:r.call(n))==="pdf")return this.pdfSidebarLeaf;let _=this.deps.app.workspace;if(typeof _.ensureSideLeaf=="function")try{let i=await _.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.pdfSidebarLeaf=i,this.updatePdfSidebarIcon(i),i}catch(i){console.warn("Failed to ensure PDF side leaf",i)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e)return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let t=this.deps.app.workspace.getRightLeaf(!0);return t?(this.pdfSidebarLeaf=t,this.updatePdfSidebarIcon(t),t):null}isRightSidebarLeaf(_){if(!_)return!1;let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&e===_)return!0;let n=_.containerEl;return n?!!n.closest(".workspace-split.mod-right-split, .mod-right-split"):!0}updatePdfSidebarIcon(_){if(!_||!this.isRightSidebarLeaf(_))return;let t=_.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let r=_;if(r.tabHeaderEl&&n.push(...Array.from(r.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),r.tabHeaderInnerIconEl&&n.push(r.tabHeaderInnerIconEl),n.length===0)return;let i=new Set;for(let s of n)if(!i.has(s)){if(i.add(s),s.replaceChildren(),(0,pe.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg){let o=document.createRange().createContextualFragment(this.deps.iconSvg);s.replaceChildren(o)}s.dataset&&(s.dataset.zrrIcon="zrr-pdf")}let a=_.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(_,e){var s;let t=Se((s=this.getPluginsRegistry())==null?void 0:s["pdf-plus"]),n=Se(t==null?void 0:t.lib),r=Se(n==null?void 0:n.workspace),i=typeof(r==null?void 0:r.openPDFLinkTextInLeaf)=="function"?r.openPDFLinkTextInLeaf:null;if(typeof i=="function")try{await i.call(r,_,e,"",{active:!1});return}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150)}let a=_;if(typeof a.openLinkText=="function"){try{await a.openLinkText(e,"",{active:!1})}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150),await a.openLinkText(e,"",{active:!1})}return}await this.deps.app.workspace.openLinkText(e,"",!1)}isPdfAnnotationRaceError(_){let e=_ instanceof Error?_.message:typeof _=="string"?_:"";return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(_){return new Promise(e=>setTimeout(e,_))}getPluginsRegistry(){var e;return(e=this.deps.app.plugins)==null?void 0:e.plugins}isLeafTabActive(_){var r;let e=_;if((r=e.parent)!=null&&r.activeLeaf)return e.parent.activeLeaf===_;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(_,e){var l,c,d,p,u;if(!_||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,_)||e,n=this.chunkPageCache.get(_);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let r=(0,pe.normalizePath)(`${te}/${_}.json`);if(!await this.deps.app.vault.adapter.exists(r))return null;let a=Se(await this.deps.readChunkPayload(r)),s=Array.isArray(a==null?void 0:a.chunks)?a.chunks:[],o=new Map;for(let g of s){let y=Se(g),x=typeof(y==null?void 0:y.chunk_id)=="string"?y.chunk_id.trim():"";if(!x)continue;let k=Number.isFinite((c=y==null?void 0:y.page_start)!=null?c:NaN)?Number(y==null?void 0:y.page_start):null,h=Number.isFinite((d=y==null?void 0:y.page_end)!=null?d:NaN)?Number(y==null?void 0:y.page_end):null,b=k!=null?k:h;b!==null&&(o.set(x,b),o.set(`${_}:${x}`,b))}return this.chunkPageCache.set(_,o),(u=(p=o.get(t))!=null?p:o.get(e))!=null?u:null}};var We={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.10
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.10
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.10
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.10
...
`).trim()}getBundledReleaseNotesEntries(){var r,i;let e=new Set,t=Array.isArray(wt)?wt:[],n=[];for(let a of t){let s=this.normalizeReleaseVersion(String((r=a==null?void 0:a.version)!=null?r:"")),o=this.sanitizeReleaseNotesMarkdown(String((i=a==null?void 0:a.markdown)!=null?i:""));!s||e.has(s)||(e.add(s),n.push({version:s,markdown:o}))}return n.sort((a,s)=>this.compareReleaseVersions(s.version,a.version))}getReleaseNotesMarkdown(e,t){let n=this.normalizeReleaseVersion(e);if(!n)return"";let r=this.normalizeReleaseVersion(t||""),i=this.getBundledReleaseNotesEntries(),a=i.filter(o=>this.compareReleaseVersions(o.version,n)>0?!1:r?this.compareReleaseVersions(o.version,r)>0:o.version===n),s=a.length?a:i.filter(o=>o.version===n);if(!s.length)return"This version includes improvements and fixes.";if(s.length===1){let o=s[0],l=this.stripLeadingVersionHeading(this.sanitizeReleaseNotesMarkdown(String(o.markdown||"")),o.version);return`### v${o.version}

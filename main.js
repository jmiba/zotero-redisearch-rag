"use strict";var le=Object.create;var Z=Object.defineProperty;var ce=Object.getOwnPropertyDescriptor;var de=Object.getOwnPropertyNames;var pe=Object.getPrototypeOf,ue=Object.prototype.hasOwnProperty;var ge=(C,p)=>{for(var e in p)Z(C,e,{get:p[e],enumerable:!0})},ee=(C,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of de(p))!ue.call(C,t)&&t!==e&&Z(C,t,{get:()=>p[t],enumerable:!(n=ce(p,t))||n.enumerable});return C};var H=(C,p,e)=>(e=C!=null?le(pe(C)):{},ee(p||!C||!C.__esModule?Z(e,"default",{value:C,enumerable:!0}):e,C)),he=C=>ee(Z({},"__esModule",{value:!0}),C);var _e={};ge(_e,{default:()=>G});module.exports=he(_e);var c=require("obsidian"),M=require("child_process"),I=require("fs"),se=H(require("http")),re=H(require("https")),y=H(require("path")),F=require("url"),oe=require("crypto");var b=require("obsidian"),N=".zotero-redisearch-rag",R=`${N}/items`,T=`${N}/chunks`,ne={zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",pythonPath:"python3",dockerPath:"docker",autoStartRedis:!1,copyPdfToVault:!0,frontmatterTemplate:`doc_id: {{doc_id}}

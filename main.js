"use strict";var $n=Object.create;var Le=Object.defineProperty;var Gn=Object.getOwnPropertyDescriptor;var Vn=Object.getOwnPropertyNames;var Un=Object.getPrototypeOf,Bn=Object.prototype.hasOwnProperty;var Zn=(u,p)=>{for(var e in p)Le(u,e,{get:p[e],enumerable:!0})},rn=(u,p,e,n)=>{if(p&&typeof p=="object"||typeof p=="function")for(let t of Vn(p))!Bn.call(u,t)&&t!==e&&Le(u,t,{get:()=>p[t],enumerable:!(n=Gn(p,t))||n.enumerable});return u};var ge=(u,p,e)=>(e=u!=null?$n(Un(u)):{},rn(p||!u||!u.__esModule?Le(e,"default",{value:u,enumerable:!0}):e,u)),Hn=u=>rn(Le({},"__esModule",{value:!0}),u);var at={};Zn(at,{default:()=>Be});module.exports=Hn(at);var g=require("obsidian");var pn=require("@codemirror/state"),W=require("@codemirror/view"),un=require("obsidian");var de=/<!--\s*zrr:sync-start[^>]*-->/i,fe=/<!--\s*zrr:sync-end\s*-->/i,ae=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ae=/<!--\s*zrr:chunk\s+end\s*-->/i,xe=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,sn=u=>{let p=u.trim();if(!p.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(p)){let c=p.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:c?c[2]:void 0}}if(/^zrr:sync-end\b/i.test(p))return{type:"sync-end"};if(/^zrr:chunk\s+end\b/i.test(p))return{type:"chunk-end"};let e=p.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let n=e[1]||"",t=n.match(/\bid=(["']?)([^"'\s]+)\1/i),i=t?t[2]:"",r=n.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?Number.parseInt(r[2],10):void 0,s=i.match(/^p(\d+)$/i),o=s?Number.parseInt(s[1],10):void 0,l=Number.isFinite(a!=null?a:NaN)?a:o,d=/\bexclude\b/i.test(n)||/\bdelete\b/i.test(n);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(l!=null?l:NaN)?l:void 0,chunkKind:l?"page":"section"}},We=u=>{var o;if(!u)return null;let p=u.match(ae);if(!p)return null;let e=p[1]||"",n=e.match(/\bid=(["']?)([^"'\s]+)\1/i),t=n?n[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?Number.parseInt(i[2],10):void 0,a=t&&(o=Kn(t))!=null?o:void 0,s=Number.isFinite(r!=null?r:NaN)?r:a;return{chunkId:t,pageNumber:Number.isFinite(s!=null?s:NaN)?Number(s):void 0}},Ee=u=>{for(let p=1;p<=u.lines;p+=1){let e=u.line(p).text;if(de.test(e)){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return n?n[2].trim():null}}return null},Ke=(u,p)=>{let e=p;for(;e>=1;e-=1){let n=u.line(e).text;if(ae.test(n))return{line:e,text:n};if(de.test(n)||fe.test(n))break}return null},Wn=(u,p)=>{for(let e=p;e<=u.lines;e+=1){let n=u.line(e).text;if(Ae.test(n))return e;if(fe.test(n))break}return null},an=(u,p)=>{let e=Ke(u,p);if(!e)return null;let n=Wn(u,e.line+1);return n===null||p<e.line||p>n?null:{startLine:e.line,endLine:n,text:e.text}},on=(u,p,e)=>{if(p>e)return!1;for(let n=p;n<=e;n+=1){let t=u.line(n).text;if(xe.test(t))return!0}return!1},Kn=u=>{var t;if(!u)return null;let e=(u.includes(":")&&(t=u.split(":").pop())!=null?t:u).match(/^p(\d+)$/i);if(!e)return null;let n=Number.parseInt(e[1],10);return Number.isFinite(n)?n:null};var ln=u=>{if(!u)return null;let p=u.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return p?We(p[0]):null};var Jn=(u,p)=>{let e=document.createElement("div");return e.classList.add("zrr-sync-badge"),u.type==="sync-start"||u.type==="sync-end"?(e.classList.add("zrr-sync-badge--sync"),e.classList.add(u.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),u.type==="sync-start"?e.textContent=u.docId?`Redis Index Sync start - ${u.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e):u.type==="chunk-end"?(e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=u.chunkKind==="page"?"Page end":"Section end",u.chunkKind&&e.classList.add(`zrr-sync-badge--${u.chunkKind}`),e):u.type!=="chunk-start"?null:(e.classList.add("zrr-sync-badge--chunk"),u.chunkKind&&e.classList.add(`zrr-sync-badge--${u.chunkKind}`),u.excluded&&e.classList.add("is-excluded"),u.pageNumber&&p>0?e.textContent=`Page ${u.pageNumber}/${p}`:u.pageNumber?e.textContent=`Page ${u.pageNumber}`:u.chunkId?e.textContent=`Section ${u.chunkId}`:e.textContent="Section",u.excluded&&(e.textContent=`${e.textContent} - excluded`),e)},Je=class extends W.WidgetType{constructor(p,e,n,t,i){super(),this.plugin=p,this.docId=e,this.chunkId=n,this.startLine=t,this.excluded=i}eq(p){return this.docId===p.docId&&this.chunkId===p.chunkId&&this.startLine===p.startLine&&this.excluded===p.excluded}toDOM(){let p=document.createElement("span");p.className="zrr-chunk-toolbar",p.setAttribute("data-chunk-id",this.chunkId);let e=(d,c)=>{d.setAttribute("title",c),d.setAttribute("aria-label",c),d.setAttribute("data-tooltip-position","top")},n=(d,c,_)=>{let m=document.createElement("span");m.className="zrr-chunk-button-icon",(0,un.setIcon)(m,c);let y=document.createElement("span");y.className="zrr-chunk-button-label",y.textContent=_,d.appendChild(m),d.appendChild(y)},t=document.createElement("button");t.type="button",t.className="zrr-chunk-button",n(t,"sparkles","Clean"),e(t,"Clean this chunk with the OCR cleanup model"),t.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),p.appendChild(t);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",n(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),p.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",n(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),p.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",n(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),p.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return n(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",d=>{d.preventDefault(),d.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),p.appendChild(s),p}ignoreEvent(){return!0}},dn=(u,p)=>{var x;let e=u.state.doc,n=Ee(e);if(!n)return W.Decoration.none;let t=u.state.selection.main.head,i=e.lineAt(t).number,r=an(e,i);if(!r)return W.Decoration.none;let a=r.text.match(ae);if(!a)return W.Decoration.none;let s=((x=a[1])!=null?x:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return W.Decoration.none;let l=o[2].trim();if(!l)return W.Decoration.none;let d=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),c=on(e,r.startLine+1,r.endLine-1),_=d||c,m=e.line(r.startLine),y=W.Decoration.widget({widget:new Je(p,n,l,r.startLine,_),side:1});return W.Decoration.set([y.range(m.to)])},Xe=class extends W.WidgetType{constructor(p,e){super(),this.info=p,this.totalPages=e}toDOM(){var p;return(p=Jn(this.info,this.totalPages))!=null?p:document.createElement("span")}},cn=u=>{var s,o;let p=u.dom.closest(".markdown-source-view");if(!p||!p.classList.contains("is-live-preview"))return W.Decoration.none;let e=u.state.doc,n=new pn.RangeSetBuilder,t=[],i=[],r=!1;for(let l=1;l<=e.lines;l+=1){let d=e.line(l),c=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!c)continue;let _=sn(c[1]);_&&(_.type==="chunk-start"?(_.chunkKind=(s=_.chunkKind)!=null?s:_.pageNumber?"page":"section",_.pageNumber&&(r=!0)):_.type==="chunk-end"&&(_.chunkKind=(o=_.chunkKind)!=null?o:"section"),t.push({line:l,from:d.from,to:d.to,info:_}),_.pageNumber&&i.push(_.pageNumber))}if(!t.length)return W.Decoration.none;if(r)for(let l of t)l.info.type==="chunk-end"&&(l.info.chunkKind="page");let a=i.length?Math.max(...i):0;for(let l of t){let d=W.Decoration.replace({widget:new Xe(l.info,a)});n.add(l.from,l.to,d)}return n.finish()},_n=()=>W.ViewPlugin.fromClass(class{constructor(u){this.decorations=cn(u)}update(u){(u.docChanged||u.viewportChanged)&&(this.decorations=cn(u.view))}},{decorations:u=>u.decorations}),gn=u=>W.ViewPlugin.fromClass(class{constructor(p){this.decorations=dn(p,u)}update(p){(p.docChanged||p.selectionSet||p.viewportChanged)&&(this.decorations=dn(p.view,u))}},{decorations:p=>p.decorations});var Q=require("child_process"),$=require("fs"),Fn=ge(require("http")),zn=ge(require("https")),we=ge(require("net")),qn=ge(require("os")),Mn=ge(require("tls")),E=ge(require("path")),tn=require("url"),Ue=require("crypto");var N=require("obsidian"),X=".zotero-redisearch-rag",Y=`${X}/items`,V=`${X}/chunks`,fn={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{pdf_block}}{{docling_markdown}}",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,chatPaneLocation:"right",enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"cross-encoder/ms-marco-MiniLM-L-6-v2",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${X}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Se=class extends N.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async f=>{this.plugin.settings.llmProviderProfiles=f,await this.plugin.saveSettings()},i=f=>{f.inputEl.type="password",f.inputEl.autocomplete="off",f.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:f=>{f.createEl("h2",{text:"Prerequisites"}),new N.Setting(f).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows).").addText(h=>h.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async v=>{this.plugin.settings.pythonPath=v.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Python environment").setDesc("Create or update the plugin's Python env (location configured below).").addButton(h=>{h.setButtonText("Create/Update").setCta(),h.onClick(async()=>{h.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{h.setDisabled(!1)}})}),new N.Setting(f).setName("Python env location").setDesc("Shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(h=>{h.addOption("shared","Shared user cache"),h.addOption("plugin","Plugin folder (.venv)"),h.setValue(this.plugin.settings.pythonEnvLocation).onChange(async v=>{v!=="shared"&&v!=="plugin"||(this.plugin.settings.pythonEnvLocation=v,await this.plugin.saveSettings())})}),new N.Setting(f).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack).").addText(h=>h.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async v=>{this.plugin.settings.dockerPath=v.trim()||"docker",await this.plugin.saveSettings()})),new N.Setting(f).setName("Redis URL").addText(h=>h.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async v=>{this.plugin.settings.redisUrl=v.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Redis data directory override").setDesc("Optional absolute path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting.").addText(h=>h.setPlaceholder("/Users/you/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async v=>{this.plugin.settings.redisDataDirOverride=v.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(h=>h.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async v=>{this.plugin.settings.redisProjectName=v.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(h=>h.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async v=>{this.plugin.settings.autoAssignRedisPort=v,await this.plugin.saveSettings()})),new N.Setting(f).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Uses a vault-specific data dir at .obsidian/zotero-redisearch-rag/redis-data unless overridden.").addToggle(h=>h.setValue(this.plugin.settings.autoStartRedis).onChange(async v=>{this.plugin.settings.autoStartRedis=v,await this.plugin.saveSettings()})),new N.Setting(f).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(h=>h.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:f=>{f.createEl("h2",{text:"Zotero Local API"}),new N.Setting(f).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(C=>C.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async P=>{this.plugin.settings.zoteroBaseUrl=P.trim(),await this.plugin.saveSettings()}));let h=new N.Setting(f).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),v=null,w=C=>{if(!v)return;let P=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(C.map(I=>I.value)).has(P)||(C=C.concat([{value:P,label:`Custom (${P})`}])),v.selectEl.options.length=0;for(let I of C)v.addOption(I.value,I.label);v.setValue(P)},S=async()=>{if(v){v.setDisabled(!0);try{let C=await this.plugin.fetchZoteroLibraryOptions();w(C)}finally{v.setDisabled(!1)}}};h.addDropdown(C=>{v=C;let P=(this.plugin.settings.zoteroUserId||"0").trim()||"0";C.addOption(P,"Loading..."),C.setValue(P),C.onChange(async D=>{this.plugin.settings.zoteroUserId=D.trim(),await this.plugin.saveSettings()})}),h.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await S()})}),S(),f.createEl("h2",{text:"Zotero Web API"}),new N.Setting(f).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(C=>C.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async P=>{this.plugin.settings.webApiBaseUrl=P.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(C=>C.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async P=>{this.plugin.settings.webApiLibraryType=P,await this.plugin.saveSettings()})),new N.Setting(f).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(C=>C.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async P=>{this.plugin.settings.webApiLibraryId=P.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(C=>{i(C),C.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async P=>{this.plugin.settings.webApiKey=P.trim(),await this.plugin.saveSettings()})}),f.createEl("h2",{text:"Output"}),new N.Setting(f).setName("PDF folder").addText(C=>C.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async P=>{this.plugin.settings.outputPdfDir=P.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Notes folder").addText(C=>C.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async P=>{this.plugin.settings.outputNoteDir=P.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(C=>{C.setValue(this.plugin.settings.frontmatterTemplate).onChange(async P=>{this.plugin.settings.frontmatterTemplate=P,await this.plugin.saveSettings()}),C.inputEl.rows=10,C.inputEl.style.width="100%"}),new N.Setting(f).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(C=>C.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async P=>{this.plugin.settings.tagSanitizeMode=P,await this.plugin.saveSettings()})),new N.Setting(f).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}} and {{docling_markdown}} placeholders.").addTextArea(C=>{C.setValue(this.plugin.settings.noteBodyTemplate).onChange(async P=>{this.plugin.settings.noteBodyTemplate=P,await this.plugin.saveSettings()}),C.inputEl.rows=8,C.inputEl.style.width="100%"}),new N.Setting(f).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(C=>C.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async P=>{this.plugin.settings.chatOutputDir=P.trim()||"zotero/chats",await this.plugin.saveSettings()})),new N.Setting(f).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(C=>C.setValue(this.plugin.settings.copyPdfToVault).onChange(async P=>{this.plugin.settings.copyPdfToVault=P,!P&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new N.Setting(f).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(C=>{let P=this.plugin.settings.copyPdfToVault;C.setValue(P?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!P).onChange(async D=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=D,await this.plugin.saveSettings()})}),new N.Setting(f).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(C=>C.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async P=>{this.plugin.settings.preferObsidianNoteForCitations=P,await this.plugin.saveSettings()}))}},{id:"ocr",label:"OCR",render:f=>{f.createEl("h2",{text:"Docling"});let h=null,v=P=>{if(!h)return;let D=this.plugin.settings.ocrEngine;new Set(P.map(z=>z.value)).has(D)||(P=P.concat([{value:D,label:`Current (unavailable): ${D}`}])),h.selectEl.options.length=0;for(let z of P)h.addOption(z.value,z.label);h.setValue(D)},w=async()=>{if(!h)return;h.setDisabled(!0);let P={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{P=await this.plugin.detectOcrEngines()}catch(z){P={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let D=[{value:"auto",label:"Auto (default)"}];P.tesseract&&D.push({value:"tesseract",label:"Tesseract (local)"}),P.paddleStructureLocal&&D.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),P.paddleVlLocal&&D.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(D.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),D.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),v(D),h.setDisabled(!1)},S=new N.Setting(f).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),C=document.createElement("a");C.href="https://aistudio.baidu.com/paddleocr",C.textContent="https://aistudio.baidu.com/paddleocr",C.target="_blank",C.rel="noopener noreferrer",S.descEl.appendChild(C),S.descEl.append("."),S.addText(P=>{i(P),P.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async D=>{this.plugin.settings.paddleApiKey=D.trim(),await this.plugin.saveSettings(),await w()})}),new N.Setting(f).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(P=>P.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async D=>{this.plugin.settings.paddleVlApiUrl=D.trim(),await this.plugin.saveSettings()})),new N.Setting(f).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(P=>P.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async D=>{this.plugin.settings.paddleStructureApiUrl=D.trim(),await this.plugin.saveSettings(),await w()})),new N.Setting(f).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(P=>{h=P,P.addOption("auto","Auto (default)"),P.setValue(this.plugin.settings.ocrEngine),P.onChange(async D=>{this.plugin.settings.ocrEngine=D,await this.plugin.saveSettings()})}),new N.Setting(f).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(P=>P.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async D=>{this.plugin.settings.ocrMode=D,await this.plugin.saveSettings()})),new N.Setting(f).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(P=>P.setValue(this.plugin.settings.forcePerPageOcr).onChange(async D=>{this.plugin.settings.forcePerPageOcr=D,await this.plugin.saveSettings()})),new N.Setting(f).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(P=>{P.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async D=>{this.plugin.settings.ocrQualityThreshold=D,await this.plugin.saveSettings()})}),new N.Setting(f).setName("Chunking").setDesc("page or section").addDropdown(P=>P.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async D=>{this.plugin.settings.chunkingMode=D,await this.plugin.saveSettings()})),w()}},{id:"llms",label:"LLMs",render:f=>{f.createEl("h2",{text:"LLM Provider Profiles"});let h=f.createDiv({cls:"zrr-llm-profiles"}),v=()=>{h.empty();let b=n();b.length||h.createEl("p",{text:"No profiles yet. Add one below."});for(let k of b){let A=h.createEl("details",{cls:"zrr-profile"});b.length===1&&(A.open=!0);let Z=A.createEl("summary",{text:k.name||k.id||"Profile"});Z.addClass("zrr-profile-title");let Ce=A.createDiv({cls:"zrr-profile-body"});new N.Setting(Ce).setName("Profile name").addText(se=>se.setPlaceholder("My provider").setValue(k.name||"").onChange(async le=>{k.name=le.trim(),Z.textContent=k.name||k.id||"Profile",await t(n())})),new N.Setting(Ce).setName("Base URL").addText(se=>se.setPlaceholder("http://localhost:1234/v1").setValue(k.baseUrl||"").onChange(async le=>{k.baseUrl=le.trim(),await t(n())})),new N.Setting(Ce).setName("API key").setDesc("Stored in settings (not encrypted).").addText(se=>{i(se),se.setPlaceholder("sk-...").setValue(k.apiKey||"").onChange(async le=>{k.apiKey=le.trim(),await t(n())})}),new N.Setting(Ce).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(se=>se.setButtonText("Delete profile").onClick(async()=>{let le=n().filter(jn=>jn.id!==k.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===k.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===k.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===k.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(le),v()}))}new N.Setting(h).addButton(k=>k.setButtonText("Add profile").onClick(async()=>{let A=`profile-${Date.now().toString(36)}`,Z=n().concat([{id:A,name:"Custom",baseUrl:"",apiKey:""}]);await t(Z),v()}))};v(),f.createEl("h2",{text:"OCR cleanup"}),new N.Setting(f).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(b=>b.setValue(this.plugin.settings.enableLlmCleanup).onChange(async k=>{this.plugin.settings.enableLlmCleanup=k,await this.plugin.saveSettings()}));let w=null,S=null,C=null,P=async()=>{},D=async(b,k=!0)=>{let A=b.trim();this.plugin.settings.llmCleanupBaseUrl=A,k&&(this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom")),S&&S.setValue(A),await this.plugin.saveSettings()},I=async b=>{let k=n().find(A=>A.id===b);this.plugin.settings.llmCleanupProviderProfileId=b,k&&(this.plugin.settings.llmCleanupBaseUrl=k.baseUrl,this.plugin.settings.llmCleanupApiKey=k.apiKey,S==null||S.setValue(k.baseUrl),C==null||C.setValue(k.apiKey)),await this.plugin.saveSettings(),await P()};new N.Setting(f).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(b=>{w=b,b.addOption("custom","Custom (manual)");for(let A of n())b.addOption(A.id,A.name||A.id);let k=this.plugin.settings.llmCleanupProviderProfileId;b.setValue(k&&n().some(A=>A.id===k)?k:"custom"),b.onChange(async A=>{if(A==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await I(A)})}),new N.Setting(f).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(b=>{S=b,b.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async k=>{await D(k)})}),new N.Setting(f).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(b=>{C=b,i(b),b.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async k=>{this.plugin.settings.llmCleanupApiKey=k.trim(),this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom"),await this.plugin.saveSettings()})});let z=new N.Setting(f).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),R=null,F=b=>{if(!R)return;let k=(this.plugin.settings.llmCleanupModel||"").trim(),A=new Set(b.map(Z=>Z.value));k&&!A.has(k)&&(b=b.concat([{value:k,label:`Custom (${k})`}])),R.selectEl.options.length=0;for(let Z of b)R.addOption(Z.value,Z.label);k&&R.setValue(k)};P=async()=>{if(R){R.setDisabled(!0);try{let b=await this.plugin.fetchCleanupModelOptions();F(b)}finally{R.setDisabled(!1)}}},z.addDropdown(b=>{R=b;let k=(this.plugin.settings.llmCleanupModel||"").trim();b.addOption(k||"loading","Loading..."),b.setValue(k||"loading"),b.onChange(async A=>{this.plugin.settings.llmCleanupModel=A.trim(),await this.plugin.saveSettings()})}),z.addButton(b=>{b.setButtonText("Refresh").onClick(async()=>{await P()})}),P(),new N.Setting(f).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(b=>b.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async k=>{let A=Number.parseFloat(k);this.plugin.settings.llmCleanupTemperature=Number.isFinite(A)?A:0,await this.plugin.saveSettings()})),new N.Setting(f).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(b=>b.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async k=>{this.plugin.settings.llmCleanupMinQuality=k,await this.plugin.saveSettings()})),new N.Setting(f).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(b=>b.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async k=>{let A=Number.parseInt(k,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(A)?A:2e3,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Text Embedding"});let O=null,G=null,K=null,T=async()=>{},q=async(b,k=!0)=>{let A=b.trim();this.plugin.settings.embedBaseUrl=A,k&&(this.plugin.settings.embedProviderProfileId="",O&&O.setValue("custom")),G&&G.setValue(A),await this.plugin.saveSettings()},H=async b=>{let k=n().find(A=>A.id===b);this.plugin.settings.embedProviderProfileId=b,k&&(this.plugin.settings.embedBaseUrl=k.baseUrl,this.plugin.settings.embedApiKey=k.apiKey,G==null||G.setValue(k.baseUrl),K==null||K.setValue(k.apiKey)),await this.plugin.saveSettings(),await T()};new N.Setting(f).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(b=>{O=b,b.addOption("custom","Custom (manual)");for(let A of n())b.addOption(A.id,A.name||A.id);let k=this.plugin.settings.embedProviderProfileId;b.setValue(k&&n().some(A=>A.id===k)?k:"custom"),b.onChange(async A=>{if(A==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await H(A)})}),new N.Setting(f).setName("Embeddings base URL").addText(b=>{G=b,b.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async k=>{await q(k)})}),new N.Setting(f).setName("Embeddings API key").addText(b=>{K=b,i(b),b.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async k=>{this.plugin.settings.embedApiKey=k.trim(),this.plugin.settings.embedProviderProfileId="",O&&O.setValue("custom"),await this.plugin.saveSettings()})});let J=new N.Setting(f).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),ee=null,Ze=b=>{if(!ee)return;let k=(this.plugin.settings.embedModel||"").trim(),A=new Set(b.map(Z=>Z.value));k&&!A.has(k)&&(b=b.concat([{value:k,label:`Custom (${k})`}])),ee.selectEl.options.length=0;for(let Z of b)ee.addOption(Z.value,Z.label);k&&ee.setValue(k)};T=async()=>{if(ee){ee.setDisabled(!0);try{let b=await this.plugin.fetchEmbeddingModelOptions();Ze(b)}finally{ee.setDisabled(!1)}}},J.addDropdown(b=>{ee=b;let k=(this.plugin.settings.embedModel||"").trim();b.addOption(k||"loading","Loading..."),b.setValue(k||"loading"),b.onChange(async A=>{this.plugin.settings.embedModel=A.trim(),await this.plugin.saveSettings()})}),J.addButton(b=>{b.setButtonText("Refresh").onClick(async()=>{await T()})}),T(),new N.Setting(f).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(b=>b.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async k=>{this.plugin.settings.embedIncludeMetadata=k,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(b=>b.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async k=>{let A=Number.parseInt(k,10);this.plugin.settings.embedContextWindow=Number.isFinite(A)?Math.max(0,A):1,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(b=>b.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async k=>{let A=Number.parseInt(k,10);this.plugin.settings.embedContextChars=Number.isFinite(A)?Math.max(0,A):220,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(b=>b.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async k=>{let A=Number.parseInt(k,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(A)?Math.max(0,A):3500,await this.plugin.saveSettings()})),new N.Setting(f).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(b=>b.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async k=>{let A=Number.parseInt(k,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(A)?Math.max(0,A):200,await this.plugin.saveSettings()})),new N.Setting(f).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(b=>b.setValue(this.plugin.settings.enableChunkTagging).onChange(async k=>{this.plugin.settings.enableChunkTagging=k,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Chat LLM"});let oe=null,re=null,pe=null,ue=async()=>{},Pe=async(b,k=!0)=>{let A=b.trim();this.plugin.settings.chatBaseUrl=A,k&&(this.plugin.settings.chatProviderProfileId="",oe&&oe.setValue("custom")),re&&re.setValue(A),await this.plugin.saveSettings()},He=async b=>{let k=n().find(A=>A.id===b);this.plugin.settings.chatProviderProfileId=b,k&&(this.plugin.settings.chatBaseUrl=k.baseUrl,this.plugin.settings.chatApiKey=k.apiKey,re==null||re.setValue(k.baseUrl),pe==null||pe.setValue(k.apiKey)),await this.plugin.saveSettings(),await ue()};new N.Setting(f).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(b=>{oe=b,b.addOption("custom","Custom (manual)");for(let A of n())b.addOption(A.id,A.name||A.id);let k=this.plugin.settings.chatProviderProfileId;b.setValue(k&&n().some(A=>A.id===k)?k:"custom"),b.onChange(async A=>{if(A==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await He(A)})}),new N.Setting(f).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(b=>{re=b,b.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async k=>{await Pe(k)})}),new N.Setting(f).setName("Chat API key").addText(b=>{pe=b,i(b),b.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async k=>{this.plugin.settings.chatApiKey=k.trim(),this.plugin.settings.chatProviderProfileId="",oe&&oe.setValue("custom"),await this.plugin.saveSettings()})});let _e=new N.Setting(f).setName("Chat model").setDesc("Select a chat-capable model from the provider."),te=null,M=b=>{if(!te)return;let k=(this.plugin.settings.chatModel||"").trim(),A=new Set(b.map(Z=>Z.value));k&&!A.has(k)&&(b=b.concat([{value:k,label:`Custom (${k})`}])),te.selectEl.options.length=0;for(let Z of b)te.addOption(Z.value,Z.label);k&&te.setValue(k)};ue=async()=>{if(te){te.setDisabled(!0);try{let b=await this.plugin.fetchChatModelOptions();M(b)}finally{te.setDisabled(!1)}}},_e.addDropdown(b=>{te=b;let k=(this.plugin.settings.chatModel||"").trim();b.addOption(k||"loading","Loading..."),b.setValue(k||"loading"),b.onChange(async A=>{this.plugin.settings.chatModel=A.trim(),await this.plugin.saveSettings()})}),_e.addButton(b=>{b.setButtonText("Refresh").onClick(async()=>{await ue()})}),ue(),new N.Setting(f).setName("Temperature").addText(b=>b.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async k=>{let A=Number.parseFloat(k);this.plugin.settings.chatTemperature=Number.isFinite(A)?A:.2,await this.plugin.saveSettings()})),new N.Setting(f).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(b=>b.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async k=>{let A=Number.parseInt(k,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(A)?Math.max(0,A):6,await this.plugin.saveSettings()})),new N.Setting(f).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(b=>b.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async k=>{this.plugin.settings.chatPaneLocation=k,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Retrieval"}),new N.Setting(f).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(b=>b.setValue(this.plugin.settings.enableQueryExpansion).onChange(async k=>{this.plugin.settings.enableQueryExpansion=k,await this.plugin.saveSettings()})),new N.Setting(f).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(b=>b.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async k=>{let A=Number.parseInt(k,10);this.plugin.settings.queryExpansionCount=Number.isFinite(A)?Math.max(1,A):3,await this.plugin.saveSettings()})),new N.Setting(f).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(b=>b.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async k=>{this.plugin.settings.enableCrossEncoderRerank=k,await this.plugin.saveSettings()})),new N.Setting(f).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(b=>b.setPlaceholder("cross-encoder/ms-marco-MiniLM-L-6-v2").setValue(this.plugin.settings.rerankModel).onChange(async k=>{this.plugin.settings.rerankModel=k.trim()||"cross-encoder/ms-marco-MiniLM-L-6-v2",await this.plugin.saveSettings()})),new N.Setting(f).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(b=>b.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async k=>{let A=Number.parseInt(k,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(A)?Math.max(1,A):4,await this.plugin.saveSettings()})),new N.Setting(f).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(b=>b.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async k=>{let A=Number.parseInt(k,10);this.plugin.settings.rrfK=Number.isFinite(A)?Math.max(1,A):60,await this.plugin.saveSettings()})),new N.Setting(f).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(b=>b.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async k=>{let A=Number.parseInt(k,10);this.plugin.settings.rrfLogTop=Number.isFinite(A)?Math.max(0,A):0,await this.plugin.saveSettings()})),new N.Setting(f).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(b=>b.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async k=>{let A=Number.parseInt(k,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(A)?Math.max(0,A):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:f=>{f.createEl("h2",{text:"Logging"}),new N.Setting(f).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(h=>h.setValue(this.plugin.settings.enableFileLogging).onChange(async v=>{this.plugin.settings.enableFileLogging=v,await this.plugin.saveSettings()})),new N.Setting(f).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(h=>h.setPlaceholder(`${X}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async v=>{this.plugin.settings.logFilePath=v.trim()||`${X}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new N.Setting(f).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(h=>h.setButtonText("Open log").onClick(async()=>{var v,w;await((w=(v=this.plugin).openLogFile)==null?void 0:w.call(v))})).addButton(h=>h.setButtonText("Clear log").onClick(async()=>{var v,w;await((w=(v=this.plugin).clearLogFile)==null?void 0:w.call(v))})),f.createEl("h2",{text:"Maintenance"}),new N.Setting(f).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(h=>h.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new N.Setting(f).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(h=>h.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(h=>h.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],c=new Map,_=new Map,m=f=>{this.activeTab=f;for(let[h,v]of c){let w=h===f;v.classList.toggle("is-active",w),v.setAttribute("aria-selected",w?"true":"false"),v.setAttribute("tabindex",w?"0":"-1")}for(let[h,v]of _){let w=h===f;v.classList.toggle("is-active",w),v.hidden=!w}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let x=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let f of d){let h=y.createEl("button",{text:f.label,cls:"zrr-settings-tab-button"}),v=`zrr-settings-tab-${f.id}`,w=`zrr-settings-panel-${f.id}`;h.type="button",h.id=v,h.setAttribute("role","tab"),h.setAttribute("aria-controls",w),h.setAttribute("aria-selected","false"),h.addEventListener("click",()=>m(f.id));let S=x.createDiv({cls:"zrr-settings-tab-panel"});S.id=w,S.setAttribute("role","tabpanel"),S.setAttribute("aria-labelledby",v),S.hidden=!0,f.render(S),c.set(f.id,h),_.set(f.id,S)}let L=d.some(f=>f.id===this.activeTab)?this.activeTab:d[0].id;m(L)}};var mn=require("@codemirror/state"),hn=require("@codemirror/view"),ie=require("obsidian");var Xn=u=>{let p=u.scrollDOM.getBoundingClientRect(),e=u.posAtCoords({x:p.left+8,y:+p.height*.25});return e===null?null:u.state.doc.lineAt(e).number},Ne=class{constructor(p,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.deps=p,this.helpers=e}createSyncExtension(){let p=this,e=this.helpers;return hn.ViewPlugin.fromClass(class{constructor(n){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=n,this.docId=e.extractDocIdFromDoc(n.state.doc),this.onScroll=()=>this.scheduleSync(!1),n.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(n){n.docChanged&&(this.docId=e.extractDocIdFromDoc(n.view.state.doc),this.lastPage=null,this.lastChunkId=null),(n.docChanged||n.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(n){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,n)}))}syncPdfSidebar(n,t){var _,m;let i=this.docId;if(!i)return;let r=Xn(n);if(r===null)return;let a=e.findChunkStartLineInDoc(n.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(_=s==null?void 0:s.pageNumber)!=null?_:null,l=(m=s==null?void 0:s.chunkId)!=null?m:null;if(!o&&!l)return;let d=o!==null&&this.lastPage===o,c=o===null&&l!==null&&this.lastChunkId===l;!t&&(d||c)||(this.lastPage=o,this.lastChunkId=l,p.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,n;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((n=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:n.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let p=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(p.docId,p.pageNumber,p.chunkId)}updatePreviewScrollHandler(){var t;let p=this.deps.app.workspace.getActiveViewOfType(ie.MarkdownView);if(!p||p.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(t=p.previewMode)==null?void 0:t.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let n=()=>this.schedulePreviewSync(p);e.addEventListener("scroll",n,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=n,this.schedulePreviewSync(p)}async syncPdfSidebarForFile(p){try{let e=await this.deps.app.vault.read(p),n=await this.deps.resolveDocIdForNote(p,e);if(!n)return;let t=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(n,t==null?void 0:t.pageNumber,t==null?void 0:t.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(p,e,n){if(!p)return;let t=await this.deps.getDocIndexEntry(p);t||(t=await this.deps.hydrateDocIndexFromCache(p));let i=t!=null&&t.pdf_path?String(t.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let m=(0,ie.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(m)instanceof ie.TFile&&(r=m)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof ie.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:n};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:p,pageNumber:e,chunkId:n};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&n&&(o=await this.resolvePageNumberForChunk(p,n)),o===null||this.pdfSidebarDocId===p&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=p,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,d=o!==null?`${l}#page=${o}`:l,c=this.deps.app.workspace,_=c.getMostRecentLeaf();c.setActiveLeaf(s,{focus:!1});try{await this.openPdfLinkInLeaf(s,d),this.updatePdfSidebarIcon(s)}finally{_&&c.setActiveLeaf(_,{focus:!1})}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(p){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(p)}))}syncPdfSidebarForPreview(p){let e=this.previewScrollEl;if(!e)return;let n=p.getViewData();if(!n)return;let t=mn.Text.of(n.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(t);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(t,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(p){var t;let e=p.getBoundingClientRect().top,n=p.querySelectorAll("[data-line]");for(let i of Array.from(n))if(i.getBoundingClientRect().bottom>=e+2){let a=(t=i.getAttribute("data-line"))!=null?t:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var t,i;if(this.pdfSidebarLeaf&&((i=(t=this.pdfSidebarLeaf.view)==null?void 0:t.getViewType)==null?void 0:i.call(t))==="pdf")return this.pdfSidebarLeaf;let p=this.deps.app.workspace;if(typeof p.ensureSideLeaf=="function")try{let r=await p.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let n=this.deps.app.workspace.getRightLeaf(!0);return n&&this.isRightSidebarLeaf(n)?(this.pdfSidebarLeaf=n,this.updatePdfSidebarIcon(n),n):null}isRightSidebarLeaf(p){if(!p)return!1;let n=p.containerEl;return!!(n!=null&&n.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(p){if(!p||!this.isRightSidebarLeaf(p))return;let n=p.containerEl,t=[];n&&t.push(...Array.from(n.querySelectorAll(".view-header-icon")));let i=p;if(i.tabHeaderEl&&t.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&t.push(i.tabHeaderInnerIconEl),t.length===0)return;let r=new Set;for(let s of t)r.has(s)||(r.add(s),s.innerHTML="",(0,ie.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=p.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(p,e){var r,a,s;let n=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],t=(s=(a=n==null?void 0:n.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof t=="function"){await t.call(n.lib.workspace,p,e,"",{active:!1});return}let i=p;if(typeof i.openLinkText=="function"){await i.openLinkText(e,"",{active:!1});return}await this.deps.app.workspace.openLinkText(e,"",!1)}getPluginsRegistry(){var p;return(p=this.deps.app.plugins)==null?void 0:p.plugins}isLeafTabActive(p){var i;let e=p;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===p;let n=e.containerEl;if(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))return!0;let t=e.tabHeaderEl;return!!(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))}async resolvePageNumberForChunk(p,e){var l,d,c,_,m;if(!p||!e)return null;let n=this.deps.normalizeChunkIdForNote(e,p)||e,t=this.chunkPageCache.get(p);if(t&&t.has(n))return(l=t.get(n))!=null?l:null;let i=(0,ie.normalizePath)(`${V}/${p}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let y of s){let x=typeof(y==null?void 0:y.chunk_id)=="string"?y.chunk_id.trim():"";if(!x)continue;let L=Number.isFinite((d=y==null?void 0:y.page_start)!=null?d:NaN)?Number(y.page_start):null,f=Number.isFinite((c=y==null?void 0:y.page_end)!=null?c:NaN)?Number(y.page_end):null,h=L!=null?L:f;h!==null&&(o.set(x,h),o.set(`${p}:${x}`,h))}return this.chunkPageCache.set(p,o),(m=(_=o.get(n))!=null?_:o.get(e))!=null?m:null}};var Re={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">

"use strict";var Qn=Object.create;var Ee=Object.defineProperty;var et=Object.getOwnPropertyDescriptor;var nt=Object.getOwnPropertyNames;var tt=Object.getPrototypeOf,it=Object.prototype.hasOwnProperty;var rt=(g,_)=>{for(var e in _)Ee(g,e,{get:_[e],enumerable:!0})},un=(g,_,e,n)=>{if(_&&typeof _=="object"||typeof _=="function")for(let t of nt(_))!it.call(g,t)&&t!==e&&Ee(g,t,{get:()=>_[t],enumerable:!(n=et(_,t))||n.enumerable});return g};var pe=(g,_,e)=>(e=g!=null?Qn(tt(g)):{},un(_||!g||!g.__esModule?Ee(e,"default",{value:g,enumerable:!0}):e,g)),at=g=>un(Ee({},"__esModule",{value:!0}),g);var kt={};rt(kt,{default:()=>Xe});module.exports=at(kt);var h=require("obsidian");var bn=require("@codemirror/state"),Q=require("@codemirror/view"),xn=require("obsidian");var ue=/<!--\s*zrr:sync-start[^>]*-->/i,fe=/<!--\s*zrr:sync-end\s*-->/i,ce=/<!--\s*zrr:chunk\b([^>]*)-->/i,Ne=/<!--\s*zrr:chunk\s+end\s*-->/i,xe=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,_n=g=>{let _=g.trim();if(!_.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(_)){let u=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:u?u[2]:void 0}}if(/^zrr:sync-end\b/i.test(_))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(_)){let u=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),m=_.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:u?u[2]:void 0,attachmentKey:m?m[2]:void 0}}if(/^zrr:annotations-end\b/i.test(_))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(_))return{type:"chunk-end"};let e=_.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let n=e[1]||"",t=n.match(/\bid=(["']?)([^"'\s]+)\1/i),i=t?t[2]:"",r=n.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:n.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(n)||/\bdelete\b/i.test(n),p=/\bsection\b/i.test(n);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:p?"section":c?"page":"section"}},nn=g=>{var l;if(!g)return null;let _=g.match(ce);if(!_)return null;let e=_[1]||"",n=e.match(/\bid=(["']?)([^"'\s]+)\1/i),t=n?n[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=t&&(l=ot(t))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:t,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},Re=g=>{for(let _=1;_<=g.lines;_+=1){let e=g.line(_).text;if(ue.test(e)){let n=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return n?n[2].trim():null}}return null},tn=(g,_)=>{let e=_;for(;e>=1;e-=1){let n=g.line(e).text;if(ce.test(n))return{line:e,text:n};if(ue.test(n)||fe.test(n))break}return null},st=(g,_)=>{for(let e=_;e<=g.lines;e+=1){let n=g.line(e).text;if(Ne.test(n))return e;if(fe.test(n))break}return null},gn=(g,_)=>{let e=tn(g,_);if(!e)return null;let n=st(g,e.line+1);return n===null||_<e.line||_>n?null:{startLine:e.line,endLine:n,text:e.text}},fn=(g,_,e)=>{if(_>e)return!1;for(let n=_;n<=e;n+=1){let t=g.line(n).text;if(xe.test(t))return!0}return!1},ot=g=>{var t;if(!g)return null;let e=(g.includes(":")&&(t=g.split(":").pop())!=null?t:g).match(/^p(\d+)$/i);if(!e)return null;let n=Number.parseInt(e[1],10);return Number.isFinite(n)?n:null};var hn=g=>{if(!g)return null;let _=g.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return _?nn(_[0]):null};var lt=(g,_)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),g.type==="sync-start"||g.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(g.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),g.type==="sync-start"?e.textContent=g.docId?`Redis Index Sync start - ${g.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e;if(g.type==="annotations-start"||g.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),g.type==="annotations-start"){let n=g.docId?` - ${g.docId}`:"";e.textContent=`Zotero annotations start${n}`}else e.textContent="Zotero annotations end";return e}if(g.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=g.chunkKind==="page"?"Page end":"Section end",g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),e;if(g.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),g.excluded&&e.classList.add("is-excluded"),g.pageNumber&&_>0)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber}/${_})`}else e.textContent=`Page ${g.pageNumber}/${_}`;else if(g.pageNumber)if(g.chunkKind==="section"){let n=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${n} (p${g.pageNumber})`}else e.textContent=`Page ${g.pageNumber}`;else g.chunkId?e.textContent=`Section ${g.chunkId}`:e.textContent="Section";return g.excluded&&(e.textContent=`${e.textContent} - excluded`),e},rn=class extends Q.WidgetType{constructor(_,e,n,t,i){super(),this.plugin=_,this.docId=e,this.chunkId=n,this.startLine=t,this.excluded=i}eq(_){return this.docId===_.docId&&this.chunkId===_.chunkId&&this.startLine===_.startLine&&this.excluded===_.excluded}toDOM(){let _=document.createElement("span");_.className="zrr-chunk-toolbar",_.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},n=(c,d,p)=>{let u=document.createElement("span");u.className="zrr-chunk-button-icon",(0,xn.setIcon)(u,d);let m=document.createElement("span");m.className="zrr-chunk-button-label",m.textContent=p,c.appendChild(u),c.appendChild(m)},t=document.createElement("button");t.type="button",t.className="zrr-chunk-button",n(t,"sparkles","Clean"),e(t,"Clean this chunk with the OCR cleanup model"),t.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),_.appendChild(t);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",n(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),_.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",n(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),_.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",n(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),_.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return n(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),_.appendChild(s),_}ignoreEvent(){return!0}},mn=(g,_)=>{var y;let e=g.state.doc,n=Re(e);if(!n)return Q.Decoration.none;let t=g.state.selection.main.head,i=e.lineAt(t).number,r=gn(e,i);if(!r)return Q.Decoration.none;let a=r.text.match(ce);if(!a)return Q.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return Q.Decoration.none;let l=o[2].trim();if(!l)return Q.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=fn(e,r.startLine+1,r.endLine-1),p=c||d,u=e.line(r.startLine),m=Q.Decoration.widget({widget:new rn(_,n,l,r.startLine,p),side:1});return Q.Decoration.set([m.range(u.to)])},an=class extends Q.WidgetType{constructor(_,e){super(),this.info=_,this.totalPages=e}toDOM(){var _;return(_=lt(this.info,this.totalPages))!=null?_:document.createElement("span")}},yn=g=>{var o,l;let _=g.dom.closest(".markdown-source-view");if(!_||!_.classList.contains("is-live-preview"))return Q.Decoration.none;let e=g.state.doc,n=new bn.RangeSetBuilder,t=[],i=[],r=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),p=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!p)continue;let u=_n(p[1]);u&&(u.type==="chunk-start"?(u.chunkKind=(o=u.chunkKind)!=null?o:u.pageNumber?"page":"section",u.pageNumber&&(r=!0),u.chunkKind==="section"&&(a=!0)):u.type==="chunk-end"&&(u.chunkKind=(l=u.chunkKind)!=null?l:"section"),t.push({line:c,from:d.from,to:d.to,info:u}),u.pageNumber&&i.push(u.pageNumber))}if(!t.length)return Q.Decoration.none;if(r&&!a)for(let c of t)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let c of t){let d=Q.Decoration.replace({widget:new an(c.info,s)});n.add(c.from,c.to,d)}return n.finish()},kn=()=>Q.ViewPlugin.fromClass(class{constructor(g){this.decorations=yn(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=yn(g.view))}},{decorations:g=>g.decorations}),vn=g=>Q.ViewPlugin.fromClass(class{constructor(_){this.decorations=mn(_,g)}update(_){(_.docChanged||_.selectionSet||_.viewportChanged)&&(this.decorations=mn(_.view,g))}},{decorations:_=>_.decorations});var ne=require("child_process"),W=require("fs"),Kn=pe(require("http")),Jn=pe(require("https")),Pe=pe(require("net")),Ae=pe(require("os")),Xn=pe(require("tls")),N=pe(require("path")),pn=require("url"),Ce=require("crypto");var D=require("obsidian"),wn=require("crypto"),De=require("fs"),Te=pe(require("path")),ee=".zotero-redisearch-rag",te=`${ee}/items`,H=`${ee}/chunks`,Pn=`${ee}/metadata_snapshots.json`,An=`${ee}/annotation_snapshots.json`,ct="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",Ie={pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,chatPaneLocation:"right",enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:"BAAI/bge-reranker-v2-m3",rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${ee}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Oe=class extends D.PluginSettingTab{constructor(e,n){super(e,n);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=n}display(){let{containerEl:e}=this;e.empty();let n=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],t=async f=>{this.plugin.settings.llmProviderProfiles=f,await this.plugin.saveSettings()},i=f=>{f.inputEl.type="password",f.inputEl.autocomplete="off",f.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:f=>{f.createEl("h2",{text:"Prerequisites"}),new D.Setting(f).setName("Python path").setDesc("Optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(A=>A.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async E=>{this.plugin.settings.pythonPath=E.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Python environment").setDesc("Create or update the plugin's Python env (location configured below).").addButton(A=>{A.setButtonText("Create/Update").setCta(),A.onClick(async()=>{A.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{A.setDisabled(!1)}})}),new D.Setting(f).setName("Python env location").setDesc("Shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(A=>{A.addOption("shared","Shared user cache"),A.addOption("plugin","Plugin folder (.venv)"),A.setValue(this.plugin.settings.pythonEnvLocation).onChange(async E=>{E!=="shared"&&E!=="plugin"||(this.plugin.settings.pythonEnvLocation=E,await this.plugin.saveSettings())})}),new D.Setting(f).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(A=>A.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async E=>{this.plugin.settings.dockerPath=E.trim()||"docker",await this.plugin.saveSettings()})),new D.Setting(f).setName("Redis URL").addText(A=>A.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async E=>{this.plugin.settings.redisUrl=E.trim(),await this.plugin.saveSettings()}));let k=null,b=null,S=null,L=null,P=()=>{let A=this.plugin.settings.autoAssignRedisPort;S==null||S.setDisabled(A),L==null||L.setDisabled(A),k==null||k.settingEl.classList.toggle("is-disabled",A),b==null||b.settingEl.classList.toggle("is-disabled",A)};new D.Setting(f).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(A=>A.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async E=>{this.plugin.settings.autoAssignRedisPort=E,await this.plugin.saveSettings(),P()})),k=new D.Setting(f).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(A=>(S=A,A.setPlaceholder("~/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async E=>{this.plugin.settings.redisDataDirOverride=E.trim(),await this.plugin.saveSettings()}))),k.settingEl.addClass("zrr-redis-override-setting"),b=new D.Setting(f).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(A=>(L=A,A.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async E=>{this.plugin.settings.redisProjectName=E.trim(),await this.plugin.saveSettings()}))),b.settingEl.addClass("zrr-redis-override-setting"),P(),new D.Setting(f).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Uses a vault-specific data dir at .obsidian/zotero-redisearch-rag/redis-data unless overridden.").addToggle(A=>A.setValue(this.plugin.settings.autoStartRedis).onChange(async E=>{this.plugin.settings.autoStartRedis=E,await this.plugin.saveSettings()})),new D.Setting(f).setName("Start Redis stack now").setDesc("Restarts Docker/Podman Compose with the vault data directory.").addButton(A=>A.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:f=>{f.createEl("h2",{text:"Zotero Local API"}),new D.Setting(f).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(P=>P.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async A=>{this.plugin.settings.zoteroBaseUrl=A.trim(),await this.plugin.saveSettings()}));let k=new D.Setting(f).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),b=null,S=P=>{if(!b)return;let A=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(P.map(z=>z.value)).has(A)||(P=P.concat([{value:A,label:`Custom (${A})`}])),b.selectEl.options.length=0;for(let z of P)b.addOption(z.value,z.label);b.setValue(A)},L=async()=>{if(b){b.setDisabled(!0);try{let P=await this.plugin.fetchZoteroLibraryOptions();S(P)}finally{b.setDisabled(!1)}}};k.addDropdown(P=>{b=P;let A=(this.plugin.settings.zoteroUserId||"0").trim()||"0";P.addOption(A,"Loading..."),P.setValue(A),P.onChange(async E=>{this.plugin.settings.zoteroUserId=E.trim(),await this.plugin.saveSettings()})}),k.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await L()})}),L(),f.createEl("h2",{text:"Zotero Web API"}),new D.Setting(f).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(P=>P.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async A=>{this.plugin.settings.webApiBaseUrl=A.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(P=>P.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async A=>{this.plugin.settings.webApiLibraryType=A,await this.plugin.saveSettings()})),new D.Setting(f).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(P=>P.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async A=>{this.plugin.settings.webApiLibraryId=A.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(P=>{i(P),P.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async A=>{this.plugin.settings.webApiKey=A.trim(),await this.plugin.saveSettings()})}),f.createEl("h2",{text:"Output"}),new D.Setting(f).setName("PDF folder").addText(P=>P.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async A=>{this.plugin.settings.outputPdfDir=A.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Notes folder").addText(P=>P.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async A=>{this.plugin.settings.outputNoteDir=A.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(P=>{P.setValue(this.plugin.settings.frontmatterTemplate).onChange(async A=>{this.plugin.settings.frontmatterTemplate=A,await this.plugin.saveSettings()}),P.inputEl.rows=10,P.inputEl.style.width="100%"}),new D.Setting(f).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(P=>P.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async A=>{this.plugin.settings.tagSanitizeMode=A,await this.plugin.saveSettings()})),new D.Setting(f).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(P=>{P.setValue(this.plugin.settings.noteBodyTemplate).onChange(async A=>{this.plugin.settings.noteBodyTemplate=A,await this.plugin.saveSettings()}),P.inputEl.rows=8,P.inputEl.style.width="100%"}),new D.Setting(f).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(P=>P.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async A=>{this.plugin.settings.chatOutputDir=A.trim()||"zotero/chats",await this.plugin.saveSettings()})),new D.Setting(f).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(P=>P.setValue(this.plugin.settings.copyPdfToVault).onChange(async A=>{this.plugin.settings.copyPdfToVault=A,!A&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new D.Setting(f).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(P=>{let A=this.plugin.settings.copyPdfToVault;P.setValue(A?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!A).onChange(async E=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=E,await this.plugin.saveSettings()})}),new D.Setting(f).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(P=>P.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async A=>{this.plugin.settings.preferObsidianNoteForCitations=A,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:f=>{f.createEl("h2",{text:"Annotations"}),new D.Setting(f).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(L=>L.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async P=>{this.plugin.settings.annotationPageLabel=P.trim()||"Page",await this.plugin.saveSettings()})),new D.Setting(f).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(L=>L.setValue(this.plugin.settings.includeAnnotationImages).onChange(async P=>{this.plugin.settings.includeAnnotationImages=P,await this.plugin.saveSettings()})),f.createEl("h3",{text:"Zotero companion"}),f.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new D.Setting(f).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(L=>L.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async P=>{this.plugin.settings.zoteroCompanionEnabled=P,await this.plugin.saveSettings()})),new D.Setting(f).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(L=>L.setPlaceholder("http://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async P=>{this.plugin.settings.zoteroCompanionBaseUrl=P.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(L=>{i(L),this.companionTokenInput=L,L.setPlaceholder("optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async P=>{this.plugin.settings.zoteroCompanionToken=P.trim(),await this.plugin.saveSettings()})}),new D.Setting(f).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero Companion Plugin token to this value.").addButton(L=>L.setButtonText("Generate token").onClick(async()=>{let P=(0,wn.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=P,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(P);try{await navigator.clipboard.writeText(P),new D.Notice("Generated and copied companion token.")}catch(A){new D.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",A)}})),f.createEl("h3",{text:"Annotation color map"}),f.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let k=f.createDiv({cls:"zrr-annotation-map"}),b=async L=>{this.plugin.settings.annotationColorMap=L,await this.plugin.saveSettings()},S=()=>{var T,M;k.empty();let L=this.plugin.settings.annotationColorMap||{},P=Object.entries(L);if(P.length||k.createEl("p",{text:"No color mappings configured."}),P.length){let I=k.createDiv({cls:"zrr-annotation-map-row-header"});I.createEl("span",{text:"Color"}),I.createEl("span",{text:"Heading"}),I.createEl("span",{text:"Callout"}),I.createEl("span")}for(let[I,F]of P){let O=k.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),q=O.createEl("input",{type:"text",value:I,cls:"zrr-annotation-map-input"}),$=O.createEl("input",{type:"text",value:(T=F.heading)!=null?T:"",cls:"zrr-annotation-map-input"}),B=O.createEl("input",{type:"text",value:(M=F.callout)!=null?M:"",cls:"zrr-annotation-map-input"}),J=O.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});J.type="button",q.addEventListener("change",async()=>{let V=q.value.trim().toLowerCase();if(!V){q.value=I;return}let Y={...this.plugin.settings.annotationColorMap||{}};if(V!==I&&Y[V]){new D.Notice(`Annotation color '${V}' already exists.`),q.value=I;return}let X=Y[I];delete Y[I],Y[V]=X!=null?X:{heading:"",callout:""},await b(Y),S()}),$.addEventListener("change",async()=>{var X;let V={...this.plugin.settings.annotationColorMap||{}},Y=(X=V[I])!=null?X:{heading:"",callout:""};Y.heading=$.value.trim(),V[I]=Y,await b(V)}),B.addEventListener("change",async()=>{var X;let V={...this.plugin.settings.annotationColorMap||{}},Y=(X=V[I])!=null?X:{heading:"",callout:""};Y.callout=B.value.trim(),V[I]=Y,await b(V)}),J.addEventListener("click",async()=>{let V={...this.plugin.settings.annotationColorMap||{}};delete V[I],await b(V),S()})}let A=k.createDiv({cls:"zrr-annotation-map-actions"}),E=A.createEl("button",{text:"Add mapping"});E.type="button",E.addEventListener("click",async()=>{let I={...this.plugin.settings.annotationColorMap||{}},F="new-color",j=1;for(;I[F];)F=`new-color-${j}`,j+=1;I[F]={heading:"",callout:""},await b(I),S()});let z=A.createEl("button",{text:"Reset to defaults"});z.type="button",z.addEventListener("click",async()=>{await b({...Ie.annotationColorMap}),S()})};S()}},{id:"ocr",label:"OCR",render:f=>{f.createEl("h2",{text:"Docling"});let k=null,b=A=>{if(!k)return;let E=this.plugin.settings.ocrEngine;new Set(A.map(T=>T.value)).has(E)||(A=A.concat([{value:E,label:`Current (unavailable): ${E}`}])),k.selectEl.options.length=0;for(let T of A)k.addOption(T.value,T.label);k.setValue(E)},S=async()=>{if(!k)return;k.setDisabled(!0);let A={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{A=await this.plugin.detectOcrEngines()}catch(T){A={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let E=[{value:"auto",label:"Auto (default)"}];A.tesseract&&E.push({value:"tesseract",label:"Tesseract (local)"}),A.paddleStructureLocal&&E.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),A.paddleVlLocal&&E.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(E.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),E.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),b(E),k.setDisabled(!1)},L=new D.Setting(f).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),P=document.createElement("a");P.href="https://aistudio.baidu.com/paddleocr",P.textContent="https://aistudio.baidu.com/paddleocr",P.target="_blank",P.rel="noopener noreferrer",L.descEl.appendChild(P),L.descEl.append("."),L.addText(A=>{i(A),A.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async E=>{this.plugin.settings.paddleApiKey=E.trim(),await this.plugin.saveSettings(),await S()})}),new D.Setting(f).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(A=>A.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async E=>{this.plugin.settings.paddleVlApiUrl=E.trim(),await this.plugin.saveSettings()})),new D.Setting(f).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(A=>A.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async E=>{this.plugin.settings.paddleStructureApiUrl=E.trim(),await this.plugin.saveSettings(),await S()})),new D.Setting(f).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(A=>{k=A,A.addOption("auto","Auto (default)"),A.setValue(this.plugin.settings.ocrEngine),A.onChange(async E=>{this.plugin.settings.ocrEngine=E,await this.plugin.saveSettings()})}),new D.Setting(f).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(A=>A.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async E=>{this.plugin.settings.ocrMode=E,await this.plugin.saveSettings()})),new D.Setting(f).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(A=>A.setValue(this.plugin.settings.forcePerPageOcr).onChange(async E=>{this.plugin.settings.forcePerPageOcr=E,await this.plugin.saveSettings()})),new D.Setting(f).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(A=>{A.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async E=>{this.plugin.settings.ocrQualityThreshold=E,await this.plugin.saveSettings()})}),new D.Setting(f).setName("Chunking").setDesc("page or section").addDropdown(A=>A.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async E=>{this.plugin.settings.chunkingMode=E,await this.plugin.saveSettings()})),S()}},{id:"llms",label:"LLMs",render:f=>{f.createEl("h2",{text:"LLM Provider Profiles"});let k=f.createDiv({cls:"zrr-llm-profiles"}),b=()=>{k.empty();let v=n();v.length||k.createEl("p",{text:"No profiles yet. Add one below."});for(let w of v){let R=k.createEl("details",{cls:"zrr-profile"});v.length===1&&(R.open=!0);let G=R.createEl("summary",{text:w.name||w.id||"Profile"});G.addClass("zrr-profile-title");let Le=R.createDiv({cls:"zrr-profile-body"});new D.Setting(Le).setName("Profile name").addText(le=>le.setPlaceholder("My provider").setValue(w.name||"").onChange(async de=>{w.name=de.trim(),G.textContent=w.name||w.id||"Profile",await t(n())})),new D.Setting(Le).setName("Base URL").addText(le=>le.setPlaceholder("http://localhost:1234/v1").setValue(w.baseUrl||"").onChange(async de=>{w.baseUrl=de.trim(),await t(n())})),new D.Setting(Le).setName("API key").setDesc("Stored in settings (not encrypted).").addText(le=>{i(le),le.setPlaceholder("sk-...").setValue(w.apiKey||"").onChange(async de=>{w.apiKey=de.trim(),await t(n())})}),new D.Setting(Le).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(le=>le.setButtonText("Delete profile").onClick(async()=>{let de=n().filter(Yn=>Yn.id!==w.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===w.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===w.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===w.id?"":this.plugin.settings.llmCleanupProviderProfileId,await t(de),b()}))}new D.Setting(k).addButton(w=>w.setButtonText("Add profile").onClick(async()=>{let R=`profile-${Date.now().toString(36)}`,G=n().concat([{id:R,name:"Custom",baseUrl:"",apiKey:""}]);await t(G),b()}))};b(),f.createEl("h2",{text:"OCR cleanup"}),new D.Setting(f).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(v=>v.setValue(this.plugin.settings.enableLlmCleanup).onChange(async w=>{this.plugin.settings.enableLlmCleanup=w,await this.plugin.saveSettings()}));let S=null,L=null,P=null,A=async()=>{},E=async(v,w=!0)=>{let R=v.trim();this.plugin.settings.llmCleanupBaseUrl=R,w&&(this.plugin.settings.llmCleanupProviderProfileId="",S&&S.setValue("custom")),L&&L.setValue(R),await this.plugin.saveSettings()},z=async v=>{let w=n().find(R=>R.id===v);this.plugin.settings.llmCleanupProviderProfileId=v,w&&(this.plugin.settings.llmCleanupBaseUrl=w.baseUrl,this.plugin.settings.llmCleanupApiKey=w.apiKey,L==null||L.setValue(w.baseUrl),P==null||P.setValue(w.apiKey)),await this.plugin.saveSettings(),await A()};new D.Setting(f).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(v=>{S=v,v.addOption("custom","Custom (manual)");for(let R of n())v.addOption(R.id,R.name||R.id);let w=this.plugin.settings.llmCleanupProviderProfileId;v.setValue(w&&n().some(R=>R.id===w)?w:"custom"),v.onChange(async R=>{if(R==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await z(R)})}),new D.Setting(f).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(v=>{L=v,v.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async w=>{await E(w)})}),new D.Setting(f).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(v=>{P=v,i(v),v.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async w=>{this.plugin.settings.llmCleanupApiKey=w.trim(),this.plugin.settings.llmCleanupProviderProfileId="",S&&S.setValue("custom"),await this.plugin.saveSettings()})});let T=new D.Setting(f).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),M=null,I=v=>{if(!M)return;let w=(this.plugin.settings.llmCleanupModel||"").trim(),R=new Set(v.map(G=>G.value));w&&!R.has(w)&&(v=v.concat([{value:w,label:`Custom (${w})`}])),M.selectEl.options.length=0;for(let G of v)M.addOption(G.value,G.label);w&&M.setValue(w)};A=async()=>{if(M){M.setDisabled(!0);try{let v=await this.plugin.fetchCleanupModelOptions();I(v)}finally{M.setDisabled(!1)}}},T.addDropdown(v=>{M=v;let w=(this.plugin.settings.llmCleanupModel||"").trim();v.addOption(w||"loading","Loading..."),v.setValue(w||"loading"),v.onChange(async R=>{this.plugin.settings.llmCleanupModel=R.trim(),await this.plugin.saveSettings()})}),T.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await A()})}),A(),new D.Setting(f).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(v=>v.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async w=>{let R=Number.parseFloat(w);this.plugin.settings.llmCleanupTemperature=Number.isFinite(R)?R:0,await this.plugin.saveSettings()})),new D.Setting(f).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(v=>v.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async w=>{this.plugin.settings.llmCleanupMinQuality=w,await this.plugin.saveSettings()})),new D.Setting(f).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(v=>v.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async w=>{let R=Number.parseInt(w,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(R)?R:2e3,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Text Embedding"});let F=null,j=null,O=null,q=async()=>{},$=async(v,w=!0)=>{let R=v.trim();this.plugin.settings.embedBaseUrl=R,w&&(this.plugin.settings.embedProviderProfileId="",F&&F.setValue("custom")),j&&j.setValue(R),await this.plugin.saveSettings()},B=async v=>{let w=n().find(R=>R.id===v);this.plugin.settings.embedProviderProfileId=v,w&&(this.plugin.settings.embedBaseUrl=w.baseUrl,this.plugin.settings.embedApiKey=w.apiKey,j==null||j.setValue(w.baseUrl),O==null||O.setValue(w.apiKey)),await this.plugin.saveSettings(),await q()};new D.Setting(f).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(v=>{F=v,v.addOption("custom","Custom (manual)");for(let R of n())v.addOption(R.id,R.name||R.id);let w=this.plugin.settings.embedProviderProfileId;v.setValue(w&&n().some(R=>R.id===w)?w:"custom"),v.onChange(async R=>{if(R==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await B(R)})}),new D.Setting(f).setName("Embeddings base URL").addText(v=>{j=v,v.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async w=>{await $(w)})}),new D.Setting(f).setName("Embeddings API key").addText(v=>{O=v,i(v),v.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async w=>{this.plugin.settings.embedApiKey=w.trim(),this.plugin.settings.embedProviderProfileId="",F&&F.setValue("custom"),await this.plugin.saveSettings()})});let J=new D.Setting(f).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),V=null,Y=v=>{if(!V)return;let w=(this.plugin.settings.embedModel||"").trim(),R=new Set(v.map(G=>G.value));w&&!R.has(w)&&(v=v.concat([{value:w,label:`Custom (${w})`}])),V.selectEl.options.length=0;for(let G of v)V.addOption(G.value,G.label);w&&V.setValue(w)};q=async()=>{if(V){V.setDisabled(!0);try{let v=await this.plugin.fetchEmbeddingModelOptions();Y(v)}finally{V.setDisabled(!1)}}},J.addDropdown(v=>{V=v;let w=(this.plugin.settings.embedModel||"").trim();v.addOption(w||"loading","Loading..."),v.setValue(w||"loading"),v.onChange(async R=>{this.plugin.settings.embedModel=R.trim(),await this.plugin.saveSettings()})}),J.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await q()})}),q(),new D.Setting(f).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(v=>v.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async w=>{this.plugin.settings.embedIncludeMetadata=w,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(v=>v.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async w=>{let R=Number.parseInt(w,10);this.plugin.settings.embedContextWindow=Number.isFinite(R)?Math.max(0,R):1,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(v=>v.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async w=>{let R=Number.parseInt(w,10);this.plugin.settings.embedContextChars=Number.isFinite(R)?Math.max(0,R):220,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(v=>v.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async w=>{let R=Number.parseInt(w,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(R)?Math.max(0,R):3500,await this.plugin.saveSettings()})),new D.Setting(f).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(v=>v.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async w=>{let R=Number.parseInt(w,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(R)?Math.max(0,R):200,await this.plugin.saveSettings()})),new D.Setting(f).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(v=>v.setValue(this.plugin.settings.enableChunkTagging).onChange(async w=>{this.plugin.settings.enableChunkTagging=w,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Chat LLM"});let X=null,ie=null,se=null,ge=async()=>{},Ye=async(v,w=!0)=>{let R=v.trim();this.plugin.settings.chatBaseUrl=R,w&&(this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom")),ie&&ie.setValue(R),await this.plugin.saveSettings()},Qe=async v=>{let w=n().find(R=>R.id===v);this.plugin.settings.chatProviderProfileId=v,w&&(this.plugin.settings.chatBaseUrl=w.baseUrl,this.plugin.settings.chatApiKey=w.apiKey,ie==null||ie.setValue(w.baseUrl),se==null||se.setValue(w.apiKey)),await this.plugin.saveSettings(),await ge()};new D.Setting(f).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(v=>{X=v,v.addOption("custom","Custom (manual)");for(let R of n())v.addOption(R.id,R.name||R.id);let w=this.plugin.settings.chatProviderProfileId;v.setValue(w&&n().some(R=>R.id===w)?w:"custom"),v.onChange(async R=>{if(R==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await Qe(R)})}),new D.Setting(f).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(v=>{ie=v,v.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async w=>{await Ye(w)})}),new D.Setting(f).setName("Chat API key").addText(v=>{se=v,i(v),v.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async w=>{this.plugin.settings.chatApiKey=w.trim(),this.plugin.settings.chatProviderProfileId="",X&&X.setValue("custom"),await this.plugin.saveSettings()})});let Se=new D.Setting(f).setName("Chat model").setDesc("Select a chat-capable model from the provider."),re=null,en=v=>{if(!re)return;let w=(this.plugin.settings.chatModel||"").trim(),R=new Set(v.map(G=>G.value));w&&!R.has(w)&&(v=v.concat([{value:w,label:`Custom (${w})`}])),re.selectEl.options.length=0;for(let G of v)re.addOption(G.value,G.label);w&&re.setValue(w)};ge=async()=>{if(re){re.setDisabled(!0);try{let v=await this.plugin.fetchChatModelOptions();en(v)}finally{re.setDisabled(!1)}}},Se.addDropdown(v=>{re=v;let w=(this.plugin.settings.chatModel||"").trim();v.addOption(w||"loading","Loading..."),v.setValue(w||"loading"),v.onChange(async R=>{this.plugin.settings.chatModel=R.trim(),await this.plugin.saveSettings()})}),Se.addButton(v=>{v.setButtonText("Refresh").onClick(async()=>{await ge()})}),ge(),new D.Setting(f).setName("Temperature").addText(v=>v.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async w=>{let R=Number.parseFloat(w);this.plugin.settings.chatTemperature=Number.isFinite(R)?R:.2,await this.plugin.saveSettings()})),new D.Setting(f).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(v=>v.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async w=>{let R=Number.parseInt(w,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(R)?Math.max(0,R):6,await this.plugin.saveSettings()})),new D.Setting(f).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(v=>v.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async w=>{this.plugin.settings.chatPaneLocation=w,await this.plugin.saveSettings()})),f.createEl("h2",{text:"Retrieval"}),new D.Setting(f).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(v=>v.setValue(this.plugin.settings.enableQueryExpansion).onChange(async w=>{this.plugin.settings.enableQueryExpansion=w,await this.plugin.saveSettings()})),new D.Setting(f).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(v=>v.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async w=>{let R=Number.parseInt(w,10);this.plugin.settings.queryExpansionCount=Number.isFinite(R)?Math.max(1,R):3,await this.plugin.saveSettings()})),new D.Setting(f).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(v=>v.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async w=>{this.plugin.settings.enableCrossEncoderRerank=w,await this.plugin.saveSettings()})),new D.Setting(f).setName("Cross-encoder model").setDesc("Local reranker model name or path.").addText(v=>v.setPlaceholder("BAAI/bge-reranker-v2-m3").setValue(this.plugin.settings.rerankModel).onChange(async w=>{this.plugin.settings.rerankModel=w.trim()||"BAAI/bge-reranker-v2-m3",await this.plugin.saveSettings()})),new D.Setting(f).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(v=>v.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async w=>{let R=Number.parseInt(w,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(R)?Math.max(1,R):4,await this.plugin.saveSettings()})),new D.Setting(f).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(v=>v.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async w=>{let R=Number.parseInt(w,10);this.plugin.settings.rrfK=Number.isFinite(R)?Math.max(1,R):60,await this.plugin.saveSettings()})),new D.Setting(f).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(v=>v.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async w=>{let R=Number.parseInt(w,10);this.plugin.settings.rrfLogTop=Number.isFinite(R)?Math.max(0,R):0,await this.plugin.saveSettings()})),new D.Setting(f).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(v=>v.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async w=>{let R=Number.parseInt(w,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(R)?Math.max(0,R):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:f=>{f.createEl("h2",{text:"Logging"}),new D.Setting(f).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(k=>k.setValue(this.plugin.settings.enableFileLogging).onChange(async b=>{this.plugin.settings.enableFileLogging=b,await this.plugin.saveSettings()})),new D.Setting(f).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(k=>k.setPlaceholder(`${ee}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async b=>{this.plugin.settings.logFilePath=b.trim()||`${ee}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new D.Setting(f).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(k=>k.setButtonText("Open log").onClick(async()=>{var b,S;await((S=(b=this.plugin).openLogFile)==null?void 0:S.call(b))})).addButton(k=>k.setButtonText("Clear log").onClick(async()=>{var b,S;await((S=(b=this.plugin).clearLogFile)==null?void 0:S.call(b))})),f.createEl("h2",{text:"Zotero Companion Plugin"}),f.createEl("p",{text:"Download the XPI, then in Zotero go to Tools \u2192 Add-ons \u2192 Install from File and restart."}),new D.Setting(f).setName("Download companion add-on").setDesc("Downloads the companion XPI to your system Downloads folder.").addButton(k=>k.setButtonText("Download XPI").onClick(async()=>{let b=this.getDefaultDownloadDir();if(!b){new D.Notice("Unable to resolve the system Downloads folder.");return}let S=Te.default.join(b,"zrr-companion.xpi");if(await this.companionXpiExists(S)){new D.Notice(`Companion XPI already exists: ${S}`);return}new D.Notice("Downloading companion XPI..."),await this.downloadCompanionXpi(S)})),new D.Setting(f).setName("Open Zotero").setDesc("Launch Zotero and open the Add-ons window (Tools \u2192 Add-ons).").addButton(k=>k.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new D.Setting(f).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(k=>k.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),f.createEl("h2",{text:"Redis Indexing"}),new D.Setting(f).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(k=>k.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new D.Setting(f).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(k=>k.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(k=>k.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()}))}}],p=new Map,u=new Map,m=f=>{this.activeTab=f;for(let[k,b]of p){let S=k===f;b.classList.toggle("is-active",S),b.setAttribute("aria-selected",S?"true":"false"),b.setAttribute("tabindex",S?"0":"-1")}for(let[k,b]of u){let S=k===f;b.classList.toggle("is-active",S),b.hidden=!S}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let x=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let f of d){let k=y.createEl("button",{text:f.label,cls:"zrr-settings-tab-button"}),b=`zrr-settings-tab-${f.id}`,S=`zrr-settings-panel-${f.id}`;k.type="button",k.id=b,k.setAttribute("role","tab"),k.setAttribute("aria-controls",S),k.setAttribute("aria-selected","false"),k.addEventListener("click",()=>m(f.id));let L=x.createDiv({cls:"zrr-settings-tab-panel"});L.id=S,L.setAttribute("role","tabpanel"),L.setAttribute("aria-labelledby",b),L.hidden=!0,f.render(L),p.set(f.id,k),u.set(f.id,L)}let C=d.some(f=>f.id===this.activeTab)?this.activeTab:d[0].id;m(C)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Te.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await De.promises.access(e),!0}catch(n){return!1}}async downloadCompanionXpi(e){try{await De.promises.mkdir(Te.default.dirname(e),{recursive:!0});let n=await(0,D.requestUrl)({url:ct,method:"GET"});if(n.status!==200){new D.Notice(`Failed to download companion XPI (HTTP ${n.status}).`);return}let t=Buffer.from(n.arrayBuffer);await De.promises.writeFile(e,t),new D.Notice(`Downloaded companion XPI: ${e}`)}catch(n){new D.Notice("Failed to download companion XPI. See console for details."),console.warn("Failed to download companion XPI",n)}}};var Cn=require("@codemirror/state"),Sn=require("@codemirror/view"),oe=require("obsidian");var dt=g=>{let _=g.scrollDOM.getBoundingClientRect(),e=g.posAtCoords({x:_.left+8,y:+_.height*.25});return e===null?null:g.state.doc.lineAt(e).number},Fe=class{constructor(_,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.deps=_,this.helpers=e}createSyncExtension(){let _=this,e=this.helpers;return Sn.ViewPlugin.fromClass(class{constructor(n){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=n,this.docId=e.extractDocIdFromDoc(n.state.doc),this.onScroll=()=>this.scheduleSync(!1),n.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(n){n.docChanged&&(this.docId=e.extractDocIdFromDoc(n.view.state.doc),this.lastPage=null,this.lastChunkId=null),(n.docChanged||n.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(n){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,n)}))}syncPdfSidebar(n,t){var p,u;let i=this.docId;if(!i)return;let r=dt(n);if(r===null)return;let a=e.findChunkStartLineInDoc(n.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(p=s==null?void 0:s.pageNumber)!=null?p:null,l=(u=s==null?void 0:s.chunkId)!=null?u:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!t&&(c||d)||(this.lastPage=o,this.lastChunkId=l,_.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,n;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((n=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:n.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let _=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(_.docId,_.pageNumber,_.chunkId)}updatePreviewScrollHandler(){var t;let _=this.deps.app.workspace.getActiveViewOfType(oe.MarkdownView);if(!_||_.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(t=_.previewMode)==null?void 0:t.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let n=()=>this.schedulePreviewSync(_);e.addEventListener("scroll",n,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=n,this.schedulePreviewSync(_)}async syncPdfSidebarForFile(_){try{let e=await this.deps.app.vault.read(_),n=await this.deps.resolveDocIdForNote(_,e);if(!n)return;let t=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(n,t==null?void 0:t.pageNumber,t==null?void 0:t.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(_,e,n){if(!_)return;let t=await this.deps.getDocIndexEntry(_);t||(t=await this.deps.hydrateDocIndexFromCache(_));let i=t!=null&&t.pdf_path?String(t.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let u=(0,oe.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(u)instanceof oe.TFile&&(r=u)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof oe.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:n};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:n};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&n&&(o=await this.resolvePageNumberForChunk(_,n)),o===null||this.pdfSidebarDocId===_&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=_,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,c=o!==null?`${l}#page=${o}`:l,d=this.deps.app.workspace,p=d.getMostRecentLeaf();d.setActiveLeaf(s,{focus:!1});try{await this.openPdfLinkInLeaf(s,c),this.updatePdfSidebarIcon(s)}finally{p&&d.setActiveLeaf(p,{focus:!1})}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(_){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(_)}))}syncPdfSidebarForPreview(_){let e=this.previewScrollEl;if(!e)return;let n=_.getViewData();if(!n)return;let t=Cn.Text.of(n.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(t);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(t,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(_){var t;let e=_.getBoundingClientRect().top,n=_.querySelectorAll("[data-line]");for(let i of Array.from(n))if(i.getBoundingClientRect().bottom>=e+2){let a=(t=i.getAttribute("data-line"))!=null?t:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var t,i;if(this.pdfSidebarLeaf&&((i=(t=this.pdfSidebarLeaf.view)==null?void 0:t.getViewType)==null?void 0:i.call(t))==="pdf")return this.pdfSidebarLeaf;let _=this.deps.app.workspace;if(typeof _.ensureSideLeaf=="function")try{let r=await _.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let n=this.deps.app.workspace.getRightLeaf(!0);return n&&this.isRightSidebarLeaf(n)?(this.pdfSidebarLeaf=n,this.updatePdfSidebarIcon(n),n):null}isRightSidebarLeaf(_){if(!_)return!1;let n=_.containerEl;return!!(n!=null&&n.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(_){if(!_||!this.isRightSidebarLeaf(_))return;let n=_.containerEl,t=[];n&&t.push(...Array.from(n.querySelectorAll(".view-header-icon")));let i=_;if(i.tabHeaderEl&&t.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&t.push(i.tabHeaderInnerIconEl),t.length===0)return;let r=new Set;for(let s of t)r.has(s)||(r.add(s),s.innerHTML="",(0,oe.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=_.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(_,e){var r,a,s;let n=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],t=(s=(a=n==null?void 0:n.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof t=="function"){await t.call(n.lib.workspace,_,e,"",{active:!1});return}let i=_;if(typeof i.openLinkText=="function"){await i.openLinkText(e,"",{active:!1});return}await this.deps.app.workspace.openLinkText(e,"",!1)}getPluginsRegistry(){var _;return(_=this.deps.app.plugins)==null?void 0:_.plugins}isLeafTabActive(_){var i;let e=_;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===_;let n=e.containerEl;if(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))return!0;let t=e.tabHeaderEl;return!!(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))}async resolvePageNumberForChunk(_,e){var l,c,d,p,u;if(!_||!e)return null;let n=this.deps.normalizeChunkIdForNote(e,_)||e,t=this.chunkPageCache.get(_);if(t&&t.has(n))return(l=t.get(n))!=null?l:null;let i=(0,oe.normalizePath)(`${H}/${_}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let m of s){let y=typeof(m==null?void 0:m.chunk_id)=="string"?m.chunk_id.trim():"";if(!y)continue;let x=Number.isFinite((c=m==null?void 0:m.page_start)!=null?c:NaN)?Number(m.page_start):null,C=Number.isFinite((d=m==null?void 0:m.page_end)!=null?d:NaN)?Number(m.page_end):null,f=x!=null?x:C;f!==null&&(o.set(y,f),o.set(`${_}:${y}`,f))}return this.chunkPageCache.set(_,o),(u=(p=o.get(n))!=null?p:o.get(e))!=null?u:null}};var ze={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.6.6
aai
aam
abb
abge
...
\xF6pnv
\xFCberarb
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.6.6
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.6.6
services:
  redis-stack:
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,n=1200){let t=this.noteSyncTimers.get(e.path);t!==void 0&&window.clearTimeout(t);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},n);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,n=1200,t="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,t)},n);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,n=1200,t="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,t)},n);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let n=this.annotationNoteEditTimes.get(e);if(!n)return 0;let t=Date.now()-n;return t>=Hn?0:Hn-t}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let n=(e.annotation_page_label||"").trim();if(n)return n;let t=e.page_start?String(e.page_start):"",i=e.page_end?String(e.page_end):"";if(t&&(!i||t===i))return t;if(t&&i)return`${t} - ${i}`;let r=(e.pages||"").trim();if(!r)return"?";let a=r.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:r.replace("-"," - ")}normalizeChunkIdForNote(e,n){if(!e)return null;let t=String(e);if(n&&t.startsWith(`${n}:`))return t.slice(n.length+1);if(t.includes(":")){let i=t.split(":");if(i.length>1&&n&&i[0]===n)return i.slice(1).join(":")}return t}async syncNoteToRedis(e){var n,t,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,h.normalizePath)(`${H}/${s}.json`),c=this.app.vault.adapter;if(!await c.exists(l))return;let d=await this.readChunkPayload(l);if(!d)return;let p=Array.isArray(d.chunks)?d.chunks:[],u=new Map;for(let b of p){if(this.isAnnotationChunk(b))continue;let S=typeof(b==null?void 0:b.chunk_id)=="string"?b.chunk_id:String((n=b==null?void 0:b.chunk_id)!=null?n:"");S&&u.set(S,b)}let m=new Set,y=new Set,x=new Set,C=new Set,f=!1;for(let b of o){let S=b.chunkId;if(!S)continue;m.add(S);let L=u.get(S);if(!L){console.warn(`Sync note: chunk id not found in cache (${S})`);continue}if(b.excludeFlag){L.excluded!==!0&&(L.excluded=!0,f=!0);let E=this.normalizeChunkText(b.text);E&&E!==String((t=L.text)!=null?t:"")&&(L.text=E,L.char_count=E.length,f=!0),x.add(S);continue}if(L.excluded&&(L.excluded=!1,f=!0,y.add(S)),!b.text.trim()){x.add(S),C.add(S);continue}let P=this.normalizeChunkText(b.text);if(!P){x.add(S),C.add(S);continue}let A=typeof L.text=="string"?L.text:String((i=L.text)!=null?i:"");P!==A&&(L.text=P,L.char_count=P.length,y.add(S),f=!0)}for(let b of u.keys())m.has(b)||(x.add(b),C.add(b));let k=new Set([...x,...C]);if(k.size){let b=Array.from(k).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==b){this.noteSyncPendingDeletes.set(e.path,b),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!y.size&&!x.size&&!C.size&&!f)return;C.size&&(d.chunks=p.filter(b=>{var L;let S=typeof(b==null?void 0:b.chunk_id)=="string"?b.chunk_id:String((L=b==null?void 0:b.chunk_id)!=null?L:"");return S&&!C.has(S)}),f=!0),(f||C.size)&&await c.write(l,JSON.stringify(d,null,2)),await this.reindexChunkUpdates(s,l,Array.from(y),Array.from(x)),(x.size||C.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,n){var t,i,r;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,n);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),s=await this.resolveDocIdForNote(e,a);if(!s)return;let o=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter;if(!o)return;let l=this.resolveZoteroItemKey(o,s);if(!l)return;let c=await this.fetchZoteroItem(l),d=(i=c==null?void 0:c.data)!=null?i:c;if(!d||typeof d!="object")return;let p=this.extractNoteMetadata(o),u=this.extractZoteroMetadata(d),m=await this.getMetadataSnapshot(s,o,e),y={},x={},C={},f=[],k=["title","short_title","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],b={title:"title",short_title:"short_title",date:"date",abstract:"abstract",doi:"doi",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},S=k.filter(P=>this.hasFrontmatterKey(o,b[P]));if(!S.length)return;let L={title:"Title",short_title:"Short title",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let P of S){let A=p[P],E=u[P];if(this.metadataValuesEqual(P,A,E))continue;let z=m==null?void 0:m[P];if(z!==void 0){let M=!this.metadataValuesEqual(P,A,z),I=!this.metadataValuesEqual(P,E,z);if(M&&!I){C[P]="note",this.assignMetadataUpdate(x,P,A);continue}if(!M&&I){C[P]="zotero",this.assignMetadataUpdate(y,P,E);continue}}let T=this.getMetadataDecisionLabels(P,A,E,L);f.push({field:P,fieldLabel:L[P],noteLabel:T.noteLabel,zoteroLabel:T.zoteroLabel,noteValue:this.formatMetadataValue(A),zoteroValue:this.formatMetadataValue(E)})}if(f.length>0){let P=await this.promptMetadataBatchDecision(f);for(let A of f){let E=(r=P[A.field])!=null?r:"skip";C[A.field]=E,E==="note"?this.assignMetadataUpdate(x,A.field,p[A.field]):E==="zotero"&&this.assignMetadataUpdate(y,A.field,u[A.field])}}Object.keys(y).length>0&&await this.applyNoteMetadataUpdates(e,y),Object.keys(x).length>0&&await this.applyZoteroMetadataUpdates(l,d,p,u,x),await this.updateMetadataSnapshot(e,s,p,u,m,C,S)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,n)}}async syncNoteAnnotationsWithZotero(e,n){var t,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,n);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let F=this.ensureDocIdInNoteContent(o,d);F!==o&&await this.writeNoteWithSyncSuppressed(e.path,F)}if(!d)return;let p=(i=(t=this.app.metadataCache.getFileCache(e))==null?void 0:t.frontmatter)!=null?i:{},u=(r=c.attachmentKey)!=null?r:"";if(u||(u=await this.resolveAttachmentKeyForDocId(d,p)),!u)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===u&&await this.updateDocIndex({doc_id:d,attachment_key:u});let m=u,y=await this.fetchZoteroAnnotationsForDoc(d,u),x=y.annotations;u=y.attachmentKey,u&&u!==m&&await this.updateDocIndex({doc_id:d,attachment_key:u});let C=this.parseAnnotationBlock(l.block,u),f=new Map;for(let F of C)F.key&&F.imagePath&&f.set(F.key,{path:F.imagePath,hash:F.imageHash||this.extractAnnotationImageHashFromPath(F.imagePath)});await this.attachAnnotationImages(d,u,x,e.path,f);let k=new Map;for(let F of C)F.key&&k.set(F.key,F);let b=new Map;for(let F of x)b.set(F.key,F);let S=await this.getAnnotationSnapshot(d),L=(a=S==null?void 0:S.annotations)!=null?a:{},P={},A=[],E=!1,z=!1,T=!1;u&&u!==m&&x.length>0&&(z=!0,T=!0);for(let[F,j]of b.entries()){let O=k.get(F);if(!O){z=!0;continue}let q=L[F],$=this.annotationSnapshotFromEntry(O,j.annotationType),B=this.annotationSnapshotFromEntry(j,j.annotationType),J=($.image_hash||"")!==(B.image_hash||"");if(!q){this.annotationSnapshotsEqualIgnoringImage($,B)?J&&(z=!0,T=!0):(P[F]="note",E=!0);continue}let V=!this.annotationSnapshotsEqual($,q),Y=!this.annotationSnapshotsEqual(B,q),X=(B.color_key||"")!==(q.color_key||""),ie=!this.annotationSnapshotsEqualIgnoringImage($,q),se=!this.annotationSnapshotsEqualIgnoringImage(B,q);ie&&!se?(P[F]="note",E=!0):!ie&&se?(P[F]="zotero",z=!0):ie&&se&&A.push({key:F,title:this.formatAnnotationConflictTitle(j),noteValue:this.formatAnnotationConflictValue($,O.tags),zoteroValue:this.formatAnnotationConflictValue(B,j.tags)}),J&&(V||Y)&&(z=!0,T=!0),X&&(z=!0,T=!0)}if(A.length>0){let F=await this.promptAnnotationBatchDecision(A);for(let j of A){let O=(s=F[j.key])!=null?s:"skip";P[j.key]=O,O==="note"?E=!0:O==="zotero"&&(z=!0,T=!0)}}let M=[];for(let[F,j]of Object.entries(P)){if(j!=="note")continue;let O=k.get(F),q=b.get(F);!O||!q||M.push({entry:q,note:O})}M.length>0&&await this.applyZoteroAnnotationUpdates(M),E&&this.annotationNoteEditTimes.set(e.path,Date.now());let I=this.getAnnotationGraceRemaining(e.path);if(z&&I>0&&E&&!T&&(this.scheduleNoteAnnotationSync(e,I+250,n),z=!1),z){let F=this.buildAnnotationBlock(d,u,x),j=this.replaceAnnotationBlock(o,F);if(j&&j!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,j)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,u,x),await this.updateAnnotationChunks(d,u,x)}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,n)}}resolveZoteroItemKey(e,n){let t=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),n];for(let i of t){let r=Z(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,n){var l;if(!e)return"";let t=await this.getDocIndexEntry(e);if(t||(t=await this.hydrateDocIndexFromCache(e)),t!=null&&t.attachment_key)return t.attachment_key;let i=(0,h.normalizePath)(`${H}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let d=await this.readChunkPayload(i),p=d!=null&&d.metadata&&typeof d.metadata=="object"?d.metadata:null,u=p==null?void 0:p.attachment_key;if(typeof u=="string"&&u.trim())return await this.updateDocIndex({doc_id:e,attachment_key:u.trim()}),u.trim()}}catch(c){}let r=this.resolveZoteroItemKey(n,e);if(!r)return"";let a=await this.fetchZoteroItem(r),s=(l=a==null?void 0:a.data)!=null?l:a;if(!s||typeof s!="object")return"";let o=await ve(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var x,C,f,k,b,S,L,P,A;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString((k=(f=(C=(x=e==null?void 0:e["short title"])!=null?x:e==null?void 0:e.short_title)!=null?C:e==null?void 0:e.shortTitle)!=null?f:e==null?void 0:e["short-title"])!=null?k:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString((b=e==null?void 0:e.abstract)!=null?b:e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((S=e==null?void 0:e.doi)!=null?S:e==null?void 0:e.DOI),s=this.normalizeMetadataString(e==null?void 0:e.publisher),o=this.normalizeMetadataString(e==null?void 0:e.place),l=this.normalizeMetadataString(e==null?void 0:e.issue),c=this.normalizeMetadataString(e==null?void 0:e.volume),d=this.normalizeMetadataString(e==null?void 0:e.pages),p=this.normalizeMetadataString((A=(P=(L=e==null?void 0:e["item type"])!=null?L:e==null?void 0:e.item_type)!=null?P:e==null?void 0:e.itemType)!=null?A:e==null?void 0:e["item-type"]),u=this.normalizeMetadataList(e==null?void 0:e.tags),m=this.normalizeMetadataList(e==null?void 0:e.authors),y=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:n,short_title:t,date:i,abstract:r,doi:a,publisher:s,place:o,issue:l,volume:c,pages:d,item_type:p,tags:this.sanitizeObsidianTags(u),authors:m,editors:y}}extractZoteroMetadata(e){var C,f,k;let n=this.normalizeMetadataString(e==null?void 0:e.title),t=this.normalizeMetadataString(me(e)),i=this.normalizeMetadataString(e==null?void 0:e.date),r=this.normalizeMetadataString(e==null?void 0:e.abstractNote),a=this.normalizeMetadataString((C=e==null?void 0:e.DOI)!=null?C:e==null?void 0:e.doi),s=this.normalizeMetadataString(e==null?void 0:e.publisher),o=this.normalizeMetadataString(e==null?void 0:e.place),l=this.normalizeMetadataString(e==null?void 0:e.issue),c=this.normalizeMetadataString(e==null?void 0:e.volume),d=this.normalizeMetadataString(e==null?void 0:e.pages),p=this.normalizeMetadataString((k=(f=e==null?void 0:e.itemType)!=null?f:e==null?void 0:e.item_type)!=null?k:e==null?void 0:e["item-type"]),u=Array.isArray(e==null?void 0:e.creators)?e.creators:[],m=u.filter(b=>(b==null?void 0:b.creatorType)==="author").map(b=>he(b)).filter(Boolean),y=u.filter(b=>(b==null?void 0:b.creatorType)==="editor"||(b==null?void 0:b.creatorType)==="seriesEditor").map(b=>he(b)).filter(Boolean),x=Array.isArray(e==null?void 0:e.tags)?e.tags.map(b=>typeof b=="string"?b:b==null?void 0:b.tag).filter(b=>typeof b=="string"):[];return{title:n,short_title:t,date:i,abstract:r,doi:a,publisher:s,place:o,issue:l,volume:c,pages:d,item_type:p,tags:this.sanitizeObsidianTags(x),authors:this.normalizeMetadataList(m),editors:this.normalizeMetadataList(y)}}extractAnnotationPageInfo(e){var a;let t=Z((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:t,pageIndex:i}}extractAnnotationImagePayload(e){var a,s,o,l;let n=(s=(a=e.annotationImage)!=null?a:e.annotationImageData)!=null?s:e.annotationImageBase64;if(!n)return null;let t=null,i="";if(Buffer.isBuffer(n))t=n;else if(ArrayBuffer.isView(n))t=Buffer.from(n.buffer,n.byteOffset,n.byteLength);else if(n instanceof ArrayBuffer)t=Buffer.from(n);else if(typeof n=="string"){let c=n.trim();if(!c)return null;let d=c.match(/^data:([^;]+);base64,(.*)$/i);if(d&&(i=this.normalizeAnnotationImageMime(d[1]),c=d[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;t=Buffer.from(c,"base64")}if(!t||!t.length)return null;i||(i=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(t)||"image/png");let r=this.annotationImageExtensionFromMime(i)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(t))||"png";return{buffer:t,mime:i,ext:r}}parseZoteroAnnotationItem(e,n){var C,f,k,b;let t=(f=(C=e==null?void 0:e.data)!=null?C:e)!=null?f:{},i=Z((k=e==null?void 0:e.key)!=null?k:t==null?void 0:t.key);if(!i)return null;let r=Z(t.annotationType),a=this.normalizeAnnotationText(t.annotationText),s=this.normalizeAnnotationText(t.annotationComment),o=Z(t.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:p,pageIndex:u}=this.extractAnnotationPageInfo(t),m=(b=t.annotationSortIndex)!=null?b:t.annotationSort,y=Number.isFinite(Number(m))?Number(m):0,x=Array.isArray(t.tags)?t.tags.map(S=>typeof S=="string"?S:S==null?void 0:S.tag).filter(S=>typeof S=="string"):[];return{key:i.trim(),attachmentKey:n,pageLabel:p,pageIndex:u,colorKey:l,callout:d,heading:c,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(x),sortIndex:y,rawValues:t}}async fetchZoteroAnnotations(e){if(!e)return[];let n=this.canUseWebApi()||await this.ensureWebApiLibraryId(),t=a=>{var o,l;let s=[];for(let c of a){let d=(l=(o=c==null?void 0:c.data)!=null?o:c)!=null?l:{};if(Z(d.itemType)!=="annotation")continue;let p=this.parseZoteroAnnotationItem(c,e);p&&s.push(p)}return s},i=[];try{i=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(a){try{i=await this.fetchZoteroChildrenLocal(e)}catch(s){console.warn("Failed to fetch Zotero annotation items from local API",s)}}let r=t(i);if(!r.length&&n)try{let a=[];try{a=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(o){a=await this.fetchZoteroChildrenWeb(e)}let s=t(a);s.length&&(r=s)}catch(a){console.warn("Failed to fetch Zotero annotation items from Web API",a)}return r}async fetchZoteroAnnotationsForDoc(e,n){var o,l,c;let t=n,i=await this.fetchZoteroAnnotations(t);if(i.length||!e)return i.length||this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i};let r=[];try{r=await this.fetchZoteroChildren(e)}catch(d){return console.warn("Failed to fetch Zotero attachments for annotations",d),this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}let a=[],s=new Set(t?[t]:[]);for(let d of r){if(!on(d))continue;let p=Z((c=(l=d==null?void 0:d.key)!=null?l:(o=d==null?void 0:d.data)==null?void 0:o.key)!=null?c:d==null?void 0:d.attachmentKey);!p||s.has(p)||(s.add(p),a.push(p))}for(let d of a){let p=await this.fetchZoteroAnnotations(d);if(p.length)return{attachmentKey:d,annotations:p}}return this.maybeWarnMissingAnnotationApi(e,n),{attachmentKey:t,annotations:i}}async attachAnnotationImages(e,n,t,i,r){var p;if(!this.settings.includeAnnotationImages||!t.length)return;let a=await this.resolveAnnotationImageOutputDir(i);if(!a)return;let s=this.sanitizeFileName(e||n)||"annotations",o=(0,h.normalizePath)(N.default.join(a.relative||"",s)),l=N.default.normalize(N.default.join(a.absolute,s));o?await this.ensureFolder(o):await W.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,d=new Map;for(let u of t){let m=String(u.annotationType||"").trim().toLowerCase(),y=m==="image"||m==="ink",x=this.extractAnnotationImagePayload((p=u.rawValues)!=null?p:{});if(!x&&y&&this.settings.zoteroCompanionEnabled&&(x=await this.fetchCompanionAnnotationImage(u.key)),!x){let b=r==null?void 0:r.get(u.key);b!=null&&b.path&&await c.exists(b.path)&&(u.imagePath=b.path,u.imageHash=b.hash,d.set(u.key,b.path));continue}let C=(0,Ce.createHash)("sha1").update(x.buffer).digest("hex").slice(0,12),f=`zrr-annotation-${u.key}-${C}.${x.ext}`,k=(0,h.normalizePath)(N.default.join(o,f));try{await c.exists(k)||await c.writeBinary(k,this.bufferToArrayBuffer(x.buffer)),u.imagePath=k,u.imageHash=C,d.set(u.key,k)}catch(b){console.warn("Failed to write annotation image",{annotationKey:u.key,error:b})}}if(o&&await c.exists(o))try{let u=await c.list(o);for(let m of u.files){let x=N.default.basename(m).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!x)continue;let C=x[1].toUpperCase(),f=d.get(C);(!f||(0,h.normalizePath)(f)!==(0,h.normalizePath)(m))&&await c.remove(m)}}catch(u){console.warn("Failed to clean up annotation images",u)}}async fetchCompanionAnnotationImage(e){let n=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!n)return null;let t=`${n.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,i={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(i.Authorization=`Bearer ${r}`);try{let a=await this.requestLocalApiRaw(t,{headers:i,timeoutMs:5e3});if(a.statusCode===200){let s=a.headers["content-type"],o=Array.isArray(s)?s[0]:s!=null?s:"";return this.buildAnnotationImagePayloadFromBuffer(a.body,o)}if(a.statusCode===204||a.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:a.statusCode})}catch(a){console.warn("Failed to fetch annotation image from Zotero companion",a)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new h.Notice("Zotero companion base URL is not set.");return}let n=`${e.replace(/\/$/,"")}/health`,t={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(t.Authorization=`Bearer ${i}`);try{let r=await this.requestLocalApiRaw(n,{headers:t,timeoutMs:3e3});if(r.statusCode===200){try{let a=JSON.parse(r.body.toString("utf8"));if(a!=null&&a.ok){new h.Notice("Zotero companion: OK.");return}}catch(a){}new h.Notice("Zotero companion responded but did not return OK.");return}if(r.statusCode===401){new h.Notice("Zotero companion: unauthorized (check token).");return}new h.Notice(`Zotero companion: HTTP ${r.statusCode}.`)}catch(r){console.warn("Zotero companion health check failed",r),new h.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new h.Notice("Opened Zotero. Go to Tools \u2192 Add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new h.Notice("Unable to open Zotero automatically. Open Zotero and go to Tools \u2192 Add-ons.")}}async spawnDetached(e){let[n,...t]=e;if(!n)throw new Error("Missing command");await new Promise((i,r)=>{let a=!1,s=(0,ne.spawn)(n,t,{detached:!0,stdio:"ignore"});s.on("error",o=>{a||(a=!0,r(o))}),s.unref(),a||(a=!0,i())})}maybeWarnMissingAnnotationApi(e,n){if(this.canUseWebApi()){console.info("No Zotero annotations returned for attachment",{docId:e,attachmentKey:n});return}let t=e||n;!t||this.annotationWebApiWarned.has(t)||(this.annotationWebApiWarned.add(t),new h.Notice("Zotero annotations require Web API access. Configure the Web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
...
${u}`:f)}let m=c!==null?r?` (${c})`:` page=${c}`:"",x=` id=${l}${r?" section":""}${m}${d?" exclude":""}`;a.push(`<!-- zrr:chunk${x} -->`),u&&a.push(u),a.push("<!-- zrr:chunk end -->"),a.push("")}return a[a.length-1]===""&&a.pop(),a.push("<!-- zrr:sync-end -->"),a.join(`

"use strict";var un=Object.create;var ze=Object.defineProperty;var _n=Object.getOwnPropertyDescriptor;var gn=Object.getOwnPropertyNames;var hn=Object.getPrototypeOf,fn=Object.prototype.hasOwnProperty;var mn=(g,_)=>{for(var e in _)ze(g,e,{get:_[e],enumerable:!0})},Ct=(g,_,e,t)=>{if(_&&typeof _=="object"||typeof _=="function")for(let n of gn(_))!fn.call(g,n)&&n!==e&&ze(g,n,{get:()=>_[n],enumerable:!(t=_n(_,n))||t.enumerable});return g};var he=(g,_,e)=>(e=g!=null?un(hn(g)):{},Ct(_||!g||!g.__esModule?ze(e,"default",{value:g,enumerable:!0}):e,g)),yn=g=>Ct(ze({},"__esModule",{value:!0}),g);var Zn={};mn(Zn,{default:()=>lt});module.exports=yn(Zn);var m=require("obsidian");var Tt=require("@codemirror/state"),ie=require("@codemirror/view"),Dt=require("obsidian");var fe=/<!--\s*zrr:sync-start[^>]*-->/i,we=/<!--\s*zrr:sync-end\s*-->/i,_e=/<!--\s*zrr:chunk\b([^>]*)-->/i,je=/<!--\s*zrr:chunk\s+end\s*-->/i,Ee=/<!--\s*zrr:(?:exclude|delete)\s*-->/i,At=g=>{let _=g.trim();if(!_.toLowerCase().startsWith("zrr:"))return null;if(/^zrr:sync-start\b/i.test(_)){let p=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i);return{type:"sync-start",docId:p?p[2]:void 0}}if(/^zrr:sync-end\b/i.test(_))return{type:"sync-end"};if(/^zrr:annotations-start\b/i.test(_)){let p=_.match(/\bdoc_id=(["']?)([^"'\s]+)\1/i),f=_.match(/\battachment_key=(["']?)([^"'\s]+)\1/i);return{type:"annotations-start",docId:p?p[2]:void 0,attachmentKey:f?f[2]:void 0}}if(/^zrr:annotations-end\b/i.test(_))return{type:"annotations-end"};if(/^zrr:chunk\s+end\b/i.test(_))return{type:"chunk-end"};let e=_.match(/^zrr:chunk\b(.*)$/i);if(!e)return null;let t=e[1]||"",n=t.match(/\bid=(["']?)([^"'\s]+)\1/i),i=n?n[2]:"",r=t.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),a=r?null:t.match(/\(\s*(\d+)\s*\)/),s=r?Number.parseInt(r[2],10):a?Number.parseInt(a[1],10):void 0,o=i.match(/^p(\d+)$/i),l=o?Number.parseInt(o[1],10):void 0,c=Number.isFinite(s!=null?s:NaN)?s:l,d=/\bexclude\b/i.test(t)||/\bdelete\b/i.test(t),u=/\bsection\b/i.test(t);return{type:"chunk-start",chunkId:i||void 0,excluded:d,pageNumber:Number.isFinite(c!=null?c:NaN)?c:void 0,chunkKind:u?"section":c?"page":"section"}},dt=g=>{var l;if(!g)return null;let _=g.match(_e);if(!_)return null;let e=_[1]||"",t=e.match(/\bid=(["']?)([^"'\s]+)\1/i),n=t?t[2].trim():void 0,i=e.match(/\bpage(?:_start)?=(["']?)(\d+)\1/i),r=i?null:e.match(/\(\s*(\d+)\s*\)/),a=i?Number.parseInt(i[2],10):r?Number.parseInt(r[1],10):void 0,s=n&&(l=xn(n))!=null?l:void 0,o=Number.isFinite(a!=null?a:NaN)?a:s;return{chunkId:n,pageNumber:Number.isFinite(o!=null?o:NaN)?Number(o):void 0}},$e=g=>{for(let _=1;_<=g.lines;_+=1){let e=g.line(_).text;if(fe.test(e)){let t=e.match(/doc_id=([\"']?)([^\"'\s]+)\1/i);return t?t[2].trim():null}}return null},pt=(g,_)=>{let e=_;for(;e>=1;e-=1){let t=g.line(e).text;if(_e.test(t))return{line:e,text:t};if(fe.test(t)||we.test(t))break}return null},bn=(g,_)=>{for(let e=_;e<=g.lines;e+=1){let t=g.line(e).text;if(je.test(t))return e;if(we.test(t))break}return null},Rt=(g,_)=>{let e=pt(g,_);if(!e)return null;let t=bn(g,e.line+1);return t===null||_<e.line||_>t?null:{startLine:e.line,endLine:t,text:e.text}},Et=(g,_,e)=>{if(_>e)return!1;for(let t=_;t<=e;t+=1){let n=g.line(t).text;if(Ee.test(n))return!0}return!1},xn=g=>{var n;if(!g)return null;let e=(g.includes(":")&&(n=g.split(":").pop())!=null?n:g).match(/^p(\d+)$/i);if(!e)return null;let t=Number.parseInt(e[1],10);return Number.isFinite(t)?t:null};var St=g=>{if(!g)return null;let _=g.match(/<!--\s*zrr:chunk\b[^>]*-->/i);return _?dt(_[0]):null};var kn=(g,_)=>{let e=document.createElement("div");if(e.classList.add("zrr-sync-badge"),g.type==="sync-start"||g.type==="sync-end")return e.classList.add("zrr-sync-badge--sync"),e.classList.add(g.type==="sync-start"?"zrr-sync-badge--sync-start":"zrr-sync-badge--sync-end"),g.type==="sync-start"?e.textContent=g.docId?`Redis Index Sync start - ${g.docId}`:"Redis Index Sync start":e.textContent="Redis Index Sync end",e;if(g.type==="annotations-start"||g.type==="annotations-end"){if(e.classList.add("zrr-sync-badge--annotations"),g.type==="annotations-start"){let t=g.docId?` - ${g.docId}`:"";e.textContent=`Zotero annotations start${t}`}else e.textContent="Zotero annotations end";return e}if(g.type==="chunk-end")return e.classList.add("zrr-sync-badge--chunk-end"),e.textContent=g.chunkKind==="page"?"Page end":"Section end",g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),e;if(g.type!=="chunk-start")return null;if(e.classList.add("zrr-sync-badge--chunk"),g.chunkKind&&e.classList.add(`zrr-sync-badge--${g.chunkKind}`),g.excluded&&e.classList.add("is-excluded"),g.pageNumber&&_>0)if(g.chunkKind==="section"){let t=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${t} (p${g.pageNumber}/${_})`}else e.textContent=`Page ${g.pageNumber}/${_}`;else if(g.pageNumber)if(g.chunkKind==="section"){let t=g.chunkId?`Section ${g.chunkId}`:"Section";e.textContent=`${t} (p${g.pageNumber})`}else e.textContent=`Page ${g.pageNumber}`;else g.chunkId?e.textContent=`Section ${g.chunkId}`:e.textContent="Section";return g.excluded&&(e.textContent=`${e.textContent} - excluded`),e},ut=class extends ie.WidgetType{constructor(_,e,t,n,i){super(),this.plugin=_,this.docId=e,this.chunkId=t,this.startLine=n,this.excluded=i}eq(_){return this.docId===_.docId&&this.chunkId===_.chunkId&&this.startLine===_.startLine&&this.excluded===_.excluded}toDOM(){let _=document.createElement("span");_.className="zrr-chunk-toolbar",_.setAttribute("data-chunk-id",this.chunkId);let e=(c,d)=>{c.setAttribute("title",d),c.setAttribute("aria-label",d),c.setAttribute("data-tooltip-position","top")},t=(c,d,u)=>{let p=document.createElement("span");p.className="zrr-chunk-button-icon",(0,Dt.setIcon)(p,d);let f=document.createElement("span");f.className="zrr-chunk-button-label",f.textContent=u,c.appendChild(p),c.appendChild(f)},n=document.createElement("button");n.type="button",n.className="zrr-chunk-button",t(n,"sparkles","Clean"),e(n,"Clean this chunk with the OCR cleanup model"),n.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.cleanChunkFromToolbar(this.startLine)}),_.appendChild(n);let i=document.createElement("button");i.type="button",i.className="zrr-chunk-button",t(i,"tag","Tags"),e(i,"Edit chunk tags"),i.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkTagEditor(this.docId,this.chunkId)}),_.appendChild(i);let r=document.createElement("button");r.type="button",r.className="zrr-chunk-button",t(r,"search","Indexed"),e(r,"Preview indexed chunk text"),r.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkIndexedTextPreview(this.docId,this.chunkId)}),_.appendChild(r);let a=document.createElement("button");a.type="button",a.className="zrr-chunk-button",t(a,"external-link","Zotero"),e(a,"Open this page in Zotero"),a.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.openChunkInZotero(this.docId,this.chunkId)}),_.appendChild(a);let s=document.createElement("button");s.type="button",s.className="zrr-chunk-button";let o=this.excluded?"Include":"Exclude",l=this.excluded?"check":"ban";return t(s,l,o),e(s,this.excluded?"Include this chunk in the index":"Exclude this chunk from the index"),s.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation(),this.plugin.toggleChunkExcludeFromToolbar(this.startLine)}),_.appendChild(s),_}ignoreEvent(){return!0}},Nt=(g,_)=>{var y;let e=g.state.doc,t=$e(e);if(!t)return ie.Decoration.none;let n=g.state.selection.main.head,i=e.lineAt(n).number,r=Rt(e,i);if(!r)return ie.Decoration.none;let a=r.text.match(_e);if(!a)return ie.Decoration.none;let s=((y=a[1])!=null?y:"").trim(),o=s.match(/id=(["']?)([^"'\s]+)\1/i);if(!o)return ie.Decoration.none;let l=o[2].trim();if(!l)return ie.Decoration.none;let c=/\bexclude\b/i.test(s)||/\bdelete\b/i.test(s),d=Et(e,r.startLine+1,r.endLine-1),u=c||d,p=e.line(r.startLine),f=ie.Decoration.widget({widget:new ut(_,t,l,r.startLine,u),side:1});return ie.Decoration.set([f.range(p.to)])},_t=class extends ie.WidgetType{constructor(_,e){super(),this.info=_,this.totalPages=e}toDOM(){var _;return(_=kn(this.info,this.totalPages))!=null?_:document.createElement("span")}},Lt=g=>{var o,l;let _=g.dom.closest(".markdown-source-view");if(!_||!_.classList.contains("is-live-preview"))return ie.Decoration.none;let e=g.state.doc,t=new Tt.RangeSetBuilder,n=[],i=[],r=!1,a=!1;for(let c=1;c<=e.lines;c+=1){let d=e.line(c),u=d.text.match(/<!--\s*([^>]*)\s*-->/);if(!u)continue;let p=At(u[1]);p&&(p.type==="chunk-start"?(p.chunkKind=(o=p.chunkKind)!=null?o:p.pageNumber?"page":"section",p.pageNumber&&(r=!0),p.chunkKind==="section"&&(a=!0)):p.type==="chunk-end"&&(p.chunkKind=(l=p.chunkKind)!=null?l:"section"),n.push({line:c,from:d.from,to:d.to,info:p}),p.pageNumber&&i.push(p.pageNumber))}if(!n.length)return ie.Decoration.none;if(r&&!a)for(let c of n)c.info.type==="chunk-end"&&(c.info.chunkKind="page");let s=i.length?Math.max(...i):0;for(let c of n){let d=ie.Decoration.replace({widget:new _t(c.info,s)});t.add(c.from,c.to,d)}return t.finish()},Ot=()=>ie.ViewPlugin.fromClass(class{constructor(g){this.decorations=Lt(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=Lt(g.view))}},{decorations:g=>g.decorations}),It=g=>ie.ViewPlugin.fromClass(class{constructor(_){this.decorations=Nt(_,g)}update(_){(_.docChanged||_.selectionSet||_.viewportChanged)&&(this.decorations=Nt(_.view,g))}},{decorations:_=>_.decorations});var ae=require("child_process"),Y=require("fs"),kt=he(require("http")),cn=he(require("https")),Oe=he(require("net")),Ie=he(require("os")),dn=he(require("tls")),S=he(require("path")),wt=require("url"),Fe=require("crypto");var T=require("obsidian"),Mt=require("crypto"),Ve=require("fs"),Ue=he(require("path")),ne=".zotero-redisearch-rag",oe=`${ne}/items`,Q=`${ne}/chunks`,qt=`${ne}/metadata_snapshots.json`,zt=`${ne}/annotation_snapshots.json`,wn="https://raw.githubusercontent.com/jmiba/zotero-redisearch-rag/main/zotero-companion/zrr-companion.xpi",ve="cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",Se="__custom__",Ft=[{value:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1",label:"cross-encoder/mmarco-mMiniLMv2-L12-H384-v1 (Fast multilingual)"},{value:"BAAI/bge-reranker-v2-m3",label:"BAAI/bge-reranker-v2-m3 (Best quality, heaviest)"},{value:"jinaai/jina-reranker-v2-base-multilingual",label:"jinaai/jina-reranker-v2-base-multilingual (Balanced multilingual)"}],Be={pythonRuntime:"worker",pythonRuntimeMigrationV1Done:!1,showAdvancedPythonRuntimeOptions:!1,pythonPath:"",pythonEnvLocation:"shared",dockerPath:"docker",redisUrl:"redis://127.0.0.1:6379",autoAssignRedisPort:!1,redisDataDirOverride:"",redisProjectName:"",autoStartRedis:!0,firstContainerStartupNoticeShown:!1,zoteroBaseUrl:"http://127.0.0.1:23119/api",zoteroUserId:"0",webApiBaseUrl:"https://api.zotero.org",webApiLibraryType:"user",webApiLibraryId:"",webApiKey:"",outputPdfDir:"Zotero/PDFs",outputNoteDir:"Zotero/Notes",frontmatterTemplate:`doc_id: {{doc_id}}
...
item_json: {{item_json_yaml}}`,tagSanitizeMode:"kebab",noteBodyTemplate:"{{annotation_block}}{{docling_markdown}}",annotationPageLabel:"Seite",annotationColorMap:{yellow:{heading:"Questions",callout:"question"},red:{heading:"Problems/Critique",callout:"bug"},green:{heading:"Main Ideas",callout:"idea"},blue:{heading:"Facts",callout:"fact"},purple:{heading:"Arguments/Solutions",callout:"argument"},magenta:{heading:"Opinions",callout:"opinion"},orange:{heading:"Follow Up",callout:"pursue"},gray:{heading:"Citable Passages",callout:"cite"}},includeAnnotationImages:!0,zoteroCompanionEnabled:!1,zoteroCompanionBaseUrl:"http://127.0.0.1:23120",zoteroCompanionToken:"",llmProviderProfiles:[{id:"lm-studio",name:"LM Studio",baseUrl:"http://localhost:1234/v1",apiKey:"lm-studio"},{id:"ollama",name:"Ollama",baseUrl:"http://localhost:11434/v1",apiKey:""},{id:"openrouter",name:"OpenRouter",baseUrl:"https://openrouter.ai/api/v1",apiKey:""},{id:"openai",name:"OpenAI",baseUrl:"https://api.openai.com/v1",apiKey:""}],chatOutputDir:"Zotero/Chats",copyPdfToVault:!0,createOcrLayeredPdf:!1,preferObsidianNoteForCitations:!0,ocrMode:"auto",ocrQualityThreshold:.5,chunkingMode:"page",ocrEngine:"auto",forcePerPageOcr:!1,paddleApiKey:"",paddleVlApiUrl:"",paddleStructureApiUrl:"",enableLlmCleanup:!1,llmCleanupProviderProfileId:"lm-studio",llmCleanupBaseUrl:"http://127.0.0.1:1234/v1",llmCleanupApiKey:"",llmCleanupModel:"openai/gpt-oss-20b",llmCleanupTemperature:0,llmCleanupMinQuality:.35,llmCleanupMaxChars:2e3,embedProviderProfileId:"lm-studio",embedBaseUrl:"http://localhost:1234/v1",embedApiKey:"lm-studio",embedModel:"google/embedding-gemma-300m",embedIncludeMetadata:!0,embedSubchunkChars:3500,embedSubchunkOverlap:200,embedContextWindow:1,embedContextChars:220,enableChunkTagging:!1,chatProviderProfileId:"lm-studio",chatBaseUrl:"http://127.0.0.1:1234/v1",chatApiKey:"",chatModel:"openai/gpt-oss-20b",chatTemperature:.2,chatHistoryMessages:6,lastSeenReleaseNotesVersion:"",chatPaneLocation:"right",enableAgenticRag:!1,agenticMaxIters:2,enableQueryExpansion:!1,queryExpansionCount:3,enableCrossEncoderRerank:!1,rerankModel:ve,rerankCandidateMultiplier:4,rrfK:60,rrfLogTop:0,maxChunksPerDoc:0,enableFileLogging:!1,logFilePath:`${ne}/logs/docling_extract.log`,redisIndex:"idx:zotero",redisPrefix:"zotero:chunk:"},Ze=class extends T.PluginSettingTab{constructor(e,t){super(e,t);this.activeTab="prerequisites";this.companionTokenInput=null;this.plugin=t}display(){let{containerEl:e}=this;e.empty();let t=()=>Array.isArray(this.plugin.settings.llmProviderProfiles)?this.plugin.settings.llmProviderProfiles:[],n=async h=>{this.plugin.settings.llmProviderProfiles=h,await this.plugin.saveSettings()},i=h=>{h.inputEl.type="password",h.inputEl.autocomplete="off",h.inputEl.spellcheck=!1},d=[{id:"prerequisites",label:"Prerequisites",render:h=>{h.createEl("h2",{text:"Prerequisites"});let k=null,x=null,w=null,R=null,P=null,N=null,E=null,F=null,L=null,j=(M,z)=>{if(!M)return;M.settingEl.classList.toggle("is-disabled",z),M.settingEl.style.opacity=z?"0.55":"";let B=M.settingEl.querySelector(".setting-item-description");B&&(B.style.color=z?"var(--text-faint)":"")},I=(M,z)=>{M&&(M.settingEl.style.display=z?"":"none")},q=()=>{let M=!!this.plugin.settings.showAdvancedPythonRuntimeOptions,z=this.plugin.settings.pythonRuntime==="local",B=M&&z;x==null||x.setDisabled(!M),j(k,!M),I(w,M),I(R,M),I(P,M),N==null||N.setDisabled(!B),E==null||E.setDisabled(!B),L==null||L.setDisabled(!B),F&&(F.disabled=!B),j(w,!B),j(R,!B),j(P,!B)};new T.Setting(h).setName("Docker/Podman path").setDesc("CLI path for Docker or Podman (used to start Redis Stack and the Python worker). Leave as 'docker'/'podman' to auto-detect via PATH and common locations without saving an absolute path (keeps cross-OS sync). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(M=>M.setPlaceholder("docker").setValue(this.plugin.settings.dockerPath).onChange(async z=>{this.plugin.settings.dockerPath=z.trim()||"docker",await this.plugin.saveSettings()})),new T.Setting(h).setName("Advanced Python runtime options").setDesc("Show legacy local interpreter/venv controls. Recommended to keep this disabled.").addToggle(M=>M.setValue(this.plugin.settings.showAdvancedPythonRuntimeOptions).onChange(async z=>{this.plugin.settings.showAdvancedPythonRuntimeOptions=z,!z&&this.plugin.settings.pythonRuntime==="local"&&(this.plugin.settings.pythonRuntime="worker",new T.Notice("Switched Python runtime to worker mode.")),await this.plugin.saveSettings(),q()})),k=new T.Setting(h).setName("Python runtime").setDesc("Worker runtime is recommended. Enable advanced options to expose local interpreter/venv mode.").addDropdown(M=>{x=M,M.addOption("worker","Python worker container (recommended)"),M.addOption("local","Local interpreter/venv"),M.setValue(this.plugin.settings.pythonRuntime).onChange(async z=>{z!=="worker"&&z!=="local"||(this.plugin.settings.pythonRuntime=z,await this.plugin.saveSettings(),q())})}),w=new T.Setting(h).setName("Python path").setDesc("Local mode only: optional path to the Python interpreter used to create or run the plugin env. Leave blank to auto-detect (python3.13/3.12/3.11/3.10/python3/python, or py on Windows). Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir.").addText(M=>(N=M,M.setPlaceholder("auto-detect").setValue(this.plugin.settings.pythonPath).onChange(async z=>{this.plugin.settings.pythonPath=z.trim(),await this.plugin.saveSettings()}))),R=new T.Setting(h).setName("Python environment").setDesc("Local mode: create or update the plugin's Python env. Worker mode: managed by Docker startup.").addButton(M=>{L=M,F=M.buttonEl,M.setButtonText("Create/Update").setCta(),M.onClick(async()=>{M.setDisabled(!0);try{await this.plugin.setupPythonEnv()}finally{M.setDisabled(this.plugin.settings.pythonRuntime!=="local")}})}),P=new T.Setting(h).setName("Python env location").setDesc("Local mode only: shared user cache can be reused across vaults; plugin folder keeps a per-vault env.").addDropdown(M=>{E=M,M.addOption("shared","Shared user cache"),M.addOption("plugin","Plugin folder (.venv)"),M.setValue(this.plugin.settings.pythonEnvLocation).onChange(async z=>{z!=="shared"&&z!=="plugin"||(this.plugin.settings.pythonEnvLocation=z,await this.plugin.saveSettings())})}),q(),new T.Setting(h).setName("Redis URL").addText(M=>M.setPlaceholder("redis://127.0.0.1:6379").setValue(this.plugin.settings.redisUrl).onChange(async z=>{this.plugin.settings.redisUrl=z.trim(),await this.plugin.saveSettings()}));let V=null,O=null,$=null,U=null,H=()=>{let M=this.plugin.settings.autoAssignRedisPort;$==null||$.setDisabled(M),U==null||U.setDisabled(M),V==null||V.settingEl.classList.toggle("is-disabled",M),O==null||O.settingEl.classList.toggle("is-disabled",M)};new T.Setting(h).setName("Auto-assign Redis port").setDesc("When starting Redis stack, pick a free local port and update the Redis URL.").addToggle(M=>M.setValue(this.plugin.settings.autoAssignRedisPort).onChange(async z=>{this.plugin.settings.autoAssignRedisPort=z,await this.plugin.saveSettings(),H()})),V=new T.Setting(h).setName("Redis data directory override").setDesc("Optional path to store Redis persistence when auto-assign is off. Env var ZRR_DATA_DIR overrides this setting. Supports ~, $HOME, and %USERPROFILE%. Relative paths with separators resolve from your home dir; use ./ to keep it vault-relative.").addText(M=>($=M,M.setPlaceholder("~/Redis/zrr-data").setValue(this.plugin.settings.redisDataDirOverride).onChange(async z=>{this.plugin.settings.redisDataDirOverride=z.trim(),await this.plugin.saveSettings()}))),V.settingEl.addClass("zrr-redis-override-setting"),O=new T.Setting(h).setName("Redis project name override").setDesc("Optional Docker/Podman Compose project name when auto-assign is off. Env var ZRR_PROJECT_NAME overrides this setting.").addText(M=>(U=M,M.setPlaceholder("zrr-shared").setValue(this.plugin.settings.redisProjectName).onChange(async z=>{this.plugin.settings.redisProjectName=z.trim(),await this.plugin.saveSettings()}))),O.settingEl.addClass("zrr-redis-override-setting"),H(),new T.Setting(h).setName("Auto-start Redis stack (Docker/Podman Compose)").setDesc("Requires Docker Desktop running and your vault path shared with Docker. Starts Redis and, in worker mode, the Python worker container.").addToggle(M=>M.setValue(this.plugin.settings.autoStartRedis).onChange(async z=>{this.plugin.settings.autoStartRedis=z,await this.plugin.saveSettings()})),new T.Setting(h).setName("Start Redis stack now").setDesc("Starts or restarts Redis stack (and Python worker in worker mode).").addButton(M=>M.setButtonText("Start").onClick(async()=>{await this.plugin.startRedisStack()}))}},{id:"zotero-import",label:"Zotero import",render:h=>{h.createEl("h2",{text:"Zotero Local API"}),new T.Setting(h).setName("Zotero base URL").setDesc("Local Zotero API base URL, e.g. http://127.0.0.1:23119/api").addText(P=>P.setPlaceholder("http://127.0.0.1:23119/api").setValue(this.plugin.settings.zoteroBaseUrl).onChange(async N=>{this.plugin.settings.zoteroBaseUrl=N.trim(),await this.plugin.saveSettings()}));let k=new T.Setting(h).setName("Zotero library").setDesc("Select your local library or a Zotero group library."),x=null,w=P=>{if(!x)return;let N=(this.plugin.settings.zoteroUserId||"0").trim()||"0";new Set(P.map(F=>F.value)).has(N)||(P=P.concat([{value:N,label:`Custom (${N})`}])),x.selectEl.options.length=0;for(let F of P)x.addOption(F.value,F.label);x.setValue(N)},R=async()=>{if(x){x.setDisabled(!0);try{let P=await this.plugin.fetchZoteroLibraryOptions();w(P)}finally{x.setDisabled(!1)}}};k.addDropdown(P=>{x=P;let N=(this.plugin.settings.zoteroUserId||"0").trim()||"0";P.addOption(N,"Loading..."),P.setValue(N),P.onChange(async E=>{this.plugin.settings.zoteroUserId=E.trim(),await this.plugin.saveSettings()})}),k.addButton(P=>{P.setButtonText("Refresh").onClick(async()=>{await R()})}),R(),h.createEl("h2",{text:"Zotero Web API"}),new T.Setting(h).setName("Web API base URL").setDesc("Zotero Web API base URL for write fallback, e.g. https://api.zotero.org").addText(P=>P.setPlaceholder("https://api.zotero.org").setValue(this.plugin.settings.webApiBaseUrl).onChange(async N=>{this.plugin.settings.webApiBaseUrl=N.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("Web API library type").setDesc("Library type for Web API writes.").addDropdown(P=>P.addOption("user","user").addOption("group","group").setValue(this.plugin.settings.webApiLibraryType).onChange(async N=>{this.plugin.settings.webApiLibraryType=N,await this.plugin.saveSettings()})),new T.Setting(h).setName("Web API library ID").setDesc("Numeric Zotero user/group ID for Web API writes.").addText(P=>P.setPlaceholder("15218").setValue(this.plugin.settings.webApiLibraryId).onChange(async N=>{this.plugin.settings.webApiLibraryId=N.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("Web API key").setDesc("Zotero API key for write fallback (from zotero.org).").addText(P=>{i(P),P.setPlaceholder("your-api-key").setValue(this.plugin.settings.webApiKey).onChange(async N=>{this.plugin.settings.webApiKey=N.trim(),await this.plugin.saveSettings()})}),h.createEl("h2",{text:"Output"}),new T.Setting(h).setName("PDF folder").addText(P=>P.setPlaceholder("zotero/pdfs").setValue(this.plugin.settings.outputPdfDir).onChange(async N=>{this.plugin.settings.outputPdfDir=N.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("Notes folder").addText(P=>P.setPlaceholder("zotero/notes").setValue(this.plugin.settings.outputNoteDir).onChange(async N=>{this.plugin.settings.outputNoteDir=N.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("Frontmatter template").setDesc("Template for note YAML frontmatter. Use {{var}} placeholders; leave blank to omit.").addTextArea(P=>{P.setValue(this.plugin.settings.frontmatterTemplate).onChange(async N=>{this.plugin.settings.frontmatterTemplate=N,await this.plugin.saveSettings()}),P.inputEl.rows=10,P.inputEl.style.width="100%"}),new T.Setting(h).setName("Tag sanitization").setDesc("Normalize Zotero tags for Obsidian (no spaces, punctuation trimmed).").addDropdown(P=>P.addOption("none","No change").addOption("camel","camelCase").addOption("pascal","PascalCase").addOption("snake","snake_case").addOption("kebab","kebab-case").setValue(this.plugin.settings.tagSanitizeMode==="replace"?"kebab":this.plugin.settings.tagSanitizeMode).onChange(async N=>{this.plugin.settings.tagSanitizeMode=N,await this.plugin.saveSettings()})),new T.Setting(h).setName("Note body template").setDesc("Template for the note body after frontmatter. Use {{pdf_block}}, {{annotation_block}}, and {{docling_markdown}} placeholders.").addTextArea(P=>{P.setValue(this.plugin.settings.noteBodyTemplate).onChange(async N=>{this.plugin.settings.noteBodyTemplate=N,await this.plugin.saveSettings()}),P.inputEl.rows=8,P.inputEl.style.width="100%"}),new T.Setting(h).setName("Saved chats folder").setDesc("Where exported chat notes are stored (vault-relative).").addText(P=>P.setPlaceholder("zotero/chats").setValue(this.plugin.settings.chatOutputDir).onChange(async N=>{this.plugin.settings.chatOutputDir=N.trim()||"zotero/chats",await this.plugin.saveSettings()})),new T.Setting(h).setName("Copy PDFs into vault").setDesc("Disable to use Zotero storage paths directly. If a local file path is unavailable, the plugin temporarily copies the PDF into the vault for processing.").addToggle(P=>P.setValue(this.plugin.settings.copyPdfToVault).onChange(async N=>{this.plugin.settings.copyPdfToVault=N,!N&&this.plugin.settings.createOcrLayeredPdf&&(this.plugin.settings.createOcrLayeredPdf=!1),await this.plugin.saveSettings(),this.display()})),new T.Setting(h).setName("Create OCR-layered PDF copy").setDesc("When OCR is used, replace the vault PDF with a Tesseract text layer (requires Copy PDFs into vault).").addToggle(P=>{let N=this.plugin.settings.copyPdfToVault;P.setValue(N?this.plugin.settings.createOcrLayeredPdf:!1).setDisabled(!N).onChange(async E=>{if(!this.plugin.settings.copyPdfToVault){this.plugin.settings.createOcrLayeredPdf=!1,await this.plugin.saveSettings();return}this.plugin.settings.createOcrLayeredPdf=E,await this.plugin.saveSettings()})}),new T.Setting(h).setName("Prefer Obsidian note for citations").setDesc("Link citations to the Obsidian note when available; otherwise use Zotero deep links.").addToggle(P=>P.setValue(this.plugin.settings.preferObsidianNoteForCitations).onChange(async N=>{this.plugin.settings.preferObsidianNoteForCitations=N,await this.plugin.saveSettings()}))}},{id:"annotations",label:"Annotations",render:h=>{h.createEl("h2",{text:"Annotations"}),new T.Setting(h).setName("Annotation page label").setDesc("Label shown before the page link in annotation callouts.").addText(R=>R.setPlaceholder("Page").setValue(this.plugin.settings.annotationPageLabel).onChange(async P=>{this.plugin.settings.annotationPageLabel=P.trim()||"Page",await this.plugin.saveSettings()})),new T.Setting(h).setName("Include annotation images").setDesc("Embed image/rect annotations as images in callouts when available.").addToggle(R=>R.setValue(this.plugin.settings.includeAnnotationImages).onChange(async P=>{this.plugin.settings.includeAnnotationImages=P,await this.plugin.saveSettings()})),h.createEl("h3",{text:"Zotero companion"}),h.createEl("p",{text:"Install the Zotero companion add-on to enable cached image/rect annotations. See tab Maintenance for instructions."}),new T.Setting(h).setName("Use Zotero companion for annotation images").setDesc("Fetch cached annotation images from a local Zotero companion plugin.").addToggle(R=>R.setValue(this.plugin.settings.zoteroCompanionEnabled).onChange(async P=>{this.plugin.settings.zoteroCompanionEnabled=P,await this.plugin.saveSettings()})),new T.Setting(h).setName("Zotero companion base URL").setDesc("Local URL for the Zotero companion plugin (loopback only).").addText(R=>R.setPlaceholder("http://127.0.0.1:23120").setValue(this.plugin.settings.zoteroCompanionBaseUrl).onChange(async P=>{this.plugin.settings.zoteroCompanionBaseUrl=P.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("Zotero companion token").setDesc("Optional shared token for the companion endpoint.").addText(R=>{i(R),this.companionTokenInput=R,R.setPlaceholder("optional-token").setValue(this.plugin.settings.zoteroCompanionToken).onChange(async P=>{this.plugin.settings.zoteroCompanionToken=P.trim(),await this.plugin.saveSettings()})}),new T.Setting(h).setName("Generate companion token").setDesc("Create and paste a secure token. The generated token is copied to your clipboard. In Zotero, set your Zotero Companion Plugin token to this value.").addButton(R=>R.setButtonText("Generate token").onClick(async()=>{let P=(0,Mt.randomBytes)(32).toString("base64url");this.plugin.settings.zoteroCompanionToken=P,await this.plugin.saveSettings(),this.companionTokenInput&&this.companionTokenInput.setValue(P);try{await navigator.clipboard.writeText(P),new T.Notice("Generated and copied companion token.")}catch(N){new T.Notice("Generated token, but failed to copy to clipboard."),console.warn("Failed to copy generated companion token",N)}})),h.createEl("h3",{text:"Annotation color map"}),h.createEl("p",{text:"Map Zotero highlight colors to section headings and callout types."});let k=h.createDiv({cls:"zrr-annotation-map"}),x=async R=>{this.plugin.settings.annotationColorMap=R,await this.plugin.saveSettings()},w=()=>{var L,j;k.empty();let R=this.plugin.settings.annotationColorMap||{},P=Object.entries(R);if(P.length||k.createEl("p",{text:"No color mappings configured."}),P.length){let I=k.createDiv({cls:"zrr-annotation-map-row-header"});I.createEl("span",{text:"Color"}),I.createEl("span",{text:"Heading"}),I.createEl("span",{text:"Callout"}),I.createEl("span")}for(let[I,q]of P){let O=k.createDiv({cls:"zrr-annotation-map-row"}).createDiv({cls:"zrr-annotation-map-row-body"}),$=O.createEl("input",{type:"text",value:I,cls:"zrr-annotation-map-input"}),U=O.createEl("input",{type:"text",value:(L=q.heading)!=null?L:"",cls:"zrr-annotation-map-input"}),H=O.createEl("input",{type:"text",value:(j=q.callout)!=null?j:"",cls:"zrr-annotation-map-input"}),M=O.createEl("button",{text:"Delete",cls:"zrr-annotation-map-delete"});M.type="button",$.addEventListener("change",async()=>{let z=$.value.trim().toLowerCase();if(!z){$.value=I;return}let B={...this.plugin.settings.annotationColorMap||{}};if(z!==I&&B[z]){new T.Notice(`Annotation color '${z}' already exists.`),$.value=I;return}let Z=B[I];delete B[I],B[z]=Z!=null?Z:{heading:"",callout:""},await x(B),w()}),U.addEventListener("change",async()=>{var Z;let z={...this.plugin.settings.annotationColorMap||{}},B=(Z=z[I])!=null?Z:{heading:"",callout:""};B.heading=U.value.trim(),z[I]=B,await x(z)}),H.addEventListener("change",async()=>{var Z;let z={...this.plugin.settings.annotationColorMap||{}},B=(Z=z[I])!=null?Z:{heading:"",callout:""};B.callout=H.value.trim(),z[I]=B,await x(z)}),M.addEventListener("click",async()=>{let z={...this.plugin.settings.annotationColorMap||{}};delete z[I],await x(z),w()})}let N=k.createDiv({cls:"zrr-annotation-map-actions"}),E=N.createEl("button",{text:"Add mapping"});E.type="button",E.addEventListener("click",async()=>{let I={...this.plugin.settings.annotationColorMap||{}},q="new-color",V=1;for(;I[q];)q=`new-color-${V}`,V+=1;I[q]={heading:"",callout:""},await x(I),w()});let F=N.createEl("button",{text:"Reset to defaults"});F.type="button",F.addEventListener("click",async()=>{await x({...Be.annotationColorMap}),w()})};w()}},{id:"ocr",label:"OCR",render:h=>{h.createEl("h2",{text:"Docling"});let k=null,x=N=>{if(!k)return;let E=this.plugin.settings.ocrEngine;new Set(N.map(L=>L.value)).has(E)||(N=N.concat([{value:E,label:`Current (unavailable): ${E}`}])),k.selectEl.options.length=0;for(let L of N)k.addOption(L.value,L.label);k.setValue(E)},w=async()=>{if(!k)return;k.setDisabled(!0);let N={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1};if(this.plugin.detectOcrEngines)try{N=await this.plugin.detectOcrEngines()}catch(L){N={tesseract:!1,paddleStructureLocal:!1,paddleVlLocal:!1}}let E=[{value:"auto",label:"Auto (default)"}];N.tesseract&&E.push({value:"tesseract",label:"Tesseract (local)"}),N.paddleStructureLocal&&E.push({value:"paddle_structure_local",label:"Paddle PP-StructureV3 (local)"}),N.paddleVlLocal&&E.push({value:"paddle_vl_local",label:"PaddleOCR-VL (local)"}),(this.plugin.settings.paddleApiKey||"").trim()&&(E.push({value:"paddle_structure_api",label:"PP-StructureV3 API"}),E.push({value:"paddle_vl_api",label:"PaddleOCR-VL API"})),x(E),k.setDisabled(!1)},R=new T.Setting(h).setName("Paddle OCR API key").setDesc("API token for PaddleOCR-VL / PP-StructureV3 endpoints. Get a free API key at "),P=document.createElement("a");P.href="https://aistudio.baidu.com/paddleocr",P.textContent="https://aistudio.baidu.com/paddleocr",P.target="_blank",P.rel="noopener noreferrer",R.descEl.appendChild(P),R.descEl.append("."),R.addText(N=>{i(N),N.setPlaceholder("your-api-token").setValue(this.plugin.settings.paddleApiKey).onChange(async E=>{this.plugin.settings.paddleApiKey=E.trim(),await this.plugin.saveSettings(),await w()})}),new T.Setting(h).setName("PaddleOCR-VL API URL").setDesc("Optional override for the PaddleOCR-VL API endpoint.").addText(N=>N.setPlaceholder("https://.../layout-parsing").setValue(this.plugin.settings.paddleVlApiUrl).onChange(async E=>{this.plugin.settings.paddleVlApiUrl=E.trim(),await this.plugin.saveSettings()})),new T.Setting(h).setName("PP-StructureV3 API URL").setDesc("API endpoint for PP-StructureV3 (see Baidu AI Studio docs).").addText(N=>N.setPlaceholder("https://.../pp-structure").setValue(this.plugin.settings.paddleStructureApiUrl).onChange(async E=>{this.plugin.settings.paddleStructureApiUrl=E.trim(),await this.plugin.saveSettings(),await w()})),new T.Setting(h).setName("OCR engine").setDesc("Select the OCR engine to use when OCR is required.").addDropdown(N=>{k=N,N.addOption("auto","Auto (default)"),N.setValue(this.plugin.settings.ocrEngine),N.onChange(async E=>{this.plugin.settings.ocrEngine=E,await this.plugin.saveSettings()})}),new T.Setting(h).setName("OCR decision (when to OCR)").setDesc("Controls when OCR runs; per-page behavior is configured separately below.").addDropdown(N=>N.addOption("auto","Auto: use text layer when reliable").addOption("force_low_quality","OCR only if text is poor").addOption("force","Prefer OCR for full document").setValue(this.plugin.settings.ocrMode).onChange(async E=>{this.plugin.settings.ocrMode=E,await this.plugin.saveSettings()})),new T.Setting(h).setName("OCR layout override (per-page)").setDesc("Force per-page OCR when OCR runs, bypassing layout heuristics; can be slower for multi-column PDFs.").addToggle(N=>N.setValue(this.plugin.settings.forcePerPageOcr).onChange(async E=>{this.plugin.settings.forcePerPageOcr=E,await this.plugin.saveSettings()})),new T.Setting(h).setName("Text quality threshold").setDesc("Lower values are stricter; below this threshold the text is treated as low quality.").addSlider(N=>{N.setLimits(0,1,.05).setValue(this.plugin.settings.ocrQualityThreshold).setDynamicTooltip().onChange(async E=>{this.plugin.settings.ocrQualityThreshold=E,await this.plugin.saveSettings()})}),new T.Setting(h).setName("Chunking").setDesc("page or section").addDropdown(N=>N.addOption("page","page").addOption("section","section").setValue(this.plugin.settings.chunkingMode).onChange(async E=>{this.plugin.settings.chunkingMode=E,await this.plugin.saveSettings()})),w()}},{id:"llms",label:"LLMs",render:h=>{h.createEl("h2",{text:"LLM Provider Profiles"});let k=h.createDiv({cls:"zrr-llm-profiles"}),x=()=>{k.empty();let C=t();C.length||k.createEl("p",{text:"No profiles yet. Add one below."});for(let A of C){let D=k.createEl("details",{cls:"zrr-profile"});C.length===1&&(D.open=!0);let te=D.createEl("summary",{text:A.name||A.id||"Profile"});te.addClass("zrr-profile-title");let qe=D.createDiv({cls:"zrr-profile-body"});new T.Setting(qe).setName("Profile name").addText(ue=>ue.setPlaceholder("My provider").setValue(A.name||"").onChange(async ge=>{A.name=ge.trim(),te.textContent=A.name||A.id||"Profile",await n(t())})),new T.Setting(qe).setName("Base URL").addText(ue=>ue.setPlaceholder("http://localhost:1234/v1").setValue(A.baseUrl||"").onChange(async ge=>{A.baseUrl=ge.trim(),await n(t())})),new T.Setting(qe).setName("API key").setDesc("Stored in settings (not encrypted).").addText(ue=>{i(ue),ue.setPlaceholder("sk-...").setValue(A.apiKey||"").onChange(async ge=>{A.apiKey=ge.trim(),await n(t())})}),new T.Setting(qe).setName("Remove profile").setDesc("Deletes this saved profile.").addButton(ue=>ue.setButtonText("Delete profile").onClick(async()=>{let ge=t().filter(pn=>pn.id!==A.id);this.plugin.settings.embedProviderProfileId=this.plugin.settings.embedProviderProfileId===A.id?"":this.plugin.settings.embedProviderProfileId,this.plugin.settings.chatProviderProfileId=this.plugin.settings.chatProviderProfileId===A.id?"":this.plugin.settings.chatProviderProfileId,this.plugin.settings.llmCleanupProviderProfileId=this.plugin.settings.llmCleanupProviderProfileId===A.id?"":this.plugin.settings.llmCleanupProviderProfileId,await n(ge),x()}))}new T.Setting(k).addButton(A=>A.setButtonText("Add profile").onClick(async()=>{let D=`profile-${Date.now().toString(36)}`,te=t().concat([{id:D,name:"Custom",baseUrl:"",apiKey:""}]);await n(te),x()}))};x(),h.createEl("h2",{text:"OCR cleanup"}),new T.Setting(h).setName("LLM cleanup for low-quality chunks").setDesc("Automatic AI cleanup for poor OCR at import. Can be slow/costly.").addToggle(C=>C.setValue(this.plugin.settings.enableLlmCleanup).onChange(async A=>{this.plugin.settings.enableLlmCleanup=A,await this.plugin.saveSettings()}));let w=null,R=null,P=null,N=async()=>{},E=async(C,A=!0)=>{let D=C.trim();this.plugin.settings.llmCleanupBaseUrl=D,A&&(this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom")),R&&R.setValue(D),await this.plugin.saveSettings()},F=async C=>{let A=t().find(D=>D.id===C);this.plugin.settings.llmCleanupProviderProfileId=C,A&&(this.plugin.settings.llmCleanupBaseUrl=A.baseUrl,this.plugin.settings.llmCleanupApiKey=A.apiKey,R==null||R.setValue(A.baseUrl),P==null||P.setValue(A.apiKey)),await this.plugin.saveSettings(),await N()};new T.Setting(h).setName("LLM cleanup provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{w=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let A=this.plugin.settings.llmCleanupProviderProfileId;C.setValue(A&&t().some(D=>D.id===A)?A:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.llmCleanupProviderProfileId="",await this.plugin.saveSettings();return}await F(D)})}),new T.Setting(h).setName("LLM cleanup base URL").setDesc("OpenAI-compatible endpoint, e.g. http://127.0.0.1:1234/v1").addText(C=>{R=C,C.setPlaceholder("http://127.0.0.1:1234/v1").setValue(this.plugin.settings.llmCleanupBaseUrl).onChange(async A=>{await E(A)})}),new T.Setting(h).setName("LLM cleanup API key").setDesc("Optional API key for the cleanup endpoint.").addText(C=>{P=C,i(C),C.setPlaceholder("sk-...").setValue(this.plugin.settings.llmCleanupApiKey).onChange(async A=>{this.plugin.settings.llmCleanupApiKey=A.trim(),this.plugin.settings.llmCleanupProviderProfileId="",w&&w.setValue("custom"),await this.plugin.saveSettings()})});let L=new T.Setting(h).setName("LLM cleanup model").setDesc("Select a cleanup-capable model from the provider."),j=null,I=C=>{if(!j)return;let A=(this.plugin.settings.llmCleanupModel||"").trim(),D=new Set(C.map(te=>te.value));A&&!D.has(A)&&(C=C.concat([{value:A,label:`Custom (${A})`}])),j.selectEl.options.length=0;for(let te of C)j.addOption(te.value,te.label);A&&j.setValue(A)};N=async()=>{if(j){j.setDisabled(!0);try{let C=await this.plugin.fetchCleanupModelOptions();I(C)}finally{j.setDisabled(!1)}}},L.addDropdown(C=>{j=C;let A=(this.plugin.settings.llmCleanupModel||"").trim();C.addOption(A||"loading","Loading..."),C.setValue(A||"loading"),C.onChange(async D=>{this.plugin.settings.llmCleanupModel=D.trim(),await this.plugin.saveSettings()})}),L.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await N()})}),N(),new T.Setting(h).setName("LLM cleanup temperature").setDesc("Lower is more conservative.").addText(C=>C.setPlaceholder("0.0").setValue(String(this.plugin.settings.llmCleanupTemperature)).onChange(async A=>{let D=Number.parseFloat(A);this.plugin.settings.llmCleanupTemperature=Number.isFinite(D)?D:0,await this.plugin.saveSettings()})),new T.Setting(h).setName("LLM cleanup min quality").setDesc("Only run cleanup when chunk quality is below this threshold (0-1).").addSlider(C=>C.setLimits(0,1,.05).setValue(this.plugin.settings.llmCleanupMinQuality).setDynamicTooltip().onChange(async A=>{this.plugin.settings.llmCleanupMinQuality=A,await this.plugin.saveSettings()})),new T.Setting(h).setName("LLM cleanup max chars").setDesc("Skip cleanup for chunks longer than this limit.").addText(C=>C.setPlaceholder("2000").setValue(String(this.plugin.settings.llmCleanupMaxChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.llmCleanupMaxChars=Number.isFinite(D)?D:2e3,await this.plugin.saveSettings()})),h.createEl("h2",{text:"Text Embedding"});let q=null,V=null,O=null,$=async()=>{},U=async(C,A=!0)=>{let D=C.trim();this.plugin.settings.embedBaseUrl=D,A&&(this.plugin.settings.embedProviderProfileId="",q&&q.setValue("custom")),V&&V.setValue(D),await this.plugin.saveSettings()},H=async C=>{let A=t().find(D=>D.id===C);this.plugin.settings.embedProviderProfileId=C,A&&(this.plugin.settings.embedBaseUrl=A.baseUrl,this.plugin.settings.embedApiKey=A.apiKey,V==null||V.setValue(A.baseUrl),O==null||O.setValue(A.apiKey)),await this.plugin.saveSettings(),await $()};new T.Setting(h).setName("Embeddings provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{q=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let A=this.plugin.settings.embedProviderProfileId;C.setValue(A&&t().some(D=>D.id===A)?A:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.embedProviderProfileId="",await this.plugin.saveSettings();return}await H(D)})}),new T.Setting(h).setName("Embeddings base URL").addText(C=>{V=C,C.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.embedBaseUrl).onChange(async A=>{await U(A)})}),new T.Setting(h).setName("Embeddings API key").addText(C=>{O=C,i(C),C.setPlaceholder("lm-studio").setValue(this.plugin.settings.embedApiKey).onChange(async A=>{this.plugin.settings.embedApiKey=A.trim(),this.plugin.settings.embedProviderProfileId="",q&&q.setValue("custom"),await this.plugin.saveSettings()})});let M=new T.Setting(h).setName("Embeddings model").setDesc("Select an embeddings model from the provider."),z=null,B=C=>{if(!z)return;let A=(this.plugin.settings.embedModel||"").trim(),D=new Set(C.map(te=>te.value));A&&!D.has(A)&&(C=C.concat([{value:A,label:`Custom (${A})`}])),z.selectEl.options.length=0;for(let te of C)z.addOption(te.value,te.label);A&&z.setValue(A)};$=async()=>{if(z){z.setDisabled(!0);try{let C=await this.plugin.fetchEmbeddingModelOptions();B(C)}finally{z.setDisabled(!1)}}},M.addDropdown(C=>{z=C;let A=(this.plugin.settings.embedModel||"").trim();C.addOption(A||"loading","Loading..."),C.setValue(A||"loading"),C.onChange(async D=>{this.plugin.settings.embedModel=D.trim(),await this.plugin.saveSettings()})}),M.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await $()})}),$(),new T.Setting(h).setName("Include metadata in embeddings").setDesc("Prepend title/authors/tags/section info before embedding chunks.").addToggle(C=>C.setValue(this.plugin.settings.embedIncludeMetadata).onChange(async A=>{this.plugin.settings.embedIncludeMetadata=A,await this.plugin.saveSettings()})),new T.Setting(h).setName("Embedding context window (chunks)").setDesc("Include neighboring chunk text around each chunk when embedding (0 disables).").addText(C=>C.setPlaceholder("1").setValue(String(this.plugin.settings.embedContextWindow)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedContextWindow=Number.isFinite(D)?Math.max(0,D):1,await this.plugin.saveSettings()})),new T.Setting(h).setName("Embedding context snippet size (chars)").setDesc("Max chars per neighboring chunk included in embeddings.").addText(C=>C.setPlaceholder("220").setValue(String(this.plugin.settings.embedContextChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedContextChars=Number.isFinite(D)?Math.max(0,D):220,await this.plugin.saveSettings()})),new T.Setting(h).setName("Embedding subchunk size (chars)").setDesc("Split long chunks into smaller subchunks for embedding only (0 disables).").addText(C=>C.setPlaceholder("1800").setValue(String(this.plugin.settings.embedSubchunkChars)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedSubchunkChars=Number.isFinite(D)?Math.max(0,D):3500,await this.plugin.saveSettings()})),new T.Setting(h).setName("Embedding subchunk overlap (chars)").setDesc("Overlap between embedding subchunks to keep context intact.").addText(C=>C.setPlaceholder("200").setValue(String(this.plugin.settings.embedSubchunkOverlap)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.embedSubchunkOverlap=Number.isFinite(D)?Math.max(0,D):200,await this.plugin.saveSettings()})),new T.Setting(h).setName("Generate LLM tags for chunks").setDesc("Use the OCR cleanup model to tag chunks before indexing.").addToggle(C=>C.setValue(this.plugin.settings.enableChunkTagging).onChange(async A=>{this.plugin.settings.enableChunkTagging=A,await this.plugin.saveSettings()})),h.createEl("h2",{text:"Chat LLM"});let Z=null,W=null,re=null,pe=async()=>{},be=async(C,A=!0)=>{let D=C.trim();this.plugin.settings.chatBaseUrl=D,A&&(this.plugin.settings.chatProviderProfileId="",Z&&Z.setValue("custom")),W&&W.setValue(D),await this.plugin.saveSettings()},xe=async C=>{let A=t().find(D=>D.id===C);this.plugin.settings.chatProviderProfileId=C,A&&(this.plugin.settings.chatBaseUrl=A.baseUrl,this.plugin.settings.chatApiKey=A.apiKey,W==null||W.setValue(A.baseUrl),re==null||re.setValue(A.apiKey)),await this.plugin.saveSettings(),await pe()};new T.Setting(h).setName("Chat provider profile").setDesc("Select a profile to populate base URL and API key.").addDropdown(C=>{Z=C,C.addOption("custom","Custom (manual)");for(let D of t())C.addOption(D.id,D.name||D.id);let A=this.plugin.settings.chatProviderProfileId;C.setValue(A&&t().some(D=>D.id===A)?A:"custom"),C.onChange(async D=>{if(D==="custom"){this.plugin.settings.chatProviderProfileId="",await this.plugin.saveSettings();return}await xe(D)})}),new T.Setting(h).setName("Chat base URL").setDesc("OpenAI-compatible base URL for chat requests.").addText(C=>{W=C,C.setPlaceholder("http://localhost:1234/v1").setValue(this.plugin.settings.chatBaseUrl).onChange(async A=>{await be(A)})}),new T.Setting(h).setName("Chat API key").addText(C=>{re=C,i(C),C.setPlaceholder("lm-studio").setValue(this.plugin.settings.chatApiKey).onChange(async A=>{this.plugin.settings.chatApiKey=A.trim(),this.plugin.settings.chatProviderProfileId="",Z&&Z.setValue("custom"),await this.plugin.saveSettings()})});let Me=new T.Setting(h).setName("Chat model").setDesc("Select a chat-capable model from the provider."),le=null,ct=C=>{if(!le)return;let A=(this.plugin.settings.chatModel||"").trim(),D=new Set(C.map(te=>te.value));A&&!D.has(A)&&(C=C.concat([{value:A,label:`Custom (${A})`}])),le.selectEl.options.length=0;for(let te of C)le.addOption(te.value,te.label);A&&le.setValue(A)};pe=async()=>{if(le){le.setDisabled(!0);try{let C=await this.plugin.fetchChatModelOptions();ct(C)}finally{le.setDisabled(!1)}}},Me.addDropdown(C=>{le=C;let A=(this.plugin.settings.chatModel||"").trim();C.addOption(A||"loading","Loading..."),C.setValue(A||"loading"),C.onChange(async D=>{this.plugin.settings.chatModel=D.trim(),await this.plugin.saveSettings()})}),Me.addButton(C=>{C.setButtonText("Refresh").onClick(async()=>{await pe()})}),pe(),new T.Setting(h).setName("Temperature").addText(C=>C.setPlaceholder("0.2").setValue(String(this.plugin.settings.chatTemperature)).onChange(async A=>{let D=Number.parseFloat(A);this.plugin.settings.chatTemperature=Number.isFinite(D)?D:.2,await this.plugin.saveSettings()})),new T.Setting(h).setName("Chat history messages").setDesc("Number of recent messages to include for conversational continuity (0 disables).").addText(C=>C.setPlaceholder("6").setValue(String(this.plugin.settings.chatHistoryMessages)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.chatHistoryMessages=Number.isFinite(D)?Math.max(0,D):6,await this.plugin.saveSettings()})),new T.Setting(h).setName("Chat panel location").setDesc("Where to open the chat view by default.").addDropdown(C=>C.addOption("right","Right sidebar").addOption("main","Main window").setValue(this.plugin.settings.chatPaneLocation).onChange(async A=>{this.plugin.settings.chatPaneLocation=A,await this.plugin.saveSettings()})),h.createEl("h2",{text:"Retrieval"}),new T.Setting(h).setName("Enable agentic retrieval").setDesc("Use a small planner step that can trigger expansion retry or full-document retrieval before answering.").addToggle(C=>C.setValue(this.plugin.settings.enableAgenticRag).onChange(async A=>{this.plugin.settings.enableAgenticRag=A,await this.plugin.saveSettings()})),new T.Setting(h).setName("Agentic max iterations").setDesc("Maximum number of planner steps per query.").addText(C=>C.setPlaceholder("2").setValue(String(this.plugin.settings.agenticMaxIters)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.agenticMaxIters=Number.isFinite(D)?Math.max(1,D):2,await this.plugin.saveSettings()})),new T.Setting(h).setName("Enable query expansion").setDesc("Use the chat model to expand queries before retrieval.").addToggle(C=>C.setValue(this.plugin.settings.enableQueryExpansion).onChange(async A=>{this.plugin.settings.enableQueryExpansion=A,await this.plugin.saveSettings()})),new T.Setting(h).setName("Query expansion count").setDesc("Number of expansion variants to request.").addText(C=>C.setPlaceholder("3").setValue(String(this.plugin.settings.queryExpansionCount)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.queryExpansionCount=Number.isFinite(D)?Math.max(1,D):3,await this.plugin.saveSettings()})),new T.Setting(h).setName("Enable cross-encoder reranking").setDesc("Rerank candidates locally with sentence-transformers (downloads model on first use).").addToggle(C=>C.setValue(this.plugin.settings.enableCrossEncoderRerank).onChange(async A=>{this.plugin.settings.enableCrossEncoderRerank=A,await this.plugin.saveSettings()}));let J=new Set(Ft.map(C=>C.value)),X=(this.plugin.settings.rerankModel||"").trim()||ve,ke=J.has(X)?X:Se,se=null,vt=()=>{if(!se)return;let A=!(ke===Se);se.setDisabled(A),se.inputEl.disabled=A,se.inputEl.readOnly=A,se.inputEl.classList.toggle("is-disabled",A),se.inputEl.setAttribute("aria-disabled",String(A))},Pt=new T.Setting(h).setName("Cross-encoder model").setDesc("Choose a multilingual preset, or select Custom to edit the model id.");Pt.addDropdown(C=>{for(let A of Ft)C.addOption(A.value,A.label);C.addOption(Se,"Custom"),C.setValue(ke),C.onChange(async A=>{ke=A,A!==Se?this.plugin.settings.rerankModel=A:(this.plugin.settings.rerankModel||"").trim()||(this.plugin.settings.rerankModel=ve),await this.plugin.saveSettings(),se==null||se.setValue(this.plugin.settings.rerankModel||ve),vt()})}),Pt.addText(C=>{se=C,C.setPlaceholder(ve).setValue(X).onChange(async A=>{ke===Se&&(this.plugin.settings.rerankModel=A.trim()||ve,await this.plugin.saveSettings())}),vt()}),new T.Setting(h).setName("Rerank candidate multiplier").setDesc("Retrieve k \xD7 N candidates before reranking.").addText(C=>C.setPlaceholder("4").setValue(String(this.plugin.settings.rerankCandidateMultiplier)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rerankCandidateMultiplier=Number.isFinite(D)?Math.max(1,D):4,await this.plugin.saveSettings()})),new T.Setting(h).setName("RRF k").setDesc("Rank fusion constant for blending lexical and vector results.").addText(C=>C.setPlaceholder("60").setValue(String(this.plugin.settings.rrfK)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rrfK=Number.isFinite(D)?Math.max(1,D):60,await this.plugin.saveSettings()})),new T.Setting(h).setName("RRF log top N").setDesc("Log the top N RRF-ranked chunks to stderr (0 disables).").addText(C=>C.setPlaceholder("0").setValue(String(this.plugin.settings.rrfLogTop)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.rrfLogTop=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()})),new T.Setting(h).setName("Max chunks per document").setDesc("Limit how many chunks from a single document can appear in retrieval (0 disables).").addText(C=>C.setPlaceholder("0").setValue(String(this.plugin.settings.maxChunksPerDoc)).onChange(async A=>{let D=Number.parseInt(A,10);this.plugin.settings.maxChunksPerDoc=Number.isFinite(D)?Math.max(0,D):0,await this.plugin.saveSettings()}))}},{id:"maintenance",label:"Maintenance",render:h=>{h.createEl("h2",{text:"Python Runtime"}),new T.Setting(h).setName("Use local runtime (legacy)").setDesc("Switch to local interpreter/venv mode and enable advanced runtime settings.").addButton(k=>k.setButtonText("Switch").onClick(async()=>{await this.plugin.switchPythonRuntimeToLocalLegacy()})),h.createEl("h2",{text:"Logging"}),new T.Setting(h).setName("Enable logging to file").setDesc("Write plugin logs to a file.").addToggle(k=>k.setValue(this.plugin.settings.enableFileLogging).onChange(async x=>{this.plugin.settings.enableFileLogging=x,await this.plugin.saveSettings()})),new T.Setting(h).setName("Log file path (vault-relative)").setDesc("Where to write the log file. Keep inside the vault.").addText(k=>k.setPlaceholder(`${ne}/logs/docling_extract.log`).setValue(this.plugin.settings.logFilePath).onChange(async x=>{this.plugin.settings.logFilePath=x.trim()||`${ne}/logs/docling_extract.log`,await this.plugin.saveSettings()})),new T.Setting(h).setName("View or clear log").setDesc("Open the log file or clear it.").addButton(k=>k.setButtonText("Open log").onClick(async()=>{var x,w;await((w=(x=this.plugin).openLogFile)==null?void 0:w.call(x))})).addButton(k=>k.setButtonText("Clear log").onClick(async()=>{var x,w;await((w=(x=this.plugin).clearLogFile)==null?void 0:w.call(x))})),h.createEl("h2",{text:"Zotero Companion Plugin"}),h.createEl("p",{text:"Download the XPI, then in Zotero go to Tools \u2192 Add-ons \u2192 Install from File and restart."}),new T.Setting(h).setName("Download companion add-on").setDesc("Downloads the companion XPI to your system Downloads folder.").addButton(k=>k.setButtonText("Download XPI").onClick(async()=>{let x=this.getDefaultDownloadDir();if(!x){new T.Notice("Unable to resolve the system Downloads folder.");return}let w=Ue.default.join(x,"zrr-companion.xpi");if(await this.companionXpiExists(w)){new T.Notice(`Companion XPI already exists: ${w}`);return}new T.Notice("Downloading companion XPI..."),await this.downloadCompanionXpi(w)})),new T.Setting(h).setName("Open Zotero").setDesc("Launch Zotero and open the Add-ons window (Tools \u2192 Add-ons).").addButton(k=>k.setButtonText("Open Zotero").onClick(async()=>{await this.plugin.openZoteroAddons()})),new T.Setting(h).setName("Check companion status").setDesc("Ping the companion /health endpoint.").addButton(k=>k.setButtonText("Check status").onClick(async()=>{await this.plugin.checkZoteroCompanionHealth()})),h.createEl("h2",{text:"Redis Indexing"}),new T.Setting(h).setName("Reindex Redis from cached chunks").setDesc("Rebuild the Redis index from cached chunk JSON files.").addButton(k=>k.setButtonText("Reindex").onClick(async()=>{await this.plugin.reindexRedisFromCache()})),new T.Setting(h).setName("Recreate missing notes from cache").setDesc("Rebuild missing notes using cached Zotero items and chunks.").addButton(k=>k.setButtonText("Recreate").onClick(async()=>{await this.plugin.recreateMissingNotesFromCache()})).addButton(k=>k.setButtonText("Cancel").onClick(()=>{this.plugin.cancelRecreateMissingNotesFromCache()})),h.createEl("h2",{text:"Release Notes"}),new T.Setting(h).setName("Show release notes").setDesc("Open the current version splash screen.").addButton(k=>k.setButtonText("Show").onClick(async()=>{await this.plugin.openReleaseNotesModal()}))}}],u=new Map,p=new Map,f=h=>{this.activeTab=h;for(let[k,x]of u){let w=k===h;x.classList.toggle("is-active",w),x.setAttribute("aria-selected",w?"true":"false"),x.setAttribute("tabindex",w?"0":"-1")}for(let[k,x]of p){let w=k===h;x.classList.toggle("is-active",w),x.hidden=!w}},y=e.createDiv({cls:"zrr-settings-tabs"});y.setAttribute("role","tablist");let b=e.createDiv({cls:"zrr-settings-tabs-panels"});for(let h of d){let k=y.createEl("button",{text:h.label,cls:"zrr-settings-tab-button"}),x=`zrr-settings-tab-${h.id}`,w=`zrr-settings-panel-${h.id}`;k.type="button",k.id=x,k.setAttribute("role","tab"),k.setAttribute("aria-controls",w),k.setAttribute("aria-selected","false"),k.addEventListener("click",()=>f(h.id));let R=b.createDiv({cls:"zrr-settings-tab-panel"});R.id=w,R.setAttribute("role","tabpanel"),R.setAttribute("aria-labelledby",x),R.hidden=!0,h.render(R),u.set(h.id,k),p.set(h.id,R)}let v=d.some(h=>h.id===this.activeTab)?this.activeTab:d[0].id;f(v)}getDefaultDownloadDir(){let e=process.env.HOME||process.env.USERPROFILE;return e?Ue.default.join(e,"Downloads"):null}async companionXpiExists(e){try{return await Ve.promises.access(e),!0}catch(t){return!1}}async downloadCompanionXpi(e){try{await Ve.promises.mkdir(Ue.default.dirname(e),{recursive:!0});let t=await(0,T.requestUrl)({url:wn,method:"GET"});if(t.status!==200){new T.Notice(`Failed to download companion XPI (HTTP ${t.status}).`);return}let n=Buffer.from(t.arrayBuffer);await Ve.promises.writeFile(e,n),new T.Notice(`Downloaded companion XPI: ${e}`)}catch(t){new T.Notice("Failed to download companion XPI. See console for details."),console.warn("Failed to download companion XPI",t)}}};var jt=require("@codemirror/state"),$t=require("@codemirror/view"),de=require("obsidian");var vn=g=>{let _=g.scrollDOM.getBoundingClientRect(),e=g.posAtCoords({x:_.left+8,y:+_.height*.25});return e===null?null:g.state.doc.lineAt(e).number},Ge=class{constructor(_,e){this.pdfSidebarLeaf=null;this.pdfSidebarDocId=null;this.pdfSidebarPdfPath=null;this.pdfSidebarPage=null;this.pendingPdfSync=null;this.chunkPageCache=new Map;this.previewScrollEl=null;this.previewScrollHandler=null;this.previewScrollFrame=null;this.pdfSyncInFlight=!1;this.queuedPdfSync=null;this.deps=_,this.helpers=e}createSyncExtension(){let _=this,e=this.helpers;return $t.ViewPlugin.fromClass(class{constructor(t){this.docId=null;this.lastPage=null;this.lastChunkId=null;this.scrollFrame=null;this.view=t,this.docId=e.extractDocIdFromDoc(t.state.doc),this.onScroll=()=>this.scheduleSync(!1),t.scrollDOM.addEventListener("scroll",this.onScroll,{passive:!0}),this.scheduleSync(!0)}update(t){t.docChanged&&(this.docId=e.extractDocIdFromDoc(t.view.state.doc),this.lastPage=null,this.lastChunkId=null),(t.docChanged||t.viewportChanged)&&this.scheduleSync(!1)}destroy(){this.view.scrollDOM.removeEventListener("scroll",this.onScroll),this.scrollFrame!==null&&(window.cancelAnimationFrame(this.scrollFrame),this.scrollFrame=null)}scheduleSync(t){this.scrollFrame===null&&(this.scrollFrame=window.requestAnimationFrame(()=>{this.scrollFrame=null,this.syncPdfSidebar(this.view,t)}))}syncPdfSidebar(t,n){var u,p;let i=this.docId;if(!i)return;let r=vn(t);if(r===null)return;let a=e.findChunkStartLineInDoc(t.state.doc,r);if(!a)return;let s=e.parseChunkMarkerLine(a.text),o=(u=s==null?void 0:s.pageNumber)!=null?u:null,l=(p=s==null?void 0:s.chunkId)!=null?p:null;if(!o&&!l)return;let c=o!==null&&this.lastPage===o,d=o===null&&l!==null&&this.lastChunkId===l;!n&&(c||d)||(this.lastPage=o,this.lastChunkId=l,_.syncPdfSidebarForDoc(i,o!=null?o:void 0,l!=null?l:void 0))}})}async maybeSyncPendingPdf(){var e,t;if(!this.pendingPdfSync||(!this.pdfSidebarLeaf||((t=(e=this.pdfSidebarLeaf.view)==null?void 0:e.getViewType)==null?void 0:t.call(e))!=="pdf")&&!await this.getPdfSidebarLeaf()||!this.pdfSidebarLeaf||!this.isLeafTabActive(this.pdfSidebarLeaf))return;let _=this.pendingPdfSync;this.pendingPdfSync=null,await this.syncPdfSidebarForDoc(_.docId,_.pageNumber,_.chunkId)}updatePreviewScrollHandler(){var n;let _=this.deps.app.workspace.getActiveViewOfType(de.MarkdownView);if(!_||_.getMode()!=="preview"){this.detachPreviewScrollHandler();return}let e=(n=_.previewMode)==null?void 0:n.containerEl;if(!e){this.detachPreviewScrollHandler();return}if(this.previewScrollEl===e)return;this.detachPreviewScrollHandler();let t=()=>this.schedulePreviewSync(_);e.addEventListener("scroll",t,{passive:!0}),this.previewScrollEl=e,this.previewScrollHandler=t,this.schedulePreviewSync(_)}async syncPdfSidebarForFile(_){try{let e=await this.deps.app.vault.read(_),t=await this.deps.resolveDocIdForNote(_,e);if(!t)return;let n=this.helpers.extractFirstChunkMarkerFromContent(e);await this.syncPdfSidebarForDoc(t,n==null?void 0:n.pageNumber,n==null?void 0:n.chunkId)}catch(e){console.warn("Failed to sync PDF sidebar for opened note",e)}}async syncPdfSidebarForDoc(_,e,t){if(_){if(this.pdfSyncInFlight){this.queuedPdfSync={docId:_,pageNumber:e,chunkId:t};return}this.pdfSyncInFlight=!0;try{let n=await this.deps.getDocIndexEntry(_);n||(n=await this.deps.hydrateDocIndexFromCache(_));let i=n!=null&&n.pdf_path?String(n.pdf_path):"";if(!i)return;let r=this.deps.toVaultRelativePath(i);if(!r){let d=(0,de.normalizePath)(i);this.deps.app.vault.getAbstractFileByPath(d)instanceof de.TFile&&(r=d)}if(!r)return;let a=this.deps.app.vault.getAbstractFileByPath(r);if(!(a instanceof de.TFile)||a.extension.toLowerCase()!=="pdf")return;let s=await this.getPdfSidebarLeaf();if(!s){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:t};return}if(this.updatePdfSidebarIcon(s),!this.isLeafTabActive(s)){this.pendingPdfSync={docId:_,pageNumber:e,chunkId:t};return}let o=Number.isFinite(e!=null?e:NaN)?Number(e):null;if(o===null&&t&&(o=await this.resolvePageNumberForChunk(_,t)),o===null||this.pdfSidebarDocId===_&&this.pdfSidebarPdfPath===a.path&&this.pdfSidebarPage===o)return;this.pdfSidebarDocId=_,this.pdfSidebarPdfPath=a.path,this.pdfSidebarPage=o;let l=r,c=o!==null?`${l}#page=${o}`:l;await this.openPdfLinkInLeaf(s,c),this.updatePdfSidebarIcon(s)}finally{this.pdfSyncInFlight=!1;let n=this.queuedPdfSync;this.queuedPdfSync=null,n&&this.syncPdfSidebarForDoc(n.docId,n.pageNumber,n.chunkId)}}}detachPreviewScrollHandler(){this.previewScrollEl&&this.previewScrollHandler&&this.previewScrollEl.removeEventListener("scroll",this.previewScrollHandler),this.previewScrollEl=null,this.previewScrollHandler=null,this.previewScrollFrame!==null&&(window.cancelAnimationFrame(this.previewScrollFrame),this.previewScrollFrame=null)}schedulePreviewSync(_){this.previewScrollFrame===null&&(this.previewScrollFrame=window.requestAnimationFrame(()=>{this.previewScrollFrame=null,this.syncPdfSidebarForPreview(_)}))}syncPdfSidebarForPreview(_){let e=this.previewScrollEl;if(!e)return;let t=_.getViewData();if(!t)return;let n=jt.Text.of(t.split(/\r?\n/)),i=this.helpers.extractDocIdFromDoc(n);if(!i)return;let r=this.getPreviewTopLineNumber(e);if(r===null)return;let a=this.helpers.findChunkStartLineInDoc(n,r+1);if(!a)return;let s=this.helpers.parseChunkMarkerLine(a.text);!(s!=null&&s.pageNumber)&&!(s!=null&&s.chunkId)||this.syncPdfSidebarForDoc(i,s==null?void 0:s.pageNumber,s==null?void 0:s.chunkId)}getPreviewTopLineNumber(_){var n;let e=_.getBoundingClientRect().top,t=_.querySelectorAll("[data-line]");for(let i of Array.from(t))if(i.getBoundingClientRect().bottom>=e+2){let a=(n=i.getAttribute("data-line"))!=null?n:"",s=Number.parseInt(a,10);if(Number.isFinite(s))return s}return null}async getPdfSidebarLeaf(){var n,i;if(this.pdfSidebarLeaf&&((i=(n=this.pdfSidebarLeaf.view)==null?void 0:n.getViewType)==null?void 0:i.call(n))==="pdf")return this.pdfSidebarLeaf;let _=this.deps.app.workspace;if(typeof _.ensureSideLeaf=="function")try{let r=await _.ensureSideLeaf("pdf","right",{active:!1,split:!1,reveal:!0});return this.isRightSidebarLeaf(r)?(this.pdfSidebarLeaf=r,this.updatePdfSidebarIcon(r),r):null}catch(r){console.warn("Failed to ensure PDF side leaf",r)}let e=this.deps.app.workspace.getRightLeaf(!1);if(e&&this.isRightSidebarLeaf(e))return this.pdfSidebarLeaf=e,this.updatePdfSidebarIcon(e),e;let t=this.deps.app.workspace.getRightLeaf(!0);return t&&this.isRightSidebarLeaf(t)?(this.pdfSidebarLeaf=t,this.updatePdfSidebarIcon(t),t):null}isRightSidebarLeaf(_){if(!_)return!1;let t=_.containerEl;return!!(t!=null&&t.closest(".workspace-split.mod-right-split, .mod-right-split"))}updatePdfSidebarIcon(_){if(!_||!this.isRightSidebarLeaf(_))return;let t=_.containerEl,n=[];t&&n.push(...Array.from(t.querySelectorAll(".view-header-icon")));let i=_;if(i.tabHeaderEl&&n.push(...Array.from(i.tabHeaderEl.querySelectorAll(".workspace-tab-header-inner-icon, .view-header-icon"))),i.tabHeaderInnerIconEl&&n.push(i.tabHeaderInnerIconEl),n.length===0)return;let r=new Set;for(let s of n)r.has(s)||(r.add(s),s.innerHTML="",(0,de.setIcon)(s,"zrr-pdf"),!s.querySelector("svg")&&this.deps.iconSvg&&(s.innerHTML=this.deps.iconSvg),s.dataset&&(s.dataset.zrrIcon="zrr-pdf"));let a=_.view;a.icon="zrr-pdf",typeof a.getIcon=="function"&&(a.getIcon=()=>"zrr-pdf")}async openPdfLinkInLeaf(_,e){var r,a,s;let t=(r=this.getPluginsRegistry())==null?void 0:r["pdf-plus"],n=(s=(a=t==null?void 0:t.lib)==null?void 0:a.workspace)==null?void 0:s.openPDFLinkTextInLeaf;if(typeof n=="function")try{await n.call(t.lib.workspace,_,e,"",{active:!1});return}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150)}let i=_;if(typeof i.openLinkText=="function"){try{await i.openLinkText(e,"",{active:!1})}catch(o){if(!this.isPdfAnnotationRaceError(o))throw o;await this.delay(150),await i.openLinkText(e,"",{active:!1})}return}await this.deps.app.workspace.openLinkText(e,"",!1)}isPdfAnnotationRaceError(_){let e=_ instanceof Error?_.message:String(_!=null?_:"");return e?/injectLinkAnnotations/i.test(e)||/render method must be called before/i.test(e):!1}delay(_){return new Promise(e=>setTimeout(e,_))}getPluginsRegistry(){var _;return(_=this.deps.app.plugins)==null?void 0:_.plugins}isLeafTabActive(_){var i;let e=_;if((i=e.parent)!=null&&i.activeLeaf)return e.parent.activeLeaf===_;let t=e.containerEl;if(t!=null&&t.classList.contains("is-active")||t!=null&&t.classList.contains("mod-active"))return!0;let n=e.tabHeaderEl;return!!(n!=null&&n.classList.contains("is-active")||n!=null&&n.classList.contains("mod-active"))}async resolvePageNumberForChunk(_,e){var l,c,d,u,p;if(!_||!e)return null;let t=this.deps.normalizeChunkIdForNote(e,_)||e,n=this.chunkPageCache.get(_);if(n&&n.has(t))return(l=n.get(t))!=null?l:null;let i=(0,de.normalizePath)(`${Q}/${_}.json`);if(!await this.deps.app.vault.adapter.exists(i))return null;let a=await this.deps.readChunkPayload(i),s=Array.isArray(a==null?void 0:a.chunks)?a==null?void 0:a.chunks:[],o=new Map;for(let f of s){let y=typeof(f==null?void 0:f.chunk_id)=="string"?f.chunk_id.trim():"";if(!y)continue;let b=Number.isFinite((c=f==null?void 0:f.page_start)!=null?c:NaN)?Number(f.page_start):null,v=Number.isFinite((d=f==null?void 0:f.page_end)!=null?d:NaN)?Number(f.page_end):null,h=b!=null?b:v;h!==null&&(o.set(y,h),o.set(`${_}:${y}`,h))}return this.chunkPageCache.set(_,o),(p=(u=o.get(t))!=null?u:o.get(e))!=null?p:null}};var We={"zrr-picker":`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
`};var me=require("@codemirror/state"),ce=require("@codemirror/view"),K=require("obsidian");var G=g=>{if(typeof g=="string")return g.trim();if(typeof g=="number"&&Number.isFinite(g))return String(g);if(Array.isArray(g))for(let _ of g){if(typeof _=="string"&&_.trim())return _.trim();if(typeof _=="number"&&Number.isFinite(_))return String(_)}if(g&&typeof g=="object"){let _=g[0];if(typeof _=="string"&&_.trim())return _.trim();if(typeof _=="number"&&Number.isFinite(_))return String(_)}return""},Vt=g=>{let _=[g.key,g.itemKey,g.id,g.citationKey];for(let e of _)if(typeof e=="string"&&e.trim())return e.trim();return null},Ut=g=>{var e,t,n;let _=(n=(t=g.key)!=null?t:(e=g.data)==null?void 0:e.key)!=null?n:"";return typeof _=="string"?_:""},gt=g=>{if(!g)return"";let _=g.match(/\b(\d{4})\b/);return _?_[1]:""},Zt=g=>{var e,t,n,i;let _=(i=(n=(e=g.meta)==null?void 0:e.parsedDate)!=null?n:(t=g.data)==null?void 0:t.date)!=null?i:"";return typeof _!="string"?"":gt(_)},Pe=g=>{if(!g||typeof g!="object")return"";if(g.name)return String(g.name);let _=g.firstName?String(g.firstName):"",e=g.lastName?String(g.lastName):"";return[e,_].filter(Boolean).join(", ")||`${_} ${e}`.trim()},He=(g,_)=>{let e=[g.citationKey,g["citation-key"],g.citation_key,_==null?void 0:_.citationKey,_==null?void 0:_["citation-key"],_==null?void 0:_.citation_key,g.citationkey,g.citekey,g.citeKey,g.betterBibtexKey,g.betterbibtexkey,_==null?void 0:_.citationkey,_==null?void 0:_.citekey,_==null?void 0:_.citeKey,_==null?void 0:_.betterBibtexKey,_==null?void 0:_.betterbibtexkey];for(let i of e){let r=G(i);if(r)return r}let t=typeof g.extra=="string"?g.extra:"";if(!t)return"";let n=t.split(/\r?\n/);for(let i of n){let r=i.match(/^\s*biblatexcitekey\s*\[([^\]]+)\]\s*$/i);if(r&&r[1])return r[1].trim();let a=i.match(/^\s*(citation key|citationkey|citekey|citation-key|bibtex key|bibtexkey|bibtex)\s*:\s*(.+)\s*$/i);if(a&&a[2])return a[2].trim()}return""},ht=g=>{if(!g)return"";let _=[g["citation-key"],g.citationKey,g.citationkey,g.citekey,g.citation_key];for(let e of _){let t=G(e);if(t)return t}return""},Bt=g=>{var e,t;if(!g)return"";let _=(t=(e=g["title-short"])!=null?e:g.shortTitle)!=null?t:g.short_title;return typeof _=="string"?_.trim():""},Ce=g=>{let _=G(g.shortTitle);if(_)return _;let e=G(g.short_title);if(e)return e;let t=G(g["title-short"]);return t||""},Gt=g=>{let _=typeof g.extra=="string"?g.extra:"";if(!_)return"";let e=_.split(/\r?\n/);for(let n of e){let i=n.match(/^\s*doi\s*:\s*(.+)\s*$/i);if(i&&i[1])return i[1].trim().replace(/[.,;]+$/,"")}let t=_.match(/\b10\.\d{4,9}\/[-._;()/:A-Z0-9]+\b/i);return t?t[0].replace(/[.,;]+$/,""):""},Wt=g=>{var e;if(!g)return"";let _=(e=g.DOI)!=null?e:g.doi;return typeof _=="string"?_.trim().replace(/[.,;]+$/,""):""},Pn=g=>{if(!g)return[];let _=[g.attachments,g.children,g.items,g.attachment,g.allAttachments],e=[];for(let t of _)t&&(Array.isArray(t)?e.push(...t):typeof t=="object"&&e.push(t));return e},ft=g=>{var t,n,i,r,a,s,o,l,c,d,u,p,f,y,b;if(((s=(a=(i=(t=g==null?void 0:g.contentType)!=null?t:g==null?void 0:g.mimeType)!=null?i:(n=g==null?void 0:g.data)==null?void 0:n.contentType)!=null?a:(r=g==null?void 0:g.data)==null?void 0:r.mimeType)!=null?s:"")==="application/pdf")return!0;let e=(b=(y=(p=(u=(c=(o=g==null?void 0:g.filename)!=null?o:g==null?void 0:g.fileName)!=null?c:(l=g==null?void 0:g.data)==null?void 0:l.filename)!=null?u:(d=g==null?void 0:g.data)==null?void 0:d.fileName)!=null?p:g==null?void 0:g.path)!=null?y:(f=g==null?void 0:g.data)==null?void 0:f.path)!=null?b:"";return!!(typeof e=="string"&&e.toLowerCase().endsWith(".pdf"))},Ht=g=>{var t;let _=Pn(g.data);if(_.length>0)return _.some(i=>ft(i))?"yes":"no";let e=(t=g.meta)==null?void 0:t.numChildren;return typeof e=="number"&&e===0?"no":"unknown"};var Cn={artwork:"image",audioRecording:"music",bill:"file-text",blogPost:"globe",book:"book",bookSection:"book-open",case:"scale",computerProgram:"code",conferencePaper:"file-text",dataset:"database",dictionaryEntry:"book",document:"file-text",email:"mail",encyclopediaArticle:"book",film:"film",forumPost:"message-circle",hearing:"file-text",interview:"mic",journalArticle:"file-text",letter:"mail",magazineArticle:"file-text",manuscript:"file-text",map:"map",newspaperArticle:"file-text",patent:"award",podcast:"mic",preprint:"file-text",presentation:"file-text",radioBroadcast:"music",report:"file-text",statute:"scale",thesis:"graduation-cap",tvBroadcast:"film",videoRecording:"film",webpage:"globe"},Kt=[{label:"Auto (no hint)",value:""},{label:"English (en)",value:"en"},{label:"German (de)",value:"de"},{label:"German + English (de,en)",value:"de,en"},{label:"French (fr)",value:"fr"},{label:"Spanish (es)",value:"es"},{label:"Italian (it)",value:"it"},{label:"Dutch (nl)",value:"nl"},{label:"Portuguese (pt)",value:"pt"},{label:"Polish (pl)",value:"pl"},{label:"Swedish (sv)",value:"sv"},{label:"Other (custom ISO code)",value:"__custom__"}],An="https://github.com/jmiba/zotero-redisearch-rag/blob/main/CHANGELOG.md",Rn=g=>g.includes("STDERR")?"zrr-log-stderr":g.includes("ERROR")?"zrr-log-error":g.includes("WARNING")||g.includes("WARN")?"zrr-log-warning":g.includes("INFO")?"zrr-log-info":null,Jt=g=>{let _=new me.RangeSetBuilder;for(let{from:e,to:t}of g.visibleRanges){let n=e;for(;n<=t;){let i=g.state.doc.lineAt(n),r=Rn(i.text);r&&_.add(i.from,i.from,ce.Decoration.line({class:r})),n=i.to+1}}return _.finish()},Xt=ce.EditorView.theme({".cm-editor":{height:"100%",display:"flex",flexDirection:"column",minHeight:"0"},".cm-scroller":{fontFamily:"var(--font-monospace)",fontSize:"0.85rem",flex:"1",height:"100%",maxHeight:"100%",overflow:"auto"},".zrr-log-error":{color:"var(--text-error)"},".zrr-log-warning":{color:"var(--text-accent)"},".zrr-log-info":{color:"var(--text-muted)"},".zrr-log-stderr":{color:"var(--text-accent)"}}),Yt=ce.ViewPlugin.fromClass(class{constructor(g){this.decorations=Jt(g)}update(g){(g.docChanged||g.viewportChanged)&&(this.decorations=Jt(g.view))}},{decorations:g=>g.decorations}),Ne=class extends K.Modal{constructor(_,e,t,n,i="Value cannot be empty."){super(_),this.titleText=e,this.placeholder=t,this.onSubmit=n,this.emptyMessage=i}onOpen(){let{contentEl:_}=this;_.empty(),_.createEl("h3",{text:this.titleText});let e=_.createEl("input",{type:"text",placeholder:this.placeholder});e.style.width="100%",e.focus();let t=_.createEl("button",{text:"Submit"});t.style.marginTop="0.75rem";let n=()=>{let i=e.value.trim();if(!i){new K.Notice(this.emptyMessage);return}this.close(),this.onSubmit(i)};t.addEventListener("click",n),e.addEventListener("keydown",i=>{i.key==="Enter"&&n()})}},Le=class extends K.Modal{constructor(e,t,n){super(e);this.markdownComponent=null;this.version=t,this.markdown=n}onOpen(){var a;let{contentEl:e}=this;e.empty(),e.addClass("zrr-release-notes-modal"),e.createEl("h3",{text:"What's new"}),(a=this.markdownComponent)==null||a.unload(),this.markdownComponent=new K.Component,this.markdownComponent.load();let t=String(this.markdown||"").trim();if(t){let s=e.createDiv({cls:"zrr-release-notes-body"});K.MarkdownRenderer.renderMarkdown(t,s,"",this.markdownComponent)}else e.createEl("p",{text:"This version includes improvements and fixes."});let n=e.createDiv({cls:"zrr-release-notes-body"});K.MarkdownRenderer.renderMarkdown(`[Full changelog](${An})`,n,"",this.markdownComponent),e.createEl("div",{cls:"zrr-release-notes-actions"}).createEl("button",{text:"Close"}).addEventListener("click",()=>this.close())}onClose(){var e;(e=this.markdownComponent)==null||e.unload(),this.markdownComponent=null,this.contentEl.empty()}},Ke=class extends K.Modal{constructor(_,e,t,n,i){super(_),this.chunkId=e,this.initialTags=t,this.onSubmit=n,this.onRegenerate=i}onOpen(){let{contentEl:_}=this;_.empty(),_.createEl("h3",{text:`Edit tags for ${this.chunkId}`});let e=_.createEl("textarea",{attr:{rows:"3"}});e.style.width="100%",e.placeholder="tag1, tag2, tag3",e.value=this.initialTags.join(", "),e.focus();let t=_.createEl("div");t.style.display="flex",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let n=t.createEl("button",{text:"Save tags"}),i=async()=>{let a=(e.value||"").split(/[,;\n]+/).map(o=>o.trim()).filter(o=>o.length>0),s=Array.from(new Set(a));this.close(),await Promise.resolve(this.onSubmit(s))};if(this.onRegenerate){let r=t.createEl("button",{text:"Regenerate"});r.addEventListener("click",async()=>{var a;r.setAttribute("disabled","true"),n.setAttribute("disabled","true");try{let s=await((a=this.onRegenerate)==null?void 0:a.call(this));s&&s.length>0?(e.value=s.join(", "),await Promise.resolve(this.onSubmit(s))):s&&new K.Notice("No tags were generated.")}finally{r.removeAttribute("disabled"),n.removeAttribute("disabled")}})}n.addEventListener("click",i),e.addEventListener("keydown",r=>{r.key==="Enter"&&(r.metaKey||r.ctrlKey)&&i()})}},Je=class extends K.Modal{constructor(_,e,t,n=""){super(_),this.titleText=e,this.content=t,this.noteText=n}onOpen(){let{contentEl:_}=this;if(_.empty(),_.createEl("h3",{text:this.titleText}),this.noteText){let t=_.createEl("div",{text:this.noteText});t.className="zrr-indexed-note"}let e=_.createEl("textarea",{attr:{rows:"12",readonly:"true"}});e.style.width="100%",e.value=this.content}},Xe=class extends K.Modal{constructor(e,t,n=""){super(e);this.bodyText="";this.plugin=t,this.initialTerm=n}onOpen(){let{contentEl:e}=this;e.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),e.style.display="flex",e.style.flexDirection="column",e.style.height="100%",e.style.overflow="hidden",e.style.minHeight="0";let t=e.createDiv();t.style.display="flex",t.style.alignItems="center",t.style.justifyContent="space-between",t.style.gap="0.5rem",t.createEl("h3",{text:"Redis index search"});let n=t.createEl("button",{text:"Copy All"});n.style.marginLeft="auto",n.addEventListener("click",()=>{this.copyResultsToClipboard()});let i=e.createDiv();i.style.display="flex",i.style.alignItems="center",i.style.gap="0.5rem",i.style.margin="0.5rem 0";let r=i.createEl("input");r.type="text",r.placeholder="Search term",r.value=this.initialTerm,r.style.flex="1",r.style.minWidth="0",this.inputEl=r,i.createEl("button",{text:"Search"}).addEventListener("click",()=>{this.runSearch()}),r.addEventListener("keydown",c=>{c.key==="Enter"&&(c.preventDefault(),this.runSearch())});let s=e.createDiv();s.style.color="var(--text-muted)",s.style.marginBottom="0.5rem",this.statusEl=s;let o=e.createDiv();o.style.flex="1 1 0",o.style.minHeight="0",o.style.border="1px solid var(--background-modifier-border)",o.style.borderRadius="6px",o.style.display="flex",o.style.flexDirection="column",o.style.overflow="auto";let l=me.EditorState.create({doc:this.bodyText,extensions:[Xt,Yt,ce.EditorView.editable.of(!1),me.EditorState.readOnly.of(!0),ce.EditorView.lineWrapping]});this.editorView=new ce.EditorView({state:l,parent:o}),this.initialTerm&&this.runSearch()}onClose(){var e;(e=this.editorView)==null||e.destroy(),this.editorView=void 0}async runSearch(){var n;let e=(((n=this.inputEl)==null?void 0:n.value)||"").trim();if(!e){this.statusEl&&(this.statusEl.textContent="Enter a search term.");return}this.statusEl&&(this.statusEl.textContent="Searching...");let t=await this.plugin.runRedisSearch(e);this.updateEditor(t),this.statusEl&&(this.statusEl.textContent=`Results for "${e}"`)}updateEditor(e){if(!this.editorView)return;let t=this.editorView,n=t.scrollDOM.scrollTop,i=t.state.selection.main,r=e.length,a=Math.min(i.anchor,r),s=Math.min(i.head,r);t.dispatch({changes:{from:0,to:t.state.doc.length,insert:e},selection:{anchor:a,head:s}}),t.scrollDOM.scrollTop=n,this.bodyText=e}copyResultsToClipboard(){let e=this.bodyText||"";if(!e){new K.Notice("Nothing to copy.");return}navigator.clipboard.writeText(e).then(()=>new K.Notice("Results copied to clipboard.")).catch(()=>new K.Notice("Failed to copy results."))}},Ae=class extends K.Modal{constructor(_,e,t,n){super(_),this.titleText=e,this.bodyText=t,this.options=n}onOpen(){var r,a,s,o;let{contentEl:_}=this;_.empty(),this.modalEl&&(this.modalEl.style.width="80vw",this.modalEl.style.maxWidth="1200px",this.modalEl.style.height="80vh",this.modalEl.style.maxHeight="90vh",this.modalEl.style.resize="both",this.modalEl.style.overflow="hidden"),_.style.display="flex",_.style.flexDirection="column",_.style.height="100%",_.style.overflow="hidden",_.style.minHeight="0";let e=_.createDiv();e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="space-between",e.style.gap="0.5rem",e.createEl("h3",{text:this.titleText});let t=e.createDiv();if(t.style.display="flex",t.style.gap="0.5rem",(r=this.options)!=null&&r.onClear){let l=(a=this.options.clearLabel)!=null?a:"Clear log";t.createEl("button",{text:l}).addEventListener("click",async()=>{var d,u;try{await((u=(d=this.options)==null?void 0:d.onClear)==null?void 0:u.call(d))}finally{await this.refreshFromSource()}})}let n=_.createDiv();n.style.flex="1 1 0",n.style.minHeight="0",n.style.border="1px solid var(--background-modifier-border)",n.style.borderRadius="6px",n.style.display="flex",n.style.flexDirection="column",n.style.overflow="auto";let i=me.EditorState.create({doc:this.bodyText,extensions:[Xt,Yt,ce.EditorView.editable.of(!0),me.EditorState.readOnly.of(!1),ce.EditorView.lineWrapping]});if(this.editorView=new ce.EditorView({state:i,parent:n}),this.refreshFromSource(),(s=this.options)!=null&&s.autoRefresh&&this.options.onRefresh){let l=(o=this.options.refreshIntervalMs)!=null?o:2e3;this.refreshTimer=window.setInterval(()=>{this.refreshFromSource()},l)}}onClose(){var _;this.refreshTimer!==void 0&&(window.clearInterval(this.refreshTimer),this.refreshTimer=void 0),(_=this.editorView)==null||_.destroy(),this.editorView=void 0}async refreshFromSource(){var s;if(!((s=this.options)!=null&&s.onRefresh)||!this.editorView)return;let _="";try{_=await this.options.onRefresh()||""}catch(o){return}if(_===this.bodyText)return;let e=this.editorView,t=e.scrollDOM.scrollTop,n=e.state.selection.main,i=_.length,r=Math.min(n.anchor,i),a=Math.min(n.head,i);e.dispatch({changes:{from:0,to:e.state.doc.length,insert:_},selection:{anchor:r,head:a}}),e.scrollDOM.scrollTop=t,this.bodyText=_}},Ye=class extends K.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.filePath=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Overwrite existing note?"}),e.createEl("p",{text:`This will overwrite: ${this.filePath}`});let t=e.createEl("div");t.style.display="flex",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Overwrite"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},Qe=class extends K.Modal{constructor(e,t,n,i){super(e);this.resolved=!1;this.notePath=t,this.docId=n,this.onResolve=i}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Delete note and cached data?"}),e.createEl("p",{text:`This will delete the note and cached chunks/items for doc_id ${this.docId}.`}),e.createEl("p",{text:`Note: ${this.notePath}`});let t=e.createEl("div");t.style.display="flex",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Delete"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},et=class extends K.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.reason=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Rebuild Redis index?"}),e.createEl("p",{text:this.reason}),e.createEl("p",{text:"This will drop the RedisSearch index (and embeddings) and rebuild it from cached chunks."});let t=e.createEl("div");t.style.display="flex",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Drop & rebuild"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},tt=class extends K.Modal{constructor(e,t){super(e);this.resolved=!1;this.onResolve=t}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Purge Redis orphaned chunks?"}),e.createEl("p",{text:"This removes Redis chunk keys that have no cached item.json or chunk.json on disk."}),e.createEl("p",{text:"Cache files are not deleted. Use this to clean up stale Redis data."});let t=e.createEl("div");t.style.display="flex",t.style.gap="0.5rem",t.style.marginTop="0.75rem";let n=t.createEl("button",{text:"Cancel"}),i=t.createEl("button",{text:"Purge orphans"});n.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!1)}),i.addEventListener("click",()=>{this.resolved=!0,this.close(),this.onResolve(!0)})}onClose(){this.resolved||this.onResolve(!1)}},nt=class extends K.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve metadata conflicts"}),e.createEl("p",{text:"Choose which values to keep for each field."});let t=e.createEl("div");t.style.display="grid",t.style.gap="0.75rem";for(let l of this.conflicts){let c=t.createEl("div");c.style.display="grid",c.style.gap="0.4rem",c.style.border="1px solid var(--background-modifier-border)",c.style.borderRadius="6px",c.style.padding="0.6rem",c.createEl("div",{text:l.fieldLabel}).style.fontWeight="600";let d=c.createEl("div");d.style.display="grid",d.style.gridTemplateColumns="1fr 1fr",d.style.gap="0.5rem";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});u.style.width="100%",u.value=l.noteValue||"(empty)";let p=d.createEl("textarea",{attr:{readonly:"true",rows:"3"}});p.style.width="100%",p.value=l.zoteroValue||"(empty)";let f=c.createEl("div");f.style.display="flex",f.style.gap="0.5rem",f.style.alignItems="center",f.createEl("span",{text:"Decision:"});let y=f.createEl("select");y.add(new Option(l.noteLabel,"note")),y.add(new Option(l.zoteroLabel,"zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.field,y)}let n=e.createEl("div");n.style.display="flex",n.style.flexWrap="wrap",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let i=l=>{for(let c of this.selects.values())c.value=l},r=n.createEl("button",{text:"Use note for all"}),a=n.createEl("button",{text:"Use Zotero for all"}),s=n.createEl("button",{text:"Skip all"}),o=n.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[t,n]of this.selects.entries())e[t]=n.value||"skip";this.onResolve(e)}}},it=class extends K.Modal{constructor(e,t,n){super(e);this.resolved=!1;this.selects=new Map;this.conflicts=t,this.onResolve=n}onOpen(){let{contentEl:e}=this;e.empty(),e.createEl("h3",{text:"Resolve annotation conflicts"}),e.createEl("p",{text:"Choose which version to keep for each annotation."});let t=e.createEl("div");t.style.display="grid",t.style.gap="0.75rem";for(let l of this.conflicts){let c=t.createEl("div");c.style.display="grid",c.style.gap="0.4rem",c.style.border="1px solid var(--background-modifier-border)",c.style.borderRadius="6px",c.style.padding="0.6rem",c.createEl("div",{text:l.title}).style.fontWeight="600";let d=c.createEl("div");d.style.display="grid",d.style.gridTemplateColumns="1fr 1fr",d.style.gap="0.5rem";let u=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});u.style.width="100%",u.value=l.noteValue||"(empty)";let p=d.createEl("textarea",{attr:{readonly:"true",rows:"4"}});p.style.width="100%",p.value=l.zoteroValue||"(empty)";let f=c.createEl("div");f.style.display="flex",f.style.gap="0.5rem",f.style.alignItems="center",f.createEl("span",{text:"Decision:"});let y=f.createEl("select");y.add(new Option("Use note","note")),y.add(new Option("Use Zotero","zotero")),y.add(new Option("Skip","skip")),y.value="skip",this.selects.set(l.key,y)}let n=e.createEl("div");n.style.display="flex",n.style.flexWrap="wrap",n.style.gap="0.5rem",n.style.marginTop="0.75rem";let i=l=>{for(let c of this.selects.values())c.value=l},r=n.createEl("button",{text:"Use note for all"}),a=n.createEl("button",{text:"Use Zotero for all"}),s=n.createEl("button",{text:"Skip all"}),o=n.createEl("button",{text:"Apply"});r.addEventListener("click",()=>i("note")),a.addEventListener("click",()=>i("zotero")),s.addEventListener("click",()=>i("skip")),o.addEventListener("click",()=>{let l={};for(let[c,d]of this.selects.entries())l[c]=d.value||"skip";this.resolved=!0,this.close(),this.onResolve(l)})}onClose(){if(!this.resolved){let e={};for(let[t,n]of this.selects.entries())e[t]=n.value||"skip";this.onResolve(e)}}},rt=class extends K.SuggestModal{constructor(e,t){super(e);this.resolved=!1;this.resolveSelection=t,this.setPlaceholder("Select a language for OCR/quality...")}getSuggestions(e){let t=e.trim().toLowerCase();return t?Kt.filter(n=>n.label.toLowerCase().includes(t)||n.value.toLowerCase().includes(t)):Kt}renderSuggestion(e,t){t.setText(e.label),t.addEventListener("click",()=>this.handleSelection(e))}onChooseSuggestion(e){this.handleSelection(e)}onClose(){this.resolved||this.resolveSelection(null)}handleSelection(e){if(!this.resolved){if(this.resolved=!0,e.value==="__custom__"){this.close(),new Ne(this.app,"Custom language hint","e.g., en, de, fr, de,en",t=>this.resolveSelection(t.trim()),"Language hint cannot be empty.").open();return}this.resolveSelection(e.value),this.close()}}},st=class extends K.SuggestModal{constructor(e,t,n){super(e);this.lastError=null;this.indexedDocIds=null;this.querySequence=0;this.queryDebounceMs=200;this.minQueryLength=2;this.maxQueryCacheEntries=100;this.queryCache=new Map;this.plugin=t,this.resolveSelection=n,this.setPlaceholder("Search Zotero items...")}async getSuggestions(e){let t=e.trim();if(t.length>0&&t.length<this.minQueryLength)return[];let n=t.toLowerCase(),i=this.queryCache.get(n);if(i)return i;let r=++this.querySequence;try{if(await new Promise(s=>{window.setTimeout(s,this.queryDebounceMs)}),r!==this.querySequence)return[];if(!this.indexedDocIds){let s=await this.plugin.getDocIndex();this.indexedDocIds=new Set(Object.keys(s))}let a=await this.plugin.searchZoteroItems(t);if(r!==this.querySequence)return[];if(this.queryCache.set(n,a),this.queryCache.size>this.maxQueryCacheEntries){let s=this.queryCache.keys().next().value;s!==void 0&&this.queryCache.delete(s)}return a}catch(a){let s=a instanceof Error?a.message:String(a);return this.lastError!==s&&(this.lastError=s,new K.Notice(s)),console.error("Zotero search failed",a),[]}}renderSuggestion(e,t){var b,v,h,k,x,w;let n=(v=(b=e.data)==null?void 0:b.title)!=null?v:"[No title]",i=Zt(e),r=Ut(e),a=r?(h=this.indexedDocIds)==null?void 0:h.has(r):!1,s=Ht(e),o=String((x=(k=e.data)==null?void 0:k.itemType)!=null?x:"").trim();a&&t.addClass("zrr-indexed-item"),s==="no"&&t.addClass("zrr-no-pdf-item");let l=t.createDiv({cls:"zrr-zotero-suggest-row"}),c=l.createSpan({cls:"zrr-zotero-item-icon"}),d=(w=Cn[o])!=null?w:"file-text";(0,K.setIcon)(c,d);let u=l.createDiv({cls:"zrr-zotero-suggest-text"});u.createEl("div",{text:n,cls:"zrr-zotero-suggest-title"});let p=u.createEl("small",{cls:"zrr-zotero-suggest-meta"}),f=!1,y=()=>{f&&p.createSpan({text:" - "})};i&&(p.createSpan({text:i}),f=!0),a&&(y(),p.createSpan({text:"Indexed",cls:"zrr-indexed-flag"}),f=!0),s==="no"&&(y(),p.createSpan({text:"No PDF attachment",cls:"zrr-no-pdf-flag"}),f=!0),t.addEventListener("click",()=>{this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()})}onChooseSuggestion(e,t){this.resolveSelection&&(this.resolveSelection(e),this.resolveSelection=null),this.close()}onClose(){this.resolveSelection&&(this.resolveSelection(null),this.resolveSelection=null)}};var Qt={"docling_extract.py":`#!/usr/bin/env python3
# zotero-redisearch-rag tool version: 0.9.7
import argparse
import atexit
import base64
import errno
...
`,"ocr_wordlist.txt":`# zotero-redisearch-rag tool version: 0.9.7
ackley
afton
alonso
altmetric
...
zaiser
zenodo
`,"requirements.txt":`# zotero-redisearch-rag tool version: 0.9.7
docling
langcodes[data]
markdown
markdown-it-py
...
spylls
`,"docker-compose.yml":`# zotero-redisearch-rag tool version: 0.9.7
services:
  redis-stack:
...
`,"python-worker.Dockerfile":`# zotero-redisearch-rag tool version: 0.9.7
...
`).trim()}getBundledReleaseNotesEntries(){var i,r;let e=new Set,t=Array.isArray(xt)?xt:[],n=[];for(let a of t){let s=this.normalizeReleaseVersion(String((i=a==null?void 0:a.version)!=null?i:"")),o=this.sanitizeReleaseNotesMarkdown(String((r=a==null?void 0:a.markdown)!=null?r:""));!s||e.has(s)||(e.add(s),n.push({version:s,markdown:o}))}return n.sort((a,s)=>this.compareReleaseVersions(s.version,a.version))}getReleaseNotesMarkdown(e,t){let n=this.normalizeReleaseVersion(e);if(!n)return"";let i=this.normalizeReleaseVersion(t||""),r=this.getBundledReleaseNotesEntries(),a=r.filter(o=>this.compareReleaseVersions(o.version,n)>0?!1:i?this.compareReleaseVersions(o.version,i)>0:o.version===n),s=a.length?a:r.filter(o=>o.version===n);if(!s.length)return"This version includes improvements and fixes.";if(s.length===1){let o=s[0],l=this.stripLeadingVersionHeading(this.sanitizeReleaseNotesMarkdown(String(o.markdown||"")),o.version);return`### v${o.version}
...
`).replace(/[ \t]*\n[ \t]*/g,`
`).trim()}scheduleNoteSync(e,t=1200){let n=this.noteSyncTimers.get(e.path);n!==void 0&&window.clearTimeout(n);let i=window.setTimeout(()=>{this.noteSyncTimers.delete(e.path),this.syncNoteToRedis(e)},t);this.noteSyncTimers.set(e.path,i)}scheduleNoteMetadataSync(e,t=1200,n="save"){let i=this.noteMetadataSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteMetadataSyncTimers.delete(e.path),this.syncNoteMetadataWithZotero(e,n)},t);this.noteMetadataSyncTimers.set(e.path,r)}scheduleNoteAnnotationSync(e,t=1200,n="save"){let i=this.noteAnnotationSyncTimers.get(e.path);i!==void 0&&window.clearTimeout(i);let r=window.setTimeout(()=>{this.noteAnnotationSyncTimers.delete(e.path),this.syncNoteAnnotationsWithZotero(e,n)},t);this.noteAnnotationSyncTimers.set(e.path,r)}getAnnotationGraceRemaining(e){let t=this.annotationNoteEditTimes.get(e);if(!t)return 0;let n=Date.now()-t;return n>=on?0:on-n}escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}formatCitationPageLabel(e){let t=(e.annotation_page_label||"").trim();if(t)return t;let n=e.page_start?String(e.page_start):"",i=e.page_end?String(e.page_end):"";if(n&&(!i||n===i))return n;if(n&&i)return`${n} - ${i}`;let r=(e.pages||"").trim();if(!r)return"?";let a=r.match(/^(\d+)\s*-\s*(\d+)$/);return a?a[1]===a[2]?a[1]:`${a[1]} - ${a[2]}`:r.replace("-"," - ")}normalizeChunkIdForNote(e,t){if(!e)return null;let n=String(e);if(t&&n.startsWith(`${t}:`))return n.slice(t.length+1);if(n.includes(":")){let i=n.split(":");if(i.length>1&&t&&i[0]===t)return i.slice(1).join(":")}return n}async syncNoteToRedis(e){var t,n,i;if(this.noteSyncInFlight.has(e.path)){this.noteSyncPending.add(e.path);return}if(this.noteSyncSuppressed.has(e.path)){this.scheduleNoteSync(e,2e3);return}this.noteSyncInFlight.add(e.path);try{let r=await this.app.vault.read(e),a=this.extractSyncSection(r);if(!a)return;let s=await this.resolveDocIdForNote(e,r);if(!s)return;let o=this.parseSyncedChunkBlocks(a);if(!o.length)return;let l=(0,m.normalizePath)(`${Q}/${s}.json`),c=this.app.vault.adapter;if(!await c.exists(l))return;let d=await this.readChunkPayload(l);if(!d)return;let u=Array.isArray(d.chunks)?d.chunks:[],p=new Map;for(let x of u){if(this.isAnnotationChunk(x))continue;let w=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((t=x==null?void 0:x.chunk_id)!=null?t:"");w&&p.set(w,x)}let f=new Set,y=new Set,b=new Set,v=new Set,h=!1;for(let x of o){let w=x.chunkId;if(!w)continue;f.add(w);let R=p.get(w);if(!R){console.warn(`Sync note: chunk id not found in cache (${w})`);continue}if(x.excludeFlag){R.excluded!==!0&&(R.excluded=!0,h=!0);let E=this.normalizeChunkText(x.text);E&&E!==String((n=R.text)!=null?n:"")&&(R.text=E,R.char_count=E.length,h=!0),b.add(w);continue}if(R.excluded&&(R.excluded=!1,h=!0,y.add(w)),!x.text.trim()){b.add(w),v.add(w);continue}let P=this.normalizeChunkText(x.text);if(!P){b.add(w),v.add(w);continue}let N=typeof R.text=="string"?R.text:String((i=R.text)!=null?i:"");P!==N&&(R.text=P,R.char_count=P.length,y.add(w),h=!0)}for(let x of p.keys())f.has(x)||(b.add(x),v.add(x));let k=new Set([...b,...v]);if(k.size){let x=Array.from(k).sort().join("|");if(this.noteSyncPendingDeletes.get(e.path)!==x){this.noteSyncPendingDeletes.set(e.path,x),this.scheduleNoteSync(e,1500);return}}else this.noteSyncPendingDeletes.has(e.path)&&this.noteSyncPendingDeletes.delete(e.path);if(!y.size&&!b.size&&!v.size&&!h)return;v.size&&(d.chunks=u.filter(x=>{var R;let w=typeof(x==null?void 0:x.chunk_id)=="string"?x.chunk_id:String((R=x==null?void 0:x.chunk_id)!=null?R:"");return w&&!v.has(w)}),h=!0),(h||v.size)&&await c.write(l,JSON.stringify(d,null,2)),await this.reindexChunkUpdates(s,l,Array.from(y),Array.from(b)),(b.size||v.size)&&this.noteSyncPendingDeletes.delete(e.path)}catch(r){console.warn("Failed to sync note edits to Redis",r)}finally{this.noteSyncInFlight.delete(e.path),this.noteSyncPending.delete(e.path)&&this.scheduleNoteSync(e,400)}}async syncNoteMetadataWithZotero(e,t){var n,i,r;if(this.noteMetadataSyncInFlight.has(e.path)){this.noteMetadataSyncPending.add(e.path);return}if(this.noteMetadataSyncSuppressed.has(e.path)){this.scheduleNoteMetadataSync(e,2e3,t);return}this.noteMetadataSyncInFlight.add(e.path);try{let a=await this.app.vault.read(e),s=await this.resolveDocIdForNote(e,a);if(!s)return;let o=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter;if(!o)return;let l=this.resolveZoteroItemKey(o,s);if(!l)return;let c=await this.fetchZoteroItem(l),d=(i=c==null?void 0:c.data)!=null?i:c;if(!d||typeof d!="object")return;let u=this.extractNoteMetadata(o),p=this.extractZoteroMetadata(d);p.citekey||(p.citekey=await this.resolveZoteroCitekey(d,l,c==null?void 0:c.meta));let f=await this.getMetadataSnapshot(s,o,e),y={},b={},v={},h=[],k=["title","short_title","citekey","date","abstract","doi","publisher","place","issue","volume","pages","item_type","tags","authors","editors"],x={title:"title",short_title:"short_title",citekey:"citekey",date:"date",abstract:"abstract",doi:"doi",publisher:"publisher",place:"place",issue:"issue",volume:"volume",pages:"pages",item_type:"item_type",tags:"tags",authors:"authors",editors:"editors"},w=Object.fromEntries(k.map(E=>[E,this.hasFrontmatterKey(o,x[E])])),R=new Set(["title","short_title","citekey","date","abstract","doi","publisher","place","issue","volume","pages","item_type","authors","editors"]),P=k.filter(E=>w[E]||!this.isMetadataValueEmpty(u[E])||!this.isMetadataValueEmpty(p[E]));if(!P.length)return;let N={title:"Title",short_title:"Short title",citekey:"Citekey",date:"Date",abstract:"Abstract",doi:"DOI",publisher:"Publisher",place:"Place",issue:"Issue",volume:"Volume",pages:"Pages",item_type:"Item type",tags:"Tags",authors:"Authors",editors:"Editors"};for(let E of P){let F=u[E],L=p[E];if(this.metadataValuesEqual(E,F,L))continue;let j=this.isMetadataValueEmpty(F),I=this.isMetadataValueEmpty(L),q=f==null?void 0:f[E];if(q===void 0){if(j&&!I){v[E]="zotero",this.assignMetadataUpdate(y,E,L);continue}if(!j&&I&&R.has(E)){v[E]="note",this.assignMetadataUpdate(b,E,F);continue}}if(q!==void 0){let O=!this.metadataValuesEqual(E,F,q),$=!this.metadataValuesEqual(E,L,q);if(O&&!$){v[E]="note",this.assignMetadataUpdate(b,E,F);continue}if(!O&&$){v[E]="zotero",this.assignMetadataUpdate(y,E,L);continue}}let V=this.getMetadataDecisionLabels(E,F,L,N);h.push({field:E,fieldLabel:N[E],noteLabel:V.noteLabel,zoteroLabel:V.zoteroLabel,noteValue:this.formatMetadataValue(F),zoteroValue:this.formatMetadataValue(L)})}if(h.length>0){let E=await this.promptMetadataBatchDecision(h);for(let F of h){let L=(r=E[F.field])!=null?r:"skip";v[F.field]=L,L==="note"?this.assignMetadataUpdate(b,F.field,u[F.field]):L==="zotero"&&this.assignMetadataUpdate(y,F.field,p[F.field])}}Object.keys(y).length>0&&await this.applyNoteMetadataUpdates(e,y),Object.keys(b).length>0&&await this.applyZoteroMetadataUpdates(l,d,u,p,b),await this.updateMetadataSnapshot(e,s,u,p,f,v,P)}catch(a){console.warn("Failed to sync note metadata with Zotero",a)}finally{this.noteMetadataSyncInFlight.delete(e.path),this.noteMetadataSyncPending.delete(e.path)&&this.scheduleNoteMetadataSync(e,500,t)}}async syncNoteAnnotationsWithZotero(e,t){var n,i,r,a,s;if(this.noteAnnotationSyncInFlight.has(e.path)){this.noteAnnotationSyncPending.add(e.path);return}if(this.noteAnnotationSyncSuppressed.has(e.path)){this.scheduleNoteAnnotationSync(e,2e3,t);return}this.noteAnnotationSyncInFlight.add(e.path);try{let o=await this.app.vault.read(e),l=this.findAnnotationBlockRange(o);if(!l)return;let c=this.parseAnnotationBlockMarker(l.startMarker),d=await this.resolveDocIdForNote(e,o);if(!d&&c.docId){d=c.docId;let q=this.ensureDocIdInNoteContent(o,d);q!==o&&await this.writeNoteWithSyncSuppressed(e.path,q)}if(!d)return;let u=(i=(n=this.app.metadataCache.getFileCache(e))==null?void 0:n.frontmatter)!=null?i:{},p=(r=c.attachmentKey)!=null?r:"";if(p||(p=await this.resolveAttachmentKeyForDocId(d,u)),!p)return;c.attachmentKey&&(!c.docId||c.docId===d)&&c.attachmentKey===p&&await this.updateDocIndex({doc_id:d,attachment_key:p});let f=p,y=await this.fetchZoteroAnnotationsForDoc(d,p),b=y.annotations;p=y.attachmentKey,p&&p!==f&&await this.updateDocIndex({doc_id:d,attachment_key:p});let v=this.parseAnnotationBlock(l.block,p),h=new Map;for(let q of v)q.key&&q.imagePath&&h.set(q.key,{path:q.imagePath,hash:q.imageHash||this.extractAnnotationImageHashFromPath(q.imagePath)});await this.attachAnnotationImages(d,p,b,e.path,h);let k=new Map;for(let q of v)q.key&&k.set(q.key,q);let x=new Map;for(let q of b)x.set(q.key,q);let w=!1,R=!1,P=!1;if(y.hadFetchError)k.size>0&&b.length===0&&console.info("Skipping annotation-prune sync due incomplete Zotero annotation fetch.",{docId:d,attachmentKey:p,reason:t});else for(let q of k.keys())x.has(q)||(R=!0);let N=await this.getAnnotationSnapshot(d),E=(a=N==null?void 0:N.annotations)!=null?a:{},F={},L=[];p&&p!==f&&b.length>0&&(R=!0,P=!0);for(let[q,V]of x.entries()){let O=k.get(q);if(!O){R=!0;continue}let $=E[q],U=this.annotationSnapshotFromEntry(O,V.annotationType),H=this.annotationSnapshotFromEntry(V,V.annotationType),M=(U.image_hash||"")!==(H.image_hash||"");if(!$){this.annotationSnapshotsEqualIgnoringImage(U,H)?M&&(R=!0,P=!0):(F[q]="note",w=!0);continue}let z=!this.annotationSnapshotsEqual(U,$),B=!this.annotationSnapshotsEqual(H,$),Z=(H.color_key||"")!==($.color_key||""),W=!this.annotationSnapshotsEqualIgnoringImage(U,$),re=!this.annotationSnapshotsEqualIgnoringImage(H,$);W&&!re?(F[q]="note",w=!0):!W&&re?(F[q]="zotero",R=!0):W&&re&&L.push({key:q,title:this.formatAnnotationConflictTitle(V),noteValue:this.formatAnnotationConflictValue(U,O.tags),zoteroValue:this.formatAnnotationConflictValue(H,V.tags)}),M&&(z||B)&&(R=!0,P=!0),Z&&(R=!0,P=!0)}if(L.length>0){let q=await this.promptAnnotationBatchDecision(L);for(let V of L){let O=(s=q[V.key])!=null?s:"skip";F[V.key]=O,O==="note"?w=!0:O==="zotero"&&(R=!0,P=!0)}}let j=[];for(let[q,V]of Object.entries(F)){if(V!=="note")continue;let O=k.get(q),$=x.get(q);!O||!$||j.push({entry:$,note:O})}j.length>0&&await this.applyZoteroAnnotationUpdates(j),w&&this.annotationNoteEditTimes.set(e.path,Date.now());let I=this.getAnnotationGraceRemaining(e.path);if(R&&I>0&&w&&!P&&(this.scheduleNoteAnnotationSync(e,I+250,t),R=!1),R){let q=this.buildAnnotationBlock(d,p,b),V=this.replaceAnnotationBlock(o,q);if(V&&V!==o){this.noteSyncSuppressed.add(e.path),this.noteAnnotationSyncSuppressed.add(e.path),this.noteMetadataSyncSuppressed.add(e.path);try{await this.app.vault.adapter.write(e.path,V)}finally{window.setTimeout(()=>{this.noteSyncSuppressed.delete(e.path),this.noteAnnotationSyncSuppressed.delete(e.path),this.noteMetadataSyncSuppressed.delete(e.path)},1500)}}}await this.updateAnnotationSnapshot(d,p,b),await this.updateAnnotationChunks(d,p,b)}catch(o){console.warn("Failed to sync note annotations with Zotero",o)}finally{this.noteAnnotationSyncInFlight.delete(e.path),this.noteAnnotationSyncPending.delete(e.path)&&this.scheduleNoteAnnotationSync(e,500,t)}}resolveZoteroItemKey(e,t){let n=[this.getFrontmatterValue(e,"zotero_key"),this.getFrontmatterValue(e,"item_key"),this.getFrontmatterValue(e,"doc_id"),t];for(let i of n){let r=G(i);if(r)return r}return""}async resolveAttachmentKeyForDocId(e,t){var l;if(!e)return"";let n=await this.getDocIndexEntry(e);if(n||(n=await this.hydrateDocIndexFromCache(e)),n!=null&&n.attachment_key)return n.attachment_key;let i=(0,m.normalizePath)(`${Q}/${e}.json`);try{if(await this.app.vault.adapter.exists(i)){let d=await this.readChunkPayload(i),u=d!=null&&d.metadata&&typeof d.metadata=="object"?d.metadata:null,p=u==null?void 0:u.attachment_key;if(typeof p=="string"&&p.trim())return await this.updateDocIndex({doc_id:e,attachment_key:p.trim()}),p.trim()}}catch(c){}let r=this.resolveZoteroItemKey(t,e);if(!r)return"";let a=await this.fetchZoteroItem(r),s=(l=a==null?void 0:a.data)!=null?l:a;if(!s||typeof s!="object")return"";let o=await Te(s,e,{fetchZoteroChildren:this.fetchZoteroChildren.bind(this)});return o!=null&&o.key?(await this.updateDocIndex({doc_id:e,attachment_key:o.key}),o.key):""}extractNoteMetadata(e){var v,h,k,x,w,R,P,N,E,F,L,j,I;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString((x=(k=(h=(v=e==null?void 0:e["short title"])!=null?v:e==null?void 0:e.short_title)!=null?h:e==null?void 0:e.shortTitle)!=null?k:e==null?void 0:e["short-title"])!=null?x:e==null?void 0:e["title-short"]),i=this.normalizeMetadataString((N=(P=(R=(w=e==null?void 0:e.citekey)!=null?w:e==null?void 0:e["citation key"])!=null?R:e==null?void 0:e.citation_key)!=null?P:e==null?void 0:e.citationKey)!=null?N:e==null?void 0:e["citation-key"]),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString((E=e==null?void 0:e.abstract)!=null?E:e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((F=e==null?void 0:e.doi)!=null?F:e==null?void 0:e.DOI),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),u=this.normalizeMetadataString(e==null?void 0:e.pages),p=this.normalizeMetadataString((I=(j=(L=e==null?void 0:e["item type"])!=null?L:e==null?void 0:e.item_type)!=null?j:e==null?void 0:e.itemType)!=null?I:e==null?void 0:e["item-type"]),f=this.normalizeMetadataList(e==null?void 0:e.tags),y=this.normalizeMetadataList(e==null?void 0:e.authors),b=this.normalizeMetadataList(e==null?void 0:e.editors);return{title:t,short_title:n,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:u,item_type:p,tags:this.sanitizeObsidianTags(f),authors:y,editors:b}}extractZoteroMetadata(e){var h,k,x;let t=this.normalizeMetadataString(e==null?void 0:e.title),n=this.normalizeMetadataString(Ce(e)),i=this.normalizeMetadataString(He(e)),r=this.normalizeMetadataString(e==null?void 0:e.date),a=this.normalizeMetadataString(e==null?void 0:e.abstractNote),s=this.normalizeMetadataString((h=e==null?void 0:e.DOI)!=null?h:e==null?void 0:e.doi),o=this.normalizeMetadataString(e==null?void 0:e.publisher),l=this.normalizeMetadataString(e==null?void 0:e.place),c=this.normalizeMetadataString(e==null?void 0:e.issue),d=this.normalizeMetadataString(e==null?void 0:e.volume),u=this.normalizeMetadataString(e==null?void 0:e.pages),p=this.normalizeMetadataString((x=(k=e==null?void 0:e.itemType)!=null?k:e==null?void 0:e.item_type)!=null?x:e==null?void 0:e["item-type"]),f=Array.isArray(e==null?void 0:e.creators)?e.creators:[],y=f.filter(w=>(w==null?void 0:w.creatorType)==="author").map(w=>Pe(w)).filter(Boolean),b=f.filter(w=>(w==null?void 0:w.creatorType)==="editor"||(w==null?void 0:w.creatorType)==="seriesEditor").map(w=>Pe(w)).filter(Boolean),v=Array.isArray(e==null?void 0:e.tags)?e.tags.map(w=>typeof w=="string"?w:w==null?void 0:w.tag).filter(w=>typeof w=="string"):[];return{title:t,short_title:n,citekey:i,date:r,abstract:a,doi:s,publisher:o,place:l,issue:c,volume:d,pages:u,item_type:p,tags:this.sanitizeObsidianTags(v),authors:this.normalizeMetadataList(y),editors:this.normalizeMetadataList(b)}}async resolveZoteroCitekey(e,t,n){let i=this.normalizeMetadataString(He(e,n!=null?n:void 0));if(i)return i;if(!t)return"";let r=await this.fetchZoteroItemCsl(t);return this.normalizeMetadataString(ht(r))}extractAnnotationPageInfo(e){var a;let n=G((a=e.annotationPageLabel)!=null?a:e.annotationPage).trim(),i=null,r=e.annotationPage;if(typeof r=="number"&&Number.isFinite(r))i=r;else if(typeof r=="string"&&r.trim()){let s=Number(r);Number.isFinite(s)&&(i=s)}if(i===null&&typeof e.annotationPosition=="string")try{let s=JSON.parse(e.annotationPosition),o=s==null?void 0:s.pageIndex;typeof o=="number"&&Number.isFinite(o)&&(i=o+1)}catch(s){}return{pageLabel:n,pageIndex:i}}extractAnnotationImagePayload(e){var a,s,o,l;let t=(s=(a=e.annotationImage)!=null?a:e.annotationImageData)!=null?s:e.annotationImageBase64;if(!t)return null;let n=null,i="";if(Buffer.isBuffer(t))n=t;else if(ArrayBuffer.isView(t))n=Buffer.from(t.buffer,t.byteOffset,t.byteLength);else if(t instanceof ArrayBuffer)n=Buffer.from(t);else if(typeof t=="string"){let c=t.trim();if(!c)return null;let d=c.match(/^data:([^;]+);base64,(.*)$/i);if(d&&(i=this.normalizeAnnotationImageMime(d[1]),c=d[2]),/^(https?|file|zotero):/i.test(c)||(c=c.replace(/^base64,/,"").replace(/\s+/g,""),!c))return null;n=Buffer.from(c,"base64")}if(!n||!n.length)return null;i||(i=this.normalizeAnnotationImageMime((l=(o=e.annotationImageMimeType)!=null?o:e.annotationImageType)!=null?l:e.annotationImageFormat)||this.guessAnnotationImageMime(n)||"image/png");let r=this.annotationImageExtensionFromMime(i)||this.annotationImageExtensionFromMime(this.guessAnnotationImageMime(n))||"png";return{buffer:n,mime:i,ext:r}}parseZoteroAnnotationItem(e,t){var h,k,x,w;let n=(k=(h=e==null?void 0:e.data)!=null?h:e)!=null?k:{},i=G((x=e==null?void 0:e.key)!=null?x:n==null?void 0:n.key);if(!i)return null;let r=G(n.annotationType),a=this.normalizeAnnotationText(n.annotationText),s=this.normalizeAnnotationText(n.annotationComment),o=G(n.annotationColor),l=this.normalizeAnnotationColorKey(o),{heading:c,callout:d}=this.resolveAnnotationColorMeta(l),{pageLabel:u,pageIndex:p}=this.extractAnnotationPageInfo(n),f=(w=n.annotationSortIndex)!=null?w:n.annotationSort,y=G(f).trim(),b=Number.isFinite(Number(y))?Number(y):Number.NaN,v=Array.isArray(n.tags)?n.tags.map(R=>typeof R=="string"?R:R==null?void 0:R.tag).filter(R=>typeof R=="string"):[];return{key:i.trim(),attachmentKey:t,pageLabel:u,pageIndex:p,colorKey:l,callout:d,heading:c,annotationType:r,text:a,comment:s,tags:this.normalizeAnnotationTags(v),sortToken:y,sortIndex:b,rawValues:n}}async fetchZoteroAnnotations(e){if(!e)return{annotations:[],hadFetchError:!1};let t=this.canUseWebApi()||await this.ensureWebApiLibraryId(),n=!1,i=!1,r=o=>{var c,d;let l=[];for(let u of o){let p=(d=(c=u==null?void 0:u.data)!=null?c:u)!=null?d:{};if(G(p.itemType)!=="annotation")continue;let f=this.parseZoteroAnnotationItem(u,e);f&&l.push(f)}return l},a=[];try{a=await this.fetchZoteroChildrenLocal(e,{includeAnnotationImage:!0})}catch(o){try{a=await this.fetchZoteroChildrenLocal(e)}catch(l){n=!0,console.warn("Failed to fetch Zotero annotation items from local API",l)}}let s=r(a);if(!s.length&&t)try{let o=[];try{o=await this.fetchZoteroChildrenWeb(e,{includeAnnotationImage:!0})}catch(c){o=await this.fetchZoteroChildrenWeb(e)}i=!0;let l=r(o);l.length&&(s=l)}catch(o){n=!0,console.warn("Failed to fetch Zotero annotation items from Web API",o)}return!s.length&&t&&!i&&(n=!0),!s.length&&!t&&(n=!0),{annotations:s,hadFetchError:n}}async fetchZoteroAnnotationsForDoc(e,t){var l,c,d;let n=t,i=await this.fetchZoteroAnnotations(n);if(i.annotations.length||!e)return i.annotations.length||this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i.annotations,hadFetchError:i.hadFetchError};let r=[];try{r=await this.fetchZoteroChildren(e)}catch(u){return console.warn("Failed to fetch Zotero attachments for annotations",u),this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i.annotations,hadFetchError:!0}}let a=i.hadFetchError,s=[],o=new Set(n?[n]:[]);for(let u of r){if(!ft(u))continue;let p=G((d=(c=u==null?void 0:u.key)!=null?c:(l=u==null?void 0:u.data)==null?void 0:l.key)!=null?d:u==null?void 0:u.attachmentKey);!p||o.has(p)||(o.add(p),s.push(p))}for(let u of s){let p=await this.fetchZoteroAnnotations(u);if(a=a||p.hadFetchError,p.annotations.length)return{attachmentKey:u,annotations:p.annotations,hadFetchError:a}}return this.maybeWarnMissingAnnotationApi(e,t),{attachmentKey:n,annotations:i.annotations,hadFetchError:a}}async attachAnnotationImages(e,t,n,i,r){var u;if(!this.settings.includeAnnotationImages||!n.length)return;let a=await this.resolveAnnotationImageOutputDir(i);if(!a)return;let s=this.sanitizeFileName(e||t)||"annotations",o=(0,m.normalizePath)(S.default.join(a.relative||"",s)),l=S.default.normalize(S.default.join(a.absolute,s));o?await this.ensureFolder(o):await Y.promises.mkdir(l,{recursive:!0});let c=this.app.vault.adapter,d=new Map;for(let p of n){let f=String(p.annotationType||"").trim().toLowerCase(),y=f==="image"||f==="ink",b=this.extractAnnotationImagePayload((u=p.rawValues)!=null?u:{});if(!b&&y&&this.settings.zoteroCompanionEnabled&&(b=await this.fetchCompanionAnnotationImage(p.key)),!b){let x=r==null?void 0:r.get(p.key);x!=null&&x.path&&await c.exists(x.path)&&(p.imagePath=x.path,p.imageHash=x.hash,d.set(p.key,x.path));continue}let v=(0,Fe.createHash)("sha1").update(b.buffer).digest("hex").slice(0,12),h=`zrr-annotation-${p.key}-${v}.${b.ext}`,k=(0,m.normalizePath)(S.default.join(o,h));try{await c.exists(k)||await c.writeBinary(k,this.bufferToArrayBuffer(b.buffer)),p.imagePath=k,p.imageHash=v,d.set(p.key,k)}catch(x){console.warn("Failed to write annotation image",{annotationKey:p.key,error:x})}}if(o&&await c.exists(o))try{let p=await c.list(o);for(let f of p.files){let b=S.default.basename(f).match(/^zrr-annotation-([A-Z0-9]{8})-[a-f0-9]{12}\./i);if(!b)continue;let v=b[1].toUpperCase(),h=d.get(v);(!h||(0,m.normalizePath)(h)!==(0,m.normalizePath)(f))&&await c.remove(f)}}catch(p){console.warn("Failed to clean up annotation images",p)}}async fetchCompanionAnnotationImage(e){let t=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!t)return null;let n=`${t.replace(/\/$/,"")}/annotations/${encodeURIComponent(e)}/image`,i={},r=(this.settings.zoteroCompanionToken||"").trim();r&&(i.Authorization=`Bearer ${r}`);try{let a=await this.requestLocalApiRaw(n,{headers:i,timeoutMs:5e3});if(a.statusCode===200){let s=a.headers["content-type"],o=Array.isArray(s)?s[0]:s!=null?s:"";return this.buildAnnotationImagePayloadFromBuffer(a.body,o)}if(a.statusCode===204||a.statusCode===404)return null;console.warn("Unexpected Zotero companion response",{annotationKey:e,status:a.statusCode})}catch(a){console.warn("Failed to fetch annotation image from Zotero companion",a)}return null}async checkZoteroCompanionHealth(){let e=(this.settings.zoteroCompanionBaseUrl||"").trim();if(!e){new m.Notice("Zotero companion base URL is not set.");return}let t=`${e.replace(/\/$/,"")}/health`,n={},i=(this.settings.zoteroCompanionToken||"").trim();i&&(n.Authorization=`Bearer ${i}`);try{let r=await this.requestLocalApiRaw(t,{headers:n,timeoutMs:3e3});if(r.statusCode===200){try{let a=JSON.parse(r.body.toString("utf8"));if(a!=null&&a.ok){new m.Notice("Zotero companion: OK.");return}}catch(a){}new m.Notice("Zotero companion responded but did not return OK.");return}if(r.statusCode===401){new m.Notice("Zotero companion: unauthorized (check token).");return}new m.Notice(`Zotero companion: HTTP ${r.statusCode}.`)}catch(r){console.warn("Zotero companion health check failed",r),new m.Notice("Zotero companion: unreachable.")}}async openZoteroAddons(){try{let e=process.platform;e==="darwin"?await this.spawnDetached(["open","-a","Zotero"]):e==="win32"?await this.spawnDetached(["cmd","/c","start","","zotero"]):await this.spawnDetached(["zotero"]),new m.Notice("Opened Zotero. Go to Tools \u2192 Add-ons.")}catch(e){console.warn("Failed to open Zotero add-ons",e),new m.Notice("Unable to open Zotero automatically. Open Zotero and go to Tools \u2192 Add-ons.")}}async spawnDetached(e){let[t,...n]=e;if(!t)throw new Error("Missing command");await new Promise((i,r)=>{let a=!1,s=(0,ae.spawn)(t,n,{detached:!0,stdio:"ignore"});s.on("error",o=>{a||(a=!0,r(o))}),s.unref(),a||(a=!0,i())})}maybeWarnMissingAnnotationApi(e,t){if(this.canUseWebApi()){console.info("No Zotero annotations returned for attachment",{docId:e,attachmentKey:t});return}let n=e||t;!n||this.annotationWebApiWarned.has(n)||(this.annotationWebApiWarned.add(n),new m.Notice("Zotero annotations require Web API access. Configure the Web API library ID and key to import annotations."))}normalizeMetadataString(e){return typeof e=="string"?e.replace(/\r\n/g,`
`).replace(/\r/g,`
